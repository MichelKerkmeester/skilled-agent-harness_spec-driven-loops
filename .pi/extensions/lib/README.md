...
| Ownership | Lifecycle behavior belongs to the dist files under `system-spec-kit/runtime/dist/hooks/claude/`. This module owns only process spawning, payload serialization, and output parsing. |

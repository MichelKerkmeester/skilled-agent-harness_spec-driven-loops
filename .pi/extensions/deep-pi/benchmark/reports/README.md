---
title: "deep-pi Benchmark Reports"
description: "Index of curated benchmark run reports for deep-pi, one row per run folder."
trigger_phrases:
  - "deep-pi benchmark reports"
  - "deep-pi benchmark index"
...
|---|---|---|---|---|---|
| 2026-08-17 | [`2026-08-17--manual-testing-playbook--deeppi-behavior/`](./2026-08-17--manual-testing-playbook--deeppi-behavior/) | deeppi-behavior | 1 PASS | **PASS** | `manual-testing-playbook` |

...
> pi-fast-mode-w-subagent-support · doc · fast-mode-usage
...
| Field | Value |
|---|---|
| Target skill | pi-fast-mode-w-subagent-support |
| Scoring method | not-applicable-manual-outcome |
| Trace mode | doc |
| Executor | not recorded |
| Model | not recorded (fast-mode-usage) |
| Scenarios | 1 |

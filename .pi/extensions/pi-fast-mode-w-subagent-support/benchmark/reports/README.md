---
title: "pi-fast-mode-w-subagent-support Benchmark Reports"
description: "Index of curated benchmark run reports for pi-fast-mode-w-subagent-support, one row per run folder."
trigger_phrases:
  - "pi-fast-mode-w-subagent-support benchmark reports"
  - "pi-fast-mode-w-subagent-support benchmark index"

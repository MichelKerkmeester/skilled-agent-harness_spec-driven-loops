---
title: "pi-cache-optimizer Benchmark Reports"
description: "Index of curated benchmark run reports for pi-cache-optimizer, one row per run folder."
trigger_phrases:
  - "pi-cache-optimizer benchmark reports"
  - "pi-cache-optimizer benchmark index"
...
|---|---|---|---|---|---|
| 2026-08-17 | [`2026-08-17--manual-testing-playbook--cache-behavior/`](./2026-08-17--manual-testing-playbook--cache-behavior/) | cache-behavior | 1 PASS | **PASS** | `manual-testing-playbook` |

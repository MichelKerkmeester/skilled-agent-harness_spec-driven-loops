...
| Other 19 scripts          | Matches real-path behavior | Authoritative runtime behavior |
...
| Repository hygiene | `worktree-guard.sh`, `check-git-hooks.sh`, `check-dist-staleness.sh`, `install-codex-hooks.mjs`, `git-live-follow.sh`, `git-preflight-advisory.mjs`, `git-primary-reconcile.sh` |

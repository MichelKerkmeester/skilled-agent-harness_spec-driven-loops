...
| @ai-council | `.claude/agents/ai-council.md` | Planning-only multi-strategy architect (max 3 strategies)                              |
...
| @code     | `.claude/agents/code.md`     | Application-code LEAF; sk-code stack delegation; convention-floor caller-restriction (`Depth: 1` marker required); fail-closed verify |

...
- Canonical event contract: `.opencode/skills/deep-loop-workflows/review/references/protocol/loop_protocol.md §Lifecycle Branches (current release)`.
...
- `.opencode/skills/deep-loop-workflows/review/scripts/reduce-state.cjs` owns registry/dashboard/report refresh.

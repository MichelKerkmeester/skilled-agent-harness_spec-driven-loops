...
| ------- | ------- | ---- |
| `/improve:agent` | Initializes and runs the bounded improve-agent workflow | `.opencode/command/improve/agent.md` |
...
| Agent | Purpose |
| ----- | ------- |
| `improve-agent` | Proposal-only mutator for bounded candidate generation |

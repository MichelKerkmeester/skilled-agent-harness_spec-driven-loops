...
**Stack Patterns Location:** `.opencode/skill/sk-code/references/{repository}/`
...
**Invocation:** Automatic via Gate 2 routing when git analysis tasks detected, or manually via `Read(".opencode/skill/sk-git/SKILL.md")`.
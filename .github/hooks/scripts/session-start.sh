...
cd "$REPO_ROOT"
if [ -f ".opencode/skills/system-spec-kit/runtime/dist/hooks/copilot/session-prime.js" ]; then
  node .opencode/skills/system-spec-kit/runtime/dist/hooks/copilot/session-prime.js < "$INPUT_FILE"
else

...
| `user-prompt-submitted.sh` | `system-spec-kit/runtime/dist/hooks/copilot/user-prompt-submit.js` | Writes a context block to `.github/copilot-instructions.md` (or `SPECKIT_COPILOT_INSTRUCTIONS_PATH`), then prints `{}` |

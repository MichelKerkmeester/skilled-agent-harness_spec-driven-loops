...
`.devin/hooks/` contains 13 relative symlinks to Devin adapters owned under `.opencode/`. Devin executes the real paths declared in `.devin/hooks.v1.json`. The mirror exists for discovery and direct comparison across runtimes.

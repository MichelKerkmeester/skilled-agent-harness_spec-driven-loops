...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/01--runtime-routing-and-rename/002-advisor-routes-council-prompts-to-skill.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/01--runtime-routing-and-rename/002-advisor-routes-council-prompts-to-skill.md`
- Playbook scenario: `manual_testing_playbook/01--runtime-routing-and-rename/002-advisor-routes-council-prompts-to-skill.md`
Related references:
- [001-runtime-agent-renamed-to-deep-ai-council.md](001-runtime-agent-renamed-to-deep-ai-council.md) — Runtime agent renamed to deep-ai-council

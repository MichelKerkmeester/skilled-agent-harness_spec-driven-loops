...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/deep-ai-council/references/structure/output_schema.md` | Reference | Requiredness contract |
| `.opencode/skills/deep-ai-council/scripts/persist-artifacts.cjs` | Script | Parser entrypoint |

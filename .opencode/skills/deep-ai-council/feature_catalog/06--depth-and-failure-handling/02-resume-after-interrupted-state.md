...
Current behavior is grounded in `.opencode/skills/deep-ai-council/references/state_format.md`, which the scenario identifies as resume semantics reference. Validation is anchored by `manual_testing_playbook/06--depth-and-failure-handling/002-resume-after-interrupted-state.md`, covering manual scenario contract.

...
Current behavior is grounded in `.opencode/skills/deep-ai-council/references/seat_diversity_patterns.md`, which the scenario identifies as seat diversity contract. Validation is anchored by `manual_testing_playbook/02--council-deliberation-and-seat-diversity/001-three-seat-diverse-deliberation.md`, covering manual scenario contract.

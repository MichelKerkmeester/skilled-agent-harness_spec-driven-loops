...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/09--council-graph-value-comparison/029-convergence-safety-under-critical-disagreement-graph-vs-baseline.md` | Automated test | Manual scenario contract |
...
- Playbook scenario: `manual_testing_playbook/09--council-graph-value-comparison/029-convergence-safety-under-critical-disagreement-graph-vs-baseline.md`
Related references:

...
- Feature file path: `feature_catalog/08--council-graph-integration/council-graph-upsert-empty-input-no-op-success.md`
- Playbook scenario: `manual_testing_playbook/08--council-graph-integration/council-graph-upsert-empty-input-no-op-success.md`
Related references:

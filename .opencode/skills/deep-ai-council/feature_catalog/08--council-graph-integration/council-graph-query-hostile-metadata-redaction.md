...
- Feature file path: `feature_catalog/08--council-graph-integration/council-graph-query-hostile-metadata-redaction.md`
- Playbook scenario: `manual_testing_playbook/08--council-graph-integration/council-graph-query-hostile-metadata-redaction.md`
Related references:

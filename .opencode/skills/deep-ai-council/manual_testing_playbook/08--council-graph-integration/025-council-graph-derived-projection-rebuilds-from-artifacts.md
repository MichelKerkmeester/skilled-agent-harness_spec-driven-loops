...
5. Replay upserts with `node .opencode/skills/deep-ai-council/scripts/replay-graph-from-artifacts.cjs --spec-folder <spec-folder> --session-id dac-025-run-01`, then pipe the emitted payload to `runtime upsert CLI`.
...
- Feature file path: `08--council-graph-integration/025-council-graph-derived-projection-rebuilds-from-artifacts.md`

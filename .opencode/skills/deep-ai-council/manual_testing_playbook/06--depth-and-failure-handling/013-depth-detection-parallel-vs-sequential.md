...
2. `bash: rg -n "## [0-9]+\\." .opencode/skills/deep-ai-council/references/convergence/depth_dispatch.md`
...
| `.opencode/skills/deep-ai-council/references/convergence/depth_dispatch.md` | Reference mirror for operator use |
...
- Feature file path: `06--depth-and-failure-handling/013-depth-detection-parallel-vs-sequential.md`

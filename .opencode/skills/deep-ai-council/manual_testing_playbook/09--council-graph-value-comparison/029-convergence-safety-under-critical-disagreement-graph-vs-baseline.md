...
| `../08--council-graph-integration/023-council-graph-convergence-three-state-decision-matrix.md` | Functional anchor for STOP_BLOCKED branch |
| `../04--convergence-and-rollback/008-two-of-three-agree-triggers-convergence.md` | The baseline rule this scenario challenges |
...
- Feature file path: `09--council-graph-value-comparison/029-convergence-safety-under-critical-disagreement-graph-vs-baseline.md`

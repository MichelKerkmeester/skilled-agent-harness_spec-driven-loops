...
| `../08--council-graph-integration/022-council-graph-query-five-modes-prompt-safe-context.md` | Functional anchor for `decision_support` mode |
...
- Feature file path: `09--council-graph-value-comparison/028-decision-provenance-audit-graph-vs-baseline.md`

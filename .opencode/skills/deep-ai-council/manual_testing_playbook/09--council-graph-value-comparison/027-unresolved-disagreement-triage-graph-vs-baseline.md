...
| `../08--council-graph-integration/022-council-graph-query-five-modes-prompt-safe-context.md` | Functional anchor for `unresolved_disagreements` mode |
...
- Feature file path: `09--council-graph-value-comparison/027-unresolved-disagreement-triage-graph-vs-baseline.md`

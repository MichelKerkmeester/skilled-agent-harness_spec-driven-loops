...
| `../08--council-graph-integration/022-council-graph-query-five-modes-prompt-safe-context.md` | Functional anchor for `convergence_blockers` mode |
| `../04--convergence-and-rollback/009-max-rounds-without-convergence-emits-non-converged.md` | Baseline `convergence:false` behavior |
...
- Feature file path: `09--council-graph-value-comparison/030-stalled-council-blocker-ranking-graph-vs-baseline.md`

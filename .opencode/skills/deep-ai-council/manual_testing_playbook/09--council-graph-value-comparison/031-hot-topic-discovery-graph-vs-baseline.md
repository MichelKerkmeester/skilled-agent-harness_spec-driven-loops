...
| `../08--council-graph-integration/022-council-graph-query-five-modes-prompt-safe-context.md` | Functional anchor for `hot_nodes` mode |
...
- Feature file path: `09--council-graph-value-comparison/031-hot-topic-discovery-graph-vs-baseline.md`

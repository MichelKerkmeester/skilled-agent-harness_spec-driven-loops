...
|------|-----------------|------------------|
| Resolve | Pick the packet and planning boundary | `references/folder_layout.md` |
| Seat | Select 2-3 distinct planning lenses | `references/seat_diversity_patterns.md` |
| Deliberate | Gather proposals and critique them | `references/scoring_rubric.md` |
| Converge | Apply two-of-three plus blocker checks | `references/convergence_signals.md` |
| Persist | Write packet-local artifacts from caller context | `references/output_schema.md` |
| Verify | Confirm final state and graph projection boundaries | `references/state_format.md`, `references/graph_support.md` |
...
- Required report sections from `references/output_schema.md` are missing.
...
- `references/loop_protocol.md` for the full council workflow.
- `references/output_schema.md` for required report sections.
- `references/state_format.md` for JSONL event semantics.

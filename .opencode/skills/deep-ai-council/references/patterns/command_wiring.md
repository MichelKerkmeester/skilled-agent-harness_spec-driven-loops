...
steps:
  ...
  - id: step_persist_council
    uses: shell.exec
    command: >
      node .opencode/skills/deep-ai-council/scripts/persist-artifacts.cjs
      "${packet.spec_folder}"
...
- Output schema: `.opencode/skills/deep-ai-council/references/structure/output_schema.md`
- State format: `.opencode/skills/deep-ai-council/references/structure/state_format.md`

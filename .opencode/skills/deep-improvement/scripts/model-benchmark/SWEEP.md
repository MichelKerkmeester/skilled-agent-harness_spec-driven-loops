...
| `../../assets/model-benchmark/benchmark-profiles/framework-bakeoff.json` | Example profile — 5 frameworks × 1 model. |
| `../../assets/model-benchmark/benchmark-profiles/model-vs-model.json` | Example profile — 1 framework × 3 models. |
| `../../assets/model-benchmark/benchmark-fixtures/t3-bugfix-in-context.json` | T3 fixture (id `t3-lower-bound`), hidden deterministic oracle. |
| `../../assets/model-benchmark/benchmark-fixtures/t3-strict-acceptance.json` | T3 fixture (id `t3-compare-versions`), hidden deterministic oracle. |
...
node sweep-benchmark.cjs \
  --profile ../../assets/model-benchmark/benchmark-profiles/framework-bakeoff.json \
  --mock \

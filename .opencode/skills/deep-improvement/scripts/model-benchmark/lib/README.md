...
```bash
npx vitest run .opencode/skills/deep-improvement/scripts/model-benchmark/tests/sweep-foundation.vitest.ts
npx vitest run .opencode/skills/deep-improvement/scripts/model-benchmark/tests/sweep-stats-ci.vitest.ts
npx vitest run .opencode/skills/deep-improvement/scripts/model-benchmark/tests/sweep-acceptance.vitest.ts
```

...
```bash
npx vitest run .opencode/skills/deep-improvement/scripts/skill-benchmark/tests/skill-benchmark.vitest.ts
npx vitest run .opencode/skills/deep-improvement/scripts/skill-benchmark/tests/playbook-mode.vitest.ts
npx vitest run .opencode/skills/deep-improvement/scripts/skill-benchmark/tests/sk-code-router-sync.vitest.ts
```

...
| **Invoke with** | `/deep:start-agent-improvement-loop`, `/deep:start-model-benchmark-loop`, `/deep:start-skill-benchmark-loop` or `/deep:start-non-dev-ai-system-loop` |
...
| D: Non-Dev-AI-System Refine | `/deep:start-non-dev-ai-system-loop` | An AI-system packaging benchmarked, independently re-graded and auto-refined behind guardrails |

...
- Real user request: `Confirm that non-dev-ai-system-refine dry-runs cleanly, that the red-team gauntlet passes 10/10 dispatch-free, and that a synthetic-deficit run produces a journaled promote_accept.`

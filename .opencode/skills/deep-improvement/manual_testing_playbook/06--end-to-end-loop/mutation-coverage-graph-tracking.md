...
| `06--end-to-end-loop/mutation-coverage-graph-tracking.md` | Canonical per-feature execution contract |
...
- Feature file path: `06--end-to-end-loop/mutation-coverage-graph-tracking.md`

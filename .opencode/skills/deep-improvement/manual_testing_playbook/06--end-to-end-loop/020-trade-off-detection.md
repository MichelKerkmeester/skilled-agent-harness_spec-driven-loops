---
title: "E2E-020 -- Trade-Off Detection Across Dimensions"
...
- Prompt: `Validate that unresolved dimension trade-offs are reported and block auto-promotion.`
...
| `06--end-to-end-loop/020-trade-off-detection.md` | Canonical per-feature execution contract |
...
- Feature file path: `06--end-to-end-loop/020-trade-off-detection.md`

---
title: "E2E-019 -- Mutation Coverage Graph Tracking"
description: "Manual validation scenario for E2E-019: Mutation Coverage Graph Tracking."
feature_id: "E2E-019"
...
This document captures the canonical manual-testing contract for `E2E-019`.
...
- Prompt: `Validate that the improvement loop maintains an isolated improvement mutation coverage graph.`
...
| `06--end-to-end-loop/019-mutation-coverage-graph-tracking.md` | Canonical per-feature execution contract |
...
- Feature file path: `06--end-to-end-loop/019-mutation-coverage-graph-tracking.md`

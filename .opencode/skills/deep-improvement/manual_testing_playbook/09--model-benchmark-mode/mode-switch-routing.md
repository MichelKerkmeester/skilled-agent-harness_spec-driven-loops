...
| `09--model-benchmark-mode/mode-switch-routing.md` | Canonical per-feature execution contract |
...
- Feature file path: `09--model-benchmark-mode/mode-switch-routing.md`

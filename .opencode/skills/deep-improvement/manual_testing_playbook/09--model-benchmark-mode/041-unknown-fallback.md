...
| `09--model-benchmark-mode/041-unknown-fallback.md` | Canonical per-feature execution contract |
...
- Feature file path: `09--model-benchmark-mode/041-unknown-fallback.md`

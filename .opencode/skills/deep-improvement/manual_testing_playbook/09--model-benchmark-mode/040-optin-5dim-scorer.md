...
| `09--model-benchmark-mode/040-optin-5dim-scorer.md` | Canonical per-feature execution contract |
...
- Feature file path: `09--model-benchmark-mode/040-optin-5dim-scorer.md`

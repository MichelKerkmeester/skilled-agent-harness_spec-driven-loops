...
| `09--model-benchmark-mode/042-criteria-exec-gate.md` | Canonical per-feature execution contract |
...
- Feature file path: `09--model-benchmark-mode/042-criteria-exec-gate.md`

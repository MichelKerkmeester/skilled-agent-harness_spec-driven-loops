---
title: "SB-040 -- Mode Wiring And Routing via loop-host"
description: "Manual validation scenario for SB-040: Mode Wiring And Routing via loop-host."
feature_id: "SB-040"
...
This document captures the canonical manual-testing contract for `SB-040`.
...
| `10--skill-benchmark/040-mode-wiring-routing.md` | Canonical per-feature execution contract |
...
- Feature file path: `10--skill-benchmark/040-mode-wiring-routing.md`

...
| `10--skill-benchmark/047-scoring-vs-private-gold.md` | Canonical per-feature execution contract |
...
| `../../assets/skill-benchmark/fixtures/deep-improvement/agent-improve-001.private.json` | Private gold (intentKeys/resources/skillId) joined for scoring |
...
- Feature file path: `10--skill-benchmark/047-scoring-vs-private-gold.md`

---
title: "SB-041 -- Contamination Gate For Public Fixtures"
description: "Manual validation scenario for SB-041: Contamination Gate For Public Fixtures."
feature_id: "SB-041"
category: "Skill-Benchmark Mode"
---

# SB-041 -- Contamination Gate For Public Fixtures

This document captures the canonical manual-testing contract for `SB-041`.
...
| `10--skill-benchmark/041-contamination-gate.md` | Canonical per-feature execution contract |
...
- Feature file path: `10--skill-benchmark/041-contamination-gate.md`

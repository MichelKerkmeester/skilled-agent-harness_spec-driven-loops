...
| `04--benchmark-integration/without-integration.md` | Canonical per-feature execution contract |
...
- Feature file path: `04--benchmark-integration/without-integration.md`

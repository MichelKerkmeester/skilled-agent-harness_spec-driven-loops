...
| `05--reducer-dimensions/014-no-dimensions.md` | Canonical per-feature execution contract |
...
- Feature file path: `05--reducer-dimensions/014-no-dimensions.md`

...
| `07--runtime-truth/031-replay-consumer.md` | Canonical per-feature execution contract |
...
- Feature file path: `07--runtime-truth/031-replay-consumer.md`
...
node -e "
  const mc = require('./.opencode/skills/deep-improvement/scripts/shared/mutation-coverage.cjs');

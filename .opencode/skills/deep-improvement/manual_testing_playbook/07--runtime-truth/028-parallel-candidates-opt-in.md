...
| `07--runtime-truth/028-parallel-candidates-opt-in.md` | Canonical per-feature execution contract |
...
| `../../assets/agent-improvement/improvement_config.json'` | Implementation or verification anchor referenced by this scenario |
...
- Feature file path: `07--runtime-truth/028-parallel-candidates-opt-in.md`

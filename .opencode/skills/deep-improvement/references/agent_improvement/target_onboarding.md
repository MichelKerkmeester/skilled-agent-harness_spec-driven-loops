...
1. (Optional) Add the manifest entry in `assets/agent_improvement/target_manifest.jsonc` if the target needs explicit classification or guardrail protections

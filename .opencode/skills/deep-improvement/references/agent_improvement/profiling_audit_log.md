...
The profile-selection logging is implemented in `.opencode/skills/deep-improvement/scripts/agent-improvement/generate-profile.cjs`.
...
- `generate-profile.cjs`: `.opencode/skills/deep-improvement/scripts/agent-improvement/generate-profile.cjs`
- `typed-errors.cjs`: `.opencode/skills/deep-improvement/scripts/lib/typed-errors.cjs`

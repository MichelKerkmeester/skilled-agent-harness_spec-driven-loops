...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/deep-improvement/scripts/skill-benchmark/build-report.cjs` | Reporting | `renderReport` renders `skill-benchmark-report.md` purely from the report object; anti-drift, only writer of the markdown. |
| `.opencode/skills/deep-improvement/assets/skill-benchmark/remediation_taxonomy.json` | Reference asset | Maps each finding class to `severity`/`targetFile`/`locus`/`oneLineFix`/`handoffLane`; validated by test, not consumed by report code. |
...
- Feature file path: `05--skill-benchmark/023-dual-report-and-remediation.md`
Related references:
- [022-scoring-and-funnel.md](022-scoring-and-funnel.md) — D1-D5 scoring and funnel

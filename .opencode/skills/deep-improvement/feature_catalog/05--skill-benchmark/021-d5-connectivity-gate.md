...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/deep-improvement/scripts/skill-benchmark/d5-connectivity.cjs` | Hard gate | Static P0/P1/P2 connectivity scan (`scanConnectivity`, `listMarkdownRefs`); sets `gateFailed` and the D5 `score`. |
| `.opencode/skills/deep-improvement/scripts/skill-benchmark/router-replay.cjs` | Utility (imported) | Supplies `parseRouter` the gate scans for dead/escaping/orphan paths and dead intent keys. |
...
- Feature file path: `05--skill-benchmark/021-d5-connectivity-gate.md`
Related references:

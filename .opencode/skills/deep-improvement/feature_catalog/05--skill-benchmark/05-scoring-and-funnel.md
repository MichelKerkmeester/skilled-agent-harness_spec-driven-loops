...
- D4 = always `{ score: null, unscored: 'requires skill-on/off ablation (live mode)' }`.
...
- Feature file path: `05--skill-benchmark/05-scoring-and-funnel.md`

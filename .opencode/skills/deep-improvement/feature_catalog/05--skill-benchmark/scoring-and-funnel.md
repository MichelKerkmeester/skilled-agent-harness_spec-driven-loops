...
| `.opencode/skills/deep-improvement/assets/skill_benchmark/default_profile.json` | Reference profile | Documents weights and verdict bands; reference only, not consumed at runtime per its own `notes`. |
...
- Feature file path: `05--skill-benchmark/scoring-and-funnel.md`
Related references:
- [d5-connectivity-gate.md](d5-connectivity-gate.md) — D5 structural connectivity hard gate
- [dual-report-and-remediation.md](dual-report-and-remediation.md) — Dual report and remediation taxonomy

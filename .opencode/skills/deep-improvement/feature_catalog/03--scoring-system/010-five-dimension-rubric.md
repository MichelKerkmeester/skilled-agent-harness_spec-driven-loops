...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-improvement/references/shared/quick_reference.md` | Operator reference | Restates the shipped dimension weights for the live release. |
| `.opencode/skills/deep-improvement/README.md` | Package reference | Mirrors the current recommendation threshold and weighted-score formula for operators. |
...
- Feature file path: `03--scoring-system/010-five-dimension-rubric.md`
Related references:

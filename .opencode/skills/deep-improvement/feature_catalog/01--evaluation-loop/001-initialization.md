...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-improvement/references/shared/loop_protocol.md` | Reference | Describes the initialization sequence and copied runtime artifacts. |
| `.opencode/skills/deep-improvement/references/shared/quick_reference.md` | Reference | Confirms the packet-local runtime layout and runtime file naming. |
...
- Feature file path: `01--evaluation-loop/001-initialization.md`
Related references:

...
- Feature file path: `01--evaluation-loop/004-promotion-gates.md`
Related references:
- [003-scoring-dispatch.md](003-scoring-dispatch.md) — Scoring dispatch
- [005-rollback.md](005-rollback.md) — Rollback

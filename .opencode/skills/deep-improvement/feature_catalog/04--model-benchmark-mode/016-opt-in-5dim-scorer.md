...
- Feature file path: `04--model-benchmark-mode/016-opt-in-5dim-scorer.md`
Related references:
- [015-model-dispatcher.md](015-model-dispatcher.md) — Model dispatcher
- [017-mode-records-and-gates.md](017-mode-records-and-gates.md) — Mode records and hardening gates

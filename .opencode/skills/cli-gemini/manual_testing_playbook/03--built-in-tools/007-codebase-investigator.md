...
3. Use `--include-directories .opencode/skills/cli-gemini` so Gemini does not waste context on the rest of the repo.
...
- Feature file path: `03--built-in-tools/007-codebase-investigator.md`

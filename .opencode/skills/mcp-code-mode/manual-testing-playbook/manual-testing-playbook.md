...
#### Test Execution
> **Feature File:** [CM-001](../manual-testing-playbook/core-tools/list-tools-enumeration.md)
...
#### Test Execution
> **Feature File:** [CM-002](../manual-testing-playbook/core-tools/search-tools-relevance.md)
...
#### Test Execution
> **Feature File:** [CM-003](../manual-testing-playbook/core-tools/tool-info-schema.md)
...
#### Test Execution
> **Feature File:** [CM-004](../manual-testing-playbook/core-tools/call-tool-chain-execution.md)
...
#### Test Execution
> **Feature File:** [CM-005](../manual-testing-playbook/manual-namespace-contract/correct-manual-tool-form.md)
...
#### Test Execution
> **Feature File:** [CM-006](../manual-testing-playbook/manual-namespace-contract/wrong-form-error.md)
...
#### Test Execution
> **Feature File:** [CM-007](../manual-testing-playbook/manual-namespace-contract/list-tools-dot-vs-underscore.md)
...
#### Test Execution
> **Feature File:** [CM-008](../manual-testing-playbook/env-var-prefixing/prefixed-env-load.md)
...
#### Test Execution
> **Feature File:** [CM-009](../manual-testing-playbook/env-var-prefixing/unprefixed-env-not-found.md)
...
#### Test Execution
> **Feature File:** [CM-010](../manual-testing-playbook/env-var-prefixing/validate-config-script.md)
...
#### Test Execution
> **Feature File:** [CM-011](../manual-testing-playbook/multi-tool-workflows/sequential-chain.md)
...
#### Test Execution
> **Feature File:** [CM-012](../manual-testing-playbook/multi-tool-workflows/promise-all-parallel.md)
...
#### Test Execution
> **Feature File:** [CM-013](../manual-testing-playbook/multi-tool-workflows/try-catch-error-path.md)
...
#### Test Execution
> **Feature File:** [CM-014](../manual-testing-playbook/clickup-and-chrome-via-cm/clickup-create-read-delete.md)
...
#### Test Execution
> **Feature File:** [CM-015](../manual-testing-playbook/clickup-and-chrome-via-cm/chrome-navigate-screenshot.md)
...
#### Test Execution
> **Feature File:** [CM-016](../manual-testing-playbook/clickup-and-chrome-via-cm/sibling-pair-handover.md)
...
#### Test Execution
> **Feature File:** [CM-017](../manual-testing-playbook/third-party-via-cm/figma-file-metadata.md)
...
#### Test Execution
> **Feature File:** [CM-018](../manual-testing-playbook/third-party-via-cm/myservice-list-sites.md)
...
#### Test Execution
> **Feature File:** [CM-019](../manual-testing-playbook/third-party-via-cm/github-list-user-repos.md)
...
#### Test Execution
> **Feature File:** [CM-020](../manual-testing-playbook/third-party-via-cm/notion-search-workspace.md)
...
#### Test Execution
> **Feature File:** [CM-021](../manual-testing-playbook/recovery-and-config/invalid-config-error.md)
...
#### Test Execution
> **Feature File:** [CM-022](../manual-testing-playbook/recovery-and-config/disabled-server-omitted.md)
...
#### Test Execution
> **Feature File:** [CM-023](../manual-testing-playbook/recovery-and-config/timeout-escalation.md)
...
#### Test Execution
> **Feature File:** [CM-024](../manual-testing-playbook/recovery-and-config/deregister-reregister-cycle.md)
...
#### Test Execution
> **Feature File:** [CM-025](../manual-testing-playbook/recovery-and-config/partial-chain-rollback.md)
...
#### Test Execution
> **Feature File:** [CM-026](../manual-testing-playbook/recovery-and-config/missing-manual-entry.md)
...
#### Test Execution
> **Feature File:** [mcp-route-guard](../manual-testing-playbook/plugins-and-hooks/mcp-route-guard.md)
...
| `.opencode/runtime-hooks/mcp-route-guard/lib/mcp-route-guard.test.cjs` | Shared route-guard core + Claude-hook unit assertions | mcp-route-guard |
...
- CM-001: [list_tools enumeration](../manual-testing-playbook/core-tools/list-tools-enumeration.md)
- CM-002: [search_tools relevance](../manual-testing-playbook/core-tools/search-tools-relevance.md)
- CM-003: [tool_info schema](../manual-testing-playbook/core-tools/tool-info-schema.md)
- CM-004: [call_tool_chain execution](../manual-testing-playbook/core-tools/call-tool-chain-execution.md)

### MANUAL NAMESPACE CONTRACT

- CM-005: [Correct manual.tool form](../manual-testing-playbook/manual-namespace-contract/correct-manual-tool-form.md)
- CM-006: [Wrong-form error](../manual-testing-playbook/manual-namespace-contract/wrong-form-error.md)
- CM-007: [list_tools dot vs underscore](../manual-testing-playbook/manual-namespace-contract/list-tools-dot-vs-underscore.md)

### ENV VAR PREFIXING

- CM-008: [Prefixed env load](../manual-testing-playbook/env-var-prefixing/prefixed-env-load.md)
- CM-009: [Unprefixed env not found](../manual-testing-playbook/env-var-prefixing/unprefixed-env-not-found.md)
- CM-010: [validate_config script](../manual-testing-playbook/env-var-prefixing/validate-config-script.md)

### MULTI-TOOL WORKFLOWS

- CM-011: [Sequential chain](../manual-testing-playbook/multi-tool-workflows/sequential-chain.md)
- CM-012: [Promise.all parallel](../manual-testing-playbook/multi-tool-workflows/promise-all-parallel.md)
- CM-013: [try/catch error path](../manual-testing-playbook/multi-tool-workflows/try-catch-error-path.md)

### CLICKUP AND CHROME VIA CM

- CM-014: [ClickUp create-read-delete](../manual-testing-playbook/clickup-and-chrome-via-cm/clickup-create-read-delete.md)
- CM-015: [Chrome navigate + screenshot](../manual-testing-playbook/clickup-and-chrome-via-cm/chrome-navigate-screenshot.md)
- CM-016: [Sibling-pair handover](../manual-testing-playbook/clickup-and-chrome-via-cm/sibling-pair-handover.md)

### THIRD-PARTY VIA CM

- CM-017: [Figma file metadata](../manual-testing-playbook/third-party-via-cm/figma-file-metadata.md)
- CM-018: [MyService list sites](../manual-testing-playbook/third-party-via-cm/myservice-list-sites.md)
- CM-019: [GitHub list user repos](../manual-testing-playbook/third-party-via-cm/github-list-user-repos.md)
- CM-020: [Notion search workspace](../manual-testing-playbook/third-party-via-cm/notion-search-workspace.md)

### RECOVERY AND CONFIG

- CM-021: [Invalid config error **(DESTRUCTIVE)**](../manual-testing-playbook/recovery-and-config/invalid-config-error.md)
- CM-022: [Disabled server omitted](../manual-testing-playbook/recovery-and-config/disabled-server-omitted.md)
- CM-023: [Timeout escalation](../manual-testing-playbook/recovery-and-config/timeout-escalation.md)
- CM-024: [Deregister/re-register cycle **(DESTRUCTIVE)**](../manual-testing-playbook/recovery-and-config/deregister-reregister-cycle.md)
- CM-025: [Partial-chain rollback](../manual-testing-playbook/recovery-and-config/partial-chain-rollback.md)
- CM-026: [Missing manual entry](../manual-testing-playbook/recovery-and-config/missing-manual-entry.md)

...
expected_leaf_resources:
  - workflow_mode: mcp-code-mode
    leaf_resource_id: references/naming-convention.md
---
...
- Prompt: `List my ClickUp workspaces using clickup.clickup_get_teams and report whether the canonical namespaced call succeeds.`
...
- Feature file path: `manual-namespace-contract/correct-manual-tool-form.md`

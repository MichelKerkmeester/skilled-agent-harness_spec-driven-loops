...
- Prompt: `Explain why a copied ClickUp tool name from list_tools fails, then verify the dot-to-underscore call form works.`
...
- Feature file path: `manual-namespace-contract/list-tools-dot-vs-underscore.md`

...
- Prompt: `Debug the failing clickup.get_teams call and confirm the error clearly names the wrong tool form.`
...
- Feature file path: `manual-namespace-contract/wrong-form-error.md`

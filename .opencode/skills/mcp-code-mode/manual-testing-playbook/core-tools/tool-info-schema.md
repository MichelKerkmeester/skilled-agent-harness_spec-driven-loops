...
- Prompt: `Show the schema for clickup.clickup_create_task and report whether required parameters and types are present.`
...
- Feature file path: `core-tools/tool-info-schema.md`

...
- Prompt: `Run a 7-second chain with a 5-second timeout and report whether it aborts on time.`
...
- Feature file path: `07--recovery-and-config/023-timeout-escalation.md`

...
- Prompt: `Call nonexistent.nonexistent_anything and report whether the error clearly names the missing manual.`
...
- Feature file path: `07--recovery-and-config/026-missing-manual-entry.md`

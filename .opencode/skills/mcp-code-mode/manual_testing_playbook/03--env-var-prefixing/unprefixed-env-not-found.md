...
- Prompt: `Check why CLICKUP_API_KEY alone is not picked up and confirm Code Mode reports the missing prefixed credential.`
...
- Feature file path: `03--env-var-prefixing/unprefixed-env-not-found.md`

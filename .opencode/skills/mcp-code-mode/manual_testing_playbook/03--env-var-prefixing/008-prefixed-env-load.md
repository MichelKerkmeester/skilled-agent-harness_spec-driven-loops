...
- Prompt: `Confirm clickup_CLICKUP_API_KEY authenticates ClickUp after restarting Code Mode and report the pass/fail reason.`
...
- Feature file path: `03--env-var-prefixing/008-prefixed-env-load.md`

...
- Prompt: `Fetch metadata for a public Figma file and report whether name, lastModified, and document tree are present.`
...
- Feature file path: `06--third-party-via-cm/017-figma-file-metadata.md`

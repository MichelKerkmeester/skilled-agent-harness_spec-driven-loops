...
- Prompt: `List my GitHub repos and report whether the response contains repo objects.`
...
| File | Role |
|---|---|
| `.opencode/skills/mcp-code-mode/SKILL.md` | GitHub MCP integration notes |
...
- Feature file path: `06--third-party-via-cm/019-github-list-user-repos.md`

...
- Prompt: `Open https://example.com in Chrome DevTools, take a screenshot, and report whether image bytes returned.`
...
- Feature file path: `05--clickup-and-chrome-via-cm/015-chrome-navigate-screenshot.md`

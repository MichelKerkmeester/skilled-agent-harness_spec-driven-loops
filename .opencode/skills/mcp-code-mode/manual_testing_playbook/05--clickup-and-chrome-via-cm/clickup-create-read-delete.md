...
- Prompt: `Create a throwaway ClickUp task, read it back, delete it, and report whether cleanup succeeded.`
...
- Feature file path: `05--clickup-and-chrome-via-cm/clickup-create-read-delete.md`

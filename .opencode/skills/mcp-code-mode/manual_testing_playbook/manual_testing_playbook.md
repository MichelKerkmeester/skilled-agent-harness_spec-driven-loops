...
#### Test Execution
> **Feature File:** [CM-005](02--manual-namespace-contract/005-correct-manual-tool-form.md)
...
#### Test Execution
> **Feature File:** [CM-006](02--manual-namespace-contract/006-wrong-form-error.md)
...
#### Test Execution
> **Feature File:** [CM-007](02--manual-namespace-contract/007-list-tools-dot-vs-underscore.md)
...
#### Test Execution
> **Feature File:** [CM-008](03--env-var-prefixing/008-prefixed-env-load.md)
...
#### Test Execution
> **Feature File:** [CM-009](03--env-var-prefixing/009-unprefixed-env-not-found.md)
...
#### Test Execution
> **Feature File:** [CM-010](03--env-var-prefixing/010-validate-config-script.md)
...
#### Test Execution
> **Feature File:** [CM-011](04--multi-tool-workflows/011-sequential-chain.md)
...
#### Test Execution
> **Feature File:** [CM-012](04--multi-tool-workflows/012-promise-all-parallel.md)
...
#### Test Execution
> **Feature File:** [CM-013](04--multi-tool-workflows/013-try-catch-error-path.md)
...
#### Test Execution
> **Feature File:** [CM-014](05--clickup-and-chrome-via-cm/014-clickup-create-read-delete.md)
...
#### Test Execution
> **Feature File:** [CM-015](05--clickup-and-chrome-via-cm/015-chrome-navigate-screenshot.md)
...
#### Test Execution
> **Feature File:** [CM-016](05--clickup-and-chrome-via-cm/016-sibling-pair-handover.md)
...
#### Test Execution
> **Feature File:** [CM-017](06--third-party-via-cm/017-figma-file-metadata.md)
...
#### Test Execution
> **Feature File:** [CM-018](06--third-party-via-cm/018-myservice-list-sites.md)
...
#### Test Execution
> **Feature File:** [CM-019](06--third-party-via-cm/019-github-list-user-repos.md)
...
#### Test Execution
> **Feature File:** [CM-020](06--third-party-via-cm/020-notion-search-workspace.md)
...
#### Test Execution
> **Feature File:** [CM-021](07--recovery-and-config/021-invalid-config-error.md)
...
#### Test Execution
> **Feature File:** [CM-022](07--recovery-and-config/022-disabled-server-omitted.md)
...
#### Test Execution
> **Feature File:** [CM-023](07--recovery-and-config/023-timeout-escalation.md)
...
#### Test Execution
> **Feature File:** [CM-024](07--recovery-and-config/024-deregister-reregister-cycle.md)
...
#### Test Execution
> **Feature File:** [CM-025](07--recovery-and-config/025-partial-chain-rollback.md)
...
#### Test Execution
> **Feature File:** [CM-026](07--recovery-and-config/026-missing-manual-entry.md)
...
- CM-005: [Correct manual.tool form](02--manual-namespace-contract/005-correct-manual-tool-form.md)
- CM-006: [Wrong-form error](02--manual-namespace-contract/006-wrong-form-error.md)
- CM-007: [list_tools dot vs underscore](02--manual-namespace-contract/007-list-tools-dot-vs-underscore.md)

### ENV VAR PREFIXING

- CM-008: [Prefixed env load](03--env-var-prefixing/008-prefixed-env-load.md)
- CM-009: [Unprefixed env not found](03--env-var-prefixing/009-unprefixed-env-not-found.md)
- CM-010: [validate_config script](03--env-var-prefixing/010-validate-config-script.md)

### MULTI-TOOL WORKFLOWS

- CM-011: [Sequential chain](04--multi-tool-workflows/011-sequential-chain.md)
- CM-012: [Promise.all parallel](04--multi-tool-workflows/012-promise-all-parallel.md)
- CM-013: [try/catch error path](04--multi-tool-workflows/013-try-catch-error-path.md)

### CLICKUP AND CHROME VIA CM

- CM-014: [ClickUp create-read-delete](05--clickup-and-chrome-via-cm/014-clickup-create-read-delete.md)
- CM-015: [Chrome navigate + screenshot](05--clickup-and-chrome-via-cm/015-chrome-navigate-screenshot.md)
- CM-016: [Sibling-pair handover](05--clickup-and-chrome-via-cm/016-sibling-pair-handover.md)

### THIRD-PARTY VIA CM

- CM-017: [Figma file metadata](06--third-party-via-cm/017-figma-file-metadata.md)
- CM-018: [MyService list sites](06--third-party-via-cm/018-myservice-list-sites.md)
- CM-019: [GitHub list user repos](06--third-party-via-cm/019-github-list-user-repos.md)
- CM-020: [Notion search workspace](06--third-party-via-cm/020-notion-search-workspace.md)

### RECOVERY AND CONFIG

- CM-021: [Invalid config error **(DESTRUCTIVE)**](07--recovery-and-config/021-invalid-config-error.md)
- CM-022: [Disabled server omitted](07--recovery-and-config/022-disabled-server-omitted.md)
- CM-023: [Timeout escalation](07--recovery-and-config/023-timeout-escalation.md)
- CM-024: [Deregister/re-register cycle **(DESTRUCTIVE)**](07--recovery-and-config/024-deregister-reregister-cycle.md)
- CM-025: [Partial-chain rollback](07--recovery-and-config/025-partial-chain-rollback.md)
- CM-026: [Missing manual entry](07--recovery-and-config/026-missing-manual-entry.md)

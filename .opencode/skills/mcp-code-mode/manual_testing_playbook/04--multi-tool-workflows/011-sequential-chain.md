...
- Prompt: `List spaces in my first ClickUp workspace and report whether both chained calls succeed.`
...
- Feature file path: `04--multi-tool-workflows/011-sequential-chain.md`

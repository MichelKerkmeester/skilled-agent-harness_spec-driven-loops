...
| File | Type | Role |
|---|---|---|
| `../../manual-testing-playbook/interaction/interaction-state-matrix.md` | Manual playbook | Interaction capture end-to-end scenario — confirms default-on capture folds interaction diffs into the tokens.json component variants the v3 writer turns into the Components interaction states |

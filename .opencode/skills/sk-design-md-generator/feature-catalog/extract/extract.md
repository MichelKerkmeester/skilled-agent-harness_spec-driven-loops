...
| File | Type | Role |
|---|---|---|
| `../../manual-testing-playbook/extract/live-extraction.md` | Manual playbook | Live extraction end-to-end scenario — confirms extract.ts produces a valid, non-empty tokens.json |
| `../../manual-testing-playbook/escalation/anti-bot-escalation.md` | Manual playbook | Anti-bot crawl escalation scenario — confirms blocked crawls never fabricate tokens |
...
Related references:
- [references/extraction-workflow.md](../../references/extraction-workflow.md) — the three-phase operational guide

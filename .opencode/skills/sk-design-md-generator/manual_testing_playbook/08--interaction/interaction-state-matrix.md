...
| `../../tool/scripts/validate.ts` | Style Reference validator -- `checkSectionCompleteness` requires the named v3 sections including `## Components`, where interaction states are characterized |
| `../../tool/resources/design_md_format_v3.md` | v3 Style Reference section specification -- §6 Components captures hover/focus states |

...
4. `npx ts-node .opencode/skills/sk-design-md-generator/backend/scripts/validate.ts /tmp/planted.md <--output>/tokens.json`  # -> exit non-zero or failures non-empty, at least one phantom-color finding for ff0000

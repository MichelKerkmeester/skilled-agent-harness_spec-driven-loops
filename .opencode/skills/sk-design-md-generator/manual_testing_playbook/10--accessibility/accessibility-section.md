...
1. `bash: ls <--output>/tokens.json <--output>/<style-reference>.md` (run from `tool/`)  # -> both files exist
...
| `../../tool/resources/design_md_format_v3.md` | v3 Style Reference section specification — §12 Agent Prompt Guide (where captured a11y data and flagged problems surface) |

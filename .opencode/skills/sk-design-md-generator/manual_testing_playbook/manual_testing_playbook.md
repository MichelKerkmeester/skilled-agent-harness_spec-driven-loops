...
| `tool/scripts/__tests__/validate.test.ts` | Hex-accuracy, v3 Style Reference section recognition, and Quick-Start fidelity validation | VALIDATE-001 |

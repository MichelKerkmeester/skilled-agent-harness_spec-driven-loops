...
- `tool/scripts/validate.ts` -- hex-accuracy checker, section-completeness checker, format-consistency checker, scoring engine
...
- Feature file: `04--validate/validate.md`

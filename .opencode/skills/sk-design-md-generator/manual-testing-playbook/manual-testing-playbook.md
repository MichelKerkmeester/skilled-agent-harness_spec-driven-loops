...
1. Working directory is the **repo root** (`pwd` shows the repository root). The embedded tool lives at `.opencode/skills/sk-design/sk-design-md-generator/backend/`; run the pipeline scripts (`extract.ts`, `validate.ts`, `report-gen.ts`, `preview-gen.ts`, `proof.ts`) from the repo root with the full script path, so a relative `--output` resolves outside the skill (the output guard refuses skill-internal paths). Run the one-time setup (`npm install`, `npx playwright install chromium`) and the `vitest` suite from the `backend/` directory.
...
> **Do-not-run note for this playbook author and executors:** Examples in this document that show command output are illustrative, so verify exact flags and output with `npx ts-node .opencode/skills/sk-design/sk-design-md-generator/backend/scripts/extract.ts --help` and `npx ts-node .opencode/skills/sk-design/sk-design-md-generator/backend/scripts/validate.ts --help` (from the repo root) on the live machine. Never fabricate tokens in any scenario; a fabricated token is a HARD FAIL.
...
|---|---|---|
| Extract (Phase 1) | `npx ts-node .opencode/skills/sk-design/sk-design-md-generator/backend/scripts/extract.ts <url> [flags]` | `npx ts-node .opencode/skills/sk-design/sk-design-md-generator/backend/scripts/extract.ts https://example.com --fast --output .opencode/specs/<track>/<packet>/output` |
| Validate (Phase 3) | `npx ts-node .opencode/skills/sk-design/sk-design-md-generator/backend/scripts/validate.ts <DESIGN.md> <tokens.json>` | `npx ts-node .opencode/skills/sk-design/sk-design-md-generator/backend/scripts/validate.ts DESIGN.md <--output>/tokens.json` |
...
2. Referenced per-scenario files under `manual-testing-playbook/NN__category_name/`
...
> **Feature File:** [fidelity/verbatim-value-fidelity.md](fidelity/verbatim-value-fidelity.md)
...
> **Feature File:** [dark-mode/dark-mode-gate.md](dark-mode/dark-mode-gate.md)
...
- Expected execution process: confirm Node 20+; run `cd backend && npm install` and verify zero errors; run `cd backend && npx playwright install chromium` and verify it completes; smoke-test with `npx ts-node .opencode/skills/sk-design/sk-design-md-generator/backend/scripts/extract.ts --help` to confirm the CLI parses; attempt `npx ts-node .opencode/skills/sk-design/sk-design-md-generator/backend/scripts/extract.ts https://example.com --fast --output .opencode/specs/<track>/<packet>/output` and confirm it runs (or fails with a clear crawl error, not a missing-binary crash)
...
> **Feature File:** [interaction/interaction-state-matrix.md](interaction/interaction-state-matrix.md)
...
> **Feature File:** [cluster/oklch-clustering.md](cluster/oklch-clustering.md)
...
> **Feature File:** [authoring-boundary/authoring-boundary.md](authoring-boundary/authoring-boundary.md)
...
> **Feature File:** [GUIDED-014](guided-run/guided-run-smoke-lane.md)
...
> **Feature File:** [STUDY-015](study/editorial-exemplar-study.md)
...
> **Feature File:** [PROCCARD-001](procedure-card-contract/card-selection-proof.md)

### PROCCARD-002 | md-generator no-card fallback

> **Feature File:** [PROCCARD-002](procedure-card-contract/no-card-fallback.md)

### PROCCARD-003 | md-generator backend-preserving direct fallback

> **Feature File:** [PROCCARD-003](procedure-card-contract/backend-preserving-direct-fallback.md)
...
|---|---|---|---|---|
| EXTRACT-001 | Live extraction produces valid tokens.json | Extract | [extract/live-extraction.md](extract/live-extraction.md) | [../feature-catalog/extract/extract.md](../feature-catalog/extract/extract.md) |
| VALIDATE-001 | Validator passes on faithful DESIGN.md and flags phantom hexes | Validate | [validate/phantom-hex-detection.md](validate/phantom-hex-detection.md) | [../feature-catalog/validate/validate.md](../feature-catalog/validate/validate.md) |
| FIDELITY-001 | Cardinal verbatim-value rule enforced | Fidelity | [fidelity/verbatim-value-fidelity.md](fidelity/verbatim-value-fidelity.md) | [../feature-catalog/write-design-md/write-design-md.md](../feature-catalog/write-design-md/write-design-md.md) |
| DARKMODE-001 | Dark-mode section appears only when detected | Dark Mode | [dark-mode/dark-mode-gate.md](dark-mode/dark-mode-gate.md) | [../feature-catalog/feature-extractors/feature-extractors.md](../feature-catalog/feature-extractors/feature-extractors.md) |
| SETUP-001 | Tool readiness from a fresh checkout | Setup | [setup/tool-readiness.md](setup/tool-readiness.md) | [../feature-catalog/extract/extract.md](../feature-catalog/extract/extract.md) |
| ESCALATE-001 | Anti-bot site causes clear escalation, never fabricates tokens | Escalation | [escalation/anti-bot-escalation.md](escalation/anti-bot-escalation.md) | [../feature-catalog/extract/extract.md](../feature-catalog/extract/extract.md) |
| REPORT-001 | Report And Preview Generation | Report | [report/report-generation.md](report/report-generation.md) | [../feature-catalog/report-preview/report-preview.md](../feature-catalog/report-preview/report-preview.md) |
| INTERACT-001 | Interaction Capture And State Matrix | Interaction | [interaction/interaction-state-matrix.md](interaction/interaction-state-matrix.md) | [../feature-catalog/interaction-capture/interaction-capture.md](../feature-catalog/interaction-capture/interaction-capture.md) |
| CLUSTER-001 | OKLCH Clustering And Stability Classification | Cluster | [cluster/oklch-clustering.md](cluster/oklch-clustering.md) | [../feature-catalog/cluster-classify/cluster-classify.md](../feature-catalog/cluster-classify/cluster-classify.md) |
| A11Y-001 | Accessibility Section Fidelity | Accessibility | [accessibility/accessibility-section.md](accessibility/accessibility-section.md) | [../feature-catalog/feature-extractors/feature-extractors.md](../feature-catalog/feature-extractors/feature-extractors.md) |
| DETECT-001 | Framework, Icon, And Motion Detection | Detectors | [detectors/framework-icon-motion-detection.md](detectors/framework-icon-motion-detection.md) | [../feature-catalog/feature-extractors/feature-extractors.md](../feature-catalog/feature-extractors/feature-extractors.md) |
| BOUNDARY-001 | Authoring boundary sorts values by origin | Authoring Boundary | [authoring-boundary/authoring-boundary.md](authoring-boundary/authoring-boundary.md) | [../feature-catalog/write-design-md/write-design-md.md](../feature-catalog/write-design-md/write-design-md.md) |
| PROVENANCE-001 | Source-of-truth router card sorts each value | Source-of-Truth | [source-of-truth/source-of-truth-card.md](source-of-truth/source-of-truth-card.md) | [../feature-catalog/write-design-md/write-design-md.md](../feature-catalog/write-design-md/write-design-md.md) |
| GUIDED-014 | Guided wrapper smoke lane | Guided Run | [guided-run/guided-run-smoke-lane.md](guided-run/guided-run-smoke-lane.md) | N/A |
| STUDY-015 | Editorial or ecommerce exemplar study | Study | [study/editorial-exemplar-study.md](study/editorial-exemplar-study.md) | N/A |
| PROCCARD-001 | md-generator procedure-card selection proof | Procedure Card Contract | [procedure-card-contract/card-selection-proof.md](procedure-card-contract/card-selection-proof.md) | N/A |

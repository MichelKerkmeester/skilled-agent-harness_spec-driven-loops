---
title: "Working With Embedded Browsers"
description: "Keep a MagicPath project open as a persistent canvas in agent hosts with an embedded browser, such as Codex or Cursor."
trigger_phrases:
  - "magicpath embedded browser"
  - "magicpath project canvas"
  - "open project in browser pane"
  - "codex cursor magicpath canvas"
  - "share project url"
...
### Core Principle
Keep the MagicPath project canvas open beside the agent; never auto-navigate to an individual design.

### When to Use
- The agent host (Codex, some Cursor flows) exposes an embedded browser, pane, or webview.
- You created or reconnected to a project and want the user to watch work appear on the canvas.

### Key Sources
- [magicpath_operations.md](magicpath_operations.md) — when and how the canvas fits the workflow.
...
## 3. WHEN TO USE THE EMBEDDED PROJECT CANVAS
...
## 4. DO NOT NAVIGATE TO INDIVIDUAL DESIGNS BY DEFAULT
...
## 5. RESOLVE A PROJECT URL WITHOUT OPENING AN EXTERNAL BROWSER
...
## 6. BROWSER SIGN-IN IS SEPARATE FROM CLI SIGN-IN
...
## 8. KEEP BROWSER NAVIGATION QUIET WHEN

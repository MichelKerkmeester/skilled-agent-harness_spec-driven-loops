...
1. `bash: grep -n "if_absent\|skip_when\|resolveArtifactRoot" .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml | head -20`
...
5. Repeat for `deep_start-research-loop_confirm.yaml`.
...
| File | Role |
|---|---|
| `.opencode/commands/deep/assets/deep_start-research-loop_auto.yaml` | `step_resolve_artifact_root` if_absent branch, `step_fanout_spawn` skip_when, `step_fanout_merge` skip_when |
| `.opencode/commands/deep/assets/deep_start-research-loop_confirm.yaml` | Same (confirm variant) |
...
- Scenario file path: `manual_testing_playbook/08--fanout/054-fanout-single-executor-parity-research.md`

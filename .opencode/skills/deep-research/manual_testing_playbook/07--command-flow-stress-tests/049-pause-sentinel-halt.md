...
| File | Anchor |
|---|---|
| `.opencode/commands/spec_kit/deep-research.md:176-185` | command output contract names research packet state |
| `.opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:400-408` | pause sentinel check |
| `.opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:513-521` | stop reason normalization |
| `.opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:179-195` | lock cleanup applies to halt paths |

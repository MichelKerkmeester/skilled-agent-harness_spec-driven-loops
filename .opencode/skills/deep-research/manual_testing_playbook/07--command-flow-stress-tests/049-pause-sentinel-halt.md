...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/deep-research/manual_testing_playbook/07--command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-049-sandbox
...
In /tmp/cp-049-sandbox/, run /deep:start-research-loop:auto while /tmp/cp-049-spec/research/.deep-research-pause exists.
...
| File | Anchor |
|---|---|
| `.opencode/commands/deep/start-research-loop.md:176-185` | command output contract names research packet state |
| `.opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:400-408` | pause sentinel check |
| `.opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:513-521` | stop reason normalization |
| `.opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:179-195` | lock cleanup applies to halt paths |
| `.opencode/skills/deep-research/SKILL.md:287-309` | packet-local state location and sentinel |

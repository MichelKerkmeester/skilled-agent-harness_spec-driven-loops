...
2. `bash: rg -n 'step_read_state|current_iteration|next_focus' .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml .opencode/commands/spec_kit/assets/spec_kit_deep-research_confirm.yaml`
...
| `.opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml` | Loop state extraction; inspect `step_read_state` |
| `.opencode/commands/spec_kit/assets/spec_kit_deep-research_confirm.yaml` | Loop state extraction; inspect `step_read_state` |

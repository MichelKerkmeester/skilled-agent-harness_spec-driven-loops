...
- Primary sources: `.opencode/skills/system-spec-kit/scripts/resource-map/extract-from-evidence.cjs`, `.opencode/skills/deep-research/scripts/reduce-state.cjs`, `.opencode/commands/deep/assets/deep_start-research-loop_auto.yaml`, `.opencode/commands/deep/assets/deep_start-research-loop_confirm.yaml`
Related references:
- [005-memory-save.md](005-memory-save.md) — Memory save
- [007-fanout-dispatch.md](007-fanout-dispatch.md) — Fan-out loop dispatch

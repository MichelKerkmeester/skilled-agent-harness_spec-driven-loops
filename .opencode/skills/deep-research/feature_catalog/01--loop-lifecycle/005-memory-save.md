...
| `.opencode/skills/deep-research/references/protocol/loop_protocol.md` | Reference | Defines the save phase and its verification step. |
...
- Feature file path: `01--loop-lifecycle/005-memory-save.md`
Related references:

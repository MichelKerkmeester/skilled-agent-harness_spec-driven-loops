...
- Feature file path: `02--state-management/009-strategy-tracking.md`
Related references:
- [008-jsonl-state-log.md](008-jsonl-state-log.md) — JSONL state log
- [010-config-management.md](010-config-management.md) — Config management

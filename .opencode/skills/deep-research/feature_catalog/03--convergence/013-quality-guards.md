...
- Feature file path: `03--convergence/013-quality-guards.md`
Related references:
- [012-stuck-detection.md](012-stuck-detection.md) — Stuck detection
- [014-graph-convergence.md](014-graph-convergence.md) — Graph convergence

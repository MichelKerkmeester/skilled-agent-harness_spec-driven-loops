...
Signal rules live in `convergence_signals.md`.
...
Graph convergence event shape lives in `convergence_graph.md`.

---

## 8. NORMALIZATION

Emission-time normalization maps legacy labels into canonical `stopReason` values before persistence. The mapping lives in `convergence.md`.

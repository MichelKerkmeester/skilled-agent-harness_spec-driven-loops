...
> **Runtime capability matrix:** `.opencode/skills/deep-research/references/capability_matrix.md` and `.opencode/skills/deep-research/assets/runtime_capabilities.json`

...
`graphEvents` are documented in `state_jsonl.md`. Reducer-owned graph summaries are documented in `state_reducer_registry.md`.
...
Event fields and namespace rules live in `state_jsonl.md`.

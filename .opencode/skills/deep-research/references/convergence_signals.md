...
Every iteration record should include `newInfoRatio` and `noveltyJustification`; see `state_jsonl.md`.
...
Dashboard and registry fields derived from these signals are documented in `state_reducer_registry.md`.

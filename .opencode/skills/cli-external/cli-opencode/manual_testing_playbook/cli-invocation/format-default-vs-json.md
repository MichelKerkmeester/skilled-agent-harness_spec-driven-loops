...
- Prompt: `Run the same short prompt with default and JSON output, verify JSON parses with expected event fields, and report the event types.`
...
- Feature file path: `cli-invocation/format-default-vs-json.md`

...
# Design Foundations (sk-design-foundations)

`sk-design-foundations` owns the static visual system of the `sk-design` family: color, type, spacing, layout, hierarchy, grids, responsive adaptation, theming, and token vocabulary. It turns a visual direction into a coherent system, or audits a system proposal before implementation.

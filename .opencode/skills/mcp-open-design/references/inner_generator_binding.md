...
| Dependency | Boundary |
|---|---|
| [`DESIGN_PROOF_TOKEN`](../../sk-design/references/design_proof_token.md) | Defines token schema, payload digest fields, freshness, replay, surface binding, validator behavior, and §4 digest canonicalization. This document cites that contract and does not redefine token internals. |
...
Canonicalization is inherited by reference from [`DESIGN_PROOF_TOKEN` §4](../../sk-design/references/design_proof_token.md#4-digest-canonicalization):

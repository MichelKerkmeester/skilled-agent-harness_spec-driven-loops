...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/04--failure-paths/daemon-not-running.md` | Manual playbook | The daemon-not-running and app-closed failure path |
...
- Feature file path: `05--transport/daemon-and-verification.md`

Related references:
- [od-mcp-install.md](../01--wiring/od-mcp-install.md) covers the wiring that points at this daemon socket
- [headless-runs.md](../04--runs/headless-runs.md) covers gating the mutating verbs this verification surfaces

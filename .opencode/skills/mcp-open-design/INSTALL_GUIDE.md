...
Design judgment stays with `sk-interface-design`: this skill owns the transport, that skill owns the taste. The two share the reuse-before-generate parity loop in `../sk-interface-design/references/claude_design_parity.md`.
...
- [`../sk-interface-design/references/claude_design_parity.md`](../sk-interface-design/references/claude_design_parity.md) - the shared reuse-before-generate parity loop.

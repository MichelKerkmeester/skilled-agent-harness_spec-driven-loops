...
| `../../feature_catalog/05--transport/daemon-and-verification.md` | Feature-catalog source describing the daemon model |
...
- Feature file path: `04--failure-paths/daemon-not-running.md`

...
| `<packet-root>` | `{spec_folder}` resolved by the command | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/_055-cli-devin-deep-loop-alignment` |
...
```bash
REPO_ROOT="/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public"
PACKET_ROOT=".opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/_055-cli-devin-deep-loop-alignment"

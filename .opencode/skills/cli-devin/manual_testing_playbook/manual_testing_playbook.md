...
> **Feature File:** [DV-001](01--cli-invocation/default-dispatch.md)
...
> **Feature File:** [DV-002](01--cli-invocation/prompt-file-vs-positional.md)
...
> **Feature File:** [DV-003](01--cli-invocation/stdin-redirect-dev-null.md)
...
> **Feature File:** [DV-004](01--cli-invocation/auth-preflight.md)
...
> **Feature File:** [DV-005](02--permission-modes/auto-mode.md)
...
> **Feature File:** [DV-006](02--permission-modes/dangerous-mode.md)
...
> **Feature File:** [DV-007](02--permission-modes/sandbox-flag.md)
...
> **Feature File:** [DV-008](03--model-presets/swe-1-6-default.md)
...
> **Feature File:** [DV-010](03--model-presets/glm-5-1-complex-fallback.md)
...
> **Feature File:** [DV-026](03--model-presets/kimi-k2-6-complex-fallback.md)
...
> **Feature File:** [DV-028](03--model-presets/swe16-via-sk-prompt-small-model-and-sk-prompt.md)
...
> **Feature File:** [DV-029](03--model-presets/deepseek-v4-via-sk-prompt-small-model-and-sk-prompt.md)
...
> **Feature File:** [DV-011](04--devin-surfaces/devin-rules-list.md)
...
> **Feature File:** [DV-012](04--devin-surfaces/devin-skills-show.md)
...
> **Feature File:** [DV-013](04--devin-surfaces/devin-mcp-lifecycle.md)
...
> **Feature File:** [DV-014](05--session-continuity/continue-last-session.md)
...
> **Feature File:** [DV-015](05--session-continuity/resume-by-session-id.md)
...
> **Feature File:** [DV-016](05--session-continuity/devin-list.md)
...
> **Feature File:** [DV-017](06--cloud-handoff/five-check-gate-negative.md)
...
> **Feature File:** [DV-018](06--cloud-handoff/cloud-handoff-roundtrip.md)
...
> **Feature File:** [DV-019](07--self-invocation-guard/self-invocation-refused.md)
...
> **Feature File:** [DV-020](07--self-invocation-guard/cloud-handoff-exception.md)
...
> **Feature File:** [DV-021](08--cross-ai-dispatch/from-cli-codex.md)
...
> **Feature File:** [DV-022](08--cross-ai-dispatch/from-cli-claude-code.md)
...
> **Feature File:** [DV-023](08--cross-ai-dispatch/from-cli-opencode.md)
...
> **Feature File:** [DV-025](09--acp-bridge/devin-acp-server.md)
...
- DV-001: [Default dispatch (swe-1.6 normal)](01--cli-invocation/default-dispatch.md)
- DV-002: [prompt-file vs positional prompt](01--cli-invocation/prompt-file-vs-positional.md)
- DV-003: [stdin redirect `</dev/null`](01--cli-invocation/stdin-redirect-dev-null.md)
- DV-004: [Auth pre-flight (`devin auth status`)](01--cli-invocation/auth-preflight.md)

### PERMISSION MODES

- DV-005: [auto mode (default — auto-approves read-only, prompts on write/exec)](02--permission-modes/auto-mode.md)
- DV-006: [dangerous mode (operator-approved)](02--permission-modes/dangerous-mode.md)
- DV-007: [`--sandbox` flag (OS-level process sandboxing, Research Preview)](02--permission-modes/sandbox-flag.md)
...
- DV-011: [`devin rules list`](04--devin-surfaces/devin-rules-list.md)
- DV-012: [`devin skills list` / `devin skills show`](04--devin-surfaces/devin-skills-show.md)
- DV-013: [`devin mcp` lifecycle](04--devin-surfaces/devin-mcp-lifecycle.md)

### SESSION CONTINUITY

- DV-014: [`devin --continue` (resume last)](05--session-continuity/continue-last-session.md)
- DV-015: [`devin --resume <id>` (specific session)](05--session-continuity/resume-by-session-id.md)
- DV-016: [`devin list` (session inventory)](05--session-continuity/devin-list.md)

### CLOUD HANDOFF

- DV-017: [5-check operator-confirmation gate (NEGATIVE)](06--cloud-handoff/five-check-gate-negative.md)
- DV-018: [Cloud handoff round-trip (LIVE — operator-driven manual)](06--cloud-handoff/cloud-handoff-roundtrip.md)
- DV-027: [Cloud surface accessibility (shell-runnable surface check)](06--cloud-handoff/cloud-surface-accessibility.md)

### SELF-INVOCATION GUARD

- DV-019: [Self-invocation refused (DEVIN_* env or ancestry)](07--self-invocation-guard/self-invocation-refused.md)
- DV-020: [Cloud-handoff exception allowed (explicit keywords)](07--self-invocation-guard/cloud-handoff-exception.md)

### CROSS-AI DISPATCH

- DV-021: [Dispatch from cli-codex (gpt-5.5 medium)](08--cross-ai-dispatch/from-cli-codex.md)
- DV-022: [Dispatch from cli-claude-code](08--cross-ai-dispatch/from-cli-claude-code.md)
- DV-023: [Dispatch from cli-opencode](08--cross-ai-dispatch/from-cli-opencode.md)

### ACP BRIDGE

- DV-025: [`devin acp` server lifecycle](09--acp-bridge/devin-acp-server.md)

...
//
// Usage:
//   node .opencode/skills/sk-code/webflow/assets/scripts/minify-webflow.mjs          # Normal run (skip unchanged)
//   node .opencode/skills/sk-code/webflow/assets/scripts/minify-webflow.mjs --force  # Force re-minify all
//

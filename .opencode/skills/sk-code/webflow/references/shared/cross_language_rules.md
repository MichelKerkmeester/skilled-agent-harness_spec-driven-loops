...
> **Cross-stack motion.dev reference**: For Motion API assumptions and integration modes that can inform `MOTION:` comments across stacks, see [`../../motion_dev/quick_start.md`](../../../animation/references/quick_start.md) and [`../../motion_dev/integration_patterns.md`](../../../animation/references/integration_patterns.md). Webflow comment and naming conventions remain defined in this style guide.

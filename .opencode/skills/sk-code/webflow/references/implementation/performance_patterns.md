...
> **Cross-stack motion.dev reference**: For Motion-specific performance pitfalls, reduced-motion handling, and CSS/Motion/GSAP trade-offs outside Webflow, see [`../../motion_dev/performance_and_pitfalls.md`](../../../animation/references/performance_and_pitfalls.md) and [`../../motion_dev/decision_matrix.md`](../../../animation/references/decision_matrix.md). This Webflow performance guide remains authoritative for Webflow deployment and CWV evidence.
...
### Cross-stack
- [`../../motion_dev/performance_and_pitfalls.md`](../../../animation/references/performance_and_pitfalls.md) — Motion.dev performance and pitfalls (will-change cleanup, GPU acceleration, frame-rate gotchas)

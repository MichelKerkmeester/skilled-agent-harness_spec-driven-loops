...
> **Cross-stack motion.dev reference**: The full Motion.dev knowledge base lives at [`../../motion_dev/`](../../../animation/references/). Load by topic:
>
> - [`quick_start.md`](../../../animation/references/quick_start.md) — install modes, API availability, first-call patterns
> - [`animation_principles.md`](../../../animation/references/animation_principles.md) — timing, easing, stagger direction, anticipation, arc, and depth vocabulary
> - [`decision_matrix.md`](../../../animation/references/decision_matrix.md) — when to use Motion.dev vs CSS vs `requestAnimationFrame`
> - [`integration_patterns.md`](../../../animation/references/integration_patterns.md) — non-Webflow integration patterns and module loading
> - [`animate_and_timelines.md`](../../../animation/references/animate_and_timelines.md) — `animate()` API surface, keyframe shapes, easing
> - [`scroll_and_gestures.md`](../../../animation/references/scroll_and_gestures.md) — `scroll()`, `inView()`, gesture-driven animation
> - [`performance_and_pitfalls.md`](../../../animation/references/performance_and_pitfalls.md) — `will-change` cleanup, GPU acceleration, frame-rate gotchas
>

...
> **Cross-stack motion.dev reference**: For Motion API and integration guidance that is not Webflow-specific, see [`../../motion_dev/quick_start.md`](../../../animation/references/quick_start.md) and [`../../motion_dev/integration_patterns.md`](../../../animation/references/integration_patterns.md). Webflow lifecycle, CDN timing, and Designer constraints remain covered by the Webflow implementation guides linked here.

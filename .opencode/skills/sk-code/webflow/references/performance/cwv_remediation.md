...
> **Cross-stack motion.dev reference**: For Motion performance and fallback guidance that applies beyond this Webflow CWV timeout pattern, see [`../../motion_dev/performance_and_pitfalls.md`](../../../animation/references/performance_and_pitfalls.md). The timeout hierarchy here remains the Webflow-specific CWV remediation contract.

...
□ AST verification passed (node .opencode/skills/sk-code/webflow/assets/scripts/verify-minification.mjs)
□ Runtime test passed (node .opencode/skills/sk-code/webflow/assets/scripts/test-minified-runtime.mjs)
...
3. Verify       → node .opencode/skills/sk-code/webflow/assets/scripts/verify-minification.mjs
4. Test         → node .opencode/skills/sk-code/webflow/assets/scripts/test-minified-runtime.mjs

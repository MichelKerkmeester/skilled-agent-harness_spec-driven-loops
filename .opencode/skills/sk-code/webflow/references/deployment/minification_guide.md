...
> **Cross-stack motion.dev reference**: For Motion API import modes and integration trade-offs that apply outside Webflow minification, see [`../../motion_dev/quick_start.md`](../../../animation/references/quick_start.md) and [`../../motion_dev/integration_patterns.md`](../../../animation/references/integration_patterns.md). The Webflow guidance below remains authoritative for CDN globals that minification must preserve.
...
```bash
node .opencode/skills/sk-code/webflow/assets/scripts/minify-webflow.mjs
```

### Step 2: AST Verification

```bash
node .opencode/skills/sk-code/webflow/assets/scripts/verify-minification.mjs
```
...
```bash
node .opencode/skills/sk-code/webflow/assets/scripts/test-minified-runtime.mjs
```
...
**Location:** `.opencode/skills/sk-code/webflow/assets/scripts/verify-minification.mjs`
...
**Location:** `.opencode/skills/sk-code/webflow/assets/scripts/test-minified-runtime.mjs`
...
**Location:** `.opencode/skills/sk-code/webflow/assets/scripts/minify-webflow.mjs`
...
node .opencode/skills/sk-code/webflow/assets/scripts/minify-webflow.mjs --force
```
...
- `.opencode/skills/sk-code/webflow/assets/scripts/minify-webflow.mjs` - Batch minification
- `.opencode/skills/sk-code/webflow/assets/scripts/verify-minification.mjs` - AST verification
- `.opencode/skills/sk-code/webflow/assets/scripts/test-minified-runtime.mjs` - Runtime testing

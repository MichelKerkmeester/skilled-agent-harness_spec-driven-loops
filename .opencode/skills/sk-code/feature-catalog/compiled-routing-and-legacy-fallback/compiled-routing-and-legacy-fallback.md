...
| `.opencode/bin/lib/compiled-routing/010-live-activation/activation/sk-code/manifest.json` | Shared | `sk-code`'s promoted activation manifest (serving authority, shadow status, selected policy). |

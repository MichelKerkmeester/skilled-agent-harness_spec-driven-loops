...
> Motion.dev API surface and full reference docs are documented in [../references/motion_dev/](../code-implement/references/motion_dev) (populated in Packet 2 of this rework). The scenarios below test motion.dev integration points; consult the canonical motion.dev docs for full API details.

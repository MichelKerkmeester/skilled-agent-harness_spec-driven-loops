...
- `.opencode/skills/sk-code/references/motion_dev/decision_matrix.md` - Required decision reference.
- `.opencode/skills/sk-code/references/motion_dev/performance_and_pitfalls.md` - Performance and reduced-motion caveats.
- `.opencode/skills/sk-code/assets/motion_dev/snippets/hover_gesture.js` - Hover example when Motion.dev is justified.

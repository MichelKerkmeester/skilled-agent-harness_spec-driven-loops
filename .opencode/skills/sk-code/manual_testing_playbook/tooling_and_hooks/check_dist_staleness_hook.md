...
1. **Make the target package's dist stale** (reversible — see `manual_testing_playbook/tooling_and_scripts/cli_dist_freshness_guard.md` in the system-spec-kit skill for the same recipe used against the identical package):
   ```bash

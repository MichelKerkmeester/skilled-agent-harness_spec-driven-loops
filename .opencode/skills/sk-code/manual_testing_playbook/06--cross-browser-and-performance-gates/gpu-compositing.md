...
| `../../code-webflow/references/animation/performance_and_pitfalls.md` | Local compositor-friendly animation guidance |
| `../../code-webflow/references/animation/animate_and_timelines.md` | Local transform/opacity animation reference |

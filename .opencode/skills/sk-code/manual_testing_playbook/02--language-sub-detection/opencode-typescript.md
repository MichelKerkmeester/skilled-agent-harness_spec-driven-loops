...
2. TypeScript sub-language reference set intact: `bash: ls .opencode/skills/sk-code/code-opencode/references/typescript/ | sort` returns exactly `quality_standards.md style_guide.md quick_reference.md` (in some sort order).

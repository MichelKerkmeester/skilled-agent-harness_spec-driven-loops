...
- [review_mode_contract.yaml](../../../system-deep-loop/deep-review/assets/review_mode_contract.yaml) - Canonical review-mode contract manifest (source of truth for deep review taxonomy)

...
| File | Role |
|---|---|
| `../../assets/code-quality-checklist.md` | Section 6 reinvent-the-wheel maintainability rows and recommended-fix wording |
...
- Feature file path: `efficiency-and-restraint/reinvent-the-wheel-detection.md`

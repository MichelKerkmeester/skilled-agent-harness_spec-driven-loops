...
- [shared/cross_language_rules.md](../../shared/references/webflow-shared/cross_language_rules.md) - Cross-language rules (file naming, comment WHY-not-WHAT, banner format, platform prefixes)
- [javascript/style_guide.md](../../code-implement/references/webflow/javascript/style_guide.md) - JS naming (`snake_case`), file structure, formatting, JSDoc, debug logging
- [javascript/quality_standards.md](../../code-implement/references/webflow/javascript/quality_standards.md) - JS defensive patterns + JS naming/init enforcement
- [css/style_guide.md](../../code-implement/references/webflow/css/style_guide.md) - CSS naming (BEM), custom properties, attribute selectors, animation CSS, file org
- [css/quality_standards.md](../../code-implement/references/webflow/css/quality_standards.md) - CSS quality patterns + CSS enforcement subsections
...
**Reference:** [code_style_guide.md Section 3](../../code-implement/references/webflow/javascript/style_guide.md)
...
- [ ] **[P1] CHK-CMT-01**: No ephemeral artifact ids in any comment (ticket/ClickUp ids, spec/phase/packet numbers, ADR ids) — keep the WHY; see [references/universal/code_style_guide.md](../../shared/references/universal/code_style_guide.md) §4
...
**Reference:** [code_style_guide.md Section 5](../../code-implement/references/webflow/javascript/style_guide.md)
...
> **Cross-stack motion.dev reference**: For motion.dev API surface, decision matrix, and integration patterns that apply across stacks (not just Webflow), see [`../../../references/motion_dev/quick_start.md`](../../code-implement/references/motion_dev/quick_start.md) and the documents in [`references/motion_dev/`](../../code-implement/references/motion_dev). The MOTION constraint above remains a Webflow-CDN-specific platform marker.
...
**Reference:** [code_style_guide.md Section 2](../../code-implement/references/webflow/javascript/style_guide.md)
...
**Reference:** [code_quality_standards.md Section 2](../../code-implement/references/webflow/javascript/quality_standards.md)
...
**Reference:** [code_style_guide.md Section 4](../../code-implement/references/webflow/javascript/style_guide.md)
...
**Reference:** [css/style_guide.md](../../code-implement/references/webflow/css/style_guide.md) — full CSS conventions (BEM naming, custom property prefixes, attribute selectors, animation CSS, file organization)
...
- [shared/cross_language_rules.md](../../shared/references/webflow-shared/cross_language_rules.md) - File naming, comment principles, file-header banner, platform prefixes
- [javascript/style_guide.md](../../code-implement/references/webflow/javascript/style_guide.md) - JS naming + file structure + formatting + JSDoc
- [javascript/quality_standards.md](../../code-implement/references/webflow/javascript/quality_standards.md) - JS defensive patterns + naming/init enforcement
- [css/style_guide.md](../../code-implement/references/webflow/css/style_guide.md) - CSS naming + custom properties + animation CSS
- [css/quality_standards.md](../../code-implement/references/webflow/css/quality_standards.md) - CSS quality patterns + enforcement subsections

### Enforcement Reference

- [code_style_enforcement.md](../../shared/references/webflow-shared/enforcement.md) - Validation prompts, examples, remediation

...
For formal findings-first review output, use `sk-code`'s code-review mode as the baseline and treat this file as TypeScript surface evidence.

```markdown
## TypeScript Standards Surface Evidence
...
### Style Guide
- [TypeScript Style Guide](../../../code-implement/references/opencode/typescript/style_guide.md)
- [TypeScript Quality Standards](../../../code-implement/references/opencode/typescript/quality_standards.md)

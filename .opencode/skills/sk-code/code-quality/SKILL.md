...
QUALITY TASK
    ...
    +- OPENCODE target    -> assets/opencode-checklists/<target-checklist>.md
...
- `assets/opencode-checklists/` contains OpenCode authoring checklists for skills, agents, commands, MCP servers, spec folders, language files, and config.
...
- The correct `assets/opencode-checklists/*` authoring checklist was loaded for OpenCode targets.
...
- [`assets/opencode-checklists/universal_checklist.md`](assets/opencode-checklists/universal_checklist.md) - Universal OpenCode quality baseline.
...
- [`assets/opencode-checklists/python_checklist.md`](assets/opencode-checklists/python_checklist.md) - Python checklist.
- [`assets/opencode-checklists/shell_checklist.md`](assets/opencode-checklists/shell_checklist.md) - Shell checklist.
- [`assets/opencode-checklists/config_checklist.md`](assets/opencode-checklists/config_checklist.md) - JSON and JSONC config checklist.

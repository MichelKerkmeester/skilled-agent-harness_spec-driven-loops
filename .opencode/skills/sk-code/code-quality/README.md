...
**Step 2: Load the right checklist.** The mode always loads [`assets/code_quality_checklist.md`](./assets/code_quality_checklist.md). For `.opencode/` targets, it also loads the matching checklist under [`assets/opencode-checklists/`](./assets/opencode-checklists/).
...
| [`assets/opencode-checklists/`](./assets/opencode-checklists/) | Target-path OpenCode authoring checklists |

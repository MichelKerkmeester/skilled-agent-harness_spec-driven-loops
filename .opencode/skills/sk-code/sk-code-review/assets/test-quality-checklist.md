...
- [code-quality-checklist.md](./code-quality-checklist.md) - Correctness, performance, KISS, and DRY checks.
...
Surface portability: pair this baseline with surface-specific test guidance from `sk-code`.

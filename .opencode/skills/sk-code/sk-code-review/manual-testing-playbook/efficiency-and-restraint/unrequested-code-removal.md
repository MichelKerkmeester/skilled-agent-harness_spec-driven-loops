...
| File | Role |
|---|---|
| `../../assets/code-quality-checklist.md` | Section 7 needed-ness removal prompt and P2/P1 escalation rule |
| `../../assets/removal-plan.md` | Section 2 safe-to-remove-now table and the Replacement field |
...
- Feature file path: `efficiency-and-restraint/unrequested-code-removal.md`

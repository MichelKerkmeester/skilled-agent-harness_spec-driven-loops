...
8. Reconcile severity against `references/review-core.md`, not against majority vote.
...
> **Feature File:** [CR-001](../manual-testing-playbook/baseline-review-flow/small-pr-single-file.md)
...
> **Feature File:** [CR-002](../manual-testing-playbook/baseline-review-flow/large-refactor-pr.md)
...
> **Feature File:** [CR-003](../manual-testing-playbook/baseline-review-flow/multi-commit-feature-branch.md)
...
> **Feature File:** [CR-004](../manual-testing-playbook/security-and-correctness-minimums/security-sensitive-auth.md)
...
> **Feature File:** [CR-005](../manual-testing-playbook/security-and-correctness-minimums/input-validation-injection.md)
...
> **Feature File:** [CR-006](../manual-testing-playbook/security-and-correctness-minimums/secrets-and-hardcoded-creds.md)
...
> **Feature File:** [CR-007](../manual-testing-playbook/severity-and-evidence-discipline/p0-blocker-with-file-line.md)
...
> **Feature File:** [CR-008](../manual-testing-playbook/severity-and-evidence-discipline/class-of-bug-vs-instance-only.md)
...
> **Feature File:** [CR-009](../manual-testing-playbook/severity-and-evidence-discipline/cross-consumer-affected-surface.md)
...
> **Feature File:** [CR-010](../manual-testing-playbook/scope-and-precedence/explicit-scope-security-only.md)
...
> **Feature File:** [CR-011](../manual-testing-playbook/scope-and-precedence/baseline-vs-surface-precedence.md)
...
> **Feature File:** [CR-012](../manual-testing-playbook/scope-and-precedence/test-code-review.md)
...
> **Feature File:** [CR-013](../manual-testing-playbook/re-review-and-stale-context/re-review-after-fixes.md)
...
> **Feature File:** [CR-014](../manual-testing-playbook/re-review-and-stale-context/stale-architecture-fresh-pass.md)
...
> **Feature File:** [CR-015](../manual-testing-playbook/re-review-and-stale-context/ai-generated-code-suspect-quality.md)
...
> **Feature File:** [CR-016](../manual-testing-playbook/cross-cli-orchestration/native-claude-code-invocation.md)
...
> **Feature File:** [CR-017](../manual-testing-playbook/cross-cli-orchestration/cli-opencode-delegation.md)
...
> **Feature File:** [CR-018](../manual-testing-playbook/cross-cli-orchestration/cli-opencode-and-cli-claude-code-handback.md)
...
> **Feature File:** [CR-020](../manual-testing-playbook/efficiency-and-restraint/reinvent-the-wheel-detection.md)
...
> **Feature File:** [CR-021](../manual-testing-playbook/efficiency-and-restraint/unrequested-code-removal.md)
...
> **Feature File:** [CR-022](../manual-testing-playbook/efficiency-and-restraint/ceiling-comment-downgrade.md)
...
> **Feature File:** [CR-023](../manual-testing-playbook/efficiency-and-restraint/review-depth-alias.md)
...
> **Feature File:** [CR-024](../manual-testing-playbook/efficiency-and-restraint/rule-invariant-canary.md)
...
|---|---|---|---|
| CR-001 | Small PR single-file | BASELINE REVIEW FLOW | [CR-001](../manual-testing-playbook/baseline-review-flow/small-pr-single-file.md) |
| CR-002 | Large refactor PR | BASELINE REVIEW FLOW | [CR-002](../manual-testing-playbook/baseline-review-flow/large-refactor-pr.md) |
| CR-003 | Multi-commit feature branch | BASELINE REVIEW FLOW | [CR-003](../manual-testing-playbook/baseline-review-flow/multi-commit-feature-branch.md) |
| CR-004 | Security-sensitive auth | SECURITY AND CORRECTNESS MINIMUMS | [CR-004](../manual-testing-playbook/security-and-correctness-minimums/security-sensitive-auth.md) |
| CR-005 | Input validation injection | SECURITY AND CORRECTNESS MINIMUMS | [CR-005](../manual-testing-playbook/security-and-correctness-minimums/input-validation-injection.md) |
| CR-006 | Secrets and hardcoded credentials | SECURITY AND CORRECTNESS MINIMUMS | [CR-006](../manual-testing-playbook/security-and-correctness-minimums/secrets-and-hardcoded-creds.md) |
| CR-007 | P0 blocker with file:line | SEVERITY AND EVIDENCE DISCIPLINE | [CR-007](../manual-testing-playbook/severity-and-evidence-discipline/p0-blocker-with-file-line.md) |
| CR-008 | Class of bug vs instance-only | SEVERITY AND EVIDENCE DISCIPLINE | [CR-008](../manual-testing-playbook/severity-and-evidence-discipline/class-of-bug-vs-instance-only.md) |
| CR-009 | Cross-consumer affected surface | SEVERITY AND EVIDENCE DISCIPLINE | [CR-009](../manual-testing-playbook/severity-and-evidence-discipline/cross-consumer-affected-surface.md) |
| CR-010 | Explicit scope security only | SCOPE AND PRECEDENCE | [CR-010](../manual-testing-playbook/scope-and-precedence/explicit-scope-security-only.md) |
| CR-011 | Baseline vs surface precedence | SCOPE AND PRECEDENCE | [CR-011](../manual-testing-playbook/scope-and-precedence/baseline-vs-surface-precedence.md) |
| CR-012 | Test code review | SCOPE AND PRECEDENCE | [CR-012](../manual-testing-playbook/scope-and-precedence/test-code-review.md) |
| CR-013 | Re-review after fixes | RE-REVIEW AND STALE CONTEXT | [CR-013](../manual-testing-playbook/re-review-and-stale-context/re-review-after-fixes.md) |
| CR-014 | Stale architecture fresh pass | RE-REVIEW AND STALE CONTEXT | [CR-014](../manual-testing-playbook/re-review-and-stale-context/stale-architecture-fresh-pass.md) |
| CR-015 | AI-generated suspect quality | RE-REVIEW AND STALE CONTEXT | [CR-015](../manual-testing-playbook/re-review-and-stale-context/ai-generated-code-suspect-quality.md) |

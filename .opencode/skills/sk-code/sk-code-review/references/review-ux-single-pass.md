...
- [review-core.md](./review-core.md) - Shared doctrine used by both interactive and deep review modes.
- [quick-reference.md](./quick-reference.md) - Lightweight index for the review reference set.
- [test-quality-checklist.md](../assets/test-quality-checklist.md) - Test quality and coverage checks for changed tests.

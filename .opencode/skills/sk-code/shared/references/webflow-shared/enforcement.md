...
**Related Documents:**
- [`../javascript/style_guide.md`](../../../code-implement/references/webflow/javascript/style_guide.md) — JS style conventions (naming, file structure, formatting, JSDoc)
- [`../css/style_guide.md`](../../../code-implement/references/webflow/css/style_guide.md) — CSS style conventions (BEM, custom properties, attribute selectors, animation CSS)
- [`../javascript/quality_standards.md`](../../../code-implement/references/webflow/javascript/quality_standards.md) — JS quality patterns + JS naming/init enforcement
- [`../css/quality_standards.md`](../../../code-implement/references/webflow/css/quality_standards.md) — CSS quality patterns + 4 CSS enforcement subsections
...
> **Note for CSS:** Section organization guidelines for CSS follow the same numbered-header structure but with CSS-specific section names. See [`../css/quality_standards.md`](../../../code-implement/references/webflow/css/quality_standards.md) for CSS section-organization details.
...
> **Cross-stack motion.dev reference**: For the Motion API and integration assumptions behind `MOTION:` comments, see [`../../motion_dev/quick_start.md`](../../../code-implement/references/motion_dev/quick_start.md) and [`../../motion_dev/integration_patterns.md`](../../../code-implement/references/motion_dev/integration_patterns.md). This file remains the Webflow style-enforcement source for comment quality.
...
4. **Apply per-language rules** from the matching `quality_standards.md` ([JS](../../../code-implement/references/webflow/javascript/quality_standards.md) | [CSS](../../../code-implement/references/webflow/css/quality_standards.md))
...
|-----------|---------------------------|-------------------------------|
| JavaScript (`.js`) | Sections 2-4 (headers, organization, comments) | [`../javascript/quality_standards.md`](../../../code-implement/references/webflow/javascript/quality_standards.md) (naming, init patterns) |
| CSS (`.css`) | Sections 2-4 (headers, organization, comments) | [`../css/quality_standards.md`](../../../code-implement/references/webflow/css/quality_standards.md) (custom properties, BEM, attribute selectors, animations) |
...
- **JavaScript** naming conventions + initialization patterns: [`../javascript/quality_standards.md`](../../../code-implement/references/webflow/javascript/quality_standards.md)
- **CSS** custom properties + attribute selectors + BEM + animation properties: [`../css/quality_standards.md`](../../../code-implement/references/webflow/css/quality_standards.md)
...
- [`../javascript/style_guide.md`](../../../code-implement/references/webflow/javascript/style_guide.md) — JS style guide
- [`../css/style_guide.md`](../../../code-implement/references/webflow/css/style_guide.md) — CSS style guide
- [`../javascript/quality_standards.md`](../../../code-implement/references/webflow/javascript/quality_standards.md) — JS quality patterns + enforcement
- [`../css/quality_standards.md`](../../../code-implement/references/webflow/css/quality_standards.md) — CSS quality patterns + enforcement

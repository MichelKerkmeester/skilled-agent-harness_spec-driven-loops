...
3. The skill advisor at `.opencode/skills/system-skill-advisor/mcp-server/scripts/skill_advisor.py` is callable and `skill-graph.json` includes the `sk-code` entry with `signals` array intact.

...
description: "Code-facing README for .opencode/skills/sk-code/sk-code-webflow/assets/patterns."
trigger_phrases:
...
This README documents the code-bearing folder `.opencode/skills/sk-code/sk-code-webflow/assets/patterns` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/sk-code/sk-code-webflow/assets/patterns
```
...
|---|---|
| Folder boundary | Documents direct code files under `sk-code-webflow/assets/patterns`. |
...
| Path | Purpose |
|---|---|
| `interaction-gate-patterns.js` | JS source file in this folder. |
| `performance-patterns.js` | JS source file in this folder. |
...
```text
User request: Check .opencode/skills/sk-code/sk-code-webflow/assets/patterns for sk-code and README coverage.

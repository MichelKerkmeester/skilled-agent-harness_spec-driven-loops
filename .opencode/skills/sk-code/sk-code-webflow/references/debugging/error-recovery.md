...
**Recovery Steps:**
1. Run verification first: `node .opencode/skills/sk-code/sk-code-webflow/assets/scripts/verify-minification.mjs [file].js`
...
node .opencode/skills/sk-code/sk-code-webflow/assets/scripts/verify-minification.mjs src/javascript/[file].js
node .opencode/skills/sk-code/sk-code-webflow/assets/scripts/test-minified-runtime.mjs dist/[file].min.js
```
...
- [cdn-deployment.md](../deployment/cdn-deployment.md) - CDN deployment workflow
- [minification_guide.md](../deployment/minification-guide/overview-terser-and-patterns.md) - Minification procedures
- [debugging_workflows.md](debugging-workflows/systematic-four-phases.md) - General debugging

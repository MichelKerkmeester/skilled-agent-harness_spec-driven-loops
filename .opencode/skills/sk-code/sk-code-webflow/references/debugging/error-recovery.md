...
**Recovery Steps:**
1. Run verification first: `node .opencode/skills/sk-code/code-webflow/assets/scripts/verify-minification.mjs [file].js`
...
node .opencode/skills/sk-code/code-webflow/assets/scripts/verify-minification.mjs src/javascript/[file].js
node .opencode/skills/sk-code/code-webflow/assets/scripts/test-minified-runtime.mjs dist/[file].min.js
```

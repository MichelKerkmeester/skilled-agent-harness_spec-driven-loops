...
- [code_organization.md](../../../../shared/references/opencode-shared/code_organization.md)
- [config_checklist.md](../../../../code-quality/assets/opencode-checklists/config_checklist.md)

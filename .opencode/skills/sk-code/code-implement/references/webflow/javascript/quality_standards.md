...
> See [`./style_guide.md`](./style_guide.md) for naming conventions, formatting, and file structure. See [`../shared/cross_language_rules.md`](../../../../shared/references/webflow-shared/cross_language_rules.md) for cross-language rules. This file covers JavaScript quality patterns and JS-specific enforcement.
...
- [`../shared/cross_language_rules.md`](../../../../shared/references/webflow-shared/cross_language_rules.md) — file naming, comment principles
- [`../shared/enforcement.md`](../../../../shared/references/webflow-shared/enforcement.md) — cross-language pre-completion gate
- [`../shared/dev_workflow.md`](../../../../shared/references/webflow-shared/dev_workflow.md) — DevTools, logging, testing patterns

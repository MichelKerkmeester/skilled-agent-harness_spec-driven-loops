...
> See [`./style_guide.md`](./style_guide.md) for CSS conventions and [`./quality_standards.md`](./quality_standards.md) for CSS quality patterns + enforcement. See [`../shared/dev_workflow.md`](../../../../shared/references/webflow-shared/dev_workflow.md) for cross-language commands and decision matrix.
...
- [`./quality_standards.md`](./quality_standards.md) — will-change, GPU props, easing, fluid typography, all 4 CSS enforcement subsections
- [`../javascript/quick_reference.md`](../javascript/quick_reference.md) — JS snippets and one-liners
- [`../shared/dev_workflow.md`](../../../../shared/references/webflow-shared/dev_workflow.md) — cross-language commands, decision matrix, debugging checklist

...
Use the canonical template at [`../../../assets/webflow/templates/embed_template.html`](../../../assets/webflow/templates/embed_template.html). Replace `[LIKE_THIS]` placeholders, never invent ad-hoc embed structures.
...
Use the canonical template at [`../../../assets/webflow/templates/head_footer_code_template.html`](../../../assets/webflow/templates/head_footer_code_template.html). Reference production example at `anobel.com/src/0_html/global.html`.
...
- [`../../../assets/webflow/templates/embed_template.html`](../../../assets/webflow/templates/embed_template.html) — custom embed scaffolding
- [`../../../assets/webflow/templates/head_footer_code_template.html`](../../../assets/webflow/templates/head_footer_code_template.html) — head + footer custom code panel template
- [`../../../assets/webflow/templates/form_scaffold_template.html`](../../../assets/webflow/templates/form_scaffold_template.html) — form field scaffolding with validation hooks

...
- In-repo: `.opencode/skills/sk-code/code-implement/references/webflow/implementation/performance_patterns.md`
...
Existing sk-code Webflow guidance gives the same local rule: animate `transform` and `opacity` first, and manage `will-change` dynamically around active animations (Repo: `.opencode/skills/sk-code/code-implement/references/webflow/implementation/performance_patterns.md`).
...
- Prefer transform/opacity and pre-measured layout changes (Repo: `.opencode/skills/sk-code/code-implement/references/webflow/implementation/performance_patterns.md`).
...
- Local Webflow performance guide: `.opencode/skills/sk-code/code-implement/references/webflow/implementation/performance_patterns.md`

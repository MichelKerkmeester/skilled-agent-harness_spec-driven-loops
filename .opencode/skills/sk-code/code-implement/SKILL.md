...
| WEBFLOW implementation | [`references/webflow/implementation/implementation_workflows.md`](../code-webflow/references/implementation/implementation_workflows.md), [`references/webflow/implementation/animation_workflows.md`](../code-webflow/references/implementation/animation_workflows.md), [`references/webflow/implementation/performance_patterns.md`](../code-webflow/references/implementation/performance_patterns.md) | [`references/webflow/implementation/async_patterns.md`](../code-webflow/references/implementation/async_patterns.md), [`observer_patterns.md`](../code-webflow/references/implementation/observer_patterns.md), [`security_patterns.md`](../code-webflow/references/implementation/security_patterns.md), [`third_party_integrations.md`](../code-webflow/references/implementation/third_party_integrations.md), [`webflow_patterns.md`](../code-webflow/references/implementation/webflow_patterns.md) |
| WEBFLOW JavaScript | [`references/webflow/javascript/style_guide.md`](../code-webflow/references/javascript/style_guide.md), [`references/webflow/javascript/quality_standards.md`](../code-webflow/references/javascript/quality_standards.md), [`references/webflow/javascript/quick_reference.md`](../code-webflow/references/javascript/quick_reference.md) | [`assets/webflow/patterns/`](../code-webflow/assets/patterns/) and [`assets/webflow/integrations/`](../code-webflow/assets/integrations/) for exact reusable patterns |
| WEBFLOW CSS | [`references/webflow/css/style_guide.md`](../code-webflow/references/css/style_guide.md), [`references/webflow/css/quality_standards.md`](../code-webflow/references/css/quality_standards.md), [`references/webflow/css/quick_reference.md`](../code-webflow/references/css/quick_reference.md) | [`references/webflow/css/patterns.md`](../code-webflow/references/css/patterns.md) and [`assets/webflow/templates/component_template.css`](../code-webflow/assets/templates/component_template.css) for component scaffolds |
| WEBFLOW HTML / embed | [`references/webflow/html/style_guide.md`](../code-webflow/references/html/style_guide.md), [`references/webflow/html/quality_standards.md`](../code-webflow/references/html/quality_standards.md) | [`assets/webflow/templates/embed_template.html`](../code-webflow/assets/templates/embed_template.html), [`head_footer_code_template.html`](../code-webflow/assets/templates/head_footer_code_template.html), [`form_scaffold_template.html`](../code-webflow/assets/templates/form_scaffold_template.html) |
| WEBFLOW deployment / CDN | [`references/webflow/deployment/cdn_deployment.md`](../code-webflow/references/deployment/cdn_deployment.md), [`references/webflow/deployment/minification_guide.md`](../code-webflow/references/deployment/minification_guide.md) | [`references/webflow/deployment/webflow_staging_production.md`](../code-webflow/references/deployment/webflow_staging_production.md), [`assets/webflow/scripts/README.md`](../code-webflow/assets/scripts/README.md) |
| WEBFLOW performance | [`references/webflow/performance/resource_loading.md`](../code-webflow/references/performance/resource_loading.md), [`references/webflow/performance/webflow_constraints.md`](../code-webflow/references/performance/webflow_constraints.md) | [`interaction_gated_loading.md`](../code-webflow/references/performance/interaction_gated_loading.md), [`cwv_remediation.md`](../code-webflow/references/performance/cwv_remediation.md), [`third_party.md`](../code-webflow/references/performance/third_party.md) |
| OPENCODE base | [`../code-opencode/references/shared/universal_patterns.md`](../code-opencode/references/shared/universal_patterns.md), [`../code-opencode/references/shared/code_organization.md`](../code-opencode/references/shared/code_organization.md) | [`../code-opencode/references/shared/hooks.md`](../code-opencode/references/shared/hooks.md) when hook behavior changes |
| OPENCODE authoring | The language-specific references from the table below | At write-time, load the matching authoring checklist from [`../code-opencode/assets/checklists/`](../code-opencode/assets/checklists/) and load [`spec_folder_write_recipe.md`](../../system-spec-kit/references/workflows/spec_folder_write_recipe.md) (system-spec-kit) for spec-folder writes |
| MOTION_DEV overlay | [`references/motion_dev/quick_start.md`](../code-animation/references/quick_start.md), [`animation_principles.md`](../code-animation/references/animation_principles.md), [`integration_patterns.md`](../code-animation/references/integration_patterns.md), [`decision_matrix.md`](../code-animation/references/decision_matrix.md) | [`animate_and_timelines.md`](../code-animation/references/animate_and_timelines.md), [`scroll_and_gestures.md`](../code-animation/references/scroll_and_gestures.md), [`performance_and_pitfalls.md`](../code-animation/references/performance_and_pitfalls.md), [`assets/motion_dev/snippets/README.md`](../code-animation/assets/snippets/README.md), and exact snippet assets |
...
| --- | --- | --- |
| JAVASCRIPT | `.js`, `.mjs`, `.cjs`, CommonJS, Node-oriented OpenCode scripts | [`references/opencode/javascript/quick_reference.md`](../code-opencode/references/javascript/quick_reference.md), [`style_guide.md`](../code-opencode/references/javascript/style_guide.md), [`quality_standards.md`](../code-opencode/references/javascript/quality_standards.md) |
| TYPESCRIPT | `.ts`, `.tsx`, `.mts`, `.d.ts`, `tsconfig`, interfaces | [`references/opencode/typescript/quick_reference.md`](../code-opencode/references/typescript/quick_reference.md), [`style_guide.md`](../code-opencode/references/typescript/style_guide.md), [`quality_standards.md`](../code-opencode/references/typescript/quality_standards.md) |
| PYTHON | `.py`, pytest, argparse, docstrings | [`references/opencode/python/quick_reference.md`](../code-opencode/references/python/quick_reference.md), [`style_guide.md`](../code-opencode/references/python/style_guide.md), [`quality_standards.md`](../code-opencode/references/python/quality_standards.md) |
| SHELL | `.sh`, `.bash`, shebangs, shell hooks | [`references/opencode/shell/quick_reference.md`](../code-opencode/references/shell/quick_reference.md), [`style_guide.md`](../code-opencode/references/shell/style_guide.md), [`quality_standards.md`](../code-opencode/references/shell/quality_standards.md) |
| CONFIG | `.json`, `.jsonc`, schema, descriptor, frontmatter-adjacent config | [`references/opencode/config/quick_reference.md`](../code-opencode/references/config/quick_reference.md), [`style_guide.md`](../code-opencode/references/config/style_guide.md), [`quality_standards.md`](../code-opencode/references/config/quality_standards.md) |
...
| --- | --- | --- |
| Skill packet or skill file | [`../code-opencode/assets/checklists/skill_authoring.md`](../code-opencode/assets/checklists/skill_authoring.md) | n/a |
| Agent file | [`../code-opencode/assets/checklists/agent_authoring.md`](../code-opencode/assets/checklists/agent_authoring.md) | n/a |
| Command file | [`../code-opencode/assets/checklists/command_authoring.md`](../code-opencode/assets/checklists/command_authoring.md) | n/a |
| MCP server source | [`../code-opencode/assets/checklists/mcp_server_authoring.md`](../code-opencode/assets/checklists/mcp_server_authoring.md) | n/a |
...
4. For skills, agents, commands, MCP servers, or spec-folder docs, load the write-time checklist from `../code-opencode/assets/checklists/` before the first write.
...
- [`references/webflow/implementation/implementation_workflows.md`](../code-webflow/references/implementation/implementation_workflows.md) - WEBFLOW implementation workflow entry point.
- [`references/webflow/implementation/animation_workflows.md`](../code-webflow/references/implementation/animation_workflows.md) - WEBFLOW animation authoring patterns.
- [`references/webflow/implementation/performance_patterns.md`](../code-webflow/references/implementation/performance_patterns.md) - WEBFLOW performance-safe implementation patterns.
- [`references/webflow/javascript/quick_reference.md`](../code-webflow/references/javascript/quick_reference.md), [`references/webflow/css/quick_reference.md`](../code-webflow/references/css/quick_reference.md), and [`references/webflow/html/style_guide.md`](../code-webflow/references/html/style_guide.md) - per-file-type WEBFLOW authoring guidance.
- [`references/opencode/javascript/quick_reference.md`](../code-opencode/references/javascript/quick_reference.md), [`references/opencode/typescript/quick_reference.md`](../code-opencode/references/typescript/quick_reference.md), [`references/opencode/python/quick_reference.md`](../code-opencode/references/python/quick_reference.md), [`references/opencode/shell/quick_reference.md`](../code-opencode/references/shell/quick_reference.md), and [`references/opencode/config/quick_reference.md`](../code-opencode/references/config/quick_reference.md) - OPENCODE language entry points.
- [`references/motion_dev/quick_start.md`](../code-animation/references/quick_start.md), [`references/motion_dev/integration_patterns.md`](../code-animation/references/integration_patterns.md), [`references/motion_dev/decision_matrix.md`](../code-animation/references/decision_matrix.md), and [`references/motion_dev/performance_and_pitfalls.md`](../code-animation/references/performance_and_pitfalls.md) - Motion.dev overlay guidance.
- [`assets/webflow/templates/README.md`](../code-webflow/assets/templates/README.md), [`assets/webflow/patterns/README.md`](../code-webflow/assets/patterns/README.md), [`assets/webflow/integrations/README.md`](../code-webflow/assets/integrations/README.md), and [`assets/motion_dev/snippets/README.md`](../code-animation/assets/snippets/README.md) - reusable authoring assets.
...
- [`../code-opencode/assets/checklists/skill_authoring.md`](../code-opencode/assets/checklists/skill_authoring.md)
- [`../code-opencode/assets/checklists/agent_authoring.md`](../code-opencode/assets/checklists/agent_authoring.md)
- [`../code-opencode/assets/checklists/command_authoring.md`](../code-opencode/assets/checklists/command_authoring.md)
- [`../code-opencode/assets/checklists/mcp_server_authoring.md`](../code-opencode/assets/checklists/mcp_server_authoring.md)

...
The action-routing pattern in [`../javascript/quality_standards/init_dom_error_and_async.md`](../javascript/quality_standards/init_dom_error_and_async.md) §13 includes the toggle handlers that perform this sync — use it as the canonical implementation.
...
- [`../javascript/quality_standards/init_dom_error_and_async.md`](../javascript/quality_standards/init_dom_error_and_async.md) — action routing pattern (§13) for ARIA state-sync helpers

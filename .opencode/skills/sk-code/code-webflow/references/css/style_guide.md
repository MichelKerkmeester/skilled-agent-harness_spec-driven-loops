...
- [`../../../assets/webflow/templates/component_template.css`](../../assets/templates/component_template.css) — production-style annotated CSS template implementing every convention in this guide (file header, numbered sections, BEM naming, custom properties, attribute selectors, GPU-only animations, prefers-reduced-motion override, sub-numbered breakpoint sections)

...
Fast-lookup CSS reference for Webflow — tokens, form-validation classes, reduced-motion, and focus detection. See [`./style-guide.md`](./style-guide.md) for the full conventions and [`quality-standards/patterns-and-naming-enforcement.md`](quality-standards/patterns-and-naming-enforcement.md) for quality patterns and enforcement.
...
- [`./style-guide.md`](./style-guide.md) — CSS naming, custom property prefixes, attribute selectors, animation CSS, file organization
- [`quality-standards/patterns-and-naming-enforcement.md`](quality-standards/patterns-and-naming-enforcement.md) — will-change, GPU props, easing, fluid typography, all 4 CSS enforcement subsections
- [`../javascript/quick-reference.md`](../javascript/quick-reference.md) — JS snippets and one-liners
- [`../shared/dev-workflow/overview-nav-and-logging.md`](../shared/dev-workflow/overview-nav-and-logging.md) — cross-language commands, decision matrix, debugging checklist

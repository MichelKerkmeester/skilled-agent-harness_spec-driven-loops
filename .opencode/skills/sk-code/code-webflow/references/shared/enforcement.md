...
- [`../css/quality_standards/patterns-and-naming-enforcement.md`](../css/quality_standards/patterns-and-naming-enforcement.md) — CSS quality patterns + 4 CSS enforcement subsections
...
> **Note for CSS:** Section organization guidelines for CSS follow the same numbered-header structure but with CSS-specific section names. See [`../css/quality_standards/patterns-and-naming-enforcement.md`](../css/quality_standards/patterns-and-naming-enforcement.md) for CSS section-organization details.
...
4. **Apply per-language rules** from the matching `quality_standards.md` ([JS](../javascript/quality_standards/init-dom-error-and-async.md) | [CSS](../css/quality_standards/patterns-and-naming-enforcement.md))
...
| CSS (`.css`) | Sections 2-4 (headers, organization, comments) | [`../css/quality_standards/patterns-and-naming-enforcement.md`](../css/quality_standards/patterns-and-naming-enforcement.md) (custom properties, BEM, attribute selectors, animations) |
...
- **CSS** custom properties + attribute selectors + BEM + animation properties: [`../css/quality_standards/patterns-and-naming-enforcement.md`](../css/quality_standards/patterns-and-naming-enforcement.md)
...
- [`../css/quality_standards/patterns-and-naming-enforcement.md`](../css/quality_standards/patterns-and-naming-enforcement.md) — CSS quality patterns + enforcement

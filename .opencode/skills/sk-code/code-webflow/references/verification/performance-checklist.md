...
- [cwv-remediation.md](../performance/cwv-remediation.md) - Core Web Vitals optimization patterns
- [resource-loading.md](../performance/resource-loading.md) - Resource hints and loading strategies

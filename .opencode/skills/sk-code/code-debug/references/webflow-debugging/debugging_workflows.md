...
- **Animation issues:** See [animation_workflows.md Section 7](../../../code-implement/references/webflow/implementation/animation_workflows.md#7-🐛-common-issues-and-solutions)
- **Webflow issues:** See [webflow_patterns.md Section 3](../../../code-implement/references/webflow/implementation/webflow_patterns.md#3-📚-collection-list-patterns)
...
### Reference Files
- [implementation_workflows.md](../../../code-implement/references/webflow/implementation/implementation_workflows.md) - Debug timing and validation issues
- [verification_workflows.md](../../../code-verify/references/webflow-verification/verification_workflows.md) - Verify fixes work correctly
- [dev_workflow.md](../../../shared/references/webflow-shared/dev_workflow.md) - Use common DevTools and logging patterns

### Asset Files
- [lenis_patterns.js](../../../code-implement/assets/webflow/integrations/lenis_patterns.js) - Complete Lenis smooth scroll integration patterns

...
---
# sk-code Surface Router — routing logic and resource maps

Authoritative routing reference for sk-code. Consolidates intent classification + resource loading into the single Barter-style smart-routing entry point. Detection logic lives in [`stack-detection.md`](shared/references/stack-detection.md); phase lifecycle lives in [`phase-detection.md`](shared/references/phase-detection.md).
...
RESOURCE_MAP = {
    ...
    "DEBUGGING": [
        ...
        "sk-code-mobile-cli/references/design-system/component-tokens.md",
        "sk-code-mobile-cli/references/svelte/svelte-runes-effects.md",
    ...
    "VERIFICATION": [
        ...
        "sk-code-mobile-cli/references/verification/verification.md",
        "sk-code-mobile-cli/references/verification/browser-free-verification-recipe.md",
    ...
    "ACCESSIBILITY": [
        ...
        "sk-code-mobile-cli/references/conventions/editability-guardrails.md",
        "sk-code-mobile-cli/references/verification/verification.md",
        "sk-code-mobile-cli/references/svelte/a11y-parity.md",

...
RESOURCE_MAP = {
    ...
    "CODE_QUALITY": [
        ...
        "assets/checklists/rust_checklist/overview-and-p0-parity.md",
        "assets/checklists/rust_checklist/p0-safety-and-boundary-discipline.md",
        "assets/checklists/rust_checklist/p1-required.md",
        "assets/checklists/rust_checklist/p2-evidence-validation-and-resources.md",
    ],
    "VERIFICATION": [

...
Specific quality checks for Rust files in the OpenCode development environment. Use alongside the [universal-checklist.md](../universal-checklist.md) for complete validation.

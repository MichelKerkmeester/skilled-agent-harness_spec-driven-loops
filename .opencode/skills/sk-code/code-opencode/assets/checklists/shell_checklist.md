...
### Style Guide
- [Shell Style Guide](../../references/shell/style_guide/overview_structure_and_naming.md)
- [Shell Quality Standards](../../references/shell/quality_standards/overview_and_priority_blockers.md)

...
```jsonc
// shared/tsconfig.json and mcp-server/tsconfig.json
{
  "compilerOptions": {
    "module": "nodenext",
...
- [style-guide.md](../style-guide/overview-strict-and-naming.md) - Detailed formatting rules
- [quality-standards.md](../quality-standards/overview-and-type-system.md) - Type system, TSDoc, error patterns

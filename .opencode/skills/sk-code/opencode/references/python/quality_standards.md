...
**Evidence**: `.opencode/skills/system-skill-advisor/mcp_server/scripts/skill_advisor.py:31-49`
...
## 8. REVIEW HANDOFF (SK-CODE CODE-REVIEW MODE BASELINE)

Use `sk-code`'s code-review mode for formal findings-first review output and severity handling. Keep this file focused on Python technical standards.

...
description: "Code-facing README for .opencode/skills/sk-code/animation/assets/snippets."
trigger_phrases:
...
This README documents the code-bearing folder `.opencode/skills/sk-code/animation/assets/snippets` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/sk-code/animation/assets/snippets
```
...
```text
User request: Check .opencode/skills/sk-code/animation/assets/snippets for sk-code and README coverage.

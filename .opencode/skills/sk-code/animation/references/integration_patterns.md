...
- `.opencode/skills/sk-code/webflow/references/implementation/animation_workflows.md`
- `.opencode/skills/sk-code/webflow/references/implementation/performance_patterns.md`
- `.opencode/skills/sk-code/webflow/references/javascript/quality_standards.md`
...
This mirrors local Webflow safety patterns and keeps Motion optional for non-critical interactions (Repo: `a_nobel_en_zn/2_javascript/navigation/nav_dropdown.js`, `.opencode/skills/sk-code/webflow/references/javascript/quality_standards.md`).

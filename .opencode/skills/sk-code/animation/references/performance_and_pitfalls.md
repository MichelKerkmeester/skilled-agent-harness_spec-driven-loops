...
- In-repo: `.opencode/skills/sk-code/webflow/references/implementation/performance_patterns.md`
...
Existing sk-code Webflow guidance gives the same local rule: animate `transform` and `opacity` first, and manage `will-change` dynamically around active animations (Repo: `.opencode/skills/sk-code/webflow/references/implementation/performance_patterns.md`).

## 3. LAYOUT-THRASHING ANTI-PATTERNS

Avoid animating layout properties like `top`, `left`, `width`, and `height` unless the UX requires measured layout transitions. These properties can cause layout recalculation and Core Web Vitals/INP risk in the local performance guide (Repo: `.opencode/skills/sk-code/webflow/references/implementation/performance_patterns.md`).
...
- Prefer transform/opacity and pre-measured layout changes (Repo: `.opencode/skills/sk-code/webflow/references/implementation/performance_patterns.md`).
...
- Local Webflow performance guide: `.opencode/skills/sk-code/webflow/references/implementation/performance_patterns.md`

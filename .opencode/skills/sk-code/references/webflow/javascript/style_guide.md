...
- [`../../../assets/webflow/templates/component_template.js`](../../../assets/webflow/templates/component_template.js) — production-style annotated JS template implementing every convention in this guide (file header, sections, IIFE, INIT_FLAG, snake_case, function preambles, cleanup hook, public API)

...
> **Cross-stack motion.dev reference**: For Motion install modes, API availability, and non-Webflow integration patterns, see [`../../motion_dev/quick_start.md`](../../motion_dev/quick_start.md) and [`../../motion_dev/integration_patterns.md`](../../motion_dev/integration_patterns.md). The guard, delay, and `Webflow.push` rules above remain Webflow-specific.

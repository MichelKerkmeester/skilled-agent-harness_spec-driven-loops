...
def validate_frontmatter(content: str) -> Tuple[bool, str, List[str], Dict]:
    """
    Validate SKILL.md frontmatter against skill-md-template.md requirements.
...
- skill-creation.md: Overall skill requirements
- skill-md-template.md: SKILL.md structure requirements
...
### Internal References
- [quality-standards.md](./quality-standards.md) - Code quality requirements

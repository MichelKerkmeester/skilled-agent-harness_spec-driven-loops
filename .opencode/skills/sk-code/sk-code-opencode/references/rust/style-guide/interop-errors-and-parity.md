...
- [quality-standards.md](../quality-standards/overview-and-data-ownership.md) - Ownership, safety, ABI contracts, error translation, concurrency, Cargo, and parity gates
- [quick-reference.md](../quick-reference/overview-and-boundary-template.md) - Copy-paste Rust boundary templates, deterministic recipes, and build commands

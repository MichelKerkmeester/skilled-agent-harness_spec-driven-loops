...
- [style-guide.md](../style-guide/overview-and-file-header.md) - Detailed formatting, naming, module, and interop rules
- [quality-standards.md](../quality-standards/overview-and-data-ownership.md) - Safety, boundary, determinism, and verification requirements

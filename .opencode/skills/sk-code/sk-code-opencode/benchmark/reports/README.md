---
title: "code-opencode Benchmark Reports"
description: "Index of curated benchmark run reports for code-opencode, one row per run folder."
trigger_phrases:
  - "code-opencode benchmark reports"
  - "code-opencode benchmark index"
...
|---|---|---|---|---|---|
| 2026-07-10 | [`2026-07-10--router-mode-a--router/`](./2026-07-10--router-mode-a--router/) | router | 9 PASS | **PASS** 86/100 | not recorded |
| 2026-07-10 | [`2026-07-10--live-mode-b--live/`](./2026-07-10--live-mode-b--live/) | live | 9 PASS | **PASS** 81/100 | not recorded |

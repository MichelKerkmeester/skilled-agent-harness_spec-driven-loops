...
- [ ] Read canonical command examples at `.opencode/commands/spec_kit/complete.md` and `.opencode/commands/create/sk-skill.md`.
...
- Prior examples: `.opencode/commands/spec_kit/complete.md`, `.opencode/commands/create/sk-skill.md`

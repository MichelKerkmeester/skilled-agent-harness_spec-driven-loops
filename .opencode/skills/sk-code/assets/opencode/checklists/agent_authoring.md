...
- [ ] Identify the 4-runtime mirror set: `.opencode/agents/`, `.claude/agents/`, `.codex/agents/`, and `.gemini/agents/`.
...
- [ ] Cross-runtime mirror parity check: compare `.opencode/agents/<name>.md`, `.claude/agents/<name>.md`, `.codex/agents/<name>.md`, and `.gemini/agents/<name>.md` where the agent is runtime-wide.

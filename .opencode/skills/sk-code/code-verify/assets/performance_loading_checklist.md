...
- [interaction_gated_loading.md](../../code-implement/references/webflow/performance/interaction_gated_loading.md) - Gate selection and exclusions
- [cwv_remediation.md](../../code-implement/references/webflow/performance/cwv_remediation.md) - TBT and Lighthouse remediation patterns
- [interaction_gate_patterns.js](../../code-implement/assets/webflow/patterns/interaction_gate_patterns.js) - Reusable trigger helpers

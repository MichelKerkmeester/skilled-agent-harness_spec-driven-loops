...
> **Cross-stack motion.dev reference**: For Motion API behavior, reduced-motion patterns, and animation regression checks that apply beyond Webflow, see [`../../motion_dev/performance_and_pitfalls.md`](../../../code-implement/references/motion_dev/performance_and_pitfalls.md) and [`../../motion_dev/integration_patterns.md`](../../../code-implement/references/motion_dev/integration_patterns.md). The Webflow verification rules here remain authoritative for browser evidence and Webflow-specific completion claims.
...
### Reference Files
- [implementation_workflows.md](../../../code-implement/references/webflow/implementation/implementation_workflows.md) - Verify implementations work correctly
- [debugging_workflows.md](../../../code-debug/references/webflow-debugging/debugging_workflows.md) - Verify fixes work after debugging
- [dev_workflow.md](../../../shared/references/webflow-shared/dev_workflow.md) - Use standard DevTools verification patterns

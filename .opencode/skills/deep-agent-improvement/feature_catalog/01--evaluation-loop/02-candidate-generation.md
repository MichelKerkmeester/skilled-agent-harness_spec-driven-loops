...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-agent-improvement/references/shared/loop_protocol.md` | Reference | Documents the proposal-first sequence and runtime-only candidate path. |
| `.opencode/skills/deep-agent-improvement/references/shared/promotion_rules.md` | Safety reference | Stops the loop when mutator and scorer boundaries blur or scope broadens. |

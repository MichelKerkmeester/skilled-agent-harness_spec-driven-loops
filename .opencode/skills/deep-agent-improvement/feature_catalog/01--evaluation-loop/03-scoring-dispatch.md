...
| `.opencode/skills/deep-agent-improvement/scripts/trade-off-detector.cjs` | Analysis helper | Detects cross-dimension regressions before the reducer refresh. |
| `.opencode/skills/deep-agent-improvement/scripts/reduce-state.cjs` | Reducer | Rebuilds the registry and dashboard after each scored iteration. |
...
| `.opencode/skills/deep-agent-improvement/references/benchmark_operator_guide.md` | Operator reference | Documents the benchmark command shape and evidence expectations that sit beside the scorer output. |

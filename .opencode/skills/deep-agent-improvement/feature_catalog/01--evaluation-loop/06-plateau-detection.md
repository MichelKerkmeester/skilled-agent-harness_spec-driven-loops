...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/deep-agent-improvement/scripts/reduce-state.cjs` | Reducer | Computes stop status from ties, infra failures, benchmark failures, drift ambiguity, and exact-score plateaus. |

...
| `.opencode/skills/deep-agent-improvement/scripts/scorer/score-model-variant.cjs` | 5-dim scorer | Ported 120/003 five-dimension scorer reached only under `--scorer 5dim`. |

...
The discovery map includes the consolidated advisor script at `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py`, so the skill-advisor surface is registered from its self-contained package location.
...
| `.opencode/skills/deep-agent-improvement/references/integration_scanning.md` | Reference | Documents the intended scan taxonomy and output summary fields. |
| `.opencode/commands/improve/agent.md` | Command | Uses the integration report as part of loop setup and review. |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-agent-improvement/references/evaluator_contract.md` | Contract reference | Locks the scanner into the integration-consistency dimension and its weighted contribution. |
| `.opencode/skills/deep-agent-improvement/references/target_onboarding.md` | Operator reference | Requires the integration scan before new targets enter the loop. |

...
description: Formal format for packet-local candidate proposals in deep-agent-improvement, including file structure, metadata, and mutation representation.
trigger_phrases:
  - "candidate proposal"
  - "candidate format"
  - "proposal format"
...
Formal format for packet-local candidate proposals in deep-agent-improvement, including file structure, metadata, and mutation representation.
...
The `@deep-agent-improvement` subagent must:

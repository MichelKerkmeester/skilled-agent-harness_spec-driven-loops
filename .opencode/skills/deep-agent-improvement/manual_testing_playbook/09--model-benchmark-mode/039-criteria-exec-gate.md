...
| `../../scripts/scorer/score-model-variant.cjs` | Ported 120/003 five-dimension scorer with the criteria-exec hardening gate |
| `../../scripts/run-benchmark.cjs` | Benchmark runner that routes 5dim scoring through the scorer |

...
This scenario validates that `run-benchmark.cjs --scorer 5dim` routes materialized outputs through `scripts/scorer/score-model-variant.cjs`, stamps `scoringMethod: "5dim"`, and emits per-dimension D1-D5 scores per fixture while staying deterministic under the default `--grader noop`.
...
| `../../scripts/run-benchmark.cjs` | Benchmark runner and scorer selection |
| `../../scripts/scorer/score-model-variant.cjs` | Ported 120/003 five-dimension scorer (D1-D5 plus pluggable grader) |

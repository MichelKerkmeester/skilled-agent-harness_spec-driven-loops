---
title: "MB-036 -- Default Pattern Scorer"
description: "Manual validation scenario for MB-036: Default Pattern Scorer."
feature_id: "MB-036"
...
This document captures the canonical manual-testing contract for `MB-036`.
...
| `09--model-benchmark-mode/036-default-pattern-scorer.md` | Canonical per-feature execution contract |
...
| `../../scripts/run-benchmark.cjs` | Benchmark runner and default pattern scorer |
| `../../scripts/materialize-benchmark-fixtures.cjs` | Fixture materializer run before scoring |
| `../../assets/benchmark-profiles/default.json` | Shipped benchmark profile used by this scenario |
...
- Feature file path: `09--model-benchmark-mode/036-default-pattern-scorer.md`

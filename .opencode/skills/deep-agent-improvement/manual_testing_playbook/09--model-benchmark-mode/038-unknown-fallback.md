...
| `../../scripts/loop-host.cjs` | Mode-switching entry point and unknown-mode fallback |
| `../../scripts/run-benchmark.cjs` | Benchmark runner and unknown-scorer fallback |

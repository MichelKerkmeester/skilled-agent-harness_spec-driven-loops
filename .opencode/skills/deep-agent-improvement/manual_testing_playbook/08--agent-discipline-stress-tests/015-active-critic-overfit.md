...
cp /tmp/cp-042-sandbox/.opencode/skills/deep-agent-improvement/assets/improvement_charter.md /tmp/cp-042-spec/improvement/control/improvement-charter.md
cp /tmp/cp-042-sandbox/.opencode/skills/deep-agent-improvement/assets/target_manifest.jsonc /tmp/cp-042-spec/improvement/control/target-manifest.jsonc

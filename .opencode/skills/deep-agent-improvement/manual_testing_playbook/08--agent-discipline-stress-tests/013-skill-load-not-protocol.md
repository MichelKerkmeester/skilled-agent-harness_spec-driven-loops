...
description: "Validate that /deep:start-agent-improvement-loop executes the deep-agent-improvement protocol instead of merely reading SKILL.md and improvising."
---
...
1. Run the packet setup helper to seed `/tmp/cp-040-sandbox/` with `.opencode/commands/deep/`, `.opencode/skills/deep-agent-improvement/`, and the fixture target/mirrors.

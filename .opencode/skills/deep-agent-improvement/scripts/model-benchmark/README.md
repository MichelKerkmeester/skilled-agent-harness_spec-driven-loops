...
```bash
node .opencode/skills/deep-agent-improvement/scripts/model-benchmark/dispatch-model.cjs --mock /dev/null
npx vitest run .opencode/skills/deep-agent-improvement/scripts/tests/run-benchmark-hardening.vitest.ts
npx vitest run .opencode/skills/deep-agent-improvement/scripts/tests/optin-scorer.vitest.ts
```

...
| `.opencode/commands/deep/assets/deep_start-context-loop_auto.yaml` | Workflow | `step_graph_convergence` — invocation, JSON parsing, graph_convergence event emission |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-context/manual_testing_playbook/04--convergence-detection/evaluate-context.md` | Manual playbook | Verifies convergence.cjs exits 0, emits parseable JSON with all five signal fields and a valid decision enum value |

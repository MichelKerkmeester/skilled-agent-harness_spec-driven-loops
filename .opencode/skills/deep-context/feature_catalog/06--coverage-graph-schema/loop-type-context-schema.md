...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-context/manual_testing_playbook/06--coverage-graph-schema/loop-type-context-schema.md` | Manual playbook | Verifies node and relation type constants in coverage-graph-db.ts, REUSES weight is 1.5, upsert.cjs exits 0 for a context-typed node batch |

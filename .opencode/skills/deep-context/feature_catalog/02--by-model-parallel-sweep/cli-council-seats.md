...
| File | Layer | Role |
|---|---|---|
| `.opencode/commands/deep/assets/deep_start-context-loop_auto.yaml` | Workflow | `step_sweep_cli_pool` — council dispatch, one-shot prompt contract, CLI invocation per executor kind |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-context/manual_testing_playbook/02--by-model-parallel-sweep/cli-council-seats.md` | Manual playbook | Verifies one-shot dispatch per seat, CLI contracts, and closed stdin for opencode seats |

...
| `.opencode/skills/deep-context/references/loop_protocol.md` | §6: Merge rules referencing kind-to-bucket assignments |
| `.opencode/skills/deep-context/references/convergence.md` | Signal definitions cross-referencing relation semantics |

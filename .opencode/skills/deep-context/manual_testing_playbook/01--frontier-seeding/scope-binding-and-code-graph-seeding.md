...
```bash
rg "whole.*repo\|never.*repo\|whole-repo" .opencode/skills/deep-context/SKILL.md .opencode/skills/deep-context/references/loop_protocol.md
```
...
| `.opencode/skills/deep-context/references/loop_protocol.md` | Loop protocol §4: frontier seeding rules, code_graph_query usage, Glob+Grep fallback |

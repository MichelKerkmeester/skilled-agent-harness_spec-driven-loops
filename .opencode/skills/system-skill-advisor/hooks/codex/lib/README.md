---
title: "system skill advisor hooks codex lib: Code README"
description: "Code-facing README for .opencode/skills/system-skill-advisor/hooks/codex/lib."
trigger_phrases:
  - "system-skill-advisor hooks/codex/lib"
  - "code README"
---
...
This README documents the code-bearing folder `.opencode/skills/system-skill-advisor/hooks/codex/lib` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/system-skill-advisor/hooks/codex/lib
```
...
|---|---|
| Folder boundary | Documents direct code files under `hooks/codex/lib`. |
...
| Path | Purpose |
|---|---|
| `codex-hook-policy.ts` | TS source file in this folder. |
...
```text
User request: Check .opencode/skills/system-skill-advisor/hooks/codex/lib for sk-code and README coverage.

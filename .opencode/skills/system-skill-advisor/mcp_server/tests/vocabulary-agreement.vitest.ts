...
const SGDB = '.opencode/skills/system-skill-advisor/mcp_server/lib/skill-graph/skill-graph-db.ts';
const COMPILER = '.opencode/skills/system-skill-advisor/mcp_server/scripts/skill_graph_compiler.py';
const TOOLS = '.opencode/skills/system-skill-advisor/mcp_server/tools/skill-graph-tools.ts';
const CLI_MANIFEST = '.opencode/skills/system-skill-advisor/mcp_server/skill-advisor-cli-manifest.ts';
const QUERY = '.opencode/skills/system-skill-advisor/mcp_server/handlers/skill-graph/query.ts';
const CHECKER = '.opencode/commands/doctor/scripts/parent-skill-check.cjs';
const TEMPLATE = '.opencode/skills/sk-doc/create-skill/assets/parent_skill/parent_skill_graph_metadata_template.json';
const DRIFT_GUARD = '.opencode/skills/system-skill-advisor/mcp_server/tests/routing-registry-drift-guard.vitest.ts';
// gated scorer-track read-only subsets — flagged, never asserted-equal
const ADVISOR_PY = '.opencode/skills/system-skill-advisor/mcp_server/scripts/skill_advisor.py';
const GRAPH_CAUSAL = '.opencode/skills/system-skill-advisor/mcp_server/lib/scorer/lanes/graph-causal.ts';

...
import { parseFile } from '../../../system-code-graph/mcp_server/lib/structural-indexer.js';
import { speckitMetrics } from '../lib/metrics.js';
import { findAdvisorWorkspaceRoot } from '../lib/utils/workspace-root.js';
import type { SupportedLanguage } from '../../../system-code-graph/mcp_server/lib/indexer-types.js';
...
function buildFixtures(root: string): readonly Fixture[] {
  ...
  return [
    f('.opencode/skills/system-code-graph/mcp_server/code_graph/lib/runtime-detection.ts', 'typescript'),
    f('.opencode/skills/system-code-graph/mcp_server/code_graph/lib/budget-allocator.ts', 'typescript'),
    f('.opencode/skills/system-code-graph/mcp_server/code_graph/lib/ensure-ready.ts', 'typescript'),
    f('.opencode/plugins/spec-kit-skill-advisor.js', 'javascript'),
    f('.opencode/plugins/spec-kit-compact-code-graph.js', 'javascript'),
    f('.opencode/skills/system-spec-kit/scripts/setup/record-node-version.js', 'javascript'),
    f('.opencode/skills/system-spec-kit/scripts/.scan-validate-all.py', 'python'),
    f('.opencode/skills/system-spec-kit/scripts/.enumerate-no-frontmatter.py', 'python'),
    f('.opencode/skills/sk-doc/scripts/quick_validate.py', 'python'),
    f('.opencode/skills/system-spec-kit/scripts/check-links.sh', 'bash'),
    f('.opencode/skills/system-spec-kit/scripts/setup/check-prerequisites.sh', 'bash'),
    f('.opencode/skills/system-spec-kit/scripts/spec/validate.sh', 'bash'),
  ];
}

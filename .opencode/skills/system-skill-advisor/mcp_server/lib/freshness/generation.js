...
import { GenerationMetadataSchema } from '../../schemas/generation-metadata.js';
import { invalidateSkillGraphCaches } from './cache-invalidation.js';
...
export function getSkillGraphGenerationPath(workspaceRoot) {
...
function readLockTokenAndAge(lockPath) {
    try {
...
function acquireGenerationLock(filePath) {
...
export function readSkillGraphGeneration(workspaceRoot) {
...
export function publishSkillGraphGeneration(options) {
...
export async function publishAfterCommit(commit, options) {

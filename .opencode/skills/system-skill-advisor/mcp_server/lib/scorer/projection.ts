...
const COMMAND_BRIDGES: readonly SkillProjection[] = [
  {
    ...
    keywords: ['/spec_kit:plan', '/spec_kit:resume', '/deep:start-research-loop', '/deep:start-review-loop'],
    domains: ['spec-kit', 'command'],
    intentSignals: ['/spec_kit:plan', '/spec_kit:resume', '/deep:start-research-loop', '/deep:start-review-loop'],
    derivedTriggers: [],
    derivedKeywords: [],
    sourcePath: null,

...
const TOKEN_BOOSTS: Readonly<Record<string, readonly [string, number][]>> = {
  ...
  deliberation: [['sk-ai-council', 0.8]],
  debug: [['sk-code', 0.25]],
...
const PHRASE_BOOSTS: Readonly<Record<string, readonly [string, number][]>> = {
  ...
  'deep ai council': [['sk-ai-council', 1.6]],
  'sk-ai-council': [['sk-ai-council', 1.6]],
  'deep-research': [['deep-research', 1.3]],
  'deep-review': [['deep-review', 1.3]],
  'ai council': [['sk-ai-council', 1.4]],
  'planning council': [['sk-ai-council', 1.2]],
  'council deliberation': [['sk-ai-council', 1.4]],
  'persist council artifacts': [['sk-ai-council', 1.2]],
  'ai-council artifacts': [['sk-ai-council', 1.2]],
  'multi-ai-council': [['sk-ai-council', 1.2]],

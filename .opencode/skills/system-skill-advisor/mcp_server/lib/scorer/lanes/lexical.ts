...
const CATEGORY_HINTS: Readonly<Record<string, readonly string[]>> = {
  ...
  'deep-research': ['deep research', 'research loop', 'overnight research', 'delta record', 'state log', 'lineage', 'convergence detection'],
  'deep-review': ['deep review', 'review loop', 'release readiness', 'canonical jsonl', 'convergence tracked', 'iterative review', 'iterative review loop', 'spec folder audit', 'iterative audit', 'multi-pass review', 'review iteration', 'review packet', 'spec folder review'],
  'deep-loop-workflows': ['deep ai council', 'ai council', 'planning council', 'council deliberation', 'multi-seat planning', 'ai-council artifacts', 'persist council artifacts', 'multi-ai-council'],

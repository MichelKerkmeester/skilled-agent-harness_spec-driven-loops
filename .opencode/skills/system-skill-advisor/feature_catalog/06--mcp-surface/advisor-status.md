...
- Feature file path: `06--mcp-surface/advisor-status.md`

Related references:

- [01-advisor-recommend.md](./advisor-recommend.md).
- [05-advisor-rebuild.md](./advisor-rebuild.md).
- [`01--daemon-and-freshness/trust-state.md`](../01--daemon-and-freshness/trust-state.md).
- [`04--scorer-fusion/weights-config.md`](../04--scorer-fusion/weights-config.md).

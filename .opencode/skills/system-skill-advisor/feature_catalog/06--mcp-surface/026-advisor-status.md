...
- Feature file path: `06--mcp-surface/026-advisor-status.md`

Related references:

- [01-advisor-recommend.md](./025-advisor-recommend.md).
- [05-advisor-rebuild.md](./029-advisor-rebuild.md).
- [`01--daemon-and-freshness/005-trust-state.md`](../01--daemon-and-freshness/005-trust-state.md).
- [`04--scorer-fusion/024-weights-config.md`](../04--scorer-fusion/024-weights-config.md).

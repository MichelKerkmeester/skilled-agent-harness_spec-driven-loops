...
- Feature file path: `06--mcp-surface/025-advisor-recommend.md`

Related references:

- [02-advisor-status.md](./026-advisor-status.md).
- [03-advisor-validate.md](./027-advisor-validate.md).
- [04-compat-entrypoint.md](./028-compat-entrypoint.md).

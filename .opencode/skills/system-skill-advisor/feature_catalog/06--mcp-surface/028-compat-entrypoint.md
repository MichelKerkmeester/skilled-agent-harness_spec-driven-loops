...
- Feature file path: `06--mcp-surface/028-compat-entrypoint.md`

Related references:

- [01-advisor-recommend.md](./025-advisor-recommend.md).
- [`07--hooks-and-plugin/037-opencode-plugin-bridge.md`](../07--hooks-and-plugin/037-opencode-plugin-bridge.md).
- [`08--python-compat/038-cli-shim.md`](../08--python-compat/038-cli-shim.md).

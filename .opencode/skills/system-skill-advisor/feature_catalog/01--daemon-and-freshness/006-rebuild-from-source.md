...
- Feature file path: `01--daemon-and-freshness/006-rebuild-from-source.md`

Related references:

- [05-trust-state.md](./005-trust-state.md).
- [07-cache-invalidation.md](./007-cache-invalidation.md).
- [`02--auto-indexing/008-derived-extraction.md`](../02--auto-indexing/008-derived-extraction.md), source extraction pipeline consumed during rebuild.

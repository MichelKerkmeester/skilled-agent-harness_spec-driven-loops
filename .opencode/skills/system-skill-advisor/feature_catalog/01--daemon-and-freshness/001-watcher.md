...
| `Playbook scenario [AU-001](../../manual_testing_playbook/05--auto-update-daemon/022-watcher-narrow-scope.md)` | Manual playbook | manual scope validation |

## 4. SOURCE METADATA

- Group: Daemon and freshness
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `01--daemon-and-freshness/001-watcher.md`

Related references:

- [02-lease.md](./002-lease.md), single-writer lease.
- [03-lifecycle.md](./003-lifecycle.md), daemon lifecycle.
- [04-generation.md](./004-generation.md), generation bump publication.

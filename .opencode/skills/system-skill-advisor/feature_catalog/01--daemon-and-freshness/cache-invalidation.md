...
| `.opencode/skills/system-skill-advisor/mcp_server/lib/prompt-cache.ts` | Library | Source reference |
...
| `Playbook scenario [AU-004](../../manual_testing_playbook/05--auto-update-daemon/generation-publication.md).` | Manual playbook | Source reference |

## 4. SOURCE METADATA

- Group: Daemon and freshness
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `01--daemon-and-freshness/cache-invalidation.md`

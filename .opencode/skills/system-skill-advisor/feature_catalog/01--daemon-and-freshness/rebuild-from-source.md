...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/system-skill-advisor/mcp_server/lib/freshness/rebuild-from-source.ts` | Library | Source reference |
...
- Feature file path: `01--daemon-and-freshness/rebuild-from-source.md`

Related references:

- [05-trust-state.md](./trust-state.md).
- [07-cache-invalidation.md](./cache-invalidation.md).
- [`02--auto-indexing/derived-extraction.md`](../02--auto-indexing/derived-extraction.md), source extraction pipeline consumed during rebuild.

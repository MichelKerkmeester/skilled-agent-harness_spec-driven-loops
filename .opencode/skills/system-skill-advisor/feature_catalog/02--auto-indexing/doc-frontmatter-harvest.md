...
| `Playbook scenario [AI-006](../../manual_testing_playbook/06--auto-indexing/doc-frontmatter-harvest.md).` | Manual playbook | Source reference |

## 4. SOURCE METADATA

- Group: Auto indexing
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `02--auto-indexing/doc-frontmatter-harvest.md`

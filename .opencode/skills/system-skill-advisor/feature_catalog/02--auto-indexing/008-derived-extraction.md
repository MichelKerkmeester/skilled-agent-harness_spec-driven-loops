...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/system-skill-advisor/mcp_server/lib/derived/extract.ts` | Library | Source reference |
...
- Feature file path: `02--auto-indexing/008-derived-extraction.md`

Related references:

- [02-sanitizer.md](./009-sanitizer.md).
- [03-provenance-and-trust-lanes.md](./010-provenance-and-trust-lanes.md).
- [05-anti-stuffing.md](./012-anti-stuffing.md).

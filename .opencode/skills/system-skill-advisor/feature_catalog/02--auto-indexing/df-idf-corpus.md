...
| `Playbook scenario [AI-004](../../manual_testing_playbook/06--auto-indexing/corpus-df-idf.md).` | Manual playbook | Source reference |

## 4. SOURCE METADATA

- Group: Auto indexing
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `02--auto-indexing/df-idf-corpus.md`

Related references:

- [`03--lifecycle-routing/archive-handling.md`](../03--lifecycle-routing/archive-handling.md), archive exclusion.
- [`04--scorer-fusion/five-lane-fusion.md`](../04--scorer-fusion/five-lane-fusion.md).

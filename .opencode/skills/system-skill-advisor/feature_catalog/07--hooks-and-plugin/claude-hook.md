...
| `.opencode/skills/system-skill-advisor/mcp_server/lib/metrics.ts` | Library | `SPECKIT_METRICS_ENABLED` emission gate and `getAdvisorHookAlertThresholds()` cache-hit p95 threshold flags |

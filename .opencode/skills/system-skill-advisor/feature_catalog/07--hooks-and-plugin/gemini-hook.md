...
| File | Type | Role |
|---|---|---|
| `Playbook scenario [CL-003](../../manual_testing_playbook/02--cli-hooks-and-plugin/gemini-user-prompt-submit.md).` | Manual playbook | Source reference |
...
- Feature file path: `07--hooks-and-plugin/gemini-hook.md`

Related references:

- [01-claude-hook.md](./claude-hook.md).
- [04-codex-hook.md](./codex-hook.md).

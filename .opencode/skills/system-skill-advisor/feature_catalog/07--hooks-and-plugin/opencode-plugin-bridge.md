...
| `Playbook scenario [CL-005](../../manual_testing_playbook/02--cli-hooks-and-plugin/opencode-plugin-bridge.md).` | Manual playbook | Source reference |

## 4. SOURCE METADATA

- Group: Hooks and plugin
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `07--hooks-and-plugin/opencode-plugin-bridge.md`

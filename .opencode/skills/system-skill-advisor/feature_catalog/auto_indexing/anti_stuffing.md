...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/system-skill-advisor/mcp_server/lib/derived/anti-stuffing.ts` | Library | Source reference |
...
| `Playbook scenario [AI-005](../../manual_testing_playbook/auto-indexing/anti-stuffing.md).` | Manual playbook | Source reference |

## 4. SOURCE METADATA

- Group: Auto indexing
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `auto-indexing/anti-stuffing.md`

...
- Feature file path: `03--lifecycle-routing/017-schema-migration.md`

Related references:

- [05-rollback.md](./018-rollback.md).
- [`01--daemon-and-freshness/006-rebuild-from-source.md`](../01--daemon-and-freshness/006-rebuild-from-source.md).
- [`02--auto-indexing/011-sync.md`](../02--auto-indexing/011-sync.md).

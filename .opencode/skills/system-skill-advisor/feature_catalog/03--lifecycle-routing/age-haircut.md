...
| `Playbook scenario [LC-001](../../manual_testing_playbook/07--lifecycle-routing/032-age-haircut.md).` | Manual playbook | Source reference |

## 4. SOURCE METADATA

- Group: Lifecycle routing
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `03--lifecycle-routing/age-haircut.md`

Related references:

- [`04--scorer-fusion/five-lane-fusion.md`](../04--scorer-fusion/five-lane-fusion.md).
- [`04--scorer-fusion/attribution.md`](../04--scorer-fusion/attribution.md).

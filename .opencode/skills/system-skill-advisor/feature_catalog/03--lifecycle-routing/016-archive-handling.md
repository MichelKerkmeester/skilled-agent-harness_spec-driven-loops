...
| `Playbook scenario [LC-003](../../manual_testing_playbook/07--lifecycle-routing/034-archive-handling.md).` | Manual playbook | Source reference |

## 4. SOURCE METADATA

- Group: Lifecycle routing
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `03--lifecycle-routing/016-archive-handling.md`

Related references:

- [`02--auto-indexing/013-df-idf-corpus.md`](../02--auto-indexing/013-df-idf-corpus.md).
- [02-supersession.md](./015-supersession.md).
- [04-schema-migration.md](./017-schema-migration.md).

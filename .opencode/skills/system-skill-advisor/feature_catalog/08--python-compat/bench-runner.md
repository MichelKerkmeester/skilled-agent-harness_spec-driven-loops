...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/system-skill-advisor/mcp_server/scripts/skill_advisor_bench.py` | Script | Source reference |
| `.opencode/skills/system-skill-advisor/mcp_server/bench/` | Implementation | Source reference |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `Playbook scenario [PC-005](../../manual_testing_playbook/10--python-compat/bench-runner.md).` | Manual playbook | Source reference |

## 4. SOURCE METADATA

- Group: Python compat
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `08--python-compat/bench-runner.md`

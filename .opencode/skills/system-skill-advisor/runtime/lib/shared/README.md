...
- Do not place tool handler registration, database mutation flows or test fixtures in this folder.
...
Runtime imports should compile into `runtime/dist/runtime/lib/shared/`.
...
python3 .opencode/skills/sk-doc/scripts/validate_document.py .opencode/skills/system-skill-advisor/runtime/lib/shared/README.md
```

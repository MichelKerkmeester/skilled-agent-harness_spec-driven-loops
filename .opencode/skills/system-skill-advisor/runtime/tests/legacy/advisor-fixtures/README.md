...
```bash
npm --prefix .opencode/skills/system-skill-advisor/runtime run test -- tests/legacy
python3 .opencode/skills/sk-doc/scripts/validate_document.py .opencode/skills/system-skill-advisor/runtime/tests/legacy/advisor-fixtures/README.md
```

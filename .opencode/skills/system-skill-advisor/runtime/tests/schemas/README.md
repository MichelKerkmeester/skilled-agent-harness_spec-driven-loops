...
description: "Vitest coverage for skill advisor tool input schemas and workspaceRoot allowlist checks."
trigger_phrases:
...
`tests/schemas/` verifies advisor tool input schemas and path-bounding rules for workspace roots.

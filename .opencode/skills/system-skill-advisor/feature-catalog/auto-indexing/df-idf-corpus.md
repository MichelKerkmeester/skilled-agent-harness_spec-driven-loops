...
- Feature file path: `auto-indexing/df-idf-corpus.md`

Related references:

- [`lifecycle-routing/archive-handling.md`](../../feature-catalog/lifecycle-routing/archive-handling.md), archive exclusion.

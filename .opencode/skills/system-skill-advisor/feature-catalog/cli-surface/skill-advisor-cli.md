...
| File | Type | Role |
|---|---|---|
| `runtime/tests/skill-advisor-cli-parity.vitest.ts` | Automated test | 10-prompt local-vs-native parity fixture (runs real python3) |
...
- Feature file path: `cli-surface/skill-advisor-cli.md`
Related references:
- [compat-entrypoint.md](../../feature-catalog/cli-surface/compat-entrypoint.md) — Stable compat entrypoint

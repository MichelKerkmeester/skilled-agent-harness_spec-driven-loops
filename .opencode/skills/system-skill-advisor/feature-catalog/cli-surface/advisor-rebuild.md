---
title: "advisor_rebuild Command"
description: "Explicit operator command that rebuilds the native advisor skill graph from checked-in skill metadata when advisor_status reports stale, absent or unavailable state."
trigger_phrases:
  - "advisor_rebuild"
  - "advisor rebuild"
...
- Feature file path: `cli-surface/advisor-rebuild.md`

Related references:

- [02-advisor-status.md](../../feature-catalog/cli-surface/advisor-status.md).

...
| `system-skill-advisor/runtime/handlers/skill-graph/status.ts` | Handler |
...
- Feature file path: `cli-surface/skill-graph-status.md`
Related references:
- [skill-graph-query.md](../../feature-catalog/cli-surface/skill-graph-query.md) — Skill graph query
- [skill-graph-validate.md](../../feature-catalog/cli-surface/skill-graph-validate.md) — Skill graph validate

...
description: "z_archive/ and z-future/ skills are visible to inspection tools but excluded from live routing and active-corpus statistics."
trigger_phrases:
  - "archive handling"
  - "z_archive skills"
  - "z_future skills"
...
- [`auto-indexing/df-idf-corpus.md`](../../feature-catalog/auto-indexing/df-idf-corpus.md).

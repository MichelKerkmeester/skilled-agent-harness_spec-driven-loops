...
| `system-skill-advisor/mcp-server/handlers/skill-graph/status.ts` | Handler |
...
Related references:
- [skill-graph-query.md](../../feature-catalog/mcp-surface/skill-graph-query.md) — Skill graph query
- [skill-graph-validate.md](../../feature-catalog/mcp-surface/skill-graph-validate.md) — Skill graph validate

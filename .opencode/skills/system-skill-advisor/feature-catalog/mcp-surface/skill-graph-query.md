...
| `system-skill-advisor/mcp-server/handlers/skill-graph/query.ts` | Handler |
...
Related references:
- [skill-graph-scan.md](../../feature-catalog/mcp-surface/skill-graph-scan.md) — Skill graph scan

...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/system-skill-advisor/mcp-server/handlers/advisor-status.ts:89-197` | Handler | Source reference |
...
| `.opencode/skills/system-skill-advisor/mcp-server/lib/scorer/lanes/semantic-shadow.ts` | Library | semantic-lane disabled-reason source |
| `.opencode/skills/system-skill-advisor/mcp-server/handlers/advisor-rebuild.ts:46-51` | Handler | Source reference |
...
- [05-advisor-rebuild.md](../../feature-catalog/mcp-surface/advisor-rebuild.md).

...
- Scenario [AU-002](./023-lease-single-writer.md), single-writer lease reclaim.
- Scenario [OP-001](../04--operator-h5/019-degraded-daemon.md), degraded state detection.
...
- Feature file path: 05--auto-update-daemon/024-daemon-lifecycle-shutdown.md

...
- Scenario [AU-003](./024-daemon-lifecycle-shutdown.md), graceful shutdown and SIGTERM.
- Scenario [OP-003](../04--operator-h5/021-unavailable-daemon.md), recovery from unreadable DB.
...
- Feature file path: 05--auto-update-daemon/023-lease-single-writer.md

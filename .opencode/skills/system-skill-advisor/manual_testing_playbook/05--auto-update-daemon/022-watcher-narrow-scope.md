...
- Scenario [AU-002](./023-lease-single-writer.md), single-writer lease semantics.
- Scenario [AU-004](./025-generation-publication.md), generation bump publication.
...
- Feature file path: 05--auto-update-daemon/022-watcher-narrow-scope.md

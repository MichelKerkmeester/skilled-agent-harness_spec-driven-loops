...
- Scenario [AU-001](./022-watcher-narrow-scope.md), watcher scope.
- Scenario [AU-005](./026-rebuild-from-source.md), recovery when snapshot unreadable.
...
- Feature file path: 05--auto-update-daemon/025-generation-publication.md

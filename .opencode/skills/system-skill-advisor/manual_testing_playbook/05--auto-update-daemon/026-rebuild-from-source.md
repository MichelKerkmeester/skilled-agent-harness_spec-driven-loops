...
- Scenario [OP-003](../04--operator-h5/021-unavailable-daemon.md), operator recovery flow.
- Scenario [AU-004](./025-generation-publication.md), generation publication after rebuild.
...
- Feature file path: 05--auto-update-daemon/026-rebuild-from-source.md

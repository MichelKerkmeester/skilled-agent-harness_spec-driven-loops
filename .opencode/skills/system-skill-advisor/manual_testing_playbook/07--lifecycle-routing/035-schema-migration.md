...
- Scenario [LC-005](./036-rollback-lifecycle.md), lifecycle rollback.
- Scenario [AU-005](../05--auto-update-daemon/026-rebuild-from-source.md), rebuild-from-source.
...
- Feature file path: 07--lifecycle-routing/035-schema-migration.md

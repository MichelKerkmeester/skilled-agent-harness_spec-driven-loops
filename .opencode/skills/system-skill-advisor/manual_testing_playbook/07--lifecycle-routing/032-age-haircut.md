...
- Scenario [LC-002](./033-supersession.md), supersession redirects.
- Scenario [SC-001](../08--scorer-fusion/037-five-lane-fusion.md), 5-lane fusion basics.
...
- Feature file path: 07--lifecycle-routing/032-age-haircut.md

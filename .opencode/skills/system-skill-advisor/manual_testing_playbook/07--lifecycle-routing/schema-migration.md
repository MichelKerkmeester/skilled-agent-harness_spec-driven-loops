...
- Scenario [LC-005](./rollback-lifecycle.md), lifecycle rollback.
- Scenario [AU-005](../05--auto-update-daemon/rebuild-from-source.md), rebuild-from-source.
- Feature [`03--lifecycle-routing/schema-migration.md`](../../feature_catalog/03--lifecycle-routing/schema-migration.md).
...
- Feature file path: 07--lifecycle-routing/schema-migration.md

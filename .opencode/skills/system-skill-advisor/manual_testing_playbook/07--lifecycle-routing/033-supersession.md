...
- Scenario [LC-005](./036-rollback-lifecycle.md), lifecycle-level rollback.
- Feature [`03--lifecycle-routing/015-supersession.md`](../../feature_catalog/03--lifecycle-routing/015-supersession.md).
...
- Feature file path: 07--lifecycle-routing/033-supersession.md

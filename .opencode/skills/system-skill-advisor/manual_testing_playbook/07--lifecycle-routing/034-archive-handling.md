...
- Scenario [AI-004](../06--auto-indexing/030-corpus-df-idf.md), active-only corpus.
- Scenario [LC-002](./033-supersession.md), supersession routing.
...
- Feature file path: 07--lifecycle-routing/034-archive-handling.md

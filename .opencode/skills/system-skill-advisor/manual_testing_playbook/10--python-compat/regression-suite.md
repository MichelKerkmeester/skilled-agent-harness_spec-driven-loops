...
- Scenario [NC-003](../01--native-mcp-tools/native-validate-slices.md), native validate.
- Feature [`08--python-compat/regression-suite.md`](../../feature_catalog/08--python-compat/regression-suite.md).
...
- Feature file path: 10--python-compat/regression-suite.md
...
Skill graph: loaded from SQLite
{
  ...
  "overall_pass": false,
  "failures": [
    "P1-RESEARCH-001 inprocess expected_top_any=[sk-deep-research] actual_top=deep-loop-workflows passed=false checks.top_ok=false",
    "P1-RESEARCH-002 inprocess expected_top_any=[sk-deep-research] actual_top=deep-loop-workflows passed=false checks.top_ok=false",
    "P1-REVIEW-003 inprocess expected_top_any=[sk-deep-review] actual_top=deep-loop-workflows passed=false checks.top_ok=false",
    "P1-REVIEW-004 inprocess expected_top_any=[sk-deep-review] actual_top=deep-loop-workflows passed=false checks.top_ok=false",
    ...
    "P1-RESEARCH-001 subprocess expected_top_any=[sk-deep-research] actual_top=deep-loop-workflows passed=false checks.top_ok=false",
    "P1-RESEARCH-002 subprocess expected_top_any=[sk-deep-research] actual_top=deep-loop-workflows passed=false checks.top_ok=false",
    "P1-REVIEW-003 subprocess expected_top_any=[sk-deep-review] actual_top=deep-loop-workflows passed=false checks.top_ok=false",
    "P1-REVIEW-004 subprocess expected_top_any=[sk-deep-review] actual_top=deep-loop-workflows passed=false checks.top_ok=false",

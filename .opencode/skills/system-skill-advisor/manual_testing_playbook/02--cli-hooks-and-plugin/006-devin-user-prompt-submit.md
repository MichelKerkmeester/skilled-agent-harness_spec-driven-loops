...
description: "Manual validation for the Devin CLI prompt-time skill advisor hook routed through the system-spec-kit shim."
trigger_phrases:
  - "cl-006"
...
```bash
ls .opencode/skills/system-spec-kit/mcp_server/dist/system-spec-kit/mcp_server/hooks/devin/user-prompt-submit.js
ls .opencode/skills/system-skill-advisor/mcp_server/dist/system-skill-advisor/hooks/devin/user-prompt-submit.js
```
...
Expect a string containing `system-spec-kit/mcp_server/dist/system-spec-kit/mcp_server/hooks/devin/user-prompt-submit.js`.
...
printf '%s' '{"prompt":"implement OAuth login flow with refresh tokens and CSRF protection","cwd":"'"$PWD"'","session_id":"cl-006","hook_event_name":"UserPromptSubmit"}' \
  | node .opencode/skills/system-spec-kit/mcp_server/dist/system-spec-kit/mcp_server/hooks/devin/user-prompt-submit.js \
...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/025-cli-devin-skill-advisor-hook/decision-record.md` (ADR-001 hybrid strategy, ADR-003 bridge migration)

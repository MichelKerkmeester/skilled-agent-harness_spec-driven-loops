...
- Scenario [AI-002](../auto_indexing/sanitizer_boundaries.md), sanitizer at write boundaries.
- Feature [`auto-indexing/anti-stuffing.md`](../../feature_catalog/auto_indexing/anti_stuffing.md).

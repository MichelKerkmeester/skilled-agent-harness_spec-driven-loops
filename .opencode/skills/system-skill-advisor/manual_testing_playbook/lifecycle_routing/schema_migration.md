...
- Scenario [AU-005](../auto-update-daemon/rebuild-from-source.md), rebuild-from-source.
- Feature [`lifecycle-routing/schema-migration.md`](../../feature_catalog/lifecycle-routing/schema-migration.md).

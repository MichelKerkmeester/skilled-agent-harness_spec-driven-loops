...
- Scenario [LC-003](../07--lifecycle-routing/034-archive-handling.md), archive indexing but not routing.
- Scenario [SC-002](../08--scorer-fusion/038-projection.md), projection input for scorer.
...
- Feature file path: 06--auto-indexing/030-corpus-df-idf.md

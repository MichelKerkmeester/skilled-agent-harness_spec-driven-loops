...
- Scenario [AI-001](./027-derived-extraction.md), deterministic extraction.
- Scenario [SC-004](../08--scorer-fusion/040-lane-attribution.md), lane attribution on the read side.
...
- Feature file path: 06--auto-indexing/029-provenance-and-trust-lanes.md

...
- Scenario [AI-002](./028-sanitizer-boundaries.md), A7 sanitizer boundary enforcement.
- Scenario [AI-003](./029-provenance-and-trust-lanes.md), provenance and trust lane tagging.
- Feature [`02--auto-indexing/008-derived-extraction.md`](../../feature_catalog/02--auto-indexing/008-derived-extraction.md).
...
- Feature file path: 06--auto-indexing/027-derived-extraction.md

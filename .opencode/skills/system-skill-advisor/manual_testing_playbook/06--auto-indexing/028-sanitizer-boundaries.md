...
- Scenario [AI-001](./027-derived-extraction.md), derived extraction correctness.
- Scenario [AI-005](./031-anti-stuffing.md), repetition-density and adversarial rejection.
...
- Feature file path: 06--auto-indexing/028-sanitizer-boundaries.md

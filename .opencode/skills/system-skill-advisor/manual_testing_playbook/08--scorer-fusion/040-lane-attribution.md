...
- Scenario [SC-001](./037-five-lane-fusion.md), fusion weights sanity.
- Scenario [SC-005](./041-ablation.md), ablation protocol.
...
- Feature file path: 08--scorer-fusion/040-lane-attribution.md

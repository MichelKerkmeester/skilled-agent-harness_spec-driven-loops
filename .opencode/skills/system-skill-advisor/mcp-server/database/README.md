...
```bash
python3 .opencode/skills/system-skill-advisor/mcp-server/scripts/skill_advisor.py --health
python3 .opencode/skills/sk-doc/scripts/validate_document.py .opencode/skills/system-skill-advisor/mcp-server/database/README.md
```
...
- [../../references/config/db-path-policy.md](../../references/config/db-path-policy.md)
- [../README.md](../README.md)

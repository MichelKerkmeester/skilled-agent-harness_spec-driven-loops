...
```bash
npx vitest run .opencode/skills/system-skill-advisor/mcp-server/tests/compat/plugin-bridge.vitest.ts
npx vitest run .opencode/skills/system-skill-advisor/mcp-server/tests/compat/plugin-bridge-smoke.vitest.ts
```

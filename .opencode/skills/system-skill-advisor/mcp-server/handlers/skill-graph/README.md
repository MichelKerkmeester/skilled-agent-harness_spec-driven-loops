...
Moved from `system-spec-kit/mcp-server/handlers/skill-graph/` in 013/009/008. Packet 013/009/011 moved the SQLite DB/query layer into this package so handlers and lifecycle share one owner.

...
description: "Code-facing README for .opencode/skills/system-skill-advisor/mcp-server/lib/scorer/lanes/__tests__."
trigger_phrases:
  - "system-skill-advisor mcp-server/lib/scorer/lanes/__tests__"
  - "code README"
---
...
This README documents the code-bearing folder `.opencode/skills/system-skill-advisor/mcp-server/lib/scorer/lanes/__tests__` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/system-skill-advisor/mcp-server/lib/scorer/lanes/__tests__
```
...
|---|---|
| Folder boundary | Documents direct code files under `mcp-server/lib/scorer/lanes/__tests__`. |
...
```text
User request: Check .opencode/skills/system-skill-advisor/mcp-server/lib/scorer/lanes/__tests__ for sk-code and README coverage.

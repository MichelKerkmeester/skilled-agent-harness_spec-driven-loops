...
Runtime imports should compile into `mcp-server/dist/mcp-server/lib/shared/`.
...
python3 .opencode/skills/sk-doc/scripts/validate_document.py .opencode/skills/system-skill-advisor/mcp-server/lib/shared/README.md
```

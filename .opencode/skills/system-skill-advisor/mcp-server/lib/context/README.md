...
description: "Code-facing README for .opencode/skills/system-skill-advisor/mcp-server/lib/context."
trigger_phrases:
...
This README documents the code-bearing folder `.opencode/skills/system-skill-advisor/mcp-server/lib/context` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/system-skill-advisor/mcp-server/lib/context
```
...
|---|---|
| Folder boundary | Documents direct code files under `mcp-server/lib/context`. |
...
```text
User request: Check .opencode/skills/system-skill-advisor/mcp-server/lib/context for sk-code and README coverage.

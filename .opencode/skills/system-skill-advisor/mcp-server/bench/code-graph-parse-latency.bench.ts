...
import { parseFile } from '../../../system-code-graph/mcp-server/lib/structural-indexer.js';
import { speckitMetrics } from '../lib/metrics.js';
import { findAdvisorWorkspaceRoot } from '../lib/utils/workspace-root.js';
import type { SupportedLanguage } from '../../../system-code-graph/mcp-server/lib/indexer-types.js';
...
function buildFixtures(root: string): readonly Fixture[] {
  ...
  return [
    f('.opencode/skills/system-code-graph/mcp-server/code_graph/lib/runtime-detection.ts', 'typescript'),
    f('.opencode/skills/system-code-graph/mcp-server/code_graph/lib/budget-allocator.ts', 'typescript'),
    f('.opencode/skills/system-code-graph/mcp-server/code_graph/lib/ensure-ready.ts', 'typescript'),

...
4. Update synchronized docs in one commit:
   ...
   - [`feature_catalog/scorer_fusion/weights_config.md`](../../feature_catalog/scorer_fusion/weights_config.md)
...
- [`feature_catalog/scorer_fusion/weights_config.md`](../../feature_catalog/scorer_fusion/weights_config.md), canonical current weights.
- [`manual_testing_playbook/scorer_fusion/ablation.md`](../../manual_testing_playbook/scorer_fusion/ablation.md), ablation scenario for measuring lane contributions.

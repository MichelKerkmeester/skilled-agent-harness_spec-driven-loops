...
4. Update synchronized docs in one commit:
   ...
   - [`feature_catalog/scorer-fusion/weights-config.md`](../../feature_catalog/scorer-fusion/weights-config.md)
...
- [`feature_catalog/scorer-fusion/weights-config.md`](../../feature_catalog/scorer-fusion/weights-config.md), canonical current weights.
- [`manual_testing_playbook/scorer-fusion/ablation.md`](../../manual_testing_playbook/scorer-fusion/ablation.md), ablation scenario for measuring lane contributions.

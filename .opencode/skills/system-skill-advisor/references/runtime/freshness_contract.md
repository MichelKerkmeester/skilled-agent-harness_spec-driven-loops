...
- [`feature_catalog/daemon_and_freshness/`](../../feature_catalog/daemon_and_freshness/), feature inventory for daemon + freshness components.
- [`manual_testing_playbook/auto_update_daemon/`](../../manual_testing_playbook/auto_update_daemon/), operator scenarios for daemon validation.

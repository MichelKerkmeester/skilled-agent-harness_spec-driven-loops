...
- [`feature_catalog/daemon-and-freshness/`](../../feature_catalog/daemon-and-freshness/), feature inventory for daemon + freshness components.
- [`manual_testing_playbook/auto-update-daemon/`](../../manual_testing_playbook/auto-update-daemon/), operator scenarios for daemon validation.

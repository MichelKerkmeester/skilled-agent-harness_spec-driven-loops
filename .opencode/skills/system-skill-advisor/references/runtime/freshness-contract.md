...
- [`tool-ids-reference.md`](./tool-ids-reference.md), `advisor_status` returns trustState, `advisor_rebuild` transitions stale → live.
- [`advisor-scorer.md`](../scoring/advisor-scorer.md), confidence calibration depends on trust state for some routes.

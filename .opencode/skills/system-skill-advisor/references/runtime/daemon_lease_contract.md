...
- `feature_catalog/daemon_and_freshness/lease.md`, feature inventory entry
- `manual_testing_playbook/auto_update_daemon/lease_single_writer.md`, operator scenario

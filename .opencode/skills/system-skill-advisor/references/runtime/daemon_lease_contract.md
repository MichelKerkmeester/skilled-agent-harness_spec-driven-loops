...
- `feature_catalog/01--daemon-and-freshness/002-lease.md`, feature inventory entry
- `manual_testing_playbook/05--auto-update-daemon/023-lease-single-writer.md`, operator scenario

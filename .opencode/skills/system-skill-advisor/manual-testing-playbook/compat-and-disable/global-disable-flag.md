...
```bash
SPECKIT_SKILL_ADVISOR_HOOK_DISABLED=1 python3 .opencode/skills/system-skill-advisor/mcp-server/scripts/skill_advisor.py "help me commit my changes"
```
...
```bash
printf '%s' '{"prompt":"help me commit my changes","workspaceRoot":"'"$PWD"'","cwd":"'"$PWD"'"}' | SPECKIT_SKILL_ADVISOR_HOOK_DISABLED=1 node .opencode/skills/system-skill-advisor/mcp-server/plugin-bridges/system-skill-advisor-bridge.mjs
```

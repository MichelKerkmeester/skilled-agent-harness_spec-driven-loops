...
Validate the native `advisor_recommend` command with a prompt that should map to `system-spec-kit`.
...
- Feature file path: native-cli-tools/native-recommend-happy-path.md

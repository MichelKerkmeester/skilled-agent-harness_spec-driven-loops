...
- Use a disposable workspace copy or a scratch sink path so the live `runtime/data/shadow-deltas.jsonl` file is not mutated.
...
- Feature file path: native-cli-tools/shadow-delta-sink.md
...
```text
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-skill-advisor/runtime/data/shadow-deltas.jsonl
```

Shadow sink contract test file presence check:

```text
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-skill-advisor/runtime/tests/shadow-sink.vitest.ts
```

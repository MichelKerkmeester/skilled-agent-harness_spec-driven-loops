...
expected_leaf_resources:
  - workflow_mode: system-skill-advisor
    leaf_resource_id: feature-catalog/mcp-surface/advisor-recommend.md
---
...
```bash
cd .opencode/skills/system-skill-advisor/mcp-server && npm exec -- vitest run tests/lifecycle-derived-metadata.vitest.ts tests/compat/plugin-bridge.vitest.ts --reporter=default
```
...
- `.opencode/skills/system-skill-advisor/mcp-server/lib/lifecycle/`

...
Verify the code-graph SQLite database lives at the correct active path (`.opencode/skills/system-code-graph/mcp_server/database/code-graph.sqlite`) and no legacy database paths are active.

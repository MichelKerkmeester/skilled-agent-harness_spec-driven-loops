...
| `.opencode/commands/deep/assets/deep-research-auto.yaml` `step_graph_upsert` | Call site | conditionally calls upsert for research graph events |
| `.opencode/commands/deep/assets/deep-review-auto.yaml` `step_seed_coverage_graph` and `step_graph_upsert` | Call site | seeds and conditionally upserts review graph events |
...
- [../../manual-testing-playbook/coverage-graph/deep-loop-graph-upsert-conditional.md](../../manual-testing-playbook/coverage-graph/deep-loop-graph-upsert-conditional.md)

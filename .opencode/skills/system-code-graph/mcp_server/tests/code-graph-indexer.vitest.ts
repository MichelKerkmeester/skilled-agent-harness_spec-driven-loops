...
describe('indexer-types', () => {
  ...
  describe('getDefaultConfig', () => {
    ...
    it('supports granular per-call skill selection with one, two and zero skills', () => {
      ...
      expect(shouldIndexForCodeGraph('/root/.opencode/skills/sk-doc/SKILL.md', oneSkill.scopePolicy)).toBe(true);
      expect(shouldIndexForCodeGraph('/root/.opencode/skills/sk-code-review/SKILL.md', oneSkill.scopePolicy)).toBe(false);
      ...
      expect(shouldIndexForCodeGraph('/root/.opencode/skills/sk-code-review/SKILL.md', twoSkills.scopePolicy)).toBe(true);
      expect(shouldIndexForCodeGraph('/root/.opencode/skills/sk-doc/SKILL.md', twoSkills.scopePolicy)).toBe(true);
      ...
      expect(noSkills.excludeGlobs).toContain('**/.opencode/skills/**');
    ...
    it('supports granular skill selection from csv env', () => {
      ...
      expect(shouldIndexForCodeGraph('/root/.opencode/skills/sk-doc/SKILL.md', config.scopePolicy)).toBe(true);
      expect(shouldIndexForCodeGraph('/root/.opencode/skills/sk-code-review/SKILL.md', config.scopePolicy)).toBe(true);
      expect(shouldIndexForCodeGraph('/root/.opencode/skills/deep-review/SKILL.md', config.scopePolicy)).toBe(false);
    });
    ...
    it('skips .opencode/skill candidates before parsing by default and includes them with opt-in', async () => {
      ...
      try {
        ...
        const skillFilePath = writeWorkspaceFile(
          tempDir,
          '.opencode/skills/example/SKILL.ts',

...
`mcp_server/tools/` owns the MCP tool dispatch surface for code graph operations. It maps incoming tool names to handler functions and keeps the public export small.

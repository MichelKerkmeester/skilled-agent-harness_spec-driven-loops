...
//   - mcp_server/handlers/query.ts:791-828 (buildFallbackDecision +
//     blocked payload)
//   - mcp_server/lib/ensure-ready.ts:151-217 (full-scan state
//     detection)
...
import * as codeGraphDb from '../../lib/code-graph-db.js';
import {
  closeDb,
  initDb,
  upsertFile,
...
import { SELECTIVE_REINDEX_THRESHOLD } from '../../lib/ensure-ready.js';

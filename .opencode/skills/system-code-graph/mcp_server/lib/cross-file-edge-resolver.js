...
const CALL_TARGET_KINDS = new Set(['function', 'method', 'class']);
...
function hasResolutionActivity(stats) {
    return stats.resolved > 0 || stats.unresolved > 0 || stats.ambiguousSkipped > 0;
}
export function hasCrossFileCallResolutionActivity(stats) {
...
export function resolveCrossFileCallEdges() {
    ...
    return d.transaction(() => {
      ...
      FROM code_nodes
    `).all();
        const callableNodesByName = new Map();
...
//# sourceMappingURL=cross-file-edge-resolver.js.map
 ...
 */
export function canonicalizeWorkspacePaths(rootDir, workspaceRoot = process.cwd()) {
    try {
 ...
 */
export function isWithinWorkspace(canonicalWorkspace, candidatePath) {
 ...
 */
export function assertWithinWorkspace(canonicalWorkspace, candidatePath, label) {

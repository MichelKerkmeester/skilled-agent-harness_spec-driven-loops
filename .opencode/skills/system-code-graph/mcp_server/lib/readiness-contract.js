...
import { buildStructuralTrustFromProvenance, } from '../../../system-spec-kit/mcp_server/lib/context/shared-payload.js';
 ...
 */
export function canonicalReadinessFromFreshness(freshness) {
    switch (freshness) {
        case 'fresh':
            return 'ready';
        case 'stale':
 ...
 */
export function queryTrustStateFromFreshness(freshness) {
    switch (freshness) {
        case 'fresh':
            return 'live';
        case 'stale':
 ...
 */
function getPersistedDetectorProvenance(readiness) {
...
function buildQueryTrustArtifacts(readiness, detectorProvenance = getPersistedDetectorProvenance(readiness)) {
...
export function buildQueryGraphMetadata(readiness) {
    return buildQueryTrustArtifacts(readiness).graphMetadata;
}
export function buildQueryStructuralTrust(readiness) {
    return buildQueryTrustArtifacts(readiness).structuralTrust;
}
export function buildQueryTrustMetadata(readiness) {
 ...
 * Origin: M8 / T-CGQ-11.
 */
export function buildReadinessBlock(readiness) {
    return {
        ...readiness,
...
//# sourceMappingURL=readiness-contract.js.map
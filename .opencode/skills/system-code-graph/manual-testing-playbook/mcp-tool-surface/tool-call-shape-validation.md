...
expected_leaf_resources:
  - workflow_mode: system-code-graph
    leaf_resource_id: manual-testing-playbook/mcp-tool-surface/tool-call-shape-validation.md
---
...
Valid routing check command: `node .opencode/bin/code-index.cjs code_graph_query --json '{"operation":"outline","subject":".opencode/skills/system-code-graph/manual-testing-playbook/mcp-tool-surface/tool-call-shape-validation.md"}' --format json --timeout-ms 3000 --warm-only`

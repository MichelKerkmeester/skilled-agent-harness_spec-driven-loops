...
expected_leaf_resources:
  - workflow_mode: system-code-graph
    leaf_resource_id: manual-testing-playbook/manual-scan-verify-status/code-graph-verify-blocked-on-stale.md
---
...
ALLOWED WRITE PATHS
- .opencode/skills/system-code-graph/manual-testing-playbook/manual-scan-verify-status/code-graph-verify-blocked-on-stale.md (this file only)
```

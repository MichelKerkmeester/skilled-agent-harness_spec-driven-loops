...
expected_leaf_resources:
  - workflow_mode: system-code-graph
    leaf_resource_id: manual-testing-playbook/manual-scan-verify-status/code-graph-scan-full.md
---
...
47: 
48: ```text
49: .opencode/skills/system-code-graph/mcp-server/database/code-graph.sqlite
50: ```
...
ALLOWED WRITE PATHS
- .opencode/skills/system-code-graph/manual-testing-playbook/manual-scan-verify-status/code-graph-scan-full.md (this file only)
```

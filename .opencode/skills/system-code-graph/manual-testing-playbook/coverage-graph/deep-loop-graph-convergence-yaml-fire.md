...
expected_leaf_resources:
  - workflow_mode: system-code-graph
    leaf_resource_id: manual-testing-playbook/coverage-graph/deep-loop-graph-convergence-yaml-fire.md
---
...
1. Inspect `.opencode/commands/deep/assets/deep-research-auto.yaml` `step_graph_convergence`.
2. Inspect `.opencode/commands/deep/assets/deep-review-auto.yaml` `step_graph_convergence`.
...
Command 1: Inspect `.opencode/commands/deep/assets/deep-research-auto.yaml` `step_graph_convergence`.
...
Command 2: Inspect `.opencode/commands/deep/assets/deep-review-auto.yaml` `step_graph_convergence`.
...
```text
Not run. The fixture step is optional in this scenario, and the session write constraint allows modifying only .opencode/skills/system-code-graph/manual-testing-playbook/coverage-graph/deep-loop-graph-convergence-yaml-fire.md.
```

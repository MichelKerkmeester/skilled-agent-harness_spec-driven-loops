...
```bash
python3 -m json.tool .opencode/skills/system-code-graph/mcp-server/tests/assets/code-graph-gold-queries.json >/dev/null
python3 .opencode/skills/sk-doc/scripts/validate_document.py --type readme .opencode/skills/system-code-graph/mcp-server/tests/assets/README.md
```

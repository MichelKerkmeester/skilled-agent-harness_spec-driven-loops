...
//   - mcp-server/handlers/query.ts:791-828 (buildFallbackDecision +
//     blocked payload)
//   - mcp-server/lib/ensure-ready.ts:151-217 (full-scan state
//     detection)
//   - mcp-server/tests/code-graph-query-fallback-decision.vitest.ts

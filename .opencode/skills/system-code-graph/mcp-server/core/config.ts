...
// Default DB dir = the SKILL-LOCAL location `.opencode/skills/system-code-graph/mcp-server/database`
...
const defaultDir = resolve(resolveWorkspaceRoot(), '.opencode/skills/system-code-graph/mcp-server/database');

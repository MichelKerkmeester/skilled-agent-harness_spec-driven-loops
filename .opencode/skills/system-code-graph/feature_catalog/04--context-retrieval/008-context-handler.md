...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/system-code-graph/mcp_server/handlers/context.ts:112-151` | Handler | matches normalized seed source metadata back onto resolved anchors |
| `.opencode/skills/system-code-graph/mcp_server/handlers/context.ts:232-280` | Handler | normalizes query mode and seed payloads |
| `.opencode/skills/system-code-graph/mcp_server/lib/code-graph-context.ts` | Library | owns compact graph context assembly and token-budget behavior |
| `.opencode/skills/system-code-graph/mcp_server/lib/budget-allocator.ts` | Library | owns context budget allocation |
...
- Feature file path: `04--context-retrieval/008-context-handler.md`

Related references:

- [01-code-graph-context.md](./007-code-graph-context.md)
- [../06--mcp-tool-surface/013-tool-registrations.md](../06--mcp-tool-surface/013-tool-registrations.md)

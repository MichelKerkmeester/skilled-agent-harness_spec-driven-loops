...
- Feature file path: `04--context-retrieval/007-code-graph-context.md`

Related references:

- [02-context-handler.md](./008-context-handler.md)
- [../01--read-path-freshness/001-ensure-code-graph-ready.md](../01--read-path-freshness/001-ensure-code-graph-ready.md)

...
- Feature file path: `05--coverage-graph/010-deep-loop-graph-status.md`

Related references:

- [01-deep-loop-graph-query.md](./009-deep-loop-graph-query.md)
- [04-deep-loop-graph-convergence.md](./012-deep-loop-graph-convergence.md)

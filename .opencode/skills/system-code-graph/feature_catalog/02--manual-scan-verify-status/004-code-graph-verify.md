...
- Feature file path: `02--manual-scan-verify-status/004-code-graph-verify.md`

Related references:

- [01-code-graph-scan.md](./003-code-graph-scan.md)
- [../08--doctor-code-graph/014-doctor-apply-mode.md](../08--doctor-code-graph/014-doctor-apply-mode.md)

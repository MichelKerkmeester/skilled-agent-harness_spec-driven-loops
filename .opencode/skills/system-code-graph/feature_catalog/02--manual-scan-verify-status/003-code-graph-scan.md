...
- Feature file path: `02--manual-scan-verify-status/003-code-graph-scan.md`

Related references:

- [02-code-graph-verify.md](./004-code-graph-verify.md)
- [03-code-graph-status.md](./005-code-graph-status.md)

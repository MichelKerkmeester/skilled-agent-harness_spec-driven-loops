...
- Feature file path: `06--mcp-tool-surface/013-tool-registrations.md`

Related references:

- [../01--read-path-freshness/002-query-self-heal.md](../01--read-path-freshness/002-query-self-heal.md)

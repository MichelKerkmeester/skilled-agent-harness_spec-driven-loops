...
- Feature file path: `08--doctor-code-graph/014-doctor-apply-mode.md`

Related references:

- [../02--manual-scan-verify-status/004-code-graph-verify.md](../02--manual-scan-verify-status/004-code-graph-verify.md)

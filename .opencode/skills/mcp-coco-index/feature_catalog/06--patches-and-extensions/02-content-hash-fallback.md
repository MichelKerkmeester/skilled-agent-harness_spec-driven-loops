...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/indexer.py:39` | Indexer | Normalizes chunk content before hashing. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/indexer.py:241` | Indexer | Stores content hash per chunk. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/query.py:65` | Query | Computes fallback content hashes. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/references/tool_reference.md:392` | Reference | Documents chunk-level fork telemetry. |
| `.opencode/skills/mcp-coco-index/tests/test_protocol.py:217` | Protocol | Covers response round trips across protocol variants. |

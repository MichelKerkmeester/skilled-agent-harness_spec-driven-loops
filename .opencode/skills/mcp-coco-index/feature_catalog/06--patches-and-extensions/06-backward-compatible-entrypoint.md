...
| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_backward_compat.py:29` | Compatibility | Covers creating settings from legacy environment variables. |
| `.opencode/skills/mcp-coco-index/tests/test_backward_compat.py:113` | Compatibility | Covers legacy root discovery behavior. |

...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/indexer.py:52` | Indexer | Classifies source paths. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/indexer.py:220` | Indexer | Stores path class for each processed file. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/schema.py:24` | Schema | Includes `path_class` on query results. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/references/tool_reference.md:390` | Reference | Documents path-class field semantics. |
| `.opencode/skills/mcp-coco-index/tests/test_e2e.py:307` | End-to-end | Covers indexed path selection with ignores. |

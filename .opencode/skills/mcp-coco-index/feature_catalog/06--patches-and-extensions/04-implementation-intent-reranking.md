...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/query.py:39` | Query | Defines implementation-intent keywords. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/query.py:56` | Query | Detects implementation intent. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/query.py:176` | Query | Applies path-class score deltas. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/references/tool_reference.md:412` | Reference | Documents implementation-intent reranking. |
| `.opencode/skills/mcp-coco-index/manual_testing_playbook/manual_testing_playbook.md:453` | Manual playbook | Covers semantic intent routing expectations. |

...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/indexer.py:217` | Indexer | Stores file path and real path for chunks. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/query.py:158` | Query | Builds dedup keys from realpath or fallback hash. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/query.py:234` | Query | Tracks seen dedup keys and alias counts. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/references/tool_reference.md:398` | Reference | Documents result-row dedup telemetry. |
| `.opencode/skills/mcp-coco-index/tests/test_protocol.py:77` | Protocol | Covers search response result fields. |

...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/daemon.py:154` | Daemon | Checks whether search should wait. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/daemon.py:454` | Daemon | Streams wait then search response. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/client.py:96` | Client | Handles waiting notices during search. |
...
| `.opencode/skills/mcp-coco-index/tests/test_daemon.py:293` | Integration | Covers search waiting during load-time indexing. |

...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/daemon.py:121` | Daemon | Defines the project registry. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/daemon.py:134` | Daemon | Loads projects and optionally starts indexing. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/daemon.py:340` | Daemon | Removes project resources from the registry. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_daemon.py:222` | Integration | Covers removing a loaded project. |
| `.opencode/skills/mcp-coco-index/tests/test_daemon.py:237` | Integration | Covers removing a project that is not loaded. |

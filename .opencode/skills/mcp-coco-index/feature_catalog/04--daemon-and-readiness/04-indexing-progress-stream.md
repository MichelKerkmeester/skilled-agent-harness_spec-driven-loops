...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/daemon.py:209` | Daemon | Streams progress for update requests. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/client.py:68` | Client | Consumes streaming index responses. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/protocol.py:72` | Protocol | Defines indexing progress messages. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_daemon.py:205` | Integration | Asserts progress updates are emitted. |
| `.opencode/skills/mcp-coco-index/tests/test_protocol.py:152` | Protocol | Covers waiting notice encoding. |

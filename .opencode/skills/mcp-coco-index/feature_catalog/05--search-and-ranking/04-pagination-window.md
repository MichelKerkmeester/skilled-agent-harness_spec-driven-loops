...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/query.py:220` | Query | Dedups and ranks rows before slicing. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/query.py:245` | Query | Applies the offset and limit window. |
| `.opencode/skills/mcp-coco-index/references/tool_reference.md:284` | Reference | Maps CLI and MCP pagination parameters. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_protocol.py:57` | Protocol | Covers offset and limit fields. |
| `.opencode/skills/mcp-coco-index/manual_testing_playbook/manual_testing_playbook.md:522` | Manual playbook | Indexes result limit validation. |

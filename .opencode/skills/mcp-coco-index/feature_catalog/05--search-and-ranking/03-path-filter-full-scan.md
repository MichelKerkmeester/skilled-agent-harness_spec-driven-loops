...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/query.py:119` | Query | Defines full-scan query with filter predicates. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/query.py:137` | Query | Applies path glob predicates. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/query.py:286` | Query | Selects full scan when paths are present. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_e2e.py:182` | End-to-end | Covers path-scoped search output. |
| `.opencode/skills/mcp-coco-index/manual_testing_playbook/manual_testing_playbook.md:520` | Manual playbook | Indexes path and combined-filter scenarios. |

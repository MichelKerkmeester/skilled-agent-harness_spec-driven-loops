...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/cli.py:136` | CLI | Formats search results. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/cli.py:151` | CLI | Prints final score and raw score per result. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/query.py:176` | Query | Creates ranked result records. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_e2e.py:167` | End-to-end | Covers search result output. |
| `.opencode/skills/mcp-coco-index/references/tool_reference.md:405` | Reference | Documents ranking transparency fields. |

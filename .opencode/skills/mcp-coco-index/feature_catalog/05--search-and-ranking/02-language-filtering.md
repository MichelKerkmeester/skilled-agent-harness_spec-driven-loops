...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/query.py:93` | Query | Accepts an optional language for KNN. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/query.py:288` | Query | Chooses single-language KNN. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/query.py:292` | Query | Merges multi-language KNN rows. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_protocol.py:57` | Protocol | Covers multiple languages in search requests. |
| `.opencode/skills/mcp-coco-index/manual_testing_playbook/manual_testing_playbook.md:517` | Manual playbook | Indexes language filter scenarios. |

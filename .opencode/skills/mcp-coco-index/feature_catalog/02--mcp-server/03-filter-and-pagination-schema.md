...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/server.py:105` | MCP schema | Defines result limit bounds. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/server.py:111` | MCP schema | Defines offset pagination. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/server.py:124` | MCP schema | Defines language and path filters. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_protocol.py:57` | Protocol | Covers search requests with all filter fields. |
| `.opencode/skills/mcp-coco-index/manual_testing_playbook/manual_testing_playbook.md:517` | Manual playbook | Indexes language, path and limit scenarios. |

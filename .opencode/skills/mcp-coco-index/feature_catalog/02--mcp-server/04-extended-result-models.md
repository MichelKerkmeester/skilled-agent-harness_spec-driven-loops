...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/server.py:42` | MCP model | Defines chunk result fields. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/server.py:59` | MCP model | Defines response-level telemetry. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/server.py:152` | MCP server | Maps daemon response fields into MCP models. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_protocol.py:77` | Protocol | Covers search responses with results. |
| `.opencode/skills/mcp-coco-index/references/tool_reference.md:384` | Reference | Documents fork-specific telemetry fields. |

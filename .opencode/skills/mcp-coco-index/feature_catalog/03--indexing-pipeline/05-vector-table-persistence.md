...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/indexer.py:259` | Indexer | Mounts the SQLite vector table target. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/indexer.py:266` | Indexer | Defines language partition and auxiliary columns. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/shared.py:79` | Schema | Defines the stored `CodeChunk` shape. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_daemon.py:186` | Integration | Covers status after the vector table is populated. |
| `.opencode/skills/mcp-coco-index/tests/test_e2e_daemon.py:95` | End-to-end | Covers index and search through persisted state. |

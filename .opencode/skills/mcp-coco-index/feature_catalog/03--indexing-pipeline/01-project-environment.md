...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/project.py:84` | Project runtime | Creates the project environment. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/project.py:100` | Project runtime | Provides context keys to CocoIndex. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/project.py:112` | Project runtime | Constructs the CocoIndex app. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_e2e_daemon.py:95` | End-to-end | Covers indexing and searching through the client. |
| `.opencode/skills/mcp-coco-index/tests/test_daemon.py:186` | Integration | Covers project status after indexing. |

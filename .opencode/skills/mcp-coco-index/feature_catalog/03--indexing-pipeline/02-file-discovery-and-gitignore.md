...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/indexer.py:93` | Indexer | Normalizes `.gitignore` lines. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/indexer.py:136` | Indexer | Defines the Gitignore-aware matcher. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/indexer.py:280` | Indexer | Combines configured patterns with Git ignore filtering. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_e2e.py:307` | End-to-end | Covers ignored files staying out of search results. |
| `.opencode/skills/mcp-coco-index/tests/test_cli_helpers.py:92` | Unit | Covers idempotent `.gitignore` entry handling. |

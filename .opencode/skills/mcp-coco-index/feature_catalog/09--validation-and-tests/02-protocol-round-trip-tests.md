...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/tests/test_protocol.py:39` | Test | Covers handshake request round trip. |
| `.opencode/skills/mcp-coco-index/tests/test_protocol.py:47` | Test | Covers search defaults. |
| `.opencode/skills/mcp-coco-index/tests/test_protocol.py:217` | Test | Covers all response types. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/protocol.py:176` | Implementation | Encodes and decodes requests. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/protocol.py:185` | Implementation | Encodes and decodes responses. |

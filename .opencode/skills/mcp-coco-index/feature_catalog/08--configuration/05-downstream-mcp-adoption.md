...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/references/downstream_adoption_checklist.md:29` | Reference | Defines the adoption bundle. |
| `.opencode/skills/mcp-coco-index/references/downstream_adoption_checklist.md:55` | Reference | Documents config wiring. |
| `.opencode/skills/mcp-coco-index/scripts/common.sh:150` | Script helper | Detects configured MCP clients. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/scripts/common.sh:218` | Script helper | Recommends the adoption checklist for missing config. |
| `.opencode/skills/mcp-coco-index/manual_testing_playbook/manual_testing_playbook.md:380` | Manual playbook | Validates readiness scripts with config requirements. |

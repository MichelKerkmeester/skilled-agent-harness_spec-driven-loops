...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/cli.py:388` | CLI | Defines `ccc status`. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/cli.py:120` | CLI helper | Formats chunks, files and languages. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/daemon.py:302` | Daemon | Computes project status from `code_chunks_vec`. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_e2e.py:162` | End-to-end | Asserts status output includes chunk counts. |
| `.opencode/skills/mcp-coco-index/tests/test_daemon.py:186` | Integration | Asserts daemon project status reports indexed chunks and files. |

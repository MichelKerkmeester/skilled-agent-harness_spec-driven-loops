...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/cli.py:397` | CLI | Defines `ccc reset`. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/cli.py:268` | CLI helper | Removes the `.gitignore` entry during full reset. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/daemon.py:340` | Daemon | Removes loaded project resources before files are deleted. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_e2e.py:216` | End-to-end | Covers database reset while keeping settings. |
| `.opencode/skills/mcp-coco-index/tests/test_e2e.py:254` | End-to-end | Covers full reset behavior. |

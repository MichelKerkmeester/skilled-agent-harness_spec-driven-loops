...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/cli.py:505` | CLI | Defines `ccc daemon status`. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/cli.py:529` | CLI | Defines `ccc daemon restart`. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/cli.py:547` | CLI | Defines `ccc daemon stop`. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_e2e.py:338` | End-to-end | Covers stop plus auto-start on later search. |
| `.opencode/skills/mcp-coco-index/tests/test_e2e.py:358` | End-to-end | Covers daemon restart. |

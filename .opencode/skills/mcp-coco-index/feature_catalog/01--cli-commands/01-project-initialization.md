...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/cli.py:295` | CLI | Defines `ccc init` and the parent-root guard. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/cli.py:245` | CLI helper | Adds the `.cocoindex_code` ignore entry when a Git repository exists. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/settings.py:326` | Settings | Writes project settings under the project root. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_e2e.py:141` | End-to-end | Covers the happy-path initialization session. |
| `.opencode/skills/mcp-coco-index/tests/test_cli_helpers.py:82` | Unit | Covers `.gitignore` creation for initialized Git projects. |

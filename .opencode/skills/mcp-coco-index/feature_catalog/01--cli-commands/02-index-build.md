...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/cli.py:338` | CLI | Defines `ccc index`. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/cli.py:164` | CLI helper | Streams indexing progress from the daemon. |
| `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/project.py:40` | Project runtime | Updates the CocoIndex app and converts file stats to progress snapshots. |

### Validation And Tests

| File | Type | Role |
|------|------|------|
| `.opencode/skills/mcp-coco-index/tests/test_e2e.py:156` | End-to-end | Asserts index output includes chunk and file counts. |
| `.opencode/skills/mcp-coco-index/tests/test_daemon.py:205` | Integration | Asserts daemon indexing streams progress updates. |

...
The canonical field-to-REQ mapping lives in [`../changelog/CHANGELOG.md`](../changelog/CHANGELOG.md#0-2-3-spec-kit-fork-0-2-0--2026-04-27); the per-REQ rationale and patch scope live in the originating spec packet at `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-mcp-runtime-stress-remediation/004-cocoindex-overfetch-dedup/`.

...
- `.opencode/skills/mcp-coco-index/scripts/`
- `.opencode/skills/mcp-coco-index/references/`
- `.opencode/skills/mcp-coco-index/assets/`
- `.opencode/skills/mcp-coco-index/mcp_server/.venv/bin/ccc` after installation
...
```bash
bash .opencode/skills/mcp-coco-index/scripts/doctor.sh --strict --require-config --expect-config opencode.json
bash .opencode/skills/mcp-coco-index/scripts/doctor.sh --strict --require-config --expect-config .codex/config.toml
```

...
bash .opencode/skills/mcp-coco-index/scripts/doctor.sh --json
...
bash .opencode/skills/mcp-coco-index/scripts/ensure_ready.sh --refresh-index
...
```bash
.opencode/skills/mcp-coco-index/mcp_server/.venv/bin/ccc daemon restart
```

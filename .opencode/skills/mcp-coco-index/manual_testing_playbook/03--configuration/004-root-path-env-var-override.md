...
- Prompt: `From a subdirectory, verify COCOINDEX_CODE_ROOT_PATH makes ccc status and search use the pinned root.`
...
| File | Role |
|---|---|
| `.opencode/skills/mcp-coco-index/SKILL.md` | §3 "Root Path Discovery" lists the 4-priority resolution order |

---
title: "mcp coco index tests: Code README"
description: "Code-facing README for .opencode/skills/mcp-coco-index/tests."
trigger_phrases:
  - "mcp-coco-index tests"
  - "code README"
---
...
This README documents the code-bearing folder `.opencode/skills/mcp-coco-index/tests` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/mcp-coco-index/tests
```
...
|---|---|
| Folder boundary | Documents direct code files under `tests`. |
...
| Path | Purpose |
|---|---|
| `conftest.py` | PY source file in this folder. |
| `test_backward_compat.py` | PY source file in this folder. |
| `test_cli_helpers.py` | PY source file in this folder. |
| `test_client.py` | PY source file in this folder. |
| `test_config.py` | PY source file in this folder. |
| `test_daemon.py` | PY source file in this folder. |
| `test_e2e.py` | PY source file in this folder. |
| `test_e2e_daemon.py` | PY source file in this folder. |
| `test_protocol.py` | PY source file in this folder. |
| `test_settings.py` | PY source file in this folder. |
...
```text
User request: Check .opencode/skills/mcp-coco-index/tests for sk-code and README coverage.

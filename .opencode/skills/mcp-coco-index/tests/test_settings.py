#!/usr/bin/env python3
# ───────────────────────────────────────────────────────────────
# COMPONENT: COCOINDEX CODE SETTINGS TESTS
# ───────────────────────────────────────────────────────────────
...
def test_default_canonical_resource_paths() -> None:
    ...
    assert ".opencode/skills/*/assets/opencode/**" in settings.canonical_resource_paths


def test_is_canonical_path_bypasses_exclusion() -> None:
    """A path under .opencode/skills/sk-code/assets/opencode/ should be canonical."""
    assert (
        is_canonical_path(

...
```bash
bash .opencode/skills/mcp-coco-index/scripts/update.sh [target-version]
```
...
cp /tmp/cocoindex-upstream-XXXXX/cocoindex_code/<file>.py \
   .opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/<file>.py
```
...
Append a new "Sync from upstream X.Y.Z" entry to `.opencode/skills/mcp-coco-index/NOTICE` with the date and any breaking changes.

### Step 6: Add Changelog Entry

Prepend a new entry to `.opencode/skills/mcp-coco-index/changelog/CHANGELOG.md` under the new version.

### Step 7: Reinstall and Reindex

```bash
bash .opencode/skills/mcp-coco-index/scripts/install.sh
.opencode/skills/mcp-coco-index/mcp_server/.venv/bin/ccc reset
.opencode/skills/mcp-coco-index/mcp_server/.venv/bin/ccc index
.opencode/skills/mcp-coco-index/mcp_server/.venv/bin/ccc --version  # verify version string
```

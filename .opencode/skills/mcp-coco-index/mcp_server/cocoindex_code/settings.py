...
CANONICAL_RESOURCE_PATHS: list[str] = [
    ".opencode/skills/*/assets/opencode/**",  # sk-code OpenCode authoring checklists + recipes
    ".opencode/skills/*/assets/*/**",  # Skill-specific asset subtrees; concrete library names come from owning skills

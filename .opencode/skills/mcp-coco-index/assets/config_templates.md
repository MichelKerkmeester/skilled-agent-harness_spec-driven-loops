...
```bash
bash .opencode/skills/mcp-coco-index/scripts/doctor.sh
...
| Resource | Location |
| --- | --- |
| Install Guide | `.opencode/skills/mcp-coco-index/INSTALL_GUIDE.md` |
| Tool Reference | `.opencode/skills/mcp-coco-index/references/tool_reference.md` |
| Tool Reference §7 (Fork-Specific Output Telemetry) | `.opencode/skills/mcp-coco-index/references/tool_reference.md` (anchor: `#-7-fork-specific-output-telemetry`) |

...
- [mobbin_tools.md](./mobbin_tools.md) and [refero_tools.md](./refero_tools.md) are the tool catalogs for the two MCPs: arguments, the verified Code Mode call convention, result shapes, and troubleshooting.

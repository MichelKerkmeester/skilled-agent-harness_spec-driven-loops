...
- Feature file path: `07--claude-design-parity/fidelity-check-and-revision-grammar.md`

Related references:
- [ground-and-reuse-before-generate.md](ground-and-reuse-before-generate.md) - Ground and reuse before generate
- [handoff-and-parity-guardrails.md](handoff-and-parity-guardrails.md) - Handoff and parity guardrails

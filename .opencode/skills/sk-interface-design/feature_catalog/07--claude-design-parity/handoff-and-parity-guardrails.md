---
title: "Handoff and parity guardrails"
...
- Group: Claude Design parity loop
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `07--claude-design-parity/handoff-and-parity-guardrails.md`

...
- Expected execution process: Follow `references/claude_design_parity.md` Section 3, search the active theme's registered components and tokens for a fit before authoring net-new, run the adherence check for raw values and bypassed components, and confirm no style-preset menu is presented.

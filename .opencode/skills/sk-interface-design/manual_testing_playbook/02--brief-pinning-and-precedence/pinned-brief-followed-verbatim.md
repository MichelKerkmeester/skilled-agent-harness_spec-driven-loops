...
| `../../references/design_principles.md` | The calibration note that the brief's own words always win |
...
- Feature file path: `02--brief-pinning-and-precedence/pinned-brief-followed-verbatim.md`

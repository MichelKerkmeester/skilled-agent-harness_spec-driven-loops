...
- Expected execution process: Resolve one matching Open Design system via `mcp-open-design`, name the look it represents as the default, propose a justified deviation, and confirm no menu of systems is surfaced and no system content is written into the skill.

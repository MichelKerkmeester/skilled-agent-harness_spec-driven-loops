...
1. Confirm the working directory is the repository root so `.opencode/skills/sk-design/sk-create-diagram/` paths resolve, and confirm the packet assets exist.

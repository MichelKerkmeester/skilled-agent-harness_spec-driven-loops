...
6. `bash: git status .opencode/skills/sk-design/sk-create-diagram/references/foundations/style-guide.md` (confirm only the approved tokens changed)
...
3. If `style-guide.md` changed without approval, restore it with `git checkout -- .opencode/skills/sk-design/sk-create-diagram/references/foundations/style-guide.md` and re-run the scenario in a scratch checkout.

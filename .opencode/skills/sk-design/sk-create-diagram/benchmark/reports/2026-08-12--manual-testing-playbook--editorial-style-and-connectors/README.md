# 2026-08-12--manual-testing-playbook--editorial-style-and-connectors
...
| Field | Value |
|---|---|
| Target skill | sk-create-diagram |
| Scoring method | not-applicable-manual-outcome |
| Trace mode | doc |
| Executor | deepseek-v4-flash |
| Model | deepseek/deepseek-v4-flash (editorial-style-and-connectors) |
| Scenarios | 1 |

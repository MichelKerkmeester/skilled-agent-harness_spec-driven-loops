...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/sk-design/design-motion/assets/motion-pattern-cards.md` | Shared | Defines all eleven fill-in cards, shared fields, and per-pattern checklists. |
| `.opencode/skills/sk-design/design-motion/references/motion-strategy.md` | Shared | Supplies the timing and easing values cards cite rather than invent. |
| `.opencode/skills/sk-design/design-motion/references/micro-interactions.md` | Shared | Supplies gesture and drag-and-drop behavior rules the corresponding cards cite. |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.opencode/skills/sk-design/design-motion/assets/motion-performance-failure-card.md` | Manual playbook | Build-side card of frame-dropping patterns checked before cards are handed off. |
| `.opencode/skills/sk-design/design-motion/manual-testing-playbook/manual-testing-playbook.md` | Manual playbook | Exercises micro-interaction and advanced-craft card scenarios against the live mode. |

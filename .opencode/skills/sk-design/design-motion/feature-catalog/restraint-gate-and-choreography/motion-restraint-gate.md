...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/sk-design/design-motion/references/animation-decision-framework.md` | Shared | Defines the frequency gate, the keyboard rule, the purpose test, and register coupling. |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/sk-design/design-motion/manual-testing-playbook/manual-testing-playbook.md` | Manual playbook | Exercises restraint-gate and decision scenarios against the live mode. |

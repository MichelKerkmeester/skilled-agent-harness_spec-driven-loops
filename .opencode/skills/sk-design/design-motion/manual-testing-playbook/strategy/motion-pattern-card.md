...
1. Run the restraint gate in `references/animation-decision-framework.md` first, then pick the matching cards in `assets/motion-pattern-cards.md` (toast card, state transition card).

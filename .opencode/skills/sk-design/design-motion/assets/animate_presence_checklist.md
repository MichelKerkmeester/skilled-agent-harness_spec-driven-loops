...
Report any open fail in the audit findings format from `references/animate_presence_patterns.md` Section 7, for example `components/modal.tsx:42 - [exit-requires-wrapper] conditional motion.div is not wrapped`.

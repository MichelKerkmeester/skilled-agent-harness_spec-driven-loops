...
- Feature file path: `02--build-cards/motion-fill-in-cards.md`

Related references:
- [../01--restraint-gate-and-choreography/choreography-and-reduced-motion.md](../01--restraint-gate-and-choreography/choreography-and-reduced-motion.md) - Timing, easing, and reduced-motion rules cards cite.
- [../03--procedure-cards/motion-procedure-card-inventory.md](../03--procedure-cards/motion-procedure-card-inventory.md) - Private card for interaction-state evidence gathering before card selection.

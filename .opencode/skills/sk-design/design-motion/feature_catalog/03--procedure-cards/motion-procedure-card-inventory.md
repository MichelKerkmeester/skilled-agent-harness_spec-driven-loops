...
- Feature file path: `03--procedure-cards/motion-procedure-card-inventory.md`

Related references:
- [../02--build-cards/motion-fill-in-cards.md](../02--build-cards/motion-fill-in-cards.md) - Build cards the interaction-states-pass card feeds evidence into.
- [../01--restraint-gate-and-choreography/motion-restraint-gate.md](../01--restraint-gate-and-choreography/motion-restraint-gate.md) - Gate the card's findings are choreographed against.

...
- Feature file path: `01--restraint-gate-and-choreography/choreography-and-reduced-motion.md`

Related references:
- [motion-restraint-gate.md](motion-restraint-gate.md) - The gate that decides whether choreography is needed at all.
- [../02--build-cards/motion-fill-in-cards.md](../02--build-cards/motion-fill-in-cards.md) - Fill-in cards that cite these timing and reduced-motion rules.

...
- Feature file path: `01--restraint-gate-and-choreography/motion-restraint-gate.md`

Related references:
- [choreography-and-reduced-motion.md](choreography-and-reduced-motion.md) - Choreography for choices that survive the gate.
- [../02--build-cards/motion-fill-in-cards.md](../02--build-cards/motion-fill-in-cards.md) - Fill-in cards that spec a gate-approved pattern.

...
- Expected execution process: No Task dispatch; select `procedures/interaction_states_pass.md`; record target interaction, affected states, existing animation system, motion budget, reduced-motion bar, performance constraints, timing/easing decisions, and verification risks.
...
| `../../procedures/interaction_states_pass.md` | Selected card |

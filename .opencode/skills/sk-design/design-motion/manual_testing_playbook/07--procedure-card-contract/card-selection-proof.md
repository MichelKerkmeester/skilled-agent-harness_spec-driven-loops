...
expected_resources:
  - SKILL.md
  - procedures/interaction_states_pass.md
---
...
This scenario validates that the single motion-owned private card, `procedures/interaction_states_pass.md`, is selected for state-feedback requests.
...
- Expected execution process: Read `SKILL.md`; select `procedures/interaction_states_pass.md`; record public mode, affected states, motion budget, reduced-motion bar, timing/easing decisions, and verification risks.
...
| `../../procedures/interaction_states_pass.md` | Interaction-state procedure card |

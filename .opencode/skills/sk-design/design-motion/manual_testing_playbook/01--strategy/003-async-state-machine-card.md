...
1. Run the restraint gate in `references/animation_decision_framework.md` first, then select the async state-machine card in `assets/motion_pattern_cards.md`.

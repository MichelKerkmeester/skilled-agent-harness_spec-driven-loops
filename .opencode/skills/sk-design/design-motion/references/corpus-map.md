...
| --- | --- | --- |
| `external/animate.md` | `motion-strategy.md`, `performance-reduced-motion.md` | Purposeful motion, timing scale, easing, materials, perceived performance, reduced motion |
| `external/interaction-design.md` | `micro-interactions.md`, `animate-presence-patterns.md` | Feedback patterns, loading, toggles, gestures, Framer Motion examples |
| `external/delight.md` | `micro-interactions.md` | Earned delight, copy/personality boundaries, celebration and loading restraint |
| `external/morphing-icons.md` | `micro-interactions.md` | Three-line SVG morphing architecture, collapsed lines, rotation groups, reduced-motion rules |
| `external/12-principles-of-animation.md` | `motion-strategy.md`, `micro-interactions.md` | Timing, easing, physics (active/pressed state, subtle deformation), staging checks adapted for web UI |
| `external/mastering-animate-presence.md` | `animate-presence-patterns.md` | Exit wrappers, exit props, keys, presence hooks, modes (sync/absolute remedy, popLayout for lists), nested exits |

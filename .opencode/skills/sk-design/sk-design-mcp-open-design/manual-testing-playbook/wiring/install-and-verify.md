...
| `../../feature-catalog/wiring/od-mcp-install.md` | Feature-catalog source describing the install contract |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `../../references/mcp-wiring.md` | Wiring commands and written config shape |
| `../../references/od-cli-reference.md` | Locating the CLI and the daemon model |

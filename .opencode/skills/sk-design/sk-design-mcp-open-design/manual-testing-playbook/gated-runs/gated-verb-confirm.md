...
| `../../feature-catalog/runs/headless-runs.md` | Feature-catalog source describing the gating policy |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `../../references/tool-surface.md` | Mutating and destructive verbs and the gate policy |
| `../../references/od-cli-reference.md` | CLI verb surface with mutating classification |

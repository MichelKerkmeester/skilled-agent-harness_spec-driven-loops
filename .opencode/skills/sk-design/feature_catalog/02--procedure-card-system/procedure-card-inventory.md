...
- Feature file path: `02--procedure-card-system/procedure-card-inventory.md`
...
- [../01--manager-shell/proof-gates-and-verifier-cadence.md](../01--manager-shell/proof-gates-and-verifier-cadence.md) - Proof line where selected cards are cited.

...
- Feature file path: `02--procedure-card-system/procedure-card-schema-and-selection.md`

Related references:
- [procedure-card-inventory.md](procedure-card-inventory.md) - Current inventory of mode-local and shared cards.
- [../01--manager-shell/context-first-intake-and-visible-plan.md](../01--manager-shell/context-first-intake-and-visible-plan.md) - Public hub route precedes card selection.

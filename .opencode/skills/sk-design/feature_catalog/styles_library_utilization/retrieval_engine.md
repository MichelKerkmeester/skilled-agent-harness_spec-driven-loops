...
- Feature file path: `styles_library_utilization/retrieval_engine.md`

Related references:
- [shared_corpus_context_seam.md](shared_corpus_context_seam.md) - Neutral planning envelope consumed before mode-owned retrieval.
- [per_mode_consumers.md](per_mode_consumers.md) - Mode-specific consumers of bounded retrieval evidence.

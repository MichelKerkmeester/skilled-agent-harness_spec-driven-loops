...
See [`01--manager-shell/context-first-intake-and-visible-plan.md`](01--manager-shell/context-first-intake-and-visible-plan.md) for source anchors and routing details.
...
See [`01--manager-shell/proof-gates-and-verifier-cadence.md`](01--manager-shell/proof-gates-and-verifier-cadence.md) for proof fields and verifier cadence.
...
See [`01--manager-shell/transport-vs-taste-separation.md`](01--manager-shell/transport-vs-taste-separation.md) for the boundary and integration points.
...
See [`02--procedure-card-system/procedure-card-schema-and-selection.md`](02--procedure-card-system/procedure-card-schema-and-selection.md) for schema and selection rules.
...
See [`02--procedure-card-system/procedure-card-inventory.md`](02--procedure-card-system/procedure-card-inventory.md) for the complete card list and ownership boundaries.

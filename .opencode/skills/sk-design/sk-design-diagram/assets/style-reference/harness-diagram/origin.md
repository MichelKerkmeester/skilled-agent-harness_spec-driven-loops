...
recorded in `assets/color/diagram-palette.json` before any reference existed. This file expresses
...
The palette this was written from is `assets/color/diagram-palette.json`; that file, not this one,

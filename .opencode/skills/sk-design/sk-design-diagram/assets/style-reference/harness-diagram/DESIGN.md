...
|------|-------|-------|------|
| Paper | `#f5f5f5` | `--color-paper` | Page ground — off-white, never pure |
...
| Accent | `#eb6c36` | `--color-accent` | The one focal mark on a page |
...
| Night | `#2d3142` | `--color-paper (dark)` | Dark ground — the light theme's ink becomes the dark theme's paper |

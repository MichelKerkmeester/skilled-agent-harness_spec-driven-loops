...
| `assets/style-reference/icons.html`, `assets/diagrams/starter-terminal.html` | Shared | The icon gallery and the terminal template variant the primitive is applied to |

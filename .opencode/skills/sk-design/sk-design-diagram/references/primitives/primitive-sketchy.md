...
description: "The optional displacement filter that wobbles strokes for a hand-drawn editorial register; filter shapes, never text."
trigger_phrases:
  - "sketchy filter"
  - "hand drawn diagram variant"
...
Optional displacement filter that wobbles every stroke and edge slightly — turns any minimal variant into a hand-drawn "editorial" register without changing layout.

---

## 1. OVERVIEW

Use when the diagram accompanies an essay rather than technical docs.

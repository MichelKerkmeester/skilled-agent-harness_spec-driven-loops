...
| File | Type | Role |
|---|---|---|
| `../../manual_testing_playbook/02--validate/002-phantom-hex-detection.md` | Manual playbook | Validator pass/fail scenario — confirms faithful DESIGN.md passes and phantom hexes are flagged |

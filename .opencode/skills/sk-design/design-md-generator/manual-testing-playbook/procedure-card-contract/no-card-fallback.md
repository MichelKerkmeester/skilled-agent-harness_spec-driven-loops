...
- Expected signals: Exact fallback line appears; no `design-system-extraction.md` selected; backend boundary remains available but unused unless a pipeline phase requires it.

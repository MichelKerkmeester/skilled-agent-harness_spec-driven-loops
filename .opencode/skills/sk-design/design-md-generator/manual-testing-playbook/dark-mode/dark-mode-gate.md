...
| `../../references/design-md-format.md` | v3 Style Reference section specification — verbatim-value rule and the token tables where detected dark values appear |
...
- Feature file path: `dark-mode/dark-mode-gate.md`

...
description: "Embedded TypeScript extract, write and validate CLI pipeline that powers the md-generator skill."
trigger_phrases:
...
npx ts-node .opencode/skills/sk-design/design-md-generator/backend/scripts/extract.ts https://example.com --fast --output .opencode/specs/<track>/<packet>/output
...
npx ts-node .opencode/skills/sk-design/design-md-generator/backend/scripts/validate.ts .opencode/specs/<track>/<packet>/output/DESIGN.md .opencode/specs/<track>/<packet>/output/tokens.json
```
...
npx ts-node .opencode/skills/sk-design/design-md-generator/backend/scripts/extract.ts https://example.com \
...
npx ts-node .opencode/skills/sk-design/design-md-generator/backend/scripts/build-write-prompt.ts \

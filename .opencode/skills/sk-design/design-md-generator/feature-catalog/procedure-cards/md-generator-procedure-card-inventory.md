...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/sk-design/design-md-generator/procedures/design-system-extraction.md` | Shared | Design-system-extraction card: purpose, tool boundary, procedure, and conflict rule. |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/sk-design/design-md-generator/manual-testing-playbook/manual-testing-playbook.md` | Manual playbook | Exercises measured extraction scenarios against the live mode. |

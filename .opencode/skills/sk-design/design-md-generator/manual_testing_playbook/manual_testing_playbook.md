...
> **Feature File:** [extract/live-extraction.md](extract/live_extraction.md)
...
> **Feature File:** [validate/phantom-hex-detection.md](validate/phantom_hex_detection.md)
...
> **Feature File:** [fidelity/verbatim-value-fidelity.md](fidelity/verbatim_value_fidelity.md)
...
> **Feature File:** [dark-mode/dark-mode-gate.md](dark_mode/dark_mode_gate.md)
...
> **Feature File:** [setup/tool-readiness.md](setup/tool_readiness.md)
...
> **Feature File:** [escalation/anti-bot-escalation.md](escalation/anti_bot_escalation.md)
...
> **Feature File:** [report/report-generation.md](report/report_generation.md)
...
> **Feature File:** [interaction/interaction-state-matrix.md](interaction/interaction_state_matrix.md)
...
> **Feature File:** [cluster/oklch-clustering.md](cluster/oklch_clustering.md)
...
> **Feature File:** [accessibility/accessibility-section.md](accessibility/accessibility_section.md)
...
> **Feature File:** [detectors/framework-icon-motion-detection.md](detectors/framework_icon_motion_detection.md)
...
> **Feature File:** [authoring-boundary/authoring-boundary.md](authoring_boundary/authoring_boundary.md)
...
> **Feature File:** [source-of-truth/source-of-truth-card.md](source_of_truth/source_of_truth_card.md)
...
> **Feature File:** [GUIDED-014](guided_run/guided_run_smoke_lane.md)
...
> **Feature File:** [STUDY-015](study/editorial_exemplar_study.md)
...
> **Feature File:** [PROCCARD-001](procedure_card_contract/card_selection_proof.md)

### PROCCARD-002 | md-generator no-card fallback

> **Feature File:** [PROCCARD-002](procedure_card_contract/no_card_fallback.md)

### PROCCARD-003 | md-generator backend-preserving direct fallback

> **Feature File:** [PROCCARD-003](procedure_card_contract/backend_preserving_direct_fallback.md)
...
|---|---|---|---|---|
| EXTRACT-001 | Live extraction produces valid tokens.json | Extract | [extract/live-extraction.md](extract/live_extraction.md) | [../feature_catalog/extract/extract.md](../feature_catalog/extract/extract.md) |
| VALIDATE-001 | Validator passes on faithful DESIGN.md and flags phantom hexes | Validate | [validate/phantom-hex-detection.md](validate/phantom_hex_detection.md) | [../feature_catalog/validate/validate.md](../feature_catalog/validate/validate.md) |
| FIDELITY-001 | Cardinal verbatim-value rule enforced | Fidelity | [fidelity/verbatim-value-fidelity.md](fidelity/verbatim_value_fidelity.md) | [../feature_catalog/write_design_md/write_design_md.md](../feature_catalog/write_design_md/write_design_md.md) |
| DARKMODE-001 | Dark-mode section appears only when detected | Dark Mode | [dark-mode/dark-mode-gate.md](dark_mode/dark_mode_gate.md) | [../feature_catalog/feature_extractors/feature_extractors.md](../feature_catalog/feature_extractors/feature_extractors.md) |
| SETUP-001 | Tool readiness from a fresh checkout | Setup | [setup/tool-readiness.md](setup/tool_readiness.md) | [../feature_catalog/extract/extract.md](../feature_catalog/extract/extract.md) |
| ESCALATE-001 | Anti-bot site causes clear escalation, never fabricates tokens | Escalation | [escalation/anti-bot-escalation.md](escalation/anti_bot_escalation.md) | [../feature_catalog/extract/extract.md](../feature_catalog/extract/extract.md) |
| REPORT-001 | Report And Preview Generation | Report | [report/report-generation.md](report/report_generation.md) | [../feature_catalog/report_preview/report_preview.md](../feature_catalog/report_preview/report_preview.md) |
| INTERACT-001 | Interaction Capture And State Matrix | Interaction | [interaction/interaction-state-matrix.md](interaction/interaction_state_matrix.md) | [../feature_catalog/interaction_capture/interaction_capture.md](../feature_catalog/interaction_capture/interaction_capture.md) |
| CLUSTER-001 | OKLCH Clustering And Stability Classification | Cluster | [cluster/oklch-clustering.md](cluster/oklch_clustering.md) | [../feature_catalog/cluster_classify/cluster_classify.md](../feature_catalog/cluster_classify/cluster_classify.md) |
| A11Y-001 | Accessibility Section Fidelity | Accessibility | [accessibility/accessibility-section.md](accessibility/accessibility_section.md) | [../feature_catalog/feature_extractors/feature_extractors.md](../feature_catalog/feature_extractors/feature_extractors.md) |
| DETECT-001 | Framework, Icon, And Motion Detection | Detectors | [detectors/framework-icon-motion-detection.md](detectors/framework_icon_motion_detection.md) | [../feature_catalog/feature_extractors/feature_extractors.md](../feature_catalog/feature_extractors/feature_extractors.md) |
| BOUNDARY-001 | Authoring boundary sorts values by origin | Authoring Boundary | [authoring-boundary/authoring-boundary.md](authoring_boundary/authoring_boundary.md) | [../feature_catalog/write_design_md/write_design_md.md](../feature_catalog/write_design_md/write_design_md.md) |
| PROVENANCE-001 | Source-of-truth router card sorts each value | Source-of-Truth | [source-of-truth/source-of-truth-card.md](source_of_truth/source_of_truth_card.md) | [../feature_catalog/write_design_md/write_design_md.md](../feature_catalog/write_design_md/write_design_md.md) |
| GUIDED-014 | Guided wrapper smoke lane | Guided Run | [guided-run/guided-run-smoke-lane.md](guided_run/guided_run_smoke_lane.md) | N/A |
| STUDY-015 | Editorial or ecommerce exemplar study | Study | [study/editorial-exemplar-study.md](study/editorial_exemplar_study.md) | N/A |
| PROCCARD-001 | md-generator procedure-card selection proof | Procedure Card Contract | [procedure-card-contract/card-selection-proof.md](procedure_card_contract/card_selection_proof.md) | N/A |
| PROCCARD-002 | md-generator no-card fallback | Procedure Card Contract | [procedure-card-contract/no-card-fallback.md](procedure_card_contract/no_card_fallback.md) | N/A |
| PROCCARD-003 | md-generator backend-preserving direct fallback | Procedure Card Contract | [procedure-card-contract/backend-preserving-direct-fallback.md](procedure_card_contract/backend_preserving_direct_fallback.md) | N/A |

...
|---|---|---|---|---|
| EXTRACT-001 | Live extraction produces valid tokens.json | Extract | [extract/live-extraction.md](extract/live-extraction.md) | [../feature_catalog/extract/extract.md](../feature_catalog/extract/extract.md) |
| VALIDATE-001 | Validator passes on faithful DESIGN.md and flags phantom hexes | Validate | [validate/phantom-hex-detection.md](validate/phantom-hex-detection.md) | [../feature_catalog/validate/validate.md](../feature_catalog/validate/validate.md) |
| FIDELITY-001 | Cardinal verbatim-value rule enforced | Fidelity | [fidelity/verbatim-value-fidelity.md](fidelity/verbatim-value-fidelity.md) | [../feature_catalog/write-design-md/write-design-md.md](../feature_catalog/write-design-md/write-design-md.md) |
| DARKMODE-001 | Dark-mode section appears only when detected | Dark Mode | [dark-mode/dark-mode-gate.md](dark-mode/dark-mode-gate.md) | [../feature_catalog/feature-extractors/feature-extractors.md](../feature_catalog/feature-extractors/feature-extractors.md) |
| SETUP-001 | Tool readiness from a fresh checkout | Setup | [setup/tool-readiness.md](setup/tool-readiness.md) | [../feature_catalog/extract/extract.md](../feature_catalog/extract/extract.md) |
| ESCALATE-001 | Anti-bot site causes clear escalation, never fabricates tokens | Escalation | [escalation/anti-bot-escalation.md](escalation/anti-bot-escalation.md) | [../feature_catalog/extract/extract.md](../feature_catalog/extract/extract.md) |
| REPORT-001 | Report And Preview Generation | Report | [report/report-generation.md](report/report-generation.md) | [../feature_catalog/report-preview/report-preview.md](../feature_catalog/report-preview/report-preview.md) |
| INTERACT-001 | Interaction Capture And State Matrix | Interaction | [interaction/interaction-state-matrix.md](interaction/interaction-state-matrix.md) | [../feature_catalog/interaction-capture/interaction-capture.md](../feature_catalog/interaction-capture/interaction-capture.md) |
| CLUSTER-001 | OKLCH Clustering And Stability Classification | Cluster | [cluster/oklch-clustering.md](cluster/oklch-clustering.md) | [../feature_catalog/cluster-classify/cluster-classify.md](../feature_catalog/cluster-classify/cluster-classify.md) |
| A11Y-001 | Accessibility Section Fidelity | Accessibility | [accessibility/accessibility-section.md](accessibility/accessibility-section.md) | [../feature_catalog/feature-extractors/feature-extractors.md](../feature_catalog/feature-extractors/feature-extractors.md) |
| DETECT-001 | Framework, Icon, And Motion Detection | Detectors | [detectors/framework-icon-motion-detection.md](detectors/framework-icon-motion-detection.md) | [../feature_catalog/feature-extractors/feature-extractors.md](../feature_catalog/feature-extractors/feature-extractors.md) |
| BOUNDARY-001 | Authoring boundary sorts values by origin | Authoring Boundary | [authoring-boundary/authoring-boundary.md](authoring-boundary/authoring-boundary.md) | [../feature_catalog/write-design-md/write-design-md.md](../feature_catalog/write-design-md/write-design-md.md) |
| PROVENANCE-001 | Source-of-truth router card sorts each value | Source-of-Truth | [source-of-truth/source-of-truth-card.md](source-of-truth/source-of-truth-card.md) | [../feature_catalog/write-design-md/write-design-md.md](../feature_catalog/write-design-md/write-design-md.md) |

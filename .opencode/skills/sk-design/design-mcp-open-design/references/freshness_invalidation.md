...
This document defines the freshness consumer for `DESIGN_PROOF_TOKEN` validation. It does not define a second token schema. Token fields, boundary responsibilities, and validator acceptance are inherited by citation from [`DESIGN_PROOF_TOKEN` §2, §6, and §7](../../shared/design_proof_token.md#2-field-schema-v1).

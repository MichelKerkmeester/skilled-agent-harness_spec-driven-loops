...
| Token validity | Delegate schema, freshness, replay, digest, file-hash, mode, and payload validation to the [`DESIGN_PROOF_TOKEN` contract](../../shared/design-proof-token.md). This contract does not redefine token internals. |

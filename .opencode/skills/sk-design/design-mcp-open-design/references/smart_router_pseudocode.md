...
- [`od_cli_reference.md`](od_cli_reference.md) - the default-loaded resource this router always fetches.
- [`mcp_wiring.md`](mcp_wiring.md) - the WIRE-direction resource.
- [`tool_surface.md`](tool_surface.md) - the READ/RUN-direction resource.

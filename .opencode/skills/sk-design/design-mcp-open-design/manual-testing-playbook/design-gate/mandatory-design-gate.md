...
| `../../feature-catalog/grounding/design-system-grounding.md` | Feature-catalog source describing the mandatory precondition |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `../../references/design-parity-transport.md` | The Open Design transport for the real-UI loop, applied with `sk-design`'s judgment |
| `../../../design-interface/references/design-process/real-ui-loop.md` | The real-UI loop and the design judgment the gate enforces |

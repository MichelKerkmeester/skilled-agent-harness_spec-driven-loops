...
| File | Layer | Role |
|---|---|---|
| `references/od_cli_reference.md` | Shared | Locating the CLI, the daemon socket model, and the verb surface |
| `references/tool_surface.md` | Shared | The roughly 18 tools and the live-verification requirement |

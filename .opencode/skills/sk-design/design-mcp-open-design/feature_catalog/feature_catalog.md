...
See [`wiring/od-mcp-install.md`](wiring/od_mcp_install.md) for the full behavior and the manual-config fallback.
...
See [`reading/read-only-content.md`](reading/read_only_content.md) for the tool list and the live-content rule.
...
See [`grounding/design-system-grounding.md`](grounding/design_system_grounding.md) for the integration contract and the guardrails that must survive.
...
See [`runs/headless-runs.md`](runs/headless_runs.md) for the surface, gate, and omit policy.
...
See [`transport/daemon-and-verification.md`](transport/daemon_and_verification.md) for the locate-and-confirm sequence and the verification requirement.

...
| `../../feature_catalog/02--reading/read-only-content.md` | Feature-catalog source describing the read contract |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `../../references/tool_surface.md` | The read-only tools and the surface policy |
| `../../references/od_cli_reference.md` | CLI verb surface with read-only classification |
...
- Feature file path: `02--reading/read-design-system.md`

...
The full steps, the socket-discovered daemon model (the HTTP port is ephemeral), and the gated wiring flow are in `../../INSTALL-GUIDE.md` and `../../references/mcp-wiring.md`.

...
See [`01--token-system/oklch-color-and-token-system.md`](01--token-system/oklch-color-and-token-system.md) for source anchors and the token starter scaffold.
...
See [`01--token-system/typography-and-spacing-scale.md`](01--token-system/typography-and-spacing-scale.md) for source anchors.
...
See [`02--adaptation-and-data/context-adaptation-matrix.md`](02--adaptation-and-data/context-adaptation-matrix.md) for the four adaptation dimensions and worked references.
...
See [`02--adaptation-and-data/data-visualization-discipline.md`](02--adaptation-and-data/data-visualization-discipline.md) for chart-type selection and encoding rules.
...
See [`03--procedure-cards/foundations-procedure-card-inventory.md`](03--procedure-cards/foundations-procedure-card-inventory.md) for the card list and boundaries.

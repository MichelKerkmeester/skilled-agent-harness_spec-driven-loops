...
- Feature file path: `02--adaptation-and-data/data-visualization-discipline.md`

Related references:
- [context-adaptation-matrix.md](context-adaptation-matrix.md) - Responsive and accessible chart adaptation per context.
- [../03--procedure-cards/foundations-procedure-card-inventory.md](../03--procedure-cards/foundations-procedure-card-inventory.md) - Private cards that review token, hierarchy, and control decisions after data work.

...
- Feature file path: `01--token-system/oklch-color-and-token-system.md`

Related references:
- [typography-and-spacing-scale.md](typography-and-spacing-scale.md) - Type and spacing scale built alongside the color system.
- [../02--adaptation-and-data/context-adaptation-matrix.md](../02--adaptation-and-data/context-adaptation-matrix.md) - Adaptation dimensions the token system must survive.

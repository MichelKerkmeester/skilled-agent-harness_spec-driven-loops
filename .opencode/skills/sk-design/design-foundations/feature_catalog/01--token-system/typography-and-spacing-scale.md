...
- Feature file path: `01--token-system/typography-and-spacing-scale.md`

Related references:
- [oklch-color-and-token-system.md](oklch-color-and-token-system.md) - Color token system built alongside type and spacing.
- [../02--adaptation-and-data/data-visualization-discipline.md](../02--adaptation-and-data/data-visualization-discipline.md) - Tabular-numeral and alignment rules extended for data tables.

...
> Make a UI look custom and intentional instead of templated, across direction, system, motion and CSS extraction.
...
| **Produces** | Design direction and tokens, motion specs, or a Style Reference DESIGN.md. |

...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/sk-design/design-interface/references/motion/animation-decision-framework.md` | Shared | Defines the frequency gate, the keyboard rule, the purpose test, and register coupling. |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/sk-design/design-interface/manual-testing-playbook/manual-testing-playbook.md` | Manual playbook | Exercises restraint-gate and decision scenarios against the live mode. |

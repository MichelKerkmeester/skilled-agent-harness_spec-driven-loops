...
description: "Current-state inventory of the one private design-interface procedure card and its read-only boundaries."
trigger_phrases:
  - "motion procedure card inventory"
  - "interaction states pass card"
  - "design-interface private card"
  - "motion state matrix"
version: 1.0.0.0
---
...
`design-interface` has one private procedure card selected for motion/interaction-state work after the public `interface` mode is chosen: `interaction_states_pass.md`.
...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/sk-design/design-interface/procedures/interaction-states-pass.md` | Shared | Interaction-states-pass card: purpose, procedure, and conflict rule. |

...
| `.opencode/skills/sk-design/design-interface/references/design-process/brief-to-dials.md` | Shared | Maps briefs into variance, motion, and density. |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.opencode/skills/sk-design/design-interface/assets/interface-preflight-card.md` | Manual playbook | Carries dial calibration into the final pre-flight check. |

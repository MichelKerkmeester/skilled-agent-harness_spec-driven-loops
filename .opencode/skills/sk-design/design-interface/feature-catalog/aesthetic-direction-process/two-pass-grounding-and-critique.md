...
| `.opencode/skills/sk-design/design-interface/references/design-process/design-principles.md` | Shared | Holds the detailed design-principles process used by the mode. |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.opencode/skills/sk-design/design-interface/assets/interface-preflight-card.md` | Manual playbook | Captures checkable pre-delivery evidence for interface work. |

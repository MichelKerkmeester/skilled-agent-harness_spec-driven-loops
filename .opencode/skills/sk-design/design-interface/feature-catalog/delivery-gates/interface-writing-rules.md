...
| `.opencode/skills/sk-design/design-interface/references/design-process/design-principles.md` | Shared | Contains full interface-writing guidance. |
| `.opencode/skills/sk-design/design-interface/references/design-process/copy-and-mock-data.md` | Shared | Defines the content gate and mock-data discipline. |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.opencode/skills/sk-design/design-interface/assets/interface-preflight-card.md` | Manual playbook | Verifies content-gate pass/fail items. |
...
Related references:
- [mechanical-delivery-gates.md](../delivery-gates/mechanical-delivery-gates.md) - Binary gates that include copy checks.

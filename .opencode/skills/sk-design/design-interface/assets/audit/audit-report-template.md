...
Map tells to findings using `../references/ai-fingerprint-tells.md`. A clean verdict here is not proof of a strong design, only proof of no obvious tells. Distinctiveness, hierarchy and flow still need judgment.

---

## 3. FINDINGS BY SEVERITY

List findings before the score. Order P0, then P1, then P2, then P3. Use the findings schema from `../references/audit-contract.md`. One finding per issue. Do not bury a P0 under polish.
...
Score each dimension 0 to 4 from the findings above. The score summarizes the findings, it does not replace them. Full rubric is in `../references/audit-contract.md`.

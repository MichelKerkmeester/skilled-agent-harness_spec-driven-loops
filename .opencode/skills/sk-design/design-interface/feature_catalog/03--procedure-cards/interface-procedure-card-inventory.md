...
- Feature file path: `03--procedure-cards/interface-procedure-card-inventory.md`

Related references:
- [../01--aesthetic-direction-process/two-pass-grounding-and-critique.md](../01--aesthetic-direction-process/two-pass-grounding-and-critique.md) - Baseline interface workflow cards support.
- [../02--delivery-gates/mechanical-delivery-gates.md](../02--delivery-gates/mechanical-delivery-gates.md) - Delivery proof after card use.

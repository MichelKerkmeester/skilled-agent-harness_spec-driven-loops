...
```bash
python3 .opencode/skills/sk-design/design-interface/scripts/baseline_rhythm_check.py <token-doc.md>
python3 .opencode/skills/sk-design/design-interface/scripts/contrast_check.py "#787878" "#ffffff"
python3 .opencode/skills/sk-design/design-interface/scripts/naming_doc_check.py <artifact.md>
```
...
```bash
python3 -m pytest .opencode/skills/sk-design/design-interface/scripts/tests/ -q
```

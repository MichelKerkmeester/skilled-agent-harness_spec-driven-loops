...
description: Index of illustrative visual-direction grounding cues for interface, subordinate to the reuse-first loop and never a chooser or preset menu.
trigger_phrases:
...
Illustrative visual-direction cues for `interface`, each a citeable example of a realized look to ground a critique against, not a menu to pick from.

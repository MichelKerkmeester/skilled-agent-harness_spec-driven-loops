...
- [`design-principles.md`](./design-principles.md) owns the aesthetic direction and the anti-default mandate. This gate is the structural complement, it catches what a taste read cannot.
- [`copy-and-mock-data.md`](./copy-and-mock-data.md) owns the content gate: plausible copy, mock data, one copy register, image-seed discipline.

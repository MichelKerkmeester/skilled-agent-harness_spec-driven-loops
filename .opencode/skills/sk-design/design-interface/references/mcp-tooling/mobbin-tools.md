...
- [`refero-tools.md`](./refero-tools.md) - the sibling real-world reference MCP (styles, screens, flows); its tool surface is canonically owned by the `mcp-refero` transport packet, and that file is the pointer.

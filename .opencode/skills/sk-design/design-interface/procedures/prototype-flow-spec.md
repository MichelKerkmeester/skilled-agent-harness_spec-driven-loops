...
If the user only needs structure, start with `wireframe-exploration.md`. If they need multiple prototype directions, combine with `variation-set.md` before handoff.

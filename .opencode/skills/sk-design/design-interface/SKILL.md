...
- [`references/mcp_tooling/refero_tools.md`](references/mcp_tooling/refero_tools.md) - Refero MCP tool catalog (styles-first model): call convention, result shape, troubleshooting.

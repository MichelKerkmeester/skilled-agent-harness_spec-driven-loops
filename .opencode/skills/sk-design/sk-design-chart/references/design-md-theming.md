...
style library. It was chosen from the library because its warm parchment and ink match the
corpus' own chrome, it carries a muted ladder and a hairline rule, and its accents clear the mark

---
title: Image Counterweight
description: Structural fingerprint that uses owned imagery as evidence and compositional counterweight rather than decoration.
trigger_phrases:
  - "image counterweight structure"
  - "evidence led imagery composition"
...
- **Divider language:** shift between image-led and text-led regions through changes in evidence role, not ornamental separators.
- **Button voice:** actions near imagery name what the user can inspect, compare, or do next; they do not turn the asset into bait.
...
**Reach for it when:** owned or licensed imagery provides product proof, process evidence, spatial understanding, or narrative specificity that text alone cannot deliver.
...
- Generic imagery fills expected slots without adding product or subject evidence.
...
Visible proof names each image's evidence role and links it to a valid owned-asset manifest entry, including fallback. Record `cardId: "image-counterweight"` in the shared `structuralFingerprintSelections` envelope with image-treatment emphasis, applied regions, responsive-gate observation, and proof that the page remains intelligible without decorative media.

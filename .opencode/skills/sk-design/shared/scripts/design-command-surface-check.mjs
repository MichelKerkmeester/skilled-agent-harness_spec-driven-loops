...
const MODE_SKILL_RESOURCE_PATTERN = /^\.opencode\/skills\/sk-design\/sk-design-([a-z-]+)\/SKILL\.md$/;
const MODE_PROCEDURES_RESOURCE_PATTERN = /^\.opencode\/skills\/sk-design\/sk-design-([a-z-]+)\/procedures\/$/;
const MODE_REFERENCES_RESOURCE_PATTERN = /^\.opencode\/skills\/sk-design\/sk-design-([a-z-]+)\/references\/$/;
...
const interfaceSkillUrl = new URL("sk-design-interface/SKILL.md", skillRootUrl);

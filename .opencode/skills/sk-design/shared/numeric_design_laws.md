...
| spacing-scale | 4px, 8px, 12px, 16px, 24px, 32px, 48px; section spacing clamp(48px, 8vw, 96px) | foundations | advisory (no script) | design-foundations/assets/token_starter.md Section 4 - Spacing Scale | Pull filled spacing tokens from the scale; no checker currently rejects one-off spacing values. |

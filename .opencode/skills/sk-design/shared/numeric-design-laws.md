...
| neutral-chroma | neutral tint C 0.005-0.015 toward the brand hue | foundations | advisory (no script) | design-interface/assets/foundations/token-starter.md Section 2 - Color Ramp | Tiny chroma keeps neutrals branded without turning surfaces into accent colors. |

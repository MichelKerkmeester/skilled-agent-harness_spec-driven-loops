...
Fill this at the end of design, build, audit, or delegated work. It proves the loaded context changed the output, not merely that files were opened. Full contract: `../context-loading-contract.md`.

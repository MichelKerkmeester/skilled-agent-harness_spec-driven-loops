...
Fill this before design decisions, build work, audit claims, or agent dispatch. Full contract: `../context-loading-contract.md`.
...
|---|---|
| `../register.md` | [ ] yes [ ] no |
| `../../sk-design-interface/references/design-process/brief-to-dials.md` | [ ] yes [ ] no |
| `../../sk-design-interface/SKILL.md` | [ ] yes [ ] no [ ] N/A |
| `../../sk-design-interface/assets/interface-preflight-card.md` | [ ] yes [ ] no [ ] N/A |
...
Recompute rule: raw-byte sha256 per `../design-proof-token.md` section 4. Gate: `python3 ../scripts/proof_check.py --require-source-proof <this-file>.md`.

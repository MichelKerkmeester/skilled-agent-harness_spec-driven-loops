...
- Feature file path: `03--procedure-cards/audit-procedure-card-inventory.md`

Related references:
- [../02--ai-tell-catalog/ai-fingerprint-tell-catalog.md](../02--ai-tell-catalog/ai-fingerprint-tell-catalog.md) - Tell catalog the AI-slop-check card applies.
- [../01--findings-first-review/findings-first-report-and-scoring.md](../01--findings-first-review/findings-first-report-and-scoring.md) - Findings schema both cards' output feeds into.

...
1. Load `references/accessibility-performance.md`, `assets/a11y-quick-fixes.md` and `references/audit-contract.md`.
...
- Contrast and touch findings measure against the numbers in `references/accessibility-performance.md` rather than an eyeball.

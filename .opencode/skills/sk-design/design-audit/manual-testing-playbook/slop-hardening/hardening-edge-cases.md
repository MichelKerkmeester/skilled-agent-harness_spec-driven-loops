...
expected_resources:
  ...
  - references/hardening-edge-cases.md
---
...
1. Load `references/hardening-edge-cases.md` and `references/audit-contract.md`.
...
- Resilience gaps that block assistive use route to Accessibility, with the disabled-control explanation pointing at `assets/a11y-quick-fixes.md`.

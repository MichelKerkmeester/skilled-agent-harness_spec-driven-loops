...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/sk-design/design-audit/references/ai-fingerprint-tells.md` | Shared | Defines every model-specific tell, its check, owner, and severity. |
| `.opencode/skills/sk-design/design-audit/references/audit-contract.md` | Shared | Supplies the severity model and findings schema tells are filed against. |
| `.opencode/skills/sk-design/design-audit/references/anti-patterns-production.md` | Shared | Supplies the shared anti-slop vocabulary this catalog sits beneath. |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.opencode/skills/sk-design/design-audit/assets/ai-fingerprint-registry.json` | Automated test | Machine-checkable row per tell, verified against the catalog for parity. |
| `.opencode/skills/sk-design/design-audit/manual-testing-playbook/manual-testing-playbook.md` | Manual playbook | Exercises AI-tell detection scenarios against the live mode. |

...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/sk-design/design-audit/references/audit-contract.md` | Shared | Defines the five-dimension score the register gates before scoring begins. |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/sk-design/design-audit/manual-testing-playbook/manual-testing-playbook.md` | Manual playbook | Exercises register-gated severity scenarios against the live mode. |
...
Related references:
- [findings-first-report-and-scoring.md](../findings-first-review/findings-first-report-and-scoring.md) - The scoring contract this register call gates.

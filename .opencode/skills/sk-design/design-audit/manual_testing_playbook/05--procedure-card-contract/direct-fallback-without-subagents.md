...
- Expected execution process: No Task dispatch; select `procedures/accessibility_audit.md`; record target artifact, available/missing evidence, audit bar, full vs focused score, evidence labels, dimensions covered, and not-assessed fields.
...
| `../../references/audit_contract.md` | Findings-first audit contract |
| `../../references/evidence_capture.md` | Evidence labels |
...
- Feature file path: `05--procedure-card-contract/direct-fallback-without-subagents.md`

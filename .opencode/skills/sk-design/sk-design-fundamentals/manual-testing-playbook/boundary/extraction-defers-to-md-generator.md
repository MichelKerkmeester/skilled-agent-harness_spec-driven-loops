...
1. `bash: python3 .opencode/skills/system-skill-advisor/runtime/scripts/skill_advisor.py "extract the design system from stripe.com" --threshold 0.5`

...
That output gives you the PRE-RENDERED value sections and a FACTS block. That is your
...
VOICE: named, confident, restrained, like a design-system handoff rather than an
extraction report. DO assign evocative colour names, name components by function, and infer a
...
5. No mechanical noise: no frequency dumps ("border 9685"), no raw DOM tags. Frequency
   decides prominence/role, and it is never printed.

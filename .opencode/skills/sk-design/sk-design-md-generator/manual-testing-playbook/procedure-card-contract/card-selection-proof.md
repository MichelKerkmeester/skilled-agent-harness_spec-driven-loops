...
This scenario validates `sk-design-md-generator/SKILL.md` section `Procedure Card Selection`: measured extraction, token capture, CSS capture, `DESIGN.md` generation, source design systems, screenshots, brand references, gaps, inconsistencies, or grounding future work in an existing surface select `procedures/design-system-extraction.md`.

...
This scenario validates `sk-design-interface/SKILL.md` redesign intake: classifying the work as greenfield, preserve, or overhaul before any visual change, and naming every approval-gated item that must not change silently.

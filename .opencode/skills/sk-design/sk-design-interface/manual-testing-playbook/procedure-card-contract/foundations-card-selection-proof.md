...
This scenario validates `sk-design-interface/SKILL.md` section `Procedure Card Selection` across all three foundations-owned cards: `tweakable-design-controls.md`, `component-system-inventory.md`, and `hierarchy-rhythm-review.md`.

...
```text
Subagents are unavailable. Define the interaction-state matrix directly in this session and show the selected card, context basis, proof line, and read-only boundary.
```
...
- Prompt: `Subagents are unavailable. Define the interaction-state matrix directly in this session and show the selected card, context basis, proof line, and read-only boundary.`
...
- Feature file path: `procedure-card-contract/motion-direct-fallback-without-subagents.md`

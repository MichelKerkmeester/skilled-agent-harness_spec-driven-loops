...
description: "Current-state reference for design-interface's frequency-based restraint gate that decides whether an interaction animates at all."
trigger_phrases:
...
`design-interface` answers "should this animate at all" before any timing, easing, or material choice, because most over-animated interfaces fail at this question rather than at the timing scale.
...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/sk-design/sk-design-interface/references/motion/animation-decision-framework.md` | Shared | Defines the frequency gate, the keyboard rule, the purpose test, and register coupling. |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/sk-design/sk-design-interface/manual-testing-playbook/manual-testing-playbook.md` | Manual playbook | Exercises restraint-gate and decision scenarios against the live mode. |
...
Related references:
- [choreography-and-reduced-motion.md](../restraint-gate-and-choreography/choreography-and-reduced-motion.md) - Choreography for choices that survive the gate.

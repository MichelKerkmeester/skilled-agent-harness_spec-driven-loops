...
description: "Current-state reference for design-interface's fill-in build cards covering feedback, hover, focus, loading, transition, toast, gesture, and async-state patterns."
trigger_phrases:
...
`design-interface` converts a gate-approved motion decision into a build-ready spec using one fill-in card per interaction pattern, each naming owner, purpose, the state path, and a reduced-motion equivalent before any motion code is written.
...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/sk-design/sk-design-interface/assets/motion/motion-pattern-cards.md` | Shared | Defines all eleven fill-in cards, shared fields, and per-pattern checklists. |
| `.opencode/skills/sk-design/sk-design-interface/references/motion/motion-strategy.md` | Shared | Supplies the timing and easing values cards cite rather than invent. |
| `.opencode/skills/sk-design/sk-design-interface/references/motion/micro-interactions.md` | Shared | Supplies gesture and drag-and-drop behavior rules the corresponding cards cite. |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.opencode/skills/sk-design/sk-design-interface/assets/motion/motion-performance-failure-card.md` | Manual playbook | Build-side card of frame-dropping patterns checked before cards are handed off. |
| `.opencode/skills/sk-design/sk-design-interface/manual-testing-playbook/manual-testing-playbook.md` | Manual playbook | Exercises micro-interaction and advanced-craft card scenarios against the live mode. |

...
When the request is primarily an accessibility release claim, `interface`'s pre-delivery gate (`sk-design-interface/assets/interface-preflight-card.md`) owns the verdict while this card supplies the interaction-state standard it cites.
...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/sk-design/sk-design-interface/procedures/interaction-states-pass.md` | Shared | Interaction-states-pass card: purpose, procedure, and conflict rule. |

...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/sk-design/sk-design-interface/references/foundations/color/oklch-workflow.md` | Shared | Defines OKLCH channels, palette generation, contrast repair, and gamut/fallback rules. |
| `.opencode/skills/sk-design/sk-design-interface/references/foundations/color/palette-theming.md` | Shared | Defines color dosage, semantic roles, tinted neutrals, surface scales, and dark-mode mapping. |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/sk-design/sk-design-interface/manual-testing-playbook/manual-testing-playbook.md (section 23)` | Manual playbook | Exercises OKLCH color and token-system scenarios against the live mode. |
...
Related references:
- [typography-and-spacing-scale.md](../token-system/typography-and-spacing-scale.md) - Type and spacing scale built alongside the color system.

...
description: "Current-state reference for the foundations subworkflow's chart-type selection, encoding discipline, color-for-data scales, and table alignment."
trigger_phrases:
  - "data visualization discipline"
  - "foundations chart selection"
...
The `foundations` subworkflow treats chart and table encoding as design: a chart type is chosen by the question rather than the dataset shape, every visual channel carries one variable, and numeric tables align for magnitude rather than decoration.
...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/sk-design/sk-design-interface/references/foundations/data-viz.md` | Shared | Defines chart-type selection, axis/encoding rules, color-for-data scales, sparklines, and table alignment. |
| `.opencode/skills/sk-design/sk-design-interface/references/foundations/color/oklch-workflow.md` | Shared | Supplies the OKLCH channel mechanics used to build even lightness-ramped data scales. |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.opencode/skills/sk-design/sk-design-interface/manual-testing-playbook/manual-testing-playbook.md (section 23)` | Manual playbook | Exercises data-visualization scenarios against the live mode. |
...
Related references:
- [context-adaptation-matrix.md](../adaptation-and-data/context-adaptation-matrix.md) - Responsive and accessible chart adaptation per context.

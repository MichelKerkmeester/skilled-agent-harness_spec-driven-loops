...
- None required. `design-mcp-open-design` is a transport packet, not a doc-guidance mode; it does not consume `shared/anti_slop_principles.md`, `shared/cognitive_laws.md`, or `shared/design_token_vocabulary.md`.

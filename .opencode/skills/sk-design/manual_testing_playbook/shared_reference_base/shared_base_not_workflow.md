...
- The AI may cite `shared/anti_slop_principles.md`, `shared/cognitive_laws.md`, or `shared/design_token_vocabulary.md` as reference-base examples, but must not treat them as a workflow packet.

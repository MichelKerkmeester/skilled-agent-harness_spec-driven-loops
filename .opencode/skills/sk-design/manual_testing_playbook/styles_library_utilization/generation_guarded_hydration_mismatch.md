...
| `../../feature_catalog/styles_library_utilization/retrieval_engine.md` | Retrieval and hydration contract. |
...
- Feature file path: `styles_library_utilization/generation_guarded_hydration_mismatch.md`

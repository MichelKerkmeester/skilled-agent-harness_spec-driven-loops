...
| `../../feature_catalog/styles_library_utilization/shared_corpus_context_seam.md` | Zero-hydration and authority contract. |
...
- Feature file path: `styles_library_utilization/zero_hydration_seam_envelope.md`

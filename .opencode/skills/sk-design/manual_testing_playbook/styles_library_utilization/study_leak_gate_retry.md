...
| `../../feature_catalog/styles_library_utilization/md_generator_schema_and_study.md` | Generator schema, STUDY and retry contract. |
...
- Feature file path: `styles_library_utilization/study_leak_gate_retry.md`

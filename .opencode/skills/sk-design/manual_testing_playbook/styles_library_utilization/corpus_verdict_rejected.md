...
| `../../feature_catalog/styles_library_utilization/shared_corpus_context_seam.md` | Fixed authority order and corpus prohibitions. |
...
- Feature file path: `styles_library_utilization/corpus_verdict_rejected.md`

...
|---|---|---|
| Corpus | `node .opencode/skills/sk-design/sk-create-chart/scripts/check-corpus.cjs` | `RESULT: PASSED` |
| Package shape | `python3 .opencode/skills/sk-doc/sk-create-skill/scripts/package_skill.py .opencode/skills/sk-design/sk-create-chart --check --strict` | `Result: PASS` |

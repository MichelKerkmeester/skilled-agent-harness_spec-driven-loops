...
1. `bash: node .opencode/skills/sk-design/sk-create-chart/scripts/check-corpus.cjs --render > before.txt 2>&1`
2. `bash: echo $?`
...
6. `bash: cp .opencode/skills/sk-design/sk-create-chart/assets/templates/bar-columns.html /tmp/keep.html`
...
8. `bash: node .opencode/skills/sk-design/sk-create-chart/scripts/check-corpus.cjs --render > broken.txt 2>&1`
9. `bash: cp /tmp/keep.html .opencode/skills/sk-design/sk-create-chart/assets/templates/bar-columns.html`
10. `bash: node .opencode/skills/sk-design/sk-create-chart/scripts/check-corpus.cjs --render > after.txt 2>&1`
11. `bash: git status --porcelain .opencode/skills/sk-design/sk-create-chart`

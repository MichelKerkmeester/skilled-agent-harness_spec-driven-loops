...
6. `bash: node .opencode/skills/sk-design/sk-create-chart/scripts/check-corpus.cjs > corpus.txt 2>&1`
7. `bash: git status --porcelain .opencode/skills/sk-design/sk-create-chart`

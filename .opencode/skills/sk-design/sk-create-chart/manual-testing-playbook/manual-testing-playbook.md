...
1. Working directory is the repository root, so every `.opencode/skills/sk-design/sk-create-chart/` subpath in this package resolves.
...
- `git status --porcelain .opencode/skills/sk-design/sk-create-chart` for the packet path
...
- Repo-relative paths are written as `.opencode/skills/sk-design/sk-create-chart/...`. The packet root means that directory wherever the packet is installed.

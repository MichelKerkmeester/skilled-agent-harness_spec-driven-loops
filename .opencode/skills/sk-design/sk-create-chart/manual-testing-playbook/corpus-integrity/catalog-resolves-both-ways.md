...
3. `bash: node .opencode/skills/sk-design/sk-create-chart/scripts/check-corpus.cjs > phantom-row.txt 2>&1`
4. `bash: git checkout -- .opencode/skills/sk-design/sk-create-chart/references/catalog.md`
...
6. `bash: node .opencode/skills/sk-design/sk-create-chart/scripts/check-corpus.cjs > orphan-file.txt 2>&1`
7. `bash: rm .opencode/skills/sk-design/sk-create-chart/assets/templates/orphan-form.html`
8. `bash: node .opencode/skills/sk-design/sk-create-chart/scripts/check-corpus.cjs > after.txt 2>&1`
9. `bash: git status --porcelain .opencode/skills/sk-design/sk-create-chart`

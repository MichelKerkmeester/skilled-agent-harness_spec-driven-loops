...
- Feature file path: `styles-library-utilization/shared-corpus-context-seam.md`

Related references:
- [retrieval-engine.md](retrieval-engine.md) - Engine that supplies generation-bound candidate evidence.
- [per-mode-consumers.md](per-mode-consumers.md) - Consumers that apply mode-owned decisions after the seam.

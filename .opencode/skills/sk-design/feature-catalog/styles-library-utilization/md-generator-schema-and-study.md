...
- Feature file path: `styles-library-utilization/md-generator-schema-and-study.md`

Related references:
- [retrieval-engine.md](retrieval-engine.md) - Candidate selection and guarded hydration used by STUDY.
- [per-mode-consumers.md](per-mode-consumers.md) - Other mode-owned consumers of styles-library evidence.

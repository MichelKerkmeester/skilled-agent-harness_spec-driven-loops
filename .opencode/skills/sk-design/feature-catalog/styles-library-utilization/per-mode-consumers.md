...
- Feature file path: `styles-library-utilization/per-mode-consumers.md`

Related references:
- [shared-corpus-context-seam.md](shared-corpus-context-seam.md) - Shared neutral envelope and authority contract.
- [md-generator-schema-and-study.md](md-generator-schema-and-study.md) - Separate generator consumer with schema and authoring gates.

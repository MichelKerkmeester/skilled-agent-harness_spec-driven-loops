...
Each canonical command has an auto workflow, a confirm workflow and a presentation contract. All three reference `shared/creation-contract.md`, which defines the common nine-stage lifecycle, rather than copying mode-specific design judgment into command wrappers.
...
| `.opencode/commands/interface/*.md` | Canonical routers | Exposes the three `/interface:*` creation commands. |

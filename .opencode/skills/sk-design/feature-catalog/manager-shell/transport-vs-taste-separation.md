...
Related references:
- [context-first-intake-and-visible-plan.md](../manager-shell/context-first-intake-and-visible-plan.md) - Hub intake before transport use.
- [proof-gates-and-verifier-cadence.md](../manager-shell/proof-gates-and-verifier-cadence.md) - Proof required after transport evidence returns.

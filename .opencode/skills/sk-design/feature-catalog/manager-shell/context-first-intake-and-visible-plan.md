...
Related references:
- [proof-gates-and-verifier-cadence.md](../manager-shell/proof-gates-and-verifier-cadence.md) - Proof required before ready claims.
- [transport-vs-taste-separation.md](../manager-shell/transport-vs-taste-separation.md) - Transport boundary for evidence and artifacts.

...
**Expected procedure card**: `design-foundations/procedures/hierarchy-rhythm-review.md`.
...
2. `design-foundations/procedures/hierarchy-rhythm-review.md` exists and names confirmed-versus-inferred proof in its proof gate.
...
- **PASS** iff advisor top-1 is `sk-design`, resolved mode is `foundations`, the response names `design-foundations/procedures/hierarchy-rhythm-review.md`, it separates confirmed evidence from inferred claims, it names proof still required before readiness, and no mutating tool is used.
...
- `.opencode/skills/sk-design/design-foundations/procedures/hierarchy-rhythm-review.md`

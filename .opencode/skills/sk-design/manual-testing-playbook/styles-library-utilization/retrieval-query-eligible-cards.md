...
| `../../feature-catalog/styles-library-utilization/retrieval-engine.md` | Current retrieval-engine contract and source anchors. |
...
- Feature file path: `styles-library-utilization/retrieval-query-eligible-cards.md`

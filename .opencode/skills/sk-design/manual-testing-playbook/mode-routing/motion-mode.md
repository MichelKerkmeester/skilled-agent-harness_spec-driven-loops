...
expected_leaf_resources:
  ...
  - workflow_mode: motion
    leaf_resource_id: references/animation-decision-framework.md
  - workflow_mode: motion
    leaf_resource_id: references/micro-interactions.md
  - workflow_mode: motion
    leaf_resource_id: references/performance-reduced-motion.md
  - workflow_mode: motion
    leaf_resource_id: assets/motion-pattern-cards.md
---

...
expected_leaf_resources:
  ...
  - workflow_mode: audit
    leaf_resource_id: references/accessibility-performance.md
  - workflow_mode: audit
    leaf_resource_id: references/anti-patterns-production.md
  - workflow_mode: audit
...
- `shared/sk-code-handoff.md` if accepted findings are routed to implementation
...
2. If the report lacks severity or score structure, inspect `design-audit/references/audit-contract.md` and `design-audit/assets/audit-report-template.md`.

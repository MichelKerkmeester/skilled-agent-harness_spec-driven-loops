...
| `../../feature_catalog/01--loop-lifecycle/loop-wide-dry-run.md` | Matching feature catalog entry |
...
- Feature file path: `01--entry-points-and-modes/loop-wide-dry-run.md`
- Feature catalog: `feature_catalog/01--loop-lifecycle/loop-wide-dry-run.md`

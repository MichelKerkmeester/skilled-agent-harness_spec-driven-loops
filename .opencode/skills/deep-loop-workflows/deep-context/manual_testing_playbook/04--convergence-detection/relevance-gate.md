...
| `.opencode/skills/deep-loop-workflows/deep-context/references/convergence/convergence.md` | §2: STOP contract, STOP_BLOCKED conditions with threshold values |
| `.opencode/skills/deep-loop-workflows/deep-context/SKILL.md` | §6 Success Criteria: quality gates including relevanceFloor and agreementRate |

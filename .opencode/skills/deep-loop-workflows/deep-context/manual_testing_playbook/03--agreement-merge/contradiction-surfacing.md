...
```bash
rg "module\.exports" .opencode/skills/deep-loop-workflows/deep-context/scripts/reduce-state.cjs
```
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/deep-context/scripts/reduce-state.cjs` | `detectContradictions`, `signatureByProducer`, `reuseByProducer`, `renderDashboard` contradiction section |
| `.opencode/skills/deep-loop-workflows/deep-context/references/protocol/loop_protocol.md` | §6: contradiction surfacing rule and CONTRADICTS edge documentation |

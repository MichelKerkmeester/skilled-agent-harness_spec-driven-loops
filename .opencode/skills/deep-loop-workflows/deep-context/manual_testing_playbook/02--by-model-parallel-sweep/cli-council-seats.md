...
| File | Role |
|---|---|
| `.opencode/commands/deep/assets/deep_context_auto.yaml` | `step_sweep_cli_pool`: CLI fan-out step in the loop phase |
...
| `.opencode/skills/deep-loop-workflows/deep-context/references/protocol/loop_protocol.md` | §5: CLI seat dispatch requirements and per-kind flag documentation |
| `.opencode/skills/deep-loop-workflows/deep-context/SKILL.md` | §4 ALWAYS rule 5: cli-* contract compliance including closed stdin |

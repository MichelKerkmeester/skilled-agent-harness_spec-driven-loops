...
| File | Role |
|---|---|
| `.opencode/commands/deep/assets/deep_context_auto.yaml` | Primary: `step_parallel_sweep`, `step_sweep_native_batch`, `step_sweep_cli_pool` in the loop phase |
| `.opencode/skills/deep-loop-workflows/deep-context/references/protocol/loop_protocol.md` | §5: concurrent dispatch, barrier-join, both seat groups |
| `.opencode/skills/deep-loop-workflows/deep-context/SKILL.md` | §3: by-model parallel sweep description with barrier-join |

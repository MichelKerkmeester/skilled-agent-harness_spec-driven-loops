...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/deep-context/manual_testing_playbook/02--by-model-parallel-sweep/heterogeneous-pool-dispatch.md` | Manual playbook | Verifies concurrent launch, barrier join, and graceful seat degradation |

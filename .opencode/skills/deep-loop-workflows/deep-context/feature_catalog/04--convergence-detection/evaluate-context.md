...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/deep-context/manual_testing_playbook/04--convergence-detection/evaluate-context.md` | Manual playbook | Verifies convergence.cjs exits 0, emits parseable JSON with all five signal fields and a valid decision enum value |

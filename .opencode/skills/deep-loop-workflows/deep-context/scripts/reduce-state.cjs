 ...
 * @returns {{records: Array<Object>, corruptionWarnings: Array<{line:number, length:number, sha256:string, error:string}>}}
 */
...
if (require.main === module) {
  ...
  if (!specFolder) {
    process.stderr.write(
      'Usage: node .opencode/skills/deep-loop-workflows/deep-context/scripts/reduce-state.cjs <spec-folder>\n',
    );
    process.exit(1);
  }

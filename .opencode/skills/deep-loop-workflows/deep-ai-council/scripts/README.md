...
description: "Code-facing README for .opencode/skills/deep-loop-workflows/deep-ai-council/scripts."
trigger_phrases:
...
This README documents the code-bearing folder `.opencode/skills/deep-loop-workflows/deep-ai-council/scripts` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/deep-loop-workflows/deep-ai-council/scripts
```
...
```text
User request: Check .opencode/skills/deep-loop-workflows/deep-ai-council/scripts for sk-code and README coverage.

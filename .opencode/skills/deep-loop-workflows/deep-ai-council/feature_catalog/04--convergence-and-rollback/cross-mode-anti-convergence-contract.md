...
| `.opencode/skills/deep-loop-runtime/lib/deep-loop/runtime-capabilities.cjs` | Shared runtime | Rejects missing or non-fail-closed stop policy. |
...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/04--convergence-and-rollback/cross-mode-anti-convergence-contract.md` | Manual scenario | Verifies council config, runtime matrix, runtime resolver, and optimizer anchors. |
...
- Feature file path: `feature_catalog/04--convergence-and-rollback/cross-mode-anti-convergence-contract.md`
- Playbook scenario: `manual_testing_playbook/04--convergence-and-rollback/cross-mode-anti-convergence-contract.md`
Related references:

...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/deep-loop-workflows/deep-ai-council/scripts/lib/persist-artifacts.cjs` | Library | Writer library and audit event implementation |
...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/07--writer-library-contract/library-writer-call-sequence.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/07--writer-library-contract/library-writer-call-sequence.md`
- Playbook scenario: `manual_testing_playbook/07--writer-library-contract/library-writer-call-sequence.md`
Related references:

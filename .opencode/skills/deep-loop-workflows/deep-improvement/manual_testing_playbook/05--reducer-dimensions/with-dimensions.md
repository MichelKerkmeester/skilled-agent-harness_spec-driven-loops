---
title: "RD-015 -- JSONL With Dimensions Produces Dimensional Progress Table"
...
This document captures the canonical manual-testing contract for `RD-015`.
...
- Prompt: `Validate that dimension-bearing JSONL records produce a Dimensional Progress table.`
...
| `05--reducer-dimensions/with-dimensions.md` | Canonical per-feature execution contract |
...
- Feature file path: `05--reducer-dimensions/with-dimensions.md`

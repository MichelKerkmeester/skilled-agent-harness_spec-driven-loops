---
title: "RD-016 -- Plateau Detection on Identical Dimension Scores"
...
This document captures the canonical manual-testing contract for `RD-016`.
...
- Prompt: `Validate that three identical dimension scores trigger the plateau stop condition.`
...
| `05--reducer-dimensions/plateau-detection.md` | Canonical per-feature execution contract |
...
- Feature file path: `05--reducer-dimensions/plateau-detection.md`

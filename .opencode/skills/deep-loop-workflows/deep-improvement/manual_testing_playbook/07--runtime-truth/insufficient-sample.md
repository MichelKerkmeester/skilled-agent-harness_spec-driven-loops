...
| `07--runtime-truth/insufficient-sample.md` | Canonical per-feature execution contract |
...
| `../../scripts/shared/tests/fixtures/low-sample-benchmark` | Implementation or verification anchor referenced by this scenario |
| `../../scripts/shared/tests/fixtures/low-sample-benchmark/` | Implementation or verification anchor referenced by this scenario |
...
- Feature file path: `07--runtime-truth/insufficient-sample.md`

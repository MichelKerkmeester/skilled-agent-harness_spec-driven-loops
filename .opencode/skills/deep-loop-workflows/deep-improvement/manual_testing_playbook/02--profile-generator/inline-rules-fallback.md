...
- Prompt: `Validate that inline NEVER rules are extracted even without a dedicated RULES section.`
...
| `02--profile-generator/inline-rules-fallback.md` | Canonical per-feature execution contract |
...
- Feature file path: `02--profile-generator/inline-rules-fallback.md`

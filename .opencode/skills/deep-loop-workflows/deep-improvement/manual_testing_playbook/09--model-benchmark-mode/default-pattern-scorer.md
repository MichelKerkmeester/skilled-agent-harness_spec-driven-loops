...
| `09--model-benchmark-mode/default-pattern-scorer.md` | Canonical per-feature execution contract |
...
- Feature file path: `09--model-benchmark-mode/default-pattern-scorer.md`

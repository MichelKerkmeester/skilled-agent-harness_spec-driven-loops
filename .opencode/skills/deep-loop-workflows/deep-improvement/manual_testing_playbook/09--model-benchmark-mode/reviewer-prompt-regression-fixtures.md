...
| `../../assets/model_benchmark/benchmark-profiles/reviewer-regression.json` | Shipped reviewer-regression profile bundling the four `reviewer-*` fixtures |
| `../../assets/model_benchmark/benchmark-fixtures/reviewer-stale-verdict.json` | Seed reviewer fixture (expected `fail`) used in this scenario |

...
| `09--model-benchmark-mode/score-delta-benchmark-gates.md` | Canonical per-feature execution contract |
...
- Feature file path: `09--model-benchmark-mode/score-delta-benchmark-gates.md`

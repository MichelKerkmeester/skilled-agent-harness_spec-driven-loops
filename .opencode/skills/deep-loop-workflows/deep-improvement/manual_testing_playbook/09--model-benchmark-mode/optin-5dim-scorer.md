---
title: "MB-040 -- Opt-In 5-Dimension Scorer"
...
This document captures the canonical manual-testing contract for `MB-040`.
...
| `09--model-benchmark-mode/optin-5dim-scorer.md` | Canonical per-feature execution contract |
...
- Feature file path: `09--model-benchmark-mode/optin-5dim-scorer.md`

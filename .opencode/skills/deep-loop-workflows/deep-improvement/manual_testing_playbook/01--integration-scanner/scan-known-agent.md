...
| `01--integration-scanner/scan-known-agent.md` | Canonical per-feature execution contract |
...
| `.opencode/agents/` | Implementation or verification anchor referenced by this scenario |
| `.opencode/agents/debug.md` | Implementation or verification anchor referenced by this scenario |
| `.opencode/skills/*/commands/` | Implementation or verification anchor referenced by this scenario |
...
- Feature file path: `01--integration-scanner/scan-known-agent.md`

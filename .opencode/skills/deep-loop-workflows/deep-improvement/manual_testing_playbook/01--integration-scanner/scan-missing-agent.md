...
| `01--integration-scanner/scan-missing-agent.md` | Canonical per-feature execution contract |
...
- Feature file path: `01--integration-scanner/scan-missing-agent.md`

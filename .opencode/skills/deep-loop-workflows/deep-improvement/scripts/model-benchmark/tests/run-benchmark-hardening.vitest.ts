...
const DEFAULT_PROFILE = path.join(WORKSPACE_ROOT, '.opencode/skills/deep-loop-workflows/deep-improvement/assets/model_benchmark/benchmark-profiles/default.json');

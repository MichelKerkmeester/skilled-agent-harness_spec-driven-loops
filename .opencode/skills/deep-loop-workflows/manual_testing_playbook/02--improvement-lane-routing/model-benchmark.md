...
1. `.opencode/skills/deep-loop-workflows/mode-registry.json` contains the `model-benchmark` mode entry.
...
- `.opencode/skills/deep-loop-workflows/mode-registry.json` - `model-benchmark` source of truth.

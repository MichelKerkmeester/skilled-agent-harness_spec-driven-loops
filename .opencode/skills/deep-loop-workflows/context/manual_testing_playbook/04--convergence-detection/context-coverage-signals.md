...
| `.opencode/skills/deep-loop-workflows/context/references/convergence/convergence_signals.md` | §2: signal roles and meanings table |
| `.opencode/skills/deep-loop-workflows/context/SKILL.md` | §8 Quick Reference: signals listed with thresholds |

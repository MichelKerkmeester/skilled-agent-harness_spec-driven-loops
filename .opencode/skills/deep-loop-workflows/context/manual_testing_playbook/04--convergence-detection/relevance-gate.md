...
| File | Role |
|---|---|
| `.opencode/commands/deep/assets/deep_context_auto.yaml` | `step_check_convergence`: dual-gate acceptance and blocked_stop event |
| `.opencode/skills/deep-loop-workflows/context/references/convergence/convergence.md` | §2: STOP contract, STOP_BLOCKED conditions with threshold values |
| `.opencode/skills/deep-loop-workflows/context/SKILL.md` | §6 Success Criteria: quality gates including relevanceFloor and agreementRate |

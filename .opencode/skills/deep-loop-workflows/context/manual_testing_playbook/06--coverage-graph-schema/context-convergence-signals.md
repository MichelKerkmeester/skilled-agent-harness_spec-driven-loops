...
| `.opencode/skills/deep-loop-workflows/context/scripts/reduce-state.cjs` | `DEFAULT_RELEVANCE_GATE = 0.55`, `DEFAULT_AGREEMENT_MIN = 2` — must match signals constants |
...
| `.opencode/skills/deep-loop-workflows/context/references/convergence/convergence_signals.md` | Composite score formula using all five signal fields with documented weights |

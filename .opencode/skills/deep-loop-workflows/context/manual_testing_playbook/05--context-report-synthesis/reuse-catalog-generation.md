...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/context/assets/context_report_template.md` | Context Report schema: REUSE catalog first, field list, pointers not bodies |
| `.opencode/skills/deep-loop-workflows/context/SKILL.md` | §3: output description; §4 ALWAYS rules 4 and 6 (verification + pointers) |

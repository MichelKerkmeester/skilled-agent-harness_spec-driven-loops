...
| `.opencode/skills/deep-loop-workflows/context/references/protocol/loop_protocol.md` | §5: CLI seat dispatch requirements and per-kind flag documentation |
| `.opencode/skills/deep-loop-workflows/context/SKILL.md` | §4 ALWAYS rule 5: cli-* contract compliance including closed stdin |

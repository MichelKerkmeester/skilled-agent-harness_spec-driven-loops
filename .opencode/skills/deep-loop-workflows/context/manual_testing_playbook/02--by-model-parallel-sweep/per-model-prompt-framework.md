...
| `.opencode/skills/deep-loop-workflows/context/SKILL.md` | §4 ALWAYS rule 3: `sk-prompt-small-model` mandate and per-framework assignments |
| `.opencode/skills/deep-loop-workflows/context/references/protocol/loop_protocol.md` | §5: four-part lineage contract (gather-subject, scope/slice, known-context, output schema) |

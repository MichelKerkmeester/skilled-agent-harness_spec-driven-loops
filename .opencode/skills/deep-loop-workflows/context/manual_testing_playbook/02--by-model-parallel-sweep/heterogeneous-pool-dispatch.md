...
| `.opencode/skills/deep-loop-workflows/context/references/protocol/loop_protocol.md` | §5: concurrent dispatch, barrier-join, both seat groups |
| `.opencode/skills/deep-loop-workflows/context/SKILL.md` | §3: by-model parallel sweep description with barrier-join |

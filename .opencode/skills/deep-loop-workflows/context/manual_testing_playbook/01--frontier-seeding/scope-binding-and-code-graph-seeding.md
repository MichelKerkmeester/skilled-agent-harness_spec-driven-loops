...
```bash
rg "whole.*repo\|never.*repo\|whole-repo" .opencode/skills/deep-loop-workflows/context/SKILL.md .opencode/skills/deep-loop-workflows/context/references/protocol/loop_protocol.md
```
...
| `.opencode/skills/deep-loop-workflows/context/references/protocol/loop_protocol.md` | Loop protocol §4: frontier seeding rules, code_graph_query usage, Glob+Grep fallback |
| `.opencode/skills/deep-loop-workflows/context/SKILL.md` | SKILL.md §3 step 1 describing frontier seeding and scope anchors |

...
```bash
rg "resumed\|skip.*phase_loop\|skip.*loop" .opencode/commands/deep/context.md .opencode/skills/deep-loop-workflows/context/SKILL.md
```
...
| `.opencode/skills/deep-loop-workflows/context/assets/deep_context_config.json` | Default config template written during fresh initialization |
| `.opencode/commands/deep/context.md` | Command entrypoint documenting lineage modes and setup phase |
| `.opencode/skills/deep-loop-workflows/context/SKILL.md` | Skill overview documenting session lifecycle in §3 HOW IT WORKS |

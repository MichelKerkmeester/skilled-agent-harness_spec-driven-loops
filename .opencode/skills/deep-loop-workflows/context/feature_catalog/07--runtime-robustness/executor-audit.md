...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/context/manual_testing_playbook/07--runtime-robustness/executor-audit.md` | Manual playbook | Verifies `SPECKIT_CLI_DISPATCH_STACK` and `executor-audit` references exist in the auto YAML |

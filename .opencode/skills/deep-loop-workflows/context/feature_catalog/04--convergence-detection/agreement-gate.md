...
| `.opencode/skills/deep-loop-workflows/context/scripts/reduce-state.cjs` | Script | `DEFAULT_AGREEMENT_MIN = 2` constant; agreement-eligible marking in the registry buckets |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/context/manual_testing_playbook/04--convergence-detection/agreement-gate.md` | Manual playbook | Verifies agreement-eligible classification, agreementRate STOP_BLOCKED when below threshold, and single-seat pool warning |

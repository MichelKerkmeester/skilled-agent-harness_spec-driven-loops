...
| `.opencode/skills/deep-loop-workflows/context/references/convergence/convergence_signals.md` | Reference | Full signal table, composite weights, and the stop contract with blocker thresholds |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/context/manual_testing_playbook/04--convergence-detection/relevance-gate.md` | Manual playbook | Verifies blocked_stop event emission, recovery hint injection, and force-CONTINUE when graph blocks stop |

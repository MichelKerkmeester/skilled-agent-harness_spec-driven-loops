...
| `.opencode/skills/deep-loop-workflows/context/assets/deep_context_config.json` | Asset | Default config template written at initialization |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/context/manual_testing_playbook/01--frontier-seeding/frontier-initialization.md` | Manual playbook | Verifies session classification, state file creation, and lock lifecycle |

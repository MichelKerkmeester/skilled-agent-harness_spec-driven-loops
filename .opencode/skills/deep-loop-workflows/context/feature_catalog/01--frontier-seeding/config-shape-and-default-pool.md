...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/context/assets/deep_context_config.json` | Asset | Default config template shape with all fields and their defaults |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/context/manual_testing_playbook/01--frontier-seeding/config-shape-and-default-pool.md` | Manual playbook | Verifies config fields, pool resolution, and read-only invariant after initialization |

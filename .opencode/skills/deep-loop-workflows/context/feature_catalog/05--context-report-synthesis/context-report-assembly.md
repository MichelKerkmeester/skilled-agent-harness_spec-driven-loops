...
| `.opencode/skills/deep-loop-workflows/context/assets/context_report_template.md` | Asset | Seven-section report template used by step_compile_report |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/context/manual_testing_playbook/05--context-report-synthesis/context-report-assembly.md` | Manual playbook | Verifies all seven sections present in context-report.md, context-report.json parseable, synthesis_complete event in JSONL |

...
| File | Layer | Role |
|---|---|---|
| `.opencode/commands/deep/assets/deep_context_auto.yaml` | Workflow | `step_parallel_sweep`, `step_sweep_native_batch`, `step_sweep_cli_pool`, `step_collect_seat_findings` |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/context/manual_testing_playbook/02--by-model-parallel-sweep/heterogeneous-pool-dispatch.md` | Manual playbook | Verifies concurrent launch, barrier join, and graceful seat degradation |

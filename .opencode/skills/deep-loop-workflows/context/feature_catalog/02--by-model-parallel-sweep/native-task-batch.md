...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/context/manual_testing_playbook/02--by-model-parallel-sweep/native-task-batch.md` | Manual playbook | Verifies all native seats dispatched simultaneously, per-seat prompt content, host-writes contract |

...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/context/manual_testing_playbook/02--by-model-parallel-sweep/cli-council-seats.md` | Manual playbook | Verifies one-shot dispatch per seat, CLI contracts, and closed stdin for opencode seats |

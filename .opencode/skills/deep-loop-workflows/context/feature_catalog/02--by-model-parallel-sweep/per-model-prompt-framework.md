...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/context/manual_testing_playbook/02--by-model-parallel-sweep/per-model-prompt-framework.md` | Manual playbook | Verifies framework assignment per model and four-part lineage contract presence in rendered prompts |

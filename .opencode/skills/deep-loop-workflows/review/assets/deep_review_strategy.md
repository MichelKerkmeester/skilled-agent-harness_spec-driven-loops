...
```markdown
## 1. REVIEW CHARTER
- Target: .opencode/skills/deep-loop-workflows/research (skill, v1.4.0)
...
- Files: .opencode/skills/deep-loop-workflows/research/scripts/reduce-state.cjs, .opencode/skills/system-spec-kit/scripts/tests/deep-research-contract-parity.vitest.ts

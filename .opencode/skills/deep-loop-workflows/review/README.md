...
```bash
node .opencode/skills/deep-loop-workflows/review/scripts/reduce-state.cjs <spec-folder>
```
...
```bash
python3 .opencode/skills/sk-doc/scripts/validate_document.py .opencode/skills/deep-loop-workflows/review/README.md --type readme
```

...
- `references/state/state_format.md` defines state records.
- `references/state/state_outputs.md` defines operator-visible outputs.
- `references/convergence/convergence_signals.md` defines STOP fields reducer views display.

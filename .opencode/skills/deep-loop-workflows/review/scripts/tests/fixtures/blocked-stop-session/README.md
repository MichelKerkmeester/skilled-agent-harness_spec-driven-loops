...
description: End-to-end fixture for the deep-review blocked_stop reducer path.
---
...
node .opencode/skills/deep-loop-workflows/review/scripts/reduce-state.cjs \
  .opencode/skills/deep-loop-workflows/review/scripts/tests/fixtures/blocked-stop-session
```

...
### Commands
1. `bash: rg -n '.deep-review-pause|paused|Delete.*pause|review/.deep-review-pause' .opencode/skills/deep-loop-workflows/review/references/protocol/loop_protocol.md .opencode/skills/deep-loop-workflows/review/SKILL.md .opencode/skills/deep-loop-workflows/review/README.md`
...
3. `bash: rg -n 'pause|sentinel|review/.deep-review-pause|Pause' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md .opencode/commands/deep/review.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/review/references/protocol/loop_protocol.md` | Pause sentinel contract, use the pause-handling subsection |
...
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | State files showing pause sentinel location, use `ANCHOR:state-files` |
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | Rule-level context, use `ANCHOR:rules` |
| `.opencode/skills/deep-loop-workflows/review/README.md` | User-facing pause FAQ |

...
### Commands
1. `bash: rg -n 'iteration.*file|iteration-NNN|write.once|iterations/|reconstruction|reconstruct|redundant|backup' .opencode/skills/deep-loop-workflows/review/references/state/state_format.md .opencode/skills/deep-loop-workflows/review/references/protocol/loop_protocol.md`
...
3. `bash: rg -n 'iteration.*file|write-once|iterations/|iteration-NNN|reconstruct|recovery|backup' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md .opencode/skills/deep-loop-workflows/review/SKILL.md .opencode/skills/deep-loop-workflows/review/README.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/review/references/state/state_format.md` | JSONL schema and iteration file schema, use the state log and findings registry sections |
| `.opencode/skills/deep-loop-workflows/review/references/protocol/loop_protocol.md` | Iteration file write-once contract and recovery guidance, use the iteration loop section |
...
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | State file listing showing iterations/ directory, use `ANCHOR:state-files` |
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | Rules for externalized state, use `ANCHOR:rules` Rule 3 |

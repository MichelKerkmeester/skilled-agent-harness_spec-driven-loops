...
### Commands
1. `bash: rg -n 'invalid.state|on_invalid|halt|repair|contradictory|partial' .opencode/commands/deep/assets/deep_review_auto.yaml`
2. `bash: rg -n 'invalid.state|on_invalid|halt|repair' .opencode/commands/deep/assets/deep_review_confirm.yaml`
3. `bash: rg -n 'on_conflict|on_canonical_present|contradictory' .opencode/commands/deep/assets/deep_review_auto.yaml`
### Expected
...
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | Phase detection guidance, use `ANCHOR:smart-routing` |

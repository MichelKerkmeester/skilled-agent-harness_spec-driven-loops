...
2. `bash: sed -n '1,220p' .opencode/skills/deep-loop-workflows/review/assets/deep_review_config.json && sed -n '1,220p' .opencode/skills/deep-loop-workflows/review/assets/deep_review_strategy.md`
...
| `.opencode/skills/deep-loop-workflows/review/assets/deep_review_config.json` | Config template |
| `.opencode/skills/deep-loop-workflows/review/assets/deep_review_strategy.md` | Strategy template |

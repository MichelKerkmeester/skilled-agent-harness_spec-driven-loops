...
3. `bash: rg -n 'resume|prior state|existing state|pick up' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md .opencode/skills/deep-loop-workflows/review/SKILL.md`
### Expected
...
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | Resume behavior documentation, use `ANCHOR:troubleshooting` |

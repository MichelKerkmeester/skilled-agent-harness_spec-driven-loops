...
- Layer partition: workflow YAML (`deep_review_auto.yaml` step `step_check_convergence`) + iteration record `searchCoverage.graphCoverageMode`.
...
- Schema: `.opencode/skills/deep-loop-workflows/review/references/state/state_format.md` (`graphCoverageMode` enum + fallback-method conventions).

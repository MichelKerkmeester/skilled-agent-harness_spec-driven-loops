...
### Commands
1. `bash: rg -n 'findingsSummary|findingsNew|Rule 11|severity counts' .opencode/skills/deep-loop-workflows/review/SKILL.md`
...
3. `bash: rg -n 'findingsSummary|findingsNew|P0.*10|P1.*5|P2.*1|severity.*weight' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md .opencode/skills/deep-loop-workflows/review/references/state/state_format.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | Rule 11: severity counts mandate, use `ANCHOR:rules` |
...
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | Convergence signals, use `ANCHOR:convergence` |
| `.opencode/skills/deep-loop-workflows/review/references/state/state_format.md` | Shared JSONL schema, inspect iteration record fields |

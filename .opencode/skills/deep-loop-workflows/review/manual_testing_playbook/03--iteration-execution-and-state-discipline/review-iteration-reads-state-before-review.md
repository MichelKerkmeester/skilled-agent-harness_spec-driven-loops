...
2. `bash: rg -n 'Read.*state\|Read.*strategy\|Read.*JSONL\|step 1\|1\. Read' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md .opencode/skills/deep-loop-workflows/review/SKILL.md`
...
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | Skill-level iteration documentation |

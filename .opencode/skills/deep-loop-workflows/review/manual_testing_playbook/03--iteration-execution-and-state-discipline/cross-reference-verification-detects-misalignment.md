...
3. `bash: rg -n 'cross.reference|traceability|spec_code|checklist_evidence' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md .opencode/skills/deep-loop-workflows/review/assets/review_mode_contract.yaml`
### Expected
...
| `.opencode/skills/deep-loop-workflows/review/assets/review_mode_contract.yaml` | Cross-reference protocol definitions, inspect `cross_reference_protocols` |
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | Quality guards, use `ANCHOR:quality-guards` and `ANCHOR:review-dimensions` |
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | Traceability dimension documentation |

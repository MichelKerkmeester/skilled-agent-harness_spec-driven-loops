...
### Commands
1. `bash: rg -n 'adversarial\|self.check\|Hunter\|Skeptic\|Referee\|Rule 10\|re-read.*P0' .opencode/skills/deep-loop-workflows/review/SKILL.md`
2. `bash: rg -n 'adversarial\|self.check\|P0.*check\|claim_adjudication' .opencode/commands/deep/assets/deep_review_auto.yaml`
3. `bash: rg -n 'adversarial\|self.check\|P0\|Hunter\|Skeptic\|Referee' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md .codex/agents/deep-review.toml .claude/agents/deep-review.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | Rule 10: adversarial self-check mandate, use `ANCHOR:rules` |
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | Iteration checklist, use `ANCHOR:agent-iteration-checklist` |

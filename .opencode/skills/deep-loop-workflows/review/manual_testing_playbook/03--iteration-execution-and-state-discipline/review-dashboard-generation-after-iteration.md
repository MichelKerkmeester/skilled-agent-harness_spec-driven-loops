...
2. `bash: sed -n '1,220p' .opencode/skills/deep-loop-workflows/review/assets/deep_review_dashboard.md`
3. `bash: rg -n 'dashboard|deep-review-dashboard' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md .opencode/commands/deep/assets/deep_review_confirm.yaml`
### Expected
...
| `.opencode/skills/deep-loop-workflows/review/assets/deep_review_dashboard.md` | Dashboard template |
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | State files table, use `ANCHOR:state-files` |

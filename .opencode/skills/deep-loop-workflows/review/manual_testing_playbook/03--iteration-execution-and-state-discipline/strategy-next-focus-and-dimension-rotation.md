...
2. `bash: rg -n 'Next Focus|dimension.*rotation|dimension.*coverage|exhausted' .opencode/skills/deep-loop-workflows/review/assets/deep_review_strategy.md`
3. `bash: rg -n 'Dimension Coverage|dimensions.*covered|minStabilization' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md`
### Expected
...
| `.opencode/skills/deep-loop-workflows/review/assets/deep_review_strategy.md` | Strategy template, inspect "Next Focus" and dimension tracking sections |
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | Convergence signals, use `ANCHOR:convergence` and `ANCHOR:review-dimensions` |
| `.opencode/skills/deep-loop-workflows/review/references/convergence/convergence.md` | Shared convergence algorithm, inspect dimension coverage signal |

...
### Commands
1. `bash: rg -n 'FAIL|CONDITIONAL|PASS|verdict|hasAdvisories|spec_kit:plan|create:changelog|Next Command|routing' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md`
...
3. `bash: rg -n 'verdict|FAIL|CONDITIONAL|PASS|hasAdvisories|routing|post.review|Planning Trigger|Executive Summary' .opencode/skills/deep-loop-workflows/review/SKILL.md .opencode/skills/deep-loop-workflows/review/README.md .opencode/commands/deep/review.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | Canonical verdict table, use `ANCHOR:verdicts` |
...
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | Verdict definitions and severity classification, use `ANCHOR:how-it-works` |
| `.opencode/skills/deep-loop-workflows/review/README.md` | Feature summary for verdicts and post-review workflow |

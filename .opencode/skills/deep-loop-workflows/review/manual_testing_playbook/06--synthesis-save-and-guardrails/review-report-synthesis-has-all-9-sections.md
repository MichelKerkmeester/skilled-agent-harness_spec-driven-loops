...
### Commands
1. `bash: rg -n 'Executive Summary|Planning Trigger|Active Finding Registry|Remediation Workstreams|Spec Seed|Plan Seed|Traceability Status|Deferred Items|Audit Appendix|review-report' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md`
...
3. `bash: rg -n 'review-report|synthesis|9.*section|report.*section|Executive Summary|verdict|hasAdvisories' .opencode/skills/deep-loop-workflows/review/SKILL.md .opencode/skills/deep-loop-workflows/review/README.md .opencode/commands/deep/review.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | Canonical 9-section table, use `ANCHOR:review-report-sections` |
...
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | Review report structure and verdict rules, use `ANCHOR:how-it-works` |
| `.opencode/skills/deep-loop-workflows/review/README.md` | Feature summary for review report synthesis |

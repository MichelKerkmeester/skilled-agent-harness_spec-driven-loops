...
### Commands
1. `bash: rg -n 'maxIterations|hard.stop|HARD_STOP|max_iterations|iteration.*cap' .opencode/skills/deep-loop-workflows/review/references/convergence/convergence.md`
...
3. `bash: rg -n 'maxIterations|max-iterations|default.*7|hard stop' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md .opencode/skills/deep-loop-workflows/review/SKILL.md .opencode/skills/deep-loop-workflows/review/README.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/review/references/convergence/convergence.md` | Canonical convergence math including hard stop rules |
...
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | User-facing parameter defaults, use `ANCHOR:commands` and `ANCHOR:convergence` |
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | Skill rules and convergence documentation, use `ANCHOR:rules` |
| `.opencode/skills/deep-loop-workflows/review/README.md` | Feature summary and configuration defaults |

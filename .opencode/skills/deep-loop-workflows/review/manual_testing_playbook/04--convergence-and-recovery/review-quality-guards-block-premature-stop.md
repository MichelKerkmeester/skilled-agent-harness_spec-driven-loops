...
### Commands
1. `bash: rg -n 'quality.guard|binary.gate|evidence.*gate|scope.*gate|coverage.*gate|QUALITY_GUARD|gate.*pass' .opencode/skills/deep-loop-workflows/review/references/convergence/convergence.md`
...
3. `bash: rg -n 'Quality Guard|Evidence|Scope|Coverage|binary gate|gate.*pass|inference.only' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md .opencode/skills/deep-loop-workflows/review/SKILL.md .opencode/skills/deep-loop-workflows/review/README.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/review/references/convergence/convergence.md` | Canonical quality guard definitions, use §6 LEGAL-STOP GATE BUNDLE for the 9 review-specific gates |
...
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | Quality guard summary, use `ANCHOR:quality-guards` |
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | Quality guard rules, use `ANCHOR:rules` Rule 12 |
| `.opencode/skills/deep-loop-workflows/review/README.md` | Feature summary for quality guards |

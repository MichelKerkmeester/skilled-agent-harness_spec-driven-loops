...
### Commands
1. `bash: rg -n 'stuck|STUCK|noProgress|no_progress|stuckThreshold|recovery|widen|least.covered' .opencode/skills/deep-loop-workflows/review/references/convergence/convergence.md`
...
3. `bash: rg -n 'stuck|recovery|dimension.*focus|noProgress|least.covered|Next Focus' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md .opencode/skills/deep-loop-workflows/review/SKILL.md .opencode/skills/deep-loop-workflows/review/assets/deep_review_strategy.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/review/references/convergence/convergence.md` | Canonical convergence math, stuck detection and recovery rules |
...
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | Convergence parameters including stuckThreshold, use `ANCHOR:convergence` |
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | Rules for dimension focus and exhausted approaches, use `ANCHOR:rules` |
| `.opencode/skills/deep-loop-workflows/review/assets/deep_review_strategy.md` | Strategy template showing "Next Focus" and dimension coverage tracking |

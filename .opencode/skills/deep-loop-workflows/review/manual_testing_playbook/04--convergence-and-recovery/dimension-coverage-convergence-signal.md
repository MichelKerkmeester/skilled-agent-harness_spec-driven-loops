...
### Commands
1. `bash: rg -n 'dimension.coverage|Dimension Coverage|0\.45|minStabilization|stabilization|all.*dimension|4.*dimension' .opencode/skills/deep-loop-workflows/review/references/convergence/convergence.md`
...
3. `bash: rg -n 'Dimension Coverage|0\.45|minStabilization|stabilization|Covered|D1|D2|D3|D4|Correctness|Security|Traceability|Maintainability' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md .opencode/skills/deep-loop-workflows/review/SKILL.md .opencode/skills/deep-loop-workflows/review/assets/deep_review_strategy.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/review/references/convergence/convergence.md` | Canonical convergence math, dimension coverage signal definition and minStabilizationPasses |
...
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | Convergence signal table, use `ANCHOR:convergence` and `ANCHOR:review-dimensions` |
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | Review dimensions and convergence rules, use `ANCHOR:how-it-works` and `ANCHOR:rules` |
| `.opencode/skills/deep-loop-workflows/review/assets/deep_review_strategy.md` | Strategy template showing dimension tracking in "Covered" list |

...
### Commands
1. `bash: rg -n 'P0.*override|P0.*block|P0.*convergence|newFindingsRatio.*0\.50|severity.*override|P0.*ratio' .opencode/skills/deep-loop-workflows/review/references/convergence/convergence.md`
...
3. `bash: rg -n 'P0 override|P0.*block.*convergence|newFindingsRatio.*0\.50|severity.*override' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md .opencode/skills/deep-loop-workflows/review/SKILL.md .opencode/skills/deep-loop-workflows/review/README.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/review/references/convergence/convergence.md` | Canonical convergence math, P0 override rule in severity-weighted section |
...
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | P0 override note, use `ANCHOR:convergence` |
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | Severity classification and P0 blocking rules, use `ANCHOR:how-it-works` and `ANCHOR:rules` |
| `.opencode/skills/deep-loop-workflows/review/README.md` | Feature summary for P0 override behavior |

...
- `deep-review` skill exists at `.opencode/skills/deep-loop-workflows/review/`.
...
- `review_mode_contract.yaml` exists at `.opencode/skills/deep-loop-workflows/review/assets/`.
...
- `SKILL.md`: `.opencode/skills/deep-loop-workflows/review/SKILL.md`
- `README.md`: `.opencode/skills/deep-loop-workflows/review/README.md`
...
- `Review Contract`: `.opencode/skills/deep-loop-workflows/review/assets/review_mode_contract.yaml`
- `Loop Protocol`: `.opencode/skills/deep-loop-workflows/review/references/protocol/loop_protocol.md`
- `Convergence`: `.opencode/skills/deep-loop-workflows/review/references/convergence/convergence.md`
- `State Format`: `.opencode/skills/deep-loop-workflows/review/references/state/state_format.md`
- `Quick Reference`: `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md`

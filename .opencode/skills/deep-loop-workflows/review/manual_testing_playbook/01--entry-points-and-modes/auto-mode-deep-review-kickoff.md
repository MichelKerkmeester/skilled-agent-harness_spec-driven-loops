...
Operators need one coherent story for `/deep:review:auto` so they can launch unattended code audits with the right artifact and lifecycle expectations.
...
### Commands
1. `bash: rg -n '/deep:review:auto|review/review-report.md|review/iterations' .opencode/skills/deep-loop-workflows/review/README.md .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md`
2. `bash: sed -n '1,220p' .opencode/commands/deep/review.md`
3. `bash: sed -n '1,260p' .opencode/commands/deep/assets/deep_review_auto.yaml`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/review/README.md` | User-facing examples, use `ANCHOR:quick-start` and `ANCHOR:configuration` |
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | Cheat-sheet command contract, use `ANCHOR:commands` and `ANCHOR:state-files` |
...
| `.opencode/commands/deep/assets/deep_review_auto.yaml` | Autonomous workflow contract, inspect `state_paths`, `phase_init`, and `phase_loop` |
...
- Feature file path: `01--entry-points-and-modes/auto-mode-deep-review-kickoff.md`

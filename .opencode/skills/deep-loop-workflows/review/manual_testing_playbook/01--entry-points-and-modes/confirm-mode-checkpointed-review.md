...
### Commands
1. `bash: rg -n '/deep:review:confirm|approval|multi_gate' .opencode/skills/deep-loop-workflows/review/README.md .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md`
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/review/README.md` | User-facing examples, use `ANCHOR:quick-start` |
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | Cheat-sheet command contract, use `ANCHOR:commands` |

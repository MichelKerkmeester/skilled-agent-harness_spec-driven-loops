...
### Commands
1. `bash: rg -n 'max.iterations|convergence.*0\.10|convergence_threshold|maxIterations' .opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md`
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md` | Parameter defaults table, use `ANCHOR:commands` |
...
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | Skill-level parameter documentation, use `ANCHOR:how-it-works` |

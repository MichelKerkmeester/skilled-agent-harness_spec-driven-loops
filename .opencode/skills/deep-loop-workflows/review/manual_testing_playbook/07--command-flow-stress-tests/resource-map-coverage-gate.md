...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/deep-loop-workflows/review/manual_testing_playbook/07--command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-054-sandbox
...
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | 233-251, 496-503 | Resource-map coverage behavior and report expectations |

...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/deep-loop-workflows/review/manual_testing_playbook/07--command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-055-sandbox
...
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | 496-514, 563-575 | Loop completion, quality gates, continuity integration |

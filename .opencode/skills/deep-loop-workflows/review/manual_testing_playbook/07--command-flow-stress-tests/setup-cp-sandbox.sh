...
require_path "${REPO_ROOT}/.opencode/skills/deep-loop-workflows/review"
...
copy_dir "${REPO_ROOT}/.opencode/skills/deep-loop-workflows/review" "${SANDBOX_DIR}/.opencode/skills/deep-loop-workflows/review"

...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/deep-loop-workflows/review/manual_testing_playbook/07--command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-056-sandbox
...
cp /tmp/cp-056-sandbox/.opencode/skills/deep-loop-workflows/review/assets/deep_review_strategy.md /tmp/cp-056-spec/review/deep-review-strategy.md
...
| `.opencode/skills/deep-loop-workflows/review/SKILL.md` | 43-61, 90-95 | Command-only loop invocation and LEAF invariant |

...
5. Replay upserts with `node .opencode/skills/deep-loop-workflows/ai-council/scripts/replay-graph-from-artifacts.cjs --spec-folder <spec-folder> --session-id dac-025-run-01`, then pipe the emitted payload to `runtime upsert CLI`.
...
4. `bash: node .opencode/skills/deep-loop-workflows/ai-council/scripts/replay-graph-from-artifacts.cjs --spec-folder <spec-folder> --session-id dac-025-run-01 > /tmp/dac-025-upsert.json`
...
| `.opencode/skills/deep-loop-workflows/ai-council/references/integration/graph_support.md` §5 | Recovery and rollback contract |

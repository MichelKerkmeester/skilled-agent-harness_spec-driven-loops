...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/ai-council/references/structure/state_format.md` | State event contract |
| `.opencode/skills/deep-loop-workflows/ai-council/scripts/advise-council-completion.cjs` | Completion advisory |

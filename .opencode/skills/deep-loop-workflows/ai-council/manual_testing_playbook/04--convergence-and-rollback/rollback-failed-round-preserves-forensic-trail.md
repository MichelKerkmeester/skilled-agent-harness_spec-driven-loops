...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/ai-council/scripts/lib/rollback.js` | Rollback behavior |
| `.opencode/skills/deep-loop-workflows/ai-council/references/structure/folder_layout.md` | Failed folder layout |
| `.opencode/skills/deep-loop-workflows/ai-council/references/structure/state_format.md` | Rollback state events |
...
- Feature file path: `04--convergence-and-rollback/rollback-failed-round-preserves-forensic-trail.md`

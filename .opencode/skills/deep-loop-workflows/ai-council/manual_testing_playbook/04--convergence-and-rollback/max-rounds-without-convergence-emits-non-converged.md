...
1. `bash: rg -n "max_rounds|max rounds|convergence:false|non-converged|council_complete" .opencode/skills/deep-loop-workflows/ai-council/references/convergence/convergence_signals.md .opencode/skills/deep-loop-workflows/ai-council/references/structure/state_format.md`
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/ai-council/references/convergence/convergence_signals.md` | Escape hatch guidance |
| `.opencode/skills/deep-loop-workflows/ai-council/references/structure/state_format.md` | Completion event semantics |

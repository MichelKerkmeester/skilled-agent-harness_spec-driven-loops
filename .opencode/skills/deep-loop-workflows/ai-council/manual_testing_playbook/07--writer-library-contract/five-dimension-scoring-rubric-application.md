...
1. `bash: rg -n "Correctness.*30|Completeness.*20|Elegance.*15|Robustness.*20|Integration.*15" .opencode/skills/deep-loop-workflows/ai-council/references/scoring/scoring_rubric.md`
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/ai-council/references/scoring/scoring_rubric.md` | Rubric and comparison-table reference |

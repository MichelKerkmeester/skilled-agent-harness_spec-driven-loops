...
| `../08--council-graph-integration/council-graph-convergence-three-state-decision-matrix.md` | Functional anchor for STOP_BLOCKED branch |
| `../04--convergence-and-rollback/two-of-three-agree-triggers-convergence.md` | The baseline rule this scenario challenges |
...
| `.opencode/skills/deep-loop-workflows/ai-council/references/convergence/convergence_signals.md` | Documents the baseline two-of-three rule |
...
- Feature file path: `09--council-graph-value-comparison/convergence-safety-under-critical-disagreement-graph-vs-baseline.md`

...
| `.opencode/skills/deep-loop-workflows/ai-council/references/structure/state_format.md` | Documents append-only `ai-council-state.jsonl` event contract |
| `.opencode/skills/deep-loop-workflows/ai-council/references/integration/graph_support.md` §5 | Documents the recovery + replay contract |

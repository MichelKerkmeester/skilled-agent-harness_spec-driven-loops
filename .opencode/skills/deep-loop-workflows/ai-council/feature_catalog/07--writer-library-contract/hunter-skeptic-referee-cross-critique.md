...
Current behavior is grounded in `.opencode/skills/deep-loop-workflows/ai-council/references/scoring/scoring_rubric.md`, which the scenario identifies as cross-critique reference. Validation is anchored by `manual_testing_playbook/07--writer-library-contract/hunter-skeptic-referee-cross-critique.md`, covering manual scenario contract.
...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/deep-loop-workflows/ai-council/references/scoring/scoring_rubric.md` | Reference | Cross-critique reference |

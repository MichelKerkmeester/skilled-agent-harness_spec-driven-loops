...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/deep-loop-workflows/ai-council/scripts/lib/persist-artifacts.cjs` | Library | Path guard implementation |

...
| `.opencode/skills/deep-loop-workflows/ai-council/references/convergence/convergence_signals.md` | Reference | Documents the baseline two-of-three rule |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/09--council-graph-value-comparison/convergence-safety-under-critical-disagreement-graph-vs-baseline.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/09--council-graph-value-comparison/convergence-safety-under-critical-disagreement-graph-vs-baseline.md`
- Playbook scenario: `manual_testing_playbook/09--council-graph-value-comparison/convergence-safety-under-critical-disagreement-graph-vs-baseline.md`
Related references:

...
Current behavior is grounded in internal design notes for adr-001 derived-projection contract. Validation is anchored by `manual_testing_playbook/08--council-graph-integration/council-graph-derived-projection-rebuilds-from-artifacts.md`, covering manual scenario contract.
...
| `.opencode/skills/deep-loop-workflows/ai-council/references/integration/graph_support.md 5` | Reference | Recovery and rollback contract |
...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/08--council-graph-integration/council-graph-derived-projection-rebuilds-from-artifacts.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/08--council-graph-integration/council-graph-derived-projection-rebuilds-from-artifacts.md`
- Playbook scenario: `manual_testing_playbook/08--council-graph-integration/council-graph-derived-projection-rebuilds-from-artifacts.md`
Related references:
...
- [council-graph-tools-registered-separately-from-deep-loop.md](council-graph-tools-registered-separately-from-deep-loop.md) — Council graph MCP surface retired

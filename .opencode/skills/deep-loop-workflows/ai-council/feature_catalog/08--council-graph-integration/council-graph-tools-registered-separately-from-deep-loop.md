...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/08--council-graph-integration/council-graph-tools-registered-separately-from-deep-loop.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/08--council-graph-integration/council-graph-tools-registered-separately-from-deep-loop.md`
- Playbook scenario: `manual_testing_playbook/08--council-graph-integration/council-graph-tools-registered-separately-from-deep-loop.md`
Related references:

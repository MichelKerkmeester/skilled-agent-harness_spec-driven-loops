...
Current behavior is grounded in `.opencode/skills/deep-loop-workflows/ai-council/scripts/lib/rollback.js`, which the scenario identifies as rollback behavior. Validation is anchored by `manual_testing_playbook/04--convergence-and-rollback/rollback-failed-round-preserves-forensic-trail.md`, covering manual scenario contract.
...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/deep-loop-workflows/ai-council/scripts/lib/rollback.js` | Library | Rollback behavior |
| `.opencode/skills/deep-loop-workflows/ai-council/references/structure/folder_layout.md` | Reference | Failed folder layout |
| `.opencode/skills/deep-loop-workflows/ai-council/references/structure/state_format.md` | Reference | Rollback state events |

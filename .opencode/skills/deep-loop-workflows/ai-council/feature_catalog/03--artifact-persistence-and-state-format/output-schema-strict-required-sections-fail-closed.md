...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/deep-loop-workflows/ai-council/references/structure/output_schema.md` | Reference | Requiredness contract |
| `.opencode/skills/deep-loop-workflows/ai-council/scripts/persist-artifacts.cjs` | Script | Parser entrypoint |

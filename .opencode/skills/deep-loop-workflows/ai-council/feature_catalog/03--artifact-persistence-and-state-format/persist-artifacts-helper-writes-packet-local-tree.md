...
The shipped surface is anchored by `persist-artifacts.cjs`, `deep-ai-council`. The playbook scenario `03--artifact-persistence-and-state-format/persist-artifacts-helper-writes-packet-local-tree.md` defines the operator prompt, command sequence, expected signals, evidence, and pass/fail criteria for DAC-005.

Current behavior is grounded in `.opencode/skills/deep-loop-workflows/ai-council/scripts/persist-artifacts.cjs`, which the scenario identifies as cli wrapper. Validation is anchored by `manual_testing_playbook/03--artifact-persistence-and-state-format/persist-artifacts-helper-writes-packet-local-tree.md`, covering manual scenario contract.
...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/deep-loop-workflows/ai-council/scripts/persist-artifacts.cjs` | Script | CLI wrapper |
| `.opencode/skills/deep-loop-workflows/ai-council/references/structure/folder_layout.md` | Reference | Artifact layout |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/03--artifact-persistence-and-state-format/persist-artifacts-helper-writes-packet-local-tree.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/03--artifact-persistence-and-state-format/persist-artifacts-helper-writes-packet-local-tree.md`
- Playbook scenario: `manual_testing_playbook/03--artifact-persistence-and-state-format/persist-artifacts-helper-writes-packet-local-tree.md`
Related references:

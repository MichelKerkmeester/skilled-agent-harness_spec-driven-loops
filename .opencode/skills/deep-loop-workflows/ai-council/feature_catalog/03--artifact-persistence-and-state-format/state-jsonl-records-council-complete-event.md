...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/deep-loop-workflows/ai-council/references/structure/state_format.md` | Reference | State event contract |
| `.opencode/skills/deep-loop-workflows/ai-council/scripts/advise-council-completion.cjs` | Script | Completion advisory |

...
Current behavior is grounded in `.opencode/skills/deep-loop-workflows/ai-council/references/patterns/seat_diversity_patterns.md`, which the scenario identifies as seat diversity contract. Validation is anchored by `manual_testing_playbook/02--council-deliberation-and-seat-diversity/three-seat-diverse-deliberation.md`, covering manual scenario contract.
...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/deep-loop-workflows/ai-council/references/patterns/seat_diversity_patterns.md` | Reference | Seat diversity contract |

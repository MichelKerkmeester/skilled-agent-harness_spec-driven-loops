...
Current behavior is grounded in `.opencode/skills/deep-loop-workflows/ai-council/SKILL.md`, which the scenario identifies as skill routing metadata. Validation is anchored by `.opencode/skills/system-skill-advisor/mcp_server/tests/scorer/native-scorer.vitest.ts`, covering advisor regression.
...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/deep-loop-workflows/ai-council/SKILL.md` | Skill | Skill routing metadata |

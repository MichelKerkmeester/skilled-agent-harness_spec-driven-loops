...
This reference documents the profile-selection audit log format and retention policy for deep-improvement, addressing DAI-004 (dynamic profiling auditability).
...
The profile-selection logging is implemented in `.opencode/skills/deep-loop-workflows/improvement/scripts/agent-improvement/generate-profile.cjs`.
...
- `generate-profile.cjs`: `.opencode/skills/deep-loop-workflows/improvement/scripts/agent-improvement/generate-profile.cjs`
- `typed-errors.cjs`: `.opencode/skills/deep-loop-workflows/improvement/scripts/lib/typed-errors.cjs`

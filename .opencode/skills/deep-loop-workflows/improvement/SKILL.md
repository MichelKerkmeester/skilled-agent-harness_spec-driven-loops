...
```bash
node .opencode/skills/deep-loop-workflows/improvement/scripts/shared/improvement-journal.cjs --emit <eventType> --journal <journal_path> --details '<json>'
```

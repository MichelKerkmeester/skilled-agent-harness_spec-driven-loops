...
const LIB = path.join(
  WORKSPACE_ROOT,
  '.opencode/skills/deep-loop-workflows/improvement/scripts/model-benchmark/lib',
);
...
const FIXTURE_DIR = path.join(
  WORKSPACE_ROOT,
  '.opencode/skills/deep-loop-workflows/improvement/assets/model_benchmark/benchmark-fixtures',
);
const PROFILE_DIR = path.join(
  WORKSPACE_ROOT,
  '.opencode/skills/deep-loop-workflows/improvement/assets/model_benchmark/benchmark-profiles',
);

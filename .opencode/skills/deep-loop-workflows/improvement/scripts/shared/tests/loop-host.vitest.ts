...
const loopHost = require(path.join(
  WORKSPACE_ROOT,
  '.opencode/skills/deep-loop-workflows/improvement/scripts/shared/loop-host.cjs',
)) as {
  ...
  describe('non-dev-ai-system-refine (Lane D)', () => {
    ...
    it('adapter ENV_FORWARD maps every loop env knob the template reads', () => {
      const adapter = require(path.join(
        WORKSPACE_ROOT,
        '.opencode/skills/deep-loop-workflows/improvement/scripts/non-dev-ai-system/run-non-dev-ai-system.cjs',

...
- Prompt: `Validate that --output writes scan results to /tmp/test-scan-output.json as valid JSON.`
...
| `01--integration-scanner/json-output-file.md` | Canonical per-feature execution contract |
...
- Feature file path: `01--integration-scanner/json-output-file.md`

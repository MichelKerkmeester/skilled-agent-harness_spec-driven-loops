...
- Prompt: `Validate that scanning the debug agent finds at least 20 integration surfaces.`
...
| `01--integration-scanner/scan-diverse-agent.md` | Canonical per-feature execution contract |
...
- Feature file path: `01--integration-scanner/scan-diverse-agent.md`

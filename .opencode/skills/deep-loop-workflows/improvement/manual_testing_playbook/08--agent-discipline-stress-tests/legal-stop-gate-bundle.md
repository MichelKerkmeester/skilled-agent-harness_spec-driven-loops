...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/deep-loop-workflows/improvement/manual_testing_playbook/08--agent-discipline-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-035-sandbox
...
| `.opencode/skills/deep-loop-workflows/improvement/SKILL.md` | Legal-stop gate contract |
...
- Feature file path: `08--agent-discipline-stress-tests/legal-stop-gate-bundle.md`

...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/deep-loop-workflows/improvement/manual_testing_playbook/08--agent-discipline-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-036-sandbox
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/improvement/scripts/agent-improvement/score-candidate.cjs` | Baseline/current score comparison |
| `.opencode/commands/deep/assets/deep_agent-improvement_auto.yaml` | Workflow score invocation |
| `.opencode/skills/deep-loop-workflows/improvement/SKILL.md` | Improvement gate contract |

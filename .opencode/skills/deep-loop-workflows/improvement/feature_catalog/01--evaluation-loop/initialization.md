...
| `.opencode/skills/deep-loop-workflows/improvement/assets/agent_improvement/improvement_config.json` | Runtime template | Defines runtime paths, scoring weights, stop rules, and file protection defaults. |
| `.opencode/skills/deep-loop-workflows/improvement/assets/agent_improvement/improvement_charter.md` | Runtime template | Freezes the mission, policy boundary, audit-trail requirements, and legal-stop gates for the run. |
| `.opencode/skills/deep-loop-workflows/improvement/assets/agent_improvement/improvement_strategy.md` | Runtime template | Splits operator-owned hypothesis fields from reducer-owned progress fields. |
| `.opencode/skills/deep-loop-workflows/improvement/assets/agent_improvement/target_manifest.jsonc` | Runtime template | Carries target classification, dynamic-profile hooks, and fixed or forbidden surfaces. |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/improvement/references/shared/loop_protocol.md` | Reference | Describes the initialization sequence and copied runtime artifacts. |
| `.opencode/skills/deep-loop-workflows/improvement/references/shared/quick_reference.md` | Reference | Confirms the packet-local runtime layout and runtime file naming. |

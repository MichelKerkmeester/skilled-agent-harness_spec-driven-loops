...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/research/assets/deep_research_config.json` | Asset | Sets `progressiveSynthesis` to `true` by default in the live config template. |
| `.opencode/agents/deep-research.md` | Agent | Defines when the iteration agent may create or update `research/research.md`. |
| `.opencode/skills/deep-loop-workflows/research/references/state/state_format.md` | Reference | Defines progressive update rules for `research/research.md`. |
| `.opencode/skills/deep-loop-workflows/research/references/protocol/loop_protocol.md` | Reference | Defines the final synthesis cleanup pass that consolidates the document. |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/research/manual_testing_playbook/03--iteration-execution-and-state-discipline/progressive-synthesis-behavior-for-research-md.md` | Manual playbook | Verifies iteration-time updates respect the progressive-synthesis contract. |
| `.opencode/skills/deep-loop-workflows/research/manual_testing_playbook/06--synthesis-save-and-guardrails/final-synthesis-memory-save-and-guardrail-behavior.md` | Manual playbook | Verifies final synthesis still owns the terminal research document. |

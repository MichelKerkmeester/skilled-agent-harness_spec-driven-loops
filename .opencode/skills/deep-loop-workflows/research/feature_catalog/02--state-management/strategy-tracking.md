...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/research/assets/deep_research_strategy.md` | Asset | Defines the strategy anchors and machine-owned section boundaries. |
| `.opencode/skills/deep-loop-workflows/research/references/state/state_format.md` | Reference | Defines the update protocol for strategy, dashboard, and reducer-owned state. |
| `.opencode/skills/deep-loop-workflows/research/scripts/reduce-state.cjs` | Reducer | Rebuilds the findings registry, updates strategy anchors, and regenerates the dashboard. |
...
| `.opencode/skills/deep-loop-workflows/research/assets/deep_research_dashboard.md` | Asset | Defines the dashboard sections the reducer fills from strategy and registry data. |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/research/manual_testing_playbook/03--iteration-execution-and-state-discipline/strategy-next-focus-and-exhausted-approach-discipline.md` | Manual playbook | Verifies next-focus selection and exhausted-approach handling. |
| `.opencode/skills/deep-loop-workflows/research/manual_testing_playbook/04--convergence-and-recovery/blocked-stop-reducer-surfacing.md` | Manual playbook | Verifies blocked-stop history and recovery guidance appear in reducer-owned outputs. |

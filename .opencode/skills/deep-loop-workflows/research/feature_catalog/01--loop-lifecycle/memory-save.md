...
| `.opencode/skills/deep-loop-workflows/research/references/protocol/loop_protocol.md` | Reference | Defines the save phase and its verification step. |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/research/manual_testing_playbook/06--synthesis-save-and-guardrails/final-synthesis-memory-save-and-guardrail-behavior.md` | Manual playbook | Verifies the save phase uses the supported continuity path after synthesis. |
...
- Feature file path: `01--loop-lifecycle/memory-save.md`
Related references:

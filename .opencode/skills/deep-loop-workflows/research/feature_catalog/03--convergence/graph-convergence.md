...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/deep-loop-workflows/research/references/convergence/convergence.md` | Reference | Defines the graph-aware convergence model and graph-specific stop support signals. |
...
| `.opencode/skills/deep-loop-workflows/research/scripts/reduce-state.cjs` | Reducer | Reads the latest graph event and exposes graph score, decision, and blockers. |
...
| `.opencode/skills/deep-loop-workflows/research/manual_testing_playbook/04--convergence-and-recovery/graph-convergence-signals.md` | Manual playbook | Verifies graph convergence signals are derived and exposed correctly. |
| `.opencode/skills/deep-loop-workflows/research/manual_testing_playbook/04--convergence-and-recovery/graph-aware-stop-gate.md` | Manual playbook | Verifies graph-aware stop gates can block or allow synthesis. |
...
- Feature file path: `03--convergence/graph-convergence.md`
Related references:

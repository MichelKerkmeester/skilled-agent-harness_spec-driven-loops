...
- Capability matrix: `.opencode/skills/deep-loop-workflows/research/assets/runtime_capabilities.json`
- Capability matrix doc: `.opencode/skills/deep-loop-workflows/research/references/guides/capability_matrix.md`
- Capability resolver: `.opencode/skills/deep-loop-workflows/research/scripts/runtime-capabilities.cjs`

...
> **Runtime capability matrix:** `.opencode/skills/deep-loop-workflows/research/references/guides/capability_matrix.md` and `.opencode/skills/deep-loop-workflows/research/assets/runtime_capabilities.json`

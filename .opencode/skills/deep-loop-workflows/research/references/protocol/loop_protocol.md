...
- Human-readable matrix: `.opencode/skills/deep-loop-workflows/research/references/guides/capability_matrix.md`
- Machine-readable matrix: `.opencode/skills/deep-loop-workflows/research/assets/runtime_capabilities.json`

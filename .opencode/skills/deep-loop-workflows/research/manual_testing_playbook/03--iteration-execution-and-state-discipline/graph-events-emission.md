...
### Commands
1. `bash: rg -n 'graphEvents|Graph Events|type \\| \"question\"|type \\| \"finding\"|type \\| \"source\"|type \\| \"edge\"' .opencode/skills/deep-loop-workflows/research/references/state/state_format.md`
2. `bash: rg -n 'graphEvents|iteration records|graph-aware convergence' .opencode/skills/deep-loop-workflows/research/references/convergence/convergence.md`
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/research/references/state/state_format.md` | Canonical flat `graphEvents` payload example and field table |
| `.opencode/skills/deep-loop-workflows/research/references/convergence/convergence.md` | Graph-aware research convergence contract; documents `graphEvents` as iteration-record input |

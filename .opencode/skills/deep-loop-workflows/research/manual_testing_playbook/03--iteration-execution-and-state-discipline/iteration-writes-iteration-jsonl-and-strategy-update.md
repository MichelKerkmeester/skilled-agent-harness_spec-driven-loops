...
### Commands
1. `bash: rg -n 'iteration-{NNN}|Verify JSONL was appended|reducer refreshed' .opencode/skills/deep-loop-workflows/research/references/protocol/loop_protocol.md`
2. `bash: rg -n 'iteration-NNN|deep-research-state.jsonl|findings-registry.json|Reducer Contract' .opencode/skills/deep-loop-workflows/research/references/state/state_format.md .codex/agents/deep-research.toml`
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/research/references/protocol/loop_protocol.md` | Evaluation and write-back checks; use `ANCHOR:phase-iteration-loop` |
| `.opencode/skills/deep-loop-workflows/research/references/state/state_format.md` | Schema expectations for JSONL and strategy; use `ANCHOR:state-log` and `ANCHOR:strategy-file` |

...
### Commands
1. `bash: rg -n 'progressiveSynthesis|workflow-owned|research/research.md' .opencode/skills/deep-loop-workflows/research/README.md .opencode/skills/deep-loop-workflows/research/references/state/state_format.md .opencode/skills/deep-loop-workflows/research/SKILL.md`
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/research/README.md` | Progressive synthesis defaults and state-file table; use `ANCHOR:overview` and `ANCHOR:configuration` |
| `.opencode/skills/deep-loop-workflows/research/references/state/state_format.md` | Canonical ownership wording; use `ANCHOR:overview` and `ANCHOR:config-file` |
| `.opencode/skills/deep-loop-workflows/research/SKILL.md` | Rule-level ownership statement; use `ANCHOR:rules` |

...
### Commands
1. `bash: rg -n 'Step 4a\|Generate Dashboard\|dashboard_generated' .opencode/skills/deep-loop-workflows/research/references/protocol/loop_protocol.md`
2. `bash: sed -n '/ANCHOR:dashboard/,/\/ANCHOR:dashboard/p' .opencode/skills/deep-loop-workflows/research/references/state/state_format.md`
3. `bash: cat .opencode/skills/deep-loop-workflows/research/assets/deep_research_dashboard.md`
...
5. `bash: rg -n 'renderDashboard\|dashboardPath' .opencode/skills/deep-loop-workflows/research/scripts/reduce-state.cjs`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/research/references/protocol/loop_protocol.md` | Loop protocol; inspect Step 4a (Generate Dashboard) under `ANCHOR:phase-iteration-loop` |
| `.opencode/skills/deep-loop-workflows/research/references/state/state_format.md` | State format; inspect `ANCHOR:dashboard` for content sections, lifecycle, and file protection rules |
| `.opencode/skills/deep-loop-workflows/research/assets/deep_research_dashboard.md` | Dashboard template; structural reference for all required sections (Status, Progress, Questions, Trend, Dead Ends, Next Focus, Active Risks) |
| `.opencode/skills/deep-loop-workflows/research/scripts/reduce-state.cjs` | Reducer script; `renderDashboard` generates the dashboard content; `reduceResearchState` writes it to disk |

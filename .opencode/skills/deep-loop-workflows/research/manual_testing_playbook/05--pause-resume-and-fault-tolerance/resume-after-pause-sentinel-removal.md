...
### Commands
1. `bash: rg -n 'On resume|resumed|Continue from step_read_state|review/.deep-research-pause' .opencode/skills/deep-loop-workflows/research/references/protocol/loop_protocol.md .opencode/skills/deep-loop-workflows/research/references/state/state_format.md`
...
3. `bash: rg -n 'Delete the file to resume|Auto-resume|review/.deep-research-pause' .opencode/skills/deep-loop-workflows/research/README.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/research/references/protocol/loop_protocol.md` | Pause-resume flow; use `ANCHOR:phase-iteration-loop` and `ANCHOR:phase-initialization` |
| `.opencode/skills/deep-loop-workflows/research/references/state/state_format.md` | Resumed event schema; use `ANCHOR:state-log` |
...
| `.opencode/skills/deep-loop-workflows/research/README.md` | User-facing pause and resume language; use `ANCHOR:faq` |

...
### Commands
1. `bash: rg -n 'Fault Tolerance|skip malformed|defaults|Warning:' .opencode/skills/deep-loop-workflows/research/references/state/state_format.md .opencode/skills/deep-loop-workflows/research/references/convergence/convergence.md`
2. `bash: rg -n 'missing_newInfoRatio|malformed|skipped' .opencode/skills/deep-loop-workflows/research/references/state/state_format.md`
3. `bash: rg -n 'State file corrupt|Validate JSONL' .opencode/skills/deep-loop-workflows/research/README.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/research/references/state/state_format.md` | Fault tolerance and event schema; use `ANCHOR:state-log` |
| `.opencode/skills/deep-loop-workflows/research/references/convergence/convergence.md` | Defensive JSONL reading; use `ANCHOR:signal-definitions` |
| `.opencode/skills/deep-loop-workflows/research/README.md` | Troubleshooting language; use `ANCHOR:troubleshooting` |

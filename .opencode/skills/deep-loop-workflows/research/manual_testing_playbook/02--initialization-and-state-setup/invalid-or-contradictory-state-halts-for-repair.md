...
### Commands
1. `bash: rg -n 'invalid-state|halt for repair|contradictory|guessing' .opencode/skills/deep-loop-workflows/research/references/protocol/loop_protocol.md .opencode/skills/deep-loop-workflows/research/SKILL.md`
...
3. `bash: rg -n 'State file corrupt|repair|recover' .opencode/skills/deep-loop-workflows/research/README.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/research/references/protocol/loop_protocol.md` | Invalid-state contract; use `ANCHOR:phase-initialization` |
| `.opencode/skills/deep-loop-workflows/research/SKILL.md` | Rule-level guardrails; use `ANCHOR:rules` |
...
| `.opencode/skills/deep-loop-workflows/research/README.md` | Troubleshooting boundary; use `ANCHOR:troubleshooting` |

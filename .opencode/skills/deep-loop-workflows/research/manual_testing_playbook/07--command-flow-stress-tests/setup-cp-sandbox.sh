...
require_path "${REPO_ROOT}/.opencode/skills/deep-loop-workflows/research"
...
copy_dir "${REPO_ROOT}/.opencode/skills/deep-loop-workflows/research" "${SANDBOX_DIR}/.opencode/skills/deep-loop-workflows/research"

...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/deep-loop-workflows/research/manual_testing_playbook/07--command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-049-sandbox
...
| `.opencode/skills/deep-loop-workflows/research/SKILL.md:287-309` | packet-local state location and sentinel |
...
- Feature file path: `07--command-flow-stress-tests/pause-sentinel-halt.md`

...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/deep-loop-workflows/research/manual_testing_playbook/07--command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-051-sandbox
...
| `.opencode/skills/deep-loop-workflows/research/SKILL.md:367-383` | skill-level state and exhausted approach rules |
...
- Feature file path: `07--command-flow-stress-tests/exhausted-approach-respect.md`

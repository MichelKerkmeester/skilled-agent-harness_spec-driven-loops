...
### Commands
1. `bash: rg -n ':confirm|approval|interactive' .opencode/commands/deep/research.md .opencode/skills/deep-loop-workflows/research/README.md`
...
| `.opencode/skills/deep-loop-workflows/research/README.md` | User-facing execution modes; use `ANCHOR:features` |

...
3. `bash: sed -n '1,180p' .opencode/skills/deep-loop-workflows/research/references/state/state_format.md`
### Expected
...
| `.opencode/skills/deep-loop-workflows/research/references/state/state_format.md` | Config schema; use `ANCHOR:config-file` |

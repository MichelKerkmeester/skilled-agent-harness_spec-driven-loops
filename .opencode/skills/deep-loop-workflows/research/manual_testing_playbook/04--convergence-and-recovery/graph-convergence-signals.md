...
2. `bash: rg -n 'blockedStop|blocked_stop|graph-aware convergence|graphEvents|sourceDiversity' .opencode/skills/deep-loop-workflows/research/references/convergence/convergence.md`
...
| `.opencode/skills/deep-loop-workflows/research/references/convergence/convergence.md` | Deep-research legal-stop and blocked-stop contract, including graph-aware convergence |
...
- Feature catalog status: No `feature_catalog/` package exists under `.opencode/skills/deep-loop-workflows/research/` as of 2026-04-10.

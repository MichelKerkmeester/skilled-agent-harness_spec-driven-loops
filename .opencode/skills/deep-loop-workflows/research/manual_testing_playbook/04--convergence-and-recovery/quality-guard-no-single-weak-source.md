...
### Commands
1. `bash: sed -n '104,139p' .opencode/skills/deep-loop-workflows/research/references/convergence/convergence.md`
2. `bash: rg -n 'single_weak_source\|tentative\|sourceStrength' .opencode/skills/deep-loop-workflows/research/references/convergence/convergence.md`
3. `bash: sed -n '183,195p' .opencode/skills/deep-loop-workflows/research/references/state/state_format.md`
4. `bash: rg -n 'guard_violation\|single_weak_source' .opencode/skills/deep-loop-workflows/research/references/state/state_format.md`
5. `bash: sed -n '97,107p' .opencode/skills/deep-loop-workflows/research/references/protocol/loop_protocol.md`
6. `bash: sed -n '236,243p' .opencode/commands/deep/assets/deep_research_auto.yaml`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/research/references/convergence/convergence.md` | Canonical quality guard definitions; use §2.4 Quality Guard Protocol |
| `.opencode/skills/deep-loop-workflows/research/references/state/state_format.md` | JSONL event schema; use guard_violation event definition and sourceStrength field classification |
| `.opencode/skills/deep-loop-workflows/research/references/protocol/loop_protocol.md` | Loop orchestration; use Step 2c: Quality Guard Check |
...
- Feature file path: `04--convergence-and-recovery/quality-guard-no-single-weak-source.md`

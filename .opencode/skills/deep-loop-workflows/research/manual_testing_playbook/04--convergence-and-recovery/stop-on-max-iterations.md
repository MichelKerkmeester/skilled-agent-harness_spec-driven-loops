...
### Commands
1. `bash: rg -n 'max iterations|Hard stop|max_iterations_reached' .opencode/skills/deep-loop-workflows/research/references/convergence/convergence.md .opencode/skills/deep-loop-workflows/research/references/protocol/loop_protocol.md`
...
3. `bash: rg -n -- '--max-iterations|Maximum loop iterations' .opencode/skills/deep-loop-workflows/research/README.md .opencode/skills/deep-loop-workflows/research/references/guides/quick_reference.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/research/references/convergence/convergence.md` | Hard-stop ordering; use `ANCHOR:shouldcontinue-algorithm` |
| `.opencode/skills/deep-loop-workflows/research/references/protocol/loop_protocol.md` | Loop decision order; use `ANCHOR:phase-iteration-loop` |
...
| `.opencode/skills/deep-loop-workflows/research/README.md` | Parameter table and examples; use `ANCHOR:configuration` and `ANCHOR:usage-examples` |
| `.opencode/skills/deep-loop-workflows/research/references/guides/quick_reference.md` | Parameter defaults; use `ANCHOR:commands` |

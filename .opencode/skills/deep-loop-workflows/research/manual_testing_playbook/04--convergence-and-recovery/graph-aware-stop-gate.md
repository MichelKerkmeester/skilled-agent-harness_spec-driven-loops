...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/research/scripts/reduce-state.cjs` | Canonical reducer implementation; surfaces `graphConvergenceScore`, `graphDecision`, `graphBlockers`, and dashboard `GRAPH CONVERGENCE` |
| `.opencode/skills/deep-loop-workflows/research/references/state/state_format.md` | Research state contract; defines reducer-owned graph convergence fields and dashboard rendering expectations |

...
### Commands
1. `bash: rg -n 'insight' .opencode/skills/deep-loop-workflows/research/references/state/state_format.md`
2. `bash: rg -n 'stuckCount\|stuck_count\|insight' .opencode/skills/deep-loop-workflows/research/references/convergence/convergence.md`
3. `bash: rg -n 'insight\|thought\|stuck' .opencode/skills/deep-loop-workflows/research/SKILL.md`
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/research/references/state/state_format.md` | Canonical JSONL schema; insight status definition and its relationship to stuck counting |
| `.opencode/skills/deep-loop-workflows/research/references/convergence/convergence.md` | Convergence math; stuckCount computation and which statuses increment it |
| `.opencode/skills/deep-loop-workflows/research/SKILL.md` | Skill overview; iteration status taxonomy including insight |

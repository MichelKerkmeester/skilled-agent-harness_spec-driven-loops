...
- The YAML event filter drops the event upstream: inspect `deep_review_auto.yaml` event-filter normalization block.
...
- YAML event filter: `.opencode/commands/deep/assets/deep_review_auto.yaml` (event-normalization block).

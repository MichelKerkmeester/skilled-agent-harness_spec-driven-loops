...
| `feature_catalog/01--loop-lifecycle/resource-map-emission.md` | Catalog | Companion feature that emits the resource-map coverage data this gate reports on. |
...
- Feature file path: `01--loop-lifecycle/resource-map-coverage-gate.md`

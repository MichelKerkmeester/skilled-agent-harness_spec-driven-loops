...
| [`references/design_generation_patterns.md`](./references/design_generation_patterns.md) | Design-generation prompt patterns for magicpath and open-design: the grounded anti-default brief, seed-of-thought variation, discovery-form pre-answer and the sk-code handoff |

...
- Expected execution process: sk-prompt detects no `$` prefix, defaults to TEXT_ENHANCE intent, loads `references/depth-framework.md` + `references/patterns-evaluation.md`, runs all five DEPTH phases for 10 total rounds, applies CLEAR, and emits the transparency report.
...
| File | Role |
|---|---|
| `../../references/depth-framework.md` | DEPTH methodology for the 10-round contract |
| `../../references/patterns-evaluation.md` | CLEAR scoring (40+/50 threshold) |
...
- Feature file path: `mode-detection/default-mode-routing.md`

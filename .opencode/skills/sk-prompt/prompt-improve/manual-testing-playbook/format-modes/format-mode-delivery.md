...
3. `bash: rg 'JSON|YAML|Markdown|format_guide_json' .opencode/skills/sk-prompt/SKILL.md .opencode/skills/sk-prompt/prompt-improve/assets/format-guide-json.md`

...
3. `bash: rg 'ON_DEMAND_KEYWORDS|format guide|format_guide_yaml' .opencode/skills/sk-prompt/SKILL.md .opencode/skills/sk-prompt/prompt-improve/assets/format-guide-yaml.md`

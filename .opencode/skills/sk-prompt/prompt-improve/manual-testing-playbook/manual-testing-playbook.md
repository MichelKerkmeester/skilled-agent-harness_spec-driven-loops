...
3. `.opencode/skills/sk-prompt/prompt-improve/references/depth-framework.md`, `.opencode/skills/sk-prompt/prompt-improve/references/patterns-evaluation.md`, `.opencode/skills/sk-prompt/prompt-improve/assets/format-guide-markdown.md`, `.opencode/skills/sk-prompt/prompt-improve/assets/format-guide-json.md`, and `.opencode/skills/sk-prompt/prompt-improve/assets/format-guide-yaml.md` resolve on disk.

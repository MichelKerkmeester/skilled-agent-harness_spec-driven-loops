...
3. `bash: rg 'Floor|dimension falls below floor|C >= 7|E >= 10' .opencode/skills/sk-prompt/prompt-improve/references/depth-framework.md .opencode/skills/sk-prompt/prompt-improve/references/patterns-evaluation.md`

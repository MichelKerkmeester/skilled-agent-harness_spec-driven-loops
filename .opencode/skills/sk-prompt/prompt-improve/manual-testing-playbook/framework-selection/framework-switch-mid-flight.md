...
3. `bash: rg 'Try alternative framework|Framework selected|Test|CLEAR 40' .opencode/skills/sk-prompt/prompt-improve/references/depth-framework.md .opencode/skills/sk-prompt/prompt-improve/references/patterns-evaluation.md`

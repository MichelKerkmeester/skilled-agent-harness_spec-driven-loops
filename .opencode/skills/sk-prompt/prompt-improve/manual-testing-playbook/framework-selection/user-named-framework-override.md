...
3. `bash: rg 'CRAFT|Framework Selection|user' .opencode/skills/sk-prompt/prompt-improve/references/patterns-evaluation.md .opencode/skills/sk-prompt/SKILL.md`
...
2. Inspect `patterns-evaluation.md` for CRAFT structure and valid use cases.
...
| File | Role |
|---|---|
| `../../references/patterns-evaluation.md` | CRAFT definition and framework matrix |
| `../../references/depth-framework.md` | DEPTH phases applying selected framework |
...
- Feature file path: `framework-selection/user-named-framework-override.md`

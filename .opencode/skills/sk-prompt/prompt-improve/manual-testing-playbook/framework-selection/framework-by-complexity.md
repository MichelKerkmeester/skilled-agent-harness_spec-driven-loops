...
3. `bash: rg 'Framework Selection Matrix|Complete Framework Matrix|Complexity' .opencode/skills/sk-prompt/SKILL.md .opencode/skills/sk-prompt/prompt-improve/references/patterns-evaluation.md`

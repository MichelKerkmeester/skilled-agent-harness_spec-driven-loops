...
3. `bash: rg 'Phase Exit Criteria|D -- DISCOVER|E -- ENGINEER|P -- PROTOTYPE|T -- TEST|H -- HARMONIZE' .opencode/skills/sk-prompt/prompt-improve/references/depth-framework.md`

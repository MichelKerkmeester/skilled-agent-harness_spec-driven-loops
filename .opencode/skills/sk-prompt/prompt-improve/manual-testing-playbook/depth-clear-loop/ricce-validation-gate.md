...
3. `bash: rg 'RICCE|Role, Instructions, Context, Constraints, Examples|present or justified' .opencode/skills/sk-prompt/SKILL.md .opencode/skills/sk-prompt/prompt-improve/references/depth-framework.md`

...
3. `bash: rg 'CRAFT|Framework Selection|user' .opencode/skills/sk-prompt/prompt-improve/references/patterns_evaluation.md .opencode/skills/sk-prompt/SKILL.md`

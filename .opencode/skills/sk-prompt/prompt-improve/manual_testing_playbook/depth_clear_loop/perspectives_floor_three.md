...
3. `bash: rg '3 minimum|Perspectives|BLOCKING' .opencode/skills/sk-prompt/prompt-improve/references/depth_framework.md`
...
- Feature file path: `depth_clear_loop/perspectives_floor_three.md`

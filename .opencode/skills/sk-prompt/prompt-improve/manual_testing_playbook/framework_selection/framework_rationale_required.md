...
3. `bash: rg 'alternative|reasoning|select_best|Framework Selection Algorithm' .opencode/skills/sk-prompt/prompt-improve/references/patterns_evaluation.md`
...
1. Inspect `patterns_evaluation.md` Framework Selection Algorithm for primary/alternative output.
...
- Feature file path: `framework_selection/framework_rationale_required.md`

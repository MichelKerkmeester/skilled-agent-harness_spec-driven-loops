...
3. `bash: rg 'Correctness|Logic|Expression|Arrangement|Reusability|CLEAR_SCORE' .opencode/skills/sk-prompt/references/patterns-evaluation.md .opencode/skills/sk-prompt/SKILL.md`

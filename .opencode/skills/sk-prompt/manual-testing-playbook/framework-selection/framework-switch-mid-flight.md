...
3. `bash: rg 'Try alternative framework|Framework selected|Test|CLEAR 40' .opencode/skills/sk-prompt/references/depth-framework.md .opencode/skills/sk-prompt/references/patterns-evaluation.md`

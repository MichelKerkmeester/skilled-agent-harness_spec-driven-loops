...
| File | Role |
|---|---|
| `../../references/patterns-evaluation.md` | CLEAR floors that, when unmet, justify escalation |
| `../../references/depth-framework.md` | Deep-path DEPTH processing after escalation |

...
Primary framework: **RCAF**. For the generic RCAF definition and CLEAR scoring methodology, see [`../../../sk-prompt-improve/references/patterns-evaluation.md`](../../../sk-prompt-improve/references/patterns-evaluation.md).
...
- [`../../../sk-prompt-improve/references/patterns-evaluation.md`](../../../sk-prompt-improve/references/patterns-evaluation.md) — Generic RCAF definition, CLEAR scoring, full framework matrix

...
3. `bash: rg 'CRAFT|Framework Selection|user' .opencode/skills/sk-prompt/sk-prompt-improve/references/patterns-evaluation.md .opencode/skills/sk-prompt/SKILL.md`

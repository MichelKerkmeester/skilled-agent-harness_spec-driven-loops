...
3. `bash: rg 'Framework Selection Matrix|Complete Framework Matrix|Complexity' .opencode/skills/sk-prompt/SKILL.md .opencode/skills/sk-prompt/sk-prompt-improve/references/patterns-evaluation.md`
...
2. Inspect `patterns-evaluation.md` Complete Framework Matrix and algorithm.
...
| File | Role |
|---|---|
| `../../references/patterns-evaluation.md` | Seven-framework library and selection algorithm |
...
- Feature file path: `framework-selection/framework-by-complexity.md`

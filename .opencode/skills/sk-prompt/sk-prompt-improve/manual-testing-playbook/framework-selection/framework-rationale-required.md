...
3. `bash: rg 'alternative|reasoning|select_best|Framework Selection Algorithm' .opencode/skills/sk-prompt/sk-prompt-improve/references/patterns-evaluation.md`

...
3. `bash: rg 'Try alternative framework|Framework selected|Test|CLEAR 40' .opencode/skills/sk-prompt/sk-prompt-improve/references/depth-framework.md .opencode/skills/sk-prompt/sk-prompt-improve/references/patterns-evaluation.md`
...
1. Inspect `depth-framework.md` Improvement Protocol for the third-cycle alternative-framework rule.
2. Inspect `patterns-evaluation.md` framework alternatives for sentiment-analysis fit.
...
| File | Role |
|---|---|
| `../../references/depth-framework.md` | Improvement cycle and Test-phase gates |
| `../../references/patterns-evaluation.md` | Framework alternatives and selection criteria |
...
- Feature file path: `framework-selection/framework-switch-mid-flight.md`

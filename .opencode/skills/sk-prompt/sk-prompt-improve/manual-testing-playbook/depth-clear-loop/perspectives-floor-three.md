...
3. `bash: rg '3 minimum|Perspectives|BLOCKING' .opencode/skills/sk-prompt/sk-prompt-improve/references/depth-framework.md`
...
2. Inspect DEPTH Energy Levels and Standard Perspectives in `depth-framework.md`.
...
| File | Role |
|---|---|
| `../../references/depth-framework.md` | Perspective-floor and energy-level source of truth |
| `../../references/patterns-evaluation.md` | CLEAR validation that follows the Discover gate |
...
- Feature file path: `depth-clear-loop/perspectives-floor-three.md`

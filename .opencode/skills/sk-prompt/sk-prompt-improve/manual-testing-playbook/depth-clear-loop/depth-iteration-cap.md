...
3. `bash: rg 'max 3 iterations|on_exceed|Deliver best version' .opencode/skills/sk-prompt/sk-prompt-improve/references/depth-framework.md`
...
1. Inspect the Improvement Protocol in `depth-framework.md` for the max-3 rule.

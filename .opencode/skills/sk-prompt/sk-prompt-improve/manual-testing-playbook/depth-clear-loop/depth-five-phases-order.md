...
3. `bash: rg 'Phase Exit Criteria|D -- DISCOVER|E -- ENGINEER|P -- PROTOTYPE|T -- TEST|H -- HARMONIZE' .opencode/skills/sk-prompt/sk-prompt-improve/references/depth-framework.md`
...
2. Inspect `references/depth-framework.md` Phase Exit Criteria for the canonical order.
...
| File | Role |
|---|---|
| `../../references/depth-framework.md` | DEPTH phase definitions and mandatory exit criteria |
| `../../references/patterns-evaluation.md` | CLEAR scoring reference used at Test phase |
...
- Feature file path: `depth-clear-loop/depth-five-phases-order.md`

...
3. `bash: rg 'JSON|YAML|Markdown|format_guide_json' .opencode/skills/sk-prompt/SKILL.md .opencode/skills/sk-prompt/sk-prompt-improve/assets/format-guide-json.md`
...
| File | Role |
|---|---|
| `../../assets/format-guide-json.md` | JSON format delivery standards |
| `../../assets/format-guide-yaml.md` | YAML comparison target for supplemental checks |
...
- Feature file path: `format-modes/format-mode-delivery.md`

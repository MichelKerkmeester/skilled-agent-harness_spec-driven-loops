...
3. `bash: rg 'Floor|dimension falls below floor|C >= 7|E >= 10' .opencode/skills/sk-prompt/sk-prompt-improve/references/depth-framework.md .opencode/skills/sk-prompt/sk-prompt-improve/references/patterns-evaluation.md`
...
1. Inspect CLEAR Dimensions in `patterns-evaluation.md` for floor values.
2. Inspect `depth-framework.md` Test phase for improvement triggers.
...
| File | Role |
|---|---|
| `../../references/patterns-evaluation.md` | CLEAR dimension floors and thresholds |
| `../../references/depth-framework.md` | Improvement trigger on floor breach |
...
- Feature file path: `clear-scoring/dimension-floors-block.md`

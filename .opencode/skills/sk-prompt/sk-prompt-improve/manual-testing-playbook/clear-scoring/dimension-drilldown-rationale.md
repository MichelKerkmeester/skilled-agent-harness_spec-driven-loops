...
3. `bash: rg 'Per-Dimension Scoring Rubrics|Scoring Criteria|CLEAR Dimensions' .opencode/skills/sk-prompt/sk-prompt-improve/references/patterns-evaluation.md`
...
1. Inspect `patterns-evaluation.md` scoring rubrics for score criteria.
...
| File | Role |
|---|---|
| `../../references/patterns-evaluation.md` | CLEAR scoring rubrics and dimension criteria |
| `../../references/depth-framework.md` | Transparency model for user-visible scoring evidence |
...
- Feature file path: `clear-scoring/dimension-drilldown-rationale.md`

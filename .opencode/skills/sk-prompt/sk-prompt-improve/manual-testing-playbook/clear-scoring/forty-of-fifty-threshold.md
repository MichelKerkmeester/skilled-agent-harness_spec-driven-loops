...
3. `bash: rg '40\\+/50|required|30-39|Max 3 iterations|CLEAR >= 40' .opencode/skills/sk-prompt/sk-prompt-improve/references/depth-framework.md .opencode/skills/sk-prompt/sk-prompt-improve/references/patterns-evaluation.md`

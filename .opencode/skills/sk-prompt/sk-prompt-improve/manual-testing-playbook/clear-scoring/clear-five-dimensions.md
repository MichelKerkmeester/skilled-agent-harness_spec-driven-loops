...
3. `bash: rg 'Correctness|Logic|Expression|Arrangement|Reusability|CLEAR_SCORE' .opencode/skills/sk-prompt/sk-prompt-improve/references/patterns-evaluation.md .opencode/skills/sk-prompt/SKILL.md`

...
**Ranking stable** — v-004-rcaf-medium wins under both text-only (v1) and full-D1 (v2) scoring regimes. The 113/004 RCAF default is confirmed. **No v1.0.6.0 uplift needed.**

 ...
 *
 * v3 source: 113/005/state/eval-loop-state-v3.jsonl (archived from 113/003 after
...
// v3 archived to 113/005/state with -v3 suffix; v2 baseline preserved at -v2 suffix
...
const VARIANTS_DIR = path.resolve(PACKET_ROOT, '..', '003-eval-loop', 'variants');

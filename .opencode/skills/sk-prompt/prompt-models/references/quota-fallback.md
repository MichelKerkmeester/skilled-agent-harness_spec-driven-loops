...
The fallback engine reads `prompt-models/assets/model-profiles.json`.
...
- `failedModelId`
- parsed registry from `prompt-models/assets/model-profiles.json`
...
3. Populate the `haiku` stub in `prompt-models/assets/model-profiles.json`.

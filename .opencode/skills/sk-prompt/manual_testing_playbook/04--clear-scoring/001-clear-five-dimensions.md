...
2. `agent: @prompt-improver raw_task="Score and improve a customer-feedback parsing prompt with full CLEAR breakdown." task_type=analyze target_cli=codex complexity_hint=6 constraints="Return C, L, E, A, R and total."`
...
- Feature file path: `04--clear-scoring/001-clear-five-dimensions.md`

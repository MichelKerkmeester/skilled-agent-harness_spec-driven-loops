...
2. `agent: @prompt-improver raw_task="Improve a prompt for summarizing legal contracts while proving every DEPTH phase runs in order." task_type=generation target_cli=codex complexity_hint=8 constraints="Show phase-order evidence."`
...
- Feature file path: `03--depth-clear-loop/009-depth-five-phases-order.md`

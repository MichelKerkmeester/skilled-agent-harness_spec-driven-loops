...
2. `agent: @prompt-improver raw_task="Improve a SQL query prompt and report every DEPTH phase exit gate." task_type=generation target_cli=codex complexity_hint=7 constraints="Include gate name, status, and remediation for each phase."`
...
1. Inspect `depth_framework.md` Phase Exit Criteria for the canonical gate names.
...
| File | Role |
|---|---|
| `../../references/depth_framework.md` | Mandatory DEPTH phase exit criteria |
| `../../references/patterns_evaluation.md` | CLEAR criteria used by the Test gate |
...
- Feature file path: `03--depth-clear-loop/014-phase-exit-gate-blocking.md`

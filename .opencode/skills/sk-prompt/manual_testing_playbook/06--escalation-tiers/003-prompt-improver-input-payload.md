...
| File | Role |
|---|---|
| `../../assets/cli_prompt_quality_card.md` | Escalation surface that dispatches the payload |
...
- Feature file path: `06--escalation-tiers/003-prompt-improver-input-payload.md`

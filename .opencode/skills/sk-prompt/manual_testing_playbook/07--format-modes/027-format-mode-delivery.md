...
2. `agent: @prompt-improver raw_task="Improve an API request prompt for JSON delivery." task_type=generation target_cli=codex complexity_hint=6 constraints="Deliver enhanced prompt as valid JSON, not markdown."`
3. `bash: rg 'JSON|YAML|Markdown|format_guide_json' .opencode/skills/sk-prompt/SKILL.md .opencode/skills/sk-prompt/assets/format_guide_json.md`
...
- Feature file path: `07--format-modes/027-format-mode-delivery.md`

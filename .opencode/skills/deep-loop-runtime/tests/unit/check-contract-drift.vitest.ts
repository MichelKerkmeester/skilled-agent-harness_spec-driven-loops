...
const REVIEW_CONFIG_SOURCE = '.opencode/skills/deep-loop-workflows/deep-review/assets/deep_review_config.json';
const COUNCIL_COMMAND = 'deep/ai-council';
const COUNCIL_PATTERN_SOURCE = '.opencode/skills/deep-loop-workflows/deep-ai-council/references/patterns/command_wiring.md';

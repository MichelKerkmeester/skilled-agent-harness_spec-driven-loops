...
describe('prompt-pack', () => {
  ...
  it('both production templates load and render successfully with the expected bound variables', () => {
    const researchTemplatePath =
      '/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/deep-research/assets/prompt_pack_iteration.md.tmpl';
    const reviewTemplatePath =
      '/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/deep-review/assets/prompt_pack_iteration.md.tmpl';
    ...
    const researchRendered = renderPromptPack(researchTemplatePath, {
      ...
      state_paths_config: '.opencode/skills/deep-research/assets/deep_research_config.json',
      state_paths_state_log: '.opencode/skills/deep-research/runtime/state.jsonl',
      state_paths_strategy: '.opencode/skills/deep-research/assets/deep_research_strategy.md',
      state_paths_registry: '.opencode/skills/deep-research/runtime/registry.json',
      state_paths_iteration_pattern: '.opencode/skills/deep-research/runtime/iteration-002.md',
      state_paths_delta_pattern: '.opencode/skills/deep-research/runtime/deltas/iter-002.jsonl',
    });
    ...
    const reviewRendered = renderPromptPack(reviewTemplatePath, {
      ...
      p1_count: 1,
      p2_count: 2,
      state_paths_config: '.opencode/skills/deep-review/assets/deep_review_config.json',
      state_paths_state_log: '.opencode/skills/deep-review/runtime/state.jsonl',
      state_paths_findings_registry: '.opencode/skills/deep-review/runtime/findings.json',
      state_paths_strategy: '.opencode/skills/deep-review/assets/deep_review_strategy.md',
      state_paths_iteration_pattern: '.opencode/skills/deep-review/runtime/iteration-003.md',
      state_paths_delta_pattern: '.opencode/skills/deep-review/runtime/deltas/iter-003.jsonl',
    });

    expect(researchRendered).toContain('Research Topic: Deep loop coverage');
    expect(researchRendered).toContain('State Log: .opencode/skills/deep-research/runtime/state.jsonl');
    expect(reviewRendered).toContain('Dimension: traceability');
    expect(reviewRendered).toContain('Findings Registry: .opencode/skills/deep-review/runtime/findings.json');
  });
});

...
- Feature catalog entry exists at `feature_catalog/04--state-safety/006-atomic-state.md`.
...
- Group: State safety
- Playbook ID: DLR-006
- Feature catalog entry: `feature_catalog/04--state-safety/006-atomic-state.md`

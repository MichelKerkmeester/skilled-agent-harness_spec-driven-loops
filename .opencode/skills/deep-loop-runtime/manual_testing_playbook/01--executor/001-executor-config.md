...
- Feature catalog entry exists at `feature_catalog/01--executor/001-executor-config.md`.
...
- Group: Executor
- Playbook ID: DLR-001
- Feature catalog entry: `feature_catalog/01--executor/001-executor-config.md`

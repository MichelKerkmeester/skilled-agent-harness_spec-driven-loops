...
- Feature catalog entry exists at `feature_catalog/07--script-entry-points/query-script.md`.
...
- Playbook ID: DLR-016
- Feature catalog entry: `feature_catalog/07--script-entry-points/query-script.md`
- Scenario file path: `manual_testing_playbook/07--script-entry-points/query-script.md`

...
- Feature catalog entry exists at `feature_catalog/07--script-entry-points/03-query-script.md`.
...
- Playbook ID: DLR-016
- Feature catalog entry: `feature_catalog/07--script-entry-points/03-query-script.md`

...
- Group: Validation
- Playbook ID: DLR-005
- Feature catalog entry: `feature_catalog/03--validation/post-dispatch-validate.md`
- Scenario file path: `manual_testing_playbook/03--validation/post-dispatch-validate.md`

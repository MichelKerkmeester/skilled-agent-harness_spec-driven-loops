...
- Feature catalog entry exists at `feature_catalog/06--coverage-graph/02-coverage-graph-query.md`.
...
- Playbook ID: DLR-012
- Feature catalog entry: `feature_catalog/06--coverage-graph/02-coverage-graph-query.md`

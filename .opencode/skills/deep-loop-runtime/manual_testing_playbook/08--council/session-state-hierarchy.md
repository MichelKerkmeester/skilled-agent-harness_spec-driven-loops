...
- Group: Council
- Playbook ID: DLR-022
- Feature catalog entry: `feature_catalog/08--council/session-state-hierarchy.md`
- Scenario file path: `manual_testing_playbook/08--council/session-state-hierarchy.md`

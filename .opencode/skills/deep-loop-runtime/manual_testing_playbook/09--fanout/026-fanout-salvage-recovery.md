...
- Group: Fan-Out
- Playbook ID: DLR-026
- Feature catalog entry: `feature_catalog/09--fanout/04-fanout-salvage.md`
- Scenario file path: `manual_testing_playbook/09--fanout/026-fanout-salvage-recovery.md`

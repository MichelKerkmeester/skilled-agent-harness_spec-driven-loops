...
| File | Role |
|---|---|
| Full vitest suite | 197/197 confirms no single-executor regression across all deep-loop-runtime tests |
...
- Scenario file path: `manual_testing_playbook/09--fanout/artifact-dir-override-parity.md`

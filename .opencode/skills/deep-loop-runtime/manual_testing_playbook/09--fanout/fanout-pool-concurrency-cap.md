...
2. `bash: cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run ../../deep-loop-runtime/tests/unit/fanout-pool.vitest.ts`
...
- Group: Fan-Out
- Playbook ID: DLR-024
- Feature catalog entry: `feature_catalog/09--fanout/fanout-pool.md`
- Scenario file path: `manual_testing_playbook/09--fanout/fanout-pool-concurrency-cap.md`

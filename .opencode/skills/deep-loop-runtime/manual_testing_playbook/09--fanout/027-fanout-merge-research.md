...
2. `bash: cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run ../../deep-loop-runtime/tests/unit/fanout-merge.vitest.ts`
...
- Group: Fan-Out
- Playbook ID: DLR-027
- Feature catalog entry: `feature_catalog/09--fanout/05-fanout-merge.md`
- Scenario file path: `manual_testing_playbook/09--fanout/027-fanout-merge-research.md`

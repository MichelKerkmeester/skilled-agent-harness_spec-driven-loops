...
- Feature ID: F016
- Feature file path: `07--script-entry-points/016-query-script.md`
- Primary sources: `scripts/query.cjs`, `tests/integration/query-script.vitest.ts`
Related references:
- [015-upsert-script.md](015-upsert-script.md) — upsert.cjs
- [017-status-script.md](017-status-script.md) — status.cjs

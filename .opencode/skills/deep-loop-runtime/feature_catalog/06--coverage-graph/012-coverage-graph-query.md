...
- Feature ID: F012
- Feature file path: `06--coverage-graph/012-coverage-graph-query.md`
- Primary sources: `lib/coverage-graph/coverage-graph-query.ts`, `tests/integration/query-script.vitest.ts`
Related references:
- [011-coverage-graph-db.md](011-coverage-graph-db.md) — Coverage graph DB
- [013-coverage-graph-signals.md](013-coverage-graph-signals.md) — Coverage graph signals

...
trigger_phrases:
  ...
  - "coverage-graph-fuzzy-merge"
  - "coverage-graph fuzzy merge deep-loop-runtime"
...
This feature belongs to the coverage graph group and is catalogued as F041 in the `deep-loop-runtime` inventory.

...
This feature belongs to the council group and is catalogued as F020 in the `deep-loop-runtime` inventory.
...
- Feature ID: F020
- Feature file path: `08--council/020-adjudicator-verdict-scoring.md`
- Primary sources: `lib/council/adjudicator-verdict-scoring.cjs`, `tests/council/adjudicator-verdict-scoring.vitest.ts`
Related references:
- [019-round-state-jsonl.md](019-round-state-jsonl.md) — Round-state JSONL
- [021-cost-guards.md](021-cost-guards.md) — Cost guards

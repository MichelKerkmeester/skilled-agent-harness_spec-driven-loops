...
- Feature ID: F019
- Feature file path: `08--council/019-round-state-jsonl.md`
- Primary sources: `lib/council/round-state-jsonl.cjs`, `tests/council/round-state-jsonl.vitest.ts`
Related references:
- [018-multi-seat-dispatch.md](018-multi-seat-dispatch.md) — Multi-seat dispatch
- [020-adjudicator-verdict-scoring.md](020-adjudicator-verdict-scoring.md) — Adjudicator verdict scoring

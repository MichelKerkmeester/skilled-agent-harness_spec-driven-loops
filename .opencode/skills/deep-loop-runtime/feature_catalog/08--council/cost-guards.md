...
- Feature ID: F021
- Feature file path: `08--council/cost-guards.md`
- Primary sources: `lib/council/cost-guards.cjs`, `tests/council/cost-guards.vitest.ts`
Related references:
- [adjudicator-verdict-scoring.md](adjudicator-verdict-scoring.md) — Adjudicator verdict scoring
- [session-state-hierarchy.md](session-state-hierarchy.md) — Session state hierarchy

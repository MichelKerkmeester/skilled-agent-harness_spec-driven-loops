...
- Feature ID: F002
- Feature file path: `01--executor/002-executor-audit.md`
- Primary sources: `lib/deep-loop/executor-audit.ts`, `tests/unit/executor-audit.vitest.ts`
Related references:
- [001-executor-config.md](001-executor-config.md) — Executor config
- [003-fallback-router.md](003-fallback-router.md) — Fallback router

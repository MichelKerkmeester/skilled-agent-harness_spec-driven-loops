...
- Feature ID: F002
- Feature file path: `01--executor/executor-audit.md`
- Primary sources: `lib/deep-loop/executor-audit.ts`, `tests/unit/executor-audit.vitest.ts`
Related references:
- [executor-config.md](executor-config.md) — Executor config
- [fallback-router.md](fallback-router.md) — Fallback router

...
- Feature ID: F008
- Feature file path: `04--state-safety/008-loop-lock.md`
- Primary sources: `lib/deep-loop/loop-lock.ts`, `tests/unit/loop-lock.vitest.ts`
Related references:
- [007-jsonl-repair.md](007-jsonl-repair.md) — JSONL repair
- [009-permissions-gate.md](009-permissions-gate.md) — Permissions gate

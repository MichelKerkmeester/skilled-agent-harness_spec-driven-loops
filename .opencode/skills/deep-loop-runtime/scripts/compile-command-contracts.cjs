...
const COMMANDS = {
  'deep/ai-council': {
    ...
    presentationPath: '.opencode/commands/deep/assets/deep_ai-council_presentation.txt',
    autoWorkflowPath: '.opencode/commands/deep/assets/deep_ai-council_auto.yaml',
    confirmWorkflowPath: '.opencode/commands/deep/assets/deep_ai-council_confirm.yaml',
    modeSkillPath: '.opencode/skills/deep-loop-workflows/deep-ai-council/SKILL.md',
    ...
    sourcePaths: [
      ...
      '.opencode/commands/deep/assets/deep_ai-council_presentation.txt',
      ...
      '.opencode/skills/deep-loop-workflows/deep-ai-council/references/convergence/convergence_signals.md',
      '.opencode/skills/deep-loop-workflows/deep-ai-council/references/convergence/deep_mode.md',
      '.opencode/skills/deep-loop-workflows/deep-ai-council/references/convergence/depth_dispatch.md',
      '.opencode/skills/deep-loop-workflows/deep-ai-council/references/convergence/failure_handling.md',
      '.opencode/skills/deep-loop-workflows/deep-ai-council/references/scoring/findings_registry.md',
      '.opencode/skills/deep-loop-workflows/deep-ai-council/references/scoring/scoring_rubric.md',
      '.opencode/skills/deep-loop-workflows/deep-ai-council/references/structure/folder_layout.md',
      '.opencode/skills/deep-loop-workflows/deep-ai-council/references/structure/output_schema.md',
      '.opencode/skills/deep-loop-workflows/deep-ai-council/references/structure/state_format.md',
      '.opencode/skills/deep-loop-workflows/deep-ai-council/references/integration/graph_support.md',
      '.opencode/skills/deep-loop-workflows/deep-ai-council/references/integration/loop_protocol.md',
      '.opencode/skills/deep-loop-workflows/deep-ai-council/references/integration/quick_reference.md',
      '.opencode/skills/deep-loop-workflows/deep-ai-council/references/patterns/anti_patterns.md',
      '.opencode/skills/deep-loop-workflows/deep-ai-council/references/patterns/command_wiring.md',
      ...
      '.opencode/skills/deep-loop-workflows/deep-ai-council/assets/prompt_pack_round.md',
      '.opencode/skills/deep-loop-workflows/deep-ai-council/assets/runtime_capabilities.json',

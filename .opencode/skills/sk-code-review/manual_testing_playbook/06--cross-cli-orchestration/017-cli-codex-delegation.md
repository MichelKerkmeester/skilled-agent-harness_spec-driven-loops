...
- Pass/fail: PASS if handback satisfies references/review_core.md schema and .opencode/agents/review.md read-only intent; FAIL if Codex fixes code or omits file:line evidence
...
- Feature file path: `06--cross-cli-orchestration/017-cli-codex-delegation.md`

---
title: "CR-018 -- cli-opencode and cli-gemini handback"
description: "This scenario validates cli-opencode and cli-gemini handback for `CR-018`. It focuses on Confirm alternate CLI reviewers can hand back findings that preserve severity, evidence, and uncertainty."
---
...
This scenario validates cli-opencode and cli-gemini handback for `CR-018`. It focuses on Confirm alternate CLI reviewers can hand back findings that preserve severity, evidence, and uncertainty.
...
- Feature file path: `06--cross-cli-orchestration/018-cli-opencode-and-cli-gemini-handback.md`

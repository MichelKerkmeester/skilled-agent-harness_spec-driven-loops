...
|---|---|---|
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/tests/python/test_skill_advisor.py` | Skill-advisor routing cases for `sk-code-review`, `deep-review`, and review/write disambiguation | CR-016, CR-017, CR-018 |

...
| `.opencode/skills/mcp-code-mode/manual_testing_playbook/manual_testing_playbook.md` | CM playbook (CM-014..CM-016 Chrome via CM) |
...
- Feature file path: `05--mcp-parallel-instances/017-multi-tab-same-instance.md`

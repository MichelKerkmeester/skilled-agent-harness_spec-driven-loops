...
| `.opencode/skills/mcp-code-mode/manual_testing_playbook/manual_testing_playbook.md` | CM playbook (CM-005..CM-007 manual-namespace, CM-014..CM-016 Chrome via CM) |
...
- Feature file path: `05--mcp-parallel-instances/014-chrome-devtools-1-navigate.md`

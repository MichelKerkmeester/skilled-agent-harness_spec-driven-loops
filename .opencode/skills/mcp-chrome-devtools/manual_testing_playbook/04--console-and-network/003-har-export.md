...
- Prompt: `Export the page network activity as HAR and confirm the saved file is valid HAR JSON.`
...
| File | Role |
|---|---|
| `.opencode/skills/mcp-chrome-devtools/SKILL.md` | bdg network har reference |

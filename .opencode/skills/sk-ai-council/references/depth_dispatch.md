...
- an orchestrator dispatches `@sk-ai-council`;
...
Do not invoke `@sk-ai-council` while already inside a council run.
...
- Agent body: `.opencode/agents/sk-ai-council.md` §0 ILLEGAL NESTING and §5 PARALLEL VS SEQUENTIAL.
- Caller patterns: `command_wiring.md`.
- Seat selection: `seat_diversity_patterns.md`.
- Failure policy: `failure_handling.md`.
- Scoring and critique: `scoring_rubric.md`.

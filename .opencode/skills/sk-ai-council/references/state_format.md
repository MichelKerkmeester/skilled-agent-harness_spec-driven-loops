---
title: "Deep AI Council State Format"
description: "Append-only JSONL event format for Deep AI Council state, resume and audit records."
trigger_phrases:
  - "sk-ai-council state format"
...
Cross-references:
- Agent body: `.opencode/agents/sk-ai-council.md` §14

...
description: "Code-facing README for .opencode/skills/sk-ai-council/scripts."
trigger_phrases:
  - "sk-ai-council scripts"
  - "code README"
---
...
This README documents the code-bearing folder `.opencode/skills/sk-ai-council/scripts` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/sk-ai-council/scripts
```
...
```text
User request: Check .opencode/skills/sk-ai-council/scripts for sk-code and README coverage.

...
1. `bash: rg -n "max_rounds|max rounds|convergence:false|non-converged|council_complete" .opencode/skills/sk-ai-council/references/convergence_signals.md .opencode/skills/sk-ai-council/references/state_format.md`
...
| File | Role |
|---|---|
| `.opencode/skills/sk-ai-council/references/convergence_signals.md` | Escape hatch guidance |
| `.opencode/skills/sk-ai-council/references/state_format.md` | Completion event semantics |

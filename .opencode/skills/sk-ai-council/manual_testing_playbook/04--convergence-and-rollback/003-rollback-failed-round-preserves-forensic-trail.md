...
| File | Role |
|---|---|
| `.opencode/skills/sk-ai-council/scripts/lib/rollback.js` | Rollback behavior |
| `.opencode/skills/sk-ai-council/references/folder_layout.md` | Failed folder layout |
| `.opencode/skills/sk-ai-council/references/state_format.md` | Rollback state events |

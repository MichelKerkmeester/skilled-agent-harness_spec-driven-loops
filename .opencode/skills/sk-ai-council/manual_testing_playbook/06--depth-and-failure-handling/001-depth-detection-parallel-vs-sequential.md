...
- Expected execution process: Inspect the agent body §0 and §5 plus `references/depth_dispatch.md`, then confirm Depth 1 maps to sequential inline deliberation.
...
1. Read `.opencode/agents/sk-ai-council.md` §0 and §5.
2. Read `references/depth_dispatch.md`.
...
1. `bash: rg -n "Depth 0|Depth 1|sequential_thinking" .opencode/agents/sk-ai-council.md`
2. `bash: rg -n "## [0-9]+\\." .opencode/skills/sk-ai-council/references/depth_dispatch.md`
...
| File | Role |
|---|---|
| `.opencode/agents/sk-ai-council.md` | Authoritative Depth 0 and Depth 1 source |
| `.opencode/skills/sk-ai-council/references/depth_dispatch.md` | Reference mirror for operator use |
...
- Feature file path: `06--depth-and-failure-handling/001-depth-detection-parallel-vs-sequential.md`

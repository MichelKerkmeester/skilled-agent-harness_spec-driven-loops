...
| File | Role |
|---|---|
| `.opencode/skills/sk-ai-council/references/state_format.md` | State event contract |
| `.opencode/skills/sk-ai-council/scripts/advise-council-completion.cjs` | Completion advisory |

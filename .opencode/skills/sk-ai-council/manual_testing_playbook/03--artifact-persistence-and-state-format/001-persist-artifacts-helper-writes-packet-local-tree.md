...
1. `bash: node .opencode/skills/sk-ai-council/scripts/persist-artifacts.cjs <packet> --input-file <report>`
...
| File | Role |
|---|---|
| `.opencode/skills/sk-ai-council/scripts/persist-artifacts.cjs` | CLI wrapper |
| `.opencode/skills/sk-ai-council/references/folder_layout.md` | Artifact layout |
...
- Feature file path: `03--artifact-persistence-and-state-format/001-persist-artifacts-helper-writes-packet-local-tree.md`

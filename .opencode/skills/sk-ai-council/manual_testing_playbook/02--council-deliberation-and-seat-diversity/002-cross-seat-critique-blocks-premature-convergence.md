...
1. `bash: rg -n "cross-critique|critique|premature|convergence" .opencode/agents/sk-ai-council.md .opencode/skills/sk-ai-council/references/convergence_signals.md .opencode/skills/sk-ai-council/references/seat_diversity_patterns.md`
...
|---|---|---|---|---|---|---|---|---|
| DAC-004 | Cross-seat critique | Verify critique before convergence | `Use the council to pressure-test this plan before we implement it and call out whether convergence is real.` | `bash: rg -n "cross-critique|critique|premature|convergence" .opencode/agents/sk-ai-council.md .opencode/skills/sk-ai-council/references/convergence_signals.md .opencode/skills/sk-ai-council/references/seat_diversity_patterns.md` | Critique and escape-hatch rules present | Grep transcript | PASS if critique gates convergence | Inspect convergence guidance |
...
| File | Role |
|---|---|
| `.opencode/agents/sk-ai-council.md` | Deliberation workflow |
| `.opencode/skills/sk-ai-council/references/convergence_signals.md` | Convergence escape hatches |

...
1. `bash: sed -n '1,140p' .opencode/skills/sk-ai-council/references/seat_diversity_patterns.md`
2. `bash: rg -n "DIVERSIFY|Lens diversity|Mandate diversity|N=3|max 3" .opencode/agents/sk-ai-council.md`
...
|---|---|---|---|---|---|---|---|---|
| DAC-003 | Three-seat diverse deliberation | Verify diverse seats | `Run a deep AI council to compare these two implementation plans and show the distinct seat lenses.` | `bash: sed -n '1,140p' .opencode/skills/sk-ai-council/references/seat_diversity_patterns.md -> bash: rg -n "DIVERSIFY|Lens diversity|Mandate diversity|N=3|max 3" .opencode/agents/sk-ai-council.md` | Distinct lens and mandate rules | Cited lines | PASS if diversity is explicit | Inspect agent strategy section |
...
| File | Role |
|---|---|
| `.opencode/skills/sk-ai-council/references/seat_diversity_patterns.md` | Seat diversity contract |
| `.opencode/agents/sk-ai-council.md` | Runtime strategy rules |

...
1. `bash: rg -n "graph" .opencode/skills/sk-ai-council/SKILL.md`
...
| File | Role |
|---|---|
| `.opencode/skills/sk-ai-council/SKILL.md` | Skill scope rules |

...
1. `bash: rg -n "planning-only|ai-council/\\*\\*|application code|spec docs|patch|Bash" .opencode/skills/sk-ai-council/SKILL.md .opencode/agents/sk-ai-council.md`
...
| File | Role |
|---|---|
| `.opencode/skills/sk-ai-council/SKILL.md` | Skill rules and integration points |
| `.opencode/agents/sk-ai-council.md` | Runtime permission boundary |

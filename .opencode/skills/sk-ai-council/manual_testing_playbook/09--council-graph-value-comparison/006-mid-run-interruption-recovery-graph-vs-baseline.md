...
| `.opencode/skills/sk-ai-council/references/state_format.md` | Documents append-only `ai-council-state.jsonl` event contract |
| `.opencode/skills/sk-ai-council/references/graph_support.md` §5 | Documents the recovery + replay contract |

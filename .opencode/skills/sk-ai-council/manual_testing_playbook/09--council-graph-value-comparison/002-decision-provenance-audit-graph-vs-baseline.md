...
| `../08--council-graph-integration/004-council-graph-query-five-modes-prompt-safe-context.md` | Functional anchor for `decision_support` mode |
...
| `.opencode/skills/sk-ai-council/references/graph_support.md` §3 | Documents SUPPORTS / PROPOSES / RECOMMENDS edges |
...
- Feature file path: `09--council-graph-value-comparison/002-decision-provenance-audit-graph-vs-baseline.md`

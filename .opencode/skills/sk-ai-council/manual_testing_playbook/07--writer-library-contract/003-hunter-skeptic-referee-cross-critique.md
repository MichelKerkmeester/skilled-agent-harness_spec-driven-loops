...
1. `bash: rg -n "HUNTER|SKEPTIC|REFEREE" .opencode/skills/sk-ai-council/references/scoring_rubric.md`
2. `bash: rg -n "Pre-Critique|Post-Critique" .opencode/skills/sk-ai-council/references/scoring_rubric.md`
...
|---|---|---|---|---|---|---|---|---|
| DAC-016 | Hunter Skeptic Referee | Verify cross-critique roles and adjustment | `Apply the Hunter / Skeptic / Referee critique pattern to a hypothetical close-score council and show the score adjustment.` | `bash: rg -n "HUNTER\|SKEPTIC\|REFEREE" .opencode/skills/sk-ai-council/references/scoring_rubric.md` -> `bash: rg -n "Pre-Critique\|Post-Critique" .opencode/skills/sk-ai-council/references/scoring_rubric.md` | Role names and pre/post rows present | Grep output | PASS if all roles and adjustment rule exist | Restore critique section |
...
| File | Role |
|---|---|
| `.opencode/skills/sk-ai-council/references/scoring_rubric.md` | Cross-critique reference |

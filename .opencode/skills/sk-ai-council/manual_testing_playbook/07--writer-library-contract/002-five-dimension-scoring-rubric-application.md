...
1. `bash: rg -n "Correctness.*30|Completeness.*20|Elegance.*15|Robustness.*20|Integration.*15" .opencode/skills/sk-ai-council/references/scoring_rubric.md`
...
| File | Role |
|---|---|
| `.opencode/skills/sk-ai-council/references/scoring_rubric.md` | Rubric and comparison-table reference |
| `.opencode/agents/sk-ai-council.md` | Authoritative synthesis protocol |

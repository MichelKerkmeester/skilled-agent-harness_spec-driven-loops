...
| `.opencode/skills/sk-ai-council/references/graph_support.md` | Documents the five query modes |
...
- Feature file path: `08--council-graph-integration/004-council-graph-query-five-modes-prompt-safe-context.md`

...
| `.opencode/skills/sk-ai-council/references/graph_support.md` §5 | Documents the recovery contract |
...
- Feature file path: `08--council-graph-integration/006-council-graph-status-recovery-payload-and-readiness.md`

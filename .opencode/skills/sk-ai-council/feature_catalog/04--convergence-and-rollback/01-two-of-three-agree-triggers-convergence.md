...
The shipped surface is anchored by `sk-ai-council`. The playbook scenario `04--convergence-and-rollback/001-two-of-three-agree-triggers-convergence.md` defines the operator prompt, command sequence, expected signals, evidence, and pass/fail criteria for DAC-008.

Current behavior is grounded in `.opencode/skills/sk-ai-council/references/convergence_signals.md`, which the scenario identifies as convergence rule. Validation is anchored by `manual_testing_playbook/04--convergence-and-rollback/001-two-of-three-agree-triggers-convergence.md`, covering manual scenario contract.
...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/sk-ai-council/references/convergence_signals.md` | Reference | Convergence rule |

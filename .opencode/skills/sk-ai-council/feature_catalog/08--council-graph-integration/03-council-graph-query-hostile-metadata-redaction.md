...
The shipped surface is anchored by `council_graph_upsert`, `council_graph_query`, `sk-ai-council`. The playbook scenario `08--council-graph-integration/003-council-graph-query-hostile-metadata-redaction.md` defines the operator prompt, command sequence, expected signals, evidence, and pass/fail criteria for DAC-021.
...
| `.opencode/skills/sk-ai-council/references/graph_support.md` | Reference | Documents the allowlist contract |

...
| -------- | ----- | ----- | ----- | ------------------- |
| PI-014 | manual | hook-extension-layer | — | PASS: 13 top-level extension symlinks now present (drift from 11, 2 new: git-preflight-advisory, goal-context); live startup exit 0, no factory error |

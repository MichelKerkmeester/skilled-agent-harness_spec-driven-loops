...
| Executor / model | pi / deepseek-v4-flash (mcp-host-integration) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| PI-011 | manual | mcp-host-integration | — | SKIP: documented SKIP: no approved Pi MCP host available for cite-only transport discovery; scenario reclassified |

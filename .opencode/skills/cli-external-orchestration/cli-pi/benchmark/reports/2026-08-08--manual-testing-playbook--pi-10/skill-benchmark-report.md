...
| -------- | ----- | ----- | ----- | ------------------- |
| PI-009 | manual | agent-bridge | — | FAIL: sync-agents-pi.cjs reports drift on 9/13 agent mirrors (STALE), not the expected in-sync state; live tool listing itself is clean |

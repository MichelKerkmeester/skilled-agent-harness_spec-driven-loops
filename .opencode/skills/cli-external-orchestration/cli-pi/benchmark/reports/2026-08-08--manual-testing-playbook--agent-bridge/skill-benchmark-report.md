...
| Executor / model | pi / deepseek-v4-flash (agent-bridge) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| PI-009 | manual | agent-bridge | — | PASS: sync-agents-pi.cjs --check PASS: 13 agents in sync; 9 stale mirrors regenerated idempotently |

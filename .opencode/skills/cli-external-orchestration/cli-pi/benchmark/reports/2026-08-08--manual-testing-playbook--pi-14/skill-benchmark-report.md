...
| -------- | ----- | ----- | ----- | ------------------- |
| PI-013 | manual | mcp-host-integration | — | PASS: reference states project settings can override global settings; no global mutation attempted; note: pi-mcp-extension currently absent from settings.json |

...
| -------- | ----- | ----- | ----- | ------------------- |
| PI-011 | manual | mcp-host-integration | — | FAIL: npm:pi-mcp-extension absent from settings.json; live session has no MCP tools registered, mcp_sequential_thinking_sequentialthinking absent |

...
| -------- | ----- | ----- | ----- | ------------------- |
| PI-016 | manual | hook-extension-layer | — | PASS: all 13 extensions (incl 2 new) use fail-open catch comments; intentional block:true only in spec-gate-enforce.ts and dispatch-preflight-lint.ts |

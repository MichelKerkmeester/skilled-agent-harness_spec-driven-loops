...
- DeepSeek V4 Pro was retired from the roster and its `.pi` provider-block entry has now been deleted, so a `cline-pass/cline-pass/deepseek-v4-pro` dispatch fails at the config layer rather than being an inert leftover.

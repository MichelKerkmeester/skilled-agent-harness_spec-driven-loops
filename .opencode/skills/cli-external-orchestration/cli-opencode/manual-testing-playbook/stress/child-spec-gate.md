---
title: "EC-006 -- cli-opencode child spec gate"
description: "Hermetic operator check for cli-opencode:EC-006: passes child gate variables through the full cli-opencode runtime."
matrix_cell: "cli-opencode:EC-006"
test_file: "tests/stress/cli-adapter/cli-opencode.vitest.ts"
test_name: "passes child gate variables through the full cli-opencode runtime"
playbook_path: "cli-external-orchestration/cli-opencode/manual-testing-playbook/stress/child-spec-gate.md"
id: "cli-opencode-EC-006"
version: 1.0.0.0
---

# EC-006 -- cli-opencode child spec gate

This document captures the hermetic stress-matrix contract, execution process, source anchors, and metadata for `cli-opencode:EC-006`.

---

## 1. OVERVIEW

This scenario runs the manifest-indexed hermetic stress test for `cli-opencode:EC-006` ("passes child gate variables through the full cli-opencode runtime"). It
...
- Objective: confirm `tests/stress/cli-adapter/cli-opencode.vitest.ts` reports `passes child gate variables through the full cli-opencode runtime` as passing under the shipped stress-matrix
  cell `cli-opencode:EC-006`.
- Operator prompt: `Run the manifest-indexed hermetic stress test for cli-opencode:EC-006 and report PASS, FAIL, or SKIP with the exact blocker.`
...
- Expected signals: the verbose Vitest reporter names the exact test `passes child gate variables through the full cli-opencode runtime` as passed, and the
...
Prompt: `Run the manifest-indexed hermetic stress test for cli-opencode:EC-006 and report PASS, FAIL, or SKIP with the exact blocker.`
...
The command exits `0`, and the verbose Vitest reporter names `passes child gate variables through the full cli-opencode runtime` as passed. Capture the verbose Vitest line for the exact test name and the final file/test count.
...
| [matrix-manifest.ts](../../../../system-deep-loop/runtime/tests/stress/cli-adapter/matrix-manifest.ts) | Stress matrix cell manifest defining `cli-opencode:EC-006` |
...
- Group: Stress Matrix
- Playbook ID: cli-opencode-EC-006

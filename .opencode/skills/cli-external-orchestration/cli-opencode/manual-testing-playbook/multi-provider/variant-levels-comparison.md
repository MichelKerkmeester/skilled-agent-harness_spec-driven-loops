...
| `xiaomi-token-plan-ams/mimo-v2.5-pro` | `--variant` maps to MiMo reasoning effort (`low`/`medium`/`high`); always use `high` per the MiMo effort map |

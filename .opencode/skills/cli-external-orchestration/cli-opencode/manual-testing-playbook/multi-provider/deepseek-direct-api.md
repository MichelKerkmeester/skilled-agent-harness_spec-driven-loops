...
| `../../references/cli-reference.md` (§5 MODEL SELECTION) | Provider table including deepseek direct API |
...
| `../../references/cli-reference.md` | §5 deepseek model ids (`deepseek-v4-pro`, `deepseek-v4-flash`) and reasoning-effort variant range |

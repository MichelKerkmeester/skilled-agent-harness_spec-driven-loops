...
- Prompt: `Run baseline, --pure, and --print-logs variants of the same prompt; verify exits, JSON parseability, plugin silence, and stderr logs.`
...
| `../../references/cli-reference.md` (§4 `--pure`, `--print-logs`, `--log-level` rows) | Diagnostic flag documentation |
...
| `../../references/cli-reference.md` | §10 troubleshooting (plugin load crash recovery via `--pure`) |
...
- Feature file path: `cli-invocation/pure-and-print-logs.md`

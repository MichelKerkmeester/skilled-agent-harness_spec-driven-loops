...
3. Read `../../../../sk-design/shared/context-loading-contract.md` and copy the manifest and proof-field requirements into the dispatch packet.
...
| `../../../../sk-design/shared/context-loading-contract.md` | Shared sk-design manifest, proof fields, and hard gates |
...
| `../../../../sk-design/shared/assets/context-loaded-card.md` | Required pre-work card for design decisions and dispatch |
| `../../../../sk-design/shared/assets/proof-of-application-card.md` | Required end-of-work proof card before ready or release claims |

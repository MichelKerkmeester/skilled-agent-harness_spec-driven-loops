...
- **Unit-test suite run.** `node --test .opencode/plugins/tests/opencode-goal-*.test.cjs` passes 125/125: state 31, lifecycle 36, supervisor 14, continuation 24, export contract 3, capabilities 8, and tool-path 9.

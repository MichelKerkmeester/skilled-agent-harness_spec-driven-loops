...
Budget awareness:
- Apply `../references/context-budget.md`; canonical semantics live in `../../../sk-prompt/prompt-models/references/context-budget.md`.

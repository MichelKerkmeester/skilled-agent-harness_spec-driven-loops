...
Budget awareness:
- Apply `../references/context-budget.md`; canonical semantics live in `../../../sk-prompt/sk-prompt-models/references/context-budget.md`.

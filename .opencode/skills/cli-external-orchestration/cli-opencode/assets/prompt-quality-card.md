...
-> `../../../sk-prompt/sk-prompt-models/assets/cli-prompt-quality-card.md`  (deep theory: `../../../sk-prompt/sk-prompt-improve/references/patterns-evaluation.md`)
...
|---|---|---|
| MiniMax M3 (Token Plan default) | TIDD-EC + dense | `../../../sk-prompt/sk-prompt-models/references/models/minimax-m3.md` |
| MiniMax M3 (Direct API) | TIDD-EC + dense | `../../../sk-prompt/sk-prompt-models/references/models/minimax-m3.md` |
| MiMo V2.5 Pro (Token Plan) | COSTAR + lean, `--variant high` | `../../../sk-prompt/sk-prompt-models/references/models/mimo-v2.5-pro.md` |
| MiMo V2.5 Pro (Direct API) | COSTAR + lean, `--variant high` | `../../../sk-prompt/sk-prompt-models/references/models/mimo-v2.5-pro.md` |
| MiMo V2.5 Pro UltraSpeed (Direct API, low-latency) | COSTAR + lean, `--variant high` | `../../../sk-prompt/sk-prompt-models/references/models/mimo-v2.5-pro.md` |
| GLM-5.2 (Z.AI GLM Coding Plan) | COSTAR + lean (empirical, benchmark 008) | [`glm-5.2.md`](../../../sk-prompt/sk-prompt-models/references/models/glm-5.2.md) |
| deepseek-v4-pro / kimi-k2.7-code | default RCAF (no model-specific benchmark; shared default-unverified note) | [`deepseek-v4-pro.md`](../../../sk-prompt/sk-prompt-models/references/models/deepseek-v4-pro.md) · [`kimi-k2.7-code.md`](../../../sk-prompt/sk-prompt-models/references/models/kimi-k2.7-code.md) |

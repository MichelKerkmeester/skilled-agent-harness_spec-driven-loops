# 2026-08-08--manual-testing-playbook--prompt-templates

> cli-opencode · doc · opencode · opencode-go/deepseek-v4-flash · prompt-templates
...
| Trace mode | doc |
| Executor | opencode |
| Model | opencode-go/deepseek-v4-flash (prompt-templates) |
| Scenarios | 1 |

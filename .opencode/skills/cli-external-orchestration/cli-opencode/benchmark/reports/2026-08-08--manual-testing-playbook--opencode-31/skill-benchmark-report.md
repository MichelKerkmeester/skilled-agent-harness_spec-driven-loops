...
| Executor / model | opencode / opencode-go/deepseek-v4-flash (opencode) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| CO-N01 | manual | intra-routing-recall | — | PASS: correctly classified NONE, no false-positive routing on out-of-domain prompt |

...
| Executor / model | cursor / composer-2.5 (mcp-integration) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| CU-011 | manual | mcp-integration | — | SKIP: documented SKIP: operator MCP-server approval unavailable in headless run; scenario reclassified |

...
| Executor / model | cursor / composer-2.5 (agents-skills-rules) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| CU-024 | manual | agents-skills-rules | — | PASS: cursor command-roster re-run: /speckit-plan produced 26 plan/scenario/packet signals in output |

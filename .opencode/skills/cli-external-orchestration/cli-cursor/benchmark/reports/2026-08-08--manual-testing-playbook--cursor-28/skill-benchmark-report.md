...
| Executor / model | cursor / composer-2.5 (cursor) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| CU-027 | manual | goal-hook | — | PASS: hook fired, turns_used 0->1, agent_message forwarded; live transcript grep 0 hits for canary+marker (documented recorded-evidence tier) |

...
| -------- | ----- | ----- | ----- | ------------------- |
| CU-026 | manual | git-preflight-advisory | — | FAIL: hook registered directly (no Shell proxy); hook only accepts tool_name bash/exec, Cursor sends Shell -> silently no-ops, no advisory fires |

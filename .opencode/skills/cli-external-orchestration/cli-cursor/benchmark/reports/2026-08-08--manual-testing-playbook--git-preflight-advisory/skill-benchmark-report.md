...
| Executor / model | cursor / composer-2.5 (git-preflight-advisory) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| CU-026 | manual | git-preflight-advisory | — | PASS: shared hook accepts Cursor Shell tool_name + workspace_roots[0]; 7 payload tests pass; negative control confirms pre-fix silent vs fixed advises |

...
| `../../assets/prompt-quality-card.md` → delegates to `../../../../sk-prompt/assets/cli-prompt-quality-card.md` (Framework Selection, Task to Framework Map, CLEAR 5-Check, Prompt-Composition Precedence) | Authoritative quality card |
...
| File | Role |
|---|---|
| `../../../../sk-prompt/assets/cli-prompt-quality-card.md` | CLEAR 5-Check (via local card delegation) |

...
| File | Role |
|---|---|
| `../../../../system-spec-kit/runtime/hooks/cursor/README.md` | Full event-delivery evidence table this repo's own adapters were built against |

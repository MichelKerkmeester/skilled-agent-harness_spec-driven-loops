...
## Expected Behavior
Natural-language deep-reasoning-second-opinion intent (no "Claude Code" alias) should still resolve `cli-claude-code`. The deeply-reasoned second-opinion handoff loads `cli-claude-code/references/cli_reference.md` and `cli-claude-code/references/integration_patterns.md`.

...
- Preconditions: `.opencode/plugins/mk-cli-dispatch-audit.js`, `.opencode/skills/cli-external-orchestration/cli-opencode/scripts/hooks/dispatch-audit-posttooluse.mjs`, and `.opencode/skills/cli-external-orchestration/cli-opencode/scripts/lib/dispatch-audit.mjs` all exist (confirmed via Read, see Section 5). `.claude/settings.json` wires a `PostToolUse` hook with `matcher: "Bash"` to the Claude adapter. Node is on `PATH`; `npx vitest` is resolvable for the core's `.test.mjs` suite.
...
printf '%s' "$PAYLOAD" | node .opencode/skills/cli-external-orchestration/cli-opencode/scripts/hooks/dispatch-audit-posttooluse.mjs
echo "exit: $?"
...
printf '%s' "$PAYLOAD3" | MK_CLI_DISPATCH_AUDIT_DISABLED=1 node .opencode/skills/cli-external-orchestration/cli-opencode/scripts/hooks/dispatch-audit-posttooluse.mjs
...
printf '%s' "$PAYLOAD4" | node .opencode/skills/cli-external-orchestration/cli-opencode/scripts/hooks/dispatch-audit-posttooluse.mjs
...
- Claude PostToolUse(Bash) hook adapter: `.opencode/skills/cli-external-orchestration/cli-opencode/scripts/hooks/dispatch-audit-posttooluse.mjs`
- Runtime-neutral shared core: `.opencode/skills/cli-external-orchestration/cli-opencode/scripts/lib/dispatch-audit.mjs`
- Core unit-test suite: `.opencode/skills/cli-external-orchestration/cli-opencode/scripts/lib/dispatch-audit.test.mjs`
- Sibling PreToolUse preflight lint (shares `DISPATCH_SHAPES`): `.opencode/skills/cli-external-orchestration/cli-opencode/scripts/hooks/dispatch-preflight-lint.mjs`

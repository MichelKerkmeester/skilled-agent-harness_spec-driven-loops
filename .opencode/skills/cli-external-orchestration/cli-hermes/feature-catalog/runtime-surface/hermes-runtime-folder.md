...
description: "The repository's `.hermes/` folder carries one directory symlink per curated skill, generated command-prompt stubs, one project plugin and a sync manifest, and nothing that pretends to configure Hermes."
trigger_phrases:

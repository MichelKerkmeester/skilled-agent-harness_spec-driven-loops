...
- Expected signals: Exit code `0`; stdout is exactly two lines, the first `ROUTER_OK` and the second `.opencode/commands/agent-router.md`; stderr carries a `session_id:` line.

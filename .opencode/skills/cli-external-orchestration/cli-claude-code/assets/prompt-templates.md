...
- [cli-reference.md](../references/cli-reference.md) - Complete CLI flag and command reference
- [integration-patterns.md](../references/integration-patterns.md) - Cross-AI orchestration patterns
- [claude-tools.md](../references/claude-tools.md) - Built-in tools, agents, and permission modes

...
| `../../references/cli-reference.md` | Output format flags (section 5) and structured output (section 9) |
...
| `../../references/cli-reference.md` | Output format comparison table |
...
- Feature file path: `cli-invocation/output-format-text-vs-json.md`

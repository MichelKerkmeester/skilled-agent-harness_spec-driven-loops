...
| `../../references/cli-reference.md` | Output format flags (section 5) |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `../../references/cli-reference.md` | Stream-json description in output format comparison |
| `../../references/integration-patterns.md` | Background execution and incremental processing patterns |
...
- Feature file path: `cli-invocation/stream-json-incremental-output.md`

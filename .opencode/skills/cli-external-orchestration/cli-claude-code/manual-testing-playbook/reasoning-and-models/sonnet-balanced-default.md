...
| `../../references/cli-reference.md` | Models table and selection guide (section 6) |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `../../assets/prompt-templates.md` | Security Review template (section 3) |
| `../../references/integration-patterns.md` | Model Selection Strategy (section 6) |
...
- Feature file path: `reasoning-and-models/sonnet-balanced-default.md`

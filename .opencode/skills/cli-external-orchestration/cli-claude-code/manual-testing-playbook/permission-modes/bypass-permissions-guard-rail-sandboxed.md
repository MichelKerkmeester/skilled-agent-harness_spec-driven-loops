...
| `../../references/cli-reference.md` | Permission Mode Flags table including the documented danger note for bypassPermissions |
...
- Feature file path: `permission-modes/bypass-permissions-guard-rail-sandboxed.md`

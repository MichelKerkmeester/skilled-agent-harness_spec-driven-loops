...
| `../../references/integration-patterns.md` | Background execution pattern |
...
| `../../references/integration-patterns.md` | Cross-AI orchestration patterns including parallel dispatch |

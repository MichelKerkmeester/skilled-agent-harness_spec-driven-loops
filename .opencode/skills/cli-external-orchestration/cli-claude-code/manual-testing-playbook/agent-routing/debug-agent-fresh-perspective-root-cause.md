...
| `../../references/agent-delegation.md` | Debug agent details (section 4) |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `../../assets/prompt-templates.md` | Fresh-Perspective Debug template (section 5) |
...
- Feature file path: `agent-routing/debug-agent-fresh-perspective-root-cause.md`

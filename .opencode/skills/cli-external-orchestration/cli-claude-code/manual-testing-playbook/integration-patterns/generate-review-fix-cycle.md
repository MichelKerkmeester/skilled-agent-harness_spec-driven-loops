...
| `../../references/integration-patterns.md` | Generate-Review-Fix Cycle pattern (section 2) |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `../../references/integration-patterns.md` | The canonical pattern documentation including flow diagram |
| `../../references/agent-delegation.md` | Review agent details for `--agent review --permission-mode plan` |

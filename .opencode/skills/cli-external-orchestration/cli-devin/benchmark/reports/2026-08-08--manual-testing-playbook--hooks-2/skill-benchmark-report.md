...
| Executor / model | devin / swe-1.7 (hooks) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| DV-007 | manual | hooks | — | SKIP: environmental SKIP: Devin 3000.x refuses untrusted /tmp workspace (respect_workspace_trust guard) and cloud backend unavailable; print-event fix in place, needs trusted-workspace config + service recovery to confirm |

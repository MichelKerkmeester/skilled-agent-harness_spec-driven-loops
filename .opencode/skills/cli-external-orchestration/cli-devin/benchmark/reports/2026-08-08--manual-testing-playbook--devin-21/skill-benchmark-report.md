...
| -------- | ----- | ----- | ----- | ------------------- |
| DV-020 | manual | cloud-handoff | — | PASS: local doc inspection: /handoff explained (repo+conversation+diff transfer); no live cloud handoff invoked, no file mutation |

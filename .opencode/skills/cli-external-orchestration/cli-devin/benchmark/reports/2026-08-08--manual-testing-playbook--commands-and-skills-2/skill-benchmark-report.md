...
| Executor / model | devin / swe-1.7 (commands-and-skills) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| DV-015 | manual | commands-and-skills | — | SKIP: environmental SKIP: /sk-doc dispatch blocked by Devin cloud outage (cognition.ai errorKind=unavailable, retryable); native skill routing fix is in place, re-run deferred to service recovery |

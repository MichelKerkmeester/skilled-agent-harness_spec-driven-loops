...
| -------- | ----- | ----- | ----- | ------------------- |
| DV-007 | manual | hooks | — | PASS: cloud-recovered re-run: trusted-workspace fixture + dangerous mode; exit 0, second-marker.txt created (hook-test), trust not refused, no cloud error |

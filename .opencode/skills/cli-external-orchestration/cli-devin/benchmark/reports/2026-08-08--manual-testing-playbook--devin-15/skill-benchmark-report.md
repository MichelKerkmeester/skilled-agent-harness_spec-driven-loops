...
| Executor / model | devin / SWE-1.7 (devin) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| DV-014 | manual | commands-and-skills | — | FAIL: .devin/skills/ dir does not exist (0 mirrored commands); devin skills list shows 10 native .opencode/skills hubs instead of 36 commands |

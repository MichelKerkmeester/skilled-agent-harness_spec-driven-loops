...
| Executor / model | devin / swe-1.7 (subagents) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| DV-012 | manual | subagents | — | PASS: cloud-recovered re-run: 13/13 AGENT.md filesystem parity + dangerous-mode read-only review dispatch (27 review signals, no mutation, no cloud error) |

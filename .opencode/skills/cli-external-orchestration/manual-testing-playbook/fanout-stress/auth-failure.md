---
title: "EC-001 -- fanout-run authentication failure"
description: "Hermetic operator check for fanout-run:EC-001: retains fan-out authentication diagnostics in the failed lineage log."
matrix_cell: "fanout-run:EC-001"
...
This snippet runs the manifest-indexed hermetic test for `fanout-run:EC-001`.
...
- **ledger/artifacts**: Exit 3 and `fanout-lineage.out` contains the OAuth-unavailable diagnostic.

---
title: "cli-codex Benchmark Reports"
description: "Index of curated benchmark run reports for cli-codex, one row per run folder."
trigger_phrases:
  - "cli-codex benchmark reports"
  - "cli-codex benchmark index"

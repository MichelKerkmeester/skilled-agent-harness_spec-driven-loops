...
| -------- | ----- | ----- | ----- | ------------------- |
| CX-012 | manual | agent-routing | — | PASS: profile-v2 re-run: disposable CODEX_HOME with copied auth.json + layered review.config.toml; exit 0, 9 category headings, no mutation |

...
| Executor / model | codex / gpt-5.6-luna (sandbox-modes) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| CX-006 | manual | sandbox-modes | — | PASS: Gate-3 preamble re-run: default home + AI_SESSION_CHILD; exit 0, hello.ts created, gate3 not asked |

# 2026-08-08--manual-testing-playbook--session-continuity

> cli-codex · doc · codex · gpt-5.6-luna · session-continuity
...
| Field | Value |
|---|---|
| Target skill | cli-codex |
| Scoring method | not-applicable-manual-outcome |
| Trace mode | doc |
| Executor | codex |
| Model | gpt-5.6-luna (session-continuity) |
| Scenarios | 1 |

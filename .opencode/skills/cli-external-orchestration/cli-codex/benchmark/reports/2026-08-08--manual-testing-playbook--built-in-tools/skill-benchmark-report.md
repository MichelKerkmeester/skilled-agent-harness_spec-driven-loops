...
| Executor / model | codex / gpt-5.6-luna (built-in-tools) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| CX-023 | manual | built-in-tools | — | SKIP: documented SKIP: interactive review TUI requires a terminal; headless stdin is not a TTY |

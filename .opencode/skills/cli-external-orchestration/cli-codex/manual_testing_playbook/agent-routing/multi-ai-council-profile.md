...
`agent_delegation.md` §3 defines `ai-council` as the multi-strategy planner with diverse thinking lenses (Analytical, Creative, Critical, Pragmatic, Integrated). It is the canonical Codex-side complement to the calling AI's planning step. If the profile fails to produce multiple strategies with scoring, the planning routing in `integration_patterns.md` §4 (Routing Table - architecture planning row) loses its second-perspective edge.
...
| `../../references/agent_delegation.md` (§3 @ai-council) | Documents the ai-council profile contract |
...
| File | Role |
|---|---|
| `../../references/agent_delegation.md` | §3 @ai-council - Multi-Strategy Planner |
...
- Feature file path: `04--agent-routing/004-ai-council-profile.md`

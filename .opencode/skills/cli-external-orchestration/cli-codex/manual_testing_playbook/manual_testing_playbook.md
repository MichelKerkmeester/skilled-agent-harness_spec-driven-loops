...
Coverage note (2026-04-26): Covers the canonical default invocation (`gpt-5.5` + `medium` reasoning + `service_tier="fast"`), every documented sandbox mode, every reasoning-effort level, every agent profile (`review`, `context`, `research`, `write`, `debug`, `ai-council`), session continuity surfaces (`--full-auto`, native hooks, resume, fork), unique built-in capabilities (`/review`, `--search`, `--image`, `codex mcp`), prompt-template usage with the CLEAR quality card and cross-AI delegation patterns. Self-invocation refusal is enforced upstream by the skill's detection guard and is not retested here.
...
> **Feature File:** [CX-001](01--cli-invocation/default-invocation.md)
...
> **Feature File:** [CX-002](01--cli-invocation/gpt-5-5-model-lock.md)
...
> **Feature File:** [CX-003](01--cli-invocation/codex-exec-review.md)
...
> **Feature File:** [CX-004](01--cli-invocation/explicit-fast-service-tier.md)
...
> **Feature File:** [CX-005](02--sandbox-modes/read-only-sandbox.md)
...
> **Feature File:** [CX-006](02--sandbox-modes/workspace-write-sandbox.md)
...
> **Feature File:** [CX-007](02--sandbox-modes/danger-full-access-sandbox.md)
...
> **Feature File:** [CX-008](02--sandbox-modes/approval-policies.md)
...
> **Feature File:** [CX-009](03--reasoning-effort/low-minimal-none-baseline.md)
...
> **Feature File:** [CX-010](03--reasoning-effort/medium-skill-default.md)
...
> **Feature File:** [CX-011](03--reasoning-effort/high-xhigh-override.md)
...
> **Feature File:** [CX-012](04--agent-routing/review-profile.md)
...
> **Feature File:** [CX-013](04--agent-routing/context-profile.md)
...
> **Feature File:** [CX-014](04--agent-routing/debug-profile.md)
...
> **Feature File:** [CX-026](04--agent-routing/research-profile.md)
...
> **Feature File:** [CX-016](05--session-continuity/full-auto-hooks.md)
...
> **Feature File:** [CX-017](05--session-continuity/session-resume-fork.md)
...
> **Feature File:** [CX-018](06--integration-patterns/generate-review-fix-cycle.md)
...
> **Feature File:** [CX-019](06--integration-patterns/web-search.md)
...
> **Feature File:** [CX-020](06--integration-patterns/image-input.md)
...
> **Feature File:** [CX-021](07--prompt-templates/prompt-templates-inventory.md)
...
> **Feature File:** [CX-022](07--prompt-templates/clear-scoring-quality-card.md)
...
> **Feature File:** [CX-023](08--built-in-tools/review-tui-command.md)
...
> **Feature File:** [CX-024](08--built-in-tools/search-exec-mode.md)
...
> **Feature File:** [CX-025](08--built-in-tools/mcp-server-registration.md)
...
> **Feature File:** [CX-028](09--codex-cloud/codex-cloud-dispatch.md)
...
- CX-001: [Default invocation (gpt-5.5 medium fast)](01--cli-invocation/default-invocation.md)
- CX-002: [gpt-5.5 model lock](01--cli-invocation/gpt-5-5-model-lock.md)
- CX-003: [codex exec review subcommand](01--cli-invocation/codex-exec-review.md)
- CX-004: [Explicit fast service tier](01--cli-invocation/explicit-fast-service-tier.md)

### SANDBOX MODES

- CX-005: [read-only sandbox (analysis)](02--sandbox-modes/read-only-sandbox.md)
- CX-006: [workspace-write sandbox (generation)](02--sandbox-modes/workspace-write-sandbox.md)
- CX-007: [danger-full-access sandbox **(DESTRUCTIVE)**](02--sandbox-modes/danger-full-access-sandbox.md)
- CX-008: [--full-auto vs explicit approval policies](02--sandbox-modes/approval-policies.md)

### REASONING EFFORT

- CX-009: [low / minimal / none reasoning baseline](03--reasoning-effort/low-minimal-none-baseline.md)
- CX-010: [medium reasoning (skill default)](03--reasoning-effort/medium-skill-default.md)
- CX-011: [high / xhigh override](03--reasoning-effort/high-xhigh-override.md)
...
- CX-016: [--full-auto + native hook integration](05--session-continuity/full-auto-hooks.md)
- CX-017: [session resume / fork](05--session-continuity/session-resume-fork.md)

### INTEGRATION PATTERNS

- CX-018: [Cross-AI generate-review-fix cycle](06--integration-patterns/generate-review-fix-cycle.md)
- CX-019: [Web search via --search](06--integration-patterns/web-search.md)
- CX-020: [Image input via --image](06--integration-patterns/image-input.md)

### PROMPT TEMPLATES

- CX-021: [Use prompt_templates.md inventory](07--prompt-templates/prompt-templates-inventory.md)
- CX-022: [CLEAR scoring via prompt_quality_card.md](07--prompt-templates/clear-scoring-quality-card.md)

### BUILT-IN TOOLS

- CX-023: [/review TUI command](08--built-in-tools/review-tui-command.md)
- CX-024: [--search live browsing in exec](08--built-in-tools/search-exec-mode.md)
- CX-025: [codex mcp server registration](08--built-in-tools/mcp-server-registration.md)

### CODEX CLOUD

- CX-028: [codex cloud dispatch](09--codex-cloud/codex-cloud-dispatch.md)

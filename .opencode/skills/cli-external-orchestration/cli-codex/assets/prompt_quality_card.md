...
-> `../../../sk-prompt/prompt-models/assets/cli_prompt_quality_card.md`  (deep theory: `../../../sk-prompt/references/patterns_evaluation.md`)
...
The 3-tier precedence rule (fast path -> model override -> deep path) is canonical in `../../../sk-prompt/prompt-models/assets/cli_prompt_quality_card.md` and restated in `../SKILL.md`.
...
-> `../../../sk-prompt/prompt-models/assets/cli_prompt_quality_card.md` · `./prompt_templates.md` · `../SKILL.md` · `../../../sk-prompt/prompt-models/references/models/` (per-model profiles)

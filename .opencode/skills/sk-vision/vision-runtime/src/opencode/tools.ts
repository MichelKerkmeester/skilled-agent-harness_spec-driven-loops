...
/** Resolve an image source from a tool arg; throws a SkVisionError on bad input. */
    ...
    "sk_vision_reverse": tool({
      ...
      args: {
        ...
        dir: tool.schema
          .string()
          .optional()
          .describe("Directory to scan for local matches (default: sk-vision cache)."),
        limit: tool.schema
          .number()
          .optional()

...
### Commands
1. `bash: rg -n 'step_memory_upsert_iteration|step_refresh_memory_context|memory_save\\(|memory_context\\(|memory_context_prompt_line|non-fatal' .opencode/commands/deep/assets/deep-research-auto.yaml`
...
| File | Role |
|---|---|
| `.opencode/commands/deep/assets/deep-research-auto.yaml` | Iteration memory upsert and focused memory-context refresh steps |

...
| File | Role |
|---|---|
| `manual-testing-playbook.md` | Root directory page, integrated research protocol, and scenario summary |
| `feature-catalog/loop-lifecycle/resource-map-emission.md` | Matching feature entry for the convergence-time emission contract |
...
| `.opencode/skills/system-spec-kit/mcp-server/scripts/tests/resource-map-extractor.vitest.ts` | Focused regression coverage for the emitted output shape |
...
- Feature catalog entry: `feature-catalog/loop-lifecycle/resource-map-emission.md`

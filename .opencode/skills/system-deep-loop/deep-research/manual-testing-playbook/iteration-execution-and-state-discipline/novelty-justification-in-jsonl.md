...
### Failure Triage
Privilege the SKILL.md ALWAYS rules as the normative contract; use state-format.md for schema details and agent files for implementation enforcement. Note: state-format.md marks the field as `No` (not required) in the schema table but SKILL.md ALWAYS rule 11 and agent v1.1.0 instructions override this to required.
---

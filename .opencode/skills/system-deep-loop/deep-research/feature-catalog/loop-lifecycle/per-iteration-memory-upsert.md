...
| File | Layer | Role |
|---|---|---|
| `.opencode/commands/deep/assets/deep-research-auto.yaml` | Workflow | Adds the iteration memory upsert and focused memory-context refresh steps. |
...
| `.opencode/skills/system-deep-loop/deep-research/manual-testing-playbook/synthesis-save-and-guardrails/per-iteration-memory-upsert.md` | Manual playbook | Verifies incremental memory persistence and context refresh behavior. |

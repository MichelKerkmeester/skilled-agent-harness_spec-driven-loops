...
2. `bash: rg -n 'resource_map|resource-map|emit-resource-map' .opencode/commands/deep/assets/deep_research_auto.yaml .opencode/commands/deep/assets/deep_research_confirm.yaml .opencode/skills/system-deep-loop/deep-research/scripts/reduce-state.cjs`
...
| `feature_catalog/loop-lifecycle/resource-map-emission.md` | Matching feature entry for the convergence-time emission contract |
...
- Feature file path: `synthesis-save-and-guardrails/resource-map-emission.md`
- Feature catalog entry: `feature_catalog/loop-lifecycle/resource-map-emission.md`

...
| `../../feature_catalog/02--state-management/injection-inbox-provenance.md` | Matching feature catalog entry |
...
- Feature file path: `03--iteration-execution-and-state-discipline/injection-inbox-provenance.md`
- Feature catalog: `feature_catalog/02--state-management/injection-inbox-provenance.md`

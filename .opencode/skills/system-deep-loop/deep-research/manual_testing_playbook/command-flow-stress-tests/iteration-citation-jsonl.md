...
This scenario enters through `/deep:research:auto` but grades body-level evidence produced by the leaf iteration: cited findings, required sections, exactly one JSONL iteration record, novelty justification and source/tool fields.
...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-050-sandbox
...
In /tmp/cp-050-sandbox/, run /deep:research:auto for one iteration.
...
- Feature file path: `command-flow-stress-tests/iteration-citation-jsonl.md`

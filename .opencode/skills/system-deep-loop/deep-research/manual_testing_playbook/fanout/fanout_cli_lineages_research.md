...
- `deep_research_auto.yaml` and `research.md` present.
- `fanout-run.cjs` and `fanout-merge.cjs` present.

### Steps

1. `bash: grep -n "step_fanout_spawn\|step_fanout_merge\|fanout_lineage_artifact_dir\|skip_when" .opencode/commands/deep/assets/deep_research_auto.yaml | head -20`
...
- Scenario file path: `manual_testing_playbook/fanout/fanout_cli_lineages_research.md`

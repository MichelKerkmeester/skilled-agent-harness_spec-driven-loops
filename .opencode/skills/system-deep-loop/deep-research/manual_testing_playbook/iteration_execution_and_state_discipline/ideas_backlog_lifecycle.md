...
| `../../feature_catalog/state_management/ideas_backlog_lifecycle.md` | Matching feature catalog entry |
...
- Feature file path: `iteration-execution-and-state-discipline/ideas-backlog-lifecycle.md`
- Feature catalog: `feature_catalog/state_management/ideas_backlog_lifecycle.md`

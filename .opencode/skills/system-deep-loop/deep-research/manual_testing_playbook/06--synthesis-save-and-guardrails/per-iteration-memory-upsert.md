...
| `../../feature_catalog/01--loop-lifecycle/per-iteration-memory-upsert.md` | Matching feature catalog entry |
...
- Feature file path: `06--synthesis-save-and-guardrails/per-iteration-memory-upsert.md`
- Feature catalog: `feature_catalog/01--loop-lifecycle/per-iteration-memory-upsert.md`

...
| `../../feature_catalog/state-management/ideas-backlog-lifecycle.md` | Matching feature catalog entry |
...
- Feature catalog: `feature_catalog/state-management/ideas-backlog-lifecycle.md`

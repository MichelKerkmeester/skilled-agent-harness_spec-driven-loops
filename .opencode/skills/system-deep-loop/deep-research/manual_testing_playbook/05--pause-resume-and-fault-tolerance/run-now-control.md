...
| `../../feature_catalog/01--loop-lifecycle/run-now-control.md` | Matching feature catalog entry |
...
- Feature file path: `05--pause-resume-and-fault-tolerance/run-now-control.md`
- Feature catalog: `feature_catalog/01--loop-lifecycle/run-now-control.md`

...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/04--convergence-and-recovery/divergent-convergence-mode.md` | Manual playbook | Verifies eligibility, hard boundaries, continuation, and existing-mode isolation. |
...
- Feature file path: `03--convergence/divergent-convergence-mode.md`

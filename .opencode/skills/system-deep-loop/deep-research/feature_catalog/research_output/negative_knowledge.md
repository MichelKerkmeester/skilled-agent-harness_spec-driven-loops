...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/synthesis_save_and_guardrails/ruled_out_directions_in_synthesis.md` | Manual playbook | Verifies ruled-out directions survive into final synthesis. |
...
Related references:
- [progressive-synthesis.md](../research_output/progressive_synthesis.md) — Progressive synthesis

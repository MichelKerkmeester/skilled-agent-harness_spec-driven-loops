...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/iteration_execution_and_state_discipline/strategy_next_focus_and_exhausted_approach_discipline.md` | Manual playbook | Verifies next-focus selection and exhausted-approach handling. |
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/convergence_and_recovery/blocked_stop_reducer_surfacing.md` | Manual playbook | Verifies blocked-stop history and recovery guidance appear in reducer-owned outputs. |

...
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/iteration_execution_and_state_discipline/rejected_pattern_cache.md` | Manual playbook | Verifies rejected candidates stay out until removed or reset. |
...
Related references:
- [ideas-backlog-lifecycle.md](../state_management/ideas_backlog_lifecycle.md) - Ideas backlog lifecycle

...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/entry_points_and_modes/parameterized_invocation_max_iterations_convergence.md` | Manual playbook | Verifies runtime flags reach the live config surface. |

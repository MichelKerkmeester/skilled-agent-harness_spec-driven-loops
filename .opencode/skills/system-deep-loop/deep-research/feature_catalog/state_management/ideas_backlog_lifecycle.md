...
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/iteration_execution_and_state_discipline/ideas_backlog_lifecycle.md` | Manual playbook | Verifies observed-only leaf behavior and reducer-owned promotion. |
...
Related references:
- [rejected-pattern-cache.md](../state_management/rejected_pattern_cache.md) - Rejected-pattern cache

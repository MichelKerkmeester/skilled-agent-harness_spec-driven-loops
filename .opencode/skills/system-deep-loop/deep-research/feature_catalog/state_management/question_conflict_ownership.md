...
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/iteration_execution_and_state_discipline/question_conflict_ownership.md` | Manual playbook | Verifies conflict ownership and generated key-question behavior. |
...
- Feature file path: `state-management/question-conflict-ownership.md`
Related references:
- [injection-inbox-provenance.md](../state_management/injection_inbox_provenance.md) - Injection inbox provenance

...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/entry_points_and_modes/loop_wide_dry_run.md` | Manual playbook | Verifies dry-run reads, previews, and mutation-boundary halts. |
...
- Feature file path: `loop-lifecycle/loop-wide-dry-run.md`
Related references:

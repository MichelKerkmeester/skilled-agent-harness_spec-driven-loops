...
| File | Layer | Role |
|---|---|---|
| `.opencode/commands/deep/assets/deep_research_auto.yaml` | Workflow | Defines the sentinel path, run-now check, pause precedence, consume-once behavior, and restore detection. |
...
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/pause_resume_and_fault_tolerance/run_now_control.md` | Manual playbook | Verifies operator-visible forced-run sentinel behavior. |

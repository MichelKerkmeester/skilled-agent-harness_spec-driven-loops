...
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/synthesis_save_and_guardrails/027_resource_map_emission.md` | Manual playbook | Verifies synthesis emits the research resource map and that opt-out skips cleanly. |
...
- [fanout-dispatch.md](../loop_lifecycle/fanout_dispatch.md) — Fan-out loop dispatch

...
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/synthesis_save_and_guardrails/per_iteration_memory_upsert.md` | Manual playbook | Verifies incremental memory persistence and context refresh behavior. |

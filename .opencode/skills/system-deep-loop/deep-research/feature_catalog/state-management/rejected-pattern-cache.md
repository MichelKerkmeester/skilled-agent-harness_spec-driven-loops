...
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/iteration-execution-and-state-discipline/rejected-pattern-cache.md` | Manual playbook | Verifies rejected candidates stay out until removed or reset. |

...
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/iteration-execution-and-state-discipline/ideas-backlog-lifecycle.md` | Manual playbook | Verifies observed-only leaf behavior and reducer-owned promotion. |
...
Related references:
- [rejected-pattern-cache.md](rejected-pattern-cache.md) - Rejected-pattern cache

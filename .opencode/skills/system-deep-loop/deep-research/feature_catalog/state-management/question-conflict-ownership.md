...
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/iteration-execution-and-state-discipline/question-conflict-ownership.md` | Manual playbook | Verifies conflict ownership and generated key-question behavior. |

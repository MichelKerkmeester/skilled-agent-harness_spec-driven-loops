...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/entry-points-and-modes/loop-wide-dry-run.md` | Manual playbook | Verifies dry-run reads, previews, and mutation-boundary halts. |

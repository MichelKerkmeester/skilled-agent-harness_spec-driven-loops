...
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/pause-resume-and-fault-tolerance/run-now-control.md` | Manual playbook | Verifies operator-visible forced-run sentinel behavior. |

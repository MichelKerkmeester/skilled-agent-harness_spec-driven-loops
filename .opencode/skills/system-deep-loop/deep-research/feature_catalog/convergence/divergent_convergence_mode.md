...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/convergence_and_recovery/divergent_convergence_mode.md` | Manual playbook | Verifies eligibility, hard boundaries, continuation, and existing-mode isolation. |
...
Related references:
- [anti-convergence-floor.md](anti_convergence_floor.md) - Minimum-iteration and off-mode behavior
- [quality-guards.md](quality_guards.md) - Legal-stop quality gates

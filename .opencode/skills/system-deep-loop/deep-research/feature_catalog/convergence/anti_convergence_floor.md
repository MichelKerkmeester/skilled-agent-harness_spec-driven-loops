...
| `.opencode/skills/system-deep-loop/deep-research/manual_testing_playbook/convergence_and_recovery/anti_convergence_floor.md` | Manual playbook | Verifies the operator-visible floor and `convergenceMode` contract. |

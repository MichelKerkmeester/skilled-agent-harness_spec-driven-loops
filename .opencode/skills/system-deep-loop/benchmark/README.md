...
| [`live-mode-b/`](./reports/2026-07-10--live-mode-b--live/) | Live-mode (Mode B) `cli-opencode` dispatch run | PASS · 93 (live) | [report](./reports/2026-07-10--live-mode-b--live/skill-benchmark-report.md) |
| [`after-d3-proxy/`](./reports/2026-07-08--after-d3-proxy--router/) | Router-mode run after the D3-efficiency proxy adjustment | PASS · 100 (router) | [report](./reports/2026-07-08--after-d3-proxy--router/skill-benchmark-report.md) |

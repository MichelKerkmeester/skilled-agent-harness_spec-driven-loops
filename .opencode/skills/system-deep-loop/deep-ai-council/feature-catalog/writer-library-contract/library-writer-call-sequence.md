...
| File | Type | Role |
|---|---|---|
| `manual-testing-playbook/writer-library-contract/library-writer-call-sequence.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature-catalog/writer-library-contract/library-writer-call-sequence.md`
- Playbook scenario: `manual-testing-playbook/writer-library-contract/library-writer-call-sequence.md`
Related references:
- [five-dimension-scoring-rubric-application.md](../../feature-catalog/writer-library-contract/five-dimension-scoring-rubric-application.md) — Five-dimension scoring rubric application

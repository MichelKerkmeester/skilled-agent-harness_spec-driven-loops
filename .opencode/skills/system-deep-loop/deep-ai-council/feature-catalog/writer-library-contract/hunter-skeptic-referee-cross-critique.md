...
| File | Type | Role |
|---|---|---|
| `manual-testing-playbook/writer-library-contract/hunter-skeptic-referee-cross-critique.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature-catalog/writer-library-contract/hunter-skeptic-referee-cross-critique.md`
- Playbook scenario: `manual-testing-playbook/writer-library-contract/hunter-skeptic-referee-cross-critique.md`
Related references:
...
- [out-of-scope-write-rejection.md](../../feature-catalog/writer-library-contract/out-of-scope-write-rejection.md) — OUT_OF_SCOPE_WRITE rejection

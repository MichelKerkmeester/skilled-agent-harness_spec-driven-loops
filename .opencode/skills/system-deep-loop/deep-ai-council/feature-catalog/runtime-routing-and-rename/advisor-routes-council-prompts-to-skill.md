...
Current behavior is grounded in `.opencode/skills/system-deep-loop/deep-ai-council/SKILL.md`, which the scenario identifies as skill routing metadata. Validation is anchored by `.opencode/skills/system-skill-advisor/mcp-server/tests/scorer/native-scorer.vitest.ts`, covering advisor regression.
...
| `.opencode/skills/system-skill-advisor/mcp-server/tests/scorer/native-scorer.vitest.ts` | Automated test | Advisor regression |
...
- Feature file path: `feature-catalog/runtime-routing-and-rename/advisor-routes-council-prompts-to-skill.md`
- Playbook scenario: `manual-testing-playbook/runtime-routing-and-rename/advisor-routes-council-prompts-to-skill.md`
Related references:
- [runtime-agent-renamed-to-deep-ai-council.md](../../feature-catalog/runtime-routing-and-rename/runtime-agent-renamed-to-deep-ai-council.md) — Runtime agent renamed to deep-ai-council

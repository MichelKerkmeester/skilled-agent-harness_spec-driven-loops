...
| File | Type | Role |
|---|---|---|
| `manual-testing-playbook/scope-boundaries/graph-support-derived-and-scoped.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature-catalog/scope-boundaries/graph-support-derived-and-scoped.md`
- Playbook scenario: `manual-testing-playbook/scope-boundaries/graph-support-derived-and-scoped.md`
Related references:
- [planning-only-boundary-rejects-implementation-writes.md](../../feature-catalog/scope-boundaries/planning-only-boundary-rejects-implementation-writes.md) — Planning-only boundary rejects implementation writes

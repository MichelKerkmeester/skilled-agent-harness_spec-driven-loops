...
Current behavior is grounded in `.opencode/agents/ai-council.md`, which the scenario identifies as authoritative depth 0 and depth 1 source. Validation is anchored by `manual-testing-playbook/depth-and-failure-handling/depth-detection-parallel-vs-sequential.md`, covering manual scenario contract.
...
| `.opencode/skills/system-deep-loop/deep-ai-council/references/convergence/depth-dispatch.md` | Reference | Reference mirror for operator use |

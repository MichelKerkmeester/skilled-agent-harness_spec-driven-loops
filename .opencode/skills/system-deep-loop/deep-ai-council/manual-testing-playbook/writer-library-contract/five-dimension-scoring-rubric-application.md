...
- Expected execution process: Inspect `scoring-rubric.md` §2 and §3, then grep for the five weighted dimensions.
...
1. Read `scoring-rubric.md` §2 and §3.
...
1. `bash: rg -n "Correctness.*30|Completeness.*20|Elegance.*15|Robustness.*20|Integration.*15" .opencode/skills/system-deep-loop/deep-ai-council/references/scoring/scoring-rubric.md`
...
Capture grep output showing each weighted dimension in `scoring-rubric.md`.
...
| File | Role |
|---|---|
| `.opencode/skills/system-deep-loop/deep-ai-council/references/scoring/scoring-rubric.md` | Rubric and comparison-table reference |
...
- Feature file path: `writer-library-contract/five-dimension-scoring-rubric-application.md`

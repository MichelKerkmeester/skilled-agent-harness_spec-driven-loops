...
| File | Role |
|---|---|
| `.opencode/skills/system-deep-loop/deep-ai-council/scripts/lib/rollback.js` | Rollback behavior |
...
- Feature file path: `convergence-and-rollback/rollback-failed-round-preserves-forensic-trail.md`

...
1. `bash: rg -n "planning-only|ai-council/\\*\\*|application code|spec docs|patch|Bash" .opencode/skills/deep-loop-workflows/deep-ai-council/SKILL.md .opencode/agents/ai-council.md`
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/deep-ai-council/SKILL.md` | Skill rules and integration points |

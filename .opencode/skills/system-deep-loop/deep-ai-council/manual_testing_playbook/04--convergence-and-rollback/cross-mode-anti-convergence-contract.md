...
| `../../feature_catalog/04--convergence-and-rollback/cross-mode-anti-convergence-contract.md` | Feature catalog entry for DAC-033 |
...
- Feature file path: `04--convergence-and-rollback/cross-mode-anti-convergence-contract.md`

...
| `../08--council-graph-integration/council-graph-status-recovery-payload-and-readiness.md` | Functional anchor for `runtime status CLI` recovery payload |
| `../06--depth-and-failure-handling/resume-after-interrupted-state.md` | Baseline JSONL-resume contract |
...
- Feature file path: `09--council-graph-value-comparison/mid-run-interruption-recovery-graph-vs-baseline.md`

...
1. `bash: rg -n "Correctness.*30|Completeness.*20|Elegance.*15|Robustness.*20|Integration.*15" .opencode/skills/deep-loop-workflows/deep-ai-council/references/scoring/scoring_rubric.md`
...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/deep-ai-council/references/scoring/scoring_rubric.md` | Rubric and comparison-table reference |
...
- Feature file path: `07--writer-library-contract/five-dimension-scoring-rubric-application.md`

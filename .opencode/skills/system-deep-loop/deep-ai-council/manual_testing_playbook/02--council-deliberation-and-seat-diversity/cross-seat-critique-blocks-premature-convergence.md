...
1. `bash: rg -n "cross-critique|critique|premature|convergence" .opencode/agents/ai-council.md .opencode/skills/deep-loop-workflows/deep-ai-council/references/convergence/convergence_signals.md .opencode/skills/deep-loop-workflows/deep-ai-council/references/patterns/seat_diversity_patterns.md`
...
|---|---|---|---|---|---|---|---|---|
| DAC-004 | Cross-seat critique | Verify critique before convergence | `Use the council to pressure-test this plan before we implement it and call out whether convergence is real.` | `bash: rg -n "cross-critique|critique|premature|convergence" .opencode/agents/ai-council.md .opencode/skills/deep-loop-workflows/deep-ai-council/references/convergence/convergence_signals.md .opencode/skills/deep-loop-workflows/deep-ai-council/references/patterns/seat_diversity_patterns.md` | Critique and escape-hatch rules present | Grep transcript | PASS if critique gates convergence | Inspect convergence guidance |
...
| `.opencode/skills/deep-loop-workflows/deep-ai-council/references/convergence/convergence_signals.md` | Convergence escape hatches |

...
| File | Role |
|---|---|
| `.opencode/skills/deep-loop-workflows/deep-ai-council/references/structure/state_format.md` | State event contract |
| `.opencode/skills/deep-loop-workflows/deep-ai-council/scripts/advise-council-completion.cjs` | Completion advisory |
...
- Feature file path: `03--artifact-persistence-and-state-format/state-jsonl-records-council-complete-event.md`

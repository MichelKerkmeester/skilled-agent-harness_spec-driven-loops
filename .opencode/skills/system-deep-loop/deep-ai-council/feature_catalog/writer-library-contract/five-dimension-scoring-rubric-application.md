...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/writer-library-contract/five-dimension-scoring-rubric-application.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/writer-library-contract/five-dimension-scoring-rubric-application.md`
- Playbook scenario: `manual_testing_playbook/writer-library-contract/five-dimension-scoring-rubric-application.md`
Related references:

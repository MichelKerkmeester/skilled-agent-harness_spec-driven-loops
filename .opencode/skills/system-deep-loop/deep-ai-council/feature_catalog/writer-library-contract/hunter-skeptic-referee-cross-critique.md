...
Current behavior is grounded in `.opencode/skills/system-deep-loop/deep-ai-council/references/scoring/scoring_rubric.md`, which the scenario identifies as cross-critique reference. Validation is anchored by `manual_testing_playbook/writer-library-contract/hunter-skeptic-referee-cross-critique.md`, covering manual scenario contract.
...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/writer-library-contract/hunter-skeptic-referee-cross-critique.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/writer-library-contract/hunter-skeptic-referee-cross-critique.md`
- Playbook scenario: `manual_testing_playbook/writer-library-contract/hunter-skeptic-referee-cross-critique.md`
Related references:

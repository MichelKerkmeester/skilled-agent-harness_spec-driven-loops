...
Current behavior is grounded in `.opencode/skills/system-deep-loop/deep-ai-council/references/scoring/scoring_rubric.md`, which the scenario identifies as cross-critique reference. Validation is anchored by `manual_testing_playbook/writer_library_contract/hunter_skeptic_referee_cross_critique.md`, covering manual scenario contract.
...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/writer_library_contract/hunter_skeptic_referee_cross_critique.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/writer_library_contract/hunter_skeptic_referee_cross_critique.md`
- Playbook scenario: `manual_testing_playbook/writer_library_contract/hunter_skeptic_referee_cross_critique.md`
Related references:
...
- [out-of-scope-write-rejection.md](../writer_library_contract/out_of_scope_write_rejection.md) — OUT_OF_SCOPE_WRITE rejection

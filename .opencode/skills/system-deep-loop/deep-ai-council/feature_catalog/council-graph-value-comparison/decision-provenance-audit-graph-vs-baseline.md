...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/council-graph-value-comparison/decision-provenance-audit-graph-vs-baseline.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/council-graph-value-comparison/decision-provenance-audit-graph-vs-baseline.md`
- Playbook scenario: `manual_testing_playbook/council-graph-value-comparison/decision-provenance-audit-graph-vs-baseline.md`
Related references:

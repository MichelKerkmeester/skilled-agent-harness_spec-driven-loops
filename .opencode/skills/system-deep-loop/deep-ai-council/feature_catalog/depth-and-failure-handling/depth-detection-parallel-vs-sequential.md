...
Current behavior is grounded in `.opencode/agents/ai-council.md`, which the scenario identifies as authoritative depth 0 and depth 1 source. Validation is anchored by `manual_testing_playbook/depth-and-failure-handling/depth-detection-parallel-vs-sequential.md`, covering manual scenario contract.
...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/depth-and-failure-handling/depth-detection-parallel-vs-sequential.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/depth-and-failure-handling/depth-detection-parallel-vs-sequential.md`
- Playbook scenario: `manual_testing_playbook/depth-and-failure-handling/depth-detection-parallel-vs-sequential.md`
Related references:

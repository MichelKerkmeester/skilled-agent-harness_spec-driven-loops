...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/council_graph_integration/council_graph_status_recovery_payload_and_readiness.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/council_graph_integration/council_graph_status_recovery_payload_and_readiness.md`
- Playbook scenario: `manual_testing_playbook/council_graph_integration/council_graph_status_recovery_payload_and_readiness.md`
Related references:

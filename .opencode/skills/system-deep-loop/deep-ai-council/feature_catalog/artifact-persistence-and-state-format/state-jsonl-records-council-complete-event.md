...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/artifact-persistence-and-state-format/state-jsonl-records-council-complete-event.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/artifact-persistence-and-state-format/state-jsonl-records-council-complete-event.md`
- Playbook scenario: `manual_testing_playbook/artifact-persistence-and-state-format/state-jsonl-records-council-complete-event.md`
Related references:

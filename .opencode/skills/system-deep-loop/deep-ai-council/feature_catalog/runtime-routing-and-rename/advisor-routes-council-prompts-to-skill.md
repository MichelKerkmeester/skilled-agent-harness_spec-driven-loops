...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/runtime-routing-and-rename/advisor-routes-council-prompts-to-skill.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/runtime-routing-and-rename/advisor-routes-council-prompts-to-skill.md`
- Playbook scenario: `manual_testing_playbook/runtime-routing-and-rename/advisor-routes-council-prompts-to-skill.md`
Related references:

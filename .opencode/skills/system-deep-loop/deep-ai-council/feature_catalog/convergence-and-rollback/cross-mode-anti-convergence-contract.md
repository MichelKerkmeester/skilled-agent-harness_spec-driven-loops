...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/convergence-and-rollback/cross-mode-anti-convergence-contract.md` | Manual scenario | Verifies council config, runtime matrix, runtime resolver, and optimizer anchors. |
...
- Feature file path: `feature_catalog/convergence-and-rollback/cross-mode-anti-convergence-contract.md`
- Playbook scenario: `manual_testing_playbook/convergence-and-rollback/cross-mode-anti-convergence-contract.md`
Related references:

...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/convergence-and-rollback/two-of-three-agree-triggers-convergence.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/convergence-and-rollback/two-of-three-agree-triggers-convergence.md`
- Playbook scenario: `manual_testing_playbook/convergence-and-rollback/two-of-three-agree-triggers-convergence.md`
Related references:

...
Current behavior is grounded in `.opencode/skills/system-deep-loop/deep-ai-council/references/convergence/convergence_signals.md`, which the scenario identifies as escape hatch guidance. Validation is anchored by `manual_testing_playbook/convergence_and_rollback/max_rounds_without_convergence_emits_non_converged.md`, covering manual scenario contract.
...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/system-deep-loop/deep-ai-council/references/convergence/convergence_signals.md` | Reference | Escape hatch guidance |
| `.opencode/skills/system-deep-loop/deep-ai-council/references/structure/state_format.md` | Reference | Completion event semantics |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/convergence_and_rollback/max_rounds_without_convergence_emits_non_converged.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/convergence_and_rollback/max_rounds_without_convergence_emits_non_converged.md`
- Playbook scenario: `manual_testing_playbook/convergence_and_rollback/max_rounds_without_convergence_emits_non_converged.md`
Related references:
...
- [rollback-failed-round-preserves-forensic-trail.md](../convergence_and_rollback/rollback_failed_round_preserves_forensic_trail.md) — Rollback failed round preserves forensic trail

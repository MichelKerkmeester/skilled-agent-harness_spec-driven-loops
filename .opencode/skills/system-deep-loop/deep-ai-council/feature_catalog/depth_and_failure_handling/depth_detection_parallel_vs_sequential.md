...
Current behavior is grounded in `.opencode/agents/ai-council.md`, which the scenario identifies as authoritative depth 0 and depth 1 source. Validation is anchored by `manual_testing_playbook/depth_and_failure_handling/depth_detection_parallel_vs_sequential.md`, covering manual scenario contract.
...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/depth_and_failure_handling/depth_detection_parallel_vs_sequential.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/depth_and_failure_handling/depth_detection_parallel_vs_sequential.md`
- Playbook scenario: `manual_testing_playbook/depth_and_failure_handling/depth_detection_parallel_vs_sequential.md`
Related references:
- [resume-after-interrupted-state.md](../depth_and_failure_handling/resume_after_interrupted_state.md) — Resume after interrupted state

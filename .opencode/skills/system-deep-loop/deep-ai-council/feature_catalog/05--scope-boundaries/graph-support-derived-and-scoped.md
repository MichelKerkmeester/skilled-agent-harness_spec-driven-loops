...
Current behavior is grounded in `.opencode/skills/deep-loop-workflows/deep-ai-council/SKILL.md`, which the scenario identifies as skill scope rules. Validation is anchored by `manual_testing_playbook/05--scope-boundaries/graph-support-derived-and-scoped.md`, covering manual scenario contract.
...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/deep-loop-workflows/deep-ai-council/SKILL.md` | Skill | Skill scope rules |

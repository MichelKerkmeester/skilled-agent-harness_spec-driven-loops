...
Current behavior is grounded in `.opencode/skills/system-deep-loop/deep-ai-council/SKILL.md`, which the scenario identifies as skill scope rules. Validation is anchored by `manual_testing_playbook/scope-boundaries/graph-support-derived-and-scoped.md`, covering manual scenario contract.
...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/scope-boundaries/graph-support-derived-and-scoped.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/scope-boundaries/graph-support-derived-and-scoped.md`
- Playbook scenario: `manual_testing_playbook/scope-boundaries/graph-support-derived-and-scoped.md`
Related references:

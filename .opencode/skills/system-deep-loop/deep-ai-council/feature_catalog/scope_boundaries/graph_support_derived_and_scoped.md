...
Current behavior is grounded in `.opencode/skills/system-deep-loop/deep-ai-council/SKILL.md`, which the scenario identifies as skill scope rules. Validation is anchored by `manual_testing_playbook/scope_boundaries/graph_support_derived_and_scoped.md`, covering manual scenario contract.
...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/scope_boundaries/graph_support_derived_and_scoped.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/scope_boundaries/graph_support_derived_and_scoped.md`
- Playbook scenario: `manual_testing_playbook/scope_boundaries/graph_support_derived_and_scoped.md`
Related references:
- [planning-only-boundary-rejects-implementation-writes.md](../scope_boundaries/planning_only_boundary_rejects_implementation_writes.md) — Planning-only boundary rejects implementation writes

...
Current behavior is grounded in `.opencode/skills/system-deep-loop/deep-ai-council/SKILL.md`, which the scenario identifies as skill routing metadata. Validation is anchored by `.opencode/skills/system-skill-advisor/mcp_server/tests/scorer/native-scorer.vitest.ts`, covering advisor regression.
...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/runtime_routing_and_rename/advisor_routes_council_prompts_to_skill.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/runtime_routing_and_rename/advisor_routes_council_prompts_to_skill.md`
- Playbook scenario: `manual_testing_playbook/runtime_routing_and_rename/advisor_routes_council_prompts_to_skill.md`
Related references:
- [runtime-agent-renamed-to-deep-ai-council.md](../runtime_routing_and_rename/runtime_agent_renamed_to_deep_ai_council.md) — Runtime agent renamed to deep-ai-council

...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/council_graph_value_comparison/convergence_safety_under_critical_disagreement_graph_vs_baseline.md` | Automated test | Manual scenario contract |
...
- Feature file path: `feature_catalog/council_graph_value_comparison/convergence_safety_under_critical_disagreement_graph_vs_baseline.md`
- Playbook scenario: `manual_testing_playbook/council_graph_value_comparison/convergence_safety_under_critical_disagreement_graph_vs_baseline.md`
Related references:

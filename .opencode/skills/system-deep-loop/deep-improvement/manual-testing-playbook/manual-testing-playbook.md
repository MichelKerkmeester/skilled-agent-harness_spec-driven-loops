...
#### Test Execution
> **Feature File:** [IS-001](../manual-testing-playbook/integration-scanner/scan-known-agent.md)
...
#### Test Execution
> **Feature File:** [IS-002](../manual-testing-playbook/integration-scanner/scan-missing-agent.md)
...
#### Test Execution
> **Feature File:** [IS-003](../manual-testing-playbook/integration-scanner/scan-diverse-agent.md)
...
#### Test Execution
> **Feature File:** [IS-004](../manual-testing-playbook/integration-scanner/json-output-file.md)
...
#### Test Execution
> **Feature File:** [PG-005](../manual-testing-playbook/profile-generator/rules-extraction.md)
...
#### Test Execution
> **Feature File:** [PG-006](../manual-testing-playbook/profile-generator/output-checks.md)
...
#### Test Execution
> **Feature File:** [PG-007](../manual-testing-playbook/profile-generator/inline-rules-fallback.md)
...
#### Test Execution
> **Feature File:** [PG-008](../manual-testing-playbook/profile-generator/file-output.md)
...
#### Test Execution
> **Feature File:** [BI-012](../manual-testing-playbook/benchmark-integration/without-integration.md)
...
#### Test Execution
> **Feature File:** [BI-013](../manual-testing-playbook/benchmark-integration/with-integration.md)
...
#### Test Execution
> **Feature File:** [RD-014](../manual-testing-playbook/reducer-dimensions/no-dimensions.md)
...
#### Test Execution
> **Feature File:** [RD-015](../manual-testing-playbook/reducer-dimensions/with-dimensions.md)
...
#### Test Execution
> **Feature File:** [RD-016](../manual-testing-playbook/reducer-dimensions/plateau-detection.md)
...
#### Test Execution
> **Feature File:** [E2E-017](../manual-testing-playbook/end-to-end-loop/full-pipeline.md)
...
#### Test Execution
> **Feature File:** [E2E-018](../manual-testing-playbook/end-to-end-loop/any-agent.md)
...
#### Test Execution
> **Feature File:** [E2E-019](../manual-testing-playbook/end-to-end-loop/mutation-coverage-graph-tracking.md)
...
#### Test Execution
> **Feature File:** [E2E-020](../manual-testing-playbook/end-to-end-loop/trade-off-detection.md)
...
#### Test Execution
> **Feature File:** [E2E-021](../manual-testing-playbook/end-to-end-loop/candidate-lineage.md)
...
#### Test Execution
> **Feature File:** [E2E-050](../manual-testing-playbook/end-to-end-loop/two-phase-promotion-and-rollback.md)
...
#### Test Execution
> **Feature File:** [RT-022](../manual-testing-playbook/runtime-truth/stop-reason-taxonomy.md)
...
#### Test Execution
> **Feature File:** [RT-023](../manual-testing-playbook/runtime-truth/audit-journal-emission.md)
...
#### Test Execution
> **Feature File:** [RT-024](../manual-testing-playbook/runtime-truth/resume-continuation.md)
...
#### Test Execution
> **Feature File:** [RT-025](../manual-testing-playbook/runtime-truth/legal-stop-gates.md)
...
#### Test Execution
> **Feature File:** [RT-026](../manual-testing-playbook/runtime-truth/benchmark-stability.md)
...
#### Test Execution
> **Feature File:** [RT-027](../manual-testing-playbook/runtime-truth/dimension-trajectory.md)
...
#### Test Execution
> **Feature File:** [RT-030](../manual-testing-playbook/runtime-truth/insufficient-sample.md)
...
#### Test Execution
> **Feature File:** [RT-031](../manual-testing-playbook/runtime-truth/replay-consumer.md)
...
#### Test Execution
> **Feature File:** [CP-032](../manual-testing-playbook/agent-discipline-stress-tests/skill-load-not-protocol.md)
...
#### Test Execution
> **Feature File:** [CP-033](../manual-testing-playbook/agent-discipline-stress-tests/proposal-only-boundary.md)
...
#### Test Execution
> **Feature File:** [CP-034](../manual-testing-playbook/agent-discipline-stress-tests/active-critic-overfit.md)
...
#### Test Execution
> **Feature File:** [CP-035](../manual-testing-playbook/agent-discipline-stress-tests/legal-stop-gate-bundle.md)
...
#### Test Execution
> **Feature File:** [CP-036](../manual-testing-playbook/agent-discipline-stress-tests/improvement-gate-delta.md)
...
#### Test Execution
> **Feature File:** [CP-037](../manual-testing-playbook/agent-discipline-stress-tests/benchmark-completed-boundary.md)
...
#### Test Execution
> **Feature File:** [MB-038](../manual-testing-playbook/model-benchmark-mode/mode-switch-routing.md)
...
#### Test Execution
> **Feature File:** [MB-039](../manual-testing-playbook/model-benchmark-mode/default-pattern-scorer.md)
...
#### Test Execution
> **Feature File:** [MB-040](../manual-testing-playbook/model-benchmark-mode/optin-5dim-scorer.md)
...
#### Test Execution
> **Feature File:** [MB-041](../manual-testing-playbook/model-benchmark-mode/unknown-fallback.md)
...
#### Test Execution
> **Feature File:** [MB-042](../manual-testing-playbook/model-benchmark-mode/criteria-exec-gate.md)
...
#### Test Execution
> **Feature File:** [MB-R01](../manual-testing-playbook/model-benchmark-mode/reviewer-prompt-regression-fixtures.md)
...
#### Test Execution
> **Feature File:** [SB-043](../manual-testing-playbook/skill-benchmark/mode-wiring-routing.md)
...
#### Test Execution
> **Feature File:** [SB-044](../manual-testing-playbook/skill-benchmark/contamination-gate.md)
...
#### Test Execution
> **Feature File:** [SB-045](../manual-testing-playbook/skill-benchmark/router-replay-mode-a.md)
...
#### Test Execution
> **Feature File:** [SB-046](../manual-testing-playbook/skill-benchmark/d5-connectivity-hard-gate.md)
...
#### Test Execution
> **Feature File:** [SB-047](../manual-testing-playbook/skill-benchmark/scoring-vs-private-gold.md)
...
Expected signals: the run exits 0 and writes both `skill-benchmark-report.json` and `.md`; re-rendering via `build-report.cjs --report <json>` reproduces the orchestrator markdown byte-for-byte (anti-drift); every bottleneck `class` is a member of `assets/skill-benchmark/remediation-taxonomy.json` (classes carry `severity`, `oneLineFix`, and `handoffLane`). Note: the taxonomy is a reference asset validated by test; the report code does not yet enrich bottlenecks with its fields.

#### Test Execution
> **Feature File:** [SB-048](../manual-testing-playbook/skill-benchmark/dual-report-and-remediation.md)
...
| Skill-Benchmark Mode | `.opencode/skills/system-deep-loop/deep-improvement/feature-catalog/skill-benchmark/mode-wiring.md`, `02-contamination-gate-and-fixtures.md`, `03-router-replay-and-advisor-probe.md`, `04-d5-connectivity-gate.md`, `05-scoring-and-funnel.md`, `06-dual-report-and-remediation.md` |

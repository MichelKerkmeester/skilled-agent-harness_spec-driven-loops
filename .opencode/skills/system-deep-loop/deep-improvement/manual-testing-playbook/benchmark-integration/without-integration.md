...
| `benchmark-integration/without-integration.md` | Canonical per-feature execution contract |
...
- Feature file path: `benchmark-integration/without-integration.md`

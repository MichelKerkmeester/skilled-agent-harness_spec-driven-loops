...
- Expected execution process: Run `run-skill-benchmark.cjs --skill deep-improvement` (which ships the `agent_improve_001` public/private fixture pair) into a disposable outputs dir; capture stdout, stderr, exit code, and the generated report; then execute the verification block against `skill-benchmark-report.json`.
...
| `skill-benchmark/scoring-vs-private-gold.md` | Canonical per-feature execution contract |
...
- Feature file path: `skill-benchmark/scoring-vs-private-gold.md`

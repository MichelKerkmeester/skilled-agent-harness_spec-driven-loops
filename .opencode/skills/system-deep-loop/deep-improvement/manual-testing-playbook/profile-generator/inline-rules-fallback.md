...
| `profile-generator/inline-rules-fallback.md` | Canonical per-feature execution contract |
...
- Feature file path: `profile-generator/inline-rules-fallback.md`

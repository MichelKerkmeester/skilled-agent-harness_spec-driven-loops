...
| `../../assets/model_benchmark/benchmark_profiles/framework_bakeoff.json` | Example profile — 5 frameworks × 1 model. |
| `../../assets/model_benchmark/benchmark_profiles/model_vs_model.json` | Example profile — 1 framework × 3 models. |
| `../../assets/model_benchmark/benchmark_fixtures/t3_bugfix_in_context.json` | T3 fixture (id `t3-lower-bound`), hidden deterministic oracle. |
| `../../assets/model_benchmark/benchmark_fixtures/t3_strict_acceptance.json` | T3 fixture (id `t3-compare-versions`), hidden deterministic oracle. |
...
node sweep-benchmark.cjs \
  --profile ../../assets/model_benchmark/benchmark_profiles/framework_bakeoff.json \
  --mock \

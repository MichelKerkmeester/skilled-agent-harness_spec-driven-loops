...
- Authoring these profiles: [`sk-doc/create-benchmark`](../../../../../sk-doc/create-benchmark/SKILL.md) §11 — the run-profile template [`model-benchmark-profile-template.md`](../../../../../sk-doc/create-benchmark/assets/model-benchmark/model-benchmark-profile-template.md) and [`model-benchmark-fixture-guide.md`](../../../../../sk-doc/create-benchmark/references/model-benchmark/model-benchmark-fixture-guide.md). That packet owns the profile *authoring* template; `run-benchmark.cjs` and the scorers stay lane-local.

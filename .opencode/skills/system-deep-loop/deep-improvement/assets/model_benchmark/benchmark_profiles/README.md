...
- Authoring these profiles: [`sk-doc/create-benchmark`](../../../../../sk-doc/create-benchmark/SKILL.md) §11 — the run-profile template [`model_benchmark_profile_template.md`](../../../../../sk-doc/create-benchmark/assets/model_benchmark_profile_template.md) and [`model_benchmark_fixture_guide.md`](../../../../../sk-doc/create-benchmark/references/model_benchmark_fixture_guide.md). That packet owns the profile *authoring* template; `run-benchmark.cjs` and the scorers stay lane-local.

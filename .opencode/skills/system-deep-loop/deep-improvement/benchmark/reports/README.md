---
title: "deep-improvement Benchmark Reports"
description: "Index of curated benchmark run reports for deep-improvement, one row per run folder."
trigger_phrases:
  - "deep-improvement benchmark reports"
  - "deep-improvement benchmark index"
...
|---|---|---|---|---|---|
| 2026-07-10 | [`2026-07-10--router-mode-a--router/`](./2026-07-10--router-mode-a--router/) | router | 9 PASS | **PASS** 100/100 | not recorded |
| 2026-07-10 | [`2026-07-10--live-mode-b--live/`](./2026-07-10--live-mode-b--live/) | live | 9 PASS | **PASS** 90/100 | not recorded |

...
| `.opencode/skills/system-deep-loop/deep-improvement/references/model-benchmark/evaluator-contract.md` | Contract reference | Documents the scorer output schema, benchmark schema, and recommendation threshold. |
| `.opencode/skills/system-deep-loop/deep-improvement/references/model-benchmark/benchmark-operator-guide.md` | Operator reference | Defines the benchmark command shape, repeatability rule, and integration-benchmark fields. |

...
See [`evaluation-loop/candidate-generation.md`](../feature-catalog/evaluation-loop/candidate-generation.md) for full implementation and validation file listings.
...
See [`evaluation-loop/scoring-dispatch.md`](../feature-catalog/evaluation-loop/scoring-dispatch.md) for full implementation and validation file listings.
...
See [`evaluation-loop/promotion-gates.md`](../feature-catalog/evaluation-loop/promotion-gates.md) for full implementation and validation file listings.
...
See [`evaluation-loop/plateau-detection.md`](../feature-catalog/evaluation-loop/plateau-detection.md) for full implementation and validation file listings.
...
See [`evaluation-loop/two-phase-promotion-and-rollback.md`](../feature-catalog/evaluation-loop/two-phase-promotion-and-rollback.md) for full implementation and validation file listings.
...
See [`integration-scanning/surface-discovery.md`](../feature-catalog/integration-scanning/surface-discovery.md) for full implementation and validation file listings.
...
See [`integration-scanning/runtime-mirrors.md`](../feature-catalog/integration-scanning/runtime-mirrors.md) for full implementation and validation file listings.
...
See [`integration-scanning/command-dispatch.md`](../feature-catalog/integration-scanning/command-dispatch.md) for full implementation and validation file listings.
...
See [`scoring-system/five-dimension-rubric.md`](../feature-catalog/scoring-system/five-dimension-rubric.md) for full implementation and validation file listings.
...
See [`scoring-system/deterministic-scoring.md`](../feature-catalog/scoring-system/deterministic-scoring.md) for full implementation and validation file listings.
...
See [`scoring-system/dimensional-progress.md`](../feature-catalog/scoring-system/dimensional-progress.md) for full implementation and validation file listings.
...
See [`model-benchmark-mode/mode-switch.md`](../feature-catalog/model-benchmark-mode/mode-switch.md) for full implementation and validation file listings.
...
`scripts/model-benchmark/dispatch-model.cjs` routes through an executor map across cli-opencode, cli-claude-code, cli-cursor, cli-devin, cli-pi, and cli-hermes (`KNOWN_EXECUTORS` in that file is authoritative; no native and no cli-codex on this path), and is loaded only on the model-benchmark path, never in agent-improvement mode. It forwards `cwd` to every executor and applies rate-limit backoff using a non-busy `Atomics` sleep.

#### Source Files

See [`model-benchmark-mode/model-dispatcher.md`](../feature-catalog/model-benchmark-mode/model-dispatcher.md) for full implementation and validation file listings.
...
See [`model-benchmark-mode/opt-in-5dim-scorer.md`](../feature-catalog/model-benchmark-mode/opt-in-5dim-scorer.md) for full implementation and validation file listings.
...
See [`model-benchmark-mode/mode-records-and-gates.md`](../feature-catalog/model-benchmark-mode/mode-records-and-gates.md) for full implementation and validation file listings.

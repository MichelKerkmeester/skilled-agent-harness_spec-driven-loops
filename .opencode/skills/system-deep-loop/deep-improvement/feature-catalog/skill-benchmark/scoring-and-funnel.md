...
| `.opencode/skills/system-deep-loop/deep-improvement/assets/skill-benchmark/default-profile.json` | Reference profile | Documents weights and verdict bands; reference only, not consumed at runtime per its own `notes`. |
...
- Feature file path: `skill-benchmark/scoring-and-funnel.md`
Related references:
- [d5-connectivity-gate.md](../../feature-catalog/skill-benchmark/d5-connectivity-gate.md) — D5 structural connectivity hard gate
- [dual-report-and-remediation.md](../../feature-catalog/skill-benchmark/dual-report-and-remediation.md) — Dual report and remediation taxonomy

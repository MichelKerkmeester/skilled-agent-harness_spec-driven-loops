...
description: Fixture target for the deep-improvement agent-discipline stress tests
mode: subagent
permission:
  read: allow
  write: allow
...
# Prose is not enough; the benchmark runner must write its completion report.

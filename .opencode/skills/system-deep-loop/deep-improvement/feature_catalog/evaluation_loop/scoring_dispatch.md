...
| `.opencode/skills/system-deep-loop/deep-improvement/references/model_benchmark/benchmark_operator_guide.md` | Operator reference | Documents the benchmark command shape and evidence expectations that sit beside the scorer output. |
...
- Feature file path: `evaluation-loop/scoring-dispatch.md`
Related references:
- [candidate-generation.md](../evaluation_loop/candidate_generation.md) — Candidate generation
- [promotion-gates.md](../evaluation_loop/promotion_gates.md) — Promotion gates

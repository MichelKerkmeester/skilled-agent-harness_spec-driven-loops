...
Related references:
- [d5-connectivity-gate.md](../skill_benchmark/d5_connectivity_gate.md) — D5 structural connectivity hard gate
- [dual-report-and-remediation.md](../skill_benchmark/dual_report_and_remediation.md) — Dual report and remediation taxonomy

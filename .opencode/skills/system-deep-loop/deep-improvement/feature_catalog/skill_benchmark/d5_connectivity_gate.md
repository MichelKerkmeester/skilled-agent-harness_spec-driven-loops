...
Related references:
- [router-replay-and-advisor-probe.md](../skill_benchmark/router_replay_and_advisor_probe.md) — Router replay and advisor probe
- [scoring-and-funnel.md](../skill_benchmark/scoring_and_funnel.md) — D1-D5 scoring and funnel

...
- Feature file path: `scoring-system/dynamic-profiling.md`
Related references:
- [five-dimension-rubric.md](../scoring_system/five_dimension_rubric.md) — Five-dimension rubric
- [deterministic-scoring.md](../scoring_system/deterministic_scoring.md) — Deterministic scoring

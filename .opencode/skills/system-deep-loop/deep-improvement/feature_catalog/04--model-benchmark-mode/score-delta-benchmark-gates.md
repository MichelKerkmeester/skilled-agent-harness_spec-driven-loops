...
- Feature file path: `04--model-benchmark-mode/score-delta-benchmark-gates.md`
Related references:
- [mode-records-and-gates.md](mode-records-and-gates.md) -- Record-level mode and hardening gates
- [promotion-gates.md](../01--evaluation-loop/promotion-gates.md) -- Promotion gate policy

...
Related references:
- [mode-records-and-gates.md](../model_benchmark_mode/mode_records_and_gates.md) -- Record-level mode and hardening gates
- [promotion-gates.md](../evaluation_loop/promotion_gates.md) -- Promotion gate policy

...
- Feature file path: `model-benchmark-mode/model-dispatcher.md`
Related references:
- [mode-switch.md](../model_benchmark_mode/mode_switch.md) — Mode switch
- [opt-in-5dim-scorer.md](../model_benchmark_mode/opt_in_5dim_scorer.md) — Opt-in 5-dimension scorer

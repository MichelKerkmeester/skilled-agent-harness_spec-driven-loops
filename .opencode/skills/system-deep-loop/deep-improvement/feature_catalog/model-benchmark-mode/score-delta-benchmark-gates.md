...
Related references:
- [mode-records-and-gates.md](mode-records-and-gates.md) -- Record-level mode and hardening gates
- [promotion-gates.md](../evaluation-loop/promotion-gates.md) -- Promotion gate policy

...
| `06--end-to-end-loop/two-phase-promotion-and-rollback.md` | Canonical per-feature execution contract |
...
- Feature file path: `06--end-to-end-loop/two-phase-promotion-and-rollback.md`

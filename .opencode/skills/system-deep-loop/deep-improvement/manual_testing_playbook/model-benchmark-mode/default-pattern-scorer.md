...
| `model-benchmark-mode/default-pattern-scorer.md` | Canonical per-feature execution contract |
...
- Feature file path: `model-benchmark-mode/default-pattern-scorer.md`

...
| `model-benchmark-mode/criteria-exec-gate.md` | Canonical per-feature execution contract |
...
- Feature file path: `model-benchmark-mode/criteria-exec-gate.md`

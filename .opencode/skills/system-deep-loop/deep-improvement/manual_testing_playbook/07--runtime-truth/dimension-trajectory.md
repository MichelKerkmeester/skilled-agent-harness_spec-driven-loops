---
title: "RT-027 -- Dimension Trajectory and Convergence Eligibility"
...
- Prompt: `Validate mutation-coverage.cjs trajectory tracking and three-point convergence eligibility.`
...
| `07--runtime-truth/dimension-trajectory.md` | Canonical per-feature execution contract |
...
| `../../scripts/shared/mutation-coverage.cjs'` | Implementation or verification anchor referenced by this scenario |
...
- Feature file path: `07--runtime-truth/dimension-trajectory.md`

...
| `07--runtime-truth/stop-reason-taxonomy.md` | Canonical per-feature execution contract |
...
- Feature file path: `07--runtime-truth/stop-reason-taxonomy.md`

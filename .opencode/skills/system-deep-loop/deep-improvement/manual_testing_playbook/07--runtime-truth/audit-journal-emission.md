...
| `07--runtime-truth/audit-journal-emission.md` | Canonical per-feature execution contract |
...
- Feature file path: `07--runtime-truth/audit-journal-emission.md`

---
title: "RT-031 -- Replay Consumer Artifact Verification"
...
| `07--runtime-truth/replay-consumer.md` | Canonical per-feature execution contract |
...
- Feature file path: `07--runtime-truth/replay-consumer.md`
...
node -e "
  const mc = require('./.opencode/skills/deep-loop-workflows/deep-improvement/scripts/shared/mutation-coverage.cjs');

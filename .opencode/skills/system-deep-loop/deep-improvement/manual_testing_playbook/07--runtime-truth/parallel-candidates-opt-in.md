---
title: "RT-028 -- Parallel Candidates Opt-In Default"
...
- Prompt: `Validate that default settings keep parallelWaves.enabled false and run sequential candidates only.`
...
| `07--runtime-truth/parallel-candidates-opt-in.md` | Canonical per-feature execution contract |
...
| `../../scripts/agent-improvement/candidate-lineage.cjs'` | Implementation or verification anchor referenced by this scenario |
| `.opencode/agents/debug.md` | Implementation or verification anchor referenced by this scenario |
| `../../assets/agent_improvement/improvement_config.json'` | Implementation or verification anchor referenced by this scenario |
...
- Feature file path: `07--runtime-truth/parallel-candidates-opt-in.md`

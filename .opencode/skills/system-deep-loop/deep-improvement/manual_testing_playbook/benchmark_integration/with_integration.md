...
| `benchmark-integration/with-integration.md` | Canonical per-feature execution contract |
...
- Feature file path: `benchmark-integration/with-integration.md`

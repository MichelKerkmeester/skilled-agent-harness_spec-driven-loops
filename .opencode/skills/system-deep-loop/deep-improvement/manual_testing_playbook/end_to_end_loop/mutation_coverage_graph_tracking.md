...
| `end-to-end-loop/mutation-coverage-graph-tracking.md` | Canonical per-feature execution contract |
...
- Feature file path: `end-to-end-loop/mutation-coverage-graph-tracking.md`

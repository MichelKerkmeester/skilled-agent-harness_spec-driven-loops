...
| `end-to-end-loop/trade-off-detection.md` | Canonical per-feature execution contract |
...
- Feature file path: `end-to-end-loop/trade-off-detection.md`

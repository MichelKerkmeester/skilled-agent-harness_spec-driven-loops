...
expected_resources:
  ...
  - references/model_benchmark/benchmark_operator_guide.md
  - references/shared/runtime_truth_contracts.md
  - references/agent_improvement/candidate_proposal_format.md
version: 1.0.0.0
---

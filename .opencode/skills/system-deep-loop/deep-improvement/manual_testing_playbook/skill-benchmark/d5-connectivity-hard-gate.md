...
| `skill-benchmark/d5-connectivity-hard-gate.md` | Canonical per-feature execution contract |
...
- Feature file path: `skill-benchmark/d5-connectivity-hard-gate.md`

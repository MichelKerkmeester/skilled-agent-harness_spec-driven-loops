---
title: "5D-009 -- Dynamic 5D Scoring on Non-Hardcoded Agent (Orchestrate)"
...
This document captures the canonical manual-testing contract for `5D-009`.
...
- Prompt: `Validate dynamic 5D scoring for an agent without a pre-built profile.`
...
| `03--5d-scorer/dynamic-arbitrary.md` | Canonical per-feature execution contract |
...
| `.opencode/agents/orchestrate.md` | Implementation or verification anchor referenced by this scenario |
...
- Feature file path: `03--5d-scorer/dynamic-arbitrary.md`

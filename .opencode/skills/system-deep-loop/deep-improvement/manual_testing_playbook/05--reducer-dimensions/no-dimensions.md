---
title: "RD-014 -- JSONL Without Dimensions Produces Normal Dashboard"
...
This document captures the canonical manual-testing contract for `RD-014`.
...
- Prompt: `Validate that JSONL records without dimension fields still produce a normal reducer dashboard.`
...
| `05--reducer-dimensions/no-dimensions.md` | Canonical per-feature execution contract |
...
- Feature file path: `05--reducer-dimensions/no-dimensions.md`

...
| `02--profile-generator/file-output.md` | Canonical per-feature execution contract |
...
| `.opencode/agents/review.md` | Implementation or verification anchor referenced by this scenario |
...
- Feature file path: `02--profile-generator/file-output.md`

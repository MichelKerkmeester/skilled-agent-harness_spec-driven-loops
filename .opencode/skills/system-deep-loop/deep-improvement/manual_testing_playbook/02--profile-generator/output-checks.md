...
- Prompt: `Validate that the profile generator extracts OUTPUT VERIFICATION checklist items from the debug agent.`
...
| `02--profile-generator/output-checks.md` | Canonical per-feature execution contract |
...
- Feature file path: `02--profile-generator/output-checks.md`

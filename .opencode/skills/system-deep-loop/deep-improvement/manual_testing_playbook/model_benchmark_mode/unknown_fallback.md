...
| `model-benchmark-mode/unknown-fallback.md` | Canonical per-feature execution contract |
...
| `../../assets/model_benchmark/benchmark_profiles/default.json` | Shipped benchmark profile used by this scenario |
...
- Feature file path: `model-benchmark-mode/unknown-fallback.md`

...
| `../../assets/model_benchmark/benchmark_profiles/reviewer_regression.json` | Shipped reviewer-regression profile bundling the four `reviewer-*` fixtures |
| `../../assets/model_benchmark/benchmark_fixtures/reviewer_stale_verdict.json` | Seed reviewer fixture (expected `fail`) used in this scenario |

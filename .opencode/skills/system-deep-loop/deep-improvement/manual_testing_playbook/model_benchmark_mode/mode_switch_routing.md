---
title: "MB-038 -- Mode Switch Routing via loop-host"
...
| `model-benchmark-mode/mode-switch-routing.md` | Canonical per-feature execution contract |
...
- Feature file path: `model-benchmark-mode/mode-switch-routing.md`

...
#### Test Execution
> **Feature File:** [DRV-001](../manual-testing-playbook/entry-points-and-modes/auto-mode-deep-review-kickoff.md)

### DRV-002 | Confirm mode checkpointed review

#### Description
Verify that `/deep:review:confirm` pauses at each phase for user approval before proceeding.
...
#### Test Execution
> **Feature File:** [DRV-002](../manual-testing-playbook/entry-points-and-modes/confirm-mode-checkpointed-review.md)
...
#### Test Execution
> **Feature File:** [DRV-004](../manual-testing-playbook/initialization-and-state-setup/fresh-review-initialization-creates-canonical-state-files.md)
...
#### Test Execution
> **Feature File:** [DRV-005](../manual-testing-playbook/initialization-and-state-setup/resume-classification-from-valid-prior-review-state.md)
...
#### Test Execution
> **Feature File:** [DRV-006](../manual-testing-playbook/initialization-and-state-setup/invalid-or-contradictory-review-state-halts-for-repair.md)
...
#### Test Execution
> **Feature File:** [DRV-007](../manual-testing-playbook/initialization-and-state-setup/scope-discovery-and-dimension-ordering.md)
...
#### Test Execution
> **Feature File:** [DRV-008](../manual-testing-playbook/iteration-execution-and-state-discipline/review-iteration-reads-state-before-review.md)
...
#### Test Execution
> **Feature File:** [DRV-009](../manual-testing-playbook/iteration-execution-and-state-discipline/review-iteration-writes-findings-jsonl-and-strategy-update.md)
...
#### Test Execution
> **Feature File:** [DRV-010](../manual-testing-playbook/iteration-execution-and-state-discipline/strategy-next-focus-and-dimension-rotation.md)
...
#### Test Execution
> **Feature File:** [DRV-011](../manual-testing-playbook/iteration-execution-and-state-discipline/cross-reference-verification-detects-misalignment.md)
...
#### Test Execution
> **Feature File:** [DRV-012](../manual-testing-playbook/iteration-execution-and-state-discipline/adversarial-self-check-runs-on-p0-findings.md)
...
#### Test Execution
> **Feature File:** [DRV-013](../manual-testing-playbook/iteration-execution-and-state-discipline/review-dashboard-generation-after-iteration.md)
...
#### Test Execution
> **Feature File:** [DRV-014](../manual-testing-playbook/iteration-execution-and-state-discipline/severity-classification-in-jsonl.md)
...
#### Test Execution
> **Feature File:** [DRV-015](../manual-testing-playbook/iteration-execution-and-state-discipline/graph-events-review.md)
...
#### Test Execution
> **Feature File:** [DRV-030](../manual-testing-playbook/convergence-and-recovery/stop-on-max-iterations.md)
...
#### Test Execution
> **Feature File:** [DRV-031](../manual-testing-playbook/convergence-and-recovery/composite-review-convergence-stop-behavior.md)
...
#### Test Execution
> **Feature File:** [DRV-017](../manual-testing-playbook/convergence-and-recovery/p0-override-blocks-convergence.md)
...
#### Test Execution
> **Feature File:** [DRV-018](../manual-testing-playbook/convergence-and-recovery/review-quality-guards-block-premature-stop.md)
...
#### Test Execution
> **Feature File:** [DRV-019](../manual-testing-playbook/convergence-and-recovery/stuck-recovery-widens-dimension-focus.md)
...
#### Test Execution
> **Feature File:** [DRV-020](../manual-testing-playbook/convergence-and-recovery/dimension-coverage-convergence-signal.md)
...
#### Test Execution
> **Feature File:** [DRV-032](../manual-testing-playbook/convergence-and-recovery/graph-convergence-review.md)
...
#### Test Execution
> **Feature File:** [DRV-033](../manual-testing-playbook/convergence-and-recovery/blocked-stop-reducer-surfacing.md)
...
#### Test Execution
> **Feature File:** [DRV-034](../manual-testing-playbook/convergence-and-recovery/fail-closed-reducer.md)
...
Expected signals: `deep-review-config.json` has `antiConvergence.minIterations = 2`, `convergenceMode = "default"`, and `stopPolicy = "fail-closed"`; runtime capabilities repeat fail-closed policy; the shared runtime resolver rejects missing or permissive policy; the optimizer manifest locks convergence mode and carries `minIterations<=maxIterations`.

#### Test Execution
> **Feature File:** [DRV-068](../manual-testing-playbook/convergence-and-recovery/cross-mode-anti-convergence-contract.md)
...
> **Feature File:** [RV-069](../manual-testing-playbook/convergence-and-recovery/divergent-convergence-mode.md)
...
#### Test Execution
> **Feature File:** [DRV-021](../manual-testing-playbook/pause-resume-and-fault-tolerance/pause-sentinel-halts-between-review-iterations.md)
...
#### Test Execution
> **Feature File:** [DRV-022](../manual-testing-playbook/pause-resume-and-fault-tolerance/resume-after-pause-sentinel-removal.md)
...
#### Test Execution
> **Feature File:** [DRV-023](../manual-testing-playbook/pause-resume-and-fault-tolerance/malformed-jsonl-lines-are-skipped-with-defaults.md)
...
#### Test Execution
> **Feature File:** [DRV-024](../manual-testing-playbook/pause-resume-and-fault-tolerance/jsonl-reconstruction-from-review-iteration-files.md)
...
#### Test Execution
> **Feature File:** [DRV-025](../manual-testing-playbook/synthesis-save-and-guardrails/review-report-synthesis-has-all-9-sections.md)
...
#### Test Execution
> **Feature File:** [DRV-026](../manual-testing-playbook/synthesis-save-and-guardrails/review-verdict-determines-post-review-workflow.md)
...
#### Test Execution
> **Feature File:** [DRV-027](../manual-testing-playbook/synthesis-save-and-guardrails/final-synthesis-memory-save-and-guardrail-behavior.md)
...
#### Test Execution
> **Feature File:** [DRV-028](../manual-testing-playbook/synthesis-save-and-guardrails/finding-deduplication-and-registry.md)
...
- DRV-004: [Fresh review initialization creates canonical state files](../manual-testing-playbook/initialization-and-state-setup/fresh-review-initialization-creates-canonical-state-files.md)
- DRV-005: [Resume classification from valid prior review state](../manual-testing-playbook/initialization-and-state-setup/resume-classification-from-valid-prior-review-state.md)
- DRV-006: [Invalid or contradictory review state halts for repair](../manual-testing-playbook/initialization-and-state-setup/invalid-or-contradictory-review-state-halts-for-repair.md)
- DRV-007: [Scope discovery and dimension ordering](../manual-testing-playbook/initialization-and-state-setup/scope-discovery-and-dimension-ordering.md)

### ITERATION EXECUTION AND STATE DISCIPLINE

- DRV-008: [Review iteration reads state before review](../manual-testing-playbook/iteration-execution-and-state-discipline/review-iteration-reads-state-before-review.md)
- DRV-009: [Review iteration writes findings.jsonl and strategy update](../manual-testing-playbook/iteration-execution-and-state-discipline/review-iteration-writes-findings-jsonl-and-strategy-update.md)
- DRV-010: [Strategy next-focus and dimension rotation](../manual-testing-playbook/iteration-execution-and-state-discipline/strategy-next-focus-and-dimension-rotation.md)
- DRV-011: [Cross-reference verification detects misalignment](../manual-testing-playbook/iteration-execution-and-state-discipline/cross-reference-verification-detects-misalignment.md)
- DRV-012: [Adversarial self-check runs on P0 findings](../manual-testing-playbook/iteration-execution-and-state-discipline/adversarial-self-check-runs-on-p0-findings.md)
- DRV-013: [Review dashboard generation after iteration](../manual-testing-playbook/iteration-execution-and-state-discipline/review-dashboard-generation-after-iteration.md)
- DRV-014: [Severity classification in JSONL](../manual-testing-playbook/iteration-execution-and-state-discipline/severity-classification-in-jsonl.md)
- DRV-015: [Review iterations emit structured graphEvents](../manual-testing-playbook/iteration-execution-and-state-discipline/graph-events-review.md)

### CONVERGENCE AND RECOVERY

- DRV-017: [P0 override blocks convergence](../manual-testing-playbook/convergence-and-recovery/p0-override-blocks-convergence.md)
- DRV-018: [Review quality guards block premature stop](../manual-testing-playbook/convergence-and-recovery/review-quality-guards-block-premature-stop.md)
- DRV-019: [Stuck recovery widens dimension focus](../manual-testing-playbook/convergence-and-recovery/stuck-recovery-widens-dimension-focus.md)
- DRV-020: [Dimension coverage convergence signal](../manual-testing-playbook/convergence-and-recovery/dimension-coverage-convergence-signal.md)
- DRV-030: [Stop on max iterations](../manual-testing-playbook/convergence-and-recovery/stop-on-max-iterations.md)
- DRV-031: [Composite review convergence stop behavior](../manual-testing-playbook/convergence-and-recovery/composite-review-convergence-stop-behavior.md)
- DRV-032: [Review graph convergence signals participate in legal-stop gates](../manual-testing-playbook/convergence-and-recovery/graph-convergence-review.md)
- DRV-033: [Review reducer surfaces blocked-stop history across registry, dashboard, next-focus](../manual-testing-playbook/convergence-and-recovery/blocked-stop-reducer-surfacing.md)
- DRV-034: [Review reducer fails closed on corruption and missing anchors](../manual-testing-playbook/convergence-and-recovery/fail-closed-reducer.md)
- DRV-068: [Cross-mode anti-convergence contract](../manual-testing-playbook/convergence-and-recovery/cross-mode-anti-convergence-contract.md)
- RV-069: [Divergent convergence mode](../manual-testing-playbook/convergence-and-recovery/divergent-convergence-mode.md)

### PAUSE, RESUME, AND FAULT TOLERANCE

- DRV-021: [Pause sentinel halts between review iterations](../manual-testing-playbook/pause-resume-and-fault-tolerance/pause-sentinel-halts-between-review-iterations.md)
- DRV-022: [Resume after pause sentinel removal](../manual-testing-playbook/pause-resume-and-fault-tolerance/resume-after-pause-sentinel-removal.md)
- DRV-023: [Malformed JSONL lines are skipped with defaults](../manual-testing-playbook/pause-resume-and-fault-tolerance/malformed-jsonl-lines-are-skipped-with-defaults.md)
- DRV-024: [JSONL reconstruction from review-iteration files](../manual-testing-playbook/pause-resume-and-fault-tolerance/jsonl-reconstruction-from-review-iteration-files.md)

### SYNTHESIS, SAVE, AND GUARDRAILS

- DRV-025: [Review-report synthesis has all 9 sections](../manual-testing-playbook/synthesis-save-and-guardrails/review-report-synthesis-has-all-9-sections.md)
- DRV-026: [Review verdict determines post-review workflow](../manual-testing-playbook/synthesis-save-and-guardrails/review-verdict-determines-post-review-workflow.md)
...
- CP-052: [Deep-review setup-to-YAML handoff (sandboxed)](../manual-testing-playbook/command-flow-stress-tests/setup-yaml-handoff.md)
- CP-053: [Three-artifact iteration contract (sandboxed)](../manual-testing-playbook/command-flow-stress-tests/three-artifact-iteration-contract.md)
- CP-054: [Resource-map coverage gate (sandboxed)](../manual-testing-playbook/command-flow-stress-tests/resource-map-coverage-gate.md)
- CP-055: [Synthesis and save boundary (sandboxed)](../manual-testing-playbook/command-flow-stress-tests/synthesis-save-boundary.md)
- CP-056: [LEAF-only nested dispatch refusal (sandboxed)](../manual-testing-playbook/command-flow-stress-tests/leaf-only-nested-dispatch-refusal.md)
- CP-057: [Write boundary and reducer-owned files (sandboxed)](../manual-testing-playbook/command-flow-stress-tests/write-boundary-reducer-owned-files.md)

### REVIEW-DEPTH V2 ROLLOUT

- DRV-058: [Validator warn rollout for legacy unversioned records](../manual-testing-playbook/review-depth-v2-rollout/validator-warn-rollout.md)
- DRV-059: [Validator strict v2 with all five failure codes](../manual-testing-playbook/review-depth-v2-rollout/validator-strict-v2.md)
- DRV-060: [Reducer search-debt registry + dashboard + report persistence](../manual-testing-playbook/review-depth-v2-rollout/reducer-search-debt.md)
- DRV-061: [candidateCoverageGate STOP blocker](../manual-testing-playbook/review-depth-v2-rollout/stop-gate-candidate-coverage.md)
- DRV-062: [graphlessFallbackGate STOP blocker](../manual-testing-playbook/review-depth-v2-rollout/stop-gate-graphless-fallback.md)
- DRV-063: [Ledger-led graph vocabulary upserts (BUG_CLASS / INVARIANT / PRODUCER / CONSUMER / TEST)](../manual-testing-playbook/review-depth-v2-rollout/graph-vocabulary.md)

---

## 15. COMMAND FLOW STRESS TESTS

This category covers 6 sandboxed stress-test scenarios that exercise the full command-to-runtime handoff against a synthetic spec folder under `/tmp/cp-deep-review-sandbox`. Setup uses `command-flow-stress-tests/setup-cp-sandbox.sh`. Each scenario validates a single contract boundary in isolation.
...
#### Test Execution
> **Feature File:** [CP-052](../manual-testing-playbook/command-flow-stress-tests/setup-yaml-handoff.md)
...
#### Test Execution
> **Feature File:** [CP-053](../manual-testing-playbook/command-flow-stress-tests/three-artifact-iteration-contract.md)
...
#### Test Execution
> **Feature File:** [CP-054](../manual-testing-playbook/command-flow-stress-tests/resource-map-coverage-gate.md)
...
#### Test Execution
> **Feature File:** [CP-055](../manual-testing-playbook/command-flow-stress-tests/synthesis-save-boundary.md)
...
#### Test Execution
> **Feature File:** [CP-056](../manual-testing-playbook/command-flow-stress-tests/leaf-only-nested-dispatch-refusal.md)
...
#### Test Execution
> **Feature File:** [CP-057](../manual-testing-playbook/command-flow-stress-tests/write-boundary-reducer-owned-files.md)
...
#### Test Execution
> **Feature File:** [DRV-058](../manual-testing-playbook/review-depth-v2-rollout/validator-warn-rollout.md)
...
#### Test Execution
> **Feature File:** [DRV-059](../manual-testing-playbook/review-depth-v2-rollout/validator-strict-v2.md)
...
#### Test Execution
> **Feature File:** [DRV-060](../manual-testing-playbook/review-depth-v2-rollout/reducer-search-debt.md)
...
#### Test Execution
> **Feature File:** [DRV-061](../manual-testing-playbook/review-depth-v2-rollout/stop-gate-candidate-coverage.md)
...
#### Test Execution
> **Feature File:** [DRV-062](../manual-testing-playbook/review-depth-v2-rollout/stop-gate-graphless-fallback.md)
...
#### Test Execution
> **Feature File:** [DRV-063](../manual-testing-playbook/review-depth-v2-rollout/graph-vocabulary.md)
...
#### Test Execution
> **Feature File:** [DRV-064](../manual-testing-playbook/fanout/fanout-cli-lineages-review.md)
...
#### Test Execution
> **Feature File:** [DRV-065](../manual-testing-playbook/fanout/fanout-strongest-restriction.md)
...
#### Test Execution
> **Feature File:** [DRV-066](../manual-testing-playbook/fanout/fanout-native-sequential-review.md)
...
#### Test Execution
> **Feature File:** [DRV-067](../manual-testing-playbook/fanout/fanout-single-executor-parity-review.md)

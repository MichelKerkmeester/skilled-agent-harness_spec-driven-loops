...
### Failure Triage
Check the review-mode-contract.yaml for the full cross-reference protocol definitions and verify the YAML step_order_dimensions derives the traceability protocol plan.
---

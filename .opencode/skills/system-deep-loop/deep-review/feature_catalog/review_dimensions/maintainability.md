...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/initialization_and_state_setup/scope_discovery_and_dimension_ordering.md` | Manual scenario | Verifies maintainability appears in the default dimension ordering. |
| `manual_testing_playbook/convergence_and_recovery/stuck_recovery_widens_dimension_focus.md` | Manual scenario | Confirms recovery pivots toward less-covered dimensions such as maintainability. |
| `manual_testing_playbook/convergence_and_recovery/dimension_coverage_convergence_signal.md` | Manual scenario | Verifies maintainability is still required for the full stop signal. |

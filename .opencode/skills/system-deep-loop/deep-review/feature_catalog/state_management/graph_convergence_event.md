...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/convergence_and_recovery/graph_convergence_review.md` | Manual scenario | Verifies the graph convergence event gates the STOP decision. |
| `manual_testing_playbook/iteration_execution_and_state_discipline/graph_events_review.md` | Manual scenario | Verifies graph events are emitted and consumed for review-aware coverage. |
...
- [pause-sentinel.md](../state_management/pause_sentinel.md) — Pause sentinel

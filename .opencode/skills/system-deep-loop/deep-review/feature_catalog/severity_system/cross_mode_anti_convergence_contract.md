...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/convergence_and_recovery/cross_mode_anti_convergence_contract.md` | Manual scenario | Verifies the review-facing config, runtime matrix, resolver, and optimizer invariant anchors. |
...
- Primary sources: `assets/deep_review_config.json`, `assets/runtime_capabilities.json`, `.opencode/skills/system-deep-loop/runtime/lib/deep-loop/runtime-capabilities.cjs`, `.opencode/skills/system-spec-kit/scripts/optimizer/optimizer-manifest.json`

Related references:
- [quality-gates.md](../severity_system/quality_gates.md) - Quality gates
- [convergence-signals.md](../severity_system/convergence_signals.md) - Semantic convergence signals

...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/convergence-and-recovery/cross-mode-anti-convergence-contract.md` | Manual scenario | Verifies the review-facing config, runtime matrix, resolver, and optimizer invariant anchors. |

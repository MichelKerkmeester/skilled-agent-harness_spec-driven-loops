...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/iteration-execution-and-state-discipline/adversarial-self-check-runs-on-p0-findings.md` | Manual scenario | Verifies the blocker re-check path is executed. |
| `manual_testing_playbook/convergence-and-recovery/p0-override-blocks-convergence.md` | Manual scenario | Confirms confirmed P0 findings still block stop after the self-check path. |
...
- [claim-adjudication.md](claim-adjudication.md) — Claim adjudication

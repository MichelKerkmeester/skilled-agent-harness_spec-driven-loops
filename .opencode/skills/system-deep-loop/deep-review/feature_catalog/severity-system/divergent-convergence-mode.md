...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-deep-loop/deep-review/manual_testing_playbook/convergence-and-recovery/divergent-convergence-mode.md` | Manual playbook | Verifies pivot eligibility, verdict isolation, security-gate preservation, and read-only behavior. |

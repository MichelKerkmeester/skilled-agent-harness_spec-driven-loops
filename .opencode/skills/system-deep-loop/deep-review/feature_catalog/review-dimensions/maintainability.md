...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/initialization-and-state-setup/scope-discovery-and-dimension-ordering.md` | Manual scenario | Verifies maintainability appears in the default dimension ordering. |
| `manual_testing_playbook/convergence-and-recovery/stuck-recovery-widens-dimension-focus.md` | Manual scenario | Confirms recovery pivots toward less-covered dimensions such as maintainability. |
| `manual_testing_playbook/convergence-and-recovery/dimension-coverage-convergence-signal.md` | Manual scenario | Verifies maintainability is still required for the full stop signal. |

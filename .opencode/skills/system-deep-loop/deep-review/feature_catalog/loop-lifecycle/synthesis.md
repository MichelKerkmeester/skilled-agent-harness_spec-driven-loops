...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/synthesis-save-and-guardrails/review-report-synthesis-has-all-9-sections.md` | Manual scenario | Verifies the report structure and synthesis output. |
| `manual_testing_playbook/synthesis-save-and-guardrails/review-verdict-determines-post-review-workflow.md` | Manual scenario | Confirms verdict routing after synthesis. |
| `manual_testing_playbook/synthesis-save-and-guardrails/finding-deduplication-and-registry.md` | Manual scenario | Exercises synthesis-time deduplication and registry alignment. |

...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/synthesis-save-and-guardrails/final-synthesis-memory-save-and-guardrail-behavior.md` | Manual scenario | Verifies post-synthesis continuity save behavior and guardrails. |

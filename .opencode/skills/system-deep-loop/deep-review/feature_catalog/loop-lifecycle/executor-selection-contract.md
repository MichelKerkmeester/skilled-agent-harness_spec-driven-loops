...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/entry-points-and-modes/parameterized-invocation-max-iterations-convergence.md` | Manual scenario | Exercises parameterized invocation paths that feed executor config. |
| `manual_testing_playbook/command-flow-stress-tests/write-boundary-reducer-owned-files.md` | Manual scenario | Confirms executor write boundaries against reducer-owned files. |

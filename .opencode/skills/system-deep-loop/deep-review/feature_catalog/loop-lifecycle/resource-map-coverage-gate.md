...
| `feature_catalog/loop-lifecycle/resource-map-emission.md` | Catalog | Companion feature that emits the resource-map coverage data this gate reports on. |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/command-flow-stress-tests/resource-map-coverage-gate.md` | Manual scenario | Verifies the coverage gate section appears only when a resource map is present. |
| `manual_testing_playbook/synthesis-save-and-guardrails/resource-map-emission.md` | Manual scenario | Verifies resource-map coverage data is emitted during synthesis. |

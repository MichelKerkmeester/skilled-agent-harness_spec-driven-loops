...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-deep-loop/deep-review/manual_testing_playbook/04--convergence-and-recovery/divergent-convergence-mode.md` | Manual playbook | Verifies pivot eligibility, verdict isolation, security-gate preservation, and read-only behavior. |
...
- Feature file path: `04--severity-system/divergent-convergence-mode.md`

Related references:
- [cross-mode-anti-convergence-contract.md](cross-mode-anti-convergence-contract.md) - Shared review floor and stop policy
- [quality-gates.md](quality-gates.md) - Review legal-stop gates

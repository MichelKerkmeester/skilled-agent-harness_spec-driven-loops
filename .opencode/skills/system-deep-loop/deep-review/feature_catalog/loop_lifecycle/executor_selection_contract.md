...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/entry_points_and_modes/parameterized_invocation_max_iterations_convergence.md` | Manual scenario | Exercises parameterized invocation paths that feed executor config. |
| `manual_testing_playbook/command_flow_stress_tests/write_boundary_reducer_owned_files.md` | Manual scenario | Confirms executor write boundaries against reducer-owned files. |
...
Related references:
- [resource-map-coverage-gate.md](../loop_lifecycle/resource_map_coverage_gate.md) — Resource Map Coverage Gate

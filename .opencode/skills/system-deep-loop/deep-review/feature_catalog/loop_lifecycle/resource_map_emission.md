...
| `.opencode/skills/system-deep-loop/deep-review/manual_testing_playbook/synthesis_save_and_guardrails/resource_map_emission.md` | Manual playbook | Verifies synthesis emits the review resource map and that opt-out skips cleanly. |

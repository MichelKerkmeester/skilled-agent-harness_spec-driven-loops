...
| `feature_catalog/loop_lifecycle/resource_map_emission.md` | Catalog | Companion feature that emits the resource-map coverage data this gate reports on. |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/command_flow_stress_tests/resource_map_coverage_gate.md` | Manual scenario | Verifies the coverage gate section appears only when a resource map is present. |
| `manual_testing_playbook/synthesis_save_and_guardrails/resource_map_emission.md` | Manual scenario | Verifies resource-map coverage data is emitted during synthesis. |

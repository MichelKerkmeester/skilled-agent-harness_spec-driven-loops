...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/synthesis_save_and_guardrails/review_report_synthesis_has_all_9_sections.md` | Manual scenario | Verifies the report structure and synthesis output. |
| `manual_testing_playbook/synthesis_save_and_guardrails/review_verdict_determines_post_review_workflow.md` | Manual scenario | Confirms verdict routing after synthesis. |
| `manual_testing_playbook/synthesis_save_and_guardrails/finding_deduplication_and_registry.md` | Manual scenario | Exercises synthesis-time deduplication and registry alignment. |
...
- [memory-save.md](../loop_lifecycle/memory_save.md) — Memory save

...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/synthesis_save_and_guardrails/final_synthesis_memory_save_and_guardrail_behavior.md` | Manual scenario | Verifies post-synthesis continuity save behavior and guardrails. |

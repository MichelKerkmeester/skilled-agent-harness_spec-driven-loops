...
Related references:
- [cross-mode-anti-convergence-contract.md](../../feature-catalog/severity-system/cross-mode-anti-convergence-contract.md) - Shared review floor and stop policy
- [quality-gates.md](../../feature-catalog/severity-system/quality-gates.md) - Review legal-stop gates

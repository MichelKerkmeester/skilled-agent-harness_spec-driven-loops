...
See [`loop-lifecycle/initialization.md`](loop-lifecycle/initialization.md) for full implementation and validation file listings.
...
See [`loop-lifecycle/iteration-dispatch.md`](../feature-catalog/loop-lifecycle/iteration-dispatch.md) for full implementation and validation file listings.
...
See [`loop-lifecycle/synthesis.md`](loop-lifecycle/synthesis.md) for full implementation and validation file listings.
...
See [`loop-lifecycle/memory-save.md`](../feature-catalog/loop-lifecycle/memory-save.md) for full implementation and validation file listings.
...
See [`loop-lifecycle/resource-map-emission.md`](../feature-catalog/loop-lifecycle/resource-map-emission.md) for full implementation and validation file listings.
...
See [`loop-lifecycle/resource-map-coverage-gate.md`](../feature-catalog/loop-lifecycle/resource-map-coverage-gate.md) for full implementation and validation file listings.
...
`parseExecutorConfig` resolves `config.executor.kind` into one of three dispatch branches (`native`, `cli-opencode`, `cli-claude-code`). Unsupported flags throw `ExecutorConfigError` at parse time. All branches share prompt rendering, output validation, and executor audit append.

#### Source Files

See [`loop-lifecycle/executor-selection-contract.md`](../feature-catalog/loop-lifecycle/executor-selection-contract.md) for full implementation and validation file listings.
...
See [`loop-lifecycle/fanout-dispatch.md`](../feature-catalog/loop-lifecycle/fanout-dispatch.md) for full implementation and validation file listings.
...
See [`state-management/jsonl-state-log.md`](../feature-catalog/state-management/jsonl-state-log.md) for full implementation and validation file listings.
...
See [`state-management/strategy-tracking.md`](../feature-catalog/state-management/strategy-tracking.md) for full implementation and validation file listings.
...
See [`state-management/config-management.md`](../feature-catalog/state-management/config-management.md) for full implementation and validation file listings.
...
See [`state-management/findings-registry.md`](../feature-catalog/state-management/findings-registry.md) for full implementation and validation file listings.
...
See [`state-management/dashboard.md`](state-management/dashboard.md) for full implementation and validation file listings.
...
See [`state-management/graph-convergence-event.md`](../feature-catalog/state-management/graph-convergence-event.md) for full implementation and validation file listings.
...
See [`state-management/pause-sentinel.md`](../feature-catalog/state-management/pause-sentinel.md) for full implementation and validation file listings.
...
See [`review-dimensions/correctness.md`](review-dimensions/correctness.md) for full implementation and validation file listings.
...
See [`review-dimensions/security.md`](review-dimensions/security.md) for full implementation and validation file listings.
...
See [`review-dimensions/traceability.md`](review-dimensions/traceability.md) for full implementation and validation file listings.
...
See [`severity-system/severity-classification.md`](../feature-catalog/severity-system/severity-classification.md) for full implementation and validation file listings.
...
See [`severity-system/adversarial-self-check.md`](../feature-catalog/severity-system/adversarial-self-check.md) for full implementation and validation file listings.
...
See [`severity-system/claim-adjudication.md`](../feature-catalog/severity-system/claim-adjudication.md) for full implementation and validation file listings.
...
See [`severity-system/verdicts.md`](severity-system/verdicts.md) for full implementation and validation file listings.
...
See [`severity-system/quality-gates.md`](../feature-catalog/severity-system/quality-gates.md) for full implementation and validation file listings.
...
`deep-review-config.json` declares `antiConvergence.minIterations = 2`, `convergenceMode = "default"`, and `stopPolicy = "fail-closed"`. The runtime capability matrix repeats the fail-closed policy, the shared resolver rejects missing or permissive policy, and the optimizer manifest locks convergence mode while rejecting `minIterations > maxIterations` candidates.

#### Source Files

See [`severity-system/cross-mode-anti-convergence-contract.md`](../feature-catalog/severity-system/cross-mode-anti-convergence-contract.md) for full implementation and validation file listings.
...
See [`severity-system/divergent-convergence-mode.md`](../feature-catalog/severity-system/divergent-convergence-mode.md) for full implementation and validation file listings.
...
See [`severity-system/convergence-signals.md`](../feature-catalog/severity-system/convergence-signals.md) for full implementation and validation file listings.
...
See [`severity-system/security-sensitive-fix-overrides.md`](../feature-catalog/severity-system/security-sensitive-fix-overrides.md) for full implementation and validation file listings.

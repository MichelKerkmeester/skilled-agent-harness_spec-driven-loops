...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/runtime/tests/resource-map-extractor.vitest.ts` | Vitest | Covers review-shape normalization, category classification, and deterministic output. |

...
| `references/adapters/sk_git_adapter.md` | Reference | Full specification: branch discovery scoping (Section 3), the body-required discrepancy (Section 8), the determinism statement (Section 4.3). |
| `references/adapters/sk_git_known_deviations.md` | Reference | The two structural exemptions plus the legacy pre-hook scope suppression rule (Section 4/6 fenced JSON). |
...
- Primary sources: `scripts/adapters/sk-git.cjs`, `references/adapters/sk_git_adapter.md`, `references/adapters/sk_git_known_deviations.md`
Related references:
- [adapter-sk-doc.md](adapter-sk-doc.md) — sk-doc adapter
- [adapter-sk-design.md](adapter-sk-design.md) — sk-design adapter
- [../lane-resolution/scope-types.md](../lane-resolution/scope-types.md) — Scope types

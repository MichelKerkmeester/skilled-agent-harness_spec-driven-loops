...
| `references/scoping_protocol.md` | Reference | Section 2.1 defines each artifact-class value and why it is asked first. |
| `references/lane_config_schema.md` | Reference | Section 3/4 enumerates the four values and the authority-to-class validity table. |
...
Related references:
- [scoping-tree.md](../lane_resolution/scoping_tree.md) — Scoping tree

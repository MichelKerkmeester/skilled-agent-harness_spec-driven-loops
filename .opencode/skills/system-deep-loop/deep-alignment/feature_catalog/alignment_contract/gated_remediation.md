...
| `references/state_machine_wiring.md` | Reference | Section 7 documents the REMEDIATE hook point as a callable proof of a safe transition, not remediation logic. |
| `assets/deep_alignment_config_template.json` | Template | The `remediateHookScriptPath` entry wiring the state to this script. |
...
- Primary sources: `scripts/remediate-hook.cjs`, `SKILL.md`, `references/state_machine_wiring.md`
Related references:
- [read-only-default.md](../alignment_contract/read_only_default.md) — Read-only default
- [../loop-lifecycle/state-machine.md](../loop_lifecycle/state_machine.md) — State machine

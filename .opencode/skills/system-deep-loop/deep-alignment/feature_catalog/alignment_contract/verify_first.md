...
Related references:
- [known-deviation-suppression.md](../alignment_contract/known_deviation_suppression.md) — Known-deviation suppression
- [read-only-default.md](../alignment_contract/read_only_default.md) — Read-only default
- [../adapter-contract/check.md](../adapter_contract/check.md) — check(artifact, rules)

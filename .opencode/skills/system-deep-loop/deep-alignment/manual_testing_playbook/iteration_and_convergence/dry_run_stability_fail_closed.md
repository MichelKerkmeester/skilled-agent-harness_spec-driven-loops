...
| `.opencode/skills/system-deep-loop/deep-alignment/references/state_machine_wiring.md` | §4 dry-run stability definition ("fresh run can never converge on its first iteration") |

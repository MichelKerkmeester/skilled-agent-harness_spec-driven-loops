...
3. `bash: node .opencode/skills/system-deep-loop/deep-alignment/scripts/adapters/sk-doc.cjs check .opencode/skills/system-deep-loop/deep-alignment/references/discover_contract.md`
...
| `.opencode/skills/system-deep-loop/deep-alignment/references/adapters/sk_doc_adapter.md` | Full adapter specification (classifier provenance, two-layer check) |

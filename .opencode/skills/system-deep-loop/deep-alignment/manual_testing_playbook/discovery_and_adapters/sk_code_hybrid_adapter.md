...
| `.opencode/skills/system-deep-loop/deep-alignment/references/adapters/sk_code_adapter.md` | Full adapter specification incl. the excluded-minifier rationale and layer split |

...
2. `bash: rg -n 'maxIterations|coverageThreshold|stabilityWindow|combination|executionMode' .opencode/skills/system-deep-loop/deep-alignment/assets/deep_alignment_config_template.json`
...
| `.opencode/skills/system-deep-loop/deep-alignment/assets/deep_alignment_config_template.json` | `maxIterations`, `convergence` object, `executionMode` defaults |

...
| `.opencode/skills/system-deep-loop/deep-alignment/references/lane_config_schema.md` | §4 authority->artifact-class validity table; §8 error contract |
| `.opencode/skills/system-deep-loop/deep-alignment/references/scoping_protocol.md` | §2.2 AUTHORITY axis and extensibility |

...
3. `bash: rg -n 'MACHINE-READABLE|status.*active|status.*dormant|loadKnownDeviations|single source of truth' .opencode/skills/system-deep-loop/deep-alignment/references/adapters/sk_doc_known_deviations.md`
### Expected
...
| `.opencode/skills/system-deep-loop/deep-alignment/references/adapters/sk_doc_known_deviations.md` | The single-source list (active/dormant labels, §8 machine block) |
| `.opencode/skills/system-deep-loop/deep-alignment/references/adapters/sk_git_known_deviations.md` | sk-git's per-authority list |

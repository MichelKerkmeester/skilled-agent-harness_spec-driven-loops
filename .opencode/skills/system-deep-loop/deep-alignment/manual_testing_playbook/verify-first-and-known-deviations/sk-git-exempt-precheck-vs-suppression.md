...
4. `bash: rg -n 'Merge|Revert|fixup|squash|amend|requiresCommitBeforeHookInstall' .opencode/skills/system-deep-loop/deep-alignment/references/adapters/sk_git_known_deviations.md`
### Expected
...
| `.opencode/skills/system-deep-loop/deep-alignment/references/adapters/sk_git_known_deviations.md` | sk-git's known-deviation list (dated pre-hook-install entry, not the exempt prefixes) |

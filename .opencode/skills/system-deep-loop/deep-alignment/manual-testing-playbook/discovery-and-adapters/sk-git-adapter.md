...
| `.opencode/skills/system-deep-loop/deep-alignment/references/adapters/sk-git-adapter.md` | Full adapter specification incl. the staging-vs-historical body-rule discrepancy |

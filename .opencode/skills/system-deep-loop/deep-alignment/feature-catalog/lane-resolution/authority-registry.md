...
| `references/scoping-protocol.md` | Reference | Section 2.2 documents the authority axis, the determinism ordering, and the extensibility rule. |
| `references/lane-config-schema.md` | Reference | Section 4 restates the authority-to-artifact-class validity table and the parse-time enforcement. |

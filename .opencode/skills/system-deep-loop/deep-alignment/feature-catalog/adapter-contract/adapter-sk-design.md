...
| `.opencode/skills/sk-design/sk-design-md-generator/references/design-md-format.md` | Standard source | The Style Reference schema and cardinal rules the structural layer checks against. |

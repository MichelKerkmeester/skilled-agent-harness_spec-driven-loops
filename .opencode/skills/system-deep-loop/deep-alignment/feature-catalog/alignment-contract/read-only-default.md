...
- Primary sources: `SKILL.md`, `scripts/adapters/sk-code.cjs`, `assets/deep-alignment-config-template.json`
Related references:
- [verify-first.md](../../feature-catalog/alignment-contract/verify-first.md) — Verify-first
- [gated-remediation.md](../../feature-catalog/alignment-contract/gated-remediation.md) — Gated remediation

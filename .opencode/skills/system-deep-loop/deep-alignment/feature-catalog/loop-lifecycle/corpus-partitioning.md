...
| `references/state-machine-wiring.md` | Reference | Section 6 documents the lane round-robin and its distinction from deep-review's fixed rotation. |
...
- Primary sources: `scripts/partition-corpus.cjs`, `runtime/scripts/reduce-alignment-state.cjs`, `references/state-machine-wiring.md`
Related references:

...
Reading all three sources side by side (`core_standards.md` Section 3's table, `extract_structure.py:617-653` and `validate_document.py:119-163`) shows they are **not** the same classifier. This is a real, load-bearing discrepancy this adapter surfaces rather than quietly picks a winner for:

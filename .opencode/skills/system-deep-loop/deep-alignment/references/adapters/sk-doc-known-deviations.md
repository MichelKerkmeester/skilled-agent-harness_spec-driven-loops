...
- `.opencode/hooks/dispatch/codex/dispatch-preflight-lint.mjs:10` and `.opencode/hooks/dispatch/lib/dispatch-rule-checks.mjs:3,22,33` (relocated from `cli-opencode/scripts/{hooks,lib}/` 2026-07-28), the field is actively read and enforced by real, live dispatch tooling, not vestigial.

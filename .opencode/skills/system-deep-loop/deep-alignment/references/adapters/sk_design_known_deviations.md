...
**Not a dumping ground**: every entry here traces to `design_md_format.md`'s own explicit, cited prose — the same document this authority's structural checker implements — not an invented convention. All three are honestly labeled dormant-by-construction rather than presented as if they were actively firing and being suppressed.

...
- Contract: [`command-surface/conformance_benchmark.md`](./command-surface/conformance_benchmark.md)
...
- [`command-surface/conformance_benchmark.md`](./command-surface/conformance_benchmark.md) — the per-benchmark purpose, scope, inputs, validity gates, and ownership boundary.

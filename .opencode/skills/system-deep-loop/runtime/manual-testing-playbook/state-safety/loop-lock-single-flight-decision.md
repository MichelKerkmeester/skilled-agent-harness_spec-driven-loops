...
- Feature catalog entry exists at `feature-catalog/state-safety/loop-lock-single-flight-decision.md`.
...
- Group: State safety
- Playbook ID: DLR-037
- Feature catalog entry: `feature-catalog/state-safety/loop-lock-single-flight-decision.md`
- Scenario file path: `manual-testing-playbook/state-safety/loop-lock-single-flight-decision.md`

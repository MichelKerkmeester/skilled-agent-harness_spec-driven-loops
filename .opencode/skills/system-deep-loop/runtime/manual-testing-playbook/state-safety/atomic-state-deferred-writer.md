...
- Feature catalog entry exists at `feature-catalog/state-safety/atomic-state-deferred-writer.md`.
...
- Group: State safety
- Playbook ID: DLR-032
- Feature catalog entry: `feature-catalog/state-safety/atomic-state-deferred-writer.md`
- Scenario file path: `manual-testing-playbook/state-safety/atomic-state-deferred-writer.md`

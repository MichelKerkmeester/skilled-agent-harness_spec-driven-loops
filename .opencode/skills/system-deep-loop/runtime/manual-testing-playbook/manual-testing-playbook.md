...
This playbook provides 53 deterministic scenarios across 12 categories validating the current `runtime/` skill surface. Each scenario maps to one feature catalog entry and one dedicated scenario file with objective, prompt, execution steps, source anchors, and verdict criteria.
...
#### Test Execution
> **Feature File:** [DLR-001](../manual-testing-playbook/executor/executor-config.md)
...
#### Test Execution
> **Feature File:** [DLR-002](../manual-testing-playbook/executor/executor-audit.md)
...
#### Test Execution
> **Feature File:** [DLR-003](../manual-testing-playbook/executor/fallback-router.md)
...
#### Test Execution
> **Feature File:** [DLR-044](../manual-testing-playbook/executor/fallback-router-typed-reroute.md)
...
#### Test Execution
> **Feature File:** [DLR-004](../manual-testing-playbook/prompt-rendering/prompt-pack.md)
...
#### Test Execution
> **Feature File:** [DLR-005](../manual-testing-playbook/validation/post-dispatch-validate.md)
...
#### Test Execution
> **Feature File:** [DLR-045](../manual-testing-playbook/validation/llm-judge-hardening.md)
...
#### Test Execution
> **Feature File:** [DLR-006](../manual-testing-playbook/state-safety/atomic-state.md)
...
#### Test Execution
> **Feature File:** [DLR-007](../manual-testing-playbook/state-safety/jsonl-repair.md)
...
#### Test Execution
> **Feature File:** [DLR-008](../manual-testing-playbook/state-safety/loop-lock.md)
...
#### Test Execution
> **Feature File:** [DLR-009](../manual-testing-playbook/state-safety/permissions-gate.md)
...
#### Test Execution
> **Feature File:** [DLR-030](../manual-testing-playbook/state-safety/atomic-state-serialize-diff.md)
...
#### Test Execution
> **Feature File:** [DLR-031](../manual-testing-playbook/state-safety/atomic-state-integrity-helpers.md)
...
#### Test Execution
> **Feature File:** [DLR-032](../manual-testing-playbook/state-safety/atomic-state-deferred-writer.md)
...
#### Test Execution
> **Feature File:** [DLR-035](../manual-testing-playbook/state-safety/jsonl-lock-held-merge.md)
...
#### Test Execution
> **Feature File:** [DLR-036](../manual-testing-playbook/state-safety/loop-lock-heartbeat-hardening.md)
...
#### Test Execution
> **Feature File:** [DLR-010](../manual-testing-playbook/scoring/bayesian-scorer.md)
...
#### Test Execution
> **Feature File:** [DLR-011](../manual-testing-playbook/coverage-graph/coverage-graph-db.md)
...
#### Test Execution
> **Feature File:** [DLR-012](../manual-testing-playbook/coverage-graph/coverage-graph-query.md)
...
#### Test Execution
> **Feature File:** [DLR-013](../manual-testing-playbook/coverage-graph/coverage-graph-signals.md)
...
#### Test Execution
> **Feature File:** [DLR-041](../manual-testing-playbook/coverage-graph/observation-threshold-guard.md)
...
#### Test Execution
> **Feature File:** [DLR-042](../manual-testing-playbook/coverage-graph/coverage-graph-time-decay.md)
...
#### Test Execution
> **Feature File:** [DLR-043](../manual-testing-playbook/coverage-graph/coverage-graph-fuzzy-merge.md)
...
#### Test Execution
> **Feature File:** [DLR-014](../manual-testing-playbook/script-entry-points/convergence-script.md)
...
#### Test Execution
> **Feature File:** [DLR-015](../manual-testing-playbook/script-entry-points/upsert-script.md)
...
#### Test Execution
> **Feature File:** [DLR-016](../manual-testing-playbook/script-entry-points/query-script.md)
...
#### Test Execution
> **Feature File:** [DLR-018](../manual-testing-playbook/council/multi-seat-dispatch.md)
...
#### Test Execution
> **Feature File:** [DLR-019](../manual-testing-playbook/council/round-state-jsonl.md)
...
#### Test Execution
> **Feature File:** [DLR-020](../manual-testing-playbook/council/adjudicator-verdict-scoring.md)
...
#### Test Execution
> **Feature File:** [DLR-021](../manual-testing-playbook/council/cost-guards.md)
...
#### Test Execution
> **Feature File:** [DLR-022](../manual-testing-playbook/council/session-state-hierarchy.md)
...
#### Test Execution
> **Feature File:** [DLR-023](../manual-testing-playbook/fanout/fanout-config-schema.md)
...
#### Test Execution
> **Feature File:** [DLR-024](../manual-testing-playbook/fanout/fanout-pool-concurrency-cap.md)
...
#### Test Execution
> **Feature File:** [DLR-025](../manual-testing-playbook/fanout/fanout-run-cli-lineage-spawn.md)
...
#### Test Execution
> **Feature File:** [DLR-026](../manual-testing-playbook/fanout/fanout-salvage-recovery.md)
...
#### Test Execution
> **Feature File:** [DLR-027](../manual-testing-playbook/fanout/fanout-merge-research.md)
...
#### Test Execution
> **Feature File:** [DLR-028](../manual-testing-playbook/fanout/fanout-merge-review-strongest-restriction.md)
...
#### Test Execution
> **Feature File:** [DLR-029](../manual-testing-playbook/fanout/artifact-dir-override-parity.md)
...
#### Test Execution
> **Feature File:** [DLR-039](../manual-testing-playbook/fanout/fixed-rate-overrun-accounting.md)
...
#### Test Execution
> **Feature File:** [DLR-046](../manual-testing-playbook/fanout/fanout-stall-watchdog.md)
...
#### Test Execution
> **Feature File:** [DLR-033](../manual-testing-playbook/lifecycle/abortable-chunked-sleep.md)
...
#### Test Execution
> **Feature File:** [DLR-034](../manual-testing-playbook/lifecycle/lifecycle-taxonomy-guards.md)
...
#### Test Execution
> **Feature File:** [DLR-038](../manual-testing-playbook/observability/byte-offset-log-regions.md)
...
#### Test Execution
> **Feature File:** [DLR-048](../manual-testing-playbook/observability/single-loop-telemetry-heartbeat.md)
...
#### Test Execution
> **Feature File:** [DLR-049](../manual-testing-playbook/observability/unified-observability-event-envelope.md)
...
#### Test Execution
> **Feature File:** [DLR-050](../manual-testing-playbook/testing/hermetic-test-isolation.md)
...
#### Test Execution
> **Feature File:** [DLR-051](../manual-testing-playbook/testing/record-replay-cassette-harness.md)
...
|---|---|---|
| DLR-001 | [F001 Executor config](../feature-catalog/executor/executor-config.md) | [executor/executor-config.md](../manual-testing-playbook/executor/executor-config.md) |
| DLR-002 | [F002 Executor audit](../feature-catalog/executor/executor-audit.md) | [executor/executor-audit.md](../manual-testing-playbook/executor/executor-audit.md) |
| DLR-003 | [F003 Fallback router](../feature-catalog/executor/fallback-router.md) | [executor/fallback-router.md](../manual-testing-playbook/executor/fallback-router.md) |
| DLR-004 | [F004 Prompt pack](../feature-catalog/prompt-rendering/prompt-pack.md) | [prompt-rendering/prompt-pack.md](../manual-testing-playbook/prompt-rendering/prompt-pack.md) |
| DLR-005 | [F005 Post-dispatch validate](../feature-catalog/validation/post-dispatch-validate.md) | [validation/post-dispatch-validate.md](../manual-testing-playbook/validation/post-dispatch-validate.md) |
| DLR-006 | [F006 Atomic state](../feature-catalog/state-safety/atomic-state.md) | [state-safety/atomic-state.md](../manual-testing-playbook/state-safety/atomic-state.md) |
| DLR-007 | [F007 JSONL repair](../feature-catalog/state-safety/jsonl-repair.md) | [state-safety/jsonl-repair.md](../manual-testing-playbook/state-safety/jsonl-repair.md) |
| DLR-008 | [F008 Loop lock](../feature-catalog/state-safety/loop-lock.md) | [state-safety/loop-lock.md](../manual-testing-playbook/state-safety/loop-lock.md) |
| DLR-009 | [F009 Permissions gate](../feature-catalog/state-safety/permissions-gate.md) | [state-safety/permissions-gate.md](../manual-testing-playbook/state-safety/permissions-gate.md) |
| DLR-010 | [F010 Bayesian scorer](../feature-catalog/scoring/bayesian-scorer.md) | [scoring/bayesian-scorer.md](../manual-testing-playbook/scoring/bayesian-scorer.md) |
| DLR-011 | [F011 Coverage graph DB](../feature-catalog/coverage-graph/coverage-graph-db.md) | [coverage-graph/coverage-graph-db.md](../manual-testing-playbook/coverage-graph/coverage-graph-db.md) |
| DLR-012 | [F012 Coverage graph query](../feature-catalog/coverage-graph/coverage-graph-query.md) | [coverage-graph/coverage-graph-query.md](../manual-testing-playbook/coverage-graph/coverage-graph-query.md) |
| DLR-013 | [F013 Coverage graph signals](../feature-catalog/coverage-graph/coverage-graph-signals.md) | [coverage-graph/coverage-graph-signals.md](../manual-testing-playbook/coverage-graph/coverage-graph-signals.md) |
| DLR-014 | [F014 convergence.cjs](../feature-catalog/script-entry-points/convergence-script.md) | [script-entry-points/convergence-script.md](../manual-testing-playbook/script-entry-points/convergence-script.md) |
| DLR-015 | [F015 upsert.cjs](../feature-catalog/script-entry-points/upsert-script.md) | [script-entry-points/upsert-script.md](../manual-testing-playbook/script-entry-points/upsert-script.md) |
| DLR-016 | [F016 query.cjs](../feature-catalog/script-entry-points/query-script.md) | [script-entry-points/query-script.md](../manual-testing-playbook/script-entry-points/query-script.md) |
| DLR-017 | [F017 status.cjs](../feature-catalog/script-entry-points/status-script.md) | [script-entry-points/status-script.md](../manual-testing-playbook/script-entry-points/status-script.md) |
| DLR-018 | [F018 Multi-seat dispatch](../feature-catalog/council/multi-seat-dispatch.md) | [council/multi-seat-dispatch.md](../manual-testing-playbook/council/multi-seat-dispatch.md) |
| DLR-019 | [F019 Round-state JSONL](../feature-catalog/council/round-state-jsonl.md) | [council/round-state-jsonl.md](../manual-testing-playbook/council/round-state-jsonl.md) |
| DLR-020 | [F020 Adjudicator verdict scoring](../feature-catalog/council/adjudicator-verdict-scoring.md) | [council/adjudicator-verdict-scoring.md](../manual-testing-playbook/council/adjudicator-verdict-scoring.md) |
| DLR-021 | [F021 Cost guards](../feature-catalog/council/cost-guards.md) | [council/cost-guards.md](../manual-testing-playbook/council/cost-guards.md) |
| DLR-022 | [F022 Session state hierarchy](../feature-catalog/council/session-state-hierarchy.md) | [council/session-state-hierarchy.md](../manual-testing-playbook/council/session-state-hierarchy.md) |
| DLR-023 | [F023 Fan-out config schema](../feature-catalog/fanout/fanout-config-schema.md) | [fanout/fanout-config-schema.md](../manual-testing-playbook/fanout/fanout-config-schema.md) |
| DLR-024 | [F024 Fan-out worker pool](../feature-catalog/fanout/fanout-pool.md) | [fanout/fanout-pool-concurrency-cap.md](../manual-testing-playbook/fanout/fanout-pool-concurrency-cap.md) |
| DLR-025 | [F025 Fan-out CLI lineage driver](../feature-catalog/fanout/fanout-run.md) | [fanout/fanout-run-cli-lineage-spawn.md](../manual-testing-playbook/fanout/fanout-run-cli-lineage-spawn.md) |
| DLR-026 | [F026 Fan-out write-failure salvage](../feature-catalog/fanout/fanout-salvage.md) | [fanout/fanout-salvage-recovery.md](../manual-testing-playbook/fanout/fanout-salvage-recovery.md) |
| DLR-027 | [F027 Fan-out cross-lineage merge (research)](../feature-catalog/fanout/fanout-merge.md) | [fanout/fanout-merge-research.md](../manual-testing-playbook/fanout/fanout-merge-research.md) |
| DLR-028 | [F027 Fan-out cross-lineage merge (review)](../feature-catalog/fanout/fanout-merge.md) | [fanout/fanout-merge-review-strongest-restriction.md](../manual-testing-playbook/fanout/fanout-merge-review-strongest-restriction.md) |
| DLR-029 | [F023 Artifact-dir override / parity](../feature-catalog/fanout/fanout-config-schema.md) | [fanout/artifact-dir-override-parity.md](../manual-testing-playbook/fanout/artifact-dir-override-parity.md) |
| DLR-030 | [F028 Atomic-state serialize-diff](../feature-catalog/state-safety/atomic-state-serialize-diff.md) | [state-safety/atomic-state-serialize-diff.md](../manual-testing-playbook/state-safety/atomic-state-serialize-diff.md) |
| DLR-031 | [F029 Atomic-state integrity helpers](../feature-catalog/state-safety/atomic-state-integrity-helpers.md) | [state-safety/atomic-state-integrity-helpers.md](../manual-testing-playbook/state-safety/atomic-state-integrity-helpers.md) |
| DLR-032 | [F030 Atomic-state deferred writer](../feature-catalog/state-safety/atomic-state-deferred-writer.md) | [state-safety/atomic-state-deferred-writer.md](../manual-testing-playbook/state-safety/atomic-state-deferred-writer.md) |
| DLR-033 | [F031 Abortable chunked sleep](../feature-catalog/lifecycle/abortable-chunked-sleep.md) | [lifecycle/abortable-chunked-sleep.md](../manual-testing-playbook/lifecycle/abortable-chunked-sleep.md) |
| DLR-034 | [F032 Lifecycle taxonomy guards](../feature-catalog/lifecycle/lifecycle-taxonomy-guards.md) | [lifecycle/lifecycle-taxonomy-guards.md](../manual-testing-playbook/lifecycle/lifecycle-taxonomy-guards.md) |
| DLR-035 | [F033 JSONL lock-held merge](../feature-catalog/state-safety/jsonl-lock-held-merge.md) | [state-safety/jsonl-lock-held-merge.md](../manual-testing-playbook/state-safety/jsonl-lock-held-merge.md) |
| DLR-036 | [F034 Loop-lock heartbeat hardening](../feature-catalog/state-safety/loop-lock-heartbeat-hardening.md) | [state-safety/loop-lock-heartbeat-hardening.md](../manual-testing-playbook/state-safety/loop-lock-heartbeat-hardening.md) |
| DLR-037 | [F035 Loop-lock single-flight decision](../feature-catalog/state-safety/loop-lock-single-flight-decision.md) | [state-safety/loop-lock-single-flight-decision.md](../manual-testing-playbook/state-safety/loop-lock-single-flight-decision.md) |
| DLR-038 | [F036 Byte-offset log regions](../feature-catalog/observability/byte-offset-log-regions.md) | [observability/byte-offset-log-regions.md](../manual-testing-playbook/observability/byte-offset-log-regions.md) |
| DLR-039 | [F037 Fixed-rate overrun accounting](../feature-catalog/fanout/fixed-rate-overrun-accounting.md) | [fanout/fixed-rate-overrun-accounting.md](../manual-testing-playbook/fanout/fixed-rate-overrun-accounting.md) |
| DLR-040 | [F038 Convergence score-delta](../feature-catalog/scoring/convergence-score-delta.md) | [scoring/convergence-score-delta.md](../manual-testing-playbook/scoring/convergence-score-delta.md) |
| DLR-041 | [F039 Observation-threshold guard](../feature-catalog/coverage-graph/observation-threshold-guard.md) | [coverage-graph/observation-threshold-guard.md](../manual-testing-playbook/coverage-graph/observation-threshold-guard.md) |
| DLR-042 | [F040 Coverage-graph time decay](../feature-catalog/coverage-graph/coverage-graph-time-decay.md) | [coverage-graph/coverage-graph-time-decay.md](../manual-testing-playbook/coverage-graph/coverage-graph-time-decay.md) |
| DLR-043 | [F041 Coverage-graph fuzzy merge](../feature-catalog/coverage-graph/coverage-graph-fuzzy-merge.md) | [coverage-graph/coverage-graph-fuzzy-merge.md](../manual-testing-playbook/coverage-graph/coverage-graph-fuzzy-merge.md) |
| DLR-044 | [F042 Fallback-router typed reroute](../feature-catalog/executor/fallback-router-typed-reroute.md) | [executor/fallback-router-typed-reroute.md](../manual-testing-playbook/executor/fallback-router-typed-reroute.md) |
| DLR-045 | [F043 LLM-judge hardening](../feature-catalog/validation/llm-judge-hardening.md) | [validation/llm-judge-hardening.md](../manual-testing-playbook/validation/llm-judge-hardening.md) |
| DLR-046 | [F044 Fan-out stall watchdog](../feature-catalog/fanout/fanout-stall-watchdog.md) | [fanout/fanout-stall-watchdog.md](../manual-testing-playbook/fanout/fanout-stall-watchdog.md) |
| DLR-047 | [F045 Persisted-wait crash resume](../feature-catalog/fanout/persisted-wait-crash-resume.md) | [fanout/persisted-wait-crash-resume.md](../manual-testing-playbook/fanout/persisted-wait-crash-resume.md) |
| DLR-048 | [F046 Single-loop telemetry heartbeat](../feature-catalog/observability/single-loop-telemetry-heartbeat.md) | [observability/single-loop-telemetry-heartbeat.md](../manual-testing-playbook/observability/single-loop-telemetry-heartbeat.md) |

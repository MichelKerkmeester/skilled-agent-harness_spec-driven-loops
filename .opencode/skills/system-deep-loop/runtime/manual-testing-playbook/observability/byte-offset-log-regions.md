...
- Feature catalog entry exists at `feature-catalog/observability/byte-offset-log-regions.md`.
...
- Group: Observability
- Playbook ID: DLR-038
- Feature catalog entry: `feature-catalog/observability/byte-offset-log-regions.md`
- Scenario file path: `manual-testing-playbook/observability/byte-offset-log-regions.md`

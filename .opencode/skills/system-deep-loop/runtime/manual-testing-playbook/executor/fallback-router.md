...
- Feature catalog entry exists at `feature-catalog/executor/fallback-router.md`.
...
- Group: Executor
- Playbook ID: DLR-003
- Feature catalog entry: `feature-catalog/executor/fallback-router.md`
- Scenario file path: `manual-testing-playbook/executor/fallback-router.md`

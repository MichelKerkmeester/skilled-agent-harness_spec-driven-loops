...
- Feature catalog entry exists at `feature-catalog/executor/executor-config.md`.
...
- Group: Executor
- Playbook ID: DLR-001
- Feature catalog entry: `feature-catalog/executor/executor-config.md`
- Scenario file path: `manual-testing-playbook/executor/executor-config.md`

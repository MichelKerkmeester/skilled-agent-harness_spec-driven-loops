...
describe('prompt-pack', () => {
  ...
  it('both production templates load and render successfully with the expected bound variables', () => {
    ...
    const researchRendered = renderPromptPack(researchTemplatePath, {
      ...
      state_paths_config: '.opencode/skills/system-deep-loop/deep-research/assets/deep_research_config.json',
      state_paths_state_log: '.opencode/skills/system-deep-loop/deep-research/runtime/state.jsonl',
      state_paths_strategy: '.opencode/skills/system-deep-loop/deep-research/assets/deep_research_strategy.md',
    ...
    const reviewRendered = renderPromptPack(reviewTemplatePath, {
      ...
      p1_count: 1,
      p2_count: 2,
      state_paths_config: '.opencode/skills/system-deep-loop/deep-review/assets/deep_review_config.json',

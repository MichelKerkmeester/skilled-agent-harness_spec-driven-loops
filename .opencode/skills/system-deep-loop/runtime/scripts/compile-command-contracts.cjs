...
const COMMANDS = {
  ...
  'deep/alignment': {
    ...
    presentationPath: '.opencode/commands/deep/assets/deep_alignment_presentation.txt',
    autoWorkflowPath: '.opencode/commands/deep/assets/deep_alignment_auto.yaml',
    confirmWorkflowPath: '.opencode/commands/deep/assets/deep_alignment_confirm.yaml',
    ...
    sourcePaths: [
      ...
      '.opencode/commands/deep/assets/deep_alignment_confirm.yaml',
      SHARED_SOURCES.modeRegistry,
      SHARED_SOURCES.hubSkill,

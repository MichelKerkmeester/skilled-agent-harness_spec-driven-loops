...
| [validation](validation/) | 3 features | `lib/deep-loop/post-dispatch-validate.ts`, `.opencode/plugins/mk-deep-loop-guard.js`, `lib/mode-contracts/strict-gate-validator.ts` |

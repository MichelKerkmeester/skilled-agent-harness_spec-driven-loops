...
See [`executor/executor-config.md`](../feature-catalog/executor/executor-config.md) for full implementation and validation file listings.
...
See [`executor/executor-audit.md`](../feature-catalog/executor/executor-audit.md) for full implementation and validation file listings.
...
See [`executor/fallback-router.md`](../feature-catalog/executor/fallback-router.md) for full implementation and validation file listings.
...
See [`executor/fallback-router-typed-reroute.md`](../feature-catalog/executor/fallback-router-typed-reroute.md) for full implementation and validation file listings.
...
See [`prompt-rendering/prompt-pack.md`](../feature-catalog/prompt-rendering/prompt-pack.md) for full implementation and validation file listings.
...
See [`validation/post-dispatch-validate.md`](../feature-catalog/validation/post-dispatch-validate.md) for full implementation and validation file listings.
...
See [`validation/llm-judge-hardening.md`](../feature-catalog/validation/llm-judge-hardening.md) for full implementation and validation file listings.
...
See [`state-safety/atomic-state.md`](../feature-catalog/state-safety/atomic-state.md) for full implementation and validation file listings.
...
See [`state-safety/jsonl-repair.md`](../feature-catalog/state-safety/jsonl-repair.md) for full implementation and validation file listings.
...
See [`state-safety/loop-lock.md`](../feature-catalog/state-safety/loop-lock.md) for full implementation and validation file listings.
...
See [`state-safety/permissions-gate.md`](../feature-catalog/state-safety/permissions-gate.md) for full implementation and validation file listings.
...
See [`state-safety/atomic-state-serialize-diff.md`](../feature-catalog/state-safety/atomic-state-serialize-diff.md) for full implementation and validation file listings.
...
See [`state-safety/atomic-state-integrity-helpers.md`](../feature-catalog/state-safety/atomic-state-integrity-helpers.md) for full implementation and validation file listings.
...
See [`state-safety/atomic-state-deferred-writer.md`](../feature-catalog/state-safety/atomic-state-deferred-writer.md) for full implementation and validation file listings.
...
See [`state-safety/jsonl-lock-held-merge.md`](../feature-catalog/state-safety/jsonl-lock-held-merge.md) for full implementation and validation file listings.
...
See [`state-safety/loop-lock-heartbeat-hardening.md`](../feature-catalog/state-safety/loop-lock-heartbeat-hardening.md) for full implementation and validation file listings.
...
See [`scoring/bayesian-scorer.md`](../feature-catalog/scoring/bayesian-scorer.md) for full implementation and validation file listings.
...
See [`coverage-graph/coverage-graph-db.md`](../feature-catalog/coverage-graph/coverage-graph-db.md) for full implementation and validation file listings.
...
See [`coverage-graph/coverage-graph-query.md`](../feature-catalog/coverage-graph/coverage-graph-query.md) for full implementation and validation file listings.
...
See [`coverage-graph/coverage-graph-signals.md`](../feature-catalog/coverage-graph/coverage-graph-signals.md) for full implementation and validation file listings.
...
See [`coverage-graph/observation-threshold-guard.md`](../feature-catalog/coverage-graph/observation-threshold-guard.md) for full implementation and validation file listings.
...
See [`coverage-graph/coverage-graph-time-decay.md`](../feature-catalog/coverage-graph/coverage-graph-time-decay.md) for full implementation and validation file listings.
...
See [`coverage-graph/coverage-graph-fuzzy-merge.md`](../feature-catalog/coverage-graph/coverage-graph-fuzzy-merge.md) for full implementation and validation file listings.
...
See [`script-entry-points/convergence-script.md`](../feature-catalog/script-entry-points/convergence-script.md) for full implementation and validation file listings.
...
See [`script-entry-points/upsert-script.md`](../feature-catalog/script-entry-points/upsert-script.md) for full implementation and validation file listings.
...
See [`script-entry-points/query-script.md`](../feature-catalog/script-entry-points/query-script.md) for full implementation and validation file listings.
...
See [`council/multi-seat-dispatch.md`](../feature-catalog/council/multi-seat-dispatch.md) for full implementation and validation file listings.
...
See [`council/round-state-jsonl.md`](../feature-catalog/council/round-state-jsonl.md) for full implementation and validation file listings.
...
See [`council/adjudicator-verdict-scoring.md`](../feature-catalog/council/adjudicator-verdict-scoring.md) for full implementation and validation file listings.
...
See [`council/cost-guards.md`](../feature-catalog/council/cost-guards.md) for full implementation and validation file listings.
...
See [`council/session-state-hierarchy.md`](../feature-catalog/council/session-state-hierarchy.md) for full implementation and validation file listings.
...
See [`fanout/fanout-config-schema.md`](../feature-catalog/fanout/fanout-config-schema.md) for full implementation and validation file listings.
...
See [`fanout/fanout-pool.md`](../feature-catalog/fanout/fanout-pool.md) for full implementation and validation file listings.
...
See [`fanout/fanout-run.md`](../feature-catalog/fanout/fanout-run.md) for full implementation and validation file listings.
...
See [`fanout/fanout-salvage.md`](../feature-catalog/fanout/fanout-salvage.md) for full implementation and validation file listings.
...
See [`fanout/fanout-merge.md`](../feature-catalog/fanout/fanout-merge.md) for full implementation and validation file listings.
...
See [`fanout/fixed-rate-overrun-accounting.md`](../feature-catalog/fanout/fixed-rate-overrun-accounting.md) for full implementation and validation file listings.
...
See [`fanout/fanout-stall-watchdog.md`](../feature-catalog/fanout/fanout-stall-watchdog.md) for full implementation and validation file listings.
...
See [`lifecycle/abortable-chunked-sleep.md`](../feature-catalog/lifecycle/abortable-chunked-sleep.md) for full implementation and validation file listings.
...
See [`lifecycle/lifecycle-taxonomy-guards.md`](../feature-catalog/lifecycle/lifecycle-taxonomy-guards.md) for full implementation and validation file listings.
...
See [`observability/byte-offset-log-regions.md`](../feature-catalog/observability/byte-offset-log-regions.md) for full implementation and validation file listings.
...
See [`observability/single-loop-telemetry-heartbeat.md`](../feature-catalog/observability/single-loop-telemetry-heartbeat.md) for full implementation and validation file listings.
...
See [`observability/unified-observability-event-envelope.md`](../feature-catalog/observability/unified-observability-event-envelope.md) for full implementation and validation file listings.
...
See [`testing/hermetic-test-isolation.md`](../feature-catalog/testing/hermetic-test-isolation.md) for full implementation and validation file listings.
...
See [`testing/record-replay-cassette-harness.md`](../feature-catalog/testing/record-replay-cassette-harness.md) for full implementation and validation file listings.

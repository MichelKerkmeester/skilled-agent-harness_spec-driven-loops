...
- Group: Fan-Out
- Feature ID: F024
- Catalog source: `feature-catalog/fanout/fanout-pool.md`
- Primary source files: `scripts/fanout-pool.cjs`
Related references:
- [fanout-config-schema.md](../../feature-catalog/fanout/fanout-config-schema.md) — Fan-out config schema
- [fanout-run.md](../../feature-catalog/fanout/fanout-run.md) — Fan-out CLI lineage driver

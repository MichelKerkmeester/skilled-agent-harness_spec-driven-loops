---
title: "deep-ai-council-shadow-parity: Shadow Parity"
description: "Deep Ai Council shadow parity layer for the durable runtime event spine."
trigger_phrases:
...
This folder compares legacy and ledger-backed lane behavior and records parity evidence for the Deep Ai Council runtime lane. It keeps lane-specific contracts beside the shared ledger, event-envelope and replay primitives, then publishes the supported surface through the public barrel.
...
This folder owns the shadow parity step for Deep Ai Council. It does not replace the shared substrate or decide consumer-facing workflow policy.

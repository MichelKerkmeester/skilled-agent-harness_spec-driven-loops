---
title: "agent-improvement-rollback-gate: Rollback Gate"
description: "Agent Improvement rollback gate layer for the durable runtime event spine."
trigger_phrases:
  - "agent-improvement-rollback-gate"
  - "agent-improvement rollback gate"
---
...
This folder evaluates rollback evidence and controls the lane's migration switch for the Agent Improvement runtime lane. It keeps lane-specific contracts beside the shared ledger, event-envelope and replay primitives, then publishes the supported surface through the public barrel.
...
This folder owns the rollback gate step for Agent Improvement. It does not replace the shared substrate or decide consumer-facing workflow policy.

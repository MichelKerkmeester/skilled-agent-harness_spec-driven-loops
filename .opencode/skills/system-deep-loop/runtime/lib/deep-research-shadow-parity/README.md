---
title: "deep-research-shadow-parity: Shadow Parity"
description: "Deep Research shadow-parity layer for the durable runtime event spine."
trigger_phrases:
...
This folder runs deterministic parity checks against the lane's shadow execution for the Deep Research runtime lane. It keeps lane-specific contracts beside the shared ledger, event-envelope and replay primitives, then publishes the supported surface through the public barrel.
...
This folder owns the shadow parity step for Deep Research. It does not replace the shared substrate or decide consumer-facing workflow policy.

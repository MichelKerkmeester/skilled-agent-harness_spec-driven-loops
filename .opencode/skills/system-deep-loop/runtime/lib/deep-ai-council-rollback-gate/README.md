---
title: "deep-ai-council-rollback-gate: Rollback Gate"
description: "Deep Ai Council rollback gate layer for the durable runtime event spine."
trigger_phrases:
  - "deep-ai-council-rollback-gate"
  - "deep-ai-council rollback gate"
---
...
This folder evaluates rollback evidence and controls the lane's migration switch for the Deep Ai Council runtime lane. It keeps lane-specific contracts beside the shared ledger, event-envelope and replay primitives, then publishes the supported surface through the public barrel.
...
This folder owns the rollback gate step for Deep Ai Council. It does not replace the shared substrate or decide consumer-facing workflow policy.

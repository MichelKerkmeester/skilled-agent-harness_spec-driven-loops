---
title: "deep-ai-council-resume-adapter: Resume Adapter"
description: "Deep Ai Council resume adapter layer for the durable runtime event spine."
trigger_phrases:
...
This folder reconstructs lane continuity from durable ledger, projection and artifact evidence for the Deep Ai Council runtime lane. It keeps lane-specific contracts beside the shared ledger, event-envelope and replay primitives, then publishes the supported surface through the public barrel.
...
| File | Responsibility |
|---|---|
| `deep-ai-council-resume-adapter.ts` | resume request parsing, continuity decisions and fingerprint binding |
...
| Primary implementation | `deep-ai-council-resume-adapter.ts` | resume request parsing, continuity decisions and fingerprint binding. |
...
This folder owns the resume adapter step for Deep Ai Council. It does not replace the shared substrate or decide consumer-facing workflow policy.

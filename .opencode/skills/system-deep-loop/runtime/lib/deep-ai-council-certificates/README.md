---
title: "deep-ai-council-certificates: Certificates"
description: "Deep Ai Council certificates layer for the durable runtime event spine."
trigger_phrases:
  - "deep-ai-council-certificates"
  - "deep-ai-council certificates"
---
...
This folder issues and validates transition receipts and run certificates for the Deep Ai Council runtime lane. It keeps lane-specific contracts beside the shared ledger, event-envelope and replay primitives, then publishes the supported surface through the public barrel.
...
| File | Responsibility |
|---|---|
| `deep-ai-council-certificate-types.ts` | Lane-specific types, constants and contract values. |
| `deep-ai-council-certificate-validation.ts` | Strict parsing and validation for the lane's durable records. |
| `deep-ai-council-certificates.ts` | certificate issuance and verification logic |
...
| Primary implementation | `deep-ai-council-certificates.ts` | certificate issuance and verification logic. |
...
This folder owns the certificates step for Deep Ai Council. It does not replace the shared substrate or decide consumer-facing workflow policy.

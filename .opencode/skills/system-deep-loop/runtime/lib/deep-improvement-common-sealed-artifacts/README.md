---
title: "deep-improvement-common-sealed-artifacts: Sealed Artifacts"
description: "Deep Improvement Common sealed artifacts layer for the durable runtime event spine."
trigger_phrases:
  - "deep-improvement-common-sealed-artifacts"
  - "deep-improvement-common sealed artifacts"
---
...
This folder canonicalizes, seals and reads lane-owned evidence artifacts for the Deep Improvement Common runtime lane. It keeps lane-specific contracts beside the shared ledger, event-envelope and replay primitives, then publishes the supported surface through the public barrel.
...
| File | Responsibility |
|---|---|
| `deep-improvement-common-artifact-material.ts` | Canonical artifact material and kind registration. |
| `deep-improvement-common-sealed-artifact-types.ts` | Lane-specific types, constants and contract values. |
| `deep-improvement-common-sealed-artifacts.ts` | artifact materialization, sealing, binding parsing and reads |
...
| Primary implementation | `deep-improvement-common-sealed-artifacts.ts` | artifact materialization, sealing, binding parsing and reads. |
...
This folder owns the sealed artifacts step for Deep Improvement Common. It does not replace the shared substrate or decide consumer-facing workflow policy.

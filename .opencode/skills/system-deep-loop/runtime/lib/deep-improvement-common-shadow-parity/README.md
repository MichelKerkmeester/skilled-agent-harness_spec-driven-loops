---
title: "deep-improvement-common-shadow-parity: Shadow Parity"
description: "Deep Improvement Common shadow parity layer for the durable runtime event spine."
trigger_phrases:
...
This folder compares legacy and ledger-backed lane behavior and records parity evidence for the Deep Improvement Common runtime lane. It keeps lane-specific contracts beside the shared ledger, event-envelope and replay primitives, then publishes the supported surface through the public barrel.
...
This folder owns the shadow parity step for Deep Improvement Common. It does not replace the shared substrate or decide consumer-facing workflow policy.

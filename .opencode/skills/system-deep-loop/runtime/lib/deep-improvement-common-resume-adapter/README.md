---
title: "deep-improvement-common-resume-adapter: Resume Adapter"
description: "Deep Improvement Common resume adapter layer for the durable runtime event spine."
trigger_phrases:
  - "deep-improvement-common-resume-adapter"
  - "deep-improvement-common resume adapter"
---
...
This folder reconstructs lane continuity from durable ledger, projection and artifact evidence for the Deep Improvement Common runtime lane. It keeps lane-specific contracts beside the shared ledger, event-envelope and replay primitives, then publishes the supported surface through the public barrel.
...
| File | Responsibility |
|---|---|
| `deep-improvement-common-resume-adapter.ts` | resume request parsing, continuity decisions and fingerprint binding |
...
| Primary implementation | `deep-improvement-common-resume-adapter.ts` | resume request parsing, continuity decisions and fingerprint binding. |
...
This folder owns the resume adapter step for Deep Improvement Common. It does not replace the shared substrate or decide consumer-facing workflow policy.

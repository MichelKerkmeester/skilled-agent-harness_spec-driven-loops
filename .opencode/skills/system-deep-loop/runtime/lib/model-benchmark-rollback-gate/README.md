---
title: "model-benchmark-rollback-gate: Rollback Gate"
description: "Model Benchmark rollback-gate layer for the durable runtime event spine."
trigger_phrases:
  - "model-benchmark-rollback-gate"
  - "model benchmark rollback-gate"
---
...
This folder evaluates safe rollback and mode-transition boundaries for the Model Benchmark runtime lane. It keeps lane-specific contracts beside the shared ledger, event-envelope and replay primitives, then publishes the supported surface through the public barrel.
...
This folder owns the rollback gate step for Model Benchmark. It does not replace the shared substrate or decide consumer-facing workflow policy.

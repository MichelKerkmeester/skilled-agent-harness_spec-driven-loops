---
title: "model-benchmark-shadow-parity: Shadow Parity"
description: "Model Benchmark shadow-parity layer for the durable runtime event spine."
trigger_phrases:
...
This folder runs deterministic parity checks against the lane's shadow execution for the Model Benchmark runtime lane. It keeps lane-specific contracts beside the shared ledger, event-envelope and replay primitives, then publishes the supported surface through the public barrel.
...
This folder owns the shadow parity step for Model Benchmark. It does not replace the shared substrate or decide consumer-facing workflow policy.

---
title: "deep-research-rollback-gate: Rollback Gate"
description: "Deep Research rollback-gate layer for the durable runtime event spine."
trigger_phrases:
  - "deep-research-rollback-gate"
  - "deep research rollback-gate"
---
...
This folder evaluates safe rollback and mode-transition boundaries for the Deep Research runtime lane. It keeps lane-specific contracts beside the shared ledger, event-envelope and replay primitives, then publishes the supported surface through the public barrel.
...
This folder owns the rollback gate step for Deep Research. It does not replace the shared substrate or decide consumer-facing workflow policy.

...
- Feature ID: F012
- Feature file path: `06--coverage-graph/coverage-graph-query.md`
- Primary sources: `lib/coverage-graph/coverage-graph-query.ts`, `tests/integration/query-script.vitest.ts`
Related references:
- [coverage-graph-db.md](coverage-graph-db.md) — Coverage graph DB
- [coverage-graph-signals.md](coverage-graph-signals.md) — Coverage graph signals

...
- Group: Fan-Out
- Feature ID: F026
- Catalog source: `feature_catalog/fanout/fanout_salvage.md`
- Primary source files: `scripts/fanout-salvage.cjs`
Related references:
- [fanout-run.md](fanout_run.md) — Fan-out CLI lineage driver
- [fanout-merge.md](fanout_merge.md) — Fan-out cross-lineage merge

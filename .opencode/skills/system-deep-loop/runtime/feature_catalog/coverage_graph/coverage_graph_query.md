...
Related references:
- [coverage-graph-db.md](../coverage_graph/coverage_graph_db.md) — Coverage graph DB
- [coverage-graph-signals.md](../coverage_graph/coverage_graph_signals.md) — Coverage graph signals

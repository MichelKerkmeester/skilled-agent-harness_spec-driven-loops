...
trigger_phrases:
  ...
  - "persisted-wait-crash-resume"
  - "persisted-wait crash resume deep-loop-runtime"
...
This feature belongs to the fan-out group and is catalogued as F045 in the `deep-loop-runtime` inventory.
...
- Feature ID: F045
- Feature file path: `09--fanout/persisted-wait-crash-resume.md`

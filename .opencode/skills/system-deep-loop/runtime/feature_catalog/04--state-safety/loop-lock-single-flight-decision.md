...
trigger_phrases:
  ...
  - "loop-lock-single-flight-decision"
  - "loop-lock single-flight decision deep-loop-runtime"
...
This feature belongs to the state safety group and is catalogued as F035 in the `deep-loop-runtime` inventory.

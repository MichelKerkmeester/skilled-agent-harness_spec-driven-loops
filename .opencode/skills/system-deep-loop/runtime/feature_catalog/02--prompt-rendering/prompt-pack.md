...
This feature belongs to the prompt rendering group and is catalogued as F004 in the `runtime/` inventory.
...
- Feature ID: F004
- Feature file path: `02--prompt-rendering/prompt-pack.md`

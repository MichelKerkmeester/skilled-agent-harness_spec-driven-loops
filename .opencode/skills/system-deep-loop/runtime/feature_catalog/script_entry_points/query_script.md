...
This feature belongs to the script entry points group and is catalogued as F016 in the `runtime/` inventory.
...
- Feature ID: F016
- Feature file path: `script-entry-points/query-script.md`
- Primary sources: `scripts/query.cjs`, `tests/integration/query-script.vitest.ts`
Related references:
- [upsert-script.md](../script_entry_points/upsert_script.md) — upsert.cjs
- [status-script.md](../script_entry_points/status_script.md) — status.cjs

...
- Feature catalog entry exists at `feature_catalog/coverage-graph/observation-threshold-guard.md`.
...
- Playbook ID: DLR-041
- Feature catalog entry: `feature_catalog/coverage-graph/observation-threshold-guard.md`
- Scenario file path: `manual_testing_playbook/coverage-graph/observation-threshold-guard.md`

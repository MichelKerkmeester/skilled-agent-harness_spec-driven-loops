...
- Feature catalog entry exists at `feature_catalog/coverage-graph/coverage-graph-signals.md`.
...
- Playbook ID: DLR-013
- Feature catalog entry: `feature_catalog/coverage-graph/coverage-graph-signals.md`
- Scenario file path: `manual_testing_playbook/coverage-graph/coverage-graph-signals.md`

...
- Feature catalog entry exists at `feature_catalog/coverage-graph/coverage-graph-time-decay.md`.
...
- Playbook ID: DLR-042
- Feature catalog entry: `feature_catalog/coverage-graph/coverage-graph-time-decay.md`
- Scenario file path: `manual_testing_playbook/coverage-graph/coverage-graph-time-decay.md`

...
- Feature catalog entry exists at `feature_catalog/coverage-graph/coverage-graph-query.md`.
...
- Playbook ID: DLR-012
- Feature catalog entry: `feature_catalog/coverage-graph/coverage-graph-query.md`
- Scenario file path: `manual_testing_playbook/coverage-graph/coverage-graph-query.md`

...
- Feature catalog entry exists at `feature_catalog/coverage-graph/coverage-graph-db.md`.
...
- Playbook ID: DLR-011
- Feature catalog entry: `feature_catalog/coverage-graph/coverage-graph-db.md`
- Scenario file path: `manual_testing_playbook/coverage-graph/coverage-graph-db.md`

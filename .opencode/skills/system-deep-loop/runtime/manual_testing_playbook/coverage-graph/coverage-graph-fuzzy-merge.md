...
- Feature catalog entry exists at `feature_catalog/coverage-graph/coverage-graph-fuzzy-merge.md`.
...
- Playbook ID: DLR-043
- Feature catalog entry: `feature_catalog/coverage-graph/coverage-graph-fuzzy-merge.md`
- Scenario file path: `manual_testing_playbook/coverage-graph/coverage-graph-fuzzy-merge.md`

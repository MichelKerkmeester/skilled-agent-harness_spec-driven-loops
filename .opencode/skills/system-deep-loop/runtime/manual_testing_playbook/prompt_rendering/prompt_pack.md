...
- Feature catalog entry exists at `feature_catalog/prompt_rendering/prompt_pack.md`.
...
- Playbook ID: DLR-004
- Feature catalog entry: `feature_catalog/prompt_rendering/prompt_pack.md`
- Scenario file path: `manual_testing_playbook/prompt_rendering/prompt_pack.md`

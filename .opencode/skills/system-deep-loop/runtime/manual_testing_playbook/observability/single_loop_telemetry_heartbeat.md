...
- Feature catalog entry exists at `feature_catalog/observability/single_loop_telemetry_heartbeat.md`.
...
- Group: Observability
- Playbook ID: DLR-048
- Feature catalog entry: `feature_catalog/observability/single_loop_telemetry_heartbeat.md`
- Scenario file path: `manual_testing_playbook/observability/single_loop_telemetry_heartbeat.md`

...
- Feature catalog entry exists at `feature_catalog/observability/byte_offset_log_regions.md`.
...
- Group: Observability
- Playbook ID: DLR-038
- Feature catalog entry: `feature_catalog/observability/byte_offset_log_regions.md`
- Scenario file path: `manual_testing_playbook/observability/byte_offset_log_regions.md`

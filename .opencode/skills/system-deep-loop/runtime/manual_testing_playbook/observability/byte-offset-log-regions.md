...
- Feature catalog entry exists at `feature_catalog/observability/byte-offset-log-regions.md`.
...
- Group: Observability
- Playbook ID: DLR-038
- Feature catalog entry: `feature_catalog/observability/byte-offset-log-regions.md`
- Scenario file path: `manual_testing_playbook/observability/byte-offset-log-regions.md`

...
- Feature catalog entry exists at `feature_catalog/prompt-rendering/prompt-pack.md`.
...
- Playbook ID: DLR-004
- Feature catalog entry: `feature_catalog/prompt-rendering/prompt-pack.md`
- Scenario file path: `manual_testing_playbook/prompt-rendering/prompt-pack.md`

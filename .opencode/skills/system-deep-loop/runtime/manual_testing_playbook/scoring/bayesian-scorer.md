...
description: "Manual validation scenario for Bayesian scorer in the runtime/ skill."
version: 1.4.0.5
---
...
- Real user request: `Validate Bayesian scorer and report whether the current source, script surface, and tests agree with the runtime/ contract.`
...
- Feature catalog entry exists at `feature_catalog/scoring/bayesian-scorer.md`.
...
- Group: Scoring
- Playbook ID: DLR-010
- Feature catalog entry: `feature_catalog/scoring/bayesian-scorer.md`
- Scenario file path: `manual_testing_playbook/scoring/bayesian-scorer.md`

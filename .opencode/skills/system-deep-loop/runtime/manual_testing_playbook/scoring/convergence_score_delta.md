...
- Feature catalog entry exists at `feature_catalog/scoring/convergence_score_delta.md`.
...
- Group: Scoring
- Playbook ID: DLR-040
- Feature catalog entry: `feature_catalog/scoring/convergence_score_delta.md`
- Scenario file path: `manual_testing_playbook/scoring/convergence_score_delta.md`

...
- Feature catalog entry exists at `feature_catalog/scoring/convergence-score-delta.md`.
...
- Group: Scoring
- Playbook ID: DLR-040
- Feature catalog entry: `feature_catalog/scoring/convergence-score-delta.md`
- Scenario file path: `manual_testing_playbook/scoring/convergence-score-delta.md`

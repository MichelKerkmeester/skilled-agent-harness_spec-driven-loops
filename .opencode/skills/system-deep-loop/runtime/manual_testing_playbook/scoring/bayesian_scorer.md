...
- Feature catalog entry exists at `feature_catalog/scoring/bayesian_scorer.md`.
...
- Group: Scoring
- Playbook ID: DLR-010
- Feature catalog entry: `feature_catalog/scoring/bayesian_scorer.md`
- Scenario file path: `manual_testing_playbook/scoring/bayesian_scorer.md`

...
- Feature catalog entry exists at `feature_catalog/coverage_graph/coverage_graph_signals.md`.
...
- Playbook ID: DLR-013
- Feature catalog entry: `feature_catalog/coverage_graph/coverage_graph_signals.md`
- Scenario file path: `manual_testing_playbook/coverage_graph/coverage_graph_signals.md`

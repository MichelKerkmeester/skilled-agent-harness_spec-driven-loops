...
- Feature catalog entry exists at `feature_catalog/coverage_graph/observation_threshold_guard.md`.
...
- Playbook ID: DLR-041
- Feature catalog entry: `feature_catalog/coverage_graph/observation_threshold_guard.md`
- Scenario file path: `manual_testing_playbook/coverage_graph/observation_threshold_guard.md`

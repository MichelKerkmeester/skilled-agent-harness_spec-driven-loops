...
- Feature catalog entry exists at `feature_catalog/coverage_graph/coverage_graph_fuzzy_merge.md`.
...
- Playbook ID: DLR-043
- Feature catalog entry: `feature_catalog/coverage_graph/coverage_graph_fuzzy_merge.md`
- Scenario file path: `manual_testing_playbook/coverage_graph/coverage_graph_fuzzy_merge.md`

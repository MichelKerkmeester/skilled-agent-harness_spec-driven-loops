...
- Feature catalog entry exists at `feature_catalog/coverage_graph/coverage_graph_db.md`.
...
- Playbook ID: DLR-011
- Feature catalog entry: `feature_catalog/coverage_graph/coverage_graph_db.md`
- Scenario file path: `manual_testing_playbook/coverage_graph/coverage_graph_db.md`

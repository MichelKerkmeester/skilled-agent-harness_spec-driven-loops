...
- Feature catalog entry exists at `feature_catalog/coverage_graph/coverage_graph_query.md`.
...
- Playbook ID: DLR-012
- Feature catalog entry: `feature_catalog/coverage_graph/coverage_graph_query.md`
- Scenario file path: `manual_testing_playbook/coverage_graph/coverage_graph_query.md`

...
description: "Manual validation scenario for Executor audit in the runtime/ skill."
version: 1.4.0.4
---
...
- Real user request: `Validate Executor audit and report whether the current source, script surface, and tests agree with the runtime/ contract.`
...
- Feature catalog entry exists at `feature_catalog/01--executor/executor-audit.md`.
...
- Group: Executor
- Playbook ID: DLR-002
- Feature catalog entry: `feature_catalog/01--executor/executor-audit.md`
- Scenario file path: `manual_testing_playbook/01--executor/executor-audit.md`

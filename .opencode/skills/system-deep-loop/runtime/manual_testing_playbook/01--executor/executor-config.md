...
description: "Manual validation scenario for Executor config in the runtime/ skill."
version: 1.4.0.4
---
...
- Real user request: `Validate Executor config and report whether the current source, script surface, and tests agree with the runtime/ contract.`
...
- Feature catalog entry exists at `feature_catalog/01--executor/executor-config.md`.
...
- Group: Executor
- Playbook ID: DLR-001
- Feature catalog entry: `feature_catalog/01--executor/executor-config.md`
- Scenario file path: `manual_testing_playbook/01--executor/executor-config.md`

...
- Feature catalog entry exists at `feature_catalog/script-entry-points/query-script.md`.
...
- Playbook ID: DLR-016
- Feature catalog entry: `feature_catalog/script-entry-points/query-script.md`
- Scenario file path: `manual_testing_playbook/script-entry-points/query-script.md`

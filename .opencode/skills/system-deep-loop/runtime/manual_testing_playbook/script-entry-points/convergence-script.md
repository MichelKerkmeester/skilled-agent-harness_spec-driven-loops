...
- Feature catalog entry exists at `feature_catalog/script-entry-points/convergence-script.md`.
...
- Playbook ID: DLR-014
- Feature catalog entry: `feature_catalog/script-entry-points/convergence-script.md`
- Scenario file path: `manual_testing_playbook/script-entry-points/convergence-script.md`

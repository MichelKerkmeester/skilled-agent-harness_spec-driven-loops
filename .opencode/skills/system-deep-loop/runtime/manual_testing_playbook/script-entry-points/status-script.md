...
- Feature catalog entry exists at `feature_catalog/script-entry-points/status-script.md`.
...
- Playbook ID: DLR-017
- Feature catalog entry: `feature_catalog/script-entry-points/status-script.md`
- Scenario file path: `manual_testing_playbook/script-entry-points/status-script.md`

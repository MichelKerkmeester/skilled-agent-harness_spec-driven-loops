...
- Feature catalog entry exists at `feature_catalog/script-entry-points/upsert-script.md`.
...
- Playbook ID: DLR-015
- Feature catalog entry: `feature_catalog/script-entry-points/upsert-script.md`
- Scenario file path: `manual_testing_playbook/script-entry-points/upsert-script.md`

...
- Feature catalog entry exists at `feature_catalog/state_safety/jsonl_repair.md`.
...
- Group: State safety
- Playbook ID: DLR-007
- Feature catalog entry: `feature_catalog/state_safety/jsonl_repair.md`
- Scenario file path: `manual_testing_playbook/state_safety/jsonl_repair.md`

...
- Feature catalog entry exists at `feature_catalog/state_safety/loop_lock.md`.
...
- Group: State safety
- Playbook ID: DLR-008
- Feature catalog entry: `feature_catalog/state_safety/loop_lock.md`
- Scenario file path: `manual_testing_playbook/state_safety/loop_lock.md`

...
- Feature catalog entry exists at `feature_catalog/state_safety/jsonl_lock_held_merge.md`.
...
- Group: State safety
- Playbook ID: DLR-035
- Feature catalog entry: `feature_catalog/state_safety/jsonl_lock_held_merge.md`
- Scenario file path: `manual_testing_playbook/state_safety/jsonl_lock_held_merge.md`

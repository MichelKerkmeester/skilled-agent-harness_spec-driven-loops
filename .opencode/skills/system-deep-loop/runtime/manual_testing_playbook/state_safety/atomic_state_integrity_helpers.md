...
- Feature catalog entry exists at `feature_catalog/state_safety/atomic_state_integrity_helpers.md`.
...
- Group: State safety
- Playbook ID: DLR-031
- Feature catalog entry: `feature_catalog/state_safety/atomic_state_integrity_helpers.md`
- Scenario file path: `manual_testing_playbook/state_safety/atomic_state_integrity_helpers.md`

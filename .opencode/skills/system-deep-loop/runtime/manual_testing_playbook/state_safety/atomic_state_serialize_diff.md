...
- Feature catalog entry exists at `feature_catalog/state_safety/atomic_state_serialize_diff.md`.
...
- Group: State safety
- Playbook ID: DLR-030
- Feature catalog entry: `feature_catalog/state_safety/atomic_state_serialize_diff.md`
- Scenario file path: `manual_testing_playbook/state_safety/atomic_state_serialize_diff.md`

...
- Feature catalog entry exists at `feature_catalog/state_safety/atomic_state.md`.
...
- Group: State safety
- Playbook ID: DLR-006
- Feature catalog entry: `feature_catalog/state_safety/atomic_state.md`
- Scenario file path: `manual_testing_playbook/state_safety/atomic_state.md`

...
- Feature catalog entry exists at `feature_catalog/state_safety/loop_lock_heartbeat_hardening.md`.
...
- Group: State safety
- Playbook ID: DLR-036
- Feature catalog entry: `feature_catalog/state_safety/loop_lock_heartbeat_hardening.md`
- Scenario file path: `manual_testing_playbook/state_safety/loop_lock_heartbeat_hardening.md`

...
- Feature catalog entry exists at `feature_catalog/executor/fallback_router_typed_reroute.md`.
...
- Group: Executor
- Playbook ID: DLR-044
- Feature catalog entry: `feature_catalog/executor/fallback_router_typed_reroute.md`
- Scenario file path: `manual_testing_playbook/executor/fallback_router_typed_reroute.md`

...
- Feature catalog entry exists at `feature_catalog/executor/fallback_router.md`.
...
- Group: Executor
- Playbook ID: DLR-003
- Feature catalog entry: `feature_catalog/executor/fallback_router.md`
- Scenario file path: `manual_testing_playbook/executor/fallback_router.md`

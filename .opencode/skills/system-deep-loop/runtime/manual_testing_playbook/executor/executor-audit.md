...
- Feature catalog entry exists at `feature_catalog/executor/executor-audit.md`.
...
- Group: Executor
- Playbook ID: DLR-002
- Feature catalog entry: `feature_catalog/executor/executor-audit.md`
- Scenario file path: `manual_testing_playbook/executor/executor-audit.md`

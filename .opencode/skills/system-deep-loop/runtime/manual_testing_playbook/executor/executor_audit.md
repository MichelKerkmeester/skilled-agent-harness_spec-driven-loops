...
- Feature catalog entry exists at `feature_catalog/executor/executor_audit.md`.
...
- Group: Executor
- Playbook ID: DLR-002
- Feature catalog entry: `feature_catalog/executor/executor_audit.md`
- Scenario file path: `manual_testing_playbook/executor/executor_audit.md`

...
- Feature catalog entry exists at `feature_catalog/executor/fallback-router.md`.
...
- Group: Executor
- Playbook ID: DLR-003
- Feature catalog entry: `feature_catalog/executor/fallback-router.md`
- Scenario file path: `manual_testing_playbook/executor/fallback-router.md`

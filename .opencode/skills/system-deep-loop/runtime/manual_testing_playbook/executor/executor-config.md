...
- Feature catalog entry exists at `feature_catalog/executor/executor-config.md`.
...
- Group: Executor
- Playbook ID: DLR-001
- Feature catalog entry: `feature_catalog/executor/executor-config.md`
- Scenario file path: `manual_testing_playbook/executor/executor-config.md`

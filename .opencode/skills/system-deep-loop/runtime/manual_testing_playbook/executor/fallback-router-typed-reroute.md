...
- Feature catalog entry exists at `feature_catalog/executor/fallback-router-typed-reroute.md`.
...
- Group: Executor
- Playbook ID: DLR-044
- Feature catalog entry: `feature_catalog/executor/fallback-router-typed-reroute.md`
- Scenario file path: `manual_testing_playbook/executor/fallback-router-typed-reroute.md`

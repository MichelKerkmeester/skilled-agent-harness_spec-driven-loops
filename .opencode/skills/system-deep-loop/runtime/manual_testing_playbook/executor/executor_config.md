...
- Feature catalog entry exists at `feature_catalog/executor/executor_config.md`.
...
- Group: Executor
- Playbook ID: DLR-001
- Feature catalog entry: `feature_catalog/executor/executor_config.md`
- Scenario file path: `manual_testing_playbook/executor/executor_config.md`

...
- Feature catalog entry exists at `feature_catalog/lifecycle/lifecycle_taxonomy_guards.md`.
...
- Group: Lifecycle
- Playbook ID: DLR-034
- Feature catalog entry: `feature_catalog/lifecycle/lifecycle_taxonomy_guards.md`
- Scenario file path: `manual_testing_playbook/lifecycle/lifecycle_taxonomy_guards.md`

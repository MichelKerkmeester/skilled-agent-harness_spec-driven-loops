...
- Feature catalog entry exists at `feature_catalog/lifecycle/abortable_chunked_sleep.md`.
...
- Group: Lifecycle
- Playbook ID: DLR-033
- Feature catalog entry: `feature_catalog/lifecycle/abortable_chunked_sleep.md`
- Scenario file path: `manual_testing_playbook/lifecycle/abortable_chunked_sleep.md`

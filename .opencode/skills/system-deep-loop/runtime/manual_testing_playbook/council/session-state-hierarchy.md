...
- Feature catalog entry exists at `feature_catalog/council/session-state-hierarchy.md`.
...
- Group: Council
- Playbook ID: DLR-022
- Feature catalog entry: `feature_catalog/council/session-state-hierarchy.md`
- Scenario file path: `manual_testing_playbook/council/session-state-hierarchy.md`

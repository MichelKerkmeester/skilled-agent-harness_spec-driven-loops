...
- Feature catalog entry exists at `feature_catalog/council/multi_seat_dispatch.md`.
...
- Group: Council
- Playbook ID: DLR-018
- Feature catalog entry: `feature_catalog/council/multi_seat_dispatch.md`
- Scenario file path: `manual_testing_playbook/council/multi_seat_dispatch.md`

...
- Feature catalog entry exists at `feature_catalog/council/round-state-jsonl.md`.
...
- Group: Council
- Playbook ID: DLR-019
- Feature catalog entry: `feature_catalog/council/round-state-jsonl.md`
- Scenario file path: `manual_testing_playbook/council/round-state-jsonl.md`

...
- Feature catalog entry exists at `feature_catalog/council/round_state_jsonl.md`.
...
- Group: Council
- Playbook ID: DLR-019
- Feature catalog entry: `feature_catalog/council/round_state_jsonl.md`
- Scenario file path: `manual_testing_playbook/council/round_state_jsonl.md`

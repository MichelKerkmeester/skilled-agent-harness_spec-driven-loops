...
- Feature catalog entry exists at `feature_catalog/council/adjudicator_verdict_scoring.md`.
...
- Group: Council
- Playbook ID: DLR-020
- Feature catalog entry: `feature_catalog/council/adjudicator_verdict_scoring.md`
- Scenario file path: `manual_testing_playbook/council/adjudicator_verdict_scoring.md`

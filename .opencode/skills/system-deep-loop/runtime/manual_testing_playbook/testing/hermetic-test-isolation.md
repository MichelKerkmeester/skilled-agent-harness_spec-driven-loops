...
- Feature catalog entry exists at `feature_catalog/testing/hermetic-test-isolation.md`.
...
- Group: Testing
- Playbook ID: DLR-050
- Feature catalog entry: `feature_catalog/testing/hermetic-test-isolation.md`
- Scenario file path: `manual_testing_playbook/testing/hermetic-test-isolation.md`

...
- Feature catalog entry exists at `feature_catalog/testing/hermetic_test_isolation.md`.
...
- Group: Testing
- Playbook ID: DLR-050
- Feature catalog entry: `feature_catalog/testing/hermetic_test_isolation.md`
- Scenario file path: `manual_testing_playbook/testing/hermetic_test_isolation.md`

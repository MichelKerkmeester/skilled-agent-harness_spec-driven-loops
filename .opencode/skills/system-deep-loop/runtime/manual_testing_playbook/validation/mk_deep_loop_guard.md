...
- Feature catalog entry exists at `feature_catalog/validation/mk_deep_loop_guard.md`.
...
- Group: Validation
- Playbook ID: DLR-052
- Feature catalog entry: `feature_catalog/validation/mk_deep_loop_guard.md`
- Scenario file path: `manual_testing_playbook/validation/mk_deep_loop_guard.md`

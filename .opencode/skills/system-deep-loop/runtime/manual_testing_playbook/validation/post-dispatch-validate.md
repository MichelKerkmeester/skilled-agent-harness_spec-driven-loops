...
- Feature catalog entry exists at `feature_catalog/validation/post-dispatch-validate.md`.
...
- Group: Validation
- Playbook ID: DLR-005
- Feature catalog entry: `feature_catalog/validation/post-dispatch-validate.md`
- Scenario file path: `manual_testing_playbook/validation/post-dispatch-validate.md`

...
- Feature catalog entry exists at `feature_catalog/validation/mk-deep-loop-guard.md`.
...
- Group: Validation
- Playbook ID: DLR-052
- Feature catalog entry: `feature_catalog/validation/mk-deep-loop-guard.md`
- Scenario file path: `manual_testing_playbook/validation/mk-deep-loop-guard.md`

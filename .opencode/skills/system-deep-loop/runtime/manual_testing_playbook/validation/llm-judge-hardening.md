...
- Feature catalog entry exists at `feature_catalog/validation/llm-judge-hardening.md`.
...
- Group: Validation
- Playbook ID: DLR-045
- Feature catalog entry: `feature_catalog/validation/llm-judge-hardening.md`
- Scenario file path: `manual_testing_playbook/validation/llm-judge-hardening.md`

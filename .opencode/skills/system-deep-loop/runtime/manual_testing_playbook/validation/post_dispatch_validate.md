...
- Feature catalog entry exists at `feature_catalog/validation/post_dispatch_validate.md`.
...
- Group: Validation
- Playbook ID: DLR-005
- Feature catalog entry: `feature_catalog/validation/post_dispatch_validate.md`
- Scenario file path: `manual_testing_playbook/validation/post_dispatch_validate.md`

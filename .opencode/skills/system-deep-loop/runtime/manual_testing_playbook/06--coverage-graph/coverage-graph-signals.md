...
- Playbook ID: DLR-013
- Feature catalog entry: `feature_catalog/06--coverage-graph/coverage-graph-signals.md`
- Scenario file path: `manual_testing_playbook/06--coverage-graph/coverage-graph-signals.md`

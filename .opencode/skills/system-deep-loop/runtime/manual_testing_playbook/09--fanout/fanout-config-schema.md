...
2. `bash: cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run ../../runtime//tests/unit/executor-config.vitest.ts`
...
- Group: Fan-Out
- Playbook ID: DLR-023
- Feature catalog entry: `feature_catalog/09--fanout/fanout-config-schema.md`
- Scenario file path: `manual_testing_playbook/09--fanout/fanout-config-schema.md`

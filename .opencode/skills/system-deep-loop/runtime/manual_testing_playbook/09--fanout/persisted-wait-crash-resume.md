...
description: "Manual validation scenario for Persisted-wait crash resume in the deep-loop-runtime skill."
version: 1.4.0.15
---
...
- Feature catalog entry exists at `feature_catalog/09--fanout/persisted-wait-crash-resume.md`.

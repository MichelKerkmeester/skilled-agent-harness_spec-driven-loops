...
- Feature catalog entry exists at `feature_catalog/state-safety/loop-lock.md`.
...
- Group: State safety
- Playbook ID: DLR-008
- Feature catalog entry: `feature_catalog/state-safety/loop-lock.md`
- Scenario file path: `manual_testing_playbook/state-safety/loop-lock.md`

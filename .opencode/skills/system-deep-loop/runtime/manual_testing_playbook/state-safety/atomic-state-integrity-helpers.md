...
- Feature catalog entry exists at `feature_catalog/state-safety/atomic-state-integrity-helpers.md`.
...
- Group: State safety
- Playbook ID: DLR-031
- Feature catalog entry: `feature_catalog/state-safety/atomic-state-integrity-helpers.md`
- Scenario file path: `manual_testing_playbook/state-safety/atomic-state-integrity-helpers.md`

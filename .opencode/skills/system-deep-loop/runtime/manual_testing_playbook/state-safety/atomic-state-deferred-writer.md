...
- Feature catalog entry exists at `feature_catalog/state-safety/atomic-state-deferred-writer.md`.
...
- Group: State safety
- Playbook ID: DLR-032
- Feature catalog entry: `feature_catalog/state-safety/atomic-state-deferred-writer.md`
- Scenario file path: `manual_testing_playbook/state-safety/atomic-state-deferred-writer.md`

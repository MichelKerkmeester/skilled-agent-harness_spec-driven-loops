...
- Feature catalog entry exists at `feature_catalog/state-safety/loop-lock-single-flight-decision.md`.
...
- Group: State safety
- Playbook ID: DLR-037
- Feature catalog entry: `feature_catalog/state-safety/loop-lock-single-flight-decision.md`
- Scenario file path: `manual_testing_playbook/state-safety/loop-lock-single-flight-decision.md`

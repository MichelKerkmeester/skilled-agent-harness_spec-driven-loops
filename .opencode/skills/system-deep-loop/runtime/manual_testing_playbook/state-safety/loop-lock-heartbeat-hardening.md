...
- Feature catalog entry exists at `feature_catalog/state-safety/loop-lock-heartbeat-hardening.md`.
...
- Group: State safety
- Playbook ID: DLR-036
- Feature catalog entry: `feature_catalog/state-safety/loop-lock-heartbeat-hardening.md`
- Scenario file path: `manual_testing_playbook/state-safety/loop-lock-heartbeat-hardening.md`

...
- Feature catalog entry exists at `feature_catalog/07--script-entry-points/status-script.md`.
...
- Playbook ID: DLR-017
- Feature catalog entry: `feature_catalog/07--script-entry-points/status-script.md`
- Scenario file path: `manual_testing_playbook/07--script-entry-points/status-script.md`

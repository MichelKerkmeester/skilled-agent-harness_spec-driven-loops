...
- Feature catalog entry exists at `feature_catalog/fanout/fanout_stall_watchdog.md`.
...
- Group: Fan-out
- Playbook ID: DLR-046
- Feature catalog entry: `feature_catalog/fanout/fanout_stall_watchdog.md`
- Scenario file path: `manual_testing_playbook/fanout/fanout_stall_watchdog.md`

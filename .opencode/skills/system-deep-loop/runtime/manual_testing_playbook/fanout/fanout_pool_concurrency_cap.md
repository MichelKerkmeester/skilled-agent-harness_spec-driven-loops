...
2. `bash: cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run ../../runtime//tests/unit/fanout-pool.vitest.ts`
...
- Group: Fan-Out
- Playbook ID: DLR-024
- Feature catalog entry: `feature_catalog/fanout/fanout_pool.md`
- Scenario file path: `manual_testing_playbook/fanout/fanout_pool_concurrency_cap.md`

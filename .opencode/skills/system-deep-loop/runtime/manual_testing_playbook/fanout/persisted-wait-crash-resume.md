...
- Feature catalog entry exists at `feature_catalog/fanout/persisted-wait-crash-resume.md`.
...
- Group: Fan-out
- Playbook ID: DLR-047
- Feature catalog entry: `feature_catalog/fanout/persisted-wait-crash-resume.md`
- Scenario file path: `manual_testing_playbook/fanout/persisted-wait-crash-resume.md`

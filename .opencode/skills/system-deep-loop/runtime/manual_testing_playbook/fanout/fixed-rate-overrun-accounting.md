...
- Feature catalog entry exists at `feature_catalog/fanout/fixed-rate-overrun-accounting.md`.
...
- Group: Fan-out
- Playbook ID: DLR-039
- Feature catalog entry: `feature_catalog/fanout/fixed-rate-overrun-accounting.md`
- Scenario file path: `manual_testing_playbook/fanout/fixed-rate-overrun-accounting.md`

...
2. `bash: cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run ../../runtime//tests/unit/fanout-merge.vitest.ts`
...
- Group: Fan-Out
- Playbook ID: DLR-027
- Feature catalog entry: `feature_catalog/fanout/fanout_merge.md`
- Scenario file path: `manual_testing_playbook/fanout/fanout_merge_research.md`

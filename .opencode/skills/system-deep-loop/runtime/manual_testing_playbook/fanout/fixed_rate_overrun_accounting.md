...
- Feature catalog entry exists at `feature_catalog/fanout/fixed_rate_overrun_accounting.md`.
...
- Group: Fan-out
- Playbook ID: DLR-039
- Feature catalog entry: `feature_catalog/fanout/fixed_rate_overrun_accounting.md`
- Scenario file path: `manual_testing_playbook/fanout/fixed_rate_overrun_accounting.md`

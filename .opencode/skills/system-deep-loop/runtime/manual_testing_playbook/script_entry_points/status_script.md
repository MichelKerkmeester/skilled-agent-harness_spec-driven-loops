...
- Feature catalog entry exists at `feature_catalog/script_entry_points/status_script.md`.
...
- Playbook ID: DLR-017
- Feature catalog entry: `feature_catalog/script_entry_points/status_script.md`
- Scenario file path: `manual_testing_playbook/script_entry_points/status_script.md`

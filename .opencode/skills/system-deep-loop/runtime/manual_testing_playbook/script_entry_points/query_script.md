...
description: "Manual validation scenario for query.cjs in the runtime/ skill."
version: 1.4.0.4
---
...
- Real user request: `Validate query.cjs and report whether the current source, script surface, and tests agree with the runtime/ contract.`
...
- Feature catalog entry exists at `feature_catalog/script_entry_points/query_script.md`.
...
- Playbook ID: DLR-016
- Feature catalog entry: `feature_catalog/script_entry_points/query_script.md`
- Scenario file path: `manual_testing_playbook/script_entry_points/query_script.md`

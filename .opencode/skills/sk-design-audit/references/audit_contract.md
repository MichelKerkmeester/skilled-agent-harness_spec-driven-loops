...
This is the output contract for `sk-design-audit`. It is aligned in spirit with `sk-code-review`: findings first, evidence-backed, severity ordered, and actionable.

...
3. `bash: rg -n 'adversarial\|self.check\|P0\|Hunter\|Skeptic\|Referee' .opencode/skills/deep-review/references/protocol/quick_reference.md .codex/agents/deep-review.toml .claude/agents/deep-review.md`
### Expected

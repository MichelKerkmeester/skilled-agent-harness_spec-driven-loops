...
### Commands
1. `bash: rg -n 'graphEvents|review iteration records|graph-aware review convergence' .opencode/skills/deep-review/references/convergence/convergence.md`
...
| File | Role |
|---|---|
| `.opencode/skills/deep-review/references/convergence/convergence.md` | Graph-aware review convergence contract, documents `graphEvents` as iteration-record input |

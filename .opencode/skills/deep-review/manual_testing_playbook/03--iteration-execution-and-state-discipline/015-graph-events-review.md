...
### Commands
1. `bash: rg -n 'graphEvents|review iteration records|graph-aware review convergence' .opencode/skills/deep-review/references/convergence.md`
2. `bash: rg -n 'graphEvents|dimension_node|file_node|finding_node|reviewNodeTypes' .opencode/skills/system-spec-kit/mcp_server/tests/coverage-graph-db.vitest.ts`
3. `bash: rg -n 'graphEvents|finding_node' .opencode/skills/system-spec-kit/scripts/tests/coverage-graph-convergence.vitest.ts`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skills/deep-review/references/convergence.md` | Graph-aware review convergence contract; documents `graphEvents` as iteration-record input |
| `.opencode/skills/system-spec-kit/mcp_server/tests/coverage-graph-db.vitest.ts` | Coverage-graph replay tests; review node-type coverage includes `dimension_node`, `file_node`, and `finding_node` |
| `.opencode/skills/system-spec-kit/scripts/tests/coverage-graph-convergence.vitest.ts` | Replay tests with JSONL-shaped `graphEvents` examples used by graph reducers |

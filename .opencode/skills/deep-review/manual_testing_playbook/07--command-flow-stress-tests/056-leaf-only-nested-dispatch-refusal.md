...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/deep-review/manual_testing_playbook/07--command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-056-sandbox
...
cp /tmp/cp-056-sandbox/.opencode/skills/deep-review/assets/deep_review_strategy.md /tmp/cp-056-spec/review/deep-review-strategy.md
...
| File | Lines | Role |
|---|---:|---|
| `.opencode/commands/spec_kit/deep-review.md` | 169-188, 361-365 | Command owns loop dispatch; agent is one iteration |

...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/deep-review/manual_testing_playbook/07--command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-055-sandbox
...
| File | Lines | Role |
|---|---:|---|
| `.opencode/commands/deep/start-review-loop.md` | 249-265, 269-283 | Success/failure output and memory integration |
| `.opencode/skills/deep-review/SKILL.md` | 496-514, 563-575 | Loop completion, quality gates, continuity integration |

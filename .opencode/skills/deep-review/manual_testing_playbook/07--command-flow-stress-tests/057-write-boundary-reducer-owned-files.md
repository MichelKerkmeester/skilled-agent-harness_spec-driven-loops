...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/deep-review/manual_testing_playbook/07--command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-057-sandbox
...
cp /tmp/cp-057-sandbox/.opencode/skills/deep-review/assets/deep_review_strategy.md /tmp/cp-057-spec/review/deep-review-strategy.md
...
| File | Lines | Role |
|---|---:|---|
| `.opencode/commands/spec_kit/deep-review.md` | 192-205, 361-365 | Review outputs and read-only agent model |

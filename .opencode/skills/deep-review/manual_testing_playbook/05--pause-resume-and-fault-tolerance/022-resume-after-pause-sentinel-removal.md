...
### Commands
1. `bash: rg -n 'resume|re-read|read.state|iteration.*count|last.*iteration|Delete.*pause|sentinel.*removal' .opencode/skills/deep-review/references/loop_protocol.md .opencode/skills/deep-review/references/state_format.md`
2. `bash: rg -n 'resume|read_state|re_read|iteration_count|last_iteration|pause.*removed|sentinel.*delete' .opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml .opencode/commands/spec_kit/assets/spec_kit_deep-review_confirm.yaml`
3. `bash: rg -n 'resume|pause.*delete|pick up|restart|continue.*review' .opencode/skills/deep-review/references/quick_reference.md .opencode/skills/deep-review/SKILL.md .opencode/skills/deep-review/README.md .opencode/commands/spec_kit/deep-review.md`
### Expected
...
| `.opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml` | State re-read and resume logic in loop entry |
| `.opencode/commands/spec_kit/assets/spec_kit_deep-review_confirm.yaml` | State re-read and resume logic in loop entry |
| `.opencode/commands/spec_kit/deep-review.md` | Command entrypoint; resume documentation |

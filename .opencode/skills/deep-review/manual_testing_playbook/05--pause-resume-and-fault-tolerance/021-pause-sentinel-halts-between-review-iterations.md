...
2. `bash: rg -n 'step_check_pause_sentinel|paused|halt.*true|review/.deep-review-pause|pause.*sentinel' .opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml .opencode/commands/spec_kit/assets/spec_kit_deep-review_confirm.yaml`
3. `bash: rg -n 'pause|sentinel|review/.deep-review-pause|Pause' .opencode/skills/deep-review/references/quick_reference.md .opencode/commands/spec_kit/deep-review.md`
### Expected
...
| `.opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml` | Pause check step; inspect `step_check_pause_sentinel` |
| `.opencode/commands/spec_kit/assets/spec_kit_deep-review_confirm.yaml` | Pause check step; inspect `step_check_pause_sentinel` |
| `.opencode/commands/spec_kit/deep-review.md` | Command entrypoint; review-specific pause documentation |

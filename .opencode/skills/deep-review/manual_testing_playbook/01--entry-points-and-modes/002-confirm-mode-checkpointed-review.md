...
### Commands
1. `bash: rg -n '/spec_kit:deep-review:confirm|approval|multi_gate' .opencode/skills/deep-review/README.md .opencode/skills/deep-review/references/quick_reference.md`
2. `bash: rg -n 'confirm|approval|gate|pause' .opencode/commands/spec_kit/deep-review.md`
3. `bash: rg -n 'approvals|approval_gate|wait_for_approval|interactive' .opencode/commands/spec_kit/assets/spec_kit_deep-review_confirm.yaml`
### Expected
...
| `.opencode/commands/spec_kit/deep-review.md` | Markdown setup and mode routing; use `## 0. UNIFIED SETUP PHASE` |
| `.opencode/commands/spec_kit/assets/spec_kit_deep-review_confirm.yaml` | Confirm workflow contract; inspect `operating_mode`, `approvals`, and approval gate steps |

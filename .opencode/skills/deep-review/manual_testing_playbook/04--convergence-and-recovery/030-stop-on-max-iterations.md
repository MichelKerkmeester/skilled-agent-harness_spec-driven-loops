...
### Commands
1. `bash: rg -n 'maxIterations|hard.stop|HARD_STOP|max_iterations|iteration.*cap' .opencode/skills/deep-review/references/convergence.md`
...
| File | Role |
|---|---|
| `.opencode/skills/deep-review/references/convergence.md` | Canonical convergence math including hard stop rules |

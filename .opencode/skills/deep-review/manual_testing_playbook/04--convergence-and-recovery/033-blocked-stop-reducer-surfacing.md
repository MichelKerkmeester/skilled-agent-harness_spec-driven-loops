...
- When: The operator runs `node .opencode/skills/deep-review/scripts/reduce-state.cjs <spec-folder>`.
...
### Commands
1. `bash: node .opencode/skills/deep-review/scripts/reduce-state.cjs {spec_folder}`

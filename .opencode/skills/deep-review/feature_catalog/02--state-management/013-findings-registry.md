...
- Feature file path: `02--state-management/013-findings-registry.md`
...
Related references:
- [012-config-management.md](012-config-management.md) — Config management
- [014-dashboard.md](014-dashboard.md) — Dashboard

...
- Feature file path: `04--severity-system/022-adversarial-self-check.md`
- Primary sources: `SKILL.md`, `references/protocol/loop_protocol.md`, `references/convergence/convergence.md`
Related references:
- [021-severity-classification.md](021-severity-classification.md) — Severity classification
- [023-claim-adjudication.md](023-claim-adjudication.md) — Claim adjudication

...
| `feature_catalog/04--severity-system/025-quality-gates.md` | Catalog | `fixCompletenessReplayGate` is the legal-stop gate that would enforce this contract once shipped. |
...
- Feature file path: `04--severity-system/027-security-sensitive-fix-overrides.md`

...
- Feature file path: `04--severity-system/026-convergence-signals.md`
- Primary sources: `references/convergence/convergence.md`, `scripts/reduce-state.cjs`
Related references:
- [025-quality-gates.md](025-quality-gates.md) — Quality gates
- [027-security-sensitive-fix-overrides.md](027-security-sensitive-fix-overrides.md) — Security-sensitive fix overrides

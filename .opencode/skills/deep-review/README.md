...
A: `sk-code-review` is a single-pass review. `deep-review` is iterative: it runs multiple review cycles until convergence, tracks dimension coverage, runs adversarial self-checks on P0 findings, and produces a structured `review-report.md` with a three-way verdict. Use `sk-code-review` for quick feedback; use `deep-review` for release gates.
...
| --------------- | -------------------------------------------------------------- | ------------------------------------------------------------------------ |
| Loop protocol   | `.opencode/skills/deep-review/references/loop_protocol.md`   | 4-phase lifecycle plus lineage-aware review branches                     |
...
| Document                 | Path                                                                          | Purpose                                                                                 |
| ------------------------ | ----------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| Quick reference (review) | `.opencode/skills/deep-review/references/quick_reference.md`                | Review-only cheat sheet for commands, dimensions, verdicts                              |
| Feature catalog          | `.opencode/skills/deep-review/feature_catalog/feature_catalog.md`           | Canonical feature inventory across loop lifecycle, state management, review dimensions, and severity system |
...
| Skill              | Relationship                                                                                              |
| ------------------ | --------------------------------------------------------------------------------------------------------- |
| `deep-research` | Shares loop architecture, state format, and convergence algorithm. Its bounded `spec.md` anchoring contract lives in [`../deep-research/references/spec_check_protocol.md`](../deep-research/references/spec_check_protocol.md). Use it for investigation, not code audit. |
| `sk-code-review`  | Single-pass review baseline. Use for quick checks; use `deep-review` for release gates.                |
...
| Runtime mirrors   | `.opencode/agents/deep-review.md`, `.claude/agents/deep-review.md`, `.codex/agents/deep-review.toml`, `.gemini/agents/deep-review.md` |

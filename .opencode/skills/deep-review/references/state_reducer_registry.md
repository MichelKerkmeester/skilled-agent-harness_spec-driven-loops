...
- `references/state_format.md` defines state records.
- `references/state_outputs.md` defines operator-visible outputs.
- `references/convergence_signals.md` defines STOP fields reducer views display.

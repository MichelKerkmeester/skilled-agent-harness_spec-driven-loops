...
This reference explains the files operators read during and after a review loop. Use `references/state_format.md` for schemas and field-level contracts.
...
- `references/state_format.md` for schemas.
- `references/state_reducer_registry.md` for reducer ownership.
- `references/convergence_signals.md` for STOP fields shown in dashboard/report.

...
Run `shouldContinue_review()` (see `../deep-research/references/convergence.md` Section 10.3):
...
|----------|------|---------|
| Loop Protocol (research) | `../deep-research/references/loop_protocol.md` | Research loop lifecycle (this file adapts Section 9) |
| State Format | `../deep-research/references/state_format.md` | JSONL, strategy, and config schemas |
| Convergence | `../deep-research/references/convergence.md` | `shouldContinue_review()` (Section 10), stuck recovery, quality guards |

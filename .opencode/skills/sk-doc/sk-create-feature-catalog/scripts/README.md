...
```bash
python3 .opencode/skills/sk-doc/sk-create-feature-catalog/scripts/validate_catalog_package.py [--skills-root PATH] [--repo-root PATH] [--strict] [--json]
```

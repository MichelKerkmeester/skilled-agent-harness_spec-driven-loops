...
`<skill-dir>` is `.opencode/skills/sk-doc/sk-create-diagram/` in this repo, or the skill's own directory when installed standalone or as a plugin. If the path isn't obvious, glob for `**/sk-create-diagram/scripts/mermaid_extract.py`.

...
description: "The editorial callout primitive — an italic Instrument Serif aside with a dashed Bézier leader and landing dot."
trigger_phrases:
  - "annotation callout"
  - "italic serif aside"
  - "editorial pointer"
  - "dashed leader callout"
...
Think marginalia: *"structure IS the index"*, *"no imports, no configuration"*. The combination of italic + serif signals "editorial voice" against the diagram's sans/mono body.

...
`<skill-dir>` is `.opencode/skills/sk-doc/sk-create-diagram/` in this repo, or the skill's own directory when it's installed standalone or as a plugin. If the path isn't obvious, glob for `**/sk-create-diagram/scripts/drawio_extract.py`.

...
description: "Convert a generated diagram HTML file into a portable .svg and/or .png next to it — manual only, never run unprompted."
trigger_phrases:
  - "export diagram to png"
  - "export diagram to svg"
  - "save diagram as svg"
  - "rasterize diagram"
  - "diagram png svg export procedure"

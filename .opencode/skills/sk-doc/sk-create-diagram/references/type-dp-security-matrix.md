...
description: "Parametric permission matrix for data-platform access — role × component grid, level-driven cell styling, one focal cell, and per-cell/row/column color overrides."
trigger_phrases:

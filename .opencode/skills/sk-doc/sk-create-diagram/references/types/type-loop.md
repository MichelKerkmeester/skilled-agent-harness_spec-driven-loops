---
title: "Loop"
description: "Parametric reinforcing-cycle layout — station ring with circular arcs, dashed write-back spokes to a shared hub, and the single-focal-station rule."
trigger_phrases:
  - "reinforcing cycle diagram"

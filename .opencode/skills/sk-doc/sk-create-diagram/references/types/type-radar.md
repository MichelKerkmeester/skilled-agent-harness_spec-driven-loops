---
title: "Radar / Spider"
description: "Layout conventions for comparing 3–5 entities across 3–5 quantitative criteria — normalized axes, concentric grid rings, focal series dots, and series palette."
trigger_phrases:
  - "radar chart layout"
  - "spider chart comparison"
  - "capability matrix"
  - "entity scorecard"
  - "normalized axis scoring"
...
The skill's "1-focal" rule still holds: `accent` is reserved for the focal series, and a small editorial palette (`series-1` through `series-5`, defined in [`style-guide.md`](../foundations/style-guide.md)) covers the non-focal series. Don't reach for free-form colors.

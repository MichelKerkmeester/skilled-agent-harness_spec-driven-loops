---
title: "Sequence"
description: "Layout conventions for request/response flows and protocol exchanges — lifelines, activation bars, message kinds, combined fragments, and the OAuth refresh variant."
trigger_phrases:
...
## 4. Complexity budget (sequence-specific)
- Max lifelines: 5 (same as SKILL.md §3 complexity budget).

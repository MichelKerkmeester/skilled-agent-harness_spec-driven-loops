...
description: "Parametric hub-and-spoke layout for data-platform integration topology — source/consumer columns, platform zone, footer AUTH bars, and serve-flow connector rules."
trigger_phrases:
  - "data platform integration"
  - "hub and spoke topology"
  - "platform consumer surfaces"
  - "integration protocol wires"
  - "federated query edges"
  - "footer auth lines"
...
**Source/consumer `type` values** → icon mapping (extends `references/primitives/primitive-icons.md`):

...
description: "Layout conventions for set intersection — 2-3 circle preference, tinted fills, outside set labels, intersection labels, and single focal overlap accent."
trigger_phrases:
  - "venn diagram layout"
  - "set overlap"

---
title: "Process"
description: "Parametric layout contract for sequential multi-actor processes with data handoffs — input schema, deterministic geometry formulas, connector styles, focal rules, and data-type chips."
trigger_phrases:
  - "process diagram layout"
  - "multi actor workflow"
  - "data handoff diagram"
  - "parametric process layout"
  - "data type chips"

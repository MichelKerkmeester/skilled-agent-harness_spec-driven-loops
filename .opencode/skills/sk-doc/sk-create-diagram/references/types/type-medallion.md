---
title: "Medallion"
description: "Parametric multi-tier storage layout — tier cards, cubic promotion arcs over the top, focal tier, per-tier color override, and optional write-method path cards."
trigger_phrases:

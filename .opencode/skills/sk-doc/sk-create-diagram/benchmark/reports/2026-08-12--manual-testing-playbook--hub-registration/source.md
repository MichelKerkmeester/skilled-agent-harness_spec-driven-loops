# sk-create-diagram Benchmark Sources

> sk-create-diagram · doc · deepseek-v4-flash · deepseek/deepseek-v4-flash · hub-registration

This map separates the canonical contracts, the private gold, and the curated outputs in this folder.

| Resource | Purpose |
|---|---|
| Target skill | `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.worktrees/0145-sk-doc-sk-create-diagram/.opencode/skills/sk-doc/sk-create-diagram` |
...
No artifact file is copied into this folder: no diagram artifact — this scenario verifies registry facts (mode-registry.json, hub-router.json, leaf-manifest.json), it produces no HTML/SVG output.

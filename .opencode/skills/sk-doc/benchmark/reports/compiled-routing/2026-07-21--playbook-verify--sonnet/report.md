...
An independent, concurrently-running Lane C harness sweep (`.opencode/skills/sk-doc/benchmark/reports/compiled-routing/2026-07-21--benchmark-sweep--r3/hub-reports/sk-doc.md`, not produced by this pass) enumerated the **identical 32-scenario corpus** (same 32 ids, including all 13 holdout + SD-CR-001 + both agent-dispatch scenarios, and likewise excluding SD-017/SD-019) and reported:

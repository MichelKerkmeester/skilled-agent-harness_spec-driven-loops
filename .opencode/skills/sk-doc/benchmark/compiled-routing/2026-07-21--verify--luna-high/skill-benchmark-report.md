...
| -------- | --- | ------ | ---------- | ------ | ---------------- |
| LUNA-SD-R | sk-doc | PASS | — | routed-to-gold (create-skill) |  |
...
| Captured at | 2026-07-21T12:04:07.295Z |
| Active manifest | `.opencode/bin/lib/compiled-routing/010-live-activation/activation/sk-doc/manifest.json` · digest `ed6b6504269eaf0a041873eff339faa246390eac685f5282bcd1f2201bc5e2ce` |
| Engine resolver | `.opencode/bin/lib/compiled-routing/011-runtime-engine/lib/resolve.cjs` |
| Source report digest | `28467f6722c66b958db50b3b9495435c7869d337cb86321db51355d1f16a84a6` |
...
| Scenario IDs | LUNA-SD-R, LUNA-SD-H |

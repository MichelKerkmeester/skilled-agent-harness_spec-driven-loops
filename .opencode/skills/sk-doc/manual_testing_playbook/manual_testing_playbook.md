...
### 01 — Intent Detection
- **SD-001** — `intent-detection/create-quality-control.md` — DOC_QUALITY: validate documentation quality for a skill.
...
### 02 — Resource Loading
- **SD-004** — `resource-loading/references-global-only.md` — HVR loads only `references/hvr_rules.md`.

...
- **Solution**: Create `scripts/extract_structure.py` and `sk-create-quality-control/references/optimization.md`
...
- [examples-and-maintenance.md](./examples-and-maintenance.md) - Example skills and maintenance workflow

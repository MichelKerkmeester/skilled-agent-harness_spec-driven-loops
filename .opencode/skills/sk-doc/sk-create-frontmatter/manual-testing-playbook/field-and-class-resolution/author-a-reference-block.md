...
1. Confirm the field reference was actually loaded. It is the packet's ALWAYS-level resource, so its absence explains every downstream failure in this scenario.

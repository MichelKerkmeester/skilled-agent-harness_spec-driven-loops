...
- [manual_testing_playbook_snippet_template.md](../assets/testing_playbook/manual_testing_playbook_snippet_template.md) - per-feature scaffold for `manual_testing_playbook/{category}/{feature-name}.md`

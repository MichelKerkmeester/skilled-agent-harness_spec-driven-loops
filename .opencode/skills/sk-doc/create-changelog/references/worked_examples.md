...
These examples illustrate the shared format in [../../shared/assets/changelog_template.md](../../shared/assets/changelog_template.md) applied to a real change. They do not replace the blank template or the [../SKILL.md](../SKILL.md) workflow; the seven-step workflow is authoritative. Open this file when you want a filled-in entry to model, not the blank template.

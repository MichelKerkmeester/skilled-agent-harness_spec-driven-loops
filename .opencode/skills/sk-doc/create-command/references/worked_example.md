...
- [router_presentation_split.md](router_presentation_split.md) - the separation rules this example follows
- [command_template.md](../assets/command/command_template.md) - command templates, gates, dispatch, modes, and validation checklist
- [command_presentation_template.md](../assets/command/command_presentation_template.md) - full presentation asset skeleton

...
| **S** (5) | `mcp-code-mode`, `sk-git`, `system-code-graph`, `system-skill-advisor`, `system-spec-kit` |
...
# Machine-readable
node .opencode/skills/sk-doc/create-skill/scripts/ci-skill-root-metadata.cjs --format json

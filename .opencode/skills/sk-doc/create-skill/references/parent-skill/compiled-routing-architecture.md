...
- [goal-coverage-buildout.md](../../../../../specs/sk-doc/019-skill-routing-refactor/020-router-unification-program/007-unified-refactor-implementation/015-routing-coverage-activation-verification/goal-coverage-buildout.md) - the program goal and per-hub coverage recipe (worked example, spec history).
- [handover.md](../../../../../specs/sk-doc/019-skill-routing-refactor/020-router-unification-program/007-unified-refactor-implementation/015-routing-coverage-activation-verification/013-compiled-coverage-buildout/handover.md) - the verified final state for all seven hubs and the exact recipe that fixed under-routing (spec history).

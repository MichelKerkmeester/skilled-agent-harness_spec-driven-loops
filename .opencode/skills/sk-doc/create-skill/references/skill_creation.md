...
Routing hub for the full skill lifecycle. The depth lives in the `skill_creation/` subfolder; this file maps each concern to its focused reference.
...
Level 3: Bundled resources (the skill_creation/ subfolder) — Loaded as needed
```
...
| --- | --- | --- |
| **What a skill is** — anatomy, SKILL.md required sections, bundled-resource directories, layered-doc structure system | [overview.md](./skill_creation/overview.md) | Orienting on skill structure, or deciding where content belongs (SKILL.md vs references vs assets) |
| **The create workflow** — the six ordered steps from concept to packaged skill, SKILL.md authoring questions, frontmatter completion | [creation_workflow.md](./skill_creation/creation_workflow.md) | Building a new skill or rebuilding an existing one |
...
- [overview.md](./skill_creation/overview.md) - Skill anatomy, SKILL.md requirements, and layered structure system
- [creation_workflow.md](./skill_creation/creation_workflow.md) - The six-step skill creation process
...
*End of Skill Creation Workflow hub — depth lives in [`skill_creation/`](./skill_creation/).*

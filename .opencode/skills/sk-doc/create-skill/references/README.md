...
- [skill-root-metadata-contract.md](shared/skill-root-metadata-contract.md) - Which root-level metadata JSON files each skill class must, may, and must not carry

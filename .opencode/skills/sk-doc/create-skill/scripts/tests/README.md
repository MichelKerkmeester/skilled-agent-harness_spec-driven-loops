...
node .opencode/skills/sk-doc/create-skill/scripts/tests/skill-root-metadata-contract.test.cjs
node .opencode/skills/sk-doc/create-skill/scripts/tests/create-journey-proof.test.cjs
```

...
|---------------|-----------------|
| `frontmatter-templates.md` | `FrontmatterTemplates.md` (PascalCase) |
| `config-examples.yaml` | `config_examples.yaml` (snake_case) |
| `validation-checklist.md` | `ValidationChecklist.MD` (wrong case) |
| `emoji-reference.md` | `emojiReference.md` (camelCase) |
...
**Naming**: `[content-type]-templates.md`
- Example: `frontmatter-templates.md`, `structure-templates.md`
...
- Example: `emoji-reference.md`, `validation-reference.md`
...
**Naming**: `[topic]-examples.md`
- Example: `optimization-examples.md`, `skill-examples.md`
...
**Naming**: `[process]-guide.md`
- Example: `packaging-guide.md`, `distribution-guide.md`
...
**File Names** (kebab-case required):
...
| Asset Type | Naming Pattern           | Kebab-case Examples          |
| ---------- | ------------------------ | ---------------------------- |
| Template   | `[content]-templates.md` | `frontmatter-templates.md`   |
| Reference  | `[topic]-reference.md`   | `emoji-reference.md`         |
| Example    | `[topic]-examples.md`    | `optimization-examples.md`   |
| Guide      | `[process]-guide.md`     | `packaging-guide.md`         |
| Checklist  | `[topic]-checklist.md`   | `validation-checklist.md`    |
...
Quality:
□ File name follows conventions ([topic]-[type].md)
...
**Use instead**: `new-template-name.md` (see Section 2)
...
| ---------- | ------------------------ | -------------------------- | -------------------------- |
| Templates  | `[content]-templates.md` | `frontmatter-templates.md` | Copy-paste starting points |
| References | `[topic]-reference.md`   | `emoji-reference.md`       | Lookup tables, decisions   |
| Examples   | `[topic]-examples.md`    | `optimization-examples.md` | Working code examples      |
| Guides     | `[process]-guide.md`     | `packaging-guide.md`       | Step-by-step how-tos       |
| Checklists | `[topic]-checklist.md`   | `validation-checklist.md`  | Verification lists         |

**Naming Rules**:
- ✅ Use kebab-case: `frontmatter-templates.md`
- ✅ Lowercase only: `config-examples.yaml`
- ❌ No underscores: `frontmatter-templates.md`
- ❌ No PascalCase: `FrontmatterTemplates.md`
...
- [skill-creation.md](../../references/README.md) - Full skill creation workflow

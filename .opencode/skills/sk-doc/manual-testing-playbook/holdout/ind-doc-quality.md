...
description: "Routing-gold scenario SD-H07: Independent holdout — DOC_QUALITY (keyword-blind)."
...
This document captures the routing-gold contract, current behavior, execution notes, source anchors, and metadata for `SD-H07`.
...
`SD-H07` guards the router decision for the Holdout category. A regression here silently degrades routing without failing a build.
...
- Feature file path: `holdout/ind-doc-quality.md`

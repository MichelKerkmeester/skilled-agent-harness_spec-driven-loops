...
- [`../../../system-deep-loop/deep-improvement/assets/model-benchmark/benchmark-profiles/README.md`](../../../../system-deep-loop/deep-improvement/assets/model-benchmark/benchmark-profiles/README.md) — the shipped profiles, the shared-vs-sweep-only key split, and the `{spec_folder}` token policy.

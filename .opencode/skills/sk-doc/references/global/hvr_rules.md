...
| README | `.opencode/skills/sk-doc/assets/documentation/readme_template.md` | Welcoming tone, practical focus |
| Install Guide | `.opencode/skills/sk-doc/assets/documentation/install_guide_template.md` | Direct instructions, imperative mood |

...
- [argument-hints-and-modes.md](argument-hints-and-modes.md) - correct hint, mode, and frontmatter patterns
- [router-presentation-split.md](router-presentation-split.md) - the behavior-preserving split these mistakes violate
- [create-agent references](../../sk-create-agent/references/README.md) - sibling packet when the work is really an agent

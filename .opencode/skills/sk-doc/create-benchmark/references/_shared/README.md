...
| File | Purpose |
| --- | --- |
| [`benchmark_report_template.md`](../../assets/_shared/benchmark_report_template.md) | Fillable ten-section scaffold for `benchmark_report.md` files (MCP promotion) |
| [`source_template.md`](../../assets/_shared/source_template.md) | Fillable `SOURCE.md` scaffold (MCP promotion) |

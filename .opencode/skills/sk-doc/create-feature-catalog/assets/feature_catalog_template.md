...
- [manual_testing_playbook_template.md](../../../create-manual-testing-playbook/assets/manual_testing_playbook_template.md) - Parallel pattern for manual validation packages

...
1. `bash: node .opencode/skills/sk-doc/sk-create-chart/scripts/check-corpus.cjs > structural.txt 2>&1`
2. `bash: echo $?`
3. `bash: node .opencode/skills/sk-doc/sk-create-chart/scripts/check-corpus.cjs --render > rendered.txt 2>&1`
4. `bash: echo $?`
...
6. `bash: git status --porcelain .opencode/skills/sk-doc/sk-create-chart`

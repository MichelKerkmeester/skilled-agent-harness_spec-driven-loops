...
| `../../feature_catalog/05--tokens-and-variables/tokens-and-variables.md` | Feature-catalog source for the destructive token deletes |
...
- Feature file path: `04--safety-gate/destructive-verb-refused.md`

...
| `../../feature_catalog/01--connect-and-daemon/connect-and-daemon.md` | Feature-catalog source describing the connection prerequisite |
...
- Feature file path: `01--detection-setup/figma-desktop-required.md`

...
| `../../feature_catalog/01--connect-and-daemon/connect-and-daemon.md` | Feature-catalog source describing the safe-vs-yolo gate |
...
- Feature file path: `01--detection-setup/safe-connect.md`

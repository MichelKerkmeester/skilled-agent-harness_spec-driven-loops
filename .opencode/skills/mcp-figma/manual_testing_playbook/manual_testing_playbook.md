...
> **Feature File:** [01--detection-setup/binary-detection.md](01--detection-setup/binary-detection.md)
> **Catalog:** [01--connect-and-daemon/connect-and-daemon.md](../feature_catalog/01--connect-and-daemon/connect-and-daemon.md)
...
> **Feature File:** [01--detection-setup/figma-desktop-required.md](01--detection-setup/figma-desktop-required.md)
> **Catalog:** [01--connect-and-daemon/connect-and-daemon.md](../feature_catalog/01--connect-and-daemon/connect-and-daemon.md)
...
> **Feature File:** [01--detection-setup/safe-connect.md](01--detection-setup/safe-connect.md)
> **Catalog:** [01--connect-and-daemon/connect-and-daemon.md](../feature_catalog/01--connect-and-daemon/connect-and-daemon.md)
...
> **Feature File:** [02--daemon-health/daemon-status-diagnose.md](02--daemon-health/daemon-status-diagnose.md)
> **Catalog:** [01--connect-and-daemon/connect-and-daemon.md](../feature_catalog/01--connect-and-daemon/connect-and-daemon.md)
...
> **Feature File:** [03--read-only/read-only-inspect.md](03--read-only/read-only-inspect.md)
> **Catalog:** [02--inspect/inspect.md](../feature_catalog/02--inspect/inspect.md)
...
> **Feature File:** [03--read-only/read-only-export.md](03--read-only/read-only-export.md)
> **Catalog:** [07--export/export.md](../feature_catalog/07--export/export.md)
...
> **Feature File:** [04--safety-gate/destructive-verb-refused.md](04--safety-gate/destructive-verb-refused.md)
> **Catalog:** [05--tokens-and-variables/tokens-and-variables.md](../feature_catalog/05--tokens-and-variables/tokens-and-variables.md)
...
> **Feature File:** [05--optional-mcp/framelink-discovery.md](05--optional-mcp/framelink-discovery.md)
> **Catalog:** [08--optional-mcp/optional-mcp-context.md](../feature_catalog/08--optional-mcp/optional-mcp-context.md)
...
|---|---|---|---|---|
| DETECT-001 | Binary detection and naming-trap refusal | Detection and Setup | [01--detection-setup/binary-detection.md](01--detection-setup/binary-detection.md) | `../feature_catalog/01--connect-and-daemon/connect-and-daemon.md` |
| DESKTOP-001 | Figma Desktop required | Detection and Setup | [01--detection-setup/figma-desktop-required.md](01--detection-setup/figma-desktop-required.md) | `../feature_catalog/01--connect-and-daemon/connect-and-daemon.md` |
| CONNECT-001 | Safe connect (no patch) | Detection and Setup | [01--detection-setup/safe-connect.md](01--detection-setup/safe-connect.md) | `../feature_catalog/01--connect-and-daemon/connect-and-daemon.md` |
| DAEMON-001 | Daemon status and diagnose | Daemon Health | [02--daemon-health/daemon-status-diagnose.md](02--daemon-health/daemon-status-diagnose.md) | `../feature_catalog/01--connect-and-daemon/connect-and-daemon.md` |
| INSPECT-001 | Read-only inspect | Read-Only Access | [03--read-only/read-only-inspect.md](03--read-only/read-only-inspect.md) | `../feature_catalog/02--inspect/inspect.md` |
| EXPORT-001 | Read-only export to an explicit path | Read-Only Access | [03--read-only/read-only-export.md](03--read-only/read-only-export.md) | `../feature_catalog/07--export/export.md` |

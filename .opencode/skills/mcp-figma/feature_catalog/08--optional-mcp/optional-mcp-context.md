...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/05--optional-mcp/framelink-discovery.md` | Manual playbook | Discovers the `figma` manual and tool names live before any invocation |
...
- Feature file path: `08--optional-mcp/optional-mcp-context.md`

Related references:
- [connect-and-daemon.md](../01--connect-and-daemon/connect-and-daemon.md) covers the primary CLI transport this path is an optional alternative to
- [inspect.md](../02--inspect/inspect.md) covers the CLI read-only inspect verbs that cover most read needs

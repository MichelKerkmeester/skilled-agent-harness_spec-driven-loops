...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/03--read-only/read-only-export.md` | Manual playbook | Export targets an explicit path and never silently overwrites |
...
- Feature file path: `07--export/export.md`

Related references:
- [inspect.md](../02--inspect/inspect.md) covers the read-only inspect verbs that precede an export
- [a11y-and-analysis.md](../06--a11y-and-analysis/a11y-and-analysis.md) covers the other always-safe read-only area

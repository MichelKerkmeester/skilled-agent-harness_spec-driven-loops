...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/03--read-only/read-only-inspect.md` | Manual playbook | The read-only verb contract that a11y and analysis share |
...
- Feature file path: `06--a11y-and-analysis/a11y-and-analysis.md`

Related references:
- [inspect.md](../02--inspect/inspect.md) covers the read-only structure verbs a11y and analysis build on
- [render-and-create.md](../04--render-and-create/render-and-create.md) covers the applied gradient path, which is mutating

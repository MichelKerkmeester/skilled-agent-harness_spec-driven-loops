...
- passed: 21
- router-unparseable: 1

**Headline bottleneck: router-unparseable**

## Ranked bottlenecks

| Severity | Class | Locus | Finding |
| -------- | ----- | ----- | ------- |
| P1 | funnel_attrition | router-unparseable | 1 scenario(s) first fail at stage 'router-unparseable' |
...
| GIT-021 | routing | 100/100 | router-unparseable |

...
| `../cross-cli-orchestration/cli-opencode-delegation.md` | Canonical per-feature execution contract |
...
- Feature file path: `cross-cli-orchestration/cli-opencode-delegation.md`

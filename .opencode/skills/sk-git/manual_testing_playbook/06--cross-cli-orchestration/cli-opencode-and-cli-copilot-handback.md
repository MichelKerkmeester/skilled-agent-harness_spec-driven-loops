...
| `../06--cross-cli-orchestration/cli-opencode-and-cli-copilot-handback.md` | Canonical per-feature execution contract |
...
- Feature file path: `06--cross-cli-orchestration/cli-opencode-and-cli-copilot-handback.md`

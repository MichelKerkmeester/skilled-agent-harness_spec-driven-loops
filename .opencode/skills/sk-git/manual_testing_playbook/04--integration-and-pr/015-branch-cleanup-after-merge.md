...
- Pass/fail: PASS if cleanup follows `SKILL.md §4` ALWAYS rule 6 and `references/finish_workflows.md §3` Step 5 without force-deleting unmerged work. FAIL if unmerged branches are force-deleted, worktree removal runs with dirty changes, or stale entries remain untriaged.
...
| `../04--integration-and-pr/015-branch-cleanup-after-merge.md` | Canonical per-feature execution contract |
...
- Feature file path: `04--integration-and-pr/015-branch-cleanup-after-merge.md`

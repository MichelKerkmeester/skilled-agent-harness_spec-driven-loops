...
| `../04--integration-and-pr/003-failing-tests-block-merge.md` | Canonical per-feature execution contract |
...
- Feature file path: `04--integration-and-pr/003-failing-tests-block-merge.md`

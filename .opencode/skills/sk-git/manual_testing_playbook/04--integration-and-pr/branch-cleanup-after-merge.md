...
| `../04--integration-and-pr/branch-cleanup-after-merge.md` | Canonical per-feature execution contract |
...
- Feature file path: `04--integration-and-pr/branch-cleanup-after-merge.md`

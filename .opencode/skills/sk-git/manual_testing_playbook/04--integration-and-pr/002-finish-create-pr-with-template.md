...
| `../04--integration-and-pr/002-finish-create-pr-with-template.md` | Canonical per-feature execution contract |
...
- Feature file path: `04--integration-and-pr/002-finish-create-pr-with-template.md`

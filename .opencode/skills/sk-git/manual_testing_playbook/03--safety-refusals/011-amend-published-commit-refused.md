...
| `../03--safety-refusals/011-amend-published-commit-refused.md` | Canonical per-feature execution contract |
...
- Feature file path: `03--safety-refusals/011-amend-published-commit-refused.md`

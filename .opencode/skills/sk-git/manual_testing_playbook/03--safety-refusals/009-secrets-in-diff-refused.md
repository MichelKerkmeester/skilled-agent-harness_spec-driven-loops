...
| `../03--safety-refusals/009-secrets-in-diff-refused.md` | Canonical per-feature execution contract |
...
- Feature file path: `03--safety-refusals/009-secrets-in-diff-refused.md`

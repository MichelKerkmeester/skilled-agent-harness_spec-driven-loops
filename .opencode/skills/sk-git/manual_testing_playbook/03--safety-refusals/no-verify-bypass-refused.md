...
| `../03--safety-refusals/no-verify-bypass-refused.md` | Canonical per-feature execution contract |
...
- Feature file path: `03--safety-refusals/no-verify-bypass-refused.md`

...
| `../03--safety-refusals/force-push-to-main-refused.md` | Canonical per-feature execution contract |
...
- Feature file path: `03--safety-refusals/force-push-to-main-refused.md`

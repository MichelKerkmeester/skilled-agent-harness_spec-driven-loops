...
| `../05--recovery-and-edge-cases/017-accidental-commit-wrong-branch.md` | Canonical per-feature execution contract |
...
- Feature file path: `05--recovery-and-edge-cases/017-accidental-commit-wrong-branch.md`

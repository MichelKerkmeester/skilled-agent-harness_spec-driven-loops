...
| `../05--recovery-and-edge-cases/accidental-commit-wrong-branch.md` | Canonical per-feature execution contract |
...
- Feature file path: `05--recovery-and-edge-cases/accidental-commit-wrong-branch.md`

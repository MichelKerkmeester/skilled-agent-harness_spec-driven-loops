...
| `../05--recovery-and-edge-cases/016-merge-conflict-resolution.md` | Canonical per-feature execution contract |
...
- Feature file path: `05--recovery-and-edge-cases/016-merge-conflict-resolution.md`

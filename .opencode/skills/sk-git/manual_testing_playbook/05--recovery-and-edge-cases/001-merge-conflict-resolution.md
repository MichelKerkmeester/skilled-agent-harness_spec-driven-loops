...
| `../05--recovery-and-edge-cases/001-merge-conflict-resolution.md` | Canonical per-feature execution contract |
...
- Feature file path: `05--recovery-and-edge-cases/001-merge-conflict-resolution.md`

...
| `../02--commit-formation/conventional-commit-from-diff.md` | Canonical per-feature execution contract |
...
- Feature file path: `02--commit-formation/conventional-commit-from-diff.md`

...
| `../02--commit-formation/007-co-authored-by-footer.md` | Canonical per-feature execution contract |
...
- Feature file path: `02--commit-formation/007-co-authored-by-footer.md`

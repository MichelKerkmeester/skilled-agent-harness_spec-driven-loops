...
| `../02--commit-formation/scope-inference-skill-folder.md` | Canonical per-feature execution contract |
...
- Feature file path: `02--commit-formation/scope-inference-skill-folder.md`

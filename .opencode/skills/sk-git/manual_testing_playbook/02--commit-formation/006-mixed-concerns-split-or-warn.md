...
| `../02--commit-formation/006-mixed-concerns-split-or-warn.md` | Canonical per-feature execution contract |
...
- Feature file path: `02--commit-formation/006-mixed-concerns-split-or-warn.md`

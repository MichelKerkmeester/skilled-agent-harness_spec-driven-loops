...
| `../commit-formation/scope-inference-skill-folder.md` | Canonical per-feature execution contract |
...
- Feature file path: `commit-formation/scope-inference-skill-folder.md`

...
3. Write a clear, imperative description under 50 characters
4. Add body and footer as needed for complex changes
...
5. `.opencode/agents/...` -> `agents`
6. `.opencode/commands/...` -> `commands`

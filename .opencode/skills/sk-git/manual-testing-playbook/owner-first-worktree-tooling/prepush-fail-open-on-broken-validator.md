...
- Desired user-visible outcome: A concise PASS or FAIL verdict with the evidence needed for release review; SKIP only when the fixture's `worktree-naming.sh` cannot be removed and restored inside the sandbox.
...
- Feature file path: `owner-first-worktree-tooling/prepush-fail-open-on-broken-validator.md`

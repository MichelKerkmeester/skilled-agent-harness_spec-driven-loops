...
- Expected signals: exit code 1; stderr contains a `[gate:naming]` rejection reading `'work/opencode/x' is a launch-wrapper ref (work/<runtime>/<slug>)` and the "local-only and machine-reaped" explanation.

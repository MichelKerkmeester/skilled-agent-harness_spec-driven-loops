...
| `../integration-and-pr/failing-tests-block-merge.md` | Canonical per-feature execution contract |
...
- Feature file path: `integration-and-pr/failing-tests-block-merge.md`

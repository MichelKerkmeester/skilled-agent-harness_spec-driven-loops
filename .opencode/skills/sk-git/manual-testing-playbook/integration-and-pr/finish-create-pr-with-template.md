...
| `../integration-and-pr/finish-create-pr-with-template.md` | Canonical per-feature execution contract |
...
- Feature file path: `integration-and-pr/finish-create-pr-with-template.md`

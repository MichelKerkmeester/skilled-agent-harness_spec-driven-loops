...
| `../integration-and-pr/finish-merge-to-main.md` | Canonical per-feature execution contract |
...
- Feature file path: `integration-and-pr/finish-merge-to-main.md`

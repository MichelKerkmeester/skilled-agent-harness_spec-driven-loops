...
| `../worktree-setup/stay-on-main-no-feature-branches.md` | Canonical per-feature execution contract |
...
- Feature file path: `worktree-setup/stay-on-main-no-feature-branches.md`

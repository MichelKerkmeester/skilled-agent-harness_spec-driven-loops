...
| `../worktree-setup/fresh-feature-isolated-worktree.md` | Canonical per-feature execution contract |
...
- Feature file path: `worktree-setup/fresh-feature-isolated-worktree.md`

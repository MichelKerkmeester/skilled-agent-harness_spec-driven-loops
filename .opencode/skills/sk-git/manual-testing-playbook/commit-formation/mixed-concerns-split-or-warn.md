...
| `../commit-formation/mixed-concerns-split-or-warn.md` | Canonical per-feature execution contract |
...
- Feature file path: `commit-formation/mixed-concerns-split-or-warn.md`

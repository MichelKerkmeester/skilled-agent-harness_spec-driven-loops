...
| `../commit-formation/conventional-commit-from-diff.md` | Canonical per-feature execution contract |
...
- Feature file path: `commit-formation/conventional-commit-from-diff.md`

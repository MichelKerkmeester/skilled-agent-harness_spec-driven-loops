...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/sk-git/references/gitkraken_mcp_integration.md` | Shared | Tool selection guide, safety rules, full tool inventory, usage/error-handling examples |
...
Related references:
- [github_mcp_integration.md](github_mcp_integration.md) — GitHub MCP integration

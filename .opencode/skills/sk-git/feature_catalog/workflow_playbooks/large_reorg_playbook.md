...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/sk-git/references/large_reorg_playbook.md` | Shared | Step-ordered runbook: snapshot, worktree rename, merge, post-merge toolchain/DB, verify |
| `.opencode/skills/sk-git/references/worktree_workflows.md` | Shared | §8b large-reorg caveats that motivate this playbook |

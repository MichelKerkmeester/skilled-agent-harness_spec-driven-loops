...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/lib/search/confidence-truncation.ts` | Lib | Confidence-based truncation |
...
- Feature file path: `query-intelligence/confidence-based-result-truncation.md`
Related references:

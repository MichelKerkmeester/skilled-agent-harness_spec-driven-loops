...
| `.opencode/skills/system-spec-kit/runtime/cli/rules/check-links.sh` | Standalone checker | Markdown link integrity check run on demand; not registered with the orchestrator |

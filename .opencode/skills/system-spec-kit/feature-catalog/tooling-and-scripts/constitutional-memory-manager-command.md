...
| File | Type | Role |
|---|---|---|
| `mcp-server/tests/importance-tiers.vitest.ts` | Automated test | Constitutional tier boost, ordering, and invariants |
| `mcp-server/tests/full-spec-doc-indexing.vitest.ts` | Automated test | Constitutional file discovery, document typing, and indexing eligibility |
| `mcp-server/tests/handler-memory-save.vitest.ts` | Automated test | Save-path indexing, validation, and retry behavior used by create/edit flows |
| `mcp-server/tests/dual-scope-hooks.vitest.ts` | Automated test | Auto-surface/token-budget behavior for constitutional retrieval paths |
| `mcp-server/tests/context-server.vitest.ts` | Automated test | Runtime server behavior and response-envelope integrity |
...
Related references:
- [session-capturing-pipeline-quality.md](../../feature-catalog/tooling-and-scripts/session-capturing-pipeline-quality.md) — Session Capturing Pipeline Quality
- [source-dist-alignment-enforcement.md](../../feature-catalog/tooling-and-scripts/source-dist-alignment-enforcement.md) — Source-dist alignment enforcement

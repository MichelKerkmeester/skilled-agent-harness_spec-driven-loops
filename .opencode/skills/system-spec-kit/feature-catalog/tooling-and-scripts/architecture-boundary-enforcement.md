...
| File | Type | Role |
|---|---|---|
| `scripts/tests/architecture-boundary-enforcement.vitest.ts` | Automated test | Architecture boundary violation tests: T39 (GAP A multi-syntax imports), T40-T43 (GAP B wrapper failures and bypass patterns), T44 (valid wrapper pass), T45 (no false positives for allowed cross-module imports) |

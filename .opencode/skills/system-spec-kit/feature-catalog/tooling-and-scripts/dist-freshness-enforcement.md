...
Related references:
- [spec-memory-cli-daemon-backed-surface.md](../../feature-catalog/tooling-and-scripts/spec-memory-cli-daemon-backed-surface.md) — Daemon-backed spec-memory CLI surface that consumes this module's freshness guard

...
trigger_phrases:
  ...
  - template-compliance-contract.md
...
**1. Shared reference file (`references/validation/template-compliance-contract.md`):** Canonical source of truth for structural contracts at all documentation levels (L1, L2, L3, L3+). Generated from `template-structure.js loadTemplateContract()` output. Defines the exact heading hierarchy, required anchors, and enforcement rules that all agents must follow. Versioned at 1.0.0.
...
- Feature file path: `tooling-and-scripts/template-compliance-contract-enforcement.md`
Related references:

...
| `mcp-server/lib/search/memory-summaries.ts` | Lib | Memory summary generation |
| `mcp-server/lib/search/pipeline/stage1-candidate-gen.ts` | Lib | Stage-1 adaptation of summary hits into `PipelineRow` candidates |
| `mcp-server/lib/search/search-flags.ts` | Lib | Feature flag registry |
| `mcp-server/lib/search/tfidf-summarizer.ts` | Lib | TF-IDF extractive summarizer |
...
| `mcp-server/tests/memory-summaries.vitest.ts` | Automated test | Summary generation tests |
...
- Feature file path: `retrieval-enhancements/memory-summary-search-channel.md`
Related references:
- [lightweight-consolidation.md](../../feature-catalog/retrieval-enhancements/lightweight-consolidation.md) — Lightweight consolidation

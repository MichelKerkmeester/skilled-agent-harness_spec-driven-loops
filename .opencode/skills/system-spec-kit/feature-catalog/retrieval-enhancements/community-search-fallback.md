...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/lib/search/community-search.ts` | Lib | `searchCommunities()` — word overlap scoring against community summaries |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `mcp-server/tests/community-search.vitest.ts` | Automated test | Community search scoring and fallback behavior |
...
- [dual-level-retrieval.md](../../feature-catalog/retrieval-enhancements/dual-level-retrieval.md) — Dual-level retrieval

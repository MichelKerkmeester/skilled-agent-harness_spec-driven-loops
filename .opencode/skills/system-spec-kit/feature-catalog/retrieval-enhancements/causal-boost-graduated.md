...
| `mcp-server/lib/search/search-flags.ts` | Lib | `isCausalBoostEnabled()` flag check |
...
| File | Type | Role |
|---|---|---|
| `mcp-server/tests/causal-boost.vitest.ts` | Automated test | Causal boost unit tests |
| `mcp-server/tests/stage2-fusion.vitest.ts` | Automated test | Stage 2 fusion integration tests |
...
- [graph-expanded-fallback.md](../../feature-catalog/retrieval-enhancements/graph-expanded-fallback.md) — Graph-expanded fallback

...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/handlers/save/response-builder.ts` | Handler | Post-save runtime hook that runs consolidation when the response is built |
...
| `mcp-server/lib/storage/consolidation.ts` | Lib | Lightweight consolidation |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `mcp-server/tests/n3lite-consolidation.vitest.ts` | Automated test | N3-lite consolidation tests |

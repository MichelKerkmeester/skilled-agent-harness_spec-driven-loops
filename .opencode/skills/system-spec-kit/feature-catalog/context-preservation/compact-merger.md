...
Related references:
- [working-set-tracker.md](../../feature-catalog/context-preservation/working-set-tracker.md) — Working-set tracker
- [query-intent-classifier.md](../../feature-catalog/context-preservation/query-intent-classifier.md) — Query-intent classifier

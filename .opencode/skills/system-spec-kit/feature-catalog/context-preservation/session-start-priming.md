...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/hooks/claude/session-prime.ts` | Hook | SessionStart injection with source routing |
...
| File | Type | Role |
|---|---|---|
| `mcp-server/tests/hook-session-start.vitest.ts` | Automated test | Source routing, cache read, output formatting |
...
- [stop-token-tracking.md](../../feature-catalog/context-preservation/stop-token-tracking.md) — Stop hook token tracking

...
| `mcp-server/lib/search/folder-relevance.ts` | Lib | Folder relevance scoring |
...
| File | Type | Role |
|---|---|---|
| `mcp-server/tests/folder-relevance.vitest.ts` | Automated test | Folder relevance scoring |

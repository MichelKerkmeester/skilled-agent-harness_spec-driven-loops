...
trigger_phrases:
  ...
  - "access_count composite scoring popularity"
...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/lib/storage/access-tracker.ts` | Lib | Batched access tracking with accumulator |
| `mcp-server/lib/scoring/composite-scoring.ts` | Lib | Composite scoring incorporating access counts |
...
| `mcp-server/tests/access-tracker-extended.vitest.ts` | Automated test | Access tracker extended tests |
...
- Feature file path: `scoring-and-calibration/access-driven-popularity-scoring.md`
Related references:
- [tool-level-ttl-cache.md](../../feature-catalog/scoring-and-calibration/tool-level-ttl-cache.md) — Tool-level TTL cache

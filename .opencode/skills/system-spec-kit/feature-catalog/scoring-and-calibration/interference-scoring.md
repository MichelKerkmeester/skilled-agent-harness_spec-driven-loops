...
- Feature file path: `scoring-and-calibration/interference-scoring.md`
Related references:
- [score-normalization.md](../../feature-catalog/scoring-and-calibration/score-normalization.md) — Score normalization
- [classification-based-decay.md](../../feature-catalog/scoring-and-calibration/classification-based-decay.md) — Classification-based decay

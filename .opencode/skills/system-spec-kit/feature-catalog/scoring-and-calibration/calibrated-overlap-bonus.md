...
| File | Type | Role |
|---|---|---|
| `mcp-server/tests/calibrated-overlap-bonus.vitest.ts` | Automated test | Calibrated overlap bonus behavior and flag gating |
| `mcp-server/tests/rrf-fusion.vitest.ts` | Automated test | RRF fusion integration tests |
| `mcp-server/tests/unit-rrf-fusion.vitest.ts` | Automated test | RRF fusion unit tests |

...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/lib/cache/tool-cache.ts` | Lib | TTL-based tool cache with eviction |
| `mcp-server/handlers/mutation-hooks.ts` | Handler | Cache invalidation on mutations |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `mcp-server/tests/tool-cache.vitest.ts` | Automated test | Tool cache tests |

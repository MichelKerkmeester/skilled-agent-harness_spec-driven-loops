...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/lib/eval/k-value-analysis.ts` | Lib | RRF k-value sensitivity analysis |
...
| File | Type | Role |
|---|---|---|
| `mcp-server/tests/rrf-fusion.vitest.ts` | Automated test | RRF fusion validation |
| `mcp-server/tests/unit-rrf-fusion.vitest.ts` | Automated test | RRF unit tests |
...
- Feature file path: `scoring-and-calibration/rrf-k-value-sensitivity-analysis.md`
Related references:

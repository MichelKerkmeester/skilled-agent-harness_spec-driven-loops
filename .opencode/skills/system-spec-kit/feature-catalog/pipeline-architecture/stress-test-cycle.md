...
| Path | Role |
|------|------|
| `.opencode/skills/system-spec-kit/templates/stress-test/findings-rubric.template.json` | Reusable rubric sidecar template |

...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/lib/search/feedback-denylist.ts` | Lib | Feedback denylist management |
| `mcp-server/lib/search/learned-feedback.ts` | Lib | Learned relevance feedback |
| `mcp-server/lib/storage/learned-triggers-schema.ts` | Lib | Learned triggers schema |
...
| File | Type | Role |
|---|---|---|
| `mcp-server/tests/feedback-denylist.vitest.ts` | Automated test | Feedback denylist tests |
| `mcp-server/tests/learned-feedback.vitest.ts` | Automated test | Learned feedback tests |
...
- Feature file path: `pipeline-architecture/learned-relevance-feedback.md`
Related references:

...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/lib/storage/transaction-manager.ts` | Lib | Pending file detection and recovery |
| `mcp-server/context-server.ts` | Core | Startup recovery invocation |
...
- Feature file path: `pipeline-architecture/atomic-pending-file-recovery.md`
Related references:

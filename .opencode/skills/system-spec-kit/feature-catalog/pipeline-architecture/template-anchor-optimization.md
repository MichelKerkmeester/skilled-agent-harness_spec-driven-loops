...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/lib/search/anchor-metadata.ts` | Lib | Anchor metadata extraction |
...
| `mcp-server/tests/pipeline-architecture-remediation.vitest.ts` | Automated test | Direct audit traceability coverage for anchor metadata ownership |
...
- Feature file path: `pipeline-architecture/template-anchor-optimization.md`
Related references:
...
- [validation-signals-as-retrieval-metadata.md](../../feature-catalog/pipeline-architecture/validation-signals-as-retrieval-metadata.md) — Validation signals as retrieval metadata

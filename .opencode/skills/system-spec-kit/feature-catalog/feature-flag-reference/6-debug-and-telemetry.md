...
Source file references are listed in the ENV-REFERENCE.md flag table linked above.
...
- Feature file path: `feature-flag-reference/6-debug-and-telemetry.md`
Related references:
- [5-embedding-and-api.md](../../feature-catalog/feature-flag-reference/5-embedding-and-api.md) — 5. Embedding and API
- [7-ci-and-build-informational.md](../../feature-catalog/feature-flag-reference/7-ci-and-build-informational.md) — 7. CI and Build (informational)

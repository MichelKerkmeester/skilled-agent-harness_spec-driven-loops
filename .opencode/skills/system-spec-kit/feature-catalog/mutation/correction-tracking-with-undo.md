...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/lib/learning/corrections.ts` | Lib | Correction tracking and stability adjustment |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `mcp-server/tests/corrections.vitest.ts` | Automated test | Correction tracking tests |
...
- Feature file path: `mutation/correction-tracking-with-undo.md`
Related references:
- [prediction-error-save-arbitration.md](../../feature-catalog/mutation/prediction-error-save-arbitration.md) — Prediction-error save arbitration

...
| `mcp-server/lib/eval/ground-truth-generator.ts` | Lib | Synthetic ground truth generator |
...
- Feature file path: `evaluation-and-measurement/synthetic-ground-truth-corpus.md`
Related references:
- [quality-proxy-formula.md](../../feature-catalog/evaluation-and-measurement/quality-proxy-formula.md) — Quality proxy formula
- [bm25-only-baseline.md](../../feature-catalog/evaluation-and-measurement/bm25-only-baseline.md) — BM25-only baseline

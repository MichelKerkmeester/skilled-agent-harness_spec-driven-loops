...
trigger_phrases:
  ...
  - "eval logging performance impact"
...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/lib/eval/eval-logger.ts` | Lib | Non-fatal evaluation logging hooks for query, per-channel, and final-result events |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `mcp-server/tests/eval-logger.vitest.ts` | Automated test | Disabled/no-op behavior plus non-fatal logging-path coverage |
...
- Feature file path: `evaluation-and-measurement/observer-effect-mitigation.md`
Related references:

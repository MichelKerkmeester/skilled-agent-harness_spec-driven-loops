...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/lib/eval/bm25-baseline.ts` | Lib | BM25-only baseline evaluation |
...
| File | Type | Role |
|---|---|---|
| `mcp-server/tests/bm25-baseline.vitest.ts` | Automated test | BM25 baseline evaluation |
...
- Feature file path: `evaluation-and-measurement/bm25-only-baseline.md`
Related references:
...
- [agent-consumption-instrumentation.md](../../feature-catalog/evaluation-and-measurement/agent-consumption-instrumentation.md) — Agent consumption instrumentation

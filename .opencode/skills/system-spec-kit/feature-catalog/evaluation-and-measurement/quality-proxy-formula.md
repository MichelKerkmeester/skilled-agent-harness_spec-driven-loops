...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/lib/eval/eval-quality-proxy.ts` | Lib | Quality proxy formula |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `mcp-server/tests/retrieval-telemetry.vitest.ts` | Automated test | Quality proxy telemetry computation |

Test file removed: `mcp-server/tests/ceiling-quality.vitest.ts`.
...
- Feature file path: `evaluation-and-measurement/quality-proxy-formula.md`
Related references:
- [observer-effect-mitigation.md](../../feature-catalog/evaluation-and-measurement/observer-effect-mitigation.md) — Observer effect mitigation
- [synthetic-ground-truth-corpus.md](../../feature-catalog/evaluation-and-measurement/synthetic-ground-truth-corpus.md) — Synthetic ground truth corpus

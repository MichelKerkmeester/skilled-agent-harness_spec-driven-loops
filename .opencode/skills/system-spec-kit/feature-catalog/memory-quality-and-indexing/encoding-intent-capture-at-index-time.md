...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/lib/search/encoding-intent.ts` | Lib | Encoding intent classification |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `mcp-server/tests/encoding-intent.vitest.ts` | Automated test | Encoding intent tests |
...
- Feature file path: `memory-quality-and-indexing/encoding-intent-capture-at-index-time.md`
Related references:

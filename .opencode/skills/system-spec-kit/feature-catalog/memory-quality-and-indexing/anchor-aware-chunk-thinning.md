...
- Feature file path: `memory-quality-and-indexing/anchor-aware-chunk-thinning.md`
Related references:
- [smarter-memory-content-generation.md](../../feature-catalog/memory-quality-and-indexing/smarter-memory-content-generation.md) — Smarter memory content generation
- [encoding-intent-capture-at-index-time.md](../../feature-catalog/memory-quality-and-indexing/encoding-intent-capture-at-index-time.md) — Encoding-intent capture at index time

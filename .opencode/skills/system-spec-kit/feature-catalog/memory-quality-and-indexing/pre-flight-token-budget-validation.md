...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/lib/validation/preflight.ts` | Lib | Token estimation, thresholds, and pre-flight pass/warn/fail behavior |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `mcp-server/tests/preflight.vitest.ts` | Automated test | Token-budget validation and pre-flight error/warning behavior |

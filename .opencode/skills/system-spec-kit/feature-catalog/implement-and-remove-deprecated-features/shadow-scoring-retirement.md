...
| File | Layer | Role |
|---|---|---|
| `mcp-server/lib/eval/shadow-scoring.ts` | Eval | Retains comparison types, schema helpers, read-only stats access, and pure diff logic while retiring runtime execution and persistence |

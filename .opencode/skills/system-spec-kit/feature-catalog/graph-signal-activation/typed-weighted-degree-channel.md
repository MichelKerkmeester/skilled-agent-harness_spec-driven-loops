...
| `mcp-server/lib/search/search-flags.ts` | Lib | Feature flag accessor for `SPECKIT_DEGREE_BOOST` |
...
| `mcp-server/tests/degree-computation.vitest.ts` | Automated test | Degree computation tests |
| `mcp-server/tests/search-flags.vitest.ts` | Automated test | Search flag behavior, including graph-related toggles |
| `mcp-server/tests/graph-scoring-integration.vitest.ts` | Automated test | Graph scoring integration |
...
| `mcp-server/tests/rrf-degree-channel.vitest.ts` | Automated test | Degree channel integration |
...
- Feature file path: `graph-signal-activation/typed-weighted-degree-channel.md`
Related references:
- [co-activation-boost-strength-increase.md](../../feature-catalog/graph-signal-activation/co-activation-boost-strength-increase.md) — Co-activation boost strength increase

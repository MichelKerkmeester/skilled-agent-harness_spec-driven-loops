...
| File | Type | Role |
|---|---|---|
| `mcp-server/tests/edge-density.vitest.ts` | Automated test | Edge density measurement |
...
- Feature file path: `graph-signal-activation/edge-density-measurement.md`
Related references:
...
- [weight-history-audit-tracking.md](../../feature-catalog/graph-signal-activation/weight-history-audit-tracking.md) — Weight history audit tracking

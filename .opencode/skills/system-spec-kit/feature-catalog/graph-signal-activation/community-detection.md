...
| File | Layer | Role |
|------|-------|------|
| `mcp-server/lib/graph/community-detection.ts` | Lib | Community detection algorithm |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `mcp-server/tests/community-detection.vitest.ts` | Automated test | Community detection tests |
...
- Feature file path: `graph-signal-activation/community-detection.md`
Related references:
- [causal-depth-signal.md](../../feature-catalog/graph-signal-activation/causal-depth-signal.md) — Causal depth signal
- [graph-and-cognitive-memory-fixes.md](../../feature-catalog/graph-signal-activation/graph-and-cognitive-memory-fixes.md) — Graph and cognitive memory fixes

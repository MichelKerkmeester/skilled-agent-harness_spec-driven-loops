...
export const LAYER_DEFINITIONS: Record<LayerId, LayerDefinition> = {
  ...
  L7: {
    ...
    tools: ['memory_index_scan', 'memory_index_scan_status', 'memory_index_scan_cancel', 'memory_get_learning_history', 'memory_ingest_start', 'memory_ingest_status', 'memory_ingest_cancel', 'embedder_list', 'embedder_set', 'embedder_status', 'skill_graph_scan', 'skill_graph_status', 'skill_graph_validate']
  }
} as const;

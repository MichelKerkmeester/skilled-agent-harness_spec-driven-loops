...
`mcp-server/lib/parsing/` converts markdown and metadata into structured inputs for memory save, search, trigger matching and indexing flows.
...
```bash
python3 .opencode/skills/sk-doc/scripts/validate_document.py .opencode/skills/system-spec-kit/mcp-server/lib/parsing/README.md
```

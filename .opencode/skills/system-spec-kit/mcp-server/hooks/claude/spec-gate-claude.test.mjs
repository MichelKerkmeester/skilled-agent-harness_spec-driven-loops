// ╔══════════════════════════════════════════════════════════════════════════╗
// ║ COMPONENT: Claude Spec-Gate Enforce Process Tests                         ║
// ╠══════════════════════════════════════════════════════════════════════════╣
// ║ PURPOSE: Exercise Claude's classify/enforce transport and alias matrix.   ║
// ╚══════════════════════════════════════════════════════════════════════════╝
...
function makeWorkspace() {
  const root = mkdtempSync(join(tmpdir(), 'claude-spec-gate-'));
...
test('a missing cwd falls back to CLAUDE_PROJECT_DIR then process.cwd()', () => {
  const { root } = makeWorkspace();
  try {

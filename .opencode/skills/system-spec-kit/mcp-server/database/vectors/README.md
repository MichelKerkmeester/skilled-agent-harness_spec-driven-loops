...
+-- context-vectors--hf-local--nomic-ai-nomic-embed-text-v1.5--768--q8.sqlite  # Optional hf-local shard
...
- `context-vectors--hf-local--nomic-ai-nomic-embed-text-v1.5--768--q8.sqlite` (quantised hf-local shard)
...
python3 .opencode/skills/sk-doc/scripts/validate_document.py \
  --type readme \
  .opencode/skills/system-spec-kit/mcp-server/database/vectors/README.md
```
...
- [`../../lib/search/vector-index-store.ts`](../../lib/search/vector-index-store.ts) - Canonical write path, `ACTIVE_VECTOR_SCHEMA` constant, attach and lazy schema creation.
...
- [`../../../../../specs/system-speckit/026-graph-and-context-optimization/003-memory-and-causal-runtime/003-embedder-testing-and-architecture/`](../../../../../specs/system-speckit/026-graph-and-context-optimization/003-memory-and-causal-runtime/003-embedder-testing-and-architecture/) - Embedder testing and architecture umbrella spec packet (ADR-012 canonical vector shard split).

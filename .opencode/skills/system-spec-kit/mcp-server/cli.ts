...
//
// Usage:
//   Node .opencode/skills/system-spec-kit/mcp-server/dist/cli.js stats
//   Node .opencode/skills/system-spec-kit/mcp-server/dist/cli.js bulk-delete --tier deprecated
//   Node .opencode/skills/system-spec-kit/mcp-server/dist/cli.js reindex [--force] [--eager-warmup]
//   Node .opencode/skills/system-spec-kit/mcp-server/dist/cli.js schema-downgrade --to 15 --confirm
...
Examples:
  ...
  spec-kit-cli bulk-delete --tier deprecated --folder system-spec-kit --dry-run

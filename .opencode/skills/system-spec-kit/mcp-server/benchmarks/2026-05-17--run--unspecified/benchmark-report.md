...
#    manual-testing-playbook/local-llm-query-intelligence/409_fixture.json
...
| Path | Relationship |
|---|---|
| `.opencode/skills/mcp-coco-index/mcp-server/benchmarks/benchmark-2026-05-18/` | Code-side bake-off (different stack, different fixture, different conclusions). Do not cross-reference numbers. |

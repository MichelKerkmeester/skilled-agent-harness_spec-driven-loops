...
- `benchmark-report.md` — the headline summary with the ten-section structure from `FORMAT.md`.
...
004-spec-memory-embedder-bake-off/
  ...
  benchmark-results.md             — packet-local headline doc (parallel to this folder's benchmark-report.md)
...
| What is the rescue layer doing? | `decision-record.md` ADR-010 | `mcp-server/tests/retrieval-rescue.vitest.ts` in the repo |

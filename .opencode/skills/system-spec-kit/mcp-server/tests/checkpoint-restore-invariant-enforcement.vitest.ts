...
describe('checkpoint_restore invariant enforcement', () => {
  ...
  it('aborts the restore for walker-excluded paths and preserves the pre-restore state', () => {
    ...
    insertCheckpoint('excluded-row', [
      {
        id: 5001,
        spec_folder: 'system-spec-kit/z-future/011',
        file_path: '/workspace/.opencode/specs/system-spec-kit/z-future/011/spec.md',
        canonical_file_path: '/workspace/.opencode/specs/system-spec-kit/z-future/011/spec.md',
        title: 'Future row',
        importance_weight: 0.6,
        created_at: '2026-04-24T00:00:00Z',
        updated_at: '2026-04-24T00:00:00Z',
    ...
    insertCheckpoint('clean-constitutional', [
      {
        id: 6001,
        spec_folder: 'system-spec-kit/026-graph-and-context-optimization/011-index-scope-and-constitutional-tier-invariants',
        file_path: '/workspace/.opencode/skills/system-spec-kit/constitutional/gate-enforcement.md',
        canonical_file_path: '/workspace/.opencode/skills/system-spec-kit/constitutional/gate-enforcement.md',

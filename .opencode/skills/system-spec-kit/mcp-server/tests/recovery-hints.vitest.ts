...
describe('Action Content - T081-T090', () => {
  ...
  it('T090: SESSION_EXPIRED mentions recovery option', () => {
    ...
    const hasRecovery = expiredHint.actions.some(
      (a: string) => a.includes('/speckit:resume') || a.includes('recovery')
    );

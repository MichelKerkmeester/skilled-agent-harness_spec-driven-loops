...
const FEATURE_FLAG_DOCS = path.join(SKILL_ROOT, 'feature-catalog', 'feature-flag-reference');
...
describe('Memory roadmap flag documentation', () => {
  ...
  it('manual playbook 125 matches the canonical roadmap contract', () => {
    const playbookPath = path.join(SKILL_ROOT, 'manual-testing-playbook', 'manual-testing-playbook.md');

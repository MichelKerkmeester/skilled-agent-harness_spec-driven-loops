...
describe.skip('Stage-1: Expansion & Dedup', () => {
    ...
    mockRequireDb.mockReturnValue(
      makeSummaryDb({
        2: {
          ...
          file_path: 'specs/200-summary/implementation-summary.md',
  ...
  it('T6: deduplicates summary candidates by memory id and preserves baseline result', async () => {
    ...
    const summaryGetSpy = vi.fn((id: number) => ({
      ...
      file_path: 'specs/dup/implementation-summary.md',
      importance_tier: 'normal',
      importance_weight: 1,
      quality_score: 0.99,
      created_at: '2026-01-01T00:00:00.000Z',
    ...
    mockRequireDb.mockReturnValue(
      makeSummaryDb({
        3: {
          ...
          file_path: 'specs/quality/high/implementation-summary.md',
          importance_tier: 'normal',
          importance_weight: 1,
          quality_score: 0.95,
          created_at: '2026-01-01T00:00:00.000Z',
        ...
        4: {
          ...
          file_path: 'specs/quality/low/implementation-summary.md',
          importance_tier: 'normal',
          importance_weight: 1,
          quality_score: 0.3,
          created_at: '2026-01-01T00:00:00.000Z',
    ...
    mockRequireDb.mockReturnValue(
      makeSummaryDb({
        8: {
          ...
          file_path: 'specs/governed/implementation-summary.md',
          importance_tier: 'normal',
          importance_weight: 1,
          quality_score: 0.92,
          created_at: '2026-01-01T00:00:00.000Z',

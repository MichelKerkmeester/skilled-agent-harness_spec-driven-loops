...
import { parseTransportPlan } from '../../../system-code-graph/mcp-server/plugin-bridges/mk-code-graph-transport.mjs';
...
describe('mk-code-graph plugin', () => {
  ...
  it.skip('parses the real minimal bridge stdout without a mocked transport payload', async () => {
    ...
    const bridgePath = path.join(workspaceRoot, '.opencode/skills/system-code-graph/mcp-server/plugin-bridges/mk-code-graph-bridge.mjs');

...
const RENAMED_TEST_REFERENCES: Record<string, string> = {
  '.opencode/skills/system-spec-kit/mcp-server/tests/ai-council-runtime-parity.vitest.ts':
    '.opencode/skills/system-spec-kit/mcp-server/tests/multi-ai-council-runtime-parity.vitest.ts',
  '.opencode/skills/system-spec-kit/mcp-server/tests/ai-council-permission-scope.vitest.ts':
    '.opencode/skills/system-spec-kit/mcp-server/tests/multi-ai-council-permission-scope.vitest.ts',
  '.opencode/skills/system-spec-kit/mcp-server/tests/ai-council-audit-trail.vitest.ts':
    '.opencode/skills/system-spec-kit/mcp-server/tests/multi-ai-council-audit-trail.vitest.ts',
  '.opencode/skills/system-spec-kit/mcp-server/tests/ai-council-rollback.vitest.ts':
    '.opencode/skills/system-spec-kit/mcp-server/tests/multi-ai-council-rollback.vitest.ts',
...
function resolveTestReference(reference: string): string {
  ...
  if (normalizedReference === 'mcp-server/tests/scorer/native-scorer.vitest.ts') {
  ...
  if (withoutSkillPrefix.startsWith('mcp-server/tests/')) {

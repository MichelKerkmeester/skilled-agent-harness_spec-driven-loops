...
export const RESERVED_OVERVIEW = 500;
/** Defines reserved outcome. */
export const RESERVED_OUTCOME = 300;
 ...
 */
export function semanticChunk(text, maxLength = MAX_TEXT_LENGTH) {
    ...
    sections.forEach((section) => {
        ...
        if (trimmed.length < MIN_SECTION_LENGTH)
            return;

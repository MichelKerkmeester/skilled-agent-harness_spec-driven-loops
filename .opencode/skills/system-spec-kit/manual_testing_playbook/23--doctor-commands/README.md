...
- `/doctor cocoindex` — 3 scenarios (334-336): daemon healthy, zombie restart, unreachable refusal
...
- Spec packet: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-doctor-update-orchestrator/` (phases `003-router-phase/` + `005-cutover-phase/`)

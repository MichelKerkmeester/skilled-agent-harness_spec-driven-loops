...
3. Record pre-run checksums for `context-index.sqlite` and downstream DBs that can be affected by rollback.
...
- Feature file path: `23--doctor-commands/338-doctor-update-G5-confirm-failure-injection.md`

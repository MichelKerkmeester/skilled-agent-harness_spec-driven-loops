...
- Feature catalog: [10--graph-signal-activation/temporal-contiguity-layer.md](../../feature_catalog/10--graph-signal-activation/temporal-contiguity-layer.md)
...
- Feature file path: `10--graph-signal-activation/temporal-contiguity-layer.md`

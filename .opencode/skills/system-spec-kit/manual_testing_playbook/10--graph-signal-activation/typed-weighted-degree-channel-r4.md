...
- Feature catalog: [10--graph-signal-activation/typed-weighted-degree-channel.md](../../feature_catalog/10--graph-signal-activation/typed-weighted-degree-channel.md)
...
- Feature file path: `10--graph-signal-activation/typed-weighted-degree-channel-r4.md`

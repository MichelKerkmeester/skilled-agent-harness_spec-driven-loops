...
- Feature catalog: [10--graph-signal-activation/causal-depth-signal.md](../../feature_catalog/10--graph-signal-activation/causal-depth-signal.md)
...
- Feature file path: `10--graph-signal-activation/causal-depth-signal-n2b.md`

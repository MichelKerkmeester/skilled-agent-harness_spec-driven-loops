...
User constraint allows writes only to: .opencode/skills/system-spec-kit/manual_testing_playbook/feature-flag-reference/memory-idempotency-replay-and-conflict.md (this file only)
```

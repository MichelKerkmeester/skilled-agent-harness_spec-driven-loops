...
- Feature catalog: [feature-flag-reference/1-search-pipeline-features-speckit.md](../../feature_catalog/feature-flag-reference/1-search-pipeline-features-speckit.md)
...
- Feature file path: `feature-flag-reference/1-search-pipeline-features-speckit.md`

...
```text
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/manual_testing_playbook/15--retrieval-enhancements/dual-scope-memory-auto-surface-tm-05.md
```
...
- Feature catalog: [15--retrieval-enhancements/dual-scope-memory-auto-surface.md](../../feature_catalog/15--retrieval-enhancements/dual-scope-memory-auto-surface.md)
...
- Feature file path: `15--retrieval-enhancements/dual-scope-memory-auto-surface-tm-05.md`

...
- Feature catalog: [15--retrieval-enhancements/session-boost-graduated.md](../../feature_catalog/15--retrieval-enhancements/session-boost-graduated.md)
...
- Feature file path: `15--retrieval-enhancements/session-boost-graduated.md`

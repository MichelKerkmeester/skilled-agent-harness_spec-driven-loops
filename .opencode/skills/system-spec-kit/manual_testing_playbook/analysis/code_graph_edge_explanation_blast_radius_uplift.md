...
| `../../feature_catalog/analysis/code_graph_edge_explanation_blast_radius_uplift.md` | Feature-catalog source describing the implementation contract |
...
- Feature file path: `analysis/code_graph_edge_explanation_blast_radius_uplift.md`

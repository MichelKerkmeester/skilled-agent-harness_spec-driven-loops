...
- Feature catalog: [analysis/epistemic_baseline_capture_taskpreflight.md](../../feature_catalog/analysis/epistemic_baseline_capture_taskpreflight.md)
...
- Feature file path: `analysis/epistemic_baseline_capture_task_preflight.md`

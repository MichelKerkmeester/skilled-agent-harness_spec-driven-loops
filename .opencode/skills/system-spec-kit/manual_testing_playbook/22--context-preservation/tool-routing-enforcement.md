...
1. cd .opencode/skills/system-spec-kit && rg -n "## Tool Routing|buildServerInstructions" mcp_server/context-server.ts && node -e "const fs=require('fs'); const p='mcp_server/context-server.ts'; const s=fs.readFileSync(p,'utf8'); console.log(s.includes('## Tool Routing'))"
...
- Feature catalog: [22--context-preservation/tool-routing-enforcement.md](../../feature_catalog/22--context-preservation/tool-routing-enforcement.md)
...
- Feature file path: 22--context-preservation/tool-routing-enforcement.md

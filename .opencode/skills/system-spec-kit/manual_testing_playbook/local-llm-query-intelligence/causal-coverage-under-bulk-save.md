...
- Current allowed write path from the user: `.opencode/skills/system-spec-kit/manual_testing_playbook/local-llm-query-intelligence/causal-coverage-under-bulk-save.md (this file only)`

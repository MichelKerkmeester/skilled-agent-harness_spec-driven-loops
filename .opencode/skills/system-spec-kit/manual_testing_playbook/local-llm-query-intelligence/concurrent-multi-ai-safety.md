...
- User-provided allowed write path for this execution: `.opencode/skills/system-spec-kit/manual_testing_playbook/local-llm-query-intelligence/concurrent-multi-ai-safety.md (this file only)`.

...
| `../../feature_catalog/16--tooling-and-scripts/spec-memory-cli-daemon-backed-surface.md` | Feature-catalog source for the daemon-backed CLI surface |
...
- Feature file path: `16--tooling-and-scripts/cli-compact-and-completion.md`

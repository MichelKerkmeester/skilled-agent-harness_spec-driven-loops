...
- Canonical memory/spec scenario: [M-007](../16--tooling-and-scripts/219-session-capturing-pipeline-quality.md)
...
- Feature file path: `16--tooling-and-scripts/235-session-capturing-pipeline-quality.md`

...
12. `pnpm vitest run .opencode/skills/system-spec-kit/scripts/tests/workflow-invariance.vitest.ts`
13. `rm -rf "$TMPDIR"`
...
- Feature catalog: [16--tooling-and-scripts/template-composition-system.md](../../feature_catalog/16--tooling-and-scripts/template-composition-system.md)
...
- Feature file path: `16--tooling-and-scripts/template-composition-system.md`

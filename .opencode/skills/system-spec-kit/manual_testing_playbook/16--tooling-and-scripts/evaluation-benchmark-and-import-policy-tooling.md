...
ALLOWED WRITE PATHS
.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/evaluation-benchmark-and-import-policy-tooling.md (this file only)
```
...
- Feature catalog: [16--tooling-and-scripts/evaluation-benchmark-and-import-policy-tooling.md](../../feature_catalog/16--tooling-and-scripts/evaluation-benchmark-and-import-policy-tooling.md)
...
- Feature file path: `16--tooling-and-scripts/evaluation-benchmark-and-import-policy-tooling.md`

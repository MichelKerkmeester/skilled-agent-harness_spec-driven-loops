...
```
Validate Template Compliance Contract Enforcement against bash .opencode/skills/system-spec-kit/scripts/validate.sh --strict <spec-folder> and report cited pass/fail evidence.
```

### Commands

1. Create a Level 2 spec folder via distributed-governance spec-authoring flow for a test feature
2. `bash .opencode/skills/system-spec-kit/scripts/validate.sh --strict <spec-folder>`

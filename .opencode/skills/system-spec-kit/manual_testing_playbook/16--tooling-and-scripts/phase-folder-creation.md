...
```text
.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/phase-folder-creation.md
```
...
- Feature file path: `16--tooling-and-scripts/phase-folder-creation.md`

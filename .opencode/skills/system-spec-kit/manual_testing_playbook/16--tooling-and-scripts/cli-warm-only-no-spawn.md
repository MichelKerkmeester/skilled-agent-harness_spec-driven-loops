...
| `../../feature_catalog/16--tooling-and-scripts/spec-memory-cli-daemon-backed-surface.md` | Feature-catalog source for the warm-only contract |
...
- Feature file path: `16--tooling-and-scripts/cli-warm-only-no-spawn.md`

...
- Feature catalog: [16--tooling-and-scripts/47-orphan-mcp-sweeper-and-launchagent-template.md](../../feature_catalog/16--tooling-and-scripts/47-orphan-mcp-sweeper-and-launchagent-template.md)
- Feature catalog: [19--feature-flag-reference/12-launcher-idle-timeout.md](../../feature_catalog/19--feature-flag-reference/12-launcher-idle-timeout.md)

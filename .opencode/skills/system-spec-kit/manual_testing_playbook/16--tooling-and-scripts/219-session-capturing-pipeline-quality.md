...
- Part I hardening spot checks:
    ...
    - `grep -n 'claude-code-capture\|codex-cli-capture\|copilot-cli-capture\|gemini-cli-capture' .opencode/skills/system-spec-kit/scripts/loaders/data-loader.ts .opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts`
...
- Feature file path: `16--tooling-and-scripts/219-session-capturing-pipeline-quality.md`

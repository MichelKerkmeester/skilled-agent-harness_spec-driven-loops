...
| [429](cli-dist-freshness-guard.md) | Sibling scenario for the CLI-shim side of the same shared freshness module |
| `../../feature_catalog/16--tooling-and-scripts/dist-freshness-enforcement.md` | Feature-catalog source describing the shared dist-freshness architecture |
...
- Feature file path: `16--tooling-and-scripts/validate-sh-dist-freshness-backstop.md`

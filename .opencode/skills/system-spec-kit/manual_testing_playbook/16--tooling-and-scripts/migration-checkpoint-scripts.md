...
- Real user request: `Please validate Migration checkpoint scripts against cd .opencode/skills/system-spec-kit/mcp_server and tell me whether the expected signals are present: Targeted suite passes; transcript shows checkpoint sidecar creation, restore success, and pre-restore backup coverage.`
...
```
Validate Migration checkpoint scripts against cd .opencode/skills/system-spec-kit/mcp_server and report cited pass/fail evidence.
```
...
- Feature catalog: [16--tooling-and-scripts/212-migration-checkpoint-scripts.md](../../feature_catalog/16--tooling-and-scripts/212-migration-checkpoint-scripts.md)
...
- Feature file path: `16--tooling-and-scripts/migration-checkpoint-scripts.md`

...
- Feature catalog: [bug_fixes_and_data_integrity/graph_channel_id_fix.md](../../feature_catalog/bug_fixes_and_data_integrity/graph_channel_id_fix.md)
...
- Feature file path: `bug_fixes_and_data_integrity/graph_channel_id_fix_g1.md`

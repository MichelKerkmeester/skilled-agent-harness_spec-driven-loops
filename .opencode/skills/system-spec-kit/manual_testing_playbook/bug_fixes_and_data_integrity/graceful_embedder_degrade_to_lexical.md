...
| `bug_fixes_and_data_integrity/graceful_embedder_degrade_to_lexical.md` | Scenario contract |
...
- Feature file path: `bug_fixes_and_data_integrity/graceful_embedder_degrade_to_lexical.md`

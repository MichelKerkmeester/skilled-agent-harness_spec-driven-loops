...
```
Validate typed-weighted degree scoring and cite caps, batched cold-cache queries, cache reuse, fallback, and varied type scoring.
```
...
- Feature catalog: [graph_signal_activation/typed_weighted_degree_channel.md](../../feature_catalog/graph_signal_activation/typed_weighted_degree_channel.md)
...
- Feature file path: `graph_signal_activation/typed_weighted_degree_channel_r4.md`

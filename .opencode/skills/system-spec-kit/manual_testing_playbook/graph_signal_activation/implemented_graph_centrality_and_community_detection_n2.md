...
- Feature catalog: [graph_signal_activation/community_detection.md](../../feature_catalog/graph_signal_activation/community_detection.md)
...
- Feature file path: `graph_signal_activation/implemented_graph_centrality_and_community_detection_n2.md`

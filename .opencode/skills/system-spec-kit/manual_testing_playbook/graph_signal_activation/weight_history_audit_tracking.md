...
```
Validate weight history audit tracking and cite audit rows, rollback restoration, and append-only history evidence.
```
...
- Feature catalog: [graph_signal_activation/weight_history_audit_tracking.md](../../feature_catalog/graph_signal_activation/weight_history_audit_tracking.md)
...
- Feature file path: `graph_signal_activation/weight_history_audit_tracking.md`

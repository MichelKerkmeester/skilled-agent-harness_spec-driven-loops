...
version: 3.6.0.14
id: graph-signal-activation-typed-traversal-speckit-typed-traversal
...
- Feature catalog: [graph_signal_activation/typed_traversal.md](../../feature_catalog/graph_signal_activation/typed_traversal.md)
...
- Feature file path: `graph_signal_activation/typed_traversal_speckit_typed_traversal.md`

...
- Feature catalog: [graph_signal_activation/causal_depth_signal.md](../../feature_catalog/graph_signal_activation/causal_depth_signal.md)
...
- Feature file path: `graph_signal_activation/causal_depth_signal_n2b.md`

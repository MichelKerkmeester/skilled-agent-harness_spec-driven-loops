...
version: 3.6.0.14
id: graph-signal-activation-llm-graph-backfill-speckit-llm-graph-backfill
...
- Feature catalog: [graph_signal_activation/llm_graph_backfill.md](../../feature_catalog/graph_signal_activation/llm_graph_backfill.md)
...
- Feature file path: `graph_signal_activation/llm_graph_backfill_speckit_llm_graph_backfill.md`

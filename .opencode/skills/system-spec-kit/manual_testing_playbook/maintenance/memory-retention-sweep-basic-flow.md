...
- Prompt: `Validate the memory retention sweep dry-run, deletion, audit evidence, memory_context cleanup, and scheduled interval behavior.`
...
SPECKIT_RETENTION_SWEEP=true SPECKIT_RETENTION_SWEEP_INTERVAL_MS=1000 npm --prefix .opencode/skills/system-spec-kit/mcp_server start 2>&1 | tee /tmp/retention-sweep-interval.log
```
...
- Source: `.opencode/skills/system-spec-kit/mcp_server/lib/governance/memory-retention-sweep.ts`
- Source: `.opencode/skills/system-spec-kit/mcp_server/lib/session/session-manager.ts`
...
- Feature file path: `maintenance/memory-retention-sweep-basic-flow.md`

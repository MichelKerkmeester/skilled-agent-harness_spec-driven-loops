...
| `../../../system-skill-advisor/feature_catalog/mcp_surface/skill_advisor_cli.md` | Feature-catalog source for the skill-advisor CLI |
...
- Feature file path: `tooling_and_scripts/cli_stress_trust_gate_fuzz.md`

...
| `../../feature_catalog/tooling_and_scripts/spec_memory_cli_daemon_backed_surface.md` | Feature-catalog source for the CLI surface contract |
...
- Feature file path: `tooling_and_scripts/cli_stress_concurrent_dual_client_load.md`

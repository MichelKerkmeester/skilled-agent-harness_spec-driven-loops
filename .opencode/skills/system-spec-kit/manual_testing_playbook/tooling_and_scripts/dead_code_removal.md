...
- Feature catalog: [tooling_and_scripts/dead_code_removal.md](../../feature_catalog/tooling_and_scripts/dead_code_removal.md)
...
- Feature file path: `tooling_and_scripts/dead_code_removal.md`

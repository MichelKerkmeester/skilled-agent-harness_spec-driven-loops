...
- Feature catalog: [tooling-and-scripts/](../../feature_catalog/tooling_and_scripts/)
...
- Feature file path: `tooling_and_scripts/template_compliance_contract_enforcement_produces_compliant.md`

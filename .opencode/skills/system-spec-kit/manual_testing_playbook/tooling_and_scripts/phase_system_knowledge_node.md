...
Inspect `references/structure/phase_system.md`, `scripts/tests/test-phase-system.sh`, `scripts/spec/validate.sh`, and `scripts/rules/check-phase-links.sh` if the documented model diverges from executable behavior

## 4. SOURCE FILES
- Root playbook: [manual_testing_playbook.md](../manual_testing_playbook.md)
- Feature catalog: [tooling_and_scripts/phase_system_knowledge_node.md](../../feature_catalog/tooling_and_scripts/phase_system_knowledge_node.md)
...
- Feature file path: `tooling_and_scripts/phase_system_knowledge_node.md`

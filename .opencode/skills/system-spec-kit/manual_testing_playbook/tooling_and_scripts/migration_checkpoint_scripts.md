...
- Feature catalog: [tooling_and_scripts/migration_checkpoint_scripts.md](../../feature_catalog/tooling_and_scripts/migration_checkpoint_scripts.md)
...
- Feature file path: `tooling_and_scripts/migration_checkpoint_scripts.md`

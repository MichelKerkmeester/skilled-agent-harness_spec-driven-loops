...
```text
.opencode/skills/system-spec-kit/manual_testing_playbook/tooling_and_scripts/phase_folder_creation.md
```
...
- Feature file path: `tooling_and_scripts/phase_folder_creation.md`

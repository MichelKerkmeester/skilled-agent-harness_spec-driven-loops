...
- Feature catalog: [13--memory-quality-and-indexing/deferred-lexical-only-indexing.md](../../feature_catalog/13--memory-quality-and-indexing/deferred-lexical-only-indexing.md)

...
| `19--feature-flag-reference/session-trace-causal-inference.md` | Scenario contract |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `mcp_server/lib/feedback/session-trace-causal-reducer.ts` | Deferred causal reducer |
| `mcp_server/tests/session-trace-causal-reducer.vitest.ts` | Reducer regression coverage |
...
- Feature file path: `19--feature-flag-reference/session-trace-causal-inference.md`

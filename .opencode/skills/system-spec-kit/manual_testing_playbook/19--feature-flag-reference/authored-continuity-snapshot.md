...
| `19--feature-flag-reference/authored-continuity-snapshot.md` | Scenario contract |
...
- Feature file path: `19--feature-flag-reference/authored-continuity-snapshot.md`

...
- Feature catalog: [lifecycle/speckit_autopilot_lifecycle.md](../../feature_catalog/lifecycle/speckit_autopilot_lifecycle.md)
...
- Feature file path: `lifecycle/speckit_autopilot_lifecycle.md`

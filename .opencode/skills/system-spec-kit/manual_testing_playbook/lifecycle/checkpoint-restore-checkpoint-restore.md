...
- Feature catalog: [lifecycle/checkpoint-restore-checkpointrestore.md](../../feature_catalog/lifecycle/checkpoint-restore-checkpointrestore.md)
...
- Feature file path: `lifecycle/checkpoint-restore-checkpoint-restore.md`

...
- Feature catalog: [lifecycle/async_ingestion_job_lifecycle.md](../../feature_catalog/lifecycle/async_ingestion_job_lifecycle.md)
...
- Feature file path: `lifecycle/async_ingestion_job_lifecycle_p0_3.md`

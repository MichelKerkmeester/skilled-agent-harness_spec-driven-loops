...
- Feature catalog: [lifecycle/checkpoint_listing_checkpointlist.md](../../feature_catalog/lifecycle/checkpoint_listing_checkpointlist.md)
...
- Feature file path: `lifecycle/checkpoint_listing_checkpoint_list.md`

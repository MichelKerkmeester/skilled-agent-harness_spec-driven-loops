...
- Feature catalog: [lifecycle/checkpoint_restore_checkpointrestore.md](../../feature_catalog/lifecycle/checkpoint_restore_checkpointrestore.md)
...
- Feature file path: `lifecycle/checkpoint_restore_checkpoint_restore.md`

...
- Feature catalog: [lifecycle/checkpoint-creation-checkpointcreate.md](../../feature_catalog/lifecycle/checkpoint-creation-checkpointcreate.md)
...
- Feature file path: `lifecycle/checkpoint-creation-checkpoint-create.md`

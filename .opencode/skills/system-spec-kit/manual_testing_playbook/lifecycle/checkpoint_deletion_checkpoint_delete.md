...
- Feature catalog: [lifecycle/checkpoint_deletion_checkpointdelete.md](../../feature_catalog/lifecycle/checkpoint_deletion_checkpointdelete.md)
...
- Feature file path: `lifecycle/checkpoint_deletion_checkpoint_delete.md`

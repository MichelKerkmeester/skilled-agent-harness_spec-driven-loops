...
1. Read `feature_catalog/retrieval/ast-level-section-retrieval-tool.md` and confirm it states `PLANNED (Sprint 019): DEFERRED`
...
- Feature catalog: [retrieval/ast-level-section-retrieval-tool.md](../../feature_catalog/retrieval/ast-level-section-retrieval-tool.md)

...
version: 3.6.0.16
id: retrieval-4-stage-pipeline-architecture
...
- Feature catalog: [retrieval/4_stage_pipeline_architecture.md](../../feature_catalog/retrieval/4_stage_pipeline_architecture.md)
...
- Feature file path: `retrieval/4_stage_pipeline_architecture.md`

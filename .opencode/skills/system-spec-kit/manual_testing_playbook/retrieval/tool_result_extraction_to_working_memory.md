...
version: 3.6.0.13
id: retrieval-tool-result-extraction-to-working-memory
...
- Feature catalog: [retrieval/tool_result_extraction_to_working_memory.md](../../feature_catalog/retrieval/tool_result_extraction_to_working_memory.md)
...
- Feature file path: `retrieval/tool_result_extraction_to_working_memory.md`

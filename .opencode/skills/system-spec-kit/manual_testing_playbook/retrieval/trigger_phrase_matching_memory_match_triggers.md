...
- Feature catalog: [retrieval/trigger_phrase_matching_memorymatchtriggers.md](../../feature_catalog/retrieval/trigger_phrase_matching_memorymatchtriggers.md)
...
- Feature file path: `retrieval/trigger_phrase_matching_memory_match_triggers.md`

...
`Validate quality-aware 3-tier search fallback and confirm degradation, tier widening, and final enrichment behave correctly.`
...
- Feature catalog: [retrieval/quality_aware_3_tier_search_fallback.md](../../feature_catalog/retrieval/quality_aware_3_tier_search_fallback.md)
...
- Feature file path: `retrieval/quality_aware_3_tier_search_fallback.md`

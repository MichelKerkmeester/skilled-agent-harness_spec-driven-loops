...
- Feature catalog: [retrieval/tool-result-extraction-to-working-memory.md](../../feature_catalog/retrieval/tool-result-extraction-to-working-memory.md)
...
- Feature file path: `retrieval/tool-result-extraction-to-working-memory.md`

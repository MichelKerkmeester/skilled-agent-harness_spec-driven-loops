...
version: 3.6.0.12
id: retrieval-ast-level-section-retrieval-tool
...
1. Read `feature_catalog/retrieval/ast_level_section_retrieval_tool.md` and confirm it states `PLANNED (Sprint 019): DEFERRED`
...
- Feature catalog: [retrieval/ast_level_section_retrieval_tool.md](../../feature_catalog/retrieval/ast_level_section_retrieval_tool.md)

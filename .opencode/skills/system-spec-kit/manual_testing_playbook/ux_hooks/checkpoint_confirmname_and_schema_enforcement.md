...
- Feature catalog: [ux_hooks/checkpoint_delete_confirmname_safety.md](../../feature_catalog/ux_hooks/checkpoint_delete_confirmname_safety.md)
...
- Feature file path: `ux_hooks/checkpoint_confirmname_and_schema_enforcement.md`

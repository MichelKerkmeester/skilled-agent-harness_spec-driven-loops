...
- Feature catalog: [ux_hooks/progressive_disclosure.md](../../feature_catalog/ux_hooks/progressive_disclosure.md)
- Feature flag reference: [01-1-search-pipeline-features-speckit.md](../../feature_catalog/feature_flag_reference/1_search_pipeline_features_speckit.md)
...
- Feature file path: `ux_hooks/progressive_disclosure_v1_speckit_progressive_disclosure_v1.md`

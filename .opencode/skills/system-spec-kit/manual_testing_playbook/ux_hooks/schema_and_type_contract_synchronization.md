...
- Feature catalog: [ux_hooks/schema_and_type_contract_synchronization.md](../../feature_catalog/ux_hooks/schema_and_type_contract_synchronization.md)
...
- Feature catalog back-ref: `ux_hooks/schema_and_type_contract_synchronization.md`

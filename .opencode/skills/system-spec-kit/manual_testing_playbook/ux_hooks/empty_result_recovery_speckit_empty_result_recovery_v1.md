...
- Feature catalog: [ux_hooks/empty_result_recovery.md](../../feature_catalog/ux_hooks/empty_result_recovery.md)
...
- Feature file path: `ux_hooks/empty_result_recovery_speckit_empty_result_recovery_v1.md`

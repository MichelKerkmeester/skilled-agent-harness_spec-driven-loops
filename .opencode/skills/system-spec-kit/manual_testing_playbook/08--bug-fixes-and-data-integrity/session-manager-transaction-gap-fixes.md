...
- Feature catalog: [08--bug-fixes-and-data-integrity/session-manager-transaction-gap-fixes.md](../../feature_catalog/08--bug-fixes-and-data-integrity/session-manager-transaction-gap-fixes.md)
...
- Feature file path: `08--bug-fixes-and-data-integrity/session-manager-transaction-gap-fixes.md`

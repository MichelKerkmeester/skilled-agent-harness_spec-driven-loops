...
- Real active allowed write path from the operator request: `.opencode/skills/system-spec-kit/manual_testing_playbook/doctor_commands/doctor_memory_fresh_install.md (this file only)`
...
- Feature file path: `doctor_commands/doctor_memory_fresh_install.md`

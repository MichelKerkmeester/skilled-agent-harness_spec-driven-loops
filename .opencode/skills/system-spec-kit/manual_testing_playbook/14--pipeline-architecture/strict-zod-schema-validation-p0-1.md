...
- Feature catalog: [14--pipeline-architecture/strict-zod-schema-validation.md](../../feature_catalog/14--pipeline-architecture/strict-zod-schema-validation.md)
...
- Feature file path: `14--pipeline-architecture/strict-zod-schema-validation-p0-1.md`

...
Layer-definition snapshot + dispatch trace + recommended-layer output example + comparison showing runtime path remains name-based
...
- Feature file path: `14--pipeline-architecture/191-7-layer-tool-architecture-metadata.md`

...
- Feature catalog: [14--pipeline-architecture/phase-017-maintainability-extracts.md](../../feature_catalog/14--pipeline-architecture/phase-017-maintainability-extracts.md)
...
- Feature file path: `14--pipeline-architecture/phase-017-maintainability-extracts.md`

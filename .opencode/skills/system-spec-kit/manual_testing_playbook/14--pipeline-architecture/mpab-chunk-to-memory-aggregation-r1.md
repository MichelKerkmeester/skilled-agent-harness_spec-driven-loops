...
```text
 ...
 ✓ mcp_server/tests/mpab-aggregation.vitest.ts > collapseAndReassembleChunkResults > multiple chunks from same parent are collapsed with MPAB 1ms
 ...
 ↓ mcp_server/tests/mpab-aggregation.vitest.ts > collapseAndReassembleChunkResults > T001a: chunks maintain document position order (by chunkIndex), NOT score order
 ↓ mcp_server/tests/mpab-aggregation.vitest.ts > collapseAndReassembleChunkResults > T001a: multi-parent collapse preserves document order per parent
...
- Feature catalog: [14--pipeline-architecture/mpab-chunk-to-memory-aggregation.md](../../feature_catalog/14--pipeline-architecture/mpab-chunk-to-memory-aggregation.md)
...
- Feature file path: `14--pipeline-architecture/mpab-chunk-to-memory-aggregation-r1.md`

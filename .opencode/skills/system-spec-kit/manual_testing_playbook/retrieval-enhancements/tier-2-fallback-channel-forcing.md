...
Tier-2 trigger and options evidence observed in `mcp_server/lib/search/hybrid-search.ts`:
...
Channel forcing evidence observed in `mcp_server/lib/search/hybrid-search.ts`:
...
Per-channel contribution evidence observed in `mcp_server/lib/search/hybrid-search.ts`:
...
Regression evidence observed in `mcp_server/tests/hybrid-search.vitest.ts`:
...
- Feature catalog: [retrieval-enhancements/tier-2-fallback-channel-forcing.md](../../feature_catalog/retrieval-enhancements/tier-2-fallback-channel-forcing.md)

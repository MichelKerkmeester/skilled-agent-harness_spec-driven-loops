...
- Feature catalog: [retrieval-enhancements/session-boost-graduated.md](../../feature_catalog/retrieval-enhancements/session-boost-graduated.md)
...
- Feature file path: `retrieval-enhancements/session-boost-graduated.md`

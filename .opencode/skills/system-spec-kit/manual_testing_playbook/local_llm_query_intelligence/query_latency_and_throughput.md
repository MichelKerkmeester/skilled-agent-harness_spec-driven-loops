...
version: 3.6.0.2
id: local-llm-query-intelligence-query-latency-and-throughput
...
1. Prepare the workload file `_sandbox/local-llm-query-intelligence/410/workload.json` with 50 queries:
   - 17 short (5-20 chars)
...
- Allowed write path: `.opencode/skills/system-spec-kit/manual_testing_playbook/local_llm_query_intelligence/query_latency_and_throughput.md`.

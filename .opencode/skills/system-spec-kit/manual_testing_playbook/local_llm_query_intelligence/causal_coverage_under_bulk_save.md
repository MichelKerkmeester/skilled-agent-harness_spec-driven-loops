...
- Current allowed write path from the user: `.opencode/skills/system-spec-kit/manual_testing_playbook/local_llm_query_intelligence/causal_coverage_under_bulk_save.md (this file only)`

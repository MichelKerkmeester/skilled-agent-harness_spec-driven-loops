...
- User-provided allowed write path for this execution: `.opencode/skills/system-spec-kit/manual_testing_playbook/local_llm_query_intelligence/concurrent_multi_ai_safety.md (this file only)`.

...
- Feature catalog: [scoring-and-calibration/shadow-feedback-holdout-evaluation.md](../../feature_catalog/scoring-and-calibration/shadow-feedback-holdout-evaluation.md)
- Feature flag reference: [feature-flag-reference/1-search-pipeline-features-speckit.md](../feature-flag-reference/1-search-pipeline-features-speckit.md)
...
- Feature file path: `scoring-and-calibration/shadow-feedback-speckit-shadow-feedback.md`

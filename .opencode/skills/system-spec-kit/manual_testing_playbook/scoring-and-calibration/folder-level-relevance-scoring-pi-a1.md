...
- Feature catalog: [scoring-and-calibration/folder-level-relevance-scoring.md](../../feature_catalog/scoring-and-calibration/folder-level-relevance-scoring.md)
...
- Feature file path: `scoring-and-calibration/folder-level-relevance-scoring-pi-a1.md`

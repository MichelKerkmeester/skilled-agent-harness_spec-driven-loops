...
- Feature catalog: [graph-signal-activation/typed-weighted-degree-channel.md](../../feature_catalog/graph-signal-activation/typed-weighted-degree-channel.md)
...
- Feature file path: `graph-signal-activation/typed-weighted-degree-channel-r4.md`

...
- Feature catalog: [graph-signal-activation/causal-neighbor-boost-and-injection.md](../../feature_catalog/graph-signal-activation/causal-neighbor-boost-and-injection.md)

...
- Feature catalog: [graph-signal-activation/unified-graph-retrieval-deterministic-ranking-explainability-and-rollback.md](../../feature_catalog/graph-signal-activation/unified-graph-retrieval-deterministic-ranking-explainability-and-rollback.md)
...
- Feature file path: `graph-signal-activation/unified-graph-rollback-and-explainability-phase-3.md`

...
- Feature catalog: [graph-signal-activation/causal-depth-signal.md](../../feature_catalog/graph-signal-activation/causal-depth-signal.md)
...
- Feature file path: `graph-signal-activation/causal-depth-signal-n2b.md`

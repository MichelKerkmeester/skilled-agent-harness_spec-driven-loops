...
- Feature catalog: [graph-signal-activation/graph-momentum-scoring.md](../../feature_catalog/graph-signal-activation/graph-momentum-scoring.md)
...
- Feature file path: `graph-signal-activation/graph-momentum-scoring-n2a.md`

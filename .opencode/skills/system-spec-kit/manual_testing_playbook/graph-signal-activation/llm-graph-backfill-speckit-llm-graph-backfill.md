...
- Feature catalog: [graph-signal-activation/llm-graph-backfill.md](../../feature_catalog/graph-signal-activation/llm-graph-backfill.md)
...
- Feature file path: `graph-signal-activation/llm-graph-backfill-speckit-llm-graph-backfill.md`

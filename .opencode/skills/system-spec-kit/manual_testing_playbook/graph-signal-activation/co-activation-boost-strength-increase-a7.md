...
- Feature catalog: [graph-signal-activation/co-activation-boost-strength-increase.md](../../feature_catalog/graph-signal-activation/co-activation-boost-strength-increase.md)
...
- Feature file path: `graph-signal-activation/co-activation-boost-strength-increase-a7.md`

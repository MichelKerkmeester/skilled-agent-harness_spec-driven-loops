...
- Feature catalog: [03--discovery/memory-browser-memorylist.md](../../feature_catalog/03--discovery/memory-browser-memorylist.md)
...
- Feature file path: `03--discovery/memory-browser-memory-list.md`

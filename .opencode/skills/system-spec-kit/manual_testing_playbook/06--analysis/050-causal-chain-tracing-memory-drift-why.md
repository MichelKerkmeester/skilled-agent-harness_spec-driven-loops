...
```
Validate memory_drift_why returns the expected causal chain relations; return pass/fail with cited evidence.
```
...
- Feature file path: `06--analysis/050-causal-chain-tracing-memory-drift-why.md`

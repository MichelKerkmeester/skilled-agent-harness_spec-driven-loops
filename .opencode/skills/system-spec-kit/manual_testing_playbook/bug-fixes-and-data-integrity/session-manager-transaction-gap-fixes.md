...
- Feature catalog: [bug-fixes-and-data-integrity/session-manager-transaction-gap-fixes.md](../../feature_catalog/bug-fixes-and-data-integrity/session-manager-transaction-gap-fixes.md)

...
- Feature catalog: [remediation_revalidation/category_stub.md](../../feature_catalog/remediation_revalidation/category_stub.md)
...
- Feature file path: `remediation_revalidation/remediation_runtime_surface.md`

...
- Feature catalog: [12--query-intelligence/130-index-time-query-surrogates.md](../../feature_catalog/12--query-intelligence/130-index-time-query-surrogates.md)
...
- Feature file path: `12--query-intelligence/134-query-surrogates-speckit-query-surrogates.md`

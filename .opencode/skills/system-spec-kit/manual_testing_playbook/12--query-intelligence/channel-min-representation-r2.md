...
Validation surface read from `../../feature_catalog/12--query-intelligence/channel-min-representation.md`:
...
- Feature catalog: [12--query-intelligence/channel-min-representation.md](../../feature_catalog/12--query-intelligence/channel-min-representation.md)
...
- Feature file path: `12--query-intelligence/channel-min-representation-r2.md`

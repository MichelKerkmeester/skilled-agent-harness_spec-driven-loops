...
```text
.opencode/skills/system-spec-kit/feature_catalog/12--query-intelligence/query-expansion.md
...
- Feature catalog: [12--query-intelligence/query-expansion.md](../../feature_catalog/12--query-intelligence/query-expansion.md)
...
- Feature file path: `12--query-intelligence/query-expansion-r12.md`

...
- Feature catalog: [12--query-intelligence/confidence-based-result-truncation.md](../../feature_catalog/12--query-intelligence/confidence-based-result-truncation.md)
...
- Feature file path: `12--query-intelligence/confidence-based-result-truncation-r15-ext.md`

...
- Feature catalog: [12--query-intelligence/hyde-hypothetical-document-embeddings.md](../../feature_catalog/12--query-intelligence/hyde-hypothetical-document-embeddings.md)

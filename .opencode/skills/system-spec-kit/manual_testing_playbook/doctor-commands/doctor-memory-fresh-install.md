...
- Real active allowed write path from the operator request: `.opencode/skills/system-spec-kit/manual_testing_playbook/doctor-commands/doctor-memory-fresh-install.md (this file only)`

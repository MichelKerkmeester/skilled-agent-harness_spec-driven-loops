...
- User allowed write path: `.opencode/skills/system-spec-kit/manual_testing_playbook/doctor-commands/doctor-memory-drift-detection.md (this file only)`.
...
- Feature file path: `doctor-commands/doctor-memory-drift-detection.md`

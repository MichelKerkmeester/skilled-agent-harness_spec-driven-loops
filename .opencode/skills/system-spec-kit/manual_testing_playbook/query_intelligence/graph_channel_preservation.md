...
- Feature catalog: [query_intelligence/graph_channel_preservation.md](../../feature_catalog/query_intelligence/graph_channel_preservation.md)
...
- Feature file path: `query_intelligence/graph_channel_preservation.md`

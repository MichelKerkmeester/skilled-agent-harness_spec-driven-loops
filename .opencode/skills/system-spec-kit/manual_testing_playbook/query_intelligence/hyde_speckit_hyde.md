...
- Feature catalog: [query_intelligence/hyde_hypothetical_document_embeddings.md](../../feature_catalog/query_intelligence/hyde_hypothetical_document_embeddings.md)
...
- Feature file path: `query_intelligence/hyde_speckit_hyde.md`

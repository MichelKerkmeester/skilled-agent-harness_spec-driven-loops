...
- Feature catalog: [query_intelligence/llm_query_reformulation.md](../../feature_catalog/query_intelligence/llm_query_reformulation.md)
...
- Feature file path: `query_intelligence/llm_reformulation_speckit_llm_reformulation.md`

...
- Feature catalog: [query_intelligence/index_time_query_surrogates.md](../../feature_catalog/query_intelligence/index_time_query_surrogates.md)
...
- Feature file path: `query_intelligence/query_surrogates_speckit_query_surrogates.md`

...
- Feature catalog: [mutation/single_and_folder_delete_memorydelete.md](../../feature_catalog/mutation/single_and_folder_delete_memorydelete.md)
...
- Feature file path: `mutation/single_and_folder_delete_memory_delete.md`

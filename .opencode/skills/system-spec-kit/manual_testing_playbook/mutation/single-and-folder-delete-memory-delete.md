...
- Feature catalog: [mutation/single-and-folder-delete-memorydelete.md](../../feature_catalog/mutation/single-and-folder-delete-memorydelete.md)
...
- Feature file path: `mutation/single-and-folder-delete-memory-delete.md`

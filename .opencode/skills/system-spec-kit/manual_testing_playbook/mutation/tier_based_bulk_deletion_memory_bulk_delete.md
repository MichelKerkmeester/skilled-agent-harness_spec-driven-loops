...
- Feature catalog: [mutation/tier_based_bulk_deletion_memorybulkdelete.md](../../feature_catalog/mutation/tier_based_bulk_deletion_memorybulkdelete.md)
...
- Feature file path: `mutation/tier_based_bulk_deletion_memory_bulk_delete.md`

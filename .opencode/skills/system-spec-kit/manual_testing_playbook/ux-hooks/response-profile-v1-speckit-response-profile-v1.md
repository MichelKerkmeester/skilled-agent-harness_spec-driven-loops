...
- Feature catalog: [ux-hooks/mode-aware-response-profiles.md](../../feature_catalog/ux-hooks/mode-aware-response-profiles.md)
...
- Feature file path: `ux-hooks/response-profile-v1-speckit-response-profile-v1.md`

...
- Scenario file read in full from `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/manual_testing_playbook/ux-hooks/result-provenance.md`.
...
- Feature catalog: [ux-hooks/result-provenance.md](../../feature_catalog/ux-hooks/result-provenance.md)

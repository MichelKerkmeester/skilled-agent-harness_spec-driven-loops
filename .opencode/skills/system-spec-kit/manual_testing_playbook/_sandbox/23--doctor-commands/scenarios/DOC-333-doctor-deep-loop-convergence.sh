#!/usr/bin/env bash
# COMPONENT: DOC-333 Doctor Deep Loop Convergence
...
SCENARIO_ID="DOC-333"
SCENARIO_MD="333-doctor-deep-loop-convergence.md"
...
run_scenario() {
    ...
    capture_evidence "$SCENARIO_ID" /doctor:deep-loop --scope=research || true

#!/usr/bin/env bash
# COMPONENT: DOC-346 Version Migration Cleanup Legacy
...
SCENARIO_ID="DOC-346"
SCENARIO_MD="346-version-migration-cleanup-legacy.md"
...
run_scenario() {
    ...
    capture_evidence "$SCENARIO_ID" /doctor:update --cleanup-legacy || true

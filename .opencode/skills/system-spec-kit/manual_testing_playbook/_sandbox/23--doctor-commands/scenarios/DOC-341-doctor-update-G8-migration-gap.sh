#!/usr/bin/env bash
# COMPONENT: DOC-341 Doctor Update G8 Migration Gap
...
SCENARIO_ID="DOC-341"
SCENARIO_MD="341-doctor-update-G8-migration-gap.md"
...
run_scenario() {
    ...
    export SPECKIT_SOURCE_VERSION="${SPECKIT_SOURCE_VERSION:-2.9.0.0}"

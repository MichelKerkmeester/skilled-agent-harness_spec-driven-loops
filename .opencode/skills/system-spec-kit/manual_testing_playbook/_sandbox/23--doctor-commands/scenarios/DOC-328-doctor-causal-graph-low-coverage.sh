#!/usr/bin/env bash
# COMPONENT: DOC-328 Doctor Causal Graph Low Coverage
...
SCENARIO_ID="DOC-328"
SCENARIO_MD="328-doctor-causal-graph-low-coverage.md"
...
run_scenario() {
    ...
    capture_evidence "$SCENARIO_ID" /doctor:causal-graph || true

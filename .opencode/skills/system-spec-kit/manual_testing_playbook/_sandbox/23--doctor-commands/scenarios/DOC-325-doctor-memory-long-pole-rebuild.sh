#!/usr/bin/env bash
# COMPONENT: DOC-325 Doctor Memory Long-Pole Rebuild
...
SCENARIO_ID="DOC-325"
SCENARIO_MD="325-doctor-memory-long-pole-rebuild.md"
...
run_scenario() {
    ...
    capture_evidence "$SCENARIO_ID" /doctor memory --incremental=false || true

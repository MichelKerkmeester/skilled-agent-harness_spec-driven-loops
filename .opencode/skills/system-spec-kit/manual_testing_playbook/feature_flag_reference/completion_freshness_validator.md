...
ALLOWED WRITE PATHS
- .opencode/skills/system-spec-kit/manual_testing_playbook/feature_flag_reference/completion_freshness_validator.md (this file only)
```
...
| `feature_flag_reference/completion_freshness_validator.md` | Scenario contract |
...
- Feature file path: `feature_flag_reference/completion_freshness_validator.md`

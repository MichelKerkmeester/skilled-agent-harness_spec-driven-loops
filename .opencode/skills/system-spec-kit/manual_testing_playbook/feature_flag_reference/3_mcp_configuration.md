...
- Feature catalog: [feature_flag_reference/3_mcp_configuration.md](../../feature_catalog/feature_flag_reference/3_mcp_configuration.md)
...
- Feature file path: `feature_flag_reference/3_mcp_configuration.md`

...
| `feature_flag_reference/feedback_retention_learning_modes.md` | Scenario contract |
...
- Feature file path: `feature_flag_reference/feedback_retention_learning_modes.md`

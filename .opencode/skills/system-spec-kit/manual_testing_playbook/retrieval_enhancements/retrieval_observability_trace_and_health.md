...
| `retrieval_enhancements/retrieval_observability_trace_and_health.md` | Scenario contract |
...
- Feature file path: `retrieval_enhancements/retrieval_observability_trace_and_health.md`

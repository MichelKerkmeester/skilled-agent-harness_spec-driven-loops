...
- Feature catalog: [discovery/memory_browser_memorylist.md](../../feature_catalog/discovery/memory_browser_memorylist.md)
...
- Feature file path: `discovery/memory_browser_memory_list.md`

...
- Feature catalog: [discovery/system_statistics_memorystats.md](../../feature_catalog/discovery/system_statistics_memorystats.md)
...
- Feature file path: `discovery/system_statistics_memory_stats.md`

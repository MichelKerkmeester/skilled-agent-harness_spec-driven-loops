...
- Feature catalog: [discovery/memory-browser-memorylist.md](../../feature_catalog/discovery/memory-browser-memorylist.md)
...
- Feature file path: `discovery/memory-browser-memory-list.md`

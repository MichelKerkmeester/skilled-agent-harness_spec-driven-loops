...
- Feature catalog: [stress_testing/category_overview.md](../../feature_catalog/stress_testing/category_overview.md)
...
- Feature file path: `stress_testing/run_stress_cycle.md`

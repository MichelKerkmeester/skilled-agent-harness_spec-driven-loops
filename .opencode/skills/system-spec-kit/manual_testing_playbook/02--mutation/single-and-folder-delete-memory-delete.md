...
- Feature catalog: [02--mutation/single-and-folder-delete-memorydelete.md](../../feature_catalog/02--mutation/single-and-folder-delete-memorydelete.md)
...
- Feature file path: `02--mutation/single-and-folder-delete-memory-delete.md`

...
| `governance/stale_exclusion_audit_and_tool_ownership_lint.md` | Scenario contract |
...
- Feature file path: `governance/stale_exclusion_audit_and_tool_ownership_lint.md`

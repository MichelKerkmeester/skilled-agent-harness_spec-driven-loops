...
```text
ALLOWED WRITE PATHS
- .opencode/skills/system-spec-kit/manual_testing_playbook/governance/source-kind-provenance-guard.md (this file only)
```
...
- **BLOCKED**: scenario command 1 requires creating a sandbox manual spec-doc file, but this run permits writes only to `.opencode/skills/system-spec-kit/manual_testing_playbook/governance/source-kind-provenance-guard.md`.

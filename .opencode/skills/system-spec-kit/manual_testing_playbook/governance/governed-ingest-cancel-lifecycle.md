...
Because the fixture path does not exist and this run was not allowed to create files outside `.opencode/skills/system-spec-kit/manual_testing_playbook/governance/governed-ingest-cancel-lifecycle.md`, the required `memory_ingest_start/status/cancel` lifecycle commands were not run.

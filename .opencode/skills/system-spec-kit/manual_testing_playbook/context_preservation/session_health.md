...
- Feature catalog: [context_preservation/session_health_tool.md](../../feature_catalog/context_preservation/session_health_tool.md)
...
- Feature file path: `context_preservation/session_health.md`

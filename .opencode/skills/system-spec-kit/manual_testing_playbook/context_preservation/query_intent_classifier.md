...
- Feature catalog: [context_preservation/query_intent_classifier.md](../../feature_catalog/context_preservation/query_intent_classifier.md)
...
- Feature file path: `context_preservation/query_intent_classifier.md`

...
version: 3.6.0.15
id: context-preservation-mcp-auto-priming
...
- Prompt: `Validate MCP auto-priming on the first memory_stats tool call.`
...
- Feature catalog: [context_preservation/mcp_auto_priming.md](../../feature_catalog/context_preservation/mcp_auto_priming.md)

...
- Feature catalog: [context_preservation/stop_token_tracking.md](../../feature_catalog/context_preservation/stop_token_tracking.md)
...
- Feature file path: `context_preservation/stop_hook_saves.md`

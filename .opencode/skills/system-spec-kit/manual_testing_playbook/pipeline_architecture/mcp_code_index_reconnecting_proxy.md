...
| `../../feature_catalog/pipeline_architecture/mcp_code_index_reconnecting_proxy.md` | Feature-catalog source describing the implementation contract |
...
- Feature file path: `pipeline_architecture/mcp_code_index_reconnecting_proxy.md`

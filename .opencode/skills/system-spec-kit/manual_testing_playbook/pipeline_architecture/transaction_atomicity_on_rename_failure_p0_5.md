...
- Feature catalog: [pipeline_architecture/atomic_pending_file_recovery.md](../../feature_catalog/pipeline_architecture/atomic_pending_file_recovery.md)
...
- Feature file path: `pipeline_architecture/transaction_atomicity_on_rename_failure_p0_5.md`

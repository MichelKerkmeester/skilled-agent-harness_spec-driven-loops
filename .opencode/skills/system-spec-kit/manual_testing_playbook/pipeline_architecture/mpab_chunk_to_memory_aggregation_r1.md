...
- Feature catalog: [pipeline_architecture/mpab_chunk_to_memory_aggregation.md](../../feature_catalog/pipeline_architecture/mpab_chunk_to_memory_aggregation.md)
...
- Feature file path: `pipeline_architecture/mpab_chunk_to_memory_aggregation_r1.md`

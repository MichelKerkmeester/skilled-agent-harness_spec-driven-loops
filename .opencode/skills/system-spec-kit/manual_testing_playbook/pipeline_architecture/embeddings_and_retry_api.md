...
- Feature catalog: [pipeline_architecture/embeddings_and_retry_api.md](../../feature_catalog/pipeline_architecture/embeddings_and_retry_api.md)
...
- Feature file path: `pipeline_architecture/embeddings_and_retry_api.md`

...
- Health diagnostics: [discovery/health_diagnostics_memoryhealth.md](../../feature_catalog/discovery/health_diagnostics_memoryhealth.md)
...
- Feature file path: `pipeline_architecture/routing_telemetry_and_graph_channel_invocation.md`

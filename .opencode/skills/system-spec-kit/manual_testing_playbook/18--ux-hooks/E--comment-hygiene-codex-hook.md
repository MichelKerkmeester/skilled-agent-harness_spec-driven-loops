...
| `../../../../specs/skilled-agent-orchestration/z_archive/119-comment-ref-hygiene/002-active-enforcement-layer/decision-record.md` | ADR-002 — documents the Codex write-time hook gap |

...
- Feature catalog: [18--ux-hooks/dedicated-ux-hook-modules.md](../../feature_catalog/18--ux-hooks/dedicated-ux-hook-modules.md)
...
- Feature file path: `18--ux-hooks/ux-hook-module-coverage-mutation-feedback-response-hints.md`

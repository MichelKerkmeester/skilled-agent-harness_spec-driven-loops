...
- Feature catalog: [18--ux-hooks/empty-result-recovery.md](../../feature_catalog/18--ux-hooks/empty-result-recovery.md)
...
- Feature file path: `18--ux-hooks/empty-result-recovery-speckit-empty-result-recovery-v1.md`

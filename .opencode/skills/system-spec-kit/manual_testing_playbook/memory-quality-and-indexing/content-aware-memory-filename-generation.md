...
```text
ALLOWED WRITE PATHS
- .opencode/skills/system-spec-kit/manual_testing_playbook/memory-quality-and-indexing/content-aware-memory-filename-generation.md (this file only)
```
...
- Feature catalog: [memory-quality-and-indexing/content-aware-memory-filename-generation.md](../../feature_catalog/memory-quality-and-indexing/content-aware-memory-filename-generation.md)

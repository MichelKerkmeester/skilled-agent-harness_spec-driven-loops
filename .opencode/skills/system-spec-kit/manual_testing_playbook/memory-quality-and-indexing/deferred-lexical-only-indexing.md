...
- Feature catalog: [memory-quality-and-indexing/deferred-lexical-only-indexing.md](../../feature_catalog/memory-quality-and-indexing/deferred-lexical-only-indexing.md)

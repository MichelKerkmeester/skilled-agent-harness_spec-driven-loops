...
- Feature catalog: [memory-quality-and-indexing/pre-flight-token-budget-validation.md](../../feature_catalog/memory-quality-and-indexing/pre-flight-token-budget-validation.md)
...
- Feature file path: `memory-quality-and-indexing/pre-flight-token-budget-validation-pi-a3.md`

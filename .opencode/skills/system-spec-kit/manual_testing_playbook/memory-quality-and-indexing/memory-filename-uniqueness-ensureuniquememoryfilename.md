...
ALLOWED WRITE PATHS
.opencode/skills/system-spec-kit/manual_testing_playbook/memory-quality-and-indexing/memory-filename-uniqueness-ensureuniquememoryfilename.md (this file only)
```
...
- Feature catalog: [memory-quality-and-indexing/spec-folder-description-discovery.md](../../feature_catalog/memory-quality-and-indexing/spec-folder-description-discovery.md)

...
ALLOWED WRITE PATHS
- .opencode/skills/system-spec-kit/manual_testing_playbook/memory-quality-and-indexing/constitutional-sufficiency-gate-exemption.md (this file only)
```
...
- Feature catalog: [memory-quality-and-indexing/constitutional-sufficiency-gate-exemption.md](../../feature_catalog/memory-quality-and-indexing/constitutional-sufficiency-gate-exemption.md)

...
Because the scenario's required create/save/corrupt/regenerate steps would create or modify files outside `.opencode/skills/system-spec-kit/manual_testing_playbook/memory-quality-and-indexing/description-json-schema-field-validation.md`, the expected schema/update/repair signals were not observed in this constrained run.

...
- Feature catalog: [scoring_and_calibration/embedding_cache.md](../../feature_catalog/scoring_and_calibration/embedding_cache.md)
...
- Feature file path: `scoring_and_calibration/embedding_cache_r18.md`

...
- Feature catalog: [query-intelligence/hyde-hypothetical-document-embeddings.md](../../feature_catalog/query-intelligence/hyde-hypothetical-document-embeddings.md)

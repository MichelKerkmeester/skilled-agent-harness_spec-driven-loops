...
Validation surface read from `../../feature_catalog/query-intelligence/channel-min-representation.md`:
...
- Feature catalog: [query-intelligence/channel-min-representation.md](../../feature_catalog/query-intelligence/channel-min-representation.md)

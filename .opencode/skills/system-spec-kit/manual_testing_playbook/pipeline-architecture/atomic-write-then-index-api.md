...
- Feature catalog: [pipeline-architecture/atomic-write-then-index-api.md](../../feature_catalog/pipeline-architecture/atomic-write-then-index-api.md)

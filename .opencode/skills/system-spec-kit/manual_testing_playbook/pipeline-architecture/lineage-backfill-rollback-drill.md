...
- Feature catalog: [pipeline-architecture/lineage-state-active-projection-and-asof-resolution.md](../../feature_catalog/pipeline-architecture/lineage-state-active-projection-and-asof-resolution.md)
...
- Feature file path: `pipeline-architecture/lineage-backfill-rollback-drill.md`

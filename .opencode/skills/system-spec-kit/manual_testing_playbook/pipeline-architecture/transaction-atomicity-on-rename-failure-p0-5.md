...
- Feature catalog: [pipeline-architecture/atomic-pending-file-recovery.md](../../feature_catalog/pipeline-architecture/atomic-pending-file-recovery.md)
...
- Feature file path: `pipeline-architecture/transaction-atomicity-on-rename-failure-p0-5.md`

...
- Feature catalog: [pipeline-architecture/dynamic-server-instructions-at-mcp-initialization.md](../../feature_catalog/pipeline-architecture/dynamic-server-instructions-at-mcp-initialization.md)
...
- Feature file path: `pipeline-architecture/dynamic-server-instructions-p1-6.md`

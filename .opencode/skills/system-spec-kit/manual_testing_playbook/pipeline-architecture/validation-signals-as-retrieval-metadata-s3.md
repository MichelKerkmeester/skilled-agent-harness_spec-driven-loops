...
- Feature catalog: [pipeline-architecture/validation-signals-as-retrieval-metadata.md](../../feature_catalog/pipeline-architecture/validation-signals-as-retrieval-metadata.md)

...
- Feature catalog: [pipeline-architecture/learned-relevance-feedback.md](../../feature_catalog/pipeline-architecture/learned-relevance-feedback.md)
...
- Feature file path: `pipeline-architecture/learned-relevance-feedback-r11.md`

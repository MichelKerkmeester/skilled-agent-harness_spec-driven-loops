...
- Feature catalog: [pipeline-architecture/dbpath-extraction-and-import-standardization.md](../../feature_catalog/pipeline-architecture/dbpath-extraction-and-import-standardization.md)
...
- Feature file path: `pipeline-architecture/db-path-extraction-and-import-standardization.md`

...
- Feature catalog: [pipeline-architecture/7-layer-tool-architecture-metadata.md](../../feature_catalog/pipeline-architecture/7-layer-tool-architecture-metadata.md)

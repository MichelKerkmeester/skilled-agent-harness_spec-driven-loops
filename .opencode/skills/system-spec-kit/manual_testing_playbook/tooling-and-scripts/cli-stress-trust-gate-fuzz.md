...
| `../../../system-skill-advisor/feature_catalog/mcp-surface/skill-advisor-cli.md` | Feature-catalog source for the skill-advisor CLI |
...
- Feature file path: `tooling-and-scripts/cli-stress-trust-gate-fuzz.md`

...
```
.opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/real-time-filesystem-watching-p1-7.md
```
...
- Feature catalog: [tooling-and-scripts/real-time-filesystem-watching-with-chokidar.md](../../feature_catalog/tooling-and-scripts/real-time-filesystem-watching-with-chokidar.md)
...
- Feature file path: `tooling-and-scripts/real-time-filesystem-watching-p1-7.md`

...
ALLOWED WRITE PATHS
- .opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/cli-dist-freshness-guard.md (this file only)
```
...
| `../../feature_catalog/tooling-and-scripts/spec-memory-cli-daemon-backed-surface.md` | Feature-catalog source describing the shim guards |

...
- Feature catalog: [tooling-and-scripts/tree-thinning-for-spec-folder-consolidation.md](../../feature_catalog/tooling-and-scripts/tree-thinning-for-spec-folder-consolidation.md)

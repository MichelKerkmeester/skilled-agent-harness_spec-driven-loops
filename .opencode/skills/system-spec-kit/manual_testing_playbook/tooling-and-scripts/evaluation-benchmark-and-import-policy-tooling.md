...
ALLOWED WRITE PATHS
.opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/evaluation-benchmark-and-import-policy-tooling.md (this file only)
```
...
- Feature catalog: [tooling-and-scripts/evaluation-benchmark-and-import-policy-tooling.md](../../feature_catalog/tooling-and-scripts/evaluation-benchmark-and-import-policy-tooling.md)

...
- Feature catalog: [implement_and_remove_deprecated_features/inert_scoring_flags_and_compatibility_shims.md](../../feature_catalog/implement_and_remove_deprecated_features/inert_scoring_flags_and_compatibility_shims.md)
...
- Feature file path: `implement_and_remove_deprecated_features/inert_scoring_flags.md`

...
ALLOWED WRITE PATHS
.opencode/skills/system-spec-kit/manual_testing_playbook/memory_quality_and_indexing/memory_filename_uniqueness_ensureuniquememoryfilename.md (this file only)
```
...
- Feature file path: `memory_quality_and_indexing/memory_filename_uniqueness_ensureuniquememoryfilename.md`

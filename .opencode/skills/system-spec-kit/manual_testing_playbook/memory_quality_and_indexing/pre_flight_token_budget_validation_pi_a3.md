...
- Feature catalog: [memory_quality_and_indexing/pre_flight_token_budget_validation.md](../../feature_catalog/memory_quality_and_indexing/pre_flight_token_budget_validation.md)
...
- Feature file path: `memory_quality_and_indexing/pre_flight_token_budget_validation_pi_a3.md`

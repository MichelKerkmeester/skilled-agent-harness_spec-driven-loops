...
```text
ALLOWED WRITE PATHS
- .opencode/skills/system-spec-kit/manual_testing_playbook/memory_quality_and_indexing/content_aware_memory_filename_generation.md (this file only)
```
...
- Feature catalog: [memory_quality_and_indexing/content_aware_memory_filename_generation.md](../../feature_catalog/memory_quality_and_indexing/content_aware_memory_filename_generation.md)
...
- Feature file path: `memory_quality_and_indexing/content_aware_memory_filename_generation.md`

...
- Feature catalog: [memory_quality_and_indexing/session_enrichment_and_alignment_guards.md](../../feature_catalog/memory_quality_and_indexing/session_enrichment_and_alignment_guards.md)
...
- Feature file path: `memory_quality_and_indexing/session_enrichment_and_alignment_guardrails.md`

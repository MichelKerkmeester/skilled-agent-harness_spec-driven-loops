...
- Feature catalog: [context-preservation/working-set-tracker.md](../../feature_catalog/context-preservation/working-set-tracker.md)
...
- Feature file path: `context-preservation/working-set-compaction.md`

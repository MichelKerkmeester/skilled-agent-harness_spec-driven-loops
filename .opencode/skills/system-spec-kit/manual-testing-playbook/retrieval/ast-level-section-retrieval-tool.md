...
1. Read `feature-catalog/retrieval/ast-level-section-retrieval-tool.md` and confirm it states `PLANNED (Sprint 019): DEFERRED`
...
- Feature file path: `retrieval/ast-level-section-retrieval-tool.md`

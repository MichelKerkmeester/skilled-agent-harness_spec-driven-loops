...
version: 3.6.0.2
id: pipeline-architecture-lease-probe-retry-reap-hardening
...
2. `cd .opencode/skills/system-spec-kit/mcp-server && npx vitest run tests/launcher-reap-hardening.vitest.ts`
...
```text
$ cd .opencode/skills/system-spec-kit/mcp-server && npx vitest run tests/launcher-reap-hardening.vitest.ts
...
| `../../feature-catalog/pipeline-architecture/lease-probe-retry-reap-hardening.md` | Feature-catalog source describing the implementation contract |

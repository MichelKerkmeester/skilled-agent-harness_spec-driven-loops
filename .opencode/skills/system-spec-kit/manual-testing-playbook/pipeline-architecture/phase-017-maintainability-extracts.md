...
```text
mcp-server/handlers/memory-context.ts:231-237
...
mcp-server/handlers/memory-context.ts:565-571
return {
  advisory: true,
  advisoryPreset: 'ready',
  preferredTool: 'code_graph_query',
...
mcp-server/tests/graph-first-routing-nudge.vitest.ts:155-159

...
version: 3.6.0.4
id: pipeline-architecture-daemon-ownership-reelection
...
| `../../feature-catalog/pipeline-architecture/daemon-ownership-reelection.md` | Feature-catalog source describing the implementation contract |
...
- Feature file path: `pipeline-architecture/daemon-ownership-reelection.md`

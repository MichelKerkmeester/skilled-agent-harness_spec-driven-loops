...
Found 7 matches
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp-server/lib/governance/scope-governance.ts:
  Line 300: export function normalizeScopeContext(input: ScopeContext): ScopeContext {


/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp-server/lib/storage/reconsolidation.ts:
...
```text
$ set +e; npx vitest run scripts/tests/normalizer-lint.vitest.ts --config mcp-server/vitest.config.ts --root .; rc=$?; printf '\nEXIT_CODE=%s\n' "$rc"

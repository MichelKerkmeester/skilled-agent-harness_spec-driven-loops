...
spec-memory: @spec-kit/mcp-server dist is stale. Run: cd .opencode/skills/system-spec-kit/mcp-server && npm run build
...
| `../../feature-catalog/tooling-and-scripts/spec-memory-cli-daemon-backed-surface.md` | Feature-catalog source for the CLI surface contract |
...
- Feature file path: `tooling-and-scripts/cli-list-tools-parity.md`

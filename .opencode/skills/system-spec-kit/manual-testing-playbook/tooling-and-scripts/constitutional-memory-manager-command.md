...
Observed `/memory:learn` surfaces from the real command contract (`.opencode/commands/memory/learn.md`), presentation asset (`.opencode/commands/memory/assets/learn-presentation.txt`), and constitutional directory (`.opencode/skills/system-spec-kit/constitutional/`):

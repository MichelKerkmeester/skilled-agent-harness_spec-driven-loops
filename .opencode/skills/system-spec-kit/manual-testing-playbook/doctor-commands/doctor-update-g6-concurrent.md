...
5. While terminal A is running, verify `.opencode/skills/system-skill-advisor/runtime/database/.doctor-update.flock` is held or represented by the command output.

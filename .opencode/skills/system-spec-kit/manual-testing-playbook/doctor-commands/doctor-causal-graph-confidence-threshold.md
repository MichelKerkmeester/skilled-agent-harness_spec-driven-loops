...
- Baseline DB stat command:
  ```
  stat -f '%m %z' .opencode/skills/system-spec-kit/mcp-server/database/context-index.sqlite
  ```
  Output:
  ```
...
- Feature file path: `doctor-commands/doctor-causal-graph-confidence-threshold.md`

...
2. If no fixture exists, record `SKIP` naming the missing `v3.3.0.0` fixture as the blocker, and stop.
...
- **Pass**: The two-hop migration runs, new schema is active, and legacy files are flagged but preserved.

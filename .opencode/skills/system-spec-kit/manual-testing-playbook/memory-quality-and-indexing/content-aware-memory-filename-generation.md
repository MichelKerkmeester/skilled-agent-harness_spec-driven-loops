...
version: 3.6.0.13
id: memory-quality-and-indexing-content-aware-memory-filename-generation
...
```text
ALLOWED WRITE PATHS
- .opencode/skills/system-spec-kit/manual-testing-playbook/memory-quality-and-indexing/content-aware-memory-filename-generation.md (this file only)
```

...
```json
{
  ...
  "data": {
    ...
    "results": [
      {
        "id": 9370,
        "filePath": ".opencode/skills/system-spec-kit/constitutional/comment-hygiene.md",
        "title": "Comment Hygiene — No Ephemeral Artifact Pointers in Code Comments",
        "confidence": {
          "label": "low",
          "value": 0.095,
      ...
      {
        "id": 9375,
        "filePath": ".opencode/skills/system-spec-kit/constitutional/memory-system-spec-kit-only.md",
        "title": "MEMORY — Spec-Kit System Only",
        "compact": true
      },
      {
        "id": 9371,
        "filePath": ".opencode/skills/system-spec-kit/constitutional/gate-enforcement.md",
        "title": "GATE ENFORCEMENT - Edge Cases & Cross-Reference",
        "compact": true
      },
      {
      ...
      {
        "id": 9380,
        "filePath": ".opencode/skills/system-spec-kit/constitutional/verify-before-completion-claims.md",
        "title": "Verify Before Completion Claims",
        "compact": true
      }
    ],
...
- Feature file path: `feature-flag-reference/memory-and-storage.md`

...
- Prompt: `Check roadmap flags in .opencode/skills/system-spec-kit/mcp-server and verify the four expected SPECKIT_MEMORY_* snapshots.`
...
```
Check roadmap flags in .opencode/skills/system-spec-kit/mcp-server and verify the four expected SPECKIT_MEMORY_* snapshots.
```
...
| File | Role |
|---|---|
| [manual-testing-playbook.md](../../manual-testing-playbook/manual-testing-playbook.md) | Root directory page and scenario summary |
...
| File | Role |
|---|---|
| `mcp-server/lib/config/capability-flags.ts` | Runtime roadmap-default resolver behavior |
| `mcp-server/tests/feature-flag-reference-docs.vitest.ts` | Regression check that keeps root summary and feature-file detail aligned |

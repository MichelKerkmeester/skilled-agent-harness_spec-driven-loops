...
| `.opencode/skills/sk-code/code-quality/scripts/check-comment-hygiene.sh` | Shared checker called by the pre-commit gate |
...
- Feature file path: `ux-hooks/C--comment-hygiene-opencode-plugin.md`

...
9. Targeted Vitest: `cd .opencode/skills/system-spec-kit/mcp-server && npm exec -- vitest run tests/provenance-envelope.vitest.ts`.
...
- Source: `.opencode/skills/system-spec-kit/mcp-server/lib/search/pipeline/stage2-fusion.ts`, `.opencode/skills/system-spec-kit/mcp-server/formatters/search-results.ts`, `.opencode/skills/system-spec-kit/mcp-server/lib/search/pipeline/types.ts`
- Regression tests: `.opencode/skills/system-spec-kit/mcp-server/tests/provenance-envelope.vitest.ts`

...
| File | Role |
|---|---|
| `.opencode/skills/sk-code/sk-code-quality/scripts/hooks/claude-posttooluse.sh` | Primary implementation anchor — the PostToolUse hook script |

...
| M-012 | Dedicated Memory/Spec-Kit Scenarios | SCOPE_ADHERENCE advisory change-set rule | [M-012](../manual-testing-playbook/tooling-and-scripts/scope-adherence-advisory-rule.md) | *(test-only, no catalog entry)* |
| M-013 | Dedicated Memory/Spec-Kit Scenarios | AC_COVERAGE single-source ratio | [M-013](../manual-testing-playbook/tooling-and-scripts/ac-coverage-single-source-ratio.md) | *(test-only, no catalog entry)* |

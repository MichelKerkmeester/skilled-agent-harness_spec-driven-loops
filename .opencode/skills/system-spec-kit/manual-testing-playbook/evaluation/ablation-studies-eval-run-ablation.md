...
- phase_018_change: post-018 audit verified against `mcp-server/handlers/eval-reporting.ts`, `mcp-server/lib/eval/ablation-framework.ts`, `mcp-server/lib/eval/k-value-analysis.ts`, `mcp-server/tests/ablation-framework.vitest.ts`, and `mcp-server/tests/handler-eval-reporting.vitest.ts`

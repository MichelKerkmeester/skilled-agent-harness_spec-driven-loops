...
```text
$ sqlite3 -readonly "/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp-server/database/context-index.sqlite" "SELECT name FROM sqlite_master WHERE type='table' AND name='community_summaries'; SELECT community_id, member_count, substr(summary,1,500) AS summary, member_ids FROM community_summaries LIMIT 10;"
community_summaries

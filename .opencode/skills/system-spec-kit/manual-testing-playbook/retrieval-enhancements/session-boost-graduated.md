...
8. Targeted Vitest: `cd .opencode/skills/system-spec-kit/mcp-server && npm exec -- vitest run tests/stage2-fusion.vitest.ts`.
...
- Source: `.opencode/skills/system-spec-kit/mcp-server/lib/search/session-boost.ts`, `.opencode/skills/system-spec-kit/mcp-server/lib/search/pipeline/stage2-fusion.ts`
- Regression tests: `.opencode/skills/system-spec-kit/mcp-server/tests/stage2-fusion.vitest.ts`

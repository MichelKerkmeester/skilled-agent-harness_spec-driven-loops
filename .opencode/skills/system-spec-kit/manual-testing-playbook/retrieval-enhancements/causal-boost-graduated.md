...
version: 3.6.0.5
id: retrieval-enhancements-causal-boost-graduated
...
9. Targeted Vitest: `cd .opencode/skills/system-spec-kit/mcp-server && npm exec -- vitest run tests/causal-boost.vitest.ts tests/stage2-fusion.vitest.ts`.
...
- Source: `.opencode/skills/system-spec-kit/mcp-server/lib/search/causal-boost.ts`, `.opencode/skills/system-spec-kit/mcp-server/lib/search/pipeline/stage2-fusion.ts`
- Regression tests: `.opencode/skills/system-spec-kit/mcp-server/tests/causal-boost.vitest.ts`, `.opencode/skills/system-spec-kit/mcp-server/tests/stage2-fusion.vitest.ts`
...
- Feature file path: `retrieval-enhancements/causal-boost-graduated.md`

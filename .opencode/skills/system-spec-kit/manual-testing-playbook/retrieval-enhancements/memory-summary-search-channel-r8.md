...
Command: `sqlite3 "/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp-server/database/context-index.sqlite" "SELECT 'memory_index_success_count', COUNT(*) FROM memory_index WHERE embedding_status = 'success'; SELECT 'memory_summaries_count', COUNT(*) FROM memory_summaries; SELECT 'scale_gate_gt_5000', CASE WHEN (SELECT COUNT(*) FROM memory_index WHERE embedding_status = 'success') > 5000 THEN 'true' ELSE 'false' END;"`

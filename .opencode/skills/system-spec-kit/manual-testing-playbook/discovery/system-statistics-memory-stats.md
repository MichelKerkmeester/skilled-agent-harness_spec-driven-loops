...
- Feature catalog: [discovery/system-statistics-memorystats.md](../../feature-catalog/discovery/system-statistics-memorystats.md)
...
- Feature file path: `discovery/system-statistics-memory-stats.md`

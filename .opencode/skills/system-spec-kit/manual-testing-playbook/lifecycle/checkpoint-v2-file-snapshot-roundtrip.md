...
- Reopen coordinator: `mcp-server/lib/search/vector-index-store.ts` (`reopenActiveDatabase`)
- Schema marker: `mcp-server/lib/search/vector-index-schema.ts` (migration v29: `snapshot_format`, `snapshot_path`)
...
- Feature file path: `lifecycle/checkpoint-v2-file-snapshot-roundtrip.md`
- Source anchors read: `mcp-server/lib/storage/checkpoints.ts` (`createCheckpointV2` ~L2181, `VACUUM main INTO`/`VACUUM active_vec INTO` ~L2217/2220, `restoreCheckpointV2` ~L2489, `RestoreJournalPhase` ~L385, `RESTORE_JOURNAL_NAME` ~L117); `mcp-server/lib/search/vector-index-schema.ts` (migration v29 `snapshot_format`/`snapshot_path` ~L1375-1381)

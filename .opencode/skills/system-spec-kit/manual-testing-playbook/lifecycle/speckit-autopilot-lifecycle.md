...
1. Inspect `.opencode/commands/speckit/complete.md`, `.opencode/commands/speckit/plan.md`, `.opencode/commands/speckit/implement.md`, and `.opencode/commands/speckit/assets/speckit-complete-auto.yaml`.

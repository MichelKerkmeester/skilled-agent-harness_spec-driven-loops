...
Inspect the three Speckit command routers first. If they route correctly, inspect `speckit-complete.yaml` for the unattended result schema and branch-preserved failure settings.

...
```ts
// .opencode/skills/system-spec-kit/mcp-server/lib/search/llm-reformulation.ts
...
- **Pass**: Reformulation produces valid abstract and variants in deep mode, and is skipped in non-deep mode.
- **Fail**: Abstract empty, variants exceed MAX_VARIANTS (2), or pipeline runs outside deep mode.
...
- Feature flag reference: [01-1-search-pipeline-features-speckit.md](../../feature-catalog/feature-flag-reference/1-search-pipeline-features-speckit.md)
- Source file: `mcp-server/lib/search/llm-reformulation.ts`

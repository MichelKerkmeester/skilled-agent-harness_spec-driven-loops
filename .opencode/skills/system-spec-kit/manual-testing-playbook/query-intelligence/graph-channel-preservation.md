...
version: 3.6.0.5
id: query-intelligence-graph-channel-preservation
...
4. Tail `.opencode/skills/system-spec-kit/mcp-server/data/search-decisions.jsonl` and confirm `routingReasons` includes `graph-preserved-by-intent` for the two find_* queries and `graph-preserved-by-entity-density` for the entity-dense query.
...
6. Targeted Vitest: `cd .opencode/skills/system-spec-kit/mcp-server && npm exec -- vitest run tests/query-router.vitest.ts tests/entity-density.vitest.ts tests/routing-telemetry-stress.vitest.ts`.
...
- Source: `.opencode/skills/system-spec-kit/mcp-server/lib/search/query-router.ts`, `.opencode/skills/system-spec-kit/mcp-server/lib/search/entity-density.ts`, `.opencode/skills/system-spec-kit/mcp-server/lib/search/routing-telemetry.ts`
- Regression tests: `.opencode/skills/system-spec-kit/mcp-server/tests/query-router.vitest.ts`, `.opencode/skills/system-spec-kit/mcp-server/tests/entity-density.vitest.ts`, `.opencode/skills/system-spec-kit/mcp-server/tests/routing-telemetry-stress.vitest.ts`
...
- Feature file path: `query-intelligence/graph-channel-preservation.md`

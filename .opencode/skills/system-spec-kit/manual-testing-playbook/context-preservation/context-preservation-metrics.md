...
version: 3.6.0.5
id: context-preservation-context-preservation-metrics
...
- Source: `.opencode/skills/system-spec-kit/mcp-server/lib/session/context-metrics.ts`, `.opencode/skills/system-spec-kit/mcp-server/handlers/session-health.ts`, `.opencode/skills/system-spec-kit/mcp-server/lib/session/session-manager.ts`

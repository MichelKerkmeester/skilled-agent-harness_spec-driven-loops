...
- Claude `PostToolUse(Write|Edit)` hook: `.opencode/runtime-hooks/post-edit-quality/claude/claude-posttooluse.cjs`
- Claude hook router: `.opencode/runtime-hooks/post-edit-quality/lib/post-edit-router.cjs`

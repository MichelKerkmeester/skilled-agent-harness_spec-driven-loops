...
version: 3.6.0.7
id: maintenance-memory-retention-sweep-basic-flow
...
SPECKIT_RETENTION_SWEEP=true SPECKIT_RETENTION_SWEEP_INTERVAL_MS=1000 npm --prefix .opencode/skills/system-spec-kit/mcp-server start 2>&1 | tee /tmp/retention-sweep-interval.log
```
...
- Source: `.opencode/skills/system-spec-kit/mcp-server/lib/governance/memory-retention-sweep.ts`
- Source: `.opencode/skills/system-spec-kit/mcp-server/lib/session/session-manager.ts`

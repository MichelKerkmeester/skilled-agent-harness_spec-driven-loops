...
node .opencode/skills/system-spec-kit/scripts/dist/graph/migrate-generated-json.js --dry-run --verify
node .opencode/skills/system-spec-kit/scripts/dist/graph/migrate-generated-json.js --only <spec-folder>
```

#!/usr/bin/env node
// ╔══════════════════════════════════════════════════════════════════════════╗
// ║ Migrate Deep Loop Legacy Owner Map                                       ║
// ╚══════════════════════════════════════════════════════════════════════════╝
...
function buildExplicitOwnerMap() {
  ...
  const reviewOwners = {
    ...
    '011-skill-advisor-graph-pt-02': `${ROOT_SPEC}/006-search-routing-advisor/001-skill-advisor-graph/001-research-findings-fixes`,
    '011-skill-advisor-graph-pt-03': `${ROOT_SPEC}/006-search-routing-advisor/001-skill-advisor-graph/002-manual-testing-playbook`,
    '011-skill-advisor-graph-pt-04': `${ROOT_SPEC}/006-search-routing-advisor/001-skill-advisor-graph/003-skill-advisor-packaging`,
    '011-skill-advisor-graph-pt-05': `${ROOT_SPEC}/006-search-routing-advisor/001-skill-advisor-graph/004-graph-metadata-enrichment`,
    '011-skill-advisor-graph-pt-06': `${ROOT_SPEC}/006-search-routing-advisor/001-skill-advisor-graph/005-repo-wide-path-migration`,
    '016-foundational-runtime-pt-01': `${ROOT_SPEC}/008-runtime-executor-hardening/001-foundational-runtime`,

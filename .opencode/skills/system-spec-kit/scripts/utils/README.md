...
node -e "import('./.opencode/skills/system-spec-kit/scripts/dist/utils/path-utils.js')\
.then(m => console.log(typeof m.sanitizePath))"
node -e "import('./.opencode/skills/system-spec-kit/scripts/dist/utils/index.js')\

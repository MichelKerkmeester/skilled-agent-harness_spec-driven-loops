...
This fixture gives the validator a fully compliant Level 2 folder so strict template comparison can be tested against live templates instead of placeholder documents. The concrete fixture artifact is `.opencode/skills/system-spec-kit/scripts/test-fixtures/053-template-compliant-level2/spec.md`.

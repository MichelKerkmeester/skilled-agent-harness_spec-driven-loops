...
/** Pattern for category/organizational folders (numbered categories or named spec tracks). */
export const CATEGORY_FOLDER_PATTERN: RegExp = /^(?:\d{2}--[a-z][a-z0-9.-]*|[a-z][a-z0-9.-]*(?:-[a-z0-9.-]+)*)$/;

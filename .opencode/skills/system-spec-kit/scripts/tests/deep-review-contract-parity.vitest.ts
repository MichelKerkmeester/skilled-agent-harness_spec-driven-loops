...
const reviewCapabilityModulePath = path.join(
  WORKSPACE_ROOT,
  '.opencode/skills/deep-loop-workflows/review/scripts/runtime-capabilities.cjs',
);
...
(reviewCapabilityModule ? describe : describe.skip)('deep-review contract parity', () => {
  const primaryDocs = [
    ...
    '.opencode/skills/deep-loop-workflows/review/README.md',
    '.opencode/skills/deep-loop-workflows/review/references/state/state_format.md',
    '.opencode/skills/deep-loop-workflows/review/references/protocol/loop_protocol.md',
    '.opencode/skills/deep-loop-workflows/review/references/protocol/quick_reference.md',
    '.opencode/skills/deep-loop-workflows/review/assets/review_mode_contract.yaml',
  ];
  ...
  it('keeps the generated review contract aligned on artifact_dir semantics', () => {
    const content = readWorkspaceFile('.opencode/skills/deep-loop-workflows/review/assets/review_mode_contract.yaml');

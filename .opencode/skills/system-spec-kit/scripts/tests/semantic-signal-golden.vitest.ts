...
const GOLDEN_CASES = [
  ...
  },
  {
    ...
    text: 'Researched workspace identity alignment, compared Claude and OpenCode capture formats, planned the adapter migration, and documented the rollout approach.',
    expected: [
      'researched workspace identity alignment',
      'workspace identity alignment compared',
      'identity alignment compared claude',
      'alignment compared claude opencode',
      'compared claude opencode capture',
      'claude opencode capture formats',
      'opencode capture formats planned',

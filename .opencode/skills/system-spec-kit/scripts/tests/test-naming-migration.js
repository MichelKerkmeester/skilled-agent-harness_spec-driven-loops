...
const LEGACY_SNAKE_CASE_FUNCTION_BUDGET = new Map([
  ['mcp-server/lib/search/vector-index-impl.ts', 75],
  ['mcp-server/lib/search/vector-index-aliases.ts', 8],
  ['mcp-server/lib/search/vector-index-mutations.ts', 10],
  ['mcp-server/lib/search/vector-index-queries.ts', 30],
  ['mcp-server/lib/search/vector-index-schema.ts', 9],
  ['mcp-server/lib/search/vector-index-store.ts', 26],
  ['mcp-server/lib/search/vector-index-types.ts', 4],
  ['mcp-server/lib/learning/corrections.ts', 19],
]);

const CROSS_REFERENCE_MISMATCH_BUDGET = new Map([
  ['mcp-server/cli.ts', 2],
  ['mcp-server/context-server.ts', 1],
  ['mcp-server/formatters/search-results.ts', 1],
  ['mcp-server/handlers/chunking-orchestrator.ts', 2],
  ['mcp-server/handlers/index.ts', 34],
  ['mcp-server/handlers/memory-context.ts', 3],
  ['mcp-server/handlers/memory-crud-update.ts', 1],
  ['mcp-server/handlers/memory-index.ts', 1],
  ['mcp-server/handlers/memory-search.ts', 1],
  ['mcp-server/handlers/save/reconsolidation-bridge.ts', 1],
  ['mcp-server/hooks/memory-surface.ts', 2],
  ['mcp-server/lib/cognitive/adaptive-ranking.ts', 2],
  ['mcp-server/lib/cognitive/prediction-error-gate.ts', 1],
  ['mcp-server/lib/cognitive/temporal-contiguity.ts', 7],
  ['mcp-server/lib/config/type-inference.ts', 1],
  ['mcp-server/lib/extraction/entity-extractor.ts', 1],
  ['mcp-server/lib/feedback/batch-learning.ts', 2],
  ['mcp-server/lib/feedback/shadow-evaluation-runtime.ts', 2],
  ['mcp-server/lib/feedback/shadow-scoring.ts', 11],
  ['mcp-server/lib/governance/scope-governance.ts', 5],
  ['mcp-server/lib/graph/community-detection.ts', 2],
  ['mcp-server/lib/graph/community-storage.ts', 1],
  ['mcp-server/lib/learning/corrections.ts', 6],
  ['mcp-server/lib/ops/job-queue.ts', 3],
  ['mcp-server/lib/parsing/memory-parser.ts', 3],
  ['mcp-server/lib/scoring/confidence-tracker.ts', 1],
  ['mcp-server/lib/search/auto-promotion.ts', 2],
  ['mcp-server/lib/search/bm25-index.ts', 3],
  ['mcp-server/lib/search/causal-boost.ts', 1],
  ['mcp-server/lib/search/chunk-reassembly.ts', 2],
  ['mcp-server/lib/search/graph-search-fn.ts', 2],
  ['mcp-server/lib/search/hybrid-search.ts', 3],
  ['mcp-server/lib/search/learned-feedback.ts', 1],
  ['mcp-server/lib/search/pipeline/stage2-fusion.ts', 3],
  ['mcp-server/lib/search/vector-index-aliases.ts', 4],
  ['mcp-server/lib/search/vector-index-mutations.ts', 1],
  ['mcp-server/lib/search/vector-index-schema.ts', 18],
  ['mcp-server/lib/session/session-manager.ts', 1],
  ['mcp-server/lib/storage/checkpoints.ts', 2],
  ['mcp-server/lib/storage/lineage-state.ts', 12],
  ['mcp-server/lib/validation/preflight.ts', 1],

...
// ───────────────────────────────────────────────────────────────
// Drives scripts/rules/check-grep-convention.sh through the same wrapper
...
const RULE_SCRIPT = path.join(SKILL_ROOT, 'scripts', 'rules', 'check-grep-convention.sh');
const VALIDATE_SCRIPT_DIR = path.join(SKILL_ROOT, 'scripts', 'spec');
const FIXTURE_ROOT = path.join(SKILL_ROOT, 'scripts', 'tests', 'fixtures', 'grep-convention');

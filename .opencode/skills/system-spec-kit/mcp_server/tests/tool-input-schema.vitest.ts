  ...
  it('runtime code_graph_verify schema accepts public fields and rejects unknown fields', () => {
    expect(() => {
      validateToolArgs('code_graph_verify', {
        rootDir: '.',
        batteryPath: '.opencode/skills/system-spec-kit/mcp_server/code_graph/gold/code-graph-gold-queries.json',
        category: 'mcp-tool',
        failFast: true,
        includeDetails: true,
  ...
  const acceptanceCases: ToolSchemaCase[] = [
    {
      ...
      args: {
        rootDir: '.opencode/skills/system-spec-kit/mcp_server',
        includeGlobs: ['**/*.ts'],
  ...
  const acceptanceCases: ToolSchemaCase[] = [
    ...
    },
    {
      ...
      args: {
        ...
        resultFile: '.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts',
        rating: 'helpful',

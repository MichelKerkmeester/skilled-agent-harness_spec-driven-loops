---
title: "system spec kit mcp server tests validation: Code README"
description: "Code-facing README for .opencode/skills/system-spec-kit/mcp_server/tests/validation."
trigger_phrases:
  - "system-spec-kit mcp_server/tests/validation"
  - "code README"
---

# system spec kit mcp server tests validation
...
This README documents the code-bearing folder `.opencode/skills/system-spec-kit/mcp_server/tests/validation` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/system-spec-kit/mcp_server/tests/validation
```
...
|---|---|
| Folder boundary | Documents direct code files under `mcp_server/tests/validation`. |
...
| Path | Purpose |
|---|---|
| `evidence-marker-audit.vitest.ts` | TS source file in this folder. |
...
```text
User request: Check .opencode/skills/system-spec-kit/mcp_server/tests/validation for sk-code and README coverage.

---
title: "system spec kit mcp server tests integration: Code README"
description: "Code-facing README for .opencode/skills/system-spec-kit/mcp_server/tests/integration."
trigger_phrases:
  - "system-spec-kit mcp_server/tests/integration"
  - "code README"
---

# system spec kit mcp server tests integration
...
This README documents the code-bearing folder `.opencode/skills/system-spec-kit/mcp_server/tests/integration` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/system-spec-kit/mcp_server/tests/integration
```
...
|---|---|
| Folder boundary | Documents direct code files under `mcp_server/tests/integration`. |
...
| Path | Purpose |
|---|---|
| `entity-density-commit-hooks.vitest.ts` | TS source file in this folder. |
...
```text
User request: Check .opencode/skills/system-spec-kit/mcp_server/tests/integration for sk-code and README coverage.

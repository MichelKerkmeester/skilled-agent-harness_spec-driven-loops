...
const EXTENDED_LIMITS: Record<string, number> = {
  ...
  'tool-schemas.js': 910,           // Actual:904 — Expanded MCP schema set + Sprint 019:Zod schema integration, ingest tools, session_bootstrap, and newer graph/search tool contracts

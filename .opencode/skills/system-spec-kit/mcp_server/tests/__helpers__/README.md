---
title: "system spec kit mcp server tests helpers: Code README"
description: "Code-facing README for .opencode/skills/system-spec-kit/mcp_server/tests/__helpers__."
trigger_phrases:
  - "system-spec-kit mcp_server/tests/__helpers__"
  - "code README"
---

# system spec kit mcp server tests helpers
...
This README documents the code-bearing folder `.opencode/skills/system-spec-kit/mcp_server/tests/__helpers__` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/system-spec-kit/mcp_server/tests/__helpers__
```
...
|---|---|
| Folder boundary | Documents direct code files under `mcp_server/tests/__helpers__`. |
...
| Path | Purpose |
|---|---|
| `test-env.ts` | TS source file in this folder. |
...
```text
User request: Check .opencode/skills/system-spec-kit/mcp_server/tests/__helpers__ for sk-code and README coverage.

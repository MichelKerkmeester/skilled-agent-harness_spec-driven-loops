...
export function defaultPolicyBootstrap(): CodexPolicyFile {
  return {
    version: 1,
    notes: 'Conservative starter Bash denylist for Codex PreToolUse enforcement. Full-word match required per .opencode/skills/system-spec-kit/mcp_server/hooks/codex/pre-tool-use.ts. Dual key aliases (`bashDenylist` and `bash_denylist`) are emitted for compatibility.',

...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/ccc-status.ts:22-58` | Handler | reports binary path, index presence, readiness-not-applicable fields, and recommendation |
| `.opencode/skills/system-spec-kit/mcp_server/code_graph/tools/code-graph-tools.ts:86-88` | Tool surface | dispatches the requested tool |

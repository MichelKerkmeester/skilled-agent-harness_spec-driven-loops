...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/verify.ts:141-190` | Handler | resolves paths, checks readiness, blocks when not fresh, and runs the battery |
| `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/gold-query-verifier.ts:23-26` | Library | defines the default battery path |
| `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/gold-query-verifier.ts:405-430` | Library | loads and validates the battery JSON |

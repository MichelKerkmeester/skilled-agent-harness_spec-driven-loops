...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/status.ts:158-180` | Handler | reads the readiness snapshot before stats |
| `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/status.ts:181-212` | Handler | returns a degraded envelope when stats are unavailable |
| `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/status.ts:214-260` | Handler | assembles the successful status payload |

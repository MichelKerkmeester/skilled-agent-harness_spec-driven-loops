...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/mcp_server/code_graph/tools/code-graph-tools.ts:20-31` | Tool surface | registers `code_graph_*`, `detect_changes`, and `ccc_*` names |
| `.opencode/skills/system-spec-kit/mcp_server/code_graph/tools/code-graph-tools.ts:60-100` | Tool surface | dispatches those names to handlers |

...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/detect-changes.ts:1-12` | Handler | states the stale-graph hard-refuse invariant |
| `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/detect-changes.ts:241-260` | Handler | checks readiness before diff parsing and blocks stale state |
| `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/detect-changes.ts:265-368` | Handler | parses the diff and returns affected files/symbols |

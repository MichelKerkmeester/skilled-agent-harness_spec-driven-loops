---
title: "system spec kit mcp server handlers council graph: Code README"
description: "Code-facing README for .opencode/skills/system-spec-kit/mcp_server/handlers/council-graph."
trigger_phrases:
  - "system-spec-kit mcp_server/handlers/council-graph"
  - "code README"
---

# system spec kit mcp server handlers council graph

Request handler code for the skill MCP surface.
...
This README documents the code-bearing folder `.opencode/skills/system-spec-kit/mcp_server/handlers/council-graph` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
| Audit packet | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/022-system-skill-advisor-extraction/026-sk-code-and-code-readme-audit` |
...
```bash
rg --files .opencode/skills/system-spec-kit/mcp_server/handlers/council-graph
```
...
|---|---|
| Folder boundary | Documents direct code files under `mcp_server/handlers/council-graph`. |
...
| Path | Purpose |
|---|---|
| `convergence.ts` | TS source file in this folder. |
| `query.ts` | TS source file in this folder. |
| `status.ts` | TS source file in this folder. |
| `upsert.ts` | TS source file in this folder. |
...
```text
User request: Check .opencode/skills/system-spec-kit/mcp_server/handlers/council-graph for sk-code and README coverage.

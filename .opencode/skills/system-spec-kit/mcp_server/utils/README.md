...
```bash
npm test -- --run .opencode/skills/system-spec-kit/mcp_server/tests/review-fixes.vitest.ts
python3 .opencode/skills/sk-doc/scripts/validate_document.py .opencode/skills/system-spec-kit/mcp_server/utils/README.md
```

...
def db_path(repo_root: Path) -> Path:
    return repo_root / ".opencode/skills/system-spec-kit/mcp_server/database/context-index.sqlite"
...
class McpServer:
    def __init__(self, repo_root: Path, env_overrides: dict[str, str]) -> None:
        ...
        env.setdefault("SPECKIT_RESPONSE_PROFILE_V1", "false")
        env.setdefault("SPECKIT_INTENT_AUTO_PROFILE", "false")
        env.setdefault("SPECKIT_PROGRESSIVE_DISCLOSURE_V1", "false")

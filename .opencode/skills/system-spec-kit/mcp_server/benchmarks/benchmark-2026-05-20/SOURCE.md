...
- "What does the current bench say about nomic at 768-dim?" → `benchmark_report.md` Section 2.
- "Why is the hit rate 0/10?" → `benchmark_report.md` Section 6 plus Section 7 caveats.
...
| Question | File |
|---|---|
| Headline metrics | `benchmark_report.md` (Section 2) |
| Per-probe raw data | `per-probe.jsonl` |
| Single-row aggregate | `results.csv` |
| Methodology + reproducibility | `benchmark_report.md` (Sections 3, 9) |

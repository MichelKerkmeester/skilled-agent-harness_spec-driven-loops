...
```bash
node -e "const D=require('better-sqlite3'); const db=new D('.opencode/skills/system-spec-kit/mcp_server/database/vectors/context-vectors__ollama__nomic-embed-text-v1.5__768.sqlite'); db.prepare('DELETE FROM embedding_cache').run(); db.close();"
...
| [`../benchmark-2026-05-17/benchmark_report.md`](../benchmark-2026-05-17/benchmark_report.md) | Prior baseline: jina-v3 plus retrieval-rescue, 9/10 cat-24/409 at top-3 |

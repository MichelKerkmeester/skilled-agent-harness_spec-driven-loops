...
- The home of the convention defined in [`FORMAT.md`](./FORMAT.md).
...
5. **Write `benchmark_report.md`** following [`FORMAT.md`](./FORMAT.md). The required 10-section structure is:
...
The bake-off promotion flow is documented in `FORMAT.md` Section "Promotion workflow."
...
| File | Purpose |
|---|---|
| [`FORMAT.md`](./FORMAT.md) | Convention every dated subfolder follows. |

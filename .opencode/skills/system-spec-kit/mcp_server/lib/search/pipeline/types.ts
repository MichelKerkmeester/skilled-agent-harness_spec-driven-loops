...
export interface PipelineRow extends Record<string, unknown> {
  ...
  /** Stage 2 composite score preserved for auditability when Stage 3 overwrites score */
  stage2Score?: number;
  /** Graph evidence provenance — edges and communities that contributed to graph-based boosts. */
  graphEvidence?: {

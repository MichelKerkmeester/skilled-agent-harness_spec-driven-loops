---
title: "system spec kit mcp server lib council graph: Code README"
description: "Code-facing README for .opencode/skills/system-spec-kit/mcp_server/lib/council-graph."
trigger_phrases:
  - "system-spec-kit mcp_server/lib/council-graph"
  - "code README"
---

# system spec kit mcp server lib council graph
...
This README documents the code-bearing folder `.opencode/skills/system-spec-kit/mcp_server/lib/council-graph` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/system-spec-kit/mcp_server/lib/council-graph
```
...
|---|---|
| Folder boundary | Documents direct code files under `mcp_server/lib/council-graph`. |
...
| Path | Purpose |
|---|---|
| `council-graph-db.ts` | TS source file in this folder. |
| `council-graph-query.ts` | TS source file in this folder. |
...
```text
User request: Check .opencode/skills/system-spec-kit/mcp_server/lib/council-graph for sk-code and README coverage.

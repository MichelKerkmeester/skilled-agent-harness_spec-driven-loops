---
title: "system spec kit mcp server lib cocoindex: Code README"
description: "Code-facing README for .opencode/skills/system-spec-kit/mcp_server/lib/cocoindex."
trigger_phrases:
  - "system-spec-kit mcp_server/lib/cocoindex"
  - "code README"
---

# system spec kit mcp server lib cocoindex
...
This README documents the code-bearing folder `.opencode/skills/system-spec-kit/mcp_server/lib/cocoindex` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/system-spec-kit/mcp_server/lib/cocoindex
```
...
|---|---|
| Folder boundary | Documents direct code files under `mcp_server/lib/cocoindex`. |
...
| Path | Purpose |
|---|---|
| `daemon-probe.ts` | TS source file in this folder. |
...
```text
User request: Check .opencode/skills/system-spec-kit/mcp_server/lib/cocoindex for sk-code and README coverage.

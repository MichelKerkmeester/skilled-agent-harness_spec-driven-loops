...
Run focused tests from the `mcp_server/` directory when changing this folder:
...
```bash
python3 .opencode/skills/sk-doc/scripts/validate_document.py .opencode/skills/system-spec-kit/mcp_server/lib/validation/README.md
```

...
env.cacheDir = '/Users/michelkerkmeester/.cache/huggingface/hub';
env.localModelPath = '/Users/michelkerkmeester/.cache/huggingface/hub';
...
try {
  pipe = await pipeline('feature-extraction', 'onnx-community/embeddinggemma-300m-ONNX', { dtype: 'fp32' });
} catch (e) {
...
if (errMsg) {
  console.log(JSON.stringify({ load_ms: loadMs, error: errMsg.slice(0, 1500) }));
  process.exit(1);
}

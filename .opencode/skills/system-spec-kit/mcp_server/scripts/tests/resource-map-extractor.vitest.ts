...
describe('resource-map extractor', () => {
  it('renders a review-shaped resource map with all ten categories and severity counts', () => {
    const markdown = emitResourceMap({
      ...
      deltas: [
        [
          ...
          { iteration: 1, event: 'new_finding', finding_id: 'F-SKILL', severity: 'P0', file: '.opencode/skills/deep-loop-workflows/review/SKILL.md' },
          ...
          { iteration: 2, event: 'adjudication', finding_id: 'F-SKILL', severity_after: 'P1', file: '.opencode/skills/deep-loop-workflows/review/SKILL.md' },
    ...
    expect(markdown).toContain(
      '| .opencode/skills/deep-loop-workflows/review/SKILL.md | Analyzed | OK | Findings P0=0 P1=1 P2=0; Iterations=2 |',
    );
    expect(markdown).toContain(
  ...
  it('renders a research-shaped resource map with per-iteration citation counts', () => {
        ...
        [
          {
            ...
            source_paths: [
              ...
              '.opencode/skills/deep-loop-workflows/research/references/convergence.md',
            ],
            citations: [
              { path: '.opencode/skills/deep-loop-workflows/research/SKILL.md' },
    ...
    expect(markdown).toContain(
      '| .opencode/skills/deep-loop-workflows/research/SKILL.md | Cited | OK | Citations=3; Iterations=3 |',
    );
    expect(markdown).toContain(
  ...
  it('strips `:line` and `:line-range` suffixes from review evidence before classification and status checks', () => {
        ...
        [
          {
            ...
            finding_id: 'F-LINE',
            severity: 'P1',
            file: '.opencode/skills/deep-loop-workflows/review/SKILL.md:250',
          },
          {
            iteration: 1,
            event: 'new_finding',
    ...
    expect(markdown).toContain('| .opencode/skills/deep-loop-workflows/review/SKILL.md | Analyzed | OK |');

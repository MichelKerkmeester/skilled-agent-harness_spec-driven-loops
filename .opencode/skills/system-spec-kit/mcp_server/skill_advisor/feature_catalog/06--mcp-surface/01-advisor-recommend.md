...
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/tools/` | Tool surface | Source reference |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/tests/handlers/advisor-recommend.vitest.ts` | Automated test | Validation reference |
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/tests/legacy/advisor-privacy.vitest.ts` | Automated test | Validation reference |

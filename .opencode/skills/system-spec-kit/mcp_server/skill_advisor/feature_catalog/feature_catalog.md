...
This catalog is the current inventory for the skill advisor. The package source of truth is `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/`. Each group links to per-feature files that cite the real implementation and test anchors.

...
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/normalize-adapter-output.ts` | Library | Source reference |
...
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/tests/legacy/advisor-runtime-parity.vitest.ts` | Automated test | runtime-parity checks |
<!-- /ANCHOR:source-files -->

...
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/freshness.ts` | Library | Source reference |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/tests/legacy/advisor-freshness.vitest.ts` | Automated test | state transitions |

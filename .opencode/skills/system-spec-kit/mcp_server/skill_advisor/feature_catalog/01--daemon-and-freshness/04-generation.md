...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/freshness/generation.ts` | Library | Source reference |
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/generation.ts` | Library | Source reference |
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/freshness/cache-invalidation.ts` | Library | Source reference |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/tests/daemon-freshness-foundation.vitest.ts` | Automated test | generation bump atomicity |

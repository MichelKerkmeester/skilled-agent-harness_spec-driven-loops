...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/ablation.ts` | Library | Source reference |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/tests/handlers/advisor-validate.vitest.ts` | Automated test | ablation slices |

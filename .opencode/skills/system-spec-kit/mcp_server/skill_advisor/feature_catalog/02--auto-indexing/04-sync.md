...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/derived/sync.ts` | Library | Source reference |
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/derived/sanitizer.ts` | Library | Source reference |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/tests/lifecycle-derived-metadata.vitest.ts` | Automated test | sync correctness and non-derived preservation |

...
| File | Layer | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor_bench.py` | Script | Source reference |
| `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/bench/` | Implementation | Source reference |

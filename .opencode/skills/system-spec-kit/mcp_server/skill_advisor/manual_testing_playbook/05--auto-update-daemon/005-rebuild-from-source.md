...
```bash
printf 'corrupt' > /tmp/path-to-copy/.opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill-graph.sqlite
```
...
- Source: `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/freshness/rebuild-from-source.ts`.

...
```bash
printf '%s' "save this conversation context to memory" | python3 .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py --stdin --force-native --threshold 0.8
```
...
- `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/tests/compat/shim.vitest.ts`

...
```bash
python3 .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py "review this pull request" --threshold 0.8
```

2. Run at a looser threshold:

```bash
python3 .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py "review this pull request" --threshold 0.6
```

3. Run at a strict threshold:

```bash
python3 .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py "review this pull request" --threshold 0.95
```
...
- Source: `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py`.

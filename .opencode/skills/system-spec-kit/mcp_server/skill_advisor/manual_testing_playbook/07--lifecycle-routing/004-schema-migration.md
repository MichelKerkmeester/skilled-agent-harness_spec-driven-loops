...
```bash
cp /tmp/path-to-copy/.opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill-graph.sqlite /tmp/pre-v1.sqlite
```
...
- Source: `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/lifecycle/schema-migration.ts`.

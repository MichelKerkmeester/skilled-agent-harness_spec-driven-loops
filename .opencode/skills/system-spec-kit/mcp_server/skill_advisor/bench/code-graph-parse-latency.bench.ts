...
function buildFixtures(root: string): readonly Fixture[] {
  ...
  return [
    f('.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/runtime-detection.ts', 'typescript'),
    f('.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/budget-allocator.ts', 'typescript'),
    f('.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/ensure-ready.ts', 'typescript'),

...
This guide covers the current setup for `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/` after Phase 027. The canonical runtime is the native TypeScript package under `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/`; the Python script remains for compatibility and diagnostics.
...
```bash
python3 .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py "help me commit my changes"
```
...
printf '%s' "save this conversation context to memory" | \
  python3 .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py --stdin

python3 .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py --force-native "save this context"
python3 .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py --force-local "save this context"
```
...
```text
.opencode/skills/system-spec-kit/mcp_server/skill_advisor/compat/index.ts
```
...
```bash
python3 .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor_regression.py \
  --dataset .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/fixtures/skill_advisor_regression_cases.jsonl
```
...
python3 .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py --force-local "help me commit my changes"
```
...
# Python shim default
python3 .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py "create a pull request on github"

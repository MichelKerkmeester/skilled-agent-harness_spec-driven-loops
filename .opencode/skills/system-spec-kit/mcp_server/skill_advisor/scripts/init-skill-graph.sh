...
SQLITE_PATH="${REPO_ROOT}/.opencode/skills/system-spec-kit/mcp_server/database/skill-graph.sqlite"
...
run_from_repo python3 .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_graph_compiler.py --validate-only

log_step "Exporting JSON skill graph"
run_from_repo python3 .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_graph_compiler.py --export-json

log_step "Running advisor health check"
run_from_repo python3 .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py --health

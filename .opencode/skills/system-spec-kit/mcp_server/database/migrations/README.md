...
These ADRs set the architecture future migrations must preserve. All three live in the `016-embedder-testing-and-architecture` umbrella under `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/`.

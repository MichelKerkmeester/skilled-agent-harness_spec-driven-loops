...
- Feature file path: `20--remediation-revalidation/memory-health-auto-repair.md`
Related references:
- [category-stub.md](category-stub.md) — Runtime remediation, revalidation, and auto-repair workflows
- [feedback-driven-revalidation.md](feedback-driven-revalidation.md) — Feedback-driven revalidation

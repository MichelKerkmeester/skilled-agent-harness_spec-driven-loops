...
- Feature file path: `03--discovery/031-session-bootstrap-reader-ready-context.md`
Related references:
- [030-detect-changes-preflight.md](030-detect-changes-preflight.md) — detect_changes preflight (Code Graph)
- [032-session-resume-continuity-ladder.md](032-session-resume-continuity-ladder.md) — Session resume continuity ladder

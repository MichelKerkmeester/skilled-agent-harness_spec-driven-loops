...
| File | Focus |
|------|-------|
| `mcp_server/tests/session-bootstrap.vitest.ts` | Happy-path response, degraded graph messaging, next-action recommendation |
...
- Feature file path: `03--discovery/05-session-bootstrap-reader-ready-context.md`

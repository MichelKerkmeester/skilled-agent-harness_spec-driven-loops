...
| File | Focus |
|------|-------|
| `mcp_server/tests/session-resume.vitest.ts` | Layer ordering, phase-parent redirect, missing-redirect listing |
...
- Feature file path: `03--discovery/06-session-resume-continuity-ladder.md`

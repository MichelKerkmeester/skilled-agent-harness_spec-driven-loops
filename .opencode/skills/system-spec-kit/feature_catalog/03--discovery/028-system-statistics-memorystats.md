...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/handler-memory-stats-edge.vitest.ts` | Automated test | Limit behavior, validation envelopes, archived/excluded folder filtering, ranking modes, and `totalSpecFolders` regression coverage |
| `mcp_server/tests/handler-memory-crud.vitest.ts` | Automated test | Public export and direct validation coverage |
| `mcp_server/tests/memory-crud-extended.vitest.ts` | Automated test | Happy-path stats structure, scoring fallback, and composite-score payload coverage |
...
- Feature file path: `03--discovery/028-system-statistics-memorystats.md`
Related references:
- [027-memory-browser-memorylist.md](027-memory-browser-memorylist.md) — Memory browser (memory_list)
- [029-health-diagnostics-memoryhealth.md](029-health-diagnostics-memoryhealth.md) — Health diagnostics (memory_health)

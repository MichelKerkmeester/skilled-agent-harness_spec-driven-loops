...
- Feature file path: `03--discovery/029-health-diagnostics-memoryhealth.md`
Related references:
- [028-system-statistics-memorystats.md](028-system-statistics-memorystats.md) — System statistics (memory_stats)
- [030-detect-changes-preflight.md](030-detect-changes-preflight.md) — detect_changes preflight (Code Graph)

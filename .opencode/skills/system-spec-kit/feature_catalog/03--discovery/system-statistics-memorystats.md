...
- Feature file path: `03--discovery/system-statistics-memorystats.md`
Related references:
- [memory-browser-memorylist.md](memory-browser-memorylist.md) — Memory browser (memory_list)
- [health-diagnostics-memoryhealth.md](health-diagnostics-memoryhealth.md) — Health diagnostics (memory_health)

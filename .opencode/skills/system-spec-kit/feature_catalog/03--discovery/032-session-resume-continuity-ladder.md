...
- Feature file path: `03--discovery/032-session-resume-continuity-ladder.md`
Related references:
- [031-session-bootstrap-reader-ready-context.md](031-session-bootstrap-reader-ready-context.md) — Session bootstrap reader-ready context
- [033-session-health-shared-payload.md](033-session-health-shared-payload.md) — Session health shared payload

...
- Feature file path: `06--analysis/049-causal-chain-tracing-memorydriftwhy.md`
...
Related references:
- [048-causal-edge-deletion-memorycausalunlink.md](048-causal-edge-deletion-memorycausalunlink.md) — Causal edge deletion (memory_causal_unlink)
- [050-epistemic-baseline-capture-taskpreflight.md](050-epistemic-baseline-capture-taskpreflight.md) — Epistemic baseline capture (task_preflight)

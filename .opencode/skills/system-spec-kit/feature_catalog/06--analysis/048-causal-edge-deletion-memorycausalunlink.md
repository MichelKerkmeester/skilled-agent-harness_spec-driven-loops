...
- Feature file path: `06--analysis/048-causal-edge-deletion-memorycausalunlink.md`
...
Related references:
- [047-causal-graph-statistics-memorycausalstats.md](047-causal-graph-statistics-memorycausalstats.md) — Causal graph statistics (memory_causal_stats)
- [049-causal-chain-tracing-memorydriftwhy.md](049-causal-chain-tracing-memorydriftwhy.md) — Causal chain tracing (memory_drift_why)

...
- Feature file path: `06--analysis/causal-tombstone-sweep-and-metadata-edge-promoter.md`

Related references:
- [causal-edge-deletion-memorycausalunlink.md](causal-edge-deletion-memorycausalunlink.md) - Manual causal edge deletion
- [causal-graph-statistics-memorycausalstats.md](causal-graph-statistics-memorycausalstats.md) - Causal graph health metrics

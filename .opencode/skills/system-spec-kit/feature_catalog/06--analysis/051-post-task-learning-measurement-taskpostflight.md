...
| `mcp_server/tests/corrections.vitest.ts` | Automated test | Learning corrections tests |

## 4. SOURCE METADATA
- Group: Analysis
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `06--analysis/051-post-task-learning-measurement-taskpostflight.md`
...
- [052-learning-history-memorygetlearninghistory.md](052-learning-history-memorygetlearninghistory.md) — Learning history (memory_get_learning_history)

...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/graph-lifecycle.vitest.ts` | Automated test | LLM backfill flag behavior, async enrichment scheduling |
...
- Feature file path: `graph_signal_activation/llm_graph_backfill.md`
Related references:
- [graph-lifecycle-refresh.md](graph_lifecycle_refresh.md) — Graph lifecycle refresh
- [graph-calibration-profiles.md](graph_calibration_profiles.md) — Graph calibration profiles and community thresholds

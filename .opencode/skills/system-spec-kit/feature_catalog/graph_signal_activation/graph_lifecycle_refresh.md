...
- Feature file path: `graph_signal_activation/graph_lifecycle_refresh.md`

- Source list updated 2026-03-25 per deep review
Related references:
- [unified-graph-retrieval-deterministic-ranking-explainability-and-rollback.md](unified_graph_retrieval_deterministic_ranking_explainability_and_rollback.md) — Unified graph retrieval, deterministic ranking, explainability, and rollback
- [llm-graph-backfill.md](llm_graph_backfill.md) — Async LLM graph backfill

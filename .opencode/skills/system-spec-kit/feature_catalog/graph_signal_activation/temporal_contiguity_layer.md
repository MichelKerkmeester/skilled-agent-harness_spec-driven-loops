...
- Feature file path: `graph_signal_activation/temporal_contiguity_layer.md`
Related references:
- [causal-neighbor-boost-and-injection.md](causal_neighbor_boost_and_injection.md) — Causal neighbor boost and injection

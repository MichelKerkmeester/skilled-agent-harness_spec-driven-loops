...
- Feature file path: `05--lifecycle/040-checkpoint-restore-checkpointrestore.md`
Related references:
- [039-checkpoint-listing-checkpointlist.md](039-checkpoint-listing-checkpointlist.md) — Checkpoint listing (checkpoint_list)
- [041-checkpoint-deletion-checkpointdelete.md](041-checkpoint-deletion-checkpointdelete.md) — Checkpoint deletion (checkpoint_delete)

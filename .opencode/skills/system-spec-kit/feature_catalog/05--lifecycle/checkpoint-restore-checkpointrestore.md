...
- Feature file path: `05--lifecycle/checkpoint-restore-checkpointrestore.md`
Related references:
- [checkpoint-listing-checkpointlist.md](checkpoint-listing-checkpointlist.md) — Checkpoint listing (checkpoint_list)
- [checkpoint-deletion-checkpointdelete.md](checkpoint-deletion-checkpointdelete.md) — Checkpoint deletion (checkpoint_delete)

...
- Feature file path: `05--lifecycle/039-checkpoint-listing-checkpointlist.md`
Related references:
- [038-checkpoint-creation-checkpointcreate.md](038-checkpoint-creation-checkpointcreate.md) — Checkpoint creation (checkpoint_create)

...
- Feature file path: `05--lifecycle/checkpoint-listing-checkpointlist.md`
Related references:
- [checkpoint-creation-checkpointcreate.md](checkpoint-creation-checkpointcreate.md) — Checkpoint creation (checkpoint_create)
- [checkpoint-restore-checkpointrestore.md](checkpoint-restore-checkpointrestore.md) — Checkpoint restore (checkpoint_restore)

...
- Feature file path: `05--lifecycle/constitutional-memory-end-to-end-lifecycle.md`
Related references:
- [startup-pending-file-recovery.md](startup-pending-file-recovery.md) — Startup pending-file recovery
- [post-insert-retry-budget.md](post-insert-retry-budget.md) — Post-insert retry budget

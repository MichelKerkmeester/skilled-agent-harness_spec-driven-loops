...
| `mcp_server/tests/transaction-manager-recovery.vitest.ts` | Automated test | Startup pending-file recovery edge coverage |
...
- Feature file path: `05--lifecycle/043-startup-pending-file-recovery.md`
Related references:

...
- Feature file path: `05--lifecycle/041-checkpoint-deletion-checkpointdelete.md`
Related references:
- [040-checkpoint-restore-checkpointrestore.md](040-checkpoint-restore-checkpointrestore.md) — Checkpoint restore (checkpoint_restore)
- [042-async-ingestion-job-lifecycle.md](042-async-ingestion-job-lifecycle.md) — Async ingestion job lifecycle

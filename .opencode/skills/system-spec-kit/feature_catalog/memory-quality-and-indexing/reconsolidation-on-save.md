...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/reconsolidation.vitest.ts` | Automated test | Reconsolidation tests |
...
- Feature file path: `memory-quality-and-indexing/reconsolidation-on-save.md`
Related references:
- [pre-storage-quality-gate.md](pre-storage-quality-gate.md) — Pre-storage quality gate
- [smarter-memory-content-generation.md](smarter-memory-content-generation.md) — Smarter memory content generation

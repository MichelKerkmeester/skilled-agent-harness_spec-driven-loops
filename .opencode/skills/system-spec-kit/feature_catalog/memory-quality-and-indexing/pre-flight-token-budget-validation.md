...
- Feature file path: `memory-quality-and-indexing/pre-flight-token-budget-validation.md`
Related references:
- [signal-vocabulary-expansion.md](signal-vocabulary-expansion.md) — Signal vocabulary expansion
- [spec-folder-description-discovery.md](spec-folder-description-discovery.md) — Spec folder description discovery

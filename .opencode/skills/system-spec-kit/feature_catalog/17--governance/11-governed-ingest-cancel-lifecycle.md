...
| File | Focus |
|------|-------|
| `mcp_server/tests/memory-ingest-lifecycle.vitest.ts` | Job lifecycle including cancel acknowledgement and terminal state |
...
- Feature file path: `17--governance/11-governed-ingest-cancel-lifecycle.md`

...
- Feature file path: `17--governance/251-constitutional-gate-enforcement-rule-pack.md`
Related references:
- [250-hierarchical-scope-governance-governed-ingest-retention-and-audit.md](250-hierarchical-scope-governance-governed-ingest-retention-and-audit.md) — Hierarchical scope governance, governed ingest, retention, and audit

...
- Feature file path: `17--governance/hierarchical-scope-governance-governed-ingest-retention-and-audit.md`

Related references:
- [feature-flag-governance.md](feature-flag-governance.md) — Feature flag governance

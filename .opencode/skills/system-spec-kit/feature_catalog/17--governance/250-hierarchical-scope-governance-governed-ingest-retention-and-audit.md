...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/memory-governance.vitest.ts` | Automated test | Governed ingest requirements, scope isolation and governance audit coverage |
| `mcp_server/tests/governance-e2e.vitest.ts` | Automated test | End-to-end scoped retrieval isolation and audit review |
...
- Feature file path: `17--governance/250-hierarchical-scope-governance-governed-ingest-retention-and-audit.md`

Related references:
- [249-feature-flag-governance.md](249-feature-flag-governance.md) — Feature flag governance

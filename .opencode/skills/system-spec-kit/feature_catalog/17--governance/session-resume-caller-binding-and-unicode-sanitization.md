...
- Feature file path: `17--governance/session-resume-caller-binding-and-unicode-sanitization.md`
Related references:
- [constitutional-gate-enforcement-rule-pack.md](constitutional-gate-enforcement-rule-pack.md) — Constitutional Gate-Enforcement Rule Pack
- [governed-ingest-cancel-lifecycle.md](governed-ingest-cancel-lifecycle.md) — Governed ingest cancel lifecycle

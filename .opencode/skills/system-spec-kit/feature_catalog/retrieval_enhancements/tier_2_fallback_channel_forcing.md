...
- Feature file path: `retrieval_enhancements/tier_2_fallback_channel_forcing.md`
Related references:
- [cross-document-entity-linking.md](cross_document_entity_linking.md) — Cross-document entity linking
- [provenance-rich-response-envelopes.md](provenance_rich_response_envelopes.md) — Provenance-rich response envelopes

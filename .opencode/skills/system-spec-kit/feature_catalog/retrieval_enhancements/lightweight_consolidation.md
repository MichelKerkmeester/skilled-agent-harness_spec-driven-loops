...
- Feature file path: `retrieval_enhancements/lightweight_consolidation.md`
Related references:
- [spec-folder-hierarchy-as-retrieval-structure.md](spec_folder_hierarchy_as_retrieval_structure.md) — Spec folder hierarchy as retrieval structure
- [memory-summary-search-channel.md](memory_summary_search_channel.md) — Memory summary search channel

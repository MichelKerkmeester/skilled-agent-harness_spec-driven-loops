...
- Feature file path: `retrieval_enhancements/constitutional_memory_as_expert_knowledge_injection.md`
Related references:
- [dual-scope-memory-auto-surface.md](dual_scope_memory_auto_surface.md) — Dual-scope memory auto-surface

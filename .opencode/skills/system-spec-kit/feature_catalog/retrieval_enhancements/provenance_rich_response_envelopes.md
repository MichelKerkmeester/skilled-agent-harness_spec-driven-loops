...
- Feature file path: `retrieval_enhancements/provenance_rich_response_envelopes.md`
Related references:
- [tier-2-fallback-channel-forcing.md](tier_2_fallback_channel_forcing.md) — Tier-2 fallback channel forcing
- [contextual-tree-injection.md](contextual_tree_injection.md) — Contextual tree injection

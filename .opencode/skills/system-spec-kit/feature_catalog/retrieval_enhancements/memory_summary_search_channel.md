...
- Feature file path: `retrieval_enhancements/memory_summary_search_channel.md`
Related references:
- [lightweight-consolidation.md](lightweight_consolidation.md) — Lightweight consolidation
- [cross-document-entity-linking.md](cross_document_entity_linking.md) — Cross-document entity linking

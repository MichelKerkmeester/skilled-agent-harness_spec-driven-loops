...
- Feature file path: `retrieval_enhancements/graph_expanded_fallback.md`

- Kill switch: SPECKIT_GRAPH_FALLBACK=false
Related references:
- [causal-boost-graduated.md](causal_boost_graduated.md) — Causal graph boost (graduated default-ON)
- [always-on-graph-context-injection.md](always_on_graph_context_injection.md) — Always-on graph context injection

...
| File | Layer | Role |
|------|-------|------|
| `.opencode/skills/system-code-graph/mcp_server/code_graph/lib/runtime-detection.ts` | Lib | Runtime identification and hook policy |

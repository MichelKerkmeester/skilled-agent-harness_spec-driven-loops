...
| `mcp_server/code_graph/lib/query-intent-classifier.ts` | Lib | Classification engine (structural/semantic/hybrid) |
| `mcp_server/code_graph/handlers/` | Handler | Structural backend (code graph query) |

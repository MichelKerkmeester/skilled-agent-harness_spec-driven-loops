...
- Feature file path: `implement-and-remove-deprecated-features/inert-scoring-flags-and-compatibility-shims.md`
Related references:
- [shadow-scoring-retirement.md](shadow-scoring-retirement.md) — Shadow-scoring retirement
- [adaptive-fusion-flag-drift.md](adaptive-fusion-flag-drift.md) — Adaptive-fusion mode flag

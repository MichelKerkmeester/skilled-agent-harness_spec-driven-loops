...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/mutation-hooks.vitest.ts` | Automated test | Mutation-hook result behavior, latencyMs, cache-clear booleans, error surfacing |
...
| `mcp_server/tests/memory-save-ux-regressions.vitest.ts` | Automated test | Mutation response payload contract verification |
...
Related references:
- [dedicated-ux-hook-modules.md](dedicated-ux-hook-modules.md) — Dedicated UX hook modules
- [mutation-response-ux-payload-exposure.md](mutation-response-ux-payload-exposure.md) — Mutation response UX payload exposure

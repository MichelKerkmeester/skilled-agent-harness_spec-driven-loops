...
- Feature file path: `12--query-intelligence/confidence-based-result-truncation.md`
Related references:
- [channel-min-representation.md](channel-min-representation.md) — Channel min-representation
- [dynamic-token-budget-allocation.md](dynamic-token-budget-allocation.md) — Dynamic token budget allocation

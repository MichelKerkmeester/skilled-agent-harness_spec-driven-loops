...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/query-surrogates.vitest.ts` | Automated test | Flag behavior, alias extraction, surrogate matching |
...
- Feature file path: `12--query-intelligence/130-index-time-query-surrogates.md`
Related references:
- [129-hyde-hypothetical-document-embeddings.md](129-hyde-hypothetical-document-embeddings.md) — HyDE (Hypothetical Document Embeddings)

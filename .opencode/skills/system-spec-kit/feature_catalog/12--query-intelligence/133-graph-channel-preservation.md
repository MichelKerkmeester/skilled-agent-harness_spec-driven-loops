...
- Feature file path: `12--query-intelligence/133-graph-channel-preservation.md`
- Related entries: `12--query-intelligence/123-query-complexity-router.md` (tier classifier — unchanged here, override sits above it), `12--query-intelligence/132-graph-concept-routing.md` (graph traversal algorithm — unchanged here), `03--discovery/029-health-diagnostics-memoryhealth.md` (surfaces the new `data.routing` block)
Related references:
- [132-graph-concept-routing.md](132-graph-concept-routing.md) — Graph concept routing

...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/concept-routing.vitest.ts` | Automated test | Concept routing logic and alias matching |
| `mcp_server/tests/memory-search-ux-hooks.vitest.ts` | Automated test | Live search integration coverage for graduated routing-adjacent UX hooks |
...
- Feature file path: `12--query-intelligence/132-graph-concept-routing.md`
Related references:
- [131-query-decomposition.md](131-query-decomposition.md) — Query decomposition
- [133-graph-channel-preservation.md](133-graph-channel-preservation.md) — Graph channel preservation

...
- Feature file path: `12--query-intelligence/125-confidence-based-result-truncation.md`
Related references:
- [124-channel-min-representation.md](124-channel-min-representation.md) — Channel min-representation

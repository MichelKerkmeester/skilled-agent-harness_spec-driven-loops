...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/search-flags.vitest.ts` | Automated test | Flag behavior for LLM reformulation |
...
- Feature file path: `12--query-intelligence/128-llm-query-reformulation.md`
Related references:
- [127-query-expansion.md](127-query-expansion.md) — Query expansion

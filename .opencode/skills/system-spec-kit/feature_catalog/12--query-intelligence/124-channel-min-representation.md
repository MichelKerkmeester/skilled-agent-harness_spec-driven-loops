...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/channel-representation.vitest.ts` | Automated test | Core analysis: promotion logic, quality floor, multi-source counting (18 tests) |
| `mcp_server/tests/channel-enforcement.vitest.ts` | Automated test | Wrapper: score ordering after promotion, precision verification, edge cases (20 tests) |
...
- Feature file path: `12--query-intelligence/124-channel-min-representation.md`
Related references:
- [123-query-complexity-router.md](123-query-complexity-router.md) — Query complexity router
- [125-confidence-based-result-truncation.md](125-confidence-based-result-truncation.md) — Confidence-based result truncation

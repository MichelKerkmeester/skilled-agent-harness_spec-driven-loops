...
| `mcp_server/tests/query-router-channel-interaction.vitest.ts` | Automated test | Channel interaction tests |
| `mcp_server/tests/query-router.vitest.ts` | Automated test | Query routing logic |
| `mcp_server/tests/trace-propagation.vitest.ts` | Automated test | Trace propagation chain integration tests |
...
- Feature file path: `12--query-intelligence/query-complexity-router.md`
Related references:
- [channel-min-representation.md](channel-min-representation.md) — Channel min-representation

...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/search-flags.vitest.ts` | Automated test | Flag behavior for HyDE |
...
- Feature file path: `12--query-intelligence/hyde-hypothetical-document-embeddings.md`
Related references:
- [llm-query-reformulation.md](llm-query-reformulation.md) — LLM query reformulation

...
- Feature file path: `12--query-intelligence/131-query-decomposition.md`
Related references:
- [130-index-time-query-surrogates.md](130-index-time-query-surrogates.md) — Index-time query surrogates

...
- Feature file path: `12--query-intelligence/graph-concept-routing.md`
Related references:
- [query-decomposition.md](query-decomposition.md) — Query decomposition
- [graph-channel-preservation.md](graph-channel-preservation.md) — Graph channel preservation

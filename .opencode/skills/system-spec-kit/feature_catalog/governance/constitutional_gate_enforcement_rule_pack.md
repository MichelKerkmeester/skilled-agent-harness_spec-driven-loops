...
- Feature file path: `governance/constitutional_gate_enforcement_rule_pack.md`
Related references:
- [hierarchical-scope-governance-governed-ingest-retention-and-audit.md](hierarchical_scope_governance_governed_ingest_retention_and_audit.md) — Hierarchical scope governance, governed ingest, retention, and audit
- [session-resume-caller-binding-and-unicode-sanitization.md](session_resume_caller_binding_and_unicode_sanitization.md) — Session-resume caller binding and Unicode sanitization

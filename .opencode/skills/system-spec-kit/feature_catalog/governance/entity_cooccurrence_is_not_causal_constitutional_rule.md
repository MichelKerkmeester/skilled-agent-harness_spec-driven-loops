...
- Feature file path: `governance/entity_cooccurrence_is_not_causal_constitutional_rule.md`

Related references:
- [automated-writers-never-overwrite-manual-constitutional-rule.md](automated_writers_never_overwrite_manual_constitutional_rule.md) - Companion constitutional rule

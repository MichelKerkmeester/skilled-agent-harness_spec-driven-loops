...
- Feature file path: `governance/constitutional_self_edit_and_cas_guard.md`
Related references:
- [automated-writers-never-overwrite-manual-constitutional-rule.md](automated_writers_never_overwrite_manual_constitutional_rule.md) — Automated writers never overwrite manual constitutional rule

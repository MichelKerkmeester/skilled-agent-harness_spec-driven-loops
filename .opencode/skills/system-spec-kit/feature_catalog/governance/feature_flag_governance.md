...
**Cross-reference**: See `tooling_and_scripts/template_compliance_contract_enforcement.md` for the 3-layer template compliance architecture (agent contracts + post-write validation + runtime schema enforcement).

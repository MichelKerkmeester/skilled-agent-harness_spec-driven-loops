...
- Feature file path: `governance/hierarchical_scope_governance_governed_ingest_retention_and_audit.md`

Related references:
- [feature-flag-governance.md](feature_flag_governance.md) — Feature flag governance

...
- Feature file path: `remediation_revalidation/memory_health_auto_repair.md`
Related references:
- [category-stub.md](category_stub.md) — Runtime remediation, revalidation, and auto-repair workflows
- [feedback-driven-revalidation.md](feedback_driven_revalidation.md) — Feedback-driven revalidation

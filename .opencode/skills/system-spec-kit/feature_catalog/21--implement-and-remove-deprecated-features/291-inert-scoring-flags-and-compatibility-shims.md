...
- Feature file path: `21--implement-and-remove-deprecated-features/291-inert-scoring-flags-and-compatibility-shims.md`
Related references:
- [290-shadow-scoring-retirement.md](290-shadow-scoring-retirement.md) — Shadow-scoring retirement
- [292-adaptive-fusion-flag-drift.md](292-adaptive-fusion-flag-drift.md) — Adaptive-fusion mode flag

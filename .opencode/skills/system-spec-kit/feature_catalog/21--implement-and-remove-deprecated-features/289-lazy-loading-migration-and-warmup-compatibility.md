...
- Feature file path: `21--implement-and-remove-deprecated-features/289-lazy-loading-migration-and-warmup-compatibility.md`
Related references:
- [288-category-stub.md](288-category-stub.md) — Retired runtime shims and inert compatibility flags
- [290-shadow-scoring-retirement.md](290-shadow-scoring-retirement.md) — Shadow-scoring retirement

...
- Feature file path: `18--ux-hooks/265-end-to-end-success-envelope-verification.md`
Related references:
- [264-hooks-readme-and-export-alignment.md](264-hooks-readme-and-export-alignment.md) — Hooks README and export alignment
- [266-result-explainability.md](266-result-explainability.md) — Two-tier result explainability

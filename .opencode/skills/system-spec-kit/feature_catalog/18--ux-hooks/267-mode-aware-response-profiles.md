...
- Feature file path: `18--ux-hooks/267-mode-aware-response-profiles.md`
Related references:
- [266-result-explainability.md](266-result-explainability.md) — Two-tier result explainability
- [268-progressive-disclosure.md](268-progressive-disclosure.md) — Progressive disclosure with cursor pagination

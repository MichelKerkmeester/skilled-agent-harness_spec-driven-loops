...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/search-flags.vitest.ts` | Automated test | Flag behavior for response profiles |
...
- Feature file path: `18--ux-hooks/mode-aware-response-profiles.md`
Related references:
- [result-explainability.md](result-explainability.md) — Two-tier result explainability

...
- Feature file path: `18--ux-hooks/schema-and-type-contract-synchronization.md`
Related references:
- [checkpoint-delete-confirmname-safety.md](checkpoint-delete-confirmname-safety.md) — Checkpoint delete confirmName safety

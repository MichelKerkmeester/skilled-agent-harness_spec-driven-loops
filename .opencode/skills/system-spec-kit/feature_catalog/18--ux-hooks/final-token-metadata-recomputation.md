...
- Feature file path: `18--ux-hooks/final-token-metadata-recomputation.md`
Related references:
- [atomic-save-parity-and-partial-indexing-hints.md](atomic-save-parity-and-partial-indexing-hints.md) — Atomic-save parity and partial-indexing hints
- [hooks-readme-and-export-alignment.md](hooks-readme-and-export-alignment.md) — Hooks README and export alignment

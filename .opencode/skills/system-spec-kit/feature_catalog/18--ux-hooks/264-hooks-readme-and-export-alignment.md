...
- Feature file path: `18--ux-hooks/264-hooks-readme-and-export-alignment.md`
Related references:
- [263-final-token-metadata-recomputation.md](263-final-token-metadata-recomputation.md) — Final token metadata recomputation
- [265-end-to-end-success-envelope-verification.md](265-end-to-end-success-envelope-verification.md) — End-to-end success-envelope verification

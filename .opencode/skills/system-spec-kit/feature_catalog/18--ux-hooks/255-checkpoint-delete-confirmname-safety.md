...
- Feature file path: `18--ux-hooks/255-checkpoint-delete-confirmname-safety.md`
Related references:
- [254-memory-health-autorepair-metadata.md](254-memory-health-autorepair-metadata.md) — Memory health autoRepair metadata

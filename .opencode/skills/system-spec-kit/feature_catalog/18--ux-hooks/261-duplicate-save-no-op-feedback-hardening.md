...
- Feature file path: `18--ux-hooks/261-duplicate-save-no-op-feedback-hardening.md`
Related references:
- [260-context-server-success-hint-append.md](260-context-server-success-hint-append.md) — Context-server success-path hint append
- [262-atomic-save-parity-and-partial-indexing-hints.md](262-atomic-save-parity-and-partial-indexing-hints.md) — Atomic-save parity and partial-indexing hints

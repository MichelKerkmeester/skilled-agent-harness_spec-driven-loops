...
- Feature file path: `18--ux-hooks/268-progressive-disclosure.md`
Related references:
- [267-mode-aware-response-profiles.md](267-mode-aware-response-profiles.md) — Mode-aware response profiles
- [269-retrieval-session-state.md](269-retrieval-session-state.md) — Retrieval session state

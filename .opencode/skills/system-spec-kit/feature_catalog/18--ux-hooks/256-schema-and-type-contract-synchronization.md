...
- Feature file path: `18--ux-hooks/256-schema-and-type-contract-synchronization.md`
Related references:
- [255-checkpoint-delete-confirmname-safety.md](255-checkpoint-delete-confirmname-safety.md) — Checkpoint delete confirmName safety
- [257-dedicated-ux-hook-modules.md](257-dedicated-ux-hook-modules.md) — Dedicated UX hook modules

...
- Feature file path: `18--ux-hooks/retrieval-observability-diagnostics.md`

Related references:
- [result-explainability.md](result-explainability.md) - Result explanation surface
- [memory-health-autorepair-metadata.md](memory-health-autorepair-metadata.md) - Health metadata presentation

...
The playbook-side viewpoint lives in `manual_testing_playbook/stress-testing/`. The pipeline-architecture catalog peer at `feature_catalog/pipeline-architecture/stress-test-cycle.md` documents the cycle as a pipeline feature; this category overview keeps the stress-testing inventory entry intact so the catalog and playbook stay structurally parallel.
...
| File | Layer | Role |
|------|-------|------|
| `manual_testing_playbook/stress-testing/run-stress-cycle.md` | Playbook | Canonical operator flow for one full stress-test cycle |
| `manual_testing_playbook/stress-testing/README.md` | Playbook | Package map and ownership guide for the stress-test category |
...
| `feature_catalog/pipeline-architecture/stress-test-cycle.md` | Catalog peer | Pipeline-side feature entry that documents the cycle as a release pattern |
...
- Feature file path: `stress-testing/category-overview.md`

...
- Feature file path: `bug_fixes_and_data_integrity/chunking_orchestrator_safe_swap.md`
Related references:
- [session-manager-transaction-gap-fixes.md](session_manager_transaction_gap_fixes.md) — Session-manager transaction gap fixes
- [working-memory-timestamp-fix.md](working_memory_timestamp_fix.md) — Working Memory Session Cleanup Timestamp Fix

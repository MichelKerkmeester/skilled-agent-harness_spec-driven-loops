...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/content-hash-dedup.vitest.ts` | Automated test | Content hash dedup tests, including `T320-1` and `T320-2` SQL-shape coverage for two direct probes and exact scope clauses |
| `mcp_server/tests/integration-session-dedup.vitest.ts` | Automated test | Session dedup integration |
...
- Feature file path: `bug_fixes_and_data_integrity/sha_256_content_hash_deduplication.md`
Related references:
- [co-activation-fan-effect-divisor.md](co_activation_fan_effect_divisor.md) — Co-activation fan-effect divisor
- [database-and-schema-safety.md](database_and_schema_safety.md) — Database and schema safety

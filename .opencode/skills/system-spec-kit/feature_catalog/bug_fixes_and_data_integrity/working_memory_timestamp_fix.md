...
- Feature file path: `bug_fixes_and_data_integrity/working_memory_timestamp_fix.md`
Related references:
- [chunking-orchestrator-safe-swap.md](chunking_orchestrator_safe_swap.md) — Chunking Orchestrator Safe Swap
- [scope-normalizer-canonicalization-and-lint.md](scope_normalizer_canonicalization_and_lint.md) — Scope normalizer canonicalization and lint

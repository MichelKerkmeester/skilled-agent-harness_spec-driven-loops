...
- Feature file path: `bug_fixes_and_data_integrity/error_code_reference.md`
Related references:
- [schema-version-history-v28-v30.md](schema_version_history_v28_v30.md) — Schema version history (v28 to v30)
- [../pipeline-architecture/mcp-launcher-front-proxy.md](../pipeline_architecture/mcp_launcher_front_proxy.md) — MCP launcher front-proxy

...
- Feature file path: `bug_fixes_and_data_integrity/graph_channel_id_fix.md`
Related references:
- [chunk-collapse-deduplication.md](chunk_collapse_deduplication.md) — Chunk collapse deduplication

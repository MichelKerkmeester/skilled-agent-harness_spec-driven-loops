...
| `mcp_server/hooks/memory-surface.ts` | Hook | PrimePackage.routingRules with Code Graph/Code Graph directives |
...
| `mcp_server/lib/session/session-snapshot.ts` | Lib | codeGraphAvailable and routingRecommendation in session state |

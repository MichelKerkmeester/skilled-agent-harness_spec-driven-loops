...
- Feature file path: `22--context-preservation/295-session-start-priming.md`
Related references:
- [294-precompact-hook.md](294-precompact-hook.md) — PreCompact hook context caching
- [296-stop-token-tracking.md](296-stop-token-tracking.md) — Stop hook token tracking

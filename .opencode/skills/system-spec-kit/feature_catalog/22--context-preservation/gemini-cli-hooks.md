...
Related references:
- [passive-context-enrichment.md](passive-context-enrichment.md) — Passive context enrichment
- [context-preservation-metrics.md](context-preservation-metrics.md) — Context preservation metrics

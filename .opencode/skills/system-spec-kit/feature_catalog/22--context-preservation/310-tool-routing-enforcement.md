...
- Feature file path: `22--context-preservation/310-tool-routing-enforcement.md`
Related references:
- [309-context-preservation-metrics.md](309-context-preservation-metrics.md) — Context preservation metrics
- [311-resource-map-template.md](311-resource-map-template.md) — Resource map template

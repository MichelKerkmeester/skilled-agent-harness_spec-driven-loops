...
- Feature file path: `22--context-preservation/309-context-preservation-metrics.md`
Related references:
- [308-gemini-cli-hooks.md](308-gemini-cli-hooks.md) — Gemini CLI hooks
- [310-tool-routing-enforcement.md](310-tool-routing-enforcement.md) — Tool routing enforcement

...
- Feature file path: `22--context-preservation/296-stop-token-tracking.md`
Related references:
- [295-session-start-priming.md](295-session-start-priming.md) — SessionStart priming (Claude)
- [297-cross-runtime-fallback.md](297-cross-runtime-fallback.md) — Cross-runtime tool fallback

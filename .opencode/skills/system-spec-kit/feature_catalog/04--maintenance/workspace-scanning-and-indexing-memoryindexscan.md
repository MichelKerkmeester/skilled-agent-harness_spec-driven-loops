...
- Feature file path: `04--maintenance/workspace-scanning-and-indexing-memoryindexscan.md`
Related references:
- [startup-runtime-compatibility-guards.md](startup-runtime-compatibility-guards.md) — Startup runtime compatibility guards

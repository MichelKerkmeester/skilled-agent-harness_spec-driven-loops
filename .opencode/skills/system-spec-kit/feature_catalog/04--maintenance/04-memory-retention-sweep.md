...
| File | Focus |
|------|-------|
| `mcp_server/tests/memory-retention-sweep.vitest.ts` | Dry-run safety, deletion correctness, audit evidence, interval driver |
...
- Feature file path: `04--maintenance/04-memory-retention-sweep.md`

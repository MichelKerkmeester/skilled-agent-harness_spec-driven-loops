...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/startup-checks.vitest.ts` | Automated test | Runtime mismatch logic and SQLite version guard tests |
| `mcp_server/tests/context-server.vitest.ts` | Automated test | Context server tests |
| `mcp_server/tests/modularization.vitest.ts` | Automated test | Modularization tests |
...
- Feature file path: `04--maintenance/startup-runtime-compatibility-guards.md`
- Manual playbook scenario: EX-035
Related references:
- [workspace-scanning-and-indexing-memoryindexscan.md](workspace-scanning-and-indexing-memoryindexscan.md) — Workspace scanning and indexing (memory_index_scan)
- [doctor-router-and-manifest-dispatch.md](doctor-router-and-manifest-dispatch.md) — Doctor router and manifest-driven dispatch

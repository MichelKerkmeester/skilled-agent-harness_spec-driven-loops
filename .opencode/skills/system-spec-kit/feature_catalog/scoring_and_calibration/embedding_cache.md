...
| `mcp_server/tests/hybrid-search.vitest.ts` | Automated test | Hybrid search regression coverage around fusion/rerank pipeline behavior |
...
- Feature file path: `scoring_and_calibration/embedding_cache.md`
Related references:
- [folder-level-relevance-scoring.md](folder_level_relevance_scoring.md) — Folder-level relevance scoring
- [double-intent-weighting-investigation.md](double_intent_weighting_investigation.md) — Double intent weighting investigation

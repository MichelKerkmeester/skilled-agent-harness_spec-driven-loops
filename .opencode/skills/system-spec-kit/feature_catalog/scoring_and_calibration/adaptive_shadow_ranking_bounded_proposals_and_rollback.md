...
- Feature file path: `scoring_and_calibration/adaptive_shadow_ranking_bounded_proposals_and_rollback.md`

Related references:
- [temporal-structural-coherence-scoring.md](temporal_structural_coherence_scoring.md) — Temporal-structural coherence scoring
- [learned-stage2-weight-combiner.md](learned_stage2_weight_combiner.md) — Learned Stage 2 weight combiner

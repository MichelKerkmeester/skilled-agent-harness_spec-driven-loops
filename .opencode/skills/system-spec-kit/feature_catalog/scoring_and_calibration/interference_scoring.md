...
- Feature file path: `scoring_and_calibration/interference_scoring.md`
Related references:
- [score-normalization.md](score_normalization.md) — Score normalization
- [classification-based-decay.md](classification_based_decay.md) — Classification-based decay

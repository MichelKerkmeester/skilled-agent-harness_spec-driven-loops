...
- Feature file path: `scoring_and_calibration/scoring_and_ranking_corrections.md`
Related references:
- [auto-promotion-on-validation.md](auto_promotion_on_validation.md) — Auto-promotion on validation
- [stage-3-effectivescore-fallback-chain.md](stage_3_effectivescore_fallback_chain.md) — Stage 3 effectiveScore fallback chain

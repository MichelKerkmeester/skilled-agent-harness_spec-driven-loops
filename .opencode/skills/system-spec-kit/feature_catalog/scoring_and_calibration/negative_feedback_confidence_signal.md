...
- Feature file path: `scoring_and_calibration/negative_feedback_confidence_signal.md`
Related references:
- [rrf-k-value-sensitivity-analysis.md](rrf_k_value_sensitivity_analysis.md) — RRF K-value sensitivity analysis

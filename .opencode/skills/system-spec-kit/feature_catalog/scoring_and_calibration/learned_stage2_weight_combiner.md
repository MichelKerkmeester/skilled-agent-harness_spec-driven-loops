...
- Feature file path: `scoring_and_calibration/learned_stage2_weight_combiner.md`
Related references:
- [adaptive-shadow-ranking-bounded-proposals-and-rollback.md](adaptive_shadow_ranking_bounded_proposals_and_rollback.md) — Adaptive shadow ranking, bounded proposals, and rollback
- [shadow-feedback-holdout-evaluation.md](shadow_feedback_holdout_evaluation.md) — Shadow scoring with holdout evaluation

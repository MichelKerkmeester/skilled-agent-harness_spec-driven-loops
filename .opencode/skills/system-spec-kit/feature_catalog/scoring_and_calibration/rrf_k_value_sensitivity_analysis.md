...
- Feature file path: `scoring_and_calibration/rrf_k_value_sensitivity_analysis.md`
Related references:
- [double-intent-weighting-investigation.md](double_intent_weighting_investigation.md) — Double intent weighting investigation
- [negative-feedback-confidence-signal.md](negative_feedback_confidence_signal.md) — Negative feedback confidence signal

...
- Feature file path: `scoring_and_calibration/rrf_k_experimental.md`
Related references:
- [calibrated-overlap-bonus.md](calibrated_overlap_bonus.md) — Calibrated overlap bonus
- [usage-weighted-ranking.md](usage_weighted_ranking.md) — Usage-weighted ranking signal

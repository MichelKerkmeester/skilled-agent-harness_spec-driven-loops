...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/community-detection.vitest.ts` | Automated test | Community detection tests |
...
Related references:
- [causal-depth-signal.md](causal-depth-signal.md) — Causal depth signal
- [graph-and-cognitive-memory-fixes.md](graph-and-cognitive-memory-fixes.md) — Graph and cognitive memory fixes

...
- Feature file path: `evaluation-and-measurement/core-metric-computation.md`
Related references:
- [evaluation-database-and-schema.md](evaluation-database-and-schema.md) — Evaluation database and schema

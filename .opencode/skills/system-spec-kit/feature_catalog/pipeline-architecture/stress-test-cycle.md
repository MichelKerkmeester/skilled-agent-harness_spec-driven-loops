...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/stress-testing/run-stress-cycle.md` | Operational guide |

## 4. SOURCE METADATA
- Group: Pipeline Architecture
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `pipeline-architecture/stress-test-cycle.md`

- Companion playbook: `.opencode/skills/system-spec-kit/manual_testing_playbook/stress-testing/run-stress-cycle.md`
Related references:

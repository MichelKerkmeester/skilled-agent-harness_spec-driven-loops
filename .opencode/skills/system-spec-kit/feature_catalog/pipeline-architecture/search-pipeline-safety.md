...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/channel-representation.vitest.ts` | Automated test | Quality floor and channel representation tests |
| `mcp_server/tests/sqlite-fts.vitest.ts` | Automated test | SQLite FTS5 tokenization tests |
| `mcp_server/tests/bm25-index.vitest.ts` | Automated test | BM25 tokenization tests |

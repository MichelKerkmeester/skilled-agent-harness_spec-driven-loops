...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/orphan-mcp-runtime-lifecycle-guardrails.md` | Manual playbook | Manual dry-run and lifecycle guardrail scenario. |

## 4. SOURCE METADATA

- Group: Feature Flag Reference
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `feature-flag-reference/launcher-idle-timeout.md`
Related references:

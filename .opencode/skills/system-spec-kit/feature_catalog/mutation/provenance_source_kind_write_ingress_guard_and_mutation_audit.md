...
- Feature file path: `mutation/provenance_source_kind_write_ingress_guard_and_mutation_audit.md`

Related references:
- [memory-indexing-memorysave.md](memory_indexing_memorysave.md) - Save entry point
- [memory-metadata-update-memoryupdate.md](memory_metadata_update_memoryupdate.md) - Update entry point

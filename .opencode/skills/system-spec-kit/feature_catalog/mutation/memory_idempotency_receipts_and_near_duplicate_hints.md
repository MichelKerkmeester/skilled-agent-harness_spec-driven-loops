...
- Feature file path: `mutation/memory_idempotency_receipts_and_near_duplicate_hints.md`

Related references:
- [provenance-source-kind-write-ingress-guard-and-mutation-audit.md](provenance_source_kind_write_ingress_guard_and_mutation_audit.md) - Guarded pre-mutation point
- [memory-indexing-memorysave.md](memory_indexing_memorysave.md) - Save entry point

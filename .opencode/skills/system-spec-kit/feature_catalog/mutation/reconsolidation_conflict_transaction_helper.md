...
- Feature file path: `mutation/reconsolidation_conflict_transaction_helper.md`
Related references:
- [per-memory-history-log.md](per_memory_history_log.md) — Per-memory history log
- [memory-retention-sweep.md](memory_retention_sweep.md) — Memory retention sweep (memory_retention_sweep)

...
- Feature file path: `mutation/memory_metadata_update_memoryupdate.md`
Related references:
- [memory-indexing-memorysave.md](memory_indexing_memorysave.md) — Memory indexing (memory_save)
- [single-and-folder-delete-memorydelete.md](single_and_folder_delete_memorydelete.md) — Single and folder delete (memory_delete)

...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/handler-memory-crud.vitest.ts` | Automated test | CRUD handler validation (includes bulk delete) |
| `mcp_server/tests/memory-crud-extended.vitest.ts` | Automated test | Extended mutation scenarios |
...
Related references:
- [single-and-folder-delete-memorydelete.md](single-and-folder-delete-memorydelete.md) — Single and folder delete (memory_delete)

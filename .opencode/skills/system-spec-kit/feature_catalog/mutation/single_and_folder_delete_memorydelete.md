...
| `mcp_server/tests/memory-delete-cascade.vitest.ts` | Automated test | Delete cascade behavior |
...
- Feature file path: `mutation/single_and_folder_delete_memorydelete.md`
- Source list updated 2026-03-26 per audit remediation
Related references:
- [memory-metadata-update-memoryupdate.md](memory_metadata_update_memoryupdate.md) — Memory metadata update (memory_update)
- [tier-based-bulk-deletion-memorybulkdelete.md](tier_based_bulk_deletion_memorybulkdelete.md) — Tier-based bulk deletion (memory_bulk_delete)

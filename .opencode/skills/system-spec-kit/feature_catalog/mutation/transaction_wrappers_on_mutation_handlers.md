...
- Feature file path: `mutation/transaction_wrappers_on_mutation_handlers.md`
Related references:
- [validation-feedback-memoryvalidate.md](validation_feedback_memoryvalidate.md) — Validation feedback (memory_validate)
- [prediction-error-save-arbitration.md](prediction_error_save_arbitration.md) — Prediction-error save arbitration

...
- Feature file path: `mutation/soft_delete_tombstones_and_active_purgeable_partitions.md`

Related references:
- [single-and-folder-delete-memorydelete.md](single_and_folder_delete_memorydelete.md) - Single and folder delete behavior
- [memory-retention-sweep.md](memory_retention_sweep.md) - Retention sweep behavior

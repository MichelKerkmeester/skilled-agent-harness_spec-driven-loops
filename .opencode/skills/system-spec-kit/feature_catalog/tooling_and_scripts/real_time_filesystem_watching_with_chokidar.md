...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/file-watcher.vitest.ts` | Automated test | Coverage for path filtering, debounce/retry/delete behavior, rename integration (unlink+add lifecycle, old-entry removal), burst/concurrent rename handling and watcher metrics (`filesReindexed`, `avgReindexTimeMs`) |
...
- Feature file path: `tooling_and_scripts/real_time_filesystem_watching_with_chokidar.md`
Related references:
- [code-standards-alignment.md](code_standards_alignment.md) — Code standards alignment
- [standalone-admin-cli.md](standalone_admin_cli.md) — Standalone admin CLI

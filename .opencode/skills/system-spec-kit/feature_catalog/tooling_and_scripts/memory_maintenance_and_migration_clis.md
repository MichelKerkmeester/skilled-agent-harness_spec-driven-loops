...
Related references:
- [spec-validation-rule-engine.md](spec_validation_rule_engine.md) — Spec Validation Rule Engine
- [core-workflow-infrastructure.md](core_workflow_infrastructure.md) — Core Workflow Infrastructure

...
- Feature file path: `tooling_and_scripts/cli_matrix_adapter_runners.md`

- Packet source: `011-cli-matrix-adapter-runners`
Related references:
- [strict-validation-addons-continuity-freshness-and-evidence-markers.md](strict_validation_addons_continuity_freshness_and_evidence_markers.md) — Strict validation add-ons: continuity freshness and evidence markers

...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/tooling_and_scripts/embedder_set_dry_run_and_validation.md` | Manual playbook | Playbook scenario 282 covering dry-run plan output, invalid-name handling, and active-pointer no-op |
...
- Feature file path: `tooling_and_scripts/embedder_set_dry_run_and_validation.md`
Related references:
- [embedder-list-registry-inventory.md](embedder_list_registry_inventory.md) — Embedder list registry inventory
- [embedder-status-and-active-pointer.md](embedder_status_and_active_pointer.md) — Embedder status and active pointer

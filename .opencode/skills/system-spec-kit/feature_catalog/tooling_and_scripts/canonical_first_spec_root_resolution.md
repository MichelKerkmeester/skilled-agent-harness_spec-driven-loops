...
| `../../manual_testing_playbook/tooling_and_scripts/canonical_first_spec_root_resolution.md` | Manual playbook | Temporary-workspace operator validation for the five user-visible behaviors |
...
Related references:
- [migration_checkpoint_scripts.md](migration_checkpoint_scripts.md) — Migration rollback tooling and checkpoint discipline
- [dist_freshness_enforcement.md](dist_freshness_enforcement.md) — Source/dist freshness enforcement for runtime rollout bundles

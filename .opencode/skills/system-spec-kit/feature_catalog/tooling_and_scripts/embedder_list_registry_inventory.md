...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/tooling_and_scripts/embedder_list_registry_inventory.md` | Manual playbook | Playbook scenario 281 covering the operator-facing list output and active-embedder identification |
...
- Feature file path: `tooling_and_scripts/embedder_list_registry_inventory.md`
Related references:

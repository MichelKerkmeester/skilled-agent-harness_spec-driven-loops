...
- Feature file path: `tooling_and_scripts/completion_verification_workflow.md`
Related references:
- [template-compliance-contract-enforcement.md](template_compliance_contract_enforcement.md) — Template Compliance Contract Enforcement
- [ops-self-healing-runbooks.md](ops_self_healing_runbooks.md) — Ops Self-Healing Runbooks

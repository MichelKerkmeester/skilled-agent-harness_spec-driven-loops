...
- Feature file path: `tooling_and_scripts/architecture_boundary_enforcement.md`
Related references:
- [tree-thinning-for-spec-folder-consolidation.md](tree_thinning_for_spec_folder_consolidation.md) — Tree thinning for spec folder consolidation
- [progressive-validation-for-spec-documents.md](progressive_validation_for_spec_documents.md) — Progressive validation for spec documents

...
- Feature file path: `tooling_and_scripts/module_boundary_map.md`
Related references:
- [source-dist-alignment-enforcement.md](source_dist_alignment_enforcement.md) — Source-dist alignment enforcement
- [json-mode-hybrid-enrichment.md](json_mode_hybrid_enrichment.md) — JSON mode structured summary hardening

...
- Feature file path: `tooling_and_scripts/standalone_admin_cli.md`
- Playbook reference: 113
Related references:
- [real-time-filesystem-watching-with-chokidar.md](real_time_filesystem_watching_with_chokidar.md) — Real-time filesystem watching with chokidar
- [watcher-delete-rename-cleanup.md](watcher_delete_rename_cleanup.md) — Watcher delete/rename cleanup

...
- Feature file path: `tooling_and_scripts/stale_exclusion_audit_and_tool_ownership_lint.md`

Related references:
- [feature-catalog-code-references.md](feature_catalog_code_references.md) - Catalog/source reference discipline
- [markdown-link-integrity-guard.md](markdown_link_integrity_guard.md) - Documentation link integrity guard

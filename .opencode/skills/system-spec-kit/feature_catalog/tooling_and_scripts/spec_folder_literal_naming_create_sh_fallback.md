...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/manual_testing_playbook/tooling_and_scripts/spec_folder_literal_naming_create_sh_fallback.md` | Manual playbook | Playbook scenario PHASE-006 covering placeholder emission, stderr warning count, and exit-code expectation |
...
- Feature file path: `tooling_and_scripts/spec_folder_literal_naming_create_sh_fallback.md`
Related references:

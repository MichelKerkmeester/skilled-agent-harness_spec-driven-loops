...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/tooling_and_scripts/embedder_status_job_and_active_pointer.md` | Manual playbook | Playbook scenario 283 covering active pointer output and unknown job ID handling |
...
- Feature file path: `tooling_and_scripts/embedder_status_and_active_pointer.md`
Related references:
- [embedder-set-dry-run-and-validation.md](embedder_set_dry_run_and_validation.md) — Embedder set dry-run and validation
- [orphan-mcp-sweeper-and-launchagent-template.md](orphan_mcp_sweeper_and_launchagent_template.md) — Orphan MCP Sweeper and LaunchAgent Template

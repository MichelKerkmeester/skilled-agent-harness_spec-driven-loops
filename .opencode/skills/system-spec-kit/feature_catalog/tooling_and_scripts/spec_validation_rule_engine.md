...
- Feature file path: `tooling_and_scripts/spec_validation_rule_engine.md`
Related references:
- [spec-lifecycle-automation.md](spec_lifecycle_automation.md) — Spec Lifecycle Automation
- [memory-maintenance-and-migration-clis.md](memory_maintenance_and_migration_clis.md) — Memory Maintenance and Migration CLIs

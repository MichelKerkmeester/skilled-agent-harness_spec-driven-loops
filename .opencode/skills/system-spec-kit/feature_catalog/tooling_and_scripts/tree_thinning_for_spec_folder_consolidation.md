...
| File | Type | Role |
|---|---|---|
| `scripts/tests/tree-thinning.vitest.ts` | Automated test | Tree-thinning thresholds, merge behavior, boundary handling and invariants |
...
- Feature file path: `tooling_and_scripts/tree_thinning_for_spec_folder_consolidation.md`
Related references:

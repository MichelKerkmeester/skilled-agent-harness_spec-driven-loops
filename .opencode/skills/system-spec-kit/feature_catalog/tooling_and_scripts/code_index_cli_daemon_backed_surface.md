...
| `.opencode/skills/system-code-graph/feature_catalog/mcp_tool_surface/code_index_cli.md` | Catalog | Owning system-code-graph feature entry |
...
- Feature file path: `tooling_and_scripts/code_index_cli_daemon_backed_surface.md`

Related references:
- [spec-memory-cli-daemon-backed-surface.md](spec_memory_cli_daemon_backed_surface.md) - Spec-memory CLI sibling surface
- [skill-advisor-cli-daemon-backed-surface.md](skill_advisor_cli_daemon_backed_surface.md) - Skill-advisor CLI sibling surface

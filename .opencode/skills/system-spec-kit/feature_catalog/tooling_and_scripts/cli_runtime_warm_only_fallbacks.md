...
- Feature file path: `tooling_and_scripts/cli_runtime_warm_only_fallbacks.md`
Related references:
- [spec-memory-cli-daemon-backed-surface.md](spec_memory_cli_daemon_backed_surface.md) — Daemon-backed spec-memory CLI surface

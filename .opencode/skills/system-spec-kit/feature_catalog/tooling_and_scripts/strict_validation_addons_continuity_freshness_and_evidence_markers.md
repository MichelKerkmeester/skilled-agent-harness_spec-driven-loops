...
- Feature file path: `tooling_and_scripts/strict_validation_addons_continuity_freshness_and_evidence_markers.md`
Related references:
- [research-metadata-backfill.md](research_metadata_backfill.md) — Research metadata backfill
- [cli-matrix-adapter-runners.md](cli_matrix_adapter_runners.md) — CLI matrix adapter runners

...
- Feature file path: `tooling_and_scripts/constitutional_memory_manager_command.md`

Related references:
- [session-capturing-pipeline-quality.md](session_capturing_pipeline_quality.md) — Session Capturing Pipeline Quality
- [source-dist-alignment-enforcement.md](source_dist_alignment_enforcement.md) — Source-dist alignment enforcement

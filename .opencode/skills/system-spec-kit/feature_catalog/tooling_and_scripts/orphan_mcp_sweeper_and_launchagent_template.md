...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/manual_testing_playbook/tooling_and_scripts/orphan_mcp_runtime_lifecycle_guardrails.md` | Manual playbook | Dry-run, preservation, plist lint, cleanup script syntax, and no-mutation checks. |
...
- Feature file path: `tooling_and_scripts/orphan_mcp_sweeper_and_launchagent_template.md`
Related references:

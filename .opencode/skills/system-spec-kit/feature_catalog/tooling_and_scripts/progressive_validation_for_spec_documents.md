...
- Feature file path: `tooling_and_scripts/progressive_validation_for_spec_documents.md`
Related references:
- [architecture-boundary-enforcement.md](architecture_boundary_enforcement.md) — Architecture boundary enforcement

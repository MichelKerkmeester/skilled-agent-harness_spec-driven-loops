...
- Feature file path: `tooling_and_scripts/feature_catalog_code_references.md`

Related references:
- [schema-compatibility-validation.md](schema_compatibility_validation.md) — Schema compatibility validation

...
- Feature file path: `01--retrieval/009-tool-result-extraction-to-working-memory.md`
Related references:
- [008-quality-aware-3-tier-search-fallback.md](008-quality-aware-3-tier-search-fallback.md) — Quality-aware 3-tier search fallback

...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/handler-memory-triggers.vitest.ts` | Automated test | Trigger handler validation |
...
| `mcp_server/tests/co-activation.vitest.ts` | Automated test | Co-activation spreading tests |
| `mcp_server/tests/tier-classifier.vitest.ts` | Automated test | Tier classifier tests |
...
- Feature file path: `01--retrieval/003-trigger-phrase-matching-memorymatchtriggers.md`
- Source list updated 2026-03-26 per audit remediation
Related references:
- [002-semantic-and-lexical-search-memorysearch.md](002-semantic-and-lexical-search-memorysearch.md) — Semantic and lexical search (memory_search)

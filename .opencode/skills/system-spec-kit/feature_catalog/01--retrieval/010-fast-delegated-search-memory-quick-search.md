...
- Feature file path: `01--retrieval/010-fast-delegated-search-memory-quick-search.md`
Related references:
- [009-tool-result-extraction-to-working-memory.md](009-tool-result-extraction-to-working-memory.md) — Tool-result extraction to working memory
- [011-session-recovery-spec-kit-resume.md](011-session-recovery-spec-kit-resume.md) — Session recovery via /spec_kit:resume

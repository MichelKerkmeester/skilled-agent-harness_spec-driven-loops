...
| `mcp_server/lib/search/pipeline/stage3-rerank.ts` | Lib | Stage 3: MMR diversity reranking and MPAB chunk-to-memory aggregation |
...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/pipeline-integration.vitest.ts` | Automated test | Pipeline integration tests |
| `mcp_server/tests/pipeline-v2.vitest.ts` | Automated test | V2 pipeline orchestration |
| `mcp_server/tests/integration-138-pipeline.vitest.ts` | Automated test | Pipeline feature-138 tests |
| `mcp_server/tests/integration-search-pipeline.vitest.ts` | Automated test | Search pipeline integration |
| `mcp_server/tests/stage2-fusion.vitest.ts` | Automated test | Stage 2 fusion validation |
| `mcp_server/tests/evidence-gap-detector.vitest.ts` | Automated test | Evidence gap detection |
| `mcp_server/tests/mpab-aggregation.vitest.ts` | Automated test | MPAB aggregation tests |
| `mcp_server/tests/anchor-metadata.vitest.ts` | Automated test | Anchor metadata tests |
| `mcp_server/tests/validation-metadata.vitest.ts` | Automated test | Validation metadata tests |
...
Related references:
- [004-hybrid-search-pipeline.md](004-hybrid-search-pipeline.md) — Hybrid search pipeline
- [006-bm25-trigger-phrase-re-index-gate.md](006-bm25-trigger-phrase-re-index-gate.md) — BM25 trigger phrase re-index gate

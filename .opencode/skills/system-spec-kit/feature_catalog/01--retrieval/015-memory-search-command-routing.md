...
- Feature file path: `01--retrieval/015-memory-search-command-routing.md`
Related references:
- [014-bounded-graph-diagnostics.md](014-bounded-graph-diagnostics.md) — Bounded graph diagnostics

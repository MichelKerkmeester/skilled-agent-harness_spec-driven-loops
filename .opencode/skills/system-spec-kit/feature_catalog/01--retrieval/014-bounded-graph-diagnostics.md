...
- Feature file path: `01--retrieval/014-bounded-graph-diagnostics.md`
Related references:
- [013-session-transition-trace-contract.md](013-session-transition-trace-contract.md) — Session transition trace contract
- [015-memory-search-command-routing.md](015-memory-search-command-routing.md) — /memory:search command routing

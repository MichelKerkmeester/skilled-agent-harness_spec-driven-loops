...
- Feature file path: `01--retrieval/012-search-api-surface.md`
Related references:
- [011-session-recovery-spec-kit-resume.md](011-session-recovery-spec-kit-resume.md) — Session recovery via /spec_kit:resume
- [013-session-transition-trace-contract.md](013-session-transition-trace-contract.md) — Session transition trace contract

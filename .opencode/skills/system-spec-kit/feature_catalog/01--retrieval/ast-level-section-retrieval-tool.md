...
- Feature file path: `01--retrieval/ast-level-section-retrieval-tool.md`
Related references:
- [bm25-trigger-phrase-re-index-gate.md](bm25-trigger-phrase-re-index-gate.md) — BM25 trigger phrase re-index gate

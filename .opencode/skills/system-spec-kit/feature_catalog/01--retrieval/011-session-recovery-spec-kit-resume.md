...
- Feature file path: `01--retrieval/011-session-recovery-spec-kit-resume.md`
Related references:
- [010-fast-delegated-search-memory-quick-search.md](010-fast-delegated-search-memory-quick-search.md) — Fast delegated search (memory_quick_search)
- [012-search-api-surface.md](012-search-api-surface.md) — Search API surface

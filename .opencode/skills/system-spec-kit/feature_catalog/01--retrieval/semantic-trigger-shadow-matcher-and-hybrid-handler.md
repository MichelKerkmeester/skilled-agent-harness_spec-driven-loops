...
- Feature file path: `01--retrieval/semantic-trigger-shadow-matcher-and-hybrid-handler.md`

Related references:
- [trigger-embedding-backfill.md](trigger-embedding-backfill.md) - Storage substrate for trigger embeddings
- [trigger-phrase-matching-memorymatchtriggers.md](trigger-phrase-matching-memorymatchtriggers.md) - Lexical trigger matcher entry point

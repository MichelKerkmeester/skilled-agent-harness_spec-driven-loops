...
| File | Focus |
|------|-------|
| `mcp_server/tests/memory/memory-search-command-routing.vitest.ts` | First-token routing, intent override, and subcommand dispatch coverage |
...
- Feature file path: `01--retrieval/15-memory-search-command-routing.md`

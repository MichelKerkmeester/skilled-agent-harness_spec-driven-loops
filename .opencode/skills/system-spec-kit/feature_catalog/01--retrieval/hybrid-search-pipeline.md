...
| `mcp_server/tests/hybrid-search-flags.vitest.ts` | Automated test | Hybrid search flag behavior |
| `mcp_server/tests/hybrid-search-context-headers.vitest.ts` | Automated test | Context header injection |
| `mcp_server/tests/search-fallback-tiered.vitest.ts` | Automated test | Tiered fallback chain |
| `mcp_server/tests/search-extended.vitest.ts` | Automated test | Search extended scenarios |
| `mcp_server/tests/channel-enforcement.vitest.ts` | Automated test | Channel enforcement tests |
| `mcp_server/tests/channel-representation.vitest.ts` | Automated test | Channel representation tests |
| `mcp_server/tests/confidence-truncation.vitest.ts` | Automated test | Truncation behavior |
...
| `mcp_server/tests/adaptive-fusion.vitest.ts` | Automated test | Adaptive fusion tests |
| `mcp_server/tests/mmr-reranker.vitest.ts` | Automated test | MMR reranker tests |
...
- Feature file path: `01--retrieval/hybrid-search-pipeline.md`
...
- [4-stage-pipeline-architecture.md](4-stage-pipeline-architecture.md) — 4-stage pipeline architecture

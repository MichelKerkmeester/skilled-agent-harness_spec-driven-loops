...
| File | Focus |
|------|-------|
| `mcp_server/tests/memory/session-transition.vitest.ts` | Trace-only gating, ordering stability, and confidence clamping |
| `mcp_server/tests/memory/memory-context.vitest.ts` | Response shape with and without `includeTrace` |
...
- Feature file path: `01--retrieval/13-session-transition-trace-contract.md`

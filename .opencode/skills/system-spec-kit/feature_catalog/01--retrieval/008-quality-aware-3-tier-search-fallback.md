...
- Feature file path: `01--retrieval/008-quality-aware-3-tier-search-fallback.md`
- Playbook reference: 109
Related references:
- [007-ast-level-section-retrieval-tool.md](007-ast-level-section-retrieval-tool.md) — AST-level section retrieval tool

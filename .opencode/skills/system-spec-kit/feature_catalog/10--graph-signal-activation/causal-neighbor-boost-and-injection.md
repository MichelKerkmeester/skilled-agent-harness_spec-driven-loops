...
| `mcp_server/tests/phase2-integration.vitest.ts` | Automated test | Phase 2 integration tests |
...
- Feature file path: `10--graph-signal-activation/causal-neighbor-boost-and-injection.md`
Related references:

...
- Feature file path: `10--graph-signal-activation/co-activation-boost-strength-increase.md`
Related references:
- [typed-weighted-degree-channel.md](typed-weighted-degree-channel.md) — Typed-weighted degree channel

...
- Feature file path: `10--graph-signal-activation/094-unified-graph-retrieval-deterministic-ranking-explainability-and-rollback.md`

Related references:
- [093-temporal-contiguity-layer.md](093-temporal-contiguity-layer.md) — Temporal contiguity layer
- [095-graph-lifecycle-refresh.md](095-graph-lifecycle-refresh.md) — Graph lifecycle refresh

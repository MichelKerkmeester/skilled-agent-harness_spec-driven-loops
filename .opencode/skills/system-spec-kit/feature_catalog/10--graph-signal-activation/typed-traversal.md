...
- Feature file path: `10--graph-signal-activation/typed-traversal.md`
Related references:
- [graph-calibration-profiles.md](graph-calibration-profiles.md) — Graph calibration profiles and community thresholds
- [temporal-edges.md](temporal-edges.md) — Temporal edge validity

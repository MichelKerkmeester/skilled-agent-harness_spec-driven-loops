...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/causal-boost.vitest.ts` | Automated test | Causal boost with typed traversal, sparse-first gating, intent-aware scoring |
| `mcp_server/tests/sparse-first-graph.vitest.ts` | Automated test | Sparse-first policy coverage for traversal depth and community gating |
...
- Feature file path: `10--graph-signal-activation/098-typed-traversal.md`
Related references:
- [097-graph-calibration-profiles.md](097-graph-calibration-profiles.md) — Graph calibration profiles and community thresholds
- [099-temporal-edges.md](099-temporal-edges.md) — Temporal edge validity

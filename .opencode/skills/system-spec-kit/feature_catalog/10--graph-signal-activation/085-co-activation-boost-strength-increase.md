...
- Feature file path: `10--graph-signal-activation/085-co-activation-boost-strength-increase.md`
Related references:
- [084-typed-weighted-degree-channel.md](084-typed-weighted-degree-channel.md) — Typed-weighted degree channel

...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/graph-lifecycle.vitest.ts` | Automated test | Refresh mode resolution, dirty-node tracking, local vs scheduled routing, LLM backfill flag |
...
- Feature file path: `10--graph-signal-activation/095-graph-lifecycle-refresh.md`

- Source list updated 2026-03-25 per deep review
Related references:
- [094-unified-graph-retrieval-deterministic-ranking-explainability-and-rollback.md](094-unified-graph-retrieval-deterministic-ranking-explainability-and-rollback.md) — Unified graph retrieval, deterministic ranking, explainability, and rollback
- [096-llm-graph-backfill.md](096-llm-graph-backfill.md) — Async LLM graph backfill

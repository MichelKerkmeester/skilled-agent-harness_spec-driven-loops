...
- Feature file path: `10--graph-signal-activation/100-contradiction-detection.md`

- Kill switch: SPECKIT_TEMPORAL_EDGES=false
Related references:
- [099-temporal-edges.md](099-temporal-edges.md) — Temporal edge validity
- [101-ontology-hooks.md](101-ontology-hooks.md) — Ontology-Guided Extraction Hooks

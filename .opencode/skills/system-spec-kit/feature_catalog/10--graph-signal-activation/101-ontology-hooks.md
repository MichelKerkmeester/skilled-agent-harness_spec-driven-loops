...
- Feature file path: `10--graph-signal-activation/101-ontology-hooks.md`
...
Related references:
- [100-contradiction-detection.md](100-contradiction-detection.md) — Contradiction detection

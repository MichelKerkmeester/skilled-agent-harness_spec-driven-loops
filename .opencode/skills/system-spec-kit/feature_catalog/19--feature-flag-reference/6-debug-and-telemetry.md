...
- Feature file path: `19--feature-flag-reference/6-debug-and-telemetry.md`
Related references:
- [5-embedding-and-api.md](5-embedding-and-api.md) — 5. Embedding and API
- [7-ci-and-build-informational.md](7-ci-and-build-informational.md) — 7. CI and Build (informational)

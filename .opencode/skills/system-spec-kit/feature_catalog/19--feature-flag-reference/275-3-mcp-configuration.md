...
| `MCP_MAX_CONTENT_LENGTH` | `250000` | number | `lib/validation/preflight.ts`, `lib/parsing/memory-parser.ts` | Maximum allowed content length in characters for a spec-doc record file. Files exceeding this limit are rejected at pre-flight validation before any embedding generation or database writes. |
...
- Feature file path: `19--feature-flag-reference/275-3-mcp-configuration.md`
Related references:
- [274-2-session-and-cache.md](274-2-session-and-cache.md) — 2. Session and Cache
- [276-4-memory-and-storage.md](276-4-memory-and-storage.md) — 4. Memory and Storage

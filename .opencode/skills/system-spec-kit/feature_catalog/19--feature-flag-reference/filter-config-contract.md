...
- Feature file path: `19--feature-flag-reference/filter-config-contract.md`
...
Related references:
- [runtime-config-contract.md](runtime-config-contract.md) — Runtime Config Contract
- [memory-roadmap-capability-flags.md](memory-roadmap-capability-flags.md) — Memory roadmap flags (SPECKIT_MEMORY_*)

...
| `.opencode/skills/system-spec-kit/scripts/core/config.ts` | Loader | Parses JSONC, merges defaults, validates `WorkflowConfig`, and exports frozen runtime constants |
...
| `manual_testing_playbook/19--feature-flag-reference/223-runtime-config-contract.md` | Manual playbook | End-to-end sandbox verification of Section 1 overrides, invalid values, and documentation-only sections |

## 4. SOURCE METADATA
- Group: Feature Flag Reference
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `19--feature-flag-reference/281-runtime-config-contract.md`
Related references:
- [280-audit-phase-020-mapping-note.md](280-audit-phase-020-mapping-note.md) — Feature flag reference mapping note

...
- Feature file path: `19--feature-flag-reference/274-2-session-and-cache.md`
Related references:
- [273-1-search-pipeline-features-speckit.md](273-1-search-pipeline-features-speckit.md) — Search Pipeline Features (SPECKIT_*)

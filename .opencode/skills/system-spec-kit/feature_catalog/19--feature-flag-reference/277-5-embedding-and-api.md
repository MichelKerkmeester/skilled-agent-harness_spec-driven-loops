...
| `VOYAGE_API_KEY` | _(none)_ | string | `shared/embeddings/factory.ts` | API key for the Voyage AI embeddings provider. In `'auto'` mode, Voyage is preferred over OpenAI and local providers when this key is present, using `voyage-code-3` embeddings. (Voyage reranker support was removed in 022/013.) |
...
- Feature file path: `19--feature-flag-reference/277-5-embedding-and-api.md`
Related references:
- [276-4-memory-and-storage.md](276-4-memory-and-storage.md) — 4. Memory and Storage
- [278-6-debug-and-telemetry.md](278-6-debug-and-telemetry.md) — 6. Debug and Telemetry

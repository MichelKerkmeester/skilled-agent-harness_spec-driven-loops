...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/k-value-judged-sweep.vitest.ts` | Automated test | Judged K sweep, per-intent selection, flag gating |
| `mcp_server/tests/k-value-optimization.vitest.ts` | Automated test | K-value optimization and flag behavior |
...
- Feature file path: `11--scoring-and-calibration/121-rrf-k-experimental.md`
Related references:
- [120-calibrated-overlap-bonus.md](120-calibrated-overlap-bonus.md) — Calibrated overlap bonus
- [122-usage-weighted-ranking.md](122-usage-weighted-ranking.md) — Usage-weighted ranking signal

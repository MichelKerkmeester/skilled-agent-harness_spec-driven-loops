...
- Feature file path: `11--scoring-and-calibration/embedding-cache.md`
Related references:
- [folder-level-relevance-scoring.md](folder-level-relevance-scoring.md) — Folder-level relevance scoring

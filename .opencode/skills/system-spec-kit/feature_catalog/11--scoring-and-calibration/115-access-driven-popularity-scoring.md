...
- Feature file path: `11--scoring-and-calibration/115-access-driven-popularity-scoring.md`
Related references:
- [114-tool-level-ttl-cache.md](114-tool-level-ttl-cache.md) — Tool-level TTL cache

...
- Feature file path: `11--scoring-and-calibration/107-double-intent-weighting-investigation.md`
...
| `mcp_server/tests/intent-weighting.vitest.ts` | Automated test | Regression coverage for no double-counting (T017-G2) |
| `mcp_server/tests/pipeline-v2.vitest.ts` | Automated test | Stage 2 contract includes G2 guard metadata (`intentWeightsApplied`) |
Related references:
- [106-embedding-cache.md](106-embedding-cache.md) — Embedding cache
- [108-rrf-k-value-sensitivity-analysis.md](108-rrf-k-value-sensitivity-analysis.md) — RRF K-value sensitivity analysis

...
|------------|------|------|------|
| C1 | `mcp_server/tests/composite-scoring.vitest.ts` | Automated test | Composite clamp regression ([0,1] ceiling) |
| C2 | `mcp_server/tests/composite-scoring.vitest.ts` | Automated test | Citation score behavior without fallback timestamps |
| C3 | `mcp_server/tests/causal-boost.vitest.ts` | Automated test | Cycle/dedup behavior in recursive graph boost |
| C4 | `mcp_server/tests/ablation-framework.vitest.ts` | Automated test | Large-n sign test stability and p-value computation |
...
- Feature file path: `11--scoring-and-calibration/111-scoring-and-ranking-corrections.md`
Related references:
- [110-auto-promotion-on-validation.md](110-auto-promotion-on-validation.md) — Auto-promotion on validation
- [112-stage-3-effectivescore-fallback-chain.md](112-stage-3-effectivescore-fallback-chain.md) — Stage 3 effectiveScore fallback chain

...
trigger_phrases:
  ...
  - "five-factor weight normalization"
...
| ~~`mcp_server/tests/rsf-fusion-edge-cases.vitest.ts`~~ | Automated test | Deleted — RSF tests removed with RSF module |
| ~~`mcp_server/tests/rsf-fusion.vitest.ts`~~ | Automated test | Deleted — RSF tests removed with RSF module |
...
- Feature file path: `11--scoring-and-calibration/scoring-and-fusion-corrections.md`
Related references:
- [stage-3-effectivescore-fallback-chain.md](stage-3-effectivescore-fallback-chain.md) — Stage 3 effectiveScore fallback chain
- [tool-level-ttl-cache.md](tool-level-ttl-cache.md) — Tool-level TTL cache

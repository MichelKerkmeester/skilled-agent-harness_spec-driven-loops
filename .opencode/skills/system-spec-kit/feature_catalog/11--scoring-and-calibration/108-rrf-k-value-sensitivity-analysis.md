...
- Feature file path: `11--scoring-and-calibration/108-rrf-k-value-sensitivity-analysis.md`
Related references:
- [107-double-intent-weighting-investigation.md](107-double-intent-weighting-investigation.md) — Double intent weighting investigation

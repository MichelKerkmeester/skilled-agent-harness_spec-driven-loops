...
- Feature file path: `11--scoring-and-calibration/scoring-and-ranking-corrections.md`
Related references:
- [auto-promotion-on-validation.md](auto-promotion-on-validation.md) — Auto-promotion on validation
- [stage-3-effectivescore-fallback-chain.md](stage-3-effectivescore-fallback-chain.md) — Stage 3 effectiveScore fallback chain

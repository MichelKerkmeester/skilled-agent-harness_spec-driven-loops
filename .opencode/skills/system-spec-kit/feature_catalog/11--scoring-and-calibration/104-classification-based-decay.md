...
- Feature file path: `11--scoring-and-calibration/104-classification-based-decay.md`
Related references:
- [103-interference-scoring.md](103-interference-scoring.md) — Interference scoring
- [105-folder-level-relevance-scoring.md](105-folder-level-relevance-scoring.md) — Folder-level relevance scoring

...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/learned-combiner.vitest.ts` | Automated test | Training, prediction, LOOCV, SHAP, shadow scoring, model serialization, flag behavior |
...
- Feature file path: `11--scoring-and-calibration/118-learned-stage2-weight-combiner.md`
Related references:
- [117-adaptive-shadow-ranking-bounded-proposals-and-rollback.md](117-adaptive-shadow-ranking-bounded-proposals-and-rollback.md) — Adaptive shadow ranking, bounded proposals, and rollback
- [119-shadow-feedback-holdout-evaluation.md](119-shadow-feedback-holdout-evaluation.md) — Shadow scoring with holdout evaluation

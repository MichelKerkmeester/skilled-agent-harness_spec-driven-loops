...
- Feature file path: `11--scoring-and-calibration/110-auto-promotion-on-validation.md`
...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/learned-feedback.vitest.ts` | Automated test | Promotion thresholds, non-promotable guards, and throttle window enforcement |
| `mcp_server/tests/promotion-positive-validation-semantics.vitest.ts` | Automated test | Positive-validation counting semantics for promotion eligibility |
| `mcp_server/tests/checkpoints-extended.vitest.ts` | Automated test | `handleMemoryValidate` handler happy-path coverage |

Related references:
- [109-negative-feedback-confidence-signal.md](109-negative-feedback-confidence-signal.md) — Negative feedback confidence signal

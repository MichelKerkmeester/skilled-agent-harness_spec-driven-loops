...
- Feature file path: `retrieval-enhancements/lightweight-consolidation.md`
Related references:
- [spec-folder-hierarchy-as-retrieval-structure.md](spec-folder-hierarchy-as-retrieval-structure.md) — Spec folder hierarchy as retrieval structure

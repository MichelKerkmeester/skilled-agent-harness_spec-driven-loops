...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/temporal-contiguity.vitest.ts` | Automated test | **E1**: T502 coverage validates temporal-contiguity boost behavior on adjacent/time-windowed results. |
| `mcp_server/tests/extraction-adapter.vitest.ts` | Automated test | **E2**: T035a/T035b/T035c verifies unresolved memory IDs skip insert rather than linking the wrong memory. |
...
- Feature file path: `08--bug-fixes-and-data-integrity/061-guards-and-edge-cases.md`
Related references:
- [060-database-and-schema-safety.md](060-database-and-schema-safety.md) — Database and schema safety
- [063-canonical-id-dedup-hardening.md](063-canonical-id-dedup-hardening.md) — Canonical ID dedup hardening

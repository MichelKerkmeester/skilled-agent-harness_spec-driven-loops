...
- Feature file path: `08--bug-fixes-and-data-integrity/error-code-reference.md`
Related references:
- [schema-version-history-v28-v30.md](schema-version-history-v28-v30.md) — Schema version history (v28 to v30)
- [../14--pipeline-architecture/mcp-launcher-front-proxy.md](../14--pipeline-architecture/mcp-launcher-front-proxy.md) — MCP launcher front-proxy

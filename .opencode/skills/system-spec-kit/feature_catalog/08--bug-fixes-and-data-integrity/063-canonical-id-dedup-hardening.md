...
- Feature file path: `08--bug-fixes-and-data-integrity/063-canonical-id-dedup-hardening.md`
Related references:
- [061-guards-and-edge-cases.md](061-guards-and-edge-cases.md) — Guards and edge cases
- [062-error-response-credential-sanitization.md](062-error-response-credential-sanitization.md) — Error response credential sanitization

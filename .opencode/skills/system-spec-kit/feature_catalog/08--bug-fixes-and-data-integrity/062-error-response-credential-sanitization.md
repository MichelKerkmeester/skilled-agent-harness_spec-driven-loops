...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/error-sanitization.vitest.ts` | Automated test | Covers all 4 credential patterns, non-sensitive passthrough, nested objects, and arrays in details |
...
- Feature file path: `08--bug-fixes-and-data-integrity/062-error-response-credential-sanitization.md`
Related references:
- [063-canonical-id-dedup-hardening.md](063-canonical-id-dedup-hardening.md) — Canonical ID dedup hardening
- [064-mathmax-min-stack-overflow-elimination.md](064-mathmax-min-stack-overflow-elimination.md) — Math.max/min stack overflow hardening

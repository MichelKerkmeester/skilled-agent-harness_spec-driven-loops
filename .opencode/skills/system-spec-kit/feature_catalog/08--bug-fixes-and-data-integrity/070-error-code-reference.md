...
- Feature file path: `08--bug-fixes-and-data-integrity/070-error-code-reference.md`
Related references:
- [069-schema-version-history-v28-v30.md](069-schema-version-history-v28-v30.md) — Schema version history (v28 to v30)
- [../14--pipeline-architecture/189-mcp-launcher-front-proxy.md](../14--pipeline-architecture/189-mcp-launcher-front-proxy.md) — MCP launcher front-proxy

...
- Feature file path: `08--bug-fixes-and-data-integrity/chunking-orchestrator-safe-swap.md`
Related references:
- [session-manager-transaction-gap-fixes.md](session-manager-transaction-gap-fixes.md) — Session-manager transaction gap fixes
- [working-memory-timestamp-fix.md](working-memory-timestamp-fix.md) — Working Memory Session Cleanup Timestamp Fix

...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/scope-governance-normalizer-parity.vitest.ts` | Automated test | Canonical helper parity and null-semantics coverage |
...
- Feature file path: `08--bug-fixes-and-data-integrity/068-scope-normalizer-canonicalization-and-lint.md`
Related references:

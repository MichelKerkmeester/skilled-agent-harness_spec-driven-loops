...
- Feature file path: `08--bug-fixes-and-data-integrity/057-chunk-collapse-deduplication.md`
Related references:
- [056-graph-channel-id-fix.md](056-graph-channel-id-fix.md) — Graph channel ID fix
- [058-co-activation-fan-effect-divisor.md](058-co-activation-fan-effect-divisor.md) — Co-activation fan-effect divisor

...
- Feature file path: `16--tooling-and-scripts/223-ops-self-healing-runbooks.md`
Related references:
- [222-completion-verification-workflow.md](222-completion-verification-workflow.md) — Completion Verification Workflow
- [224-eval-runner-cli.md](224-eval-runner-cli.md) — Eval Runner CLI

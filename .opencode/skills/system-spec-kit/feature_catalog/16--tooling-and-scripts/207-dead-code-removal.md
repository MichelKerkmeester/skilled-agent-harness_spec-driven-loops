...
- Feature file path: `16--tooling-and-scripts/207-dead-code-removal.md`
Related references:
- [206-progressive-validation-for-spec-documents.md](206-progressive-validation-for-spec-documents.md) — Progressive validation for spec documents
- [208-code-standards-alignment.md](208-code-standards-alignment.md) — Code standards alignment

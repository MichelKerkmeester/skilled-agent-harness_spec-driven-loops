...
- Feature file path: `16--tooling-and-scripts/227-spec-validation-rule-engine.md`
Related references:
- [226-spec-lifecycle-automation.md](226-spec-lifecycle-automation.md) — Spec Lifecycle Automation

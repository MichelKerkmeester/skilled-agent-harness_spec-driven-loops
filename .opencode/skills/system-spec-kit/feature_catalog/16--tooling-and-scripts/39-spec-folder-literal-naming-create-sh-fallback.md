...
| File | Focus |
|------|-------|
| `.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/006-spec-folder-literal-naming-create-sh-fallback.md` | Playbook scenario PHASE-006 covering placeholder emission, stderr warning count, and exit-code expectation |
...
- Feature file path: `16--tooling-and-scripts/39-spec-folder-literal-naming-create-sh-fallback.md`

...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/279-graph-degraded-stress-cell-isolation.md` | Manual playbook | Playbook scenario 279 covering bucket routing, live-DB byte-equality, and suite runtime budget |
...
- Feature file path: `16--tooling-and-scripts/244-graph-degraded-stress-cell-isolation.md`
Related references:
- [243-mcp-daemon-rebuild-restart-live-probe.md](243-mcp-daemon-rebuild-restart-live-probe.md) — MCP daemon rebuild, restart, and live-probe protocol
- [245-embedder-list-registry-inventory.md](245-embedder-list-registry-inventory.md) — Embedder list registry inventory

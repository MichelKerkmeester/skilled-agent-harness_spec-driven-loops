...
- Feature file path: `16--tooling-and-scripts/205-architecture-boundary-enforcement.md`
Related references:
- [204-tree-thinning-for-spec-folder-consolidation.md](204-tree-thinning-for-spec-folder-consolidation.md) — Tree thinning for spec folder consolidation

...
- Feature file path: `16--tooling-and-scripts/217-source-dist-alignment-enforcement.md`
Related references:
- [216-constitutional-memory-manager-command.md](216-constitutional-memory-manager-command.md) — Constitutional memory manager command

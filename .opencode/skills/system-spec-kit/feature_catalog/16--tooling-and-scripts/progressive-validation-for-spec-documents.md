...
- Feature file path: `16--tooling-and-scripts/progressive-validation-for-spec-documents.md`
Related references:
- [architecture-boundary-enforcement.md](architecture-boundary-enforcement.md) — Architecture boundary enforcement

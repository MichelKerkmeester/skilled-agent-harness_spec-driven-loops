...
- Feature file path: `16--tooling-and-scripts/237-strict-validation-addons-continuity-freshness-and-evidence-markers.md`
Related references:
- [236-research-metadata-backfill.md](236-research-metadata-backfill.md) — Research metadata backfill

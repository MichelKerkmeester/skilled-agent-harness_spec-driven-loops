...
- Feature file path: `16--tooling-and-scripts/213-schema-compatibility-validation.md`

Related references:
- [212-migration-checkpoint-scripts.md](212-migration-checkpoint-scripts.md) — Migration checkpoint scripts
- [214-feature-catalog-code-references.md](214-feature-catalog-code-references.md) — Feature catalog code references

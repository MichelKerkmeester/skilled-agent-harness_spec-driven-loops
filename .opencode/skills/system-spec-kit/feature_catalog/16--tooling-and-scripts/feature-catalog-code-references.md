...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/sk-code/code-verify/assets/scripts/verify_alignment_drift.py` | Automated test | Enforces `MODULE:` header in first 40 lines of all non-test `.ts` files |

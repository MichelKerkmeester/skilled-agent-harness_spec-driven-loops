...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/281-embedder-list-registry-inventory.md` | Manual playbook | Playbook scenario 281 covering the operator-facing list output and active-embedder identification |
...
- Feature file path: `16--tooling-and-scripts/245-embedder-list-registry-inventory.md`
Related references:

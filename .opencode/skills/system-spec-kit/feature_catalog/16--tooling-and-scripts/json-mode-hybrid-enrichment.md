...
- See feature catalog entry `13--memory-quality-and-indexing/post-save-quality-review.md` for full specification.
...
- Feature file path: `16--tooling-and-scripts/json-mode-hybrid-enrichment.md`

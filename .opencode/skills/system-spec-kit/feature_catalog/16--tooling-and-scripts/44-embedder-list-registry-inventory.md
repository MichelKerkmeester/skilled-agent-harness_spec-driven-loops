...
| File | Focus |
|------|-------|
| `.opencode/skills/system-spec-kit/mcp_server/tests/embedder-list.vitest.ts` | Happy-path coverage for the list handler shape, required fields, and active-marker invariant |
| `.opencode/skills/system-spec-kit/mcp_server/tests/embedder-registry.vitest.ts` | Registry-level coverage for every shipped embedder definition |
| `.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/281-embedder-list-registry-inventory.md` | Playbook scenario 281 covering the operator-facing list output and active-embedder identification |
...
- Feature file path: `16--tooling-and-scripts/44-embedder-list-registry-inventory.md`

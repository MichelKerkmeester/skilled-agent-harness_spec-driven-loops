...
| File | Type | Role |
|---|---|---|
| `scripts/tests/backfill-research-metadata.vitest.ts` | Automated test | Backfill behavior for missing-vs-complete research iteration folders |
...
Related references:
- [memory-quality-kpi-reporting.md](memory-quality-kpi-reporting.md) — Memory Quality KPI Reporting

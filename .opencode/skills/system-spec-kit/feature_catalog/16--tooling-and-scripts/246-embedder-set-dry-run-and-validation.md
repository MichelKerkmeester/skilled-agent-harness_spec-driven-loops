...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/282-embedder-set-dry-run-and-validation.md` | Manual playbook | Playbook scenario 282 covering dry-run plan output, invalid-name handling, and active-pointer no-op |
...
- Feature file path: `16--tooling-and-scripts/246-embedder-set-dry-run-and-validation.md`
Related references:

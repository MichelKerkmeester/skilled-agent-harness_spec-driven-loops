...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/006-spec-folder-literal-naming-create-sh-fallback.md` | Manual playbook | Playbook scenario PHASE-006 covering placeholder emission, stderr warning count, and exit-code expectation |
...
- Feature file path: `16--tooling-and-scripts/240-spec-folder-literal-naming-create-sh-fallback.md`
Related references:
- [239-codex-hook-freshness-smoke-check.md](239-codex-hook-freshness-smoke-check.md) — Codex hook freshness smoke check
- [241-spec-folder-literal-naming-ai-derived-slugs.md](241-spec-folder-literal-naming-ai-derived-slugs.md) — Spec folder literal naming: AI-derived slugs

...
- Feature file path: `16--tooling-and-scripts/spec-memory-cli-daemon-backed-surface.md`
Related references:
...
- `.opencode/skills/system-code-graph/feature_catalog/06--mcp-tool-surface/code-index-cli.md` — code-index CLI sibling surface
- `.opencode/skills/system-skill-advisor/feature_catalog/06--mcp-surface/skill-advisor-cli.md` — skill-advisor CLI sibling surface

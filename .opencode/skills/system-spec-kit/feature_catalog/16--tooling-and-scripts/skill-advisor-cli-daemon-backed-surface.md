...
| `.opencode/skills/system-skill-advisor/feature_catalog/06--mcp-surface/skill-advisor-cli.md` | Catalog | Owning system-skill-advisor feature entry |
...
- Feature file path: `16--tooling-and-scripts/skill-advisor-cli-daemon-backed-surface.md`

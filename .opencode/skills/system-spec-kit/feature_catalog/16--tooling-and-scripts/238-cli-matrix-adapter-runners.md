...
- Feature file path: `16--tooling-and-scripts/238-cli-matrix-adapter-runners.md`

- Packet source: `011-cli-matrix-adapter-runners`
Related references:
- [237-strict-validation-addons-continuity-freshness-and-evidence-markers.md](237-strict-validation-addons-continuity-freshness-and-evidence-markers.md) — Strict validation add-ons: continuity freshness and evidence markers
- [239-codex-hook-freshness-smoke-check.md](239-codex-hook-freshness-smoke-check.md) — Codex hook freshness smoke check

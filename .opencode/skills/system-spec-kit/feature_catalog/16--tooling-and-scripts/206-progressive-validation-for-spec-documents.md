...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/progressive-validation.vitest.ts` | Automated test | Pipeline prerequisites, detect behavior, auto-fix transforms/diff logging, suggest guidance, report output modes, exit code contract, dry-run semantics, edge-case handling and level progression |
...
- Feature file path: `16--tooling-and-scripts/206-progressive-validation-for-spec-documents.md`
Related references:
- [205-architecture-boundary-enforcement.md](205-architecture-boundary-enforcement.md) — Architecture boundary enforcement

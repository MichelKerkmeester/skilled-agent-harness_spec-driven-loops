...
- Feature file path: `16--tooling-and-scripts/239-codex-hook-freshness-smoke-check.md`

- Packet source: `010-half-auto-upgrades`
Related references:
- [238-cli-matrix-adapter-runners.md](238-cli-matrix-adapter-runners.md) — CLI matrix adapter runners
- [240-spec-folder-literal-naming-create-sh-fallback.md](240-spec-folder-literal-naming-create-sh-fallback.md) — Spec folder literal naming: create.sh fallback

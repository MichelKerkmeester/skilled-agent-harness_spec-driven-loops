...
- Feature file path: `16--tooling-and-scripts/220-json-primary-deprecation-posture.md`
...
Related references:
- [219-json-mode-hybrid-enrichment.md](219-json-mode-hybrid-enrichment.md) — JSON mode structured summary hardening
- [221-template-compliance-contract-enforcement.md](221-template-compliance-contract-enforcement.md) — Template Compliance Contract Enforcement

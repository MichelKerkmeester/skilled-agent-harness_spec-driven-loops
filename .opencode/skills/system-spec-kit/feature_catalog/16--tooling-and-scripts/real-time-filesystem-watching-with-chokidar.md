...
- Feature file path: `16--tooling-and-scripts/real-time-filesystem-watching-with-chokidar.md`
Related references:
- [code-standards-alignment.md](code-standards-alignment.md) — Code standards alignment
- [standalone-admin-cli.md](standalone-admin-cli.md) — Standalone admin CLI

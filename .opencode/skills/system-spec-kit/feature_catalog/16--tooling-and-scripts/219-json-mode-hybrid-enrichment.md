...
- See feature catalog entry `13--memory-quality-and-indexing/151-post-save-quality-review.md` for full specification.
...
- Feature file path: `16--tooling-and-scripts/219-json-mode-hybrid-enrichment.md`
...
Related references:
- [218-module-boundary-map.md](218-module-boundary-map.md) — Module boundary map
- [220-json-primary-deprecation-posture.md](220-json-primary-deprecation-posture.md) — JSON-primary deprecation posture

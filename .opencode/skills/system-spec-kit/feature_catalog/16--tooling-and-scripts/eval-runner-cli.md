...
- Feature file path: `16--tooling-and-scripts/eval-runner-cli.md`
Related references:
- [ops-self-healing-runbooks.md](ops-self-healing-runbooks.md) — Ops Self-Healing Runbooks
- [phase-system-knowledge-node.md](phase-system-knowledge-node.md) — Phase-System Knowledge Node

...
| File | Focus |
|------|-------|
| `.opencode/skills/system-spec-kit/mcp_server/tests/embedder-status.vitest.ts` | Handler-level coverage for no-args active pointer, jobId polling, and unknown-job-id NOT_FOUND shape |
| `.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/283-embedder-status-job-and-active-pointer.md` | Playbook scenario 283 covering active pointer output and unknown job ID handling |
...
- Feature file path: `16--tooling-and-scripts/46-embedder-status-and-active-pointer.md`

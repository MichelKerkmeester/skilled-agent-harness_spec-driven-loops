...
The protocol pairs with the standalone install path documented in `16--tooling-and-scripts/setup-native-module-health-and-mcp-installation.md`. Install covers the upfront workspace bootstrap. This protocol covers the post-fix verification loop after the daemon is already running.

...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/419-orphan-mcp-runtime-lifecycle-guardrails.md` | Manual playbook | Dry-run, preservation, plist lint, cleanup script syntax, and no-mutation checks. |
...
- Feature file path: `16--tooling-and-scripts/248-orphan-mcp-sweeper-and-launchagent-template.md`
Related references:
- [247-embedder-status-and-active-pointer.md](247-embedder-status-and-active-pointer.md) — Embedder status and active pointer

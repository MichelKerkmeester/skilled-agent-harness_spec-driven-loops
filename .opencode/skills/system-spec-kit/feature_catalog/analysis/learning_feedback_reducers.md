...
- Feature file path: `analysis/learning_feedback_reducers.md`

Related references:
- [learning-history-memorygetlearninghistory.md](learning_history_memorygetlearninghistory.md) - Learning history reporting
- [causal-edge-creation-memorycausallink.md](causal_edge_creation_memorycausallink.md) - Causal edge creation surface

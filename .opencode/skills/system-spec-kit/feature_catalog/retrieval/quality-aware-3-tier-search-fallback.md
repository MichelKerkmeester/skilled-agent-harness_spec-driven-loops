...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/search-fallback-tiered.vitest.ts` | Automated test | Tiered fallback chain behavior |
...
Related references:
- [ast-level-section-retrieval-tool.md](ast-level-section-retrieval-tool.md) — AST-level section retrieval tool

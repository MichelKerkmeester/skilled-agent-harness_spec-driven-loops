...
| `mcp_server/tests/working-memory-event-decay.vitest.ts` | Automated test | Working memory decay tests |
| `mcp_server/tests/checkpoint-working-memory.vitest.ts` | Automated test | Checkpoint working memory tests |
...
Related references:
- [quality-aware-3-tier-search-fallback.md](quality-aware-3-tier-search-fallback.md) — Quality-aware 3-tier search fallback

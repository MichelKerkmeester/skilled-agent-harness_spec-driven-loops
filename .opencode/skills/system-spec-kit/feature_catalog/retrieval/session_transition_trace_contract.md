...
- Feature file path: `retrieval/session_transition_trace_contract.md`
Related references:
- [search-api-surface.md](search_api_surface.md) — Search API surface
- [bounded-graph-diagnostics.md](bounded_graph_diagnostics.md) — Bounded graph diagnostics

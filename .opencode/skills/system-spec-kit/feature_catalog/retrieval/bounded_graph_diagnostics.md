...
- Feature file path: `retrieval/bounded_graph_diagnostics.md`
Related references:
- [session-transition-trace-contract.md](session_transition_trace_contract.md) — Session transition trace contract
- [memory-search-command-routing.md](memory_search_command_routing.md) — /memory:search command routing

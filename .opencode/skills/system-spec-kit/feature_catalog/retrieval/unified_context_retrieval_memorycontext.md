...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/handler-memory-context.vitest.ts` | Automated test | Context handler input/output |
| `mcp_server/tests/memory-context.vitest.ts` | Automated test | Context integration tests |
| `mcp_server/tests/memory-context-eval-channels.vitest.ts` | Automated test | Context eval channel coverage |
| `mcp_server/tests/intent-classifier.vitest.ts` | Automated test | Intent classification accuracy |
| `mcp_server/tests/pressure-monitor.vitest.ts` | Automated test | Pressure monitor tests |
| `mcp_server/tests/token-budget-enforcement.vitest.ts` | Automated test | Token budget enforcement |
| `mcp_server/tests/session-manager.vitest.ts` | Automated test | Session manager tests |
| `mcp_server/tests/folder-discovery.vitest.ts` | Automated test | Folder discovery tests |
...
- Feature file path: `retrieval/unified_context_retrieval_memorycontext.md`
Related references:
- [semantic-and-lexical-search-memorysearch.md](semantic_and_lexical_search_memorysearch.md) — Semantic and lexical search (memory_search)

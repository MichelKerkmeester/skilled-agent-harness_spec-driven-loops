...
| `feature_catalog/context-preservation/resource-map-template.md` | Feature catalog | This feature entry for ongoing discovery |
| `manual_testing_playbook/context-preservation/resource-map-template.md` | Playbook | Manual verification scenario for the rollout |

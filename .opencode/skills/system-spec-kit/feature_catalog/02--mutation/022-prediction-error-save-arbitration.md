...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/prediction-error-gate.vitest.ts` | Automated test | PE gate tests |
| `mcp_server/tests/handler-memory-save.vitest.ts` | Automated test | Save handler validation |
| `mcp_server/tests/memory-save-extended.vitest.ts` | Automated test | Save extended scenarios |
| `mcp_server/tests/memory-save-integration.vitest.ts` | Automated test | Save-path PE arbitration integration tests |
| `mcp_server/tests/create-record-lineage-regressions.vitest.ts` | Automated test | Cross-path supersede lineage and causal-edge routing coverage |
...
- Feature file path: `02--mutation/022-prediction-error-save-arbitration.md`
- Playbook reference: 110
Related references:
- [021-transaction-wrappers-on-mutation-handlers.md](021-transaction-wrappers-on-mutation-handlers.md) — Transaction wrappers on mutation handlers
- [023-correction-tracking-with-undo.md](023-correction-tracking-with-undo.md) — Correction tracking with undo

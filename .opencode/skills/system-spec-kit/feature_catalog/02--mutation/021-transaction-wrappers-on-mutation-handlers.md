...
| `mcp_server/handlers/save/atomic-index-memory.ts` | Handler | Atomic save commit helper inside the spec-folder lock |
...
| `mcp_server/tests/memory-crud-extended.vitest.ts` | Automated test | Extended transactional mutation scenarios |
| `mcp_server/tests/history.vitest.ts` | Automated test | Mutation history validation |
...
- Feature file path: `02--mutation/021-transaction-wrappers-on-mutation-handlers.md`
Related references:
- [020-validation-feedback-memoryvalidate.md](020-validation-feedback-memoryvalidate.md) — Validation feedback (memory_validate)
- [022-prediction-error-save-arbitration.md](022-prediction-error-save-arbitration.md) — Prediction-error save arbitration

...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/reconsolidation.vitest.ts` | Automated test | Conflict-path regression coverage for both transaction branches |
| `mcp_server/tests/p0-b-reconsolidation-composite.vitest.ts` | Automated test | Composite reconsolidation behavior across repeated conflict runs |
...
- Feature file path: `02--mutation/025-reconsolidation-conflict-transaction-helper.md`
Related references:
- [024-per-memory-history-log.md](024-per-memory-history-log.md) — Per-memory history log
- [026-memory-retention-sweep.md](026-memory-retention-sweep.md) — Memory retention sweep (memory_retention_sweep)

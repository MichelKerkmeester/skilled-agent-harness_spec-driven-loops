...
- Feature file path: `02--mutation/transaction-wrappers-on-mutation-handlers.md`
Related references:
- [validation-feedback-memoryvalidate.md](validation-feedback-memoryvalidate.md) — Validation feedback (memory_validate)
- [prediction-error-save-arbitration.md](prediction-error-save-arbitration.md) — Prediction-error save arbitration

...
| File | Focus |
|------|-------|
| `.opencode/skills/system-spec-kit/mcp_server/tests/history.vitest.ts` | History schema migration, actor format coverage, and boundary validation |
| `.opencode/skills/system-spec-kit/mcp_server/tests/memory-crud-extended.vitest.ts` | Mutation handler integration paths that write history events |

...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/handler-checkpoints.vitest.ts` | Automated test | `memory_validate` handler validation |
| `mcp_server/tests/confidence-tracker.vitest.ts` | Automated test | Confidence update transaction behavior |
| `mcp_server/tests/learned-feedback.vitest.ts` | Automated test | Learned-feedback persistence and safeguards |
| `mcp_server/tests/promotion-positive-validation-semantics.vitest.ts` | Automated test | Positive-validation counting and promotion semantics |
| `mcp_server/tests/adaptive-ranking.vitest.ts` | Automated test | Adaptive outcome/correction signal logging |
...
- Feature file path: `02--mutation/validation-feedback-memoryvalidate.md`
Related references:
- [tier-based-bulk-deletion-memorybulkdelete.md](tier-based-bulk-deletion-memorybulkdelete.md) — Tier-based bulk deletion (memory_bulk_delete)
- [transaction-wrappers-on-mutation-handlers.md](transaction-wrappers-on-mutation-handlers.md) — Transaction wrappers on mutation handlers

...
- Feature file path: `02--mutation/016-memory-indexing-memorysave.md`
- Source list updated 2026-03-25 per deep review

Related references:
- [017-memory-metadata-update-memoryupdate.md](017-memory-metadata-update-memoryupdate.md) — Memory metadata update (memory_update)

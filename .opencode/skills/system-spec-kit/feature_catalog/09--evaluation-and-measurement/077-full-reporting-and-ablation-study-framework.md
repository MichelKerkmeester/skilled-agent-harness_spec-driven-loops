...
| `mcp_server/tests/eval-db.vitest.ts` | Automated test | Eval database operations |
...
| `mcp_server/tests/reporting-dashboard.vitest.ts` | Automated test | Dashboard reporting tests |
...
- Feature file path: `09--evaluation-and-measurement/077-full-reporting-and-ablation-study-framework.md`
Related references:
- [076-scoring-observability.md](076-scoring-observability.md) — Scoring observability
- [078-test-quality-improvements.md](078-test-quality-improvements.md) — Test quality improvements

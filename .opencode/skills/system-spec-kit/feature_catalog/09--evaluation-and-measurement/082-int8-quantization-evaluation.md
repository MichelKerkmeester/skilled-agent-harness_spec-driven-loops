...
- Feature file path: `09--evaluation-and-measurement/082-int8-quantization-evaluation.md`
Related references:
- [081-evaluation-api-surface.md](081-evaluation-api-surface.md) — Evaluation API Surface
- [083-memory-roadmap-baseline-snapshot.md](083-memory-roadmap-baseline-snapshot.md) — Memory roadmap baseline snapshot

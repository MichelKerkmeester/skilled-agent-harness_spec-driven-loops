...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/eval-logger.vitest.ts` | Automated test | Disabled/no-op behavior plus non-fatal logging-path coverage |
...
- Feature file path: `09--evaluation-and-measurement/071-observer-effect-mitigation.md`
Related references:
- [070-core-metric-computation.md](070-core-metric-computation.md) — Core metric computation
- [072-quality-proxy-formula.md](072-quality-proxy-formula.md) — Quality proxy formula

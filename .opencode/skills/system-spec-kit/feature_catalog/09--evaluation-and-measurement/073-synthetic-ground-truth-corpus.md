...
- Feature file path: `09--evaluation-and-measurement/073-synthetic-ground-truth-corpus.md`
Related references:
- [072-quality-proxy-formula.md](072-quality-proxy-formula.md) — Quality proxy formula
- [074-bm25-only-baseline.md](074-bm25-only-baseline.md) — BM25-only baseline

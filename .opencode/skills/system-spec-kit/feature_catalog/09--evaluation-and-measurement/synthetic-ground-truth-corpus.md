...
- Feature file path: `09--evaluation-and-measurement/synthetic-ground-truth-corpus.md`
Related references:
- [quality-proxy-formula.md](quality-proxy-formula.md) — Quality proxy formula

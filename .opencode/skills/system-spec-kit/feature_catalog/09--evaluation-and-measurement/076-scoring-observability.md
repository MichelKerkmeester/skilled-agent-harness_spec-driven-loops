...
- Feature file path: `09--evaluation-and-measurement/076-scoring-observability.md`
Related references:
- [075-agent-consumption-instrumentation.md](075-agent-consumption-instrumentation.md) — Agent consumption instrumentation
- [077-full-reporting-and-ablation-study-framework.md](077-full-reporting-and-ablation-study-framework.md) — Full reporting and ablation study framework

...
- Feature file path: `09--evaluation-and-measurement/069-evaluation-database-and-schema.md`
- Source list updated 2026-03-25 per deep review

Related references:
- [070-core-metric-computation.md](070-core-metric-computation.md) — Core metric computation

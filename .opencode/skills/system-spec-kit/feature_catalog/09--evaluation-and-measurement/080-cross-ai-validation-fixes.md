...
- Feature file path: `09--evaluation-and-measurement/080-cross-ai-validation-fixes.md`
Related references:
- [079-evaluation-and-housekeeping-fixes.md](079-evaluation-and-housekeeping-fixes.md) — Evaluation and housekeeping fixes

...
- Feature file path: `09--evaluation-and-measurement/observer-effect-mitigation.md`
Related references:
- [core-metric-computation.md](core-metric-computation.md) — Core metric computation

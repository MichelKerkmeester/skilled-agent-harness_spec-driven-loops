...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/api-public-surfaces.vitest.ts` | Automated test | Direct export contract for the public eval/search barrels and top-level API barrel parity |

---
## 4. SOURCE METADATA
- Group: Evaluation And Measurement
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `09--evaluation-and-measurement/081-evaluation-api-surface.md`
Related references:
- [080-cross-ai-validation-fixes.md](080-cross-ai-validation-fixes.md) — Cross-AI validation fixes
- [082-int8-quantization-evaluation.md](082-int8-quantization-evaluation.md) — INT8 quantization evaluation

...
- Feature file path: `09--evaluation-and-measurement/quality-proxy-formula.md`
Related references:
- [observer-effect-mitigation.md](observer-effect-mitigation.md) — Observer effect mitigation

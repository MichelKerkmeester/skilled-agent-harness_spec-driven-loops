...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/n3lite-consolidation.vitest.ts` | Automated test | N3-lite consolidation tests |
...
- Feature file path: `15--retrieval-enhancements/192-lightweight-consolidation.md`
Related references:
- [191-spec-folder-hierarchy-as-retrieval-structure.md](191-spec-folder-hierarchy-as-retrieval-structure.md) — Spec folder hierarchy as retrieval structure
- [193-memory-summary-search-channel.md](193-memory-summary-search-channel.md) — Memory summary search channel

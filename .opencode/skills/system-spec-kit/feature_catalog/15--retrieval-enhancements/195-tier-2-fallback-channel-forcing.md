...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/hybrid-search.vitest.ts` | Automated test | Regression `C138-P0-FB-T2` for Tier-2 forced-channel fallback |
...
- Feature file path: `15--retrieval-enhancements/195-tier-2-fallback-channel-forcing.md`
Related references:
- [194-cross-document-entity-linking.md](194-cross-document-entity-linking.md) — Cross-document entity linking
- [196-provenance-rich-response-envelopes.md](196-provenance-rich-response-envelopes.md) — Provenance-rich response envelopes

...
- Feature file path: `15--retrieval-enhancements/provenance-rich-response-envelopes.md`
Related references:
- [tier-2-fallback-channel-forcing.md](tier-2-fallback-channel-forcing.md) — Tier-2 fallback channel forcing
- [contextual-tree-injection.md](contextual-tree-injection.md) — Contextual tree injection

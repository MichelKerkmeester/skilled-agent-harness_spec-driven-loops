...
- Feature file path: `15--retrieval-enhancements/199-causal-boost-graduated.md`

- Kill switch: `SPECKIT_CAUSAL_BOOST=false`
- See also: `10--graph-signal-activation/092-causal-neighbor-boost-and-injection.md` (detailed causal mechanics)
Related references:
- [198-session-boost-graduated.md](198-session-boost-graduated.md) — Session attention boost (graduated default-ON)
- [200-graph-expanded-fallback.md](200-graph-expanded-fallback.md) — Graph-expanded fallback

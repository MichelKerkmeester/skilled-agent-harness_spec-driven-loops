...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/context-server.vitest.ts` | Automated test | Tool-dispatch and compaction hook integration coverage |
...
- Feature file path: `15--retrieval-enhancements/189-dual-scope-memory-auto-surface.md`
Related references:
- [190-constitutional-memory-as-expert-knowledge-injection.md](190-constitutional-memory-as-expert-knowledge-injection.md) — Constitutional memory as expert knowledge injection

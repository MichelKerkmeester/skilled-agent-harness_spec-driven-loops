...
- Feature file path: `15--retrieval-enhancements/tier-2-fallback-channel-forcing.md`
Related references:
- [cross-document-entity-linking.md](cross-document-entity-linking.md) — Cross-document entity linking

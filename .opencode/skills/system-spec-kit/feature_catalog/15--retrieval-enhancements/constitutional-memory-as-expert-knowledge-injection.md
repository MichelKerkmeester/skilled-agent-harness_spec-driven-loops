...
- Feature file path: `15--retrieval-enhancements/constitutional-memory-as-expert-knowledge-injection.md`
Related references:
- [dual-scope-memory-auto-surface.md](dual-scope-memory-auto-surface.md) — Dual-scope memory auto-surface

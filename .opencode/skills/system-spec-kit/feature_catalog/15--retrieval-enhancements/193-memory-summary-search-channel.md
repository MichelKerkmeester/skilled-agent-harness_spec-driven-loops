...
| `mcp_server/tests/memory-summaries.vitest.ts` | Automated test | Summary generation tests |
...
- Feature file path: `15--retrieval-enhancements/193-memory-summary-search-channel.md`
Related references:
- [192-lightweight-consolidation.md](192-lightweight-consolidation.md) — Lightweight consolidation
- [194-cross-document-entity-linking.md](194-cross-document-entity-linking.md) — Cross-document entity linking

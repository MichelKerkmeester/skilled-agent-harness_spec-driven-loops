...
- Feature file path: `15--retrieval-enhancements/graph-expanded-fallback.md`

- Kill switch: SPECKIT_GRAPH_FALLBACK=false
Related references:
- [causal-boost-graduated.md](causal-boost-graduated.md) — Causal graph boost (graduated default-ON)

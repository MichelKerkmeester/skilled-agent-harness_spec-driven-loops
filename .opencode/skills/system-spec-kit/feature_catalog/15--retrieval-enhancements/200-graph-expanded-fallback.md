...
- Feature file path: `15--retrieval-enhancements/200-graph-expanded-fallback.md`

- Kill switch: SPECKIT_GRAPH_FALLBACK=false
Related references:
- [199-causal-boost-graduated.md](199-causal-boost-graduated.md) — Causal graph boost (graduated default-ON)
- [201-always-on-graph-context-injection.md](201-always-on-graph-context-injection.md) — Always-on graph context injection

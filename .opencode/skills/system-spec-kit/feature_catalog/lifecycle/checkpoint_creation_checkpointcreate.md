...
- Feature file path: `lifecycle/checkpoint_creation_checkpointcreate.md`
Related references:
- [checkpoint-listing-checkpointlist.md](checkpoint_listing_checkpointlist.md) — Checkpoint listing (checkpoint_list)

...
- Feature file path: `lifecycle/post_insert_retry_budget.md`
Related references:
- [constitutional-memory-end-to-end-lifecycle.md](constitutional_memory_end_to_end_lifecycle.md) — Constitutional Memory end-to-end lifecycle

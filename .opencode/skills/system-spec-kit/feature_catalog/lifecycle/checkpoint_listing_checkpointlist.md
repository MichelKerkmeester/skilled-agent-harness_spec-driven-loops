...
- Feature file path: `lifecycle/checkpoint_listing_checkpointlist.md`
Related references:
- [checkpoint-creation-checkpointcreate.md](checkpoint_creation_checkpointcreate.md) — Checkpoint creation (checkpoint_create)

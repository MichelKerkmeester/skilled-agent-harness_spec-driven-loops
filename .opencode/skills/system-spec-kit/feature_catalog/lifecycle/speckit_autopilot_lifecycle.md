...
| `manual_testing_playbook/lifecycle/speckit_autopilot_lifecycle.md` | Manual playbook | Operator scenario for unattended lifecycle validation |
...
Related references:
- [async-ingestion-job-lifecycle.md](async_ingestion_job_lifecycle.md) - lifecycle-state precedent in the same category

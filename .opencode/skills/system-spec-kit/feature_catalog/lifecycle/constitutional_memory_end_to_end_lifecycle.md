...
- Feature file path: `lifecycle/constitutional_memory_end_to_end_lifecycle.md`
Related references:
- [startup-pending-file-recovery.md](startup_pending_file_recovery.md) — Startup pending-file recovery
- [post-insert-retry-budget.md](post_insert_retry_budget.md) — Post-insert retry budget

...
- Feature file path: `evaluation/reporting_dashboard_evalreportingdashboard.md`
Related references:
- [ablation-studies-evalrunablation.md](ablation_studies_evalrunablation.md) — Ablation studies (eval_run_ablation)

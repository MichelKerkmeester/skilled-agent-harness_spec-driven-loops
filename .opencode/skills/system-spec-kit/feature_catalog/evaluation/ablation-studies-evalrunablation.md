...
### Ablation Framework & Statistical Significance
...
### Snapshot Persistence & Feature Flag
...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/ablation-framework.vitest.ts` | Automated test | Ablation framework tests |
| `mcp_server/tests/handler-eval-reporting.vitest.ts` | Automated test | Handler-level eval reporting tests |
| `mcp_server/tests/k-value-optimization.vitest.ts` | Automated test | K-sensitivity analysis and recommendation tests |
...
- Feature file path: `evaluation/ablation-studies-evalrunablation.md`
Related references:
- [reporting-dashboard-evalreportingdashboard.md](reporting-dashboard-evalreportingdashboard.md) — Reporting dashboard (eval_reporting_dashboard)

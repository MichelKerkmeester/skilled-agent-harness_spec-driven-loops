...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/slug-utils-boundary.vitest.ts` | Automated test | Slug generation boundary tests |
...
- Feature file path: `13--memory-quality-and-indexing/144-content-aware-memory-filename-generation.md`
Related references:
- [143-auto-entity-extraction.md](143-auto-entity-extraction.md) — Auto entity extraction
- [145-entity-normalization-consolidation.md](145-entity-normalization-consolidation.md) — Entity normalization consolidation

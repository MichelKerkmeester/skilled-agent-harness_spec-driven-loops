...
trigger_phrases:
  ...
  - "token count estimate before save"
...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/preflight.vitest.ts` | Automated test | Token-budget validation and pre-flight error/warning behavior |
...
- Feature file path: `13--memory-quality-and-indexing/136-pre-flight-token-budget-validation.md`
Related references:

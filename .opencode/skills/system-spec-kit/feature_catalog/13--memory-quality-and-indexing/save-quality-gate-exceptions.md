...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/short-critical-quality-gate.vitest.ts` | Automated test | Short-critical exception behavior, structural signal thresholds, flag gating |
...
- Feature file path: `13--memory-quality-and-indexing/save-quality-gate-exceptions.md`
Related references:
- [hybrid-decay-policy.md](hybrid-decay-policy.md) — Hybrid decay policy

...
- Feature file path: `13--memory-quality-and-indexing/142-encoding-intent-capture-at-index-time.md`
Related references:
- [141-anchor-aware-chunk-thinning.md](141-anchor-aware-chunk-thinning.md) — Anchor-aware chunk thinning

...
- Feature file path: `13--memory-quality-and-indexing/159-vec-memories-knn-and-factory-shard-fallback.md`
...
Related references:
- [158-memory-causal-trust-display.md](158-memory-causal-trust-display.md) — Memory causal trust display
- [160-constitutional-sufficiency-gate-exemption.md](160-constitutional-sufficiency-gate-exemption.md) — Constitutional sufficiency-gate exemption

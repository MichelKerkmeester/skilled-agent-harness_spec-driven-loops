...
trigger_phrases:
  ...
  - "writeVectorsToKnn"
  - "factory shard fallback ADR-012"
...
- Feature file path: `13--memory-quality-and-indexing/vec-memories-knn-and-factory-shard-fallback.md`
...
Related references:
- [memory-causal-trust-display.md](memory-causal-trust-display.md) — Memory causal trust display

...
- Feature file path: `13--memory-quality-and-indexing/145-entity-normalization-consolidation.md`
Related references:
- [144-content-aware-memory-filename-generation.md](144-content-aware-memory-filename-generation.md) — Content-aware memory filename generation
- [146-quality-gate-timer-persistence.md](146-quality-gate-timer-persistence.md) — Quality gate timer persistence

...
- Feature file path: `13--memory-quality-and-indexing/141-anchor-aware-chunk-thinning.md`
Related references:
- [140-smarter-memory-content-generation.md](140-smarter-memory-content-generation.md) — Smarter memory content generation
- [142-encoding-intent-capture-at-index-time.md](142-encoding-intent-capture-at-index-time.md) — Encoding-intent capture at index time

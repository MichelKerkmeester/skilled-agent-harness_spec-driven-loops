...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/quality-loop.vitest.ts` | Automated test | Attempt counting, retry behavior, and rejection semantics |
| `mcp_server/tests/handler-memory-save.vitest.ts` | Automated test | Rejected-save rollback semantics plus post-loop insufficiency hard-block coverage |
...
- Feature file path: `13--memory-quality-and-indexing/134-verify-fix-verify-memory-quality-loop.md`
- Source list updated 2026-03-25 per deep review
Related references:
- [135-signal-vocabulary-expansion.md](135-signal-vocabulary-expansion.md) — Signal vocabulary expansion

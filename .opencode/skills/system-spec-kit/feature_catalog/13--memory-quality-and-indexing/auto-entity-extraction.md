...
trigger_phrases:
  ...
  - "entity extraction at save time"
  - "regex entity rules"
...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/entity-extractor.vitest.ts` | Automated test | Entity extraction rule coverage |
| `mcp_server/tests/entity-linker.vitest.ts` | Automated test | Entity linking and normalization tests |
| `mcp_server/tests/extraction-adapter.vitest.ts` | Automated test | Extraction adapter tests |
...
- Feature file path: `13--memory-quality-and-indexing/auto-entity-extraction.md`
Related references:
- [encoding-intent-capture-at-index-time.md](encoding-intent-capture-at-index-time.md) — Encoding-intent capture at index time
- [content-aware-memory-filename-generation.md](content-aware-memory-filename-generation.md) — Content-aware memory filename generation

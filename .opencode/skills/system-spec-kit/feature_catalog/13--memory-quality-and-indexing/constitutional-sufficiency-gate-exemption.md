...
- Feature file path: `13--memory-quality-and-indexing/constitutional-sufficiency-gate-exemption.md`
...
- [graph-metadata-and-lineage-repair-runner.md](graph-metadata-and-lineage-repair-runner.md) — Graph-metadata and lineage repair runner

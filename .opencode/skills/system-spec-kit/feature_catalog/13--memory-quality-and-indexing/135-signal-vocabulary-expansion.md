...
- Feature file path: `13--memory-quality-and-indexing/135-signal-vocabulary-expansion.md`
Related references:
- [134-verify-fix-verify-memory-quality-loop.md](134-verify-fix-verify-memory-quality-loop.md) — Verify-fix-verify memory quality loop

...
- Feature file path: `13--memory-quality-and-indexing/verify-fix-verify-memory-quality-loop.md`
- Source list updated 2026-03-25 per deep review
Related references:
- [signal-vocabulary-expansion.md](signal-vocabulary-expansion.md) — Signal vocabulary expansion

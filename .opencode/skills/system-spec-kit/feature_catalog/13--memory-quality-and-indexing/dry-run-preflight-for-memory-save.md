...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/preflight.vitest.ts` | Automated test | Pre-flight validation tests |
| `mcp_server/tests/handler-memory-save.vitest.ts` | Automated test | Save handler dry-run and insufficiency reporting |
...
- Feature file path: `13--memory-quality-and-indexing/dry-run-preflight-for-memory-save.md`
Related references:

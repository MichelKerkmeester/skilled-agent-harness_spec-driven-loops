...
trigger_phrases:
  ...
  - "memory_index_scan constitutional warn-only"
...
- Feature file path: `13--memory-quality-and-indexing/160-constitutional-sufficiency-gate-exemption.md`
- Shipping packet: `016/002/018-constitutional-quality-gate-exemption`
Related references:
- [159-vec-memories-knn-and-factory-shard-fallback.md](159-vec-memories-knn-and-factory-shard-fallback.md) — vec_memories KNN dual-write and factory shard fallback
- [161-graph-metadata-and-lineage-repair-runner.md](161-graph-metadata-and-lineage-repair-runner.md) — Graph-metadata and lineage repair runner

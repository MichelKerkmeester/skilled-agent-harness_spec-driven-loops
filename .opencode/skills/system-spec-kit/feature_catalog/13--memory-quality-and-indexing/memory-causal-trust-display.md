...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/memory/trust-badges.test.ts` | Automated test | Badge derivation, age rendering, orphan detection, explicit-badge preservation |
| `mcp_server/tests/response-profile-formatters.vitest.ts` | Automated test | Response-profile preservation for `trustBadges` |
...
- [vec-memories-knn-and-factory-shard-fallback.md](vec-memories-knn-and-factory-shard-fallback.md) — vec_memories KNN dual-write and factory shard fallback

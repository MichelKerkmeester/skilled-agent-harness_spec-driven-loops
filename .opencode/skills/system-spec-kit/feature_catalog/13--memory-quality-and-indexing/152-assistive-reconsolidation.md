...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/assistive-reconsolidation.vitest.ts` | Automated test | Flag behavior, tier classification, supersede/complement heuristic, recommendation logging |
...
- Feature file path: `13--memory-quality-and-indexing/152-assistive-reconsolidation.md`
Related references:
- [151-post-save-quality-review.md](151-post-save-quality-review.md) — Post-save quality review
- [153-hybrid-decay-policy.md](153-hybrid-decay-policy.md) — Hybrid decay policy

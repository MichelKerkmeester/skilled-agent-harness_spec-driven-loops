...
- Feature file path: `13--memory-quality-and-indexing/smarter-memory-content-generation.md`
Related references:
- [reconsolidation-on-save.md](reconsolidation-on-save.md) — Reconsolidation-on-save

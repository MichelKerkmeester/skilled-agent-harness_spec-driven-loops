...
- Feature file path: `13--memory-quality-and-indexing/session-enrichment-and-alignment-guards.md`
Related references:
- [outsourced-agent-memory-capture.md](outsourced-agent-memory-capture.md) — Outsourced agent memory capture
- [post-save-quality-review.md](post-save-quality-review.md) — Post-save quality review

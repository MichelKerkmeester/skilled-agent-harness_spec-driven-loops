...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/entity-extractor.vitest.ts` | Automated test | Entity extraction tests |
...
- Feature file path: `memory_quality_and_indexing/entity_normalization_consolidation.md`
Related references:
- [content-aware-memory-filename-generation.md](content_aware_memory_filename_generation.md) — Content-aware memory filename generation
- [quality-gate-timer-persistence.md](quality_gate_timer_persistence.md) — Quality gate timer persistence

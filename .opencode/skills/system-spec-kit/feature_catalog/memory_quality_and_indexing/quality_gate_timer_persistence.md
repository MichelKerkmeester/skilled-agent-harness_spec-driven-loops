...
Related references:
- [entity-normalization-consolidation.md](entity_normalization_consolidation.md) — Entity normalization consolidation
- [deferred-lexical-only-indexing.md](deferred_lexical_only_indexing.md) — Deferred lexical-only indexing

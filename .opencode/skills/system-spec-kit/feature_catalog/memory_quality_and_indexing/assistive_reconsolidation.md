...
- Feature file path: `memory_quality_and_indexing/assistive_reconsolidation.md`
Related references:
- [post-save-quality-review.md](post_save_quality_review.md) — Post-save quality review
- [hybrid-decay-policy.md](hybrid_decay_policy.md) — Hybrid decay policy

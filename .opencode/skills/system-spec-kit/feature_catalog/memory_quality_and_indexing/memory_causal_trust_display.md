...
- Feature file path: `memory_quality_and_indexing/memory_causal_trust_display.md`
Related references:
- [canonical-continuity-save-substrate.md](canonical_continuity_save_substrate.md) — Canonical continuity save substrate

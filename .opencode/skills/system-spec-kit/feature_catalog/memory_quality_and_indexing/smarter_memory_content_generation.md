...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/content-normalizer.vitest.ts` | Automated test | Content normalization primitive and pipeline tests |
| `mcp_server/tests/memory-parser.vitest.ts` | Automated test | Memory parser tests |
...
- Feature file path: `memory_quality_and_indexing/smarter_memory_content_generation.md`
Related references:
- [reconsolidation-on-save.md](reconsolidation_on_save.md) — Reconsolidation-on-save
- [anchor-aware-chunk-thinning.md](anchor_aware_chunk_thinning.md) — Anchor-aware chunk thinning

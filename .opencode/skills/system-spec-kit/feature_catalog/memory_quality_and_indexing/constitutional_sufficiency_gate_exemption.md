...
- Feature file path: `memory_quality_and_indexing/constitutional_sufficiency_gate_exemption.md`
- Shipping packet: `016/002/018-constitutional-quality-gate-exemption`
Related references:
- [vec-memories-knn-and-factory-shard-fallback.md](vec_memories_knn_and_factory_shard_fallback.md) — vec_memories KNN dual-write and factory shard fallback
- [graph-metadata-and-lineage-repair-runner.md](graph_metadata_and_lineage_repair_runner.md) — Graph-metadata and lineage repair runner

...
- Feature file path: `memory_quality_and_indexing/pre_storage_quality_gate.md`
Related references:
- [spec-folder-description-discovery.md](spec_folder_description_discovery.md) — Spec folder description discovery
- [reconsolidation-on-save.md](reconsolidation_on_save.md) — Reconsolidation-on-save

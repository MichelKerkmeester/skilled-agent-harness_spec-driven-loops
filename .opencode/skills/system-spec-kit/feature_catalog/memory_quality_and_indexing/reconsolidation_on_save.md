...
- Feature file path: `memory_quality_and_indexing/reconsolidation_on_save.md`
Related references:
- [pre-storage-quality-gate.md](pre_storage_quality_gate.md) — Pre-storage quality gate

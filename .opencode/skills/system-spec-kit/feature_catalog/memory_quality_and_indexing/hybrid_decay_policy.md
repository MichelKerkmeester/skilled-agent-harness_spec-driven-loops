...
- Feature file path: `memory_quality_and_indexing/hybrid_decay_policy.md`
Related references:
- [assistive-reconsolidation.md](assistive_reconsolidation.md) — Assistive reconsolidation
- [save-quality-gate-exceptions.md](save_quality_gate_exceptions.md) — Save quality gate exceptions

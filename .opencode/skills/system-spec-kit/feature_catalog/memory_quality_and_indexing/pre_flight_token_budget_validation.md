...
- Feature file path: `memory_quality_and_indexing/pre_flight_token_budget_validation.md`
Related references:
- [signal-vocabulary-expansion.md](signal_vocabulary_expansion.md) — Signal vocabulary expansion

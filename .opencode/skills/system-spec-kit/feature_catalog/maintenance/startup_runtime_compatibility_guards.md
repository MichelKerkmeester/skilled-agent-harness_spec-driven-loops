...
- Feature file path: `maintenance/startup_runtime_compatibility_guards.md`
- Manual playbook scenario: EX-035
Related references:
- [workspace-scanning-and-indexing-memoryindexscan.md](workspace_scanning_and_indexing_memoryindexscan.md) — Workspace scanning and indexing (memory_index_scan)
- [doctor-router-and-manifest-dispatch.md](doctor_router_and_manifest_dispatch.md) — Doctor router and manifest-driven dispatch

...
- Feature file path: `07--evaluation/reporting-dashboard-evalreportingdashboard.md`
Related references:
- [ablation-studies-evalrunablation.md](ablation-studies-evalrunablation.md) — Ablation studies (eval_run_ablation)

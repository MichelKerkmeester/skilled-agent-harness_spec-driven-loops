...
- Feature file path: `07--evaluation/055-reporting-dashboard-evalreportingdashboard.md`
Related references:
- [054-ablation-studies-evalrunablation.md](054-ablation-studies-evalrunablation.md) — Ablation studies (eval_run_ablation)

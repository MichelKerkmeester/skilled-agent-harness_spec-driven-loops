...
- Feature file path: `14--pipeline-architecture/171-legacy-v1-pipeline-removal.md`
Related references:
- [170-performance-improvements.md](170-performance-improvements.md) — Performance improvements
- [172-pipeline-and-mutation-hardening.md](172-pipeline-and-mutation-hardening.md) — Pipeline and mutation hardening

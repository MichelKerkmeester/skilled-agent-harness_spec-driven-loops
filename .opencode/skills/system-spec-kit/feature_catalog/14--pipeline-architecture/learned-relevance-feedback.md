...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/feedback-denylist.vitest.ts` | Automated test | Feedback denylist tests |
| `mcp_server/tests/learned-feedback.vitest.ts` | Automated test | Learned feedback tests |
...
- Feature file path: `14--pipeline-architecture/learned-relevance-feedback.md`
Related references:
- [validation-signals-as-retrieval-metadata.md](validation-signals-as-retrieval-metadata.md) — Validation signals as retrieval metadata

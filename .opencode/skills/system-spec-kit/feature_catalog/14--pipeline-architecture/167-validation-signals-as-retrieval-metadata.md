...
| `mcp_server/tests/pipeline-architecture-remediation.vitest.ts` | Automated test | Direct audit traceability coverage for validation metadata ownership |
...
- Feature file path: `14--pipeline-architecture/167-validation-signals-as-retrieval-metadata.md`
Related references:
- [166-template-anchor-optimization.md](166-template-anchor-optimization.md) — Template anchor optimization
- [168-learned-relevance-feedback.md](168-learned-relevance-feedback.md) — Learned relevance feedback

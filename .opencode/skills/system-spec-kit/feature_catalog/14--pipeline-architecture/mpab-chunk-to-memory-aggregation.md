...
- Feature file path: `14--pipeline-architecture/mpab-chunk-to-memory-aggregation.md`
Related references:
- [4-stage-pipeline-refactor.md](4-stage-pipeline-refactor.md) — 4-stage pipeline refactor
- [chunk-ordering-preservation.md](chunk-ordering-preservation.md) — Chunk ordering preservation

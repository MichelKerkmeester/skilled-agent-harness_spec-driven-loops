...
- Feature file path: `14--pipeline-architecture/170-performance-improvements.md`
Related references:
- [169-search-pipeline-safety.md](169-search-pipeline-safety.md) — Search pipeline safety

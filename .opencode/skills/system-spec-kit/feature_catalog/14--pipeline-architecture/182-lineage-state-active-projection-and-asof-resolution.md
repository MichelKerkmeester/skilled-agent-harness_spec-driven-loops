...
- Feature file path: `14--pipeline-architecture/182-lineage-state-active-projection-and-asof-resolution.md`

Related references:
- [181-atomic-pending-file-recovery.md](181-atomic-pending-file-recovery.md) — Atomic pending-file recovery
- [183-mcp-server-public-api-barrel.md](183-mcp-server-public-api-barrel.md) — MCP Server Public API Barrel

...
- Feature file path: `14--pipeline-architecture/166-template-anchor-optimization.md`
Related references:
- [165-chunk-ordering-preservation.md](165-chunk-ordering-preservation.md) — Chunk ordering preservation
- [167-validation-signals-as-retrieval-metadata.md](167-validation-signals-as-retrieval-metadata.md) — Validation signals as retrieval metadata

...
- Feature file path: `14--pipeline-architecture/164-mpab-chunk-to-memory-aggregation.md`
Related references:
- [163-4-stage-pipeline-refactor.md](163-4-stage-pipeline-refactor.md) — 4-stage pipeline refactor

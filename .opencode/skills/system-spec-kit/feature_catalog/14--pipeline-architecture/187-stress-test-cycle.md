...
trigger_phrases:
  - "stress test cycle"
  - "structured manual evaluation rubric"
...
| Cycle | Role | Evidence |
|-------|------|----------|
| v1.0.1 baseline | Established the fixed search-intelligence corpus and calibrated scoring basis. | `<spec-folder>:133` documents the scenario corpus; lines 200-210 document the active v1.0.1 4-dimension calibration. |
...
| Path | Role |
|------|------|
| Internal design notes | v1.0.1 baseline corpus, dispatch matrix, and scenario execution |
| Internal design notes | v1.0.2 narrative findings shape |
| Internal design notes | v1.0.2 sidecar shape and aggregate math |
| Internal design notes | v1.0.3 wired telemetry findings |
| Internal design notes | v1.0.3 telemetry samples |
...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/14--stress-testing/01-run-stress-cycle.md` | Operational guide |

## 4. SOURCE METADATA
- Group: Pipeline Architecture
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `14--pipeline-architecture/187-stress-test-cycle.md`

- Companion playbook: `.opencode/skills/system-spec-kit/manual_testing_playbook/14--stress-testing/01-run-stress-cycle.md`
Related references:
- [186-code-graph-phase-dag-runner.md](186-code-graph-phase-dag-runner.md) — Code Graph phase-DAG runner
- [188-routing-telemetry-and-channel-invocation-rates.md](188-routing-telemetry-and-channel-invocation-rates.md) — Routing telemetry and channel invocation rates

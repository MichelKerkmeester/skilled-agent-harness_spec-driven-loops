...
- Feature file path: `14--pipeline-architecture/179-embedding-retry-orchestrator.md`
Related references:
- [178-atomic-write-then-index-api.md](178-atomic-write-then-index-api.md) — Atomic write-then-index API
- [180-7-layer-tool-architecture-metadata.md](180-7-layer-tool-architecture-metadata.md) — 7-layer tool architecture metadata

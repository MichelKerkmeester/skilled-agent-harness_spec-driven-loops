...
- Feature file path: `14--pipeline-architecture/174-strict-zod-schema-validation.md`
Related references:
- [173-dbpath-extraction-and-import-standardization.md](173-dbpath-extraction-and-import-standardization.md) — DB_PATH extraction and import standardization

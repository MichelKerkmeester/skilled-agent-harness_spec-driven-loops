...
- Feature file path: `14--pipeline-architecture/188-routing-telemetry-and-channel-invocation-rates.md`
Related references:
- [187-stress-test-cycle.md](187-stress-test-cycle.md) — Stress test cycle

...
- Feature file path: `14--pipeline-architecture/186-code-graph-phase-dag-runner.md`
...
Related references:
- [185-phase-017-maintainability-extracts.md](185-phase-017-maintainability-extracts.md) — Maintainability extracts

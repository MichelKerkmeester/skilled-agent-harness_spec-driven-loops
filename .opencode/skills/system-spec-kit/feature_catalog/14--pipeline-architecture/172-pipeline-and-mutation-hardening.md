...
- Feature file path: `14--pipeline-architecture/172-pipeline-and-mutation-hardening.md`
Related references:
- [171-legacy-v1-pipeline-removal.md](171-legacy-v1-pipeline-removal.md) — Legacy V1 pipeline removal

...
- Feature file path: `14--pipeline-architecture/180-7-layer-tool-architecture-metadata.md`
Related references:
- [179-embedding-retry-orchestrator.md](179-embedding-retry-orchestrator.md) — Embedding retry orchestrator

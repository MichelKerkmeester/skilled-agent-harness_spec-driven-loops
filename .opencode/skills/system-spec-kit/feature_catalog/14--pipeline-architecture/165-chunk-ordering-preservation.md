...
- Feature file path: `14--pipeline-architecture/165-chunk-ordering-preservation.md`
Related references:
- [164-mpab-chunk-to-memory-aggregation.md](164-mpab-chunk-to-memory-aggregation.md) — MPAB chunk-to-memory aggregation

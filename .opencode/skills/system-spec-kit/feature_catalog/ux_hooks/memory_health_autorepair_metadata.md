...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/memory-crud-extended.vitest.ts` | Automated test | Auto-repair metadata and partial-success scenarios |
| `mcp_server/tests/handler-memory-health-edge.vitest.ts` | Automated test | Confirmation and validation edge cases |
...
- Feature file path: `ux_hooks/memory_health_autorepair_metadata.md`
Related references:

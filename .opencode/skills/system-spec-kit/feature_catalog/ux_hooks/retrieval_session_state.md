...
- Feature file path: `ux_hooks/retrieval_session_state.md`
Related references:
- [progressive-disclosure.md](progressive_disclosure.md) — Progressive disclosure with cursor pagination
- [empty-result-recovery.md](empty_result_recovery.md) — Empty result recovery

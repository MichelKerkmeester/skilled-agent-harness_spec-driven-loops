...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/provenance-envelope.vitest.ts` | Automated test | Provenance envelope structure and graph evidence content |
...
Related references:
- [result-confidence.md](result_confidence.md) — Result confidence scoring

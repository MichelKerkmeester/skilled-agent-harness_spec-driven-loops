...
- Feature file path: `ux_hooks/result_explainability.md`
Related references:
- [end-to-end-success-envelope-verification.md](end_to_end_success_envelope_verification.md) — End-to-end success-envelope verification
- [mode-aware-response-profiles.md](mode_aware_response_profiles.md) — Mode-aware response profiles

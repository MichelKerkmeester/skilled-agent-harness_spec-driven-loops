...
- Feature file path: `ux_hooks/context_server_success_hint_append.md`
Related references:
- [mutation-response-ux-payload-exposure.md](mutation_response_ux_payload_exposure.md) — Mutation response UX payload exposure
- [duplicate-save-no-op-feedback-hardening.md](duplicate_save_no_op_feedback_hardening.md) — Duplicate-save no-op feedback hardening

...
- Feature file path: `ux_hooks/checkpoint_delete_confirmname_safety.md`
Related references:
- [memory-health-autorepair-metadata.md](memory_health_autorepair_metadata.md) — Memory health autoRepair metadata

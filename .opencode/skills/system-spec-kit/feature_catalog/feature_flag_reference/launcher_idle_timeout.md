...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/tooling_and_scripts/orphan_mcp_runtime_lifecycle_guardrails.md` | Manual playbook | Manual dry-run and lifecycle guardrail scenario. |

## 4. SOURCE METADATA

- Group: Feature Flag Reference
- Canonical catalog source: `feature_catalog.md`
- Feature file path: `feature_flag_reference/launcher_idle_timeout.md`
Related references:
- [memory-roadmap-capability-flags.md](memory_roadmap_capability_flags.md) — Memory roadmap flags (SPECKIT_MEMORY_*)

...
- Feature file path: `feature_flag_reference/2_session_and_cache.md`
Related references:
- [1-search-pipeline-features-speckit.md](1_search_pipeline_features_speckit.md) — Search Pipeline Features (SPECKIT_*)
- [3-mcp-configuration.md](3_mcp_configuration.md) — 3. MCP Configuration

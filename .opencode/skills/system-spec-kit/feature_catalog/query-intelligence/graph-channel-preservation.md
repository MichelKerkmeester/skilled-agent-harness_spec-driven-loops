...
- Related entries: `query-intelligence/query-complexity-router.md` (tier classifier — unchanged here, override sits above it), `query-intelligence/graph-concept-routing.md` (graph traversal algorithm — unchanged here), `discovery/health-diagnostics-memoryhealth.md` (surfaces the new `data.routing` block)
Related references:

...
- Feature file path: `pipeline_architecture/mpab_chunk_to_memory_aggregation.md`
Related references:
- [4-stage-pipeline-refactor.md](4_stage_pipeline_refactor.md) — 4-stage pipeline refactor

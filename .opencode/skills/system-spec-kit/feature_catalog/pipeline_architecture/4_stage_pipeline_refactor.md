...
- Feature file path: `pipeline_architecture/4_stage_pipeline_refactor.md`
Related references:
- [mpab-chunk-to-memory-aggregation.md](mpab_chunk_to_memory_aggregation.md) — MPAB chunk-to-memory aggregation

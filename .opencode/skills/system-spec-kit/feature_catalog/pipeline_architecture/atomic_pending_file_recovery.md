...
- Feature file path: `pipeline_architecture/atomic_pending_file_recovery.md`
Related references:
- [7-layer-tool-architecture-metadata.md](7_layer_tool_architecture_metadata.md) — 7-layer tool architecture metadata
- [lineage-state-active-projection-and-asof-resolution.md](lineage_state_active_projection_and_asof_resolution.md) — Lineage state active projection and asOf resolution

...
- Feature file path: `pipeline_architecture/validation_signals_as_retrieval_metadata.md`
Related references:
- [template-anchor-optimization.md](template_anchor_optimization.md) — Template anchor optimization
- [learned-relevance-feedback.md](learned_relevance_feedback.md) — Learned relevance feedback

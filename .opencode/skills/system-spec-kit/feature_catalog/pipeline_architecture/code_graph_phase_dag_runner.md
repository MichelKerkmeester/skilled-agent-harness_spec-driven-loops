...
- Feature file path: `pipeline_architecture/code_graph_phase_dag_runner.md`
...
Related references:
- [phase-017-maintainability-extracts.md](phase_017_maintainability_extracts.md) — Maintainability extracts
- [stress-test-cycle.md](stress_test_cycle.md) — Stress test cycle

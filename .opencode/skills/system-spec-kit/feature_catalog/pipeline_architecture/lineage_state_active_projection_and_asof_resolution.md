...
- Feature file path: `pipeline_architecture/lineage_state_active_projection_and_asof_resolution.md`

Related references:
- [atomic-pending-file-recovery.md](atomic_pending_file_recovery.md) — Atomic pending-file recovery
- [mcp-server-public-api-barrel.md](mcp_server_public_api_barrel.md) — MCP Server Public API Barrel

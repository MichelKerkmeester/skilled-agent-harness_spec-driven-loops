...
trigger_phrases:
  - "retired runtime shims"
  - "inert compatibility flags"
...
- Feature file path: `implement_and_remove_deprecated_features/category_stub.md`
Related references:
- [lazy-loading-migration-and-warmup-compatibility.md](lazy_loading_migration_and_warmup_compatibility.md) — Lazy-loading migration and warmup compatibility

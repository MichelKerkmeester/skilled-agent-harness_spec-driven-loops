...
- Feature file path: `implement_and_remove_deprecated_features/lazy_loading_migration_and_warmup_compatibility.md`
Related references:
- [category-stub.md](category_stub.md) — Retired runtime shims and inert compatibility flags

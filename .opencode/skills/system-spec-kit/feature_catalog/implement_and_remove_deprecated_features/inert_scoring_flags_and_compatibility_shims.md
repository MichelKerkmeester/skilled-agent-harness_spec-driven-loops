...
### Novelty Boost as Inert Compatibility Surface
...
- Feature file path: `implement_and_remove_deprecated_features/inert_scoring_flags_and_compatibility_shims.md`
Related references:
- [shadow-scoring-retirement.md](shadow_scoring_retirement.md) — Shadow-scoring retirement
- [adaptive-fusion-flag-drift.md](adaptive_fusion_flag_drift.md) — Adaptive-fusion mode flag

...
- Feature file path: `evaluation_and_measurement/core_metric_computation.md`
Related references:
- [evaluation-database-and-schema.md](evaluation_database_and_schema.md) — Evaluation database and schema

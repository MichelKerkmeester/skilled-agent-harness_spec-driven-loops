...
| File | Type | Role |
|---|---|---|
| `mcp_server/tests/retrieval-telemetry.vitest.ts` | Automated test | Quality proxy telemetry computation |
...
- Feature file path: `evaluation_and_measurement/quality_proxy_formula.md`
Related references:
- [observer-effect-mitigation.md](observer_effect_mitigation.md) — Observer effect mitigation
- [synthetic-ground-truth-corpus.md](synthetic_ground_truth_corpus.md) — Synthetic ground truth corpus

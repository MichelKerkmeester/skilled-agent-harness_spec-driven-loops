...
- Feature file path: `evaluation_and_measurement/evaluation_api_surface.md`
Related references:
- [cross-ai-validation-fixes.md](cross_ai_validation_fixes.md) — Cross-AI validation fixes

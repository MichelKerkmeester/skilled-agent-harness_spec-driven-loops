...
- Feature file path: `evaluation_and_measurement/agent_consumption_instrumentation.md`
Related references:
- [bm25-only-baseline.md](bm25_only_baseline.md) — BM25-only baseline
- [scoring-observability.md](scoring_observability.md) — Scoring observability

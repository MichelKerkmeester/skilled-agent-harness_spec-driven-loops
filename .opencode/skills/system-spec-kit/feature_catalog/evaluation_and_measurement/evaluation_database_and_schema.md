...
- Feature file path: `evaluation_and_measurement/evaluation_database_and_schema.md`
- Source list updated 2026-03-25 per deep review

Related references:
- [core-metric-computation.md](core_metric_computation.md) — Core metric computation

...
- Feature file path: `discovery/health_diagnostics_memoryhealth.md`
Related references:
- [system-statistics-memorystats.md](system_statistics_memorystats.md) — System statistics (memory_stats)
- [detect-changes-preflight.md](detect_changes_preflight.md) — detect_changes preflight (Code Graph)

...
- Feature file path: `discovery/session_health_shared_payload.md`
Related references:
- [session-resume-continuity-ladder.md](session_resume_continuity_ladder.md) — Session resume continuity ladder

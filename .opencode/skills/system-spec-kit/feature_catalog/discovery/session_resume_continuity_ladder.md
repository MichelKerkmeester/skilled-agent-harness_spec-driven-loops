...
- Feature file path: `discovery/session_resume_continuity_ladder.md`
Related references:
...
- [session-health-shared-payload.md](session_health_shared_payload.md) — Session health shared payload

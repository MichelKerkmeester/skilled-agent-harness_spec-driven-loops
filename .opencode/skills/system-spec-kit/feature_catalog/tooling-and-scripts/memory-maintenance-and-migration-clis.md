...
Related references:
- [spec-validation-rule-engine.md](spec-validation-rule-engine.md) — Spec Validation Rule Engine
- [core-workflow-infrastructure.md](core-workflow-infrastructure.md) — Core Workflow Infrastructure

...
- See feature catalog entry `memory-quality-and-indexing/post-save-quality-review.md` for full specification.
...
- Feature file path: `tooling-and-scripts/json-mode-hybrid-enrichment.md`

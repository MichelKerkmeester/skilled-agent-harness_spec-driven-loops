...
Related references:
- [tree-thinning-for-spec-folder-consolidation.md](tree-thinning-for-spec-folder-consolidation.md) — Tree thinning for spec folder consolidation
- [progressive-validation-for-spec-documents.md](progressive-validation-for-spec-documents.md) — Progressive validation for spec documents

...
| File | Type | Role |
|---|---|---|
| `.opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/mcp-daemon-rebuild-restart-live-probe.md` | Manual playbook | Playbook scenario 278 covering source diff, targeted vitest, dist marker check, runtime restart, and live probe verification |

...
- Feature file path: `tooling-and-scripts/spec-folder-detection-and-description.md`
Related references:
- [session-extraction-and-enrichment.md](session-extraction-and-enrichment.md) — Session Extraction and Enrichment

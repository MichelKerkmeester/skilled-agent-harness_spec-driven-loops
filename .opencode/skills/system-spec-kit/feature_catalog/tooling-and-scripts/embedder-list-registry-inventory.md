...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/embedder-list-registry-inventory.md` | Manual playbook | Playbook scenario 281 covering the operator-facing list output and active-embedder identification |
...
- Feature file path: `tooling-and-scripts/embedder-list-registry-inventory.md`
Related references:

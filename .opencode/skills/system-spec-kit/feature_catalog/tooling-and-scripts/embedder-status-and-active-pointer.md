...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/embedder-status-job-and-active-pointer.md` | Manual playbook | Playbook scenario 283 covering active pointer output and unknown job ID handling |

...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/graph-degraded-stress-cell-isolation.md` | Manual playbook | Playbook scenario 279 covering bucket routing, live-DB byte-equality, and suite runtime budget |

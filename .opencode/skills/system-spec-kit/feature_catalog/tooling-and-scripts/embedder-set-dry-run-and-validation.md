...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/embedder-set-dry-run-and-validation.md` | Manual playbook | Playbook scenario 282 covering dry-run plan output, invalid-name handling, and active-pointer no-op |
...
- Feature file path: `tooling-and-scripts/embedder-set-dry-run-and-validation.md`
Related references:
- [embedder-list-registry-inventory.md](embedder-list-registry-inventory.md) — Embedder list registry inventory

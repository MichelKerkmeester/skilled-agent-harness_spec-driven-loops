...
- Feature file path: `context_preservation/session_start_priming.md`
Related references:
- [precompact-hook.md](precompact_hook.md) — PreCompact hook context caching
- [stop-token-tracking.md](stop_token_tracking.md) — Stop hook token tracking

...
Related references:
- [category-overview.md](category_overview.md) — Context preservation and code graph
- [session-start-priming.md](session_start_priming.md) — SessionStart priming (Claude)

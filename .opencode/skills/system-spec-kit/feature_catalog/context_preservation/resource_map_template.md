...
| `feature_catalog/context_preservation/resource_map_template.md` | Feature catalog | This feature entry for ongoing discovery |
| `manual_testing_playbook/context_preservation/resource_map_template.md` | Playbook | Manual verification scenario for the rollout |
...
- Feature file path: `context_preservation/resource_map_template.md`
Related references:
- [tool-routing-enforcement.md](tool_routing_enforcement.md) — Tool routing enforcement

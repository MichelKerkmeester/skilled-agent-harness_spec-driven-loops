...
- Feature file path: `context_preservation/session_health_tool.md`
Related references:
- [mcp-auto-priming.md](mcp_auto_priming.md) — MCP auto-priming
- [session-resume-tool.md](session_resume_tool.md) — Session resume tool

...
Phase 005 split code-graph-owned category-22 docs into the sibling skill. For the code-graph feature pages that moved, see `.opencode/skills/system-code-graph/feature_catalog/context_preservation/`; for code-graph manual scenarios, see `.opencode/skills/system-code-graph/manual_testing_playbook/context_preservation/`. Shared hook, runtime, budget, routing, skill-graph, and coverage-graph pages remain here.
...
- Feature file path: `context_preservation/category_overview.md`
Related references:

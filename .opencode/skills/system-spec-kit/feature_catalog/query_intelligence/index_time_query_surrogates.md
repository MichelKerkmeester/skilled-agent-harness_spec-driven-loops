...
- Feature file path: `query_intelligence/index_time_query_surrogates.md`
Related references:
- [hyde-hypothetical-document-embeddings.md](hyde_hypothetical_document_embeddings.md) — HyDE (Hypothetical Document Embeddings)

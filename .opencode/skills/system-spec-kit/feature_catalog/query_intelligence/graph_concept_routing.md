...
- Feature file path: `query_intelligence/graph_concept_routing.md`
Related references:
- [query-decomposition.md](query_decomposition.md) — Query decomposition
- [graph-channel-preservation.md](graph_channel_preservation.md) — Graph channel preservation

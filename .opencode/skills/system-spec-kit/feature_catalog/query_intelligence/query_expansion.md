...
- Feature file path: `query_intelligence/query_expansion.md`
Related references:
- [dynamic-token-budget-allocation.md](dynamic_token_budget_allocation.md) — Dynamic token budget allocation
- [llm-query-reformulation.md](llm_query_reformulation.md) — LLM query reformulation

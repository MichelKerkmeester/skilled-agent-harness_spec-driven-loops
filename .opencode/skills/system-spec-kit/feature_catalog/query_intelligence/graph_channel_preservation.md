...
- Related entries: `query_intelligence/query_complexity_router.md` (tier classifier — unchanged here, override sits above it), `query_intelligence/graph_concept_routing.md` (graph traversal algorithm — unchanged here), `discovery/health_diagnostics_memoryhealth.md` (surfaces the new `data.routing` block)
Related references:

...
- Feature file path: `query_intelligence/channel_min_representation.md`
Related references:
- [query-complexity-router.md](query_complexity_router.md) — Query complexity router
- [confidence-based-result-truncation.md](confidence_based_result_truncation.md) — Confidence-based result truncation

...
The playbook-side viewpoint lives in `manual_testing_playbook/14--stress-testing/`. The pipeline-architecture catalog peer at `feature_catalog/14--pipeline-architecture/187-stress-test-cycle.md` documents the cycle as a pipeline feature; this category overview keeps the stress-testing inventory entry intact so the catalog and playbook stay structurally parallel.
...
| `feature_catalog/14--pipeline-architecture/187-stress-test-cycle.md` | Catalog peer | Pipeline-side feature entry that documents the cycle as a release pattern |
...
- Feature file path: `14--stress-testing/162-category-overview.md`

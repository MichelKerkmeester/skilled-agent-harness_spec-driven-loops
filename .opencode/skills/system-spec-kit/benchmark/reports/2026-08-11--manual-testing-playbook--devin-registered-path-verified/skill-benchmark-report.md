...
| Executor / model | node / — (devin-registered-path-verified) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| ux-hooks-directive-lifecycle-dedup | manual | registered-path | — | PASS: Registered Devin path passed native payload/envelope cadence, malformed post-compaction invalidation, lifecycle bridge, and durable provenance gates. |

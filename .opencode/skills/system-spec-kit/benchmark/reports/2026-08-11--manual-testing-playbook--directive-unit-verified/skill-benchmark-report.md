...
| Executor / model | vitest / — (directive-unit-verified) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| ux-hooks-directive-lifecycle-dedup | manual | unit | — | PASS: Canonical unit lane passed high-water, unknown evidence, generation/epoch, deferred receipt, directory-anchored topology, cleanup, contention, and rollback behavior. |

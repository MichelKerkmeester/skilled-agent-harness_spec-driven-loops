...
| Executor / model | — / — (cursor-native-host) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| ux-hooks-directive-lifecycle-dedup | manual | native-host | — | SKIP: Installed Cursor CLI does not live-fire beforeSubmitPrompt in the tested build; adapter cadence passes but native-host delivery remains dormant and unconfirmed. |

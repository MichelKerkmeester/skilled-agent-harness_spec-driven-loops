# 2026-08-11--manual-testing-playbook--pi-repeat-suppression-verified

> system-spec-kit · doc · vitest · pi-repeat-suppression-verified
...
| Trace mode | doc |
| Executor | vitest |
| Model | not recorded (pi-repeat-suppression-verified) |
| Scenarios | 1 |

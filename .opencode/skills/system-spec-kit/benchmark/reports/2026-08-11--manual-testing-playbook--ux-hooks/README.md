# 2026-08-11--manual-testing-playbook--ux-hooks

> system-spec-kit · doc · opencode · opencode-go/deepseek-v4-flash · ux-hooks
...
| Trace mode | doc |
| Executor | opencode |
| Model | opencode-go/deepseek-v4-flash (ux-hooks) |
| Scenarios | 1 |

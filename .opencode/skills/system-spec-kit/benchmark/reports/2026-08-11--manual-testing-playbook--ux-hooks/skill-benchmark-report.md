...
| Executor / model | opencode / opencode-go/deepseek-v4-flash (ux-hooks) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| ux-hooks-directive-lifecycle-dedup | manual | documentation | — | PASS: Live plugin transform via spawnOverride seam: turn1 full, turn2 route-only, session.compacted re-delivers full, kill-switch full every turn, __global__ fails open full; automated lane vitest 38/38 |

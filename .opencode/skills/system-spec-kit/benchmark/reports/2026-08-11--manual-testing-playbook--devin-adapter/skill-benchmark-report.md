...
| Executor / model | node / — (devin-adapter) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| ux-hooks-directive-lifecycle-dedup | manual | registered-adapter | — | PASS: Registered Devin adapter produced full, route-only, and shrink-boundary full delivery with native payload and envelope shapes. |

...
| Executor / model | node / — (cursor-adapter) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| ux-hooks-directive-lifecycle-dedup | manual | registered-adapter | — | PASS: Registered Cursor adapter produced full, route-only, and shrink-boundary full delivery with its native payload and agent_message envelope. |

...
| Executor / model | vitest / — (pi-adapter-suite) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| ux-hooks-directive-lifecycle-dedup | manual | adapter-suite | — | PASS: Pi dispatch suite passed first-full, repeat suppression, lifecycle re-arm, fail-open, kill-switch, and session-isolation behavior. |

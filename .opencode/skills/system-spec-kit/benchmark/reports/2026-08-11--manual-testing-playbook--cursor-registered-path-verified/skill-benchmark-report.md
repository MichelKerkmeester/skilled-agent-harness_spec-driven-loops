...
| Executor / model | node / — (cursor-registered-path-verified) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| ux-hooks-directive-lifecycle-dedup | manual | registered-path | — | PASS: Registered Cursor path passed native payload/agent_message cadence, failure handling, lifecycle bridge, and durable provenance gates; native host delivery is separate. |

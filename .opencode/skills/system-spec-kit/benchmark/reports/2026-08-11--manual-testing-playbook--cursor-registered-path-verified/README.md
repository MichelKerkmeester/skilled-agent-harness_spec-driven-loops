# 2026-08-11--manual-testing-playbook--cursor-registered-path-verified

> system-spec-kit · doc · node · cursor-registered-path-verified
...
| Trace mode | doc |
| Executor | node |
| Model | not recorded (cursor-registered-path-verified) |
| Scenarios | 1 |

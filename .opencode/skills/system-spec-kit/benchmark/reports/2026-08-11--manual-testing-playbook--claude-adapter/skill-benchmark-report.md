...
| Captured at | 2026-08-11T15:55:00.000Z |
| Active manifest | `—` · digest `—` |
| Engine resolver | `—` |
| Source report digest | `—` |
| Executor / model | node / — (claude-adapter) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| ux-hooks-directive-lifecycle-dedup | manual | registered-adapter | — | PASS: Registered Claude adapter produced full, route-only, and shrink-boundary full delivery with its native additionalContext envelope. |

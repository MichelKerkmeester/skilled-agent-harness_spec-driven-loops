...
description: "Code-facing README for .opencode/skills/system-spec-kit/runtime/tests/validation."
trigger_phrases:
  - "system-spec-kit runtime/tests/validation"
  - "code README"
---
...
This README documents the code-bearing folder `.opencode/skills/system-spec-kit/runtime/tests/validation` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/system-spec-kit/runtime/tests/validation
```
...
|---|---|
| Folder boundary | Documents direct code files under `runtime/tests/validation`. |
...
```text
User request: Check .opencode/skills/system-spec-kit/runtime/tests/validation for sk-code and README coverage.

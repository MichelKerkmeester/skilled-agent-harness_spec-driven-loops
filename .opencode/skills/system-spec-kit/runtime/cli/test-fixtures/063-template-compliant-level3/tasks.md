...
- [x] T002 Read existing fixture 063 files (`.opencode/skills/system-spec-kit/runtime/cli/test-fixtures/063-template-compliant-level3/`) [5m]
- [x] T003 Confirm fixture 054 remains intentionally broken (`.opencode/skills/system-spec-kit/runtime/cli/test-fixtures/054-template-extra-header/spec.md`) [2m]
...
### Integration Tests
- [x] T015 Run strict validation (`bash .opencode/skills/system-spec-kit/runtime/cli/spec/validate.sh .opencode/skills/system-spec-kit/runtime/cli/test-fixtures/063-template-compliant-level3 --strict`) [5m] {deps: T014}

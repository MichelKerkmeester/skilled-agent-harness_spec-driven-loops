...
| File | Action | Purpose |
|------|--------|---------|
| .opencode/skills/system-spec-kit/runtime/cli/test-fixtures/071-comment-hygiene-marker-violation/spec.md | Added | Supplies marker violation fixture content |
<!-- /ANCHOR:what-built -->

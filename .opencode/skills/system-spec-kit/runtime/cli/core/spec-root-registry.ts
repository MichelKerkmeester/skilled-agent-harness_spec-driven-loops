...
export const SPEC_ROOT_RESOLVERS = [
  ...
  {
    file: 'runtime/cli/continuity/generate-context.ts:193-230,269-380,531-549,785-799',
    symbol:
  ...
  {
    file: 'runtime/lib/resume/resume-ladder.ts:863-910',
  ...
  {
    file: 'runtime/lib/continuity/authored-continuity-snapshot.ts:50-70',
  ...
  {
    file: 'runtime/api/graph-refresh.ts:19-55',

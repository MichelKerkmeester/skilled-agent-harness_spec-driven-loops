...
│ dist/continuity caller   │      │ save orchestration   │
└──────────────────────┘      └──────────┬───────────┘
                                          │
                       ┌──────────────────┼──────────────────┐
                       ▼                  ▼                  ▼
...
```text
core helper modules -> dist compiled output
lib utilities -> workflow.ts
...
| `runtime/cli/dist/continuity/generate-context.js` | CLI script | Primary caller for core workflow behavior. |

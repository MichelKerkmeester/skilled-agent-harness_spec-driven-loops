...
USAGE:
  node runtime/cli/dist/ops/process-sweep.js plan [--pretty]
  node runtime/cli/dist/ops/process-sweep.js fixture [--pretty]
  node runtime/cli/dist/ops/process-sweep.js apply [--pretty]

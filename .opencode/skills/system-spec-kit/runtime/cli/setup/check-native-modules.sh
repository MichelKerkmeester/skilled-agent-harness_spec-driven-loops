...
# Run from spec-kit root: bash runtime/cli/setup/check-native-modules.sh
set -euo pipefail
...
echo "-- Summary --"
echo ""
echo "If any modules FAILED, run: bash runtime/cli/setup/rebuild-native-modules.sh" >&2

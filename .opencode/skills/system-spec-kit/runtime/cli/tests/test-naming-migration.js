...
const LEGACY_SNAKE_CASE_FUNCTION_BUDGET = new Map([
  ['runtime/lib/search/vector-index-impl.ts', 75],
  ['runtime/lib/search/vector-index-aliases.ts', 8],
  ['runtime/lib/search/vector-index-mutations.ts', 10],
  ['runtime/lib/search/vector-index-queries.ts', 30],
  ['runtime/lib/search/vector-index-schema.ts', 9],
  ['runtime/lib/search/vector-index-store.ts', 26],
  ['runtime/lib/search/vector-index-types.ts', 4],
  ['runtime/lib/learning/corrections.ts', 19],
]);

const CROSS_REFERENCE_MISMATCH_BUDGET = new Map([
  ['runtime/cli.ts', 2],
  ['runtime/context-server.ts', 1],
  ['runtime/formatters/search-results.ts', 1],
  ['runtime/handlers/chunking-orchestrator.ts', 2],
  ['runtime/handlers/index.ts', 34],
  ['runtime/handlers/memory-context.ts', 3],
  ['runtime/handlers/memory-crud-update.ts', 1],
  ...
  ['runtime/lib/feedback/shadow-scoring.ts', 11],
  ['runtime/lib/governance/scope-governance.ts', 5],
  ['runtime/lib/graph/community-detection.ts', 2],
  ['runtime/lib/graph/community-storage.ts', 1],
  ['runtime/lib/learning/corrections.ts', 6],
  ['runtime/lib/ops/job-queue.ts', 3],
  ['runtime/lib/parsing/memory-parser.ts', 3],
  ['runtime/lib/scoring/confidence-tracker.ts', 1],
  ['runtime/lib/search/auto-promotion.ts', 2],
  ['runtime/lib/search/bm25-index.ts', 3],
  ['runtime/lib/search/causal-boost.ts', 1],
  ['runtime/lib/search/chunk-reassembly.ts', 2],
  ['runtime/lib/search/graph-search-fn.ts', 2],
  ['runtime/lib/search/hybrid-search.ts', 3],
  ['runtime/lib/search/learned-feedback.ts', 1],
  ['runtime/lib/search/pipeline/stage2-fusion.ts', 3],
  ['runtime/lib/search/vector-index-aliases.ts', 4],
  ['runtime/lib/search/vector-index-mutations.ts', 1],
  ['runtime/lib/search/vector-index-schema.ts', 18],
...
function t2RuntimeImports() {
  ...
  const files = walkFiles(RUNTIME_ROOT, '.js').filter((filePath) => {
    ...
    return !normalized.includes('/tests/') &&
      ...
      !normalized.includes('/runtime/cli/dist/');
  });

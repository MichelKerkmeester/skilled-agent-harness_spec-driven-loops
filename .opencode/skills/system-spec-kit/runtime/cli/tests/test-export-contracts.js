...
const BARREL_FILES = [
  {
    file: 'runtime/cli/dist/core/index.js',
    root: SCRIPTS_ROOT,
    expectedKeys: [], // config re-exports vary; just check non-empty
    minExports: 1,
  },
  {
    file: 'runtime/cli/dist/extractors/index.js',
    root: SCRIPTS_ROOT,
    expectedKeys: [],
    minExports: 3,
  },
  {
    file: 'runtime/cli/dist/loaders/index.js',
    root: SCRIPTS_ROOT,
    expectedKeys: ['loadCollectedData'],
    minExports: 1,
  },
  {
    file: 'runtime/cli/dist/renderers/index.js',
    root: SCRIPTS_ROOT,
    expectedKeys: ['populateTemplate', 'renderTemplate'],
    minExports: 2,
  },
  {
    file: 'runtime/cli/dist/spec-folder/index.js',
    root: SCRIPTS_ROOT,
    expectedKeys: ['detectSpecFolder', 'setupContextDirectory'],
    minExports: 3,
  },
  {
    file: 'runtime/cli/dist/utils/index.js',
    root: SCRIPTS_ROOT,
    expectedKeys: [],
    minExports: 3,
  },

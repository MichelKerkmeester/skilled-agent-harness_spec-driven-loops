...
- Template: `.opencode/skills/system-spec-kit/templates/stress-test/findings-rubric.template.json`
- Companion findings template: `.opencode/skills/system-spec-kit/templates/stress-test/findings.template.md`

...
| `/spec_kit:deep-research` | N/A | Autonomous research loop with convergence detection plus bounded `spec.md` anchoring under [spec_check_protocol.md](../deep-research/references/spec_check_protocol.md) |

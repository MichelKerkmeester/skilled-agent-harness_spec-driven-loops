...
`@multi-ai-council` is planning-only. It returns a council report and cannot write, edit, patch, or run shell commands. The dispatching parent owns persistence by invoking `.opencode/skills/system-spec-kit/scripts/multi-ai-council/persist-artifacts.cjs` after the report is captured.
...
```bash
node .opencode/skills/system-spec-kit/scripts/multi-ai-council/advise-council-completion.cjs "$PACKET"
```
...
- Agent body §16: `.opencode/agents/multi-ai-council.md`
- Output schema: `.opencode/skills/system-spec-kit/references/multi-ai-council/output-schema.md`
- State format: `.opencode/skills/system-spec-kit/references/multi-ai-council/state-format.md`
- Persistence helper: `.opencode/skills/system-spec-kit/scripts/multi-ai-council/persist-artifacts.cjs`

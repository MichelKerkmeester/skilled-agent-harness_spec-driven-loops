...
| [template-guide.md](../templates/template-guide.md) | Template usage and customization |
| [folder-structure.md](../structure/folder-structure.md) | Spec folder organization |

...
- [ ] Adds a one-line citation: `Setup contract: see references/workflows/auto-mode-contract.md`
...
- `/deep:review` (prototype) — see `.../103/001-deep-review-three-tier-setup/`
...
- Commands without paired YAML workflows (`/prompt`, `agent_router`, etc.) — they have no setup-phase surface where the contract applies.

...
Use these templates for packet-local changelog generation. Do not reuse the global `.opencode/skills/sk-doc/assets/documentation/changelog_template.md` for nested packet output.

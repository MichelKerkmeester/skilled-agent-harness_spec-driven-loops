...
The sibling families for the other daemons (`SPECKIT_CODE_INDEX_CLI_*`, `SYSTEM_SKILL_ADVISOR_CLI_*`, `SYSTEM_SKILL_ADVISOR_TRUST_DEFAULT`) are documented in `mcp-server/ENV-REFERENCE.md`.

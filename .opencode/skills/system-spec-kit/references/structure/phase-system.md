...
- [phase-definitions.md](phase-definitions.md) -- Full phase taxonomy, detection scoring, and lifecycle rules
- [phase-checklists.md](../validation/phase-checklists.md) -- Phase-specific validation checklists
- [sub-folder-versioning.md](sub-folder-versioning.md) -- Sub-folder versioning (distinct from phase decomposition)
- [quick-reference.md](../workflows/quick-reference.md) -- Phase workflow shortcuts and decision tables

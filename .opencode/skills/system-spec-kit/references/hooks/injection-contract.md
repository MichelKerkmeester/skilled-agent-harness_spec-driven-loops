...
- **Owning module:** `cli-external-orchestration/cli-opencode/scripts/lib/dispatch-rule-checks.mjs`.
...
- **Owning module:** `mcp-code-mode/runtime/lib/mcp-route-guard.cjs`.
...
- **Owning module:** `system-deep-loop/runtime/lib/deep-loop/...` dispatch-guard core.
...
- **Owning module:** `sk-code/code-quality/scripts/lib/post-edit-router.cjs`.

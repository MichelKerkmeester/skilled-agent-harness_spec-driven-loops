...
This reference describes the current prompt-time Skill Advisor integrations. The primary routing implementation is the native TypeScript package at `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/`; Python remains as a compatibility fallback through `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py`.
...
printf '%s' "save this context" | python3 .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py --stdin
```
...
See `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/manual_testing_playbook/manual_testing_playbook.md`.

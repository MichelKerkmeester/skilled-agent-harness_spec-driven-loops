...
> **Source of truth for template LOC counts:** [level-specifications.md](./level-specifications.md)
...
- [template-guide.md](./template-guide.md) - Template selection and adaptation

...
- Feature file path: `08--cupt-attachments/042-upload-file.md`
Related references:
- [041-list-attachments.md](041-list-attachments.md) — List Attachments
- [043-download-file.md](043-download-file.md) — Download File

...
- Feature file path: `13--mcp-low-priority/079-use-template.md`
Related references:
- [078-get-dependencies.md](078-get-dependencies.md) — clickup_get_task_dependencies
- [080-manage-chat.md](080-manage-chat.md) — clickup_manage_chat

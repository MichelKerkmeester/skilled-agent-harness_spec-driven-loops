...
- Feature file path: `12--mcp-medium-priority/073-create-document.md`
Related references:
- [072-get-views.md](072-get-views.md) — clickup_get_views
- [074-get-document.md](074-get-document.md) — clickup_get_document

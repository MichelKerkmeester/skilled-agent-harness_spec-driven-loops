...
- Feature file path: `12--mcp-medium-priority/063-multi-list.md`
Related references:
- [062-create-task-link.md](062-create-task-link.md) — clickup_create_task_link
- [064-task-attachments.md](064-task-attachments.md) — clickup_manage_task_attachments

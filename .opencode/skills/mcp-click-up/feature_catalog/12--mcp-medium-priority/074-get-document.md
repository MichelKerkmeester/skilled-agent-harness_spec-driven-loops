...
- Feature file path: `12--mcp-medium-priority/074-get-document.md`
Related references:
- [073-create-document.md](073-create-document.md) — clickup_create_document
- [075-update-document.md](075-update-document.md) — clickup_update_document

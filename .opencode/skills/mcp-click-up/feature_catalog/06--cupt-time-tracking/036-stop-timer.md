...
- Feature file path: `06--cupt-time-tracking/036-stop-timer.md`
Related references:
- [035-start-timer.md](035-start-timer.md) — Start Timer
- [037-log-manual.md](037-log-manual.md) — Log Time Manually

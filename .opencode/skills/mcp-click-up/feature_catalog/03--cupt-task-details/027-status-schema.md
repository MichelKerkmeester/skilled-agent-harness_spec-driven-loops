...
- Feature file path: `03--cupt-task-details/027-status-schema.md`
Related references:
- [026-task-context.md](026-task-context.md) — Task Context
- [028-status-by-list.md](028-status-by-list.md) — Status Schema by List

...
See [`01--cupt-authentication/001-interactive-auth.md`](01--cupt-authentication/001-interactive-auth.md)

### Direct token
`cupt config --api-token pk_xxx` — set Personal API Token non-interactively. Token must start with `pk_`.

See [`01--cupt-authentication/002-direct-token.md`](01--cupt-authentication/002-direct-token.md)

### Workspace default
`cupt config --workspace-id <id>` — persist a default workspace ID for all subsequent commands.

See [`01--cupt-authentication/003-workspace-default.md`](01--cupt-authentication/003-workspace-default.md)

### List default
`cupt config --default-list <id>` — persist a default list ID.

See [`01--cupt-authentication/004-list-default.md`](01--cupt-authentication/004-list-default.md)

### Show config
`cupt config --show` — display workspace, default list, and masked auth state.

See [`01--cupt-authentication/005-show-config.md`](01--cupt-authentication/005-show-config.md)

### Clear cache
`cupt config --clear-cache` — remove all locally cached task data.

See [`01--cupt-authentication/006-clear-cache.md`](01--cupt-authentication/006-clear-cache.md)

### Auth status
`cupt status` — workspace name, user, and auth health check. Use as preflight before starting any agent workflow.

See [`01--cupt-authentication/007-auth-status.md`](01--cupt-authentication/007-auth-status.md)

### Logout
`cupt logout` — revoke stored credentials and clear the local cache.

See [`01--cupt-authentication/008-logout.md`](01--cupt-authentication/008-logout.md)
...
See [`02--cupt-task-listing/009-list-assigned.md`](02--cupt-task-listing/009-list-assigned.md)

### Filter today
`cupt list --today` — tasks due today only.

See [`02--cupt-task-listing/010-filter-today.md`](02--cupt-task-listing/010-filter-today.md)

### Filter week
`cupt list --week` — tasks due within the current week.

See [`02--cupt-task-listing/011-filter-week.md`](02--cupt-task-listing/011-filter-week.md)

### Filter overdue
`cupt list --overdue` — past-due tasks only.

See [`02--cupt-task-listing/012-filter-overdue.md`](02--cupt-task-listing/012-filter-overdue.md)

### Filter by tag
`cupt list --tag <name>` — server-side filter (fast). Multiple `--tag` flags use AND logic: task must carry all specified tags.

See [`02--cupt-task-listing/013-filter-tag.md`](02--cupt-task-listing/013-filter-tag.md)

### Exclude by tag
`cupt list --no-tag <name>` — exclude tasks carrying the specified tag. Useful for filtering out already-processed work.

See [`02--cupt-task-listing/014-exclude-tag.md`](02--cupt-task-listing/014-exclude-tag.md)
...
See [`03--cupt-task-details/023-show-task.md`](03--cupt-task-details/023-show-task.md)

### Show with notes
`cupt show <id> --notes` — appends all comments below the task detail output.

See [`03--cupt-task-details/024-show-notes.md`](03--cupt-task-details/024-show-notes.md)

### Show offline
`cupt show <id> --offline` — returns cached task data without network call.

See [`03--cupt-task-details/025-show-offline.md`](03--cupt-task-details/025-show-offline.md)
...
See [`03--cupt-task-details/026-task-context.md`](03--cupt-task-details/026-task-context.md)
...
See [`03--cupt-task-details/027-status-schema.md`](03--cupt-task-details/027-status-schema.md)
...
See [`03--cupt-task-details/028-status-by-list.md`](03--cupt-task-details/028-status-by-list.md)
...
See [`04--cupt-task-completion/029-mark-complete.md`](04--cupt-task-completion/029-mark-complete.md)

### Dry-run preview
`cupt done <id> --dry-run` — shows which status would be applied without writing. Required before any batch completion loop.

See [`04--cupt-task-completion/030-dry-run.md`](04--cupt-task-completion/030-dry-run.md)

### Complete with note
`cupt done <id> --note "<text>"` — marks complete and adds a comment in one call. Preferred for agent handoff patterns.

See [`04--cupt-task-completion/031-complete-with-note.md`](04--cupt-task-completion/031-complete-with-note.md)

### Auto-note
`cupt done <id> --auto-note` — uses local AI (if configured) to draft a completion note automatically.

See [`04--cupt-task-completion/032-auto-note.md`](04--cupt-task-completion/032-auto-note.md)
...
See [`05--cupt-notes-comments/033-add-comment.md`](05--cupt-notes-comments/033-add-comment.md)

### List comments
`cupt notes <id>` — displays all comments on the task in chronological order with author and timestamp.

See [`05--cupt-notes-comments/034-list-comments.md`](05--cupt-notes-comments/034-list-comments.md)
...
See [`06--cupt-time-tracking/035-start-timer.md`](06--cupt-time-tracking/035-start-timer.md)

### Stop timer
`cupt time stop` — stops the currently running timer and logs the elapsed time to ClickUp automatically.

See [`06--cupt-time-tracking/036-stop-timer.md`](06--cupt-time-tracking/036-stop-timer.md)

### Log manually
`cupt time add <id> <duration>` — log time retroactively without using a timer. Duration formats: `1h30m`, `45m`, `2h`, `30m`.

See [`06--cupt-time-tracking/037-log-manual.md`](06--cupt-time-tracking/037-log-manual.md)

### Timer status
`cupt time status` — shows running task name + elapsed time, or "no timer running" when idle.

See [`06--cupt-time-tracking/038-timer-status.md`](06--cupt-time-tracking/038-timer-status.md)
...
See [`07--cupt-tag-management/039-add-tag.md`](07--cupt-tag-management/039-add-tag.md)

### Remove tag
`cupt tag remove <id> <name>` — removes a named tag from the task.

See [`07--cupt-tag-management/040-remove-tag.md`](07--cupt-tag-management/040-remove-tag.md)
...
See [`08--cupt-attachments/041-list-attachments.md`](08--cupt-attachments/041-list-attachments.md)

### Upload file
`cupt attach add <id> <file>` — uploads a local file as a task attachment.

See [`08--cupt-attachments/042-upload-file.md`](08--cupt-attachments/042-upload-file.md)

### Download file
`cupt attach get <id> <selector>` — downloads an attachment by index number or partial name match.

See [`08--cupt-attachments/043-download-file.md`](08--cupt-attachments/043-download-file.md)
...
See [`09--cupt-workspace/044-list-teams.md`](09--cupt-workspace/044-list-teams.md)

### Task summary
`cupt summary` — generates a workspace-wide overview of task counts and status distribution.

See [`09--cupt-workspace/045-task-summary.md`](09--cupt-workspace/045-task-summary.md)

### Prefetch cache
`cupt prefetch` — eagerly downloads and caches task details. Enables all `--offline` flags without prior `cupt list`.

See [`09--cupt-workspace/046-prefetch.md`](09--cupt-workspace/046-prefetch.md)
...
See [`10--cupt-global-flags/047-json-flag.md`](10--cupt-global-flags/047-json-flag.md)

### Offline mode flag
`--offline` — uses local cache instead of the API on `list` and `show` commands. Requires prior caching.

See [`10--cupt-global-flags/048-offline-flag.md`](10--cupt-global-flags/048-offline-flag.md)

### Debug logging flag
`--debug` — enables verbose internal logs for troubleshooting auth, API calls, and cache misses.

See [`10--cupt-global-flags/049-debug-flag.md`](10--cupt-global-flags/049-debug-flag.md)

### Version flag
`--version` — prints the installed cupt version string (e.g. `cupt 0.7.1`).

See [`10--cupt-global-flags/050-version-flag.md`](10--cupt-global-flags/050-version-flag.md)
...
See [`11--mcp-high-priority/058-create-bulk-tasks.md`](11--mcp-high-priority/058-create-bulk-tasks.md)
...
See [`12--mcp-medium-priority/059-update-bulk-tasks.md`](12--mcp-medium-priority/059-update-bulk-tasks.md)

### clickup_create_subtask
Create a subtask under a parent task. Requires `parent_task_id` and `name`.

See [`12--mcp-medium-priority/060-create-subtask.md`](12--mcp-medium-priority/060-create-subtask.md)
...
See [`12--mcp-medium-priority/061-task-dependencies.md`](12--mcp-medium-priority/061-task-dependencies.md)

### clickup_create_task_link
Create a non-dependency link between two tasks (e.g. "related to").

See [`12--mcp-medium-priority/062-create-task-link.md`](12--mcp-medium-priority/062-create-task-link.md)

### clickup_add_task_to_multiple_lists
Add an existing task to additional lists without duplicating it.

See [`12--mcp-medium-priority/063-multi-list.md`](12--mcp-medium-priority/063-multi-list.md)
...
See [`12--mcp-medium-priority/064-task-attachments.md`](12--mcp-medium-priority/064-task-attachments.md)

### clickup_manage_lists
Create, update, or delete lists within a space or folder.

See [`12--mcp-medium-priority/065-manage-lists.md`](12--mcp-medium-priority/065-manage-lists.md)

### clickup_manage_spaces
Create, update, or delete spaces within the workspace.

See [`12--mcp-medium-priority/066-manage-spaces.md`](12--mcp-medium-priority/066-manage-spaces.md)

### clickup_manage_folders
Create, update, or delete folders within a space.

See [`12--mcp-medium-priority/067-manage-folders.md`](12--mcp-medium-priority/067-manage-folders.md)

### clickup_manage_custom_fields
Create or update custom field definitions for a list.

See [`12--mcp-medium-priority/068-custom-fields.md`](12--mcp-medium-priority/068-custom-fields.md)

### clickup_add_tag_to_task
Add a tag to a task via MCP. Functionally equivalent to `cupt tag add`.

See [`12--mcp-medium-priority/069-add-tag.md`](12--mcp-medium-priority/069-add-tag.md)

### clickup_remove_tag_from_task
Remove a tag from a task via MCP. Functionally equivalent to `cupt tag remove`.

See [`12--mcp-medium-priority/070-remove-tag.md`](12--mcp-medium-priority/070-remove-tag.md)

### clickup_manage_space_tags
Create or update workspace-level tag definitions in a space.

See [`12--mcp-medium-priority/071-space-tags.md`](12--mcp-medium-priority/071-space-tags.md)

### clickup_get_views
List all views (list view, board, calendar, etc.) for a workspace, space, or list.

See [`12--mcp-medium-priority/072-get-views.md`](12--mcp-medium-priority/072-get-views.md)
...
See [`12--mcp-medium-priority/073-create-document.md`](12--mcp-medium-priority/073-create-document.md)

### clickup_get_document
Get document details by document ID.

See [`12--mcp-medium-priority/074-get-document.md`](12--mcp-medium-priority/074-get-document.md)

### clickup_update_document
Update an existing document's name or content.

See [`12--mcp-medium-priority/075-update-document.md`](12--mcp-medium-priority/075-update-document.md)
...
See [`12--mcp-medium-priority/076-time-tracking.md`](12--mcp-medium-priority/076-time-tracking.md)

### clickup_manage_goals
Create, update, or delete goals and OKRs. Requires workspace-level team ID.

See [`12--mcp-medium-priority/077-manage-goals.md`](12--mcp-medium-priority/077-manage-goals.md)
...
See [`13--mcp-low-priority/078-get-dependencies.md`](13--mcp-low-priority/078-get-dependencies.md)

### clickup_use_task_template
Create a new task from a saved ClickUp task template.

See [`13--mcp-low-priority/079-use-template.md`](13--mcp-low-priority/079-use-template.md)

### clickup_manage_chat
Send messages to ClickUp Chat channels.

See [`13--mcp-low-priority/080-manage-chat.md`](13--mcp-low-priority/080-manage-chat.md)
...
See [`13--mcp-low-priority/081-manage-webhooks.md`](13--mcp-low-priority/081-manage-webhooks.md)

### clickup_get_user_groups
List user groups (teams) in the workspace. Enterprise feature — requires admin token.

See [`13--mcp-low-priority/082-user-groups.md`](13--mcp-low-priority/082-user-groups.md)

### clickup_manage_guests
Add or remove guest users from the workspace. Enterprise feature.

See [`13--mcp-low-priority/083-manage-guests.md`](13--mcp-low-priority/083-manage-guests.md)

### clickup_get_audit_logs
Access workspace audit logs for compliance and security review. Enterprise feature.

See [`13--mcp-low-priority/084-audit-logs.md`](13--mcp-low-priority/084-audit-logs.md)

### clickup_provide_feedback
Submit product feedback directly to ClickUp from the MCP. Rarely used in agent workflows.

See [`13--mcp-low-priority/085-feedback.md`](13--mcp-low-priority/085-feedback.md)

### clickup_create_checklist
Create a named checklist inside a task.

See [`13--mcp-low-priority/086-create-checklist.md`](13--mcp-low-priority/086-create-checklist.md)

### clickup_update_checklist
Update a checklist's name or ordering.

See [`13--mcp-low-priority/087-update-checklist.md`](13--mcp-low-priority/087-update-checklist.md)

### clickup_delete_checklist
Delete a checklist from a task.

See [`13--mcp-low-priority/088-delete-checklist.md`](13--mcp-low-priority/088-delete-checklist.md)

### clickup_create_checklist_item
Add a new item to an existing checklist.

See [`13--mcp-low-priority/089-create-checklist-item.md`](13--mcp-low-priority/089-create-checklist-item.md)

### clickup_update_checklist_item
Update a checklist item: change text or mark as resolved/unresolved.

See [`13--mcp-low-priority/090-update-checklist-item.md`](13--mcp-low-priority/090-update-checklist-item.md)

### clickup_delete_checklist_item
Remove a specific item from a checklist.

See [`13--mcp-low-priority/091-delete-checklist-item.md`](13--mcp-low-priority/091-delete-checklist-item.md)

### clickup_get_document_pages
List all pages within a ClickUp document.

See [`13--mcp-low-priority/092-get-doc-pages.md`](13--mcp-low-priority/092-get-doc-pages.md)

### clickup_create_document_page
Add a new page to an existing ClickUp document.

See [`13--mcp-low-priority/093-create-doc-page.md`](13--mcp-low-priority/093-create-doc-page.md)

### clickup_update_document_page
Update the name or content of a specific document page.

See [`13--mcp-low-priority/094-update-doc-page.md`](13--mcp-low-priority/094-update-doc-page.md)

### clickup_get_custom_fields
List all custom field definitions for a list.

See [`13--mcp-low-priority/095-get-custom-fields.md`](13--mcp-low-priority/095-get-custom-fields.md)

### clickup_set_custom_field_value
Set the value of a custom field on a specific task.

See [`13--mcp-low-priority/096-set-custom-field.md`](13--mcp-low-priority/096-set-custom-field.md)

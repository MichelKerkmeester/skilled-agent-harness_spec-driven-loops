...
- Feature file path: `01--cupt-authentication/006-clear-cache.md`
Related references:
- [005-show-config.md](005-show-config.md) — Show Config
- [007-auth-status.md](007-auth-status.md) — Auth Status

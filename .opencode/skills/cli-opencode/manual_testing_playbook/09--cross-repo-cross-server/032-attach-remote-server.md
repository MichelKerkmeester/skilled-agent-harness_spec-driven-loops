...
- Prompt: `Verify --attach is documented in cli_reference.md, opencode attach appears in the subcommand map, and run help exposes the flag.`
...
- Feature file path: `09--cross-repo-cross-server/032-attach-remote-server.md`

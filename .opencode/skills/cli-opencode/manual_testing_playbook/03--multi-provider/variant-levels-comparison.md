...
|---|---|
| `deepseek/deepseek-v4-pro` | `minimal`, `low`, `medium`, `high`, `xhigh` |
| `deepseek/deepseek-v4-pro` | `minimal`, `low`, `medium`, `high`, `max` |
| `deepseek/deepseek-v4-pro` | `--variant` accepted; effect depends on direct deepseek provider routing |

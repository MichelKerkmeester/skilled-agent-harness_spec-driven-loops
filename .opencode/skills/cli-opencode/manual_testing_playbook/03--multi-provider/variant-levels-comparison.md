...
- Prompt: `Run the same architecture prompt with --variant minimal and max; compare response byte counts and trade-off dimension coverage.`
...
- Feature file path: `03--multi-provider/variant-levels-comparison.md`

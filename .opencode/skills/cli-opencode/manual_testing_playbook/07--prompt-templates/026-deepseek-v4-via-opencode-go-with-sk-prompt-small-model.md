...
2. Read `.opencode/skills/sk-prompt/assets/model-profiles.json` deepseek-v4-pro entry. Confirm 3 executor paths and document why opencode-go is chosen (e.g., Devin Pro quota exhausted, no DeepSeek API key, opencode-go credits available).

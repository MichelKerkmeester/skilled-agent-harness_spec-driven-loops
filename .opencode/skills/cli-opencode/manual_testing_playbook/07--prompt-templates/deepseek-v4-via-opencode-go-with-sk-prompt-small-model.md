...
2. Read `.opencode/skills/sk-prompt-small-model/assets/model-profiles.json` deepseek-v4-pro entry. Confirm 2 executor paths and document why opencode-go is chosen (e.g., no DeepSeek API key, opencode-go credits available).
...
| `../../../sk-prompt-small-model/assets/model-profiles.json` | deepseek-v4-pro entry: 2 executor paths |

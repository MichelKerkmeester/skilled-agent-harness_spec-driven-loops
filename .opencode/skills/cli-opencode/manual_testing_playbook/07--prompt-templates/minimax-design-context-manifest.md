...
- Expected execution process: Consult `sk-prompt-small-model` for MiniMax-M3, read `../../../sk-prompt-small-model/references/models/minimax-m3.md`, read `../../assets/prompt_quality_card.md`, read `../../../sk-design/shared/context_loading_contract.md`, compose a MiniMax prompt with `<pre-plan>`, Design Manifest, Context Loaded card, proof-field requirements, `## Verification`, and Proof Of Application card, then dispatch or dry-run the exact packet depending on provider availability.
...
2. Read `../../../sk-prompt-small-model/references/models/minimax-m3.md` and confirm the design-task scaffold section is used.
...
| `../../../sk-prompt-small-model/references/models/minimax-m3.md` | MiniMax-M3 profiled prompt contract and design-task scaffold |

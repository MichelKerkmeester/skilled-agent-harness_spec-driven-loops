...
| GLM-5.2 (Z.AI GLM Coding Plan) | COSTAR + lean (empirical, benchmark 008) | [`glm-5.2.md`](../../sk-prompt-small-model/references/models/glm-5.2.md) |
| deepseek-v4-pro / kimi-k2.6 / qwen3.6 | default RCAF (no model-specific benchmark; shared default-unverified note) | [`deepseek-v4-pro.md`](../../sk-prompt-small-model/references/models/deepseek-v4-pro.md) · [`kimi-k2.6.md`](../../sk-prompt-small-model/references/models/kimi-k2.6.md) · [`qwen3.6.md`](../../sk-prompt-small-model/references/models/qwen3.6.md) |

...
| File | Type | Role |
|---|---|---|
| `manual-testing-playbook/read-only/styles-funnel.md` | Manual playbook | The metadata-first styles funnel returns cited evidence read-only |

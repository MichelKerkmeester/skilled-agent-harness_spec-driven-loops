...
- [mcp_wiring.md](../references/mcp_wiring.md) - the full wiring reference: bridge behavior, OAuth, auth state, naming, and discovery.
- [tool_surface.md](../references/tool_surface.md) - the eight-tool contract the manual exposes.

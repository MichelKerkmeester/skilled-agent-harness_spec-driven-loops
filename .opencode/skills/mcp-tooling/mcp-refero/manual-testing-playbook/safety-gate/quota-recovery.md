...
| `../../feature-catalog/feature-catalog.md` | The out-of-scope note on limits and workspace mutation |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `../../references/tool-surface.md` | Plan gating and limits (Section 4): the published quota and the unknown list |
...
- Feature file path: `safety-gate/quota-recovery.md`

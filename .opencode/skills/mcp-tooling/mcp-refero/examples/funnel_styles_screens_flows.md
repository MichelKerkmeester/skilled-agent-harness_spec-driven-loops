...
A worked walkthrough of the official research funnel for a realistic brief: *"We are designing a pricing page for a developer-tools SaaS; gather visual direction, real pricing-page patterns, and how products run the upgrade journey."* Every tool, argument, and bound below traces to [`references/tool_surface.md`](../references/tool_surface.md).

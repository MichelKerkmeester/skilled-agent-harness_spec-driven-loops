...
| File | Role |
|---|---|
| `../../references/tool_surface.md` | Args, bounds, result shape, and the funnel role (Section 1) |
| `../../manual_testing_playbook/read_only/styles_funnel.md` | The metadata-first funnel scenario exercising this tool |
...
- Feature file path: `styles/search_styles.md`

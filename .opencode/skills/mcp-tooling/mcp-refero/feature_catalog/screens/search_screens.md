...
| File | Role |
|---|---|
| `../../references/tool_surface.md` | Args, the required platform enum, result shape, and the facet rule (Section 1) |
| `../../manual_testing_playbook/read_only/format_text_retrieval.md` | The response_format discipline scenario exercising this tool |
| `../../examples/metadata_first_lookup.md` | Worked metadata-first Code Mode invocation |
...
- Feature file path: `screens/search_screens.md`

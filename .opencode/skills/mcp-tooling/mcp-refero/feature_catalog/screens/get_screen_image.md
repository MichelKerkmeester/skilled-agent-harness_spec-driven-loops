...
| File | Role |
|---|---|
| `../../references/tool_surface.md` | The image-size enum, the image-last rule, and the response_format exclusion (Sections 1-2) |
| `../../manual_testing_playbook/read_only/format_text_retrieval.md` | The scenario proving the response_format exclusion holds |
| `../../examples/screen_image_fetch.md` | Worked thumbnail-before-full Code Mode invocation |
...
- Feature file path: `screens/get_screen_image.md`

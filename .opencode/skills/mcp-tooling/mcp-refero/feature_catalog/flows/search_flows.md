...
| File | Role |
|---|---|
| `../../references/tool_surface.md` | Args, the numeric-ID rule, and the sparse-flow discipline (Sections 1, 3) |
| `../../manual_testing_playbook/read_only/flow_detail.md` | The numeric-typing scenario exercising this tool |
...
- Feature file path: `flows/search_flows.md`

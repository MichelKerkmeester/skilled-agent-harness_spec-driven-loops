...
| `../../references/mcp_wiring.md` | The verify-never-edit rule and the operator-owned auth-state contract |
| `../../assets/utcp_refero_manual.md` | The Bearer alternative marked alternative-only, never base-manual |

...
| File | Role |
|---|---|
| `../../references/mcp_wiring.md` | The registered manual, bridge behavior, and the verify-never-edit rule |
| `../../assets/utcp_refero_manual.md` | The byte-preserved manual snapshot marked "verify, do not re-add" |
...
- Feature file path: `discovery_setup/manual_registered.md`

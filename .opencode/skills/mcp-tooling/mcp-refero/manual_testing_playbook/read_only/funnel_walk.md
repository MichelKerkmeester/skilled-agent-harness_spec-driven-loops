...
| File | Role |
|---|---|
| `../../references/tool_surface.md` | The funnel contract (Section 3), ID typing, and per-tool bounds |
| `../../examples/funnel_styles_screens_flows.md` | The worked Code Mode walkthrough this scenario executes |
...
- Feature file path: `read_only/funnel_walk.md`

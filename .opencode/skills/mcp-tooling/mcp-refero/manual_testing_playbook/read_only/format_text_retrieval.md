...
| `../../feature_catalog/screens/screens.md` | Feature-catalog source for the screens layer |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `../../references/tool_surface.md` | The response_format contract (Section 1), the preserved source conflict, and the image-tool exclusion |
...
- Feature file path: `read_only/format_text_retrieval.md`

...
- Failure Triage: 1. Confirm `NOTION_TOKEN` is set and the scratch parent is shared with the integration. 2. Confirm the server pins `2026-03-11` for the markdown tools. 3. Repeat `list_tools()` and each `tool_info()` call before retrying.

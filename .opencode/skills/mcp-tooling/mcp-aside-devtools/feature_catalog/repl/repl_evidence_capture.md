...
| File | Layer | Role |
|---|---|---|
| `references/aside_cli_reference.md` | Shared | REPL invocation form and helper boundary rules |
| `references/session_management.md` | Shared | REPL persistence layer and single-writer posture |
...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/repl_evidence/repl_open_tab.md` | Manual playbook | ASD-006 deterministic tab open round trip |
| `manual_testing_playbook/repl_evidence/repl_screenshot_artifact.md` | Manual playbook | ASD-007 screenshot artifact with independent PNG verification |
...
- Feature file path: `repl/repl_evidence_capture.md`

Related references:
- [agent_tasks.md](../task/agent_tasks.md) covers the outcome-oriented lane for multi-step goals
- [mcp_transport_and_code_mode.md](../mcp/mcp_transport_and_code_mode.md) covers the same REPL surface exposed as the MCP `repl` tool

...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/repl-evidence/repl-open-tab.md` | Manual playbook | ASD-006 deterministic tab open round trip |
| `manual_testing_playbook/repl-evidence/repl-screenshot-artifact.md` | Manual playbook | ASD-007 screenshot artifact with independent PNG verification |

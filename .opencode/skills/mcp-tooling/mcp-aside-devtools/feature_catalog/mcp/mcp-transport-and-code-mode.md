...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/mcp-transport/mcp-handshake.md` | Manual playbook | ASD-008 stdio initialize handshake |
| `manual_testing_playbook/mcp-transport/tools-list-discovery.md` | Manual playbook | ASD-009 runtime inventory discovery with drift reporting |
| `manual_testing_playbook/mcp-transport/code-mode-discovery.md` | Manual playbook | ASD-011 Code Mode callable confirmation against the registered manual |

...
- [session-management.md](./session-management.md) — three-layer session model, daemon, concurrency, permission modes.
- [mcp-wiring.md](./mcp-wiring.md) — MCP transport, discovery, and Code Mode registration posture.

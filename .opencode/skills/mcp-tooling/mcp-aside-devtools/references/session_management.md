...
- [aside_cli_reference.md](./aside_cli_reference.md) — command surface for tasks, REPL, and accounts.
- [mcp_wiring.md](./mcp_wiring.md) — transport, handshake, binding error, registration posture.

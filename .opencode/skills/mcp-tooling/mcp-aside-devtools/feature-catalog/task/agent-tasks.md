...
| File | Type | Role |
|---|---|---|
| `manual-testing-playbook/agent-task/direct-task.md` | Manual playbook | ASD-004 direct natural-language task end-to-end |
| `manual-testing-playbook/agent-task/session-continuation.md` | Manual playbook | ASD-005 session continuation with prior context |

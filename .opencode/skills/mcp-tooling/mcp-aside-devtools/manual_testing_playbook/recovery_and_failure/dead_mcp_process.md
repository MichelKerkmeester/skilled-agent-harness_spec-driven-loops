...
| File | Role |
|---|---|
| `.opencode/skills/mcp-tooling/mcp-aside-devtools/references/session_management.md` | Dead-child vs daemon-unavailable distinction |
...
- Feature file path: `recovery_and_failure/dead_mcp_process.md`

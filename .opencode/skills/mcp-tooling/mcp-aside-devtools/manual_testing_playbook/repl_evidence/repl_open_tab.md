...
| File | Role |
|---|---|
| `.opencode/skills/mcp-tooling/mcp-aside-devtools/references/aside_cli_reference.md` | REPL lane contract and helper list |
...
- Feature file path: `repl_evidence/repl_open_tab.md`

...
| File | Role |
|---|---|
| `.opencode/skills/mcp-tooling/mcp-aside-devtools/references/mcp_wiring.md` | Binding-state contract |
...
- Feature file path: `mcp_transport/unbound_profile_error.md`

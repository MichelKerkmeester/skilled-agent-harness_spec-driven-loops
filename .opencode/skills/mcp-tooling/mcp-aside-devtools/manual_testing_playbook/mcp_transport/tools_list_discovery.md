...
| File | Role |
|---|---|
| `.opencode/skills/mcp-tooling/mcp-aside-devtools/references/mcp_wiring.md` | Version-pinned inventory and rediscovery mandate |
...
- Feature file path: `mcp_transport/tools_list_discovery.md`

...
| File | Role |
|---|---|
| `.opencode/skills/mcp-tooling/mcp-aside-devtools/references/aside_cli_reference.md` | Version-pinned command surface this fixture validates |
...
- Feature file path: `cli_lifecycle/help_fixture.md`

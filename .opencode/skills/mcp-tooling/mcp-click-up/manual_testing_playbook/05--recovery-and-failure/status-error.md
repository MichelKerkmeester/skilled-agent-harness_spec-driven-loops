...
| [`../../feature_catalog/03--cupt-task-details/status-schema.md`](../../feature_catalog/03--cupt-task-details/status-schema.md) | Feature catalog source |
...
- Feature file path: `05--recovery-and-failure/status-error.md`

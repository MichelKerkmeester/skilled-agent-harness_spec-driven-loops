...
| [`../../feature_catalog/03--cupt-task-details/show-task.md`](../../feature_catalog/03--cupt-task-details/show-task.md) | Feature catalog source |
...
- Feature file path: `02--task-operations/show-task.md`

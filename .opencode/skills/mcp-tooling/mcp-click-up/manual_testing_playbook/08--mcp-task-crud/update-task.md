...
| [`../../feature_catalog/11--mcp-high-priority/update-task.md`](../../feature_catalog/11--mcp-high-priority/update-task.md) | Feature catalog source |
...
- Feature file path: `08--mcp-task-crud/update-task.md`

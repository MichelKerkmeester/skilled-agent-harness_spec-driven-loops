...
> **Feature File:** [cupt-lifecycle/install-version.md](cupt_lifecycle/install_version.md)
> **Catalog:** [cupt-global-flags/version-flag.md](../feature_catalog/cupt_global_flags/version_flag.md)
...
> **Feature File:** [cupt-lifecycle/session-auth.md](cupt_lifecycle/session_auth.md)
> **Catalog:** [cupt-authentication/interactive-auth.md](../feature_catalog/cupt_authentication/interactive_auth.md)
...
> **Feature File:** [cupt-lifecycle/session-auth.md](cupt_lifecycle/session_auth.md)
> **Catalog:** [cupt-authentication/direct-token.md](../feature_catalog/cupt_authentication/direct_token.md)
...
> **Feature File:** [cupt-lifecycle/config-show.md](cupt_lifecycle/config_show.md)
> **Catalog:** [cupt-authentication/workspace-default.md](../feature_catalog/cupt_authentication/workspace_default.md)
...
> **Feature File:** [cupt-lifecycle/config-show.md](cupt_lifecycle/config_show.md)
> **Catalog:** [cupt-authentication/list-default.md](../feature_catalog/cupt_authentication/list_default.md)
...
> **Feature File:** [cupt-lifecycle/config-show.md](cupt_lifecycle/config_show.md)
> **Catalog:** [cupt-authentication/show-config.md](../feature_catalog/cupt_authentication/show_config.md)
...
> **Feature File:** [cupt-lifecycle/status-json.md](cupt_lifecycle/status_json.md)
> **Catalog:** [cupt-authentication/auth-status.md](../feature_catalog/cupt_authentication/auth_status.md)
...
> **Feature File:** [recovery-and-failure/missing-auth.md](recovery_and_failure/missing_auth.md)
> **Catalog:** [cupt-authentication/logout.md](../feature_catalog/cupt_authentication/logout.md)
...
> **Feature File:** [task-operations/list-today.md](task_operations/list_today.md)
> **Catalog:** [cupt-task-listing/list-assigned.md](../feature_catalog/cupt_task_listing/list_assigned.md)
...
> **Feature File:** [task-operations/list-today.md](task_operations/list_today.md)
> **Catalog:** [cupt-task-listing/filter-today.md](../feature_catalog/cupt_task_listing/filter_today.md)
...
> **Feature File:** [task-operations/list-today.md](task_operations/list_today.md)
> **Catalog:** [cupt-task-listing/filter-tag.md](../feature_catalog/cupt_task_listing/filter_tag.md)
...
> **Feature File:** [task-operations/list-today.md](task_operations/list_today.md)
> **Catalog:** [cupt-task-listing/json-output.md](../feature_catalog/cupt_task_listing/json_output.md)
...
> **Feature File:** [cupt-advanced-listing/exclude-tag.md](cupt_advanced_listing/exclude_tag.md)
> **Catalog:** [cupt-task-listing/exclude-tag.md](../feature_catalog/cupt_task_listing/exclude_tag.md)
...
> **Feature File:** [cupt-advanced-listing/cap-results.md](cupt_advanced_listing/cap_results.md)
> **Catalog:** [cupt-task-listing/cap-results.md](../feature_catalog/cupt_task_listing/cap_results.md)
...
> **Feature File:** [cupt-advanced-listing/verbose.md](cupt_advanced_listing/verbose.md)
> **Catalog:** [cupt-task-listing/verbose.md](../feature_catalog/cupt_task_listing/verbose.md)
...
> **Feature File:** [cupt-advanced-listing/stacked-filters.md](cupt_advanced_listing/stacked_filters.md)
> **Catalog:** [cupt-task-listing/stacked-filters.md](../feature_catalog/cupt_task_listing/stacked_filters.md)
...
> **Feature File:** [task-operations/show-task.md](task_operations/show_task.md)
> **Catalog:** [cupt-task-details/show-task.md](../feature_catalog/cupt_task_details/show_task.md)
...
> **Feature File:** [task-operations/show-task.md](task_operations/show_task.md)
> **Catalog:** [cupt-task-details/show-notes.md](../feature_catalog/cupt_task_details/show_notes.md)
...
> **Feature File:** [task-operations/show-task.md](task_operations/show_task.md)
> **Catalog:** [cupt-task-details/task-context.md](../feature_catalog/cupt_task_details/task_context.md)
...
> **Feature File:** [cupt-offline-and-cache/prefetch-offline.md](cupt_offline_and_cache/prefetch_offline.md)
> **Catalog:** [cupt-workspace/prefetch.md](../feature_catalog/cupt_workspace/prefetch.md)
...
> **Feature File:** [task-operations/statuses-dry-run.md](task_operations/statuses_dry_run.md)
> **Catalog:** [cupt-task-details/status-schema.md](../feature_catalog/cupt_task_details/status_schema.md)
...
> **Feature File:** [task-operations/statuses-dry-run.md](task_operations/statuses_dry_run.md)
> **Catalog:** [cupt-task-details/status-by-list.md](../feature_catalog/cupt_task_details/status_by_list.md)
...
> **Feature File:** [task-operations/statuses-dry-run.md](task_operations/statuses_dry_run.md)
> **Catalog:** [cupt-task-completion/dry-run.md](../feature_catalog/cupt_task_completion/dry_run.md)
...
> **Feature File:** [task-operations/done-with-note.md](task_operations/done_with_note.md)
> **Catalog:** [cupt-task-completion/mark-complete.md](../feature_catalog/cupt_task_completion/mark_complete.md)
...
> **Feature File:** [task-operations/done-with-note.md](task_operations/done_with_note.md)
> **Catalog:** [cupt-task-completion/complete-with-note.md](../feature_catalog/cupt_task_completion/complete_with_note.md)
...
> **Feature File:** [task-operations/done-with-note.md](task_operations/done_with_note.md)
> **Catalog:** [cupt-tag-management/add-tag.md](../feature_catalog/cupt_tag_management/add_tag.md)
...
> **Feature File:** [time-and-notes/note-and-notes.md](time_and_notes/note_and_notes.md)
...
> **Feature File:** [time-and-notes/time-start-stop.md](time_and_notes/time_start_stop.md)
...
> **Feature File:** [time-and-notes/time-add-manual.md](time_and_notes/time_add_manual.md)
...
> **Feature File:** [cupt-offline-and-cache/clear-cache.md](cupt_offline_and_cache/clear_cache.md)
...
> **Feature File:** [cupt-offline-and-cache/attachments.md](cupt_offline_and_cache/attachments.md)
...
> **Feature File:** [recovery-and-failure/empty-queue.md](recovery_and_failure/empty_queue.md)
...
> **Feature File:** [mcp-task-crud/create-task.md](mcp_task_crud/create_task.md)
> **Catalog:** [mcp-high-priority/create-task.md](../feature_catalog/mcp_high_priority/create_task.md)
...
> **Feature File:** [mcp-task-crud/get-task.md](mcp_task_crud/get_task.md)
...
> **Feature File:** [mcp-task-crud/update-task.md](mcp_task_crud/update_task.md)
...
> **Feature File:** [mcp-task-crud/delete-task.md](mcp_task_crud/delete_task.md)
...
> **Feature File:** [mcp-task-crud/search-tasks.md](mcp_task_crud/search_tasks.md)
...
> **Feature File:** [mcp-task-crud/get-workspace.md](mcp_task_crud/get_workspace.md)
...
> **Feature File:** [mcp-task-crud/manage-comments.md](mcp_task_crud/manage_comments.md)
...
> **Feature File:** [mcp-task-crud/bulk-create.md](mcp_task_crud/bulk_create.md)
...
> **Feature File:** [mcp-documents-goals/create-document.md](mcp_documents_goals/create_document.md)
> **Catalog:** [mcp-medium-priority/create-document.md](../feature_catalog/mcp_medium_priority/create_document.md)
...
> **Feature File:** [mcp-documents-goals/get-document.md](mcp_documents_goals/get_document.md)
...
> **Feature File:** [mcp-documents-goals/document-pages.md](mcp_documents_goals/document_pages.md)
...
> **Feature File:** [mcp-documents-goals/manage-goals.md](mcp_documents_goals/manage_goals.md)
...
> **Feature File:** [mcp-bulk-and-structure/manage-lists.md](mcp_bulk_and_structure/manage_lists.md)
...
> **Feature File:** [mcp-bulk-and-structure/create-webhook.md](mcp_bulk_and_structure/create_webhook.md)
...
> **Feature File:** [mcp-bulk-and-structure/checklist-lifecycle.md](mcp_bulk_and_structure/checklist_lifecycle.md)
...
> **Feature File:** [mcp-bulk-and-structure/custom-field.md](mcp_bulk_and_structure/custom_field.md)
...
> **Feature File:** [recovery-and-failure/status-error.md](recovery_and_failure/status_error.md)

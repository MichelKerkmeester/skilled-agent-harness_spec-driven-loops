...
| [`../../feature_catalog/cupt-authentication/auth-status.md`](../../feature_catalog/cupt-authentication/auth-status.md) | Feature catalog source |
...
- Feature file path: `cupt-lifecycle/status-json.md`

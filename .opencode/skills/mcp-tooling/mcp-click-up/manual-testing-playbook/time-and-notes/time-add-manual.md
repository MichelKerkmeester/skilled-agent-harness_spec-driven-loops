...
| [`../../feature-catalog/cupt-time-tracking/log-manual.md`](../../feature-catalog/cupt-time-tracking/log-manual.md) | Feature catalog source |
...
- Feature file path: `time-and-notes/time-add-manual.md`

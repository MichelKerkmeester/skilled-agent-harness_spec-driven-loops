...
| [`../../feature-catalog/cupt-authentication/logout.md`](../../feature-catalog/cupt-authentication/logout.md) | Feature catalog source |
...
- Feature file path: `recovery-and-failure/missing-auth.md`

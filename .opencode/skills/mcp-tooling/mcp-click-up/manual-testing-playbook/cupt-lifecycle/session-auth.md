...
| [`../../feature-catalog/cupt-authentication/interactive-auth.md`](../../feature-catalog/cupt-authentication/interactive-auth.md) | Feature catalog source |
...
- Feature file path: `cupt-lifecycle/session-auth.md`

...
| [`../../feature-catalog/cupt-task-listing/exclude-tag.md`](../../feature-catalog/cupt-task-listing/exclude-tag.md) | Feature catalog source |
...
- Feature file path: `cupt-advanced-listing/exclude-tag.md`

...
| File | Role |
|------|------|
| `manual-testing-playbook.md` | Root directory and scenario summary |
| `../feature-catalog/mcp-medium-priority/create-document.md` | Feature catalog source |

### Implementation And Test Anchors

| File | Role |
|------|------|
| `../references/cupt-commands.md` | cupt command reference |

...
Related references:
- [update-document.md](../../feature-catalog/mcp-medium-priority/update-document.md) — clickup_update_document
- [manage-goals.md](../../feature-catalog/mcp-medium-priority/manage-goals.md) — clickup_manage_goals

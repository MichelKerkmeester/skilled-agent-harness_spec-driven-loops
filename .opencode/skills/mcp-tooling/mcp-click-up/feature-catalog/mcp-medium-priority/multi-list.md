...
Related references:
- [create-task-link.md](../../feature-catalog/mcp-medium-priority/create-task-link.md) — clickup_create_task_link
- [task-attachments.md](../../feature-catalog/mcp-medium-priority/task-attachments.md) — clickup_manage_task_attachments

...
| File | Role |
|---|---|
| `../../references/mcp_wiring.md` | The inferred naming rule and the discovery-first contract |
| `../../references/tool_surface.md` | The single-tool baseline and the open questions discovery resolves |
| `../../assets/utcp_mobbin_manual.md` | The post-registration checklist this scenario partially exercises |
...
- Feature file path: `discovery_setup/discovery_first.md`

...
| File | Layer | Role |
|---|---|---|
| `references/tool-surface.md` | Shared | The flow-intent workflow and the reconstruction-as-inference rule |
...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/read-only/flow-intent.md` | Manual playbook | Flow-intent search with labeled reconstruction |
| `manual_testing_playbook/pairing/sk-design-pairing.md` | Manual playbook | Flow evidence routes through sk-design before any design verdict |

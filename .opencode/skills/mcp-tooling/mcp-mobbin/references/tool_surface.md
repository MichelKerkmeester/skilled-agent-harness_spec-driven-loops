...
Live-listed pre-auth on 2026-07-16 ([`discovery_fixture_2026-07-16.json`](./discovery_fixture_2026-07-16.json)); all schemas below are the fixture's declared TypeScript interfaces. **[CONFIRMED: fixture]**
...
1. **RESOLVED for pre-auth discovery, 2026-07-16** ([`discovery_fixture_2026-07-16.json`](./discovery_fixture_2026-07-16.json)): `list_tools()` and `tool_info()` work WITHOUT OAuth and return three tools with full declared schemas (Section 1). Whether an authenticated session's inventory differs remains unobserved — re-run discovery after operator OAuth.

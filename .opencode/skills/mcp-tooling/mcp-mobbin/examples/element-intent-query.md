...
- Budget check: each variation spends the same 60-per-60s rate window; on 429 honor `Retry-After`, then exponential backoff with jitter (tool-surface.md §3).

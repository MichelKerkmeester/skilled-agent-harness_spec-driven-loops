...
- Prompt: `List available CDP domains and confirm Page, Network, and Runtime appear.`
...
| File | Role |
|---|---|
| `.opencode/skills/mcp-tooling/mcp-chrome-devtools/SKILL.md` | bdg cdp subcommand reference |
...
- Feature file path: `02--protocol-discovery/list-cdp-domains.md`

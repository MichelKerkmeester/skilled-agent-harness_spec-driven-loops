...
#### Test Execution
> **Feature File:** [BDG-001](../manual-testing-playbook/cli-bdg-lifecycle/install-version.md)
...
#### Test Execution
> **Feature File:** [BDG-002](../manual-testing-playbook/cli-bdg-lifecycle/session-start.md)
...
#### Test Execution
> **Feature File:** [BDG-003](../manual-testing-playbook/cli-bdg-lifecycle/status-json.md)
...
#### Test Execution
> **Feature File:** [BDG-004](../manual-testing-playbook/cli-bdg-lifecycle/session-stop.md)
...
#### Test Execution
> **Feature File:** [BDG-005](../manual-testing-playbook/protocol-discovery/list-cdp-domains.md)
...
#### Test Execution
> **Feature File:** [BDG-006](../manual-testing-playbook/protocol-discovery/describe-page-domain.md)
...
#### Test Execution
> **Feature File:** [BDG-007](../manual-testing-playbook/protocol-discovery/search-cdp-method.md)
...
#### Test Execution
> **Feature File:** [BDG-008](../manual-testing-playbook/dom-and-screenshot/query-selector.md)
...
#### Test Execution
> **Feature File:** [BDG-009](../manual-testing-playbook/dom-and-screenshot/eval-javascript.md)
...
#### Test Execution
> **Feature File:** [BDG-010](../manual-testing-playbook/dom-and-screenshot/screenshot-capture.md)
...
#### Test Execution
> **Feature File:** [BDG-011](../manual-testing-playbook/console-and-network/console-list.md)
...
#### Test Execution
> **Feature File:** [BDG-012](../manual-testing-playbook/console-and-network/cookies-retrieval.md)
...
#### Test Execution
> **Feature File:** [BDG-013](../manual-testing-playbook/console-and-network/har-export.md)
...
#### Test Execution
> **Feature File:** [BDG-014](../manual-testing-playbook/mcp-parallel-instances/chrome-devtools-1-navigate.md)
...
#### Test Execution
> **Feature File:** [BDG-015](../manual-testing-playbook/mcp-parallel-instances/dual-instance-parallel.md)
...
#### Test Execution
> **Feature File:** [BDG-016](../manual-testing-playbook/mcp-parallel-instances/close-and-select-page.md)
...
#### Test Execution
> **Feature File:** [BDG-017](../manual-testing-playbook/mcp-parallel-instances/multi-tab-same-instance.md)
...
#### Test Execution
> **Feature File:** [BDG-018](../manual-testing-playbook/mcp-parallel-instances/page-context-isolation.md)
...
#### Test Execution
> **Feature File:** [BDG-019](../manual-testing-playbook/recovery-and-failure/missing-browser.md)
...
#### Test Execution
> **Feature File:** [BDG-020](../manual-testing-playbook/recovery-and-failure/invalid-url.md)
...
#### Test Execution
> **Feature File:** [BDG-021](../manual-testing-playbook/recovery-and-failure/dead-session.md)
...
#### Test Execution
> **Feature File:** [BDG-022](../manual-testing-playbook/recovery-and-failure/cleanup-leak.md)
...
- BDG-001: [Install + version](../manual-testing-playbook/cli-bdg-lifecycle/install-version.md)
- BDG-002: [Session start](../manual-testing-playbook/cli-bdg-lifecycle/session-start.md)
- BDG-003: [Status JSON](../manual-testing-playbook/cli-bdg-lifecycle/status-json.md)
- BDG-004: [Session stop](../manual-testing-playbook/cli-bdg-lifecycle/session-stop.md)

### PROTOCOL DISCOVERY

- BDG-005: [List CDP domains](../manual-testing-playbook/protocol-discovery/list-cdp-domains.md)
- BDG-006: [Describe Page domain](../manual-testing-playbook/protocol-discovery/describe-page-domain.md)
- BDG-007: [Search CDP method](../manual-testing-playbook/protocol-discovery/search-cdp-method.md)

### DOM AND SCREENSHOT

- BDG-008: [Query selector](../manual-testing-playbook/dom-and-screenshot/query-selector.md)
- BDG-009: [Eval JavaScript](../manual-testing-playbook/dom-and-screenshot/eval-javascript.md)
- BDG-010: [Screenshot capture](../manual-testing-playbook/dom-and-screenshot/screenshot-capture.md)

### CONSOLE AND NETWORK

- BDG-011: [Console list](../manual-testing-playbook/console-and-network/console-list.md)
- BDG-012: [Cookies retrieval](../manual-testing-playbook/console-and-network/cookies-retrieval.md)
- BDG-013: [HAR export](../manual-testing-playbook/console-and-network/har-export.md)

### MCP PARALLEL INSTANCES

- BDG-014: [chrome_devtools_1 navigate via Code Mode](../manual-testing-playbook/mcp-parallel-instances/chrome-devtools-1-navigate.md)
- BDG-015: [Dual-instance parallel](../manual-testing-playbook/mcp-parallel-instances/dual-instance-parallel.md)
- BDG-016: [Close + select page](../manual-testing-playbook/mcp-parallel-instances/close-and-select-page.md)
- BDG-017: [Multi-tab same instance](../manual-testing-playbook/mcp-parallel-instances/multi-tab-same-instance.md)
- BDG-018: [Page-context isolation cross-instance](../manual-testing-playbook/mcp-parallel-instances/page-context-isolation.md)

### RECOVERY AND FAILURE

- BDG-019: [Missing browser](../manual-testing-playbook/recovery-and-failure/missing-browser.md)

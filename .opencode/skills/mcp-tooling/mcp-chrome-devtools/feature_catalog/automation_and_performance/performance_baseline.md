...
| `references/cdp_patterns.md` §4, §8 | Reference | Performance domain patterns and monitoring pipeline |
...
- Feature file path: `automation_and_performance/performance_baseline.md`
Related references:

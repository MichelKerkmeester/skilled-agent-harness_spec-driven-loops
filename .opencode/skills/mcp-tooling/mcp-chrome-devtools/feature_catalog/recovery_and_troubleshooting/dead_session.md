...
| File | Type | Role |
|------|------|------|
| `manual_testing_playbook/recovery_and_failure/dead_session.md` | Manual | BDG-021 scenario contract (destructive, throwaway sessions only) |
...
- Feature file path: `recovery_and_troubleshooting/dead_session.md`
Related references:

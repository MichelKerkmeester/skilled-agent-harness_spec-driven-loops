...
Moves a design system out of Figma read-only, or into Figma behind a gate. Extract feeds design judgment in `sk-design`; import changes the document and is gated. A typical caller extracts a `DESIGN.md` to ground later work, or imports an existing token source to populate Figma collections.

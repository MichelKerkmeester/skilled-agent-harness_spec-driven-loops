...
| File | Layer | Role |
|---|---|---|
| `references/figma-cli-reference.md` | Shared | Export verb surface and output flags |
| `references/tool-surface.md` | Shared | READ-ONLY (explicit output) classification and no-overwrite rule |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `manual-testing-playbook/read-only/read-only-export.md` | Manual playbook | Export targets an explicit path and never silently overwrites |
...
- [a11y-and-analysis.md](../../feature-catalog/a11y-and-analysis/a11y-and-analysis.md) covers the other always-safe read-only area

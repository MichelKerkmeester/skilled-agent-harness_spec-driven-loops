...
| File | Type | Role |
|---|---|---|
| `manual_testing_playbook/03--read-only/read-only-inspect.md` | Manual playbook | An inspect verb returns structure without changing the document |
...
- Feature file path: `02--inspect/inspect.md`

Related references:
- [connect-and-daemon.md](../01--connect-and-daemon/connect-and-daemon.md) covers the connection inspect depends on
- [export.md](../07--export/export.md) covers writing read-only assets out to explicit paths

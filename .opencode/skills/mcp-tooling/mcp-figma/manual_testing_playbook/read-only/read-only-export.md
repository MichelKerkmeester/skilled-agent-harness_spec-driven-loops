...
| `../../feature_catalog/export/export.md` | Feature-catalog source describing the explicit-output, no-overwrite rule |
...
- Feature file path: `read-only/read-only-export.md`

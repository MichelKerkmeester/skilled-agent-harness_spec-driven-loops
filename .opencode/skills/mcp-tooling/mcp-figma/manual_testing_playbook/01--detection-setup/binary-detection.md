...
| `../../feature_catalog/01--connect-and-daemon/connect-and-daemon.md` | Feature-catalog source for the connect/daemon foundation this unblocks |
...
- Feature file path: `01--detection-setup/binary-detection.md`

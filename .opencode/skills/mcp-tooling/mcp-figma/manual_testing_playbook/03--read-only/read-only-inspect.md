...
| `../../feature_catalog/02--inspect/inspect.md` | Feature-catalog source describing the read-only inspect surface |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `../../references/figma_cli_reference.md` | Inspect verb surface and read-only classification |
| `../../references/tool_surface.md` | READ-ONLY gating taxonomy |
...
- Feature file path: `03--read-only/read-only-inspect.md`

...
| `../../feature-catalog/export/export.md` | Feature-catalog source describing the explicit-output, no-overwrite rule |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `../../references/figma-cli-reference.md` | Export verb surface and output flags |
| `../../references/tool-surface.md` | READ-ONLY (explicit output) classification |

...
### 2.6 Verify a chart shows real data (mock-fallback escape)
...
### 2.7 Discover individual entry notes
...
- Never treat a rendered chart as verification on its own — see §2.6.

...
> Ships in the `mcp-obsidian` mode at `references/plugins/`. Operate this plugin at the **file layer**: edit the Beancount ledger the plugin reads; the plugin only renders it.

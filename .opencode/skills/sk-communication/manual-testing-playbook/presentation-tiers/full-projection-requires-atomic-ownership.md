...
| File | Role |
|---|---|
| [Display client](../../../../../.opencode/skills/sk-communication/cli-communication-projection/src/clients/display.ts) | Applies atomic replacement and append outcomes. |
| [Render decision](../../../../../.opencode/skills/sk-communication/cli-communication-projection/src/render/decision.ts) | Selects digest-checked supported render modes. |
| [Client display tests](../../../../../.opencode/skills/sk-communication/cli-communication-projection/test/clients/display.test.ts) | Atomic ownership and commit behavior. |

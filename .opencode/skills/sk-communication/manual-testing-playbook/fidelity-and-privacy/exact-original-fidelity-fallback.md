...
| File | Role |
|---|---|
| [Protected-span implementation](../../../../../.opencode/skills/sk-communication/cli-communication-projection/src/fidelity/protected-spans.ts) | Token protection and exact restoration. |
| [Fidelity validator](../../../../../.opencode/skills/sk-communication/cli-communication-projection/src/fidelity/validator.ts) | Terminal failure and exact-original decision logic. |
| [Protected-span tests](../../../../../.opencode/skills/sk-communication/cli-communication-projection/test/fidelity/protected-spans.test.ts) | Byte-for-byte restoration evidence. |
| [Fidelity validator tests](../../../../../.opencode/skills/sk-communication/cli-communication-projection/test/fidelity/validator.test.ts) | Failure-path fallback evidence. |

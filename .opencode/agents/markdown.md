...
| `.opencode/skills/sk-doc/sk-create-skill/assets/parent-skill/parent-skill-smart-routing-template.md`  | Root `ROUTER.md` stage-two authoring template for `/create:skill-parent` |

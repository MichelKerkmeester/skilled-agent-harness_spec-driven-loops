...
**Codex Effort Calibration:** For iterations on lower-risk dimensions (`traceability`, `maintainability`), prefer the lowest-effort path that still meets evidence requirements. Retain extra-high rigor for `security` and `correctness`.

...
| **Deep**     | N=4-5      | Architecture, high-risk decisions | high             |
...
- **Adaptive Mode**: [Quick | Standard | Deep]
...
│                                                                         │
│  CHATGPT FEATURES                                                       │
│  ├─► Adaptive modes: Quick (N=2), Standard (N=3), Deep (N=4-5)          │
│  └─► Reasoning effort: high (configurable per mode)                      │
│                                                                         │
│  OUTPUT                                                                 │

...
| **LEAF**         | MUST NOT dispatch any sub-agents | @context, @code, @create-doc, @multi-ai-council, @review, @debug, @deep-research, @deep-review |
...
| @create-doc | `.opencode/agent/create-doc.md` | `/create:*` command executor; sk-doc template-first; caller-restricted to create commands |
...
├─ Agent: @code | @context | @create-doc | @deep-research | @multi-ai-council | @review | @debug

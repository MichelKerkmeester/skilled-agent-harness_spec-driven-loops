...
| **LEAF**         | MUST NOT dispatch any sub-agents | @context, @code, @create, @multi-ai-council, @review, @debug, @deep-research, @deep-review |
...
├─ Agent: @code | @context | @create | @deep-research | @multi-ai-council | @review | @debug

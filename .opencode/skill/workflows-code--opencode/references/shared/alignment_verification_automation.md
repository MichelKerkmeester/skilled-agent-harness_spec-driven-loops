...
- Path: `.opencode/skill/workflows-code--opencode/scripts/verify_alignment_drift.py`
...
```bash
python3 .opencode/skill/workflows-code--opencode/scripts/verify_alignment_drift.py --root .opencode
```

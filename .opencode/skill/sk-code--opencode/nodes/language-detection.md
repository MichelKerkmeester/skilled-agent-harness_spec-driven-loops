---
description: "Quick language identification table mapping file extensions and keywords to TypeScript/Python configuration, validation, and implementation routing paths"
---
# Language Detection
...
- [Web Implementation Workflow](../../sk-code--web/nodes/implementation-workflow.md) - CSS/layout/API execution context
- [Validation Workflow](../../system-spec-kit/nodes/validation-workflow.md) - Spec quality gates and completion checks

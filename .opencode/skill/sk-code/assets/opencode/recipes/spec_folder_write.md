...
node .opencode/skill/system-spec-kit/scripts/dist/spec-folder/backfill-graph-metadata.js \
  --root <folder>
```
...
```bash
bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh <folder> --strict
```

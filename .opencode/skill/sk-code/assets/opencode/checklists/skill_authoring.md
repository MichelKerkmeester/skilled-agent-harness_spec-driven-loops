...
description: Checklist for authoring or modifying sk-* skills under `.opencode/skill/` with correct metadata, resources, and validation.
---
...
- Use this when authoring a new sk-* skill under `.opencode/skill/`.
...
- [ ] Read existing canonical skills at `.opencode/skill/sk-doc/SKILL.md`, `.opencode/skill/sk-code/SKILL.md`, and `.opencode/skill/sk-git/SKILL.md`.
- [ ] Read `sk-doc` source rules at `.opencode/skill/sk-doc/references/specific/skill_creation.md`.
...
- Prior examples: `.opencode/skill/sk-doc/SKILL.md`, `.opencode/skill/sk-code/SKILL.md`, `.opencode/skill/sk-git/SKILL.md`

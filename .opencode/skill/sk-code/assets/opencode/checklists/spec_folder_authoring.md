...
- [ ] Read templates from `.opencode/skill/system-spec-kit/templates/` and the manifest entries under `.opencode/skill/system-spec-kit/templates/manifest/`.
...
- [ ] Run `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh <path> --strict`.
...
- [ ] Confirm the companion recipe was followed: `.opencode/skill/sk-code/assets/opencode/recipes/spec_folder_write.md`.
...
- Verification recipes: `.opencode/skill/sk-code/assets/opencode/recipes/spec_folder_write.md`

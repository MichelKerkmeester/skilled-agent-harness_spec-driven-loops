...
//
// Usage:
//   node .opencode/skill/sk-code/assets/webflow/scripts/minify-webflow.mjs          # Normal run (skip unchanged)
//   node .opencode/skill/sk-code/assets/webflow/scripts/minify-webflow.mjs --force  # Force re-minify all
//

...
2. `references/router/code_surface_detection.md:30-37` contains the WEBFLOW marker block (verify with `head -40 .opencode/skill/sk-code/references/router/code_surface_detection.md`).
...
4. Skill advisor binary callable: `python3 .opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py --help` exits 0.
...
- `.opencode/skill/sk-code/SKILL.md` — Smart router pseudocode (lines 53-68).
- `.opencode/skill/sk-code/references/router/code_surface_detection.md` — WEBFLOW marker definitions (lines 30-37).
- `.opencode/skill/sk-code/references/router/intent_classification.md` — Intent → resource-loading mapping.
- `.opencode/skill/sk-code/references/webflow/implementation/webflow_patterns.md` — Expected-loaded reference.

...
**Exact prompt**:
```
Add set -euo pipefail and a trap to .opencode/skill/system-spec-kit/scripts/spec/validate.sh to clean up the temp dir on exit.
```
...
1. Target file exists: `bash: test -f .opencode/skill/system-spec-kit/scripts/spec/validate.sh`
...
- `.opencode/skill/sk-code/references/opencode/shell/{style_guide,quality_standards,quick_reference}.md`.

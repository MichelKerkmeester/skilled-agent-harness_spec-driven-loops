...
- `specs/skilled-agent-orchestration/069-sk-code-motion-dev-and-playbook/005-playbook-cross-cli-execution/results/CS-001-<cli>.yaml`

---

## 4. SOURCE FILES

- `.opencode/skill/sk-code/references/router/code_surface_detection.md` - WEBFLOW marker block.
- `.opencode/skill/sk-code/references/router/resource_loading.md` - WEBFLOW plus MOTION_DEV loading rules.
- `.opencode/skill/sk-code/references/motion_dev/quick_start.md` - Motion install and import guidance.
- `.opencode/skill/sk-code/assets/motion_dev/snippets/in_view_reveal.js` - Required snippet.

...
- `specs/skilled-agent-orchestration/069-sk-code-motion-dev-and-playbook/005-playbook-cross-cli-execution/results/CS-006-<cli>.yaml`

---

## 4. SOURCE FILES

- `.opencode/skill/sk-code/references/webflow/performance/cwv_remediation.md` - Required Webflow CWV reference.
- `.opencode/skill/sk-code/references/motion_dev/performance_and_pitfalls.md` - Required Motion performance reference.
- `.opencode/skill/sk-code/assets/webflow/checklists/performance_loading_checklist.md` - Expected asset.

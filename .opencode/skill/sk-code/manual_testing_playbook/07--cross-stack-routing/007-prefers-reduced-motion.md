...
- `specs/skilled-agent-orchestration/069-sk-code-motion-dev-and-playbook/005-playbook-cross-cli-execution/results/CS-007-<cli>.yaml`

---

## 4. SOURCE FILES

- `.opencode/skill/sk-code/references/motion_dev/performance_and_pitfalls.md` - Motion reduced-motion guidance.
- `.opencode/skill/sk-code/references/webflow/implementation/animation_workflows.md` - Webflow animation accessibility guidance.
- `.opencode/skill/sk-code/references/webflow/verification/verification_workflows.md` - Browser evidence expectations.
- `.opencode/skill/sk-code/assets/motion_dev/snippets/hover_gesture.js` - Reduced-motion snippet pattern.

...
- `specs/skilled-agent-orchestration/069-sk-code-motion-dev-and-playbook/005-playbook-cross-cli-execution/results/CS-004-<cli>.yaml`

---

## 4. SOURCE FILES

- `.opencode/skill/sk-code/references/motion_dev/decision_matrix.md` - Required decision reference.
- `.opencode/skill/sk-code/references/motion_dev/performance_and_pitfalls.md` - Performance and reduced-motion caveats.
- `.opencode/skill/sk-code/assets/motion_dev/snippets/hover_gesture.js` - Hover example when Motion.dev is justified.

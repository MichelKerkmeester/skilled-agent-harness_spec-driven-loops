...
- `.opencode/skill/sk-code/references/router/code_surface_detection.md` - generic-node guard.
- `.opencode/skill/sk-code/references/router/intent_classification.md` - MOTION_DEV signals.
- `.opencode/skill/sk-code/references/motion_dev/decision_matrix.md` - CSS/Motion/WAAPI trade-offs.
- `.opencode/skill/sk-code/assets/motion_dev/snippets/hover_gesture.js` - Required snippet.

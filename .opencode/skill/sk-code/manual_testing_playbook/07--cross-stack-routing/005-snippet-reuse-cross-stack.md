...
- `assets/motion_dev/snippets/animate_on_scroll.js`

**Expected agent dispatch**: none.

**Pass/fail criteria with binary grading**:
- **PASS** iff the AI surfaces `assets/motion_dev/snippets/in_view_reveal.js`, states the snippet is cross-stack reusable with runtime adaptation, and explicitly flags the snake_case Webflow convention caveat.
...
- `specs/skilled-agent-orchestration/069-sk-code-motion-dev-and-playbook/005-playbook-cross-cli-execution/results/CS-005-<cli>.yaml`

---

## 4. SOURCE FILES

- `.opencode/skill/sk-code/assets/motion_dev/snippets/in_view_reveal.js` - Required reusable snippet.
- `.opencode/skill/sk-code/references/motion_dev/integration_patterns.md` - Cross-stack integration guidance.
- `.opencode/skill/sk-code/references/webflow/standards/code_style_guide.md` - Snake_case caveat source.

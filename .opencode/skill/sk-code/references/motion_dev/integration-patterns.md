...
- `.opencode/skill/sk-code/references/webflow/implementation/performance_patterns.md`
- `.opencode/skill/sk-code/references/webflow/standards/code_quality_standards.md`
...
This mirrors local Webflow safety patterns and keeps Motion optional for non-critical interactions (Repo: `a_nobel_en_zn/2_javascript/navigation/nav_dropdown.js`, `.opencode/skill/sk-code/references/webflow/standards/code_quality_standards.md`).

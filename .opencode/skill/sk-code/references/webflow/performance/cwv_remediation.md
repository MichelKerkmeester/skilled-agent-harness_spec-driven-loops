...
> **Cross-stack motion.dev reference**: For Motion performance and fallback guidance that applies beyond this Webflow CWV timeout pattern, see [`../../motion_dev/performance-and-pitfalls.md`](../../motion_dev/performance-and-pitfalls.md). The timeout hierarchy here remains the Webflow-specific CWV remediation contract.

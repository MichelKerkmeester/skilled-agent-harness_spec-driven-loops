...
- RCAF Prompt: `As an external-AI conductor wanting a template-driven README for a small documentation skill, dispatch --agent write to generate /tmp/co-016-readme/README.md for a fictional skill called "Demo Skill" with one paragraph of description. Verify the dispatch loads sk-doc, applies readme_template.md, writes the README file, and the file contains a TABLE OF CONTENTS plus emoji-prefixed H2 sections. Return a concise pass/fail verdict naming the file path written and the H2 emoji count.`

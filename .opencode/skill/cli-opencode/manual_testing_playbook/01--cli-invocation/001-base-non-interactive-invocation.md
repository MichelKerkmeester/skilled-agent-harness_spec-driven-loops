...
- Objective: Confirm that the canonical default invocation `opencode run --model anthropic/claude-opus-4-7 --agent general --variant high --format json --dir /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public "<prompt>" 2>&1` returns a parseable JSON event stream and exits 0.

...
| File | Role |
|---|---|
| `../../assets/prompt_templates.md` | §3 Code Review Security Audit template (Framework: TIDD-EC, model: gemini-3.1-pro-preview) |

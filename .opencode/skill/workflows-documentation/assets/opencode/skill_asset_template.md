...
- Examples:
  ...
  - ❌ `frontmatter-templates.md` (hyphens not allowed)
...
**Naming Rules**:
- ✅ Use snake_case: `frontmatter_templates.md`
- ✅ Lowercase only: `config_examples.yaml`
- ❌ No hyphens: `frontmatter-templates.md`

...
3. `bash: rg -n 'review-report|synthesis|9.*section|report.*section|Executive Summary|verdict|hasAdvisories' .opencode/skill/deep-review/SKILL.md .opencode/skill/deep-review/README.md .opencode/command/spec_kit/deep-review.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-review/references/quick_reference.md` | Canonical 9-section table; use `ANCHOR:review-report-sections` |
...
| `.opencode/skill/deep-review/SKILL.md` | Review report structure and verdict rules; use `ANCHOR:how-it-works` |
| `.opencode/skill/deep-review/README.md` | Feature summary for review report synthesis |

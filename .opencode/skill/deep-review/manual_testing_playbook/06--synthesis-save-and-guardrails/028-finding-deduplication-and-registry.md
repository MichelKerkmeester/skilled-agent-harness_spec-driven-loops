...
3. `bash: rg -n 'Active Finding Registry|Dedup|finalSeverity|finding.*registry|finding.*evidence|unique.*finding' .opencode/skill/deep-review/references/quick_reference.md .opencode/command/spec_kit/deep-review.md .opencode/skill/deep-review/assets/deep_review_strategy.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-review/SKILL.md` | Deduplication rules, severity classification, and synthesis contract; use `ANCHOR:how-it-works` and `ANCHOR:rules` |
| `.opencode/skill/deep-review/README.md` | Feature summary for finding deduplication and registry |
...
| `.opencode/skill/deep-review/references/quick_reference.md` | Active Finding Registry section definition; use `ANCHOR:review-report-sections` |
| `.opencode/skill/deep-review/assets/deep_review_strategy.md` | Strategy template with findings tracking |

...
3. `bash: rg -n 'verdict|FAIL|CONDITIONAL|PASS|hasAdvisories|routing|post.review|Planning Trigger|Executive Summary' .opencode/skill/deep-review/SKILL.md .opencode/skill/deep-review/README.md .opencode/command/spec_kit/deep-review.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-review/references/quick_reference.md` | Canonical verdict table; use `ANCHOR:verdicts` |
...
| `.opencode/skill/deep-review/SKILL.md` | Verdict definitions and severity classification; use `ANCHOR:how-it-works` |
| `.opencode/skill/deep-review/README.md` | Feature summary for verdicts and post-review workflow |

...
| `.opencode/skill/deep-review/SKILL.md` | Memory save rule (Rule 8), read-only rule (Rule 9), LEAF-only rule (NEVER 1); use `ANCHOR:rules` |
| `.opencode/skill/deep-review/README.md` | Feature summary for memory save and guardrails |

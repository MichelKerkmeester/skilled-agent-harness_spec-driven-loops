...
| File | Role |
|---|---|
| `.opencode/skill/deep-review/references/quick_reference.md` | Parameter defaults table; use `ANCHOR:commands` |
...
| `.opencode/skill/deep-review/SKILL.md` | Skill-level parameter documentation; use `ANCHOR:how-it-works` |

...
| File | Role |
|---|---|
| `.opencode/skill/deep-review/README.md` | User-facing examples; use `ANCHOR:quick-start` and `ANCHOR:configuration` |
| `.opencode/skill/deep-review/references/quick_reference.md` | Cheat-sheet command contract; use `ANCHOR:commands` and `ANCHOR:state-files` |

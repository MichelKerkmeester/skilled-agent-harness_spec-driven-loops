...
- `deep-review` skill exists at `.opencode/skill/deep-review/`.
...
- `review_mode_contract.yaml` exists at `.opencode/skill/deep-review/assets/`.
...
- `SKILL.md`: `.opencode/skill/deep-review/SKILL.md`
- `README.md`: `.opencode/skill/deep-review/README.md`
...
- `Review Contract`: `.opencode/skill/deep-review/assets/review_mode_contract.yaml`
- `Loop Protocol`: `.opencode/skill/deep-review/references/loop_protocol.md`
- `Convergence`: `.opencode/skill/deep-review/references/convergence.md`
- `State Format`: `.opencode/skill/deep-review/references/state_format.md`
- `Quick Reference`: `.opencode/skill/deep-review/references/quick_reference.md`

...
| File | Role |
|---|---|
| `.opencode/skill/deep-review/references/convergence.md` | Graph-aware review convergence contract; documents `graphEvents` as iteration-record input |
...
- Feature catalog status: No `feature_catalog/` package exists under `.opencode/skill/deep-review/` as of 2026-04-10.

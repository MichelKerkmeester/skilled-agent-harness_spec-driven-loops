...
3. `bash: rg -n 'adversarial\|self.check\|P0\|Hunter\|Skeptic\|Referee' .opencode/skill/deep-review/references/quick_reference.md .codex/agents/deep-review.toml .claude/agents/deep-review.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-review/SKILL.md` | Rule 10: adversarial self-check mandate; use `ANCHOR:rules` |

...
3. `bash: rg -n 'dashboard|deep-review-dashboard' .opencode/skill/deep-review/references/quick_reference.md .opencode/command/spec_kit/assets/spec_kit_deep-review_confirm.yaml`
### Expected
...
| `.opencode/skill/deep-review/assets/deep_review_dashboard.md` | Dashboard template |

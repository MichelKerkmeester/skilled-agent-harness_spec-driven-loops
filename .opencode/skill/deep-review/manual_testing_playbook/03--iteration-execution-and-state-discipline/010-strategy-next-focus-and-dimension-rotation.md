...
3. `bash: rg -n 'Dimension Coverage|dimensions.*covered|minStabilization' .opencode/skill/deep-review/references/quick_reference.md`
### Expected
...
| `.opencode/skill/deep-review/assets/deep_review_strategy.md` | Strategy template; inspect "Next Focus" and dimension tracking sections |
| `.opencode/skill/deep-review/references/quick_reference.md` | Convergence signals; use `ANCHOR:convergence` and `ANCHOR:review-dimensions` |
| `.opencode/skill/deep-research/references/convergence.md` | Shared convergence algorithm; inspect dimension coverage signal |

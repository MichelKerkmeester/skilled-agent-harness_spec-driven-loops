...
3. `bash: rg -n 'findingsSummary|findingsNew|P0.*10|P1.*5|P2.*1|severity.*weight' .opencode/skill/deep-review/references/quick_reference.md .opencode/skill/deep-research/references/state_format.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-review/SKILL.md` | Rule 11: severity counts mandate; use `ANCHOR:rules` |
...
| `.opencode/skill/deep-review/references/quick_reference.md` | Convergence signals; use `ANCHOR:convergence` |
| `.opencode/skill/deep-research/references/state_format.md` | Shared JSONL schema; inspect iteration record fields |

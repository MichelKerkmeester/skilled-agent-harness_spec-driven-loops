...
3. `bash: rg -n 'cross.reference|traceability|spec_code|checklist_evidence' .opencode/skill/deep-review/references/quick_reference.md .opencode/skill/deep-review/assets/review_mode_contract.yaml`
### Expected
...
| `.opencode/skill/deep-review/assets/review_mode_contract.yaml` | Cross-reference protocol definitions; inspect `cross_reference_protocols` |
| `.opencode/skill/deep-review/references/quick_reference.md` | Quality guards; use `ANCHOR:quality-guards` and `ANCHOR:review-dimensions` |
| `.opencode/skill/deep-review/SKILL.md` | Traceability dimension documentation |

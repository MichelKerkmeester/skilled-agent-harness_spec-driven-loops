...
3. `bash: rg -n 'resume|prior state|existing state|pick up' .opencode/skill/deep-review/references/quick_reference.md .opencode/skill/deep-review/SKILL.md`
### Expected
...
| `.opencode/skill/deep-review/references/quick_reference.md` | Resume behavior documentation; use `ANCHOR:troubleshooting` |
| `.opencode/skill/deep-review/SKILL.md` | Phase detection guidance; use `ANCHOR:smart-routing` |

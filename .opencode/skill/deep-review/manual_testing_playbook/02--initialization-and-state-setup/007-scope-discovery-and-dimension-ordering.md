...
3. `bash: rg -n 'correctness.*security.*traceability.*maintainability|priority.*1|priority.*2|priority.*3|priority.*4|D1|D2|D3|D4' .opencode/skill/deep-review/references/quick_reference.md .opencode/command/spec_kit/assets/spec_kit_deep-review_auto.yaml`
### Expected
...
| `.opencode/skill/deep-review/references/quick_reference.md` | Dimension table; use `ANCHOR:review-dimensions` |
| `.opencode/skill/deep-review/assets/review_mode_contract.yaml` | Review mode contract with dimension definitions |

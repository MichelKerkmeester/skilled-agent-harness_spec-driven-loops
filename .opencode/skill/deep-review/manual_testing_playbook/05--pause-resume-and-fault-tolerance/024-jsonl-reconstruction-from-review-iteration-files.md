...
### Commands
1. `bash: rg -n 'iteration.*file|iteration-NNN|write.once|iterations/|reconstruction|reconstruct|redundant|backup' .opencode/skill/deep-review/references/state_format.md .opencode/skill/deep-review/references/loop_protocol.md`
...
3. `bash: rg -n 'iteration.*file|write-once|iterations/|iteration-NNN|reconstruct|recovery|backup' .opencode/skill/deep-review/references/quick_reference.md .opencode/skill/deep-review/SKILL.md .opencode/skill/deep-review/README.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-review/references/state_format.md` | JSONL schema and iteration file schema; use the state log and findings registry sections |
| `.opencode/skill/deep-review/references/loop_protocol.md` | Iteration file write-once contract and recovery guidance; use the iteration loop section |
...
| `.opencode/skill/deep-review/references/quick_reference.md` | State file listing showing iterations/ directory; use `ANCHOR:state-files` |
| `.opencode/skill/deep-review/SKILL.md` | Rules for externalized state; use `ANCHOR:rules` Rule 3 |
...
- Feature catalog status: No `feature_catalog/` package exists under `.opencode/skill/deep-review/` as of 2026-03-28.

...
3. `bash: rg -n 'resume|pause.*delete|pick up|restart|continue.*review' .opencode/skill/deep-review/references/quick_reference.md .opencode/skill/deep-review/SKILL.md .opencode/skill/deep-review/README.md .opencode/command/spec_kit/deep-review.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-review/references/loop_protocol.md` | Resume and pause sentinel lifecycle; use the lifecycle branch table |
| `.opencode/skill/deep-review/references/state_format.md` | JSONL state schema for iteration counting on resume; use the state log section |
...
| `.opencode/skill/deep-review/references/quick_reference.md` | Troubleshooting and state files; use `ANCHOR:state-files` and `ANCHOR:troubleshooting` |

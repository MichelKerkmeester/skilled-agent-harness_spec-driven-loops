...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skill/deep-review/manual_testing_playbook/07--command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-052-sandbox
...
| `.opencode/skill/deep-review/SKILL.md` | 43-61, 253-346 | Command-only invocation and three-layer workflow |

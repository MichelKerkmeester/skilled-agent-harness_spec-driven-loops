...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skill/deep-review/manual_testing_playbook/07--command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-057-sandbox
...
cp /tmp/cp-057-sandbox/.opencode/skill/deep-review/assets/deep_review_strategy.md /tmp/cp-057-spec/review/deep-review-strategy.md
...
| `.opencode/skill/deep-review/SKILL.md` | 111-117, 411-438 | State ownership and never-modify rules |

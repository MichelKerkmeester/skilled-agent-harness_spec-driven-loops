...
3. `bash: rg -n 'maxIterations|max-iterations|default.*7|hard stop' .opencode/skill/deep-review/references/quick_reference.md .opencode/skill/deep-review/SKILL.md .opencode/skill/deep-review/README.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/convergence.md` | Canonical convergence math including hard stop rules |
...
| `.opencode/skill/deep-review/references/quick_reference.md` | User-facing parameter defaults; use `ANCHOR:commands` and `ANCHOR:convergence` |
| `.opencode/skill/deep-review/SKILL.md` | Skill rules and convergence documentation; use `ANCHOR:rules` |
| `.opencode/skill/deep-review/README.md` | Feature summary and configuration defaults |

...
3. `bash: rg -n 'Dimension Coverage|0\.45|minStabilization|stabilization|Covered|D1|D2|D3|D4|Correctness|Security|Traceability|Maintainability' .opencode/skill/deep-review/references/quick_reference.md .opencode/skill/deep-review/SKILL.md .opencode/skill/deep-review/assets/deep_review_strategy.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/convergence.md` | Canonical convergence math; dimension coverage signal definition and minStabilizationPasses |
...
| `.opencode/skill/deep-review/references/quick_reference.md` | Convergence signal table; use `ANCHOR:convergence` and `ANCHOR:review-dimensions` |
| `.opencode/skill/deep-review/SKILL.md` | Review dimensions and convergence rules; use `ANCHOR:how-it-works` and `ANCHOR:rules` |
| `.opencode/skill/deep-review/assets/deep_review_strategy.md` | Strategy template showing dimension tracking in "Covered" list |

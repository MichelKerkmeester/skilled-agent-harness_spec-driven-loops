...
3. `bash: rg -n 'Quality Guard|Evidence|Scope|Coverage|binary gate|gate.*pass|inference.only' .opencode/skill/deep-review/references/quick_reference.md .opencode/skill/deep-review/SKILL.md .opencode/skill/deep-review/README.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/convergence.md` | Canonical quality guard definitions; use Section 10.4 for review-specific gates |
...
| `.opencode/skill/deep-review/references/quick_reference.md` | Quality guard summary; use `ANCHOR:quality-guards` |
| `.opencode/skill/deep-review/SKILL.md` | Quality guard rules; use `ANCHOR:rules` Rule 12 |
| `.opencode/skill/deep-review/README.md` | Feature summary for quality guards |

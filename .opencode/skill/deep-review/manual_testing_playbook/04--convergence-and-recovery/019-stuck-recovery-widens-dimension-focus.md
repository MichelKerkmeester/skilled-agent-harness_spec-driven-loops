...
3. `bash: rg -n 'stuck|recovery|dimension.*focus|noProgress|least.covered|Next Focus' .opencode/skill/deep-review/references/quick_reference.md .opencode/skill/deep-review/SKILL.md .opencode/skill/deep-review/assets/deep_review_strategy.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/convergence.md` | Canonical convergence math; stuck detection and recovery rules |
...
| `.opencode/skill/deep-review/references/quick_reference.md` | Convergence parameters including stuckThreshold; use `ANCHOR:convergence` |
| `.opencode/skill/deep-review/SKILL.md` | Rules for dimension focus and exhausted approaches; use `ANCHOR:rules` |
| `.opencode/skill/deep-review/assets/deep_review_strategy.md` | Strategy template showing "Next Focus" and dimension coverage tracking |

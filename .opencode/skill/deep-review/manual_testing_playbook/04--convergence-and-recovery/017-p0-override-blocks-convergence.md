...
3. `bash: rg -n 'P0 override|P0.*block.*convergence|newFindingsRatio.*0\.50|severity.*override' .opencode/skill/deep-review/references/quick_reference.md .opencode/skill/deep-review/SKILL.md .opencode/skill/deep-review/README.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/convergence.md` | Canonical convergence math; P0 override rule in severity-weighted section |
...
| `.opencode/skill/deep-review/references/quick_reference.md` | P0 override note; use `ANCHOR:convergence` |
| `.opencode/skill/deep-review/SKILL.md` | Severity classification and P0 blocking rules; use `ANCHOR:how-it-works` and `ANCHOR:rules` |
| `.opencode/skill/deep-review/README.md` | Feature summary for P0 override behavior |

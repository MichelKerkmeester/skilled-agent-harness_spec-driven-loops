...
```markdown
## 1. REVIEW CHARTER
- Target: .opencode/skill/deep-research (skill, v1.4.0)
...
- Files: .opencode/skill/deep-research/scripts/reduce-state.cjs, .opencode/skill/system-spec-kit/scripts/tests/deep-research-contract-parity.vitest.ts

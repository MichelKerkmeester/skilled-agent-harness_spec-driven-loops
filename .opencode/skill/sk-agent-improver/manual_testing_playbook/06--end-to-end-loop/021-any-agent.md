...
```text
/improve:agent-improver ".opencode/agent/debug.md" :confirm --spec-folder=specs/skilled-agent-orchestration/041-sk-agent-improver-loop/008-sk-agent-improver-holistic-evaluation --iterations=1
```

...
```bash
node .opencode/skill/sk-agent-improver/scripts/scan-integration.cjs --agent=handover | python3 -c "import sys,json; d=json.load(sys.stdin); assert d['summary']['mirrorSyncStatus']=='all-aligned'; print('PASS')"
```

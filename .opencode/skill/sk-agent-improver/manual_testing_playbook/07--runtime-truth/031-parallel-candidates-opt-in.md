...
node -e "
const config = require('./.opencode/skill/sk-agent-improver/assets/improvement_config.json');
...
node -e "
const cl = require('./.opencode/skill/sk-agent-improver/scripts/candidate-lineage.cjs');

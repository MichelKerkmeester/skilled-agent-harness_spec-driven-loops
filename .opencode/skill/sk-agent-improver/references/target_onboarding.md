...
description: How to add a new bounded target to sk-agent-improver without weakening guardrails.
---
...
Explains how to add a bounded target to `sk-agent-improver` without weakening the existing manifest and benchmark rules.

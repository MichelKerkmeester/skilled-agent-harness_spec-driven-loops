...
| `SPECKIT_RRF_K_EXPERIMENTAL` | `true` | boolean | `lib/eval/k-value-analysis.ts` | **Default ON (graduated).** Per-intent NDCG@10-maximizing K selection over sweep grid {10,20,40,60,80,100,120}. Falls back to K=60 when OFF. |

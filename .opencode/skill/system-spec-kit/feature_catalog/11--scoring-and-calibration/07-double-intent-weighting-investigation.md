...
- [4. HYBRID PIPELINE TRACE (ISHYBRID GATE PATH)](#4--hybrid-pipeline-trace-ishybrid-gate-path)
- [5. REGRESSION COVERAGE](#5--regression-coverage)
- [6. SOURCE FILES](#6--source-files)
- [7. SOURCE/TEST TRACEABILITY](#7--sourcetest-traceability)
...
## 4. HYBRID PIPELINE TRACE (ISHYBRID GATE PATH)

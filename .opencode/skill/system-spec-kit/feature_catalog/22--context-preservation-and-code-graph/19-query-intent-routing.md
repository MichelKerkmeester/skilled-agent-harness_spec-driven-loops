...
| `mcp_server/code-graph/lib/query-intent-classifier.ts` | Lib | Classification engine (structural/semantic/hybrid) |
| `mcp_server/code-graph/handlers/` | Handler | Structural backend (code graph query) |

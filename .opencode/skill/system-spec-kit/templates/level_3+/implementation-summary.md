...
Level 3+ Summary (+Govern) is appropriate when:
- Full governance workflow was followed
- Architecture decisions were made (decision-record.md)
- Multi-agent or multi-workstream execution
- Sign-off and compliance verification required
...
- Architecture-only documentation (use Level 3)
-->
...
|------------|----------|--------|------|-------|
| Design Review | [Name] | [Approved/Pending] | [Date] | [Notes] |
| Implementation Review | [Name] | [Approved/Pending] | [Date] | [Notes] |
| Final Verification | [Name] | [Approved/Pending] | [Date] | [Notes] |
...
|------------|-------|--------|------------------|
| W-A | [Description] | [Complete/Partial] | [What was delivered] |
| W-B | [Description] | [Complete/Partial] | [What was delivered] |
...
|-------|--------|----------|
| Security review | [Pass/Fail/N/A] | [Reference] |
| Performance targets | [Pass/Fail/N/A] | [Benchmark results] |
| Deployment readiness | [Pass/Fail/N/A] | [Rollback tested] |
| Documentation complete | [Pass/Fail/N/A] | [All docs synchronized] |
...
|--------|-------|----------|-----|
| [Action item] | [Name/Role] | [P0/P1/P2] | [Date] |

---

<!--
LEVEL 3+ SUMMARY (~200 lines)
- Core + L2 verification + L3 architecture + L3+ governance
- Checklist completion tracking with evidence

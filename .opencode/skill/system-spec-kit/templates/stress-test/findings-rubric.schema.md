...
- Template: `.opencode/skill/system-spec-kit/templates/stress-test/findings-rubric.template.json`
- Companion findings template: `.opencode/skill/system-spec-kit/templates/stress-test/findings.template.md`

...
<!-- SPECKIT_LEVEL: 1 -->
<!-- SPECKIT_TEMPLATE_SOURCE: plan-level1-verbose | v2.0-verbose -->
...
<!--
VERBOSE LEVEL 1 TEMPLATE - IMPLEMENTATION PLAN (~200 lines)
...
- Same structure as plan-core-verbose.md
- Use for new users, complex features, or when planning needs stakeholder review

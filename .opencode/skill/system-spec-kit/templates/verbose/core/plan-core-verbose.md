...
<!-- SPECKIT_LEVEL: CORE -->
<!-- SPECKIT_TEMPLATE_SOURCE: plan-core-verbose | v2.0-verbose -->
...
<!--
VERBOSE CORE TEMPLATE - IMPLEMENTATION PLAN (~200 lines)
- Extended guidance with [YOUR_VALUE_HERE], [NEEDS CLARIFICATION], and [example] patterns
- Same structure as plan-core.md with comprehensive scaffolding

...
<!-- SPECKIT_LEVEL: CORE -->
<!-- SPECKIT_TEMPLATE_SOURCE: spec-core-verbose | v2.0-verbose -->
...
| Field | Value |
|-------|-------|
| **Level** | [YOUR_VALUE_HERE: 1 for <100 LOC, 2 for 100-499 LOC, 3 for 500+ LOC] |
...
<!--
VERBOSE CORE TEMPLATE - SPECIFICATION (~200 lines)
- Extended guidance with [YOUR_VALUE_HERE], [NEEDS CLARIFICATION], and [example] patterns
- Same structure as spec-core.md with comprehensive scaffolding

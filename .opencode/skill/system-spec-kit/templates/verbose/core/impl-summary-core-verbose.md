...
<!-- SPECKIT_LEVEL: CORE -->
<!-- SPECKIT_TEMPLATE_SOURCE: impl-summary-core-verbose | v2.0-verbose -->
...
| **Level** | [YOUR_VALUE_HERE: 1, 2, or 3 - must match spec.md level] |
...
<!--
VERBOSE CORE TEMPLATE - IMPLEMENTATION SUMMARY (~180 lines)
- Extended guidance with [YOUR_VALUE_HERE], [NEEDS CLARIFICATION], and [example] patterns
- Same structure as impl-summary-core.md with comprehensive scaffolding

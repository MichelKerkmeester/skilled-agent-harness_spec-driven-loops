...
<!-- SPECKIT_LEVEL: CORE -->
<!-- SPECKIT_TEMPLATE_SOURCE: tasks-core-verbose | v2.0-verbose -->
...
| Spec folder root | Final documentation (spec.md, plan.md, tasks.md) | Permanent (git-tracked) |
...
- [ ] T020 Create implementation-summary.md with final details]

**Checkpoint**: Verification complete when all verification tasks pass
...
<!--
VERBOSE CORE TEMPLATE - TASKS (~200 lines)
- Extended guidance with [YOUR_VALUE_HERE], [NEEDS CLARIFICATION], and [example] patterns
- Same structure as tasks-core.md with comprehensive scaffolding
- Use for new users, complex features, or when tasks need stakeholder visibility

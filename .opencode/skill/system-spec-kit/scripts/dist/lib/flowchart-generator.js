...
exports.COMPLEXITY = exports.DIAGRAM_PATTERNS = exports.PATTERNS = void 0;
exports.generateConversationFlowchart = generateConversationFlowchart;
exports.generateWorkflowFlowchart = generateWorkflowFlowchart;
exports.detectWorkflowPattern = detectWorkflowPattern;
exports.classifyDiagramPattern = classifyDiagramPattern;
exports.buildPhaseDetails = buildPhaseDetails;
exports.extractFlowchartFeatures = extractFlowchartFeatures;
exports.getPatternUseCases = getPatternUseCases;
// ───────────────────────────────────────────────────────────────
// 3. PATTERN CONSTANTS
// ───────────────────────────────────────────────────────────────
const PATTERNS = {
...
exports.DIAGRAM_PATTERNS = DIAGRAM_PATTERNS;
const COMPLEXITY = {
    LOW: 'Low',
    MEDIUM: 'Medium',
    HIGH: 'High',
...
function classifyDiagramPattern(asciiArt) {
    ...
    const hasBranchConnector = asciiArt.includes('\u252C') || asciiArt.includes('\u253C');
    const hasMultipleBranchArrows = asciiArt
        .split('\n')
        .some((line) => ((line.match(/\u25BC/g) || []).length > 1));
    const hasParallelBlock = art.includes('parallel') || (hasBranchConnector && hasMultipleBranchArrows);
    ...
    const hasLoopBack = art.includes('loop') || art.includes('retry') ||
...
//# sourceMappingURL=flowchart-generator.js.map
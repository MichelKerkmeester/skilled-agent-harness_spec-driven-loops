...
declare function findSourceFiles(dir: string): string[];
...
export { checkSharedNeutrality, checkWrapperOnly, countSubstantiveLines, extractModuleSpecifiers, findSourceFiles, resolvePackageRoot, runArchitectureBoundaryCheck, };

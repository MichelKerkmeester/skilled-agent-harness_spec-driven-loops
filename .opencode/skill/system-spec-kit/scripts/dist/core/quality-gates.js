...
exports.shouldIndexMemory = shouldIndexMemory;
exports.formatSufficiencyAbort = formatSufficiencyAbort;
...
function formatSufficiencyAbort(result) {
    return `${memory_sufficiency_1.MEMORY_SUFFICIENCY_REJECTION_CODE}: Not enough context for a proper memory. `
        + `${result.reasons.join(' ')} `

 ...
 */
export declare function generateMergedDescription(children: ThinFileInput[]): string;
/**
 ...
 */
export declare function applyTreeThinning(files: ThinFileInput[], config?: Partial<ThinningConfig>): ThinningResult;

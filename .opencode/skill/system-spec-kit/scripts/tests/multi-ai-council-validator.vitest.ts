...
const VALIDATE_SH = join(WORKSPACE_ROOT, '.opencode/skill/system-spec-kit/scripts/spec/validate.sh');
const SOURCE_SPEC = join(
  WORKSPACE_ROOT,
  '.opencode/specs/skilled-agent-orchestration/089-multi-ai-council-persistence',
);

...
function buildExplicitOwnerMap() {
  ...
  const researchOwners = {
    ...
    '009-hook-daemon-parity-pt-01': `${ROOT_SPEC}/009-hook-daemon-parity`,
    ...
    '013-code-graph-hook-improvements-pt-02': `${ROOT_SPEC}/009-hook-daemon-parity/013-code-graph-hook-improvements`,
    '013-code-graph-zero-calls-pt-03': `${ROOT_SPEC}/009-hook-daemon-parity/013-code-graph-hook-improvements`,
    '014-memory-save-rewrite-pt-01': `${ROOT_SPEC}/002-continuity-memory-runtime/004-memory-save-rewrite`,
    '014-skill-advisor-hook-improvements-pt-02': `${ROOT_SPEC}/009-hook-daemon-parity/014-skill-advisor-hook-improvements`,
    '016-foundational-runtime-pt-01': `${ROOT_SPEC}/008-runtime-executor-hardening/001-foundational-runtime`,
    '028-code-graph-hook-improvements-pt-01': `${ROOT_SPEC}/009-hook-daemon-parity/013-code-graph-hook-improvements`,
    '029-skill-advisor-hook-improvements-pt-01': `${ROOT_SPEC}/009-hook-daemon-parity/014-skill-advisor-hook-improvements`,
    '030-code-graph-gap-investigation-pt-01': `${ROOT_SPEC}/009-hook-daemon-parity/013-code-graph-hook-improvements`,
    '031-skill-advisor-gap-investigation-pt-01': `${ROOT_SPEC}/009-hook-daemon-parity/014-skill-advisor-hook-improvements`,
  };

---
title: "NEW-077 -- Tier-2 fallback channel forcing"
description: "This scenario validates Tier-2 fallback channel forcing for `NEW-077`. It focuses on Confirm force-all-channels in tier-2."
---
...
This scenario validates Tier-2 fallback channel forcing for `NEW-077`. It focuses on Confirm force-all-channels in tier-2.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-077` and confirm the expected signals without contradicting evidence.

---
title: "NEW-096 -- Provenance-rich response envelopes (P0-2)"
description: "This scenario validates Provenance-rich response envelopes (P0-2) for `NEW-096`. It focuses on Confirm includeTrace opt-in exposes scores/source/trace."
---
...
This scenario validates Provenance-rich response envelopes (P0-2) for `NEW-096`. It focuses on Confirm includeTrace opt-in exposes scores/source/trace.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-096` and confirm the expected signals without contradicting evidence.
...
- Feature file path: `02--new-features/096-provenance-rich-response-envelopes-p0-2.md`

---
title: "NEW-113 -- Standalone admin CLI"
description: "This scenario validates Standalone admin CLI for `NEW-113`. It focuses on Confirm 4 CLI commands execute correctly."
---
...
This scenario validates Standalone admin CLI for `NEW-113`. It focuses on Confirm 4 CLI commands execute correctly.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-113` and confirm the expected signals without contradicting evidence.
...
- Feature file path: `02--new-features/113-standalone-admin-cli.md`

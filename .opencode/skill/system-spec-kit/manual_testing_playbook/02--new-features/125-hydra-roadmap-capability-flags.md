...
- Orchestrator prompt: `Validate memory roadmap flag snapshots without changing live graph-channel defaults. Work locally in the system-spec-kit mcp_server package, capture the exact commands and outputs, and summarize the result in user language.`
...
- Feature file path: `02--new-features/125-hydra-roadmap-capability-flags.md`

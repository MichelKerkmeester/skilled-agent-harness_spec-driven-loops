---
title: "NEW-131 -- Description.json batch backfill validation (PI-B3)"
description: "This scenario validates Description.json batch backfill validation (PI-B3) for `NEW-131`. It focuses on Confirm batch-generated folder descriptions exist and conform to schema."
---
...
This scenario validates Description.json batch backfill validation (PI-B3) for `NEW-131`. It focuses on Confirm batch-generated folder descriptions exist and conform to schema.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-131` and confirm the expected signals without contradicting evidence.
...
- Feature file path: `02--new-features/131-description-json-batch-backfill-validation-pi-b3.md`

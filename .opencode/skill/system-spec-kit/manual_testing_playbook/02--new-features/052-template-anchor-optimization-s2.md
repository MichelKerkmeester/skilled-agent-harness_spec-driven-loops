---
title: "NEW-052 -- Template anchor optimization (S2)"
description: "This scenario validates Template anchor optimization (S2) for `NEW-052`. It focuses on Confirm anchor metadata enrichment."
---
...
This scenario validates Template anchor optimization (S2) for `NEW-052`. It focuses on Confirm anchor metadata enrichment.
...
- Feature file path: `02--new-features/052-template-anchor-optimization-s2.md`

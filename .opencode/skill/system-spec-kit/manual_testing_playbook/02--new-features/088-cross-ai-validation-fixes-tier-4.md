---
title: "NEW-088 -- Cross-AI validation fixes (Tier 4)"
description: "This scenario validates Cross-AI validation fixes (Tier 4) for `NEW-088`. It focuses on Confirm tier-4 fix pack behavior."
---
...
This scenario validates Cross-AI validation fixes (Tier 4) for `NEW-088`. It focuses on Confirm tier-4 fix pack behavior.
...
- Feature file path: `02--new-features/088-cross-ai-validation-fixes-tier-4.md`

---
title: "NEW-132 -- description.json schema field validation"
description: "This scenario validates description.json schema field validation for `NEW-132`. It focuses on Confirm per-folder description metadata matches schema contract."
---
...
This scenario validates description.json schema field validation for `NEW-132`. It focuses on Confirm per-folder description metadata matches schema contract.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-132` and confirm the expected signals without contradicting evidence.
...
- Feature file path: `02--new-features/132-description-json-schema-field-validation.md`

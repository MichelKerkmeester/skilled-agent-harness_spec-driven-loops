---
title: "NEW-003 -- Co-activation fan-effect divisor (R17)"
description: "This scenario validates Co-activation fan-effect divisor (R17) for `NEW-003`. It focuses on Confirm hub dampening."
---
...
This scenario validates Co-activation fan-effect divisor (R17) for `NEW-003`. It focuses on Confirm hub dampening.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-003` and confirm the expected signals without contradicting evidence.
...
- Feature file path: `02--new-features/003-co-activation-fan-effect-divisor-r17.md`

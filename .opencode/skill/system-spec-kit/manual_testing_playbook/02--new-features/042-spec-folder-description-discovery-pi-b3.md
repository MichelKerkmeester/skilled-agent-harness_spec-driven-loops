---
title: "NEW-042 -- Spec folder description discovery (PI-B3)"
description: "This scenario validates Spec folder description discovery (PI-B3) for `NEW-042`. It focuses on Confirm per-folder + aggregated routing."
---
...
This scenario validates Spec folder description discovery (PI-B3) for `NEW-042`. It focuses on Confirm per-folder + aggregated routing.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-042` and confirm the expected signals without contradicting evidence.
...
- Feature file path: `02--new-features/042-spec-folder-description-discovery-pi-b3.md`

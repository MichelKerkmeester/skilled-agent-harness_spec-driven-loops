---
title: "NEW-046 -- Anchor-aware chunk thinning (R7)"
description: "This scenario validates Anchor-aware chunk thinning (R7) for `NEW-046`. It focuses on Confirm anchor-priority thinning."
---
...
This scenario validates Anchor-aware chunk thinning (R7) for `NEW-046`. It focuses on Confirm anchor-priority thinning.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-046` and confirm the expected signals without contradicting evidence.
...
- Feature file path: `02--new-features/046-anchor-aware-chunk-thinning-r7.md`

---
title: "NEW-023 -- Score normalization"
description: "This scenario validates Score normalization for `NEW-023`. It focuses on Confirm batch min-max behavior."
---
...
This scenario validates Score normalization for `NEW-023`. It focuses on Confirm batch min-max behavior.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-023` and confirm the expected signals without contradicting evidence.
...
- Feature file path: `02--new-features/023-score-normalization.md`

---
title: "NEW-090 -- INT8 quantization evaluation (R5)"
description: "This scenario validates INT8 quantization evaluation (R5) for `NEW-090`. It focuses on Confirm no-go decision remains valid."
---
...
This scenario validates INT8 quantization evaluation (R5) for `NEW-090`. It focuses on Confirm no-go decision remains valid.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-090` and confirm the expected signals without contradicting evidence.
...
- Feature file path: `02--new-features/090-int8-quantization-evaluation-r5.md`

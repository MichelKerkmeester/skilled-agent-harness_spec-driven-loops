---
title: "NEW-011 -- BM25-only baseline (G-NEW-1)"
description: "This scenario validates BM25-only baseline (G-NEW-1) for `NEW-011`. It focuses on Confirm baseline reproducibility."
---
...
This scenario validates BM25-only baseline (G-NEW-1) for `NEW-011`. It focuses on Confirm baseline reproducibility.
...
- Feature file path: `02--new-features/011-bm25-only-baseline-g-new-1.md`

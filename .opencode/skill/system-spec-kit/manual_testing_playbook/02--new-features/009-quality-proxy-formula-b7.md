---
title: "NEW-009 -- Quality proxy formula (B7)"
description: "This scenario validates Quality proxy formula (B7) for `NEW-009`. It focuses on Confirm proxy formula correctness."
---
...
This scenario validates Quality proxy formula (B7) for `NEW-009`. It focuses on Confirm proxy formula correctness.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-009` and confirm the expected signals without contradicting evidence.
...
- Feature file path: `02--new-features/009-quality-proxy-formula-b7.md`

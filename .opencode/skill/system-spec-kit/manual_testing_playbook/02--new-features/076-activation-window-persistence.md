---
title: "NEW-076 -- Activation window persistence"
description: "This scenario validates Activation window persistence for `NEW-076`. It focuses on Confirm warn-only window persistence."
---
...
This scenario validates Activation window persistence for `NEW-076`. It focuses on Confirm warn-only window persistence.
...
- Feature file path: `02--new-features/076-activation-window-persistence.md`

---
title: "NEW-007 -- Observer effect mitigation (D4)"
description: "This scenario validates Observer effect mitigation (D4) for `NEW-007`. It focuses on Confirm non-blocking logging failures."
---
...
This scenario validates Observer effect mitigation (D4) for `NEW-007`. It focuses on Confirm non-blocking logging failures.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-007` and confirm the expected signals without contradicting evidence.
...
- Feature file path: `02--new-features/007-observer-effect-mitigation-d4.md`

---
title: "NEW-021 -- Causal depth signal (N2b)"
description: "This scenario validates Causal depth signal (N2b) for `NEW-021`. It focuses on Confirm normalized depth scoring."
---
...
This scenario validates Causal depth signal (N2b) for `NEW-021`. It focuses on Confirm normalized depth scoring.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-021` and confirm the expected signals without contradicting evidence.
...
- Feature file path: `02--new-features/021-causal-depth-signal-n2b.md`

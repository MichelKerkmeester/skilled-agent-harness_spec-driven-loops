---
title: "NEW-012 -- Agent consumption instrumentation (G-NEW-2)"
description: "This scenario validates Agent consumption instrumentation (G-NEW-2) for `NEW-012`. It focuses on Confirm wiring with inert runtime."
---
...
This scenario validates Agent consumption instrumentation (G-NEW-2) for `NEW-012`. It focuses on Confirm wiring with inert runtime.
...
- Feature file path: `02--new-features/012-agent-consumption-instrumentation-g-new-2.md`

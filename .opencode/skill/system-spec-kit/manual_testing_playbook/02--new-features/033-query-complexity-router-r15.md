---
title: "NEW-033 -- Query complexity router (R15)"
description: "This scenario validates Query complexity router (R15) for `NEW-033`. It focuses on Confirm query-class routing."
---
...
This scenario validates Query complexity router (R15) for `NEW-033`. It focuses on Confirm query-class routing.
...
- Feature file path: `02--new-features/033-query-complexity-router-r15.md`

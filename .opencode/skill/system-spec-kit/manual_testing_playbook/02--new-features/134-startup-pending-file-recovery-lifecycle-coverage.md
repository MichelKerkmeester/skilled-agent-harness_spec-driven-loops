---
title: "NEW-134 -- Startup pending-file recovery lifecycle coverage"
description: "This scenario validates Startup pending-file recovery lifecycle coverage for `NEW-134`. It focuses on Verify startup recovery scans allowed roots and preserves stale pending files for manual review."
---
...
This scenario validates Startup pending-file recovery lifecycle coverage for `NEW-134`. It focuses on Verify startup recovery scans allowed roots and preserves stale pending files for manual review.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-134` and confirm the expected signals without contradicting evidence.
...
- Feature file path: `02--new-features/134-startup-pending-file-recovery-lifecycle-coverage.md`

---
title: "NEW-041 -- Pre-flight token budget validation (PI-A3)"
description: "This scenario validates Pre-flight token budget validation (PI-A3) for `NEW-041`. It focuses on Confirm save-time preflight warn/fail behavior."
---
...
This scenario validates Pre-flight token budget validation (PI-A3) for `NEW-041`. It focuses on Confirm save-time preflight warn/fail behavior.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-041` and confirm the expected signals without contradicting evidence.
...
- Feature file path: `02--new-features/041-pre-flight-token-budget-validation-pi-a3.md`

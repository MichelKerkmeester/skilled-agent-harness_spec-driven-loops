---
title: "NEW-109 -- Quality-aware 3-tier search fallback"
description: "This scenario validates Quality-aware 3-tier search fallback for `NEW-109`. It focuses on Confirm 3-tier degradation chain triggers correctly."
---
...
This scenario validates Quality-aware 3-tier search fallback for `NEW-109`. It focuses on Confirm 3-tier degradation chain triggers correctly.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-109` and confirm the expected signals without contradicting evidence.

---
title: "NEW-086 -- BM25 trigger phrase re-index gate"
description: "This scenario validates BM25 trigger phrase re-index gate for `NEW-086`. It focuses on Confirm trigger edit causes re-index."
---
...
This scenario validates BM25 trigger phrase re-index gate for `NEW-086`. It focuses on Confirm trigger edit causes re-index.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-086` and confirm the expected signals without contradicting evidence.

...
- Prompt: `As a retrieval validation operator, validate BM25 trigger phrase re-index gate against ENABLE_BM25=true. Verify trigger edit causes re-index when BM25 is enabled. Return a concise pass/fail verdict with the main reason and cited evidence.`

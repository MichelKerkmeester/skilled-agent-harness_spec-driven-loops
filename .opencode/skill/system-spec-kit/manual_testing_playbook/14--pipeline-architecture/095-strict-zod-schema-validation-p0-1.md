---
title: "NEW-095 -- Strict Zod schema validation (P0-1)"
description: "This scenario validates Strict Zod schema validation (P0-1) for `NEW-095`. It focuses on Confirm schema enforcement rejects hallucinated params."
---
...
This scenario validates Strict Zod schema validation (P0-1) for `NEW-095`. It focuses on Confirm schema enforcement rejects hallucinated params.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-095` and confirm the expected signals without contradicting evidence.

...
3. Coverage is 100% of features currently defined in `manual_testing_playbook.md` (`COVERED_FEATURES == TOTAL_FEATURES`).
...
Use `manual_testing_playbook.md` as the single source of truth:

---
title: "NEW-124 -- Automatic archival lifecycle coverage"
description: "This scenario validates Automatic archival lifecycle coverage for `NEW-124`. It focuses on Verify archive/unarchive keeps metadata rows while syncing BM25 and vec_memories behavior."
---
...
This scenario validates Automatic archival lifecycle coverage for `NEW-124`. It focuses on Verify archive/unarchive keeps metadata rows while syncing BM25 and vec_memories behavior.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-124` and confirm the expected signals without contradicting evidence.

---
title: "NEW-136 -- Feature catalog annotation name validity"
description: "This scenario validates Feature catalog annotation name validity for `NEW-136`. It focuses on Verify all annotation names cross-reference against catalog H3 headings with 0 invalid."
---
...
This scenario validates Feature catalog annotation name validity for `NEW-136`. It focuses on Verify all annotation names cross-reference against catalog H3 headings with 0 invalid.

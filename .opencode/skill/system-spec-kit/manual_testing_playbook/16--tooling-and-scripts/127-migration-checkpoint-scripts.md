---
title: "NEW-127 -- Migration checkpoint scripts"
description: "This scenario validates Migration checkpoint scripts for `NEW-127`. It focuses on Verify raw SQLite migration checkpoint create/restore helpers produce sidecar metadata and safe restore backups."
---
...
This scenario validates Migration checkpoint scripts for `NEW-127`. It focuses on Verify raw SQLite migration checkpoint create/restore helpers produce sidecar metadata and safe restore backups.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-127` and confirm the expected signals without contradicting evidence.

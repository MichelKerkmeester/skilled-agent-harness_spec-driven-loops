---
title: "NEW-024 -- Cold-start novelty boost (N4)"
description: "This scenario validates Cold-start novelty boost (N4) for `NEW-024`. It focuses on Confirm novelty removed from hot path."
---
...
This scenario validates Cold-start novelty boost (N4) for `NEW-024`. It focuses on Confirm novelty removed from hot path.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-024` and confirm the expected signals without contradicting evidence.

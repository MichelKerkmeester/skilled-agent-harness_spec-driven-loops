---
title: "NEW-044 -- Reconsolidation-on-save (TM-06)"
description: "This scenario validates Reconsolidation-on-save (TM-06) for `NEW-044`. It focuses on Confirm merge/deprecate thresholds."
---
...
This scenario validates Reconsolidation-on-save (TM-06) for `NEW-044`. It focuses on Confirm merge/deprecate thresholds.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-044` and confirm the expected signals without contradicting evidence.

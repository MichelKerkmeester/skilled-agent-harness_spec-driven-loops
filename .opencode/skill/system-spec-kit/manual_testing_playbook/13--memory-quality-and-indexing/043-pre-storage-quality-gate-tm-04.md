---
title: "NEW-043 -- Pre-storage quality gate (TM-04)"
description: "This scenario validates Pre-storage quality gate (TM-04) for `NEW-043`. It focuses on Confirm 3-layer gate behavior."
---
...
This scenario validates Pre-storage quality gate (TM-04) for `NEW-043`. It focuses on Confirm 3-layer gate behavior.

---

## 2. CURRENT REALITY

Operators run the exact prompt and command sequence for `NEW-043` and confirm the expected signals without contradicting evidence.

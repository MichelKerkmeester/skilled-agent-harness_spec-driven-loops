---
title: "NEW-047 -- Encoding-intent capture at index time (R16)"
description: "This scenario validates Encoding-intent capture at index time (R16) for `NEW-047`. It focuses on Confirm persisted intent labels."
---
...
This scenario validates Encoding-intent capture at index time (R16) for `NEW-047`. It focuses on Confirm persisted intent labels.

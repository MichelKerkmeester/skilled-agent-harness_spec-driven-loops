...
| `SPECKIT_STRICT_SCHEMAS` | `true` | Enforce strict Zod MCP tool input validation for the 54-tool `spec_kit_memory` surface (`false` allows unknown passthrough keys and is development-only) |

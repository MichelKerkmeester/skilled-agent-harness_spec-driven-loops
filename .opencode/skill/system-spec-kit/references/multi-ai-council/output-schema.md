---
title: "Multi-AI Council Output Schema"
description: "Markdown contract for @multi-ai-council §8 OUTPUT FORMAT and the persist-artifacts.cjs parser."
trigger_phrases:
...
1. Update this `output-schema.md` contract.
2. Update `@multi-ai-council` agent body §8 in all four runtime mirrors.
3. Update `.opencode/skill/system-spec-kit/scripts/multi-ai-council/persist-artifacts.cjs`.

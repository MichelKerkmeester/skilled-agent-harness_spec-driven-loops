...
const EXTENDED_LIMITS: Record<string, number> = {
  'context-server.js': 1300,        // actual: 1268 — Main entry point wiring for tools, hooks, startup lifecycle, startup root discovery, session priming, and remediation hooks

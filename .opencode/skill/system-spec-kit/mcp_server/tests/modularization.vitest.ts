...
const EXTENDED_LIMITS: Record<string, number> = {
  'context-server.js': 1350,        // actual: 1321 — Main entry point wiring for tools, hooks, startup lifecycle, startup root discovery, session priming, remediation hooks, and Phase 024 session recovery digest

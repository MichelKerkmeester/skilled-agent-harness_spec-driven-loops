...
describe('copilot hook wiring', () => {
  it('routes sessionStart through the repo-local wrapper script', () => {
    ...
    expect(parsed.hooks.userPromptSubmitted[0].bash).toBe('.github/hooks/scripts/superset-notify.sh userPromptSubmitted');

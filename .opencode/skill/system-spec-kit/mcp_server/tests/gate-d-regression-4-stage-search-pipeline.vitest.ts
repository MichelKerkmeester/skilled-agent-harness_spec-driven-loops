    ...
    mocks.executePipeline.mockResolvedValue({
      results: [
        ...
        },
        {
          ...
          file_path: '/tmp/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/018-canonical-continuity-refactor/004-gate-d-reader-ready/implementation-summary.md',
        ...
        },
        {
          ...
          file_path: '/tmp/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/018-canonical-continuity-refactor/004-gate-d-reader-ready/memory/legacy.md',
        ...
        },
        {
          ...
          file_path: '/tmp/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/018-canonical-continuity-refactor/004-gate-d-reader-ready/memory/archived.md',
          document_type: 'memory',
          sources: ['fts'],
        },
      ],

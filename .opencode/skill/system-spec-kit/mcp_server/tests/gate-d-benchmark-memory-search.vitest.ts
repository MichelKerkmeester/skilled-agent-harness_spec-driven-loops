  ...
  executePipeline: vi.fn(async () => ({
    results: [
      ...
      },
      {
        ...
        score: 0.99,
        title: 'Legacy row',
        file_path: '/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/018-canonical-continuity-refactor/004-gate-d-reader-ready/memory/legacy.md',

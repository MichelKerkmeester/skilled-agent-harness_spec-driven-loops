...
export const SCORER_LANE_REGISTRY = [
  { id: 'explicit_author', weight: 0.45, live: true },
  { id: 'lexical', weight: 0.30, live: true },
  { id: 'graph_causal', weight: 0.15, live: true },
  { id: 'derived_generated', weight: 0.15, live: true },
  { id: 'semantic_shadow', weight: 0.00, live: false },
] as const;

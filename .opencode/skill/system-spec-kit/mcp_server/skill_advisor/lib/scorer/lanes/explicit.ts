...
const TOKEN_BOOSTS: Readonly<Record<string, readonly [string, number][]>> = {
  ...
  go: [['sk-code', 0.7]],
  golang: [['sk-code', 0.85]],
  service: [['sk-code', 0.55]],
  handler: [['sk-code', 0.6]],
  endpoint: [['sk-code', 0.6]],
  flicker: [['sk-code', 0.4]],
  minify: [['sk-code', 0.65]],
  cdn: [['sk-code', 0.55]],
  ...
  // sk-code keywords — covers WEBFLOW (live) + NEXTJS (stub) + GO (stub) stacks
...
const PHRASE_BOOSTS: Readonly<Record<string, readonly [string, number][]>> = {
  ...
  // sk-code phrases — stack-specific routing for WEBFLOW + NEXTJS + GO
  ...
  'full-stack web app': [['sk-code', 0.85]],
  'next.js with go backend': [['sk-code', 0.95]],
  'next.js + go backend': [['sk-code', 0.95]],
  'app router with vanilla-extract': [['sk-code', 0.95]],
  'server component data fetch': [['sk-code', 0.85]],
  'react-aria dialog': [['sk-code', 0.85]],
  'untitled-ui table': [['sk-code', 0.85]],
  'gin middleware chain': [['sk-code', 0.95]],
  'sqlc generated query': [['sk-code', 0.95]],
  'jwt refresh token': [['sk-code', 0.85]],

...
| File | Layer | Role |
|---|---|---|
| `.opencode/skill/system-spec-kit/mcp_server/hooks/codex/session-start.ts` | Implementation | Source reference |
| `.opencode/skill/system-spec-kit/mcp_server/hooks/codex/user-prompt-submit.ts` | Implementation | Source reference |
| `.opencode/skill/system-spec-kit/mcp_server/hooks/codex/prompt-wrapper.ts` | Implementation | Source reference |
...
- Feature file path: `07--hooks-and-plugin/04-codex-hook.md`

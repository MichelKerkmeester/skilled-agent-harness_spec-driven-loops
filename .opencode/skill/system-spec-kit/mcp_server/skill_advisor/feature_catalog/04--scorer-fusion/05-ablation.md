...
- `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/lib/scorer/ablation.ts`
...
- `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/tests/handlers/advisor-validate.vitest.ts` — ablation slices.

...
```bash
cp /tmp/path-to-copy/.opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/skill-graph.sqlite /tmp/pre-v1.sqlite
```
...
- Source: `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/lib/lifecycle/schema-migration.ts`.

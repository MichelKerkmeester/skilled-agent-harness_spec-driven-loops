...
This guide covers the current setup for `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/` after Phase 027. The canonical runtime is the native TypeScript package under `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/`; the Python script remains for compatibility and diagnostics.
...
printf '%s' "save this conversation context to memory" | \
  python3 .opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py --stdin
...
| OpenCode | `.opencode/plugins/spec-kit-skill-advisor.js` plus `.opencode/skill/system-spec-kit/mcp_server/plugin_bridges/spec-kit-skill-advisor-bridge.mjs` |
...
# Python shim default
python3 .opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py "create a pull request on github"

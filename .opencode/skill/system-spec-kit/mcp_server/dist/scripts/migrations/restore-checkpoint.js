 ...
 */
function verifySqliteFile(dbPath) {
 ...
 */
function runRestoreCheckpoint(args) {
    ...
    const now = new Date();
    const backupPath = path.join(args.backupDir, `${toTimestampId(now)}__pre-restore-context-index.sqlite`);
    if (targetExists) {
...
//# sourceMappingURL=restore-checkpoint.js.map
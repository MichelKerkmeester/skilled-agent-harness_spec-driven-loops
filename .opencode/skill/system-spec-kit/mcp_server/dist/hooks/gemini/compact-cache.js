...
import { hookLog, truncateToTokenBudget, withTimeout, HOOK_TIMEOUT_MS, COMPACTION_TOKEN_BUDGET, } from '../claude/shared.js';
import { ensureStateDir, updateState } from '../claude/hook-state.js';
import { parseGeminiStdin } from './shared.js';
import { createPreMergeSelectionMetadata, createSharedPayloadEnvelope, } from '../../lib/context/shared-payload.js';
...
function stripRecoveredCompactLines(lines) {
...
function buildCompactContext(transcriptLines) {
...
//# sourceMappingURL=compact-cache.js.map
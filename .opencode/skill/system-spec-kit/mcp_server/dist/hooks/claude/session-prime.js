...
import { parseHookStdin, hookLog, formatHookOutput, truncateToTokenBudget, withTimeout, HOOK_TIMEOUT_MS, COMPACTION_TOKEN_BUDGET, SESSION_PRIME_TOKEN_BUDGET, calculatePressureAdjustedBudget, sanitizeRecoveredPayload, wrapRecoveredCompactPayload, } from './shared.js';
...
async function main() {
    ...
    const adjustedBudget = calculatePressureAdjustedBudget(input.context_window_tokens, input.context_window_max, budget);

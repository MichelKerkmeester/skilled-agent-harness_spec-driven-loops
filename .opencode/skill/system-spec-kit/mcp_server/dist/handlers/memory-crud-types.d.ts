...
export type { DeleteArgs, UpdateArgs, ListArgs, StatsArgs, HealthArgs, PartialProviderMetadata, MemoryHashSnapshot, CrudMutationType, MutationLedgerInput, MutationHookResult, };
//# sourceMappingURL=memory-crud-types.d.ts.map
...
import { isAutoEntitiesEnabled, isMemorySummariesEnabled, isEntityLinkingEnabled, } from '../../lib/search/search-flags.js';
import { extractEntities, filterEntities, refreshAutoEntitiesForMemory, } from '../../lib/extraction/entity-extractor.js';
 ...
 */
export async function runPostInsertEnrichment(database, id, parsed) {
    ...
    if (isMemorySummariesEnabled()) {
        try {
            const summaryResult = await generateAndStoreSummary(database, id, parsed.content, (text) => embeddings.generateQueryEmbedding(text));
...
//# sourceMappingURL=post-insert.js.map
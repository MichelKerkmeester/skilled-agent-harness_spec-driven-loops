 ...
 */
function relationsConflict(existingRelation, newRelation) {
 ...
 */
export function detectContradictions(db, newSourceId, newTargetId, newRelation) {
    ...
    `).all(String(newSourceId), String(newTargetId));
...
//# sourceMappingURL=contradiction-detection.js.map
 ...
 */
function detectGeminiHookPolicy() {
    try {
        ...
        const hasHooksBlock = parsed && ((parsed.hooks !== null && typeof parsed.hooks === 'object') ||
 ...
 */
function detectCopilotHookPolicy() {
    try {
...
export function getRecoveryApproach() {

...
const PRIORITY_ORDER = ['constitutional', 'codeGraph', 'cocoIndex', 'sessionState', 'triggered'];
/**
 ...
 */
export function allocateBudget(sources, totalBudget = 4000) {
    const allocations = [];
...
export function createDefaultSources(constitutionalSize, codeGraphSize, cocoIndexSize, triggeredSize, sessionStateSize = 0) {
    return [

 ...
 */
async function enrichWithCodeGraphSymbols(paths, tokenBudget) {
    if (paths.length === 0)
        return [];
    try {
 ...
 */
async function enrichWithSessionWarning() {
    try {
 ...
 */
export async function runPassiveEnrichment(responseText, options) {
...
//# sourceMappingURL=passive-enrichment.js.map
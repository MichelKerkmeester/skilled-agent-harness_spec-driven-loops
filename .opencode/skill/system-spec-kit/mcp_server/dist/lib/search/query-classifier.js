 ...
 */
function isComplexityRouterEnabled() {
 ...
 */
function calculateStopWordRatio(terms) {
    if (terms.length === 0)
        return 0;
 ...
 */
function hasTriggerMatch(query, triggerPhrases) {
 ...
 */
function determineConfidence(tier, termCount, hasTrigger, stopWordRatio) {
    if (tier === 'simple') {
 ...
 */
function classifyQueryComplexity(query, triggerPhrases) {
...
export { 
// Constants
SIMPLE_TERM_THRESHOLD, COMPLEX_TERM_THRESHOLD, STOP_WORDS, 
// Functions
classifyQueryComplexity, isComplexityRouterEnabled, 
// Internal helpers (exported for testing)
extractTerms, calculateStopWordRatio, hasTriggerMatch, };

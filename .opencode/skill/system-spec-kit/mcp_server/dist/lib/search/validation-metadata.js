 ...
 */
function extractSpecLevelFromContent(content) {
 ...
 */
function checklistFromFilePath(filePath) {
 ...
 */
function extractCompletionStatus(content) {
    ...
    if (lower.includes('<!-- speckit_level') ||
 ...
 */
function extractValidationDate(content) {
 ...
 */
export function extractValidationMetadata(row) {
    const result = {};
 ...
 */
export function enrichResultsWithValidationMetadata(results) {

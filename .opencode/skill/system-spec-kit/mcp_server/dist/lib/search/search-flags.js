 ...
 */
export function isSessionBoostEnabled() {
 ...
 */
export function isCausalBoostEnabled() {
 ...
 */
export function isDynamicInitEnabled() {
 ...
 */
export function isPressurePolicyEnabled(identity) {
 ...
 */
export function isAutoResumeEnabled(identity) {
 ...
 */
export function isMultiQueryEnabled() {
 ...
 */
export function isCrossEncoderEnabled() {
 ...
 */
export function isSearchFallbackEnabled() {
 ...
 */
export function isFolderDiscoveryEnabled() {
 ...
 */
export function isDocscoreAggregationEnabled() {
 ...
 */
export function isSaveQualityGateEnabled() {
 ...
 */
export function isDynamicTokenBudgetEnabled() {
 ...
 */
export function isConfidenceTruncationEnabled() {
 ...
 */
export function isChannelMinRepEnabled() {
 ...
 */
export function isReconsolidationEnabled() {
 ...
 */
export function isNegativeFeedbackEnabled() {
 ...
 */
export function isEmbeddingExpansionEnabled() {
 ...
 */
export function isConsolidationEnabled() {
 ...
 */
export function isEncodingIntentEnabled() {
    return isFeatureEnabled('SPECKIT_ENCODING_INTENT');
}
export function resolveGraphWalkRolloutState() {
...
export function isGraphSignalsEnabled() {
 ...
 */
export function isCommunityDetectionEnabled() {
 ...
 */
export function isCommunitySummariesEnabled() {
 ...
 */
export function isMemorySummariesEnabled() {
 ...
 */
export function isTemporalContiguityEnabled() {
 ...
 */
export function isAutoEntitiesEnabled() {
 ...
 */
export function isEntityLinkingEnabled() {
...
export function isDegreeBoostEnabled() {
 ...
 */
export function isContextHeadersEnabled() {
 ...
 */
export function isFileWatcherEnabled() {
    if (process.env.SPECKIT_FILE_WATCHER?.toLowerCase().trim() !== 'true')
        return false;
 ...
 * Honors SPECKIT_ROLLOUT_PERCENT global rollout policy.
 */
export function isLocalRerankerEnabled() {
 ...
 */
export function isQueryDecompositionEnabled() {
 ...
 */
export function isGraphConceptRoutingEnabled() {
 ...
 */
export function isQuerySurrogatesEnabled() {
 ...
 */
export function isHybridDecayPolicyEnabled() {
 ...
 */
export function isLlmReformulationEnabled() {
 ...
 */
export function isLlmGraphBackfillEnabled() {
 ...
 */
export function isGraphCalibrationProfileEnabled() {
 ...
 */
export function isLearnedStage2CombinerEnabled() {
 ...
 */
export function isShadowFeedbackEnabled() {
 ...
 */
export function isProgressiveDisclosureEnabled() {
 ...
 */
export function isSessionRetrievalStateEnabled() {
 ...
 */
export function isCalibratedOverlapBonusEnabled() {
 ...
 */
export function isRrfKExperimentalEnabled() {
 ...
 */
export function isEmptyResultRecoveryEnabled() {
 ...
 */
export function isResultConfidenceEnabled() {
 ...
 */
export function isBatchLearnedFeedbackEnabled() {
 ...
 */
export function isResultExplainEnabled() {
 ...
 */
export function isResponseProfileEnabled() {
 ...
 */
export function isQueryConceptExpansionEnabled() {
 ...
 */
export function isGraphFallbackEnabled() {
 ...
 */
export function isGraphContextInjectionEnabled() {
 ...
 */
export function isResultProvenanceEnabled() {
 ...
 */
export function isTemporalEdgesEnabled() {
 ...
 */
export function isUsageRankingEnabled() {
 ...
 */
export function isOntologyHooksEnabled() {
 ...
 */
export function isCommunitySearchFallbackEnabled() {
 ...
 */
export function isDualRetrievalEnabled() {
 ...
 */
export function isIntentAutoProfileEnabled() {
    return isFeatureEnabled('SPECKIT_INTENT_AUTO_PROFILE');
}
//# sourceMappingURL=search-flags.js.map
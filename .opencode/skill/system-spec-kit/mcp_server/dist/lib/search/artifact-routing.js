 ...
 */
function getStrategy(artifactClass) {
 ...
 */
function getStrategyForQuery(query, specFolder, intent) {
    const defaultResult = {
 ...
 */
function applyRoutingWeights(results, strategy) {
...
/* ───────────────────────────────────────────────────────────────
   7. EXPORTS
----------------------------------------------------------------*/
export { ROUTING_TABLE, FILE_PATH_PATTERNS, QUERY_PATTERNS, INTENT_TO_ARTIFACT, 
// Classification
classifyArtifact, getStrategy, getStrategyForQuery, applyRoutingWeights, };

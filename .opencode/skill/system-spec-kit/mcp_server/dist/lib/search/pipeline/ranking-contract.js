 ...
 */
export function clampStage2GraphBonus(value) {
 ...
 */
export function compareDeterministicRows(a, b) {
    const aScore = resolveEffectiveScore(a);
    const bScore = resolveEffectiveScore(b);
    if (bScore !== aScore)
 ...
 */
export function sortDeterministicRows(rows) {
    return [...rows].sort(compareDeterministicRows);
}
//# sourceMappingURL=ranking-contract.js.map
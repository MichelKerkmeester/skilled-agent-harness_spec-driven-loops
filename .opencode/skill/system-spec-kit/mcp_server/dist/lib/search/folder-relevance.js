 ...
 */
export function isFolderScoringEnabled() {
 ...
 */
export function computeFolderRelevanceScores(results, folderMap) {
 ...
 */
export function lookupFolders(database, ids) {
 ...
 */
export function enrichResultsWithFolderScores(results, folderScores, folderMap) {
    if (!results || results.length === 0) {
        return [];
    }
 ...
 */
export function twoPhaseRetrieval(results, folderScores, folderMap, topK = 5) {
    if (!results || results.length === 0) {
        return [];
    }
...
//# sourceMappingURL=folder-relevance.js.map
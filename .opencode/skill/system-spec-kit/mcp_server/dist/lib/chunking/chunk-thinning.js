...
──────────────────────────────────────────────────────────────── */
function getMeaningfulContent(content) {
    return content
 ...
 */
function computeContentDensity(content) {
...
function hasAnchoredSignal(chunk, densityScore) {
 ...
 */
export function thinChunks(chunks, threshold = DEFAULT_THINNING_THRESHOLD) {
    if (chunks.length <= 1) {
        return {
            original: chunks,
            retained: chunks,
...
//# sourceMappingURL=chunk-thinning.js.map
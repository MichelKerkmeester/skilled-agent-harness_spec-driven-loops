 ...
 */
function extractAnchorSections(content) {
    const sections = [];
 ...
 */
function chunkByAnchors(sections) {
    const chunks = [];
    let currentContent = '';
    let currentAnchors = [];
    let currentLabels = [];
 ...
 */
function chunkByStructure(content) {
 ...
 */
export function chunkLargeFile(content) {
...
//# sourceMappingURL=anchor-chunker.js.map
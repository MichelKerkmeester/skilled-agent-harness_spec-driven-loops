...
function initEvalDb(dataDir) {
    ...
    if (evalDb) {
        try {
            ...
            console.warn('[eval-db] initEvalDb close-before-switch warning:', err instanceof Error ? err.message : String(err));
        }
        evalDb = null;
        evalDbPath = null;
    }
...
//# sourceMappingURL=eval-db.js.map
 ...
 */
export function getLayerForTool(toolName) {
 ...
 */
export function getLayerPrefix(toolName) {
 ...
 */
export function enhanceDescription(toolName, description) {
 ...
 */
export function getLayerTokenBudget(toolName) {
    const layerId = getLayerForTool(toolName);
    if (!layerId)
 ...
 * Get the token budget for a tool.
 */
export function getTokenBudget(toolName) {
    return getLayerTokenBudget(toolName);
}
/**
 * Get layer information for a tool.
 */
export function getLayerInfo(toolName) {
    const layerId = getLayerForTool(toolName);
    if (!layerId)
        return null;
 ...
 */
export function getRecommendedLayers(taskType) {
 ...
 */
export function getLayerDocumentation() {
...
//# sourceMappingURL=layer-definitions.js.map
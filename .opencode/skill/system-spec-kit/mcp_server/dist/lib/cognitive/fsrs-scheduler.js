 ...
 */
function calculateOptimalInterval(stability, desiredRetention = 0.9) {
 ...
 */
function updateDifficulty(currentDifficulty, grade) {
 ...
 */
function calculateElapsedDays(lastReview) {
    if (!lastReview) {
        return 0;
    }
 ...
 */
function getNextReviewDate(stability, desiredRetention = 0.9) {
 ...
 */
function processReview(params, grade) {
 ...
 */
const CONTEXT_TYPE_STABILITY_MULTIPLIER = {
    ...
    ...Object.fromEntries(Object.entries(LEGACY_CONTEXT_TYPE_ALIASES).map(([legacy, canonical]) => [legacy, canonical === 'planning' ? Infinity : canonical === 'research' ? 2.0 : 1.0])),
};
/**
 ...
 */
const IMPORTANCE_TIER_STABILITY_MULTIPLIER = {
 ...
 */
function getClassificationDecayMultiplier(contextType, importanceTier) {
 ...
 */
function applyClassificationDecay(stability, contextType, importanceTier) {
 ...
 */
function applyHybridDecayPolicy(stability, contextType, importanceTier) {
...
export { 
// Constants
FSRS_FACTOR, FSRS_DECAY, FSRS_HALF_LIFE_FACTOR, // T301: derived constant for half-life ↔ stability
GRADE_AGAIN, GRADE_HARD, GRADE_GOOD, GRADE_EASY, DEFAULT_INITIAL_STABILITY, DEFAULT_INITIAL_DIFFICULTY, MIN_DIFFICULTY, MAX_DIFFICULTY, MIN_STABILITY, FSRS_CONSTANTS, TIER_MULTIPLIER, 
// TM-03: Classification-based decay constants and functions
CONTEXT_TYPE_STABILITY_MULTIPLIER, IMPORTANCE_TIER_STABILITY_MULTIPLIER, getClassificationDecayMultiplier, applyClassificationDecay, 
// REQ-D4-002: Hybrid decay policy
NO_DECAY, HYBRID_FSRS_CONTEXT_TYPES, HYBRID_NO_DECAY_CONTEXT_TYPES, isHybridDecayPolicyEnabled, classifyHybridDecay, getHybridDecayMultiplier, applyHybridDecayPolicy, 
// Core functions
calculateRetrievability, updateStability, calculateOptimalInterval, updateDifficulty, calculateElapsedDays, getNextReviewDate, createInitialParams, processReview, };
//# sourceMappingURL=fsrs-scheduler.js.map
 ...
 */
export function detectSpecLevelFromParsed(filePath) {
    ...
    try {
        ...
        if (siblings.includes('decision-record.md'))
            return 3;
        if (siblings.includes('checklist.md'))
            return 2;
        return 1;
    }
    catch (_error) {
...
//# sourceMappingURL=spec-level.js.map
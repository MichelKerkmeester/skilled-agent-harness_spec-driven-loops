...
function shouldSkipMatch(value, category) {
...
function redactWithPattern(inputText, pattern, matches) {
    return inputText.replace(pattern.expression, (value) => {
...
function applyRedactionGate(inputText) {
...
//# sourceMappingURL=redaction-gate.js.map
 ...
 */
export declare const MPAB_BONUS_COEFFICIENT = 0.3;
/**
 ...
 */
export declare function isMpabEnabled(): boolean;
/**
 ...
 */
export declare function computeMPAB(scores: number[]): number;
/**
 ...
 */
export declare function collapseAndReassembleChunkResults(chunkResults: ChunkResult[]): CollapsedResult[];
//# sourceMappingURL=mpab-aggregation.d.ts.map
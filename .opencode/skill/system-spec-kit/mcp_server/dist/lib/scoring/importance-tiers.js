...
export const VALID_TIERS = Object.keys(IMPORTANCE_TIERS);
...
export function applyTierBoost(score, tier) {
...
export function getExpiredTemporaryFilter() {
...
export function getTiersByImportance() {
...
export function getDefaultTierForDocumentType(documentType) {
    const DOC_TYPE_TIERS = {
        spec: 'important',
        plan: 'important',
...
//# sourceMappingURL=importance-tiers.js.map
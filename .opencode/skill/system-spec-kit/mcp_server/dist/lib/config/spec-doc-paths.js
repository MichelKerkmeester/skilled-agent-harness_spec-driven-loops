...
export function matchesSpecDocumentPath(filePath, basename) {
    ...
    return ((normalizedPath.endsWith(`/${normalizedBasename}`) || normalizedPath === normalizedBasename)
        && isSpecLeafSegment(parent));
}
export function extractSpecFolderFromSpecDocumentPath(filePath) {
    if (!canClassifyAsSpecDocument(filePath)) {
        return null;
    }
    const normalizedPath = normalizeSpecPath(filePath);
...
//# sourceMappingURL=spec-doc-paths.js.map
...
```bash
printf 'corrupt' > /tmp/path-to-copy/.opencode/skill/system-spec-kit/mcp_server/skill-advisor/scripts/skill-graph.sqlite
```
...
- Source: `.opencode/skill/system-spec-kit/mcp_server/skill-advisor/lib/freshness/rebuild-from-source.ts`.

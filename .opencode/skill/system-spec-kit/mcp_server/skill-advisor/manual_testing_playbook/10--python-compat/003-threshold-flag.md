...
```bash
python3 .opencode/skill/system-spec-kit/mcp_server/skill-advisor/scripts/skill_advisor.py "review this pull request" --threshold 0.8
```

2. Run at a looser threshold:

```bash
python3 .opencode/skill/system-spec-kit/mcp_server/skill-advisor/scripts/skill_advisor.py "review this pull request" --threshold 0.6
```

3. Run at a strict threshold:

```bash
python3 .opencode/skill/system-spec-kit/mcp_server/skill-advisor/scripts/skill_advisor.py "review this pull request" --threshold 0.95
```
...
- Source: `.opencode/skill/system-spec-kit/mcp_server/skill-advisor/scripts/skill_advisor.py`.

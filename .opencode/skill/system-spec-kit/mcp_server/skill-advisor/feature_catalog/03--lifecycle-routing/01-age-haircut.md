...
- `.opencode/skill/system-spec-kit/mcp_server/skill-advisor/lib/lifecycle/age-haircut.ts`
...
- `.opencode/skill/system-spec-kit/mcp_server/skill-advisor/tests/scorer/native-scorer.vitest.ts` — derived-lane decay application.

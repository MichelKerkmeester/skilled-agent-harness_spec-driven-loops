...
- `.opencode/skill/system-spec-kit/mcp_server/skill-advisor/lib/lifecycle/archive-handling.ts`

---

## 4. TEST COVERAGE

- `.opencode/skill/system-spec-kit/mcp_server/skill-advisor/tests/lifecycle-derived-metadata.vitest.ts` — rollback invariants.

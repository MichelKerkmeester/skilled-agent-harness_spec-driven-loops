...
import { parseFile } from '../../code-graph/lib/structural-indexer.js';
import { speckitMetrics } from '../lib/metrics.js';
import type { SupportedLanguage } from '../../code-graph/lib/indexer-types.js';
...
function buildFixtures(root: string): readonly Fixture[] {
  ...
  return [
    f('.opencode/skill/system-spec-kit/mcp_server/code-graph/lib/runtime-detection.ts', 'typescript'),
    f('.opencode/skill/system-spec-kit/mcp_server/code-graph/lib/budget-allocator.ts', 'typescript'),
    f('.opencode/skill/system-spec-kit/mcp_server/code-graph/lib/ensure-ready.ts', 'typescript'),

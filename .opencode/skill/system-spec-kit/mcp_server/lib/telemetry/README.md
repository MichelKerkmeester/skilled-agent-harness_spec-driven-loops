...
| `SPECKIT_MEMORY_ROADMAP_PHASE` | `scope-governance` | Record the active memory-roadmap phase in telemetry/checkpoint metadata. Unsupported values fall back to `scope-governance` |

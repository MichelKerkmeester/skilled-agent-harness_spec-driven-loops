...
3. `bash: rg 'CRAFT|Framework Selection|user' .opencode/skill/sk-prompt/references/patterns_evaluation.md .opencode/skill/sk-prompt/SKILL.md`
...
- Feature file path: `05--framework-selection/002-user-named-framework-override.md`

...
3. `bash: rg 'Framework Selection Matrix|Complete Framework Matrix|Complexity' .opencode/skill/sk-prompt/SKILL.md .opencode/skill/sk-prompt/references/patterns_evaluation.md`
...
- Feature file path: `05--framework-selection/001-framework-by-complexity.md`

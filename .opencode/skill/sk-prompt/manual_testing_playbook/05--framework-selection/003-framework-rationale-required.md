...
3. `bash: rg 'alternative|reasoning|select_best|Framework Selection Algorithm' .opencode/skill/sk-prompt/references/patterns_evaluation.md`
...
- Feature file path: `05--framework-selection/003-framework-rationale-required.md`

...
3. `bash: rg 'Try alternative framework|Framework selected|Test|CLEAR 40' .opencode/skill/sk-prompt/references/depth_framework.md .opencode/skill/sk-prompt/references/patterns_evaluation.md`
...
- Feature file path: `05--framework-selection/004-framework-switch-mid-flight.md`

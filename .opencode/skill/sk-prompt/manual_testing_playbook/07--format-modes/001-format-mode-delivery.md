...
3. `bash: rg 'JSON|YAML|Markdown|format_guide_json' .opencode/skill/sk-prompt/SKILL.md .opencode/skill/sk-prompt/assets/format_guide_json.md`
...
- Feature file path: `07--format-modes/001-format-mode-delivery.md`

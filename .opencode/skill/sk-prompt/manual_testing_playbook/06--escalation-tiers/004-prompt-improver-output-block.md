...
3. `bash: rg 'Structured Output Block|FRAMEWORK|CLEAR_SCORE|RATIONALE|ENHANCED_PROMPT|ESCALATION_NOTES' .opencode/skill/sk-prompt/SKILL.md`
...
| File | Role |
|---|---|
| `../../assets/cli_prompt_quality_card.md` | Expected compact structured return mirrored by fast-path escalation |
...
- Feature file path: `06--escalation-tiers/004-prompt-improver-output-block.md`

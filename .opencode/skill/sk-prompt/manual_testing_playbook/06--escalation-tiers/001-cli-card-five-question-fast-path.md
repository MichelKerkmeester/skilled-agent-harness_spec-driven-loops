...
2. `bash: rg 'CLEAR 5-Question|Escalation Triggers|@prompt-improver' .opencode/skill/sk-prompt/assets/cli_prompt_quality_card.md`
...
- Feature file path: `06--escalation-tiers/001-cli-card-five-question-fast-path.md`

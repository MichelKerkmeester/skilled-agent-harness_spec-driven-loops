...
2. `agent: @prompt-improver raw_task="Score and improve a data-validation prompt with per-dimension CLEAR rationale." task_type=analyze target_cli=codex complexity_hint=7 constraints="Each CLEAR dimension must include a one-line reason."`
3. `bash: rg 'Per-Dimension Scoring Rubrics|Scoring Criteria|CLEAR Dimensions' .opencode/skill/sk-prompt/references/patterns_evaluation.md`
...
- Feature file path: `04--clear-scoring/004-dimension-drilldown-rationale.md`

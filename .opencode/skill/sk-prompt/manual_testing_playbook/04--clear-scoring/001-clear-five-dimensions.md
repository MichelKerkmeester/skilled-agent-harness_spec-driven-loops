...
3. `bash: rg 'Correctness|Logic|Expression|Arrangement|Reusability|CLEAR_SCORE' .opencode/skill/sk-prompt/references/patterns_evaluation.md .opencode/skill/sk-prompt/SKILL.md`

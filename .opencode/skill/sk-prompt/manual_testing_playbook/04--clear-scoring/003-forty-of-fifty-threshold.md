...
3. `bash: rg '40\\+/50|required|30-39|Max 3 iterations|CLEAR >= 40' .opencode/skill/sk-prompt/references/depth_framework.md .opencode/skill/sk-prompt/references/patterns_evaluation.md`
...
- Feature file path: `04--clear-scoring/003-forty-of-fifty-threshold.md`

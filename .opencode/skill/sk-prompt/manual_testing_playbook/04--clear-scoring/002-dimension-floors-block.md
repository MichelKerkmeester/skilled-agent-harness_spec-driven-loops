...
3. `bash: rg 'Floor|dimension falls below floor|C >= 7|E >= 10' .opencode/skill/sk-prompt/references/depth_framework.md .opencode/skill/sk-prompt/references/patterns_evaluation.md`
...
- Feature file path: `04--clear-scoring/002-dimension-floors-block.md`

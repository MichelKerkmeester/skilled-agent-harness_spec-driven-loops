...
2. `bash: rg 'STEP 0' .opencode/skill/sk-prompt/SKILL.md` (confirm prefix detection happens at STEP 0)
...
- Feature file path: `01--mode-detection/004-mode-prefix-keyword-collision.md`

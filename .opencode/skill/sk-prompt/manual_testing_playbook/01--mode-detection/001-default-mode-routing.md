...
2. `bash: grep -E '^\| Improve' .opencode/skill/sk-prompt/SKILL.md` (confirm default-mode row in operating-modes table)
...
3. Run `bash: rg '\$improve' .opencode/skill/sk-prompt/SKILL.md` to confirm the alias still points to default mode.
...
- Feature file path: `01--mode-detection/001-default-mode-routing.md`

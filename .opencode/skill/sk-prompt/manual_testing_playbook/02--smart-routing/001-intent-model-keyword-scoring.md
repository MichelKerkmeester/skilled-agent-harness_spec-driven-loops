...
3. `bash: rg -A 12 'INTENT_MODEL' .opencode/skill/sk-prompt/SKILL.md` (verify keyword weights still match)
...
3. Confirm RESOURCE_MAP entries still resolve on disk (`bash: ls .opencode/skill/sk-prompt/references/`).
...
- Feature file path: `02--smart-routing/001-intent-model-keyword-scoring.md`

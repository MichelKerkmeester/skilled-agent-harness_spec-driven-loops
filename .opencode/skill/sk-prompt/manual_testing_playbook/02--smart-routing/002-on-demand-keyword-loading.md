...
2. `bash: rg 'ON_DEMAND_KEYWORDS' .opencode/skill/sk-prompt/SKILL.md` (verify keyword list still includes "deep dive" and "all frameworks")
...
- Feature file path: `02--smart-routing/002-on-demand-keyword-loading.md`

...
2. `bash: rg -A 6 'UNKNOWN_FALLBACK_CHECKLIST' .opencode/skill/sk-prompt/SKILL.md` (capture canonical 4-item list)
...
- Feature file path: `02--smart-routing/004-unknown-fallback-checklist.md`

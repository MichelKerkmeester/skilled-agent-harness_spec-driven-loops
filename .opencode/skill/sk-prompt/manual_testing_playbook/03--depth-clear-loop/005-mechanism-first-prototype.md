...
3. `bash: rg 'Mechanism First|WHY then WHAT|Prototype' .opencode/skill/sk-prompt/references/depth_framework.md`
...
- Feature file path: `03--depth-clear-loop/005-mechanism-first-prototype.md`

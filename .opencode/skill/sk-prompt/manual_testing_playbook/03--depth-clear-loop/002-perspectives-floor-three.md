...
3. `bash: rg '3 minimum|Perspectives|BLOCKING' .opencode/skill/sk-prompt/references/depth_framework.md`
...
- Feature file path: `03--depth-clear-loop/002-perspectives-floor-three.md`

...
3. `bash: rg 'RICCE|Role, Instructions, Context, Constraints, Examples|present or justified' .opencode/skill/sk-prompt/SKILL.md .opencode/skill/sk-prompt/references/depth_framework.md`
...
- Feature file path: `03--depth-clear-loop/004-ricce-validation-gate.md`

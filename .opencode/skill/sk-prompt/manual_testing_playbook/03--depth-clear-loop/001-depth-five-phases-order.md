...
3. `bash: rg 'Phase Exit Criteria|D -- DISCOVER|E -- ENGINEER|P -- PROTOTYPE|T -- TEST|H -- HARMONIZE' .opencode/skill/sk-prompt/references/depth_framework.md`
...
- Feature file path: `03--depth-clear-loop/001-depth-five-phases-order.md`

...
1. Local `mcp-cocoindex-code` skill payload
...
- `.opencode/skill/mcp-cocoindex-code/scripts/`
- `.opencode/skill/mcp-cocoindex-code/references/`
- `.opencode/skill/mcp-cocoindex-code/assets/`
- `.opencode/skill/mcp-cocoindex-code/mcp_server/.venv/bin/ccc` after installation

If this payload is missing, `skill_advisor.py` cannot discover `mcp-cocoindex-code` even if semantic-search heuristics exist.
...
- the local `mcp-cocoindex-code` skill subtree
...
```bash
bash .opencode/skill/mcp-cocoindex-code/scripts/doctor.sh --strict --require-config --expect-config opencode.json
bash .opencode/skill/mcp-cocoindex-code/scripts/doctor.sh --strict --require-config --expect-config .codex/config.toml
```

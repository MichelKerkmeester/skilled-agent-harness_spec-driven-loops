...
bash .opencode/skill/mcp-cocoindex-code/scripts/doctor.sh --json
...
bash .opencode/skill/mcp-cocoindex-code/scripts/ensure_ready.sh --refresh-index
...
```bash
.opencode/skill/mcp-cocoindex-code/mcp_server/.venv/bin/ccc daemon restart
```

...
description: "This scenario validates Status verification for `CFG-003`. It focuses on Verify `ccc status` shows indexed file count, chunk count, embedding model, and project root."
---

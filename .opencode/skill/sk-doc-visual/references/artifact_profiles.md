---
description: "SpecKit artifact profile schema and detector precedence for doc-visual artifact-aware routing"
---

# Doc Visual — SpecKit Artifact Profiles
...
This reference defines the SpecKit artifact profile model, profile catalog, detector precedence, and the quality checks that `sk-doc-visual` must apply per artifact type.
...
| `style_profile` | string | Required visual profile for generated output shell |
...
Default style profile for this catalog: `README Ledger Profile`.

If a profile does not override `style_profile`, inherit the default.

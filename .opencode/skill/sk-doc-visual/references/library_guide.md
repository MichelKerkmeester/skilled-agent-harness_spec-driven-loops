...
Detailed reference for all external JavaScript libraries used in sk-doc-visual HTML output.
...
## Tailwind/Iconify Decision

Default recommendation for this skill: **do not depend on runtime Tailwind or Iconify** in generated artifacts. Prefer semantic CSS classes and inline SVG so output stays deterministic and validator-safe.

If a request explicitly needs Tailwind/Iconify:
- Pin exact versions and include URLs in delivery notes.
- Mirror critical styles/icons with semantic fallback classes.
- Re-run drift and HTML validation checks before delivery.
...
|---|-----------|-----------|------|------------------------|
| 1 | Inter | JetBrains Mono | README Ledger default | `Inter:wght@300;400;500;600;700;800;900&JetBrains+Mono:wght@400;700` |
...
| 8 | Archivo | JetBrains Mono | Bold, industrial | `Archivo:wght@400;500;600;700&JetBrains+Mono:wght@400;700` |
...
README Ledger profile uses `Inter` + `JetBrains Mono` by default. Outside that profile, avoid generic defaults and never use Roboto or Arial as primary display/body font variables.
...
| Playfair Display | IBM Plex Mono | Elegant contrast |

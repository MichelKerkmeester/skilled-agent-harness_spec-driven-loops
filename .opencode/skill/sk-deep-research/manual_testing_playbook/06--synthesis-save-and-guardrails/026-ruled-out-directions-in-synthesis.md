...
- Desired user-facing outcome: The user can open research/research.md after synthesis and find a complete table of all approaches that were investigated and eliminated, with reasons and evidence.

...
- Orchestrator prompt: Validate the strategy-discipline contract for sk-deep-research. Confirm that iteration focus comes from Next Focus and that exhausted or blocked approaches are not retried, then return a concise user-facing verdict.

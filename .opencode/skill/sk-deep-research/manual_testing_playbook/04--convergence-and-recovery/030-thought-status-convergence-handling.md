...
- Desired user-facing outcome: The user understands that a thought iteration is recognized as deliberate meta-reasoning and is excluded from both stuck counting and the rolling newInfoRatio average.

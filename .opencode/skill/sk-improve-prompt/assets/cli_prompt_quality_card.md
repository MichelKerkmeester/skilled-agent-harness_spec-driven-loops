<!-- Four mirrors exist under cli-*/assets/prompt_quality_card.md. When you edit the framework table below, update all mirrors or regenerate via copy. -->
...
## 3. CLEAR 5-Question Pre-Dispatch Checklist
...
## 5. Common CLI Prompt Failure Patterns

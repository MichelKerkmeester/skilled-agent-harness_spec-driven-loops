...
- Added stack-domain mapping and phase detection narrative aligned with the current references/assets tree.
- Updated related resources and quick-reference tables to reflect current anonymized stack folders and examples.
- Combined stack folder mapping content into a single `Resource Domains` section to reduce duplication in Smart Routing.

### Notes
- Alignment intentionally preserves Smart Router pseudocode-first ordering for validation compatibility.

...
- Orchestrator prompt: Validate the dimension rotation contract for sk-deep-review. Confirm that the loop manager rotates through dimensions based on the strategy "Next Focus" and that exhausted dimensions are skipped, then return a concise user-facing pass/fail verdict.

...
- Orchestrator prompt: Validate the autonomous entrypoint for sk-deep-review. Confirm that /spec_kit:deep-review:auto is documented consistently across the README, quick reference, command entrypoint, and autonomous YAML workflow, then return a concise user-facing pass/fail verdict with the expected artifact summary.

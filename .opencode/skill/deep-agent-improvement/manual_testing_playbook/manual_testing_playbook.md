...
The manual scenarios exercise the operator-visible behavior. Runtime helper coverage lives under `.opencode/skill/deep-agent-improvement/scripts/tests/` and should be used as regression evidence when a scenario touches the matching helper.

| Runtime Test | Covered Runtime Surface |
|---|---|
| `.opencode/skill/deep-agent-improvement/scripts/tests/benchmark-stability.vitest.ts` | Benchmark stability helpers used by RT-029 and low-sample validation |
| `.opencode/skill/deep-agent-improvement/scripts/tests/candidate-lineage.vitest.ts` | Candidate lineage graph helpers used by E2E-024 and replay-consumer validation |
| `.opencode/skill/deep-agent-improvement/scripts/tests/improvement-journal.vitest.ts` | Journal emission and taxonomy helpers used by RT-025, RT-026, and RT-032 |
| `.opencode/skill/deep-agent-improvement/scripts/tests/mutation-coverage.vitest.ts` | Mutation coverage and trajectory helpers used by E2E-022 and RT-030 |
| `.opencode/skill/deep-agent-improvement/scripts/tests/trade-off-detector.vitest.ts` | Trade-off and insufficient-data helpers used by E2E-023 and RT-033 |
...
|---|---|
| Integration Scanner | `.opencode/skill/deep-agent-improvement/feature_catalog/02--integration-scanning/01-surface-discovery.md`, `02-runtime-mirrors.md`, `03-command-dispatch.md` |
| Profile Generator | `.opencode/skill/deep-agent-improvement/feature_catalog/03--scoring-system/02-dynamic-profiling.md` |
| 5-Dimension Scorer | `.opencode/skill/deep-agent-improvement/feature_catalog/03--scoring-system/01-five-dimension-rubric.md`, `03-deterministic-scoring.md` |
...
| Reducer Dimensions | `.opencode/skill/deep-agent-improvement/feature_catalog/03--scoring-system/04-dimensional-progress.md` |
| End-to-End Loop | `.opencode/skill/deep-agent-improvement/feature_catalog/01--evaluation-loop/01-initialization.md`, `02-candidate-generation.md`, `03-scoring-dispatch.md`, `04-promotion-gates.md`, `05-rollback.md`, `06-plateau-detection.md` |

...
Read `.opencode/skill/deep-research/references/capability_matrix.md` for the parity checklist and `.opencode/skill/deep-research/assets/runtime_capabilities.json` plus `.opencode/skill/deep-research/scripts/runtime-capabilities.cjs` for the machine-readable lookup path.
<!-- /ANCHOR:runtime-parity -->

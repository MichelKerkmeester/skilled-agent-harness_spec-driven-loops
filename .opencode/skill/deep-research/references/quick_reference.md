...
> **Runtime capability matrix:** `.opencode/skill/deep-research/references/capability_matrix.md` and `.opencode/skill/deep-research/assets/runtime_capabilities.json`

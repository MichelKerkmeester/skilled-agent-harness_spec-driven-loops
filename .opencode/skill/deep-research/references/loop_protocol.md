...
- Human-readable matrix: `.opencode/skill/deep-research/references/capability_matrix.md`
- Machine-readable matrix: `.opencode/skill/deep-research/assets/runtime_capabilities.json`

...
3. `bash: sed -n '1,180p' .opencode/skill/deep-research/references/state_format.md`
### Expected
...
| `.opencode/skill/deep-research/references/state_format.md` | Config schema; use `ANCHOR:config-file` |

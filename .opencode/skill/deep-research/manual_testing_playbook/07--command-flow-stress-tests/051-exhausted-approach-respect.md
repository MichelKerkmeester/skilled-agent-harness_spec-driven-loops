...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skill/deep-research/manual_testing_playbook/07--command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-051-sandbox
...
| `.opencode/skill/deep-research/SKILL.md:367-383` | skill-level state and exhausted approach rules |

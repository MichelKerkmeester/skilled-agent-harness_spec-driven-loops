...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skill/deep-research/manual_testing_playbook/07--command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-050-sandbox
...
## Research Context
- The sandbox contains .opencode/agent/deep-research.md and .opencode/skill/deep-research/SKILL.md.
EOF
...
| `.opencode/skill/deep-research/SKILL.md:450-459` | per-iteration quality gate criteria |

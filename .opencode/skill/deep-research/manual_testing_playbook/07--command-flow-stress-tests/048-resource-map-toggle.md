...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skill/deep-research/manual_testing_playbook/07--command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-048-sandbox
...
| `.opencode/skill/deep-research/SKILL.md:443-448` | resource-map is expected unless disabled |

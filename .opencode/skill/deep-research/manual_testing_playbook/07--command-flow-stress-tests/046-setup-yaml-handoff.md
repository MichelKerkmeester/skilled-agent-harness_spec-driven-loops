...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skill/deep-research/manual_testing_playbook/07--command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-046-sandbox
...
| `.opencode/skill/deep-research/SKILL.md:46-64` | command-owned workflow is mandatory |

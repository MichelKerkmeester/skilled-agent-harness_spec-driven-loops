...
/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skill/deep-research/manual_testing_playbook/07--command-flow-stress-tests/setup-cp-sandbox.sh --sandbox-dir /tmp/cp-049-sandbox
...
| `.opencode/skill/deep-research/SKILL.md:287-309` | packet-local state location and sentinel |

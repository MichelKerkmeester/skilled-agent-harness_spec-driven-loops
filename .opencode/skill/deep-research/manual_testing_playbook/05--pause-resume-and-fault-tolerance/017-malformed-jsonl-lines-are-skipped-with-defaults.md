...
3. `bash: rg -n 'State file corrupt|Validate JSONL' .opencode/skill/deep-research/README.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/state_format.md` | Fault tolerance and event schema; use `ANCHOR:state-log` |
| `.opencode/skill/deep-research/references/convergence.md` | Defensive JSONL reading; use `ANCHOR:signal-definitions` |
| `.opencode/skill/deep-research/README.md` | Troubleshooting language; use `ANCHOR:troubleshooting` |

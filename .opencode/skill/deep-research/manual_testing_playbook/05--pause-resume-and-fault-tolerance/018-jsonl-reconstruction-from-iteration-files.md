...
3. `bash: rg -n 'iteration-{NNN}|reconstructed' .opencode/skill/deep-research/references/state_format.md .opencode/skill/deep-research/references/convergence.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/state_format.md` | Reconstruction algorithm and event schema; use `ANCHOR:state-log` |
| `.opencode/command/spec_kit/deep-research.md` | Error handling summary; use `## 10. ERROR HANDLING` |
| `.opencode/skill/deep-research/README.md` | Troubleshooting and FAQ recovery language; use `ANCHOR:troubleshooting` and `ANCHOR:faq` |
| `.opencode/skill/deep-research/references/convergence.md` | Valid-entry behavior during convergence; use `ANCHOR:signal-definitions` |

...
3. `bash: rg -n 'Delete the file to resume|Auto-resume|review/.deep-research-pause' .opencode/skill/deep-research/README.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/loop_protocol.md` | Pause-resume flow; use `ANCHOR:phase-iteration-loop` and `ANCHOR:phase-initialization` |
| `.opencode/skill/deep-research/references/state_format.md` | Resumed event schema; use `ANCHOR:state-log` |
...
| `.opencode/skill/deep-research/README.md` | User-facing pause and resume language; use `ANCHOR:faq` |

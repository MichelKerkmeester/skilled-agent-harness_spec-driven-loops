...
3. `bash: rg -n 'pause|sentinel|review/.deep-research-pause' .opencode/skill/deep-research/references/quick_reference.md .opencode/skill/deep-research/SKILL.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/loop_protocol.md` | Pause sentinel contract; use `ANCHOR:phase-iteration-loop` |
...
| `.opencode/skill/deep-research/README.md` | User-facing pause FAQ; use `ANCHOR:faq` |
| `.opencode/skill/deep-research/SKILL.md` | Rule-level context; use `ANCHOR:rules` |

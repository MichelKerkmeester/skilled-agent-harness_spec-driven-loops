...
3. `bash: sed -n '97,107p' .opencode/skill/deep-research/references/loop_protocol.md`
4. `bash: rg -n 'guard_violation\|source_diversity' .opencode/skill/deep-research/references/state_format.md`
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/convergence.md` | Canonical quality guard definitions; use §2.4 Quality Guard Protocol |
| `.opencode/skill/deep-research/references/loop_protocol.md` | Loop orchestration; use Step 2c: Quality Guard Check |
| `.opencode/skill/deep-research/references/state_format.md` | JSONL event schema; use guard_violation event definition and sourceStrength field |

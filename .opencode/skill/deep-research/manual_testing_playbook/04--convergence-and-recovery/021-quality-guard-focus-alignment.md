...
4. `bash: rg -n 'guard_violation\|focus_alignment' .opencode/skill/deep-research/references/state_format.md`
...
| `.opencode/skill/deep-research/references/state_format.md` | JSONL event schema; use guard_violation event definition and supported guard values |

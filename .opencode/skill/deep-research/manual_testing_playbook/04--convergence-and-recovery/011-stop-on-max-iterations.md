...
3. `bash: rg -n -- '--max-iterations|Maximum loop iterations' .opencode/skill/deep-research/README.md .opencode/skill/deep-research/references/quick_reference.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/convergence.md` | Hard-stop ordering; use `ANCHOR:shouldcontinue-algorithm` |
| `.opencode/skill/deep-research/references/loop_protocol.md` | Loop decision order; use `ANCHOR:phase-iteration-loop` |
...
| `.opencode/skill/deep-research/README.md` | Parameter table and examples; use `ANCHOR:configuration` and `ANCHOR:usage-examples` |
| `.opencode/skill/deep-research/references/quick_reference.md` | Parameter defaults; use `ANCHOR:commands` |

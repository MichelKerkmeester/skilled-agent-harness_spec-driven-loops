...
3. `bash: sed -n '183,195p' .opencode/skill/deep-research/references/state_format.md`
4. `bash: rg -n 'guard_violation\|single_weak_source' .opencode/skill/deep-research/references/state_format.md`
5. `bash: sed -n '97,107p' .opencode/skill/deep-research/references/loop_protocol.md`
...
| `.opencode/skill/deep-research/references/state_format.md` | JSONL event schema; use guard_violation event definition and sourceStrength field classification |

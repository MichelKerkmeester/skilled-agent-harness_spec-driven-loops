...
3. `bash: rg -n 'insight\|thought\|stuck' .opencode/skill/deep-research/SKILL.md`
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/state_format.md` | Canonical JSONL schema; insight status definition and its relationship to stuck counting |
| `.opencode/skill/deep-research/references/convergence.md` | Convergence math; stuckCount computation and which statuses increment it |
| `.opencode/skill/deep-research/SKILL.md` | Skill overview; iteration status taxonomy including insight |

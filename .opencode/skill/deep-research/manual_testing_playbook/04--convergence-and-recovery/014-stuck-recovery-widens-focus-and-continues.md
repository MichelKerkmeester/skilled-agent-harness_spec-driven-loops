...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/convergence.md` | Stuck recovery protocol; use `ANCHOR:stuck-recovery-protocol` |
| `.opencode/skill/deep-research/references/loop_protocol.md` | Ideas backlog and stuck recovery; use `ANCHOR:phase-iteration-loop` |

...
3. `bash: rg -n 'thought\|insight\|stuck' .opencode/skill/deep-research/SKILL.md`
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/state_format.md` | Canonical JSONL schema; thought status definition and its convergence-neutral semantics |
| `.opencode/skill/deep-research/references/convergence.md` | Convergence math; rolling average and stuckCount computation with thought exclusion |
| `.opencode/skill/deep-research/SKILL.md` | Skill overview; iteration status taxonomy including thought |
...
- Feature catalog status: No `feature_catalog/` package exists under `.opencode/skill/deep-research/` as of 2026-03-24.

...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/scripts/reduce-state.cjs` | Canonical reducer implementation; surfaces `graphConvergenceScore`, `graphDecision`, `graphBlockers`, and dashboard `GRAPH CONVERGENCE` |
| `.opencode/skill/deep-research/references/state_format.md` | Research state contract; defines reducer-owned graph convergence fields and dashboard rendering expectations |
...
- Feature catalog status: No `feature_catalog/` package exists under `.opencode/skill/deep-research/` as of 2026-04-11.

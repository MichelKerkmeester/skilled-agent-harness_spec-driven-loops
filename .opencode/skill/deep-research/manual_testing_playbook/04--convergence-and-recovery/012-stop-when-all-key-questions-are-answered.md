...
3. `bash: rg -n 'Questions:|coverage|all questions answered' .opencode/skill/deep-research/references/quick_reference.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/convergence.md` | Question-coverage hard stop; use `ANCHOR:shouldcontinue-algorithm` and `ANCHOR:signal-definitions` |
...
| `.opencode/skill/deep-research/README.md` | Question-coverage framing; use `ANCHOR:usage-examples` |
| `.opencode/skill/deep-research/references/quick_reference.md` | Coverage visualization; use `ANCHOR:progress-visualization` |

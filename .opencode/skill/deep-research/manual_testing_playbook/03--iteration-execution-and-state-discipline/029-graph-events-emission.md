...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/state_format.md` | Canonical flat `graphEvents` payload example and field table |
| `.opencode/skill/deep-research/references/convergence.md` | Graph-aware research convergence contract; documents `graphEvents` as iteration-record input |
...
- Feature catalog status: No `feature_catalog/` package exists under `.opencode/skill/deep-research/` as of 2026-04-10.

...
3. `bash: cat .opencode/skill/deep-research/assets/deep_research_dashboard.md`
...
5. `bash: rg -n 'renderDashboard\|dashboardPath' .opencode/skill/deep-research/scripts/reduce-state.cjs`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/loop_protocol.md` | Loop protocol; inspect Step 4a (Generate Dashboard) under `ANCHOR:phase-iteration-loop` |
| `.opencode/skill/deep-research/references/state_format.md` | State format; inspect `ANCHOR:dashboard` for content sections, lifecycle, and file protection rules |
| `.opencode/skill/deep-research/assets/deep_research_dashboard.md` | Dashboard template; structural reference for all required sections (Status, Progress, Questions, Trend, Dead Ends, Next Focus, Active Risks) |
| `.opencode/skill/deep-research/scripts/reduce-state.cjs` | Reducer script; `renderDashboard` generates the dashboard content; `reduceResearchState` writes it to disk |

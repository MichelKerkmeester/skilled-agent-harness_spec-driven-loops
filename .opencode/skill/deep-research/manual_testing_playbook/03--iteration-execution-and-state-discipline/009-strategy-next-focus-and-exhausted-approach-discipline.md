...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/state_format.md` | Strategy file requirements; use `ANCHOR:strategy-file` |
| `.opencode/skill/deep-research/references/loop_protocol.md` | Ideas backlog and recovery focus; use `ANCHOR:phase-iteration-loop` |

...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/state_format.md` | State format; inspect `Novelty Justification` subsection under `ANCHOR:state-log` for field definition and example |
| `.opencode/skill/deep-research/SKILL.md` | Skill rules; inspect ALWAYS rule 11: "Report newInfoRatio + 1-sentence novelty justification" |

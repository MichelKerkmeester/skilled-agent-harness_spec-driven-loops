...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/README.md` | Progressive synthesis defaults and state-file table; use `ANCHOR:overview` and `ANCHOR:configuration` |
| `.opencode/skill/deep-research/references/state_format.md` | Canonical ownership wording; use `ANCHOR:overview` and `ANCHOR:config-file` |
| `.opencode/skill/deep-research/SKILL.md` | Rule-level ownership statement; use `ANCHOR:rules` |

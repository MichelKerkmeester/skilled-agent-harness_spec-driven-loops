...
3. `bash: sed -n '1,220p' .opencode/skill/deep-research/references/quick_reference.md && sed -n '1,220p' .codex/agents/deep-research.toml`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/loop_protocol.md` | Iteration loop order; use `ANCHOR:phase-iteration-loop` |
...
| `.opencode/skill/deep-research/references/quick_reference.md` | Iteration checklist; use `ANCHOR:agent-iteration-checklist` |

...
3. `bash: sed -n '1,220p' .opencode/skill/deep-research/assets/deep_research_config.json && sed -n '1,220p' .opencode/skill/deep-research/assets/deep_research_strategy.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/loop_protocol.md` | Initialization lifecycle; use `ANCHOR:phase-initialization` |
...
| `.opencode/skill/deep-research/assets/deep_research_config.json` | Config template |
| `.opencode/skill/deep-research/assets/deep_research_strategy.md` | Strategy template |

...
3. `bash: rg -n 'State file corrupt|repair|recover' .opencode/skill/deep-research/README.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/loop_protocol.md` | Invalid-state contract; use `ANCHOR:phase-initialization` |
| `.opencode/skill/deep-research/SKILL.md` | Rule-level guardrails; use `ANCHOR:rules` |
...
| `.opencode/skill/deep-research/README.md` | Troubleshooting boundary; use `ANCHOR:troubleshooting` |

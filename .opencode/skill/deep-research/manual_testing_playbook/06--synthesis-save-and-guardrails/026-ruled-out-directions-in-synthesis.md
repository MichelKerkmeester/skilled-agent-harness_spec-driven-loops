...
3. `bash: sed -n '/ANCHOR:ruled-out-directions/,/\/ANCHOR:ruled-out-directions/p' .opencode/skill/deep-research/assets/deep_research_strategy.md`
4. `bash: rg -n 'rule.*10\|ruled-out' .opencode/skill/deep-research/SKILL.md`
### Expected
...
| File | Role |
|---|---|
| `.opencode/skill/deep-research/references/loop_protocol.md` | Loop protocol; inspect `ANCHOR:phase-synthesis` for the Eliminated Alternatives consolidation rules (synthesis Step 3) |
| `.opencode/skill/deep-research/references/state_format.md` | State format; inspect `ruledOut` array under `ANCHOR:state-log` (Negative Knowledge subsection) and iteration file requirements under `ANCHOR:iteration-files` |
| `.opencode/skill/deep-research/assets/deep_research_strategy.md` | Strategy template; inspect `ANCHOR:ruled-out-directions` for section 10 (Ruled Out Directions) |
| `.opencode/skill/deep-research/SKILL.md` | Skill rules; inspect ALWAYS rule 10: "Document ruled-out directions per iteration" |

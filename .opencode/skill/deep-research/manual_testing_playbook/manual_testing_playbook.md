...
- `deep-research` skill exists at `.opencode/skill/deep-research/`.
...
No dedicated `feature_catalog/` package exists under `.opencode/skill/deep-research/`. Use the live source anchors inside each per-feature file as the canonical implementation cross-reference surface.

...
- Capability matrix: `.opencode/skill/deep-research/assets/runtime_capabilities.json`
- Capability matrix doc: `.opencode/skill/deep-research/references/capability_matrix.md`
- Capability resolver: `.opencode/skill/deep-research/scripts/runtime-capabilities.cjs`

...
| `.opencode/skill/deep-research/references/state_format.md` | Reference | Defines the `ruledOut` JSONL payload and iteration-file requirements. |
| `.opencode/skill/deep-research/references/loop_protocol.md` | Reference | Defines the `Eliminated Alternatives` synthesis contract. |
| `.opencode/skill/deep-research/scripts/reduce-state.cjs` | Reducer | Promotes ruled-out directions into synchronized strategy and registry state. |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.opencode/skill/deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/026-ruled-out-directions-in-synthesis.md` | Manual playbook | Verifies ruled-out directions survive into final synthesis. |

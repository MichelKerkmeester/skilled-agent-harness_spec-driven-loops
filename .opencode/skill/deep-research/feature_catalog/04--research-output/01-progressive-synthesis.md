...
| File | Layer | Role |
|---|---|---|
| `.opencode/skill/deep-research/assets/deep_research_config.json` | Asset | Sets `progressiveSynthesis` to `true` by default in the live config template. |
| `.opencode/agent/deep-research.md` | Agent | Defines when the iteration agent may create or update `research/research.md`. |
| `.opencode/skill/deep-research/references/state_format.md` | Reference | Defines progressive update rules for `research/research.md`. |
| `.opencode/skill/deep-research/references/loop_protocol.md` | Reference | Defines the final synthesis cleanup pass that consolidates the document. |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skill/deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/010-progressive-synthesis-behavior-for-research-md.md` | Manual playbook | Verifies iteration-time updates respect the progressive-synthesis contract. |
| `.opencode/skill/deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/019-final-synthesis-memory-save-and-guardrail-behavior.md` | Manual playbook | Verifies final synthesis still owns the terminal research document. |

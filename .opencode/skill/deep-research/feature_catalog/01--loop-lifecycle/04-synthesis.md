...
| File | Layer | Role |
|---|---|---|
| `.opencode/skill/deep-research/references/loop_protocol.md` | Reference | Defines the synthesis phase steps, required output shape, and terminal event contract. |
| `.opencode/skill/deep-research/references/state_format.md` | Reference | Defines the `research/research.md` lifecycle and progressive update rules. |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skill/deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/019-final-synthesis-memory-save-and-guardrail-behavior.md` | Manual playbook | Verifies final synthesis and the handoff into save behavior. |
| `.opencode/skill/deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/026-ruled-out-directions-in-synthesis.md` | Manual playbook | Verifies negative knowledge is consolidated into the final research output. |

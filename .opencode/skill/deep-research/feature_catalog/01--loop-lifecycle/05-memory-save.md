...
| `.opencode/skill/deep-research/references/loop_protocol.md` | Reference | Defines the save phase and its verification step. |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skill/deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/019-final-synthesis-memory-save-and-guardrail-behavior.md` | Manual playbook | Verifies the save phase uses the supported continuity path after synthesis. |

...
| File | Layer | Role |
|---|---|---|
| `.opencode/skill/deep-research/references/state_format.md` | Reference | Defines the JSONL schema for config, iteration, and event lines. |
| `.opencode/skill/deep-research/references/convergence.md` | Reference | Defines how convergence readers parse JSONL safely and interpret stuck, insight, and thought statuses. |
...
| File | Type | Role |
|---|---|---|
| `.opencode/skill/deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/025-novelty-justification-in-jsonl.md` | Manual playbook | Verifies `noveltyJustification` is present and aligned with the iteration record. |
| `.opencode/skill/deep-research/manual_testing_playbook/05--pause-resume-and-fault-tolerance/017-malformed-jsonl-lines-are-skipped-with-defaults.md` | Manual playbook | Verifies tolerant parsing of malformed JSONL lines. |
| `.opencode/skill/deep-research/manual_testing_playbook/05--pause-resume-and-fault-tolerance/018-jsonl-reconstruction-from-iteration-files.md` | Manual playbook | Verifies state reconstruction when JSONL is damaged. |

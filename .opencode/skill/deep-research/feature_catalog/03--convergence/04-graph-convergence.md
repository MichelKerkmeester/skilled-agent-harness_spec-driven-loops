...
| File | Layer | Role |
|---|---|---|
| `.opencode/skill/deep-research/references/convergence.md` | Reference | Defines the graph-aware convergence model and graph-specific stop support signals. |
...
| `.opencode/skill/deep-research/scripts/reduce-state.cjs` | Reducer | Reads the latest graph event and exposes graph score, decision, and blockers. |
...
| `.opencode/skill/deep-research/manual_testing_playbook/04--convergence-and-recovery/031-graph-convergence-signals.md` | Manual playbook | Verifies graph convergence signals are derived and exposed correctly. |
| `.opencode/skill/deep-research/manual_testing_playbook/04--convergence-and-recovery/033-graph-aware-stop-gate.md` | Manual playbook | Verifies graph-aware stop gates can block or allow synthesis. |

...
```text
/improve:agent-improver ".opencode/agent/handover.md" :confirm --spec-folder=specs/skilled-agent-orchestration/041-sk-improve-agent-loop/008-sk-improve-agent-holistic-evaluation --iterations=1
```

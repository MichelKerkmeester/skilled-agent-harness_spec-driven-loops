...
All files follow workflows-documentation conventions:
- Emoji headers on H2 sections (77 headers across React references)
- Consistent divider format in code files

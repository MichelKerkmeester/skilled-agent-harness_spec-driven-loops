---
description: "Index of all reference files, asset files, template files, and related skills for the sk-visual-explainer skill"
---
# Related Resources
...
| `sk-git` | READ — gathers diff data | `/diff-review`, `/recap --include-git` |
| `mcp-chrome-devtools` | READ — validates HTML output | Post-delivery quality validation |
| `sk-documentation` | Complementary — text documentation | When user needs Markdown docs instead of HTML visuals |
...
```
.opencode/skill/sk-visual-explainer/

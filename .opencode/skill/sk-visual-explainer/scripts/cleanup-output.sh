#!/usr/bin/env bash
# ───────────────────────────────────────────────────────────────
# COMPONENT: VISUAL EXPLAINER OUTPUT CLEANUP
# ───────────────────────────────────────────────────────────────
# Remove old sk-visual-explainer HTML artifacts from the output folder.
#
...
show_help() {
  cat <<EOF_HELP
${SCRIPT_NAME} - Remove old sk-visual-explainer output files
...
print_header() {
  ...
  log_info ""
  log_info "${BOLD}Visual Explainer - Output Cleanup${NC}"

...
| `../01--worktree-setup/002-current-branch-no-worktree.md` | Canonical per-feature execution contract |
...
- Feature file path: `01--worktree-setup/002-current-branch-no-worktree.md`

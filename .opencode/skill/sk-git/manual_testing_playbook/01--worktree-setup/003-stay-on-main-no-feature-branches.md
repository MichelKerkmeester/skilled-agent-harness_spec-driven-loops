...
| `../01--worktree-setup/003-stay-on-main-no-feature-branches.md` | Canonical per-feature execution contract |
...
- Feature file path: `01--worktree-setup/003-stay-on-main-no-feature-branches.md`

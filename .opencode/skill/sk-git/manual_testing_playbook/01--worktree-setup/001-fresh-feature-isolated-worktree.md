...
| `../01--worktree-setup/001-fresh-feature-isolated-worktree.md` | Canonical per-feature execution contract |
...
- Feature file path: `01--worktree-setup/001-fresh-feature-isolated-worktree.md`

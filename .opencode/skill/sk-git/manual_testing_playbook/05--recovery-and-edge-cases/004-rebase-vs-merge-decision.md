...
| `../05--recovery-and-edge-cases/004-rebase-vs-merge-decision.md` | Canonical per-feature execution contract |
...
- Feature file path: `05--recovery-and-edge-cases/004-rebase-vs-merge-decision.md`

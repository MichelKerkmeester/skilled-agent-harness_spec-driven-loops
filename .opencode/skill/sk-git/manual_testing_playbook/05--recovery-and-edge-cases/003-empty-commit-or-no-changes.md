...
| `../05--recovery-and-edge-cases/003-empty-commit-or-no-changes.md` | Canonical per-feature execution contract |
...
- Feature file path: `05--recovery-and-edge-cases/003-empty-commit-or-no-changes.md`

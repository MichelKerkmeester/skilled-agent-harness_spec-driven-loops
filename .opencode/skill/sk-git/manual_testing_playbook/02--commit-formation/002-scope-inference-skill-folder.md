...
description: "This scenario validates Scope inference skill folder for `GIT-005`. It focuses on verify a change inside `.opencode/skill/sk-git/` yields a deterministic `sk-git` scope."
---
...
This scenario validates Scope inference skill folder for `GIT-005`. It focuses on verify a change inside `.opencode/skill/sk-git/` yields a deterministic `sk-git` scope.
...
- Objective: verify a change inside `.opencode/skill/sk-git/` yields a deterministic `sk-git` scope.
...
| `../02--commit-formation/002-scope-inference-skill-folder.md` | Canonical per-feature execution contract |
...
- Feature file path: `02--commit-formation/002-scope-inference-skill-folder.md`

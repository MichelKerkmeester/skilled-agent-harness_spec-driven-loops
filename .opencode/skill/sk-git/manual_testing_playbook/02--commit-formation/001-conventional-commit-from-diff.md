...
| `../02--commit-formation/001-conventional-commit-from-diff.md` | Canonical per-feature execution contract |
...
- Feature file path: `02--commit-formation/001-conventional-commit-from-diff.md`

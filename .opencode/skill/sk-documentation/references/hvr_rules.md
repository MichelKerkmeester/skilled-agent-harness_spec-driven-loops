...
| README | `.opencode/skill/sk-documentation/assets/documentation/readme_template.md` | Welcoming tone, practical focus |
| Install Guide | `.opencode/skill/sk-documentation/assets/documentation/install_guide_template.md` | Direct instructions, imperative mood |

### Standards
- [core_standards.md](./core_standards.md) - Document formatting standards
- [sk-documentation SKILL.md](../SKILL.md) - Parent skill with HVR enforcement rules

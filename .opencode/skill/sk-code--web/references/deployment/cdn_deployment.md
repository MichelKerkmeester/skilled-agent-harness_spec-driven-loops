...
□ AST verification passed (node .opencode/skill/sk-code--web/scripts/verify-minification.mjs)
□ Runtime test passed (node .opencode/skill/sk-code--web/scripts/test-minified-runtime.mjs)
...
3. Verify       → node .opencode/skill/sk-code--web/scripts/verify-minification.mjs
4. Test         → node .opencode/skill/sk-code--web/scripts/test-minified-runtime.mjs

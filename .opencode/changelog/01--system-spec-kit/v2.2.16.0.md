...
> Spec folder: `specs/02--system-spec-kit/z_archive/008-codex-system-wide-audit/` (Level 3+)
...
- `specs/02--system-spec-kit/z_archive/008-codex-system-wide-audit/` (all documentation files)

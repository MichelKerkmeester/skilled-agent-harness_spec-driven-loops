...
**Consolidated agent-orchestration update (ChatGPT + Copilot + Claude + core runtime model defaults)** -- Combines the single-hop delegation safety rollout, Claude parity sync, and core OpenCode model-unpin changes into one release note for `specs/05--agent-orchestration/021-codex-orchestrate`.

> Spec folder: `specs/05--agent-orchestration/021-codex-orchestrate/` (Level 3)
>

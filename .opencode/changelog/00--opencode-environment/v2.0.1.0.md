...
> Spec folders: `.opencode/specs/02--system-spec-kit/111-readme-anchor-schema/` through `117-create-folder-readme-alignment/` (Levels 2-3+)
...
~130+ files across `.opencode/command/`, `.opencode/skill/`, README.md files, YAML assets, and tests

...
- **Skill graph migration**: `mcp-code-mode` and `workflows-documentation` SKILL.md files restructured to `index.md` + `nodes/` format with granular skill graph nodes.
- **New skill graph nodes**: `smart-routing.md`, `success-criteria.md`, `when-to-use.md` for workflows-documentation; `rules.md`, `when-to-use.md`, `success-criteria.md` for mcp-code-mode.

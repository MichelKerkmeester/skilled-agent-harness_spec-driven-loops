...
- **Session memory corrected**: Misrouted memory was moved into `.opencode/specs/05--agent-orchestration/021-codex-orchestrate/memory/` and normalized to the correct spec metadata.
...
- `.opencode/specs/05--agent-orchestration/021-codex-orchestrate/memory/19-02-26_17-51__codex-orchestrate.md`

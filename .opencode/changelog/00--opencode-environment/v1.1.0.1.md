...
**Critical: Code Mode Environment Variables** — Documentation fix for prefixed env var format across 2 skills, plus 5 new skill-level CHANGELOGs for better change tracking.
...
- **5 CHANGELOGs created** — mcp-code-mode, mcp-figma, workflows-chrome-devtools, workflows-documentation, sk-git
...
- `.opencode/skill/sk-git/CHANGELOG.md`

...
> Related spec: `.opencode/specs/02--system-spec-kit/020-mcp-working-memory-hybrid-rag/`
...
- `.opencode/specs/02--system-spec-kit/020-mcp-working-memory-hybrid-rag/*.md`
- `.opencode/specs/02--system-spec-kit/020-mcp-working-memory-hybrid-rag/007-documentation-alignment/*.md`

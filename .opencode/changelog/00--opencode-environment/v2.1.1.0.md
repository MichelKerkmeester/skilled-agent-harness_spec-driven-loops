...
This release packages post-`v2.0.2.3` framework work into one consistent update across orchestration, commands, documentation, and memory/runtime reliability. The sections below summarize the highest-impact changes and where they landed.
...
- **Indexable spec documentation introduced (prominent)** -- Spec folder documents became a first-class index source (spec, plan, tasks, checklist, decision records, implementation summary, research, handover), enabling `find_spec`/`find_decision` workflows and spec-level retrieval.
- **README indexing and anchor coverage strengthened** -- README indexing quality and anchor/HVR compliance were expanded to improve retrieval precision and consistency.
...
- **Skill/changelog consistency updates** -- Version normalization and changelog additions for `workflows-code--opencode`, `workflows-code--web-dev`, `workflows-code--full-stack`, and `sk-git`.

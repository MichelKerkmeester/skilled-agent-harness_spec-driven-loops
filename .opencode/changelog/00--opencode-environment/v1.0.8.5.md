...
**Performance Patterns Series** — Adding Phase 0: Research to workflows-code, 6 new performance references, AGENTS.md Section 9 for multi-stack code implementation, with all 27 documents verified and quality fixes applied.
...
`workflows-code/SKILL.md`, `cwv_remediation.md`, `resource_loading.md`, `webflow_constraints.md`, `third_party.md`, `performance_checklist.md`, `multi_agent_patterns.md`, `AGENTS.md`, `validation_patterns.js`, `code_quality_checklist.md`, and 17 additional files

...
> Spec folder: `anobel.com/.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/` (Level 3+, 5 ADRs)
...
### Style — Header Alignment & Standardization
...
### Fixed — AGENTS.md Audit & Repository Cleanup
...
- 7 command `.md` files in `.opencode/command/spec_kit/`
- 11 YAML assets in `.opencode/command/spec_kit/assets/`
- `AGENTS.md`
- `.gitignore`
- `.agents/` (symlinks)

...
**Complete Memory System Overhaul** — Largest SpecKit release: 6 specs batched with causal memory graph, 44% command consolidation (9→5), 86 bug fixes P0-P3, and 28+ parallel Opus agents with comprehensive audits.
...
- **Command Migration** — Update scripts using old commands:

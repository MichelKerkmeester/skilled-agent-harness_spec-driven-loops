...
```
/spec_kit:resume 004-agents/020-agent-sonnet-upgrade
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: 004-agents/020-agent-sonnet-upgrade
Last: Tool: bash
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 004-agents/020-agent-sonnet-upgrade` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "004-agents/020-agent-sonnet-upgrade" })` |
...
memory_search({ specFolder: "004-agents/020-agent-sonnet-upgrade", limit: 10 })

# Verify memory file integrity
ls -la 004-agents/020-agent-sonnet-upgrade/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js 004-agents/020-agent-sonnet-upgrade --force
```
...
spec_folder: "004-agents/020-agent-sonnet-upgrade"
channel: "main"
...
parent_spec: "004-agents/020-agent-sonnet-upgrade"
child_sessions:

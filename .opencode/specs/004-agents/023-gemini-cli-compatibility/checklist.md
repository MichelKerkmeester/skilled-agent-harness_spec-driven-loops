...
- [ ] CHK-030 [P0] 9 skill symlinks created in `.gemini/skills/` (mcp-code-mode, mcp-figma, system-spec-kit, workflows-chrome-devtools, workflows-code--full-stack, workflows-code--opencode, workflows-code--web-dev, workflows-documentation, workflows-git)

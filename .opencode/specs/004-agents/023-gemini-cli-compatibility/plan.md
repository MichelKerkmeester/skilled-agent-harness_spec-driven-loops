...
4. Model activates skill → reads `.gemini/skills/workflows-documentation/SKILL.md` → follows symlink to `.opencode/skill/` source
...
- [ ] `.gemini/skills/workflows-git` → `../../.opencode/skill/workflows-git`

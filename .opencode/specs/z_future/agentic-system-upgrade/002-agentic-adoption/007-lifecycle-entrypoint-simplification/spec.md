...
trigger_phrases:
  - "feature"
  - "specification"
  - "007-lifecycle-entrypoint-simplification"
  - "adoption"
importance_tier: "important"
contextType: "implementation"
---
# Feature Specification: 007 Lifecycle Entrypoint Simplification
...
| **Status** | Draft |
| **Created** | 2026-04-11 |
| **Branch** | `007-lifecycle-entrypoint-simplification` |
| **Parent Spec** | `../spec.md` |
| **Predecessor Phase** | `../006-agent-role-consolidation/spec.md` |
| **Successor Phase** | `../008-continuity-and-memory-ux-integration/spec.md` |
<!-- /ANCHOR:metadata -->
...
### Problem Statement
Public already has the core authority needed for 007 lifecycle entrypoint simplification, but the change still needs one implementation-ready contract. This child phase narrows the converged research into a current-authority-safe design.

### Purpose
Turn the research synthesis for 007 lifecycle entrypoint simplification into one follow-on implementation-ready packet contract.

### Research Sources
- `.opencode/specs/system-spec-kit/999-agentic-system-upgrade/001-research-agentic-systems/001-agent-lightning-main/research/archive/legacy-research-log/research-dashboard-legacy.md:25-34` - Agent Lightning Phase 3 called the lifecycle front door redesign a must-have while explicitly keeping slash commands.
- `.opencode/specs/system-spec-kit/999-agentic-system-upgrade/001-research-agentic-systems/002-babysitter-main/research/archive/legacy-research-log/research-dashboard-legacy.md:25-34` - Babysitter Phase 3 consistently merged lifecycle, continuity, and skill surfaces behind a smaller operator shell.
- `.opencode/specs/system-spec-kit/999-agentic-system-upgrade/001-research-agentic-systems/003-claude-code-mastery-project-starter-kit-main/research/archive/legacy-research-log/research-dashboard-legacy.md:25-34` - Claude Code starter-kit synthesis favored one guided work command and fewer up-front lifecycle choices.
- `.opencode/specs/system-spec-kit/999-agentic-system-upgrade/001-research-agentic-systems/003-claude-code-mastery-project-starter-kit-main/research/iterations/iteration-029.md:18-30` - Late synthesis recommended a single guided work command that interviews once and routes through existing lifecycle internals.
<!-- /ANCHOR:problem -->
...
### In Scope
- Define the thin entry surface that wraps plan, implement, complete, and resume behavior.
- Identify which current command docs and YAML assets become expert or internal surfaces after the wrapper lands.
...
- **SC-001**: A canonical guided entrypoint is defined with routing rules for new work, bound continuation, and expert escape hatches.
- **SC-002**: The packet names the exact lifecycle docs and wrappers that would change.
- **SC-003**: The phase documents how slash-command compatibility is preserved during rollout.

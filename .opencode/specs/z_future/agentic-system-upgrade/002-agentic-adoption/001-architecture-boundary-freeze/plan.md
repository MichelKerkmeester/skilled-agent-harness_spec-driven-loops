...
---
# Implementation Plan: 001 Architecture Boundary Freeze
...
### Overview
Lock the non-negotiable adoption rule: keep Public's current authorities, preserve externalized loop state, and only import compatible patterns at the shell layer.
<!-- /ANCHOR:summary -->
...
|------------|------|--------|-------------------|
| Parent packet only | Internal | Green | None beyond the parent packet |
<!-- /ANCHOR:dependencies -->

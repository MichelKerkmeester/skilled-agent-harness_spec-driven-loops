...
---
# Feature Specification: 002 Retry Feedback Bridge
...
| **Status** | Draft |
| **Created** | 2026-04-11 |
| **Branch** | `002-retry-feedback-bridge` |
| **Parent Spec** | `../spec.md` |
| **Predecessor Phase** | `../001-architecture-boundary-freeze/spec.md` |
| **Successor Phase** | `../003-loop-observability/spec.md` |
<!-- /ANCHOR:metadata -->
...
### Problem Statement
Public already has the core authority needed for 002 retry feedback bridge, but the change still needs one implementation-ready contract. This child phase narrows the converged research into a current-authority-safe design.

### Purpose
Turn the research synthesis for 002 retry feedback bridge into one follow-on implementation-ready packet contract.

### Research Sources
- `.opencode/specs/system-spec-kit/999-agentic-system-upgrade/001-research-agentic-systems/004-get-it-right-main/research/archive/legacy-research-log/research-dashboard-legacy.md:5-14` - Phase 1 identified fresh forks, verify-before-review, compressed feedback bridging, and attempt-local state as the most portable Reliant patterns.
- `.opencode/specs/system-spec-kit/999-agentic-system-upgrade/001-research-agentic-systems/004-get-it-right-main/research/archive/legacy-research-log/research-dashboard-legacy.md:25-34` - Phase 3 converged on merging lifecycle surfaces and redesigning the default feature workflow around lower-friction execution.
- `.opencode/specs/system-spec-kit/999-agentic-system-upgrade/001-research-agentic-systems/004-get-it-right-main/research/iterations/iteration-030.md:27-47` - Final synthesis framed the external loop as a lower-friction workflow shell that should wrap existing authorities rather than replace them.
<!-- /ANCHOR:problem -->
...
### Out of Scope
- Replacing the existing review agent or memory platform.
- Adding global retry state outside the active packet.
- Generalizing this bridge into a cross-system loop kernel in the same phase.

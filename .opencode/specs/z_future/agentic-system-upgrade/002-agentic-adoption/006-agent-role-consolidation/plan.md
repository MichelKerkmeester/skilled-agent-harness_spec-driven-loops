...
---
# Implementation Plan: 006 Agent Role Consolidation
...
### Overview
Reduce operator-visible agent sprawl by consolidating related roles into capability bundles while keeping exclusive authorities where file ownership or review safety requires them.
<!-- /ANCHOR:summary -->

...
- Public also already has iterative loop managers for deep research and deep review, each with externalized state, convergence handling, synthesis phases, and memory preservation. [SOURCE: .opencode/commands/speckit/deep-research.md:147-155] [SOURCE: .opencode/commands/speckit/deep-review.md:162-169]

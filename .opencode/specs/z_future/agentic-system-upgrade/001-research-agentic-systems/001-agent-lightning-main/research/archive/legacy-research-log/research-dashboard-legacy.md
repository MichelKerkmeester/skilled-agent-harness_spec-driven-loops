...
| 012 | 2 | Standard-tool validation versus monolithic `validate.sh` orchestration? | high | must-have | refactor | `.opencode/skills/system-spec-kit/scripts/spec/validate.sh` |
...
| 017 | 2 | Named agent-role sprawl versus capability layers? | medium | should-have | simplify | `.opencode/agents/orchestrate.md` |

...
- Public's Codex, Gemini, and Copilot references all share the conductor/executor model, but each describes capabilities in tool-specific prose and syntax. [SOURCE: .opencode/skills/cli-codex/references/agent_delegation.md:17-22] [SOURCE: .opencode/skills/cli-gemini/references/agent_delegation.md:15-22] [SOURCE: .opencode/skills/cli-copilot/references/agent_delegation.md:14-20]
- The three Public references diverge on what they foreground: profiles and stateless exec for Codex, prompt-invoked agents and tool lists for Gemini, and Explore/Task/Cloud modes for Copilot. [SOURCE: .opencode/skills/cli-codex/references/agent_delegation.md:62-89] [SOURCE: .opencode/skills/cli-gemini/references/agent_delegation.md:60-79] [SOURCE: .opencode/skills/cli-copilot/references/agent_delegation.md:57-79]
...
- **Target file or module:** `.opencode/skills/cli-codex/references/agent_delegation.md`, `.opencode/skills/cli-gemini/references/agent_delegation.md`, `.opencode/skills/cli-copilot/references/agent_delegation.md`, and the `system-spec-kit` documentation contract

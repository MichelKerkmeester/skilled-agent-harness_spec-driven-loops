...
## Evidence
- Both `AGENTS.md` and `CLAUDE.md` require Gate 2 for non-trivial tasks, explicitly instructing the agent to run `python3 .opencode/skills/scripts/skill_advisor.py ... --threshold 0.8`. [SOURCE: AGENTS.md:174-179] [SOURCE: CLAUDE.md:122-127]
- The skill advisor is itself a substantial routing system, with synonym expansion, intent boosters, and threshold logic designed around confidence scoring. [SOURCE: .opencode/skills/scripts/skill_advisor.py:6-17] [SOURCE: .opencode/skills/scripts/skill_advisor.py:67-80] [SOURCE: .opencode/skills/scripts/skill_advisor.py:211-219]
- Public also carries specialist skills whose value is real but long-tail, including prompt improvement and bounded agent-improvement loops. [SOURCE: .opencode/skills/sk-improve-prompt/SKILL.md:10-38] [SOURCE: .opencode/skills/sk-improve-agent/SKILL.md:17-47]

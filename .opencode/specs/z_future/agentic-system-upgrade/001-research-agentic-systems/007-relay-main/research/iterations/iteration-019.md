...
- Public's deep-research skill is intentionally narrow: one focus per iteration, externalized state, quality guards, findings registry, and final reducer-owned synthesis. [SOURCE: .opencode/skills/sk-deep-research/SKILL.md:179-222] [SOURCE: .opencode/skills/sk-deep-research/SKILL.md:229-255]
- Public's deep-review skill is likewise narrow and domain-specific: review dimensions, P0/P1/P2 findings, lineage-aware reducer contract, and strict read-only review rules. [SOURCE: .opencode/skills/sk-deep-review/SKILL.md:216-285] [SOURCE: .opencode/skills/sk-deep-review/SKILL.md:307-333]

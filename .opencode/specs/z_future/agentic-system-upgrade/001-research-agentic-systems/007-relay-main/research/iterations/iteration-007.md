...
- Public's deep-research command defines an iterative loop with state files, dashboards, synthesis, and memory save, but it does not define a comparable evidence/owner completion ladder for iterations or synthesis. [SOURCE: .opencode/commands/speckit/deep-research.md:117-154]

...
## Evidence
- `system-spec-kit` declares itself mandatory for all file modifications and also requires routing code updates through `sk-code-opencode` and documentation updates through `sk-doc`. [SOURCE: .opencode/skills/system-spec-kit/SKILL.md:10-12] [SOURCE: .opencode/skills/system-spec-kit/SKILL.md:808-830]
- `sk-code-opencode` owns OpenCode system-code standards only and explicitly excludes web/frontend and broader lifecycle work. [SOURCE: .opencode/skills/sk-code-opencode/SKILL.md:10-18] [SOURCE: .opencode/skills/sk-code-opencode/SKILL.md:21-48]
- `sk-code-web` owns frontend implementation patterns but still delegates formal review output to `sk-code-review`. [SOURCE: .opencode/skills/sk-code-web/SKILL.md:61-68] [SOURCE: .opencode/skills/sk-code-web/SKILL.md:495-505]
- `sk-code-full-stack` is another stack-agnostic development orchestrator that likewise depends on `sk-code-review` as the baseline. [SOURCE: .opencode/skills/sk-code-full-stack/SKILL.md:10-15] [SOURCE: .opencode/skills/sk-code-full-stack/SKILL.md:41-60]
- `sk-code-review` itself defines a baseline+overlay model where exactly one `sk-code-*` overlay is paired with the review baseline. [SOURCE: .opencode/skills/sk-code-review/SKILL.md:10-12] [SOURCE: .opencode/skills/sk-code-review/SKILL.md:47-68]
- Public also maintains longer-tail specialist skills such as `sk-improve-prompt`, `sk-improve-agent`, and `mcp-coco-index`. [SOURCE: .opencode/skills/sk-improve-prompt/SKILL.md:10-38] [SOURCE: .opencode/skills/sk-improve-agent/SKILL.md:17-47] [SOURCE: .opencode/skills/mcp-coco-index/SKILL.md:10-32]

...
- Public's `deep-research` and `deep-review` commands each restate setup, lifecycle, outputs, memory integration, and examples in separate long-form markdown entrypoints. [SOURCE: .opencode/commands/speckit/deep-research.md:7-31] [SOURCE: .opencode/commands/speckit/deep-research.md:147-247] [SOURCE: .opencode/commands/speckit/deep-review.md:7-33] [SOURCE: .opencode/commands/speckit/deep-review.md:162-286]

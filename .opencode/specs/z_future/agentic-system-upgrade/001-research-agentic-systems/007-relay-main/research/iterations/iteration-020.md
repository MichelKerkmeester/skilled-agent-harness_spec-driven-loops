...
- Public's `deep-research` and `deep-review` commands each restate setup, lifecycle, outputs, memory integration, and examples in separate long-form markdown entrypoints. [SOURCE: .opencode/commands/spec_kit/deep-research.md:7-31] [SOURCE: .opencode/commands/spec_kit/deep-research.md:147-247] [SOURCE: .opencode/commands/spec_kit/deep-review.md:7-33] [SOURCE: .opencode/commands/spec_kit/deep-review.md:162-286]
- Public's provider delegation references likewise repeat conductor/executor framing, routing rules, and capability explanations across three provider-specific markdown files. [SOURCE: .opencode/skills/cli-codex/references/agent_delegation.md:15-22] [SOURCE: .opencode/skills/cli-gemini/references/agent_delegation.md:15-22] [SOURCE: .opencode/skills/cli-copilot/references/agent_delegation.md:12-29]

...
- `/spec_kit:resume` alone contains a large consolidated setup phase with auto-detection, phase-child selection, continuation validation, artifact checks, and memory-choice routing before the main workflow begins. [SOURCE: .opencode/commands/spec_kit/resume.md:37-141]
...
- **Current system-spec-kit approach:** Rich command taxonomy plus gate-driven setup prompts expose many branches before work starts. [SOURCE: .opencode/skills/system-spec-kit/references/workflows/quick_reference.md:116-187] [SOURCE: .opencode/commands/spec_kit/resume.md:37-141]

...
I looked for strong task-local executable acceptance contracts in the current Level 3 tasks template and found broad phase buckets instead, which reinforces the current documentation-heavy validation bias. [SOURCE: .opencode/skills/system-spec-kit/templates/level_3/tasks.md:35-71]

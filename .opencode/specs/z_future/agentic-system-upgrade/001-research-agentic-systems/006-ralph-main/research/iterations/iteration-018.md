...
- `system-spec-kit`'s current task guidance still stops at task breakdown, dependencies, and effort estimates, which leaves execution-size rules under-specified. [SOURCE: .opencode/skills/system-spec-kit/references/templates/level_specifications.md:117-123] [SOURCE: .opencode/skills/system-spec-kit/templates/level_3/tasks.md:35-71]

...
- Deep research already splits protocol across multiple layers: the command owns setup and YAML dispatch, while the agent owns a single-iteration contract. [SOURCE: .opencode/commands/speckit/deep-research.md:7-24] [SOURCE: .opencode/commands/speckit/deep-research.md:147-174] [SOURCE: .opencode/agents/deep-research.md:24-29] [SOURCE: .opencode/agents/deep-research.md:50-60]

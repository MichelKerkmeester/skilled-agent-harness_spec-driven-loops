...
- `system-spec-kit` is architecturally broader: deep research alone spans setup, YAML workflow execution, convergence detection, synthesized reporting, and memory save. [SOURCE: .opencode/commands/speckit/deep-research.md:115-154]
...
I looked for evidence that Ralph solves the same scope of lifecycle/governance problems as `system-spec-kit` and found none; the bundled repo remains intentionally narrower throughout code and docs. [SOURCE: external/README.md:88-145] [SOURCE: .opencode/commands/speckit/deep-research.md:147-174]

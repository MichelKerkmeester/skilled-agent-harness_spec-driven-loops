...
- `system-spec-kit` currently leans on dense textual quick-reference and command docs for onboarding and command selection. [SOURCE: .opencode/skills/system-spec-kit/references/workflows/quick_reference.md:15-32] [SOURCE: .opencode/skills/system-spec-kit/references/workflows/quick_reference.md:110-187]
...
I looked for an equivalent first-class lifecycle diagram in the current quick-reference and command docs and did not find one; the onboarding surface is primarily textual. [SOURCE: .opencode/skills/system-spec-kit/references/workflows/quick_reference.md:110-187]

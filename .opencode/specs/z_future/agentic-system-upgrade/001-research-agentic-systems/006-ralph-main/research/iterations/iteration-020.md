...
- `system-spec-kit` intentionally spans a much wider stack: command families for resume/plan/implement/research/review, a large memory subsystem, and governance-aware retrieval/management surfaces. [SOURCE: .opencode/skills/system-spec-kit/references/workflows/quick_reference.md:116-130] [SOURCE: .opencode/skills/system-spec-kit/references/memory/memory_system.md:99-145] [SOURCE: .opencode/commands/memory/manage.md:48-99]

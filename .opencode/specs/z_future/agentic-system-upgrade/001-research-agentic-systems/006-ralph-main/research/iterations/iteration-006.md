...
- `system-spec-kit`'s deep-research command explicitly uses a Markdown setup phase plus a YAML workflow with initialization, loop, synthesis, and save phases. [SOURCE: .opencode/commands/deep/start-research-loop.md:7-23] [SOURCE: .opencode/commands/deep/start-research-loop.md:147-174]
- The auto YAML manages config/state files, lineage, convergence checks, reducer-owned artifacts, and dispatch context construction. [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:96-207] [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:250-320]
...
- **Target file or module:** `.opencode/skills/system-spec-kit/scripts/spec/fresh-loop.sh`

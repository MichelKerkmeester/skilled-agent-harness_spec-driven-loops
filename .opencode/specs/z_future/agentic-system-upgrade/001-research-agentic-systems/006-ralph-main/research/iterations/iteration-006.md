...
- `system-spec-kit`'s deep-research command explicitly uses a Markdown setup phase plus a YAML workflow with initialization, loop, synthesis, and save phases. [SOURCE: .opencode/commands/spec_kit/deep-research.md:7-23] [SOURCE: .opencode/commands/spec_kit/deep-research.md:147-174]
- The auto YAML manages config/state files, lineage, convergence checks, reducer-owned artifacts, and dispatch context construction. [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:96-207] [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:250-320]

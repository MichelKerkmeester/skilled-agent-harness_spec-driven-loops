...
- `system-spec-kit` formalizes three gates, multiple constitutional files, hook fallback rules, a large feature-flag table, and a wide set of mandatory or "always/never" behaviors. [SOURCE: .opencode/skills/system-spec-kit/constitutional/gate-enforcement.md:58-87] [SOURCE: .opencode/skills/system-spec-kit/constitutional/gate-tool-routing.md:35-55] [SOURCE: .opencode/skills/system-spec-kit/SKILL.md:650-710] [SOURCE: .opencode/skills/system-spec-kit/SKILL.md:812-842]
- Session hooks add real value for continuity, but they also show that much of the gate-and-recovery machinery can already run implicitly. [SOURCE: .opencode/skills/system-spec-kit/references/config/hook_system.md:5-30] [SOURCE: .opencode/skills/system-spec-kit/mcp_server/dist/hooks/claude/session-prime.js:83-168] [SOURCE: .opencode/skills/system-spec-kit/mcp_server/dist/hooks/claude/session-stop.js:154-234]
...
I looked for proof that the full gate sequence must remain explicitly user-visible to preserve correctness, but the hook system already shows that some of this machinery can execute implicitly without operator burden. [SOURCE: .opencode/skills/system-spec-kit/references/config/hook_system.md:5-30] [SOURCE: .opencode/skills/system-spec-kit/mcp_server/dist/hooks/claude/session-prime.js:83-168]

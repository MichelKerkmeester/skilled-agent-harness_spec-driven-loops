...
- Top Phase 3 adoption opportunities for `system-spec-kit`:
  ...
  - Add one guided lifecycle front door above `/speckit:plan`, `/speckit:implement`, and `/speckit:complete`. [SOURCE: .opencode/commands/speckit/plan.md:13-21] [SOURCE: .opencode/commands/speckit/implement.md:171-201] [SOURCE: .opencode/commands/speckit/complete.md:198-217]

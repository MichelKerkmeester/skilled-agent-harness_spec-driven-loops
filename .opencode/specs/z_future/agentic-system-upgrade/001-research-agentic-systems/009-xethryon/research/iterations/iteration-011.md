...
- Spec Kit's own research workflow already assumes reducer-owned artifacts and explicit packet outputs, which makes it a natural place to require a generated surface inventory instead of trusting a prose-only summary. [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:79-89] [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:328-343] [SOURCE: .opencode/skills/system-spec-kit/README.md:52-56] [SOURCE: .opencode/skills/system-spec-kit/README.md:227-246]

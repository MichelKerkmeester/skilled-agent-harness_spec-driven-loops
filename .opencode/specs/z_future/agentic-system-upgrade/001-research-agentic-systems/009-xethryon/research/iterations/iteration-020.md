...
- Spec Kit already has startup/recovery surfaces (`session_bootstrap()` and `session_resume()`) and presents next-step continuation behavior in its docs, but that guidance is more descriptive than compact. [SOURCE: .opencode/skills/system-spec-kit/README.md:93-99] [SOURCE: .opencode/skills/system-spec-kit/README.md:170-179] [SOURCE: .opencode/skills/system-spec-kit/references/memory/memory_system.md:103-105]
- The current gate system is rich, but its operator-facing explanation lives mostly in long-form docs rather than a concise runtime hint surface. [SOURCE: .opencode/skills/system-spec-kit/constitutional/gate-enforcement.md:62-106]

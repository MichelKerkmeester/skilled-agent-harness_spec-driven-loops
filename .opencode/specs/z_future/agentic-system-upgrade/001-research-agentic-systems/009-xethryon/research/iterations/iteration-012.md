...
- Spec Kit's deep-research workflow requires citations and reducer-owned outputs, but it does not currently force the researcher to attach a verification source to each material external claim. [SOURCE: .opencode/agents/deep-research.md:113-120] [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:328-359]

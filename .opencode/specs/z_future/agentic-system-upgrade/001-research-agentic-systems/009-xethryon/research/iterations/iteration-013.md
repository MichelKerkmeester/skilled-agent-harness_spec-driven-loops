...
- Spec Kit's save path is intentionally explicit: structured JSON is preferred, the CLI target is authoritative, and indexed content comes from three managed sources rather than free-form repo-global markdown alone. [SOURCE: .opencode/skills/system-spec-kit/scripts/memory/generate-context.ts:75-84] [SOURCE: .opencode/skills/system-spec-kit/scripts/memory/generate-context.ts:163-231] [SOURCE: .opencode/skills/system-spec-kit/references/memory/memory_system.md:17-27] [SOURCE: .opencode/skills/system-spec-kit/references/memory/memory_system.md:36-57]

...
- [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:20-23] `system-spec-kit` already encodes the same principle for research: fresh context per iteration plus externalized state is treated as the core operating model.
...
- [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:320-325] The internal dispatcher already enforces leaf-only behavior, limited tool budgets, and file-owned state rather than long-lived conversational carry-over.

...
- [SOURCE: .opencode/agents/orchestrate.md:171-181] `system-spec-kit` supports a broader runtime inventory including retrieval, research, documentation, debugging, handover, and planning specialists.
- [SOURCE: .opencode/agents/deep-research.md:24-32] At least one internal specialist exists because it owns a different workflow family: iterative research rather than implementation retry.
- [SOURCE: .opencode/agents/orchestrate.md:177-181] Documentation and handover remain explicit specialists rather than generic loop actors.

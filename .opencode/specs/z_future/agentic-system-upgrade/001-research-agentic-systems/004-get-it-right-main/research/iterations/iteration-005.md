...
- [SOURCE: .opencode/agents/review.md:124-131] The internal review agent returns PASS/FAIL bands with auto-retry guidance based on score, but not an explicit branch decision for the surrounding workflow.
- [SOURCE: .opencode/agents/review.md:237-257] The internal quality-gate output includes `pass`, score breakdown, blockers, required changes, suggestions, and revision guidance, which is rich review data but not a control-plane strategy enum.
...
- **Target file or module:** `.opencode/agents/review.md`

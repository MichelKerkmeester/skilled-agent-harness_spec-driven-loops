...
- [SOURCE: .opencode/commands/speckit/assets/speckit_implement_auto.yaml:501-518] Internal durable memory creation is an end-of-session action with a hard boundary around `generate-context.js`, which implies a curated preservation step rather than per-attempt chatter.

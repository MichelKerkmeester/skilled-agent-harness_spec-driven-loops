...
- [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:361-369] `system-spec-kit` already maintains human-readable reducer outputs inside the packet itself, showing that packet-local observability is an accepted pattern distinct from memory persistence.

...
- [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:79-89] The internal deep-research workflow declares config, state log, strategy, registry, dashboard, pause sentinel, archive root, synthesis snapshots, and iteration outputs as first-class packet paths.
- [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:157-197] Initialization creates config, JSONL, strategy, and findings registry before any research iteration runs.
- [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:218-369] Each iteration reads state, checks convergence, dispatches a leaf, runs a reducer, updates registry, and regenerates a dashboard.
...
- **Target file or module:** `.opencode/commands/deep/assets/deep_start-research-loop_auto.yaml` and related loop contracts

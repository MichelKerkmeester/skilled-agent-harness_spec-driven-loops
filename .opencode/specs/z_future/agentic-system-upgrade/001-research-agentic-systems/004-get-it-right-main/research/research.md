...
- **Phase 2:** keep retry-mode separate from the normal implementation lifecycle, keep working state out of durable memory, and extract common loop primitives instead of building another bespoke stack. [SOURCE: .opencode/commands/spec_kit/implement.md:151-205] [SOURCE: .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js:61-93] [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:212-380]

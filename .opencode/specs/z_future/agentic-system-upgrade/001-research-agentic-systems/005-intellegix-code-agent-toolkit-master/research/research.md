...
- system-spec-kit target: `.opencode/skills/sk-deep-research/assets/deep_research_config.json`, `.opencode/skills/sk-deep-research/references/loop_protocol.md`
- Priority: should-have
...
- system-spec-kit target: `.opencode/skills/sk-deep-research/references/convergence.md`, `.opencode/skills/sk-deep-research/references/loop_protocol.md`
- Priority: should-have
...
- system-spec-kit target: `.opencode/agents/orchestrate.md`, `.opencode/skills/system-spec-kit/constitutional/gate-tool-routing.md`
- Priority: should-have
...
- system-spec-kit target: `.opencode/skills/system-spec-kit/templates/decision-record.md`, `.opencode/skills/system-spec-kit/references/validation/validation_rules.md`
- Priority: nice-to-have
...
- system-spec-kit target: `.opencode/skills/system-spec-kit/scripts/tests/deep-research-contract-parity.vitest.ts`, `.opencode/skills/system-spec-kit/scripts/tests/deep-research-reducer.vitest.ts`
- Priority: must-have
...
- system-spec-kit target: `.opencode/skills/system-spec-kit/references/templates/level_specifications.md`, `.opencode/skills/system-spec-kit/references/templates/template_guide.md`
- Priority: should-have

...
- `[SOURCE: .opencode/skills/system-spec-kit/references/memory/save_workflow.md:148-152]` The slash-command save path requires the AI to analyze the conversation, produce structured JSON, invoke `generate-context.js`, and then write into `memory/`.

...
- `[SOURCE: .opencode/skills/system-spec-kit/references/structure/phase_definitions.md:8-19]` `system-spec-kit` phases are a decomposition overlay, not a product-maturity tier.
- `[SOURCE: .opencode/skills/system-spec-kit/references/structure/phase_definitions.md:37-68]` Phase detection is driven by complexity score and documentation level, not user count or business criticality.
- `[SOURCE: .opencode/skills/system-spec-kit/references/validation/validation_rules.md:17-27]` Validation is centered on documentation completeness and quality, not product portfolio governance.
...
- **Target file or module:** `.opencode/skills/system-spec-kit/references/validation/validation_rules.md`, `.opencode/skills/system-spec-kit/templates/decision-record.md`

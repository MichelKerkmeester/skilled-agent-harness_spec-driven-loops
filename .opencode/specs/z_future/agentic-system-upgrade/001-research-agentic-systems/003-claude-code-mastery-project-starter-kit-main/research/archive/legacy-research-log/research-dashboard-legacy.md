...
| 002 | Guided doc-first front door | high | should-have | KEEP | `.opencode/commands/speckit/README.txt` |
...
| 021 | Merge lifecycle command front door | high | should-have | MERGE | `.opencode/commands/speckit/README.txt` |
...
| 029 | Add one guided work command | high | should-have | ADD | `.opencode/commands/speckit/` |

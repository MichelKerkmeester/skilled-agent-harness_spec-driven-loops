...
## Evidence
- The local command README and Spec Kit README present a broad command matrix, then ask the operator to choose among separate planning, implementation, completion, resume, handover, debug, deep-review, and deep-research entry points. [SOURCE: .opencode/commands/README.txt:84-100] [SOURCE: .opencode/commands/spec_kit/README.txt:54-76] [SOURCE: .opencode/commands/spec_kit/README.txt:121-159]
- Local lifecycle commands are not just labels; they each carry their own autonomous workflow logic and branching prompts, especially in the completion and resume assets. [SOURCE: .opencode/commands/spec_kit/implement.md:29-120] [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_complete_auto.yaml:30-108] [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml:32-92]
...
- **Target file or module:** `.opencode/commands/spec_kit/README.txt`, command routing surfaces, workflow asset entrypoints
...
I looked for evidence that the local split materially reduces ambiguity for operators, but the docs mostly shift the burden onto the user to pick the correct command before the automation begins. [SOURCE: .opencode/commands/spec_kit/README.txt:83-111]

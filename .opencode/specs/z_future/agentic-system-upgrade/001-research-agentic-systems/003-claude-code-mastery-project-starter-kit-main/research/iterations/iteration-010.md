...
- The local repo already has a much broader agent set with explicit contracts for deep research, handover, and session priming, including LEAF-only rules, recovery behavior, and output verification. [SOURCE: .opencode/agents/deep-research.md:22-32] [SOURCE: .opencode/agents/deep-research.md:36-43] [SOURCE: .opencode/agents/context-prime.md:22-39] [SOURCE: .opencode/agents/context-prime.md:57-65] [SOURCE: .opencode/agents/handover.md:22-31] [SOURCE: .opencode/agents/handover.md:40-58]
- Local skill routing is already formalized through `skill_advisor.py`, which exists specifically to recommend skills using thresholds, synonyms, and intent boosters. [SOURCE: .opencode/skills/scripts/skill_advisor.py:7-16] [SOURCE: .opencode/skills/scripts/skill_advisor.py:32-45] [SOURCE: .opencode/skills/scripts/skill_advisor.py:67-84] [SOURCE: .opencode/skills/scripts/skill_advisor.py:211-218] [SOURCE: .opencode/skills/scripts/skill_advisor.py:221-260]
...
- **Target file or module:** `.opencode/agents/`

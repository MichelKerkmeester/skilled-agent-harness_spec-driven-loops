...
- The local deep-research agent explicitly treats JSONL, strategy, findings registry, dashboard, and progressive `research.md` updates as synchronized packet surfaces. [SOURCE: .opencode/agents/deep-research.md:50-60] [SOURCE: .opencode/agents/deep-research.md:159-213]
- The `sk-deep-research` skill frames the workflow as a three-layer system with config, strategy, JSONL, findings registry, dashboard, and progressive synthesis, and it treats reducer ownership as part of the live contract. [SOURCE: .opencode/skills/sk-deep-research/SKILL.md:167-176] [SOURCE: .opencode/skills/sk-deep-research/SKILL.md:215-221] [SOURCE: .opencode/skills/sk-deep-research/SKILL.md:231-244] [SOURCE: .opencode/skills/sk-deep-research/SKILL.md:316-323]
- The local agent even awards a novelty bonus for simplification/consolidation work, which is a good signal that the workflow already recognizes over-complex state as a problem. [SOURCE: .opencode/agents/deep-research.md:191-201]
...
- **Target file or module:** `.opencode/agents/deep-research.md`, `.opencode/skills/sk-deep-research/SKILL.md`, `spec_kit:deep-research` workflow assets
...
I looked for evidence that the external repo solves convergence, recovery, and lineage tracking at the same scale as `system-spec-kit`; it does not. That means the local loop abstraction is still justified even if the artifact count is not. [SOURCE: .opencode/agents/deep-research.md:167-213]

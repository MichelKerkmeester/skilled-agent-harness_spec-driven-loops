...
- The local `session-prime` hook injects startup and recovery context, exposes memory/code-graph tools, and adjusts output to token pressure. [SOURCE: .opencode/skills/system-spec-kit/mcp_server/hooks/claude/session-prime.ts:111-173] [SOURCE: .opencode/skills/system-spec-kit/mcp_server/hooks/claude/session-prime.ts:245-260]
- The local `compact-inject` hook caches compact context using transcript analysis plus merged memory/code-graph signals, while `session-stop` stores token snapshots and can auto-save a session summary. [SOURCE: .opencode/skills/system-spec-kit/mcp_server/hooks/claude/compact-inject.ts:5-8] [SOURCE: .opencode/skills/system-spec-kit/mcp_server/hooks/claude/compact-inject.ts:205-225] [SOURCE: .opencode/skills/system-spec-kit/mcp_server/hooks/claude/session-stop.ts:175-192]

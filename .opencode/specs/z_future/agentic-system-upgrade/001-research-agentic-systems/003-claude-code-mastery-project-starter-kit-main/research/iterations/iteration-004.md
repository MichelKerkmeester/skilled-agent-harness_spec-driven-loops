...
- The local deep-research agent is explicitly packet-based: it writes `research/iterations/iteration-NNN.md`, appends JSONL state, and progressively updates `research/research.md`. [SOURCE: .opencode/agents/deep-research.md:24-32] [SOURCE: .opencode/agents/deep-research.md:50-60] [SOURCE: .opencode/agents/deep-research.md:159-171]
- The local handover agent requires reading `spec.md`, `plan.md`, `tasks.md`, `checklist.md`, `memory/*.md`, and `implementation-summary.md` before writing a continuation document from a template. [SOURCE: .opencode/agents/handover.md:28-31] [SOURCE: .opencode/agents/handover.md:42-58]
- The local Claude Stop hook can auto-save a session summary into the memory pipeline by running `generate-context.js` for the last active spec folder. [SOURCE: .opencode/skills/system-spec-kit/mcp_server/hooks/claude/session-stop.ts:60-83] [SOURCE: .opencode/skills/system-spec-kit/mcp_server/hooks/claude/session-stop.ts:97-105]
...
- **Target file or module:** `.opencode/skills/system-spec-kit/templates/`

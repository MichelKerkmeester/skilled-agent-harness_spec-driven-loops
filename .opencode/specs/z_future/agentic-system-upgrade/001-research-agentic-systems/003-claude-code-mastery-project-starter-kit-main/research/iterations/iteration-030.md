...
## Evidence
- The local command ecosystem is documented through several static READMEs and command documents, which are informative but require manual navigation. [SOURCE: .opencode/commands/README.txt:36-60] [SOURCE: .opencode/commands/speckit/README.txt:41-45] [SOURCE: .opencode/commands/memory/README.txt:36-52]
- Some local status or health capabilities exist, but they are specialized and split across memory management, resume, dashboards, and validator outputs. [SOURCE: .opencode/commands/memory/manage.md:33-61] [SOURCE: .opencode/commands/speckit/assets/speckit_resume_auto.yaml:113-210]

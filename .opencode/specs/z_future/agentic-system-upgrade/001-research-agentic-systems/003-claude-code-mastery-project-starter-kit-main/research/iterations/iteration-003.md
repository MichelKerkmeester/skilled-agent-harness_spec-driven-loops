...
- The local deep-research system already treats externalized state as first-class: it writes findings to files, keeps JSONL state, auto-generates dashboards, and explicitly says "never hold findings in memory." [SOURCE: .opencode/commands/deep/start-research-loop.md:136-143] [SOURCE: .opencode/commands/deep/start-research-loop.md:196-205] [SOURCE: .opencode/commands/deep/start-research-loop.md:263-270] [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:20-24] [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:79-89]
- The local compaction hook already merges transcript tail, active files, topics, attention signals, and memory/code-graph context into cached recovery payloads. [SOURCE: .opencode/skills/system-spec-kit/mcp_server/hooks/claude/compact-inject.ts:5-8] [SOURCE: .opencode/skills/system-spec-kit/mcp_server/hooks/claude/compact-inject.ts:205-225] [SOURCE: .opencode/skills/system-spec-kit/mcp_server/hooks/claude/compact-inject.ts:230-250]

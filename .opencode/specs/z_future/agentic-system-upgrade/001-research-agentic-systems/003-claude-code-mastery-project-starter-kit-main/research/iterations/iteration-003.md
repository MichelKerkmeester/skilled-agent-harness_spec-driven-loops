...
- The local deep-research system already treats externalized state as first-class: it writes findings to files, keeps JSONL state, auto-generates dashboards, and explicitly says "never hold findings in memory." [SOURCE: .opencode/commands/spec_kit/deep-research.md:136-143] [SOURCE: .opencode/commands/spec_kit/deep-research.md:196-205] [SOURCE: .opencode/commands/spec_kit/deep-research.md:263-270] [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:20-24] [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:79-89]

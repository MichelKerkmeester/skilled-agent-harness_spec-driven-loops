...
## Research question
What lessons from the starter kit's `scope:` command metadata and dynamic help behavior should be applied to `.opencode/commands/`?
...
- The local repo organizes commands by group and documents execution modes and ownership statically in `README.txt` files; it does not expose equivalent audience/distribution metadata in the command surface itself. [SOURCE: .opencode/commands/README.txt:38-49] [SOURCE: .opencode/commands/README.txt:58-60] [SOURCE: .opencode/commands/README.txt:164-169] [SOURCE: .opencode/commands/README.txt:216-233] [SOURCE: .opencode/commands/spec_kit/README.txt:41-46] [SOURCE: .opencode/commands/spec_kit/README.txt:54-63]
...
- **Target file or module:** `.opencode/commands/README.txt`

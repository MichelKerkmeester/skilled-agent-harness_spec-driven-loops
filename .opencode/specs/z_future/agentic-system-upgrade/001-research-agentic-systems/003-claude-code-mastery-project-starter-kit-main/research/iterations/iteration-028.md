...
- Constitutional files further spell out gate routing and enforcement semantics, including mandatory steps and violation recovery. [SOURCE: .opencode/skills/system-spec-kit/constitutional/gate-tool-routing.md:31-47] [SOURCE: .opencode/skills/system-spec-kit/constitutional/gate-enforcement.md:51-69] [SOURCE: .opencode/skills/system-spec-kit/constitutional/gate-enforcement.md:74-102]

...
- **Target file or module:** `.opencode/commands/README.txt`, `.opencode/commands/spec_kit/README.txt`, command wrapper metadata, follow-on phase `005`
...
I looked for evidence that the local repo already has an equivalent command manifest that docs and help are generated from. The reviewed command readmes did not reveal one. [SOURCE: .opencode/commands/README.txt:36-60]

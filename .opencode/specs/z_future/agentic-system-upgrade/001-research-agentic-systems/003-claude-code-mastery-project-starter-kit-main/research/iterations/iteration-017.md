...
- **Target file or module:** `.opencode/commands/README.txt`, `.opencode/commands/speckit/README.txt`, command wrapper metadata, follow-on phase `005`

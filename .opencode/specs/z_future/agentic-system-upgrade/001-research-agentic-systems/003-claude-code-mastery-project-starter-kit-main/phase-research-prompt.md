...
6. Compare the starter kit command surface against this repo's `.opencode/commands/README.txt`, `.opencode/commands/speckit/README.txt`, and relevant command entrypoints such as `.opencode/commands/prompt.md`. Focus on workflow ergonomics, discoverability, distribution model, and execution-mode design.

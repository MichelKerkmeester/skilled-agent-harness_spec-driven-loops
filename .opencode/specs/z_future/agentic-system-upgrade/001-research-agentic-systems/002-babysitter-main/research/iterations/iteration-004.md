...
- `spec_kit:deep-research` exposes `:auto` and `:confirm` modes, with confirm mode inserting approval gates and auto mode declaring `approvals: none`. [SOURCE: .opencode/commands/deep/start-research-loop.md:156-162] [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:9-15] [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_confirm.yaml:9-15]
- Confirm mode shows explicit approval gates after initialization, while auto mode has no corresponding audit structure for "this gate existed but was intentionally skipped." [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_confirm.yaml:204-227]
...
- **Target file or module:** `.opencode/commands/deep/assets/deep_start-research-loop_auto.yaml`, `.opencode/commands/deep/assets/deep_start-research-loop_confirm.yaml`, and the `research/deep-research-state.jsonl` event schema
...
I looked for an existing autonomous deep-research audit event that records skipped approvals and found mode declarations plus confirm-only approval gates, but no explicit auto-pass event. [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:9-15] [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_confirm.yaml:204-227]

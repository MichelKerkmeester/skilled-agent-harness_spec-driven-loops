...
- The current deep-research loop decides `STOP`, `STUCK_RECOVERY`, or `CONTINUE`, then derives only a textual `next_focus`. [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:250-293]
...
- **Target file or module:** `.opencode/commands/deep/assets/deep_start-research-loop_auto.yaml`, `.opencode/commands/deep/assets/deep_start-research-loop_confirm.yaml`, and `.opencode/agents/deep-research.md`

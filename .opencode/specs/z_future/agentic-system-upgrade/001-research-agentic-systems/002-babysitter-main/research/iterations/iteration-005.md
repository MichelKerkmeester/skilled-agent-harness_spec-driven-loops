...
- The current deep-research loop decides `STOP`, `STUCK_RECOVERY`, or `CONTINUE`, then derives only a textual `next_focus`. [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:250-293]
- The current deep-research agent state record has no dedicated field for resumable pending actions or blocked sub-work beyond freeform narrative. [SOURCE: .opencode/agents/deep-research.md:167-199]
...
- **Target file or module:** `.opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml`, `.opencode/commands/spec_kit/assets/spec_kit_deep-research_confirm.yaml`, and `.opencode/agents/deep-research.md`

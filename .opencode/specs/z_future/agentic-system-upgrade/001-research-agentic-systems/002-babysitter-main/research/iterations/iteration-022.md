...
- `/spec_kit:resume` already overlaps that terrain by auto-detecting sessions, choosing resume context, and loading just enough state to continue. [SOURCE: .opencode/commands/spec_kit/resume.md:29-45] [SOURCE: .opencode/commands/spec_kit/resume.md:85-141] [SOURCE: .opencode/commands/spec_kit/resume.md:200-202]
- The resume YAML pushes even harder toward automatic continuity: it prioritizes handover, `session_bootstrap()`, `memory_context()`, and sufficiency-based gap filling, with the explicit rule to stop loading once the next safe action is known. [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml:69-93] [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml:127-155] [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml:195-210]
...
- **Current system-spec-kit surface:** Operators can use `/memory:save`, `/memory:search`, `/memory:manage`, and `/memory:learn` in parallel with `/spec_kit:*`, while `/spec_kit:resume` separately implements continuity recovery. [SOURCE: .opencode/commands/memory/save.md:51-85] [SOURCE: .opencode/commands/memory/search.md:53-92] [SOURCE: .opencode/commands/spec_kit/resume.md:200-202]
...
- **Current system-spec-kit approach:** Expose memory as a separate public command family while also embedding continuity behavior into `/spec_kit:resume` and completion flows. [SOURCE: .opencode/commands/memory/save.md:51-76] [SOURCE: .opencode/commands/memory/search.md:53-92] [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml:69-93]
...
- **Target file or module:** `.opencode/commands/memory/save.md`, `.opencode/commands/memory/search.md`, `.opencode/commands/spec_kit/resume.md`, `.opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml`
...
I looked for evidence that routine manual memory operations are central to the happy path, but the strongest current Spec Kit UX already points the other way: "load just enough state" and "stop once the next safe action is known." [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml:73-93]

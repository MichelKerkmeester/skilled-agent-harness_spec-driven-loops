...
- Top combined adoption opportunities for `system-spec-kit`:
  ...
  - Preserve the deeper substrate where it solves real problems: keep LEAF deep-loop architecture and keep advanced memory search/governance separate even as the common save/resume path becomes more implicit. [SOURCE: .opencode/agents/deep-research.md:24-32] [SOURCE: .opencode/agents/deep-research.md:167-212] [SOURCE: .opencode/commands/memory/README.txt:248-320]

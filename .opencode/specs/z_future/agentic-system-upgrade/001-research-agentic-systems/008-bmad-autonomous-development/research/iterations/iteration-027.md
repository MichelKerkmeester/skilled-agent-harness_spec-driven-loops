...
- The local skill system documents a formal loading sequence from request, to `skill_advisor.py`, to `SKILL.md`, to referenced resources, across 20 skill folders. [SOURCE: .opencode/skills/README.md:42-46] [SOURCE: .opencode/skills/README.md:80-109]
- Some local skills are narrow expert tools rather than default workflow surfaces, such as `sk-improve-prompt` and `sk-improve-agent`. [SOURCE: .opencode/skills/sk-improve-prompt/SKILL.md:23-46] [SOURCE: .opencode/skills/sk-improve-agent/SKILL.md:28-55]

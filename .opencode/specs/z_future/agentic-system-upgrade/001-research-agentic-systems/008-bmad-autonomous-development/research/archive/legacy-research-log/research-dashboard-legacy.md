...
| 2 | 018 | Command surface sprawl | high | should-have | `.opencode/commands/spec_kit/README.txt` |
| 2 | 019 | Deep-loop abstraction overhead | high | must-have | `.opencode/skills/sk-deep-research/references/state_format.md` |
| 2 | 020 | Core versus extension boundary | high | should-have | `.opencode/commands/spec_kit/README.txt` |
| 3 | 021 | Command UX surface area | high | should-have | `.opencode/commands/spec_kit/README.txt` |
| 3 | 022 | Lifecycle split versus integrated flow | high | must-have | `.opencode/commands/spec_kit/README.txt` |
...
| 3 | 029 | End-to-end workflow friction | high | should-have | `.opencode/commands/spec_kit/README.txt` |

...
scope: bounded style-verifier sweep over the exact HEAD~10 TypeScript diff under `.opencode/skills/system-spec-kit/` with hard stop on failing required verification gates
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/context-server.ts | sed -n '720,840p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/context/opencode-transport.ts | sed -n '90,230p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc 'rg -n "buildServerInstructions|startup snapshot|session_bootstrap|memory_health|compaction|transport|memory discipline|ready|degraded|blocked|resume" .opencode/skills/system-spec-kit/mcp_server/context-server.ts .opencode/skills/system-spec-kit/mcp_server/handlers/session-bootstrap.ts .opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts .opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts .opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-types.ts .opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts .opencode/skills/system-spec-kit/mcp_server/lib/context/opencode-transport.ts .opencode/plugins/spec-kit-compact-code-graph.js .opencode/skills/mcp-coco-index/README.md' in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:12:import { getGraphFreshness, type GraphFreshness } from '../lib/code-graph/ensure-ready.js';
.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:29:} from '../lib/context/opencode-transport.js';
.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:112:  sessionQuality?: 'healthy' | 'degraded' | 'critical' | 'unknown';
...
.opencode/skills/system-spec-kit/mcp_server/lib/context/opencode-transport.ts:4:// Phase 030 / Phase 2: transport-only mapping from shared payload
...
.opencode/skills/system-spec-kit/mcp_server/lib/context/opencode-transport.ts:9:/** Hook names emitted by the OpenCode transport adapter. */
.opencode/skills/system-spec-kit/mcp_server/lib/context/opencode-transport.ts:16:/** One transport block delivered to an OpenCode runtime hook surface. */
...
.opencode/skills/system-spec-kit/mcp_server/lib/context/opencode-transport.ts:52:/** Narrow an unknown runtime payload to the shared transport envelope contract. */
...
.opencode/skills/system-spec-kit/mcp_server/lib/context/opencode-transport.ts:124:            'Inject this as the startup digest for hookless OpenCode recovery. Keep it transport-only.',
...
.opencode/skills/system-spec-kit/mcp_server/handlers/session-bootstrap.ts:52:    readiness: 'ready';
...
.opencode/skills/system-spec-kit/mcp_server/handlers/session-bootstrap.ts:152:    readiness: 'ready',
...
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:253:  readiness: 'ready';
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:257:  preservesAuthority: 'session_bootstrap';
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:319:    readiness: 'ready',
...
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:741:async function buildServerInstructions(): Promise<string> {
...
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:942:    // Ensure database is initialized (safe no-op if already done)
...
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1876:      const dynamicInstructions = await buildServerInstructions();
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts:446:    hints.push('Embedding model not ready - some operations may fail');
...
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:82:        description: 'Enable session deduplication (REQ-001). When true and sessionId provided, filters out already-sent memories.'
...
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:460:  description: '[L5:Lifecycle] Enable the shared-memory subsystem. First-run setup: persists enablement, creates infrastructure tables, and generates a README. Idempotent — subsequent calls return alreadyEnabled: true.',
...
.opencode/skills/mcp-coco-index/README.md:99:bash .opencode/skills/mcp-coco-index/scripts/ensure_ready.sh --strict --require-config
...
.opencode/skills/mcp-coco-index/README.md:226:    ensure_ready.sh                Idempotent bootstrap (install + init + index if needed)
.opencode/skills/mcp-coco-index/README.md:491:**Q: What is the difference between `doctor.sh` and `ensure_ready.sh`?**
...
.opencode/skills/mcp-coco-index/README.md:515:| [scripts/ensure_ready.sh](scripts/ensure_ready.sh) | Idempotent bootstrap |

exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/session-bootstrap.ts | sed -n '95,360p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts | sed -n '400,620p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts | sed -n '350,470p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
   350	    }
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/context/opencode-transport.ts | sed -n '1,110p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/mcp-coco-index/README.md | sed -n '36,150p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
    36	
    37	<!-- ANCHOR:overview -->
    38	## 1. OVERVIEW
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-types.ts | sed -n '1,120p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ────────────────────────────────────────────────────────────────

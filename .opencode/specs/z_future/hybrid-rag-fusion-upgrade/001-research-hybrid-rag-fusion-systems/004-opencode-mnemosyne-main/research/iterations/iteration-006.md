...
- **Source**: [bm25-index.ts:45](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/search/bm25-index.ts#L45), [sqlite-fts.ts:147](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts#L147), [hybrid-search.ts:445](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts#L445), [hybrid-search.ts:2101](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts#L2101), [vector-index-queries.ts:259](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts#L259)
...
- [bm25-index.ts](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/search/bm25-index.ts)
- [query-router.ts](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts)
...
exec
/bin/zsh -lc "rg -n \"experimental\\.session\\.compacting|compact|memory_recall|memory_store|memory_delete|context\\.push|memory awareness|Persistent Memory\" .opencode/plugins/spec-kit-compact-code-graph.js .opencode/skills/system-spec-kit/mcp_server/context-server.ts .opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts .opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts | sed -n '1,260p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:439:  const compactStructuredResult = (
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:593:        const compacted = compactStructuredResult(innerEnvelope, currentResults, contentArr);
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:594:        if (compacted) {
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:596:            result: compacted.result,
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:599:              actualTokens: compacted.actualTokens,
...
exec
/bin/zsh -lc "rg -n \"dedup|upsert|revision|soft delete|archive|deleteAfter|retention|triggerPhrases|content_hash|supersedes|contradicts|memory_delete|memory_update|memory_save|duplicate|hash|title\" .opencode/skills/system-spec-kit/mcp_server .opencode/skills/system-spec-kit/scripts/dist/memory | sed -n '1,260p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.d.ts:3:type RemovalReason = 'empty_or_invalid' | 'sanitizer' | 'canonical_duplicate' | 'title_overlap';
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.d.ts:13:    duplicateOf?: string;
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.d.ts:18:    title: string;
...
.opencode/skills/system-spec-kit/mcp_server/ENV_REFERENCE.md:2:title: SPECKIT Environment Variable Reference
.opencode/skills/system-spec-kit/mcp_server/ENV_REFERENCE.md:225:| `SPECKIT_RECONSOLIDATION` | `true` | boolean | Reconsolidation-on-save for memory deduplication (TM-06). Graduated ON. | `lib/search/search-flags.ts` |
.opencode/skills/system-spec-kit/mcp_server/ENV_REFERENCE.md:226:| `SPECKIT_ASSISTIVE_RECONSOLIDATION` | `true` | boolean | Assistive reconsolidation for near-duplicate detection (REQ-D4-005). Graduated ON. | `lib/search/search-flags.ts` |
.opencode/skills/system-spec-kit/mcp_server/ENV_REFERENCE.md:285:| `SPECKIT_SESSION_RETRIEVAL_STATE_V1` | `true` | boolean | Cross-turn retrieval session state for dedup and goal-aware refinement (REQ-D5-006). Graduated ON. | `lib/search/search-flags.ts` |
.opencode/skills/system-spec-kit/scripts/dist/memory/ast-parser.d.ts:5:    title: string | null;
...
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:85:  --include-archive    Include z_archive trees (default: excluded)
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:92:  node backfill-frontmatter.js --dry-run --include-archive
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:122:        if (arg === '--include-archive') {
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:234:    const deduped = new Map();
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:238:            if (!deduped.has(realPath)) {
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:239:                deduped.set(realPath, root);
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:243:            if (error instanceof Error && !deduped.has(root)) {
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:244:                deduped.set(root, root);
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:247:            if (!deduped.has(root)) {
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:248:                deduped.set(root, root);
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:252:    return Array.from(deduped.values()).sort();
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:309:                if (!includeArchive && normalized.includes('/z_archive/')) {
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:425:    const deduped = Array.from(new Set(allTargets.map((entry) => path.resolve(entry)))).sort();
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:429:    for (const filePath of deduped) {
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:458:                    title: result.managed.title,
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-types.ts:25:  title?: string;
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-types.ts:26:  triggerPhrases?: string[];
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-types.ts:67:/** Snapshot of a memory's hash state for mutation tracking. */
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-types.ts:70:  content_hash: string | null;
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-bulk-delete.ts:184:  let selectSql = 'SELECT id, content_hash, file_path, spec_folder FROM memory_index WHERE importance_tier = ?';
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-bulk-delete.ts:199:    content_hash: string | null;
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts:54:  title: string | null;
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts:70:  title: string | null;
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts:449:        title: r.title,
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts:450:        triggerPhrases: r.matchedPhrases
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts:457:        title: r.title,
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts:483:      title: r.title,
.opencode/skills/system-spec-kit/scripts/dist/memory/rank-memories.js:98:        title: m.title ?? 'Untitled',
.opencode/skills/system-spec-kit/scripts/dist/memory/rank-memories.js:119:        title: m.title,
.opencode/skills/system-spec-kit/scripts/dist/memory/rank-memories.js:167:        title: m.title,
...
.opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js:479:                    const allSpecs = available.filter((n) => core_1.SPEC_FOLDER_PATTERN.test(n) && !n.match(/^z_|archive/i))
...
.opencode/skills/system-spec-kit/scripts/dist/memory/ast-parser.js:34:            title: block.type === 'heading' ? extractHeadingTitle(block.content) : null,
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:104:function canonicalizeTitleKey(title) {
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:105:    return canonicalizePhraseKey(title).replace(/\b\d+\b/g, ' ').replace(/\s+/g, ' ').trim();
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:117:        && !normalized.includes('/memory/.archive');
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:124:        && !normalized.includes('/.archive');
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:217:                if (entry.name === '.git' || entry.name === 'node_modules' || entry.name === 'dist' || entry.name.startsWith('.archive')) {
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:306:    const titleSection = detection.sections.find((section) => section.key === 'title');
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:308:    const titleValue = titleSection ? (0, frontmatter_migration_1.parseSectionValue)(titleSection) : undefined;
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:310:    const title = typeof titleValue === 'string' ? titleValue : '';
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:311:    const triggerPhrases = Array.isArray(triggerValue)
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:315:        title,
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:316:        triggerPhrases,
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:320:function resolveTriggerPhrases(triggerPhrases, title) {
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:321:    const titleKey = canonicalizeTitleKey(title);
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:326:    for (const originalPhrase of triggerPhrases) {
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:349:                reason: 'canonical_duplicate',
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:350:                duplicateOf: seenCanonicalKeys.get(canonicalKey) || undefined,
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:354:        const titleOverlap = titleKey.length > 0
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:356:            && new RegExp(`(?:^| )${escapeRegex(canonicalKey)}(?:$| )`, 'i').test(titleKey);
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:357:        if (titleOverlap) {
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:360:                reason: 'title_overlap',
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:377:function hashTriggerPhrases(triggerPhrases) {
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:378:    return crypto.createHash('sha1').update(JSON.stringify(triggerPhrases)).digest('hex');
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:398:        canonical_duplicate: 0,
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:399:        title_overlap: 0,
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:405:            const resolution = resolveTriggerPhrases(parsed.triggerPhrases, parsed.title);
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:407:            const changed = rewrittenContent !== null && JSON.stringify(parsed.triggerPhrases) !== JSON.stringify(resolution.kept);
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:419:                title: parsed.title,
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:421:                originalCount: parsed.triggerPhrases.length,
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:426:                beforeTriggerPhrases: parsed.triggerPhrases,
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:429:                    beforeHash: hashTriggerPhrases(parsed.triggerPhrases),
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:430:                    afterHash: hashTriggerPhrases(resolution.kept),
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-list.ts:131:    const sql = `SELECT id, spec_folder, file_path, title, trigger_phrases, importance_weight, created_at, updated_at FROM memory_index ${whereClause} ORDER BY ${sortColumn} DESC LIMIT ? OFFSET ?`;
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-list.ts:149:    title: (row.title as string) || '(untitled)',
...
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:34:  title: string | null;
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:35:  triggerPhrases: string[];
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:51:  title: string | null;
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:52:  triggerPhrases?: string[];
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:60:  content_hash?: string;
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:94:  'content_hash', 'context_type', 'importance_tier', 'memory_type',
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:163:             title: parsed.title ?? '', message: 'Zero chunks retained after thinning' };
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:225:        title: parsed.title,
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:226:        triggerPhrases: parsed.triggerPhrases,
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:241:        content_hash: parsed.contentHash,
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:272:    const chunkTitle = `${parsed.title || 'Untitled'} [chunk ${i + 1}/${retainedChunks.length}]`;
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:280:      // Provider on re-index — content-hash keyed so unchanged chunks skip API entirely.
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:312:            title: chunkTitle,
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:313:            triggerPhrases: [],
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:326:            title: chunkTitle,
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:327:            triggerPhrases: [],
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:342:          content_hash: parsed.contentHash,
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:363:            title: chunkTitle,
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:472:      title: parsed.title,
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:473:      triggerPhrases: parsed.triggerPhrases,
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:505:        SET content_hash = ?,
...
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:583:        title: parsed.title,
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:584:        triggerPhrases: parsed.triggerPhrases,
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:599:        title: parsed.title,
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:601:        trigger_phrases: parsed.triggerPhrases,
...
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:640:    title: parsed.title,
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:641:    triggerPhrases: parsed.triggerPhrases,
...
.opencode/skills/system-spec-kit/mcp_server/handlers/save/validation-responses.ts:41:    title: parsed.title ?? '',
.opencode/skills/system-spec-kit/mcp_server/handlers/save/validation-responses.ts:42:    triggerPhrases: parsed.triggerPhrases,
.opencode/skills/system-spec-kit/mcp_server/handlers/save/validation-responses.ts:65:    title: parsed.title ?? '',
.opencode/skills/system-spec-kit/mcp_server/handlers/save/validation-responses.ts:66:    triggerPhrases: parsed.triggerPhrases,
...
.opencode/skills/system-spec-kit/mcp_server/handlers/save/markdown-evidence-builder.ts:97:  const observations: Array<{ title?: string; narrative?: string }> = [];
.opencode/skills/system-spec-kit/mcp_server/handlers/save/markdown-evidence-builder.ts:120:        title: section.heading,
.opencode/skills/system-spec-kit/mcp_server/handlers/save/markdown-evidence-builder.ts:153:        title: section.heading,
.opencode/skills/system-spec-kit/mcp_server/handlers/save/markdown-evidence-builder.ts:168:    title: parsed.title,
.opencode/skills/system-spec-kit/mcp_server/handlers/save/markdown-evidence-builder.ts:170:    triggerPhrases: parsed.triggerPhrases,
.opencode/skills/system-spec-kit/mcp_server/README.md:2:title: "Spec Kit Memory - MCP Server"
...
.opencode/skills/system-spec-kit/mcp_server/README.md:74:| **Sessions** | Stateless | Working memory with attention decay, ~50% token savings via deduplication |
...
.opencode/skills/system-spec-kit/mcp_server/README.md:360:| **supersedes** | -- | B replaces A |
...
.opencode/skills/system-spec-kit/mcp_server/README.md:416:**SHA-256 content-hash deduplication** -- recognizes unchanged files instantly and skips expensive reprocessing.
.opencode/skills/system-spec-kit/mcp_server/README.md:426:**Session deduplication** -- pushes down results you already saw. If you got a result 3 turns ago, new searches rank it lower. Saves approximately 50% of tokens on follow-up queries.
.opencode/skills/system-spec-kit/mcp_server/README.md:499:**Incremental indexing with content hashing** -- tracks SHA-256 hashes of every indexed file. Unchanged files get skipped instantly during scans.
.opencode/skills/system-spec-kit/mcp_server/README.md:507:**Phase 13 chunked-save finalization hardening** -- chunked saves now track the created parent and child IDs so finalization can stay transactional. Prediction-error supersede finalization records cross-path `supersedes` edges and marks predecessors superseded inside one transaction. Safe-swap updates now null old-child `parent_id` values before bulk delete inside that same finalization step, and any finalize failure triggers compensating cleanup that removes the staged replacement chunk tree. Parent BM25 mutation is delayed until at least one chunk succeeds and, for safe-swap updates, until finalization completes, which preserves the old parent BM25 state when all chunks fail.
.opencode/skills/system-spec-kit/mcp_server/README.md:578:| `sessionId` | string | Session ID for deduplication across turns |
.opencode/skills/system-spec-kit/mcp_server/README.md:624:The main search tool. You type what you are looking for in plain language and the system searches through all stored knowledge to find the best matches. It understands meaning (beyond keywords), so searching for "login problems" can find a document titled "authentication troubleshooting."
...
.opencode/skills/system-spec-kit/mcp_server/README.md:803:Change a memory's title, keywords or importance without deleting and re-creating it. When you change the title, the search index updates automatically. If the update fails partway through, everything rolls back to the way it was before.
.opencode/skills/system-spec-kit/mcp_server/README.md:808:| `title` | string | Updated title |
...
.opencode/skills/system-spec-kit/mcp_server/README.md:1100:| `force` | boolean | Re-index even if file hash unchanged |
...
.opencode/skills/system-spec-kit/mcp_server/README.md:1247:| `handlers/memory-save.ts` | Runs the save pipeline: validates structure, checks dedup/quality gates, generates embeddings, and stores the result. |
...
.opencode/skills/system-spec-kit/mcp_server/README.md:1576:**Common causes**: Too little real content, missing required structure (headings, metadata) or semantic duplicate.
...
.opencode/skills/system-spec-kit/mcp_server/README.md:1723:A dry run validates the file against the quality gate, estimates the token budget, checks for duplicates and returns a report, all without writing anything to the database. Use it to verify a file will pass before committing.
.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:26:// Feature catalog: Memory indexing (memory_save)
.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:101:): { id: number; title: string | null; content_hash?: string | null } | undefined {
.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:109:    SELECT id, title, content_hash
.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:135:  ) as { id: number; title: string | null; content_hash?: string | null } | undefined;
.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:184:          title: parsed.title,
.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:185:          triggerPhrases: parsed.triggerPhrases,
.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:199:          title: parsed.title,
.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:200:          triggerPhrases: parsed.triggerPhrases,
.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:216:      content_hash: parsed.contentHash,
.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:254:      actor: 'mcp:memory_save',
.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:269:          title: parsed.title,
.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:271:          trigger_phrases: parsed.triggerPhrases,
...
.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:289:          samePathExisting?.title ?? null,
.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:290:          parsed.title ?? filePath,
.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:291:          'mcp:memory_save',
.opencode/skills/system-spec-kit/scripts/dist/memory/rank-memories.d.ts:6:    title?: string;
.opencode/skills/system-spec-kit/scripts/dist/memory/rank-memories.d.ts:18:    title: string;
.opencode/skills/system-spec-kit/scripts/dist/memory/rank-memories.d.ts:32:    title: string;
.opencode/skills/system-spec-kit/scripts/dist/memory/rank-memories.d.ts:50:    title: string;
.opencode/skills/system-spec-kit/scripts/dist/memory/rank-memories.d.ts:67:        archivedFolders: number;
.opencode/skills/system-spec-kit/mcp_server/handlers/session-health.ts:141:        title: 'Session Health',
.opencode/skills/system-spec-kit/mcp_server/handlers/session-health.ts:147:        title: 'Quality Score',
.opencode/skills/system-spec-kit/mcp_server/handlers/session-health.ts:153:        title: 'Structural Context',
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:833:              SELECT id, title, similarity, content, file_path, importance_tier, context_type,
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud.ts | sed -n '1,260p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ────────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "rg -n \"recordHistory|supersedes|contradicts|retentionPolicy|deleteAfter|archived_at|includeArchived|content_hash|checkContentHashDedup|checkExistingRow|safe-swap|finalization|bulk delete|memory_update|memory_delete|soft delete|archive|restore\" .opencode/skills/system-spec-kit/mcp_server/handlers .opencode/skills/system-spec-kit/mcp_server/lib .opencode/skills/system-spec-kit/mcp_server/db .opencode/skills/system-spec-kit/scripts/dist/memory | sed -n '1,320p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
rg: .opencode/skills/system-spec-kit/mcp_server/db: No such file or directory (os error 2)
.opencode/skills/system-spec-kit/mcp_server/lib/session/session-manager.ts:36:  content_hash?: string;
.opencode/skills/system-spec-kit/mcp_server/lib/session/session-manager.ts:485:  if (memory.content_hash) {
.opencode/skills/system-spec-kit/mcp_server/lib/session/session-manager.ts:486:    hashInput = memory.content_hash;
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-types.ts:9:/** Arguments for the memory_delete handler. */
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-types.ts:12:// Feature catalog: Memory metadata update (memory_update)
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-types.ts:13:// Feature catalog: Single and folder delete (memory_delete)
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-types.ts:22:/** Arguments for the memory_update handler. */
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-types.ts:46:  includeArchived?: boolean;
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-types.ts:70:  content_hash: string | null;
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-types.ts:76:type CrudMutationType = 'create' | 'update' | 'delete' | 'merge' | 'archive' | 'restore' | 'reindex';
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:85:  --include-archive    Include z_archive trees (default: excluded)
.opencode/skills/system-spec-kit/scripts/dist/memory/backfill-frontmatter.js:92:  node backfill-frontmatter.js --dry-run --include-archive
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-bulk-delete.ts:45:  if (restoreBarrier) {
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-bulk-delete.ts:48:      error: restoreBarrier.message,
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-bulk-delete.ts:49:      code: restoreBarrier.code,
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-bulk-delete.ts:283:    hints.push('Checkpoint skipped: restore is not available for this operation');
...
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-historical-json-mode-memories.js:179:    if (normalized.includes('/research/archive/')) {
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-historical-json-mode-memories.js:182:    if (normalized.includes('/memory/.archive')) {
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-historical-json-mode-memories.js:333:    const supersedesIndex = lines.findIndex((line) => line.trim() === 'supersedes:');
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-historical-json-mode-memories.js:334:    if (supersedesIndex === -1) {
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-historical-json-mode-memories.js:338:    for (let index = supersedesIndex + 1; index < lines.length; index += 1) {
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-historical-json-mode-memories.js:390:        supersedes: extractSupersedesEntries(content),
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-historical-json-mode-memories.js:499:    if (details.continuationPattern && parsed.supersedes.length === 0) {
.opencode/skills/system-spec-kit/scripts/dist/memory/rank-memories.js:181:    const archivedCount = allFolders.filter((f) => f.isArchived).length;
.opencode/skills/system-spec-kit/scripts/dist/memory/rank-memories.js:190:            activeFolders: folderMap.size - archivedCount,
.opencode/skills/system-spec-kit/scripts/dist/memory/rank-memories.js:191:            archivedFolders: archivedCount,
.opencode/skills/system-spec-kit/scripts/dist/memory/rank-memories.js:227:        if (arg === '--show-archived') {
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud.ts:42:  handle_memory_update,
.opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js:479:                    const allSpecs = available.filter((n) => core_1.SPEC_FOLDER_PATTERN.test(n) && !n.match(/^z_|archive/i))
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:83:  includeArchived?: boolean;
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:447: * @param options - Optional limit, specFolder filter, and includeArchived flag.
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:452:  options: { limit?: number; specFolder?: string; includeArchived?: boolean } = {}
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:459:  const { limit = DEFAULT_LIMIT, specFolder, includeArchived = false } = options;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:486: * @param options - Optional limit, specFolder filter, and includeArchived flag.
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:491:  options: { limit?: number; specFolder?: string; includeArchived?: boolean } = {}
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:866:    includeArchived = false,
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:879:        includeArchived,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1069:          includeArchived: options.includeArchived || false,
...
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:124:        && !normalized.includes('/.archive');
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:217:                if (entry.name === '.git' || entry.name === 'node_modules' || entry.name === 'dist' || entry.name.startsWith('.archive')) {
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/mpab-aggregation.ts:141: * 4. Within each group, sort chunks by chunkIndex (ascending) to restore
...
.opencode/skills/system-spec-kit/mcp_server/lib/architecture/layer-definitions.ts:85:    useCase: 'Create checkpoints before major changes, restore previous states.',
...
.opencode/skills/system-spec-kit/mcp_server/handlers/save/index.ts:30:export { checkExistingRow, checkContentHashDedup } from './dedup.js';
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:67:  content_hash: string | null;
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:98:  content_hash?: string;
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:420:    content_hash: provided_hash,
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:443:    content_hash: null,
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:510:  const content_hash = provided_hash || computeContentHash(content);
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:511:  result.content_hash = content_hash;
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:516:      const whereClauses = ['content_hash = ?'];
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:517:      const paramsArray: unknown[] = [content_hash];
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:60:    'idx_save_parent_content_hash_scope',
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:121:  CREATE INDEX IF NOT EXISTS idx_save_parent_content_hash_scope
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:124:    content_hash,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:177:  return /PRIMARY\s+KEY\s*\(\s*content_hash\s*,\s*model_id\s*,\s*dimensions\s*\)/i.test(tableSql);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:197:      content_hash,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:205:      content_hash,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:1741:  if (!column_names.includes('content_hash')) {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:1749:      logDuplicateColumnMigrationSkip('content_hash', error);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2033:      'idx_save_parent_content_hash_scope',
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2037:    logger.info('Created idx_content_hash index');
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2041:      index: 'idx_content_hash/idx_save_parent_content_hash_scope',
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2329:      content_hash TEXT,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2456:      content_hash,
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/memory-state-baseline.ts:184:  // restored even when initEvalDb() fails after closing the prior singleton.
.opencode/skills/system-spec-kit/mcp_server/lib/eval/memory-state-baseline.ts:222:      try { initEvalDb(path.dirname(previousEvalDbPath)); } catch (_: unknown) { /* best-effort restore */ }
.opencode/skills/system-spec-kit/scripts/dist/memory/rank-memories.d.ts:67:        archivedFolders: number;
...
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/README.md:239:const ranked = computeFolderScores(memories, { includeArchived: false });
...
.opencode/skills/system-spec-kit/mcp_server/handlers/save/types.ts:144:  content_hash?: string;
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:63:  content_hash?: string | null;
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:141:  includeArchived?: boolean;
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:1090:      "expectedResultDescription": "Should surface memory_bulk_delete tool schema (tier parameter, confirm safety gate), the bulk delete handler, and any spec about tier-based cleanup strategies.",
...
.opencode/skills/system-spec-kit/mcp_server/lib/errors/README.md:93:| E060-E069 | Checkpoint | Not found, restore/create failed |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:595:        recordHistory(row.id, 'DELETE', file_path ?? null, null, 'mcp:delete_by_path', row.spec_folder ?? spec_folder);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:661:            recordHistory(id, 'DELETE', null, null, 'mcp:delete_memories', specFolderById.get(id) ?? null);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:706:        // BM25 cleanup is best-effort for bulk deletes as well.
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:433:    hint: 'Failed to restore from checkpoint.',
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:519:      'For bulk delete, ensure confirm=true is set',
...
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:717:  // Checkpoint_restore specific hints
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:718:  checkpoint_restore: {
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:720:      hint: 'Cannot restore: checkpoint does not exist.',
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:730:      hint: 'Checkpoint restore failed. Database state unchanged.',
...
.opencode/skills/system-spec-kit/mcp_server/handlers/save/reconsolidation-bridge.ts:260:                  content_hash: parsed.contentHash,
...
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts:256:  const content_hash = computeContentHash(content);
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts:279:    contentHash: content_hash,
...
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:30:// Feature catalog: Checkpoint restore (checkpoint_restore)
...
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:365:      `Restore with: checkpoint_restore({ name: "${name}" })`,
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:421:/** Handle checkpoint_restore tool - restores memory state from a named checkpoint */
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:424:  const restoreBarrier = checkpoints.getRestoreBarrierStatus();
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:425:  if (restoreBarrier) {
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:427:      tool: 'checkpoint_restore',
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:428:      error: restoreBarrier.message,
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:429:      code: restoreBarrier.code,
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:434:        hint: 'Retry checkpoint_restore after the active restore maintenance window completes.',
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:435:        actions: ['Wait for the current restore to finish', 'Retry the restore request'],
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:446:    return createCheckpointScopeValidationError('checkpoint_restore');
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:457:        tool: 'checkpoint_restore',
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:473:  const result = checkpoints.restoreCheckpoint(name, clear_existing, scope);
...
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:479:  // T102 FIX: Rebuild search indexes after checkpoint restore
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:480:  // Without this, restored memories are invisible to search until server restart.
...
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:495:      console.error('[T102] Index rebuild after checkpoint restore failed:', toErrorMessage(rebuildErr));
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:501:      tool: 'checkpoint_restore',
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:502:      error: `Checkpoint "${name}" restore failed`,
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:507:        restored: result.restored,
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:513:        actions: ['Inspect checkpoint integrity', 'Create a fresh checkpoint before retrying restore'],
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:521:      tool: 'checkpoint_restore',
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:522:      error: `Checkpoint "${name}" restore completed with partial failure`,
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:527:        restored: result.restored,
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:534:        hint: 'Review the reported table failures before retrying restore.',
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:536:          'Inspect restored.errors and restored.rolledBackTables for the failed merge-replace tables',
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:546:      tool: 'checkpoint_restore',
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:548:        ? `Checkpoint "${name}" restored with warnings (${result.errors.length})`
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:549:        : `Checkpoint "${name}" restored partially`,
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:554:        restored: result,
...
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:565:    tool: 'checkpoint_restore',
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:566:    summary: `Checkpoint "${name}" restored successfully`,
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:569:      restored: result
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:572:      ? ['Previous data was cleared before restore', 'Search indexes rebuilt']
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:813:const handle_checkpoint_restore = handleCheckpointRestore;
.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:820:  handle_checkpoint_restore,
.opencode/skills/system-spec-kit/mcp_server/handlers/eval-reporting.ts:159:      includeArchived: false,
...
.opencode/skills/system-spec-kit/mcp_server/lib/errors/core.ts:61:  checkpoint_restore: ERROR_CODES.CHECKPOINT_RESTORE_FAILED,
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-index.ts:150:  const restoreBarrier = checkpoints.getRestoreBarrierStatus();
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-index.ts:151:  if (restoreBarrier) {
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-index.ts:154:      error: restoreBarrier.message,
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-index.ts:155:      code: restoreBarrier.code,
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-index.ts:158:        actions: ['Wait for the restore to finish', 'Retry the index scan'],
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-index.ts:266:            recordHistory(
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:203:  includeArchived?: boolean; // REQ-206: include archived memories in search (default false)
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:520:    includeArchived: includeArchived = false, // REQ-206: exclude archived by default
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:733:    includeArchived,
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:787:      includeArchived,
...
.opencode/skills/system-spec-kit/mcp_server/handlers/save/dedup.ts:38:  content_hash: string;
...
.opencode/skills/system-spec-kit/mcp_server/handlers/save/dedup.ts:182:export function checkExistingRow(
.opencode/skills/system-spec-kit/mcp_server/handlers/save/dedup.ts:229:  if (existing && existing.content_hash === parsed.contentHash && isUnchangedEligible && isMetadataEquivalent) {
.opencode/skills/system-spec-kit/mcp_server/handlers/save/dedup.ts:245:export function checkContentHashDedup(
.opencode/skills/system-spec-kit/mcp_server/handlers/save/dedup.ts:257:      'content_hash = ?',
.opencode/skills/system-spec-kit/mcp_server/handlers/quality-loop.ts:656:        // Return mutated content so caller can persist it and recompute content_hash
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-stats.ts:63:    includeArchived = false,
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-stats.ts:105:  if (includeArchived !== undefined && typeof includeArchived !== 'boolean') {
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-stats.ts:108:      error: 'includeArchived must be a boolean',
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-stats.ts:182:      if (!includeArchived) {
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-stats.ts:214:        includeArchived,
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-stats.ts:240:          .filter(([folder]) => includeArchived || !folderScoring.isArchived(folder))
...
.opencode/skills/system-spec-kit/mcp_server/lib/graph/contradiction-detection.ts:65: * 1. Same source+target with relation 'supersedes' → invalidate old edge
...
.opencode/skills/system-spec-kit/mcp_server/lib/graph/contradiction-detection.ts:99:      // Rule 1: 'supersedes' replaces any existing edge on the same pair
.opencode/skills/system-spec-kit/mcp_server/lib/graph/contradiction-detection.ts:100:      if (newRelation.toLowerCase() === 'supersedes' && oldRelation.toLowerCase() !== 'supersedes') {
...
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:60:  content_hash?: string;
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:94:  'content_hash', 'context_type', 'importance_tier', 'memory_type',
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:194:      // The safe-swap pattern is NOT applied here because force is an explicit
...
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:594:  // (for safe-swap) finalization completes.
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-update.ts:204:        priorHash: priorSnapshot?.content_hash ?? (existing.content_hash as string | null) ?? null,
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts:94:  content_hash: string | null;
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts:183:    bucket.variants.set(normalizedPath, row.content_hash ?? null);
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts:184:    if (typeof row.content_hash === 'string' && row.content_hash.trim().length > 0) {
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts:185:      bucket.hashes.add(row.content_hash.trim());
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts:318:        SELECT file_path, content_hash, spec_folder
...
.opencode/skills/system-spec-kit/mcp_server/handlers/index.ts:279:// Memory bulk delete handler
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:366:      } catch (restoreErr: unknown) {
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:368:          '[memory-save] Auto-fix file restore failed after finalize error:',
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:369:          restoreErr instanceof Error ? restoreErr.message : String(restoreErr),
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:544:function restoreAtomicSaveOriginalState(

exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts | sed -n '1,340p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/save/dedup.ts | sed -n '1,320p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ───────────────────────────────────────────────────────────────
     2	// MODULE: Dedup
     3	// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-update.ts | sed -n '1,340p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ────────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-delete.ts | sed -n '1,320p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ────────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/storage/history.ts | sed -n '1,260p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ───────────────────────────────────────────────────────────────
     2	// MODULE: History
     3	// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/storage/history.ts | sed -n '260,360p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts | sed -n '2328,2465p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-bulk-delete.ts | sed -n '1,320p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ────────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/utils/canonical-path.ts | sed -n '1,220p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js | sed -n '100,220p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-ingest.ts:64:  return filePath === '__job__' ? filePath : path.basename(filePath || '');
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.d.ts:3:type RemovalReason = 'empty_or_invalid' | 'sanitizer' | 'canonical_duplicate' | 'title_overlap';
...
.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:152:    console.error(`[memory-save] Using deferred indexing for ${path.basename(filePath)}`);
.opencode/skills/system-spec-kit/mcp_server/handlers/save/embedding-pipeline.ts:107:    title: parsed.title || path.basename(parsed.filePath, path.extname(parsed.filePath)),
.opencode/skills/system-spec-kit/mcp_server/handlers/save/embedding-pipeline.ts:137:      console.error(`[memory-save] Embedding cache HIT for ${path.basename(filePath)} (async mode)`);
.opencode/skills/system-spec-kit/mcp_server/handlers/save/embedding-pipeline.ts:140:      console.error(`[memory-save] T306: Async embedding mode - deferring embedding for ${path.basename(filePath)}`);
.opencode/skills/system-spec-kit/mcp_server/handlers/save/embedding-pipeline.ts:150:        console.error(`[memory-save] Embedding cache HIT for ${path.basename(filePath)}`);
.opencode/skills/system-spec-kit/mcp_server/handlers/save/embedding-pipeline.ts:159:          console.error(`[memory-save] Embedding cache MISS+GENERATE for ${path.basename(filePath)}`);
.opencode/skills/system-spec-kit/mcp_server/handlers/save/embedding-pipeline.ts:173:          console.warn(`[memory-save] Embedding failed for ${path.basename(filePath)}: ${embeddingFailureReason}`);
.opencode/skills/system-spec-kit/mcp_server/handlers/save/embedding-pipeline.ts:179:        `[memory-save] Embedding failed for ${path.basename(filePath)}`,
.opencode/skills/system-spec-kit/mcp_server/handlers/save/embedding-pipeline.ts:209:  console.error(`[memory-save] Embedding cache STORE after quality gate for ${path.basename(filePath)}`);
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:205:    console.warn(`[memory] Warning for ${path.basename(parsed.filePath)}:`);
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:224:      console.error(`[memory-save] V-rule hard block for ${path.basename(parsed.filePath)}: ${failedRuleIds.join(', ')}`);
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:252:      console.warn(`[memory-save] V-rule index block for ${path.basename(parsed.filePath)}: ${vRuleDisposition.indexBlockingRuleIds.join(', ')}`);
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:281:    console.warn(`[memory-save] ${warning} ${path.basename(parsed.filePath)}`);
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:312:        `[memory-save] spec-doc-health annotation skipped for ${path.basename(parsed.filePath)}: ${message}`
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:636:        console.warn(`[memory-save] V-rule warn-only (spec doc) for ${path.basename(filePath)}: ${qualityLoopResult.rejectionReason}`);
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:657:        console.warn(`[memory-save] Sufficiency warn-only (spec doc) for ${path.basename(filePath)}: ${sufficiencyResult.reasons.join('; ')}`);
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:666:          `[memory-save] Template contract bypassed in ${MANUAL_FALLBACK_SOURCE_CLASSIFICATION} mode for ${path.basename(filePath)}: ${templateContract.violations.map((v: { message?: string; rule?: string }) => v.message || v.rule).join('; ')}`,
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:670:          `[memory-save] Template contract warn-only (spec doc) for ${path.basename(filePath)}: ${templateContract.violations.map((v: { message?: string; rule?: string }) => v.message || v.rule).join('; ')}`,
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:765:          console.error(`[memory-save] TM-04: Quality gate REJECTED save for ${path.basename(filePath)}: ${qualityGateResult.reasons.join('; ')}`);
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:784:          console.warn(`[memory-save] TM-04: Quality gate warn-only (spec doc) for ${path.basename(filePath)}: ${qualityGateResult.reasons.join('; ')}`);
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:788:          console.warn(`[memory-save] TM-04: Quality gate WARN-ONLY for ${path.basename(filePath)}: ${qualityGateResult.reasons.join('; ')}`);
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts:44:/** Redact absolute paths: keep only project-relative portion or basename. */
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts:53:  // Fallback: basename only
.opencode/skills/system-spec-kit/mcp_server/handlers/save/reconsolidation-bridge.ts:316:          console.error(`[memory-save] TM-06: Reconsolidation ${reconResult.action} for ${path.basename(filePath)}`);
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-index-discovery.ts:26:/** Constitutional markdown basenames intentionally excluded from indexing. */
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:97:function canonicalizePhraseKey(value) {
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:105:    return canonicalizePhraseKey(title).replace(/\b\d+\b/g, ' ').replace(/\s+/g, ' ').trim();
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:341:        const canonicalKey = canonicalizePhraseKey(normalized);
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:349:                reason: 'canonical_duplicate',
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:360:                reason: 'title_overlap',
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:382:    const tempPath = path.join(dirPath, `.${path.basename(filePath)}.tmp-${process.pid}-${Date.now()}`);
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:398:        canonical_duplicate: 0,
.opencode/skills/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js:399:        title_overlap: 0,
.opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js:173:    const folderName = path.basename(folderPath);
.opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js:228:    const folderName = path.basename(rawArg);
.opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js:402:    const inputBaseName = path.basename(specFolderArg);
.opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js:421:            const matches = available.filter((n) => n.includes(path.basename(specFolderArg)) && core_1.SPEC_FOLDER_PATTERN.test(n));
.opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js:429:                const targetBase = path.basename(specFolderArg);
.opencode/skills/system-spec-kit/mcp_server/test/hooks/replay-harness.ts:7:import { basename, dirname, join, resolve } from 'node:path';
.opencode/skills/system-spec-kit/mcp_server/test/hooks/replay-harness.ts:74:  const transcriptPath = join(transcriptRoot, basename(fixturePath));
...
.opencode/skills/system-spec-kit/mcp_server/README.md:809:| `triggerPhrases` | string[] | Updated trigger phrases |
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-index.ts:416:          file: path.basename(filePath),
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-index.ts:465:            file: path.basename(filePath),
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-index.ts:476:          file: path.basename(filePath),
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-index.ts:511:      // We use parsed document type (not basename) to avoid false positives
...
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-index.vitest.ts:124:        expect(path.basename(result[0])).toBe('spec.md');
...
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:421:    const basename = BASENAME_BY_DOCUMENT_TYPE[config.documentType];
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:423:      basename &&
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:425:      && matchesSpecDocumentPath(filePath, basename)
...
.opencode/skills/system-spec-kit/mcp_server/tests/job-queue-state-edge.vitest.ts:311:    expect(updated?.errors[0]?.filePath).toBe(path.basename(missingPath));
...
.opencode/skills/system-spec-kit/mcp_server/lib/config/spec-doc-paths.ts:82:  basename: string,
.opencode/skills/system-spec-kit/mcp_server/lib/config/spec-doc-paths.ts:89:  const normalizedBasename = basename.toLowerCase();
.opencode/skills/system-spec-kit/mcp_server/lib/config/spec-doc-paths.ts:126:  const basename = segments[segments.length - 1] || '';
.opencode/skills/system-spec-kit/mcp_server/lib/config/spec-doc-paths.ts:127:  if (!matchesSpecDocumentPath(normalizedPath, basename)) {
.opencode/skills/system-spec-kit/mcp_server/lib/config/spec-doc-paths.ts:132:  if (basename === 'research.md' && parent === 'research') {
.opencode/skills/system-spec-kit/mcp_server/lib/ops/job-queue.ts:116:  return filePath === '__job__' ? filePath : path.basename(filePath || '');
.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:384:  - `canonical-path.ts` — canonical path keying used for deduplication and identity.
.opencode/skills/system-spec-kit/mcp_server/lib/ops/file-watcher.ts:153:  const basename = path.basename(targetPath);
.opencode/skills/system-spec-kit/mcp_server/lib/ops/file-watcher.ts:154:  return basename.startsWith('.');
.opencode/skills/system-spec-kit/mcp_server/lib/ops/file-watcher.ts:291:        console.warn(`[file-watcher] Watch task failed for ${path.basename(filePath)}: ${message}`);
.opencode/skills/system-spec-kit/mcp_server/lib/ops/file-watcher.ts:351:          console.warn(`[file-watcher] Skipping reindex outside watch roots: ${path.basename(filePath)}`);
.opencode/skills/system-spec-kit/mcp_server/lib/ops/file-watcher.ts:389:          console.error(`[file-watcher] Reindexed ${path.basename(resolvedPath)} in ${reindexElapsed}ms (total: ${filesReindexed} files, avg: ${Math.round(totalReindexTimeMs / filesReindexed)}ms)`);
.opencode/skills/system-spec-kit/mcp_server/lib/ops/file-watcher.ts:429:      console.error(`[file-watcher] Removed indexed entries for ${path.basename(filePath)}`);
.opencode/skills/system-spec-kit/mcp_server/tests/progressive-validation.vitest.ts:776:      expect(path.basename(PROGRESSIVE_VALIDATE)).toBe('progressive-validate.sh');
.opencode/skills/system-spec-kit/mcp_server/tests/progressive-validation.vitest.ts:777:      expect(path.basename(VALIDATE_SH)).toBe('validate.sh');
...
.opencode/skills/system-spec-kit/mcp_server/tests/unit-path-security.vitest.ts:21:    expect(path.basename(result!)).toBe('package.json');
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/local-reranker.ts:318:          `[local-reranker] reranked=${rerankCount} total=${candidates.length} durationMs=${elapsed} model=${path.basename(modelPath)}`
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:591:    rawDescription || slugifyFolderName(path.basename(folderPath)).replace(/-/g, ' ') || path.basename(folderPath);
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:660:  const folderName = path.basename(folderPath);
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:727:      const folderName = path.basename(folderPath);
...
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts:306:  const basename = path.basename(filePath).toLowerCase();
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts:321:    const docType = FILENAME_TO_DOC_TYPE[basename];
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts:322:    if (docType && matchesSpecDocumentPath(filePath, basename)) return docType;
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts:376:  return path.basename(parentDir);
...
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts:755:/** Constitutional markdown basenames intentionally excluded from indexing */
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts:778:    SPEC_DOCUMENT_FILENAMES_SET.has(path.basename(normalizedPath).toLowerCase()) &&
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts:779:    matchesSpecDocumentPath(normalizedPath, path.basename(normalizedPath).toLowerCase())
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts:787:    !EXCLUDED_CONSTITUTIONAL_BASENAMES.has(path.basename(normalizedPath).toLowerCase())
...
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:120:// Example: Normalize a canonical path key
...
.opencode/skills/system-spec-kit/mcp_server/tests/stdio-logging-safety.vitest.ts:35:      const basename = path.basename(currentPath);
.opencode/skills/system-spec-kit/mcp_server/tests/stdio-logging-safety.vitest.ts:36:      if (EXCLUDED_SEGMENTS.has(basename)) {
.opencode/skills/system-spec-kit/mcp_server/tests/stdio-logging-safety.vitest.ts:50:    const basename = path.basename(currentPath);
.opencode/skills/system-spec-kit/mcp_server/tests/stdio-logging-safety.vitest.ts:51:    if (EXCLUDED_BASENAMES.has(basename)) {
.opencode/skills/system-spec-kit/mcp_server/tests/stdio-logging-safety.vitest.ts:59:    if (basename.endsWith('.test.ts') || basename.endsWith('.vitest.ts')) {
.opencode/skills/system-spec-kit/mcp_server/tests/folder-discovery.vitest.ts:305:    const folderNames = cache.folders.map(f => path.basename(f.specFolder));
.opencode/skills/system-spec-kit/mcp_server/tests/folder-discovery.vitest.ts:331:    const folderNames = cache.folders.map(f => path.basename(f.specFolder));
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:420:    return filename ? path.basename(filename, path.extname(filename)) : 'Untitled';
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:444:  return filename ? path.basename(filename, path.extname(filename)) : 'Untitled';
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:563:    const filename = path.basename(file_path);
...
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-save.vitest.ts:1061:    it('persists quality-loop trigger phrase fixes into downstream save inputs', async () => {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:282:  || path.join(DEFAULT_DB_DIR, path.basename(DATABASE_PATH));
...
.opencode/skills/system-spec-kit/mcp_server/tests/job-queue.vitest.ts:157:    expect(updated?.errors[0]?.filePath).toBe(path.basename(missingFile));
.opencode/skills/system-spec-kit/mcp_server/tests/job-queue.vitest.ts:168:    expect(storedErrors[0]?.filePath).toBe(path.basename(missingFile));
.opencode/skills/system-spec-kit/mcp_server/tests/job-queue.vitest.ts:311:        processingOrder.push(path.basename(filePath));
...
.opencode/skills/system-spec-kit/mcp_server/tests/context-server.vitest.ts:1743:      expect(hooksModule!.extractContextHint!({ prompt: 'trigger phrase' })).toBe('trigger phrase')
...
.opencode/skills/system-spec-kit/mcp_server/tests/memory-save-pipeline-enforcement.vitest.ts:442:    expect(result.fixes.some(f => /trigger phrase/i.test(f))).toBe(true);
...
.opencode/skills/system-spec-kit/mcp_server/tests/session-analytics-db.vitest.ts:4:import { basename, join } from 'node:path';
.opencode/skills/system-spec-kit/mcp_server/tests/session-analytics-db.vitest.ts:66:    transcriptPath = join(tempDir, basename(fixturePath));
...
.opencode/skills/system-spec-kit/mcp_server/tests/transaction-manager.vitest.ts:381:    const fileNames = pendingFiles.map((f: string) => path.basename(f));
...
.opencode/skills/system-spec-kit/mcp_server/tests/eval-db.vitest.ts:62:      expect(path.basename(dbPath!)).toBe('speckit-eval.db');
.opencode/skills/system-spec-kit/mcp_server/tests/eval-db.vitest.ts:68:      expect(path.basename(evalPath!)).not.toBe('context-index.sqlite');
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/transaction-manager.ts:91:  const base = path.basename(filePath, ext);
.opencode/skills/system-spec-kit/mcp_server/lib/storage/transaction-manager.ts:105:    const base = path.basename(candidatePath, ext);
.opencode/skills/system-spec-kit/mcp_server/lib/utils/canonical-path.ts:54:      segments.unshift(path.basename(probe));

exec
/bin/zsh -lc "rg -n \"delete_after|retention_policy|is_archived|sweep|expires_at|retention sweep|archive\" .opencode/skills/system-spec-kit/mcp_server | sed -n '1,260p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
.opencode/skills/system-spec-kit/mcp_server/ENV_REFERENCE.md:109:| `SPECKIT_RRF_K_EXPERIMENTAL` | `true` | boolean | Per-intent RRF K selection from the D1 K-sweep grid. Graduated ON. | `lib/search/search-flags.ts` |
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-types.ts:76:type CrudMutationType = 'create' | 'update' | 'delete' | 'merge' | 'archive' | 'restore' | 'reindex';
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-index-discovery.ts:24:const SPEC_DOC_EXCLUDE_DIRS = new Set(['scratch', 'memory', 'node_modules', 'iterations', 'z_archive']);
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:535:        const archivePlaceholders = oldChildIds.map(() => '?').join(', ');
.opencode/skills/system-spec-kit/mcp_server/handlers/chunking-orchestrator.ts:540:          WHERE id IN (${archivePlaceholders})
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:1825:  if (!column_names.includes('expires_at')) {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:1833:      logDuplicateColumnMigrationSkip('expires_at', error);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2336:      expires_at DATETIME,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2345:      is_archived INTEGER DEFAULT 0,
...
.opencode/skills/system-spec-kit/mcp_server/tests/full-spec-doc-indexing.vitest.ts:875:        expires_at: null,
.opencode/skills/system-spec-kit/mcp_server/tests/full-spec-doc-indexing.vitest.ts:918:        expires_at: null,
...
.opencode/skills/system-spec-kit/mcp_server/tests/incremental-index-v2.vitest.ts:54:      expires_at DATETIME,
...
.opencode/skills/system-spec-kit/mcp_server/tests/unit-normalization.vitest.ts:36:    expires_at: null,
.opencode/skills/system-spec-kit/mcp_server/tests/unit-normalization.vitest.ts:164:    row.expires_at = null;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/schema-downgrade.ts:64:  'expires_at',
.opencode/skills/system-spec-kit/mcp_server/lib/storage/schema-downgrade.ts:72:  'is_archived',
.opencode/skills/system-spec-kit/mcp_server/lib/storage/schema-downgrade.ts:140:      expires_at DATETIME,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/schema-downgrade.ts:148:      is_archived INTEGER DEFAULT 0,
.opencode/skills/system-spec-kit/mcp_server/tests/k-value-optimization.vitest.ts:43:  it('uses the D1 K sweep grid {10,20,40,60,80,100,120}', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/k-value-optimization.vitest.ts:98:  it('optimizes K per intent across the full sweep', () => {
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/README.md:236:  { spec_folder: 'z_archive/001-old', updated_at: '2024-06-01', importance_tier: 'deprecated' },
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/README.md:271:| Archive check | `isArchived('/z_archive/old')` | Deprioritize archived folders |
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/save/reconsolidation-bridge.ts | sed -n '360,430p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts | sed -n '1,260p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/governance/retention.ts | sed -n '1,260p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
exec
/bin/zsh -lc "rg -n \"runRetentionSweep|delete_after_expired|retention_sweep|archiveMemory|unarchiveMemory|archival scan|is_archived = 1|expires_at\" .opencode/skills/system-spec-kit/mcp_server/lib .opencode/skills/system-spec-kit/mcp_server/handlers | sed -n '1,260p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/schema-downgrade.ts:64:  'expires_at',
.opencode/skills/system-spec-kit/mcp_server/lib/storage/schema-downgrade.ts:140:      expires_at DATETIME,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:1336:    'expires_at',
...
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:665:archiveMemory(memoryId);
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:666:unarchiveMemory(memoryId);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:224:  where_clauses.push('(m.expires_at IS NULL OR m.expires_at > datetime(\'now\'))');
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:381:        AND (m.expires_at IS NULL OR m.expires_at > datetime('now'))
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:1825:  if (!column_names.includes('expires_at')) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:1827:      database.exec(`ALTER TABLE memory_index ADD COLUMN expires_at DATETIME`);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:1828:      console.warn('[vector-index] Migration: Added expires_at column');
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:1833:      logDuplicateColumnMigrationSkip('expires_at', error);
...
exec
/bin/zsh -lc 'rg --files .opencode/skills/system-spec-kit/mcp_server/lib | rg "retention|archival-manager|reconsolidation|mutation-ledger|lineage-state"' in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts | sed -n '550,690p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts | sed -n '250,330p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
   250	    }
   251	
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts | sed -n '212,245p;372,390p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
   212	       END`
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/storage/mutation-ledger.ts | sed -n '1,260p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts | sed -n '1,260p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts | sed -n '440,470p;1056,1118p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/context-server.ts | sed -n '740,770p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
- **Source**: [external/src/index.ts:27](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/999-hybrid-rag-fusion-upgrade/001-research-hybrid-rag-fusion-systems/004-opencode-mnemosyne-main/external/src/index.ts#L27), [external/README.md:51](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/999-hybrid-rag-fusion-upgrade/001-research-hybrid-rag-fusion-systems/004-opencode-mnemosyne-main/external/README.md#L51), [canonical-path.ts:18](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/utils/canonical-path.ts#L18), [lineage-state.ts:207](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts#L207), [lineage-state.ts:232](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts#L232), [create-record.ts:162](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts#L162)

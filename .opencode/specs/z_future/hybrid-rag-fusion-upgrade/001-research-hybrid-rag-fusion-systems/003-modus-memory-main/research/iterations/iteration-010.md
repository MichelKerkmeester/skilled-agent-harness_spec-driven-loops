...
- **Source**: `external/internal/mcp/memory.go:7-39`; `external/internal/mcp/vault.go:219-227`; `external/internal/vault/vault.go:123-158`; `external/cmd/modus-memory/doctor.go:19-31`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts:222-594`
...
- **Source**: `external/cmd/modus-memory/doctor.go:42-84`; `external/cmd/modus-memory/doctor.go:108-158`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts:296-376`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts:445-594`; `.opencode/skills/system-spec-kit/mcp_server/lib/storage/causal-edges.ts:647-680`
...
- **Source**: `external/internal/index/crossref.go:9-214`; `external/internal/mcp/vault.go:75-101`; `external/internal/mcp/vault.go:899-925`; `.opencode/skills/system-spec-kit/mcp_server/handlers/causal-graph.ts:339-540`; `.opencode/skills/system-spec-kit/mcp_server/handlers/causal-graph.ts:557-847`; `.opencode/skills/system-spec-kit/mcp_server/lib/storage/causal-edges.ts:18-52`; `.opencode/skills/system-spec-kit/mcp_server/lib/storage/causal-edges.ts:173-247`; `.opencode/skills/system-spec-kit/mcp_server/lib/storage/causal-edges.ts:616-760`
...
- **Source**: `external/internal/mcp/memory.go:7-39`; `external/internal/mcp/vault.go:21-104`; `external/internal/mcp/vault.go:273-343`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts:184-229`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts:273-550`; `.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:157-185`; `.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:337-440`; `.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:644-689`; `.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:695-791`
...
- **Source**: `external/internal/markdown/parser.go:98-159`; `external/internal/markdown/parser.go:161-186`; `external/internal/markdown/writer.go:10-51`; `external/internal/vault/facts.go:348-375`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:1273-1418`

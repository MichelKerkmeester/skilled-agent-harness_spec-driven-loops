...
- **Source**: `external/internal/learnings/learnings.go:1-10,23-64,121-208,299-328`; `external/internal/vault/prs.go:10-46`; `external/internal/vault/missions.go:14-39,89-111,211-256`; `external/internal/index/crossref.go:9-16,154-214,221-245`; `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:41-45,48-188,275-399,471-499`
...
- **Source**: `external/internal/vault/trust.go:11-25,28-95`; `external/internal/mcp/vault.go:607-635`; `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:275-399,402-466`
...
- **Source**: `external/internal/vault/prs.go:10-110`; `external/internal/mcp/vault.go:681-777`; `.opencode/skills/system-spec-kit/mcp_server/handlers/save/reconsolidation-bridge.ts:64-131`; `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:291-322`
...
- **Source**: `external/internal/vault/facts.go:160-254`; `external/internal/vault/beliefs.go:31-126`; `external/internal/learnings/learnings.go:229-277`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:519-520`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:840-883,1194-1207`; `.opencode/skills/system-spec-kit/mcp_server/lib/feedback/batch-learning.ts:4-20,33-41,175-247`; `.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:721-777`; `.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:357-445,670-684`
...
- **Source**: `external/internal/vault/missions.go:153-256`; `external/internal/mcp/vault.go:781-845`; `external/internal/index/crossref.go:154-214,263-278`; `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:471-499`

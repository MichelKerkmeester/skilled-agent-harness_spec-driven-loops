...
- **Source**: `.opencode/specs/system-spec-kit/999-hybrid-rag-fusion-upgrade/001-research-hybrid-rag-fusion-systems/003-modus-memory-main/external/internal/mcp/vault.go:21-58,75-101`; `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:41-50,638-718`; `.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:97-124,157-167`; `.opencode/skills/system-spec-kit/mcp_server/handlers/session-bootstrap.ts:143-156` [SOURCE: paths above]
...
- **Source**: `.opencode/specs/system-spec-kit/999-hybrid-rag-fusion-upgrade/001-research-hybrid-rag-fusion-systems/003-modus-memory-main/external/internal/index/crossref.go:26-31,41-112,154-214`; `.opencode/specs/system-spec-kit/999-hybrid-rag-fusion-upgrade/001-research-hybrid-rag-fusion-systems/003-modus-memory-main/external/internal/mcp/vault.go:75-101,901-924`; `.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts:61-106`; `.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:167-193` [SOURCE: paths above]
...
- **Source**: `.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/fsrs-scheduler.ts:39-43,65-72,197-215`; `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:165-169,297-315`; `.opencode/specs/system-spec-kit/999-hybrid-rag-fusion-upgrade/001-research-hybrid-rag-fusion-systems/003-modus-memory-main/external/internal/vault/facts.go:160-217`; `.opencode/specs/system-spec-kit/999-hybrid-rag-fusion-upgrade/001-research-hybrid-rag-fusion-systems/003-modus-memory-main/external/internal/mcp/vault.go:885-897` [SOURCE: paths above]
...
- **Source**: `.opencode/specs/system-spec-kit/999-hybrid-rag-fusion-upgrade/001-research-hybrid-rag-fusion-systems/003-modus-memory-main/external/internal/mcp/vault.go:273-317`; `.opencode/specs/system-spec-kit/999-hybrid-rag-fusion-upgrade/001-research-hybrid-rag-fusion-systems/003-modus-memory-main/external/internal/vault/facts.go:160-217`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:751-769,1071-1143`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:840-845,1194-1202` [SOURCE: paths above]
...
- **Source**: `.opencode/specs/system-spec-kit/999-hybrid-rag-fusion-upgrade/001-research-hybrid-rag-fusion-systems/003-modus-memory-main/external/internal/mcp/vault.go:280-299,343`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:812-861`; `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:41-50,638-718`; `.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:4-15,106-117` [SOURCE: paths above]
...
- `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:41-50,165-169,297-315,638-718,740-757`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:751-769,812-861,1071-1143`
- `.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:529-585,840-845,1194-1202`
- `.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/fsrs-scheduler.ts:39-43,65-72,197-215`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts:61-106`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:97-124,157-193`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:4-15,106-117`

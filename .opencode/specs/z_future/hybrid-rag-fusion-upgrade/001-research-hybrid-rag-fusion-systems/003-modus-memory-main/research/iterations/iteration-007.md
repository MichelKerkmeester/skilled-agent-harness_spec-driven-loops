...
- **Source**: `.opencode/specs/system-spec-kit/999-hybrid-rag-fusion-upgrade/001-research-hybrid-rag-fusion-systems/003-modus-memory-main/external/internal/mcp/vault.go:273-317,343,885-897`; `.opencode/specs/system-spec-kit/999-hybrid-rag-fusion-upgrade/001-research-hybrid-rag-fusion-systems/003-modus-memory-main/external/internal/vault/facts.go:160-217`; `.opencode/specs/system-spec-kit/999-hybrid-rag-fusion-upgrade/001-research-hybrid-rag-fusion-systems/003-modus-memory-main/external/README.md:296-300,454-457`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:519-533,771-802,1304-1320`; `.opencode/skills/system-spec-kit/mcp_server/lib/storage/access-tracker.ts:83-116,145-181`; `.opencode/skills/system-spec-kit/mcp_server/lib/feedback/query-flow-tracker.ts:157-199,205-258`; `.opencode/skills/system-spec-kit/mcp_server/context-server.ts:962-973`
...
- `.opencode/skills/system-spec-kit/mcp_server/lib/feedback/query-flow-tracker.ts`

...
- **Source**: `external/internal/index/crossref.go:41-214`; `external/internal/index/indexer.go:110-136,277-289`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:532-674`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1474-1503`
...
- **Source**: `external/internal/vault/facts.go:188-217`; `external/internal/mcp/vault.go:885-897`; `.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/fsrs-scheduler.ts:39-47,65-71,138-155,198-215`; `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:164-169`

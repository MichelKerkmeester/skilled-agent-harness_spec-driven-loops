...
- **Source**: prior rollout planning and current tool surface [SOURCE: `research/iterations/iteration-031.md:105`; `research/iterations/iteration-032.md:29-46,130-133`; `research/iterations/iteration-033.md:8-18,113-119`; `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:236-270`; `external/src/drift/checkers/path.ts:6-67`; `external/src/drift/checkers/index-sync.ts:6-68`]
...
- **Source**: Mex command surface, prior DX iterations, and current Public authority boundaries [SOURCE: `external/src/cli.ts:28-161`; `research/iterations/iteration-031.md:29-37,84-90,105`; `research/iterations/iteration-036.md:39-45,81-88`; `research/iterations/iteration-037.md:156-160`; `.opencode/skills/system-spec-kit/mcp_server/handlers/session-bootstrap.ts:94-126`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts:426-440`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:1301-1389`]
...
- **Source**: Mex staleness code, earlier temporal analysis, and current session-health hints [SOURCE: `external/src/drift/checkers/staleness.ts:4-56`; `external/README.md:76-87`; `research/iterations/iteration-023.md:9951-9962`; `research/iterations/iteration-031.md:40-49`; `research/iterations/iteration-034.md:8-12,85-88`; `.opencode/skills/system-spec-kit/mcp_server/handlers/session-health.ts:107-130`]
...
- **Source**: performance, testing, and rollout-matrix follow-ups [SOURCE: `research/iterations/iteration-032.md:130-133`; `research/iterations/iteration-033.md:38-52,113-119`; `research/iterations/iteration-034.md:24-45,85-88`; `research/iterations/iteration-035.md:82-89`; `.opencode/skills/system-spec-kit/mcp_server/handlers/session-bootstrap.ts:113-126`; `.opencode/skills/system-spec-kit/mcp_server/handlers/session-health.ts:117-130`]
...
- **Source**: prior safety pass plus current resume/context surfaces [SOURCE: `research/iterations/iteration-025.md:10552,10568,10611,10627`; `.opencode/skills/system-spec-kit/mcp_server/handlers/session-bootstrap.ts:94-126,194-209`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:700-815`]
...
- `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:236-270,638-665`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:700-815`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/session-bootstrap.ts:94-126,194-209`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/session-health.ts:107-130`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts:426-440`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:1301-1389`

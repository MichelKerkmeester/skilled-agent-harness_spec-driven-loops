...
.opencode/skills/system-spec-kit/mcp_server/schemas/tool-input-schemas.ts:413:  task_preflight: taskPreflightSchema as unknown as ToolInputSchema,
.opencode/skills/system-spec-kit/mcp_server/schemas/tool-input-schemas.ts:414:  task_postflight: taskPostflightSchema as unknown as ToolInputSchema,
...
.opencode/skills/system-spec-kit/templates/handover.md:35:- **From Session:** [YOUR_VALUE_HERE: session_id or date]
.opencode/skills/system-spec-kit/templates/handover.md:116:- Create new memory file via `generate-context.js` before handover
...
.opencode/skills/system-spec-kit/shared/embeddings/README.md:398:| [generate-context.js](../../scripts/dist/memory/generate-context.js) | Main script using embeddings |
...
.opencode/skills/system-spec-kit/templates/context_template.md:9:_sourceSessionId: "{{SOURCE_SESSION_ID}}"
.opencode/skills/system-spec-kit/templates/context_template.md:108:     - "Memory files MUST use generate-context.js script"
.opencode/skills/system-spec-kit/templates/context_template.md:126:| Session ID | {{SESSION_ID}} |
.opencode/skills/system-spec-kit/templates/context_template.md:328:node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js {{SPEC_FOLDER}} --force
.opencode/skills/system-spec-kit/templates/context_template.md:404:session_id: "{{SESSION_ID}}"
.opencode/skills/system-spec-kit/shared/README.md:38:- **CLI scripts** (`scripts/`) - `generate-context.ts` and other utilities
.opencode/skills/system-spec-kit/shared/README.md:369:// In scripts/memory/generate-context.ts or similar
...
.opencode/skills/system-spec-kit/mcp_server/handlers/session-learning.ts:15:// Feature catalog: Post-task learning measurement (task_postflight)
...
.opencode/skills/system-spec-kit/mcp_server/handlers/session-learning.ts:300:/** Handle task_preflight tool - captures baseline knowledge scores before a task begins */
...
.opencode/skills/system-spec-kit/mcp_server/handlers/session-learning.ts:370:        tool: 'task_preflight',
...
.opencode/skills/system-spec-kit/mcp_server/handlers/session-learning.ts:420:      tool: 'task_preflight',
...
.opencode/skills/system-spec-kit/mcp_server/handlers/session-learning.ts:442:          : `Call task_postflight with taskId: "${taskId}" after completing the task`,
.opencode/skills/system-spec-kit/mcp_server/handlers/session-learning.ts:457:/** Handle task_postflight tool - measures learning by comparing post-task scores to baseline */
...
.opencode/skills/system-spec-kit/mcp_server/handlers/session-learning.ts:537:        ? `No preflight record found for spec_folder="${spec_folder}" and task_id="${taskId}". Call task_preflight first.`
...
.opencode/skills/system-spec-kit/mcp_server/handlers/session-learning.ts:607:      tool: 'task_postflight',
...
.opencode/skills/system-spec-kit/mcp_server/handlers/session-learning.ts:836:      hints.push('Call task_postflight to complete learning measurement');
.opencode/skills/system-spec-kit/mcp_server/handlers/session-learning.ts:872:const handle_task_preflight = handleTaskPreflight;
.opencode/skills/system-spec-kit/mcp_server/handlers/session-learning.ts:873:const handle_task_postflight = handleTaskPostflight;
.opencode/skills/system-spec-kit/mcp_server/handlers/session-learning.ts:878:  handle_task_preflight,
.opencode/skills/system-spec-kit/mcp_server/handlers/session-learning.ts:879:  handle_task_postflight,
.opencode/skills/system-spec-kit/shared/normalization.ts:51:  session_id: string | null;
.opencode/skills/system-spec-kit/shared/normalization.ts:146:    sessionId: row.session_id,
.opencode/skills/system-spec-kit/shared/normalization.ts:191:  if (memory.sessionId !== undefined) row.session_id = memory.sessionId;
.opencode/skills/system-spec-kit/shared/normalization.ts:236:  if (row.session_id !== undefined) mem.sessionId = row.session_id;
...
.opencode/skills/system-spec-kit/templates/memory/README.md:7:  - "generate-context"
.opencode/skills/system-spec-kit/templates/memory/README.md:40:node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js <spec-folder-or-json-input>
.opencode/skills/system-spec-kit/templates/memory/README.md:50:node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js /tmp/save-context-data.json specs/system-spec-kit
.opencode/skills/system-spec-kit/templates/memory/README.md:53:node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js --recovery 003-parent/001-child
.opencode/skills/system-spec-kit/templates/memory/README.md:56:node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js --recovery 001-child-name
.opencode/skills/system-spec-kit/templates/memory/README.md:59:node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js /tmp/save-context-data.json
.opencode/skills/system-spec-kit/templates/memory/README.md:80:- `../../scripts/dist/memory/generate-context.js`
...
.opencode/skills/system-spec-kit/SKILL.md:619:**Epistemic Learning:** Use `task_preflight()` before and `task_postflight()` after implementation to measure knowledge gains. Learning Index: `LI = (KnowledgeDelta × 0.4) + (UncertaintyReduction × 0.35) + (ContextImprovement × 0.25)`. Review trends via `memory_get_learning_history()`. See [epistemic_vectors.md](./references/memory/epistemic_vectors.md).
...
.opencode/skills/system-spec-kit/assets/template_mapping.md:179:    └── *.md                     (auto-generated via generate-context.js)
.opencode/skills/system-spec-kit/assets/template_mapping.md:201:    └── *.md                     (auto-generated via generate-context.js)
.opencode/skills/system-spec-kit/assets/template_mapping.md:223:    └── *.md                     (auto-generated via generate-context.js)
.opencode/skills/system-spec-kit/assets/template_mapping.md:245:    └── *.md                     (auto-generated via generate-context.js)
.opencode/skills/system-spec-kit/assets/template_mapping.md:322:**Generation:** Use `/memory:save` or `node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js --json '{"specFolder":"###-name","sessionSummary":"..."}' specs/###-name/` to auto-generate properly formatted memory files.
.opencode/skills/system-spec-kit/mcp_server/tools/lifecycle-tools.ts:48:  'task_preflight',
.opencode/skills/system-spec-kit/mcp_server/tools/lifecycle-tools.ts:49:  'task_postflight',
...
.opencode/skills/system-spec-kit/mcp_server/tools/lifecycle-tools.ts:69:    case 'task_preflight':             return handleTaskPreflight(parseArgs<PreflightArgs>(validateToolArgs('task_preflight', args)));
.opencode/skills/system-spec-kit/mcp_server/tools/lifecycle-tools.ts:70:    case 'task_postflight':            return handleTaskPostflight(parseArgs<PostflightArgs>(validateToolArgs('task_postflight', args)));
...
.opencode/skills/system-spec-kit/references/templates/template_style_guide.md:87:| `{{MUSTACHE}}` | Auto-generated (context_template.md only) | `{{SESSION_ID}}` |
...
.opencode/skills/system-spec-kit/feature_catalog/06--analysis/05-epistemic-baseline-capture-taskpreflight.md:2:title: "Epistemic baseline capture (task_preflight)"
.opencode/skills/system-spec-kit/feature_catalog/06--analysis/05-epistemic-baseline-capture-taskpreflight.md:6:# Epistemic baseline capture (task_preflight)
.opencode/skills/system-spec-kit/feature_catalog/06--analysis/05-epistemic-baseline-capture-taskpreflight.md:35:| `mcp_server/schemas/tool-input-schemas.ts` | Zod input schemas for `task_preflight` arguments |
.opencode/skills/system-spec-kit/feature_catalog/06--analysis/05-epistemic-baseline-capture-taskpreflight.md:36:| `mcp_server/tool-schemas.ts` | MCP-visible JSON schema for `task_preflight` |
.opencode/skills/system-spec-kit/feature_catalog/06--analysis/05-epistemic-baseline-capture-taskpreflight.md:60:- Source feature title: Epistemic baseline capture (task_preflight)
...
.opencode/skills/system-spec-kit/feature_catalog/06--analysis/06-post-task-learning-measurement-taskpostflight.md:2:title: "Post-task learning measurement (task_postflight)"
.opencode/skills/system-spec-kit/feature_catalog/06--analysis/06-post-task-learning-measurement-taskpostflight.md:6:# Post-task learning measurement (task_postflight)
...
.opencode/skills/system-spec-kit/feature_catalog/06--analysis/06-post-task-learning-measurement-taskpostflight.md:40:| `mcp_server/schemas/tool-input-schemas.ts` | Zod input schemas for `task_postflight` arguments |
.opencode/skills/system-spec-kit/feature_catalog/06--analysis/06-post-task-learning-measurement-taskpostflight.md:41:| `mcp_server/tool-schemas.ts` | MCP-visible JSON schema for `task_postflight` |
.opencode/skills/system-spec-kit/feature_catalog/06--analysis/06-post-task-learning-measurement-taskpostflight.md:64:- Source feature title: Post-task learning measurement (task_postflight)
...
.opencode/skills/system-spec-kit/mcp_server/tests/memory-save-ux-regressions.vitest.ts:115:session_id: "${titleSlug}-fixture"
...
.opencode/skills/system-spec-kit/scripts/extractors/index.ts:34:export * from './collect-session-data';
.opencode/skills/system-spec-kit/mcp_server/tests/incremental-index-v2.vitest.ts:49:      session_id TEXT,
.opencode/skills/system-spec-kit/references/memory/epistemic_vectors.md:399:1. **`task_preflight()`** — Captures epistemic baseline before work begins. Records uncertainty score (0-100), knowledge gaps, and context coverage.
.opencode/skills/system-spec-kit/references/memory/epistemic_vectors.md:400:2. **`task_postflight()`** — Measures post-task state. Computes Learning Index: `LI = (KnowledgeDelta × 0.4) + (UncertaintyReduction × 0.35) + (ContextImprovement × 0.25)`.
...
.opencode/skills/system-spec-kit/scripts/extractors/README.md:34:- `collect-session-data.ts` - Orchestrates session data collection across observations, files, decisions, and context
...
.opencode/skills/system-spec-kit/feature_catalog/09--evaluation-and-measurement/13-evaluation-and-housekeeping-fixes.md:22:- **Postflight re-correction (#35):** `task_postflight` SELECT now matches `phase IN ('preflight', 'complete')` so re-posting updates the existing record instead of failing.
...
.opencode/skills/system-spec-kit/references/memory/memory_system.md:126:| L6: Analysis | `task_preflight()` | Capture epistemic baseline before task execution | Start of implementation work |
.opencode/skills/system-spec-kit/references/memory/memory_system.md:127:| L6: Analysis | `task_postflight()` | Capture epistemic state after task, calculate Learning Index | After completing implementation |
...
.opencode/skills/system-spec-kit/mcp_server/tests/mcp-tool-dispatch.vitest.ts:20:  { tool: 'task_preflight', handler: 'handleTaskPreflight', layer: 'L6' },
.opencode/skills/system-spec-kit/mcp_server/tests/mcp-tool-dispatch.vitest.ts:21:  { tool: 'task_postflight', handler: 'handleTaskPostflight', layer: 'L6' },
...
.opencode/skills/system-spec-kit/mcp_server/tests/mcp-tool-dispatch.vitest.ts:46:  { camel: 'handleTaskPreflight', snake: 'handle_task_preflight' },
.opencode/skills/system-spec-kit/mcp_server/tests/mcp-tool-dispatch.vitest.ts:47:  { camel: 'handleTaskPostflight', snake: 'handle_task_postflight' },
...
.opencode/skills/system-spec-kit/manual_testing_playbook/06--analysis/024-post-task-learning-measurement-task-postflight.md:2:title: "EX-024 -- Post-task learning measurement (task_postflight)"
.opencode/skills/system-spec-kit/manual_testing_playbook/06--analysis/024-post-task-learning-measurement-task-postflight.md:3:description: "This scenario validates Post-task learning measurement (task_postflight) for `EX-024`. It focuses on Learning closeout."
.opencode/skills/system-spec-kit/manual_testing_playbook/06--analysis/024-post-task-learning-measurement-task-postflight.md:6:# EX-024 -- Post-task learning measurement (task_postflight)
.opencode/skills/system-spec-kit/manual_testing_playbook/06--analysis/024-post-task-learning-measurement-task-postflight.md:10:This scenario validates Post-task learning measurement (task_postflight) for `EX-024`. It focuses on Learning closeout.
.opencode/skills/system-spec-kit/manual_testing_playbook/06--analysis/024-post-task-learning-measurement-task-postflight.md:29:| EX-024 | Post-task learning measurement (task_postflight) | Learning closeout | `Complete postflight for pipeline-v2-audit. Capture the evidence needed to prove Delta/learning record saved. Return a concise user-facing pass/fail verdict with the main reason.` | `task_postflight(specFolder,taskId,knowledgeScore,uncertaintyScore,contextScore)` | Delta/learning record saved | Postflight output | PASS if completion recorded | Verify taskId matches preflight |
...
.opencode/skills/system-spec-kit/scripts/extractors/collect-session-data.ts:617:        component: 'collect-session-data',
.opencode/skills/system-spec-kit/scripts/extractors/collect-session-data.ts:1574:    SESSION_ID: sessionId,
.opencode/skills/system-spec-kit/scripts/extractors/collect-session-data.ts:1594:    SOURCE_SESSION_ID: sourceSessionId,
.opencode/skills/system-spec-kit/templates/README.md:84:- Memory context is saved via `../scripts/dist/memory/generate-context.js`, never manual file creation.
...
.opencode/skills/system-spec-kit/manual_testing_playbook/06--analysis/023-epistemic-baseline-capture-task-preflight.md:2:title: "EX-023 -- Epistemic baseline capture (task_preflight)"
.opencode/skills/system-spec-kit/manual_testing_playbook/06--analysis/023-epistemic-baseline-capture-task-preflight.md:3:description: "This scenario validates Epistemic baseline capture (task_preflight) for `EX-023`. It focuses on Pre-task baseline logging."
.opencode/skills/system-spec-kit/manual_testing_playbook/06--analysis/023-epistemic-baseline-capture-task-preflight.md:6:# EX-023 -- Epistemic baseline capture (task_preflight)
.opencode/skills/system-spec-kit/manual_testing_playbook/06--analysis/023-epistemic-baseline-capture-task-preflight.md:10:This scenario validates Epistemic baseline capture (task_preflight) for `EX-023`. It focuses on Pre-task baseline logging.
.opencode/skills/system-spec-kit/manual_testing_playbook/06--analysis/023-epistemic-baseline-capture-task-preflight.md:29:| EX-023 | Epistemic baseline capture (task_preflight) | Pre-task baseline logging | `Create preflight for pipeline-v2-audit. Capture the evidence needed to prove Baseline record created. Return a concise user-facing pass/fail verdict with the main reason.` | `task_preflight(specFolder,taskId,knowledgeScore,uncertaintyScore,contextScore)` | Baseline record created | Preflight output | PASS if baseline persisted | Retry with complete fields |
...
.opencode/skills/system-spec-kit/mcp_server/tests/runtime-detection.vitest.ts:12:  delete process.env.CLAUDE_SESSION_ID;
.opencode/skills/system-spec-kit/mcp_server/tests/runtime-detection.vitest.ts:84:      delete process.env.CLAUDE_SESSION_ID;
.opencode/skills/system-spec-kit/mcp_server/tests/runtime-detection.vitest.ts:97:      delete process.env.CLAUDE_SESSION_ID;
.opencode/skills/system-spec-kit/mcp_server/tests/runtime-detection.vitest.ts:129:      delete process.env.CLAUDE_SESSION_ID;
.opencode/skills/system-spec-kit/mcp_server/tests/runtime-detection.vitest.ts:143:      delete process.env.CLAUDE_SESSION_ID;
...
.opencode/skills/system-spec-kit/feature_catalog/16--tooling-and-scripts/12-session-capturing-pipeline-quality.md:83:   - `collect-session-data.ts` guards SUMMARY derivation against error text in the `learning` field
...
.opencode/skills/system-spec-kit/feature_catalog/16--tooling-and-scripts/12-session-capturing-pipeline-quality.md:183:| `scripts/extractors/collect-session-data.ts` | Template-field assembly, completion-status recovery, and structured summary preservation |
...
.opencode/skills/system-spec-kit/manual_testing_playbook/manual_testing_playbook.md:576:### EX-023 | Epistemic baseline capture (task_preflight)
.opencode/skills/system-spec-kit/manual_testing_playbook/manual_testing_playbook.md:590:### EX-024 | Post-task learning measurement (task_postflight)
...
.opencode/skills/system-spec-kit/feature_catalog/16--tooling-and-scripts/16-json-mode-hybrid-enrichment.md:139:| `scripts/extractors/collect-session-data.ts` | Wave 2 count, confidence, and outcome handling |
...
.opencode/skills/system-spec-kit/mcp_server/tests/continue-session.vitest.ts:2:// - T124 uses collect-session-data extractor
.opencode/skills/system-spec-kit/mcp_server/tests/continue-session.vitest.ts:34:  const collectSessionDataPath = path.join(__dirname, '../../scripts/dist/extractors/collect-session-data.js');
...
.opencode/skills/system-spec-kit/scripts/lib/simulation-factory.ts:242:    SOURCE_SESSION_ID: '',
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:1100:      "expectedResultDescription": "Should surface the Learning Index formula (LI = KnowledgeDelta×0.4 + UncertaintyReduction×0.35 + ContextImprovement×0.25) from CLAUDE.md or memory_task_preflight tool documentation.",
...
.opencode/skills/system-spec-kit/mcp_server/tests/integration-session-dedup.vitest.ts:70:        // Session_id should not be the cause of error
...
.opencode/skills/system-spec-kit/feature_catalog/feature_catalog_in_simple_terms.md:252:### Epistemic baseline capture (task_preflight)
.opencode/skills/system-spec-kit/feature_catalog/feature_catalog_in_simple_terms.md:256:### Post-task learning measurement (task_postflight)
...
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-save.vitest.ts:176:          'session_id: "atomic-save-fi"',
...
.opencode/skills/system-spec-kit/manual_testing_playbook/13--memory-quality-and-indexing/003-context-save-index-update.md:25:  - `node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js /tmp/save-context-data.json specs/<target-spec>`
...
.opencode/skills/system-spec-kit/feature_catalog/feature_catalog.md:881:### Epistemic baseline capture (task_preflight)
.opencode/skills/system-spec-kit/feature_catalog/feature_catalog.md:901:### Post-task learning measurement (task_postflight)
...
.opencode/skills/system-spec-kit/feature_catalog/feature_catalog.md:1417:- **Postflight re-correction (#35):** `task_postflight` SELECT now matches `phase IN ('preflight', 'complete')` so re-posting updates the existing record instead of failing.
...
.opencode/skills/system-spec-kit/mcp_server/tests/handler-session-learning.vitest.ts:46:        'handle_task_preflight',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-session-learning.vitest.ts:47:        'handle_task_postflight',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-session-learning.vitest.ts:154:          session_id TEXT,
.opencode/skills/system-spec-kit/manual_testing_playbook/13--memory-quality-and-indexing/005-outsourced-agent-memory-capture-round-trip.md:27:  - `node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js /tmp/save-context-data.json specs/<target-spec>`
.opencode/skills/system-spec-kit/manual_testing_playbook/13--memory-quality-and-indexing/005-outsourced-agent-memory-capture-round-trip.md:31:- Evidence: agent stdout with memory section + generate-context output + search result showing saved memory.
.opencode/skills/system-spec-kit/manual_testing_playbook/13--memory-quality-and-indexing/005-outsourced-agent-memory-capture-round-trip.md:33:- Fail triage: Check memory epilogue in prompt template → Verify generate-context.js JSON mode input → Inspect agent stdout for structured section → Verify index scan ran post-save.
.opencode/skills/system-spec-kit/manual_testing_playbook/13--memory-quality-and-indexing/005-outsourced-agent-memory-capture-round-trip.md:37:2. Run: `node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js /tmp/save-context-data.json specs/<target-spec>`
.opencode/skills/system-spec-kit/manual_testing_playbook/13--memory-quality-and-indexing/005-outsourced-agent-memory-capture-round-trip.md:42:2. Run generate-context.js with the JSON file
...
.opencode/skills/system-spec-kit/mcp_server/tests/context-server.vitest.ts:179:      'task_preflight',
.opencode/skills/system-spec-kit/mcp_server/tests/context-server.vitest.ts:180:      'task_postflight',
...
.opencode/skills/system-spec-kit/mcp_server/tests/context-server.vitest.ts:292:      'task_preflight', 'task_postflight', 'memory_get_learning_history',
...
.opencode/skills/system-spec-kit/mcp_server/tests/context-server.vitest.ts:2094:      'task_preflight': '[L6:Analysis]',
.opencode/skills/system-spec-kit/mcp_server/tests/context-server.vitest.ts:2095:      'task_postflight': '[L6:Analysis]',
...
.opencode/skills/system-spec-kit/mcp_server/tests/anchor-id-simplification.vitest.ts:8:// (no {{SESSION_ID}} or {{SPEC_FOLDER}} in anchor names)
.opencode/skills/system-spec-kit/mcp_server/tests/anchor-id-simplification.vitest.ts:92:    it('S01: NO anchor contains {{SESSION_ID}}', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/anchor-id-simplification.vitest.ts:97:        expect(anchor).not.toContain('{{SESSION_ID}}');
...
.opencode/skills/system-spec-kit/mcp_server/tests/layer-definitions.vitest.ts:129:        task_preflight: 'L6',
.opencode/skills/system-spec-kit/mcp_server/tests/layer-definitions.vitest.ts:130:        task_postflight: 'L6',
...
.opencode/skills/system-spec-kit/mcp_server/tests/layer-definitions.vitest.ts:214:        { tool: 'task_preflight', desc: 'Capture baseline', prefix: '[L6:Analysis]' },
...
.opencode/skills/system-spec-kit/mcp_server/tests/memory-save-pipeline-enforcement.vitest.ts:204:session_id: "pipeline-enforcement-fixture"
...
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:59:const MEMORY_CONTEXT_SOURCE = fs.readFileSync(
...
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:386:    expect(MEMORY_CONTEXT_SOURCE).toContain('options.sessionTransition = options.includeTrace === true ? sessionTransition : undefined;');
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:387:    expect(MEMORY_CONTEXT_SOURCE).not.toContain('sessionLifecycle.transition');
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:429:    expect(MEMORY_CONTEXT_SOURCE).toMatch(/mode:\s*requested_mode\s*=\s*'auto'/);
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:430:    expect(MEMORY_CONTEXT_SOURCE).not.toMatch(/mode:\s*requested_mode\s*=\s*'quick'/);
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:653:    expect(MEMORY_CONTEXT_SOURCE).toMatch(/mode:\s*requested_mode\s*=\s*'auto'/);
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:654:    expect(MEMORY_CONTEXT_SOURCE).toContain('requestedMode: requested_mode');
...
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/18-session-resume-tool.md:32:| `mcp_server/tools/lifecycle-tools.ts` | Dispatch | Tool dispatch registration for session_resume |
...
.opencode/skills/system-spec-kit/mcp_server/tests/token-budget-enforcement.vitest.ts:33:        task_preflight: 1500,
.opencode/skills/system-spec-kit/mcp_server/tests/token-budget-enforcement.vitest.ts:34:        task_postflight: 1500,
...
.opencode/skills/system-spec-kit/mcp_server/tests/mcp-input-validation.vitest.ts:125:    tool: 'task_preflight',
.opencode/skills/system-spec-kit/mcp_server/tests/mcp-input-validation.vitest.ts:131:    tool: 'task_postflight',
...
.opencode/skills/system-spec-kit/mcp_server/lib/architecture/layer-definitions.ts:100:      'task_preflight',
.opencode/skills/system-spec-kit/mcp_server/lib/architecture/layer-definitions.ts:101:      'task_postflight',
...
.opencode/skills/system-spec-kit/mcp_server/tests/fixtures/runtime-fixtures.ts:74:  delete process.env.CLAUDE_SESSION_ID;
.opencode/skills/system-spec-kit/mcp_server/tests/fixtures/runtime-fixtures.ts:106:  delete process.env.CLAUDE_SESSION_ID;
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/runtime-detection.ts:26:  if (env.CLAUDE_CODE === '1' || env.CLAUDE_SESSION_ID || env.MCP_SERVER_NAME === 'context-server') {
...
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/253-runtime-detection.md:21:- **Prompt**: `Validate 253 Runtime detection behavior. Run the vitest suites for runtime-detection and cross-runtime fallback and confirm all 5 detection scenarios: (1) CLAUDE_CODE=1 or CLAUDE_SESSION_ID or MCP_SERVER_NAME=context-server yields runtime=claude-code, hookPolicy=enabled, (2) CODEX_CLI=1 or CODEX_SANDBOX yields runtime=codex-cli, hookPolicy=unavailable, (3) COPILOT_CLI=1 or GITHUB_COPILOT_TOKEN yields runtime=copilot-cli with hookPolicy=enabled when repo .github/hooks/*.json exposes sessionStart and disabled_by_scope when it does not, (4) GEMINI_CLI=1 or GOOGLE_GENAI_USE_VERTEXAI yields runtime=gemini-cli with hookPolicy driven by .gemini/settings.json, (5) no matching env vars yields runtime=unknown, hookPolicy=unknown.`
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/253-runtime-detection.md:40:| 253a | Runtime detection | Claude Code detected with hookPolicy=enabled and hooks available | `Validate 253a claude-code detection` | `cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run tests/runtime-detection.vitest.ts` | `CLAUDE_CODE=1` yields `{ runtime: 'claude-code', hookPolicy: 'enabled' }`, `areHooksAvailable()` returns true, `getRecoveryApproach()` returns 'hooks' | Test output showing detection and helper results | PASS if claude-code identified with enabled hooks | Check env var checks: CLAUDE_CODE, CLAUDE_SESSION_ID, MCP_SERVER_NAME |
...
.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/154-json-primary-deprecation-posture.md:27:- Prompt: `Test the two generate-context.js save paths: (1) --json with valid structured payload should succeed, (2) direct positional without --json/--stdin should reject with migration guidance. Return a pass/fail verdict for each path.`
.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/154-json-primary-deprecation-posture.md:37:| 154 | JSON-primary deprecation posture | Verify JSON-only save contract | `Test the two generate-context.js save paths: (1) --json with valid structured payload should succeed, (2) direct positional without --json/--stdin should reject with migration guidance. Return a pass/fail verdict for each path.` | 1) `node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js --json '{"specFolder":"test","sessionSummary":"test"}' <spec-folder>` → expect exit 0 2) `node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js <spec-folder>` → expect non-zero exit with migration message | Path 1: exit 0, Path 2: non-zero with guidance | CLI exit codes and stdout/stderr output | PASS if both paths match documented behavior | Check generate-context.ts argument parsing and migration guidance text |
...
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/265-gemini-hooks.md:37:| 265a | Gemini CLI hooks | Session-prime outputs additionalContext on startup | `Validate 265a session-prime startup` | `echo '{"session_id":"test","source":"startup","cwd":"."}' \| node .opencode/skills/system-spec-kit/mcp_server/dist/hooks/gemini/session-prime.js` | JSON output with hookSpecificOutput.additionalContext string | Hook script stdout | PASS if valid JSON with additionalContext field containing context text | Check formatGeminiOutput() and session-prime handleStartup() |
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/265-gemini-hooks.md:38:| 265b | Gemini CLI hooks | Compact-inject returns empty when no cached payload | `Validate 265b compact-inject no-op` | `echo '{"session_id":"test","hook_event_name":"BeforeAgent","prompt":"test"}' \| node .opencode/skills/system-spec-kit/mcp_server/dist/hooks/gemini/compact-inject.js` | No output or empty JSON (no cached compact payload) | Hook script stdout | PASS if no additionalContext injected when no cache exists | Check readAndClearCompactPrime() returns null |
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/265-gemini-hooks.md:39:| 265c | Gemini CLI hooks | Shared stdin parser handles Gemini format | `Validate 265c stdin parsing` | `cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run tests/ --grep gemini` | parseGeminiStdin returns GeminiHookInput with session_id, source, cwd | Test output | PASS if all fields parsed correctly from Gemini JSON format | Check parseGeminiStdin() buffer concatenation and JSON.parse |
...
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/263-session-resume.md:27:  - structuralContext.summary is a string, `recommendedAction` is a string, and `sourceSurface === "session_resume"`
...
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:602:// entries = [{ id, session_id, memory_id, attention_score, added_at, last_focused, focus_count }]
...
.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/007-session-capturing-pipeline-quality.md:68:    - `grep -n 'SYSTEM_SPEC_KIT_CAPTURE_SOURCE\|trigger_phrases' .opencode/skills/system-spec-kit/scripts/loaders/data-loader.ts .opencode/skills/system-spec-kit/scripts/memory/generate-context.ts .opencode/skills/system-spec-kit/templates/context_template.md`
.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/007-session-capturing-pipeline-quality.md:72:    - `cd .opencode/skills/system-spec-kit/scripts && npm test -- --run tests/spec-affinity.vitest.ts tests/claude-code-capture.vitest.ts tests/codex-cli-capture.vitest.ts tests/copilot-cli-capture.vitest.ts tests/gemini-cli-capture.vitest.ts tests/quality-scorer-calibration.vitest.ts tests/runtime-memory-inputs.vitest.ts tests/session-enrichment.vitest.ts tests/task-enrichment.vitest.ts tests/memory-render-fixture.vitest.ts tests/generate-context-cli-authority.vitest.ts tests/memory-sufficiency.vitest.ts tests/memory-template-contract.vitest.ts`
.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/007-session-capturing-pipeline-quality.md:77:    - `cd .opencode/skills/system-spec-kit/scripts && npm test -- --run tests/workflow-e2e.vitest.ts tests/generate-context-cli-authority.vitest.ts tests/contamination-filter.vitest.ts tests/quality-scorer-calibration.vitest.ts`
.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/007-session-capturing-pipeline-quality.md:86:    - `M-007a` Rich JSON-mode save: run `node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js <json-data-file> 009-perfect-session-capturing` with a populated synthetic or sandbox JSON file and verify `qualityValidation.valid === true`, indexing succeeds, and a memory ID is returned.
.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/007-session-capturing-pipeline-quality.md:88:    - `M-007b` Thin JSON insufficiency: rerun `generate-context.js` with intentionally thin JSON input using the documented snake_case contract and verify it now fails `INSUFFICIENT_CONTEXT_ABORT` before file write, with a materially lower diagnostic score than `M-007a`.
.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/007-session-capturing-pipeline-quality.md:99:    - `M-007m` `--stdin` structured input: pipe valid structured JSON into `node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js --stdin <target-spec-folder>` and confirm the explicit CLI target wins over any payload `specFolder`, while `toolCalls` and `exchanges` survive into the generated output.
.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/007-session-capturing-pipeline-quality.md:100:    - `M-007n` `--json` structured input: run `node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js --json '<payload>'` and confirm the payload target is used when no explicit CLI target is provided, while file-backed JSON remains on the authoritative structured path instead of entering runtime-derived reconstruction.
.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/007-session-capturing-pipeline-quality.md:129:  - `generate-context.js` output or capture logs showing results for `M-007a` through `M-007j`.
.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/007-session-capturing-pipeline-quality.md:130:  - `generate-context.js` output or targeted Vitest evidence showing results for `M-007k` through `M-007q`.
...
.opencode/skills/system-spec-kit/scripts/memory/generate-context.ts:27:import { collectSessionData } from '../extractors/collect-session-data';
...
.opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts:1409:    sessionId: capture.sessionId ?? (raw.session_id as string | undefined),
...
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:471:  name: 'task_preflight',
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:477:  name: 'task_postflight',
...
.opencode/skills/system-spec-kit/mcp_server/README.md:682:| `session_id` | string | Session context for co-activation |
.opencode/skills/system-spec-kit/mcp_server/README.md:688:  "tool": "memory_match_triggers",
.opencode/skills/system-spec-kit/mcp_server/README.md:948:##### `task_preflight`
.opencode/skills/system-spec-kit/mcp_server/README.md:950:Capture your starting knowledge before a task. Records how well you understand the domain, how uncertain you are and how much relevant context you have. These scores get compared to `task_postflight` to measure what you learned.
.opencode/skills/system-spec-kit/mcp_server/README.md:964:##### `task_postflight`
...
.opencode/skills/system-spec-kit/mcp_server/README.md:1459:  "tool": "task_preflight",
.opencode/skills/system-spec-kit/mcp_server/README.md:1475:  "tool": "task_postflight",
...
.opencode/skills/system-spec-kit/README.md:95:| **Session Continuity**        | Context preserved across session boundaries via `generate-context.js` and semantic indexing                                                                                                                    |
...
.opencode/skills/system-spec-kit/README.md:157:node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js \
.opencode/skills/system-spec-kit/README.md:262:├── memory/                      # Session context files (via generate-context.js)
.opencode/skills/system-spec-kit/README.md:552:| `generate-context.ts`         | Source for the runtime memory-save entrypoint `scripts/dist/memory/generate-context.js` |
.opencode/skills/system-spec-kit/README.md:562:TypeScript sources compile to `scripts/dist/`. The runtime entry point for memory saves is `scripts/dist/memory/generate-context.js`.
.opencode/skills/system-spec-kit/README.md:630:| `scripts/dist/memory/generate-context.js`                                    | Primary workflow for saving session context to memory                                                |
...
.opencode/skills/system-spec-kit/README.md:655:  └─► generate-context.js writes memory file
.opencode/skills/system-spec-kit/README.md:660:  └─► Startup surface auto-primes OR session_bootstrap() runs once
.opencode/skills/system-spec-kit/README.md:781:# Using the generate-context.js script directly
.opencode/skills/system-spec-kit/README.md:782:node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js \
...
.opencode/skills/system-spec-kit/README.md:878:**What you see**: `generate-context.js` runs but the output file is empty or the script exits with an error.
.opencode/skills/system-spec-kit/README.md:889:node scripts/dist/memory/generate-context.js \
...
.opencode/skills/system-spec-kit/README.md:951:| `generate-context.js` not found  | Run `npm run build` in `system-spec-kit/`                                       |
...
.opencode/skills/system-spec-kit/scripts/types/README.md:137:| **Identity** | `TITLE`, `SESSION_ID`, `CHANNEL`, `SPEC_FOLDER` |
.opencode/skills/system-spec-kit/scripts/types/session-types.ts:177:  // (AI-composed JSON data from generate-context.js input)
.opencode/skills/system-spec-kit/scripts/types/session-types.ts:580:  SESSION_ID: string;
.opencode/skills/system-spec-kit/scripts/types/session-types.ts:643:  SOURCE_SESSION_ID: string;
...
.opencode/skills/system-spec-kit/scripts/tests/collect-session-data.vitest.ts:1:// TEST: collect-session-data — basic unit tests for session status, completion, and collection
.opencode/skills/system-spec-kit/scripts/tests/collect-session-data.vitest.ts:7:} from '../extractors/collect-session-data';
...
.opencode/skills/system-spec-kit/scripts/tests/memory-save-title-description-override.vitest.ts:61:    const { main } = await import('../memory/generate-context');
.opencode/skills/system-spec-kit/scripts/tests/memory-save-title-description-override.vitest.ts:100:    const { main } = await import('../memory/generate-context');
...
.opencode/skills/system-spec-kit/scripts/tests/task-enrichment.vitest.ts:127:    `_sourceSessionId: "${String(data.SOURCE_SESSION_ID ?? '')}"`,
...
.opencode/skills/system-spec-kit/scripts/tests/task-enrichment.vitest.ts:347:    SOURCE_SESSION_ID: '',
...
.opencode/skills/system-spec-kit/scripts/tests/trigger-phrase-no-prose-bigrams.vitest.ts:7:import type { CollectedDataFull } from '../extractors/collect-session-data';
...
.opencode/skills/system-spec-kit/scripts/tests/memory-render-fixture.vitest.ts:125:    SOURCE_SESSION_ID: '',
.opencode/skills/system-spec-kit/scripts/tests/memory-render-fixture.vitest.ts:361:            SOURCE_SESSION_ID: 'session-xyz',
.opencode/skills/system-spec-kit/scripts/tests/memory-render-fixture.vitest.ts:419:        SOURCE_SESSION_ID: '',
...
.opencode/skills/system-spec-kit/scripts/tests/phase-status-from-payload.vitest.ts:3:import { collectSessionData } from '../extractors/collect-session-data';
.opencode/skills/system-spec-kit/scripts/tests/test-template-comprehensive.js:989:    if (contextTemplate.includes('```yaml') && contextTemplate.includes('session_id:')) {
...
.opencode/skills/system-spec-kit/scripts/tests/memory-quality-phase6-extractors.test.ts:13:import { collectSessionData, generateResumeContext, type CollectedDataFull } from '../extractors/collect-session-data';
.opencode/skills/system-spec-kit/scripts/tests/memory-quality-phase6-extractors.test.ts:64:    SESSION_ID: 'phase6-extractor-fixture',
.opencode/skills/system-spec-kit/scripts/tests/memory-quality-phase6-extractors.test.ts:93:    ACTIVE_FILE: '.opencode/skills/system-spec-kit/scripts/extractors/collect-session-data.ts',
.opencode/skills/system-spec-kit/scripts/tests/test-folder-detector-functional.js:109:        session_id TEXT,
...
.opencode/skills/system-spec-kit/scripts/tests/memory-quality-phase2-pr4.test.ts:113:    SESSION_ID: 'phase2-pr4-fixture',
...
.opencode/skills/system-spec-kit/scripts/tests/fixtures/session-data-factory.ts:122:  SOURCE_SESSION_ID: '',
.opencode/skills/system-spec-kit/scripts/tests/memory-quality-phase6-template.test.ts:62:    SOURCE_SESSION_ID: '',
.opencode/skills/system-spec-kit/scripts/tests/memory-quality-phase6-template.test.ts:88:    SESSION_ID: 'phase6-template-fixture',
...
.opencode/skills/system-spec-kit/scripts/tests/post-save-render-round-trip.vitest.ts:87:        'scripts/extractors/collect-session-data.ts:1176 canonical docs now render as relative links.',
.opencode/skills/system-spec-kit/scripts/tests/post-save-render-round-trip.vitest.ts:88:        'scripts/extractors/collect-session-data.ts:1176 canonical docs now render as relative links.',
.opencode/skills/system-spec-kit/scripts/tests/post-save-render-round-trip.vitest.ts:92:        { path: 'scripts/extractors/collect-session-data.ts', description: 'Fixed canonical discovery and counts.' },
.opencode/skills/system-spec-kit/scripts/tests/post-save-render-round-trip.vitest.ts:104:    const { main } = await import('../memory/generate-context');
.opencode/skills/system-spec-kit/scripts/tests/post-save-render-round-trip.vitest.ts:123:    expect(evidence).toContain('scripts/extractors/collect-session-data.ts:1176');
.opencode/skills/system-spec-kit/scripts/tests/post-save-render-round-trip.vitest.ts:124:    expect((evidence.match(/scripts\/extractors\/collect-session-data\.ts:1176/g) ?? []).length).toBe(1);
...
.opencode/skills/system-spec-kit/scripts/tests/test-extractors-loaders.js:260:   4. COLLECT-SESSION-DATA TESTS (P0)
.opencode/skills/system-spec-kit/scripts/tests/test-extractors-loaders.js:265:  log('\n=== COLLECT-SESSION-DATA.JS (P0) ===');
...
.opencode/skills/system-spec-kit/scripts/tests/test-scripts-modules.js:2836:   23. MEDIUM PRIORITY: MEMORY/GENERATE-CONTEXT.JS TESTS
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts | sed -n '980,1145p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/session-bootstrap.ts | sed -n '1,260p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts | sed -n '1,320p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts | sed -n '1500,1605p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts | sed -n '184,260p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/scripts/core/workflow.ts | sed -n '1400,1485p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc 'cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && rg -n "session_bootstrap|session_resume|memory_context|memory_match_triggers|task_preflight|task_postflight" .opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts .opencode/skills/system-spec-kit/mcp_server/schemas/tool-input-schemas.ts -S' in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
.opencode/skills/system-spec-kit/mcp_server/schemas/tool-input-schemas.ts:397:  memory_context: memoryContextSchema as unknown as ToolInputSchema,
.opencode/skills/system-spec-kit/mcp_server/schemas/tool-input-schemas.ts:400:  memory_match_triggers: memoryMatchTriggersSchema as unknown as ToolInputSchema,
.opencode/skills/system-spec-kit/mcp_server/schemas/tool-input-schemas.ts:413:  task_preflight: taskPreflightSchema as unknown as ToolInputSchema,
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/mcp_server/schemas/tool-input-schemas.ts | sed -n '440,505p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/scripts/memory/generate-context.ts | sed -n '1,220p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ---------------------------------------------------------------
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/scripts/extractors/collect-session-data.ts | sed -n '1,260p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/scripts/extractors/collect-session-data.ts | sed -n '600,780p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts | sed -n '730,780p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
   730	
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts | sed -n '35,70p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
    35	
    36	// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts | sed -n '205,225p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
   205	    },
   206	    required: ['query'],
   207	  },
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts | sed -n '320,520p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
   320	      'freshness',
   321	      'unknown_scope',
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts | sed -n '520,760p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
   520	      key: 'cached-continuity',
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts | sed -n '820,870p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
   820	
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts | sed -n '1328,1365p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts | sed -n '1428,1445p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/session-learning.ts | sed -n '300,460p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/scripts/extractors/collect-session-data.ts | sed -n '980,1035p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && rg -n \"runWorkflow\\(|collectSessionData\\(|loadCollectedData\\(|sessionId\" .opencode/skills/system-spec-kit/scripts/memory/generate-context.ts -S" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
35:  sessionId: string | null;
386:    sessionId: null,
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/scripts/memory/generate-context.ts | sed -n '300,420p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
   300	
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/scripts/memory/generate-context.ts | sed -n '540,590p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/scripts/core/workflow.ts | sed -n '1510,1545p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc 'cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && rg -n "buildContinueSessionData|SESSION_STATUS|CONTEXT_SUMMARY|RESUME_CONTEXT|SOURCE_SESSION_ID|SESSION_ID" .opencode/skills/system-spec-kit/scripts/core/workflow.ts -S' in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
1426:      sessionId: sessionData.SESSION_ID,
1428:      sourceSessionId: sessionData.SOURCE_SESSION_ID,
1443:    sessionId: sessionData.SESSION_ID,
...
exec
/bin/zsh -lc "cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && nl -ba .opencode/skills/system-spec-kit/scripts/core/workflow.ts | sed -n '1368,1450p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
- **Source**: [tool-schemas.ts](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts#L42), [tool-schemas.ts](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts#L210), [tool-schemas.ts](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts#L739), [handlers/session-resume.ts](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts#L191), [handlers/session-bootstrap.ts](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/handlers/session-bootstrap.ts#L163), [handlers/memory-context.ts](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts#L821), [handlers/memory-triggers.ts](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts#L207)
...
- [external/src/types.ts](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/999-hybrid-rag-fusion-upgrade/001-research-hybrid-rag-fusion-systems/002-mex-main/external/src/types.ts)
- [mcp_server/tool-schemas.ts](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts)
- [mcp_server/schemas/tool-input-schemas.ts](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/schemas/tool-input-schemas.ts)
...
- [mcp_server/handlers/session-learning.ts](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/handlers/session-learning.ts)
...
- [scripts/extractors/collect-session-data.ts](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/scripts/extractors/collect-session-data.ts)

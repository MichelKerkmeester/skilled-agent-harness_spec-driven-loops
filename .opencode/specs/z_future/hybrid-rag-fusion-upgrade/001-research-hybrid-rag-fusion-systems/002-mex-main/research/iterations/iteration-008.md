...
exec
/bin/zsh -lc "rg -n \"memory_search|memory_context|memory_match_triggers|code_graph_query|code_graph_context|session_bootstrap|CocoIndex|cocoindex|mcp__cocoindex_code__search\" .opencode/skills/system-spec-kit -g '"'!**/dist/**'"'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:9:import { isCocoIndexAvailable } from '../lib/utils/cocoindex-path.js';
.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:101:interface CocoIndexStatus {
.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:109:  cocoIndex: CocoIndexStatus;
...
.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:463:  const cocoIndex: CocoIndexStatus = {
.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:464:    available: isCocoIndexAvailable(),
.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:468:    hints.push('CocoIndex not installed. Install: `bash .opencode/skills/mcp-coco-index/scripts/install.sh`');
...
.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:541:      title: 'CocoIndex Status',
.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:566:      { label: 'cocoindex', certainty: cocoIndexCertainty },
.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:575:      sourceRefs: ['memory-context', 'code-graph-db', 'cocoindex-path', 'session-snapshot'],
...
.opencode/skills/system-spec-kit/SKILL.md:770:| `code_graph_context` | LLM-oriented compact graph neighborhoods (neighborhood/outline/impact modes) |
.opencode/skills/system-spec-kit/SKILL.md:772:**Architecture:** CocoIndex (semantic, external MCP) finds code by concept. Code Graph (structural, this system) maps imports, calls, hierarchy. Memory (session, existing MCP) preserves decisions. The compact-merger combines all three under a 4000-token budget for compaction injection.
...
.opencode/skills/system-spec-kit/SKILL.md:786:**CocoIndex seed bridge:** CocoIndex search results (file + line range) are accepted as seeds by `code_graph_context`, which resolves them to graph nodes and expands structurally. This combines "what resembles what" (CocoIndex) with "what connects to what" (Code Graph).
.opencode/skills/system-spec-kit/SKILL.md:788:**CCC tools** (CocoIndex lifecycle):
.opencode/skills/system-spec-kit/SKILL.md:792:| `ccc_status` | Check CocoIndex availability and index status |
.opencode/skills/system-spec-kit/SKILL.md:793:| `ccc_reindex` | Trigger incremental or full CocoIndex re-indexing |
.opencode/skills/system-spec-kit/SKILL.md:801:| `session_resume` | Combined memory + code graph + CocoIndex resume in one call |
...
.opencode/skills/system-spec-kit/constitutional/README.md:60:| **Always Surfaces** | Included at top of every `memory_search` result by default |
.opencode/skills/system-spec-kit/constitutional/README.md:133:3. **Verify** with `memory_search({ query: "anything" })`. Check for `isConstitutional: true`
.opencode/skills/system-spec-kit/constitutional/README.md:148:├── gate-tool-routing.md   # Search and retrieval routing rules for memory, graph, and CocoIndex
.opencode/skills/system-spec-kit/constitutional/README.md:165:| `gate-tool-routing.md` | Recommended | Search and retrieval routing rules for memory, graph, and CocoIndex |
.opencode/skills/system-spec-kit/constitutional/README.md:178:Constitutional memories are **automatically included** at the top of every `memory_search()` result.
.opencode/skills/system-spec-kit/constitutional/README.md:184:memory_search({ query: "authentication flow" })
.opencode/skills/system-spec-kit/constitutional/README.md:196:memory_search({ 
.opencode/skills/system-spec-kit/constitutional/README.md:229:> **Implemented (v1.7.2):** ANCHOR tags are now fully indexed and support section-level retrieval. Use the `anchors` parameter in `memory_search()` to retrieve specific sections with 58-90% token savings.
.opencode/skills/system-spec-kit/constitutional/README.md:398:memory_search({ query: "test" })
.opencode/skills/system-spec-kit/constitutional/README.md:559:memory_search({ 
.opencode/skills/system-spec-kit/constitutional/README.md:672:**Symptom:** `memory_match_triggers()` doesn't return your memory
.opencode/skills/system-spec-kit/constitutional/README.md:705:memory_match_triggers({ prompt: "fix the bug" })
...
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/README.md:12:| `context.ts` | `code_graph_context` | LLM-oriented compact graph neighborhoods |
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/ccc-reindex.ts:2:// MODULE: CocoIndex Re-index Handler
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/ccc-reindex.ts:26:            error: 'CocoIndex binary not found. Install: bash .opencode/skills/mcp-coco-index/scripts/install.sh',
.opencode/skills/system-spec-kit/constitutional/gate-tool-routing.md:25:  - CocoIndex
.opencode/skills/system-spec-kit/constitutional/gate-tool-routing.md:27:  - memory_search
.opencode/skills/system-spec-kit/constitutional/gate-tool-routing.md:28:  - memory_context
.opencode/skills/system-spec-kit/constitutional/gate-tool-routing.md:39:| **Semantic/concept** (meaning-based) | `mcp__cocoindex_code__search` (CocoIndex) | `memory_search` |
.opencode/skills/system-spec-kit/constitutional/gate-tool-routing.md:40:| **Structural** (callers, imports, deps) | `code_graph_query` (Code Graph) | `Grep` / `Glob` |
.opencode/skills/system-spec-kit/constitutional/gate-tool-routing.md:47:| **Memory/context** (prior work, decisions) | `memory_search` / `memory_context` | `memory_match_triggers` |
.opencode/skills/system-spec-kit/constitutional/gate-tool-routing.md:48:| **Broad topic** (thematic overview) | `memory_search` with `retrievalLevel: "global"` | community search fallback |
...
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:4:// MCP tool handler for code_graph_context — LLM-oriented graph neighborhoods.
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:56:    filePath: seed.provider === 'cocoindex'
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:59:    startLine: seed.provider === 'cocoindex' ? seed.range?.start : seed.startLine,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:60:    endLine: seed.provider === 'cocoindex' ? seed.range?.end : seed.endLine,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:87:/** Handle code_graph_context tool call */
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:116:      if (seed.provider === 'cocoindex' && seed.file) {
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:118:          provider: 'cocoindex' as const,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:204:          error: 'code_graph_context failed',
...
.opencode/skills/system-spec-kit/mcp_server/tools/code-graph-tools.ts:22:  'code_graph_context',
.opencode/skills/system-spec-kit/mcp_server/tools/code-graph-tools.ts:60:    case 'code_graph_query': {
.opencode/skills/system-spec-kit/mcp_server/tools/code-graph-tools.ts:69:    case 'code_graph_context':
...
.opencode/skills/system-spec-kit/ARCHITECTURE.md:29:- [10. HOOK + CODE GRAPH + COCOINDEX ARCHITECTURE](#10--hook--code-graph--cocoindex-architecture)
.opencode/skills/system-spec-kit/ARCHITECTURE.md:437:<!-- ANCHOR:hook-code-graph-cocoindex -->
.opencode/skills/system-spec-kit/ARCHITECTURE.md:442:Three subsystems collaborate to provide intelligent context across session boundaries: **startup/recovery surfaces** deliver runtime-specific startup context, **Code Graph** provides structural code intelligence, and **CocoIndex** enables semantic discovery. A **Compact Merger** still unifies structural, semantic, and memory-oriented signals for bounded payload construction, but startup delivery is now runtime-specific rather than Claude-only.
.opencode/skills/system-spec-kit/ARCHITECTURE.md:458:        codex["Codex bootstrap parity<br/>session_bootstrap() MCP tool"]
.opencode/skills/system-spec-kit/ARCHITECTURE.md:481:    subgraph COCOINDEX["CocoIndex Layer"]
.opencode/skills/system-spec-kit/ARCHITECTURE.md:483:        semantic["Semantic Search<br/>mcp__cocoindex_code__search"]
.opencode/skills/system-spec-kit/ARCHITECTURE.md:525:| `seed-resolver.ts` | `lib/code-graph/` | CocoIndex results to graph node resolution |
.opencode/skills/system-spec-kit/ARCHITECTURE.md:539:    "CocoIndex (900)" : 900
.opencode/skills/system-spec-kit/ARCHITECTURE.md:548:| CocoIndex | 900 | Semantic search results, related code |
.opencode/skills/system-spec-kit/ARCHITECTURE.md:559:| Semantic discovery (find by meaning/concept) | CocoIndex | `mcp__cocoindex_code__search` |
.opencode/skills/system-spec-kit/ARCHITECTURE.md:560:| Structural navigation (call graph, dependencies) | Code Graph | `code_graph_query` / `code_graph_context` |
.opencode/skills/system-spec-kit/ARCHITECTURE.md:561:| Startup or recovery state | Session surfaces | `session_bootstrap` / `session_resume` / startup surface |
.opencode/skills/system-spec-kit/ARCHITECTURE.md:562:| Session continuity (prior work, decisions) | Memory | `memory_search` / `memory_context` |
.opencode/skills/system-spec-kit/ARCHITECTURE.md:564:<!-- /ANCHOR:hook-code-graph-cocoindex -->
.opencode/skills/system-spec-kit/mcp_server/lib/session/README.md:93:1. User queries memory_search
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/ccc-feedback.ts:2:// MODULE: CocoIndex Feedback Handler
.opencode/skills/system-spec-kit/mcp_server/lib/session/session-snapshot.ts:12:import { isCocoIndexAvailable } from '../utils/cocoindex-path.js';
...
.opencode/skills/system-spec-kit/mcp_server/lib/session/session-snapshot.ts:155:  // CocoIndex availability
...
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/ccc-status.ts:2:// MODULE: CocoIndex Status Handler
...
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/ccc-status.ts:14:    const indexDir = resolve(projectRoot, '.cocoindex_code');
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/ccc-status.ts:36:              ? 'Install CocoIndex: bash .opencode/skills/mcp-coco-index/scripts/install.sh'
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/ccc-status.ts:39:                : 'CocoIndex is ready. Use mcp__cocoindex_code__search for semantic queries.',
...
.opencode/skills/system-spec-kit/mcp_server/handlers/README.md:47:- `code-graph/context.ts` - `code_graph_context`: LLM-oriented compact graph neighborhoods.
.opencode/skills/system-spec-kit/mcp_server/lib/utils/cocoindex-path.ts:2:// MODULE: CocoIndex Path Helper
.opencode/skills/system-spec-kit/mcp_server/lib/utils/cocoindex-path.ts:4:// F046/F051: Shared helper for resolving the CocoIndex binary path.
.opencode/skills/system-spec-kit/mcp_server/lib/utils/cocoindex-path.ts:12:/** Relative path from project root to the CocoIndex CLI binary. */
.opencode/skills/system-spec-kit/mcp_server/lib/utils/cocoindex-path.ts:48: * Get the absolute path to the CocoIndex binary.
.opencode/skills/system-spec-kit/mcp_server/lib/utils/cocoindex-path.ts:51:export function getCocoIndexBinaryPath(): string {
.opencode/skills/system-spec-kit/mcp_server/lib/utils/cocoindex-path.ts:56: * Check whether the CocoIndex binary exists on disk.
.opencode/skills/system-spec-kit/mcp_server/lib/utils/cocoindex-path.ts:58:export function isCocoIndexAvailable(): boolean {
.opencode/skills/system-spec-kit/mcp_server/lib/utils/cocoindex-path.ts:59:  return existsSync(getCocoIndexBinaryPath());
...
.opencode/skills/system-spec-kit/mcp_server/tests/startup-brief.vitest.ts:44:vi.mock('../lib/utils/cocoindex-path.js', () => ({
.opencode/skills/system-spec-kit/mcp_server/tests/startup-brief.vitest.ts:45:  isCocoIndexAvailable: vi.fn(() => false),
.opencode/skills/system-spec-kit/mcp_server/tests/startup-brief.vitest.ts:52:import * as cocoIndexPath from '../lib/utils/cocoindex-path.js';
.opencode/skills/system-spec-kit/mcp_server/tests/startup-brief.vitest.ts:72:    expect(brief.startupSurface).toContain('- CocoIndex: missing');
.opencode/skills/system-spec-kit/mcp_server/tests/startup-brief.vitest.ts:114:  it('reports cocoindex as available when the binary exists', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/startup-brief.vitest.ts:115:    vi.mocked(cocoIndexPath.isCocoIndexAvailable).mockReturnValueOnce(true);
.opencode/skills/system-spec-kit/mcp_server/tests/startup-brief.vitest.ts:118:    expect(brief.startupSurface).toContain('- CocoIndex: available');
.opencode/skills/system-spec-kit/mcp_server/tests/startup-brief.vitest.ts:124:    expect(brief.graphOutline).toContain('CocoIndex');
...
.opencode/skills/system-spec-kit/feature_catalog/feature_catalog.md:4686:This category tracks the compact-code-graph rollout: hook lifecycle capture, hookless priming, code-graph retrieval, CocoIndex bridging, and routing enforcement surfaces that preserve context across long-running sessions.
...
.opencode/skills/system-spec-kit/references/config/hook_system.md:57:3. `session_bootstrap()` / `session_resume()` — Session-oriented wrappers that layer health and structural context around resume retrieval
...
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/23-tool-routing-enforcement.md:29:| `mcp_server/hooks/memory-surface.ts` | Hook | PrimePackage.routingRules with CocoIndex/Code Graph directives |
...
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/09-cocoindex-bridge-context.md:2:title: "CocoIndex bridge and code_graph_context"
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/09-cocoindex-bridge-context.md:3:description: "CocoIndex bridge resolves semantic search results to code graph nodes and expands into LLM-oriented neighborhoods."
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/09-cocoindex-bridge-context.md:6:# CocoIndex bridge and code_graph_context
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/09-cocoindex-bridge-context.md:10:CocoIndex bridge resolves semantic search results to code graph nodes and expands into LLM-oriented neighborhoods.
...
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/09-cocoindex-bridge-context.md:28:| `mcp_server/lib/code-graph/seed-resolver.ts` | Lib | Resolves CocoIndex file-range hits to graph anchors or file-level fallbacks |
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/09-cocoindex-bridge-context.md:30:| `mcp_server/handlers/code-graph/context.ts` | Handler | Exposes `code_graph_context` over MCP |
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/09-cocoindex-bridge-context.md:43:- Source feature title: CocoIndex bridge and code_graph_context
...
.opencode/skills/system-spec-kit/references/memory/memory_system.md:104:| L1: Orchestration | `session_resume()` | Resume memory, code graph, and CocoIndex state in one call | Detailed recovery payload after reconnect, or when you want direct merged resume state |
.opencode/skills/system-spec-kit/references/memory/memory_system.md:105:| L1: Orchestration | `session_bootstrap()` | Composite bootstrap combining resume and health checks | Canonical first tool call in a fresh OpenCode-style session or after `/clear` |
...
.opencode/skills/system-spec-kit/references/memory/memory_system.md:134:| L6: Analysis | `code_graph_query()` | Query structural relationships such as callers, imports, and outlines | Find what calls a symbol or which files import a module |
.opencode/skills/system-spec-kit/references/memory/memory_system.md:135:| L6: Analysis | `code_graph_context()` | Expand CocoIndex or symbol seeds into compact graph neighborhoods | Pull structural context for an LLM prompt |
.opencode/skills/system-spec-kit/references/memory/memory_system.md:143:| L7: Maintenance | `ccc_status()` | Report CocoIndex availability and index health | Confirm semantic code search is ready |
.opencode/skills/system-spec-kit/references/memory/memory_system.md:144:| L7: Maintenance | `ccc_reindex()` | Trigger incremental or full CocoIndex re-indexing | Refresh semantic search after a refactor |
.opencode/skills/system-spec-kit/references/memory/memory_system.md:145:| L7: Maintenance | `ccc_feedback()` | Submit search-quality feedback for CocoIndex results | Record whether semantic hits were helpful |
...
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/01-category-overview.md:3:description: "Category covering Claude Code hooks (PreCompact, SessionStart, Stop), structural code graph (indexer, SQLite, MCP tools), CocoIndex bridge, and compaction working-set integration."
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/01-category-overview.md:10:Category covering runtime hook automation, structural code graph (indexer, SQLite, MCP tools), CocoIndex bridge, and compaction working-set integration.
...
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/01-category-overview.md:36:| `mcp_server/handlers/session-resume.ts` | Handler | Composite resume (memory + graph + CocoIndex) |
...
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/18-session-resume-tool.md:3:description: "Composite MCP tool (session_resume) that merges memory resume context, code graph status, CocoIndex availability, and structural bootstrap hints into a detailed recovery payload."
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/18-session-resume-tool.md:10:Composite MCP tool (session_resume) that merges memory resume context, code graph status, CocoIndex availability, and structural bootstrap hints into a single recovery payload.
...
.opencode/skills/system-spec-kit/templates/context_template.md:307:| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "{{SPEC_FOLDER}}" })` |
.opencode/skills/system-spec-kit/templates/context_template.md:319:memory_search({ specFolder: "{{SPEC_FOLDER}}", limit: 10 })
.opencode/skills/system-spec-kit/templates/context_template.md:325:memory_search({ query: "orphaned", anchors: ["state"] })
.opencode/skills/system-spec-kit/templates/context_template.md:338:2. **Load memory context** - Use memory_search to surface prior work
...
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/12-compact-merger.md:3:description: "Compact merger combines context from Memory, Code Graph, and CocoIndex into a unified compact brief within the 4000-token budget."
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/12-compact-merger.md:10:Compact merger combines context from Memory, Code Graph, and CocoIndex into a unified compact brief within the 4000-token budget.
...
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/08-code-graph-storage-query.md:30:| `mcp_server/handlers/code-graph/query.ts` | Handler | Implements `code_graph_query` for callers, imports, and outlines |
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/08-code-graph-storage-query.md:32:| `mcp_server/handlers/code-graph/context.ts` | Handler | Implements `code_graph_context` for compact structural neighborhoods |
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/14-query-intent-classifier.md:3:description: "Heuristic pre-classifier that routes queries to the optimal retrieval backend: structural (code graph), semantic (CocoIndex), or hybrid (both)."
.opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph/14-query-intent-classifier.md:10:Heuristic pre-classifier that routes queries to the optimal retrieval backend: structural (code graph), semantic (CocoIndex), or hybrid (both).
...
.opencode/skills/system-spec-kit/mcp_server/tests/structural-contract.vitest.ts:27:  vi.doMock('../lib/utils/cocoindex-path.js', () => ({
.opencode/skills/system-spec-kit/mcp_server/tests/structural-contract.vitest.ts:28:    isCocoIndexAvailable: vi.fn(() => false),
...
.opencode/skills/system-spec-kit/mcp_server/lib/architecture/layer-definitions.ts:105:      'code_graph_context'
...
.opencode/skills/system-spec-kit/mcp_server/hooks/memory-surface.ts:5:import { isCocoIndexAvailable } from '../lib/utils/cocoindex-path.js';
...
.opencode/skills/system-spec-kit/mcp_server/hooks/memory-surface.ts:451:  // F046: CocoIndex availability via shared helper (no process.cwd())
...
.opencode/skills/system-spec-kit/mcp_server/hooks/memory-surface.ts:468:    toolRoutingRules.push('semantic/concept queries → mcp__cocoindex_code__search');
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/README.md:12:| `seed-resolver.ts` | Resolves CocoIndex file:line results to graph nodes |
...
.opencode/skills/system-spec-kit/mcp_server/tests/graph-payload-validator.vitest.ts:166:    vi.doMock('../lib/utils/cocoindex-path.js', () => ({
.opencode/skills/system-spec-kit/mcp_server/tests/graph-payload-validator.vitest.ts:167:      isCocoIndexAvailable: vi.fn(() => true),
...
.opencode/skills/system-spec-kit/mcp_server/hooks/claude/session-prime.ts:98:    '- CocoIndex: unknown',
...
.opencode/skills/system-spec-kit/mcp_server/tests/budget-allocator.vitest.ts:34:      // CocoIndex and triggered are empty, their floors + overflow go to others
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:4:// LLM-oriented compact graph neighborhoods with CocoIndex seed support.
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:5:// Provides the code_graph_context MCP tool implementation.
...
.opencode/skills/system-spec-kit/mcp_server/tests/dual-scope-hooks.vitest.ts:784:    // cocoIndex and triggered were empty — their section sources ('cocoindex', 'memory') should not
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/startup-brief.ts:10:import { isCocoIndexAvailable } from '../utils/cocoindex-path.js';
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/startup-brief.ts:124:    `- CocoIndex: ${args.cocoIndexAvailable ? 'available' : 'missing'}`,
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/startup-brief.ts:199:  const cocoIndexAvailable = isCocoIndexAvailable();
...
.opencode/skills/system-spec-kit/mcp_server/tests/context-server.vitest.ts:195:      'code_graph_context',
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/compact-merger.ts:4:// Merges context from multiple sources (Memory, Code Graph, CocoIndex, Session)
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/compact-merger.ts:18:  cocoIndex: string;         // Semantic neighbors (from CocoIndex)
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/compact-merger.ts:172:  pushSection(input.cocoIndex, 'cocoIndex', 'Semantic Neighbors', 'cocoindex');
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/compact-merger.ts:199:          : section.source === 'cocoindex'
.opencode/skills/system-spec-kit/mcp_server/hooks/claude/compact-inject.ts:6:// using the 3-source merge pipeline (Memory, Code Graph, CocoIndex)
.opencode/skills/system-spec-kit/mcp_server/hooks/claude/compact-inject.ts:146:  // Hint for AI to use CocoIndex for semantic neighbors after recovery
.opencode/skills/system-spec-kit/mcp_server/hooks/claude/compact-inject.ts:148:    sections.push('## Semantic Context (CocoIndex)\nUse `mcp__cocoindex_code__search` to find semantic neighbors of active files listed above.');
.opencode/skills/system-spec-kit/mcp_server/hooks/claude/compact-inject.ts:224:    ? 'Use `mcp__cocoindex_code__search` to find semantic neighbors of active files listed above.'
.opencode/skills/system-spec-kit/mcp_server/hooks/claude/compact-inject.ts:360:      ? 'Use `mcp__cocoindex_code__search` to find semantic neighbors of active files listed above.'
...
.opencode/skills/system-spec-kit/scripts/tests/trigger-phrase-sanitizer.vitest.ts:24:    expect(sanitizeTriggerPhrase('phase 7 cocoindex')).toEqual({ keep: false, reason: 'suspicious_prefix' });
...
.opencode/skills/system-spec-kit/mcp_server/hooks/copilot/session-prime.ts:35:    '- CocoIndex: unknown',
.opencode/skills/system-spec-kit/mcp_server/tests/opencode-plugin.vitest.ts:145:          tool: 'session_bootstrap',
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:4:// Resolves CocoIndex search results (file:line) to code graph nodes.
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:10:/** A seed from CocoIndex or other providers */
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:18:/** Native CocoIndex search result as a seed */
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:19:export interface CocoIndexSeed {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:20:  provider: 'cocoindex';
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:43:export type AnySeed = CodeGraphSeed | CocoIndexSeed | ManualSeed | GraphSeed;
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:66:function isCocoIndexSeed(seed: unknown): seed is CocoIndexSeed {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:67:  return hasProvider(seed, 'cocoindex');
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:86:/** Resolve a CocoIndex seed by converting to CodeGraphSeed and delegating */
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:87:export function resolveCocoIndexSeed(seed: CocoIndexSeed): ArtifactRef {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:268:  if (isCocoIndexSeed(seed)) return resolveCocoIndexSeed(seed);
...
.opencode/skills/system-spec-kit/mcp_server/hooks/gemini/session-prime.ts:98:        '- CocoIndex: unknown',
...
.opencode/skills/system-spec-kit/mcp_server/tests/shared-payload-certainty.vitest.ts:99:    vi.doMock('../lib/utils/cocoindex-path.js', () => ({
.opencode/skills/system-spec-kit/mcp_server/tests/shared-payload-certainty.vitest.ts:100:      isCocoIndexAvailable: vi.fn(() => true),
...
.opencode/skills/system-spec-kit/mcp_server/tests/shared-payload-certainty.vitest.ts:139:    expect(parsed.data.payloadContract.summary).toContain('cocoindex=exact');
...
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:663:  name: 'code_graph_context',
...
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:680:            provider: { type: 'string', enum: ['cocoindex', 'manual', 'graph'], description: 'Seed provider type' },
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:681:            file: { type: 'string', description: 'CocoIndex file path (provider: cocoindex)' },
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:682:            range: { type: 'object', properties: { start: { type: 'number' }, end: { type: 'number' } }, description: 'CocoIndex line range' },
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:683:            score: { type: 'number', description: 'CocoIndex relevance score' },
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:688:        description: 'Seeds from CocoIndex, manual input, or graph lookups',
...
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:706:  description: '[L7:Maintenance] Trigger CocoIndex incremental (or full) re-indexing of the workspace.',
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:718:  description: '[L7:Maintenance] Submit quality feedback on CocoIndex search results to improve future searches.',
...
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:927:  // L8: CocoIndex
...
.opencode/skills/system-spec-kit/scripts/tests/warm-start-bundle-benchmark.vitest.ts.test.ts:26:        'R4 nudges structural follow-up toward code_graph_query when graph readiness is high.',
.opencode/skills/system-spec-kit/scripts/tests/warm-start-bundle-benchmark.vitest.ts.test.ts:45:      liveBaselineResolution: 'code_graph_query',
...
.opencode/skills/system-spec-kit/mcp_server/INSTALL_GUIDE.md:435:- `code_graph_context` (LLM-oriented graph neighborhoods)
...
.opencode/skills/system-spec-kit/mcp_server/README.md:55:| **MCP tools** | 47 | Organized across core memory layers plus dedicated code-graph and CocoIndex dispatch groups |
.opencode/skills/system-spec-kit/mcp_server/README.md:56:| **Search channels** | 5 core + CocoIndex bridge | Vector, FTS5, BM25, Causal Graph, Degree (+ CocoIndex semantic code search as external bridge) |
...
.opencode/skills/system-spec-kit/mcp_server/README.md:1075:##### `code_graph_context`
...
.opencode/skills/system-spec-kit/mcp_server/README.md:1084:| `seeds` | array | Seeds from CocoIndex, manual input or graph lookups |
.opencode/skills/system-spec-kit/mcp_server/README.md:1177:Check CocoIndex availability, binary path and index status.
.opencode/skills/system-spec-kit/mcp_server/README.md:1181:| _(none required)_ |  | Returns CocoIndex health |
.opencode/skills/system-spec-kit/mcp_server/README.md:1187:Trigger CocoIndex incremental or full re-indexing of the workspace.
.opencode/skills/system-spec-kit/mcp_server/README.md:1197:Submit quality feedback on CocoIndex search results to improve future searches.
...
.opencode/skills/system-spec-kit/shared/README.md:300:| Technical Terms | 2.5x  | "generateContext", "memory_search"    |
...
.opencode/skills/system-spec-kit/manual_testing_playbook/manual_testing_playbook.md:252:### EX-001 | Unified context retrieval (memory_context)
.opencode/skills/system-spec-kit/manual_testing_playbook/manual_testing_playbook.md:258:Prompt: `Use memory_context in resume mode for: fix flaky index scan retry logic. Reuse a real sessionId with prompt-context history. Capture the evidence needed to prove Relevant bounded context returned; auto-resume systemPromptContext is injected before budget enforcement; final response stays within the advertised token budget. Return a concise user-facing pass/fail verdict with the main reason.`
.opencode/skills/system-spec-kit/manual_testing_playbook/manual_testing_playbook.md:266:### EX-002 | Semantic and lexical search (memory_search)
.opencode/skills/system-spec-kit/manual_testing_playbook/manual_testing_playbook.md:276:Additional audit scenario: `Run memory_search against a fixture set that contains one expired memory, one live memory, and enough constitutional rows to overflow a tiny limit. Capture the evidence needed to prove multi-concept search excludes the expired row, constitutional injection never returns more than the requested limit, and malformed embeddings fail with a clear validation-style error instead of a raw sqlite-vec exception. Return a concise user-facing pass/fail verdict with the main reason.`
.opencode/skills/system-spec-kit/manual_testing_playbook/manual_testing_playbook.md:284:### EX-003 | Trigger phrase matching (memory_match_triggers)
...
.opencode/skills/system-spec-kit/manual_testing_playbook/19--feature-flag-reference/032-5-embedding-and-api.md:29:| EX-032 | 5. Embedding and API | Provider selection audit | `Retrieve embedding provider selection rules. Capture the evidence needed to prove Provider rules and key precedence shown. Return a concise user-facing pass/fail verdict with the main reason.` | `memory_search({ query:"EMBEDDINGS_PROVIDER auto provider selection rules", limit:20 })` | Provider rules and key precedence shown | Search output | PASS if provider routing is clear | Verify env in runtime |
.opencode/skills/system-spec-kit/manual_testing_playbook/19--feature-flag-reference/033-6-debug-and-telemetry.md:29:| EX-033 | 6. Debug and Telemetry | Observability toggle check | `List telemetry/debug vars and separate opt-in flags from inert flags. Capture the evidence needed to prove Debug/telemetry controls identified. Return a concise user-facing pass/fail verdict with the main reason.` | `memory_search({ query:"DEBUG_TRIGGER_MATCHER telemetry opt-in inert flags", limit:20 })` | Debug/telemetry controls identified | Search output | PASS if opt-in vs inert controls are clearly separated | Check feature flag governance section |
.opencode/skills/system-spec-kit/shared/algorithms/README.md:124:- **Consumers**: MCP server retrieval pipeline, `memory_search` and `memory_match_triggers` endpoints
.opencode/skills/system-spec-kit/manual_testing_playbook/19--feature-flag-reference/028-1-search-pipeline-features-speckit.md:29:| EX-028 | 1. Search Pipeline Features (SPECKIT_*) | Flag catalog verification with inert and retired surface cleanup | `List SPECKIT search-pipeline flags as active, inert compatibility shims, or retired. Capture the evidence needed to prove active flags stay separated from inert compatibility shims such as SPECKIT_RSF_FUSION and SPECKIT_SHADOW_SCORING, and that retired topics such as full-context ceiling eval, index refresh, context budget, PageRank, and entity scope are not presented as active manual-test scenarios. Return a concise user-facing pass/fail verdict with the main reason.` | `memory_search({ query: "SPECKIT search pipeline flags active inert retired RSF shadow scoring", limit: 20 })` -> `memory_context({ input: "Classify live search-pipeline flags versus inert compatibility shims and retired topics", mode: "deep", sessionId: "ex028" })` | Accurate active/inert/retired classification; retired topics absent from active manual-test guidance | Search/context outputs + catalog cross-check notes | PASS if classifications are internally consistent and retired topics are not framed as active checks | Validate against code/config docs; remove any manual-test wording that still treats retired topics as live search-pipeline behavior |
.opencode/skills/system-spec-kit/shared/trigger-extractor.ts:4:// Feature catalog: Trigger phrase matching (memory_match_triggers)
.opencode/skills/system-spec-kit/manual_testing_playbook/19--feature-flag-reference/034-7-ci-and-build-informational.md:29:| EX-034 | 7. CI and Build (informational) | Branch metadata source audit | `Find branch env vars used in checkpoint metadata. Capture the evidence needed to prove Branch source vars surfaced. Return a concise user-facing pass/fail verdict with the main reason.` | `memory_search({ query:"GIT_BRANCH BRANCH_NAME checkpoint metadata", limit:20 })` | Branch source vars surfaced | Search output | PASS if all listed vars are found | Search CI scripts and runtime helpers |
.opencode/skills/system-spec-kit/manual_testing_playbook/01--retrieval/142-session-transition-trace-contract.md:3:description: "This scenario validates Session transition trace contract for `142`. It focuses on Verify `memory_context` emits trace-only session transitions with no non-trace leakage."
.opencode/skills/system-spec-kit/manual_testing_playbook/01--retrieval/142-session-transition-trace-contract.md:10:This scenario validates Session transition trace contract for `142`. It focuses on Verify `memory_context` emits trace-only session transitions with no non-trace leakage.
.opencode/skills/system-spec-kit/manual_testing_playbook/01--retrieval/142-session-transition-trace-contract.md:18:- Objective: Verify `memory_context` emits trace-only session transitions with no non-trace leakage
.opencode/skills/system-spec-kit/manual_testing_playbook/01--retrieval/142-session-transition-trace-contract.md:19:- Prompt: `Validate Markovian session transition tracing for memory_context. Capture the evidence needed to prove Trace-enabled responses include spec-shaped sessionTransition; non-trace responses omit it entirely; no top-level metadata leak appears when trace is disabled. Return a concise user-facing pass/fail verdict with the main reason.`
...
.opencode/skills/system-spec-kit/manual_testing_playbook/01--retrieval/002-targeted-memory-lookup.md:24:  - `memory_search({query:"<decision rationale>", specFolder:"specs/<target-spec>", anchors:["decision-record","rationale"]})`
...
.opencode/skills/system-spec-kit/scripts/tests/session-cached-consumer.vitest.ts.test.ts:300:    vi.doMock('../../mcp_server/lib/utils/cocoindex-path.js', () => ({
.opencode/skills/system-spec-kit/scripts/tests/session-cached-consumer.vitest.ts.test.ts:301:      isCocoIndexAvailable: vi.fn(() => true),
...
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/250-session-start-startup.md:25:  - Body mentions `memory_context`, `memory_match_triggers`, `memory_search`
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/250-session-start-startup.md:26:  - Body mentions `code_graph_scan`, `code_graph_query`, `code_graph_context`, `code_graph_status`
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/250-session-start-startup.md:27:  - CocoIndex status line shows either "available" or "not installed" based on `.opencode/skills/mcp-coco-index/mcp_server/.venv/bin/ccc` existence
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/250-session-start-startup.md:28:  - Resume instruction: `memory_context({ input: "resume previous work", mode: "resume", profile: "resume" })`
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/250-session-start-startup.md:31:  - PASS: All tool references present in stdout, CocoIndex status accurate, output within budget
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/250-session-start-startup.md:32:  - FAIL: Missing tool references, incorrect CocoIndex status, or output exceeds 2000 tokens
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/250-session-start-startup.md:40:| 250a | SessionStart priming (startup) | Fresh startup outputs Spec Kit Memory tool overview | `Validate 250a startup tool listing` | `cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run tests/hook-session-start.vitest.ts` | Stdout "Session Priming" section lists `memory_context`, `memory_match_triggers`, `memory_search`, code graph tools | Test output showing tool names in stdout | PASS if all 7+ tools listed in session priming output | Check `session-prime.ts` handleStartup() for expected tool names |
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/250-session-start-startup.md:41:| 250b | SessionStart priming (startup) | CocoIndex availability check returns correct status | `Validate 250b CocoIndex status` | `cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run tests/hook-session-start.vitest.ts` | CocoIndex line shows "available" when binary exists or "not installed" when missing | Test output showing CocoIndex status line | PASS if CocoIndex status matches filesystem reality | Verify `.opencode/skills/mcp-coco-index/mcp_server/.venv/bin/ccc` path |
...
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/263-session-resume.md:28:  - hints array present (may be empty if all subsystems healthy; should point to `session_bootstrap` when structure is degraded)
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/263-session-resume.md:41:| 263c | Session resume tool | CocoIndex availability check | `Validate 263c cocoindex status` | Call `session_resume({})` via MCP | cocoIndex.available is boolean, binaryPath is string | session_resume response JSON cocoIndex field | PASS if cocoIndex fields present with correct types | Check `cocoindex-path.ts` plus the availability probe used by session-resume.ts |
...
.opencode/skills/system-spec-kit/manual_testing_playbook/13--memory-quality-and-indexing/006-session-enrichment-and-alignment-guardrails.md:24:  - `memory_search({ query: "session enrichment alignment", specFolder: "specs/<target-spec>" })`
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/264-query-intent-routing.md:2:title: "264 -- Query-intent routing in memory_context"
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/264-query-intent-routing.md:3:description: "This scenario validates Query-intent routing for 264. It focuses on verifying structural queries route to code graph and semantic queries route to CocoIndex."
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/264-query-intent-routing.md:6:# 264 -- Query-intent routing in memory_context
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/264-query-intent-routing.md:10:This scenario validates Query-intent routing in memory_context.
.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/264-query-intent-routing.md:16:- **Objective**: Verify that memory_context auto-routes queries based on the query-intent classifier. Structural queries (containing keywords like "calls", "imports", "callers", "function", "class") must route to the code graph backend. Semantic queries (containing keywords like "similar", "find examples", "how to") must route to the standard memory/CocoIndex pipeline. Hybrid queries must trigger both backends and merge results. The classifier confidence score and matched keywords must be available in the response metadata.
...
exec
/bin/zsh -lc "rg -n \"function handleMemoryMatchTriggers|const handleMemoryMatchTriggers|co-activation|decay|trigger\" .opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts -g '"'!**/dist/**'"'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "rg -n \"function handleMemorySearch|const handleMemorySearch|classifyQueryIntent|retrievalLevel|graphEvidence|weighted|RRF|hybrid|channel\" .opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts .opencode/skills/system-spec-kit/mcp_server/lib -g '"'!**/dist/**'"'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:34:// Eval channel tracking (extracted from this file)
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:482:/** Handle memory_search tool — performs hybrid vector/BM25 search with intent-aware ranking.
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:486:async function handleMemorySearch(args: SearchArgs): Promise<MCPResponse> {
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:1242:          channel: payload.channel,
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:120:/** Layer 2 dimension weights for weighted average signal density */
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:596: * Signal density is the weighted average of all dimension scores.
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:616:  // Compute weighted average signal density
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:617:  let weightedSum = 0;
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:621:    weightedSum += score * weight;
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:625:  const signalDensity = totalWeight > 0 ? weightedSum / totalWeight : 0;
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:532:// Correction signals (0.2) weighted higher than preferences (0.1) and reinforcement (0.15) — corrections indicate stronger search intent
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/edge-density.ts:200:    '  Priority  : HIGH — must be scheduled before Sprint 3 graph-channel work.',
...
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:5:// Utilities for collecting eval channel attribution, resolving
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:6:// scores, building per-channel payloads, and summarizing graph
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:14:  channel: string;
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:57: * Collect all eval channel attributions from a result row.
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:58: * Checks `sources` (array), `source` (string), and `channelAttribution` (array).
...
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:62:  const channels = new Set<string>();
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:67:        channels.add(source.trim());
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:73:    channels.add(row.source.trim());
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:76:  if (Array.isArray(row.channelAttribution)) {
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:77:    for (const source of row.channelAttribution) {
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:79:        channels.add(source.trim());
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:84:  if (channels.size === 0) {
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:85:    channels.add('hybrid');
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:88:  return Array.from(channels);
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:92: * Build per-channel eval payloads from an array of result rows.
...
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:109:    const channels = collectEvalChannelsFromRow(row);
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:111:    for (const channel of channels) {
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:112:      const bucket = byChannel.get(channel) ?? new Map<number, number>();
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:117:      byChannel.set(channel, bucket);
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:121:  return Array.from(byChannel.entries()).map(([channel, idToScore]): EvalChannelPayload => {
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:124:      channel,
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:36:import { enforceChannelRepresentation } from './channel-enforcement.js';
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:65:import type { EnforcementResult } from './channel-enforcement.js';
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:97:   * enable all retrieval channels for this search call.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:162:    channels: string[];
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:280: * Return current graph channel metrics for health check reporting.
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:292:/** Reset all graph channel metrics counters to zero. */
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:445: * Run FTS5 full-text search with weighted BM25 scoring and optional spec folder filtering.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:570:    const channelCount = sources.length;
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:574:      channelCount,
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:576:      channelAttribution: sources,
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:592:  const channelCount = sources.length;
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:593:  const crossChannelBonus = Math.min(0.06, 0.02 * Math.max(0, channelCount - 1));
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:602:    channelCount,
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:607:    channelAttribution: sources,
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:642:        channelAttribution: [list.source],
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1007:    // When enabled, classifies query complexity and restricts channels to a
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1008:    // Subset (e.g., simple queries skip graph+degree). When disabled, all channels run.
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1013:      : new Set<ChannelName>(routeResult.channels);
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1015:    // Respect explicit caller channel disables across both the primary route and
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1018:    for (const channel of allPossibleChannels) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1019:      if (!allowedChannels.has(channel)) activeChannels.delete(channel);
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1027:        channels: routeResult.channels,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1061:    // Vector channel — gated by query-complexity routing
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1114:    // Graph channel — gated by query-complexity routing
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1118:        graphMetrics.totalQueries++; // counted only if channel executes
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1132:        // Non-critical — graph channel failure does not block pipeline
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1137:    // Degree channel re-ranks based on causal-edge connectivity.
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1139:    // Degree channel — also gated by query-complexity routing
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1142:        // Collect all numeric IDs from existing channels
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1176:        // Non-critical — degree channel failure does not block pipeline
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1342:  // Ensures every channel that returned results has at least one representative
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1346:    const channelResultSets = new Map<string, Array<{ id: number | string; score: number; [key: string]: unknown }>>();
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1348:      channelResultSets.set(list.source, list.results.map(r => ({
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1361:      channelResultSets,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2144:  // TIER 2: Widen search — lower similarity, force all channels
...
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/batch-learning.ts:68:  /** Confidence-weighted composite score. */
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/batch-learning.ts:69:  weightedScore: number;
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/batch-learning.ts:83:  weighted_score: number;
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/batch-learning.ts:142:    weighted_score  REAL NOT NULL DEFAULT 0.0,
...
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/batch-learning.ts:221:      const weightedScore =
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/batch-learning.ts:229:      const normalizedScore = totalEvents > 0 ? weightedScore / totalEvents : 0;
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/batch-learning.ts:238:        weightedScore,
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/batch-learning.ts:243:    // Sort descending by weightedScore for deterministic output
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/batch-learning.ts:244:    signals.sort((a, b) => b.weightedScore - a.weightedScore);
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/batch-learning.ts:366:        (memory_id, batch_run_at, session_count, weighted_score, computed_boost, shadow_rank_delta, promoted)
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/batch-learning.ts:372:      signal.weightedScore,
.opencode/skills/system-spec-kit/mcp_server/lib/manage/README.md:34:The former graph-authority helper was removed because the active retrieval pipeline uses typed-weighted degree scoring and graph signal helpers instead.
.opencode/skills/system-spec-kit/mcp_server/lib/manage/README.md:87:- `../search/graph-search-fn.ts` — typed-weighted degree scoring used by the live retrieval path.
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:55:      "query": "what was recently discussed about the graph channel hit rate being zero",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:60:      "expectedResultDescription": "Should surface sprint-0 baseline measurement (T000a) which records graphHitRate=0, and any related spec memories about graph channel initialization or telemetry gaps.",
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:385:      "query": "how should I refactor the eval-logger to support per-channel metrics",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:390:      "expectedResultDescription": "Should surface eval-logger.ts, eval-db.ts schema (eval_channel_results table), and any spec decisions about the eval framework design.",
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:461:      "notes": "Cross-document query spanning fusion implementation and channel weight configuration."
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:821:      "notes": "Manual bug report for the graph channel — relates to known T000a baseline finding."
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:7:// For results related to top seed results via weighted CTE.
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:427:  // C138-P2: Relation-weighted CTE — accumulates score with multiplier
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:482:      // C138-P2: Combine hop-distance decay with relation-weighted walk score
.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:158:  - `ablation-framework.ts` — controlled channel-ablation experimentation.
.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:206:- Purpose: Owns graph-derived retrieval signals and community detection over memory relationships. It is the canonical place for graph algorithms that operate over causal/community structure rather than primary retrieval channels.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/learned-feedback.ts:22:// Query weight: 0.7x (learned triggers weighted lower than organic triggers)
.opencode/skills/system-spec-kit/mcp_server/lib/search/learned-feedback.ts:446: * the query terms. Returns matching memories with a weighted score.
.opencode/skills/system-spec-kit/mcp_server/lib/search/learned-feedback.ts:450: * @returns Array of matching memories with 0.7x weighted scores
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:120: * other channels explicitly disabled.
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:137: *     justify the added complexity. Evaluate whether the multi-channel
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:142: *     improve over this baseline. Each additional channel needs
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:161:        'Re-evaluate whether a multi-channel architecture is warranted before proceeding with ' +
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:264:        'Each additional channel must show a statistically meaningful positive delta ' +
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:434:      (eval_run_id, metric_name, metric_value, channel, query_count, metadata, created_at)
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:438:  const channel = 'bm25';
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:444:    insertSnapshot.run(evalRunId, 'mrr@5',       result.metrics.mrr5,      channel, queryCount, null, createdAt);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:445:    insertSnapshot.run(evalRunId, 'ndcg@10',      result.metrics.ndcg10,    channel, queryCount, null, createdAt);
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:447:    insertSnapshot.run(evalRunId, 'hit_rate@1',   result.metrics.hitRate1,  channel, queryCount, null, createdAt);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:455:      channel,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:243: * Community summary generation and search channel.
.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:251: * R8: Memory summary generation (TF-IDF extractive summaries as search channel).
.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:344: * activating the graph channel for matched concepts.
.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:513: * REQ-D1-001: Calibrated overlap bonus for multi-channel convergence.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:634: * Phase D T036: Usage-weighted ranking signal.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:10:// additional retrieval channel.  This helps bridge the vocabulary
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:355: * This is the search channel activated when HyDE fires.
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/composite-scoring.ts:528: * observability telemetry to an already-computed weighted composite score.
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/composite-scoring.ts:533: * @param composite  Raw weighted-sum composite score (pre-multiplier)
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/composite-scoring.ts:589: * Returns a single 0-1 score combining five weighted factors:
...
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/composite-scoring.ts:633: * Returns a single 0-1 score combining six weighted factors:
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:5:// Aggregates metrics per sprint/eval-run, per-channel views,
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:9:// Eval_channel_results table.
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:36:  channelFilter?: string[];
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:52:/** Per-channel performance within a sprint. */
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:69:  /** Per-metric, per-channel summary statistics derived from channel-tagged snapshots. */
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:70:  channelMetrics: Record<string, Record<string, MetricSummary>>;
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:71:  /** Per-channel performance data. */
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:72:  channels: Record<string, ChannelPerformance>;
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:136:  channel: string | null;
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:142:/** Aggregated per-run/per-channel row shape from eval_channel_results. */
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:145:  channel: string;
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:191:  let sql = `SELECT id, eval_run_id, metric_name, metric_value, channel, query_count, metadata, created_at
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:202:  if (config.channelFilter && config.channelFilter.length > 0) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:203:    const placeholders = config.channelFilter.map(() => '?').join(', ');
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:204:    sql += ` AND (channel IN (${placeholders}) OR channel IS NULL)`;
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:205:    params.push(...config.channelFilter);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:227: * Query grouped channel results for specific eval_run_ids.
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:228: * Aggregating in SQL keeps channel coverage complete for the included runs
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:234:  channelFilter?: string[],
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:241:               channel,
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:245:             FROM eval_channel_results
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:249:  if (channelFilter && channelFilter.length > 0) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:250:    const chPlaceholders = channelFilter.map(() => '?').join(', ');
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:251:    sql += ` AND channel IN (${chPlaceholders})`;
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:252:    params.push(...channelFilter);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:255:  sql += ` GROUP BY eval_run_id, channel`;
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:322: * Build a SprintReport from grouped snapshots and channel results.
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:327:  channelRows: ChannelResultRow[],
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:335:  const channelMetricGroups = new Map<string, Map<string, number[]>>();
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:336:  const channelMetricLatest = new Map<string, Map<string, { value: number; time: string }>>();
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:353:    if (snap.channel) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:354:      if (!channelMetricGroups.has(snap.metric_name)) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:355:        channelMetricGroups.set(snap.metric_name, new Map());
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:357:      if (!channelMetricLatest.has(snap.metric_name)) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:358:        channelMetricLatest.set(snap.metric_name, new Map());
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:361:      const perMetricGroups = channelMetricGroups.get(snap.metric_name)!;
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:362:      const perMetricLatest = channelMetricLatest.get(snap.metric_name)!;
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:363:      if (!perMetricGroups.has(snap.channel)) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:364:        perMetricGroups.set(snap.channel, []);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:366:      perMetricGroups.get(snap.channel)!.push(snap.metric_value);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:368:      const existingChannelMetric = perMetricLatest.get(snap.channel);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:370:        perMetricLatest.set(snap.channel, {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:385:  const channelMetrics: Record<string, Record<string, MetricSummary>> = {};
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:386:  for (const [metricName, perChannelGroups] of channelMetricGroups) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:387:    const perChannelLatest = channelMetricLatest.get(metricName) ?? new Map();
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:388:    channelMetrics[metricName] = {};
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:389:    for (const [channelName, values] of perChannelGroups) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:390:      channelMetrics[metricName][channelName] = computeMetricSummary(
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:392:        perChannelLatest.get(channelName)?.value ?? 0,
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:397:  // Build channel performance
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:398:  const channels: Record<string, ChannelPerformance> = {};
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:399:  const runChannelRows = channelRows.filter(r => evalRunIds.includes(r.eval_run_id));
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:401:  const channelGroups = new Map<string, ChannelResultRow[]>();
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:403:    if (!channelGroups.has(row.channel)) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:404:      channelGroups.set(row.channel, []);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:406:    // ChannelGroups.set(...) above ensures this channel bucket exists before push
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:407:    channelGroups.get(row.channel)!.push(row);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:410:  for (const [ch, rows] of channelGroups) {
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:427:    channels[ch] = {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:442:    channelMetrics,
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:443:    channels,
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:524:    const channelMetricCount = Object.values(latest.channelMetrics)
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:526:    if (channelMetricCount > 0) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:527:      lines.push(`Per-channel metric breakdowns: ${channelMetricCount}.`);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:529:    const channelNames = Object.keys(latest.channels);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:530:    if (channelNames.length > 0) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:531:      lines.push(`Active channels: ${channelNames.join(', ')}.`);
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:619:  // Query channel results only for included runs so row limits cannot starve kept groups.
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:620:  const channelRows = queryChannelResults(db, includedRunIds, config.channelFilter);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:623:    buildSprintReport(label, groupSnapshots, channelRows)
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:684:    const channelMetricNames = Object.keys(sprint.channelMetrics).sort();
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:685:    if (channelMetricNames.length > 0) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:687:      for (const metricName of channelMetricNames) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:688:        const channelsForMetric = sprint.channelMetrics[metricName];
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:689:        const metricChannelNames = Object.keys(channelsForMetric).sort();
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:690:        for (const channelName of metricChannelNames) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:691:          const summary = channelsForMetric[channelName];
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:693:            `    ${`${metricName} [${channelName}]`.padEnd(35)} latest=${summary.latest.toFixed(4)}  mean=${summary.mean.toFixed(4)}  range=[${summary.min.toFixed(4)}, ${summary.max.toFixed(4)}]  n=${summary.count}`
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:700:    const channelNames = Object.keys(sprint.channels).sort();
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:701:    if (channelNames.length > 0) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:703:      for (const ch of channelNames) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/reporting-dashboard.ts:704:        const c = sprint.channels[ch];
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/k-value-analysis.ts:352:  channels: RankedList[];
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/k-value-analysis.ts:609: * @param queries - Judged queries with channels, labels, and relevantIds
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/k-value-analysis.ts:622:    const fused = fuseResultsMulti(q.channels, { k });
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/k-value-analysis.ts:713:  // Global best-K: argmax of weighted-average NDCG@10 across all intents
...
.opencode/skills/system-spec-kit/mcp_server/lib/response/profile-formatters.ts:47:    channelContribution?: Record<string, number>;
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-db.ts:52:  -- Per-channel results for each query evaluation
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-db.ts:53:  CREATE TABLE IF NOT EXISTS eval_channel_results (
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-db.ts:57:    channel TEXT NOT NULL,
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-db.ts:65:  -- Final fused results after RRF/fusion
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-db.ts:95:    channel TEXT,
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-db.ts:104:  CREATE INDEX IF NOT EXISTS idx_channel_results_run
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-db.ts:105:    ON eval_channel_results (eval_run_id, channel, query_id);
.opencode/skills/system-spec-kit/mcp_server/lib/search/graph-search-fn.ts:5:// Causal graph search channel — uses FTS5 for node matching
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/graph-search-fn.ts:367: * Compute the raw typed-weighted degree for a single memory node.
.opencode/skills/system-spec-kit/mcp_server/lib/search/graph-search-fn.ts:404: * @param rawDegree - The raw typed-weighted degree
.opencode/skills/system-spec-kit/mcp_server/lib/search/graph-search-fn.ts:691:  // Typed-degree computation (R4 5th RRF channel)
.opencode/skills/system-spec-kit/mcp_server/lib/search/graph-flags.ts:4:// Feature catalog: Typed-weighted degree channel
.opencode/skills/system-spec-kit/mcp_server/lib/search/graph-flags.ts:15: * Unified graph channel gate (default-on, explicit opt-out with `'false'`).
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:5:// Pipeline-ready wrapper around the channel min-representation check.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:10:// Delegates core logic to channel-representation.ts.
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:14:} from './channel-representation.js';
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:29:/** A raw result from a single retrieval channel. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:46:  /** Number of results promoted from under-represented channels. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:50:  /** Per-channel item count in the final result set. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:51:  channelCounts: Record<string, number>;
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:65: * Apply channel min-representation enforcement to a set of fused search results.
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:72: *    from any channel that returned results but is absent from that window.
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:73: *  - Promoted items are appended, their raw per-channel scores are normalized
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:77: *    promotion; channels whose best result is below the floor are noted
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:81: * @param channelResultSets - Map of channel name → raw results from that channel.
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:89:  channelResultSets: Map<string, Array<ChannelResult>>,
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:103:        channelCounts: computeChannelCounts(fusedResults),
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:112:  // ---- Delegate to core channel-representation logic ----
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:113:  const analysis = analyzeChannelRepresentation(window, channelResultSets);
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:117:    channelResultSets,
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:132:      channelCounts: computeChannelCounts(finalResults),
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:142: * Count how many items in a result array belong to each channel.
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:143: * Uses the `source` field as the channel identifier.
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:155:  channelResultSets: Map<string, Array<ChannelResult>>,
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:168:    const channelScoreRange = computeScoreRange(channelResultSets.get(item.promotedFrom) ?? []);
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-enforcement.ts:169:    const normalizedWithinChannel = normalizeScoreWithinRange(item.promotedRawScore, channelScoreRange);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-logger.ts:52:        const channelMax = db.prepare('SELECT MAX(eval_run_id) as maxId FROM eval_channel_results').get() as { maxId: number | null } | undefined;
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-logger.ts:54:        const maxId = Math.max(channelMax?.maxId ?? 0, finalMax?.maxId ?? 0);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-logger.ts:86:  /** Eval run ID to pass to channel / final result loggers. */
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-logger.ts:94:  channel: string;
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-logger.ts:95:  /** Memory IDs returned by this channel. */
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-logger.ts:138: * must be forwarded to channel / final result loggers.
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-logger.ts:177: * Log the result set from a single retrieval channel.
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-logger.ts:188:      INSERT INTO eval_channel_results
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-logger.ts:194:      params.channel ?? 'unknown',
.opencode/skills/system-spec-kit/mcp_server/lib/graph/usage-ranking-signal.ts:4:// Feature catalog: Usage-weighted ranking boost
.opencode/skills/system-spec-kit/mcp_server/lib/eval/README.md:41:| `ablation-framework.ts` | Controlled channel ablation runs, formatting, and storage helpers |
.opencode/skills/system-spec-kit/mcp_server/lib/eval/README.md:45:| `eval-logger.ts` | Fail-safe query, channel, and final-result logging hooks |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/bm25-index.ts:46: * C138: Field weight multipliers for weighted BM25 scoring.
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-metrics.ts:559:  // P1-7 fix: Multiplier values ARE the weighted grades (not factors to multiply
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-metrics.ts:563:  const weightedGT: GroundTruthEntry[] = groundTruth.map(e => ({
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-metrics.ts:568:  return computeNDCG(results, weightedGT, k);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-metrics.ts:582: * @param params.intentType          Intent type for intent-weighted NDCG.
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/README.md:15:| `working-set-tracker.ts` | Recency-weighted file/symbol access tracking |
...
.opencode/skills/system-spec-kit/mcp_server/lib/graph/graph-signals.ts:4:// Feature catalog: Typed-weighted degree channel
...
.opencode/skills/system-spec-kit/mcp_server/lib/graph/graph-signals.ts:306:    const normalizedReach = clamp(weightedReach / candidateSpan, 0, 1);
.opencode/skills/system-spec-kit/mcp_server/lib/graph/graph-signals.ts:307:    scores.set(memoryId, { raw: weightedReach, normalized: normalizedReach });
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:10://   - debug (opt-in): adds channelContribution map
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:23:// The channelContribution map is only included when debug.enabled=true.
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:43:/** Per-channel score contribution breakdown (debug tier). */
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:56:/** Full explainability payload — includes channelContribution when debug ON. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:58:  channelContribution?: ChannelContribution;
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:69:  /** Whether to include channelContribution (debug tier). Default: false. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:98:  // Lexical match: only present if the row came through FTS channel
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:99:  // We detect this via channelAttribution on the row (Stage 4 annotation)
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:100:  const channelAttribution = Array.isArray(row.channelAttribution)
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:101:    ? row.channelAttribution as string[]
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:230: * Extract channel contribution scores from a PipelineRow.
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:231: * Uses channelAttribution array and graphContribution.totalDelta to
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:239:  // Prefer explicit channel scores when available
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:265:  const channelAttribution = Array.isArray(row.channelAttribution)
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:266:    ? row.channelAttribution as string[]
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:308: * When debugEnabled=true, channelContribution is also included.
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:327:    why.channelContribution = extractChannelContribution(row);
...
.opencode/skills/system-spec-kit/mcp_server/lib/graph/usage-tracking.ts:4:// Feature catalog: Access count tracking for usage-weighted ranking
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:6:// Controlled ablation studies for search channel contribution analysis.
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:8:// Delta against a full-pipeline baseline, and attributes per-channel
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:51:/** Known search channels that can be ablated. */
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:54:/** All channels available for ablation. */
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:66:  channels: AblationChannel[];
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:103: * The runner passes channel disable flags; the function must respect them.
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:106: * @param disabledChannels - Set of channel names to disable for this run.
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:114:/** Result of ablating a single channel. */
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:116:  /** The channel that was disabled. */
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:117:  channel: AblationChannel;
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:122:  /** ablatedRecall20 - baselineRecall20. Negative means channel contributes positively. */
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:130:  /** Number of queries unaffected by removing this channel. */
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:145:/** All 9 metrics tracked per ablation channel. */
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:158:/** Failure captured for a single channel ablation run. */
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:161:  channel: AblationChannel;
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:178:  /** Per-channel ablation results. */
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:181:  channelFailures?: AblationChannelFailure[];
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:406: * @param nPositive - Number of queries where ablated < baseline (channel helped).
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:407: * @param nNegative - Number of queries where ablated > baseline (channel hurt).
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:540: * For each channel in config.channels:
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:541: * 1. Run all queries with all channels enabled (baseline) — cached across channels
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:542: * 2. Run all queries with that one channel disabled (ablated)
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:547: * the query text and a set of disabled channel names. When the set
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:548: * is empty, all channels should be active (baseline condition).
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:550: * @param searchFn - Search function that respects channel disable flags.
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:552: * @returns AblationReport with per-channel results, or null if ablation is disabled.
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:556:  config: AblationConfig = { channels: ALL_CHANNELS },
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:588:    // -- Step 1: Compute baseline (all channels enabled) --
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:610:    // -- Step 2: Ablate each channel --
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:612:    const channelFailures: AblationChannelFailure[] = [];
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:614:    for (const channel of config.channels) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:615:      const disabledSet = new Set<AblationChannel>([channel]);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:636:        let queriesChannelHelped = 0;   // ablated < baseline (removing channel decreased quality — channel was helpful)
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:637:        let queriesChannelHurt = 0;    // ablated > baseline (removing channel increased quality — channel was harmful)
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:657:        // QueriesChannelHelped = channel was helping (removing it hurt quality)
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:658:        // QueriesChannelHurt = channel was harmful (removing it helped quality)
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:665:          channel,
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:679:          channel,
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:688:        channelFailures.push(failure);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:692:          `[ablation] Channel "${channel}" failed${querySuffix}; continuing with remaining channels:`,
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:703:      ...(channelFailures.length > 0 ? { channelFailures } : {}),
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:726: * Inserts one row per channel with:
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:728: * - metric_value: the delta (negative = channel contributes positively)
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:729: * - channel: the ablated channel name
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:751:        (eval_run_id, metric_name, metric_value, channel, query_count, metadata, created_at)
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:778:            channelFailures: report.channelFailures ?? [],
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:783:      // Store per-channel deltas
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:789:          result.channel,
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:803:        // Store all 9 multi-metric entries per channel
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:821:              result.channel,
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:850: * Sorts channels by absolute delta (largest contribution first).
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:894:      `| ${r.channel} ` +
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:907:  lines.push(`**Legend:** Delta = ablated - baseline. Negative delta = channel contributes positively.`);
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:911:  if (report.channelFailures && report.channelFailures.length > 0) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:914:    for (const failure of report.channelFailures) {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:916:      lines.push(`- \`${failure.channel}\`${queryInfo}: ${failure.error}`);
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:933:        `| ${r.channel} ` +
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:945:    lines.push(`**Note:** Delta values shown (ablated - baseline). Negative = channel contributes positively to that metric.`);
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:966: * Generate a human-readable verdict for a channel ablation result.
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:977:    // Removing the channel hurt quality — channel is valuable
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:982:    // Removing the channel helped quality — channel may be harmful
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:994: * Maps ablation channel names to the corresponding useXxx: false flags
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:997: * @param disabledChannels - Set of channels to disable.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:600: * weighted combination so all three dimensions operate on the same scale.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:1173:  // -- 2d. Usage-weighted ranking (Phase D T034) --
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:1215:      const weighted = applyIntentWeightsToResults(results, config.intentWeights);
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:1216:      results = weighted.map((result) =>
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:118:export function classifyQueryIntent(query: string): ClassificationResult {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:6:// Responsibility: Execute search channels and collect raw candidate results.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:9:// Results are collected from the appropriate search channel based on search type.
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:11:// Search channels handled:
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:19:// Post-channel operations:
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:269:    const channelAttribution = mergeStringLists(incoming.channelAttribution, sources);
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:273:      channelAttribution: channelAttribution.length > 0 ? channelAttribution : incoming.channelAttribution,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:279:      channelCount: sources.length > 0 ? sources.length : incoming.channelCount,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:290:    existing.channelAttribution,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:291:    incoming.channelAttribution,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:310:    channelAttribution: mergedChannelAttribution.length > 0
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:312:      : primary.channelAttribution,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:320:    channelCount: mergedSources.length > 0 ? mergedSources.length : primary.channelCount,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:458: * Selects and runs the appropriate search channel(s) based on `config.searchType`
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:467: * @returns Stage 1 output with raw candidate rows and channel metadata.
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:497:  let channelCount = 0;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:503:  // matched, log them to the trace for downstream use (graph channel activation
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:504:  // is surfaced via trace metadata; actual graph channel is handled in Stage 2).
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:539:                  channel: 'd2-concept-expansion',
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:555:            channel: 'd2-concept-routing',
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:593:    channelCount = 1;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:682:            channelCount = allQueries.length;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:690:              addTraceEntry(trace, 'candidate', channelCount, candidates.length, 0, {
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:691:                channel: 'd2-query-decomposition',
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:699:            // (jump to post-channel processing via the else-if chain)
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:746:          channelCount = queryVariants.length;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:762:          channelCount = 1;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:771:        channelCount = 1;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:786:      // Hybrid search channel whose results are merged with the baseline.
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:807:          // Only run an extra channel if the expansion actually produced new terms
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:843:            channelCount = 2;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:854:              addTraceEntry(trace, 'candidate', channelCount, candidates.length, 0, {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:874:          channelCount = 1;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:889:          channelCount = 1;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:929:    channelCount = 1;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1145:            channelCount += allQueries.length - 1; // discount original (already counted)
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1149:                channel: 'd2-llm-reformulation',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1199:        channelCount++;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1203:            channel: 'd2-hyde',
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1275:              channelCount++;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1290:      console.warn(`[stage1-candidate-gen] R8 summary channel failed: ${r8Msg}`);
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1357:              channel: 'd2-query-surrogates',
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1378:      channelCount,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1384:        channelCount,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1400:      channelCount,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/README.md:34:The `pipeline/` directory implements the core retrieval pipeline behind `memory_search`. Each search request flows through four sequential stages, each with a defined I/O contract and clear responsibility boundary. The pipeline supports hybrid, vector and multi-concept search types with optional deep-mode query expansion, cross-encoder reranking, MMR diversity pruning and MPAB chunk-to-parent reassembly.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/README.md:61:      |  search channels, constitutional injection, quality filter
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/README.md:77:- Runs one or more search channels based on `searchType` and `mode`.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:29:/** A promoted item – a TopKItem augmented with the channel name it was lifted from. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:39:/** A raw result from a single retrieval channel (no source field required). */
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:50: * - `promoted`               — items that were promoted from under-represented channels
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:51: * - `underRepresentedChannels` — channel names that had 0 results in topK but did return results
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:52: * - `channelCounts`          — per-channel result counts in the final (enhanced) topK
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:58:  channelCounts: Record<string, number>;
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:65: * enabled, promote the best-scoring result from every channel that
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:69: *  - Only checks channels that actually returned results (no phantom penalties).
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:70: *  - A channel is under-represented when it has 0 results in topK.
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:73: *  - The `source` field of each topK item is the authoritative channel label.
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:74: *    Items that carry a `sources` array (multi-channel convergence) are counted
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:75: *    toward each channel listed in that array.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:78: * @param allChannelResults - Map of channel name → raw results for that channel.
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:91:      channelCounts: computeChannelCounts(topK),
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:101:      channelCounts: {},
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:105:  // Compute which channels are represented in the current top-k.
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:110:    // Also count any additional sources (multi-channel convergence)
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:118:  // Identify which channels that returned results are missing from top-k.
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:120:  for (const [channelName, channelResults] of allChannelResults) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:121:    if (channelResults.length === 0) continue; // channel returned nothing — not penalised
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:122:    if (!representedChannels.has(channelName)) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:123:      underRepresentedChannels.push(channelName);
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:133:      channelCounts: computeChannelCounts(topK),
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:137:  // Padding appends the best item from each missing channel to guarantee
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:138:  // Every contributing channel has at least one representative in the result set.
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:142:  for (const channelName of underRepresentedChannels) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:143:    const results = allChannelResults.get(channelName) ?? [];
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:154:    if (best === null) continue; // no qualifying result — skip channel
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:158:      source: channelName,
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:159:      promotedFrom: channelName,
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:171:    channelCounts: computeChannelCounts(enhancedTopK),
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:178: * Count how many items in an array belong to each channel.
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:179: * Uses the `source` field as the channel identifier.
.opencode/skills/system-spec-kit/mcp_server/lib/search/channel-representation.ts:182: * @returns Record mapping channel name to item count.
.opencode/skills/system-spec-kit/mcp_server/lib/storage/schema-downgrade.ts:62:  'channel',
.opencode/skills/system-spec-kit/mcp_server/lib/storage/schema-downgrade.ts:138:      channel TEXT DEFAULT 'default',
...
.opencode/skills/system-spec-kit/mcp_server/lib/chunking/README.md:68:| `chunk-thinning.ts` | Scores chunks using a weighted composite of anchor presence and content density, then applies a configurable threshold (default 0.3) to filter low-quality chunks before indexing. Always retains at least one chunk. |
.opencode/skills/system-spec-kit/mcp_server/lib/search/embedding-expansion.ts:38: *                     use as a search query in downstream channels.
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/adaptive-ranking.ts:10: * Adaptive feedback channels that influence shadow ranking proposals.
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/adaptive-ranking.ts:65:  weightedSignalScore: number;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/adaptive-ranking.ts:542:  let weightedSignalScore = 0;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/adaptive-ranking.ts:547:    weightedSignalScore += row.total * thresholds.signalWeights[row.signal_type];
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/adaptive-ranking.ts:582:    weightedSignalScore,
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/adaptive-ranking.ts:636:    && summary.weightedSignalScore >= 0.04
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:4:// Tier-to-channel-subset routing for query complexity
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:5:// Maps classifier tiers to channel subsets for selective pipeline execution.
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:26:/** Maps each complexity tier to the set of channels that should be executed. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:36:  channels: ChannelName[];
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:40:/** All available channels in execution order. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:43:/** Minimum required channels for safe routing. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:46:/** Fallback channels used to pad configs that violate the minimum invariant. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:63: * Default tier-to-channel mapping:
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:66: * - complex:  5 channels (all) — full pipeline
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:79: * Enforce the minimum 2-distinct-channel invariant on a channel list.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:83:function enforceMinimumChannels(channels: ChannelName[]): ChannelName[] {
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:84:  const result = [...new Set(channels)] as ChannelName[];
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:98: * Get the channel subset for a given complexity tier.
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:102: * @returns Array of channel names to execute, guaranteed minimum 2 channels
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:109:  const channels = effectiveConfig[tier] ?? [...ALL_CHANNELS];
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:110:  return enforceMinimumChannels([...channels]);
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:128: * Classify a query's complexity and route it to the appropriate channel subset
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:131: * When the SPECKIT_COMPLEXITY_ROUTER feature flag is disabled, returns all 5 channels
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:136: * @returns RouteResult with tier, channels, and full classification details
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:145:  // In that case, always return all channels (full pipeline — safe default).
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:149:      channels: [...ALL_CHANNELS],
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:154:  const channels = getChannelSubset(classification.tier);
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:156:    ? enforceMinimumChannels([...channels, 'bm25'])
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:157:    : channels;
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:161:    channels: adjustedChannels,
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-quality-proxy.ts:68:/** Breakdown of each component's weighted contribution. */
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-quality-proxy.ts:164: *          weighted contributions, and a human-readable interpretation.
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-quality-proxy.ts:182:  // Compute raw (unweighted) component values in [0, 1]
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-quality-proxy.ts:194:  // Sum all weighted components and clamp to [0, 1]
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:47:  graphEvidence?: {
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:109:  channelAttribution?: string[];
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:205:    channelCount: number;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:288: * State filtering, session dedup, constitutional injection, channel attribution.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-surrogates.ts:433: * Matching channels (weighted):
.opencode/skills/system-spec-kit/mcp_server/lib/eval/memory-state-baseline.ts:86:    'retrieval.eval_channel_rows_total': safeScalarMetric(
.opencode/skills/system-spec-kit/mcp_server/lib/eval/memory-state-baseline.ts:88:      'SELECT COUNT(*) AS value FROM eval_channel_results',
.opencode/skills/system-spec-kit/mcp_server/lib/eval/memory-state-baseline.ts:90:    'retrieval.avg_channel_hit_count': safeScalarMetric(
.opencode/skills/system-spec-kit/mcp_server/lib/eval/memory-state-baseline.ts:92:      'SELECT COALESCE(AVG(hit_count), 0) AS value FROM eval_channel_results',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/entity-linker.ts:11:// table, returning the matched canonical concept names for graph channel routing.
.opencode/skills/system-spec-kit/mcp_server/lib/search/entity-linker.ts:89: * activate the graph channel.
.opencode/skills/system-spec-kit/mcp_server/lib/search/entity-linker.ts:320: * Contains the matched concepts and the activation state for the graph channel.
...
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:188:Attention score = weighted combination of 5 factors:
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:486:// score = weighted 5-factor composite (temporal, usage, importance, pattern, citation)
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:994:4. Each hop applies `decayPerHop` (0.5) decay, weighted by similarity
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:57:Parallel Search (5 channels)
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:63:RRF Fusion (k=40) + Adaptive Fusion -> Unified scores
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:89:Executes 5 search channels in parallel and collects raw candidates with no scoring modifications.
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:95:| FTS5 | `sqlite-fts.ts` | SQLite FTS5 BM25 weighted scoring |
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:96:| Graph | `graph-search-fn.ts` | Causal edge traversal + typed-weighted degree (R4) |
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:97:| Degree | `graph-search-fn.ts` | Structural graph discovery via typed-weighted degree |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:139:- **1.5x Graph Weight**: Graph-exclusive discoveries weighted higher for novelty
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:299:| `graph-search-fn.ts`       | -      | TypeScript | Graph-structure search channel with typed-weighted degree computation |
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:301:| `query-router.ts`          | -      | TypeScript | Tier-to-channel-subset routing for selective pipeline execution (Sprint 3) |
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:303:| `channel-representation.ts`| -      | TypeScript | Ensures minimum channel representation in top-k results (QUALITY_FLOOR=0.005) (Sprint 3) |
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:304:| `channel-enforcement.ts`   | -      | TypeScript | Pipeline-ready wrapper around channel min-representation check (Sprint 3) |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:314:| `graph-flags.ts`           | -      | TypeScript | Legacy compatibility shim for graph channel gate (SPECKIT_GRAPH_UNIFIED) |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:335:| `graph-calibration.ts`     | -      | TypeScript | Calibrates graph-channel scoring inputs and weights |
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:359:   hybrid-search.ts -> Expand acronyms + fix typos (inline)
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:365:2. PARALLEL RETRIEVAL (5 channels)
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:419:| `SPECKIT_MEMORY_SUMMARIES`| `true`  | Enable memory summary generation and search channel (R8) |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:574:**Purpose**: Generate TF-IDF extractive summaries of memory content and expose them as a search channel. Gated via `SPECKIT_MEMORY_SUMMARIES`.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:687:| 2. Content Quality | 5-dimension weighted signal density | Dimensions: title (0.25), triggers (0.20), length (0.20), anchors (0.15), metadata (0.20) |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:737:Typed-degree ranking is cached per database connection and invalidated through `clearDegreeCache()` / `clearDegreeCacheForDb()` after causal-edge and mutation flows, so the degree channel stays in sync with recent graph writes.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:1753:  if (!column_names.includes('channel')) {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:1761:      logDuplicateColumnMigrationSkip('channel', error);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2328:      channel TEXT DEFAULT 'default',
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:1334:    'channel',
.opencode/skills/system-spec-kit/mcp_server/lib/search/tfidf-summarizer.ts:4:// Feature catalog: Memory summary search channel
...
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:150:│   ├── graph-search-fn.ts      # Typed-weighted degree computation (Sprint 1)
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:153:│   ├── channel-enforcement.ts  # Channel enforcement policies
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:154:│   ├── channel-representation.ts # Min-representation R2 (QUALITY_FLOOR=0.005)
...
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:342:| `search/channel-representation.ts` | Min-representation R2 (QUALITY_FLOOR=0.005) |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:4:// Feature catalog: Memory summary search channel
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:204: * Used to determine if the summary search channel should be activated
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:6:// PURPOSE: Combine margin, multi-channel agreement, reranker support,
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:17://     "drivers": ["large_margin", "multi_channel_agreement"]
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:68:  | 'multi_channel_agreement'
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:103:  /** RRF fusion score (0–1). */
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:117:  /** Source channels that contributed this result. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:119:  /** Single source channel string (legacy). */
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:121:  /** Trace metadata containing channel attribution. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:132: * Count the number of unique channels that retrieved this result.
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:136:  const channels = new Set<string>();
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:140:      if (typeof s === 'string' && s.trim().length > 0) channels.add(s.trim());
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:145:    channels.add(result.source.trim());
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:148:  // Check traceMetadata.attribution for richer channel data
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:152:    for (const [channel, memoryIds] of Object.entries(attribution as Record<string, unknown>)) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:158:      if (matched && typeof channel === 'string' && channel.trim().length > 0) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:159:        channels.add(channel.trim());
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:164:  return channels.size;
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:216: *   - Number of channels that contributed this result (30%)
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:233:    const channelCount = countChannels(result);
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:244:    const channelFactor = channelCount >= STRONG_CHANNEL_AGREEMENT_MIN
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:246:      : channelCount === 1
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:257:      WEIGHT_CHANNEL_AGREEMENT * channelFactor +
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:269:    if (channelCount >= STRONG_CHANNEL_AGREEMENT_MIN) drivers.push('multi_channel_agreement');
.opencode/skills/system-spec-kit/mcp_server/lib/storage/causal-edges.ts:478:      const weightedStrength = clampStrength(node.strength * edge.strength * weight) ?? 0;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/causal-edges.ts:485:        strength: weightedStrength,

exec
/bin/zsh -lc "rg -n \"function handleMemoryContext|const handleMemoryContext|mode === \\\"resume\\\"|query-intent|structural|semantic|hybrid|code_graph_query|memory_search\" .opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts .opencode/skills/system-spec-kit/mcp_server/lib -g '"'!**/dist/**'"'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:657:  // Deep: Comprehensive semantic search with full context
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:1082:async function handleMemoryContext(args: ContextArgs): Promise<MCPResponse> {
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:1133:  // existing semantic logic.
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:1149:          : classification.intent === 'hybrid'
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:1150:            ? 'hybrid'
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:1151:            : 'semantic',
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:1184:      } else if (classification.intent === 'hybrid') {
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/index.ts:13:export * from './query-intent-classifier.js';
...
exec
/bin/zsh -lc "rg -n \"handleCodeGraphQuery|operation:|calls_from|imports_from|blast_radius|outline|impact|neighborhood|seed\" .opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts .opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts .opencode/skills/system-spec-kit/mcp_server/lib -g '"'!**/dist/**'"'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:4:// MCP tool handler for code_graph_context — LLM-oriented graph neighborhoods.
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:7:import type { CodeGraphSeed } from '../../lib/code-graph/seed-resolver.js';
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:15:  seeds?: Array<{
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:52:  const normalizedSeeds: NormalizedSeedSource[] = (args.seeds ?? []).map((seed) => ({
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:53:    source: typeof seed.source === 'string' && seed.source.trim().length > 0
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:54:      ? seed.source
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:55:      : seed.provider,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:56:    filePath: seed.provider === 'cocoindex'
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:57:      ? (seed.file ?? seed.filePath ?? '')
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:58:      : (seed.filePath ?? seed.file ?? ''),
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:59:    startLine: seed.provider === 'cocoindex' ? seed.range?.start : seed.startLine,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:60:    endLine: seed.provider === 'cocoindex' ? seed.range?.end : seed.endLine,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:61:    symbolId: seed.symbolId,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:62:    symbolName: seed.symbolName,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:65:  const match = normalizedSeeds.find((seed) => {
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:66:    if (seed.symbolId && anchor.symbolId) {
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:67:      return seed.symbolId === anchor.symbolId;
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:69:    if (seed.symbolName && anchor.fqName) {
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:70:      return seed.symbolName === anchor.fqName || anchor.fqName.endsWith(`.${seed.symbolName}`);
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:72:    if (seed.filePath !== anchor.filePath) {
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:75:    if (typeof seed.startLine === 'number' && seed.startLine !== anchor.startLine) {
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:78:    if (typeof seed.endLine === 'number' && seed.endLine !== anchor.endLine) {
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:107:    const queryMode = (['neighborhood', 'outline', 'impact'].includes(args.queryMode ?? '')
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:109:      : 'neighborhood');
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:111:    const seeds = (args.seeds ?? []).map((seed) => {
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:112:      const source = typeof seed.source === 'string' && seed.source.trim().length > 0
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:113:        ? seed.source
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:114:        : seed.provider;
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:116:      if (seed.provider === 'cocoindex' && seed.file) {
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:119:          file: seed.file,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:120:          range: seed.range ?? { start: seed.startLine ?? 1, end: seed.endLine ?? seed.startLine ?? 1 },
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:121:          score: seed.score ?? 0,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:122:          snippet: seed.snippet,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:127:      if (seed.provider === 'manual' && seed.symbolName) {
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:130:          symbolName: seed.symbolName,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:131:          filePath: seed.filePath,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:132:          kind: seed.kind,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:137:      if (seed.provider === 'graph' && seed.symbolId) {
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:140:          nodeId: seed.nodeId ?? seed.symbolId,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:141:          symbolId: seed.symbolId,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:147:        filePath: seed.filePath ?? seed.file ?? '',
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:148:        startLine: seed.startLine ?? seed.range?.start,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:149:        endLine: seed.endLine ?? seed.range?.end,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:150:        query: seed.query,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:161:      seeds,
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts:16:  operation: 'outline' | 'calls_from' | 'calls_to' | 'imports_from' | 'imports_to' | 'blast_radius';
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts:318:export async function handleCodeGraphQuery(args: QueryArgs): Promise<{ content: Array<{ type: string; text: string }> }> {
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts:340:  if (operation === 'outline') {
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts:349:            operation: 'outline',
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts:361:          }, readiness, 'code_graph_query outline payload'),
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts:367:  if (operation === 'blast_radius') {
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts:400:          }, readiness, 'code_graph_query blast_radius payload'),
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts:441:    case 'calls_from': {
.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts:495:    case 'imports_from': {
...
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:96:  operation: string;
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:131:export function logExecutionTime(operation: string, durationMs: number, details: Record<string, unknown> = {}): ExecutionLogEntry | undefined {
.opencode/skills/system-spec-kit/mcp_server/lib/errors/core.ts:146:export function withTimeout<T>(promise: Promise<T>, ms: number, operation: string): Promise<T> {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:9:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:19:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:29:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:39:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:49:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:59:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:69:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:79:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:89:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:99:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:109:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:119:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:129:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:139:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:149:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:159:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:169:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:179:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:189:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:199:      "source": "seed",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:209:      "source": "seed",
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/k-value-analysis.ts:5:// Measures the impact of different RRF K-values on ranking stability.
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:880:  // Sort by absolute delta descending (most impactful first)
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ground-truth-data.ts:27:export type QuerySource = 'manual' | 'trigger_derived' | 'pattern_derived' | 'seed';
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ground-truth-data.ts:68:    seed: GROUND_TRUTH_QUERIES.filter(q => q.source === 'seed').length,
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/scoring-observability.ts:95: * Uses Math.random() — no seeding, no state.
.opencode/skills/system-spec-kit/mcp_server/lib/ops/job-queue.ts:131:async function withBusyRetry<T>(operation: () => T): Promise<T> {
.opencode/skills/system-spec-kit/mcp_server/lib/ops/job-queue.ts:148:function withBusyRetrySync<T>(operation: () => T): T {
.opencode/skills/system-spec-kit/mcp_server/lib/ops/file-watcher.ts:187:async function withBusyRetry(operation: () => Promise<void>): Promise<void> {
.opencode/skills/system-spec-kit/mcp_server/lib/ops/file-watcher.ts:262:    operation: () => Promise<void>,
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:247:/** Number of top results used as seeds for co-activation spreading. */
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/index.ts:7:export * from './seed-resolver.js';
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:44:  seedPair: ContradictionPair;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:298:    for (const seedId of [pair.memoryA.id, pair.memoryB.id]) {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:304:        `) as Database.Statement).all(String(seedId), String(seedId)) as Array<{ neighbor_id: number }>;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:318:      seedPair: pair,
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:532:// Spread activation from seed memories
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:534:  [42, 58],    // seedIds: number[]
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:991:1. Call `spreadActivation(seedIds)` with one or more seed memory IDs
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:992:2. For each seed, get `related_memories` from DB (JSON array of `{id, similarity}`)
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/README.md:12:| `seed-resolver.ts` | Resolves CocoIndex file:line results to graph nodes |
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/README.md:13:| `code-graph-context.ts` | LLM-oriented graph neighborhoods (neighborhood/outline/impact modes) |
.opencode/skills/system-spec-kit/mcp_server/lib/cache/tool-cache.ts:310:function invalidateOnWrite(operation: string, _context: Record<string, unknown> = {}): number {
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/co-activation.ts:365: * and causal_edges graph from seed memories. Merging both sources
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/co-activation.ts:370:  seedIds: number[],
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/co-activation.ts:374:  if (!db || seedIds.length === 0) return [];
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/co-activation.ts:386:  const queue: QueueItem[] = seedIds.map(id => ({
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:145:  seeded: number;
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:599:export function seedLineageFromCurrentState(
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:618:  const seedTx = database.transaction(() => {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:646:  seedTx();
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:706:          const seeded = seedLineageFromCurrentState(database, predecessorMemoryId, {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:710:          if (seeded.logicalKey !== rowLogicalKey) {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:712:              `E_LINEAGE: predecessor ${predecessorMemoryId} logical identity ${seeded.logicalKey} ` +
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:716:          logicalKey = seeded.logicalKey;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:717:          rootMemoryId = seeded.rootMemoryId;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:718:          versionNumber = seeded.versionNumber + 1;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:1064: * @returns Backfill summary including scanned and seeded rows.
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:1093:  let seeded = 0;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:1120:        seeded += 1;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:1131:      seeded,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:1210:    seeded,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:1321: * @returns Backfill summary including scanned and seeded rows.
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:34:  'neighborhood', 'outline', 'impact', 'graph',
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:65:  /(?:impact|blast\s+radius)\s+of/i,
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:66:  /(?:outline|structure)\s+of/i,
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-evaluation-runtime.ts:63:  seed?: number;
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-evaluation-runtime.ts:82:/** Deterministic seed so weekly holdout selection is stable across restarts. */
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-evaluation-runtime.ts:347:  seed: number,
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-evaluation-runtime.ts:357:  const holdoutQueryIds = selectHoldoutQueries(allQueryIds, { holdoutPercent, seed });
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-evaluation-runtime.ts:404:  const seed = options.seed ?? DEFAULT_SEED;
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-evaluation-runtime.ts:428:    const replayed = await buildHoldoutReplayMap(db, queryRows, holdoutPercent, seed, searchLimit);
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-evaluation-runtime.ts:444:        seed,
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:13://   - Holdout queries are deterministically selected via seed
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:100:  seed?: number;
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:108:  seed?: number;
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:207: * Simple seeded PRNG (mulberry32).
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:210:export function seededRandom(seed: number): () => number {
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:211:  let s = seed | 0;
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:227: * Uses a seeded PRNG for deterministic selection. When intentClasses
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:240:  const seed = opts.seed ?? 42;
...
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:253:  // Simple random sampling with deterministic seed
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:254:  const rng = seededRandom(seed);
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:267:  seed: number
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:269:  const rng = seededRandom(seed);
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:611:      seed: opts.seed,
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:7:// For results related to top seed results via weighted CTE.
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:14://   score = seedScore * edgePrior * hopDecay * freshness
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:27:/** Top fraction of result set used as graph walk seed nodes. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:29:/** Absolute cap on seed nodes regardless of result set size. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:282: * Formula: seedScore * edgePrior * hopDecay * freshness
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:284: * @param seedScore  - Base score of the seed node (0–1)
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:286: * @param hopDistance - Hop distance from seed (1 = direct neighbor)
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:291:  seedScore: number,
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:299:  return seedScore * edgePrior * hopDecay * freshness;
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:342:  seedScore: number;
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:349:  return params.seedScore *
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:410: * Walk causal edges up to maxHops from the given seed memory IDs,
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:527: *   score = seedScore * edgePrior * hopDecay * freshness
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:557:  const seedLimit = Math.max(1, Math.min(MAX_SEED_RESULTS, Math.ceil(results.length * SEED_FRACTION)));
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:558:  const seedResults = results.slice(0, seedLimit);
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:559:  const seedIds = seedResults.map((item) => item.id);
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:561:  const neighborBoosts = getNeighborBoosts(seedIds, effectiveMaxHops);
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:567:  // using the intent-aware traversal formula: seedScore * edgePrior * hopDecay * freshness.
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:568:  // We use the average seed score as the seedScore proxy and the actual hop distance
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:573:    const avgSeedScore = seedResults.length > 0
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:574:      ? seedResults.map((s) => resolveBaseScore(s)).reduce((a, b) => a + b, 0) / seedResults.length
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:580:      // so we use the seed's dominant relation by querying the first-hop edge from the DB.
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:587:            WHERE source_id IN (${seedIds.map(() => '?').join(',')})
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:590:          `) as Database.Statement).get(...seedIds.map(String), String(neighborId)) as
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:683: * even when the causal boost has no seed results.
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:692:  /** Edge relation types connecting seeds to neighbors. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:701: * Unlike applyCausalBoost, this runs even when there are no seed results,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:732:    const seedRows = (database.prepare(`
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:736:    if (seedRows.length === 0) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:740:    const seedIds = seedRows.map((r) => String(r.id));
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:741:    const seedPlaceholders = seedIds.map(() => '?').join(', ');
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:747:          WHEN ce.source_id IN (${seedPlaceholders}) THEN CAST(ce.target_id AS INTEGER)
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:752:      WHERE ce.source_id IN (${seedPlaceholders}) OR ce.target_id IN (${seedPlaceholders})
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:755:      ...seedIds,
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:756:      ...seedIds,
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:757:      ...seedIds,
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:762:    const seedIdSet = new Set(seedRows.map((r) => r.id));
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:765:      if (!seedIdSet.has(row.neighbor_id) && Number.isFinite(row.neighbor_id)) {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:4:// LLM-oriented compact graph neighborhoods with CocoIndex seed support.
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:9:import { resolveSeeds, type CodeGraphSeed, type ArtifactRef } from './seed-resolver.js';
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:11:export type QueryMode = 'neighborhood' | 'outline' | 'impact';
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:17:  seeds?: CodeGraphSeed[];
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:48:  const queryMode = args.queryMode ?? 'neighborhood';
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:50:  const seeds = args.seeds ?? [];
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:51:  const resolvedAnchors = resolveSeeds(seeds);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:53:  // If no seeds but subject given, create seed from subject
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:80:      // File anchor — get outline
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:81:      const outlineNodes = graphDb.queryOutline(anchor.filePath).slice(0, nodeLimit);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:84:        nodes: outlineNodes.map(n => ({ name: n.fqName, kind: n.kind, file: n.filePath, line: n.startLine })),
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:87:      totalNodes += outlineNodes.length;
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:126:    combinedSummary: 'Empty context — no seeds or subject resolved to graph nodes.',
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:146:  if (mode === 'neighborhood' && sections.some(s => s.edges.length > 5)) {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:147:    actions.push('Use `queryMode: "impact"` to see who calls these symbols');
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:149:  if (mode === 'impact') {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:150:    actions.push('Use `queryMode: "outline"` for file-level overview');
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:156:    actions.push('Narrow with `seeds[]` for more specific context');
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:190:    case 'neighborhood': {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:210:    case 'outline': {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:211:      const outlineNodes = graphDb.queryOutline(anchor.filePath);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:212:      for (const n of outlineNodes) {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:222:    case 'impact': {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:228:          console.warn(`[code-graph-context] impact query exceeded ${budgetMs}ms budget (${Math.round(elapsed)}ms elapsed), breaking early`);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:279: * Never-drops guarantee: always includes top seed, root anchor, one boundary edge, one next action.
.opencode/skills/system-spec-kit/mcp_server/lib/search/recovery-payload.ts:203:    // Step 1: Find seed memory IDs whose titles contain matched concepts
.opencode/skills/system-spec-kit/mcp_server/lib/search/recovery-payload.ts:207:    const seedRows = (db.prepare(`
.opencode/skills/system-spec-kit/mcp_server/lib/search/recovery-payload.ts:213:    if (seedRows.length === 0) return [];
.opencode/skills/system-spec-kit/mcp_server/lib/search/recovery-payload.ts:215:    const seedIds = seedRows.map((r) => String(r.id));
.opencode/skills/system-spec-kit/mcp_server/lib/search/recovery-payload.ts:216:    const seedPlaceholdersSql = seedIds.map(() => '?').join(', ');
.opencode/skills/system-spec-kit/mcp_server/lib/search/recovery-payload.ts:218:    // Step 2: Walk 1-hop causal edges from seeds to find neighbor nodes
.opencode/skills/system-spec-kit/mcp_server/lib/search/recovery-payload.ts:223:        (ce.source_id IN (${seedPlaceholdersSql}) AND mi.id = CAST(ce.target_id AS INTEGER))
.opencode/skills/system-spec-kit/mcp_server/lib/search/recovery-payload.ts:225:        (ce.target_id IN (${seedPlaceholdersSql}) AND mi.id = CAST(ce.source_id AS INTEGER))
.opencode/skills/system-spec-kit/mcp_server/lib/search/recovery-payload.ts:227:      WHERE mi.id NOT IN (${seedPlaceholdersSql})
.opencode/skills/system-spec-kit/mcp_server/lib/search/recovery-payload.ts:230:      ...seedIds,
.opencode/skills/system-spec-kit/mcp_server/lib/search/recovery-payload.ts:231:      ...seedIds,
.opencode/skills/system-spec-kit/mcp_server/lib/search/recovery-payload.ts:232:      ...seedIds,
.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:400: * Step-back abstraction + corpus seed grounding. Deep-mode only.
.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:608: * Runs concept routing + graph neighbor lookup even without seed results.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:800:                operation: 'migration_v14_backfill',
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:814:              operation: 'migration_v14_backfill',
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2006:      operation: 'create_common_indexes',
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2023:      operation: 'create_common_indexes',
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2040:      operation: 'create_common_indexes',
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2051:      operation: 'create_common_indexes',
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2062:      operation: 'create_common_indexes',
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2080:      operation: 'create_common_indexes',
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2091:      operation: 'create_common_indexes',
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:8:// Step-back abstraction combined with corpus seed grounding.
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:32:/** A single seed result used to ground the reformulation prompt. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:49:  /** Number of seed results to retrieve. Default: SEED_LIMIT. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:57:/** Number of seed results to retrieve for grounding. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:89: * Fast, low-cost seed retrieval for reformulation grounding.
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:100: * @returns Array of seed results (may be empty).
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:135: * Injects the original query and top-3 seed snippets so the LLM can
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:145: * @param seeds - Corpus seed results for grounding.
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:148:function buildReformulationPrompt(query: string, seeds: SeedResult[]): string {
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:149:  const seedBlock = seeds.length > 0
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:150:    ? seeds.map((s, i) => {
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:154:    : '(no corpus seeds available)';
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:158:    'Your task: given an original query and corpus seed excerpts, produce:',
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:163:    '  - Stay strictly grounded in the provided seed content.',
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:164:    '  - Do NOT invent concepts, entities, or facts not present in the seeds.',
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:165:    '  - If seeds are unavailable, use only the original query as grounding.',
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:173:    'Corpus seeds:',
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:174:    seedBlock,
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:317: * Matches the call site pattern: `await llm.rewrite({ q, seeds, mode })`.
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:326:   *   3. Build grounded prompt using seeds.
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:336:   * @param params.seeds - Seed results for corpus grounding.
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:342:    seeds: SeedResult[];
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:345:    const { q, seeds } = params;
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:366:      const prompt = buildReformulationPrompt(q, seeds);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:1260:      operation: 'get_memory_preview',
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:326:  options: { seedCandidates?: PipelineRow[]; seedLabel?: string } = {},
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:329:  const seedLabel = options.seedLabel ?? '';
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:331:  for (const row of options.seedCandidates ?? []) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:333:    merged.set(key, mergeCandidateRows(merged.get(key), row, seedLabel));
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1090:      const seeds = cheapSeedRetrieve(query, { limit: 3 });
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1091:      const reform = await llm.rewrite({ q: query, seeds, mode: 'step_back+corpus' });
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1142:              seedCandidates: candidates,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1143:              seedLabel: query,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1196:          seedCandidates: candidates,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1197:          seedLabel: query,
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:656:Top-ranked results seed a 2-hop BFS traversal over causal edges. Discovered neighbors receive a score boost with `SEED_FRACTION=0.25` strength. A `1/sqrt(neighbor_count)` fan-effect divisor (R17) prevents hub nodes from appearing in every co-activation result.
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-db.ts:414:/** Query: get file outline (nodes sorted by line) */
.opencode/skills/system-spec-kit/mcp_server/lib/search/encoding-intent.ts:11:// Scoring impact.
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:10:/** A seed from CocoIndex or other providers */
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:18:/** Native CocoIndex search result as a seed */
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:27:/** Manual seed with symbol name (no file path required) */
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:35:/** Pre-resolved graph node seed */
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:42:/** Union type for all seed kinds */
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:59:function hasProvider(seed: unknown, provider: string): boolean {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:60:  if (typeof seed !== 'object' || seed === null) {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:63:  return (seed as { provider?: unknown }).provider === provider;
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:66:function isCocoIndexSeed(seed: unknown): seed is CocoIndexSeed {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:67:  return hasProvider(seed, 'cocoindex');
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:70:function isManualSeed(seed: unknown): seed is ManualSeed {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:71:  return hasProvider(seed, 'manual');
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:74:function isGraphSeed(seed: unknown): seed is GraphSeed {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:75:  return hasProvider(seed, 'graph');
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:78:function throwResolutionError(operation: string, seed: unknown, err: unknown): never {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:80:  console.error(`[seed-resolver] ${operation} failed`, { seed, error: message });
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:81:  throw new Error(`[seed-resolver] ${operation} failed: ${message}`);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:86:/** Resolve a CocoIndex seed by converting to CodeGraphSeed and delegating */
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:87:export function resolveCocoIndexSeed(seed: CocoIndexSeed): ArtifactRef {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:89:    filePath: seed.file,
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:90:    startLine: seed.range.start,
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:91:    endLine: seed.range.end,
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:96:export function resolveManualSeed(seed: ManualSeed): ArtifactRef {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:101:    const params: unknown[] = [seed.symbolName];
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:103:    if (seed.filePath) {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:105:      params.push(seed.filePath);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:107:    if (seed.kind) {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:109:      params.push(seed.kind);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:128:    throwResolutionError('resolveManualSeed', seed, err);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:132:    filePath: seed.filePath ?? '<unknown>',
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:137:    kind: seed.kind ?? null,
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:144:export function resolveGraphSeed(seed: GraphSeed): ArtifactRef {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:150:    ).get(seed.symbolId) as Record<string, unknown> | undefined;
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:165:    throwResolutionError('resolveGraphSeed', seed, err);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:172:    symbolId: seed.symbolId,
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:180:/** Resolve a single seed to an ArtifactRef */
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:181:export function resolveSeed(seed: CodeGraphSeed): ArtifactRef {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:186:    if (seed.startLine) {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:192:      `).get(seed.filePath, seed.startLine) as Record<string, unknown> | undefined;
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:196:          filePath: seed.filePath,
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:212:      `).get(seed.filePath, seed.startLine, seed.startLine) as Record<string, unknown> | undefined;
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:215:        const distance = Math.abs((nearExact.start_line as number) - seed.startLine);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:217:          filePath: seed.filePath,
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:234:      `).get(seed.filePath, seed.startLine, seed.startLine) as Record<string, unknown> | undefined;
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:238:          filePath: seed.filePath,
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:252:      filePath: seed.filePath,
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:253:      startLine: seed.startLine ?? 1,
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:254:      endLine: seed.endLine ?? 1,
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:262:    throwResolutionError('resolveSeed', seed, err);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:266:/** Resolve any seed variant to an ArtifactRef */
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:267:function resolveAnySeed(seed: AnySeed): ArtifactRef {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:268:  if (isCocoIndexSeed(seed)) return resolveCocoIndexSeed(seed);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:269:  if (isManualSeed(seed)) return resolveManualSeed(seed);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:270:  if (isGraphSeed(seed)) return resolveGraphSeed(seed);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:271:  return resolveSeed(seed as CodeGraphSeed);
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:275:export function resolveSeeds(seeds: AnySeed[]): ArtifactRef[] {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:279:  for (const seed of seeds) {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts:280:    const ref = resolveAnySeed(seed);
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:25:// 2a. Co-activation spreading — spreading activation from top-N seeds
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:121:/** Number of top results used as seeds for co-activation spreading. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:933: *   2a. Co-activation      (spreading activation from top-N seeds)
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:1031:  // Only for hybrid search type — causal graph traversal is seeded from the
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:1055:  // Gated behind SPECKIT_COACTIVATION flag. Takes the top-N results as seeds,

mcp: cocoindex_code/search started
mcp: cocoindex_code/search (failed)
user cancelled MCP tool call
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/context-server.ts | sed -n '780,810p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts | sed -n '482,1040p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts | sed -n '1082,1210p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts | sed -n '1,220p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts | sed -n '184,460p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
   184	/** Handle memory_match_triggers tool - matches prompt against trigger phrases with cognitive decay */
   185	async function handleMemoryMatchTriggers(args: TriggerArgs): Promise<MCPResponse> {
   186	  const {
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts | sed -n '318,560p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts | sed -n '1,220p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts | sed -n '1,220p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts | sed -n '600,930p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
   600	  }
   601	
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/session/session-snapshot.ts | sed -n '180,260p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts | sed -n '930,1095p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/code-graph/seed-resolver.ts | sed -n '1,220p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts | sed -n '1,240p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ───────────────────────────────────────────────────────────────

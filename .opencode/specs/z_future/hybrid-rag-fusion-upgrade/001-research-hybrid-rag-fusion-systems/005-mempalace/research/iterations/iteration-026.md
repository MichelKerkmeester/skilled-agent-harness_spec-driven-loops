...
exec
/bin/zsh -lc "sed -n '1080,1325p' .opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
        resultsData = null;
      }
...
exec
/bin/zsh -lc "rg -n \"lexical|semantic|fts|bm25|hybrid|rrf|vector|embedding|keyword|query expansion|fallback|degrad\" .opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts .opencode/skills/system-spec-kit/mcp_server/context-server.ts .opencode/skills/system-spec-kit/mcp_server/lib -g '"'!**/*.map'"'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:763:    // Wait for embedding model only on cache miss
...
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:75:import * as vectorIndex from './lib/search/vector-index.js';
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:76:import * as _embeddings from './lib/providers/embeddings.js';
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:80:import * as hybridSearch from './lib/search/hybrid-search.js';
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:87:import * as bm25Index from './lib/search/bm25-index.js';
...
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:747:  const channels: string[] = ['vector', 'fts5'];
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:748:  if (bm25Index.isBm25Enabled()) channels.push('bm25');
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:945:      vectorIndex.initializeDb();
...
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1193:    const database = vectorIndex.getDb();
...
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1380:    runCleanupStep('vectorIndex', () => vectorIndex.closeDb());
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1410:  const database = vectorIndex.getDb();
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1437:      if (vectorIndex.deleteMemory(row.id)) {
...
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1554:  vectorIndex.initializeDb();
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1563:    vectorIndex,
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1566:    hybridSearch,
...
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1584:  // Mark embedding as "ready" since it will self-initialize on first use
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1589:    const report = vectorIndex.verifyIntegrity();
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1593:    // Validate embedding dimension matches database
...
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1605:    const database = vectorIndex.getDb();
...
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1669:    hybridSearch.init(database, vectorIndex.vectorSearch, graphSearchFn);
...
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1697:    if (bm25Index.isBm25Enabled()) {
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1699:        const bm25 = bm25Index.getIndex();
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1700:        const count = bm25.rebuildFromDatabase(database);
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1702:      } catch (bm25Err: unknown) {
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1703:        const message = bm25Err instanceof Error ? bm25Err.message : String(bm25Err);
...
.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1744:    // Processes memories with failed embeddings in the background
.opencode/skills/system-spec-kit/mcp_server/lib/session/session-snapshot.ts:27:  sessionQuality: 'healthy' | 'degraded' | 'critical' | 'unknown';
.opencode/skills/system-spec-kit/mcp_server/lib/session/session-snapshot.ts:185:    routingParts.push('semantic/concept search → mcp__cocoindex_code__search');
.opencode/skills/system-spec-kit/mcp_server/lib/session/context-metrics.ts:26:export type QualityLevel = 'healthy' | 'degraded' | 'critical';
.opencode/skills/system-spec-kit/mcp_server/lib/session/context-metrics.ts:218:  //                          degradation signal. A 60-min gap almost certainly means
.opencode/skills/system-spec-kit/mcp_server/lib/session/context-metrics.ts:242:  else if (score > 0.4) level = 'degraded';
...
.opencode/skills/system-spec-kit/mcp_server/lib/interfaces/README.md:6:  - "embedding provider interface"
...
.opencode/skills/system-spec-kit/mcp_server/lib/interfaces/README.md:39:| **Flexibility** | Swap backends (local vs API embeddings) via configuration |
.opencode/skills/system-spec-kit/mcp_server/lib/interfaces/README.md:51:> **Note**: Most source files (`embedding-provider.ts`, `index.ts`) were relocated to `@spec-kit/shared` during the shared package migration. `vector-store.ts` remains as a local stub/re-export.
.opencode/skills/system-spec-kit/mcp_server/lib/interfaces/README.md:55:├── vector-store.ts         # Vector store interface (stub/re-export from @spec-kit/shared)
.opencode/skills/system-spec-kit/mcp_server/lib/interfaces/README.md:63:| `embedding-provider.ts` | Relocated to `@spec-kit/shared` |
.opencode/skills/system-spec-kit/mcp_server/lib/interfaces/README.md:64:| `vector-store.ts` | **Remains locally** (stub/re-export) |
.opencode/skills/system-spec-kit/mcp_server/lib/interfaces/README.md:80:| `IVectorStore` | `vector-store.ts` | Abstract base class for JS runtime consumers; subclasses must implement search/upsert/delete/get/stats/availability/dimension/close |
.opencode/skills/system-spec-kit/mcp_server/lib/interfaces/README.md:100:import { IVectorStore } from './vector-store';
.opencode/skills/system-spec-kit/mcp_server/lib/interfaces/README.md:103:  async search(embedding, topK, options) { return []; }
.opencode/skills/system-spec-kit/mcp_server/lib/interfaces/README.md:104:  async upsert(id, embedding, metadata) { return 1; }
.opencode/skills/system-spec-kit/mcp_server/lib/interfaces/README.md:117:import { IVectorStore } from './vector-store';
.opencode/skills/system-spec-kit/mcp_server/lib/interfaces/README.md:139:| [./vector-store.ts](./vector-store.ts) | Local runtime abstract class contract |
.opencode/skills/system-spec-kit/mcp_server/lib/interfaces/README.md:140:| [../search/vector-index-impl.ts](../search/vector-index-impl.ts) | Main in-repo `IVectorStore` implementation |
...
.opencode/skills/system-spec-kit/mcp_server/lib/interfaces/vector-store.ts:14:  async search(_embedding: unknown, _topK: number, _options?: unknown): Promise<unknown[]> {
.opencode/skills/system-spec-kit/mcp_server/lib/interfaces/vector-store.ts:18:  async upsert(_id: string, _embedding: unknown, _metadata: Record<string, unknown>): Promise<number> {
.opencode/skills/system-spec-kit/mcp_server/lib/analytics/session-analytics-db.ts:313:    throw new Error('[session-analytics-db] Seeded model pricing is missing a sonnet fallback');
.opencode/skills/system-spec-kit/mcp_server/lib/validation/README.md:30:The validation subsystem provides pre-flight checks that run before expensive operations like embedding generation or database writes. It prevents invalid data from entering the system and provides actionable feedback for resolution.
.opencode/skills/system-spec-kit/mcp_server/lib/validation/README.md:38:| Quality Gate Layers | 3 | Structural, content quality, semantic dedup |
.opencode/skills/system-spec-kit/mcp_server/lib/validation/README.md:47:| **Duplicate Detection** | Exact (SHA-256 hash) and similar (vector similarity) duplicate finding |
.opencode/skills/system-spec-kit/mcp_server/lib/validation/README.md:50:| **Save Quality Gate** | 3-layer pre-storage validation (structural, content quality scoring, semantic dedup). Behind `SPECKIT_SAVE_QUALITY_GATE` flag |
.opencode/skills/system-spec-kit/mcp_server/lib/validation/README.md:60: save-quality-gate.ts # 3-layer pre-storage quality gate (structural, content, semantic dedup)
.opencode/skills/system-spec-kit/mcp_server/lib/validation/README.md:69:| `save-quality-gate.ts` | 3-layer pre-storage quality gate: structural validation, content quality scoring (title, triggers, length, anchors, metadata, signal density), and semantic dedup. Behind `SPECKIT_SAVE_QUALITY_GATE` flag with 14-day warn-only graduation period |
.opencode/skills/system-spec-kit/mcp_server/lib/validation/README.md:94:| Similar | Vector similarity | Requires embedding |
.opencode/skills/system-spec-kit/mcp_server/lib/validation/README.md:98:Prevents exceeding embedding API limits:
.opencode/skills/system-spec-kit/mcp_server/lib/validation/README.md:180:| `cosineSimilarity(a, b)` | Cosine similarity between two vectors |
.opencode/skills/system-spec-kit/mcp_server/lib/validation/README.md:181:| `checkSemanticDedup(params)` | Layer 3: semantic dedup check |
.opencode/skills/system-spec-kit/mcp_server/lib/validation/README.md:260:  embedding: embeddingVector,
.opencode/skills/system-spec-kit/mcp_server/lib/validation/README.md:261:  findSimilar: (emb, opts) => vectorStore.search(emb, opts),
.opencode/skills/system-spec-kit/mcp_server/lib/validation/README.md:277:| Token estimate | `estimateTokens()` | Before embedding API |
...
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:72:    semanticDedup: SemanticDedupResult | null;
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:84:  embedding?: Float32Array | number[] | null;
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:90:/** Callback for finding similar memories by embedding */
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:92:  embedding: Float32Array | number[],
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:172:    const db = vectorIndex.getDb();
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:189:    const db = vectorIndex.getDb();
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:205:    const db = vectorIndex.getDb();
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:659: * Compute cosine similarity between two vectors.
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:661: * @param a - First vector
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:662: * @param b - Second vector
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:686: * Layer 3: Check for semantic near-duplicates using vector similarity.
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:688: * Compares the new memory's embedding against existing memories in
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:692: * @param embedding - The embedding vector of the new memory
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:694: * @param findSimilar - Callback to find similar memories by embedding
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:698:  embedding: Float32Array | number[],
...
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:785:        semanticDedup: null,
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:817:  // Layer 3: Semantic dedup (only if embedding and findSimilar are available)
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:818:  let semanticDedup: SemanticDedupResult | null = null;
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:819:  if (params.embedding && params.findSimilar) {
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:820:    semanticDedup = checkSemanticDedup(
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:821:      params.embedding,
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:825:    if (semanticDedup.reason) {
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:826:      allReasons.push(semanticDedup.reason);
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:833:    || (semanticDedup !== null && !semanticDedup.pass);
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:852:      semanticDedup,
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:102:  embedding?: Float32Array | number[];
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:123:  embedding?: Float32Array | number[];
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:197:type FindSimilarFn = (embedding: Float32Array | number[], options: {
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:424:    embedding,
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:566:  // Check 2: Similar duplicate via vector similarity (requires embedding)
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:567:  if (check_similar && find_similar && embedding) {
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:569:      const candidates = find_similar(embedding, {
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:627:  include_embedding_overhead?: boolean;
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:632:    include_embedding_overhead = true,
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:652:  // Add overhead for embedding API call (context + response)
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:653:  if (include_embedding_overhead) {
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:654:    const embeddingOverhead = 150;
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:655:    estimated += embeddingOverhead;
.opencode/skills/system-spec-kit/mcp_server/lib/validation/preflight.ts:758:    embedding,
...
.opencode/skills/system-spec-kit/mcp_server/lib/extraction/entity-extractor.ts:98:  // Rule 3: Words after key phrases — keywords are case-insensitive via explicit
.opencode/skills/system-spec-kit/mcp_server/lib/storage/schema-downgrade.ts:48:  'embedding_model',
.opencode/skills/system-spec-kit/mcp_server/lib/storage/schema-downgrade.ts:49:  'embedding_generated_at',
.opencode/skills/system-spec-kit/mcp_server/lib/storage/schema-downgrade.ts:50:  'embedding_status',
.opencode/skills/system-spec-kit/mcp_server/lib/storage/schema-downgrade.ts:124:      embedding_model TEXT,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/schema-downgrade.ts:125:      embedding_generated_at TEXT,
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/schema-downgrade.ts:151:        CHECK(memory_type IN ('working', 'episodic', 'prospective', 'implicit', 'declarative', 'procedural', 'semantic', 'autobiographical', 'meta-cognitive')),
.opencode/skills/system-spec-kit/mcp_server/lib/storage/schema-downgrade.ts:154:        CHECK(type_inference_source IN ('frontmatter_explicit', 'importance_tier', 'file_path', 'keywords', 'default', 'manual')),
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/schema-downgrade.ts:193:    CREATE INDEX IF NOT EXISTS idx_embedding_pending
...
.opencode/skills/system-spec-kit/mcp_server/lib/extraction/extraction-adapter.ts:113:    // Intentional no-op — error deliberately discarded for fail-safe fallback
.opencode/skills/system-spec-kit/mcp_server/lib/extraction/extraction-adapter.ts:181:    // Intentional no-op — error deliberately discarded for fail-safe fallback
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:36:  conflictType: 'keyword_negation' | 'semantic_opposition';
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:66:/** Consolidation cadence for runtime hook (weekly batch semantics) */
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:83: * 2. Conflict check — keyword negation heuristic
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:85: * Returns pairs that are both semantically similar AND contain
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:130:  // Get all non-deprecated, non-chunk memories with embeddings
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:132:    SELECT m.id, m.title, m.content_text, v.embedding
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:145:    embedding: Buffer;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:149:  // A 5-second deadline prevents runaway CPU when embeddings are large or the
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:161:        new Float32Array(memories[i].embedding.buffer, memories[i].embedding.byteOffset, memories[i].embedding.byteLength / 4),
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:162:        new Float32Array(memories[j].embedding.buffer, memories[j].embedding.byteOffset, memories[j].embedding.byteLength / 4),
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:174:            conflictType: 'keyword_negation',
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:209:  // Unbounded CPU usage in the heuristic O(n^2) fallback path.
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:228:          conflictType: 'keyword_negation',
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:244:  for (const keyword of NEGATION_KEYWORDS) {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:245:    const inA = lowerA.includes(keyword);
.opencode/skills/system-spec-kit/mcp_server/lib/storage/consolidation.ts:246:    const inB = lowerB.includes(keyword);
.opencode/skills/system-spec-kit/mcp_server/lib/extraction/README.md:44:| **Memory ID Resolution** | Deterministic ID fallback ensures stable identity across extraction runs |
.opencode/skills/system-spec-kit/mcp_server/lib/extraction/README.md:74:| `extraction-adapter.ts` | Resolves memory IDs with deterministic fallback; orchestrates post-tool extraction pipeline | — |
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:6:// Gzip-compressed database checkpoints with embedding preservation
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:98:    'memory_fts',
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:103:    'embedding_cache',
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:186:  embedding: Buffer | null;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:205:  vectors?: SnapshotVectorRow[];
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:637:    return ['rowid', 'embedding'];
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:673:        'SELECT rowid AS rowid, embedding FROM vec_memories WHERE rowid IN (__PLACEHOLDERS__)',
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:679:      SELECT v.rowid AS rowid, v.embedding AS embedding
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:686:      'SELECT rowid AS rowid, embedding FROM vec_memories'
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:853:  if (Array.isArray(snapshot.vectors)) {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:855:      columns: ['rowid', 'embedding'],
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:856:      rows: snapshot.vectors.map((row) => ({
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:858:        embedding: row.embedding,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:886:  if (tableName === 'memory_fts') {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:887:    database.exec(`INSERT INTO memory_fts(memory_fts) VALUES('delete-all')`);
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:1047:    if (tableName === 'memory_fts') {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:1218:      name: 'fts-rebuild',
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:1221:        if (tableExists(database, 'memory_fts')) {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:1222:          database.exec(`INSERT INTO memory_fts(memory_fts) VALUES('rebuild')`);
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:1320:    'embedding_model',
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:1321:    'embedding_generated_at',
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:1322:    'embedding_status',
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:1375: * Optional fields (anchor_id, embedding_*, etc.) may be null/undefined for
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:1452:      const vectorRows = tables.vec_memories?.rows ?? [];
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:1455:      const vectors = vectorRows.map((row) => ({
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:1457:        embedding: toBuffer(row.embedding),
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:1465:        vectors,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/checkpoints.ts:1492:          vectorCount: vectors.length,
.opencode/skills/system-spec-kit/mcp_server/lib/config/README.md:42:| **Automatic Inference** | Detect memory type from path, frontmatter, or keywords |
.opencode/skills/system-spec-kit/mcp_server/lib/config/README.md:74:| **semantic** | 180 days | Never | Core concepts: architecture, design principles |
.opencode/skills/system-spec-kit/mcp_server/lib/config/README.md:95:| critical | semantic | Core concepts, high persistence |
.opencode/skills/system-spec-kit/mcp_server/lib/config/README.md:109:| `architecture`, `adr-\d+` | semantic | `docs/adr-001.md` |
.opencode/skills/system-spec-kit/mcp_server/lib/config/README.md:132:| `memory-types.ts` | Type definitions, half-lives, path/keyword patterns |
.opencode/skills/system-spec-kit/mcp_server/lib/config/README.md:170:  content: '---\nmemory_type: semantic\n---\n# Architecture Overview',
...
.opencode/skills/system-spec-kit/mcp_server/lib/config/README.md:174:// From keywords
...
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:35:The telemetry module provides structured observability for the retrieval pipeline and scoring subsystem. It records per-stage latency, search mode selection, fallback triggers, composite quality scores, scoring observation samples, trace payload validation, and agent consumption events. Telemetry data flows to governance tooling and is used by retrieval handlers to surface pipeline health metrics.
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:52:| **FallbackMetrics** | Fallback trigger detection, optional reason string, and degraded-mode flag |
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:108:When `SPECKIT_EXTENDED_TELEMETRY` is disabled (default), the minimal `RetrievalTelemetry` shell is still created so callers can rely on a stable shape. Latency, mode, fallback, quality, graph-health, and adaptive sub-metrics remain zeroed/empty, while the baseline architecture snapshot still records the current memory-roadmap phase/capability defaults.
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:120:| `fallback` | `FallbackMetrics` | Fallback trigger record |
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:148:| `selectedMode` | `string \| null` | Mode chosen for this run (e.g., `hybrid`, `auto`, `deep`) |
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:155:**Purpose**: Record whether and why the pipeline fell back to a degraded path.
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:159:| `fallbackTriggered` | `boolean` | Whether any fallback was activated |
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:160:| `fallbackReason` | `string \| undefined` | Human-readable reason for fallback (omitted when not triggered) |
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:161:| `degradedModeActive` | `boolean` | Whether the run completed in degraded mode |
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:183:| < 0.40 | Poor -- review fallback policy |
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:222:**Purpose**: Summarize graph-walk rollout semantics and bounded contribution diagnostics for a retrieval run.
...
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:361:const fallback: FallbackMetrics = {
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:362:  fallbackTriggered: false,
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:363:  degradedModeActive: false,
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:380:  fallback,
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:445:| Check `fallback.fallbackTriggered` to gate quality alerts | Governance / SLO monitoring |
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/README.md:446:| Use `quality.qualityProxyScore < 0.6` to log degraded-run warnings | Observability dashboards |
.opencode/skills/system-spec-kit/mcp_server/lib/response/profile-formatters.ts:35:  rrfScore?: number;
.opencode/skills/system-spec-kit/mcp_server/lib/response/profile-formatters.ts:130:    rrfScore: typeof result.rrfScore === 'number' ? result.rrfScore : undefined,
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/content-normalizer.ts:10:// Table syntax, fence markers, checkbox notation) that degrades
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/content-normalizer.ts:11:// The quality of semantic embeddings and keyword retrieval.
...
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/content-normalizer.ts:30: * including it verbatim in the embedding text just adds repetitive
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/content-normalizer.ts:81: * tokens like "typescript" or "json" carry no semantic signal about
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/content-normalizer.ts:166: * numbering carries no semantic meaning for retrieval.
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/content-normalizer.ts:197: * Normalize markdown content for use in embedding generation.
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/content-normalizer.ts:209: * The result is a clean prose representation suitable for semantic
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/content-normalizer.ts:210: * embedding models (nomic-embed-text-v1.5 and compatible providers).
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/content-normalizer.ts:235: * Normalize markdown content for use in BM25 keyword indexing.
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/content-normalizer.ts:238: * embedding pipeline.  Code fence markers (``` + lang id) are stripped
...
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/content-normalizer.ts:257:  // Steps as the embedding pipeline (frontmatter, anchors, HTML
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/content-normalizer.ts:261:  // Can diverge in the future without modifying the embedding path.
...
.opencode/skills/system-spec-kit/mcp_server/lib/contracts/README.md:50:| **ContextEnvelope\<T\>** | Generic typed wrapper for pipeline results with trace and degraded-mode metadata |
.opencode/skills/system-spec-kit/mcp_server/lib/contracts/README.md:87:**Purpose**: Generic typed wrapper for pipeline results with trace and degraded-mode metadata.
.opencode/skills/system-spec-kit/mcp_server/lib/contracts/README.md:93:| `degradedMode` | `DegradedModeContract?` | Optional degraded mode contract if any stage failed |
.opencode/skills/system-spec-kit/mcp_server/lib/contracts/README.md:130:| `fallback_mode` | `string` | Fallback strategy applied |
.opencode/skills/system-spec-kit/mcp_server/lib/contracts/README.md:133:| `degradedStages` | `RetrievalStage[]` | Stages affected by the degradation |
.opencode/skills/system-spec-kit/mcp_server/lib/contracts/README.md:153:| `fallback` | Fallback path (degraded mode) |
...
.opencode/skills/system-spec-kit/mcp_server/lib/contracts/README.md:163:| `createEnvelope(data, trace, degradedMode?, serverVersion?)` | `ContextEnvelope<T>` | New envelope wrapping results + trace + metadata |
.opencode/skills/system-spec-kit/mcp_server/lib/contracts/README.md:227:// Reranker timed out -- signal degraded mode
.opencode/skills/system-spec-kit/mcp_server/lib/contracts/README.md:228:const degraded = createDegradedContract(
...
.opencode/skills/system-spec-kit/mcp_server/lib/contracts/README.md:246:| Signal failure | `createDegradedContract(failure, fallback, impact, retry, stages)` | When a stage falls back or fails |
.opencode/skills/system-spec-kit/mcp_server/lib/contracts/README.md:247:| Wrap output | `createEnvelope(data, trace, degraded?)` | Before returning from retrieval handler |
.opencode/skills/system-spec-kit/mcp_server/lib/storage/transaction-manager.ts:349:      // Node 18 compatibility fallback when recursive readdir is unavailable.
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/working-memory.ts:613:        // Mention boost can push rawScore above 1.0 which breaks [0,1] score semantics.
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:36:  | 'semantic'
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:94:  semantic: {
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:124:  'semantic',
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:180:  { pattern: /architecture/i, type: 'semantic' },
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:181:  { pattern: /design[-_]?doc/i, type: 'semantic' },
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:182:  { pattern: /adr[-_]?\d+/i, type: 'semantic' },
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:243:  'architecture': 'semantic',
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:244:  'design': 'semantic',
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:245:  'principle': 'semantic',
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:246:  'concept': 'semantic',
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:247:  'decision': 'semantic',
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:355:    semantic: 180,
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:391:  { filePattern: /(?:^|\/)spec\.md$/i,                    documentType: 'spec',                    memoryType: 'semantic',    defaultImportanceTier: 'important', defaultImportanceWeight: 0.8 },
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:392:  { filePattern: /(?:^|\/)plan\.md$/i,                    documentType: 'plan',                    memoryType: 'semantic',    defaultImportanceTier: 'important', defaultImportanceWeight: 0.7 },
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:395:  { filePattern: /(?:^|\/)decision-record\.md$/i,         documentType: 'decision_record',         memoryType: 'semantic',    defaultImportanceTier: 'important', defaultImportanceWeight: 0.8 },
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:396:  { filePattern: /(?:^|\/)implementation-summary\.md$/i,  documentType: 'implementation_summary',  memoryType: 'semantic',    defaultImportanceTier: 'normal',    defaultImportanceWeight: 0.6 },
.opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts:397:  { filePattern: /(?:^|\/)(?:research\/research\.md|research\.md)$/i, documentType: 'research', memoryType: 'semantic', defaultImportanceTier: 'normal', defaultImportanceWeight: 0.6 },
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:35: * Checks `score`, then `similarity`, then `rrfScore` — returns 0 if none found.
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:48:  const rrfScore = row.rrfScore;
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:49:  if (typeof rrfScore === 'number' && Number.isFinite(rrfScore)) {
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/eval-channel-tracking.ts:50:    return rrfScore;
...
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:6:import * as vectorIndex from '../search/vector-index.js';
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:17:  keywords: string[];
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:58:  degraded?: TriggerMatcherDegradedState;
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:179:  WHERE embedding_status = 'success'
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:352:    vectorIndex.initializeDb();
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:353:    const db = vectorIndex.getDb();
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:553:  // Check CORRECTION keywords
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:563:      keywords: correctionHits,
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:568:  // Check PREFERENCE keywords
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:578:      keywords: preferenceHits,
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:583:  // Check REINFORCEMENT keywords
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:593:      keywords: reinforcementHits,
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:720:      ...(lastDegradedState ? { degraded: lastDegradedState } : {}),
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/README.md:37:- The primary memory schema is at `SCHEMA_VERSION = 23` in `lib/search/vector-index-schema.ts`.
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/README.md:71:- `checkpoints.ts` supports working-memory snapshots, while restore flows still require a re-index pass to rebuild embeddings.
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/confidence-tracker.ts:174:    // T-07: Replace success-shaped fallback with explicit failure signaling.
.opencode/skills/system-spec-kit/mcp_server/lib/storage/document-helpers.ts:17: * @param filePath - Source file path used for fallback heuristics.
.opencode/skills/system-spec-kit/mcp_server/lib/storage/document-helpers.ts:48: * @returns True when the document participates in spec-level semantics.
.opencode/skills/system-spec-kit/mcp_server/lib/config/type-inference.ts:31:  source: 'frontmatter_explicit' | 'importance_tier' | 'file_path' | 'keywords' | 'default';
.opencode/skills/system-spec-kit/mcp_server/lib/config/type-inference.ts:61:  critical: 'semantic',              // Core concepts, high persistence
.opencode/skills/system-spec-kit/mcp_server/lib/config/type-inference.ts:141:    return 'semantic';
.opencode/skills/system-spec-kit/mcp_server/lib/config/type-inference.ts:184:  // Score each type based on keyword matches
.opencode/skills/system-spec-kit/mcp_server/lib/config/type-inference.ts:187:  for (const [keyword, type] of Object.entries(KEYWORD_TYPE_MAP)) {
.opencode/skills/system-spec-kit/mcp_server/lib/config/type-inference.ts:188:    if (fullText.includes(keyword.toLowerCase())) {
.opencode/skills/system-spec-kit/mcp_server/lib/config/type-inference.ts:190:      // Longer keywords get higher scores (more specific)
.opencode/skills/system-spec-kit/mcp_server/lib/config/type-inference.ts:191:      typeScores.set(type, currentScore + keyword.length);
.opencode/skills/system-spec-kit/mcp_server/lib/config/type-inference.ts:275:  // 5. Check keyword analysis
.opencode/skills/system-spec-kit/mcp_server/lib/config/type-inference.ts:276:  const keywordType = inferTypeFromKeywords(title, triggerPhrases, content);
.opencode/skills/system-spec-kit/mcp_server/lib/config/type-inference.ts:277:  if (keywordType) {
.opencode/skills/system-spec-kit/mcp_server/lib/config/type-inference.ts:279:      type: keywordType,
.opencode/skills/system-spec-kit/mcp_server/lib/config/type-inference.ts:280:      source: 'keywords',
.opencode/skills/system-spec-kit/mcp_server/lib/config/type-inference.ts:307:    // L1 FIX: Use index-based fallback key to avoid collapsing pathless inputs
...
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/tier-classifier.ts:17: * fallbacks, search-enriched properties, etc.).
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:5:// Captures latency, mode selection, fallback, and quality-proxy
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:71:  fallbackTriggered: boolean;
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:72:  fallbackReason?: string;
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:73:  degradedModeActive: boolean;
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:162:  fallback: FallbackMetrics;
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:197:    fallback: {
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:198:      fallbackTriggered: false,
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:199:      degradedModeActive: false,
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:266:  t.fallback.fallbackTriggered = true;
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:268:    t.fallback.fallbackReason = reason;
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:270:  t.fallback.degradedModeActive = true;
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:643:  const fallbackPayload: Record<string, unknown> = {
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:644:    fallbackTriggered: t.fallback.fallbackTriggered,
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:645:    degradedModeActive: t.fallback.degradedModeActive,
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:647:  if (typeof t.fallback.fallbackReason === 'string' && t.fallback.fallbackReason.length > 0) {
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:648:    fallbackPayload.fallbackReason = t.fallback.fallbackReason;
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:662:    fallback: fallbackPayload,
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/README.md:28:- `content-normalizer.ts` for embedding/BM25-safe normalization.
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/README.md:36:| `content-normalizer.ts` | Strips frontmatter, anchors, HTML comments, fences, tables, list syntax, and heading markers before embedding or BM25 work |
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/README.md:47:- `content-normalizer.ts` is the shared normalization path for both embedding generation and BM25 token building.
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/README.md:262:> but the camelCase variant is always `undefined`. The `??` fallback chain ensures
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:9:import * as bm25Index from '../search/bm25-index.js';
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:10:import * as embeddingsProvider from '../providers/embeddings.js';
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:12:import { ensureLineageTables } from '../search/vector-index-schema.js';
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:14:import { to_embedding_buffer } from '../search/vector-index-types.js';
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:167:  embedding: Float32Array | null;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:168:  embeddingFailureReason: string | null;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:442:  const { database, parsed, filePath, embedding, embeddingFailureReason } = params;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:452:  const embeddingStatus = embedding
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:466:      embedding_model,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:467:      embedding_generated_at,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:468:      embedding_status,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:486:    embeddingsProvider.getModelName(),
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:487:    embedding ? now : null,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:488:    embeddingStatus,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:489:    embeddingFailureReason,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:512:  if (embedding && sqlite_vec_available()) {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:513:    const expectedDim = get_embedding_dim();
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:514:    if (embedding.length !== expectedDim) {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:515:      throw new Error(`Embedding must be ${expectedDim} dimensions, got ${embedding.length}`);
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:519:      INSERT INTO vec_memories (rowid, embedding)
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:521:    `).run(BigInt(memoryId), to_embedding_buffer(embedding));
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:524:  if (bm25Index.isBm25Enabled()) {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts:526:      bm25Index.getIndex().addDocument(String(memoryId), bm25Index.buildBm25DocumentText({
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:64:let bm25IndexModule: Bm25IndexModule | null = null;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:65:let bm25IndexModulePromise: Promise<Bm25IndexModule | null> | null = null;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:68:  if (bm25IndexModule !== null) {
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:69:    return bm25IndexModule;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:71:  if (bm25IndexModulePromise !== null) {
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:72:    return bm25IndexModulePromise;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:75:  const primaryModulePath = '../search/bm25-index.js';
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:76:  const fallbackModulePath = '../../search/bm25-index.js';
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:80:      bm25IndexModule = await import(primaryModulePath) as Bm25IndexModule;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:81:      return bm25IndexModule;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:86:        bm25IndexModule = await import(fallbackModulePath) as Bm25IndexModule;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:87:        return bm25IndexModule;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:88:      } catch (fallbackError: unknown) {
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:89:        const fallbackMessage = fallbackError instanceof Error ? fallbackError.message : String(fallbackError);
...
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:98:  bm25IndexModulePromise = loadPromise;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:102:    if (bm25IndexModulePromise === loadPromise) {
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:103:      bm25IndexModulePromise = null;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:109:  if (bm25IndexModule !== null) return bm25IndexModule;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:110:  if (bm25IndexModulePromise === null) {
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:120:let embeddingsModule: EmbeddingModule | null = null;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:121:let embeddingsModulePromise: Promise<EmbeddingModule | null> | null = null;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:124:  if (embeddingsModule !== null) {
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:125:    return embeddingsModule;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:127:  if (embeddingsModulePromise !== null) {
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:128:    return embeddingsModulePromise;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:131:  const primaryModulePath = '../providers/embeddings.js';
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:132:  const fallbackModulePath = '../../providers/embeddings.js';
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:136:      embeddingsModule = await import(primaryModulePath) as EmbeddingModule;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:137:      return embeddingsModule;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:142:        embeddingsModule = await import(fallbackModulePath) as EmbeddingModule;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:143:        return embeddingsModule;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:144:      } catch (fallbackError: unknown) {
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:145:        const fallbackMessage = fallbackError instanceof Error ? fallbackError.message : String(fallbackError);
...
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:154:  embeddingsModulePromise = loadPromise;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:158:    if (embeddingsModulePromise === loadPromise) {
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:159:      embeddingsModulePromise = null;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:165:  if (embeddingsModule !== null) return embeddingsModule;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:166:  if (embeddingsModulePromise === null) {
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:173:  embeddingsModule = module;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:174:  embeddingsModulePromise = null;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:491:  const bm25 = getBm25Index();
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:492:  if (!db || !bm25 || !bm25.isBm25Enabled()) return;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:495:    bm25.getIndex().removeDocument(String(memoryId));
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:502:// Vector-only deletion — removes the vec_memories embedding row without
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:520:  const bm25 = getBm25Index();
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:521:  if (!db || !bm25 || !bm25.isBm25Enabled()) return;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:534:    const text = bm25.buildBm25DocumentText(row);
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:536:    bm25.getIndex().addDocument(String(memoryId), text);
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/archival-manager.ts:544: * Defer vector re-embedding to the next index scan rather than rebuilding immediately.
...
.opencode/skills/system-spec-kit/mcp_server/lib/graph/community-summaries.ts:101:    const fallbackIds = memberIds.slice(0, 3).map(String);
.opencode/skills/system-spec-kit/mcp_server/lib/graph/community-summaries.ts:102:    sentences.push(`The cluster is currently identified by member IDs ${formatList(fallbackIds)}.`);
.opencode/skills/system-spec-kit/mcp_server/lib/config/capability-flags.ts:45: * | `regex`      | Lightweight regex-based fallback — no WASM dependencies     |
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts:92:  fallbackTier?: string | null;
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts:589:  // Method 2: Find ## Trigger Phrases section (fallback/additional)
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts:631:  const { documentType = null, fallbackTier = null } = options;
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts:658:  if (fallbackTier && isValidTier(fallbackTier)) {
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts:659:    return normalizeTier(fallbackTier);
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/interference-scoring.ts:80: * This is a lightweight heuristic used when vector cosine similarity
.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/trace-schema.ts:15:  'fallback',
.opencode/skills/system-spec-kit/mcp_server/lib/errors/core.ts:17:// Feature catalog: Stage 3 effectiveScore fallback chain
.opencode/skills/system-spec-kit/mcp_server/lib/errors/core.ts:188:    { pattern: /embedding.*failed/i, message: 'Failed to generate embedding. Search may be unavailable.' },
.opencode/skills/system-spec-kit/mcp_server/lib/errors/core.ts:268:  // Legacy fallback patterns
.opencode/skills/system-spec-kit/mcp_server/lib/errors/core.ts:300:  // Legacy fallback patterns
.opencode/skills/system-spec-kit/mcp_server/lib/errors/core.ts:350:  // Extract error code (from MemoryError or fallback)
.opencode/skills/system-spec-kit/mcp_server/lib/context/shared-payload.ts:146:  source: 'memory' | 'code-graph' | 'semantic' | 'session' | 'operational';
.opencode/skills/system-spec-kit/mcp_server/lib/context/shared-payload.ts:303:    // fallbacks are preserved separately and map to the nearest legacy parser
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:6:// After embedding generation, check top-3 most similar memories
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:19:import * as bm25Index from '../search/bm25-index.js';
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:20:import { clear_search_cache } from '../search/vector-index-aliases.js';
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:21:import { refresh_interference_scores_for_folder } from '../search/vector-index-store.js';
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:59:  embedding: Float32Array | number[];
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:113:/** Callback for finding similar memories by embedding */
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:115:  embedding: Float32Array | number[],
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:122:/** Callback for generating an embedding from content */
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:154: * @param embedding - The embedding vector to compare against
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:156: * @param findSimilar - Callback to find similar memories by embedding
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:161:  embedding: Float32Array | number[],
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:167:    return findSimilar(embedding, { limit, specFolder });
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:203: * memory, boosts the importance_weight, and updates the embedding
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:209: * @param generateEmbedding - Optional callback to regenerate embedding for merged content
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:220:  let bm25RepairWarning: string | null = null;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:239:    // Generate embedding BEFORE transaction (async I/O cannot run inside
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:247:        console.warn('[reconsolidation] Failed to regenerate embedding for merge:', msg);
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:248:        // Non-fatal: merged content is stored even without updated embedding
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:252:    let bm25RepairNeeded = false;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:269:        SELECT embedding
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:272:      `).get(existingMemory.id) as { embedding?: Buffer } | undefined;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:274:        ? embeddingToBuffer(newEmbedding)
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:275:        : (reusedEmbeddingRow?.embedding ?? null);
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:282:      mergedBm25DocumentText = bm25Index.buildBm25DocumentText({
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:308:        embedding_status: mergedEmbeddingStatus,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:309:        embedding_model: getOptionalString(currentRow, 'embedding_model'),
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:310:        embedding_generated_at: mergedEmbeddingBuffer ? now : getOptionalString(currentRow, 'embedding_generated_at'),
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:314:        bm25_repair_needed: 0,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:329:          INSERT INTO vec_memories (rowid, embedding)
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:337:        embedding_status: mergedEmbeddingStatus,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:358:      if (bm25Index.isBm25Enabled()) {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:360:          const bm25 = bm25Index.getIndex();
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:361:          bm25.removeDocument(String(existingMemory.id));
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:362:          bm25.addDocument(String(newId), mergedBm25DocumentText);
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:363:        } catch (bm25Err: unknown) {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:364:          const message = bm25Err instanceof Error ? bm25Err.message : String(bm25Err);
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:366:          bm25RepairNeeded = true;
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:392:    if (bm25RepairNeeded) {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:400:        bm25RepairWarning =
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:414:      warnings: bm25RepairWarning ? [bm25RepairWarning] : undefined,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:467: * Legacy fallback (when no new ID is available):
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:522:      // Atomic transaction: content + embedding + hash update together.
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:534:        if (newMemory.embedding) {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:535:          const buffer = embeddingToBuffer(newMemory.embedding);
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:537:            'UPDATE vec_memories SET embedding = ? WHERE rowid = ?'
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:624:    newMemory.embedding,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:723: * Convert an embedding array to a Buffer for SQLite storage.
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:725: * @param embedding - The embedding as Float32Array or number[]
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:726: * @returns Buffer representation of the embedding
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:728:function embeddingToBuffer(embedding: Float32Array | number[]): Buffer {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:729:  if (embedding instanceof Float32Array) {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:730:    return Buffer.from(embedding.buffer, embedding.byteOffset, embedding.byteLength);
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:732:  return Buffer.from(new Float32Array(embedding).buffer);
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:740:  if (!bm25Index.isBm25Enabled()) {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:745:    const bm25 = bm25Index.getIndex();
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:747:      bm25.removeDocument(String(args.previousMemoryId));
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:749:    bm25.removeDocument(String(args.memoryId));
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:750:    bm25.addDocument(String(args.memoryId), args.documentText);
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:768:  if (tableColumns.has('bm25_repair_needed')) {
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:774:    tableColumns.add('bm25_repair_needed');
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:778:      tableColumns.add('bm25_repair_needed');
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:781:    console.warn('[reconsolidation] Failed to ensure bm25_repair_needed column:', message);
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:791:  if (!tableColumns.has('bm25_repair_needed')) {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:798:      SET bm25_repair_needed = ?,
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:804:    console.warn(`[reconsolidation] Failed to persist bm25_repair_needed=${repairNeeded ? 1 : 0} for memory ${memoryId}: ${message}`);
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:900:  const fallbackFields: Record<keyof PostInsertMetadataFields, unknown> = {
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:932:  for (const key of Object.keys(fallbackFields) as Array<keyof PostInsertMetadataFields>) {
.opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts:936:    const value = preferredFields[key] ?? fallbackFields[key];
.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:65:- Purpose: Owns short-lived caching for expensive operations, especially tool output reuse and embedding reuse. This module is an infrastructure concern, not a ranking or retrieval-policy layer.
.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:67:  - `embedding-cache.ts` — persistent embedding cache used to avoid duplicate embedding generation.
.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:81:  - `anchor-chunker.ts` — anchor-first, heading-fallback chunk generation for large files.
.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:156:  - `bm25-baseline.ts` — lexical-only baseline measurement.
.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:218:- Purpose: Owns local runtime abstractions for vector-store behavior and documents the shared-package migration of interface types. It is the compatibility boundary between in-repo consumers and `@spec-kit/shared` contracts.
.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:220:  - `vector-store.ts` — local abstract base class for JS/runtime vector-store implementations.
.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:270:- Purpose: Owns embedding provider abstraction and retry orchestration. It is the provider-facing infrastructure boundary between retrieval/indexing code and concrete embedding backends.
.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:272:  - `embeddings.ts` — shared-package-backed embeddings surface used by index/search code.
...
.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:315:  - `hybrid-search.ts` — main hybrid retrieval entry point across search channels.
.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:317:  - `vector-index-store.ts` — vector-store abstraction bridge and core index operations.
.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:318:  - `vector-index-schema.ts` — schema creation and schema-safety helpers for search storage.
.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:352:  - `incremental-index.ts` — incremental indexing and deferred lexical-only indexing helpers.
.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:401:  - `save-quality-gate.ts` — multi-layer structural/content/semantic quality gate.
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-evaluation-runtime.ts:226:    searchType: 'hybrid',
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-evaluation-runtime.ts:417:        console.warn('[shadow-evaluation-runtime] skipped cycle: embedding model not ready');
.opencode/skills/system-spec-kit/mcp_server/lib/errors/README.md:91:| E040-E049 | Search | Query errors, vector unavailable |
.opencode/skills/system-spec-kit/mcp_server/lib/errors/README.md:143:// Returns tool-specific hint for embedding failure in search context
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/pressure-monitor.ts:4:// Feature catalog: Quality-aware 3-tier search fallback
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/pressure-monitor.ts:60: * Compute pressure level with a three-tier fallback contract:
...
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/rank-metrics.ts:42:  degradedCount: number;
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/rank-metrics.ts:84:  if (delta < 0) return 'degraded';
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/rank-metrics.ts:242:  let degradedCount = 0;
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/rank-metrics.ts:258:      else if (direction === 'degraded') degradedCount++;
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/rank-metrics.ts:289:      degradedCount,
...
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:10:import { computeContentHash, lookupEmbedding, storeEmbedding } from '../cache/embedding-cache.js';
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:12:import { generateDocumentEmbedding, getEmbeddingDimension, getModelName } from './embeddings.js';
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:36:/** In-memory-only snapshot of embedding retry health — no DB access. */
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:82: * for camelCase fallback fields (e.g. retryCount, triggerPhrases).
...
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:118:    : typeof memory.embeddingStatus === 'string'
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:119:      ? memory.embeddingStatus
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:151:  if (lower.includes('openai') || lower.includes('text-embedding')) return 'openai';
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:160:    /^embedding_[a-z_]+/.test(lower) ||
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:164:    lower.includes('text-embedding') ||
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:174:    lower.includes('embedding provider')
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:182:  if (lower.includes('embedding_timeout') || lower.includes('timeout') || lower.includes('timed out')) {
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:190:    lower.includes('embedding_rate_limit') ||
...
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:366:// Hammering the embedding API when the provider is entirely down. After
...
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:537: * Return a lightweight in-memory snapshot of embedding retry health.
...
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:572:        : typeof (memory as { embeddingStatus?: unknown }).embeddingStatus === 'string'
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:573:          ? (memory as { embeddingStatus?: string }).embeddingStatus ?? null
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:582:    // BUG-1 fix: Normalize content before embedding to match sync save path (memory-save.ts:1119).
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:583:    // Without this, async-saved memories get embeddings from raw markdown (YAML frontmatter, HTML
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:584:    // Comments, code fences) while sync-saved memories get clean normalized embeddings.
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:587:    const embeddingDim = getEmbeddingDimension();
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:589:    const cachedEmbedding = lookupEmbedding(db, contentHash, modelId, embeddingDim);
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:591:    let embedding: Float32Array | null = null;
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:594:      embedding = new Float32Array(
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:606:        embedding = await generateDocumentEmbedding(normalizedContent);
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:619:      if (embedding) {
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:625:          Buffer.from(embedding.buffer, embedding.byteOffset, embedding.byteLength),
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:626:          embedding.length,
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:633:    if (!embedding) {
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:641:        SET embedding_status = 'success',
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:642:            embedding_generated_at = ?,
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:654:      const embeddingBuffer = Buffer.from(embedding.buffer, embedding.byteOffset, embedding.byteLength);
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:655:      db.prepare('INSERT INTO vec_memories (rowid, embedding) VALUES (?, ?)').run(BigInt(id), embeddingBuffer);
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:661:      return { success: true, id, dimensions: embedding.length };
...
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:698:    : typeof (memory as { embeddingStatus?: unknown }).embeddingStatus === 'string'
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:699:      ? (memory as { embeddingStatus?: string }).embeddingStatus ?? null
...
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:730:    : memory && typeof (memory as { embeddingStatus?: unknown }).embeddingStatus === 'string'
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:731:      ? (memory as { embeddingStatus?: string }).embeddingStatus ?? null
...
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:751:    : memory && typeof (memory as { embeddingStatus?: unknown }).embeddingStatus === 'string'
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:752:      ? (memory as { embeddingStatus?: string }).embeddingStatus ?? null
...
.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:895:    console.error(`[retry-manager] Background job: Processing up to ${batchSize} of ${stats.queue_size} pending embeddings`);
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/causal-edges.ts:789:      // This preserves legacy "rollback to before next change" semantics for
.opencode/skills/system-spec-kit/mcp_server/lib/enrichment/passive-enrichment.ts:8://   2. Session continuity warning if quality score is degraded/critical
.opencode/skills/system-spec-kit/mcp_server/lib/enrichment/passive-enrichment.ts:120: * Enrich with session continuity warning if quality is degraded.
.opencode/skills/system-spec-kit/mcp_server/lib/enrichment/passive-enrichment.ts:131:    if (quality.level === 'degraded') {
...
.opencode/skills/system-spec-kit/mcp_server/lib/storage/incremental-index.ts:4:// Feature catalog: Deferred lexical-only indexing
...
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/composite-scoring.ts:23: * fallbacks, search-enriched properties like similarity, etc.).
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/composite-scoring.ts:28:// Try to import, fallback to inline calculation if not yet available
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/composite-scoring.ts:77:    console.warn(`[composite-scoring] fsrs-scheduler unavailable; using inline fallback: ${fsrsSchedulerLoadError}`);
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/composite-scoring.ts:151:  semantic_threshold: number;
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/composite-scoring.ts:259:  semantic_threshold: 0.8,
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/composite-scoring.ts:312:  // Graduated-ON semantics — classification decay is active unless explicitly disabled.
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/composite-scoring.ts:468:  if (similarity >= PATTERN_ALIGNMENT_BONUSES.semantic_threshold) {
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/composite-scoring.ts:469:    score += (similarity - PATTERN_ALIGNMENT_BONUSES.semantic_threshold) * 0.5;
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/composite-scoring.ts:473:  // Boost score when query keywords match the document type
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/composite-scoring.ts:567:        // Graduated flag — default ON. Use !== 'false' to match graduated semantics (BUG-4 fix).
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/composite-scoring.ts:600:  // Merging partial overrides. Without this, partial overrides break weighted-average semantics.
.opencode/skills/system-spec-kit/mcp_server/lib/scoring/composite-scoring.ts:648:  // Without this, partial overrides break weighted-average semantics.
...
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/co-activation.ts:280:    // Get the memory's actual embedding from vec_memories
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/co-activation.ts:281:    const embeddingRow = db ? (db.prepare(
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/co-activation.ts:282:      'SELECT embedding FROM vec_memories WHERE rowid = ?'
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/co-activation.ts:283:    ) as import('better-sqlite3').Statement).get(memoryId) as { embedding: Buffer } | undefined : undefined;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/co-activation.ts:285:    if (!embeddingRow || !embeddingRow.embedding || embeddingRow.embedding.length === 0) return 0;
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/co-activation.ts:288:    const uint8 = new Uint8Array(embeddingRow.embedding);
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/co-activation.ts:291:      console.warn(`[co-activation] Invalid embedding size (${uint8.byteLength} bytes) for memory ${memoryId}`);
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/co-activation.ts:294:    const embedding = new Float32Array(uint8.buffer, uint8.byteOffset, uint8.byteLength / 4);
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/co-activation.ts:295:    const similar = vectorSearchFn(embedding, {
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/co-activation.ts:322: * which may be semantically dissimilar but contextually important.
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/co-activation.ts:366: * surfaces causally related but semantically dissimilar memories
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/co-activation.ts:367: * that pure vector similarity would miss.
.opencode/skills/system-spec-kit/mcp_server/lib/architecture/README.md:147:// Returns: ['L1', 'L2'] - Start orchestration, fallback to core
...
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:5:  - "embedding providers"
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:32:The providers module handles embedding generation and retry logic for the Spec Kit Memory MCP server. It provides a unified abstraction layer for multiple embedding providers (Voyage AI, OpenAI) with exponential backoff retry management for reliable embedding generation.
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:38:| Modules | 2 | embeddings, retry-manager |
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:46:| **Provider Abstraction** | Unified interface for Voyage AI, OpenAI and local models (re-exported from `@spec-kit/shared/embeddings`) |
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:48:| **Background Retry Job** | Optional processing of pending embeddings every 5 minutes |
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:60: embeddings.ts        # Re-export from @spec-kit/shared/embeddings
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:69:| `embeddings.ts` | Re-exports all embedding utilities from `@spec-kit/shared/embeddings` |
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:83:### Embeddings Provider (`embeddings.ts`)
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:85:**Purpose**: Unified interface for generating embeddings from multiple providers
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:90:| **Task Types** | Query embeddings, document embeddings, batch processing |
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:92:| **Source** | Re-exported from `@spec-kit/shared/embeddings` (workspace package) |
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:95:import { generateDocumentEmbedding, generateQueryEmbedding } from './embeddings';
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:103:**Purpose**: Handle failed embedding generations with exponential backoff
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:120:| `retryEmbedding` | `(id: number, content: string) => Promise<RetryResult>` | Retry a single embedding |
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:137:**T3-15 circuit breaker:** The retry manager opens a provider circuit breaker after 5 consecutive embedding-provider failures, cools down for 2 minutes, and causes retry paths to skip outbound embedding API calls until the cooldown expires.
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:149:import { generateDocumentEmbedding } from './embeddings';
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:152:const embedding = await generateDocumentEmbedding(text);
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:154:if (embedding) {
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:155:  console.log(`Embedding dimensions: ${embedding.length}`);
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:187:| Generate doc embedding | `generateDocumentEmbedding(text)` | Index new content |
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:188:| Generate query embedding | `generateQueryEmbedding(text)` | Search queries |
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:207:| [search/README.md](../search/README.md) | Vector search using embeddings |
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:213:| [Voyage AI Docs](https://docs.voyageai.com/) | Primary embedding provider |
.opencode/skills/system-spec-kit/mcp_server/lib/providers/README.md:214:| [OpenAI Embeddings](https://platform.openai.com/docs/guides/embeddings) | Alternative provider |
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:148:      'Verify network connectivity to embedding provider',
...
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:158:      'Check if embedding provider changed (e.g., Voyage vs OpenAI)',
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:168:      'Check network latency to embedding provider',
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:169:      'Consider enabling local fallback: ENABLE_LOCAL_FALLBACK=true'
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:175:    hint: 'No embedding provider available. Search limited to text matching.',
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:178:      'Enable local fallback: ENABLE_LOCAL_FALLBACK=true',
...
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:343:    hint: 'Vector search unavailable. Using text-based search as fallback.',
...
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:346:      'Ensure at least one embedding method is configured',
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:347:      'Text search (BM25) will still work for keyword matches'
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:389:      'Enable local fallback: ENABLE_LOCAL_FALLBACK=true'
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:403:    hint: 'Local embedding model not available.',
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:407:      'Use API-based embedding as alternative'
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:412:    hint: 'Rate limited by embedding provider. Retry after delay.',
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:415:      'Consider enabling local fallback for high-volume operations',
...
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:696:      hint: 'Semantic search unavailable. Results limited to keyword matching.',
...
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:753:      hint: 'Memory saved but embedding failed. Will be searchable via text only.',
...
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:777:      hint: 'Scan complete but embeddings unavailable. Files indexed for text search only.',
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:779:        'Configure an embedding provider for semantic search',
.opencode/skills/system-spec-kit/mcp_server/lib/errors/recovery-hints.ts:780:        'Re-run scan after configuring embeddings',
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:15:  embedding: Buffer;
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:40: * Create the embedding_cache table if it does not exist.
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:47:    CREATE TABLE IF NOT EXISTS embedding_cache (
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:50:      embedding BLOB NOT NULL,
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:62: * Look up a cached embedding by content hash, model ID, and embedding dimension.
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:63: * On hit: updates last_used_at and returns the embedding Buffer.
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:69: * @param dimensions - Expected embedding dimensions for this lookup
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:79:    'SELECT embedding FROM embedding_cache WHERE content_hash = ? AND model_id = ? AND dimensions = ?',
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:81:    | { embedding: Buffer }
...
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:96:  return row.embedding;
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:107: * Store an embedding in the cache.
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:109: * rows are overwritten with the latest embedding, while allowing multiple
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:120: * @param embedding - Raw embedding buffer
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:121: * @param dimensions - Number of embedding dimensions
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:127:  embedding: Buffer,
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:132:    'SELECT COUNT(*) AS cnt FROM embedding_cache',
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:138:      `DELETE FROM embedding_cache WHERE rowid IN (
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:139:         SELECT rowid FROM embedding_cache ORDER BY last_used_at ASC LIMIT ?
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:145:    `INSERT OR REPLACE INTO embedding_cache
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:146:       (content_hash, model_id, embedding, dimensions, last_used_at)
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:148:  ) as Database.Statement).run(contentHash, modelId, embedding, dimensions);
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:162:    `DELETE FROM embedding_cache
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:172: * Return runtime hit/miss statistics for the embedding cache.
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:179: * Return aggregate statistics about the embedding cache.
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:199:      COALESCE(SUM(LENGTH(embedding)), 0) AS total_size_bytes,
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:202:    FROM embedding_cache
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:221: * Remove all entries from the embedding cache.
.opencode/skills/system-spec-kit/mcp_server/lib/cache/embedding-cache.ts:226:  db.exec('DELETE FROM embedding_cache');
...
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/attention-decay.ts:105:  // Inline fallback uses canonical constants from fsrs-scheduler.ts
...
.opencode/skills/system-spec-kit/mcp_server/lib/cache/README.md:63:├── embedding-cache.ts     # Persistent SQLite embedding cache with LRU eviction
.opencode/skills/system-spec-kit/mcp_server/lib/cache/README.md:74:| `embedding-cache.ts` | Persistent SQLite embedding cache: avoids re-computing embeddings for identical content. Uses content-hash + model-ID keys with LRU eviction (Sprint 3) |
.opencode/skills/system-spec-kit/mcp_server/lib/cache/README.md:144:### Embedding Cache (`embedding-cache.ts`)
.opencode/skills/system-spec-kit/mcp_server/lib/cache/README.md:146:**Purpose**: Persistent SQLite-backed embedding cache to avoid redundant API calls for identical content.
.opencode/skills/system-spec-kit/mcp_server/lib/cache/README.md:151:| **Storage** | SQLite table `embedding_cache` |
.opencode/skills/system-spec-kit/mcp_server/lib/cache/README.md:157:| `initEmbeddingCacheTable(db)` | Create `embedding_cache` table (idempotent) |
.opencode/skills/system-spec-kit/mcp_server/lib/cache/README.md:158:| `getEmbeddingFromCache(db, contentHash, modelId)` | Retrieve cached embedding (updates LRU timestamp) |
.opencode/skills/system-spec-kit/mcp_server/lib/cache/README.md:159:| `putEmbeddingInCache(db, contentHash, modelId, embedding, dimensions)` | Store embedding in cache |
.opencode/skills/system-spec-kit/mcp_server/lib/cache/README.md:242:| `embedding-cache.ts` | Persistent embedding cache keyed by content hash + model |
.opencode/skills/system-spec-kit/mcp_server/lib/providers/embeddings.ts:8:// MAINTENANCE: Keep exports in sync with @spec-kit/shared/embeddings.
.opencode/skills/system-spec-kit/mcp_server/lib/providers/embeddings.ts:18:  semanticChunk,
.opencode/skills/system-spec-kit/mcp_server/lib/providers/embeddings.ts:48:  __embeddingCircuitTestables,
.opencode/skills/system-spec-kit/mcp_server/lib/providers/embeddings.ts:49:} from '@spec-kit/shared/embeddings';
.opencode/skills/system-spec-kit/mcp_server/lib/ops/job-queue.ts:27:  | 'embedding'
.opencode/skills/system-spec-kit/mcp_server/lib/ops/job-queue.ts:85:const ACTIVE_STATES = new Set<IngestJobState>(['queued', 'parsing', 'embedding', 'indexing']);
.opencode/skills/system-spec-kit/mcp_server/lib/ops/job-queue.ts:90:  parsing: new Set<IngestJobState>(['embedding', 'cancelled', 'failed']),
.opencode/skills/system-spec-kit/mcp_server/lib/ops/job-queue.ts:91:  embedding: new Set<IngestJobState>(['indexing', 'cancelled', 'failed']),
.opencode/skills/system-spec-kit/mcp_server/lib/ops/job-queue.ts:166:function parseJsonArray<T>(value: string | null | undefined, fallback: T[]): T[] {
.opencode/skills/system-spec-kit/mcp_server/lib/ops/job-queue.ts:167:  if (!value) return fallback;
.opencode/skills/system-spec-kit/mcp_server/lib/ops/job-queue.ts:170:    return Array.isArray(parsed) ? (parsed as T[]) : fallback;
.opencode/skills/system-spec-kit/mcp_server/lib/ops/job-queue.ts:172:    return fallback;
.opencode/skills/system-spec-kit/mcp_server/lib/ops/job-queue.ts:551:  const stateRisk = job.state === 'indexing' ? 0.15 : (job.state === 'embedding' ? 0.1 : 0.05);
.opencode/skills/system-spec-kit/mcp_server/lib/ops/job-queue.ts:586:  // Step 2: Embedding — placeholder for batch embedding pre-processing.
.opencode/skills/system-spec-kit/mcp_server/lib/ops/job-queue.ts:590:  job = await setIngestJobState(jobId, 'embedding');
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:91:| **Spreading Activation**     | Boost related memories (+0.15 on access)                                              | Maintains semantic coherence         |
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:271:| `temporal-contiguity.ts`   | Time-based linking        | `vectorSearchWithContiguity`, `getTemporalNeighbors`, `buildTimeline`       |
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:547:// Populate related memories using vector search
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:550:  vectorSearchFn  // (embedding: Float32Array, options) => Array<{id, similarity}>
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:701:  vectorSearchWithContiguity,
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:711:// Boost vector search results by temporal proximity
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:717:const boosted = vectorSearchWithContiguity(results, DEFAULT_WINDOW);
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:791:  candidates,        // from vector search
.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/README.md:1029:| [../search/vector-index.ts](../search/vector-index.ts)             | Semantic search using voyageai embeddings |
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ground-truth-feedback.ts:14:// Scores query-memory relevance using lexical overlap heuristics.
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ground-truth-feedback.ts:20://   - LLM-judge interface is deterministic (non-stub fallback).
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ground-truth-feedback.ts:326: * Deterministic fallback implementation for LLM-judge relevance labels.
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ground-truth-feedback.ts:328: * Uses lexical overlap between query and memory content to assign
.opencode/skills/system-spec-kit/mcp_server/lib/eval/ground-truth-feedback.ts:357:          reasoning: 'Heuristic judge: insufficient lexical signal (empty query or content tokens)',
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/compact-merger.ts:200:            ? 'semantic'
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:59:  // Empty seeds + no subject → outline mode fallback
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:119:/** Build fallback result when no seeds/subject resolve */
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-context.ts:158:  actions.push('Use `mcp__cocoindex_code__search` for semantic discovery of related code');
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:65:  /** Total improved / degraded / unchanged across all queries. */
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:83:  total_degraded: number;
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:149:    direction    TEXT NOT NULL CHECK(direction IN ('improved','degraded','unchanged')),
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:172:    total_degraded   INTEGER NOT NULL DEFAULT 0,
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:433:         mean_kendall_tau, total_improved, total_degraded, total_unchanged, is_improvement)
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:517:      totalDegraded: row.total_degraded,
.opencode/skills/system-spec-kit/mcp_server/lib/feedback/shadow-scoring.ts:660:      totalDegraded += comp.metrics.degradedCount;
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/structural-indexer.ts:6:// - Regex fallback (SPECKIT_PARSER=regex): lightweight, no WASM deps
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/structural-indexer.ts:342:    // Class methods — require at least one modifier keyword OR a method body opener `{`
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/structural-indexer.ts:477:  let classIndent = 0; // indentation column of the class keyword
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/structural-indexer.ts:604:    // F042: Match 'function foo { }' and 'function foo() { }' (function keyword form without prior match)
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/structural-indexer.ts:679: *   - 'regex': Lightweight regex-based fallback with no WASM dependencies
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/structural-indexer.ts:904:        // Skip self-references, keywords, and duplicates
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/structural-indexer.ts:906:        // Skip common JS/TS keywords that precede parens
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:5:// retrieval backend: structural (code graph) vs semantic
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:6:// (CocoIndex) vs hybrid (both).
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:9:// routing between structural (code graph) and semantic backends.
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:11:export type QueryIntent = 'structural' | 'semantic' | 'hybrid';
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:17:  semanticScore: number;
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:71:  // F035: Narrowed — require semantic noun after opener to avoid matching structural queries
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:75:  // F035: Narrowed — require semantic noun after "what is/are/does"
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:85:function countKeywordHits(tokens: string[], keywords: Set<string>): { count: number; matched: string[] } {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:88:    if (keywords.has(token)) matched.push(token);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:92:  for (const kw of keywords) {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:113: * (code graph) and semantic (CocoIndex) retrieval backends.
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:125:  const semanticHits = countKeywordHits(tokens, SEMANTIC_KEYWORDS);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:127:  const semanticPatterns = countPatternHits(query, SEMANTIC_PATTERNS);
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:129:  // Weighted scoring: keywords count 1x, patterns count 2x
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:131:  const semanticScore = semanticHits.count + semanticPatterns * 2;
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:132:  const total = structuralScore + semanticScore;
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:134:  const matchedKeywords = [...structuralHits.matched, ...semanticHits.matched];
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:136:  // No signals at all → hybrid (run both)
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:142:  const semanticRatio = semanticScore / total;
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:156:      semanticScore,
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:161:  // Clear semantic signal (>65% semantic)
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:162:  if (semanticRatio > 0.65) {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:164:      intent: 'semantic',
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:167:      semanticScore,
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:174:    intent: 'hybrid',
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/query-intent-classifier.ts:177:    semanticScore,
.opencode/skills/system-spec-kit/mcp_server/lib/chunking/anchor-chunker.ts:19:  /** Anchor IDs covered by this chunk (empty for fallback chunks) */
.opencode/skills/system-spec-kit/mcp_server/lib/chunking/anchor-chunker.ts:57:/** Maximum chunk size — hard cap to stay under embedding token budget */
.opencode/skills/system-spec-kit/mcp_server/lib/chunking/anchor-chunker.ts:63:/** Max characters for parent summary (BM25 fallback) */
.opencode/skills/system-spec-kit/mcp_server/lib/eval/edge-density.ts:97:    // Density denominator uses total memories for meaningful sparse-graph semantics.
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/startup-brief.ts:160:      lines.push('Orientation: use code graph highlights for structural entry points and call paths; use CocoIndex for semantic discovery when the symbol or file is still unknown.');
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/runtime-detection.ts:118:export function getRecoveryApproach(): 'hooks' | 'tool_fallback' {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/runtime-detection.ts:119:  return areHooksAvailable() ? 'hooks' : 'tool_fallback';
.opencode/skills/system-spec-kit/mcp_server/lib/chunking/README.md:32:The chunking module splits large memory files into smaller pieces suitable for embedding and indexing. It works in two stages: first chunking (splitting), then thinning (filtering).
.opencode/skills/system-spec-kit/mcp_server/lib/chunking/README.md:43:| Anchor-first, structure-fallback | ANCHOR tags provide precise author-defined boundaries. Heading-based splitting is a reasonable fallback for untagged content. |
.opencode/skills/system-spec-kit/mcp_server/lib/chunking/README.md:44:| 4,000-char target, 12,000-char max | Target of ~1,000 tokens (at 4 chars/token) fits embedding model budgets. Hard cap prevents single chunks from exceeding token limits. |
.opencode/skills/system-spec-kit/mcp_server/lib/chunking/README.md:58:  anchor-chunker.ts    # Two-strategy file chunking (anchor-based + structure-based fallback)
.opencode/skills/system-spec-kit/mcp_server/lib/chunking/README.md:116:| `PARENT_SUMMARY_LENGTH` | 500 chars | BM25 fallback summary extracted from file start |
.opencode/skills/system-spec-kit/mcp_server/lib/governance/scope-governance.ts:8:import { ensureGovernanceTables, ensureSharedSpaceTables } from '../search/vector-index-schema.js';
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:104:  rrfScore?: number;
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:113:  /** Score origin metadata for distinguishing real reranks from fallbacks. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/confidence-scoring.ts:180:  if (result.scoringMethod === 'fallback') return false;
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/tree-sitter-parser.ts:148:  if (node.type === 'lexical_declaration') {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/tree-sitter-parser.ts:311:  if (node.type === 'lexical_declaration') {
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/tree-sitter-parser.ts:480:      || nodeType === 'lexical_declaration';
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/ops-hardening.ts:71:      : 'Code graph is missing or unusable; fallback and repair flows should be used.';
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/ops-hardening.ts:90:        'fts_consistency',
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/ops-hardening.ts:93:        'orphan_vectors',
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:36:The MCP Server Library provides the core functionality for the Spec Kit Memory MCP server. It implements cognitive memory features including semantic search, attention decay, importance scoring and intelligent context retrieval. These modules work together to provide AI assistants with human-like memory recall and context awareness.
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:54:| **Semantic Search** | Vector-based similarity search with SQLite vector index and hybrid keyword matching |
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:62:| **Embedding Cache** | Persistent SQLite cache for embedding reuse with LRU eviction |
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:81:| Voyage AI API | Required | For embeddings |
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:94:import { SQLiteVectorStore } from './search/vector-index';
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:111:import { SQLiteVectorStore } from './search/vector-index';
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:135:│   ├── vector-index.ts         # Vector similarity search with SQLite
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:136:│   ├── vector-index-impl.ts    # Core vector index implementation
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:137:│   ├── hybrid-search.ts        # Combined semantic + keyword search + token budget
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:138:│   ├── rrf-fusion.ts           # Reciprocal Rank Fusion scoring (5 channels incl. degree)
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:140:│   ├── bm25-index.ts           # BM25 lexical indexing
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:141:│   ├── sqlite-fts.ts           # SQLite FTS5 full-text search
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:200:│   ├── embeddings.ts           # Embedding provider (Voyage AI)
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:227:│   ├── embedding-cache.ts      # Persistent SQLite embedding cache with LRU eviction
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:238:│   ├── bm25-baseline.ts        # BM25 baseline measurement
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:250:│   ├── vector-store.ts         # Vector store interface
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:270:│   ├── retrieval-telemetry.ts  # Latency, mode, fallback and quality metrics
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:320:| `search/vector-index.ts` | Core vector similarity search with RRF fusion |
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:321:| `search/vector-index-impl.ts` | Core vector index implementation |
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:323:| `search/bm25-index.ts` | BM25 lexical search indexing |
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:324:| `search/cross-encoder.ts` | Cross-encoder semantic reranking |
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:343:| `cache/embedding-cache.ts` | Persistent SQLite embedding cache with LRU eviction |
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:358:**Vector Index**: Semantic similarity search using Voyage AI embeddings
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:362:| **Purpose** | Find memories by semantic meaning, not just keywords |
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:363:| **Usage** | `search.vectorIndex.search_memories(query, options)` |
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:366:**Hybrid Search**: Combines semantic and keyword search for better recall
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:370:| **Purpose** | Use both semantic understanding and exact keyword matches |
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:371:| **Usage** | `search.hybridSearch.search(query, options)` |
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:403:3. **Stability fallback**: If only `stability` exists but no timestamps, use `min(1, stability / 10)`
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:404:4. **Attention score fallback**: If `attentionScore` exists, use it directly
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:518:- `lib/search/vector-index-impl.ts`: v13 migration adds `document_type` and `spec_level` columns and indexes.
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:532:import * as vectorIndex from './search/vector-index';
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:534:const queryEmbedding = new Float32Array(vectorIndex.getEmbeddingDim());
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:535:const results = vectorIndex.vectorSearch(queryEmbedding, {
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:546:**Result**: Returns top 5 memories ranked by semantic similarity and importance
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:577:// Combine semantic and keyword search
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:578:import { hybridSearch } from './search/hybrid-search';
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:581:const results = await hybridSearch('TODO authentication', queryEmbedding, {
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:615:| Direct imports | `import { SQLiteVectorStore } from './search/vector-index';` | Focused module usage |
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:631:**Symptom**: `Error: Cannot find module './search/vector-index'`
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:638:import { SQLiteVectorStore } from './search/vector-index';
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:669:import * as embeddingsProvider from './providers/embeddings';
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:677:| Import errors | Use concrete module paths such as `./search/vector-index` |
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:686:import { SQLiteVectorStore } from './search/vector-index';
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:695:// Test embedding provider
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:696:import * as embeddingsProvider from './providers/embeddings';
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:697:const embedding = await embeddingsProvider.generateQueryEmbedding('test query');
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:698:console.log('Embedding dimensions:', embedding.length);
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:721:| [Search Modules](./search/) | Vector index, hybrid search, fusion algorithms |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:71:  embedding: Float32Array | number[],
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:96:   * Internal fallback override: when true, bypass complexity routing and
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:118:   * - `'bm25'` — BM25 term-frequency relevance (min-max normalized per source group)
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:135:  _degradation?: unknown;
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:141:  const primarySource = result.sources[0] ?? 'hybrid';
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:147:    score: typeof scoreCandidate === 'number' ? scoreCandidate : result.rrfScore,
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:196:/** Fallback tier in the 3-tier degradation chain. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:199:/** Why degradation was triggered at a given tier. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:207:/** Record of a single degradation event during tiered fallback. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:216: * Absolute quality floor for degradation checks.
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:219: * high fixed threshold causes false degradations. Use a conservative floor and
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:324: * @returns Array of BM25-scored results tagged with source 'bm25'.
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:326:function bm25Search(
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:394:        source: 'bm25',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:468:    return bm25Results.map(row => ({
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:494:  const bm25Results = bm25Search(query, options);
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:501:  for (const r of ftsResults) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:505:  for (const r of bm25Results) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:554:  const fallbackScores: Record<string, number> = {};
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:559:    fallbackScores[source] = resultScore;
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:561:  return fallbackScores;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:685:    allowed.add('bm25');
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:689:  if (options.useBm25 === false) allowed.delete('bm25');
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:708:    useBm25: allowedChannels.has('bm25'),
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:747:    (result as Record<string, unknown>).fallbackRetry = true;
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:772:  embedding: Float32Array | number[] | null,
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:784:  const primaryExecution = await collectAndFuseHybridResults(query, embedding, primaryOptions);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:806:    const retryExecution = await collectAndFuseHybridResults(query, embedding, retryOptions);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:826:    const retryExecution = await collectAndFuseHybridResults(query, embedding, retryOptions);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:851: * Retained as internal fallback only.
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:853:async function hybridSearch(
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:855:  embedding: Float32Array | number[] | null,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:903:    const bm25Results = bm25Search(query, { limit, specFolder });
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:904:    results.push(...bm25Results);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:979:  embedding: Float32Array | number[] | null,
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:982:  const execution = await collectAndFuseHybridResults(query, embedding, options);
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:991:  return hybridSearch(query, embedding, options);
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:996:  embedding: Float32Array | number[] | null,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1016:    // every fallback tier. useGraph=false also disables the dependent degree lane.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1055:    let bm25ChannelResults: HybridSearchResult[] = [];
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1079:          const embeddingCandidate = toEmbeddingBufferView(
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1080:            (result as Record<string, unknown>).embedding
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1081:            ?? (result as Record<string, unknown>).embeddingBuffer
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1083:          if (embeddingCandidate) {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1104:    // BM25 channel (internal error handling in bm25Search) — gated by query-complexity routing
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1105:    if (activeChannels.has('bm25')) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1106:      bm25ChannelResults = bm25Search(query, options);
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1107:      if (bm25ChannelResults.length > 0) {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1110:        lists.push({ source: 'bm25', results: bm25ChannelResults, weight: 0.6 });
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1181:    // Merge keyword results after all channels complete
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1182:    const keywordResults: Array<{ id: number | string; source: string; [key: string]: unknown }> = [
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1183:      ...ftsChannelResults,
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1184:      ...bm25ChannelResults,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1229:    const keywordFusionResults = keywordResults.map((result) => ({
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1231:      source: 'keyword',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1245:    if (keywordFusionResults.length > 0 && keywordWeight > 0) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1247:        source: 'keyword',
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1248:        results: keywordFusionResults,
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1249:        weight: keywordWeight,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1382:  const degradationMeta = shadowMeta._degradation;
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1384:  // C138/T316: MMR reranking with request-scoped embedding cache.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1406:        const missingIds = numericIds.filter((id) => !embeddingMap.has(id));
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1411:            `SELECT rowid, embedding FROM vec_memories WHERE rowid IN (${placeholders})`
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1412:          ) as Database.Statement).all(...missingIds) as Array<{ rowid: number; embedding: Buffer }>;
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1415:            if (Buffer.isBuffer(row.embedding)) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1416:              embeddingMap.set(
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1418:                new Float32Array(row.embedding.buffer, row.embedding.byteOffset, row.embedding.byteLength / 4)
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1426:          const emb = embeddingMap.get(r.id as number);
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1431:              embedding: emb,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1491:            if ('rrfScore' in result) (result as Record<string, unknown>).rrfScore = boostedScore;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1575:          ...(degradationMeta !== undefined ? { degradation: degradationMeta } : {}),
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1686:  embedding: Float32Array | number[] | null,
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1691:    embedding,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1718:  if (allowedChannels.has('bm25')) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1719:    const bm25Fallback = collectCandidatesFromLists(
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1720:      [{ source: 'bm25', results: bm25Search(query, options) }],
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1723:    if (bm25Fallback.length > 0) return bm25Fallback;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1731: * Search with automatic fallback chain.
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1733: * fallback (searchWithFallbackTiered). Otherwise: C138-P0 two-pass adaptive
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1734: * fallback — primary at minSimilarity=30, retry at 17.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1743:  embedding: Float32Array | number[] | null,
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1746:  // PI-A2: Delegate to tiered fallback when flag is enabled
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1748:    return searchWithFallbackTiered(query, embedding, options);
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1751:  // Primary 30 filters noise; fallback 17 widens recall for sparse corpora
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1757:    embedding,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1777:  if (allowedChannels.has('bm25')) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1778:    const bm25Results = bm25Search(query, options);
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1779:    if (bm25Results.length > 0) return bm25Results;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:1791: * requiring embeddings or text similarity. Pure SQL fallback.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2101: * PI-A2: Quality-aware 3-tier search fallback chain.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2117: * @returns Results with _degradation metadata attached as non-enumerable property.
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2121:  embedding: Float32Array | number[] | null,
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2124:  const degradationEvents: DegradationEvent[] = [];
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2125:  const { stages } = await executeFallbackPlan(query, embedding, options, 'tiered');
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2135:    // Tier 1 passed quality thresholds — attach empty degradation metadata
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2136:    Object.defineProperty(finalTier1, '_degradation', {
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2137:      value: degradationEvents,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2151:  degradationEvents.push({
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2163:    Object.defineProperty(finalTier2, '_degradation', {
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2164:      value: degradationEvents,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2179:  degradationEvents.push({
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2190:  Object.defineProperty(finalResults, '_degradation', {
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2191:    value: degradationEvents,
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2204:/** Maximum characters for a summary fallback when a single result overflows the budget. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2282:    'combined_lexical_score',
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2317: * Create a summary fallback for a single result whose content exceeds the token budget.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2467:  bm25Search,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:2489:  // PI-A2: Tiered fallback exports
...
.opencode/skills/system-spec-kit/mcp_server/lib/ops/README.md:44:| `job-queue.ts` | SQLite-backed ingestion job queue with a finite state machine (`queued` > `parsing` > `embedding` > `indexing` > `complete`/`failed`/`cancelled`). Enforces valid state transitions, tracks per-file progress against the original submitted path list and caps stored errors at 50. Crash recovery resets incomplete jobs to `queued` on startup. |
.opencode/skills/system-spec-kit/mcp_server/lib/ops/README.md:55:- Reindex parity: watcher- and ingest-driven reindex paths use the normal synchronous embedding cache-miss path; they do not force deferred embeddings unless async mode was explicitly requested or provider generation fails.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:15:import { initEmbeddingCache } from '../cache/embedding-cache.js';
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:172:  const tableSql = getTableSql(database, 'embedding_cache');
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:181:  if (!hasTable(database, 'embedding_cache')) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:190:  logger.info('Migrating embedding_cache primary key to include dimensions');
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:192:    ALTER TABLE embedding_cache RENAME TO embedding_cache_legacy_dimensions;
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:196:    INSERT OR REPLACE INTO embedding_cache (
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:199:      embedding,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:207:      embedding,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:211:    FROM embedding_cache_legacy_dimensions
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:213:  database.exec('DROP TABLE embedding_cache_legacy_dimensions');
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:288:  fallback: string,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:295:  return fallback;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:542:              'frontmatter_explicit', 'importance_tier', 'file_path', 'keywords', 'default', 'manual'
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:584:          CREATE INDEX IF NOT EXISTS idx_embedding_pending
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:588:        logger.info('Migration v7: Created idx_embedding_pending partial index');
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:590:        console.warn('[VectorIndex] Migration v7 warning (idx_embedding_pending):', get_error_message(e));
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:1011:            summary_embedding BLOB,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2291:    // the rollout (REQ-S2-001) — embedding cache table must exist before any
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2310:      embedding_model TEXT,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2311:      embedding_generated_at TEXT,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2363:    const embedding_dim = get_embedding_dim();
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2366:        embedding FLOAT[${embedding_dim}]
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2377:      INSERT OR REPLACE INTO vec_metadata (key, value) VALUES ('embedding_dim', ?)
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2378:    `).run(String(embedding_dim));
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2379:    logger.info(`Created vec_memories table with dimension ${embedding_dim}`);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-schema.ts:2420:  // the rollout (REQ-S2-001) — create embedding_cache table
...
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/README.md:22:- **CocoIndex** (semantic, external MCP): finds relevant code by concept
.opencode/skills/system-spec-kit/mcp_server/lib/collab/shared-spaces.ts:11:} from '../search/vector-index-schema.js';
.opencode/skills/system-spec-kit/mcp_server/lib/collab/shared-spaces.ts:95:  'semantic_divergence',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/cross-encoder.ts:9:// Module returns a positional fallback (scored 0–0.5) and marks
.opencode/skills/system-spec-kit/mcp_server/lib/search/cross-encoder.ts:10:// Results with scoringMethod:'fallback' so callers can distinguish
.opencode/skills/system-spec-kit/mcp_server/lib/search/cross-encoder.ts:17:// Local cross-encoder model.  The positional fallback is NOT a
.opencode/skills/system-spec-kit/mcp_server/lib/search/cross-encoder.ts:94:   *   'fallback'      — synthetic positional score (0–0.5) when no provider is available
.opencode/skills/system-spec-kit/mcp_server/lib/search/cross-encoder.ts:96:  scoringMethod: 'cross-encoder' | 'fallback';
.opencode/skills/system-spec-kit/mcp_server/lib/search/cross-encoder.ts:144:// Positional fallback scores instead.
.opencode/skills/system-spec-kit/mcp_server/lib/search/cross-encoder.ts:400:    // No reranker available — P3-16: use 'fallback' scoringMethod and distinct score range
.opencode/skills/system-spec-kit/mcp_server/lib/search/cross-encoder.ts:407:      scoringMethod: 'fallback' as const,
.opencode/skills/system-spec-kit/mcp_server/lib/search/cross-encoder.ts:412:  // Consecutively, skip the API call and return positional fallback.
.opencode/skills/system-spec-kit/mcp_server/lib/search/cross-encoder.ts:419:      provider: 'fallback',
.opencode/skills/system-spec-kit/mcp_server/lib/search/cross-encoder.ts:420:      scoringMethod: 'fallback' as const,
.opencode/skills/system-spec-kit/mcp_server/lib/search/cross-encoder.ts:485:      provider: 'fallback',
.opencode/skills/system-spec-kit/mcp_server/lib/search/cross-encoder.ts:486:      scoringMethod: 'fallback' as const,
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:50:      "expectedResultDescription": "Should surface adaptive-fusion.ts (FEATURE_FLAG constant, isFeatureEnabled check), search-flags.ts, and rollout-policy.ts. Tests understanding the opt-out semantics.",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:51:      "notes": "Bug-intent query matching a specific flag. Tests whether bug-type queries get boosted keyword weighting for technical terms."
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:91:      "notes": "Bug-intent query with specific symptom. Tests whether bug-type queries get boosted keyword weighting for technical terms."
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:135:      "query": "smartRanking config weights in search-weights.json are inconsistent with the code fallback values",
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:375:      "query": "how does multi-query expansion work in deep mode retrieval",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:381:      "notes": "From T007b §1 step 3: multi-query expansion is specific to deep mode — cross-document query."
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:460:      "expectedResultDescription": "Should surface rrf-fusion.ts, adaptive-fusion.ts channel weights, and the T000a baseline note about graphHitRate=0.",
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:610:      "expectedResultDescription": "Should surface rrf-fusion.ts, adaptive-fusion.ts, and spec memories about channel weight configuration.",
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:751:      "notes": "Vague natural language query — tests whether broad semantic retrieval surfaces the right subsystems."
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:1065:      "query": "machine learning model training pipeline for embedding fine-tuning",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:1071:      "notes": "Hard negative — \"embedding\" exists but \"training pipeline\" context is completely absent."
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:16: * and extracted keywords for lightweight matching.
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:21:  keywords: string[];
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:339: * Extract significant keywords from a description string.
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:346: * @param description - A description string to extract keywords from.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:358:  const keywords: string[] = [];
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:366:    keywords.push(cleaned);
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:369:  return keywords;
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:378: * simple keyword-overlap scoring.
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:383: *   in its keywords or description (case-insensitive)
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:413:    const keywordSet = new Set(folder.keywords);
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:416:      // Keywords set lookup is O(1); description substring is fallback for partial matches
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:417:      if (keywordSet.has(term)) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:475:      // Cases still aggregate through spec.md fallback so discovery retains a useful label.
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:484:            keywords: perFolder.keywords,
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:492:      // Missing files still use pure spec.md fallback to avoid surprising backfill writes.
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:500:          /* Best-effort repair — fallback extraction below remains authoritative */
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:520:            keywords: perFolder.keywords,
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:593:  const keywords = extractKeywords(description);
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:602:    keywords,
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:659:  const keywords = extractKeywords(description);
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:681:    keywords,
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:693: * Returns null if missing, corrupt, or structurally invalid (graceful degradation).
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:715:      !Array.isArray(parsed.keywords) ||
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:716:      !parsed.keywords.every((e: unknown) => typeof e === 'string') ||
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:946:    // Never throw — return null for graceful degradation
.opencode/skills/system-spec-kit/mcp_server/lib/search/folder-discovery.ts:977:    // CHK-PI-B3-004: Never throw — graceful degradation
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index.ts:9:  to_embedding_buffer,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index.ts:70:  generate_query_embedding,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index.ts:71:  keyword_search,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index.ts:72:  vector_search_enriched,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index.ts:74:  multi_concept_keyword_search,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index.ts:88:  vectorSearch,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index.ts:96:  keywordSearch,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index.ts:151:  get_embedding_dim,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index.ts:152:  get_confirmed_embedding_dimension,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index.ts:153:  validate_embedding_dimension,
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:11:// Keyword search achieves without any semantic, graph, or trigger
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:136: *     BM25 alone is very strong — semantic/graph additions may not
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:141: *     BM25 is moderate — semantic/graph channels must demonstrably
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:160:        'BM25 alone is very strong — semantic/graph additions may not justify complexity. ' +
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:174:        'BM25 is moderate — semantic/graph channels should demonstrably improve over this baseline. ' +
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:187:      'The low keyword-only baseline confirms that semantic and graph augmentation ' +
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:248:        'The multi-channel architecture adds marginal value over keyword search alone. ' +
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/bm25-baseline.ts:279:      'Multi-channel retrieval provides substantial improvement over keyword search. ' +
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/warm-start-variant-runner.ts:247:        ? 'live_fallback'
.opencode/skills/system-spec-kit/mcp_server/lib/search/local-reranker.ts:5:// RERANKER_LOCAL and gracefully degrades to unchanged ordering on any
.opencode/skills/system-spec-kit/mcp_server/lib/search/local-reranker.ts:277:     * remote/fallback behavior for non-opted-in environments.
.opencode/skills/system-spec-kit/mcp_server/lib/search/local-reranker.ts:330:    console.warn(`[local-reranker] fallback to original ordering: ${toErrorMessage(error)}`);
.opencode/skills/system-spec-kit/mcp_server/lib/search/community-search.ts:4:// Phase B T018: Community-level search as fallback channel.
.opencode/skills/system-spec-kit/mcp_server/lib/search/community-search.ts:7:// searches community summaries by keyword matching and returns
.opencode/skills/system-spec-kit/mcp_server/lib/search/community-search.ts:29:  source: 'community_fallback';
.opencode/skills/system-spec-kit/mcp_server/lib/search/community-search.ts:91: * Search community summaries by keyword matching.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/community-search.ts:109:    source: 'community_fallback',
.opencode/skills/system-spec-kit/mcp_server/lib/search/community-search.ts:171:      source: 'community_fallback',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:14:import * as embeddingsProvider from '../providers/embeddings.js';
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:18:  to_embedding_buffer,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:21:} from './vector-index-types.js';
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:24:  get_embedding_dim,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:159: * @param query_embedding - The query embedding to search with.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:169:  query_embedding: EmbeddingInput,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:190:  // M9 FIX: Validate embedding dimension before querying
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:191:  const expected_dim = get_embedding_dim();
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:192:  if (!query_embedding || query_embedding.length !== expected_dim) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:194:      `Invalid embedding dimension: expected ${expected_dim}, got ${query_embedding?.length}`,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:199:  const query_buffer = to_embedding_buffer(query_embedding);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:202:  // ADR-004: FSRS-preferred decay with half-life fallback
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:263:      SELECT m.*, vec_distance_cosine(v.embedding, ?) as distance,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:309: * Searches indexed memories with multiple concept embeddings.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:310: * @param concept_embeddings - The concept embeddings to search with.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:313: * @throws {VectorIndexError} When concept count or embedding dimensions are invalid, or when store initialization fails.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:320:  concept_embeddings: EmbeddingInput[],
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:331:  const concepts = concept_embeddings;
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:336:  const expected_dim = get_embedding_dim();
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:340:        `Invalid embedding dimension: expected ${expected_dim}, got ${emb?.length}`,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:348:  const concept_buffers = concepts.map(c => to_embedding_buffer(c));
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:352:    `vec_distance_cosine(v.embedding, ?) as dist_${i}`
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:356:    `vec_distance_cosine(v.embedding, ?) <= ?`
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:586: * Generates an embedding for a search query.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:588: * @returns A promise that resolves to the embedding, if generated.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:590:export async function generate_query_embedding(query: string): Promise<Float32Array | null> {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:597:    const embeddings = embeddingsProvider;
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:598:    const embedding = await embeddings.generateQueryEmbedding(query.trim());
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:599:    return embedding;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:611: * Searches indexed memories using keyword matching.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:616:export function keyword_search(
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:677:    return { ...row, keyword_score: score };
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:681:    .filter((row: MemoryRow) => Number(row.keyword_score ?? 0) > 0)
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:682:    .sort((a: MemoryRow, b: MemoryRow) => Number(b.keyword_score ?? 0) - Number(a.keyword_score ?? 0))
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:717:  const query_embedding = await generate_query_embedding(query);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:720:  let search_method = 'vector';
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:723:  if (query_embedding && sqlite_vec) {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:731:    search_method = 'keyword';
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:732:    raw_results = keyword_search(query, { limit, specFolder }, database);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:747:    const similarity = search_method === 'vector'
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:749:      : Math.min(100, (row.keyword_score || 0) * 20);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:781: * @param concepts - The concept queries or embeddings.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:804:  const concept_embeddings: EmbeddingInput[] = [];
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:807:      const embedding = await generate_query_embedding(concept);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:808:      if (!embedding) {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:810:        return await multi_concept_keyword_search(concepts.filter(c => typeof c === 'string'), limit, options);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:812:      concept_embeddings.push(embedding);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:814:      concept_embeddings.push(concept);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:821:    return await multi_concept_keyword_search(concepts.filter(c => typeof c === 'string'), limit, options);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:824:  const raw_results = multi_concept_search(concept_embeddings, { limit, specFolder, minSimilarity });
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:862: * Runs keyword search for multiple concepts.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:868:export async function multi_concept_keyword_search(
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:881:    keyword_search(concept, { limit: 100, specFolder })
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:920:      avgSimilarity: Math.min(100, (row.keyword_score || 1) * 15),
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:921:      conceptSimilarities: concepts.map(() => row.keyword_score || 1),
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:930:      searchMethod: 'keyword',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:1444:export { generate_query_embedding as generateQueryEmbedding };
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:1445:export { keyword_search as keywordSearch };
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-queries.ts:1448:export { multi_concept_keyword_search as multiConceptKeywordSearch };
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:21:/** Maximum graph traversal depth. Beyond 2 hops, signal degrades and queries become expensive. */
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:103:  rrfScore?: number;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:356: * Resolve the primary numeric score from a result, checking score, rrfScore,
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:361:  if (typeof result.rrfScore === 'number' && Number.isFinite(result.rrfScore)) return result.rrfScore;
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:376:    rrfScore: score,
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:639:      rrfScore: score,
.opencode/skills/system-spec-kit/mcp_server/lib/search/causal-boost.ts:728:    // Find seed memory IDs whose titles contain matched concept keywords
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/k-value-analysis.ts:177:      ? fused.reduce((sum, r) => sum + r.rrfScore, 0) / fused.length
.opencode/skills/system-spec-kit/mcp_server/lib/eval/k-value-analysis.ts:675:    const fallbackResult: JudgedKSweepResult = {
.opencode/skills/system-spec-kit/mcp_server/lib/eval/k-value-analysis.ts:680:    return fallbackResult;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:25:  /** Weight for keyword (BM25) search component, 0-1 */
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:26:  keywordWeight: number;
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:55:    semanticWeight: 0.7,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:56:    keywordWeight: 0.3,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:63:    semanticWeight: 0.6,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:64:    keywordWeight: 0.4,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:71:    semanticWeight: 0.4,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:72:    keywordWeight: 0.6,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:79:    semanticWeight: 0.3,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:80:    keywordWeight: 0.7,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:87:    semanticWeight: 0.6,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:88:    keywordWeight: 0.4,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:95:    semanticWeight: 0.5,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:96:    keywordWeight: 0.5,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:103:    semanticWeight: 0.8,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:104:    keywordWeight: 0.2,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:111:    semanticWeight: 0.7,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:112:    keywordWeight: 0.3,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:119:    semanticWeight: 0.5,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:120:    keywordWeight: 0.5,
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:153: * Query keyword/pattern mapping for artifact class detection from
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:156:const QUERY_PATTERNS: Array<{ keywords: string[]; patterns: RegExp[]; artifactClass: ArtifactClass }> = [
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:159:    keywords: ['checklist', 'checkbox', 'check list', 'verification', 'p0', 'p1', 'p2', 'blocker'],
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:164:    keywords: ['tasks', 'task list', 'todo', 'to-do', 'work items', 'backlog'],
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:169:    keywords: ['decision', 'adr', 'decision-record', 'rationale', 'trade-off', 'tradeoff', 'chose', 'alternative'],
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:174:    keywords: ['implementation-summary', 'implementation summary', 'summary of changes', 'what was implemented', 'config', 'setup', 'env', 'flag', 'setting'],
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:179:    keywords: ['plan', 'planning', 'approach', 'strategy', 'phases', 'milestones', 'timeline'],
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:184:    keywords: ['spec', 'specification', 'requirements', 'scope', 'objective', 'constraints'],
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:194:    keywords: ['memory', 'context', 'session', 'previous session', 'prior work', 'last time', 'continue', 'resume', 'recover', 'continuation'],
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:204: * Intent-based fallback mapping for artifact class detection.
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:205: * Used when keyword/pattern scoring yields zero matches but an
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:277:  for (const { keywords, patterns, artifactClass } of QUERY_PATTERNS) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:281:    for (const keyword of keywords) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:282:      if (lower.includes(keyword)) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:300:  // Confidence: normalize score. Max realistic score ~6-8 (3 keywords + 2 patterns).
.opencode/skills/system-spec-kit/mcp_server/lib/search/artifact-routing.ts:304:  // Intent-based fallback: use module-level INTENT_TO_ARTIFACT map
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:9:// query, embeds it, then uses the pseudo-document embedding as an
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:30:import * as embeddings from '../providers/embeddings.js';
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:31:import * as vectorIndex from './vector-index.js';
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:57:/** HyDE result including the pseudo-document and its embedding. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:61:  /** Embedding vector of the pseudo-document (Float32Array). */
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:62:  embedding: Float32Array;
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:69:  rrfScore?: number;
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:128: *   intentAdjustedScore (not in BaselineResult) → rrfScore → score → similarity/100
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:156:  if (typeof result.rrfScore === 'number' && Number.isFinite(result.rrfScore))
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:157:    return Math.max(0, Math.min(1, result.rrfScore));
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:286: *   3. Embed the pseudo-document via the embeddings provider.
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:287: *   4. Cache { pseudoDocument, embedding } with 1-hour TTL.
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:293: *   - LLM or embedding call fails
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:316:  // Cache hit — return stored pseudo-document + embedding
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:328:    const embeddingRaw = await embeddings.generateQueryEmbedding(pseudoDocument);
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:329:    if (!embeddingRaw) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:334:    const embedding = embeddingRaw instanceof Float32Array
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:335:      ? embeddingRaw
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:336:      : Float32Array.from(embeddingRaw as number[]);
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:338:    const result: HyDEResult = { pseudoDocument, embedding };
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:361: * @param embedding - The pseudo-document embedding.
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:366:export function vectorOnly(
.opencode/skills/system-spec-kit/mcp_server/lib/search/hyde.ts:367:  embedding: Float32Array,
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-logger.ts:112:  /** Fusion method used, e.g. "rrf". */
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:15:// Feature catalog: Quality-aware 3-tier search fallback
.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:84: * Multi-query expansion for deep-mode retrieval.
.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:100: * PI-A2: Quality-aware 3-tier search fallback chain.
.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:176: * R12: Query expansion for embedding-based retrieval.
.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:197: * Records intent metadata (document, code, structured_data) alongside embeddings.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:598: * Phase B T017: Graph-expanded fallback on zero/weak results.
.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:650: * Phase B T018: Community-level search as fallback channel.
.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:661: * Adds retrievalLevel parameter: 'local' (entity), 'global' (community), 'auto' (local + fallback).
.opencode/skills/system-spec-kit/mcp_server/lib/search/chunk-reassembly.ts:28:  contentSource?: 'reassembled_chunks' | 'file_read_fallback';
.opencode/skills/system-spec-kit/mcp_server/lib/search/chunk-reassembly.ts:38:    fallback: number;
.opencode/skills/system-spec-kit/mcp_server/lib/search/chunk-reassembly.ts:82: * 4. Falls back to file_read_fallback when chunks have missing content
.opencode/skills/system-spec-kit/mcp_server/lib/search/chunk-reassembly.ts:99:        fallback: 0,
.opencode/skills/system-spec-kit/mcp_server/lib/search/chunk-reassembly.ts:126:        contentSource: 'file_read_fallback',
.opencode/skills/system-spec-kit/mcp_server/lib/search/chunk-reassembly.ts:148:        fallback: 0,
.opencode/skills/system-spec-kit/mcp_server/lib/search/chunk-reassembly.ts:185:    let fallback = 0;
.opencode/skills/system-spec-kit/mcp_server/lib/search/chunk-reassembly.ts:192:        fallback++;
.opencode/skills/system-spec-kit/mcp_server/lib/search/chunk-reassembly.ts:193:        return { ...row, chunkCount, contentSource: 'file_read_fallback' as const };
.opencode/skills/system-spec-kit/mcp_server/lib/search/chunk-reassembly.ts:205:        fallback++;
.opencode/skills/system-spec-kit/mcp_server/lib/search/chunk-reassembly.ts:206:        return { ...row, chunkCount, contentSource: 'file_read_fallback' as const };
.opencode/skills/system-spec-kit/mcp_server/lib/search/chunk-reassembly.ts:216:        fallback++;
.opencode/skills/system-spec-kit/mcp_server/lib/search/chunk-reassembly.ts:217:        return { ...row, chunkCount, contentSource: 'file_read_fallback' as const };
.opencode/skills/system-spec-kit/mcp_server/lib/search/chunk-reassembly.ts:235:        fallback,
.opencode/skills/system-spec-kit/mcp_server/lib/search/chunk-reassembly.ts:247:        fallback: parentIds.size,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/recovery-payload.ts:173: * Phase B T017: Build graph-expanded fallback query terms on zero/weak results.
.opencode/skills/system-spec-kit/mcp_server/lib/search/recovery-payload.ts:200:    // Find memory IDs matching the routed concepts via title keyword search,
.opencode/skills/system-spec-kit/mcp_server/lib/search/recovery-payload.ts:237:    // Step 3: Extract short keyword phrases from neighbor titles
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/session-state.ts:296: * Compute keyword overlap between goal and content.
.opencode/skills/system-spec-kit/mcp_server/lib/search/session-state.ts:297: * Returns a score between 0 and 1 based on fraction of goal keywords found in content.
.opencode/skills/system-spec-kit/mcp_server/lib/search/session-state.ts:325: * Applies a boost factor of up to GOAL_BOOST_MAX (1.2x) based on keyword overlap.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:8:import * as embeddingsProvider from '../providers/embeddings.js';
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:14:import * as bm25Index from './bm25-index.js';
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:17:} from './vector-index-aliases.js';
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:20:  to_embedding_buffer,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:23:} from './vector-index-types.js';
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:26:  get_embedding_dim,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:132:type IndexMemoryDeferredParams = Omit<IndexMemoryParams, 'embedding'> & {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:140: * Indexes a memory with an embedding payload.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:143: * @throws {VectorIndexError} When embedding validation fails or the mutation cannot be applied.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:149: *   embedding,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:165:    embedding,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:175:  if (!embedding) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:179:  const expected_dim = get_embedding_dim();
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:180:  if (embedding.length !== expected_dim) {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:183:      `Embedding must be ${expected_dim} dimensions, got ${embedding.length}`,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:190:  const embedding_buffer = to_embedding_buffer(embedding);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:204:      embedding,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:223:        importance_weight, created_at, updated_at, embedding_model,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:242:        INSERT INTO vec_memories (rowid, embedding) VALUES (?, ?)
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:243:      `).run(row_id, embedding_buffer);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:258: * Indexes a memory record without storing an embedding yet.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:334:    logger.info(`Deferred indexing: Memory ${Number(row_id)} saved without embedding (BM25/FTS5 searchable)`);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:343: * Updates stored memory metadata and embeddings.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:346: * @throws {VectorIndexError} When embedding validation fails or the mutation transaction cannot complete.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:349: * const id = update_memory({ id: 42, title: 'Updated title', embedding });
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:362:    embedding,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:433:    if (embedding) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:434:      updates.push('embedding_model = ?');
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:435:      updates.push('embedding_generated_at = ?');
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:438:      values.push(embeddingsProvider.getModelName(), now, 'pending');
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:453:    if (embedding && sqlite_vec) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:454:      const expected_dim = get_embedding_dim();
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:455:      if (embedding.length !== expected_dim) {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:458:          `Embedding must be ${expected_dim} dimensions, got ${embedding.length}`,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:463:      const embedding_buffer = to_embedding_buffer(embedding);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:466:        INSERT INTO vec_memories (rowid, embedding) VALUES (?, ?)
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:467:      `).run(BigInt(id), embedding_buffer);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:551:      if (bm25Index.isBm25Enabled()) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:552:        bm25Index.getIndex().removeDocument(String(id));
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:699:        if (bm25Index.isBm25Enabled()) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:700:          const bm25 = bm25Index.getIndex();
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-mutations.ts:702:            bm25.removeDocument(String(id));
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts:38:  fallbackState: FallbackState;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts:102:        fallbackState: 'compile_probe_miss',
.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts:107:      lexicalPath: 'unavailable',
.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts:108:      fallbackState: 'compile_probe_miss',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts:120:        fallbackState: 'missing_table',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts:132:      fallbackState: 'missing_table',
.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts:137:    lexicalPath: 'fts5',
.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts:138:    fallbackState: 'ok',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts:210:  if (capability.fallbackState !== 'ok') {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts:227:      fallbackState: 'ok',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts:240:            fallbackState: 'bm25_runtime_failure',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts:245:              fallbackState: 'missing_table',
.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts:248:              lexicalPath: 'unavailable',
.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts:249:              fallbackState: 'bm25_runtime_failure',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts:273:  return probeFts5Capability(db).fallbackState === 'ok';
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:47:  embedding_model?: string | null;
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:48:  embedding_generated_at?: string | null;
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:49:  embedding_status?: string;
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:71:  keywordScore?: number;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:88:  keyword_score?: number;
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:107:  embedding: EmbeddingInput;
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:123:  embedding?: EmbeddingInput;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:169: * @param embedding - The embedding values to serialize.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:170: * @returns A binary buffer representing the embedding.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:172:export function to_embedding_buffer(embedding: EmbeddingInput): Buffer {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:173:  if (embedding instanceof Float32Array) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:174:    return Buffer.from(embedding.buffer, embedding.byteOffset, embedding.byteLength);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:176:  return Buffer.from(new Float32Array(embedding).buffer);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:9:// Seeds are retrieved via a lightweight keyword-only search using
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:10:// BM25/FTS5 (no embedding call) to ground the LLM prompt in real
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:24:import { fts5Bm25Search } from './sqlite-fts.js';
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:91: * Uses FTS5 / BM25 keyword search only — no embedding call — to keep
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:186: * If neither is set, the function returns null (caller handles graceful fallback).
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:330:   *   7. Return result (or fallback identity on any failure).
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:359:    const fallback: ReformulationResult = { abstract: q, variants: [] };
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:362:      return fallback;
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:376:        `[llm-reformulation] llm.rewrite failed, returning fallback: ${msg}`,
.opencode/skills/system-spec-kit/mcp_server/lib/search/llm-reformulation.ts:380:    return fallback;
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-surrogates.ts:406: * Compute keyword overlap score between a query and a target string.
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-surrogates.ts:414:function keywordOverlap(queryTokens: string[], target: string): number {
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-surrogates.ts:435: *   - Question match (best keyword overlap across surrogateQuestions): weight 0.4
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-surrogates.ts:436: *   - Summary match (keyword overlap): weight 0.2
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-surrogates.ts:437: *   - Heading match (best keyword overlap across headings): weight 0.1
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-surrogates.ts:463:    const overlap = keywordOverlap(queryTokens, alias);
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-surrogates.ts:475:    const overlap = keywordOverlap(queryTokens, question);
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-surrogates.ts:490:    summaryScore = keywordOverlap(queryTokens, surrogates.summary);
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-surrogates.ts:499:    const overlap = keywordOverlap(queryTokens, heading);
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-surrogates.ts:537:  keywordOverlap,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:12://   - multi-concept: Generate per-concept embeddings, run multiConceptSearch
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:33://     - Generates query embeddings via the embeddings provider (external call)
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:39:import * as embeddings from '../../providers/embeddings.js';
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:44:import { expandQueryWithEmbeddings, isExpansionActive } from '../embedding-expansion.js';
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:245:  const fallbackScores: Record<string, number> = {};
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:247:    fallbackScores[source] = resolvedScore;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:249:  return fallbackScores;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:354: * rule-based expansion is skipped — consistent with the R12 embedding-expansion
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:472:  // Fix #16: Cache embedding at function scope for reuse in constitutional injection
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:581:    // Generate one embedding per concept
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:584:      const emb = await embeddings.generateQueryEmbedding(concept);
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:587:          `[stage1-candidate-gen] Failed to generate embedding for concept: "${concept}"`
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:605:    // Resolve the query embedding — either pre-computed in config or generate now
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:606:    // Fix #16 — Cache this embedding for reuse in constitutional injection path
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:609:      queryEmbedding ?? (await embeddings.generateQueryEmbedding(query));
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:661:                  const facetEmbedding = await embeddings.generateQueryEmbedding(q);
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:663:                    console.warn('[stage1-candidate-gen] D2 facet embedding generation returned null');
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:724:                const variantEmbedding = await embeddings.generateQueryEmbedding(variant);
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:726:                  console.warn('[stage1-candidate-gen] Deep variant embedding generation returned null');
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:784:      // We expand the query using embedding similarity to find related terms
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:822:              embeddings.generateQueryEmbedding(expanded.combinedQuery).then(
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:825:                    console.warn('[stage1-candidate-gen] Expanded query embedding generation returned null');
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:855:                channel: 'r12-embedding-expansion',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:909:            addTraceEntry(trace, 'fallback', 0, candidates.length, 0, {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:923:      queryEmbedding ?? (await embeddings.generateQueryEmbedding(query));
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1026:      // Fix #16 — Reuse cached embedding instead of generating a new one
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1028:        cachedEmbedding ?? queryEmbedding ?? (await embeddings.generateQueryEmbedding(query));
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1080:  //   1. Retrieve top-3 seed results via fast BM25/FTS5 (no embedding call).
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1096:          cachedEmbedding ?? queryEmbedding ?? (await embeddings.generateQueryEmbedding(query));
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1103:              // Reuse cached embedding for original query (idx 0); generate fresh for variants
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1104:              const emb = idx === 0 ? reformEmbedding : await embeddings.generateQueryEmbedding(q);
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1106:                console.warn('[stage1-candidate-gen] LLM reform embedding generation returned null');
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1216:  // Met (>5000 indexed), run a parallel search on summary embeddings and merge
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1217:  // Results. Pattern follows R12 embedding expansion: run in parallel, merge
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1224:          queryEmbedding ?? (await embeddings.generateQueryEmbedding(query));
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1279:                  channel: 'r8-summary-embeddings',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1337:              // Using the canonical fallback chain prevents overwriting
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1345:                rrfScore: boostedScore,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:1393:  // and keyword channels are always active regardless of query variant count.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/orchestrator.ts:8:// Stages 2-4 fall back to previous stage output with degraded metadata.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/orchestrator.ts:18://     - When a stage degrades, metadata.degraded = true and timing tracks each stage
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/orchestrator.ts:60:  let degraded = false;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/orchestrator.ts:62:  // -- Stage 1: Candidate Generation (MANDATORY — no fallback possible) --
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/orchestrator.ts:97:    degraded = true;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/orchestrator.ts:129:    degraded = true;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/orchestrator.ts:138:          fallback: 0,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/orchestrator.ts:163:    degraded = true;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/orchestrator.ts:190:      degraded: degraded || undefined,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/embedding-expansion.ts:163: *      retrieval; broadening them degrades precision without recall gain.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/embedding-expansion.ts:174: * @param embedding - Pre-computed query embedding (Float32Array from the
.opencode/skills/system-spec-kit/mcp_server/lib/search/embedding-expansion.ts:175: *                    embeddings provider). Must not be empty.
.opencode/skills/system-spec-kit/mcp_server/lib/search/embedding-expansion.ts:183:  embedding: Float32Array,
.opencode/skills/system-spec-kit/mcp_server/lib/search/embedding-expansion.ts:201:  // -- Guard 3: Valid embedding -----------------------------------------------
.opencode/skills/system-spec-kit/mcp_server/lib/search/embedding-expansion.ts:202:  if (!embedding || embedding.length === 0) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/embedding-expansion.ts:203:    console.warn('[embedding-expansion] Received empty embedding — skipping expansion');
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/embedding-expansion.ts:267:    // FTS and embedding re-encoding without requiring a separator token.
.opencode/skills/system-spec-kit/mcp_server/lib/search/embedding-expansion.ts:277:    console.warn(`[embedding-expansion] Expansion failed, using original query: ${msg}`);
.opencode/skills/system-spec-kit/mcp_server/lib/search/embedding-expansion.ts:287: * Synchronous predicate that returns true when R12 embedding expansion
.opencode/skills/system-spec-kit/mcp_server/lib/search/embedding-expansion.ts:298: * @returns True when embedding expansion should be applied.
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:19:  keywords: string[];
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:131: * T016: Lightweight deterministic embedding centroid classifier.
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:133: * The model uses hashed bag-of-words embeddings so centroids can be built
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:212: * Score a query against an intent's keyword list, returning normalized score and matched keywords.
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:216: * @returns Object with normalized score and array of matched keywords
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:220:  const keywords = INTENT_KEYWORDS[intent];
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:224:  for (const keyword of keywords) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:225:    if (lower.includes(keyword)) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:227:      matches.push(keyword);
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:231:  // P3-12: Require at least 2 keyword matches for a meaningful keyword score.
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:232:  // A single generic keyword match produces a heavily discounted score.
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:237:  // Normalize by keyword count
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:239:    score: keywords.length > 0 ? score / keywords.length : 0,
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:279: * Compute a deterministic normalized embedding for text.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:367: * Score query-to-intent using centroid embeddings.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:410:      keywords: [],
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:428:    const { score: keywordScore, matches } = calculateKeywordScore(query, intent);
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:432:    let combined = (centroidScore * 0.5) + (keywordScore * 0.35) + (patternScore * 0.15);
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:468:  // This prevents weak single-keyword matches from dominating classification.
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:474:      keywords: [...new Set(allKeywords)],
.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:483:    keywords: [...new Set(allKeywords)],
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/bm25-index.ts:42:const BM25_ENABLED_VALUES = new Set(['1', 'true', 'yes', 'on', 'experimental', 'fallback']);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/bm25-index.ts:415:      console.warn(`[bm25-index] Failed to sync BM25 rows: ${msg}`);
.opencode/skills/system-spec-kit/mcp_server/lib/search/bm25-index.ts:465:      console.warn(`[bm25-index] Failed to schedule BM25 warmup: ${msg}`);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/bm25-index.ts:562:  bm25: string[];
.opencode/skills/system-spec-kit/mcp_server/lib/search/bm25-index.ts:573:    fts: [...sharedTokens, ...phraseToken],
.opencode/skills/system-spec-kit/mcp_server/lib/search/bm25-index.ts:574:    bm25: sharedTokens
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-classifier.ts:135: * graduated), all queries classify as "complex" (safe fallback — full pipeline).
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-classifier.ts:137: * On any error, returns "complex" (safe fallback per spec).
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-classifier.ts:147:  // Safe fallback for any unexpected state
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-classifier.ts:151:    confidence: 'fallback',
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-classifier.ts:160:    // Edge case: empty or whitespace-only queries → complex fallback
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:263: * from types.ts. The shared function uses the correct fallback chain:
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:264: * intentAdjustedScore → rrfScore → score → similarity/100, all clamped to [0,1].
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:275:    rrfScore: clamped,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:288:    row.rrfScore = clamped;
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:654: * current composite score (`score`, then `rrfScore`, then `similarity`).
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:972:  // the same row objects, creating a race condition if the orchestrator's timeout fallback
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:988:      // so rrfScore/intentAdjustedScore are not stale for subsequent steps.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:1266:          rrfScore: row.rrfScore,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-aliases.ts:23:  generate_query_embedding,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-aliases.ts:340:    const embedding = await generate_query_embedding(content.substring(0, 1000));
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-aliases.ts:341:    if (!embedding) {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/graph-search-fn.ts:111:    // Hierarchy-aware fallback/augmentation for spec-scoped retrieval.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/graph-search-fn.ts:256: * Legacy LIKE-based fallback when FTS5 table is unavailable.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/result-explainability.ts:298:  // Vector-only fallback
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/anchor-metadata.ts:15:// Structured IDs follow the pattern: TYPE-keywords-NNN
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/anchor-metadata.ts:40:   * For structured IDs (TYPE-keywords-NNN) this is the leading segment in
.opencode/skills/system-spec-kit/mcp_server/lib/search/anchor-metadata.ts:69: * Derive the semantic type from an anchor ID.
.opencode/skills/system-spec-kit/mcp_server/lib/search/reranker.ts:4:// Feature catalog: Stage 3 effectiveScore fallback chain
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:21://     - contentSource is set to 'reassembled_chunks' or 'file_read_fallback'
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:68:function resolveRerankOutputScore(raw: unknown, fallback: number): number {
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:72:  return floorScore(fallback);
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:100:  fallback: number;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:116:type RerankProvider = 'cross-encoder' | 'local-gguf' | 'fallback-sort' | 'none';
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:167:  // Gated behind SPECKIT_MMR feature flag. Retrieves embeddings from
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:180:          `SELECT rowid, embedding FROM vec_memories WHERE rowid IN (${placeholders})`
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:181:        ) as Database.Statement).all(...numericIds) as Array<{ rowid: number; embedding: Buffer }>;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:183:        const embeddingMap = new Map<number, Float32Array>();
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:185:          if (Buffer.isBuffer(row.embedding)) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:186:            embeddingMap.set(
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:188:              new Float32Array(row.embedding.buffer, row.embedding.byteOffset, row.embedding.byteLength / 4)
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:195:          const emb = embeddingMap.get(r.id);
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:199:              // Use effectiveScore() for consistent fallback chain
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:201:              embedding: emb,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:213:          // FIX #5: MMR can only diversify rows that have embeddings. Non-embedded
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:269:        fallback: chunkStats.fallback,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:298: * results unmodified (graceful degradation).
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:357:          rrfScore: rerankScore,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:373:  // P1-015: Use effectiveScore() for consistent fallback chain
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:394:      (result) => result.scoringMethod === 'fallback'
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:396:      ? 'fallback-sort'
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:421:        rrfScore: rerankScore,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:429:    // Graceful degradation — return original results on any reranker failure
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:485:    fallback: 0,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:577: * and rrfScore before raw score/similarity, matching Stage 2's
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:596: *   `contentSource: 'file_read_fallback'`.
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:623:      // Parent not found in DB — use best chunk as fallback
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:624:      stats.fallback++;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:649:      rrfScore: parentScore,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:666:      `[stage3-rerank] MPAB DB reassembly failed for parent ${parentId}: ${toErrorMessage(err)} — using chunk fallback`
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:668:    stats.fallback++;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:674: * Mark a pipeline row as a chunk-content fallback.
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:679: * @returns A new PipelineRow annotated as a fallback parent representation.
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:691:    contentSource: 'file_read_fallback',
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage3-rerank.ts:693:    rrfScore: parentScore,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/feedback-denylist.ts:40:   Generic programming keywords that appear in nearly all code.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:83: * Generate summary, compute embedding, store in memory_summaries.
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:87: * 3. Call embeddingFn(summary) to get embedding
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:89: * 5. Store embedding as Buffer (Float32Array -> Buffer)
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:102:  embeddingFn: (text: string) => Promise<Float32Array | null>
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:115:    const embedding = await embeddingFn(summary);
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:116:    const embeddingBlob = embedding ? float32ToBuffer(embedding) : null;
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:122:        (memory_id, summary_text, summary_embedding, key_sentences, created_at, updated_at)
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:130:      embeddingBlob,
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:148: * Vector search on summary embeddings — parallel channel for stage1.
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:150: * 1. SELECT id, memory_id, summary_embedding FROM memory_summaries
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:151: *    WHERE summary_embedding IS NOT NULL
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:152: * 2. Compute cosine similarity between query embedding and each summary embedding
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:171:      SELECT id, memory_id, summary_embedding
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:173:      WHERE summary_embedding IS NOT NULL
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:175:    `).all(fetchCap) as Array<{ id: number; memory_id: number; summary_embedding: Buffer }>;
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:180:      const storedEmbedding = bufferToFloat32(row.summary_embedding);
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:195:      '[memory-summaries] Failed to query summary embeddings:',
.opencode/skills/system-spec-kit/mcp_server/lib/search/memory-summaries.ts:215:      WHERE embedding_status = 'success'
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:38:  contentSource?: 'reassembled_chunks' | 'file_read_fallback';
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:42:  rrfScore?: number;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:55: * Shared score resolution function — canonical fallback chain for deriving the
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:60: * separate implementations with different fallback orders and clamping. This shared
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:61: * function uses the correct chain: intentAdjustedScore → rrfScore → score → similarity/100,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:67:  if (typeof row.rrfScore === 'number' && Number.isFinite(row.rrfScore))
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:68:    return Math.max(0, Math.min(1, row.rrfScore));
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:82:  'similarity' | 'score' | 'importance_weight' | 'rrfScore' | 'intentAdjustedScore' | 'attentionScore'
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:105:  contentSource?: 'reassembled_chunks' | 'file_read_fallback';
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:280:      fallback: number;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:334:    /** B1: True when one or more stages fell back to degraded output. */
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:335:    degraded?: boolean;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:371:  rrfScore?: number;
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:385:    rrfScore: r.rrfScore,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:419:    if (row.rrfScore !== snap.rrfScore) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/types.ts:421:        `[Stage4Invariant] Score mutation detected: id=${snap.id} rrfScore changed from ${snap.rrfScore} to ${row.rrfScore}`
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage4-filter.ts:16://     - No score field (similarity, score, rrfScore, intentAdjustedScore,
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage4-filter.ts:207: * A1 FIX: Previously used a different precedence order (rrfScore first) and
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage4-filter.ts:306:  // Enforce caller's limit after all filtering to prevent degraded paths exceeding requested count
.opencode/skills/system-spec-kit/mcp_server/lib/search/retrieval-directives.ts:113: * or a leading imperative keyword followed by a noun phrase or condition.
.opencode/skills/system-spec-kit/mcp_server/lib/search/retrieval-directives.ts:145: *   - the condition clause introduced by a condition keyword (conditionClause)
.opencode/skills/system-spec-kit/mcp_server/lib/search/retrieval-directives.ts:155:  // Find the earliest imperative keyword present in this line
.opencode/skills/system-spec-kit/mcp_server/lib/search/retrieval-directives.ts:179:      // Clause starts after the condition keyword
.opencode/skills/system-spec-kit/mcp_server/lib/search/retrieval-directives.ts:198: *    imperative keywords (must, always, never, should, …).
.opencode/skills/system-spec-kit/mcp_server/lib/search/retrieval-directives.ts:207: * @param title   - Title of the memory (used as fallback source label).
.opencode/skills/system-spec-kit/mcp_server/lib/search/validation-metadata.ts:16:// Fields (score, rrfScore, similarity, intentAdjustedScore). It only
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/validation-metadata.ts:236:  // -- 4. Importance tier signal (even without quality score fallback above) --
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:23:import { getStartupEmbeddingDimension } from '@spec-kit/shared/embeddings/factory';
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:124: * Gets the active embedding dimension for the current provider.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:125: * @returns The embedding dimension.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:127:export function get_embedding_dim(): number {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:132: * Waits for the embedding provider to report a stable dimension.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:134: * @returns A promise that resolves to the confirmed embedding dimension.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:136:export async function get_confirmed_embedding_dimension(timeout_ms = 5000): Promise<number> {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:139:    const dim = get_embedding_dim();
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:164:function get_existing_embedding_dimension(
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:186:      SELECT value FROM vec_metadata WHERE key = 'embedding_dim'
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:226:function validate_embedding_dimension_for_connection(
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:235:    const current_dim = get_embedding_dim();
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:236:    const existing = get_existing_embedding_dimension(database);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:259:    return { valid: true, stored: null, current: get_embedding_dim(), reason: get_error_message(e) };
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:267:export function validate_embedding_dimension(): { valid: boolean; stored: number | null; current: number | null; reason?: string; warning?: string } {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:268:  return validate_embedding_dimension_for_connection(db, sqlite_vec_available_flag);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:337: * @param default_value - The fallback value to return on failure.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:338: * @returns The parsed JSON value or the fallback.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:810:  const preBootstrapDimCheck = validate_embedding_dimension_for_connection(new_db, vec_available);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:814:    console.error(`[vector-index] FATAL: ${msg}`);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:819:  create_schema(new_db, { sqlite_vec_available: vec_available, get_embedding_dim });
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:822:  const dimCheck = validate_embedding_dimension_for_connection(new_db, vec_available);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:911:   * Searches indexed memories by embedding similarity.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:912:   * @param embedding - The query embedding to search with.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:916:   * @throws {VectorIndexError} When the embedding dimension is invalid or the store cannot initialize.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:922:  async search(embedding: EmbeddingInput, topK: number, options: VectorSearchOptions = {}): Promise<MemoryRow[]> {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:926:    const expected_dim = get_embedding_dim();
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:927:    if (!embedding || embedding.length !== expected_dim) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:929:        `Invalid embedding dimension: expected ${expected_dim}, got ${embedding?.length}`,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:950:   * Inserts or updates a memory row and its embedding metadata.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:952:   * @param embedding - The embedding to persist.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:955:   * @throws {VectorIndexError} When embedding validation fails or required metadata is missing.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:958:   * const id = await store.upsert('ignored', embedding, { spec_folder: 'specs/001-demo', file_path: 'spec.md' });
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:961:  async upsert(_id: string, embedding: EmbeddingInput, metadata: JsonObject): Promise<number> {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:965:    const expected_dim = get_embedding_dim();
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:966:    if (!embedding || embedding.length !== expected_dim) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:968:        `Embedding dimension mismatch: expected ${expected_dim}, got ${embedding?.length}`,
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:994:      embedding: embedding
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:1054:    return get_embedding_dim();
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:1079:    embedding: string,
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:1088:  async enhancedSearch(embedding: string, options: EnhancedSearchOptions = {}): Promise<EnrichedSearchResult[]> {
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:1092:    return enhanced_search(embedding, undefined, options, database);
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:1114:    cleaned?: { vectors: number; chunks: number };
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:1132:export { get_confirmed_embedding_dimension as getConfirmedEmbeddingDimension };
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:1133:export { get_embedding_dim as getEmbeddingDim };
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts:1134:export { validate_embedding_dimension as validateEmbeddingDimension };
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/README.md:79:- Optional R12 embedding expansion and R8 summary embedding channels.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/README.md:108:4. **Score Resolution Consistency.** All stages use the shared `resolveEffectiveScore()` function from `types.ts` with fallback chain: `intentAdjustedScore` > `rrfScore` > `score` > `similarity/100`, clamped to [0, 1].
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/entity-linker.ts:102:  'embedding': 'embedding',
.opencode/skills/system-spec-kit/mcp_server/lib/search/entity-linker.ts:103:  'embeddings': 'embedding',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/entity-linker.ts:106:  'representation': 'embedding',
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/entity-linker.ts:593:        // Keep canonical fallback even when aliases are malformed.
.opencode/skills/system-spec-kit/mcp_server/lib/search/entity-linker.ts:743: * Resolve S5 density threshold from env var with safe fallback.
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-decomposer.ts:14://   - Graceful fallback: any error returns only the original query
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-decomposer.ts:206: * The "score" used for tie-breaking is resolved from `score`, `rrfScore`,
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-decomposer.ts:212:export function mergeByFacetCoverage<T extends { id: number; score?: number; rrfScore?: number; similarity?: number }>(
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-decomposer.ts:263: * Resolve a numeric score from a result item using the pipeline's fallback chain.
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-decomposer.ts:266:function resolveItemScore(item: { score?: number; rrfScore?: number; similarity?: number }): number {
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-decomposer.ts:269:  if (typeof item.rrfScore === 'number' && Number.isFinite(item.rrfScore))
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-decomposer.ts:270:    return Math.max(0, Math.min(1, item.rrfScore));
.opencode/skills/system-spec-kit/mcp_server/lib/search/encoding-intent.ts:9:// Stored in the `encoding_intent` column alongside the embedding
.opencode/skills/system-spec-kit/mcp_server/lib/search/encoding-intent.ts:59:  // Import/require/export statements and programming keywords
.opencode/skills/system-spec-kit/mcp_server/lib/search/session-boost.ts:16:  rrfScore?: number;
.opencode/skills/system-spec-kit/mcp_server/lib/search/session-boost.ts:124:  if (typeof result.rrfScore === 'number' && Number.isFinite(result.rrfScore)) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/session-boost.ts:125:    return result.rrfScore;
.opencode/skills/system-spec-kit/mcp_server/lib/search/session-boost.ts:174:          rrfScore: finalScore,
.opencode/skills/system-spec-kit/mcp_server/lib/search/dynamic-token-budget.ts:34:  /** Whether the dynamic flag was active (false = default fallback used). */
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:94:| BM25 | `bm25-index.ts` | Pure TypeScript keyword matching |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:116:Cross-encoder reranking (optional, min 2 results) followed by MPAB chunk-to-memory aggregation. Aggregation formula: `parentScore = sMax + 0.3 * Sum(rest) / sqrt(N)` where `sMax` is the best chunk score and N is the remaining chunk count. Chunk ordering preserves `chunk_index` document order (B2 guarantee). `contentSource` metadata marks provenance (`reassembled_chunks` or `file_read_fallback`).
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:134:- Resilient to retrieval method failures (graceful degradation)
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:178:- `fallbackState`: the truthful FTS capability outcome for the request.
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:180:The forced-degrade matrix is:
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:188:| `bm25_runtime_failure` | The FTS5 table exists, but the `bm25(...)` ranking call fails at runtime | `unavailable` |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:292:| `local-reranker.ts`        | -      | TypeScript | Local GGUF-based cross-encoder reranking fallback   |
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:293:| `intent-classifier.ts`     | ~500   | TypeScript | 7 intent types with keyword patterns                |
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:294:| `bm25-index.ts`            | ~280   | TypeScript | Pure TypeScript BM25 (REQ-028, v1.2.0)              |
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:307:| `folder-discovery.ts`      | -      | TypeScript | Spec folder description discovery: per-folder `description.json` CRUD, centralized cache aggregation, staleness detection, `slugifyFolderName()` helper, keyword-overlap relevance scoring (PI-B3) |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:316:| `memory-summaries.ts`      | -      | TypeScript | Summary storage, embedding, and search channel for memory summaries (R8) |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:343:| `community-search.ts`      | -      | TypeScript | Community-level search fallback — keyword-matches community summaries, returns member IDs |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:367:   bm25-index.ts -> BM25 search (keyword)
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:418:| `EMBEDDING_DIM`          | `768`    | Fallback embedding dimension        |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:476:function toEmbeddingBuffer(embedding) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:477:  return Buffer.from(embedding.buffer, embedding.byteOffset, embedding.byteLength);
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:506:// 1. Vector search (semantic similarity)
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:507:// 2. BM25/FTS5 search (keyword matching)
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:523:- If no structural graph channel: Vector + Lexical + Co-activation (3-channel fallback)
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:529:// Primary keywords: 2x weight
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:530:// Secondary keywords: 1x weight
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:600:| **Pipeline** | `generateAndStoreSummary()` combines TF-IDF extraction with embedding and persistence |
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:607:| `querySummaryEmbeddings` | `(db, queryEmbedding, limit?) => SummarySearchResult[]` | Search summaries by embedding similarity |
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:679:Same-path `unchanged` only applies to healthy existing rows (`success`, `pending`, `partial`), so unhealthy embedding states still re-enter indexing. Cross-path content-hash dedup accepts chunked parents only when the parent row is in valid `partial` state and ignores invalid parent rows marked `complete`.
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:706:**Embedding Cache Consistency** (`save/embedding-pipeline.ts` + chunking path):
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:707:Embedding cache keys now hash normalized content in both the primary and chunked embedding paths, so equivalent normalized content shares cache entries.
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:718:**Lexical Normalization + BM25 Document Text** (`bm25-index.ts`):
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:722:Watcher- and ingest-triggered reindex paths now use the normal synchronous embedding cache-miss flow. Deferred embeddings remain opt-in via `asyncEmbedding` or failure fallback.
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:786:// - rrfScore: Combined score
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:833:import * as bm25Index from './bm25-index';
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:836:if (bm25Index.isBm25Enabled()) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:838:  const results = bm25Index.getIndex().search('authentication', {
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:850:import { initializeDb, getDb } from './vector-index';
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:872:- Guard clauses added for missing data, null embeddings, and edge cases (B4)
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:906:| `@spec-kit/shared/embeddings` | Embeddings provider abstraction   |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:949:| REQ-028 | Pure TypeScript BM25             | bm25-index.ts                   |
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:87:  for (const fallback of FALLBACK_CHANNELS) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:89:    if (!result.includes(fallback)) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:90:      result.push(fallback);
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/evidence-gap-detector.ts:102:  // Tokenize the query into lowercase keywords.
.opencode/skills/system-spec-kit/mcp_server/lib/search/evidence-gap-detector.ts:151: * @param rrfScores - Array of Reciprocal Rank Fusion scores (any length).
.opencode/skills/system-spec-kit/mcp_server/lib/search/evidence-gap-detector.ts:154:export function detectEvidenceGap(rrfScores: number[]): TRMResult {
.opencode/skills/system-spec-kit/mcp_server/lib/search/evidence-gap-detector.ts:155:  if (rrfScores.length === 0) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/evidence-gap-detector.ts:159:  const finiteScores = rrfScores.filter((score) => Number.isFinite(score));
...
exec
/bin/zsh -lc "sed -n '1,260p' .opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
// ───────────────────────────────────────────────────────────────
// MODULE: Query Router
// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "sed -n '1,320p' .opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
exec
/bin/zsh -lc "sed -n '1,280p' .opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "sed -n '1,280p' .opencode/skills/system-spec-kit/mcp_server/lib/search/bm25-index.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
// ───────────────────────────────────────────────────────────────
// MODULE: Bm25 Index
// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "rg -n \"routeQuery|fts5Bm25Search|getIndex\\(|vectorSearchFn|fuseResultsMulti|degradation|fallback|useBm25|useFts|useVector|enforceChannelRepresentation|channels\" .opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "sed -n '320,760p' .opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
/**
...
exec
/bin/zsh -lc "sed -n '760,1180p' .opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
    return asNumbers ? new Float32Array(value) : null;
  }
...
exec
/bin/zsh -lc "sed -n '1180,1480p' .opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "sed -n '2100,2205p' .opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
/**
...
user cancelled MCP tool call
exec
/bin/zsh -lc "sed -n '1,260p' .opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
// ────────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "rg -n \"memory_match_triggers|match_triggers|trigger phrase|exact match|memory_context\\(|mode: 'resume'|mode === 'resume'|resume\" .opencode/skills/system-spec-kit/mcp_server -g '"'!**/*.map'"'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
.opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts:8:// Feature catalog: BM25 trigger phrase re-index gate
...
.opencode/skills/system-spec-kit/mcp_server/handlers/index.ts:80:type SessionResumeModule = typeof import('./session-resume.js');
.opencode/skills/system-spec-kit/mcp_server/handlers/index.ts:208:    sessionResumeModule = loadHandlerModule<SessionResumeModule>('session-resume');
...
.opencode/skills/system-spec-kit/mcp_server/handlers/index.ts:331:// Session resume handler
...
.opencode/skills/system-spec-kit/mcp_server/tools/types.ts:40:  profile?: 'quick' | 'research' | 'resume' | 'debug';
.opencode/skills/system-spec-kit/mcp_server/tools/types.ts:204:/** Arguments for session resume requests. */
...
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:212:  description: '[L2:Core] Fast trigger phrase matching with cognitive memory features. Supports attention-based decay, tiered content injection (HOT=full, WARM=summary), and co-activation of related memories. Pass session_id and turnNumber for cognitive features. Token Budget: 3500.',
...
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:738:// Phase 020: Composite session resume tool
...
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:746:      specFolder: { type: 'string', description: 'Optional spec folder to scope the resume context' },
...
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:761:      specFolder: { type: 'string', description: 'Optional spec folder to scope the resume context' },
...
.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:774:    required: ['resume', 'health', 'hints', 'nextActions'],
...
.opencode/skills/system-spec-kit/mcp_server/formatters/search-results.ts:549:            // SK-005 Prefix matching: try exact match first, then fall back to
.opencode/skills/system-spec-kit/mcp_server/handlers/quality-loop.ts:87: * Compute trigger phrase quality sub-score.
...
.opencode/skills/system-spec-kit/mcp_server/handlers/quality-loop.ts:112:    issues.push(`Only ${count} trigger phrase(s) — 4+ recommended`);
...
.opencode/skills/system-spec-kit/mcp_server/handlers/quality-loop.ts:443:  const hasTriggerIssue = issues.some(i => /trigger phrase/i.test(i));
...
.opencode/skills/system-spec-kit/mcp_server/hooks/claude/session-prime.ts:6:// based on the session source (compact, startup, resume, clear).
.opencode/skills/system-spec-kit/mcp_server/hooks/claude/session-prime.ts:18:import { getCachedSessionSummaryDecision, logCachedSummaryDecision } from '../../handlers/session-resume.js';
...
.opencode/skills/system-spec-kit/mcp_server/hooks/claude/session-prime.ts:96:    `- Memory: ${hasCachedContinuity ? 'session continuity available' : 'startup summary only (resume on demand)'}`,
.opencode/skills/system-spec-kit/mcp_server/hooks/claude/session-prime.ts:107:    `- Memory: ${hasCachedContinuity ? 'session continuity available' : 'startup summary only (resume on demand)'}`,
...
.opencode/skills/system-spec-kit/mcp_server/hooks/claude/session-prime.ts:176:/** Handle source=resume: load resume context for continued session */
...
.opencode/skills/system-spec-kit/mcp_server/hooks/claude/session-prime.ts:232:    case 'resume':
...
.opencode/skills/system-spec-kit/mcp_server/INSTALL_GUIDE.md:539:- `resume`: Session recovery (loads previous state)
...
.opencode/skills/system-spec-kit/mcp_server/hooks/gemini/session-prime.ts:10://   source: "startup" | "resume" | "clear"
...
.opencode/skills/system-spec-kit/mcp_server/hooks/gemini/session-prime.ts:142:/** Handle source=resume: load resume context */
...
.opencode/skills/system-spec-kit/mcp_server/README.md:605:| `specFolder` | string | Scope resume to a specific spec folder |
...
.opencode/skills/system-spec-kit/mcp_server/schemas/tool-input-schemas.ts:101:  mode: z.enum(['auto', 'quick', 'deep', 'focused', 'resume']).optional(),
.opencode/skills/system-spec-kit/mcp_server/schemas/tool-input-schemas.ts:115:  profile: z.enum(['quick', 'research', 'resume', 'debug']).optional(),
.opencode/skills/system-spec-kit/mcp_server/schemas/tool-input-schemas.ts:152:  profile: z.enum(['quick', 'research', 'resume', 'debug']).optional(),
...
.opencode/skills/system-spec-kit/mcp_server/hooks/claude/README.md:10:| `session-prime.ts` | SessionStart | Injects context via stdout based on source (compact/startup/resume/clear) |
.opencode/skills/system-spec-kit/mcp_server/hooks/claude/README.md:21:SessionStart(resume) → load prior session state
...
.opencode/skills/system-spec-kit/mcp_server/lib/README.md:509:const matches = await parsing.triggerMatcher.match_triggers({
.opencode/skills/system-spec-kit/mcp_server/hooks/claude/shared.ts:9:/** Token budget for session priming (startup/resume) */
.opencode/skills/system-spec-kit/mcp_server/hooks/claude/shared.ts:17:  source?: 'startup' | 'resume' | 'clear' | 'compact';
.opencode/skills/system-spec-kit/mcp_server/lib/session/README.md:125:- Quick resume command
.opencode/skills/system-spec-kit/mcp_server/lib/session/README.md:200:| Recover state | `recoverState(sessionId)` | On session resume |
.opencode/skills/system-spec-kit/mcp_server/lib/contracts/README.md:191:Bootstrap and resume remain the authority surfaces for structural context. Packet `006` only adds the shared trust contract beside packet `005`'s certainty contract; it does not create a new graph-only owner surface.
.opencode/skills/system-spec-kit/mcp_server/lib/contracts/README.md:306:- Preserve the three axes distinctly through bootstrap or resume-facing payloads. Do not merge them into a single "graph trust" label during transport.
.opencode/skills/system-spec-kit/mcp_server/lib/contracts/README.md:311:- Current owner surfaces remain authoritative: shared payload sections, session bootstrap or resume consumers, and bridge-facing graph payloads.
...
.opencode/skills/system-spec-kit/mcp_server/lib/context/opencode-transport.ts:25:/** Complete transport-only plan derived from shared startup/resume payloads. */
.opencode/skills/system-spec-kit/mcp_server/lib/context/opencode-transport.ts:85:  resumePayload?: SharedPayloadEnvelope | null;
.opencode/skills/system-spec-kit/mcp_server/lib/context/opencode-transport.ts:93:    args.resumePayload?.kind,
.opencode/skills/system-spec-kit/mcp_server/lib/context/opencode-transport.ts:98:  const systemPayload = args.bootstrapPayload ?? args.startupPayload ?? args.resumePayload ?? null;
.opencode/skills/system-spec-kit/mcp_server/lib/context/opencode-transport.ts:99:  const messagePayloads = [args.resumePayload, args.healthPayload].filter(
...
.opencode/skills/system-spec-kit/mcp_server/tests/tool-input-schema.vitest.ts:338:      input: 'resume auth work',
.opencode/skills/system-spec-kit/mcp_server/tests/tool-input-schema.vitest.ts:353:      input: 'resume auth work',
.opencode/skills/system-spec-kit/mcp_server/tests/tool-input-schema.vitest.ts:354:      profile: 'resume',
...
.opencode/skills/system-spec-kit/mcp_server/tests/tool-input-schema.vitest.ts:380:      prompt: 'resume auth work',
...
.opencode/skills/system-spec-kit/mcp_server/lib/context/shared-payload.ts:9:  | 'resume'
.opencode/skills/system-spec-kit/mcp_server/lib/context/shared-payload.ts:157:    | 'session_resume'
.opencode/skills/system-spec-kit/mcp_server/tests/handler-helpers.vitest.ts:312:    const expected = ['auto', 'quick', 'deep', 'focused', 'resume'];
.opencode/skills/system-spec-kit/mcp_server/tests/handler-helpers.vitest.ts:353:  it('resume tokenBudget is 2000', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/handler-helpers.vitest.ts:355:    expect(memoryContext.CONTEXT_MODES.resume.tokenBudget).toBe(2000);
...
.opencode/skills/system-spec-kit/mcp_server/tests/five-factor-scoring.vitest.ts:842:      title: 'test query exact match',
.opencode/skills/system-spec-kit/mcp_server/tests/five-factor-scoring.vitest.ts:847:      query: 'test query exact match',
.opencode/skills/system-spec-kit/mcp_server/lib/response/profile-formatters.ts:13://   resume   — state + nextSteps + blockers
.opencode/skills/system-spec-kit/mcp_server/lib/response/profile-formatters.ts:29:export type ResponseProfile = 'quick' | 'research' | 'resume' | 'debug';
.opencode/skills/system-spec-kit/mcp_server/lib/response/profile-formatters.ts:86:/** Output of the `resume` profile formatter. */
.opencode/skills/system-spec-kit/mcp_server/lib/response/profile-formatters.ts:111:  | { profile: 'resume'; data: ResumeProfile }
.opencode/skills/system-spec-kit/mcp_server/lib/response/profile-formatters.ts:352: * Format results as the `resume` profile.
...
.opencode/skills/system-spec-kit/mcp_server/lib/response/profile-formatters.ts:423:    case 'resume':
.opencode/skills/system-spec-kit/mcp_server/lib/response/profile-formatters.ts:424:      return { profile: 'resume', data: formatResume(safeInput) };
.opencode/skills/system-spec-kit/mcp_server/lib/config/README.md:54:| Keyword Mappings | 40+ | Title/trigger phrase to type mapping |
.opencode/skills/system-spec-kit/mcp_server/tests/composite-scoring.vitest.ts:947:        title: 'exact match test query',
.opencode/skills/system-spec-kit/mcp_server/tests/composite-scoring.vitest.ts:952:      const optionsMax = { query: 'exact match test query', anchors: ['test'] }
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-classifier.ts:76: * Check if the query exactly matches any known trigger phrase (case-insensitive).
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-classifier.ts:80: * @returns True when the query matches a trigger phrase exactly.
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-classifier.ts:95: * @param hasTrigger    - Whether a trigger phrase matched.
.opencode/skills/system-spec-kit/mcp_server/lib/search/query-classifier.ts:130: * - Simple: ≤3 terms OR trigger phrase match
...
.opencode/skills/system-spec-kit/mcp_server/lib/response/README.md:33:| `profile-formatters.ts` | Profile reducers for `quick`, `research`, `resume`, and `debug` response shapes |
...
.opencode/skills/system-spec-kit/mcp_server/lib/config/type-inference.ts:323:  keywords: 'Matched keywords in title or trigger phrases',
.opencode/skills/system-spec-kit/mcp_server/lib/validation/README.md:175:| `scoreTriggerQuality(triggerPhrases)` | Layer 2 dimension: trigger phrase quality (0-1) |
.opencode/skills/system-spec-kit/mcp_server/tests/opencode-transport.vitest.ts:21:        : kind === 'resume'
.opencode/skills/system-spec-kit/mcp_server/tests/opencode-transport.vitest.ts:22:          ? 'session_resume'
.opencode/skills/system-spec-kit/mcp_server/tests/opencode-transport.vitest.ts:36:    const resume = makePayload('resume', 'resume summary');
.opencode/skills/system-spec-kit/mcp_server/tests/opencode-transport.vitest.ts:41:      resumePayload: resume,
.opencode/skills/system-spec-kit/mcp_server/tests/opencode-transport.vitest.ts:57:    const payload = makePayload('resume', 'resume summary');
.opencode/skills/system-spec-kit/mcp_server/tests/opencode-transport.vitest.ts:58:    expect(coerceSharedPayloadEnvelope(payload)?.kind).toBe('resume');
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:180: * Parses trigger phrase storage into a normalized string array.
.opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-types.ts:181: * @param value - The stored trigger phrase payload.
...
.opencode/skills/system-spec-kit/mcp_server/tests/query-router.vitest.ts:290:  it('T21: routes trigger phrase match to simple tier', () => {
.opencode/skills/system-spec-kit/mcp_server/lib/validation/save-quality-gate.ts:487: * Score trigger phrase quality (0-1).
...
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-triggers.vitest.ts:315:      prompt: 'resume auth work',
...
.opencode/skills/system-spec-kit/mcp_server/tests/startup-brief.vitest.ts:151:    expect(brief.startupSurface).toContain('- Memory: startup summary only (resume on demand)');
...
.opencode/skills/system-spec-kit/mcp_server/tests/query-classifier.vitest.ts:219:  it('classifies trigger phrase matches as simple regardless of length', () => {
...
.opencode/skills/system-spec-kit/mcp_server/tests/query-classifier.vitest.ts:480:  it('matches exact trigger phrase (case-insensitive)', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/query-classifier.vitest.ts:486:  it('does not match partial trigger phrase', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/query-classifier.vitest.ts:491:  it('handles empty trigger phrase list', () => {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:719:`buildBm25DocumentText()` builds the canonical lexical document from title, content, trigger phrases, and folder metadata. `normalizeLexicalQueryTokens()` is shared by BM25 and SQLite FTS flows so lexical matching stays aligned across search channels.
.opencode/skills/system-spec-kit/mcp_server/tests/session-token-resume.vitest.ts:8:describe('hook-state session resume', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/session-token-resume.vitest.ts:9:  const sessionId = 'test-resume-session';
.opencode/skills/system-spec-kit/mcp_server/tests/session-token-resume.vitest.ts:14:  it('recovers session state for resume', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/session-token-resume.vitest.ts:32:  it('preserves compact prime across resume', () => {
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/embedding-expansion.ts:10:// Latency on short, well-defined queries that benefit from exact matches
...
.opencode/skills/system-spec-kit/mcp_server/tests/context-server.vitest.ts:1136:        triggered: [{ memory_id: 11, matched_phrases: ['resume'] }],
...
.opencode/skills/system-spec-kit/mcp_server/tests/context-server.vitest.ts:1150:      expect(autoSurfaceAtCompactionMock).toHaveBeenCalledWith('session resume context')
...
.opencode/skills/system-spec-kit/mcp_server/tests/context-server.vitest.ts:1747:      expect(hooksModule!.extractContextHint!({ prompt: 'trigger phrase' })).toBe('trigger phrase')
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:671: * (quick, research, resume, debug) when no explicit profile is specified by the caller.
.opencode/skills/system-spec-kit/mcp_server/tests/anchor-prefix-matching.vitest.ts:77:    it('P01: exact match returns the anchor ID itself', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/anchor-prefix-matching.vitest.ts:82:    it('P02: exact match even when multiple prefix candidates exist', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/anchor-prefix-matching.vitest.ts:91:    it('P03: exact match with empty string content still matches', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/anchor-prefix-matching.vitest.ts:203:      // Empty string exact match — extracted[''] is undefined
...
.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts:306:/** Get or create a cached regex for a trigger phrase. @param phrase - The trigger phrase @returns Compiled RegExp */
...
.opencode/skills/system-spec-kit/mcp_server/lib/search/session-transition.ts:50:      return `resumed session inferred ${effectiveMode} mode`;
.opencode/skills/system-spec-kit/mcp_server/lib/search/session-transition.ts:71:  if (args.resumedSession) {
.opencode/skills/system-spec-kit/mcp_server/lib/search/session-transition.ts:72:    activeSignals.push('session-resume');
...
.opencode/skills/system-spec-kit/mcp_server/tests/session-resume.vitest.ts:39:import { handleSessionResume } from '../handlers/session-resume.js';
.opencode/skills/system-spec-kit/mcp_server/tests/session-resume.vitest.ts:45:describe('session-resume handler', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/session-resume.vitest.ts:65:    expect(parsed.data.payloadContract.kind).toBe('resume');
...
.opencode/skills/system-spec-kit/mcp_server/tests/session-bootstrap.vitest.ts:11:          hints: ['resume ok'],
.opencode/skills/system-spec-kit/mcp_server/tests/session-bootstrap.vitest.ts:13:            kind: 'resume',
.opencode/skills/system-spec-kit/mcp_server/tests/session-bootstrap.vitest.ts:14:            summary: 'resume payload',
.opencode/skills/system-spec-kit/mcp_server/tests/session-bootstrap.vitest.ts:19:                content: 'resume structural context',
...
.opencode/skills/system-spec-kit/mcp_server/tests/session-bootstrap.vitest.ts:67:import { handleSessionResume } from '../handlers/session-resume.js';
...
.opencode/skills/system-spec-kit/mcp_server/tests/session-bootstrap.vitest.ts:83:    expect(parsed.data.resume.memory).toEqual({ resumed: true });
.opencode/skills/system-spec-kit/mcp_server/tests/session-bootstrap.vitest.ts:90:      resume: expect.any(Object),
.opencode/skills/system-spec-kit/mcp_server/tests/session-bootstrap.vitest.ts:95:    expect(parsed.data.hints).toEqual(expect.arrayContaining(['resume ok', 'health ok']));
...
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-save.vitest.ts:1068:    it('persists quality-loop trigger phrase fixes into downstream save inputs', async () => {
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-save.vitest.ts:1123:        fixes: ['Re-extracted 4 trigger phrases from content'],
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-save.vitest.ts:1362:        fixes: ['Re-extracted 4 trigger phrases from content'],
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-save.vitest.ts:1410:        fixes: ['Re-extracted 4 trigger phrases from content'],
...
.opencode/skills/system-spec-kit/mcp_server/tests/preflight.vitest.ts:447:      const testContent = 'Test memory content for exact match detection';
.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/startup-brief.ts:96:    : 'startup summary only (resume on demand)';
...
.opencode/skills/system-spec-kit/mcp_server/lib/enrichment/passive-enrichment.ts:132:      return ['[session] Context quality is degraded. Session may benefit from a `session_resume` call.'];
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:231:      "notes": "From T007b Pattern 2: session resume always uses \"session state\" as the input string."
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:240:      "expectedResultDescription": "Topic-scoped resume query. Should surface spec folder 001-sprint-0-measurement-foundation memories with state/next-steps anchors.",
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:241:      "notes": "From T007b Pattern 2: variant of session resume scoped to a specific sprint/spec folder."
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:510:      "expectedResultDescription": "Should surface trigger-matcher.ts, trigger-extractor.vitest.ts, and any spec about trigger phrase normalization.",
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:591:      "notes": "Derived from env var name which appears as a trigger phrase in session boost documentation."
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:611:      "notes": "Derived from \"reciprocal rank fusion\" trigger phrase in the hybrid search documentation."
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:621:      "notes": "Direct trigger phrase derived from the system name and initialization context."
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:651:      "notes": "Derived from \"attention decay\" trigger phrase in the cognitive subsystem."
...
.opencode/skills/system-spec-kit/mcp_server/lib/eval/data/ground-truth.json:701:      "notes": "Derived from SPECKIT_PRESSURE_POLICY env var trigger phrase — overlaps with seed query 9 but phrased differently."
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context-eval-channels.vitest.ts:111:      input: 'resume quickly',
.opencode/skills/system-spec-kit/mcp_server/tests/graph-first-routing-nudge.vitest.ts:68:    vi.doMock('../handlers/session-resume.js', () => ({
.opencode/skills/system-spec-kit/mcp_server/tests/graph-first-routing-nudge.vitest.ts:223:  it('keeps bootstrap and resume authoritative while surfacing the nudge separately', async () => {
.opencode/skills/system-spec-kit/mcp_server/tests/graph-first-routing-nudge.vitest.ts:224:    vi.doMock('../handlers/session-resume.js', () => ({
.opencode/skills/system-spec-kit/mcp_server/tests/graph-first-routing-nudge.vitest.ts:231:              memory: { resumed: true },
.opencode/skills/system-spec-kit/mcp_server/tests/graph-first-routing-nudge.vitest.ts:232:              hints: ['resume ok'],
.opencode/skills/system-spec-kit/mcp_server/tests/graph-first-routing-nudge.vitest.ts:234:                kind: 'resume',
...
.opencode/skills/system-spec-kit/mcp_server/tests/runtime-routing.vitest.ts:24:    it('resume', () => { expect(classifyQueryIntent('resume my last session').intent).toBe('hybrid'); });
.opencode/skills/system-spec-kit/mcp_server/tests/runtime-routing.vitest.ts:43:    it('resume my previous work', () => { expect(classifyQueryIntent('resume my previous work').intent).toBe('hybrid'); });
.opencode/skills/system-spec-kit/mcp_server/tests/feature-eval-scoring-calibration.vitest.ts:86:  // T041-01: Store an embedding, look it up, verify exact match
.opencode/skills/system-spec-kit/mcp_server/tests/bm25-index.vitest.ts:703:          trigger_phrases: 'updated trigger phrase',
.opencode/skills/system-spec-kit/mcp_server/tests/bm25-index.vitest.ts:780:    await handleMemoryUpdate({ id: 42, triggerPhrases: ['updated trigger phrase'] });
.opencode/skills/system-spec-kit/mcp_server/tests/bm25-index.vitest.ts:792:        trigger_phrases: 'updated trigger phrase',
.opencode/skills/system-spec-kit/mcp_server/tests/layer-definitions.vitest.ts:120:        memory_match_triggers: 'L2',
.opencode/skills/system-spec-kit/mcp_server/lib/eval/eval-metrics.ts:525: *   find_spec       — rewards exact matches heavily (3x), moderate partial
...
.opencode/skills/system-spec-kit/mcp_server/tests/token-budget-enforcement.vitest.ts:216:      expect(modes.resume.tokenBudget).toBe(2000);
.opencode/skills/system-spec-kit/mcp_server/tests/token-budget-enforcement.vitest.ts:226:    it('T205-D3: Budget ordering is logical (quick < resume < focused < deep)', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/token-budget-enforcement.vitest.ts:231:      const resumeBudget = modes.resume.tokenBudget;
.opencode/skills/system-spec-kit/mcp_server/tests/token-budget-enforcement.vitest.ts:235:      expect(resumeBudget).toBeDefined();
.opencode/skills/system-spec-kit/mcp_server/tests/token-budget-enforcement.vitest.ts:238:      if (quickBudget === undefined || resumeBudget === undefined || focusedBudget === undefined || deepBudget === undefined) {
.opencode/skills/system-spec-kit/mcp_server/tests/token-budget-enforcement.vitest.ts:241:      expect(quickBudget).toBeLessThan(resumeBudget);
.opencode/skills/system-spec-kit/mcp_server/tests/token-budget-enforcement.vitest.ts:242:      expect(resumeBudget).toBeLessThan(focusedBudget);
...
.opencode/skills/system-spec-kit/mcp_server/tests/shared-payload-certainty.vitest.ts:71:  it('surfaces certainty fields in the shared resume payload', async () => {
.opencode/skills/system-spec-kit/mcp_server/tests/shared-payload-certainty.vitest.ts:118:        sourceSurface: 'session_resume',
.opencode/skills/system-spec-kit/mcp_server/tests/shared-payload-certainty.vitest.ts:123:    const { handleSessionResume } = await import('../handlers/session-resume.js');
.opencode/skills/system-spec-kit/mcp_server/tests/shared-payload-certainty.vitest.ts:142:      'memory-resume': 'estimated',
.opencode/skills/system-spec-kit/mcp_server/tests/shared-payload-certainty.vitest.ts:162:    vi.doMock('../handlers/session-resume.js', () => ({
.opencode/skills/system-spec-kit/mcp_server/tests/shared-payload-certainty.vitest.ts:169:              memory: { resumed: true },
.opencode/skills/system-spec-kit/mcp_server/tests/shared-payload-certainty.vitest.ts:170:              hints: ['resume ok'],
.opencode/skills/system-spec-kit/mcp_server/tests/shared-payload-certainty.vitest.ts:172:                kind: 'resume',
...
.opencode/skills/system-spec-kit/mcp_server/tests/shared-payload-certainty.vitest.ts:238:    expect(parsed.data.payloadContract.summary).toContain('resume=estimated');
.opencode/skills/system-spec-kit/mcp_server/tests/shared-payload-certainty.vitest.ts:243:      'resume-surface': 'estimated',
...
.opencode/skills/system-spec-kit/mcp_server/tests/quality-loop.vitest.ts:116:    expect(result.issues[0]).toMatch(/2 trigger phrase/i);
.opencode/skills/system-spec-kit/mcp_server/tests/quality-loop.vitest.ts:119:  it('returns 1.0 for 4+ trigger phrases', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/quality-loop.vitest.ts:363:  it('extracts title as trigger phrase', () => {
...
.opencode/skills/system-spec-kit/mcp_server/tests/hook-session-start.vitest.ts:130:      expect(['startup', 'resume', 'compact', 'clear']).toContain(source);
.opencode/skills/system-spec-kit/mcp_server/tests/hook-session-start.vitest.ts:151:  it('keeps structural snapshot trust off the errored resume payload while preserving it on structural context', async () => {
.opencode/skills/system-spec-kit/mcp_server/tests/hook-session-start.vitest.ts:152:    vi.doMock('../handlers/session-resume.js', () => ({
.opencode/skills/system-spec-kit/mcp_server/tests/hook-session-start.vitest.ts:154:        throw new Error('synthetic resume failure');
.opencode/skills/system-spec-kit/mcp_server/tests/hook-session-start.vitest.ts:188:    expect(parsed.data.resume.error).toContain('synthetic resume failure');
.opencode/skills/system-spec-kit/mcp_server/tests/hook-session-start.vitest.ts:189:    expect(parsed.data.resume).not.toHaveProperty('parserProvenance');
.opencode/skills/system-spec-kit/mcp_server/tests/hook-session-start.vitest.ts:190:    expect(parsed.data.resume).not.toHaveProperty('evidenceStatus');
.opencode/skills/system-spec-kit/mcp_server/tests/hook-session-start.vitest.ts:191:    expect(parsed.data.resume).not.toHaveProperty('freshnessAuthority');
.opencode/skills/system-spec-kit/mcp_server/tests/opencode-plugin.vitest.ts:23:          trackedPayloadKinds: ['resume'],
.opencode/skills/system-spec-kit/mcp_server/tests/opencode-plugin.vitest.ts:29:          payloadKind: 'resume',
.opencode/skills/system-spec-kit/mcp_server/tests/opencode-plugin.vitest.ts:30:          dedupeKey: 'system:resume',
.opencode/skills/system-spec-kit/mcp_server/tests/opencode-plugin.vitest.ts:31:          content: 'Summary: resume summary',
.opencode/skills/system-spec-kit/mcp_server/tests/opencode-plugin.vitest.ts:36:          payloadKind: 'resume',
.opencode/skills/system-spec-kit/mcp_server/tests/opencode-plugin.vitest.ts:37:          dedupeKey: 'messages:resume:0',
.opencode/skills/system-spec-kit/mcp_server/tests/opencode-plugin.vitest.ts:43:          payloadKind: 'resume',
.opencode/skills/system-spec-kit/mcp_server/tests/opencode-plugin.vitest.ts:44:          dedupeKey: 'compaction:resume',
.opencode/skills/system-spec-kit/mcp_server/tests/opencode-plugin.vitest.ts:126:        specKitCompactCodeGraph: 'messages:resume:0',
...
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:85:      resumed?: boolean;
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:87:      resumedContextCount?: number;
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:137:    it('T524-1: Auto mode routes "resume" to resume strategy', async () => {
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:140:          input: 'resume where I left off on the authentication module',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:156:      expect(mode).toBe('resume');
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:181:    it('routes auto mode to resume when a caller session already exists without resume keywords', async () => {
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:182:      mockTrustedSession('session-auto-resume');
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:188:          sessionId: 'session-auto-resume',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:191:        'auto-resume-session-context'
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:195:      expect(parsed.meta.mode).toBe('resume');
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:288:    it('forwards governed scope fields through resume-mode search routing', async () => {
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:291:          input: 'resume session',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:292:          mode: 'resume',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:299:        'scope-forward-resume'
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:319:        resume: 2000,
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:515:  describe('Session lifecycle metadata and resume context', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:561:    it('T027l/T027m: caller session resume reports counter and injects top-5 context', async () => {
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:576:          input: 'resume previous work on memory quality',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:578:          mode: 'resume',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:581:        'T027l-resume'
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:588:      expect(parsed.meta.sessionLifecycle.resumed).toBe(true);
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:590:      expect(parsed.meta.sessionLifecycle.resumedContextCount).toBe(1);
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:625:          input: 'resume prior work',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:627:          mode: 'resume',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:639:          currentState: 'resume',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:641:          signalSources: expect.arrayContaining(['session-resume', 'explicit-mode']),
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:642:          reason: 'resumed session inferred resume mode',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:647:    it('uses the last inferred mode as previousState when a traced caller session resumes', async () => {
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:655:          input: 'resume previous work on memory quality',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:657:          mode: 'resume',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:667:          currentState: 'resume',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:668:          signalSources: expect.arrayContaining(['session-resume', 'explicit-mode']),
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:673:    it('default-on contract: auto-resume injection runs when SPECKIT_AUTO_RESUME is unset', async () => {
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:682:          title: 'Auto resume memory',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:683:          filePath: '/tmp/auto-resume.md',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:690:          input: 'resume prior work',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:692:          mode: 'resume',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:695:        'auto-resume-default-on'
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:713:          title: 'Disabled auto-resume memory',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:714:          filePath: '/tmp/disabled-auto-resume.md',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:721:          input: 'resume prior work',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:723:          mode: 'resume',
.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-context.vitest.ts:726:        'auto-resume-opt-out'
.opencode/skills/system-spec-kit/mcp_server/tests/memory-search-ux-hooks.vitest.ts:190:    const resumed = await handleMemorySearch({
.opencode/skills/system-spec-kit/mcp_server/tests/memory-search-ux-hooks.vitest.ts:195:    const resumedEnvelope = parseEnvelope(resumed);
.opencode/skills/system-spec-kit/mcp_server/tests/memory-search-ux-hooks.vitest.ts:196:    const resumedData = resumedEnvelope.data as Record<string, unknown>;
.opencode/skills/system-spec-kit/mcp_server/tests/memory-search-ux-hooks.vitest.ts:198:    expect(resumedEnvelope.summary).toBe('Error: Cursor is invalid, expired, or out of scope');
...
.opencode/skills/system-spec-kit/mcp_server/tests/memory-save-pipeline-enforcement.vitest.ts:453:  it('auto-fix rescues missing trigger phrases from headings', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/memory-save-pipeline-enforcement.vitest.ts:455:    // Content with headings (for trigger extraction) but NO trigger phrases and NO anchors.
.opencode/skills/system-spec-kit/mcp_server/tests/memory-save-pipeline-enforcement.vitest.ts:467:    expect(result.fixes.some(f => /trigger phrase/i.test(f))).toBe(true);
.opencode/skills/system-spec-kit/mcp_server/tests/memory-save-pipeline-enforcement.vitest.ts:1091:  it('rejects emoji-only trigger phrases as non-semantic', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/memory-save-pipeline-enforcement.vitest.ts:1166:  it('quality loop handles exactly 3 trigger phrases at boundary', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/session-lifecycle.vitest.ts:49:  it('resume session continues event_counter and preserves working memory items', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/session-lifecycle.vitest.ts:52:    expect(workingMemory.setAttentionScore('resume-session', 2, 0.7)).toBe(true); // 0
.opencode/skills/system-spec-kit/mcp_server/tests/session-lifecycle.vitest.ts:53:    expect(workingMemory.setAttentionScore('resume-session', 3, 0.6)).toBe(true); // 1
.opencode/skills/system-spec-kit/mcp_server/tests/session-lifecycle.vitest.ts:55:    expect(workingMemory.sessionExists('resume-session')).toBe(true);
.opencode/skills/system-spec-kit/mcp_server/tests/session-lifecycle.vitest.ts:56:    expect(workingMemory.getSessionEventCounter('resume-session')).toBe(1);
.opencode/skills/system-spec-kit/mcp_server/tests/session-lifecycle.vitest.ts:58:    expect(workingMemory.setAttentionScore('resume-session', 2, 0.9)).toBe(true); // 2
.opencode/skills/system-spec-kit/mcp_server/tests/session-lifecycle.vitest.ts:59:    expect(workingMemory.getSessionEventCounter('resume-session')).toBeGreaterThanOrEqual(1);
.opencode/skills/system-spec-kit/mcp_server/tests/session-lifecycle.vitest.ts:61:    const rows = workingMemory.getWorkingMemory('resume-session');
.opencode/skills/system-spec-kit/mcp_server/tests/session-lifecycle.vitest.ts:62:    const resumedRow = rows.find((row) => row.memory_id === 2);
.opencode/skills/system-spec-kit/mcp_server/tests/session-lifecycle.vitest.ts:63:    expect(resumedRow?.event_counter).toBe(2);
.opencode/skills/system-spec-kit/mcp_server/tests/session-lifecycle.vitest.ts:65:    const promptContext = workingMemory.getSessionPromptContext('resume-session', 0.05, 5);
...
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:136:    const resumeMode: ContextMode = CONTEXT_MODES.resume;
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:137:    expect(resumeMode.strategy).toBe('resume');
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:138:    expect(resumeMode.tokenBudget).toBe(2000);
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:229:  it('T020: No intent maps to quick or resume by default', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:232:      expect(mode).not.toBe('resume');
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:304:      resumedSession: false,
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:323:  it('prioritizes resumed-session and explicit-mode reasons deterministically', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:324:    const resumed = buildSessionTransitionTrace({
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:326:      resumedSession: true,
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:327:      effectiveMode: 'resume',
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:333:    expect(resumed.signalSources).toEqual([
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:334:      'session-resume',
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:338:    expect(resumed.confidence).toBe(0.95);
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:339:    expect(resumed.reason).toBe('resumed session inferred resume mode');
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:343:      resumedSession: false,
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:375:      resumedSession: false,
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:574:  it('T061: Resume mode strategy is resume', () => {
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:575:    expect(CONTEXT_MODES.resume.strategy).toBe('resume');
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:579:    expect(CONTEXT_MODES.resume.name).toBe('Resume');
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:583:    const desc: string = CONTEXT_MODES.resume.description.toLowerCase();
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:585:      desc.includes('session') || desc.includes('previous') || desc.includes('resume') || desc.includes('state')
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:590:    expect(CONTEXT_MODES.resume.tokenBudget).toBe(2000);
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:594:    const resumeBudget: number = CONTEXT_MODES.resume.tokenBudget!;
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:596:    expect(resumeBudget).toBeLessThan(deepBudget);
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:601:    expect(mappedModes).not.toContain('resume');
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:606:    const resumeCount: number = strategies.filter((s: string) => s === 'resume').length;
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:607:    expect(resumeCount).toBe(1);
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:611:    const desc: string = CONTEXT_MODES.resume.description.toLowerCase();
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:618:    expect(CONTEXT_MODES.resume.description.length).toBeGreaterThan(10);
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:622:    const resume: ContextMode = CONTEXT_MODES.resume;
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:623:    expect(resume.name).toBeDefined();
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:624:    expect(resume.description).toBeDefined();
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:625:    expect(resume.strategy).toBeDefined();
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:626:    expect(resume.tokenBudget).toBeDefined();
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:671:    // And via keyword detection, can route to resume
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:731:    const resume: number = CONTEXT_MODES.resume.tokenBudget!;
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:735:    expect(quick).toBeLessThan(resume);
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:736:    expect(resume).toBeLessThan(focused);
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:852:    expect(Object.keys(CONTEXT_MODES).sort()).toEqual(['auto', 'deep', 'focused', 'quick', 'resume']);
.opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts:1005:      resume: 2000
.opencode/skills/system-spec-kit/mcp_server/tests/query-flow-tracker.vitest.ts:59:    trackQueryAndDetect(db, 'sess-b', 'memory context resume', 'q1', ['mem-9']);
.opencode/skills/system-spec-kit/mcp_server/tests/query-flow-tracker.vitest.ts:61:    const detection = trackQueryAndDetect(db, 'sess-b', 'resume memory context', 'q2', ['mem-10']);
.opencode/skills/system-spec-kit/mcp_server/tests/fixtures/similarity-test-cases.json:112:      "description": "Exact or near-exact matches"
...
.opencode/skills/system-spec-kit/mcp_server/tests/graph-payload-validator.vitest.ts:151:            data: { resumed: true },
.opencode/skills/system-spec-kit/mcp_server/tests/graph-payload-validator.vitest.ts:195:    const { handleSessionResume } = await import('../handlers/session-resume.js');
.opencode/skills/system-spec-kit/mcp_server/tests/graph-payload-validator.vitest.ts:196:    const resumeResult = await handleSessionResume({ specFolder: 'specs/026-root' });
.opencode/skills/system-spec-kit/mcp_server/tests/graph-payload-validator.vitest.ts:197:    const parsedResume = JSON.parse(resumeResult.content[0].text);
.opencode/skills/system-spec-kit/mcp_server/tests/graph-payload-validator.vitest.ts:198:    const resumeStructuralSection = parsedResume.data.payloadContract.sections.find(
.opencode/skills/system-spec-kit/mcp_server/tests/graph-payload-validator.vitest.ts:202:    expect(resumeStructuralSection?.structuralTrust).toEqual({
.opencode/skills/system-spec-kit/mcp_server/tests/graph-payload-validator.vitest.ts:215:    expect(parsed.data.resume).toMatchObject({
.opencode/skills/system-spec-kit/mcp_server/lib/utils/cocoindex-path.ts:6:// session-resume.ts, and other consumers.

exec
/bin/zsh -lc "sed -n '1,260p' .opencode/skills/system-spec-kit/mcp_server/handlers/memory-match-triggers.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 exited 1 in 0ms:
sed: .opencode/skills/system-spec-kit/mcp_server/handlers/memory-match-triggers.ts: No such file or directory
...
exec
/bin/zsh -lc "sed -n '1,280p' .opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "sed -n '280,560p' .opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
    try {
...
exec
/bin/zsh -lc "rg -n \"strategy: 'resume'|handleMemorySearch\\(|handleMemoryMatchTriggers\\(|classifyQueryIntent|code_graph_query|structural\" .opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "sed -n '640,830p' .opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
exec
/bin/zsh -lc "sed -n '1120,1195p' .opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "sed -n '1,280p' .opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc 'rg -n "LIKE|MATCH|fts|bm25|trigger|normalizeLexicalQueryTokens|tokenize|exact|substring|phrase" .opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts' in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "sed -n '619,690p' .opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "sed -n '288,315p' .opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts | sed -n '20,170p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts | sed -n '430,540p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
   430	    return false;
   431	  }
   432	
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts | sed -n '2100,2198p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts | sed -n '1000,1285p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
  2100	/**
  2101	 * PI-A2: Quality-aware 3-tier search fallback chain.
  2102	 *
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts.ts | sed -n '1,240p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     1	// ───────────────────────────────────────────────────────────────
     2	// MODULE: Sqlite Fts
     3	// ───────────────────────────────────────────────────────────────
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts | sed -n '640,820p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts | sed -n '300,530p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts | sed -n '203,260p;619,684p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
   203	function buildBoundaryRegex(phrase: string): RegExp {
   204	  const normalizedPhrase = normalizeTriggerText(phrase);
...
exec
/bin/zsh -lc "nl -ba .opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts | sed -n '90,120p;470,520p;900,930p'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
- **Source**: [longmemeval_bench.py:1413](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/999-hybrid-rag-fusion-upgrade/001-research-hybrid-rag-fusion-systems/005-mempalace/external/benchmarks/longmemeval_bench.py#L1413), [longmemeval_bench.py:1512](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/999-hybrid-rag-fusion-upgrade/001-research-hybrid-rag-fusion-systems/005-mempalace/external/benchmarks/longmemeval_bench.py#L1512), [query-router.ts:48](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts#L48), [query-router.ts:113](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts#L113), [trigger-matcher.ts:621](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/parsing/trigger-matcher.ts#L621)
...
- **Source**: [query-router.ts:62](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts#L62), [hybrid-search.ts:1094](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts#L1094), [hybrid-search.ts:1221](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts#L1221), [hybrid-search.ts:2100](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts#L2100)

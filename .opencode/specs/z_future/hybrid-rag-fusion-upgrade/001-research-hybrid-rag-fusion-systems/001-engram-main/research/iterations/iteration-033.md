...
- **Source**: `001-engram-main/external/internal/mcp/mcp_test.go`; `.opencode/skills/system-spec-kit/mcp_server/tests/session-resume.vitest.ts`; `.opencode/skills/system-spec-kit/mcp_server/tests/session-bootstrap.vitest.ts` [SOURCE: `001-engram-main/external/internal/mcp/mcp_test.go:921-1231`; `001-engram-main/external/internal/mcp/mcp_test.go:1249-1319`; `001-engram-main/external/internal/mcp/mcp_test.go:1339-1490`; `.opencode/skills/system-spec-kit/mcp_server/tests/session-resume.vitest.ts:50-135`; `.opencode/skills/system-spec-kit/mcp_server/tests/session-bootstrap.vitest.ts:77-122`]
...
- **Source**: `.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts`; `.opencode/skills/system-spec-kit/mcp_server/tests/ablation-framework.vitest.ts`; `.opencode/skills/system-spec-kit/mcp_server/tests/memory-search-eval-channels.vitest.ts` [SOURCE: `.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:4-20`; `.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:52-77`; `.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:170-196`; `.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:218-260`; `.opencode/skills/system-spec-kit/mcp_server/tests/ablation-framework.vitest.ts:1-12`; `.opencode/skills/system-spec-kit/mcp_server/tests/ablation-framework.vitest.ts:45-77`; `.opencode/skills/system-spec-kit/mcp_server/tests/ablation-framework.vitest.ts:455-617`; `.opencode/skills/system-spec-kit/mcp_server/tests/ablation-framework.vitest.ts:703-787`; `.opencode/skills/system-spec-kit/mcp_server/tests/ablation-framework.vitest.ts:908-1150`; `.opencode/skills/system-spec-kit/mcp_server/tests/memory-search-eval-channels.vitest.ts:1-12`; `.opencode/skills/system-spec-kit/mcp_server/tests/memory-search-eval-channels.vitest.ts:117-149`]
...
- **Source**: `.opencode/skills/system-spec-kit/mcp_server/tests/integration-trigger-pipeline.vitest.ts`; `.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-triggers.vitest.ts`; `.opencode/skills/system-spec-kit/mcp_server/tests/memory-search-integration.vitest.ts`; `.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-save.vitest.ts`; `.opencode/skills/system-spec-kit/mcp_server/tests/memory-save-ux-regressions.vitest.ts`; `.opencode/skills/system-spec-kit/mcp_server/tests/memory-lineage-state.vitest.ts` [SOURCE: `.opencode/skills/system-spec-kit/mcp_server/tests/integration-trigger-pipeline.vitest.ts:23-24`; `.opencode/skills/system-spec-kit/mcp_server/tests/integration-trigger-pipeline.vitest.ts:46-124`; `.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-triggers.vitest.ts:70-133`; `.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-triggers.vitest.ts:144-332`; `.opencode/skills/system-spec-kit/mcp_server/tests/memory-search-integration.vitest.ts:208-257`; `.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-save.vitest.ts:15-84`; `.opencode/skills/system-spec-kit/mcp_server/tests/memory-save-ux-regressions.vitest.ts:221-418`; `.opencode/skills/system-spec-kit/mcp_server/tests/memory-lineage-state.vitest.ts:90-154`; `.opencode/skills/system-spec-kit/mcp_server/tests/memory-lineage-state.vitest.ts:163-203`]
...
- `.opencode/skills/system-spec-kit/mcp_server/tests/session-resume.vitest.ts:50-135`
- `.opencode/skills/system-spec-kit/mcp_server/tests/session-bootstrap.vitest.ts:77-122`
- `.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:4-20`
- `.opencode/skills/system-spec-kit/mcp_server/tests/ablation-framework.vitest.ts:455-617`
- `.opencode/skills/system-spec-kit/mcp_server/tests/memory-search-eval-channels.vitest.ts:117-149`
- `.opencode/skills/system-spec-kit/mcp_server/tests/memory-save-ux-regressions.vitest.ts:221-418`
- `.opencode/skills/system-spec-kit/mcp_server/tests/memory-lineage-state.vitest.ts:90-203`
- `.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-triggers.vitest.ts:144-332`
- `.opencode/skills/system-spec-kit/mcp_server/tests/integration-trigger-pipeline.vitest.ts:23-124`
- `.opencode/skills/system-spec-kit/mcp_server/tests/memory-search-integration.vitest.ts:208-257`
...
- Copying Engram’s coarse `project`/`personal` scope test matrix as-is — Public must test tenant/user/agent/shared-space boundaries too [`001-engram-main/external/internal/store/store_test.go:112-169`; `.opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-triggers.vitest.ts:282-331`; `.opencode/skills/system-spec-kit/mcp_server/tests/memory-lineage-state.vitest.ts:163-203`].

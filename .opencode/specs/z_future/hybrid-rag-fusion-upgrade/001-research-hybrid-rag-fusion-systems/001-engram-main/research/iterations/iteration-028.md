...
- **Source**: `001-engram-main/external/internal/mcp/mcp.go:41-46,50-74,399-590`; `001-engram-main/external/internal/store/store.go:1462-1547`; `.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:648-790`; `.opencode/skills/system-spec-kit/mcp_server/lib/scoring/confidence-tracker.ts:83-179`; `.opencode/skills/system-spec-kit/mcp_server/handlers/eval-reporting.ts:223-326`; `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:297-317,508-541`
...
- **Source**: `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-stats.ts:126-154,205-320`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts:296-594`; `.opencode/skills/system-spec-kit/mcp_server/handlers/session-health.ts:33-195`; `.opencode/skills/system-spec-kit/mcp_server/handlers/causal-graph.ts:667-749`; `.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/status.ts:10-34`; `.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/ccc-status.ts:10-40`; `.opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/status.ts:27-77`; `.opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:58-163`
...
- **Source**: `.opencode/skills/system-spec-kit/mcp_server/handlers/quality-loop.ts:73-78,102-220,691-727`; `.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts:767-790`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:520-610,724-807,904-934`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:1134-1154`

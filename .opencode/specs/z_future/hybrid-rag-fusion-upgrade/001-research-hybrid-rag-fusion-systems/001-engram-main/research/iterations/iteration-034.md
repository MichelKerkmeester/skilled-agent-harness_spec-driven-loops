...
- **Source**: Engram `topic_key` index + direct lookup; Public artifact-preserving router [SOURCE: `001-engram-main/external/internal/store/store.go:572-577,1462-1519`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:48-56,68-71,113-157`]
...
- **Source**: Engram single FTS search; Public sequential hybrid channels, cache/dedup, mode routing, trigger fast-path [SOURCE: `001-engram-main/external/internal/store/store.go:1518-1583`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:973-976,994-1111`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:450-471,486-520,718-809`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:649-679,700-807,891-927`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts:156-177,444-505`]
...
- **Source**: Engram topic upserts and duplicate counters; Public append-only/chunked save path [SOURCE: `001-engram-main/external/internal/store/store.go:462-467,575-577,948-1068`; `.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:166-229`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:831-905,927-1031`]
...
- **Source**: Engram DB open + bounded context formatter; Public composite resume/bootstrap + startup scan [SOURCE: `001-engram-main/external/internal/store/store.go:395-425,1613-1667`; `.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:409-598`; `.opencode/skills/system-spec-kit/mcp_server/handlers/session-bootstrap.ts:168-217`; `.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1230-1305`]
...
- **Source**: generate-context file output and incremental scan controls [SOURCE: `.opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js:81-88`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-index.ts:148-205,212-245,367-388,486-505`; `.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1230-1305`]
...
- `.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:973-1111`
- `.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:48-56,68-71,113-157`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:450-471,486-520,718-809`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:329-635,641-679,700-807,891-927`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts:156-177,444-505`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/save/embedding-pipeline.ts:119-190`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/save/create-record.ts:138-229`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts:728-829,831-905,927-1073`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-index.ts:148-205,212-245,367-388,486-505`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:409-598`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/session-bootstrap.ts:168-217`
- `.opencode/skills/system-spec-kit/mcp_server/context-server.ts:1230-1305`
- `.opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js:81-88`

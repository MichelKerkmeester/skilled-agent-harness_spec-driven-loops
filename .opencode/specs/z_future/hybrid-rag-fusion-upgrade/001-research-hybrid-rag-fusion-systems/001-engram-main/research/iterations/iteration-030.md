...
- **Source**: `001-engram-main/external/internal/store/store.go:1613-1667`; `001-engram-main/external/internal/mcp/mcp.go:375-395,460-562`; `.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:400-614`; `.opencode/skills/system-spec-kit/mcp_server/handlers/session-bootstrap.ts:163-240`
...
- **Source**: `001-engram-main/external/README.md:35-58`; `001-engram-main/external/docs/AGENT-SETUP.md:27-36,111-122,147-158`; `001-engram-main/external/docs/PLUGINS.md:13-37,48-57,76-120`; `.opencode/skills/system-spec-kit/mcp_server/context-server.ts:741-811`
...
- **Source**: `001-engram-main/external/internal/store/store.go:1474-1519,1546-1583,3384-3391`; `001-engram-main/external/docs/ARCHITECTURE.md:86-116`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:48-56,113-164`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:973-1253,1747-1779`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-triggers.ts:184-520`
...
- **Source**: `001-engram-main/external/internal/store/store.go:948-1068,1474-1519,3201-3278`; `001-engram-main/external/internal/mcp/mcp.go:302-324,416-457`; `.opencode/skills/system-spec-kit/mcp_server/handlers/save/markdown-evidence-builder.ts:92-178`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/progressive-disclosure.ts:345-444`
...
- **Source**: `001-engram-main/external/internal/store/store.go:959-1056,3396-3495`; `001-engram-main/external/internal/mcp/mcp.go:565-590`; `.opencode/skills/system-spec-kit/mcp_server/lib/enrichment/passive-enrichment.ts:1-213`; `.opencode/skills/system-spec-kit/mcp_server/lib/governance/scope-governance.ts:218-280`
...
- **Source**: `001-engram-main/external/internal/mcp/mcp.go:7-13,50-79,121-138,169-210,375-619`; `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:230-239,733-756`

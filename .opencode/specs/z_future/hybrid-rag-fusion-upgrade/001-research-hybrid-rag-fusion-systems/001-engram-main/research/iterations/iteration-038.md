...
- **Source**: Engram bounded context formatter; Public composite resume/bootstrap, dynamic instructions, and compaction injection [SOURCE: `001-engram-main/external/internal/store/store.go:1613-1667`; `.opencode/skills/system-spec-kit/mcp_server/handlers/session-resume.ts:409-597`; `.opencode/skills/system-spec-kit/mcp_server/handlers/session-bootstrap.ts:168-245`; `.opencode/skills/system-spec-kit/mcp_server/context-server.ts:764-809`; `.opencode/plugins/spec-kit-compact-code-graph.js:396-417`]
...
- **Source**: Engram topic-key indexing, upsert, and direct lookup; Public router and governed-scope filters [SOURCE: `001-engram-main/external/internal/store/store.go:572-577`; `001-engram-main/external/internal/store/store.go:948-1068`; `001-engram-main/external/internal/store/store.go:1462-1583`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:48-157`; `.opencode/skills/system-spec-kit/mcp_server/lib/governance/scope-governance.ts:218-280`; `.opencode/skills/system-spec-kit/mcp_server/lib/governance/scope-governance.ts:456-493`]
...
- **Source**: Engram lightweight stats surface; Public health and evaluation surfaces [SOURCE: `001-engram-main/external/internal/mcp/mcp.go:399-411`; `001-engram-main/external/internal/store/store.go:1588-1608`; `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts:223-360`; `.opencode/skills/system-spec-kit/mcp_server/handlers/session-health.ts:65-195`; `.opencode/skills/system-spec-kit/mcp_server/handlers/eval-reporting.ts:223-326`; `.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:170-260`]
...
- **Source**: Late-run synthesis and Public promotion machinery [SOURCE: `research/iterations/iteration-030.md:1-91`; `research/iterations/iteration-032.md:1-129`; `research/iterations/iteration-033.md:1-85`; `research/iterations/iteration-034.md:1-90`; `research/iterations/iteration-035.md:1-90`; `.opencode/skills/system-spec-kit/mcp_server/handlers/eval-reporting.ts:223-326`; `.opencode/skills/system-spec-kit/mcp_server/handlers/session-health.ts:107-131`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:113-157`]
...
- `.opencode/skills/system-spec-kit/mcp_server/handlers/session-bootstrap.ts:168-245`
...
- `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:638-776`
- `.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:48-157`
- `.opencode/skills/system-spec-kit/mcp_server/lib/governance/scope-governance.ts:218-280`
- `.opencode/skills/system-spec-kit/mcp_server/lib/governance/scope-governance.ts:456-493`
- `.opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js:61-88`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-crud-health.ts:223-360`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/session-health.ts:65-195`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/eval-reporting.ts:223-326`
- `.opencode/skills/system-spec-kit/mcp_server/lib/eval/ablation-framework.ts:170-260`

You are one read-only research seat executing iteration 3 of a deep-research loop. Repository root: /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public (your CWD).
...
THIS ITERATION FOCUS: C3 FTS layer
Questions (answer ALL):
- C3a Tantivy FTS status at 0.7.0-pre.6: experimental flag, query surface (fts_match/fts_score/fts_highlight) — gap 2
- C3b NoMergePolicy / OPTIMIZE INDEX maintenance still required — gap 13
- C3c libsql FTS5 parameterized-insert bug fixed upstream? — gap 15

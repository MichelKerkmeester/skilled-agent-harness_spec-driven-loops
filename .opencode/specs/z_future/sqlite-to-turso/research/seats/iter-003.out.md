Web tools were not granted for this seat, so C3c's upstream status stays unverified — everything else is answered from the vendored source at the hard call budget. Final result below.

...
## Objective
Your perspective: STRUCTURE. Find every schema/table/index/virtual-table/shard-layout/migration construct in the slice: vec0 virtual table DDL, shard file naming and per-embedder layout, dimension-suffixed tables (e.g. vec_768), schema-version handling, and the SQL statement shapes used for KNN/distance queries. Return structured findings.
...
---
Pre-plan (lean):
1. Read each slice file; locate schema/virtual-table/shard/migration constructs -> candidate list with exact line numbers.

# Iteration 5: Policy delivery confirmation semantics
...
`{"claim":"Configured-but-unobserved delivery is treated as confirmed across policy and Gate 3 state machines","evidenceRefs":[".opencode/skills/system-skill-advisor/mcp-server/lib/policy-plan.ts:346",".opencode/skills/system-skill-advisor/mcp-server/lib/render.ts:229",".opencode/skills/system-spec-kit/mcp-server/hooks/lib/spec-gate/spec-gate-core.mjs:166"],"counterevidenceSought":["passing focused tests","shadow-only defaults","consumer-side signal stripping"],"alternativeExplanation":"configured may have been intended as host acknowledgement, but phase 001 explicitly distinguishes it from observed","finalSeverity":"P1","confidence":0.94,"downgradeTrigger":"evidence that the host emits an independent observed receipt before suppression"}`
...
- SL-005: The two independent confirmation predicates govern the policy and Gate 3 delivery consumers reviewed by phases 004 and 005. [SOURCE: .opencode/skills/system-skill-advisor/mcp-server/lib/policy-plan.ts:346]
...
Gate 3 relay confirmation semantics

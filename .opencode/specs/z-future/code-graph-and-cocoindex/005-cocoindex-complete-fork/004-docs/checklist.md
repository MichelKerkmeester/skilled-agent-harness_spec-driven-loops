---
title: "Verification Checklist: Author Fork Documentation"
description: "Verification checklist for Author skill, README, install guide, and reference docs for the complete local fork."
trigger_phrases:
  - "027 phase 004"
  - "cocoindex docs"
  - "004-docs"
...
---
# Verification Checklist: Author Fork Documentation
...
- [x] CHK-050 [P0] Child files live under the approved phase folder.
  - Evidence: `Author Fork Documentation` packet exists under the phase parent.
<!-- /ANCHOR:file-org -->

...
> Provenance: remediates the DO-NOT-SHIP findings of the GPT-5.6-SOL (max/fast) review of `sk-git/002-skill-scoped-worktree-naming`; each finding was independently re-verified against source before it was accepted here.
...
Track the remediation in a new `sk-git/003-review-remediation-and-alignment` packet (Gate 3 answer: New packet). 002 stays the historical record of the first ship; 003 owns the fixes and reconciles 002's over-claimed rows by reference.
<!-- /ANCHOR:adr-001-decision -->
...
Create `.opencode/specs/sk-git/003-review-remediation-and-alignment` (Level 3, sibling of `002-skill-scoped-worktree-naming`); reconcile 002's over-claimed rows by reference to this packet.
<!-- /ANCHOR:adr-001-impl -->
<!-- /ANCHOR:adr-001 -->
...
- Predecessor: `../002-skill-scoped-worktree-naming/decision-record.md`

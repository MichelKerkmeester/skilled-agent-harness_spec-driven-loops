...
- [x] CHK-051 [P1] Packet lives under the `sk-git` track as `011-feature-catalog-and-manual-playbook`. Evidence: `.opencode/specs/sk-git/011-feature-catalog-and-manual-playbook/`.
<!-- /ANCHOR:file-org -->

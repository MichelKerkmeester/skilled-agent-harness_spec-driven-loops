...
| **Track** | `sk-git` |
| **Sibling** | `010-review-remediation-and-alignment` (the code hardening these docs describe) |
<!-- /ANCHOR:metadata -->
...
- Sibling (code hardening): `../010-review-remediation-and-alignment/spec.md`

...
| Field | Value |
|-------|-------|
| **Spec Folder** | `skill-advisor-docs-quality-refactor/005-content-additions-and-hvr` |
| **Completed** | [PENDING] |
| **Level** | 1 |
<!-- /ANCHOR:metadata -->
...
|-------|---------|--------|
| sk-doc validate per new file | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skill-advisor-docs-quality-refactor/005-content-additions-and-hvr --strict` | [PENDING] |

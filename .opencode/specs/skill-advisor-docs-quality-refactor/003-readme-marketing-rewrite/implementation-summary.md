...
| Field | Value |
|-------|-------|
| **Spec Folder** | `skill-advisor-docs-quality-refactor/003-readme-marketing-rewrite` |
| **Completed** | [PENDING] |
| **Level** | 1 |
<!-- /ANCHOR:metadata -->
...
| sk-doc validate | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skill-advisor-docs-quality-refactor/003-readme-marketing-rewrite --strict` | [PENDING] |

...
- [x] T009 [P] Flip the playbook: root naming status + do-not-run note + DISCOVER-001 row, discovery-first.md, flow-intent.md, screens-search.md (`manual_testing_playbook/**`) [evidence: 12 edits; FLOWS-001 pass/fail re-anchored on the live tool; SCREENS-001 allows deliberate `mode` use]

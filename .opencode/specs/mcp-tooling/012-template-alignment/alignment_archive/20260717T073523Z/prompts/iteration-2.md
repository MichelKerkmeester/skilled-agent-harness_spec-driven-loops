...
- Artifacts Slice (check exactly these this iteration): [{"path":".opencode/skills/mcp-tooling/mcp-aside-devtools/references/troubleshooting.md"},{"path":".opencode/skills/mcp-tooling/mcp-aside-devtools/scripts/README.md"}]
...
- Write this iteration's narrative to: .opencode/specs/mcp-tooling/012-template-alignment/alignment/iterations/iteration-002.md
- Write this iteration's delta file to: .opencode/specs/mcp-tooling/012-template-alignment/alignment/deltas/iter-002.jsonl
...
- **ALLOWED WRITE PATHS (the ONLY paths you may create, modify, or append to):**
  - `.opencode/specs/mcp-tooling/012-template-alignment/alignment/iterations/iteration-002.md`, this iteration's narrative markdown (Bash-create a new file)
  ...
  - `.opencode/specs/mcp-tooling/012-template-alignment/alignment/deltas/iter-002.jsonl`, this iteration's write-once delta JSONL (Bash-create once)

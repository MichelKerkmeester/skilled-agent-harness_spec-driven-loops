...
**Created:**
- `.opencode/specs/mcp-tooling/003-mcp-testing-playbooks/` — 9 spec files (spec, plan, tasks, checklist, decision-record, research, implementation-summary, description.json, graph-metadata.json)
...
- `.opencode/specs/mcp-tooling/003-mcp-testing-playbooks/research.md` — §5 CCC Audit findings populated.

...
- [x] T007 Author the playbook incl. `intra_routing_recall/` with ≥2 holdouts, `negative.md`, `troubleshoot.md` (`.opencode/skills/mcp-tooling/mcp-aside-devtools/manual_testing_playbook/`)

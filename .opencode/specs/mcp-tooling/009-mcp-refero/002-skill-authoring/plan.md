...
- **manual_testing_playbook/**: Scenario set incl. `intra_routing_recall/` with ≥2 holdout prompts that must route to mcp-refero, `negative.md` (prompts that must NOT route here — e.g. Figma edits, local design builds), `troubleshoot.md`.
...
- [ ] Author manual_testing_playbook/ incl. intra_routing_recall holdouts, negative.md, troubleshoot.md; seed changelog/, feature_catalog/, scripts/, assets/ (UTCP snippet)

...
_memory:
  continuity:
    packet_pointer: "mcp-tooling/008-mcp-tooling-parent/006-advisor-and-integration"
    ...
    blockers: []
    key_files:
      - ".opencode/specs/mcp-tooling/008-mcp-tooling-parent/006-advisor-and-integration/spec.md"
      - ".opencode/specs/mcp-tooling/008-mcp-tooling-parent/006-advisor-and-integration/plan.md"
      - ".opencode/specs/mcp-tooling/008-mcp-tooling-parent/006-advisor-and-integration/tasks.md"
    session_dedup:

...
_memory:
  continuity:
    packet_pointer: "mcp-tooling/008-mcp-tooling-parent"
    ...
    session_dedup:
      ...
      session_id: "008-mcp-tooling-parent"
...
| **Branch** | `main` |
| **Parent Spec** | `../spec.md` |
| **Parent Packet** | mcp-tooling/008-mcp-tooling-parent |
| **Predecessor** | None |

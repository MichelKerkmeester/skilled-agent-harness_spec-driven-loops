...
_memory:
  continuity:
    packet_pointer: "mcp-tooling/008-mcp-tooling-parent/003-scaffold-hub"
    ...
    blockers: []
    key_files:
      - ".opencode/specs/mcp-tooling/008-mcp-tooling-parent/003-scaffold-hub/spec.md"
      - ".opencode/specs/mcp-tooling/008-mcp-tooling-parent/003-scaffold-hub/plan.md"
      - ".opencode/specs/mcp-tooling/008-mcp-tooling-parent/003-scaffold-hub/tasks.md"
    session_dedup:

...
**Created:**
- `.opencode/specs/mcp-tooling/002-mcp-testing-playbooks/` — 9 spec files (spec, plan, tasks, checklist, decision-record, research, implementation-summary, description.json, graph-metadata.json)

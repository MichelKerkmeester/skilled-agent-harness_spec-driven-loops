---
title: "Implementation Plan: Phase 013: Safety Boundaries and Gates"
...
**Goal**: Gates are now consistent: custom-code is DW staging that ships with publish; robots replacement/delete are DS with pre-read/diff/post-read; Agent Instructions are declared untrusted content subordinate to the frozen gates.

---
title: "Implementation Plan: Phase 015: Designer Depth (P1 Batch)"
...
**Goal**: Designer execution depth: queries are multi-dimensional with a strict target-id shape, class semantics distinguish named/combo/raw-CSS with read-back, breakpoints are version-qualified, branches document merge as out-of-surface, and the variants card matches the action reference exactly.

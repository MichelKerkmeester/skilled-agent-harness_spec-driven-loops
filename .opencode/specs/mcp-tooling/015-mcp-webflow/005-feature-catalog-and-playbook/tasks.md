...
<!-- ANCHOR:phase-1 -->
## Phase 1: Setup
- [ ] T001 Load feature-catalog and playbook authoring contracts.
- [ ] T002 Build capability/risk/source matrix from verified package.
- [ ] T003 Define target, fixture, confirmation, rollback, cleanup, and evidence rules.
<!-- /ANCHOR:phase-1 -->
...
- [ ] T004 Generate one canonical entry per shipped capability.
- [ ] T005 Author setup, auth, discovery, and read scenarios.
- [ ] T006 Author safe-write, error, permission, rate, and recovery scenarios.
- [ ] T007 Author destructive/publish/deploy confirmation and tabletop scenarios.
- [ ] T008 Author `sk-design` pairing and routing-boundary scenarios.
<!-- /ANCHOR:phase-2 -->
...
- [ ] T009 Run catalog and playbook validators.
- [ ] T010 Reconcile tool, doc, catalog, and scenario coverage.
- [ ] T011 Run eligible non-production scenarios and record evidence.
- [ ] T012 Verify cleanup/rollback and no production mutation.
- [ ] T013 Update summary and hand off to Phase 6.
<!-- /ANCHOR:phase-3 -->

---
title: "Implementation Plan: Phase 014: Authority Pinning"
...
**Goal**: The packet now has a single dated authority record; discovery must compare `list_tools()` against it and fail closed on drift, and the refresh procedure ends with a pin.

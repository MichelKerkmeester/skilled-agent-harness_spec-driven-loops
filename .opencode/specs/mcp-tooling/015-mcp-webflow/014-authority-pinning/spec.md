---
title: "Phase 014: Authority Pinning"
...
| **Created** | 2026-08-03 |
| **Branch** | `015-mcp-webflow/014-authority-pinning` |
| **Parent Spec** | `../spec.md` |
| **Predecessor** | (chain via 011) |
| **Successor** | `015-designer-depth-p1` |
...
P0-6: `webflow-mcp-server@latest` is not reproducible; hosted docs, OSS README, and packet disagreed on endpoint and capability provenance.
...
New `references/version-fixture.md` (dated capture, consumption rule, refresh procedure); mcp-wiring links the fixture.

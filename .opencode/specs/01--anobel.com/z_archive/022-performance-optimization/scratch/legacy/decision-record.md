...
The archived documentation for anobel.com contained real implementation detail, but it no longer matched the current spec template requirements. We needed a structure that validates cleanly without rewriting the historical substance.

...
---
        ...
        | **Created** | 2025-12-14 |
        | **Branch** | `.opencode/specs/01--anobel.com/z_archive/005-minify-javascript` |
        <!-- /ANCHOR:metadata -->
...
| `.opencode/specs/01--anobel.com/z_archive/005-minify-javascript/spec.md` | Modify | Referenced by the archived work and retained in the normalized record |
| `package-lock.json` | Modify | Referenced by the archived work and retained in the normalized record |
| `.opencode/specs/01--anobel.com/z_archive/005-minify-javascript/checklist.md` | Modify | Referenced by the archived work and retained in the normalized record |
| `.opencode/specs/01--anobel.com/z_archive/005-minify-javascript/plan.md` | Modify | Referenced by the archived work and retained in the normalized record |
| `.opencode/specs/01--anobel.com/z_archive/005-minify-javascript/tasks.md` | Modify | Referenced by the archived work and retained in the normalized record |
        <!-- /ANCHOR:scope -->

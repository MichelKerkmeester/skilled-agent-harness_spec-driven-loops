---
        ...
        | **Created** | 2026-03-31 |
        | **Branch** | `.opencode/specs/01--anobel.com/z_archive/015-performance-hacks` |
        <!-- /ANCHOR:metadata -->
        ...
        ### Problem Statement
        Specification: Additional Performance Hacks 1. Overview Implementation of high-impact, low-effort performance optimizations ("hacks") for anobel.com to improve LCP and FCP scores.

        ### Purpose
        Keep the archived record for Specification: Additional Performance Hacks readable, structurally valid, and faithful to the original implementation intent.
        <!-- /ANCHOR:problem -->
...
| `hero_video.js` | Modify | Referenced by the archived work and retained in the normalized record |
...
| `modal_cookie_consent.js` | Modify | Referenced by the archived work and retained in the normalized record |
        <!-- /ANCHOR:scope -->
        ...
        |----|-------------|---------------------|
        | REQ-001 | The archived record clearly captures the core change described for Specification: Additional Performance Hacks. | Reviewer can confirm this is explicitly documented in the archive folder |
        ...
        1. **Given** the archived documents for Specification: Additional Performance Hacks, **When** a reviewer opens `spec.md`, **Then** the original problem and purpose are clear.
...
4. **Given** the supporting documents, **When** a reviewer inspects them, **Then** checklist, tasks, and summary remain aligned.
        ...
        - **SC-001**: The archive explains the original objective for Specification: Additional Performance Hacks in plain language.

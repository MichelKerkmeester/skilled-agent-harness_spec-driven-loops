...
| Session ID | session-1769251412293-hjfebsbfk |
| Spec Folder | 005-anobel.com/001-decoding-async-analysis |
...
| Created At (Epoch) | 1769251412 |
| Last Accessed (Epoch) | 1769251412 |
| Access Count | 1 |
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 005-anobel.com/001-decoding-async-analysis` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "005-anobel.com/001-decoding-async-analysis" })` |
...
```yaml
# Core Identifiers
session_id: "session-1769251412293-hjfebsbfk"
spec_folder: "005-anobel.com/001-decoding-async-analysis"
channel: "078-speckit-test-suite"
...
created_at_epoch: 1769251412
last_accessed_epoch: 1769251412
expires_at_epoch: 1777027412  # 0 for critical (never expires)
...
parent_spec: "005-anobel.com/001-decoding-async-analysis"
child_sessions:

---
        ...
        | **Created** | 2024-12-13 |
        | **Branch** | `.opencode/specs/01--anobel.com/z_archive/004-table-of-content/001-toc-scrollspy` |
        | **Parent Spec** | ../spec.md |
| **Parent Plan** | ../plan.md |
| **Phase** | 1 of 3 |
| **Predecessor** | None |
...
- Replacing historical decisions that belong to the archive record.
        ...
        |-----------|-------------|-------------|
        | `.opencode/specs/01--anobel.com/z_archive/004-table-of-content/001-toc-scrollspy/spec.md` | Modify | Referenced by the archived work and retained in the normalized record |
...
2. **Given** the scope section, **When** a reviewer checks the documented implementation surface, **Then** primary references such as `.opencode/specs/01--anobel.com/z_archive/004-table-of-content/001-toc-scrollspy/spec.md` are visible.
        <!-- /ANCHOR:requirements -->

...
| Field | Value |
|-------|-------|
| **Spec Folder** | 004-table-of-content |
...
This archive records the work completed for Table Of Content. The normalized summary keeps the original intent visible while updating the markdown structure so the folder remains usable and valid.

...
| Spec Folder | 05--agent-orchestration/025-codex-cli-agents |
| Channel | main |
...
```
/spec_kit:resume 05--agent-orchestration/025-codex-cli-agents
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: 05--agent-orchestration/025-codex-cli-agents
Last: Tool: bash
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 05--agent-orchestration/025-codex-cli-agents` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "05--agent-orchestration/025-codex-cli-agents" })` |
...
memory_search({ specFolder: "05--agent-orchestration/025-codex-cli-agents", limit: 10 })

# Verify memory file integrity
ls -la 05--agent-orchestration/025-codex-cli-agents/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js 05--agent-orchestration/025-codex-cli-agents --force
```
...
spec_folder: "05--agent-orchestration/025-codex-cli-agents"
channel: "main"
...
parent_spec: "05--agent-orchestration/025-codex-cli-agents"
child_sessions:

...
- [x] **P1** `sk-doc/assets/opencode/agent_template.md` Table 1: Added @context_loader, @general, @handover
- [x] **P1** `sk-doc/assets/opencode/agent_template.md` Table 2: Added context_loader, general, handover

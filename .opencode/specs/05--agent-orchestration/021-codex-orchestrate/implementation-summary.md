...
| `.opencode/specs/05--agent-orchestration/021-codex-orchestrate/{spec,plan,tasks,checklist,decision-record,implementation-summary}.md` | Modified | Spec scope, execution records, and evidence updated to include suite + command runtime-path work |
...
1. Run final `scripts/spec/validate.sh --json .opencode/specs/05--agent-orchestration/021-codex-orchestrate` after any remaining documentation sync.

...
| Session ID | session-1771437599293-e5rxrlsvw |
...
| Created At (Epoch) | 1771437599 |
| Last Accessed (Epoch) | 1771437599 |
| Access Count | 1 |
...
<!-- ANCHOR:implementation-ill-execute-step-step-0246b5f0 -->
### FEATURE: 
...
<!-- ANCHOR:implementation-tool-read-5c46e98c -->
### BUGFIX: Tool: read
...
<!-- ANCHOR:implementation-tool-glob-8f53634b -->
...
<!-- ANCHOR:implementation-tool-bash-757fb44b -->
...
```yaml
# Core Identifiers
session_id: "session-1771437599293-e5rxrlsvw"
...
created_at_epoch: 1771437599
last_accessed_epoch: 1771437599
expires_at_epoch: 1779213599  # 0 for critical (never expires)

...
- **SC-004**: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/cli-external-orchestration/025-cli-codex-deprecation --strict` passes before completion is claimed.

...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/cli-external-orchestration/025-cli-codex-deprecation/spec.md"
      - ".opencode/specs/cli-external-orchestration/025-cli-codex-deprecation/plan.md"
      - ".opencode/specs/cli-external-orchestration/025-cli-codex-deprecation/tasks.md"
    session_dedup:

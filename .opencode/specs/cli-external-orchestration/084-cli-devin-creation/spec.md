...
_memory:
  continuity:
    ...
    answered_questions:
      - "Spec folder location: .opencode/specs/skilled-agent-orchestration/z_archive/084-cli-devin-creation/"
...
- **SC-002**: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/084-cli-devin-creation --strict` exits 0.

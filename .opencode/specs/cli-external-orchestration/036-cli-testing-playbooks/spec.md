...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/skilled-agent-orchestration/z_archive/036-cli-testing-playbooks/plan.md"
...
| `.opencode/specs/skilled-agent-orchestration/z_archive/036-cli-testing-playbooks/*` | Create | Level 3 spec docs (this folder) |
<!-- /ANCHOR:scope -->

...
---
title: "Implementation Plan: CLI Skill Prompt-Quality [skilled-agent-orchestration/z_archive/031-cli-skill-improved-prompting/plan]"
...
- [x] The target spec folder is fixed: `.opencode/specs/skilled-agent-orchestration/z_archive/031-cli-skill-improved-prompting/`.

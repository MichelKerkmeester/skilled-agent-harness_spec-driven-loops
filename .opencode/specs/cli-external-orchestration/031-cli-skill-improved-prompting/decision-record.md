...
---
title: "Decision Record: CLI Skill [skilled-agent-orchestration/z_archive/031-cli-skill-improved-prompting/decision-record]"
...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/skilled-agent-orchestration/z_archive/031-cli-skill-improved-prompting/decision-record.md"

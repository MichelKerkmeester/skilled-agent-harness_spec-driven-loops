...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/plan.md"
...
| `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/*` | Create | Level 3 spec docs (this folder) |
<!-- /ANCHOR:scope -->
...
- **Sibling spec (MCP playbooks)**: `.opencode/specs/skilled-agent-orchestration/z_archive/037-mcp-testing-playbooks/`

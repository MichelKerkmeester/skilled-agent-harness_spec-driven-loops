...
_memory:
  continuity:
    ...
    key_files:
      - ".opencode/specs/cli-external-orchestration/037-spec-gate-question-noise/handover.md"
...
- **File:** worktree `spec.md` for packet 037 (implementation complete; this handover sits beside it)
...
- [ ] 036 folder: main `.opencode/specs/cli-external-orchestration/036-pi-input-hook-latency/spec.md` (latency thread + amendment records)
<!-- /ANCHOR:next-session -->
...
- The user's earlier 'a' answer = sk-git option A (worktree) for 037; packet 036 used the current branch (option B) — do not conflate.
<!-- /ANCHOR:session-notes -->

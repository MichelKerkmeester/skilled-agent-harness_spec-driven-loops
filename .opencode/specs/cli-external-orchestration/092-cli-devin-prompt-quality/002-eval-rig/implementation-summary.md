...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/z_archive/092-cli-devin-prompt-quality/002-eval-rig"
...
| strict-validate | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/092-cli-devin-prompt-quality/002-eval-rig --strict` | TO RUN |
<!-- /ANCHOR:verification -->

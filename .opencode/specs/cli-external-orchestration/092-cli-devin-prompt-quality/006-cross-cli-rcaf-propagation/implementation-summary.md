...
| Field | Value |
|-------|-------|
| **Spec Folder** | 113-cli-devin-prompt-quality/006-cross-cli-rcaf-propagation |
...
| Spec validation | PASS: `validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/092-cli-devin-prompt-quality/006-cross-cli-rcaf-propagation --strict` |
<!-- /ANCHOR:verification -->

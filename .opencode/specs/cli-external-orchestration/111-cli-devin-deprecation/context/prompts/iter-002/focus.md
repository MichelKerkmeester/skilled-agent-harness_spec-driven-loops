...
```
BINDING lines first (gatherSubject, slice=runtime-code, mode=context, specFolder=.opencode/specs/skilled-agent-orchestration/z_archive/111-cli-devin-deprecation). Tool budget ~8-12.

...
### Key Components
- **Fixture source**: `.opencode/specs/cli-external-orchestration/018-cli-devin-prompt-quality/002-eval-rig/fixtures`
- **Variant source**: `.opencode/specs/cli-external-orchestration/018-cli-devin-prompt-quality/003-eval-loop/variants`
- **Dispatch surface**: cli-opencode for both `deepseek/deepseek-v4-pro --variant high` and `opencode-go/kimi-k2.6 --variant high`
- **Extraction**: `extract()` from `.opencode/specs/cli-external-orchestration/018-cli-devin-prompt-quality/005-extraction-rerun/scripts/extract-files-from-markdown.cjs`
- **Scoring**: `scoreVariantFixture()` from `.opencode/specs/cli-external-orchestration/018-cli-devin-prompt-quality/003-eval-loop/scripts/score-variant.cjs`

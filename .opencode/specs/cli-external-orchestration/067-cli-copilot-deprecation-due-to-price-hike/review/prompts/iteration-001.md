...
Spec packet: `.opencode/specs/skilled-agent-orchestration/z_archive/067-cli-copilot-deprecation-due-to-price-hike/`
...
1. `.opencode/specs/skilled-agent-orchestration/z_archive/067-cli-copilot-deprecation-due-to-price-hike/spec.md`
2. `.opencode/specs/skilled-agent-orchestration/z_archive/067-cli-copilot-deprecation-due-to-price-hike/plan.md`
3. `.opencode/specs/skilled-agent-orchestration/z_archive/067-cli-copilot-deprecation-due-to-price-hike/checklist.md`
4. `.opencode/specs/skilled-agent-orchestration/z_archive/067-cli-copilot-deprecation-due-to-price-hike/resource-map.md`
5. `.opencode/specs/skilled-agent-orchestration/z_archive/067-cli-copilot-deprecation-due-to-price-hike/implementation-summary.md`
...
Write your findings to `.opencode/specs/skilled-agent-orchestration/z_archive/067-cli-copilot-deprecation-due-to-price-hike/review/iterations/iteration-001.md` with this structure:

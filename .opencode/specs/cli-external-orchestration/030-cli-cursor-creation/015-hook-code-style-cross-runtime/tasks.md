...
<!-- ANCHOR:cross-refs -->
## Cross-References
- Generalizes `../013-hooks-sk-code-alignment/` from Cursor-only to all four runtimes.
- Sequential-numbering neighbor `../014-cursor-hooks-discovery-mirror/` is unrelated; no dependency either way.
...
- `../013-hooks-sk-code-alignment/tasks.md` (Cursor-only predecessor)

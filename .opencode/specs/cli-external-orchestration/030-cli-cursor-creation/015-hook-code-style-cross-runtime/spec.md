...
_memory:
  continuity:
    packet_pointer: "cli-external-orchestration/030-cli-cursor-creation/015-hook-code-style-cross-runtime"
    ...
    blockers: []
    key_files: [".opencode/skills/sk-code/code-opencode/assets/checklists/javascript-checklist.md", "../013-hooks-sk-code-alignment/spec.md"]
...
| **Predecessor** | `../014-cursor-hooks-discovery-mirror/spec.md` |
| **Successor** | `../016-cursor-mcp-wiring-and-route-guard-fix/spec.md` |
...
- `../013-hooks-sk-code-alignment/spec.md` (Cursor-only predecessor this phase generalizes)
- `../014-cursor-hooks-discovery-mirror/spec.md` (sequential-numbering neighbor; no dependency)

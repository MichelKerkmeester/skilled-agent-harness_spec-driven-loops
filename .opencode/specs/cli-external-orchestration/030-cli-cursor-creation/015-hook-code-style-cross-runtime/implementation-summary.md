...
_memory:
  continuity:
    ...
    blockers: []
    key_files: ["spec.md", "checklist.md", "../013-hooks-sk-code-alignment/implementation-summary.md"]
...
| Field | Value |
|---|---|
| **Spec Folder** | 015-hook-code-style-cross-runtime |
...
- `../013-hooks-sk-code-alignment/implementation-summary.md` (the Cursor-only predecessor this generalizes)

...
| **Predecessor** | `../010-hook-code-style-cross-runtime/spec.md` |
| **Successor** | `../012-codex-claude-hooks-discovery-mirrors/spec.md` |
...
- `../010-hook-code-style-cross-runtime/spec.md` (predecessor)
- `../009-cursor-hooks-lifecycle/003-cursor-hooks-claude-parity/implementation-summary.md` (source of the blocker this phase invalidates)

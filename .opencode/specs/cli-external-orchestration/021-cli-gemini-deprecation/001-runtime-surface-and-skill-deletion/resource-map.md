...
| `.opencode/specs/cli-external-orchestration/021-cli-gemini-deprecation/spec.md` | Created | OK | Active packet specification. |
| `.opencode/specs/cli-external-orchestration/021-cli-gemini-deprecation/plan.md` | Created | OK | Active packet implementation plan. |
| `.opencode/specs/cli-external-orchestration/021-cli-gemini-deprecation/tasks.md` | Created | OK | Active packet task ledger. |
| `.opencode/specs/cli-external-orchestration/021-cli-gemini-deprecation/checklist.md` | Created | OK | Active packet verification checklist. |
| `.opencode/specs/cli-external-orchestration/021-cli-gemini-deprecation/decision-record.md` | Created | OK | Active packet decision record. |
| `.opencode/specs/cli-external-orchestration/021-cli-gemini-deprecation/implementation-summary.md` | Created | OK | Active packet delivery summary. |
| `.opencode/specs/cli-external-orchestration/021-cli-gemini-deprecation/debug-delegation.md` | Created | OK | Debug handoff preserved. |
| `.opencode/specs/cli-external-orchestration/021-cli-gemini-deprecation/description.json` | Created | OK | Packet metadata. |
| `.opencode/specs/cli-external-orchestration/021-cli-gemini-deprecation/graph-metadata.json` | Created | OK | Packet graph metadata. |
| `.opencode/specs/cli-external-orchestration/021-cli-gemini-deprecation/complete-config.json` | Created | OK | Auto-mode configuration. |
| `.opencode/specs/cli-external-orchestration/021-cli-gemini-deprecation/scratch/.gitkeep` | Created | OK | Scratch directory placeholder. |
| `specs/cli-external-orchestration/021-cli-gemini-deprecation/spec.md` | Updated | OK | User-visible packet copy. |
| `specs/cli-external-orchestration/021-cli-gemini-deprecation/plan.md` | Updated | OK | User-visible packet copy. |
| `specs/cli-external-orchestration/021-cli-gemini-deprecation/tasks.md` | Updated | OK | User-visible packet copy. |
| `specs/cli-external-orchestration/021-cli-gemini-deprecation/checklist.md` | Updated | OK | User-visible packet copy. |
| `specs/cli-external-orchestration/021-cli-gemini-deprecation/decision-record.md` | Updated | OK | User-visible packet copy. |
| `specs/cli-external-orchestration/021-cli-gemini-deprecation/implementation-summary.md` | Updated | OK | User-visible packet copy. |
| `specs/cli-external-orchestration/021-cli-gemini-deprecation/resource-map.md` | Created | OK | This resource map. |
<!-- /ANCHOR:specs -->
...
| `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/cli-external-orchestration/021-cli-gemini-deprecation --strict` | PASS | 0 errors, 0 warnings. |

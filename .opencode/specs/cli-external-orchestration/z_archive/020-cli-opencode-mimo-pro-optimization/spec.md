...
| **Parent Packet** | `cli-external-orchestration/020-cli-opencode-mimo-pro-optimization` |
| **Predecessor** | `cli-external-orchestration/019-cli-opencode-minimax-optimization` (the MiniMax equivalent this packet mirrors) |
| **Successor** | None |

...
---
title: "Verification Checklist: CLI Skill [cli-external-orchestration/006-cli-skill-improved-prompting/checklist]"
...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/cli-external-orchestration/006-cli-skill-improved-prompting/checklist.md"
...
- [x] CHK-001 [P0] Requirements are documented in `spec.md` [Evidence: `.opencode/specs/cli-external-orchestration/006-cli-skill-improved-prompting/spec.md`]
- [x] CHK-002 [P0] Technical approach is defined in `plan.md` [Evidence: `.opencode/specs/cli-external-orchestration/006-cli-skill-improved-prompting/plan.md`]
...
- [x] CHK-024 [P1] Strict packet validation passes for `.opencode/specs/cli-external-orchestration/006-cli-skill-improved-prompting/` [Evidence: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh --strict .opencode/specs/cli-external-orchestration/006-cli-skill-improved-prompting` -> `RESULT: PASSED`]
<!-- /ANCHOR:testing -->
...
- [x] CHK-041 [P1] The implementation summary is updated from placeholder to delivery summary once implementation completes [Evidence: `.opencode/specs/cli-external-orchestration/006-cli-skill-improved-prompting/implementation-summary.md`]
...
- [x] CHK-100 [P0] Architecture decisions are captured in `decision-record.md` [Evidence: `.opencode/specs/cli-external-orchestration/006-cli-skill-improved-prompting/decision-record.md`]
...
- [x] CHK-140 [P1] All planning docs exist in the packet root [Evidence: `rg --files .opencode/specs/cli-external-orchestration/006-cli-skill-improved-prompting`]
...
- [x] CHK-142 [P2] The implementation summary is converted from placeholder to final summary at closeout [Evidence: `.opencode/specs/cli-external-orchestration/006-cli-skill-improved-prompting/implementation-summary.md`]

You are running iteration 1 of a 5-iteration deep review on spec folder `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/`.
...
2. The Level 3 spec docs at `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/`
...
Write your findings to `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/review/iterations/iteration-001.md` using this exact structure:

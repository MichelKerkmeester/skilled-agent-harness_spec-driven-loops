...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/skills/sk-prompt-models/benchmarks/2026-06-28--prompt-framework--glm-5-2/synthesis.md"
    session_dedup:
...
| `.opencode/skills/sk-prompt-models/benchmarks/2026-06-28--prompt-framework--glm-5-2/` | Created | Run outputs: results.json, aggregate.json, synthesis.md, sweep logs |

---
title: "Feature Specification: Codex Tone-of-Voice [cli-external-orchestration/007-cli-codex-tone-of-voice/spec]"
...
_memory:
  continuity:
    ...
    open_questions: []
    answered_questions:
      - "Spec folder path: .opencode/specs/cli-external-orchestration/007-cli-codex-tone-of-voice"
...
| `.opencode/specs/cli-external-orchestration/007-cli-codex-tone-of-voice/*.md`         | Create      | Spec folder docs (spec, plan, tasks, checklist, decision-record, impl)  |
| `.opencode/specs/cli-external-orchestration/007-cli-codex-tone-of-voice/*.json`       | Create      | description.json + graph-metadata.json (via generate-context.js)        |
<!-- /ANCHOR:scope -->
...
- **SC-003**: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/cli-external-orchestration/007-cli-codex-tone-of-voice --strict` exits 0.

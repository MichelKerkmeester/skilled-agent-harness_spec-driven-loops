...
- [x] T027 Run `validate.sh --strict` on this phase folder; mark checklist with evidence (`validate.sh .opencode/specs/cli-external-orchestration/039-pi-caching-like-reasonix/001-research --strict`: 0 errors, 0 warnings)
<!-- /ANCHOR:phase-3 -->

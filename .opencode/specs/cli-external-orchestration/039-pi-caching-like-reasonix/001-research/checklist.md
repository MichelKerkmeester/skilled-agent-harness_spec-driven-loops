...
- [x] CHK-023 [P1] `validate.sh --strict` on this folder exits 0
  Evidence: `validate.sh .opencode/specs/cli-external-orchestration/039-pi-caching-like-reasonix/001-research --strict` returned `RESULT: PASSED` with 0 errors and 0 warnings.
<!-- /ANCHOR:testing -->

...
- The lumo statement that concurrent agents share a cache should be treated as a conditional design goal, not a Pi capability claim. A plugin can offer explicit namespaces and warnings, but it should default to isolation to avoid cross-task leakage and misleading hit-rate attribution. [SOURCE: .opencode/specs/cli-external-orchestration/039-pi-caching-like-reasonix/lumo.md:12-19; INFERENCE: https://pi.dev/docs/latest/sessions]
...
- `.opencode/specs/cli-external-orchestration/039-pi-caching-like-reasonix/lumo.md:12-19`

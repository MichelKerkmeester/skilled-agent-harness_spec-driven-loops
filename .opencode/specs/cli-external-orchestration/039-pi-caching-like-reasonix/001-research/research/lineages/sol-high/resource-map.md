...
- `.opencode/specs/cli-external-orchestration/039-pi-caching-like-reasonix/lumo.md` — uncited claim source.
- `.opencode/specs/cli-external-orchestration/039-pi-caching-like-reasonix/001-research/spec.md` — research questions and acceptance criteria.

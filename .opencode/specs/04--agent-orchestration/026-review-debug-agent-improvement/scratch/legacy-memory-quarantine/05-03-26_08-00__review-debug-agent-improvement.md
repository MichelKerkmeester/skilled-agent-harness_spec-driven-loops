...
| Spec Folder | 04--agent-orchestration/026-review-debug-agent-improvement |
| Channel | main |
...
```
/spec_kit:resume 04--agent-orchestration/026-review-debug-agent-improvement
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: 04--agent-orchestration/026-review-debug-agent-improvement
Last: Tool: bash
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 04--agent-orchestration/026-review-debug-agent-improvement` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "04--agent-orchestration/026-review-debug-agent-improvement" })` |
...
memory_search({ specFolder: "04--agent-orchestration/026-review-debug-agent-improvement", limit: 10 })

# Verify memory file integrity
ls -la 04--agent-orchestration/026-review-debug-agent-improvement/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js 04--agent-orchestration/026-review-debug-agent-improvement --force
```
...
spec_folder: "04--agent-orchestration/026-review-debug-agent-improvement"
channel: "main"
...
parent_spec: "04--agent-orchestration/026-review-debug-agent-improvement"
child_sessions:

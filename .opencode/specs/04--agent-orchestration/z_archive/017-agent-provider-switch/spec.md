...
contextType: "general"
---
# Feature Specification: Agent Provider Switch
...
### Problem Statement
This archived agent orchestration archive folder captures work related to Agent Provider Switch. The earlier markdown drifted away from the active templates, which caused validator failures and made the archive harder to trust.
...
### In Scope
- Preserve the archived topic and folder identity for Agent Provider Switch.
...
|----|-------------|---------------------|
| REQ-001 | The archive must clearly state that the folder documents Agent Provider Switch. | A maintainer can identify the archived topic from spec.md without opening other files. |

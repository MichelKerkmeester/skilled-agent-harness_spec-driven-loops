...
contextType: "general"
---
# Feature Specification: Command Agent Utilization
...
| **Status** | Complete |
| **Created** | 2026-03-31 |
| **Branch** | `014-command-agent-utilization` |
<!-- /ANCHOR:metadata -->
...
### Problem Statement
This archived agent orchestration archive folder captures work related to Command Agent Utilization. The earlier markdown drifted away from the active templates, which caused validator failures and made the archive harder to trust.
...
### In Scope
- Preserve the archived topic and folder identity for Command Agent Utilization.
...
|----|-------------|---------------------|
| REQ-001 | The archive must clearly state that the folder documents Command Agent Utilization. | A maintainer can identify the archived topic from spec.md without opening other files. |

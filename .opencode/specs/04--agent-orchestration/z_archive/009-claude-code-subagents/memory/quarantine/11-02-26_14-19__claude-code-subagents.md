...
| Spec Folder | ../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents |
| Channel | main |
...
- Uncertainty: [TBD]
- Readiness: [TBD]
<!-- /ANCHOR:preflight-session-1770815950245-43y47835l/opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents -->
...
```
/spec_kit:resume ../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: ../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents
Last: Tool: bash
...
<!-- /ANCHOR:continue-session-session-1770815950245-43y47835l/opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents -->
...
<!-- ANCHOR_EXAMPLE:task-guide-../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents-../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents -->
<!-- ANCHOR:task-guide -->
...
<!-- ANCHOR_EXAMPLE:summary-session-1770815950245-43y47835l-../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents -->
<!-- ANCHOR:summary -->
<a id="overview"></a>
...
<!-- ANCHOR_EXAMPLE:detailed-changes-session-1770815950245-43y47835l-../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents -->
...
<!-- ANCHOR_EXAMPLE:decisions-session-1770815950245-43y47835l-../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents -->
<a id="decisions"></a>
...
<!-- ANCHOR_EXAMPLE:session-history-session-1770815950245-43y47835l-../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents -->
<a id="conversation"></a>
...
<!-- ANCHOR_EXAMPLE:recovery-hints-session-1770815950245-43y47835l-../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents -->
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume ../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents" })` |
...
memory_search({ specFolder: "../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents", limit: 10 })

# Verify memory file integrity
ls -la ../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js ../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents --force
```
...
<!-- ANCHOR_EXAMPLE:postflight-session-1770815950245-43y47835l-../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents -->
<!-- ANCHOR:postflight -->
...
<!-- ANCHOR_EXAMPLE:metadata-session-1770815950245-43y47835l-../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents -->
...
spec_folder: "../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents"
channel: "main"
...
parent_spec: "../.opencode/specs/04--agent-orchestration/z_archive/009-claude-code-subagents"
child_sessions:

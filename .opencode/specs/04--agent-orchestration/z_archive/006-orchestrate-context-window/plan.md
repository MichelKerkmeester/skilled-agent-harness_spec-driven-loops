...
contextType: "general"
---
# Implementation Plan: Orchestrate Context Window
...
### Overview
This archive fix rewrites the required Level 1 documents for orchestrate context window. The plan favors structural compliance, concise historical context, and clean validation over recreating every superseded planning artifact.
<!-- /ANCHOR:summary -->

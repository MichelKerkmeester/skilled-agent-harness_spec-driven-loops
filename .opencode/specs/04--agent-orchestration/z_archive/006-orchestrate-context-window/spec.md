...
trigger_phrases:
  - "feature"
  - "specification"
  - "orchestrate context window"
  - "archive"
  - "spec core"
importance_tier: "normal"
contextType: "general"
---
# Feature Specification: Orchestrate Context Window
...
### Problem Statement
This folder documents archived work on how the orchestrator manages context-window limits and context handoff, but its markdown had drifted away from the current system-spec-kit contract. Missing anchors, stale file expectations, and archive-era notes created validation errors and made the historical record harder to review with confidence.

### Purpose
Capture the context-window orchestration topic in a minimal archive that validates cleanly.
<!-- /ANCHOR:problem -->
...
- **SC-002**: The archive remains readable as a concise history of orchestrate context window.
...
| Risk | Context-window assumptions can age quickly as orchestration prompts and models evolve. | Reviewers may misread the archive as current guidance. | Mark the work as archived and keep the content concise and descriptive rather than prescriptive. |
<!-- /ANCHOR:risks -->

...
| Field | Value |
|-------|-------|
| **Spec Folder** | 007-explore-sub-agent |
...
This archive fix replaced drifted planning documents with a concise Level 1 record for explore sub-agent. You can now inspect the folder without running into broken structure, stale metadata, or invalid top-level references.

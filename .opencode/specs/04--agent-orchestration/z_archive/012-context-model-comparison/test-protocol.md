...
- Must discover: agent files in `.opencode/agent/` and `.claude/agents/`, orchestrator dispatch patterns, agent relationships, spec folders under `04--agent-orchestration/`

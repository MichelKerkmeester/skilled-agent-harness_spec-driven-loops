...
- **Feature/Spec**: Agent System Upgrade (.opencode/specs/04--agent-orchestration/z_archive/003-agent-system-upgrade)
- **Status**: Complete
...
├── skills/
│   ├── research/research.md      # Research capabilities
...
---
[INCLUDE: skills/research/research/research.md]
---
...
const checkpoint = {
    ...
    // Context
    context: {
        specFolder: ".opencode/specs/04--agent-orchestration/z_archive/003-agent-system-upgrade",
        originalRequest: "...",
        decisions: [...]
    },

...
contextType: "general"
---
# Decision Record: Agent System Upgrade
...
The archived folder for Agent System Upgrade had drifted away from the active templates. We needed a safe way to preserve the archive while eliminating validator errors.

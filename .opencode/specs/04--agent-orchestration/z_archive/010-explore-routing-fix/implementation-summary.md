...
description: "Archive normalization summary for Explore Routing Fix."
trigger_phrases:
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 010-explore-routing-fix |
...
This archived folder now has a current-template Level 1 documentation set for Explore Routing Fix. You can open the archive and understand the topic, the cleanup scope, and the fact that the folder was normalized to pass today’s validator instead of being left in drifted historical form.

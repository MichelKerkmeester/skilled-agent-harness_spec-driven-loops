...
Save as `.opencode/specs/04--agent-orchestration/z_archive/001-agents-from-oh-my-opencode/run_tests.sh`:
...
chmod +x .opencode/specs/04--agent-orchestration/z_archive/001-agents-from-oh-my-opencode/run_tests.sh

# Run all tests
bash .opencode/specs/04--agent-orchestration/z_archive/001-agents-from-oh-my-opencode/run_tests.sh
```

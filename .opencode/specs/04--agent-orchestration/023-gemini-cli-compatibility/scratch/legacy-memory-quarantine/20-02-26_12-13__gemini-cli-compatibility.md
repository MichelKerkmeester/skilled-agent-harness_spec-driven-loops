...
```
/spec_kit:resume 04--agent-orchestration/023-gemini-cli-compatibility
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: 04--agent-orchestration/023-gemini-cli-compatibility
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 04--agent-orchestration/023-gemini-cli-compatibility` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "04--agent-orchestration/023-gemini-cli-compatibility" })` |
...
memory_search({ specFolder: "04--agent-orchestration/023-gemini-cli-compatibility", limit: 10 })

# Verify memory file integrity
ls -la 04--agent-orchestration/023-gemini-cli-compatibility/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js 04--agent-orchestration/023-gemini-cli-compatibility --force
```
...
spec_folder: "04--agent-orchestration/023-gemini-cli-compatibility"
channel: "main"
...
parent_spec: "04--agent-orchestration/023-gemini-cli-compatibility"
child_sessions:

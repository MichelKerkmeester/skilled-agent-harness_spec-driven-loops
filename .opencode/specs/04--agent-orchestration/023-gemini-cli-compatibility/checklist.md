---
title: "Verification Checklist: Gemini CLI Compatibility [04--agent-orchestration/023-gemini-cli-compatibility/checklist]"
...
- [ ] CHK-051 [P1] `.opencode/command/create agent command` references `.opencode/agent/gemini/` as a target path for new agent creation
...
- [ ] CHK-030 [P0] 9 skill symlinks created in `.gemini/skills/` (mcp-code-mode, mcp-figma, system-spec-kit, mcp-chrome-devtools, sk-code--full-stack, sk-code--opencode, workflows-code--web-dev, sk-doc, sk-git)

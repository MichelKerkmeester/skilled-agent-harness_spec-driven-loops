...
| `019-skill-command-alignment/spec.md` | Create | This file |
| `019-skill-command-alignment/plan.md` | Create | Implementation plan |
| `019-skill-command-alignment/tasks.md` | Create | Task breakdown |
| `019-skill-command-alignment/checklist.md` | Create | Verification checklist |
| `019-skill-command-alignment/decision-record.md` | Create | ADR-001 and ADR-002 |
| `019-skill-command-alignment/implementation-summary.md` | Create | Post-implementation summary |
<!-- /ANCHOR:scope -->
...
- Successor: `020-subfolder-resolution-fix`

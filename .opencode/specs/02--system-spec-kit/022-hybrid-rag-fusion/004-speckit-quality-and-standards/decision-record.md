---
title: "Consolidated decision-record: 004-speckit-quality-and-standards [004-speckit-quality-and-standards/decision-record.md]"
...
<!-- ANCHOR:adr-004 -->
## ADR-004: Consolidate Phase 002 into Canonical Phase 008
...
| Option | Pros | Cons | Score |
|--------|------|------|-------|
| **Merge into 008 and tombstone 002 (chosen)** | Single source of truth; preserves full evidence chain | Requires one-time continuity edits | 10/10 |

---
title: "Tasks: Spec Kit Code Quality Initiative [002-spec-kit-code-quality/tasks.md]"
...
- [x] T003 Define hotspot scoring rubric for bloated files (`.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/002-spec-kit-code-quality/scratch/`). [EVIDENCE: `scratch/review-summary.md`]
<!-- /ANCHOR:phase-1 -->
...
- [x] T023 Run spec validation for this phase folder. [EVIDENCE: `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/009-spec-kit-code-quality`]

...
**Spec**: 022-hybrid-rag-fusion / 014-feedback-and-quality
...
|----------|------|-----------|
| Sprint 4 Specification | `014-feedback-and-quality/spec.md` | Primary source: requirements, risks, scope |
| Sprint 4 Plan | `014-feedback-and-quality/plan.md` | Effort estimates, architecture, rollback plan |
| Sprint 4 Tasks | `014-feedback-and-quality/tasks.md` | Task sums used for effort reconciliation |
| Sprint 4 Checklist | `014-feedback-and-quality/checklist.md` | Duplicate ID defect (CHK-050/051/052) |
...
| Sprint 5 Spec | `015-pipeline-refactor/spec.md` | Proposed home for PI-A4 |

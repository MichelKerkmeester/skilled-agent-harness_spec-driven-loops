...
- **Relational queries:** Many agent memory lookups are structured ("Find the decision for spec 002", "Get all memories about RRF fusion"). These are relational queries wearing a semantic-search costume. SQL might be faster, simpler, and more reliable.

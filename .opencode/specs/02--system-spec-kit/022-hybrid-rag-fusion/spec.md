...
|-------|--------|-------|--------------|--------|
| 1 | `010-measurement-foundation/` | G1, G3, R17, R13-S1, G-NEW-1, B7, D4, TM-02, A2, Eval-the-eval, G-NEW-3 (Phase A) (50-77h) | None (BLOCKING) | Complete |
...
| 020-subfolder-resolution-fix | 021-cross-cutting-remediation | Subfolder path resolution fixes complete; P0 and P1 checklist gates fully checked | `020-subfolder-resolution-fix/checklist.md` summary + testing section |
| 021-cross-cutting-remediation | 022-post-review-remediation | Phase-1 remediation exit gate complete with all required checklist items verified | `021-cross-cutting-remediation/checklist.md` remediation exit gate + summary |

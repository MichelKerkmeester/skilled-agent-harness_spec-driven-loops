...
Spec: `030-architecture-boundary-remediation` (archived under `010-architecture-audit/scratch/merged-030-architecture-boundary-remediation`)

## Scope

- T020: Create `decision-record.md` for spec 013 with ADR-001 on regex evasion vector acceptance.
- T021: Create allowlist expiry checker in `scripts/evals/` (30-day warning, exit 1 on expired).

## Changes Made

1. Created `decision-record.md` at:
   `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/010-architecture-audit/scratch/merged-030-architecture-boundary-remediation/decision-record.md`

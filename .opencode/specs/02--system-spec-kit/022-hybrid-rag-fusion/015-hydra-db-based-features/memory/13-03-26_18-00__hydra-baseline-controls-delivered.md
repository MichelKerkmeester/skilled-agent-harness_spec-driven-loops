...
---
title: "Hydra baseline controls delivered [015-hydra-db-based-features/13-03-26_18-00__hydra-baseline-controls-delivered]"
...
| Spec Folder | 02--system-spec-kit/022-hybrid-rag-fusion/015-hydra-db-based-features |
| Channel | main |
...
```
/spec_kit:resume 02--system-spec-kit/022-hybrid-rag-fusion/015-hydra-db-based-features
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: 02--system-spec-kit/022-hybrid-rag-fusion/015-hydra-db-based-features
...
| `.opencode/skill/system-spec-kit/mcp_server/scripts/migrations/(merged-small-files)` | Tree-thinning merged 2 small files (create-checkpoint.ts, restore-checkpoint.ts). Merged from .opencode/skill/system-spec-kit/mcp_server/scripts/migrations/create-checkpoint.ts : Updated create checkpoint | Merged from .opencode/skill/system-spec-kit/mcp_server/scripts/migrations/restore-checkpoint.ts : Updated restore checkpoint |
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 02--system-spec-kit/022-hybrid-rag-fusion/015-hydra-db-based-features` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "02--system-spec-kit/022-hybrid-rag-fusion/015-hydra-db-based-features" })` |
...
memory_search({ specFolder: "02--system-spec-kit/022-hybrid-rag-fusion/015-hydra-db-based-features", limit: 10 })

# Verify memory file integrity
ls -la 02--system-spec-kit/022-hybrid-rag-fusion/015-hydra-db-based-features/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js 02--system-spec-kit/022-hybrid-rag-fusion/015-hydra-db-based-features --force
```
...
spec_folder: "02--system-spec-kit/022-hybrid-rag-fusion/015-hydra-db-based-features"
channel: "main"
...
parent_spec: "02--system-spec-kit/022-hybrid-rag-fusion/015-hydra-db-based-features"
child_sessions:

...
trigger_phrases:
  ...
  - "score resolution chains delegating"
  - "resolution chains delegating comparedeterministicrows"
  - "chains delegating comparedeterministicrows extractscoringvalue"
  - "delegating comparedeterministicrows extractscoringvalue resolveeffectivescore"
  - "comparedeterministicrows extractscoringvalue resolveeffectivescore canonical"
  - "extractscoringvalue resolveeffectivescore canonical types.ts"
  - "fixed 100x similarity scale"
  - "100x similarity scale mismatch"
  - "kit/022"
  - "fusion/001"
  - "epic"

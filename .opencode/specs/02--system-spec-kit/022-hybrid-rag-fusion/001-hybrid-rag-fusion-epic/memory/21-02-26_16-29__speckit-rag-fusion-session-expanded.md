---
title: "To promote a memory to constitutional tier [001-hybrid-rag-fusion-epic/21-02-26_16-29__speckit-rag-fusion-session-expanded]"
...
**Key Topics:** `system` | `hybrid` | `rag` | `memory` | `skill graph` | `02--system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic` | `skill` | `graph` | `002` | `spec` | `kit/022` | `fusion/001` | 
...
key_topics:
  ...
  - "memory"
  - "skill graph"
  - "02--system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic"
  - "skill"
  - "graph"
  - "003"
  - "spec"

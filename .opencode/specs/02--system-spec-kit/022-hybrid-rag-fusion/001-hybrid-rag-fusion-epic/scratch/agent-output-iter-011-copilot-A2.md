...
● Read deep-research-strategy.md
  │ specs/02--system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/scratch/deep-research
  │ -strategy.md
  └ 1 line read
...
● Search (grep)
  ...
  │ (specs/02--system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic)
  └ 5 lines found

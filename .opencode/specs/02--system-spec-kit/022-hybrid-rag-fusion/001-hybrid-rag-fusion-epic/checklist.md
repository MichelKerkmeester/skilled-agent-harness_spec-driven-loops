...
| *(deleted)* 009-spec-descriptions | *(deleted 2026-03-16)* | 8/10 | 12/19 | Phase 3-4 confirmed, gap items remain *(folder deleted 2026-03-16)* |
| 011-command-alignment | complete | Yes | Yes | CHK-052 P2 deferred |

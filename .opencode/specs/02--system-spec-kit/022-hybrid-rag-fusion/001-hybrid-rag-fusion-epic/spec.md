...
- sources/000-feature-overview/spec.md
...
| 003 | `003-constitutional-learn-refactor` | Complete | 2026-03-08 |
| 004 | `004-ux-hooks-automation` | Complete | 2026-03-08 |
...
| *(deleted)* | `013-outsourced-agent-memory` | *(deleted)* | — |
...
| Documentation artifacts (NEW) | `006-feature-catalog/**/**/feature.md` (generated from feature_catalog.md + summary_of_new_features.md) | Create/Update |
<!-- /ANCHOR:scope -->
...
<!-- NOTE: Sprint child folders now live directly under 001-hybrid-rag-fusion-epic/ (merged from former 005-core-rag-sprints-0-to-9 on 2026-03-16). -->
...
- Use `/spec_kit:resume 022-hybrid-rag-fusion/NNN-*/` to resume a specific phase
...
|------|-----|----------|--------------|
| Sprint 0 (in `001-sprint-0-measurement-foundation/`) | Sprint 1 (in `002-sprint-1-graph-signal-activation/`) | Graph hit rate >0%, chunk dedup verified, BM25 baseline MRR@5 recorded, ground truth corpus meets diversity requirements (see below) | R13 eval metrics |
| Sprint 0 (in `001-sprint-0-measurement-foundation/`) | Sprint 2 (in `003-sprint-2-scoring-calibration/`) | Same Sprint 0 exit gate (S1 and S2 run **in parallel** after S0) | R13 eval metrics |
...
<!-- NOTE: Sprint children now live directly under 001-hybrid-rag-fusion-epic/ -->
| Sprint 1 (`002-sprint-1-graph-signal-activation/`) AND Sprint 2 (`003-sprint-2-scoring-calibration/`) | Sprint 3 (`004-sprint-3-query-intelligence/`) | S1: R4 MRR@5 delta >+2% absolute, edge density measured; S2: Cache hit >90%, score distributions normalized, G2 resolved | R13 eval metrics |
...
| `007-combined-bug-fixes` *(deleted)* | 021-cross-cutting-remediation | Subfolder path resolution fixes complete; P0 and P1 checklist gates fully checked | 007-combined-bug-fixes/checklist.md summary + testing section *(historical — folder deleted 2026-03-16)* |
| 021-cross-cutting-remediation | 022-post-review-remediation | Phase-1 remediation exit gate complete with all required checklist items verified | `003-speckit-quality-and-standards` *(deleted)* /checklist.md remediation exit gate + summary *(historical — folder deleted 2026-03-16)* | <!-- AUDIT-2026-03-08: corrected from non-existent 002-cross-cutting-remediation -->
...
|----|-------------|---------------------|------------------|
| DOC-01 | Extract each canonical feature into per-folder markdown artifacts — parse all `###` features from 006-feature-catalog/feature_catalog.md, enrich with optional matching content from 006-feature-catalog/summary_of_new_features.md, and write feature.md in each corresponding numbered feature folder under `006-feature-catalog/` | 1) One feature.md per canonical feature folder (`006-feature-catalog/**/**/feature.md`), 2) each artifact contains canonical section + new/updated context section + source metadata, 3) folder mapping uses numbered group/feature ordering from the canonical catalog, 4) coverage check passes with missing=0 and extra=0 | Cross-cutting |

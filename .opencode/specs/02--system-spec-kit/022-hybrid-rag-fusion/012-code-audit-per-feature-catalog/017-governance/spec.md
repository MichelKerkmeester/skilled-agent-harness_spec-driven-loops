...
|-----------|-------------|-------------|
| `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/012-code-audit-per-feature-catalog/017-governance/spec.md` | Modify | Convert governance specification into Level 2 template format |
| `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/012-code-audit-per-feature-catalog/017-governance/plan.md` | Modify | Convert audit methodology into Level 2 implementation plan format |
| `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/012-code-audit-per-feature-catalog/017-governance/tasks.md` | Modify | Convert audit task list into Level 2 task tracking format |
| `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/012-code-audit-per-feature-catalog/017-governance/checklist.md` | Modify | Convert findings into Level 2 verification checklist format |

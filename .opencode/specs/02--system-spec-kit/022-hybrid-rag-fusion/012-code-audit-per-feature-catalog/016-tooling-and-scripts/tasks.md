...
- [x] T001 Build feature inventory for all 8 Tooling and Scripts features (`.opencode/skill/system-spec-kit/feature_catalog/16--tooling-and-scripts/*.md`)
...
- [x] T004 [P0] Repoint tree-thinning feature mapping to actual consolidation workflow code (`.opencode/skill/system-spec-kit/feature_catalog/16--tooling-and-scripts/01-tree-thinning-for-spec-folder-consolidation.md`)
...
- [x] T010 [P1] Add auditable source evidence for dead-code-removal claims (`.opencode/skill/system-spec-kit/feature_catalog/16--tooling-and-scripts/04-dead-code-removal.md`)
- [x] T011 [P1] Add file-level evidence and rule mapping for standards-alignment claims (`.opencode/skill/system-spec-kit/feature_catalog/16--tooling-and-scripts/05-code-standards-alignment.md`)
- [x] T012 [P1] Decide and document checkpoint-before-delete contract for standalone admin CLI (`mcp_server/cli.ts`, `.opencode/skill/system-spec-kit/feature_catalog/16--tooling-and-scripts/07-standalone-admin-cli.md`)
...
- [x] T015 [P2] Add regression tests to protect dead-code-removal outcomes (`.opencode/skill/system-spec-kit/feature_catalog/16--tooling-and-scripts/04-dead-code-removal.md`)
- [x] T016 [P2] Link lint/check outputs for standards-alignment verification traceability (`.opencode/skill/system-spec-kit/feature_catalog/16--tooling-and-scripts/05-code-standards-alignment.md`)
<!-- /ANCHOR:phase-2 -->
...
- [x] T018 Reconcile feature-catalog implementation/test tables with resolved runtime surfaces (`.opencode/skill/system-spec-kit/feature_catalog/16--tooling-and-scripts/*.md`)

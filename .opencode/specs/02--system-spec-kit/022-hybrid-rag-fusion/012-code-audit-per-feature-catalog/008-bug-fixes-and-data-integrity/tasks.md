...
- [x] T016 [P] [P2] Remove stray packet artifact file (`.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/012-code-audit-per-feature-catalog/005-lifecycle/.DS_Store`)
<!-- /ANCHOR:phase-2 -->
...
- [x] T022 [P] [P1] Replace stale glob/brace placeholders in Discovery packet task references with concrete paths (`.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/012-code-audit-per-feature-catalog/003-discovery/tasks.md`)
<!-- /ANCHOR:phase-4 -->

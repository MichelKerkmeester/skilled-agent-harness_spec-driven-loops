...
| `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/012-code-audit-per-feature-catalog/007-evaluation/*.md` | Modify | Maintain phase specification, plan, tasks, and checklist artifacts. |
<!-- /ANCHOR:scope -->

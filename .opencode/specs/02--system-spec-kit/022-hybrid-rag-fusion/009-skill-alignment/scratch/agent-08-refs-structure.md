...
- **Gap 5 (P2):** Special folders section (Section 4) does not mention the `.gitkeep` sentinel file pattern used by stub phases (e.g., `015-skill-alignment/memory/.gitkeep`). No guidance explains when stub phases are appropriate or how to signal that a child folder is a placeholder.

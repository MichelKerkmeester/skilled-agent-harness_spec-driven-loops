...
description: "Actionable backlog for the still-open documentation alignment work in 009-skill-alignment."
...
- [x] T002 Fix local relative references so links resolve from `009-skill-alignment` (`./spec.md`, `./plan.md`, `./tasks.md`)
...
- [x] T016 Run `validate.sh` for the `009-skill-alignment` folder and record any remaining policy conflicts honestly (`./checklist.md`)

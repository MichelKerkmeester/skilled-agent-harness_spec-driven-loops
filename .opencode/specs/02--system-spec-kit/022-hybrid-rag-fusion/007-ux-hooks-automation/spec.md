...
| manual test playbook document in folder 016-manual-testing-per-playbook | Modify | Add NEW-103+ manual scenarios for UX hooks |
<!-- /ANCHOR:scope -->
...
| REQ-007 | Manual test playbook covers UX hook additions | manual test playbook document in folder 016-manual-testing-per-playbook includes NEW-103+ scenarios for hook modules, handler hints, context-server hint append, and automated verification commands |

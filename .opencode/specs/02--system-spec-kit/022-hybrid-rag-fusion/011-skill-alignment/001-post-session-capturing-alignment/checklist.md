# Checklist — Post Session Capturing Alignment
...
- [x] CHK-005: SKILL.md handler count updated to ~40 [Evidence: T002 completed]
- [x] CHK-006: 6-command structure noted in SKILL.md [Evidence: T003 completed]
- [x] CHK-007: Quality-fix Key Concepts added to SKILL.md [Evidence: T004 completed]
- [x] CHK-008: execution_methods.md shows JSON mode first [Evidence: T006 completed]
- [x] CHK-009: save_workflow.md bare positional examples use --recovery [Evidence: T007 completed]
- [x] CHK-010: environment_variables.md has JSON-mode usage example [Evidence: T008 completed]

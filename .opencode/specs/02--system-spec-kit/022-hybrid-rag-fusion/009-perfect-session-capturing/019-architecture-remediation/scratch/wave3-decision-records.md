# Wave 3 - OPUS-B3: Architecture Decision Records (Synthesis)

Date: 2026-03-21
Agent: Claude Opus 4.6 (1M context)
Input: 10 Wave 1 scratch files (codex-1..5, opus-1..5), 10 Wave 2 scratch files (wave1-codex-A1..A5, wave2-opus-A1..A5), existing decision-record.md skeleton

---

## ADR-001: Multi-Agent Architecture Audit Approach

**Verified.** ADR-001 in `decision-record.md` is already fully populated. No `[OPUS-B3: fill]` markers remain. Content is accurate: the 3-wave structure (10 parallel Wave 1 analysis agents, Wave 2 targeted fixes, 5 Wave 3 synthesis agents) with isolated scratch outputs is correctly documented. Five Checks all PASS.
...
**What it costs**:
- Sprint S2 touches 15-20 files across extractors, utils, core, and tests
- Re-export shims add 3-4 temporary files that must be cleaned up in Sprint S3
...
| Test fixtures use `as any` to bypass renamed types | M | Sprint S2 includes test fixture migration; CODEX-A3-014 tracks `as any` removal |
<!-- /ANCHOR:adr-002-consequences -->
...
- Sprint S3 cleanup: Remove all deprecated re-export aliases

**How to roll back**: Revert Sprint S2 commit. Type errors will re-emerge but callers remain functional.
<!-- /ANCHOR:adr-002-impl -->
<!-- /ANCHOR:adr-002 -->
...
- Sprint S3 is the designated window for boundary restoration
...
| 4 | **Fits Goal?** | PASS | Architecture boundary restoration is the primary goal of Sprint S3 |
...
**How to roll back**: Revert Sprint S3 commit. Architecture violations re-emerge but functionality is restored.
<!-- /ANCHOR:adr-003-impl -->
<!-- /ANCHOR:adr-003 -->
...
**We chose**: A two-track approach -- (1) immediate manual backfill of critical metadata gaps (Sprint S4), and (2) an automated lint script that enforces description.json consistency going forward.

**How it works**:

**Track 1 -- Manual backfill (Sprint S4):**
...
| Manual correction in Sprint S4 only | No new tooling | Will drift again on next phase addition without enforcement | 5/10 |
...
**What it costs**:
- Sprint S4: ~1 hour for manual backfill across 20+ files
...
**What changes**:
- Sprint S4: Update 20 `description.json` files with `status` field; update 7 spec.md files with corrected phase numbers and denominators; add 019 to `descriptions.json`; fix parent checklist counts
...
|--------|------|------------------|
| **S1** | ADR-001 (done), ADR-004, ADR-008 (ops/dist cleanup) | Delete stale artifacts, wire cli-capture-shared, remove broken ops scripts |
| **S2** | ADR-002, ADR-008 (quality scorer, dead exports) | Type renames, legacy scorer deletion, dead export removal |
| **S3** | ADR-003 | Circular dep fix, shim removal, boundary enforcement |
| **S4** | ADR-005 (manual backfill), ADR-006, ADR-007 | Metadata backfill, save pipeline safety, JSON-primary integrity |
| **S5** | ADR-005 (lint script) | Automated metadata governance |

---

## Evidence Index

| Finding ID | ADR | Severity | Category |
|------------|-----|----------|----------|
| CODEX-A1-005 | 006 | HIGH | Race condition |
| CODEX-A1-006 | 002, 008 | MEDIUM | Dual scorer |
| CODEX-A1-010 | 004 | LOW | Build drift |
| CODEX-A2-001 | 007 | HIGH | Data loss |
| CODEX-A2-002 | 007 | HIGH | Data loss |
| CODEX-A2-003 | 007 | MEDIUM | Type mismatch |
| CODEX-A2-008 | 008 | MEDIUM | Dual scorer |
| CODEX-A2-009 | 008 | LOW | Dead code |
| CODEX-A2-010 | 008 | LOW | Dead code |
| CODEX-A3-001 | 002 | HIGH | Naming collision |
| CODEX-A3-002 | 002 | MEDIUM | Naming collision |
| CODEX-A3-003 | 002 | MEDIUM | Naming collision |
| CODEX-A3-004 | 002 | LOW | Naming collision |
| CODEX-A3-005 | 002 | HIGH | Index overuse |
| CODEX-A3-006 | 002 | HIGH | Index overuse |
| CODEX-A5-001 | 007 | HIGH | Skipped validation |
| CODEX-A5-002 | 006 | HIGH | Fail-open V-rules |
| CODEX-A5-003 | 006 | HIGH | Race condition |
| CODEX-A5-004 | 006 | HIGH | Non-atomic writes |
| CODEX-A5-005 | 006 | MEDIUM | Quality threshold |
| CODEX1-006 | 008 | LOW | Dead export |
| CODEX3-009 | 008 | LOW | Dead export |
| CODEX3-010 | 008 | LOW | Dead parameter |
| OPUS-A1-001..004 | 003 | HIGH/MEDIUM | Circular deps |
| OPUS-A1-005..006 | 003 | MEDIUM | Layer violations |
| OPUS-A1-007 | 003 | HIGH | God module |
| OPUS-A1-008..009 | 003 | MEDIUM/LOW | Barrel bypass |
| OPUS-A1-013..015 | 003 | LOW | Barrel gaps |
| OPUS-A2-002..005 | 005 | HIGH | Phase numbering |
| OPUS-A2-006 | 005 | HIGH | Count error |
| OPUS-A2-010 | 005 | MEDIUM | Status mismatch |
| OPUS-A3-001 | 005 | HIGH | Missing status |
| OPUS-A3-002..003 | 005 | MEDIUM | Wrong denominators |
| OPUS-A3-004 | 005 | HIGH | Missing from index |
| OPUS-A4-001..005 | 004 | CRITICAL | Stale dist |
| OPUS-A4-008..010 | 004, 008 | HIGH | Ops breakage |
| OPUS-A4-013..014 | 004 | MEDIUM | Build drift |
| OPUS-A5-001 | 008 | CRITICAL | Unwired module |
| OPUS-A5-002 | 008 | HIGH | Deprecated scorer |
| OPUS-A5-003..005 | 003, 008 | MEDIUM | Re-export shims |
| OPUS5-002..003 | 002 | HIGH | Naming collision |
| OPUS5-005 | 002 | HIGH | Unsafe casts |
| OPUS5-009 | 002, 008 | HIGH | Dual scorer |

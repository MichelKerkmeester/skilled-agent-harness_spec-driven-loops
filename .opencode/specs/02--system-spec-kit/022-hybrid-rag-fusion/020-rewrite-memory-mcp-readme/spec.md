...
---
<!-- SPECKIT_LEVEL: 1 -->
# Specification: 020-rewrite-memory-mcp-readme
...
- INSTALL_GUIDE.md (owned by sibling spec `020-update-install-guide`)
- Spec Kit README (owned by `021-rewrite-system-speckit-readme`)
- Command documentation (completed by `016-command-alignment`)
...
<!--
SPEC: 020-rewrite-memory-mcp-readme

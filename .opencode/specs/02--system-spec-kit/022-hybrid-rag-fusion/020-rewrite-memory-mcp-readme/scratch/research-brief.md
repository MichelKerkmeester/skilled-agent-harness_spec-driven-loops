...
> Investigation artifact for spec 020-rewrite-memory-mcp-readme. Provides the drafting agent with a complete inventory of tools, features, architecture details, current README gaps and target structure.

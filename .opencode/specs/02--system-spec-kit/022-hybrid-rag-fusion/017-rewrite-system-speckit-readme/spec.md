...
description: "Complete rewrite of the system-spec-kit README to document the full skill surface: documentation levels 1-3+, memory system, 32 MCP tools, 13 commands, templates, scripts, and validation."
trigger_phrases:
...
---
<!-- SPECKIT_LEVEL: 1 -->
# Specification: 017-rewrite-system-speckit-readme
...
| **Created** | 2026-03-15 |
| **Branch** | `main` |
| **Parent** | `022-hybrid-rag-fusion` (Phase 021) |
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../016-update-install-guide/spec.md |
| **Successor** | ../018-rewrite-repo-readme/spec.md |
<!-- /ANCHOR:metadata -->
...
The system-spec-kit README (`README.md`, ~872 lines) was written before the 22-category feature catalog, 13-command suite (8 spec_kit + 5 memory), and phase decomposition system existed. It describes an earlier, smaller version of the skill that does not reflect the current capability surface: 32 MCP tools, 4 documentation levels, CORE+ADDENDUM template architecture, validation scripts, and the full memory system.
...
- MCP server README (owned by `015-rewrite-memory-mcp-readme`)
- Root README (owned by `018-rewrite-repo-readme`)
- Command documentation content (completed by `011-command-alignment`)
...
|----|-------------|---------------------|
| SR-001 | All major components documented | Documentation levels (1-3+), memory system, MCP tools (summary), commands (all 13), templates, scripts, validation |
...
<!--
SPEC: 017-rewrite-system-speckit-readme
...
|-------|-------|
| **Parent Spec** | ../spec.md |
| **Previous Phase** | ../016-update-install-guide/spec.md |
| **Next Phase** | ../018-rewrite-repo-readme/spec.md |

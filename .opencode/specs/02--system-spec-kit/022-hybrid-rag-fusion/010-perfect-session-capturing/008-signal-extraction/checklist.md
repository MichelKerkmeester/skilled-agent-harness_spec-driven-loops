...
- [x] CHK-023 [P1] Existing extractor test suites pass through the adapter layer [Evidence: `node scripts/tests/test-extractors-loaders.js` passed (299 passed, 0 failed).]
...
- [x] CHK-052 [P2] Findings saved to memory/ [Evidence: `node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js '<phase-folder>'` created `memory/16-03-26_19-54__signal-extraction.md` and refreshed `metadata.json`.]
<!-- /ANCHOR:file-org -->

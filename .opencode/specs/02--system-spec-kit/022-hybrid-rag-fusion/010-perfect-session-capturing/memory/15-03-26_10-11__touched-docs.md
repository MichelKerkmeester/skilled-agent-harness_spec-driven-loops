...
---
title: "Touched docs. [010-perfect-session-capturing/15-03-26_10-11__touched-docs]"
...
| Session ID | session-1773565914540-db592d4bf7ff |
...
| Created At (Epoch) | 1773565914 |
| Last Accessed (Epoch) | 1773565914 |
| Access Count | 1 |
...
| Completion % | 8% |
| Last Activity | 2026-03-15T09:11:54.535Z |
| Time in Session | 0m |
...
**Key Topics:** `system spec kit/022 hybrid rag fusion/010 perfect session capturing` | `system` | `spec` | `kit/022` | `hybrid` | `rag` | `fusion/010` | `perfect` | `capturing` |
...
```yaml
# Core Identifiers
session_id: "session-1773565914540-db592d4bf7ff"
...
created_at_epoch: 1773565914
last_accessed_epoch: 1773565914
expires_at_epoch: 1781341914  # 0 for critical (never expires)
...
trigger_phrases:
  ...
  - "fusion/010 perfect session capturing"
  - "system"
  - "spec"
  - "kit/022"
  - "hybrid"

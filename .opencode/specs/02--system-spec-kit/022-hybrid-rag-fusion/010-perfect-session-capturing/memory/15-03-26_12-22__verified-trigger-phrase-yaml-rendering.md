...
Re-run closure verification for 010-perfect-session-capturing and prove the rendered memory preserves anchors, renders valid trigger phrases, and accepts the documented snake_case JSON contract.

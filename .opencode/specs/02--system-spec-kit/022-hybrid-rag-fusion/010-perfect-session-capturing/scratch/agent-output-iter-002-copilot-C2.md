...
● Search (grep)
  ...
  │ tem-spec-kit/022-hybrid-rag-fusion/010-perfect-session-capturing/research.md)
  └ 25 lines found
...
● Search (grep)
  ...
  │ encode/specs/02--system-spec-kit/022-hybrid-rag-fusion/010-perfect-session-capturing/spec.md)
  └ 21 lines found

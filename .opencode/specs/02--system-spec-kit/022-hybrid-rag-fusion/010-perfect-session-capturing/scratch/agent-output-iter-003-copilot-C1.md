...
● Search (grep)
  ...
  │ (.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/010-perfect-session-capturing/researc
...
`SYSTEM_SPEC_KIT_CAPTURE_SOURCE=<opencode|claude|codex|copilot|gemini> node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js 010-perfect-session-capturing`  

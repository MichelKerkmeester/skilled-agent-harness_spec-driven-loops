...
**Base path**: `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/010-perfect-session-capturing/`
...
- `specFolder`: `"02--system-spec-kit/022-hybrid-rag-fusion/010-perfect-session-capturing"` — **Correct**, matches actual folder location

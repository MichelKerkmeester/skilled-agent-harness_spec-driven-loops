...
> **Scope:** All `.md` files under `010-perfect-session-capturing/`, excluding `scratch/`, `research/`, and `memory/` subdirectories.
> **Date:** 2026-03-17
...
All five checks pass. The ANCHOR tag infrastructure across the 010-perfect-session-capturing spec folder is structurally sound:

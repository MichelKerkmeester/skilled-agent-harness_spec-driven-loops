...
| `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/010-perfect-session-capturing/000-dynamic-capture-deprecation/003-multi-cli-parity/*.md` | Modify | Bring the archived branch phase artifacts back into Level 2 template compliance with current evidence. |
<!-- /ANCHOR:scope -->

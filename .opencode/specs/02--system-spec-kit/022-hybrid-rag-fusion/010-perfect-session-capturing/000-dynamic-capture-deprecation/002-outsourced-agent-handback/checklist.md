...
- [x] CHK-001 [P0] Requirements documented in `spec.md` - explicit hard-fail, next-step persistence, post-010 gate awareness, and evidence reconciliation captured [Evidence: `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/010-perfect-session-capturing/000-dynamic-capture-deprecation/002-outsourced-agent-handback/spec.md`]
- [x] CHK-002 [P0] Technical approach defined in `plan.md` - runtime, CLI-doc, catalog/test, and reconciliation phases documented [Evidence: `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/010-perfect-session-capturing/000-dynamic-capture-deprecation/002-outsourced-agent-handback/plan.md`]
...
- [x] CHK-050 [P1] Temp files remain in `scratch/` only - `scratch/` contains `.gitkeep` [Evidence: `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/010-perfect-session-capturing/000-dynamic-capture-deprecation/002-outsourced-agent-handback/scratch`]

...
| Field | Value |
|-------|-------|
| **Spec Folder** | 017-stateless-quality-gates |
...
| `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/010-perfect-session-capturing/017-stateless-quality-gates --json` | PASS on 2026-03-18 with 0 errors and 0 warnings |

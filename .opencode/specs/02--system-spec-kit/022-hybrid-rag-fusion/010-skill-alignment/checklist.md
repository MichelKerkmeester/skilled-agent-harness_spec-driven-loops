...
- [x] CHK-012 [P1] Local cross-references are written from the `010-skill-alignment` folder context [EVIDENCE: the rewritten docs use `./...` and `../...` paths instead of broken repo-root-relative references]
...
- [x] CHK-040 [P1] `spec.md`, `plan.md`, and `tasks.md` tell the same story about this phase [EVIDENCE: all three documents frame `010` as a draft, documentation-only, pre-implementation phase]

...
- **Evidence:** Completion criterion says "deep-research.md naming only" but packet still contains `research.md` in historical context. This is acceptable but the criterion is overstated.

...
```json
{
  ...
  "spec_folder": ".opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/013-agents-alignment"
}
```
...
- `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/` — sub-spec implementation summaries

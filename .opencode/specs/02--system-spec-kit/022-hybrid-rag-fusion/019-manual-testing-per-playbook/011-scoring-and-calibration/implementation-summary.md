...
Phase 011 (scoring-and-calibration) manual testing documentation packet isolating playbook scenarios for the scoring-and-calibration feature catalog category. The packet maps each assigned test ID to its feature catalog entry and preserves exact prompts, command sequences, evidence expectations, and verdict criteria from the canonical playbook.

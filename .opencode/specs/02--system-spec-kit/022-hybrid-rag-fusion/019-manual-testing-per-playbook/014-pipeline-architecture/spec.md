...
|-----------|-------------|-------------|
| `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/019-manual-testing-per-playbook/014-pipeline-architecture/spec.md` | Create | Level 1 phase specification for the pipeline-architecture manual test slice. |
| `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/019-manual-testing-per-playbook/014-pipeline-architecture/plan.md` | Create | Level 1 execution plan for prompts, scenario flow, evidence, and verdict handling. |
<!-- /ANCHOR:scope -->

...
|-----------|-------------|-------------|
| `019-manual-testing-per-playbook/spec.md` | Create | Parent requirements and phase map anchor |
| `019-manual-testing-per-playbook/plan.md` | Create | Parent implementation and verification plan |
| `019-manual-testing-per-playbook/001-retrieval/spec.md` | Create | Phase 001 test specification |
| `019-manual-testing-per-playbook/001-retrieval/plan.md` | Create | Phase 001 execution plan |
| `019-manual-testing-per-playbook/002-mutation/spec.md` | Create | Phase 002 test specification |
| `019-manual-testing-per-playbook/002-mutation/plan.md` | Create | Phase 002 execution plan |
| `019-manual-testing-per-playbook/003-discovery/spec.md` | Create | Phase 003 test specification |
| `019-manual-testing-per-playbook/003-discovery/plan.md` | Create | Phase 003 execution plan |
| `019-manual-testing-per-playbook/004-maintenance/spec.md` | Create | Phase 004 test specification |
| `019-manual-testing-per-playbook/004-maintenance/plan.md` | Create | Phase 004 execution plan |
| `019-manual-testing-per-playbook/005-lifecycle/spec.md` | Create | Phase 005 test specification |
| `019-manual-testing-per-playbook/005-lifecycle/plan.md` | Create | Phase 005 execution plan |
| `019-manual-testing-per-playbook/006-analysis/spec.md` | Create | Phase 006 test specification |
| `019-manual-testing-per-playbook/006-analysis/plan.md` | Create | Phase 006 execution plan |
| `019-manual-testing-per-playbook/007-evaluation/spec.md` | Create | Phase 007 test specification |
| `019-manual-testing-per-playbook/007-evaluation/plan.md` | Create | Phase 007 execution plan |
| `019-manual-testing-per-playbook/008-bug-fixes-and-data-integrity/spec.md` | Create | Phase 008 test specification |
| `019-manual-testing-per-playbook/008-bug-fixes-and-data-integrity/plan.md` | Create | Phase 008 execution plan |
| `019-manual-testing-per-playbook/009-evaluation-and-measurement/spec.md` | Create | Phase 009 test specification |
| `019-manual-testing-per-playbook/009-evaluation-and-measurement/plan.md` | Create | Phase 009 execution plan |
| `019-manual-testing-per-playbook/010-graph-signal-activation/spec.md` | Create | Phase 010 test specification |
| `019-manual-testing-per-playbook/010-graph-signal-activation/plan.md` | Create | Phase 010 execution plan |
| `019-manual-testing-per-playbook/011-scoring-and-calibration/spec.md` | Create | Phase 011 test specification |
| `019-manual-testing-per-playbook/011-scoring-and-calibration/plan.md` | Create | Phase 011 execution plan |
| `019-manual-testing-per-playbook/012-query-intelligence/spec.md` | Create | Phase 012 test specification |
| `019-manual-testing-per-playbook/012-query-intelligence/plan.md` | Create | Phase 012 execution plan |
| `019-manual-testing-per-playbook/013-memory-quality-and-indexing/spec.md` | Create | Phase 013 test specification |
| `019-manual-testing-per-playbook/013-memory-quality-and-indexing/plan.md` | Create | Phase 013 execution plan |
| `019-manual-testing-per-playbook/014-pipeline-architecture/spec.md` | Create | Phase 014 test specification |
| `019-manual-testing-per-playbook/014-pipeline-architecture/plan.md` | Create | Phase 014 execution plan |
| `019-manual-testing-per-playbook/015-retrieval-enhancements/spec.md` | Create | Phase 015 test specification |
| `019-manual-testing-per-playbook/015-retrieval-enhancements/plan.md` | Create | Phase 015 execution plan |
| `019-manual-testing-per-playbook/016-tooling-and-scripts/spec.md` | Create | Phase 016 test specification |
| `019-manual-testing-per-playbook/016-tooling-and-scripts/plan.md` | Create | Phase 016 execution plan |
| `019-manual-testing-per-playbook/017-governance/spec.md` | Create | Phase 017 test specification |
| `019-manual-testing-per-playbook/017-governance/plan.md` | Create | Phase 017 execution plan |
| `019-manual-testing-per-playbook/018-ux-hooks/spec.md` | Create | Phase 018 test specification |
| `019-manual-testing-per-playbook/018-ux-hooks/plan.md` | Create | Phase 018 execution plan |
| `019-manual-testing-per-playbook/019-feature-flag-reference/spec.md` | Create | Phase 019 test specification |
| `019-manual-testing-per-playbook/019-feature-flag-reference/plan.md` | Create | Phase 019 execution plan |
<!-- /ANCHOR:scope -->
...
- **SC-004**: `validate.sh --recursive` passes on the entire `019-manual-testing-per-playbook/` tree
<!-- /ANCHOR:success-criteria -->

...
- Most remediation items below remain `[ ]` while the broader remediation program is still staged. Six narrow slices are recorded as `[x]` below from fresh evidence, and none changes the overall `FAIL` verdict.

...
| **Phase** | 3 of 8 |
| **Predecessor** | ../010-measurement-foundation/ (direct dependency — Sprint 1 is a parallel sibling, not a predecessor) |
...
- **Predecessor**: See `../010-measurement-foundation/` (direct dependency — Sprint 1 is a parallel sibling)

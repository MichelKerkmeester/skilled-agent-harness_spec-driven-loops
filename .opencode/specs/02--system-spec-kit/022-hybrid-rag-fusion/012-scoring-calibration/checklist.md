...
- [x] CHK-S2-003 [P1] N4 formula confirmed: `0.15 * exp(-elapsed_hours / 12)` — HOW: Verify implementation matches formula; test at key timestamps (0h=0.15, 12h=~0.055, 48h=~0.003). Cross-ref T002. [EVIDENCE: documented in phase spec/plan/tasks artifacts]

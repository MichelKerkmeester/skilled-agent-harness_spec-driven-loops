...
CONTINUATION - Attempt 1 | Spec: `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/005-auto-detected-session-bug` | Last: confirmed wrong session detection behavior | Next: create Level 2 docs, then implement fix
...
3. `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/003-index-tier-anomalies/handover.md` - related context from adjacent remediation.

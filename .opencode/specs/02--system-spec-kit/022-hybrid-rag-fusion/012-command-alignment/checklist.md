...
- [x] CHK-050 [P1] Write scope respected — only canonical files inside `012-command-alignment` were edited in this pass [EVIDENCE: scoped file list remains limited to the five canonical 011 docs]

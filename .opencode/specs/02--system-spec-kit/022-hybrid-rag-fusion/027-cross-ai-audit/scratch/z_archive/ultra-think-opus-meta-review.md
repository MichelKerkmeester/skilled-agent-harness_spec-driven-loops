...
The spec.md for the 022-hybrid-rag-fusion program states "23 MCP tools" in the complexity assessment table (line 124). The actual count is 25. This stale number propagated into the implementation-summary.md ("23 MCP tools" on line 13). None of the models flagged this as a distinct finding from the tool count audit.

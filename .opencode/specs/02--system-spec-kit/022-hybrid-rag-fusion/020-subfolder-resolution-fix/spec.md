...
1. A bare child name like `019-skill-command-alignment` (3 levels deep under `02--system-spec-kit/022-hybrid-rag-fusion/`)
2. A relative path like `02--system-spec-kit/022-hybrid-rag-fusion/019-skill-command-alignment`

Only the full path `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/019-skill-command-alignment` works.
...
1. `node generate-context.js "020-subfolder-resolution-fix"` succeeds (bare name)
...
| **Parent Spec** | ../spec.md |
- Predecessor: `019-skill-command-alignment`

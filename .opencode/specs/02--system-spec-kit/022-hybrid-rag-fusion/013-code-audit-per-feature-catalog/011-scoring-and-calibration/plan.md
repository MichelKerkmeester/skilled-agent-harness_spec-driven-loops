# Phase 011-scoring-and-calibration — Scoring and Calibration — Audit Plan

## Methodology

### Step 1: Feature Inventory
- Read all 17 feature .md files in `feature_catalog/11--scoring-and-calibration/`
- Extract source file lists (Implementation + Tests)
- Map features to manual test playbook scenarios (NEW-050..065+)
...
- Find matching scenarios: NEW-050..065+

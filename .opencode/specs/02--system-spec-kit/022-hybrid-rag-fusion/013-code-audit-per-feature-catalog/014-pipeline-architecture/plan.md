# Phase 014-pipeline-architecture — Pipeline Architecture — Audit Plan

## Methodology

### Step 1: Feature Inventory
- Read all 21 feature .md files in `feature_catalog/14--pipeline-architecture/`
- Extract source file lists (Implementation + Tests)
- Map features to manual test playbook scenarios (EX-005, NEW-070+)
...
- Find matching scenarios: EX-005, NEW-070+

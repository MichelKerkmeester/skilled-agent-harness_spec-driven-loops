# Phase 003-discovery — Discovery — Audit Plan

## Methodology

### Step 1: Feature Inventory
- Read all 3 feature .md files in `feature_catalog/03--discovery/`
- Extract source file lists (Implementation + Tests)
- Map features to manual test playbook scenarios (EX-018..EX-020)
...
- Find matching scenarios: EX-018..EX-020

# Phase 001-retrieval — Retrieval — Audit Plan

## Methodology

### Step 1: Feature Inventory
- Read all 9 feature .md files in `feature_catalog/01--retrieval/`
- Extract source file lists (Implementation + Tests)
- Map features to manual test playbook scenarios (EX-001..EX-009)
...
- Find matching scenarios: EX-001..EX-009

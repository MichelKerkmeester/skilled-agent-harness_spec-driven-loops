# Phase 010-graph-signal-activation — Graph Signal Activation — Audit Plan

## Methodology

### Step 1: Feature Inventory
- Read all 11 feature .md files in `feature_catalog/10--graph-signal-activation/`
- Extract source file lists (Implementation + Tests)
- Map features to manual test playbook scenarios (NEW-035..039, NEW-050+)
...
- Find matching scenarios: NEW-035..039, NEW-050+

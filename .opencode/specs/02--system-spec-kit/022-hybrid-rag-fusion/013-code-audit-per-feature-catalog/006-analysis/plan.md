# Phase 006-analysis — Analysis — Audit Plan

## Methodology

### Step 1: Feature Inventory
- Read all 7 feature .md files in `feature_catalog/06--analysis/`
- Extract source file lists (Implementation + Tests)
- Map features to manual test playbook scenarios (EX-028..EX-031, NEW-*)
...
- Find matching scenarios: EX-028..EX-031, NEW-*

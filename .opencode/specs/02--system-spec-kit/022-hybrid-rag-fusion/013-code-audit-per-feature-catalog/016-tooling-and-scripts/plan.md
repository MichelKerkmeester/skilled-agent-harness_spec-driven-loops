# Phase 016-tooling-and-scripts — Tooling and Scripts — Audit Plan

## Methodology

### Step 1: Feature Inventory
- Read all 8 feature .md files in `feature_catalog/16--tooling-and-scripts/`
- Extract source file lists (Implementation + Tests)
- Map features to manual test playbook scenarios (NEW-090+)
...
- Find matching scenarios: NEW-090+

# Phase 012-query-intelligence — Query Intelligence — Audit Plan

## Methodology

### Step 1: Feature Inventory
- Read all 6 feature .md files in `feature_catalog/12--query-intelligence/`
- Extract source file lists (Implementation + Tests)
- Map features to manual test playbook scenarios (NEW-060+)
...
- Find matching scenarios: NEW-060+

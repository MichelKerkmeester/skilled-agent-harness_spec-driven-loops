...
Spec: `030-architecture-boundary-remediation` (archived under `012-architecture-audit/scratch/merged-030-architecture-boundary-remediation`)
...
1. Created `decision-record.md` at:
   `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/012-architecture-audit/scratch/merged-030-architecture-boundary-remediation/decision-record.md`

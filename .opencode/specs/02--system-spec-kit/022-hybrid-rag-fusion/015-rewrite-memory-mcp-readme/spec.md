...
---
<!-- SPECKIT_LEVEL: 1 -->
# Specification: 015-rewrite-memory-mcp-readme
...
- INSTALL_GUIDE.md (owned by sibling spec `016-update-install-guide`)
- Spec Kit README (owned by `017-rewrite-system-speckit-readme`)
- Command documentation (completed by `011-command-alignment`)

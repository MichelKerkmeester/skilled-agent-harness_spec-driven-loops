...
---
<!-- SPECKIT_LEVEL: 1 -->
# Specification: 021-rewrite-system-speckit-readme
...
- MCP server README (owned by `020-rewrite-memory-mcp-readme`)
- Root README (owned by `022-rewrite-repo-readme`)
- Command documentation content (completed by `016-command-alignment`)
...
<!--
SPEC: 021-rewrite-system-speckit-readme

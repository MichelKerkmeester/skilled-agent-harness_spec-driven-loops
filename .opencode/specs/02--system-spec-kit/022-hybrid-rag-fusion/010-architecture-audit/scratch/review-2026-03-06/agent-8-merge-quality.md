...
**No JSON files** (`descriptions.json`, etc.) contain orphaned 030 references. The only "030" entries in `descriptions.json` are unrelated specs (`01--anobel.com/030-label-product-content-attr` and a `z_archive/030-gate3-enforcement`).

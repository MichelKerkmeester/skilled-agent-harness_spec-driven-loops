...
* **Reality:** `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/010-architecture-audit/scratch/ast-parsing-evaluation.md` documents a detailed evaluation on migrating parsing from Regex to TS Compiler or ESTree architectures.
* **Verdict:** ACCURATE

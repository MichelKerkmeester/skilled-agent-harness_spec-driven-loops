...
### Q2: Restart procedure for NEW-097 requeue verification
...
### Q3: Evidence format for NEW-124 DB parity checks
...
| 3 | NEW-097 | Non-destructive | ingest_start → ingest_status → ingest_cancel | Seed files |
| 4 | NEW-114 | Non-destructive | ingest_start (invalid + valid paths) | Seed files |
| 5 | NEW-134 | Non-destructive | Code analysis only | None |
| 6 | NEW-144 | Non-destructive | ingest_start → ingest_status | Seed files |
...
| 9 | NEW-124 | Destructive | Code analysis only | Pre-test checkpoint |

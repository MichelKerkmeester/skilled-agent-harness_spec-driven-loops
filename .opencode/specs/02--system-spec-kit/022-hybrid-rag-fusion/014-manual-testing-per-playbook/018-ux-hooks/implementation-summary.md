...
| 106 | Hooks barrel + README synchronization | **PASS** | All | `index.ts:13` → `mutation-feedback`; `index.ts:18` → `response-hints`; `README.md:30–31` name both modules; `README.md:56` → `MutationHookResult`; `README.md:58` → `postMutationHooks` |
...
| 106 Hooks barrel + README sync | PASS — all 4 terms confirmed in `hooks/index.ts` and `hooks/README.md` |

...
- [x] CHK-004 [P0] Target spec folder for EX-014 identified (at least one markdown file) — `02--system-spec-kit/022-hybrid-rag-fusion/014-manual-testing-per-playbook/004-maintenance/` contains multiple markdown files
<!-- /ANCHOR:pre-impl -->

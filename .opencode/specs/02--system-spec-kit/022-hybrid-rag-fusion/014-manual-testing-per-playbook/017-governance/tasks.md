...
- [x] T003 [P] Prepare sandbox prerequisites, baseline DB config snapshot, and evidence capture checklist for `plan.md`
<!-- /ANCHOR:phase-1 -->
...
- [x] T007 Add evidence references and verdict outcomes after manual execution
- [x] T008 [P] Resolve open questions for 122 disposable tenant IDs and 148 MCP restart isolation strategy
<!-- /ANCHOR:phase-2 -->
...
- [x] T009 Run the five Phase 017 scenarios following `plan.md`

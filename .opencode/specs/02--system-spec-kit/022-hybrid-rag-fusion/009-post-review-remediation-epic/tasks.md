...
- [x] T001 [P] Schema & DB fixes — P0-1, P0-2, P1-10 (`vector-index-impl.ts`, `reconsolidation.vitest.ts`)
- [x] T002 [P] Pipeline V2 integration — P1-3, P1-4 (`memory-search.ts`, `mmr-reranker.ts`, `co-activation.ts`)
- [x] T003 [P] Memory save SQL dedup — P1-5 (`memory-save.ts`)
- [x] T004 [P] Search subsystem fixes — P1-6, P1-8, P1-9 (`query-expander.ts`, `graph-search-fn.ts`, `co-activation.ts`)
- [x] T005 [P] Eval metrics fix — P1-7 (`eval-metrics.ts`)
<!-- /ANCHOR:phase-1 -->
...
- [x] T006 [P] Error handling — P1-11, P1-12 (5 files + `stage3-rerank.ts`)
- [x] T007 [P] Comment standards — P1-13, P1-16 (`save-quality-gate.ts`)
- [x] T008 [P] Import & comment cleanup — P1-14, P1-15 (`memory-context.ts`, `hybrid-search.ts`, `memory-save.ts`)
- [x] T009 [P] Section dividers — P1-17 (`composite-scoring.ts`, `tool-schemas.ts`)
- [x] T010 [P] Documentation fixes — P1-18, P1-20, P1-21 (`summary_of_*.md`)
<!-- /ANCHOR:phase-2 -->
...
- [x] T011 TypeScript compilation passes (`tsc --noEmit`)
- [x] T012 Full test suite passes (`npm test`)
- [x] T013 Build check passes (`npm run build`) — N/A (no build script; server runs TS directly)
- [x] T014 MCP smoke test passes
<!-- /ANCHOR:phase-3 -->
...
- [x] `implementation-summary.md` filled

...
| Direct indexing proof | Built runtime packet indexing under corrected Voyage env | PASS (`handleMemoryIndexScan` for `02--system-spec-kit/022-hybrid-rag-fusion/008-combined-bug-fixes` -> `failed: 0`) |
...
| Area | Current Truth |
| --- | --- |
| Canonical scope | `008-combined-bug-fixes` is the active remediation folder with merged 009/010 historical context. |
...
| TASK-SCOPE | Do not modify files outside `008-combined-bug-fixes`. |

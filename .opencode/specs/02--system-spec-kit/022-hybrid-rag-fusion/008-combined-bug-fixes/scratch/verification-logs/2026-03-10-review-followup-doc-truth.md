...
- `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/008-combined-bug-fixes/spec.md`
- `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/008-combined-bug-fixes/tasks.md`
- `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/008-combined-bug-fixes/checklist.md`
- `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/008-combined-bug-fixes/decision-record.md`
- `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/008-combined-bug-fixes/handover.md`
...
- Updated `decision-record.md` so `008-combined-bug-fixes` is the only live canonical folder and source 015/016 status is described truthfully.
...
- Command: `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/008-combined-bug-fixes`

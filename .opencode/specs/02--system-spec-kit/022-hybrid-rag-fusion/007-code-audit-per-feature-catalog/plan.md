...
| **Storage** | Repository spec-folder files under `007-code-audit-per-feature-catalog/` |
...
| Integration | Parent-child markdown integrity across all phases | `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh --recursive .../007-code-audit-per-feature-catalog` |

...
- [x] CHK-012 [P1] Discrepancies documented with evidence — T001 (channelId fallback traceability gap), T008 (iterative replacement coverage)
...
- [x] CHK-021 [P0] All findings categorized (match/mismatch/gap) — 9 MATCH, 2 PARTIAL, 0 MISMATCH

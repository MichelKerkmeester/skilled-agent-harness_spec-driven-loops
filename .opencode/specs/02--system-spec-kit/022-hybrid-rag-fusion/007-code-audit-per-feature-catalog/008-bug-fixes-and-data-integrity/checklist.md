...
- [x] CHK-001 [P0] Requirements documented in `spec.md` [EVIDENCE: `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/007-code-audit-per-feature-catalog/008-bug-fixes-and-data-integrity/spec.md`]
- [x] CHK-002 [P0] Technical approach documented in `plan.md` [EVIDENCE: `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/007-code-audit-per-feature-catalog/008-bug-fixes-and-data-integrity/plan.md`]
...
- [x] CHK-015 [P0] Packet artifact cleanup completed [EVIDENCE: `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/007-code-audit-per-feature-catalog/005-lifecycle/.DS_Store` absent]
<!-- /ANCHOR:code-quality -->
...
- [x] CHK-033 [P1] Discovery task doc uses concrete path references (no stale brace/glob placeholders) [EVIDENCE: `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/007-code-audit-per-feature-catalog/003-discovery/tasks.md`]
...
- [x] CHK-041 [P2] Context saved to memory via `generate-context.js` [EVIDENCE: `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/007-code-audit-per-feature-catalog/008-bug-fixes-and-data-integrity/memory/14-03-26_10-42__closed-deferred-context-save-item-after-final.md`]
<!-- /ANCHOR:file-org -->

...
| **Storage** | Spec-folder markdown under `007-code-audit-per-feature-catalog/` |
...
|-----------|-------|-------|
| Structural validation | Parent + child markdown integrity | `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/007-code-audit-per-feature-catalog --recursive` |

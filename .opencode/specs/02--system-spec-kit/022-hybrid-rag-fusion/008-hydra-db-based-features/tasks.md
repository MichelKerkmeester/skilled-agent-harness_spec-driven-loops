...
- [x] T004 [W:FOUNDATION] Related feature-catalog planning baseline reviewed (`../006-feature-catalog/spec.md`, `../006-feature-catalog/plan.md`, `../006-feature-catalog/tasks.md`)

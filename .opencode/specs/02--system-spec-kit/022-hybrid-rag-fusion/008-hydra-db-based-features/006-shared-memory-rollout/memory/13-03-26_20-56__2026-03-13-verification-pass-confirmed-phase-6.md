...
| **File** | **Description** |
|:---------|:----------------|
| `02--system-spec-kit/022-hybrid-rag-fusion/008-hydra-db-based-features/006-shared-memory-rollout/(merged-small-files)` | Tree-thinning merged `tasks.md`, `checklist.md`, and `implementation-summary.md` from this phase folder into one synthetic summary entry. |
<!-- /ANCHOR:summary -->

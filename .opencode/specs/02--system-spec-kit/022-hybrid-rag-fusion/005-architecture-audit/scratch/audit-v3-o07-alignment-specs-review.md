...
- **Location**: `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/011-skill-alignment/001-post-session-capturing-alignment/`
...
- **Severity**: LOW
- **Category**: alignment
- **Location**: `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/014-agents-md-alignment/spec.md` line 45, `plan.md` line 3, `implementation-summary.md` lines 3, 15
...
- **Severity**: LOW
- **Category**: alignment
- **Location**: `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/011-skill-alignment/implementation-summary.md` lines 14, 95
...
- **Severity**: LOW
- **Category**: architecture
- **Location**: `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/013-agents-alignment/` and `014-agents-md-alignment/`
...
- **Severity**: LOW
- **Category**: completeness
- **Location**: `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/011-skill-alignment/checklist.md` line 109

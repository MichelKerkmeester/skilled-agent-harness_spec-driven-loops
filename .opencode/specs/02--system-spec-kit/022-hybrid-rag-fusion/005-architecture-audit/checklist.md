...
- [x] CHK-040 [P1] Level 3 docs exist in this folder: `spec.md`, `plan.md`, `tasks.md`, `checklist.md`, `decision-record.md`. [EVIDENCE: all 5 files present in `005-architecture-audit/` directory listing]
...
- [x] CHK-112 [P2] Spec folder docs pass recursive validation (`validate.sh --recursive`). [EVIDENCE: T038 completed; `validate.sh --recursive 005-architecture-audit` passed with 0 errors and 0 warnings]
<!-- /ANCHOR:docs-verify -->
...
- [x] CHK-215 [P1] `.opencode/skill/system-spec-kit/scripts/evals/README.md` documents all eval-scope exceptions. [EVIDENCE: both `run-performance-benchmarks.ts` and `deleted-chk210-quality-backfill-script` listed]

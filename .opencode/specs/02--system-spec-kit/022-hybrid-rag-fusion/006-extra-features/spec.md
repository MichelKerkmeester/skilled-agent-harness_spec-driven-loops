...
**Acceptance Criteria**:
1. Given a memory in `022-hybrid-rag-fusion/024-timer-persistence-stage3-fallback/`, When returned by `memory_search`, Then the content is prefixed with `[022-hybrid-rag-fusion > 024-timer-persistence-stage3-fallback — description]`

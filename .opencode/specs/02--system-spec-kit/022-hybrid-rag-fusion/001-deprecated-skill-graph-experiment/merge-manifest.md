...
| `002-unified-graph-intelligence/` | Historical unified graph adapter/integration outcomes and status captured in `013/implementation-summary.md` and this manifest | `z_archive/skill-graph-legacy/002-unified-graph-intelligence/` |
...
| `004-skill-graph-improvement/` | Gap-fix and benchmark recovery context captured in this manifest and `013/implementation-summary.md` | `z_archive/skill-graph-legacy/004-skill-graph-improvement/` |
| `002-skill-graph-score-recovery/` | Milestone 3.5 score-recovery context and additive strict re-score references captured in this manifest and `013/implementation-summary.md` | `z_archive/skill-graph-legacy/002-skill-graph-score-recovery/` |

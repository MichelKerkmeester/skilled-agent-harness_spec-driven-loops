...
|------|----------|----------|----------|-------------|----------|
| 1 | ISS-A07-ALL | Spec Compliance | P0 | 007-ux-hooks claims 100% but only 52% verifiable — 10 false completions with boilerplate evidence | 006-ux-hooks-automation |
...
| 10 | ISS-A09-STALE | Spec Compliance | P1 | 009-arch-audit: 2/9 sampled findings stale — ARCHITECTURE_BOUNDARIES.md cited but doesn't exist, allowlist mismatch | 008-architecture-audit |

...
- Existing adjacent folders that do resolve include `007-combined-bug-fixes` and `011-feature-catalog`, but the epic documentation does not consistently reference the current child-folder names.

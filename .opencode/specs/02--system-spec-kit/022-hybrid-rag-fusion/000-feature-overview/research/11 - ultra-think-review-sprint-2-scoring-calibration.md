...
<!-- PARENT_SPEC: ../012-scoring-calibration/spec.md -->
...
|----------|------|--------------|
| Sprint 2 Spec | `012-scoring-calibration/spec.md` | Primary source |
| Sprint 2 Plan | `012-scoring-calibration/plan.md` | Implementation plan |
| Sprint 2 Tasks | `012-scoring-calibration/tasks.md` | Task breakdown |
| Sprint 2 Checklist | `012-scoring-calibration/checklist.md` | Verification checklist |
| Parent Spec | `../000-feature-overview/spec.md` | Parent 140 specification |
...
| Sprint 3 Spec | `013-query-intelligence/spec.md` | Successor (normalization feed-forward) |

...
**Spec Folder**: `02--system-spec-kit/022-hybrid-rag-fusion/011-graph-signal-activation/`
...
|----------|------|-------------|
| Sprint 1 Spec | `011-graph-signal-activation/spec.md` | `requirements`, `risks`, `nfr`, `edge-cases` |
| Sprint 1 Plan | `011-graph-signal-activation/plan.md` | `phases`, `effort`, `phase-deps`, `architecture` |
| Sprint 1 Tasks | `011-graph-signal-activation/tasks.md` | `phase-1`, `phase-2`, `phase-3`, `completion` |
| Sprint 1 Checklist | `011-graph-signal-activation/checklist.md` | `code-quality`, `testing`, `pre-impl` |
| Parent Spec | `022-hybrid-rag-fusion/spec.md` | Sprint roadmap, cross-sprint dependencies |
| Sprint 0 (Predecessor) | `010-measurement-foundation/` | Exit gate, eval infrastructure, BM25 baseline |
| Sprint 2 (Parallel) | `012-scoring-calibration/` | R18, N4, G2, normalization — zero dependency on Sprint 1 |

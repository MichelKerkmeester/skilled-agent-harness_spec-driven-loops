...
| Field | Value |
|-------|-------|
| **Spec Folder** | 006-ux-hooks-automation |
...
- `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/006-ux-hooks-automation/tasks.md` and `checklist.md` - Captured implementation progress, review-driven fixes, and current verification state.

...
```
/spec_kit:resume ../.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/003-index-tier-anomalies
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: ../.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/003-index-tier-anomalies
Last: Tool: bash
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume ../.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/003-index-tier-anomalies` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "../.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/003-index-tier-anomalies" })` |
...
memory_search({ specFolder: "../.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/003-index-tier-anomalies", limit: 10 })

# Verify memory file integrity
ls -la ../.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/003-index-tier-anomalies/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js ../.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/003-index-tier-anomalies --force
```
...
spec_folder: "../.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/003-index-tier-anomalies"
channel: "main"
...
parent_spec: "../.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/003-index-tier-anomalies"
child_sessions:

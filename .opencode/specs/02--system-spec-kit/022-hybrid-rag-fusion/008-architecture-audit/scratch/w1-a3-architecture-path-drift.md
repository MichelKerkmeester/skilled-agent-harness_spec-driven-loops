...
|---|------|-------------|---------|
| 1 | `008-architecture-audit/scratch/cross-ai-review-2026-03-05/gemini-gamma-checklist-verification.md` | 4 | Review artifact from 2026-03-05 |
| 2 | `008-architecture-audit/scratch/cross-ai-review-2026-03-05/codex-beta-enforcement-robustness.md` | 3 | Review artifact from 2026-03-05 |
| 3 | `008-architecture-audit/scratch/cross-ai-review-2026-03-05/codex-alpha-implementation-integrity.md` | 2 | Review artifact from 2026-03-05 |
| 4 | `008-architecture-audit/scratch/cross-ai-review-2026-03-05/gemini-alpha-adr-quality.md` | 1 | Review artifact from 2026-03-05 |
| 5 | `008-architecture-audit/scratch/cross-ai-review-2026-03-05/gemini-epsilon-risk-analysis.md` | 2 | Review artifact from 2026-03-05 |
| 6 | `008-architecture-audit/scratch/cross-ai-review-2026-03-05/codex-epsilon-cross-spec-continuity.md` | 1 | Review artifact from 2026-03-05 |
| 7 | `008-architecture-audit/scratch/review-2026-03-06/agent-6-cross-ai-remediation.md` | 2 | Review artifact from 2026-03-06 |
| 8 | `008-architecture-audit/scratch/review-2026-03-06/agent-4-adr-quality.md` | 1 | Review artifact from 2026-03-06 |
| 9 | `008-architecture-audit/scratch/review-2026-03-06/agent-8-merge-quality.md` | 1 | Review artifact from 2026-03-06 |
| 10 | `008-architecture-audit/scratch/review-2026-03-06/agent-9-evidence-audit.md` | 1 | Review artifact from 2026-03-06 |
| 11 | `008-architecture-audit/scratch/review-2026-03-06/agent-10-risk-debt.md` | 3 | Review artifact from 2026-03-06 |
| 12 | `008-architecture-audit/scratch/review-2026-03-06/agent-3-checklist-integrity.md` | 2 | Review artifact from 2026-03-06 |
| 13 | `008-architecture-audit/scratch/merged-030-architecture-boundary-remediation/spec.md` | 3 | Archived merged spec |
| 14 | `008-architecture-audit/scratch/merged-030-architecture-boundary-remediation/plan.md` | 2 | Archived merged plan |
| 15 | `008-architecture-audit/scratch/merged-030-architecture-boundary-remediation/tasks.md` | 2 | Archived merged tasks |
| 16 | `008-architecture-audit/scratch/merged-030-architecture-boundary-remediation/checklist.md` | 1 | Archived merged checklist |
| 17 | `008-architecture-audit/scratch/architecture-audit-report.md` | 1 | Original audit report |
| 18 | `008-architecture-audit/memory/06-03-26_11-58__phase-8-architecture-boundaries.md` | 8+ | Memory file (auto-generated) |
...
- The **core documents are already fixed**: `checklist.md`, `tasks.md`, `implementation-summary.md`, `decision-record.md`, and `spec.md` within 008-architecture-audit all use the correct `ARCHITECTURE.md` filename.

...
- [x] T038 Run `validate.sh --recursive` and fix any remaining validation issues - WHY: CHK-112 [P2] was deferred; ensures spec folder docs pass structural validation - Acceptance: CHK-112 verifiable with passing exit code. [DONE: `validate.sh --recursive 029-architecture-audit` → 0 errors, 0 warnings, PASSED]

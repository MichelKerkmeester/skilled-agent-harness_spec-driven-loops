...
| Agent | Tasks | Scope |
|-------|-------|-------|
| Codex-1 | T019, T022, T023 | 030/spec.md — CI mandate, path fixes, SC-001 |
...
| File | Change |
|------|--------|
| `030/spec.md` | CI mandate, SC-001 strengthened, paths fixed, open question resolved |
...
| `029/spec.md` | §4.5 Requirement-Task Traceability table added |

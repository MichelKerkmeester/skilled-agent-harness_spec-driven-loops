...
| **Source** | Cross-AI review (spec 030, Phase 0) |
...
See 029-architecture-audit/decision-record.md ADR-004 for the original analysis. Both ADRs accept the same P2 AST-upgrade timeline.
...
- Add this ADR for T020 completion evidence in spec 030.

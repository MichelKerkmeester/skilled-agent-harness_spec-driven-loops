...
- **ISS-A10-002:** `010-spec-descriptions` is missing `implementation-summary.md`, so its Level 2 file set is incomplete.
- **ISS-A10-003:** `010-spec-descriptions/tasks.md` is completely unchecked despite checklist claims of meaningful progress.
...
2. Add `implementation-summary.md` to **010-spec-descriptions** and reconcile `tasks.md` with the checklist so both trackers describe the same state.

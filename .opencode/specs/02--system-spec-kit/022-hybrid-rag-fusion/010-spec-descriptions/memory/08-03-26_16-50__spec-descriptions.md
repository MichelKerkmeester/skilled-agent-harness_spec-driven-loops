---
title: "Spec Descriptions [010-spec-descriptions/08-03-26_16-50__spec-descriptions]"
...
| Session ID | session-1772985015107-9zy85oxg8 |
| Spec Folder | 02--system-spec-kit/022-hybrid-rag-fusion/010-spec-descriptions |
| Channel | main |
...
| Created At (Epoch) | 1772985015 |
| Last Accessed (Epoch) | 1772985015 |
| Access Count | 1 |
...
```
/spec_kit:resume 02--system-spec-kit/022-hybrid-rag-fusion/010-spec-descriptions
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: 02--system-spec-kit/022-hybrid-rag-fusion/010-spec-descriptions
Last: Tool: bash
...
**Key Topics:** `spec` | `system` | `memory` | `skill graph` | `system spec kit/022 hybrid rag fusion/010 spec descriptions` | `skill` | `graph` | `kit/022` | `hybrid` | `rag` | `fusion/010` | `descriptions` | 
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 02--system-spec-kit/022-hybrid-rag-fusion/010-spec-descriptions` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "02--system-spec-kit/022-hybrid-rag-fusion/010-spec-descriptions" })` |
...
memory_search({ specFolder: "02--system-spec-kit/022-hybrid-rag-fusion/010-spec-descriptions", limit: 10 })

# Verify memory file integrity
ls -la 02--system-spec-kit/022-hybrid-rag-fusion/010-spec-descriptions/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js 02--system-spec-kit/022-hybrid-rag-fusion/010-spec-descriptions --force
```
...
```yaml
# Core Identifiers
session_id: "session-1772985015107-9zy85oxg8"
spec_folder: "02--system-spec-kit/022-hybrid-rag-fusion/010-spec-descriptions"
channel: "main"
...
created_at_epoch: 1772985015
last_accessed_epoch: 1772985015
...
key_topics:
  ...
  - "memory"
  - "skill graph"
  - "system spec kit/022 hybrid rag fusion/010 spec descriptions"
  - "skill"
  - "graph"
  - "kit/022"
  - "hybrid"
...
# Trigger Phrases (auto-extracted for fast 

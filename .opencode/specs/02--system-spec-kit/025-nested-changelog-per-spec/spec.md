---
title: "Feature Specification: Nested Changelog Per Spec [02--system-spec-kit/025-nested-changelog-per-spec/spec]"
...
- **Given** `/spec_kit:implement` or `/spec_kit:complete` targets a packet-aware folder, **When** the closeout steps are followed, **Then** they instruct nested changelog generation in addition to `.opencode/specs/02--system-spec-kit/025-nested-changelog-per-spec/implementation-summary.md`.

---
title: "Tasks: Nested Changelog Per Spec [02--system-spec-kit/025-nested-changelog-per-spec/tasks]"
...
- Confirm work stays inside `.opencode/specs/02--system-spec-kit/025-nested-changelog-per-spec/`
- Confirm packet-local nested changelog output remains additive to `.opencode/specs/02--system-spec-kit/025-nested-changelog-per-spec/implementation-summary.md`
...
- [x] T001 Review packet-local changelog examples in `024-compact-code-graph/changelog` (`.opencode/specs/02--system-spec-kit/024-compact-code-graph/changelog/`)
...
- [x] T015 Update packet `025` documentation to match the shipped workflow (`.opencode/specs/02--system-spec-kit/025-nested-changelog-per-spec/`)
<!-- /ANCHOR:phase-3 -->

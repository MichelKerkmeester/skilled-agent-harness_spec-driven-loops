...
trigger_phrases:
  ...
  - "upgrade auto populate"
  - "archive"
  - "validation"
importance_tier: "normal"
contextType: "general"
---
# Feature Specification: Upgrade Auto Populate
...
| **Status** | Complete |
| **Created** | 2026-03-31 |
| **Branch** | `011-upgrade-auto-populate` |
<!-- /ANCHOR:metadata -->
...
### Problem Statement
This archived system-spec-kit archive folder captures work related to Upgrade Auto Populate. The earlier markdown drifted away from the active templates, which caused validator failures and made the archive harder to trust.
...
### In Scope
- Preserve the archived topic and folder identity for Upgrade Auto Populate.
...
|----|-------------|---------------------|
| REQ-001 | The archive must clearly state that the folder documents Upgrade Auto Populate. | A maintainer can identify the archived topic from spec.md without opening other files. |

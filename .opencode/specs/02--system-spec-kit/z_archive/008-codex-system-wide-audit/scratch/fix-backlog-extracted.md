...
**Target Path(s):**  
- Either create missing directory: `.opencode/specs/02--system-spec-kit/z_archive/004-script-audit-comprehensive/` with documentation
- OR delete orphaned memory entry via: `memory_delete({ specFolder: "02--system-spec-kit/z_archive/004-script-audit-comprehensive" })`
...
4. `.opencode/specs/02--system-spec-kit/z_archive/006-generate-context-subfolder/scratch/build-output.txt` (NEW)
   - Evidence log from TypeScript build
5. `.opencode/specs/02--system-spec-kit/z_archive/006-generate-context-subfolder/scratch/test-results.txt` (NEW)
   - Evidence log from test suite
6. `.opencode/specs/02--system-spec-kit/z_archive/006-generate-context-subfolder/scratch/manual-verification.txt` (NEW)
   - Evidence log from manual format checks
7. `.opencode/specs/02--system-spec-kit/z_archive/004-script-audit-comprehensive/` (CONDITIONAL)
...
1. Spec 121 disposition decision:
   ...
   - Path B: Delete orphaned memory via `memory_delete({ specFolder: "02--system-spec-kit/z_archive/004-script-audit-comprehensive" })`

...
## Scope
- Sources synthesized:
  - `.opencode/specs/02--system-spec-kit/z_archive/008-codex-system-wide-audit/scratch/context-121-audit.md`
  - `.opencode/specs/02--system-spec-kit/z_archive/008-codex-system-wide-audit/scratch/context-123-audit.md`
  - `.opencode/specs/02--system-spec-kit/z_archive/008-codex-system-wide-audit/scratch/context-124-audit.md`
  - `.opencode/specs/02--system-spec-kit/z_archive/008-codex-system-wide-audit/scratch/context-cross-spec-lineage.md`
  - `.opencode/specs/02--system-spec-kit/z_archive/008-codex-system-wide-audit/scratch/context-typo-path-resolution.md`
...
3. **Resolve Spec 121 orphaned memory/filesystem mismatch**
   ...
   - Targets: either create `.opencode/specs/02--system-spec-kit/z_archive/004-script-audit-comprehensive/` docs, or perform memory cleanup.
...
5. **Spec 123 completion gate: verify and mark all P0 checklist items**
   ...
   - Target: `.opencode/specs/02--system-spec-kit/z_archive/006-generate-context-subfolder/checklist.md`.
...
4. Reconcile Spec 123 process/documentation contradictions (tasks/checklist/summary).
   - Targets:
     - `.opencode/specs/02--system-spec-kit/z_archive/006-generate-context-subfolder/tasks.md`
     - `.opencode/specs/02--system-spec-kit/z_archive/006-generate-context-subfolder/checklist.md`
     - `.opencode/specs/02--system-spec-kit/z_archive/006-generate-context-subfolder/implementation-summary.md`
...
5. Populate Spec 123 `scratch/` with verification evidence logs.
   - Target directory: `.opencode/specs/02--system-spec-kit/z_archive/006-generate-context-subfolder/scratch/`.
...
1. `.opencode/specs/02--system-spec-kit/z_archive/006-generate-context-subfolder/checklist.md`
2. `.opencode/specs/02--system-spec-kit/z_archive/006-generate-context-subfolder/tasks.md`
3. `.opencode/specs/02--system-spec-kit/z_archive/006-generate-context-subfolder/implementation-summary.md`
4. `.opencode/specs/02--system-spec-kit/z_archive/006-generate-context-subfolder/scratch/build-output.txt` (new evidence log)
5. `.opencode/specs/02--system-spec-kit/z_archive/006-generate-context-subfolder/scratch/test-results.txt` (new evidence log)
6. `.opencode/specs/02--system-spec-kit/z_archive/006-generate-context-subfolder/scratch/manual-verification.txt` (new evidence log)
7. `.opencode/specs/02--system-spec-kit/z_archive/004-script-audit-comprehensive/` (restore path, if restoration decision chosen)
...
```bash
cd .opencode/skill/system-spec-kit/scripts && node scripts/dist/memory/generate-context.js 02--system-spec-kit/z_archive/006-generate-context-subfolder && node scripts/dist/memory/generate-context.js 123-generate-context-subfolder && node scripts/dist/memory/generate-context.js specs/02--system-spec-kit/z_archive/006-generate-context-subfolder
```

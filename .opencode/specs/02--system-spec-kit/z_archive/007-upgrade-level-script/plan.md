...
### Overview
This archive repair keeps the original level upgrade script topic but reduces the folder to a clean Level 1 archive package. The plan is to restore the core documents and validate until the folder reports zero errors.
<!-- /ANCHOR:summary -->

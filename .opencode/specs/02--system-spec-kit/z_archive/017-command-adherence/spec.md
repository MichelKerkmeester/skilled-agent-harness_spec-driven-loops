...
contextType: "general"
---
# Feature Specification: Command Adherence
...
### Problem Statement
This archived system-spec-kit archive folder captures work related to Command Adherence. The earlier markdown drifted away from the active templates, which caused validator failures and made the archive harder to trust.
...
### In Scope
- Preserve the archived topic and folder identity for Command Adherence.
...
|----|-------------|---------------------|
| REQ-001 | The archive must clearly state that the folder documents Command Adherence. | A maintainer can identify the archived topic from spec.md without opening other files. |

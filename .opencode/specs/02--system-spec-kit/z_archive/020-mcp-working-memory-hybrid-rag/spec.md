...
| **Status** | Complete |
| **Created** | 2026-03-31 |
| **Branch** | `020-mcp-working-memory-hybrid-rag` |
<!-- /ANCHOR:metadata -->
...
### In Scope
- Preserve the archived topic and folder identity for MCP Working Memory Hybrid Rag.
...
|----|-------------|---------------------|
| REQ-001 | The archive must clearly state that the folder documents MCP Working Memory Hybrid Rag. | A maintainer can identify the archived topic from spec.md without opening other files. |

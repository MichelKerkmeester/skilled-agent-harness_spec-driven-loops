...
The archived child phase for Post Research Wave 3 Outcome Confirmation used an older phase-package structure that no longer matched the active validator expectations. We needed to preserve the phase while removing error-level drift.

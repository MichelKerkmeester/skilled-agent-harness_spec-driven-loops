...
### Overview
This archive repair keeps the original full spec document indexing topic but reduces the folder to a clean Level 1 archive package. The plan is to restore the core documents, retain a brief handover note, and validate until the folder reports zero errors.
<!-- /ANCHOR:summary -->

...
trigger_phrases:
  ...
  - "readme and summary with hvr"
  - "archive"
  - "validation"
importance_tier: "normal"
contextType: "general"
---
# Feature Specification: Readme And Summary With HVR
...
| **Status** | Complete |
| **Created** | 2026-03-31 |
| **Branch** | `019-readme-and-summary-with-hvr` |
<!-- /ANCHOR:metadata -->
...
### Problem Statement
This archived system-spec-kit archive folder captures work related to Readme And Summary With HVR. The earlier markdown drifted away from the active templates, which caused validator failures and made the archive harder to trust.
...
### In Scope
- Preserve the archived topic and folder identity for Readme And Summary With HVR.
...
|----|-------------|---------------------|
| REQ-001 | The archive must clearly state that the folder documents Readme And Summary With HVR. | A maintainer can identify the archived topic from spec.md without opening other files. |

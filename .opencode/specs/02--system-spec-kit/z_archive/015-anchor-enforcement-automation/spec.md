...
| **Status** | Complete |
| **Created** | 2026-03-31 |
| **Branch** | `015-anchor-enforcement-automation` |
<!-- /ANCHOR:metadata -->
...
### Problem Statement
This archived system-spec-kit archive folder captures work related to Anchor Enforcement Automation. The earlier markdown drifted away from the active templates, which caused validator failures and made the archive harder to trust.
...
### In Scope
- Preserve the archived topic and folder identity for Anchor Enforcement Automation.
...
|----|-------------|---------------------|
| REQ-001 | The archive must clearly state that the folder documents Anchor Enforcement Automation. | A maintainer can identify the archived topic from spec.md without opening other files. |

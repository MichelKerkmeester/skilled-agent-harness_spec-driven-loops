...
**Spec Folder**: `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/072-speckit-template-memory-ranking-release`
...
**Spec Path**: `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/069-speckit-template-complexity`
...
**Test File**: `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/069-speckit-template-complexity/tests/test-detector.js`
...
**Test File**: `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/069-speckit-template-complexity/tests/test-classifier.js`
...
**Test File**: `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/069-speckit-template-complexity/tests/test-marker-parser.js`
...
**Test File**: `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/069-speckit-template-complexity/tests/test-preprocessor.js`
...
**Test File**: `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/069-speckit-template-complexity/tests/test-cli.sh`
...
**Spec Path**: `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/070-memory-ranking`
...
**Test File**: `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/070-memory-ranking/test/test-folder-scoring.js`
...
**Spec Path**: `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/071-speckit-level-alignment`
...
```bash
cd .opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/069-speckit-template-complexity
bash tests/run-tests.sh
```

### Run All Spec 070 Tests
```bash
cd .opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/070-memory-ranking

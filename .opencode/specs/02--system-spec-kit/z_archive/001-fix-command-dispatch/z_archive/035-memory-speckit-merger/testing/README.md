...
```bash
# From project root
..opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/035-memory-speckit-merger/testing/test-suite.sh
```
...
```bash
..opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/035-memory-speckit-merger/testing/memory-restart.sh
```
...
```bash
..opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/035-memory-speckit-merger/testing/rollback.sh
```
<!-- /ANCHOR:how-to-run-tests -->

...
grep -rn "week" .opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/082-speckit-reimagined --include="*.md"
```
...
**Validation:**
```bash
grep -n "TASK-HALT" .opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/082-speckit-reimagined/tasks.md
```
...
**Validation:**
```bash
grep -n "TASK-FAIL\|Recovery Protocol" .opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/082-speckit-reimagined/tasks.md
```
...
**Validation:**
```bash
grep -n "Evidence Log" .opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/082-speckit-reimagined/checklist.md | wc -l
...
grep -c "\[P0\]" .opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/082-speckit-reimagined/checklist.md
# Before: 69, After: 66
```
...
**Validation:**
```bash
head -3 .opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/082-speckit-reimagined/implementation-summary.md
```
...
**Validation:**
```bash
grep -n "SKILL TRIGGERS\|Trigger Phrase" .opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/082-speckit-reimagined/spec.md
```

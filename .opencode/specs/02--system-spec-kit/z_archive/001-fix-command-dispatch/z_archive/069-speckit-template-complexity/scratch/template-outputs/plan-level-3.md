...
<!-- For Level 2: Table format -->
<!-- COMPLEXITY_GATE: level>=2, level<=2 -->
...
Legend: ──▶ Sequential | ─ ─▶ Parallel | ◄── Sync
```
...
|------|----------|--------|
| Main: 0→1→2→3→4 | [YOUR_VALUE_HERE] | CRITICAL |

### Milestones

| Milestone | Phase End | Criteria | Target |
|-----------|-----------|----------|--------|
| M1: Research | PH-0 | Findings documented | [TBD] |
| M2: Design | PH-1 | Approach approved | [TBD] |
| M3: MVP | PH-2 | Core features working | [TBD] |
| M4: Release | PH-4 | Production ready | [TBD] |
...
|-------|-------------|------------|-------|
| Phase 0 | [YOUR_VALUE_HERE] | [H/M/L] | |
| Phase 1 | [YOUR_VALUE_HERE] | [H/M/L] | |
| Phase 2 | [YOUR_VALUE_HERE] | [H/M/L] | |
| Phase 3 | [YOUR_VALUE_HERE] | [H/M/L] | |
| Phase 4 | [YOUR_VALUE_HERE] | [H/M/L] | |
| **Total** | **[YOUR_VALUE_HERE]** | | |

**Estimation Method**: [FORMAT: Story Points | T-Shirt | Hours]
...
1. [ ] Dependencies complete (check tasks.md)
2. [ ] Files accessible
3. [ ] Goal understood
4. [ ] Approach identified
...
|------|-------------|-------------|
| TASK-SEQ | Execute in dependency order | HARD |
| TASK-SCOPE | One logical change per task | SOFT |
| TASK-VERIFY | Evidence before marking done | HARD |
| TASK-BLOCK | Report blockers immediately | HARD |
...
**Files Modified**: path/file.js (lines X-Y)
**Next**: T### unblocked
```

...
- `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive` - Parent SpecKit improvement area
- `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive` - Memory system (complementary)

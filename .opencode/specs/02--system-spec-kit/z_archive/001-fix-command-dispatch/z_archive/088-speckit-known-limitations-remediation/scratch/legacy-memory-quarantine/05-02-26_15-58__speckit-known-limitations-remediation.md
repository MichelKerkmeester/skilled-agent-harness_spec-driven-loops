---
title: SQLite remediation notes for speckit known limitations remediation 2026-02-05
  [088-speckit-known-limitations-remediation/05-02-26_15-58__speckit-known-limitations-remediation]
description: This memory captures a research session for speckit known limitations
  remediation on 2026-02-05. Migration v12 uses DROP+CREATE (not ALTER TABLE) because
  SQLite cannot modify CHECK constraints in-place. Data loss acceptable for audit-only
  table. ensure_conflicts_table() kept as @deprecated no-op .
trigger_phrases:
- speckit known limitations remediation
- speckit known limitations remediation research

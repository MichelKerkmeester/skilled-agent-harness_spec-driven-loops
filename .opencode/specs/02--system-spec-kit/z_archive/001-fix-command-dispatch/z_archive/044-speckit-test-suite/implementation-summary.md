...
- `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/044-speckit-test-suite/spec.md`
- `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/044-speckit-test-suite/plan.md`
- `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/044-speckit-test-suite/tasks.md`
- `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/044-speckit-test-suite/checklist.md`
- `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/044-speckit-test-suite/decision-record.md`
- `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/044-speckit-test-suite/memory-mcp-test-plan.md`
- `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/044-speckit-test-suite/BUG-checkpoint-database-null.md`
- `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/044-speckit-test-suite/implementation-summary.md`

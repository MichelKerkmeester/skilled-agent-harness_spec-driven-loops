...
```
.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/041-post-merge-refinement-4
...
- Prior refinement: `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/040-mcp-server-rename`

...
research/research.md line 30: In Progress | Completed | Archived
...
**Issue 5.8: research/research.md "WHEN TO USE" Position**
```
...
resume.md:429-437 vs research/research.md:107 - Inconsistent naming
...
```
research/research.md:107-109 - memory_match_triggers() no error handling
...
- research/research.md: Steps 3, 4, 5

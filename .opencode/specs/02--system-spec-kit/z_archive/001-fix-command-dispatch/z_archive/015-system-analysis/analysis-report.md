...
**Spec Folder:** `.opencode/specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/015-system-analysis/`
...
- **Self-Healing**: The system possesses the unique capability to audit itself (as seen in `.opencode/specs/03--commands-and-skills/commands/z_archive/001-command-analysis/`), effectively treating its own configuration as a "product" to be specified and tested.
...
*   **Evidence**: The `001-command-analysis` report (`.opencode/specs/03--commands-and-skills/commands/z_archive/001-command-analysis/`) explicitly identified this drift ("Auto/Confirm Parity").
...
*   **Mechanism**: `.opencode/specs/03--commands-and-skills/commands/z_archive/001-command-analysis` proves the system can spin up agents to audit its own YAML configurations against its Markdown documentation.

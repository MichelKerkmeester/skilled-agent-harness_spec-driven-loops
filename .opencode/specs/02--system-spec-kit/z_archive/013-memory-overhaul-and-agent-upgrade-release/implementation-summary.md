...
| Field | Value |
|-------|-------|
| **Spec Folder** | 013-memory-overhaul-and-agent-upgrade-release |
...
This archived folder now has a current-template Level 1 documentation set for Memory Overhaul And Agent Upgrade Release. You can open the archive and understand the topic, the cleanup scope, and the fact that the folder was normalized to pass today’s validator instead of being left in drifted historical form.

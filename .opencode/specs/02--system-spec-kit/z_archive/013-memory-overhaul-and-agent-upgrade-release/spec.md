...
| **Status** | Complete |
| **Created** | 2026-03-31 |
| **Branch** | `013-memory-overhaul-and-agent-upgrade-release` |
<!-- /ANCHOR:metadata -->
...
### In Scope
- Preserve the archived topic and folder identity for Memory Overhaul And Agent Upgrade Release.
...
|----|-------------|---------------------|
| REQ-001 | The archive must clearly state that the folder documents Memory Overhaul And Agent Upgrade Release. | A maintainer can identify the archived topic from spec.md without opening other files. |

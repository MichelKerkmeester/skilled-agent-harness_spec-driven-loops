---
title: "Tasks: Spec & Memory Compliance [02--system-spec-kit/023-esm-module-compliance/008-spec-memory-compliance-audit/tasks]"
...
- [ ] T061 [P] Fix `02--system-spec-kit/023-esm-module-compliance`
...
**Phase children of 023-esm-module-compliance (8):**
- [ ] T090 [P] Fix `023-esm-module-compliance/001-shared-esm-migration`
- [ ] T091 [P] Fix `023-esm-module-compliance/002-mcp-server-esm-migration`
- [ ] T092 [P] Fix `023-esm-module-compliance/003-scripts-interop-refactor`
- [ ] T093 [P] Fix `023-esm-module-compliance/004-verification-and-standards`
- [ ] T094 [P] Fix `023-esm-module-compliance/005-test-and-scenario-remediation`
- [ ] T095 [P] Fix `023-esm-module-compliance/006-review-remediation`
- [ ] T096 [P] Fix `023-esm-module-compliance/007-hybrid-search-null-db-fix`
- [ ] T097 [P] Fix `023-esm-module-compliance/008-spec-memory-compliance-audit`
...
- **Parent Spec**: See `../spec.md` (023-esm-module-compliance)
<!-- /ANCHOR:cross-refs -->

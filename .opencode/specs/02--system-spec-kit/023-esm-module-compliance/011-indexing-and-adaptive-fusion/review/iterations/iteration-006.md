...
- Phase folder: `.opencode/specs/02--system-spec-kit/023-esm-module-compliance/011-indexing-and-adaptive-fusion`
...
1. [P1] Tracked execution inventory remains open - tasks unchecked=6, checklist unchecked=0

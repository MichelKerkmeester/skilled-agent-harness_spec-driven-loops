...
You are the **conductor**. You orchestrate the full ESM migration for spec `023-esm-module-compliance` by running `/spec_kit:implement` on each phase folder in order, delegating parallelizable work to GPT-5.4 agents via `codex exec`, and integrating their output.
...
**Spec folder**: `specs/02--system-spec-kit/023-esm-module-compliance/001-shared-esm-migration/`
...
**Spec folder**: `specs/02--system-spec-kit/023-esm-module-compliance/002-mcp-server-esm-migration/`
**Run**: `/spec_kit:implement` on this phase folder
...
**Spec folder**: `specs/02--system-spec-kit/023-esm-module-compliance/003-scripts-interop-refactor/`
**Run**: `/spec_kit:implement` on this phase folder
...
**Spec folder**: `specs/02--system-spec-kit/023-esm-module-compliance/004-verification-and-standards/`
**Run**: `/spec_kit:implement` on this phase folder
...
2. Save to `specs/02--system-spec-kit/023-esm-module-compliance/003-scripts-interop-refactor/scratch/dual-build-escalation.md`
...
2. Update `specs/02--system-spec-kit/023-esm-module-compliance/implementation-summary.md` with runtime evidence
...
| Item | Path |
|------|------|
| Parent spec folder | `specs/02--system-spec-kit/023-esm-module-compliance/` |
| Phase 1 | `specs/02--system-spec-kit/023-esm-module-compliance/001-shared-esm-migration/` |
| Phase 2 | `specs/02--system-spec-kit/023-esm-module-compliance/002-mcp-server-esm-migration/` |
| Phase 3 | `specs/02--system-spec-kit/023-esm-module-compliance/003-scripts-interop-refactor/` |
| Phase 4 | `specs/02--system-spec-kit/023-esm-module-compliance/004-verification-and-standards/` |
...
| Research (source of truth) | `specs/02--system-spec-kit/023-esm-module-compliance/research/research.md` |

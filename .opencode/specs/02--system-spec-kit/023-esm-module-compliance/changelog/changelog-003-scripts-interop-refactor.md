...
> Spec folder: `.opencode/specs/02--system-spec-kit/023-esm-module-compliance/003-scripts-interop-refactor` (Level 1)
...
| File | Changes |
| ---- | ------- |
| `.opencode/specs/02--system-spec-kit/023-esm-module-compliance/003-scripts-interop-refactor/spec.md` | Recorded the phase scope, save-pipeline hardening work, and the JSON v2 contract requirement. |
| `.opencode/specs/02--system-spec-kit/023-esm-module-compliance/003-scripts-interop-refactor/tasks.md` | Recorded completion evidence for the scripts tests, help-command smoke, schema freeze, and end-to-end save verification. |

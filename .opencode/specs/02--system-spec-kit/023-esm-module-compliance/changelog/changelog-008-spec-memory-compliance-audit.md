...
> Spec folder: `.opencode/specs/02--system-spec-kit/023-esm-module-compliance/008-spec-memory-compliance-audit` (Level 2)
...
| `.opencode/specs/02--system-spec-kit/023-esm-module-compliance/scratch/fix-anchors.py` | Inserted missing anchor markers, repaired unclosed anchors, and removed duplicate legacy anchors during the audit. |
...
| File | Changes |
| ---- | ------- |
| `.opencode/specs/02--system-spec-kit/023-esm-module-compliance/008-spec-memory-compliance-audit/spec.md` | Restored the `SPECKIT_TEMPLATE_SOURCE` marker and kept the audit scope aligned with the active packet. |
| `.opencode/specs/02--system-spec-kit/023-esm-module-compliance/008-spec-memory-compliance-audit/plan.md` | Restored the `SPECKIT_TEMPLATE_SOURCE` marker and preserved the ranked repair plan. |
| `.opencode/specs/02--system-spec-kit/023-esm-module-compliance/008-spec-memory-compliance-audit/tasks.md` | Restored the `SPECKIT_TEMPLATE_SOURCE` marker and tracked the execution wave details. |
| `.opencode/specs/02--system-spec-kit/023-esm-module-compliance/008-spec-memory-compliance-audit/checklist.md` | Restored the `SPECKIT_TEMPLATE_SOURCE` marker and recorded verification checkpoints. |
| `.opencode/specs/02--system-spec-kit/023-esm-module-compliance/008-spec-memory-compliance-audit/implementation-summary.md` | Recorded final audit counts, the restart-based verification note, and the broader follow-up search check as pending. |
| `.opencode/specs/02--system-spec-kit/023-esm-module-compliance/008-spec-memory-compliance-audit/research/discovery-summary.md` | Captured baseline error counts and the folder breakdown used to prioritize repair waves. |
| `.opencode/specs/02--system-spec-kit/023-esm-module-compliance/008-spec-memory-compliance-audit/research/hard-block-memories.txt` | Captured the deletion set for memory files that could not safely stay in the rebuilt corpus. |

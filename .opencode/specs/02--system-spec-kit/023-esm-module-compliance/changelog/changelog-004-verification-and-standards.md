...
> Spec folder: `.opencode/specs/02--system-spec-kit/023-esm-module-compliance/004-verification-and-standards/` (Level 1)
...
| `.opencode/specs/02--system-spec-kit/023-esm-module-compliance/004-verification-and-standards/implementation-summary.md` | Recorded the phase result, delivery order, key decisions, and verification outcome. |
| `.opencode/specs/02--system-spec-kit/023-esm-module-compliance/implementation-summary.md` | Recorded packet-wide verification evidence and final completion status. |

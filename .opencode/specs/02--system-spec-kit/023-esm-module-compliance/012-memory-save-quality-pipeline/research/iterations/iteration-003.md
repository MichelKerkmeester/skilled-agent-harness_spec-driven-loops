...
- Spec IDs extracted from the `specFolder` path string (e.g., `023-esm-module-compliance/012-memory-save-quality-pipeline` yields `{023-esm-module-compliance, 012-memory-save-quality-pipeline}`)

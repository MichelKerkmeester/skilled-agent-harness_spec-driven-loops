...
| Spec Folder | 02--system-spec-kit/023-esm-module-compliance/013-fts5-fix-and-search-dashboard |
...
```
/spec_kit:resume 02--system-spec-kit/023-esm-module-compliance/013-fts5-fix-and-search-dashboard
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: 02--system-spec-kit/023-esm-module-compliance/013-fts5-fix-and-search-dashboard
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 02--system-spec-kit/023-esm-module-compliance/013-fts5-fix-and-search-dashboard` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "02--system-spec-kit/023-esm-module-compliance/013-fts5-fix-and-search-dashboard" })` |
...
memory_search({ specFolder: "02--system-spec-kit/023-esm-module-compliance/013-fts5-fix-and-search-dashboard", limit: 10 })

# Verify memory file integrity
ls -la 02--system-spec-kit/023-esm-module-compliance/013-fts5-fix-and-search-dashboard/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js 02--system-spec-kit/023-esm-module-compliance/013-fts5-fix-and-search-dashboard --force
```
...
spec_folder: "02--system-spec-kit/023-esm-module-compliance/013-fts5-fix-and-search-dashboard"
channel: "system-speckit/024-compact-code-graph"
...
parent_spec: "02--system-spec-kit/023-esm-module-compliance/013-fts5-fix-and-search-dashboard"
child_sessions:

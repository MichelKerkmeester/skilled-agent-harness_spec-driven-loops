...
| Parent Spec | `../000-feature-overview/spec.md` | Overall sprint sequencing and R-series requirements |
| Parent Plan | `../000-feature-overview/plan.md` | Cross-sprint effort totals context |

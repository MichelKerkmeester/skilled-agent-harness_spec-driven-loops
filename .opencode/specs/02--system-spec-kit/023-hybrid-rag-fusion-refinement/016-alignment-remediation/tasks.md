---
title: "Tasks: Alignment Remediation Finalized Scope [template:level_2/tasks.md]"
...
---
# Tasks: Alignment Remediation Finalized Scope
...
- [x] T005 Correct RSF/shadow/fallback/floor/reconsolidation wording (`.opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/summary_of_existing_features.md`)
- [x] T006 Correct contradiction around `isInShadowPeriod` (`.opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/summary_of_new_features.md`)
...
- [x] T010 Run child-folder validation (`bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh ".opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/016-alignment-remediation"`) [Result: PASS, Errors 0, Warnings 0]
- [x] T011 Run contradiction/wording verification search (`rg -n "RSF|shadow|fallback|floor|reconsolidation" .opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/summary_of_existing_features.md && rg -n "isInShadowPeriod" .opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/summary_of_new_features.md`) [Result: PASS, targeted contradiction/stale wording removed]
...
- [x] T022 Align parent feature summaries for R11 default/gating truth, G-NEW-2 instrumentation inert status, TM-05 hook-scope correction, and dead-code list correction (`.opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/summary_of_existing_features.md`, `.opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/summary_of_new_features.md`)
...
- [x] T024 Re-run child-folder validation (`bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh ".opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/016-alignment-remediation"`) [Result: PASS, Errors 0, Warnings 0]
<!-- /ANCHOR:phase-5 -->
...
- [x] T025 Apply parent-summary P2 polish updates A/C/D/F (MPAB naming, PI-B3 folder-discovery ID, global density-guard wording, entity-linking dependency wording) in existing-features summary (`.opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/summary_of_existing_features.md`)
- [x] T026 Apply parent-summary P2 polish updates A/B/E/F (global density-guard checks, SQL wording accuracy, active-flag inventory count to 20, entity-linking dependency wording) in new-features summary (`.opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/summary_of_new_features.md`)
...
- [x] T029 Re-run child-folder validation after tranche-4 doc-polish updates (`bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh ".opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/016-alignment-remediation"`) [Result: PASS, Errors 0, Warnings 0]
<!-- /ANCHOR:phase-6 -->
...
- **Parent**: `../spec.md`
- **Predecessor**: `../015-gemini-review-p1-fixes/spec.md`
<!-- /ANCHOR:cross-refs -->

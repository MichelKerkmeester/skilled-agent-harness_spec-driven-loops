...
**Spec folder**: `specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/001-shared-esm-migration/`
...
**Spec folder**: `specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/002-mcp-server-esm-migration/`
**Run**: `/spec_kit:implement` on this phase folder
...
**Spec folder**: `specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/003-scripts-interop-refactor/`
**Run**: `/spec_kit:implement` on this phase folder
...
**Spec folder**: `specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/004-verification-and-standards/`
**Run**: `/spec_kit:implement` on this phase folder
...
2. Save to `specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/003-scripts-interop-refactor/scratch/dual-build-escalation.md`
...
2. Update `specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/implementation-summary.md` with runtime evidence
...
| Item | Path |
|------|------|
| Parent spec folder | `specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/` |
| Phase 1 | `specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/001-shared-esm-migration/` |
| Phase 2 | `specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/002-mcp-server-esm-migration/` |
| Phase 3 | `specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/003-scripts-interop-refactor/` |
| Phase 4 | `specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/004-verification-and-standards/` |
...
| Research (source of truth) | `specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/research/research.md` |

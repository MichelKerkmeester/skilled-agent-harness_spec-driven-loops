...
> Spec folder: `.opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/011-indexing-and-adaptive-fusion` (Level 1 parent with nested child phases)
...
| File Group | Changes |
| ---------- | ------- |
| `.opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/011-indexing-and-adaptive-fusion/*.md` | Parent wrapper docs aligned to the current template and open verification state. |
| `.opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/011-indexing-and-adaptive-fusion/*/*.md` | Child phase artifacts capture the shipped work and child-level evidence in more detail than the previous parent changelog exposed. |

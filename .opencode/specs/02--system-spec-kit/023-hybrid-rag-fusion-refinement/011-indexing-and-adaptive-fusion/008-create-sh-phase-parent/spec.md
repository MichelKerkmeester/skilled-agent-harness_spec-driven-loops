---
title: "Feature Specification: Append Nested Child Phases in create.sh [02--system-spec-kit/023-hybrid-rag-fusion-refinement/011-indexing-and-adaptive-fusion/008-create-sh-phase-parent]"
...
| REQ-003 | Validate nested parent paths under both `specs/` and `.opencode/specs/` | Parent paths like `02--system-spec-kit/023-hybrid-rag-fusion-refinement/011-indexing-and-adaptive-fusion` are accepted when they resolve under an approved root |

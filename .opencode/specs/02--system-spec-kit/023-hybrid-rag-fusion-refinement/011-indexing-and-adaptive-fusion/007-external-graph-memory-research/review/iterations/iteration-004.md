...
- Phase folder: `.opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/011-indexing-and-adaptive-fusion/007-external-graph-memory-research`
...
2. [P1] Tracked execution inventory remains open — tasks unchecked=0, checklist unchecked=6

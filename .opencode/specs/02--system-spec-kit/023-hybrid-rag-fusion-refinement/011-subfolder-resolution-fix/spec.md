...
1. A bare child name like `011-skill-command-alignment` (3 levels deep under `02--system-spec-kit/023-hybrid-rag-fusion-refinement/`)
2. A relative path like `02--system-spec-kit/023-hybrid-rag-fusion-refinement/011-skill-command-alignment`

Only the full path `.opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/011-skill-command-alignment` works.
...
1. `node generate-context.js "012-subfolder-resolution-fix"` succeeds (bare name)

...
- Evidence: [SOURCE: .opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/spec.md:116]
- Evidence: [SOURCE: .opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/tasks.md:60]
- Evidence: [SOURCE: .opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/checklist.md:46]
...
```json
{
  ...
  "evidenceRefs": [
    ".opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/spec.md:116",
    ".opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/tasks.md:60",
    ".opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/checklist.md:46",
...
- Dimension: D1 Correctness
- Evidence: [SOURCE: .opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/implementation-summary.md:46]
- Evidence: [SOURCE: .opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/implementation-summary.md:73]
- Evidence: [SOURCE: .opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/implementation-summary.md:84]
...
```json
{
  ...
  "evidenceRefs": [
    ".opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/implementation-summary.md:46",
    ".opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/implementation-summary.md:73",
    ".opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/implementation-summary.md:84",
...
- [SOURCE: .opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/checklist.md:46]
- [SOURCE: .opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/implementation-summary.md:46]
- [SOURCE: .opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/implementation-summary.md:73]
- [SOURCE: .opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/implementation-summary.md:84]
- [SOURCE: .opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/spec.md:116]
- [SOURCE: .opencode/specs/02--system-spec-kit/023-hybrid-rag-fusion-refinement/tasks.md:60]

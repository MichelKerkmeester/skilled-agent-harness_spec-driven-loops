...
| `011-skill-command-alignment/spec.md` | Create | This file |
| `011-skill-command-alignment/plan.md` | Create | Implementation plan |
| `011-skill-command-alignment/tasks.md` | Create | Task breakdown |
| `011-skill-command-alignment/checklist.md` | Create | Verification checklist |
| `011-skill-command-alignment/decision-record.md` | Create | ADR-001 and ADR-002 |
| `011-skill-command-alignment/implementation-summary.md` | Create | Post-implementation summary |
<!-- /ANCHOR:scope -->
...
- Successor: `011-subfolder-resolution-fix`

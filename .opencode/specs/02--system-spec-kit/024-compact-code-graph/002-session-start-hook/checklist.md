...
- [x] Clear path outputs minimal guidance (tool availability reminder only)
...
- [x] ~~Working memory attention signals~~ — NOT IMPLEMENTED (deferred). handleStartup does not load workingSet.

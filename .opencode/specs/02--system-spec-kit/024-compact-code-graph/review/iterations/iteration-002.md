...
- Spec refs: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/{spec.md,implementation-summary.md}`
...
| `.opencode/specs/02--system-spec-kit/024-compact-code-graph/implementation-summary.md` | 2 | 2 | 1 | 3 |
...
- Cross-reference: The canonical packet still claims Phase 014 delivered “provenance fencing for injection safety,” which overstates the current Gemini SessionStart posture. [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/implementation-summary.md:108-111]
...
- Cross-reference: The packet claims the Stop hook “saves session state” and that `lastSpecFolder` provides continuity, but this implementation can persist summaries into an unrelated packet whenever the transcript discusses another spec more often than the active one. [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/spec.md:115-118] [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/spec.md:188-195] [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/implementation-summary.md:84-90]
...
- [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/spec.md:101-118]
- [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/spec.md:188-195]
- [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/implementation-summary.md:84-111]

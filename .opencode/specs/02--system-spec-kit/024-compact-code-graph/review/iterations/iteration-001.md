...
- Evidence: [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/implementation-summary.md:110], [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/implementation-summary.md:111], [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/checklist.md:162], [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/checklist.md:172], [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/checklist.md:177], [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/015-tree-sitter-migration/spec.md:129], [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/016-cross-runtime-ux/spec.md:156]
- Cross-reference: [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/checklist.md:162], [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/checklist.md:172], [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/checklist.md:177]
...
- Contradictions: Root checklist evidence for tree-sitter/parser follow-through and SessionStart scope still points at an implementation summary that says those items were deferred [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/implementation-summary.md:110] [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/checklist.md:162]
- Unknowns: None for this inventory pass.

### Overlay Protocols
- Confirmed: Claude SessionStart registration is a single unscoped hook entry with in-script branching, matching the later phase-016 correction [SOURCE: .claude/settings.local.json:17] [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/016-cross-runtime-ux/spec.md:156]
...
- [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/plan.md:65-121]
...
- [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/decision-record.md:94-100]
- [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/015-tree-sitter-migration/spec.md:124-143]
- [SOURCE: .opencode/specs/02--system-spec-kit/024-compact-code-graph/016-cross-runtime-ux/spec.md:148-163]

...
| WS-2 Root packet evidence repair | P1-002 | Blocker | `.opencode/specs/02--system-spec-kit/024-compact-code-graph/implementation-summary.md`, `.opencode/specs/02--system-spec-kit/024-compact-code-graph/checklist.md`, child packet evidence references for phases 015/016 if needed |

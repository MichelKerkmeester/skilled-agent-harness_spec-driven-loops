...
- [ ] Item 8 (Spec 26): Stop-hook surrogate save redesign — Not implemented: planned `pendingStopSave` field was not added to the `HookState` interface, and `session-stop.ts` does not use a dedicated stop-save field

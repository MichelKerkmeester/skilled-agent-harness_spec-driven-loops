---
title: "Verification Checklist: Copilot Startup Hook Wiring [02--system-spec-kit/024-compact-code-graph/030-opencode-graph-plugin/031-copilot-startup-hook-wiring]"
...
- [x] CHK-024 [P1] Strict packet validation passes after truth-sync [EVIDENCE: `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/02--system-spec-kit/024-compact-code-graph/030-opencode-graph-plugin --recursive --strict`]
<!-- /ANCHOR:testing -->

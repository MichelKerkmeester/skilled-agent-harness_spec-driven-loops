---
title: "Decision Record: OpenCode Transport Adapter [02--system-spec-kit/024-compact-code-graph/030-opencode-graph-plugin/002-opencode-transport-adapter]"
description: "Architecture decisions for OpenCode Transport Adapter: preserve the shipped runtime boundary and close the phase as a clean Level 3 artifact."
trigger_phrases:
  - "opencode transport adapter adr"
  - "level 3 decision record"
importance_tier: "important"
contextType: "implementation"
---
# Decision Record: OpenCode Transport Adapter
...
<!-- ANCHOR:adr-001 -->
## ADR-001: Preserve the Shipped OpenCode Transport Adapter Boundary
...
**We chose**: Keep the shipped OpenCode Transport Adapter runtime scope intact and rebuild the phase docs around that existing implementation evidence.

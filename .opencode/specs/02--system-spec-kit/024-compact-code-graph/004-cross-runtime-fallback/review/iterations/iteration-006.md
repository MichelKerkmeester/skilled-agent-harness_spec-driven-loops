...
- Phase folder: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/004-cross-runtime-fallback`
...
1. [P1] Tracked execution inventory remains open - tasks unchecked=3, checklist unchecked=0

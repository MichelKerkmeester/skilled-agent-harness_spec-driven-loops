...
**Implementation gap to close:** Add a compact Tool Routing block that is availability-aware and preserves the exact-text/regex escape hatch described in the spec risk section. [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/025-tool-routing-enforcement/spec.md:138-141`]
...
**Mitigation:** Keep the routing block under ~200 tokens, make it availability-aware, and preserve the exact-text/regex escape hatch so the model is not told to use CocoIndex for literal grep tasks. [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/025-tool-routing-enforcement/spec.md:138-141`]
...
If those two conditions are accepted, the implementation can proceed in a single dependency-ordered PR without touching CocoIndex or Code Graph core logic. [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/025-tool-routing-enforcement/spec.md:82-86`]

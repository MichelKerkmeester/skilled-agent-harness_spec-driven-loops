...
```
specs/02--system-spec-kit/024-compact-code-graph/
...
```
/spec_kit:implement specs/02--system-spec-kit/024-compact-code-graph/001-precompact-hook
/spec_kit:implement specs/02--system-spec-kit/024-compact-code-graph/002-session-start-hook
```
...
```
/spec_kit:implement specs/02--system-spec-kit/024-compact-code-graph/006-documentation-alignment
```
...
```
/spec_kit:implement specs/02--system-spec-kit/024-compact-code-graph/007-testing-validation
```
...
Read the phase spec first: `specs/02--system-spec-kit/024-compact-code-graph/[NNN]-[phase]/spec.md`

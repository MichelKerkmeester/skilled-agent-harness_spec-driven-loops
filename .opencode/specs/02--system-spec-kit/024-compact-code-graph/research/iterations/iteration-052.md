...
5. The merged payload should look like a compact recovery brief with explicit source-derived sections, not a source dump.
   ...
   This shape is consistent with the packet's existing hook recommendations: concise brief, compact markdown, active files/symbols, structural edges, tests/status, and durable rules. [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-025.md:21-25`] [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-045.md:159-173`] [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-045.md:193-205`]
...
6. Multi-language active symbols should be merged through a normalized edge vocabulary, but cross-language graph links must stay conservative.
   ...
   [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/plan.md:97-106`] [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/research.md:463-468`]
...
7. The merge should happen in PreCompact, not be split across PreCompact and SessionStart, except for fallback repair.
   ...
   This also matches iteration 045's explicit fallback recommendation when graph data is missing or stale. [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-045.md:201-205`]

8. Deduplication should be entity-level first, file-level second, never section-level only.

   File-level dedup alone is too coarse because the same file can matter for very different reasons. A file might appear from CocoIndex because one function semantically matches the task, while the Code Graph points to a separate caller or test symbol in the same file. Because Code Graph is designed around stable node IDs and CocoIndex works at function-level chunking, the natural dedup key is the symbol when available. [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-044.md:119-123`] [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/research.md:463-466`]
...
10. The minimum viable merge is fixed-order concatenation with section headers, but it should be treated as a fallback, not the target design.
   ...
   This is consistent with the packet's structured-output guidance and the existing hook guidance to emit concise sections rather than raw JSON. [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-025.md:21-25`] [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-039.md:173-187`] [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-039.md:281-286`]
...
- `.opencode/specs/02--system-spec-kit/024-compact-code-graph/decision-record.md:58-74`
- `.opencode/specs/02--system-spec-kit/024-compact-code-graph/plan.md:97-106`
- `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/research.md:248-263`
- `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/research.md:300-339`
- `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/research.md:463-468`
- `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/research.md:500-512`
- `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-016.md:64-71`
- `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-025.md:15-25`
- `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-039.md:173-187`
- `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-039.md:255-286`
- `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-041.md:42-50`
- `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-044.md:75-80`
- `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-044.md:117-140`
- `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-044.md:266-277`
- `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-045.md:159-205`

...
7. Indexing should be hybrid: background-first for coverage, on-demand for freshness repair.
   ...
   This matches the packet's earlier incremental-update findings and respects the interactive UX constraint that graph queries should not routinely trigger a repo-wide rebuild. [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-041.md`]
...
10. The MVP should be intentionally narrow: JS/TS-first, structural navigation first, fusion later.
   ...
   This aligns with the packet's prior recommendation to build a clean-room code graph channel using tree-sitter inside the existing architecture, but without forcing phase-one changes into the current memory search contracts too early. [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-010.md:12-53`] [SOURCE: `.opencode/specs/02--system-spec-kit/024-compact-code-graph/decision-record.md:49-56`]
...
- Prior packet direction:
  - `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-010.md`
  - `.opencode/specs/02--system-spec-kit/024-compact-code-graph/research/iterations/iteration-041.md`
  - `.opencode/specs/02--system-spec-kit/024-compact-code-graph/memory/29-03-26_10-28__deep-research-evaluating-codex-cli-compact-dual.md`

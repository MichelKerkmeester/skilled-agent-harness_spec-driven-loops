---
title: "Checklist: migrate config and data (017 phase 013)"
description: "Checklist for phase 013 of the 017 kebab-case filesystem-naming program: migrate config and data."
trigger_phrases:
  - "migrate config and data checklist"
  - "hyphen naming phase 013 checklist"
...
_memory:
  continuity:
    ...
    answered_questions: []
---
# Checklist: Migrate config and data
...
This checklist is the blocking SOL verifier contract for phase 013. Every item is a check the paired
...
- [ ] CHK-001 [P0] Parse all JSON/YAML/TOML; compare before/after key sets; ensure changed path values resolve
- [ ] CHK-002 [P0] Resolve the SQLite classification and migrate schema-aware or regenerate; never raw byte replace
- [ ] CHK-003 [P0] Verify all symlinks and prove protected magic-name path sets did not change
<!-- /ANCHOR:testing -->

<!-- ANCHOR:fix-completeness -->
## Fix Completeness

- [ ] CHK-004 [P1] Run the final exemption reconciliation
<!-- /ANCHOR:fix-completeness -->

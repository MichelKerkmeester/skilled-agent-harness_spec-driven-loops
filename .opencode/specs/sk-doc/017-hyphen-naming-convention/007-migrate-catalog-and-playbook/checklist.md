---
title: "Checklist: migrate catalog and playbook (017 phase 007)"
description: "Checklist for phase 007 of the 017 kebab-case filesystem-naming program: migrate catalog and playbook."
trigger_phrases:
  - "migrate catalog and playbook checklist"
  - "hyphen naming phase 007 checklist"
...
_memory:
  continuity:
    ...
    answered_questions: []
---
# Checklist: Migrate catalog and playbook
...
- [ ] CHK-001 [P0] Enumerate every catalog/playbook leaf and assert its exact document type; zero silent `readme` downgrades
- [ ] CHK-002 [P0] Compare Lane C scenario IDs, prompts, expectations, warnings, and scores — not count alone
- [ ] CHK-003 [P0] Frontmatter key set is unchanged; only path-valued fields moved
<!-- /ANCHOR:testing -->

<!-- ANCHOR:fix-completeness -->
## Fix Completeness

- [ ] CHK-004 [P1] Index tables and cross-refs resolve to hyphenated paths
<!-- /ANCHOR:fix-completeness -->

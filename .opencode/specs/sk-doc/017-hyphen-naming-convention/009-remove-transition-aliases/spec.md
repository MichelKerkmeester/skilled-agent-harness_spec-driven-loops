---
title: "Feature Specification: remove transition aliases (017 phase 009)"
...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/sk-doc/017-hyphen-naming-convention/002-root-name-consumer-migration/spec.md"
...
> Phase adjacency under the 017 parent: prerequisite `002-root-name-consumer-migration` with its coexistence window closed and the physical catalog/playbook migration complete; successor `010-whole-repo-gate`.
...
| Field | Value |
|-------|-------|
| **Packet** | sk-doc/017-hyphen-naming-convention/009-remove-transition-aliases |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Planned |
| **Created** | 2026-07-14 |
...
The phase inherits the 017 policy risks around classifier downgrade, exemption leakage, and scope drift. It does not authorize a broad repository rename or edits to frozen history.
<!-- /ANCHOR:risks -->

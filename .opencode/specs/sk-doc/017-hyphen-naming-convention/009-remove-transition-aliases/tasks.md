...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/sk-doc/017-hyphen-naming-convention/009-remove-transition-aliases/plan.md"
      - ".opencode/specs/sk-doc/017-hyphen-naming-convention/009-remove-transition-aliases/checklist.md"
    completion_pct: 0
    open_questions: []
    answered_questions: []
---

---
title: "Checklist: migrate references and assets (017 phase 010)"
description: "Checklist for phase 010 of the 017 kebab-case filesystem-naming program: migrate references and assets."
trigger_phrases:
  - "migrate references and assets checklist"
...
_memory:
  continuity:
    ...
    answered_questions: []
---
# Checklist: Migrate references and assets
...
- [ ] CHK-001 [P0] Resolve markdown links + path-values across the touched surfaces; 0 broken
- [ ] CHK-002 [P0] No .py/vendored/generated asset name was renamed
<!-- /ANCHOR:testing -->

<!-- ANCHOR:fix-completeness -->
## Fix Completeness

- [ ] CHK-003 [P1] Touched packets strict-validate Errors 0 after each batch
<!-- /ANCHOR:fix-completeness -->

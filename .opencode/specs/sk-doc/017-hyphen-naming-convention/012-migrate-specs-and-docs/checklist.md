---
title: "Checklist: migrate specs and docs (017 phase 012)"
description: "Checklist for phase 012 of the 017 kebab-case filesystem-naming program: migrate specs and docs."
trigger_phrases:
  - "migrate specs and docs checklist"
  - "hyphen naming phase 012 checklist"
...
_memory:
  continuity:
    ...
    answered_questions: []
---
# Checklist: Migrate specs and docs
...
- [ ] CHK-001 [P0] Resolve markdown links across active specs and docs, not only current checker roots
- [ ] CHK-002 [P0] Prove frozen-tree blobs are unchanged except the approved supersession exception
<!-- /ANCHOR:testing -->

<!-- ANCHOR:fix-completeness -->
## Fix Completeness

- [ ] CHK-003 [P1] Strict-validate every touched packet/skill
<!-- /ANCHOR:fix-completeness -->

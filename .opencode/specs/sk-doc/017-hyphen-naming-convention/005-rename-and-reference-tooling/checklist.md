---
title: "Checklist: rename and reference tooling (017 phase 005)"
description: "Checklist for phase 005 of the 017 kebab-case filesystem-naming program: rename and reference tooling."
trigger_phrases:
  - "rename and reference tooling checklist"
  - "hyphen naming phase 005 checklist"
...
_memory:
  continuity:
    ...
    answered_questions: []
---
# Checklist: Rename and reference tooling
...
- [ ] CHK-001 [P0] In a temp git repo, dry-run makes zero writes; exact/casefold/NFC collision aborts
- [ ] CHK-002 [P0] Leading/double-underscore, symlink, ignored, frozen, Python, and tool-magic cases behave correctly; changed-vs-all honored
- [ ] CHK-003 [P0] Plant broken literal and registry references and prove the checker catches them with a non-zero scan count
<!-- /ANCHOR:testing -->

<!-- ANCHOR:fix-completeness -->
## Fix Completeness

- [ ] CHK-004 [P1] Every non-literal require/import/source/glob site is dispositioned in the ledger
<!-- /ANCHOR:fix-completeness -->

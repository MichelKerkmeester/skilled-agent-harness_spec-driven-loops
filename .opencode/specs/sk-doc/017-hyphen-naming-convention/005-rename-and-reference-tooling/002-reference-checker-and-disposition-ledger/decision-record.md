---
title: "Decision Record: reference checker and disposition ledger (017 phase 005.002)"
...
**Alternative rejected:** normalize every matching token. That would alter data/API contracts and violate the 017 exemption
boundary.

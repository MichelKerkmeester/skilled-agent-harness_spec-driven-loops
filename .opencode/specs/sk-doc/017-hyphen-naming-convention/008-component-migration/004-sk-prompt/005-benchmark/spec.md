---
title: "Feature Specification: sk-prompt benchmark artifact names (017 phase 004.005)"
...
| Field | Value |
|-------|-------|
| **Packet** | sk-doc/017-hyphen-naming-convention/008-component-migration/004-sk-prompt/005-benchmark |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Planned |
| **Created** | 2026-07-14 |
| **Owner skill** | sk-prompt |
| **Origin** | Phase 005 of the sk-prompt component subtree under the 017 kebab-case filesystem-naming program |
<!-- /ANCHOR:metadata -->

---
title: "Feature Specification: component migration (017 phase 008)"
...
_memory:
  continuity:
    packet_pointer: "sk-doc/017-hyphen-naming-convention/008-component-migration"
...
> Phase adjacency under the 017 parent (grouping order, not a runtime dependency): predecessor `007-shared-and-cross-cutting-closures`; successor `009-remove-transition-aliases`.
...
| Field | Value |
|-------|-------|
| **Packet** | sk-doc/017-hyphen-naming-convention/008-component-migration |
| **Level** | phase parent |
| **Priority** | P1 |
| **Status** | Planned |
| **Created** | 2026-07-15 |

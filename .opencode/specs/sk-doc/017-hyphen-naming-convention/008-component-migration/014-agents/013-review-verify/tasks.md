---
title: "Tasks: verify review agent naming (017 phase 013)"
description: "Tasks for phase 013 of the 017 agents component migration: verify the review filename candidate set."
trigger_phrases:
...
- [ ] T002 Confirm the three expected review definition paths in the runtime inventory
<!-- /ANCHOR:phase-1 -->

<!-- ANCHOR:phase-2 -->
## Phase 2: Implementation

- [ ] T003 Record the OpenCode, Claude, and Codex path, extension, and basename for review

---
title: "Implementation Plan: verify review agent naming (017 phase 013)"
description: "Implementation Plan for phase 013 of the 017 agents component migration: a read-only review filename candidate audit."
trigger_phrases:
...
_memory:
  continuity:
    packet_pointer: "sk-doc/017-hyphen-naming-convention/008-component-migration/014-agents/013-review-verify"
...
- [ ] The expected review definition paths are listed in spec.md
...
- OpenCode definition: .opencode/agents/review.md
- Claude definition: .claude/agents/review.md
- Codex definition: .codex/agents/review.toml
...
- Confirm all three expected review definition paths exist in the runtime inventory.
...
|-------------|--------------|
| REQ-001 | Path-level inventory lists .opencode/agents/review.md, .claude/agents/review.md, and .codex/agents/review.toml |

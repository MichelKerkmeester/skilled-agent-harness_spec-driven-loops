---
title: "Checklist: verify design agent naming (017 phase 009)"
description: "Checklist for phase 009 of the 017 agents component migration: verify the design filename candidate set."
trigger_phrases:
...
# Checklist: Design Agent Naming Verification
...
- [ ] CHK-001 [P0] The pinned BASE and all three runtime agent directories are available for the design inventory
...
- [ ] CHK-005 [P0] The inventory records exactly .opencode/agents/design.md, .claude/agents/design.md, and .codex/agents/design.toml

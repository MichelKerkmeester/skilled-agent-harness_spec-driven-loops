---
title: "Implementation Plan: verify code agent naming (017 phase 002)"
description: "Implementation Plan for phase 002 of the 017 agents component migration: a read-only code filename candidate audit."
trigger_phrases:
  - "code agent naming implementation plan"
  - "agents phase 002 implementation plan"
...
# Implementation Plan: Code Agent Naming Verification
...
- [ ] The expected code definition paths are listed in spec.md
...
- OpenCode definition: .opencode/agents/code.md
- Claude definition: .claude/agents/code.md
- Codex definition: .codex/agents/code.toml
...
- Confirm all three expected code definition paths exist in the runtime inventory.
...
|-------------|--------------|
| REQ-001 | Path-level inventory lists .opencode/agents/code.md, .claude/agents/code.md, and .codex/agents/code.toml |

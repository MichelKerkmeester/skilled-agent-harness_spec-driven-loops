---
title: "Implementation Plan: verify debug agent naming (017 phase 004)"
description: "Implementation Plan for phase 004 of the 017 agents component migration: a read-only debug filename candidate audit."
trigger_phrases:
  - "debug agent naming implementation plan"
  - "agents phase 004 implementation plan"
importance_tier: "important"
contextType: "planning"
parent: "sk-doc/017-hyphen-naming-convention/008-component-migration/014-agents"
_memory:
  continuity:
    packet_pointer: "sk-doc/017-hyphen-naming-convention/008-component-migration/014-agents/004-debug-verify"
...
# Implementation Plan: Debug Agent Naming Verification
...
- [ ] The expected debug definition paths are listed in spec.md
...
- OpenCode definition: .opencode/agents/debug.md
- Claude definition: .claude/agents/debug.md
- Codex definition: .codex/agents/debug.toml
...
- Confirm all three expected debug definition paths exist in the runtime inventory.
...
|-------------|--------------|
| REQ-001 | Path-level inventory lists .opencode/agents/debug.md, .claude/agents/debug.md, and .codex/agents/debug.toml |

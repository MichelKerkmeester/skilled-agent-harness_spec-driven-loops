---
title: "Checklist: sk-git skill gate (017 phase 008/012/006)"
...
- [ ] CHK-003 [P1] The 017 exemption boundary and each excluded surface are recorded before the all-path scan.
<!-- /ANCHOR:pre-impl -->
...
- [ ] CHK-007 [P0] The full tracked-path scan finds zero in-scope snake_case directories or files outside the 017 exemption set.

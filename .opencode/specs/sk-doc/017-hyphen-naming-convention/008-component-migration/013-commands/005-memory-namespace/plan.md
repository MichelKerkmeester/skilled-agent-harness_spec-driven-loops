---
title: "Implementation Plan: memory command namespace naming (017 phase 008/013/005)"
...
|------------|------|--------|-------------------|
| 017 phase 005 rename/reference tooling | Internal | Required before execution | Manual replacement can alter data keys or miss path consumers. |

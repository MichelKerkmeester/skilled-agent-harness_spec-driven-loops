---
title: "Implementation Plan: Hub root and shared (017 phase 001)"
description: "Execution plan for Hub root and shared in the 017 sk-design naming subtree."
trigger_phrases:
  - "hub-root-and-shared implementation plan"
  - "sk-design hub/shared plan"
  - "017 hub-root-and-shared tasks"
importance_tier: "important"
contextType: "planning"
parent: "sk-doc/017-hyphen-naming-convention/008-component-migration/002-sk-design/001-hub-root-and-shared"
_memory:
  continuity:
    ...
    answered_questions: []
---
# Implementation Plan: Hub root and shared (017 phase 001)
...
| Aspect | Value |
|-------|-------|
| **Surface** | `.opencode/skills/sk-design/` hub files and its `shared/` reference base |
...
Rename only the non-exempt hub/shared filesystem names to kebab-case and update every reference that resolves those paths.
<!-- /ANCHOR:summary -->
...
### Key Components
- **Inventory**: the live `.opencode/skills/sk-design/` hub files and its `shared/` reference base tree and its exact candidate paths.

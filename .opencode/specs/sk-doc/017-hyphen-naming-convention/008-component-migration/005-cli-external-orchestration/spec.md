---
title: "Feature Specification: cli-external-orchestration component migration (017 phase 005)"
...
_memory:
  continuity:
    packet_pointer: "sk-doc/017-hyphen-naming-convention/008-component-migration/005-cli-external-orchestration"
...
This parent defines eight independently reviewable phases that migrate only in-scope filesystem names to kebab-case, preserve the 017 exemption boundary, verify release evidence, and close with a read-only subtree gate.
<!-- /ANCHOR:problem -->

---
title: "Checklist: remove transition aliases (017 phase 008)"
description: "Checklist for phase 008 of the 017 kebab-case filesystem-naming program: remove transition aliases."
trigger_phrases:
  - "remove transition aliases checklist"
  - "hyphen naming phase 008 checklist"
...
- [ ] CHK-001 [P0] After alias removal, old live root names are rejected by classifier + guard
- [ ] CHK-002 [P0] A scope-aware scan confirms old-name references remain only under frozen/exempt paths
<!-- /ANCHOR:testing -->

<!-- ANCHOR:fix-completeness -->
## Fix Completeness

- [ ] CHK-003 [P1] Lane C scenario count and IDs are unchanged after removal
<!-- /ANCHOR:fix-completeness -->

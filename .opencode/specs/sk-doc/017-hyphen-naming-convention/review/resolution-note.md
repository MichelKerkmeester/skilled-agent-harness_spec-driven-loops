# 017 Pre-Merge Deep-Review — Resolution Note

Pre-merge deep review of the 175-node `sk-doc/017-hyphen-naming-convention` spec tree.
...
| F004-cac9 | P1 | Phase 000 worktree identity de-hardcoded in `spec.md`, `plan.md`, `tasks.md`: allocate an owner-first branch via `worktree-naming.sh create sk-doc 017-hyphen-naming` instead of the literal legacy `wt/0037-*`. |

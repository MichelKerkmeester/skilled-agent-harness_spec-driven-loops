---
title: "Checklist: create-* generators and templates (017 phase 003)"
description: "Checklist for phase 003 of the 017 kebab-case filesystem-naming program: create-* generators and templates."
trigger_phrases:
  - "create-* generators and templates checklist"
  - "hyphen naming phase 003 checklist"
...
_memory:
  continuity:
    ...
    answered_questions: []
---
# Checklist: create-* generators and templates
...
- [ ] CHK-001 [P0] Run all create generators into temporary directories; the emitted tree contains only canonical names and validates
- [ ] CHK-002 [P0] No producer or template still emits old root/index or underscore filesystem names
<!-- /ANCHOR:testing -->

<!-- ANCHOR:fix-completeness -->
## Fix Completeness

- [ ] CHK-003 [P1] The `package_skill.py` regression tests pass against the hyphenated policy
- [ ] CHK-004 [P1] The generators are linked from the convention doc as the reference emitter
<!-- /ANCHOR:fix-completeness -->

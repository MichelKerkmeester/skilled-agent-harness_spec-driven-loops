---
title: "Feature Specification: README, agent, command, changelog, flowchart, diff, and benchmark generators (017 phase 003 child 003)"
...
| Field | Value |
|-------|-------|
| **Packet** | sk-doc/017-hyphen-naming-convention/003-create-generators-and-templates/003-readme-agent-command-changelog-flowchart-diff-benchmark |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Planned |
| **Created** | 2026-07-14 |
| **Owner skill** | sk-doc |
| **Origin** | Child 003 of phase 003 in the 017 kebab-case filesystem-naming program |
<!-- /ANCHOR:metadata -->
...
None blocking; the semantic naming rule and exemption boundary are fixed by the 017 parent and DR-005/DR-008.
<!-- /ANCHOR:questions -->

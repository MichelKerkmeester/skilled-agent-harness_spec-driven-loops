---
title: "Feature Specification: whole-repo verification gate (017 phase 010)"
...
> Phase adjacency under the 017 parent: prerequisite `009-remove-transition-aliases`; successor `011-integrate-and-closeout`.
...
| Field | Value |
|-------|-------|
| **Packet** | sk-doc/017-hyphen-naming-convention/010-whole-repo-gate |
| **Level** | 2 |
| **Priority** | P0 |
| **Status** | Planned |
| **Created** | 2026-07-14 |

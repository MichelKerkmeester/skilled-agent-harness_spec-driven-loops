---
title: "Feature Specification: static reference-rewrite executor (017 phase 005.004)"
...
_memory:
  continuity:
    packet_pointer: "sk-doc/019-hyphen-naming-convention/005-rename-and-reference-tooling/004-reference-rewrite-executor"
...
| Field | Value |
|-------|-------|
| **Packet** | sk-doc/019-hyphen-naming-convention/005-rename-and-reference-tooling/004-reference-rewrite-executor |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Planned |
| **Created** | 2026-07-15 |
| **Owner skill** | sk-doc |
| **Origin** | Child phase 004 of the 017 rename-and-reference-tooling program |
<!-- /ANCHOR:metadata -->
...
The phase inherits the 017 program risks: over-broad rewrites, exemption leakage, broken references, concurrent worktrees, and

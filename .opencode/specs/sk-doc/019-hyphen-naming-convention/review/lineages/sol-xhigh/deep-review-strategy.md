...
Review the complete planning packet at `.opencode/specs/sk-doc/019-hyphen-naming-convention` for correctness, security, traceability, and maintainability. The review target is read-only.

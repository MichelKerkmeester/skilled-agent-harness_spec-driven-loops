---
title: "Checklist: Feature-catalog (017 phase 008)"
description: "Blocking SOL verification contract for Feature-catalog in the 017 sk-design naming subtree."
trigger_phrases:
  - "feature-catalog verification"
  - "sk-design feature-catalog checklist"
  - "017 feature-catalog gate"
importance_tier: "important"
contextType: "planning"
parent: "sk-doc/019-hyphen-naming-convention/008-component-migration/002-sk-design/008-feature-catalog"
_memory:
  continuity:
    packet_pointer: "sk-doc/019-hyphen-naming-convention/008-component-migration/002-sk-design/008-feature-catalog"
    ...
    answered_questions: []
---
# Checklist: Feature-catalog (017 phase 008)
...
This checklist is the blocking SOL verifier contract for phase 008. Every item is a check the paired verify agent runs BEFORE the candidate phase is accepted; the report pins the candidate SHA and BASE SHA, records commands, exit codes, counts, and evidence, and fails on zero tests/scenarios or unexpected tracked mutation.
<!-- /ANCHOR:protocol -->
...
- [ ] CHK-008 [P1] Changes are limited to feature-catalog; no adjacent cleanup or sibling-phase rename is included
...
- [ ] CHK-001 [P0] The recursive map covers all seven feature_catalog roots, every feature_catalog.md index, category directories, and underscore-bearing feature files
- [ ] CHK-002 [P0] Each catalog index and catalog-owned cross-reference resolves under feature-catalog/, with catalog→playbook handoffs recorded
- [ ] CHK-003 [P0] All seven catalog trees are clean while feature IDs, frontmatter keys, category semantics, and scenario references remain unchanged
<!-- /ANCHOR:testing -->

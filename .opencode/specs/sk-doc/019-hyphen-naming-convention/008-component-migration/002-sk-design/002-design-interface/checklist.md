---
title: "Checklist: Design-interface (017 phase 002)"
description: "Blocking SOL verification contract for Design-interface in the 017 sk-design naming subtree."
trigger_phrases:
  - "design-interface verification"
  - "sk-design design-interface checklist"
  - "017 design-interface gate"
importance_tier: "important"
contextType: "planning"
parent: "sk-doc/019-hyphen-naming-convention/008-component-migration/002-sk-design/002-design-interface"
_memory:
  continuity:
    packet_pointer: "sk-doc/019-hyphen-naming-convention/008-component-migration/002-sk-design/002-design-interface"
    last_updated_at: "2026-07-14T16:00:00Z"
    last_updated_by: "codex"
    recent_action: "Authored design-interface checklist"
    ...
    answered_questions: []
---
# Checklist: Design-interface (017 phase 002)
...
This checklist is the blocking SOL verifier contract for phase 002. Every item is a check the paired verify agent runs BEFORE the candidate phase is accepted; the report pins the candidate SHA and BASE SHA, records commands, exit codes, counts, and evidence, and fails on zero tests/scenarios or unexpected tracked mutation.
<!-- /ANCHOR:protocol -->
...
- [ ] CHK-008 [P1] Changes are limited to design-interface; no adjacent cleanup or sibling-phase rename is included
...
- [ ] CHK-001 [P0] The map covers interface-preflight-card.md, the six procedures, design-grounding/design-process/mcp-tooling directories, and their underscore-bearing files
- [ ] CHK-002 [P0] design-interface/SKILL.md, README.md, procedure links, and reference tables resolve the renamed assets and references
- [ ] CHK-003 [P0] The design-interface tree outside feature-catalog/manual-testing-playbook has no in-scope underscore path and its route/content semantics are unchanged
<!-- /ANCHOR:testing -->

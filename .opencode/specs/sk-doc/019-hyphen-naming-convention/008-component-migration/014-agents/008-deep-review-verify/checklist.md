---
title: "Checklist: verify deep-review agent naming (017 phase 008)"
description: "Checklist for phase 008 of the 017 agents component migration: verify the deep-review filename candidate set."
trigger_phrases:
...
- [ ] CHK-001 [P0] The pinned BASE and all three runtime agent directories are available for the deep-review inventory
...
- [ ] CHK-005 [P0] The inventory records exactly .opencode/agents/deep-review.md, .claude/agents/deep-review.md, and .codex/agents/deep-review.toml

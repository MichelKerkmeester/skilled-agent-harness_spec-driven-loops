---
title: "Implementation Plan: verify deep-review agent naming (017 phase 008)"
description: "Implementation Plan for phase 008 of the 017 agents component migration: a read-only deep-review filename candidate audit."
trigger_phrases:
...
_memory:
  continuity:
    packet_pointer: "sk-doc/019-hyphen-naming-convention/008-component-migration/014-agents/008-deep-review-verify"
...
# Implementation Plan: Deep Review Agent Naming Verification
...
- OpenCode definition: .opencode/agents/deep-review.md
- Claude definition: .claude/agents/deep-review.md
- Codex definition: .codex/agents/deep-review.toml
...
|-------------|--------------|
| REQ-001 | Path-level inventory lists .opencode/agents/deep-review.md, .claude/agents/deep-review.md, and .codex/agents/deep-review.toml |

---
title: "Implementation Plan: verify deep-improvement agent naming (017 phase 006)"
description: "Implementation Plan for phase 006 of the 017 agents component migration: a read-only deep-improvement filename candidate audit."
trigger_phrases:
  - "deep-improvement agent naming implementation plan"
  - "agents phase 006 implementation plan"
...
# Implementation Plan: Deep Improvement Agent Naming Verification
...
- [ ] The expected deep-improvement definition paths are listed in spec.md
...
- OpenCode definition: .opencode/agents/deep-improvement.md
- Claude definition: .claude/agents/deep-improvement.md
- Codex definition: .codex/agents/deep-improvement.toml
...
- Confirm all three expected deep-improvement definition paths exist in the runtime inventory.
...
|-------------|--------------|
| REQ-001 | Path-level inventory lists .opencode/agents/deep-improvement.md, .claude/agents/deep-improvement.md, and .codex/agents/deep-improvement.toml |

---
title: "Checklist: verify deep-research agent naming (017 phase 007)"
description: "Checklist for phase 007 of the 017 agents component migration: verify the deep-research filename candidate set."
trigger_phrases:
...
_memory:
  continuity:
    packet_pointer: "sk-doc/019-hyphen-naming-convention/008-component-migration/014-agents/007-deep-research-verify"
...
# Checklist: Deep Research Agent Naming Verification
...
- [ ] CHK-001 [P0] The pinned BASE and all three runtime agent directories are available for the deep-research inventory
...
- [ ] CHK-005 [P0] The inventory records exactly .opencode/agents/deep-research.md, .claude/agents/deep-research.md, and .codex/agents/deep-research.toml

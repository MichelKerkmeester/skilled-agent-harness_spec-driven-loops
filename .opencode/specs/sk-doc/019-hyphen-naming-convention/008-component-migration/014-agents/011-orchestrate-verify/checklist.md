---
title: "Checklist: verify orchestrate agent naming (017 phase 011)"
description: "Checklist for phase 011 of the 017 agents component migration: verify the orchestrate filename candidate set."
trigger_phrases:
  - "orchestrate agent naming checklist"
  - "agents phase 011 checklist"
importance_tier: "important"
contextType: "planning"
parent: "sk-doc/019-hyphen-naming-convention/008-component-migration/014-agents"
_memory:
  continuity:
    packet_pointer: "sk-doc/019-hyphen-naming-convention/008-component-migration/014-agents/011-orchestrate-verify"
...
- [ ] CHK-001 [P0] The pinned BASE and all three runtime agent directories are available for the orchestrate inventory
...
- [ ] CHK-005 [P0] The inventory records exactly .opencode/agents/orchestrate.md, .claude/agents/orchestrate.md, and .codex/agents/orchestrate.toml

---
title: "Feature Specification: verify orchestrate agent naming (017 phase 011)"
...
> Phase adjacency under the 017 agents component parent (grouping order, not a runtime dependency): predecessor 010-markdown-verify; successor 012-prompt-improver-verify.
...
| Field | Value |
|-------|-------|
| **Packet** | sk-doc/019-hyphen-naming-convention/008-component-migration/014-agents/011-orchestrate-verify |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Planned |
| **Created** | 2026-07-14 |
| **Owner skill** | sk-doc |
| **Origin** | Phase 011 of the 017 agents component migration |
<!-- /ANCHOR:metadata -->

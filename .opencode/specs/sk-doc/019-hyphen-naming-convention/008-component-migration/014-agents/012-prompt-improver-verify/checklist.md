---
title: "Checklist: verify prompt-improver agent naming (017 phase 012)"
description: "Checklist for phase 012 of the 017 agents component migration: verify the prompt-improver filename candidate set."
trigger_phrases:
...
# Checklist: Prompt Improver Agent Naming Verification
...
This checklist is the blocking SOL verifier contract for phase 012. Every item is a check the paired
...
- [ ] CHK-001 [P0] The pinned BASE and all three runtime agent directories are available for the prompt-improver inventory
...
- [ ] CHK-005 [P0] The inventory records exactly .opencode/agents/prompt-improver.md, .claude/agents/prompt-improver.md, and .codex/agents/prompt-improver.toml

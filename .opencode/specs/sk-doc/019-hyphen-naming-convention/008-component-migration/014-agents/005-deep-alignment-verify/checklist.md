---
title: "Checklist: verify deep-alignment agent naming (017 phase 005)"
description: "Checklist for phase 005 of the 017 agents component migration: verify the deep-alignment filename candidate set."
trigger_phrases:
...
# Checklist: Deep Alignment Agent Naming Verification
...
- [ ] CHK-001 [P0] The pinned BASE and all three runtime agent directories are available for the deep-alignment inventory
...
- [ ] CHK-005 [P0] The inventory records exactly .opencode/agents/deep-alignment.md, .claude/agents/deep-alignment.md, and .codex/agents/deep-alignment.toml

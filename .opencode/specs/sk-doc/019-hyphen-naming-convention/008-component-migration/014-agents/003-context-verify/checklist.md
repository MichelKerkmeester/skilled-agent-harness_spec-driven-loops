---
title: "Checklist: verify context agent naming (017 phase 003)"
description: "Checklist for phase 003 of the 017 agents component migration: verify the context filename candidate set."
trigger_phrases:
...
_memory:
  continuity:
    packet_pointer: "sk-doc/019-hyphen-naming-convention/008-component-migration/014-agents/003-context-verify"
...
# Checklist: Context Agent Naming Verification
...
- [ ] CHK-001 [P0] The pinned BASE and all three runtime agent directories are available for the context inventory
...
- [ ] CHK-005 [P0] The inventory records exactly .opencode/agents/context.md, .claude/agents/context.md, and .codex/agents/context.toml

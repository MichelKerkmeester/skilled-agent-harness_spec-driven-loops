---
title: "Checklist: verify code agent naming (017 phase 002)"
description: "Checklist for phase 002 of the 017 agents component migration: verify the code filename candidate set."
trigger_phrases:

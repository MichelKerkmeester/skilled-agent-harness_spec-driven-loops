---
title: "Implementation Plan: verify markdown agent naming (017 phase 010)"
description: "Implementation Plan for phase 010 of the 017 agents component migration: a read-only markdown filename candidate audit."
trigger_phrases:
  - "markdown agent naming implementation plan"
  - "agents phase 010 implementation plan"
importance_tier: "important"
contextType: "planning"
parent: "sk-doc/019-hyphen-naming-convention/008-component-migration/014-agents"
_memory:
  continuity:
    packet_pointer: "sk-doc/019-hyphen-naming-convention/008-component-migration/014-agents/010-markdown-verify"
...
# Implementation Plan: Markdown Agent Naming Verification
...
- [ ] The expected markdown definition paths are listed in spec.md
...
- OpenCode definition: .opencode/agents/markdown.md
- Claude definition: .claude/agents/markdown.md
- Codex definition: .codex/agents/markdown.toml
...
- Confirm all three expected markdown definition paths exist in the runtime inventory.
...
|-------------|--------------|
| REQ-001 | Path-level inventory lists .opencode/agents/markdown.md, .claude/agents/markdown.md, and .codex/agents/markdown.toml |

---
title: "Checklist: verify debug agent naming (017 phase 004)"
description: "Checklist for phase 004 of the 017 agents component migration: verify the debug filename candidate set."
trigger_phrases:
...
# Checklist: Debug Agent Naming Verification
...
- [ ] CHK-001 [P0] The pinned BASE and all three runtime agent directories are available for the debug inventory
...
- [ ] CHK-005 [P0] The inventory records exactly .opencode/agents/debug.md, .claude/agents/debug.md, and .codex/agents/debug.toml

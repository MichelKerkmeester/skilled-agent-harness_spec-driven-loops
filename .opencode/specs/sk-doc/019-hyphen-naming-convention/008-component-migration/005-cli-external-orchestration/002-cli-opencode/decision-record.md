---
title: "Decision Record: cli-opencode component naming (017 phase 005.002)"
...
The nested `manual_testing_playbook/` tree belongs to phase 005. Existing hyphenated JavaScript under `scripts/` is protected by inventory, and changelog history is frozen under the 017 program boundary.
<!-- /ANCHOR:decisions -->

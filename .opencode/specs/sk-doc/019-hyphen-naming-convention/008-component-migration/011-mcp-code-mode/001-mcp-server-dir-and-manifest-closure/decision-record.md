---
title: "Decision Record: mcp-server path closure (017 component 011 phase 001)"
...
paths refer to that directory. The 017 policy requires permitted filesystem names to use kebab-case, but it explicitly
...
rename of every underscore-bearing token would violate the 017 exemption boundary and could change npm or TypeScript
behavior.
...
- Program convention and exemption decisions: sk-doc/019-hyphen-naming-convention/001-convention-policy-and-scope/decision-record.md
- Program scope and sequencing: sk-doc/019-hyphen-naming-convention/spec.md

...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/sk-doc/019-hyphen-naming-convention/008-component-migration/010-system-code-graph/001-mcp-server-dir-and-manifest-closure/checklist.md"
      - ".opencode/specs/sk-doc/019-hyphen-naming-convention/008-component-migration/010-system-code-graph/006-manual-testing-playbook/checklist.md"
    completion_pct: 0
    open_questions: []
    answered_questions:
...
| Field | Value |
|-------|-------|
| **Packet** | sk-doc/019-hyphen-naming-convention/008-component-migration/010-system-code-graph/007-changelog-verify |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Planned |
| **Created** | 2026-07-14 |
...
The current system-code-graph release history ends at v1.3.0.0, which predates the 017 kebab-case filesystem

---
title: "Implementation Plan: design command namespace naming (017 phase 008/013/003)"
...
parent: "sk-doc/019-hyphen-naming-convention/008-component-migration/013-commands/003-design-namespace"
_memory:
  continuity:
    packet_pointer: "sk-doc/019-hyphen-naming-convention/008-component-migration/013-commands/003-design-namespace"
...
|------------|------|--------|-------------------|
| 017 phase 005 rename/reference tooling | Internal | Required before execution | Manual replacement can alter keys or miss path consumers. |
| 017 phase 006 frozen map | Internal | Required before execution | Targets and ownership are not fixed. |

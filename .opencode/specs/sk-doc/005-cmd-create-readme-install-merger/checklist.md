...
- [x] CHK-001 [P0] `spec.md` documents merge scope, requirements, and constraints [Evidence: `.opencode/specs/03--commands-and-skills/020-cmd-create-readme-install-merger/spec.md`]
- [x] CHK-002 [P0] `plan.md` defines canonical naming, routing, and migration strategy [Evidence: `.opencode/specs/03--commands-and-skills/020-cmd-create-readme-install-merger/plan.md`]

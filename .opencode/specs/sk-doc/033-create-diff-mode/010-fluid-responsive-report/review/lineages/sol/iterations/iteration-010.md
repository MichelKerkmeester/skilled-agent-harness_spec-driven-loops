...
- Every active finding has concrete source evidence: P0-001 at cleanup's manifest-derived unlink [SOURCE: `.opencode/skills/sk-doc/create-diff/scripts/create_diff.py:1431-1448`], P1-001 at the unsupported-unit fallback contract and variable-backed declarations [SOURCE: `.opencode/specs/sk-doc/033-create-diff-mode/010-fluid-responsive-report/spec.md:137`; `.opencode/skills/sk-doc/create-diff/scripts/create_diff.py:720-727`], and P2-001 at the narrow regression assertion [SOURCE: `.opencode/skills/sk-doc/create-diff/scripts/test_create_diff.py:325-332`].

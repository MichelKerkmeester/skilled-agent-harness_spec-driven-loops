...
_memory:
  continuity:
    packet_pointer: "sk-doc/017-benchmark-authoring-centralization"
...
| 002 | `002-benchmark-authoring-completion-and-crosslinks/` | Author the Lane A guide, complete the create-benchmark ↔ deep-loop cross-links, and land the fixtureDir/metadata/sibling corrections | Complete |

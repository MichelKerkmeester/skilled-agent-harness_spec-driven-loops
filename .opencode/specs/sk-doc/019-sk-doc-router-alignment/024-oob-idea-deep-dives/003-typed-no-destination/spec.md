...
Seed evidence (do NOT re-derive): `../../021-default-mode-policy-research/research/lineages/sol-oob/iterations/iteration-003.md` and lineage `research.md` §4.3, §11(1). Cross-domain sources already gathered: Linux cpuidle, RFC 4191, RFC 9520, AWS NLB fail-open, Australian no-wrong-door referral guidance.

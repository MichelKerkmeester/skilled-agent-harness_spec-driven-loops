...
- **Parent design (source of truth)**: `../../../009-unified-refactor-research/unified-refactor-synthesis.md` — Idea 5 (§3 table), §2.3 (closed decision algebra), §4 (recovery ladder), §8.1 (advisor read), §11 Q2 (parked corpus), §10 (constraint compliance).

...
- **Source design**: `../../009-unified-refactor-research/unified-refactor-synthesis.md` (§7 sk-code archetype; §9 stages 4/6; §2.3 closed algebra; §8.1–§8.3 three-dimension read; §10 constraint compliance)

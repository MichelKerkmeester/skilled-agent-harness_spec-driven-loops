...
_memory:
  continuity:
    packet_pointer: "sk-doc/019-sk-doc-router-alignment"
...
| `.opencode/specs/sk-doc/019-sk-doc-router-alignment/**` | Create | 001-006 | Audit map, evidence, decisions, verification, and router-marker gap analysis |
<!-- /ANCHOR:scope -->
...
- Use `/spec_kit:resume .opencode/specs/sk-doc/019-sk-doc-router-alignment/006-router-conformance-gap-analysis/` to resume the active phase

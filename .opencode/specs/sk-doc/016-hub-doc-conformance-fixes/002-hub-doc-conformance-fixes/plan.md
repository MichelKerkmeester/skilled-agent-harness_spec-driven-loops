---
title: "Implementation Plan: Hub Doc Conformance Fixes [016-hub-doc-conformance-fixes/002-hub-doc-conformance-fixes]"
description: "Verify-first fix protocol, four-work-stream partition, doc-layer/routing-layer coordination boundary, and the re-run-deep-review gate for remediating the 016-hub-doc-conformance-fixes/001-hub-doc-conformance-review FAIL verdict."
trigger_phrases:
  - "implementation"
  - "plan"
...
- [ ] Re-run `016-hub-doc-conformance-fixes/001-hub-doc-conformance-review`'s scope (or an equivalent `/deep:review` dispatch) against `cli-external` + `mcp-tooling`.
...
| Manual (end-to-end) | Whole-corpus re-verification | Re-run of `016-hub-doc-conformance-fixes/001-hub-doc-conformance-review`'s scope (Phase 3 gate) |
<!-- /ANCHOR:testing -->
...
| M3 | Release-ready | Re-run of `016-hub-doc-conformance-fixes/001-hub-doc-conformance-review`'s scope reports 0 active P0 findings or an approved carry-over list | End of Phase 3 |
<!-- /ANCHOR:milestones -->

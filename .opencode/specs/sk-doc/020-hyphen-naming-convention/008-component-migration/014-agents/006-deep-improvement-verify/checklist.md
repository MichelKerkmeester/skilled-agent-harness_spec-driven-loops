...
# Checklist: Deep Improvement Agent Naming Verification
...
- [ ] CHK-001 [P0] The pinned BASE and all three runtime agent directories are available for the deep-improvement inventory
...
- [ ] CHK-005 [P0] The inventory records exactly .opencode/agents/deep-improvement.md, .claude/agents/deep-improvement.md, and .codex/agents/deep-improvement.toml

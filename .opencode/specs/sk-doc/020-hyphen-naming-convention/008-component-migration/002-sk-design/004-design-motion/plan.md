...
_memory:
  continuity:
    ...
    recent_action: "Authored design-motion plan"
...
| Aspect | Value |
|-------|-------|
| **Surface** | `.opencode/skills/sk-design/design-motion/` outside its feature-catalog and manual-testing-playbook trees |
...
Rename the motion mode's non-exempt filesystem names to kebab-case and update its resource references without changing motion guidance.
<!-- /ANCHOR:summary -->
...
### Key Components
- **Inventory**: the live `.opencode/skills/sk-design/design-motion/` outside its feature-catalog and manual-testing-playbook trees tree and its exact candidate paths.

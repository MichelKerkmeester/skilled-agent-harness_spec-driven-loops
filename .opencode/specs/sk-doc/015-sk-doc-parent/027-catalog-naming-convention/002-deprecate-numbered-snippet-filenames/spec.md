...
| Field | Value |
|-------|-------|
| **Packet** | sk-doc/015-sk-doc-parent/027-catalog-naming-convention/002-deprecate-numbered-snippet-filenames |
...
- **Repeating 108's self-exclusion bug** — 108's own deny-list referenced a non-existent
  `999-sk-doc-parent` path; 026's deny-list must use the correct `015-sk-doc-parent` packet path (see

...
- [x] CHK-050 [P1] Packet is a phase child of 028 (`sk-doc/015-sk-doc-parent/028-create-skill-contract-unification/001-parent-hub-canon`) [EVIDENCE: folder path + `parent:` frontmatter]

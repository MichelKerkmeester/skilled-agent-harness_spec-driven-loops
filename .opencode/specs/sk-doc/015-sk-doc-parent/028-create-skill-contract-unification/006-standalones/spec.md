---
title: "Feature Specification: Standalone Skills Contract Conformance"
...
trigger_phrases:
  - "006-standalones conformance"
  - "create-skill contract conformance"
  - "SKILL.md conformance standalones"
...
# Feature Specification: Standalone Skills Contract Conformance

> **Phase adjacency** (grouping order under the parent, not a runtime dependency): predecessor `005-code-cli-mcp-prompt-children`; successor `007-fresh-verify-remediation`.
...
| Field | Value |
|-------|-------|
| **Packet** | sk-doc/015-sk-doc-parent/028-create-skill-contract-unification/006-standalones |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Complete |
| **Created** | 2026-07-14 |
...
| `.opencode/skills/mcp-code-mode/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-git/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/system-code-graph/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/system-skill-advisor/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/system-spec-kit/SKILL.md` | Modify | Conform to contract |
...
|----|-------------|----------|
| REQ-001 | `.opencode/skills/mcp-code-mode/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-002 | `.opencode/skills/sk-git/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-003 | `.opencode/skills/system-code-graph/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-004 | `.opencode/skills/system-skill-advisor/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-005 | `.opencode/skills/system-spec-kit/SKILL.md` conforms to the contract and passes its validator | P0 |
<!-- /ANCHOR:requirements -->

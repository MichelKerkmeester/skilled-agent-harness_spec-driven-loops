---
title: "Implementation Plan: Standalone Skills Contract Conformance"
description: "Per-file dispatch harness: a fresh LUNA MAX update then a fresh Sonnet-5 xhigh verify then the validator gate, run >=5 in parallel across the 5 files in this batch."
trigger_phrases:
  - "006-standalones plan"
...
# Implementation Plan: Standalone Skills Contract Conformance
...
### Overview
Each of the 5 files is one independent work-item: LUNA MAX updates it to the machine-readable create-skill contract (`sk-doc/shared/assets/skill_contract.json`), a fresh Sonnet-5
...
- [x] File inventory frozen (5 files) [EVIDENCE: spec.md SCOPE table]
...
- [ ] Dispatch LUNA MAX updates in waves of >=5 across the 5 files
- [ ] As each update returns, launch its fresh Sonnet-5 xhigh verifier

### Phase 3: Verification
- [ ] Validator green on all 5 files
- [ ] Owning-hub regression check green
...
| Core (5 files, waves of >=5) | Medium | ~1 update+verify waves |

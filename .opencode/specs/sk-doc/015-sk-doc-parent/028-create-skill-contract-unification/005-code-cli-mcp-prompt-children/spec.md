---
title: "Feature Specification: sk-code / cli / mcp / sk-prompt Children Contract Conformance"
description: "Bring the 12 skill SKILL.md files in this batch into full conformance with the create-skill contract; each file is updated by a fresh GPT-5.6 LUNA MAX agent and independently verified by a fresh Sonnet-5 xhigh agent, then must pass its validator."
trigger_phrases:
  - "005-code-cli-mcp-prompt-children conformance"
  - "create-skill contract conformance"
  - "SKILL.md conformance code-cli-mcp-prompt-children"
...
# Feature Specification: sk-code / cli / mcp / sk-prompt Children Contract Conformance

> **Phase adjacency** (grouping order under the parent, not a runtime dependency): predecessor `004-deep-loop-children`; successor `006-standalones`.
...
| Field | Value |
|-------|-------|
| **Packet** | sk-doc/015-sk-doc-parent/028-create-skill-contract-unification/005-code-cli-mcp-prompt-children |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Complete |
| **Created** | 2026-07-14 |
| **Parent Packet** | sk-doc/015-sk-doc-parent/028-create-skill-contract-unification |
| **Files in batch** | 12 |
...
concrete batch of 12 SKILL.md files so every skill in the batch measures against the same rules.
...
**In scope:** the 12 files below, plus each file's own resource-doc frontmatter where the validator requires it.

| `.opencode/skills/sk-code/code-opencode/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-code/code-quality/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-code/code-review/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-code/code-webflow/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/cli-external-orchestration/cli-claude-code/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/cli-external-orchestration/cli-codex/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/cli-external-orchestration/cli-opencode/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/mcp-tooling/mcp-chrome-devtools/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/mcp-tooling/mcp-click-up/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/mcp-tooling/mcp-figma/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-prompt/prompt-improve/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-prompt/prompt-models/SKILL.md` | Modify | Conform to contract |
...
|----|-------------|----------|
| REQ-001 | `.opencode/skills/sk-code/code-opencode/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-002 | `.opencode/skills/sk-code/code-quality/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-003 | `.opencode/skills/sk-code/code-review/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-004 | `.opencode/skills/sk-code/code-webflow/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-005 | `.opencode/skills/cli-external-orchestration/cli-claude-code/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-006 | `.opencode/skills/cli-external-orchestration/cli-codex/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-007 | `.opencode/skills/cli-external-orchestration/cli-opencode/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-008 | `.opencode/skills/mcp-tooling/mcp-chrome-devtools/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-009 | `.opencode/skills/mcp-tooling/mcp-click-up/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-010 | `.opencode/skills/mcp-tooling/mcp-figma/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-011 | `.opencode/skills/sk-prompt/prompt-improve/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-012 | `.opencode/skills/sk-prompt/prompt-models/SKILL.md` conforms to the contract and passes its validator | P0 |
<!-- /ANCHOR:requirements -->
...
1. All 12 files pass their validator (`python3 .opencode/skills/sk-doc/create-skill/scripts/package_skill.py <skill-dir> --check --strict`) with zero errors/warnings.

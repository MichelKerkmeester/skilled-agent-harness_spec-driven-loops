---
title: "Feature Specification: sk-design Children Contract Conformance"
description: "Bring the 6 skill SKILL.md files in this batch into full conformance with the create-skill contract; each file is updated by a fresh GPT-5.6 LUNA MAX agent and independently verified by a fresh Sonnet-5 xhigh agent, then must pass its validator."
trigger_phrases:
  - "003-sk-design-children conformance"
  - "create-skill contract conformance"
  - "SKILL.md conformance sk-design-children"
...
# Feature Specification: sk-design Children Contract Conformance

> **Phase adjacency** (grouping order under the parent, not a runtime dependency): predecessor `002-sk-doc-children`; successor `004-deep-loop-children`.
...
| Field | Value |
|-------|-------|
| **Packet** | sk-doc/015-sk-doc-parent/028-create-skill-contract-unification/003-sk-design-children |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Complete |
| **Created** | 2026-07-14 |
...
concrete batch of 6 SKILL.md files so every skill in the batch measures against the same rules.
...
**In scope:** the 6 files below, plus each file's own resource-doc frontmatter where the validator requires it.

| `.opencode/skills/sk-design/design-audit/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-design/design-foundations/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-design/design-interface/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-design/design-mcp-open-design/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-design/design-md-generator/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-design/design-motion/SKILL.md` | Modify | Conform to contract |
...
|----|-------------|----------|
| REQ-001 | `.opencode/skills/sk-design/design-audit/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-002 | `.opencode/skills/sk-design/design-foundations/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-003 | `.opencode/skills/sk-design/design-interface/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-004 | `.opencode/skills/sk-design/design-mcp-open-design/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-005 | `.opencode/skills/sk-design/design-md-generator/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-006 | `.opencode/skills/sk-design/design-motion/SKILL.md` conforms to the contract and passes its validator | P0 |
<!-- /ANCHOR:requirements -->
...
1. All 6 files pass their validator (`python3 .opencode/skills/sk-doc/create-skill/scripts/package_skill.py <skill-dir> --check --strict`) with zero errors/warnings.

...
trigger_phrases:
  - "mcp magnific readme"
  - "magnific readme rewrite"
  - "mode readme revisit magnific"
...
_memory:
  continuity:
    ...
    recent_action: "Scaffolded phase 011 docs (spec, plan, tasks, checklist) inside 005-mode-child-readme-revisit"
    next_safe_action: "Execute phase 011 work: rewrite the mcp-magnific skill README per tasks.md"
    blockers: []
    key_files:
...
# Feature Specification: Phase 011 mcp-magnific mode skill README rewrite
...
| **Predecessor** | `010-mcp-figma` |
| **Successor** | `012-mcp-mobbin` |
| **Handoff Criteria** | The mcp-magnific skill README is purpose-first on the refined template with a one-line pitch and a problem-first OVERVIEW, passes the HVR grep with zero violations, carries a bumped version field and a changelog entry, passes `validate_document.py --type readme` with zero issues and this phase folder validates with zero errors |
<!-- /ANCHOR:metadata -->
...
### Problem Statement
The skill README at `.opencode/skills/mcp-tooling/mcp-magnific/README.md` still carries the older tabular reference-card style and predates the pilot standard. The mcp-obsidian README pilot proved the standard for mode skill READMEs: narrative, purpose-first documents in the Human Voice Rules, validated by the sk-doc README validator. The magnific README predates those learnings and does not yet follow the refined template from phase 001. The mode is an unregistered child of the mcp-tooling hub, so the README must stay honest about planned versus shipped state.
...
### Out of Scope
- SKILL.md content for mcp-magnific.
...
|-----------|-------------|-------------|
| `.opencode/skills/mcp-tooling/mcp-magnific/README.md` | Rewrite | Purpose-first rewrite per the refined template with a one-line pitch, a problem-first OVERVIEW and a bumped version field |
| `.opencode/skills/mcp-tooling/mcp-magnific/changelog/v0.1.1.0.md` | Add | Changelog entry recording the README rewrite |
| `.opencode/specs/sk-doc/026-skill-readme-refinement/005-mode-child-readme-revisit/011-mcp-magnific/spec.md` | Create | Phase specification (this file) |
| `.opencode/specs/sk-doc/026-skill-readme-refinement/005-mode-child-readme-revisit/011-mcp-magnific/plan.md` | Create | Phase implementation plan |
| `.opencode/specs/sk-doc/026-skill-readme-refinement/005-mode-child-readme-revisit/011-mcp-magnific/tasks.md` | Create | Phase task list |
| `.opencode/specs/sk-doc/026-skill-readme-refinement/005-mode-child-readme-revisit/011-mcp-magnific/checklist.md` | Create | Phase verification checklist |
...
| REQ-005 | Version bump and changelog entry | The frontmatter version field is bumped and a changelog entry exists at `changelog/v0.1.1.0.md` |
...
- **SC-003**: The version field is bumped and `changelog/v0.1.1.0.md` records the change.
...
| Risk | Unregistered skill status | The README could claim shipped states that do not exist | Preserve the current status facts and keep planned items marked as planned |
<!-- /ANCHOR:risks -->

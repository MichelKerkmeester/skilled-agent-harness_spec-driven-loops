---
title: "Feature Specification: Phase 037 deep-improvement README revisit"
description: "Rewrite the deep-improvement README at .opencode/skills/system-deep-loop/deep-improvement/README.md against the refined README template from phase 001 and the mcp-obsidian exemplar, with a version bump and a changelog entry."
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "Scaffolded phase 037 docs (spec, plan, tasks, checklist) inside 005-mode-child-readme-revisit"
    next_safe_action: "Execute phase 037 work: rewrite the deep-improvement README per tasks.md"
    blockers: []
    key_files:
...
# Feature Specification: Phase 037 deep-improvement README revisit
...
| **Predecessor** | `036-deep-alignment` |
| **Successor** | `038-deep-research` |
| **Handoff Criteria** | The deep-improvement README is purpose-first on the refined template with a one-line pitch and a problem-first OVERVIEW, the version field is bumped to `1.17.1.0` with `changelog/v1.17.1.0.md` added, the validator reports zero issues and this phase folder validates with zero errors |
<!-- /ANCHOR:metadata -->
...
### Problem Statement
The deep-improvement README at `.opencode/skills/system-deep-loop/deep-improvement/README.md` still carries the older tabular reference-card style, opens with an AT A GLANCE table before the OVERVIEW and predates the pilot standard proven by the mcp-obsidian README. The frontmatter `version` field reads `1.17.0.38` while the newest changelog entry is `v1.17.0.1.md`, so the README claims a version with no matching entry. The skill is the deepest of the deep loop family with three co-equal lanes, a guarded promotion gate and multiple scripts, so the reference-card style scales poorly for anyone who needs to learn the skill from the README.
...
### In Scope
- Read the current README at `.opencode/skills/system-deep-loop/deep-improvement/README.md` and record the baseline: version field value, validator output and link state.
- Rewrite the README purpose-first per the refined template with a one-line pitch and a problem-first OVERVIEW.
- Bump the frontmatter `version` field from `1.17.0.38` to `1.17.1.0`.
- Add the changelog entry `changelog/v1.17.1.0.md`.
...
### Out of Scope
- Edits to `SKILL.md` content or frontmatter of the deep-improvement package.
...
- Edits to scripts, references, feature catalog, manual testing playbook, benchmark or vault files.
- Changes to changelog entries other than the new `v1.17.1.0.md` entry.

### Files to Change

| File Path | Change Type | Description |
|-----------|-------------|-------------|
| `.opencode/skills/system-deep-loop/deep-improvement/README.md` | Rewrite | Purpose-first README on the refined template: one-line pitch, problem-first OVERVIEW, capability sections, integration and navigation, version bump to `1.17.1.0` |
| `.opencode/skills/system-deep-loop/deep-improvement/changelog/v1.17.1.0.md` | Add | Changelog entry summarizing the README rewrite |
| `.opencode/specs/sk-doc/026-skill-readme-refinement/005-mode-child-readme-revisit/037-deep-improvement/spec.md` | Create | Phase specification (this file) |
| `.opencode/specs/sk-doc/026-skill-readme-refinement/005-mode-child-readme-revisit/037-deep-improvement/plan.md` | Create | Phase implementation plan |
| `.opencode/specs/sk-doc/026-skill-readme-refinement/005-mode-child-readme-revisit/037-deep-improvement/tasks.md` | Create | Phase task list |
| `.opencode/specs/sk-doc/026-skill-readme-refinement/005-mode-child-readme-revisit/037-deep-improvement/checklist.md` | Create | Phase verification checklist |
...
| REQ-002 | Baseline inventory recorded for the current README | The version field value `1.17.0.38`, the validator output and the link state are recorded as evidence in tasks.md |
...
| REQ-005 | Version field bumped with a matching changelog entry | The frontmatter `version` field reads `1.17.1.0` and `changelog/v1.17.1.0.md` exists with a summary of the rewrite |
...
- **SC-003**: The version field is bumped to `1.17.1.0` and `changelog/v1.17.1.0.md` exists.

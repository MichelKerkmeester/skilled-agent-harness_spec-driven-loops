...
_memory:
  continuity:
    ...
    recent_action: "Scaffolded phase 020 docs (spec, plan, tasks, checklist) inside 005-mode-child-readme-revisit"
    next_safe_action: "Execute phase 020 work: rewrite the sk-design-mcp-open-design README per the refined template"
    blockers: []
    key_files:
...
# Feature Specification: Phase 020 sk-design-mcp-open-design README revisit
...
| **Predecessor** | `019-sk-design-interface` |
| **Successor** | `021-sk-design-md-generator` |
| **Handoff Criteria** | The sk-design-mcp-open-design README is rewritten purpose-first on the refined template, HVR clean, versioned with a changelog entry, validated with zero issues and this phase folder validates with zero errors |
<!-- /ANCHOR:metadata -->
...
### Problem Statement
The mcp-obsidian README pilot proved the standard for mode skill READMEs: narrative, purpose-first documents in the Human Voice Rules, validated by the sk-doc README validator. The sk-design-mcp-open-design README still carries the older tabular reference-card style and predates the pilot standard. It describes a real MCP surface with real gates, so a reader needs the purpose-first shape to grasp the wire, read and run directions quickly. The refined template from phase 001 adds Human Voice Rules enforcement, versioning conventions and a stricter validation checklist that the current README has never been measured against.
...
**End goal:** a purpose-first README for the open-design MCP transport that reads clean under the Human Voice Rules, carries a bumped version field with a changelog entry and reports zero validator issues.
<!-- /ANCHOR:problem -->
...
### Out of Scope
- SKILL.md content and any other file inside the sk-design-mcp-open-design skill folder.
...
|-----------|-------------|-------------|
| `.opencode/skills/sk-design/sk-design-mcp-open-design/README.md` | Rewrite | Purpose-first narrative on the refined template with a one-line pitch and a problem-first OVERVIEW |
| `.opencode/skills/sk-design/sk-design-mcp-open-design/changelog/<version>.md` | Add | Per-release changelog entry matching the bumped version field |
| `.opencode/specs/sk-doc/026-skill-readme-refinement/005-mode-child-readme-revisit/020-sk-design-mcp-open-design/spec.md` | Create | Phase specification (this file) |
| `.opencode/specs/sk-doc/026-skill-readme-refinement/005-mode-child-readme-revisit/020-sk-design-mcp-open-design/plan.md` | Create | Phase implementation plan |
| `.opencode/specs/sk-doc/026-skill-readme-refinement/005-mode-child-readme-revisit/020-sk-design-mcp-open-design/tasks.md` | Create | Phase task list |
| `.opencode/specs/sk-doc/026-skill-readme-refinement/005-mode-child-readme-revisit/020-sk-design-mcp-open-design/checklist.md` | Create | Phase verification checklist |
...
- Which version value becomes the bump target? The README version field reads 1.4.0.11 while the changelog head is v1.4.0.1 and the SKILL.md field reads 1.5.0.0. The baseline evidence and the changelog convention decide.

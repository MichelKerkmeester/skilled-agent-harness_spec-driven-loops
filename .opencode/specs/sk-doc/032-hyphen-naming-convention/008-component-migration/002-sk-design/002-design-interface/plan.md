...
_memory:
  continuity:
    ...
    recent_action: "Authored design-interface plan"
...
| Aspect | Value |
|-------|-------|
| **Surface** | `.opencode/skills/sk-design/design-interface/` outside its feature-catalog and manual-testing-playbook trees |
...
Rename the design-interface mode's non-exempt filesystem names to kebab-case and keep its routing, procedure, and handoff references intact.
<!-- /ANCHOR:summary -->
...
### Key Components
- **Inventory**: the live `.opencode/skills/sk-design/design-interface/` outside its feature-catalog and manual-testing-playbook trees tree and its exact candidate paths.

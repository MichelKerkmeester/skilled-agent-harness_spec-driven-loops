...
# Checklist: Markdown Agent Naming Verification
...
This checklist is the blocking SOL verifier contract for phase 010. Every item is a check the paired
...
- [ ] CHK-001 [P0] The pinned BASE and all three runtime agent directories are available for the markdown inventory
...
- [ ] CHK-005 [P0] The inventory records exactly .opencode/agents/markdown.md, .claude/agents/markdown.md, and .codex/agents/markdown.toml

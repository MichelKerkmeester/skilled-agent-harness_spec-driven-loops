---
title: "Tasks: verify deep-improvement agent naming (032 phase 006)"
description: "Tasks for phase 006 of the 032 agents component migration: verify the deep-improvement filename candidate set."
trigger_phrases:
  - "deep-improvement agent naming tasks"
  - "agents phase 006 tasks"
...
# Tasks: Deep Improvement Agent Naming Verification
...
- [ ] T002 Confirm the three expected deep-improvement definition paths in the runtime inventory
<!-- /ANCHOR:phase-1 -->

<!-- ANCHOR:phase-2 -->
## Phase 2: Implementation

- [ ] T003 Record the OpenCode, Claude, and Codex path, extension, and basename for deep-improvement

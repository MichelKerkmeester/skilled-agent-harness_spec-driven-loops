...
parent: "sk-doc/032-hyphen-naming-convention/010-whole-repo-gate"
_memory:
  continuity:
    packet_pointer: "sk-doc/032-hyphen-naming-convention/010-whole-repo-gate"
    ...
    blockers: []
    key_files:
      - ".opencode/specs/sk-doc/032-hyphen-naming-convention/000-worktree-baseline-and-census"
      - ".opencode/specs/sk-doc/032-hyphen-naming-convention/010-whole-repo-gate/decision-record.md"
      - ".opencode/specs/sk-doc/032-hyphen-naming-convention/010-whole-repo-gate/checklist.md"
    completion_pct: 0
    open_questions: []
    answered_questions:

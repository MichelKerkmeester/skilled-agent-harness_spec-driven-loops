...
<!-- ANCHOR:status -->
## 2. STATUS
- Review Target: .opencode/specs/sk-doc/032-hyphen-naming-convention (spec-folder)
...
- iteration 2 repository_boundary (ruled_out): Executable negative criteria cover the boundary.; evidence=.opencode/specs/sk-doc/032-hyphen-naming-convention/005-rename-and-reference-tooling/001-rename-engine/checklist.md:71-75, .opencode/specs/sk-doc/032-hyphen-naming-convention/005-rename-and-reference-tooling/003-fixture-corpus-and-dry-run-harness/checklist.md:71-75

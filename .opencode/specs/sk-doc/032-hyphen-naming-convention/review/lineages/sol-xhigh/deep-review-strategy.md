...
Review the complete planning packet at `.opencode/specs/sk-doc/032-hyphen-naming-convention` for correctness, security, traceability, and maintainability. The review target is read-only.

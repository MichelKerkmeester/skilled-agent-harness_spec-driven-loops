...
| Field | Value |
|-------|-------|
| **Packet** | sk-doc/014-sk-doc-parent/027-catalog-naming-convention |
...
- Re-nesting the two completed de-numbering packets from top-level `014-sk-doc-parent/025` and `.../026` into this

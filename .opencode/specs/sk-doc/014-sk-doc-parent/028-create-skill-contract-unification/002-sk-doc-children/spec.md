---
title: "Feature Specification: sk-doc Children Contract Conformance"
description: "Bring the 11 skill SKILL.md files in this batch into full conformance with the create-skill contract; each file is updated by a fresh GPT-5.6 LUNA MAX agent and independently verified by a fresh Sonnet-5 xhigh agent, then must pass its validator."
trigger_phrases:
  - "002-sk-doc-children conformance"
  - "create-skill contract conformance"
  - "SKILL.md conformance sk-doc-children"
...
# Feature Specification: sk-doc Children Contract Conformance

> **Phase adjacency** (grouping order under the parent, not a runtime dependency): predecessor `001-parent-hub-canon`; successor `003-sk-design-children`.
...
| Field | Value |
|-------|-------|
| **Packet** | sk-doc/014-sk-doc-parent/028-create-skill-contract-unification/002-sk-doc-children |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Draft |
| **Created** | 2026-07-14 |
...
concrete batch of 11 SKILL.md files so every skill in the batch measures against the same rules.
...
**In scope:** the 11 files below, plus each file's own resource-doc frontmatter where the validator requires it.

| `.opencode/skills/sk-doc/create-agent/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-doc/create-benchmark/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-doc/create-changelog/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-doc/create-command/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-doc/create-diff/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-doc/create-feature-catalog/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-doc/create-flowchart/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-doc/create-manual-testing-playbook/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-doc/create-quality-control/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-doc/create-readme/SKILL.md` | Modify | Conform to contract |
| `.opencode/skills/sk-doc/create-skill/SKILL.md` | Modify | Conform to contract |
...
|----|-------------|----------|
| REQ-001 | `.opencode/skills/sk-doc/create-agent/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-002 | `.opencode/skills/sk-doc/create-benchmark/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-003 | `.opencode/skills/sk-doc/create-changelog/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-004 | `.opencode/skills/sk-doc/create-command/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-005 | `.opencode/skills/sk-doc/create-diff/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-006 | `.opencode/skills/sk-doc/create-feature-catalog/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-007 | `.opencode/skills/sk-doc/create-flowchart/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-008 | `.opencode/skills/sk-doc/create-manual-testing-playbook/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-009 | `.opencode/skills/sk-doc/create-quality-control/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-010 | `.opencode/skills/sk-doc/create-readme/SKILL.md` conforms to the contract and passes its validator | P0 |
| REQ-011 | `.opencode/skills/sk-doc/create-skill/SKILL.md` conforms to the contract and passes its validator | P0 |
<!-- /ANCHOR:requirements -->
...
1. All 11 files pass their validator (`python3 .opencode/skills/sk-doc/create-skill/scripts/package_skill.py <skill-dir> --check --strict`) with zero errors/warnings.

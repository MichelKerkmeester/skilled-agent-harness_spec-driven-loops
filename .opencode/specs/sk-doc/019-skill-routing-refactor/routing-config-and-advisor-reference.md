...
- Advisor: `system-skill-advisor/` (`mcp-server/lib/scorer/{lane-registry.ts, scoring-constants.ts}`, `mcp-server/scripts/skill-graph.json`, `hooks/claude/user-prompt-submit.ts`) and `.opencode/bin/skill-advisor.cjs`.

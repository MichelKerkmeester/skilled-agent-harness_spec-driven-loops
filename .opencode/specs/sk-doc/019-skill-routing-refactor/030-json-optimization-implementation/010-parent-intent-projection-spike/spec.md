...
- **Program**: `sk-doc/019-skill-routing-refactor/030-json-optimization-implementation`
- **Research this phase implements**: `../../029-skill-json-optimization-research/research/research.md` (finding O8, lines 74-75, 88, 101)
- **Contract under study**: `.opencode/skills/sk-doc/create-skill/references/shared/skill-root-metadata-contract.md`; `.opencode/skills/system-skill-advisor/mcp-server/schemas/skill-derived-v2.ts`

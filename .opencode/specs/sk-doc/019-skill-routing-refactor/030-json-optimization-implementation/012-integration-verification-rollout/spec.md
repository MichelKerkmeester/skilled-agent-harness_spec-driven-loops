...
_memory:
  continuity:
    ...
    blockers:
      - "Depends on every prior phase in 030-json-optimization-implementation landing first (003 derived schema, 008 edges, 011 command rewire, and the 002 pinned-corpus baseline)"
    key_files:
      - "spec.md"

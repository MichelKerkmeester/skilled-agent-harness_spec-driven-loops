---
title: "Tasks: Rename the sk-prompt mode packets to the sk- prefix"
...
# Tasks: Rename the sk-prompt mode packets to the sk- prefix
...
- [x] T004 Commit with paired renames (9efb3fc561)
<!-- /ANCHOR:phase-1 -->

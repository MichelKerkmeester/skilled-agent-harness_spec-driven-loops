...
- Source pointers:
  - Parent rename map: `.opencode/specs/sk-doc/019-skill-routing-refactor/021-mode-sk-prefix-rename/assets/rename-map.json` (21 rows, 20 packets; `create-skill` shared by two workflowModes; `create-skill-parent` keeps key!=directory)
...
- Artifact dir (fanout override): `.opencode/specs/sk-doc/019-skill-routing-refactor/021-mode-sk-prefix-rename/001-surface-research/research/lineages/glm-5-2`

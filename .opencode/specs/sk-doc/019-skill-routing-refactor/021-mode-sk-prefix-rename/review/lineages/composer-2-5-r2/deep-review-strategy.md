...
Review target: `.opencode/specs/sk-doc/019-skill-routing-refactor/021-mode-sk-prefix-rename` (spec-folder, phase parent with 8 children). Independent r2 lineage validating rename contract fidelity, live consumer alignment, and completion-metadata reconciliation after phases 001–008.

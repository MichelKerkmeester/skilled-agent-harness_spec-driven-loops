...
const artifactDir = path.join(REPO, '.opencode/specs/sk-doc/019-skill-routing-refactor/021-mode-sk-prefix-rename/review/lineages/composer-2-5-r2');
const specFolder = '.opencode/specs/sk-doc/019-skill-routing-refactor/021-mode-sk-prefix-rename';
const sessionId = 'fanout-composer-2-5-r2-1785218484113-fxt4vn';
const createdAt = '2026-07-28T06:01:00.000Z';

const config = {
  topic: 'Review: .opencode/specs/sk-doc/019-skill-routing-refactor/021-mode-sk-prefix-rename',
  mode: 'review',
  ...
  fanout: {
    ...
    artifactDirOverride: '.opencode/specs/sk-doc/019-skill-routing-refactor/021-mode-sk-prefix-rename/review/lineages/composer-2-5-r2',
  },
  'config.fanout_lineage_artifact_dir': '.opencode/specs/sk-doc/019-skill-routing-refactor/021-mode-sk-prefix-rename/review/lineages/composer-2-5-r2',
  fileProtection: {
...
const reviewReport = `# Deep Review Report: sk- Prefix Mode Packet Rename (021-mode-sk-prefix-rename)

...
- **F002**: Parent problem statement still narrates pre-rename examples (`interface`→`design-interface`, `quality`→`code-quality`) as the motivating defect [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/021-mode-sk-prefix-rename/spec.md:35-37]. Accurate as historical framing; post-closeout readers may confuse it for current state.

...
| Spec-folder strict validation | Run: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/sk-doc/019-skill-routing-refactor/015-router-unification-program/016-default-on-decision --strict`; Errors zero |
<!-- /ANCHOR:verification -->

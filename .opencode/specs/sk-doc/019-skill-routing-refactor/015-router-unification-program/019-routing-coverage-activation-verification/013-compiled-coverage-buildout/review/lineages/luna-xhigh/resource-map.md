...
- **Total references**: 4
- **By category**: READMEs=0, Documents=0, Commands=0, Agents=0, Skills=0, Specs=2, Scripts=2, Tests=0, Config=0, Meta=0
- **Missing on disk**: 0
- **Scope**: review convergence output for 013-compiled-coverage-buildout
- **Generated**: 2026-07-22T04:17:09.775Z
...
| Path | Action | Status | Note |
|------|--------|--------|------|
| .opencode/bin/lib/compiled-route-manifest.cjs | Analyzed | OK | Findings P0=0 P1=1 P2=0; Iterations=1 |
| .opencode/bin/lib/compiled-routing/011-runtime-engine/lib/resolve.cjs | Analyzed | OK | Findings P0=0 P1=0 P2=1; Iterations=1 |

...
| `DEFAULT_ON_HUBS`, both resolver copies — CURRENT | `.opencode/bin/lib/compiled-routing/014-runtime-engine/lib/resolve.cjs` and its authored twin under `.../015-router-unification-program/014-runtime-engine/lib/resolve.cjs` both list all 7 hubs; `diff` confirms byte-identical. |

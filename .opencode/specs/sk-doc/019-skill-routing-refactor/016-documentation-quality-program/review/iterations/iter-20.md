...
- **[P0] All ten “complete” phases fail the mandatory strict validation gate**
  ...
  `.opencode/specs/sk-doc/019-skill-routing-refactor/016-documentation-quality-program/010-deferred-code-and-checker-fixes/implementation-summary.md:103`  
  `.opencode/specs/sk-doc/019-skill-routing-refactor/016-documentation-quality-program/context-index.md:7`
...
- **[P1] Parent packet state still describes the obsolete eight-phase plan**
  ...
  `.opencode/specs/sk-doc/019-skill-routing-refactor/016-documentation-quality-program/spec.md:3`  
  `.opencode/specs/sk-doc/019-skill-routing-refactor/016-documentation-quality-program/spec.md:15`  
  `.opencode/specs/sk-doc/019-skill-routing-refactor/016-documentation-quality-program/graph-metadata.json:44`

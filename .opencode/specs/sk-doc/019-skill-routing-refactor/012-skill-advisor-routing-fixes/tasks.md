...
_memory:
  continuity:
    ...
    blockers:
      - "T005 (P1-5) is blocked on joint fixture design with sibling packet 011-sk-doc-routing-fixes"
...
- **Plan**: See `plan.md`
- **Research Source**: `../001-research/002-skill-advisor-routing-research/research/research.md` (Sections 8-11)
- **Sibling Fix Packet (T005 coordination)**: `../011-sk-doc-routing-fixes/tasks.md`
<!-- /ANCHOR:cross-refs -->

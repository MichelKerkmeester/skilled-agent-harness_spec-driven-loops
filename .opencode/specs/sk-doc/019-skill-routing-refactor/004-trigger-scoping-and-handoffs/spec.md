...
_memory:
  continuity:
    ...
    session_dedup:
      ...
      session_id: "scaffold-scaffold/004-trigger-scoping-and-handoffs"
...
| **Parent Spec** | ../spec.md |
| **Phase** | 3 of 4 |
| **Predecessor** | 003-router-collision-fixes |
| **Successor** | 005-router-standardization-and-regen |
...
- `../002-router-audit-and-fix-map/plan.md` is the frozen fix map.

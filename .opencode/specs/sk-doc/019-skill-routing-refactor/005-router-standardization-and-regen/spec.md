...
_memory:
  continuity:
    ...
    session_dedup:
      ...
      session_id: "scaffold-scaffold/005-router-standardization-and-regen"
...
| **Parent Spec** | ../spec.md |
| **Phase** | 4 of 4 |
| **Predecessor** | 004-trigger-scoping-and-handoffs |
| **Successor** | None |
...
| **Parent Spec** | `../spec.md` |
| **Predecessor** | `004-trigger-scoping-and-handoffs` |
| **Successor** | `006-create-skill-smart-routing-notes` |

...
- [ ] T-18 Reconcile the parent packet's (`033-json-optimization-implementation`) completion metadata — `spec.md`/`implementation-summary.md` — so it does not claim Complete before this phase's checklist is green
<!-- /ANCHOR:phase-3 -->

...
Use `.opencode/specs/sk-doc/019-skill-routing-refactor/001-research/001-sk-doc-routing-research/research/inbox.jsonl` to append external questions during an active run.
...
- Reuse candidates: sibling packets 001–009 under `019-skill-routing-refactor/` (prior audits, conformance gap analyses, hub intent keyword coverage work).

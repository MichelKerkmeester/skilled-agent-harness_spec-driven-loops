...
- **Treating `routing_contract_error` as the cause of low recall:** unresolved preamble entries explain the error class, but baseline hit/expected counts independently show missed expected leaves. [SOURCE: .opencode/skills/sk-code/benchmark/reports/baseline/skill-benchmark-report.json:431-440] [SOURCE: .opencode/skills/sk-code/benchmark/reports/baseline/skill-benchmark-report.json:1620-1629]
...
- `.opencode/skills/sk-code/benchmark/reports/baseline/skill-benchmark-report.json:1-65,356-478,1543-1667`
- `.opencode/specs/sk-doc/019-skill-routing-refactor/014-sk-code-router-alignment/implementation-summary.md:58-78,105-128`

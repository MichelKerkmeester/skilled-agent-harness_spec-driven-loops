...
_memory:
  continuity:
    packet_pointer: "sk-doc/019-skill-routing-refactor/003-router-collision-fixes"
    ...
    session_dedup:
      ...
      session_id: "scaffold-scaffold/003-router-collision-fixes"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 003-router-collision-fixes |

Spec folder: sk-doc/014-skill-readme-standardization/005-cli-opencode-readme (pre-approved, skip Gate 3). READ-ONLY: do not write, create or edit any file, and do not run the skill. Return findings as your final assistant message only.

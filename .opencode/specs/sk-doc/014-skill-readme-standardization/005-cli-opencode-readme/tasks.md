---
title: "Tasks: cli-opencode README"
description: "Task list for the cli-opencode README rewrite via deep-context and dual-draft."
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "All phase-005 tasks complete; Batch A done"
...
- [x] T002 [P] Iteration 1 seats: DeepSeek + MiMo gather the three use cases and invocation
- [x] T003 [P] Iteration 2 seats: verify flags, provider roster and stale facts
- [x] T004 Host-verify against SKILL.md and synthesize context-report.md
- [x] T005 [P] Dual-draft: DeepSeek + MiMo author the README
- [x] T006 Merge best-of into `cli-opencode/README.md`, keep accurate references
<!-- /ANCHOR:phase-2 -->

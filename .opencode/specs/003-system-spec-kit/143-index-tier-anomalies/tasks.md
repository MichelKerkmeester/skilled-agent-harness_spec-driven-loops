...
- [x] T013 [P1] Run spec validation and resolve issues (`scripts/spec/validate.sh`) [EVIDENCE: `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh specs/003-system-spec-kit/143-index-tier-anomalies` PASS (0 errors, 0 warnings)]

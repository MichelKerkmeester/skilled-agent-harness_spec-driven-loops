...
| Spec Folder | ../.opencode/specs/003-system-spec-kit/139-hybrid-rag-fusion/002-hybrid-rag-fusion |
| Channel | main |
...
```
/spec_kit:resume ../.opencode/specs/003-system-spec-kit/139-hybrid-rag-fusion/002-hybrid-rag-fusion
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: ../.opencode/specs/003-system-spec-kit/139-hybrid-rag-fusion/002-hybrid-rag-fusion
Last: Tool: bash
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume ../.opencode/specs/003-system-spec-kit/139-hybrid-rag-fusion/002-hybrid-rag-fusion` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "../.opencode/specs/003-system-spec-kit/139-hybrid-rag-fusion/002-hybrid-rag-fusion" })` |
...
memory_search({ specFolder: "../.opencode/specs/003-system-spec-kit/139-hybrid-rag-fusion/002-hybrid-rag-fusion", limit: 10 })

# Verify memory file integrity
ls -la ../.opencode/specs/003-system-spec-kit/139-hybrid-rag-fusion/002-hybrid-rag-fusion/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js ../.opencode/specs/003-system-spec-kit/139-hybrid-rag-fusion/002-hybrid-rag-fusion --force
```
...
spec_folder: "../.opencode/specs/003-system-spec-kit/139-hybrid-rag-fusion/002-hybrid-rag-fusion"
channel: "main"
...
parent_spec: "../.opencode/specs/003-system-spec-kit/139-hybrid-rag-fusion/002-hybrid-rag-fusion"
child_sessions:

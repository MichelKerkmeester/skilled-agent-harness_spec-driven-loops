---
title: "To promote a memory to constitutional tier (always [009-skill-graph-score-recovery/21-02-26_14-07__score-recovery-v2]"
...
| Session ID | session-1771679257791-jusprduf9 |
| Spec Folder | ../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-score-recovery-v2 |
| Channel | main |
...
| Created At (Epoch) | 1771679257 |
| Last Accessed (Epoch) | 1771679257 |
| Access Count | 1 |
...
```
/spec_kit:resume ../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-score-recovery-v2
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: ../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-score-recovery-v2
Last: Tool: bash
...
**Key Topics:** `system` | `memory` | `skill graph` | `../.opencode/specs/003 system spec kit/138 hybrid rag fusion/009 score recovery v2` | `skill` | `graph` | `../.opencode/specs/003` | `spec` | `kit/138` | `hybrid` | `rag` | `fusion/009` | 
...
<!-- ANCHOR:implementation-here-review-work-completed-35e1e785 -->
...
<!-- ANCHOR:implementation-based-analysis-036skillgraphs-implementation-7d5cfed6 -->
...
<!-- ANCHOR:implementation-tool-grep-c6bd0dd4 -->
...
<!-- ANCHOR:implementation-tool-glob-a2b65e1f -->
...
<!-- ANCHOR:implementation-tool-read-551401df -->
...
<!-- ANCHOR:implementation-tool-read-551401df-2 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-read-551401df-3 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-read-551401df-4 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-read-551401df-5 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-write-c3a47bab -->
...
<!-- ANCHOR:implementation-tool-read-551401df-6 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-edit-761320db -->
...
<!-- ANCHOR:implementation-tool-edit-761320db-2 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-edit-761320db-3 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-edit-761320db-4 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-read-551401df-7 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-bash-7692998f -->
...
<!-- ANCHOR:integration-tool-read-551401df -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-read-551401df-8 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-grep-c6bd0dd4-2 -->
### OBSERVATION: Tool: grep
...
<!-- ANCHOR:implementation-tool-read-551401df-9 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-edit-761320db-5 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-read-551401df-10 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-read-551401df-11 -->
### BUGFIX: Tool: read
...
<!-- ANCHOR:implementation-tool-edit-761320db-6 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-grep-c6bd0dd4-3 -->
### OBSERVATION: Tool: grep
...
<!-- ANCHOR:implementation-tool-edit-761320db-7 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-read-551401df-12 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-grep-c6bd0dd4-4 -->
### OBSERVATION: Tool: grep
...
<!-- ANCHOR:implementation-tool-edit-761320db-8 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-edit-761320db-9 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-edit-761320db-10 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-edit-761320db-11 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-read-551401df-13 -->
### OBSERVATION: Tool: read
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume ../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-score-recovery-v2` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-score-recovery-v2" })` |
...
memory_search({ specFolder: "../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-score-recovery-v2", limit: 10 })

# Verify memory file integrity
ls -la ../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-score-recovery-v2/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js ../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-score-recovery-v2 --force
```
...
```yaml
# Core Identifiers
session_id: "session-1771679257791-jusprduf9"
spec_folder: "../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-score-recovery-v2"
channel: "main"
...
created_at_epoch: 1771679257
last_accessed_epoch: 1771679257
...
key_topics:
  ...
  - "memory"
  - "skill graph"
  - "../.opencode/specs/003 system spec kit/138 hybrid rag fusion/009 score recovery v2"
  - "skill"
  - "graph"
  - "../.opencode/specs/003"
  - "spec"
...
parent_spec: "../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-score-recovery-v2"
child_sessions:

---
title: "To promote a memory to constitutional tier [009-skill-graph-score-recovery/21-02-26_16-29__skill-graph-score-recovery]"
...
| Session ID | session-1771687791863-am38u0vxn |
| Spec Folder | ../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-skill-graph-score-recovery |
| Channel | main |
...
| Created At (Epoch) | 1771687791 |
| Last Accessed (Epoch) | 1771687791 |
| Access Count | 1 |
...
```
/spec_kit:resume ../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-skill-graph-score-recovery
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: ../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-skill-graph-score-recovery
Last: Tool: bash
...
**Key Topics:** `skill` | `graph` | `system` | `memory` | `skill graph` | `../.opencode/specs/003 system spec kit/138 hybrid rag fusion/009 skill graph score recovery` | `../.opencode/specs/003` | `spec` | `kit/138` | `hybrid` | `rag` | `fusion/009` | 
...
<!-- ANCHOR:implementation-here-review-work-completed-f04f991f -->
...
<!-- ANCHOR:implementation-based-analysis-036skillgraphs-implementation-32d2cfe1 -->
...
<!-- ANCHOR:implementation-tool-grep-5933ebd8 -->
...
<!-- ANCHOR:implementation-tool-glob-f7e0030a -->
...
<!-- ANCHOR:implementation-tool-read-59130a07 -->
...
<!-- ANCHOR:implementation-tool-read-59130a07-2 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-read-59130a07-3 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-read-59130a07-4 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-read-59130a07-5 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-write-15b1fd3c -->
...
<!-- ANCHOR:implementation-tool-read-59130a07-6 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-edit-6faa95e6 -->
...
<!-- ANCHOR:implementation-tool-edit-6faa95e6-2 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-edit-6faa95e6-3 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-edit-6faa95e6-4 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-read-59130a07-7 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-bash-d1239315 -->
...
<!-- ANCHOR:integration-tool-read-59130a07 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-read-59130a07-8 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-grep-5933ebd8-2 -->
### OBSERVATION: Tool: grep
...
<!-- ANCHOR:implementation-tool-read-59130a07-9 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-edit-6faa95e6-5 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-read-59130a07-10 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-read-59130a07-11 -->
### BUGFIX: Tool: read
...
<!-- ANCHOR:implementation-tool-edit-6faa95e6-6 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-grep-5933ebd8-3 -->
### OBSERVATION: Tool: grep
...
<!-- ANCHOR:implementation-tool-edit-6faa95e6-7 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-read-59130a07-12 -->
### OBSERVATION: Tool: read
...
<!-- ANCHOR:implementation-tool-grep-5933ebd8-4 -->
### OBSERVATION: Tool: grep
...
<!-- ANCHOR:implementation-tool-edit-6faa95e6-8 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-edit-6faa95e6-9 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-edit-6faa95e6-10 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-edit-6faa95e6-11 -->
### IMPLEMENTATION: Tool: edit
...
<!-- ANCHOR:implementation-tool-read-59130a07-13 -->
### OBSERVATION: Tool: read
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume ../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-skill-graph-score-recovery` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-skill-graph-score-recovery" })` |
...
memory_search({ specFolder: "../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-skill-graph-score-recovery", limit: 10 })

# Verify memory file integrity
ls -la ../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-skill-graph-score-recovery/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js ../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-skill-graph-score-recovery --force
```
...
```yaml
# Core Identifiers
session_id: "session-1771687791863-am38u0vxn"
spec_folder: "../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-skill-graph-score-recovery"
channel: "main"
...
created_at_epoch: 1771687791
last_accessed_epoch: 1771687791
...
key_topics:
  ...
  - "memory"
  - "skill graph"
  - "../.opencode/specs/003 system spec kit/138 hybrid rag fusion/009 skill graph score recovery"
  - "../.opencode/specs/003"
  - "spec"
  - "kit/138"
  - "hybrid"
...
trigger_phrases:
  ...
  - "details on the integrated spec kit memory mcp server (vector search, tiers, chunking), including memory save workflows, audit tools, and handler architecture."
  - "phase-system"
  - "phase system"
  ...
  - "how the 3-level documentation system (core + addendum) scales by complexity using template levels, quality validation, and configuration-aware rollout gates."
  - "rules"
  - "system-spec-kit rules"
  - "mandatory rules (always, never, escalate) for using the system-spec-kit workflow."
  - "validation-workflow"
  - "validation workflow"
  - "how validate.sh automates spec folder validation, quality gates, template level checks, memory save readiness, and configuration safety."
  - "when-to-use"
  ...
  - "cli-approach"
  - "cli approach"
  - "cli (bdg) approach for browser debugging: installation, discovery, network inspection, har export, session management, and commands"
  - "how-it-works"
  - "how it works"
  ...
  - "quick-reference"
  - "cheat sheet of essential cli commands, network inspection, mcp tool patterns, and error handling templates"
  - "routing-decision"
  - "routing decision"
  ...
  - "when to use"
  - "activation triggers, use cases including performance audit, and exclusion criteria for the chrome devtools orchestrator skill"
  - "cdp_patterns"
  ...
  - "the architecture of the utcp typescript execution environment including tool chain routing and handler dispatch."
  - "project-configuration"
  - "project configuration"
  - "how to configure .utcp_config.json for external mcp tools."
  - "code snippets, tool chain patterns, and templates for code mode invocations."
  - "code mode rules"
  - "mandatory rules (always, never) for writing code mode scripts."
  - "definition of done for a successful code mode invocation."
  - "when to use code mode"
  - "when to trigger code mode for external api access and when to use native mcp instead."
  ...
  - "prerequisites, code mode dependency, configuration, design export workflows, and cross-tool workflow patterns."
  ...
  - "language-detection"
  - "language detection"
  - "quick language identification table mapping file extensions and keywords to typescript/python configuration, validation, and implementation routing paths"
  - "file header templates, naming matrix, typescript/python config guidance, api/network tracing cues, and comment patterns for all supported languages"
  ...
  - "debugging-workflow"
  - "debugging workflow"
  - "phase 2 systematic debugging framework with root cause tracing, css/layout animation debugging, api/network tracing, and accessibility (aria) error recovery"
  - "development lifecycle overview, phase transitions, and phase 0 research methodology"
  - "implementation-workflow"
  - "implementation workflow"
  - "phase 1 implementation patterns for css/layout/animation, accessibility (aria), api/network handlers, and responsive frontend delivery with a phase 1.5 quality gate"
  - "common commands, cdn/version workflow, css/layout/animation and api/network debugging references, accessibility audit cues, and related skills"
  ...
  - "verification workflow"
  - "phase 3 mandatory browser verification including layout inspection, accessibility audit, testing matrix, and completion gate"
  - "activation triggers, use cases including api integration, phase overview, and when not to use this skill"
  - "debugging_workflows"
  ...
  - "how the document quality index (dqi) pipeline evaluates templates, levels, validation quality, save guidance, and configuration clarity across readmes/specs/knowledge docs."
  ...
  - "commit-workflow"
  - "commit workflow"
  - "commit creation process: staging, artifact filtering, conventional commits formatting, and merge-conflict recovery with validation context"
  - "github-integration"
  - "github integration"
  - "github mcp integration for remote operations: prs, issues, conflict resolution, ci/cd, and repository management"
  ...
  - "workspace-setup"
  - "workspace setup"
  - "git worktree setup, workspace choice enforcement, branch management, and conflict-safe cross-skill handoff to implementation and validation workflows"
  - "commit_workflows"
  ...
  - "animation_workflows.md section 7"
  - "webflow_patterns.md section 3"
  - "shared_patterns.md"
  - "cdn_deployment.md"
  ...
  - "../performance/cwv_remediation.md"
  - "../verification/performance_checklist.md"
  - "skill_creation.md"
  ...
  - "skill_creation.md § 5. common pitfalls"
  - "skill_creation.md § progressive disclosure"
  - "optimization.md"
  - "readme_template.md"
  - "worktree_workflows.md"
  - "commit_workflows.md"
  - "finish_workflows.md"
  - "worktree_checklist.md"
...
parent_spec: "../.opencode/specs/003-system-spec-kit/138-hybrid-rag-fusion/009-skill-graph-score-recovery"
child_sessions:

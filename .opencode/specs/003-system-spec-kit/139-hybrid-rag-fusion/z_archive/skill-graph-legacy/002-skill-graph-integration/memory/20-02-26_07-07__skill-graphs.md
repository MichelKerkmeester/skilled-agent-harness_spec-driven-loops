---
title: "To promote a memory to constitutional tier (always surfaced) [002-skill-graph-integration/20-02-26_07-07__skill-graphs]"
...
| Session ID | session-1771567652306-y87hcl5lw |
...
| Created At (Epoch) | 1771567652 |
| Last Accessed (Epoch) | 1771567652 |
| Access Count | 1 |
...
<!-- ANCHOR:implementation-ill-execute-step-step-a03922f2 -->
### FEATURE: 
...
<!-- ANCHOR:implementation-tool-read-6170c9e4 -->
### BUGFIX: Tool: read
...
<!-- ANCHOR:implementation-tool-glob-64a3a263 -->
...
<!-- ANCHOR:implementation-tool-bash-3116de32 -->
...
```yaml
# Core Identifiers
session_id: "session-1771567652306-y87hcl5lw"
...
created_at_epoch: 1771567652
last_accessed_epoch: 1771567652
expires_at_epoch: 1779343652  # 0 for critical (never expires)

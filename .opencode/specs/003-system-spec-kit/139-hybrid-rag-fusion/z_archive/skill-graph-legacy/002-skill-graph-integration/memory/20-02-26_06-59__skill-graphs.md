---
title: "To promote a memory to constitutional tier (always surfaced) [002-skill-graph-integration/20-02-26_06-59__skill-graphs]"
...
| Session ID | session-1771567192292-4y2ycjc6x |
...
| Created At (Epoch) | 1771567192 |
| Last Accessed (Epoch) | 1771567192 |
| Access Count | 1 |
...
<!-- ANCHOR:implementation-ill-execute-step-step-9ceebd5a -->
### FEATURE: 
...
<!-- ANCHOR:implementation-tool-read-b846df67 -->
### BUGFIX: Tool: read
...
<!-- ANCHOR:implementation-tool-glob-f5969fc3 -->
...
<!-- ANCHOR:implementation-tool-bash-15c268e4 -->
...
```yaml
# Core Identifiers
session_id: "session-1771567192292-4y2ycjc6x"
...
created_at_epoch: 1771567192
last_accessed_epoch: 1771567192
expires_at_epoch: 1779343192  # 0 for critical (never expires)

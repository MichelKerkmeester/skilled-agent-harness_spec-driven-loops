...
- [x] CHK-025 [P1] Parent `138` root docs synchronized to consolidated active/archived folder state [Evidence: root `spec.md`, `plan.md`, `tasks.md`, `checklist.md`, `implementation-summary.md` updated with active `013` and archive-path references]
<!-- /ANCHOR:p1 -->

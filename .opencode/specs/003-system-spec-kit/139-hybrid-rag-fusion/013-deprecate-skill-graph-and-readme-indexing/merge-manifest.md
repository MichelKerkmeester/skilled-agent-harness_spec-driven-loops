...
This manifest defines `013-deprecate-skill-graph-and-readme-indexing-2` as the **single active skill-graph-related subfolder** in `138-hybrid-rag-fusion` and records the non-destructive consolidation of legacy child folders.

- Active canonical folder: `013-deprecate-skill-graph-and-readme-indexing-2/`
...
- `013-deprecate-skill-graph-and-readme-indexing-2/` is the only active skill-graph-related child folder.

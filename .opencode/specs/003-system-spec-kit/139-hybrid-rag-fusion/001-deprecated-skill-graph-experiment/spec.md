...
|-----------|-------------|-------------|
| `specs/003-system-spec-kit/139-hybrid-rag-fusion/001-deprecated-skill-graph-experiment/spec.md` | Create | Completion specification and frozen scope |
| `specs/003-system-spec-kit/139-hybrid-rag-fusion/001-deprecated-skill-graph-experiment/plan.md` | Create | Delivery/verification plan with closed phases |
| `specs/003-system-spec-kit/139-hybrid-rag-fusion/001-deprecated-skill-graph-experiment/tasks.md` | Create | Completed task ledger |
| `specs/003-system-spec-kit/139-hybrid-rag-fusion/001-deprecated-skill-graph-experiment/checklist.md` | Create | P0/P1/P2 verification evidence |
| `specs/003-system-spec-kit/139-hybrid-rag-fusion/001-deprecated-skill-graph-experiment/decision-record.md` | Create | ADRs for deprecation and retained causal graph |
| `specs/003-system-spec-kit/139-hybrid-rag-fusion/001-deprecated-skill-graph-experiment/implementation-summary.md` | Create | Concise completion summary |
| `specs/003-system-spec-kit/139-hybrid-rag-fusion/001-deprecated-skill-graph-experiment/merge-manifest.md` | Create | Legacy skill-graph source mapping + archive manifest |

...
| Session ID | session-1771172569335-n982hjh78 |
...
| Created At (Epoch) | 1771172569 |
| Last Accessed (Epoch) | 1771172569 |
| Access Count | 1 |
...
<!-- ANCHOR:implementation-ill-execute-step-step-7b887e3c -->
### FEATURE: 
...
<!-- ANCHOR:implementation-tool-read-fe6e5ac5 -->
### BUGFIX: Tool: read
...
<!-- ANCHOR:implementation-tool-glob-612f4b70 -->
...
<!-- ANCHOR:implementation-tool-bash-8a1213f1 -->
...
```yaml
# Core Identifiers
session_id: "session-1771172569335-n982hjh78"
...
created_at_epoch: 1771172569
last_accessed_epoch: 1771172569
expires_at_epoch: 1778948569  # 0 for critical (never expires)

...
| Session ID | session-1765976890686-dy3puslxh |
...
| Created At (Epoch) | 1765976890 |
| Last Accessed (Epoch) | 1765976890 |
| Access Count | 1 |
...
<!-- ANCHOR:preflight-session-1765976890686-dy3puslxh-005-memory/015-roampal-analysis -->
## PREFLIGHT BASELINE
...
<!-- ANCHOR:continue-session-session-1765976890686-dy3puslxh-005-memory/015-roampal-analysis -->
...
<!-- ANCHOR:summary-session-1765976890686-dy3puslxh-005-memory/015-roampal-analysis -->
## 1. OVERVIEW
...
<!-- ANCHOR:detailed-changes-session-1765976890686-dy3puslxh-005-memory/015-roampal-analysis -->
## 2. DETAILED CHANGES

<!-- ANCHOR:decision-test-session-keydecisions-object-c613389e-session-1765976890686-dy3puslxh -->
...
<!-- ANCHOR:decisions-session-1765976890686-dy3puslxh-005-memory/015-roampal-analysis -->
## 3. DECISIONS

<!-- ANCHOR:decision-object-format-decisions-17d95b0f-session-1765976890686-dy3puslxh -->
### Decision 1: Use object format for decisions

**Context**: Use object format for decisions

**Timestamp**: 2025-12-17T14:08:10Z
...
<!-- ANCHOR:decision-string-format-decision-backward-3c40a6c4-session-1765976890686-dy3puslxh -->
...
<!-- ANCHOR:session-history-session-1765976890686-dy3puslxh-005-memory/015-roampal-analysis -->
## 4. CONVERSATION
...
<!-- ANCHOR:recovery-hints-session-1765976890686-dy3puslxh-005-memory/015-roampal-analysis -->
...
<!-- ANCHOR:postflight-session-1765976890686-dy3puslxh-005-memory/015-roampal-analysis -->
...
<!-- ANCHOR:metadata-session-1765976890686-dy3puslxh-005-memory/015-roampal-analysis -->

> **Machine-Readable Section** - This YAML block is parsed by the semantic memory indexer for search optimization and decay calculations.

```yaml
# Core Identifiers
session_id: "session-1765976890686-dy3puslxh"
...
created_at_epoch: 1765976890
last_accessed_epoch: 1765976890
expires_at_epoch: 1773752890  # 0 for critical (never expires)

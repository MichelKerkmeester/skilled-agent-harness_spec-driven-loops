---
title: "Epistemic state captured at session start for learning delta calculation. [invalid-anchors/context]"
...
| Session ID | session-legacy-1770632216906-t352r4 |
| Spec Folder | 003-memory-and-spec-kit/z_archive/023-path-scoped-rules/002-modular-architecture/test-fixtures/invalid-anchors |
| Channel | main |
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 003-memory-and-spec-kit/z_archive/023-path-scoped-rules/002-modular-architecture/test-fixtures/invalid-anchors` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "003-memory-and-spec-kit/z_archive/023-path-scoped-rules/002-modular-architecture/test-fixtures/invalid-anchors" })` |
...
```yaml
# Core Identifiers
session_id: "session-legacy-1770632216906-t352r4"
spec_folder: "003-memory-and-spec-kit/z_archive/023-path-scoped-rules/002-modular-architecture/test-fixtures/invalid-anchors"
channel: "main"
...
# Relationships
related_sessions: []
parent_spec: "003-memory-and-spec-kit/z_archive/023-path-scoped-rules/002-modular-architecture/test-fixtures/invalid-anchors"
child_sessions: []

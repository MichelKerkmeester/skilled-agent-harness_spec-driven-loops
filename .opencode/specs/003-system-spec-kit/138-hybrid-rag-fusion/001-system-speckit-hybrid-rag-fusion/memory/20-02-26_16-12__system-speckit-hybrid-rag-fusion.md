...
```
/spec_kit:resume 003-system-spec-kit/138-hybrid-rag-fusion/001-system-speckit-hybrid-rag-fusion
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: 003-system-spec-kit/138-hybrid-rag-fusion/001-system-speckit-hybrid-rag-fusion
Last: Tool: bash
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 003-system-spec-kit/138-hybrid-rag-fusion/001-system-speckit-hybrid-rag-fusion` |
...
ls -la 003-system-spec-kit/138-hybrid-rag-fusion/001-system-speckit-hybrid-rag-fusion/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js 003-system-spec-kit/138-hybrid-rag-fusion/001-system-speckit-hybrid-rag-fusion --force
```

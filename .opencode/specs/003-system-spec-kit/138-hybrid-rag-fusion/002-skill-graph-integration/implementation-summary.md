...
| `workflows-chrome-devtools/SKILL.md` | Added Skill Graph Status header pointing to supplemental graph navigation |
| `mcp-figma/SKILL.md` | Added Skill Graph Status header pointing to supplemental graph navigation |
| `workflows-code--full-stack/SKILL.md` | Added Skill Graph Status header pointing to supplemental graph navigation |

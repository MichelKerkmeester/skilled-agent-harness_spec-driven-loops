...
| `sk-documentation` | Yes | Yes | 7 | No | Complete |
| `mcp-chrome-devtools` | Yes | No | 0 | No | Not started |
| `sk-code--full-stack` | Yes | No | 0 | No | Not started |
| `sk-code--opencode` | Yes | No | 0 | No | Not started |
| `workflows-code--web-dev` | Yes | No | 0 | No | Not started |
| `sk-git` | Yes | No | 0 | No | Not started |

## Progress Summary

- Complete: 3/9 skills (`mcp-code-mode`, `system-spec-kit`, `sk-documentation`)
...
2. `sk-documentation` now includes skill graph guidance and enablement resources:
...
1. Migrate remaining skills in this order: `sk-git`, `mcp-chrome-devtools`, `mcp-figma`, then `workflows-code--*` variants.

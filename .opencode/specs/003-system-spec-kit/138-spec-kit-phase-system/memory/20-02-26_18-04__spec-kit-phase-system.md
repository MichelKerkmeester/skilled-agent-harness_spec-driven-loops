...
trigger_phrases:
  ...
  - "json safe"
  - "l1 l3"
  - "phase intent to skill"
  - "smart router /spec kit"
  - "router /spec kit phase"
  - "/spec kit phase command"
  - "test fixture tasks t005/t028/t033"
  - "composes l1-l3+ rather replacing"
  - "signal scoring dimensions architectural=15"
  - "scoring dimensions architectural=15 files"
  - "dimensions architectural=15 files loc"
  - "architectural=15 files loc risk"
  - "files loc risk extreme=5"
  - "loc risk extreme=5 threshold"
  - "risk extreme=5 threshold correctly"
  - "extreme=5 threshold correctly identifies"
  - "threshold correctly identifies needing"
  - "correctly identifies needing phases"
  - "system"
  - "spec"
  - "kit/139"
  - "kit"
...
key_files:
  - ".opencode/.../spec/recommend-level.sh"
  ...
  - ".opencode/.../structure/sub_folder_versioning.md"
  - ".opencode/.../structure/level_specifications.md"

...
| Spec Folder | 002-commands-and-skills/003-workflows-documentation/002-skill-rename |
| Channel | main |
...
<!-- ANCHOR:preflight-session-legacy-1770632216860-90d1ew-002-commands-and-skills/003-workflows-documentation/002-skill-rename -->
## PREFLIGHT BASELINE
...
<!-- ANCHOR:continue-session-session-legacy-1770632216860-90d1ew-002-commands-and-skills/003-workflows-documentation/002-skill-rename -->
...
```
/spec_kit:resume 002-commands-and-skills/003-workflows-documentation/002-skill-rename
```
<!-- /ANCHOR:continue-session-session-legacy-1770632216860-90d1ew-002-commands-and-skills/003-workflows-documentation/002-skill-rename -->
...
<!-- ANCHOR:summary-session-legacy-1770632216860-90d1ew-002-commands-and-skills/003-workflows-documentation/002-skill-rename -->
<a id="overview"></a>
...
| `workflows-chrome-devtools/examples/README.md` | 1 ref |
...
✓ workflows-chrome-devtools - CLEAN (0 old refs)
...
<!-- ANCHOR:decisions-session-legacy-1770632216860-90d1ew-002-commands-and-skills/003-workflows-documentation/002-skill-rename -->
<a id="decisions"></a>
...
<!-- ANCHOR:session-history-session-legacy-1770632216860-90d1ew-002-commands-and-skills/003-workflows-documentation/002-skill-rename -->
<a id="conversation"></a>
...
<!-- ANCHOR:recovery-hints-session-legacy-1770632216860-90d1ew-002-commands-and-skills/003-workflows-documentation/002-skill-rename -->
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 002-commands-and-skills/003-workflows-documentation/002-skill-rename` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "002-commands-and-skills/003-workflows-documentation/002-skill-rename" })` |
...
<!-- ANCHOR:postflight-session-legacy-1770632216860-90d1ew-002-commands-and-skills/003-workflows-documentation/002-skill-rename -->
...
<!-- ANCHOR:metadata-session-legacy-1770632216860-90d1ew-002-commands-and-skills/003-workflows-documentation/002-skill-rename -->
...
spec_folder: "002-commands-and-skills/003-workflows-documentation/002-skill-rename"
channel: "main"
...
# Relationships
related_sessions: []
parent_spec: "002-commands-and-skills/003-workflows-documentation/002-skill-rename"
child_sessions: []

...
- `.opencode/specs/002-commands-and-skills/000-skills/002-smart-router-v2/scratch/smart-router-tests/router-rules.json` (threshold configuration)
...
**Affected Systems**:
- `.opencode/specs/002-commands-and-skills/000-skills/002-smart-router-v2/scratch/smart-router-tests/router-rules.json` (lexicon storage)

...
### Definition of Ready
- [ ] Smart Router V2 baseline (002-smart-router-v2) deployment complete and verified
...
| Regression | V2 baseline tests continue passing after refinements | Existing test suite from 002-smart-router-v2 |
...
|------------|------|--------|-------------------|
| Smart Router V2 baseline (002-smart-router-v2) | Internal | Green (assumed complete) | Cannot start refinement work; must verify completion status |
...
3. Revert router-rules.json: `git restore .opencode/specs/002-commands-and-skills/000-skills/002-smart-router-v2/scratch/smart-router-tests/router-rules.json`

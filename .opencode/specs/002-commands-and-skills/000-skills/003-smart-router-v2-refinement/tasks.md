...
- [x] **T001** [W:SYNONYM] Add synonym mappings to router-rules.json (7+ noisy terms)  
  **File**: `.opencode/specs/002-commands-and-skills/000-skills/002-smart-router-v2/scratch/smart-router-tests/router-rules.json`  
...
- [x] **T012** [W:TEST] Add pseudocode validation assertions to run-smart-router-tests.mjs  
  **File**: `.opencode/specs/002-commands-and-skills/000-skills/002-smart-router-v2/scratch/smart-router-tests/run-smart-router-tests.mjs`  
...
- [x] **T014** [W:TEST] Create ambiguity-focused test fixture: close-score delta <0.15  
  **File**: `.opencode/specs/002-commands-and-skills/000-skills/002-smart-router-v2/scratch/smart-router-tests/fixtures/ambiguity-close-score.json`  
...
- [x] **T015** [W:TEST] [P] Create ambiguity-focused test fixture: multi-symptom prompts  
  **File**: `.opencode/specs/002-commands-and-skills/000-skills/002-smart-router-v2/scratch/smart-router-tests/fixtures/ambiguity-multi-symptom.json`  
...
- [x] **T017** [W:BENCH] Create benchmark-harness.mjs script skeleton  
  **File**: `.opencode/specs/002-commands-and-skills/000-skills/003-smart-router-v2-refinement/scratch/benchmark-harness.mjs`  
...
- [x] **T021** [W:DOCS] Synchronize spec.md with final implementation state  
  **File**: `.opencode/specs/002-commands-and-skills/000-skills/003-smart-router-v2-refinement/spec.md`  
...
- [x] **T022** [W:DOCS] Synchronize plan.md with final implementation state  
  **File**: `.opencode/specs/002-commands-and-skills/000-skills/003-smart-router-v2-refinement/plan.md`  
...
- [x] **T023** [W:DOCS] Synchronize tasks.md with completion status  
  **File**: `.opencode/specs/002-commands-and-skills/000-skills/003-smart-router-v2-refinement/tasks.md`  
...
- [x] **T025** [W:VERIFY] Run benchmark harness and generate efficiency report (P1 optional)  
  ...
  **Verify**: `node benchmark-harness.mjs --test-corpus ../002-smart-router-v2/scratch/smart-router-tests/fixtures/ --output scratch/efficiency-report.json && jq '.recommendations' scratch/efficiency-report.json`  
...
- [x] **T027** [W:VERIFY] Document unresolved items and future work recommendations  
  **File**: `.opencode/specs/002-commands-and-skills/000-skills/003-smart-router-v2-refinement/scratch/unresolved-items.md`  

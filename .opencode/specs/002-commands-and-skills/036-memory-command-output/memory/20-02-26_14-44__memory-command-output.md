---
title: "To promote a memory to constitutional tier (always [036-memory-command-output/20-02-26_14-44__memory-command-output]"
...
- `.opencode/.../036-memory-command-output/implementation-summary.md` - Documentation

- `.opencode/.../036-memory-command-output/checklist.md` - Documentation
...
| `.opencode/.../036-memory-command-output/implementation-summary.md` | File modified (description pending) |
| `.opencode/.../036-memory-command-output/checklist.md` | File modified (description pending) |
...
key_files:
  ...
  - ".opencode/.../036-memory-command-output/implementation-summary.md"
  - ".opencode/.../036-memory-command-output/checklist.md"

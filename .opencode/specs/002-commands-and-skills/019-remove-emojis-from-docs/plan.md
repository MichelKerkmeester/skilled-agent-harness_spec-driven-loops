...
**Target**: `.opencode/skill/workflows-chrome-devtools/`
...
**Verification**: Zero emoji H2 headings in `.opencode/skill/workflows-chrome-devtools/`.

---

### Phase 6: workflows-code--full-stack Skill (~33 files)

**Target**: `.opencode/skill/workflows-code--full-stack/`
...
**Verification**: Zero emoji H2 headings in `.opencode/skill/workflows-code--full-stack/`.
...
| Phase 5 (workflows-chrome-devtools) | Low | ~2 minutes |
| Phase 6 (workflows-code--full-stack) | Medium | ~5 minutes |
...
| Agent 5 | Phase 5 | workflows-chrome-devtools | 7 |
| Agent 6 | Phase 6 | workflows-code--full-stack | 33 |
...
| W-05 | workflows-chrome-devtools | Agent 5 | 7 files | Pending |
| W-06 | workflows-code--full-stack | Agent 6 | 33 files | Pending |

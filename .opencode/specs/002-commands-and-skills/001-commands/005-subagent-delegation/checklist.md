...
/spec_kit:handover specs/002-commands-and-skills/001-commands/005-subagent-delegation

# Test memory save with sub-agent  
/memory:save 005-subagent-delegation

# Verify files created
ls -la specs/002-commands-and-skills/001-commands/005-subagent-delegation/
```

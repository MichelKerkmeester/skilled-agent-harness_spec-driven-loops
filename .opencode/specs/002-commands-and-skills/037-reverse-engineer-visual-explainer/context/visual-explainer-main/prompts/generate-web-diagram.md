...
---
Load the sk-doc-visual skill, then generate an HTML diagram for: $@

Follow the sk-doc-visual skill workflow. Read the reference template and CSS patterns before generating. Pick a distinctive aesthetic that fits the content — vary fonts, palette, and layout style from previous diagrams.

...
| `.opencode/skill/workflows-chrome-devtools/SKILL.md` | Modify | Update references to workflows-code |
| `.opencode/skill/workflows-chrome-devtools/examples/README.md` | Modify | Update references |

---
title: "To promote a memory to constitutional tier (always [006-sk-doc-visual/21-02-26_12-30__sk-doc-visual]"
...
| Spec Folder | 002-commands-and-skills/038-skill-rename/006-sk-doc-visual |
| Channel | main |
...
```
/spec_kit:resume 002-commands-and-skills/038-skill-rename/006-sk-doc-visual
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: 002-commands-and-skills/038-skill-rename/006-sk-doc-visual
Last: Tool: bash
...
**Key Topics:** `skill` | `memory` | `skill graph` | `commands and skills/038 skill rename/006 sk doc visual` | `graph` | `commands` | `skills/038` | `rename/006` | `visual` | `explainer` | `sgqs` | `analysis` | 
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 002-commands-and-skills/038-skill-rename/006-sk-doc-visual` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "002-commands-and-skills/038-skill-rename/006-sk-doc-visual" })` |
...
memory_search({ specFolder: "002-commands-and-skills/038-skill-rename/006-sk-doc-visual", limit: 10 })

# Verify memory file integrity
ls -la 002-commands-and-skills/038-skill-rename/006-sk-doc-visual/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js 002-commands-and-skills/038-skill-rename/006-sk-doc-visual --force
```
...
spec_folder: "002-commands-and-skills/038-skill-rename/006-sk-doc-visual"
channel: "main"
...
key_topics:
  ...
  - "memory"
  - "skill graph"
  - "commands and skills/038 skill rename/006 sk doc visual"
  - "graph"
  - "commands"
  - "skills/038"
  - "rename/006"
...
parent_spec: "002-commands-and-skills/038-skill-rename/006-sk-doc-visual"
child_sessions:

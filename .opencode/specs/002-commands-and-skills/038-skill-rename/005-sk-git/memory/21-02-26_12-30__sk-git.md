...
```
/spec_kit:resume 002-commands-and-skills/038-skill-rename/005-sk-git
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: 002-commands-and-skills/038-skill-rename/005-sk-git
Last: Tool: bash
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 002-commands-and-skills/038-skill-rename/005-sk-git` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "002-commands-and-skills/038-skill-rename/005-sk-git" })` |
...
memory_search({ specFolder: "002-commands-and-skills/038-skill-rename/005-sk-git", limit: 10 })

# Verify memory file integrity
ls -la 002-commands-and-skills/038-skill-rename/005-sk-git/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js 002-commands-and-skills/038-skill-rename/005-sk-git --force
```
...
spec_folder: "002-commands-and-skills/038-skill-rename/005-sk-git"
channel: "main"
...
parent_spec: "002-commands-and-skills/038-skill-rename/005-sk-git"
child_sessions:

...
- [x] CHK-001 [P0] Requirements documented in `spec.md` [EVIDENCE: `.opencode/specs/002-commands-and-skills/041-sk-doc-visual-hardening/001-online-visual-upgrade/spec.md`]
- [x] CHK-002 [P0] Technical approach defined in `plan.md` [EVIDENCE: `.opencode/specs/002-commands-and-skills/041-sk-doc-visual-hardening/001-online-visual-upgrade/plan.md`]
...
- [x] CHK-050 [P1] Temp files in `scratch/` only [EVIDENCE: temporary package exists at `.opencode/specs/002-commands-and-skills/041-sk-doc-visual-hardening/001-online-visual-upgrade/scratch/sk-doc-visual.zip`]

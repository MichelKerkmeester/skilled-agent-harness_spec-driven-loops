...
| File | Path | Purpose |
|------|------|---------|
| `spec.md` | `specs/002-commands-and-skills/004-workflows-code/006-js-codebase-analysis/spec.md` | Requirements document |
| `plan.md` | `specs/002-commands-and-skills/004-workflows-code/006-js-codebase-analysis/plan.md` | 5-phase analysis plan |
| `tasks.md` | `specs/002-commands-and-skills/004-workflows-code/006-js-codebase-analysis/tasks.md` | Task breakdown |
| `checklist.md` | `specs/002-commands-and-skills/004-workflows-code/006-js-codebase-analysis/checklist.md` | Validation checklist |
| `decision-record.md` | `specs/002-commands-and-skills/004-workflows-code/006-js-codebase-analysis/decision-record.md` | Architecture decisions |
| `files-inventory.md` | `specs/002-commands-and-skills/004-workflows-code/006-js-codebase-analysis/files-inventory.md` | This file |

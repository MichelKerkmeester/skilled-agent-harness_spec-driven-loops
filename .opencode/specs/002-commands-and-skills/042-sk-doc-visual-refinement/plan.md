...
| Spec validation | Level 2 spec file integrity | `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/002-commands-and-skills/042-sk-doc-visual-speckit-alignmnet` |
<!-- /ANCHOR:testing -->

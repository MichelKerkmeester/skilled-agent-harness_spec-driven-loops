...
- **Smart Router V2 baseline** (034-smart-router-v2) must be complete
...
- **Parent Spec (Baseline)**: `../034-smart-router-v2/` (Smart Router V2 initial deployment)
- **Test Suite Location**: `../034-smart-router-v2/scratch/smart-router-tests/`

...
| Spec Folder | 002-commands-and-skills/005-workflows-code-opencode |
| Channel | main |
...
<!-- ANCHOR:preflight-session-1770189135265-4smzo602m-002-commands-and-skills/005-workflows-code-opencode -->
## PREFLIGHT BASELINE
...
<!-- ANCHOR:continue-session-session-1770189135265-4smzo602m-002-commands-and-skills/005-workflows-code-opencode -->
...
```
/spec_kit:resume 002-commands-and-skills/005-workflows-code-opencode
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: 002-commands-and-skills/005-workflows-code-opencode
...
<!-- ANCHOR:summary-session-1770189135265-4smzo602m-002-commands-and-skills/005-workflows-code-opencode -->
<a id="overview"></a>
...
<!-- ANCHOR:decisions-session-1770189135265-4smzo602m-002-commands-and-skills/005-workflows-code-opencode -->
<a id="decisions"></a>
...
<!-- ANCHOR:session-history-session-1770189135265-4smzo602m-002-commands-and-skills/005-workflows-code-opencode -->
<a id="conversation"></a>
...
<!-- ANCHOR:recovery-hints-session-1770189135265-4smzo602m-002-commands-and-skills/005-workflows-code-opencode -->
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 002-commands-and-skills/005-workflows-code-opencode` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "002-commands-and-skills/005-workflows-code-opencode" })` |
...
memory_search({ specFolder: "002-commands-and-skills/005-workflows-code-opencode", limit: 10 })

# Verify memory file integrity
ls -la 002-commands-and-skills/005-workflows-code-opencode/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/memory/generate-context.js 002-commands-and-skills/005-workflows-code-opencode --force
```
...
<!-- ANCHOR:postflight-session-1770189135265-4smzo602m-002-commands-and-skills/005-workflows-code-opencode -->
...
<!-- ANCHOR:metadata-session-1770189135265-4smzo602m-002-commands-and-skills/005-workflows-code-opencode -->
...
spec_folder: "002-commands-and-skills/005-workflows-code-opencode"
channel: "main"
...
key_files:
  - "specs/002-commands-and-skills/005-workflows-code-opencode/spec.md"
  - "specs/002-commands-and-skills/005-workflows-code-opencode/plan.md"
  - "specs/002-commands-and-skills/005-workflows-code-opencode/checklist.md"
  - "specs/002-commands-and-skills/005-workflows-code-opencode/decision-record.md"
  - "specs/002-commands-and-skills/005-workflows-code-opencode/handover.md"
...
parent_spec: "002-commands-and-skills/005-workflows-code-opencode"
child_sessions:

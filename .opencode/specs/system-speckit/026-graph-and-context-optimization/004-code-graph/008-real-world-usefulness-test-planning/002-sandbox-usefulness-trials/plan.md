...
- [x] Spec folder approved. Evidence: user pre-approved `002-sandbox-usefulness-trials/`.
...
- **Procedure**: Remove `002-sandbox-usefulness-trials/` and remove `system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/002-sandbox-usefulness-trials` from `../graph-metadata.json.children_ids`.
<!-- /ANCHOR:rollback -->
...
### Rollback Procedure
1. Delete `002-sandbox-usefulness-trials/`.

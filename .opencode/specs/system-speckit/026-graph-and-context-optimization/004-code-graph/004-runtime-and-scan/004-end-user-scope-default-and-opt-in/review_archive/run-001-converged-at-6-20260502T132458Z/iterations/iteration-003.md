...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/review/deep-review-state.jsonl:1-3`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/review/deep-review-findings-registry.json:1-47`
...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/review/iterations/iteration-001.md:46-61`
...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/spec.md:84-122`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/plan.md:144-167`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/checklist.md:82-88`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/implementation-summary.md:64-80`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/resource-map.md:54-90`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/resource-map.md:103-109`
- `.opencode/skills/system-spec-kit/mcp_server/lib/utils/index-scope.ts:48-65`
...
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/structural-indexer.ts:1390-1423`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/structural-indexer.ts:1435-1485`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/structural-indexer.ts:2070-2098`
...
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/ensure-ready.ts:293-303`
...
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/status.ts:168-278`
...
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/tests/code-graph-indexer.vitest.ts:257-325`
...
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/tests/code-graph-scope-readiness.vitest.ts:63-100`
...
#### R3-P1-001 — Symlinked `rootDir` can bypass the default `.opencode/skills/**` exclusion
...
- **evidenceRefs**:
  - `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/scan.ts:184-217`
  - `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/structural-indexer.ts:1390-1423`
  - `.opencode/skills/system-spec-kit/mcp_server/lib/utils/index-scope.ts:48-65`
  - `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/structural-indexer.ts:2070-2098`

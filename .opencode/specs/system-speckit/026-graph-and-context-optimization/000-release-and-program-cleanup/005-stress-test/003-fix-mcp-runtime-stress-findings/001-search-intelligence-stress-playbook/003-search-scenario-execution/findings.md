...
> v1.0.2 re-run: scaffold landed at [`../../010-stress-test-close-loop-measurement-rerun/`](../../010-stress-test-close-loop-measurement-rerun/); sweep execution pending. This v1.0.1 findings document remains frozen as the baseline.

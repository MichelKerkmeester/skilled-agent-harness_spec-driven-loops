...
trigger_phrases:
  - "003-fix-mcp-runtime-stress-findings"
...
| 11 | `011-research-post-stress-finding-followups/` | 10-iteration `/deep:start-research-loop:auto` loop refining v1.0.2 P0/P1/P2 follow-ups + light architectural touch on intelligence-system seams | complete (10/10 iters converged 2026-04-27; research.md synthesized) |
...
- Use `/spec_kit:resume specs/.../003-fix-mcp-runtime-stress-findings/[NNN-phase]/` to resume a specific phase.

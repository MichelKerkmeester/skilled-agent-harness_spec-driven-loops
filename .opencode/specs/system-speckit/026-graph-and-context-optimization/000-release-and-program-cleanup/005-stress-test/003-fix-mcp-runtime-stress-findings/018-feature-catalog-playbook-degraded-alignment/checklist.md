...
title: "Verification Checklist: Catalog and playbook degraded-alignment [system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/018-feature-catalog-playbook-degraded-alignment/checklist]"
...
- [x] CHK-003 [P0] Review-report §4 (F-005 / F-007 / F-008 doc parts) and §7 Packet C read end-to-end. [EVIDENCE: `../011-research-post-stress-finding-followups/review/review-report.md` ingested by spec author; finding citations match.]
...
- [x] CHK-055 [P1] No per-runtime copies created (only `.opencode/skills/system-spec-kit/` hosts these files). [EVIDENCE: `find .gemini .claude .codex` returned no feature_catalog or manual_testing_playbook trees.]

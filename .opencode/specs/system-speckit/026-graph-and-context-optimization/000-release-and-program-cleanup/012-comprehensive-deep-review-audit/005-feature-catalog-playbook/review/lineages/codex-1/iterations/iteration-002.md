...
The sampled local-LLM cleanup scenario uses a placeholder `<spec-folder>` for file removal [SOURCE: .opencode/skills/system-spec-kit/manual_testing_playbook/24--local-llm-query-intelligence/paraphrase-recall.md:101], and the root deterministic notation says placeholders must be replaced before execution [SOURCE: .opencode/skills/system-spec-kit/manual_testing_playbook/manual_testing_playbook.md:91].

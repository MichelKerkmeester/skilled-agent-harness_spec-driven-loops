...
|---|---|---|---|---|
| DR-CAT-P1-001 | P1 | catalog-code-traceability | Code-reference coverage claim is stale: docs claim `192/280` and about 69%, current non-test `.ts` sweep found `195/990` and 19.70%. | `.opencode/skills/system-spec-kit/feature_catalog/tooling-and-scripts/feature-catalog-code-references.md:26` |
...
| DR-CAT-P2-001 | P2 | portability | Validation docs use `FEATURE_CATALOG.md`, which is risky on case-sensitive filesystems. | `.opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/feature-catalog-annotation-name-validity.md:38` |
| DR-CAT-P2-002 | P2 | playbook-capability | Scenario 135 greps only `mcp_server/` while the catalog scope also names `shared/`. | `.opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/grep-traceability-for-feature-catalog-code-references.md:38` |
| DR-CAT-P2-003 | P2 | playbook-quality | Scenario 136 has malformed real-user-request and expected-signal text. | `.opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/feature-catalog-annotation-name-validity.md:18` |

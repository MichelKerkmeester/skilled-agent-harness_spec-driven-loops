...
| Field | Value |
|-------|-------|
| **Spec Folder** | 001-fix-additional-release-readiness-findings |
...
- Strict validators did not pass. The focused implementation tests and build are green, but validator runs failed on structural/template debt:
  - `002-fix-additional-release-readiness-findings`: custom task/checklist/summary section shape lacks the current Level 2 template anchors.

...
### Definition of Ready
- [ ] 001-phase-parent-validator-docs has shipped (lean trio enforcement live)
...
|-------|------------|--------|
| Phase 1 | 001-phase-parent-validator-docs | Phase 3 (resume needs pointer) |
| Phase 2 | 001-phase-parent-validator-docs | None (template/create work independent) |

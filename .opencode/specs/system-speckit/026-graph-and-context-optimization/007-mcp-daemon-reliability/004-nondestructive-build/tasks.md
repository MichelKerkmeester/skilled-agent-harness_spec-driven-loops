...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/007-mcp-daemon-reliability/004-nondestructive-build"
...
- **Plan**: See `plan.md`
- **Root cause**: See `../003-daemon-reliability-research/research/research.md` (RC-4)
<!-- /ANCHOR:cross-refs -->

...
| **Successor** | 008-template-levels/003 hands off to a future implementation execution session |
...
- Use `/spec_kit:resume 008-template-levels/00X-...` to resume a specific phase

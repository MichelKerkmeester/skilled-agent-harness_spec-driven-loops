...
| Field | Value |
|-------|-------|
| **Spec Folder** | 006-playbook-run-and-remediation/005-finding-remediation/002-scorer-p0-routing-fixes |
...
2. **`lane-weight-sweep.vitest.ts` fails on a stale 026-packet path** — pre-existing, unrelated to this phase (the referenced `002-skill-advisor-scoring-engine/` packet was renamed in the 026 reorg).
<!-- /ANCHOR:limitations -->

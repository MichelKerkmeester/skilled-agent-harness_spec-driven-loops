...
## Evidence read
- `.opencode/skills/system-spec-kit/scripts/observability/live-session-wrapper.ts:128-157` -> wrapper records only `Read` tool calls, swallows failures, and never blocks runtime behavior.

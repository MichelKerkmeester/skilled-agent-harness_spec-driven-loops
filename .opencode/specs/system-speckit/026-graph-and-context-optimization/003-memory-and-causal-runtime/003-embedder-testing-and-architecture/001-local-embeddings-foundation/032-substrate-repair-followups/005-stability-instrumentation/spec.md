...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/001-local-embeddings-foundation/032-substrate-repair-followups/005-stability-instrumentation/resource-map.md` | Create | Document five substrate stability thresholds |
<!-- /ANCHOR:scope -->

...
FIXTURE="${FIXTURE_OVERRIDE:-$REPO_ROOT/.opencode/skills/mcp-coco-index/mcp_server/benchmarks/2026-05-20--run--unspecified/code-retrieval-fixture-expanded-v2.json}"
PACKET_DIR="$REPO_ROOT/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/004-code-index-stack/023-deep-research-arc-blind-spots/007-fixture-calibration"

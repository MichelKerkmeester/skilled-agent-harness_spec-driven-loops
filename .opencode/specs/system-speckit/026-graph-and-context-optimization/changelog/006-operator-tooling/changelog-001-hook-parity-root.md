---
title: "Phase Parent Rollup: hook parity"
description: "Rollup of 17 child phase changelogs under 001-hook-parity. Each child shipped independently and is listed in the Included Phases table. Detail lives in the child changelogs."
trigger_phrases:
...
|------|--------|--------------|
| `006-operator-tooling/001-hook-parity/` (child phases) | n/a | Rollup of 17 child phase changelogs, no direct source changes at the parent level |

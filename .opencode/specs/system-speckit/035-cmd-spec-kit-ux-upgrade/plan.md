...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade"
...
| **Storage** | Packet-local files under `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/` |
...
| Packet | Spec-folder compliance | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade --strict` |

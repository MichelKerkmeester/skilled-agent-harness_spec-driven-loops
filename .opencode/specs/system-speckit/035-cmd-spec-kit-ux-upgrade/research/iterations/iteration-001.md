...
1. Read external root docs and package surface:
   - `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/README.md`
   - `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/ROADMAP.md`
   - `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/technicalBrief.md`
   - `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/AGENTS.md`
   - `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/package.json`
2. Read the five external SPAR skills:
   - `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/install-root/skills/spar-init/SKILL.md`
   - `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/install-root/skills/spar-specify/SKILL.md`
   - `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/install-root/skills/spar-plan/SKILL.md`
   - `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/install-root/skills/spar-act/SKILL.md`
   - `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/install-root/skills/spar-retain/SKILL.md`
3. Read external target configs and installer code:
   - `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/install-root/targets/default.json`
   - `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/install-root/targets/codex.json`
   - `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/install-root/targets/opencode.json`
   - `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/lib/cli.mjs`
   - `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/lib/install-engine.mjs`
...
SPAR's strongest distribution pattern is not npm itself; it is the small target manifest layer. The external package exposes one install command with runtime flags in `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/lib/cli.mjs`, applies default/general behavior through `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/lib/install-engine.mjs`, and expresses placement policy through `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/install-root/targets/default.json`, `codex.json`, and `opencode.json`.

The internal system already has cross-runtime complexity, but it is spread through command assets, runtime agent directories, and hook architecture rather than a single install manifest. Relevant internal surfaces include `.opencode/agents/README.txt`, `.opencode/commands/create/assets/create_feature_catalog_confirm.yaml`, and `.opencode/skills/system-spec-kit/ARCHITECTURE.md`.
...
SPAR's individual skills are concise about what not to do in each phase. `spar-specify` forbids implementation planning, `spar-plan` asks before starting implementation, `spar-act` stops before retention, and `spar-retain` reconciles final artifacts before archiving. The relevant external files are `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/install-root/skills/spar-specify/SKILL.md`, `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/install-root/skills/spar-plan/SKILL.md`, `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/install-root/skills/spar-act/SKILL.md`, and `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/install-root/skills/spar-retain/SKILL.md`.
...
- Q1 needs a focused managed-block pass over `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/lib/repo-bootstrap.mjs` and the internal AGENTS.md sync triad.
...
- Q4 and Q7 need the personas / tone pass over `.opencode/specs/skilled-agent-orchestration/z_archive/045-cmd-spec-kit-ux-upgrade/external/Research/Personas/Personas.md` and SPAR's specify/plan prompt language.
- Q5 needs the tools.yaml pass over `.spar-kit/.local/tools.yaml` seed behavior and internal skill-advisor + MCP discovery.

## Next Focus

Iteration 2 should cover Axis 2 and Axis 4 together: read external `lib/repo-bootstrap.mjs`, `install-root/AGENTS.md`, `install-root/CLAUDE.md`, `templates/spec.md`, `templates/plan.md`, and internal `.opencode/skills/system-spec-kit/templates/compose.sh` plus the core/addendum template directories. The goal is to separate a small managed-block policy we can realistically adapt from template-composition ideas that need deeper design.

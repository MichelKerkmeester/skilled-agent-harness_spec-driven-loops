...
_memory:
  continuity:
    packet_pointer: "system-speckit/003-xce-research-based-refinement/002-memory-store-and-search/013-provenance-injection"
...
| `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/002-memory-store-and-search/013-provenance-injection/*` | Created | Document phase scope, plan, checklist, tasks, metadata, summary, and follow-ons. |
<!-- /ANCHOR:what-built -->

...
[F-074-06] No nested `002-coco` edit is required in the 027 parent or `001-aggregator/graph-metadata.json`: 027 lists only `008` as the child phase, and `001` has no downstream/manual edge. `003-xce-research-based-refinement/graph-metadata.json:6-16`, `003-xce-research-based-refinement/description.json:27-36`, `003-xce-research-based-refinement/context-index.md:35-40`, `001-aggregator/graph-metadata.json:6-13`
...
status: complete  
sources: `005-learning-feedback-reducers/description.json:23-34`, `005-learning-feedback-reducers/graph-metadata.json:6-12`, `005-learning-feedback-reducers/spec.md:47-94`, `005-env-tests-integration/description.json:17-23`, `005-env-tests-integration/graph-metadata.json:6-13`, `005-env-tests-integration/spec.md:38-150`, `001-aggregator/graph-metadata.json:6-13`, `003-xce-research-based-refinement/graph-metadata.json:6-16`, `003-xce-research-based-refinement/description.json:27-36`, `003-xce-research-based-refinement/context-index.md:35-40`, `.opencode/skills/system-spec-kit/constitutional/spec-folder-naming.md:31-33`

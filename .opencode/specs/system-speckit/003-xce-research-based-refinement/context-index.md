...
mirroring how `002-graph-and-context-optimization` organizes its work and how
...
Two standalone track-root packets were relocated under `003-xce-research-based-refinement/` as
...
> is `004-memory-search-intelligence` (unrelated to the Code Graph / CocoIndex work). The fate of the

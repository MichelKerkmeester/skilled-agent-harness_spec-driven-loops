...
| 002 memory store and search | 39 | 6 | [changelog-002-memory-store-and-search-root.md](./002-memory-store-and-search/changelog-002-memory-store-and-search-root.md) |
| 003 advisor and code graph | 13 | 2 | [changelog-003-advisor-and-codegraph-root.md](./003-advisor-and-codegraph/changelog-003-advisor-and-codegraph-root.md) |
...
- The directory layout mirrors `002-graph-and-context-optimization/changelog/` (flat per themed track).

...
trigger_phrases:
  - "004/005 autonomous dependency patching changelog"
...
> Spec folder: `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/004-shared-infrastructure/005-autonomous-dependency-patching` (Level 1)
...
- `005-autonomous-dependency-patching/scripts/audit-and-fix.sh` — audit and remediation entrypoint over the eligible skill package roots
...
| File | Action |
|------|--------|
| `005-autonomous-dependency-patching/scripts/audit-and-fix.sh` | Created |

...
_memory:
  continuity:
    packet_pointer: "system-speckit/003-xce-research-based-refinement/005-verification-and-remediation/005-fresh-regression-remediation/005-spec-folder-metadata-reconciliation"
...
- [x] 005-T006 · `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/context-index.md:62` — Add a forward note recording what happened to 028-code-graph-and-cocoindex after the 2026-05-28 split (renamed/abandoned; current track 028 is 004-memory-search-intelligence), or explicitly mark the s _[P2]_ — **FIXED**. [Confirmed: `028-code-graph-and-cocoindex` does not exist at any depth; real track-028 is `004-memory-search-intelligence` (.gitkeep + external/ only). Added a "Historical event record (not live guidance)" callout under the section header and rewrote line-62 present-tense guidance into past-tense with the real fate + dangling-pointer note.]

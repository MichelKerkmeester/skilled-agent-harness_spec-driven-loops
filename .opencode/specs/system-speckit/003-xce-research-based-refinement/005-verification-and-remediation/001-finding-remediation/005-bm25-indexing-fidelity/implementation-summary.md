...
_memory:
  continuity:
    packet_pointer: "system-speckit/003-xce-research-based-refinement/005-verification-and-remediation/001-finding-remediation/005-bm25-indexing-fidelity"
...
| Disposition | Count |
|-------------|-------|
| Fixed (verified + remediated, incl. pre-lane rounds) | 0 |
| Refuted with proof | 1 |
| Downgraded to P2 (triaged below) | 3 |
...
| WAIVE (reason recorded per entry) | 0 |
| ALREADY_FIXED | 0 |

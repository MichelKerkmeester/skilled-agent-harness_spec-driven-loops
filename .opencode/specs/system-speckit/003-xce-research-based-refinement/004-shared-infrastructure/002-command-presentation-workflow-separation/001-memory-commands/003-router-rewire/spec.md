---
title: "Feature Specification: Memory Commands - Router Rewire"
...
trigger_phrases:
  - "001-memory-commands 003-router-rewire"
  - "memory commands router rewire"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/003-xce-research-based-refinement/004-shared-infrastructure/002-command-presentation-workflow-separation/001-memory-commands/003-router-rewire"
    last_updated_at: "2026-06-10T19:14:00Z"
    last_updated_by: "gpt-5.5"
    recent_action: "Slimmed memory commands into presentation-aware routers"
    next_safe_action: "Create workflow YAML assets in a separate scoped change if YAML-owned execution is required"
    blockers: []
    key_files:
      - "spec.md"
      - "plan.md"
    ...
    session_dedup:
      ...
      session_id: "2026-06-10-001-memory-commands-003-router-rewire-scaffold"
...
---
# Feature Specification: Memory Commands - Router Rewire
...
### Problem Statement
Memory Commands needs a scoped router rewire phase so presentation extraction can proceed without mixing implementation, routing, and display-contract decisions.

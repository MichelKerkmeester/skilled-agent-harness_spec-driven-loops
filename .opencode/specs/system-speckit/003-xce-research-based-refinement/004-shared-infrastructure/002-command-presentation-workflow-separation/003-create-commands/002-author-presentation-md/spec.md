---
title: "Feature Specification: Create Commands - Author Presentation Markdown"
...
trigger_phrases:
  - "003-create-commands 002-author-presentation-md"
  - "create commands author presentation markdown"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/003-xce-research-based-refinement/004-shared-infrastructure/002-command-presentation-workflow-separation/003-create-commands/002-author-presentation-md"
    last_updated_at: "2026-06-10T19:45:00Z"
    last_updated_by: "gpt-5.5-fast"
    recent_action: "Created dedicated presentation Markdown assets for every create command"
    next_safe_action: "Keep startup questions, dashboards, and result templates in presentation Markdown"
    blockers: []
    key_files:
      - "spec.md"
      - "plan.md"
    ...
    session_dedup:
      ...
      session_id: "2026-06-10-003-create-commands-002-author-presentation-md-scaffold"
...
---
# Feature Specification: Create Commands - Author Presentation Markdown
...
### Problem Statement
Create Commands needs a scoped author presentation markdown phase so presentation extraction can proceed without mixing implementation, routing, and display-contract decisions.

---
title: "Feature Specification: Doctor Commands - Verify and UX"
...
trigger_phrases:
  - "004-doctor-commands 004-verify-and-ux"
  - "doctor commands verify and ux"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/003-xce-research-based-refinement/004-shared-infrastructure/002-command-presentation-workflow-separation/004-doctor-commands/004-verify-and-ux"
    last_updated_at: "2026-06-10T20:07:37Z"
    last_updated_by: "gpt-5.5"
    recent_action: "Verification completed"
    next_safe_action: "Run doctor commands using presentation assets for display and YAML assets for execution."
    blockers: []
    key_files:
      - "spec.md"
      - "plan.md"
    ...
    session_dedup:
      ...
      session_id: "2026-06-10-004-doctor-commands-004-verify-and-ux-scaffold"
...
---
# Feature Specification: Doctor Commands - Verify and UX
...
### Problem Statement
Doctor Commands needs a scoped verify and ux phase so presentation extraction can proceed without mixing implementation, routing, and display-contract decisions.
...
|-----------|-------------|-------------|
| `.opencode/commands/doctor/*.md` | Verified | Router references and presentation load order checked |
| `.opencode/commands/doctor:*.md` | Reviewed | No legacy command surfaces found |
| `.opencode/commands/doctor/assets/**/*.yaml` | Verified Read-Only | Existing workflow YAML referenced, never edited |
| `.opencode/commands/doctor/assets/**/*.yml` | Verified Read-Only | No workflow YAML edits performed |
| Dedicated presentation Markdown files | Verified | Presentation contracts cover startup questions, dashboards, and results display |
<!-- /ANCHOR:scope -->

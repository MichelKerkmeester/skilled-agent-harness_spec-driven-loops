...
- [x] T001 Enumerate the 41 in-scope packet roots (43 total minus `system-speckit/028-*` minus `deep-loops/030-agent-loops-improved`; discovered and excluded `system-speckit/031-manual-playbook-execution-sweep` mid-sweep as a live concurrent session).

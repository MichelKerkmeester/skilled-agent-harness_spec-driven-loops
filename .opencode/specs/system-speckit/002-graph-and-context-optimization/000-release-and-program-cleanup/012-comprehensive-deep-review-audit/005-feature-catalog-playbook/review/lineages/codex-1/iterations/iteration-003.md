...
Running the same glob in the current tree returned 384 files. Category 24 is listed in the root playbook [SOURCE: .opencode/skills/system-spec-kit/manual_testing_playbook/manual_testing_playbook.md:41] and its README lists scenarios 401-415 [SOURCE: .opencode/skills/system-spec-kit/manual_testing_playbook/local-llm-query-intelligence/README.md:60].
...
```json
{
  ...
  "evidenceRefs": [
    ...
    ".opencode/skills/system-spec-kit/manual_testing_playbook/manual_testing_playbook.md:173",
    ".opencode/skills/system-spec-kit/manual_testing_playbook/local-llm-query-intelligence/README.md:60"
  ],
...
- `mutation/10-per-record-history-log.md` [SOURCE: .opencode/skills/system-spec-kit/manual_testing_playbook/mutation/feature-09-direct-manual-scenario-per-memory-history-log.md:55]
- `retrieval/hybrid-search-pipeline.md` [SOURCE: .opencode/skills/system-spec-kit/manual_testing_playbook/retrieval/hybrid-search-pipeline.md:60]
- `retrieval/4-stage-pipeline-architecture.md` [SOURCE: .opencode/skills/system-spec-kit/manual_testing_playbook/retrieval/4-stage-pipeline-architecture.md:57]
- `stress-testing/01-stress-test-cycle.md` [SOURCE: .opencode/skills/system-spec-kit/manual_testing_playbook/stress-testing/run-stress-cycle.md:146]
- `maintenance/startup-runtime-compatibility-guards.md` [SOURCE: .opencode/skills/system-spec-kit/manual_testing_playbook/maintenance/startup-runtime-compatibility-guards.md:59]
...
```json
{
  ...
  "evidenceRefs": [
    ".opencode/skills/system-spec-kit/manual_testing_playbook/mutation/feature-09-direct-manual-scenario-per-memory-history-log.md:55",
    ".opencode/skills/system-spec-kit/manual_testing_playbook/retrieval/hybrid-search-pipeline.md:60",
    ".opencode/skills/system-spec-kit/manual_testing_playbook/retrieval/4-stage-pipeline-architecture.md:57",
    ".opencode/skills/system-spec-kit/manual_testing_playbook/stress-testing/run-stress-cycle.md:146",
    ".opencode/skills/system-spec-kit/manual_testing_playbook/maintenance/startup-runtime-compatibility-guards.md:59"
  ],
...
The dedicated scenario file's real user request is malformed and includes a dangling command fragment [SOURCE: .opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/feature-catalog-annotation-name-validity.md:18]. Its expected signals repeat the same broken sequence [SOURCE: .opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/feature-catalog-annotation-name-validity.md:21].
...
```json
{
  ...
  "evidenceRefs": [
    ".opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/feature-catalog-annotation-name-validity.md:18",
    ".opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/feature-catalog-annotation-name-validity.md:21",

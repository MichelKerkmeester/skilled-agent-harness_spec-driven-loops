...
trigger_phrases:
  - "007-fix-stress-test-coverage-gap-followup summary"
  - "stress gap remediation summary"
importance_tier: "important"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "system-speckit/002-graph-and-context-optimization/000-release-and-program-cleanup/005-stress-test/007-fix-stress-test-coverage-gap-followup"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 007-fix-stress-test-coverage-gap-followup |

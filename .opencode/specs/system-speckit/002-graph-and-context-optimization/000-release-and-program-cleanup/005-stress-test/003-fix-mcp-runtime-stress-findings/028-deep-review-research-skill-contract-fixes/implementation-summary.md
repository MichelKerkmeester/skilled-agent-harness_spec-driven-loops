...
trigger_phrases:
  - "028-deep-review-research-skill-contract-fixes complete"
importance_tier: "important"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "system-speckit/002-graph-and-context-optimization/000-release-and-program-cleanup/005-stress-test/003-fix-mcp-runtime-stress-findings/028-deep-review-research-skill-contract-fixes"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 028-deep-review-research-skill-contract-fixes |
...
- This packet does NOT migrate any historical missing-iterations folder (e.g., `001-post-program-doc-and-state-cleanup-pt-01/` from commit `6a8095907`). That's a separate cleanup decision — historical incomplete artifacts stay incomplete; new runs benefit from the fix.
<!-- /ANCHOR:limitations -->

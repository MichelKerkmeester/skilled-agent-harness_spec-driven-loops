...
_memory:
  continuity:
    packet_pointer: "system-speckit/002-graph-and-context-optimization/000-release-and-program-cleanup/005-stress-test/003-fix-mcp-runtime-stress-findings/011-research-post-stress-finding-followups"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 011-research-post-stress-finding-followups |
...
- **New leaf packet, not 010-internal research.** Per user clarification, research lands at this new sibling packet rather than inside `010-stress-test-close-loop-measurement-rerun/research/`. Makes the research a first-class child of the 011 phase parent (visible in `derived.children_ids`, surfaced by resume ladder).

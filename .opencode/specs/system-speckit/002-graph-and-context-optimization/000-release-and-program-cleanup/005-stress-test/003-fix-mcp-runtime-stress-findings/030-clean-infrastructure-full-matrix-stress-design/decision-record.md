...
v1.0.2 used a 30-cell CLI-model rubric. Packet 029 used 12 search-quality cases and 16 telemetry captures, and explicitly said v1.0.2 was not exact same-cell comparable (`029-clean-infrastructure-stress-test/findings-v1-0-4.md:25`, `:129`, `:150`). The future full matrix is likely 220-260 applicable/scored-or-fixture cells.

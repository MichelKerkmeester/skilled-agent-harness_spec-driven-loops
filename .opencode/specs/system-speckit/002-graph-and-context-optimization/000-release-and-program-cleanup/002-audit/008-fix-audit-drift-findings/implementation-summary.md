...
trigger_phrases:
  - "008-fix-audit-drift-findings summary"
importance_tier: "important"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "system-speckit/002-graph-and-context-optimization/000-release-and-program-cleanup/002-audit/008-fix-audit-drift-findings"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 008-fix-audit-drift-findings |
...
| `008-fix-audit-drift-findings/{spec,plan,tasks,checklist,implementation-summary}.md` | Created | Packet docs |
| `008-fix-audit-drift-findings/{description,graph-metadata}.json` | Generated | Lean-trio metadata |
| `008-fix-audit-drift-findings/logs/stress-run-*.log` | Created | Full `npm run stress` capture |
<!-- /ANCHOR:what-built -->

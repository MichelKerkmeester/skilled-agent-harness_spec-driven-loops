...
_memory:
  continuity:
    packet_pointer: "system-speckit/002-graph-and-context-optimization/000-release-and-program-cleanup/003-cross-cutting-cleanup-pass/016-runtime-hook-plugin-testing"
...
Remove the packet-local files added under `016-runtime-hook-plugin-testing/`. Runtime hook configs were not modified, so rollback does not require restoring Claude, Codex, Copilot, Gemini, or OpenCode settings.
<!-- /ANCHOR:rollback -->

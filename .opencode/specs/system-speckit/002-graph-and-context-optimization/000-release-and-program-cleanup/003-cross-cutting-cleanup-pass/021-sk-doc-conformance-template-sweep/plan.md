...
_memory:
  continuity:
    packet_pointer: "system-speckit/002-graph-and-context-optimization/000-release-and-program-cleanup/003-cross-cutting-cleanup-pass/021-sk-doc-conformance-template-sweep"
    ...
    session_dedup:
      ...
      parent_session_id: "002-graph-and-context-optimization"
    completion_pct: 8
    open_questions: []
    answered_questions: []
---

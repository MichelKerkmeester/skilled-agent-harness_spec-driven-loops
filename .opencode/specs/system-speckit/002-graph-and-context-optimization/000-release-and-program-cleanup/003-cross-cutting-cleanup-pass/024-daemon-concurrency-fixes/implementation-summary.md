...
_memory:
  continuity:
    packet_pointer: "system-speckit/002-graph-and-context-optimization/000-release-and-program-cleanup/003-cross-cutting-cleanup-pass/024-daemon-concurrency-fixes"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 024-daemon-concurrency-fixes |
...
| `.opencode/specs/.../024-daemon-concurrency-fixes/` | Created | Level 2 packet (spec, plan, tasks, checklist, implementation-summary, README) |
<!-- /ANCHOR:what-built -->

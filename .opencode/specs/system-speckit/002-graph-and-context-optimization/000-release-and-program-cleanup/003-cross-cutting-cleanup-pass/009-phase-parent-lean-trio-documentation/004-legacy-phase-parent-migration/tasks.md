...
- [ ] T002 [P] Author `/tmp/copilot-worker-2.md` (Worker 2: 00--ai-systems subtree (6) + 024-compact-code-graph subtree (1) + 026/003-fix-mcp-runtime-stress-findings/001-search-intelligence-stress-playbook (1) = 8 total)
- [ ] T003 [P] Author `/tmp/copilot-worker-3.md` (Worker 3: 002-graph-and-context-optimization C-category active (3-4 parents) + ALL z_archive/z_future entries (~7) = ~11 total)
...
- [ ] T013 Run `validate.sh --strict --json` on `002-graph-and-context-optimization/`; diff parent error rules against `scratch/regression-baseline-pre-004.txt` — MUST match
...
- **Predecessors**: See `../001-phase-parent-validator-docs/`, `../002-phase-parent-generator-pointer-polish/`, `../003-phase-parent-reference-readme-sync/`

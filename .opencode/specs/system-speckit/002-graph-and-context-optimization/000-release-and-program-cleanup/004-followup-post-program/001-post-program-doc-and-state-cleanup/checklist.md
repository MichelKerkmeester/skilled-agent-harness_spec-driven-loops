...
_memory:
  continuity:
    ...
    session_dedup:
      fingerprint: "sha256:001-post-program-doc-and-state-cleanup-checklist-20260428"
...
- [x] CHK-050 [P1] Review report lives under `review/001-post-program-doc-and-state-cleanup-pt-01/`. [EVIDENCE: review/001-post-program-doc-and-state-cleanup-pt-01/review-report.md]

...
- [x] T002 Audit Tier A status/phase-map/validator state. Evidence: `review/001-post-program-doc-and-state-cleanup-pt-01/review-report.md`.
- [x] T003 Audit Tier B helpers and fixtures. Evidence: `review/001-post-program-doc-and-state-cleanup-pt-01/review-report.md`.
...
- [x] T009 Refresh stale `derived.status` values for completed packets. Evidence: `../001-fix-memory-indexer-storage-boundary/graph-metadata.json`, `../002-fix-additional-release-readiness-findings/graph-metadata.json`, `../../../006-skill-advisor/002-skill-graph-daemon-native-advisor-tools/graph-metadata.json`.
...
- **Plan**: See `plan.md`
- **Review**: See `review/001-post-program-doc-and-state-cleanup-pt-01/review-report.md`
<!-- /ANCHOR:cross-refs -->

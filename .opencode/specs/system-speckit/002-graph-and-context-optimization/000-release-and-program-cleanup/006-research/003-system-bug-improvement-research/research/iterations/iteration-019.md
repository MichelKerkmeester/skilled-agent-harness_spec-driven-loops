...
## Questions Remaining
- Should `002-graph-and-context-optimization/000-release-cleanup/005-review-remediation` be reorganized physically, or should the graph layer introduce virtual grouping while preserving paths?

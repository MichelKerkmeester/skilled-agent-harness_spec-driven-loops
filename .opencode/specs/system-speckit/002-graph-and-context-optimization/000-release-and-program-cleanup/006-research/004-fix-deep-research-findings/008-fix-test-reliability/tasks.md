...
_memory:
  continuity:
    packet_pointer: "system-speckit/002-graph-and-context-optimization/000-release-and-program-cleanup/006-research/004-fix-deep-research-findings/008-fix-test-reliability"
    ...
    session_dedup:
      ...
      session_id: "049-009-fix-test-reliability"
...
- [x] T001 [P1] Re-read packet 046 §C5 (test reliability) to confirm finding IDs and cited line ranges (`.opencode/specs/.../003-system-bug-improvement-research/research/research.md`)
...
- Source of truth: `../003-system-bug-improvement-research/research/research.md` §C5
- Parent packet: `../spec.md` (049 phase parent — manifest)
- Worked-pilot pattern: sub-phase 010-fix-cli-orchestrator-doc-drift (committed as `889d1ee08`)
<!-- /ANCHOR:cross-refs -->

...
_memory:
  continuity:
    packet_pointer: "system-speckit/002-graph-and-context-optimization/000-release-and-program-cleanup/006-research/004-fix-deep-research-findings/005-fix-architecture-cleanup-followups"
    ...
    session_dedup:
      ...
      session_id: "049-006-fix-architecture-cleanup-followups"
...
- Worked-pilot patterns: `../004-fix-validation-memory/` (commit `1822a1e69`, 13 findings) and `../001-fix-code-graph-consistency/` (commit `57abfc553`, 9 findings)
<!-- /ANCHOR:cross-refs -->

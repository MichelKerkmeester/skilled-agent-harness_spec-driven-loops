...
_memory:
  continuity:
    packet_pointer: "system-speckit/002-graph-and-context-optimization/z_archive/wave-2-merges/013-002-sandbox-testing-playbook"
...
- `description.json` — parentChain ["system-spec-kit", "002-graph-and-context-optimization"], specId "013", childTopology

...
### Request Summary
Can a cross-runtime hook or shared module GUARANTEE spec-folder naming-convention quality at creation time, preventing mis-located or badly-named folders across all four runtimes? The operator just hit this defect: `.opencode/specs/system-spec-kit/028-026-program-research` was created at the track root when its slug embeds another packet's number (`026`), signalling it should have been a phase child of `002-graph-and-context-optimization`.

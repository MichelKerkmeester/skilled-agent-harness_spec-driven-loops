---
title: "...kit/026-graph-and-context-optimization/007-hook-parity/005-fix-opencode-plugin-loader-bridge/decision-record]"
...
- Sibling phases: `../002-copilot-custom-instructions-hook-parity/`, `../003-codex-native-startup-advisor-hooks/` (different runtime, different gap).
...
| Strict spec validation | PASS — `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-hook-parity/005-fix-opencode-plugin-loader-bridge --strict` passed with 0 errors / 0 warnings. |

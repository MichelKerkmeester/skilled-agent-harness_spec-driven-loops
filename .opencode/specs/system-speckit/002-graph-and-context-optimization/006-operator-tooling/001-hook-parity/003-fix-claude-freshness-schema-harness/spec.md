---
title: "Fe [system-spec-kit/026-graph-and-context-optimization/007-hook-parity/004-fix-claude-freshness-schema-harness/spec]"
...
| **Parent Spec** | `../spec.md` |
| **Predecessor** | `../003-codex-native-startup-advisor-hooks/spec.md` |
| **Successor** | `../005-fix-opencode-plugin-loader-bridge/spec.md` |
<!-- /ANCHOR:metadata -->

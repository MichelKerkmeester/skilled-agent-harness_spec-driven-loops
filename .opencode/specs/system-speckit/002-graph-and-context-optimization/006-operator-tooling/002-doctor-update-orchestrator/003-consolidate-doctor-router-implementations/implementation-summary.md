...
_memory:
  continuity:
    packet_pointer: "system-speckit/002-graph-and-context-optimization/006-operator-tooling/002-doctor-update-orchestrator/003-consolidate-doctor-router-implementations"
...
Run strict validation for `003-skill-advisor-routing-engine-consolidation`, patch any remaining template-schema findings, then update checklist evidence once validation exits 0.
<!-- /ANCHOR:next-session -->

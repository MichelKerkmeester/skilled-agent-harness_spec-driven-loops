...
Fix all 6 P1 findings from the 002-graph-and-context-optimization deep review (canonical source: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/review/review-report.md`). Findings cluster on 4 packets: **009, 011, 012, 013**. Five other packets (005, 006, 007, 008, 010) are clean and must NOT regress.

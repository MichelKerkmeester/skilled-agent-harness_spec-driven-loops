...
Do NOT touch per-phase review-report.md files. Do NOT touch iteration files. Do NOT touch deep-review-*.json or *.jsonl. Do NOT touch any spec/code files under `002-graph-and-context-optimization/` other than the consolidated report.

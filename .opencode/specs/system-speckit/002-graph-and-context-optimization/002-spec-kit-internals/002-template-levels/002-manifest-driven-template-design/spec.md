...
- The PARTIAL plan from `008-template-levels/001-template-level-consolidation-research/research/research.md` — that framing is REJECTED
...
- **Parent Spec**: `../spec.md` (002-graph-and-context-optimization theme)

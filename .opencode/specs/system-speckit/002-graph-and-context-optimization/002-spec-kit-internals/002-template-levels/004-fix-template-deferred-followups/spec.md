...
_memory:
  continuity:
    packet_pointer: "system-speckit/002-graph-and-context-optimization/002-spec-kit-internals/002-template-levels/004-fix-template-deferred-followups"
...
### In Scope
- DEFER-G7-01 through DEFER-G7-10 from `003-manifest-template-implementation-plan/checklist.md`.

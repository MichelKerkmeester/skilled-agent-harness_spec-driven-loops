...
_memory:
  continuity:
    packet_pointer: "system-speckit/002-graph-and-context-optimization/002-spec-kit-internals/002-template-levels"
...
| **Created** | 2026-05-01 |
| **Branch** | `main` |
| **Parent Spec** | `../spec.md` (002-graph-and-context-optimization) |

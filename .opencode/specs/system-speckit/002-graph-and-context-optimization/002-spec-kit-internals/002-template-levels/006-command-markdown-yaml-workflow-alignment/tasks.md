...
_memory:
  continuity:
    packet_pointer: "system-speckit/002-graph-and-context-optimization/002-spec-kit-internals/002-template-levels/006-command-markdown-yaml-workflow-alignment"
...
- [x] T101 Create Level 3 packet folder (`.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/006-command-markdown-yaml-workflow-alignment`)
...
- [x] T109 Audit command doc (`.opencode/commands/deep/start-research-loop.md`)
- [x] T110 Audit command doc (`.opencode/commands/deep/start-review-loop.md`)
...
- [x] T115 Audit YAML asset (`.opencode/commands/deep/assets/deep_start-research-loop_auto.yaml`)
- [x] T116 Audit YAML asset (`.opencode/commands/deep/assets/deep_start-review-loop_auto.yaml`)
...
- [x] T121 Audit YAML asset (`.opencode/commands/deep/assets/deep_start-research-loop_confirm.yaml`)
- [x] T122 Audit YAML asset (`.opencode/commands/deep/assets/deep_start-review-loop_confirm.yaml`)

...
|---:|---:|---|---|---|---|---:|---|
| 1 | 4460 | `027 phase 004` | `003-xce-research-based-refinement/013-cocoindex-complete-fork/004-docs/checklist.md` | present, embedded | medium | 2 | Specific packet/phase shorthand; enough metadata overlap for a trigger-aware system. |

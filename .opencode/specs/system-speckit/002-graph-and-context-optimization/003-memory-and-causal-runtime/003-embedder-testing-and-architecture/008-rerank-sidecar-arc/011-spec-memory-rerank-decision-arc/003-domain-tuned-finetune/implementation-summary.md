...
| `003-xce-research-based-refinement/003-memoization-dependency-dag-foundation/spec.md` | `---`<br>`title: "Memoization dependency DAG foundation"`<br>`description: "Introduce canonical-input memoization...` | `# Memoization dependency DAG foundation`<br>`---`<br>`\| Field \| Value \|` |

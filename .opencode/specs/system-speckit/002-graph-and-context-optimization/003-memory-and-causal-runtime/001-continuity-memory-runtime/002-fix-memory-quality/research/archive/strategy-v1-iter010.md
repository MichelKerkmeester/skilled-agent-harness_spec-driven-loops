...
_memory:
  continuity:
    ...
    key_files: ["research/archive/strategy-v1-iter010.md"]
...
**Observed defects (across 7 memory files in `002-graph-and-context-optimization/001-research-graph-context-systems/{001..005}/memory/`):**

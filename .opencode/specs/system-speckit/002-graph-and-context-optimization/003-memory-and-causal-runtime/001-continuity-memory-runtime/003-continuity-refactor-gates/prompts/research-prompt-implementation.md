...
>
> **Spec folder** (pre-approved, skip Gate 3): `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/003-continuity-refactor-gates/`
...
All written inside the phase 018 spec folder (`.opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/003-continuity-refactor-gates/`). Nothing outside that folder.
...
- **No file writes outside the phase 018 spec folder.** Every artifact lives in `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/003-continuity-refactor-gates/`.
...
| **Parent packet** | `002-graph-and-context-optimization` |
| **Max iterations** | 20 |

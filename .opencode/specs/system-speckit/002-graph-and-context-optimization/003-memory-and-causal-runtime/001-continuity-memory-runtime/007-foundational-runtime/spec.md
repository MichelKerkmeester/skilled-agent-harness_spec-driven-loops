...
_memory:
  continuity:
    packet_pointer: "system-speckit/002-graph-and-context-optimization/003-memory-and-causal-runtime/001-continuity-memory-runtime/007-foundational-runtime"
...
- **FC-2**: All 16 sibling folders under `002-graph-and-context-optimization/` have `description.json.lastUpdated ≥ graph-metadata.json.derived.last_save_at - 10m`.

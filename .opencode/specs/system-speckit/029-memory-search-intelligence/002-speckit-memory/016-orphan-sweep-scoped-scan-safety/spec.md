...
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../015-procedural-reliability-benchmark/spec.md |
| **Successor** | ../017-enrichment-observability/spec.md |
<!-- /ANCHOR:metadata -->
...
`029-memory-search-intelligence`, all already shipped and passing `validate.sh --strict`. Both findings sit
...
`027-graph-and-context-optimization/007-mcp-daemon-reliability/{032,033,034}`). The other 14 findings from

...
_memory:
  continuity:
    packet_pointer: "system-speckit/029-memory-search-intelligence/002-speckit-memory/028-query-time-filter-benchmark"
    ...
    key_files:
      ...
      - ".opencode/specs/system-speckit/029-memory-search-intelligence/005-dark-flag-graduation/002-retrieval-class-weights/scripts/retrieval-class-routing-benchmark.mjs"
    session_dedup:

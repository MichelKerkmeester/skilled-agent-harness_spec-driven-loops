---
title: "Feature Specification: Red-Team Probe Gate [system-speckit/029-memory-search-intelligence/001-speckit-memory/006-redteam-probe-gate/spec]"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/029-memory-search-intelligence/002-speckit-memory/006-redteam-probe-gate"
...
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../005-recall-render-escaper/spec.md |
| **Successor** | ../007-bitemporal-window/spec.md |
<!-- /ANCHOR:metadata -->
...
- Answered 2026-06-19: `run-tests.mjs` gains a dedicated `--security` / `security` / `redteam-probe-gate` selector. The `npm test -- --security` invocation runs only this lane.

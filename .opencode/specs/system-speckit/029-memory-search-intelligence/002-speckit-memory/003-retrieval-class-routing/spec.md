...
_memory:
  continuity:
    packet_pointer: "system-speckit/029-memory-search-intelligence/002-speckit-memory/003-retrieval-class-routing"
...
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../002-determinism-content-id-foundation/spec.md |
| **Successor** | ../004-graceful-degradation/spec.md |
<!-- /ANCHOR:metadata -->

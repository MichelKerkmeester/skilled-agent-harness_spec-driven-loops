...
_memory:
  continuity:
    packet_pointer: "system-speckit/029-memory-search-intelligence/006-speckit-surface-alignment/002-fix-stress-docs"
...
| `.opencode/specs/system-speckit/029-memory-search-intelligence/005-speckit-surface-alignment/002-fix-stress-docs/` | Create | Level 1 implementation packet. |
<!-- /ANCHOR:scope -->

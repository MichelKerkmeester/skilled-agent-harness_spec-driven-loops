...
- Treating generic ablation display as sufficient for packet 028 was ruled out because packet 028 requires corrected-driver distinctions that the display template cannot show. [SOURCE: .opencode/specs/system-speckit/029-memory-search-intelligence/benchmark-status.md:51]
...
- `.opencode/specs/system-speckit/029-memory-search-intelligence/001-speckit-memory/027-envelope-fidelity-enforcement/implementation-summary.md:57`

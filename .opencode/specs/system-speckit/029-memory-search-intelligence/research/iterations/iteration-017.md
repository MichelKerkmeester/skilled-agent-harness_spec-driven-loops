...
- Missing dependencies: Code graph remained stale/untrusted; direct file reads, greps, and a bounded validation command were used. [SOURCE: .opencode/specs/system-speckit/029-memory-search-intelligence/research/deep-research-strategy.md:122]

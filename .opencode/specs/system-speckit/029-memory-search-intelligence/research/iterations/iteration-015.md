...
- Missing dependencies: Code graph remained stale/untrusted, so direct `Read`/`Grep` evidence was used. [SOURCE: .opencode/specs/system-speckit/029-memory-search-intelligence/research/deep-research-strategy.md:122]

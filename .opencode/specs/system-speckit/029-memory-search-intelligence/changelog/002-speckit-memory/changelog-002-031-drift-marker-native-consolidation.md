...
> Spec folder: `.opencode/specs/system-speckit/029-memory-search-intelligence/002-speckit-memory/031-drift-marker-native-consolidation` (Level recorded in phase evidence)

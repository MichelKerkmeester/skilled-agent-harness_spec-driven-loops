...
> Spec folder: `.opencode/specs/system-speckit/029-memory-search-intelligence/002-speckit-memory/025-git-hooks-reinstall-and-guard` (Level recorded in phase evidence)

---
title: "Verification Checklist: AGENTS And Runtime Routing Cleanup"
description: "PENDING verification checklist for root agents and runtime-routing mirror sweep."
trigger_phrases:
  - "028 release cleanup agents md checklist"
  - "agents-md cleanup checklist"
importance_tier: "important"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "system-speckit/029-memory-search-intelligence/001-release-cleanup/008-agents-md"
    ...
    session_dedup:
      ...
      session_id: "2026-06-19-checklist-008-agents-md"
...
# Verification Checklist: AGENTS And Runtime Routing Cleanup
...
- [x] CHK-001 [P0] Scope is limited to root agents and runtime-routing mirror sweep.
...
- [x] CHK-020 [P0] Stale-reference scan is run with `contradiction|stale gate|removed skill|renamed command|missing route|obsolete`.

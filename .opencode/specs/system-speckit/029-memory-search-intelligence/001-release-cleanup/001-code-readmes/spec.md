...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-speckit/029-memory-search-intelligence/000-release-cleanup/001-code-readmes --strict` exits 0 after cleanup.
<!-- /ANCHOR:success-criteria -->

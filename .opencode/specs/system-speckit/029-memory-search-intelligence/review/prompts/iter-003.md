...
Review Scope Files: .opencode/specs/system-speckit/029-memory-search-intelligence/009-validation-integrity-hardening/*.md, .opencode/specs/system-speckit/029-memory-search-intelligence/010-query-channel-calibration/*.md, .opencode/specs/system-speckit/029-memory-search-intelligence/011-automatic-drift-self-healing/*.md, .opencode/specs/system-speckit/029-memory-search-intelligence/012-orphan-sweep-scoped-scan-safety/*.md — slice 3 RETRY: Phase R evidence lines vs actual code/tests, status coherence. A prior attempt confirmed but lost: contradictory benchmark-completion records in 011; 012 evidence claiming delete-chunk coverage the cited sweep path/test does not perform — re-derive with evidence.
...
- Write iteration narrative to: .opencode/specs/system-speckit/029-memory-search-intelligence/review/iterations/iteration-003.md
- Write per-iteration delta file to: .opencode/specs/system-speckit/029-memory-search-intelligence/review/deltas/iter-003.jsonl
...
- **ALLOWED WRITE PATHS (the ONLY paths you may create, modify, or append to)**:
  - `.opencode/specs/system-speckit/029-memory-search-intelligence/review/iterations/iteration-003.md`, this iteration's narrative markdown
  - `.opencode/specs/system-speckit/029-memory-search-intelligence/review/deep-review-state.jsonl`, append-only JSONL state log
  - `.opencode/specs/system-speckit/029-memory-search-intelligence/review/deltas/iter-003.jsonl`, this iteration's delta JSONL
...
1. **Iteration narrative markdown** at `.opencode/specs/system-speckit/029-memory-search-intelligence/review/iterations/iteration-003.md` (path pre-substituted for the current iteration number). Structure: headings for Dimension, Files Reviewed, Findings by Severity (P0/P1/P2), Traceability Checks, Verdict, Next Dimension.

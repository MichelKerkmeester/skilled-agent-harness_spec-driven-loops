...
Final iteration 10 of 10. Re-verify all open findings, sweep declared coverage gaps, deliver the final verdict. This is the last iteration — completeness beats novelty.
...
Review Scope Files: FINAL SWEEP: re-verify EVERY open finding in the registry against the current tree (confirm still-open or mark resolved with evidence); close coverage gaps from iterations 1-9 (check the strategy iteration log for declared gaps); final verdict per the VERDICTS contract
...
- Write iteration narrative to: .opencode/specs/system-speckit/029-memory-search-intelligence/review/iterations/iteration-010.md
- Write per-iteration delta file to: .opencode/specs/system-speckit/029-memory-search-intelligence/review/deltas/iter-010.jsonl
...
- **ALLOWED WRITE PATHS (the ONLY paths you may create, modify, or append to)**:
  - `.opencode/specs/system-speckit/029-memory-search-intelligence/review/iterations/iteration-010.md`, this iteration's narrative markdown
  - `.opencode/specs/system-speckit/029-memory-search-intelligence/review/deep-review-state.jsonl`, append-only JSONL state log
  - `.opencode/specs/system-speckit/029-memory-search-intelligence/review/deltas/iter-010.jsonl`, this iteration's delta JSONL
...
1. **Iteration narrative markdown** at `.opencode/specs/system-speckit/029-memory-search-intelligence/review/iterations/iteration-010.md` (path pre-substituted for the current iteration number). Structure: headings for Dimension, Files Reviewed, Findings by Severity (P0/P1/P2), Traceability Checks, Verdict, Next Dimension.
...
run: run-010 | sessionId: deep-review-20260710T153457Z | generation: 1 | lineageMode: new

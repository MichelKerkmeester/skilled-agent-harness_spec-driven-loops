...
- `.opencode/specs/system-speckit/029-memory-search-intelligence/009-validation-integrity-hardening/implementation-summary.md:37-87`
- `.opencode/specs/system-speckit/029-memory-search-intelligence/010-query-channel-calibration/implementation-summary.md:37-118`
- `.opencode/specs/system-speckit/029-memory-search-intelligence/011-automatic-drift-self-healing/spec.md:17-21,68-78`
- `.opencode/specs/system-speckit/029-memory-search-intelligence/011-automatic-drift-self-healing/tasks.md:77,111`
- `.opencode/specs/system-speckit/029-memory-search-intelligence/011-automatic-drift-self-healing/checklist.md:140,175-183`
- `.opencode/specs/system-speckit/029-memory-search-intelligence/011-automatic-drift-self-healing/implementation-summary.md:3,18-21,53-58,151-164`
- `.opencode/specs/system-speckit/029-memory-search-intelligence/012-orphan-sweep-scoped-scan-safety/spec.md:236-259`
- `.opencode/specs/system-speckit/029-memory-search-intelligence/012-orphan-sweep-scoped-scan-safety/checklist.md:133-142`
- `.opencode/specs/system-speckit/029-memory-search-intelligence/012-orphan-sweep-scoped-scan-safety/implementation-summary.md:58-77,127-131,139-148`

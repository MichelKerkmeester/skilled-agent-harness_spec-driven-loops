...
_memory:
  continuity:
    packet_pointer: "system-speckit/029-memory-search-intelligence/003-spec-data-quality/003-retrieval-gated-tuning"
...
|-------|-------|
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../002-retroactive-automation/spec.md |
| **Successor** | ../004-novel-research/spec.md |

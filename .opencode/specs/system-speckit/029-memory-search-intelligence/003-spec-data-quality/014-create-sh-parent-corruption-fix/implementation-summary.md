...
| `.opencode/specs/system-speckit/029-memory-search-intelligence/001-speckit-memory/description.json` | Repaired | Corrected `specFolder`/`specId`/`parentChain` to match sibling phase-parent packets. |
<!-- /ANCHOR:what-built -->

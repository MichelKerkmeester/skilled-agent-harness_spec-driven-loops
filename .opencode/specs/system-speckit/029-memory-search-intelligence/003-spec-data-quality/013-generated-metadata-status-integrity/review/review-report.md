...
```json Planning Packet
{
  ...
  "remediationWorkstreams": [
    ...
    "T1: scoped dry-run repair of already-corrupted phase-parent metadata (system-speckit/029-memory-search-intelligence/001-speckit-memory)",
...
| T1-P1-002 | P1 | Existing phase-parent metadata already carries the same corruption signature (`001-speckit-memory`, both metadata roots) | correctness | `.opencode/specs/system-speckit/029-memory-search-intelligence/001-speckit-memory/description.json:3,20` (+ mirrored `specs/...` root) | active |
...
2. T1-P1-002/003 — scoped, dry-run-first repair of `system-speckit/029-memory-search-intelligence/001-speckit-memory`'s `description.json` in both metadata roots, gated behind the writer fix landing first.
...
STATUS=OK PATH=.opencode/specs/system-speckit/029-memory-search-intelligence/002-spec-data-quality/047-generated-metadata-status-integrity

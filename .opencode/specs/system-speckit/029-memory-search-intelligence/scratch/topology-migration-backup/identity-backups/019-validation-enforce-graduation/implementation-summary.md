...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/system-speckit/029-memory-search-intelligence/019-validation-enforce-graduation/scripts/census-validation-rule.sh"
      - ".opencode/specs/system-speckit/029-memory-search-intelligence/019-validation-enforce-graduation/scripts/regen-worker.sh"
      - ".opencode/specs/system-speckit/029-memory-search-intelligence/019-validation-enforce-graduation/scripts/fix-packet-pointer.mjs"
    session_dedup:
...
```bash
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-speckit/029-memory-search-intelligence/019-validation-enforce-graduation --strict
```

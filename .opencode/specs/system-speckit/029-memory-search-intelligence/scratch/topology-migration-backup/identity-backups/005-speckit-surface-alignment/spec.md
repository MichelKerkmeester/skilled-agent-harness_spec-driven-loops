...
_memory:
  continuity:
    packet_pointer: "system-speckit/029-memory-search-intelligence/005-speckit-surface-alignment"
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-speckit/029-memory-search-intelligence/005-speckit-surface-alignment/spec.md"
      - ".opencode/specs/system-speckit/029-memory-search-intelligence/changelog/changelog-028-root.md"
    session_dedup:
...
- **Status:** Planned
- **Level:** Phase Parent
- **Parent:** `029-memory-search-intelligence`

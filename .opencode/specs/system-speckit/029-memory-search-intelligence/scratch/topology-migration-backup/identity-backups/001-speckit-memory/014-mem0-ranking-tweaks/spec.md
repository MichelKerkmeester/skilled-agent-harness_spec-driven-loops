...
_memory:
  continuity:
    packet_pointer: "system-speckit/029-memory-search-intelligence/001-speckit-memory/014-mem0-ranking-tweaks"
...
| **Parent Packet** | `system-speckit/029-memory-search-intelligence/001-speckit-memory` (Memory MCP research phase, PRIMARY) |

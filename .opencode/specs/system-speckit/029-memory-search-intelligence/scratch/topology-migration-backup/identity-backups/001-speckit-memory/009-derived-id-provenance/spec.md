...
_memory:
  continuity:
    packet_pointer: "system-speckit/029-memory-search-intelligence/001-speckit-memory/009-derived-id-provenance"
    ...
    key_files:
      ...
      - "checklist.md"
      - "decision-record.md"
      - ".opencode/specs/system-speckit/029-memory-search-intelligence/001-speckit-memory/research/research.md"
      - ".opencode/specs/system-speckit/029-memory-search-intelligence/research/synthesis/01-go-candidates.md"
    session_dedup:
...
| **Parent phase** | `system-speckit/029-memory-search-intelligence/001-speckit-memory` (Memory MCP, PRIMARY) |
<!-- /ANCHOR:metadata -->

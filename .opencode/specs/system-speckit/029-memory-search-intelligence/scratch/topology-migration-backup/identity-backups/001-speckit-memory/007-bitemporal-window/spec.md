...
_memory:
  continuity:
    packet_pointer: "system-speckit/029-memory-search-intelligence/001-speckit-memory/007-bitemporal-window"
...
| **Parent Phase** | `system-speckit/029-memory-search-intelligence/001-speckit-memory` (research) |

...
_memory:
  continuity:
    packet_pointer: "system-speckit/029-memory-search-intelligence/002-spec-data-quality/048-create-sh-parent-corruption-fix"
    ...
    key_files:
      ...
      - ".opencode/specs/system-speckit/029-memory-search-intelligence/001-speckit-memory/description.json"
    session_dedup:
...
| **Parent Spec** | ../spec.md |
| **Phase** | 11 of 12 |
| **Predecessor** | 047-generated-metadata-status-integrity |
| **Successor** | 049-derive-status-explicit-bypass-fix |
...
- A dry-run-first repair of `system-speckit/029-memory-search-intelligence/001-speckit-memory/description.json` in both the `.opencode/specs/` and legacy `specs/` metadata roots
...
| `.opencode/specs/system-speckit/029-memory-search-intelligence/001-speckit-memory/description.json` | Repair | Regenerate `specFolder`/`parentChain` from the packet's own `spec.md` |
| `specs/system-speckit/029-memory-search-intelligence/001-speckit-memory/description.json` (legacy root, if present) | Repair | Same repair, mirrored root |
<!-- /ANCHOR:scope -->
...
| ID | Requirement | Acceptance Criteria |
|----|-------------|---------------------|
| REQ-003 | The confirmed corrupted packet is repaired | `system-speckit/029-memory-search-intelligence/001-speckit-memory/description.json` (both metadata roots) has `specFolder: "system-speckit/029-memory-search-intelligence/001-speckit-memory"` and a non-empty `parentChain` after repair |
...
- **SC-002**: `system-speckit/029-memory-search-intelligence/001-speckit-memory`'s `description.json` is repaired in both metadata roots and matches its `spec.md`'s real identity
...
- **Finding source**: `.opencode/specs/system-speckit/029-memory-search-intelligence/002-spec-data-quality/047-generated-metadata-status-integrity/review/review-report.md` (T1-P1-001, T1-P1-002, T1-P1-003)
<!-- /ANCHOR:cross-refs -->

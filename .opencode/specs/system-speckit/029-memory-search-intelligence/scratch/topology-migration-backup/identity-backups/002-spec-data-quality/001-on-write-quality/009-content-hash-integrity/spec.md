...
_memory:
  continuity:
    packet_pointer: "system-speckit/029-memory-search-intelligence/002-spec-data-quality/001-on-write-quality/009-content-hash-integrity"
    ...
    session_dedup:
      ...
      session_id: "phase-spec-009-content-hash-integrity"
...
| **Status** | Draft |
| **Created** | 2026-06-21 |
| **Branch** | `009-content-hash-integrity` |
<!-- /ANCHOR:metadata -->
...
| Dependency | This is a governance check with zero ranking effect, so it does NOT depend on `015-prodmode-recall-gate` or any 027 retrieval item | No prod-mode recall gate is required to ship it | Ship on cost and structural soundness, the floor never touches it |
<!-- /ANCHOR:risks -->

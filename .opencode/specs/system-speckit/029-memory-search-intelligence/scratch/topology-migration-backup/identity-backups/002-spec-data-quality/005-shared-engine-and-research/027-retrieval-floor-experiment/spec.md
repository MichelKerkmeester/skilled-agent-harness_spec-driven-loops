...
| `.opencode/specs/system-speckit/029-memory-search-intelligence/002-spec-data-quality/005-shared-engine-and-research/027-retrieval-floor-experiment/floor-experiment-report.md` | Create | The measured per-setting recall deltas and the one signal-or-noise verdict |
<!-- /ANCHOR:scope -->

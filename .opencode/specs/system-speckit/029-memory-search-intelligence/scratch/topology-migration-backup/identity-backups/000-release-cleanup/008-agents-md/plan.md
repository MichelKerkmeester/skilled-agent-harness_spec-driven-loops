---
title: "Implementation Plan: AGENTS And Runtime Routing Cleanup"
description: "Defines the pending cleanup approach for root agents and runtime-routing mirror sweep."
trigger_phrases:
  - "028 release cleanup agents md plan"
  - "agents-md cleanup plan"
importance_tier: "important"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "system-speckit/029-memory-search-intelligence/000-release-cleanup/008-agents-md"
    ...
    session_dedup:
      ...
      session_id: "2026-06-19-plan-008-agents-md"
...
# Implementation Plan: AGENTS And Runtime Routing Cleanup
...
|---------|--------------|--------|--------------|
| Root AGENTS and runtime-routing mirror sweep | Release documentation surface | Review later | Discovery output and grep evidence |
...
|-------|------------|--------|
| 008 | `../spec.md` | Parent phase map owns release-cleanup ordering |
<!-- /ANCHOR:phase-deps -->

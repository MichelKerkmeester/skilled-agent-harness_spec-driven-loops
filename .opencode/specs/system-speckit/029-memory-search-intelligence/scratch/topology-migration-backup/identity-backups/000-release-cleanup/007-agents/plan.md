---
title: "Implementation Plan: Agent Definition Cleanup"
description: "Defines the pending cleanup approach for agent definition and runtime mirror sweep."
trigger_phrases:
  - "028 release cleanup agents plan"
  - "agents cleanup plan"
importance_tier: "important"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "system-speckit/029-memory-search-intelligence/000-release-cleanup/007-agents"
    last_updated_at: "2026-07-04T17:31:29.256Z"
    last_updated_by: "claude-opus-4-8"
    recent_action: "Executed cleanup plan for agent definitions"
    ...
    session_dedup:
      ...
      session_id: "2026-06-19-plan-007-agents"
...
# Implementation Plan: Agent Definition Cleanup
...
|---------|--------------|--------|--------------|
| Agent definition and runtime mirror sweep | Release documentation surface | Review later | Discovery output and grep evidence |
...
### Phase 1: Setup
- [ ] Run discovery: `rg --files .opencode/agents .claude/agents .codex/agents 2>/dev/null | sort`
...
- [ ] Run stale-reference scan: `rg -n 'deprecated tool|removed skill|stale route|orphan|missing mirror|renamed agent' <discovered-docs>`
...
|-------|------------|--------|
| 007 | `../spec.md` | Parent phase map owns release-cleanup ordering |
<!-- /ANCHOR:phase-deps -->

---
title: "Tasks: Skill And Repo README Cleanup"
description: "PENDING task list for skill-level and top-level readme sweep."
trigger_phrases:
  - "028 release cleanup skill readmes tasks"
  - "skill-and-repo-readmes cleanup tasks"
...
_memory:
  continuity:
    ...
    session_dedup:
      ...
      session_id: "2026-06-19-tasks-002-skill-and-repo-readmes"
...
# Tasks: Skill And Repo README Cleanup
...
- [x] T001 Run discovery for skill-level and top-level readme sweep.

...
- Packet root: `.opencode/specs/system-speckit/029-memory-search-intelligence`.
...
All paths below are relative to `.opencode/specs/system-speckit/029-memory-search-intelligence/`.

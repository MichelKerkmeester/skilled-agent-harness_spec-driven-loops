---
title: "Feature Specification: Doctor Update Orchestrator [system-spec-kit/026-graph-and-context-optimization/010-doctor-update-orchestrator/spec]"
...
trigger_phrases:
  ...
  - "004-cutover-doctor-router-from-legacy-files"
importance_tier: "important"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/006-operator-tooling/002-doctor-update-orchestrator"
    ...
    key_files:
      ...
      - "004-cutover-doctor-router-from-legacy-files/spec.md"
    session_dedup:
...
| **Predecessor** | ../009-causal-graph-channel-routing/spec.md |
...
### In Scope
- Maintain `010-doctor-update-orchestrator/` as the active thematic parent for the doctor command surface plus its testing harness.
...
| REQ-P-002 | `graph-metadata.json` `derived.last_active_child_id` matches the most recently saved child packet. | Field is one of the five child folders and currently points to `004-cutover-doctor-router-from-legacy-files`. |

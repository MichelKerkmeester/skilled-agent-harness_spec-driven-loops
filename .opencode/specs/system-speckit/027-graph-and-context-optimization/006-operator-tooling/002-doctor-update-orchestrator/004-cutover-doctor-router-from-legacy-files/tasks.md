---
title: "Tasks: Doctor Cutover Phase 2 [system-spec-kit/026-graph-and-context-optimization/010-doctor-update-orchestrator/004-cutover-doctor-router-from-legacy-files/tasks]"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/006-operator-tooling/002-doctor-update-orchestrator/004-cutover-doctor-router-from-legacy-files"
...
- [ ] **Effort:** 10-15 min
- [ ] Validate 013 parent, 003-skill-advisor-routing-engine-consolidation, and 004-cutover-doctor-router-from-legacy-files.

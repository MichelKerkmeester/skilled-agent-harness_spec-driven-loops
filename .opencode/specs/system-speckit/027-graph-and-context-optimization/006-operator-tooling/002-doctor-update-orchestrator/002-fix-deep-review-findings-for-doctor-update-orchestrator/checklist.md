...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/006-operator-tooling/002-doctor-update-orchestrator/002-fix-deep-review-findings-for-doctor-update-orchestrator"
...
- [ ] 013 phase parent metadata: `derived.status == in_progress` (or `done`) and `derived.last_active_child_id == 002-fix-deep-review-findings-for-doctor-update-orchestrator`

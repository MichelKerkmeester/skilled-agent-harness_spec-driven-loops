---
title: "...26-graph-and-context-optimization/007-hook-parity/006-claude-hook-findings-remediation/implementation-summary]"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/006-operator-tooling/001-hook-parity/003-fix-claude-freshness-schema-harness"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 003-fix-claude-freshness-schema-harness |
...
| Strict spec validation | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-hook-parity/004-fix-claude-freshness-schema-harness --strict --no-recursive` | To run after checklist/task updates and cleanup |
<!-- /ANCHOR:verification -->

...
| Track A live packet rescan | `memory_index_scan` on `026/007-hook-parity` after MCP restart | **PENDING** — requires live-capable runtime; until this rerun is recorded, Track A packet readiness and scan counts are not authoritative |

...
```json
{
  ...
  "results": [
    ...
    {"protocolId": "spec_code_017_stub_uniqueness", "status": "fail", "gateClass": "advisory", "applicable": true, "counts": {"pass": 0, "partial": 0, "fail": 1}, "evidence": ["027-graph-and-context-optimization/008,010,007,009,015,014/description.json sizes"], "findingRefs": ["R9-P2-001"], "summary": "017 stub is one of 6+ sub-threshold description.json files."},

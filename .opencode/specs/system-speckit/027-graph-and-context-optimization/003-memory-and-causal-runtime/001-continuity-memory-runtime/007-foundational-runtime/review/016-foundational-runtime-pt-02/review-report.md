...
| T-DESC-01 | P2 | M | `027-graph-and-context-optimization/{007,008,009,010,014,015,017}/description.json` | Run bulk `generate-description.js` sweep to restore full-fidelity description text + trigger_phrases + keywords. R9-P2-001 + C3-iter5 resolve. |

...
_memory:
  continuity:
    ...
    key_files: ["research/archive/spec-pre-phase-decomposition.md"]
...
| **Created** | 2026-04-06 |
| **Branch** | `027-graph-and-context-optimization/003-memory-quality-issues` |
...
Seven memory files saved across `027-graph-and-context-optimization/001-research-graph-context-systems/{001..005}/memory/` exhibited eight distinct defect classes when generated through JSON mode of `generate-context.js`:

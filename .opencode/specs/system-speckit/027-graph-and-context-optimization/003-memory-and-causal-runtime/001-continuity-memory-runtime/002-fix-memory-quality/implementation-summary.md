...
- Verification: `scripts` build + full test suite PASS; 5 new vitest files; `validate.sh --strict` PASS; real dist-based save to `027-graph-and-context-optimization` PASS (indexed as memory #2126, 0 issues).

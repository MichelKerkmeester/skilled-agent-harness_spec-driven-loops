...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/003-memory-and-causal-runtime/003-embedder-testing-and-architecture/005-cross-cutting-quality/006-benchmark-format-to-sk-doc"
...
| 4 historical spec.md files in `013-embedder-testing-and-architecture` | Modify | Canonical-mechanics pointer updated to benchmark_creation.md |
...
| REQ-007 | Update 4 historical spec.md files in `013-embedder-testing-and-architecture` | `rg "references/benchmarks/FORMAT\.md" .opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/` returns 0 matches |
...
- **SC-006**: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/005-cross-cutting-quality/006-benchmark-format-to-sk-doc --strict` exits 0.

...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/003-memory-and-causal-runtime/003-embedder-testing-and-architecture/006-mcp-launcher-concurrency/003-launcher-race-and-error-surface-hardening"
...
**Changelog**: `013-embedder-testing-and-architecture/006-mcp-launcher-concurrency/changelog/003-launcher-race-and-error-surface-hardening.md`.
<!-- /ANCHOR:phase-context -->
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/006-mcp-launcher-concurrency/changelog/003-launcher-race-and-error-surface-hardening.md` | Create | Changelog entry. |
<!-- /ANCHOR:scope -->

...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/003-memory-and-causal-runtime/003-embedder-testing-and-architecture/001-local-embeddings-foundation/022-local-llm-legacy-remediation"
...
| **Created** | 2026-05-13 |
| **Branch** | `main` |
| **Parent packet** | `027-graph-and-context-optimization/014-local-embeddings-setup-a` |

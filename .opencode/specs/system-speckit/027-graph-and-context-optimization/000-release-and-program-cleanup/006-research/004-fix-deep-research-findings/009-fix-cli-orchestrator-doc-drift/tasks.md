...
- [x] T001 [P1] Re-read packet 046 §6 (CLI orchestrator skills) to confirm finding IDs and cited line ranges (`.opencode/specs/.../003-system-bug-improvement-research/research/research.md`)
...
- Source of truth: `../003-system-bug-improvement-research/research/research.md` §6

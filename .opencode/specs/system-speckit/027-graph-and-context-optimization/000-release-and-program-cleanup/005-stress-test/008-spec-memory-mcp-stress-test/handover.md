...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/000-release-and-program-cleanup/005-stress-test/008-spec-memory-mcp-stress-test"
...
gtimeout 600 devin -p \
  ...
  --agent-config /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-stress-test/008-spec-memory-mcp-stress-test/evidence/agent-config-008.json \
...
| Packet 111 (dispatch pattern reference) | `.opencode/specs/skilled-agent-orchestration/111-base-files-renumbering-name-cleanup/` |

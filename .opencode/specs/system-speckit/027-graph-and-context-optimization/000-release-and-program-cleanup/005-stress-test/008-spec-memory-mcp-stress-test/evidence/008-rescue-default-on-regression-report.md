...
- Prior 20-row smoke sample: 20/20 preserved under opt-in rescue layer (`.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-spec-memory-embedder-bake-off/evidence/008-pass-sample-rerun.jsonl`)

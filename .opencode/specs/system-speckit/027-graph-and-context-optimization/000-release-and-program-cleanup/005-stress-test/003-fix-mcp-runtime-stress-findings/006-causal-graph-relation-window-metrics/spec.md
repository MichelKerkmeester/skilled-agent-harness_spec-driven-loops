---
title: "Feature Specification: causal-graph relation-window balance metrics + auto-edge caps [system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/006-causal-graph-relation-window-metrics/spec]"
...
trigger_phrases:
  - "006-causal-graph-relation-window-metrics"
...
<!-- SPECKIT_LEVEL: 1 -->
<!-- PHASE_LINKS_PARENT: ../spec.md; PREDECESSOR: 005-code-graph-fail-fast-routing; SUCCESSOR: 007-intent-classifier-stability-telemetry -->

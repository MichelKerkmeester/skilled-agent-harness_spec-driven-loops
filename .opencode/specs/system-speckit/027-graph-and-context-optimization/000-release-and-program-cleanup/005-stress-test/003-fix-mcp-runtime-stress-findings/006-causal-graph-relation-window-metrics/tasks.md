---
title: "Tasks: causal-graph window metrics + auto-edge caps [system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/006-causal-graph-relation-window-metrics/tasks]"

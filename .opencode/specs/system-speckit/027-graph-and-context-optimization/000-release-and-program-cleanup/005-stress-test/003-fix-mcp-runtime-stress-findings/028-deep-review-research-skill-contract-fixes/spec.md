...
trigger_phrases:
  - "028-deep-review-research-skill-contract-fixes"
...
| **Source** | Direct user observations of (a) `001-post-program-doc-and-state-cleanup/review/001-post-program-doc-and-state-cleanup-pt-01/` shipped without iteration trail in commit `6a8095907` and (b) unnecessary `pt-01` wrapper on first-run reviews |
<!-- /ANCHOR:metadata -->

...
**TARGET AUTHORITY**: All write paths in this prompt are pre-approved under spec folder `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-mcp-runtime-stress-remediation/`. Write iteration-002.md, append to JSONL, write delta — these are the deliverables, not options.
...
The `011-post-stress-finding-remediation-research/` deep-research loop produced a P0 patch proposal: a Gate-3 bypass in the cli-copilot dispatch path lets recovered/bootstrap context override the workflow-approved spec folder, unilaterally enabling write-intent dispatch outside the approved scope.
...
### S3. Memory-search refusal contract (009-memory-search-citation-response-policy)
...
### S4. Truncation contract (003-memory-context-truncation-telemetry-contract)
...
### S5. CocoIndex fork semantics (004-cocoindex-overfetch-dedup-rerank)
...
Write to: `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-mcp-runtime-stress-remediation/review/001-mcp-runtime-stress-remediation-review/iterations/iteration-002.md`

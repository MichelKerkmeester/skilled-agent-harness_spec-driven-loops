...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/000-release-and-program-cleanup/005-stress-test/003-fix-mcp-runtime-stress-findings/029-clean-infrastructure-stress-test"
...
- **Procedure**: Remove or regenerate only files under `029-clean-infrastructure-stress-test/`; do not modify runtime, harness, prior packets, or unrelated workspace changes.
<!-- /ANCHOR:rollback -->

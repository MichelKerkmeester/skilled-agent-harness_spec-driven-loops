...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/000-release-and-program-cleanup/005-stress-test/003-fix-mcp-runtime-stress-findings/017-cli-copilot-dispatch-test-parity"
...
- [x] **T001** Read 011 deep-review report §4 F-004 + §7 Packet B PASS gate.
  - **Files**: `../011-research-post-stress-finding-followups/review/review-report.md` (lines 91-99 + 170-174)
...
- [x] **T206** Author `description.json` and `graph-metadata.json` with `specId="017"`, `folderSlug="cli-copilot-dispatch-test-parity"`, `parentChain` to 011, `depends_on=[011-research-post-stress-finding-followups, 012-copilot-target-authority-gate-helper]`, `related_to=[016-degraded-readiness-envelope-parity]`.
...
- **Source of recommendations**: `../011-research-post-stress-finding-followups/review/review-report.md` §4 F-004 + §7 Packet B

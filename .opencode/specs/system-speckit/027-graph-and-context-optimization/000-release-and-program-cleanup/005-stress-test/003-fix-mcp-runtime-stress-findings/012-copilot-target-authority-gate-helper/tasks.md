...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/000-release-and-program-cleanup/005-stress-test/003-fix-mcp-runtime-stress-findings/012-copilot-target-authority-gate-helper"
...
- [x] **T206** Author `description.json` and `graph-metadata.json` with `specId="012"`, `folderSlug="copilot-target-authority-helper"`, `parentChain` to 011, `depends_on=[011-research-post-stress-finding-followups, 010-stress-test-close-loop-measurement-rerun, 003-continuity-memory-runtime/004-memory-save-rewrite]`, `related_to=[009-memory-search-citation-response-policy]`.
...
- **Source of recommendations**: `../011-research-post-stress-finding-followups/research/research.md` §3
- **Failing cell**: `../010-stress-test-close-loop-measurement-rerun/runs/I1/cli-copilot-1/score.md`

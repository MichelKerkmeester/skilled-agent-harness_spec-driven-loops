...
title: "Implementation Plan: Degraded-readiness envelope parity [system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/016-degraded-readiness-envelope-parity/plan]"
...
|------------|------|--------|-------------------|
| 011-research-post-stress-finding-followups / review-report.md | Internal | Green | Source of truth |

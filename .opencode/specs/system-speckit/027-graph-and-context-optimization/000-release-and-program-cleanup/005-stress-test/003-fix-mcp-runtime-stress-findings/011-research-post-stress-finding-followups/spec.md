...
trigger_phrases:
  - "011-research-post-stress-finding-followups"
...
_memory:
  continuity:
    ...
    key_files:
      ...
      - "checklist.md"
    session_dedup:
      session_id: "011-research-post-stress-finding-followups-scaffold-2026-04-27"
    completion_pct: 5
    open_questions: []
    answered_questions: []
---
...
| **SC-007** | Parent metadata updated: `003-fix-mcp-runtime-stress-findings/{spec.md,description.json,graph-metadata.json,resource-map.md}` all reference the new child. |

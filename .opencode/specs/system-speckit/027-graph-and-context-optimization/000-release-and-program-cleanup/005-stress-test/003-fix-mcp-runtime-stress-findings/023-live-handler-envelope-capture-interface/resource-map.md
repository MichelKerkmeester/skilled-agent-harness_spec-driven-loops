...
trigger_phrases:
  - "023-live-handler-envelope-capture-interface resource map"
...
- **Missing on disk**: 0
- **Scope**: Files created during packet `026/011/023-live-handler-envelope-capture-interface` (commit `af22aa045`) plus runtime files cited as test boundaries.

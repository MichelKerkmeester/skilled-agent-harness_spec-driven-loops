...
6. **description.json** — `specFolder`, `description`, `keywords`, `lastUpdated`, `specId="031"`, `folderSlug="doc-truth-pass"`, `parentChain=["system-spec-kit","027-graph-and-context-optimization"]`, `memorySequence=1`.

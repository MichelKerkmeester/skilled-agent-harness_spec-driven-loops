...
- Source: the 026 changelog tree at `027-graph-and-context-optimization/changelog/` and `.opencode/changelog/system-spec-kit/v3.5.0.0.md` — the shipped behavior the angles were assessed against.
<!-- /ANCHOR:sources -->

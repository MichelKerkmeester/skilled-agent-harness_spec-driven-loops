...
trigger_phrases:
  - "006-fix-stress-test-coverage-gap summary"
  - "P1 P2 remediation summary"
importance_tier: "important"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/000-release-and-program-cleanup/001-release-readiness/005-fix-stress-test-coverage-gap"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 005-fix-stress-test-coverage-gap |

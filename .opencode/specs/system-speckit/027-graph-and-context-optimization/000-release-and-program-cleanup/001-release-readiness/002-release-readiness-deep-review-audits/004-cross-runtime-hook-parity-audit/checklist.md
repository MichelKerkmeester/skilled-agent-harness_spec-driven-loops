...
_memory:
  continuity:
    ...
    key_files:
      ...
      - "review-report.md"
    session_dedup:
      fingerprint: "sha256:045-005-cross-runtime-hook-parity-audit-checklist"
...
- [x] CHK-050 [P1] Packet files created under the user-specified path. [EVIDENCE: all authored files are under `005-cross-runtime-hook-parity-audit`]

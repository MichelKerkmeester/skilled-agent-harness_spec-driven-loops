...
trigger_phrases:
  - "001-fix-memory-indexer-storage-boundary implementation"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/000-release-and-program-cleanup/003-cross-cutting-cleanup-pass/001-fix-memory-indexer-storage-boundary"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 001-fix-memory-indexer-storage-boundary |

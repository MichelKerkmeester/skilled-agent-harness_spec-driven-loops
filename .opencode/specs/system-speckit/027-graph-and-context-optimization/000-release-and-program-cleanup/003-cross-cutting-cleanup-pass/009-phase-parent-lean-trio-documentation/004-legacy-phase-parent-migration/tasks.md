...
- [ ] T003 [P] Author `/tmp/copilot-worker-3.md` (Worker 3: 027-graph-and-context-optimization C-category active (3-4 parents) + ALL z_archive/z_future entries (~7) = ~11 total)
...
- [ ] T013 Run `validate.sh --strict --json` on `027-graph-and-context-optimization/`; diff parent error rules against `scratch/regression-baseline-pre-004.txt` — MUST match

...
- [ ] `validate.sh --strict` regression preserved on `027-graph-and-context-optimization/`
<!-- /ANCHOR:quality-gates -->
...
- [ ] T018 Run `validate.sh --strict` regression on `027-graph-and-context-optimization/` after all changes — must show no new errors vs current baseline
<!-- /ANCHOR:phases -->

...
- **SC-003**: The existing parent at `027-graph-and-context-optimization/` continues to validate under strict mode without regressions, even though it retains its heavy docs (tolerant policy).

...
- [x] T-002 SP-002 Spec folder shell created at 021-sk-doc-conformance-template-sweep/
...
| 005-stress-test-expansion-alignment (prior packet) | Internal (sibling) | Complete | Provides stress-test path-reference patterns |
<!-- /ANCHOR:dependencies -->

...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/000-release-and-program-cleanup/003-cross-cutting-cleanup-pass/008-remove-sk-doc-legacy-template-debt"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 008-remove-sk-doc-legacy-template-debt |
...
- `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/022-stress-test-results-deep-research/`
- `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/023-live-handler-envelope-capture-interface/`
- `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/024-harness-telemetry-export-mode/`
- `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/025-memory-search-degraded-readiness-wiring/`
- `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/026-remove-readiness-scaffolding/`
- `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/027-memory-context-structural-channel-research/`
- `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/028-deep-review-research-skill-contract-fixes/`
...
- `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/006-stale-documentation-readme-fixes/`
- `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/007-vitest-broad-suite-honesty/`
- `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/008-remove-sk-doc-legacy-template-debt/` for audit bulk edits only. Packet docs were updated as required by this packet.
...
| `validate.sh specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/022-stress-test-results-deep-research --strict` | PASS, exit 0. |
| `validate.sh specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/023-live-handler-envelope-capture-interface --strict` | PASS, exit 0. |
| `validate.sh specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/024-harness-telemetry-export-mode --strict` | PASS, exit 0. |
| `validate.sh specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/025-memory-search-degraded-readiness-wiring --strict` | PASS, exit 0. |
| `validate.sh specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/026-remove-readiness-scaffolding --strict` | PASS, exit 0. |
| `validate.sh specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/027-memory-context-structural-channel-research --strict` | PASS, exit 0. |
| `validate.sh specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/028-deep-review-research-skill-contract-fixes --strict` | PASS, exit 0. |
...
| `validate.sh specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/008-remove-sk-doc-legacy-template-debt --strict` | PASS, exit 0. |
<!-- /ANCHOR:verification -->
...
| G1 | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/001-fix-mcp-stress-cycle-doc-observability/spec.md` | HVR prose rewrite, em dash cleanup. |
| G1 | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/009-phase-parent-lean-trio-documentation/001-phase-parent-validator-docs/checklist.md` | HVR prose rewrite, em dash cleanup. |
| G1 | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/009-phase-parent-lean-trio-documentation/001-phase-parent-validator-docs/implementation-summary.md` | HVR prose rewrite, em dash cleanup. |
| G1 | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/009-phase-parent-lean-trio-documentation/001-phase-parent-validator-docs/plan.md` | HVR prose rewrite, em dash cleanup. |
| G1 | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/009-phase-parent-lean-trio-documentation/001-phase-parent-validator-docs/spec.md` | HVR prose rewrite, em dash cleanup. |
| G1 | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/009-phase-parent-lean-trio-documentation/001-phase-parent-validator-docs/tasks.md` | HVR prose rewrite, em dash cleanup. |
| G1 | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/009-phase-parent-lean-trio-documentation/002-phase-parent-generator-pointer-polish/checklist.md` | HVR prose rewrite, em dash cleanup. |
| G1 | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/009-phase-parent-lean-trio-documentation/002-phase-parent-generator-pointer-polish/implementation-summary.md` | HVR prose rewrite, em dash cleanup. |
| G1 | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/009-phase-parent-lean-trio-documentation/002-phase-parent-generator-pointer-polish/plan.md` | HVR prose rewrite, em dash cleanup. |
...
| G6 | `.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/275-code-graph-readiness-contract.md` | Non-spec manual playbook source-file section backfill. |
| G6 | `.opencode/skills/system-spec-kit/manual_testing_playbook/22--context-preservation-and-code-graph/277-code-graph-fast-fail.md` | Non-spec manual playbook source-file section backfill. |
| G12 | `.opencode/skills/mcp-coco-index/README.md` | Non-spec README structure rewrite. |
| G12 | `.opencode/skills/sk-code-opencode/README.md` | Non-spec README structure rewrite. |

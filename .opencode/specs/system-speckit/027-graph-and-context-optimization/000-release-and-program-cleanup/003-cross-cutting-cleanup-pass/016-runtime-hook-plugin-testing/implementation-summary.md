...
| Field | Value |
|-------|-------|
| **Spec Folder** | 016-runtime-hook-plugin-testing |
...
| `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/.../016-runtime-hook-plugin-testing --strict` | Exit 0 |
<!-- /ANCHOR:verification -->

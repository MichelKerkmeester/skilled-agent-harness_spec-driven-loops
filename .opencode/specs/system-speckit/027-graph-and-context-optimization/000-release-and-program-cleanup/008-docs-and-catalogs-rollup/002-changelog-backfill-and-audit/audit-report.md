...
Spec 026 (`027-graph-and-context-optimization`) is the largest program in the repo: 8 tracks and 639 live spec folders, most with a shipped implementation summary. At the start of this effort only 103 packet-local changelogs existed, so roughly 80 percent of shipped phases had no changelog.

...
description: "Consolidated verdict across {N} child phases of 027-graph-and-context-optimization. Aggregate findings: {N} P0 / {N} P1 / {N} P2. Overall program verdict: {verdict}."
trigger_phrases:
...
- **Scope**: 13 phases under `027-graph-and-context-optimization/`, reviewed via 5-iteration deep-review per phase (total planned iterations: 65, actual may be lower due to convergence-driven early stops)

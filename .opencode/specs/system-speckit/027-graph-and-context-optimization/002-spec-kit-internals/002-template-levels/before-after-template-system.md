...
> Plain-language walkthrough of what changed in the spec-kit template system after the 008-template-levels refactor (Apr-May 2026). No jargon. If you're a maintainer who needs the schema, see `templates/manifest/EXTENSION_GUIDE.md`.
...
- **One follow-up packet** (`004-fix-template-deferred-followups/`) implemented 10 deferred items + 5 architectural decisions that didn't fit the contained-remediation budget of round 3.
...
- `004-fix-template-deferred-followups/` — orchestrator + exit codes + version field + 5 more ADRs

...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/002-spec-kit-internals/002-template-levels/006-command-markdown-yaml-workflow-alignment"

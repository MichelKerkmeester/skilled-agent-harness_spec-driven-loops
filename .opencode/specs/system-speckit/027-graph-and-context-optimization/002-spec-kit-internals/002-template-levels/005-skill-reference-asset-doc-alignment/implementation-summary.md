...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/002-spec-kit-internals/002-template-levels/005-skill-reference-asset-doc-alignment"
...
The phase parent `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/graph-metadata.json` now includes `005-skill-reference-asset-doc-alignment` in `children_ids` and points `derived.last_active_child_id` at the 005 packet.
<!-- /ANCHOR:what-built -->

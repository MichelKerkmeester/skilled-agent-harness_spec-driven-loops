...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/002-spec-kit-internals/002-template-levels"
...
| **Created** | 2026-05-01 |
| **Branch** | `main` |
| **Parent Spec** | `../spec.md` (027-graph-and-context-optimization) |

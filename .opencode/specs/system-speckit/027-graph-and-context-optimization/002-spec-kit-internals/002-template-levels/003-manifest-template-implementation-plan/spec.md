...
- **Source design**: `../002-manifest-driven-template-design/research/research.md` (51.4 KB, 17 sections + §18 addendum)
- **ADRs**: `../002-manifest-driven-template-design/decision-record.md` (ADR-001 through ADR-005)

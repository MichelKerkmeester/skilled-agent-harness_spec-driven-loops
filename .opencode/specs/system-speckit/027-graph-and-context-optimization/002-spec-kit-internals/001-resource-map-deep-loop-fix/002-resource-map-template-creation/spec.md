---
title: "F [system-spec-kit/026-graph-and-context-optimization/002-resource-map-deep-loop-fix/002-resource-map-deep-loop-fix-creation/spec]"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/002-spec-kit-internals/001-resource-map-deep-loop-fix/002-resource-map-template-creation"
...
This is Phase 012 of the 027-graph-and-context-optimization specification. It introduces a reusable, level-agnostic template that catalogs every file path a packet touched, grouped by resource category, and wires it into the discovery surfaces so operators find it next to the other cross-cutting templates.
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/002-resource-map-deep-loop-fix/002-resource-map-deep-loop-fix-creation/*` | Create | Packet docs. |
<!-- /ANCHOR:scope -->

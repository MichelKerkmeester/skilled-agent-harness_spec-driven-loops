...
_memory:
  continuity:
    packet_pointer: "system-speckit/027-graph-and-context-optimization/002-spec-kit-internals/003-literal-spec-folder-names"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 003-literal-spec-folder-names |

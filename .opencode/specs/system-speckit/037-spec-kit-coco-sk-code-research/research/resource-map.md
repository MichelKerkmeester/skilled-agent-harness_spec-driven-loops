...
| Path | Note |
|---|---|
| `.opencode/specs/skilled-agent-orchestration/z_archive/065-spec-kit-coco-sk-code-research/` | This packet |
| `.opencode/specs/skilled-agent-orchestration/z_archive/054-sk-doc-organization/` | Predecessor — assets/ root reorg |
| `.opencode/specs/skilled-agent-orchestration/z_archive/055-sk-code-motion-dev-and-playbook/` | Just shipped sk-code v3.1.0.0 (out of scope here) |
| `.opencode/specs/skilled-agent-orchestration/z_archive/064-sk-doc-missing-router-intents-bullet-aware-matrix/` | Most recent prior packet (different scope) |
...
| `.opencode/specs/skilled-agent-orchestration/z_archive/065-spec-kit-coco-sk-code-research/research/scripts/dispatch-iter.sh` | This packet's per-iteration dispatcher |
| `.opencode/specs/skilled-agent-orchestration/z_archive/065-spec-kit-coco-sk-code-research/research/scripts/run-loop.sh` | This packet's loop driver |
...
| `.opencode/specs/skilled-agent-orchestration/z_archive/065-spec-kit-coco-sk-code-research/research/deep-research-config.json` | This packet's research config |

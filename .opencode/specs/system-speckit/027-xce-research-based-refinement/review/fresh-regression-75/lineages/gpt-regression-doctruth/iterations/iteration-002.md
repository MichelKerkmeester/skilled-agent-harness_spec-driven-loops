...
```json
{
  ...
  "files_reviewed": [
    ...
    ".opencode/skills/system-spec-kit/feature_catalog/16--tooling-and-scripts/spec-memory-cli-daemon-backed-surface.md",
    ".opencode/skills/system-spec-kit/feature_catalog/16--tooling-and-scripts/stale-exclusion-audit-and-tool-ownership-lint.md",
    ".opencode/skills/system-spec-kit/feature_catalog/01--retrieval/session-recovery-spec-kit-resume.md",
    ".opencode/skills/system-spec-kit/feature_catalog/16--tooling-and-scripts/spec-folder-literal-naming-ai-derived-slugs.md",
    ".opencode/skills/system-spec-kit/feature_catalog/16--tooling-and-scripts/debug-delegation-scaffold-generator.md",
  ...
  "findings": [
    ...
    },
    {
      ...
      "file": ".opencode/skills/system-spec-kit/feature_catalog/01--retrieval/session-recovery-spec-kit-resume.md:64",

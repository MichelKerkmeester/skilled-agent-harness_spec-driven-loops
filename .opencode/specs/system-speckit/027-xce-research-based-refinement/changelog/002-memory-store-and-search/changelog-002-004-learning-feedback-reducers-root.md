...
> Spec folder: `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/002-memory-store-and-search/004-learning-feedback-reducers` (Level 2, Phase Parent)
...
|-----------|------|-------|
| [changelog-002-004-001-shared-feedback-aggregation.md](./changelog-002-004-001-shared-feedback-aggregation.md) | 2026-06-10 | Learning Feedback Reducers 001: Shared Feedback Aggregation Foundation |
| [changelog-002-004-003-session-trace-causal-reducer.md](./changelog-002-004-003-session-trace-causal-reducer.md) | 2026-06-10 | Learning Feedback Reducers 003: Deferred Session-Trace Causal Reducer |
| [changelog-002-004-004-feedback-retention-reducer.md](./changelog-002-004-004-feedback-retention-reducer.md) | 2026-06-10 | Learning Feedback Reducers 004: Feedback Retention Reducer and Narrow Edge Floor |
| [changelog-002-004-005-env-tests-integration.md](./changelog-002-004-005-env-tests-integration.md) | 2026-06-10 | Learning Feedback Reducers 005: Env Docs and Integration Closeout |
...
|------|--------|--------------|
| `004-learning-feedback-reducers/` (child phases) | n/a | Rollup of 4 child phase changelogs; no direct source changes at the parent level. |

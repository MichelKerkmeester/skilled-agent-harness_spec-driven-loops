...
| 5 | 005-deep-ai-council/ | Apply the canonical contract to deep-ai-council (15/15 references, 2/3 assets carry the detailed block). | Complete |
...
| 7 | 007-deep-improvement/ | Apply the canonical contract to deep-improvement (17/23 references, 8/11 assets carry the detailed block). | Complete |
| 8 | 008-deep-loop-runtime/ | Apply the canonical contract to deep-loop-runtime (4/4 references carry the detailed block; no assets). | Complete |
| 9 | 009-deep-research/ | Apply the canonical contract to deep-research (0/13 references, 0/2 assets carry the detailed block). | Complete |
| 10 | 010-deep-review/ | Apply the canonical contract to deep-review (3/10 references, 0/2 assets carry the detailed block). | Complete |

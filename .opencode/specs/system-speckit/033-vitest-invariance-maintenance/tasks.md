...
- [x] T001 Scaffold spec folder `033-vitest-invariance-maintenance` (Level 2, `--track system-speckit --skip-branch`)
...
- [ ] T014 `bash validate.sh 033-vitest-invariance-maintenance --strict` clean; write `implementation-summary.md`
<!-- /ANCHOR:phase-3 -->

...
- `node .opencode/skills/system-spec-kit/mcp_server/dist/lib/validation/spec-doc-structure.js --folder .opencode/specs/system-speckit/004-memory-search-intelligence --level phase --rule FRONTMATTER_MEMORY_BLOCK --output json`
- `source .opencode/skills/system-spec-kit/scripts/rules/check-spec-doc-integrity.sh; run_check .opencode/specs/system-speckit/004-memory-search-intelligence phase`

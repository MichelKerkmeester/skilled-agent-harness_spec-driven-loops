...
- [x] T025 Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-speckit/004-memory-search-intelligence/022-drift-marker-native-consolidation --strict`
- [x] T026 Update documentation (spec/plan/tasks/checklist/implementation-summary)
<!-- /ANCHOR:phase-3 -->

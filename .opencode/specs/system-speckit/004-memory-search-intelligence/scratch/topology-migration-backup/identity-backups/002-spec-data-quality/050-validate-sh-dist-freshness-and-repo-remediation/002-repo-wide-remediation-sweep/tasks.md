...
_memory:
  continuity:
    packet_pointer: "system-speckit/004-memory-search-intelligence/002-spec-data-quality/050-validate-sh-dist-freshness-and-repo-remediation/002-repo-wide-remediation-sweep"
...
- [x] T001 Enumerate the 41 in-scope packet roots (43 total minus `system-speckit/028-*` minus `deep-loops/030-agent-loops-improved`; discovered and excluded `system-speckit/004-memory-search-intelligence/000-release-cleanup/015-manual-playbook-execution-sweep` mid-sweep as a live concurrent session).

...
- `.opencode/specs/system-speckit/004-memory-search-intelligence/before-vs-after.md` sections 1-6, the canonical 028 shipped-feature inventory.
- `.opencode/specs/system-speckit/004-memory-search-intelligence/000-release-cleanup/` phases 004-feature-catalogs and 005-manual-testing-playbooks, the edits-only spec-kit-only cleanup.

...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-speckit/004-memory-search-intelligence/000-release-cleanup/004-feature-catalogs --strict` exits 0 after cleanup.
<!-- /ANCHOR:success-criteria -->

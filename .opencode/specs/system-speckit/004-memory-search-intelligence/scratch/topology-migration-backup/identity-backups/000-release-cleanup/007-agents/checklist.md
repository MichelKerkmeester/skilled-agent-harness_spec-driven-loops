...
- [x] CHK-001 [P0] Scope is limited to agent definition and runtime mirror sweep.
...
- [x] CHK-020 [P0] Stale-reference scan is run with `deprecated tool|removed skill|stale route|orphan|missing mirror|renamed agent`.

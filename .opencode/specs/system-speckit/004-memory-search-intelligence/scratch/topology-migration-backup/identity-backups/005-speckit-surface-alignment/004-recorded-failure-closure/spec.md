...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-speckit/004-memory-search-intelligence/005-speckit-surface-alignment/004-recorded-failure-closure/spec.md"
      - ".opencode/specs/system-speckit/004-memory-search-intelligence/005-speckit-surface-alignment/004-recorded-failure-closure/implementation-summary.md"
    session_dedup:

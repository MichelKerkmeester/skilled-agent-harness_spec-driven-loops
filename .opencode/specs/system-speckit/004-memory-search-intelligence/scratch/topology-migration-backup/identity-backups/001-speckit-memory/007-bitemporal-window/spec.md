...
_memory:
  continuity:
    packet_pointer: "system-speckit/004-memory-search-intelligence/001-speckit-memory/007-bitemporal-window"
...
| **Parent Phase** | `system-speckit/004-memory-search-intelligence/001-speckit-memory` (research) |

...
- [x] CHK-FIX-007 [P1] Evidence is pinned to a fix SHA or explicit diff range, not a moving branch-relative range. [EVIDENCE: pinned to the 010 integration commit on branch system-speckit/004-memory-search-intelligence]
<!-- /ANCHOR:fix-completeness -->

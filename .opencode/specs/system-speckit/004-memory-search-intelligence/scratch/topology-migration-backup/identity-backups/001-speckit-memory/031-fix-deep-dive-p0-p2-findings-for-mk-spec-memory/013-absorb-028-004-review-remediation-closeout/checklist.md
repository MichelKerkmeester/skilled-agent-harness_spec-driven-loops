...
- [x] CHK-FIX-007 [P1] Closeout evidence pinned to a commit SHA or explicit diff range, not a moving branch-relative range [EVIDENCE: closeout evidence pinned to the 013 integration commit on branch system-speckit/004-memory-search-intelligence]
<!-- /ANCHOR:fix-completeness -->

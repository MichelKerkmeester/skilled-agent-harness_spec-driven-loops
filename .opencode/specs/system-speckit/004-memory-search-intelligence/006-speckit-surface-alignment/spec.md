...
_memory:
  continuity:
    packet_pointer: "system-speckit/004-memory-search-intelligence/006-speckit-surface-alignment"
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-speckit/004-memory-search-intelligence/006-speckit-surface-alignment/spec.md"
...
- **Parent Spec:** `../spec.md`
- **Predecessor:** `../005-dark-flag-graduation/spec.md`

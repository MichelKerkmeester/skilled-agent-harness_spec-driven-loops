...
_memory:
  continuity:
    packet_pointer: "system-speckit/004-memory-search-intelligence/006-speckit-surface-alignment/004-recorded-failure-closure"
...
| File | Action | Purpose |
|------|--------|---------|
| `.opencode/specs/system-speckit/004-memory-search-intelligence/research/deep-research-strategy.md` | Modified before this doc pass | Reconcile recorded cap text. |

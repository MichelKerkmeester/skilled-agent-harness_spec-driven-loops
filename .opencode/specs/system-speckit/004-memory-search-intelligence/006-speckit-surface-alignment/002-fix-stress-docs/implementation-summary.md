...
| `.opencode/specs/system-speckit/004-memory-search-intelligence/005-speckit-surface-alignment/002-fix-stress-docs/` | Created | Captured spec, plan, tasks, and implementation summary. |
<!-- /ANCHOR:what-built -->

...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-speckit/004-memory-search-intelligence/005-speckit-surface-alignment/003-stress-and-skillmd-audit/review-report.md"
      - ".opencode/specs/system-speckit/004-memory-search-intelligence/005-speckit-surface-alignment/003-stress-and-skillmd-audit/spec.md"
    session_dedup:
...
| **Successor** | ../004-recorded-failure-closure/spec.md |
<!-- /ANCHOR:metadata -->

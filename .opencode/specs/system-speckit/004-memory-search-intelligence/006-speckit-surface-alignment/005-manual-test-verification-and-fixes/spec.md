...
_memory:
  continuity:
    packet_pointer: "system-speckit/004-memory-search-intelligence/006-speckit-surface-alignment/005-manual-test-verification-and-fixes"
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-speckit/004-memory-search-intelligence/005-speckit-surface-alignment/005-manual-test-verification-and-fixes/spec.md"
      - ".opencode/specs/system-speckit/004-memory-search-intelligence/005-speckit-surface-alignment/005-manual-test-verification-and-fixes/implementation-summary.md"
      - ".opencode/specs/system-speckit/004-memory-search-intelligence/005-speckit-surface-alignment/005-manual-test-verification-and-fixes/decision-record.md"
    session_dedup:

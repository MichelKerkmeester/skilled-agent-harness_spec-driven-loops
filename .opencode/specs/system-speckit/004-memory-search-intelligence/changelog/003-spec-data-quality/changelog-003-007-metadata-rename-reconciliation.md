...
> Spec folder: `.opencode/specs/system-speckit/004-memory-search-intelligence/003-spec-data-quality/007-metadata-rename-reconciliation` (Level recorded in phase evidence)

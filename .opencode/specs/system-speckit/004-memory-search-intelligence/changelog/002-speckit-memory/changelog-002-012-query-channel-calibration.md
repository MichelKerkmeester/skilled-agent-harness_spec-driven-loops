...
> Spec folder: `.opencode/specs/system-speckit/004-memory-search-intelligence/002-speckit-memory/012-query-channel-calibration` (Level recorded in phase evidence)

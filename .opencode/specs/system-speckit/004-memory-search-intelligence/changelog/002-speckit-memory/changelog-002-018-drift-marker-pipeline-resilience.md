...
> Spec folder: `.opencode/specs/system-speckit/004-memory-search-intelligence/002-speckit-memory/018-drift-marker-pipeline-resilience` (Level recorded in phase evidence)

...
> Spec folder: `.opencode/specs/system-speckit/004-memory-search-intelligence/005-dark-flag-graduation/011-graph-preservation-quality-benchmark` (Level recorded in phase evidence)

...
_memory:
  continuity:
    packet_pointer: "system-speckit/004-memory-search-intelligence/002-speckit-memory/038-scoring-hardening"
...
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../037-envelope-fidelity-enforcement/spec.md |
| **Successor** | ../039-substrate-sandbox-cleanup/spec.md |
<!-- /ANCHOR:metadata -->

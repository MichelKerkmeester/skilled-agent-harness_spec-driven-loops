...
All internal paths are relative to `.opencode/skills/system-spec-kit/`. The aionforge doc path is `.opencode/specs/system-speckit/004-memory-search-intelligence/external/aionforge-memory-development/docs/retrieval.md`.

...
- **028 Advisor-C4 × 027 `005-advisor-feedback-calibration`** — C4 (bounded Beta lane auto-tune, graduation of `feedback-calibration.ts:154`) shares Q4's Beta math but applies to ADVISOR; 027 shipped an advisor-calibration child. → a "028-002-skill-advisor × 027" reconciliation.

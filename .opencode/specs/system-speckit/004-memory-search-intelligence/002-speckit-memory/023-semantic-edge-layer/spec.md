...
_memory:
  continuity:
    packet_pointer: "system-speckit/004-memory-search-intelligence/002-speckit-memory/023-semantic-edge-layer"
...
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../022-iterative-agentic-recall/spec.md |
| **Successor** | ../024-sleeptime-consolidation/spec.md |
<!-- /ANCHOR:metadata -->

...
_memory:
  continuity:
    packet_pointer: "system-speckit/004-memory-search-intelligence/002-speckit-memory/032-new-feature-research-build"
...
| **Phase** | 008 of 008 |
| **Predecessor** | ../031-drift-marker-native-consolidation/spec.md |
| **Source decisions** | `../benchmark-status.md`, `../feature-flags.md`, `../before-vs-after.md` |
| **Successor** | ../033-self-healing-model-consolidation/spec.md |
<!-- /ANCHOR:metadata -->
...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-speckit/004-memory-search-intelligence --strict` exits 0.
<!-- /ANCHOR:success-criteria -->

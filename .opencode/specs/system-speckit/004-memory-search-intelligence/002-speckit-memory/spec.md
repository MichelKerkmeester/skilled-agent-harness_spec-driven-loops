...
_memory:
  continuity:
    packet_pointer: "system-speckit/004-memory-search-intelligence/002-speckit-memory"
...
- Use `/speckit:resume system-speckit/004-memory-search-intelligence/002-speckit-memory/[NNN-phase]/` to resume a specific current child.

...
`004-memory-search-intelligence`, all already shipped and passing `validate.sh --strict`. Both findings sit
...
`002-graph-and-context-optimization/007-mcp-daemon-reliability/{032,033,034}`). The other 14 findings from

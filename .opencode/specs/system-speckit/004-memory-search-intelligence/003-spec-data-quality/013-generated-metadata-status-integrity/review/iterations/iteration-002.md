...
- `.opencode/specs/system-speckit/004-memory-search-intelligence/002-spec-data-quality/047-generated-metadata-status-integrity/review/iterations/iteration-001.md:54`
- `.opencode/specs/system-speckit/004-memory-search-intelligence/002-spec-data-quality/047-generated-metadata-status-integrity/review/deep-review-state.jsonl:1`
- `.opencode/specs/system-speckit/004-memory-search-intelligence/002-spec-data-quality/047-generated-metadata-status-integrity/review/deep-review-strategy.md:21`
...
- `.opencode/specs/system-speckit/004-memory-search-intelligence/001-speckit-memory/description.json:3`
...
- `blast_radius_scan`: Partial, read-only. Exact grep for basename-only `specFolder` and empty `parentChain` found candidate metadata shapes, including `.opencode/specs/system-speckit/004-memory-search-intelligence/001-speckit-memory/description.json:3`; full path-aware corruption classification remains deferred to the planned blast-radius iteration.

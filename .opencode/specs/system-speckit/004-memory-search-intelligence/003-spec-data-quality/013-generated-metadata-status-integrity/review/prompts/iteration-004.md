...
Mode: review
Dimension: MINIMAL FIX PROPOSAL — TARGET 1 ONLY. Given iterations 1-3's root-cause and blast-radius findings, propose the minimal correct fix for the defective code path (which function, what specific change, why it is minimal and does not regress the legitimate child-packet description.json write). Cross-check the fix proposal against is-phase-parent.ts and phase-classifier.ts assumptions about parent/child folder classification so the fix doesn't break phase-parent detection. Also propose (as a finding, not an implementation) how to detect/repair already-corrupted packets found in iteration 3 — do NOT actually repair any real packet's description.json in this repo, this is a read-only review.
...
- Write iteration narrative to: .opencode/specs/system-speckit/004-memory-search-intelligence/002-spec-data-quality/047-generated-metadata-status-integrity/review/iterations/iteration-004.md
- Write per-iteration delta file to: .opencode/specs/system-speckit/004-memory-search-intelligence/002-spec-data-quality/047-generated-metadata-status-integrity/review/deltas/iter-004.jsonl
...
- **ALLOWED WRITE PATHS (the ONLY paths you may create, modify, or append to)**:
  - `.opencode/specs/system-speckit/004-memory-search-intelligence/002-spec-data-quality/047-generated-metadata-status-integrity/review/iterations/iteration-004.md`, this iteration's narrative markdown
  ...
  - `.opencode/specs/system-speckit/004-memory-search-intelligence/002-spec-data-quality/047-generated-metadata-status-integrity/review/deltas/iter-004.jsonl`, this iteration's delta JSONL
...
1. **Iteration narrative markdown** at `.opencode/specs/system-speckit/004-memory-search-intelligence/002-spec-data-quality/047-generated-metadata-status-integrity/review/iterations/iteration-004.md` (path pre-substituted for the current iteration number). Structure: headings for Dimension, Files Reviewed, Findings by Severity (P0/P1/P2), Traceability Checks, Verdict, Next Dimension.

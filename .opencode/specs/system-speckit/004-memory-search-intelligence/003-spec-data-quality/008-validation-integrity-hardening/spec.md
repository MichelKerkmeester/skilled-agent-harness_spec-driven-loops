...
| **Branch** | `main` |
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../007-metadata-rename-reconciliation/spec.md |
| **Successor** | ../009-validation-hardening-fixes/spec.md |
<!-- /ANCHOR:metadata -->

...
_memory:
  continuity:
    packet_pointer: "system-speckit/004-memory-search-intelligence/005-dark-flag-graduation/008-followup-deep-review"
...
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../007-graduation-follow-ups/spec.md |
| **Successor** | ../009-cross-package-flag-governance/spec.md |
<!-- /ANCHOR:metadata -->

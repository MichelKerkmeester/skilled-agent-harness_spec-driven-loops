...
const SINGLE_HOP_QUERIES = [
  {
    ...
    targetFolders: [
      'system-spec-kit/028-memory-search-intelligence/003-spec-data-quality/043-gap-threshold-calibration-benchmark',
      'system-spec-kit/028-memory-search-intelligence/003-spec-data-quality/044-relevance-aware-evidence-gap',
    ],
  },
  {
  ...
  },
  {
    ...
    targetFolders: ['system-spec-kit/028-memory-search-intelligence/003-spec-data-quality/043-gap-threshold-calibration-benchmark'],
  },
  {
    id: 'sh-relevance-aware-gap',
    text: 'find the relevance aware evidence gap spec',
    targetFolders: ['system-spec-kit/028-memory-search-intelligence/003-spec-data-quality/044-relevance-aware-evidence-gap'],
  },
  {
    id: 'sh-conflict-rerank-routing',
    text: 'show me the conflict rerank query routing spec',
    targetFolders: ['system-spec-kit/028-memory-search-intelligence/002-skill-advisor/005-conflict-rerank-query-routing'],
  },
  {
...
const MULTI_HOP_QUERIES = [
  ...
  },
  {
    ...
    relevantFolders: ['system-spec-kit/028-memory-search-intelligence/005-dark-flag-graduation'],
  },
];

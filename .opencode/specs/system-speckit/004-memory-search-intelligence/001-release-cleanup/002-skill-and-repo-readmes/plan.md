---
title: "Implementation Plan: Skill And Repo README Cleanup"
description: "Defines the pending cleanup approach for skill-level and top-level readme sweep."
trigger_phrases:
  - "028 release cleanup skill readmes plan"
  - "skill-and-repo-readmes cleanup plan"
importance_tier: "important"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "system-speckit/004-memory-search-intelligence/001-release-cleanup/002-skill-and-repo-readmes"
...
# Implementation Plan: Skill And Repo README Cleanup
...
|---------|--------------|--------|--------------|
| Skill-level and top-level README sweep | Release documentation surface | Review later | Discovery output and grep evidence |
...
### Phase 1: Setup
- [ ] Run discovery: `rg --files .opencode/skills | rg '^\.opencode/skills/[^/]+/README\.md$' && printf '%s\n' README.md .opencode/README.md .claude/README.md .codex/README.md`
...
- [ ] Run stale-reference scan: `rg -n 'deprecated|stale|coming soon|old version|removed|renamed|does not exist|legacy only' <discovered-docs>`
...
|-------|------------|--------|
| 002 | `../spec.md` | Parent phase map owns release-cleanup ordering |
<!-- /ANCHOR:phase-deps -->

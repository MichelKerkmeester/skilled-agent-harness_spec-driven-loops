---
title: "Verification Checklist: Skill References Assets And SKILL Cleanup"
description: "PENDING verification checklist for skill.md, references and assets sweep."
trigger_phrases:
  - "028 release cleanup skill references checklist"
  - "skill-references-assets-and-skillmd cleanup checklist"
importance_tier: "important"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "system-speckit/004-memory-search-intelligence/001-release-cleanup/003-skill-references-assets-and-skillmd"
    last_updated_at: "2026-07-04T17:31:34.024Z"
    last_updated_by: "claude-opus-4-8"
    recent_action: "Verified SKILL.md, references and assets cleanup checklist items"
    ...
    session_dedup:
      ...
      session_id: "2026-06-19-checklist-003-skill-references-assets-and-skillmd"
...
# Verification Checklist: Skill References Assets And SKILL Cleanup
...
- [x] CHK-001 [P0] Scope is limited to skill.md, references and assets sweep.
...
- [x] CHK-020 [P0] Stale-reference scan is run with `TODO|TBD|deprecated|stale|removed|renamed|missing|does not exist|dead link`.

---
title: "Implementation Plan: Feature Catalog Cleanup"
description: "Defines the pending cleanup approach for feature catalog sweep."
trigger_phrases:
  - "028 release cleanup feature catalogs plan"
  - "feature-catalogs cleanup plan"
importance_tier: "important"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "system-speckit/004-memory-search-intelligence/001-release-cleanup/004-feature-catalogs"
    ...
    session_dedup:
      ...
      session_id: "2026-06-19-plan-004-feature-catalogs"
...
# Implementation Plan: Feature Catalog Cleanup
...
|---------|--------------|--------|--------------|
| Feature catalog sweep | Release documentation surface | Review later | Discovery output and grep evidence |
...
### Phase 1: Setup
- [ ] Run discovery: `rg --files | rg '(^|/)(FEATURE_CATALOG\.md|feature_catalog/.+\.md|feature_catalog[^/]*\.md)$'`
...
- [ ] Run stale-reference scan: `rg -n 'unshipped|planned only|removed|renamed|stale|missing source|count mismatch' <discovered-docs>`
...
|-------|------------|--------|
| 004 | `../spec.md` | Parent phase map owns release-cleanup ordering |
<!-- /ANCHOR:phase-deps -->

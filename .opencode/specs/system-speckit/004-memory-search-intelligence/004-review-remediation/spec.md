...
_memory:
  continuity:
    packet_pointer: "system-speckit/004-memory-search-intelligence/004-review-remediation"
    ...
    session_dedup:
      ...
      session_id: "2026-06-19-028-004-review-remediation-parent"
...
| **Predecessor** | `../003-spec-data-quality/spec.md` |
| **Successor** | `../005-dark-flag-graduation/spec.md` |
<!-- /ANCHOR:metadata -->
...
### Purpose
Keep the parent as the six-child review-remediation rollup. The child folders own implementation detail, evidence and verification; `../changelog/004-review-remediation/changelog-004-root.md` is the current status source and `../archive/review-report.md` is source-review context for the first four children.

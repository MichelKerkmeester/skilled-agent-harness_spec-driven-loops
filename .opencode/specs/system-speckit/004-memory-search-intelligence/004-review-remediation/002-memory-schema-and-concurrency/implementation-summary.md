...
_memory:
  continuity:
    packet_pointer: "system-speckit/004-memory-search-intelligence/004-review-remediation/002-memory-schema-and-concurrency"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 002-memory-schema-and-concurrency |
...
| Strict validation | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/028-memory-search-intelligence/004-review-remediation/002-memory-schema-and-concurrency --strict` |
<!-- /ANCHOR:verification -->

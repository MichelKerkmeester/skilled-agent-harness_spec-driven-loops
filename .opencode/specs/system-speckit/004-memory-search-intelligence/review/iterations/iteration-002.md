...
- `.opencode/specs/system-speckit/004-memory-search-intelligence/006-presentation-layer-fixes/spec.md:50-195`
- `.opencode/specs/system-speckit/004-memory-search-intelligence/006-presentation-layer-fixes/plan.md:66-149`
- `.opencode/specs/system-speckit/004-memory-search-intelligence/006-presentation-layer-fixes/tasks.md:56-134`
- `.opencode/specs/system-speckit/004-memory-search-intelligence/006-presentation-layer-fixes/implementation-summary.md:48-149`
- `.opencode/specs/system-speckit/004-memory-search-intelligence/007-search-index-integrity-sweep/{spec,plan,checklist,tasks,implementation-summary}.md`
- `.opencode/specs/system-speckit/004-memory-search-intelligence/008-metadata-rename-reconciliation/{spec,plan,checklist,tasks,implementation-summary}.md`

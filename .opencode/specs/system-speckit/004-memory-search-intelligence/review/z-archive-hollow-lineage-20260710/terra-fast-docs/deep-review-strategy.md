...
## Topic
Review `.opencode/specs/system-speckit/004-memory-search-intelligence` as a phase-parent packet.
...
## Review Boundaries
- Detached artifact directory only: `.opencode/specs/system-speckit/004-memory-search-intelligence/review/lineages/terra-fast-docs`

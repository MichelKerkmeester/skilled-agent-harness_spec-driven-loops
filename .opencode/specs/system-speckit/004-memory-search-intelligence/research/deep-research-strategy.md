...
- Source pointers: `.opencode/specs/system-speckit/004-memory-search-intelligence/` phase children, `.opencode/skills/system-spec-kit/`, `.opencode/skills/deep-loop-workflows/`, `.opencode/commands/`, related benchmark and manual-testing folders.

...
- Missing dependencies: Code graph remained stale/untrusted; direct `Glob`, `Grep`, and `Read` evidence was used. [SOURCE: .opencode/specs/system-speckit/004-memory-search-intelligence/research/deep-research-strategy.md:122]

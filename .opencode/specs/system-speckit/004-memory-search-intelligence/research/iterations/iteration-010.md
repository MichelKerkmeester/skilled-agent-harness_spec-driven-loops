...
- Missing dependencies: Code graph remained stale/untrusted; direct `Read`, `Glob`, and `Grep` evidence was used instead. [SOURCE: .opencode/specs/system-speckit/004-memory-search-intelligence/research/deep-research-strategy.md:122]

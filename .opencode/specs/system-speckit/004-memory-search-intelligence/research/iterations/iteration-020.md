...
- Missing dependencies: Code graph remains stale/untrusted, so this pass used direct file evidence. [SOURCE: .opencode/specs/system-speckit/004-memory-search-intelligence/research/deep-research-strategy.md:122]

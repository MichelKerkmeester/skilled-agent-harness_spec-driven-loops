...
- Treating field-level mentions of `requestQuality`, `citationPolicy`, or `envelopeRender` as full coverage was ruled out because packet 028's graduated behavior is flag-specific and fixture-benchmark-specific. [SOURCE: .opencode/specs/system-speckit/004-memory-search-intelligence/feature-flags.md:125]
...
- `.opencode/specs/system-speckit/004-memory-search-intelligence/feature-flags.md:125`

...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/system-speckit/028-memory-search-intelligence/004-dark-flag-graduation/002-retrieval-class-weights/scripts/retrieval-class-routing-benchmark.mjs"
    session_dedup:

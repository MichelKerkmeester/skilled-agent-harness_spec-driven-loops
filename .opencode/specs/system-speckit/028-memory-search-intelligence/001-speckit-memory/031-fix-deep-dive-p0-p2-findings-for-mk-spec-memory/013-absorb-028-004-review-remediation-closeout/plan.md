...
- Stale open-state strings: `rg -n 'PENDING, scaffold only|queued for next fix-dispatch round' .opencode/specs/system-speckit/028-memory-search-intelligence/004-review-remediation .opencode/specs/system-speckit/028-memory-search-intelligence/000-release-cleanup/015-manual-playbook-execution-sweep` — must return zero hits after the pass.

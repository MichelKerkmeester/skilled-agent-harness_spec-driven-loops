...
- `.opencode/specs/system-speckit/028-memory-search-intelligence/010-generated-metadata-status-integrity/review/deep-review-state.jsonl:1-8` - prior review state through iteration 7.
- `.opencode/specs/system-speckit/028-memory-search-intelligence/010-generated-metadata-status-integrity/review/deep-review-strategy.md:77-80` - scheduled iteration 8 Target 2 test-suite gap focus.
- `.opencode/specs/system-speckit/028-memory-search-intelligence/010-generated-metadata-status-integrity/review/iterations/iteration-006.md:18-48` - edge-case matrix and existing parser coverage advisory.
- `.opencode/specs/system-speckit/028-memory-search-intelligence/010-generated-metadata-status-integrity/review/iterations/iteration-007.md:32-41` - active orchestrator enforcement-flag finding and downgrade trigger.
- `.opencode/specs/system-speckit/028-memory-search-intelligence/010-generated-metadata-status-integrity/spec.md:132-143` - REQ-001..REQ-005 acceptance criteria.

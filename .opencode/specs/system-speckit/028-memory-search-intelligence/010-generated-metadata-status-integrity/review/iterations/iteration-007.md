...
- `.opencode/specs/system-speckit/028-memory-search-intelligence/010-generated-metadata-status-integrity/spec.md:132-143` - REQ-001..REQ-005 acceptance criteria, especially REQ-004 explicit enforced-mode exception.
...
- Final severity: P1. This is a must-fix validation gate mismatch against REQ-004's "unless the new flag is explicitly opted into enforced mode" acceptance criterion at `.opencode/specs/system-speckit/028-memory-search-intelligence/010-generated-metadata-status-integrity/spec.md:141-143`.
- Confidence: 0.87.

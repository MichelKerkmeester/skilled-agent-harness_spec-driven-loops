...
> Spec folder: `.opencode/specs/system-speckit/028-memory-search-intelligence/002-speckit-memory/014-automatic-drift-self-healing` (Level recorded in phase evidence)

...
> Spec folder: `.opencode/specs/system-speckit/028-memory-search-intelligence/006-speckit-surface-alignment` (Phase Parent)
...
- Strict validation for `.opencode/specs/system-speckit/028-memory-search-intelligence/006-speckit-surface-alignment` is the acceptance gate for this entry.

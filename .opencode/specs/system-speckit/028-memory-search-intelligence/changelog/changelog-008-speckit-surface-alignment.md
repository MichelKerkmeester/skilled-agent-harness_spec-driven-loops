...
|---|---|---|
| `002-false-now-doc-corrections` | Complete | Corrected false-now documentation drift: added the Track-C supersession pointer and fixed the live `SPECKIT_RETENTION_FORGETTING` flag name in `benchmark-status.md`; confirmed three already-corrected cited surfaces in place. |
...
| `012-stress-and-skillmd-audit` | Complete | Read-only audit of stress-test docs and system-spec-kit SKILL.md/changelog surfaces. Found stress-lane gaps while confirming SKILL.md and changelog current. |
| `012-fix-stress-docs` | Complete | Aligned stress catalog, playbook, and stress_test README surfaces with the shipped automated harness. |
...
| `014-recorded-failure-closure` | Complete | Reconciled the deep-research cap record and shipped the recorded-failure closure route. |
...
| File | Action | Purpose |
|------|--------|---------|
| `008-speckit-surface-alignment/011-code-graph-doc-audit/spec.md` | Created | Audit phase spec. |
| `008-speckit-surface-alignment/011-code-graph-doc-audit/plan.md` | Created | Audit phase plan. |
| `008-speckit-surface-alignment/011-code-graph-doc-audit/tasks.md` | Created | Audit task ledger. |
| `008-speckit-surface-alignment/011-code-graph-doc-audit/implementation-summary.md` | Created | Audit delivered-state summary. |
| `008-speckit-surface-alignment/012-stress-and-skillmd-audit/spec.md` | Created | Audit phase spec. |
| `008-speckit-surface-alignment/012-stress-and-skillmd-audit/plan.md` | Created | Audit phase plan. |
| `008-speckit-surface-alignment/012-stress-and-skillmd-audit/tasks.md` | Created | Audit task ledger. |
| `008-speckit-surface-alignment/012-stress-and-skillmd-audit/implementation-summary.md` | Created | Audit delivered-state summary. |
| `008-speckit-surface-alignment/013-deep-research-loop-instrumentation/plan.md` | Created | Shipped implementation plan and evidence. |
| `008-speckit-surface-alignment/013-deep-research-loop-instrumentation/tasks.md` | Created | Shipped task ledger. |
| `008-speckit-surface-alignment/013-deep-research-loop-instrumentation/implementation-summary.md` | Created | Shipped delivered-state summary. |
| `008-speckit-surface-alignment/014-recorded-failure-closure/plan.md` | Created | Shipped implementation plan and evidence. |
| `008-speckit-surface-alignment/014-recorded-failure-closure/tasks.md` | Created | Shipped task ledger. |
| `008-speckit-surface-alignment/014-recorded-failure-closure/implementation-summary.md` | Created | Shipped delivered-state summary. |
| `changelog/changelog-008-speckit-surface-alignment.md` | Created | Program changelog entry for 008. |

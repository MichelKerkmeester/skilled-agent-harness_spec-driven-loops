...
_memory:
  continuity:
    packet_pointer: "system-speckit/028-memory-search-intelligence/005-speckit-surface-alignment/002-fix-stress-docs"
...
| `.opencode/specs/system-speckit/028-memory-search-intelligence/005-speckit-surface-alignment/002-fix-stress-docs/` | Created | Captured spec, plan, tasks, and implementation summary. |
<!-- /ANCHOR:what-built -->

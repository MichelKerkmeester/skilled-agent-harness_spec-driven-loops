...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-speckit/028-memory-search-intelligence/005-speckit-surface-alignment/003-stress-and-skillmd-audit/review-report.md"
      - ".opencode/specs/system-speckit/028-memory-search-intelligence/005-speckit-surface-alignment/003-stress-and-skillmd-audit/spec.md"
    session_dedup:

...
_memory:
  continuity:
    ...
    recent_action: "Delivered the planned validation rules, sweep, workflow, and test coverage"
    next_safe_action: "Use local sweep reports before enabling either staged enforcement flag"
    blockers: []
    key_files: []
    session_dedup:

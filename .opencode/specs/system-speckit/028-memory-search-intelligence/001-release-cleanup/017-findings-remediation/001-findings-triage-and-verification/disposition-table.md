...
| `devin-01:F9` | CAT-3 | **CONFIRMED** | composer | ``find .opencode/skills/sk-doc/benchmark/reports/compiled-routing/ -maxdepth 1 -type d`` | 5 dated subfolders exist and are committed; claim's example names (`luna-high-acceptance-1784596615522/`) are wrong — actual names are `2026-07-21--acceptance--luna-high/` etc. — but core claim (dated |
...
| `devin-05:F3` | CAT-4 | **CONFIRMED** | composer | ``ls .opencode/skills/sk-design/benchmark/reports/2026-07-06--after-009--router/` + `grep -n 'after-009\` | after-012-routing\ |

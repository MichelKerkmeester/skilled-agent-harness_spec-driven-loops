...
| `devin-01:F9` | CAT-3 | `find .opencode/skills/sk-doc/benchmark/compiled-routing/ -maxdepth 1 -type d` | 5 dated subfolders exist and are committed; claim's example names (`luna-high-acceptance-1784596615522/`) are wrong — actual names are `2026-07-21--acceptance--luna-high/` etc. — but core claim (dated |

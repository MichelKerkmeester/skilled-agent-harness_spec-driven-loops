---
title: "Verification Checklist: Code README Cleanup"
description: "PENDING verification checklist for per-directory code readme sweep."
trigger_phrases:
  - "028 release cleanup code readmes checklist"
  - "code-readmes cleanup checklist"
importance_tier: "important"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "system-speckit/028-memory-search-intelligence/001-release-cleanup/001-code-readmes"
    last_updated_at: "2026-07-04T17:31:32.623Z"
    last_updated_by: "claude-opus-4-8"
    recent_action: "Verified code README cleanup checklist items"
    ...
    session_dedup:
      ...
      session_id: "2026-06-19-checklist-001-code-readmes"
...
# Verification Checklist: Code README Cleanup
...
- [x] CHK-001 [P0] Scope is limited to per-directory code readme sweep.
...
- [x] CHK-020 [P0] Stale-reference scan is run with `removed|renamed|deprecated|stale|missing file|does not exist|old path`.

...
_memory:
  continuity:
    packet_pointer: "system-speckit/028-memory-search-intelligence/001-release-cleanup/015-manual-playbook-execution-sweep"
...
| Phase | Spec |
|-------|------|
| `001-findings-remediation` | [`spec.md`](001-findings-remediation/spec.md) |

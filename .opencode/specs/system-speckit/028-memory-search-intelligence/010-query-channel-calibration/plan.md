---
title: "Implementation Plan: Query-Channel Calibration and Visibility [template:level_2/plan.md]"
...
|------------|------|--------|---------------------|
| 007-search-index-integrity-sweep | Internal | Red (not yet started at time of writing) | Widening graph/degree usage before the index is clean would amplify recall of the 42% stale rows F10 removes; this phase must not start Core Implementation until 007 ships |
...
- [ ] 007-search-index-integrity-sweep confirmed shipped before Phase 2 starts

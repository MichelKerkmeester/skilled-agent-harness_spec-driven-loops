...
- [ ] T007 Add pointer note in prior pass's own docs (`008-drift-audit-remediation/{spec.md,implementation-summary.md}`) - acknowledge pass 2
...
- [ ] T015 Run `validate.sh 009-drift-audit-deep-history-correction --strict`
<!-- /ANCHOR:phase-3 -->

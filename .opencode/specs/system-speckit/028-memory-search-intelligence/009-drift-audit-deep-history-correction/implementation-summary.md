...
| Field | Value |
|-------|-------|
| **Spec Folder** | 009-drift-audit-deep-history-correction |
...
5. **008-drift-audit-remediation pointer**: added a short follow-up note in the prior pass's own docs, without altering its completion status.

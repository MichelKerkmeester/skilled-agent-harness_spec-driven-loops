...
automatic drift self-healing implementation (`028-memory-search-intelligence/011-automatic-drift-self-healing`,
...
- F1-F7, F9, F10, F14, F15, F16 from the same review digest — each belongs to a different, separately
  planned sibling phase under `028-memory-search-intelligence`, or (F16) is already fixed.

...
| `feature_catalog/16--tooling-and-scripts/dist-freshness-enforcement.md` + playbooks 429/455 (docs) | Claims exit 69 (:35, :42) and "cache never pre-warmed by a build script" (§2) | update — real exit taxonomy, new cache-bootstrap behavior | `grep -n "exit 69" feature_catalog/16--tooling-and-scripts/dist-freshness-enforcement.md` returns nothing stale |

...
|-----------|-------------|-------------|
| `../../006-review-remediation/002-memory-schema-and-concurrency/tasks.md` | Modify | Mark T005/T006 absorbed → phase 008, T007 absorbed → phase 009 as verify-first-then-close (already fixed in code per SYSTEMIC #1), with pointer paths |
...
| `../../006-review-remediation/004-p2-triage/spec.md` | Modify | Complete the reconstructed 91-item per-item mapping; repath this tracker's own inherited dead `../../archive/review-report.md` pointer (spec.md:65,86) to the reconstructed list |

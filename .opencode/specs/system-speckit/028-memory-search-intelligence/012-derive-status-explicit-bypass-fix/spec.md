...
| **Parent Spec** | ../spec.md |
| **Phase** | 12 of 12 |
| **Predecessor** | 011-create-sh-parent-corruption-fix |
| **Successor** | None |
...
| `.opencode/specs/system-speckit/028-memory-search-intelligence/010-generated-metadata-status-integrity/spec.md` | Amend | Clarify REQ-001/REQ-002/REQ-005 wording per review's Spec Seed |
<!-- /ANCHOR:scope -->

...
| Field | Value |
|-------|-------|
| **Spec Folder** | 012-derive-status-explicit-bypass-fix |
| **Status** | Complete |
| **Level** | 1 |
<!-- /ANCHOR:metadata -->
...
| `.opencode/specs/system-speckit/028-memory-search-intelligence/010-generated-metadata-status-integrity/spec.md` | Amended | REQ-001/REQ-002/REQ-005 now state the completion-evidence requirement applies to explicit-status `complete` claims too. |
<!-- /ANCHOR:what-built -->

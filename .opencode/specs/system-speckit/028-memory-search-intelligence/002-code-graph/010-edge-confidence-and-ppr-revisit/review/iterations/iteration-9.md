...
- `.opencode/specs/system-speckit/028-memory-search-intelligence/002-code-graph/010-edge-confidence-and-ppr-revisit/decision-record.md:62` - intended same-file candidate-cardinality mapping.
- `.opencode/specs/system-speckit/028-memory-search-intelligence/002-code-graph/010-edge-confidence-and-ppr-revisit/spec.md:167` - zero-candidate default-tier boundary.

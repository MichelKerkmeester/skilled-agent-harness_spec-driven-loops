...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-speckit/028-memory-search-intelligence/008-speckit-surface-alignment/011-code-graph-doc-audit/review-report.md"
      - ".opencode/specs/system-speckit/028-memory-search-intelligence/008-speckit-surface-alignment/011-code-graph-doc-audit/spec.md"
    session_dedup:

...
| `.opencode/specs/system-speckit/028-memory-search-intelligence/008-speckit-surface-alignment/011-fix-code-graph-docs/` | Create | Phase documentation for this fix. |
<!-- /ANCHOR:scope -->

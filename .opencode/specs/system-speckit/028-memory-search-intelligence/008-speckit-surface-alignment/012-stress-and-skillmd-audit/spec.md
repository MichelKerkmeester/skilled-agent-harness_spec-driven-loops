...
contextType: "general"
parent: "../spec.md"
predecessor: "012-fix-stress-docs"
...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-speckit/028-memory-search-intelligence/008-speckit-surface-alignment/012-stress-and-skillmd-audit/review-report.md"
      - ".opencode/specs/system-speckit/028-memory-search-intelligence/008-speckit-surface-alignment/012-stress-and-skillmd-audit/spec.md"
    session_dedup:

...
- [x] T001 Read audit report (`012-stress-and-skillmd-audit/review-report.md`)
- [x] T002 Create pre-approved spec folder (`012-fix-stress-docs/`)
...
- **Audit source**: `../012-stress-and-skillmd-audit/review-report.md`
<!-- /ANCHOR:cross-refs -->

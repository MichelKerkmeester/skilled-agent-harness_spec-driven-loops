...
| Field | Value |
|-------|-------|
| **Spec Folder** | 012-fix-stress-docs |
...
| `.opencode/specs/system-speckit/028-memory-search-intelligence/008-speckit-surface-alignment/012-fix-stress-docs/` | Created | Captured spec, plan, tasks, and implementation summary. |
<!-- /ANCHOR:what-built -->

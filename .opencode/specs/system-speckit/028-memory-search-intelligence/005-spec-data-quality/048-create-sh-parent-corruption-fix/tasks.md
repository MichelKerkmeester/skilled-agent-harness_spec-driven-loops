...
- [x] T010 Re-index repaired packet, confirm correct specFolder/parentChain - confirmed via direct read-back matching sibling packets (002-code-graph, 003-skill-advisor)

...
|---|-------|--------|----------|
| 1 | **Necessary?** | PASS | `sk-design` and `005-spec-data-quality` are drifted right now; the check prevents every future occurrence of the same silent gap |

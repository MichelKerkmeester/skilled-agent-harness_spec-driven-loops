...
- Missing dependencies: Code graph remained stale/untrusted; direct file reads, greps, and a bounded validation command were used. [SOURCE: .opencode/specs/system-speckit/028-memory-search-intelligence/research/deep-research-strategy.md:122]
...
- `.opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/dual-level-retrieval.md:41`
- `.opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/dual-level-retrieval.md:43`
- `command output: python3 .opencode/skills/sk-doc/scripts/validate_document.py .opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/dual-level-retrieval.md --json`

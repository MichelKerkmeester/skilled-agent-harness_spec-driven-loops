...
- Treating all system-spec-kit automated-test references as suspect was ruled out; many entries name concrete vitest files and coverage roles. [SOURCE: .opencode/skills/system-spec-kit/feature_catalog/03--discovery/health-diagnostics-memoryhealth.md:67]
- Treating the AI-council root playbook as the source of the mislabel was ruled out; the root playbook separates automated, operator, and documentation-reference rows, while the feature catalogs collapse manual scenario contracts into `Automated test`. [SOURCE: .opencode/skills/deep-loop-workflows/deep-ai-council/manual_testing_playbook/manual_testing_playbook.md:409] [SOURCE: .opencode/skills/deep-loop-workflows/deep-ai-council/feature_catalog/08--council-graph-integration/council-graph-status-recovery-payload-and-readiness.md:51]
...
- `.opencode/skills/deep-loop-workflows/deep-ai-council/feature_catalog/08--council-graph-integration/council-graph-status-recovery-payload-and-readiness.md:51`
...
- `.opencode/skills/deep-loop-workflows/deep-ai-council/feature_catalog/02--council-deliberation-and-seat-diversity/three-seat-diverse-deliberation.md:50`
...
- `.opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/graph-expanded-fallback.md:42`
- `.opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/always-on-graph-context-injection.md:42`
- `.opencode/skills/system-spec-kit/feature_catalog/03--discovery/health-diagnostics-memoryhealth.md:67`
- `.opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/cross-document-entity-linking.md:57`
- `.opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/provenance-rich-response-envelopes.md:48`
- `.opencode/skills/deep-loop-runtime/feature_catalog/11--observability/single-loop-telemetry-heartbeat.md:40`
- `.opencode/skills/deep-loop-runtime/feature_catalog/07--script-entry-points/convergence-script.md:48`
- `.opencode/skills/deep-loop-runtime/feature_catalog/06--coverage-graph/coverage-graph-signals.md:49`

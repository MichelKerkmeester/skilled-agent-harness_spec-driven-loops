...
_memory:
  continuity:
    packet_pointer: "system-speckit/028-memory-search-intelligence/002-speckit-memory/037-envelope-fidelity-enforcement"
...
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../036-lexical-grounding-floor/spec.md |
| **Successor** | ../038-scoring-hardening/spec.md |
<!-- /ANCHOR:metadata -->

...
_memory:
  continuity:
    packet_pointer: "system-speckit/028-memory-search-intelligence/002-speckit-memory/022-iterative-agentic-recall"
...
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../021-summary-fusion-grounding/spec.md |
| **Successor** | ../023-semantic-edge-layer/spec.md |
<!-- /ANCHOR:metadata -->
...
- **Sibling (distinct)**: `CG-iterative-context-extension` (top-7 #2) lands in `../../002-skill-advisor`/routing context, not here

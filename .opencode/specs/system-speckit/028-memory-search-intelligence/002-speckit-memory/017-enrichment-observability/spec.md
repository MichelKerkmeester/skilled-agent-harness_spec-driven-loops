...
_memory:
  continuity:
    packet_pointer: "system-speckit/028-memory-search-intelligence/002-speckit-memory/017-enrichment-observability"
...
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../016-orphan-sweep-scoped-scan-safety/spec.md |
| **Successor** | ../018-drift-marker-pipeline-resilience/spec.md |
<!-- /ANCHOR:metadata -->

...
```json
{
  ...
  "evidenceRefs": [
    ".opencode/specs/system-speckit/028-memory-search-intelligence/003-spec-data-quality/001-on-write-quality/001-extend-quality-loop-authored/plan.md:104",
    ".opencode/skills/system-spec-kit/scripts/core/workflow.ts:1854",
    ".opencode/specs/system-speckit/028-memory-search-intelligence/003-spec-data-quality/001-on-write-quality/001-extend-quality-loop-authored/tasks.md:66"
  ],

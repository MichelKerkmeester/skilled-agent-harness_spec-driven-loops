...
- [ ] T007 Write the report with the pre-stated threshold, the per-setting prod-column deltas and the one signal-or-noise verdict (`.opencode/specs/system-speckit/028-memory-search-intelligence/003-spec-data-quality/005-shared-engine-and-research/027-retrieval-floor-experiment/floor-experiment-report.md`)
<!-- /ANCHOR:phase-2 -->

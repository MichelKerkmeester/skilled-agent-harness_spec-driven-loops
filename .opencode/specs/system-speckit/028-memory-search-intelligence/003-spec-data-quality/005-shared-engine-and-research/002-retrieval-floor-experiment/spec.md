...
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../001-shared-safe-fix-engine/spec.md |
| **Successor** | ../003-governance-rollout/spec.md |
<!-- /ANCHOR:metadata -->
...
| `.opencode/specs/system-speckit/028-memory-search-intelligence/002-spec-data-quality/005-shared-engine-and-research/027-retrieval-floor-experiment/floor-experiment-report.md` | Create | The measured per-setting recall deltas and the one signal-or-noise verdict |
<!-- /ANCHOR:scope -->

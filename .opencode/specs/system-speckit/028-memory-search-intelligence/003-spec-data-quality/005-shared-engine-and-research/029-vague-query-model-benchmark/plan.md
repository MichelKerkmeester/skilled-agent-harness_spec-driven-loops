...
- Same-class producers: `rg -n 'opencode run --command' .opencode/specs/system-speckit/028-memory-search-intelligence/003-spec-data-quality/005-shared-engine-and-research/029-vague-query-model-benchmark/scripts`.

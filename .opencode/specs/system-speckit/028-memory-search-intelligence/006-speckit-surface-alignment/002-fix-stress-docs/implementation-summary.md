...
| `.opencode/specs/system-speckit/028-memory-search-intelligence/006-speckit-surface-alignment/002-fix-stress-docs/` | Created | Captured spec, plan, tasks, and implementation summary. |
<!-- /ANCHOR:what-built -->

...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-speckit/028-memory-search-intelligence/006-speckit-surface-alignment/005-manual-test-verification-and-fixes/spec.md"
      - ".opencode/specs/system-speckit/028-memory-search-intelligence/006-speckit-surface-alignment/005-manual-test-verification-and-fixes/implementation-summary.md"
      - ".opencode/specs/system-speckit/028-memory-search-intelligence/006-speckit-surface-alignment/005-manual-test-verification-and-fixes/decision-record.md"
    session_dedup:

...
- [x] T001 Scaffold spec folder `031-vitest-invariance-maintenance` (Level 2, `--track system-speckit --skip-branch`)
...
- [ ] T014 `bash validate.sh 031-vitest-invariance-maintenance --strict` clean; write `implementation-summary.md`
<!-- /ANCHOR:phase-3 -->

...
✗ Run skill advisor (shell)
  ...
  │ against .opencode/skills/system-spec-kit/mcp_server code and child spec.md audit findings, check
...
● Search (grep)
  │ "AUDIT FINDINGS|MISMATCH|F11|F15|F21|F23" in **/spec.md (.opencode/skills/system-spec-kit)
  └ No matches found

● Search (glob)
  │ "**/spec.md" in .opencode/skills/system-spec-kit
  └ 87 files found
...
● List directory .opencode/skills/system-spec-kit/feature_catalog
  └ 24 files found
...
● Search (glob)
  │ "**/*.md" in .opencode/skills/system-spec-kit/feature_catalog
  └ 5 files found
...
● Explore Mapping catalog refs
  ...
  │   │ Env/Public/.opencode/skills/system-spec-kit/feature_catalog/0* | head -5
  │   └ 6 lines...
  └ List first 5 of remaining category folders (shell)
      │ ls -d /Users/michelkerkmeester/MEGA/Development/Opencode\
      │ Env/Public/.opencode/skills/system-spec-kit/feature_catalog/1* | head -5
      └ 6 lines...

● List directory .opencode/skills/system-spec-kit/feature_catalog/16--tooling-and-scripts
  └ 18 files found
...
● List directory .opencode/skills/system-spec-kit/feature_catalog/11--scoring-and-calibration
  └ 22 files found

● List directory .opencode/skills/system-spec-kit/feature_catalog/13--memory-quality-and-indexing
  └ 24 files found
...
● Read adaptive-ranking.ts
  │ .opencode/skills/system-spec-kit/mcp_server/lib/cognitive/adaptive-ranking.ts
  └ L1:260 (260 lines read)

● Search (grep)
  │ "adaptive-ranking|adaptive ranking|SPECKIT_MEMORY_ADAPTIVE_RANKING|shadow proposal|proposal
  │ delta" in **/*.{ts,md} (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found
...
● Search (grep)
  ...
  │ KIT_CALIBRATION_PROFILE_NAME" in **/*.{ts,md} (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found
...
● Search (grep)
  ...
  │ sal" in **/*.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 124 lines found
...
● Search (grep)
  │ "Feature catalog:" (.opencode/skills/system-spec-kit/mcp_server/handlers/index.ts)
  └ 1 line found

● Search (grep)
  │ "Feature catalog:" (.opencode/skills/system-spec-kit/shared/trigger-extractor.ts)
  └ 1 line found

● Search (grep)
  │ "MODULE:" (.opencode/skills/system-spec-kit/scripts/utils/workspace-identity.ts)
  └ 1 line found
...
● Search (grep)
  │ "applyCalibrationProfile\(" in **/*.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 39 lines found

● Search (grep)
  │ "getCalibrationProfile\(" in **/*.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ No matches found

● Search (grep)
  │ "shouldActivateLouvain\(" in **/*.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 106 lines found

● Search (grep)
  │ "runAblation\(" in **/*.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found
...
● Search (grep)
  │ "adaptive|shadow" (.opencode/skills/system-spec-kit/mcp_server/handlers/checkpoints.ts)
  └ 5 lines found

● Search (grep)
  │ "adaptive|shadow" (.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts)
  └ 18 lines found

● Search (grep)
  │ "adaptive|shadow" in **/*.ts (.opencode/skills/system-spec-kit/mcp_server/handlers)
  └ 48 lines found
...
● Search (grep)
  │ "Feature catalog:" (.opencode/skills/system-spec-kit/mcp_server/lib/search/graph-calibration.ts)
  └ 2 lines found
...
● Search (grep)
  │ "Feature catalog:|MODULE:|feature catalog" (.opencode/skills/system-spec-kit/README.md)
  └ 5 lines found

● Search (grep)
  │ "Feature catalog:" (.opencode/skills/system-spec-kit/scripts/utils/workspace-identity.ts)
  └ No matches found
...
● Search (grep)
  │ "MODULE:|header" (.opencode/skills/sk-code-opencode/scripts/verify_alignment_drift.py)
  └ 21 lines found
...
● Search (grep)
  ...
  │ s" in **/*.md (.opencode/skills/system-spec-kit/feature_catalog)
  └ 5 lines found
...
● Search (grep)
  ...
  │ thresholds" in **/*.md (.opencode/skills/system-spec-kit/feature_catalog)
  └ 71 lines found
...
● Search (grep)
  ...
  │ ts|reconsolidation-bridge\.ts" in **/*.md (.opencode/skills/system-spec-kit/feature_catalog)
  └ 5 lines found

● Search (glob)
  │ "**/history.ts" in .opencode/skills/system-spec-kit/mcp_server
  └ 1 file found

● Search (glob)
  │ "**/session-manager.ts" in .opencode/skills/system-spec-kit/mcp_server
  └ 1 file found

● Search (glob)
  │ "**/*workspace-identity.ts" in .opencode/skills/system-spec-kit
  └ 1 file found
...
● Search (grep)
  │ "history\.ts" in **/*.md (.opencode/skills/system-spec-kit/feature_catalog)
  └ 39 lines found

● Search (grep)
  │ "session-manager\.ts" in **/*.md (.opencode/skills/system-spec-kit/feature_catalog)
  └ 53 lines found
...
● Search (grep)
  │ "Feature catalog:" in **/*.ts (.opencode/skills/system-spec-kit/scripts)
  └ No matches found
...
● Search (grep)
  ...
  │ sent_at ASC" (.opencode/skills/system-spec-kit/mcp_server/lib/session/session-manager.ts)
  └ 67 lines found

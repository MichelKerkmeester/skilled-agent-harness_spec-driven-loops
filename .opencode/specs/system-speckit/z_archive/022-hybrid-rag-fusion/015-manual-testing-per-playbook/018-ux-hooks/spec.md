---
title: "Feature Specification [system-spec-kit/022-hybrid-rag-fusion/015-manual-testing-per-playbook/018-ux-hooks/spec]"
...
| 106 | Hooks barrel + README synchronization | [`../../feature_catalog/18--ux-hooks/12-hooks-readme-and-export-alignment.md`](../../feature_catalog/18--ux-hooks/12-hooks-readme-and-export-alignment.md) | `Validate hook barrel and README coverage for the finalized UX-hook surface.` | `1) rg "mutation-feedback\|response-hints" .opencode/skills/system-spec-kit/mcp_server/hooks/index.ts 2) rg "mutation-feedback\|response-hints\|MutationHookResult\|postMutationHooks" .opencode/skills/system-spec-kit/mcp_server/hooks/README.md` |

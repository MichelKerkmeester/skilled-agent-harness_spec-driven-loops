---
title: "Implementation Plan [system-spec-kit/022-hybrid-rag-fusion/015-manual-testing-per-playbook/003-discovery/plan]"
...
- [ ] Playbook context file read: `.opencode/skills/system-spec-kit/manual_testing_playbook/MANUAL_TESTING_PLAYBOOK.md` §03--discovery
...
- **Playbook context**: `.opencode/skills/system-spec-kit/manual_testing_playbook/MANUAL_TESTING_PLAYBOOK.md` — source of truth for prompts and pass criteria
...
### Phase 1: Setup
- [ ] Read `.opencode/skills/system-spec-kit/manual_testing_playbook/MANUAL_TESTING_PLAYBOOK.md` section 03--discovery for all three scenario definitions
...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/MANUAL_TESTING_PLAYBOOK.md` | Internal | Available | Cannot confirm pass criteria without it |
<!-- /ANCHOR:dependencies -->

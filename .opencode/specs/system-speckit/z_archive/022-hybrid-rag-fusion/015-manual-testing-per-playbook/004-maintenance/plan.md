...
- [ ] Playbook context file read: `.opencode/skills/system-spec-kit/manual_testing_playbook/MANUAL_TESTING_PLAYBOOK.md` §04--maintenance
...
### Phase 1: Setup
- [ ] Read `.opencode/skills/system-spec-kit/manual_testing_playbook/MANUAL_TESTING_PLAYBOOK.md` section 04--maintenance for both scenario definitions

---
title: "Implementation Plan: 008-hydra-db-based-fea [system-spec-kit/022-hybrid-rag-fusion/008-hydra-db-based-features/plan]"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/z_archive/022-hybrid-rag-fusion/008-hydra-db-based-features"
...
- **Operator docs**: `.opencode/skills/system-spec-kit/mcp_server/INSTALL_GUIDE.md` and `.opencode/skills/system-spec-kit/manual_testing_playbook/MANUAL_TESTING_PLAYBOOK.md`

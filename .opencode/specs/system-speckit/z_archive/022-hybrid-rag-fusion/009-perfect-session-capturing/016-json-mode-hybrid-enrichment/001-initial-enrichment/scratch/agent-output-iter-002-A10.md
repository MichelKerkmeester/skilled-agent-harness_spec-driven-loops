...
[SOURCE: .opencode/skills/system-spec-kit/scripts/core/workflow.ts:39,1205-1216]
[SOURCE: .opencode/skills/system-spec-kit/scripts/core/quality-scorer.ts:124-127]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/core/workflow.ts:1205-1215]
...
[SOURCE: .opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts:86-233]
[SOURCE: .opencode/skills/system-spec-kit/mcp_server/context-server.ts:951-966]
...
[SOURCE: .opencode/skills/system-spec-kit/mcp_server/handlers/save/embedding-pipeline.ts:116-184]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts:621-703]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts:71-98, 621-703]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts:634-639]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts:663-669, 602-606]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts:686-690]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/tests/quality-scorer-calibration.vitest.ts:5]
[SOURCE: .opencode/skills/system-spec-kit/scripts/tests/test-memory-quality-lane.js:11]

## Sources Consulted
- `.opencode/skills/system-spec-kit/scripts/core/workflow.ts` lines 39, 1205-1216 (scorer import chain)
- `.opencode/skills/system-spec-kit/scripts/core/quality-scorer.ts` line 124 (deprecation comment)
- `.opencode/skills/system-spec-kit/mcp_server/lib/providers/retry-manager.ts` lines 1-240 (full retry infrastructure)
- `.opencode/skills/system-spec-kit/mcp_server/context-server.ts` lines 83-84, 951-966 (retry bootstrap)
- `.opencode/skills/system-spec-kit/mcp_server/handlers/save/embedding-pipeline.ts` lines 116-184 (async embedding path)
- `.opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts` lines 71-703 (validation + normalization)
- `.opencode/skills/system-spec-kit/scripts/tests/quality-scorer-calibration.vitest.ts` line 5 (wrong import)
- `.opencode/skills/system-spec-kit/scripts/tests/test-memory-quality-lane.js` line 11 (correct import)

...
● Search (glob)
  │ "**/test*/**/*parity*" in .opencode/skills/system-spec-kit
  └ 1 file found

● Search (glob)
  │ "**/test*/**/*cross-cli*" in .opencode/skills/system-spec-kit
  └ No matches found

● Search (glob)
  │ "**/test*/**/*multi-cli*" in .opencode/skills/system-spec-kit
  └ No matches found
...
● Search (grep)
  ...
  │ -capture|DataSource" (.opencode/skills/system-spec-kit/scripts/extractors/opencode-capture.ts)
  └ No matches found

● Search (grep)
  │ "claude|codex|copilot|gemini|sourceCapabilities|getSourceCapabilities|DataSource|normalize|captu
  │ re" (.opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts)
  └ 67 lines found
...
● Search (grep)
  ...
  │ ross-CLI|cross cli|source-capabilities" (.opencode/skills/system-spec-kit/scripts/tests)
  └ 76 lines found

● Search (grep)
  │ "claude-code-capture|codex-cli-capture|copilot-cli-capture|gemini-cli-capture|opencode-capture"
  │ in **/*.ts (.opencode/skills/system-spec-kit/scripts)
  └ 5 lines found
...
● Search (grep)
  │ "describe\(|it\(" (.opencode/skills/system-spec-kit/scripts/tests/claude-code-capture.vitest.ts)
  └ 1 file found

● Search (grep)
  │ "describe\(|it\(" (.opencode/skills/system-spec-kit/scripts/tests/codex-cli-capture.vitest.ts)
  └ 1 file found

● Search (grep)
  │ "describe\(|it\(" (.opencode/skills/system-spec-kit/scripts/tests/copilot-cli-capture.vitest.ts)
  └ 1 file found

● Search (grep)
  │ "describe\(|it\(" (.opencode/skills/system-spec-kit/scripts/tests/gemini-cli-capture.vitest.ts)
  └ 1 file found
...
● Search (grep)
  │ "describe\(|it\(" (.opencode/skills/system-spec-kit/scripts/tests/phase-classification.vitest.ts)
  └ 1 file found
...
✗ Count tests per target file (shell)
  ...
  │ Env/Public/.opencode/skills/system-spec-kit/scripts/tests' && for f in
...
● Search (grep)
  │ "^\s*(it|test)\(" in codex-cli-capture.vitest.ts (.opencode/skills/system-spec-kit/scripts/tests)
  └ 1 file found
...
● Search (grep)
  ...
  │ captureConversation" (.opencode/skills/system-spec-kit/scripts/loaders/data-loader.ts)
  └ 18 lines found
...
● Search (grep)
  │ "^\s*(it|test)\(" in opencode-capture.vitest.ts (.opencode/skills/system-spec-kit/scripts/tests)
  └ 1 file found
...
● Search (grep)
  ...
  │ Mode" (.opencode/skills/system-spec-kit/scripts/memory/validate-memory-quality.ts)
  └ 19 lines found
...
● Search (grep)
  ...
  │ capture" (.opencode/skills/system-spec-kit/scripts/utils/source-capabilities.ts)
  └ 16 lines found

● Search (grep)
  │ "buildClaudeSessionHints|ClaudeSessionHints|sessionHints|expectedSessionId|CLAUDE_CODE_SESSION|C
  │ LAUDE_CODE_ENTRYPOINT" (.opencode/skills/system-spec-kit/scripts/loaders/data-loader.ts)
  └ 12 lines found

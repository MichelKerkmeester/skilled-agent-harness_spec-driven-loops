...
_memory:
  continuity:
    packet_pointer: "system-speckit/z_archive/022-hybrid-rag-fusion/009-perfect-session-capturing/012-auto-detection-fixes"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 012-auto-detection-fixes |

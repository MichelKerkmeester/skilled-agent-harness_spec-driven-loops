---
title: "Feature Specific [system-spec-kit/022-hybrid-rag-fusion/009-perfect-session-capturing/007-phase-classification/spec]"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/z_archive/022-hybrid-rag-fusion/009-perfect-session-capturing/007-phase-classification"
...
| `.opencode/skills/system-spec-kit/templates/context_template.md` | Modify | Update conversation summary wording for phase segments and unique phase count |
...
| Risk | Broader shared module suites can evolve independently of phase-classification logic | Low | Use current reruns as closure evidence and treat unrelated suite movement separately from this phase's contract |
<!-- /ANCHOR:risks -->

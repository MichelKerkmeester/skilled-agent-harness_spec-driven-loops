...
[SOURCE: .opencode/skills/system-spec-kit/scripts/spec/validate.sh:406-463]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/rules/ -- all 20 check-*.sh files listed via ls]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/rules/check-template-headers.sh:50-68]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/spec/progressive-validate.sh:103-108, 296-401]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/spec/quality-audit.sh:63-77, 119-152]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/rules/check-spec-doc-integrity.sh:58-135]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/spec/validate.sh:14-18, 144-159]
...
## Sources Consulted
- `.opencode/skills/system-spec-kit/scripts/spec/validate.sh` (full file, 640 lines)
- `.opencode/skills/system-spec-kit/scripts/spec/progressive-validate.sh` (full file, 745 lines)
- `.opencode/skills/system-spec-kit/scripts/spec/quality-audit.sh` (full file, 197 lines)
- `.opencode/skills/system-spec-kit/scripts/rules/check-template-headers.sh` (full file, 129 lines)
- `.opencode/skills/system-spec-kit/scripts/rules/check-spec-doc-integrity.sh` (full file, 140 lines)
- `.opencode/skills/system-spec-kit/scripts/rules/` directory listing (20 rule scripts)

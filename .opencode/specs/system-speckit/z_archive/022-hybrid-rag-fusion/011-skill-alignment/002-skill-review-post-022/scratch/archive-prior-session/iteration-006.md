...
- **Severity**: P1
- **Dimension**: maintainability
- **File**: `.opencode/skills/system-spec-kit/references/workflows/quick_reference.md:231`
...
- **Severity**: P1
- **Dimension**: maintainability
- **File**: `.opencode/skills/system-spec-kit/references/workflows/quick_reference.md:481`
...
- **Severity**: P1
- **Dimension**: maintainability
- **File**: `.opencode/skills/system-spec-kit/references/workflows/execution_methods.md:118`
...
- **Severity**: P2
- **Dimension**: maintainability
- **File**: `.opencode/skills/system-spec-kit/references/workflows/worked_examples.md:153`

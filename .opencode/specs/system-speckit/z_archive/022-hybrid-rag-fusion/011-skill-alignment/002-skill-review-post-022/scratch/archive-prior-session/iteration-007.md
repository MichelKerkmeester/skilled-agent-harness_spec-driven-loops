...
- **File**: `.opencode/skills/system-spec-kit/templates/addendum/phase/phase-child-header.md:22`
...
- **Severity**: P1
- **Dimension**: traceability
- **File**: `.opencode/skills/system-spec-kit/templates/addendum/phase/phase-parent-section.md:23`
...
- **File**: `.opencode/skills/system-spec-kit/templates/core/spec-core.md:25`
...
- **Severity**: P1
- **Dimension**: traceability
- **File**: `.opencode/skills/system-spec-kit/assets/template_mapping.md:130`
...
- **Severity**: P1
- **Dimension**: maintainability
- **File**: `.opencode/skills/system-spec-kit/assets/complexity_decision_matrix.md:40`
...
- **Severity**: P1
- **Dimension**: maintainability
- **File**: `.opencode/skills/system-spec-kit/references/template-compliance-contract.md:36`
...
- **Severity**: P2
- **Dimension**: maintainability
- **File**: `.opencode/skills/system-spec-kit/assets/parallel_dispatch_config.md:56`

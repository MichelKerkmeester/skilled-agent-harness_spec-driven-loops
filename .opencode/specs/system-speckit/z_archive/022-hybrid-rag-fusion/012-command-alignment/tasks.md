---
title: "Tasks: Command Alignment [system-spec-kit/022-hybrid-rag-fusion/012-command-alignment/tasks]"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/z_archive/022-hybrid-rag-fusion/012-command-alignment"
...
- **Priority:** P0
- **File:** `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/012-command-alignment/plan.md`
...
- **Priority:** P0
- **File:** `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/012-command-alignment/tasks.md`

...
● Explore Survey workflow automation
  ...
  │   │ Env/Public/.opencode/skills/system-spec-kit/mcp_server/handlers/memory-ingest.ts" | head -30
  │   └ 1 line...
...
● Search (grep)
  ...
  │ ob" (.opencode/skills/system-spec-kit/mcp_server/lib/ops/job-queue.ts)
  └ 5 lines found
...
● Count target file lines (shell)
  ...
  │ '/Users/michelkerkmeester/MEGA/Development/Opencode
  │ Env/Public/.opencode/skills/system-spec-kit/scripts/memory/generate-context.ts' \…
  └ 28 lines...
...
● Search (grep)
  ...
  │ (.opencode/skills/system-spec-kit/scripts/spec-folder/directory-setup.ts)
  └ 32 lines found
...
● Search (grep)
  ...
  │ t|ancestor|recursive" (.opencode/skills/system-spec-kit/scripts/spec-folder/folder-detector.ts)
  └ 112 lines found
...
● Search (grep)
  ...
  │ folder|specs/|generate-context|rebuild|retry|Step" (.opencode/skills/system-spec-kit/SKILL.md)
  └ 5 lines found
...
● Search (grep)
  ...
  │ rebuild\"" (.opencode/skills/system-spec-kit/scripts/core/workflow.ts)
  └ 112 lines found
...
● Search (grep)
  ...
  │ tadataEmbeddingStatus" in **/*.{ts,md} (.opencode/skills/system-spec-kit)
  └ 5 lines found

● Search (grep)
  │ "getWatcherMetrics\(" in **/*.ts (.opencode/skills/system-spec-kit)
  └ 44 lines found

● Search (grep)
  │ "ensureIndexFresh\(" in **/*.ts (.opencode/skills/system-spec-kit)
  └ 11 lines found

● Search (grep)
  │ "getIndexStats\(" in **/*.ts (.opencode/skills/system-spec-kit)
  └ 17 lines found

● Search (grep)
  │ "updateMetadataEmbeddingStatus" in **/*.ts (.opencode/skills/system-spec-kit)
  └ 41 lines found

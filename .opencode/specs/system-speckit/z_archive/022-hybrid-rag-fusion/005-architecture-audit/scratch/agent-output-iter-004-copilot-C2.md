...
● Search (glob)
  │ ".opencode/skills/system-spec-kit/mcp_server/lib/storage/*.ts"
  └ 13 files found
...
● Search (glob)
  │ ".opencode/skills/system-spec-kit/mcp_server/lib/eval/**/*.ts"
  └ 16 files found
...
● Explore Map storage audit surfaces
  ...
  └ Get function signatures from lineage-state (shell)
      ...
      │ Env/Public/.opencode/skills/system-spec-kit/mcp_server/lib/storage/lineage-state.ts" | head
      -40
      └ 36 lines...
...
● Explore Map vector and eval audit surfaces
  ...
  └ Find interference score refresh function (shell)
      ...
      │ .opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-store.ts | head -5
      └ 2 lines...
...
● Search (grep)
  ...
  │ ity" in *.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 17 lines found
...
● Search (grep)
  ...
  │ in *.ts (.opencode/skills/system-spec-kit/mcp_server/lib/eval)
  └ No matches found
...
● Search (grep)
  ...
  │ eval_run_id, channel" in *.ts (.opencode/skills/system-spec-kit/mcp_server/lib)
  └ 7 lines found

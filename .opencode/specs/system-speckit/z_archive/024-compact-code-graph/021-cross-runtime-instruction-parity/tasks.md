...
_memory:
  continuity:
    packet_pointer: "system-speckit/z_archive/024-compact-code-graph/021-cross-runtime-instruction-parity"
...
- [x] @context-prime agent created — .opencode/agents/context.md (227 lines) with `session_resume()` plus optional `session_health()`
...
- [x] F059: Orchestrator delegation to @context-prime verified — `.opencode/agents/orchestrate.md` lines 18-21 delegate on first turn or after `/clear`

...
- [ ] T016 Re-run `validate.sh <phase> --strict`; confirm no `mcp_server/` dist was rebuilt and update the spec/plan/tasks/changelog references (.opencode/specs/system-speckit/031-spec-gate-enforce-readiness/004-headless-enforce-scoping)
<!-- /ANCHOR:phase-3 -->

...
trigger_phrases:
  - "031-spec-gate-enforce-readiness"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/031-spec-gate-enforce-readiness"
...
| **Parent Spec** | `../spec.md` |
| **Parent Packet** | `system-speckit/031-spec-gate-enforce-readiness` |

...
| 005-T006 | `context-index.md` | Marked the "027→028 Split" section as a historical record; rewrote dangling present-tense pointer to `028-code-graph-and-cocoindex` (nonexistent) into past-tense with real fate (track-028 is `029-memory-search-intelligence`) |

...
_memory:
  continuity:
    packet_pointer: "system-speckit/028-xce-research-based-refinement/004-shared-infrastructure/004-cli-tooling-ux/001-cli-freshness-and-smoke"
...
| `manual_testing_playbook/tooling-and-scripts/cli-list-tools-parity.md` (`:16-20`, `:32-56`) | Modify | Point the parity scenario at the unified smoke check |
<!-- /ANCHOR:scope -->

---
title: "Feature Specification: Speckit Commands - Inventory and Extract"
...
trigger_phrases:
  - "002-speckit-commands 001-inventory-extract"
  - "speckit commands inventory and extract"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/028-xce-research-based-refinement/004-shared-infrastructure/002-command-presentation-workflow-separation/002-speckit-commands/001-inventory-extract"
    last_updated_at: "2026-06-10T19:51:18Z"
    last_updated_by: "gpt-5.5-fast"
    recent_action: "Inventoried speckit command routers, workflow YAML references, and inline presentation contracts"
    next_safe_action: "Use the extraction map in implementation-summary.md when auditing future presentation changes"
    blockers: []
    key_files:
      - "spec.md"
      - "plan.md"
    ...
    session_dedup:
      ...
      session_id: "2026-06-10-002-speckit-commands-001-inventory-extract-scaffold"
...
---
# Feature Specification: Speckit Commands - Inventory and Extract
...
### Problem Statement
Speckit Commands needs a scoped inventory and extract phase so presentation extraction can proceed without mixing implementation, routing, and display-contract decisions.

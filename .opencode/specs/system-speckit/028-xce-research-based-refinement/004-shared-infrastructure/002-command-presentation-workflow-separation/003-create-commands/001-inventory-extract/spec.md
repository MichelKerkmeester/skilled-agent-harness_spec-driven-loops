---
title: "Feature Specification: Create Commands - Inventory and Extract"
...
trigger_phrases:
  - "003-create-commands 001-inventory-extract"
  - "create commands inventory and extract"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/028-xce-research-based-refinement/004-shared-infrastructure/002-command-presentation-workflow-separation/003-create-commands/001-inventory-extract"
    last_updated_at: "2026-06-10T19:45:00Z"
    last_updated_by: "gpt-5.5-fast"
    recent_action: "Inventoried create command routers and workflow YAML assets; extracted display-contract targets"
    next_safe_action: "Use presentation assets as the display-contract source for future command updates"
    blockers: []
    key_files:
      - "spec.md"
      - "plan.md"
    ...
    session_dedup:
      ...
      session_id: "2026-06-10-003-create-commands-001-inventory-extract-scaffold"
...
---
# Feature Specification: Create Commands - Inventory and Extract
...
### Problem Statement
Create Commands needs a scoped inventory and extract phase so presentation extraction can proceed without mixing implementation, routing, and display-contract decisions.

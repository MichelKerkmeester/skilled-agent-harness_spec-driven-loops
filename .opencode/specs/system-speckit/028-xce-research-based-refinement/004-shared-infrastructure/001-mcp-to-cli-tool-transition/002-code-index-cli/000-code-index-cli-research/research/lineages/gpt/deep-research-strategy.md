...
- Code Graph was unavailable at session startup, which matches the packet's motivating incident class. [SOURCE: file:.opencode/specs/system-spec-kit/027-xce-research-based-refinement/004-shared-infrastructure/001-mcp-to-cli-tool-transition/002-code-index-cli/000-code-index-cli-research/spec.md:52]
...
| Full MCP-reference migration now | Parent packet keeps full migration out of scope until dual-stack proves itself. | [SOURCE: file:.opencode/specs/system-spec-kit/027-xce-research-based-refinement/004-shared-infrastructure/001-mcp-to-cli-tool-transition/spec.md:111] |

...
**Raw analysis:** `research/prompts/iteration-074.out`
...
[F-074-06] No nested `002-coco` edit is required in the 027 parent or `001-aggregator/graph-metadata.json`: 027 lists only `008` as the child phase, and `001` has no downstream/manual edge. `028-xce-research-based-refinement/graph-metadata.json:6-16`, `028-xce-research-based-refinement/description.json:27-36`, `028-xce-research-based-refinement/context-index.md:35-40`, `001-aggregator/graph-metadata.json:6-13`
...
| `005-env-tests-integration/spec.md:38,147-150` | Remove `002` dependency and related-doc link. | remove dependency/link |
| `027 parent graph/description/context-index` | No nested `002-coco` reference found. | no edit |

### RENUMBER_DECISION

Keep numbering with the `002` gap.

Renumbering `003/004/005 -> 002/003/004` is not forced for validator or graph traversal if `children_ids`, `manual.children`, and dependency edges are updated to existing folders. Closing the gap would create a large rename cascade across packet IDs, spec folders, `packet_pointer`, validation commands, child metadata, related-doc links, and research citations. If renumbering is chosen anyway, it must be done as `git mv`, not delete/recreate. `.opencode/skills/system-spec-kit/constitutional/spec-folder-naming.md:31-33`

### VERDICT

008 structural = remove deleted `002-coco` from 008 parent `description.json` + `graph-metadata.json`, remove coco-only soft dep, rewrite 008 phase map/execution/counts to `001 -> {003,004} -> 005`, remove `002` from `005` manual dependencies and closeout dependency prose, regenerate stale derived metadata. Recommendation: keep `003/004/005` numbered as-is with a gap.

### RULED_OUT

- No 027 parent `graph-metadata.json`, `description.json`, or `context-index.md` nested `002-coco` edit.
- No `001-aggregator/graph-metadata.json` downstream edge to remove.
- No `005-env-tests-integration/graph-metadata.json` manual dependency/child edge to remove; only stale derived strings.
...
status: complete  
sources: `005-learning-feedback-reducers/description.json:23-34`, `005-learning-feedback-reducers/graph-metadata.json:6-12`, `005-learning-feedback-reducers/spec.md:47-94`, `005-env-tests-integration/description.json:17-23`, `005-env-tests-integration/graph-metadata.json:6-13`, `005-env-tests-integration/spec.md:38-150`, `001-aggregator/graph-metadata.json:6-13`, `028-xce-research-based-refinement/graph-metadata.json:6-16`, `028-xce-research-based-refinement/description.json:27-36`, `028-xce-research-based-refinement/context-index.md:35-40`, `.opencode/skills/system-spec-kit/constitutional/spec-folder-naming.md:31-33`

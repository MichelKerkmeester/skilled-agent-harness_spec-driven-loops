...
Fields are taken from the Zod schema at `lib/graph/graph-metadata-schema.ts:34-71` and from 3 real files: `028-xce-research-based-refinement/graph-metadata.json`, `027-graph-and-context-optimization/graph-metadata.json`, and `028-code-graph-and-cocoindex/001-code-graph-hld-lld/graph-metadata.json`.

...
The 012 packet (spec at `027-graph-and-context-optimization/003-memory-and-causal-runtime/002-causal-graph-channel-routing/001-deliver-causal-graph-channel-routing-mvp/`) was **purely additive** at the handler level. The changelog at `001-deliver-causal-graph-channel-routing-mvp/changelog.md` (section "Fixed") states: "No fixes recorded — this packet is purely additive."

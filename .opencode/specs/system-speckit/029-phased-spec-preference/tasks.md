...
- [x] T001 Scaffold spec folder `029-phased-spec-preference` (Level 2, `--track system-speckit --skip-branch`)
...
- [x] T010 `bash validate.sh 029-phased-spec-preference --strict` clean - [evidence: `validate.sh` output "Summary: Errors: 0  Warnings: 0 / RESULT: PASSED"]
<!-- /ANCHOR:phase-3 -->

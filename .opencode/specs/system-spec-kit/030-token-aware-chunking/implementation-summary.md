...
trigger_phrases:
  - "030 token-aware chunking summary"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 030-token-aware-chunking |
...
| `.opencode/specs/system-spec-kit/030-token-aware-chunking/` | Created | Track this implementation packet. |
<!-- /ANCHOR:what-built -->
...
| `validate.sh --strict` on 030 | PASS after compacting `next_safe_action`. |
<!-- /ANCHOR:verification -->

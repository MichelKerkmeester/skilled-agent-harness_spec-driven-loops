...
- [x] Gate 3 was pre-answered for `.opencode/specs/system-spec-kit/030-token-aware-chunking`.
...
- [x] Run strict validation on the 030 packet.
<!-- /ANCHOR:phases -->
...
| Spec validation | 030 packet docs and metadata | `validate.sh --strict` |
<!-- /ANCHOR:testing -->
...
- **Procedure**: Revert the 030 commit to restore fixed 512 context creation and remove the new token-budget test file and packet folder.
<!-- /ANCHOR:rollback -->

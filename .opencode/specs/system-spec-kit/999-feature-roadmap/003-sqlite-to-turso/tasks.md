---
title: "Tasks: SQLite-to-Turso Migration Research [system-spec-kit/999-sqlite-to-turso/tasks]"
...
- [x] T001 Review the assigned spec root contents (`.opencode/specs/system-spec-kit/999-sqlite-to-turso`)

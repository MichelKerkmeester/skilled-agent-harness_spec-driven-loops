---
title: "Feature Specification: SQLite-to-Turso Migration Research [system-spec-kit/999-sqlite-to-turso/spec]"
...
|-----------|-------------|-------------|
| `.opencode/specs/system-spec-kit/999-sqlite-to-turso/spec.md` | Modify | Align with Level 1 template structure and anchors. |
| `.opencode/specs/system-spec-kit/999-sqlite-to-turso/plan.md` | Create | Add implementation planning document required by the validator. |
| `.opencode/specs/system-spec-kit/999-sqlite-to-turso/tasks.md` | Create | Add task breakdown document required by the validator. |
<!-- /ANCHOR:scope -->

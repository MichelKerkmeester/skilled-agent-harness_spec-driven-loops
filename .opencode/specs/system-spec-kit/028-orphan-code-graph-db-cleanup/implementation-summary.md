...
trigger_phrases:
  - "028 orphan code graph db cleanup summary"
...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/system-spec-kit/028-orphan-code-graph-db-cleanup/spec.md"
    session_dedup:
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 028-orphan-code-graph-db-cleanup |
...
| `.opencode/specs/system-spec-kit/028-orphan-code-graph-db-cleanup/` | Created | Document this cleanup and verification. |
<!-- /ANCHOR:what-built -->
...
| `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/028-orphan-code-graph-db-cleanup --strict` | PASS, exit 0. |
<!-- /ANCHOR:verification -->

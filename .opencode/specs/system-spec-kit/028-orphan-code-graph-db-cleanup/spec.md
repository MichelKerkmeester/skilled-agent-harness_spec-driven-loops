...
trigger_phrases:
  - "028 orphan code graph db cleanup"
...
_memory:
  continuity:
    packet_pointer: ".opencode/specs/system-spec-kit/028-orphan-code-graph-db-cleanup"
    ...
    session_dedup:
      ...
      session_id: "2026-05-14-028-orphan-code-graph-db-cleanup"
...
| `.opencode/specs/system-spec-kit/028-orphan-code-graph-db-cleanup/` | Create | Track this cleanup packet and verification evidence. |
<!-- /ANCHOR:scope -->
...
| REQ-006 | Packet docs validate | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/028-orphan-code-graph-db-cleanup --strict` exits 0. |
<!-- /ANCHOR:requirements -->

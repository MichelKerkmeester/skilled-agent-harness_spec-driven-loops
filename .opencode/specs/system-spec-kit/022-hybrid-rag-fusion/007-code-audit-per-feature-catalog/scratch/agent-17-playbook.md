...
- Updated `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/manual_testing_playbook/MANUAL_TESTING_PLAYBOOK.md` only where audit findings showed drift.
- Updated `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/manual_testing_playbook/review_protocol.md` so the coverage command matches the canonical underscore path and current scenario set.

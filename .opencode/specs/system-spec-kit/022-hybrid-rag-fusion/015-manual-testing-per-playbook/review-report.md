...
```json
{
  ...
  "specSeed": "specs/system-spec-kit/022-hybrid-rag-fusion/015-manual-testing-per-playbook",
...
- Create new spec folder for playbook scenario creation: `specs/system-spec-kit/022-hybrid-rag-fusion/023-playbook-coverage-remediation/`
...
- `specs/system-spec-kit/022-hybrid-rag-fusion/015-manual-testing-per-playbook/` — 22 spec phases + root docs

---
title: "Tasks: State [system-spec-kit/022-hybrid-rag-fusion/009-perfect-session-capturing/014-stateless-quality-gates/tasks]"
...
- **Predecessor**: `../013-spec-descriptions/tasks.md`
<!-- /ANCHOR:cross-refs -->

...
- **P2** `33-36`: spec-folder parsing assumes a flat `NNN-name` slug. When `specFolderName` is a nested relative path like `system-spec-kit/013-foo`, category/path noise leaks straight into topic extraction.

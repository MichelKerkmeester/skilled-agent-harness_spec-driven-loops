...
- **Severity**: HIGH
- **Category**: alignment
- **Location**: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/007-code-audit-per-feature-catalog/016-tooling-and-scripts/spec.md` vs `007-code-audit-per-feature-catalog/spec.md`
...
- **Severity**: MEDIUM
- **Category**: completeness
- **Location**: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/007-code-audit-per-feature-catalog/021-remediation-revalidation/`
...
- **Severity**: HIGH
- **Category**: alignment
- **Location**: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/006-feature-catalog/tasks.md` (T100)
...
- **Severity**: MEDIUM
- **Category**: alignment
- **Location**: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/006-feature-catalog/tasks.md` (T102)
...
- **Severity**: MEDIUM
- **Category**: alignment
- **Location**: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/006-feature-catalog/tasks.md` (T101)
...
- **Severity**: LOW
- **Category**: alignment
- **Location**: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/006-feature-catalog/spec.md` (Normalization Addendum)
...
- **Severity**: HIGH
- **Category**: completeness
- **Location**: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/006-feature-catalog/tasks.md` (Phase F section)
...
- **Severity**: MEDIUM
- **Category**: alignment
- **Location**: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/007-code-audit-per-feature-catalog/019-decisions-and-deferrals/` and `020-feature-flag-reference/`
...
- **Severity**: MEDIUM
- **Category**: alignment
- **Location**: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/006-feature-catalog/spec.md` (Current-State Addendum)
...
- **Severity**: LOW
- **Category**: completeness
- **Location**: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/006-feature-catalog/plan.md` (Phase C findings)

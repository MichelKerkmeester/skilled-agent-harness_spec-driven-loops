...
- **Severity**: MEDIUM
- **Category**: alignment
- **Location**: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/005-architecture-audit/spec.md:3,41`
...
- **Severity**: MEDIUM
- **Category**: drift
- **Location**: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/005-architecture-audit/plan.md:108`
...
- **Severity**: LOW
- **Category**: drift
- **Location**: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/005-architecture-audit/checklist.md:399` (CHK-802)
...
- **Severity**: LOW
- **Category**: alignment
- **Location**: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/005-architecture-audit/checklist.md:421-429`
...
- **Severity**: LOW
- **Category**: alignment
- **Location**: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/005-architecture-audit/implementation-summary.md:2,12`

---
title: "Feature Specification: 001-hybrid-rag-fusion [system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/spec]"
...
|-----------|-------------|-------------|
| `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/spec.md` | Modify | Replace consolidated merge prose with a concise parent packet |
| `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/plan.md` | Modify | Keep the parent implementation plan aligned with current sprint normalization |
| `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/tasks.md` | Modify | Track parent normalization and sprint-link follow-up |
| `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/checklist.md` | Modify | Capture validator-backed verification evidence |
| `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/decision-record.md` | Modify | Preserve parent-level ADRs for current-tree authority |
| `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/implementation-summary.md` | Modify | Summarize the current parent normalization pass |
| `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/implementation-summary-sprints.md` | Modify | Remove stale parent metadata that no longer matches the live folder |
| `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/00*-*/spec.md` | Modify | Normalize sprint-child parent and neighboring-phase navigation |
<!-- /ANCHOR:scope -->

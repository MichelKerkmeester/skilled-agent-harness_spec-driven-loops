...
● Search (grep)
  ...
  │ **/*.{md,json} (.opencode/specs/system-spec-kit/022-hybrid-rag-fusion)
  └ 5 lines found
...
● Read implementation-summary.md
  │ .opencode/specs/system-spec-kit/022-hybrid-rag-fusion/implementation-summary.md
...
● Search (grep)
  ...
  │ safety|artifact|MPAB|MMR" in **/*.md (.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/
...
● Search (grep)
  ...
  │ in **/*.md
  │ (.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic)
  └ 5 lines found

● Search (glob)
  │ ".opencode/specs/system-spec-kit/022-hybrid-rag-fusion/{001-hybrid-rag-fusion-epic,007-code-
...
● Read spec.md
  │ .opencode/specs/system-spec-kit/022-hybrid-rag-fusion/007-code-audit-per-feature-catalog/014
  │ -pipeline-architecture/spec.md
  └ L1:320 (198 lines read)

● Read spec.md
  │ .opencode/specs/system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/spec.md
...
● Search (grep)
  ...
  │ artifact" in **/*.md (.opencode/specs/system-spec-kit/022-hybrid-rag-fusion)
  └ 5 lines found

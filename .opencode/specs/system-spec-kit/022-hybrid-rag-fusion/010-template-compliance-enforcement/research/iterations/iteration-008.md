...
2. Level 2 contract (all 5 doc types) -- identical to the 49-line block in Section 3.5 of research/research.md
...
The exact content is the 49-line compact contract table from iteration 6 (research/research.md Section 3.5), wrapped with a version header:
...
[...exact 49-line block from research/research.md Section 3.5...]
...
**REPLACE WITH** the full 49-line compact contract from research/research.md Section 3.5, plus a reference to the shared file:

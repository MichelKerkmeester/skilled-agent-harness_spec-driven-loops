...
- [ ] **T-VAL-04** `validate.sh --strict` on 018 packet.
  - Run: `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/018-deep-loop-cli-executor --strict`
  - Acceptance: exits 0.

...
- **Privacy contract vs implementation:** 027/004 still claims no raw prompt content appears in response envelopes, but `includeAttribution` currently routes prompt-derived evidence into `laneBreakdown`, so the shipped MCP surface does not satisfy that requirement. [SOURCE: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-package/002-skill-graph-daemon-and-advisor-unification/004-mcp-advisor-surface/spec.md:101-104,122`], [SOURCE: `.opencode/skill/system-spec-kit/mcp_server/skill-advisor/handlers/advisor-recommend.ts:79-90`], [SOURCE: `.opencode/skill/system-spec-kit/mcp_server/skill-advisor/lib/scorer/lanes/explicit.ts:127-137,157-165`]

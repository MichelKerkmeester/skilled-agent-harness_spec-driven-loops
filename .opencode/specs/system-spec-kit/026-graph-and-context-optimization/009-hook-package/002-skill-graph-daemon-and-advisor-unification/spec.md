---
title: "...ec-kit/026-graph-and-context-optimization/009-hook-package/002-skill-graph-daemon-and-advisor-unification/spec]"
...
| **Status** | In Progress |
| **Created** | 2026-04-20 |
| **Branch** | `009-hook-package` |
| **Parent Spec** | `../spec.md` |
| **Predecessor** | `../001-skill-advisor-hook-surface/spec.md` |
| **Successor** | `../003-hook-parity-remediation/spec.md` |
<!-- /ANCHOR:metadata -->
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-package/002-skill-graph-daemon-and-advisor-unification/**` | Modify | Phase 027 packet evidence and strict validation shape. |
<!-- /ANCHOR:scope -->

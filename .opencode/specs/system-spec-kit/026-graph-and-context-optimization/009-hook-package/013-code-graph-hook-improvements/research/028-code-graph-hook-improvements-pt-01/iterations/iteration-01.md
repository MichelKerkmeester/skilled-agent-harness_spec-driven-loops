...
- The packet purpose explicitly asks for under-used signals, observability, and cross-runtime enrichment, which makes status/startup/hook adapter surfaces valid investigation targets even when the core graph storage layer itself is out of rewrite scope [.opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-package/013-code-graph-hook-improvements/spec.md:54-61,69-74].

...
You are cli-codex (gpt-5.5 high fast) implementing **049-runtime-command-agent-alignment-review**.

### CRITICAL: Spec folder path

The packet folder is: `specs/system-spec-kit/026-graph-and-context-optimization/049-runtime-command-agent-alignment-review/` — write ALL packet files there. Do NOT ask for the spec folder.
...
- `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh specs/system-spec-kit/026-graph-and-context-optimization/049-runtime-command-agent-alignment-review --strict` — must exit 0
...
**Deps**: `manual.depends_on=["system-spec-kit/026-graph-and-context-optimization/042-root-readme-refresh","system-spec-kit/026-graph-and-context-optimization/047-matrix-runners-snake-case-rename","system-spec-kit/026-graph-and-context-optimization/048-remaining-p1-p2-remediation"]`.

**Trigger phrases**: `["049-runtime-command-agent-alignment-review","runtime command audit","agent alignment review","cross-runtime agent consistency"]`.

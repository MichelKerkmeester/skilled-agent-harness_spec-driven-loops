...
description: "This phase brought the requested doc surfaces back into sync with the shipped graph metadata parser."
trigger_phrases:
  - "doc surface alignment"
  - "graph metadata validation"
  - "doc surface alignment for graph metadata"

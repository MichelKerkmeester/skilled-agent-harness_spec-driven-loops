...
description: "This phase taught deriveEntities() to treat entity names as the dedupe key instead of blindly reserving one slot per keyfiles entry."
trigger_phrases:
  - "deduplicate entities"
  - "graph metadata validation"
  - "deduplicate graph metadata entities"
  - "deduplicate entities implementation summary"
  - "system spec kit"

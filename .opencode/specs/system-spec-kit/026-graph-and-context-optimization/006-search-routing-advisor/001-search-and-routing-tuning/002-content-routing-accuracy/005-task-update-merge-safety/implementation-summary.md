...
description: "This phase added a document-wide prevalidation step for task updates before update-in-place can mutate a task or checklist document."
trigger_phrases:
  - "task update merge safety"
  - "content routing accuracy"
  - "add task update merge safety guard"
  - "task update merge safety implementation summary"
  - "system spec kit"

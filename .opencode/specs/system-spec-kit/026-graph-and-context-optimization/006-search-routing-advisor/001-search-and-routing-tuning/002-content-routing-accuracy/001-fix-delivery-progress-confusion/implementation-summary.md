...
description: "This phase corrected the delivery-versus-progress asymmetry inside the Tier 1 router instead of chasing the problem with threshold tuning."
trigger_phrases:
  - "fix delivery progress confusion"
  - "content routing accuracy"
  - "fix delivery vs progress routing confusion"
  - "fix delivery progress confusion implementation summary"
  - "system spec kit"

...
### Overview
This parent groups `001-search-and-routing-tuning/`, `002-skill-advisor-graph/`, `003-advisor-phrase-booster-tailoring/`, `004-smart-router-context-efficacy/`, `005-skill-advisor-docs-and-code-alignment/`, `006-smart-router-remediation-and-opencode-plugin/`, `007-deferred-remediation-and-telemetry-run/` as direct child folders. It keeps the active theme concise while avoiding an extra archive layer.
<!-- /ANCHOR:summary -->

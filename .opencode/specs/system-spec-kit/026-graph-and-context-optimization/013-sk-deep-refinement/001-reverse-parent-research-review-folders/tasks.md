...
title: "Tasks: Reverse Parent Research/Review Folder Placement"
...
- [x] T020 Rebase `002-resource-map-deep-loop-integration` onto the restored local-owner contract.
...
- **Dependent phase**: `../002-resource-map-deep-loop-integration/`
<!-- /ANCHOR:cross-refs -->

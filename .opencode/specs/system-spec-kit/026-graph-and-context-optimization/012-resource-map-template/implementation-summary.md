...
title: "Implementation Summary: Resource Map Template [012-resource-map-template]"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 012-resource-map-template |
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/012-resource-map-template/*` | Created | Packet docs (spec, plan, tasks, checklist, implementation-summary, description.json, graph-metadata.json). |
<!-- /ANCHOR:what-built -->

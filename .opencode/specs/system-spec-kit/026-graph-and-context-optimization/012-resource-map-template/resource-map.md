---
title: "Resource Map: Resource Map Template [012-resource-map-template]"
...
| Path | Action | Status | Note |
|------|--------|--------|------|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/012-resource-map-template/spec.md` | Created | OK | Level 2 spec (metadata + problem + scope + requirements + L2 NFR/edge-cases/complexity). |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/012-resource-map-template/plan.md` | Created | OK | Level 2 plan with SUMMARY, QUALITY GATES, ARCHITECTURE, PHASES, TESTING, DEPENDENCIES, ROLLBACK, L2 addenda. |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/012-resource-map-template/tasks.md` | Created | OK | Level 2 tasks (Phase 1/2/3 + Completion + Cross-References). |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/012-resource-map-template/checklist.md` | Created | OK | Level 2 checklist (Protocol, Pre-Impl, Code Quality, Testing, Security, Docs, File Org, Summary). |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/012-resource-map-template/implementation-summary.md` | Created | OK | Impl summary with Files Changed + Verification + Key Decisions + Limitations. |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/012-resource-map-template/resource-map.md` | Created | OK | This file. |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/012-resource-map-template/description.json` | Created | OK | Packet description metadata. |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/012-resource-map-template/graph-metadata.json` | Created | OK | Packet graph metadata (schema_version 1, derived trigger_phrases + key_files + entities). |
...
| Path | Action | Status | Note |
|------|--------|--------|------|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/012-resource-map-template/description.json` | Created | OK | Listed above under Specs; appears here for completeness of config-like JSON. |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/012-resource-map-template/graph-metadata.json` | Created | OK | Listed above under Specs; appears here for completeness of config-like JSON. |

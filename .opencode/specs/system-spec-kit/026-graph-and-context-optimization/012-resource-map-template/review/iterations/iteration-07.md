...
- The filled example (`026/012-resource-map-template/resource-map.md`) acts as a reference impl: 32 entries across 7 categories, categories with zero rows correctly omitted, `_memory.continuity` block populated.

...
| `constitutional memory` | `system-spec-kit` | 1.7 | Distinct system-spec-kit memory subsystem name that is documented as user-facing lifecycle behavior but has no PHRASE route today. | `.opencode/skills/system-spec-kit/feature_catalog/05--lifecycle/08-constitutional-memory-end-to-end-lifecycle.md:1-25` |

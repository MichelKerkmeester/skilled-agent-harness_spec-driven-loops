...
## Evidence read
- `.opencode/skills/system-spec-kit/mcp_server/lib/skill-advisor/render.ts:50-66` -> `sanitizeSkillLabel()` canonical-folds labels, strips control chars, collapses whitespace, and rejects instruction-shaped prefixes.

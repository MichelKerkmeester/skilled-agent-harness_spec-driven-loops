...
## Evidence read
- `.opencode/skills/system-spec-kit/mcp_server/lib/skill-advisor/prompt-cache.ts:33-36` -> prompt-cache HMAC secret is process-local, not persisted, and rotates on process start.

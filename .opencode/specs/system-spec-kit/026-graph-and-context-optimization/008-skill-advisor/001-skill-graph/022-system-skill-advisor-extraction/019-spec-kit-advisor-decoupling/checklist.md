...
- [x] CHK-001 [P0] Existing 019 packet confirmed at the post-dissolution `022-system-skill-advisor-extraction/019-spec-kit-advisor-decoupling` path.
...
- [x] CHK-FIX-002 [P0] Same-class path inventory checked under `008-skill-advisor`; current packet paths exist.

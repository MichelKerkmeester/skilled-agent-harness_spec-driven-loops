...
|-----------|-------------|-------------|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/022-system-skill-advisor-extraction/026-sk-code-and-code-readme-audit/` | Create | Level 3 packet docs and audit report. |

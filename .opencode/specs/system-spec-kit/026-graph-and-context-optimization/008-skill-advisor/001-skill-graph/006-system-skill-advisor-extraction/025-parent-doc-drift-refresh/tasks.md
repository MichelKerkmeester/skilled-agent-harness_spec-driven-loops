...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/006-system-skill-advisor-extraction/025-parent-doc-drift-refresh"
...
- [x] T003 Scaffold `025-parent-doc-drift-refresh` as Level 2.
<!-- /ANCHOR:phase-1 -->
...
- [x] T004 Modify `.opencode/specs/.../006-system-skill-advisor-extraction/handover.md`.
- [x] T005 Modify `.opencode/specs/.../006-system-skill-advisor-extraction/graph-metadata.json`.
<!-- /ANCHOR:phase-2 -->

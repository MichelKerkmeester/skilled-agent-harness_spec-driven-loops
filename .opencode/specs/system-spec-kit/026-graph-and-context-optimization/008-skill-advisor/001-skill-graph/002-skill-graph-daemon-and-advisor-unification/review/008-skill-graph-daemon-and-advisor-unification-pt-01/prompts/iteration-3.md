...
Open `002-skill-graph-daemon-and-advisor-unification/spec.md` and enumerate REQ-* statements. For each, identify file:line implementation evidence. Particular attention:
...
Write to: `specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/002-skill-graph-daemon-and-advisor-unification/review/002-skill-graph-daemon-and-advisor-unification-pt-01/iterations/iteration-003.md`

---
title: "Session [system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/001-skill-advisor-graph/handover]"
...
- `011-skill-advisor-graph/003-skill-advisor-packaging/` — phase spec for rename + playbook + catalog
...
```
/spec_kit:resume .opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/001-skill-advisor-graph
```

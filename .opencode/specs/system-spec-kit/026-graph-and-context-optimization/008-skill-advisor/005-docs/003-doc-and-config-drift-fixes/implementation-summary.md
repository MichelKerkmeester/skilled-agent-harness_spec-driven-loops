...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/005-docs/003-doc-and-config-drift-fixes"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | `008-skill-advisor/005-docs/003-doc-and-config-drift-fixes` |
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/005-docs/003-doc-and-config-drift-fixes/*` | Created | Level 1 spec packet (spec/plan/tasks/impl-summary/description.json/graph-metadata.json) |
<!-- /ANCHOR:what-built -->

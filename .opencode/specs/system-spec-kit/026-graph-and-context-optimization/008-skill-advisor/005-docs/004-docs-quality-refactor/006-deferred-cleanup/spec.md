---
title: "Feature Specification: 006-deferred-cleanup (Tier A+B+C-subset closure pass)"
...
_memory:
  continuity:
    ...
    answered_questions: []
---
# Feature Specification: 006-deferred-cleanup
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/005-docs/004-docs-quality-refactor/spec.md` | Modify | Add 006 row to PHASE DOCUMENTATION MAP |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/005-docs/004-docs-quality-refactor/graph-metadata.json` | Modify | Append 006 to children_ids, advance last_active_child_id |
<!-- /ANCHOR:scope -->

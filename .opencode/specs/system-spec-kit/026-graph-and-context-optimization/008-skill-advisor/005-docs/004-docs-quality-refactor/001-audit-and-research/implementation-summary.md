...
| Field | Value |
|-------|-------|
| **Spec Folder** | `004-docs-quality-refactor/001-audit-and-research` |
...
| Parent `derived.last_active_child_id` intact | PASS — points to `004-docs-quality-refactor/001-audit-and-research` |

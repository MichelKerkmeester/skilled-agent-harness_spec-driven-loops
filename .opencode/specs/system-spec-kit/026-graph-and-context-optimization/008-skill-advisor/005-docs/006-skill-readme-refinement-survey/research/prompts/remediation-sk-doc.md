REMEDIATE: sk-doc/README.md per packet-005-style refinement rules.

# Goal

Modify exactly one file: `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/sk-doc/README.md`

Apply the refinements catalogued in the audit report for skill `sk-doc`. Output the modified README directly in-place (the agent-config allows writes only to this one path).
...
Section 1 tables to remove or move:
  - lines 52-62 (2 cols, 7 rows): Key Statistics table (Skill version, Operating modes, Script count, Template count, Reference files, Flowchart patterns, DQI scale) -> to-paragraph
  - lines 64-74 (3 cols, 5 rows): How This Compares table (sk-doc vs system-spec-kit vs sk-git for Markdown quality enforcement, DQI scoring, Skill/Agent/Command creation, Spec folder lifecycle, ASCII flowcharts, Install guides, Feature catalogs/playbooks, Git workflow orchestration) -> move-to-§3
Banned words:
  - line 46: leverage in: All documentation output produced through this skill must follow Human Voice Rules (HVR): no em dashes, no semicolons, n
  - line 376: leverage in: Common causes: Writing that uses banned words (leverage, robust, seamless, utilize, delve, cutting-edge, and others), em
...
Write the entire revised README to `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/sk-doc/README.md`. Do not produce any other files. Do not edit any other file.

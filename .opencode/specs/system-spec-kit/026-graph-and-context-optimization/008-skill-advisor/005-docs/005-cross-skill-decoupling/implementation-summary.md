...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/005-docs/005-cross-skill-decoupling"
    ...
    session_dedup:
      ...
      session_id: "005-cross-skill-decoupling-impl-summary"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 005-cross-skill-decoupling |

...
- File: `.opencode/skills/system-spec-kit/mcp_server/tests/cross-encoder.vitest.ts:213`
- Evidence: `cross-encoder.vitest.ts` calls `rerankResults()` in fallback-style tests at `.opencode/skills/system-spec-kit/mcp_server/tests/cross-encoder.vitest.ts:213`, `.opencode/skills/system-spec-kit/mcp_server/tests/cross-encoder.vitest.ts:228`, and `.opencode/skills/system-spec-kit/mcp_server/tests/cross-encoder.vitest.ts:246` without any local env cleanup. `search-limits-scoring.vitest.ts` also calls `rerankResults()` in fallback assertions at `.opencode/skills/system-spec-kit/mcp_server/tests/search-limits-scoring.vitest.ts:231` and `.opencode/skills/system-spec-kit/mcp_server/tests/search-limits-scoring.vitest.ts:291`. Production provider resolution will select Voyage when `VOYAGE_API_KEY` exists at `.opencode/skills/system-spec-kit/mcp_server/lib/search/cross-encoder.ts:219`.

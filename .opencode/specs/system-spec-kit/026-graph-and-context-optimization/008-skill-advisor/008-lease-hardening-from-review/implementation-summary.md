...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/changelog/008-lease-hardening-from-review.md` | Create (+115) | Changelog with upgrade notes + verification evidence |
<!-- /ANCHOR:what-built -->

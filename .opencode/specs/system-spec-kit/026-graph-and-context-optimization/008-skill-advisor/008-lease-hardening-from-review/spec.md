...
**Changelog**: `008-skill-advisor/changelog/008-lease-hardening-from-review.md`.
<!-- /ANCHOR:phase-context -->
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/changelog/008-lease-hardening-from-review.md` | Create | Changelog entry. |
<!-- /ANCHOR:scope -->

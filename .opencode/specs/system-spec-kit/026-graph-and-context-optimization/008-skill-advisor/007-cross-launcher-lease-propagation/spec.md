...
**Changelog**: `008-skill-advisor/changelog/007-cross-launcher-lease-propagation.md`.
<!-- /ANCHOR:phase-context -->
...
- Changelog entry — `008-skill-advisor/changelog/007-cross-launcher-lease-propagation.md`.
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/changelog/007-cross-launcher-lease-propagation.md` | Create | Changelog entry. |
<!-- /ANCHOR:scope -->
...
| REQ-008 | Changelog entry | `008-skill-advisor/changelog/007-cross-launcher-lease-propagation.md` documents the patch + upgrade notes (zero migration). |
<!-- /ANCHOR:requirements -->

---
title: "...ec-kit/026-graph-and-context-optimization/008-skill-advisor/004-skill-advisor-docs-and-code-alignment/tasks]"
...
- [x] T020 [P0] Run `validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/004-skill-advisor-docs-and-code-alignment --strict --no-recursive` clean [Evidence: strict validation returned errors=0, warnings=0]

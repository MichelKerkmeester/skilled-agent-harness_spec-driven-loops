...
|-----------|-------------|-------------|
| `.opencode/specs/.../022-system-skill-advisor-extraction/handover.md` | Modify | Replace obsolete seven-child framing with 25-child state. |
| `.opencode/specs/.../022-system-skill-advisor-extraction/graph-metadata.json` | Modify | Add children 022-025 and point last active child at 025. |
<!-- /ANCHOR:scope -->

...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/022-system-skill-advisor-extraction/025-parent-doc-drift-refresh"
...
- [x] T004 Modify `.opencode/specs/.../022-system-skill-advisor-extraction/handover.md`.
- [x] T005 Modify `.opencode/specs/.../022-system-skill-advisor-extraction/graph-metadata.json`.
<!-- /ANCHOR:phase-2 -->

...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/022-system-skill-advisor-extraction/019-spec-kit-advisor-decoupling/"
    completion_pct: 100
    open_questions: []
    answered_questions:
...
- [x] T001 Confirm packet path moved under `022-system-skill-advisor-extraction`.

...
> Spec folder: `026-graph-and-context-optimization/008-skill-advisor/005-skill-advisor-setup-command` (Level 2)
...
- Parent `008-skill-advisor/{context-index,spec,tasks}.md` updated: 11 to 12 children, trigger phrases include `005-skill-advisor-setup-command` and `/spec_kit:skill-advisor` (the command was later renamed to `/doctor:skill-advisor` in a follow-on namespace refactor).

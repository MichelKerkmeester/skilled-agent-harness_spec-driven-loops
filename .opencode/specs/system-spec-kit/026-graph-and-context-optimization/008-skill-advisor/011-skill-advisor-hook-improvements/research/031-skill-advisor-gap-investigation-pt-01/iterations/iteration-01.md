...
- Grep patterns:
  - `rg -l "workspaceRoot|effectiveThresholds|advisor_recommend" .opencode/skills/system-spec-kit/mcp_server/skill-advisor`
...
- Not flagged: `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/README.md` because it was explicitly updated and recorded in the resource map.

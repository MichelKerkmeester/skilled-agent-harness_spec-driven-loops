...
| **Parent Spec** | `../spec.md` |
| **Related** | `../004-skill-advisor-hook-surface/`, `../009-skill-advisor-plugin-hardening/`, `../010-skill-advisor-standards-alignment/`, `../../007-deep-review-remediation/006-integrity-parity-closure/applied/CF-019.md` |

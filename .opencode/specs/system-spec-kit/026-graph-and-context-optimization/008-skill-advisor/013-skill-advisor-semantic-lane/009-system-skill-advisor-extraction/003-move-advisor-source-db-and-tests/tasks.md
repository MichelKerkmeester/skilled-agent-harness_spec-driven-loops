...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/013-skill-advisor-semantic-lane/009-system-skill-advisor-extraction/003-move-advisor-source-db-and-tests"
...
- [x] T014 Added moved `013` child to `008-skill-advisor/graph-metadata.json`.
...
- Parent phase: `013-skill-advisor-semantic-lane/009-system-skill-advisor-extraction`
- ADR source: `009-system-skill-advisor-extraction/001-design-and-decision-record`
- Next packet: `009-system-skill-advisor-extraction/004-standalone-mcp-launcher-and-runtime-configs`
<!-- /ANCHOR:cross-refs -->

...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/013-skill-advisor-semantic-lane/009-system-skill-advisor-extraction/015-mcp-server-rename-mk-skill-advisor"
...
| **Created** | 2026-05-14 |
| **Branch** | `main` |
| **Spec Folder** | `015-mcp-server-rename-mk-skill-advisor` |
<!-- /ANCHOR:metadata -->

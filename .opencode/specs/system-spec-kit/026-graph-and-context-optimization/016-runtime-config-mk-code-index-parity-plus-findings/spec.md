...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/016-runtime-config-mk-code-index-parity-plus-findings"
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-runtime-config-mk-code-index-parity-plus-findings/` | Create | Packet docs and metadata. |
<!-- /ANCHOR:scope -->

---
title: "...ystem-spec-kit/026-graph-and-context-optimization/005-code-graph/002-stale-highlights-and-scan-scope-fix/tasks]"
...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/005-code-graph/002-stale-highlights-and-scan-scope-fix"
...
- [x] **T-09** Author surface matrix doc at the code-graph SURFACES doc (location TBD by Codex) (or location chosen based on layout). [EVIDENCE: `.opencode/skills/system-spec-kit/mcp_server/code-graph/SURFACES.md` exists with the required 4-column matrix.]
<!-- /ANCHOR:phase-2 -->

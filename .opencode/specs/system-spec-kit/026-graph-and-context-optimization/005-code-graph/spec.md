...
trigger_phrases:
  ...
  - "002-fix-stale-highlights-and-scan-scope"
...
### In Scope
- Preserve the root purpose for `005-code-graph` without rewriting child-phase intent.
...
### Out of Scope
- Editing any child packet content under `005-code-graph/[0-9][0-9][0-9]-*/`.
...
| 3 | `002-fix-stale-highlights-and-scan-scope/` | Code Graph Context + Scan Scope Remediation | complete |
| 4 | `003-resolver-and-hook-improvements/` | Code-Graph System + Hooks Improvement Investigation | complete |
| 5 | `004-research-and-fix-code-graph-advisor-refinement/` | Code Graph and Skill Advisor Refinement Research | complete |
...
- Use `/spec_kit:resume system-spec-kit/026-graph-and-context-optimization/005-code-graph/[NNN-phase]/` to resume a specific child phase.
...
| `002-code-graph-self-contained-package` | `002-fix-stale-highlights-and-scan-scope` | `002-code-graph-self-contained-package` remains discoverable and its successor relationship stays explicit in the parent manifest | Parent `spec.md` phase map and `graph-metadata.json` child list both include `002-fix-stale-highlights-and-scan-scope` |
| `002-fix-stale-highlights-and-scan-scope` | `003-resolver-and-hook-improvements` | `002-fix-stale-highlights-and-scan-scope` remains discoverable and its successor relationship stays explicit in the parent manifest | Parent `spec.md` phase map and `graph-metadata.json` child list both include `003-resolver-and-hook-improvements` |
| `003-resolver-and-hook-improvements` | `004-research-and-fix-code-graph-advisor-refinement` | `003-resolver-and-hook-improvements` remains discoverable and its successor relationship stays explicit in the parent manifest | Parent `spec.md` phase map and `graph-metadata.json` child list both include `004-research-and-fix-code-graph-advisor-refinement` |
| `004-research-and-fix-code-graph-advisor-refinement` | `005-doctor-diagnostic-command-phase-a` | `004-research-and-fix-code-graph-advisor-refinement` remains discoverable and its successor relationship stays explicit in the parent manifest | Parent `spec.md` phase map and `graph-metadata.json` child list both include `005-doctor-diagnostic-command-phase-a` |

...
| Field | Value |
|-------|-------|
| **Spec Folder** | system-spec-kit/026-graph-and-context-optimization/005-code-graph/017-code-folder-readmes |
| **Completed** | TBD |
| **Level** | 1 |
<!-- /ANCHOR:metadata -->
...
| Strict-validate packet | TBD | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/017-code-folder-readmes --strict` |
<!-- /ANCHOR:verification -->

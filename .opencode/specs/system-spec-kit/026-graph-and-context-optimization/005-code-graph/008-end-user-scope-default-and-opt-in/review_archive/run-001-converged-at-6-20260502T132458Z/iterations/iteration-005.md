...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/review/deep-review-state.jsonl:1-5`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/review/deep-review-strategy.md:1-80`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/review/deep-review-findings-registry.json:1-71`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/review/iterations/iteration-002.md:57-73`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/review/iterations/iteration-004.md:50-67`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/plan.md:203-277`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/plan.md:281-310`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/checklist.md:193-224`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/decision-record.md:65-80`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/implementation-summary.md:61-80`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/resource-map.md:50-90`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/index-scope-policy.ts:1-51`
- `.opencode/skills/system-spec-kit/mcp_server/lib/utils/index-scope.ts:18-65`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/indexer-types.ts:140-167`
...
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/scan.ts:244-294`
...
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/structural-indexer.ts:1451-1489`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/code-graph-db.ts:213-251`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/code-graph-db.ts:579-594`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/ensure-ready.ts:277-304`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/ensure-ready.ts:489-563`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/startup-brief.ts:223-234`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/status.ts:159-172`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/status.ts:248-295`
...
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/tests/code-graph-indexer.vitest.ts:248-325`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/tests/code-graph-scan.vitest.ts:245-277`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/tests/code-graph-scope-readiness.vitest.ts:1-108`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/tests/code-graph-siblings-readiness.vitest.ts:217-223`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/tests/code-graph-siblings-readiness.vitest.ts:265-319`
...
- `.opencode/skills/system-spec-kit/mcp_server/ENV_REFERENCE.md:255-265`

...
|------|--------|--------|------|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/spec.md` | Analyzed | OK | Packet framing and research questions |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/research/deep-research-config.json` | Analyzed | OK | Loop settings |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/research/deep-research-strategy.md` | Updated | OK | Loop strategy |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in/research/deep-research-state.jsonl` | Updated | OK | Iteration state |
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-manifest-driven-template-design/decision-record.md` | Analyzed | OK | ADR-005 workflow invariance |
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-manifest-driven-template-design/decision-record.md` | Cited | OK | ADR-005 source only |

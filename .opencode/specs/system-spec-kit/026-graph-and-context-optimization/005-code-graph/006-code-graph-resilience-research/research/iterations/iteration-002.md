...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/005-code-graph-resilience-research/research/deep-research-strategy.md:40-56`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/005-code-graph-resilience-research/research/iterations/iteration-001.md:11-20`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/005-code-graph-resilience-research/research/iterations/iteration-001.md:35-47`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/code-graph-db.ts:50-65`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/code-graph-db.ts:95-115`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/code-graph-db.ts:157-162`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/code-graph-db.ts:281-321`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/code-graph-db.ts:380-424`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/code-graph-db.ts:640-715`
...
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/ensure-ready.ts:290-379`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/scan.ts:174-206`
...
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/detect-changes.ts:319-369`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/status.ts:11-62`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/readiness-contract.ts:73-124`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/readiness-contract.ts:161-181`

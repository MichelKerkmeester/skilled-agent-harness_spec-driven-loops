...
- Spec packet `026-graph-and-context-optimization/` contains sibling packets `003-code-graph-package/`, `006-skill-advisor/`, `007-hook-parity/` with prior findings on code-graph scan-scope, search-routing tuning, skill-advisor hook surface — review these for lessons learned.

...
- [x] CHK-010 [P0] Research synthesis cites specific source files, not vague references [EVIDENCE: research/001-code-graph-advisor-refinement-roadmap/research.md findings cite concrete files such as structural-indexer.ts, startup-brief.ts, fusion.ts, metrics.ts, and hook settings files]
- [x] CHK-011 [P0] Findings are actionable — each names a file, function, or behavior [EVIDENCE: review/001-code-graph-advisor-refinement-roadmap/review-report.md lists file:line and recommended fix for each open finding]
...
- [x] CHK-013 [P1] Research follows the 3-phase structure: Discovery (iters 1-6), Deep-Dive (7-14), Synthesis (15-20) [EVIDENCE: research/001-code-graph-advisor-refinement-roadmap/iterations/iteration-001.md through iteration-020.md exist and research.md section 17 indexes iteration coverage]
<!-- /ANCHOR:code-quality -->
...
- [x] CHK-051 [P1] Research outputs land in `research/` subfolder (auto-created by deep-research skill) [EVIDENCE: research/001-code-graph-advisor-refinement-roadmap/ contains state, deltas, iterations, findings registry, dashboard, and research.md]
...
- [x] CHK-121 [P1] Synthesis document available for review before follow-up phase begins [EVIDENCE: research/001-code-graph-advisor-refinement-roadmap/research.md exists and review-report.md reviews the implemented PR set]
<!-- /ANCHOR:deploy-ready -->
...
- [x] CHK-131 [P2] Memory context saved after research completes [EVIDENCE: research.md and deep-research-state.jsonl persisted under research/001-code-graph-advisor-refinement-roadmap/; description.json + graph-metadata.json present at packet root for memory indexing]
<!-- /ANCHOR:compliance-verify -->

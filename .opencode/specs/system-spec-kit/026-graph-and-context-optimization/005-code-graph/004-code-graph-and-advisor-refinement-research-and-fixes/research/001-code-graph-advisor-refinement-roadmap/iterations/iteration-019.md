...
- **Pre-merge sanity** (rigor matches blast radius):
  ...
  - Sibling-spec doc grep: no stale references in `002-skill-graph-daemon-native-advisor-tools`
...
- `research/001-code-graph-advisor-refinement-roadmap/iterations/iteration-018.md` (F83
  master roadmap, F84 dependency graph, F85 ordering principles, F86 risk-mitigation
  notes per PR)
- `research/001-code-graph-advisor-refinement-roadmap/deltas/iter-018.jsonl` (per-PR

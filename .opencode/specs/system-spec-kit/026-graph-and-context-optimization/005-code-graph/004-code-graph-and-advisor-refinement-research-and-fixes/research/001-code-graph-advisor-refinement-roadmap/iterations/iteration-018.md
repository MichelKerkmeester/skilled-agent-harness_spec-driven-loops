...
- `research/001-code-graph-advisor-refinement-roadmap/iterations/iteration-007.md` (F33, F36 8-bench list)
- `research/001-code-graph-advisor-refinement-roadmap/iterations/iteration-009.md` (F45 PR-ready, F46 test shape, F47 INV-F5-V2)
- `research/001-code-graph-advisor-refinement-roadmap/iterations/iteration-010.md` (F51 settings diff, F52 retraction, F55 alias)
- `research/001-code-graph-advisor-refinement-roadmap/iterations/iteration-011.md` (F56 test skeleton, F57 handler skeleton, F59 11-row table)
- `research/001-code-graph-advisor-refinement-roadmap/iterations/iteration-012.md` (F15 13-gate matrix, F37 #7 archaeology)
- `research/001-code-graph-advisor-refinement-roadmap/iterations/iteration-013.md` (F37-CLOSURE memo, F60-F62)
- `research/001-code-graph-advisor-refinement-roadmap/iterations/iteration-014.md` (delete plan actuation, cross-packet preflight)
- `research/001-code-graph-advisor-refinement-roadmap/iterations/iteration-015.md` (F68 package.json, F70 STOP_READY, F71 vocab unification mapping)
- `research/001-code-graph-advisor-refinement-roadmap/iterations/iteration-016.md` (F72-F76 metric catalog, library choice, sequencing)
- `research/001-code-graph-advisor-refinement-roadmap/iterations/iteration-017.md` (F77-F82 cache race, F81 5-LOC patch)
- `research/001-code-graph-advisor-refinement-roadmap/deep-research-strategy.md` (Exhausted Approaches list — 22+ entries respected)

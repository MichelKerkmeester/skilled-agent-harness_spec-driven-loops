...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/005-code-graph/004-code-graph-and-advisor-refinement-research-and-fixes"
...
**Canonical synthesis:** See `research/001-code-graph-advisor-refinement-roadmap/research.md` for the full 17-section synthesis (~7,000 words) including per-RQ findings, retractions, defects catalog, master roadmap, rollback plans, instrumentation namespace, and vocabulary unification mapping.
...
- **Research Synthesis**: See `research/001-code-graph-advisor-refinement-roadmap/research.md`
- **Resource Map**: See `research/001-code-graph-advisor-refinement-roadmap/resource-map.md`
- **Thematic Sibling**: See `014-skill-advisor-hook-improvements/` spec folder (007-hook-parity peer)

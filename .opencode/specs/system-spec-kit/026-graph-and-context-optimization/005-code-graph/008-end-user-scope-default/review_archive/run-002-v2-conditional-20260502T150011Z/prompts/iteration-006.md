...
- New test in code-graph-indexer.vitest.ts: symlink alias → real `.opencode/skills/example.ts` is NOT indexed by default
...
- Edge case: rootDir = `/tmp/foo/.opencode/skills/bar` (canonical contains skill but root looks legit) → still excluded?
...
Path: `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default/review/iterations/iteration-006.md`
...
Path: `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default/review/deltas/iter-006.jsonl`

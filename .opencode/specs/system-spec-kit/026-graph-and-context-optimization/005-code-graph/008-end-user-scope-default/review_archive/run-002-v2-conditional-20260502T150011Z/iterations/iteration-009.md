...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default/review/deep-review-strategy.md:23-41`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default/review/deep-review-findings-registry.json:6-78`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default/review/iterations/iteration-004.md:41-54`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default/review/iterations/iteration-005.md:36-48`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default/review/iterations/iteration-008.md:30-83`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default/spec.md:119-128`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default/plan.md:162-194`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default/decision-record.md:162-181`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default/checklist.md:226-232`
...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default/resource-map.md:58-87`
...
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/code-graph-db.ts:242-252`
...
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/scan.ts:328-380`
...
- `.opencode/skills/system-spec-kit/mcp_server/schemas/tool-input-schemas.ts:680-749`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/tests/code-graph-indexer.vitest.ts:257-359`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/tests/code-graph-scan.vitest.ts:253-346`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/tests/code-graph-scope-readiness.vitest.ts:63-107`
- `.opencode/skills/system-spec-kit/mcp_server/tests/tool-input-schema.vitest.ts:534-632`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/README.md:250-272`
...
- evidenceRefs:
  - `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/scan.ts:233-235`
  - `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/scan.ts:311-312`
  - `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/status.ts:159-173`
  - `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/status.ts:268-275`
  - `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:600-604`
  - `.opencode/skills/system-spec-kit/mcp_server/schemas/tool-input-schemas.ts:683-685`
  - `.opencode/skills/system-spec-kit/mcp_server/schemas/tool-input-schemas.ts:746-748`
  - `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default/decision-record.md:168-180`

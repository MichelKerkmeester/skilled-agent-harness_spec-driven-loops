...
## Findings
- ADR-005 makes `Level 1/2/3/3+ + phase-parent` the only public/AI-facing vocabulary and requires user conversation flow to remain unchanged. Evidence: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-template-greenfield-redesign/decision-record.md:211` and `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-template-greenfield-redesign/decision-record.md:217`.
- ADR-005 explicitly keeps forbidden internal taxonomy off public/AI-facing surfaces and allows it only in maintainer-internal design docs. Evidence: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-template-greenfield-redesign/decision-record.md:235` and `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-template-greenfield-redesign/decision-record.md:241`.

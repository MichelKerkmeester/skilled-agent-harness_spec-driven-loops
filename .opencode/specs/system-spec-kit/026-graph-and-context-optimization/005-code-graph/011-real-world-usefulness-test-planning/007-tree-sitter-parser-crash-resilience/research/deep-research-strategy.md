...
- 003-code-graph-bug-surface-research surfaced this as one of four primary findings (alongside default-scope-excludes, drift detector, zero-node persistence).

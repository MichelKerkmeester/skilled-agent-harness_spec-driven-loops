...
const FIXTURES = {
  vitestConfig: resolve(REPO, '.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/003-mcp-runtime-stress-remediation/029-clean-infrastructure-stress-test/measurements/vitest.phase-k.config.ts'),
  ...
  runnersCommon: resolve(REPO, '.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/016-runtime-hook-plugin-testing/runners/common.ts'),
};

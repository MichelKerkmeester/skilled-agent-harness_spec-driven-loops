...
| `specs/.../006-readiness-hooks-advisor-polish/*` | Create | Level 2 packet docs and implementation summary. |
| `specs/.../011-real-world-usefulness-test-planning/graph-metadata.json` | Modify | Add `006-readiness-hooks-advisor-polish` child ID. |
<!-- /ANCHOR:scope -->

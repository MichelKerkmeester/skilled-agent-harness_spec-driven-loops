...
- [x] CHK-041 [P1] Parent `graph-metadata.json` includes `006-readiness-hooks-advisor-polish`. Evidence: parent `children_ids` includes `system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/006-readiness-hooks-advisor-polish`.
...
- [x] CHK-051 [P1] Parent/child packet files remain under the requested spec hierarchy. Evidence: packet artifacts live under `006-readiness-hooks-advisor-polish`, with parent `graph-metadata.json` updated.
<!-- /ANCHOR:file-org -->

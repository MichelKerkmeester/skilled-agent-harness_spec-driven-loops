...
### In Scope
- Create the 001-sandbox-usefulness-trials Level 2 packet under the approved parent folder.
...
- Update parent `graph-metadata.json.children_ids` with `001-sandbox-usefulness-trials`.

...
| **Status** | Complete |
| **Created** | 2026-05-06 |
| **Branch** | `003-code-graph-bug-surface-research` |
<!-- /ANCHOR:metadata -->
...
- **SC-003**: Parent metadata includes `system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/003-code-graph-bug-surface-research`.
<!-- /ANCHOR:success-criteria -->

...
| Field | Value |
|-------|-------|
| **Spec Folder** | system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/002-native-deferred-trial-rerun |
...
| `../graph-metadata.json` | Updated | Parent children include `002-native-deferred-trial-rerun`. |
<!-- /ANCHOR:what-built -->
...
| Parent metadata | PASS: `children_ids` includes `002-native-deferred-trial-rerun`. |

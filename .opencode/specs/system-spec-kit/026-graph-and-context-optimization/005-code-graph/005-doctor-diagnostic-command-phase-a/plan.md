---
title: "Implementation Plan: Code Graph Doctor Command [system-spec-kit/026-graph-and-context-optimization/005-code-graph/005-doctor-diagnostic-command-phase-a/plan]"
...
trigger_phrases:
  ...
  - "005-doctor-diagnostic-command-phase-a plan"
...
- [ ] Parent `005-code-graph/{context-index, spec, tasks}.md` updated with 006 child entry
...
- [ ] Update parent `005-code-graph/{context-index, spec, tasks}.md` with 006 child entry

---
title: "Decision Record: Detector Provenance and Regression Floor [template:level_3/decision-record.md]"
description: "Decision record for 007-detector-provenance-and-regression-floor."
trigger_phrases:
...
---
# Decision Record: Detector Provenance and Regression Floor
...
<!-- ANCHOR:adr-001 -->
## ADR-001: Ship detector honesty and fixtures as a floor, not as proof
...
The CodeSight closeout strengthened the case for detector fixtures while also showing that weak detectors and provenance overclaims still exist. The research explicitly says those fixtures should be treated as a floor only.
...
**We chose**: Open a bounded detector packet that hardens provenance labels and frozen fixtures without claiming broader quality wins.
...
|--------|------|------|-------|
| **Detector floor packet** | Low-risk hardening that catches regressions early | Needs later outcome evaluation to prove user-visible gains | 8/10 |
| **Skip directly to routing work** | Feels more visible | Leaves detector truthfulness drift unresolved | 5/10 |

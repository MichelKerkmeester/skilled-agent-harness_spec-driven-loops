...
- Read addon writer and routing surfaces: `.opencode/skills/system-spec-kit/scripts/spec/scaffold-debug-delegation.sh`, `.opencode/skills/system-spec-kit/mcp_server/lib/routing/content-router.ts`, `.opencode/agents/deep-research.md`, `.opencode/commands/spec_kit/deep-research.md`, `.opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml`, `.opencode/skills/sk-deep-research/scripts/reduce-state.cjs`, `.opencode/skills/system-spec-kit/templates/README.md`, `.opencode/skills/system-spec-kit/templates/context-index.md`, and `.opencode/skills/system-spec-kit/templates/resource-map.md`.

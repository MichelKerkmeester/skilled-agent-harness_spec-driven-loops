...
1. **Write `research/research.md`**:
   ...
   17. Appendices (A: graph from iter 1-8 nodes/edges; B: commands run; C: cross-validation summary linking to ../001-template-level-consolidation-research/001-template-level-consolidation-research/research/cross-validation/copilot-response.md)

2. **Emit `research/resource-map.md`**:
   Path: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-manifest-driven-template-design/research/resource-map.md`
...
- Write iteration narrative to: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-manifest-driven-template-design/research/iterations/iteration-009.md
- Write per-iteration delta file to: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-manifest-driven-template-design/research/deltas/iter-009.jsonl
- **Write canonical synthesis to: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-manifest-driven-template-design/research/research.md** (THE headline deliverable)
- **Write resource map to: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-manifest-driven-template-design/research/resource-map.md**

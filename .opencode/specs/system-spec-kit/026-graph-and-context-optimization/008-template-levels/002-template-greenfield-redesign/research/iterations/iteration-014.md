...
- Read the existing synthesis in `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-template-greenfield-redesign/research/research.md` first, preserving the 17-section structure.
...
- Updated `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-template-greenfield-redesign/research/resource-map.md` with iteration 10-14 artifacts and workflow-invariance test targets.

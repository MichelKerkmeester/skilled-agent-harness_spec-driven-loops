...
## Topic
Review of 004-template-deferred-followup-fixes — implementation code for 10 Gate 7 deferred items (validation orchestrator, manifest versions, section gates, inline renderer batch mode, canonical save lock, lineage warnings, exit-code taxonomy, extension guide, migration guide, snapshot coverage).
...
| 004-template-deferred-followup-fixes/spec.md | pending |
| 004-template-deferred-followup-fixes/tasks.md | pending |
| 004-template-deferred-followup-fixes/checklist.md | pending |
| 004-template-deferred-followup-fixes/decision-record.md | pending |
| 004-template-deferred-followup-fixes/implementation-summary.md | pending |

## Known Context
- 004-template-deferred-followup-fixes implements 10 deferred items from 003-manifest-template-implementation-plan Gate 7.

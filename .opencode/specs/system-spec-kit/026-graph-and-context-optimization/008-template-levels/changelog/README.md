...
|-------|------|-------|----------------|
| 010/001 | 2026-05-01 | [Template consolidation investigation](./changelog-001-template-level-consolidation-research.md) | A 10-iteration deep-research loop analyzed the 86-file template system and recommended PARTIAL consolidation. The user rejected this framing. |
| 010/002 | 2026-05-01 | [Template greenfield redesign](./changelog-002-manifest-driven-template-design.md) | A 9-iteration loop converged on the C+F hybrid manifest-driven design with 5 ADRs, eliminating the level taxonomy. |
| 010/003 | 2026-05-01 | [Template greenfield implementation](./changelog-003-manifest-template-implementation-plan.md) | Executed the 4-phase plan: added manifest/resolver/renderer/CI-test, modified scaffolder, modified validators, deleted 51 legacy files. Source surface: 86 to 13. |
| 010/004 | 2026-05-01 | [Deferred followups](./changelog-004-template-deferred-followup-fixes.md) | Implemented 10 Gate 7 items: validation orchestrator, manifest template versions, exit-code taxonomy, save lock, batch renderer, and 5 ADRs. |
| 010/005 | 2026-05-02 | [Skill references and assets alignment](./changelog-005-skill-reference-asset-doc-alignment.md) | Audited SKILL.md, references/, and assets/ for stale references after the migration. Removed all stale hits and added current-feature notes. |
| 010/006 | 2026-05-02 | [Command Markdown and YAML alignment](./changelog-006-command-markdown-yaml-workflow-alignment.md) | Audited 18 command assets (6 Markdown + 12 YAML) for stale references and missing behavior notes. All 12 YAMLs parse cleanly. |
| 010/007 | 2026-05-02 | [Fleet marker validation sweep](./changelog-007-marker-validation-unused-scaffold.md) | Swept all spec folders for SPECKIT_LEVEL and SPECKIT_TEMPLATE_SOURCE markers referencing deleted paths. Corrected where needed. |
| 010/008 | 2026-05-02 | [z_archive marker validation sweep](./changelog-008-archive-marker-validation-unused-scaffold.md) | Confirmed archive markers are correct as historical provenance under ADR-005 indefinite support. No corrections needed. |

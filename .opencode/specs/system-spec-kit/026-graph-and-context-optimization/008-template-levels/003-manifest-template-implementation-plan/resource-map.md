...
| Path | Why cited |
|---|---|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-manifest-driven-template-design/research/research.md` | The 51.4 KB synthesis driving this implementation |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-manifest-driven-template-design/decision-record.md` | ADR-001 through ADR-005 |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-manifest-driven-template-design/plan.md` | The 4-phase plan structure inherited by this packet |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/001-template-level-consolidation-research/research/research.md` | Prior PARTIAL-recommendation framing (REJECTED but cited for factual carryover) |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/001-template-level-consolidation-research/research/cross-validation/copilot-response.md` | Independent gpt-5.5 analysis that materially refined the design |

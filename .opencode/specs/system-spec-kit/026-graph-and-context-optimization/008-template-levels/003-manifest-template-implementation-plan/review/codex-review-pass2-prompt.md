...
- The packet was renumbered: was `012-template-greenfield-impl/`, now `008-template-levels/003-manifest-template-implementation-plan/` (sibling 011 renumbered to 002, original 010 renumbered to 001)
...
- `../002-manifest-driven-template-design/decision-record.md` — inherited ADRs
...
6. **Cross-reference paths post-reorg.** Internal references like `../001-template-level-consolidation-research/` in 003's docs — do they all resolve to existing files?

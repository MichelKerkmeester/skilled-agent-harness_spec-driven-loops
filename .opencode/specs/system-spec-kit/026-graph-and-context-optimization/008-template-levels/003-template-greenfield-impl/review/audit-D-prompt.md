...
The user is implementing the C+F hybrid manifest-driven greenfield template-system per the design in `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-template-greenfield-redesign/research/research.md`. The implementation plan + file-by-file blast radius live in `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/003-template-greenfield-impl/` (especially `resource-map.md` §2.5).

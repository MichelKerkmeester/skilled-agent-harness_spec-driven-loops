...
4. `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/015-packets-009-014-audit --strict` — **FAIL** (`ANCHORS_VALID`, `FRONTMATTER_MEMORY_BLOCK`, `SPEC_DOC_INTEGRITY`, `TEMPLATE_HEADERS`, `TEMPLATE_SOURCE`)

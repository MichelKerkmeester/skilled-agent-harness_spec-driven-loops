---
title: "Decision Record: Structural Trust Axis Contract [template:level_3/decision-record.md]"
description: "Decision record for 006-structural-trust-axis-contract."
trigger_phrases:
...
---
# Decision Record: Structural Trust Axis Contract
...
<!-- ANCHOR:adr-001 -->
## ADR-001: Separate structural trust axes before payload enrichment
...
The research falsified the old packaging story because provenance, evidence, and freshness were asked to behave like one confidence score. Public has substrate pieces, but not a shared contract yet.
...
**We chose**: Define the structural trust contract first and force later graph packets to build on it instead of on a collapsed trust score.
...
|--------|------|------|-------|
| **Trust-axis separation first** | Makes later graph payloads inspectable and honest | Requires contract work before visible features | 9/10 |
| **Improve confidence labels only** | Looks smaller and faster | Repeats the collapse the research rejected | 3/10 |

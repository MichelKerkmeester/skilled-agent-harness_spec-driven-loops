...
- Write iteration narrative to: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/019-system-code-graph-uplift/research/iterations/iteration-001.md`
- Write per-iteration delta file to: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/019-system-code-graph-uplift/research/deltas/iter-001.jsonl`
...
1. **Iteration narrative markdown** at `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/019-system-code-graph-uplift/research/iterations/iteration-001.md`. Structure: H2 headings for Focus, Actions Taken, Findings (per-file subsections with file:line citations), Questions Answered, Questions Remaining, Next Focus.

2. **Canonical JSONL iteration record** APPENDED (echo with `>>`) to `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/019-system-code-graph-uplift/research/deep-research-state.jsonl`. Required schema:
...
Optional: write the per-iteration delta file to `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/019-system-code-graph-uplift/research/deltas/iter-001.jsonl` with the same iteration record plus one record per finding. If the recipe's write-permission denies the deltas path, the workflow will synthesize the delta file from your state-log append.

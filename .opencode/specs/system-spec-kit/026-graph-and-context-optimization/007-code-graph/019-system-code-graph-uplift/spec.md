...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/007-code-graph/019-system-code-graph-uplift"
...
| **Created** | 2026-05-16 |
| **Branch** | `main` |
| **Parent Spec** | `../spec.md` (parent: 007-code-graph) |
| **Parent Packet** | `system-spec-kit/026-graph-and-context-optimization/007-code-graph` |
...
- Three implementation children scaffolded post-research:
  - `001-skill-md-and-references-polish/` — SKILL.md + references + per-folder mcp_server READMEs + INSTALL_GUIDE drift fixes
  - `002-readme-marketing-rewrite/` — README rewrite in problem→solution→mechanism arc with HVR ≥85
  - `003-sk-doc-1to1-alignment/` — exhaustive `validate_document.py --type <type>` exit-0 across all authored docs
...
| 001 | `001-skill-md-and-references-polish/` | SKILL.md hook framing, references HVR, mcp_server per-folder README usefulness audit, INSTALL_GUIDE drift fixes | Not Scaffolded |
| 002 | `002-readme-marketing-rewrite/` | README rewrite in problem→solution→mechanism arc; HVR ≥85 | Not Scaffolded |
| 003 | `003-sk-doc-1to1-alignment/` | `validate_document.py --type <type>` exit-0 across every authored doc | Not Scaffolded |
...
- Use `/spec_kit:resume .opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/019-system-code-graph-uplift/[NNN-phase]/` to resume a specific phase

...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/014-system-code-graph-extraction/` | Cited | OK | Original extraction packet |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/025-skill-docs-sk-doc-alignment/` | Cited | OK | Prior sk-doc alignment work |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/040-three-way-isolation-finalize/` | Cited | OK | v1.0.3.0 isolation packet |
<!-- /ANCHOR:specs -->

...
|------|--------|--------|------|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/008-end-user-scope-default/spec.md` | Analyzed | OK | Packet framing and research questions |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/008-end-user-scope-default/research/deep-research-config.json` | Analyzed | OK | Loop settings |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/008-end-user-scope-default/research/deep-research-strategy.md` | Updated | OK | Loop strategy |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/008-end-user-scope-default/research/deep-research-state.jsonl` | Updated | OK | Iteration state |

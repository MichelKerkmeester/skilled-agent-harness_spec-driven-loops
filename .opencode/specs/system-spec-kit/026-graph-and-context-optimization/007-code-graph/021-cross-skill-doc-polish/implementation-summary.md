...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/007-code-graph/021-cross-skill-doc-polish"
    ...
    answered_questions:
      ...
      - "Spec folder → 021-cross-skill-doc-polish under 007-code-graph (corrected from the 029 frontmatter claim)"
---
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 021-cross-skill-doc-polish |
...
| Remove `_memory.continuity` from SKILL.md frontmatter | Continuity state belongs in the packet's `implementation-summary.md`, not in the skill's runtime contract. The block referenced a stale packet path (`029-system-code-graph-uplift`) that doesn't exist — corrected to the real parent (`026/007-code-graph/`). |

...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/014-system-code-graph-extraction/014-architecture-md/` | Created | Level 1 packet for this documentation-only change. |
<!-- /ANCHOR:what-built -->

...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/014-system-code-graph-extraction/013-readmes-update/` | Create | Track this README-only packet. |
<!-- /ANCHOR:scope -->

...
| 003 | 2026-04-23 | [Context and Scan Scope Remediation](./changelog-003-code-graph-context-and-scan-scope.md) | Stale graphs now show highlights. Default scan scope excludes noise and honors .gitignore. Two absorbed sub-phases shipped. |
...
| 004 | 2026-04-24 | [Hook Improvement Implementation](./changelog-004-code-graph-hook-improvements.md) | Eight streams shipped from the research findings: CALLS resolution, blocked-read contracts, CocoIndex fidelity, startup payload parity, and more. |
...
| 005 | 2026-04-25 | [Code Graph and Skill Advisor Refinement](./changelog-005-code-graph-advisor-refinement.md) | 10 PRs across 5 fix-up batches (B1-B5) plus F35 calibration bench. All 35 findings closed. |
...
| 006 | 2026-04-25 | [Doctor Command](./changelog-006-code-graph-doctor-command.md) | Phase A diagnostic-only /doctor:code-graph shipped. Phase B gated on research packet 007. |

...
| Field | Value |
|-------|-------|
| **Spec Folder** | `system-spec-kit/026-graph-and-context-optimization/007-code-graph/011-real-world-usefulness-test/005-scope-guard` |
...
| `specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/011-real-world-usefulness-test/005-scope-guard/*` | Created | Add Phase 005 planning, ADR, checklist, and summary docs. |
<!-- /ANCHOR:what-built -->

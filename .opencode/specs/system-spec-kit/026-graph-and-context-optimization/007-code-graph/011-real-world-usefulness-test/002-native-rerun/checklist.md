...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/007-code-graph/011-real-world-usefulness-test/002-native-rerun"
...
- [x] CHK-004 [P0] Prior execution packet read first. Evidence: `../001-execution/` docs reviewed.
<!-- /ANCHOR:pre-impl -->

...
- **Procedure**: Remove `002-native-rerun/` and remove `system-spec-kit/026-graph-and-context-optimization/007-code-graph/011-real-world-usefulness-test/002-native-rerun` from `../graph-metadata.json.children_ids`.
<!-- /ANCHOR:rollback -->
...
2. Remove `system-spec-kit/026-graph-and-context-optimization/007-code-graph/011-real-world-usefulness-test/002-native-rerun` from `../graph-metadata.json.children_ids`.

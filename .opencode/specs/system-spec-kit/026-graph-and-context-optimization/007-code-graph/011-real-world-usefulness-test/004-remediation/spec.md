...
| `specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/011-real-world-usefulness-test/004-remediation/*` | Create | Level 2 planning, decision, checklist, metadata, and implementation summary artifacts. |
| `specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/011-real-world-usefulness-test/graph-metadata.json` | Modify | Add `004-remediation` to `children_ids`. |
<!-- /ANCHOR:scope -->

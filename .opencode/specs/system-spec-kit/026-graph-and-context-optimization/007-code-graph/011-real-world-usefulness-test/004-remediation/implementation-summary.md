...
| `specs/.../011-real-world-usefulness-test/graph-metadata.json` | Modified | Added `004-remediation` child pointer. |
<!-- /ANCHOR:what-built -->
...
| Parent strict validation | PASS: `011-real-world-usefulness-test --strict` exited 0. |
<!-- /ANCHOR:verification -->

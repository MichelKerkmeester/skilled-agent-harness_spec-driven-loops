...
_memory:
  continuity:
    packet_pointer: ".opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/014-system-code-graph-extraction/011-skill-docs-sk-doc-alignment"
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/014-system-code-graph-extraction/011-skill-docs-sk-doc-alignment/` | Create | Track scope, plan, tasks and implementation evidence. |
<!-- /ANCHOR:scope -->

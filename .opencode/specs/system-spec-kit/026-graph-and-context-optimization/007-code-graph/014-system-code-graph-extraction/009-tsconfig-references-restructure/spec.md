...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/014-system-code-graph-extraction/009-tsconfig-references-restructure/` | Create | Track the scoped fix and verification evidence. |
<!-- /ANCHOR:scope -->
...
| REQ-005 | Packet docs validate | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/014-system-code-graph-extraction/009-tsconfig-references-restructure --strict` exits 0. |
<!-- /ANCHOR:requirements -->

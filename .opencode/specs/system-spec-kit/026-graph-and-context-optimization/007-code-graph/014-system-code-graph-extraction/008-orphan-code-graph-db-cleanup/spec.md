...
_memory:
  continuity:
    packet_pointer: ".opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/014-system-code-graph-extraction/008-orphan-code-graph-db-cleanup"
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/014-system-code-graph-extraction/008-orphan-code-graph-db-cleanup/` | Create | Track this cleanup packet and verification evidence. |
<!-- /ANCHOR:scope -->
...
| REQ-006 | Packet docs validate | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/014-system-code-graph-extraction/008-orphan-code-graph-db-cleanup --strict` exits 0. |
<!-- /ANCHOR:requirements -->

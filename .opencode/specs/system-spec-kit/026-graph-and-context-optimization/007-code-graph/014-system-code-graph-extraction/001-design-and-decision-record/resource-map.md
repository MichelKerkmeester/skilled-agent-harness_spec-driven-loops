...
| Path | Category | Disposition | Notes |
|------|----------|-------------|-------|
| This packet (014-system-code-graph-extraction/001-design-and-decision-record/) | spec | n/a | the research packet itself |
...
| `.../014-system-code-graph-extraction/001-design-and-decision-record/{spec,plan,tasks,checklist}.md` | meta | n/a | child packet docs |

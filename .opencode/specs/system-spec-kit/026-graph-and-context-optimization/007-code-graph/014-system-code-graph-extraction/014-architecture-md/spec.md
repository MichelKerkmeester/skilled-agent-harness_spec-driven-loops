...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/014-system-code-graph-extraction/014-architecture-md/` | Create | Level 1 packet docs and metadata. |
<!-- /ANCHOR:scope -->

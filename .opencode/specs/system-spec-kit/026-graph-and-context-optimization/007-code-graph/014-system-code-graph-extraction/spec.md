...
The 007 line — through `001-code-graph-upgrades`, `002-code-graph-context-and-scan-scope`, `007-code-graph-backend-resilience`, `010-broader-scope-excludes-and-granular-skills`, and `012-doctor-apply-mode-phase-b` — proved code-graph is empirically stable and well-instrumented; this is a structural cleanup, not a functional change.

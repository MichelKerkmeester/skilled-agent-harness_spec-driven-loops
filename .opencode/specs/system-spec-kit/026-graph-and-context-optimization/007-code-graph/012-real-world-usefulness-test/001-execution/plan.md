...
- **Procedure**: Remove `001-execution/` and remove `system-spec-kit/026-graph-and-context-optimization/007-code-graph/012-real-world-usefulness-test/001-execution` from `../graph-metadata.json.children_ids`.
<!-- /ANCHOR:rollback -->

...
```text
find .opencode/skill/system-spec-kit ... indexable extensions | wc -l => 4924
find .opencode/skill/system-spec-kit/mcp_server/code_graph ... -type f | wc -l => 97
```
...
## OPEN QUESTIONS
- Should the default scope become CWD-aware only when the active root is inside `.opencode/skill/system-spec-kit`, or should all `.opencode/skill/**` folders be included by default in this repository?

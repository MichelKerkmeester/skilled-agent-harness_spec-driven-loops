...
../002-native-rerun/synthesis-report-native-rerun.md:37-40 records Codex session-start --smoke as fixed and verified.
../002-native-rerun/synthesis-report-native-rerun.md:39-40 records Copilot offline preflight as fixed and verified.
../002-native-rerun/trials/trial-log.jsonl:12 records N-HK-005 codex_session_start_smoke_flag as verified.
../002-native-rerun/trials/trial-log.jsonl:13 records N-HK-006 copilot_offline_unauthenticated_preflight as verified.
```

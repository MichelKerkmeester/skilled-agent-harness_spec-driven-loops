...
```text
../002-native-rerun/synthesis-report-native-rerun.md:25-33 says native advisor routing was useful, with three live probes routing correctly.
../002-native-rerun/trials/trial-log.jsonl:8-10 records advisor_recommend probes for frontend motion, save context, and create spec folder as completed/useful.
```

...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/skill/system-spec-kit/mcp_server/code_graph/lib/tree-sitter-parser.ts"
...
3. `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/015-mcp-runtime-stress-remediation/001-search-intelligence-stress-test/001-scenario-design/scripts/run-all.sh`
4. `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/015-mcp-runtime-stress-remediation/010-stress-test-rerun-v1-0-2/scripts/run-all.sh`
5. `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/015-mcp-runtime-stress-remediation/011-post-stress-followup-research/research/run-iterations.sh`
6. `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/015-mcp-runtime-stress-remediation/011-post-stress-followup-research/review/run-iterations.sh`
...
9. `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/008-code-graph-backend-resilience/scratch/codex-runner.sh` (or equivalent: the 9-throw set is the steady-state intersection of the iter-005 100-loop run. exact membership is identifiable by replaying the iter-005 harness with file-level B1 logging: see Note below)
...
- `001-execution`, `002-native-rerun`, `003-deep-research-issues`: sibling packets that surfaced the parser-crash signal
- `004-remediation`, `005-scope-guard`, `006-cluster-a-to-e`: closed F-002/F-003/F-008/F-011/F-018/F-019 via Path 3 native subagents
<!-- /ANCHOR:citations -->

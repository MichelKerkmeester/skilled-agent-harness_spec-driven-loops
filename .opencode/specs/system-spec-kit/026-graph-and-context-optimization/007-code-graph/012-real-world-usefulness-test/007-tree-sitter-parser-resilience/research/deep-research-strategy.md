...
- **Iter 3:** Marker-search (`findRepoRoot()` walking up looking for `.opencode/skill/system-spec-kit/mcp_server/package.json`) replaced relative-path counting in the harness: robust against future moves of the script. Worth carrying into iter 4 fixtures.

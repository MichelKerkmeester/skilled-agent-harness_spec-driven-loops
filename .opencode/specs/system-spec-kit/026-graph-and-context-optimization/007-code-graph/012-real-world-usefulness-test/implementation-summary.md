...
| Field | Value |
|-------|-------|
| **Spec Folder** | `specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/012-real-world-usefulness-test` |
...
| Parent metadata assertion | PASS, `children_ids` includes `system-spec-kit/026-graph-and-context-optimization/007-code-graph/012-real-world-usefulness-test`. |
<!-- /ANCHOR:verification -->

...
- [x] T002 Read prior sandbox execution packet. Evidence: `../001-execution/` docs reviewed before authoring.
- [x] T003 Reuse existing scaffold. Evidence: `trials/raw/` and `analysis/` existed before packet authoring.
- [x] T004 Update parent graph metadata with `002-native-rerun`. Evidence: `../graph-metadata.json.children_ids`.
<!-- /ANCHOR:phase-1 -->

...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/007-code-graph/009-fix-iteration-quality-meta-research"
...
| Field | Value |
|-------|-------|
| Spec Folder | 009-fix-iteration-quality-meta-research |

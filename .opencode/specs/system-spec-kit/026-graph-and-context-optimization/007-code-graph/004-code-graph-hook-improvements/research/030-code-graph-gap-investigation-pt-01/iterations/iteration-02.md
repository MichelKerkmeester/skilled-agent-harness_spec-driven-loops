...
- Exact cross-reference scans:
  - `rg -n 'mcp_server/tests/code-graph-indexer\.vitest\.ts|mcp_server/tests/code-graph-seed-resolver\.vitest\.ts|mcp_server/tests/code-graph-siblings-readiness\.vitest\.ts' .opencode/skills/system-spec-kit/feature_catalog .opencode/skills/system-spec-kit/manual_testing_playbook -g '!**/dist/**'`
  - `rg --files .opencode/skills/system-spec-kit/mcp_server | rg 'code-graph-indexer\.vitest\.ts$|code-graph-seed-resolver\.vitest\.ts$|code-graph-siblings-readiness\.vitest\.ts$'`
  - `rg -n 'code_graph_status|code_graph_context|readiness|trustState|lastPersistedAt|requiredAction|graphAnswersOmitted' .opencode/skills/system-spec-kit/feature_catalog/22--context-preservation-and-code-graph -g '!**/dist/**'`

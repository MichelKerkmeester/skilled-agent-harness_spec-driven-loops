...
- Final README-family grep:
  - `rg -n "code_graph_status|code_graph_context|report graph health and statistics|LLM-oriented compact graph neighborhoods" .opencode/skills/system-spec-kit/mcp_server/code-graph/handlers/README.md .opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts .opencode/skills/system-spec-kit/mcp_server/README.md`

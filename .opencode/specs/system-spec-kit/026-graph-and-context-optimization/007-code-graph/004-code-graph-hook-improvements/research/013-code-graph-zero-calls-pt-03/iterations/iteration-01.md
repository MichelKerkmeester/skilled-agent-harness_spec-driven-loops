...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-package/013-code-graph-hook-improvements/code-graph-zero-calls-investigation.md`
- `.opencode/skills/system-spec-kit/mcp_server/code-graph/lib/structural-indexer.ts`
- `.opencode/skills/system-spec-kit/mcp_server/code-graph/lib/tree-sitter-parser.ts`
...
- The symptom is not explained by a read-side filter in `calls_from` or `calls_to`; those handlers do not drop valid CALLS edges by kind or provenance after subject resolution [.opencode/skills/system-spec-kit/mcp_server/code-graph/lib/code-graph-db.ts:515-550,.opencode/skills/system-spec-kit/mcp_server/code-graph/handlers/query.ts:762-823].

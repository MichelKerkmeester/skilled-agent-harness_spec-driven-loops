...
- `computeEdgeShare()`, `computePSI()`, and `computeJSD()` are pure exported helpers in `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/edge-drift.ts:26-74`, so they are testable in isolation. The maintainability debt is concentrated in the verification surface, not the drift math helpers.
...
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/detect-changes.ts:102-110,257-264`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/index.ts:1-9`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/query.ts:1040-1447`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/scan.ts:1-317`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/status.ts:1-229`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/verify.ts:1-112`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/code-graph-db.ts:117-130,216-223,284-301,410-475`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/edge-drift.ts:1-74`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/ensure-ready.ts:33-39,103-140,343-442`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/gold-query-verifier.ts:1-509`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/indexer-types.ts:15-27,90-97`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/structural-indexer.ts:43-63,73-80,156-169,735-778,916-1128,1391-1859,1913-1927`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/tree-sitter-parser.ts:26-33,301-307,364-482,626-697`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/tools/code-graph-tools.ts:1-78`
- `.opencode/skills/system-spec-kit/mcp_server/lib/architecture/layer-definitions.ts:103-117`
- `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:558-657,941`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/tests/code-graph-verify.vitest.ts:1-324`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/tests/code-graph-scan.vitest.ts:1-239`
- `.opencode/skills/system-spec-kit/mcp_server/code_graph/tests/code-graph-query-handler.vitest.ts:126,594,685-716`

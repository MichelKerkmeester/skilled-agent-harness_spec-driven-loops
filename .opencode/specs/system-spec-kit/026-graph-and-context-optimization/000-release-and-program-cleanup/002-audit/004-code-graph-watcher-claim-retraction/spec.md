...
- Packet-local docs under this `004-code-graph-watcher-claim-retraction/` folder
...
| Dependency | Strict validator | Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/004-code-graph-watcher-claim-retraction --strict` |
<!-- /ANCHOR:risks -->

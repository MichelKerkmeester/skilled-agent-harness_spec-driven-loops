...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/004-fix-deep-research-findings/001-fix-code-graph-consistency"
    ...
    session_dedup:
      ...
      session_id: "049-001-fix-code-graph-consistency"
...
- Worked-pilot pattern: `../004-fix-validation-memory/` (commit `1822a1e69`)
- Older pilot: `../010-fix-cli-orchestrator-doc-drift/` (commit `889d1ee08`)
<!-- /ANCHOR:cross-refs -->

...
[
  {
    "findingId": "F002",
    "claim": "The active dependency metadata in 002-memory-write-safety points at 027/009-feedback-reducers even though the current reducer phase is 008-learning-feedback-reducers.",
    "evidenceRefs": [
      ...
      ".opencode/specs/system-spec-kit/027-xce-research-based-refinement/008-learning-feedback-reducers/spec.md:37"
    ],
...
- 008 correctly records `002-memory-write-safety` as a hard dependency in its own metadata. [SOURCE: `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/008-learning-feedback-reducers/spec.md:37`]

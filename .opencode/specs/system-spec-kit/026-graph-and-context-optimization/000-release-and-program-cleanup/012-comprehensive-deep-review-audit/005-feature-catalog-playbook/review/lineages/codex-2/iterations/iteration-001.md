...
```json
{
  ...
  "evidenceRefs": [
    ...
    ".opencode/skills/system-spec-kit/feature_catalog/16--tooling-and-scripts/247-embedder-status-and-active-pointer.md:42",
...
```json
{
  ...
  "evidenceRefs": [
    ".opencode/skills/system-spec-kit/feature_catalog/16--tooling-and-scripts/214-feature-catalog-code-references.md:30",
    ".opencode/skills/system-spec-kit/feature_catalog/feature_catalog.md:3950",

...
That prevents escalation of P1-005 into a broader "annotation names invalid" finding. The problem remains the dedicated scenario contract text [SOURCE: .opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/232-feature-catalog-annotation-name-validity.md:18].

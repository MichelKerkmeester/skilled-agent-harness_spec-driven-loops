...
ROOT="$(cd "${SCRIPT_DIR}/../.." && pwd)"   # .../001-search-intelligence-stress-playbook
RUNS_DIR="${ROOT}/002-search-scenario-execution/runs"
PROMPTS_DIR="${ROOT}/001-search-scenario-design/scripts/prompts"
LOG_FILE="${ROOT}/002-search-scenario-execution/runs/run-all.log"

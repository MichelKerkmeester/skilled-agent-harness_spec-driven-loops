...
- Findings:
  ...
  7. Code-authoring skills (`sk-code`, `sk-code-review`, `sk-doc`, `sk-prompt`, `sk-prompt-small-model`) have **no doctor diagnostic target**. Failure modes undiagnosed: convention template drift, surface-detection marker staleness. [HIGH]

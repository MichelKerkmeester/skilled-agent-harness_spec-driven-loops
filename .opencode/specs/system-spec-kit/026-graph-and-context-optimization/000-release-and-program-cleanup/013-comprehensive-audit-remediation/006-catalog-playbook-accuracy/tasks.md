...
- [x] T002 F7: Qualify cleanup-complete claim in leaf file (214-feature-catalog-code-references.md line 30)
- [x] T003 F6: Fix stale implementation paths in local-LLM category overview (313-category-overview.md lines 40-47)
...
- [x] T013 F5: Fix garbled Real user request + Expected signals in scenario 232 (232-feature-catalog-annotation-name-validity.md lines 18, 21)
- [x] T014 F9: Update scenario numbers 401-415 -> 361-375 in playbook 24 README
- [x] T015 F9: Update scenario range in 313-category-overview.md line 47
- [x] T016 F8: Fix verifier path in scenario 234 line 38 (234-module-header-compliance-via-verify-alignment-drift-py.md)

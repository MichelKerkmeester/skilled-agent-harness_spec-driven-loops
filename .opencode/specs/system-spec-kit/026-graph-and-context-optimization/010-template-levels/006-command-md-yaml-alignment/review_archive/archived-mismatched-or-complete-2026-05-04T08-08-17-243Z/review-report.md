...
|----|-----|-----------|-------|----------|-------------|
| F001 | P1 | traceability | Target packet remains scaffold placeholders rather than an implementation-ready spec | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-template-levels/007-fleet-marker-validation-sweep/spec.md:55` | active |
| F002 | P1 | traceability | Requirements table has placeholder requirements with no acceptance contract | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-template-levels/007-fleet-marker-validation-sweep/spec.md:116` | active |
| F003 | P1 | maintainability | Level 3 AI protocol coverage is hidden in marker comments instead of executable review sections | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-template-levels/007-fleet-marker-validation-sweep/plan.md:279` | active |
| F004 | P1 | traceability | Strict validation currently fails for the target packet | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-template-levels/007-fleet-marker-validation-sweep/spec.md:240` | active |
| F005 | P2 | maintainability | Nested packet metadata does not record its parent chain | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-template-levels/007-fleet-marker-validation-sweep/description.json:10` | active |

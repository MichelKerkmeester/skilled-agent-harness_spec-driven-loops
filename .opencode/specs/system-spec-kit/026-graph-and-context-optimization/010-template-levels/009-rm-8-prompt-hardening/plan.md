...
- [ ] Smoke run on `013-doctor-update-orchestrator` (the worktree-isolated dispatch) shows no out-of-scope writes
<!-- /ANCHOR:quality-gates -->
...
- [ ] Post-dispatch `git status` clean outside `013-doctor-update-orchestrator/review/`
<!-- /ANCHOR:phases -->

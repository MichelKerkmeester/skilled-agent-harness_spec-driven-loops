...
- [ ] T008 Smoke-test: dispatch `/spec_kit:deep-review:auto` on `013-doctor-update-orchestrator` phase parent inside isolated worktree using cli-opencode + deepseek/deepseek-v4-pro (this is the run that motivated this packet — verification is in-band)
- [ ] T009 Post-dispatch: `git status -- 013-doctor-update-orchestrator/` shows no surprise writes outside `013-doctor-update-orchestrator/review/`

...
- Spec folder: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/001-code-graph-upgrades/` (PRE-APPROVED, skip Gate 3)
...
1. `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/001-code-graph-upgrades/spec.md` — packet scope, requirements (REQ-001..REQ-009), acceptance scenarios
2. `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/001-code-graph-upgrades/plan.md` — phases, execution rules, dependency matrix
3. `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/001-code-graph-upgrades/tasks.md` — the 9 roadmap tasks
4. `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/001-code-graph-upgrades/decision-record.md` — ADR-001 (011 dependency), ADR-002 (008 non-overlap), ADR-003 (prototype-later boundaries), ADR-004 (side-branch placement)
...
Edit `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-code-graph/001-code-graph-upgrades/spec.md`:

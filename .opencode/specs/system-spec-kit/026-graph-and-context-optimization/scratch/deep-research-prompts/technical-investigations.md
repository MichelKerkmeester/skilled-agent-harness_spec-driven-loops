...
**Example filled-in:**
```
/spec_kit:deep-research :auto "Compare the claims in .opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-parity/001-hook-parity-remediation/spec.md against the actual implementation of .opencode/skills/system-spec-kit/mcp_server/hooks/codex/**/*.ts. ..." --max-iterations=12 ...
```

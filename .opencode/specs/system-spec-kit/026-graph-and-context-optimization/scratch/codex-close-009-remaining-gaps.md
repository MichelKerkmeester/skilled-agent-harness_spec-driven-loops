...
1. The wild-verified successful save (your ground truth for what the current pipeline produces):
   - `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-code-graph-upgrades/memory/09-04-26_12-40__shipped-the-014-code-graph-upgrades-runtime-lane.md`
...
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js \
  ...
  /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-code-graph-upgrades
```

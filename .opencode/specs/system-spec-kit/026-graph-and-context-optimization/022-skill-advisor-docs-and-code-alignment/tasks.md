...
- [x] T020 [P0] Run `validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/022-skill-advisor-docs-and-code-alignment --strict --no-recursive` clean [Evidence: strict validation returned errors=0, warnings=0]

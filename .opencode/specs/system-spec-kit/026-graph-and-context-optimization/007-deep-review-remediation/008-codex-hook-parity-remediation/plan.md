...
Added the cli-codex hook contract reference, updated cli-codex skill and README surfaces, updated parent handover, and recorded checklist/task evidence.
<!-- /ANCHOR:phases -->

...
_memory:
  continuity:
    ...
    last_updated_at: "2026-04-22T12:45:00Z"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 008-codex-hook-parity-remediation |
...
The cli-codex skill and README now document native hooks, troubleshooting, and the hook contract reference. The parent handover records the phase outcome.

...
_memory:
  continuity:
    ...
    last_updated_at: "2026-04-23T11:03:20Z"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 013-claude-hook-findings-remediation |
...
| Strict spec validation | `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-deep-review-remediation/013-claude-hook-findings-remediation --strict --no-recursive` | To run after checklist/task updates and cleanup |
<!-- /ANCHOR:verification -->

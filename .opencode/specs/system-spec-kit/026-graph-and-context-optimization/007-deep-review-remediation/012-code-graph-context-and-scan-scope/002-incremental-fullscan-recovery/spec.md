...
| **Created** | 2026-04-23 |
| **Branch** | `UNKNOWN` |
| **Parent Packet** | `012-code-graph-context-and-scan-scope` |
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-deep-review-remediation/012-code-graph-context-and-scan-scope/002-incremental-fullscan-recovery/` | Create | Level 3 documentation packet. |
<!-- /ANCHOR:scope -->

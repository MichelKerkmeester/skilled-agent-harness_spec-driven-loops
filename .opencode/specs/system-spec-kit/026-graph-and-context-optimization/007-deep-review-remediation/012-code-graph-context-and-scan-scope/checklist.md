...
- [x] **P1-06** Parent handover updated with 012 row. [EVIDENCE: `../handover.md` contains the `012-code-graph-context-and-scan-scope` row in the Files Modified table.]
<!-- /ANCHOR:pre-impl -->
...
- [x] **P1-F03** Spec packet docs remain in this child phase folder. [EVIDENCE: `implementation-summary.md`, `tasks.md`, and `checklist.md` updated under `.../012-code-graph-context-and-scan-scope/`.]
<!-- /ANCHOR:file-org -->

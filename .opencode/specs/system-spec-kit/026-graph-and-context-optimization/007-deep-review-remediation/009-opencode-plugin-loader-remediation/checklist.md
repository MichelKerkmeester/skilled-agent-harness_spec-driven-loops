...
_memory:
  continuity:
    ...
    recent_action: "Checklist populated with implementation evidence; one out-of-scope full-suite blocker remains"
...
- [ ] **P1-04** No vitest regression elsewhere. [EVIDENCE: deferred — see implementation-summary.md Known Limitations item 1; out-of-scope Copilot hook wiring blocker tracked in parent 007-deep-review-remediation handover.md as priority follow-up.]
...
- [x] **P1-CQ03** Each relocated helper has a top-of-file comment explaining why it lives outside `.opencode/plugins/`. [EVIDENCE: first comment block in all three relocated helpers references packet 026/007/009.]
<!-- /ANCHOR:code-quality -->

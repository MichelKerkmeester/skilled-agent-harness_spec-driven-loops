...
_memory:
  continuity:
    ...
    completion_pct: 0
---
# Decision Record: 009-security-and-guardrails Security and Guardrails Remediation
<!-- SPECKIT_LEVEL: 3 -->
...
**We chose**: Keep Security and Guardrails as one remediation-owned Level 3 packet.

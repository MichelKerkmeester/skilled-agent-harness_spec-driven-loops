...
| Dependency | Status |
|------------|--------|
| Phase 5 baseline (23 tests, fixed metrics, fixed event listener) | Shipped in packet 009 |
| Vitest already configured | Yes |
| OpenCode plugin API stable | Yes (Hooks interface verified in 009 ADR-001) |
<!-- /ANCHOR:dependencies -->

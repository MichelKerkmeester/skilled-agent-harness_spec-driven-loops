...
- [x] **P1-03** Strict spec validation. [EVIDENCE: final `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .../010-skill-advisor-plugin-hardening --strict` returned 0 errors / 0 warnings.]
...
- [x] **P1-05** Parent handover updated with 010 phase outcome row. [EVIDENCE: `../handover.md` includes a 010 row under Files Modified and session notes.]
<!-- /ANCHOR:pre-impl -->
...
- [x] **P2-D01** Inline JSDoc comment above the per-instance `state` object explains why state was moved out of module scope (cite packet 010 + sibling 009 ADR-005). [EVIDENCE: plugin comment above `state` cites packet 010 and sibling 009 ADR-005.]
...
- [x] **P1-F03** Spec packet docs remain in this child phase folder. [EVIDENCE: `spec.md`, `plan.md`, `tasks.md`, `checklist.md`, and `implementation-summary.md` remain in `010-skill-advisor-plugin-hardening/`.]
<!-- /ANCHOR:file-org -->

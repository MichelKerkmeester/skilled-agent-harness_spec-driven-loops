...
- **`.opencode/specs/system-spec-kit/026-graph-and-context-optimization/015-implementation-deep-review/implementation-summary.md`** — Summarizes the 120-iteration review, the 243 findings, and the planned remediation workstreams.

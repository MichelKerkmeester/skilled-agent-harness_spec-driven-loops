---
title: "Feature Specification: Doctor Cutover Phase 2 [system-spec-kit/026-graph-and-context-optimization/010-doctor-update-orchestrator/004-cutover-doctor-router-from-legacy-files/spec]"
...
| **Branch** | `main` |
| **Parent Spec** | ../spec.md |
| **Predecessor** | `../003-skill-advisor-routing-engine-consolidation/spec.md` |

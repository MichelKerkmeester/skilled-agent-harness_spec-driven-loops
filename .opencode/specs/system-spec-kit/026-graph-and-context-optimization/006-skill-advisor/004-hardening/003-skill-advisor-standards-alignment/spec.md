---
title: "F [system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/003-skill-advisor-standards-alignment/spec]"
...
| **Parent Spec** | `../spec.md` |
| **Predecessor** | `../002-skill-advisor-plugin-hardening/spec.md` |
| **Successor** | `../../007-hook-parity/006-copilot-wrapper-schema-fix/spec.md` |
| **Related** | `006-skill-advisor-plugin-hardening/` (audit source) |
<!-- /ANCHOR:metadata -->
...
- Source packet (audit): `../002-skill-advisor-plugin-hardening/`

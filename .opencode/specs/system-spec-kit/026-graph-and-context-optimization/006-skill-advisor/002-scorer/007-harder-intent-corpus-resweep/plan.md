...
3. Emit `007-harder-intent-corpus-resweep/research/sweep-results-harder.md` with per-vector accuracy on the harder set + per-case routing diffs + a comparison column to the 015/006 baseline (which was the original 24).

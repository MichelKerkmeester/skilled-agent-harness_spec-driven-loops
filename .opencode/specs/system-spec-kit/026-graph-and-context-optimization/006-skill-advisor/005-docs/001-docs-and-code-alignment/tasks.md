---
title: "...ec-kit/026-graph-and-context-optimization/006-skill-advisor/001-docs-and-code-alignment/tasks]"
...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/001-docs-and-code-alignment"
...
- [x] T020 [P0] Run `validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/001-docs-and-code-alignment --strict --no-recursive` clean [Evidence: strict validation returned errors=0, warnings=0]
...
- Spec: `spec.md`
- Parent: `../../006-skill-advisor/004-skill-advisor-hook-surface/implementation-summary.md`

...
- Iteration-006 found db-path-policy.md and standalone-mcp-shape.md are consistent with current implementation, with system-spec-kit references being intentional boundary documentation <ref_file file="/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-docs/004-docs-quality-refactor/001-audit-and-research/research/iterations/iteration-006.md" lines="51-80" />

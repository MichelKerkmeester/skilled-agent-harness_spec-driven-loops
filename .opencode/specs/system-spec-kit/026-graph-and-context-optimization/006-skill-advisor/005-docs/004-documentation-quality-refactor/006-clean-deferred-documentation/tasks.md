...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-docs/004-documentation-quality-refactor/006-clean-deferred-documentation"
...
- [ ] T004 [Tier A] F33: add SOURCE FILES section to `manual_testing_playbook/01--native-mcp-tools/007-skill-graph-status.md`
- [ ] T005 [Tier A] F33: add SOURCE FILES section to `008-skill-graph-query.md`
- [ ] T006 [Tier A] F33: add SOURCE FILES section to `009-skill-graph-validate.md`

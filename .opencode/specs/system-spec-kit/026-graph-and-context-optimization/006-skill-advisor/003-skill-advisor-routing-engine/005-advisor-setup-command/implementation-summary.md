...
trigger_phrases:
  ...
  - "005-advisor-setup-command implementation summary"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 005-advisor-setup-command |
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-advisor-setup-command/implementation-summary.md` | Created | This file |
<!-- /ANCHOR:what-built -->

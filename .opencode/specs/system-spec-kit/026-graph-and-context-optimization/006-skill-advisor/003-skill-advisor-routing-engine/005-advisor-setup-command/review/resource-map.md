---
title: "Resource Map: 005-advisor-setup-command Deep Review"
...
trigger_phrases:
  - "005-advisor-setup-command resource map"
  - "skill advisor setup command review resources"
importance_tier: "important"
contextType: "review"
---
# Resource Map: 005-advisor-setup-command Deep Review
...
### Top-level
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-advisor-setup-command/review/review-report.md` (this report's companion)
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-advisor-setup-command/review/resource-map.md` (this file)
...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-advisor-setup-command --strict

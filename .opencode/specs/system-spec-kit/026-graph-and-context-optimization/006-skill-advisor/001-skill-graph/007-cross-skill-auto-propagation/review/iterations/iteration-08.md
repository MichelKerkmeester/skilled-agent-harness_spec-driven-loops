...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/007-cross-skill-auto-propagation/spec.md:210-222` (Edge Cases section — same-family circular, empty enhances, malformed JSON, write denied)
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/007-cross-skill-auto-propagation/plan.md:199-227` (scoreFamilyInference plan sketches)
...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/007-cross-skill-auto-propagation/review/iterations/iteration-06.md:1-334` (F-06-004 — silent null returns from metadata loader)

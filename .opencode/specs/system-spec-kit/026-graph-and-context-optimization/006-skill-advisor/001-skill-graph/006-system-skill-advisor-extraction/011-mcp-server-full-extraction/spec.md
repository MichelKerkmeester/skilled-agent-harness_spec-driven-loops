...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/006-system-skill-advisor-extraction/011-mcp-server-full-extraction"
...
| `.opencode/specs/.../011-mcp-server-full-extraction/**` | Create | Packet docs and promoted council research artifact. |
<!-- /ANCHOR:scope -->

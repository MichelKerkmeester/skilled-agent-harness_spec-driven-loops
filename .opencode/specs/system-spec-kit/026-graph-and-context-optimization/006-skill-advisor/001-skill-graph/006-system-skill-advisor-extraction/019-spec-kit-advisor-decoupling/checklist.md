...
- [x] CHK-001 [P0] Existing 019 packet confirmed at the post-dissolution `006-system-skill-advisor-extraction/019-spec-kit-advisor-decoupling` path.
...
- [x] CHK-012 [P1] Advisor lane sweep fixture paths now point to current packets `006-corpus-seeded-sweep` and `007-harder-intent-corpus-resweep`.

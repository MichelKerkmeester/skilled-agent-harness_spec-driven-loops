...
|---------|--------------|--------|--------------|
| `.opencode/specs/.../006-system-skill-advisor-extraction/handover.md` | Target surface | Modify | Focused tests and strict validation |
| `.opencode/specs/.../006-system-skill-advisor-extraction/graph-metadata.json` | Target surface | Modify | Focused tests and strict validation |
<!-- /ANCHOR:affected-surfaces -->

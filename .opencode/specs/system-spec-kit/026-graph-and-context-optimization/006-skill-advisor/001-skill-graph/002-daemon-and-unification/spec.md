---
title: "...ec-kit/026-graph-and-context-optimization/006-skill-advisor/002-daemon-and-unification/spec]"
...
| **Successor** | `../../007-hook-parity/001-hook-parity-remediation/spec.md` |
<!-- /ANCHOR:metadata -->
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/002-daemon-and-unification/**` | Modify | Phase 027 packet evidence and strict validation shape. |
<!-- /ANCHOR:scope -->

...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-package/002-daemon-and-unification/003-native-advisor-core/spec.md`
...
- `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/scorer/ambiguity.ts`
- `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/scorer/attribution.ts`
- `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/promotion/gate-bundle.ts`
- `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/promotion/semantic-lock.ts`

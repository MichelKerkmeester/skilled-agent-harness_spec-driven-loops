...
4. `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/generation.ts`
5. `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/freshness.ts`
6. `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/freshness/generation.ts`
7. `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/handlers/advisor-status.ts`
8. `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/daemon/lifecycle.ts`
9. `.opencode/skills/system-spec-kit/mcp_server/tests/advisor-freshness.vitest.ts`
10. `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/tests/daemon-freshness-foundation.vitest.ts`
...
- **R8-P2-001 — advisor freshness ownership is split across two persisted generation ledgers with overlapping names.**
  ...
  - **evidenceRefs:** [SOURCE: `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/generation.ts:44-49`], [SOURCE: `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/generation.ts:167-191`], [SOURCE: `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/freshness.ts:16-20`], [SOURCE: `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/freshness/generation.ts:7-8`], [SOURCE: `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/freshness/generation.ts:56-99`], [SOURCE: `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/handlers/advisor-status.ts:8-9`], [SOURCE: `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/daemon/lifecycle.ts:4-5`], [SOURCE: `.opencode/skills/system-spec-kit/mcp_server/tests/advisor-freshness.vitest.ts:16-24`], [SOURCE: `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/tests/daemon-freshness-foundation.vitest.ts:14-17`]

...
| REQ-004 | Packet 014 strict validation passes. | `validate.sh 014-manual-testing-playbook-validation --strict` exits 0. |
...
| REQ-006 | Parent and lane validation are not regressed. | Strict validation passes for parent `009-system-skill-advisor-extraction` and lane `002-semantic-routing-lane`. |

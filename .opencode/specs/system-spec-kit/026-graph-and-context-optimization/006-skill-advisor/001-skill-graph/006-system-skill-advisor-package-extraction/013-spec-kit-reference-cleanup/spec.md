...
| **Created** | 2026-05-14 |
| **Branch** | `main` |
| **Spec Folder** | `013-spec-kit-reference-cleanup` |
<!-- /ANCHOR:metadata -->
...
- Scaffold this Level 2 packet under `013/009/013-spec-kit-reference-cleanup`.
...
|-----------|-------------|-------------|
| `.opencode/specs/.../013-spec-kit-reference-cleanup/*.md` | Create/modify | Level 2 packet documentation and evidence. |
| `.opencode/specs/.../013-spec-kit-reference-cleanup/{description,graph-metadata}.json` | Create/modify | Packet metadata mirrored from 010 shape. |
...
| REQ-004 | Strict validation passes for this packet. | `validate.sh <013-spec-kit-reference-cleanup> --strict` exits 0. |
...
- **SC-003**: Strict validation for `013-spec-kit-reference-cleanup` passes.

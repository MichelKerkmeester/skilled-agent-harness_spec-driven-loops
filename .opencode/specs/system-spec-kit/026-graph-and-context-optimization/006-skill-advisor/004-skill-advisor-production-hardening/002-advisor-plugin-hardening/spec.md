---
title: "Feat [system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/002-advisor-plugin-hardening/spec]"
...
| **Parent Spec** | `../spec.md` |
| **Predecessor** | `../../007-hook-parity/005-opencode-plugin-loader-bridge-fixes/spec.md` |
| **Successor** | `../003-advisor-standards-alignment/spec.md` |
...
- Sibling packet (source of deferrals): `../../007-hook-parity/005-opencode-plugin-loader-bridge-fixes/decision-record.md` ADR-005

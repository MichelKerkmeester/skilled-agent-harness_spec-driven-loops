...
**GATE 3 PRE-ANSWERED — A**: `specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/004-skill-advisor-hook-surface`. Pre-approved. Proceed directly.
...
1. **Read inputs**:
   - `specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/004-skill-advisor-hook-surface/{spec,plan,tasks,checklist,implementation-summary,decision-record,handover,battle-plan}.md`
...
3. **Output review-report.md** at `specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/004-skill-advisor-hook-surface/review/004-skill-advisor-hook-surface-tier2-pt-01/review-report.md`

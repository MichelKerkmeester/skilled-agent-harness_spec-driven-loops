...
{
  "planningPacket": {
    "suggestedSpecFolder": "specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/004-skill-advisor-hook-surface/010-copilot-current-turn-contract",

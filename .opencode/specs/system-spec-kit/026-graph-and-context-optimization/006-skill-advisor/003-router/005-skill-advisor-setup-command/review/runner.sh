#!/usr/bin/env bash
# Sequential cli-copilot deep-review runner for 005-skill-advisor-setup-command
...
PACKET="$REPO_ROOT/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command"

...
- F-CORR-010: Confirm mode inherits the graph-metadata scoring-source field mismatch already proven for auto mode.
  - Evidence: `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:138-140`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:73-75`, `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/iterations/iteration-002.md:17-20`
...
- F-CORR-011: Confirm mode's per-lane approval option can still lead to unconditional Phase 3 lane edits.
  - Evidence: `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:85-91`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:201-206`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:243-247`, `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/iterations/iteration-002.md:39-42`
...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/deltas/iteration-002.json:1-59`
...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/prompts/iteration-003.md:1-33`

...
- Parent doc updates: `006-skill-advisor/{context-index.md, spec.md, tasks.md}` (counts and entries match)
- Nested changelog at `006-skill-advisor/changelog/changelog-008-012-*.md` matches implementation-summary
...
3. `006-skill-advisor/{context-index.md, spec.md, tasks.md}`
4. `006-skill-advisor/changelog/changelog-008-005-skill-advisor-setup-command.md`

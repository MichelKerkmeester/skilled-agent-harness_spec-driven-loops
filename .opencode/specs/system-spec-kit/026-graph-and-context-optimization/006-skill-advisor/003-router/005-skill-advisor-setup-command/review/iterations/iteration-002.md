...
Iteration 1 already recorded the command/YAML dry-run mismatch as F-CORR-003, including `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:135` and `:151`. This iteration does not duplicate that finding; it treats dry-run as covered unless additional YAML-only contradictions are found.
...
- F-CORR-005: The auto workflow names graph-metadata fields that do not match real skill `graph-metadata.json` files or the advisor projection reader.
  - Evidence: `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:73`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:74`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:75`, `.opencode/skills/system-spec-kit/graph-metadata.json:44`, `.opencode/skills/system-spec-kit/graph-metadata.json:45`, `.opencode/skills/system-spec-kit/graph-metadata.json:59`, `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/projection.ts:234`, `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/projection.ts:235`, `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/projection.ts:236`, `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/projection.ts:237`, `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/projection.ts:238`, `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/projection.ts:239`, `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/projection.ts:240`
...
- F-CORR-006: Mutation-boundary enforcement is declared, but Phase 3 has no concrete allowlist/denylist validation step before writes.
  - Evidence: `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:49`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:50`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:54`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:58`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:132`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:136`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:137`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:138`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:146`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:147`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:148`
...
- F-CORR-007: Graph-scan failure handling is internally contradictory between the hard post-verify gate, Phase 4 fail handling, and `error_recovery`.
  - Evidence: `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:181`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:183`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:186`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:188`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:165`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:167`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:221`
...
- F-CORR-008: The confidence framework is not connected to proposal outputs or the pre-apply quality gate, so its thresholds cannot be enforced.
  - Evidence: `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:201`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:202`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:203`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:204`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:205`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:206`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:125`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:126`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:127`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:128`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:176`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:177`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:178`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:179`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:230`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:231`
...
- F-CORR-009: Scope filtering is asserted in Phase 2, quality gates, and rules, but Phase 3 activities are written as unconditional edits across all lanes.
  - Evidence: `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:40`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:41`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:42`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:43`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:44`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:123`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:136`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:137`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:138`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:179`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:250`
...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/deltas/iteration-001.json:1-48`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/deep-review-state.jsonl:1-3`
...
- `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/lanes/lexical.ts:1-92`
- `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/weights-config.ts:1-50`
- `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/lanes/derived.ts:1-68`
- `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/fusion.ts:1-368`
- `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/projection.ts:1-283`
- `.opencode/skills/system-spec-kit/graph-metadata.json:1-157`

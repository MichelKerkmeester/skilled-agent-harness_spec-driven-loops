...
- F-SEC-001: Autonomous proposal generation reads untrusted SKILL.md frontmatter without an explicit data-only/prompt-injection boundary while the command grants broad mutating tools.
  - Evidence: `.opencode/commands/spec_kit/skill-advisor.md:4`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:14-15`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:85`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:120`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:136-138`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:150`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:204-206`
...
- F-SEC-002: Mutation-boundary enforcement lacks canonical target-path validation, leaving traversal/out-of-bound proposal targets under-specified.
  - Evidence: `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:49-58`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:126-128`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:136-138`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:173-180`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:49-58`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:191-194`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:204-206`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:239-247`
  - Impact: The workflows declare allowed and forbidden targets, but neither Phase 2 outputs nor pre-Phase 3 gates require resolving every proposal target through `realpath`, proving it remains under the repository root, rejecting `..` segments/symlinks, and matching an exact allowlist. This is the security form of the earlier mutation-boundary finding: a malicious or malformed proposal can name a path that looks like `.opencode/skills/*/graph-metadata.json` but resolves outside the intended write set.
  - Remediation: Add a hard pre-apply step that canonicalizes each proposed target, rejects absolute paths, `..`, symlinks escaping the repo root, and any path not exactly equal to the two scorer files or a real `.opencode/skills/<name>/graph-metadata.json`; abort before any write on the first violation.
...
- F-SEC-003: Rollback instructions use broad `git checkout HEAD --` paths without a clean-tree/snapshot guard, so recovery can destroy unrelated WIP.
  - Evidence: `.opencode/commands/spec_kit/skill-advisor.md:37`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:149`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:111`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:216`, `.opencode/install_guides/SET-UP - Skill Advisor.md:30-35`, `.opencode/install_guides/SET-UP - Skill Advisor.md:112-118`
  - Impact: The rollback command resets the whole skill-advisor lib directory and every `.opencode/skills/*/graph-metadata.json` path to HEAD. If a user has unrelated uncommitted edits in any of those paths, following the documented rollback loses them. The spec requires rollback instructions, but does not require a clean working tree or backup before applying rollback.
...
- F-SEC-004: The cli-copilot review runner grants all tools and disables user prompts for nominally read-only review iterations.
  - Evidence: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/runner.sh:38-43`, `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/runner.sh:45-50`
...
- F-SEC-005: Proposal diffs are written under `/tmp` without a private-file mode or repo-local scratch contract.
  - Evidence: `.opencode/commands/spec_kit/skill-advisor.md:185`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:130`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:84`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:188`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:194`, `.opencode/install_guides/SET-UP - Skill Advisor.md:129`
...
- F-SEC-006: TOKEN_BOOSTS / PHRASE_BOOSTS proposal validation checks collisions, but not literal/schema safety before editing TypeScript source.
  - Evidence: `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:120-128`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:136`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:183-194`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:204`, `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/lanes/explicit.ts:8`, `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/lanes/explicit.ts:76`
...
- No regex injection path was confirmed in the current scorer: PHRASE_BOOSTS entries are matched with `lower.includes(phrase)`, TOKEN_BOOSTS are looked up from tokenized prompt tokens, and the reusable phrase-boundary regex helper escapes dynamic phrase text before building a RegExp. Evidence: `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/lanes/explicit.ts:149-158`, `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/text.ts:63-67`.
- The command-level `--scope` flag itself is not a path traversal input because it is documented as a closed enum (`all|explicit|derived|lexical`) in the command markdown and both YAML workflows. Evidence: `.opencode/commands/spec_kit/skill-advisor.md:64`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:28`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:40-44`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:28`, `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:40-44`.
- The required NFR-S section covers credential absence and confirm-mode approval, but it does not yet cover prompt-injection treatment of skill metadata, temp-file confidentiality, target canonicalization, or rollback clean-tree safety. Evidence: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/spec.md:176-179`.
...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/deep-review-strategy.md:1-103`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/deep-review-state.jsonl:1-4`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/iterations/iteration-001.md:1-48`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/iterations/iteration-002.md:1-77`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/logs/iteration-003.log:170-316`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/prompts/iteration-003.md:1-34`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/prompts/iteration-004.md:1-36`
- `.opencode/commands/spec_kit/skill-advisor.md:1-320`
- `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_auto.yaml:1-259`
- `.opencode/commands/spec_kit/assets/spec_kit_skill-advisor_confirm.yaml:1-309`
- `.opencode/install_guides/SET-UP - Skill Advisor.md:1-145`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/spec.md:169-183`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/runner.sh:1-73`
- `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/lanes/explicit.ts:1-198`
- `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/lib/scorer/text.ts:1-106`

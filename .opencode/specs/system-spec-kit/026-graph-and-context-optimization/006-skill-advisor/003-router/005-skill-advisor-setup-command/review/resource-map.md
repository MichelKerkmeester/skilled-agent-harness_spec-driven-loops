---
title: "Resource Map: 005-skill-advisor-setup-command Deep Review"
...
trigger_phrases:
  - "005-skill-advisor-setup-command resource map"
  - "skill advisor setup command review resources"
importance_tier: "important"
contextType: "review"
---
# Resource Map: 005-skill-advisor-setup-command Deep Review
...
### Spec folder packet
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/spec.md`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/plan.md`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/tasks.md`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/checklist.md`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/implementation-summary.md`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/graph-metadata.json`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/description.json`
...
### Parent doc updates
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/context-index.md`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/spec.md`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/tasks.md`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/changelog/changelog-008-005-skill-advisor-setup-command.md`
...
### Top-level
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/review-report.md` (this report's companion)
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/resource-map.md` (this file)
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/deep-review-config.json`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/deep-review-strategy.md`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/deep-review-state.jsonl`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/runner.sh`
...
| `006-skill-advisor/changelog/changelog-008-012-*.md` | F-TRACE-005, F-TRACE-006 |
...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command --strict

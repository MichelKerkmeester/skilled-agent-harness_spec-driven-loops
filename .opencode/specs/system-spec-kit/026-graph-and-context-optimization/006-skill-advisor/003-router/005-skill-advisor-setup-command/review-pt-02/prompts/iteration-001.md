...
## Required reads
1. `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review-pt-02/deep-review-strategy.md` (this run's strategy)
2. `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/iterations/iteration-001.md` (prior P1 findings F-CORR-001..004)
3. `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/iterations/iteration-002.md` (F-CORR-005..009)
4. `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review/iterations/iteration-003.md` (F-CORR-010..014)
5. `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/implementation-summary.md` (post-review-fixes section)
...
Path: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-setup-command/review-pt-02/iterations/iteration-001.md`

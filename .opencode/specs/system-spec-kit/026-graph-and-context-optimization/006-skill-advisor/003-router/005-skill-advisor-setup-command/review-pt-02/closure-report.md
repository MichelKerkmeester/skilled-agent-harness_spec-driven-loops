---
title: "Closure Re-Review Report: 005-skill-advisor-setup-command (pt-02)"
...
trigger_phrases:
  - "005-skill-advisor-setup-command closure report"
...
| Action | Command |
|---|---|
| Refresh search support to index this report | `/memory:save .opencode/specs/.../005-skill-advisor-setup-command/` |

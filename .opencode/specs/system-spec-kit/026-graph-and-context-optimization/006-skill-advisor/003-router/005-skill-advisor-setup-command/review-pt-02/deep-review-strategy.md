# Strategy - 005-skill-advisor-setup-command Closure Re-Review (pt-02)
...
- Parent `006-skill-advisor/{context-index,spec,tasks}.md` (trigger_phrases include 012; description text 12 children)
- Parent `006-skill-advisor/changelog/changelog-008-012-*.md` (3 added rows, .opencode/ prefixes)

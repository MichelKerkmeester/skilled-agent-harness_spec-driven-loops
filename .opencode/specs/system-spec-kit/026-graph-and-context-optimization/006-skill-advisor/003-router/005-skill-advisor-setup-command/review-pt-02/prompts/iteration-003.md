...
## Required reads
1. `.opencode/specs/.../005-skill-advisor-setup-command/review-pt-02/deep-review-strategy.md`
2. `.opencode/specs/.../005-skill-advisor-setup-command/review-pt-02/iterations/iteration-{001,002}.md`
3. `.opencode/specs/.../005-skill-advisor-setup-command/review/iterations/iteration-005.md` (original F-TRACE findings)
...
- F-TRACE-003: Parent docs trigger_phrases include 012 + description "12 children"
  → expect: parent context-index.md, spec.md, tasks.md frontmatter trigger_phrases list "005-skill-advisor-setup-command" and "/spec_kit:skill-advisor"; parent description text says "12 direct child packet(s)"

...
2. `.opencode/specs/.../005-skill-advisor-setup-command/review-pt-02/iterations/iteration-001.md` (prior closure verdicts)
3. `.opencode/specs/.../005-skill-advisor-setup-command/review/iterations/iteration-004.md` (original F-SEC-001..006 findings)

...
- F-CONV-001 (artifact gap from pt-01): pt-01 iterations 003 + 006 had log-embedded artifacts that were materialized post-loop
  → expect: `.opencode/specs/.../005-skill-advisor-setup-command/review/iterations/iteration-{003,006}.md` exist as canonical files
...
Path: `.opencode/specs/.../005-skill-advisor-setup-command/review-pt-02/iterations/iteration-005.md`

...
<!-- ANCHOR:status -->
## 2. STATUS
- Review Target: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/001-search-and-routing-tuning/001-search-fusion-tuning/ (spec-folder)

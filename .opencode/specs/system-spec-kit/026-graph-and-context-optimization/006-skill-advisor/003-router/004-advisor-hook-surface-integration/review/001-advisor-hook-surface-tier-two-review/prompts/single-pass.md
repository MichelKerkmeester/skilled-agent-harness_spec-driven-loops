...
**GATE 3 PRE-ANSWERED — A**: `specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/004-advisor-hook-surface-integration`. Pre-approved. Proceed directly.
...
1. **Read inputs**:
   - `specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/004-advisor-hook-surface-integration/{spec,plan,tasks,checklist,implementation-summary,decision-record,handover,battle-plan}.md`
...
3. **Output review-report.md** at `specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/004-advisor-hook-surface-integration/review/004-advisor-hook-surface-integration-tier2-pt-01/review-report.md`

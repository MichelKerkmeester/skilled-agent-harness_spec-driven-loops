REMEDIATE: sk-prompt/README.md — zero §1 tables
...
Write the entire revised README to `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/sk-prompt/README.md`. Do not produce any other files.
...
- Read-only access to all files EXCEPT `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/sk-prompt/README.md`.

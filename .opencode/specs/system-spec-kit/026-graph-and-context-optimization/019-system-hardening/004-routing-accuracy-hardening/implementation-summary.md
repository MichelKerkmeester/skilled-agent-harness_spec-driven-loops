...
- Final corpus command: `python3 tests/routing-accuracy/score-routing-corpus.py --min-advisor-accuracy 0.60 --min-gate3-f1 0.83 --require-historical-clean --min-joint-tt 108 --max-joint-ft 12 --max-joint-ff 15 --out .opencode/specs/system-spec-kit/026-graph-and-context-optimization/019-system-hardening/004-routing-accuracy-hardening/routing-accuracy-final.json` — PASS.

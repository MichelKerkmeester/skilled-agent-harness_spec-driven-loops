...
- Run `node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js --json '{"specFolder":"system-spec-kit/026-graph-and-context-optimization/007-release-alignment-revisits","sessionSummary":"Wave B: restored root spec for coordination-parent packet"}'` for each of 007/008/009/010

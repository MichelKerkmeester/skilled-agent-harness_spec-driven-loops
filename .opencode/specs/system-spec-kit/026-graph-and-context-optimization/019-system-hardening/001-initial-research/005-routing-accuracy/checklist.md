---
title: "Verification Checklist: Routing Accuracy Research"
description: "Checklist for SSK-RR-1 packet."
trigger_phrases:
  - "ssk-rr-1 checklist"
...
---
# Verification Checklist: Routing Accuracy Research
...
- [x] CHK-011 [P1] Wave 3 documented. [EVIDENCE: spec.md executive]
<!-- /ANCHOR:code-quality -->
...
- [ ] CHK-021 [P0] Corpus ≥ 150. [EVIDENCE: T041]
- [ ] CHK-022 [P1] Accuracy matrix computed. [EVIDENCE: research.md]
- [ ] CHK-023 [P1] Ranked proposals with simulated impact. [EVIDENCE: T042]
<!-- /ANCHOR:testing -->
...
- [x] CHK-030 [P0] Transcript anonymization. [EVIDENCE: spec.md NFR-S01]
- [x] CHK-031 [P1] Research stays local. [EVIDENCE: spec.md NFR-S02]
<!-- /ANCHOR:security -->

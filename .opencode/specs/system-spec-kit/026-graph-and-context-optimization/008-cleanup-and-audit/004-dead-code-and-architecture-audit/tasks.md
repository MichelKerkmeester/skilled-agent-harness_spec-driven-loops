...
# Tasks: 018 / 013 — dead code and architecture audit
...
- [x] T016 Add the promoted runtime modules to the package architecture narrative. [EVIDENCE: the doc now covers resume ladder, content routing, anchor merge, coverage graph, feedback, and authoring surfaces.]
...
- [x] T022 Re-read the legacy 006 resource map before refresh. [EVIDENCE: the legacy map was read before rewrite.]
- [x] T023 Add current runtime surfaces to the legacy 006 resource map. [EVIDENCE: the rewritten map now reflects resume, routing, merge, hooks, coverage graph, feedback, authoring, and verification surfaces.]
- [x] T024 Remove deleted runtime surfaces from the legacy 006 resource map. [EVIDENCE: shared-memory-era rows were removed.]
- [x] T025 Refresh legacy resource-map ownership wording to current reality. [EVIDENCE: the rewritten map now describes the surviving runtime instead of the older migration snapshot.]
<!-- /ANCHOR:phase-2 -->

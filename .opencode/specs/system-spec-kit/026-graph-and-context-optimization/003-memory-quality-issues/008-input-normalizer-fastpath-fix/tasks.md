---
title: "Tasks: Input Normalizer Fast-Path Fix [system-spec-kit/026-graph-and-context-optimization/003-memory-quality-issues/008-input-normalizer-fastpath-fix/tasks]"
...
- [x] T001 Read the diagnostic report and repro payload - WHY: confirm the root cause before editing - Acceptance: the failing shape and expected fix are pinned down from `/tmp/003mq-complete/b4-output.md` and `/tmp/save-context-data.json`.

...
> **Memory save contract (cross-ref):** This packet is the implementation host for the compact retrieval wrapper memory save contract. Research authority: `001-research-graph-context-systems/006-research-memory-redundancy/research/research.md` (Section 10 per-file change proposals). The contract flips memory saves from packet-narrative clones to compact wrappers that point at `decision-record.md` + `implementation-summary.md` as canonical narrative owners. [SOURCE: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/001-research-graph-context-systems/006-research-memory-redundancy/research/research.md:103-120]

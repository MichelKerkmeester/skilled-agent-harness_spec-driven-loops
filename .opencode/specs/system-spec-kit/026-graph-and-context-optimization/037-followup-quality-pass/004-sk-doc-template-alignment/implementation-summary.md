...
_memory:
  continuity:
    ...
    key_files:
      ...
      - "audit-findings.md"
    session_dedup:
      fingerprint: "sha256:037004skdoctemplatealignmentimplsummary0000000000000000"
...
| `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh specs/system-spec-kit/026-graph-and-context-optimization/037-followup-quality-pass/004-sk-doc-template-alignment --strict` | PASS |
| Strict validator on `.opencode/specs/.../031-doc-truth-pass` through `036-cli-matrix-adapter-runners` | PASS |
<!-- /ANCHOR:verification -->

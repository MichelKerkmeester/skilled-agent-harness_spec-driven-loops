...
PACKET_ROOT_REL=".opencode/specs/system-spec-kit/026-graph-and-context-optimization/998-aggressive-restructure-research"
...
AGENT_CONFIG_TMP="/tmp/agent-config-998-synthesis.json"

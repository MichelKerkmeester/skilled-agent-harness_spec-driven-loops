...
- [ ] **T-VAL-04** `validate.sh --strict` on 018 packet.
  - Run: `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/017-sk-deep-cli-runtime-execution/001-executor-feature --strict`
  - Acceptance: exits 0.
...
- **Parent**: `../` (026 root)
- **Predecessor**: `../016-foundational-runtime/`

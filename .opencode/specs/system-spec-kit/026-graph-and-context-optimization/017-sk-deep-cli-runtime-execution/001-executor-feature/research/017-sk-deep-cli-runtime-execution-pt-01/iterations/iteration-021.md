...
Reproduction path:
- Read `016-foundational-runtime/plan.md:448-456`.
- Read `016-foundational-runtime/005-p2-maintainability/spec.md:87-103`.
- Re-read `research/017-sk-deep-cli-runtime-execution-001-executor-feature/iterations/iteration-009.md:16-83`.

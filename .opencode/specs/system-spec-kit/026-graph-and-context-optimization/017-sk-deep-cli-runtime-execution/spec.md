...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/017-sk-deep-cli-runtime-execution"
...
|-------|----------|-------------|
| `001-executor-feature/` | 017-sk-deep-cli-runtime-execution/001-executor-feature | native + cli-codex ship |
| `002-runtime-matrix/` | 017-sk-deep-cli-runtime-execution/002-runtime-matrix | cli-copilot + cli-gemini + cli-claude-code ship |

---

## 5. DOWNSTREAM

- `018-cli-executor-remediation/` (ex-020) remediates R1-R12 findings from the 30-iter deep-research dogfood pass against this packet's research root (`research/017-sk-deep-cli-runtime-execution-001-executor-feature/`)

...
3. Read the live Phase 019 contract in `017-sk-deep-cli-runtime-execution/002-runtime-matrix/spec.md`, `decision-record.md`, `implementation-summary.md`, `spec_kit_deep-research_auto.yaml`, and `tests/deep-loop/cli-matrix.vitest.ts` to verify which Copilot hardening gaps are still active in checked-in code.
...
- Read `017-sk-deep-cli-runtime-execution/002-runtime-matrix/spec.md` REQ-010 / edge cases and `decision-record.md` ADR-008.
...
- Compare with `017-sk-deep-cli-runtime-execution/002-runtime-matrix/implementation-summary.md` "Files Touched" and the deep-loop YAML branches.

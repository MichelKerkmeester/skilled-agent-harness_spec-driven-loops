...
4. Read `research/deep-research-strategy.md` and `research/deep-research-state.jsonl` to align with the current loop topic and iteration focus. [SOURCE: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-advisor-phrase-booster-tailoring/research/deep-research-strategy.md:1-45] [SOURCE: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-advisor-phrase-booster-tailoring/research/deep-research-state.jsonl:1]

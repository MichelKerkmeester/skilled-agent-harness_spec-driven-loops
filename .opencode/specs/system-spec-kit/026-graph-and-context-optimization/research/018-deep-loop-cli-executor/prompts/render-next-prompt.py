...
ARTIFACT_DIR = Path(".opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/018-deep-loop-cli-executor")
...
def main():
    ...
    iter_path = f".opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/018-deep-loop-cli-executor/iterations/iteration-{next_n:03d}.md"
    state_log = ".opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/018-deep-loop-cli-executor/deep-research-state.jsonl"
    ...
    strategy_path = ".opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/018-deep-loop-cli-executor/deep-research-strategy.md"

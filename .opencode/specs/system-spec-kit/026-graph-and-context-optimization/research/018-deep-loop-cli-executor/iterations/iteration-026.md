...
4. Opened concrete outlier examples in [018-deep-loop-cli-executor/implementation-summary.md](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/018-deep-loop-cli-executor/implementation-summary.md), [018-deep-loop-cli-executor/graph-metadata.json](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/018-deep-loop-cli-executor/graph-metadata.json), [012-command-graph-consolidation/implementation-summary.md](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/012-command-graph-consolidation/implementation-summary.md), and [012-command-graph-consolidation/graph-metadata.json](/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/012-command-graph-consolidation/graph-metadata.json) to anchor the distribution to real packet state rather than aggregate counts alone.
...
- Open `018-deep-loop-cli-executor/implementation-summary.md` and `018-deep-loop-cli-executor/graph-metadata.json`.
...
- The 026 scan found 10 negative-delta folders, with several additional large negative cases under `017-review-findings-remediation` and its child phases.

...
- Pick any at-risk packet such as:
  - `017-review-findings-remediation/001-infrastructure-primitives/description.json`
  - `017-review-findings-remediation/002-cluster-consumers/description.json`
...
- The densest schema-extended cluster is `017-review-findings-remediation`, especially:

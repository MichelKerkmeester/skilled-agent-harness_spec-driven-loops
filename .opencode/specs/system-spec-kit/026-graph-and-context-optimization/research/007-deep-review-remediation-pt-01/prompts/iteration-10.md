You are executing iteration 10 of 10 of a deep-research loop against the Copilot CLI hook parity question. Operate as a LEAF agent — do not dispatch sub-agents.
...
Last 3 iterations:
  ...
  run 9: agents acp and instruction surfaces (ratio=0.2)
...
Write to: /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/007-deep-review-remediation-pt-01/iterations/iteration-10.md

Structure:
# Iteration 10: <focus-topic>
## Focus
<1-2 sentences>
## Actions Taken
...
## Next Focus
<one-sentence recommendation for iteration 11>
...
{"type":"iteration","run":10,"status":"insight"|"evidence"|"thought"|"dead-end","focus":"<short focus label>","findingsCount":<int>,"newInfoRatio":<0..1>,"citationCount":<int>,"primarySourceCount":<int>,"timestamp":"<ISO8601>","graphEvents":[]}

newInfoRatio guidance: 1.0 = all findings new; 0.0 = all redundant with prior iterations. Be honest.

### 3. Per-iteration delta file

Write to: /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/007-deep-review-remediation-pt-01/deltas/iter-10.jsonl
...
Begin iteration 10 now. Produce the three artifacts.

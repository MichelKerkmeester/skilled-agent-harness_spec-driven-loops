...
STATE SUMMARY (auto-generated): Session dr-20260418T120854Z-9c57f9 | Iteration: 13 of 30 | Last iteration completed: 12
...
Iteration: 13 of 30
Focus Area: Return to Q2 and deepen the preserve-field analysis for `generate-description.js`. Focus on the exact overwrite paths, which rich fields are currently lost, and the safest mitigation pattern that preserves hand-authored content without blocking canonical regeneration.
...
- Iter 10: focus='Q9: Evidence-marker bracket-depth lint false positives' status='q9-answered-parser-safe-for-delimiter-heavy-prose-but-fence-detection-has-two-false-positive-gaps' newInfoRatio=0.11
- Iter 11: focus='Q10: continuity-freshness threshold calibration' status='q10-answered-threshold-remains-policy-budget-without-latency-calibration' newInfoRatio=0.09
...
- Write findings to: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/017-cli-runtime-executors-001-executor-feature/iterations/iteration-013.md
...
1. **Iteration narrative markdown** at `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/017-cli-runtime-executors-001-executor-feature/iterations/iteration-013.md`. Structure: headings for Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus.
...
```
{"type":"iteration","iteration":13,"newInfoRatio":<0..1>,"status":"<string>","focus":"<string>","graphEvents":[/* optional */]}
```

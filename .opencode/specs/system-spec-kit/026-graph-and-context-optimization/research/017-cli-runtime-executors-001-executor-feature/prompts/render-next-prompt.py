...
ARTIFACT_DIR = Path(".opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/017-cli-runtime-executors/001-executor-feature")
...
def main():
    ...
    iter_path = f".opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/017-cli-runtime-executors/001-executor-feature/iterations/iteration-{next_n:03d}.md"
    state_log = ".opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/017-cli-runtime-executors/001-executor-feature/deep-research-state.jsonl"
    ...
    strategy_path = ".opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/017-cli-runtime-executors/001-executor-feature/deep-research-strategy.md"

...
- This matches Phase 017 packet wording like `description.json.lastUpdated >= graph-metadata.json.derived.last_save_at - 10m` in `016-foundational-runtime/spec.md` and `003-rollout-sweeps/spec.md`.
...
- The associated packet references in `016-foundational-runtime/tasks.md` and feature-catalog prose describe the rule as a validator contract, not as a measured SLA derived from save-path timing.

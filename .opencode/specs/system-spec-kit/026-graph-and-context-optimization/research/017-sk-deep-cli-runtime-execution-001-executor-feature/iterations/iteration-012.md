...
3. Read the Phase 017 packet evidence trail in `016-foundational-runtime/spec.md`, `plan.md`, `tasks.md`, and `implementation-summary.md` to reconstruct what T-CNS-03 and the H-56-1 cascade actually changed.
...
Reproduction path:
- Read `016-foundational-runtime/tasks.md` around `T-CNS-03`.
- Read `016-foundational-runtime/implementation-summary.md` around the Wave C rollout summary.

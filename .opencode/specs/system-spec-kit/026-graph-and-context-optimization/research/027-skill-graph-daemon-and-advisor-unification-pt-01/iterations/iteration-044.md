...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/027-skill-graph-daemon-and-advisor-unification/spec.md:90-96` → A1/A6 require the watcher to survive editor atomic-rename patterns and keep debounce below 10s so multi-file saves do not thrash the daemon.

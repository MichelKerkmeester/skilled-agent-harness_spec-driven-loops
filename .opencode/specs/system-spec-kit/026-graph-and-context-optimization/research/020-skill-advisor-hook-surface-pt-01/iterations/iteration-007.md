...
- The parent 020 plan originally reserved seven children: advisor brief producer, Claude wiring, Gemini wiring, Copilot wiring, Codex integration, freshness signal, and documentation. It explicitly said exact child numbering and count would be determined by research convergence. [SOURCE: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/020-skill-advisor-hook-surface/plan.md:129-137`]
- The parent spec requires a compact advisor brief with top skill, confidence, uncertainty, freshness, cache state, shared-payload transport, cross-runtime parity, the 019/004 200-prompt corpus, and fail-open behavior. [SOURCE: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/020-skill-advisor-hook-surface/spec.md:109-128`] [SOURCE: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/020-skill-advisor-hook-surface/spec.md:136-151`]

...
| `004-copilot-hook-parity-remediation/` | Feature Specification: Copilot CLI Hook Parity Remediation | Complete | `009-hook-daemon-parity/004-copilot-hook-parity-remediation/` |
| `005-codex-hook-parity-remediation/` | Feature Specification: Codex CLI Hook Parity Remediation | Complete | `009-hook-daemon-parity/005-codex-hook-parity-remediation/` |
| `006-claude-hook-findings-remediation/` | Feature Specification: Claude Hook Findings Remediation | Partial Verification | `009-hook-daemon-parity/006-claude-hook-findings-remediation/` |
| `007-opencode-plugin-loader-remediation/` | Feature Specification: OpenCode Plugin Loader Remediation | Complete | `009-hook-daemon-parity/007-opencode-plugin-loader-remediation/` |
| `008-skill-advisor-plugin-hardening/` | Feature Specification: Skill-Advisor Plugin Hardening | Complete | `009-hook-daemon-parity/008-skill-advisor-plugin-hardening/` |
| `009-skill-advisor-standards-alignment/` | Feature Specification: Skill-Advisor Standards Alignment | Complete | `009-hook-daemon-parity/009-skill-advisor-standards-alignment/` |
| `010-copilot-wrapper-schema-fix/` | Feature Specification: Copilot Wrapper Schema Fix | Reverted - Reapply Required | `009-hook-daemon-parity/010-copilot-wrapper-schema-fix/` |
| `011-copilot-writer-wiring/` | Feature Specification: Copilot Writer Wiring | Reverted - Reapply Required | `009-hook-daemon-parity/011-copilot-writer-wiring/` |

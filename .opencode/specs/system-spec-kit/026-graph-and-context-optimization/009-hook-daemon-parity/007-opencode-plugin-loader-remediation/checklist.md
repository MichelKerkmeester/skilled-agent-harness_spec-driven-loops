...
- [ ] **P1-04** No vitest regression elsewhere. [EVIDENCE: deferred — see implementation-summary.md Known Limitations item 1; out-of-scope Copilot hook wiring blocker tracked in parent 009-hook-daemon-parity docs as priority follow-up.]

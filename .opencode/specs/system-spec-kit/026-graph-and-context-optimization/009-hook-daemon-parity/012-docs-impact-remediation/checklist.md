...
- [x] **T-014** 009 parent `graph-metadata.json` `children_ids` includes `system-spec-kit/026-graph-and-context-optimization/009-hook-daemon-parity/012-docs-impact-remediation`. [Evidence: parent 009 graph-metadata.json children_ids count=12 incl. 012-docs-impact-remediation]

...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-daemon-parity/002-skill-graph-daemon-and-advisor-unification/**` | Modify | Phase 027 packet evidence and strict validation shape. |
<!-- /ANCHOR:scope -->
...
| Child | Purpose |
|-------|---------|
| `001-validator-esm-fix` | Validator runtime prerequisite. |
| `002-daemon-freshness-foundation` | Daemon, lease, and freshness substrate. |
| `003-lifecycle-and-derived-metadata` | Derived metadata, lifecycle, schema migration. |
| `004-native-advisor-core` | TypeScript scorer and parity harness. |
| `005-mcp-advisor-surface` | MCP tool contracts and handlers. |
| `006-compat-migration-and-bootstrap` | Legacy compatibility and operator bootstrap. |
| `007-promotion-gates` | Shadow cycles and promotion gate bundle. |

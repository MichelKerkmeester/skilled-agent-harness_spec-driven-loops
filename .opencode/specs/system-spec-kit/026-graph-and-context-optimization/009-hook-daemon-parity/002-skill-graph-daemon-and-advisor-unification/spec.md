...
| **Parent** | `../001-skill-advisor-hook-surface/` |
...
| **Child Layout** | `001-validator-esm-fix` (prereq); `002-daemon-freshness-foundation`; `003-lifecycle-and-derived-metadata`; `004-native-advisor-core`; `005-mcp-advisor-surface`; `006-compat-migration-and-bootstrap`; `007-promotion-gates` |

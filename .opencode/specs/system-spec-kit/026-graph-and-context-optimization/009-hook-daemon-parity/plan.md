...
### Overview
This parent groups `001-skill-advisor-hook-surface/`, `002-skill-graph-daemon-and-advisor-unification/`, `003-hook-parity-remediation/` as direct child folders. It keeps the active theme concise while avoiding an extra archive layer.
<!-- /ANCHOR:summary -->

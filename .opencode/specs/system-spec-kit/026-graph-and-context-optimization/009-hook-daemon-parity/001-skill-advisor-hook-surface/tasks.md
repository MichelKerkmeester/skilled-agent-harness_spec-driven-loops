---
title: "Tasks [system-spec-kit/026-graph-and-context-optimization/009-hook-daemon-parity/001-skill-advisor-hook-surface/tasks]"
...
- [x] T001 Scaffold 020/001-initial-research Level 2 sub-packet (spec/plan/tasks/checklist/implementation-summary) (P0) [Evidence: `001-initial-research/implementation-summary.md`.]
...
- [x] T014 Implement 002 via `/spec_kit:implement :auto` (P0) [Evidence: `002-shared-payload-advisor-contract/implementation-summary.md`, commit `9c5fa135b4`.]
- [x] T015 Implement 003 via `/spec_kit:implement :auto` after 002 merges (P0) [Evidence: `003-advisor-freshness-and-source-cache/implementation-summary.md`, commit `5f081f71e9`.]
- [x] T016 Implement 004 via `/spec_kit:implement :auto` after 003 merges (P0) [Evidence: `004-advisor-brief-producer-cache-policy/implementation-summary.md`, commit `25c8976e98`.]
- [x] T017 Implement 005 via `/spec_kit:implement :auto` after 004 merges (P0) — HARD GATE; must green before T018-T020 [Evidence: `005-advisor-renderer-and-regression-harness/implementation-summary.md`, commit `e19bf2e213`.]
- [x] T018 Implement 006 via `/spec_kit:implement :auto` after 005 gate lifts (P0) [Evidence: `006-claude-hook-wiring/implementation-summary.md`, commit `6d4b41a9f6`.]
- [x] T019 Implement 007 via `/spec_kit:implement :auto` after 006 merges (P1) — parallel with T020 allowed [Evidence: `007-gemini-copilot-hook-wiring/implementation-summary.md`, commit `11ad3e8a5f`.]
- [x] T020 Implement 008 via `/spec_kit:implement :auto` after 005 gate lifts (P1) — parallel with T019 allowed [Evidence: `008-codex-integration-and-hook-policy/implementation-summary.md`, commit `8dc1bd065b`.]
- [x] T021 Implement 009 via `/spec_kit:implement :auto` after 006/007/008 converge (P1) [Evidence: `009-documentation-and-release-contract/implementation-summary.md` updated in this workspace.]
...
|------------------|--------|----------------------------|----------|
| T1 — 020/002 contract | Complete | 2026-04-19T13:05:00Z | `002-shared-payload-advisor-contract/implementation-summary.md` |
| T2 — 020/003 freshness | Complete | 2026-04-19T09:30:00Z | `003-advisor-freshness-and-source-cache/implementation-summary.md` |
| T3 — 020/004 producer | Complete | 2026-04-19T15:33:00Z | `004-advisor-brief-producer-cache-policy/implementation-summary.md` |
| T4 — 020/005 hard gate | Complete | 2026-04-19T15:51:00Z | `005-advisor-renderer-and-regression-harness/implementation-summary.md` |
| T5 — 020/006 Claude | Complete | 2026-04-19T14:04:00Z | `006-claude-hook-wiring/implementation-summary.md` |
| T6 — 020/007 Gemini and Copilot | Complete | 2026-04-19T14:25:00Z | `007-gemini-copilot-hook-wiring/implementation-summary.md` |
| T7 — 020/008 Codex | Complete | 2026-04-19T16:40:00Z | `008-codex-integration-and-hook-policy/implementation-summary.md` |
| T8 — 020/009 docs and release | Complete | 2026-04-19T14:51:54Z | `009-documentation-and-release-contract/implementation-summary.md` |

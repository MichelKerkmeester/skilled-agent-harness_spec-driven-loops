...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-daemon-parity/001-skill-advisor-hook-surface/002-shared-payload-advisor-contract/tasks.md` | Modified | Marked T001-T014 complete as implementation and verification progressed. |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-daemon-parity/001-skill-advisor-hook-surface/002-shared-payload-advisor-contract/checklist.md` | Modified | Marked all checklist rows with evidence citations. |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-daemon-parity/001-skill-advisor-hook-surface/002-shared-payload-advisor-contract/implementation-summary.md` | Modified | Captured delivery details, files changed, verification results, and next step. |
<!-- /ANCHOR:what-built -->
...
| `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-daemon-parity/001-skill-advisor-hook-surface/002-shared-payload-advisor-contract --strict --no-recursive` | PASS (errors=0) | 1 accepted pre-existing warning: `RELATED DOCUMENTS` custom section |
<!-- /ANCHOR:verification -->

...
## Evidence read
- .opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-daemon-parity/001-skill-advisor-hook-surface/review/deep-review-state.jsonl:40 → iteration 38 left cumulative counts at P0=0, P1=19, P2=17 with `stuck=0`.
- .opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-daemon-parity/001-skill-advisor-hook-surface/review/iterations/iteration-038.md:41 → prior handoff explicitly asked for a D4 pass on exported API documentation and dead/internal paths.

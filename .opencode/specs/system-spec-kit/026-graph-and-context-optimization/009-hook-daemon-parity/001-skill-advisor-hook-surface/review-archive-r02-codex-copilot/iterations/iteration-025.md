...
- .opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-daemon-parity/001-skill-advisor-hook-surface/review/iterations/iteration-018.md:7-24 → prior D4 coverage only captured the same documentation gap for cache/generation utilities, not these core advisor entrypoints.

...
## Evidence read
- .opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-daemon-parity/001-skill-advisor-hook-surface/review/deep-review-state.jsonl:39 → iteration 37 ended at cumulative P0=0, P1=18, P2=17 with `stuck=3`.
- .opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-daemon-parity/001-skill-advisor-hook-surface/review/iterations/iteration-037.md:43 → prior iteration explicitly handed off to a D3 observability check.

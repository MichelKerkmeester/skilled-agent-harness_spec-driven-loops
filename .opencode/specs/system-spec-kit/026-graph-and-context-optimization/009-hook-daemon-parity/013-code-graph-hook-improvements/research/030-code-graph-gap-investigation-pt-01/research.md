...
Add the following as `Cited` or `Analyzed` entries to packet `013`’s [`resource-map.md`](../../009-hook-daemon-parity/013-code-graph-hook-improvements/resource-map.md):

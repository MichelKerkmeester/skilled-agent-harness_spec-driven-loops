...
- [ ] T016 Run `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-daemon-parity/013-code-graph-hook-improvements --strict` to verify packet-doc alignment for `013-ZC-F-001`, `013-F-001`, `013-F-003`, and `013-F-005`
<!-- /ANCHOR:phase-3 -->

...
| Strict spec validation | `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-daemon-parity/006-claude-hook-findings-remediation --strict --no-recursive` | To run after checklist/task updates and cleanup |
<!-- /ANCHOR:verification -->

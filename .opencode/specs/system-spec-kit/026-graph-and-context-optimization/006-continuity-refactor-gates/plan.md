...
|-----------|-------|-------|
| Packet validation | Root docs plus all six child phase folders | `./.opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-continuity-refactor-gates --recursive --strict` |

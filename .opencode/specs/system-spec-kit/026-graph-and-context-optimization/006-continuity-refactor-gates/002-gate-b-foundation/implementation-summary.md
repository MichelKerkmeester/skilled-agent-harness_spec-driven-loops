...
_memory:
  continuity:
    ...
    key_files: [".opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-continuity-refactor-gates/002-gate-b-foundation/implementation-summary.md"]

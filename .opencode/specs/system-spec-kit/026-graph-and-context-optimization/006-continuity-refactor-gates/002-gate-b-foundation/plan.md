...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/006-continuity-refactor-gates/002-gate-b-foundation"
    ...
    key_files: [".opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-continuity-refactor-gates/002-gate-b-foundation/plan.md"]
...
trigger_phrases: ["gate b plan", "foundation plan", "archive flip", "causal edges migration", "phase 018"]

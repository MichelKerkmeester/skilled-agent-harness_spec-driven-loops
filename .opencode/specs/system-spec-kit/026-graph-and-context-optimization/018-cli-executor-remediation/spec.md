...
| **Immediate Predecessor** | `017-cli-runtime-executors/002-runtime-matrix/` (shipped 2026-04-18) |
| **Research Source** | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/017-cli-runtime-executors-001-executor-feature/research.md` (256 lines, 17 sections, 30 iterations) |
...
- **Research source**: `research/017-cli-runtime-executors-001-executor-feature/research.md`
- **Plan**: `plan.md`
- **Tasks**: `tasks.md`

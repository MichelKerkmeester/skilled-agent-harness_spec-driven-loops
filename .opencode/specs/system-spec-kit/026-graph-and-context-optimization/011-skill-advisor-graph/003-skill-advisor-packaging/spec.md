...
|----|-------------|---------------------|
| REQ-001 | Strict packet validation must stop failing | `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/011-skill-advisor-graph/003-skill-advisor-packaging --strict` exits `0` or `1`, never `2` |

...
- [x] CHK-020 [P0] Strict packet validation exits `0` or `1`, not `2` [Evidence: `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/011-skill-advisor-graph/003-skill-advisor-packaging --strict` exits without error status]

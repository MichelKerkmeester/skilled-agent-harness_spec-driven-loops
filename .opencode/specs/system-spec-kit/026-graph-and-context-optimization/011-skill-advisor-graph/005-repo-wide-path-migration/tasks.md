...
- [x] T014 Run strict packet validation after the packet rewrite and confirm exit `0` or `1` only (packet validation gate) [Evidence: `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/011-skill-advisor-graph/005-repo-wide-path-migration --strict` exited `0`]
<!-- /ANCHOR:phase-3 -->

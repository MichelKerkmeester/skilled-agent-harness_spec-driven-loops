...
### Scope Coherence
The packet (022-orphan-mcp-leak-prevention) is a Level 3 child under a logical parent chain (009-memory-leak-remediation / 013-embedder-testing / 026-graph-and-context-optimization). The three layers (sweeper, Claude cleanup, idle timeout) form a complete defense-in-depth against orphan MCP accumulation.

...
RESEARCH="$REPO_ROOT/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/research"
...
declare -a FOCUSES=(
  "2|arc 001 local-embeddings-foundation|.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/001-local-embeddings-foundation"
  "3|arc 002 spec-memory-stack|.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/002-spec-memory-stack"
  "4|arc 003 skill-advisor-stack|.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/003-skill-advisor-stack"
  "5|arc 004 code-index-stack|.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/004-code-index-stack"
  "6|arc 005 cross-cutting-quality|.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/005-cross-cutting-quality"
  "7|arc 006 mcp-launcher-concurrency|.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/006-mcp-launcher-concurrency"
  "8|arc 007 ollama-and-bge-promotion|.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/007-ollama-and-bge-promotion"
  "9|cross-arc consistency + global hygiene|.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture"
)

...
- Research inputs:
  - `../021-smart-router-context-efficacy/001-initial-research/research/research.md` (V8+V9 plugin recommendations)
  - `../021-smart-router-context-efficacy/002-skill-md-intent-router-efficacy/research/research.md` (6 smart-router recommendations)

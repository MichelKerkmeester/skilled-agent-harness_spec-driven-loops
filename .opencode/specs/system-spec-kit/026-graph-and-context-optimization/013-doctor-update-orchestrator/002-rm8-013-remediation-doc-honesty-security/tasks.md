...
- [ ] T-A01 Run `node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js --json '{...}' .opencode/specs/.../001-doctor-commands` → fixes description.json.specFolder
...
- [ ] T-D05 Fix `packet_pointer` strings in 001 child docs that are missing the `/001-doctor-commands` suffix (R9-P2-004)

...
|------|---------------|-------|
| `013-doctor-update-orchestrator/spec.md` | Phase parent spec | Cross-child claims, lean-trio enforcement, phase map completeness |
| `013-doctor-update-orchestrator/graph-metadata.json` | Parent metadata | `derived.last_active_child_id`, `children_ids`, manual fields |
| `013-doctor-update-orchestrator/description.json` | Parent metadata | Identity + parentChain |
| `013-doctor-update-orchestrator/handover.md` | Cross-cutting | Parent-level optional doc (not checked for correctness this pass) |
| `013-doctor-update-orchestrator/resource-map.md` | Cross-cutting | Parent-level optional doc (not checked for correctness this pass) |
...
- **File**: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-doctor-update-orchestrator/graph-metadata.json:220`

...
|------|-----------|---------------|-------|
| `001-doctor-commands/spec.md` | spec_code | source-of-truth | P0 REQ-001..008, P1 REQ-010..017 |
| `001-doctor-commands/checklist.md` | checklist_evidence | all-unchecked | 80+ items, zero [x]; no verification artifacts referenced |
| `001-doctor-commands/resource-map.md` | spec_code, checklist_evidence | PLANNED-gap | Claims 10 YAMLs but only 5 exist on disk |
| `001-doctor-commands/implementation-summary.md` | checklist_evidence | claims-vs-reality | Claims Phases A, A.1, B1 partial complete but checklist never updated |
...
- **File**: `001-doctor-commands/checklist.md:1-202`
...
- **Affected surface hints**: ["001-doctor-commands checklist", "implementation-summary claims", "Phase A/A.1 deliverables"]
...
- **File**: `001-doctor-commands/spec.md:133` (vs `001-doctor-commands/resource-map.md:85-91`, and actual disk)
...
- **Affected surface hints**: ["001-doctor-commands spec scope table", "resource-map YAML count", "actual disk delivery"]
...
- **File**: `001-doctor-commands/spec.md:184` (REQ-003)
...
- **File**: `001-doctor-commands/checklist.md:189` (CHK-803), `002-sandbox-testing-playbook/checklist.md:311` (CHK-503)
...
- **File**: `001-doctor-commands/implementation-summary.md:225`

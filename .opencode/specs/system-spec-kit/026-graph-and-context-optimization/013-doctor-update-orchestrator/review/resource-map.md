...
description: "Path ledger for the artifacts produced by /spec_kit:deep-review:auto on 013-doctor-update-orchestrator (10 iterations, cli-opencode + deepseek/deepseek-v4-pro)."
trigger_phrases:
...
| Path | Role | Status |
|------|------|--------|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-doctor-update-orchestrator/review/` | Packet root | OK |
...
| Path | Role |
|------|------|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-doctor-update-orchestrator/spec.md` | Parent spec |
| `…/description.json` · `…/graph-metadata.json` · `…/handover.md` · `…/resource-map.md` | Parent control + cross-cutting docs |
| `…/001-doctor-commands/{spec,plan,tasks,checklist,decision-record,implementation-summary,resource-map}.md` | Child 001 Level 3 docs |
| `…/001-doctor-commands/{description,graph-metadata}.json` | Child 001 metadata |
...
| L1 packet of record | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-template-levels/009-rm-8-prompt-hardening/` |
...
- The 24 scope files are unchanged in the worktree post-review. Verify via `git status -- 013-doctor-update-orchestrator/spec.md 013-doctor-update-orchestrator/001-doctor-commands/ 013-doctor-update-orchestrator/002-sandbox-testing-playbook/` (expects empty).

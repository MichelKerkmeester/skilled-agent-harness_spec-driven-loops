...
Spec folder (pre-approved, skip Gate 3): `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-doctor-update-orchestrator/001-doctor-commands/`
...
5. **`.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-doctor-update-orchestrator/001-doctor-commands/decision-record.md`** — ADR-001..ADR-009 (council 10-line spec, tx-model finding). Cite ADR IDs in `upstream_assets` blocks where relevant.
6. **`.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-doctor-update-orchestrator/001-doctor-commands/spec.md`** — REQ-001..REQ-023.
...
5. **`upstream_assets.pass_policy`** numbers must match the gold-battery thresholds already in the workflow (e.g., causal-graph coverage 0.60 must match CHK-065 in `001-doctor-commands/checklist.md`).

...
| T012 | AC-1 Verify: `bash validate.sh .../001-daemon-freshness-foundation --strict --no-recursive` under Node 25 → no SyntaxError/ReferenceError | P0 | 2m | stderr clean |
...
```
Implement Phase 027/000 per spec at .opencode/specs/system-spec-kit/026-graph-and-context-optimization/027-skill-graph-daemon-and-advisor-unification/000-validator-esm-fix/spec.md.

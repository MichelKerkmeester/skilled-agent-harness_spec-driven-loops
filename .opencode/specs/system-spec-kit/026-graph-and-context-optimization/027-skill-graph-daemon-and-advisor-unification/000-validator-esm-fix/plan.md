...
- Run `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/.../027-.../001-daemon-freshness-foundation --strict --no-recursive 2>&1 | tee /tmp/027-000-validate-before.log` — expect FAILED

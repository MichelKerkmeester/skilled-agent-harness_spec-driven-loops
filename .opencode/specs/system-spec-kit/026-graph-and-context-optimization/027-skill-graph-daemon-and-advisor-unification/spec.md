...
- **A6 Resource budget.** Watching ~50-100 SKILL.md + supporting files + 10-20 asset dirs. Target: <5% CPU idle, <50MB RAM, <10s debounce to avoid thrash during multi-file editor saves.

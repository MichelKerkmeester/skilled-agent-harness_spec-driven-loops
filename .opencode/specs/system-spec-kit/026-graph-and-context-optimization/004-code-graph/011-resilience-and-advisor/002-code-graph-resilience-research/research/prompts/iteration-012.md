...
2. Synthesize iterations 8-11 into a single implementation roadmap that the next packet (005-code-graph-backend-resilience) can consume directly
...
- **Implementation Roadmap** (ordered task list ready for 005-code-graph-backend-resilience packet — minimum 10 ordered tasks with dependencies)

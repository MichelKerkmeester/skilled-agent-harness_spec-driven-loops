...
| `specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/004-fix-zero-node-and-parser-issues/*` | Create | Level 2 planning, decision, checklist, metadata, and implementation summary artifacts. |
| `specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/graph-metadata.json` | Modify | Add `004-fix-zero-node-and-parser-issues` to `children_ids`. |
<!-- /ANCHOR:scope -->

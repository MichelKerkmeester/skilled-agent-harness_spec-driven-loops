...
- [x] Spec folder approved. Evidence: user pre-approved `002-native-deferred-trial-rerun/`.
...
- **Procedure**: Remove `002-native-deferred-trial-rerun/` and remove `system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/002-native-deferred-trial-rerun` from `../graph-metadata.json.children_ids`.
<!-- /ANCHOR:rollback -->
...
### Rollback Procedure
1. Remove `002-native-deferred-trial-rerun/`.
2. Remove `system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/002-native-deferred-trial-rerun` from `../graph-metadata.json.children_ids`.

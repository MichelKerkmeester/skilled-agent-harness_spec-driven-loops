...
### In Scope
- Author the `002-native-deferred-trial-rerun/` Level 2 packet.
...
- Update parent `graph-metadata.json.children_ids` with `002-native-deferred-trial-rerun`.
...
| REQ-004 | Update parent graph metadata. | Parent `children_ids` includes `002-native-deferred-trial-rerun`. |

...
| Field | Value |
|-------|-------|
| **Spec Folder** | system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/001-sandbox-usefulness-trials |
...
| `../graph-metadata.json` | Update | Parent children_ids includes 001-sandbox-usefulness-trials. |
<!-- /ANCHOR:what-built -->

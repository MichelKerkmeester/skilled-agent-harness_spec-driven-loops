...
- [x] Spec folder approved. Evidence: user pre-approved `001-sandbox-usefulness-trials/`.
...
- **Procedure**: Remove `001-sandbox-usefulness-trials/` and remove `system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/001-sandbox-usefulness-trials` from `../graph-metadata.json.children_ids`.
<!-- /ANCHOR:rollback -->
...
### Rollback Procedure
1. Delete `001-sandbox-usefulness-trials/`.

...
Session-changed files still not substantively reviewed after this pass are mostly docs/tests/config surfaces: `.opencode/skills/system-code-graph/README.md`, `SKILL.md`, `feature_catalog/02--manual-scan-verify-status/03-code-graph-status.md`, `feature_catalog/feature_catalog.md`, the changed `manual_testing_playbook/**` files, `mcp_server/index.ts`, `mcp_server/lib/README.md`, `mcp_server/lib/ipc/socket-server.ts`, the changed stress/test files, `mcp_server/tests/lib/README.md`, `references/readiness/readiness_and_scope_fingerprint.md`, `references/runtime/launcher_lease.md`, `references/runtime/ownership_boundary.md`, and `opencode.json`.

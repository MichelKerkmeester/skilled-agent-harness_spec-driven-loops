...
- `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/promotion/gate-bundle.ts` (185 LOC)
- `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/promotion/rollback.ts` (87 LOC)
- `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/promotion/semantic-lock.ts` (39 LOC)
- `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/promotion/shadow-cycle.ts` (203 LOC)
- `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/promotion/two-cycle-requirement.ts` (50 LOC)
- `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/promotion/weight-delta-cap.ts` (72 LOC)
- `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/schemas/promotion-cycle.ts` (82 LOC, 8 exports)
- `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/tests/promotion/promotion-gates.vitest.ts` (316 LOC)
- `.opencode/skills/system-spec-kit/mcp_server/tests/promotion-positive-validation-semantics.vitest.ts` (127 LOC)
- `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/bench/corpus-bench.ts:9-10` (callsite of runShadowCycle)
- `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/bench/safety-bench.ts:9-10` (callsite)
- `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/bench/holdout-bench.ts:9-10` (callsite)

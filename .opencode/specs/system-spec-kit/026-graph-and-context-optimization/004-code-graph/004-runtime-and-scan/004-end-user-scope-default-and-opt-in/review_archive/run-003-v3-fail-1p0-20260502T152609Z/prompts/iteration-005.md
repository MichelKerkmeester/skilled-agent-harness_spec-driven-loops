...
# Deep-Review v3 Iteration 5 of 5 — VERIFICATION SWEEP
...
You are running iteration 5 of a 5-iteration RUN-3 verification sweep.
...
- code_graph_metadata table doesn't leak old fingerprint values when policy changes (no stale row issue)
...
```json
{"type":"iteration","iteration":5,"mode":"review","run":"run-005","status":"complete","focus":"correctness","dimensions":["correctness"],"filesReviewed":[<arr>],"findingsCount":<int>,"findingsSummary":{"P0":<int>,"P1":<int>,"P2":<int>},"findingsNew":[<arr>],"newFindingsRatio":<float>,"sessionId":"2026-05-02T15:03:06.606Z","generation":3,"lineageMode":"restart","timestamp":"<ISO>","durationMs":<int>}
```

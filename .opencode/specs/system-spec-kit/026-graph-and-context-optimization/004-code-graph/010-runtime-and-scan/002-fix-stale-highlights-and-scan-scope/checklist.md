---
title: "...m-spec-kit/026-graph-and-context-optimization/005-code-graph/002-fix-stale-highlights-and-scan-scope/checklist]"
...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/005-code-graph/002-fix-stale-highlights-and-scan-scope"
...
- [x] **P1-01** Surface matrix doc exists. [EVIDENCE: `.opencode/skills/system-spec-kit/mcp_server/code-graph/SURFACES.md` begins with `# Code Graph Context Surfaces` and includes the required 4-column matrix.]
...
- [x] **P1-06** Historical parent handover updated with 012 row. [EVIDENCE: `../../007-deep-review-remediation/handover.md` contains the `002-fix-stale-highlights-and-scan-scope` row in the Files Modified table.]
<!-- /ANCHOR:pre-impl -->
...
- [x] **P2-01** Surface matrix doc references investigation file:line citations. [EVIDENCE: `.opencode/skills/system-spec-kit/mcp_server/code-graph/SURFACES.md` cites session-snapshot, code-graph-db, indexer-types, and structural-indexer source/dist locations.]
...
- [x] **P1-F02** Surface doc placed at sensible location (`.opencode/skills/system-spec-kit/mcp_server/code-graph/SURFACES.md` or skill-advisor/README.md). [EVIDENCE: chose `.opencode/skills/system-spec-kit/mcp_server/code-graph/SURFACES.md` because it documents code-graph payload surfaces.]
- [x] **P1-F03** Spec packet docs remain in this child phase folder. [EVIDENCE: `implementation-summary.md`, `tasks.md`, and `checklist.md` updated under `.../002-fix-stale-highlights-and-scan-scope/`.]
<!-- /ANCHOR:file-org -->

---
title: "...ion/007-hook-parity/013-code-graph-hook-improvements/research/002-readiness-cocoindex-and-startup-contract-research/research]"
...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/005-code-graph/003-resolver-and-hook-improvements/research/002-readiness-cocoindex-and-startup-contract-research"
...
---
# Deep Research — 002-readiness-cocoindex-and-startup-contract-research
...
- Code-graph read, readiness, scan, context, and startup surfaces named by the parent packet [.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/003-resolver-and-hook-improvements/spec.md:54-74].
- CocoIndex-to-code-graph seed resolution and neighborhood expansion behavior [.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/003-resolver-and-hook-improvements/spec.md:67-74].
...
- CocoIndex indexing internals, broad memory-system work, storage-engine rewrites, or the dedicated zero-calls lane [.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/003-resolver-and-hook-improvements/spec.md:76-81].
...
- The subtree-root scan deletion and readiness debounce invalidation issues from pt-01 still matter, but this packet did not need to promote them again to justify its own synthesis [.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/003-resolver-and-hook-improvements/research/001-subtree-scan-freshness-and-startup-research/research.md:3-4,13-20].
...
- Parent packet spec: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/003-resolver-and-hook-improvements/spec.md`
- Prior packet synthesis: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/003-resolver-and-hook-improvements/research/001-subtree-scan-freshness-and-startup-research/research.md`
- Prior packet registry: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/003-resolver-and-hook-improvements/research/001-subtree-scan-freshness-and-startup-research/findings-registry.json`
...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/003-resolver-and-hook-improvements/research/001-subtree-scan-freshness-and-startup-research/research.md`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/003-resolver-and-hook-improvements/research/001-subtree-scan-freshness-and-startup-research/findings-registry.json`

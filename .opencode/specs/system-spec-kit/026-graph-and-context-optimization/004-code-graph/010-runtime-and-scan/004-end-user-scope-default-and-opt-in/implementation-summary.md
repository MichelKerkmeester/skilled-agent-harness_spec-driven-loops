...
| Field | Value |
|-------|-------|
| **Spec Folder** | 008-end-user-scope-default-and-opt-in |
...
| Strict validation 009 | PASS: `validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/008-end-user-scope-default-and-opt-in --strict`; Errors: 0, Warnings: 0. |
| Strict validation 008 | PASS: `validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/005-code-graph-backend-resilience --strict`; Errors: 0, Warnings: 0. |
| Sentinel validation | PASS: `validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/003-manifest-template-implementation-plan --strict`; Errors: 0, Warnings: 0. |

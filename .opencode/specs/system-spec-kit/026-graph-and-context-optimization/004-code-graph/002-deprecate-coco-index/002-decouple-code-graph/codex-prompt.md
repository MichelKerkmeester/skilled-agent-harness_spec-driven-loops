...
7. DELETE `feature_catalog/07--ccc-integration/` (3 files) and update `feature_catalog/06--mcp-tool-surface/01-tool-registrations.md` + any manual_testing_playbook tool-count reference to 8 tools.

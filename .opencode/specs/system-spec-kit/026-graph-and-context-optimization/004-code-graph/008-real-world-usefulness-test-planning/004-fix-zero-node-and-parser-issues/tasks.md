...
- [x] T001 Create Level 2 packet scaffold (`004-fix-zero-node-and-parser-issues/`)
...
- [x] T020 Run child strict validation (`validate.sh 004-fix-zero-node-and-parser-issues --strict`)

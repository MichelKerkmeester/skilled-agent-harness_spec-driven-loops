...
| **Storage** | On-disk research packet under `specs/.../004-code-graph-bug-surface-research` |
...
- [x] Parent metadata includes child packet `004-code-graph-bug-surface-research`.

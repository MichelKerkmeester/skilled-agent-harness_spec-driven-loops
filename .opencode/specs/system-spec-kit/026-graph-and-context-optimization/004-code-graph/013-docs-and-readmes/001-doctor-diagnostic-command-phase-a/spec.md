---
title: "Feature Specification: Code Graph Doctor Command [system-spec-kit/026-graph-and-context-optimization/005-code-graph/005-doctor-diagnostic-command-phase-a/spec]"
...
| **Related** | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/006-code-graph-resilience-research/` (research dependency), `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-advisor-setup-command/` (pattern source) |
<!-- /ANCHOR:metadata -->
...
| `.opencode/specs/.../005-code-graph/{context-index,spec,tasks}.md` | Modify | Add 006 child phase entry |
<!-- /ANCHOR:scope -->

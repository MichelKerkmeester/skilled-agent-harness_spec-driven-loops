...
- **F-021-1 (playbook label mismatch):** the playbook index labels scenario 021 "unicode-normalization fix from 009", but the actual `021-unicode-normalization-fix-from-009.md` content is "root dist cleanup verification". Doc label vs content drift; recommend reconciling.

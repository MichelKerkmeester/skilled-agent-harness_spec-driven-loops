---
title: "Tasks: Code Graph Doctor Command [system-spec-kit/026-graph-and-context-optimization/005-code-graph/005-doctor-diagnostic-command-phase-a/tasks]"
...
trigger_phrases:
  ...
  - "005-doctor-diagnostic-command-phase-a tasks"
...
_memory:
  continuity:
    ...
    session_dedup:
      ...
      session_id: "005-doctor-diagnostic-command-phase-a"
...
- [x] T006 Update parent `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/context-index.md` — add 006 row to child phase map
- [x] T007 Update parent `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/spec.md` — add 006 entry to phase documentation map
- [x] T008 Update parent `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/tasks.md` — add T-NNN entry tracking the 006 child packet
...
- **Specification**: See `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/005-doctor-diagnostic-command-phase-a/spec.md`
- **Plan**: See `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/005-doctor-diagnostic-command-phase-a/plan.md`
- **Parent Spec**: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/spec.md`
- **Sibling research dependency**: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/006-code-graph-resilience-research/spec.md`
- **Pattern source**: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-advisor-setup-command/`
<!-- /ANCHOR:cross-refs -->

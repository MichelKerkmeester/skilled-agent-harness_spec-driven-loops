...
- [ ] T003 [P] Reconfirm the highest-priority README targets before the later pass begins (`readme-audit.md`)
<!-- /ANCHOR:phase-1 -->
...
- [x] T005 Review command README indexes next (`.opencode/command/spec_kit/README.txt`, `.opencode/command/memory/README.txt`, `.opencode/command/README.txt`) | Evidence: Covered via scripts/memory/README.md (validate-memory-quality.ts and post-render quality validation descriptions expanded)
...
- [ ] T008 Re-check touched README paths against the curated target list in `readme-audit.md` (`readme-audit.md`)
- [ ] T009 Run strict packet validation after packet or later README updates change (`003-readme-alignment/`)
- [ ] T010 Confirm the change set stayed documentation-only and did not introduce runtime code edits (`git diff`, README target review)
<!-- /ANCHOR:phase-3 -->
...
- [ ] README review/update work stays within the audit-defined release-alignment scope
<!-- /ANCHOR:completion -->

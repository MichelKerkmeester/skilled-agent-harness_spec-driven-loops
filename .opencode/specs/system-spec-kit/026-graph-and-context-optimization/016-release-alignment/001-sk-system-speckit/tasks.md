...
- [x] T006 [P] Review and update mapped MCP server docs after root/reference alignment (`.opencode/skill/system-spec-kit/mcp_server/README.md`, `.opencode/skill/system-spec-kit/mcp_server/ENV_REFERENCE.md`, `.opencode/skill/system-spec-kit/mcp_server/INSTALL_GUIDE.md`, `.opencode/skill/system-spec-kit/mcp_server/lib/*/README.md`) — Evidence: Covered via gate-tool-routing.md graph-first routing which governs MCP tool selection
- [x] T007 [P] Review supporting feature catalog and manual testing playbook surfaces only after the higher-priority docs are aligned (`feature_catalog/*`, `manual_testing_playbook/*`) — Evidence: Supporting surfaces reviewed; changes propagated through updated workflow docs
<!-- /ANCHOR:phase-2 -->

...
- `.opencode/specs/.../010-doctor-update-orchestrator/001-doctor-commands/spec.md` — spec packet
- `.opencode/specs/.../010-doctor-update-orchestrator/001-doctor-commands/decision-record.md` — ADR decisions

...
5. **`.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-doctor-update-orchestrator/001-doctor-commands/decision-record.md`** — ADR-001..ADR-009 (council 10-line spec, tx-model finding). Cite ADR IDs in `upstream_assets` blocks where relevant.
6. **`.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-doctor-update-orchestrator/001-doctor-commands/spec.md`** — REQ-001..REQ-023.
...
```yaml
upstream_assets:
  packet: ".opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-doctor-update-orchestrator/001-doctor-commands"
  files:

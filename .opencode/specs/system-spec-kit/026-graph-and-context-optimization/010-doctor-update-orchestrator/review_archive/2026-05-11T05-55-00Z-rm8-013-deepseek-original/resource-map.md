...
| L1 packet of record | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/009-rm-8-prompt-hardening/` |
...
- The 24 scope files are unchanged in the worktree post-review. Verify via `git status -- 010-doctor-update-orchestrator/spec.md 010-doctor-update-orchestrator/001-doctor-commands/ 010-doctor-update-orchestrator/002-sandbox-testing-playbook/` (expects empty).

...
| Symptom | Citations |
|---------|-----------|
| 001 `description.json:2` `specFolder` points to parent-level path (`010-doctor-update-orchestrator`) instead of child-level (`010-doctor-update-orchestrator/001-doctor-commands`); spec-folder resolution lands on parent | R1-P1-005 |

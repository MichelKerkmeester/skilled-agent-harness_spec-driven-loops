...
# Implementation Summary: [004-hard-cutover]
...
| Field | Value |
|-------|-------|
| **Spec Folder** | `system-spec-kit/026-graph-and-context-optimization/010-doctor-update-orchestrator/004-hard-cutover` |
| **Status** | Placeholder |
| **Level** | 2 |
| **Phase** | [004-hard-cutover] |

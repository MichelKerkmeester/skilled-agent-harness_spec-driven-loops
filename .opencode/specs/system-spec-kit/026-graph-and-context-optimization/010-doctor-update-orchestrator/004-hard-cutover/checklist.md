---
title: "Checklist: Doctor Cutover Phase 2 [system-spec-kit/026-graph-and-context-optimization/010-doctor-update-orchestrator/004-hard-cutover/checklist]"
...
- [ ] CHK-001 [P0]: 003-router-consolidation static verification table has 7/7 YAML matches.
- [ ] CHK-002 [P0]: `route-validate.sh` exits 0 before cutover.
- [ ] CHK-003 [P0]: `route-validate.sh --self-test` rejects 3/3 bad fixtures.
- [ ] CHK-004 [P0]: 013 parent `children_ids` includes `004-hard-cutover`.
- [ ] CHK-005 [P0]: 004-hard-cutover has full Level 2 doc set.
- [ ] CHK-006 [P0]: 004-hard-cutover passes strict validation before destructive deletes.
<!-- /ANCHOR:pre-impl -->
...
- [ ] CHK-602 [P0]: 003-router-consolidation strict-validates after completion metadata update.

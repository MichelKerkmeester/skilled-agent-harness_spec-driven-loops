...
Spec folder (pre-approved, skip Gate 3): `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-doctor-update-orchestrator/001-implement-initial-doctor-command-set/`
...
# UPSTREAM ASSETS
# ─────────────────────────────────────────────────────────────────
upstream_assets: { ... }   # spec/ADR pointers from 001-implement-initial-doctor-command-set
...
3. Do NOT modify spec packet docs (`001-implement-initial-doctor-command-set/{spec,plan,tasks,checklist,decision-record,implementation-summary,resource-map}.md`) — that is a follow-on packet's scope.

...
- Spec folder: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-doctor-update-orchestrator/002-rm8-013-remediation-doc-honesty-security/`
...
- T-D05 / R9-P2-004: fixed authored `001-doctor-commands` packet pointers to include `/001-doctor-commands`.
- T-D06:
  ...
  - R9-P2-003: updated `001-doctor-commands/spec.md` continuity `completion_pct` from `0` to `95`, matching the reconciled implementation summary.
  ...
  - R9-P2-009: verified `002-sandbox-testing-playbook/spec.md` no longer references absent `../001-doctor-commands/handover.md`.

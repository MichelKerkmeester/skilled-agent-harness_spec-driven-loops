...
_memory:
  continuity:
    packet_pointer: "010-doctor-update-orchestrator/002-deep-review-remediation"
...
- **SC-001**: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-doctor-update-orchestrator/002-deep-review-remediation --strict` exits 0.

...
| **Branch** | `main` |
| **Parent Spec** | ../spec.md |
| **Superseded By** | ../003-router-consolidation/ and ../004-hard-cutover/ (router consolidation + cutover, 2026-05-11) |
| **Phase** | 13 of 13 |
...
Packet 013/002-sandbox-testing-playbook absorbed into 013/001-initial-doctor-commands per resource-map.md §3.3 M7. Both were superseded by 013/004 + 013/005 (router + cutover phases). Source archived to z_archive/wave-2-merges/.

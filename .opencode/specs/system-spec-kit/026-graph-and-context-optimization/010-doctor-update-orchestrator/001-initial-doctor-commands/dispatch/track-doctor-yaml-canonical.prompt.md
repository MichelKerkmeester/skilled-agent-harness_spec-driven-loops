...
# UPSTREAM ASSETS
# ─────────────────────────────────────────────────────────────────
upstream_assets: { ... }   # spec/ADR pointers from 001-initial-doctor-commands
...
3. Do NOT modify spec packet docs (`001-initial-doctor-commands/{spec,plan,tasks,checklist,decision-record,implementation-summary,resource-map}.md`) — that is a follow-on packet's scope.

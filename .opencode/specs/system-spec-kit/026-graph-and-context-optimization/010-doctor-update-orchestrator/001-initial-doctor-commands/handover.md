...
- **Read first:**
  ...
  - `.opencode/specs/.../002-deep-review-remediation/implementation-summary.md` (what changed in 001 during RM-8 remediation)
...
- [ ] Sibling packet: `002-deep-review-remediation` (Level 2, RM-8 remediation + cross-runtime mirror + security hardening)

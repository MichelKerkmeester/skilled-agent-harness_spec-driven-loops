...
- `.opencode/specs/.../010-doctor-update-orchestrator/001-initial-doctor-commands/spec.md` — spec packet
- `.opencode/specs/.../010-doctor-update-orchestrator/001-initial-doctor-commands/decision-record.md` — ADR decisions

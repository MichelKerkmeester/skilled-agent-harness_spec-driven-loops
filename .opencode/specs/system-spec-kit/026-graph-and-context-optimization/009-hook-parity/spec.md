---
title: "Feature Specification: Hook Parity [system-spec-kit/026-graph-and-context-optimization/009-hook-parity/spec]"
...
### In Scope
- Keep the active thematic parent at `009-hook-parity/`.
...
| `009-hook-parity/00N-*/` | Move | Hook-parity phase packet roots now live directly under this parent. |
<!-- /ANCHOR:scope -->

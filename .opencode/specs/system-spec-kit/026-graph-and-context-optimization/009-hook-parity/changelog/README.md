...
|-------|------|-------|----------------|
| 009/001 | 2026-04-21 | [Runtime hook parity remediation](./changelog-001-hook-parity-remediation.md) | 10 hook defects closed across OpenCode transport, Codex advisor/pre-tool, Copilot startup routing, and documentation truth-sync. |
| 009/002 | 2026-04-22 | [Copilot CLI hook parity remediation](./changelog-002-copilot-hook-parity-remediation.md) | Copilot receives startup context and advisor briefs through a managed custom-instructions block because Copilot hook output cannot mutate prompts. |
...
| 009/005 | 2026-04-22 | [OpenCode plugin loader remediation](./changelog-005-opencode-plugin-loader-remediation.md) | OpenCode TUI crash fixed. Helper modules relocated. Skill-advisor plugin remapped to OpenCode event and system.transform hooks. |
...
- Research artifacts for the Copilot schema crash live at `026/009/002/research/007-deep-review-remediation-pt-03/research.md`.

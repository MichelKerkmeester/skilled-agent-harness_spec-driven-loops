...
- `014-memory-save-planner-first-default/spec.md` and `implementation-summary.md` remain internally consistent about planner-first default, explicit `full-auto` fallback, and packet completion.

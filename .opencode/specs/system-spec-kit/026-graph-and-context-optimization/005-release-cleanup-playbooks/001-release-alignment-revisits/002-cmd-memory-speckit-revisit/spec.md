---
title: "...ontext-optimization/005-release-cleanup-playbooks/001-release-alignment-revisits/002-cmd-memory-speckit-revisit/spec]"
...
trigger_phrases:
  - "phase 018 command revisit"
  - "memory command revisit"
  - "spec kit command revisit"
  - "016 command alignment revisit"
...
- Re-review the 44 existing file paths extracted from the [016 002 reference map](../../z_archive/016-release-alignment/002-cmd-memory-and-speckit/reference-map.md).

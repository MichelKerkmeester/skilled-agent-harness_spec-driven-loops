...
| **Parent Spec** | ../spec.md |
| **Parent Plan** | ../plan.md |
| **Predecessor** | ../001-release-alignment-revisits/spec.md |
| **Successor** | ../003-playbook-and-remediation/spec.md |
<!-- /ANCHOR:metadata -->
...
|-----------|-------------|-------------|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-release-cleanup-playbooks/002-cleanup-and-audit/spec.md` | Create | Root coordination spec for the cleanup-and-audit packet |
<!-- /ANCHOR:scope -->

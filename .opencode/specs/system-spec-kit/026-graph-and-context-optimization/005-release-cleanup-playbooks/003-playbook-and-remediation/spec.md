...
| **Parent Spec** | ../spec.md |
| **Parent Plan** | ../plan.md |
| **Predecessor** | ../002-cleanup-and-audit/spec.md |
| **Successor** | None |
<!-- /ANCHOR:metadata -->
...
|-----------|-------------|-------------|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-release-cleanup-playbooks/003-playbook-and-remediation/spec.md` | Create | Root coordination spec for the playbook-and-remediation packet |
<!-- /ANCHOR:scope -->

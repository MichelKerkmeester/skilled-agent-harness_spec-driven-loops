...
- P1-5: Update `002-cache-warning-hooks` packet docs to describe autosave as intended stop-hook behavior
- P1-6: Batch-update `003-memory-quality-remediation` parent phase map and child status fields to match shipped state

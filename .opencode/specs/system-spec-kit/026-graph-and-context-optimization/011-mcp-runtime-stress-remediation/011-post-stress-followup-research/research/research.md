...
- **LOC**: ~150–250 (test-only). One new test file in `mcp_server/tests/code-graph-degraded-sweep.vitest.ts` (~150 LOC) + helper for DB-dir setup/teardown (~50 LOC) + fixture data (~30 LOC).

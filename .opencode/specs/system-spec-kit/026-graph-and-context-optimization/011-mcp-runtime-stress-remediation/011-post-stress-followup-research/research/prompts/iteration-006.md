...
You are iteration 6 of 10 in a deep-research loop. Build on prior iterations and refine fix proposals for the 5 open questions.
...
Read prior iterations' `Suggested focus for iteration 6` (if present) AND the strategy file's NEXT FOCUS section. Use those signals to decide which 1-2 questions deserve deepest attention. **Don't re-cover ground already covered** — refine, deepen, falsify, propose specific implementation sketches where feasible.
...
## Output requirement 1: write `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/011-mcp-runtime-stress-remediation/011-post-stress-followup-research/research/iterations/iteration-006.md` (ABSOLUTE PATH)
...
```markdown
# Iteration 006 — [your focus theme]
...
## Output requirement 2: write `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/011-mcp-runtime-stress-remediation/011-post-stress-followup-research/research/deltas/iter-006.jsonl` (ABSOLUTE PATH)

```json
{"type":"iteration","iteration":6,"newInfoRatio":<decimal>,"status":"completed","focus":"<theme>","questionsCovered":[...],"sourcesRead":[...],"keyFindings":[...],"timestamp":"2026-04-27T17:20:00Z"}
```
...
- **Refine, don't re-state** — by iteration 6 you should be deepening, not re-grounding.

...
bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh --strict \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-canonical-continuity-refactor/00N-gate-X-name
...
- Parent packet `006-canonical-continuity-refactor/spec.md` flipped to `status: complete`

...
- [x] T-06: Update `002-implement-cache-warning-hooks` packet docs (`spec.md:124`, `tasks.md:69`, `checklist.md:61`, `implementation-summary.md:63`) — describe autosave as intended
- [x] T-07: Update `003-memory-quality-issues/spec.md:99-109` and child specs — status updated via graph-metadata backfill (deriveStatus now checklist-aware)

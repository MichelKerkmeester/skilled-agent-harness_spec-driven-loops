...
| 5 | P1-5 | `002-implement-cache-warning-hooks/spec.md`, `tasks.md`, `checklist.md`, `implementation-summary.md` | Describe autosave as intended stop-hook behavior |
| 6 | P1-6 | `003-memory-quality-issues/spec.md` + child specs | Update status fields Draft→complete where implementation-summary confirms shipped |

...
```
/spec_kit:deep-research:auto "Content routing tier1/tier2/tier3 classification accuracy and threshold optimization" --max-iterations=15 --spec-folder=.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-canonical-continuity-refactor/018-research-content-routing-accuracy
```

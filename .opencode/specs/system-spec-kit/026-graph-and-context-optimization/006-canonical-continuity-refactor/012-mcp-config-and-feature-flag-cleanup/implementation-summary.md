...
| Field | Value |
|-------|-------|
| **Spec Folder** | 012-mcp-config-and-feature-flag-cleanup |
...
| `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh --strict .opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-canonical-continuity-refactor/012-mcp-config-and-feature-flag-cleanup` | PASS |

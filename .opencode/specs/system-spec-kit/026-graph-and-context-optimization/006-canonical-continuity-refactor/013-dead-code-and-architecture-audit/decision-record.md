---
title: "Decision Record: 026 / 006 / 013 — dead code and architecture audit"
...
# Decision Record: 026 / 006 / 013 — dead code and architecture audit
...
| **Status** | Accepted |
| **Date** | 2026-04-12 |
| **Deciders** | Codex implementation pass for Phase 026 / 006 / 013 |
...
**We chose**: keep code cleanup inside the `mcp_server` and `scripts` workspaces, while allowing shared truth updates only for the package architecture document and the parent Phase 006 resource map.
...
- The package architecture and parent resource map remain trustworthy summaries.
...
- Shared truth updates in the package architecture doc and parent resource map

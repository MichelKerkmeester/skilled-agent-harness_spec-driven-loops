...
>
> **Spec folder** (pre-approved, skip Gate 3): `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-canonical-continuity-refactor/`
...
- **Do NOT write outside `006-canonical-continuity-refactor/`.** No global file mutations.
...
- **No file writes outside `006-canonical-continuity-refactor/`.** Every artifact (research, findings, summary) lives inside the phase 018 spec folder.
...
| **Spec folder** | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-canonical-continuity-refactor/` |
...
| **Output root** | `006-canonical-continuity-refactor/research/` and `006-canonical-continuity-refactor/findings/` |

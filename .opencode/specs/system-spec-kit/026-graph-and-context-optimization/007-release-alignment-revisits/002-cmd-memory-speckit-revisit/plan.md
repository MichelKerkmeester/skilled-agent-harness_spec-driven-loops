...
- Documentation-only revisit scoped to the 44 files from the [016 002 reference map](../../z_archive/016-release-alignment/002-cmd-memory-and-speckit/reference-map.md)
...
- [x] The source-of-truth target list is locked to the [016 002 reference map](../../z_archive/016-release-alignment/002-cmd-memory-and-speckit/reference-map.md).

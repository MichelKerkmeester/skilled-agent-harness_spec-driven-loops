...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/007-release-alignment-revisits"
...
|-----------|-------------|-------------|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-release-alignment-revisits/spec.md` | Create | Root coordination spec for the release-alignment revisit packet |
<!-- /ANCHOR:scope -->

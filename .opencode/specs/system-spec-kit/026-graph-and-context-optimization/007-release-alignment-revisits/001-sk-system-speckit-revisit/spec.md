...
| Predecessor | `006-gate-f-archive-permanence` |
| Successor | `008-cmd-memory-speckit-revisit` |
...
- Re-review the 63 existing file paths extracted from the [016 001 reference map](../../z_archive/016-release-alignment/001-sk-system-speckit/reference-map.md).

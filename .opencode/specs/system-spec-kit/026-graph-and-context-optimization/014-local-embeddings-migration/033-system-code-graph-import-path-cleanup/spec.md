...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/033-system-code-graph-import-path-cleanup/spec.md"
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/033-system-code-graph-import-path-cleanup/` | Create | Level 2 packet docs and metadata. |
<!-- /ANCHOR:scope -->

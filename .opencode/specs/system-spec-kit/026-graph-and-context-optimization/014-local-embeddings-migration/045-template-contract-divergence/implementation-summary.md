...
| Field | Value |
|-------|-------|
| **Spec Folder** | `system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/045-template-contract-divergence` |
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/045-template-contract-divergence/` | Created | Captures the packet, contract map, verification evidence, and binding trace. |
<!-- /ANCHOR:what-built -->
...
| PACKET_PATH | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/045-template-contract-divergence` |

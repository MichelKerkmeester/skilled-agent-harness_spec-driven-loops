...
| Field | Value |
|-------|-------|
| **Spec Folder** | `system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/051-runtime-config-mk-code-index-parity-plus-findings` |
...
| 045 strict validation | PASS: `validate.sh .../045-shared-daemon-suite-runner --strict`, 0 errors and 0 warnings. |

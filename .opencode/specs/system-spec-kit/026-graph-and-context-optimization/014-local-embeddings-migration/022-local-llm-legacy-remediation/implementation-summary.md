...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/022-local-llm-legacy-remediation"
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/022-local-llm-legacy-remediation/ai-council/embedding-worker-diagnostic/seat-statements.md` | Created | Multi-seat AI council diagnosis (Systems/Empirical/Contrarian) |

...
Created the Level 3 packet under `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/050-all-skills-alignment-sweep/` and added `research/skills-audit.md`. The audit ledger records template evidence, current-reality facts, batch membership, per-skill baseline DQI proxy and follow-on candidates.

...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/038-embedding-error-propagation/` | Created | Track this implementation packet. |
<!-- /ANCHOR:what-built -->

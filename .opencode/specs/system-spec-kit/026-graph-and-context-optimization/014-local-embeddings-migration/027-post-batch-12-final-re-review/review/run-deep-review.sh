...
PACKET="$REPO_ROOT/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-setup-a/027-post-batch-12-final-re-review"
...
- 021-local-llm-legacy-review/**, 022-local-llm-legacy-remediation/**, 027-post-batch-12-final-re-review/** (own packets, not target)

...
- [x] CHK-042 [P0] `graph-metadata.json` parent and dependencies populated.
  - Evidence: parent_id is `system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration`; manual depends_on points at 037 and 039.
...
- [x] CHK-050 [P0] Packet lives at requested 034 path.
  - Evidence: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/034-query-expansion-context-size/`.

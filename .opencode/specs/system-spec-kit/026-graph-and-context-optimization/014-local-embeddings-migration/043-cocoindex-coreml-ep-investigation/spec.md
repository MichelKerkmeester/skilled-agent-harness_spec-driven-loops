...
| **Created** | 2026-05-14 |
| **Branch** | `main` |
| **Packet ID** | `system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/043-cocoindex-coreml-ep-investigation` |
<!-- /ANCHOR:metadata -->
...
|-----------|-------------|-------------|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/043-cocoindex-coreml-ep-investigation/spec.md` | Modify | Define the research-only packet scope and success criteria. |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/043-cocoindex-coreml-ep-investigation/plan.md` | Modify | Record the investigation approach and verification route. |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/043-cocoindex-coreml-ep-investigation/tasks.md` | Modify | Track completed inventory, analysis, and validation work. |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/043-cocoindex-coreml-ep-investigation/implementation-summary.md` | Modify | Summarize findings and evidence after completion. |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/043-cocoindex-coreml-ep-investigation/research.md` | Create | Document the EP state, hypothesis matrix, and performance baseline. |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/043-cocoindex-coreml-ep-investigation/decision-record.md` | Create | Record the CoreML EP adoption recommendation. |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/043-cocoindex-coreml-ep-investigation/scratch/*.txt` | Create | Preserve raw command output for auditability. |
<!-- /ANCHOR:scope -->

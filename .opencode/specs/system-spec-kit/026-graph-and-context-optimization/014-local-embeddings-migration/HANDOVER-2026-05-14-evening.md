...
All under `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/`. All strict-validate PASS (0 errors / 0 warnings).

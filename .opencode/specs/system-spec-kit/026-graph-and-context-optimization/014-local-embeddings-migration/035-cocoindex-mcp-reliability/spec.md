...
|-----------|-------------|-------------|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/035-cocoindex-mcp-reliability/` | Create | Level-2 diagnostic packet documentation and metadata |
<!-- /ANCHOR:scope -->

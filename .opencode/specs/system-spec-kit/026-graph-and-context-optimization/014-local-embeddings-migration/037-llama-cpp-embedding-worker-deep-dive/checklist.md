...
- [ ] CHK-070 [P0] All 037 spec docs at `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/037-llama-cpp-embedding-worker-deep-dive/`

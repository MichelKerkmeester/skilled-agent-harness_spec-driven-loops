...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/047-v8-dominates-relaxation"
...
The live parent handover at `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/handover.md` currently fails with `body:foreign spec ids dominate rendered content` while reporting `current_spec:014-local-llama-cpp`.
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/047-v8-dominates-relaxation/*` | Create | Level-2 packet docs and metadata. |
<!-- /ANCHOR:scope -->

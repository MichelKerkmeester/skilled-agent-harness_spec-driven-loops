...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/034-query-expansion-context-size/` | Create | Level-2 packet docs and metadata. |
<!-- /ANCHOR:scope -->

...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/040-reset-stuck-embedding-rows/` | Created | Packet docs and metadata for this reset. |
<!-- /ANCHOR:what-built -->

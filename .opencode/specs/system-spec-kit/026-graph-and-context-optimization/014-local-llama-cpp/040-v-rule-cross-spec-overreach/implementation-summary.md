...
| Field | Value |
|-------|-------|
| **Spec Folder** | `system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/040-v-rule-cross-spec-overreach` |
| **Started** | 2026-05-14 |
...
| PACKET_PATH | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/040-v-rule-cross-spec-overreach` |

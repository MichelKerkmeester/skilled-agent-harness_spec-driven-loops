...
- [ ] CHK-004 [P0] Parent 014-local-llama-cpp spec.md Phase Map updated for row 37 + handoff criteria
...
- [ ] CHK-070 [P0] All 037 spec docs at `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/037-llama-cpp-embedding-worker-deep-dive/`
...
- [ ] CHK-075 [P1] Parent 014-local-llama-cpp spec.md Phase Map row 37 still references 037- folder name

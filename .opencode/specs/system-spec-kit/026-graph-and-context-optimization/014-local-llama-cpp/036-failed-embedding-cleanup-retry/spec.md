...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/036-failed-embedding-cleanup-retry"
...
| **Parent Spec** | ../spec.md (014-local-llama-cpp phase parent) |
| **Phase** | 36 |
...
|-----------|-------------|-------------|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/036-failed-embedding-cleanup-retry/` | Create | Level-2 packet documentation and metadata |
<!-- /ANCHOR:scope -->

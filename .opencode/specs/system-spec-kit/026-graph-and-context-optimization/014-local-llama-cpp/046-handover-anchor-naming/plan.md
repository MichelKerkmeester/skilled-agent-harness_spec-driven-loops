...
_memory:
  continuity:
    ...
    session_dedup:
      ...
      session_id: "046-handover-anchor-naming-plan"
...
- Same-class producer inventory: `rg -n "session-log|session_log|session-notes|session_notes" .opencode/skills/system-spec-kit .../014-local-llama-cpp/handover.md`.

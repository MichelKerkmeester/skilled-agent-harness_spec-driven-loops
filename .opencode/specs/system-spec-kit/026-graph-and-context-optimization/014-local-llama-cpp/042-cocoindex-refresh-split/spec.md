...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/042-cocoindex-refresh-split"
    ...
    open_questions: []
    answered_questions:
      - "Gate 3: E - phase folder 042-cocoindex-refresh-split"
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/042-cocoindex-refresh-split/` | Create | Packet docs and metadata. |
<!-- /ANCHOR:scope -->

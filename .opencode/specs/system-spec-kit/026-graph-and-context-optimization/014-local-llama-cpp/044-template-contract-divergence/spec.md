...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/044-template-contract-divergence/` | Create | Level 2 packet documentation and verification evidence. |
<!-- /ANCHOR:scope -->

...
_memory:
  continuity:
    packet_pointer: ".opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/038-embedding-error-propagation"
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/038-embedding-error-propagation/` | Created | Track this implementation packet. |
<!-- /ANCHOR:what-built -->

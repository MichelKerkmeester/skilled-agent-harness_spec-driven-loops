...
| Field | Value |
|-------|-------|
| **Spec Folder** | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/033-system-code-graph-import-path-cleanup` |
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/033-system-code-graph-import-path-cleanup/` | Created | Level 2 packet docs and metadata. |
<!-- /ANCHOR:what-built -->

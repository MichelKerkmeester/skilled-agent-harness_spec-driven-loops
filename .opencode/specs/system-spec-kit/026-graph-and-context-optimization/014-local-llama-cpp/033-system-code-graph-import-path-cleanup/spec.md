...
_memory:
  continuity:
    packet_pointer: ".opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/033-system-code-graph-import-path-cleanup"
    ...
    key_files:
      ...
      - ".opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/033-system-code-graph-import-path-cleanup/spec.md"
      - ".opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/033-system-code-graph-import-path-cleanup/implementation-summary.md"
    session_dedup:
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/033-system-code-graph-import-path-cleanup/` | Create | Level 2 packet docs and metadata. |
<!-- /ANCHOR:scope -->

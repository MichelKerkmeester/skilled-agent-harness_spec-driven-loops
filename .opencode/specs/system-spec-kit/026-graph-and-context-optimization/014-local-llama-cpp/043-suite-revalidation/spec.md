...
_memory:
  continuity:
    ...
    open_questions: []
    answered_questions:
      - "Gate 3: E - phase folder 043-suite-revalidation"
...
|-----------|-------------|-------------|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/043-suite-revalidation/` | Create | Level 2 packet docs and metadata. |

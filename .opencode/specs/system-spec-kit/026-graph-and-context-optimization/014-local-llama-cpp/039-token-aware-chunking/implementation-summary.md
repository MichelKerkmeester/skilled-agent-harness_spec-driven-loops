...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-llama-cpp/039-token-aware-chunking/` | Created | Track this implementation packet. |
<!-- /ANCHOR:what-built -->

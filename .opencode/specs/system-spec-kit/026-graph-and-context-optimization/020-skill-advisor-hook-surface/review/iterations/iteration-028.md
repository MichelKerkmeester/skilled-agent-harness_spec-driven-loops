...
## Evidence read
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/020-skill-advisor-hook-surface/review/deep-review-strategy.md:26,30-34,79-81` -> R03 keeps D7 on documentation accuracy and explicitly asks for command-snippet and path verification on fresh evidence.

...
- Parent: `../spec.md`
- Predecessors: `../004-*`, `../005-*` (HARD GATE), `../006-claude-hook-wiring/`
- Research: `../../../research/020-skill-advisor-hook-surface-001-initial-research/research.md §Gemini path + §Copilot path`
- Extended research: `../../../research/020-skill-advisor-hook-surface-001-initial-research-extended-copilot/research-extended.md §X3`

...
- .opencode/specs/system-spec-kit/026-graph-and-context-optimization/020-skill-advisor-hook-surface/review/iterations/iteration-010.md:33-34 → prior D3 coverage already established the separate zero-read blind spot, so this iteration targeted nonzero multi-read session accounting instead.

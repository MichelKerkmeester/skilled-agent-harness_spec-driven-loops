...
- .opencode/specs/system-spec-kit/026-graph-and-context-optimization/020-skill-advisor-hook-surface/implementation-summary.md:187-191 → the packet still records OpenCode plugin follow-up work as separate from the original four-runtime hook rollout.

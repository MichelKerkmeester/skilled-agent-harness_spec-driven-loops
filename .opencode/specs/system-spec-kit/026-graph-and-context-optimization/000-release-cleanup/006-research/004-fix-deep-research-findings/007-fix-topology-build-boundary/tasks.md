...
_memory:
  continuity:
    ...
    session_dedup:
      ...
      session_id: "049-007-fix-topology-build-boundary"
...
- Worked-pilot pattern: `../004-fix-validation-memory/` (commit `1822a1e69`) and `../010-fix-cli-orchestrator-doc-drift/` (commit `889d1ee08`)
<!-- /ANCHOR:cross-refs -->

...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/004-deep-research-findings-remediation/005-resource-leaks-silent-errors"
...
- [x] T001 [P1] Re-read packet 046 §3/§4 to confirm finding IDs and cited line ranges (`.opencode/specs/.../003-system-bug-improvement-research/research/research.md`)
...
- Source of truth: `../003-system-bug-improvement-research/research/research.md` §3, §4
- Parent packet: `../spec.md` (049 phase parent — manifest)
- Worked-pilot pattern: `../004-validation-memory-remediation/` (commit `1822a1e69`)
- Predecessor: `../003-skill-advisor-quality-remediation/` (commit `f5b815c7e`) — preserves projection.ts coexistence
<!-- /ANCHOR:cross-refs -->

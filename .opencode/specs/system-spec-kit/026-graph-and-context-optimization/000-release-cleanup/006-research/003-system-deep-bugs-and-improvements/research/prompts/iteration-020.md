...
You are the deep-research LEAF agent for iteration 020 of 20. The packet root is `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-system-deep-bugs-and-improvements/`.
...
### 1. Iteration narrative — write to `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-system-deep-bugs-and-improvements/research/iterations/iteration-020.md`
...
### 2. Per-iteration delta JSONL — write to `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-system-deep-bugs-and-improvements/research/deltas/iter-020.jsonl`

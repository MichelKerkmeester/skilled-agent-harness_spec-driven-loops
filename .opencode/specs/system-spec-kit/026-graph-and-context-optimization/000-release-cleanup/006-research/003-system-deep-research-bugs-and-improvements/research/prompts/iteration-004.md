...
You are the deep-research LEAF agent for iteration 004 of 20. The packet root is `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-system-deep-research-bugs-and-improvements/`.

**Workflow position**: Iteration 004 of 20. Convergence threshold: 0.01. Executor: yourself (cli-codex gpt-5.5 high, normal speed).
...
### 1. Iteration narrative — write to `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-system-deep-research-bugs-and-improvements/research/iterations/iteration-004.md`
...
|----|----------|-----------|-------------|----------------|
| F-004-A4-01 | P0/P1/P2/none | path/file.ext:LINE | What's wrong | What to do |

## Questions Answered
[Which sub-questions of A4 did this iteration answer?]

## Questions Remaining
[Open A4 questions for follow-on packets]
...
### 2. Per-iteration delta JSONL — write to `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-system-deep-research-bugs-and-improvements/research/deltas/iter-004.jsonl`

One JSON record per line. MUST start with the canonical iteration record:

```json
{"type":"iteration","iteration":4,"newInfoRatio":0.85,"status":"insight","focus":"A4: Silent error recovery patterns","angle":"A4"}
```

Then one `{"type":"finding",...}` record per finding:

```json
{"type":"finding","id":"f-iter004-001","severity":"P1","label":"<short label>","file":"path/file.ext","line":NN,"iteration":4,"angle":"A4"}
```

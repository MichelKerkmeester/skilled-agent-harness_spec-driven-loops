...
| Strict validator | PASS: `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh specs/system-spec-kit/026-graph-and-context-optimization/045-release-readiness-deep-review-program/005-cross-runtime-hook-parity --strict`. |
<!-- /ANCHOR:verification -->

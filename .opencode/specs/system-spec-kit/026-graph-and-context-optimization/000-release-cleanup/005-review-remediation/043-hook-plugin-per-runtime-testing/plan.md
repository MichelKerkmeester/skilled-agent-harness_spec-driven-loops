...
Remove the packet-local files added under `043-hook-plugin-per-runtime-testing/`. Runtime hook configs were not modified, so rollback does not require restoring Claude, Codex, Copilot, Gemini, or OpenCode settings.
<!-- /ANCHOR:rollback -->

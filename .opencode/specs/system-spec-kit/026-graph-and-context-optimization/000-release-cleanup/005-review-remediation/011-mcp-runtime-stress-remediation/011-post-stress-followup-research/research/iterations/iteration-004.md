...
Evidence:
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/011-mcp-runtime-stress-remediation/004-cocoindex-overfetch-dedup/spec.md:69` through `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/011-mcp-runtime-stress-remediation/004-cocoindex-overfetch-dedup/spec.md:73` define the intended fork behavior: keep `.opencode/specs`, add identity fields, fetch `limit * 4`, dedup, rerank by `path_class`, and surface telemetry.

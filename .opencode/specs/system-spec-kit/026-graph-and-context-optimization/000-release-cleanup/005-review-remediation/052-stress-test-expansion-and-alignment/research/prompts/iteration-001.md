...
You are cli-codex (gpt-5.5 high fast) implementing **052-stress-test-expansion-and-alignment**.

### CRITICAL: Spec folder path

The packet folder is: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/052-stress-test-expansion-and-alignment/` — write ALL packet files there. Do NOT ask for the spec folder.
...
bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/052-stress-test-expansion-and-alignment --strict
...
**Deps**: `manual.depends_on=["system-spec-kit/026-graph-and-context-optimization/038-stress-test-folder-completion","system-spec-kit/026-graph-and-context-optimization/050-feature-catalog-shape-realignment"]`.

**Trigger phrases**: `["052-stress-test-expansion-and-alignment","stress test alignment","stress test coverage","sk-code-opencode stress test"]`.

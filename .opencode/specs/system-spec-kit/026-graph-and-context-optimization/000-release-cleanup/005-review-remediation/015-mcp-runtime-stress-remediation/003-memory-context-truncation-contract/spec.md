...
title: "Feature Specification: memory_context truncation contract + token telemetry [system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/015-mcp-runtime-stress-remediation/003-memory-context-truncation-contract/spec]"
...
<!-- SPECKIT_LEVEL: 1 -->
<!-- PHASE_LINKS_PARENT: ../spec.md; PREDECESSOR: 002-mcp-runtime-improvement-research; SUCCESSOR: 004-cocoindex-overfetch-dedup -->
<!-- SPECKIT_TEMPLATE_SOURCE: spec-core | v2.2 -->
...
| **Sibling Phases** | 005-memory-search-runtime-bugs, 001-search-intelligence-stress-test, 002-mcp-runtime-improvement-research |
<!-- /ANCHOR:metadata -->

...
| `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/003-cleanup/032-public-doc-internal-spec-reference-removal/**` | Create/Modify | Track this cleanup packet |
<!-- /ANCHOR:scope -->

...
│   ├── 001-sk-code-opencode-standards-audit/
│   ├── 002-feature-catalog-trio-alignment/
│   ├── 003-testing-playbook-trio-alignment/
...
- Scope line: "Parent-aggregate map across the 6 children of 003-post-program-quality-pass"
...
7-file structure under `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/014-resource-map-memory-finalization/`.
...
**Trigger phrases**: `["014-resource-map-memory-finalization","resource maps cycle","memory finalization","session packet indexing"]`.

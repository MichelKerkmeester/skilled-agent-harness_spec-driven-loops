...
- [x] T003 [P] Read reference resource map (`.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-mcp-runtime-stress-remediation/resource-map.md`)
<!-- /ANCHOR:phase-1 -->

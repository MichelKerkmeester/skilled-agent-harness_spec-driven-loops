...
- **Missing on disk**: 0
- **Scope**: All paths created, updated, removed, or analyzed during phase 053 (`028-doc-alignment-and-readme-filling`) under parent `000-release-cleanup`. One aggregated map per packet (not per-WB).
...
| Path | Action | Status | Note |
|------|--------|--------|------|
| `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/028-doc-alignment-and-readme-filling/spec.md` | Created | OK | Level 3 spec authored manually after `--phase` scaffold output Level 1 boilerplate. |
| `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/028-doc-alignment-and-readme-filling/plan.md` | Created | OK | Authored alongside spec.md; references this resource-map. |
| `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/028-doc-alignment-and-readme-filling/tasks.md` | Created | OK | Granular task breakdown per work-block. |
| `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/028-doc-alignment-and-readme-filling/checklist.md` | Created | OK | Verification checklist; populated during Phase 2/3. |
| `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/028-doc-alignment-and-readme-filling/decision-record.md` | Created | OK | 3 ADRs (D-1 merge scope, D-2 prefix scheme, D-3 manifest-doc placement). |
| `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/028-doc-alignment-and-readme-filling/resource-map.md` | Created | OK | This file. |
| `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/028-doc-alignment-and-readme-filling/implementation-summary.md` | Created | OK | Filled at Phase 3 completion. |
| `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/028-doc-alignment-and-readme-filling/description.json` | Updated | OK | Auto-generated by `create.sh`; refreshed by `generate-context.js` post-author. |
| `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/028-doc-alignment-and-readme-filling/graph-metadata.json` | Updated | OK | Auto-generated by `create.sh`; needs `parent_id` restored to `system-spec-kit/026-graph-and-context-optimization/000-release-cleanup` post-author. |
...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/028-doc-alignment-and-readme-filling \
  --strict
...
rg -ln 'operator_runbook' .opencode/ specs/ \
  | grep -v '028-doc-alignment-and-readme-filling' \

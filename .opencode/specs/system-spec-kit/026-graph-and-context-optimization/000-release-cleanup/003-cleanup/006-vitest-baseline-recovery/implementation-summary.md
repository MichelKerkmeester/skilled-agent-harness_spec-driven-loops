...
| Decision | Rationale |
|----------|-----------|
| Use placeholder follow-up `026/000/007-vitest-recovery-followup` | User explicitly approved placeholder IDs for escalated runtime or flaky cases. |
...
| Runtime regression | 152 | Follow-up required: `026/000/007-vitest-recovery-followup` |
...
3. Several broad runtime-regression clusters exceed the packet's <=30 LOC single-file repair rule and need `026/000/007-vitest-recovery-followup`.

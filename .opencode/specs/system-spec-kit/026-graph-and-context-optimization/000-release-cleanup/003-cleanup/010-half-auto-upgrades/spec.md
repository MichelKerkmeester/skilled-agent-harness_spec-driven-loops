...
| **Related** | `001-automation-self-management-deep-research`, `002-automation-reality-supplemental-research` |
...
2. Codex timeout fallback served stale cold-start context without a machine-visible marker. [EVIDENCE: `../001-automation-self-management-deep-research/research/research-report.md:13`; `.opencode/skills/system-spec-kit/mcp_server/hooks/codex/user-prompt-submit.ts:174-180` before this packet]

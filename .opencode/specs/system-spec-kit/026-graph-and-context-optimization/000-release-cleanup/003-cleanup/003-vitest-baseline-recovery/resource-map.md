...
| runtime-regression | `it.fails.skip` + `// followup: 026/000/007-vitest-recovery-followup` | 152 |
...
- **Tests escalated**: 152 runtime-regression → `026/000/007-vitest-recovery-followup`.
...
The 196 remaining failures are tracked via annotation comments (`// followup: 026/000/007-vitest-recovery-followup`). Operators can `grep -rn 'followup: 026/000/007'` to inventory the deferred work. The follow-up packet itself is not scaffolded in this release.

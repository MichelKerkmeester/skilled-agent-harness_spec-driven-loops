...
- [ ] T011 Annotate larger runtime regressions with `it.fails.skip` and `// followup: 026/000/007-vitest-recovery-followup`.
...
- **Follow-up placeholder**: `026/000/007-vitest-recovery-followup`

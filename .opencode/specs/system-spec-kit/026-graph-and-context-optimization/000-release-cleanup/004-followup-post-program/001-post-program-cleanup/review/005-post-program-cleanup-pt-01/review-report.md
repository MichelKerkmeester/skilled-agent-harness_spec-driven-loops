...
- `008-skill-advisor/002-skill-graph-daemon-and-advisor-unification/graph-metadata.json:44` has `derived.status: "in_progress"`.
...
- Strict validator on `003-mcp-runtime-stress-remediation` exits 2.
...
| REQ-002 | P1 | Attempt to bring `003-mcp-runtime-stress-remediation` strict validation to green; halt after two fix passes if broad historical debt remains. |
...
| `validate.sh .../003-mcp-runtime-stress-remediation --strict` | FAIL, 21 errors / 33 warnings |

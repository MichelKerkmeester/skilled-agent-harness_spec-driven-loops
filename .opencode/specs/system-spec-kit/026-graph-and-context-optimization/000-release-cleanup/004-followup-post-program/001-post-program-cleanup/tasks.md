...
- [x] T009 Refresh stale `derived.status` values for completed packets. Evidence: `../001-memory-indexer-storage-boundary/graph-metadata.json`, `../002-tier2-remediation/graph-metadata.json`, `../../../006-skill-advisor/002-daemon-and-unification/graph-metadata.json`.

...
- **Runtime cleanup**: 005-post-program-cleanup (general post-program cleanup) and 054-runtime-cleanup-followups (packet 096 followups: workspace root hardening, memory health diagnostics, deprecated-tier bulk deletion)

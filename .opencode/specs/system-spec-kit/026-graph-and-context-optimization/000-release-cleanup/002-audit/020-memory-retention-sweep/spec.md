...
The 013 supplemental research validated P1-2: governed memory ingest persists `delete_after`, but no cleanup path consumes it. Session cleanup is real but targets session-state tables, and `memory_bulk_delete` filters by tier/spec/date rather than `delete_after`. [EVIDENCE: `../017-automation-reality-supplemental-research/research/research-report.md:40`; `../017-automation-reality-supplemental-research/research/iterations/iteration-004.md:73-76`]

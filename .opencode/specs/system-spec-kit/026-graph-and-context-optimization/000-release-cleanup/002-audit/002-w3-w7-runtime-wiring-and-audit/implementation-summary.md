...
| F-EMPTY-001 | Closed | Removed `.opencode/skills/system-spec-kit/mcp_server/tmp-test-fixtures/specs/` and duplicate empty `.opencode/skills/system-spec-kit/specs/.../004-search-rag-measurement-driven-implementation/measurements/`; follow-up `find` returned no paths. |

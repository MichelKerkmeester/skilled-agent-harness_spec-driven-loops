...
- **Q1**: Should `it.fails.skip` annotations point at follow-up packet IDs that don't exist yet? (Recommendation: yes — placeholders fine; e.g., `// followup: 026/000/007-vitest-recovery-followup`.)

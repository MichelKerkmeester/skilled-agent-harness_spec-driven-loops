...
title: "Tasks: causal-graph window metrics + auto-edge caps [system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/015-mcp-runtime-stress-remediation/006-causal-graph-window-metrics/tasks]"

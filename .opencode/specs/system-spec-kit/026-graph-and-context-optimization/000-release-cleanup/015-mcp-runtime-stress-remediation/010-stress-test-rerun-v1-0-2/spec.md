...
| REQ-016 | Memory DB re-indexed on this packet | After scaffolding lands, run `memory_index_scan({ specFolder: "system-spec-kit/.../015-mcp-runtime-stress-remediation/010-stress-test-rerun-v1-0-2" })`. Tracked as T305 in `tasks.md`. |

...
- [x] CHK-003 [P1] Historical evidence reviewed. [EVIDENCE: `../030-hook-plugin-per-runtime-testing/results/*.jsonl`]
<!-- /ANCHOR:pre-impl -->
...
- [x] CHK-010 [P0] Runner changes are scoped to methodology files. [EVIDENCE: `../030-hook-plugin-per-runtime-testing/runners/*.ts`]
- [x] CHK-011 [P0] Hook and plugin source code is unchanged. [EVIDENCE: `git status --short`]
- [x] CHK-012 [P1] `SKIPPED_SANDBOX` remains distinct from `SKIPPED`. [EVIDENCE: `../030-hook-plugin-per-runtime-testing/runners/common.ts`]
- [x] CHK-013 [P1] Runner output avoids rewriting historical results. [EVIDENCE: `../030-hook-plugin-per-runtime-testing/run-output/latest/`]
<!-- /ANCHOR:code-quality -->
...
- [x] CHK-031 [P1] Sandbox probe writes only a temporary home probe and removes it. [EVIDENCE: `../030-hook-plugin-per-runtime-testing/runners/common.ts`]
<!-- /ANCHOR:security -->
...
- [x] CHK-041 [P1] Operator run path documented. [EVIDENCE: `../030-hook-plugin-per-runtime-testing/runners/README.md`]
- [x] CHK-042 [P1] Prior findings reclassified. [EVIDENCE: `../030-hook-plugin-per-runtime-testing/findings.md`]
<!-- /ANCHOR:docs -->

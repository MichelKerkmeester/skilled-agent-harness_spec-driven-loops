...
- None. All design choices match the sibling research packet (`../011-post-stress-finding-remediation-research/research/research.md` Section 4, Q-P1) recommendations 1-of-3 (isolated DB sweep). The remaining unknown of whether to also lower `DEFAULT_DEBOUNCE_MS` is owned by packet 014 (`../014-code-graph-status-readiness-snapshot/`), not this one.
<!-- /ANCHOR:questions -->

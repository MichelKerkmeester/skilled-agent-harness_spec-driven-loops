...
PACKET_ROOT="$(cd "${SCRIPT_DIR}/.." && pwd)"   # .../010-stress-test-close-loop-measurement-rerun (leaf packet; v1.0.2 reuses scripts in-tree)
RUNS_DIR="${PACKET_ROOT}/runs"
PROMPTS_DIR="${SCRIPT_DIR}/prompts"
LOG_FILE="${RUNS_DIR}/run-all.log"

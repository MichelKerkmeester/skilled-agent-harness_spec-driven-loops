...
>
> **Source of evidence**: read .../003-mcp-runtime-stress-remediation/010-stress-test-rerun-v1-0-2/findings.md Recommendations §1-5; per-cell scores at `010-stress-test-rerun-v1-0-2/runs/*/score.md`; preflight log at `runs/preflight.log`.
>

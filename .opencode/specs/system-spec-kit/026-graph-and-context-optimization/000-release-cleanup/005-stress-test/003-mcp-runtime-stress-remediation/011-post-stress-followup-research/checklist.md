...
- [ ] **CHK-P1-004** [P1] **C-P1-004** Topic prompt (rendered into `research/prompts/iteration-001.md`) cites source-of-evidence paths. **Evidence**: grep for 010-stress-test-rerun-v1-0-2/findings.md in iteration-001 prompt.
- [ ] **CHK-P1-005** [P1] **C-P1-005** Parent metadata updated: 4 parent files (spec.md, description.json, graph-metadata.json, resource-map.md) all reference new child. **Evidence**: grep `011-post-stress-followup-research` returns ≥1 hit per file.

...
- **Files:**
  - research.md §3.5 bullet 4 — `.opencode/specs/.../011-post-stress-finding-remediation-research/research/research.md:95-98`
...
- **Files (out of packet 012 scope):**
  - `.opencode/specs/.../003-mcp-runtime-stress-remediation/spec.md:114-116` (parent references 013–015)
  - `.opencode/specs/.../003-mcp-runtime-stress-remediation/description.json` and `graph-metadata.json`

...
Read prior iterations' `Suggested focus for iteration 2` AND strategy §11 NEXT FOCUS. Use those signals to decide which 1-2 questions deserve deepest attention. **Don't re-cover ground**.
...
- **Honest newFindingsRatio** — by iter 2 it should be decaying; high ratio in late iterations indicates churn

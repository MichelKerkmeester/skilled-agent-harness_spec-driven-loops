#!/usr/bin/env bash
# Loop iterations 2-10 of /spec_kit:deep-research:auto for 011-post-stress-finding-remediation-research.
...
- ${PWD}/.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/

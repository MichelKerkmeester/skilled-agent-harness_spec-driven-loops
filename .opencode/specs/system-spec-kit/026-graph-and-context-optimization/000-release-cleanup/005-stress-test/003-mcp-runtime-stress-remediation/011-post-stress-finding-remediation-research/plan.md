...
- T001: Author `011-post-stress-finding-remediation-research/{spec.md, plan.md, tasks.md, checklist.md, description.json, graph-metadata.json, implementation-summary.md}`
- T002: Update parent `003-mcp-runtime-stress-remediation/{spec.md, description.json, graph-metadata.json, resource-map.md}`
...
>
> **Source of evidence**: read .../003-mcp-runtime-stress-remediation/010-stress-test-close-loop-measurement-rerun/findings.md Recommendations §1-5; per-cell scores at `010-stress-test-close-loop-measurement-rerun/runs/*/score.md`; preflight log at `runs/preflight.log`.
>
...
2. Discard the new packet by `git rm -r 011-post-stress-finding-remediation-research/` and reverting the parent-metadata edits.

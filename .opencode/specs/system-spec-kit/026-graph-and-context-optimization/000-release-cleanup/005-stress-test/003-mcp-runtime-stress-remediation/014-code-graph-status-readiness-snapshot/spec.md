...
title: "Feature Specification: code_graph_status read-only readiness snapshot [system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-mcp-runtime-stress-remediation/014-code-graph-status-readiness-snapshot/spec]"
...
<!-- SPECKIT_LEVEL: 1 -->
<!-- PHASE_LINKS_PARENT: ../spec.md; PREDECESSOR: 013-code-graph-degraded-stress-cell; SUCCESSOR: 015-cocoindex-seed-telemetry-passthrough -->
<!-- SPECKIT_TEMPLATE_SOURCE: spec-core | v2.2 -->

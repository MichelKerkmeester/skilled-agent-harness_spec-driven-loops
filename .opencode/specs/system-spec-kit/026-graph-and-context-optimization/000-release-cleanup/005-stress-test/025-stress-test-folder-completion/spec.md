...
| **Created** | 2026-04-29 |
| **Branch** | `main` |
| **Depends On** | `system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/024-followup-quality-pass/005-stress-test-folder-migration` |
<!-- /ANCHOR:metadata -->

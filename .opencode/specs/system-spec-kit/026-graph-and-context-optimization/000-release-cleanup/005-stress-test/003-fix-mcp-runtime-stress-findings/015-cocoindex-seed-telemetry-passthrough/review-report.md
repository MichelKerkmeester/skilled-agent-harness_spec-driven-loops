...
**Date:** 2026-04-27
**Packet:** `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/015-cocoindex-seed-telemetry-passthrough/`
**Mode:** Read-only

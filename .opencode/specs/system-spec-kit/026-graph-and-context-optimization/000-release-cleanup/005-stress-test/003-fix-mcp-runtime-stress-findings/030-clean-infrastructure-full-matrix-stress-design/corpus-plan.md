...
Packet 029 used this posture for its 12-case/16-capture run and warned that rates and percentiles were directional (`029-clean-infrastructure-stress-test/findings-v1-0-4.md:27`, `:152`).

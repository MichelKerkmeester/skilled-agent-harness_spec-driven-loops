...
**Ship 3 remediation packets** (`016-degraded-readiness-envelope-parity/`, `017-cli-copilot-dispatch-test-parity/`, `018-feature-catalog-playbook-degraded-alignment/`) under the 011 phase parent. Packet A is required (P1); Packets B and C are P2 follow-ups. Packet C should reference the contract Packet A actually ships.

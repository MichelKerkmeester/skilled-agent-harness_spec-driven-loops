...
You are cli-codex (gpt-5.5 high fast) implementing **005-expansion-and-alignment**.

### CRITICAL: Spec folder path

The packet folder is: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/005-expansion-and-alignment/` — write ALL packet files there. Do NOT ask for the spec folder.
...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/005-expansion-and-alignment --strict
...
**Trigger phrases**: `["005-expansion-and-alignment","stress test alignment","stress test coverage","sk-code-opencode stress test"]`.

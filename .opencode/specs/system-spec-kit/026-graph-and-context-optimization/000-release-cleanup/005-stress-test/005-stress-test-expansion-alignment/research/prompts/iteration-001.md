...
The packet folder is: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/005-stress-test-expansion-alignment/` — write ALL packet files there. Do NOT ask for the spec folder.
...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/005-stress-test-expansion-alignment --strict
...
**Trigger phrases**: `["005-stress-test-expansion-alignment","stress test alignment","stress test coverage","sk-code-opencode stress test"]`.

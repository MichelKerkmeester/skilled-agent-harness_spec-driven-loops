...
- [x] **T19** [REQ-006] Strict validation: run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/002-daemon-and-unification --strict`. Exit: exit 0 OR keep as explicit operator gate with rationale. Evidence: command exit 0.

...
| Field | Value |
|-------|-------|
| **Spec Folder** | 002-second-pass-release-readiness-remediation |
...
- Strict validators did not pass. The focused implementation tests and build are green, but validator runs failed on structural/template debt:
  - `002-second-pass-release-readiness-remediation`: custom task/checklist/summary section shape lacks the current Level 2 template anchors.

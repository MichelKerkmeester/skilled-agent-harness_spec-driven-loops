...
trigger_phrases:
  - "045-009-documentation-truth-audit"
  - "docs truth audit"
  - "stale claims review"
...
| DOC-TRUTH-005 | P1 | Correctness | Skill Advisor overview and install docs omit `advisor_rebuild` from the public native tool list | `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/README.md:38-42`, `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/README.md:180-185`, `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/INSTALL_GUIDE.md:26-28`, `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/tools/advisor-rebuild.ts:7-10` |
| DOC-TRUTH-006 | P1 | Maintainability | Local markdown cross-references are broken in root and generated catalog/playbook indexes | `README.md:1318`, `.opencode/skills/system-spec-kit/feature_catalog/feature_catalog.md:539`, `.opencode/skills/system-spec-kit/manual_testing_playbook/manual_testing_playbook.md:2146` |
| DOC-TRUTH-007 | P2 | Maintainability | Evergreen grep remains too noisy to use as a clean release gate without a stable-ID allowlist | `.opencode/skills/sk-doc/references/global/evergreen_packet_id_rule.md:29-35` |
...
| Automation trigger columns | Pass | `AGENTS.md:94-100`, `CLAUDE.md:94-100`, `.opencode/skills/system-spec-kit/SKILL.md:758-763`, and `.opencode/skills/system-spec-kit/mcp_server/README.md:544-552` use non-empty trigger columns plus caveats. |
| Security posture | Pass | API key guidance uses placeholders such as `README.md:140-143`; install guide uses placeholder paths at `.opencode/skills/system-spec-kit/mcp_server/INSTALL_GUIDE.md:334-348` and warns Codex users about writable DB placement at `.opencode/skills/system-spec-kit/mcp_server/INSTALL_GUIDE.md:310-313`. |
...
| Source | Evidence |
|--------|----------|
| Local tool descriptors | `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:48-884` contains 50 `name: '` descriptors by grep. |
| Advisor schema entries | `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/schemas/advisor-tool-schemas.ts:268-273` lists `advisor_recommend`, `advisor_rebuild`, `advisor_status`, and `advisor_validate`. |

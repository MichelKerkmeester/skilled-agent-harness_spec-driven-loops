...
The packet folder is: `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/005-remaining-priority-findings-remediation/` — write ALL packet files there. Do NOT ask for the spec folder.
...
- `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/004-release-readiness-findings-synthesis-remediation/synthesis.md` (full P1 + P2 registries)
- `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/004-release-readiness-findings-synthesis-remediation/remediation-log.md` (what 046 already fixed; do NOT re-do)
- `.opencode/skills/sk-doc/references/global/evergreen_packet_id_rule.md` (honor)
- All 10 review-reports under `003-release-readiness-deep-review-audits/00X-*/review-report.md` for full context
...
**Deps**: `manual.depends_on=["system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/004-release-readiness-findings-synthesis-remediation"]`.

**Trigger phrases**: `["005-remaining-priority-findings-remediation","P1 P2 backlog","release polish","conservative defaults pass"]`.

...
- `014-memory-save-planner-first-default/plan.md`, `implementation-summary.md`, and `decision-record.md` remain internally consistent about the planner-first delivery arc; the identity drift is concentrated in `spec.md`, `tasks.md`, and `checklist.md`.

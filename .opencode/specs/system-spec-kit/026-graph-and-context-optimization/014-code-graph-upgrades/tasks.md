...
- [x] T001 Define the packet boundary against `007`, `008`, and `011`, with explicit non-overlap notes in spec, plan, and tasks. [SOURCE: spec.md:31] [SOURCE: decision-record.md:89] [EVIDENCE: runtime changes stayed inside `mcp_server/lib/context/`, `mcp_server/lib/code-graph/`, `mcp_server/handlers/code-graph/`, and additive resume/bootstrap preservation only]

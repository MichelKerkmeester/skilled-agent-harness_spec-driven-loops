...
- [ ] CHK-010 [P0] Canonical continuity is verified as the only live runtime path.
- [ ] CHK-011 [P0] A sample save is verified end to end against the canonical path.
...
- [ ] CHK-013 [P1] Any remaining rollout flag is confirmed canonical or removed entirely.
<!-- /ANCHOR:code-quality -->
...
- [ ] CHK-021 [P1] The broader mapped doc-parity batches are all complete.
- [ ] CHK-022 [P1] Updated surfaces are swept for retired continuity vocabulary.
<!-- /ANCHOR:testing -->
...
- [ ] CHK-031 [P0] `validate.sh --strict` for this packet has been run and attached.
- [ ] CHK-032 [P1] Repo-wide completion claims, if made, cite actual validator output and update counts.
<!-- /ANCHOR:security -->

<!-- ANCHOR:docs -->
## Documentation

- [ ] CHK-040 [P0] `implementation-summary.md` contains final touched files, validation state, and any real post-flip metrics.
- [ ] CHK-041 [P1] Packet frontmatter and closeout wording are marked complete only after evidence exists.
- [ ] CHK-042 [P2] Any remaining parity gaps or uncertainties are logged clearly for follow-up.
<!-- /ANCHOR:docs -->
...
- [ ] CHK-051 [P1] Final packet closeout artifacts are present with no missing required evidence.
- [ ] CHK-052 [P2] Any follow-up gaps are recorded cleanly for the orchestrator.
<!-- /ANCHOR:file-org -->

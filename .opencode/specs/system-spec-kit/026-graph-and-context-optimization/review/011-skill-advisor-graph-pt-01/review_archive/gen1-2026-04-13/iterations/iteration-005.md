...
## Verified claims
- Section 3.3's damping constants still match the implementation: enhances uses `0.3`, siblings `0.15`, depends_on `0.2`, family affinity `0.08`, and the boost floor remains `0.1`. [SOURCE: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-search-routing-advisor/002-skill-advisor-graph/spec.md:145-147] [SOURCE: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-search-routing-advisor/002-skill-advisor-graph/plan.md:88-97] [SOURCE: .opencode/skill/skill-advisor/scripts/skill_advisor.py:100-149]

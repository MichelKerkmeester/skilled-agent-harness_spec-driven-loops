...
Open a promotion-remediation pass to fix the stale prompt, regenerate root review artifacts, refresh root graph-metadata into canonical JSON, and reconcile root packet completion state before treating `010-search-and-routing-tuning` as cleanly promoted.

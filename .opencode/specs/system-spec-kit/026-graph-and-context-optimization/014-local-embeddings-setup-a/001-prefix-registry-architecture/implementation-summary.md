...
- Sub-phase 002 partially blocked: Qwen3-Embedding-4B downloading; `google/embeddinggemma-300m` is an HF-gated repo, requires user authentication or fallback to `mixedbread-ai/mxbai-embed-large-v1`.
<!-- /ANCHOR:limitations -->

...
# (a) Qwen lookup
a = resolve_query_prompt_name('Qwen/Qwen3-Embedding-4B')
...
c = resolve_query_prompt_name('Qwen/Qwen3-Embedding-4B')
...
d = resolve_query_prompt_name('Qwen/Qwen3-Embedding-4B')
assert d is None, f"(d) empty override expected None got {d!r}"
del os.environ['COCOINDEX_QUERY_PROMPT_NAME']

# (e) Registry has Qwen entries
assert 'Qwen/Qwen3-Embedding-4B' in _QUERY_PROMPT_MODELS

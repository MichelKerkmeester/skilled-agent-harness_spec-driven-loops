...
## Focus
Swept the promoted `010-continuity-research` tree for exact old-path references (`006`, `017`, `018`, `019`) to distinguish legitimate historical citations in research notes from genuinely stale live operational surfaces that should already have been migrated.

---
title: "Phase Parent Rollup: graph impact and affordance"
description: "Rollup of 6 child phase changelogs under 005-graph-impact-and-affordance. Each child shipped independently and is listed in the Included Phases table. Detail lives in the child changelogs."
trigger_phrases:
...
|------|--------|--------------|
| `005-graph-impact-and-affordance/` (child phases) | n/a | Rollup of 6 child phase changelogs, no direct source changes at the parent level |

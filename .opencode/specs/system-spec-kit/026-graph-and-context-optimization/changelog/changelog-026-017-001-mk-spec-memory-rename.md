# Changelog — 026/017: mk-spec-memory MCP Server Rename
...
- Packet relocated `027-xce-research-based-refinement/001-rename-mcp-namespace-mk-spec-memory` → `026-graph-and-context-optimization/017-mk-spec-memory-rename`
...
Deep-review packet (`017/review/`, commit `259886eec`) flagged 6 P1 + 5 P2 findings. The remediation packet `018-mk-spec-memory-rename-remediation` closes all 11 findings.

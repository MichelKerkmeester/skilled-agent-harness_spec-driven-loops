...
| 002 | 2026-05-02 | [Resource map template creation](./changelog-002-resource-map-template-creation.md) | Created the cross-cutting resource-map.md template and wired it into 12 discovery surfaces. |

...
| 010/003 | 2026-05-01 | [Template greenfield implementation](./changelog-003-003-manifest-template-implementation-plan.md) | Executed the 4-phase plan: added manifest/resolver/renderer/CI-test, modified scaffolder, modified validators, deleted 51 legacy files. Source surface: 86 to 13. |

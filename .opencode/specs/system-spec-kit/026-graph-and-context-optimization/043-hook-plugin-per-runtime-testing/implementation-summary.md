...
| Field | Value |
|-------|-------|
| **Spec Folder** | 043-hook-plugin-per-runtime-testing |
...
| `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh specs/.../043-hook-plugin-per-runtime-testing --strict` | Exit 0 |
<!-- /ANCHOR:verification -->

...
- **Procedure**: Revert only `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/014-local-embeddings-migration/041-llama-cpp-metal-investigation/`.
<!-- /ANCHOR:rollback -->

---
title: "Decision Record: Auditable Savings Publication Contract [template:level_3/decision-record.md]"
description: "Decision record for 009-auditable-savings-publication-contract."
trigger_phrases:
...
---
# Decision Record: Auditable Savings Publication Contract
...
<!-- ANCHOR:adr-001 -->
## ADR-001: Gate publication after measurement honesty, not before
...
The research ranked the auditable-savings stack highly, but only as a governance layer on top of a measurement contract and reader substrate. Publishing first would repeat the same certainty laundering problem.
...
**We chose**: Open a dedicated publication-governance packet that consumes the measurement contract and reader substrate while keeping UI work out of scope.
...
|--------|------|------|-------|
| **Publication contract packet** | Keeps reporting auditable and explainable | Defers dashboard polish until contracts are stable | 8/10 |
| **Dashboard-first packet** | Looks more visible | Overruns the evidence quality the research warned about | 3/10 |

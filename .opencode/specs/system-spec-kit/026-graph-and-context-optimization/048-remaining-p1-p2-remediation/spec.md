...
_memory:
  continuity:
    ...
    key_files:
      ...
      - "decision-record.md"
    session_dedup:
      fingerprint: "sha256:048-remaining-p1-p2-remediation"
...
| **Status** | Complete |
| **Created** | 2026-04-30 |
| **Branch** | `048-remaining-p1-p2-remediation` |
<!-- /ANCHOR:metadata -->
...
| `specs/.../048-remaining-p1-p2-remediation/` | Create | Packet docs and ledgers |
<!-- /ANCHOR:scope -->

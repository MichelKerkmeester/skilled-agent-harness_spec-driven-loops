...
Questions: 5/5 evidence-iterations | Last focus: RQ3 + RQ4 cross-substrate analysis: External Project resource/tool affordances versus Public Memory causal graph and Skill Advisor graph-causal lane
Last 2 ratios: 0.74 -> 0.78 | Stuck count: 0
Resource map: resource-map.md not present; skipping coverage gate.
Next focus: Cross-system mapping + boundary stress: take the External Project patterns catalogued so far (phase DAG, edge metadata, query/context/impact, change-safety tools, route/tool/shape maps, group resources, agent affordances, freshness story) and for EACH pattern produce a row of: (a) target Public owner (Code Graph / Memory / Skill Graph / NONE), (b) integration cost (S/M/L), (c) blast radius (subsystem/cross-system), (d) failure mode if mis-applied. Identify patterns that are SUPERFICIALLY portable but break under boundary stress (e.g., shared graph for code+memory, default group members, low-confidence rename application). Cite file:line for every claim. Anchoring guard still in effect.

PACKET-SPECIFIC CONSTRAINTS (orchestrator-imposed for pt-02 sibling cross-check):
- ANCHORING GUARD: this is iteration 6 of an INDEPENDENT cross-check. You MUST NOT read or grep any file under research/007-external-project-pt-01/ during iterations 1-9. Iteration 10 (synthesis-only) MAY compare against pt-01 — but NOT this iteration.
- SOURCE GROUNDING: every claim about External Project or Public must carry a file:line citation. Synthesizing without citations is a quality-guard failure.
...
- PRIOR ITERATIONS: read the strategy.md (.opencode/specs/system-spec-kit/026-graph-and-context-optimization/001-research-and-baseline/007-external-project/research/007-external-project-pt-02/deep-research-strategy.md) and prior iteration files (.opencode/specs/system-spec-kit/026-graph-and-context-optimization/001-research-and-baseline/007-external-project/research/007-external-project-pt-02/iterations/iteration-NNN.md) to build on prior findings. Avoid repeating prior findings — extend, contradict, or deepen them.

Research Topic: Independent cross-check (pt-02): Research the downloaded External Project project under .opencode/specs/system-spec-kit/026-graph-and-context-optimization/001-research-and-baseline/007-external-project/external/ for patterns to adopt, adapt, reject, or defer for Public Code Graph, Memory causal graph, and Skill Graph / Skill Advisor surfaces.
Iteration: 6 of 10
Focus Area: Cross-system mapping + boundary stress: take the External Project patterns catalogued so far (phase DAG, edge metadata, query/context/impact, change-safety tools, route/tool/shape maps, group resources, agent affordances, freshness story) and for EACH pattern produce a row of: (a) target Public owner (Code Graph / Memory / Skill Graph / NONE), (b) integration cost (S/M/L), (c) blast radius (subsystem/cross-system), (d) failure mode if mis-applied. Identify patterns that are SUPERFICIALLY portable but break under boundary stress (e.g., shared graph for code+memory, default group members, low-confidence rename application). Cite file:line for every claim. Anchoring guard still in effect.
...
Last 3 Iterations Summary: run 3: RQ2 groundwork: External Project MCP safety/query tools versus Public code_graph_query/context/sta... (0.72)
  run 4: RQ2 depth: External Project change-safety implementations for detect_changes, rename, impact, and ... (0.74)
  run 5: RQ3 + RQ4 cross-substrate analysis: External Project resource/tool affordances versus Public Memor... (0.78)
...
- Write iteration narrative to: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/001-research-and-baseline/007-external-project/research/007-external-project-pt-02/iterations/iteration-006.md
- Write per-iteration delta file to: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/001-research-and-baseline/007-external-project/research/007-external-project-pt-02/deltas/iter-006.jsonl
...
1. **Iteration narrative markdown** at `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/001-research-and-baseline/007-external-project/research/007-external-project-pt-02/iterations/iteration-006.md` (path is pre-substituted for the current iteration number). Structure: headings for Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus.
...
3. **Per-iteration delta file** at `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/001-research-and-baseline/007-external-project/research/007-external-project-pt-02/deltas/iter-006.jsonl` (path pre-substituted for the current iteration — e.g. `deltas/iter-001.jsonl`). This file holds the structured delta stream for this iteration: one `{"type":"iteration",...}` record (same content as the state-log append) plus per-event structured records (one per graphEvent, finding, invariant, observation, edge, ruled_out direction). Each record on its own JSON line. The reducer reads the combined state log + delta files to rebuild dashboards and registries after interruption or partial runs.

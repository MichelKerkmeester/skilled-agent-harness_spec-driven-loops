...
**GATE 3 PRE-ANSWERED — A**: `specs/system-spec-kit/026-graph-and-context-optimization/007-hook-parity/002-copilot-hook-parity-remediation`. Pre-approved.
...
1. **Read inputs**:
   - `specs/system-spec-kit/026-graph-and-context-optimization/007-hook-parity/002-copilot-hook-parity-remediation/{spec,plan,tasks,checklist,implementation-summary,decision-record}.md`
...
3. **Output review-report.md** at `specs/system-spec-kit/026-graph-and-context-optimization/007-hook-parity/002-copilot-hook-parity-remediation/review/002-copilot-hook-parity-remediation-tier2-pt-01/review-report.md` with standard 9-section + Planning Packet.

...
cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && \
  node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js \
    ...
    "$PWD/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-memory-quality-remediation/001-foundation-templates-truncation"
```
...
bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-memory-quality-remediation/001-foundation-templates-truncation
```
<!-- /ANCHOR:testing -->

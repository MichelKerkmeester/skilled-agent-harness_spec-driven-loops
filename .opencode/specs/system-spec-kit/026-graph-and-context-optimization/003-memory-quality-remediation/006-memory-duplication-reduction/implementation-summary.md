...
| `node .opencode/skill/system-spec-kit/scripts/dist/memory/migrate-trigger-phrase-residual.js --dry-run --report .opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-memory-quality-remediation/006-memory-duplication-reduction/scratch/pr13-dry-run-sample.json` | PASS, exit `0`, report emitted with `scanned=117`, `changed=87`, `removed=425`, `useful_preserved=2` |
| `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-memory-quality-remediation/006-memory-duplication-reduction --strict` | PASS, exit `0` |
<!-- /ANCHOR:verification -->

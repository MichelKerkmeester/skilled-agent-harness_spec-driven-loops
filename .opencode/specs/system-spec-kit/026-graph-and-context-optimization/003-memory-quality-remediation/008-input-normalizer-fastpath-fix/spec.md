---
title: "Feature Specification: Input Normalizer Fast-Path Fix [system-spec-kit/026-graph-and-context-optimization/003-memory-quality-remediation/008-input-normalizer-fastpath-fix/spec]"
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-memory-quality-remediation/008-input-normalizer-fastpath-fix/*.md` | Create | Track the fix with a minimal Level-1 packet. |
<!-- /ANCHOR:scope -->
...
| REQ-803 | The original failing save repro must complete successfully. | Running `node .../dist/memory/generate-context.js /tmp/save-context-data.json system-spec-kit/026-graph-and-context-optimization/003-memory-quality-remediation` exits 0 and writes a new memory file. |

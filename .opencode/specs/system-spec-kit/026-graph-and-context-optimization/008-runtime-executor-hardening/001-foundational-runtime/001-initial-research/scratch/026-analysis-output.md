...
- **`.opencode/specs/system-spec-kit/026-graph-and-context-optimization/007-deep-review-remediation/001-deep-review-and-remediation/implementation-summary.md`** — Summarizes the 120-iteration review, the 243 findings, and the planned remediation workstreams.
...
- **`.opencode/specs/system-spec-kit/026-graph-and-context-optimization/002-continuity-memory-runtime/003-continuity-refactor-gates/implementation-summary.md`** — Documents the repaired gates-only root after the 006 split and promotion of later work into 007-010.

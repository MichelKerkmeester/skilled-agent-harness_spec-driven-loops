...
**Target:** `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-runtime-executor-hardening/001-foundational-runtime/001-initial-research`
...
- `016-foundational-runtime/001-initial-research/spec.md` — full candidate list with priorities
- `016-foundational-runtime/001-initial-research/scratch/high-priority-deep-dive.md` — detailed per-file findings
...
With spec folder: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-runtime-executor-hardening/001-foundational-runtime/001-initial-research`

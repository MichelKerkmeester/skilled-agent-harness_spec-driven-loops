...
| Field | Value |
|-------|-------|
| **Packet** | `system-spec-kit/026-graph-and-context-optimization/017-cli-runtime-executors/001-executor-feature` |
| **Verdict** | **PASS** |
| **Shipped** | 2026-04-18 |
...
bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/017-cli-runtime-executors/001-executor-feature
...
Track-root research variant: artifacts land at `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/017-cli-runtime-executors-001-executor-feature/` (the track root's `research/` folder + matching subfolder name).

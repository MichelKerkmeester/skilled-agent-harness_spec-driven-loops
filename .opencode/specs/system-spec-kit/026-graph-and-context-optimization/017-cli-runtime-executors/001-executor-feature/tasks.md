...
- [ ] **T-VAL-04** `validate.sh --strict` on 018 packet.
  - Run: `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/017-cli-runtime-executors/001-executor-feature --strict`
  - Acceptance: exits 0.

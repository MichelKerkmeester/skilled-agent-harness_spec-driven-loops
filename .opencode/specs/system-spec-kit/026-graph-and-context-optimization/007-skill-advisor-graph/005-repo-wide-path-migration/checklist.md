...
- [x] CHK-023 [P1] Scoped grep over `007-skill-advisor-graph/` returns zero forbidden legacy matches [Evidence: final scoped `rg` over `007-skill-advisor-graph/` returned no matches]
<!-- /ANCHOR:testing -->
...
- [x] CHK-030 [P0] No non-spec files were edited during this packet-closeout pass [Evidence: the edit scope is limited to packet markdown and packet JSON under `007-skill-advisor-graph/`]

...
_memory:
  continuity:
    ...
    recent_action: "Adapters and meta-runner built"
    next_safe_action: "Use targeted matrix smoke"
    blockers: []
    completion_pct: 100
---

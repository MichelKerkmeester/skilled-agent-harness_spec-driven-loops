...
- The feature catalog claims lane weights are “tunable only through the promotion pipeline” and surfaced through `advisor_status`, but the implementation still reports immutable defaults. Citation: `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/feature_catalog/04--scorer-fusion/06-weights-config.md:25`, `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/feature_catalog/04--scorer-fusion/06-weights-config.md:31`.

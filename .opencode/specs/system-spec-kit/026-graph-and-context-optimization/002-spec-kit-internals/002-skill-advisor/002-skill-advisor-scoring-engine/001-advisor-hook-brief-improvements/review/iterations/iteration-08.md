...
- P2 `traceability` `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/009-hook-package/014-skill-advisor-hook-improvements/resource-map.md:122-127`: the resource map preserves two unreconciled research lineages (`002-advisor-hook-followup-research` and `001-advisor-hook-baseline-research`) without resolving which one is canonical for packet 014.
...
| `.../001-advisor-hook-baseline-research/` | Cited | OK | NEEDS VERIFICATION: ... |
```

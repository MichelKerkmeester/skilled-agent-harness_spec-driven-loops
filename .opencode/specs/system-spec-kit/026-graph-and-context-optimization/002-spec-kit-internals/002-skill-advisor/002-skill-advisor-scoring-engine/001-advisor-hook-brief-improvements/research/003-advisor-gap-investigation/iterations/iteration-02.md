...
- Grep patterns:
  ...
  - `rg -n 'spec-kit-skill-advisor-bridge\.mjs' .opencode/plugins/README.md .opencode/skills/system-spec-kit/mcp_server/skill-advisor/SET-UP_GUIDE.md`

...
> Parent packet: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/002-spec-kit-internals/002-skill-advisor`
...
- Update parent .opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/context-index.md, add 012 row to child phase map and key implementation summary

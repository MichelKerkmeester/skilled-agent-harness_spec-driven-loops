...
## Dead Ends
- Using the packet's current reducer-local wording as the rollout plan is now a dead end. The live synthesis boundary and the phase-012 template make that plan structurally incompatible with the shipped contract. [SOURCE: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/011-resource-map-template/003-resource-map-deep-loop-integration/spec.md:81] [SOURCE: .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:857] [SOURCE: .opencode/skills/system-spec-kit/templates/resource-map.md:45]
...
- .opencode/commands/deep/start-research-loop.md:64
- .opencode/commands/deep/start-review-loop.md:62
...
- .opencode/commands/deep/assets/deep_start-research-loop_confirm.yaml:84
- .opencode/commands/deep/assets/deep_start-review-loop_confirm.yaml:89
...
- .opencode/skills/sk-deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/final-synthesis-memory-save-and-guardrail-behavior.md:71
- .opencode/skills/sk-deep-review/manual_testing_playbook/06--synthesis-save-and-guardrails/final-synthesis-memory-save-and-guardrail-behavior.md:73

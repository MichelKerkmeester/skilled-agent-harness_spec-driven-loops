...
| 8 | iteration 8: token stats calculation and provenance | - | 0.78 | 5 | insight |
| 6 | iteration 6: contract enrichment pipeline | - | 0.82 | 5 | insight |
| 9 | iteration 9: monorepo + config + plugins | - | 0.79 | 6 | insight |
| 7 | iteration 7: python and go AST extraction depth | - | 0.88 | 6 | insight |
| 10 | iteration 10: components + telemetry + cumulative risk | - | 0.44 | 4 | insight |
| 11 | iteration 11: watch mode and pre-commit automation | - | 0.74 | 4 | insight |
| 12 | iteration 12: middleware detector precision and test depth | - | 0.71 | 4 | insight |
| 13 | iteration 13: libs detector export-scraping limits | - | 0.69 | 4 | insight |
| 14 | iteration 14: config detector breadth and env-var semantics | - | 0.73 | 4 | insight |
| 15 | iteration 15: formatter contract and artifact lifecycle | - | 0.76 | 5 | insight |
| 16 | iteration 16: MCP server request lifecycle and cache semantics | - | 0.78 | 5 | insight |
| 17 | iteration 17: AI config generation write safety and profile coupling | - | 0.81 | 5 | insight |

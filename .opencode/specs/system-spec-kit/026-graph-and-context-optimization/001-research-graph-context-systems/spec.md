...
This packet turns the v2 master synthesis into a Level 3 coordination root for `Public`. The research now says Public should preserve its split semantic, structural, and continuity topology, prioritize seam-hardening contracts ahead of packaging work, and translate the strongest surviving recommendations into follow-on packets instead of treating any external system as a replacement architecture. [SOURCE: research/research-v2.md:20-28] [SOURCE: research/research-v2.md:274-306] [SOURCE: research/recommendations-v2.md:3-101]

**Key Decisions**: Publish a provisional honest measurement contract before any multiplier claims. Replace the old structural-artifact bundle with trust-axis separation plus freshness authority before packaging structural context. [SOURCE: research/recommendations-v2.md:3-12] [SOURCE: research/recommendations-v2.md:93-101] [SOURCE: research/research-v2.md:229-236]

**Critical Dependencies**: `research/research-v2.md` is the canonical synthesis, `research/recommendations-v2.md` is the ranked decision surface, `research/findings-registry-v2.json` is the 88-finding evidence index, and `research/iterations/q-d-adoption-sequencing.md` plus `research/cross-phase-matrix.md` supply the sequencing and capability baselines used by this packet. [SOURCE: research/findings-registry-v2.json:1-39] [SOURCE: research/iterations/q-d-adoption-sequencing.md:13-116] [SOURCE: research/cross-phase-matrix.md:6-123]
...
| **Created** | 2026-04-07 |
| **Branch** | `main` |
| **Research Scope** | 5 external systems, 18 master-consolidation iterations, 88 findings, 10 ranked recommendations |
...
- Capture the major adoption decisions as explicit ADRs: honest measurement, P0 fast wins, trust-axis separation, and conditional warm-start sequencing. [SOURCE: scratch/spec-doc-audit.md:65-87] [SOURCE: research/research-v2.md:148-199] [SOURCE: research/recommendations-v2.md:3-101]

### Out of Scope

- Editing any file under `research/` or `memory/` because those deliverables are frozen for this phase.
- Implementing runtime code in Spec Kit Memory, Code Graph, CocoIndex, or startup hooks.
- Re-scoring or re-tagging `findings-registry-v2.json` in this phase, even though the diff report still notes an over-assigned `new-cross-phase` taxonomy.
- Replacing Public's split topology with a monolithic scan, bootstrap, or artifact surface.
- Changing template files or introducing a new packet metadata schema. [SOURCE: scratch/spec-doc-audit.md:77-87] [SOURCE: research/iterations/v1-v2-diff-iter-18.md:27-45] [SOURCE: research/research-v2.md:178-183]
...
| REQ-003 | Adoption requirements must be evidence-backed rather than product-feature phrasing | Requirements and ADRs cite `research/research-v2.md`, `research/recommendations-v2.md`, `research/iterations/q-d-adoption-sequencing.md`, or `research/iterations/q-f-killer-combos.md` |
...
- **SC-002**: The packet preserves the v2 headline: Public keeps its split topology and front-loads seam contracts before packaging work. [SOURCE: research/research-v2.md:20-28] [SOURCE: research/research-v2.md:277-306]
- **SC-003**: Every top-10 recommendation is represented in the root plan or tasks as follow-on packet work, with R1, R10, R4, R6, and R9 treated as the strongest surviving cluster. [SOURCE: research/recommendations-v2.md:3-101] [SOURCE: research/iterations/v1-v2-diff-iter-18.md:87-113]
...
- **SC-005**: No new document invents runtime deployment, feature-flag, or monitoring claims for this research-only packet. [SOURCE: scratch/spec-doc-audit.md:79-87] [SOURCE: research/research-v2.md:238-247]
- **SC-006**: The packet records the remaining open follow-on questions honestly, including the registry taxonomy caveat and the two UNKNOWN-confirmed gaps carried forward from v2. [SOURCE: research/iterations/v1-v2-diff-iter-18.md:172-183] [SOURCE: research/research-v2.md:238-247]
<!-- /ANCHOR:success-criteria -->
...
|------|------|--------|------------|
| Dependency | `research/research-v2.md`, `research/recommendations-v2.md`, and `research/findings-registry-v2.json` remain frozen inputs | Root packet can only be correct if it mirrors those files honestly | Cite the frozen deliverables directly and do not rewrite them in this phase |
...
| Risk | `findings-registry-v2.json` still carries the known `new-cross-phase` taxonomy mismatch | Phase 3 could surface a non-doc blocker after doc work is complete | Record the blocker in packet open questions and keep the registry frozen in this phase |
<!-- /ANCHOR:risks -->
...
- **NFR-T01**: No section may recommend replacing Public's semantic, structural, and continuity owners with a single external-style facade. The packet may only recommend bounded adapters, contracts, or follow-on packets. [SOURCE: research/research-v2.md:80-96] [SOURCE: research/research-v2.md:277-285]

### Uncertainty Honesty
- **NFR-U01**: The packet must preserve the v2 exact-versus-estimated posture and the separate provenance, evidence, and freshness axes whenever trust or savings claims are discussed. [SOURCE: research/research-v2.md:46-60] [SOURCE: research/recommendations-v2.md:43-51] [SOURCE: research/recommendations-v2.md:93-101]
...
- `findings-registry-v2.json` currently passes parse and evidence checks but still carries the known `new-cross-phase` tag overcount. This packet may record that blocker, but it cannot silently repair or reinterpret the registry in this phase. [SOURCE: research/iterations/v1-v2-diff-iter-18.md:27-35] [SOURCE: research/findings-registry-v2.json:1-39]

### Contract Before Packaging
- Any downstream reader who tries to treat cached startup, dashboard publication, or structural artifacts as ready-made defaults must be pointed back to the trust-axis and freshness prerequisites first. [SOURCE: research/recommendations-v2.md:13-31] [SOURCE: research/recommendations-v2.md:93-101] [SOURCE: research/research-v2.md:217-236]
...
|---------|-------------|--------|------------|------------|
| R-001 | Root packet drifts from the frozen v2 recommendation order | H | M | Tie every decision section back to `research/recommendations-v2.md` and the diff report |
...
**Acceptance Criteria**:
1. **Given** the root packet docs are open, **When** I compare them against `research/recommendations-v2.md`, **Then** the ordering and verdicts match the frozen top-10 recommendations.
2. **Given** I need to open the first downstream packet, **When** I read `plan.md` and `tasks.md`, **Then** I can see why the first cluster starts with measurement, trust, payload, and detector-discipline work rather than artifact packaging. [SOURCE: research/recommendations-v2.md:3-101] [SOURCE: research/research-v2.md:148-199]
...
2. **Given** `spec.md` or `plan.md` is open, **When** I look for structural-artifact work, **Then** it appears after the trust contract prerequisites, not before them. [SOURCE: research/recommendations-v2.md:43-51] [SOURCE: research/recommendations-v2.md:93-101] [SOURCE: research/research-v2.md:229-236]
...
2. **Given** the open questions section is open, **When** I look for unresolved items, **Then** I see the remaining registry taxonomy caveat and the two UNKNOWN-confirmed research gaps called out explicitly. [SOURCE: research/iterations/v1-v2-diff-iter-18.md:172-183] [SOURCE: research/research-v2.md:243-247]

---

## 12. OPEN QUESTIONS

- Which follow-on packet should own the `findings-registry-v2.json` retagging pass that reduces the over-assigned `new-cross-phase` count without changing the v2 narrative? [SOURCE: research/iterations/v1-v2-diff-iter-18.md:27-35] [SOURCE: research/findings-registry-v2.json:7-18]
- What is the first frozen task corpus that should be used to decide when the conditional warm-start bundle is safe enough to promote beyond experiment status? [SOURCE: research/recommendations-v2.md:23-31] [SOURCE: research/recommendations-v2.md:73-81]
- Which downstream packet should formalize the first-class auditor versus discoverer workflow contract once the placement rubric and trust-axis contract land? [SOURCE: research/research-v2.md:289-300]
<!-- /ANCHOR:questions -->
...
- **Master Synthesis**: See `research/research-v2.md`
- **Ranked Recommendations**: See `research/recommendations-v2.md`

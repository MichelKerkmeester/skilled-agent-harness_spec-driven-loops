...
- **Missing on disk**: 0
- **Scope**: All files created, updated, or analyzed during packet 012-causal-graph-channel-routing — covers mcp_server source/tests, packet docs, the packet changelog, and the new system-spec-kit knowledge-surface entries authored as part of this packet's closure.
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/012-causal-graph-channel-routing/001-initial-delivery/scratch/live-smoke-results.md` | Created | OK | Live MCP smoke evidence for graph-channel routing and degree parity |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/012-causal-graph-channel-routing/001-initial-delivery/scratch/stress-test-results.md` | Created | OK | Stress coverage evidence for routing telemetry, cache invalidation, latency, and flag-off path |
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/012-causal-graph-channel-routing/001-initial-delivery/changelog.md` | Created | OK | Packet changelog |
<!-- /ANCHOR:specs -->

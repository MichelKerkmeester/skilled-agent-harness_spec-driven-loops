...
|---------------------|--------|-------|
| `changelog/changelog-026-012-causal-graph-channel-routing.md` | **MISSING** | Glob of `changelog/*012*` returns zero files. Resource-map claims status OK. |
...
| **P1-003** | Resource-map changelog entry missing on disk | `resource-map.md:73` | `changelog/changelog-026-012-causal-graph-channel-routing.md` listed with status OK but no file found under any variant in the changelog directory. Resource-map integrity broken. |
...
- **claim**: Resource-map.md claims changelog `changelog-026-012-causal-graph-channel-routing.md` exists with status OK, but no such file exists on disk.

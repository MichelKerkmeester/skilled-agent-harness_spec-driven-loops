...
**Packet:** 012-causal-graph-channel-routing
**Mode:** review
...
No `applied/T-*.md` target files exist — the directory `.opencode/specs/.../012-causal-graph-channel-routing/applied/` is absent. Resource-map.md lists all 6 mcp_server artifacts and all 9 packet docs that constitute the change set. No gaps to report.

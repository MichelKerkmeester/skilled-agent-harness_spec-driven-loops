...
trigger_phrases:
  - "012-causal-graph-channel-routing tasks"
...
- [x] T016 Synthetic baseline + test-derived rate (012-T3.1 = 0.40) recorded in `scratch/post-change.md`; live MCP smoke deferred to next restart

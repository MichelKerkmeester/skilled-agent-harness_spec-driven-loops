...
| `specs/.../012-causal-graph-channel-routing/spec.md`, `plan.md`, `tasks.md`, `checklist.md`, `implementation-summary.md` | Authored | Level 2 spec packet documents |
| `specs/.../012-causal-graph-channel-routing/scratch/baseline.md`, `scratch/post-change.md` | Created | Synthetic baseline rationale + live-smoke procedure |

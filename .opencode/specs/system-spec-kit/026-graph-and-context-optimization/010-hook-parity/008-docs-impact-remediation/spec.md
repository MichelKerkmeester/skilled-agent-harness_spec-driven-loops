---
title: "Feature [system-spec-kit/026-graph-and-context-optimization/010-hook-parity/008-docs-impact-remediation/spec]"
...
Sub-packets 001-011 of `010-hook-parity` changed runtime hook contracts, advisor delivery, plugin-loader semantics, Copilot wrapper schema, Codex startup parity, and Claude prompt-time hook registration. The shipped behavior diverges from what the checked-in documentation still describes.

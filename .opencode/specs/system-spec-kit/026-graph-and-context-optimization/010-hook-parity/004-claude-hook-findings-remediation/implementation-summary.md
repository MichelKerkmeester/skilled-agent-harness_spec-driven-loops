---
title: "...26-graph-and-context-optimization/010-hook-parity/006-claude-hook-findings-remediation/implementation-summary]"
...
| Strict spec validation | `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-hook-parity/004-claude-hook-findings-remediation --strict --no-recursive` | To run after checklist/task updates and cleanup |
<!-- /ANCHOR:verification -->

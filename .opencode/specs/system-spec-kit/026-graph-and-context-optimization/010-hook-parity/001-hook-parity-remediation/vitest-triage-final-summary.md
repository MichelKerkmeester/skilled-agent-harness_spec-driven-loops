...
- Active packet path: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-hook-parity/001-hook-parity-remediation`.
- Requested packet alias `026-graph-and-context-optimization/010-hook-parity/001-hook-parity-remediation` was not present in this working tree; existing Phase 029 summaries were found under the active packet path above.
...
```text
bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-hook-parity/001-hook-parity-remediation --strict

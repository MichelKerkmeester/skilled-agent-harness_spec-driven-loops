---
title: "...stem-spec-kit/026-graph-and-context-optimization/010-hook-parity/005-opencode-plugin-loader-remediation/tasks]"
...
- [ ] **T-22** Run full vitest suite to ensure no regression: `cd .opencode/skill/system-spec-kit/mcp_server && npx vitest run`. [EVIDENCE: deferred per P1-04 — see implementation-summary.md Known Limitations item 1; out-of-scope Copilot hook wiring blocker is tracked in parent 010-hook-parity docs as priority follow-up. Focused plugin-loader tests passed 15/15.]
...
- [x] **T-25** Update parent docs (the sibling-level handover.md in `010-hook-parity/`) with phase outcome. [EVIDENCE: parent docs now record the 007 phase outcome.]

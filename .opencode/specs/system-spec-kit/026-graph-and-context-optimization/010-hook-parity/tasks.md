---
title: "Tasks: Hook Parity [system-spec-kit/026-graph-and-context-optimization/010-hook-parity/tasks]"
description: "Task record for the 010-hook-parity flattened parent layout with 8 direct child phase packets."
trigger_phrases:
  - "010-hook-parity"
  - "hook parity"
  - "runtime hook parity"
...
- [x] T013 Place central + per-runtime hook-parity remediation packets at `010-hook-parity/001-005`.
- [x] T014 Place Copilot wrapper schema and writer-wiring packets at `010-hook-parity/006-007`.
- [x] T015 Place documentation impact remediation packet at `010-hook-parity/008`.
<!-- /ANCHOR:phase-2 -->

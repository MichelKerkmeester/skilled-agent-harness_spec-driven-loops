...
|---|---:|---:|---:|---:|---:|
| baseline-bge | 12/18 | 0 | 0 | 1644 | 12210 |
| bge-path-class | 13/18 | 1 | 0 | 1648 | 11963 |
| jina-v3 | 14/18 | 2 | 0 | 2001 | 13427 |

## Verdict

- **bge-path-class**: ⚠️ **HOLDS** — only 1 failure flip
- **jina-v3**: ✅ **SHIPS** — ≥2 failure flips, 0 control regressions

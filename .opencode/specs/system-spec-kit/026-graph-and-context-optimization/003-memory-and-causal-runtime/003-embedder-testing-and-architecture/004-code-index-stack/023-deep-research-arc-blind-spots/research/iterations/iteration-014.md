...
- **FINDING-014-A** [severity: MEDIUM-OPPORTUNITY] [Pass-1 relation: FALSIFIES-#4]:
  ...
  - **Evidence**: Perturbation parse above; `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/004-code-index-stack/011-rerank-model-fit-investigation/research/phase2-bench/*rrf-K*.results.jsonl`.

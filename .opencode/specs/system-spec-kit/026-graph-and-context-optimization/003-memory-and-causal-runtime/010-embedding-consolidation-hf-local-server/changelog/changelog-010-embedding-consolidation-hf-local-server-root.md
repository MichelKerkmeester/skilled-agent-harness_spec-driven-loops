...
description: "Rollup of 1 child phase changelogs under 010-embedding-consolidation-hf-local-server. Each child shipped independently and is listed in the Included Phases table. Detail lives in the child changelogs."
trigger_phrases:
...
|------|--------|--------------|
| `003-memory-and-causal-runtime/010-embedding-consolidation-hf-local-server/` (child phases) | n/a | Rollup of 1 child phase changelogs, no direct source changes at the parent level |

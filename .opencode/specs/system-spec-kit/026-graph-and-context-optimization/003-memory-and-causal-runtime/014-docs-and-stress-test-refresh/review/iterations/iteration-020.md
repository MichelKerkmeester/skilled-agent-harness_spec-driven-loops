...
- `.opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/070-error-code-reference.md:30`
- `.opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/070-error-code-reference.md:42`
...
- `.opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/070-error-code-reference.md:31`
- `.opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/070-error-code-reference.md:32`
...
- `.opencode/skills/system-spec-kit/manual_testing_playbook/14--pipeline-architecture/258-front-proxy-reconnect-and-backend-only.md:15`
...
- `.opencode/skills/system-spec-kit/manual_testing_playbook/14--pipeline-architecture/258-front-proxy-reconnect-and-backend-only.md:17`
...
- File: `.opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/070-error-code-reference.md:30`
...
- `feature_catalog_code`: Fail for `E429` in `070-error-code-reference.md`; pass for `-32001` live and `-32002` fail-closed semantics.

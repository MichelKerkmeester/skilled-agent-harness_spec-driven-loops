...
- `.opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/069-schema-version-history-v28-v30.md:18` and `.opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/069-schema-version-history-v28-v30.md:30` through `.opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/069-schema-version-history-v28-v30.md:32` schema claims.

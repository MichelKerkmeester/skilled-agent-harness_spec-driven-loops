...
| R45-001 | `AGENTS.md:182-186`; `confirm-mode-checkpointed-review.md:26-32`; `plan.md:86-89`; `memory-save-planner-first.vitest.ts:12-214` | P2 | Gate 3 trigger list includes `analyze`, `decompose`, `phase`; read-only deep-review/deep-research prompts reuse these tokens | False positives: read-only review can trigger unnecessary spec-folder setup |

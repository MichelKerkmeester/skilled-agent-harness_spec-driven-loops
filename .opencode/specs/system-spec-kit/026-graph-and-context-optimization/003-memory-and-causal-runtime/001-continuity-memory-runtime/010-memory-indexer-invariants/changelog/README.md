...
|-------|------|-------|----------------|
| 005-pt-01 | 2026-04-29 | [Memory indexer invariants review](./changelog-005-memory-indexer-invariants-pt-01.md) | Deep review validated both invariant tracks across 92 file reads, found 1 P1 and 13 P2 items, and confirmed the packet is CONDITIONAL pending a storage-boundary fix and a live MCP rescan. |

...
3. Read the live owner files for D1/D3/D4/D5 and the follow-on calibration work: `truncate-on-word-boundary.ts`, `trigger-phrase-sanitizer.ts`, `decision-extractor.ts`, `frontmatter-migration.ts`, `workflow.ts`, and `find-predecessor-memory.ts`. [SOURCE: `.opencode/skills/system-spec-kit/scripts/lib/truncate-on-word-boundary.ts:14-47`] [SOURCE: `.opencode/skills/system-spec-kit/scripts/lib/trigger-phrase-sanitizer.ts:128-236`] [SOURCE: `.opencode/skills/system-spec-kit/scripts/lib/frontmatter-migration.ts:1124-1208`] [SOURCE: `.opencode/skills/system-spec-kit/scripts/core/workflow.ts:1265-1304`] [SOURCE: `.opencode/skills/system-spec-kit/scripts/core/find-predecessor-memory.ts:15-18,170-183,257-260`]
4. Read the reviewer and validator surfaces to distinguish prevention-at-write-time from post-write detection: `post-save-review.ts`, `validate-memory-quality.ts`, `save-mode.ts`, `content-router.ts`, and `session-extractor.ts`. [SOURCE: `.opencode/skills/system-spec-kit/scripts/core/post-save-review.ts:844-987,1032-1086`] [SOURCE: `.opencode/skills/system-spec-kit/scripts/lib/validate-memory-quality.ts:144-170`] [SOURCE: `.opencode/skills/system-spec-kit/scripts/types/save-mode.ts:10-71`] [SOURCE: `.opencode/skills/system-spec-kit/mcp_server/lib/routing/content-router.ts:58,144`] [SOURCE: `.opencode/skills/system-spec-kit/scripts/extractors/session-extractor.ts:93-107`]

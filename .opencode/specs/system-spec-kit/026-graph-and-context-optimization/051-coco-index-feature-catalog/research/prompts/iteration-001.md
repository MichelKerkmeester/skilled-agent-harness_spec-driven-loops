...
You are cli-codex (gpt-5.5 high fast) implementing **051-coco-index-feature-catalog**.

### CRITICAL: Spec folder path

The packet folder is: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/051-coco-index-feature-catalog/` — write ALL packet files there. Do NOT ask for the spec folder.
...
bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/051-coco-index-feature-catalog --strict
...
**Deps**: `manual.depends_on=["system-spec-kit/026-graph-and-context-optimization/050-feature-catalog-shape-realignment"]`.

**Trigger phrases**: `["051-coco-index-feature-catalog","mcp-coco-index feature catalog","cocoindex catalog","semantic search catalog"]`.

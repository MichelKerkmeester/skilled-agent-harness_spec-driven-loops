...
- [x] CHK-050 [P1] E2E trace kept in `scratch/` (not at root) [EVIDENCE: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-phase-parent-documentation/002-generator-and-polish/scratch/e2e-trace.txt`]

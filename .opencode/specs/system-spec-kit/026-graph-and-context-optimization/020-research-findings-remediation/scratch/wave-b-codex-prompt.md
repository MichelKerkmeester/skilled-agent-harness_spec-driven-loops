...
Steps:
1. Copy 3-4 rich 017 packet `description.json` files into fixtures: e.g., `017-review-findings-remediation.description.json`, `018-deep-loop-cli-executor.description.json`, `019-cli-runtime-matrix.description.json`. (If file-copying is possible; otherwise inline the content.)

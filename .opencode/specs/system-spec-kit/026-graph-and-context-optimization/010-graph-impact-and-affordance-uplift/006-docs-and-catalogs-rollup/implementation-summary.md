...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/merged-phase-map.md` | +10 / 0 | New "Derived Implementation Phases" section after "Active Phase Themes": 012 entry (derived from `001-research-and-baseline/007-git-nexus/` pt-01 + pt-02; owner wrapper `026-graph-and-context-optimization/`) with one-paragraph note describing the six sub-phase decomposition and the ownership-boundary contract from pt-02 §13 |
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/merged-phase-map.md` | Modified | "Derived Implementation Phases" section recording 012 as the GitNexus implementation phase derived from pt-01 + pt-02 |

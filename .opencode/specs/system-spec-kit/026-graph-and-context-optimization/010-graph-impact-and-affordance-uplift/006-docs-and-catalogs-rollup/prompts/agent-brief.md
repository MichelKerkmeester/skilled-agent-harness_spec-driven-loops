...
1. **Sub-phase spec (your scope, READ FULLY):**
   `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-graph-impact-and-affordance-uplift/006-docs-and-catalogs-rollup/spec.md`
2. **Sub-phase plan + tasks + checklist:**
   `.../006-docs-and-catalogs-rollup/{plan.md,tasks.md,checklist.md}`
3. **Phase-root (read-only):**
   `.../010-graph-impact-and-affordance-uplift/{spec.md,decision-record.md}` (note ADR-012-007: per-packet inline + trailing rollup)

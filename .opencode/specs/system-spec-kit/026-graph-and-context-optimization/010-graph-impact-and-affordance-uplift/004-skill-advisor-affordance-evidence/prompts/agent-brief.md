...
1. **Sub-phase spec (your scope, READ FULLY):**
   `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-graph-impact-and-affordance-uplift/004-skill-advisor-affordance-evidence/spec.md`
...
3. **Phase-root (read-only):**
   `.../010-graph-impact-and-affordance-uplift/{spec.md,decision-record.md}` (note ADR-012-006: affordance via existing lanes only)
4. **License clearance:**

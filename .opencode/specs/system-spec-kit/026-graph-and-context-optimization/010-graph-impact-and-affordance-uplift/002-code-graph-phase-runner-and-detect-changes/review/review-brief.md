...
Conduct **7 independent review iterations** of sub-phase `002-code-graph-phase-runner-and-detect-changes` of phase `010-graph-impact-and-affordance-uplift`. Each iteration is a focused audit pass on a different dimension. Track findings as P0/P1/P2 with file:line evidence. Produce a single `review-report.md` at the end.

## Scope

**Sub-phase root:** `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-graph-impact-and-affordance-uplift/002-code-graph-phase-runner-and-detect-changes/`
...
- mcp_server/code_graph/lib/structural-indexer.ts (lines ~1369, indexFiles wrap)
- mcp_server/code_graph/handlers/index.ts
- mcp_server/code_graph/tests/phase-runner.test.ts
- mcp_server/code_graph/tests/detect-changes.test.ts

**Spec context:**
- `010/002-code-graph-phase-runner-and-detect-changes/spec.md` (requirements)
- `010/002-code-graph-phase-runner-and-detect-changes/checklist.md` (verification items)
- `010/002-code-graph-phase-runner-and-detect-changes/implementation-summary.md` (what was built)
...
Write `010/002-code-graph-phase-runner-and-detect-changes/review/review-report.md` (create directory if needed):
...
- Stay scoped to `002-code-graph-phase-runner-and-detect-changes` — don't audit other sub-phases.

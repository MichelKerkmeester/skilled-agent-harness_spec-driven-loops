...
Conduct **7 independent review iterations** of sub-phase `001-clean-room-license-audit` of phase `010-graph-impact-and-affordance-uplift`. Each iteration is a focused audit pass on a different dimension. Track findings as P0/P1/P2 with file:line evidence. Produce a single `review-report.md` at the end.

## Scope

**Sub-phase root:** `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-graph-impact-and-affordance-uplift/001-clean-room-license-audit/`

**Implementation surface (read in full before reviewing):**
- 010/001/decision-record.md (LICENSE quote + classification)

**Spec context:**
- `010/001-clean-room-license-audit/spec.md` (requirements)
- `010/001-clean-room-license-audit/checklist.md` (verification items)
- `010/001-clean-room-license-audit/implementation-summary.md` (what was built)
...
Write `010/001-clean-room-license-audit/review/review-report.md` (create directory if needed):
...
- Stay scoped to `001-clean-room-license-audit` — don't audit other sub-phases.

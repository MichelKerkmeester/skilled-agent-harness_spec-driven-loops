...
- [x] **[CHK-019] [P1] `016-embedder-testing-and-architecture/012-mcp-launcher-concurrency-arc/changelog/002-cross-launcher-lease-propagation.md` created.** 103 lines; summary + what-changed + upgrade notes + verification evidence.
<!-- /ANCHOR:docs -->

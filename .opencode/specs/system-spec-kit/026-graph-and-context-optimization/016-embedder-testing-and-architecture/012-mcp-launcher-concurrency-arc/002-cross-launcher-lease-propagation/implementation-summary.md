...
`016-embedder-testing-and-architecture/012-mcp-launcher-concurrency-arc/changelog/002-cross-launcher-lease-propagation.md` records the patch with summary, what-changed table, upgrade notes (zero migration), and full verification evidence including the manual spawn-twice transcripts.
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/012-mcp-launcher-concurrency-arc/changelog/002-cross-launcher-lease-propagation.md` | Create (+103) | Packet changelog |
<!-- /ANCHOR:what-built -->

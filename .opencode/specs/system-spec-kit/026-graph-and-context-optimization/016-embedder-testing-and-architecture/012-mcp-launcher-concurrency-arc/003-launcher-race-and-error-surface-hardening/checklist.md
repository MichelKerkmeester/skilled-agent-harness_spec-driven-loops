...
- [x] **[CHK-021] [P1] `016-embedder-testing-and-architecture/012-mcp-launcher-concurrency-arc/changelog/003-launcher-race-and-error-surface-hardening.md` written.** Includes Summary + What Changed table + Upgrade Notes + Verification Evidence + Deferred P2s list.

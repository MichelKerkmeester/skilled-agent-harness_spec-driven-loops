...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/002-mk-spec-memory-stack/004-mxbai-swap-and-008-closure/evidence/cat-24-rerun.jsonl:12`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/002-mk-spec-memory-stack/004-mxbai-swap-and-008-closure/evidence/cat-24-rerun.jsonl:15`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/002-mk-spec-memory-stack/004-mxbai-swap-and-008-closure/evidence/cat-24-rerun.jsonl:18`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/002-mk-spec-memory-stack/004-mxbai-swap-and-008-closure/evidence/cat-24-rerun.jsonl:21`
...
| 7 | 4400 | `template consolidation decision` | `010-template-levels/001-template-consolidation-investigation/decision-record.md` | stale/orphaned: indexed row exists, file missing | broken | 3 | Live/current equivalent exists as id 8048 under `010-template-levels/001-consolidation-investigation/decision-record.md`; exact id 4400 is stale. |
...
| 10 | 1534 | `FIX-010-v2` | `007-code-graph/010-fix-iteration-quality-meta-research/tasks.md` | stale/orphaned: indexed row exists, file missing | broken | 2 | Current packet is `007-code-graph/009-fix-iteration-quality-meta-research`; exact id 1534 points at a removed/renumbered path. |
...
|---|---:|---|
| `embeddinggemma-300m` baseline | 1/10 | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/002-mk-spec-memory-stack/004-mxbai-swap-and-008-closure/evidence/embedder-comparison.csv:2` |
| `mxbai-embed-large-v1` | 2/10 | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/002-mk-spec-memory-stack/004-mxbai-swap-and-008-closure/evidence/cat-24-rerun.jsonl:9` |
| `jina-embeddings-v3` | 4/10 | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/002-mk-spec-memory-stack/004-mxbai-swap-and-008-closure/evidence/cat-24-rerun.jsonl:12` |
| `nomic-embed-text-v1.5` | 5/10 | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/002-mk-spec-memory-stack/004-mxbai-swap-and-008-closure/evidence/cat-24-rerun.jsonl:15` |
| `bge-m3` | 2/10 | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/002-mk-spec-memory-stack/004-mxbai-swap-and-008-closure/evidence/cat-24-rerun.jsonl:18` |
| `snowflake-arctic-embed-l-v2.0` | 1/10 | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/002-mk-spec-memory-stack/004-mxbai-swap-and-008-closure/evidence/cat-24-rerun.jsonl:21` |

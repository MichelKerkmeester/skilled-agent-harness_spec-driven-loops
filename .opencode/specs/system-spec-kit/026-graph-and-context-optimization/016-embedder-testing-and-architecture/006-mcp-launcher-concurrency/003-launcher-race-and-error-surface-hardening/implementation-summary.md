...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/006-mcp-launcher-concurrency/changelog/003-launcher-race-and-error-surface-hardening.md` | Create (+115) | Changelog with upgrade notes + verification evidence |
<!-- /ANCHOR:what-built -->

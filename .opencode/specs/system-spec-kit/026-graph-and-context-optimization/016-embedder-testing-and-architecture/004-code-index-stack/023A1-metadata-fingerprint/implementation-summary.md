...
_memory:
  continuity:
    ...
    session_dedup:
      fingerprint: "sha256:023a1metadatafingerprint000000000000000000000000000000000005"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | `023A1-metadata-fingerprint` |
...
| `.venv/bin/python -m pytest tests/ -q` | PASS, `210 passed in 17.31s` |
...
```text
PACKET_023A1_COMPLETE pytest=210 ruff=clean strict_validate=PASSED findings_closed=15
SPAWN_AGENT_USED=no

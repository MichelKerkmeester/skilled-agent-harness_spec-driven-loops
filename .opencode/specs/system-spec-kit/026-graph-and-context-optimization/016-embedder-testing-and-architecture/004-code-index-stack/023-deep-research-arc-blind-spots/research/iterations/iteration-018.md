...
- Local decision-record evidence: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-code-index-stack/decision-record.md:22-24` references ADR-020 RRF defaults and ADR-022 scaled boosts, but not a single consolidated "model governance/default churn" ADR.

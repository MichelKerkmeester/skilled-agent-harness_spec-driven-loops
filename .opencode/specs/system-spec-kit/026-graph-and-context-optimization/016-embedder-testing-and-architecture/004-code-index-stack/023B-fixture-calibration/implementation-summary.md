...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/skills/mcp-coco-index/mcp_server/benchmarks/benchmark-2026-05-19-expanded/code-retrieval-fixture-expanded-v2.json"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-code-index-stack/023B-fixture-calibration` |
...
| `validate.sh .../023B-fixture-calibration --strict` | PASS, `Errors: 0 Warnings: 0`. |
<!-- /ANCHOR:verification -->

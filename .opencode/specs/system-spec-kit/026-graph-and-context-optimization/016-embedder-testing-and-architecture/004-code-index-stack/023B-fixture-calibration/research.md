...
023B uses `../023C-retrieval-observability/implementation-summary.md` as the diagnostic-counter source and `../011-rerank-model-fit-investigation/research/phase2-bench/code-retrieval-fixture-corrected.json` as the regression fixture source.
...
| Source | Finding |
|---|---|
| `../023C-retrieval-observability/implementation-summary.md` | Search diagnostics expose candidate, dedup, rerank, boost-flip, and fallback counters. |

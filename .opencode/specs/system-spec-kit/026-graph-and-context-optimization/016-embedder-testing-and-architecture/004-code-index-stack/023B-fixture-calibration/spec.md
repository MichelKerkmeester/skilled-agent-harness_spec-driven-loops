...
- Create `benchmark-2026-05-19-expanded/code-retrieval-fixture-expanded-v2.json`.
...
|-----------|-------------|-------------|
| `.opencode/skills/mcp-coco-index/mcp_server/benchmarks/benchmark-2026-05-19-expanded/` | Create | Expanded benchmark fixture and source note. |
...
| `023B-fixture-calibration/evidence/*.md` | Create | Gates, recommendation, taxonomy, and summary evidence. |
<!-- /ANCHOR:scope -->
...
- `../023C-retrieval-observability/implementation-summary.md`

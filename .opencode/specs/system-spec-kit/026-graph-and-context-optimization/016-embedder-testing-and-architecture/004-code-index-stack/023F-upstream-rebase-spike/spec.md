...
| `.opencode/specs/.../023F-upstream-rebase-spike/research/*.md` | Create | Upstream sweep, delta classification, rebase plan, dimensions impact, cross-packet handoff. |
| `.opencode/specs/.../023F-upstream-rebase-spike/*.md` | Modify/Create | Level 2 packet docs and verification evidence. |
<!-- /ANCHOR:scope -->

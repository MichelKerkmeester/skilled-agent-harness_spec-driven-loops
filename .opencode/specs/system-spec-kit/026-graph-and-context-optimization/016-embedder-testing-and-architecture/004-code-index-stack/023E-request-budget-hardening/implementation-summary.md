...
| Field | Value |
|-------|-------|
| **Spec Folder** | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-code-index-stack/023E-request-budget-hardening/` |
...
| `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-code-index-stack/023E-request-budget-hardening/` | Created | Level 2 packet docs and metadata. |
...
| Strict spec validation | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-code-index-stack/023E-request-budget-hardening --strict` | Passed |
...
- `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/cli.py`
- `.opencode/skills/mcp-coco-index/mcp_server/tests/test_search_budget.py`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-code-index-stack/023E-request-budget-hardening/`

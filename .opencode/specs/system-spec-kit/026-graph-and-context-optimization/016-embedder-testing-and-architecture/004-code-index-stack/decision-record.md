...
| ADR-018 | `015-code-aware-chunking-tree-sitter` | Tree-sitter code-aware chunking | `../../002-spec-memory-stack/004-spec-memory-embedder-bake-off/decision-record.md#adr-018-tree-sitter-code-aware-chunking-for-cocoindex-code` |

...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-code-index-stack/023c-retrieval-observability"
    ...
    session_dedup:
      ...
      session_id: "023c-retrieval-observability"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | `023C-retrieval-observability` |

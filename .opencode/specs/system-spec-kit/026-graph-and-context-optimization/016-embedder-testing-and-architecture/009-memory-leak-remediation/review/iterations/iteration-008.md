...
- **File(s):** `.opencode/skills/system-spec-kit/mcp_server/lib/deep-loop/executor-config.ts:21`, `.opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml:656`, `.opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml:697`, `.opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml:937`, `.opencode/commands/spec_kit/assets/spec_kit_deep-review_confirm.yaml:657`, `.opencode/commands/spec_kit/assets/spec_kit_deep-review_confirm.yaml:863`, `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/009-memory-leak-remediation/review/deep-review-config.json:14`

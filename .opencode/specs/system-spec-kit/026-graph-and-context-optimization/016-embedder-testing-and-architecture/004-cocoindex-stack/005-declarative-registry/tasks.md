...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-cocoindex-stack/005-declarative-registry"
...
- Analog: `../../016-embedder-testing-and-architecture/002-mk-spec-memory-stack/004-mxbai-swap-and-008-closure/` (the mk-spec-memory side)
<!-- /ANCHOR:cross-refs -->

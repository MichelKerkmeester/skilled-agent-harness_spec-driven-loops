...
```text
SCOPE: spec packet 011/001-off-baseline-audit in .opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/008-rerank-sidecar-arc/011-spec-memory-rerank-decision-arc/001-off-baseline-audit/. Execute Phase A (measure) → Phase B (decide + patch if applicable) → Phase C (verify).

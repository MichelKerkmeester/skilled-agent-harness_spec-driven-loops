...
| 2 | `011-section3-structural-improvements/spec.md` | Umbrella spec: 3 structural improvements that affect ALL embedders. Research-first, implementation after convergence. |

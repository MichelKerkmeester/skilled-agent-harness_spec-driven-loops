...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/006-mcp-launcher-concurrency-arc/012-daemon-bridge-socket-for-skill-advisor-and-code-index"
...
- Add phase-map row to `006-mcp-launcher-concurrency-arc/spec.md`
- Add `012-*` to `children_ids` in `006-mcp-launcher-concurrency-arc/graph-metadata.json`
...
| Arc parent | `git checkout HEAD~1 -- 006-mcp-launcher-concurrency-arc/{spec.md,graph-metadata.json}` |

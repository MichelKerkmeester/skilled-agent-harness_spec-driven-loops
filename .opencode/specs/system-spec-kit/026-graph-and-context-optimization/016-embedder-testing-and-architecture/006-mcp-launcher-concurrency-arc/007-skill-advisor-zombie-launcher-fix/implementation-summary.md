...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/006-mcp-launcher-concurrency-arc/007-skill-advisor-zombie-launcher-fix"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | `007-skill-advisor-zombie-launcher-fix` |
...
git add \
  .opencode/bin/mk-skill-advisor-launcher.cjs \
  .opencode/skills/system-skill-advisor/mcp_server/tests/launcher-lease.vitest.ts \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/006-mcp-launcher-concurrency-arc/007-skill-advisor-zombie-launcher-fix/spec.md \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/006-mcp-launcher-concurrency-arc/007-skill-advisor-zombie-launcher-fix/plan.md \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/006-mcp-launcher-concurrency-arc/007-skill-advisor-zombie-launcher-fix/tasks.md \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/006-mcp-launcher-concurrency-arc/007-skill-advisor-zombie-launcher-fix/checklist.md \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/006-mcp-launcher-concurrency-arc/007-skill-advisor-zombie-launcher-fix/implementation-summary.md \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/006-mcp-launcher-concurrency-arc/007-skill-advisor-zombie-launcher-fix/description.json \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/006-mcp-launcher-concurrency-arc/007-skill-advisor-zombie-launcher-fix/graph-metadata.json
```

...
**Changelog**: `016-embedder-testing-and-architecture/006-mcp-launcher-concurrency-arc/changelog/002-cross-launcher-lease-propagation.md`.
<!-- /ANCHOR:phase-context -->
...
- Changelog entry — `016-embedder-testing-and-architecture/006-mcp-launcher-concurrency-arc/changelog/002-cross-launcher-lease-propagation.md`.
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/006-mcp-launcher-concurrency-arc/changelog/002-cross-launcher-lease-propagation.md` | Create | Changelog entry. |
<!-- /ANCHOR:scope -->
...
| REQ-008 | Changelog entry | `016-embedder-testing-and-architecture/006-mcp-launcher-concurrency-arc/changelog/002-cross-launcher-lease-propagation.md` documents the patch + upgrade notes (zero migration). |
<!-- /ANCHOR:requirements -->

...
**Decision:** Update `006-mcp-launcher-concurrency-arc/spec.md` to include rows for 006-011 (not just 011), and add 005/007/010 to `children_ids` (the existing list was stale).
...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/006-mcp-launcher-concurrency-arc/011-sun-path-and-stale-lease-followups \
  --strict
# Expect: Exit 0
```

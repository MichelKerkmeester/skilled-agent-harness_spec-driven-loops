...
description: "Research artifact ledger for the completed 15-iteration memory-leak audit."
trigger_phrases:
...
| 011 | cli-codex | `iterations/iteration-011.md` | `deltas/iter-011.jsonl` |
| 012 | cli-codex | `iterations/iteration-012.md` | `deltas/iter-012.jsonl` |
| 013 | cli-codex | `iterations/iteration-013.md` | `deltas/iter-013.jsonl` |
| 014 | cli-codex | `iterations/iteration-014.md` | `deltas/iter-014.jsonl` |
| 015 | cli-codex | `iterations/iteration-015.md` | `deltas/iter-015.jsonl` |
...
| `deep-research-state.jsonl` | Append-only state log with 15 iteration entries plus one continuation resume event. |

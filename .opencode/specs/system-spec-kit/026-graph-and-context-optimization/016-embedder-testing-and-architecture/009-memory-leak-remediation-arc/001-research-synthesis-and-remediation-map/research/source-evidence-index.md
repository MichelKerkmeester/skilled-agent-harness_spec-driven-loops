...
This index records where the original research evidence now lives after relocation into `009-memory-leak-remediation-arc/001-research-synthesis-and-remediation-map/research/source-research/`. Later phases should cite these moved paths rather than the old stack packet locations.

## Packet 020: CLI Process Memory Leak Deep Research

| Evidence Class | Relocated Path | Notes |
| --- | --- | --- |
| Final synthesis | `system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/009-memory-leak-remediation-arc/001-research-synthesis-and-remediation-map/research/source-research/020-cli-process-memory-leak-deep-research/research/research.md` | Nine-class taxonomy and ranked remediation backlog. |

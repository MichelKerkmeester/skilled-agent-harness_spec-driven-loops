...
description: "Implementation plan for Spec Memory Runtime Retention Cleanup."
trigger_phrases:
...
### Overview
Bound Spec Kit Memory runtime leases, timers, caches, sessions, queues, retries, audits, and embedder sidecar cleanup. The phase must preserve source evidence from the research packets and avoid claiming memory relief without process and telemetry proof.
<!-- /ANCHOR:summary -->
...
- **Implementation surface**: `.opencode/skills/system-spec-kit/mcp_server/`, `.opencode/skills/system-spec-kit/scripts/`.
...
|---------|--------------|--------|--------------|
| `.opencode/skills/system-spec-kit/mcp_server/` | Phase implementation or evidence surface | Inspect and update only within this phase scope | Stress save/search/index workloads, pending-job caps, retry abort, lease cleanup, timer shutdown, audit rotation cap |
| `.opencode/skills/system-spec-kit/scripts/` | Phase implementation or evidence surface | Inspect and update only within this phase scope | Stress save/search/index workloads, pending-job caps, retry abort, lease cleanup, timer shutdown, audit rotation cap |

...
### Overview
Make deep-research, deep-review, council, and related loops interruption-safe. The phase must preserve source evidence from the research packets and avoid claiming memory relief without process and telemetry proof.
<!-- /ANCHOR:summary -->
...
- **Implementation surface**: `.opencode/skills/system-spec-kit/`, `.opencode/skills/deep-research/`, `.opencode/skills/deep-review/`.
...
|---------|--------------|--------|--------------|
| `.opencode/skills/system-spec-kit/` | Phase implementation or evidence surface | Inspect and update only within this phase scope | Kill-during-append, corrupt-trailing-line, dead-PID lock, concurrent run fixtures |
| `.opencode/skills/deep-research/` | Phase implementation or evidence surface | Inspect and update only within this phase scope | Kill-during-append, corrupt-trailing-line, dead-PID lock, concurrent run fixtures |
| `.opencode/skills/deep-review/` | Phase implementation or evidence surface | Inspect and update only within this phase scope | Kill-during-append, corrupt-trailing-line, dead-PID lock, concurrent run fixtures |

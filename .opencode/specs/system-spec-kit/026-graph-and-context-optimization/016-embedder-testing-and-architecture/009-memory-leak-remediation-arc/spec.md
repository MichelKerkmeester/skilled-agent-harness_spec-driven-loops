...
| `003-cli-dispatch-containment-and-recursion-guards/` | CLI Dispatch Containment and Recursion Guards | P0 | Ready |
| `004-deep-loop-locks-state-and-recovery/` | Deep Loop Locks, State, and Recovery | P1 | Planned |
| `005-expected-daemon-classifier-and-process-sweep/` | Expected Daemon Classifier and Process Sweep | P1 | Planned |

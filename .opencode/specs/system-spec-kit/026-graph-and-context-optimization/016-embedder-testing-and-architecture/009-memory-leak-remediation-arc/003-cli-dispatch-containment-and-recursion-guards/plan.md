...
description: "Implementation plan for CLI Dispatch Containment and Recursion Guards."
trigger_phrases:
...
### Overview
Centralize CLI dispatch supervision and prevent same-runtime or cross-runtime recursion loops. The phase must preserve source evidence from the research packets and avoid claiming memory relief without process and telemetry proof.
<!-- /ANCHOR:summary -->
...
- **Implementation surface**: `.opencode/skills/system-spec-kit/commands/spec_kit/`, `.opencode/skills/cli-*/`, `.opencode/skills/system-spec-kit/mcp_server/lib/`.
...
|---------|--------------|--------|--------------|
| `.opencode/skills/system-spec-kit/commands/spec_kit/` | Phase implementation or evidence surface | Inspect and update only within this phase scope | Nested CLI fixtures, ignored SIGTERM child fixture, dispatch audit failure records |
| `.opencode/skills/cli-*/` | Phase implementation or evidence surface | Inspect and update only within this phase scope | Nested CLI fixtures, ignored SIGTERM child fixture, dispatch audit failure records |
| `.opencode/skills/system-spec-kit/mcp_server/lib/` | Phase implementation or evidence surface | Inspect and update only within this phase scope | Nested CLI fixtures, ignored SIGTERM child fixture, dispatch audit failure records |

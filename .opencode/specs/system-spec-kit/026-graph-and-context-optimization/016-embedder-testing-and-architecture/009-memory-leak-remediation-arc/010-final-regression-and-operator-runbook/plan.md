...
| `009-memory-leak-remediation-arc/spec.md` | Phase-parent control file | Mark phase 010 and arc completed, update continuity | Parent strict validation |
| `009-memory-leak-remediation-arc/graph-metadata.json` | Search/graph metadata | Set derived status completed and last active child | Parent strict validation |

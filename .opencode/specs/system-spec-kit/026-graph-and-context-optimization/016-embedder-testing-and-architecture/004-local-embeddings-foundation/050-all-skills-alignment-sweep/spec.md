...
|-----------|-------------|-------------|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-local-embeddings-foundation/050-all-skills-alignment-sweep/**` | Create/Modify | Tracking packet, audit results, verification evidence |

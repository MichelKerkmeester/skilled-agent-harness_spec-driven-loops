...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-local-embeddings-foundation/043-cocoindex-refresh-split/` | Create | Packet docs and metadata. |
<!-- /ANCHOR:scope -->

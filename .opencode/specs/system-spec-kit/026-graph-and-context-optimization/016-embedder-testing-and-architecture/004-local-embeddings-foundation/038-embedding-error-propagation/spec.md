...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-local-embeddings-foundation/038-embedding-error-propagation/` | Create | Track scope, plan, tasks, verification, and metadata for this packet. |
<!-- /ANCHOR:scope -->

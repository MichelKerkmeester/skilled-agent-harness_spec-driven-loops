...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-local-embeddings-foundation/045-template-contract-divergence/` | Create | Level 2 packet documentation and verification evidence. |
<!-- /ANCHOR:scope -->

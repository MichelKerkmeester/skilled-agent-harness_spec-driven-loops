...
|-----------|-------------|-------------|
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-local-embeddings-foundation/035-cocoindex-mcp-reliability/` | Create | Level-2 diagnostic packet documentation and metadata |
<!-- /ANCHOR:scope -->

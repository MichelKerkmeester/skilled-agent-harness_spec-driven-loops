...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-local-embeddings-foundation/040-reset-stuck-embedding-rows/tasks.md"
    session_dedup:

...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-local-embeddings-foundation/034-query-expansion-context-size/` | Create | Level-2 packet docs and metadata. |
<!-- /ANCHOR:scope -->

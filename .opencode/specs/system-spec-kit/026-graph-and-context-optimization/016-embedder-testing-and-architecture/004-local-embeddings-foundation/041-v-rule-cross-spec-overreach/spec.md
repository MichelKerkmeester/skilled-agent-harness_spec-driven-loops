...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-local-embeddings-foundation/041-v-rule-cross-spec-overreach/*` | Create | Level-2 packet docs |
<!-- /ANCHOR:scope -->

...
8 prior iter files at /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/002-spec-memory-stack/005-context-server-memory-reduction-research/research/iterations/. Read them ALL first, then build on (do not duplicate).

## DIMENSION FOR THIS ITERATION

**architectural alternatives (subprocess pool, separate embed-only daemon, on-disk vector index like LMDB/RocksDB)**
...
Write a single iteration file to `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/002-spec-memory-stack/005-context-server-memory-reduction-research/research/iterations/iteration-009.md` with this structure:

...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/changelog/014-lease-hardening-from-review.md` | Create (+115) | Changelog with upgrade notes + verification evidence |
<!-- /ANCHOR:what-built -->

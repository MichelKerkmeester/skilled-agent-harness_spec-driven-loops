...
- Internal links verified by inspection:
  ...
  - `../../specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/003-skill-advisor-stack/002-jina-swap-and-reindex/evidence/swap-runbook.md` — exists.

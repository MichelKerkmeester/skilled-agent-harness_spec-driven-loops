...
This is phase 1 of the memory-leak follow-ons arc. Source baseline lives in `system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/009-memory-leak-remediation-arc/007-code-graph-launcher-and-db-lifecycle/implementation-summary.md` (the Limitations anchor).
...
**Changelog**:
- When this phase closes, refresh the parent arc 010 status and remediation-map item annotation.
<!-- /ANCHOR:phase-context -->

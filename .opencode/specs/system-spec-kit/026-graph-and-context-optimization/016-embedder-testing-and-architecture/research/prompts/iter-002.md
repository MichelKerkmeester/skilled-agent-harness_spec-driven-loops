...
- Target for this iter: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/001-local-embeddings-foundation`
...
- Read-only against source. Writes ONLY to `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/research/iterations/iteration-002.md` and the JSONL state.
...
Write `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/research/iterations/iteration-002.md` with the canonical structure:
...
1. Skim `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/001-local-embeddings-foundation`'s spec.md / plan.md / tasks.md / implementation-summary.md / graph-metadata.json.

...
- T-CNS-02 run against 1 research folder (e.g. `research/016-foundational-runtime-001-initial-research/iterations/`) — verify generated `description.json` + `graph-metadata.json` match template

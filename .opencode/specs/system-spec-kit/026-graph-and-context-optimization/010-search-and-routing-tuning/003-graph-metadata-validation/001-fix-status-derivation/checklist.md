...
## P1 (Should Fix)
- [x] Verification evidence shows the change fixes the `180 + 39` high-confidence subset from `../research/research.md:317-324`. Evidence: the post-build full-corpus backfill completed successfully and the follow-up status scan returned `0` outlier derived statuses, confirming the remaining legacy variants now collapse into canonical buckets.

...
```
/spec_kit:deep-research:auto "Graph metadata relationship validation and entity quality analysis across 515+ spec folders" --max-iterations=15 --spec-folder=.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-continuity-refactor-gates/003-graph-metadata-validation
```

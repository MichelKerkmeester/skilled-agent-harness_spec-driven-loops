...
- [x] T001 Read the phase `spec.md` and confirm the requested routing deltas. Evidence: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-search-and-routing-tuning/002-content-routing-accuracy/004-doc-surface-alignment/spec.md`
...
- [x] T010 Run strict packet validation for `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-search-and-routing-tuning/002-content-routing-accuracy/004-doc-surface-alignment`. Evidence: `validate.sh --strict` exited `0` with `RESULT: PASSED`.

...
- [x] T011 Run `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh --strict .opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-search-and-routing-tuning/001-search-fusion-tuning/005-doc-surface-alignment` and repair packet docs until it passes.
<!-- /ANCHOR:phase-3 -->

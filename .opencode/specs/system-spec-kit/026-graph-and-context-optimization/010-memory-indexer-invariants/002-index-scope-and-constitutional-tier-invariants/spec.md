...
| **Status** | Wave-2 Remediation Complete |
| **Created** | 2026-04-24 |
| **Branch** | `010-memory-indexer-invariants/002-index-scope-and-constitutional-tier-invariants` |
| **Parent** | `010-memory-indexer-invariants/` |
| **Parent Spec** | `../spec.md` |
| **Predecessor** | `../001-memory-indexer-lineage-and-concurrency-fix/spec.md` |
| **Successor** | None |
<!-- /ANCHOR:metadata -->

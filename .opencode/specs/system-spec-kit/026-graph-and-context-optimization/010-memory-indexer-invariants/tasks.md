---
title: "Tasks: Memory Indexer Invariants [system-spec-kit/026-graph-and-context-optimization/010-memory-indexer-invariants/tasks]"
...
- [ ] **T-90** Restart MCP, rerun `memory_index_scan` on `026/009-hook-package`, and confirm zero `E_LINEAGE` plus zero `candidate_changed`. (BLOCKED: requires user restart + live embedding-capable runtime.)
<!-- /ANCHOR:phase-3 -->
...
- [ ] Track A live MCP rescan on `026/009-hook-package` — pending user restart + embedding-capable runtime
<!-- /ANCHOR:completion -->

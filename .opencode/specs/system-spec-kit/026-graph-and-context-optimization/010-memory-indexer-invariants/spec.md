...
| REQ-011 | Duplicate `.opencode/skill/system-spec-kit/constitutional/gate-enforcement.md` rows are consolidated safely. | Cleanup keeps the newer row (`id=9868`), deletes the older row (`id=1`), and rewrites lineage + feedback references to the kept row. |

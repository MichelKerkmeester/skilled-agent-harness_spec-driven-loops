---
title: "Plan: Memory Indexer Invariants [system-spec-kit/026-graph-and-context-optimization/010-memory-indexer-invariants/plan]"
...
- [ ] Track A live MCP rescan on `026/009-hook-package` — requires user restart + embedding-capable runtime
<!-- /ANCHOR:phases -->
...
| Live Acceptance (pending) | `memory_index_scan` on `026/009-hook-package` | Zero `E_LINEAGE`, zero `candidate_changed` |
<!-- /ANCHOR:testing -->

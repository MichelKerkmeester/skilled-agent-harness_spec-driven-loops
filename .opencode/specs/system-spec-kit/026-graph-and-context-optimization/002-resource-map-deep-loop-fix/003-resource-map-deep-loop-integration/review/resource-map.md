---
title: "Resource Map — .opencode/specs/system-spec-kit/026-graph-and-context-optimization/002-resource-map-deep-loop-fix/003-resource-map-deep-loop-integration"
...
- **Total references**: 4
- **By category**: READMEs=0, Documents=0, Commands=1, Agents=0, Skills=2, Specs=1, Scripts=0, Tests=0, Config=0, Meta=0
- **Missing on disk**: 0
- **Scope**: review convergence output for 003-resource-map-deep-loop-integration
- **Generated**: 2026-04-24T15:23:34.872Z
...
| Path | Action | Status | Note |
|------|--------|--------|------|
| .opencode/specs/system-spec-kit/026-graph-and-context-optimization/002-resource-map-deep-loop-fix/003-resource-map-deep-loop-integration/tasks.md | Analyzed | OK | Findings P0=0 P1=1 P2=0; Iterations=1 |

...
- The filled example (`026/011-resource-map-template/002-resource-map-deep-loop-fix-creation/resource-map.md`) acts as a reference impl: 32 entries across 7 categories, categories with zero rows correctly omitted, `_memory.continuity` block populated.

---
title: "...6-graph-and-context-optimization/011-resource-map-template/002-resource-map-deep-loop-fix-creation/implementation-summary]"
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/002-resource-map-deep-loop-fix/002-resource-map-deep-loop-fix-creation/*` | Created | Packet docs (spec, plan, tasks, checklist, implementation-summary, description.json, graph-metadata.json). |
<!-- /ANCHOR:what-built -->

...
|-------|------|-------|----------------|
| 001 | 2026-05-02 | [Reverse parent research/review folders](./changelog-001-reverse-parent-research-review-folders.md) | Restored local-owner artifact placement for 135 child packets and rewrote 155 references. |
| 002 | 2026-05-02 | [Resource map template creation](./changelog-002-resource-map-deep-loop-fix-creation.md) | Created the cross-cutting resource-map.md template and wired it into 12 discovery surfaces. |
| 003 | 2026-04-26 | [Resource map deep-loop integration](./changelog-003-resource-map-deep-loop-integration.md) | Made deep-review and deep-research auto-emit filled resource maps at convergence. |

...
title: "Feature Specification: MCP daemon rebuild + restart protocol [system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/013-mcp-daemon-rebuild-protocol/spec]"
...
trigger_phrases:
  - "013-mcp-daemon-rebuild-protocol"

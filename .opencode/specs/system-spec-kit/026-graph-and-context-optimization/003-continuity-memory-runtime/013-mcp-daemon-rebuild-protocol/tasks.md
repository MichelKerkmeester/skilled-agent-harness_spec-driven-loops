...
title: "Tasks: MCP daemon rebuild + restart protocol [system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/013-mcp-daemon-rebuild-protocol/tasks]"
...
- [ ] T203 `grep -r "013-mcp-daemon-rebuild-protocol" .opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/` shows at least 1 sibling packet citing it
...
- **Plan**: plan.md
- **Sources**: ../005-memory-search-runtime-bugs (post-remediation lesson), ../007-mcp-runtime-improvement-research (Q1, §11 Rec #1)
- **Cited by**: ../008-memory-context-truncation-contract, ../014-memory-search-response-policy (and others)
<!-- /ANCHOR:cross-refs -->

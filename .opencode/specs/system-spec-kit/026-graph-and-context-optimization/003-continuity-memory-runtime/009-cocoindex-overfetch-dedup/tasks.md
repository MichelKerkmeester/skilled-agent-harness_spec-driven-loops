...
title: "Tasks: CocoIndex over-fetch + dedup + rerank [system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/009-cocoindex-overfetch-dedup/tasks]"
...
- **Plan**: plan.md
- **Sources**: ../005-memory-search-runtime-bugs (REQ-018, REQ-019), ../007-mcp-runtime-improvement-research (Q2, Q3)
<!-- /ANCHOR:cross-refs -->

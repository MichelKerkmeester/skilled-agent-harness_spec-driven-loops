...
trigger_phrases:
  - "RESEARCH-007"
  - "007-mcp-runtime-improvement-research"
...
_memory:
  continuity:
    ...
    key_files:
      ...
      - "research/007-mcp-runtime-improvement-research-pt-01/deep-research-state.jsonl"
      - "research/007-mcp-runtime-improvement-research-pt-01/deep-research-config.json"
    completion_pct: 100
    open_questions:
...
| Feature/Spec | 007-mcp-runtime-improvement-research |
| Status | Complete |
...
| Document | Path |
|----------|------|
| Spec | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/007-mcp-runtime-improvement-research/spec.md` |
...
| Source packet 006 | `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/006-search-intelligence-stress-test/` |
...
| 006-search-intelligence-stress-test | Cross-AI stress-test, live probes, weak-retrieval hallucination evidence |

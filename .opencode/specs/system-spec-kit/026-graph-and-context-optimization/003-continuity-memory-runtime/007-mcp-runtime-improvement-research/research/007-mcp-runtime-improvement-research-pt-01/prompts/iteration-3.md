...
- Write iteration narrative to: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/007-mcp-runtime-improvement-research/research/007-mcp-runtime-improvement-research-pt-01/iterations/iteration-003.md
- Write per-iteration delta file to: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/007-mcp-runtime-improvement-research/research/007-mcp-runtime-improvement-research-pt-01/deltas/iter-003.jsonl
...
1. Write iteration narrative markdown to .opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/007-mcp-runtime-improvement-research/research/007-mcp-runtime-improvement-research-pt-01/iterations/iteration-003.md. Headings: Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus.

2. APPEND single-line JSONL record to .opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/007-mcp-runtime-improvement-research/research/007-mcp-runtime-improvement-research-pt-01/deep-research-state.jsonl via:
   echo '<single-line-json>' >> .opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/007-mcp-runtime-improvement-research/research/007-mcp-runtime-improvement-research-pt-01/deep-research-state.jsonl
...
3. Write delta file to .opencode/specs/system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/007-mcp-runtime-improvement-research/research/007-mcp-runtime-improvement-research-pt-01/deltas/iter-003.jsonl (one JSON per line):

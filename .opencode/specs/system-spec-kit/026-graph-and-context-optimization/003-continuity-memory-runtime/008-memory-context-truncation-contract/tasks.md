...
title: "Tasks: memory_context truncation contract + token telemetry [system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/008-memory-context-truncation-contract/tasks]"
...
- **Source packets**: ../005-memory-search-runtime-bugs (REQ-002 origin), ../007-mcp-runtime-improvement-research (Q5 contract)
- **Companion packets**: ../013-mcp-daemon-rebuild-protocol (rebuild + restart contract)
<!-- /ANCHOR:cross-refs -->

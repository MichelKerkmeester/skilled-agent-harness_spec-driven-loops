...
3. Searched the runtime for explicit Gate A-F enforcers and gate/continuity runners under `.opencode/skills/system-spec-kit/scripts/`; only generic validators and continuity checks surfaced.

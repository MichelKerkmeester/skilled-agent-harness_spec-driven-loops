...
title: "Feature Specification: memory_search hard response policy + citation policy [system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/014-memory-search-response-policy/spec]"
...
trigger_phrases:
  - "014-memory-search-response-policy"

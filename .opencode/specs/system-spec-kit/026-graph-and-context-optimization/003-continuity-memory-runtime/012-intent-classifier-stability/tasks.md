...
title: "Tasks: intent classifier stability [system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/012-intent-classifier-stability/tasks]"
...
- **Plan**: plan.md
- **Sources**: ../005-memory-search-runtime-bugs (REQ-001, REQ-004, REQ-016), ../007-mcp-runtime-improvement-research (Q8)
<!-- /ANCHOR:cross-refs -->

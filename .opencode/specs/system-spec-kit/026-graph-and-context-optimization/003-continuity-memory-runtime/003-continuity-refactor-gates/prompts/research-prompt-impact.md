...
>
> **Target runtime**: `cli-codex gpt-5.4 high fast` — single-shot delegation piped via stdin, or input to `/deep:start-research-loop:auto`. Follows `sk-deep-research v1.5.0` strategy template format.
>

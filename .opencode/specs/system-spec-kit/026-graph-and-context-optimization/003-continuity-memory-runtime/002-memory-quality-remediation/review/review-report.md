...
- Sampled runtime surfaces from the child summaries do exist in live code, including `.opencode/skills/system-spec-kit/scripts/core/workflow.ts`, `.opencode/skills/system-spec-kit/scripts/extractors/decision-extractor.ts`, `.opencode/skills/system-spec-kit/scripts/core/post-save-review.ts`, `.opencode/skills/system-spec-kit/scripts/lib/trigger-phrase-sanitizer.ts`, `.opencode/skills/system-spec-kit/scripts/core/memory-metadata.ts`, and `.opencode/skills/system-spec-kit/scripts/extractors/collect-session-data.ts`.

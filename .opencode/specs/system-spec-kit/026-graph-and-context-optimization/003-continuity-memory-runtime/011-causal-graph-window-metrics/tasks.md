...
title: "Tasks: causal-graph window metrics + auto-edge caps [system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/011-causal-graph-window-metrics/tasks]"
...
- **Plan**: plan.md
- **Sources**: ../005-memory-search-runtime-bugs (REQ-005, REQ-006, REQ-010), ../007-mcp-runtime-improvement-research (Q7)
<!-- /ANCHOR:cross-refs -->

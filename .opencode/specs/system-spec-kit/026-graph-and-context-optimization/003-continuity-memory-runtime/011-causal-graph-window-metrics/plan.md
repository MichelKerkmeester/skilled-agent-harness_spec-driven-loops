...
title: "Implementation Plan: causal-graph relation-window balance metrics + auto-edge caps [system-spec-kit/026-graph-and-context-optimization/003-continuity-memory-runtime/011-causal-graph-window-metrics/plan]"

# Packet 028 — Synthesis Index (222-iteration campaign)

> **Why this directory exists.** The 028 campaign ran **222 read-only research iterations** across **7 children** + **6 external systems** + a **cross-packet revisit**. That volume outgrew a single `roadmap.md`, which now carries stacked layers (pass-1 + broadening + 027-revisit + memory-systems). These `synthesis/*` docs are the **consolidated, digestible view**; `roadmap.md` and the per-child `research.md` remain the detailed/historical record.

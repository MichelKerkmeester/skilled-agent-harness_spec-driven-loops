...
> 4-model mining (DeepSeek v4 Pro · MiMo v2.5 Pro · Kimi K2.7 · Opus 4.8 native) of **Mem0 · Graphiti/Zep · Letta/MemGPT · Cognee**, novelty-diffed against everything 027/028 already shipped. Stopped at **22 of a planned 40** at the honest saturation point. Plain-language before→after: `synthesis/06-memory-systems-findings.md`. Full evidence: `../001-speckit-memory/research/external-memory-systems/{research.md, iterations/, deltas/}`. **Research-only.**

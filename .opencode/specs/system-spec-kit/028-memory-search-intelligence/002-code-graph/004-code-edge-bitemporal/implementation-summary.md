...
| Field | Value |
|-------|-------|
| **Spec Folder** | `028-memory-search-intelligence/002-code-graph/004-code-edge-bitemporal` |
...
5. **The real edge-staleness bug is out of scope here.** Dependency-transitivity staleness is owned by sibling `002-edge-staleness-correctness`; this cluster does not fix it.
<!-- /ANCHOR:limitations -->

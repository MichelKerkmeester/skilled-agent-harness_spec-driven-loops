...
- [x] T022 [P] The single-hop path short-circuits before any PPR walk; regression test covers flag-enabled neighborhood behavior
...
- [x] T066 Record the benchmark caveat: PPR ranking QUALITY + damping/cap/decay parameter VALUES are gated on a code-graph retrieval benchmark; mechanism ships default-off

...
- [ ] Confirm the cluster does NOT fix the real edge-staleness bug → route to sibling `002-002-edge-staleness-correctness`
...
| Memory C3-B validity-window shape | Internal | Yellow (`007-007-bitemporal-window` planned) | Shared column shape; reconcile to avoid a fork |

...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/028-memory-search-intelligence/002-code-graph/002-002-edge-staleness-correctness"
    ...
    session_dedup:
      ...
      session_id: "2026-06-19-028-002-002-edge-staleness-correctness"
...
| `queryImportersOf(stalePaths)` (NEW, beside `:1343`) | — | Create: path-filtered importers query for the scan loop | Returns only importers of the changed paths |

...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/028-memory-search-intelligence/006-review-remediation/004-p2-triage --strict` exits 0.
<!-- /ANCHOR:success-criteria -->

...
- [x] CHK-060 [P0] Both P1-1 and P1-3 are addressed. Evidence: P1-1 — per-flag default routing; P1-3 — trigger noise row removed.
...
- [x] CHK-063 [P1] The concurrent session's files and packet 030 remain unchanged. Evidence: `git status` — `rrf-fusion.ts`/deep-research/commands/.gitignore untouched by this seat; no packet-030 path changed.
<!-- /ANCHOR:fix-completeness -->

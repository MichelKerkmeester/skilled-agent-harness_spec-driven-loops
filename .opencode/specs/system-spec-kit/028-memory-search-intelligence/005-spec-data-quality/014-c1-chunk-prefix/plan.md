...
_memory:
  continuity:
    ...
    session_dedup:
      ...
      session_id: "2026-06-21-plan-014-c1-chunk-prefix"
...
|------------|------|--------|-------------------|
| 015-c2-prodmode-recall-gate | Internal | Red | Promotion is hard-blocked until the prod-mode gate lands and the number moves |

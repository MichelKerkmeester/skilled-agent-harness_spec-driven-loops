...
Not delivered yet. This phase is PLANNED and blocked on 026-shared-safe-fix-engine and 011-b1-scheduled-dq-sweep. The build will ship the detector behind a default-off flag, prove the report-only contract on a decayed-fixture corpus and leave the shipped FSRS retrievability math untouched.
<!-- /ANCHOR:how-delivered -->
...
2. **Blocked on upstream phases.** The build cannot start until 026-shared-safe-fix-engine lands the registry and 011-b1-scheduled-dq-sweep lands the report-mode fan-out.

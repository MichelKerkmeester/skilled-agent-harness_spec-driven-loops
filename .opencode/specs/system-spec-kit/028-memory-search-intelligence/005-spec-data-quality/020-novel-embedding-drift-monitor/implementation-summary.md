...
3. **Report-only by design.** The planned detector never re-embeds or remediates a mixed regime. The re-embed itself is the C1 surface at `014-c1-chunk-prefix` behind its own coverage guard.

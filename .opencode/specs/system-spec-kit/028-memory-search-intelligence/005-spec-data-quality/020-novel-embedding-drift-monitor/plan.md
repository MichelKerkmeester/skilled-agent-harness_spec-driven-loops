...
|------------|------|--------|-------------------|
| 014-c1-chunk-prefix | Internal | Green | This phase is the coverage guard a C1 partial re-embed needs and shares the `embedding_context_version` field |
| 015-c2-prodmode-recall-gate | Internal | Green | This phase protects the C2 prod read from a mixed-regime confound but is not itself C2-gated |

...
| Field | Value |
|-------|-------|
| **Spec Folder** | 017-c4-metadata-fusion |
...
2. **Build precondition.** C4 is subsumed by the cheaper C1 deterministic prefix, so the build cannot start until 014-c1-chunk-prefix shows the prod floor can move.
3. **Promotion gate.** The lane stays default-off until a prod-mode completeRecall@3 rise through 015-c2-prodmode-recall-gate beats the C1 baseline.

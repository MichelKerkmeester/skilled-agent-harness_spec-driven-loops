...
|------------|------|--------|-------------------|
| 014-c1-chunk-prefix floor-movement readout | Internal | Yellow | C4 has no admissible build justification until C1 shows the prod floor can move |
| 015-c2-prodmode-recall-gate prod@3 read | Internal | Yellow | The lane cannot be promoted past default-off without a prod-mode completeRecall@3 rise through C2 |

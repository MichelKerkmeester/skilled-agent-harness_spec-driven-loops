...
| **Status** | Draft |
| **Created** | 2026-06-21 |
| **Branch** | `016-c3-answerable-questions-tags` |
<!-- /ANCHOR:metadata -->
...
### Out of Scope
- Promoting the consumer past default-off. That promotion is the C2 gate's job and is forbidden here. See 015-c2-prodmode-recall-gate.
...
<!--
VERDICT: conditional (C2-gated). Auto-generation is novel-cheap GO-on-cost (floor-bypassing, write-time, no re-index). The fusion consumer plus parser allow-list extension is retrieval-class and stays default-off behind the 015-c2-prodmode-recall-gate prod@3 read. NO-GO as a standalone field per research.md section 3.
-->

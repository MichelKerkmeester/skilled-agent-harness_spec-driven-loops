...
| **Status** | Draft |
| **Created** | 2026-06-21 |
| **Branch** | `008-a8-surface-provenance-fields` |
...
|------|------|--------|------------|
| Dependency | `015-c2-prodmode-recall-gate` | Any field that becomes a retrieval input must pass the C2 prod-mode gate first. | A8 surfaces fields for logic and governance only, the retrieval fusion stays out of scope and C2-gated. |

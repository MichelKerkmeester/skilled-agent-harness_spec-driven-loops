...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/028-memory-search-intelligence/005-spec-data-quality/008-a8-surface-provenance-fields"
...
| 015-c2-prodmode-recall-gate | Internal | Yellow | Any field that becomes a retrieval input must pass the C2 gate first, A8 stays logic-only to avoid the block |
<!-- /ANCHOR:dependencies -->

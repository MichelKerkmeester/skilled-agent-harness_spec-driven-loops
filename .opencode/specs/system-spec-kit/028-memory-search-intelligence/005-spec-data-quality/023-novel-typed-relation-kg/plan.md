...
_memory:
  continuity:
    packet_pointer: "028-memory-search-intelligence/005-spec-data-quality/023-novel-typed-relation-kg"
...
| `015-c2-prodmode-recall-gate` | Internal | Green | Recorded only to assert it does not apply, this is navigation not retrieval |
<!-- /ANCHOR:dependencies -->

...
| **Status** | Draft |
| **Created** | 2026-06-21 |
| **Branch** | `011-b1-scheduled-dq-sweep` |
...
- Any retrieval-class detector - those are Tier C and gated on 015-c2-prodmode-recall-gate.
...
- **Not gated on 015-c2-prodmode-recall-gate**: B1 carries no retrieval-class detector, so the C2 prod-mode completeRecall@3 gate does not block it. Any retrieval-class detector added later to the sweep inherits the C2 gate on its own.

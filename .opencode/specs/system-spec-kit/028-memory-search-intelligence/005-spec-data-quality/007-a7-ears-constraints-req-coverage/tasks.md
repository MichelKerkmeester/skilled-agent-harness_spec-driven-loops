...
- [ ] T003 [P] Decide the REQ-to-task linkage shape, a tasks-table column or an inline REQ-NNN marker (.opencode/specs/system-spec-kit/028-memory-search-intelligence/005-spec-data-quality/007-a7-ears-constraints-req-coverage/spec.md) [REQ-006]
<!-- /ANCHOR:phase-1 -->

...
| Field | Value |
|-------|-------|
| **Spec Folder** | 018-c5-llm-judge-scorer |
...
2. **Promotion gate.** The judge stays default-off and unpromoted until a prod-mode completeRecall@3 rise through 015-c2-prodmode-recall-gate beats baseline.

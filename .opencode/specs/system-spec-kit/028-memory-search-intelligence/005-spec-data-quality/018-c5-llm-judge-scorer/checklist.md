...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/028-memory-search-intelligence/005-spec-data-quality/018-c5-llm-judge-scorer"
...
- [ ] CHK-003 [P1] The 015-c2-prodmode-recall-gate promotion gate and the shipped `quality_score` column dependency identified and available
<!-- /ANCHOR:pre-impl -->

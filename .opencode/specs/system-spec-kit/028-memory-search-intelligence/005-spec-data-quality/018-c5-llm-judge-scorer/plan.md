...
| 015-c2-prodmode-recall-gate | The prod-mode completeRecall@3 read | not a code change here, the promotion precondition | no task promotes the judge to the default fusion input ahead of a C2 prod@3 rise |
...
|------------|------|--------|-------------------|
| 015-c2-prodmode-recall-gate prod@3 read | Internal | Yellow | The judge cannot be promoted past default-off without a prod-mode completeRecall@3 rise through C2 |

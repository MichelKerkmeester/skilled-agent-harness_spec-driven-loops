...
| **Status** | Draft |
| **Created** | 2026-06-21 |
| **Branch** | `002-a2-trigger-propagation-description` |
<!-- /ANCHOR:metadata -->
...
|------|------|--------|------------|
| Dependency | `015-c2-prodmode-recall-gate` | None for this phase. A2 is a write-time metadata fix that bypasses the prod retrieval floor, so the C2 gate does not block it. | Documented as not-required, no retrieval promotion claim is made here. |

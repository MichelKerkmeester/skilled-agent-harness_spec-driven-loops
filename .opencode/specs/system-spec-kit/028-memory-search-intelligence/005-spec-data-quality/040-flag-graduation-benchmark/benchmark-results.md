...
```bash
node .opencode/specs/system-spec-kit/028-memory-search-intelligence/005-spec-data-quality/040-flag-graduation-benchmark/scripts/flag-graduation-benchmark.mjs --sample 60
```

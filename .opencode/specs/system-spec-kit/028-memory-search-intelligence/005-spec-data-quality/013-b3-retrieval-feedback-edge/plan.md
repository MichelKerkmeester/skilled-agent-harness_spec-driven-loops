...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/028-memory-search-intelligence/005-spec-data-quality/013-b3-retrieval-feedback-edge"
    ...
    session_dedup:
      ...
      session_id: "2026-06-21-plan-005-013-b3-retrieval-feedback-edge"
...
|------------|------|--------|-------------------|
| `015-c2-prodmode-recall-gate` | Internal | Red | Edge-b below-floor actions stay advisory until the prod-mode completeRecall@3 gate exists |

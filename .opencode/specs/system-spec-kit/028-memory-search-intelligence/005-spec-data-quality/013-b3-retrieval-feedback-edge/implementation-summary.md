...
_memory:
  continuity:
    ...
    session_dedup:
      ...
      session_id: "2026-06-21-implsummary-005-013-b3-retrieval-feedback-edge"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 013-b3-retrieval-feedback-edge |
| **Status** | PLANNED |
...
2. **Edge-b is blocked.** Acting on below-floor rows waits on `015-c2-prodmode-recall-gate`. Edge-b rows stay advisory until that gate ships.
<!-- /ANCHOR:limitations -->

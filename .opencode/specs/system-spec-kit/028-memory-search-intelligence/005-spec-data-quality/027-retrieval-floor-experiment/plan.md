...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/028-memory-search-intelligence/005-spec-data-quality/027-retrieval-floor-experiment"
    ...
    blockers:
      - "Depends on 015-c2-prodmode-recall-gate which must ship the prod-mode completeRecall@3 instrument first"
    key_files:
...
|------------|------|--------|-------------------|
| 015-c2-prodmode-recall-gate prod-mode completeRecall@3 instrument | Internal | Red | No prod-mode column exists to read without C2, so this phase is hard-blocked until C2 lands |

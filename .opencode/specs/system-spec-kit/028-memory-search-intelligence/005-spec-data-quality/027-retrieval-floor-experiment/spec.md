...
|------|------|--------|------------|
| Dependency | 015-c2-prodmode-recall-gate | Hard blocker - there is no prod-mode completeRecall@3 instrument to read without C2 | Sequence this phase after C2 lands and consume its harness export and baseline unchanged |

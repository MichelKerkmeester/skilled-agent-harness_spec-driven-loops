...
- Same-class producers: `rg -n 'executePipeline' .opencode/specs/system-spec-kit/028-memory-search-intelligence/005-spec-data-quality/043-gap-threshold-calibration-benchmark/scripts`.

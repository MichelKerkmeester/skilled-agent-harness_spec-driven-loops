...
- [ ] T002 Confirm sibling 010 lands the C-G1 clock host + C4-C cursor + `LT-turn-cadence-trigger` gate this packet will ride/consume (`../010-consolidation-cursor-clock/`)

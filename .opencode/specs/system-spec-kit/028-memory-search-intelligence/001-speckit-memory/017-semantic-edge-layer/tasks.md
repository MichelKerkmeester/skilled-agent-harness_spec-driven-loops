...
- [x] T014 Migration back-compat test: flag-off old edge reads remain unchanged, and pre-migration edges get deterministic `fact_text` backfill and read as un-embedded

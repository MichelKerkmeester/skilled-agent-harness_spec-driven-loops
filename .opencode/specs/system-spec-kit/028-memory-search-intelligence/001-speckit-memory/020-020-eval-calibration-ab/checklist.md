...
_memory:
  continuity:
    ...
    next_safe_action: "Confirm the 019 eval-harness ECE lane (CHK-001 precondition)."
    blockers:
      - "Gated on the 019 eval-harness ECE lane + A8 promotion gate."
    key_files:
      - ".opencode/specs/system-spec-kit/028-memory-search-intelligence/001-speckit-memory/020-020-eval-calibration-ab/checklist.md"
    completion_pct: 0
    open_questions: []
    answered_questions: []
---
...
- [ ] CHK-001 [P0] The 019 eval-harness ECE lane + A8 gate confirmed (or scoped as this phase's consumer)
...
- [ ] CHK-004 [P1] Scope exclusions documented
...
- [ ] CHK-010 [P0] `fitCalibration` has a real (non-test) caller harvesting label pairs
...
- [ ] CHK-020 [P0] The calibration flag graduates only on held-out ECE evidence
...
- [ ] CHK-021 [P0] The S5 eval-mode blind spot is fixed before the S5 A/B
...
- [ ] CHK-022 [P0] Each lever (S5/S3/S2) has a reported on/off measured effect
...
- [ ] CHK-025 [P1] Strict spec validation passes
...
- [ ] CHK-FIX-002 [P0] The S5 demotion class is instrumented and bounded or escalated
...
- [ ] CHK-FIX-003 [P0] The fit x-axis and label-shape blockers are closed
...
- [ ] CHK-031 [P0] Production defaults unchanged until a promotion decision
...
- [ ] CHK-032 [P1] `maybeCalibrate` degrades fail-open
...
- [ ] CHK-051 [P1] Shared eval-harness edits coordinated

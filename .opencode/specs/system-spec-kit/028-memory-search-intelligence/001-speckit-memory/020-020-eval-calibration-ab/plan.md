...
|------------|------|--------|-------------------|
| 019 eval-harness ECE lane (`C9-3`) + `A8` promotion gate (sibling `019-019-eval-harness-extension`) | Cross-phase | **Blocking** | Calibration cannot be validated/promoted; A/B has no class-gate. |

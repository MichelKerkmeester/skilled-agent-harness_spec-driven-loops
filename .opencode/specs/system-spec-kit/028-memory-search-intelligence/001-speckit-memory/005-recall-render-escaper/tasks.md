...
- [x] T202 C8: bind tests to the live wrapper-tag constant; ensure MCP transport never re-renders the escape away (`mcp_server/formatters/search-results.ts`, `tests/search-results-format.vitest.ts`)

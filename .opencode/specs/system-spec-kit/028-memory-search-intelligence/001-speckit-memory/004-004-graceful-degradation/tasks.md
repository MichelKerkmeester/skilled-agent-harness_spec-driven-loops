...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/028-memory-search-intelligence/001-speckit-memory/004-004-graceful-degradation"
...
- [x] T001 Confirm the three null-embedding throw sites + the keep-lexical substrate (`mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:700-707, 1014-1020`; `mcp_server/lib/search/hybrid-search.ts:931-947`) — evidence: iter-003 f-iter003-007, iter-034 C9-sketch

...
- Enrichment retry-budget + dead-letter / terminal `failed` state (Wave-2, `boot enrichment replay`) — that *adds* state; this sub-phase only *reads*.
...
- **027-revisit detail**: `../../005-revisit-027/research/research.md`

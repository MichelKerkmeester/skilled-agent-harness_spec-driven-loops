...
| Field | Value |
|-------|-------|
| **Spec Folder** | `028-memory-search-intelligence/001-speckit-memory/019-019-eval-harness-extension` |
| **Level** | 3 |
...
- **Gate-zero dependency** — every recall/calibration/cold number is untrustworthy until the sibling corpus reindex (`001-001-corpus-reindex-gate-zero`) runs and `assertEmbeddingCoverage` passes.

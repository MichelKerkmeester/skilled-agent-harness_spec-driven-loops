...
- **Source research**: `../../research/roadmap.md` (MEMORY-SYSTEMS ADDENDUM, top-7 #7), `../../research/synthesis/06-memory-systems-findings.md` (#14), `../../007-memory-systems/research/research.md` (+ `iterations/iteration-0{11,17,20,22}.md`, `deltas/iter-0{11,17,20,22}.jsonl`)

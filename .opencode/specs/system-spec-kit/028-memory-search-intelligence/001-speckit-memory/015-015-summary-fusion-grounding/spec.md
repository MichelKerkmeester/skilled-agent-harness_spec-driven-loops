...
| `.opencode/specs/system-spec-kit/028-memory-search-intelligence/001-speckit-memory/015-015-summary-fusion-grounding/*` | Create | This phase's documentation. |
<!-- /ANCHOR:scope -->
...
- **Source research**: `../../research/roadmap.md` (MEMORY-SYSTEMS ADDENDUM #5/#13), `../../research/synthesis/06-memory-systems-findings.md`, `../../007-memory-systems/research/iterations/iteration-{017,018,019,022}.md`.

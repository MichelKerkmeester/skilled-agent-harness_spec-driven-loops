...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/028-memory-search-intelligence/001-speckit-memory/015-015-summary-fusion-grounding"
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-spec-kit/028-memory-search-intelligence/001-speckit-memory/015-015-summary-fusion-grounding/checklist.md"
    completion_pct: 0
    open_questions: []
    answered_questions: []
---
...
- [ ] CHK-003 [P1] Scope exclusions documented
...
- [ ] CHK-010 [P0] Summary/community is a first-class weighted RRF lane
...
- [ ] CHK-011 [P0] No double-counting of summary/community evidence
...
- [ ] CHK-012 [P0] Adaptive-weight model carries a per-channel slot for the lane
  - **Evidence**: `artifact-routing.ts` exposes a tuned weight slot instead of a collapsed bucket.
- [ ] CHK-013 [P1] Existing summary/community computation reused, not rebuilt
...
- [ ] CHK-FIX-001 [P0] Both candidates have an explicit status
...
- [ ] CHK-FIX-002 [P0] All five hardcoded channel-list sites updated
  - **Evidence**: `query-router.ts:36,68,74,106-107`; `routing-telemetry.ts:17`; `hybrid-search.ts:1310,951` all carry the new channel.
- [ ] CHK-FIX-003 [P0] Consumer inventory completed for the new lane
...
- [ ] CHK-030 [P0] No live shard or host daemon used
...
- [ ] CHK-032 [P1] Lane degrades fail-open
...
- [ ] CHK-040 [P1] Spec/plan/tasks/checklist/summary synchronized
  - **Evidence**: All docs point to the same scope, candidates, seams, and shadow-gating discipline.
- [ ] CHK-041 [P1] Open questions documented

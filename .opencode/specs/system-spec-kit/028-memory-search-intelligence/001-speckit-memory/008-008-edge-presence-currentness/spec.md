...
| **Source research** | `../research/research.md`; `../../005-revisit-027/research/research.md`; `../../007-memory-systems/research/research.md` |
...
- **027 reconciliation (memory_history + bi-temporal scoping):** `../../005-revisit-027/research/research.md`.
- **Memory-systems mining (temporal-query-extraction):** `../../007-memory-systems/research/research.md`.

...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/028-memory-search-intelligence/001-speckit-memory/002-002-determinism-content-id-foundation"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | system-spec-kit/028-memory-search-intelligence/001-speckit-memory/002-002-determinism-content-id-foundation |
| **Authored** | 2026-06-19 |
| **Level** | 3 |
...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/system-spec-kit/028-memory-search-intelligence/001-speckit-memory/002-002-determinism-content-id-foundation --strict
```

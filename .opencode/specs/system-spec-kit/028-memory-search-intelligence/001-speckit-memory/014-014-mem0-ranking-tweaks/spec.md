...
| **Source research** | `../research/research.md`; `../../007-memory-systems/research/{research.md,iterations,deltas}`; `../../research/synthesis/06-memory-systems-findings.md`; `../../research/roadmap.md` (MEMORY-SYSTEMS addendum) |
...
- **External-memory-systems detail**: `../../007-memory-systems/research/{research.md, iterations/iteration-001.md, iteration-002.md, iteration-007.md, iteration-009.md, iteration-019.md}`

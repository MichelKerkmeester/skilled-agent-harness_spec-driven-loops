...
- **Research (PRIMARY)**: `../research/research.md`, `../../research/roadmap.md` (BROADENING + 027-REVISIT + MEMORY-SYSTEMS addenda), `../../research/synthesis/01-go-candidates.md`, `../../research/synthesis/06-memory-systems-findings.md`, `../../005-revisit-027/research/research.md`.

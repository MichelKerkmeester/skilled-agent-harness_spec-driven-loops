...
- [ ] CHK-001 [P0] Scope is limited to manual testing playbook sweep.
...
- [ ] CHK-020 [P0] Stale-reference scan is run with `outdated|removed|renamed|stale|missing anchor|count mismatch|non-sequential`.

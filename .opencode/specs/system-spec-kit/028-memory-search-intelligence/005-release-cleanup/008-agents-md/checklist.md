...
- [ ] CHK-001 [P0] Scope is limited to root agents and runtime-routing mirror sweep.
...
- [ ] CHK-020 [P0] Stale-reference scan is run with `contradiction|stale gate|removed skill|renamed command|missing route|obsolete`.

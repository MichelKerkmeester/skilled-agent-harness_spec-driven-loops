...
- [ ] CHK-001 [P0] Scope is limited to command doc and runtime mirror sweep.
...
- [ ] CHK-020 [P0] Stale-reference scan is run with `deprecated flag|removed command|renamed route|stale|missing mirror|orphan`.

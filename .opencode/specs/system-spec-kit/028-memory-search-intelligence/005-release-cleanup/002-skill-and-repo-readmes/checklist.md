...
- [ ] CHK-001 [P0] Scope is limited to skill-level and top-level readme sweep.
...
- [ ] CHK-020 [P0] Stale-reference scan is run with `deprecated|stale|coming soon|old version|removed|renamed|does not exist|legacy only`.

...
- [ ] CHK-001 [P0] Scope is limited to feature catalog sweep.
...
- [ ] CHK-020 [P0] Stale-reference scan is run with `unshipped|planned only|removed|renamed|stale|missing source|count mismatch`.

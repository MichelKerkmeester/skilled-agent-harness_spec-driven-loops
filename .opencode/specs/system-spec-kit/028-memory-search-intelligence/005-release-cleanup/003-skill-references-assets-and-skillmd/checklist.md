...
- [ ] CHK-001 [P0] Scope is limited to skill.md, references and assets sweep.
...
- [ ] CHK-020 [P0] Stale-reference scan is run with `TODO|TBD|deprecated|stale|removed|renamed|missing|does not exist|dead link`.

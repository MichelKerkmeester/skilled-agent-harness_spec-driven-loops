...
- [ ] CHK-001 [P0] Scope is limited to per-directory code readme sweep.
...
- [ ] CHK-020 [P0] Stale-reference scan is run with `removed|renamed|deprecated|stale|missing file|does not exist|old path`.

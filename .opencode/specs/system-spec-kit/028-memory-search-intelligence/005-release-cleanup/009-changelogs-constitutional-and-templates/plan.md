...
### Phase 1: Setup
- [ ] Run discovery: `rg --files .opencode | rg '(/changelog/.+\.md$|/constitutional/.+\.md$|/system-spec-kit/templates/.+\.md$|/system-spec-kit/templates/.+\.tmpl$)'`
...
- [ ] Run stale-reference scan: `rg -n 'missing changelog|deprecated rule|stale template|placeholder|validator mismatch|removed path' <discovered-docs>`

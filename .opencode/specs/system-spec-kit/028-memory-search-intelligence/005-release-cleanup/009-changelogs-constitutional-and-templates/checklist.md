...
- [ ] CHK-001 [P0] Scope is limited to changelog, constitutional doc and template sweep.
...
- [ ] CHK-020 [P0] Stale-reference scan is run with `missing changelog|deprecated rule|stale template|placeholder|validator mismatch|removed path`.

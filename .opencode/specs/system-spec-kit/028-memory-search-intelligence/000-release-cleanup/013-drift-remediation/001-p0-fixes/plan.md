...
description: "Plan for remediation phase 1: fix and verify 6 findings."
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "Scaffolded plan for phase 1"
...
## 1. SUMMARY
### Technical Context
6 findings, fixed by gpt-5.5-fast (variant high) via cli-opencode, verified by opus.
### Overview
...
<!-- ANCHOR:l2-effort -->
## 9. EFFORT
6 findings; mostly small doc/config edits.
<!-- /ANCHOR:l2-effort -->

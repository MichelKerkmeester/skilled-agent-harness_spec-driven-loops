...
- **Fan-out failure recovery / resilience cluster** (failure-class taxonomy, transient/fatal retry, orphan-lineage reset, recover-vs-fresh gate) — that is the sibling `003-003-fanout-failure-recovery` sub-phase, decoupled from continuity. [CONFIRMED: separate cluster.]

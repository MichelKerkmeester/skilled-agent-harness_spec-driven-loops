...
- [ ] T023 `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/028-memory-search-intelligence/004-deep-loop/003-003-fanout-failure-recovery --strict` passes [10m]

...
- **The fan-out resilience cluster** — failure-class taxonomy, transient/fatal retry, orphan-lineage reset, recover-vs-fresh gate. Owned by the sibling sub-phase `003-003-fanout-failure-recovery`; not re-implemented here.
...
- **Sibling impl sub-phase**: `../003-003-fanout-failure-recovery/` (the resilience cluster; this sub-phase is the convergence/STOP-corroboration complement).

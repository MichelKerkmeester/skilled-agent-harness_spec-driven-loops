...
| Field | Value |
|-------|-------|
| **Spec Folder** | 028-memory-search-intelligence/003-skill-advisor/006-006-provenance-drift-observability |
...
2. **Two of the three are blocked on infrastructure this sub-phase does not own.** SA-attested-baseline-drift-sweep and SA-skip-never-fabricate need the durable calibration substrate built under sibling `004-004-c4-shadow-seam-beta-posterior`; co-own it, do not fork a second store (REQ-005).

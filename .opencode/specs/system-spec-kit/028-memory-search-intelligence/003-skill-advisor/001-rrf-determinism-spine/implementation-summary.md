...
| **Shipped via** | Uncommitted working-tree implementation; no packet 030 changes; dependency commit `65cfcea513` remains the Memory-side `fuseResultsMulti` API extension |
<!-- /ANCHOR:metadata -->

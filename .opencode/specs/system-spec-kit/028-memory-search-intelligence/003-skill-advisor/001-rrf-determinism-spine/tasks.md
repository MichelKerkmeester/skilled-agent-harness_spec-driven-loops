...
- [B] T008 Benchmark gate — compare the RRF advisor's top-1/top-3 against the T001 baseline; confirm `explicit_author` dominance; only then propose a live flip (REQ-005) [LEFT-PENDING — live benchmark prohibited in this pass].

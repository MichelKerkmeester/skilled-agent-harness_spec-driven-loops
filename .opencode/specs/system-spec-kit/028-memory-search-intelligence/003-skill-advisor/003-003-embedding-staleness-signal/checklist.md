...
- [x] CHK-002 [P0] 028 research is treated as roadmap input; the shipped record is traced to packet 030.
  - **Evidence**: `spec.md` METADATA + section 10 cite `../../006-sibling-revisit/research/research.md:80` and `../../../030-memory-search-intelligence-impl/spec.md` section 14 (SA8 absent → PENDING; Wave-1 future-work `030 spec.md:104`).
...
- [x] CHK-FIX-006 [P1] Evidence is pinned to research citations and the mirror seam.
  - **Evidence**: `spec.md` + `tasks.md` cite `006-sibling-revisit/research.md:80`, synthesis `01:36`/`04:15,:34`, and `embedding-reconcile.ts:162-189`.
<!-- /ANCHOR:fix-completeness -->
...
- [x] CHK-053 [P2] Research provenance is cited per candidate.
  - **Evidence**: `spec.md` RELATED DOCUMENTS maps each facet to `006-sibling-revisit/research.md:80` and synthesis `04:34`.
<!-- /ANCHOR:docs -->
...
- [x] CHK-061 [P1] Unrelated and shipped-record files remain untouched.
  - **Evidence**: No edits to packet 030, the 028 parent, Memory `010-010-consolidation-cursor-clock`, `embedding-reconcile.ts`, or sibling research children.
<!-- /ANCHOR:file-org -->
...
- **Plan**: `plan.md`.
- **Tasks**: `tasks.md`.
- **Source research**: `../research/research.md`, `../../006-sibling-revisit/research/research.md:80`, `../../research/synthesis/01-go-candidates.md:36` + `04-sibling-and-cross-cutting.md:15,:34`.
- **Shared-infra dependency**: `../../001-speckit-memory/010-010-consolidation-cursor-clock/spec.md`.

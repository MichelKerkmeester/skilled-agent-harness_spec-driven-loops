...
**What changes**:
- A thin advisor adapter over sibling 004's Beta primitive; one shared ambient-tick driver; a query-length-bucketed midpoint in `bm25.ts` (shadow-only); a recorded NO-GO.

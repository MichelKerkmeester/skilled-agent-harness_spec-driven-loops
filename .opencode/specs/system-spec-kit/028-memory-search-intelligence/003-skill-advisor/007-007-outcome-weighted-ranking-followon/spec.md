...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/028-memory-search-intelligence/003-skill-advisor/007-007-outcome-weighted-ranking-followon"
...
- Building the shared Beta f64 primitive. — owned by sibling 004 (`004-004-c4-shadow-seam-beta-posterior`) + Deep-Loop D2 (028/004); this sub-phase consumes it via a thin adapter.
...
- **Sibling sub-phase (owns the shared Beta primitive + C4-seam promoter):** `../004-004-c4-shadow-seam-beta-posterior/`.

...
- [ ] T007 [P] Confirm the ambient-tick is the SHARED substrate the sibling 004 C4-seam promoter rides on — one driver, two consumers (coordinate with `../004-004-c4-shadow-seam-beta-posterior/`)
...
- **Sibling (owns shared Beta + C4-seam promoter):** `../004-004-c4-shadow-seam-beta-posterior/`.

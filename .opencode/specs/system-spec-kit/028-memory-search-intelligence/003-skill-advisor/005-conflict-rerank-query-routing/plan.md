...
|------------|------|--------|-------------------|
| 001 RRF determinism spine (sibling `001-rrf-determinism-spine`, C3) | Sibling 028/003 sub-phase | Pending (not in 030 Wave-0 advisor scope) | HARD — all three ride it; C6 cannot ship byte-stable without C3's rank-based survivor set [CONFIRMED: research.md C3; iter-004 F9] |

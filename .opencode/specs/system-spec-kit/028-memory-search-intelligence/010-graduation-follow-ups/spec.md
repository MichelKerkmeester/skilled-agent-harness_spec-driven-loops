...
_memory:
  continuity:
    ...
    key_files:
      ...
      - "003-search-append-citation-probe/spec.md"
    session_dedup:
...
| `003-search-append-citation-probe/spec.md` | Create | 003 | Defines scope and acceptance criteria |
...
| 003 | `003-search-append-citation-probe/` | Append-exempt serializer and citation density probe | IN PROGRESS |

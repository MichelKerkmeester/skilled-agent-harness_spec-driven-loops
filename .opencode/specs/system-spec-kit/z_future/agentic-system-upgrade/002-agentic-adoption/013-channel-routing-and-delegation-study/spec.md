...
trigger_phrases:
  - "feature"
  - "specification"
  - "013-channel-routing-and-delegation-study"
  - "investigation"
importance_tier: "important"
contextType: "research"
---
# Feature Specification: 013 Channel Routing and Delegation Study
...
| **Status** | Draft |
| **Created** | 2026-04-11 |
| **Branch** | `013-channel-routing-and-delegation-study` |
| **Parent Spec** | `../spec.md` |
| **Predecessor Phase** | `../012-runtime-manifest-and-hook-extensibility/spec.md` |
| **Successor Phase** | `../014-multi-model-council-evaluation/spec.md` |
<!-- /ANCHOR:metadata -->
...
### Problem Statement
Public has enough research signal to justify a focused study for 013 channel routing and delegation study, but not enough evidence for direct adoption. This child phase keeps the question bounded and additive.

### Purpose
Answer the remaining uncertainty for 013 channel routing and delegation study with bounded experiments and a clear promote-or-reject outcome.

### Research Sources
- `.opencode/specs/system-spec-kit/999-agentic-system-upgrade/001-research-agentic-systems/007-relay-main/research/archive/legacy-research-log/research-dashboard-legacy.md:5-14` - Relay Phase 1 separated adoptable lifecycle hooks, provider defaults, and team taxonomy from broker-style channel replacement that should remain architectural boundary only.
- `.opencode/specs/system-spec-kit/999-agentic-system-upgrade/001-research-agentic-systems/007-relay-main/research/archive/legacy-research-log/research-dashboard-legacy.md:29-34` - Phase 3 explicitly kept broker replacement rejected while treating shared lifecycle engines and coordination semantics as merge or redesign candidates.
- `.opencode/specs/system-spec-kit/999-agentic-system-upgrade/001-research-agentic-systems/007-relay-main/research/iterations/iteration-030.md:20-47` - Late Relay synthesis argued for a thinner shared lifecycle engine and smaller coordination shell rather than a full broker transplant.
<!-- /ANCHOR:problem -->
...
### In Scope
- Map current orchestrator fan-out, escalation, and completion semantics against a lightweight channel taxonomy.
- Prototype ready-state, provider-default, and delivery-ack metadata in packet-local coordination artifacts.
- Compare the prototype against current Task delegation for clarity, reliability, and implementation cost.

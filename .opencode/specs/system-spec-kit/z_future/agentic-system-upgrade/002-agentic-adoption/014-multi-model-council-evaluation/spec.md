...
trigger_phrases:
  - "feature"
  - "specification"
  - "014-multi-model-council-evaluation"
  - "investigation"
importance_tier: "important"
contextType: "research"
---
# Feature Specification: 014 Multi-Model Council Evaluation
...
| **Status** | Draft |
| **Created** | 2026-04-11 |
| **Branch** | `014-multi-model-council-evaluation` |
| **Parent Spec** | `../spec.md` |
| **Predecessor Phase** | `../013-channel-routing-and-delegation-study/spec.md` |
| **Successor Phase** | `../015-worktree-and-pipeline-evaluation/spec.md` |
<!-- /ANCHOR:metadata -->
...
### Problem Statement
Public has enough research signal to justify a focused study for 014 multi-model council evaluation, but not enough evidence for direct adoption. This child phase keeps the question bounded and additive.

### Purpose
Answer the remaining uncertainty for 014 multi-model council evaluation with bounded experiments and a clear promote-or-reject outcome.

### Research Sources
- `.opencode/specs/system-spec-kit/999-agentic-system-upgrade/001-research-agentic-systems/005-intellegix-code-agent-toolkit-master/research/archive/legacy-research-log/research-dashboard-legacy.md:5-13` - Intellegix raised council-style multi-model synthesis as a bounded, nice-to-have pattern rather than a default runtime.
- `.opencode/specs/system-spec-kit/999-agentic-system-upgrade/001-research-agentic-systems/005-intellegix-code-agent-toolkit-master/research/archive/legacy-research-log/research-dashboard-legacy.md:61-65` - Final Intellegix priorities kept preserved hidden automation and smaller shells ahead of additive council features.
<!-- /ANCHOR:problem -->
...
### In Scope
- Shadow one deep-research synthesis and one high-risk review pass with an optional second-model cross-check.
- Compare finding quality, contradiction detection, and operator time cost against the current single-stack baseline.
- Measure whether councils help only on bounded synthesis tasks rather than default loop execution.
...
| `.opencode/skill/sk-deep-research/assets/deep_research_config.json` | Investigate | Potential touchpoint for the bounded study |
<!-- /ANCHOR:scope -->

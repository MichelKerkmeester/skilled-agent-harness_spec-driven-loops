...
| Category | Scanned | With Errors | Pass Rate |
|----------|---------|-------------|-----------|
| 00--anobel.com/z_archive | 28 | 28 | 0% |
| system-spec-kit/z_archive | 20 | 20 | 0% |
...
1. `system-spec-kit/023-hybrid-rag-fusion-refinement` (top-level only)
2. `system-spec-kit/024-compact-code-graph` (top-level only)

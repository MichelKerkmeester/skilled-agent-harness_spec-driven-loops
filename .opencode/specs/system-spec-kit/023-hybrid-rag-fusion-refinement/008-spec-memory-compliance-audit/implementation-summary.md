---
title: "Implementation [system-spec-kit/023-hybrid-rag-fusion-refinement/008-spec-memory-compliance-audit/implementation-summary]"
...
- `system-spec-kit/024-compact-code-graph` (top-level + 12 phase children = 13 folders)

...
> Spec folder: `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/008-spec-memory-compliance-audit` (Level 2)
...
| File | Changes |
| ---- | ------- |
| `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/008-spec-memory-compliance-audit/spec.md` | Restored the `SPECKIT_TEMPLATE_SOURCE` marker and kept the audit scope aligned with the active packet. |
| `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/008-spec-memory-compliance-audit/plan.md` | Restored the `SPECKIT_TEMPLATE_SOURCE` marker and preserved the ranked repair plan. |
| `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/008-spec-memory-compliance-audit/tasks.md` | Restored the `SPECKIT_TEMPLATE_SOURCE` marker and tracked the execution wave details. |
| `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/008-spec-memory-compliance-audit/checklist.md` | Restored the `SPECKIT_TEMPLATE_SOURCE` marker and recorded verification checkpoints. |
| `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/008-spec-memory-compliance-audit/implementation-summary.md` | Recorded final audit counts, the restart-based verification note, and the broader follow-up search check as pending. |
| `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/008-spec-memory-compliance-audit/research/discovery-summary.md` | Captured baseline error counts and the folder breakdown used to prioritize repair waves. |
| `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/008-spec-memory-compliance-audit/research/hard-block-memories.txt` | Captured the deletion set for memory files that could not safely stay in the rebuilt corpus. |

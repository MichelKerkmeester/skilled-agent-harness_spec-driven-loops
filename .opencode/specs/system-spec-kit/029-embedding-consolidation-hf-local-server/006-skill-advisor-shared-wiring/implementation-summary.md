...
description: "Spec authored only. Captures implementation scope, plan, tasks, risks, and verification commands for skill-advisor shared server wiring spec; application code remains unchanged."
trigger_phrases:
  - "skill-advisor shared server wiring spec implementation summary"
...
No application code was built in this pass. This packet authored the phase markdown needed to implement skill-advisor shared server wiring spec: `006-skill-advisor-shared-wiring/spec.md`, `006-skill-advisor-shared-wiring/plan.md`, `006-skill-advisor-shared-wiring/tasks.md`, and this `006-skill-advisor-shared-wiring/implementation-summary.md`.
...
| Check | Result |
|-------|--------|
| `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/029-embedding-consolidation-hf-local-server/006-skill-advisor-shared-wiring --strict` | Expected verification command for this phase |

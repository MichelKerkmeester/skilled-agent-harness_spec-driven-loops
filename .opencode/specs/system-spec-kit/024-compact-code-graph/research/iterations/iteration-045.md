...
9. The ideal architecture combines code graph, memory system, and compaction hooks as separate layers with late fusion.
   ...
   This preserves the packet's existing decisions: hooks remain transport, `memory_context` remains the canonical resume primitive, and code graph stays a sibling retrieval channel rather than a replacement for semantic search. [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/002-session-start-hook/spec.md:72-77`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/decision-record.md:16-36`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/decision-record.md:48-74`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-033.md`]
...
10. A practical v1 should add code graph to the existing compaction pipeline as a narrow working-set augmenter, not as a full graph product.
   ...
   This v1 respects the packet's existing architecture and the deferred clean-room code-graph decision. It uses code graph specifically to improve compaction fidelity and recovery speed, not to broaden scope into a separate search product on day one. [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/decision-record.md:48-56`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/research.md`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-031.md`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-032.md`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-033.md`]
...
- Packet architecture and prior synthesis:
  ...
  - `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-031.md`
  - `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-032.md`
  - `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-033.md`

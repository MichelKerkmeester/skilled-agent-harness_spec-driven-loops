...
4. The optimal repo-map format for LLM consumption is compact, path-first, symbol-rich, and relevance-annotated, with structure preserved and prose used sparingly.
   ...
   For tool surfaces, the same content should also exist as structured data with `nodes`, `edges`, `freshness`, and `warnings`, but the LLM-facing repo map should stay mostly path + symbol + minimal adjacency. Richer JSON is for machines and follow-up tools; the map itself should optimize scanability. [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/research.md:198-217`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-039.md:12-19`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-039.md:114-137`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-044.md:62-125`] [SOURCE: https://aider.chat/docs/repomap.html]
...
6. The right size for a repo map in our system is Tier A's 1K-4K token range, with 1.5K-2K as the default target and 4K as the hard ceiling for research/debug flows.
   ...
   If the working set exceeds budget, cut breadth before depth: keep fewer files, but preserve signatures and the strongest edges for the files that remain. [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/research.md:198-217`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-032.md:37-45`] [SOURCE: https://aider.chat/docs/repomap.html]
...
9. Freshness should be maintained by incrementally updating the structural index and regenerating repo maps from fresh graph state when requested.
   ...
   Repo maps themselves do not need independent persistence beyond a short-lived cache keyed by query + working set + budget + freshness version. If the graph is fresh, the repo map is cheap to regenerate. If the graph is stale, the map should surface that explicitly in metadata or a warning block rather than pretending to be exact. [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/research.md:248-260`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-041.md:9-18`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-041.md:35-50`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-044.md:117-125`]
...
10. The right MVP is a query-ranked dynamic repo map built from the precomputed structural graph, with static outlines only as fallback.
   ...
   Keep a static package/file outline as a fallback when there is no query or when CocoIndex is unavailable, but the MVP should be query-ranked from day one. Otherwise we would be building only the "structural outline" half of the design and postponing the actual value of the hybrid. [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/plan.md:93-106`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/decision-record.md:95-105`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-044.md:50-58`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-045.md:177-209`] [SOURCE: `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-047.md:45-70`]

## Evidence (cite sources/URLs or file:line citations)

- `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-032.md:9-45`
- `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-039.md`
- `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-041.md:9-50`
- `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-044.md:9-18`
- `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-044.md:20-48`
- `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-044.md:62-125`
- `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-044.md:281-307`
- `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-045.md:28-40`
- `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-045.md:96-118`
- `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-045.md:177-209`
- `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-047.md:7-23`
- `.opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-047.md:45-70`
...
--- /dev/null
+++ b/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-050.md
@@ -0,0 +1,206 @@
+# Iteration 050: Compact Repo Map Generation — Structural Graph + CocoIndex
+
+## Focus

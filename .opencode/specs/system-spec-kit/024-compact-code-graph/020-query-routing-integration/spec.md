---
title: "Feature Specification: Query-Routing [system-spec-kit/024-compact-code-graph/020-query-routing-integration/spec]"
...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/024-compact-code-graph/020-query-routing-integration"

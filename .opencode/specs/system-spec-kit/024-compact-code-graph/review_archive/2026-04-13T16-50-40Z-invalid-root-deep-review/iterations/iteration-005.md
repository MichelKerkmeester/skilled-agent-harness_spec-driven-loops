...
| `.opencode/specs/system-spec-kit/024-compact-code-graph/implementation-summary.md` | 2 | 3 | 2 | 2 |
| `.opencode/specs/system-spec-kit/024-compact-code-graph/checklist.md` | 2 | 3 | 2 | 2 |
...
| `AGENTS.md` | 3 | 3 | 2 | 2 |
| `.opencode/specs/system-spec-kit/024-compact-code-graph/021-cross-runtime-instruction-parity/implementation-summary.md` | 2 | 3 | 2 | 2 |
| `.opencode/specs/system-spec-kit/024-compact-code-graph/027-opencode-structural-priming/spec.md` | 3 | 3 | 2 | 3 |
...
- Dimension: traceability
- Evidence: [SOURCE: .opencode/specs/system-spec-kit/024-compact-code-graph/implementation-summary.md:110-111] [SOURCE: .opencode/specs/system-spec-kit/024-compact-code-graph/implementation-summary.md:163-164] [SOURCE: .opencode/specs/system-spec-kit/024-compact-code-graph/checklist.md:162-163] [SOURCE: .opencode/specs/system-spec-kit/024-compact-code-graph/checklist.md:167-170] [SOURCE: .opencode/specs/system-spec-kit/024-compact-code-graph/checklist.md:176-177]
...
- Evidence: [SOURCE: AGENTS.md:75-93] [SOURCE: .opencode/specs/system-spec-kit/024-compact-code-graph/021-cross-runtime-instruction-parity/implementation-summary.md:75-90]
...
- Evidence: [SOURCE: .opencode/specs/system-spec-kit/024-compact-code-graph/027-opencode-structural-priming/spec.md:144-147] [SOURCE: .opencode/skill/system-spec-kit/mcp_server/lib/session/session-snapshot.ts:142-193]
...
- A downgrade of P1-006 to a soft wording issue was ruled out because the Phase 027 spec still states a hard 500-token ceiling. [SOURCE: .opencode/specs/system-spec-kit/024-compact-code-graph/027-opencode-structural-priming/spec.md:144-147]
...
- [SOURCE: .opencode/specs/system-spec-kit/024-compact-code-graph/implementation-summary.md:104-126]
- [SOURCE: .opencode/specs/system-spec-kit/024-compact-code-graph/implementation-summary.md:156-184]
- [SOURCE: .opencode/specs/system-spec-kit/024-compact-code-graph/checklist.md:123-178]
...
- [SOURCE: .opencode/specs/system-spec-kit/024-compact-code-graph/021-cross-runtime-instruction-parity/implementation-summary.md:71-92]

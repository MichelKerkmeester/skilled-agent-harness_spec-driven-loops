...
trigger_phrases:
  - "029 embedding error propagation"
...
| `.opencode/specs/system-spec-kit/029-embedding-error-propagation/` | Create | Track scope, plan, tasks, verification, and metadata for this packet. |
<!-- /ANCHOR:scope -->
...
| Risk | Dirty parallel-track worktree | Accidental staging can pollute commit scope. | Stage only the 029 packet and files edited for this bug. |
<!-- /ANCHOR:risks -->

...
trigger_phrases:
  - "029 embedding error propagation plan"
...
- [x] Gate 3 was pre-answered for `.opencode/specs/system-spec-kit/029-embedding-error-propagation`.
...
- [x] Run strict validation on the 029 packet.
<!-- /ANCHOR:phases -->
...
| Spec validation | 029 packet docs | `validate.sh --strict` |
<!-- /ANCHOR:testing -->
...
- **Procedure**: Revert the 029 changes in `shared/embeddings.ts`, caller wrappers, tests, and packet docs. Then rerun the targeted Vitest group to confirm old catch-and-null behavior is restored.
<!-- /ANCHOR:rollback -->

...
Scenarios (read each in full) under .opencode/skills/deep-review/manual_testing_playbook/07--command-flow-stress-tests/:
  052-setup-yaml-handoff.md            (CP-052)
  053-three-artifact-iteration-contract.md (CP-053)
  054-resource-map-coverage-gate.md    (CP-054)
  055-synthesis-save-boundary.md       (CP-055)
  056-leaf-only-nested-dispatch-refusal.md (CP-056)
  057-write-boundary-reducer-owned-files.md (CP-057)

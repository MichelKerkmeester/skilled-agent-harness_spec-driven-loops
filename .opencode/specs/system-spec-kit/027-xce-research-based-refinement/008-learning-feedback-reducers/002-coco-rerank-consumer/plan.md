...
- Live ranking use requires consumer-specific evidence: flag-off parity, shadow replay, support threshold, clamped deltas, and measured ranking lift without privacy leakage.
<!-- /ANCHOR:quality-gates -->
...
- Keep live ranking disabled until shadow replay proves safe ranking deltas and enough support.
<!-- /ANCHOR:phases -->
...
| Shadow replay | Ranking deltas, support thresholds, privacy-safe aggregates | Pytest |
<!-- /ANCHOR:testing -->
...
| Ledger quality gate | Parent gate | Required before live mode | Blocks low-support or malformed aggregate windows from influencing ranking. |
<!-- /ANCHOR:dependencies -->

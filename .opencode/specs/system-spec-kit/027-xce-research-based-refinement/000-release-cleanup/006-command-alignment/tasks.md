...
- [ ] T001 Inventory current claims (.opencode/commands/**)
- [ ] T002 List claims about schema, flags, CLI, constitutional rules, memory features, and doctrine (.opencode/commands/**)
<!-- /ANCHOR:phase-1 -->
...
- [ ] T003 [P] Align stale schema and flag references (.opencode/commands/**)
- [ ] T004 [P] Align CLI front-door and memory-feature references (.opencode/commands/**)
- [ ] T005 [P] Align constitutional-rule and doctrine references (.opencode/commands/**)
- [ ] T006 Preserve ownership boundary: Coordinate with 027/011, which owns the structural router and presentation split; this phase is content-only. (.opencode/commands/**)
<!-- /ANCHOR:phase-2 -->

---
title: "Implementation Plan: Skill Feature Catalog"
description: "Planned Level 1 implementation handoff for Skill Feature Catalog."
trigger_phrases:
  - "skill feature catalog plan"
...
### Overview
Add one feature_catalog entry per new 027 feature, bump hand-maintained count self-checks, and keep SOURCE-FILES paths grep-traceable. This planned phase follows an inventory -> align -> verify flow and is scaffolded only.
<!-- /ANCHOR:summary -->
...
| Surface review | .opencode/skills/**/feature_catalog/** | Grep/read diff review during implementation |

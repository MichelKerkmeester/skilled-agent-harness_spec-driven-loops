...
- [ ] T001 Inventory current claims (.opencode/skills/**/feature_catalog/**)
- [ ] T002 List claims about schema, flags, CLI, constitutional rules, memory features, and doctrine (.opencode/skills/**/feature_catalog/**)
<!-- /ANCHOR:phase-1 -->
...
- [ ] T003 [P] Align stale schema and flag references (.opencode/skills/**/feature_catalog/**)
- [ ] T004 [P] Align CLI front-door and memory-feature references (.opencode/skills/**/feature_catalog/**)
- [ ] T005 [P] Align constitutional-rule and doctrine references (.opencode/skills/**/feature_catalog/**)
- [ ] T006 Preserve ownership boundary: Feature catalog entries must trace to source-file paths. (.opencode/skills/**/feature_catalog/**)
<!-- /ANCHOR:phase-2 -->

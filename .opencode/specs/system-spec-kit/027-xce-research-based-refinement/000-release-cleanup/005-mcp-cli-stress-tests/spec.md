...
description: "Plan stress coverage for the three daemons, CLI front doors under schema v37, and the new gated flags."
trigger_phrases:
...
### Problem Statement
Plan stress coverage for the three daemons, CLI front doors under schema v37, and the new gated flags.
...
- Note: Epic Phase-5 runs this coverage.
...
|-----------|-------------|-------------|
| .opencode/skills/system-spec-kit/** | Future Review/Modify | Inventory, align, and verify current-state documentation claims |

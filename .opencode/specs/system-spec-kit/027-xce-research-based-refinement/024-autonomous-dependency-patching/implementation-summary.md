...
| Field | Value |
|-------|-------|
| **Spec Folder** | system-spec-kit/027-xce-research-based-refinement/024-autonomous-dependency-patching |
...
|-----------|--------|-------|
| Shell syntax | Pass | `bash -n .opencode/specs/system-spec-kit/027-xce-research-based-refinement/024-autonomous-dependency-patching/scripts/audit-and-fix.sh` |

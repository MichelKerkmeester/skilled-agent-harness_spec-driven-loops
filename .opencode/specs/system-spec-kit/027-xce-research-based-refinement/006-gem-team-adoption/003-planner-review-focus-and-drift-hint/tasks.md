...
- [x] T012 Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/027-xce-research-based-refinement/006-gem-team-adoption/003-planner-review-focus-and-drift-hint --strict`. Evidence: final validation passed with exit 0.
<!-- /ANCHOR:phase-3 -->

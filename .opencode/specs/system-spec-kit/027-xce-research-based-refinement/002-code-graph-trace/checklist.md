---
title: "Verification Checklist: 027/002 Code Graph Trace"
...
_memory:
  continuity:
    ...
    next_safe_action: "Implement Phase 002 after Phase 001 file-role helper exists"
---
# Verification Checklist: 027/002 Code Graph Trace
...
- [ ] CHK-014 [P0] `architectural_role` reuses Phase 001 `classifyFileRole` for the same file.

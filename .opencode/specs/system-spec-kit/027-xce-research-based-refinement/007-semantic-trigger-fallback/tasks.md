...
| 21 | [ ] | T021 | Add resumable-backfill tests | REQ-005, REQ-006, REQ-011 | `mcp_server/__tests__/triggers/backfill-resume.vitest.ts` (NEW) | Interrupted backfill restarts without duplicate ready rows |
| 22 | [ ] | T022 | Add shadow-to-union promotion checklist evidence | REQ-010, REQ-013 | `checklist.md`, `implementation-summary.md` | Union mode remains blocked until FP, recall, latency, cost, and rollback evidence pass |
...
- ~280-450 production LOC across schema, matcher, handler, telemetry, and resumable backfill bookkeeping.
- ~220-330 test LOC across 7 test files + fixtures.
- 22 tasks total; ~16-22 hours estimated wall.

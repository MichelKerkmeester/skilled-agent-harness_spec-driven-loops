...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-spec-kit/027-xce-research-based-refinement/023-idempotency-flag-on-correctness/checklist.md"
    completion_pct: 100
    open_questions: []
    answered_questions: []
---
...
- [x] CHK-025 [P1] Strict spec validation passes
  - **Evidence**: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/027-xce-research-based-refinement/023-idempotency-flag-on-correctness --strict` passed with 0 errors and 0 warnings.
<!-- /ANCHOR:testing -->
...
- [x] CHK-050 [P1] New docs are in approved phase folder
  - **Evidence**: Docs are under `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/023-idempotency-flag-on-correctness`.

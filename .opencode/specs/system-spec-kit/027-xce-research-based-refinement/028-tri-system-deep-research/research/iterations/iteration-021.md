...
- Evidence: .opencode/specs/system-spec-kit/027-xce-research-based-refinement/003-memory-index-causal-lifecycle/003-metadata-edge-promoter/spec.md:203-205 requires no duplicate edges and stale auto-edge tombstoning; tests/frontmatter-promoter.vitest.ts:82-121,124-145,198-219 cover small fixtures only; the stress filename command above returned no frontmatter/metadata/promoter stress suite.

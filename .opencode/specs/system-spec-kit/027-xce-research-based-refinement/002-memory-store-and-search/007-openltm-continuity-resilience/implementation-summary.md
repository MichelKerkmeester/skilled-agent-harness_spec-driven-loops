...
| `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/002-memory-store-and-search/007-openltm-continuity-resilience/*` | Modified | Reconciles phase documentation and validation metadata. |
<!-- /ANCHOR:what-built -->

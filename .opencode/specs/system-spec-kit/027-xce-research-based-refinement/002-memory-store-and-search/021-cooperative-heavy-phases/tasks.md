---
title: "Tasks: cooperative heavy phases keep the daemon responsive [template:level_1/tasks.md]"
...
_memory:
  continuity:
    ...
    recent_action: "Broke down scan-lag, trigger-backfill chunk, and marker-refresh tasks"

---
title: "Verification Checklist: 027/004 Code Graph Impact Analysis"
description: "QA validation checklist for deterministic file-level impact analysis."
trigger_phrases:
  - "027 phase 004 checklist"
...
_memory:
  continuity:
    ...
    next_safe_action: "Implement Phase 004 after Phase 002/002 data contracts are available"
---
# Verification Checklist: 027/004 Code Graph Impact Analysis
...
- [ ] CHK-004 [P1] Dependency on Phase 002 layer data is documented with unavailable fallback behavior.
<!-- /ANCHOR:pre-impl -->
...
- [ ] CHK-022 [P1] Layer fallback emits `{source: "unavailable", value: null}` if Phase 002 layer data is absent.
- [ ] CHK-023 [P1] CLI provider subprocess handling reuses the Phase 006 hardening contract if enabled.
- [ ] CHK-024 [P1] Risk weight overrides are marked heuristic until Phase 006 calibration.
<!-- /ANCHOR:code-quality -->
...
- [ ] CHK-034 [P0] New Phase 004 code reaches at least 80 percent line coverage.

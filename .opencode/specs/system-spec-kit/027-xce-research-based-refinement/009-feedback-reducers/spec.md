---
title: "Phase Parent — 009 Feedback Reducers"
...
_memory:
  continuity:
    ...
    completion_pct: 0
---
# Phase Parent: 009 Feedback Reducers
...
| **Packet ID** | `system-spec-kit/027-xce-research-based-refinement/009-feedback-reducers` |
| **Hard Dependency** | `system-spec-kit/027-xce-research-based-refinement/012-feedback-p0-correctness` |
| **Soft Dependencies** | `006-code-graph-adoption-eval`, `007-coco-intent-steering` |
...
Phase 009 coordinates the learning feedback reducers that consume existing feedback signals after Phase 012 has landed the required correctness preconditions. The parent holds no implementation tasks itself; it routes work into five child packets with explicit dependency order.
...
|-------|-------|-----|------------|----------|
| `001-aggregator` | Shared `feedback-aggregation.ts` foundation. | ~70 | `system-spec-kit/027-xce-research-based-refinement/012-feedback-p0-correctness` | TS |
...
| `003-causal-reducer` | `session-trace-causal-reducer.ts`. | ~265 | `001-aggregator` | TS |
| `004-retention-reducer` | `feedback-retention-reducer.ts`. | ~385 | `001-aggregator` | TS |
...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/system-spec-kit/027-xce-research-based-refinement/009-feedback-reducers --strict
```

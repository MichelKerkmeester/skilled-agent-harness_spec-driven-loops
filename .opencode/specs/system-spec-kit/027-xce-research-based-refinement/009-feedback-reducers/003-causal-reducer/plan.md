...
The reducer groups feedback events by session, keeps a rolling list of shown memory IDs, and emits weak edges when later citations identify a target. The edge-writing path must respect Phase 012 guardrails.
<!-- /ANCHOR:architecture -->

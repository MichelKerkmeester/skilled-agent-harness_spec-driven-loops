...
- [x] T019 Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/system-spec-kit/027-xce-research-based-refinement/003-memory-index-causal-lifecycle/002-causal-edge-tombstones --strict`. Evidence: strict validation passed with 0 errors and 0 warnings.
<!-- /ANCHOR:phase-3 -->

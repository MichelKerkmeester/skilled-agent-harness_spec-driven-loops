...
| `.opencode/skills/system-spec-kit/mcp_server/__tests__/skill_advisor/render-coco-hint.vitest.ts` | Created | PLANNED | Phase-004-integrated path + standalone-fallback |
<!-- /ANCHOR:tests -->
...
- **Soft dep on Phase 004** — `render.ts` is shared with Phase 004 work; coordination via standalone-fallback flag (REQ-009).
<!-- /ANCHOR:author-notes -->

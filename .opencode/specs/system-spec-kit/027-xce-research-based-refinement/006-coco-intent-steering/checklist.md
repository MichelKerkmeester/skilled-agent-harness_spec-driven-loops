...
| 8 | [ ] | CHK-008 | Strict spec validation passes for Phase 006 folder | n/a | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/027-xce-research-based-refinement/006-coco-intent-steering --strict` exits 0 |
...
| 12 | [ ] | CHK-012 | Advisor first-action hint integrates with Phase-004 mandate brief OR works standalone | REQ-009 | `vitest run render-coco-hint.vitest.ts` (both paths) |
...
| 25 | [ ] | CHK-025 | Phase-005 eval (when shipped) measures expansion lift on labeled task set | success metric | Phase-005 paired comparison report |
...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/system-spec-kit/027-xce-research-based-refinement/006-coco-intent-steering --strict

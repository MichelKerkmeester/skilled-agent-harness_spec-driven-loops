...
| `008-learning-feedback-reducers/**` (downstream specs/docs) | Active-reducer child specs | not a consumer here (coordination note only; no edits) | doc: coordination note in spec/tasks naming the deferred children |
...
- [ ] Add the coordination note rescoping the `008-learning-feedback-reducers/` active-reducer children to diagnostics-first / deferred (no edits to those specs)

...
- [ ] T007 Add the coordination note rescoping the `008-learning-feedback-reducers/{001-aggregator,003-causal-reducer,004-retention-reducer,005-env-tests-integration}` children to diagnostics-first / deferred — coordination only, do NOT edit those specs (this folder's docs)
<!-- /ANCHOR:phase-2 -->

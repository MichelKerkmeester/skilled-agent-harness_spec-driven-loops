...
| **Packet ID** | `system-spec-kit/027-xce-research-based-refinement/012-feedback-reducers` |
...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/system-spec-kit/027-xce-research-based-refinement/012-feedback-reducers --strict
```

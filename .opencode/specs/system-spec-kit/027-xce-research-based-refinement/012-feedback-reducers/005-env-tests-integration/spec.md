...
_memory:
  continuity:
    packet_pointer: ".opencode/specs/system-spec-kit/027-xce-research-based-refinement/012-feedback-reducers/005-env-tests-integration"
...
| **Parent Packet** | `system-spec-kit/027-xce-research-based-refinement/012-feedback-reducers` |

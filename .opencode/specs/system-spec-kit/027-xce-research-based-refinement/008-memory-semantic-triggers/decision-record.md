---
title: "Decision Record — Phase 008 Memory Semantic Triggers"
description: "ADRs documenting design decisions for Phase 008: Level-3 designation, hybrid not replacement, derived table vs JSON extension, reduced activation, threshold/margin starting values, backfill not synchronous."
trigger_phrases:
  - "027 phase 008 ADRs"
...
_memory:
  continuity:
    packet_pointer: ".opencode/specs/system-spec-kit/027-xce-research-based-refinement/008-memory-semantic-triggers"
...
# Architectural Decision Records: Phase 008 Memory Semantic Triggers
...
- Phase 006 eval will measure recall lift at calibrated threshold.

---
title: "Tasks — Phase 010 Coco-Memory Context Extras"
...
| 28 | [ ] | T028 | Update SKILL.md (mcp-coco-index + system-spec-kit) with both features | REQ-005, REQ-018 | both SKILL.md files (modified) | Documentation reviewed; opt-out + Phase-005 gate documented |
...
- Phase-005 eval gate documented (if applicable for active-mode rollout).

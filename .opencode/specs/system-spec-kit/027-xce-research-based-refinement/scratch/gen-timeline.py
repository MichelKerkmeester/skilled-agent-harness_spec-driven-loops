#!/usr/bin/env python3
"""Generate timeline.md for the 027 phase parent.
...
Regenerate (run from the 027 root):
...
def repo_prefix():
    """ROOT26 path relative to the git repo root (e.g. '.opencode/specs/.../027-...')."""
...
def changelog_map():
    ...
    anchor = "027-xce-research-based-refinement"
    m = {}

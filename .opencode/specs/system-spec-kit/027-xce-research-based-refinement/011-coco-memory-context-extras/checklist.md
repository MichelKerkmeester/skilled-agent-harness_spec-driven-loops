---
title: "Checklist — Phase 011 Coco-Memory Context Extras"
description: "Verification checklist for Phase 011. P0/P1/P2 items mapped to REQ-001..018."
trigger_phrases:
  - "027 phase 011 checklist"
...
| 13 | [ ] | CHK-013 | Strict spec validation passes for Phase 011 folder | n/a | `validate.sh ... --strict` exits 0 |
...
| 25 | [ ] | CHK-025 | Phase-006 lift gate documented for both features | REQ-018 | Manual review of docs |
...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/system-spec-kit/027-xce-research-based-refinement/011-coco-memory-context-extras --strict

# All Phase 011 vitest (memory side)
cd .opencode/skills/system-spec-kit && npx vitest run mcp_server/__tests__/search/

# All Phase 011 pytest (coco side)

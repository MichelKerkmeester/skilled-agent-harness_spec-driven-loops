---
title: "Resource Map — Phase 011 Coco-Memory Context Extras"
description: "File inventory for Phase 011: per-child scope. Bundles RQ-A4 (coco) + RQ-B2 (memory) presentation features. ~25 files."
trigger_phrases:
...
Per-child resource map for Phase 011. Pt-03 aggregate map at `../research/027-xce-research-pt-03/resource-map.md`.
<!-- /ANCHOR:when-to-use -->
...
- **Missing on disk**: 0
- **Scope**: Per-child — files Phase 011 reads, modifies, creates, or cites across 5 sub-phases (bundles RQ-A4 + RQ-B2).
...
| Path | Action | Status | Note |
|------|--------|--------|------|
| `011-coco-memory-context-extras/spec.md` | Created | OK | This packet |
| `011-coco-memory-context-extras/plan.md` | Created | OK | This packet |
| `011-coco-memory-context-extras/tasks.md` | Created | OK | This packet (28 tasks) |
| `011-coco-memory-context-extras/checklist.md` | Created | OK | This packet (28 CHK items) |
| `011-coco-memory-context-extras/decision-record.md` | Created | OK | This packet (7 ADRs) |
| `011-coco-memory-context-extras/implementation-summary.md` | Created | OK | Placeholder |
| `011-coco-memory-context-extras/description.json` | Created | OK | Spec-folder metadata |
| `011-coco-memory-context-extras/graph-metadata.json` | Created | OK | Graph metadata |
<!-- /ANCHOR:specs -->
...
- **Bundles two features** — RQ-A4 (Sub-Phases 1-2) and RQ-B2 (Sub-Phases 3-4) share governance pattern + Phase-006 gate.

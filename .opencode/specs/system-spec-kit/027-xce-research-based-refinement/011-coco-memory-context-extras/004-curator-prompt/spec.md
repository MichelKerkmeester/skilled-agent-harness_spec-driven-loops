...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/027-xce-research-based-refinement/011-coco-memory-context-extras/004-curator-prompt"
...
- Active mode: attach validated plan only after Phase 006 lift gate.
<!-- /ANCHOR:edge-cases -->

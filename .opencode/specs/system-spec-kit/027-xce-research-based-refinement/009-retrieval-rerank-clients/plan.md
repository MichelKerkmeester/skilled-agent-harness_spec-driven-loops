---
title: "Plan — Phase 009 Retrieval Rerank Clients"
...
- Phase 008 Sub-Phase 3 (Consumer A) is independently using a Python feedback reducer; if Coco rerank adapter goes Python-side, similar patterns apply.
...
### Hard preconditions
None — `cross-encoder.ts` exists and is mature.

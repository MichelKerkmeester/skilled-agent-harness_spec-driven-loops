---
title: "Decision Record — Phase 009 Retrieval Rerank Clients"
description: "ADRs for Phase 009: L3 designation, extract vs duplicate, why interface but not shared store, abstraction boundary, why Coco adapter deferred, circuit-breaker contract."
trigger_phrases:
  - "027 phase 009 ADRs"
...
# Architectural Decision Records: Phase 009 Retrieval Rerank Clients
...
**Decision:** Memory adapter for `EmbeddingCacheClient` ships in Phase 009. Coco adapter is DEFERRED.

---
title: "Resource Map — Phase 009 Retrieval Rerank Clients"
description: "File inventory for Phase 009: per-child scope. Spans interface modules + memory adapters + Coco adapter + telemetry + tests + docs. ~20 files."
trigger_phrases:
  - "027 phase 009 resource map"
importance_tier: "normal"
contextType: "general"
_memory:
  continuity:
    packet_pointer: ".opencode/specs/system-spec-kit/027-xce-research-based-refinement/009-retrieval-rerank-clients"
...
Per-child resource map for Phase 009. Pt-03 aggregate map at `../research/027-xce-research-pt-03/resource-map.md`.
<!-- /ANCHOR:when-to-use -->
...
- **Missing on disk**: 0
- **Scope**: Per-child — files Phase 009 reads, modifies, creates, or cites across 4 sub-phases.
...
| Path | Action | Status | Note |
|------|--------|--------|------|
| `009-retrieval-rerank-clients/spec.md` | Created | OK | This packet |
| `009-retrieval-rerank-clients/plan.md` | Created | OK | This packet |
| `009-retrieval-rerank-clients/tasks.md` | Created | OK | This packet |
| `009-retrieval-rerank-clients/checklist.md` | Created | OK | This packet |
| `009-retrieval-rerank-clients/decision-record.md` | Created | OK | This packet (6 ADRs) |
| `009-retrieval-rerank-clients/implementation-summary.md` | Created | OK | Placeholder |
| `009-retrieval-rerank-clients/description.json` | Created | OK | Spec-folder metadata |
| `009-retrieval-rerank-clients/graph-metadata.json` | Created | OK | Graph metadata |
<!-- /ANCHOR:specs -->

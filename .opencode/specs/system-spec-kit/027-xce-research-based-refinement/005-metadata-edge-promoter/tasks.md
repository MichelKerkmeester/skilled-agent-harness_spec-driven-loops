...
- [ ] T017 Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/system-spec-kit/027-xce-research-based-refinement/005-metadata-edge-promoter --strict`.
<!-- /ANCHOR:phase-3 -->

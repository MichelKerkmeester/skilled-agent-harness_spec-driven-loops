...
description: "Phase-parent for the verify-first remediation and research programs: epic finding remediation, tri-system deep research, deep-research remediation, and residual design units."
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "Author 005-verification-and-remediation phase-parent control trio"
    next_safe_action: "Resume or validate a child phase folder"
    blockers: []
    key_files:
      - "spec.md"
      - "001-finding-remediation/spec.md"
      - "002-tri-system-deep-research/spec.md"
      - "003-deep-research-remediation/spec.md"
      - "004-residual-design-units/spec.md"
    session_dedup:

...
_memory:
  continuity:
    packet_pointer: "027-xce-research-based-refinement/004-metadata-edge-promoter"
...
| **Status** | Draft |
| **Created** | 2026-05-13 |
| **Branch** | `scaffold/004-metadata-edge-promoter` |
| **Parent Spec** | ../spec.md |
| **Phase** | 21 of 21 |
| **Predecessor** | 003-causal-edge-tombstones |
| **Successor** | 005-write-path-reconciliation |

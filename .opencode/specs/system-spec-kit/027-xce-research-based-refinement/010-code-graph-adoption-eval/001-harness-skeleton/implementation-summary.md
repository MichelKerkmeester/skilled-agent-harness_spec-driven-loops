...
| Field | Value |
|-------|-------|
| **Spec Folder** | 006-code-graph-adoption-eval/001-harness-skeleton |
| **Updated** | 2026-05-12 |
| **Level** | 2 |
...
| Strict validation | Pending | Command: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/027-xce-research-based-refinement/010-code-graph-adoption-eval/001-harness-skeleton --strict` |
<!-- /ANCHOR:verification -->

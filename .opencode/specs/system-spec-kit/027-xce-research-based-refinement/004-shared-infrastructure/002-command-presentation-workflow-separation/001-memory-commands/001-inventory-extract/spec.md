---
title: "Feature Specification: Memory Commands - Inventory and Extract"
...
trigger_phrases:
  - "001-memory-commands 001-inventory-extract"
  - "memory commands inventory and extract"
...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/027-xce-research-based-refinement/004-shared-infrastructure/002-command-presentation-workflow-separation/001-memory-commands/001-inventory-extract"
    last_updated_at: "2026-06-10T19:14:00Z"
    last_updated_by: "gpt-5.5-fast"
    recent_action: "Inventoried memory commands and extracted presentation sections"
    next_safe_action: "Use the extraction map in implementation-summary.md when adding future workflow YAML assets"
    blockers: []
    key_files:
      - "spec.md"
      - "plan.md"
    ...
    session_dedup:
      ...
      session_id: "2026-06-10-001-memory-commands-001-inventory-extract-scaffold"
...
---
# Feature Specification: Memory Commands - Inventory and Extract
...
### Problem Statement
Memory Commands needs a scoped inventory and extract phase so presentation extraction can proceed without mixing implementation, routing, and display-contract decisions.

...
- **F7** `opencode.json` / `.claude/mcp.json` / `.codex/config.toml` — `_NOTE_INDEX_DEFAULTS` documents the selectable subset; identical across all three.

...
| **Packet ID** | `system-spec-kit/027-xce-research-based-refinement/003-code-graph-trace` |
| **Depends on** | `system-spec-kit/027-xce-research-based-refinement/002-code-graph-hld-lld` |
<!-- /ANCHOR:metadata -->
...
- `001-contract` can start after `system-spec-kit/027-xce-research-based-refinement/002-code-graph-hld-lld/001-contract` publishes.
- `002-lib-impl` starts after local `001-contract` and `system-spec-kit/027-xce-research-based-refinement/002-code-graph-hld-lld/002-lib-impl` merge.

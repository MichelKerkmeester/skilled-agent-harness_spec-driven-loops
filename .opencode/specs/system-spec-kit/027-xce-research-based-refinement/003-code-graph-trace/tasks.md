---
title: "Tasks: 027/003 Code Graph Trace"
...
_memory:
  continuity:
    ...
    next_safe_action: "Implement Phase 003 after Phase 002 exports classifyFileRole"
    blockers:
      - "Phase 002 classifyFileRole export is required for architectural_role."
    key_files:
      - "spec.md"
      - "plan.md"
      - "checklist.md"
...
---
# Tasks: 027/003 Code Graph Trace
...
- [ ] T001 Confirm Phase 002 exports `classifyFileRole(filePath, db)`.
...
- [ ] T009 Call Phase 002 `classifyFileRole(filePath, db)` and assert equality with HLD `file_role`.

...
- **[F-009-03]** spec-kit ALREADY has small-model dispatch infra (cli-opencode default deepseek; sk-prompt-models qwen/glm/minimax/mimo profiles) — plumbing, not a verification POLICY (`cli-opencode/SKILL.md:247,263`, `sk-prompt-models/SKILL.md:200,214`). GAP partial — "run cheap review GATES" is net-new as a default/recommended pattern. **ADAPT** · S/M · med.

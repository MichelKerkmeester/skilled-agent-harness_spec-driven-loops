...
- Contradictory evidence: feature docs say malformed lines are skipped with defaults, while reducer code throws unless lenient. Resolution: readers may tolerate damage, but official reducer repair should fail closed unless explicitly lenient. [SOURCE: .opencode/skills/deep-research/feature_catalog/02--state-management/008-jsonl-state-log.md:26-29] [SOURCE: .opencode/skills/deep-research/scripts/reduce-state.cjs:84-90]
...
- .opencode/skills/deep-research/feature_catalog/02--state-management/008-jsonl-state-log.md:18-29
...
- .opencode/skills/deep-research/feature_catalog/04--research-output/015-progressive-synthesis.md:24-41
- .opencode/commands/deep/assets/deep_start-research-loop_auto.yaml:1006-1024
- .opencode/skills/deep-research/feature_catalog/04--research-output/016-negative-knowledge.md:24-41

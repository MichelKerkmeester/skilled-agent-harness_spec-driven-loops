...
iteration: 031
rq: RQ-N2
phase_target: 003-memoization-dependency-dag-foundation
newInfoRatio: 0.72
verdict: ADAPT
---
...
What memoization and fingerprint primitives are (A) already present in the current memory indexer/MCP code and (B) still missing per the spec for phase `003-memoization-dependency-dag-foundation`? Produce a revised scope table.

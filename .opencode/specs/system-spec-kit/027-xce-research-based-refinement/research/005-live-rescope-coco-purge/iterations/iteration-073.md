...
| `specs/system-spec-kit/027-xce-research-based-refinement/005-learning-feedback-reducers/spec.md` | 38 | Soft dep includes `028/006-coco-intent-steering` | Remove named 028/coco folder dependency; keep only evidence-based shadow/promotion gate if needed |
| `specs/system-spec-kit/027-xce-research-based-refinement/004-semantic-trigger-fallback/plan.md` | 248 | Downstream consumer `028/008-coco-memory-context-extras` | Remove or rewrite as generic future downstream curator consumer |
| `specs/system-spec-kit/027-xce-research-based-refinement/002-memory-write-safety/spec.md` | 64 | Ships before 028 code-graph folders and `027/009-feedback-reducers` | Remove 028 ordering claim; if needed, reference current `027/005-learning-feedback-reducers` |

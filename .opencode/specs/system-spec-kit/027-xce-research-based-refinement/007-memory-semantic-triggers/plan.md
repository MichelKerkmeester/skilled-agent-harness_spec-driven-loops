...
### Soft preconditions
- **Phase 005** (adoption eval harness) — for threshold tuning runs and recall-lift measurement; not required for spec scaffold or initial implementation.
...
- **Phase 010** (coco-memory context extras) — better trigger candidate set improves curator input quality (RQ-B2 soft dep).
...
| Phase 005 paraphrase task recall lift | ≥ 0.15 over baseline | Phase 005 paired comparison |
<!-- /ANCHOR:success-metrics -->

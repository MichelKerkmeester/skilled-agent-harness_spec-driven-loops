---
title: "Phase 007 — Memory Backend Semantic Trigger Matching (Hybrid Lexical+Semantic)"
...
_memory:
  continuity:
    ...
    recent_action: "Scaffolded 027/007 from pt-03 RQ-B1"
...
| **Depends on** | none (hard); shared infra from `005-code-graph-adoption-eval` for threshold tuning eval |
...
- Phase 005 eval (when shipped) measures recall lift on paraphrase-heavy task set.
<!-- /ANCHOR:success -->

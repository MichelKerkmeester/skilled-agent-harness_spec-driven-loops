---
title: "Resource Map — Phase 007 Memory Semantic Triggers"
description: "File inventory for Phase 007: per-child scope. Spans memory backend handlers + semantic matcher + schema + cache + cognitive activation. ~22 files."
trigger_phrases:
...
Per-child resource map for Phase 007. Pt-03's aggregate map (`../research/027-xce-research-pt-03/resource-map.md`) covers full research scope; this file narrows to Phase 007's specific touch set.
<!-- /ANCHOR:when-to-use -->
...
| Path | Action | Status | Note |
|------|--------|--------|------|
| `007-memory-semantic-triggers/spec.md` | Created | OK | This packet |
| `007-memory-semantic-triggers/plan.md` | Created | OK | This packet |
| `007-memory-semantic-triggers/tasks.md` | Created | OK | This packet |
| `007-memory-semantic-triggers/checklist.md` | Created | OK | This packet |
| `007-memory-semantic-triggers/decision-record.md` | Created | OK | This packet |
| `007-memory-semantic-triggers/implementation-summary.md` | Created | OK | Placeholder; filled post-impl |
| `007-memory-semantic-triggers/description.json` | Created | OK | Spec-folder metadata |
| `007-memory-semantic-triggers/graph-metadata.json` | Created | OK | Graph metadata |
<!-- /ANCHOR:specs -->
...
- **No external dependencies** — Phase 007 has no hard preconditions; soft dep on Phase 005 for threshold tuning.
<!-- /ANCHOR:author-notes -->

...
_memory:
  continuity:
    packet_pointer: "027-xce-research-based-refinement/004-causal-graph-lifecycle-tombstones"
...
| **Status** | Draft |
| **Created** | 2026-05-13 |
| **Branch** | `scaffold/004-causal-graph-lifecycle-tombstones` |
| **Parent Spec** | ../spec.md |
| **Phase** | 20 of 20 |
| **Predecessor** | 003-memoization-dependency-dag-foundation |
| **Successor** | 005-frontmatter-causal-edge-promoter |

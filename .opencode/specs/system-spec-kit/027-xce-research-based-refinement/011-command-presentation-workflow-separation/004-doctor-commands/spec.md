...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/027-xce-research-based-refinement/011-command-presentation-workflow-separation/004-doctor-commands"
    last_updated_at: "2026-06-10T00:00:00Z"
    last_updated_by: "gpt-5.5"
    recent_action: "Scaffold family phase-parent and four leaf aspects; no implementation"
    next_safe_action: "Plan or implement 004-doctor-commands/001-inventory-extract"
    blockers: []
    key_files:
...
|-----------|-------------|-------|-------------|
| `.opencode/commands/doctor/*.md` | Future Review/Modify | 001-003 | Inventory inline presentation and then thin-router rewiring |
| `.opencode/commands/doctor:*.md` | Future Review/Modify | 001-003 | Inventory inline presentation and then thin-router rewiring |
| `.opencode/commands/doctor/assets/**/*.yaml` | Future Review/Modify | 001-003 | Inventory inline presentation and then thin-router rewiring |
| `.opencode/commands/doctor/assets/**/*.yml` | Future Review/Modify | 001-003 | Inventory inline presentation and then thin-router rewiring |

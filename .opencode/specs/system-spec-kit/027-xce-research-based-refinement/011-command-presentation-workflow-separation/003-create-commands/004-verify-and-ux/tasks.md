...
- [ ] T001 Define cross-model render scenarios (.opencode/commands/create/*.md)
- [ ] T002 Verify startup questions are asked consistently (.opencode/commands/create/*.md)
<!-- /ANCHOR:phase-1 -->
...
- [ ] T003 [P] Verify dashboard layout is stable (.opencode/commands/create/*.md)
- [ ] T004 [P] Verify results-display template is followed (.opencode/commands/create/*.md)
- [ ] T005 [P] Apply family-specific UX polish plan (.opencode/commands/create/*.md)
<!-- /ANCHOR:phase-2 -->
...
- [ ] T006 Record verification evidence for implementation handoff (.opencode/commands/create/*.md)

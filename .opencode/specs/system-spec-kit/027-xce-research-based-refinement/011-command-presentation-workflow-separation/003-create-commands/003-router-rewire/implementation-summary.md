...
trigger_phrases:
  - "create commands - router rewire implementation summary"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | system-spec-kit/027-xce-research-based-refinement/011-command-presentation-workflow-separation/003-create-commands/003-router-rewire |

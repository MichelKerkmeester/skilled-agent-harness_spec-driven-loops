...
| Surface | Files |
|---------|-------|
| Root phase parent | `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/011-command-presentation-workflow-separation/spec.md`, `graph-metadata.json` |

...
## 1. TOPIC
Fan-out review of `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/011-command-presentation-workflow-separation`, focused on command router/presentation separation across memory, speckit, create, and doctor command families.

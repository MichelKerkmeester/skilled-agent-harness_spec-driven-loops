...
description: "Planned task outline for memory commands author presentation markdown."
trigger_phrases:
...
- [ ] T001 Define presentation Markdown path conventions (.opencode/commands/memory/*.md)
- [ ] T002 Author startup-question sections (.opencode/commands/memory/*.md)
<!-- /ANCHOR:phase-1 -->
...
- [ ] T003 [P] Author dashboard layout sections (.opencode/commands/memory/*.md)
- [ ] T004 [P] Author results-display sections (.opencode/commands/memory/*.md)
- [ ] T005 [P] Check that presentation files are the single display source of truth (.opencode/commands/memory/*.md)
<!-- /ANCHOR:phase-2 -->
...
- [ ] T006 Record any shared template reuse within the family (.opencode/commands/memory/*.md)

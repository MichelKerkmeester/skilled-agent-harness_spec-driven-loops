...
description: "Planned task outline for memory commands router rewire."
trigger_phrases:
...
- [ ] T001 Define thin-router acceptance criteria (.opencode/commands/memory/*.md)
- [ ] T002 Map each command to workflow and presentation files (.opencode/commands/memory/*.md)
<!-- /ANCHOR:phase-1 -->
...
- [ ] T003 [P] Plan command.md rewrites without changing behavior (.opencode/commands/memory/*.md)
- [ ] T004 [P] Plan inline-presentation removal checks (.opencode/commands/memory/*.md)
- [ ] T005 [P] Plan routing-preservation checks (.opencode/commands/memory/*.md)
<!-- /ANCHOR:phase-2 -->
...
- [ ] T006 Record rollback expectations for command.md rewires (.opencode/commands/memory/*.md)

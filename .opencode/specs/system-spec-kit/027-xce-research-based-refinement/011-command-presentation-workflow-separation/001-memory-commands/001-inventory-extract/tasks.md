...
description: "Planned task outline for memory commands inventory and extract."
trigger_phrases:
...
- [ ] T001 List every family command Markdown file (.opencode/commands/memory/*.md)
- [ ] T002 List referenced workflow asset YAML files (.opencode/commands/memory/*.md)
<!-- /ANCHOR:phase-1 -->
...
- [ ] T003 [P] Identify inline startup-question blocks (.opencode/commands/memory/*.md)
- [ ] T004 [P] Identify inline dashboard layout blocks (.opencode/commands/memory/*.md)
- [ ] T005 [P] Identify inline results-display templates (.opencode/commands/memory/*.md)
<!-- /ANCHOR:phase-2 -->
...
- [ ] T006 Draft the extraction map for each command (.opencode/commands/memory/*.md)

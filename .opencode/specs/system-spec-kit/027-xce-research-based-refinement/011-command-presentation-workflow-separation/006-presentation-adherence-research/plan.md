...
| Structural | Packet document compliance | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/027-xce-research-based-refinement/011-command-presentation-workflow-separation/006-presentation-adherence-research --strict` |

...
| **Packet ID** | `system-spec-kit/027-xce-research-based-refinement/004-semantic-trigger-fallback` |
...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/system-spec-kit/027-xce-research-based-refinement/004-semantic-trigger-fallback --strict
```

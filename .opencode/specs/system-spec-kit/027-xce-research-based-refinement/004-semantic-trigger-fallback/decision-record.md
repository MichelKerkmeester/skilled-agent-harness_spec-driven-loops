---
title: "Decision Record — Phase 004 Memory Semantic Triggers"
description: "ADRs documenting design decisions for Phase 004: Level-3 designation, hybrid not replacement, derived table vs JSON extension, reduced activation, threshold/margin starting values, backfill not synchronous."
trigger_phrases:
  - "027 phase 004 ADRs"
...
# Architectural Decision Records: Phase 004 Memory Semantic Triggers
...
**Decision:** Designate Phase 004 as Level 3.
...
Designate Phase 004 as **Level 3**. Apply full L3 file contract: spec.md, plan.md, tasks.md, checklist.md, decision-record.md, implementation-summary.md, description.json, graph-metadata.json, plus per-child resource-map.md per user directive.
<!-- /ANCHOR:adr-001-decision -->

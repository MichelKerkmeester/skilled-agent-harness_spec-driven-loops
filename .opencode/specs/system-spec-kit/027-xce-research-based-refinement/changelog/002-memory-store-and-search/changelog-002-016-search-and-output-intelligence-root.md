...
---
# Changelog Rollup — 002/016: Search and Output Intelligence Implementation

## 2026-06-17

> Spec folder: `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/002-memory-store-and-search/016-search-and-output-intelligence` (Phase Parent)
...
|-------|-------|-----------|
| `016/001` | Token-budget truncation safety (skip don't break, floor of three, progressive remainder) | [changelog-002-016-001-token-budget-truncation-safety.md](./changelog-002-016-001-token-budget-truncation-safety.md) |
| `016/002` | Request-quality aggregation (top-dominant and margin-aware citable verdict) | [changelog-002-016-002-request-quality-aggregation.md](./changelog-002-016-002-request-quality-aggregation.md) |
| `016/003` | Generic-query deep routing (escalate short low-signal queries) | [changelog-002-016-003-generic-query-deep-routing.md](./changelog-002-016-003-generic-query-deep-routing.md) |
| `016/004` | Confidence calibration (relevance-dominant rebalance on, isotonic infra off) | [changelog-002-016-004-confidence-calibration-labeled-set.md](./changelog-002-016-004-confidence-calibration-labeled-set.md) |
| `016/005` | Cosine top-N reorder (stable head reorder by absolute relevance) | [changelog-002-016-005-cosine-topn-reorder.md](./changelog-002-016-005-cosine-topn-reorder.md) |
| `016/006` | Command-contract structural (deterministic args, salience inversion) | [changelog-002-016-006-command-contract-structural.md](./changelog-002-016-006-command-contract-structural.md) |
| `016/007` | Output surface-parity (one score, one scale, one name) | [changelog-002-016-007-output-surface-parity.md](./changelog-002-016-007-output-surface-parity.md) |

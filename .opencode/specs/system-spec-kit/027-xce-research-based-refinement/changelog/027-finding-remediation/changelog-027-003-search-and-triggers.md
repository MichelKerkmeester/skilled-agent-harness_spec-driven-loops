...
trigger_phrases:
  - "027 003 search triggers changelog"
...
> Spec folder: `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/027-finding-remediation/003-search-and-triggers` (Level 1)

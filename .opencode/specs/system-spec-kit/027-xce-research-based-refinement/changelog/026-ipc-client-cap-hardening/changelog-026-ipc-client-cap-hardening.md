...
trigger_phrases:
  - "026 ipc client cap hardening changelog"
...
> Spec folder: `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/026-ipc-client-cap-hardening` (Level 1)

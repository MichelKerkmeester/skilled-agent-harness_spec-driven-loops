...
trigger_phrases:
  - "027 phase 004 004 tests goldens shadow eval"
...
> Spec folder: `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/004-semantic-trigger-fallback/004-tests-goldens-shadow-eval` (Level 1)

...
trigger_phrases:
  - "027 phase 004 002 semantic matcher"
...
> Spec folder: `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/004-semantic-trigger-fallback/002-semantic-matcher` (Level 1)

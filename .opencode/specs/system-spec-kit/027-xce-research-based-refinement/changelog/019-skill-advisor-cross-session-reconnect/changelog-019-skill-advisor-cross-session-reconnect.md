...
trigger_phrases:
  - "019 skill advisor cross session reconnect changelog"
...
> Spec folder: `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/019-skill-advisor-cross-session-reconnect` (Level 2)

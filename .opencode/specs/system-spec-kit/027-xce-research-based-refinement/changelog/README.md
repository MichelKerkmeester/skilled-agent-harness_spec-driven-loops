...
Spec 027 (xce-research-based-refinement) shipped its memory, doctrine, search, resilience, and CLI hardening across twenty-four phase tracks (000 through 023). Every shipped phase has a packet-local changelog, and every phase parent has a rollup with an Included Phases table. This index links each track to its top rollup. The chronological view of the same folders lives in `../timeline.md`.
...
- All twenty-four tracks (000 through 023) now have a changelog. Tracks 000, 011, 016, and 018 summarize children inline in their rollup; the others use separate leaf changelogs.

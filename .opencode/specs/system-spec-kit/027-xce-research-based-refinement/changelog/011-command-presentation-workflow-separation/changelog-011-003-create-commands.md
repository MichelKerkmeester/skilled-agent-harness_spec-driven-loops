...
trigger_phrases:
  - "011 003 create commands changelog"
...
> Spec folder: `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/011-command-presentation-workflow-separation/003-create-commands` (Level 2, Phase Parent)

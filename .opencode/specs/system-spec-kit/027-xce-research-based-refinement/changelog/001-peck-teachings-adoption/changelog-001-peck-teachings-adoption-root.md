...
> Spec folder: `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/001-peck-teachings-adoption` (Level 1, Phase Parent)
...
|-----------|------|-------|
| [changelog-001-001-peck-teachings-for-spec-kit.md](./changelog-001-001-peck-teachings-for-spec-kit.md) | 2026-06-05 | Peck teachings analysis report for system-spec-kit |
| [changelog-001-002-self-check-templates.md](./changelog-001-002-self-check-templates.md) | 2026-06-10 | Self-check and failure-mode guidance in manifest templates (peck T3) |
| [changelog-001-003-current-state-discipline.md](./changelog-001-003-current-state-discipline.md) | 2026-06-10 | Advisory CURRENT_STATE_DISCIPLINE validation rule (peck T4) |
| [changelog-001-004-constitutional-rule-review.md](./changelog-001-004-constitutional-rule-review.md) | 2026-06-10 | Constitutional rule review cadence and staleness diagnostic (peck T2) |
| [changelog-001-005-reviewer-prompt-benchmark-substrate.md](./changelog-001-005-reviewer-prompt-benchmark-substrate.md) | 2026-06-10 | Reviewer-prompt benchmark substrate for deep-improvement Lane B |
| [changelog-001-006-peck-verification-discipline.md](./changelog-001-006-peck-verification-discipline.md) | 2026-06-10 | Peck verification discipline: read-budget, escalation, anti-softening, and completion-freshness gate |
| [changelog-001-007-acceptance-coverage-gate.md](./changelog-001-007-acceptance-coverage-gate.md) | 2026-06-10 | Opt-in acceptance-criteria coverage gate (peck T1, source pass) |

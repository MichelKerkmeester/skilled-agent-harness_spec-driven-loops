...
trigger_phrases:
  - "007 003 feedback safety posture changelog"
...
> Spec folder: `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/007-memclaw-derived-memory-hardening/003-feedback-log-and-005-reframe` (Level 2)
...
- Phase docs recording the 008 reducer coordination note: `005-learning-feedback-reducers/{001-aggregator, 003-causal-reducer, 004-retention-reducer, 005-env-tests-integration}` are deferred as diagnostics-first and default-off.

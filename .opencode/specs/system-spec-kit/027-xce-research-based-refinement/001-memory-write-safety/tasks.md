...
- [ ] T012 Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/027-xce-research-based-refinement/001-memory-write-safety --strict`.
<!-- /ANCHOR:phase-3 -->

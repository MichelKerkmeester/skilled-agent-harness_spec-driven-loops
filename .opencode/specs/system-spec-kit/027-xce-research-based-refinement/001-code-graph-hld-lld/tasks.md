...
_memory:
  continuity:
    ...
    open_questions:
      ...
      - "Confirm whether omni wiring stays in Phase 001 scope."
    answered_questions:
...
- [ ] T004 Confirm whether `queryMode: "omni"` remains in Phase 001 scope or is explicitly removed.
<!-- /ANCHOR:phase-1 -->
...
- [ ] `classifyFileRole` is exported for Phase 002 and equals HLD `file_role`.
- [ ] Omni scope is either fully wired and tested or explicitly removed from Phase 001.
<!-- /ANCHOR:completion -->

...
- [ ] T001 [B] Confirm child 012's agent-IO envelope is landed; read its `advisory` field group.
...
- [ ] T012 Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/system-spec-kit/027-xce-research-based-refinement/012-gem-team-adoption/003-planner-review-focus-and-drift-hint --strict`.
<!-- /ANCHOR:phase-3 -->

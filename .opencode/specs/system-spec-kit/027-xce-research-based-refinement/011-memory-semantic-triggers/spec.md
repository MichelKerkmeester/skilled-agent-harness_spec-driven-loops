---
title: "Phase 008 — Memory Backend Semantic Trigger Matching (Hybrid Lexical+Semantic)"
...
# Feature Specification: Memory Backend Semantic Trigger Matching (Hybrid)
...
- Learned trigger confidence weighting (would require Phase 009's feedback reducer).
...
- Phase 006 eval (when shipped) measures recall lift on paraphrase-heavy task set.
<!-- /ANCHOR:success -->

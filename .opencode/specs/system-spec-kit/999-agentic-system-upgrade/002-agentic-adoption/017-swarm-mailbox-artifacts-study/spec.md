...
trigger_phrases:
  - "feature"
  - "specification"
  - "017-swarm-mailbox-artifacts-study"
  - "investigation"
importance_tier: "important"
contextType: "research"
---
# Feature Specification: 017 Swarm Mailbox Artifacts Study
...
| **Status** | Draft |
| **Created** | 2026-04-11 |
| **Branch** | `017-swarm-mailbox-artifacts-study` |
| **Parent Spec** | `../spec.md` |
| **Predecessor Phase** | `../016-self-reflection-and-reconsolidation-study/spec.md` |
| **Successor Phase** | `../018-git-context-and-run-state-evaluation/spec.md` |
<!-- /ANCHOR:metadata -->
...
### Problem Statement
Public has enough research signal to justify a focused study for 017 swarm mailbox artifacts study, but not enough evidence for direct adoption. This child phase keeps the question bounded and additive.

### Purpose
Answer the remaining uncertainty for 017 swarm mailbox artifacts study with bounded experiments and a clear promote-or-reject outcome.

### Research Sources
- `.opencode/specs/system-spec-kit/999-agentic-system-upgrade/001-research-agentic-systems/009-xethryon/research/archive/legacy-research-log/research-dashboard-legacy.md:9-14` - Xethryon Phase 1 treated the file-based swarm mailbox as an additive idea worth studying, not a runtime to transplant directly.
- `.opencode/specs/system-spec-kit/999-agentic-system-upgrade/001-research-agentic-systems/009-xethryon/research/archive/legacy-research-log/research-dashboard-legacy.md:19-24` - Phase 2 explicitly rejected pivoting from orchestrate-and-packet to a mailbox-driven team runtime.
- `.opencode/specs/system-spec-kit/999-agentic-system-upgrade/001-research-agentic-systems/009-xethryon/research/iterations/iteration-028.md:21-49` - Late synthesis recommended keeping gates and packet rigor while compressing operator-facing ceremony through compact summaries.
<!-- /ANCHOR:problem -->
...
### In Scope
- Prototype a packet-local mailbox or task-board artifact for one orchestrated multi-agent workflow.
- Compare the artifact against current orchestrator notes and dispatch configs for clarity and failure recovery.
- Measure whether the artifact helps humans and agents coordinate without becoming a hidden runtime dependency.

...
| Spec Folder | ../.opencode/specs/system-spec-kit/z_archive/009-full-spec-doc-indexing |
| Channel | main |
...
```
/spec_kit:resume ../.opencode/specs/system-spec-kit/z_archive/009-full-spec-doc-indexing
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: ../.opencode/specs/system-spec-kit/z_archive/009-full-spec-doc-indexing
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume ../.opencode/specs/system-spec-kit/z_archive/009-full-spec-doc-indexing` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "../.opencode/specs/system-spec-kit/z_archive/009-full-spec-doc-indexing" })` |
...
ls -la ../.opencode/specs/system-spec-kit/z_archive/009-full-spec-doc-indexing/memory/
...
spec_folder: "../.opencode/specs/system-spec-kit/z_archive/009-full-spec-doc-indexing"
channel: "main"
...
parent_spec: "../.opencode/specs/system-spec-kit/z_archive/009-full-spec-doc-indexing"
child_sessions:

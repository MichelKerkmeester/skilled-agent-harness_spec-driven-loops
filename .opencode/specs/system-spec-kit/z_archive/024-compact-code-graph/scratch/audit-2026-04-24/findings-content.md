...
- Issue: Reference `.opencode/skills/system-spec-kit/scripts/dist/hooks/claude/session-prime.js` resolves to a missing path.
- Target: .opencode/skills/system-spec-kit/scripts/dist/hooks/claude/session-prime.js
- Proposed fix: replace `.opencode/skills/system-spec-kit/scripts/dist/hooks/claude/session-prime.js` with `.opencode/skills/system-spec-kit/mcp_server/dist/hooks/claude/session-prime.js`
...
- Issue: Reference `.opencode/skills/system-spec-kit/scripts/dist/hooks/claude/session-stop.js` resolves to a missing path.
- Target: .opencode/skills/system-spec-kit/scripts/dist/hooks/claude/session-stop.js
- Proposed fix: replace `.opencode/skills/system-spec-kit/scripts/dist/hooks/claude/session-stop.js` with `.opencode/skills/system-spec-kit/mcp_server/dist/hooks/claude/session-stop.js`
...
- Issue: Reference `.opencode/skills/system-spec-kit/feature_catalog/feature_catalog_in_simple_terms.md` resolves to a missing path.
- Target: .opencode/skills/system-spec-kit/feature_catalog/feature_catalog_in_simple_terms.md
- Proposed fix: delete the plain-language catalog reference or replace it with `.opencode/skills/system-spec-kit/feature_catalog/feature_catalog.md` after confirming that is the intended reader surface
...
- Proposed fix: replace `./lib/enrichment/passive-enrichment.js` with `.opencode/skills/system-spec-kit/mcp_server/lib/enrichment/passive-enrichment.ts`
...
- Issue: Reference `.opencode/skills/sk-doc/references/hvr_rules.md` resolves to a missing path.
- Target: .opencode/skills/sk-doc/references/hvr_rules.md
- Proposed fix: replace `.opencode/skills/sk-doc/references/hvr_rules.md` with `.opencode/skills/sk-doc/references/global/hvr_rules.md`
...
- Target: CODEX.md
- Proposed fix: delete `../../../../../CODEX.md` or replace it with an existing runtime guidance surface such as `AGENTS.md` or the current `.opencode/commands/spec_kit/*.md` docs
...
- Target: GEMINI.md
- Proposed fix: delete `../../../../../GEMINI.md` or replace it with an existing runtime guidance surface such as `AGENTS.md` or the current `.opencode/commands/spec_kit/*.md` docs
...
- Issue: Reference `.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-db.ts` resolves to a missing path.
- Target: .opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-db.ts
- Proposed fix: replace `.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/code-graph-db.ts` with `.opencode/skills/system-spec-kit/mcp_server/code-graph/lib/code-graph-db.ts`
...
- Issue: Reference `.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/ops-hardening.ts` resolves to a missing path.
- Target: .opencode/skills/system-spec-kit/mcp_server/lib/code-graph/ops-hardening.ts
- Proposed fix: replace `.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/ops-hardening.ts` with `.opencode/skills/system-spec-kit/mcp_server/code-graph/lib/ops-hardening.ts`
...
- Issue: Reference `.opencode/skills/system-spec-kit/mcp_server/tests/code-graph-ops-hardening.vitest.ts` resolves to a missing path.
- Target: .opencode/skills/system-spec-kit/mcp_server/tests/code-graph-ops-hardening.vitest.ts
- Proposed fix: replace `.opencode/skills/system-spec-kit/mcp_server/tests/code-graph-ops-hardening.vitest.ts` with `.opencode/skills/system-spec-kit/mcp_server/code-graph/tests/code-graph-ops-hardening.vitest.ts`
...
- Issue: Reference `.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/startup-brief.ts` resolves to a missing path.
- Target: .opencode/skills/system-spec-kit/mcp_server/lib/code-graph/startup-brief.ts
- Proposed fix: replace `.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/startup-brief.ts` with `.opencode/skills/system-spec-kit/mcp_server/code-graph/lib/startup-brief.ts`
...
- Issue: Reference `.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/ensure-ready.ts` resolves to a missing path.
- Target: .opencode/skills/system-spec-kit/mcp_server/lib/code-graph/ensure-ready.ts
- Proposed fix: replace `.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/ensure-ready.ts` with `.opencode/skills/system-spec-kit/mcp_server/code-graph/lib/ensure-ready.ts`
...
- Issue: Reference `.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts` resolves to a missing path.
- Target: .opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts
- Proposed fix: replace `.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts` with `.opencode/skills/system-spec-kit/mcp_server/code-graph/handlers/context.ts`
...
- Issue: Reference `.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts` resolves to a missing path.
- Target: .opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts
- Proposed fix: replace `.opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts` with `.opencode/skills/system-spec-kit/mcp_server/code-graph/handlers/query.ts`
...
- Issue: Reference `.opencode/skills/system-spec-kit/mcp_server/tests/code-graph-query-handler.vitest.ts` resolves to a missing path.
- Target: .opencode/skills/system-spec-kit/mcp_server/tests/code-graph-query-handler.vitest.ts
- Proposed fix: replace `.opencode/skills/system-spec-kit/mcp_server/tests/code-graph-query-handler.vitest.ts` with `.opencode/skills/system-spec-kit/mcp_server/code-graph/tests/code-graph-query-handler.vitest.ts`
...
- Issue: Reference `.opencode/skills/system-spec-kit/mcp_server/tests/code-graph-context` resolves to a missing path.
- Target: .opencode/skills/system-spec-kit/mcp_server/tests/code-graph-context
- Proposed fix: replace `.opencode/skills/system-spec-kit/mcp_server/tests/code-graph-context` with `.opencode/skills/system-spec-kit/mcp_server/code-graph/tests/code-graph-context-handler.vitest.ts`
...
- Issue: Reference `.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/runtime-detection.ts` resolves to a missing path.
- Target: .opencode/skills/system-spec-kit/mcp_server/lib/code-graph/runtime-detection.ts
- Proposed fix: delete `.opencode/skills/system-spec-kit/mcp_server/lib/code-graph/runtime-detection.ts` or replace it with the current existing path
...
- Issue: Reference `.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts` resolves to a missing path.
- Target: .opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts
- Proposed fix: delete `.opencode/skills/system-spec-kit/mcp_server/lib/search/sqlite-fts` or replace it with the current existing path
...
- Issue: Packet command `/spec_kit:handover` is not present in current `.opencode/commands/` inventory.
- Target: Current command inventory under `.opencode/commands/`
- Proposed fix: delete `/spec_kit:handover` or replace it with a current packet command from `.opencode/commands/`
...
- Issue: Packet command `/memory:continue` is not present in current `.opencode/commands/` inventory.
- Target: Current command inventory under `.opencode/commands/`
- Proposed fix: delete `/memory:continue` or replace it with a current packet command from `.opencode/commands/`
...
- File: .opencode/specs/system-spec-kit/024-compact-code-graph/research/iterations/iteration-029.md:34
- Issue: Packet command `/spec_kit:debug` is not present in current `.opencode/commands/` inventory.
- Target: Current command inventory under `.opencode/commands/`
- Proposed fix: delete `/spec_kit:debug` or replace it with a current packet command from `.opencode/commands/`

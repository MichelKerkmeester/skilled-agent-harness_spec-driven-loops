...
3. Clarified OpenCode-first recovery wording in `context-server.ts`, `AGENTS.md`, and `.opencode/agents/context-prime.md`.
...
3. `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/024-compact-code-graph/027-opencode-structural-priming --strict`: PASS (0 errors, 0 warnings)

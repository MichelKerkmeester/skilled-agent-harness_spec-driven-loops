...
- [x] Audit memory commands (`.opencode/commands/memory/`) for compaction references — search, manage, learn all hook-compatible; no changes needed
...
- [x] Update `.opencode/agents/*.md` with hook-injected context awareness and tool fallback

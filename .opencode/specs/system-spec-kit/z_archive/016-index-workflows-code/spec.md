---
title: "Feature Specification: Index Workflows Code [system-spec-kit/z_archive/016-index-workflows-code/spec]"
...
trigger_phrases:
  ...
  - "index workflows code"
  - "archive"
  - "validation"
importance_tier: "normal"
contextType: "general"
---
# Feature Specification: Index Workflows Code
...
| **Status** | Complete |
| **Created** | 2026-03-31 |
| **Branch** | `016-index-workflows-code` |
<!-- /ANCHOR:metadata -->
...
### Problem Statement
This archived system-spec-kit archive folder captures work related to Index Workflows Code. The earlier markdown drifted away from the active templates, which caused validator failures and made the archive harder to trust.
...
### In Scope
- Preserve the archived topic and folder identity for Index Workflows Code.
...
|----|-------------|---------------------|
| REQ-001 | The archive must clearly state that the folder documents Index Workflows Code. | A maintainer can identify the archived topic from spec.md without opening other files. |

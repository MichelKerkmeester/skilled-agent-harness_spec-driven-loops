---
title: "Checklist [system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/025-system-memory-rename/checklist]"
...
- [x] **P2-1:** Historical references preserved in specs/
  - Scope: `.opencode/specs/system-spec-kit/z_archive/001-fix-command-dispatch/z_archive`, `.opencode/specs/system-spec-kit/z_archive/001-fix-command-dispatch/z_archive`, `specs/008-*`
...
- [ ] **P2-5:** Memory context saved
  - File: `.opencode/specs/system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/025-system-memory-rename/memory*.md`

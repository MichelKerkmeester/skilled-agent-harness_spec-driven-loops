---
title: "Spec: Rename workflows [system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/025-system-memory-rename/spec]"
...
| `sk-doc/SKILL.md` | 1 | 448 |
| `sk-doc/references/quick_reference.md` | 1 | 187 |
| `sk-doc/assets/frontmatter_templates.md` | 1 | 25 |
| `sk-doc/assets/skill_md_template.md` | 1 | 987 |
...
|----------|--------------|
| `.opencode/specs/system-spec-kit/z_archive/001-fix-command-dispatch/z_archive` | ~10 |
| `.opencode/specs/system-spec-kit/z_archive/001-fix-command-dispatch/z_archive` | ~40 |
| `.opencode/specs/system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/007-system-spec-kit-rename` | ~5 |
...
- Previous rename: `.opencode/specs/03--commands-and-skills/z_archive/002-doc-skill-rename`
- Previous rename: `.opencode/specs/system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/007-system-spec-kit-rename`

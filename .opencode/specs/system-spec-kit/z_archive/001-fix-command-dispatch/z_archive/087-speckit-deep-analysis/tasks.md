---
title: "Tasks: System-Spec-Ki [system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/087-speckit-deep-analysis/tasks]"
...
- [x] T032 [P] Replace AGENTS.md in `research/research.md` (2 locations)
- [x] T033 [P] Replace AGENTS.md in `plan.md` (3 locations)
- [x] T034 [P] Replace AGENTS.md in `agent/research/research/research.md` (1 location)

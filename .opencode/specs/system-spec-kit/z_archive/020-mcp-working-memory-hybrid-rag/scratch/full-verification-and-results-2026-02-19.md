...
```bash
npx tsx scripts/evals/deleted-phase1-5-shadow-eval-script "/Users/michelkerkmeester/MEGA/Development/Opencode Env/Public/.opencode/specs/system-spec-kit/020-mcp-working-memory-hybrid-rag"
```
...
```bash
node scripts/evals/run-phase2-closure-metrics.mjs "/Users/michelkerkmeester/MEGA/Development/Opencode Env/Public/.opencode/specs/system-spec-kit/020-mcp-working-memory-hybrid-rag"
```
...
```bash
npx tsx scripts/evals/deleted-phase3-telemetry-dashboard-script "/Users/michelkerkmeester/MEGA/Development/Opencode Env/Public/.opencode/specs/system-spec-kit/020-mcp-working-memory-hybrid-rag"
```
...
3. **TOC casing enforcement in context template and generated memories**
   ...
   - Verify representative generated memory files use uppercase TOC labels:
     ...
     - `.opencode/specs/system-spec-kit/020-mcp-working-memory-hybrid-rag/002-extraction-rollout-phases-2-3/memory/`
     - `.opencode/specs/system-spec-kit/020-mcp-working-memory-hybrid-rag/003-memory-quality-qp-0-4/memory/`

4. **Lane-level KPI/eval outputs remain healthy**
   - Re-run the 3 eval commands above.
   - Confirm output artifacts update in:
     - `.opencode/specs/system-spec-kit/020-mcp-working-memory-hybrid-rag/scratch/phase1-5-eval-results.md`
     - `.opencode/specs/system-spec-kit/020-mcp-working-memory-hybrid-rag/scratch/phase2-closure-metrics.json`
     - `.opencode/specs/system-spec-kit/020-mcp-working-memory-hybrid-rag/scratch/phase3-telemetry-dashboard.md`

5. **Checklist/task closure consistency in root + package docs**
   - Confirm no unchecked boxes remain where closure was requested.
   - Primary files:
     - `.opencode/specs/system-spec-kit/020-mcp-working-memory-hybrid-rag/tasks.md`
     - `.opencode/specs/system-spec-kit/020-mcp-working-memory-hybrid-rag/checklist.md`
     - `.opencode/specs/system-spec-kit/020-mcp-working-memory-hybrid-rag/001-foundation-phases-0-1-1-5/tasks.md`
     - `.opencode/specs/system-spec-kit/020-mcp-working-memory-hybrid-rag/001-foundation-phases-0-1-1-5/checklist.md`
     - `.opencode/specs/system-spec-kit/020-mcp-working-memory-hybrid-rag/002-extraction-rollout-phases-2-3/tasks.md`
     - `.opencode/specs/system-spec-kit/020-mcp-working-memory-hybrid-rag/002-extraction-rollout-phases-2-3/checklist.md`
     - `.opencode/specs/system-spec-kit/020-mcp-working-memory-hybrid-rag/003-memory-quality-qp-0-4/tasks.md`
     - `.opencode/specs/system-spec-kit/020-mcp-working-memory-hybrid-rag/003-memory-quality-qp-0-4/checklist.md`

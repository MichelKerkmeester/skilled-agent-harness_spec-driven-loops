...
> Spec folder: `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/013-fts5-fix-and-search-dashboard` (Level 2)
...
| File | Changes |
| ---- | ------- |
| `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/changelog/changelog-013-fts5-fix-and-search-dashboard.md` | Adds the missing changelog entry for the completed phase. |

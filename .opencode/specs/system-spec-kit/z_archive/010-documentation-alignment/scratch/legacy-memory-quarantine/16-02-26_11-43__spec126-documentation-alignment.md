...
| Spec Folder | ../.opencode/specs/system-spec-kit/127-spec126-documentation-alignment |
| Channel | main |
...
```
/spec_kit:resume ../.opencode/specs/system-spec-kit/127-spec126-documentation-alignment
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: ../.opencode/specs/system-spec-kit/127-spec126-documentation-alignment
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume ../.opencode/specs/system-spec-kit/127-spec126-documentation-alignment` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "../.opencode/specs/system-spec-kit/127-spec126-documentation-alignment" })` |
...
ls -la ../.opencode/specs/system-spec-kit/127-spec126-documentation-alignment/memory/
...
spec_folder: "../.opencode/specs/system-spec-kit/127-spec126-documentation-alignment"
channel: "main"
...
parent_spec: "../.opencode/specs/system-spec-kit/127-spec126-documentation-alignment"
child_sessions:

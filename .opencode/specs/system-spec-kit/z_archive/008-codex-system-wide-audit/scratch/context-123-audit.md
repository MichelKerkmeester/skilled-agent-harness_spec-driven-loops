...
**Subject**: `.opencode/specs/system-spec-kit/z_archive/006-generate-context-subfolder`  
...
- ✅ **AGENTS.md**: Memory save rule updated with subfolder examples (lines 210-216):
  ...
  node [script] system-spec-kit/121-child-name
...
node scripts/tests/test-subfolder-resolution.js 2>&1 | tee ../specs/system-spec-kit/z_archive/006-generate-context-subfolder/scratch/test-results.txt

# Step 3: Manual verification (spot-check 3 formats)
node scripts/dist/memory/generate-context.js system-spec-kit/121-child-name
node scripts/dist/memory/generate-context.js 121-child-name  
node scripts/dist/memory/generate-context.js specs/system-spec-kit/121-child-name
```

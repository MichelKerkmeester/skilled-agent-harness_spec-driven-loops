...
✗ Run skill advisor (shell)
  │ python3 .opencode/skills/scripts/skill_advisor.py "Deep audit of Spec Kit Memory MCP server
...
● Search (glob)
  │ ".opencode/skills/system-spec-kit/**/spec.md"
  └ 87 files found
...
✗ Read eslint.config.js
  │ .opencode/skills/system-spec-kit/mcp_server/eslint.config.js
  └ Path does not exist
...
● Search (grep)
  │ "\.test\.ts$|\.spec\.ts$" in **/* (.opencode/skills/system-spec-kit/mcp_server/tests)
  └ No matches found
...
● Search (grep)
  ...
  │ arate|supersede|complement" in **/*.{ts,md,json} (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found

● Search (grep)
  │ "Feature catalog:|MODULE:" in **/*.{ts,md} (.opencode/skills/system-spec-kit)
  └ 5 lines found
...
● Search (grep)
  │ "@deprecated" in **/*.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 1 file found

● Search (grep)
  │ "Feature catalog:|MODULE:" in **/*.{ts,md} (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 files found

● Search (glob)
  │ ".opencode/skills/system-spec-kit/mcp_server/**/*{shadow,calibration,reconsolidation,contiguity,f
...
● Search (glob)
  │ ".opencode/skills/system-spec-kit/mcp_server/**/ARCHITECTURE.md"
  └ No matches found
...
● Search (grep)
  │ "ARCHITECTURE\.md" in **/* (.opencode/skills/system-spec-kit)
  └ 14 files found
...
● Read 15-graph-calibration-profiles.md
  │ .opencode/skills/system-spec-kit/feature_catalog/10--graph-signal-activation/15-graph-calibration
  │ -profiles.md
  └ 47 lines read
...
● Read 23-hybrid-decay-policy.md
  │ .opencode/skills/system-spec-kit/feature_catalog/13--memory-quality-and-indexing/23-hybrid-decay-
  │ policy.md
  └ 53 lines read
...
● Read assistive-reconsolidation.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/assistive-reconsolidation.vitest.ts
  └ L1:220 (220 lines read)
...
● Read shadow-scoring-holdout.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/shadow-scoring-holdout.vitest.ts
...
● Read shadow-scoring.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/shadow-scoring.vitest.ts
  └ L230:390 (161 lines read)
...
● Search (grep)
  │ "\.ts$" in **/* (.opencode/skills/system-spec-kit/mcp_server/tests)
  └ 11 files found

● Search (grep)
  │ "module\.exports|require\(" in **/*.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 21 files found
...
- Evidence: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/007-code-audit-per-feature-catalog/010-graph-signal-activation/spec.md:190,199-200`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts:28-30,41-42`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:181-186`; `.opencode/skills/system-spec-kit/mcp_server/tests/temporal-contiguity.vitest.ts:1-10,59-73`
...
- Evidence: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/007-code-audit-per-feature-catalog/010-graph-signal-activation/spec.md:194,199-200`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:67,776-778`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:371-374`; `.opencode/skills/system-spec-kit/mcp_server/tests/graph-calibration.vitest.ts:75-103`
...
- Evidence: `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/007-code-audit-per-feature-catalog/013-memory-quality-and-indexing/spec.md:212`; `.opencode/skills/system-spec-kit/feature_catalog/FEATURE_CATALOG.md:2934,4391`; `.opencode/skills/system-spec-kit/feature_catalog/13--memory-quality-and-indexing/21-assistive-reconsolidation.md:20-30`; `.opencode/skills/system-spec-kit/mcp_server/handlers/save/reconsolidation-bridge.ts:69-75`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:479-485`; `.opencode/skills/system-spec-kit/mcp_server/tests/assistive-reconsolidation.vitest.ts:22-25`
...
- Evidence: `.opencode/skills/system-spec-kit/mcp_server/lib/search/graph-calibration.ts:12,166-169`; `.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:371-374`; `.opencode/skills/system-spec-kit/mcp_server/tests/graph-calibration.vitest.ts:75-103`
...
- Evidence: `.opencode/skills/system-spec-kit/feature_catalog/FEATURE_CATALOG.md:3746-3750`; `.opencode/skills/system-spec-kit/feature_catalog/16--tooling-and-scripts/15-module-boundary-map.md:17-18,27-33`; `.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md:21-24,179,337`; `.opencode/skills/system-spec-kit/mcp_server/lib/MODULE_MAP.md` has 28 top-level `### \`...\`` entries
...
- Maintainability: TypeScript strict mode and package/module structure look aligned (`.opencode/skills/system-spec-kit/tsconfig.json:6`; `mcp_server/api/index.ts:4-6`). Sampled public APIs in reviewed files do have JSDoc; the dominant problem is **documentation drift**, not missing typing.

...
| Field | Value |
|-------|-------|
| **Catalog Entry** | `.opencode/skills/system-spec-kit/feature_catalog/20--remediation-revalidation/01-category-stub.md` |
| **Verdict** | MATCH |

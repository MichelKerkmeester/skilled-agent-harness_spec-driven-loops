...
● Route skills for research audit (shell)
  │ python3 .opencode/skills/scripts/skill_advisor.py "Deep research iteration 20/20 on
  │ hybrid-rag-fusion system at .opencode/skills/system-spec-kit/mcp_server/lib/search/. Focus: gap
...
● Search (grep)
  ...
  │ cs\(|searchWithFallback\(" in **/*.{ts,md} (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found
...
● Explore Verifying search findings
  ...
  │   │ Env/Public/.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts"
  │   └ 42 lines...

...
● Search (glob)
  │ "**/lib/search/**/*" in .opencode/skills/system-spec-kit/mcp_server
  └ 58 files found
...
● Search (grep)
  ...
  │ **/*.{ts,md} (.opencode/skills/system-spec-kit/mcp_server/lib/search)
  └ 58 lines found
...
● Search (grep)
  ...
  │ elineMetadata" in **/*.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 58 lines found
...
● Search (grep)
  │ "SPECKIT_PIPELINE_V2" in **/*.{ts,md} (.opencode/skills/system-spec-kit/mcp_server)
  └ 15 lines found
...
● Search (grep)
  ...
  │ oosts" in **/*.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 15 lines found

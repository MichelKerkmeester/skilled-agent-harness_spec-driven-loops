...
- [x] T004 [P] Update conversation summary wording for phase segments and unique phase count (REQ-005) (`.opencode/skills/system-spec-kit/templates/context_template.md`)
<!-- /ANCHOR:phase-1 -->

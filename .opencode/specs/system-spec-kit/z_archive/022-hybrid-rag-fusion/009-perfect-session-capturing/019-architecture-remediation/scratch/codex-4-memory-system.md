1. `CODEX4-001`  
Severity: High. Category: Concurrency / TOCTOU. File: [cleanup-orphaned-vectors.ts](/Users/michelkerkmeester/MEGA/Development/Opencode%20Env/Public/.opencode/skills/system-spec-kit/scripts/memory/cleanup-orphaned-vectors.ts#L84)  
...
2. `CODEX4-002`  
Severity: Medium. Category: Data Loss / TOCTOU. File: [historical-memory-remediation.ts](/Users/michelkerkmeester/MEGA/Development/Opencode%20Env/Public/.opencode/skills/system-spec-kit/scripts/memory/historical-memory-remediation.ts#L706)  
...
3. `CODEX4-003`  
Severity: Medium. Category: JSON Validation. File: [rank-memories.ts](/Users/michelkerkmeester/MEGA/Development/Opencode%20Env/Public/.opencode/skills/system-spec-kit/scripts/memory/rank-memories.ts#L386)  
...
4. `CODEX4-004`  
Severity: Medium. Category: Silent Error Swallowing / Validation Gap. File: [validate-memory-quality.ts](/Users/michelkerkmeester/MEGA/Development/Opencode%20Env/Public/.opencode/skills/system-spec-kit/scripts/memory/validate-memory-quality.ts#L617)  
...
5. `CODEX4-005`  
Severity: Medium. Category: Silent Failure / Result Validation. File: [reindex-embeddings.ts](/Users/michelkerkmeester/MEGA/Development/Opencode%20Env/Public/.opencode/skills/system-spec-kit/scripts/memory/reindex-embeddings.ts#L76)  
...
6. `CODEX4-006`  
Severity: Medium. Category: Silent Coverage Loss. File: [backfill-frontmatter.ts](/Users/michelkerkmeester/MEGA/Development/Opencode%20Env/Public/.opencode/skills/system-spec-kit/scripts/memory/backfill-frontmatter.ts#L240)  
...
7. `CODEX4-007`  
Severity: Low. Category: JSON Mode UX / Hanging Input Path. File: [generate-context.ts](/Users/michelkerkmeester/MEGA/Development/Opencode%20Env/Public/.opencode/skills/system-spec-kit/scripts/memory/generate-context.ts#L322)  
...
I did not find a direct recovery-mode bypass in `generate-context.ts`: `--recovery` is rejected for structured JSON input, and downstream folder detection keeps explicit CLI targets authoritative. No material issues stood out in [ast-parser.ts](/Users/michelkerkmeester/MEGA/Development/Opencode%20Env/Public/.opencode/skills/system-spec-kit/scripts/memory/ast-parser.ts) or [rebuild-auto-entities.ts](/Users/michelkerkmeester/MEGA/Development/Opencode%20Env/Public/.opencode/skills/system-spec-kit/scripts/memory/rebuild-auto-entities.ts) during this pass.
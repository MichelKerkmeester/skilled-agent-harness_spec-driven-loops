...
● Search (grep)
  ...
  │ (|_isSimulation" (.opencode/skills/system-spec-kit/scripts/loaders/data-loader.ts)
  └ 13 lines found
...
● Search (grep)
  │ "prefersStructuredSave" (.opencode/skills/system-spec-kit/scripts)
  └ 9 lines found
...
● Search (grep)
  ...
  │ ource" (.opencode/skills/system-spec-kit/scripts/core/workflow.ts)
  └ 5 lines found

● Search (grep)
  │ "enum\s+|SourceInputMode|KnownDataSource|SourceCapabilities|isKnownDataSource\(|getSourceCapabil
  │ ities\(" (.opencode/skills/system-spec-kit/scripts/utils/source-capabilities.ts)
  └ 10 lines found

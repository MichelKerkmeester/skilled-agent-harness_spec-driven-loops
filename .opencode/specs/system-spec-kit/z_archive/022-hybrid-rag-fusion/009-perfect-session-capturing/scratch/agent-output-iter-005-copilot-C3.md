...
● Search (grep)
  ...
  │ ontamination-filter.ts,core/quality-scorer.ts} (.opencode/skills/system-spec-kit/scripts)
  └ No matches found
...
● Search (grep)
  ...
  │ |template" (.opencode/skills/system-spec-kit/scripts/core/workflow.ts)
  └ 74 lines found
...
● Search (grep)
  ...
  │ ave|toolTitleWithPathExpected" (.opencode/skills/system-spec-kit/scripts/core/workflow.ts)
  └ 7 lines found
...
● Search (grep)
  ...
  │ tionDisposition" (.opencode/skills/system-spec-kit/scripts/core/workflow.ts)
  └ 12 lines found
...
✗ Search (grep)
  ...
  │ (.opencode/skills/system-spec-kit/scripts/extractors/{claude-code-capture.ts,codex-cli-capture.ts
  │ ,copilot-cli-capture.ts,gemini-cli-capture.ts})
  └ rg: /Users/michelkerkmeester/MEGA/Development/Opencode
    Env/Public/.opencode/skills/system-spec-kit/scripts/extractors/{claude-code-capture.ts,codex-cli-
...
● Read task-enrichment.ts
  │ .opencode/skills/system-spec-kit/scripts/utils/task-enrichment.ts

...
● Search (grep)
  ...
  │ pture" (.opencode/skills/system-spec-kit/scripts/extractors/contamination-filter.ts)
  └ No matches found
...
● Search (grep)
  ...
  │ pilot|gemini" (.opencode/skills/system-spec-kit/scripts/memory/validate-memory-quality.ts)
  └ 2 lines found

● Search (grep)
  │ "captureCapabilities|getSourceCapabilities|prefersStructuredSave|inputMode|toolTitleWithPathExpe
  │ cted|claude|codex|copilot|gemini" (.opencode/skills/system-spec-kit/scripts/core/workflow.ts)
  └ 4 lines found
...
● Search (grep)
  ...
  │ path|contamination" (.opencode/skills/system-spec-kit/scripts/extractors/opencode-capture.ts)
  └ No matches found

● Search (glob)
  │ "**/*opencode-capture*.vitest.ts" in .opencode/skills/system-spec-kit/scripts/tests
  └ 1 file found
...
● Search (grep)
  ...
  │ apture" (.opencode/skills/system-spec-kit/scripts/extractors/opencode-capture.ts)
  └ No matches found
...
● Search (grep)
  ...
  │ **/*-capture.ts (.opencode/skills/system-spec-kit/scripts/extractors)
  └ 4 lines found
...
● Search (grep)
  ...
  │ ource\s*===\s*'gemini-cli-capture'" in **/*.ts (.opencode/skills/system-spec-kit/scripts)
  └ No matches found
...
● Search (grep)
  ...
  │ 'stateless'|prefersStructuredSave" in **/*.ts (.opencode/skills/system-spec-kit/scripts)
  └ 33 lines found
...
● Search (grep)
  ...
  │ xSeverity" (.opencode/skills/system-spec-kit/scripts/core/workflow.ts)
  └ 25 lines found

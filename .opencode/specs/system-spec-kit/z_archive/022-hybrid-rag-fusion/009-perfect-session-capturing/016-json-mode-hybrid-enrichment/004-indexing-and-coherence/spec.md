...
_memory:
  continuity:
    packet_pointer: "system-spec-kit/022-hybrid-rag-fusion/009-perfect-session-capturing/016-json-mode-hybrid-enrichment/004-indexing-and-coherence"
...
**Acceptance Criteria**:
1. Given a session with spec folder path "system-spec-kit/022-hybrid-rag-fusion", When trigger phrases are extracted and filtered, Then phrases like "system spec kit/022 hybrid rag fusion" and tokens like "of", "the", "22" are excluded from the output

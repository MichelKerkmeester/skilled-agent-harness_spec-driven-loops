...
2. **`extractors/quality-scorer.ts`** (new, V-rule-based) -- Uses a 1.0 subtractive model. Score starts at 1.0, then subtracts severity-weighted penalties for each failed V-rule. Adds bonuses for messageCount (+0.05), toolCount (+0.05), decisionCount (+0.10).
   [SOURCE: .opencode/skills/system-spec-kit/scripts/extractors/quality-scorer.ts:72-231]
...
3. **`core/post-save-review.ts`** -- A post-hoc comparison layer that detects field drift between the JSON payload and saved file. Does not produce a numeric score but surfaces HIGH/MEDIUM/LOW issues.
   [SOURCE: .opencode/skills/system-spec-kit/scripts/core/post-save-review.ts:204-346]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/lib/validate-memory-quality.ts:42-139]
[SOURCE: .opencode/skills/system-spec-kit/scripts/extractors/quality-scorer.ts:44-48]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/extractors/quality-scorer.ts:195-205]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/core/quality-scorer.ts:58-84]
[SOURCE: .opencode/skills/system-spec-kit/scripts/extractors/quality-scorer.ts (entire file -- no description logic)]
...
[SOURCE: .opencode/specs/system-spec-kit/022-hybrid-rag-fusion/009-perfect-session-capturing/016-json-mode-hybrid-enrichment/memory/20-03-26_11-38__implemented-4-json-mode-memory-save-quality-gap.md:46-48]
...
[SOURCE: .opencode/skills/system-spec-kit/scripts/core/quality-scorer.ts:262-278]
[SOURCE: .opencode/skills/system-spec-kit/scripts/extractors/quality-scorer.ts:159-171]
...
[SOURCE: .opencode/specs/system-spec-kit/022-hybrid-rag-fusion/009-perfect-session-capturing/016-json-mode-hybrid-enrichment/memory/20-03-26_11-38__implemented-4-json-mode-memory-save-quality-gap.md:31-36]

## Sources Consulted
- `.opencode/skills/system-spec-kit/scripts/core/quality-scorer.ts` (321 lines, full read)
- `.opencode/skills/system-spec-kit/scripts/extractors/quality-scorer.ts` (247 lines, full read)
- `.opencode/skills/system-spec-kit/scripts/lib/validate-memory-quality.ts` (732 lines, full read)
- `.opencode/skills/system-spec-kit/scripts/core/post-save-review.ts` (383 lines, full read)

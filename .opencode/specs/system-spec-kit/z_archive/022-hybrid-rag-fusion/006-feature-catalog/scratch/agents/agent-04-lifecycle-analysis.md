...
● Search (glob)
  │ ".opencode/skills/system-spec-kit/feature_catalog/{05--lifecycle,06--analysis}/*.md"
  └ 14 files found
...
● Run skill advisor (shell)
  ...
  │ .opencode/skills/system-spec-kit/feature_catalog/05--lifecycle/ and 06--analysis/, compare
  │ described tool names and parameters against implementations in
  │ .opencode/skills/system-spec-kit/scripts/, and flag mismatches per file with a summary."
  │ --threshold 0.8
  └ 35 lines...
...
● Read 01-checkpoint-creation-checkpointcreate.md
  │ .opencode/skills/system-spec-kit/feature_catalog/05--lifecycle/01-checkpoint-creation-checkpointc
  │ reate.md
  └ 149 lines read
...
● Read 04-checkpoint-deletion-checkpointdelete.md
  │ .opencode/skills/system-spec-kit/feature_catalog/05--lifecycle/04-checkpoint-deletion-checkpointd
  │ elete.md
  └ 144 lines read

● Read 05-async-ingestion-job-lifecycle.md
  │ .opencode/skills/system-spec-kit/feature_catalog/05--lifecycle/05-async-ingestion-job-lifecycle.m
  │ d
  └ 133 lines read

● Read 06-startup-pending-file-recovery.md
  │ .opencode/skills/system-spec-kit/feature_catalog/05--lifecycle/06-startup-pending-file-recovery.m
  │ d
  └ 48 lines read
...
● Read 01-causal-edge-creation-memorycausallink.md
  │ .opencode/skills/system-spec-kit/feature_catalog/06--analysis/01-causal-edge-creation-memorycausa
  │ llink.md
  └ 149 lines read

● Read 02-causal-graph-statistics-memorycausalstats.md
  │ .opencode/skills/system-spec-kit/feature_catalog/06--analysis/02-causal-graph-statistics-memoryca
  │ usalstats.md
  └ 148 lines read

● Read 03-causal-edge-deletion-memorycausalunlink.md
  │ .opencode/skills/system-spec-kit/feature_catalog/06--analysis/03-causal-edge-deletion-memorycausa
  │ lunlink.md
  └ 144 lines read

● Read 04-causal-chain-tracing-memorydriftwhy.md
  │ .opencode/skills/system-spec-kit/feature_catalog/06--analysis/04-causal-chain-tracing-memorydrift
  │ why.md
  └ 152 lines read

● Read 05-epistemic-baseline-capture-taskpreflight.md
  │ .opencode/skills/system-spec-kit/feature_catalog/06--analysis/05-epistemic-baseline-capture-taskp
  │ reflight.md
  └ 143 lines read

● Read 06-post-task-learning-measurement-taskpostflight.md
  │ .opencode/skills/system-spec-kit/feature_catalog/06--analysis/06-post-task-learning-measurement-t
  │ askpostflight.md
  └ 145 lines read

● Read 07-learning-history-memorygetlearninghistory.md
  │ .opencode/skills/system-spec-kit/feature_catalog/06--analysis/07-learning-history-memorygetlearni
  │ nghistory.md
  └ 145 lines read
...
● Search (grep)
  ...
  │ ate-edge.vitest.ts} (.opencode/skills/system-spec-kit/mcp_server)
  └ No matches found
...
● Search (grep)
  ...
  │ sts/learning-stats-filters.vitest.ts} (.opencode/skills/system-spec-kit/mcp_server)
  └ No matches found
...
● Search (grep)
  ...
  │ led|cancelled" (.opencode/skills/system-spec-kit/mcp_server/lib/ops/job-queue.ts)
  └ 78 lines found
...
● Search (grep)
  ...
  │ 'Strong learning trend|metadata" (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found

✗ Read memory-mutate.ts
  │ .opencode/skills/system-spec-kit/mcp_server/handlers/memory-mutate.ts
  └ Path does not exist
...
● Search (grep)
  │ "deleteEdgesForMemory\(" (.opencode/skills/system-spec-kit/mcp_server)
  └ 13 lines found

● Search (grep)
  │ "handleMemoryDelete|memory_delete" (.opencode/skills/system-spec-kit/mcp_server/handlers)
  └ 7 files found

● Search (glob)
  │ "**/*memory*delete*.ts" in .opencode/skills/system-spec-kit/mcp_server/handlers
  └ 2 files found
...
Note: none of these runtime tool names are defined under `.opencode/skills/system-spec-kit/scripts/`; the authoritative contracts are in `mcp_server/tool-schemas.ts`, `schemas/tool-input-schemas.ts`, and handlers.

● List directory .opencode/skills/system-spec-kit/feature_catalog/01--retrieval/
  └ 11 files found
...
● Run skill advisor and create session plan (shell)
  ...
  │ .opencode/skills/system-spec-kit/feature_catalog/01--retrieval/ for alignment with described
  │ tool/feature names and parameters in .opencode/skills/system-spec-kit/scripts/ source code"
...
● Search (glob)
  │ "**/*" in .opencode/skills/system-spec-kit/scripts
  └ 5 files found
...
● Search (glob)
  │ "**/*.{ts,js,sh}" in .opencode/skills/system-spec-kit/scripts
  └ 5 files found
...
● Search (grep)
  ...
  │ ggerPhrases|BM25|pipeline|resume" in **/*.{ts,js,sh} (.opencode/skills/system-spec-kit/scripts)
  └ 5 lines found
...
● Search (grep)
  │ "\bmemory_context\b" in **/*.{ts,js,sh,md,json,jsonc} (.opencode/skills/system-spec-kit/scripts)
  └ 1 line found

● Search (grep)
  │ "\bmemory_search\b" in **/*.{ts,js,sh,md,json,jsonc} (.opencode/skills/system-spec-kit/scripts)
  └ 1 line found
...
● Search (grep)
  ...
  │ **/*.{ts,js,sh,md,json,jsonc} (.opencode/skills/system-spec-kit/scripts)
  └ No matches found
...
● Search (grep)
  ...
  │ t" in **/*.{ts,js,sh,md,json,jsonc} (.opencode/skills/system-spec-kit/scripts)
  └ 3 lines found
...
● Read test-export-contracts.js
  │ .opencode/skills/system-spec-kit/scripts/tests/test-export-contracts.js
...
● Search (grep)
  ...
  │ in **/*.{ts,js,sh} (.opencode/skills/system-spec-kit/scripts)
  └ No matches found
...
● Search (grep)
  ...
  │ e|concepts|autoDetectIntent|query" in **/*.ts (.opencode/skills/system-spec-kit/scripts/evals)
  └ 38 lines found

● Search (grep)
  │ "memory_context|memory_search|memory_match_triggers|memory_quick_search|memory_list|memory_stats
  │ " in **/*.ts (.opencode/skills/system-spec-kit/scripts/evals)
  └ No matches found
...
● Explore Cross-checking audit
  ...
  └ Search for MCP tool names in scripts (shell)
      ...
      │ Env/Public/.opencode/skills/system-spec-kit/scripts" --include="*.ts" --include="*.js"
...
Assessed against `.opencode/skills/system-spec-kit/scripts/` only. Most docs describe `mcp_server` runtime features, not `scripts/` implementations.

...
● Run skill advisor (shell)
  ...
  │ .opencode/skills/system-spec-kit/feature_catalog/02--mutation/ against mcp_server
...
● Search (glob)
  │ ".opencode/skills/system-spec-kit/scripts/**/*.py"
  └ 1 file found
...
● Search (grep)
  ...
  │ matcher|constitutional cache" in *.ts (.opencode/skills/system-spec-kit/mcp_server/handlers)
  └ 4 lines found
...
● Search (grep)
  ...
  │ ble" (.opencode/skills/system-spec-kit/mcp_server/schemas/tool-input-schemas.ts)
  └ 8 lines found
...
● Search (grep)
  ...
  │ (.opencode/skills/system-spec-kit/mcp_server/lib/scoring/negative-feedback.ts)
  └ 13 lines found

● Search (grep)
  │ "recordUserSelection|recordSelection|learned_triggers|groundTruthSelectionId|queryTerms|resultRa
  │ nk" in *.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found

● Search (glob)
  │ ".opencode/skills/system-spec-kit/mcp_server/lib/learning/**/*.ts"
  └ 2 files found
...
● Search (grep)
  ...
  │ *.{ts,js,py} (.opencode/skills/system-spec-kit/scripts)
  └ 5 lines found
...
● Search (grep)
  │ "clearSearchCache|clear_search_cache" in *.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 20 lines found
...
● Search (grep)
  ...
  │ (.opencode/skills/system-spec-kit/mcp_server/lib/storage/document-helpers.ts)
  └ 12 lines found
...
● Search (grep)
  │ "appendMutationLedgerSafe\(" in *.ts (.opencode/skills/system-spec-kit/mcp_server/handlers/save)
  └ 4 lines found

● Search (grep)
  │ "appendMutationLedgerSafe\(" (.opencode/skills/system-spec-kit/mcp_server/handlers/pe-gating.ts)
  └ No matches found
...
● Search (grep)
  ...
  │ ared_memory_enable" in *.{ts,js,py} (.opencode/skills/system-spec-kit/scripts)
  └ No matches found
...
● Search (grep)
  ...
  │ ed_memories" in *.ts (.opencode/skills/system-spec-kit/mcp_server/handlers)
  └ 39 lines found

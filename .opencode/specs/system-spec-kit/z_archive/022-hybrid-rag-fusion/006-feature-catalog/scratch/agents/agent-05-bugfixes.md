...
● Run skill advisor (shell)
  ...
  │ .opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/ and compare
  │ described features against .opencode/skills/system-spec-kit/mcp_server and
  │ .opencode/skills/system-spec-kit/scripts source code" --threshold 0.8
  └ 59 lines...
...
● Read 02-chunk-collapse-deduplication.md
  │ .opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/02-chunk-collap
  │ se-deduplication.md
  └ 48 lines read

● Read 01-graph-channel-id-fix.md
  │ .opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/01-graph-channe
  │ l-id-fix.md
  └ 55 lines read

● Read 03-co-activation-fan-effect-divisor.md
  │ .opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/03-co-activatio
...
● Read 05-database-and-schema-safety.md
  │ .opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/05-database-and
  │ -schema-safety.md
  └ 59 lines read
...
● Read 07-canonical-id-dedup-hardening.md
  │ .opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/07-canonical-id
  │ -dedup-hardening.md
  └ 43 lines read
...
● Read 09-session-manager-transaction-gap-fixes.md
  │ .opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/09-session-mana
  │ ger-transaction-gap-fixes.md
  └ 62 lines read

● Read 10-chunking-orchestrator-safe-swap.md
  │ .opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/10-chunking-orc
  │ hestrator-safe-swap.md
  └ 42 lines read

● Read 11-working-memory-timestamp-fix.md
  │ .opencode/skills/system-spec-kit/feature_catalog/08--bug-fixes-and-data-integrity/11-working-memo
  │ ry-timestamp-fix.md
  └ 43 lines read
...
● Search (grep)
  │ "Math\.(max|min)\(\.\.\." in **/*.{ts,js} (.opencode/skills/system-spec-kit/mcp_server)
  └ 17 lines found
...
● Search (grep)
  ...
  │ t|cleanupOldSessions|chunking" in **/*.{ts,js,py,sh} (.opencode/skills/system-spec-kit/scripts)
  └ 5 lines found

...
● List directory .opencode/skills/system-spec-kit/feature_catalog/10--graph-signal-activation
  └ 16 files found
...
● Search (glob)
  │ ".opencode/skills/system-spec-kit/feature_catalog/10--graph-signal-activation/*.md"
  └ 16 files found
...
✗ Read all feature catalog markdown files (shell)
  ...
  │ .opencode/skills/system-spec-kit/feature_catalog/10--graph-signal-activation/*.md; do printf
...
● Search (grep)
  ...
  │ **/*.{ts,js,mjs,cjs,py,sh,json} (.opencode/skills/system-spec-kit/scripts)
  └ 81 files found

● Search (grep)
  │ "causal|co-activation|coactivation|contiguity|community|traversal|anchor|momentum|density|backfi
  │ ll|calibration|rollback|degree|neighbor boost|signal activation|graph" in
  │ **/*.{ts,js,mjs,cjs,py,sh,json} (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 files found
...
● Print feature catalog markdown contents (shell)
  ...
  │ Env/Public/.opencode/skills/system-spec-kit/feature_catalog/10--graph-signal-activation')
...
● Search (grep)
  ...
  │ RAL_CONTIGUITY" in **/*.{ts,js} (.opencode/skills/system-spec-kit/mcp_server)
  └ 23 lines found

● Search (grep)
  │ "MAX_TYPED_DEGREE|MAX_TOTAL_DEGREE|DEGREE_BOOST_CAP|getDegreeCacheForDb|clearDegreeCacheForDb|SP
  │ ECKIT_DEGREE_BOOST|constitutional" in **/*.{ts,js} (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found
...
● Search (grep)
  ...
  │ **/*.{ts,js,py,sh,json} (.opencode/skills/system-spec-kit/scripts)
  └ 21 lines found
...
● Read community-detection.ts
  │ .opencode/skills/system-spec-kit/mcp_server/lib/graph/community-detection.ts
  └ L1:320 (320 lines read)
...
● Read graph-calibration.ts
  │ .opencode/skills/system-spec-kit/mcp_server/lib/search/graph-calibration.ts
  └ L1:260 (260 lines read)

● Search (grep)
  │ "MAX_COMBINED_BOOST|SPECKIT_TYPED_TRAVERSAL|INTENT_EDGE_PRIORITY|SPARSE_DENSITY_THRESHOLD|SPARSE
  │ _MAX_HOPS" (.opencode/skills/system-spec-kit/mcp_server/tests/typed-traversal.vitest.ts)
  └ 33 lines found
...
● Read retrieval-telemetry.ts
  │ .opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts
  └ L1:260 (260 lines read)
...
● Search (grep)
  ...
  │ (.opencode/skills/system-spec-kit/mcp_server/tests/temporal-contiguity.vitest.ts)
  └ 13 lines found
...
● Read graph-roadmap-finalization.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/graph-roadmap-finalization.vitest.ts
  └ L1:260 (217 lines read)

● Read typed-traversal.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/typed-traversal.vitest.ts
...
● Read graph-lifecycle.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/graph-lifecycle.vitest.ts
  └ L1:320 (320 lines read)
...
● Search (grep)
  ...
  │ threshold" (.opencode/skills/system-spec-kit/mcp_server/lib/eval/edge-density.ts)
  └ 4 lines found
...
● Read edge-density.ts
  │ .opencode/skills/system-spec-kit/mcp_server/lib/eval/edge-density.ts
  └ L1:220 (213 lines read)

● Read graph-signals.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/graph-signals.vitest.ts
  └ L1:260 (260 lines read)

● Read community-detection.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/community-detection.vitest.ts
  └ L300:760 (415 lines read)

● Read graph-calibration.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/graph-calibration.vitest.ts
  └ L1:260 (260 lines read)
...
● Search (grep)
  │ "runPostMutationHooks" in **/*.{ts,js} (.opencode/skills/system-spec-kit/mcp_server/handlers)
  └ 14 lines found
...
● Search (grep)
  ...
  │ (.opencode/skills/system-spec-kit/mcp_server/tests/intent-aware-traversal.vitest.ts)
  └ No matches found
...
● Search (grep)
  │ "applyCausalBoost\(" in **/*.{ts,js} (.opencode/skills/system-spec-kit/mcp_server)
  └ 13 lines found

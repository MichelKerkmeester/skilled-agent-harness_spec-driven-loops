...
- **File**: `.opencode/commands/spec_kit/complete.md:98`
...
- **Claim Adjudication**:
  ...
  - Evidence Refs: `.opencode/commands/spec_kit/complete.md:98-100`; `.opencode/commands/spec_kit/assets/spec_kit_complete_auto.yaml:37-38,472-473`; `.opencode/commands/spec_kit/assets/spec_kit_complete_confirm.yaml:36-37,523-525`; `.opencode/commands/spec_kit/README.txt:91-105`
...
- **File**: `.opencode/commands/spec_kit/plan.md:160`
...
- **Claim Adjudication**:
  ...
  - Evidence Refs: `.opencode/commands/spec_kit/plan.md:158-160,199`; `.opencode/commands/spec_kit/implement.md:162-165`; `spec_kit_implement_auto.yaml:97-101,316`; `spec_kit_implement_confirm.yaml:97-101,335`
...
- **File**: `.opencode/commands/spec_kit/implement.md:287`

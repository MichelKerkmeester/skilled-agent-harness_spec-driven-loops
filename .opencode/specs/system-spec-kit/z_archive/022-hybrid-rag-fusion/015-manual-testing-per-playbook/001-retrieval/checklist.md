...
- [x] CHK-001 [P0] Playbook files for 01--retrieval confirmed accessible — all 13 scenario files read from `.opencode/skills/system-spec-kit/manual_testing_playbook/01--retrieval/` [EVIDENCE: tasks.md; implementation-summary.md]
- [x] CHK-002 [P0] Feature catalog files for 01--retrieval confirmed accessible — all 6 catalog files read from `.opencode/skills/system-spec-kit/feature_catalog/01--retrieval/` [EVIDENCE: tasks.md; implementation-summary.md]
...
- [x] CHK-021 [P0] 185 — PASS. `/memory:search` exposes retrieval plus analysis tools in frontmatter and documents the no-args prompt, retrieval routing, and analysis subcommand matrix in `.opencode/commands/memory/search.md`. [EVIDENCE: tasks.md; implementation-summary.md]
- [x] CHK-022 [P0] 187 — PASS. `memory_quick_search` is part of the `/memory:search` retrieval surface in `.opencode/commands/memory/search.md`, and the governed-scope forwarding contract remains covered by the schema and tool tests. [EVIDENCE: tasks.md; implementation-summary.md]

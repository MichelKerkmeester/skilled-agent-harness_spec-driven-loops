...
- After each batch, run `cd .opencode/skills/system-spec-kit/mcp_server && npx tsc --noEmit && npx vitest run --reporter=verbose 2>&1 | tail -10`
...
Add a checkpoint restore maintenance barrier in .opencode/skills/system-spec-kit/mcp_server/
...
Run: cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run tests/checkpoints-storage.vitest.ts tests/checkpoints-extended.vitest.ts"
```
...
Fix shared-space concurrent create race in .opencode/skills/system-spec-kit/mcp_server/
...
Run: cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run tests/shared-memory.vitest.ts"
```
...
Fix reconsolidation stale-merge race in .opencode/skills/system-spec-kit/mcp_server/lib/storage/reconsolidation.ts
...
Run: cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run tests/reconsolidation.vitest.ts"
```
...
Fix chunked save partial commit in .opencode/skills/system-spec-kit/mcp_server/handlers/memory-save.ts
...
Run: cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run tests/handler-memory-save.vitest.ts"
```
...
Optimize fallback pipeline in .opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts
...
Run: cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run tests/hybrid-search.vitest.ts"
```
...
Fix two search performance issues in .opencode/skills/system-spec-kit/mcp_server/
...
Run: cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run tests/hybrid-search.vitest.ts tests/bm25-index.vitest.ts"
```
...
Fix two SQLite query optimization issues in .opencode/skills/system-spec-kit/mcp_server/
...
Run: cd .opencode/skills/system-spec-kit/mcp_server && npx tsc --noEmit"
```
...
Fix three SQLite index/query issues in .opencode/skills/system-spec-kit/mcp_server/
...
Fix four search performance issues in .opencode/skills/system-spec-kit/mcp_server/
...
Run: cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run tests/graph-signals.vitest.ts tests/hybrid-search.vitest.ts"
```
...
Fix five smaller issues in .opencode/skills/system-spec-kit/mcp_server/
...
Clean up 7 dead code and architectural debt items in .opencode/skills/system-spec-kit/mcp_server/
...
After each batch:
```bash
cd .opencode/skills/system-spec-kit/mcp_server && npx tsc --noEmit && npx vitest run --reporter=verbose 2>&1 | tail -10
```

...
● Search (grep)
  ...
  │ extractors/collect-session-data.ts} (.opencode/skills/system-spec-kit/scripts)
  └ No matches found
...
● Analyze review target files for console usage, assertions, catches, and long functions (shell)
  ...
  │ import re
  │ files = [
  │ Path('.opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts'),…
  └ 49 lines...
...
File: `.opencode/skills/system-spec-kit/scripts/core/memory-indexer.ts:50`  
...
Category: HEADER  
Severity: SHOULD-FIX  
File: `.opencode/skills/system-spec-kit/scripts/utils/spec-affinity.ts:5`  
...
Category: IMPORT  
Severity: NICE-TO-HAVE  
File: `.opencode/skills/system-spec-kit/scripts/core/memory-indexer.ts:15`  
...
Category: TYPE  
Severity: SHOULD-FIX  
File: `.opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts:348`  
...
Category: ERROR  
Severity: SHOULD-FIX  
File: `.opencode/skills/system-spec-kit/scripts/utils/spec-affinity.ts:147`  
...
Category: ERROR  
Severity: SHOULD-FIX  
File: `.opencode/skills/system-spec-kit/scripts/extractors/collect-session-data.ts:870`  
...
Category: LOGGING  
Severity: SHOULD-FIX  
File: `.opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts:563`  
...
Category: LOGGING  
Severity: SHOULD-FIX  
File: `.opencode/skills/system-spec-kit/scripts/core/memory-indexer.ts:46`  
...
Category: LOGGING  
Severity: SHOULD-FIX  
File: `.opencode/skills/system-spec-kit/scripts/extractors/collect-session-data.ts:722`  
...
Category: FUNCTION  
Severity: SHOULD-FIX  
File: `.opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts:190`  
...
Category: FUNCTION  
Severity: SHOULD-FIX  
File: `.opencode/skills/system-spec-kit/scripts/core/memory-indexer.ts:54`  
...
Category: FUNCTION  
Severity: SHOULD-FIX  
File: `.opencode/skills/system-spec-kit/scripts/utils/spec-affinity.ts:467`  
...
Category: FUNCTION  
Severity: SHOULD-FIX  
File: `.opencode/skills/system-spec-kit/scripts/extractors/collect-session-data.ts:172`  
...
Category: CONSTANT  
Severity: SHOULD-FIX  
File: `.opencode/skills/system-spec-kit/scripts/core/memory-indexer.ts:119`  
...
Category: DOC  
Severity: SHOULD-FIX  
File: `.opencode/skills/system-spec-kit/scripts/utils/spec-affinity.ts:301`  
...
Category: DOC  
Severity: SHOULD-FIX  
File: `.opencode/skills/system-spec-kit/scripts/extractors/collect-session-data.ts:697`  

---
title: "Veri [system-spec-kit/022-hybrid-rag-fusion/008-hydra-db-based-features/005-hierarchical-scope-governance/checklist]"
...
- [x] CHK-521 [P1] Manual governance procedures added to the playbook [EVIDENCE:.opencode/skills/system-spec-kit/manual_testing_playbook/MANUAL_TESTING_PLAYBOOK.md]
...
- [x] CHK-523 [P1] Maintainer sign-off recorded in phase docs [EVIDENCE:.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/008-hydra-db-based-features/005-hierarchical-scope-governance/checklist.md (L3+: SIGN-OFF)]
<!-- /ANCHOR:docs -->
...
- [x] CHK-542 [P1] Governance design reviewed by policy reviewer [EVIDENCE:.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/008-hydra-db-based-features/005-hierarchical-scope-governance/checklist.md (L3+: SIGN-OFF)]
<!-- /ANCHOR:arch-verify -->

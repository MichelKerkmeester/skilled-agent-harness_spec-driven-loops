...
- [ ] Strict-validate child 001 + parent 029 exits 0
- [ ] Commit on main referencing 029/001
<!-- /ANCHOR:quality-gates -->
...
- Strict-validate on child 001 and parent 029 exits 0
...
| Strict validate | child 001 + parent 029 | `validate.sh --strict` |

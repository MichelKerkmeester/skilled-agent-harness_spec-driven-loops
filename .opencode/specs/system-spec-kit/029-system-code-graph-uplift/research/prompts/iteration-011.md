...
- Iteration narrative target: `.opencode/specs/system-spec-kit/029-system-code-graph-uplift/research/iterations/iteration-011.md`
- Delta file target: `.opencode/specs/system-spec-kit/029-system-code-graph-uplift/research/deltas/iter-011.jsonl`
...
1. `.opencode/specs/system-spec-kit/029-system-code-graph-uplift/research/iterations/iteration-011.md` with sections: Focus, Actions Taken, Findings (file:line-cited per-file), Questions Answered (with question IDs from registry), Questions Remaining, Next Focus.
...
3. Optional: write `.opencode/specs/system-spec-kit/029-system-code-graph-uplift/research/deltas/iter-011.jsonl` with the iteration record + per-finding records. Workflow will synthesize if absent.

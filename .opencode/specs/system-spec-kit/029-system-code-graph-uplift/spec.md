...
| **Created** | 2026-05-16 |
| **Branch** | `main` |
| **Parent Spec** | n/a (top-level under system-spec-kit) |
...
- Use `/spec_kit:resume .opencode/specs/system-spec-kit/029-system-code-graph-uplift/[NNN-phase]/` to resume a specific phase

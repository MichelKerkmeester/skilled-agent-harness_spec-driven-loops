...
| REQ-006 | Strict-validate child 002 + parent 029 exits 0 | `validate.sh --strict` exits 0 |
...
- **SC-004**: Strict-validate exit 0 for child 002 and parent 029.
<!-- /ANCHOR:success-criteria -->

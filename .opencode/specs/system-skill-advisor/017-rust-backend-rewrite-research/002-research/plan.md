...
_memory:
  continuity:
    packet_pointer: "system-skill-advisor/017-rust-backend-rewrite-research/002-research"
...
- **Structure**: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-skill-advisor/017-rust-backend-rewrite-research/002-research --strict`.
<!-- /ANCHOR:testing -->

...
_memory:
  continuity:
    packet_pointer: "system-skill-advisor/001-skill-advisor-tuning"
...
> This spec uses phased decomposition. Each phase is an independently executable child spec folder; all implementation detail lives inside the phase children. Resume a specific phase with `/speckit:resume system-skill-advisor/001-skill-advisor-tuning/[NNN-phase]/`.

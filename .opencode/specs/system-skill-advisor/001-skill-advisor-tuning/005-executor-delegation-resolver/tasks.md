...
_memory:
  continuity:
    packet_pointer: "system-skill-advisor/001-skill-advisor-tuning/005-executor-delegation-resolver"
...
- Design input: `system-skill-advisor/001-skill-advisor-tuning/001-scorer-saturation-root-fix` (WS2 umbrella).
<!-- /ANCHOR:cross-refs -->

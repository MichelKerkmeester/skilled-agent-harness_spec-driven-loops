...
| `.opencode/specs/system-skill-advisor/001-skill-advisor-tuning/008-semantic-shadow-prove-or-freeze/**` | Create | This Level 2 decision record (spec/plan/tasks/checklist/implementation-summary + metadata) |
...
- **Sibling**: `system-skill-advisor/001-skill-advisor-tuning/007-eval-hardening`

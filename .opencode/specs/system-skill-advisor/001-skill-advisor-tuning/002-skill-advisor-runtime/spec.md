...
_memory:
  continuity:
    packet_pointer: "system-skill-advisor/001-skill-advisor-tuning/002-skill-advisor-runtime"
...
- Use `/speckit:resume system-skill-advisor/001-skill-advisor-tuning/002-skill-advisor-runtime/[NNN-phase]/` to resume a specific child.

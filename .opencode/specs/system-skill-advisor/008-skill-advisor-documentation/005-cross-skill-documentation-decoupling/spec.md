...
_memory:
  continuity:
    ...
    open_questions: []
    answered_questions:
      - "Spec folder placement? Under 008-skill-advisor-documentation as sibling 005"
...
| **Created** | 2026-05-16 |
| **Branch** | `main` |
| **Parent** | `008-skill-advisor-documentation` |
<!-- /ANCHOR:metadata -->
...
| REQ-005 | Strict-validate child 005 + parent 008-skill-advisor-documentation (where pre-existing warnings allow) | Child exit 0 errors |

...
- The script scans top-level `.opencode/skills/*/SKILL.md` files only.
...
- Added observe-only JSONL telemetry at `.opencode/skills/.smart-router-telemetry/compliance.jsonl`.

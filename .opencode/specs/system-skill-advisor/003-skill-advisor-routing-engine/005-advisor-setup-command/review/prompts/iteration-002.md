...
## Required reads
1. `.opencode/specs/.../005-advisor-setup-command/review/deep-review-strategy.md`
2. `.opencode/specs/.../005-advisor-setup-command/review/iterations/iteration-001.md` (prior findings)

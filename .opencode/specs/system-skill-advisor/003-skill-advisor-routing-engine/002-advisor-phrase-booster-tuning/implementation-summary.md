...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/system-skill-advisor/003-skill-advisor-routing-engine/002-advisor-phrase-booster-tuning/scratch/phrase-boost-delta.md"
      - ".opencode/specs/system-skill-advisor/003-skill-advisor-routing-engine/002-advisor-phrase-booster-tuning/research/research.md"
    session_dedup:

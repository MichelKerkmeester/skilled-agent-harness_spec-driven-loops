...
- Constraint: read-only proposals only; no advisor/scorer code edits. [SOURCE: .opencode/specs/system-skill-advisor/012-skill-advisor-tuning/_research-charter.md:3]
- Priority: angles 1-5 weighted highest, with parent-hub compatibility as top priority. [SOURCE: .opencode/specs/system-skill-advisor/012-skill-advisor-tuning/_research-charter.md:7]
...
007's ambiguity slice is 15/25 top-1, proving contested prompts are a weak area. [SOURCE: .opencode/specs/system-skill-advisor/012-skill-advisor-tuning/007-eval-hardening/implementation-summary.md:129]
...
003 showed conflict overlay signal on one prompt, but live edge authoring remains a separate decision. [SOURCE: .opencode/specs/system-skill-advisor/012-skill-advisor-tuning/003-advisor-rrf-fusion/results/metrics.json:183]
...
008 froze `semantic_shadow` at weight 0.05 after a net-negative ablation. [SOURCE: .opencode/specs/system-skill-advisor/012-skill-advisor-tuning/008-semantic-shadow-prove-or-freeze/implementation-summary.md:46]

The harmful flips include three gold-none false-fires to `mcp-chrome-devtools`. [SOURCE: .opencode/specs/system-skill-advisor/012-skill-advisor-tuning/008-semantic-shadow-prove-or-freeze/implementation-summary.md:79]
...
| Tune weights before labels | Existing ambiguity evidence is weak and needs a named slice. | `.opencode/specs/system-skill-advisor/012-skill-advisor-tuning/007-eval-hardening/implementation-summary.md:63` | 5 |
| Live DB experiment mutation | Existing packets use read-only copy or fixture projection. | `.opencode/specs/system-skill-advisor/012-skill-advisor-tuning/003-advisor-rrf-fusion/results/metrics.json:9` | 6 |
...
| Immediate semantic_shadow weight change | 008 froze the lane after net-negative evidence. | `.opencode/specs/system-skill-advisor/012-skill-advisor-tuning/008-semantic-shadow-prove-or-freeze/implementation-summary.md:46` | 10 |
...
- `.opencode/specs/system-skill-advisor/012-skill-advisor-tuning/003-advisor-rrf-fusion/results/metrics.json`

...
1. 007 added an empirical ambiguity slice over the 25 lowest-margin rows; its frozen top-1 is only 15/25, so parent-hub ambiguity needs a named slice rather than informal spot checks. [SOURCE: .opencode/specs/system-skill-advisor/012-skill-advisor-tuning/007-eval-hardening/implementation-summary.md:63]
2. The baseline output records full-corpus 147/193, holdout 60/78, and ambiguity 15/25; parent-hub prompts should be recaptured under the same ratchet model. [SOURCE: .opencode/specs/system-skill-advisor/012-skill-advisor-tuning/007-eval-hardening/implementation-summary.md:129]

...
_memory:
  continuity:
    packet_pointer: "system-skill-advisor/012-skill-advisor-tuning/008-semantic-shadow-prove-or-freeze"
...
- [x] T-041 Register the child in the parent `graph-metadata.json` `children_ids`. Evidence: `system-skill-advisor/012-skill-advisor-tuning/008-semantic-shadow-prove-or-freeze` after 007, before z_archive; `last_active_child_id` repointed.
...
- Program umbrella: `system-skill-advisor/012-skill-advisor-tuning/001-scorer-saturation-root-fix`.
<!-- /ANCHOR:cross-refs -->

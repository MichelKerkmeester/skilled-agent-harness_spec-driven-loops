...
- [x] T-051 Register the child in the parent `graph-metadata.json` `children_ids`. Evidence: `system-skill-advisor/012-skill-advisor-tuning/007-eval-hardening` after 006, before z_archive; `last_active_child_id` set.
<!-- /ANCHOR:phase-3 -->

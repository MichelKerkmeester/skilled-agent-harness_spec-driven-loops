...
_memory:
  continuity:
    packet_pointer: "system-skill-advisor/011-skill-advisor-phase-parent"
...
- Use `/speckit:resume system-skill-advisor/011-skill-advisor-phase-parent/[NNN-phase]/` to resume a specific child.

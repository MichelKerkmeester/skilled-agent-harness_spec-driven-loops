---
title: "Feature [system-skill-advisor/001-skill-graph/001-skill-graph-metadata-routing-boosts/spec]"
...
| **Parent Spec** | ../spec.md |
| **Parent Plan** | ../plan.md |
| **Predecessor** | ../001-memory-search-routing-tuning/spec.md |
| **Successor** | ../002-advisor-phrase-booster-tuning/spec.md |
<!-- /ANCHOR:metadata -->
...
Single file at `.opencode/skills/skill-advisor/scripts/skill-graph.json`:
...
| File | Action |
|------|--------|
| `.opencode/skills/skill-advisor/scripts/skill_advisor.py` | Modify |
| `.opencode/skills/skill-advisor/scripts/skill_graph_compiler.py` | Create |
| `.opencode/skills/skill-advisor/scripts/skill-graph.json` | Create (generated) |
| `.opencode/skills/*/graph-metadata.json` (20 files) | Create |
| `.opencode/skills/skill-advisor/scripts/fixtures/skill_advisor_regression_cases.jsonl` | Modify |
<!-- /ANCHOR:files -->

...
_memory:
  continuity:
    packet_pointer: "system-skill-advisor/001-skill-graph/006-system-skill-advisor-package-extraction/009-fix-script-filesystem-scope"
...
| `.opencode/specs/.../009-fix-script-filesystem-scope/spec.md` | Create | Level 2 specification. |
| `.opencode/specs/.../009-fix-script-filesystem-scope/plan.md` | Create | Three-phase implementation and rollback plan. |
| `.opencode/specs/.../009-fix-script-filesystem-scope/tasks.md` | Create | Setup, implementation, and verification task ledger. |
| `.opencode/specs/.../009-fix-script-filesystem-scope/checklist.md` | Create | Level 2 verification checklist. |
| `.opencode/specs/.../009-fix-script-filesystem-scope/implementation-summary.md` | Create | Evidence summary and continuity block. |
| `.opencode/specs/.../009-fix-script-filesystem-scope/description.json` | Create | Retrieval metadata. |
| `.opencode/specs/.../009-fix-script-filesystem-scope/graph-metadata.json` | Create | Packet graph metadata. |
<!-- /ANCHOR:scope -->

...
- [x] T002 Read sibling 008 spec and metadata shape (`008-skill-graph-tools-advisor-migration/`) [10m]
...
- [x] T009 Create Level 2 packet folder and docs (`009-fix-script-filesystem-scope/`) [25m]

...
trigger_phrases:
  - "001-fix-skill-advisor-fail-open-fallback tasks"
...
- [x] **T25** Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/001-fix-skill-advisor-fail-open-fallback --strict`. Exit: exit 0. Evidence: final validator exit 0.

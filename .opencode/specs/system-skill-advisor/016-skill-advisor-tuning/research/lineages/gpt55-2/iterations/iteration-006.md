...
1. The 001 root packet explicitly says pre-Layer-1b numbers are not comparable and that a fresh 193-row baseline is required after metadata lands [SOURCE: .opencode/specs/system-skill-advisor/016-skill-advisor-tuning/001-scorer-saturation-root-fix/implementation-summary.md:104].
...
3. 008 avoids live daemon vector DB access for semantic-shadow ablation because of native-ABI/SIGBUS fragility [SOURCE: .opencode/specs/system-skill-advisor/016-skill-advisor-tuning/008-semantic-shadow-prove-or-freeze/implementation-summary.md:95].

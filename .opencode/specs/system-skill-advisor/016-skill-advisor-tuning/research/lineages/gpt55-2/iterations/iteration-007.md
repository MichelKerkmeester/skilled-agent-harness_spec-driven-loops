...
4. The 003 benchmark found RRF needs the conflict-rerank seam when conflict edges exist, but the live corpus currently has zero `conflicts_with` edges [SOURCE: .opencode/specs/system-skill-advisor/016-skill-advisor-tuning/003-advisor-rrf-fusion/benchmark-results.md:67].

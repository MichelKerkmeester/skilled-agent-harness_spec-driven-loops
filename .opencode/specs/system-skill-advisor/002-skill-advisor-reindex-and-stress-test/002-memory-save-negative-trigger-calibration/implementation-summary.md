...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-skill-advisor/002-skill-advisor-reindex-and-stress-test --strict`: passed with 0 errors and 0 warnings.
<!-- /ANCHOR:verification -->

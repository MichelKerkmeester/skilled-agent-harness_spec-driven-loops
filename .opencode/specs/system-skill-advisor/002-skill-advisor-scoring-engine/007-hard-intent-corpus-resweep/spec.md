...
_memory:
  continuity:
    ...
    session_dedup:
      ...
      session_id: "007-hard-intent-corpus-resweep"
...
- Emit `007-hard-intent-corpus-resweep/research/sweep-results-harder.md` with per-vector accuracy on the harder set, deltas vs the original 24-prompt baseline, and per-case routing diffs.

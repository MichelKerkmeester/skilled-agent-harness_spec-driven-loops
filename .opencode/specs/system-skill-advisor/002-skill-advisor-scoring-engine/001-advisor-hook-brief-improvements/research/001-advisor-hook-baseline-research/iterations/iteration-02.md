...
- The bridge’s own feature catalog and tests encode the `0.7` OpenCode default, which means this is institutionalized drift rather than a one-off implementation oversight. Citation: `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/feature_catalog/hooks-and-plugin/05-opencode-plugin-bridge.md:31`, `.opencode/skills/system-spec-kit/mcp_server/skill-advisor/tests/compat/plugin-bridge.vitest.ts:21`.

...
| `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-skill-advisor-documentation/007-reference-template-alignment --strict --verbose` | PASS: strict packet validation passed with 0 errors and 0 warnings. |
<!-- /ANCHOR:verification -->

...
- 3 HIGH-severity bugs: ADR-001 path missing `001-skill-graph/` segment in SKILL.md + ARCHITECTURE.md; broken hook reference link in README + INSTALL_GUIDE; wrong build-command path in ARCHITECTURE §8

---
title: "...ec-kit/026-graph-and-context-optimization/006-skill-advisor/001-documentation-code-alignment/tasks]"
...
- [x] T020 [P0] Run `validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/001-documentation-code-alignment --strict --no-recursive` clean [Evidence: strict validation returned errors=0, warnings=0]
...
- Spec: `spec.md`
- Parent: `../../006-skill-advisor/004-advisor-hook-surface-integration/implementation-summary.md`

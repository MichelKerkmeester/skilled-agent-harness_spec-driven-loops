...
_memory:
  continuity:
    packet_pointer: "system-skill-advisor/008-semantic-shadow-prove-or-freeze"
...
| `.opencode/specs/system-skill-advisor/008-semantic-shadow-prove-or-freeze/**` | Create | This Level 2 decision record (spec/plan/tasks/checklist/implementation-summary + metadata) |
...
- **Sibling**: `system-skill-advisor/007-eval-hardening`

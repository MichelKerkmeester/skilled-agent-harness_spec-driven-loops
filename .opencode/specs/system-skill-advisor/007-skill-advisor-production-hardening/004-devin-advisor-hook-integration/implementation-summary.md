...
trigger_phrases:
  - "implementation"
  - "summary"
  - "004-devin-advisor-hook-integration"
  - "mk-skill-advisor"
  - "devin hook"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 004-devin-advisor-hook-integration |
...
6. **Doc updates**: SKILL.md, README, INSTALL_GUIDE, SET-UP_GUIDE, ARCHITECTURE.md, feature_catalog/hooks-and-plugin/, manual_testing_playbook/cli-hooks-and-plugin/ — all stale `spec-kit-skill-advisor` references updated.
...
- **Strict validate (packet)**: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/004-devin-advisor-hook-integration --strict` → exit 0, 0 errors, 0 warnings.

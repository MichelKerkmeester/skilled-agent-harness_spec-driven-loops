---
title: "Feat [system-skill-advisor/007-skill-advisor-production-hardening/002-advisor-plugin-hardening/spec]"
...
| **Parent Spec** | `../spec.md` |
| **Predecessor** | `../../007-hook-parity/005-fix-opencode-plugin-loader-bridge/spec.md` |
...
- Sibling packet (source of deferrals): `../../007-hook-parity/005-fix-opencode-plugin-loader-bridge/decision-record.md` ADR-005

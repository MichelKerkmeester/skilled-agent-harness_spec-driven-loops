...
trigger_phrases:
  - "001-fix-skill-advisor-fail-open-fallback implementation"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 005-fail-open-fallback |
...
| `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/001-fix-skill-advisor-fail-open-fallback --strict` | PASS, exit 0. |

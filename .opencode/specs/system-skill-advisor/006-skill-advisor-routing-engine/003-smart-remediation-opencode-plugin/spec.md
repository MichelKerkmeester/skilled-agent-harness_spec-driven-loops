---
title: ".../026-graph-and-context-optimization/006-skill-advisor/003-smart-remediation-opencode-plugin/spec]"
...
| **Parent Spec** | ../spec.md |
| **Parent Plan** | ../plan.md |
| **Predecessor** | ../001-documentation-code-alignment/spec.md |
| **Successor** | ../001-deferred-remediation-telemetry-run/spec.md |
<!-- /ANCHOR:metadata -->
...
- Parent: `../../006-skill-advisor/004-advisor-hook-surface-integration/` (shipped)
- Research inputs:

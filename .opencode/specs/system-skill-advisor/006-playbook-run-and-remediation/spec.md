...
_memory:
  continuity:
    packet_pointer: "system-skill-advisor/006-playbook-run-and-remediation"
...
| **Parent Packet** | system-skill-advisor/006-playbook-run-and-remediation |
...
|-----------|-------------|-------|-------------|
| `006-playbook-run-and-remediation/00*-*/**` | Create | all | Phase-child spec docs + recorded verdicts/evidence |
<!-- /ANCHOR:scope -->

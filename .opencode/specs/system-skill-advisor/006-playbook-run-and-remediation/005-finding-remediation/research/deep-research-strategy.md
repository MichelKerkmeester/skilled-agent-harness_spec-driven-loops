...
<!-- MACHINE-OWNED: END -->
## 12. KNOWN CONTEXT
Findings source: `.opencode/specs/system-skill-advisor/006-playbook-run-and-remediation/004-shell-python-daemon/implementation-summary.md` (consolidated findings) and `002-mcp-native-scenarios/` (NC-003 evidence).

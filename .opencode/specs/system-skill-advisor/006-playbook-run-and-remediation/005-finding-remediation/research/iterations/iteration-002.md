...
Doc remediation: update `.opencode/skills/system-skill-advisor/manual_testing_playbook/python-compat/005-bench-runner.md` to include `--dataset .opencode/skills/system-skill-advisor/mcp_server/scripts/fixtures/skill_advisor_regression_cases.jsonl`, and describe `--runs 1` as manual smoke guidance rather than the performance baseline. Evidence: `.opencode/specs/system-skill-advisor/006-playbook-run-and-remediation/005-finding-remediation/research/deltas/iter-002.jsonl:11`.

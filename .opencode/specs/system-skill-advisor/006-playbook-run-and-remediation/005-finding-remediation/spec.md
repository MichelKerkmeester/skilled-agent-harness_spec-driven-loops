...
_memory:
  continuity:
    packet_pointer: "system-skill-advisor/006-playbook-run-and-remediation/005-finding-remediation"
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-skill-advisor/006-playbook-run-and-remediation/005-finding-remediation/research/research.md"
    session_dedup:

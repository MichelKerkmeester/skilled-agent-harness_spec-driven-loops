...
_memory:
  continuity:
    packet_pointer: "system-skill-advisor/002-skill-advisor-runtime/002-runtime-lane-health-degrade"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | system-skill-advisor/002-skill-advisor-runtime/002-runtime-lane-health-degrade |
| **Status** | complete |
| **Level** | 2 |
<!-- /ANCHOR:metadata -->

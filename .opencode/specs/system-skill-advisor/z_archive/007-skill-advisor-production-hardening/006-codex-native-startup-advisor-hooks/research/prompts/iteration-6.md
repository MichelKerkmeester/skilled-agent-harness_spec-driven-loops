You are executing iteration 6 of 10 of a deep-research loop against the Codex CLI hook CONTRACT question. Operate as a LEAF agent — do not spawn sub-agents.
...
Last 3 iterations:
  run 3: source-level parser contract (ratio=0.45)
  run 4: Q1/Q2 stdin and context injection contract (ratio=0.35)
  run 5: exit codes and blocker semantics (ratio=0.55)
...
Write to: /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/007-deep-review-remediation-pt-02/iterations/iteration-6.md

Structure:
# Iteration 6: <focus-topic>
## Focus
<1-2 sentences>
## Actions Taken
...
## Next Focus
<one-sentence recommendation for iteration 7>
...
{"type":"iteration","run":6,"status":"insight"|"evidence"|"thought"|"dead-end","focus":"<short focus label>","findingsCount":<int>,"newInfoRatio":<0..1>,"citationCount":<int>,"primarySourceCount":<int>,"timestamp":"<ISO8601>","graphEvents":[]}
...
Write to: /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/007-deep-review-remediation-pt-02/deltas/iter-6.jsonl
...
Begin iteration 6 now. Produce the three artifacts.

...
_memory:
  continuity:
    ...
    session_dedup:
      ...
      session_id: "049-003-fix-skill-advisor-quality"
...
| **Parent Spec** | ../spec.md |
| **Phase** | 3 of 10 |
| **Predecessor** | 002-fix-deep-loop-workflow-state |
| **Successor** | 004-fix-validation-memory |
<!-- /ANCHOR:metadata -->
...
Dependencies:
- Source of truth: `003-system-bug-improvement-research/research/research.md` §6 (B1: advisor formatting drift), §12 (C2: scorer math), §13 (C3: regression fixture)

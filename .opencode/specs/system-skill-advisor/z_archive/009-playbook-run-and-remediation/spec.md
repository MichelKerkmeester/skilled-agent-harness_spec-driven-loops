...
_memory:
  continuity:
    packet_pointer: "system-skill-advisor/009-playbook-run-and-remediation"
...
| **Parent Packet** | system-skill-advisor/009-playbook-run-and-remediation |
...
|-----------|-------------|-------|-------------|
| `009-playbook-run-and-remediation/00*-*/**` | Create | all | Phase-child spec docs + recorded verdicts/evidence |
<!-- /ANCHOR:scope -->

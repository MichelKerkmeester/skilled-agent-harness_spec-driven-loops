...
Moved advisor-owned unit tests, hook tests, rebuild tests, and stress tests into `system-skill-advisor/mcp_server`. Added advisor stress config coverage and fixed the moved lane-weight sweep fixture paths to the current `006-seeded-corpus-evaluation-sweep` and `007-hard-intent-corpus-resweep` packets.

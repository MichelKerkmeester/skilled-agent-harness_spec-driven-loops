---
title: "Session [system-skill-advisor/004-skill-graph/001-skill-graph-metadata-routing-boosts/handover]"
...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/retrieval/unified-context-retrieval-memory-context.md` | Reference playbook example |
| `.opencode/skills/system-spec-kit/feature_catalog/retrieval/01-unified-context-retrieval-memorycontext.md` | Reference catalog example |
...
```
/spec_kit:resume .opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/004-skill-graph-metadata-routing-boosts
```

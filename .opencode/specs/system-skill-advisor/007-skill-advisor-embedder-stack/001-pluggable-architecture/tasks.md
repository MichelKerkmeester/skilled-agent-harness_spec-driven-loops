...
_memory:
  continuity:
    packet_pointer: "system-skill-advisor/007-skill-advisor-embedder-stack/001-pluggable-architecture"
...
- Plan: `plan.md`
- Parent: `../spec.md`
- Reference: `../../013-embedder-testing-and-architecture/002-spec-memory-stack/004-spec-memory-embedder-bake-off/`

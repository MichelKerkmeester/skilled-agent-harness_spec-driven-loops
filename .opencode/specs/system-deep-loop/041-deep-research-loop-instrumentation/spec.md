...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-deep-loop/041-deep-research-loop-instrumentation/spec.md"
      - ".opencode/specs/system-deep-loop/041-deep-research-loop-instrumentation/implementation-summary.md"
    session_dedup:

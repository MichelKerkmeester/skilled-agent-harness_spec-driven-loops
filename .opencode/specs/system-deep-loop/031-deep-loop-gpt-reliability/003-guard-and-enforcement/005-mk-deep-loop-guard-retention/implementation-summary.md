...
_memory:
  continuity:
    packet_pointer: "system-deep-loop/031-deep-loop-gpt-reliability/003-guard-and-enforcement/005-mk-deep-loop-guard-retention"
...
3. **This packet was initially placed as top-level `system-deep-loop/037-mk-deep-loop-guard-retention`** because 031 was mid-restructure when it was written. It has since been re-homed into `031-deep-loop-gpt-reliability/003-guard-and-enforcement/005-mk-deep-loop-guard-retention` (2026-07-05) as the guard/enforcement track's retention phase, once that restructuring settled.
<!-- /ANCHOR:limitations -->

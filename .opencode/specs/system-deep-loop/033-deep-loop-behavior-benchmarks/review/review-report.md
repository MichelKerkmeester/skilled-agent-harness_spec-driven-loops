  ...
  "activeFindings": [
    {
      ...
      "evidence": [
        ".opencode/specs/deep-loops/033-deep-loop-behavior-benchmarks/fixtures/fx-001-review-target/spec.md:18-20",
        ".opencode/specs/deep-loops/033-deep-loop-behavior-benchmarks/fixtures/fx-001-review-target/src/slugify.js:20-26"
      ]
    }
  ],
...
- Evidence: `.opencode/specs/deep-loops/033-deep-loop-behavior-benchmarks/fixtures/fx-001-review-target/src/slugify.js:25`
- Spec evidence: `.opencode/specs/deep-loops/033-deep-loop-behavior-benchmarks/fixtures/fx-001-review-target/spec.md:18-20`
...
- Dashboard: `.opencode/specs/deep-loops/033-deep-loop-behavior-benchmarks/review/deep-review-dashboard.md`
- Resource map: `.opencode/specs/deep-loops/033-deep-loop-behavior-benchmarks/review/resource-map.md`

...
> `.opencode/specs/deep-loops/032-goal-opencode-plugin`. Writes
> are confined to
...
|------|------------------------|
| `.opencode/specs/deep-loops/032-goal-opencode-plugin/spec.md` | 002, 004, 010 |
| `.opencode/specs/deep-loops/032-goal-opencode-plugin/description.json` | 001, 010 |
| `.opencode/specs/deep-loops/032-goal-opencode-plugin/graph-metadata.json` | 002, 010 |
| `.opencode/specs/deep-loops/032-goal-opencode-plugin/changelog/README.md` | 001, 010 |
| `.opencode/specs/deep-loops/032-goal-opencode-plugin/scratch/2026-07-03-four-reviewer-audit-findings.md` | 003 |
| `.opencode/specs/deep-loops/032-goal-opencode-plugin/009-diagnostic-review/` | 001 |
| `.opencode/specs/deep-loops/032-goal-opencode-plugin/009-speckit-command-goal-prompt-offer/{spec,impl-summary,graph-metadata}.md` | 002, 004 |
| `.opencode/specs/deep-loops/032-goal-opencode-plugin/012-regression-test-backfill/{spec,impl-summary,graph-metadata}.md` | 002, 004 |
| `.opencode/specs/deep-loops/032-goal-opencode-plugin/014-goal-state-cleanup-and-archive/spec.md` | 002, 004 |

...
_memory:
  continuity:
    packet_pointer: "system-deep-loop/032-goal-opencode-plugin/007-sk-prompt-goal-enhancement"
...
| `.opencode/specs/system-deep-loop/032-goal-opencode-plugin/spec.md` | Modify | Add phase 7 scope and handoff criteria to the parent map. |
| `.opencode/specs/system-deep-loop/032-goal-opencode-plugin/007-sk-prompt-goal-enhancement/` | Create | Phase documentation for this enhancement. |
<!-- /ANCHOR:scope -->

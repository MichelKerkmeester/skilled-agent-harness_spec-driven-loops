...
- [x] T011 Restamp generated metadata and run strict spec validation (`validate.sh --strict`) — evidence: `validate.sh .opencode/specs/system-deep-loop/032-goal-opencode-plugin --strict` PASS
<!-- /ANCHOR:phase-3 -->

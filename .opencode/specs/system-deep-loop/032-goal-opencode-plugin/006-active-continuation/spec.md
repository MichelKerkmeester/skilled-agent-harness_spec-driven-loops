...
| `.opencode/specs/system-deep-loop/032-goal-opencode-plugin/006-active-continuation/*` | Modify | Replaces scaffold phase docs with actual scope, plan, tasks, metadata, and verification summary. |
<!-- /ANCHOR:scope -->

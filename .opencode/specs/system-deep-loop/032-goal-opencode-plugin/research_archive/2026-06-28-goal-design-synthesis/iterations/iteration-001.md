...
- Read the packet strategy and state seed. The strategy names the target OpenCode files as `.opencode/plugins/mk-goal.js`, `.opencode/commands/goal.md`, and a state store at `.opencode/specs/deep-loops/032-goal-opencode-plugin/research/deep-research-strategy.md:11`; G1 is the current focus at `.opencode/specs/deep-loops/032-goal-opencode-plugin/research/deep-research-strategy.md:17`.

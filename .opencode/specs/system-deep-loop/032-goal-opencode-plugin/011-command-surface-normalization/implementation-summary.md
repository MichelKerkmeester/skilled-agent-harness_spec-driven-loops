...
| `.opencode/specs/system-deep-loop/032-goal-opencode-plugin/004-lifecycle-tracking/graph-metadata.json` | Modified | Stripped two non-deliverable files (`mk-spec-memory.js`, `session-cleanup.js`) from `key_files` (DR-007-P2) |
<!-- /ANCHOR:what-built -->

...
description: "Decision record for 026-alignment-coverage-integrity: the architectural rulings this remediation child depends on, with alternatives and consequences."
trigger_phrases:

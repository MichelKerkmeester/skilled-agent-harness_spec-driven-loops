...
- [x] T021 `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-deep-loop/036-deep-loop-innovation/023-legacy-compat-event-vocabulary --strict` exits 0; record the Blocker 2 discharge handoff [2h] {deps: T020} [Evidence: `validate.sh`]
<!-- /ANCHOR:phase-3 -->

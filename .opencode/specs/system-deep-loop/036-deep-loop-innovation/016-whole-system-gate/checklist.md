...
description: "Blocking verification checklist for phase 016 of the 006 recommendations-implementation program; all checks are bound to the exact candidate SHA and phase-003 BASE."
trigger_phrases:
  - "whole-system gate checklist"
  - "deep-loop phase 016 checklist"
  - "exact-SHA gate verification"
importance_tier: "critical"
contextType: "planning"
parent: "system-deep-loop/036-deep-loop-innovation/016-whole-system-gate"
_memory:
  continuity:
    packet_pointer: "system-deep-loop/036-deep-loop-innovation/016-whole-system-gate"
...
This checklist is the blocking SOL verifier contract for phase 016. Every item is run against one frozen candidate SHA
and the phase-003 BASE SHA; the report records the manifest hash, commands, exit codes, fixture and scenario IDs,
artifact digests, expected controls, failure owner, and tracked-mutation result. Any P0 failure blocks phase 017 and
...
- [ ] CHK-005 [P1] Eight phase-013 mode-gate outputs plus phase-014 cutover and phase-015 retirement evidence are addressable
<!-- /ANCHOR:pre-impl -->
...
- [ ] CHK-008 [P1] All observed deltas are classified against the phase-003 protected baseline; no defect is silently promoted to a contract
...
- [ ] CHK-010 [P0] Every result carries the exact candidate SHA, phase-003 BASE SHA, manifest hash, fixture digest, and toolchain identity
...
- [ ] CHK-013 [P0] All phase-012 mixed-version fixture families replay deterministically through upcasters, projections, archival readers, resume, and terminal checks
- [ ] CHK-014 [P0] Crash injection at effect, receipt, dispatch, checkpoint, resume, and recovery boundaries passes phase-007 recovery with no lost, duplicated, or unauthorized effects
- [ ] CHK-015 [P0] Phase-007 blinded/counterfactual adjudication passes order/identity perturbation controls and preserves replayable decision evidence
- [ ] CHK-016 [P0] Phase-011 health and degeneration cases detect or correctly clear repetition, cycles, mode collapse, quality decay, and unsafe continuation
- [ ] CHK-017 [P0] Full phase-008 parity against phase 003 is green by stable scenario ID and semantic assertion, including budget, receipt, terminal, replay, sealed-artifact, and archival-read behavior
...
- [ ] CHK-021 [P1] Every failure, if any, maps to an owning phase and blocks phase 017 until the corrected exact SHA reruns affected and dependent checks
<!-- /ANCHOR:testing -->
...
and the tracked worktree is unchanged. Any failure is recorded with its reopen owner; phase 017 remains blocked until

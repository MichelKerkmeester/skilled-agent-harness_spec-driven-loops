# Deep-review leaf — iteration 39 of 40 (correctness)
...
## Focus
REVISIT: re-examine the modules with the most open P0/P1 findings (see digest below) — confirm, refute, or deepen each
...
- F-RES-04 [P0/correctness] Alignment artifact coverage is self-attested — audit execution is never proven @ .opencode/skills/system-deep-loop/runtime/lib/deep-loop/leaf-artifact-writer.ts
- F-RES-03 [P0/correctness] Failed iteration evidence still counts toward coverage and stability @ .opencode/skills/system-deep-loop/runtime/scripts/reduce-alignment-state.cjs
- F-RES-02 [P0/correctness] Reducer seal predicate excludes integrity faults but not pre-discovery state @ .opencode/skills/system-deep-loop/runtime/scripts/reduce-alignment-state.cjs
- F-RES-01 [P0/correctness] Workflow marks a run complete without requiring the reducer to have sealed it @ .opencode/commands/deep/assets/deep-alignment-auto.yaml
- F-029-02 [P0/traceability] Mandatory legacy-writer-retirement evidence does not exist @ .opencode/specs/system-deep-loop/036-deep-loop-innovation/015-legacy-writer-retirement/checklist.md
...
- F-038-06 [P1/maintainability] Council completion is documented as a gate but implemented as advisory @ .opencode/skills/system-deep-loop/deep-ai-council/README.md
- F-038-03 [P1/maintainability] Runtime script contract omits the supported council loop type @ .opencode/skills/system-deep-loop/runtime/references/script-interface-contract.md
- F-038-02 [P1/maintainability] Research README promises corruption repair that the reducer does not perform @ .opencode/skills/system-deep-loop/deep-research/README.md
- F-038-01 [P1/maintainability] Command-surface benchmark mixes live 035 and absent 066 packet @ .opencode/skills/system-deep-loop/deep-alignment/assets/conformance-benchmark/command-surface/conformance-benchmark.md
- F-037-04 [P1/maintainability] Malformed delta rows are dropped while the iteration still passes @ .opencode/skills/system-deep-loop/runtime/scripts/reduce-state.cjs

# Deep-review leaf — iteration 26 of 40 (traceability)
...
## Focus
Contract accuracy: SKILL.md and README claims vs code (including the three iteration-1 P2 doc drifts)
...
- F-025-04 [P1/traceability] Deep Research certificate evidence uses stale counts and displaced line anchors @ .opencode/specs/system-deep-loop/036-deep-loop-innovation/013-mode-and-lane-migrations/001-deep-research/004-certificates-and-receipts/checklist.md
- F-025-03 [P1/traceability] Council shadow-parity checklist contradicts its own implementation evidence @ .opencode/specs/system-deep-loop/036-deep-loop-innovation/013-mode-and-lane-migrations/003-deep-ai-council/006-shadow-parity/checklist.md
- F-025-02 [P1/traceability] Council resume checklist overstates coverage behind obsolete 6/6 evidence @ .opencode/specs/system-deep-loop/036-deep-loop-innovation/013-mode-and-lane-migrations/003-deep-ai-council/005-resume-adapter/checklist.md
- F-025-01 [P1/traceability] Deep Review resume checklist certifies scenarios absent from its cited suite @ .opencode/specs/system-deep-loop/036-deep-loop-innovation/013-mode-and-lane-migrations/002-deep-review/005-resume-adapter/checklist.md
- F-024-02 [P1/traceability] Common and Agent Improvement mode gates trust caller-supplied version bindings @ .opencode/skills/system-deep-loop/runtime/lib/deep-improvement-common-rollback-gate/mode-gate.ts
- F-024-01 [P1/traceability] Skill Benchmark cannot migrate shared common legacy lifecycle records @ .opencode/skills/system-deep-loop/runtime/lib/skill-benchmark-ledger-schema/legacy-compatibility.ts
- F-SOL-03 [P1/correctness] Absent corpus indistinguishable from valid empty corpus — pre-discovery reads as a pass @ .opencode/skills/system-deep-loop/deep-alignment/scripts/check-convergence.cjs
- F-SOL-02 [P1/correctness] Duplicate/orphan corpus lane IDs accepted; the two readers disagree @ .opencode/skills/system-deep-loop/runtime/scripts/reduce-alignment-state.cjs
- F-SOL-01 [P1/correctness] Alignment corpus/config bijection unvalidated — omitted lane silently drops from coverage @ .opencode/skills/system-deep-loop/runtime/scripts/reduce-alignment-state.cjs
- F-023-03 [P1/traceability] Council compatibility rejects live heartbeat and terminal state records @ .opencode/skills/system-deep-loop/runtime/lib/deep-ai-council-ledger-schema/legacy-compatibility.ts
- F-023-02 [P1/traceability] Alignment compatibility cannot migrate live identity and convergence records @ .opencode/skills/system-deep-loop/runtime/lib/deep-alignment-ledger-schema/legacy-compatibility.ts

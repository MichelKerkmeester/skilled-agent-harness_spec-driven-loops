# Deep-review leaf — iteration 36 of 40 (maintainability)
...
## Focus
Type discipline: as-casts, any, closed-shape violations across runtime/lib TS
...
- F-035-03 [P1/maintainability] Benchmark postconditions can depend on arbitrary host paths @ .opencode/skills/system-deep-loop/shared/behavior-benchmark/behavior-bench-run.cjs
- F-035-02 [P1/maintainability] Shared-packet leaf identity makes two workflow routes unobservable @ .opencode/skills/system-deep-loop/shared/references/smart-routing.md
- F-035-01 [P1/maintainability] Four commands are promoted before the required evidence mechanism exists @ .opencode/skills/system-deep-loop/shared/rollout/command-injection-rollout.json

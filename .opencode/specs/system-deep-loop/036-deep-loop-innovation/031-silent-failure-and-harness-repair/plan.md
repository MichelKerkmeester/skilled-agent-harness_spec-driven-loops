...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-deep-loop/036-deep-loop-innovation/031-silent-failure-and-harness-repair --strict`
<!-- /ANCHOR:testing -->

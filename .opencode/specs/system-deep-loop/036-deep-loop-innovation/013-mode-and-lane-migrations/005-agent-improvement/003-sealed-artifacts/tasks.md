...
- [ ] T002 Read the shared phase-007 sealing primitive and deep-improvement-common adapter contract; record canonicalization, dependency, seal-on-write, publication, verification, lifecycle, and failure semantics

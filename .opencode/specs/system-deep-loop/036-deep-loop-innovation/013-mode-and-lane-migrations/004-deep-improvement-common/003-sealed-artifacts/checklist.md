...
_memory:
  continuity:
    ...
    next_safe_action: "Run the seal verifier after the phase-007 primitive and reducer contracts are frozen"
    blockers: []
    key_files: []
    completion_pct: 0
    open_questions: []
...
- [ ] CHK-002 [P0] The phase-007 sealing primitive contract records canonicalization, digest, dependency, seal-on-write, publication, verification, and failure semantics
...
- [ ] CHK-006 [P0] Every artifact kind uses the phase-007 sealing adapter; no second digest, signature, chain, manifest, storage, or verification scheme exists
...
- [ ] CHK-028 [P1] Implementation and fixture changes land in dependency-closed, path-scoped commits after the predecessor reducer and phase-007 sealing contracts are pinned
<!-- /ANCHOR:file-org -->

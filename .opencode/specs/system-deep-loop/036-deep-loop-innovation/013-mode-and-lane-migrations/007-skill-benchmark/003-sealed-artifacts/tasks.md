...
- [ ] T002 Read the shared phase-007 sealing primitive and record canonicalization, digest, dependency, seal-on-write, publication, lifecycle, and verification semantics
...
- [ ] T007 [P] Define the single phase-007-backed Skill Benchmark sealing adapter, typed reference, dependency manifest, lifecycle, visibility, and verification result

...
- [ ] CHK-002 [P0] The phase-007 sealing primitive records canonicalization, digest, dependency, seal-on-write, publication, lifecycle, verification, and failure semantics
...
- [ ] CHK-030 [P1] Implementation and fixture changes land in dependency-closed, path-scoped commits after the reducer, phase-007 sealing, and mode-004 common-service contracts are pinned
<!-- /ANCHOR:file-org -->

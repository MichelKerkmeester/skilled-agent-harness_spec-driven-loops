...
_memory:
  continuity:
    packet_pointer: "system-deep-loop/034-deep-loop-innovation/006-transition-authorized-ledger-core"
...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/034-deep-loop-innovation/006-transition-authorized-ledger-core |

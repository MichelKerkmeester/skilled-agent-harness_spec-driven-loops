...
parent: "system-deep-loop/034-deep-loop-innovation/005-fanout-live-tools-unblock"
_memory:
  continuity:
...
- **Reference implementation**: preserve the proven mechanisms in `.opencode/specs/system-deep-loop/034-deep-loop-innovation/002-deep-loop-effectiveness-and-fanout/scratch/fanout-prototype.cjs` while adapting them to production config validation and hermetic tests.
<!-- /ANCHOR:architecture -->

...
parent: "system-deep-loop/034-deep-loop-innovation/017-integrate-latest-and-closeout"
_memory:
  continuity:
    packet_pointer: "system-deep-loop/034-deep-loop-innovation/017-integrate-latest-and-closeout"
...
- [ ] T002 Confirm the pinned 000 baseline, parent 065 status, phase-tree manifest, open-item ledger, and changelog surfaces (`034-deep-loop-innovation/`) [30m]
...
- [ ] T016 Reconcile parent phase-map status, child status fields, completion percentages, changelogs, and open-item dispositions (`034-deep-loop-innovation/`) [1h]

...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/034-deep-loop-innovation/011-convergence-termination-and-health/002-cycle-detection |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Planned |
| **Created** | 2026-07-15 |
...
(`.opencode/specs/system-deep-loop/034-deep-loop-innovation/spec.md` and

...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/034-deep-loop-innovation/007-shared-evidence-and-control-services/003-blinded-adjudication-service |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Planned |
| **Created** | 2026-07-15 |
...
Sources: `.opencode/specs/system-deep-loop/034-deep-loop-innovation/004-architecture-coverage-and-transition-contract/001-spine-architecture-adr/spec.md`;

...
parent: "system-deep-loop/034-deep-loop-innovation/007-shared-evidence-and-control-services"
_memory:
  continuity:
    packet_pointer: "system-deep-loop/034-deep-loop-innovation/007-shared-evidence-and-control-services/005-stream-fold-gauges"
...
> Phase adjacency under `007-shared-evidence-and-control-services` (navigation order, not a hard runtime dependency): predecessor `004-hierarchical-typed-budgets`; successor `006-locks-and-fencing`.
...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/034-deep-loop-innovation/007-shared-evidence-and-control-services/005-stream-fold-gauges |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Planned |
| **Created** | 2026-07-15 |
...
`006-transition-authorized-ledger-core/002-typed-append-only-ledger/spec.md`. Each gauge has an immutable identity,

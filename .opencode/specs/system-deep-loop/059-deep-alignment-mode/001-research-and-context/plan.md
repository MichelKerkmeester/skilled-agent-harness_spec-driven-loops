...
- **Reference-implementation pass**: Read `.opencode/specs/skilled-agent-orchestration/130-hub-doc-conformance-review/review/deep-review-strategy.md` and `131-hub-doc-conformance-fixes/spec.md`, recording the manual scoping question, ruleset, and verify-first fix pattern those packets used.

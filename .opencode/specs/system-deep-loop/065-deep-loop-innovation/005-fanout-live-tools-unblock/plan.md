...
- **Reference implementation**: preserve the proven mechanisms in `.opencode/specs/system-deep-loop/065-deep-loop-innovation/002-deep-loop-effectiveness-and-fanout/scratch/fanout-prototype.cjs` while adapting them to production config validation and hermetic tests.
<!-- /ANCHOR:architecture -->

...
| Dependency | `016-whole-system-gate` contract and receipts | The final program claim cannot be reproduced | Treat the phase-013 outcome in the parent and manifest as the minimum gate contract; require the phase-013 artifact set before execution |

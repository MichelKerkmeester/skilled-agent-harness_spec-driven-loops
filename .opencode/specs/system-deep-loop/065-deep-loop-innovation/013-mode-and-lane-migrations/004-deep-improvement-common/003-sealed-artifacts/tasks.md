...
- [ ] T002 Read the phase-003 sealing primitive contract and record canonicalization, digest, dependency, seal-on-write, publication, verification, and failure semantics
...
- [ ] T006 [P] Define the single phase-003-backed sealing adapter and typed artifact reference, dependency manifest, lifecycle, verification result, and failure vocabulary

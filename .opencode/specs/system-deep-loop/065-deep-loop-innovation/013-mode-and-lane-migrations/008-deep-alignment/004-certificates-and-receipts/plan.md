...
_memory:
  continuity:
    ...
    open_questions:
      ...
      - "Which phase-009 fields are inherited by alignment receipts?"
    answered_questions:
...
| Aspect | Value |
|--------|-------|
| **Surface** | system-deep-loop / deep-alignment (mode 008, child 004) |
...
certificate primitives. Phase 009 supplies the shared review-loop contract used by Deep Alignment and Deep Review. The design
...
- [ ] Phase 009 publishes the shared review-loop identity, transition result, lineage, causal-link, replay, handoff, and write-set contracts used by Deep Alignment and Deep Review.
...
### Definition of Done
- [ ] The run certificate and transition receipt fields are ratified against phase `003-sealed-artifacts` and phase 009.
...
- Keep Deep Alignment and Deep Review on the same phase-009 review-loop transitions. Mode extensions carry only Deep Alignment authority, applicability, proof, and conformance fields; they do not duplicate shared run, scope, pass, lineage, convergence, continuity, or terminal semantics.
<!-- /ANCHOR:architecture -->
...
This phase consumes phase `003-sealed-artifacts` certificate and receipt primitives, phase 009 shared review-loop and replay
...
the inherited phase-009 fields and must not receive a Deep Alignment-only review-loop fork. Shadow parity, rollback, and the
...
explicit blocked compatibility outcomes. Any phase `003-sealed-artifacts` or phase 009 contract change invalidates the

...
candidate SHA, phase-003 and phase-009 contract revisions, event-vocabulary revision, fixture manifest hash, commands,
...
- [ ] CHK-001 [P0] Phase 003 publishes the transition-authorized envelope and append boundary; phase 009 publishes the shared review-loop, event, lineage, and replay contracts
...
- [ ] CHK-022 [P0] Every event append is rejected when phase-003 authorization metadata is absent, stale, or inconsistent with the transition
...
- [ ] CHK-029 [P1] Authorization, lineage, and replay references cannot be supplied by an untrusted payload in place of the phase-003 gateway result
<!-- /ANCHOR:security -->
...
Signed off when the SOL verifier confirms the typed Deep Review event vocabulary, phase-003 authorization coverage,
phase-009 shared review-loop alignment, fail-closed upcaster behavior, candidate adjudication boundary, and

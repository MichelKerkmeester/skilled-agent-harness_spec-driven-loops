...
| **Inputs** | Parent `065-deep-loop-innovation/spec.md`; `manifest/phase-tree.json`; `findings-registry.json`; `findings-registry-modes.json`; Deep Research phase 009 shadow-parity contract; shared transition and rollback policy |
<!-- /ANCHOR:metadata -->

...
- [ ] The shared phase-003 sealing primitive and deep-improvement-common adapter publish canonicalization, digest, dependency, seal-on-write, publication, and verification semantics
...
- **Single sealing adapter**: use the deep-improvement-common adapter over the phase-003 primitive for canonicalize, digest, seal, publish, inspect, and verify. The agent variant owns fields and bindings, not alternate cryptography or storage.
...
- Read the shared phase-003 sealing primitive and deep-improvement-common adapter contract; record canonicalization, dependency ordering, publication, verification, lifecycle, and failure semantics. Reject duplicate sealing behavior.
...
|-------------|--------------|
| REQ-001 | Adapter contract tests prove every agent artifact uses the common phase-003-backed seal and reject alternate seal metadata or verification paths |
...
The primary inputs are `002-reducers-and-projections` for artifact references and shared service status, the shared phase-003

...
- [ ] CHK-002 [P0] The shared phase-003 sealing primitive and deep-improvement-common adapter record canonicalization, digest, dependency, seal-on-write, publication, verification, lifecycle, and failure semantics
...
- [ ] CHK-006 [P0] Every agent artifact kind uses the shared phase-003-backed sealing adapter; no second digest, signature, chain, manifest, storage, or verification scheme exists

---
title: "Checklist: Agent Improvement certificates and receipts (013 mode migration)"
...
parent: "system-deep-loop/065-deep-loop-innovation/013-mode-and-lane-migrations/005-agent-improvement/004-certificates-and-receipts"
_memory:
  continuity:
...
- [ ] CHK-007 [P2] BASE SHA, phase-003 primitive digest, sealed-artifact schema digest, common-service epoch digests, and fixture manifest hash are recorded in the candidate report
<!-- /ANCHOR:pre-impl -->
...
- [ ] CHK-013 [P0] Phase-003 receipt/certificate primitives and `003-sealed-artifacts` references validate across compatible versions and reject silent coercion on incompatible versions

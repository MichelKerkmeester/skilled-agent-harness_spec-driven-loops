---
title: "Tasks: Agent Improvement certificates and receipts (013 mode migration)"
...
- [ ] T001 Confirm the phase-012 shared contracts, write-set graph, phase-003 primitives, and `003-sealed-artifacts` boundary are frozen before implementation
...
- [ ] T008 Bind phase-003 primitives and `003-sealed-artifacts` references as versioned dependencies with explicit incompatibility handling

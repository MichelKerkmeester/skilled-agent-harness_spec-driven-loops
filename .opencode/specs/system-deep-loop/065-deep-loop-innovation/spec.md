...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/065-deep-loop-innovation |
...
- **New capabilities beyond the 178 recs.** No speculative features; the bijective ledger (phase 004) is the scope fence.

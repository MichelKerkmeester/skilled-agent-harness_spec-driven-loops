...
- **Cutover policy**: See `../../001-architecture-coverage-and-transition-contract/003-transition-versioning-and-rollback-policy/spec.md`
- **Shadow parity**: See `../../005-compatibility-shadow-and-rollback-bridge/003-shadow-parity-harness/spec.md`
- **Rollback drills**: See `../../005-compatibility-shadow-and-rollback-bridge/005-rollback-drills/spec.md`
<!-- /ANCHOR:cross-refs -->

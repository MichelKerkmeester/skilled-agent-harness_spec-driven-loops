...
The phase consumes the [phase-005 in-flight classification](../../005-compatibility-shadow-and-rollback-bridge/004-inflight-state-classification/spec.md),
the [phase-004 locks and fencing contract](../../004-shared-evidence-and-control-services/006-locks-and-fencing/spec.md),

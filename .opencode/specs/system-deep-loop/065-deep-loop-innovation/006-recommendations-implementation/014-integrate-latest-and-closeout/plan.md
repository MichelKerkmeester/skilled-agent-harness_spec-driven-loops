...
### Definition of Ready
- [ ] `013-whole-system-gate` is green on its pre-integration SHA with receipts and exact candidate evidence
...
| `013-whole-system-gate` artifacts | Internal gate | Yellow | Final-SHA verification cannot be replayed until the phase-013 contract and receipts are available |

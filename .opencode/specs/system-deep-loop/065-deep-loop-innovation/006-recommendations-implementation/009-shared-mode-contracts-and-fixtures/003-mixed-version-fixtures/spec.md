...
> Phase adjacency under `009-shared-mode-contracts-and-fixtures` (navigation order, not a hard runtime dependency): predecessor `002-cross-mode-closures`; successor `004-write-set-conflict-graph`.
...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/065-deep-loop-innovation/006-recommendations-implementation/009-shared-mode-contracts-and-fixtures/003-mixed-version-fixtures |
| **Level** | 2 |
| **Priority** | P0 |
| **Status** | Planned |
| **Created** | 2026-07-15 |
...
authority on the legacy path (`../../005-compatibility-shadow-and-rollback-bridge/003-shadow-parity-harness/spec.md`).
The phase-004 sealed-reference-artifact contract supplies the only trusted way to freeze the prompt set, initial state,
configuration, prior outputs, and evaluator material used by a replay (`../../004-shared-evidence-and-control-services/

...
_memory:
  continuity:
    ...
    next_safe_action: "Define the four scenario families against the phase-005 contracts"
    blockers: []
    key_files: []
    completion_pct: 0
    open_questions: []
...
- [ ] T001 Read the parent spec, `manifest/phase-tree.json`, phase-004 sealed-reference-artifact spec, phase-005 upcaster spec, and phase-005 shadow-parity spec; record fixture obligations and authority constraints
- [ ] T002 [P] Derive the eight phase-010 workstream rows and deep-improvement-common ordering directly from `mode_workstreams_phase_010`
- [ ] T003 [P] Inventory supported event and state versions, adjacent upcaster edges, causal-boundary fields, and comparable event/state pairs from the phase-005 contracts
...
- [ ] T011 Implement phase-004 sealing and verified-read setup for prompts, state, events, configuration, evaluator material, prior outputs, version policy, and restart metadata
- [ ] T012 Implement phase-005 upcaster and dual-read invocation with stored/effective versions, adjacent hop traces, immutable source references, and typed fail-closed results
...
- [ ] T014 Implement phase-005 shadow-parity handoff from one verified capsule to isolated legacy and dark roots without authority mutation
...
- [ ] T016 Publish the manifest-derived fixture matrix and handoff identities for phase 010 and the phase-005 parity certificate precondition
<!-- /ANCHOR:phase-2 -->
...
- [ ] T023 Verify: Every replay-affecting input is verified by phase 004 and seal mutation, alias use, missing bytes, or wrong order blocks execution
...
- **Sealed artifacts**: See `../../004-shared-evidence-and-control-services/002-sealed-reference-artifacts/spec.md`
- **Upcasters and dual-read adapters**: See `../../005-compatibility-shadow-and-rollback-bridge/001-upcasters-and-dual-read-adapters/spec.md`
- **Shadow-parity harness**: See `../../005-compatibility-shadow-and-rollback-bridge/003-shadow-parity-harness/spec.md`
<!-- /ANCHOR:cross-refs -->

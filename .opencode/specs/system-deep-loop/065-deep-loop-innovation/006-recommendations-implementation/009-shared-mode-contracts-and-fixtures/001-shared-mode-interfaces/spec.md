...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/065-deep-loop-innovation/006-recommendations-implementation/009-shared-mode-contracts-and-fixtures/001-shared-mode-interfaces |
| **Level** | 2 |
| **Priority** | P0 |
| **Status** | Planned |
| **Created** | 2026-07-15 |
...
- **Dependencies**: `003-transition-authorized-ledger-core/spec.md`, `004-shared-evidence-and-control-services/spec.md`, `008-convergence-termination-and-health/spec.md`, `manifest/phase-tree.json`, and the parent `../spec.md` are the source contracts; phase 010 consumes this phase's frozen interface.
<!-- /ANCHOR:risks -->

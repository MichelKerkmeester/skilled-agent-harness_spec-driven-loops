...
### Definition of Ready
- [ ] The parent `009-shared-mode-contracts-and-fixtures` outcome and phase adjacency are recorded.
...
- Extract the stable interface obligations from `003-transition-authorized-ledger-core/spec.md`, `004-shared-evidence-and-control-services/spec.md`, and `008-convergence-termination-and-health/spec.md` into a requirement-to-port matrix.

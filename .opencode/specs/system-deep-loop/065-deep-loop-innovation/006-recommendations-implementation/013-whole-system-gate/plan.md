...
### Definition of Ready
- [ ] `012-legacy-writer-retirement` has passed zero-use telemetry, rollback evidence, and archival-reader checks
...
### Phase 1: Setup
- Confirm `012-legacy-writer-retirement` evidence and the phase adjacency; do not start from a moving checkout.

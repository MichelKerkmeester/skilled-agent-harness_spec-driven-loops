...
> Phase adjacency under `006-fanout-fanin-durable-orchestration` (navigation order, not a hard runtime dependency): predecessor `002-result-envelopes-and-resume-salvage`; successor `004-conditional-budget-aware-fanin`.
...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/065-deep-loop-innovation/006-recommendations-implementation/006-fanout-fanin-durable-orchestration/003-logical-branch-ids-leases-waves |
| **Level** | 2 |
| **Priority** | P0 |
| **Status** | Planned |
| **Created** | 2026-07-15 |
...
- Designing the shared lease coordinator or fencing-token store. Phase `004-shared-evidence-and-control-services/006-locks-and-fencing` owns those primitives; this phase consumes and specializes them.

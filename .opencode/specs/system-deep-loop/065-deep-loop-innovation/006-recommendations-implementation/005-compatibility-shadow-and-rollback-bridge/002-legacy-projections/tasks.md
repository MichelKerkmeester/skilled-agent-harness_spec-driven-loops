...
- **Plan**: See `plan.md`
- **Schema census**: See `../../000-baseline-taxonomy-and-state-census/spec.md`
- **Dark ledger**: See `../../003-transition-authorized-ledger-core/002-typed-append-only-ledger/spec.md`

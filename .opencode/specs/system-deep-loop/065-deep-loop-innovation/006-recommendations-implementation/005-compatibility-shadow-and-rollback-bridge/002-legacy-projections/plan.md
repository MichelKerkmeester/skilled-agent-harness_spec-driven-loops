...
`000-baseline-taxonomy-and-state-census/spec.md`, the verified ledger contract from
`003-transition-authorized-ledger-core/002-typed-append-only-ledger/spec.md`, the migration posture in

...
> Phase adjacency under `007-novelty-claims-continuity-and-projections` (navigation order, not a hard runtime dependency): predecessor `004-next-focus-semantics`; successor none (last sibling).
...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/065-deep-loop-innovation/006-recommendations-implementation/007-novelty-claims-continuity-and-projections/005-transactional-projections-and-gauges |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Planned |
| **Created** | 2026-07-15 |
...
`../../003-transition-authorized-ledger-core/002-typed-append-only-ledger/spec.md` provides immutable verified order,
idempotent append, integrity linkage, and deterministic reduction. The stream-fold gauge contract in
`../../004-shared-evidence-and-control-services/005-stream-fold-gauges/spec.md` defines versioned pure folds and

...
`../../003-transition-authorized-ledger-core/002-typed-append-only-ledger/spec.md` and
`../../003-transition-authorized-ledger-core/003-replay-fingerprints/spec.md`, plus run-2
`../../../../005-deep-loop-effectiveness-and-fanout/research/research-modes.md`.
<!-- /ANCHOR:architecture -->

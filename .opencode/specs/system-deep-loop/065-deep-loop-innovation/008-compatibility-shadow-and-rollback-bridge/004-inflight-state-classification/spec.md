...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/065-deep-loop-innovation/008-compatibility-shadow-and-rollback-bridge/004-inflight-state-classification |
| **Level** | 2 |
| **Priority** | P0 |
| **Status** | Planned |
| **Created** | 2026-07-15 |
...
The [phase-000 census specification](../../003-baseline-taxonomy-and-state-census/spec.md) requires a row-addressable
...
The [phase-001 transition and rollback policy](../../004-architecture-coverage-and-transition-contract/003-transition-versioning-and-rollback-policy/spec.md)
...
[phase-000 census](../../003-baseline-taxonomy-and-state-census/spec.md), inherits deterministic upcasting and
rollback constraints from the [phase-001 policy](../../004-architecture-coverage-and-transition-contract/003-transition-versioning-and-rollback-policy/spec.md),

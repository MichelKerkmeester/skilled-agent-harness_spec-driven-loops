...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/065-deep-loop-innovation/011-convergence-termination-and-health/001-path-covering-termination |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Planned |
| **Created** | 2026-07-15 |
...
(`.opencode/specs/system-deep-loop/065-deep-loop-innovation/manifest/phase-tree.json:15`-`:17`).

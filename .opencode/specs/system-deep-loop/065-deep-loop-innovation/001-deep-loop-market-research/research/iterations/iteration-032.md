...
- The strongest ablation is “Debate or Vote?” Across seven benchmarks, independent majority voting captured most gains attributed to debate; unbiased debate was modeled as a martingale, providing no expected correctness improvement. `deep-ai-council` should begin with independent answers and escalate only when disagreement or verification risk warrants the extra rounds. The repository has ~76 stars; it accompanied a NeurIPS 2025 Spotlight paper, while its latest commit year was not surfaced. [Paper](https://arxiv.org/abs/2508.17536), [repository](https://github.com/deeplearning-wisc/debate-or-vote).

- Effectiveness is conditional. A 2025 systematic study found little advantage over matched self-agent scaling on ordinary mathematics, with better relative results on harder problems and weaker models. On safety tasks, collaborative refinement could increase vulnerability; heterogeneous configurations helped counter that effect. [Study](https://arxiv.org/abs/2505.22960). Earlier DebateLLM experiments similarly found untuned debate unreliable against self-consistency and ensembling, but sensitive hyperparameter tuning could reverse the result. [Paper](https://arxiv.org/abs/2311.17371), [repository](https://github.com/instadeepai/DebateLLM).

- Agreement is not a safe convergence signal. Problem-drift research across ten tasks attributed failures chiefly to no progress (35%), poor feedback (26%), and unclear reasoning (25%); its intervention mitigated only 31% of drift cases. [EACL 2026 paper](https://aclanthology.org/2026.findings-eacl.268/). Controlled logical-reasoning experiments also found majority pressure suppressing independent correction. [Controlled study](https://arxiv.org/abs/2511.07784).

- Adjudication needs evidence and calibrated reliability. ReConcile reported gains up to 11.4% using heterogeneous models and confidence-weighted consensus, but newer controlled evidence says reported confidence and structural details contribute less reliably than underlying reasoning strength. [ReConcile](https://arxiv.org/abs/2309.13007). Preserve minority arguments, score externally verifiable claims, and treat self-confidence as one feature—not authority.

- Full-transcript broadcasting is probably wasteful. DAR selectively retains maximally distinct dissenting messages instead of rebroadcasting every response, targeting both redundancy and noise. This is a promising `deep-ai-council` fan-in policy, but currently rests on a March 2026 preprint. [Paper](https://arxiv.org/abs/2603.20640), [repository](https://github.com/DA2I2-SLM/DAR).

```json
{
  "new_repos": [
    {
      "name": "deeplearning-wisc/debate-or-vote",
      "url": "https://github.com/deeplearning-wisc/debate-or-vote",
      "stars": "~76",
      "what": "NeurIPS 2025 Spotlight code separating majority-vote gains from inter-agent debate; latest commit year was not surfaced.",
      "lesson": "Run independent proposals plus voting first, and spend debate rounds only when a targeted correction signal exists.",
      "maps_to": [
        "deep-ai-council",
    ...
    {
      "name": "instadeepai/DebateLLM",
      "url": "https://github.com/instadeepai/DebateLLM",
      "stars": "unknown",
      "what": "Benchmark suite for cost, latency, accuracy, agreement, and protocol comparisons behind the 2023 Should we be going MAD? study; latest commit year was not verified.",
      "lesson": "Treat council protocols as tunable policies benchmarked against self-consistency and ensembling, not as inherently superior architectures.",
      "maps_to": [
        "deep-ai-council",
        "runtime/convergence",
        "runtime/budget-cost"
    ...
    {
      "name": "dinobby/ReConcile",
      "url": "https://github.com/dinobby/ReConcile",
      "stars": "unknown",
      "what": "Official ACL 2024 code for heterogeneous round-table reasoning with confidence-weighted consensus; latest commit year was not verified.",
      "lesson": "Use heterogeneous seats and reliability-aware aggregation, while calibrating confidence against observed accuracy or external evidence.",
      "maps_to": [
        "deep-ai-council",
        "runtime/fan-out-fan-in",
    ...
    },
    {
      ...
      "stars": "unknown",
      "what": "March 2026 preprint implementation of diversity-aware message retention for efficient multi-agent debate; repository stars and latest commit were not independently surfaced.",
      "lesson": "Fan-in should retain representative disagreement rather than broadcasting every redundant council message.",
      "maps_to": [
        "deep-ai-council",
        "runtime/fan-out-fan-in",
  ...
  "insights": [
    {
      "insight": "Adopt vote-first, debate-by-exception: collect independent answers, aggregate them, then open debate only for split votes, verifier conflicts, high-impact uncertainty, or credible minority objections.",
      "evidence": "https://arxiv.org/abs/2508.17536 ; https://github.com/deeplearning-wisc/debate-or-vote",
      "maps_to": [
        "deep-ai-council",
        "runtime/fan-out-fan-in",
        "runtime/budget-cost"
    ...
    {
      "insight": "Route debate conditionally by task difficulty, base-model strength, and risk domain: its marginal value rises on harder tasks and weaker models, while collaborative safety discussion can amplify attacks unless panel diversity is deliberately introduced.",
      "evidence": "https://arxiv.org/abs/2505.22960 ; https://arxiv.org/abs/2311.17371",
      "maps_to": [
        "deep-ai-council",
        "deep-alignment",
        "runtime/convergence",
    ...
    {
      "insight": "Replace agreement-only convergence with a progress-and-drift gate measuring claim-level novelty, relevance to the original question, feedback quality, unresolved dissent, and answer correctness where verification is available.",
      "evidence": "https://aclanthology.org/2026.findings-eacl.268/ ; https://arxiv.org/abs/2511.07784",
      "maps_to": [
        "deep-ai-council",
        "runtime/convergence",
        "runtime/gauges-observability",
    ...
    {
      "insight": "Adjudicators should receive independent first answers, cited evidence, historical seat reliability, and an explicit dissent register; self-reported confidence and final consensus should remain non-binding features.",
      "evidence": "https://arxiv.org/abs/2309.13007 ; https://arxiv.org/abs/2511.07784",
      "maps_to": [
        "deep-ai-council",
        "deep-review",
        "runtime/dedup-novelty",
    ...
    {
      "insight": "Use diversity-aware transcript compression: retain arguments farthest from both one another and the majority, plus evidence-bearing corrections, instead of replaying the complete debate to every seat.",
      "evidence": "https://arxiv.org/abs/2603.20640 ; https://github.com/DA2I2-SLM/DAR",
      "maps_to": [
        "deep-ai-council",
        "runtime/fan-out-fan-in",
        "runtime/dedup-novelty",
  ...
  "contradictions": [
    {
      "claim": "Iterative debate itself improves collective correctness.",
      "counter": "Across seven benchmarks, majority voting accounted for most observed gains, and unbiased debate produced no expected correctness improvement under the paper's belief-update model.",
      "evidence": "https://arxiv.org/abs/2508.17536"
    },
    {
      "claim": "Heterogeneous model diversity is generally critical to debate gains.",
      "counter": "ReConcile found diversity critical and reported large gains, whereas a newer matched-scaling study found little mathematical benefit from diversity; the effect appears task- and risk-dependent.",
      "evidence": "https://arxiv.org/abs/2309.13007 ; https://arxiv.org/abs/2505.22960"
    },
    {
      "claim": "More rounds allow agents to progressively correct one another.",
      "counter": "Longer discussions can drift, repeat low-quality feedback, and amplify majority pressure, suppressing correct minority revisions.",
      "evidence": "https://aclanthology.org/2026.findings-eacl.268/ ; https://arxiv.org/abs/2511.07784"
    },
    {
      "claim": "Broadcasting the full transcript gives every agent the information needed for better decisions.",
      "counter": "Full broadcasts introduce redundant and noisy messages; early DAR results favor retaining a small set of authentic disagreements.",
      "evidence": "https://arxiv.org/abs/2603.20640"
    }
  ],
  "next_angles": [
    "Run a token- and call-matched causal benchmark of one-shot, best-of-N vote, transcript-free adjudication, one-round critique, multi-round debate, and verifier-gated debate across model-strength and difficulty strata.",
    "Compare blinded adjudication against transcript-exposed adjudication to measure persuasion, verbosity, position, authority, and majority-pressure bias while holding candidate answers fixed.",
    "Benchmark all-to-all, sparse-neighbor, representative-dissent, claim-graph, and adjudicator-only communication under family-correlated agent failures and identical token budgets.",
    "Learn a debate-escalation policy from independent-answer entropy, verifier conflict, task risk, predicted difficulty, and expected quality gain per additional token.",
    "Adversarially test councils with persuasive wrong majorities, malicious minority seats, shared-model correlated errors, and evidence-injection attacks."
  ],
  "notes": "Four repositories are new relative to the supplied 149-repository exclusion set. Exact star counts and latest commit years were not exposed for DebateLLM, ReConcile, or DAR, so they remain unknown rather than estimated. DAR is a recent preprint and needs independent replication. The largest remaining gap is a resource-symmetric evaluation that separates sampling, voting, interaction, adjudication, and verification costs on identical model snapshots."
}
```
...
session id: 019f6308-467a-7432-8896-14d3e1678567
--------
user
You are iteration 32/45 of a NON-CONVERGING (deliberately BROADENING) research loop mapping the state of the art in LOOP ENGINEERING for agentic / iterative AI systems.
...
THIS ITERATION'S ANGLE: Multi-agent debate: when it helps vs hurts
DIRECTIVE: Evidence on debate/MoA gains, adjudication design, cost/benefit. Map to deep-ai-council.
...
codex
This is a read-only deep-research iteration; no spec-folder choice is needed. I’m applying the loop’s evidence and novelty constraints, then splitting repository verification, empirical debate evidence, and adjudication/cost design so the final JSON contains only cross-checked additions.
exec
/bin/zsh -lc "python3 .opencode/skills/system-skill-advisor/mcp_server/scripts/skill_advisor.py 'Iteration 32/45 broadening research on multi-agent debate: when it helps vs hurts; evidence on debate/MoA gains, adjudication design, cost-benefit; map to deep-ai-council; read-only web research.' --threshold 0.8" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
exec
/bin/zsh -lc "node .opencode/bin/spec-memory.cjs memory_match_triggers --json '{\"prompt\":\"Iteration 32/45 broadening research on multi-agent debate: when it helps vs hurts; evidence on debate/MoA gains, adjudication design, cost-benefit; map to deep-ai-council; read-only web research.\"}' --format json --timeout-ms 3000" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 2003ms:
2026-07-15 01:48:53.832 xcodebuild[76799:203120477]  DVTFilePathFSEvents: Failed to start fs event stream.
2026-07-15 01:48:53.981 xcodebuild[76799:203120476] [MT] DVTDeveloperPaths: Failed to get length of DARWIN_USER_CACHE_DIR from confstr(3), error = Error Domain=NSPOSIXErrorDomain Code=5 "Input/output error". Using NSCachesDirectory instead.
python3: warning: confstr() failed with code 5: couldn't get path of DARWIN_USER_TEMP_DIR; using /tmp instead
python3: error: couldn't create cache file '/tmp/xcrun_db-zvPJWxXV' (errno=Operation not permitted)
2026-07-15 01:48:54.324 xcodebuild[76804:203120500]  DVTFilePathFSEvents: Failed to start fs event stream.
2026-07-15 01:48:54.421 xcodebuild[76804:203120499] [MT] DVTDeveloperPaths: Failed to get length of DARWIN_USER_CACHE_DIR from confstr(3), error = Error Domain=NSPOSIXErrorDomain Code=5 "Input/output error". Using NSCachesDirectory instead.
...
[
  {
    ...
    "reason": "Matched: !deep-ai-council(keyword), !deep-ai-council(signal), council, deep(name), research [Candidate-3 deep routing: system-deep-loop ai-council MED]",
...
codex
SKILL ROUTING: `system-deep-loop` matched at 0.95 confidence. The advisor suggested `ai-council` from the topic, but the requested artifact is explicitly a `/deep:research` iteration about council design, so research mode governs; `deep-ai-council` is the transfer target. Memory-trigger lookup was attempted and unavailable because the local daemon socket is sandbox-blocked.
exec
/bin/zsh -lc "rg --files .opencode/skills/system-deep-loop .opencode/commands 2>/dev/null | rg '(SKILL\\.md"'$|deep.*/research|research.*'"\\.md"'$|ai-council)'"'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
.opencode/commands/deep/assets/compiled/deep_ai-council.contract.md
...
.opencode/commands/deep/assets/legacy/deep_ai-council.body.md
...
exec
/bin/zsh -lc "sed -n '1,220p' .opencode/skills/system-deep-loop/mode-registry.json && sed -n '1,220p' .opencode/commands/deep/research.md" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
{
  "skill": "system-deep-loop",
  "version": "2.0.0.0",
...
FILE .opencode/skills/system-deep-loop/deep-research/references/protocol/loop_protocol.md
---
...
FILE .opencode/skills/system-deep-loop/deep-research/references/state/state_outputs.md
---
...
FILE .opencode/skills/system-deep-loop/deep-research/references/convergence/convergence_signals.md
---
...
exec
/bin/zsh -lc "sed -n '190,390p' .opencode/skills/system-deep-loop/deep-research/references/protocol/loop_protocol.md" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
     Research paused. Delete research/.deep-research-pause to resume.
     Current state: Iteration {N}, {remaining} questions remaining.
     ```
...
exec
/bin/zsh -lc "rg --files .opencode/specs/system-deep-loop/065-deep-loop-innovation/001-deep-loop-market-research | rg 'deep-research-(state\\.jsonl|strategy\\.md)"'$'"'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc 'tail -n 12 .opencode/specs/system-deep-loop/065-deep-loop-innovation/001-deep-loop-market-research/research/deep-research-state.jsonl' in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
codex
The prior state confirms iteration 31 ended at 149 repositories and 154 insights, matching the prompt. I’m now testing the strongest empirical split: independent sampling versus interaction, heterogeneous versus homogeneous panels, and whether an adjudicator earns its extra tokens.
web search: 
web search: site:arxiv.org multi-agent debate language models when hurts cost adjudication empirical study ...
web search: 
web search: instadeepai DebateLLM Should we be going MAD paper results agents rounds cost ...
web search: 
web search: "Revisiting Multi-Agent Debate as Test-Time Scaling" conditional effectiveness results ...
codex
The evidence favors debate as an escalation path, not the default council protocol.

...
- [ ] T001 Pin the baseline and confirm the verified phase-003 reader, phase-004 gauge registry, phase-007 event contracts, storage transaction features, and legacy observability authority.
...
- [ ] T007 Implement fenced expected-watermark apply so all affected views, phase-004 gauges, the receipt, and watermark commit in one transaction or roll back together.
...
- [ ] T013 Add additive-dark adapters and comparison evidence for `runtime/lib/deep-loop/observability-events.cjs`, legacy views, and phase-004 gauge outputs.
<!-- /ANCHOR:phase-2 -->
...
- [ ] T019 Verify phase-004 gauge golden outputs remain byte-identical when composed into the transactional projection bundle.

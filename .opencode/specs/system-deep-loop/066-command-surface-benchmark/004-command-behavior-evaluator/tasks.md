...
_memory:
  continuity:
    packet_pointer: "system-deep-loop/066-command-surface-benchmark/004-command-behavior-evaluator"
...
Parent: `system-deep-loop/066-command-surface-benchmark`. Predecessor: 003-command-lane-integration. Successor: 005-command-topology-pilot.
<!-- /ANCHOR:cross-refs -->

...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/system-deep-loop/030-deep-loop-improved/011-followup-remediation/003-scaffold-content-002-deep-loop-runtime/implementation-summary.md"
    session_dedup:

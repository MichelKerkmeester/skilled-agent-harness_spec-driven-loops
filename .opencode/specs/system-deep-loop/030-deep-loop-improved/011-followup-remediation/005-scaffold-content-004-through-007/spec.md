...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/system-deep-loop/030-deep-loop-improved/004-system-spec-kit/001-speckit-autopilot-lifecycle/spec.md"
      - ".opencode/specs/system-deep-loop/030-deep-loop-improved/005-skill-interconnection/001-advisor-routing-projection/spec.md"
      - ".opencode/specs/system-deep-loop/030-deep-loop-improved/006-ux-observability-automation/spec.md"
      - ".opencode/specs/system-deep-loop/030-deep-loop-improved/007-testing/spec.md"
    session_dedup:
...
|-----------|-------------|-------------|
| `.opencode/specs/system-deep-loop/030-deep-loop-improved/004-system-spec-kit/001-speckit-autopilot-lifecycle/` | Modify | ~2 files: `plan.md` + `tasks.md` for 1 leaf |
| `.opencode/specs/system-deep-loop/030-deep-loop-improved/005-skill-interconnection/001-advisor-routing-projection/` | Modify | ~2 files: `plan.md` + `tasks.md` for 1 leaf |
| `.opencode/specs/system-deep-loop/030-deep-loop-improved/006-ux-observability-automation/{001..006}/` | Modify | ~12 files: `plan.md` + `tasks.md` per leaf across 6 leaves |
| `.opencode/specs/system-deep-loop/030-deep-loop-improved/007-testing/{001,002}/` | Modify | ~4 files: `plan.md` + `tasks.md` per leaf across 2 leaves |
<!-- /ANCHOR:scope -->

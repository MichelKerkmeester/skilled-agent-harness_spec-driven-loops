...
- **Parent packet:** `.opencode/specs/system-deep-loop/030-deep-loop-improved/` (the `002-implementation` parent was ungrouped earlier this arc; its children are now 156 root phases `002`–`008`; the whole 156 tree validates 63/63).
- **This phase parent:** `030-deep-loop-improved/008-loop-systems-remediation/` with 6 children (below).
...
- `030-deep-loop-improved/{spec.md, description.json, graph-metadata.json}` — modified (phase-map gained the `009` row; metadata re-regenerated). **Uncommitted.**

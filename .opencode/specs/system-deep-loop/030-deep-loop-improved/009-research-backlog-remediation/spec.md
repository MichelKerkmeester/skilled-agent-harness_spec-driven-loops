...
_memory:
  continuity:
    packet_pointer: "system-deep-loop/030-deep-loop-improved/009-research-backlog-remediation"
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-deep-loop/030-deep-loop-improved/research/research.md"
    session_dedup:
...
| `030-deep-loop-improved/**/spec.md`, `graph-metadata.json`, `description.json` | Modify | 004-007 | Phase-doc-map sync, completion_pct backfill, packet-identity cleanup, registry disposition, metadata backfill, scaffold authoring |

...
Segment: 6 (synthesis) | Iteration: 46 of 58
Questions: 0/73 checked | Last focus: S6-05
Last 2 ratios: 0.42 -> 0.45 | Stuck count: 0
...
Focus Area: [S6-06] How should loop-cli's "clean failure with branch preserved beats merging unverified code" reshape the promote/rollback gate, and does it conflict with kasper's auto-apply + backup-rollback? (build on S1 ob-autopilot, S2-11) -> deep-improvement promotion gate
...
Last 3 Iterations Summary: run 43: S6-02 (ratio 0.34); run 44: S6-04 (ratio 0.42); run 45: S6-05 (ratio 0.45)
...
- Write iteration narrative to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-046.md
- Write per-iteration delta file to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-046.jsonl
...
1. Iteration narrative markdown at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-046.md` with headings: Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus. In Findings give: reference mechanism + file:line; exact OUR target file; port-difficulty (easy/med/hard); quick-win vs deep-rewrite tag.

2. Per-iteration delta file at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-046.jsonl`. Its FIRST line MUST be the canonical iteration record, EXACT type "iteration":
`{"type":"iteration","iteration":46,"newInfoRatio":<0..1>,"status":"<complete|insight|stuck>","focus":"S6-06","graphEvents":[...]}`

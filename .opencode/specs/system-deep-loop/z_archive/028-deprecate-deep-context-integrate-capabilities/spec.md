...
_memory:
  continuity:
    packet_pointer: "system-deep-loop/028-deprecate-deep-context-integrate-capabilities"
...
| **Spec Folder** | `.opencode/specs/system-deep-loop/028-deprecate-deep-context-integrate-capabilities/` |
<!-- /ANCHOR:metadata -->

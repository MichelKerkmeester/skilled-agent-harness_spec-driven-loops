---
title: "Deep Research: Improving sk-deep-research [system-deep-loop/z_archive/044-sk-deep-research-evolution/004-sk-deep-research-first-upgrade/research]"
...
_memory:
  continuity:
    packet_pointer: "system-deep-loop/z_archive/044-sk-deep-research-evolution/004-sk-deep-research-first-upgrade/research"
...
|-----------|-----------------|-----------------|--------------|
| **State container** | Config JSON + JSONL + strategy + iterations + research/research.md | .lab/ (6 files + git) | JSONL + dashboard |
...
5. **Progressive synthesis** — research/research.md updated each iteration. Neither repo has an equivalent progressive output.

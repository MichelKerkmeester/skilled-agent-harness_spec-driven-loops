...
- `.opencode/skills/sk-improve-agent/scripts/improvement-journal.cjs:148-203`
- `.opencode/skills/sk-improve-agent/scripts/improvement-journal.cjs:243-275`
- `.opencode/commands/deep/start-agent-improvement-loop.md:296-339`
- `.opencode/skills/sk-improve-agent/SKILL.md:246-300`
- `.opencode/skills/sk-improve-agent/scripts/mutation-coverage.cjs:50-53`
- `.opencode/skills/sk-improve-agent/scripts/mutation-coverage.cjs:80-93`
- `.opencode/skills/sk-improve-agent/scripts/mutation-coverage.cjs:192-205`
...
- `.opencode/skills/sk-improve-agent/assets/improvement_config.json:80-95`
- `.opencode/skills/sk-improve-agent/assets/improvement_config.json:124-129`

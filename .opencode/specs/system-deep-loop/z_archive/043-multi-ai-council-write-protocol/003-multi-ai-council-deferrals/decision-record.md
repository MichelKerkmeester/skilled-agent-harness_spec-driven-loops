...
_memory:
  continuity:
    packet_pointer: "system-deep-loop/z_archive/043-multi-ai-council-write-protocol/003-multi-ai-council-deferrals"
    ...
    session_dedup:
      ...
      session_id: "scaffold-system-deep-loop/z_archive/043-multi-ai-council-write-protocol/003-multi-ai-council-deferrals"
...
# Decision Record: Multi-AI Council Deferrals — state.jsonl v1.1 forward-compat metadata + memory-save payload routing + advisory-check + command wiring docs (packet-089 deferrals)

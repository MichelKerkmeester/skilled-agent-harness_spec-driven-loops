---
title: "Spec: Skill [system-deep-loop/z_archive/001-sk-recursive-agent-loop/011-sk-agent-improver-advisor-readme-sync/spec]"
...
- `.opencode/skills/README.md` — version bump + description update for sk-improve-agent
- `.opencode/skills/skill-advisor/scripts/skill_advisor.py` — add Phase 008+ routing entries + COMMAND_BRIDGES

---
title: "Research Report: 041 Recursive Agent [system-deep-loop/z_archive/001-sk-recursive-agent-loop/research]"
...
_memory:
  continuity:
    packet_pointer: "system-deep-loop/z_archive/001-sk-recursive-agent-loop/research"
...
This repo already has strong reusable mechanics for a similar loop: disk-first state, fresh-context iteration dispatch, reducer-managed summaries, skill auto-discovery, and canonical create/update flows for new skills. [SOURCE: .opencode/skills/sk-deep-research/SKILL.md:137] [SOURCE: .opencode/agents/deep-research.md:28] [SOURCE: .opencode/skills/README.md:42] [SOURCE: .opencode/commands/create/sk-skill.md:239]

The 10 Copilot-led extension iterations made the key gap clearer: the hard part is not packaging a skill. The hard part is defining one canonical mutable surface, one independent evaluator, one experiment ledger, and one promotion contract that respects repo guardrails. [SOURCE: AGENTS.md:12] [SOURCE: .opencode/agents/review.md:24] [SOURCE: .opencode/README.md:330]
...
Start with one canonical `.opencode/agents/*.md` file, not all runtime mirrors. Runtime copies and adjacent control files should be treated as fixed or derived until the mirror/promotion contract is explicit. [SOURCE: .opencode/README.md:330] [SOURCE: .opencode/commands/create/assets/create_agent_auto.yaml:41]
...
This matches how iterative workflows already live here: command -> workflow -> leaf agent -> disk state -> reducer-managed summaries. [SOURCE: .opencode/skills/sk-deep-research/SKILL.md:137] [SOURCE: .opencode/commands/create/README.txt:126] [SOURCE: .opencode/skills/sk-doc/assets/agents/agent_template.md:41]

### 4.3 Reuse the Packet Skeleton, Not the Research Semantics
Deep research already provides the right externalized-state skeleton: immutable config, append-only JSONL, mutable strategy, write-once iteration files, and reducer-owned dashboard/registry surfaces. [SOURCE: .opencode/skills/sk-deep-research/references/state_format.md:15] [SOURCE: .opencode/agents/deep-research.md:159]
...
[SOURCE: .opencode/skills/sk-deep-research/references/state_format.md:132] [SOURCE: .opencode/skills/sk-deep-research/references/convergence.md:25]
...
- document-integrity checks for references, metadata, and handover resume targets [SOURCE: .opencode/skills/system-spec-kit/scripts/rules/check-spec-doc-integrity.sh:82]
- regression tests for assistant-facing startup briefs [SOURCE: .opencode/skills/system-spec-kit/mcp_server/tests/startup-brief.vitest.ts:49]
- thresholded quality-loop behavior with best-state retention [SOURCE: .opencode/skills/system-spec-kit/mcp_server/handlers/quality-loop.ts:567]
- DQI-style structural/content/style scoring [SOURCE: .opencode/skills/sk-doc/scripts/extract_structure.py:940]
...
2. Phase 2: bounded auto-edit on one canonical `.opencode/agents/*.md` target after the scorer and rollback/promotion contract are proven.
...
[SOURCE: AGENTS.md:179] [SOURCE: .opencode/skills/system-spec-kit/SKILL.md:438] [SOURCE: .opencode/specs/skilled-agent-orchestration/041-sk-improve-agent-loop/external/autoagent-main/program.md:89]
...
[SOURCE: .opencode/agents/review.md:24] [SOURCE: .opencode/README.md:330] [SOURCE: AGENTS.md:14]

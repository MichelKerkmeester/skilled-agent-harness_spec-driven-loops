...
This is grounded in the repo's actual review/deep-research/playbook/catalog patterns: review quick ref (`.opencode/skills/sk-code-review/references/quick_reference.md#L38`), strategy template (`.opencode/skills/sk-deep-research/assets/deep_research_strategy.md#L35`), the live Level 3 packet 028 spec (`.opencode/specs/03--commands-and-skills/028-sk-deep-research-testing-playbook/spec.md#L76`), 028 checklist (`.opencode/specs/03--commands-and-skills/028-sk-deep-research-testing-playbook/checklist.md#L18`), 028 summary (`.opencode/specs/03--commands-and-skills/028-sk-deep-research-testing-playbook/implementation-summary.md#L30`), the templates catalog template (`.opencode/skills/sk-doc/assets/documentation/feature_catalog/feature_catalog_template.md#L24`) and playbook template (`.opencode/skills/sk-doc/assets/documentation/testing_playbook/manual_testing_playbook_template.md#L18`), live docs system catalog root (`.opencode/skills/system-spec-kit/feature_catalog/FEATURE_CATALOG.md#L11`), memory_context feature (`.opencode/skills/system-spec-kit/feature_catalog/01--retrieval/01-unified-context-retrieval-memorycontext.md#L11`), live DR playbook (`.opencode/skills/sk-deep-research/manual_testing_playbook/MANUAL_TESTING_PLAYBOOK.md#L47`), DR-008 scenario (`.opencode/skills/sk-deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/008-iteration-writes-iteration-jsonl-and-strategy-update.md#L45`), and the current 030 review spec (`.opencode/specs/03--commands-and-skills/030-sk-deep-research-review-mode/spec.md#L11`), 030 strategy (`.opencode/specs/03--commands-and-skills/030-sk-deep-research-review-mode/research/deep-research-strategy.md#L11`).
...
| Agent family | `agent:review` or `agent:deep-research` | Normalize siblings across `.opencode/agents/`, `.opencode/agents/chatgpt/`, `.codex/agents/`, `.claude/agents/` and compare workflow/permissions | Medium | 5 |
...
This matches the review baseline's front-loaded correctness/security order in review quick ref (`.opencode/skills/sk-code-review/references/quick_reference.md#L38`) while preserving deep-research's "one focus per iteration" model in strategy template (`.opencode/skills/sk-deep-research/assets/deep_research_strategy.md#L19`).
...
**Good pass example:** The deep-research agent's LEAF-only and spec-folder write exception mirror the skill's loop model in deep-research agent (`.opencode/agents/deep-research.md#L32`).
...
**Good pass example:** OpenCode review agent (`.opencode/agents/review.md#L30`) and Codex review agent (`.codex/agents/review.toml#L16`) are semantically aligned on read-only review and baseline+overlay loading.
...
**Example:** System catalog root (`.opencode/skills/system-spec-kit/feature_catalog/FEATURE_CATALOG.md#L11`) explicitly acts as canonical inventory, and memory_context feature (`.opencode/skills/system-spec-kit/feature_catalog/01--retrieval/01-unified-context-retrieval-memorycontext.md#L11`) gives the source-file/test surface that must still match reality.
...
**Example:** Live DR playbook (`.opencode/skills/sk-deep-research/manual_testing_playbook/MANUAL_TESTING_PLAYBOOK.md#L362`) exposes explicit automated-test and catalog cross-reference sections, while DR-008 scenario (`.opencode/skills/sk-deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/008-iteration-writes-iteration-jsonl-and-strategy-update.md#L45`) shows the canonical 9-column row plus source anchors.

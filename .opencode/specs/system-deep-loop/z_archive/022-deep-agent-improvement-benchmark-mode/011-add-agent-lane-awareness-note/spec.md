---
title: "Feature Specification: add agent lane-awareness note"
description: "Add lane-awareness guidance across agent mirrors so agents distinguish agent-improvement and model-benchmark workflows."
trigger_phrases:
  - "agent lane note"
  - "lane awareness"
...
# Feature Specification: add agent lane-awareness note
...
| **Parent Spec** | ../spec.md |
| **Phase** | 11 of 19 |
| **Predecessor** | 010-reorganize-two-lane-references-assets |
| **Successor** | 012-label-catalog-playbook-and-advisor-lanes |
...
**Dependencies**:
- 009-restructure-skill-md-two-lane established the co-equal Lane A / Lane B framing this note must reflect.

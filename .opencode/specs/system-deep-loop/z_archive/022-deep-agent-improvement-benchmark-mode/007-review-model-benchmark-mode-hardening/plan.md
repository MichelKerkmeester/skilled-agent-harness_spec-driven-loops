...
_memory:
  continuity:
    ...
    session_dedup:
      ...
      session_id: "scaffold-scaffold/122-session-120-121-deep-review"
...
# Implementation Plan: Deep review (dual-executor gpt-5.5 + MiniMax M2.7) of session 120+121 work: deep-agent-improvement model-benchmark mode build + MiniMax integration

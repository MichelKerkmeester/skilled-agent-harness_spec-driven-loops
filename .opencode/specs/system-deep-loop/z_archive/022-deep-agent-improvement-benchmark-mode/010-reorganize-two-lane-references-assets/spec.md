---
title: "Feature Specification: reorganize references and assets for two-lane workflow"
description: "Reorganize references and assets into agent-improvement, model-benchmark, and shared lane folders and update references."
trigger_phrases:
...
# Feature Specification: reorganize references and assets for two-lane workflow
...
| **Parent Spec** | ../spec.md |
| **Phase** | 10 of 19 |
| **Predecessor** | 009-restructure-skill-md-two-lane |
| **Successor** | 011-add-agent-lane-awareness-note |
...
**Dependencies**:
- 009-restructure-skill-md-two-lane shipped the two co-equal lane structure in prose, so the disk layout can now mirror it.

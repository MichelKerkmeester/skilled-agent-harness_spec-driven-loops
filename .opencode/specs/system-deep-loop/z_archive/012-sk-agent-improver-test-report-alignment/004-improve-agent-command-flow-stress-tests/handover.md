...
_memory:
  continuity:
    ...
    key_files:
      ...
      - .opencode/specs/system-deep-loop/z_archive/012-sk-agent-improver-test-report-alignment/004-improve-agent-command-flow-stress-tests/implementation-summary.md
      ...
      - .opencode/specs/system-deep-loop/z_archive/012-sk-agent-improver-test-report-alignment/004-improve-agent-command-flow-stress-tests/stress-runs/r2-summary.md

...
## Fix Completeness
- [x] CHK-07 [P0] **REQ-001** D4-R integrated (opt-in `--d4` → `augmentWithD4R`); `D4_task_outcome` advisory, separate from `D4_hallucination`; run on LS-001/002/003/004 + SD-002 → aggregate **54/100**, per-scenario evidence in `sk-code/benchmark/reports/2026-06-02--d4r-live--live/`.
...
<!-- ANCHOR:docs -->
## Documentation
- [x] CHK-13 [P2] `sk-code/benchmark/reports/2026-06-02--d4r-live--live/README.md` documents the D4-R instrument, the n=5 result, the two-number split, and reproduction.
<!-- /ANCHOR:docs -->
...
<!-- ANCHOR:file-org -->
## File Organization
- [x] CHK-14 [P2] Changes confined to the skill-benchmark harness (5 `.cjs`) + the new grader prompt + sk-code INTENT_SIGNALS; live result artifact under `sk-code/benchmark/reports/2026-06-02--d4r-live--live/`.
<!-- /ANCHOR:file-org -->

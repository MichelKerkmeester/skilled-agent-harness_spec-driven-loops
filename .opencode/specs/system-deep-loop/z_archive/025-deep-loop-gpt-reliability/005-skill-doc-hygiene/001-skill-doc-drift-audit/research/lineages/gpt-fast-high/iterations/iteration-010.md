...
5. Final stale cluster E: deep-improvement scanner docs and scanner code still encode `.opencode/agents/{name}.toml` as active mirror surface. [SOURCE: .opencode/skills/deep-loop-workflows/deep-improvement/README.md:81] [SOURCE: .opencode/skills/deep-loop-workflows/deep-improvement/feature_catalog/integration-scanning/runtime-mirrors.md:29] [SOURCE: .opencode/skills/deep-loop-workflows/deep-improvement/references/agent_improvement/integration_scanning.md:42-47] [SOURCE: .opencode/skills/deep-loop-workflows/deep-improvement/scripts/agent-improvement/scan-integration.cjs:18]

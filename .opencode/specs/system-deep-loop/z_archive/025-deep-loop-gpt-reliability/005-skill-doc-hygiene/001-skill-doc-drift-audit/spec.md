...
description: "Deep-review + deep-research investigation into whether SKILL.md files, references/, assets/, and READMEs across the repo went stale as a result of the 025-deep-loop-gpt-reliability packet's changes (phases 008-013 plus the mk-deep-loop-guard rename/integration)."
trigger_phrases:
...
_memory:
  continuity:
    packet_pointer: "system-deep-loop/025-deep-loop-gpt-reliability/005-skill-doc-hygiene/001-skill-doc-drift-audit"

---
title: "Implementation Plan: deep-review README"
description: "Gather context with a two-iteration deep-context sweep, dual-draft with DeepSeek and MiMo, verify the severity model and convergence math, then merge the narrative README."
trigger_phrases:
...
_memory:
  continuity:
    packet_pointer: "system-deep-loop/z_archive/021-skill-readme-standardization/006-deep-review-readme"
...
# Implementation Plan: deep-review README
...
Run the full per-skill recipe: a two-iteration deep-context sweep with DeepSeek v4 Pro and MiMo v2.5 Pro as read-only seats, host verification of the severity model, the verdicts and the convergence math, a synthesized context report, then a dual-model draft the host merges and validates.
<!-- /ANCHOR:summary -->
...
- [x] Severity model, verdicts and convergence math verified

### Definition of Done
- [x] README rewritten to the narrative skeleton
- [x] `validate_document.py --type readme` passes (0 issues)
- [x] Prose HVR-clean, version line and brittle counts dropped
<!-- /ANCHOR:quality-gates -->
...
Seats return findings, host synthesizes the report, models draft, host verifies paths and merges into the README.
<!-- /ANCHOR:architecture -->
...
| Accuracy | Severity, verdicts, convergence, paths | Host SKILL.md, review_mode_contract.yaml and tree |
<!-- /ANCHOR:testing -->

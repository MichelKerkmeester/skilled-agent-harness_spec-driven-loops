---
title: "Plan: deep-review CP-Scenario Authoring (003)"
...
_memory:
  continuity:
    ...
    answered_questions: []
---
# Plan: deep-review CP-Scenario Authoring (003)
...
Direct adaptation of `060/004` (improve-agent stress) for `/speckit:deep-review`. Re-read 060/004's plan.md as the methodology source.
...
`@deep-review` is dispatched ONLY by `/speckit:deep-review`. The command owns iteration state, convergence, journal, gates, stop reasons. Body is a thin LEAF.
...
- sk-deep-review skill + scripts (executor of the command being stress-tested)

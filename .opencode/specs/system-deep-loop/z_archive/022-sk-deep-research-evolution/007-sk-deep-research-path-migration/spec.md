---
title: "Feature Specification: sk-deep-research Path [system-deep-loop/z_archive/022-sk-deep-research-evolution/007-sk-deep-research-path-migration/spec]"
...
_memory:
  continuity:
    ...
    key_files: ["spec.md"]
---
<!-- PHASE_LINKS: parent=../spec.md predecessor=006-sk-deep-research-review-folders successor=008-sk-deep-research-review-split -->

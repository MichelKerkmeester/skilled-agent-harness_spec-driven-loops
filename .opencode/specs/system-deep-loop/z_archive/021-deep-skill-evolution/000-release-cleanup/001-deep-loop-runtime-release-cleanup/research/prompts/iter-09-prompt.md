...
| 4 | `SKILL.md:252` | "118 ADR-001" | YES (cited in L262-264 as 003/004/005 phases under 116-deep-skill-evolution; ADR-001 in 005 = "Complete Removal of Four MCP Tools") | YES | PASS |
| 5 | `SKILL.md:261-264` | 118 phase parent + phases 003/004/005/008 paths | YES — all paths resolve under `116-deep-skill-evolution/spec.md` and `003-deep-loop-runtime/` | YES | PASS |
...
| 8 | `README.md:116` | spec-folder `116-deep-skill-evolution` (in example command) | YES | YES | PASS |
...
| 11 | `README.md:345` | spec-folder `116-deep-skill-evolution/000-release-cleanup/001-deep-loop-runtime` (in example command) | YES | YES | PASS |
...
| 15 | `README.md:458` | `116-deep-skill-evolution/spec.md` | YES | YES | PASS |
| 16 | `README.md:459` | `116-deep-skill-evolution/003-deep-loop-runtime/004-script-shim-db-relocation/decision-record.md` ADR-001 | YES — ADR-001 = "Per-Invocation DB Ownership..." | YES (matches "script interface contract and DB lifecycle ownership transfer") | PASS |
| 17 | `README.md:460` | `116-deep-skill-evolution/003-deep-loop-runtime/005-mcp-tool-surface-removal/decision-record.md` ADR-001 | YES — ADR-001 = "Complete Removal of Four MCP Tools (No Backward-Compat Aliases)" | YES (matches "MCP tool surface removal rationale") | PASS |
| 18 | `README.md:461` | `116-deep-skill-evolution/003-deep-loop-runtime/001-core-isolation-deliberation/decision-record.md` "117 council ruling (SPLIT, superseded by 118)" | YES — ADR-001 = "SPLIT — Move Pure Runtime Libs..." | YES | PASS |
| 19 | `changelog/v1.0.0.0.md:3` | spec folder `116-deep-skill-evolution/003-deep-loop-runtime/009-verification-changelog-closeout/` | YES | YES | PASS |
| 20 | `changelog/v1.0.0.0.md:9,72,77` | "Arc 118" prose claims (FULL_ISOLATE_NO_MCP, MCP tool deletion) | YES (prose, not paths) | YES | PASS |
| 21 | `changelog/v1.0.0.0.md:94` | `116-deep-skill-evolution/spec.md` | YES | YES | PASS |
| 22 | `changelog/v1.0.0.0.md:95` | "117 council ruling (superseded)" + `116-deep-skill-evolution/003-deep-loop-runtime/001-core-isolation-deliberation/decision-record.md` ADR-001 | YES | YES | PASS |
...
| 25 | `changelog/v1.1.0.0.md:8,107,117` | spec folder + project arc `116-deep-skill-evolution/...` | YES | YES | PASS |
...
- **Spec folder paths (`116-deep-skill-evolution/...`)**: every absolute path under `.opencode/specs/skilled-agent-orchestration/116-deep-skill-evolution/...` cited in the docs resolves on disk (verified by orchestrator).
...
| 116-deep-skill-evolution spec folder paths | PASS (all resolve) |

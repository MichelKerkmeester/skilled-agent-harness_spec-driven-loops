...
| `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/116-deep-skill-evolution/001-ai-council/001-rename-preflight-and-plan --strict` | PASS, Level 2 with 0 errors and 0 warnings |
<!-- /ANCHOR:verification -->
...
```bash
git add \
  .opencode/specs/skilled-agent-orchestration/116-deep-skill-evolution/001-ai-council/001-rename-preflight-and-plan/scratch/rename-plan.json \
  .opencode/specs/skilled-agent-orchestration/116-deep-skill-evolution/001-ai-council/001-rename-preflight-and-plan/spec.md \
  .opencode/specs/skilled-agent-orchestration/116-deep-skill-evolution/001-ai-council/001-rename-preflight-and-plan/implementation-summary.md \
  .opencode/specs/skilled-agent-orchestration/116-deep-skill-evolution/001-ai-council/001-rename-preflight-and-plan/checklist.md
```

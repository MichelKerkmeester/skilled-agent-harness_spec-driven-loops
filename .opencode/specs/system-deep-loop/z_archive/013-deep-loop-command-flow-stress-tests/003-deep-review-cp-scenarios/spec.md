...
### In Scope
- 6 CP-XXX scenarios authored in `.opencode/skills/sk-deep-review/manual_testing_playbook/`
...
- **SC-001**: 6 CPs landed under `.opencode/skills/sk-deep-review/manual_testing_playbook/`

---
title: "Spec: deep-research Stress Runs (002)"
...
_memory:
  continuity:
    ...
    answered_questions: []
---
# Spec: deep-research Stress Runs (002)
...
R1→R2→R3 stress runs against the 001-authored CP scenarios; target final PASS 6/0/0.

The 060/004 methodology proved that LEAF agents with command-orchestrator architecture (like @improve-agent) need command-flow stress, not body-prepend stress. `@deep-research` shares this architecture; this sub-phase applies the methodology.
<!-- /ANCHOR:problem -->

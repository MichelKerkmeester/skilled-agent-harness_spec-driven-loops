...
# Feature Specification: Multi-AI Council Deferrals — state.jsonl v1.1 forward-compat metadata + memory-save payload routing + advisory-check + command wiring docs (packet-089 deferrals)

<!-- SPECKIT_LEVEL: 3 -->
<!-- PHASE_LINKS: parent=../spec.md; predecessor=002-multi-ai-council-persistence; successor=004-multi-ai-council-write-authority -->
...
| **Created** | 2026-05-06 |
| **Branch** | `scaffold/092-multi-ai-council-deferrals` |
<!-- /ANCHOR:metadata -->

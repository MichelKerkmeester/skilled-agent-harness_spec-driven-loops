...
- [x] T001 Read `research/iterations/iteration-006.md` F-003/F-014 for the full trade-off writeup (both forks) (026-goal-opencode-plugin/research/iterations/iteration-006.md)
<!-- agent: direct | deps: [T001] | touched-files: ["026-goal-opencode-plugin/013-design-fidelity-and-polish/implementation-summary.md"] -->
...
<!-- agent: direct | deps: [] | touched-files: ["026-goal-opencode-plugin/001-state-store/", "026-goal-opencode-plugin/002-injection-plugin/", "026-goal-opencode-plugin/003-goal-command/", "026-goal-opencode-plugin/004-lifecycle-tracking/", "026-goal-opencode-plugin/005-completion-supervisor/", "026-goal-opencode-plugin/006-active-continuation/", "026-goal-opencode-plugin/007-sk-prompt-goal-enhancement/", "026-goal-opencode-plugin/008-system-spec-kit-integration/"] -->
- [x] T005 [P] [REQ-003] Recompute real session_dedup.fingerprint values across all 8 original phase docs' frontmatter (026-goal-opencode-plugin/00{1-8}-*/)
<!-- agent: direct | deps: [] | touched-files: ["026-goal-opencode-plugin/006-active-continuation/implementation-summary.md"] -->
- [x] T006 [P] [REQ-004] Downgrade phase 006's completion_pct (100 -> <=90) and align recent_action wording with next_safe_action (026-goal-opencode-plugin/006-active-continuation/implementation-summary.md)
...
<!-- agent: direct | deps: [T009, T010, T011] | touched-files: ["026-goal-opencode-plugin/013-design-fidelity-and-polish/implementation-summary.md"] -->

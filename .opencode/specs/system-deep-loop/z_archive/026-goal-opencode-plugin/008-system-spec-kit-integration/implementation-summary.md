...
| `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-deep-loop/026-goal-opencode-plugin --strict` | PASS: parent packet and all nine phases |
<!-- /ANCHOR:verification -->

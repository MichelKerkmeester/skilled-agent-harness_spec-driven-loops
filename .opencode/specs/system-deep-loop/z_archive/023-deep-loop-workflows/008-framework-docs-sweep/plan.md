...
- [ ] T1 Preflight phase 007 completion and verify deep-loop-workflows hub metadata exists with no nested mode graph metadata. (`.opencode/specs/system-deep-loop/023-deep-loop-workflows/007-governance-consolidation/checklist.md`, `.opencode/specs/system-deep-loop/023-deep-loop-workflows/007-governance-consolidation/implementation-summary.md`, `.opencode/skills/deep-loop-workflows/mode-registry.json`) — _verify:_ Phase 007 validate is green and rg --files for graph-metadata.json under deep-loop-workflows returns only the hub file.

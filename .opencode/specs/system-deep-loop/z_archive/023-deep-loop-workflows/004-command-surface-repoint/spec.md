...
_memory:
  continuity:
    packet_pointer: "system-deep-loop/023-deep-loop-workflows/004-command-surface-repoint"
...
| **Phase** | 004 of 009 (parent: `147-deep-loop-workflows`) |
| **Depends on** | 003 |
<!-- /ANCHOR:metadata -->
...
> **Scaffold note.** This child is a scoped scaffold derived from `../research/research.md`. Its `plan.md`, `tasks.md`, and `checklist.md` are authored when the phase is picked up via `/speckit:plan system-deep-loop/023-deep-loop-workflows/004-command-surface-repoint`.
<!-- /ANCHOR:problem -->

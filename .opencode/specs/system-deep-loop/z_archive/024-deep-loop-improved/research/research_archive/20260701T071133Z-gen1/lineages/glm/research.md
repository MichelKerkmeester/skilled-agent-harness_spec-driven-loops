...
References to `123-agent-loops-improved` persist across 7 phase parent spec.md files in Parent Spec, Successor, and prose fields. The packet was migrated to `030-deep-loop-improved` but find-replace was never run.

**Recommendation:** Global find-replace `123-agent-loops-improved` → `030-deep-loop-improved`.
...
- GLM review registry: `.opencode/specs/deep-loops/030-deep-loop-improved/review/lineages/glm/deep-review-findings-registry.json`
- Codex review config: `.opencode/specs/deep-loops/030-deep-loop-improved/review/lineages/codex/deep-review-config.json`

...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-deep-loop/024-deep-loop-improved/002-deep-loop-runtime/001-atomic-state-serialize-diff/plan.md"
      - ".opencode/specs/system-deep-loop/024-deep-loop-improved/002-deep-loop-runtime/018-persisted-wait-crash-resume/tasks.md"
      - ".opencode/skills/system-spec-kit/scripts/rules/check-scaffold-never-touched.sh"
      - ".opencode/specs/system-deep-loop/024-deep-loop-improved/011-followup-remediation/003-scaffold-content-002-deep-loop-runtime/implementation-summary.md"
    session_dedup:

...
| `024-deep-loop-improved/{002..007}/spec.md` | Modify | Phase Documentation Map Status columns |
| `024-deep-loop-improved/{002..007}/**/spec.md` (143 grandchildren, revised count) | Modify | `completion_pct` frontmatter field |
<!-- /ANCHOR:scope -->

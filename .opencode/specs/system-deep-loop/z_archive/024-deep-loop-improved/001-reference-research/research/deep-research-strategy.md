...
- [S2-08] The same source file also exposes `mergeExternalState()` read-merge-write behavior at `.opencode/specs/deep-loops/030-deep-loop-improved/external/kasper/src/state.ts:958-1028`; that needs a separate pass against our JSONL repair and append semantics. (iteration 15)

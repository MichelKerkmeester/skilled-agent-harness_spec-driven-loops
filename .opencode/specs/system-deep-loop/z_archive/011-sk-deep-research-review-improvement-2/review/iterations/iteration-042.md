...
● Search (glob)
  │ "**/{README.md,CHANGELOG.md,SKILL.md}" in .opencode/skills/cli-copilot
  └ 2 files found

● Search (glob)
  │ "**/{README.md,CHANGELOG.md,SKILL.md}" in .opencode/skills/sk-deep-research
  └ 3 files found

● Search (glob)
  │ "**/{README.md,CHANGELOG.md,SKILL.md}" in .opencode/skills/sk-improve-agent
  └ 3 files found

● Search (glob)
  │ "**/{README.md,CHANGELOG.md,SKILL.md}" in .opencode/skills/system-spec-kit
  └ 109 files found

● Search (glob)
  │ "**/{README.md,CHANGELOG.md,SKILL.md}" in .opencode/skills/sk-deep-review
  └ 3 files found
...
● Search (grep)
  ...
  │ Changelog" in **/*.{md,yaml,yml,json} (.opencode/skills/sk-deep-research)
  └ 1 line found

● Search (grep)
  │ "Version|version:|Changelog|CHANGELOG|## Changelog|## Version History|### Version History|###
  │ Changelog" in **/*.{md,yaml,yml,json} (.opencode/skills/sk-deep-review)
  └ 3 lines found

● Search (grep)
  │ "Version|version:|Changelog|CHANGELOG|## Changelog|## Version History|### Version History|###
  │ Changelog" in **/*.{md,yaml,yml,json} (.opencode/skills/sk-improve-agent)
  └ 1 line found

● Search (grep)
  │ "Version|version:|Changelog|CHANGELOG|## Changelog|## Version History|### Version History|###
  │ Changelog" in **/*.{md,yaml,yml,json} (.opencode/skills/cli-copilot)
  └ 2 lines found

● Search (grep)
  │ "Version|version:|Changelog|CHANGELOG|## Changelog|## Version History|### Version History|###
  │ Changelog" in **/*.{md,yaml,yml,json} (.opencode/skills/system-spec-kit)
  └ 6 lines found
...
● Search (grep)
  │ "1\.6\.2\.0" in **/*.{md,json,yaml,yml} (.opencode/skills/sk-deep-research)
  └ 1 line found
...
● Search (grep)
  │ "3\.3\.1\.0" in **/*.{md,json,yaml,yml} (.opencode/skills/system-spec-kit)
  └ 2 lines found

● Search (grep)
  │ "1\.3\.2\.0" in **/*.{md,json,yaml,yml} (.opencode/skills/sk-deep-review)
  └ 1 line found

● Search (grep)
  │ "1\.2\.2\.0" in **/*.{md,json,yaml,yml} (.opencode/skills/sk-improve-agent)
  └ 1 line found
...
● Search (grep)
  ...
  │ version|Documentation version" (.opencode/skills/sk-deep-research/README.md)
  └ 2 lines found

● Search (grep)
  │ "## 9\. RELATED DOCUMENTS|## 12\. RELATED DOCUMENTS|RELATED DOCUMENTS|Skill
  │ version|Documentation version" (.opencode/skills/sk-deep-review/README.md)
  └ 2 lines found

● Search (grep)
  │ "## 9\. RELATED DOCUMENTS|## 12\. RELATED DOCUMENTS|RELATED DOCUMENTS|Skill
  │ version|Documentation version" (.opencode/skills/sk-improve-agent/README.md)
  └ 2 lines found
...
● Search (grep)
  ...
  │ alias|deprecated" in **/*.{cjs,js,ts,md,yaml,yml} (.opencode/skills/sk-deep-review)
  └ 5 lines found

● Search (grep)
  │ "TODO|FIXME|XXX|HACK|NOTE:.*(deferred|legacy|remove|obsolete)|legacy alias|compatibility
  │ alias|deprecated" in **/*.{cjs,js,ts,md,yaml,yml} (.opencode/skills/sk-deep-research)
  └ 5 lines found

● Search (grep)
  │ "TODO|FIXME|XXX|HACK|NOTE:.*(deferred|legacy|remove|obsolete)|legacy alias|compatibility
  │ alias|deprecated" in **/*.{cjs,js,ts,md,yaml,yml} (.opencode/skills/sk-improve-agent)
  └ 5 lines found

● Search (grep)
  │ "TODO|FIXME|XXX|HACK|NOTE:.*(deferred|legacy|remove|obsolete)|legacy alias|compatibility
  │ alias|deprecated" in **/*.{cjs,js,ts,md,yaml,yml} (.opencode/skills/system-spec-kit)
  └ 6 lines found
...
● Search (grep)
  │ "repeatedFindings" in **/*.{cjs,md,json,yaml,yml} (.opencode/skills/sk-deep-review)
  └ 12 lines found
...
● Search (glob)
  │ "**/*wave*.{cjs,ts,js}" in .opencode/skills/system-spec-kit
  └ 9 files found
...
● Search (grep)
  │ "Skill version|Documentation version|Version" (.opencode/skills/cli-copilot/README.md)
  └ 1 line found
...
● Code-review(gpt-5.4-mini) Audit wave optimizer
  ...
  │   '^\.opencode/skills/system-spec-kit/mcp_server/lib/graph/|^\
  │   │ .opencode/skills/system-spec-kit/scripts/lib/'
  │   └ 2 lines...
...
- **Dimension:** Maintainability
- **File / Line:**  
  - `.opencode/skills/sk-deep-research/README.md:214-224`  
  - `.opencode/skills/sk-deep-review/README.md:379-389`  
  - `.opencode/skills/sk-improve-agent/README.md:379-403`  
  - `.opencode/skills/cli-copilot/README.md:360-376`  
  - `.opencode/skills/system-spec-kit/README.md:1039-1086`
...
- **Dimension:** Maintainability
- **File / Line:**  
  - `.opencode/skills/sk-deep-review/scripts/reduce-state.cjs:716-749,1027-1033`  
  - `.opencode/skills/sk-deep-review/assets/review_mode_contract.yaml:250-259`  
  - `.opencode/skills/sk-deep-review/references/loop_protocol.md:106-110`  
  - `.opencode/skills/sk-deep-review/references/state_format.md:533-536`
...
- **Dimension:** Maintainability
- **File / Line:**  
  - `.opencode/skills/system-spec-kit/mcp_server/lib/graph/graph-metadata-parser.ts:430-446`  
  - `.opencode/skills/system-spec-kit/mcp_server/lib/extraction/entity-extractor.ts:129-145`  
  - `.opencode/skills/system-spec-kit/mcp_server/lib/graph/graph-metadata-schema.ts:19-24`

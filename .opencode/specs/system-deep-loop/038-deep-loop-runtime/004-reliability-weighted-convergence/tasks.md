...
_memory:
  continuity:
    ...
    recent_action: "Authored Level 3 task breakdown. Nine candidates PENDING behind benchmark gate"
...
- [ ] T-111 Parity/throw test: integer `computeScore`/`shouldDemote` byte-unchanged and still throw on fractional inputs, the f64 export accepts them

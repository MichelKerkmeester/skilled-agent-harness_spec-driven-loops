...
### In Scope
- `bash validate.sh .opencode/specs/system-deep-loop/052-deep-loop-unification --recursive --strict` (parent + all children).
...
|-----------|-------------|-------------|
| `052-deep-loop-unification/description.json`, `graph-metadata.json` | Regenerate | Final completion state |

...
The plan's directional rule is right: workflow content importing runtime should lose one parent hop after runtime becomes a child of the hub. But the current table is incomplete. Confirmed additional or under-emphasized sites include `deep-review/scripts/reduce-state.cjs`, `deep-research/scripts/runtime-capabilities.cjs`, `deep-review/scripts/runtime-capabilities.cjs`, `deep-ai-council/scripts/replay-graph-from-artifacts.cjs`, and the deep-improvement runtime self-profile. [SOURCE: .opencode/skills/deep-loop-workflows/deep-review/scripts/reduce-state.cjs:11-15] [SOURCE: .opencode/skills/deep-loop-workflows/deep-research/scripts/runtime-capabilities.cjs:17-18] [SOURCE: .opencode/skills/deep-loop-workflows/deep-review/scripts/runtime-capabilities.cjs:17-18] [SOURCE: .opencode/skills/deep-loop-workflows/deep-ai-council/scripts/replay-graph-from-artifacts.cjs:51-65] [SOURCE: .opencode/skills/deep-loop-workflows/deep-improvement/assets/non_dev_ai_system/profiles/deep-loop-runtime.json:1-5]

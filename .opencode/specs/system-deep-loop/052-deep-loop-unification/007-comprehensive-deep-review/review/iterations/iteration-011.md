...
- `.opencode/skills/system-deep-loop/deep-review/feature_catalog/01--loop-lifecycle/executor-selection-contract.md:32`
- `.opencode/skills/system-deep-loop/deep-review/manual_testing_playbook/07--command-flow-stress-tests/write-boundary-reducer-owned-files.md:25`

...
description: "An operator-directed, 50-seat-budget deep review of three sibling packets — 147-deep-loop-workflows (the 9-phase merge), 148-mcp-skill-install-doctor-standardization, and 117-parent-nested-skill-pattern — run as an orchestrated-wave deep review to surface release-readiness gaps with file:line evidence and a prioritized remediation plan. Read-only: it produces no production code, only the review report and the plan."
trigger_phrases:
...
_memory:
  continuity:
    packet_pointer: "system-deep-loop/029-deep-loop-workflows/010-deep-loop-skill-system-review"
...
| **Reviews** | `../../147-deep-loop-workflows`, `../../148-mcp-skill-install-doctor-standardization`, `../../117-parent-nested-skill-pattern` |
<!-- /ANCHOR:metadata -->
...
### In Scope
- A read-only deep review of three packets: `147-deep-loop-workflows`, `148-mcp-skill-install-doctor-standardization`, `117-parent-nested-skill-pattern`.
...
**Depends on:** the three reviewed packets (`../../147-deep-loop-workflows`, `../../148-mcp-skill-install-doctor-standardization`, `../../117-parent-nested-skill-pattern`) existing in their shipped form, and the `review/deep-review-config.json` executor stack being reachable.
...
- **Reviewed packets**: `../../147-deep-loop-workflows`, `../../148-mcp-skill-install-doctor-standardization`, `../../117-parent-nested-skill-pattern`.

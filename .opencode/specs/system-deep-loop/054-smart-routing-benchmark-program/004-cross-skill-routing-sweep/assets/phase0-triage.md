...
## Orphan classification — routable vs exempt vs prune (27 orphans)

**ROUTABLE 18** (genuine task-time guidance → wire into a meaningful intent), **EXEMPT 9** (structural/index/catalog — stay on an intentionally-unrouted allowlist, do NOT wire), **PRUNE 0**, **NEEDS-HUMAN 0**.
...
- Phase 1 hand-sweeps deep-improvement (the ROUTABLE-11 + EXEMPT-7 + 3-genuine mix — the hardest case) with independent sign-off before any optimizer is generalized.

...
- [x] T001 Confirm packet-038 scope and branch [small] — spec.md fixes the existing `system-deep-loop/054-smart-routing-benchmark-program/014-scenario-loader-code-surface-sync` packet on branch `system-speckit/028-memory-search-intelligence`

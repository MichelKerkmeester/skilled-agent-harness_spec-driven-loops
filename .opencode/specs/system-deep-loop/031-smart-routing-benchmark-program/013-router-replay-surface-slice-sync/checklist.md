...
- [x] CHK-050 [P1] Authored docs stay in the existing packet folder [EVIDENCE: plan.md, tasks.md, checklist.md, and implementation-summary.md are authored under `.opencode/specs/system-deep-loop/031-smart-routing-benchmark-program/013-router-replay-surface-slice-sync/`]

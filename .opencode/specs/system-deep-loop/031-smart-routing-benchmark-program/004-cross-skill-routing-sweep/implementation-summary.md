...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-deep-loop/031-smart-routing-benchmark-program/004-cross-skill-routing-sweep/assets/phase0-triage.md"
      - ".opencode/specs/system-deep-loop/031-smart-routing-benchmark-program/004-cross-skill-routing-sweep/assets/code-opencode-language-split-design.md"
    session_dedup:

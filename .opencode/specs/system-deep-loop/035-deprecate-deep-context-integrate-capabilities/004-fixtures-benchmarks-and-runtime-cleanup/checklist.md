...
- [x] CHK-024 [P0] Phase 004 strict validation passes. [EVIDENCE: `bash ".opencode/skills/system-spec-kit/scripts/spec/validate.sh" ".opencode/specs/system-deep-loop/035-deprecate-deep-context-integrate-capabilities/004-fixtures-benchmarks-and-runtime-cleanup" --strict` passed]

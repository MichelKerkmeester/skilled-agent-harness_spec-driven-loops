...
- [ ] Regenerate `030-deep-loop-unification/description.json` + `graph-metadata.json`.
...
- [ ] `bash validate.sh .opencode/specs/system-deep-loop/030-deep-loop-unification --recursive --strict` exit 0.

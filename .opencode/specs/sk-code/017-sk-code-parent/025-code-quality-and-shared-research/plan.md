...
| **Storage** | Repository filesystem: `.opencode/specs/sk-code/017-sk-code-parent/025-code-quality-and-shared-research/` with read-only research output under `research/` |

...
_memory:
  continuity:
    packet_pointer: "sk-code/017-sk-code-parent/010-plugin-tui-fix"
...
| Documentation validation | Phase Level-2 docs | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/sk-code/017-sk-code-parent/010-plugin-tui-fix --strict` |

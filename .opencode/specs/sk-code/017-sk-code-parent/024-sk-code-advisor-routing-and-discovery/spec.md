...
- Regenerate `sk-code/benchmark/reports/2026-06-01--router-final--router` and write new sibling benchmark reports `sk-design/benchmark/reports/2026-07-06--after-d3-proxy--router` and `deep-loop-workflows/benchmark/2026-07-06--after-d3-proxy--router`.
...
| `.opencode/skills/sk-code/benchmark/reports/2026-06-01--router-final--router/` | Regenerate | Current/regenerable sk-code router benchmark report |
| `.opencode/skills/sk-design/benchmark/reports/2026-07-06--after-d3-proxy--router/` | Add | Sibling report preserving frozen `baseline/` |

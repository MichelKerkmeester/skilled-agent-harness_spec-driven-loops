...
- [x] CHK-025 [P0] Benchmark reports regenerated without overwriting frozen baselines [EVIDENCE: `sk-code/benchmark/reports/2026-06-01--router-final--router` regenerated; `sk-design/benchmark/reports/2026-07-06--after-d3-proxy--router` and `deep-loop-workflows/benchmark/2026-07-06--after-d3-proxy--router` written as sibling reports]

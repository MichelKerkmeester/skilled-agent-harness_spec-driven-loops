...
- Editing target README/checklist files during research; the run is research-only and target skills remain read-only. [SOURCE: .opencode/specs/sk-code/017-sk-code-parent/023-sk-code-workflow-subskill-research/research/deep-research-strategy.md:29]

...
| Spec validation | Backfilled phase docs | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/sk-code/017-sk-code-parent/011-hub-canon --strict` |

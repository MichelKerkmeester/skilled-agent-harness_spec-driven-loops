...
_memory:
  continuity:
    packet_pointer: "sk-code/z_archive/008-sk-code-scripts-relocation"
...
- [x] T001 Create Level 2 spec packet (`specs/sk-code/z_archive/008-sk-code-scripts-relocation/`)

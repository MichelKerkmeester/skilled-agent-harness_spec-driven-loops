...
| `specs/sk-code/z_archive/008-sk-code-scripts-relocation/*` | Create/Modify | Planning, ADR, scratch inventory, checklist, and completion summary. |
<!-- /ANCHOR:scope -->
...
| REQ-005 | Validate the spec packet strictly. | `validate.sh specs/sk-code/z_archive/008-sk-code-scripts-relocation --strict` exits 0. |

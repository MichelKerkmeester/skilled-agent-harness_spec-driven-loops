...
_memory:
  continuity:
    packet_pointer: "sk-code/z_archive/005-sk-code-fullstack-branch"
...
| `specs/sk-code/z_archive/005-sk-code-fullstack-branch/` (this packet) | Rewrite | Unified narrative covering Phases A → D |

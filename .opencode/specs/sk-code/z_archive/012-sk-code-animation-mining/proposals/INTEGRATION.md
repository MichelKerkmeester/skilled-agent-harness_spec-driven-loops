...
| `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/sk-code/z_archive/012-sk-code-animation-mining --strict` | Could not run: `ERROR: Folder not found: .opencode/specs/sk-code/z_archive/012-sk-code-animation-mining`. No `.opencode/specs/**/129-*` folder exists in this isolated worktree. |

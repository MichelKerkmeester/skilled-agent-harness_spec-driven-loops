...
_memory:
  continuity:
    packet_pointer: "sk-code/z_archive/007-sk-code-motion-dev-and-playbook"
...
- Use `/speckit:resume specs/sk-code/z_archive/007-sk-code-motion-dev-and-playbook/[NNN-phase]/` to resume a specific phase.

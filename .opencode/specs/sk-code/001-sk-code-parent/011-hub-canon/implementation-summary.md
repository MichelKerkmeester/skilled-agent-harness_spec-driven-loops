...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/sk-code/001-sk-code-parent/011-hub-canon/spec.md"
      - ".opencode/specs/sk-code/001-sk-code-parent/011-hub-canon/plan.md"
      - ".opencode/specs/sk-code/001-sk-code-parent/011-hub-canon/tasks.md"
      - ".opencode/specs/sk-code/001-sk-code-parent/011-hub-canon/checklist.md"
      - ".opencode/specs/sk-code/001-sk-code-parent/011-hub-canon/design-contract.md"
    session_dedup:
...
| spec validation | Zero errors | Level-2 phase docs | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/sk-code/001-sk-code-parent/011-hub-canon --strict` reports `Summary: Errors: 0  Warnings: 1` for the accepted missing graph metadata warning |

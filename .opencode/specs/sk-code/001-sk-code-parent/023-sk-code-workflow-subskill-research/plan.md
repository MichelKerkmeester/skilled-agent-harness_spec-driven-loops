...
| **Storage** | Repository filesystem: `.opencode/specs/sk-code/001-sk-code-parent/023-sk-code-workflow-subskill-research/` and read-only research outputs under `research/` |

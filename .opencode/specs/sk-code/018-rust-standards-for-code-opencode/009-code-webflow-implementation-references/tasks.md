...
<!-- ANCHOR:phase-1 -->
## Phase 1: Setup
- [x] T001 Compute heading-aligned boundaries for the 11 docs — 29 parts
- [x] T002 Dry-run the splitter — coverage contiguous 1..EOF; all parts ≤488 lines
<!-- /ANCHOR:phase-1 -->
...
- [x] T003 Apply split: 29 parts created, 11 sources deleted (0 parts >500)
...
- [x] T006 Rewire 18 cross-link/playbook files (rewire_xlinks.py surface=code-webflow)

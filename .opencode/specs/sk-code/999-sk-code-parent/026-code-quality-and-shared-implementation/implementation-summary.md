...
| `.opencode/specs/skilled-agent-orchestration/124-sk-code-parent/graph-metadata.json` | Modified | Register 026 in `children_ids` and set `derived.last_active_child_id` | close-out doc |

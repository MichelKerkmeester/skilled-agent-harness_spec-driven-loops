---
title: "Feature Specification: Specification: Additional [00--anobel.com/z_archive/015-performance-hacks/scratch/legacy/spec]"
...
---
        ...
        | **Created** | 2026-03-31 |
        | **Branch** | `.opencode/specs/00--anobel.com/z_archive/015-performance-hacks` |
        <!-- /ANCHOR:metadata -->
        ...
        ### In Scope
        - title: "Specification: Additional Performance Hacks [00--anobel.com/z_archive/015-performance-hacks/spec]".
- description: "Implementation of high-impact, low-effort performance optimizations (\"hacks\") for anobel.com to improve LCP and FCP scores.".
- "additional".

---
title: "Implementation Plan: Language Selector - [00--anobel.com/z_archive/024-language-selector-hover/scratch/legacy/plan]"
...
### Overview
Spec: Language Selector - Desktop Hover to Open Overview Modify `nav_language_selector.js` to open the dropdown on hover (desktop only), matching the behavior of `nav_dropdown.js`.
<!-- /ANCHOR:summary -->
...
### Key Components
- **Primary implementation surface**: nav_language_selector.js

---
title: "Feature Specification: Specification: Font [00--anobel.com/z_archive/013-font-performance/scratch/legacy/spec]"
...
---
        ...
        | **Created** | 2026-03-31 |
        | **Branch** | `.opencode/specs/00--anobel.com/z_archive/013-font-performance` |
        <!-- /ANCHOR:metadata -->
        ...
        ### In Scope
        - title: "Specification: Font Performance Optimization [00--anobel.com/z_archive/013-font-performance/spec]".
- description: "This specification outlines the implementation of font performance optimizations for anobel.com. The goal is to improve the site's Core Web Vitals (specifically LCP) and user ex...".
- "optimization".
...
| `.opencode/specs/00--anobel.com/z_archive/013-font-performance/webflow_guide.md` | Modify | Referenced by the archived work and retained in the normalized record |
        <!-- /ANCHOR:scope -->

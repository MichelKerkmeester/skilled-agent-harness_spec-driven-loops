---
title: "Feature Specification: Hero Webshop Selector Scoping [00--anobel.com/035-hero-contact-success/spec]"
...
|-----------|-------------|-------------|
| `.opencode/specs/00--anobel.com/035-hero-contact-success/spec.md` | Modify | Normalize the Level 1 feature specification |
| `.opencode/specs/00--anobel.com/035-hero-contact-success/plan.md` | Modify | Document the selector-scoping implementation plan |
| `.opencode/specs/00--anobel.com/035-hero-contact-success/tasks.md` | Modify | Track the investigation, implementation, and verification steps |

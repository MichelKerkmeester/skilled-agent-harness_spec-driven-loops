...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/111-base-files-renumbering-name-cleanup"
...
- [x] T0.1: Create `.opencode/specs/skilled-agent-orchestration/111-base-files-renumbering-name-cleanup/`

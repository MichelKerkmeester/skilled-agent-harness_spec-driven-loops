...
| 001-docs-and-code-alignment | 006-skill-advisor/005-docs | 3 | 3 | 0 | 0 | 6 | 001-and-code-alignment | L=3.0, R=3 |
...
| 002-scaffold-advisor-package | 006-skill-advisor/001-skill-graph/006-system-skill-advisor-extraction | 3 | 3 | 0 | 0 | 6 | 002-scaffold-package | L=3.0, R=3 |
| 002-daemon-and-unification | 006-skill-advisor/001-skill-graph | 3 | 3 | 0 | 0 | 6 | 002-daemon-and-unification | L=3, R=3 |
| 003-deep-review-program | 000-release-cleanup/001-release-readiness | 3 | 3 | 0 | 0 | 6 | 003-deep-review-program | L=3.0, R=3 |
| 003-smart-remediation-and-opencode-plugin | 006-skill-advisor/003-router | 3 | 3 | 0 | 0 | 6 | 003-smart-remediation-and-opencode-plugin | L=3, R=3 |
...
| 001-consolidation-investigation | 008-template-levels | 2.5 | 3 | 0 | 0 | 6 | 001-consolidation-investigation | L=2.5, R=3 |
| 005-expansion-and-alignment | 000-release-cleanup/005-stress-test | 2 | 3 | 0 | 0 | 5 | 005-expansion-and-alignment | L=2.0, R=3 |
| 005-stability-instrumentation | 014-local-embeddings-migration/032-substrate-repair-followups | 2 | 3 | 0 | 0 | 5 | 005-stability-instrumentation | L=2.0, R=3 |

...
| 3 | `003-deep-review-uplift` | H-7 (extend EXISTING file:line+normalized_title dedup at `deep_start-review-loop_auto.yaml:1115-1124` per council §10.4) — **H-9 DEFERRED to packet 111+** per council §10.5 | `.opencode/commands/deep/assets/deep_start-review-loop_{auto,confirm}.yaml` synthesis dedup step | ~2-3h (revised down after H-9 defer) |

---
title: "Implementation Plan: Phase 1 H-5 + M-6 mk-plugins config uplift"
description: "Add 3-tier config resolution + async config init to mk-skill-advisor and mk-code-graph plugins."
trigger_phrases:
  - "110 phase 001-mk-plugins plan"
importance_tier: "important"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/110-auto-review-stretch-config-dedup-gates/001-mk-plugins-config-uplift"
    ...
    session_dedup:
      ...
      session_id: "2026-05-16-110-001-mk-plugins-plan"
...
# Implementation Plan: Phase 1 H-5 + M-6 mk-plugins config uplift
...
### Overview
Add 3-tier config resolution + async config init to mk-skill-advisor and mk-code-graph plugins. Sequential file edits with per-file smoke tests.
<!-- /ANCHOR:summary -->

...
description: "Task tracking for maturing sk-prompt-small-model into the per-model prompt-craft content hub: SKILL.md rewrite, _index.md creation, and two priority profiles (minimax-m3.md + mimo-v2.5-pro.md)."
trigger_phrases:
  - "tasks"
  - "model hub tasks"
...
- [x] T001 Audit existing SKILL.md to identify what to keep vs rewrite (`.opencode/skills/sk-prompt-small-model/SKILL.md`)
...
- [x] T004 Rewrite SKILL.md: retitle to "Small-Model Prompt-Craft Hub", flip ALWAYS/NEVER rules (prompt-craft here; executor mechanics in cli-*), add dispatch matrix, add adoption protocol, bump version 0.1.0 -> 0.2.0, keep at <= 200 LOC (`.opencode/skills/sk-prompt-small-model/SKILL.md`)

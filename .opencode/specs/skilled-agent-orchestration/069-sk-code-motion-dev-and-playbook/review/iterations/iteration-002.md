...
- The requested kebab-case residual grep returned zero matches: `grep -rn "motion_dev/[a-z]*-[a-z]" .opencode/skills/sk-code/ specs/skilled-agent-orchestration/069-sk-code-motion-dev-and-playbook/`.

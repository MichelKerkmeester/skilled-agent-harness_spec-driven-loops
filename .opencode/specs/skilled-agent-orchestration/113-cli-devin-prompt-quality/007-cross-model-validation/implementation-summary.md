...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/skilled-agent-orchestration/113-cli-devin-prompt-quality/007-cross-model-validation/scripts/analyze-only.cjs"
      - ".opencode/specs/skilled-agent-orchestration/113-cli-devin-prompt-quality/007-cross-model-validation/state/cross-model-results.jsonl"

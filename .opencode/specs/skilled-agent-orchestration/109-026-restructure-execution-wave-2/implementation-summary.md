...
| Field | Value |
|-------|-------|
| **Spec Folder** | skilled-agent-orchestration/109-026-restructure-execution-wave-2 |
| **Phase** | 109 |
| **Completed** | TBD |
| **Level** | 1 |
...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/` — 26 children → 5 sub-phases

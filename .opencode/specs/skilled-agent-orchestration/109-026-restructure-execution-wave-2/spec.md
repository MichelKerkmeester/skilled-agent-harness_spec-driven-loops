...
- 000 dup-prefixed packets (003-vitest-baseline-recovery vs 002-search-query-rag-optimization; 004-search-rag-measurement-driven-implementation vs 007-vitest-recovery-followup): rename via -alt suffix before sub-phase move

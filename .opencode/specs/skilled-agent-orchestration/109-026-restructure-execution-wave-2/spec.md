...
description: "Execute 998 Wave 2 PROCEED operations: 000-release-cleanup 6-sub-phase recatalog, 008-skill-advisor 5-sub-phase internal structure, parent-doc derived fields, SHALLOW+MEDIUM→DEEP archive. Reduced from 998's full 4-op plan."
trigger_phrases:
  - "109 spec"
...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/109-026-restructure-execution-wave-2"
...
Execute 998's 4 PROCEED Wave 2 operations: graph-metadata sync (000 7→59, 008 13→26), 000-release-cleanup 6-sub-phase recatalog, 008-skill-advisor 5-sub-phase internal structure, SHALLOW+MEDIUM reclassification archive, parent-doc derived fields. Per-operation immediate commit, per-wave HEAD baseline.
<!-- /ANCHOR:problem -->
...
- 000 dup-prefixed packets (006-vitest-baseline-recovery vs 006-search-query-rag-optimization; 007-search-rag-measurement-driven-implementation vs 007-vitest-recovery-followup): rename via -alt suffix before sub-phase move

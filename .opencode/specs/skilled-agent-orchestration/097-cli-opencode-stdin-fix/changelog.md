...
- **Spec-folder docs** at `specs/skilled-agent-orchestration/097-cli-opencode-stdin-fix/`: spec.md, plan.md, tasks.md, checklist.md, description.json, graph-metadata.json, implementation-summary.md, resource-map.md, changelog.md (this file).

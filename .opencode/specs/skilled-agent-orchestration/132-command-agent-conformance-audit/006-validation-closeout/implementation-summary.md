...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/skilled-agent-orchestration/132-command-agent-conformance-audit/graph-metadata.json"
    session_dedup:
...
| `132-command-agent-conformance-audit/{description,graph-metadata}.json` (parent + all 6 children) | Regenerated | Program metadata rollup |
<!-- /ANCHOR:what-built -->

...
2. **`graph-metadata.json` `derived.last_active_child_id` is `null`** — `graph-metadata.json:222` — Expected `"skilled-agent-orchestration/082-sk-improve-prompt-rename/006-advisor-and-validate"`. Auto-generated on next memory save.

...
| From | To | Notes |
|------|-----|-------|
| `.opencode/skill/sk-improve-prompt/` | `.opencode/skill/sk-prompt/` | Folder rename target; aggregate content count: 39 matching lines across 8 files |
...
| String `.opencode/skill/sk-improve-prompt/` | `.opencode/skill/sk-prompt/` | URL/path references in docs, agents, commands, graph metadata, and changelogs |
...
- Highest concentration: `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py` with 31 matching lines.
...
| Area | Representative paths | Count | Category |
|------|----------------------|-------|----------|
| Skill folder root | `.opencode/skill/sk-improve-prompt/` | 39 aggregate | MUST RENAME |
| Skill frontmatter | `.opencode/skill/sk-improve-prompt/SKILL.md` | 1 | MUST RENAME |
| Skill README | `.opencode/skill/sk-improve-prompt/README.md` | 4 | MUST RENAME |
| Skill graph metadata | `.opencode/skill/sk-improve-prompt/graph-metadata.json` | 15 | MUST RENAME |
| Skill changelog | `.opencode/skill/sk-improve-prompt/changelog/v1.0.0.0.md` | 1 | MUST RENAME |
| Skill changelog | `.opencode/skill/sk-improve-prompt/changelog/v1.1.0.0.md` | 7 | MUST RENAME |
| Skill changelog | `.opencode/skill/sk-improve-prompt/changelog/v1.2.0.0.md` | 7 | MUST RENAME |
| Skill reference | `.opencode/skill/sk-improve-prompt/references/depth_framework.md` | 1 | MUST RENAME |
| Skill reference | `.opencode/skill/sk-improve-prompt/references/patterns_evaluation.md` | 0 | MUST RENAME path only via folder rename |
| Skill asset | `.opencode/skill/sk-improve-prompt/assets/cli_prompt_quality_card.md` | 3 | MUST RENAME |
| Skill assets | `.opencode/skill/sk-improve-prompt/assets/format_guide_json.md`, `.opencode/skill/sk-improve-prompt/assets/format_guide_markdown.md`, `.opencode/skill/sk-improve-prompt/assets/format_guide_yaml.md` | 0 each | MUST RENAME path only via folder rename |
| Changelog symlink | `.opencode/changelog/sk-improve-prompt` | 15 via symlink target | MUST RENAME or retarget symlink |
| Advisor skill graph | `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/skill-graph.json` | 5 | MUST RENAME: `hub_skills`, `signals`, `families`, `adjacency`, node entry |

### Phase 003 — `.opencode/` internals

| Sub-area | Representative paths | Count | Category |
|----------|----------------------|-------|----------|
| Advisor Python scoring | `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py` | 31 | MUST RENAME |
| Advisor explicit lane | `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/lib/scorer/lanes/explicit.ts` | 9 | MUST RENAME |
| Advisor lexical lane | `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/lib/scorer/lanes/lexical.ts` | 1 | MUST RENAME |
| Advisor fusion lane | `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/lib/scorer/fusion.ts` | 1 | MUST RENAME |
| Advisor metadata | `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/graph-metadata.json` | 1 | MUST RENAME |
| Advisor sync script | `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/check-prompt-quality-card-sync.sh` | 1 | MUST RENAME |
| Routing accuracy fixtures | `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/routing-accuracy/labeled-prompts.jsonl` | 10 | MUST RENAME |
| Regression fixtures | `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/fixtures/skill_advisor_regression_cases.jsonl` | 2 | MUST RENAME |
| Dispatcher command body | `.opencode/command/improve/prompt.md` | 10 | MUST RENAME body refs only; command path/name unchanged |
| Dispatcher README | `.opencode/command/improve/README.txt` | 2 | MUST RENAME body refs only |
| OpenCode agent body | `.opencode/agent/improve-prompt.md` | 9 | MUST RENAME body refs only; agent path/name unchanged |
| CLI Claude mirror | `.opencode/skill/cli-claude-code/assets/prompt_quality_card.md`, `.opencode/skill/cli-claude-code/SKILL.md` | 1 each | MUST RENAME |
| CLI Claude manual playbook | `.opencode/skill/cli-claude-code/manual_testing_playbook/07--prompt-templates/002-clear-quality-card-5-check.md` | 1 | MUST RENAME |
| CLI Copilot mirror | `.opencode/skill/cli-copilot/assets/prompt_quality_card.md`, `.opencode/skill/cli-copilot/SKILL.md`, `.opencode/skill/cli-copilot/manual_testing_playbook/07--prompt-templates/002-clear-quality-card-application.md` | 1 each | MUST RENAME |
| CLI Codex mirror | `.opencode/skill/cli-codex/assets/prompt_quality_card.md`, `.opencode/skill/cli-codex/SKILL.md` | 1 each | MUST RENAME |
| CLI Gemini mirror | `.opencode/skill/cli-gemini/assets/prompt_quality_card.md`, `.opencode/skill/cli-gemini/SKILL.md` | 1 each | MUST RENAME |
| CLI Gemini manual playbook | `.opencode/skill/cli-gemini/manual_testing_playbook/07--prompt-templates/002-clear-quality-card-application.md` | 0 | NEEDS DECISION: verified exists but has no old-name content |
| CLI OpenCode mirror | `.opencode/skill/cli-opencode/assets/prompt_quality_card.md` | 1 | MUST RENAME |
| CLI OpenCode manual playbook | `.opencode/skill/cli-opencode/manual_testing_playbook/07--prompt-templates/002-clear-quality-card.md` | 2 | MUST RENAME |
| Deep agent improvement cross-refs | `.opencode/skill/deep-agent-improvement/SKILL.md`, `.opencode/skill/deep-agent-improvement/changelog/v1.1.0.0.md`, `.opencode/skill/deep-agent-improvement/graph-metadata.json` | 1 each | MUST RENAME |
| sk-code advisor docs | `.opencode/skill/sk-code/assets/opencode/checklists/mcp_server_authoring.md` | 2 | MUST RENAME |
| sk-code advisor playbook | `.opencode/skill/sk-code/manual_testing_playbook/04--skill-advisor-integration/001-advisor-probe-battery.md` | 1 | MUST RENAME |
...
| Skill catalog README | `.opencode/skill/README.md` | 4 | MUST RENAME |
| system-spec-kit changelog | `.opencode/skill/system-spec-kit/changelog/v3.4.0.0.md` | 1 | MUST RENAME |
| Smart-router measurement results | `.opencode/skill/system-spec-kit/scripts/observability/smart-router-measurement-results.jsonl` | 15 | NEEDS DECISION: generated measurement history; update only if forward-facing IDs are intentionally mutable |
| Smart-router measurement report | `.opencode/skill/system-spec-kit/scripts/observability/smart-router-measurement-report.md` | 1 | NEEDS DECISION: generated report table; update with results if regenerated |
...
| Advisor probe 1 | `python3 .opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py "improve this prompt with COSTAR" --threshold 0.0` | top skill is `sk-prompt` |
| Advisor probe 2 | `python3 .opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py "enhance my prompt using CRISPE and CRAFT" --threshold 0.0` | top skill is `sk-prompt` |
| Advisor probe 3 | `python3 .opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py "/improve:prompt make this clearer" --threshold 0.0` | command bridge still routes to prompt skill |
| Advisor probe 4 | `python3 .opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py "create a sharper prompt for the routing evaluator" --threshold 0.0` | top skill is `sk-prompt` |
| Advisor probe 5 | `python3 .opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py "clear scoring for this prompt package" --threshold 0.0` | top skill is `sk-prompt` |
| Parent validation | `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/082-sk-improve-prompt-rename --strict` | exit 0 |
...
1. **Filename embeds**: `find . -name "*sk-improve-prompt*"` found `.opencode/skill/sk-improve-prompt`, `.opencode/changelog/sk-improve-prompt`, `.opencode/specs/skilled-agent-orchestration/082-sk-improve-prompt-rename`, plus `barter/coder/.opencode/...` nested-copy paths. The packet must decide whether only the canonical root `.opencode/` surfaces are in scope.
2. **JSON keys**: `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/skill-graph.json` contains `sk-improve-prompt` as object keys and graph IDs, not only values.
3. **URL paths**: docs and agents link to `.opencode/skill/sk-improve-prompt/` and `.opencode/skill/sk-improve-prompt/SKILL.md`; these become broken links after folder rename.
...
| 005 — Root + active config | `README.md`, `.opencode/install_guides/SET-UP - AGENTS.md`, `.opencode/install_guides/README.md`, `.opencode/skill/README.md`, `.opencode/skill/system-spec-kit/changelog/v3.4.0.0.md`, `.opencode/changelog/agent-orchestration/v2.4.0.0.md` | N/A | Smart-router observability JSONL/report: update only if considered forward-facing or regenerated |

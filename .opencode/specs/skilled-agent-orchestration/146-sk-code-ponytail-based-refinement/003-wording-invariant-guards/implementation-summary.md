...
_memory:
  continuity:
    packet_pointer: .opencode/specs/skilled-agent-orchestration/146-sk-code-ponytail-based-refinement/003-wording-invariant-guards
...
| **Parent** | `146-sk-code-ponytail-based-refinement` (phase 3 of 6) |

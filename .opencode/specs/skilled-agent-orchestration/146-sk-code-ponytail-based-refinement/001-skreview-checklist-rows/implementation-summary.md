...
_memory:
  continuity:
    packet_pointer: .opencode/specs/skilled-agent-orchestration/146-sk-code-ponytail-based-refinement/001-skreview-checklist-rows
...
| **Parent** | `146-sk-code-ponytail-based-refinement` (phase 1 of 6) |

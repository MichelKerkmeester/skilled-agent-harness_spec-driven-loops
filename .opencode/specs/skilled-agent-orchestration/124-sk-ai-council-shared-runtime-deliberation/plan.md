...
- **Procedure**: Remove only `.opencode/specs/skilled-agent-orchestration/124-sk-ai-council-shared-runtime-deliberation/`. No source-code rollback is needed because this packet does not modify skill or MCP files.
<!-- /ANCHOR:rollback -->
...
### Rollback Procedure
1. Remove `.opencode/specs/skilled-agent-orchestration/124-sk-ai-council-shared-runtime-deliberation/`.

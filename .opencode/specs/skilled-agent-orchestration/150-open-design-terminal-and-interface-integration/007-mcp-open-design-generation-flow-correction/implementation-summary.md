...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/150-open-design-terminal-and-interface-integration/007-mcp-open-design-generation-flow-correction"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | skilled-agent-orchestration/150-open-design-terminal-and-interface-integration/007-mcp-open-design-generation-flow-correction |

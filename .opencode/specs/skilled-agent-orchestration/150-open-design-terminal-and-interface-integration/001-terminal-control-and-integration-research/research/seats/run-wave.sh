...
SEATS="$REPO/.opencode/specs/skilled-agent-orchestration/150-open-design-terminal-and-interface-integration/001-terminal-control-and-integration-research/research/seats"

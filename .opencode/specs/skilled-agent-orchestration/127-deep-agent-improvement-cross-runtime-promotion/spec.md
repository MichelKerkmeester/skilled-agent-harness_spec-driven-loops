...
| Source Roadmap | `.opencode/specs/skilled-agent-orchestration/123-deep-agent-improvement-uplift/003-improvement-recommendations/improvement-roadmap.md` |
<!-- /ANCHOR:metadata -->
...
| `.opencode/specs/skilled-agent-orchestration/127-deep-agent-improvement-cross-runtime-promotion/*` | Create | Level 3 docs and metadata. |
<!-- /ANCHOR:scope -->

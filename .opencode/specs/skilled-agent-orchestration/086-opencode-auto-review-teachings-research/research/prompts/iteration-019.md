...
for N in 007 008 009 010 011 012 013 014 015 016 017 018; do
  ...
  rg -A 30 'Reusable Patterns|Adopt|Cross-Skill Adoption|adoption|Recommendations' \
    .opencode/specs/skilled-agent-orchestration/z_archive/086-opencode-auto-review-teachings-research/research/iterations/iteration-$N.md 2>/dev/null | head -40
done
```
...
for N in 007 008 009 010 011 012 013 014 015 016 017 018; do
  ...
  rg -A 30 'Adopt|adoption|Recommendations|Reject|Justification' \
    .opencode/specs/skilled-agent-orchestration/z_archive/086-opencode-auto-review-teachings-research/research/iterations/iteration-$N.md 2>/dev/null
done
```

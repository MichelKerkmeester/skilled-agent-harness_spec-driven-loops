...
- [x] T002 `memory_index_scan({ specFolder: "skilled-agent-orchestration/120-glm-5-2-support" })`
- [x] T003 `memory_index_scan({ specFolder: "skilled-agent-orchestration/121-sk-prompt-models-rename" })`
<!-- /ANCHOR:phase-2 -->

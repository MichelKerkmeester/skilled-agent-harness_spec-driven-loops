...
### Validation
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/110-auto-review-stretch-uplift/001-mk-plugins-config-uplift --strict` — exit 0

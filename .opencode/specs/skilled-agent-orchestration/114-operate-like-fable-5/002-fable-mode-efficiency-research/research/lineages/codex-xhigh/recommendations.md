...
## Evidence Anchors
- Round-2 scope: `.opencode/specs/skilled-agent-orchestration/z_archive/114-operate-like-fable-5/002-fable-mode-efficiency-research/spec.md:77`
- Round-1 shipped set: `.opencode/specs/skilled-agent-orchestration/z_archive/114-operate-like-fable-5/001-initial-refinement/before-vs-after.md:17`
- Governor source: `.opencode/specs/skilled-agent-orchestration/z_archive/114-operate-like-fable-5/external/opus-fable-mode-main/governor-block.md:4`
- Re-injection source: `.opencode/specs/skilled-agent-orchestration/z_archive/114-operate-like-fable-5/external/opus-fable-mode-main/reinject.sh:4`
- Metric source: `.opencode/specs/skilled-agent-orchestration/z_archive/114-operate-like-fable-5/external/opus-fable-mode-main/leak_test.py:13`

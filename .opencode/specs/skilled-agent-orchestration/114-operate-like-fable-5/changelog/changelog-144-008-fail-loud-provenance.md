...
> Spec folder: `.opencode/specs/skilled-agent-orchestration/z_archive/114-operate-like-fable-5/008-fail-loud-provenance` (Level 2)
...
- Ran the full skill vitest suite and `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/114-operate-like-fable-5/008-fail-loud-provenance --strict`, then synced spec, plan, tasks and checklist.

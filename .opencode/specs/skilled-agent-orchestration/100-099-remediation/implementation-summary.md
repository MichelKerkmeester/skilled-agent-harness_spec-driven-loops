...
| `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/004-symlinks/spec.md` | Modified | P1-022 |
| `.opencode/specs/skilled-agent-orchestration/098-097-remediation/00N-*/checklist.md` (×7) | Rewritten | P1-024 |
| `.opencode/specs/skilled-agent-orchestration/098-097-remediation/00N-*/tasks.md` (×7) | Modified | P1-024 |
| `.opencode/specs/skilled-agent-orchestration/098-097-remediation/00N-*/implementation-summary.md` (×7) | Modified | P1-024 + P1-023 |

...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/121-deep-research-uncovered-questions-tracking"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 121-deep-research-uncovered-questions-tracking |
...
| `.opencode/specs/skilled-agent-orchestration/121-deep-research-uncovered-questions-tracking/` | Created | Level 3 packet docs |
<!-- /ANCHOR:what-built -->
...
| Packet strict validation | PASS: `validate.sh .../121-deep-research-uncovered-questions-tracking --strict` |
...
.opencode/skills/deep-research/scripts/reduce-state.cjs
.opencode/skills/system-spec-kit/scripts/tests/deep-research-reducer.vitest.ts
.opencode/specs/skilled-agent-orchestration/121-deep-research-uncovered-questions-tracking/spec.md
.opencode/specs/skilled-agent-orchestration/121-deep-research-uncovered-questions-tracking/plan.md
.opencode/specs/skilled-agent-orchestration/121-deep-research-uncovered-questions-tracking/tasks.md
.opencode/specs/skilled-agent-orchestration/121-deep-research-uncovered-questions-tracking/checklist.md
.opencode/specs/skilled-agent-orchestration/121-deep-research-uncovered-questions-tracking/decision-record.md
.opencode/specs/skilled-agent-orchestration/121-deep-research-uncovered-questions-tracking/implementation-summary.md
.opencode/specs/skilled-agent-orchestration/121-deep-research-uncovered-questions-tracking/description.json
.opencode/specs/skilled-agent-orchestration/121-deep-research-uncovered-questions-tracking/graph-metadata.json
```

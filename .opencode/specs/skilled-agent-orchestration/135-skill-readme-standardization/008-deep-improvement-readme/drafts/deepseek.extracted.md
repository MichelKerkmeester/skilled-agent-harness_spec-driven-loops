...
| **Invoke with** | `/deep:start-agent-improvement-loop`, `/deep:start-model-benchmark-loop` or `/deep:start-skill-benchmark-loop` |
...
| Check | How to run it |
|---|---|
| README structure | `python3 .opencode/skills/sk-doc/scripts/validate_document.py .opencode/skills/deep-improvement/README.md --type readme` reports zero issues |

...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/097-track-review"
...
|-----------|-------------|-------------|
| `.opencode/specs/skilled-agent-orchestration/097-track-review/review/` | Create | Skill-owned review packet with state files |
| `.opencode/specs/skilled-agent-orchestration/097-track-review/review/review-report.md` | Create | Synthesis output: 9 sections + Planning Packet |
| `.opencode/specs/skilled-agent-orchestration/097-track-review/review/resource-map.md` | Create | Resource map of touched files across 093-096 |
| `.opencode/specs/skilled-agent-orchestration/097-track-review/implementation-summary.md` | Modify | Continuity update post-synthesis |
<!-- /ANCHOR:scope -->

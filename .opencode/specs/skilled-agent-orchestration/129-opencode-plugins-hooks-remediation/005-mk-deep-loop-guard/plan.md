---
title: "Implementation Plan: mk-deep-loop-guard remediation"
description: "The fix approach for the 13 mk-deep-loop-guard findings, grouped by severity."
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "Drafted fix approach for mk-deep-loop-guard"
    ...
    answered_questions: []
---
# Implementation Plan: mk-deep-loop-guard remediation
...
### Overview
Apply 13 fixes to `mk-deep-loop-guard` and its Claude hook version, ordered P1 -> P2 -> refinement, each verified against its finding. Capture a green test baseline first.
<!-- /ANCHOR:summary -->
...
### Key Components
- **Plugin entrypoint**: `.opencode/plugins/mk-deep-loop-guard.js`
- **Affected surfaces**: 3 file(s) across plugin, bridge, and Claude hook
...
|---------|--------------|--------|--------------|
| `.opencode/plugins/mk-deep-loop-guard.js` | audited surface | apply fixes | finding no longer reproduces; tests green |
| `.claude/settings.json` | audited surface | apply fixes | finding no longer reproduces; tests green |
| `.opencode/plugins/tests/mk-deep-loop-guard.test.cjs` | audited surface | apply fixes | finding no longer reproduces; tests green |
<!-- /ANCHOR:affected-surfaces -->
...
- [ ] Apply 6 P1 fixes (see tasks.md Phase 2)
- [ ] Apply 5 P2 fixes

---
title: "Implementation Plan: mk-dist-freshness-guard remediation"
description: "The fix approach for the 12 mk-dist-freshness-guard findings, grouped by severity."
trigger_phrases:
...
_memory:
  continuity:
    ...
    answered_questions: []
---
# Implementation Plan: mk-dist-freshness-guard remediation
...
### Overview
Apply 12 fixes to `mk-dist-freshness-guard` and its Claude hook version, ordered P1 -> P2 -> refinement, each verified against its finding. Capture a green test baseline first.
<!-- /ANCHOR:summary -->
...
### Key Components
- **Plugin entrypoint**: `.opencode/plugins/mk-dist-freshness-guard.js`
...
|---------|--------------|--------|--------------|
| `.opencode/skills/system-spec-kit/scripts/lib/dist-freshness.cjs` | audited surface | apply fixes | finding no longer reproduces; tests green |
| `.opencode/plugins/mk-dist-freshness-guard.js` | audited surface | apply fixes | finding no longer reproduces; tests green |
| `.opencode/skills/sk-code/code-quality/scripts/hooks/claude-posttooluse.sh` | audited surface | apply fixes | finding no longer reproduces; tests green |
| `.opencode/skills/sk-code/code-quality/scripts/check-dist-staleness.sh` | audited surface | apply fixes | finding no longer reproduces; tests green |
<!-- /ANCHOR:affected-surfaces -->
...
- [ ] Apply 5 P1 fixes (see tasks.md Phase 2)
- [ ] Apply 2 P2 fixes
- [ ] Apply 5 refinements or log as follow-ups

...
- `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/003-remediation/*/implementation-summary.md`
...
- File: `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/003-remediation/003-narrative-validation-repair/implementation-summary.md:76`
...
- **P1-007 still active**: 098/005 added honest deferral notes, but sampled checklist items remain unchecked at `.opencode/specs/skilled-agent-orchestration/z_archive/076-testing-playbooks-code-review-and-git/001-sk-code-review-playbook/checklist.md:106-118`. The evidence gap is disclosed, not backfilled.

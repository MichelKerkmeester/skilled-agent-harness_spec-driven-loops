...
- `.opencode/specs/skilled-agent-orchestration/121-deep-agent-improvement-benchmark-mode/003-build-benchmark-mode/spec.md:43,118-135,162-167` (priority, REQ-002/003/004, open questions)
- `.opencode/specs/skilled-agent-orchestration/121-deep-agent-improvement-benchmark-mode/002-implementation-deep-research/research/research.md:5-11,42-55` (seam contracts, scorer-decoupling intent, dispatcher = generation seam)

...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/115-deep-ai-council-rename/006-reindex-and-validate"
...
- `115-deep-ai-council-rename/graph-metadata.json` (refreshed via `generate-context.js`)
- `115-deep-ai-council-rename/changelog/changelog-115-<phase>-*.md` (one per phase via `nested-changelog.js`)

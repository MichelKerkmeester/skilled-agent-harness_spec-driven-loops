...
| `115-deep-ai-council-rename/graph-metadata.json` | Refresh via generate-context.js |
| `115-deep-ai-council-rename/changelog/*.md` | Generate per-phase via nested-changelog.js |
<!-- /ANCHOR:scope -->

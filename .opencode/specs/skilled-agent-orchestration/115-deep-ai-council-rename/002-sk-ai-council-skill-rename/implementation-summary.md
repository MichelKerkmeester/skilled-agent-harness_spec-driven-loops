...
Pattern source: `../../114-small-ai-model-optimization/007-sk-ai-small-model-rename/implementation-summary.md` (the sister 007 rename packet shipped 2026-05-21 documents the exact same mechanical pattern, applied to a different skill).
<!-- /ANCHOR:what-built -->

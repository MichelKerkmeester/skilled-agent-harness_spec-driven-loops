...
- **Procedure**: `git restore .opencode/specs/skilled-agent-orchestration/115-deep-ai-council-rename/001-preflight-scope-map/` to revert 001 spec docs; or `git clean -fd 001/scratch/` to clear scratch artifacts.
<!-- /ANCHOR:rollback -->

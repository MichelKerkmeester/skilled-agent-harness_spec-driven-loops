...
Stale refs / dead pointers / quality across the packet: HVR_REFERENCE paths resolve (references/global/hvr_rules.md); no leftover zeroed-fingerprint claims presented as real; no dead file paths; Branch field correct (matches actual branch). Anchors/template structure intact.

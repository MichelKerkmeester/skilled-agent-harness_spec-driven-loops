...
- [P1/traceability] Parent phase-map claims 001 accepted while child graph-metadata says draft (.opencode/specs/skilled-agent-orchestration/155-parent-skill-native-invocability/spec.md:line 49)
- [P1/traceability] Parent graph-metadata status 'planned' contradicts parent spec.md 'accepted' for 001 (.opencode/specs/skilled-agent-orchestration/155-parent-skill-native-invocability/graph-metadata.json:line 38)
- [P1/traceability] REQ-002 (P0 blocker) acceptance criterion is not satisfied by the decision-record artifact (.opencode/specs/skilled-agent-orchestration/155-parent-skill-native-invocability/001-invocability-mechanism/spec.md:line 115)
- [P1/traceability] Task T005 scope does not match the produced decision-record artifact (.opencode/specs/skilled-agent-orchestration/155-parent-skill-native-invocability/001-invocability-mechanism/tasks.md:line 63)
- [P1/traceability] SC-002 fallback requirement is not traced to a satisfied artifact (.opencode/specs/skilled-agent-orchestration/155-parent-skill-native-invocability/001-invocability-mechanism/spec.md:line 132)
- [P2/traceability] No checklist item verifies ADR status synchronization across documents (.opencode/specs/skilled-agent-orchestration/155-parent-skill-native-invocability/001-invocability-mechanism/checklist.md:line 151)

...
```json
{
  ...
  "findings": [
    ...
    },
    {
      ...
      "evidence": "jq '.children_ids' 114/graph-metadata.json includes 'skilled-agent-orchestration/114-small-ai-model-optimization/007-rename-sk-ai-small-model' (line 13); jq '.derived.last_active_child_id' points to same path (line 113)",

...
3. **Produce** per-edit JSON: `{file, old_text, new_text, verification_command}`. For file #6, the new_text includes the "(renamed sk-ai-small-model 2026-05-21)" tag preserving date.

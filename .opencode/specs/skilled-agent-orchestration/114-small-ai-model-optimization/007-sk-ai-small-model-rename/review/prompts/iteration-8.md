...
1. **Read** all 7 prior iter files at `.opencode/specs/skilled-agent-orchestration/114-small-ai-model-optimization/007-sk-ai-small-model-rename/review/iterations/iteration-{001..007}.md`. Build the full findings registry (P0/P1/P2 by ID).

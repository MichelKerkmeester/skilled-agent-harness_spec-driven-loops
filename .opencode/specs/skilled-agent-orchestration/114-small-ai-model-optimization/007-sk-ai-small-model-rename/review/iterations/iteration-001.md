...
- sk-ai-small-model/SKILL.md: rg count 0, expected 0 (live) → MATCH ✓
- cli-devin/graph-metadata.json: rg count 0, expected 0 (live) → MATCH ✓  
- sk-ai-small-model/changelog/v0.1.0.0.md: rg count 13, expected >0 (historical) → MATCH ✓
- sk-ai-small-model/changelog/v0.2.0.0.md: rg count 17, expected >0 (historical) → MATCH ✓

---
title: "Tasks: Relocate the model registry + all model benchmarks into sk-prompt-small-model; make sk-prompt a forkable standalone framework engine; deep-improvement writes benchmarks to the hub only [template:level_3/tasks.md]"
...
# Tasks: Relocate the model registry + all model benchmarks into sk-prompt-small-model; make sk-prompt a forkable standalone framework engine; deep-improvement writes benchmarks to the hub only
...
- [x] T001 Create `sk-prompt-small-model/assets/` directory (if not present)
- [x] T002 Create `sk-prompt-small-model/benchmarks/` hub directory
...
- [x] T004 Copy `sk-prompt/assets/model-profiles.json` to `sk-prompt-small-model/assets/model-profiles.json`
...
- [x] T009 Reword sk-prompt Tier-2 precedence generically (no sk-prompt-small-model path, no model names)
- [x] T010 [P] Move benchmark run-data from spec 120/003 (MiniMax) to `sk-prompt-small-model/benchmarks/minimax-m2.7-bakeoff/`
- [x] T011 [P] Move benchmark run-data from spec 126/004 (MiMo) to `sk-prompt-small-model/benchmarks/mimo-v2.5-bakeoff/`
- [x] T012 [P] Move benchmark run-data from spec 113/003 (SWE-1.6) to `sk-prompt-small-model/benchmarks/swe-1.6-eval/`
- [x] T013 [P] Move benchmark run-data from spec 113/005 (SWE-1.6 rerun) to `sk-prompt-small-model/benchmarks/swe-1.6-rerun/`
- [x] T014 [P] Move benchmark run-data from spec 127/004 to `sk-prompt-small-model/benchmarks/127-004-sweep/`
- [x] T015 [P] Move benchmark run-data from spec 127/006 to `sk-prompt-small-model/benchmarks/127-006-sweep/`
...
- [x] T020 Update `deep-improvement/commands/auto.yaml` output_dir to `sk-prompt-small-model/benchmarks/{run_label}`
- [x] T021 Update `deep-improvement/commands/confirm.yaml` output_dir to `sk-prompt-small-model/benchmarks/{run_label}`
<!-- /ANCHOR:phase-2 -->

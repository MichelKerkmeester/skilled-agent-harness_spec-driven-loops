---
title: "Changelog: install-claude-frontend-design [143-sk-design-interface/001-install-claude-frontend-design]"
...
- Confirmed the name and family with the operator: `sk-design-interface`, in the `sk-code` family.
...
- Authored lean house-template runtime instructions in `.opencode/skills/sk-design-interface/SKILL.md`.
...
| `.opencode/skills/sk-design-interface/references/design_principles.md` | Created | Full upstream guidance, reference template and verbatim content. |
...
| `.opencode/skills/sk-design-interface/graph-metadata.json` | Created | Schema-2 advisor node in the `sk-code` family. |
| `.opencode/skills/sk-code/graph-metadata.json` | Modified | Reciprocal sibling edge to `sk-design-interface`. |
| `.opencode/skills/mcp-magicpath/SKILL.md` | Modified | Auto-apply `sk-design-interface` when authoring or shaping UI. |
| `.opencode/skills/mcp-magicpath/graph-metadata.json` | Modified | Added `depends_on sk-design-interface` at 0.7, `related_to` and reciprocal `prerequisite_for`. |

...
> Spec folder: `.opencode/specs/skilled-agent-orchestration/143-sk-design-interface` (Level Phase Parent)
...
| `.opencode/specs/skilled-agent-orchestration/143-sk-design-interface/*` | Created and updated | Phase packet docs, research outputs and completion evidence. |

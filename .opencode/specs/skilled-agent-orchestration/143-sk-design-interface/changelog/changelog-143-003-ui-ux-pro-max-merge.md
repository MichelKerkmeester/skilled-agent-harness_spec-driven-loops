---
title: "Changelog: ui-ux-pro-max merge [143-sk-design-interface/003-ui-ux-pro-max-merge]"
...
> Spec folder: `.opencode/specs/skilled-agent-orchestration/143-sk-design-interface/003-ui-ux-pro-max-merge` (Level 2)
> Parent packet: `.opencode/specs/skilled-agent-orchestration/143-sk-design-interface`

### Summary

`sk-design-interface` gained real design data for the first time. The merge added a quality floor, aesthetic inventory and optional query-only search across the adopted data while keeping `SKILL.md` lean at 1437 words. The upstream `design_principles.md` remained byte-for-byte unchanged.
...
|------|--------|--------------|
| `sk-design-interface/assets/data/*.csv (8)` | Created | Adopted MIT design data for quality floor and aesthetic inventory. |
...
| `sk-design-interface/scripts/design_search{,_core}.py` | Created | Optional zero-dependency query-only search. |
| `sk-design-interface/LICENSE-ui-ux-pro-max.txt, THIRD-PARTY-NOTICES.md` | Created | Licensing artifacts. |
| `sk-design-interface/SKILL.md, graph-metadata.json` | Modified | Routing and license declaration. |

...
| 2 | sk-design-interface current-state parity gap | 0.72 | 6 | complete |
...
| `sk-design-interface` parity gap | Answered | iteration-002 |
...
| Turn `sk-design-interface` catalog into a generator | The catalog is explicitly critique-against fuel. |

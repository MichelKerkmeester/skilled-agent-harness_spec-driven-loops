...
4. Read the target house skill (SKILL.md, design_principles.md, graph-metadata.json) to anchor the receiving structure. [SOURCE: file:.opencode/skills/sk-design-interface/SKILL.md]

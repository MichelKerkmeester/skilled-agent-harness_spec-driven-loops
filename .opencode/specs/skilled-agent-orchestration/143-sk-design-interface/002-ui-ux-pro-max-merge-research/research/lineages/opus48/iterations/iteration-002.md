...
- **Importing the 16 `stacks/*.csv` into sk-design-interface** — ruled out: overlaps and cross-cuts `sk-code`'s ownership of implementation/stack guidance. [SOURCE: file:.opencode/skills/sk-code/references/stack_detection.md]

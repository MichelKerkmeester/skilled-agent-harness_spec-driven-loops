---
title: "Research Specification: ui-ux-pro-max merge into sk-design-interface"
description: "10-iteration deep-research loop (5x gpt-5.5-fast xhigh via cli-opencode + 5x claude-opus-4-8 xhigh via cli-claude-code, parallel by-model fan-out) into how the vendored ui-ux-pro-max-skill-main repo (or parts) can merge into and improve the house sk-design-interface skill. Research-only: produce a merge recommendation; NO change to sk-design-interface in this packet."
trigger_phrases:
  - "ui-ux-pro-max merge research"
  - "sk-design-interface improvement research"
  - "ui ux pro max skill"
...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/143-sk-design-interface/002-ui-ux-pro-max-merge-research"
...
# Research Specification: ui-ux-pro-max merge into sk-design-interface
...
| **Type** | Deep-research (read-only). Recommend; NO change to sk-design-interface in this packet. |
<!-- /ANCHOR:metadata -->
...
**In scope:**
- Inventory and assessment of `external/ui-ux-pro-max-skill-main/` assets (data files, scripts, checklist, docs) for reuse in `sk-design-interface`.
...
**Out of scope:**
- Implementing the merge into `sk-design-interface` (no edits to the skill in this packet).
...
- How can we use the ui-ux-pro-max-skill-main repo (or parts) to merge into and improve our sk-design-interface skill: what data, scripts, and patterns to adopt, how to integrate them into the house skill structure, what to leave out, and the licensing path.
...
- External repo: `.opencode/specs/skilled-agent-orchestration/143-sk-design-interface/external/ui-ux-pro-max-skill-main/` (MIT) — data files, `cli/`, `src/`, `docs/`, README, `skill.json`.
- Target skill: `.opencode/skills/sk-design-interface/` (SKILL.md, references/, README, graph-metadata.json).

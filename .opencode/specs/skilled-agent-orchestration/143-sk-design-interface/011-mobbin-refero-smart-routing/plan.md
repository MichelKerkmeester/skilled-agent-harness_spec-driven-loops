...
description: "Plan to add a hybrid initiative/ask decision gate for the Mobbin/Refero reference MCPs in sk-design-interface."
trigger_phrases:
...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/143-sk-design-interface/011-mobbin-refero-smart-routing"

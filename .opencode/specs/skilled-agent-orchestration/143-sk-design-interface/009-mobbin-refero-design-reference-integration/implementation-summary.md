...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/143-sk-design-interface/009-mobbin-refero-design-reference-integration"
    last_updated_at: "2026-06-15T11:20:00Z"
    last_updated_by: "claude-opus-4-8"
    recent_action: "Wired both MCPs and integrated them into sk-design-interface"
...
| `.opencode/skills/sk-design-interface/references/design_references_mcp.md` | Created | The critique-against use and the hard rules |
| `.opencode/skills/sk-design-interface/references/mobbin_tools.md` | Created | Mobbin MCP tool catalog (search_screens, search_flows) |
| `.opencode/skills/sk-design-interface/references/refero_tools.md` | Created | Refero MCP tool catalog (8 tools: styles, screens, flows) |
| `.opencode/skills/sk-design-interface/SKILL.md` | Modified | ON_DEMAND row, references entry, Related Skills bullet, loading note |
...
| `package_skill --check` (sk-design-interface) | PASS |

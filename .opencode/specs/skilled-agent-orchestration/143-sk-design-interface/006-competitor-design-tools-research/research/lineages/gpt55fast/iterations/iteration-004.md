...
6. Subframe exports Tailwind v3/v4 theme configurations and syncs theme/components to code. This supports a recommendation for `sk-design-interface` to emit token/handoff blocks in a machine-consumable form, but not to own the implementation. [SOURCE: https://docs.subframe.com/learn/theme/exporting-theme.md]

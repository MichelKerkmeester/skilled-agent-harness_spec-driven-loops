...
# Research Specification: Competitor AI design-tool ideas for sk-design-interface and mcp-magicpath
...
- Per-idea ADOPT / ADAPT / SKIP for `sk-design-interface` and `mcp-magicpath`, with reasons.
...
- Local skills under improvement: `.opencode/skills/sk-design-interface/` and `.opencode/skills/mcp-magicpath/`.

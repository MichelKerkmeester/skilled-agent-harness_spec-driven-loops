---
title: "Feature Specification: sk-design-interface"
description: "Establish and strengthen the sk-design-interface skill: install it into the framework (phase 001) and research how to improve it from external sources (phase 002)."
trigger_phrases:
  - "sk-design-interface"
...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/143-sk-design-interface"
    ...
    session_dedup:
      ...
      session_id: "phase-143-sk-design-interface"
...
# Feature Specification: sk-design-interface
...
### Purpose
Build `sk-design-interface` as a framework-native design skill and improve it through scoped, independently shippable phases.
...
### In Scope
- The `sk-design-interface` skill: its installation and its improvement phases.
...
|-------|--------|-------|--------|
| 1 | `001-install-claude-frontend-design/` | Install Anthropic's frontend-design as the house-conformant, advisor-routable `sk-design-interface` skill | Complete |
| 2 | `002-ui-ux-pro-max-merge-research/` | Deep research into how the vendored `ui-ux-pro-max` repo can merge into and improve `sk-design-interface` (recommendation only) | Complete |
...
| 5 | `005-claude-design-parity-research/` | Deep research into improving sk-design-interface + mcp-magicpath toward Claude Design parity (recommendation only) | Complete |
...
| 12 | `012-catalog-playbook-realignment/` | Realign the feature_catalog + manual_testing_playbook to the post-011 reality: catalogue the Mobbin/Refero design-references capability + its hybrid routing, and add a routing manual-testing scenario | Complete |
...
- **The skill itself**: `.opencode/skills/sk-design-interface/`.

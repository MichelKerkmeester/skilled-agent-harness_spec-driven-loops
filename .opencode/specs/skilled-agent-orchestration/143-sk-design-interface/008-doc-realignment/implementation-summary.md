...
description: "Three fresh opus markdown agents realigned the sk-design-interface feature catalog, playbook, and README, and the mcp-magicpath READMEs, to the post-007 parity reality. All sk-doc valid; protocol single-sourced."
trigger_phrases:
...
| Field | Value |
|-------|-------|
| **Spec Folder** | skilled-agent-orchestration/143-sk-design-interface/008-doc-realignment |
...
### Feature catalog (sk-design-interface)
...
### Manual testing playbook + README (sk-design-interface)

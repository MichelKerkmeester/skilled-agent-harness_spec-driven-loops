...
```yaml
      ...
      step_evaluate_legal_stop:
        ...
        command: "node .opencode/skills/sk-improve-agent/scripts/evaluate-legal-stop.cjs {spec_folder}/improvement --output {spec_folder}/improvement/legal-stop-evaluation.json --journal {spec_folder}/improvement/improvement-journal.jsonl --session-id {session_id} --iteration {iteration}"
      step_stop_check:
...
For `.opencode/skills/sk-improve-agent/scripts/evaluate-legal-stop.cjs` as a new helper, proposed core output shape:

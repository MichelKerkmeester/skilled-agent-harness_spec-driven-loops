# Deep Research Iteration 10 of 10 — packet 060/003
...
`/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/060-sk-agent-improver-test-report-alignment/003-followup-research/research/iterations/iteration-010.md`
...
- **RQ-4** Which OTHER meta-agents in the system share @improve-agent's command-orchestrator pattern (discipline in command, not body)? Read each `.opencode/agent/*.md` and classify body-level vs command-level. Candidates: @write, @prompt-improver, @debug, @deep-research, @deep-review, @context, @orchestrate, @review.
...
7. For RQ-4: `.opencode/agent/{write,prompt-improver,debug,deep-research,deep-review,context,orchestrate,review,code}.md`
...
- `.opencode/specs/skilled-agent-orchestration/060-sk-agent-improver-test-report-alignment/003-followup-research/research/iterations/iteration-006.md` (read frontmatter + Findings sections)
- `.opencode/specs/skilled-agent-orchestration/060-sk-agent-improver-test-report-alignment/003-followup-research/research/iterations/iteration-007.md` (read frontmatter + Findings sections)
- `.opencode/specs/skilled-agent-orchestration/060-sk-agent-improver-test-report-alignment/003-followup-research/research/iterations/iteration-008.md` (read frontmatter + Findings sections)
- `.opencode/specs/skilled-agent-orchestration/060-sk-agent-improver-test-report-alignment/003-followup-research/research/iterations/iteration-009.md` (read frontmatter + Findings sections)
...
4. Write findings to `.opencode/specs/skilled-agent-orchestration/060-sk-agent-improver-test-report-alignment/003-followup-research/research/iterations/iteration-010.md` using the EXACT structure below
...
- Write only to `.opencode/specs/skilled-agent-orchestration/060-sk-agent-improver-test-report-alignment/003-followup-research/research/iterations/iteration-010.md` (the absolute-from-repo-root path)

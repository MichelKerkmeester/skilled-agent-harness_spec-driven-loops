...
The body-level class has enforcement in the agent body itself. `@write` owns template loading, skeleton copying, validation, DQI scoring, and delivery gates in its body [SOURCE: `.opencode/agent/write.md:22-65`]. `@prompt-improver` owns its five-step prompt escalation and structured output contract while denying write/edit/bash [SOURCE: `.opencode/agent/prompt-improver.md:22-40`, `.opencode/agent/prompt-improver.md:86-101`]. `@debug` owns the fresh-context debugging method and 5-phase observe/analyze/hypothesize/fix/report flow [SOURCE: `.opencode/agent/debug.md:22-30`, `.opencode/agent/debug.md:105-180`]. `@context` owns canonical continuity retrieval, codebase scan, and structured Context Package delivery without nested delegation [SOURCE: `.opencode/agent/context.md:25-55`]. `@review` owns read-only review, standards loading, scoring, and issue classification [SOURCE: `.opencode/agent/review.md:22-57`, `.opencode/agent/review.md:114-141`].

...
Create `063-improve-agent-command-flow-stress-tests`. Its job is to restructure CP-040 through CP-045 so Call B invokes `/improve:agent` through the command/YAML workflow, then re-run stress tests against the orchestrator-level flow.

...
- [x] T011 Run the full skill vitest suite and `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/144-operate-like-fable-5/008-fail-loud-provenance --strict`; sync spec/plan/tasks/checklist. Verify: green suite + clean validator.
<!-- /ANCHOR:phase-3 -->

...
description: "Plan for a 10-iteration parallel-by-model deep-research loop assessing how the vendored MIT ui-ux-pro-max repo can merge into and improve sk-interface-design. Research-only; the deliverable is a merge recommendation, not a skill change."
trigger_phrases:
  - "ui-ux-pro-max merge plan"
  - "sk-interface-design research plan"
...
### Overview
Run a read-only deep-research loop over the local `external/ui-ux-pro-max-skill-main/` repo and the `sk-interface-design` skill to determine what to ADOPT/ADAPT/SKIP, how to integrate it into the house skill, and the licensing path. Two parallel by-model lineages produce independent syntheses that are merged and cross-checked.
<!-- /ANCHOR:summary -->
...
|---------|--------------|--------|--------------|
| `.opencode/skills/sk-interface-design/` | Target skill under study | unchanged (read-only) | no diff in skill dir |

...
- [x] Author `sk-interface-design/references/claude_design_parity.md` (the shared protocol)
- [x] Hook `sk-interface-design` SKILL.md (Core References + resource-loading row) + graph-metadata key_files
...
- Shared protocol: `.opencode/skills/sk-interface-design/references/claude_design_parity.md`

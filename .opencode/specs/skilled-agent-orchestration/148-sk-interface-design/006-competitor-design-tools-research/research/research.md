...
<!-- ANCHOR:references -->
- **Dedup baseline:** `../005-claude-design-parity-research/research/research.md`. [SOURCE: file:.opencode/specs/skilled-agent-orchestration/148-sk-interface-design/005-claude-design-parity-research/research/research.md]

...
- `sk-interface-design` local target. [SOURCE: file:.opencode/skills/sk-interface-design/SKILL.md]
...
- Packet 006 spec. [SOURCE: file:.opencode/specs/skilled-agent-orchestration/148-sk-interface-design/006-competitor-design-tools-research/spec.md]
- Packet 005 baseline research. [SOURCE: file:.opencode/specs/skilled-agent-orchestration/148-sk-interface-design/005-claude-design-parity-research/research/research.md]

---
title: "Lineage Research: Competitor AI design-tool ideas for sk-interface-design and mcp-magicpath (gpt55fast)"
...
trigger_phrases:
  ...
  - "sk-interface-design mcp-magicpath competitor ideas"
...
| Local evidence | `sk-interface-design` SKILL.md, `mcp-magicpath` SKILL.md, packet 005 synthesis |
...
| Lovable | Three rendered design directions appear before full build for open-ended visual prompts; refinements are capped before submitting. [SOURCE: https://docs.lovable.dev/features/design-guidance.md] | ADAPT as anti-default direction gate for `sk-interface-design`; avoid presets. |
...
Packet 005 already recommended a shared protocol: design-context snapshot, iteration ledger, handoff manifest, MagicPath fidelity verification, and design-system inheritance. [SOURCE: file:.opencode/specs/skilled-agent-orchestration/148-sk-interface-design/005-claude-design-parity-research/research/research.md]
...
- Preserve `sk-interface-design` as a judgment skill, not a generator or preset picker. [SOURCE: file:.opencode/skills/sk-interface-design/SKILL.md]
...
| Rank | Idea | `sk-interface-design` verdict | `mcp-magicpath` verdict | Rationale |
| --- | --- | --- | --- | --- |
...
## 8. Recommendations for sk-interface-design
...
| P1 | ADOPT | Add design-system adherence scan after generated output when project/theme context exists: raw color, arbitrary spacing, inline style, unapproved component, token misuse. | Keep mechanical; design choices still route to `sk-interface-design`. |
...
| Preset palette/font/layout chooser | Conflicts with `sk-interface-design` anti-default mandate. | [SOURCE: https://docs.lovable.dev/features/design-guidance.md] [SOURCE: file:.opencode/skills/sk-interface-design/SKILL.md] | 2, 5 |
...
2. **Update `sk-interface-design` next**: direction gate and adherence checklist are small additions aligned with the existing two-pass process.
...
- Local sources: [SOURCE: file:.opencode/skills/sk-interface-design/SKILL.md] [SOURCE: file:.opencode/skills/mcp-magicpath/SKILL.md] [SOURCE: file:.opencode/specs/skilled-agent-orchestration/148-sk-interface-design/005-claude-design-parity-research/research/research.md]
...
- Direction gate for `sk-interface-design`, guarded against presets.

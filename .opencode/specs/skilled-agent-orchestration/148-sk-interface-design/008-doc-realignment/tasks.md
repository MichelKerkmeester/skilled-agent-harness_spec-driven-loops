...
- New reality: `.opencode/skills/sk-interface-design/references/claude_design_parity.md`
- Source build: `../007-claude-design-parity-build/`
- Skills: `.opencode/skills/sk-interface-design/`, `.opencode/skills/mcp-magicpath/`
<!-- /ANCHOR:cross-refs -->

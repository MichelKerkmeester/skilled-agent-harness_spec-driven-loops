...
description: "Task tracking for vendoring Anthropic's frontend-design skill into .opencode/skills/sk-interface-design and registering it."
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "Authored task list for sk-interface-design install"
...
- [x] T002 Confirm name + family with operator (sk-interface-design, sk-code family)
...
- [x] T005 Author lean house-template SKILL.md (`.opencode/skills/sk-interface-design/SKILL.md`)
...
- [x] Advisor routes design prompts to sk-interface-design (Gate 2)
<!-- /ANCHOR:completion -->

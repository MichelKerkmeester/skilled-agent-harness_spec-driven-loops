...
description: "Verification evidence for the sk-interface-design framework install. Verification Date: 2026-06-13"
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "Recorded verification evidence for sk-interface-design install"
    next_safe_action: "Run validate.sh --strict"
    blockers: []
    key_files:
      - ".opencode/skills/sk-interface-design/README.md"
    session_dedup:
...
- [x] CHK-021 [P0] Manual testing complete: advisor_recommend routes design prompt to sk-interface-design (conf 0.92)

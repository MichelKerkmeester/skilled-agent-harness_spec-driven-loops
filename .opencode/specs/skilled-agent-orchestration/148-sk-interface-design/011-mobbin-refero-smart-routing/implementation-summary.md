...
description: "Status: DONE. sk-interface-design now decides when to consult Mobbin/Refero via a hybrid initiative/ask/fall-back gate, with a Mobbin-vs-Refero source pick, surfaced in SKILL.md routing and RULES."
trigger_phrases:

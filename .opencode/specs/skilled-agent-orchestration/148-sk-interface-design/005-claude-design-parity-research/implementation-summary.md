...
description: "A 10-iteration parallel-by-model deep-research loop produced a cross-checked recommendation for improving sk-interface-design and mcp-magicpath toward Claude Design parity: a shared cross-skill protocol, not a clone, with fidelity verification as the keystone."
trigger_phrases:
  - "claude design parity summary"
  - "sk-interface-design mcp-magicpath research outcome"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | skilled-agent-orchestration/148-sk-interface-design/005-claude-design-parity-research |

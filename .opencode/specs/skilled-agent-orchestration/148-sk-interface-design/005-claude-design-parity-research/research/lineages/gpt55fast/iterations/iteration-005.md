...
4. The parent merge should compare whether sibling lineages also prioritize a shared parity protocol over separate, duplicated improvements in each skill. [SOURCE: file:.opencode/specs/skilled-agent-orchestration/148-sk-interface-design/005-claude-design-parity-research/spec.md:90]

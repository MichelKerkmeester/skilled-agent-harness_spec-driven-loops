...
- `.opencode/specs/skilled-agent-orchestration/148-sk-interface-design/005-claude-design-parity-research/spec.md` - packet scope, requirements, success criteria, and seeded context.

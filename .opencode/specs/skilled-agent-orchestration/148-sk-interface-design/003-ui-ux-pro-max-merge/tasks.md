...
description: "Task breakdown for the three-phase merge of ui-ux-pro-max data + search into sk-interface-design. Status planned; tasks grouped by implementation phase."
trigger_phrases:
  - "ui-ux-pro-max merge tasks"
  - "sk-interface-design data merge tasks"
...
- Target skill: `.opencode/skills/sk-interface-design/`
<!-- /ANCHOR:cross-refs -->

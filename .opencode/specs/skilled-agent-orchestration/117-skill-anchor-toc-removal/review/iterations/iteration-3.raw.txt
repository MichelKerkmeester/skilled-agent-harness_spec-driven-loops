...
.opencode/skills/deep-review/manual_testing_playbook/01--entry-points-and-modes/002-confirm-mode-checkpointed-review.md:73:| `.opencode/skills/deep-review/README.md` | User-facing examples, use `ANCHOR:quick-start` |
.opencode/skills/deep-review/manual_testing_playbook/01--entry-points-and-modes/002-confirm-mode-checkpointed-review.md:74:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Cheat-sheet command contract, use `ANCHOR:commands` |
.opencode/skills/deep-review/manual_testing_playbook/01--entry-points-and-modes/001-auto-mode-deep-review-kickoff.md:73:| `.opencode/skills/deep-review/README.md` | User-facing examples, use `ANCHOR:quick-start` and `ANCHOR:configuration` |
.opencode/skills/deep-review/manual_testing_playbook/01--entry-points-and-modes/001-auto-mode-deep-review-kickoff.md:74:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Cheat-sheet command contract, use `ANCHOR:commands` and `ANCHOR:state-files` |
.opencode/skills/deep-review/manual_testing_playbook/01--entry-points-and-modes/003-parameterized-invocation-max-iterations-convergence.md:73:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Parameter defaults table, use `ANCHOR:commands` |
.opencode/skills/deep-review/manual_testing_playbook/01--entry-points-and-modes/003-parameterized-invocation-max-iterations-convergence.md:77:| `.opencode/skills/deep-review/SKILL.md` | Skill-level parameter documentation, use `ANCHOR:how-it-works` |
.opencode/skills/deep-review/manual_testing_playbook/02--initialization-and-state-setup/005-resume-classification-from-valid-prior-review-state.md:75:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Resume behavior documentation, use `ANCHOR:troubleshooting` |
.opencode/skills/deep-review/manual_testing_playbook/02--initialization-and-state-setup/005-resume-classification-from-valid-prior-review-state.md:76:| `.opencode/skills/deep-review/SKILL.md` | Phase detection guidance, use `ANCHOR:smart-routing` |
.opencode/skills/deep-review/manual_testing_playbook/02--initialization-and-state-setup/007-scope-discovery-and-dimension-ordering.md:75:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Dimension table, use `ANCHOR:review-dimensions` |
...
.opencode/skills/deep-review/manual_testing_playbook/02--initialization-and-state-setup/006-invalid-or-contradictory-review-state-halts-for-repair.md:75:| `.opencode/skills/deep-review/SKILL.md` | Phase detection guidance, use `ANCHOR:smart-routing` |
.opencode/skills/deep-review/manual_testing_playbook/02--initialization-and-state-setup/004-fresh-review-initialization-creates-canonical-state-files.md:77:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | State files table, use `ANCHOR:state-files` |
.opencode/skills/deep-review/manual_testing_playbook/05--pause-resume-and-fault-tolerance/022-resume-after-pause-sentinel-removal.md:78:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Troubleshooting and state files, use `ANCHOR:state-files` and `ANCHOR:troubleshooting` |
.opencode/skills/deep-review/manual_testing_playbook/05--pause-resume-and-fault-tolerance/022-resume-after-pause-sentinel-removal.md:79:| `.opencode/skills/deep-review/SKILL.md` | Rules for state reading, use `ANCHOR:rules` Rule 1 |
.opencode/skills/deep-review/manual_testing_playbook/05--pause-resume-and-fault-tolerance/023-malformed-jsonl-lines-are-skipped-with-defaults.md:79:| `.opencode/skills/deep-review/SKILL.md` | Rules for state reading, use `ANCHOR:rules` Rule 1 |
.opencode/skills/deep-review/manual_testing_playbook/05--pause-resume-and-fault-tolerance/021-pause-sentinel-halts-between-review-iterations.md:77:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | State files showing pause sentinel location, use `ANCHOR:state-files` |
.opencode/skills/deep-review/manual_testing_playbook/05--pause-resume-and-fault-tolerance/021-pause-sentinel-halts-between-review-iterations.md:78:| `.opencode/skills/deep-review/SKILL.md` | Rule-level context, use `ANCHOR:rules` |
.opencode/skills/deep-review/manual_testing_playbook/05--pause-resume-and-fault-tolerance/024-jsonl-reconstruction-from-review-iteration-files.md:77:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | State file listing showing iterations/ directory, use `ANCHOR:state-files` |
.opencode/skills/deep-review/manual_testing_playbook/05--pause-resume-and-fault-tolerance/024-jsonl-reconstruction-from-review-iteration-files.md:78:| `.opencode/skills/deep-review/SKILL.md` | Rules for externalized state, use `ANCHOR:rules` Rule 3 |
...
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/030-stop-on-max-iterations.md:76:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | User-facing parameter defaults, use `ANCHOR:commands` and `ANCHOR:convergence` |
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/030-stop-on-max-iterations.md:77:| `.opencode/skills/deep-review/SKILL.md` | Skill rules and convergence documentation, use `ANCHOR:rules` |
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/018-review-quality-guards-block-premature-stop.md:78:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Quality guard summary, use `ANCHOR:quality-guards` |
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/018-review-quality-guards-block-premature-stop.md:79:| `.opencode/skills/deep-review/SKILL.md` | Quality guard rules, use `ANCHOR:rules` Rule 12 |
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/017-p0-override-blocks-convergence.md:76:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | P0 override note, use `ANCHOR:convergence` |
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/017-p0-override-blocks-convergence.md:77:| `.opencode/skills/deep-review/SKILL.md` | Severity classification and P0 blocking rules, use `ANCHOR:how-it-works` and `ANCHOR:rules` |
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/033-blocked-stop-reducer-surfacing.md:29:- Then: `deep-review-findings-registry.json` exposes `blockedStopHistory` entries that preserve the review gate names, `deep-review-dashboard.md` renders `BLOCKED STOPS`, and the `ANCHOR:next-focus` block in `deep-review-strategy.md` contains the blocked-stop recovery strategy.
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/033-blocked-stop-reducer-surfacing.md:55:4. `bash: sed -n '/ANCHOR:next-focus/,/\/ANCHOR:next-focus/p' {spec_folder}/review/deep-review-strategy.md`
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/033-blocked-stop-reducer-surfacing.md:58:`blockedStopHistory` contains reducer-promoted blocked-stop entries with the review gate names. `BLOCKED STOPS` renders each blocked-stop event. `ANCHOR:next-focus` includes the recovery strategy from the latest blocked-stop record.
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/033-blocked-stop-reducer-surfacing.md:83:| `.opencode/skills/deep-review/scripts/reduce-state.cjs` | Canonical reducer implementation, promotes `blocked_stop` into `blockedStopHistory`, renders `BLOCKED STOPS`, and rewrites `ANCHOR:next-focus` |
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/034-fail-closed-reducer.md:58:7. `bash: sed -n '/ANCHOR:next-focus/,/\/ANCHOR:next-focus/p' {anchor_fixture}/review/deep-review-strategy.md`
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/020-dimension-coverage-convergence-signal.md:76:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Convergence signal table, use `ANCHOR:convergence` and `ANCHOR:review-dimensions` |
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/020-dimension-coverage-convergence-signal.md:77:| `.opencode/skills/deep-review/SKILL.md` | Review dimensions and convergence rules, use `ANCHOR:how-it-works` and `ANCHOR:rules` |
...
.opencode/skills/deep-review/manual_testing_playbook/06--synthesis-save-and-guardrails/025-review-report-synthesis-has-all-9-sections.md:73:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Canonical 9-section table, use `ANCHOR:review-report-sections` |
.opencode/skills/deep-review/manual_testing_playbook/06--synthesis-save-and-guardrails/025-review-report-synthesis-has-all-9-sections.md:77:| `.opencode/skills/deep-review/SKILL.md` | Review report structure and verdict rules, use `ANCHOR:how-it-works` |
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/016-composite-review-convergence-stop-behavior.md:73:| `.opencode/skills/deep-review/references/convergence/convergence.md` | Canonical convergence math, use `ANCHOR:shouldcontinue-algorithm` and `ANCHOR:signal-definitions` |
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/016-composite-review-convergence-stop-behavior.md:76:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Convergence signal summary, use `ANCHOR:convergence` |
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/016-composite-review-convergence-stop-behavior.md:77:| `.opencode/skills/deep-review/SKILL.md` | Convergence and rules documentation, use `ANCHOR:rules` and `ANCHOR:how-it-works` |
.opencode/skills/deep-review/manual_testing_playbook/06--synthesis-save-and-guardrails/028-finding-deduplication-and-registry.md:73:| `.opencode/skills/deep-review/SKILL.md` | Deduplication rules, severity classification, and synthesis contract, use `ANCHOR:how-it-works` and `ANCHOR:rules` |
.opencode/skills/deep-review/manual_testing_playbook/06--synthesis-save-and-guardrails/028-finding-deduplication-and-registry.md:78:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Active Finding Registry section definition, use `ANCHOR:review-report-sections` |
...
.opencode/skills/deep-review/manual_testing_playbook/06--synthesis-save-and-guardrails/026-review-verdict-determines-post-review-workflow.md:73:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Canonical verdict table, use `ANCHOR:verdicts` |
.opencode/skills/deep-review/manual_testing_playbook/06--synthesis-save-and-guardrails/026-review-verdict-determines-post-review-workflow.md:77:| `.opencode/skills/deep-review/SKILL.md` | Verdict definitions and severity classification, use `ANCHOR:how-it-works` |
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/019-stuck-recovery-widens-dimension-focus.md:76:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Convergence parameters including stuckThreshold, use `ANCHOR:convergence` |
.opencode/skills/deep-review/manual_testing_playbook/04--convergence-and-recovery/019-stuck-recovery-widens-dimension-focus.md:77:| `.opencode/skills/deep-review/SKILL.md` | Rules for dimension focus and exhausted approaches, use `ANCHOR:rules` |
...
.opencode/skills/deep-review/manual_testing_playbook/06--synthesis-save-and-guardrails/027-final-synthesis-memory-save-and-guardrail-behavior.md:74:| `.opencode/skills/deep-review/SKILL.md` | Memory save rule (Rule 8), read-only rule (Rule 9), LEAF-only rule (NEVER 1), use `ANCHOR:rules` |
...
.opencode/skills/deep-review/manual_testing_playbook/03--iteration-execution-and-state-discipline/010-strategy-next-focus-and-dimension-rotation.md:75:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Convergence signals, use `ANCHOR:convergence` and `ANCHOR:review-dimensions` |
.opencode/skills/deep-review/manual_testing_playbook/03--iteration-execution-and-state-discipline/011-cross-reference-verification-detects-misalignment.md:75:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Quality guards, use `ANCHOR:quality-guards` and `ANCHOR:review-dimensions` |
.opencode/skills/deep-review/manual_testing_playbook/03--iteration-execution-and-state-discipline/009-review-iteration-writes-findings-jsonl-and-strategy-update.md:75:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Iteration checklist, use `ANCHOR:agent-iteration-checklist` |
...
.opencode/skills/deep-review/manual_testing_playbook/03--iteration-execution-and-state-discipline/008-review-iteration-reads-state-before-review.md:75:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Iteration checklist, use `ANCHOR:agent-iteration-checklist` |
...
.opencode/skills/deep-review/manual_testing_playbook/03--iteration-execution-and-state-discipline/013-review-dashboard-generation-after-iteration.md:76:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | State files table, use `ANCHOR:state-files` |
.opencode/skills/deep-review/manual_testing_playbook/03--iteration-execution-and-state-discipline/014-severity-classification-in-jsonl.md:73:| `.opencode/skills/deep-review/SKILL.md` | Rule 11: severity counts mandate, use `ANCHOR:rules` |
.opencode/skills/deep-review/manual_testing_playbook/03--iteration-execution-and-state-discipline/014-severity-classification-in-jsonl.md:76:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Convergence signals, use `ANCHOR:convergence` |
.opencode/skills/deep-review/manual_testing_playbook/03--iteration-execution-and-state-discipline/012-adversarial-self-check-runs-on-p0-findings.md:73:| `.opencode/skills/deep-review/SKILL.md` | Rule 10: adversarial self-check mandate, use `ANCHOR:rules` |
.opencode/skills/deep-review/manual_testing_playbook/03--iteration-execution-and-state-discipline/012-adversarial-self-check-runs-on-p0-findings.md:74:| `.opencode/skills/deep-review/references/protocol/quick_reference.md` | Iteration checklist, use `ANCHOR:agent-iteration-checklist` |
...
.opencode/skills/deep-research/manual_testing_playbook/01--entry-points-and-modes/002-confirm-mode-checkpointed-execution.md:75:| `.opencode/skills/deep-research/README.md` | User-facing execution modes; use `ANCHOR:features` |
...
.opencode/skills/deep-research/manual_testing_playbook/01--entry-points-and-modes/001-auto-mode-deep-research-kickoff.md:73:| `.opencode/skills/deep-research/README.md` | User-facing examples; use `ANCHOR:quick-start` and `ANCHOR:configuration` |
.opencode/skills/deep-research/manual_testing_playbook/01--entry-points-and-modes/001-auto-mode-deep-research-kickoff.md:74:| `.opencode/skills/deep-research/references/guides/quick_reference.md` | Cheat-sheet command contract; use `ANCHOR:commands` and `ANCHOR:state-files` |
.opencode/skills/deep-research/manual_testing_playbook/01--entry-points-and-modes/003-parameterized-invocation-max-iterations-convergence.md:76:| `.opencode/skills/deep-research/references/state/state_format.md` | Config schema; use `ANCHOR:config-file` |
...
.opencode/skills/deep-research/manual_testing_playbook/02--initialization-and-state-setup/027-research-charter-validation.md:48:2. `bash: sed -n '/ANCHOR:non-goals/,/\/ANCHOR:stop-conditions/p' .opencode/skills/deep-research/assets/deep_research_strategy.md`
.opencode/skills/deep-research/manual_testing_playbook/02--initialization-and-state-setup/027-research-charter-validation.md:73:| `.opencode/skills/deep-research/references/protocol/loop_protocol.md` | Loop protocol; inspect Step 5a (Validate Research Charter) under `ANCHOR:phase-initialization` |
.opencode/skills/deep-research/manual_testing_playbook/02--initialization-and-state-setup/027-research-charter-validation.md:74:| `.opencode/skills/deep-research/assets/deep_research_strategy.md` | Strategy template; inspect `ANCHOR:non-goals` (section 4) and `ANCHOR:stop-conditions` (section 5) |
...
.opencode/skills/deep-research/manual_testing_playbook/02--initialization-and-state-setup/006-invalid-or-contradictory-state-halts-for-repair.md:73:| `.opencode/skills/deep-research/references/protocol/loop_protocol.md` | Invalid-state contract; use `ANCHOR:phase-initialization` |
.opencode/skills/deep-research/manual_testing_playbook/02--initialization-and-state-setup/006-invalid-or-contradictory-state-halts-for-repair.md:74:| `.opencode/skills/deep-research/SKILL.md` | Rule-level guardrails; use `ANCHOR:rules` |
.opencode/skills/deep-research/manual_testing_playbook/02--initialization-and-state-setup/006-invalid-or-contradictory-state-halts-for-repair.md:77:| `.opencode/skills/deep-research/README.md` | Troubleshooting boundary; use `ANCHOR:troubleshooting` |
...
.opencode/skills/deep-research/manual_testing_playbook/02--initialization-and-state-setup/004-fresh-initialization-creates-canonical-state-files.md:73:| `.opencode/skills/deep-research/references/protocol/loop_protocol.md` | Initialization lifecycle; use `ANCHOR:phase-initialization` |
...
.opencode/skills/deep-research/manual_testing_playbook/02--initialization-and-state-setup/005-resume-classification-from-valid-prior-state.md:73:| `.opencode/skills/deep-research/references/protocol/loop_protocol.md` | Resume contract; use `ANCHOR:phase-initialization` and `Auto-Resume Protocol` |
.opencode/skills/deep-research/manual_testing_playbook/02--initialization-and-state-setup/005-resume-classification-from-valid-prior-state.md:76:| `.opencode/skills/deep-research/README.md` | User-facing auto-resume claim; use `ANCHOR:features` and `ANCHOR:faq` |
.opencode/skills/sk-doc/references/global/quick_reference.md:18:# Checks: TOC, H2 format, anchors, required sections
.opencode/skills/deep-research/manual_testing_playbook/05--pause-resume-and-fault-tolerance/017-malformed-jsonl-lines-are-skipped-with-defaults.md:73:| `.opencode/skills/deep-research/references/state/state_format.md` | Fault tolerance and event schema; use `ANCHOR:state-log` |
.opencode/skills/deep-research/manual_testing_playbook/05--pause-resume-and-fault-tolerance/017-malformed-jsonl-lines-are-skipped-with-defaults.md:74:| `.opencode/skills/deep-research/references/convergence/convergence.md` | Defensive JSONL reading; use `ANCHOR:signal-definitions` |
.opencode/skills/deep-research/manual_testing_playbook/05--pause-resume-and-fault-tolerance/017-malformed-jsonl-lines-are-skipped-with-defaults.md:75:| `.opencode/skills/deep-research/README.md` | Troubleshooting language; use `ANCHOR:troubleshooting` |
.opencode/skills/deep-research/manual_testing_playbook/05--pause-resume-and-fault-tolerance/018-jsonl-reconstruction-from-iteration-files.md:73:| `.opencode/skills/deep-research/references/state/state_format.md` | Reconstruction algorithm and event schema; use `ANCHOR:state-log` |
.opencode/skills/deep-research/manual_testing_playbook/05--pause-resume-and-fault-tolerance/018-jsonl-reconstruction-from-iteration-files.md:75:| `.opencode/skills/deep-research/README.md` | Troubleshooting and FAQ recovery language; use `ANCHOR:troubleshooting` and `ANCHOR:faq` |
.opencode/skills/deep-research/manual_testing_playbook/05--pause-resume-and-fault-tolerance/018-jsonl-reconstruction-from-iteration-files.md:76:| `.opencode/skills/deep-research/references/convergence/convergence.md` | Valid-entry behavior during convergence; use `ANCHOR:signal-definitions` |
...
.opencode/skills/deep-research/manual_testing_playbook/05--pause-resume-and-fault-tolerance/015-pause-sentinel-halts-between-iterations.md:73:| `.opencode/skills/deep-research/references/protocol/loop_protocol.md` | Pause sentinel contract; use `ANCHOR:phase-iteration-loop` |
.opencode/skills/deep-research/manual_testing_playbook/05--pause-resume-and-fault-tolerance/015-pause-sentinel-halts-between-iterations.md:76:| `.opencode/skills/deep-research/README.md` | User-facing pause FAQ; use `ANCHOR:faq` |
.opencode/skills/deep-research/manual_testing_playbook/05--pause-resume-and-fault-tolerance/015-pause-sentinel-halts-between-iterations.md:77:| `.opencode/skills/deep-research/SKILL.md` | Rule-level context; use `ANCHOR:rules` |
...
.opencode/skills/deep-research/manual_testing_playbook/05--pause-resume-and-fault-tolerance/016-resume-after-pause-sentinel-removal.md:73:| `.opencode/skills/deep-research/references/protocol/loop_protocol.md` | Pause-resume flow; use `ANCHOR:phase-iteration-loop` and `ANCHOR:phase-initialization` |
.opencode/skills/deep-research/manual_testing_playbook/05--pause-resume-and-fault-tolerance/016-resume-after-pause-sentinel-removal.md:74:| `.opencode/skills/deep-research/references/state/state_format.md` | Resumed event schema; use `ANCHOR:state-log` |
.opencode/skills/deep-research/manual_testing_playbook/05--pause-resume-and-fault-tolerance/016-resume-after-pause-sentinel-removal.md:77:| `.opencode/skills/deep-research/README.md` | User-facing pause and resume language; use `ANCHOR:faq` |
...
.opencode/skills/deep-research/manual_testing_playbook/04--convergence-and-recovery/012-stop-when-all-key-questions-are-answered.md:73:| `.opencode/skills/deep-research/references/convergence/convergence.md` | Question-coverage hard stop; use `ANCHOR:shouldcontinue-algorithm` and `ANCHOR:signal-definitions` |
.opencode/skills/deep-research/manual_testing_playbook/04--convergence-and-recovery/012-stop-when-all-key-questions-are-answered.md:76:| `.opencode/skills/deep-research/README.md` | Question-coverage framing; use `ANCHOR:usage-examples` |
.opencode/skills/deep-research/manual_testing_playbook/04--convergence-and-recovery/012-stop-when-all-key-questions-are-answered.md:77:| `.opencode/skills/deep-research/references/guides/quick_reference.md` | Coverage visualization; use `ANCHOR:progress-visualization` |
...
.opencode/skills/deep-research/manual_testing_playbook/04--convergence-and-recovery/032-blocked-stop-reducer-surfacing.md:55:4. `bash: sed -n '/ANCHOR:next-focus/,/\/ANCHOR:next-focus/p' {spec_folder}/research/deep-research-strategy.md`
.opencode/skills/deep-research/manual_testing_playbook/04--convergence-and-recovery/032-blocked-stop-reducer-surfacing.md:58:`blockedStopHistory` contains reducer-promoted blocked-stop entries; `BLOCKED STOPS` renders each blocked-stop event; `ANCHOR:next-focus` includes the recovery strategy from the latest blocked-stop record.
.opencode/skills/deep-research/manual_testing_playbook/04--convergence-and-recovery/032-blocked-stop-reducer-surfacing.md:83:| `.opencode/skills/deep-research/scripts/reduce-state.cjs` | Canonical reducer implementation; promotes `blocked_stop` into `blockedStopHistory`, renders `BLOCKED STOPS`, and rewrites `ANCHOR:next-focus` |
...
.opencode/skills/deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/026-ruled-out-directions-in-synthesis.md:49:3. `bash: sed -n '/ANCHOR:ruled-out-directions/,/\/ANCHOR:ruled-out-directions/p' .opencode/skills/deep-research/assets/deep_research_strategy.md`
.opencode/skills/deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/026-ruled-out-directions-in-synthesis.md:74:| `.opencode/skills/deep-research/references/protocol/loop_protocol.md` | Loop protocol; inspect `ANCHOR:phase-synthesis` for the Eliminated Alternatives consolidation rules (synthesis Step 3) |
.opencode/skills/deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/026-ruled-out-directions-in-synthesis.md:75:| `.opencode/skills/deep-research/references/state/state_format.md` | State format; inspect `ruledOut` array under `ANCHOR:state-log` (Negative Knowledge subsection) and iteration file requirements under `ANCHOR:iteration-files` |
.opencode/skills/deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/026-ruled-out-directions-in-synthesis.md:76:| `.opencode/skills/deep-research/assets/deep_research_strategy.md` | Strategy template; inspect `ANCHOR:ruled-out-directions` for section 10 (Ruled Out Directions) |
.opencode/skills/deep-research/manual_testing_playbook/04--convergence-and-recovery/011-stop-on-max-iterations.md:73:| `.opencode/skills/deep-research/references/convergence/convergence.md` | Hard-stop ordering; use `ANCHOR:shouldcontinue-algorithm` |
.opencode/skills/deep-research/manual_testing_playbook/04--convergence-and-recovery/011-stop-on-max-iterations.md:74:| `.opencode/skills/deep-research/references/protocol/loop_protocol.md` | Loop decision order; use `ANCHOR:phase-iteration-loop` |
.opencode/skills/deep-research/manual_testing_playbook/04--convergence-and-recovery/011-stop-on-max-iterations.md:77:| `.opencode/skills/deep-research/README.md` | Parameter table and examples; use `ANCHOR:configuration` and `ANCHOR:usage-examples` |
.opencode/skills/deep-research/manual_testing_playbook/04--convergence-and-recovery/011-stop-on-max-iterations.md:78:| `.opencode/skills/deep-research/references/guides/quick_reference.md` | Parameter defaults; use `ANCHOR:commands` |
...
.opencode/skills/deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/019-final-synthesis-memory-save-and-guardrail-behavior.md:74:| `.opencode/skills/deep-research/SKILL.md` | Supported save path and reference-only features; use `ANCHOR:rules` |
.opencode/skills/deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/019-final-synthesis-memory-save-and-guardrail-behavior.md:75:| `.opencode/skills/deep-research/README.md` | User-facing reference-only notes and FAQ; use `ANCHOR:overview`, `ANCHOR:faq`, and `ANCHOR:related-documents` |
.opencode/skills/deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/019-final-synthesis-memory-save-and-guardrail-behavior.md:77:| `.opencode/skills/deep-research/references/protocol/loop_protocol.md` | Reference-only wave, checkpoint, and direct-mode sections; use `ANCHOR:phase-iteration-loop` and `ANCHOR:wave-orchestration-protocol` |
.opencode/skills/deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/019-final-synthesis-memory-save-and-guardrail-behavior.md:78:| `.opencode/skills/deep-research/references/state/state_format.md` | Reference-only segment model and active events; use `ANCHOR:state-log` |
.opencode/skills/deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/019-final-synthesis-memory-save-and-guardrail-behavior.md:81:| `.opencode/skills/deep-research/references/guides/quick_reference.md` | Reference-only notes; use `Reference-Only Notes` under `ANCHOR:state-files` |
...
.opencode/skills/deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/009-strategy-next-focus-and-exhausted-approach-discipline.md:73:| `.opencode/skills/deep-research/references/state/state_format.md` | Strategy file requirements; use `ANCHOR:strategy-file` |
.opencode/skills/deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/009-strategy-next-focus-and-exhausted-approach-discipline.md:74:| `.opencode/skills/deep-research/references/protocol/loop_protocol.md` | Ideas backlog and recovery focus; use `ANCHOR:phase-iteration-loop` |
.opencode/skills/deep-research/manual_testing_playbook/04--convergence-and-recovery/014-stuck-recovery-widens-focus-and-continues.md:73:| `.opencode/skills/deep-research/references/convergence/convergence.md` | Stuck recovery protocol; use `ANCHOR:stuck-recovery-protocol` |
.opencode/skills/deep-research/manual_testing_playbook/04--convergence-and-recovery/014-stuck-recovery-widens-focus-and-continues.md:74:| `.opencode/skills/deep-research/references/protocol/loop_protocol.md` | Ideas backlog and stuck recovery; use `ANCHOR:phase-iteration-loop` |
.opencode/skills/deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/024-dashboard-generation-after-iteration.md:48:2. `bash: sed -n '/ANCHOR:dashboard/,/\/ANCHOR:dashboard/p' .opencode/skills/deep-research/references/state/state_format.md`
.opencode/skills/deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/024-dashboard-generation-after-iteration.md:75:| `.opencode/skills/deep-research/references/protocol/loop_protocol.md` | Loop protocol; inspect Step 4a (Generate Dashboard) under `ANCHOR:phase-iteration-loop` |
.opencode/skills/deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/024-dashboard-generation-after-iteration.md:76:| `.opencode/skills/deep-research/references/state/state_format.md` | State format; inspect `ANCHOR:dashboard` for content sections, lifecycle, and file protection rules |
...
.opencode/skills/deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/025-novelty-justification-in-jsonl.md:73:| `.opencode/skills/deep-research/references/state/state_format.md` | State format; inspect `Novelty Justification` subsection under `ANCHOR:state-log` for field definition and example |
.opencode/skills/deep-research/manual_testing_playbook/04--convergence-and-recovery/013-composite-convergence-stop-behavior.md:73:| `.opencode/skills/deep-research/references/convergence/convergence.md` | Canonical convergence math; use `ANCHOR:shouldcontinue-algorithm` and `ANCHOR:signal-definitions` |
.opencode/skills/deep-research/manual_testing_playbook/04--convergence-and-recovery/013-composite-convergence-stop-behavior.md:76:| `.opencode/skills/deep-research/README.md` | Feature summary for convergence; use `ANCHOR:features` |
.opencode/skills/deep-research/manual_testing_playbook/04--convergence-and-recovery/013-composite-convergence-stop-behavior.md:77:| `.opencode/skills/deep-research/references/guides/quick_reference.md` | Progress visualization and decision tree; use `ANCHOR:convergence-decision-tree` and `ANCHOR:progress-visualization` |
...
.opencode/skills/deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/008-iteration-writes-iteration-jsonl-and-strategy-update.md:73:| `.opencode/skills/deep-research/references/protocol/loop_protocol.md` | Evaluation and write-back checks; use `ANCHOR:phase-iteration-loop` |
.opencode/skills/deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/008-iteration-writes-iteration-jsonl-and-strategy-update.md:74:| `.opencode/skills/deep-research/references/state/state_format.md` | Schema expectations for JSONL and strategy; use `ANCHOR:state-log` and `ANCHOR:strategy-file` |
...
.opencode/skills/deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/010-progressive-synthesis-behavior-for-research-md.md:73:| `.opencode/skills/deep-research/README.md` | Progressive synthesis defaults and state-file table; use `ANCHOR:overview` and `ANCHOR:configuration` |
.opencode/skills/deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/010-progressive-synthesis-behavior-for-research-md.md:74:| `.opencode/skills/deep-research/references/state/state_format.md` | Canonical ownership wording; use `ANCHOR:overview` and `ANCHOR:config-file` |
.opencode/skills/deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/010-progressive-synthesis-behavior-for-research-md.md:75:| `.opencode/skills/deep-research/SKILL.md` | Rule-level ownership statement; use `ANCHOR:rules` |
...
.opencode/skills/deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/007-iteration-reads-state-before-research.md:73:| `.opencode/skills/deep-research/references/protocol/loop_protocol.md` | Iteration loop order; use `ANCHOR:phase-iteration-loop` |
.opencode/skills/deep-research/manual_testing_playbook/03--iteration-execution-and-state-discipline/007-iteration-reads-state-before-research.md:76:| `.opencode/skills/deep-research/references/guides/quick_reference.md` | Iteration checklist; use `ANCHOR:agent-iteration-checklist` |

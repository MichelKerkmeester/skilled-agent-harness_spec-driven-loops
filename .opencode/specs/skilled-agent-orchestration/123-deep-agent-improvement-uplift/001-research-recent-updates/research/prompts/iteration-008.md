...
`.opencode/specs/skilled-agent-orchestration/123-deep-agent-improvement-uplift/001-research-recent-updates/research/iterations/iteration-008.md` + `.../deltas/iter-008.jsonl`.

...
- [ ] T010 Run `node --test` and `node --experimental-test-module-mocks --test`, confirm no `shared/`/`mcp_server/` edits, and refresh spec/plan/tasks/checklist evidence (`.opencode/specs/skilled-agent-orchestration/133-spec-gate-enforce-readiness/002-trigger-turn-self-binding/`)
<!-- /ANCHOR:phase-3 -->

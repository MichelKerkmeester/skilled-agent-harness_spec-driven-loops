...
- [ ] T012 Re-run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/133-spec-gate-enforce-readiness/001-advise-telemetry --strict`
<!-- /ANCHOR:phase-3 -->

...
| **Storage** | `.opencode/specs/skilled-agent-orchestration/156-deep-loop-skill-system-review/review/` |
...
| Structural | This packet | `validate.sh --strict` on `156-deep-loop-skill-system-review` |

...
- Prior-art summary of `.opencode/specs/skilled-agent-orchestration/121-sk-prompt-models-rename/` focused on task shape, referrer handling, and lessons for the fold-in.
...
- Review `.opencode/specs/skilled-agent-orchestration/121-sk-prompt-models-rename/` as prior art for task shape, path referrers, and rename lessons.
...
|-----------|-------------|-------------|
| `.opencode/specs/skilled-agent-orchestration/124-sk-prompt-parent/001-research-and-context/spec.md` | Modify | Define the phase 001 read-only research scope and acceptance criteria |
| `.opencode/specs/skilled-agent-orchestration/124-sk-prompt-parent/001-research-and-context/plan.md` | Modify | Plan the two research passes, prior-art review, and verification path |
| `.opencode/specs/skilled-agent-orchestration/124-sk-prompt-parent/001-research-and-context/tasks.md` | Modify | Track the scoped research-gate tasks pending human review |
<!-- /ANCHOR:scope -->
...
- **SC-002**: Zero files outside `.opencode/specs/skilled-agent-orchestration/124-sk-prompt-parent/001-research-and-context/` are touched during this phase.
<!-- /ANCHOR:success-criteria -->

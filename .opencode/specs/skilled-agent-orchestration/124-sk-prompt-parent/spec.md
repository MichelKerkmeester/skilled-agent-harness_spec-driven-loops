...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/124-sk-prompt-parent"
    ...
    session_dedup:
      ...
      session_id: "124-sk-prompt-parent-complete"
...
| **Branch** | `main` |
| **Parent Spec** | `../spec.md` |
| **Parent Packet** | skilled-agent-orchestration/124-sk-prompt-parent |
| **Predecessor** | skilled-agent-orchestration/121-sk-prompt-models-rename (renamed sk-prompt-models to its current name; this program folds the renamed skill into the sk-prompt hub) |

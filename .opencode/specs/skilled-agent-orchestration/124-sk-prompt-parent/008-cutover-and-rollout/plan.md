...
- **Recursive spec validation**: Confirms the full `.opencode/specs/skilled-agent-orchestration/124-sk-prompt-parent` packet, including phase children, satisfies strict Spec Kit validation.
...
| `.opencode/specs/skilled-agent-orchestration/124-sk-prompt-parent` | Parent packet and phase docs | Validate recursively, then roll up parent metadata after clean evidence | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/124-sk-prompt-parent --recursive --strict` |
...
- [x] Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/124-sk-prompt-parent --recursive --strict` and stop on any error.

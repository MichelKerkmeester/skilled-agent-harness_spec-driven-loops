...
- **Scope**: the completed 124-sk-prompt-parent merge (parent + 8 phase specs), the merged `sk-prompt` hub + both packets, the post-merge benchmark artifacts, and the touched command/agent referrers — 73 scope files.

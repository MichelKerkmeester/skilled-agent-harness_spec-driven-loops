...
- `.opencode/skills/sk-prompt/prompt-improve/manual_testing_playbook/03--depth-clear-loop/depth-five-phases-order.md:45-50`
- `.opencode/skills/sk-prompt/prompt-improve/manual_testing_playbook/02--smart-routing/intent-model-keyword-scoring.md:46-69`
- `.opencode/skills/sk-prompt/prompt-improve/manual_testing_playbook/07--format-modes/format-guide-on-demand.md:45-50`
- `.opencode/skills/sk-prompt/prompt-improve/manual_testing_playbook/04--clear-scoring/clear-five-dimensions.md:45-50`

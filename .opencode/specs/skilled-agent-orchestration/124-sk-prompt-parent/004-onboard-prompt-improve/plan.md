...
| Spec | Phase documentation remains Level 1 compliant | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/124-sk-prompt-parent/004-onboard-prompt-improve --strict` |
<!-- /ANCHOR:testing -->

...
Update workflow YAML references in `.opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml`, `.opencode/commands/spec_kit/assets/spec_kit_deep-review_confirm.yaml`, `.opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml`, and `.opencode/commands/spec_kit/assets/spec_kit_deep-research_confirm.yaml` from `system-spec-kit/mcp_server/lib/deep-loop/*` to `deep-loop-runtime/mcp_server/lib/deep-loop/*`. Move vitest coverage from `.opencode/skills/system-spec-kit/mcp_server/tests/deep-loop/` to `.opencode/skills/deep-loop-runtime/mcp_server/tests/deep-loop/`, and update parity or integration tests under `system-spec-kit/scripts/tests/` to import the runtime as an external deep-loop dependency rather than treating spec-kit as the owner.

...
- [x] T001 Create Level 2 packet (`specs/skilled-agent-orchestration/071-stack-agnostic-cleanup/`)
- [x] T002 Draft spec, plan, tasks, checklist, and ADR (`specs/skilled-agent-orchestration/071-stack-agnostic-cleanup/`)
- [x] T003 Save initial scoped grep inventory (`specs/skilled-agent-orchestration/071-stack-agnostic-cleanup/scratch/initial-inventory.md`)
<!-- /ANCHOR:phase-1 -->

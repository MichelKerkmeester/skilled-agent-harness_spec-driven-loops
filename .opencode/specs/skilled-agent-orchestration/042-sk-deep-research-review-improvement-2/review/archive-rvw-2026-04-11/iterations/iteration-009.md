...
| reducer_dashboard | fail | hard | `.opencode/skills/sk-deep-review/scripts/reduce-state.cjs:832` | Reducer risk summarization collapses all non-P0 open findings into a no-risk message. |

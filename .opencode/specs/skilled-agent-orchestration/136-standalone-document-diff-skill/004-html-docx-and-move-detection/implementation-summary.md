...
| Check | Result |
|-------|--------|
| Phase scaffold validation | PASS: bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/136-standalone-document-diff-skill/004-html-docx-and-move-detection --strict completed with 0 errors and 0 warnings |

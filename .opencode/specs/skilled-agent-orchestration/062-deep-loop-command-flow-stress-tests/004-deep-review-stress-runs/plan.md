...
Direct adaptation of `060/004` (improve-agent stress) for `/spec_kit:deep-review`. Re-read 060/004's plan.md as the methodology source.
...
`@deep-review` is dispatched ONLY by `/spec_kit:deep-review`. The command owns iteration state, convergence, journal, gates, stop reasons. Body is a thin LEAF.

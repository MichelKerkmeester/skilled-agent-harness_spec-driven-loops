 ...
 *
 * Reads 116/state/eval-loop-state-v2.jsonl, computes v2 ranking, compares
 * against 114/003 v1 synthesis, writes 116/synthesis-v2.md with verdict.
 */
...
function writeSynthesis() {
  ...
  lines.push('');
  if (sameWinner) {
    lines.push(`**Ranking stable** — ${v2Winner.variantId} wins under both text-only (v1) and full-D1 (v2) scoring regimes. The 114/004 RCAF default is confirmed. **No v1.0.6.0 uplift needed.**`);

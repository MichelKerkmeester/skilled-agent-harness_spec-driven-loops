...
- [ ] T001 Verify 114/002 rig dry-run green
- [ ] T002 Verify claude CLI auth (`claude --version`) + devin CLI auth (`devin auth status`)
- [ ] T003 Create 116 directory tree (scripts/, state/, iterations/)
<!-- /ANCHOR:phase-1 -->
...
- [ ] T012 Modify `../114-cli-devin-swe16-prompt-optimization/002-eval-rig/scripts/score-variant.cjs` to call extraction when `EVAL_LOOP_EXTRACT=true`; add seed snapshot/restore between variants
- [ ] T013 Build `scripts/loop-v2.cjs` wrapper that sets env vars + invokes 114/003 loop with output dir redirected to 116/state
...
- [ ] T025 strict-validate 116 packet
- [ ] T026 Commit + push
<!-- /ANCHOR:phase-3 -->
...
- **Plan**: See `plan.md`
- **Upstream**: 114/002 rig, 114/003 loop, 114/003 synthesis.md (v1 baseline)
<!-- /ANCHOR:cross-refs -->

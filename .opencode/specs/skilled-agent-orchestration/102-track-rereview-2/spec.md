...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/102-track-rereview-2"
...
|-----------|-------------|-------------|
| `.opencode/specs/skilled-agent-orchestration/102-track-rereview-2/review/` | Create | Skill-owned review packet with state files |
| `.opencode/specs/skilled-agent-orchestration/102-track-rereview-2/review/review-report.md` | Create | Synthesis output: 9 sections + Planning Packet |
| `.opencode/specs/skilled-agent-orchestration/102-track-rereview-2/review/resource-map.md` | Create | Resource map of touched files across 100 + 101 |
| `.opencode/specs/skilled-agent-orchestration/102-track-rereview-2/implementation-summary.md` | Create | Continuity update post-synthesis |
<!-- /ANCHOR:scope -->

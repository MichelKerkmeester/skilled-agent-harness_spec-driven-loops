  ...
  "remediationWorkstreams": [
    ...
    },
    {
      ...
      "affectedSurfaces": [
        ...
        ".opencode/specs/skilled-agent-orchestration/101-cli-opencode-executor/spec.md",
        ".opencode/specs/skilled-agent-orchestration/102-track-rereview-2/review/deep-review-strategy.md"
      ]
    },
    {
    ...
    },
    {
      ...
      "affectedSurfaces": [
        ".opencode/specs/skilled-agent-orchestration/102-track-rereview-2/review/deep-review-strategy.md",
        ".opencode/specs/skilled-agent-orchestration/101-cli-opencode-executor/implementation-summary.md"
      ]
    }
  ],
  "specSeed": [
...
| P2-032 | P2 | Strategy doc surface inventory drift — claims `aliases.ts` touched by 101 but 101 implementation-summary lists only 5 surfaces | traceability | `.opencode/specs/skilled-agent-orchestration/102-track-rereview-2/review/deep-review-strategy.md` | active |
...
- `.opencode/specs/skilled-agent-orchestration/099-track-rereview/review/review-report.md` (predecessor verdict baseline)
- `.opencode/specs/skilled-agent-orchestration/100-099-remediation/spec.md`, `plan.md`, `tasks.md`, `checklist.md`, `implementation-summary.md`, `graph-metadata.json`
- `.opencode/specs/skilled-agent-orchestration/101-cli-opencode-executor/spec.md`, `implementation-summary.md`, `graph-metadata.json`
- `.opencode/specs/skilled-agent-orchestration/102-track-rereview-2/spec.md`, `plan.md`, `tasks.md`, `checklist.md`, `implementation-summary.md`, `graph-metadata.json` (self-validation)

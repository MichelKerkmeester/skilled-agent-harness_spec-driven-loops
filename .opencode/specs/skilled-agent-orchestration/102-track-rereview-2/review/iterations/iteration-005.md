...
- `.opencode/specs/skilled-agent-orchestration/101-cli-opencode-executor/implementation-summary.md` (lines 28-92)
...
2. **Strategy doc + iter-1 narrative claim cli-opencode "advisor alias" was added — narrative drift versus actual implementation surface** — `.opencode/specs/skilled-agent-orchestration/102-track-rereview-2/review/deep-review-strategy.md:33`

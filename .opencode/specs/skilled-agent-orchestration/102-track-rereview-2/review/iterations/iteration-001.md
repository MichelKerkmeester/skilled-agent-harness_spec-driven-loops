...
- `.opencode/specs/skilled-agent-orchestration/099-track-rereview/review/review-report.md:132-167` — 099's active P1+P2 finding registry
- `.opencode/specs/skilled-agent-orchestration/100-099-remediation/implementation-summary.md:38-238` — 100's resolution claims
- `.opencode/specs/skilled-agent-orchestration/100-099-remediation/implementation-summary.md:172-204` — 100's verification table
...
- `.opencode/specs/skilled-agent-orchestration/098-097-remediation/005-checklist-evidence/implementation-summary.md` — P1-023 continuity blockers backfill
- `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/004-symlinks/spec.md` — P1-022 anchor repair (validated via strict-validate)

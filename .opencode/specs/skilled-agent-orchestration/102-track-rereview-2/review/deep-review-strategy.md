...
- `.opencode/specs/skilled-agent-orchestration/099-track-rereview/review/review-report.md` (predecessor verdict)
- `.opencode/specs/skilled-agent-orchestration/100-099-remediation/` (NEW — phase parent + sub-phases)
- `.opencode/specs/skilled-agent-orchestration/101-cli-opencode-executor/` (NEW — executor wiring)

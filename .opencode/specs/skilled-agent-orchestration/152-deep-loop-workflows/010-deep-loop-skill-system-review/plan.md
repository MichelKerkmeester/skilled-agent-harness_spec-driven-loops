...
| **Storage** | `.opencode/specs/skilled-agent-orchestration/152-deep-loop-workflows/010-deep-loop-skill-system-review/review/` |
...
|------------|------|--------|-------------------|
| `../../152-deep-loop-workflows` | Reviewed packet | Shipped | No 152 surface to review |
| `../../153-mcp-skill-install-doctor-standardization` | Reviewed packet | Shipped | No 153 surface to review |
| `../../155-parent-nested-skill-pattern` | Reviewed packet | Shipped | No 155 surface to review |

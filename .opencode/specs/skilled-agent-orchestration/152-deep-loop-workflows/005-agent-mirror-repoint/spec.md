...
| **Phase** | 005 of 009 (parent: `152-deep-loop-workflows`) |
| **Depends on** | 004 |
<!-- /ANCHOR:metadata -->
...
> **Scaffold note.** This child is a scoped scaffold derived from `../research/research.md`. Its `plan.md`, `tasks.md`, and `checklist.md` are authored when the phase is picked up via `/speckit:plan skilled-agent-orchestration/152-deep-loop-workflows/005-agent-mirror-repoint`.
<!-- /ANCHOR:problem -->

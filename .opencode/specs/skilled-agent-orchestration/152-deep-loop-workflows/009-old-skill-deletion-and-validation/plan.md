...
- [ ] T12 Record final evidence and run strict spec validation. (`.opencode/specs/skilled-agent-orchestration/152-deep-loop-workflows/009-old-skill-deletion-and-validation/checklist.md`, `.opencode/specs/skilled-agent-orchestration/152-deep-loop-workflows/009-old-skill-deletion-and-validation/implementation-summary.md`, `.opencode/specs/skilled-agent-orchestration/152-deep-loop-workflows/spec.md`) — _verify:_ bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/152-deep-loop-workflows/009-old-skill-deletion-and-validation --strict and parent recursive validation are green.

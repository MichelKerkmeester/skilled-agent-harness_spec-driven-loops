...
- [ ] T007 Dedupe the three CP sandbox setup helpers into one shared helper and update stress-test docs. (`.opencode/skills/deep-loop-workflows/manual_testing_playbook/shared/setup-cp-sandbox.sh`, `.opencode/skills/deep-loop-workflows/manual_testing_playbook/research/07--command-flow-stress-tests/*.md`)
- [ ] T008 Reconcile known drift: false council catalog prose, duplicate headings, and stale count self-checks. (`.opencode/skills/deep-loop-workflows/manual_testing_playbook/ai-council/08--council-graph-integration/*.md`, `.opencode/skills/deep-loop-workflows/manual_testing_playbook/{context,research,review,improvement,ai-council}/manual_testing_playbook.md`)
...
- [ ] T010 Validate the phase spec folder after implementation evidence is recorded. (`.opencode/specs/skilled-agent-orchestration/152-deep-loop-workflows/007-governance-consolidation/`)
- [ ] T011 Re-run phase-001 artifact parity and compare post-phase outputs byte-for-byte. (`.opencode/specs/skilled-agent-orchestration/152-deep-loop-workflows/001-parity-baseline-and-runtime-ownership-adr/`, `post-phase generated parity outputs`)

...
**We chose**: run a 10-iteration deep-research loop before changing deep-review.
...
|--------|------|------|-------|
| **10-iteration deep-research loop** | Evidence-led, fresh context per pass, likely to expose workflow failure modes | Takes longer before remediation | 9/10 |
...
**What it costs**:
- The user waits for research before remediation. Mitigation: keep the loop bounded to 10 iterations and synthesize immediately.
...
| 3 | **Sufficient?** | PASS | 10 iterations should cover prompts, agents, YAML, convergence, and synthesis. |

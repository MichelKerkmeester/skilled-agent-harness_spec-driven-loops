---
title: "Feature Specification: Deep Review Complexity Research"
description: "Research why focused deep-research bug-finding can surface more actionable defects than the deep-review workflow, and identify changes that would make deep-review less surface-level. This packet completed an evidence-only 10-iteration synthesis with ranked recommendations."
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "Completed Level 3 auto deep-research synthesis."
...
# Feature Specification: Deep Review Complexity Research
...
**Key Decisions**: run an evidence-only 10-iteration deep-research loop; defer implementation until findings are synthesized and ranked.
...
### Purpose
Use 10 autonomous research iterations to identify why deep-review underperforms on bug discovery and produce actionable recommendations for hardening the deep-review workflow.
<!-- /ANCHOR:problem -->
...
|-----------|-------------|-------------|
| `.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/spec.md` | Modify | Define research packet and requirements. |
| `.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/plan.md` | Modify | Define auto research execution plan. |
| `.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/tasks.md` | Modify | Track planning, research, synthesis, and validation tasks. |
| `.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/checklist.md` | Modify | Track evidence and workflow compliance checks. |
| `.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/description.json` | Create | Provide system-spec-kit indexing metadata. |
| `.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/research/**` | Create | Workflow-owned deep-research artifacts. |
<!-- /ANCHOR:scope -->
...
| REQ-002 | Use `cli-codex` with `gpt-5.5`, `high` reasoning, and `fast` service tier for each iteration. | Deep-research config and iteration audit metadata record the requested executor settings. |
...
- **SC-001**: 10 iterations complete or the workflow halts with a documented convergence or failure reason.

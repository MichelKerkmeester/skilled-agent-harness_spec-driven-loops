...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary/spec.md"
      - ".opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary/plan.md"
      - ".opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary/tasks.md"
      - ".opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary/checklist.md"
      - ".opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary/implementation-summary.md"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | `skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary` |
...
| `.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary/spec.md` | Modified | Level 2 specification. |
| `.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary/plan.md` | Modified | Level 2 implementation plan. |
| `.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary/tasks.md` | Modified | Level 2 task ledger. |
| `.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary/checklist.md` | Created | Level 2 verification checklist. |
| `.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary/implementation-summary.md` | Modified | Final evidence and commit handoff. |
| `.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary/description.json` | Refreshed | Memory metadata. |
| `.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary/graph-metadata.json` | Refreshed | Graph metadata. |
<!-- /ANCHOR:what-built -->
...
| Strict spec validation | Pass | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary --strict` passed. |
...
.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary/checklist.md
.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary/implementation-summary.md
.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary/description.json
.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/007-ledger-led-graph-vocabulary/graph-metadata.json
.opencode/skills/system-spec-kit/mcp_server/lib/coverage-graph/coverage-graph-db.ts

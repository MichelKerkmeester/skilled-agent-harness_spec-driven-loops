...
_memory:
  continuity:
    ...
    recent_action: "Completed 10 research iterations and final synthesis"
...
- [x] T001 Use existing packet folder selected by the user (`.opencode/specs/skilled-agent-orchestration/116-deep-review-complexity/`)

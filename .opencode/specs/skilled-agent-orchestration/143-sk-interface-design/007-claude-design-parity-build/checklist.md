...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/143-sk-interface-design/007-claude-design-parity-build"
...
- [x] CHK-006 [P0] `package_skill.py` valid for sk-interface-design
...
- [x] CHK-017 [P1] Protocol lives in `sk-interface-design/references/`; mcp-magicpath references it cross-skill

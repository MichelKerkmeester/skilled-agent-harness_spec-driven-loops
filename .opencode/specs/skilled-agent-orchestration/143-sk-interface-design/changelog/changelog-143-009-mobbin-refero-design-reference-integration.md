---
title: "Changelog: Mobbin and Refero design-reference integration [143-sk-interface-design/009-mobbin-refero-design-reference-integration]"
...
| `package_skill --check` | PASS: `sk-interface-design` validated. |
...
| `.opencode/skills/sk-interface-design/references/design_references_mcp.md` | Created | Critique-against use and hard rules. |
| `.opencode/skills/sk-interface-design/references/mobbin_tools.md` | Created | Mobbin MCP tool catalog for `search_screens` and `search_flows`. |
| `.opencode/skills/sk-interface-design/references/refero_tools.md` | Created | Refero MCP tool catalog, 8 tools for styles, screens and flows. |
| `.opencode/skills/sk-interface-design/SKILL.md` | Modified | ON_DEMAND row, references entry, Related Skills bullet and loading note. |

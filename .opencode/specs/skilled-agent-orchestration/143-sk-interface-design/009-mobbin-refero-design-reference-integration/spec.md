...
This is **Phase 9** of the 143-sk-interface-design packet. The earlier phases built the skill, de-vendored it from `ui-ux-pro-max`, and added the Claude Design parity loop and variation-diversity. This phase adds a real-world shipped-UI reference path so the skill can name the real-world default for a category and deviate from it deliberately.

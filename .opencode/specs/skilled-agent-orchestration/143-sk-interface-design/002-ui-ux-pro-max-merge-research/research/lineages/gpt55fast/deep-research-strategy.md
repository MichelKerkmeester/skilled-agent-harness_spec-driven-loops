...
description: Runtime strategy for the gpt-5.5-fast fan-out lineage researching ui-ux-pro-max merge recommendations for sk-interface-design.
---
...
This lineage investigates how the vendored `ui-ux-pro-max-skill-main` repository can improve `sk-interface-design` without bloating the house skill or changing implementation in this research packet.

## 2. TOPIC

ui-ux-pro-max merge into sk-interface-design
...
- Do not edit `.opencode/skills/sk-interface-design/` in this packet.
- Do not rewrite or re-derive the external repo data.
- Do not evaluate `mcp-magicpath` except where it is already a related skill edge for `sk-interface-design`.
...
- Stack ownership is answered: skip direct stack CSV merge into `sk-interface-design`; adapt only cross-cutting design-quality fragments, and leave true implementation-stack adoption to future `sk-code` surface work. (iteration 3)
...
- Do NOT retry: Direct CLI/marketplace plumbing merge into `sk-interface-design`.
...
- Do NOT retry: Absorbing React/Next performance tables into `sk-interface-design` beyond design-relevant cross-references.
...
- What was tried: Treat external stack CSVs as mergeable `sk-interface-design` references.
- Why blocked: Most rows are framework implementation checklists rather than aesthetic-direction guidance.
- Do NOT retry: Moving stack CSVs wholesale into `sk-interface-design`.
...
- Directly merging installer and platform-template plumbing; it adds maintenance burden without improving the target skill's design guidance. (iteration 1, evidence: .opencode/specs/skilled-agent-orchestration/143-sk-interface-design/external/ui-ux-pro-max-skill-main/skill.json:20-40)
- Directly merging Phosphor icon imports; preserve the app's existing icon system instead. (iteration 2, evidence: .opencode/specs/skilled-agent-orchestration/143-sk-interface-design/external/ui-ux-pro-max-skill-main/src/ui-ux-pro-max/data/icons.csv:1-28)
- Directly merging React/Next performance rules; keep implementation performance primarily under `sk-code`. (iteration 2, evidence: .opencode/specs/skilled-agent-orchestration/143-sk-interface-design/external/ui-ux-pro-max-skill-main/src/ui-ux-pro-max/data/react-performance.csv:1-16)
- Copying the giant generated `design.csv` corpus wholesale into `SKILL.md` or the main principles reference. (iteration 2, evidence: .opencode/specs/skilled-agent-orchestration/143-sk-interface-design/external/ui-ux-pro-max-skill-main/src/ui-ux-pro-max/data/design.csv:1-80)
- Making external `--design-system --persist` mandatory; it writes separate project docs and conflicts with the house skill's lean reference workflow. (iteration 2, evidence: .opencode/specs/skilled-agent-orchestration/143-sk-interface-design/external/ui-ux-pro-max-skill-main/src/ui-ux-pro-max/templates/base/skill-content.md:77-109)
- Moving stack CSVs wholesale into `sk-interface-design`; most content belongs to implementation-stack guidance or future `sk-code` expansion. (iteration 3, evidence: .opencode/specs/skilled-agent-orchestration/143-sk-interface-design/external/ui-ux-pro-max-skill-main/src/ui-ux-pro-max/data/stacks/react.csv:1-54)
...
- Replacing existing Apache-2.0 notices or external MIT notices with one unqualified license statement. (iteration 3, evidence: .opencode/skills/sk-interface-design/LICENSE.txt:90-122)
- Continuing to iteration 5 without new evidence; iteration 4 reached 0.03 novelty with 5/5 questions answered. (iteration 4, evidence: .opencode/specs/skilled-agent-orchestration/143-sk-interface-design/002-ui-ux-pro-max-merge-research/research/lineages/gpt55fast/iterations/iteration-004.md:45-51)
...
- Packet spec states the external repo is MIT-licensed and includes styles, palettes, type pairings, product reasoning, UX guidelines, stack guides, BM25 search, and a design-system generator. [SOURCE: .opencode/specs/skilled-agent-orchestration/143-sk-interface-design/002-ui-ux-pro-max-merge-research/spec.md:55-61]
- Packet scope requires per-asset ADOPT/ADAPT/SKIP classification, house-structure mapping, licensing path, cross-lineage comparison, and negative knowledge. [SOURCE: .opencode/specs/skilled-agent-orchestration/143-sk-interface-design/002-ui-ux-pro-max-merge-research/spec.md:71-95]
- `sk-interface-design` is currently a lean router plus one full principles reference, with `sk-code` implementation handoff and Apache-2.0 Anthropic attribution. [SOURCE: .opencode/skills/sk-interface-design/SKILL.md:14-17]

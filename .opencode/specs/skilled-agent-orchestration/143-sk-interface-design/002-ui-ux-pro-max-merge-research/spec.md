...
- External repo: `.opencode/specs/skilled-agent-orchestration/143-sk-interface-design/external/ui-ux-pro-max-skill-main/` (MIT) — data files, `cli/`, `src/`, `docs/`, README, `skill.json`.

...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/skills/sk-interface-design/feature_catalog/feature_catalog.md"
...
This is **Phase 12** of the sk-interface-design specification — a doc-realignment phase in the same spirit as phase 008.

**Scope Boundary**: Edit only `feature_catalog/` and `manual_testing_playbook/` in `sk-interface-design`. No change to SKILL.md/README/references (those already carry the phase-011 routing reality). No new behavior.

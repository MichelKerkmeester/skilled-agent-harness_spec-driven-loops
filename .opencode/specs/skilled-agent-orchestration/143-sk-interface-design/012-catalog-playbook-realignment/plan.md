...
description: "Plan to add the Mobbin/Refero design-references feature and a hybrid-routing manual-testing scenario to sk-interface-design's catalog and playbook."
trigger_phrases:
  - "sk-interface-design catalog realignment plan"
...
| **Storage** | `.opencode/skills/sk-interface-design/{feature_catalog,manual_testing_playbook}/` |

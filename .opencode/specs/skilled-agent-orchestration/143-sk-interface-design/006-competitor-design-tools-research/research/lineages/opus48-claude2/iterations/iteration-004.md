...
- **Relevance:** image→UI (OVERLAP w/ 005 image-brief). Theme-swap = preset chooser → anti-default SKIP for sk-interface-design.
...
| T1 direct edits | **SKIP** | sk-interface-design owns judgment, not a live canvas; direct-manipulation belongs to mcp-magicpath/sk-code. |
...
- SKIP preset theme-swap / "pick-a-vibe" variant menus in sk-interface-design — violates the anti-default mandate (primary guardrail, agrees with 005).

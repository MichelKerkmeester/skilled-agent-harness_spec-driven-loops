...
6. v0's broad product scope includes backend, deployment, diagnostics, APIs, databases, and app shipping. Those are useful as contrast but mostly SKIP for this packet: they belong to app-building platforms, not `sk-interface-design` or `mcp-magicpath`. [SOURCE: https://vercel.com/docs/v0]
...
- Local `sk-interface-design` and `mcp-magicpath` SKILL.md files. [SOURCE: file:.opencode/skills/sk-interface-design/SKILL.md] [SOURCE: file:.opencode/skills/mcp-magicpath/SKILL.md]

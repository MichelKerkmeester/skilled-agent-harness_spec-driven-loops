...
2. The adoptable part for `sk-interface-design` is a direction-comparison protocol, not the curated chooser. The skill could produce 2-3 brief-specific directions with named rationale and an anti-default critique, while explicitly avoiding reusable style presets. [SOURCE: file:.opencode/skills/sk-interface-design/SKILL.md] [SOURCE: https://docs.lovable.dev/features/design-guidance.md]

...
- Local sources: [SOURCE: file:.opencode/skills/sk-interface-design/SKILL.md] [SOURCE: file:.opencode/skills/mcp-magicpath/SKILL.md] [SOURCE: file:.opencode/specs/skilled-agent-orchestration/143-sk-interface-design/005-claude-design-parity-research/research/research.md]

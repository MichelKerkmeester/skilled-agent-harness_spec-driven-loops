...
This is **Phase 11** of the sk-interface-design specification.
...
**Changelog**:
- `sk-interface-design/changelog/v1.5.0.0.md`.
<!-- /ANCHOR:phase-context -->
...
|-----------|-------------|-------------|
| `sk-interface-design/references/design-grounding/design_references_mcp.md` | Modify | §3 hybrid decision gate + category taxonomy + source pick; §1 pointer |
| `sk-interface-design/SKILL.md` | Modify | §2 resource row INITIATIVE/ASK; §4 ALWAYS rule 7 |
| `sk-interface-design/changelog/v1.5.0.0.md` | Create | Changelog for the routing upgrade |
<!-- /ANCHOR:scope -->

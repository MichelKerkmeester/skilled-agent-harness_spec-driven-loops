...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/z_archive/115-mcp-skill-install-doctor-standardization"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 148-mcp-skill-install-doctor-standardization |

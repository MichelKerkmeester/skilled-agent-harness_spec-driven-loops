...
|---|---|
| **Sub-phase** | 061/006 |
| **Target** | `@ultra-think` → @multi-ai-council |
| **Status** | Planned |
| **Completion** | 0% |
<!-- /ANCHOR:metadata -->
...
### Rename Audit
[grep -r ultra-think across all surfaces — must be zero.]
<!-- /ANCHOR:verification -->
...
| File | Change |
|---|---|
| `.opencode/agent/ultra-think.md` | [TBD] |
| `.claude/agents/ultra-think.md` | [TBD] |
| `.gemini/agents/ultra-think.md` | [TBD] |
| `.codex/agents/ultra-think.toml` | [TBD] |

---
title: "Spec: @write Agent Optimization"
...
### Problem Statement
`@write` (399 LOC) has not been through the sk-improve-agent v2 lens. After 060's empirical validation (PASS 6/0/0), the substrate is ready to apply across the fleet.

### Purpose
Improvement focus: **Doc generation; sk-doc template alignment; DQI scoring discipline**. Backed by sk-doc skill — must use templates, never freeform. DQI score must be reported in completion claim.
...
### In Scope
- Canonical agent body: `.opencode/agent/write.md`
- Runtime mirrors: `.claude/agents/write.md`, `.gemini/agents/write.md`, `.codex/agents/write.toml`
- Frontmatter / behavioral rules / output verification / anti-patterns refinements
- Score-weighting dimensions: template fidelity, DQI score honesty
...
|---|---|---|
| `.opencode/agent/write.md` | Update | Promoted candidate body |
| `.claude/agents/write.md` | Update | Mirror sync |
| `.gemini/agents/write.md` | Update | Mirror sync |
| `.codex/agents/write.toml` | Update | Mirror sync (TOML) |
<!-- /ANCHOR:scope -->

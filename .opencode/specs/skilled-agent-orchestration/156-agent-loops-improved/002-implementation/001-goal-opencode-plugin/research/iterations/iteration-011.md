...
Evidence: prior Claude evidence says Claude exposes `Goal`, `Last check`, `Goal active`, `Goal achieved`, and no-goal labels, and prior G2 already concluded OpenCode needs a status substitute rather than literal overlay parity. [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-implementation/001-goal-opencode-plugin/research/iterations/iteration-002.md`:44] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-implementation/001-goal-opencode-plugin/research/iterations/iteration-002.md`:46] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-implementation/001-goal-opencode-plugin/research/iterations/iteration-002.md`:48] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-implementation/001-goal-opencode-plugin/research/iterations/iteration-002.md`:50] The strategy also declares literal Claude status-line replication a non-goal because OpenCode cannot render it. [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-implementation/001-goal-opencode-plugin/research/deep-research-strategy.md`:38]
...
Evidence: the thin-router command pattern keeps routing in the markdown file and makes outputs parseable. [SOURCE: `.opencode/commands/memory/learn.md`:7] [SOURCE: `.opencode/commands/memory/learn.md`:9] [SOURCE: `.opencode/commands/memory/learn.md`:32] [SOURCE: `.opencode/commands/memory/learn.md`:39] G6 already chose a root `/goal` command delegating state mutation to plugin tools, with `mk_goal` and `mk_goal_status` as the plugin surfaces. [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-implementation/001-goal-opencode-plugin/research/iterations/iteration-006.md`:68] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-implementation/001-goal-opencode-plugin/research/iterations/iteration-006.md`:78] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-implementation/001-goal-opencode-plugin/research/iterations/iteration-006.md`:83]

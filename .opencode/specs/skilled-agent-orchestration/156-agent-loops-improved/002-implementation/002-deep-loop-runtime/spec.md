...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/156-agent-loops-improved/002-implementation/002-deep-loop-runtime"
...
### Out of Scope
- Improvements targeting `deep-loop-workflows`, `system-spec-kit`, or `skill-interconnection` subsystems (other subsystem groups in `002-implementation`)

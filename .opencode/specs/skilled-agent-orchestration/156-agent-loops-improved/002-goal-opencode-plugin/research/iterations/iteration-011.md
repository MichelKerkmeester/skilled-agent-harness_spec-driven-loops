...
Evidence: prior Claude evidence says Claude exposes `Goal`, `Last check`, `Goal active`, `Goal achieved`, and no-goal labels, and prior G2 already concluded OpenCode needs a status substitute rather than literal overlay parity. [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-goal-opencode-plugin/research/iterations/iteration-002.md`:44] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-goal-opencode-plugin/research/iterations/iteration-002.md`:46] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-goal-opencode-plugin/research/iterations/iteration-002.md`:48] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-goal-opencode-plugin/research/iterations/iteration-002.md`:50] The strategy also declares literal Claude status-line replication a non-goal because OpenCode cannot render it. [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-goal-opencode-plugin/research/deep-research-strategy.md`:38]

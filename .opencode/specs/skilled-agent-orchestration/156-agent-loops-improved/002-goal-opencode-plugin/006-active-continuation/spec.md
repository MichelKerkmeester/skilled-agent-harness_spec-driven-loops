...
| `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-goal-opencode-plugin/006-active-continuation/*` | Modify | Replaces scaffold phase docs with actual scope, plan, tasks, metadata, and verification summary. |
<!-- /ANCHOR:scope -->

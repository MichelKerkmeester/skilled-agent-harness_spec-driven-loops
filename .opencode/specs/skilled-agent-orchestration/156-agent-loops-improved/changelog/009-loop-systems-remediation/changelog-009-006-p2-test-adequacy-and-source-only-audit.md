---
title: "Changelog: P2 Test Adequacy and Source-Only Audit [009-loop-systems-remediation/006-p2-test-adequacy-and-source-only-audit]"
...
> Spec folder: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/009-loop-systems-remediation/006-p2-test-adequacy-and-source-only-audit` (Level 1)

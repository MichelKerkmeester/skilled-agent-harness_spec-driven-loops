---
title: "Changelog: Run-Now Control (Forced-Run Sentinel) [007-ux-observability-automation/004-run-now-control]"
...
> Spec folder: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/007-ux-observability-automation/004-run-now-control` (Level 1)

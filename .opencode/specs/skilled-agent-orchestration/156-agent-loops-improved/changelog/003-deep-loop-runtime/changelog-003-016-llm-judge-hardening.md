---
title: "Changelog: LLM Judge Hardening Stack [003-deep-loop-runtime/016-llm-judge-hardening]"
...
> Spec folder: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/003-deep-loop-runtime/016-llm-judge-hardening` (Level 1)

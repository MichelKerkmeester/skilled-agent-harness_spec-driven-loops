---
title: "Changelog: Phase 2: injection-plugin [002-goal-opencode-plugin/002-injection-plugin]"
...
> Spec folder: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-goal-opencode-plugin/002-injection-plugin` (Level 1)

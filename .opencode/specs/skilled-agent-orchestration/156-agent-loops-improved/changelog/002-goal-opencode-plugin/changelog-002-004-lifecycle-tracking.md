---
title: "Changelog: Phase 4: lifecycle-tracking [002-goal-opencode-plugin/004-lifecycle-tracking]"
...
> Spec folder: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-goal-opencode-plugin/004-lifecycle-tracking` (Level 1)

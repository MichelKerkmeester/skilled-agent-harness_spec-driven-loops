---
title: "Changelog: Phase 6: active-continuation [002-goal-opencode-plugin/006-active-continuation]"
...
> Spec folder: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/002-goal-opencode-plugin/006-active-continuation` (Level 1)

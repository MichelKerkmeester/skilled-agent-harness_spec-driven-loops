...
# Deep-Review Iteration 20 of 20
...
- Sub-angle: **integration contract: convergence.cjs <-> upsert.cjs <-> reduce-state, fanout-run <-> fanout-pool <-> fanout-salvage <-> fanout-merge**
- Scope slice (SCRIPTS) — review these files as an integrated unit:
...
1) Narrative markdown at `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/review/iterations/iteration-020.md` with headings: Dimension, Files Reviewed, Findings by Severity (P0/P1/P2 — each with file:line + why + suggested fix direction), Verdict (FAIL|CONDITIONAL|PASS), Notes.
2) Delta JSONL at `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/review/deltas/iter-020.jsonl` — first line EXACTLY this canonical iteration record (single line, no pretty-print):
{"type":"iteration","iteration":20,"mode":"review","run":"iter-020","status":"complete","focus":"maintainability: integration contract: convergence.cjs <-> upsert.cjs <-> reduce-state, fanout-run <-> fanout-pool <-> fanout-salvage <-> fanout-merge","dimensions":["maintainability"],"filesReviewed":[<files with :line you actually inspected>],"findingsCount":<n>,"findingsSummary":{"P0":<n>,"P1":<n>,"P2":<n>},"findingsNew":[],"traceabilityChecks":{},"newFindingsRatio":<0..1>,"sessionId":"review-156-002-2026-06-29","generation":1,"lineageMode":"new","timestamp":"2026-06-29T00:00:00Z","durationMs":0}
   then ONE `{"type":"finding",...}` line per finding with: {"type":"finding","id":"R20-<P0|P1|P2>-NNN","severity":"<P0|P1|P2>","dimension":"maintainability","file":"path:line","title":"...","detail":"...","claim":"...","evidenceRefs":["path:line"],"counterevidenceSought":"...","alternativeExplanation":"...","confidence":"<low|med|high>","downgradeTrigger":"...","suggestedFix":"...","iteration":20}

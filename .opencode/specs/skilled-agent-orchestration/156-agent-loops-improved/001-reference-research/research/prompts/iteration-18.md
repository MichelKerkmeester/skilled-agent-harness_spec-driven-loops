...
Segment: 3 (map -> deep-loop-runtime) | Iteration: 18 of 58
Questions: 0/36 checked | Last focus: S3-01
Last 2 ratios: 0.77 -> 0.74 | Stuck count: 0
...
Focus Area: [S3-02] Given the YAML notes our macOS lock is advisory, should `loop-lock.ts` add loop-cli's socket-bind-before-init as a hard single-flight guard, and what breaks on multi-host? (build on S1-09) -> loop-lock.ts
...
Last 3 Iterations Summary: run 15: S2-07 (ratio 0.78); run 16: S2-08 (ratio 0.77); run 17: S3-01 (ratio 0.74)
...
- Write iteration narrative to: .opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/001-reference-research/research/iterations/iteration-018.md
- Write per-iteration delta file to: .opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/001-reference-research/research/deltas/iter-018.jsonl
...
1. Iteration narrative markdown at `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/001-reference-research/research/iterations/iteration-018.md` with headings: Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus. In Findings give: reference mechanism + file:line; exact OUR target file; port-difficulty (easy/med/hard); quick-win vs deep-rewrite tag.

2. Canonical JSONL record APPENDED to the State Log, EXACT type "iteration":
`{"type":"iteration","iteration":18,"newInfoRatio":<0..1>,"status":"<complete|insight|stuck>","focus":"S3-02","graphEvents":[...]}`
...
3. Per-iteration delta file at `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/001-reference-research/research/deltas/iter-018.jsonl`: the same iteration record plus one record per finding/observation/graphEvent, each on its own line.

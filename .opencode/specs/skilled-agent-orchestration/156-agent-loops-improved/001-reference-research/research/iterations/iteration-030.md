...
1. **Rank 1 - Add `run_now_sentinel` beside `pause_sentinel` in `state_paths`.**
   ...
   Reference mechanism: `loop-cli-main` models run-now as a first-class control-plane request, not as ordinary loop state; the request union includes `type: "trigger"` [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/types.ts:99`], the daemon handles it in its own branch [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/server.ts:151`], and accepted triggers route through `manager.trigger()` [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/manager.ts:213`].
...
2. **Rank 2 - Make two-sentinel precedence explicit in `step_check_pause_sentinel`.**
   ...
   Reference mechanism: `LoopController.triggerNow()` refuses only an active `running` loop, snapshots the remaining delay, sets `_forceRun`, and resumes a paused loop if needed [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/core/loop-controller.ts:161`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/core/loop-controller.ts:165`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/core/loop-controller.ts:173`]. Its wait loop checks `_forceRun` before the pause branch [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/core/loop-controller.ts:233`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/core/loop-controller.ts:248`], and tests show a trigger interrupts sleep immediately [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/tests/loop-controller.test.ts:134`].
...
3. **Rank 3 - Consume the run-now sentinel exactly once and persist the outcome.**
   ...
   Reference mechanism: after `controller.triggerNow()` accepts, the manager immediately persists the changed controller snapshot [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/manager.ts:216`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/manager.ts:218`], and manager event wiring persists `triggered` alongside run, pause, resume, waiting, and stop events [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/manager.ts:263`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/manager.ts:268`]. Tests also assert an active run rejects a second trigger [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/tests/loop-controller.test.ts:162`].

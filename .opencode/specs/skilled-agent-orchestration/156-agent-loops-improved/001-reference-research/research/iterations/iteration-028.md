...
2. Add a dispatch-duration `progress` heartbeat while a lone executor is running.
   - Reference mechanism: loop-cli-main exposes live wait/run state through `status`, `nextRunAt`, `remainingDelayMs`, `runHistory`, and `skippedCount` in `getMeta()` [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/core/loop-controller.ts:189`] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/core/loop-controller.ts:201`] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/types.ts:74`]. Waiting transitions emit and persist a status update before the long sleep continues [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/core/loop-controller.ts:266`] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/manager.ts:269`].
...
3. Gate heartbeat writes by cadence and serialized snapshot, not by every loop-state read.
   - Reference mechanism: loop-cli-main keeps `lastSerialized` per loop and returns without writing when the serialized meta is unchanged [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/manager.ts:23`] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/manager.ts:279`] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/manager.ts:281`]. Kasper separately uses configurable polling intervals, clamped in config, instead of a hard-coded tight loop [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/config.ts:40`] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/config.ts:233`] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/index.ts:421`].
...
4. Add parity tests that assert single-loop telemetry uses the fan-out ledger vocabulary.
   - Reference mechanism: kasper's logger appends one structured JSON object per line and treats logging failure as non-fatal [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/logging.ts:27`] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/logging.ts:33`] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/logging.ts:36`]. Kasper also logs batch progress and completion events with counts [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/evaluate.ts:1185`] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/evaluate.ts:1192`] [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/evaluate.ts:1258`].

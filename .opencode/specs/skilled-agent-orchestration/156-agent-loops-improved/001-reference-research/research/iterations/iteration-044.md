...
1. Define one ADR-owned `antiConvergence` contract, then project it into every graph-backed loop config.
   ...
   Reference mechanism: loop-cli-main defines a central `LoopOptions` shape before loop instances run [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/types.ts:20`] and builds those options through one adapter [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/loop-config.ts:86`]. Kasper likewise makes the minimum evidence floor a typed config field, not an incidental scoring constant [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/config.ts:46`].
...
2. Put `minIterations` in the config floor, but keep `convergenceMode` outside optimizer tunables.
   ...
   Reference mechanism: Kasper separates bounded numeric fields from semantic switches in one schema [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/config.ts:26`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/config.ts:46`] and carries defaults for both thresholds and switches in `DEFAULT_CONFIG` [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/types.ts:31`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/types.ts:48`]. The enforcement path then returns before improvement side effects if the minimum observation floor is not met [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/evaluate.ts:1675`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/evaluate.ts:1682`].
...
3. Treat council as a glossary mapping, not a forced rename.
   ...
   Reference mechanism: loop-cli-main models a hard cap as `maxRuns: number | null` [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/types.ts:27`] and parses invalid caps before the loop is constructed [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/loop-config.ts:22`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/loop-config.ts:112`]. Its controller test verifies that `maxRuns: 1` stops after one immediate run [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/tests/loop-controller.test.ts:75`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/tests/loop-controller.test.ts:82`].
...
4. Add stop-policy capability metadata so runtime parity checks can reject modes without the floor.
   ...
   Reference mechanism: Kasper validates each config key through `safeParse` and falls back only after warning on invalid fields [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/config.ts:59`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/config.ts:66`]. Loop-cli-main similarly rejects invalid run caps at parse time [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/loop-config.ts:27`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/loop-config.ts:29`].
...
5. Extend the optimizer manifest from independent ranges to invariant groups before broadening products to context/council.
   ...
   Reference mechanism: Kasper's schema bounds each independent field [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/config.ts:17`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/config.ts:46`], but the minimum observation floor is consumed with aggregate evidence before update side effects [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/evaluate.ts:1675`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/evaluate.ts:1682`]. That is a cross-field behavioral invariant, not only a numeric range.

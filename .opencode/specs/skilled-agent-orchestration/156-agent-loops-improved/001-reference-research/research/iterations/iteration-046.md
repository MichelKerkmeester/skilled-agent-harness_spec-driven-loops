...
Reference mechanism: loop-cli runs unattended, but still creates a branch before work begins, keeps `main` untouched until the final merge, and only merges after verification passes with a clean tree [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/.opencode/commands/ob-autopilot.md:13`; SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/.opencode/commands/ob-autopilot.md:25`; SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/.opencode/commands/ob-autopilot.md:54`]. On verification failure or unresolved merge conflict it stops and preserves the branch instead of shipping [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/.opencode/commands/ob-autopilot.md:68`; SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/.opencode/commands/ob-autopilot.md:74`].
...
Reference mechanism: loop-cli's failure policy is explicit: propose-no-tasks, stalled wave, exhausted retry, failed verification, or merge conflict all halt; the branch remains intact and unmerged for diagnosis [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/.opencode/commands/ob-autopilot.md:68`; SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/.opencode/commands/ob-autopilot.md:72`; SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/.opencode/commands/ob-autopilot.md:74`].
...
Reference mechanism: Kasper snapshots before mutation and keeps rollback local: AGENTS.md backups are timestamped before write, rollback backs up the pre-rollback state, restores latest backup, and writes atomically [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/agents-md.ts:51`; SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/agents-md.ts:128`; SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/agents-md.ts:138`; SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/agents-md.ts:142`]. Agent prompt backups follow the same pattern and refuse inline prompt rollback because there is no on-disk file to restore [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/agent-prompts.ts:194`; SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/agent-prompts.ts:214`; SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/agent-prompts.ts:216`].
...
Reference mechanism: Kasper defaults `auto_update` on in config [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/config.ts:212`; SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/config.ts:214`], shows the current config/session auto-update state in improvement output [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/handlers.ts:465`], and lets the session toggle automatic application on/off [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/handlers.ts:481`; SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/handlers.ts:487`; SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/handlers.ts:490`].
...
Reference mechanism: loop-cli preserves the feature branch on failure and refuses unverified merge [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/.opencode/commands/ob-autopilot.md:74`]. Kasper proves local backup/rollback can still be useful for reversible edits [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/improvements.ts:49`; SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/improvements.ts:90`; SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/improvements.ts:101`].

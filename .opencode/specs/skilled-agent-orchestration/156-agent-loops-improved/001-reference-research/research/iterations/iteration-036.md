...
2. Ranked backlog: persist source provenance and fallback quality on seeded graph nodes.
   ...
   Reference mechanism: `kasper` resolves an agent prompt source through a precedence chain: project config, global config, explicit file directive, inline prompt, project file candidates, then global file candidates [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/agent-prompt-resolver.ts:203`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/agent-prompt-resolver.ts:209`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/agent-prompt-resolver.ts:218`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/agent-prompt-resolver.ts:236`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/agent-prompt-resolver.ts:240`].
...
3. Ranked backlog: repair missing or stale seeded nodes before scoring, not during scoring.
   ...
   Reference mechanism: `kasper` state init loads existing state, checks integrity, overlays defaults, repairs absent arrays/maps, restores dedupe sets, and rebuilds running state when counts disagree before later evaluation uses the state [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/state.ts:159`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/state.ts:165`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/state.ts:176`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/state.ts:185`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/state.ts:201`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/kasper/src/state.ts:204`].
...
4. Ranked backlog: extend review graph seeding from changed-file impact, but keep it smaller than context mode.
   ...
   Reference mechanism: `loop-cli-main` project manager migrates old project files into a consolidated JSON array, skips corrupted files, loads valid entries into an in-memory map, and creates a default project if the inventory is absent [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/projects.ts:12`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/projects.ts:15`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/projects.ts:28`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/projects.ts:35`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/projects.ts:47`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/projects.ts:56`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/projects.ts:73`].
...
5. Ranked backlog: only expand review/context coverage graph vocabularies where the signal math can use them.
   ...
   Reference mechanism: `loop-cli-main` init preserves only the relationships it can run: `projectId`, `taskId`, prior run state, and task resolver wiring are loaded before controllers start [SOURCE: `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/manager.ts:56`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/manager.ts:66`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/manager.ts:69`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/manager.ts:78`; `.opencode/specs/skilled-agent-orchestration/156-agent-loops-improved/external/loop-cli-main/src/daemon/manager.ts:86`].

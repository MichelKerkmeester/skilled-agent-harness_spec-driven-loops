...
- `.opencode/command/improve/agent.md:269` and `.claude/commands/improve/agent.md:269` point to `assets/improve_deep-agent-improvement_auto.yaml`; `.gemini/commands/improve/improve-agent.toml:60` still points to `assets/improve_improve-agent_auto.yaml`.
- `.opencode/command/improve/assets/` and `.claude/commands/improve/assets/` contain only the renamed `improve_deep-agent-improvement_{auto,confirm}.yaml` files.
- Direct runtime agent inventory found the renamed 4-agent set: `.opencode/agent/deep-agent-improvement.md`, `.claude/agents/deep-agent-improvement.md`, `.gemini/agents/deep-agent-improvement.md`, `.codex/agents/deep-agent-improvement.toml`.

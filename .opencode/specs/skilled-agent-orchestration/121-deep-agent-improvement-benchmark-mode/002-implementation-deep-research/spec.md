---
title: "Feature Specification: MiniMax M2.7 implementation deep-research"
description: "Deep-research charter (MiniMax M2.7 executor): how to implement the model-benchmark mode designed in 001 — seam interface contracts, dispatch-model generalization, eval-rig scorer port, loop wiring, backward-compat. Output build guidance for the follow-on build."
trigger_phrases:
...
# Feature Specification: Deep research (MiniMax M2.7) on how to implement the deep-agent-improvement model-benchmark mode
...
|-----------|-------------|-------------|
| `002-implementation-deep-research/research/**` | Create | Loop state + `research.md` + `resource-map.md` |
| `002-implementation-deep-research/spec.md` | Modify | Bounded findings-fence writeback at synthesis |
<!-- /ANCHOR:scope -->

---
title: "Feature Specification: Deep-loop empty archive-dir fix"
description: "Phase 6 of 121: deep-research command init eagerly created {mode}_archive/ dirs that stayed empty without a restart. Fix makes archive-root creation lazy and guarded across deep-research and deep-review, with regression tests and cleanup of existing empties."
trigger_phrases:
...
# Feature Specification: Deep-loop empty archive-dir fix

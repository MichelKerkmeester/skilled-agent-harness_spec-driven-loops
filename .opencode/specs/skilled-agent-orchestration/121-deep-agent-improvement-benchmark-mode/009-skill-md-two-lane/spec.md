---
title: "Feature Specification: SKILL.md two-lane restructure"
description: "SKILL.md frames model-benchmark as a bolt-on Mode 4 inside the agent-improvement lane, and the smart-router lacks a clean MODEL_BENCHMARK intent surface. This phase restructures SKILL.md into two co-equal lanes and aligns the router."
trigger_phrases:
  - "skill-md two-lane"
...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/121-deep-agent-improvement-benchmark-mode/009-skill-md-two-lane"
...
# Feature Specification: SKILL.md two-lane restructure

---
title: "Feature Specification: Command lane-asking for the model-benchmark lane"
description: "The model-benchmark lane of deep-agent-improvement has no command entry, and the existing command never asks which use-case lane the user wants. This phase makes the model-benchmark lane first-class at the command layer."
trigger_phrases:
  - "command lane-asking"
...
# Feature Specification: Command lane-asking for the model-benchmark lane

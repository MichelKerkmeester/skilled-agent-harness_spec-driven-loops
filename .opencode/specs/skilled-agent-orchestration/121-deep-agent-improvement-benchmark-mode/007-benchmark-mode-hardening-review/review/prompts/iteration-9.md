...
This iteration focus: Cross-cutting integration pass — trace the full model-benchmark path end-to-end (loop-host --mode=model-benchmark -> materialize -> run-benchmark -> promote-candidate; and the scorer seam loop-host could wire to score-model-variant). Hunt for integration gaps, contract mismatches between the new files and the existing journal-based plumbing, and any backward-compat hole in the mode field additions.
Review Scope Files: 
...
- Write iteration narrative to: .opencode/specs/skilled-agent-orchestration/122-session-120-121-deep-review/review/iterations/iteration-009.md
- Write per-iteration delta file to: .opencode/specs/skilled-agent-orchestration/122-session-120-121-deep-review/review/deltas/iter-009.jsonl
...
- **ALLOWED WRITE PATHS (the ONLY paths you may create, modify, or append to)**:
  - `.opencode/specs/skilled-agent-orchestration/122-session-120-121-deep-review/review/iterations/iteration-009.md`, this iteration's narrative markdown
  ...
  - `.opencode/specs/skilled-agent-orchestration/122-session-120-121-deep-review/review/deltas/iter-009.jsonl`, this iteration's delta JSONL
...
- **SCOPE VIOLATION PROTOCOL**: if your plan would require modifying any path NOT in the allowed-write list, you MUST STOP that action and emit a finding instead. Record the would-be mutation as a `scope_violation` entry in the iteration narrative (under a `## SCOPE VIOLATIONS` heading) and continue the review. NEVER execute the out-of-scope mutation. The review packet (`.opencode/specs/skilled-agent-orchestration/122-session-120-121-deep-review/review/iterations/iteration-009.md` directory and parents) is the only zone for your writes; the reviewed target spec/code is off-limits.
...
1. **Iteration narrative markdown** at `.opencode/specs/skilled-agent-orchestration/122-session-120-121-deep-review/review/iterations/iteration-009.md` (path pre-substituted for the current iteration number). Structure: headings for Dimension, Files Reviewed, Findings by Severity (P0/P1/P2), Traceability Checks, Verdict, Next Dimension.

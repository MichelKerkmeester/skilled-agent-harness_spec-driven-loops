---
title: "Feature Specification: opt-in 5-dim scorer + sk-doc skill alignment"
description: "Phase 5 of 121: wire the ported 120/003 5-dimension scorer as an opt-in run-benchmark scorer (closing review deferral F-P2-1/F-P2-2) and align/document the deep-agent-improvement skill docs against sk-doc templates."
trigger_phrases:
  - "optin 5dim scorer"
...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/121-deep-agent-improvement-benchmark-mode/005-optin-5dim-scorer-and-skill-docs"
...
# Feature Specification: opt-in 5-dim scorer + sk-doc skill alignment
...
| **Parent Spec** | ../spec.md |
| **Phase** | 5 of 5 |
| **Predecessor** | 004-benchmark-mode-remediation |
| **Successor** | None |

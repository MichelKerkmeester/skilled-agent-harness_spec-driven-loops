---
title: "Feature Specification: scripts physical lane reorg"
description: "The 16 deep-agent-improvement scripts are still flat while references and assets are lane-split. Move them into agent-improvement, model-benchmark, and shared subdirs, fix every __dirname-relative path, and rewrite all cross-references."
trigger_phrases:
...
# Feature Specification: scripts physical lane reorg
...
| **Parent Spec** | ../spec.md |
| **Phase** | 13 of 13 |
| **Predecessor** | 012-catalog-playbook-advisor-fp25 |
| **Successor** | None |
...
**Dependencies**:
- 010-references-assets-lane-reorg shipped the references and assets lane split, so the scripts tree is the last on-disk surface still flat.

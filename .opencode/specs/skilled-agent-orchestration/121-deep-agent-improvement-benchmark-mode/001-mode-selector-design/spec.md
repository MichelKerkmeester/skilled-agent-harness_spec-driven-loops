---
title: "Feature Specification: deep-agent-improvement model-benchmark mode (design)"
description: "Design to add a model/prompt-framework benchmark mode to deep-agent-improvement via a mode selector, porting the 120/003 rig behind pluggable candidate/dispatcher/scorer seams. Design only; no implementation in this packet."
trigger_phrases:
...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/121-deep-agent-improvement-benchmark-mode/001-mode-selector-design"
...
# Feature Specification: Design: add a model/prompt-framework benchmark mode to deep-agent-improvement (port the 120/003 rig behind a mode selector)

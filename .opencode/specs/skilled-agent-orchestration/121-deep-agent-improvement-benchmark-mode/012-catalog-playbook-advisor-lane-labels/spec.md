---
title: "Feature Specification: Phase 12: catalog-playbook-advisor-fp25"
description: "Catalog lane legend, playbook lane note, and F-P2-5 reduce-state mode display so two-lane usage is visible in docs and the dashboard."
trigger_phrases:
  - "lane legend"
  - "lane note"
  - "mode mix"
...
# Feature Specification: Phase 1: catalog-playbook-advisor-fp25

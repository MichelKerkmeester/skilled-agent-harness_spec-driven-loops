...
- `.opencode/specs/.../014-two-lane-deep-review/review/all-findings.jsonl` (014 emitted every finding as `"id":"n"`; the `dimension-iter-N` IDs in source are reconstructed, not original)

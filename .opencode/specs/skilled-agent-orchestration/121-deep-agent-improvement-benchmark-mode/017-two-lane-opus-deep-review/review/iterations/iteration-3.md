...
- `feature_catalog_code` (provenance packet chain): command-doc provenance "built 121/003, remediated 121/004, opt-in scorer/docs 121/005, command entry 121/008" resolves to real packets `003-build-benchmark-mode`, `004-benchmark-mode-remediation`, `005-optin-5dim-scorer-and-skill-docs`, `008-command-lane-asking`. PASS.

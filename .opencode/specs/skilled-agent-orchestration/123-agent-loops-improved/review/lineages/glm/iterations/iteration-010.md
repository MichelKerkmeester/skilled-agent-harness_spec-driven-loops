# Iteration 10 — undefined — Adversarial replay of F003: is the prompt agent-named?
...
## Focus
Adversarial replay of F003: is the prompt agent-named?
...
- note: fanout-run.cjs:806 uses ${agentName}; for review agentName=deep-review. F003 survives.

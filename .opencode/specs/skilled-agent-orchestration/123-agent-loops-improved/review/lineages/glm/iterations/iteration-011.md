# Iteration 11 — undefined — Adversarial replay of F004: run focused vitest
...
## Focus
Adversarial replay of F004: run focused vitest
...
- note: Test at 323 still asserts empty results; impl assigns all lineages to pool. F004 survives.

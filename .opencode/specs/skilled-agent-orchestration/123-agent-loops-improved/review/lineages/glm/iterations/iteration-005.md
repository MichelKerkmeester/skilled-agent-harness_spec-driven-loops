# Iteration 5 — undefined — Ephemeral finding-id comments in workflow YAML
...
## Focus
Ephemeral finding-id comments in workflow YAML
...
- note: Discovered F005; comment-hygiene rule violation.

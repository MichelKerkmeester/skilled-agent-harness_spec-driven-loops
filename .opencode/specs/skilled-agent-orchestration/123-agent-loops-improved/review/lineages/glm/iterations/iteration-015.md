# Iteration 15 — undefined — spec_code protocol: parent phase map vs child statuses
...
## Focus
spec_code protocol: parent phase map vs child statuses
...
- note: Parent spec.md:106 says 009 In Progress; child says Complete. spec_code = partial.

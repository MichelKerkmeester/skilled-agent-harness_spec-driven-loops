# Iteration 3 — undefined — CLI fan-out prompt vs LEAF deep-review agent contract
...
## Focus
CLI fan-out prompt vs LEAF deep-review agent contract
...
- note: Discovered F003; cross-read agents/deep-review.md:34,54-64.

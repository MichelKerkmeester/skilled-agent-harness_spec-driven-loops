...
**Created:**
- `.opencode/specs/skilled-agent-orchestration/z_archive/037-mcp-testing-playbooks/` — 9 spec files (spec, plan, tasks, checklist, decision-record, research, implementation-summary, description.json, graph-metadata.json)
...
- `.opencode/specs/skilled-agent-orchestration/z_archive/037-mcp-testing-playbooks/research.md` — §5 CCC Audit findings populated.

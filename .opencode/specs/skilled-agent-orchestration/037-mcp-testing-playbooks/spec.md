...
| `.opencode/specs/skilled-agent-orchestration/z_archive/037-mcp-testing-playbooks/*` | Create | spec.md, plan.md, tasks.md, checklist.md, decision-record.md, research.md, implementation-summary.md, description.json, graph-metadata.json |
<!-- /ANCHOR:scope -->
...
| REQ-008 | Spec 049 strict validate passes | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/037-mcp-testing-playbooks --strict` exits 0 |

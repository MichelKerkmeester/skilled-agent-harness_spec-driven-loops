...
## 2. TOPIC
Review of mcp-figma skill with direct CLI support — spec folder `skilled-agent-orchestration/146-mcp-figma-with-direct-cli-support`. Both phases (001 research, 002 skill build) are marked complete. The deliverable is the `mcp-figma` skill at `.opencode/skills/mcp-figma/`.

...
| `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/002-deep-review/003-complexity-schema-prompt-contract/` | Modify/Create | Populate Level 3 spec packet and metadata. |
<!-- /ANCHOR:scope -->

...
|-----------|-------------|-------------|
| `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/spec.md` | Modify | Define research packet and requirements. |
| `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/plan.md` | Modify | Define auto research execution plan. |
| `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/tasks.md` | Modify | Track planning, research, synthesis, and validation tasks. |
| `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/checklist.md` | Modify | Track evidence and workflow compliance checks. |
| `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/description.json` | Create | Provide system-spec-kit indexing metadata. |
| `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/research/**` | Create | Workflow-owned deep-research artifacts. |
<!-- /ANCHOR:scope -->

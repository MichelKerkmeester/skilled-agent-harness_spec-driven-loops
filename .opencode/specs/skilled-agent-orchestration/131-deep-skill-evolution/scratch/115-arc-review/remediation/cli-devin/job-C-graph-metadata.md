...
| 7 | `.opencode/specs/skilled-agent-orchestration/114-small-ai-model-optimization/007-sk-prompt-small-model-rename/graph-metadata.json` | `"skilled-agent-orchestration/114-small-ai-model-optimization"` | `"complete"` |
...
- Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/114-small-ai-model-optimization/007-sk-prompt-small-model-rename --strict`. Expect exit 0.

...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/128-deep-agent-improvement-mixed-executor-adjudication"
    ...
    session_dedup:
      ...
      session_id: "128-deep-agent-improvement-mixed-executor-adjudication"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 128-deep-agent-improvement-mixed-executor-adjudication |

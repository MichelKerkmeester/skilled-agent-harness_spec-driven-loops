...
| Field | Value |
|-------|-------|
| **Spec Folder** | `skilled-agent-orchestration/131-deep-skill-evolution/000-release-cleanup/010-evergreen-citation-sweep-across-deep-skills` |
...
- **deep-review** (10 files): genericized 2 command-example paths, retitled `### Phase 008 Additions` to `### Blocked-Stop and Corruption-Tracking Additions`, dropped `phase 008` from a JSON example + 2 reduce-state.cjs comments, replaced 6 playbook provenance footers (`131-deep-skill-evolution` ADR/spec paths + `arc completion` sourcing) with evergreen descriptions, and cleaned bare `116` packet references.

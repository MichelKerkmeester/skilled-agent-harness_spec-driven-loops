...
2. For spec-folder abandonment: `rm -rf .opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/000-release-cleanup/003-deep-review/` + remove `children_ids` entry from parent `graph-metadata.json` + re-run `skill_graph_compiler.py`.

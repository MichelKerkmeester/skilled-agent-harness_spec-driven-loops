...
7. Read `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/001-ai-council/008-iterative-research-and-architecture/decision-record.md` lines 1-120 — confirmed ADR-001 "Runtime Boundary Decision" + the verbatim negative-consequence at L88 mandating doc broadening.
...
**Full canonical path** (for commit messages or see-also links): `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/001-ai-council/008-iterative-research-and-architecture/decision-record.md#adr-001`
...
- DR-029 corrected path resolves: `131-deep-skill-evolution/001-ai-council/008-iterative-research-and-architecture/decision-record.md`.
...
- ADR-001 source: `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/001-ai-council/008-iterative-research-and-architecture/decision-record.md` L40-120 (Runtime Boundary Decision)

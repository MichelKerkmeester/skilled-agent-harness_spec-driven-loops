...
```
/deep:start-research-loop :auto --spec-folder=.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/000-release-cleanup/001-deep-loop-runtime
```
...
node -e '
  const fs = require("fs");
  const p = ".opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/000-release-cleanup/001-deep-loop-runtime/research/deep-research-config.json";

...
- **Procedure**: Remove only `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/001-ai-council/007-shared-runtime-deliberation/`. No source-code rollback is needed because this packet does not modify skill or MCP files.
<!-- /ANCHOR:rollback -->
...
### Rollback Procedure
1. Remove `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/001-ai-council/007-shared-runtime-deliberation/`.

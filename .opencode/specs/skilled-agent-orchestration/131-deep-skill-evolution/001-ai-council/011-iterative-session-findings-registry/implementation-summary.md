...
- `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/001-ai-council/011-iterative-session-findings-registry/checklist.md`
- `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/001-ai-council/011-iterative-session-findings-registry/decision-record.md`
- `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/001-ai-council/011-iterative-session-findings-registry/implementation-summary.md`
<!-- /ANCHOR:limitations -->

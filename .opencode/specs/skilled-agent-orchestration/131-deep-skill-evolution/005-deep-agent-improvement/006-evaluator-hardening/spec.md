...
| Priority | P1 |
| Date | 2026-05-23 |
| Spec Folder | `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/005-deep-agent-improvement/006-evaluator-hardening/` |
...
| `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/005-deep-agent-improvement/006-evaluator-hardening/*` | Create | Level 3 docs and metadata. |
<!-- /ANCHOR:scope -->

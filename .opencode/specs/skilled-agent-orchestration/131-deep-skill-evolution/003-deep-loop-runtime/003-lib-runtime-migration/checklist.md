...
- [ ] CHK-050 [P1] No scratch files left in spec folder
  - **Evidence**: `ls .opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/003-deep-loop-runtime/003-lib-runtime-migration/` contains only the 7 scaffolded files

...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/131-deep-skill-evolution/003-deep-loop-runtime/001-core-isolation-deliberation"
...
| **Superseded By** | `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/` (user directive relaxed both "MCP tool ID stability" and "DB lifecycle in MCP server" constraints; ruling moves from SPLIT → FULL_ISOLATE_NO_MCP; see 118/spec.md §2 Problem Statement) |

...
|-----------|-------------|-------------|
| `131-deep-skill-evolution/003-deep-loop-runtime/001-core-isolation-deliberation/*.md` | Create | Spec, plan, tasks, checklist, decision-record, implementation-summary |

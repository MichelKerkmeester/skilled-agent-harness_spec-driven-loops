...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/129-deep-ai-council-iterative-multi-topic/003-per-topic-multi-round-orchestration --strict
```
...
git add \
  ...
  .opencode/skills/deep-ai-council/scripts/tests/orchestrate-topic.vitest.ts \
  .opencode/skills/deep-ai-council/scripts/tests/orchestrate-session.vitest.ts \
  .opencode/specs/skilled-agent-orchestration/129-deep-ai-council-iterative-multi-topic/003-per-topic-multi-round-orchestration/spec.md \
  .opencode/specs/skilled-agent-orchestration/129-deep-ai-council-iterative-multi-topic/003-per-topic-multi-round-orchestration/plan.md \
  .opencode/specs/skilled-agent-orchestration/129-deep-ai-council-iterative-multi-topic/003-per-topic-multi-round-orchestration/tasks.md \
  .opencode/specs/skilled-agent-orchestration/129-deep-ai-council-iterative-multi-topic/003-per-topic-multi-round-orchestration/checklist.md \
  .opencode/specs/skilled-agent-orchestration/129-deep-ai-council-iterative-multi-topic/003-per-topic-multi-round-orchestration/decision-record.md \
  .opencode/specs/skilled-agent-orchestration/129-deep-ai-council-iterative-multi-topic/003-per-topic-multi-round-orchestration/implementation-summary.md
```
<!-- /ANCHOR:limitations -->

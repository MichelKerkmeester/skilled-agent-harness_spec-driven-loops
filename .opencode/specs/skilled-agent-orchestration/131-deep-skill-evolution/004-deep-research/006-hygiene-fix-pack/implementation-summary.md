...
| Field | Value |
|-------|-------|
| **Spec Folder** | 131-deep-skill-evolution/004-deep-research/006-hygiene-fix-pack |
...
| `.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/004-deep-research/006-hygiene-fix-pack/` | Created | Level 2 packet docs |
<!-- /ANCHOR:what-built -->
...
| Packet strict validation | PASS: `validate.sh .../004-deep-research/006-hygiene-fix-pack --strict` |
...
.opencode/skills/deep-research/scripts/verify-yaml-script-paths.sh
.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/004-deep-research/006-hygiene-fix-pack/spec.md
.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/004-deep-research/006-hygiene-fix-pack/plan.md
.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/004-deep-research/006-hygiene-fix-pack/tasks.md
.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/004-deep-research/006-hygiene-fix-pack/checklist.md
.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/004-deep-research/006-hygiene-fix-pack/implementation-summary.md
.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/004-deep-research/006-hygiene-fix-pack/description.json
.opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/004-deep-research/006-hygiene-fix-pack/graph-metadata.json
```

...
| Field | Value |
|-------|-------|
| **Spec Folder** | `skilled-agent-orchestration/131-deep-skill-evolution/004-deep-research/004-iteration-ordering-fix` |
...
| Strict validate | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/131-deep-skill-evolution/004-deep-research/004-iteration-ordering-fix --strict` | PASS expected |

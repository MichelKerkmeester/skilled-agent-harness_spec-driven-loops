...
```json
{
  "verified_facts": [
    ...
    },
    {
      ...
      "status": "confirmed",
      "evidence": "command `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/119-parent-skill-native-invocability --strict --recursive` exited 0 with RESULT: PASSED for parent, 001, and 002."
    },
    {

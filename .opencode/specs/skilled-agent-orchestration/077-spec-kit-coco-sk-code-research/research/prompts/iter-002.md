# Deep-Research Iteration 2 of 10 — 077 system-spec-kit + mcp-coco-index + sk-code OpenCode audit
...
Write to: `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/077-spec-kit-coco-sk-code-research/research/iterations/iteration-002.md`

Structure:
```markdown
# Iteration 2 — <short focus title>
...
## Findings
### F-002-001 — <short label> [P0/P1/P2]
...
```json
{"type":"iteration","iteration":2,"newInfoRatio":<0..1>,"status":"<insight|stuck|converged>","focus":"<short>","findingsP0":<n>,"findingsP1":<n>,"findingsP2":<n>,"executor":{"kind":"cli-codex","model":"gpt-5.5","reasoningEffort":"high","serviceTier":"fast"}}
```
...
Write to: `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/077-spec-kit-coco-sk-code-research/research/deltas/iter-002.jsonl`

Contents — one JSON record per line:
```json
{"type":"iteration","iteration":2,"newInfoRatio":<0..1>,"status":"...","focus":"...","findingsP0":<n>,"findingsP1":<n>,"findingsP2":<n>}
{"type":"finding","id":"f-iter002-001","severity":"P1","label":"<short>","iteration":2,"surface":"system-spec-kit|mcp-coco-index|sk-code","evidence":"<file:line>"}
{"type":"observation","id":"obs-iter002-001","packet":"077","classification":"real","iteration":2}
{"type":"ruled_out","direction":"<approach>","reason":"<why>","iteration":2}
```
...
- This is iteration 2. After writing the 3 artifacts, STOP.
- Update strategy.md Section 11 (Next Focus) with the recommendation for iteration 3.

# Deep-Research Iteration 10 of 10 — 077 system-spec-kit + mcp-coco-index + sk-code OpenCode audit
...
- Config: `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/077-spec-kit-coco-sk-code-research/research/deep-research-config.json`
- State Log: `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/077-spec-kit-coco-sk-code-research/research/deep-research-state.jsonl`
- Strategy: `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/077-spec-kit-coco-sk-code-research/research/deep-research-strategy.md`
- Registry: `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/077-spec-kit-coco-sk-code-research/research/findings-registry.json`

## REQUIRED ITERATION 10 FOCUS

Read `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/077-spec-kit-coco-sk-code-research/research/deep-research-strategy.md` Section 11 (Next Focus) for the current iteration's focus area. Also review Sections 3 (Key Questions remaining), 6 (Answered Questions), 7-10 (machine-owned: what worked/failed, exhausted, ruled out), and 12 (Known Context).

Read prior iterations under `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/077-spec-kit-coco-sk-code-research/research/iterations/` to avoid re-treading.

## OUTPUT CONTRACT (THREE REQUIRED ARTIFACTS)

### 1. Iteration narrative

Write to: `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/077-spec-kit-coco-sk-code-research/research/iterations/iteration-010.md`

Structure:
```markdown
# Iteration 10 — <short focus title>
...
## Findings
### F-010-001 — <short label> [P0/P1/P2]
...
APPEND a single line to: `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/077-spec-kit-coco-sk-code-research/research/deep-research-state.jsonl`

Format (NO pretty-print, single line, newline-terminated):
```json
{"type":"iteration","iteration":10,"newInfoRatio":<0..1>,"status":"<insight|stuck|converged>","focus":"<short>","findingsP0":<n>,"findingsP1":<n>,"findingsP2":<n>,"executor":{"kind":"cli-codex","model":"gpt-5.5","reasoningEffort":"high","serviceTier":"fast"}}
```
...
Write to: `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/077-spec-kit-coco-sk-code-research/research/deltas/iter-010.jsonl`

Contents — one JSON record per line:
```json
{"type":"iteration","iteration":10,"newInfoRatio":<0..1>,"status":"...","focus":"...","findingsP0":<n>,"findingsP1":<n>,"findingsP2":<n>}
{"type":"finding","id":"f-iter010-001","severity":"P1","label":"<short>","iteration":10,"surface":"system-spec-kit|mcp-coco-index|sk-code","evidence":"<file:line>"}
{"type":"observation","id":"obs-iter010-001","packet":"077","classification":"real","iteration":10}
{"type":"ruled_out","direction":"<approach>","reason":"<why>","iteration":10}
```
...
- This is iteration 10. After writing the 3 artifacts, STOP.
- Update strategy.md Section 11 (Next Focus) with the recommendation for iteration 11.

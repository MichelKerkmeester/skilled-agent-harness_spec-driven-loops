...
### Strict validate
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/108-sk-code-review-auto-review-uplift/001-h1-final-line-contract --strict` → exit 0 ✓

...
- Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/125-cli-external-parent --recursive --strict` and require a passing result for the whole parent packet.
...
|-----------|-------------|-------------|
| `.opencode/specs/skilled-agent-orchestration/125-cli-external-parent/description.json` | Modify | Refresh parent packet description metadata during closeout after validation evidence is available (execution-time only). |
| `.opencode/specs/skilled-agent-orchestration/125-cli-external-parent/graph-metadata.json` | Modify | Roll parent status to complete and set `derived.last_active_child_id` to `008` during the future execution pass (execution-time only). |
<!-- /ANCHOR:scope -->
...
| REQ-002 | Recursive strict spec validation passes for the whole parent packet. | `validate.sh .opencode/specs/skilled-agent-orchestration/125-cli-external-parent --recursive --strict` exits successfully. |

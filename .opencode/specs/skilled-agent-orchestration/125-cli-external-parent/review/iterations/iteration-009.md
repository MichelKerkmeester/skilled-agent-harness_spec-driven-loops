...
- `.opencode/specs/skilled-agent-orchestration/125-cli-external-parent/spec.md:86-115,126-154`
- `.opencode/specs/skilled-agent-orchestration/125-cli-external-parent/002-architecture-decision/decision-record.md:347-362,445-527`
- `.opencode/specs/skilled-agent-orchestration/125-cli-external-parent/004-onboard-cli-opencode/spec.md:103-148`
- `.opencode/specs/skilled-agent-orchestration/125-cli-external-parent/005-foldin-cli-claude-code/spec.md:105-153,181-206`
- `.opencode/specs/skilled-agent-orchestration/125-cli-external-parent/006-advisor-and-integration/spec.md:105-152`
...
- `checklist_evidence`: deferred. The configured review scope omits execution checklists and completed implementation evidence. [SOURCE: `.opencode/specs/skilled-agent-orchestration/125-cli-external-parent/review/deep-review-config.json:18-59`]

...
- Primary trace: `.opencode/specs/skilled-agent-orchestration/125-cli-external-parent/003-scaffold-hub/spec.md:104-105,121`, `.opencode/specs/skilled-agent-orchestration/125-cli-external-parent/005-foldin-cli-claude-code/spec.md:72,81-82,142-144`, and `.opencode/specs/skilled-agent-orchestration/125-cli-external-parent/002-architecture-decision/decision-record.md:347-362,445-463`.
...
- Evidence: Phase 003 explicitly creates the hub graph identity with `family: cli` [SOURCE: `.opencode/specs/skilled-agent-orchestration/125-cli-external-parent/003-scaffold-hub/spec.md:104-105,121`]. ADR-004 identifies `family: cli` as the condition that makes the existing scorer's family filter select the hub [SOURCE: `.opencode/specs/skilled-agent-orchestration/125-cli-external-parent/002-architecture-decision/decision-record.md:347-362`]. ADR-005 requires the scorer to change in the same atomic bundle as the identity dissolution [SOURCE: `.opencode/specs/skilled-agent-orchestration/125-cli-external-parent/002-architecture-decision/decision-record.md:445-463`], and phase 005 repeats that one-commit requirement [SOURCE: `.opencode/specs/skilled-agent-orchestration/125-cli-external-parent/005-foldin-cli-claude-code/spec.md:72,81-82,142-144`].

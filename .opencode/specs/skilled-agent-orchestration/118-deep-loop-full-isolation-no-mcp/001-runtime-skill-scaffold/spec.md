...
|-----------|-------------|-------------|
| `.opencode/specs/skilled-agent-orchestration/118-deep-loop-full-isolation-no-mcp/001-runtime-skill-scaffold/spec.md` | Create | This Level 2 spec packet doc. |
| `.opencode/specs/skilled-agent-orchestration/118-deep-loop-full-isolation-no-mcp/001-runtime-skill-scaffold/plan.md` | Create | Level 2 implementation plan. |
...
| `.opencode/specs/skilled-agent-orchestration/118-deep-loop-full-isolation-no-mcp/001-runtime-skill-scaffold/implementation-summary.md` | Create | Placeholder implementation summary with anchors. |
...
- **NFR-R02**: The scaffold must not break any existing skill or MCP tool: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/118-deep-loop-full-isolation-no-mcp --strict` must continue to PASS at the phase parent.
<!-- /ANCHOR:nfr -->

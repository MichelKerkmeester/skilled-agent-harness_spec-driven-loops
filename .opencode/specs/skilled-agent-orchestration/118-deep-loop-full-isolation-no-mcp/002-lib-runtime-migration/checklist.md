...
- [ ] CHK-050 [P1] No scratch files left in spec folder
  - **Evidence**: `ls .opencode/specs/skilled-agent-orchestration/118-deep-loop-full-isolation-no-mcp/002-lib-runtime-migration/` contains only the 7 scaffolded files

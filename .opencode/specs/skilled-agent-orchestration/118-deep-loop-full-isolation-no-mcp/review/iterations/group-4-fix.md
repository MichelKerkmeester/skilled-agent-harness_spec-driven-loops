...
## What Was Built
- `.opencode/skills/deep-loop-runtime/tests/_helpers/spawn-cjs.ts` — added async `spawnCjs(...)`, env-aware `runScript(...)`, and exported `runtimeRoot`.
...
```text
.opencode/skills/deep-loop-runtime/tests/_helpers/spawn-cjs.ts

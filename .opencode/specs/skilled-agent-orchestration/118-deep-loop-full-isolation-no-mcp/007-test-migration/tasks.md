...
- [ ] T050 Author `tests/_helpers/spawn-cjs.ts` shared helper (`spawn` wrapper returning `{ exit, stdout, stderr, parsedJson }`) [30m]
...
- [ ] T100 Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/118-deep-loop-full-isolation-no-mcp/007-test-migration --strict` and confirm exit 0 [5m]

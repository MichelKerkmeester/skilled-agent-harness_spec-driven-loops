...
- [x] CHK-031 [P0] Workflow-resolved spec_folder write authority held — evidence: every iteration prompt pinned `.opencode/specs/skilled-agent-orchestration/099-track-rereview/` as the only legal write target

...
- `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/` (phase parent)
- `.opencode/specs/skilled-agent-orchestration/098-097-remediation/` (phase parent + 7 sub-phases)
...
- Write iteration narrative to: .opencode/specs/skilled-agent-orchestration/099-track-rereview/review/iterations/iteration-008.md
- Write per-iteration delta file to: .opencode/specs/skilled-agent-orchestration/099-track-rereview/review/deltas/iter-008.jsonl

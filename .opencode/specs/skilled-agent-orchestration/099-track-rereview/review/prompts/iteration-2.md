...
Review Scope Files (this iteration's focus):
  - .opencode/specs/skilled-agent-orchestration/098-097-remediation/001-dist-rebuild/
  ...
  - .opencode/specs/skilled-agent-orchestration/098-097-remediation/002-sk-deep-token-replace/
  - .opencode/specs/skilled-agent-orchestration/098-097-remediation/003-narrative-validation-repair/
  - .opencode/specs/skilled-agent-orchestration/098-097-remediation/005-checklist-evidence/
  - .opencode/specs/skilled-agent-orchestration/098-097-remediation/006-skill-advisor-python/
  - .opencode/specs/skilled-agent-orchestration/098-097-remediation/007-p2-doc-drift/
...
- Config: .opencode/specs/skilled-agent-orchestration/099-track-rereview/review/deep-review-config.json
- State Log: .opencode/specs/skilled-agent-orchestration/099-track-rereview/review/deep-review-state.jsonl
- Findings Registry: .opencode/specs/skilled-agent-orchestration/099-track-rereview/review/deep-review-findings-registry.json
- Strategy: .opencode/specs/skilled-agent-orchestration/099-track-rereview/review/deep-review-strategy.md
- Write iteration narrative to: .opencode/specs/skilled-agent-orchestration/099-track-rereview/review/iterations/iteration-002.md
- Write per-iteration delta file to: .opencode/specs/skilled-agent-orchestration/099-track-rereview/review/deltas/iter-002.jsonl
...
- Workflow-resolved spec_folder is `.opencode/specs/skilled-agent-orchestration/099-track-rereview/` — that and `review/` underneath are the ONLY legal write targets. Do NOT touch any predecessor packet.

...
- `rg -l "TODO|FIXME|XXX" .opencode/specs/skilled-agent-orchestration/098-097-remediation/` for orphan TODOs
...
- Write iteration narrative to: .opencode/specs/skilled-agent-orchestration/099-track-rereview/review/iterations/iteration-010.md
- Write per-iteration delta file to: .opencode/specs/skilled-agent-orchestration/099-track-rereview/review/deltas/iter-010.jsonl

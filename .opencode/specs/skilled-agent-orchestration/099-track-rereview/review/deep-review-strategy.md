...
- `.opencode/specs/skilled-agent-orchestration/098-097-remediation/` (phase parent)
  - `001-dist-rebuild/` through `007-p2-doc-drift/`
- `.opencode/specs/skilled-agent-orchestration/097-track-review/review/review-report.md` (predecessor verdict)

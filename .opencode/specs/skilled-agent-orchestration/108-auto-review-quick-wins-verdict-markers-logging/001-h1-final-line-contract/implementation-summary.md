...
### Strict validate
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/108-auto-review-quick-wins-verdict-markers-logging/001-h1-final-line-contract --strict` → exit 0 ✓

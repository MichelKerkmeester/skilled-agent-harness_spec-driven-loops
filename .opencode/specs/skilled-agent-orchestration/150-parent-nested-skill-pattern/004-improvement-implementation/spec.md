...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/150-parent-nested-skill-pattern/004-improvement-implementation"
...
| **Phase** | 004 (parent: `150-parent-nested-skill-pattern`) |

---
title: "Changelog: Formalize the parent-nested-skill pattern [150-parent-nested-skill-pattern/003-formalize-pattern]"
...
> Spec folder: `.opencode/specs/skilled-agent-orchestration/150-parent-nested-skill-pattern/003-formalize-pattern` (Level 2)
...
| `.opencode/specs/skilled-agent-orchestration/150-parent-nested-skill-pattern/research/research.md` | Updated | Reconciled routing class from 3 to 4 by adding alias-fold. |

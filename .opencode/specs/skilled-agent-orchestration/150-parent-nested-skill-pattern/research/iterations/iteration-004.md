...
```json
{
  ...
  "key_findings": [
    ...
    },
    {
      ...
      "evidence": ".opencode/skills/deep-loop-workflows/deep-context/SKILL.md:1-8; .opencode/skills/deep-loop-workflows/ai-council/SKILL.md:1-8; .opencode/specs/skilled-agent-orchestration/150-parent-nested-skill-pattern/001-rename-fix-and-shared-decision/decision-record.md:90-98",
      "confidence": "high"
    },
    {

...
```json
{
  ...
  "key_findings": [
    ...
    },
    {
      ...
      "evidence": ".opencode/skills/system-skill-advisor/mcp_server/lib/skill-graph/skill-graph-db.ts:654-657; .opencode/specs/skilled-agent-orchestration/150-parent-nested-skill-pattern/001-rename-fix-and-shared-decision/decision-record.md:88-105",
      "confidence": "high"
    },
    {
      ...
      "evidence": ".opencode/skills/deep-loop-workflows/SKILL.md:77-86; .opencode/specs/skilled-agent-orchestration/150-parent-nested-skill-pattern/001-rename-fix-and-shared-decision/decision-record.md:92-99",
      "confidence": "high"
    }
  ],
  "risks": [

...
- The one-identity keystone is already documented and verified: packets carry no `graph-metadata.json`; only the hub does. Evidence: `.opencode/specs/skilled-agent-orchestration/147-deep-loop-workflows/003-merged-hub-and-mode-packets/implementation-summary.md:76-88`.
...
- Define a `parent-skill` pattern in `sk-doc`: one discoverable hub `graph-metadata.json`, one `mode-registry.json`, non-discoverable mode packets, optional non-discoverable `shared/`, and no per-mode graph metadata. Evidence: `.opencode/specs/skilled-agent-orchestration/150-parent-nested-skill-pattern/spec.md:57-71`, `.opencode/specs/skilled-agent-orchestration/150-parent-nested-skill-pattern/001-rename-fix-and-shared-decision/decision-record.md:67-70`.
- Ship `/create:parent-skill` with hub `SKILL.md`, registry, hub `graph-metadata.json`, packet directories, and shared helper scaffolding. Evidence: `.opencode/specs/skilled-agent-orchestration/150-parent-nested-skill-pattern/spec.md:71`.
- Ship `/doctor:parent-skill` to validate registry schema, alias uniqueness, Python/TS registry parity, no nested `graph-metadata.json`, packet folder/SKILL naming policy, freshness/watch inclusion, and routing parity fixtures. Evidence for required fixture preservation: `.opencode/specs/skilled-agent-orchestration/150-parent-nested-skill-pattern/spec.md:69-71`, `.opencode/skills/system-skill-advisor/mcp_server/tests/routing-parity-deep-skills.vitest.ts:52-67`.
- Add a routing/discovery benchmark that checks one-identity discovery, alias-to-mode precision, stale-registry invalidation, and no mode flattening. Evidence for phase charter: `.opencode/specs/skilled-agent-orchestration/150-parent-nested-skill-pattern/spec.md:69-71`, `.opencode/skills/deep-loop-workflows/README.md:21-28`.

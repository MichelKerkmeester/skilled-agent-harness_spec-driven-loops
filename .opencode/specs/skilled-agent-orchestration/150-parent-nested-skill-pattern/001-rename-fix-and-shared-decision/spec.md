...
| **Phase** | 001 (parent: `150-parent-nested-skill-pattern`) |
| **Depends on** | `../147-deep-loop-workflows` (the merge that created the parent skill) |
<!-- /ANCHOR:metadata -->
...
**Depends on:** `../147-deep-loop-workflows` (the parent skill must already exist in its merged form).

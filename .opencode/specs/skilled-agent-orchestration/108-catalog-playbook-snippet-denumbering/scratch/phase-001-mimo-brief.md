...
Spec folder: `.opencode/specs/skilled-agent-orchestration/z_archive/108-catalog-playbook-snippet-denumbering/001-sk-doc-standards-and-templates` — pre-approved at Gate 3. Do NOT ask about documentation or spec folders; it is already answered.

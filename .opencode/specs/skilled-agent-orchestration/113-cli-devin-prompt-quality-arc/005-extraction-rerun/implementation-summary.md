...
| Field | Value |
|-------|-------|
| **Spec Folder** | 113-cli-devin-prompt-quality-arc/005-extraction-rerun |
...
| strict-validate | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh 113-cli-devin-prompt-quality-arc/005-extraction-rerun --strict` | TO RUN |
<!-- /ANCHOR:verification -->

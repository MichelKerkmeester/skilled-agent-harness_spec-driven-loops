...
|-----------|-------------|-------------|
| `113-cli-devin-prompt-quality-arc/005-extraction-rerun/scripts/extract-files-from-markdown.cjs` | Create | Parse markdown → write files to fixture CWD |
| `113-cli-devin-prompt-quality-arc/002-eval-rig/scripts/score-variant.cjs` | Modify | Call extraction when env flag set; restore fixture CWD between variants |
| `113-cli-devin-prompt-quality-arc/005-extraction-rerun/state/eval-loop-state-v2.jsonl` | Create | New run's state (separate from 003's state.jsonl) |
| `113-cli-devin-prompt-quality-arc/005-extraction-rerun/iterations/iteration-NNN.md` | Create (5) | One per variant run |
| `113-cli-devin-prompt-quality-arc/005-extraction-rerun/synthesis-v2.md` | Create | New ranking + comparison vs 003 |
<!-- /ANCHOR:scope -->
...
**Acceptance Criteria**:
1. Given the extraction layer is built, When operator runs `node 113-cli-devin-prompt-quality-arc/005-extraction-rerun/scripts/loop-v2.cjs --real`, Then the loop dispatches 5 variants × 7 fixtures with extraction + live grader and exits with synthesis-v2.md written.

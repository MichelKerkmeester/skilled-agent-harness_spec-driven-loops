...
grep -E "path\.resolve|startsWith" "/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/113-cli-devin-prompt-quality-arc/002-eval-rig/fixtures/fix-006-adversarial-path-traversal/seed/read-config.cjs"

# Step 2: Verify malicious input is rejected (should exit non-zero)
cd "/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/113-cli-devin-prompt-quality-arc/002-eval-rig/fixtures/fix-006-adversarial-path-traversal/seed" && node read-config.cjs '../../../../etc/passwd'
echo "Exit code: $?"

# Step 3: Verify no naive unvalidated file reads
grep -E "fs\.readFileSync\([a-zA-Z_]+\)" "/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/113-cli-devin-prompt-quality-arc/002-eval-rig/fixtures/fix-006-adversarial-path-traversal/seed/read-config.cjs"

# Step 4: Test legitimate file access (should succeed)
cd "/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/113-cli-devin-prompt-quality-arc/002-eval-rig/fixtures/fix-006-adversarial-path-traversal/seed" && node read-config.cjs 'config.json'
```

...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/skilled-agent-orchestration/113-cli-devin-prompt-quality-arc/007-cross-model-validation/scripts/analyze-only.cjs"
      - ".opencode/specs/skilled-agent-orchestration/113-cli-devin-prompt-quality-arc/007-cross-model-validation/state/cross-model-results.jsonl"
    ...
    session_dedup:
      ...
      session_id: "main-agent-113-cli-devin-prompt-quality-arc/007-cross-model-validation"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 113-cli-devin-prompt-quality-arc/007-cross-model-validation |

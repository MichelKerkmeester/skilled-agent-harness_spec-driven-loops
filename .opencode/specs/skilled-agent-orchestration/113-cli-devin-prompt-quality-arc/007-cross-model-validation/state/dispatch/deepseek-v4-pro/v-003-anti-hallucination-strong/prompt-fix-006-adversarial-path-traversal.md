...
Working in `fixtures/fix-006-adversarial-path-traversal/seed`. Failure cluster: `Adversarial / security`. Grounded in: Skeptic seat S-4 insistence (adversarial coverage, blind-spot-3 mitigation, ≥1 path-traversal fixture).

...
```bash
cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/113-cli-devin-prompt-quality-arc/003-eval-loop/fixtures/fix-003-bundle-gate-smoke-run/seed && node scripts/check.cjs; echo "EXIT_CODE=$?"
```

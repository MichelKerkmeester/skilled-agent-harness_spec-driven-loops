...
_memory:
  continuity:
    ...
    next_safe_action: "Plan P1 from ../research roadmap (stats, dispatch envelope, loop-host hook)"
    blockers: []
    key_files: []
    session_dedup:
...
| `../research/research.md` P0 roadmap | Internal | Green | P0 scope (registry/renderer/validator/sweep/gate/reporter) is the design source |

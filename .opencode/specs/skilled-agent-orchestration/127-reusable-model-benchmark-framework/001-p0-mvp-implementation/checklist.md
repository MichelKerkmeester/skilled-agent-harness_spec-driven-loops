...
- [x] CHK-003 [P1] Dependencies identified and available
  - **Evidence**: existing `dispatch-model.cjs` mock mode + Lane B scorer consumed as-is; Node stdlib only (NFR-001); `../research/research.md` P0 roadmap is the design source
<!-- /ANCHOR:pre-impl -->

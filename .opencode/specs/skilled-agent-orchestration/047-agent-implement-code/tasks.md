...
- [x] **T001 [P0]** Scaffold child folder `059-agent-implement-code/` under parent `022-mcp-coco-integration/` (`.opencode/specs/skilled-agent-orchestration/z_archive/022-mcp-coco-integration/059-agent-implement-code/`)
...
- [ ] **T014 [P0]** Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/skilled-agent-orchestration/z_archive/047-agent-implement-code --strict` (exit 0 expected). [BLOCKED on Phase-1 template-header drift; resolved during Phase 3 by canonical-header rewrite of this file + checklist.md + implementation-summary.md and `ADR-D#` → `ADR-#: D# —` rename in decision-record.md.]
...
5. `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/skilled-agent-orchestration/z_archive/047-agent-implement-code --strict` exits 0.

...
- [x] [P0] Spec folder `059-agent-implement-code/` exists at parent path. [EVIDENCE: `specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/`]
...
- [x] [P0] description.json exists and is valid JSON. [EVIDENCE: `specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/description.json` parses cleanly.]
- [x] [P0] graph-metadata.json exists with required fields (status, purpose, children_ids, lastUpdated). [EVIDENCE: `specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/graph-metadata.json` carries the required keys.]

...
| **Parent** | `specs/skilled-agent-orchestration/z_archive/022-mcp-coco-integration/` (becomes phase parent on first child registration) |
<!-- /ANCHOR:metadata -->
...
| `.opencode/specs/skilled-agent-orchestration/z_archive/022-mcp-coco-integration/graph-metadata.json` | Modify | `children_ids` adds `059-agent-implement-code`; `derived.last_active_child_id` set |
| `.opencode/specs/skilled-agent-orchestration/z_archive/022-mcp-coco-integration/description.json` | Modify | Children registration |
| `.opencode/specs/skilled-agent-orchestration/z_archive/022-mcp-coco-integration/context-index.md` | Create | Phase-parent transition note (heavy docs at parent are tolerated; new work goes to children) |
<!-- /ANCHOR:scope -->

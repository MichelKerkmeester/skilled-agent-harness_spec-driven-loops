...
- `specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/research/synthesis.md` (D3 convention-floor; LEAF mechanism; stack-detection-in-skills; Bash-bypass warning)
...
3. **Validate** with `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/skilled-agent-orchestration/z_archive/047-agent-implement-code --strict` after applying.

...
- Config / State Log / Strategy / Registry: in `.opencode/specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/research/stream-02-opencode-swarm-main/`

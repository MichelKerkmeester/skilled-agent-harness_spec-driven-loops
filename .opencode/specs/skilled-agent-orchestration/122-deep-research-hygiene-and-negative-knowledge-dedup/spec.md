...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/122-deep-research-hygiene-and-negative-knowledge-dedup"
...
| `.opencode/specs/skilled-agent-orchestration/122-deep-research-hygiene-and-negative-knowledge-dedup/*` | Create | Level 2 packet documentation |
<!-- /ANCHOR:scope -->

...
| Field | Value |
|-------|-------|
| **Spec Folder** | 122-deep-research-hygiene-and-negative-knowledge-dedup |
...
| `.opencode/specs/skilled-agent-orchestration/122-deep-research-hygiene-and-negative-knowledge-dedup/` | Created | Level 2 packet docs |
<!-- /ANCHOR:what-built -->
...
| Packet strict validation | PASS: `validate.sh .../122-deep-research-hygiene-and-negative-knowledge-dedup --strict` |
...
.opencode/skills/deep-research/scripts/verify-yaml-script-paths.sh
.opencode/specs/skilled-agent-orchestration/122-deep-research-hygiene-and-negative-knowledge-dedup/spec.md
.opencode/specs/skilled-agent-orchestration/122-deep-research-hygiene-and-negative-knowledge-dedup/plan.md
.opencode/specs/skilled-agent-orchestration/122-deep-research-hygiene-and-negative-knowledge-dedup/tasks.md
.opencode/specs/skilled-agent-orchestration/122-deep-research-hygiene-and-negative-knowledge-dedup/checklist.md
.opencode/specs/skilled-agent-orchestration/122-deep-research-hygiene-and-negative-knowledge-dedup/implementation-summary.md
.opencode/specs/skilled-agent-orchestration/122-deep-research-hygiene-and-negative-knowledge-dedup/description.json
.opencode/specs/skilled-agent-orchestration/122-deep-research-hygiene-and-negative-knowledge-dedup/graph-metadata.json
```

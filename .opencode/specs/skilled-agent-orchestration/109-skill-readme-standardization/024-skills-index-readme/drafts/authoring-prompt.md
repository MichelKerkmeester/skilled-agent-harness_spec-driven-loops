Spec folder: skilled-agent-orchestration/z_archive/109-skill-readme-standardization/024-skills-index-readme (pre-approved, skip Gate 3). OUTPUT-ONLY task: do NOT write, create or edit any file. Return ONLY the finished README markdown in a single fenced ```markdown block as your final message. No preamble, no commentary.
...
- The factual catalog is in `.opencode/specs/skilled-agent-orchestration/z_archive/109-skill-readme-standardization/024-skills-index-readme/context/context-report.md`. Read it. The 22 skills, their five families and their one-line descriptions come from there.

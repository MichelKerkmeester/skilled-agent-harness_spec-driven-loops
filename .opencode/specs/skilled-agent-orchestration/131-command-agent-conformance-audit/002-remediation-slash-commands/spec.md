...
- **SC-004**: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/131-command-agent-conformance-audit/002-remediation-slash-commands --strict` exits 0, and the diff contains no file outside the 12-finding scope in §3.

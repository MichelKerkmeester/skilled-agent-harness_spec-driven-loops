...
- `.opencode/skill/sk-code/` exact security-token and unsafe-command search results
- `.opencode/agent/` public-agent exact search results
- `.opencode/command/spec_kit/` command/workflow exact search results
- `.opencode/skill/system-spec-kit/mcp_server/skill_advisor/scripts/` generated advisor artifact exact search results
...
- Security doctrine loaded from `.opencode/skill/sk-code-review/references/review_core.md`; severity definitions require P0 for exploitable security/auth/destructive data loss and P1 for must-fix gate issues. [SOURCE: `.opencode/skill/sk-code-review/references/review_core.md:20`]
...
- Historical references to `.opencode/skill/sk-code-opencode/` remain expected inside the spec packet/resource map and were not treated as live public surface leaks.

...
```bash
cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/114-cli-devin-swe16-prompt-optimization/003-eval-loop/fixtures/fix-003-bundle-gate-smoke-run/seed && node scripts/check.cjs; echo "EXIT_CODE=$?"
```

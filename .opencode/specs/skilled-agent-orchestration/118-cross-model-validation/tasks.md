...
description: "Tracks planned packet 118 work for a confirm-only cross-model validation harness. No harness implementation has started in this packet state."
trigger_phrases:
  - "118 validation tasks"
...
- [ ] T003 Inventory 114/002 fixture ids and 114/003 variant ids
...
- [ ] T005 Create `.opencode/specs/skilled-agent-orchestration/118-cross-model-validation/scripts/cross-model-confirm.cjs`
- [ ] T006 Wire cli-opencode dispatch for both model routes
- [ ] T007 Reuse 116 `extract()` before D1 acceptance scoring
- [ ] T008 Reuse 114/003 `scoreVariantFixture()` for weighted scoring
- [ ] T009 Write append-only or resumable results under packet 118 state
...
- [ ] T014 Record propagation recommendation in packet 118 analysis and implementation summary
<!-- /ANCHOR:phase-3 -->

...
description: "Planning-state checklist for packet 118. Items remain pending until the confirm harness is built, run, and analyzed."
trigger_phrases:
...
- [ ] CHK-FIX-002 [P0] Same-class producer inventory covers the 114/003 variants under test.
- [ ] CHK-FIX-003 [P0] Consumer inventory covers packet 117 held propagation decisions and future CLI prompt cards.
- [ ] CHK-FIX-004 [P0] Security/path/parser/redaction cases inherit coverage from 116 extraction and fixture deterministic checks where applicable.
...
- [ ] CHK-051 [P1] Result state stays under packet 118 state or scratch paths
<!-- /ANCHOR:file-org -->

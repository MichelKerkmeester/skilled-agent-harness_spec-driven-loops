...
| REQ-004 | No 4-runtime mirror writes | `git status` shows no changes outside `.opencode/skills/cli-devin/` AND `.opencode/specs/...114/004-skill-uplift/` |

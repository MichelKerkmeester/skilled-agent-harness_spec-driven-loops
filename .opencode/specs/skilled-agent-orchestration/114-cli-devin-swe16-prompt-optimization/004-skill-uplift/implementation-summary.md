...
| REQ-002: each diff cites synthesis | All 4 modified/new files reference `specs/skilled-agent-orchestration/114-cli-devin-swe16-prompt-optimization/003-eval-loop/synthesis.md` with empirical scores quoted inline | PASS |
...
| REQ-006: strict-validate packet | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/114-cli-devin-swe16-prompt-optimization/004-skill-uplift --strict` | TO RUN |

---
title: "Implementation Plan: mk-goal audit"
description: "The read-only audit approach for mk-goal and its Claude hook version."
trigger_phrases:
  - "mk-goal audit"
  - "mk-goal review"
...
_memory:
  continuity:
    ...
    recent_action: "Executed read-only audit of mk-goal"
    ...
    answered_questions: []
---
# Implementation Plan: mk-goal audit
...
### Overview
Dispatch one read-only GPT-5.6-Sol-Fast auditor over `.opencode/plugins/mk-goal.js` plus its Claude hook version, capturing structured findings on correctness, parity, and refinements.
<!-- /ANCHOR:summary -->
...
|---------|--------------|--------|--------------|
| `.opencode/plugins/mk-goal.js` | /goal session-goal plugin | audited (no change) | `review/review-report.md` (13 findings) |
<!-- /ANCHOR:affected-surfaces -->

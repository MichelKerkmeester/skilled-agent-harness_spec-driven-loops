---
title: "Implementation Plan: mk-skill-advisor audit"
description: "The read-only audit approach for mk-skill-advisor and its Claude hook version."
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "Executed read-only audit of mk-skill-advisor"
    ...
    answered_questions: []
---
# Implementation Plan: mk-skill-advisor audit
...
### Overview
Dispatch one read-only GPT-5.6-Sol-Fast auditor over `.opencode/plugins/mk-skill-advisor.js` plus its Claude hook version, capturing structured findings on correctness, parity, and refinements.
<!-- /ANCHOR:summary -->
...
|---------|--------------|--------|--------------|
| `.opencode/plugins/mk-skill-advisor.js` | Skill Advisor prompt-time plugin | audited (no change) | `review/review-report.md` (12 findings) |
<!-- /ANCHOR:affected-surfaces -->

---
title: "Tasks: mk-skill-advisor audit"
...
_memory:
  continuity:
    ...
    recent_action: "Audit of mk-skill-advisor complete"
...
<!-- ANCHOR:phase-1 -->
## Phase 1: Setup
- [x] T001 Identify `mk-skill-advisor` + its Claude hook counterpart [evidence: mapping in `review/review-report.md`]
<!-- /ANCHOR:phase-1 -->
...
- [x] T002 Audit `.opencode/plugins/mk-skill-advisor.js` + Claude hook (read-only) [evidence: 12 findings in `review/review-report.md`]
<!-- /ANCHOR:phase-2 -->

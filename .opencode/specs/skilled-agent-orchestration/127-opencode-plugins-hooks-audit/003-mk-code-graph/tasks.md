---
title: "Tasks: mk-code-graph audit"
...
_memory:
  continuity:
    ...
    recent_action: "Audit of mk-code-graph complete"
...
<!-- ANCHOR:phase-1 -->
## Phase 1: Setup
- [x] T001 Identify `mk-code-graph` + its Claude hook counterpart [evidence: mapping in `review/review-report.md`]
<!-- /ANCHOR:phase-1 -->
...
- [x] T002 Audit `.opencode/plugins/mk-code-graph.js` + Claude hook (read-only) [evidence: 8 findings in `review/review-report.md`]
<!-- /ANCHOR:phase-2 -->

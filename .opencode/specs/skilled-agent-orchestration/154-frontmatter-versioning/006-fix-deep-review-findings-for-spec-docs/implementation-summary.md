...
| File | Action | Purpose |
|------|--------|---------|
| `154-frontmatter-versioning/spec.md` (parent) | Modified | Real counts, execution-model wording, 3-part note, phase-6 row |
| `154-frontmatter-versioning/00{1..5}/spec.md` | Modified | completion_pct 100, real recent-action, .ts to .mjs |
| `154-frontmatter-versioning/00{1..5}/{plan,tasks}.md` | Modified | Populated from implementation summaries |
| `154-frontmatter-versioning/006-.../{spec,plan,tasks,implementation-summary}.md` | Created | This remediation phase |
| `154-frontmatter-versioning/**/graph-metadata.json` and `description.json` | Modified | Regenerated via backfill and generate-context |

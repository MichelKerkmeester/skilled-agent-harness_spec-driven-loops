...
description: Review strategy for 154-frontmatter-versioning spec folder
...
## topic
Review of Skill Frontmatter Versioning (154-frontmatter-versioning) — a phase-parent spec with 5 child phases that retroactively versions ~2,500 skill-doc frontmatter files and enforces a 4-part `version: X.Y.Z.W` standard.

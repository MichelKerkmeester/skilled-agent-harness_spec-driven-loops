...
### Definition of Ready
- [x] Parent skill exists in its merged form (`../152-deep-loop-workflows` complete).
...
|------------|------|--------|-------------------|
| `../152-deep-loop-workflows` | Internal epic | Complete | The parent skill must exist in merged form |
...
|-------|------------|--------|
| Setup | `../152-deep-loop-workflows` + on-disk rename | Core Implementation |

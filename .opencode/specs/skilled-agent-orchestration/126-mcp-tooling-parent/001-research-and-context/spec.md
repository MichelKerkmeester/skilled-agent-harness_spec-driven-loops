...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/126-mcp-tooling-parent/001-research-and-context"
    ...
    key_files:
      ...
      - ".opencode/specs/skilled-agent-orchestration/126-mcp-tooling-parent/001-research-and-context/tasks.md"
    session_dedup:
...
|-----------|-------------|-------------|
| `.opencode/specs/skilled-agent-orchestration/126-mcp-tooling-parent/001-research-and-context/spec.md` | Modify | Define the phase 001 read-only research scope and acceptance criteria |
| `.opencode/specs/skilled-agent-orchestration/126-mcp-tooling-parent/001-research-and-context/plan.md` | Modify | Plan the skill-state pass, transport-eligibility pass, and referrer inventory pass |
| `.opencode/specs/skilled-agent-orchestration/126-mcp-tooling-parent/001-research-and-context/tasks.md` | Modify | Track the scoped research-gate tasks pending human review |
<!-- /ANCHOR:scope -->
...
- **SC-002**: Zero files outside `.opencode/specs/skilled-agent-orchestration/126-mcp-tooling-parent/001-research-and-context/` are touched during this phase.
<!-- /ANCHOR:success-criteria -->

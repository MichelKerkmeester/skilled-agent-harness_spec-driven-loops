...
| `.opencode/specs/skilled-agent-orchestration/126-mcp-tooling-parent/graph-metadata.json` | Modify | Parent rollup: status and `last_active_child_id` reconciliation |
<!-- /ANCHOR:scope -->

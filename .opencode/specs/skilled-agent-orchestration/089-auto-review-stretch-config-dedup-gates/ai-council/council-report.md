...
- Phase 3 `003-deep-review-uplift`: HIGH. Existing synthesis already deduplicates by `file:line + normalized_title` in `.opencode/commands/deep/assets/deep_start-review-loop_auto.yaml:1115` through `.opencode/commands/deep/assets/deep_start-review-loop_auto.yaml:1124`, so H-7 should extend that contract rather than invent a disconnected path. H-9 needs a concrete evidence producer before implementation.
...
- Phase 3 evidence: deep-review's prompt pack starts with the shipped `DEEP-REVIEW` marker at `.opencode/skills/deep-review/assets/prompt_pack_iteration.md.tmpl:1`, and its current prompt context is state/metadata rather than embedded full-file contents at `.opencode/skills/deep-review/assets/prompt_pack_iteration.md.tmpl:7` through `.opencode/skills/deep-review/assets/prompt_pack_iteration.md.tmpl:17`. The auto dispatcher renders that template with variables at `.opencode/commands/deep/assets/deep_start-review-loop_auto.yaml:654` through `.opencode/commands/deep/assets/deep_start-review-loop_auto.yaml:670`; the confirm dispatcher mirrors that at `.opencode/commands/deep/assets/deep_start-review-loop_confirm.yaml:654` through `.opencode/commands/deep/assets/deep_start-review-loop_confirm.yaml:662`.
- Phase 3 evidence: final verdict derivation from packet 108 is already present in auto mode at `.opencode/commands/deep/assets/deep_start-review-loop_auto.yaml:1088` through `.opencode/commands/deep/assets/deep_start-review-loop_auto.yaml:1108` and confirm mode at `.opencode/commands/deep/assets/deep_start-review-loop_confirm.yaml:1039` through `.opencode/commands/deep/assets/deep_start-review-loop_confirm.yaml:1059`. H-7 should avoid conflicting with that existing synthesis flow.

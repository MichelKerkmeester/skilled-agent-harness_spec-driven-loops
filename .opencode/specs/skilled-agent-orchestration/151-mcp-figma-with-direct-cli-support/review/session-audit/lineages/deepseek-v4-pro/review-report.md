...
| F007 | P2 | traceability | Phase-parent spec uses zero-fingerprint session_dedup placeholder | `.opencode/specs/.../151-mcp-figma-with-direct-cli-support/spec.md:20` | 3 | active |

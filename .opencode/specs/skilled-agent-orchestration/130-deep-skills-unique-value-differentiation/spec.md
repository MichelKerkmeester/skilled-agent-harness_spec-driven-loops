...
|-----------|-------------|-------------|
| `.opencode/specs/skilled-agent-orchestration/130-*/research/` | Create | deep-research iteration outputs |
| `.opencode/specs/skilled-agent-orchestration/130-*/research/research.md` | Create | synthesized recommendations |
| `.opencode/specs/skilled-agent-orchestration/130-*/decision-record.md` | Create | ADRs from synthesis |
| `.opencode/specs/skilled-agent-orchestration/130-*/implementation-summary.md` | Create | completion record |
<!-- /ANCHOR:scope -->
...
- **Sibling**: `../129-deep-ai-council-iterative-multi-topic/` (upgrades sk-ai-council into deep-council, which this packet analyzes for differentiation)

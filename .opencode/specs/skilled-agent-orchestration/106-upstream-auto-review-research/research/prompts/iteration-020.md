...
for N in 001 002 003 004 005 006 007 008 009 010 011 012 013 014 015 016 017 018 019; do
  L=$(wc -l < .opencode/specs/skilled-agent-orchestration/106-upstream-auto-review-research/research/iterations/iteration-$N.md 2>/dev/null || echo 0)
  echo "iter-$N: $L lines"
done
```
...
Write the file at `.opencode/specs/skilled-agent-orchestration/106-upstream-auto-review-research/research/review-report.md`.
...
**Packet**: `skilled-agent-orchestration/106-upstream-auto-review-research`
...
rg -A 50 'TEACHINGS' .opencode/specs/skilled-agent-orchestration/106-upstream-auto-review-research/research/iterations/iteration-019.md 2>/dev/null | head -60
```

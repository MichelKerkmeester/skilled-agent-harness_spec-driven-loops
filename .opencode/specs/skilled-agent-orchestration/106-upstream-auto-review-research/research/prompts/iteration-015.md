...
```bash
sed -n '1,200p' .opencode/specs/skilled-agent-orchestration/106-upstream-auto-review-research/research/iterations/iteration-008.md
sed -n '1,200p' .opencode/specs/skilled-agent-orchestration/106-upstream-auto-review-research/research/iterations/iteration-010.md

...
```bash
# Reuse pinned SHA
SHA=$(rg -oP 'PINNED_UPSTREAM_SHA:\s*\K[0-9a-f]{40}' .opencode/specs/skilled-agent-orchestration/106-upstream-auto-review-research/research/iterations/iteration-001.md 2>/dev/null | head -1)
echo "USING_SHA=$SHA"

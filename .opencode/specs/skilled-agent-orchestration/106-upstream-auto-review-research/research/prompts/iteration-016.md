...
for N in 007 008 009 010 011 012 013 014 015; do
  echo "=== iter-$N summary ==="
  rg -A 4 '^## Summary' .opencode/specs/skilled-agent-orchestration/106-upstream-auto-review-research/research/iterations/iteration-$N.md 2>/dev/null
done
```
...
for N in 007 008 009 010 011 012 013 014 015; do
  ...
  rg -A 3 '^## Findings' .opencode/specs/skilled-agent-orchestration/106-upstream-auto-review-research/research/iterations/iteration-$N.md 2>/dev/null
done
```

---
title: "Tasks: @review Agent Optimization"
...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/z_archive/048-agent-optimization/004-agent-review"
    ...
    answered_questions: []
---
# Tasks: @review Agent Optimization
...
- `/deep:start-agent-improvement-loop .opencode/agents/review.md :confirm --spec-folder=specs/skilled-agent-orchestration/z_archive/048-agent-optimization/004-agent-review`
<!-- /ANCHOR:phase-1 -->
...
- Sync to `.claude/agents/review.md`, `.gemini/agents/review.md`, `.codex/agents/review.toml`

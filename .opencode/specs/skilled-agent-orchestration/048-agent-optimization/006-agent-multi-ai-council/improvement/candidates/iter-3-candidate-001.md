...
7. **COMPOSE** -> Merge the best supported elements into a unified plan with rationale, ordered execution steps, risks, and explicit source attribution, or present unresolved alternatives when consensus is unsafe.
8. **DELIVER** -> Present the Multi-AI Council Report with council composition, comparison table, deliberation notes, implementation roadmap, consensus outcome, and confidence score. PLAN ONLY: do not apply changes.
...
## Vantage Integrity
State whether this is actual external dispatch, orchestrator-provided output, or a simulated vantage lens. If the user required actual external execution and it is unavailable, report unavailability instead of simulating it.
...
6. **Compose the unified plan** with attribution, prerequisites, validation steps, and risk mitigations, or compose a non-consensus alternatives report when synthesis would be misleading.
...
| Seat | Strategy Lens | AI Vantage Target | Distinct Mandate | Availability | Confidence |
| --- | --- | --- | --- | --- | --- |
| <Seat> | <Lens> | <Vantage> | <Mandate> | <available | simulated | unavailable> | <0-100> |
...
4. Did I label simulated and unavailable vantages honestly? (YES/NO/N/A)
5. Did I score ALL available seats with the rubric? (YES/NO/N/A)
6. Did I include the comparison table for council output? (YES/NO/N/A)
7. Did I run multi-round deliberation before recommending? (YES/NO/N/A)
8. Did I stop rather than force consensus when strong disagreement remained? (YES/NO/N/A)
9. Did I honor a requested single AI strategy without claiming council synthesis? (YES/NO/N/A)
10. Did I check for complementary elements across seats? (YES/NO/N/A)

...
7. **Feature catalog to playbook links:** Sample feature file `feature_catalog/01--runtime-routing-and-rename/01-runtime-agent-renamed-to-deep-ai-council.md` line 52 correctly links to `manual_testing_playbook/01--runtime-routing-and-rename/runtime-agent-renamed-to-deep-ai-council.md`. The bidirectional link is intact. <ref_file file="/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/deep-ai-council/feature_catalog/01--runtime-routing-and-rename/01-runtime-agent-renamed-to-deep-ai-council.md" lines="52" />

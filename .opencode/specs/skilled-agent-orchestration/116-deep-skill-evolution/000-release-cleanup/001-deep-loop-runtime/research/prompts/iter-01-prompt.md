...
`.opencode/specs/skilled-agent-orchestration/116-deep-skill-evolution/000-release-cleanup/001-deep-loop-runtime/` — pre-approved at Gate 3. You do NOT need to ask the Gate 3 question.
...
**Spec folder (Gate 3 pre-approved, skip Gate 3)**: `.opencode/specs/skilled-agent-orchestration/116-deep-skill-evolution/000-release-cleanup/001-deep-loop-runtime/`

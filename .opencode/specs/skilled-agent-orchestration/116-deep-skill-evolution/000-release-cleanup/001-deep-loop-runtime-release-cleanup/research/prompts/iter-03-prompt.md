...
- **HC-6**: `.opencode/skills/system-code-graph/manual_testing_playbook/05--coverage-graph/009-deep-loop-graph-convergence-yaml-fire.md` — playbook scenario documenting exact convergence yaml-fire pattern. Integration_points.md §5 only lists feature_catalog references, NOT playbook scenarios.

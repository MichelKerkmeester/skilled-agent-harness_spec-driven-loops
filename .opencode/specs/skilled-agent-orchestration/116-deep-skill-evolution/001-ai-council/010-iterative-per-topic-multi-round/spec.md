---
title: "Feature Specification: Per-Topic Multi-Round Orchestration"
...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/116-deep-skill-evolution/001-ai-council/010-iterative-per-topic-multi-round"
    ...
    answered_questions: []
---
# Feature Specification: Per-Topic Multi-Round Orchestration
...
| **Successor** | `004-multi-topic-session-and-findings-registry/` |
<!-- /ANCHOR:metadata -->
...
Implement a topic-local multi-round loop with verdict-delta convergence and max-round handling.

### Purpose

Implement the phase slice defined by ADR-002 and ADR-003, leaving unrelated packet work to later phases.
<!-- /ANCHOR:problem -->
...
|----|-------------|---------------------|
| REQ-001 | Honor ADR-002 and ADR-003 | Implementation cites the relevant ADR in summary. |

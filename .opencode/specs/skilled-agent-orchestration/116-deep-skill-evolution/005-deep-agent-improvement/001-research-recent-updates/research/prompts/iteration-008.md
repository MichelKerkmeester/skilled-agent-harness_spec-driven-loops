...
`.opencode/specs/skilled-agent-orchestration/116-deep-skill-evolution/037-deep-agent-improvement-research-recent-updates/research/iterations/iteration-008.md` + `.../deltas/iter-008.jsonl`.

...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/116-deep-skill-evolution/006-deep-skills-differentiation"
...
This cluster groups 1 sub-phases that share a single thematic focus. Before restructuring, these existed as flat siblings at the root of `116-deep-skill-evolution/`. Nesting them under this thematic phase parent reduces root-level fan-out and makes the cluster's internal arc easier to follow.
...
- Use `/speckit:resume skilled-agent-orchestration/116-deep-skill-evolution/006-deep-skills-differentiation/[NNN-phase]/` to resume a specific phase

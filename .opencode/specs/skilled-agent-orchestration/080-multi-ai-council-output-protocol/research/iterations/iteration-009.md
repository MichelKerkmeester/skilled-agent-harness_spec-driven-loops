...
The amended plan correctly identifies four caller patterns: top-level Task dispatch, `@orchestrate` Depth 1 dispatch, future `/spec_kit:*` command YAMLs, and CLI-skill manual dispatch at `.opencode/specs/skilled-agent-orchestration/080-multi-ai-council-output-protocol/ai-council/council-report.md:129` through `.opencode/specs/skilled-agent-orchestration/080-multi-ai-council-output-protocol/ai-council/council-report.md:138`. `@orchestrate` confirms `@multi-ai-council` is a LEAF target at `.opencode/agent/orchestrate.md:97`, with LEAF agents prohibited from sub-dispatch at `.opencode/agent/orchestrate.md:111` through `.opencode/agent/orchestrate.md:121` and reinforced at `.opencode/agent/orchestrate.md:748` through `.opencode/agent/orchestrate.md:749`.
...
The current agent body says the council must not modify files and the final report is planning-only at `.opencode/agent/multi-ai-council.md:460` through `.opencode/agent/multi-ai-council.md:463`, and the summary repeats "No file writes, edits, patches, or shell execution" at `.opencode/agent/multi-ai-council.md:684` through `.opencode/agent/multi-ai-council.md:687`. The smoke-test council report also records that the dispatching orchestrator wrote artifacts while `@multi-ai-council` retained `write: deny` at `.opencode/specs/skilled-agent-orchestration/080-multi-ai-council-output-protocol/ai-council/council-report.md:120` through `.opencode/specs/skilled-agent-orchestration/080-multi-ai-council-output-protocol/ai-council/council-report.md:121`.

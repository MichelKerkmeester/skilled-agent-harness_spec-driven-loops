...
- **system-spec-kit**: Hosts validators and templates. Round-1's location for the helper at `.opencode/skill/system-spec-kit/scripts/multi-ai-council/` is correct architecturally (centralizes spec-folder lifecycle scripts). ✓

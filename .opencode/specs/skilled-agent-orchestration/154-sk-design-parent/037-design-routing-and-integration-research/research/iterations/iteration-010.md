...
1. Reviewed the last D2 iteration results and state log so this pass would not duplicate the existing command-surface findings. D2-3 already covered sibling discriminators, D2-4 deliverable shape, and D2-5 preconditions/failure modes. [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/037-design-routing-and-integration-research/research/iterations/iteration-007.md:16] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/037-design-routing-and-integration-research/research/iterations/iteration-008.md:14] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/037-design-routing-and-integration-research/research/iterations/iteration-009.md:103]
...
4. Compared `impeccable-main` as the D2 corpus: its public command catalog is phrased as jobs and outcomes, while internal phases and references sit behind those commands. [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/README.md:40] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/skill/SKILL.src.md:122] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/site/content/skills/craft.md:47]

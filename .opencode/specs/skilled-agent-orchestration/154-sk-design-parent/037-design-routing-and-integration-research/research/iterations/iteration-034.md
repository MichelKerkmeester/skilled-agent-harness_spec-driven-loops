...
1. Re-read the active strategy and prior D4 iterations to avoid re-covering the direct MCP and Bash CLI bypass work. Prior work already established that mutating MCP calls need a tool-bound `skDesignGate`, and `daemon-cli.mjs` write verbs need a parser-backed Bash precondition. [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/037-design-routing-and-integration-research/research/iterations/iteration-032.md:17] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/037-design-routing-and-integration-research/research/iterations/iteration-033.md:47]

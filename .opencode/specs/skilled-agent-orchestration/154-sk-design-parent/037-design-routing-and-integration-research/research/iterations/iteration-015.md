...
4. Checked `impeccable-main` for the corpus pattern: it has one invocable design skill with subcommands, a source command metadata file, generated provider outputs, and build validation around generated surfaces. [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/CLAUDE.md:5] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/CLAUDE.md:10] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/CLAUDE.md:121] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/CLAUDE.md:283]
...
- `impeccable-main` documents one user-invocable skill with 23 commands underneath it, which is the same command-visible-under-one-family shape this research is pushing toward for `sk-design`. [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/CLAUDE.md:5]
- The corpus explicitly names `skill/scripts/command-metadata.json` as the single source of truth for each command's description and argument hint, read by both the build and pin script. [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/CLAUDE.md:10]
- The actual corpus metadata file stores `description` and `argumentHint` per command, for example `craft`, `audit`, and `polish`. [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/skill/scripts/command-metadata.json:2] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/skill/scripts/command-metadata.json:3] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/skill/scripts/command-metadata.json:4] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/skill/scripts/command-metadata.json:30] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/skill/scripts/command-metadata.json:31] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/skill/scripts/command-metadata.json:32] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/skill/scripts/command-metadata.json:78] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/skill/scripts/command-metadata.json:79] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/skill/scripts/command-metadata.json:80]
- The corpus also documents generated provider output as generated artifacts and requires `bun run build` after skill, transformer, site count, or provider behavior changes. [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/CLAUDE.md:117] [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable-main/CLAUDE.md:121]

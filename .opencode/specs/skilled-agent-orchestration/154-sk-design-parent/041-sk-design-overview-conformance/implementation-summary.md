...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/154-sk-design-parent/041-sk-design-overview-conformance"
...
| **Level** | 2 |
| **Parent** | skilled-agent-orchestration/154-sk-design-parent |
<!-- /ANCHOR:metadata -->

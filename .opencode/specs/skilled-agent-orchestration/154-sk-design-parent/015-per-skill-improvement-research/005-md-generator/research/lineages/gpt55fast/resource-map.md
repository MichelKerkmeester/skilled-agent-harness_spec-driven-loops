...
| `.opencode/specs/skilled-agent-orchestration/154-sk-design-parent/009-reference-asset-expansion/research/research.md` | Prior corpus synthesis and md-generator recommendations |
| `.opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/stitch-skill.md` | Forward-authoring contrast source |
| `.opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/impeccable.md` | External design workflow/routing contrast source |
| `.opencode/specs/skilled-agent-orchestration/154-sk-design-parent/014-routing-benchmark` | Expected benchmark location; no artifact present in checkout |

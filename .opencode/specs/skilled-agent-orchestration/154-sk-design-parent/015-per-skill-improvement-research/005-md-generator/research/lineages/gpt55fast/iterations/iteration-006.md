...
- The external Stitch corpus is a useful contrast because it author-generates DESIGN.md from a brief [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/external/stitch-skill.md:17-25], but the md-generator boundary explicitly routes that out of scope [SOURCE: .opencode/skills/sk-design/design-md-generator/references/authoring_boundary.md:86-99].
- Prior synthesis rejected bulk corpus import, second backend, forward authoring, and taxonomy changes [SOURCE: .opencode/specs/skilled-agent-orchestration/154-sk-design-parent/009-reference-asset-expansion/research/research.md:158-176].

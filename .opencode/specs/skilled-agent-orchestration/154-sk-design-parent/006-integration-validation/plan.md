...
| Recursive validation | Parent + all phase children validate as one unit | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/154-sk-design-parent --recursive` |

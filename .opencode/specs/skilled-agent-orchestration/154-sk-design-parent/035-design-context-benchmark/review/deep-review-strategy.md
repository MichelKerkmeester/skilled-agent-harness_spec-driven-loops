...
- `.opencode/specs/skilled-agent-orchestration/154-sk-design-parent/029-design-context-loading/research/research.md`.
- `.opencode/specs/skilled-agent-orchestration/154-sk-design-parent/030-design-context-adoption/{spec,plan,tasks,implementation-summary}.md`.

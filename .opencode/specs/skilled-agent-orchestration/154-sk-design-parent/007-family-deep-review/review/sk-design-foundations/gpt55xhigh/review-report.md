...
| --- | --- | --- | --- | --- | --- |
| F001 | P1 | traceability | Strict validation acceptance claim fails on the target child | `.opencode/specs/skilled-agent-orchestration/154-sk-design-parent/005-build-subskills/spec.md:155`; `.opencode/specs/skilled-agent-orchestration/154-sk-design-parent/005-build-subskills/implementation-summary.md:130-138`; `.opencode/skills/system-spec-kit/scripts/spec/validate.sh:100-115`; `logs/validation-and-advisor-evidence.md:3-8` | active |
...
| --- | --- | --- | --- |
| spec_code | hard | fail | F001 contradicts `.opencode/specs/skilled-agent-orchestration/154-sk-design-parent/005-build-subskills/spec.md:155`. |

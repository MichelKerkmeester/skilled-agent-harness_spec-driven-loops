...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results"
    ...
    key_files:
      - "specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/001-skill-reindex/"
      - "specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/002-skill-router-stress-tests/"
...
- `specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/001-skill-reindex/{pre,post}-snapshot.json` — advisor + skill graph state captures
- `specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/001-skill-reindex/reindex-diff.md` — pre/post comparison report
- `specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/002-skill-router-stress-tests/scenarios/CP-1{00..05}-*.md` — 6 CP scenario files
- `specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/002-skill-router-stress-tests/results/CP-1{00..05}-{copilot,codex,gemini}.json` — up to 18 result captures
- `specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/002-skill-router-stress-tests/test-report.md` — aggregate findings + lessons + recommendations
- `specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/implementation-summary.md` — baseline roll-up
...
- Change parent `graph-metadata.json` `derived.last_active_child_id` to `skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/002-skill-router-stress-tests` and `derived.session_outcome` to `ready_for_002`.
- Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test --strict`.
...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test --strict` -> passed.
...
**Working directory:** `specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/001-skill-reindex/`
...
mkdir -p specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/001-skill-reindex/.snapshot-pre
for p in "${PROMPTS[@]}"; do
  slug=$(echo "$p" | tr ' ' '_')
  python3 .opencode/skills/system-spec-kit/mcp_server/skill_advisor/scripts/skill_advisor.py "$p" --threshold 0.0 \
    > "specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/001-skill-reindex/.snapshot-pre/${slug}.json"
done
```
...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/001-skill-reindex --strict
```
...
```bash
# Edit specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/graph-metadata.json:
...
**Working directory:** `specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/002-skill-router-stress-tests/`

#### T-001: Verify GO signal

```bash
grep -i "GO_SIGNAL.*GO" \
  specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/001-skill-reindex/implementation-summary.md
```
...
```bash
ls specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/002-skill-router-stress-tests/results/CP-1{00,01,02,03,04,05}-{copilot,codex,gemini}.json | wc -l
...
```bash
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/002-skill-router-stress-tests --strict
```
...
1. Copy: `cp specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/templates/parent-roll-up-template.md specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/implementation-summary.md`
...
```bash
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test --strict
# Should auto-recurse and validate all 3 folders
```

#### Commit + push
```bash
git add -A specs/skilled-agent-orchestration/z_archive/051-skill-advisor-reindex-and-stress-test/

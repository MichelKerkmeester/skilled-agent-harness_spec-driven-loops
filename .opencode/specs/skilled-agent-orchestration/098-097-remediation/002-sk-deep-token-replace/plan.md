...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/098-097-remediation/002-sk-deep-token-replace"
...
|-------|------------|--------|
| 002 sk-deep-token-replace | `skilled-agent-orchestration/098-097-remediation/001-dist-rebuild` | Parent completion and final review rerun |

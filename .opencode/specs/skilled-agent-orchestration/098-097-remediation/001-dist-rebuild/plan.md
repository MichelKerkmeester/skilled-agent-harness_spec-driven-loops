...
|------------|------|--------|-------------------|
| `skilled-agent-orchestration/097-track-review` | Phase | Required | Cannot complete this phase truthfully |
...
|-------|------------|--------|
| 001 dist-rebuild | `skilled-agent-orchestration/097-track-review` | Parent completion and final review rerun |

---
title: "Implementation Plan: Phase 003 - narrative validation repair"
...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/098-097-remediation/003-narrative-validation-repair"
    ...
    blockers: []
    key_files:
      - ".opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/spec.md"
      - ".opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/004-symlinks/spec.md"
      - ".opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/001-skills/spec.md"
      - ".opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/002-agents/spec.md"
    session_dedup:
    ...
    answered_questions: []
---
# Implementation Plan: Phase 003 - narrative validation repair
...
- [x] Findings mapped: P1-004, P1-010, P1-013
...
|---------|--------|-------|
| `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/spec.md` | Modify | See phase scope |
| `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/004-symlinks/spec.md` | Modify | See phase scope |
| `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/001-skills/spec.md` | Modify | See phase scope |
| `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/002-agents/spec.md` | Modify | See phase scope |
| `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/003-commands/spec.md` | Modify | See phase scope |
| `.opencode/skills/system-spec-kit/scripts/spec/check-smart-router.sh:68` | Modify | See phase scope |
...
|------------|------|--------|-------------------|
| `skilled-agent-orchestration/098-097-remediation/001-dist-rebuild` | Phase | Required | Cannot complete this phase truthfully |
...
|-------|------------|--------|
| 003 narrative-validation-repair | `skilled-agent-orchestration/098-097-remediation/001-dist-rebuild` | Parent completion and final review rerun |

...
| **Created** | 2026-05-07 |
| **Branch** | `main` |
| **Parent** | `skilled-agent-orchestration/098-097-remediation` |
...
|-----------|-------------|-------------|
| `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/spec.md` | Modify | Phase-owned remediation surface |
| `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/004-symlinks/spec.md` | Modify | Phase-owned remediation surface |
| `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/001-skills/spec.md` | Modify | Phase-owned remediation surface |
| `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/002-agents/spec.md` | Modify | Phase-owned remediation surface |
| `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/003-commands/spec.md` | Modify | Phase-owned remediation surface |
...
|------|------|--------|------------|
| Dependency | `skilled-agent-orchestration/098-097-remediation/001-dist-rebuild` | Required for phases 002-007 | Phase 001 is complete before draft phases execute |

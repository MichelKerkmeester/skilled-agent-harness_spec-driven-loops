...
- Orphan-marker sweep: `rg -n "TODO|FIXME|XXX" .opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/003-remediation/` returned no hits.

...
- `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/003-remediation/` (phase parent)
  - `001-dist-rebuild/` through `007-p2-doc-drift/`
- `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/002-track-review/review/review-report.md` (predecessor verdict)

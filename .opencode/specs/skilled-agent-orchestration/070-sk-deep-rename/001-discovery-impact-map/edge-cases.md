...
Snippet: `L91: - Lifecycle branch from 'config.lineage.lineageMode' ('new', 'resume', or 'restart'; 'fork' and 'completed-continue' are deferred -- see '.opencode/skill/sk-deep-research/references/loop_protocol.md §Lifecycle Branches')`
...
Snippet: `L83: - Lifecycle branch from 'config.lineage.lineageMode' ('new', 'resume', or 'restart'; 'fork' and 'completed-continue' are deferred -- see '.opencode/skill/sk-deep-research/references/loop_protocol.md §Lifecycle Branches')`
...
Snippet: `L74: - Lifecycle branch from 'config.lineage.lineageMode' ('new', 'resume', or 'restart'; 'fork' and 'completed-continue' are deferred -- see '.opencode/skill/sk-deep-research/references/loop_protocol.md §Lifecycle Branches')`
...
Snippet: `L36: > '.opencode/skill/sk-deep-research/references/spec_check_protocol.md'.`
...
Snippet: `L54: "capabilityMatrixPath": ".opencode/skill/sk-deep-research/assets/runtime_capabilities.json",`

### `.opencode/skill/sk-deep-research/assets/deep_research_strategy.md`

Snippet: `L105: - Capability matrix: '.opencode/skill/sk-deep-research/assets/runtime_capabilities.json'`

### `.opencode/skill/sk-deep-research/assets/runtime_capabilities.json`

Snippet: `L3: "docPath": ".opencode/skill/sk-deep-research/references/capability_matrix.md",`

### `.opencode/skill/sk-deep-research/feature_catalog/01--loop-lifecycle/01-initialization.md`

Snippet: `L33: | '.opencode/skill/sk-deep-research/references/loop_protocol.md' | Reference | Documents session classification, canonical names, and the resumed or restarted lifecycle event contract. |`

### `.opencode/skill/sk-deep-research/feature_catalog/01--loop-lifecycle/02-iteration-dispatch.md`

Snippet: `L34: | '.opencode/skill/sk-deep-research/scripts/reduce-state.cjs' | Reducer | Synchronizes strategy, findings registry, and dashboard from iteration artifacts and events. |`

### `.opencode/skill/sk-deep-research/feature_catalog/01--loop-lifecycle/03-convergence-check.md`

Snippet: `L30: | '.opencode/skill/sk-deep-research/references/convergence.md' | Reference | Defines the hard stops, weighted signals, legal-stop bundle, and stop labels. |`

### `.opencode/skill/sk-deep-research/feature_catalog/01--loop-lifecycle/04-synthesis.md`

Snippet: `L30: | '.opencode/skill/sk-deep-research/references/loop_protocol.md' | Reference | Defines the synthesis phase steps, required output shape, and terminal event contract. |`

### `.opencode/skill/sk-deep-research/feature_catalog/01--loop-lifecycle/05-memory-save.md`

Snippet: `L31: | '.opencode/skill/sk-deep-research/references/loop_protocol.md' | Reference | Defines the save phase and its verification step. |`

### `.opencode/skill/sk-deep-research/feature_catalog/01--loop-lifecycle/06-resource-map-emission.md`

Snippet: `L31: | '.opencode/skill/sk-deep-research/scripts/reduce-state.cjs' | Reducer | Adds the '--emit-resource-map' path and honors 'config.resource_map.emit'. |`

### `.opencode/skill/sk-deep-research/feature_catalog/02--state-management/01-jsonl-state-log.md`

Snippet: `L30: | '.opencode/skill/sk-deep-research/references/state_format.md' | Reference | Defines the JSONL schema for config, iteration, and event lines. |`

### `.opencode/skill/sk-deep-research/feature_catalog/02--state-management/02-strategy-tracking.md`

Snippet: `L30: | '.opencode/skill/sk-deep-research/assets/deep_research_strategy.md' | Asset | Defines the strategy anchors and machine-owned section boundaries. |`

### `.opencode/skill/sk-deep-research/feature_catalog/02--state-management/03-config-management.md`

Snippet: `L30: | '.opencode/skill/sk-deep-research/assets/deep_research_config.json' | Asset | Defines the default config fields, reducer paths, file protections, and optimizer-managed knobs. |`

### `.opencode/skill/sk-deep-research/feature_catalog/03--convergence/01-three-signal-model.md`

Snippet: `L30: | '.opencode/skill/sk-deep-research/references/convergence.md' | Reference | Defines hard stops, weighted signals, stop-score threshold, and status handling. |`
...
### `.opencode/skill/system-spec-kit/mcp_server/tests/remediation-008-docs.vitest.ts`
...
### `.opencode/skill/system-spec-kit/mcp_server/database/code-graph.sqlite`

Snippet: `(binary grep matched old-name bytes)`

### `.opencode/skill/system-spec-kit/mcp_server/database/code-graph.sqlite-wal`
...
### `.opencode/skill/system-spec-kit/mcp_server/database/context-index__voyage__voyage-4__1024.sqlite-wal`

Snippet: `(binary grep matched old-name bytes)`

### `.opencode/skill/system-spec-kit/mcp_server/database/skill-graph.sqlite`

Snippet: `(binary grep matched old-name bytes)`

### `.opencode/skill/system-spec-kit/mcp_server/database/skill-graph.sqlite-wal`
...
Snippet: `L49: ".opencode/skill/sk-deep-research/changelog/v1.9.0.0.md",`
...
### `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/027-evergreen-doc-packet-id-removal/graph-metadata.json`

Snippet: `L48: ".opencode/skill/sk-deep-research/feature_catalog/feature_catalog.md",`

### `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/046-system-deep-research-bugs-and-improvements/graph-metadata.json`

Snippet: `L56: ".opencode/skill/sk-deep-research/SKILL.md"`
...
Snippet: `L49: ".opencode/skill/sk-deep-research/references/state_format.md",`
...
Snippet: `L52: ".opencode/skill/sk-deep-research/scripts/reduce-state.cjs",`
...
Snippet: `L49: ".opencode/skill/sk-deep-research/scripts/reduce-state.cjs",`
...
Snippet: `L51: ".opencode/skill/sk-deep-research/scripts/reduce-state.cjs",`
...
Snippet: `L48: ".opencode/skill/sk-deep-research/scripts/reduce-state.cjs",`
...
Snippet: `L49: ".opencode/skill/sk-deep-review/scripts/reduce-state.cjs",`

### `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/002-resource-map-template/graph-metadata.json`

Snippet: `L55: ".opencode/skill/sk-deep-review/scripts/reduce-state.cjs",`
...
### `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/005-smart-router-remediation-and-opencode-plugin/graph-metadata.json`

Snippet: `L80: ".opencode/skill/sk-deep-research/SKILL.md",`
...
Snippet: `L52: ".opencode/skill/sk-deep-research/references/loop_protocol.md",`

### `.opencode/specs/z_future/agentic-system-upgrade/002-agentic-adoption/003-loop-observability/graph-metadata.json`

Snippet: `L44: ".opencode/skill/sk-deep-research/references/state_format.md",`
...
Snippet: `L41: ".opencode/skill/sk-deep-research/assets/deep_research_config.json",`
...
Snippet: `L43: ".opencode/skill/sk-deep-research/references/state_format.md",`
...
Snippet: `L43: ".opencode/skill/sk-deep-research/assets/deep_research_config.json",`
...
### `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/027-evergreen-doc-packet-id-removal/graph-metadata.json`

Snippet: `L48: ".opencode/skill/sk-deep-research/feature_catalog/feature_catalog.md",`

### `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/046-system-deep-research-bugs-and-improvements/graph-metadata.json`
...
### `specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/005-smart-router-remediation-and-opencode-plugin/graph-metadata.json`

...
1. Fix P0-004 in Packet 070 child specs:
   - `specs/skilled-agent-orchestration/070-sk-deep-rename/002-skill-folder-rename/spec.md`
   - `specs/skilled-agent-orchestration/070-sk-deep-rename/002-skill-folder-rename/plan.md`
   - `specs/skilled-agent-orchestration/070-sk-deep-rename/002-skill-folder-rename/tasks.md`
   - `specs/skilled-agent-orchestration/070-sk-deep-rename/002-skill-folder-rename/implementation-summary.md`
   - `specs/skilled-agent-orchestration/070-sk-deep-rename/002-skill-folder-rename/graph-metadata.json`
   - `specs/skilled-agent-orchestration/070-sk-deep-rename/003-opencode-internals/spec.md`
   - `specs/skilled-agent-orchestration/070-sk-deep-rename/003-opencode-internals/graph-metadata.json`
   - `specs/skilled-agent-orchestration/070-sk-deep-rename/004-runtime-mirrors/spec.md`
   - `specs/skilled-agent-orchestration/070-sk-deep-rename/004-runtime-mirrors/graph-metadata.json`

...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/070-sk-deep-rename/003-opencode-internals"
...
|-----------|-------------|-------------|
| `specs/skilled-agent-orchestration/070-sk-deep-rename/003-opencode-internals/spec.md` | Create/Update | Phase 003 scope and requirements |
| `specs/skilled-agent-orchestration/070-sk-deep-rename/003-opencode-internals/plan.md` | Create/Update | Execution and verification plan |

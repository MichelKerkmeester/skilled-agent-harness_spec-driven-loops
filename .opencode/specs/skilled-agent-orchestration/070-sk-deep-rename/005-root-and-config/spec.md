...
| `specs/skilled-agent-orchestration/070-sk-deep-rename/005-root-and-config/spec.md` | Create | Phase 005 requirements and scope |
| `specs/skilled-agent-orchestration/070-sk-deep-rename/005-root-and-config/plan.md` | Create | Implementation and verification plan |
| `specs/skilled-agent-orchestration/070-sk-deep-rename/005-root-and-config/tasks.md` | Create | Concrete task checklist |
| `specs/skilled-agent-orchestration/070-sk-deep-rename/005-root-and-config/checklist.md` | Create | Level 2 verification checklist |
| `specs/skilled-agent-orchestration/070-sk-deep-rename/005-root-and-config/implementation-summary.md` | Create | Completion summary required by strict validation |
| `specs/skilled-agent-orchestration/070-sk-deep-rename/005-root-and-config/graph-metadata.json` | Create | Phase graph metadata |
<!-- /ANCHOR:scope -->

...
- `specs/skilled-agent-orchestration/065-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/001-skill-reindex/{pre,post}-snapshot.json` — advisor + skill graph state captures
- `specs/skilled-agent-orchestration/065-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/001-skill-reindex/reindex-diff.md` — pre/post comparison report
- `specs/skilled-agent-orchestration/065-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/002-skill-router-stress-tests/scenarios/CP-1{00..05}-*.md` — 6 CP scenario files
- `specs/skilled-agent-orchestration/065-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/002-skill-router-stress-tests/results/CP-1{00..05}-{copilot,codex,gemini}.json` — up to 18 result captures
...
**Working directory:** `specs/skilled-agent-orchestration/065-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/001-skill-reindex/`
...
**Working directory:** `specs/skilled-agent-orchestration/065-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/002-skill-router-stress-tests/`

#### T-001: Verify GO signal

```bash
grep -i "GO_SIGNAL.*GO" \
  specs/skilled-agent-orchestration/065-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/001-skill-reindex/implementation-summary.md
```
...
```bash
ls specs/skilled-agent-orchestration/065-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/002-skill-router-stress-tests/results/CP-1{00,01,02,03,04,05}-{copilot,codex,gemini}.json | wc -l

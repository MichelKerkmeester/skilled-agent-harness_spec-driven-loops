---
title: "Resource Map [skilled-agent-orchestration/133-catalog-playbook-snippet-denumbering/resource-map]"
...
| `.opencode/specs/skilled-agent-orchestration/133-catalog-playbook-snippet-denumbering/spec.md` | Created | OK | Phase-parent spec |

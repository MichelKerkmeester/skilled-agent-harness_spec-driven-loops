...
| **Reviews** | `../../147-deep-loop-workflows`, `../../148-mcp-skill-install-doctor-standardization`, `../../150-parent-nested-skill-pattern` |
<!-- /ANCHOR:metadata -->
...
### In Scope
- A read-only deep review of three packets: `147-deep-loop-workflows`, `148-mcp-skill-install-doctor-standardization`, `150-parent-nested-skill-pattern`.
...
**Depends on:** the three reviewed packets (`../../147-deep-loop-workflows`, `../../148-mcp-skill-install-doctor-standardization`, `../../150-parent-nested-skill-pattern`) existing in their shipped form, and the `review/deep-review-config.json` executor stack being reachable.
...
- **Reviewed packets**: `../../147-deep-loop-workflows`, `../../148-mcp-skill-install-doctor-standardization`, `../../150-parent-nested-skill-pattern`.

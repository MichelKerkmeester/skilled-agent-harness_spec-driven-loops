...
| 150-parent-nested-skill-pattern | **PASS** | invariants hold; the C-plus guard + runtime self-containment are sound *for the shipped instance*; post-rename doc staleness only |

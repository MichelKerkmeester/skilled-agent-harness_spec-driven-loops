...
| **Storage** | `.opencode/specs/skilled-agent-orchestration/147-deep-loop-workflows/010-deep-loop-skill-system-review/review/` |
...
| `../../150-parent-nested-skill-pattern` | Reviewed packet | Shipped | No 155 surface to review |

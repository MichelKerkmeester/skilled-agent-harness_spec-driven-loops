...
- [ ] T012 Record phase evidence and run strict phase validation. (`.opencode/specs/skilled-agent-orchestration/147-deep-loop-workflows/002-runtime-backend-promotions/plan.md`, `.opencode/specs/skilled-agent-orchestration/147-deep-loop-workflows/002-runtime-backend-promotions/tasks.md`)

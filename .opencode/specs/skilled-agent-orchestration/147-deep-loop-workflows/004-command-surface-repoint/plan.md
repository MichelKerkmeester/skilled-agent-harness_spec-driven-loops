...
- [ ] T10 Run final phase validation. (`.opencode/specs/skilled-agent-orchestration/147-deep-loop-workflows/004-command-surface-repoint`) — _verify:_ bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/147-deep-loop-workflows/004-command-surface-repoint --strict exits 0.

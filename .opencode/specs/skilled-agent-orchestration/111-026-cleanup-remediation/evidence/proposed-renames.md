...
|--------------|-------------|---|---|---|---|------:|----------|-----------|
| 021-sk-doc-conformance-sweep-and-template-cleanup | 000-release-cleanup/003-cleanup | 3 | 3 | 1 | 0 | 7 | 021-sk-doc-conformance-sweep | L=3, R=3, G=1 |
...
| 005-stress-test-expansion-and-alignment | 000-release-cleanup/005-stress-test | 2 | 3 | 0 | 0 | 5 | 005-expansion-and-alignment | L=2.0, R=3 |

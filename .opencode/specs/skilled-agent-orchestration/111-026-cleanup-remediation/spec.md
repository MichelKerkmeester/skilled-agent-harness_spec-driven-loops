...
- 007-code-graph thematic sub-phase recatalog (defer)
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-skill-advisor/*/` (5 dirs) | Create 15 files | Same as above |

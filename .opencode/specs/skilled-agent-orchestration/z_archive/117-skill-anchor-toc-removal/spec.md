...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/117-skill-anchor-toc-removal"
...
- Use `/spec_kit:resume specs/skilled-agent-orchestration/117-skill-anchor-toc-removal/[NNN-phase]/` to resume

Spec folder: skilled-agent-orchestration/135-skill-readme-standardization/003-cli-codex-readme (pre-approved, skip Gate 3). This task is READ-ONLY: do not write, create or edit any file, and do not run the skill. Return your findings as your final assistant message only.

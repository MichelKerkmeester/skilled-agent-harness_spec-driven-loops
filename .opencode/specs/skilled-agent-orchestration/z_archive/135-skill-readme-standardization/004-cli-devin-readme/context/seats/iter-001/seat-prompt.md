Spec folder: skilled-agent-orchestration/135-skill-readme-standardization/004-cli-devin-readme (pre-approved, skip Gate 3). READ-ONLY: do not write, create or edit any file, and do not run the skill. Return findings as your final assistant message only.

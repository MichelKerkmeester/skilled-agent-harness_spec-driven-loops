...
- **Predecessor**: `.opencode/specs/skilled-agent-orchestration/z_archive/079-sk-deep-agent-improvement/` (skill rename, complete)
- **Direct precedent**: `.opencode/specs/skilled-agent-orchestration/085-sk-prompt-testing-playbook-and-agent-rename/001-prompt-improver-rename/`

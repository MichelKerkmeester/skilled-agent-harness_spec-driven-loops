...
- `specs/skilled-agent-orchestration/087-improve-agent-to-deep-agent-improvement-rename/spec.md`
- `specs/skilled-agent-orchestration/087-improve-agent-to-deep-agent-improvement-rename/tasks.md`
- `specs/skilled-agent-orchestration/087-improve-agent-to-deep-agent-improvement-rename/checklist.md`
...
- `.opencode/specs/skilled-agent-orchestration/087-improve-agent-to-deep-agent-improvement-rename/tasks.md`
- `.opencode/specs/skilled-agent-orchestration/087-improve-agent-to-deep-agent-improvement-rename/checklist.md`
- `.opencode/specs/skilled-agent-orchestration/087-improve-agent-to-deep-agent-improvement-rename/resource-map.md`
...
- The unchanged slash command `/improve:agent` and unchanged Gemini command filename `.gemini/commands/improve/improve-agent.toml` were not treated as defects; only stale content inside active files was considered.

...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/z_archive/036-cli-testing-playbooks"
    ...
    key_files:
      - ".opencode/specs/skilled-agent-orchestration/z_archive/036-cli-testing-playbooks/review/review-report.md"
...
| `.opencode/specs/skilled-agent-orchestration/z_archive/036-cli-testing-playbooks/spec.md` | Created | Level 3 spec scaffolding |
| `.opencode/specs/skilled-agent-orchestration/z_archive/036-cli-testing-playbooks/plan.md` | Created | Wave-based delivery plan |
| `.opencode/specs/skilled-agent-orchestration/z_archive/036-cli-testing-playbooks/tasks.md` | Created | Linear task list |
| `.opencode/specs/skilled-agent-orchestration/z_archive/036-cli-testing-playbooks/checklist.md` | Created | P0/P1/P2 acceptance gates |
| `.opencode/specs/skilled-agent-orchestration/z_archive/036-cli-testing-playbooks/decision-record.md` | Created | ADR-001 through ADR-005 |
| `.opencode/specs/skilled-agent-orchestration/z_archive/036-cli-testing-playbooks/implementation-summary.md` | Created | This summary |
| `.opencode/specs/skilled-agent-orchestration/z_archive/036-cli-testing-playbooks/description.json` | Created | Spec-folder discovery metadata |
| `.opencode/specs/skilled-agent-orchestration/z_archive/036-cli-testing-playbooks/graph-metadata.json` | Created | Graph indexing metadata |
<!-- /ANCHOR:what-built -->

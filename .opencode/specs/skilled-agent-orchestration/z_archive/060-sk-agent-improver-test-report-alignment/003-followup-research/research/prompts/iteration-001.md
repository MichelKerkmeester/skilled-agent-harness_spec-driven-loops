# Deep Research Iteration 1 of 10 — packet 060/003
...
`/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/060-sk-agent-improver-test-report-alignment/003-followup-research/research/iterations/iteration-001.md`
...
This is iteration 1. No prior findings exist. Start with the question that has the highest leverage: RQ-4 (which other meta-agents share the command-orchestrator pattern?) is good seed work because it grounds RQ-7 (the reusable template). RQ-2/RQ-3 give 063 a head start. Pick 2-3 RQs to target this iteration.
...
4. Write findings to `.opencode/specs/skilled-agent-orchestration/060-sk-agent-improver-test-report-alignment/003-followup-research/research/iterations/iteration-001.md` using the EXACT structure below
...
- Write only to `.opencode/specs/skilled-agent-orchestration/060-sk-agent-improver-test-report-alignment/003-followup-research/research/iterations/iteration-001.md` (the absolute-from-repo-root path)

...
| `session_end.details.stopReason:"converged"` appears only when `improvementGate.passed:true`; otherwise `blockedStop` | Matches the command taxonomy (`.opencode/commands/improve/agent.md:306-316`). |
...
For `.opencode/commands/improve/assets/improve_improve-agent_auto.yaml`, current text:

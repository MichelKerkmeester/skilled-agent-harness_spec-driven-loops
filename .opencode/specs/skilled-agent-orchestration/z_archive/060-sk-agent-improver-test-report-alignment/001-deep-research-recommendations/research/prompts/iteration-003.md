...
This packet is RESEARCH-ONLY. Do NOT modify any source files in the triad. You may read freely, write to /tmp/ for scratch work, and write your iteration findings to `research/iterations/iteration-003.md`.
...
### Iteration 2 summary (excerpt)

---
iteration: 2
date: 2026-05-02T09:09:28Z
focus_rqs: []
new_findings_count: 0
rqs_now_answerable: []
convergence_signal: yes
...
4. Write your iteration findings to `research/iterations/iteration-003.md` using the EXACT structure below
5. Stop after writing — do not continue investigating beyond this iteration

## OUTPUT FORMAT (write to research/iterations/iteration-003.md)
...
[Recommend what iteration 4 should focus on, given what's now answered vs still open]
...
- Write only to `research/iterations/iteration-003.md`

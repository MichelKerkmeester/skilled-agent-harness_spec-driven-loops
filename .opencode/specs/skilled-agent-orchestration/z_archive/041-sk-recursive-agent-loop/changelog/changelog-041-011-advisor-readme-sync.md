...
| File | What changed |
| --- | --- |
| `.opencode/skills/skill-advisor/scripts/skill_advisor.py` | 7 intent boosters, 13 phrase intent boosters, 8 command bridges (Public). |
| `.opencode/skills/skill-advisor/scripts/skill_advisor.py` (Barter) | 7 command bridges, 2 phrase intent boosters. |
...
| `.opencode/commands/*/README.txt` | 5 command README.txt files updated across runtimes. |

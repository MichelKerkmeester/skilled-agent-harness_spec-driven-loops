...
| `specs/skilled-agent-orchestration/z_archive/059-sk-code-scripts-relocation/*` | Create/Modify | Planning, ADR, scratch inventory, checklist, and completion summary. |
<!-- /ANCHOR:scope -->
...
| REQ-005 | Validate the spec packet strictly. | `validate.sh specs/skilled-agent-orchestration/z_archive/059-sk-code-scripts-relocation --strict` exits 0. |

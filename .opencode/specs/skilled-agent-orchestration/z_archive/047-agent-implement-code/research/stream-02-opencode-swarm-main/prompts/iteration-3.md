...
- Config: `.opencode/specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/research/stream-02-opencode-swarm-main/deep-research-config.json`
- State Log: `.opencode/specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/research/stream-02-opencode-swarm-main/deep-research-state.jsonl`
- Strategy: `.opencode/specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/research/stream-02-opencode-swarm-main/deep-research-strategy.md`
- Registry: `.opencode/specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/research/stream-02-opencode-swarm-main/findings-registry.json`
- Write iteration narrative to: `.opencode/specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/research/stream-02-opencode-swarm-main/iterations/iteration-003.md`
- Write per-iteration delta file to: `.opencode/specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/research/stream-02-opencode-swarm-main/deltas/iter-003.jsonl`

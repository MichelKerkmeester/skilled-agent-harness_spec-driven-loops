...
> specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/decision-record.md ADR-D3.)"
>
...
2. **T028** — Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/skilled-agent-orchestration/z_archive/047-agent-implement-code --strict` to validate authored-spec markdown contract.
...
- `specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/decision-record.md` (D1-D10)

...
5. Read `AGENTS.md:125-153` and `specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/research/synthesis.md:74-108` to fold in scope discipline, evidence requirements, integration lenses, LEAF boundaries, and the Bash/interpreter write-bypass warning.

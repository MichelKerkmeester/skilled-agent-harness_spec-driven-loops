...
Runtime packet for `specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/research/stream-03-internal-agent-inventory/`.
...
Decision-record context (D1-D10) at `specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/decision-record.md`. The D3 row is the explicit research blocker:

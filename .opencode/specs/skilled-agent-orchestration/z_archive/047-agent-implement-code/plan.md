...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/skilled-agent-orchestration/z_archive/047-agent-implement-code --strict`
...
- `specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/{spec,plan,tasks,checklist,decision-record,implementation-summary,handover}.md` — all Level-3 docs (this folder)
- `specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/{description,graph-metadata}.json`
- `specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/research/synthesis.md`
- `specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/research/stream-{01,02,03}-…/research.md` + state packets
- `specs/skilled-agent-orchestration/z_archive/022-mcp-coco-integration/context-index.md` (parent-level transition note)
...
- `specs/skilled-agent-orchestration/z_archive/022-mcp-coco-integration/{description,graph-metadata}.json`

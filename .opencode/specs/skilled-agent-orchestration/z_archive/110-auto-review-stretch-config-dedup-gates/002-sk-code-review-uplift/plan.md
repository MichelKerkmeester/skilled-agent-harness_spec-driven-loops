---
title: "Implementation Plan: Phase 2 M-1 + M-2 sk-code-review uplift"
description: "Add PR-state-dedup signature spec + opt-in min-evidence gate to sk-code-review SKILL.md."
trigger_phrases:
  - "110 phase 002-sk-cr plan"
importance_tier: "important"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/110-auto-review-stretch-config-dedup-gates/002-sk-code-review-uplift"
    ...
    session_dedup:
      ...
      session_id: "2026-05-16-110-002-sk-cr-plan"
...
# Implementation Plan: Phase 2 M-1 + M-2 sk-code-review uplift
...
### Overview
Add PR-state-dedup signature spec + opt-in min-evidence gate to sk-code-review SKILL.md. Sequential file edits with per-file smoke tests.
<!-- /ANCHOR:summary -->

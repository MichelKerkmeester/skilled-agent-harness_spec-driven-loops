...
- Prior findings so far: P0=0 P1=1 P2=6 (across iterations 3)
...
1. Iteration narrative markdown at `.opencode/specs/skilled-agent-orchestration/122-deep-improvement-skill-benchmark-mode/015-post-remediation-deep-review/review-mimo-v25pro-run2/iterations/iteration-004.md` with headings: Dimension, Files Reviewed (file:line), Findings by Severity (P0/P1/P2 — each with file:line + claim + impact + fix), Traceability Checks, Verdict (FAIL/CONDITIONAL/PASS), Next Dimension.
...
3. Write the per-iteration delta file `.opencode/specs/skilled-agent-orchestration/122-deep-improvement-skill-benchmark-mode/015-post-remediation-deep-review/review-mimo-v25pro-run2/deltas/iter-004.jsonl`: the same "iteration" record on line 1, then one {"type":"finding","id":"R4-P<sev>-NNN","severity":"P0|P1|P2","file":"path:line","title":"...","iteration":4} line per finding.

...
| `.opencode/specs/skilled-agent-orchestration/141-advisor-doc-trigger-harvest/*` | All 5 packet docs authored with evidence; strict validate PASSED 0/0 | complete |
...
- **File:** `.opencode/specs/skilled-agent-orchestration/141-advisor-doc-trigger-harvest/tasks.md` (T025 is the only open task)

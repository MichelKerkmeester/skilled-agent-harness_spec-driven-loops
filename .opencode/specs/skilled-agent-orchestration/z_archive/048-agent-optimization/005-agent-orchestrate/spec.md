---
title: "Spec: @orchestrate Agent Optimization"
...
_memory:
  continuity:
    ...
    answered_questions: []
---
# Spec: @orchestrate Agent Optimization
...
### Problem Statement
`@orchestrate` (855 LOC) has not been through the sk-improve-agent v2 lens. After 060's empirical validation (PASS 6/0/0), the substrate is ready to apply across the fleet.

### Purpose
Improvement focus: **Multi-agent coordination; sub-agent dispatch authority; quality evaluation; unified delivery synthesis**. Highest-authority agent. Largest LOC in fleet (855) — biggest improvement surface.

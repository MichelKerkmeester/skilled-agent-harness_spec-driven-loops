---
title: "Plan: @review Agent Optimization"
...
_memory:
  continuity:
    ...
    answered_questions: []
---
# Plan: @review Agent Optimization
...
Single linear iteration applying the validated sk-improve-agent v2 substrate (proven 060 → PASS 6/0/0) against `@review`. Standard 9-step pipeline. Mode: `:confirm`.
<!-- /ANCHOR:summary -->
...
| **P2** Dispatch | `/deep:start-agent-improvement-loop .opencode/agents/review.md` | `<packet>/candidate.md` |

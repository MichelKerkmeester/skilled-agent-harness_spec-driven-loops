...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/z_archive/048-agent-optimization/006-agent-multi-ai-council"
...
- `/deep:start-agent-improvement-loop .opencode/agents/ultra-think.md :auto --spec-folder=specs/skilled-agent-orchestration/z_archive/048-agent-optimization/006-agent-multi-ai-council`
<!-- /ANCHOR:phase-1 -->

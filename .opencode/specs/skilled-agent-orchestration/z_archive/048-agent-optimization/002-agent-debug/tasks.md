---
title: "Tasks: @debug Agent Optimization"
...
_memory:
  continuity:
    ...
    answered_questions: []
---
# Tasks: @debug Agent Optimization
...
- `cat .opencode/agents/debug.md`
- `node .opencode/skills/sk-improve-agent/scripts/scan-integration.cjs --agent=debug --output=<packet>/integration.json`

### T-002: Generate dynamic 5-dimension profile
- `node .opencode/skills/sk-improve-agent/scripts/generate-profile.cjs --agent=.opencode/agents/debug.md --output=<packet>/profile.json`

### T-003: Dispatch /deep:start-agent-improvement-loop
- `/deep:start-agent-improvement-loop .opencode/agents/debug.md :confirm --spec-folder=specs/skilled-agent-orchestration/z_archive/048-agent-optimization/002-agent-debug`
<!-- /ANCHOR:phase-1 -->
...
- `node .opencode/skills/sk-improve-agent/scripts/score-candidate.cjs --candidate=<packet>/candidate.md --target=.opencode/agents/debug.md --manifest=<packet>/profile.json`
- `node .opencode/skills/sk-improve-agent/scripts/run-benchmark.cjs --profile=debug --outputs-dir=<packet>/benchmark-outputs --output=<packet>/benchmark.json`
...
- `node .opencode/skills/sk-improve-agent/scripts/promote-candidate.cjs --candidate=<packet>/candidate.md --target=.opencode/agents/debug.md --score=<packet>/score.json --approve`
<!-- /ANCHOR:phase-2 -->
...
- Sync to `.claude/agents/debug.md`, `.gemini/agents/debug.md`, `.codex/agents/debug.toml`

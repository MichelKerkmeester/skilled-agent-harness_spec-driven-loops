...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/z_archive/048-agent-optimization"
    ...
    blockers: []
    key_files:
      - .opencode/specs/skilled-agent-orchestration/z_archive/048-agent-optimization/spec.md
    completion_pct: 0
    open_questions:

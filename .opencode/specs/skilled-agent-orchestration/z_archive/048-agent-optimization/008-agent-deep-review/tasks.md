---
title: "Tasks: @deep-review Agent Optimization"
...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/z_archive/048-agent-optimization/008-agent-deep-review"
    ...
    answered_questions: []
---
# Tasks: @deep-review Agent Optimization
...
- `cat .opencode/agents/deep-review.md`
- `node .opencode/skills/sk-improve-agent/scripts/scan-integration.cjs --agent=deep-review --output=<packet>/integration.json`
...
- `/deep:start-agent-improvement-loop .opencode/agents/deep-review.md :auto --spec-folder=specs/skilled-agent-orchestration/z_archive/048-agent-optimization/008-agent-deep-review`
<!-- /ANCHOR:phase-1 -->
...
- `node .opencode/skills/sk-improve-agent/scripts/score-candidate.cjs --candidate=<packet>/candidate.md --target=.opencode/agents/deep-review.md --manifest=<packet>/profile.json`
- `node .opencode/skills/sk-improve-agent/scripts/run-benchmark.cjs --profile=deep-review --outputs-dir=<packet>/benchmark-outputs --output=<packet>/benchmark.json`
...
- `node .opencode/skills/sk-improve-agent/scripts/promote-candidate.cjs --candidate=<packet>/candidate.md --target=.opencode/agents/deep-review.md --score=<packet>/score.json --approve`
<!-- /ANCHOR:phase-2 -->
...
- Sync to `.claude/agents/deep-review.md`, `.gemini/agents/deep-review.md`, `.codex/agents/deep-review.toml`

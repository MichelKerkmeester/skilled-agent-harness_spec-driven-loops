...
_memory:
  continuity:
    ...
    key_files:
      ...
      - .opencode/specs/skilled-agent-orchestration/076-sk-doc-missing-router-intents-bullet-aware-matrix/scripts/extract_metrics_v3.py
      - .opencode/specs/skilled-agent-orchestration/076-sk-doc-missing-router-intents-bullet-aware-matrix/matrix_v3.csv
    session_dedup:

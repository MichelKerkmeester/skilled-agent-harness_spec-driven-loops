...
### Approach
1. **Stage A — Restructure**: `git mv` `system-spec-kit/028-deep-review-noninteractive-setup-bypass` → `skilled-agent-orchestration/z_archive/083-spec-kit-auto-mode-noninteractive-contract/001-deep-review-three-tier-setup/` (10 files, history preserved); authored 103 phase parent lean trio.

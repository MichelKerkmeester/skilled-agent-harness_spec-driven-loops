...
<!-- ANCHOR:status -->
## 2. STATUS
- Review Target: .opencode/specs/skilled-agent-orchestration/z_archive/052-sk-code-opencode-merger plus working tree changes for sk-code merger and public agent/command cleanup (spec-folder)

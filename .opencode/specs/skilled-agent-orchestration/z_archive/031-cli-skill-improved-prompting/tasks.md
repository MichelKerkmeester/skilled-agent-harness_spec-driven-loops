...
---
title: "Tasks: CLI Skill Prompt-Quality Integration via [skilled-agent-orchestration/z_archive/031-cli-skill-improved-prompting/tasks]"
description: "Task Format: T### [P?] Description (file path)"
trigger_phrases:
  - "043 tasks"
  - "mirror card tasks"
...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/skilled-agent-orchestration/z_archive/031-cli-skill-improved-prompting/tasks.md"
...
- [x] T001 Create the canonical prompt-quality card (sk-improve-prompt asset surface) `[Evidence: ls .opencode/skills/sk-improve-prompt/assets/cli_prompt_quality_card.md]`
- [x] T002 Update the `sk-improve-prompt` skill definition with the canonical-card reference `[Evidence: rg -n "cli_prompt_quality_card\\.md|External consumption entry point" .opencode/skills/sk-improve-prompt/SKILL.md]`
- [x] T003 Add the `@improve-prompt` agent invocation contract to the `sk-improve-prompt` skill definition `[Evidence: rg -n "Agent Invocation Contract|FRAMEWORK:|CLEAR_SCORE:|ENHANCED_PROMPT:|ESCALATION_NOTES:" .opencode/skills/sk-improve-prompt/SKILL.md]`
- [x] T004 Add the fast-path asset section and trigger-language update, then bump the skill version to `1.3.0.0` `[Evidence: rg -n "version: 1\\.3\\.0\\.0|FAST-PATH ASSET|invoked indirectly via" .opencode/skills/sk-improve-prompt/SKILL.md]`
- [x] T005 Decide whether the optional drift fixture lands in this packet or is deferred with rationale `[Evidence: ls .opencode/skills/skill-advisor/scripts/check-prompt-quality-card-sync.sh; bash .opencode/skills/skill-advisor/scripts/check-prompt-quality-card-sync.sh -> SYNC OK]`
<!-- /ANCHOR:phase-1 -->
...
- [x] T010 [P] Create the Claude Code mirror card (Claude Code asset surface) `[Evidence: ls .opencode/skills/cli-claude-code/assets/prompt_quality_card.md; rg -n "^<!-- sync:|^Source of truth:" .opencode/skills/cli-claude-code/assets/prompt_quality_card.md]`
- [x] T011 [P] Create the Codex mirror card (Codex asset surface) `[Evidence: ls .opencode/skills/cli-codex/assets/prompt_quality_card.md; rg -n "^<!-- sync:|^Source of truth:" .opencode/skills/cli-codex/assets/prompt_quality_card.md]`
- [x] T012 [P] Create the Copilot mirror card (Copilot asset surface) `[Evidence: ls .opencode/skills/cli-copilot/assets/prompt_quality_card.md; rg -n "^<!-- sync:|^Source of truth:" .opencode/skills/cli-copilot/assets/prompt_quality_card.md]`
- [x] T013 [P] Create the Gemini mirror card (Gemini asset surface) `[Evidence: ls .opencode/skills/cli-gemini/assets/prompt_quality_card.md; rg -n "^<!-- sync:|^Source of truth:" .opencode/skills/cli-gemini/assets/prompt_quality_card.md]`
- [x] T014 Update Claude Code skill routing and rules for local-card loading `[Evidence: .opencode/skills/cli-claude-code/SKILL.md:105,112,146,429]`
- [x] T015 Update Codex skill routing and rules for local-card loading `[Evidence: .opencode/skills/cli-codex/SKILL.md:101,108,142,446]`
- [x] T016 Update Copilot skill routing and rules for local-card loading `[Evidence: .opencode/skills/cli-copilot/SKILL.md:99,106,140,299]`
- [x] T017 Update Gemini skill routing and rules for local-card loading `[Evidence: .opencode/skills/cli-gemini/SKILL.md:98,105,139,373]`
- [x] T018 [P] Add framework tags to Claude Code prompt templates `[Evidence: grep -c '^Framework:' .opencode/skills/cli-claude-code/assets/prompt_templates.md -> 25]`
- [x] T019 [P] Add framework tags to Codex prompt templates `[Evidence: grep -c '^Framework:' .opencode/skills/cli-codex/assets/prompt_templates.md -> 34]`
- [x] T020 [P] Add framework tags to Copilot prompt templates `[Evidence: grep -c '^Framework:' .opencode/skills/cli-copilot/assets/prompt_templates.md -> 20]`
- [x] T021 [P] Add framework tags to Gemini prompt templates `[Evidence: grep -c '^Framework:' .opencode/skills/cli-gemini/assets/prompt_templates.md -> 24]`

- [x] T022 Create the canonical OpenCode runtime agent for `@improve-prompt` `[Evidence: ls .opencode/agents/improve-prompt.md; rg -n "name: improve-prompt|FRAMEWORK:|CLEAR_SCORE:|ENHANCED_PROMPT:|ESCALATION_NOTES:" .opencode/agents/improve-prompt.md]`

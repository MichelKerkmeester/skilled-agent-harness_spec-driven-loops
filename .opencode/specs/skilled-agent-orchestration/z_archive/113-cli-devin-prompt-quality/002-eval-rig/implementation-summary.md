...
| strict-validate | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/113-cli-devin-prompt-quality/002-eval-rig --strict` | TO RUN |
<!-- /ANCHOR:verification -->

...
| **Parent Packet** | `skilled-agent-orchestration/120-cli-opencode-minimax-optimization` |
| **Predecessor** | `skilled-agent-orchestration/114-small-ai-model-optimization` (small-model infra this work extends) |
| **Successor** | None |

...
```
Emit BINDING lines first (gatherSubject, slice, mode=context, specFolder=.opencode/specs/skilled-agent-orchestration/138-cli-devin-deprecation), then the JSON. Verified pointers (path:line), not source bodies. Tool budget ~8-12.

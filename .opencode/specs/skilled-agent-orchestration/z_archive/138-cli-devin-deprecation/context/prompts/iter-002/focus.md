...
```
BINDING lines first (gatherSubject, slice=runtime-code, mode=context, specFolder=.opencode/specs/skilled-agent-orchestration/138-cli-devin-deprecation). Tool budget ~8-12.

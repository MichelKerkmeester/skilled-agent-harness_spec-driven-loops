...
- [ ] T090 Memory save: run `node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js --json '<spec-049-data>' .opencode/specs/skilled-agent-orchestration/z_archive/037-mcp-testing-playbooks/`

...
4. Compared those against internal prompt surfaces in `AGENTS.md`, `.codex/AGENTS.md`, `.opencode/commands/spec_kit/plan.md`, `.opencode/commands/spec_kit/assets/spec_kit_complete_auto.yaml`, `.opencode/commands/spec_kit/assets/spec_kit_implement_auto.yaml`, `.opencode/agents/orchestrate.md`, `.opencode/agents/improve-prompt.md`, and `.opencode/agents/ultra-think.md`.

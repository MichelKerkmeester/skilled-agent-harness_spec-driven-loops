...
3. Re-checked the internal comparison surfaces: `AGENTS.md`, `.codex/AGENTS.md`, `.opencode/commands/spec_kit/README.txt`, `.opencode/commands/spec_kit/{plan,implement}.md`, `.opencode/skills/system-spec-kit/templates/`, `.opencode/skills/system-spec-kit/scripts/templates/compose.sh`, `.opencode/skills/system-spec-kit/scripts/spec/validate.sh`, `.opencode/skills/system-spec-kit/references/hooks/skill-advisor-hook.md`, `.opencode/skills/mcp-code-mode/SKILL.md`, and `.opencode/agents/*.md`.

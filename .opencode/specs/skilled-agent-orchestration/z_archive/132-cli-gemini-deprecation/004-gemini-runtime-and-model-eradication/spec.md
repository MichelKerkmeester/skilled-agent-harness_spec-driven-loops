...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/132-cli-gemini-deprecation/004-gemini-runtime-and-model-eradication"
...
| **Branch** | `main` |
| **Parent Spec** | `../spec.md` |
| **Parent Packet** | `skilled-agent-orchestration/132-cli-gemini-deprecation` |
...
| `.opencode/specs/skilled-agent-orchestration/132-cli-gemini-deprecation/004-gemini-runtime-and-model-eradication/**` | Create | Author this packet's Level 3 SpecKit docs. |
<!-- /ANCHOR:scope -->

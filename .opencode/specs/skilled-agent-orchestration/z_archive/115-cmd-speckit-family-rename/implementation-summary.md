...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/115-cmd-speckit-family-rename"
    ...
    answered_questions:
      ...
      - q: "Memory save target?"
        a: "Create new packet skilled-agent-orchestration/115-cmd-speckit-family-rename/ at Level 1."
---
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 115-cmd-speckit-family-rename |

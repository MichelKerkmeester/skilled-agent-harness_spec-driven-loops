...
```bash
sed -n '1,400p' .opencode/specs/skilled-agent-orchestration/z_archive/086-opencode-auto-review-teachings-research/research/iterations/iteration-005.md | rg -A 100 'REVIEW PROMPT TEMPLATE'
```

---
title: "Tasks: cli-devin README"
description: "Task list for the cli-devin README rewrite via deep-context and dual-draft."
trigger_phrases:
...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/z_archive/109-skill-readme-standardization/004-cli-devin-readme"
    last_updated_at: "2026-06-07T00:00:00Z"
    last_updated_by: "claude-opus-4-8"
    recent_action: "All phase-004 tasks complete"
...
- [x] T003 [P] Iteration 2 seats: verify flags, model roster and stale facts
- [x] T004 Host-verify against SKILL.md and synthesize context-report.md
- [x] T005 [P] Dual-draft: DeepSeek + MiMo author the README
- [x] T006 Merge best-of into `cli-devin/README.md`, fix HVR
<!-- /ANCHOR:phase-2 -->

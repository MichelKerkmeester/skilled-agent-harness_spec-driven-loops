---
title: "Implementation Plan: deep-loop-runtime README"
description: "Gather context with a two-iteration deep-context sweep, dual-draft with DeepSeek and MiMo, verify the components and counts, then merge the narrative README."
trigger_phrases:
  - "deep-loop-runtime readme plan"
importance_tier: "normal"
contextType: "specification"
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/z_archive/109-skill-readme-standardization/009-deep-loop-runtime-readme"
...
# Implementation Plan: deep-loop-runtime README
...
Run the full per-skill recipe: a two-iteration deep-context sweep with DeepSeek v4 Pro and MiMo v2.5 Pro as read-only seats, host verification of components and counts, a synthesized context report, then a dual-model draft the host merges and validates.
<!-- /ANCHOR:summary -->
...
| Accuracy | Components, scripts, consumers | Host SKILL.md and tree |
<!-- /ANCHOR:testing -->

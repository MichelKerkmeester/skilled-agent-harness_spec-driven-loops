---
title: "Implementation Plan: deep-context README"
...
trigger_phrases:
  - "deep-context readme plan"
importance_tier: "normal"
contextType: "specification"
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/z_archive/109-skill-readme-standardization/007-deep-context-readme"
...
# Implementation Plan: deep-context README
...
Run the full per-skill recipe: a two-iteration deep-context sweep with DeepSeek v4 Pro and MiMo v2.5 Pro as read-only seats, host verification, a synthesized context report, then a dual-model draft the host merges and validates.
<!-- /ANCHOR:summary -->
...
- [x] HVR-clean, stale facts dropped
<!-- /ANCHOR:quality-gates -->
...
| Accuracy | Signals, subfolders, paths | Host SKILL.md and tree |
<!-- /ANCHOR:testing -->

---
title: "Tasks: deep-context README"
description: "Task list for the deep-context README rewrite via deep-context and dual-draft."
trigger_phrases:
  - "deep-context readme tasks"
...
_memory:
  continuity:
    ...
    recent_action: "All phase-007 tasks complete"
...
- [x] T003 [P] Iteration 2 seats: verify flags, the five signals and the subfolders
- [x] T004 Synthesize context-report.md
- [x] T005 [P] Dual-draft: DeepSeek + MiMo author the README
- [x] T006 Verify paths, fix HVR, write `deep-context/README.md`
<!-- /ANCHOR:phase-2 -->

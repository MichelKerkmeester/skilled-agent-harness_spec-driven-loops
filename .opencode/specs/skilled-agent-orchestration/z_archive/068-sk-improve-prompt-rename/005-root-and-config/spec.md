...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/z_archive/068-sk-improve-prompt-rename/005-root-and-config"
...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/068-sk-improve-prompt-rename/005-root-and-config --strict
```
<!-- /ANCHOR:handoff -->

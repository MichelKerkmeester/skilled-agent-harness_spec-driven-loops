...
rg "companion CLI execution is out of scope|out of scope for this scenario|cross-AI handback|companion CLI" .opencode/skills/cli-opencode/manual_testing_playbook .opencode/specs/skilled-agent-orchestration/048-cli-testing-playbooks
python3 - <<'PY'

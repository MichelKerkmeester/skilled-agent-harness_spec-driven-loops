...
---
# Verification Checklist: <!-- SPECKIT_TEMPLATE_SOURCE: checklist | v2.2 -->
...
- [x] CHK-003 [P1] Scope boundary explicitly limited to advisor workflow and adjacent script files [EVIDENCE: File: implemented file list remains under `.opencode/skills/scripts/*`]
...
- [x] CHK-013 [P1] Changes remain in approved scope only (`.opencode/skills/scripts/*`) [EVIDENCE: File: implemented files are all under `.opencode/skills/scripts/*` plus spec-folder docs]
...
```bash
python3 .opencode/skills/scripts/skill_advisor.py --health
python3 .opencode/skills/scripts/skill_advisor_regression.py --dataset .opencode/skills/scripts/fixtures/skill_advisor_regression_cases.jsonl --mode both --out .opencode/skills/scripts/out/regression-report.json
python3 .opencode/skills/scripts/skill_advisor_bench.py --dataset .opencode/skills/scripts/fixtures/skill_advisor_regression_cases.jsonl --runs 7 --out .opencode/skills/scripts/out/benchmark-report.json
```
...
- [x] CHK-030 [P0] No hardcoded secrets, tokens, or credentials introduced in new scripts [EVIDENCE: Test: secret-pattern scan across `.opencode/skills/scripts/*.py` returned no matches]
...
- [x] CHK-041 [P1] CLI help text and script docs explain new flags and defaults [EVIDENCE: File: `.opencode/skills/scripts/README.md` and `.opencode/skills/scripts/SET-UP_GUIDE.md` updated for `--confidence-only`, `--batch-file`, `--batch-stdin`]
- [x] CHK-042 [P2] Optional examples for common prompts added to script docs [File: `.opencode/skills/scripts/README.md` and `.opencode/skills/scripts/SET-UP_GUIDE.md` include confidence-only and batch examples]
...
- [x] CHK-141 [P1] CLI usage docs include new flags and mode examples [EVIDENCE: File: `.opencode/skills/scripts/README.md` and `.opencode/skills/scripts/SET-UP_GUIDE.md` updates]
- [x] CHK-142 [P2] Optional user-facing guidance updated where needed [File: `.opencode/skills/scripts/README.md` and `.opencode/skills/scripts/SET-UP_GUIDE.md` updated with new flags and examples]
...
- [x] CHK-050 [P1] Benchmark and regression artifacts written under `.opencode/skills/scripts/out/` only [EVIDENCE: File: `out/regression-report.json`, `out/benchmark-report.json`]
...
- [x] CHK-113 [P2] Before/after benchmark report committed under `out/` [File: `.opencode/skills/scripts/out/benchmark-report.json`]
...
- [x] CHK-123 [P1] Script-level runbook documented in script docs [EVIDENCE: File: `.opencode/skills/scripts/README.md` and `.opencode/skills/scripts/SET-UP_GUIDE.md` harness and flag docs]

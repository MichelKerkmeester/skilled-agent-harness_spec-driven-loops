...
- iteration 7 doc_consistency (ruled_out): direct read found consistent names and ownership across the reviewed documentation; evidence=.opencode/skills/cli-opencode/SKILL.md:200, .opencode/skills/cli-opencode/assets/prompt_templates.md:451, .opencode/skills/sk-prompt-small-model/references/pattern-index.md:49, .opencode/skills/sk-prompt/assets/model-profiles.json:197

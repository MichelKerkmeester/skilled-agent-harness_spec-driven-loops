...
- This packet: `.opencode/specs/skilled-agent-orchestration/116-deep-skill-evolution/000-release-cleanup/001-deep-loop-runtime/001-doc-remediation/`
...
e. `manual.related_to` array: append:
   - `"deep-ai-council"` (full path: `"skilled-agent-orchestration/116-deep-skill-evolution/000-release-cleanup/004-deep-ai-council"` — use whichever shape the existing entries use; mirror existing convention)

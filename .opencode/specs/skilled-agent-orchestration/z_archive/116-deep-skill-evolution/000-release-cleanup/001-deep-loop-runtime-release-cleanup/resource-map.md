...
| DR-021 | iter-03 (orchestrator-direct) | P1 | `references/integration_points.md:79-89` §5 SYSTEM-CODE-GRAPH lists 4 feature_catalog refs but OMITS playbook scenarios `deep-loop-graph-convergence-yaml-fire.md` + `deep-loop-graph-upsert-conditional.md`. | Add the 2 playbook scenario paths to §5. |

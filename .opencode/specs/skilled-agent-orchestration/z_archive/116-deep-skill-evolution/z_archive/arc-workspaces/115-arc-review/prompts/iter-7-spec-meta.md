...
3. `.opencode/specs/skilled-agent-orchestration/114-small-ai-model-optimization/graph-metadata.json` (parent)
4. `.opencode/specs/skilled-agent-orchestration/114-small-ai-model-optimization/description.json` (parent)

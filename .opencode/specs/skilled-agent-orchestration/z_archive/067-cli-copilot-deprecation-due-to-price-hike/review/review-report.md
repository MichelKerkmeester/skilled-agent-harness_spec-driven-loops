...
| Field | Value |
|-------|-------|
| **Review target** | Spec packet `skilled-agent-orchestration/z_archive/067-cli-copilot-deprecation-due-to-price-hike` + 4 commits on `main` |
...
$ bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
    .opencode/specs/skilled-agent-orchestration/z_archive/067-cli-copilot-deprecation-due-to-price-hike --strict

...
This iteration focused on Q5: how sub-agent dispatch contracts, LEAF rules, and depth/nesting restrictions are represented and enforced in the internal `.opencode/agents/*.md` ecosystem. The specific question was whether `permission.task: deny` is runtime-enforced, whether `agent_config.leaf_only` has a loader, and how much of LEAF is prose convention.
...
1. The prompt expectation that `.opencode/agents/orchestrate.md` "must be `task: allow`" does not match the current file. `@orchestrate` frontmatter has `permission:` entries for read/list/glob/grep/write/edit/bash/patch/webfetch, but no `task` key. Its body says it primarily orchestrates via the `task` tool, so dispatch authority is expressed in role/body instructions rather than a `permission.task: allow` frontmatter field. Evidence: `.opencode/agents/orchestrate.md:6`, `.opencode/agents/orchestrate.md:15`, `.opencode/agents/orchestrate.md:34`.

2. Current `permission.task` inventory:

| Agent | `permission.task` | Notes |
| --- | --- | --- |
| `context` | `deny` | LEAF retrieval agent. Evidence: `.opencode/agents/context.md:16`, `.opencode/agents/context.md:39`. |
| `debug` | `deny` | User-invoked debug specialist, never auto-dispatched. Evidence: `.opencode/agents/debug.md:16`, `.opencode/agents/debug.md:36`. |
| `deep-research` | `deny` | Single-iteration LEAF worker. Evidence: `.opencode/agents/deep-research.md:18`, `.opencode/agents/deep-research.md:40`. |
| `deep-review` | `deny` | Single-iteration LEAF review worker. Evidence: `.opencode/agents/deep-review.md:18`, `.opencode/agents/deep-review.md:39`. |
| `improve-agent` | `deny` | Leaf mutator; body says bounded candidate generation. Evidence: `.opencode/agents/improve-agent.md:16`, `.opencode/agents/improve-agent.md:42`. |
| `improve-prompt` | `deny` | Read-only, leaf-only prompt package builder. Evidence: `.opencode/agents/improve-prompt.md:16`, `.opencode/agents/improve-prompt.md:26`. |
| `orchestrate` | no task field | Body grants orchestration role; no frontmatter task key. Evidence: `.opencode/agents/orchestrate.md:6`, `.opencode/agents/orchestrate.md:15`, `.opencode/agents/orchestrate.md:34`. |
| `review` | `deny` | LEAF review specialist. Evidence: `.opencode/agents/review.md:16`, `.opencode/agents/review.md:37`. |
| `ultra-think` | `allow` | Only live agent with explicit `task: allow`; allowed at Depth 0, but body switches to inline `sequential_thinking` at Depth 1. Evidence: `.opencode/agents/ultra-think.md:16`, `.opencode/agents/ultra-think.md:39`, `.opencode/agents/ultra-think.md:40`. |
| `write` | `deny` | LEAF documentation specialist. Evidence: `.opencode/agents/write.md:16`, `.opencode/agents/write.md:36`. |

3. LEAF has three layers in current repo evidence. First, frontmatter denies the Task tool for most subagents (`task: deny`). Second, agent bodies say LEAF agents must not dispatch or use Task. Third, the orchestrator injects a "NESTING CONSTRAINT" into every non-orchestrator dispatch. Evidence: `.opencode/agents/deep-research.md:18`, `.opencode/agents/deep-research.md:40`, `.opencode/agents/deep-research.md:42`, `.opencode/agents/orchestrate.md:147`, `.opencode/agents/orchestrate.md:151`.

4. The concrete depth contract is in `@orchestrate` body prose, not a discovered repository-side validator. It defines single-hop delegation, maximum depth 2 with counters 0 and 1, depth-0 orchestrator dispatch authority, depth-1 no-dispatch, and forbidden depth 2+ chains. Evidence: `.opencode/agents/orchestrate.md:40`, `.opencode/agents/orchestrate.md:43`, `.opencode/agents/orchestrate.md:105`, `.opencode/agents/orchestrate.md:116`, `.opencode/agents/orchestrate.md:120`, `.opencode/agents/orchestrate.md:122`, `.opencode/agents/orchestrate.md:126`, `.opencode/agents/orchestrate.md:129`.

5. The orchestrator's dispatch contract is explicit and operationally detailed: read the target agent definition before dispatch, include it or a focused summary in the Task prompt, set `subagent_type: "general"`, include `Depth: N`, estimate tool calls, and apply context/tool-call budget ceilings. Evidence: `.opencode/agents/orchestrate.md:155`, `.opencode/agents/orchestrate.md:158`, `.opencode/agents/orchestrate.md:201`, `.opencode/agents/orchestrate.md:208`, `.opencode/agents/orchestrate.md:267`, `.opencode/agents/orchestrate.md:493`, `.opencode/agents/orchestrate.md:513`, `.opencode/agents/orchestrate.md:739`, `.opencode/agents/orchestrate.md:745`, `.opencode/agents/orchestrate.md:748`.
...
9. The YAML-owned post-dispatch validator enforces artifact/schema completion, not LEAF behavior. It checks state-log growth, iteration markdown existence and non-empty status, canonical `"type":"iteration"`, required JSONL fields, executor provenance for non-native runs, and delta-file existence/type. It does not check sub-agent dispatch, depth, `leaf_only`, or Task-tool use. Evidence: `.opencode/skills/system-spec-kit/mcp_server/lib/deep-loop/post-dispatch-validate.ts:23`, `.opencode/skills/system-spec-kit/mcp_server/lib/deep-loop/post-dispatch-validate.ts:37`, `.opencode/skills/system-spec-kit/mcp_server/lib/deep-loop/post-dispatch-validate.ts:103`, `.opencode/skills/system-spec-kit/mcp_server/lib/deep-loop/post-dispatch-validate.ts:136`, `.opencode/skills/system-spec-kit/mcp_server/lib/deep-loop/post-dispatch-validate.ts:146`, `.opencode/skills/system-spec-kit/mcp_server/lib/deep-loop/post-dispatch-validate.ts:164`.
...
- `.opencode/agents/deep-review.md:39`
- `.opencode/agents/improve-agent.md:16`
- `.opencode/agents/improve-agent.md:42`
- `.opencode/agents/improve-prompt.md:16`
- `.opencode/agents/improve-prompt.md:26`
- `.opencode/agents/orchestrate.md:6`
- `.opencode/agents/orchestrate.md:15`
- `.opencode/agents/orchestrate.md:34`
- `.opencode/agents/orchestrate.md:40`
- `.opencode/agents/orchestrate.md:43`
- `.opencode/agents/orchestrate.md:105`
- `.opencode/agents/orchestrate.md:116`
- `.opencode/agents/orchestrate.md:120`
- `.opencode/agents/orchestrate.md:122`
- `.opencode/agents/orchestrate.md:126`
- `.opencode/agents/orchestrate.md:129`
- `.opencode/agents/orchestrate.md:147`
- `.opencode/agents/orchestrate.md:151`
- `.opencode/agents/orchestrate.md:155`
- `.opencode/agents/orchestrate.md:158`
- `.opencode/agents/orchestrate.md:201`
- `.opencode/agents/orchestrate.md:208`
- `.opencode/agents/orchestrate.md:267`
- `.opencode/agents/orchestrate.md:493`
- `.opencode/agents/orchestrate.md:513`
- `.opencode/agents/orchestrate.md:739`
- `.opencode/agents/orchestrate.md:745`
- `.opencode/agents/orchestrate.md:748`
- `.opencode/agents/review.md:16`
- `.opencode/agents/review.md:37`
- `.opencode/agents/ultra-think.md:16`
- `.opencode/agents/ultra-think.md:37`
- `.opencode/agents/ultra-think.md:40`
- `.opencode/agents/ultra-think.md:42`
- `.opencode/agents/ultra-think.md:55`
- `.opencode/agents/ultra-think.md:77`
...
- `.opencode/skills/system-spec-kit/mcp_server/lib/deep-loop/post-dispatch-validate.ts:23`
- `.opencode/skills/system-spec-kit/mcp_server/lib/deep-loop/post-dispatch-validate.ts:37`
- `.opencode/skills/system-spec-kit/mcp_server/lib/deep-loop/post-dispatch-validate.ts:103`
- `.opencode/skills/system-spec-kit/mcp_server/lib/deep-loop/post-dispatch-validate.ts:136`
- `.opencode/skills/system-spec-kit/mcp_server/lib/deep-loop/post-dispatch-validate.ts:146`
- `.opencode/skills/system-spec-kit/mcp_server/lib/deep-loop/post-dispatch-validate.ts:164`
- `.opencode/skills/sk-deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/019-final-synthesis-memory-save-and-guardrail-behavior.md:3`
- `.opencode/skills/sk-deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/019-final-synthesis-memory-save-and-guardrail-behavior.md:29`
- `.opencode/skills/sk-deep-research/manual_testing_playbook/06--synthesis-save-and-guardrails/019-final-synthesis-memory-save-and-guardrail-behavior.md:55`

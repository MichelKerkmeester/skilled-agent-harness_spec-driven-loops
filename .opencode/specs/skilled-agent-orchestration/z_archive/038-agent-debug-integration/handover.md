...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/skilled-agent-orchestration/z_archive/038-agent-debug-integration/implementation-summary.md"
      - ".opencode/specs/skilled-agent-orchestration/z_archive/038-agent-debug-integration/handover.md"
...
- **Spec folder:** `.opencode/specs/skilled-agent-orchestration/z_archive/038-agent-debug-integration/` — full Level 2 doc set
...
- **File:** `.opencode/specs/skilled-agent-orchestration/z_archive/038-agent-debug-integration/implementation-summary.md`

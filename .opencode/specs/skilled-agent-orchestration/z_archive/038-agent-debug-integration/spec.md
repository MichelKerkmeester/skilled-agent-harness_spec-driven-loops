...
| `.opencode/specs/skilled-agent-orchestration/z_archive/038-agent-debug-integration/` | Create | This packet's spec/plan/tasks/checklist + implementation-summary post-impl. |
<!-- /ANCHOR:scope -->

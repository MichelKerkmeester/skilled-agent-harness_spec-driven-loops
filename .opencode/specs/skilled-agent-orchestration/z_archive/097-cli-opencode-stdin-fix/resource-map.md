...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/097-cli-opencode-stdin-fix"
...
| Path | Lines | Purpose |
|------|------:|---------|
| `specs/skilled-agent-orchestration/097-cli-opencode-stdin-fix/spec.md` | 198 | Level 2 specification |
| `specs/skilled-agent-orchestration/097-cli-opencode-stdin-fix/plan.md` | 113 | Phased implementation plan |
| `specs/skilled-agent-orchestration/097-cli-opencode-stdin-fix/tasks.md` | 36 | Per-file task list (T1–T18) |
| `specs/skilled-agent-orchestration/097-cli-opencode-stdin-fix/checklist.md` | 53 | QA validation checklist |
| `specs/skilled-agent-orchestration/097-cli-opencode-stdin-fix/description.json` | 24 | Packet metadata |
| `specs/skilled-agent-orchestration/097-cli-opencode-stdin-fix/graph-metadata.json` | 16 | Graph metadata |
| `specs/skilled-agent-orchestration/097-cli-opencode-stdin-fix/implementation-summary.md` | ~190 | Summary, verification, follow-ups |
| `specs/skilled-agent-orchestration/097-cli-opencode-stdin-fix/resource-map.md` | (this file) | Path ledger |
| `specs/skilled-agent-orchestration/097-cli-opencode-stdin-fix/changelog.md` | ~70 | Change history |

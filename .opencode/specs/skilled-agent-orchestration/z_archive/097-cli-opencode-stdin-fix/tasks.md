...
| T17 | Run strict validate | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/skilled-agent-orchestration/097-cli-opencode-stdin-fix --strict` | [ ] |

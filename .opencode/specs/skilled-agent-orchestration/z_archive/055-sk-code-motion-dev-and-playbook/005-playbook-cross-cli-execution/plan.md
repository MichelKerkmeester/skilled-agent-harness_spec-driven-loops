...
|-----------|-------|---------|
| Spec validation | Phase 005 docs | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/skilled-agent-orchestration/z_archive/055-sk-code-motion-dev-and-playbook/005-playbook-cross-cli-execution --strict` |
| Parent validation | Packet 069 phase parent | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/skilled-agent-orchestration/z_archive/055-sk-code-motion-dev-and-playbook --strict` |

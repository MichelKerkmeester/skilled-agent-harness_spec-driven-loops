...
|-----------|-------|---------|
| Spec validation | Phase 006 docs | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/skilled-agent-orchestration/z_archive/055-sk-code-motion-dev-and-playbook/006-routing-precision-fixes --strict` |

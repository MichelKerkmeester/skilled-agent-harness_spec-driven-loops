...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/z_archive/055-sk-code-motion-dev-and-playbook"
...
- Use `/speckit:resume specs/skilled-agent-orchestration/z_archive/055-sk-code-motion-dev-and-playbook/[NNN-phase]/` to resume a specific phase.

...
- [x] CHK-020 [P0] Strict spec validation exits 0. Evidence: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/skilled-agent-orchestration/z_archive/055-sk-code-motion-dev-and-playbook/002-motion-dev --strict` returned exit 0.

...
|-----------|-------------|-------------|
| `specs/skilled-agent-orchestration/z_archive/058-stack-agnostic-cleanup/` | Create/Modify | Phase packet docs, inventory note, ADR, summary |
...
| REQ-008 | Strictly validate the packet | `validate.sh specs/skilled-agent-orchestration/z_archive/058-stack-agnostic-cleanup --strict` exits 0 |
<!-- /ANCHOR:requirements -->

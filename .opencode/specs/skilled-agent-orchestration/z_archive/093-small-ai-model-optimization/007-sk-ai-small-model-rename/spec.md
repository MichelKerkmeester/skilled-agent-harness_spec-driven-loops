...
| `.opencode/specs/skilled-agent-orchestration/z_archive/093-small-ai-model-optimization/spec.md` | Modify (single row append) | Add Phase 7 row to PHASE DOCUMENTATION MAP |

...
```json
{
  ...
  "findings": [
    ...
    },
    {
      ...
      "evidence": "jq '.children_ids' 114/graph-metadata.json includes 'skilled-agent-orchestration/z_archive/093-small-ai-model-optimization/007-sk-prompt-small-model-rename' (line 13); jq '.derived.last_active_child_id' points to same path (line 113)",

  ...
  "findings": [
    {
      ...
      "severity": "P2",
      "location": ".opencode/specs/skilled-agent-orchestration/z_archive/093-small-ai-model-optimization/spec.md frontmatter",
    ...
    },
    {
      ...
      "hypothesis": "H5: parent metadata drift",
      "severity": "P2",
      "location": ".opencode/specs/skilled-agent-orchestration/z_archive/093-small-ai-model-optimization/description.json",

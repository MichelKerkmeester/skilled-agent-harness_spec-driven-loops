...
1. **Read** all 7 prior iter files at `.opencode/specs/skilled-agent-orchestration/z_archive/093-small-ai-model-optimization/007-sk-prompt-models-rename/review/iterations/iteration-{001..007}.md`. Build the full findings registry (P0/P1/P2 by ID).

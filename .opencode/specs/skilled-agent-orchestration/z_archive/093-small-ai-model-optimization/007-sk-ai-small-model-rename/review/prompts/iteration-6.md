...
1. **Re-read** `.opencode/specs/skilled-agent-orchestration/z_archive/093-small-ai-model-optimization/spec.md` frontmatter `_memory.continuity`. Verify:
...
2. **Re-read** `.opencode/specs/skilled-agent-orchestration/z_archive/093-small-ai-model-optimization/description.json`. Verify:

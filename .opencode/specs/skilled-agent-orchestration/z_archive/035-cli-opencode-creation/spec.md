---
title: "Feature Specification: cli-opencode Skill Creation [skilled-agent-orchestration/z_archive/035-cli-opencode-creation/spec]"
...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/z_archive/035-cli-opencode-creation"
...
- **REQ-013 (Validation gate):** `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/035-cli-opencode-creation/ --strict` passes 0/0 against this packet. The skill itself does not have a strict validator, but `python3 skill_graph_compiler.py --validate-only` MUST pass.
...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/035-cli-opencode-creation/ --strict` exits 0 with 0 errors / 0 warnings.

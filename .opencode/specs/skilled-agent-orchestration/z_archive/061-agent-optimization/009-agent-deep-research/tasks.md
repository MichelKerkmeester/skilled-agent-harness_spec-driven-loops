...
- `/deep:start-agent-improvement-loop .opencode/agents/deep-research.md :auto --spec-folder=specs/skilled-agent-orchestration/061-agent-optimization/009-agent-deep-research`
<!-- /ANCHOR:phase-1 -->

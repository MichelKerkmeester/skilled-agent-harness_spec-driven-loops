...
- `/deep:start-agent-improvement-loop .opencode/agents/debug.md :confirm --spec-folder=specs/skilled-agent-orchestration/061-agent-optimization/002-agent-debug`
<!-- /ANCHOR:phase-1 -->

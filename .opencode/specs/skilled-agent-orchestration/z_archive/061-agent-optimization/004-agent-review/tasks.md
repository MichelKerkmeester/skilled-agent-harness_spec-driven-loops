...
- `/deep:start-agent-improvement-loop .opencode/agents/review.md :confirm --spec-folder=specs/skilled-agent-orchestration/061-agent-optimization/004-agent-review`
<!-- /ANCHOR:phase-1 -->

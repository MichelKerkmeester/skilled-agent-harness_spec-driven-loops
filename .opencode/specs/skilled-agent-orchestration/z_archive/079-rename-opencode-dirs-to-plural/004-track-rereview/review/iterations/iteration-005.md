...
- EvidenceRefs: `.opencode/commands/doctor/scripts/audit_descriptions.py:155`, `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/003-remediation/006-skill-advisor-python/spec.md:98`, `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/003-remediation/006-skill-advisor-python/implementation-summary.md:127`, `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/003-remediation/006-skill-advisor-python/checklist.md:48`

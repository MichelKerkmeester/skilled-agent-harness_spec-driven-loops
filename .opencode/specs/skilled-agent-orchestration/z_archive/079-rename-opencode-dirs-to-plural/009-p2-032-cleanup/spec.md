...
|-----------|-------------|-------------|
| `specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/007-track-rereview/review/deep-review-strategy.md` | Modify | Remove 3 stale aliases.ts references; correct surface count 6 → 5 in two places. |
| `specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/008-remediation/implementation-summary.md` | Modify | Clear `_memory.continuity.blockers` entry referring to P2-032. |
<!-- /ANCHOR:scope -->

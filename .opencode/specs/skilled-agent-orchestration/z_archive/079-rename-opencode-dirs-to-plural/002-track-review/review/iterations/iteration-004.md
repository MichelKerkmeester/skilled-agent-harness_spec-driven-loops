...
- `.opencode/specs/skilled-agent-orchestration/z_archive/077-playbook-prompt-naturalness/decision-record.md:40`
- `.opencode/specs/skilled-agent-orchestration/z_archive/077-playbook-prompt-naturalness/spec.md:74`
- `.opencode/specs/skilled-agent-orchestration/z_archive/077-playbook-prompt-naturalness/checklist.md:40`
- `.opencode/specs/skilled-agent-orchestration/z_archive/077-playbook-prompt-naturalness/implementation-summary.md:61`
- `.opencode/specs/skilled-agent-orchestration/z_archive/076-testing-playbooks-code-review-and-git/001-sk-code-review-playbook/spec.md:107`
- `.opencode/specs/skilled-agent-orchestration/z_archive/076-testing-playbooks-code-review-and-git/002-sk-git-playbook/spec.md:60`
- `.opencode/specs/skilled-agent-orchestration/z_archive/078-sk-code-review-playbook-execution/spec.md:94`
- `.opencode/specs/skilled-agent-orchestration/z_archive/078-sk-code-review-playbook-execution/implementation-summary.md:45`
- `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/spec.md:96`
- `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/resource-map.md:169`
- `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/001-rename-opencode-dirs/004-symlinks/spec.md:101`
...
- Evidence refs: `.opencode/specs/skilled-agent-orchestration/z_archive/077-playbook-prompt-naturalness/checklist.md:40`, `.opencode/specs/skilled-agent-orchestration/z_archive/077-playbook-prompt-naturalness/checklist.md:84`, `.opencode/specs/skilled-agent-orchestration/z_archive/077-playbook-prompt-naturalness/implementation-summary.md:106`, `.opencode/specs/skilled-agent-orchestration/z_archive/076-testing-playbooks-code-review-and-git/001-sk-code-review-playbook/checklist.md:72`, `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/001-rename-opencode-dirs/004-symlinks/checklist.md:40`.
...
```json
{
  ...
  "evidenceRefs": [
    ".opencode/specs/skilled-agent-orchestration/z_archive/077-playbook-prompt-naturalness/checklist.md:40",
    ".opencode/specs/skilled-agent-orchestration/z_archive/077-playbook-prompt-naturalness/implementation-summary.md:106",
    ".opencode/specs/skilled-agent-orchestration/z_archive/076-testing-playbooks-code-review-and-git/001-sk-code-review-playbook/checklist.md:72",
    ".opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/001-rename-opencode-dirs/004-symlinks/checklist.md:40"
  ],
...
- Evidence refs: `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/spec.md:101`, `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/001-rename-opencode-dirs/004-symlinks/spec.md:117`.
...
- Evidence refs: `.opencode/specs/skilled-agent-orchestration/z_archive/076-testing-playbooks-code-review-and-git/001-sk-code-review-playbook/spec.md:107`, `.opencode/specs/skilled-agent-orchestration/z_archive/076-testing-playbooks-code-review-and-git/002-sk-git-playbook/spec.md:60`, `.opencode/specs/skilled-agent-orchestration/z_archive/077-playbook-prompt-naturalness/decision-record.md:47`, `.opencode/specs/skilled-agent-orchestration/z_archive/077-playbook-prompt-naturalness/implementation-summary.md:53`.

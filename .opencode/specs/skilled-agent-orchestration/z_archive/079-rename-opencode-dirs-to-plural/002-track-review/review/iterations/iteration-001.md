...
- `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/002-track-review/review/deep-review-config.json:1`
...
- Packet 095: no independent commit was found by `git log --grep='095|sk-code-review playbook execution' -- .opencode/specs/skilled-agent-orchestration/z_archive/078-sk-code-review-playbook-execution`; the only matching history entry was packet 096's rename commit touching the folder.
...
- Dimension: correctness
- Evidence: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural` exits `2` with `SPEC_DOC_SUFFICIENCY: 1 spec_doc_sufficiency issue(s) found`; `--strict` also exits `2`. The packet root is `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/spec.md:1`.
...
```json
{
  ...
  "evidenceRefs": [
    ".opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/spec.md:1",
    ".opencode/specs/skilled-agent-orchestration/z_archive/076-testing-playbooks-code-review-and-git/spec.md:1",
    ".opencode/specs/skilled-agent-orchestration/z_archive/077-playbook-prompt-naturalness/spec.md:1",
    ".opencode/specs/skilled-agent-orchestration/z_archive/078-sk-code-review-playbook-execution/spec.md:1"
  ],

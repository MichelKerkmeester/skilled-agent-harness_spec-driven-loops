...
- Iteration narrative target: `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/002-track-review/review/iterations/iteration-003.md`
- Delta target: `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/002-track-review/review/deltas/iter-003.jsonl`
...
3. **Workflow-resolved spec_folder write authority**:
   ...
   - Confirm iteration outputs cannot escape `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/002-track-review/review/` even under malformed config.

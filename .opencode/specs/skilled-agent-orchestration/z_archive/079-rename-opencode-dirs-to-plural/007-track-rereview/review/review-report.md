  ...
  "remediationWorkstreams": [
    ...
    },
    {
      ...
      "affectedSurfaces": [
        ...
        ".opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/006-cli-opencode-executor/spec.md",
        ".opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/007-track-rereview/review/deep-review-strategy.md"
      ]
    },
    {
    ...
    },
    {
      ...
      "affectedSurfaces": [
        ".opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/007-track-rereview/review/deep-review-strategy.md",
        ".opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/006-cli-opencode-executor/implementation-summary.md"
      ]
    }
  ],
  "specSeed": [
...
| P2-032 | P2 | Strategy doc surface inventory drift — claims `aliases.ts` touched by 101 but 101 implementation-summary lists only 5 surfaces | traceability | `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/007-track-rereview/review/deep-review-strategy.md` | active |
...
- `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/004-track-rereview/review/review-report.md` (predecessor verdict baseline)
- `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/005-remediation/spec.md`, `plan.md`, `tasks.md`, `checklist.md`, `implementation-summary.md`, `graph-metadata.json`
- `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/006-cli-opencode-executor/spec.md`, `implementation-summary.md`, `graph-metadata.json`
- `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/007-track-rereview/spec.md`, `plan.md`, `tasks.md`, `checklist.md`, `implementation-summary.md`, `graph-metadata.json` (self-validation)

...
| Field | Value |
|-------|-------|
| **Spec Folder** | `.opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/007-track-rereview/` |
| **Level** | 2 |
| **Status** | In Progress |
| **Completed** | (pending) |
| **Branch** | `main` |
...
| Strict validate | (pending) | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/079-rename-opencode-dirs-to-plural/007-track-rereview --strict` |
<!-- /ANCHOR:verification -->

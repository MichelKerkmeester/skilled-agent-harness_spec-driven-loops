...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/001-rename-opencode-dirs/"
      - ".opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/008-remediation/"
    session_dedup:

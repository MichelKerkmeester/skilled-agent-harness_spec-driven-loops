...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/003-remediation/001-dist-rebuild"
...
|------------|------|--------|-------------------|
| `skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/002-track-review` | Phase | Required | Cannot complete this phase truthfully |
...
|-------|------------|--------|
| 001 dist-rebuild | `skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/002-track-review` | Parent completion and final review rerun |

...
|-----------|-------------|-------------|
| `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/004-track-rereview/review/` | Create | Skill-owned review packet with state files |
| `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/004-track-rereview/review/review-report.md` | Create | Synthesis output: 9 sections + Planning Packet |
| `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/004-track-rereview/review/resource-map.md` | Create | Resource map of touched files across 093-098 |
| `.opencode/specs/skilled-agent-orchestration/096-rename-opencode-dirs-to-plural/004-track-rereview/implementation-summary.md` | Create | Continuity update post-synthesis |
<!-- /ANCHOR:scope -->

...
Strategy should store only the latest durable state and open risks, not every evidence item. It is the planning surface, not the event log. [SOURCE: .opencode/specs/03--commands-and-skills/030-sk-deep-research-review-mode/research/deep-research-strategy.md:113-115] [SOURCE: .opencode/agent/deep-review.md:83-87]

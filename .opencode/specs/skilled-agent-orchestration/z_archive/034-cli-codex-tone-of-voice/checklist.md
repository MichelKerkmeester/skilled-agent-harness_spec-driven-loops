---
title: "Verification Checklist: Codex Tone-of-Voice [skilled-agent-orchestration/z_archive/034-cli-codex-tone-of-voice/checklist]"
...
- [ ] **P0-07** — `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/034-cli-codex-tone-of-voice --strict` exits 0. (SC-003) — Evidence: recorded exit code.

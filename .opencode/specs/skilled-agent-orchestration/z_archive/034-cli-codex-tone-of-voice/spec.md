---
title: "Feature Specification: Codex Tone-of-Voice [skilled-agent-orchestration/z_archive/034-cli-codex-tone-of-voice/spec]"
...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/z_archive/034-cli-codex-tone-of-voice"
    ...
    open_questions: []
    answered_questions:
      - "Spec folder path: .opencode/specs/skilled-agent-orchestration/z_archive/034-cli-codex-tone-of-voice"
...
| `.opencode/specs/skilled-agent-orchestration/z_archive/034-cli-codex-tone-of-voice/*.md`         | Create      | Spec folder docs (spec, plan, tasks, checklist, decision-record, impl)  |
| `.opencode/specs/skilled-agent-orchestration/z_archive/034-cli-codex-tone-of-voice/*.json`       | Create      | description.json + graph-metadata.json (via generate-context.js)        |
<!-- /ANCHOR:scope -->
...
- **SC-003**: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/034-cli-codex-tone-of-voice --strict` exits 0.

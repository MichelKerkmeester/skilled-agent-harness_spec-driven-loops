...
| REQ-007 | spec validates strict | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh skilled-agent-orchestration/z_archive/041-cli-skill-removal-mcp-clickup --strict` exits 0 or 1 (warnings tolerated, errors not) |
<!-- /ANCHOR:requirements -->

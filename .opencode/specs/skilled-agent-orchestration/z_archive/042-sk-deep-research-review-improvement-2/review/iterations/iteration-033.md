...
● Search (grep)
  ...
  │ mode|completed-continue|fork" (.opencode/skills/sk-deep-research/references/loop_protocol.md)
  └ 6 lines found

● Search (grep)
  │ "full
  │ replay|full-replay|replay|resume|restart|lineage|iteration|append-only|state\.jsonl|continue
  │ mode|completed-continue|fork" (.opencode/skills/sk-deep-review/references/loop_protocol.md)
  └ 6 lines found

● Search (grep)
  │ "full
  │ replay|full-replay|replay|resume|restart|lineage|iteration|append-only|state\.jsonl|continue
  │ mode|completed-continue|fork" (.opencode/skills/sk-improve-agent/references/loop_protocol.md)
  └ 1 line found
...
● Search (grep)
  ...
  │ (.opencode/skills/sk-improve-agent/references)
  └ 54 lines found
...
- **Severity:** P1
- **Dimension:** traceability
- **File:** `.opencode/skills/sk-deep-research/references/convergence.md`
...
- **Severity:** P1
- **Dimension:** traceability
- **File:** `.opencode/skills/sk-deep-research/references/loop_protocol.md`
- **Line:** `226-228`
...
- **Evidence:** The protocol says to run the reducer with `{ latestJSONLDelta, newIterationFile, priorReducedState }` and explicitly says this is “not a full replay” (`loop_protocol.md:226-228`). But `.opencode/skills/sk-deep-research/scripts/reduce-state.cjs:824-864` reads the entire `deep-research-state.jsonl`, loads all `iterations/iteration-*.md` files, and rebuilds registry/strategy/dashboard from that full packet state.
...
- **Severity:** P1
- **Dimension:** traceability
- **File:** `.opencode/skills/sk-deep-review/assets/review_mode_contract.yaml`
- **Line:** `162-176`
...
- **Evidence:** `review_mode_contract.yaml:162-176` still lists delta-style reducer inputs. The review reference already documents the canonical inputs as `fullJSONLHistory`, `iterationFiles`, and `priorReducedState` in `.opencode/skills/sk-deep-review/references/loop_protocol.md:150-156`, and the reducer implementation reads the whole `deep-review-state.jsonl` plus all iteration files in `.opencode/skills/sk-deep-review/scripts/reduce-state.cjs:1118-1147`.
...
- **Severity:** P2
- **Dimension:** traceability
- **File:** `.opencode/skills/sk-deep-research/references/loop_protocol.md`; `.opencode/skills/sk-deep-review/references/loop_protocol.md`
...
Traceability is **mostly aligned** on the lifecycle-mode cleanup itself: `.opencode/skills/sk-deep-research/assets/deep_research_config.json:18-22` contains only `new/resume/restart`, and `.opencode/skills/sk-deep-review/assets/review_mode_contract.yaml:147-153` also contains only those three modes. `.opencode/skills/sk-deep-review/references/convergence.md:44-93` is aligned to the `blocked_stop` model.

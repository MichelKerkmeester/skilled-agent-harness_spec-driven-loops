...
● Search (grep)
  │ "\.opencode/skills/|mcp_server|wave
...
● Search (grep)
  ...
  │ |compositeScore|signals\." (.opencode/skills/sk-deep-review/scripts/reduce-state.cjs)
  └ 11 lines found

● Search (grep)
  │ "graphConvergenceScore|graph_convergence|computeGraphConvergenceScore|blendedScore|decisionScore
  │ |compositeScore|signals\." (.opencode/skills/sk-deep-research/scripts/reduce-state.cjs)
  └ 12 lines found
...
● Search (grep)
  │ "synthesis_complete" in **/*.{md,yml,yaml,json,cjs,js} (.opencode/skills/sk-improve-agent)
  └ No matches found
...
● Search (grep)
  ...
  │ **/*.{yaml,yml,json,md,cjs,js} (.opencode/skills/sk-deep-review)
  └ 6 lines found
...
● Search (grep)
  │ "sessionId|parentSessionId|lineageMode|generation|continuedFromRun" in
  │ **/*.{yaml,yml,json,md,cjs,js} (.opencode/skills/sk-deep-research)
  └ 8 lines found

● Search (glob)
  │ "**/*.json" in .opencode/skills/sk-deep-review/assets
  └ 2 files found
...
● Search (glob)
  │ "**/*review*config*.json" in .opencode/skills/sk-deep-review/assets
  └ 1 file found
...
- **Evidence:** In `.opencode/skills/sk-improve-agent/scripts/reduce-state.cjs:50-61`, malformed JSONL lines are caught and replaced with `[]`. The reducer then consumes that parser for the main state log at `.opencode/skills/sk-improve-agent/scripts/reduce-state.cjs:1023-1032`, and for journal replay at `.opencode/skills/sk-improve-agent/scripts/reduce-state.cjs:173-180`. By contrast, the peer reducers already fail closed: `.opencode/skills/sk-deep-review/scripts/reduce-state.cjs:1125-1150` and `.opencode/skills/sk-deep-research/scripts/reduce-state.cjs:831-867` both collect corruption warnings and throw `STATE_CORRUPTION` unless explicitly run leniently.

...
### .opencode/agents/agent-improver.md:175-177 -- BLOCKED (iteration 3, 1 attempts)
- What was tried: .opencode/agents/agent-improver.md:175-177
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/agents/agent-improver.md:175-177

### .opencode/agents/deep-research.md:159-166 -- BLOCKED (iteration 1, 1 attempts)
- What was tried: .opencode/agents/deep-research.md:159-166
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/agents/deep-research.md:159-166

### .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:326 -- BLOCKED (iteration 2, 1 attempts)
- What was tried: .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:326
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:326

### .opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml:436-437 -- BLOCKED (iteration 2, 1 attempts)
- What was tried: .opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml:436-437
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml:436-437

### .opencode/skills/sk-deep-research/references/convergence.md:1181-1205 -- BLOCKED (iteration 3, 1 attempts)
- What was tried: .opencode/skills/sk-deep-research/references/convergence.md:1181-1205
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/sk-deep-research/references/convergence.md:1181-1205

### .opencode/skills/sk-deep-research/references/loop_protocol.md:190-198 -- BLOCKED (iteration 1, 1 attempts)
- What was tried: .opencode/skills/sk-deep-research/references/loop_protocol.md:190-198
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/sk-deep-research/references/loop_protocol.md:190-198

### .opencode/skills/sk-deep-research/references/loop_protocol.md:247-255 -- BLOCKED (iteration 1, 1 attempts)
- What was tried: .opencode/skills/sk-deep-research/references/loop_protocol.md:247-255
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/sk-deep-research/references/loop_protocol.md:247-255

### .opencode/skills/sk-deep-research/references/loop_protocol.md:77-84 -- BLOCKED (iteration 1, 1 attempts)
- What was tried: .opencode/skills/sk-deep-research/references/loop_protocol.md:77-84
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/sk-deep-research/references/loop_protocol.md:77-84

### .opencode/skills/sk-deep-research/references/state_format.md:145-177 -- BLOCKED (iteration 1, 1 attempts)
- What was tried: .opencode/skills/sk-deep-research/references/state_format.md:145-177
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/sk-deep-research/references/state_format.md:145-177

### .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:103-127 -- BLOCKED (iteration 2, 2 attempts)
- What was tried: .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:103-127
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:103-127

### .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:11-12 -- BLOCKED (iteration 3, 1 attempts)
- What was tried: .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:11-12
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:11-12

### .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:438-444 -- BLOCKED (iteration 1, 1 attempts)
- What was tried: .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:438-444
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:438-444

### .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:489-502 -- BLOCKED (iteration 2, 2 attempts)
- What was tried: .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:489-502
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:489-502

### .opencode/skills/sk-deep-research/SKILL.md:190-199 -- BLOCKED (iteration 1, 1 attempts)
- What was tried: .opencode/skills/sk-deep-research/SKILL.md:190-199
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/sk-deep-research/SKILL.md:190-199

### .opencode/skills/sk-deep-review/references/convergence.md:658-683 -- BLOCKED (iteration 3, 1 attempts)
- What was tried: .opencode/skills/sk-deep-review/references/convergence.md:658-683
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/sk-deep-review/references/convergence.md:658-683

### .opencode/skills/sk-improve-agent/scripts/mutation-coverage.cjs:16-67 -- BLOCKED (iteration 3, 1 attempts)
- What was tried: .opencode/skills/sk-improve-agent/scripts/mutation-coverage.cjs:16-67
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/sk-improve-agent/scripts/mutation-coverage.cjs:16-67

### .opencode/skills/sk-improve-agent/SKILL.md:294-300 -- BLOCKED (iteration 3, 1 attempts)
- What was tried: .opencode/skills/sk-improve-agent/SKILL.md:294-300
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/sk-improve-agent/SKILL.md:294-300

### .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:109-163 -- BLOCKED (iteration 2, 1 attempts)
- What was tried: .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:109-163
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:109-163

### .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:20-25 -- BLOCKED (iteration 2, 1 attempts)
- What was tried: .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:20-25
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:20-25

### .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:245-275 -- BLOCKED (iteration 2, 1 attempts)
- What was tried: .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:245-275
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:245-275

### .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:343-355 -- BLOCKED (iteration 2, 1 attempts)
- What was tried: .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:343-355
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:343-355

### .opencode/skills/system-spec-kit/mcp_server/tests/coverage-graph-db.vitest.ts:135-185 -- BLOCKED (iteration 3, 1 attempts)
- What was tried: .opencode/skills/system-spec-kit/mcp_server/tests/coverage-graph-db.vitest.ts:135-185
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/system-spec-kit/mcp_server/tests/coverage-graph-db.vitest.ts:135-185

### .opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:779-869 -- BLOCKED (iteration 3, 1 attempts)
- What was tried: .opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:779-869
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:779-869

### .opencode/skills/system-spec-kit/scripts/lib/coverage-graph-contradictions.cjs:37-67 -- BLOCKED (iteration 2, 1 attempts)
- What was tried: .opencode/skills/system-spec-kit/scripts/lib/coverage-graph-contradictions.cjs:37-67
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/system-spec-kit/scripts/lib/coverage-graph-contradictions.cjs:37-67

### .opencode/skills/system-spec-kit/scripts/lib/coverage-graph-contradictions.cjs:85-129 -- BLOCKED (iteration 2, 1 attempts)
- What was tried: .opencode/skills/system-spec-kit/scripts/lib/coverage-graph-contradictions.cjs:85-129
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: .opencode/skills/system-spec-kit/scripts/lib/coverage-graph-contradictions.cjs:85-129
...
### `stuckRecovery` is not entirely absent from runtime serialization, but the only concrete live record I found is review's raw `stuck_recovery` event; that is weaker than the documented shared enum contract and does not prove consumer-visible normalization (.opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml:375-383). -- BLOCKED (iteration 5, 1 attempts)
- What was tried: `stuckRecovery` is not entirely absent from runtime serialization, but the only concrete live record I found is review's raw `stuck_recovery` event; that is weaker than the documented shared enum contract and does not prove consumer-visible normalization (.opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml:375-383).
- Why blocked: Repeated iteration evidence ruled this direction out.
...
### Benchmark stability is not over-blocking small samples in the inspected helper path; it under-blocks them by allowing 1-2 replay samples to look stable enough unless visible variance already appears. (`.opencode/skills/sk-improve-agent/scripts/benchmark-stability.cjs:69-92`, `.opencode/skills/sk-improve-agent/scripts/benchmark-stability.cjs:103-171`, `.opencode/skills/sk-improve-agent/scripts/tests/benchmark-stability.vitest.ts:124-139`) -- BLOCKED (iteration 17, 1 attempts)
...
### No evidence that YAML workflow outputs bypass the reducer-owned packet surfaces; both auto and confirm flows still target `findings-registry.json` and `deep-research-dashboard.md` as synchronized outputs (.opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:83-84; .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:197; .opencode/commands/spec_kit/assets/spec_kit_deep-research_confirm.yaml:83-84; .opencode/commands/spec_kit/assets/spec_kit_deep-research_confirm.yaml:196-217). -- BLOCKED (iteration 1, 1 attempts)
- What was tried: No evidence that YAML workflow outputs bypass the reducer-owned packet surfaces; both auto and confirm flows still target `findings-registry.json` and `deep-research-dashboard.md` as synchronized outputs (.opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:83-84; .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:197; .opencode/commands/spec_kit/assets/spec_kit_deep-research_confirm.yaml:83-84; .opencode/commands/spec_kit/assets/spec_kit_deep-research_confirm.yaml:196-217).
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: No evidence that YAML workflow outputs bypass the reducer-owned packet surfaces; both auto and confirm flows still target `findings-registry.json` and `deep-research-dashboard.md` as synchronized outputs (.opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:83-84; .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:197; .opencode/commands/spec_kit/assets/spec_kit_deep-research_confirm.yaml:83-84; .opencode/commands/spec_kit/assets/spec_kit_deep-research_confirm.yaml:196-217).

### No hidden bridge appeared in the active reducer path: the deep-research reducer still has no MCP/tool client imports and no graph-event parsing branch, so the bridge is not merely buried deeper in the same file (.opencode/skills/sk-deep-research/scripts/reduce-state.cjs:11-12; .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:246-247). -- BLOCKED (iteration 3, 1 attempts)
- What was tried: No hidden bridge appeared in the active reducer path: the deep-research reducer still has no MCP/tool client imports and no graph-event parsing branch, so the bridge is not merely buried deeper in the same file (.opencode/skills/sk-deep-research/scripts/reduce-state.cjs:11-12; .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:246-247).
- Why blocked: Repeated iteration evidence ruled this direction out.
...
### The graph layer is not purely nominal overall; the shared MCP convergence handler can block STOP on graph-derived coverage gaps, contradictions, unverified claims, source diversity, and evidence depth when it is actually invoked (.opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:122-163; .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:225-275; .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:330-355). -- BLOCKED (iteration 2, 1 attempts)
- What was tried: The graph layer is not purely nominal overall; the shared MCP convergence handler can block STOP on graph-derived coverage gaps, contradictions, unverified claims, source diversity, and evidence depth when it is actually invoked (.opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:122-163; .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:225-275; .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:330-355).
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: The graph layer is not purely nominal overall; the shared MCP convergence handler can block STOP on graph-derived coverage gaps, contradictions, unverified claims, source diversity, and evidence depth when it is actually invoked (.opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:122-163; .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:225-275; .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:330-355).
...
### This is not a bad gate taxonomy problem. The blocked-stop fixture uses the same gate names and recovery semantics the contract publishes, so the issue is persistence/consumption drift rather than mislabeled review gates (`.opencode/skills/sk-deep-review/references/convergence.md:362-419`, `.opencode/skills/system-spec-kit/scripts/tests/fixtures/deep-loop-optimizer/sample-040-corpus.jsonl:4`). -- BLOCKED (iteration 10, 1 attempts)
- What was tried: This is not a bad gate taxonomy problem. The blocked-stop fixture uses the same gate names and recovery semantics the contract publishes, so the issue is persistence/consumption drift rather than mislabeled review gates (`.opencode/skills/sk-deep-review/references/convergence.md:362-419`, `.opencode/skills/system-spec-kit/scripts/tests/fixtures/deep-loop-optimizer/sample-040-corpus.jsonl:4`).
- Why blocked: Repeated iteration evidence ruled this direction out.
...
### This is not a blanket "any truncation breaks lifecycle" failure. If a truncated iteration file still includes a parseable finding bullet, `parseFindingLine()` and `buildFindingRegistry()` can still record the severity transition and mark the finding as repeated (`.opencode/skills/sk-deep-review/scripts/reduce-state.cjs:116-143`, `.opencode/skills/sk-deep-review/scripts/reduce-state.cjs:239-267`). -- BLOCKED (iteration 8, 1 attempts)
- What was tried: This is not a blanket "any truncation breaks lifecycle" failure. If a truncated iteration file still includes a parseable finding bullet, `parseFindingLine()` and `buildFindingRegistry()` can still record the severity transition and mark the finding as repeated (`.opencode/skills/sk-deep-review/scripts/reduce-state.cjs:116-143`, `.opencode/skills/sk-deep-review/scripts/reduce-state.cjs:239-267`).
- Why blocked: Repeated iteration evidence ruled this direction out.
...
### This is not a documentation-gap false alarm: both convergence references already define the shared enum, the legacy-label normalization rules, and the required blocked-stop persistence shape in detail (.opencode/skills/sk-deep-research/references/convergence.md:21-31; .opencode/skills/sk-deep-review/references/convergence.md:44-56). -- BLOCKED (iteration 5, 1 attempts)
- What was tried: This is not a documentation-gap false alarm: both convergence references already define the shared enum, the legacy-label normalization rules, and the required blocked-stop persistence shape in detail (.opencode/skills/sk-deep-research/references/convergence.md:21-31; .opencode/skills/sk-deep-review/references/convergence.md:44-56).
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: This is not a documentation-gap false alarm: both convergence references already define the shared enum, the legacy-label normalization rules, and the required blocked-stop persistence shape in detail (.opencode/skills/sk-deep-research/references/convergence.md:21-31; .opencode/skills/sk-deep-review/references/convergence.md:44-56).

### This is not a reducer-only discard bug. The visible YAML workflow never emits journal events into the reducer input path in the first place, so the contract break begins upstream of `reduce-state.cjs`. (`.opencode/commands/improve/assets/improve_agent-improver_auto.yaml:149-167`, `.opencode/commands/improve/assets/improve_agent-improver_confirm.yaml:173-201`, `.opencode/skills/sk-improve-agent/scripts/reduce-state.cjs:489-503`) -- BLOCKED (iteration 19, 1 attempts)
...
### This is not because contradiction tooling is missing. The shared contradiction scanner and MCP convergence handler already implement contradiction-aware blocking logic (`.opencode/skills/system-spec-kit/scripts/lib/coverage-graph-contradictions.cjs:37-158`, `.opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:200-264`). -- BLOCKED (iteration 6, 1 attempts)
...
### This is not limited to one loop. Both research and review convergence references promise graph-aware gate participation, but both active auto workflows keep STOP evaluation inline and local (`.opencode/skills/sk-deep-research/references/convergence.md:1181-1205`, `.opencode/skills/sk-deep-review/references/convergence.md:661-683`, `.opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:250-277`, `.opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml:343-375`). -- BLOCKED (iteration 6, 1 attempts)
- What was tried: This is not limited to one loop. Both research and review convergence references promise graph-aware gate participation, but both active auto workflows keep STOP evaluation inline and local (`.opencode/skills/sk-deep-research/references/convergence.md:1181-1205`, `.opencode/skills/sk-deep-review/references/convergence.md:661-683`, `.opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:250-277`, `.opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml:343-375`).
- Why blocked: Repeated iteration evidence ruled this direction out.
...
### This is not primarily a threshold-value bug: the shipped trade-off thresholds and weak-benchmark stop thresholds are internally consistent with config, so the problem is missing sample-size enforcement and signal loss across consumers, not a simple off-by-one constant mismatch. (`.opencode/skills/sk-improve-agent/assets/improvement_config.json:72-79`, `.opencode/skills/sk-improve-agent/assets/improvement_config.json:100-123`, `.opencode/skills/sk-improve-agent/scripts/trade-off-detector.cjs:40-49`) -- BLOCKED (iteration 17, 1 attempts)
- What was tried: This is not primarily a threshold-value bug: the shipped trade-off thresholds and weak-benchmark stop thresholds are internally consistent with config, so the problem is missing sample-size enforcement and signal loss across consumers, not a simple off-by-one constant mismatch. (`.opencode/skills/sk-improve-agent/assets/improvement_config.json:72-79`, `.opencode/skills/sk-improve-agent/assets/improvement_config.json:100-123`, `.opencode/skills/sk-improve-agent/scripts/trade-off-detector.cjs:40-49`)
- Why blocked: Repeated iteration evidence ruled this direction out.
- Do NOT retry: This is not primarily a threshold-value bug: the shipped trade-off thresholds and weak-benchmark stop thresholds are internally consistent with config, so the problem is missing sample-size enforcement and signal loss across consumers, not a simple off-by-one constant mismatch. (`.opencode/skills/sk-improve-agent/assets/improvement_config.json:72-79`, `.opencode/skills/sk-improve-agent/assets/improvement_config.json:100-123`, `.opencode/skills/sk-improve-agent/scripts/trade-off-detector.cjs:40-49`)
...
- .opencode/agents/deep-research.md:159-166 (iteration 1)
- .opencode/skills/sk-deep-research/references/loop_protocol.md:190-198 (iteration 1)
- .opencode/skills/sk-deep-research/references/loop_protocol.md:247-255 (iteration 1)
- .opencode/skills/sk-deep-research/references/loop_protocol.md:77-84 (iteration 1)
- .opencode/skills/sk-deep-research/references/state_format.md:145-177 (iteration 1)
- .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:103-127 (iteration 1)
- .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:438-444 (iteration 1)
- .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:489-502 (iteration 1)
- .opencode/skills/sk-deep-research/SKILL.md:190-199 (iteration 1)
...
- No evidence that YAML workflow outputs bypass the reducer-owned packet surfaces; both auto and confirm flows still target `findings-registry.json` and `deep-research-dashboard.md` as synchronized outputs (.opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:83-84; .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:197; .opencode/commands/spec_kit/assets/spec_kit_deep-research_confirm.yaml:83-84; .opencode/commands/spec_kit/assets/spec_kit_deep-research_confirm.yaml:196-217). (iteration 1)
- .opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:326 (iteration 2)
- .opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml:436-437 (iteration 2)
- .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:103-127 (iteration 2)
- .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:489-502 (iteration 2)
- .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:109-163 (iteration 2)
- .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:20-25 (iteration 2)
- .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:245-275 (iteration 2)
- .opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:343-355 (iteration 2)
- .opencode/skills/system-spec-kit/scripts/lib/coverage-graph-contradictions.cjs:37-67 (iteration 2)
- .opencode/skills/system-spec-kit/scripts/lib/coverage-graph-contradictions.cjs:85-129 (iteration 2)
...
- .opencode/agents/agent-improver.md:175-177 (iteration 3)
- .opencode/skills/sk-deep-research/references/convergence.md:1181-1205 (iteration 3)
- .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:11-12 (iteration 3)
- .opencode/skills/sk-deep-review/references/convergence.md:658-683 (iteration 3)
- .opencode/skills/sk-improve-agent/scripts/mutation-coverage.cjs:16-67 (iteration 3)
- .opencode/skills/sk-improve-agent/SKILL.md:294-300 (iteration 3)
- .opencode/skills/system-spec-kit/mcp_server/tests/coverage-graph-db.vitest.ts:135-185 (iteration 3)
- .opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:779-869 (iteration 3)
...
- No hidden bridge appeared in the active reducer path: the deep-research reducer still has no MCP/tool client imports and no graph-event parsing branch, so the bridge is not merely buried deeper in the same file (.opencode/skills/sk-deep-research/scripts/reduce-state.cjs:11-12; .opencode/skills/sk-deep-research/scripts/reduce-state.cjs:246-247). (iteration 3)
- The shared graph capability itself is not missing; the missing piece is runtime wiring. The MCP tool layer already exposes both `deep_loop_graph_upsert` and `deep_loop_graph_convergence` with reducer-oriented contracts (.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:779-823; .opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:856-869). (iteration 3)
...
- This is not isolated to one loop. The research and review auto YAMLs both classify the same lineage branches while only surfacing a smaller event set in the active runtime path (`.opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:128-153`, `.opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml:155-177`). (iteration 4)
- This is not just a documentation omission. Both convergence references are explicit about first-class blocked-stop persistence and full gate bundles, so the drift is between published contract and live workflow serialization, not between two equally vague docs (`.opencode/skills/sk-deep-research/references/convergence.md:305-309`, `.opencode/skills/sk-deep-review/references/convergence.md:58-85`). (iteration 4)
- `stuckRecovery` is not entirely absent from runtime serialization, but the only concrete live record I found is review's raw `stuck_recovery` event; that is weaker than the documented shared enum contract and does not prove consumer-visible normalization (.opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml:375-383). (iteration 5)
...
- This is not a documentation-gap false alarm: both convergence references already define the shared enum, the legacy-label normalization rules, and the required blocked-stop persistence shape in detail (.opencode/skills/sk-deep-research/references/convergence.md:21-31; .opencode/skills/sk-deep-review/references/convergence.md:44-56). (iteration 5)
...
- This is not limited to one loop. Both research and review convergence references promise graph-aware gate participation, but both active auto workflows keep STOP evaluation inline and local (`.opencode/skills/sk-deep-research/references/convergence.md:1181-1205`, `.opencode/skills/sk-deep-review/references/convergence.md:661-683`, `.opencode/commands/spec_kit/assets/spec_kit_deep-research_auto.yaml:250-277`, `.opencode/commands/spec_kit/assets/spec_kit_deep-review_auto.yaml:343-375`). (iteration 6)
...
- This is not a blanket "any truncation breaks lifecycle" failure. If a truncated iteration file still includes a parseable finding bullet, `parseFindingLine()` and `buildFindingRegistry()` can still record the severity transition and mark the finding as repeated (`.opencode/skills/sk-deep-review/scripts/reduce-state.cjs:116-143`, `.opencode/skills/sk-deep-review/scripts/reduce-state.cjs:239-267`). (iteration 8)
...
- This is not a bad gate taxonomy problem. The blocked-stop fixture uses the same gate names and recovery semantics the contract publishes, so the issue is persistence/consumption drift rather than mislabeled review gates (`.opencode/skills/sk-deep-review/references/convergence.md:362-419`, `.opencode/skills/system-spec-kit/scripts/tests/fixtures/deep-loop-optimizer/sample-040-corpus.jsonl:4`). (iteration 10)
...
- `step_reduce_review_state` in both auto + confirm YAML workflows now invokes `node .opencode/skills/sk-deep-review/scripts/reduce-state.cjs {spec_folder}`
...
CJS (scripts/lib):
- `.opencode/skills/system-spec-kit/scripts/lib/coverage-graph-core.cjs` (edge manager, relation weights)
- `.opencode/skills/system-spec-kit/scripts/lib/coverage-graph-signals.cjs` (degree, depth, momentum)
- `.opencode/skills/system-spec-kit/scripts/lib/coverage-graph-contradictions.cjs` (contradiction scanning)
- `.opencode/skills/system-spec-kit/scripts/lib/coverage-graph-convergence.cjs` (STOP-blocking guards)

TypeScript (mcp_server/handlers + lib):
- `.opencode/skills/system-spec-kit/mcp_server/lib/coverage-graph/coverage-graph-db.ts` (SQLite schema, CRUD)
- `.opencode/skills/system-spec-kit/mcp_server/lib/coverage-graph/coverage-graph-query.ts` (query layer)
- `.opencode/skills/system-spec-kit/mcp_server/lib/coverage-graph/coverage-graph-signals.ts` (signal computation)

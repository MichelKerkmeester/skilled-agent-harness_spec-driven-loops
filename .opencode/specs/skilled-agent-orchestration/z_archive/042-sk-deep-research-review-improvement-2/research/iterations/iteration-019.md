...
- `.opencode/commands/deep/assets/improve_agent-improver_auto.yaml:111-167`
- `.opencode/commands/deep/assets/improve_agent-improver_confirm.yaml:144-201`
- `.opencode/skills/sk-improve-agent/scripts/improvement-journal.cjs:78-104`
- `.opencode/skills/sk-improve-agent/scripts/improvement-journal.cjs:242-275`
- `.opencode/skills/sk-improve-agent/scripts/reduce-state.cjs:42-54`
- `.opencode/skills/sk-improve-agent/scripts/reduce-state.cjs:425-503`
...
Rotate back to D5 and run one final upstream-to-downstream audit on improve-agent coverage-graph usage. The most productive closeout is to compare any graph-writing helpers or documented graph-aware claims against the visible `/deep:start-agent-improvement-loop` command/YAML/reducer path, then determine whether graph events and coverage decisions actually influence focus selection, stop gating, or contradiction handling, or whether they remain helper-only capability that never enters the operator-visible loop.

...
- `.opencode/commands/deep/start-agent-improvement-loop.md:294-339`
- `.opencode/skills/sk-improve-agent/SKILL.md:270-322`
- `.opencode/skills/sk-improve-agent/scripts/improvement-journal.cjs:47-67`
- `.opencode/skills/sk-improve-agent/scripts/improvement-journal.cjs:168-203`
- `.opencode/skills/sk-improve-agent/scripts/reduce-state.cjs:145-235`
- `.opencode/skills/sk-improve-agent/scripts/reduce-state.cjs:259-332`
- `.opencode/skills/sk-improve-agent/scripts/reduce-state.cjs:371-503`
- `.opencode/skills/sk-improve-agent/scripts/candidate-lineage.cjs:47-109`
- `.opencode/skills/sk-improve-agent/scripts/trade-off-detector.cjs:130-172`
- `.opencode/skills/sk-improve-agent/scripts/benchmark-stability.cjs:95-171`
- `.opencode/skills/sk-improve-agent/assets/improvement_strategy.md:123-136`
- `.opencode/skills/sk-improve-agent/manual_testing_playbook/06--end-to-end-loop/023-trade-off-detection.md:20-35`
- `.opencode/skills/sk-improve-agent/manual_testing_playbook/06--end-to-end-loop/024-candidate-lineage.md:20-34`

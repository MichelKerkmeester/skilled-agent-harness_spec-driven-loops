---
title: "Feature Specification: sk-design-interface variation diversity"
description: "Add a seed-of-thought variation-diversity mechanism to sk-design-interface: when a brief asks for two or more directions, a committed random seed picks a non-median start in a subject-grounded option space and the rest are spread to be distinct, with grounding and the anti-default critique still primary and never a style chooser."
trigger_phrases:
  - "sk-design-interface variation diversity"
...
_memory:
  continuity:
    ...
    answered_questions: []
---
# Feature Specification: sk-design-interface variation diversity
...
|-----------|-------------|-------------|
| `.opencode/skills/sk-design-interface/references/variation_diversity.md` | Create | The seed-of-thought debias mechanism |
| `.opencode/skills/sk-design-interface/SKILL.md` | Modify | Version bump plus the routing and ALWAYS hook |
| `.opencode/skills/sk-design-interface/changelog/v1.2.0.0.md` | Create | Release notes for the mechanism |
| `.opencode/skills/sk-design-interface/graph-metadata.json` | Modify | Register the reference and refresh routing |
| `.opencode/skills/sk-design-interface/README.md` | Modify | List the new reference |
<!-- /ANCHOR:scope -->
...
- **SC-001**: `package_skill.py .opencode/skills/sk-design-interface --check` prints PASS.
...
### Routing
- **NFR-R01**: The advisor still surfaces `sk-design-interface` on design intent after the change.
...
- **The skill**: `.opencode/skills/sk-design-interface/` (SKILL.md, references/variation_diversity.md, changelog/v1.2.0.0.md)

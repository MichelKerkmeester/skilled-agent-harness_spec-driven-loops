...
TASK ID-002: A user asks: "Build the hero using exactly this direction: cream #F4F1EA background, a high-contrast serif display, and a terracotta accent. Do not change the palette." Produce the plan the skill directs for a brief that PINS the visual direction.

TASK ID-003: A user asks: "Check this finished landing page against the accessibility and quality floor and tell me what fails before I ship." The finished landing page is the file .opencode/specs/skilled-agent-orchestration/154-design-skill-integration-test/designs/mimo/01-meridian-roasters.html - read it and grade it against the skill's quality floor (contrast, focus, reduced motion, touch targets, responsive). Name each failing rule and a fix.

...
This packet turned Open Design from a researched possibility into the live design transport for agent work. It built `mcp-open-design`, de-vendored and strengthened `sk-interface-design`, added `sk-prompt` support for design-generation briefs and retired `mcp-magicpath` after the local terminal path was live-verified. The final doctrine is simple: Open Design is the transport, `sk-interface-design` is the mandatory design judgment and the docs now reflect the live multi-turn run flow rather than the early one-shot assumption.
...
| [`003-sk-interface-design-evolution`](./changelog-145-003-sk-interface-design-evolution.md) | DONE | Removed MIT-derived assets from `sk-interface-design` and rewired it to live Open Design reads. |
...
| [`005-sk-interface-design-variation-diversity`](./changelog-145-005-sk-interface-design-variation-diversity.md) | DONE | Added a grounded variation-diversity mechanism for multi-direction design briefs. |
...
| [`011-mandatory-interface-design-coupling`](./changelog-145-011-mandatory-interface-design-coupling.md) | DONE | Made `sk-interface-design` a hard precondition for any design work through Open Design. |
...
- `sk-interface-design` variation-diversity guidance and mandatory Open Design coupling.
...
- `sk-interface-design` moved from vendored MIT-derived data to Apache-2.0-only live grounding through Open Design.
...
- Manual playbooks and catalogs now state that design work requires `sk-interface-design`, while pure wiring and bare inventory remain exempt.
...
| `.opencode/skills/sk-interface-design/` | Updated | De-vendored data, live Open Design grounding, variation diversity, mandatory coupling and playbook refinement. |

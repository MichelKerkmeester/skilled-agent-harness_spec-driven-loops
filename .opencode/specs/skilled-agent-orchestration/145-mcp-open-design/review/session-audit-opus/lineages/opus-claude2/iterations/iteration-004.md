...
**Files reviewed**: `mcp-open-design/SKILL.md` (re-read §5/§8), `sk-interface-design/SKILL.md` (re-read §4/§7 + frontmatter), `sk-interface-design/references/claude_design_parity.md` (hygiene), cross-skill `SKILL.md` section-naming convention (sk-git, sk-doc, mcp-figma), tree-wide `version:` frontmatter survey, ephemeral-id hygiene grep over `sk-interface-design/references/`

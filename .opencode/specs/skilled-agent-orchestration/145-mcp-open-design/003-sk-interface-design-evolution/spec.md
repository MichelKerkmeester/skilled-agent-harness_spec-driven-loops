---
title: "Feature Specification: sk-interface-design evolution"
description: "Record of de-vendoring sk-interface-design from the MIT ui-ux-pro-max repo to an Apache-2.0-only v1.1.0 (ordered: data first, MIT notices second, Apache base kept) and wiring the Open Design integration through the shared claude_design_parity.md loop (live-read only, never cached). Already shipped as commit b12ffd3d76."
trigger_phrases:
  - "sk-interface-design de-vendor"
...
_memory:
  continuity:
    packet_pointer: "skilled-agent-orchestration/145-mcp-open-design/003-sk-interface-design-evolution"
    last_updated_at: "2026-06-14T16:30:00Z"
    last_updated_by: "claude-opus"
    recent_action: "Documented the shipped sk-interface-design v1.1.0 de-vendor (commit b12ffd3d76)"
    ...
    answered_questions: []
---
# Feature Specification: sk-interface-design evolution
...
|-----------|-------------|-------------|
| `.opencode/skills/sk-interface-design/assets/data/*.csv` (nine files) | Removed | The MIT-derived data inventory deleted first |
| `.opencode/skills/sk-interface-design/assets/data/README.md` | Removed | The vendored data README |
| `.opencode/skills/sk-interface-design/scripts/design_search*.py` | Removed | The scripts that queried the vendored data |
| `.opencode/skills/sk-interface-design/LICENSE-ui-ux-pro-max.txt` | Removed | The MIT notice, removed after the data |
| `.opencode/skills/sk-interface-design/THIRD-PARTY-NOTICES.md` | Removed | The MIT third-party notices, removed after the data |
| `.opencode/skills/sk-interface-design/references/claude_design_parity.md` | Modified | Open Design integration, live-read-only sourcing |
| `.opencode/skills/sk-interface-design/references/design_inventory.md` | Modified | Reframed around live Open Design systems |
| `.opencode/skills/sk-interface-design/SKILL.md` | Modified | Apache-2.0-only, Open Design grounding, version 1.1.0 |
| `.opencode/skills/sk-interface-design/feature_catalog/` | Modified | Design-grounding section reframed to Open Design live reads |
| `.opencode/skills/sk-interface-design/manual_testing_playbook/` | Modified | Licensing-integrity and grounding scenarios reframed |
| `.opencode/skills/sk-interface-design/changelog/v1.1.0.0.md` | Created | De-vendor and integration changelog |
| `.opencode/skills/sk-interface-design/graph-metadata.json` | Modified | Topics, edges, source docs |
<!-- /ANCHOR:scope -->
...
- **SC-001**: The skill at `.opencode/skills/sk-interface-design/` is Apache-2.0-only with no MIT-derived data, scripts, or notices remaining (delivered in commit `b12ffd3d76`).

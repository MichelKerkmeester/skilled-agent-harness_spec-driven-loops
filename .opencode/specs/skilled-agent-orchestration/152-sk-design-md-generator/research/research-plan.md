...
4. After each wave: `node .opencode/skills/deep-loop-workflows/deep-research/scripts/reduce-state.cjs .opencode/specs/skilled-agent-orchestration/152-sk-design-md-generator` (refreshes strategy machine-sections + dashboard + findings-registry).

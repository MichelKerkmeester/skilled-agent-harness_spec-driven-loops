...
- Registry has seven modes, including `context` and three improvement lanes, so hardcoded maps are already not isomorphic with the registry. Evidence: `.opencode/skills/deep-loop-workflows/mode-registry.json:10-98`.

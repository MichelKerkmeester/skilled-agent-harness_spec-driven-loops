...
```json
{
  ...
  "open_questions": [
    ...
    "Should Python --deep-skill-routing-json expose all seven workflow modes or only the historical Candidate-3 modes plus a separate advisor mode layer?",

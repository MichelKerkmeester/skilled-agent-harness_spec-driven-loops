---
title: "Changelog: Parent nested skill pattern root [117-parent-nested-skill-pattern/root]"
...
> Spec folder: `.opencode/specs/skilled-agent-orchestration/117-parent-nested-skill-pattern` (Level Phase Parent)
...
| `.opencode/specs/skilled-agent-orchestration/117-parent-nested-skill-pattern/research/research.md` | Updated | Research routing class reconciled from 3 to 4 by adding alias-fold. |

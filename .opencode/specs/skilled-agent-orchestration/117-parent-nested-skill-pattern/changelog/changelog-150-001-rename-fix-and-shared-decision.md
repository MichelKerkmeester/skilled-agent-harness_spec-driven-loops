---
title: "Changelog: Fix the four-folder rename and record the shared decision [117-parent-nested-skill-pattern/001-rename-fix-and-shared-decision]"
...
> Spec folder: `.opencode/specs/skilled-agent-orchestration/117-parent-nested-skill-pattern/001-rename-fix-and-shared-decision` (Level 2)

...
- [x] T005 Decide whether the optional drift fixture lands in this packet or is deferred with rationale `[Evidence: ls .opencode/skill/skill-advisor/scripts/check-prompt-quality-card-sync.sh; bash .opencode/skill/skill-advisor/scripts/check-prompt-quality-card-sync.sh -> SYNC OK]`
<!-- /ANCHOR:phase-1 -->

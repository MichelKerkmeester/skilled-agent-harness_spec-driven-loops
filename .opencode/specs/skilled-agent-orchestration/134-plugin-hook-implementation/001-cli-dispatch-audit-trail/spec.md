...
### Purpose
As the foundation phase of packet 134, stand up the repo's first post-execution telemetry loop: append one redacted, size-rotated JSONL audit line after every completed CLI dispatch, over a shared core reused by both runtimes and by later phases.
<!-- /ANCHOR:problem -->

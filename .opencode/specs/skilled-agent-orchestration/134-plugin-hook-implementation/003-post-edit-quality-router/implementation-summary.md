...
```bash
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/134-plugin-hook-implementation/003-post-edit-quality-router --strict
```

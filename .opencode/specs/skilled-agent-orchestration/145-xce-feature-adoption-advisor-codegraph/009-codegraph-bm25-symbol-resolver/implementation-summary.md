...
| `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/145-xce-feature-adoption-advisor-codegraph/009-codegraph-bm25-symbol-resolver --strict` | PASS |
<!-- /ANCHOR:verification -->

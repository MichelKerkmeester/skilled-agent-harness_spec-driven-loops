...
- **Spec folder: `.opencode/specs/skilled-agent-orchestration/150-mcp-open-design` (pre-approved — skip Gate 3).** This is a shared working tree with other active sessions: you may WRITE exactly ONE file — `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/150-mcp-open-design/001-terminal-control-and-integration-research/research/seats/seat-a.findings.md`. Do NOT create, modify, move, or delete ANY other file. Do NOT run `git` or any mutating/install command.

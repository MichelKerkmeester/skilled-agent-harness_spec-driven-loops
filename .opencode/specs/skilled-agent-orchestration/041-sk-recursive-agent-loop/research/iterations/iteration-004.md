...
## Findings
1. `autoagent-main` expects a local experiment ledger, not just git history. `results.tsv`, `run.log`, and `jobs/` are runtime artifacts, and `program.md` requires an initialized baseline plus repeatable reruns from the same commit to measure variance. [SOURCE: .opencode/specs/skilled-agent-orchestration/041-sk-agent-improver-loop/external/autoagent-main/.gitignore:13] [SOURCE: .opencode/specs/skilled-agent-orchestration/041-sk-agent-improver-loop/external/autoagent-main/program.md:33] [SOURCE: .opencode/specs/skilled-agent-orchestration/041-sk-agent-improver-loop/external/autoagent-main/program.md:138]
2. A discarded run is still a useful run. `program.md` explicitly says to mine rejected iterations for newly solved tasks, regressions, missing capabilities, and verifier mismatch signals before selecting the next change. [SOURCE: .opencode/specs/skilled-agent-orchestration/041-sk-agent-improver-loop/external/autoagent-main/program.md:160] [SOURCE: .opencode/specs/skilled-agent-orchestration/041-sk-agent-improver-loop/external/autoagent-main/program.md:171]
3. The simplicity tie-break is concrete rather than aesthetic. Equal `passed` should prefer fewer components, fewer special cases, simpler prompts, simpler tool interfaces, and less brittle logic, while "small gains with ugly complexity" are explicitly suspect. [SOURCE: .opencode/specs/skilled-agent-orchestration/041-sk-agent-improver-loop/external/autoagent-main/program.md:89] [SOURCE: .opencode/specs/skilled-agent-orchestration/041-sk-agent-improver-loop/external/autoagent-main/program.md:109]
4. The loop isolates infrastructure failures from harness failures. The ledger schema includes crash tracking, but infra failures are supposed to be repaired and rerun instead of being treated as real regressions in the mutation target. [SOURCE: .opencode/specs/skilled-agent-orchestration/041-sk-agent-improver-loop/external/autoagent-main/program.md:127] [SOURCE: .opencode/specs/skilled-agent-orchestration/041-sk-agent-improver-loop/external/autoagent-main/program.md:136] [SOURCE: .opencode/specs/skilled-agent-orchestration/041-sk-agent-improver-loop/external/autoagent-main/program.md:204]
...
## Sources Consulted
- .opencode/specs/skilled-agent-orchestration/041-sk-agent-improver-loop/external/autoagent-main/.gitignore:13
- .opencode/specs/skilled-agent-orchestration/041-sk-agent-improver-loop/external/autoagent-main/program.md:33
- .opencode/specs/skilled-agent-orchestration/041-sk-agent-improver-loop/external/autoagent-main/program.md:89
- .opencode/specs/skilled-agent-orchestration/041-sk-agent-improver-loop/external/autoagent-main/program.md:160

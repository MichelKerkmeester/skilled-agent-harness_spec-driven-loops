...
## Focus
Infer the most repo-native package shape for a future `sk-agent-improver` and decide whether it should be skill-only or paired with a command/workflow layer.

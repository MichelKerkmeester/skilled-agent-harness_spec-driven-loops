...
Map the external loop onto our current `.opencode/agent`, `sk-deep-research`, and skill infrastructure to separate what we already have from what a future `sk-improve-agent` would still need.

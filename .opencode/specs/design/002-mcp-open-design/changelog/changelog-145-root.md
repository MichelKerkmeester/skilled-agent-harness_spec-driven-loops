...
> Spec folder: `.opencode/specs/design/002-mcp-open-design` (Level Phase Parent)
...
| `.opencode/specs/design/002-mcp-open-design/*` | Created and updated | Parent control files and 12 completed phase children. |

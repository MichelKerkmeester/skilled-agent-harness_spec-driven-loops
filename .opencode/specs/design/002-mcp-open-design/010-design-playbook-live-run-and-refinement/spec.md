...
_memory:
  continuity:
    ...
    next_safe_action: "Validate, commit, then restructure 157 under 145-mcp-open-design"
    blockers: []
    key_files:
      ...
      - ".opencode/specs/design/002-mcp-open-design/010-design-playbook-live-run-and-refinement/scratch/results-matrix.md"
    session_dedup:

...
_memory:
  continuity:
    ...
    open_questions: []
    answered_questions:
      - "Numbering: generator=151, rename=152 (151 reserved for kasper)"
...
- None — numbering and breadth resolved with the user (generator=151, rename=152; rewrite history with pointer reconciliation).
<!-- /ANCHOR:questions -->

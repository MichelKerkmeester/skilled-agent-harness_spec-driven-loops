...
<!-- ANCHOR:references -->
- Review target: `.opencode/specs/design/001-sk-design-interface/003-ui-ux-pro-max-merge/` (spec.md, plan.md, tasks.md, checklist.md, implementation-summary.md). [SOURCE: file:.opencode/specs/design/001-sk-design-interface/003-ui-ux-pro-max-merge/spec.md]
- Source recommendation: `../002-ui-ux-pro-max-merge-research/research/research.md`. [SOURCE: file:.opencode/specs/design/001-sk-design-interface/002-ui-ux-pro-max-merge-research/research/research.md]

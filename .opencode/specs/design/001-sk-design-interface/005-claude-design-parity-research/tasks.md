...
description: "Task breakdown for the 10-iteration parallel-by-model deep-research loop on Claude Design parity for sk-design-interface and mcp-magicpath. All tasks complete; deliverable is research/research.md."
trigger_phrases:
  - "claude design parity tasks"
  - "sk-design-interface mcp-magicpath research tasks"
...
- Skills under study: `.opencode/skills/sk-design-interface/`, `.opencode/skills/mcp-magicpath/`
<!-- /ANCHOR:cross-refs -->

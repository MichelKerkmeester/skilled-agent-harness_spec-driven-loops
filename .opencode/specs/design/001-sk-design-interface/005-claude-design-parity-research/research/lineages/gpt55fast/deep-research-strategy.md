...
- Packet objective: `.opencode/specs/design/001-sk-design-interface/005-claude-design-parity-research/spec.md` defines a research-only parity analysis across design-system inheritance, iteration and visual feedback, context grounding, quality levers, and output/handoff.

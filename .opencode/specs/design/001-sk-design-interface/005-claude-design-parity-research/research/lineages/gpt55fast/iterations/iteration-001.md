...
- `.opencode/specs/design/001-sk-design-interface/005-claude-design-parity-research/spec.md`
...
Map the dimensions onto `sk-design-interface`: design-system inheritance, context grounding, feedback loop, quality levers, and handoff.

...
description: "Plan for a 10-iteration parallel-by-model deep-research loop assessing how to improve sk-design-interface and mcp-magicpath toward Claude Design parity. Research-only; deliverable is a recommendation."
trigger_phrases:
  - "claude design parity plan"
  - "sk-design-interface mcp-magicpath research plan"
...
|---------|--------------|--------|--------------|
| `sk-design-interface/` | Skill under study | unchanged (read-only) | no diff |

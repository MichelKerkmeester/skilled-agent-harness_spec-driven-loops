...
- [x] T003 Strip Open Design naming from sk-design-interface SKILL.md, README.md, design_inventory.md, design_references_mcp.md, variation_diversity.md, graph-metadata.json
...
- [x] T006 Version bumps + changelogs (sk-design-interface v1.4.0.0, mcp-open-design v1.4.0.0)
<!-- /ANCHOR:phase-2 -->
...
- [x] T007 grep: zero Open Design naming in sk-design-interface live content; reverse coupling intact in mcp-open-design

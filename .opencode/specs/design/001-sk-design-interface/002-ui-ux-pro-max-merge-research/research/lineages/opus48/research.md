...
- External repo: `.opencode/specs/design/001-sk-design-interface/external/ui-ux-pro-max-skill-main/` (MIT) — `LICENSE`, `skill.json`, `CLAUDE.md`, `.claude/skills/ui-ux-pro-max/SKILL.md`, `src/ui-ux-pro-max/data/*.csv`, `src/ui-ux-pro-max/scripts/{core,search,design_system}.py`.

...
5. The guidelines article says guidelines can include coding/personality rules, design-system rules, variant rules, and explicit "don't" constraints; it also advises that more context is not always better. This maps almost directly to a future `sk-design-interface` design-brief/context artifact. [SOURCE: https://help.figma.com/hc/en-us/articles/33665861260823-Add-guidelines-to-Figma-Make]

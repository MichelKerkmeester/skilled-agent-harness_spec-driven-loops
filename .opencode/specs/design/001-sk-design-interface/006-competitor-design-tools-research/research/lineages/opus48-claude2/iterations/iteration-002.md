...
- **Relevance:** Plan/build separation. `sk-design-interface` already does this (brainstorm→critique→build, "iterate in thinking, show at higher confidence"). OVERLAP / already-have. Minor.

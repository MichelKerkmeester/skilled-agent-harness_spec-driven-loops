...
<!-- ANCHOR:references -->
- **Dedup baseline:** `.opencode/specs/design/001-sk-design-interface/005-claude-design-parity-research/research/research.md` (Claude Design parity, COMPLETE). [SOURCE: file:.opencode/specs/design/001-sk-design-interface/005-claude-design-parity-research/research/research.md]

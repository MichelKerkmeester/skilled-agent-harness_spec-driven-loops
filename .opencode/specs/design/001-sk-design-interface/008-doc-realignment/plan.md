...
description: "Plan for realigning the sk-design-interface feature catalog, playbook, and README, and the mcp-magicpath READMEs, to the post-007 parity reality, via fresh opus markdown agents."
trigger_phrases:
...
### Key Components
- **Agent A**: sk-design-interface feature_catalog.
- **Agent B**: sk-design-interface manual_testing_playbook + README.
...
|---------|--------------|--------|--------------|
| sk-design-interface feature_catalog | New parity section | add (Agent A) | validate_document, count |
| sk-design-interface manual_testing_playbook + README | New parity scenarios + mention | add (Agent B) | validate_document, count |

...
- The phase spec asks for a per-mode expansion matrix with type, what it adds, corpus source, effort, and do-not-add lists [SOURCE: .opencode/specs/design/008-sk-design-parent/009-reference-asset-expansion/spec.md:57].
...
- `.opencode/specs/design/008-sk-design-parent/009-reference-asset-expansion/spec.md:57`

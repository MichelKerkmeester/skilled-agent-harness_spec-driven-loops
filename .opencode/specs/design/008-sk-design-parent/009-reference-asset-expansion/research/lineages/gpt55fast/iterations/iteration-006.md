...
- Add a forward-authoring reference, not a new backend. `stitch-skill` describes generating `DESIGN.md` files from atmosphere, color, typography, component behaviors, layout, motion, and anti-patterns rather than measured extraction [SOURCE: .opencode/specs/design/008-sk-design-parent/external/stitch-skill.md:17].
...
- `.opencode/specs/design/008-sk-design-parent/external/stitch-skill.md:17`

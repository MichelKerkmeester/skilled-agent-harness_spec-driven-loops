...
- Add a shared Brand/Product register first. Prior gap analysis calls it must-add and says it gates transform verbs, model-specific tells, remediation, mock content, and preflight [SOURCE: .opencode/specs/design/008-sk-design-parent/001-corpus-research/research/gap-analysis.md:41].
...
- Do not add full process lifecycle. Prior analysis classifies designer-skills process lifecycle as a scope ruling rather than a content gap [SOURCE: .opencode/specs/design/008-sk-design-parent/001-corpus-research/research/gap-analysis.md:28].
- Do not add slides/canvas/poster workflows to these five modes in this phase. The phase spec excludes taxonomy and net-new sub-skills, and prior analysis marks presentation/canvas as scope-ruling territory [SOURCE: .opencode/specs/design/008-sk-design-parent/009-reference-asset-expansion/spec.md:53], [SOURCE: .opencode/specs/design/008-sk-design-parent/001-corpus-research/research/gap-analysis.md:28].

## Sources Consulted

- `.opencode/specs/design/008-sk-design-parent/001-corpus-research/research/gap-analysis.md:41`
- `.opencode/specs/design/008-sk-design-parent/001-corpus-research/research/gap-analysis.md:47`
- `.opencode/skills/sk-design/shared/anti_slop_principles.md:24`
- `.opencode/specs/design/008-sk-design-parent/009-reference-asset-expansion/spec.md:53`

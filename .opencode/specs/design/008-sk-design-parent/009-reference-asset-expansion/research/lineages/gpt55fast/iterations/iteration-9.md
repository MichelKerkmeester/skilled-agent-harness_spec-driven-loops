...
- Write only under `.opencode/specs/design/008-sk-design-parent/009-reference-asset-expansion/research/lineages/gpt55fast`.
- Do not touch paths outside the lineage artifact directory.
- Bind `artifact_dir` directly to `.opencode/specs/design/008-sk-design-parent/009-reference-asset-expansion/research/lineages/gpt55fast`; do not run `resolveArtifactRoot`.
...
## Next Steps
- Create/write lineage packet files only under `.opencode/specs/design/008-sk-design-parent/009-reference-asset-expansion/research/lineages/gpt55fast`.
...
- External corpus has 43 entries under `.opencode/specs/design/008-sk-design-parent/external`.
...
- `.opencode/specs/design/008-sk-design-parent/009-reference-asset-expansion/research/lineages/gpt55fast`: only allowed write directory.
- `.opencode/specs/design/008-sk-design-parent/001-corpus-research/research/research.md`: prior architecture/corpus synthesis.
- `.opencode/specs/design/008-sk-design-parent/001-corpus-research/research/gap-analysis.md`: validated content-gap source.
- `.opencode/specs/design/008-sk-design-parent/external/`: 43-entry external corpus.
...
1. Authorize broader spec-folder fixes for `.opencode/specs/design/008-sk-design-parent/009-reference-asset-expansion`.

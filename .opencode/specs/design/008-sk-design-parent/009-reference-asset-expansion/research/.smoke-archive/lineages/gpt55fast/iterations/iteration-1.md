...
- Write only inside `.opencode/specs/design/008-sk-design-parent/009-reference-asset-expansion/research/lineages/gpt55fast`.
...
- Confirmed external corpus directory has 43 entries under `.opencode/specs/design/008-sk-design-parent/external`.
...
## Relevant Files
- `.opencode/specs/design/008-sk-design-parent/009-reference-asset-expansion/research/lineages/gpt55fast`: bound artifact dir; only allowed write target.
- `.opencode/specs/design/008-sk-design-parent/009-reference-asset-expansion/spec.md`: spec packet metadata; read-only due write constraint.
- `.opencode/specs/design/008-sk-design-parent/001-corpus-research/research/research.md`: prior architecture/corpus synthesis.
- `.opencode/specs/design/008-sk-design-parent/001-corpus-research/research/gap-analysis.md`: validated content gaps and severity.
- `.opencode/specs/design/008-sk-design-parent/external/`: 43-entry external design corpus.

...
Hypothesis confirmed. The plan requires every new or edited file to pass `validate_document.py` at `.opencode/specs/design/008-sk-design-parent/030-design-context-adoption/plan.md:46`. The implementation summary claims "PASS (0 issues) on all 18 files" at `.opencode/specs/design/008-sk-design-parent/030-design-context-adoption/implementation-summary.md:95`.

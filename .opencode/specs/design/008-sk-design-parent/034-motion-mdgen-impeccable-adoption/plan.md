---
title: "Implementation Plan: design-motion + design-md-generator impeccable adoption"
description: "Per-file build plan applying the design-motion + design-md-generator slice of the 028 impeccable backlog via cli-codex gpt-5.5 high fast, scope-locked, additive, skip-if-present, with independent fresh-Opus verification."
trigger_phrases:
  - "034-motion-mdgen-impeccable-adoption plan"
  - "impeccable motion+mdgen adoption plan"
  - "sk-design impeccable motion+mdgen plan"
...
_memory:
  continuity:
    ...
    recent_action: "Authored the motion+mdgen build plan"
    ...
    answered_questions: []
---
# Implementation Plan: design-motion + design-md-generator impeccable adoption
...
| Aspect | Value |
|--------|-------|
| **Language/Stack** | Markdown design-guidance docs in the design-motion + design-md-generator mode |
...
### Overview
Apply the motion+mdgen slice of the 028 backlog into the named live references via one scope-locked cli-codex dispatch, then an independent fresh-Opus reviewer verifies each item landed.
<!-- /ANCHOR:summary -->
...
### Definition of Ready
- [x] The 028 backlog names the motion+mdgen items + files
...
|---------|--------------|--------|--------------|
| `sk-design/design-motion/references/advanced_craft.md` | mode reference | add the named items | diff additive, fresh-Opus PASS |
| `sk-design/design-md-generator/references/quality_checklist.md` | mode reference | add the named items | diff additive, fresh-Opus PASS |
...
- Matrix axes: backlog motion+mdgen items x their references; skip-if-present per edit.

...
Segment: 1 | Iteration: 10 of 30
Questions remaining: 4/4 | Last 2 ratios: 0.28 -> 0.18
...
Last 3 Iterations Summary: run 7: Actual anti-pattern catalog semantics via the allowed detect (0.31); run 8: Remaining command-flow tail: extract/document/adapt/optimize (0.28); run 9: Synthesis pass over iterations 1-8: dedupe adoption backlog, (0.18)
...
- Write iteration narrative to: .opencode/specs/design/008-sk-design-parent/028-impeccable-design-research/research/iterations/iteration-010.md
- Write per-iteration delta file to: .opencode/specs/design/008-sk-design-parent/028-impeccable-design-research/research/deltas/iter-010.jsonl
...
1. **Iteration narrative markdown** at `.opencode/specs/design/008-sk-design-parent/028-impeccable-design-research/research/iterations/iteration-010.md` (path is pre-substituted for the current iteration number). Structure: headings for Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus.

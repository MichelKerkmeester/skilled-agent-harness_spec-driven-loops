...
Segment: 1 | Iteration: 5 of 30
Questions remaining: 4/4 | Last 2 ratios: 0.36 -> 0.34
...
[None yet]
Last 3 Iterations Summary: run 2: Audit/critique/polish/harden command references in impeccabl (0.47); run 3: Detector facade and STYLE prose denylist: classify detector  (0.36); run 4: Brand/product/color/type/layout command references: crosswal (0.34)
...
- Write iteration narrative to: .opencode/specs/design/008-sk-design-parent/028-impeccable-design-research/research/iterations/iteration-005.md
- Write per-iteration delta file to: .opencode/specs/design/008-sk-design-parent/028-impeccable-design-research/research/deltas/iter-005.jsonl
...
1. **Iteration narrative markdown** at `.opencode/specs/design/008-sk-design-parent/028-impeccable-design-research/research/iterations/iteration-005.md` (path is pre-substituted for the current iteration number). Structure: headings for Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus.

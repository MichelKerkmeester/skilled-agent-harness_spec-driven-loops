...
Segment: 1 | Iteration: 8 of 30
Questions remaining: 4/4 | Last 2 ratios: 0.29 -> 0.31
...
This iteration's focus (from strategy): Q4 remains open for final prioritized adoption order after the remaining command-flow references are read.
...
Last 3 Iterations Summary: run 5: Motion, delight, and interaction-design command references:  (0.32); run 6: Interface transformation and pre-build direction cluster: bo (0.29); run 7: Actual anti-pattern catalog semantics via the allowed detect (0.31)
...
- Write iteration narrative to: .opencode/specs/design/008-sk-design-parent/028-impeccable-design-research/research/iterations/iteration-008.md
- Write per-iteration delta file to: .opencode/specs/design/008-sk-design-parent/028-impeccable-design-research/research/deltas/iter-008.jsonl
...
1. **Iteration narrative markdown** at `.opencode/specs/design/008-sk-design-parent/028-impeccable-design-research/research/iterations/iteration-008.md` (path is pre-substituted for the current iteration number). Structure: headings for Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus.
...
3. **Per-iteration delta file** at `.opencode/specs/design/008-sk-design-parent/028-impeccable-design-research/research/deltas/iter-008.jsonl` (path pre-substituted for the current iteration — e.g. `deltas/iter-001.jsonl`). This file holds the structured delta stream for this iteration: one `{"type":"iteration",...}` record (same content as the state-log append) plus per-event structured records (one per graphEvent, finding, invariant, observation, edge, ruled_out direction). Each record on its own JSON line. The reducer reads the combined state log + delta files to rebuild dashboards and registries after interruption or partial runs.

...
> Artifact dir: `.opencode/specs/design/008-sk-design-parent/015-per-skill-improvement-research/001-interface/research/lineages/gpt55fast`
...
The benchmark evidence also differs from the prompt. The current report under `014-routing-benchmark/design-interface` says `CONDITIONAL` with aggregate `70/100`, not `78/100` [SOURCE: file:.opencode/specs/design/008-sk-design-parent/014-routing-benchmark/design-interface/skill-benchmark-report.md:5]. The bottleneck is `routed-intra`, specifically ID-011 preflight and ID-005 pure-logic abstention [SOURCE: file:.opencode/specs/design/008-sk-design-parent/014-routing-benchmark/design-interface/skill-benchmark-report.md:35] [SOURCE: file:.opencode/specs/design/008-sk-design-parent/014-routing-benchmark/design-interface/skill-benchmark-report.md:50] [SOURCE: file:.opencode/specs/design/008-sk-design-parent/014-routing-benchmark/design-interface/skill-benchmark-report.md:55].
...
The current report leaves D1-inter and D4 unscored in this run [SOURCE: file:.opencode/specs/design/008-sk-design-parent/014-routing-benchmark/design-interface/skill-benchmark-report.md:23]. Therefore, follow-up cannot honestly claim usefulness improvement from Mode A alone.

## 5. Prioritized Improvements

### P0 - Encode Route-Away Outcomes For Non-Design Prompts

ID-005 scores `31/100` and first-fails at `routed-intra` [SOURCE: file:.opencode/specs/design/008-sk-design-parent/014-routing-benchmark/design-interface/skill-benchmark-report.md:55]. The skill already says pure logic should use `sk-code` [SOURCE: file:.opencode/skills/sk-design/design-interface/SKILL.md:36], but the benchmark row observed empty resources and `agent: none` [SOURCE: file:.opencode/specs/design/008-sk-design-parent/014-routing-benchmark/design-interface/skill-benchmark-report.json:647].
...
Current interface handles redesign prompts, but lacks explicit preserve/overhaul intake. External corpus states redesign mode misclassification is the biggest source of bad redesign output and requires greenfield, preserve, or overhaul detection [SOURCE: file:.opencode/specs/design/008-sk-design-parent/external/taste-skill.md:783] [SOURCE: file:.opencode/specs/design/008-sk-design-parent/external/taste-skill.md:787].
...
- Audit before touching: brand tokens, IA, content blocks, patterns to preserve/retire, SEO baseline [SOURCE: file:.opencode/specs/design/008-sk-design-parent/external/taste-skill.md:794].
- Never change silently: URL slugs, nav labels, form field names/order, logo, legal/cookie copy [SOURCE: file:.opencode/specs/design/008-sk-design-parent/external/taste-skill.md:825].
...
- `.opencode/specs/design/008-sk-design-parent/014-routing-benchmark/design-interface/skill-benchmark-report.md`
- `.opencode/specs/design/008-sk-design-parent/014-routing-benchmark/design-interface/skill-benchmark-report.json`
- `.opencode/specs/design/008-sk-design-parent/external/taste-skill.md`
- `.opencode/specs/design/008-sk-design-parent/external/gpt-tasteskill.md`
- `.opencode/specs/design/008-sk-design-parent/external/redesign-skill.md`
- `.opencode/specs/design/008-sk-design-parent/external/impeccable.md`

...
| `.opencode/specs/design/008-sk-design-parent/014-routing-benchmark/design-audit/**` | Glob returned no files in this checkout; used as evidence for missing checked-in audit benchmark artifacts. |
...
| Resource | Use in this lineage |
| --- | --- |
| `.opencode/specs/design/008-sk-design-parent/009-reference-asset-expansion/research/research.md` | Baseline for what prior 009 research recommended and what is now implemented. Key evidence: audit expansion matrix lines 99-114; priority ranking lines 129-155; eliminated alternatives lines 158-175. |

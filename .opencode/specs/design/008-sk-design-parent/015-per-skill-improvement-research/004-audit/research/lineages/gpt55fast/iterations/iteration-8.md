...
- Bind `artifact_dir` directly to `.opencode/specs/design/008-sk-design-parent/015-per-skill-improvement-research/004-audit/research/lineages/gpt55fast`
- Do **not** run `resolveArtifactRoot`
- Write only inside `.opencode/specs/design/008-sk-design-parent/015-per-skill-improvement-research/004-audit/research/lineages/gpt55fast`
...
- Confirmed `.opencode/specs/design/008-sk-design-parent/015-per-skill-improvement-research/004-audit/spec.md` is missing.
...
- Read prior corpus research at `.opencode/specs/design/008-sk-design-parent/009-reference-asset-expansion/research/research.md`.
- Read selected external corpus files under `.opencode/specs/design/008-sk-design-parent/external/`.
- Checked routing benchmark path; `.opencode/specs/design/008-sk-design-parent/014-routing-benchmark/design-interface` exists but is empty.
...
- Use prior lineage example shape from `.opencode/specs/design/001-sk-design-interface/006-competitor-design-tools-research/research/lineages/gpt55fast/`.
...
## Relevant Files
- `.opencode/specs/design/008-sk-design-parent/015-per-skill-improvement-research/004-audit/research/lineages/gpt55fast`: required write-only artifact dir.

...
- `.opencode/skills/sk-prompt-models/references/models/minimax-m3.md` - MiniMax-M3 prompt-craft profile.
- `.opencode/skills/sk-prompt-models/assets/cli_prompt_quality_card.md` - CLI prompt quality and profile precedence.
...
- `sk-prompt-models` - MiniMax-M3 prompt craft.
- `cli-opencode` - small-model executor mechanics.
- `deep-loop-runtime` - fan-out isolation and merge.

## Specs

- Target: `.opencode/specs/design/008-sk-design-parent/029-design-context-loading`

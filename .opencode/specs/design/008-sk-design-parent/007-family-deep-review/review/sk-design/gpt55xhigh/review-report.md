...
| F002 | P1 | traceability | Terminal validation phase claims complete while evidence is still planned and unchecked. | `.opencode/specs/design/008-sk-design-parent/006-integration-validation/spec.md:55`, `.opencode/specs/design/008-sk-design-parent/006-integration-validation/spec.md:62`, `.opencode/specs/design/008-sk-design-parent/006-integration-validation/tasks.md:56-68`, `.opencode/specs/design/008-sk-design-parent/006-integration-validation/tasks.md:88-92`, `.opencode/specs/design/008-sk-design-parent/006-integration-validation/implementation-summary.md:62-64`, `.opencode/specs/design/008-sk-design-parent/006-integration-validation/implementation-summary.md:129-137` | active |
| F003 | P1 | traceability | Configured 007 review spec folder is absent from the phase-parent packet. | `.opencode/specs/design/008-sk-design-parent/spec.md:98-105`, `.opencode/specs/design/008-sk-design-parent/graph-metadata.json:6-12` | active |
...
3. Create or rebind the review packet.
   - Resolve F003 by creating `.opencode/specs/design/008-sk-design-parent/007-family-deep-review` with the required docs, or rerun this lineage against an existing spec folder.
...
4. Create or correct `.opencode/specs/design/008-sk-design-parent/007-family-deep-review` before re-running this review.
...
|---|---|---|---|---|---|
| spec_code | core | hard | fail | `.opencode/skills/sk-design/SKILL.md:93`, `.opencode/skills/sk-design/SKILL.md:146`, `.opencode/specs/design/008-sk-design-parent/006-integration-validation/spec.md:55`, `.opencode/specs/design/008-sk-design-parent/spec.md:98-105` | F001, F002, F003 |
| checklist_evidence | core | hard | fail | `.opencode/specs/design/008-sk-design-parent/006-integration-validation/tasks.md:56-68`, `.opencode/specs/design/008-sk-design-parent/006-integration-validation/tasks.md:88-92` | F002 |
...
| `.opencode/specs/design/008-sk-design-parent/spec.md` | partial |
| `.opencode/specs/design/008-sk-design-parent/graph-metadata.json` | partial |
| `.opencode/specs/design/008-sk-design-parent/006-integration-validation/spec.md` | partial |
| `.opencode/specs/design/008-sk-design-parent/006-integration-validation/tasks.md` | partial |
| `.opencode/specs/design/008-sk-design-parent/006-integration-validation/implementation-summary.md` | partial |

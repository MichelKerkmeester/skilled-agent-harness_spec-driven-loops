...
- Strict spec-folder validation: FAILED. `validate.sh` reported `FILE_EXISTS: Missing 4 required file(s) for Level 1` for `.opencode/specs/design/008-sk-design-parent/007-family-deep-review`.

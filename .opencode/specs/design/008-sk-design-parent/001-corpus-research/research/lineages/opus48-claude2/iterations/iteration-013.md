...
Rollback: each phase validates independently; children remain individually invocable throughout, so a failed phase never dark-launches a broken family. [SOURCE: .opencode/specs/design/008-sk-design-parent/spec.md:98-119]

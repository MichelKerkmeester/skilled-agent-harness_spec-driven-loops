...
[D3-A8 / D3] tool-permission correctness across the `reference-base` versus `playwright-extract` `backendKind` split. The previous iteration framed the risk: wrong mode routing is not only a taste miss; it can grant the wrong tool surface. [SOURCE: .opencode/specs/design/008-sk-design-parent/044-design-routing-and-integration-research/research/iterations/iteration-024.md:129] The angle bank names the same target as D3-A8. [SOURCE: .opencode/specs/design/008-sk-design-parent/044-design-routing-and-integration-research/research/angle-bank.json:26]
...
- `.opencode/specs/design/008-sk-design-parent/044-design-routing-and-integration-research/research/iterations/iteration-017.md`

...
2. Reviewed iterations 5-7 to avoid duplicating the generic argument-hint, missing example, and sibling-discriminator angles. [SOURCE: .opencode/specs/design/008-sk-design-parent/044-design-routing-and-integration-research/research/iterations/iteration-005.md:26] [SOURCE: .opencode/specs/design/008-sk-design-parent/044-design-routing-and-integration-research/research/iterations/iteration-006.md:17] [SOURCE: .opencode/specs/design/008-sk-design-parent/044-design-routing-and-integration-research/research/iterations/iteration-007.md:24]
...
5. Compared the `impeccable-main` command docs pattern, where command pages name expected output and artifacts instead of returning status only. [SOURCE: .opencode/specs/design/008-sk-design-parent/external/impeccable-main/CLAUDE.md:287] [SOURCE: .opencode/specs/design/008-sk-design-parent/external/impeccable-main/site/content/skills/audit.md:80] [SOURCE: .opencode/specs/design/008-sk-design-parent/external/impeccable-main/site/content/skills/document.md:89]
...
Evidence:
- The corpus contribution guide requires command docs to include `Try it` with one or two concrete examples and expected output. [SOURCE: .opencode/specs/design/008-sk-design-parent/external/impeccable-main/CLAUDE.md:287] [SOURCE: .opencode/specs/design/008-sk-design-parent/external/impeccable-main/CLAUDE.md:291]
- Its audit docs say the user gets back a single ticket-tracker-ready document, then the `Try it` section includes an `Expected output:` block. [SOURCE: .opencode/specs/design/008-sk-design-parent/external/impeccable-main/site/content/skills/audit.md:70] [SOURCE: .opencode/specs/design/008-sk-design-parent/external/impeccable-main/site/content/skills/audit.md:80]
- Its document docs name the output as a fixed-section `DESIGN.md` plus `.impeccable/design.json`, and state that other commands read `DESIGN.md` on invocation. [SOURCE: .opencode/specs/design/008-sk-design-parent/external/impeccable-main/site/content/skills/document.md:89] [SOURCE: .opencode/specs/design/008-sk-design-parent/external/impeccable-main/site/content/skills/document.md:91]
- Its shape docs visually label `brief.md` as the output of `/impeccable shape`, and later state that standalone shape is for getting the brief rather than the full implementation flow. [SOURCE: .opencode/specs/design/008-sk-design-parent/external/impeccable-main/site/content/skills/shape.md:8] [SOURCE: .opencode/specs/design/008-sk-design-parent/external/impeccable-main/site/content/skills/shape.md:9] [SOURCE: .opencode/specs/design/008-sk-design-parent/external/impeccable-main/site/content/skills/shape.md:57]

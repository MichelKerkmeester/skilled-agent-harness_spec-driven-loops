...
1. Re-read the deep-research output contract and the active strategy's Q3/D4 target: a deny-by-default, content-bound-token mechanism for `mcp-open-design` across MCP, CLI, HTTP, and automation surfaces. [SOURCE: .opencode/specs/design/008-sk-design-parent/044-design-routing-and-integration-research/research/deep-research-strategy.md:37]

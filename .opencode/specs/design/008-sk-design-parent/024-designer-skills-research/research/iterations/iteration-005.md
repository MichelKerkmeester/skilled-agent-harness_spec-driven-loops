...
- Compared the root corpus README, which lists `interaction-design` as 16 skills, against the plugin README, which declares 15 skills. [SOURCE: .opencode/specs/design/008-sk-design-parent/external/designer-skills-main/README.md:73] [SOURCE: .opencode/specs/design/008-sk-design-parent/external/designer-skills-main/interaction-design/README.md:3]
- Ran a filesystem inventory over `interaction-design/skills/*/SKILL.md`; the command returned 16 skill files, including the README-omitted `interfaces-that-feel/SKILL.md`. [SOURCE: command `rg --files .opencode/specs/design/008-sk-design-parent/external/designer-skills-main/interaction-design/skills | sort`]
- Re-read `interfaces-that-feel` and the prior interaction pass to avoid re-opening already-covered material. Iteration 2 already classified the hidden skill as real, in-scope taste craft around felt state, copy, timing, and motion. [SOURCE: .opencode/specs/design/008-sk-design-parent/024-designer-skills-research/research/iterations/iteration-002.md:17] [SOURCE: .opencode/specs/design/008-sk-design-parent/024-designer-skills-research/research/iterations/iteration-002.md:77]
...
The skill's reference-aesthetic examples and emotional vocabulary are useful inspiration, but should not be imported as a broad lifecycle or brand-strategy capability. The in-scope portion is build-facing craft: copy tone by state, emotional timing, and checking whether the state is acknowledged. The out-of-scope portion is turning this into research, brand strategy, or a general emotional-design methodology. [SOURCE: .opencode/specs/design/008-sk-design-parent/external/designer-skills-main/interaction-design/skills/interfaces-that-feel/SKILL.md:52] [SOURCE: .opencode/specs/design/008-sk-design-parent/external/designer-skills-main/interaction-design/skills/interfaces-that-feel/SKILL.md:61]
...
- `.opencode/specs/design/008-sk-design-parent/external/designer-skills-main/README.md`
- `.opencode/specs/design/008-sk-design-parent/external/designer-skills-main/interaction-design/README.md`
- `.opencode/specs/design/008-sk-design-parent/external/designer-skills-main/interaction-design/skills/interfaces-that-feel/SKILL.md`
- `.opencode/specs/design/008-sk-design-parent/024-designer-skills-research/research/iterations/iteration-002.md`
...
- Command: `rg --files .opencode/specs/design/008-sk-design-parent/external/designer-skills-main/interaction-design/skills | sort`

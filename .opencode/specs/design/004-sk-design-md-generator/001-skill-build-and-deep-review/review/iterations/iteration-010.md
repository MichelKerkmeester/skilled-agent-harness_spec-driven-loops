...
- Evidence: SKILL.md:5 declares `version: 1.0.0` (three-segment). The changelog file is named `v1.0.0.0.md` and its H1 reads `v1.0.0.0 - First Stable Release` (four-segment). The spec at 151-sk-design-md-generator and graph-metadata.json both lack an explicit version field, so there is no authoritative tie-breaker.
...
- File: .opencode/specs/design/004-sk-design-md-generator/spec.md:21

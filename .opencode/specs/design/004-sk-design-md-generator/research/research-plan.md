...
4. After each wave: `node .opencode/skills/deep-loop-workflows/deep-research/scripts/reduce-state.cjs .opencode/specs/design/004-sk-design-md-generator` (refreshes strategy machine-sections + dashboard + findings-registry).

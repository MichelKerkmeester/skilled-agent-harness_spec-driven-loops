...
_memory:
  continuity:
    packet_pointer: "design/006-sk-design-md-generator/005-doc-as-view-architecture"
...
Parent packet: `design/006-sk-design-md-generator` (phase parent). Evidence base: `research/research.md`.

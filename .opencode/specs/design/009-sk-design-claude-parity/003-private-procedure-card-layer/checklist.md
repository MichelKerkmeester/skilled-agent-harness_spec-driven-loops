...
- [x] CHK-004 [P1] [EVIDENCE: plan.md DEPENDENCIES section; Phase 002 is closed per verified groundi...] Dependencies on Phase 002 and external source identifiers are understood before implementation starts. Evidence: `plan.md` DEPENDENCIES section; Phase 002 is closed per verified grounding facts; all 14 files under `.opencode/specs/design/009-sk-design-claude-parity/external/claude/skills/*.md` were read and cited.
<!-- /ANCHOR:pre-impl -->
...
- [x] CHK-051 [P0] [EVIDENCE: both files are present at .opencode/specs/design/009-sk-design-claude-...] `description.json` and `graph-metadata.json` exist in the Phase 003 root. Evidence: both files are present at `.opencode/specs/design/009-sk-design-claude-parity/003-private-procedure-card-layer/` and were regenerated after this reconciliation.

...
- [x] CHK-051 [P0] [EVIDENCE: description.json + graph-metadata.json present] `description.json` and `graph-metadata.json` exist in the Phase 004 root.
  - **Evidence**: Verified. Both files exist at `.opencode/specs/design/009-sk-design-claude-parity/004-mode-packet-refactor/` and were regenerated after the doc edits in this pass.
...
- [x] CHK-060 [P0] [EVIDENCE: git diff scope] Packet creation and this verification pass write only inside the Phase 004 root.
  - **Evidence**: Verified. This verification pass edited only files under `.opencode/specs/design/009-sk-design-claude-parity/004-mode-packet-refactor/`.

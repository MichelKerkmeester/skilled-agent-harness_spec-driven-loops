...
_memory:
  continuity:
    ...
    key_files:
      ...
      - "system-code-graph/008-code-graph-scatter/013-code-graph-import-path-cleanup/spec.md"
      - "system-code-graph/008-code-graph-scatter/013-code-graph-import-path-cleanup/implementation-summary.md"
    session_dedup:
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/001-local-embeddings-foundation/033-system-code-graph-import-path-cleanup/` | Create | Level 2 packet docs and metadata. |
<!-- /ANCHOR:scope -->

...
title: "Implementation Plan: code_graph_status read-only readiness snapshot [system-code-graph/008-code-graph-scatter/010-code-graph-status-readiness-snapshot/plan]"

...
- **Structure**: Validate JSON and run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-code-graph/035-rust-backend-rewrite-research/001-research --strict`.
<!-- /ANCHOR:testing -->

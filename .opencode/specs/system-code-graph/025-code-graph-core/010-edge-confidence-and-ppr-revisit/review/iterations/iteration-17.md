...
- `.opencode/specs/system-code-graph/025-code-graph-core/010-edge-confidence-and-ppr-revisit/review/deep-review-findings-registry.json:9` confirms `P1-001` is already active, so this iteration avoids duplicating the missing-dist dependency finding.

---
title: "Deep Research: Tool Routing Enforcement [system-code-graph/z_archive/013-tool-routing-enforcement/research]"
description: "AI assistants across all CLI runtimes (Claude Code, Codex CLI, Copilot CLI, Gemini CLI) consistently default to Grep/Glob for code search tasks even when CocoIndex (semantic) an..."
trigger_phrases:
  - "deep"
  - "research"
  - "tool"
...
_memory:
  continuity:
    packet_pointer: "system-code-graph/z_archive/013-tool-routing-enforcement/research"

...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/system-code-graph/031-code-graph-buildout/001-mcp-shared-dependency-startup-fix/spec.md"
    session_dedup:
    ...
    answered_questions:
      ...
      - "Spec placement: .opencode/specs/system-code-graph/031-code-graph-buildout/001-mcp-shared-dependency-startup-fix."
---

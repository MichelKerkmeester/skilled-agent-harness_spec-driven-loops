...
_memory:
  continuity:
    packet_pointer: "system-code-graph/031-code-graph-buildout/005-resilience-and-advisor/001-code-graph-advisor-refinement"
    ...
    key_files:
      - "plan.md"
      - "tasks.md"
      - "research/001-code-graph-advisor-refinement-roadmap/research.md"
      - "research/001-code-graph-advisor-refinement-roadmap/iterations/iteration-018.md"
      - "research/001-code-graph-advisor-refinement-roadmap/iterations/iteration-019.md"
    session_dedup:
...
**Research basis**: `research/001-code-graph-advisor-refinement-roadmap/research.md` §11 (roadmap), §12 (rollback), §13 (metrics namespace). All citations in this plan are recoverable from that synthesis and the per-iteration delta JSONL records.
<!-- /ANCHOR:summary -->
...
- Sibling-spec doc grep: no stale references in `002-skill-graph-daemon-native-advisor-tools` or `042-sk-deep-research-review-improvement-2`

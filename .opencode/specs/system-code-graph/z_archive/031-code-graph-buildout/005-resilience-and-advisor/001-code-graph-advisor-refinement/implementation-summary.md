...
_memory:
  continuity:
    ...
    key_files:
      ...
      - "tasks.md"
      - "checklist.md"
      - "review/001-code-graph-advisor-refinement-roadmap/review-report.md"
      - "applied/B1.md"
      - "applied/B2.md"
      - "applied/B3.md"
      - "applied/B4.md"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 001-code-graph-advisor-refinement |

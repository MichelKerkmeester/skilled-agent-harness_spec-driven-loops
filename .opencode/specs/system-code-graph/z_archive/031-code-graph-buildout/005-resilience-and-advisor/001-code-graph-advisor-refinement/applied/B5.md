...
```diff
diff --git a/.opencode/skills/system-spec-kit/mcp_server/skill-advisor/handlers/advisor-validate.ts b/.opencode/skills/system-spec-kit/mcp_server/skill-advisor/handlers/advisor-validate.ts
@@
...
diff --git a/.opencode/skills/system-spec-kit/mcp_server/skill-advisor/tests/legacy/advisor-corpus-parity.vitest.ts b/.opencode/skills/system-spec-kit/mcp_server/skill-advisor/tests/legacy/advisor-corpus-parity.vitest.ts
@@
...
- `cd .opencode/skills/system-spec-kit/mcp_server && npx vitest run skill-advisor/tests/legacy/advisor-corpus-parity.vitest.ts` passed: 1 file, 1 test.

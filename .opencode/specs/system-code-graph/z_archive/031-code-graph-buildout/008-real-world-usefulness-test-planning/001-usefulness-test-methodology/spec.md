...
_memory:
  continuity:
    packet_pointer: "system-code-graph/031-code-graph-buildout/008-real-world-usefulness-test-planning/001-usefulness-test-methodology"
    ...
    session_dedup:
      ...
      session_id: "026-007-011-real-world-usefulness-test-planning"
...
|-----------|-------------|-------------|
| `specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/spec.md` | Create | Problem, scope, scenario battery, requirements, success criteria. |
| `specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/plan.md` | Create | Execution design, phased rollout, CLI matrix, scoring rubric. |
| `specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/tasks.md` | Create | Scenario, matrix-cell, and analysis task list for the later execution pass. |
| `specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/checklist.md` | Create | Scaffold verification plus future execution gates. |
| `specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/decision-record.md` | Create | Methodology ADRs for the campaign design. |
| `specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/implementation-summary.md` | Create | Planning-only placeholder; execution summary comes later. |
| `specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/description.json` | Create | Discovery metadata for this packet. |
| `specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning/graph-metadata.json` | Create | Graph metadata for this child packet. |
...
- **SC-005**: Parent `graph-metadata.json.children_ids` includes `system-spec-kit/026-graph-and-context-optimization/005-code-graph/011-real-world-usefulness-test-planning`.

---
title: "Feature Specification: Code-Graph Docs and READMEs [system-code-graph/031-code-graph-buildout/007-docs-and-readmes/spec]"
...
_memory:
  continuity:
    packet_pointer: "system-code-graph/031-code-graph-buildout/007-docs-and-readmes"

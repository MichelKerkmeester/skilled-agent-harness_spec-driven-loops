...
- [x] T016 Run strict spec validation (`bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-code-graph/030-fix-code-graph-docs --strict`)
<!-- /ANCHOR:phase-3 -->

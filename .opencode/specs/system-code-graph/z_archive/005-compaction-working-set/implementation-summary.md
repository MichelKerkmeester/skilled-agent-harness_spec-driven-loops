...
---
title: "Implementation Summary [system-spec-kit/system-code-graph/z_archive/005-compaction-working-set/implementation-summary]"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 005-compaction-working-set |

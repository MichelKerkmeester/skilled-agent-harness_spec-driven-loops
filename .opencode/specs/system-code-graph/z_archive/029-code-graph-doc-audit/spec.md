...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/system-code-graph/029-code-graph-doc-audit/spec.md"
    session_dedup:
...
- Compare documentation claims against `.opencode/specs/system-code-graph/025-code-graph-core/**` and live `mcp_server/` implementation evidence.

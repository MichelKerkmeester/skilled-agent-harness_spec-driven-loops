...
_memory:
  continuity:
    packet_pointer: "system-code-graph/032-code-graph-scatter/009-code-graph-degraded-stress-cell"
...
- **Research**: See `../011-research-post-stress-finding-followups/research/research.md` §4

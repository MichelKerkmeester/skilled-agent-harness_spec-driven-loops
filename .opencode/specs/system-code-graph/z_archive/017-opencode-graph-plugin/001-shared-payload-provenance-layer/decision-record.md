---
title: "D [system-code-graph/z_archive/017-opencode-graph-plugin/001-shared-payload-provenance-layer/decision-record]"
description: "Architecture decisions for Shared Payload and Provenance Layer: preserve the shipped runtime boundary and close the phase as a clean Level 3 artifact."
trigger_phrases:
  - "shared payload and provenance layer adr"
...
_memory:
  continuity:
    packet_pointer: "system-code-graph/z_archive/017-opencode-graph-plugin/001-shared-payload-provenance-layer"
...
---
# Decision Record: Shared Payload and Provenance Layer
...
<!-- ANCHOR:adr-001 -->
## ADR-001: Preserve the Shipped Shared Payload and Provenance Layer Boundary
...
**We chose**: Keep the shipped Shared Payload and Provenance Layer runtime scope intact and rebuild the phase docs around that existing implementation evidence.

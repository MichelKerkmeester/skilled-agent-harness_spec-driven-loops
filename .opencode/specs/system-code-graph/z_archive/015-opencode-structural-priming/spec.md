---
title: "Spec: OpenCode Structural Priming — [system-code-graph/z_archive/015-opencode-structural-priming/spec]"
...
_memory:
  continuity:
    packet_pointer: "system-code-graph/z_archive/015-opencode-structural-priming"
...
| `.opencode/agents/context.md` | Modify | Mirror the non-hook structural bootstrap contract for agent-facing first-turn guidance |

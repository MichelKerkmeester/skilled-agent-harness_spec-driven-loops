...
_memory:
  continuity:
    packet_pointer: "system-code-graph/033-advisor-code-graph-shared-features/004-codegraph-bm25-symbol-resolver"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 004-codegraph-bm25-symbol-resolver |
...
| `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-spec-kit/027-xce-research-based-refinement/003-advisor-and-codegraph/002-xce-feature-adoption-advisor-codegraph/004-codegraph-bm25-symbol-resolver --strict` | PASS |
<!-- /ANCHOR:verification -->

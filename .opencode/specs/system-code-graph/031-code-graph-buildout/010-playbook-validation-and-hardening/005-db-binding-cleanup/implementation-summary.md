...
_memory:
  continuity:
    packet_pointer: "system-code-graph/031-code-graph-buildout/010-playbook-validation-and-hardening/005-db-binding-cleanup"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 005-db-binding-cleanup |

...
_memory:
  continuity:
    packet_pointer: "system-code-graph/031-code-graph-buildout/001-mcp-shared-dependency-startup-fix"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 001-mcp-shared-dependency-startup-fix |
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/011-mcp-shared-dependency-startup-fix/*` | Created | Tracks scope and verification evidence. |
<!-- /ANCHOR:what-built -->

...
| **Branch** | `main` |
| **Parent Spec** | `../spec.md` |
| **Source Research** | `../003-code-graph-bug-surface-research/research/research.md` |
<!-- /ANCHOR:metadata -->
...
| `specs/.../007-readiness-hooks-advisor-polish/*` | Create | Level 2 packet docs and implementation summary. |
| `specs/.../011-real-world-usefulness-test-planning/graph-metadata.json` | Modify | Add `007-readiness-hooks-advisor-polish` child ID. |
<!-- /ANCHOR:scope -->

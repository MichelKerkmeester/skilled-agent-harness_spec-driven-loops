...
| Field | Value |
|-------|-------|
| **Spec Folder** | 003-native-deferred-trial-rerun |
...
I used the prior `001-sandbox-usefulness-trials` packet as the local scaffold, then authored the native child packet around the orchestrator's measured data. I kept code graph failures as blocked or completed-with-failure rows instead of smoothing them into a generic partial result.
<!-- /ANCHOR:how-delivered -->

...
_memory:
  continuity:
    packet_pointer: "system-code-graph/031-code-graph-buildout/008-real-world-usefulness-test-planning/005-fix-zero-node-and-parser-issues"
...
- [x] CHK-041 [P1] Parent `children_ids` includes `005-fix-zero-node-and-parser-issues`.

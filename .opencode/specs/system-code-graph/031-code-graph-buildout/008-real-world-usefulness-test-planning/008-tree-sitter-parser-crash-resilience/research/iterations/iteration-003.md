...
```
===== PROBE 1 =====
[P1.alone-vitest] file=029-clean-infrastructure-stress-test/measurements/vitest.phase-k.config.ts bytes=634
...
[P5b.then-vitest] file=029-clean-infrastructure-stress-test/measurements/vitest.phase-k.config.ts bytes=634

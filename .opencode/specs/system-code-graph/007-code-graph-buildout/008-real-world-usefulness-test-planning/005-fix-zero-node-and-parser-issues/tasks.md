...
- [x] T001 Create Level 2 packet scaffold (`005-fix-zero-node-and-parser-issues/`)
...
- [x] T020 Run child strict validation (`validate.sh 005-fix-zero-node-and-parser-issues --strict`)

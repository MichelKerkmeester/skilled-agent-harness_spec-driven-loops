...
| Field | Value |
|-------|-------|
| **Spec Folder** | 004-doc-drift-alignment |
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/020-doc-drift-alignment/` | Created | This packet (6 files) |
<!-- /ANCHOR:what-built -->

...
_memory:
  continuity:
    packet_pointer: "system-code-graph/007-code-graph-buildout/007-docs-and-readmes/002-system-code-graph-readmes-update"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 002-system-code-graph-readmes-update |

...
- `.opencode/skills/sk-code-review/SKILL.md:281-320`
- `.opencode/skills/sk-code-review/references/review_core.md:75-99`
- `.opencode/agents/deep-review.md:172-184`
- `.opencode/agents/deep-review.md:185-211`
- `.opencode/skills/sk-deep-review/references/state_format.md:185-221`
- `.opencode/skills/sk-deep-review/references/state_format.md:448-452`
- `.opencode/commands/deep/assets/deep_start-review-loop_auto.yaml:1036-1055`
- `.opencode/commands/deep/assets/deep_start-review-loop_confirm.yaml:1058-1077`
- `.opencode/commands/spec_kit/assets/spec_kit_plan_auto.yaml:215-230`
- `.opencode/commands/spec_kit/assets/spec_kit_plan_auto.yaml:570-576`
- `.opencode/commands/spec_kit/assets/spec_kit_plan_confirm.yaml:221-237`
...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/009-fix-iteration-quality-meta-research/spec.md:109-115`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/009-fix-iteration-quality-meta-research/plan.md:41-49`
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/005-code-graph/009-fix-iteration-quality-meta-research/plan.md:116-122`

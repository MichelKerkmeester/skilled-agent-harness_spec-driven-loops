...
| `.opencode/specs/system-code-graph/001-code-graph-core/010-edge-confidence-and-ppr-revisit/spec.md` | 80-85, 112-122, 141-160 | Confirmed packet scope: default-off confidence differentiation, seeded-PPR recovery, and consumer no-change requirement. |
| `.opencode/specs/system-code-graph/001-code-graph-core/010-edge-confidence-and-ppr-revisit/implementation-summary.md` | 57-65, 87-90, 113-117 | Confirmed delivered capability, default-off rationale, and known limitations. |

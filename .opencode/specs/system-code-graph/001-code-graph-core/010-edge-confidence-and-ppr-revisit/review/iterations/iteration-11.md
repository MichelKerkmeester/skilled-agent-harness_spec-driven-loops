...
- `.opencode/specs/system-code-graph/001-code-graph-core/005-seeded-ppr-ranking/spec.md:50` - older correction claims the flag/symbol do not exist in current source.
- `.opencode/specs/system-code-graph/001-code-graph-core/005-seeded-ppr-ranking/spec.md:52` - newer correction explicitly says that older source-absence claim is stale after recovery.

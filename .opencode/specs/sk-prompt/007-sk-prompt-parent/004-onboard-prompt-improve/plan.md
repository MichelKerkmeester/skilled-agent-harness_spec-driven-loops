...
| Spec | Phase documentation remains Level 1 compliant | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/sk-prompt/007-sk-prompt-parent/004-onboard-prompt-improve --strict` |
<!-- /ANCHOR:testing -->

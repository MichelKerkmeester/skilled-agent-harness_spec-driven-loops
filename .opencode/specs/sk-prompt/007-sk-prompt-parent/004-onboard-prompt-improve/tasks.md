...
- [x] T013 Run strict validation for `.opencode/specs/sk-prompt/007-sk-prompt-parent/004-onboard-prompt-improve/` after implementation docs are updated. — Evidence: `validate.sh --strict` run after this update.
<!-- /ANCHOR:phase-3 -->

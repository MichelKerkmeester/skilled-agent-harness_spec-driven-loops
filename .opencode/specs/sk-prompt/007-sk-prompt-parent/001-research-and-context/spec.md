...
_memory:
  continuity:
    packet_pointer: "sk-prompt/007-sk-prompt-parent/001-research-and-context"
...
- Prior-art summary of `.opencode/specs/sk-prompt/006-sk-prompt-models-rename/` focused on task shape, referrer handling, and lessons for the fold-in.
...
- Review `.opencode/specs/sk-prompt/006-sk-prompt-models-rename/` as prior art for task shape, path referrers, and rename lessons.
...
|-----------|-------------|-------------|
| `.opencode/specs/sk-prompt/007-sk-prompt-parent/001-research-and-context/spec.md` | Modify | Define the phase 001 read-only research scope and acceptance criteria |
| `.opencode/specs/sk-prompt/007-sk-prompt-parent/001-research-and-context/plan.md` | Modify | Plan the two research passes, prior-art review, and verification path |
| `.opencode/specs/sk-prompt/007-sk-prompt-parent/001-research-and-context/tasks.md` | Modify | Track the scoped research-gate tasks pending human review |
<!-- /ANCHOR:scope -->
...
- **SC-002**: Zero files outside `.opencode/specs/sk-prompt/007-sk-prompt-parent/001-research-and-context/` are touched during this phase.
<!-- /ANCHOR:success-criteria -->

...
- iteration 5 bundle_route_gap (deferred): author a bundle gold scenario before severity escalation; evidence=.opencode/skills/sk-prompt/hub-router.json:8-14, .opencode/skills/sk-prompt/benchmark/reports/2026-07-10--router-final--router/skill-benchmark-report.json:108-117

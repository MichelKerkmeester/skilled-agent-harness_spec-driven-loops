  ...
  "findings": [
    {
      ...
      "severity": "P2",
      "location": ".opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/spec.md frontmatter",
    ...
    },
    {
      ...
      "hypothesis": "H5: parent metadata drift",
      "severity": "P2",
      "location": ".opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/description.json",

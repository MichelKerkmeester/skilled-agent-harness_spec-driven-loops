...
| `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/sk-prompt/006-sk-prompt-parent/002-architecture-decision --strict` (after the ADR-001 amendment) | PASS — 0 errors, 0 warnings. |
<!-- /ANCHOR:verification -->

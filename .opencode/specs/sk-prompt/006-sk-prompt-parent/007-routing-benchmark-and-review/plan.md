...
_memory:
  continuity:
    packet_pointer: "sk-prompt/006-sk-prompt-parent/007-routing-benchmark-and-review"
...
- [ ] Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/sk-prompt/006-sk-prompt-parent/007-routing-benchmark-and-review --strict` after phase docs are updated.
<!-- /ANCHOR:phases -->

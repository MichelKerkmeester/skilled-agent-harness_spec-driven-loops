...
- [x] T007 Review `.opencode/specs/sk-prompt/005-sk-prompt-models-rename/` and summarize relevant rename lessons for phases 002-006 — Evidence: `spec.md` "Research Findings", history-care carve-out lesson.
<!-- /ANCHOR:phase-2 -->

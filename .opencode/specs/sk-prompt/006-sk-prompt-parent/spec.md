...
_memory:
  continuity:
    packet_pointer: "sk-prompt/006-sk-prompt-parent"
    ...
    session_dedup:
      ...
      session_id: "006-sk-prompt-parent-complete"
...
| **Branch** | `main` |
| **Parent Spec** | `../spec.md` |
| **Parent Packet** | sk-prompt/006-sk-prompt-parent |
| **Predecessor** | sk-prompt/005-sk-prompt-models-rename (renamed sk-prompt-models to its current name; this program folds the renamed skill into the sk-prompt hub) |

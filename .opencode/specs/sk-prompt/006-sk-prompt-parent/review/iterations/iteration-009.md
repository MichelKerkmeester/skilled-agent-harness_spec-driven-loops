...
- `.opencode/specs/sk-prompt/006-sk-prompt-parent/review/deep-review-state.jsonl:3-26` - prior iteration state and duplicate-finding guard.
- `.opencode/specs/sk-prompt/006-sk-prompt-parent/review/deep-review-findings-registry.json:9-270` - active finding registry, including prior path and stale-reference findings.
- `.opencode/specs/sk-prompt/006-sk-prompt-parent/review/deep-review-strategy.md:127-215` - exhausted correctness directions.
...
- `.opencode/specs/sk-prompt/006-sk-prompt-parent/spec.md:88-93` - command rename and live referrer sweep scope.
- `.opencode/specs/sk-prompt/006-sk-prompt-parent/spec.md:124-133` - phase map showing the active packet is under `.opencode/specs/...`.

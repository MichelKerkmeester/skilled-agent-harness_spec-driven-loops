...
| Field | Value |
|---|---|
| Spec folder | `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/007-sk-prompt-small-model-rename/` |
| Phase | 7 of 7 |
...
- Phase 7 row in `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/spec.md` PHASE DOCUMENTATION MAP.
...
- `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/{001-006}/**` (deep-research + 5 implementation phase children)
- `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/review/**` (deep-review iterations + prompts + deltas)

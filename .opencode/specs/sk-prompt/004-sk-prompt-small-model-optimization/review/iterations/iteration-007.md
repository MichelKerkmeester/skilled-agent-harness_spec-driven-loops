...
### Root Cause
Iter-6 agent searched for ADR artifacts within the 114 spec folder boundary, but implementation artifacts for this packet live in `.opencode/skills/`, not under `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/`. This was a scope-misinterpretation error.

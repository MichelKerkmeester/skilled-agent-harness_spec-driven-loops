...
- `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/002-sentinel-skill-foundation/spec.md`
- `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/003-structured-permissions-matrix/spec.md`
- `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/004-budget-and-output-verification/spec.md`
- `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/005-model-profiles-and-fallback/spec.md`

...
| Field | Value |
|-------|-------|
| **Packet** | sk-prompt/004-sk-prompt-small-model-optimization/002-sentinel-skill-foundation |
| **Level** | 2 |
...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/002-sentinel-skill-foundation --strict` passed.

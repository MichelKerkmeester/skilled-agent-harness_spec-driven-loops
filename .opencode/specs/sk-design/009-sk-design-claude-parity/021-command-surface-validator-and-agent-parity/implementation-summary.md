...
3. **No fresh skill-benchmark run was performed in this phase** -- the validator reaching a clean pass is the relevant automated gate for this phase's scope (a validator/doc-fidelity fix, not a routing behavior change); the last real benchmark baseline remains Phase 019's `benchmark/2026-07-07--after-018-transport-integration--live/`.
<!-- /ANCHOR:limitations -->

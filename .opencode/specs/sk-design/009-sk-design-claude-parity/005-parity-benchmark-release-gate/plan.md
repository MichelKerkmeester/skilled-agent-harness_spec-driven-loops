...
Use one summary status line with validation evidence: `STATUS=OK PATH=/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/sk-design/009-sk-design-claude-parity/005-parity-benchmark-release-gate VALIDATION_EXIT=0` or `STATUS=FAIL ERROR=reason VALIDATION_EXIT=code`.

...
- Claim: Keeping the same benchmark evidence under both `benchmark/2026-07-06--after-012-routing-rigor--router/report.{json,md}` and `benchmark/2026-07-06--after-d3-proxy--router/skill-benchmark-report.{json,md}` creates a future maintainer trap: the folders look like separate benchmark runs but are documented as byte-identical duplicate evidence.
...
- Naming mismatch: The two markdown reports render the same report title, verdict, coverage, scores, scenario rows, and caveats, but one folder uses `report.md` while the other uses `skill-benchmark-report.md`. Evidence: `.opencode/skills/sk-design/benchmark/2026-07-06--after-012-routing-rigor--router/report.md:1`, `.opencode/skills/sk-design/benchmark/2026-07-06--after-d3-proxy--router/skill-benchmark-report.md:1`, `.opencode/skills/sk-design/benchmark/2026-07-06--after-012-routing-rigor--router/report.md:5`, `.opencode/skills/sk-design/benchmark/2026-07-06--after-d3-proxy--router/skill-benchmark-report.md:5`.
...
- Finding class: matrix/evidence.
- Affected surface hints: `benchmark/2026-07-06--after-012-routing-rigor--router/`, `benchmark/2026-07-06--after-d3-proxy--router/`, `benchmark/README.md`, future Phase 012 benchmark follow-up.

...
| `feature_catalog_code` | Covered for active mismatch | P1-004 remains a feature-catalog/code mismatch at `.opencode/skills/sk-design/design-md-generator/feature_catalog/05--report-preview/report-preview.md:59`. |

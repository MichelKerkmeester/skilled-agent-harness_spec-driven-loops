...
| `.opencode/specs/sk-design/009-sk-design-claude-parity/001-baseline-ownership-gate/` through `013-design-commands-asset-refactor/` | inventory + checklist spot-check | 1 | 0 | mapped; deep traceability pending |

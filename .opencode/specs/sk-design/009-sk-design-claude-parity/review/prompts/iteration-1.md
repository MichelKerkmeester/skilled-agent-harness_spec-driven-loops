...
- Hub-level `feature_catalog/` (2 packages: `01--manager-shell/` 3 files, `02--procedure-card-system/` 2 files, plus top-level `feature_catalog.md`) and `manual_testing_playbook/` (8 categories, 24 scenario files + top-level `manual_testing_playbook.md`).

...
- [ ] CHK-010 [P0] All 11 in-scope file(s) read and diffed against no single authored template for loose shared-root contracts; closest structural analog is .opencode/skills/sk-doc/create-skill/assets/skill/skill-reference-template.md (numbered OVERVIEW, --- separators) — apply as a judgment call and record it

---
title: "Implementation Plan: sk-design shared procedures conformance"
...
# Implementation Plan: sk-design shared procedures conformance
...
### Definition of Ready
- [ ] Governing template identified: `.opencode/skills/sk-doc/create-skill/assets/skill/skill-procedure-template.md`
- [ ] Full file list for `.opencode/skills/sk-design/shared/procedures/` enumerated
...
### Key Components
- **File audit**: Read every file under .opencode/skills/sk-design/shared/procedures/ and diff against .opencode/skills/sk-doc/create-skill/assets/skill/skill-procedure-template.md
...
### Phase 1: Setup
- [ ] Enumerate all files under .opencode/skills/sk-design/shared/procedures/
- [ ] Read .opencode/skills/sk-doc/create-skill/assets/skill/skill-procedure-template.md in full

### Phase 2: Core Implementation
- [ ] Diff each file under .opencode/skills/sk-design/shared/procedures/ against .opencode/skills/sk-doc/create-skill/assets/skill/skill-procedure-template.md
...
|------------|------|--------|-------------------|
| Governing template | Internal | Green | Path: .opencode/skills/sk-doc/create-skill/assets/skill/skill-procedure-template.md |
<!-- /ANCHOR:dependencies -->

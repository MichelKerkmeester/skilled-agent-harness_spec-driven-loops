...
_memory:
  continuity:
    ...
    next_safe_action: "Verify CHK items once the tests/ finding is presented"
    blockers: []
    key_files: []
    session_dedup:
...
- [ ] CHK-010 [P0] Missing `tests/` finding documented with `skill-reference-template.md` §8 citation
- [ ] CHK-011 [P1] Operator decision on `tests/` recorded (scaffold vs. formal exception)
- [ ] CHK-012 [P1] `README.md` and 3 checkers audited against `overview.md`
<!-- /ANCHOR:code-quality -->

...
_memory:
  continuity:
    ...
    next_safe_action: "Verify CHK items once root cause and audit land"
    blockers: []
    key_files: []
    session_dedup:
...
- [ ] CHK-010 [P0] `foundations-*` root cause confirmed with evidence
- [ ] CHK-011 [P0] `foundations-*` disposition operator-approved before any deletion
- [ ] CHK-012 [P0] All 20 categories audited against §3-§5
- [ ] CHK-013 [P1] `licensing-and-provenance/` `ID-007` confirmed untouched
<!-- /ANCHOR:code-quality -->
...
- [ ] CHK-020 [P0] No scenario ID renumbered anywhere in the folder
- [ ] CHK-021 [P1] 9-column contract spot-checked across all 20 categories
<!-- /ANCHOR:testing -->

...
Nothing yet. This leaf is Planned: the audit of `.opencode/skills/sk-design/changelog/` against its governing template has not started. This placeholder exists to satisfy the Level 2 required-file list before work begins.

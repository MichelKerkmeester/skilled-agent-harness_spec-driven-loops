...
- [ ] CHK-010 [P0] All 6 in-scope file(s) read and diffed against .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules (no authored styles/ template; this is a 1,304-dir/7,812-file bespoke data library, audited at top-level shape only)

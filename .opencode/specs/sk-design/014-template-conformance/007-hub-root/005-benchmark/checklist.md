...
- [ ] CHK-010 [P0] All 9 in-scope file(s) read and diffed against .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules (no authored benchmark/ template; these are frozen dated-run-record directories)

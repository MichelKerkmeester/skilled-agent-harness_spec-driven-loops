---
title: "Tasks: design-motion procedures/ conformance"
description: "Task breakdown for auditing design-motion's single procedures/ file."
_memory:
  continuity:
    ...
    answered_questions: []
---
# Tasks: design-motion procedures/ conformance
...
- [ ] T002 Diff `interaction-states-pass.md` against the template; fix if confirmed
<!-- /ANCHOR:phase-2 -->

---
title: "Verification Checklist: design-mcp-open-design mcp-servers conformance"
...
# Verification Checklist: design-mcp-open-design mcp-servers conformance
...
- [ ] CHK-010 [P0] All 1 in-scope file(s) read and diffed against .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules (no authored mcp-servers/ template; this is a bespoke transport-only directory)

---
title: "Verification Checklist: design-mcp-open-design tests conformance"
...
# Verification Checklist: design-mcp-open-design tests conformance
...
- [ ] CHK-010 [P0] All 2 in-scope file(s) read and diffed against .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored tests/ template)

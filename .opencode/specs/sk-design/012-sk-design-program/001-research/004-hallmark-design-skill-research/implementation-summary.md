...
_memory:
  continuity:
    ...
    recent_action: "Research complete (20/20); reuse matrix + MIT verdict recorded"
    next_safe_action: "Execute the hallmark-design-system phases"
    blockers: []
    key_files:
      ...
      - ".opencode/specs/sk-design/012-sk-design-program/001-research/004-hallmark-design-skill-research/research/lineages/sol-opencode/research.md"
    session_dedup:
...
| Field | Value |
|---|---|
| **Spec Folder** | 004-hallmark-design-skill-research |
| **Level** | 2 |

...
- Artifacts Slice (check exactly these this iteration): [{"path":".opencode/skills/sk-design/styles/_db/indexer.mjs"},{"path":".opencode/skills/sk-design/styles/_db/retrieval.mjs"},{"path":".opencode/skills/sk-design/styles/_db/schema.mjs"},{"path":".opencode/skills/sk-design/styles/_db/vectors.mjs"},{"path":".opencode/skills/sk-design/styles/_engine/persistent-adapter.mjs"}]
...
- Write this iteration's narrative to: .opencode/specs/sk-design/012-style-database-and-interface-commands/alignment/iterations/iteration-002.md
- Write this iteration's delta file to: .opencode/specs/sk-design/012-style-database-and-interface-commands/alignment/deltas/iter-002.jsonl
...
- **ALLOWED WRITE PATHS (the ONLY paths you may create, modify, or append to):**
  - `.opencode/specs/sk-design/012-style-database-and-interface-commands/alignment/iterations/iteration-002.md`, this iteration's narrative markdown (Bash-create a new file)
  ...
  - `.opencode/specs/sk-design/012-style-database-and-interface-commands/alignment/deltas/iter-002.jsonl`, this iteration's write-once delta JSONL (Bash-create once)

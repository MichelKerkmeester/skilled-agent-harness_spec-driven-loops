...
| Cluster | Files | Fix |
|---|---|---|
| 1 | `cli-opencode/SKILL.md:31,285`; `README.md:76,164`; `assets/prompt_templates.md:372,386-392`; `manual_testing_playbook.md:417-423`; `04--agent-routing/multi-ai-council-multi-strategy.md:27-43,51` | Remove/replace direct `--agent ai-council` guidance with `/deep:ai-council` or Task-dispatch routing |

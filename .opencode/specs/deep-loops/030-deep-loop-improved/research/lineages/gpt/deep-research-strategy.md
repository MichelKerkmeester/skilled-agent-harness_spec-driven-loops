...
Continue and deepen research into perfecting `.opencode/specs/deep-loops/030-deep-loop-improved` across phases 001-009 and its deep-loop tooling, with `stopPolicy=max-iterations` and 35 iterations.

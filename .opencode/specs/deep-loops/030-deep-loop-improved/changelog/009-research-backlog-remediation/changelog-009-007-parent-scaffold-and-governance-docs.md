...
> Spec folder: `.opencode/specs/deep-loops/030-deep-loop-improved/009-research-backlog-remediation/007-parent-scaffold-and-governance-docs` (Level 1)
...
|---|---|---|
| `.opencode/specs/deep-loops/030-deep-loop-improved/008-loop-systems-remediation/tasks.md` | Modified | Rewritten as a real aggregate. |
| `.opencode/specs/deep-loops/030-deep-loop-improved/008-loop-systems-remediation/implementation-summary.md` | Modified | Rewritten as a real aggregate. |
| `.opencode/specs/deep-loops/030-deep-loop-improved/008-loop-systems-remediation/plan.md` | Modified | Written from scratch as a real aggregate. |
| `.opencode/specs/deep-loops/030-deep-loop-improved/008-loop-systems-remediation/spec.md` | Modified | Level annotation and child-count wording corrected. |
| `.opencode/specs/deep-loops/030-deep-loop-improved/003-deep-loop-workflows/003-cross-mode-anti-convergence-adr/decision-record.md` | Added | Real ADR content. |
| `.opencode/specs/deep-loops/030-deep-loop-improved/003-deep-loop-workflows/005-anchor-ownership-conflict-adr/decision-record.md` | Added | Real ADR content. |

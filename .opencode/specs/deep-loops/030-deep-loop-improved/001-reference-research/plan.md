...
_memory:
  continuity:
    packet_pointer: "deep-loops/030-deep-loop-improved/001-reference-research"
    ...
    blockers: []
    key_files:
      - ".opencode/specs/deep-loops/030-deep-loop-improved/001-reference-research/research/research.md"
    session_dedup:
...
### Downstream
The 40-item backlog is the direct source for `deep-loops/030-deep-loop-improved`'s own phase 002-010 tree (each backlog item became its own follow-up implementation spec).
<!-- /ANCHOR:dependencies -->

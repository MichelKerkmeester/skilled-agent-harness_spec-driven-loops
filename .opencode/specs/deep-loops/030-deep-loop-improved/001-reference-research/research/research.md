...
> Reference paths below are relative to the packet root `.opencode/specs/deep-loops/030-deep-loop-improved/`, i.e. `external/loop-cli-main/...` and `external/kasper/...`. OUR target paths are repo-absolute from `.opencode/`.

...
|------|--------|--------|------|
| .opencode/specs/deep-loops/030-deep-loop-improved/external/loop-cli-main/src/core/log-parser.ts | Cited | OK | Citations=1; Iterations=1 |
| .opencode/specs/deep-loops/030-deep-loop-improved/external/loop-cli-main/src/core/loop-controller.ts | Cited | OK | Citations=1; Iterations=1 |
| .opencode/specs/deep-loops/030-deep-loop-improved/external/loop-cli-main/src/daemon/server.ts | Cited | OK | Citations=1; Iterations=1 |
| .opencode/specs/deep-loops/030-deep-loop-improved/external/loop-cli-main/src/types.ts | Cited | OK | Citations=1; Iterations=1 |

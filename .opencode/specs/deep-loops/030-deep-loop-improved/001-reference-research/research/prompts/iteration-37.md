...
Segment: 5 (cross-cutting) | Iteration: 37 of 58
...
Focus Area: [S5-02] What would a loop-wide dry-run mode look like (kasper `--dry-run`) that renders planned iterations/prompts/convergence checks without dispatching executors? -> deep_research_confirm.yaml
...
- Write iteration narrative to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-037.md
- Write per-iteration delta file to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-037.jsonl
...
1. Iteration narrative markdown at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-037.md` with headings: Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus. In Findings give: reference mechanism + file:line; exact OUR target file; port-difficulty (easy/med/hard); quick-win vs deep-rewrite tag.

2. Per-iteration delta file at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-037.jsonl`. Its FIRST line MUST be the canonical iteration record, EXACT type "iteration":
`{"type":"iteration","iteration":37,"newInfoRatio":<0..1>,"status":"<complete|insight|stuck>","focus":"S5-02","graphEvents":[...]}`

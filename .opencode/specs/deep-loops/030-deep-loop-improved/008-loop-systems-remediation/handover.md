...
- **Parent packet:** `.opencode/specs/deep-loops/030-deep-loop-improved/` (the `002-implementation` parent was ungrouped earlier this arc; its children are now 156 root phases `002`–`008`; the whole 156 tree validates 63/63).

...
_memory:
  continuity:
    packet_pointer: "deep-loops/030-deep-loop-improved/002-deep-loop-runtime"
...
### Out of Scope
- Improvements targeting `deep-loop-workflows`, `system-spec-kit`, or `skill-interconnection` subsystems (other subsystem groups in `deep-loops/030-deep-loop-improved`)
...
- **Parent Spec**: `../spec.md` (deep-loops/030-deep-loop-improved)
- **Root Packet**: `../../spec.md` (deep-loops/030-deep-loop-improved)

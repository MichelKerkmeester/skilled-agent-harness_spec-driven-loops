...
| F003 | P1 | CO-017 playbook still expects direct `--agent ai-council` dispatch to exit 0. | `.opencode/skills/cli-opencode/manual_testing_playbook/manual_testing_playbook.md:362`; `.opencode/skills/cli-opencode/manual_testing_playbook/manual_testing_playbook.md:417-423`; `.opencode/skills/cli-opencode/manual_testing_playbook/04--agent-routing/multi-ai-council-multi-strategy.md:27-33`; `.opencode/skills/cli-opencode/manual_testing_playbook/04--agent-routing/multi-ai-council-multi-strategy.md:43`. |

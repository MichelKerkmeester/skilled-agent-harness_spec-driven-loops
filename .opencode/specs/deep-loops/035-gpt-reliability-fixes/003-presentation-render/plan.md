---
title: "Plan: Verbatim Setup-Render Contract (P1)"
description: "Lean plan for phase 003 of packet 035; authored fully at execution. Closes F-006, F-007, F-042; effort S."
trigger_phrases:
  - "plan"
  - "035 003 plan"
...
# Plan: Verbatim Setup-Render Contract (P1)
...
Implement the fix package that closes F-006, F-007, F-042 (effort S), applying the ready designs from the 034 research packet. Full step-by-step plan is authored when this phase is picked up; the requirements and acceptance cells are fixed in `spec.md`.
<!-- /ANCHOR:summary -->
...
Per `spec.md` §3 SCOPE and §4 REQUIREMENTS. The change surfaces and their evidence are named in the closed findings (F-006, F-007, F-042) and the corresponding 034 design iterations.
<!-- /ANCHOR:architecture -->
...
Acceptance is the 033 behavior benchmark: RVB-002, CXB-002, IMB-003 (D2). Re-run gpt-fast-med + gpt-fast-high on the affected cells after the change; baseline leg must not regress.
<!-- /ANCHOR:testing -->

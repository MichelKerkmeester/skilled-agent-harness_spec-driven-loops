---
title: "Plan: Retrofit, Pacing, and Rollout Completion"
description: "Lean plan for phase 005 of packet 035 (unified command-contract architecture); authored fully at execution. Closes F-018, F-023, F-024, F-026, F-032, F-033, F-034; effort L."
trigger_phrases:
  - "plan"
  - "035 005 plan"
...
# Plan: Retrofit, Pacing, and Rollout Completion
...
Implement the fix package that closes F-018, F-023, F-024, F-026, F-032, F-033, F-034 (effort L). The full step-by-step plan is authored when this phase is picked up; requirements and acceptance cells are fixed in `spec.md`, and the packet-wide gap mapping in `../context-index.md`.
<!-- /ANCHOR:summary -->
...
Acceptance is the 033 behavior benchmark: ACB-003, IMB-003, RSB-004, IMB-001-high. Re-run gpt-fast-med + gpt-fast-high on the affected cells; baseline leg must not regress beyond the parent REQ-006 exceptions.
<!-- /ANCHOR:testing -->

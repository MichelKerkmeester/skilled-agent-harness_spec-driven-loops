---
title: "Plan: Command Contract Compiler"
description: "Lean plan for phase 003 of packet 035 (unified command-contract architecture); authored fully at execution. Closes F-006, F-007, F-009, F-019, F-020, F-021, F-022, F-027, F-029, F-035, F-036, F-037, F-038, F-039, F-042; effort L."
trigger_phrases:
  - "plan"
  - "035 003 plan"
...
# Plan: Command Contract Compiler
...
Implement the fix package that closes F-006, F-007, F-009, F-019, F-020, F-021, F-022, F-027, F-029, F-035, F-036, F-037, F-038, F-039, F-042 (effort L). The full step-by-step plan is authored when this phase is picked up; requirements and acceptance cells are fixed in `spec.md`, and the packet-wide gap mapping in `../context-index.md`.
<!-- /ANCHOR:summary -->
...
Acceptance is the 033 behavior benchmark: RVB-002, CXB-002, IMB-003 + structural assertions. Re-run gpt-fast-med + gpt-fast-high on the affected cells; baseline leg must not regress beyond the parent REQ-006 exceptions.
<!-- /ANCHOR:testing -->

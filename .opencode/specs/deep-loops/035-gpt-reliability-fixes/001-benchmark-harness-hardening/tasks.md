---
title: "Tasks: Benchmark Harness Hardening"
description: "Task stub for phase 001 of packet 035; closes F-014, F-025."
trigger_phrases:
  - "tasks"
  - "035 001 tasks"
...
# Tasks: Benchmark Harness Hardening
...
- [ ] T001 Apply the requirement edits from `spec.md` §4, verifying quoted current-text against the live files first (closes F-014, F-025).
<!-- /ANCHOR:phase-1 -->
...
- [ ] T002 Re-run the acceptance cells (Harness-internal (enables every later phase's cell-flip verification)) on gpt-fast-med + gpt-fast-high; confirm the baseline leg does not regress.
<!-- /ANCHOR:phase-2 -->

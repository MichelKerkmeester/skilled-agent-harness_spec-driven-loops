---
title: "Plan: Top-Loaded Agent Executor Contracts (P2)"
description: "Lean plan for phase 007 of packet 035; authored fully at execution. Closes F-019, F-020, F-021, F-022, F-039; effort M."
trigger_phrases:
  - "plan"
  - "035 007 plan"
...
# Plan: Top-Loaded Agent Executor Contracts (P2)
...
Implement the fix package that closes F-019, F-020, F-021, F-022, F-039 (effort M), applying the ready designs from the 034 research packet. Full step-by-step plan is authored when this phase is picked up; the requirements and acceptance cells are fixed in `spec.md`.
<!-- /ANCHOR:summary -->
...
Per `spec.md` §3 SCOPE and §4 REQUIREMENTS. The change surfaces and their evidence are named in the closed findings (F-019, F-020, F-021, F-022, F-039) and the corresponding 034 design iterations.
<!-- /ANCHOR:architecture -->
...
Acceptance is the 033 behavior benchmark: Cross-class (Gate-3 inversion, presentation, absorption); measured indirectly. Re-run gpt-fast-med + gpt-fast-high on the affected cells after the change; baseline leg must not regress.
<!-- /ANCHOR:testing -->

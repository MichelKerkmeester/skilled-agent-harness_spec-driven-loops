...
- [x] T013 Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/deep-loops/032-goal-opencode-plugin/017-hot-path-optimization --strict` (this is a Level 1 phase, no checklist.md required); write `implementation-summary.md`

...
Iteration: 4 of 15
Dimension: correctness (pass D: sk-prompt-goal-enhancement + system-spec-kit-integration, closing correctness pass)
Prior Findings: P0=0 P1=3 P2=0
Dimension Coverage: correctness in progress (1/4 dimensions touched, 6 of 8 phases reviewed)
...
Open findings: DR-001-P1-001 (injection cap), DR-002-P1-001 (command naming drift), DR-003-P1-001 (stale-verifier continuation race)

Review Iteration: 4 of 15
Mode: review
Dimension: correctness -- PASS D (closing correctness pass). Focus this iteration on: (a) .opencode/plugins/mk-goal.js sections implementing sk-prompt goal-enhancement hooks (how objective/goal_prompt text is shaped or enhanced before storage/injection) and system-spec-kit integration (any hooks into spec-kit workflows, generate-context.js, memory save, or constitutional rules), cross-checked against 032-goal-opencode-plugin/007-sk-prompt-goal-enhancement/{spec,plan,tasks,implementation-summary}.md and 032-goal-opencode-plugin/008-system-spec-kit-integration/{spec,plan,tasks,implementation-summary}.md; (b) do a final correctness sweep of .opencode/commands/opencode_goal.md end-to-end against actual tool behavior (arguments, defaults, error messages) since only a partial pass happened in iteration 2; (c) if time remains, spot-check .opencode/plugins/__tests__/mk-goal-export-contract.test.cjs for any correctness-relevant export/loader mismatch. IMPORTANT SCOPE BOUNDARY: 032-goal-opencode-plugin/009-speckit-command-goal-prompt-offer/** remains OUT OF SCOPE -- this includes not inferring what phase 007/008 imply about phase 009's design.
...
Review Scope Files: .opencode/plugins/mk-goal.js, .opencode/commands/opencode_goal.md, .opencode/plugins/__tests__/mk-goal-export-contract.test.cjs, 032-goal-opencode-plugin/007-sk-prompt-goal-enhancement/{spec,plan,tasks,implementation-summary}.md, 032-goal-opencode-plugin/008-system-spec-kit-integration/{spec,plan,tasks,implementation-summary}.md -- EXCLUDED: 032-goal-opencode-plugin/009-speckit-command-goal-prompt-offer/**
Prior Findings: P0=0 P1=3 P2=0
...
- Write iteration narrative to: .opencode/specs/deep-loops/032-goal-opencode-plugin/review/iterations/iteration-004.md
- Write per-iteration delta file to: .opencode/specs/deep-loops/032-goal-opencode-plugin/review/deltas/iter-004.jsonl
...
- **ALLOWED WRITE PATHS (the ONLY paths you may create, modify, or append to)**:
  - `.opencode/specs/deep-loops/032-goal-opencode-plugin/review/iterations/iteration-004.md`, this iteration's narrative markdown
  - `.opencode/specs/deep-loops/032-goal-opencode-plugin/review/deep-review-state.jsonl`, append-only JSONL state log
  - `.opencode/specs/deep-loops/032-goal-opencode-plugin/review/deltas/iter-004.jsonl`, this iteration's delta JSONL
...
- **SCOPE VIOLATION PROTOCOL**: if your plan would require modifying any path NOT in the allowed-write list, you MUST STOP that action and emit a finding instead. Record the would-be mutation as a `scope_violation` entry in the iteration narrative (under a `## SCOPE VIOLATIONS` heading) and continue the review. NEVER execute the out-of-scope mutation. The review packet (`.opencode/specs/deep-loops/032-goal-opencode-plugin/review/iterations/iteration-004.md` directory and parents) is the only zone for your writes; the reviewed target spec/code is off-limits.
...
1. **Iteration narrative markdown** at `.opencode/specs/deep-loops/032-goal-opencode-plugin/review/iterations/iteration-004.md` (path pre-substituted for the current iteration number). Structure: headings for Dimension, Files Reviewed, Findings by Severity (P0/P1/P2), Traceability Checks, Verdict, Next Dimension.
...
3. **Per-iteration delta file** at `.opencode/specs/deep-loops/032-goal-opencode-plugin/review/deltas/iter-004.jsonl` (path pre-substituted, e.g. `deltas/iter-001.jsonl`). This file holds the structured delta stream for this iteration: one `{"type":"iteration",...}` record (same as the state-log append) plus per-event structured records (one per graphEvent, finding, classification, traceability-check, ruled_out direction). Each record on its own JSON line.

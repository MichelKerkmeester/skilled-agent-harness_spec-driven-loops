---
title: "Changelog: Phase 1: state-store [032-goal-opencode-plugin/001-state-store]"
...
> Spec folder: `.opencode/specs/deep-loops/032-goal-opencode-plugin/001-state-store` (Level 1)

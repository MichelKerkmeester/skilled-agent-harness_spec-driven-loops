...
- Same-class producers: `rg -n "of 7 |of 8 |of 9 |of 13 " .opencode/specs/deep-loops/032-goal-opencode-plugin/0*/spec.md` — confirm the exact set of phase-count self-labels before editing.
- Consumers of changed symbols: `rg -n "opencode_goal\.md|packet-wide" .opencode/specs/deep-loops/032-goal-opencode-plugin` — confirm the full set of PKT-5/PKT-6 narrative locations before editing, since the dossier's list may not be exhaustive (011 spec.md:75 was found this way, beyond the dossier's originally cited locations).

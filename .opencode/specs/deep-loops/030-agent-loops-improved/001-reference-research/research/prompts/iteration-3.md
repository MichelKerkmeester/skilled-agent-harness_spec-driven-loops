...
Segment: 1 (mine loop-cli-main) | Iteration: 3 of 58
Questions: 0/12 checked | Last focus: S1-02
Last 2 ratios: 0.88 -> 0.76 | Stuck count: 0
...
Focus Area: [S1-03] How does loop-cli-main's triggerNow() save/restore the schedule around a forced run and guard against double-run? → deep_research_auto.yaml run-now control
...
Last 3 Iterations Summary: run 1: S1-01 (ratio 0.88); run 2: S1-02 (ratio 0.76)
...
- Write iteration narrative to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-003.md
- Write per-iteration delta file to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-003.jsonl
...
1. Iteration narrative markdown at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-003.md` with headings: Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus. In Findings give: reference mechanism + file:line; exact OUR target file; port-difficulty (easy/med/hard); quick-win vs deep-rewrite tag.

2. Canonical JSONL record APPENDED to the State Log, EXACT type "iteration":
`{"type":"iteration","iteration":3,"newInfoRatio":<0..1>,"status":"<complete|insight|stuck>","focus":"S1-03","graphEvents":[...]}`
...
3. Per-iteration delta file at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-003.jsonl`: the same iteration record plus one record per finding/observation/graphEvent, each on its own line.

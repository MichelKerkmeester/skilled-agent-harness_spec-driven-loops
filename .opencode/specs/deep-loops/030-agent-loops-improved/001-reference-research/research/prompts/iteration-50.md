...
Segment: W (wildcard / broaden) | Iteration: 50 of 58
Questions: 0/75 checked | Last focus: S6-09
Last 2 ratios: 0.37 -> 0.43 | Stuck count: 0
...
Iteration: 50 of 58
Dimension this iteration: D3 (cross-cutting)
Focus Area: [W-06] Could we build a record-replay harness capturing each iteration's dispatch inputs/outputs (loop-cli fixture style) so a full run is deterministically replayable for convergence-change regression? -> deep-loop-runtime tests (record-replay)
...
Last 3 Iterations Summary: run 46: S6-06 (ratio 0.5); run 47: S6-08 (ratio 0.37); run 48: S6-09 (ratio 0.43)
...
- Write iteration narrative to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-050.md
- Write per-iteration delta file to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-050.jsonl
...
1. Iteration narrative markdown at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-050.md` with headings: Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus. In Findings give: reference mechanism + file:line; exact OUR target file; port-difficulty (easy/med/hard); quick-win vs deep-rewrite tag.

2. Per-iteration delta file at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-050.jsonl`. Its FIRST line MUST be the canonical iteration record, EXACT type "iteration":
`{"type":"iteration","iteration":50,"newInfoRatio":<0..1>,"status":"<complete|insight|stuck>","focus":"W-06","graphEvents":[...]}`

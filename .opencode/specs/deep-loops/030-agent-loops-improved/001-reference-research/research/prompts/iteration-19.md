...
Segment: 3 (map -> deep-loop-runtime) | Iteration: 19 of 58
Questions: 0/36 checked | Last focus: S3-02
...
Focus Area: [S3-03] Should `atomic-state.ts` adopt kasper's SHA-256 `_integrity` stamp so JSONL/registry tampering between iterations is detected on resume? (build on S2-09) -> atomic-state.ts
...
Last 3 Iterations Summary: run 16: S2-08 (ratio 0.77); run 17: S3-01 (ratio 0.74); run 18: S3-02 (ratio 0.68)
...
- Write iteration narrative to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-019.md
- Write per-iteration delta file to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-019.jsonl
...
1. Iteration narrative markdown at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-019.md` with headings: Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus. In Findings give: reference mechanism + file:line; exact OUR target file; port-difficulty (easy/med/hard); quick-win vs deep-rewrite tag.

2. Canonical JSONL record APPENDED to the State Log, EXACT type "iteration":
`{"type":"iteration","iteration":19,"newInfoRatio":<0..1>,"status":"<complete|insight|stuck>","focus":"S3-03","graphEvents":[...]}`
...
3. Per-iteration delta file at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-019.jsonl`: the same iteration record plus one record per finding/observation/graphEvent, each on its own line.

...
Segment: 3 (map -> deep-loop-runtime) | Iteration: 24 of 58
Questions: 0/36 checked | Last focus: S3-09
Last 2 ratios: 0.57 -> 0.58 | Stuck count: 0
...
Focus Area: [S3-10] Our stall detector (`lag_ceiling_exceeded`) only warns — should it adopt kasper's stuck-watchdog force-clear to abort+requeue a hung lineage past the ceiling? (build on S2-10) -> fanout-pool.cjs
...
Last 3 Iterations Summary: run 21: S3-05 (ratio 0.46); run 22: S3-06 (ratio 0.57); run 23: S3-09 (ratio 0.58)
...
- Write iteration narrative to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-024.md
- Write per-iteration delta file to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-024.jsonl
...
1. Iteration narrative markdown at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-024.md` with headings: Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus. In Findings give: reference mechanism + file:line; exact OUR target file; port-difficulty (easy/med/hard); quick-win vs deep-rewrite tag.

2. Canonical JSONL record APPENDED to the State Log, EXACT type "iteration":
`{"type":"iteration","iteration":24,"newInfoRatio":<0..1>,"status":"<complete|insight|stuck>","focus":"S3-10","graphEvents":[...]}`
...
3. Per-iteration delta file at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-024.jsonl`: the same iteration record plus one record per finding/observation/graphEvent, each on its own line.

...
Segment: 3 (map -> deep-loop-runtime) | Iteration: 20 of 58
Questions: 0/36 checked | Last focus: S3-03
Last 2 ratios: 0.68 -> 0.62 | Stuck count: 0
...
Focus Area: [S3-04] Would kasper's debounced-flush + version dirty-again model reduce write amplification when the reducer rewrites strategy/registry/dashboard 3× per iteration, without dropping the last write? (build on S2-07) -> atomic-state.ts
...
Last 3 Iterations Summary: run 17: S3-01 (ratio 0.74); run 18: S3-02 (ratio 0.68); run 19: S3-03 (ratio 0.62)
...
- Write iteration narrative to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-020.md
- Write per-iteration delta file to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-020.jsonl
...
1. Iteration narrative markdown at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-020.md` with headings: Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus. In Findings give: reference mechanism + file:line; exact OUR target file; port-difficulty (easy/med/hard); quick-win vs deep-rewrite tag.

2. Canonical JSONL record APPENDED to the State Log, EXACT type "iteration":
`{"type":"iteration","iteration":20,"newInfoRatio":<0..1>,"status":"<complete|insight|stuck>","focus":"S3-04","graphEvents":[...]}`
...
3. Per-iteration delta file at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-020.jsonl`: the same iteration record plus one record per finding/observation/graphEvent, each on its own line.

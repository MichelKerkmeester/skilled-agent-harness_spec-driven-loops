...
Segment: 5 (cross-cutting) | Iteration: 36 of 58
...
Focus Area: [S5-07] How can a bridge seed the coverage-graph from `code_graph_query`/impact at init so review/context loops start with real FILE/DEPENDENCY nodes instead of an empty graph returning CONTINUE? -> code-graph↔deep-loop
...
- Write iteration narrative to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-036.md
- Write per-iteration delta file to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-036.jsonl
...
1. Iteration narrative markdown at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-036.md` with headings: Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus. In Findings give: reference mechanism + file:line; exact OUR target file; port-difficulty (easy/med/hard); quick-win vs deep-rewrite tag.

2. Per-iteration delta file at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-036.jsonl`. Its FIRST line MUST be the canonical iteration record, EXACT type "iteration":
`{"type":"iteration","iteration":36,"newInfoRatio":<0..1>,"status":"<complete|insight|stuck>","focus":"S5-07","graphEvents":[...]}`

---
title: "Changelog: Rejected-Pattern Cache for Research State [003-deep-loop-workflows/006-rejected-pattern-cache]"
...
> Spec folder: `.opencode/specs/deep-loops/030-agent-loops-improved/003-deep-loop-workflows/006-rejected-pattern-cache` (Level 1)

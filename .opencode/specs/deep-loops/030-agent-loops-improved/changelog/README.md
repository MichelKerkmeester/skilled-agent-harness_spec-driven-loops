...
description: "Program-level index of all packet-local changelogs for spec 156 (agent-loops-improved), organized under ten phases that ran from reference research through deep-loop implementation to a research-backlog remediation track and a documentation truth audit. Each phase links to its top rollup."
trigger_phrases:
  - "156 changelog index"

...
> Spec folder: `.opencode/specs/deep-loops/030-agent-loops-improved/009-research-backlog-remediation/004-phase-doc-map-and-completion-pct-sync` (Level 1)
...
| `.opencode/specs/deep-loops/030-agent-loops-improved/{002..007}/spec.md` | Modified | Phase Documentation Map Status columns corrected. |
| `.opencode/specs/deep-loops/030-agent-loops-improved/{002..007}/**/spec.md` (40 files) | Modified | `completion_pct` frontmatter corrected. |

...
| Field | Value |
|-------|-------|
| **Spec Folder** | `deep-loops/030-agent-loops-improved/009-research-backlog-remediation/006-review-registry-and-metadata-backfill` |
...
| `.opencode/skills/deep-loops/030-agent-loops-improved/008-loop-systems-remediation/graph-metadata.json`, root `graph-metadata.json`, root `description.json` | Regenerated | Real `key_files`; non-truncated description |
<!-- /ANCHOR:what-built -->

...
_memory:
  continuity:
    packet_pointer: "deep-loops/030-agent-loops-improved/009-research-backlog-remediation/004-phase-doc-map-and-completion-pct-sync"
...
| `030-agent-loops-improved/{002..007}/spec.md` | Modify | Phase Documentation Map Status columns |
| `030-agent-loops-improved/{002..007}/**/spec.md` (143 grandchildren, revised count) | Modify | `completion_pct` frontmatter field |
<!-- /ANCHOR:scope -->

# Research Report: Perfecting deep-loops/030-agent-loops-improved (Fan-Out Synthesis)
...
**[F-011] 14 references to the old pre-migration packet number (`123-agent-loops-improved`) persist across 7 phase-parent `spec.md` files** (in Parent Spec, Successor, and prose fields) — the packet was migrated to `030-agent-loops-improved` but a global find-replace was never completed. This directly explains and generalizes the pre-seeded "orphaned pre-migration `review-report.md` at the old `skilled-agent-orchestration/123-agent-loops-improved` path" lead — it's not an isolated orphaned file, it's a **systemic 14-reference migration-residue pattern** across 7 files. **Recommendation:** global find-replace `123-agent-loops-improved` → `030-agent-loops-improved` (and audit for any `156-agent-loops-improved` variant per F-007's lock file); tombstone or delete the orphaned old-path `review-report.md`.
...
- glm lineage synthesis (source): `.opencode/specs/deep-loops/030-agent-loops-improved/research/lineages/glm/research.md`
- gpt lineage synthesis (source): `.opencode/specs/deep-loops/030-agent-loops-improved/research/lineages/gpt/research.md`
- glm findings registry (raw, `findings` schema): `.opencode/specs/deep-loops/030-agent-loops-improved/research/lineages/glm/deep-research-findings-registry.json`
- gpt findings registry (raw, `keyFindings` schema): `.opencode/specs/deep-loops/030-agent-loops-improved/research/lineages/gpt/deep-research-findings-registry.json`
- Merged (gpt-only, see §4.1 bug) root registry: `.opencode/specs/deep-loops/030-agent-loops-improved/research/deep-research-findings-registry.json`
- `fanout-attribution.md`: `.opencode/specs/deep-loops/030-agent-loops-improved/research/fanout-attribution.md`

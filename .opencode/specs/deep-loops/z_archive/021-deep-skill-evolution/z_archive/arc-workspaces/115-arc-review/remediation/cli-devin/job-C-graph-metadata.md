...
| 7 | `.opencode/specs/skilled-agent-orchestration/z_archive/093-small-ai-model-optimization/007-sk-prompt-models-rename/graph-metadata.json` | `"skilled-agent-orchestration/z_archive/093-small-ai-model-optimization"` | `"complete"` |
...
- Run `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/093-small-ai-model-optimization/007-sk-prompt-models-rename --strict`. Expect exit 0.

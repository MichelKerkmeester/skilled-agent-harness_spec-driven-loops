...
This packet is RESEARCH-ONLY. Do NOT modify any source files in the triad. You may read freely, write to /tmp/ for scratch work, and write your iteration findings to `research/iterations/iteration-001.md`.
...
This is iteration 1. No prior findings exist. Start with RQ-1 and RQ-3 as your primary focus per the strategy file.
...
4. Write your iteration findings to `research/iterations/iteration-001.md` using the EXACT structure below
5. Stop after writing — do not continue investigating beyond this iteration

## OUTPUT FORMAT (write to research/iterations/iteration-001.md)
...
[Recommend what iteration 2 should focus on, given what's now answered vs still open]
...
- Write only to `research/iterations/iteration-001.md`

...
- [ ] T004 Freeze aliases schema (B6), {skill,mode} contract (B2), deep-context metadata-routed (B3); record in decision-record (`.opencode/specs/deep-loops/029-deep-loop-workflows/006-advisor-graph-mode-routing/plan.md`, `.opencode/specs/deep-loops/029-deep-loop-workflows/006-advisor-graph-mode-routing/decision-record.md`)

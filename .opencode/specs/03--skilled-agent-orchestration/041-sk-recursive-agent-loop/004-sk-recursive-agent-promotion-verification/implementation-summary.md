...
- `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/03--skilled-agent-orchestration/041-sk-agent-improver-loop --strict`
- `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/03--skilled-agent-orchestration/041-sk-agent-improver-loop/004-sk-agent-improver-promotion-verification --strict`

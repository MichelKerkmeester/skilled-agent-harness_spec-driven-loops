...
- `bash .opencode/skill/system-spec-kit/scripts/spec/validate.sh .opencode/specs/03--skilled-agent-orchestration/041-sk-agent-improver-loop/003-sk-agent-improver-doc-alignment --strict`

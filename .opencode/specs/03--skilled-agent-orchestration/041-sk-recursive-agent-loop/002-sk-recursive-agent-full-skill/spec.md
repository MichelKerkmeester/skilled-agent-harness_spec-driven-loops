---
title: "Feature Specification: Agent Improvement Full Skill [03--skilled-agent-orchestration/041-sk-agent-improver-loop/002-sk-agent-improver-full-skill/spec]"
...
| `.opencode/specs/03--skilled-agent-orchestration/041-sk-agent-improver-loop/002-sk-agent-improver-full-skill/` | Create | Phase `002` docs and verification evidence |
<!-- /ANCHOR:scope -->

...
2. The existing recommendation still holds: start propose-only, then bounded auto-edit, then parity-aware expansion. That sequence matches both the external loop's narrow-boundary discipline and the repo's strong promotion gates. [SOURCE: .opencode/specs/03--skilled-agent-orchestration/041-sk-agent-improver-loop/external/autoagent-main/program.md:89] [SOURCE: .opencode/specs/03--skilled-agent-orchestration/041-sk-agent-improver-loop/external/autoagent-main/program.md:156] [SOURCE: .opencode/skill/sk-deep-research/SKILL.md:179]

...
description: "041 is the parent packet for the sk-agent-improver program, with completed child phases 001 through 008. Phase 008 adds holistic 5-dimension evaluation, integration scanning, dynamic profiling, any-agent support, and renames the skill from sk-recursive-agent to sk-agent-improver."
trigger_phrases:
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 041-sk-agent-improver-loop |
...
`041-sk-agent-improver-loop` now acts as the parent packet for the agent-improver program rather than a flat one-pass packet. The original evaluator-first MVP work now lives in [001-sk-agent-improver-mvp/](./001-sk-agent-improver-mvp/), the broader full-skill expansion lives in [002-sk-agent-improver-full-skill/](./002-sk-agent-improver-full-skill/), the sk-doc alignment closeout lives in [003-sk-agent-improver-doc-alignment/](./003-sk-agent-improver-doc-alignment/), the promotion-verification closeout lives in [004-sk-agent-improver-promotion-verification/](./004-sk-agent-improver-promotion-verification/), the package/runtime alignment closeout lives in [005-sk-agent-improver-package-runtime-alignment/](./005-sk-agent-improver-package-runtime-alignment/), the command-entrypoint rename lives in [006-sk-agent-improver-command-rename/](./006-sk-agent-improver-command-rename/), and the wording-alignment cleanup lives in [007-sk-agent-improver-wording-alignment/](./007-sk-agent-improver-wording-alignment/).

### Phase 1: Recursive Agent MVP ([001-sk-agent-improver-mvp/](./001-sk-agent-improver-mvp/))
...
### Phase 2: Recursive Agent Full Skill ([002-sk-agent-improver-full-skill/](./002-sk-agent-improver-full-skill/))
...
### Phase 3: Recursive Agent sk-doc Alignment ([003-sk-agent-improver-doc-alignment/](./003-sk-agent-improver-doc-alignment/))

Phase 3 contains the documentation-structure closeout: `sk-doc` alignment for `.opencode/skill/sk-agent-improver/SKILL.md`, the skill README, bundled references and markdown assets, the canonical loop command, the canonical loop agent, and the parent packet records.

### Phase 4: Recursive Agent Promotion Verification ([004-sk-agent-improver-promotion-verification/](./004-sk-agent-improver-promotion-verification/))
...
### Phase 5: Recursive Agent Package and Runtime Alignment ([005-sk-agent-improver-package-runtime-alignment/](./005-sk-agent-improver-package-runtime-alignment/))
...
### Phase 6: Recursive Agent Command Rename ([006-sk-agent-improver-command-rename/](./006-sk-agent-improver-command-rename/))
...
### Phase 7: Recursive Agent Wording Alignment ([007-sk-agent-improver-wording-alignment/](./007-sk-agent-improver-wording-alignment/))
...
Future agent-improver work should continue under `041-sk-agent-improver-loop/` as additional child phases such as `010-*` and later folders.
<!-- /ANCHOR:what-built -->
...
| Skill rename verification | sk-recursive-agent -> sk-agent-improver | PASS (0 old refs) |
| `sk-agent-improver` package validation | Skill docs | PASS |

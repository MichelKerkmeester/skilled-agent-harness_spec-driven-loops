...
## Replay Method
1. Replayed the actual `newFindingsRatio` sequences from the completed review runs in spec `012` and spec `013`. [SOURCE: .opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/012-pre-release-fixes-alignment-preparation/research/deep-research-state.jsonl:2-8] [SOURCE: .opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/013-memory-generation-quality/research/deep-research-state.jsonl:2-6]
...
- Keep MAD weight reduced relative to research mode; the real runs still use it effectively as a late-pass confirmation signal in spec `013`. [SOURCE: .opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/013-memory-generation-quality/research/deep-research-state.jsonl:5-6] [SOURCE: .opencode/specs/03--commands-and-skills/030-sk-deep-research-review-mode/scratch/archive-research-v1/iteration-002.md:166-171]
...
- `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/012-pre-release-fixes-alignment-preparation/research/deep-research-state.jsonl`
- `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/012-pre-release-fixes-alignment-preparation/research/iterations/iteration-006.md`
- `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/013-memory-generation-quality/research/deep-research-state.jsonl`
- `.opencode/specs/02--system-spec-kit/022-hybrid-rag-fusion/001-hybrid-rag-fusion-epic/013-memory-generation-quality/research/iterations/iteration-004.md`

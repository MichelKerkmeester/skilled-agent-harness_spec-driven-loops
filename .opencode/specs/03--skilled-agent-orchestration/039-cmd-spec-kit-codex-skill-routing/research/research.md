...
4. Historical repo work already exposed command-surface drift around `/memory:save`, so any solution that duplicates command inventories broadly is likely to regress over time. [SOURCE: `specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/064-bug-analysis-and-fix/tasks.md:350-379`]
...
- `specs/02--system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/064-bug-analysis-and-fix/tasks.md:350-379`

...
| Session ID | session-1769411868736-9m49afj1w |
| Spec Folder | 005-anobel.com/024-performance-optimization |
| Channel | main |
...
| Created At (Epoch) | 1769411868 |
| Last Accessed (Epoch) | 1769411868 |
| Access Count | 1 |
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 005-anobel.com/024-performance-optimization` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "005-anobel.com/024-performance-optimization" })` |
...
```yaml
# Core Identifiers
session_id: "session-1769411868736-9m49afj1w"
spec_folder: "005-anobel.com/024-performance-optimization"
channel: "main"
...
created_at_epoch: 1769411868
last_accessed_epoch: 1769411868
expires_at_epoch: 1777187868  # 0 for critical (never expires)
...
parent_spec: "005-anobel.com/024-performance-optimization"
child_sessions:

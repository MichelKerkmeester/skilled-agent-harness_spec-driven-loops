...
| Spec Folder | 03--commands-and-skills/cli-001-gemini |
| Channel | main |
...
```
/spec_kit:resume 03--commands-and-skills/cli-001-gemini
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: 03--commands-and-skills/cli-001-gemini
Last: Tool: bash
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 03--commands-and-skills/cli-001-gemini` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "03--commands-and-skills/cli-001-gemini" })` |
...
memory_search({ specFolder: "03--commands-and-skills/cli-001-gemini", limit: 10 })

# Verify memory file integrity
ls -la 03--commands-and-skills/cli-001-gemini/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js 03--commands-and-skills/cli-001-gemini --force
```
...
spec_folder: "03--commands-and-skills/cli-001-gemini"
channel: "main"
...
trigger_phrases:
  - "skill graph memory analysis"
  - "sgqs memory integration"
  - "cli gemini memory audit"parent_spec: "03--commands-and-skills/cli-001-gemini"
child_sessions:

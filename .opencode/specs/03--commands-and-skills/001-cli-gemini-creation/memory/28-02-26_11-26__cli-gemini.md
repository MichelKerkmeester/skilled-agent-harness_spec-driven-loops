...
| Spec Folder | 03--commands-and-skills/001-cli-gemini |
| Channel | main |
...
```
/spec_kit:resume 03--commands-and-skills/001-cli-gemini
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: 03--commands-and-skills/001-cli-gemini
Last: Tool: bash
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 03--commands-and-skills/001-cli-gemini` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "03--commands-and-skills/001-cli-gemini" })` |
...
memory_search({ specFolder: "03--commands-and-skills/001-cli-gemini", limit: 10 })

# Verify memory file integrity
ls -la 03--commands-and-skills/001-cli-gemini/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js 03--commands-and-skills/001-cli-gemini --force
```
...
spec_folder: "03--commands-and-skills/001-cli-gemini"
channel: "main"
...
trigger_phrases:
  - "skill graph memory analysis"
  - "sgqs memory integration"
  - "cli gemini memory audit"parent_spec: "03--commands-and-skills/001-cli-gemini"
child_sessions:

---
title: "Verification Checklist: Create Changelog Command [03--commands-and-skills/015-cmd-create-changelog/checklist]"
...
- [x] CHK-050 [P1] Files in correct locations per project structure [EVIDENCE: changelog.md in command/create/, YAMLs in command/create/assets/, spec files in specs/03--commands-and-skills/015-cmd-create-changelog/]

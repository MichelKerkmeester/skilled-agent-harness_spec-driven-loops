...
**Key Topics:** `changelog` | `decision` | `folder` | `component` | `create` | `commands` | `hardcoded component` | `command` | `commands and skills/014-cmd-create-changelog` | `discovery` | `styling` | `unicode` | 
<!-- /ANCHOR:project-state-snapshot -->
...
trigger_phrases:
  ...
  - "dynamic folder discovery"
  - "unicode changelog styling"
  - "gemini changelog wrapper"parent_spec: "03--commands-and-skills/015-cmd-create-changelog"
child_sessions:

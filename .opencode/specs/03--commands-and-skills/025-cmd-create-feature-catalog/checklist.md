...
- [ ] CHK-013 [P1] The command loads both feature-catalog templates and the creation reference
- [ ] CHK-014 [P1] Runtime discovery docs stay synchronized
<!-- /ANCHOR:code-quality -->
...
- [ ] CHK-020 [P0] `validate_document.py` passes for `.opencode/command/create/feature-catalog.md`
- [ ] CHK-021 [P0] YAML parse checks pass for both workflow assets
- [ ] CHK-022 [P1] TOML parse check passes for `.agents/commands/create/feature-catalog.toml`
...
- [ ] CHK-031 [P1] The command does not fabricate shipped behavior in scaffold text
- [ ] CHK-032 [P1] Failure paths are documented when reference/template inputs are missing
<!-- /ANCHOR:security -->
...
- [ ] CHK-133 [P2] Custom `--path` handling documented with examples
<!-- /ANCHOR:compliance-verify -->

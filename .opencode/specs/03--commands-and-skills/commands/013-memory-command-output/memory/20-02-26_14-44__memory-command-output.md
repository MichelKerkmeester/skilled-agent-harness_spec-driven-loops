...
trigger_phrases:
  ...
  - "decision replaced emoji status"
  - "replaced emoji status indicators"
  - "emoji status indicators plain"
  - "status indicators plain text"
  - "indicators plain text pass/warn/fail"
  - "plain text pass/warn/fail terminal"
  - "text pass/warn/fail terminal rendering"
  - "pass/warn/fail terminal rendering reliable"
  - "terminal rendering reliable accessible"
  - "decision swapped continue.md sections"
  - "swapped continue.md sections purpose"
  - "continue.md sections purpose precede"
  - "sections purpose precede implementation"
  - "purpose precede implementation sections"
  - "precede implementation sections per"
  - "implementation sections per template"
  - "component design system vocabulary"
  - "design system vocabulary command"
  - "system vocabulary command header"
  - "vocabulary command header label"
  - "commands"
  - "and"
  - "skills/036"
  - "memory"
...
key_files:
  ...
  - ".opencode/changelog/01--system-spec-kit/v2.2.27.0.md"
  - ".opencode/.../013-memory-command-output/implementation-summary.md"
  - ".opencode/.../013-memory-command-output/checklist.md"
...
parent_spec: "03--commands-and-skills/013-memory-command-output"
child_sessions:

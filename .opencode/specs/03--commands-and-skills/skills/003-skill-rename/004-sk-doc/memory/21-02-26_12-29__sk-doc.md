...
```
/spec_kit:resume 03--commands-and-skills/002-skill-rename/004-sk-doc
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: 03--commands-and-skills/002-skill-rename/004-sk-doc
Last: Tool: bash
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 03--commands-and-skills/002-skill-rename/004-sk-doc` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "03--commands-and-skills/002-skill-rename/004-sk-doc" })` |
...
memory_search({ specFolder: "03--commands-and-skills/002-skill-rename/004-sk-doc", limit: 10 })

# Verify memory file integrity
ls -la 03--commands-and-skills/002-skill-rename/004-sk-doc/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js 03--commands-and-skills/002-skill-rename/004-sk-doc --force
```
...
spec_folder: "03--commands-and-skills/002-skill-rename/004-sk-doc"
channel: "main"
...
parent_spec: "03--commands-and-skills/002-skill-rename/004-sk-doc"
child_sessions:

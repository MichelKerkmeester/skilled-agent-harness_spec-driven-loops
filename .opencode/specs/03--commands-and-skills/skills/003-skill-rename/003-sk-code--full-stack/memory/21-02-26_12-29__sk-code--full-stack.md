...
| Spec Folder | 03--commands-and-skills/002-skill-rename/003-sk-code--full-stack |
| Channel | main |
...
```
/spec_kit:resume 03--commands-and-skills/002-skill-rename/003-sk-code--full-stack
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: 03--commands-and-skills/002-skill-rename/003-sk-code--full-stack
Last: Tool: bash
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume 03--commands-and-skills/002-skill-rename/003-sk-code--full-stack` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "03--commands-and-skills/002-skill-rename/003-sk-code--full-stack" })` |
...
memory_search({ specFolder: "03--commands-and-skills/002-skill-rename/003-sk-code--full-stack", limit: 10 })

# Verify memory file integrity
ls -la 03--commands-and-skills/002-skill-rename/003-sk-code--full-stack/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skill/system-spec-kit/scripts/dist/memory/generate-context.js 03--commands-and-skills/002-skill-rename/003-sk-code--full-stack --force
```
...
spec_folder: "03--commands-and-skills/002-skill-rename/003-sk-code--full-stack"
channel: "main"
...
parent_spec: "03--commands-and-skills/002-skill-rename/003-sk-code--full-stack"
child_sessions:

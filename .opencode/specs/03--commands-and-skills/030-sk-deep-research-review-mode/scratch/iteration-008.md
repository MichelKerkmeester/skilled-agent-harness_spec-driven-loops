...
## Focus
Determine how `@deep-review` should integrate with the existing `@review` agent and `sk-code--review` skill so the deep-review loop reuses the baseline reviewer contract without duplicating rubric, severity, and overlay logic. [SOURCE: .opencode/specs/03--commands-and-skills/030-sk-deep-research-review-mode/scratch/deep-research-strategy.md:32] [SOURCE: .opencode/specs/03--commands-and-skills/030-sk-deep-research-review-mode/scratch/deep-research-strategy.md:135]
...
- `.opencode/specs/03--commands-and-skills/030-sk-deep-research-review-mode/scratch/iteration-007.md`

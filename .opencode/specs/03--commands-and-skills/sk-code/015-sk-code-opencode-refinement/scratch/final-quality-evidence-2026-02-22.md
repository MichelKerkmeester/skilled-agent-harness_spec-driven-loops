...
- Changed files (scoped):
  ...
  - .opencode/specs/03--commands-and-skills/015-sk-code-opencode-refinement/checklist.md
  - .opencode/specs/03--commands-and-skills/015-sk-code-opencode-refinement/global-quality-sweep.md
  - .opencode/specs/03--commands-and-skills/015-sk-code-opencode-refinement/tasks.md
...
───────────────────────────────────────────────────────────────
  ...
  Folder: .opencode/specs/03--commands-and-skills/015-sk-code-opencode-refinement
  Level:  3+ (explicit)
...
✓ FOLDER_NAMING: Folder name '015-sk-code-opencode-refinement' follows naming convention

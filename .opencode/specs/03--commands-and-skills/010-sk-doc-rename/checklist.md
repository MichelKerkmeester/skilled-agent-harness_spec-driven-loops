...
- [x] CHK-001 [P0] Requirements documented in `spec.md`. [Evidence: `.opencode/specs/03--commands-and-skills/010-doc-rename/spec.md:1`]
- [x] CHK-002 [P0] Technical approach and checks (`PC-001` to `PC-006`) defined in `plan.md`. [Evidence: `.opencode/specs/03--commands-and-skills/010-doc-rename/plan.md:1`]
- [x] CHK-003 [P1] Dependencies and external conditional scope identified. [Evidence: `.opencode/specs/03--commands-and-skills/010-doc-rename/plan.md:127`]
<!-- /ANCHOR:pre-impl -->
...
- [x] CHK-031 [P0] External update scope constrained to one allowed file path only. [Evidence: `.opencode/specs/03--commands-and-skills/010-doc-rename/spec.md:67`, external check command path points only to `.../Barter/coder/AGENTS.md`]
...
- [x] CHK-040 [P1] `spec.md`, `plan.md`, and `tasks.md` synchronized on completed scope and checks. [Evidence: `.opencode/specs/03--commands-and-skills/010-doc-rename/spec.md:1`, `.opencode/specs/03--commands-and-skills/010-doc-rename/plan.md:1`, `.opencode/specs/03--commands-and-skills/010-doc-rename/tasks.md:1`]
- [x] CHK-041 [P1] `implementation-summary.md` updated to executed implementation narrative and verification outcomes. [Evidence: `.opencode/specs/03--commands-and-skills/010-doc-rename/implementation-summary.md:1`]
...
- [x] CHK-050 [P1] Temporary artifacts are contained under spec-local `scratch/`. [Evidence: `.opencode/specs/03--commands-and-skills/010-doc-rename/scratch` listing]

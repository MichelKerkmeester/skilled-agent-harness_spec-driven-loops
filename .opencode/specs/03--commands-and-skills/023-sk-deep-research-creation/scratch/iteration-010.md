...
**Reusability**: Simple but effective for user-initiated pause. Our system could adopt a similar `scratch/.deep-research-pause` sentinel for manual intervention during long-running research sessions.

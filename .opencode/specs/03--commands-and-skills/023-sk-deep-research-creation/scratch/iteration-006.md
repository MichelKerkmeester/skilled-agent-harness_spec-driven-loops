...
```
{spec_folder}/
  research.md                          # Progressive synthesis (additive only)
  scratch/
...
In optimization, failed experiments are reverted (`git reset`). In research, negative findings are valuable ("X does not exist", "Y contradicts Z"). There is no "discard" in research -- every iteration's findings persist. This is why our write-once iteration files and progressive research.md are architecturally correct.
...
4. **Progressive synthesis** -- research.md has no optimization equivalent.
...
- /Users/michelkerkmeester/MEGA/Development/Opencode Env/Public/.opencode/specs/03--commands-and-skills/023-sk-deep-research-creation/scratch/iteration-001.md (prior AGR findings)
- /Users/michelkerkmeester/MEGA/Development/Opencode Env/Public/.opencode/specs/03--commands-and-skills/023-sk-deep-research-creation/scratch/iteration-002.md (prior pi-autoresearch findings)
- /Users/michelkerkmeester/MEGA/Development/Opencode Env/Public/.opencode/specs/03--commands-and-skills/023-sk-deep-research-creation/scratch/iteration-003.md (prior autoresearch-opencode findings)

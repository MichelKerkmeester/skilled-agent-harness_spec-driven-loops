...
- [x] T-011: Create assets/deep_research_strategy.md
- [x] T-012: Create references/loop_protocol.md
- [x] T-013: Create references/state_format.md
...
- [ ] T-100: **JSONL Fault Tolerance** (REQ-010, Effort: S)
  ...
  - Files: `references/state_format.md`, `references/convergence.md`
...
- [ ] T-103: **Iteration Reflection Section** (REQ-013, Effort: S)
  ...
  - Files: `.claude/agents/deep-research.md` (iteration output format)
...
- [ ] T-104: **Tiered Error Recovery Protocol** (REQ-014, Effort: S)
  ...
  - Files: `references/convergence.md`, `.claude/agents/deep-research.md`
...
- [ ] T-112: **Compact State Summary Injection** (REQ-018, Effort: S)
  ...
  - Files: `references/loop_protocol.md`, YAML workflows (dispatch step)
...
- [ ] T-114: **Segment-Based State Partitioning** (REQ-020, Effort: S)
  ...
  - Files: `references/state_format.md`, `references/convergence.md`, `assets/`
...
- [ ] T-115: **Scored Branching with Pruning** (REQ-021, Effort: L)
  ...
  - Files: `references/loop_protocol.md`, YAML workflows, SKILL.md
...
- [ ] T-122: **Git Commit Per Iteration** (REQ-024, Effort: S)
  ...
  - Files: `references/loop_protocol.md`, YAML workflows
...
- [ ] T-130: **File Mutability Declarations** (REQ-025, Effort: S)
  ...
  - Files: `assets/deep_research_config.json`, `references/state_format.md`
...
- [ ] T-131: **True Context Isolation via `claude -p`** (REQ-026, Effort: L)
  ...
  - Files: `references/loop_protocol.md`, YAML workflows (major restructure)
...
- [ ] T-132: **Research Simplicity Criterion** (REQ-027, Effort: S)
  ...
  - Files: `.claude/agents/deep-research.md` (assessment section)

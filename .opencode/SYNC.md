...
| `package.json`, `package-lock.json`, `bun.lock` | relative symlinks | `../.skilled/` | Continuous integration installs against this prefix |
| `vitest.config.bin.ts` | relative symlink | `../.skilled/vitest.config.bin.ts` | Test configuration addressed by this name |

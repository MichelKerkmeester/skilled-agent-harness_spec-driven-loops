...
- `/spec_kit:complete`: Full 14+ step workflow from research to completion, with the shared intake contract in `.opencode/skill/system-spec-kit/references/intake-contract.md` when the packet needs intake repair

...
Surfaces walked:
- .opencode/skill/<name>/SKILL.md            (YAML frontmatter)
- .opencode/command/**/<name>.md             (YAML frontmatter)
- .opencode/agent/<name>.md                  (YAML frontmatter)
...
Reference: .opencode/skill/sk-doc/assets/documentation/frontmatter_templates.md

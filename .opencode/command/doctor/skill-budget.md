...
Reference: see `.opencode/skill/sk-doc/assets/documentation/frontmatter_templates.md` § "Description Budget & Trim Style" for the trim style guide. The audit script reuses constants from `.opencode/skill/sk-doc/scripts/quick_validate.py`.
...
| ------- | --------- | ------------------ |
| Skills | `.opencode/skill/<name>/SKILL.md` | YAML |
| Commands | `.opencode/command/**/*.md` (excl. `assets/` and `scripts/`) | YAML |
| Agents | `.opencode/agent/*.md`, `.claude/agents/*.md`, `.gemini/agents/*.md` | YAML |
...
- **AUTONOMOUS**: `.opencode/command/doctor/assets/doctor_skill-budget_auto.yaml`
- **INTERACTIVE**: `.opencode/command/doctor/assets/doctor_skill-budget_confirm.yaml`

...
- Read the skill definition:
  ```
  Read(".opencode/skill/sk-prompt/SKILL.md")
  ```
...
- If skill not found: `STATUS=FAIL ERROR="sk-prompt skill not found at .opencode/skill/sk-prompt/SKILL.md"`
...
- **Skill dependency**: Requires `sk-prompt` at `.opencode/skill/sk-prompt/`

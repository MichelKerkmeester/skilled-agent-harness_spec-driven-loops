...
| `system-spec-memory`     | `memory_*`              | Context preservation        |
...
| **MCP - Keep**        | Yes    | system-spec-memory       | Required for spec-kit skill |
...
| **MCP - Keep**      | Yes    | system-spec-memory     | Context preservation             |
...
| ----------------- | ------ | --------------------------------------------------------------------------------------------------------------------------- |
| **Skills**        | 13     | mcp-chrome-devtools, mcp-code-mode, system-spec-kit, cli-opencode, cli-claude-code, sk-code, deep-research, sk-doc, sk-git, sk-prompt |
| **MCP Servers**   | 3      | sequential-thinking, system-spec-memory, code-mode                                                                             |

// ╔══════════════════════════════════════════════════════════════════════════╗
// ║ COMPONENT: mcp-route-guard OpenCode Plugin (adapter)                  ║
// ╠══════════════════════════════════════════════════════════════════════════╣
...
const WARN_LOG_NAME = 'mcp-route-guard.log';
...
function appendGuardLog(projectDir, detail) {
  try {
    ...
    appendFileSync(logPath, `${new Date().toISOString()} [mcp-route-guard] ${detail}\n`, 'utf8');
  } catch (_) {

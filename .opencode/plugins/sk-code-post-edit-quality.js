// ╔══════════════════════════════════════════════════════════════════════════╗
// ║ COMPONENT: sk-code-post-edit-quality OpenCode Plugin (adapter)                ║
// ╠══════════════════════════════════════════════════════════════════════════╣
...
// Same mutating-tool set system-dist-freshness-guard.js watches, reused here
...
function appendQualityLog(projectDir, line) {
  try {
    ...
    appendFileSync(logPath, `${new Date().toISOString()} [sk-code-post-edit-quality] ${line}\n`, 'utf8');
  } catch (_) {
...
/**
 * Create the sk-code-post-edit-quality OpenCode plugin hooks.
 *

...
5. **Skills Integration**: What skills should this agent invoke?
   (e.g., "sk-code for code standards", "system-spec-kit for documentation")
...
- [Template](../skill/sk-doc/assets/agent_template.md)
```
...
| sk-code     | `../skill/sk-code/`      | Code quality standards  |

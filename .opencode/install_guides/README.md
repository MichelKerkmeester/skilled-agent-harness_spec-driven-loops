...
Full reference: `.opencode/commands/doctor/speckit.md` + `.opencode/commands/doctor/_routes.yaml`. Canonical 7 subsystem targets: memory, causal-graph, code-graph, deep-loop, cocoindex, skill-advisor, skill-budget.

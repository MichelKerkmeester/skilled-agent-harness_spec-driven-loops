...
# /design:diagram Router

This command is a thin router. It separates execution routing from user-facing presentation.

## 1. ROUTER CONTRACT

Route /design:diagram to its presentation contract and workflow YAML for producing an HTML/SVG technical diagram, an ASCII/markdown flowchart, or a redraw of an existing draw.io/Mermaid source at a chosen format, size, detail level, and audience.

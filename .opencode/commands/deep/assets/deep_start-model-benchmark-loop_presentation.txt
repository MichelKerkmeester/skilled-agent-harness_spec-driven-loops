# Deep Start Model Benchmark Loop Presentation Contract

Presentation source of truth for `/deep:start-model-benchmark-loop`. The command router owns only mode selection, setup binding, and asset loading. Workflow YAML owns execution. This file owns visible prompts, dashboard/checkpoint layout, final result displays, examples, and next-step wording.
...
### Promotion (benchmark-report based, optional)

# Deep Start Research Loop Presentation Contract

Presentation source of truth for `/deep:start-research-loop`. The command router owns only mode selection, setup binding, and asset loading. Workflow YAML owns execution. This file owns visible prompts, dashboard/checkpoint layout, final result displays, examples, and next-step wording.
...
### Memory Integration Before Starting
...
### Memory Integration After Completing
...
### Key Differences (vs. single-pass research)

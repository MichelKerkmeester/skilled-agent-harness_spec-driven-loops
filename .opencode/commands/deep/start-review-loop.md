...
| Purpose | Asset |
|---------|-------|
| Presentation source of truth | `.opencode/commands/deep/assets/deep_start-review-loop_presentation.md` |
| Auto workflow | `.opencode/commands/deep/assets/deep_start-review-loop_auto.yaml` |
| Confirm workflow | `.opencode/commands/deep/assets/deep_start-review-loop_confirm.yaml` |
...
The following content lives only in `.opencode/commands/deep/assets/deep_start-review-loop_presentation.md`:

...
| Purpose | Asset |
|---------|-------|
| Presentation source of truth | `.opencode/commands/deep/assets/deep_start-model-benchmark-loop_presentation.md` |
| Auto workflow | `.opencode/commands/deep/assets/deep_start-model-benchmark-loop_auto.yaml` |
| Confirm workflow | `.opencode/commands/deep/assets/deep_start-model-benchmark-loop_confirm.yaml` |
...
6. For `:confirm`, use the presentation contract's consolidated setup prompt to bind missing setup values, then load `.opencode/commands/deep/assets/deep_start-model-benchmark-loop_confirm.yaml`.
...
The following content lives only in `.opencode/commands/deep/assets/deep_start-model-benchmark-loop_presentation.md`:
...
Use `/deep:start-agent-improvement-loop` to improve an agent definition. Related follow-on routes are `/speckit:complete` for full spec-driven development, `/prompt` for prompt improvement, and `/deep:start-review-loop` for iterative code review.

...
| Purpose | Asset |
|---------|-------|
| Presentation source of truth | `.opencode/commands/speckit/assets/speckit_plan_presentation.md` |
...
The following content lives only in `.opencode/commands/speckit/assets/speckit_plan_presentation.md`:

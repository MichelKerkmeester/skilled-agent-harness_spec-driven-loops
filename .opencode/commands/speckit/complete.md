...
allowed-tools: Read, Write, Edit, Bash, Grep, Glob, Task, mcp__mk_spec_memory__memory_search, mcp__mk_spec_memory__memory_save, mcp__mk_spec_memory__task_preflight, mcp__mk_spec_memory__task_postflight, mk_goal, mk_goal_status
---

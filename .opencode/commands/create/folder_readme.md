...
**Reference READMEs:**
- `.opencode/skills/system-spec-kit/README.md` (SpecKit + Memory pattern)
...
**Skill README:**
```
/create:folder_readme .opencode/skills/my-skill --type skill
```
...
```
/create:folder_readme .opencode/skills/my-skill --type skill :confirm
```

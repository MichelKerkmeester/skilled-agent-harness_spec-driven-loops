...
allowed-tools: Read, Bash, Grep, Glob, mcp__cocoindex_code__search, mcp__system_code_graph__code_graph_status, mcp__system_code_graph__code_graph_query, mcp__system_code_graph__code_graph_context, mcp__system_code_graph__code_graph_scan, mcp__system_code_graph__code_graph_apply, mcp__system_code_graph__detect_changes, mcp__spec_kit_memory__memory_context, mcp__spec_kit_memory__memory_search, mcp__spec_kit_memory__memory_health, mcp__spec_kit_memory__memory_index_scan, mcp__spec_kit_memory__memory_drift_why, mcp__spec_kit_memory__memory_stats, mcp__spec_kit_memory__memory_causal_stats, mcp__spec_kit_memory__memory_causal_link, mcp__spec_kit_memory__deep_loop_graph_status, mcp__spec_kit_memory__deep_loop_graph_query, mcp__spec_kit_memory__deep_loop_graph_upsert, mcp__spec_kit_memory__deep_loop_graph_convergence, mcp__system_code_graph__ccc_status, mcp__system_code_graph__ccc_reindex, mcp__system_code_graph__ccc_feedback, mcp__spec_kit_memory__advisor_recommend, mcp__spec_kit_memory__advisor_status, mcp__spec_kit_memory__advisor_validate, mcp__spec_kit_memory__advisor_rebuild, mcp__system_skill_advisor__skill_graph_scan, mcp__system_skill_advisor__skill_graph_query, mcp__system_skill_advisor__skill_graph_status, mcp__spec_kit_memory__eval_run_ablation, mcp__spec_kit_memory__session_health
---
<!-- skill_agent: system-spec-kit -->

> **Code Graph ownership:** The code-graph tier now uses `.opencode/skills/system-code-graph/database/code-graph.sqlite` by default, with `SPECKIT_CODE_GRAPH_DB_DIR` as the DB-dir override.
...
| skill-graph   | `system_skill_advisor` skill graph DB                               | `system_skill_advisor.skill_graph_status` | `system_skill_advisor.skill_graph_scan` | skill count/freshness + query          |
...
| --------- | ------------------------------------------- | ------------------------------------------ | ------------------------ | -------------------------------------------------- |
| Short     | `system_skill_advisor.skill_graph_scan`, deep-loop lazy init | none (auto-acknowledged via log line only) | n/a                      | Fast idempotent initialization                     |
...
| `.opencode/skills/system-spec-kit/mcp_server/database/deep-loop-graph.sqlite` and `.opencode/skills/system-spec-kit/mcp_server/database/deep-loop-graph.sqlite.pre-doctor-update.*.bak`                                 | deep research/review graph DB          |

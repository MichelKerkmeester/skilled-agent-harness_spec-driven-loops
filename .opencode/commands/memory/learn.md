...
IF $ARGUMENTS starts with "edit" and has NO <filename>:
    → STOP IMMEDIATELY
    → Run Glob(".opencode/skills/system-spec-kit/constitutional/*.md")
...
```text
1. Glob(".opencode/skills/system-spec-kit/constitutional/*.md")
   → Exclude README.md
...
```text
1. WRITE file:
   Write(".opencode/skills/system-spec-kit/constitutional/<filename>.md")

2. INDEX in indexed-continuity database:
   memory_save({
     filePath: ".opencode/skills/system-spec-kit/constitutional/<filename>.md",
     force: true
   })
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  Location    .opencode/skills/system-spec-kit/constitutional/
...
```text
Glob(".opencode/skills/system-spec-kit/constitutional/*.md")
→ Exclude README.md
...
```text
memory_save({
  filePath: ".opencode/skills/system-spec-kit/constitutional/<filename>",
  force: true
})
```
...
| Step | Tool | Purpose |
|------|------|---------|
| Discover files | `Glob(".opencode/skills/system-spec-kit/constitutional/*.md")` | Find constitutional files |

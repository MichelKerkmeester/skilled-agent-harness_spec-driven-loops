...
| **Open Design dispatch** | UI or design work through `mcp-open-design` MUST co-load `sk-design-interface` first (the transport never decides taste). Pure transport is exempt. `mcp-figma` is the sibling Figma transport. |
...
| **UI / design work**              | `sk-design-interface` (design judgment, required) → `mcp-open-design` or `mcp-figma` (transport) → hand the build to `sk-code`                                                              |                                                                                                                                                                          |

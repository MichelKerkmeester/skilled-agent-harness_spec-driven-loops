...
| Purpose | Asset |
|---------|-------|
| Presentation source of truth | `.skilled/commands/create/assets/create-with-human-voice-presentation.txt` |
| Auto workflow | `.skilled/commands/create/assets/create-with-human-voice-auto.yaml` |
| Confirm workflow | `.skilled/commands/create/assets/create-with-human-voice-confirm.yaml` |
| Mode contract | `.skilled/skills/sk-doc/sk-create-with-human-voice/SKILL.md` |
| Standard | `.skilled/skills/sk-doc/sk-create-with-human-voice/references/hvr-rules.md` |
...
| Mode | Target |
|------|----------|
| `:auto` | `.skilled/commands/create/assets/create-with-human-voice-auto.yaml` |
| `:confirm` or interactive choice | `.skilled/commands/create/assets/create-with-human-voice-confirm.yaml` |

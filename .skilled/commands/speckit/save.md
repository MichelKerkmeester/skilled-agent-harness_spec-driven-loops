...
- Explicit apply/full-auto runs `node .skilled/skills/system-spec-kit/runtime/cli/dist/continuity/generate-context.js` with AI-authored JSON. That script is the whole write.

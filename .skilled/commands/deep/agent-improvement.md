...
| Purpose | Asset |
|---------|-------|
| Presentation source of truth | `.skilled/commands/deep/assets/deep-agent-improvement-presentation.txt` |
| Auto workflow | `.skilled/commands/deep/assets/deep-agent-improvement-auto.yaml` |
| Confirm workflow | `.skilled/commands/deep/assets/deep-agent-improvement-confirm.yaml` |
...
4. If `lane=model-benchmark` is resolved by explicit lane, marker lane, `--profile`, benchmark-profile input, or Q(lane), hand off to `/deep:model-benchmark` and load `.skilled/commands/deep/assets/deep_model-benchmark_{auto,confirm}.yaml`; do not ask the Lane A Q0/Q1/Q3 questions.
...
8. For `:confirm`, use the presentation contract's consolidated setup prompt to bind missing setup values, then load `.skilled/commands/deep/assets/deep-agent-improvement-confirm.yaml`.
...
| Mode | Target |
|------|----------|
| `:auto` | `.skilled/commands/deep/assets/deep-agent-improvement-auto.yaml` |
| `:confirm` or interactive choice | `.skilled/commands/deep/assets/deep-agent-improvement-confirm.yaml` |
...
The following content lives only in `.skilled/commands/deep/assets/deep-agent-improvement-presentation.txt`:

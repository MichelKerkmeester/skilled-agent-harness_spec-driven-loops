...
| `../recovery-and-edge-cases/merge-conflict-resolution.md` | Canonical per-feature execution contract |
...
- Feature file path: `recovery-and-edge-cases/merge-conflict-resolution.md`

...
| `../cross-cli-orchestration/native-claude-code-invocation.md` | Canonical per-feature execution contract |
...
- Feature file path: `cross-cli-orchestration/native-claude-code-invocation.md`

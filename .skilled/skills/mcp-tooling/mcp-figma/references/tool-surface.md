...
- [figma-cli-reference.md](figma-cli-reference.md) - the binary identity, connect modes, daemon model, and command examples.
- [mcp-wiring.md](mcp-wiring.md) - the optional Framelink Figma MCP via Code Mode (a separate, opt-in surface, not part of this CLI gating).
...
- [figma-cli-reference.md](figma-cli-reference.md) - binary identity, connect modes, daemon model, command examples.
- [mcp-wiring.md](mcp-wiring.md) - the optional Framelink Figma MCP via Code Mode (separate, opt-in surface).

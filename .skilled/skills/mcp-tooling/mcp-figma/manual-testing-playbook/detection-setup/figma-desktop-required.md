...
| `../../feature-catalog/connect-and-daemon/connect-and-daemon.md` | Feature-catalog source describing the connection prerequisite |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `../../references/mcp-wiring.md` | Desktop-open requirement and the daemon model |

...
1. `sed -n '1,15p' .skilled/skills/mcp-tooling/mcp-figma/manual-testing-playbook/intra-routing-recall/design-tokens.md`
2. `sed -n '/^INTENT_MODEL = {/,/^}/p' .skilled/skills/mcp-tooling/mcp-figma/SKILL.md | sed -n '/"DESIGN_SYSTEM_TOKENS":/p'`

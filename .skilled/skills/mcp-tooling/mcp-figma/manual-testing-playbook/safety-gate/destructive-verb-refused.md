...
| `../../feature-catalog/tokens-and-variables/tokens-and-variables.md` | Feature-catalog source for the destructive token deletes |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `../../references/tool-surface.md` | DESTRUCTIVE gating taxonomy and the confirm + target + rollback rule |
| `../../references/figma-cli-reference.md` | The destructive verb surface |

...
- Prompt: `Start bdg with an invalid URL and confirm the URL parse error is clear.`
...
| File | Role |
|---|---|
| `.skilled/skills/mcp-tooling/mcp-chrome-devtools/SKILL.md` | bdg URL parsing + error path |
...
- Feature file path: `recovery-and-failure/invalid-url.md`

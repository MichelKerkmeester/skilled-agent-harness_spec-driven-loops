...
- Prompt: `Try starting bdg with a missing Chrome binary and confirm the error names the missing path.`
...
| File | Role |
|---|---|
| `.skilled/skills/mcp-tooling/mcp-chrome-devtools/SKILL.md` | bdg browser discovery + error path |
...
- Feature file path: `recovery-and-failure/missing-browser.md`

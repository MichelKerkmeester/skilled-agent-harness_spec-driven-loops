...
- Prompt: `Run JavaScript on https://example.com and confirm the title is Example Domain.`
...
| File | Role |
|---|---|
| `.skilled/skills/mcp-tooling/mcp-chrome-devtools/SKILL.md` | bdg dom eval reference |

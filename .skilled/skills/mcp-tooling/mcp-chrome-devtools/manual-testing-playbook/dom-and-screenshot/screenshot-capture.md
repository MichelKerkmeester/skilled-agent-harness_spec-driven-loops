...
- Prompt: `Capture a screenshot of https://example.com and confirm the saved file is a valid PNG.`
...
| File | Role |
|---|---|
| `.skilled/skills/mcp-tooling/mcp-chrome-devtools/SKILL.md` | bdg dom screenshot reference |

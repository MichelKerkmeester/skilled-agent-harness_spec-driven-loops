...
- Prompt: `Show console messages from the active page and confirm the output is a JSON messages array.`
...
| File | Role |
|---|---|
| `.skilled/skills/mcp-tooling/mcp-chrome-devtools/SKILL.md` | bdg console --list reference |
...
- Feature file path: `console-and-network/console-list.md`

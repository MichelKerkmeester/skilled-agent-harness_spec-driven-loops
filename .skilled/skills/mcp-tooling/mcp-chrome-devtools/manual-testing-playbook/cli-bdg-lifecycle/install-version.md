...
- Prompt: `Confirm bdg is installed and report its path and version.`
...
| File | Role |
|---|---|
| `.skilled/skills/mcp-tooling/mcp-chrome-devtools/SKILL.md` | bdg CLI catalog + install reference |

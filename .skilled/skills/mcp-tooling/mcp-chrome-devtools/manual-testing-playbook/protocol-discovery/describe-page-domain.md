...
- Prompt: `Describe the Page CDP domain and confirm navigate and reload are listed.`
...
| File | Role |
|---|---|
| `.skilled/skills/mcp-tooling/mcp-chrome-devtools/SKILL.md` | bdg cdp --describe usage |
...
- Feature file path: `protocol-discovery/describe-page-domain.md`

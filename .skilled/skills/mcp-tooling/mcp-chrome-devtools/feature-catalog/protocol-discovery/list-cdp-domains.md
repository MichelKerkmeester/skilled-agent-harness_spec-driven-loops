...
| `references/cdp-patterns.md` §7 | Reference | Progressive-disclosure before/after pattern |
...
| File | Type | Role |
|------|------|------|
| `manual-testing-playbook/protocol-discovery/list-cdp-domains.md` | Manual | BDG-005 scenario contract |
...
- Feature file path: `protocol-discovery/list-cdp-domains.md`
Related references:
- [describe-domain.md](../protocol-discovery/describe-domain.md) — Describe Domain or Method

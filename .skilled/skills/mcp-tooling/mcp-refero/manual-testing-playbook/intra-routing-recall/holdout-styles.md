...
1. `sed -n '1,15p' .skilled/skills/mcp-tooling/mcp-refero/manual-testing-playbook/intra-routing-recall/holdout-styles.md`
2. `sed -n '/^INTENT_MODEL = {/,/^}/p' .skilled/skills/mcp-tooling/mcp-refero/SKILL.md | sed -n '/"STYLES":/p'`

...
| File | Role |
|---|---|
| `../../references/tool-surface.md` | The 1-20 bound and the only-tool-with-limit rule (Sections 1-2) |
| `../../manual-testing-playbook/read-only/styles-funnel.md` | The funnel-order discipline (similar only after one relevant hit) |
...
- Feature file path: `screens/get-similar-screens.md`

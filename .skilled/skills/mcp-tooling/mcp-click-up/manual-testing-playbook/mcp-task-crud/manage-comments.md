...
1. Code Mode: `clickup_official.clickup_official_clickup_manage_comments({task_id: 'TASK_ID', comment_text: 'MCP test comment MCP-H007'})`
2. Code Mode: `clickup_official.clickup_official_clickup_manage_comments({task_id: 'TASK_ID'})`  # GET — list comments
3. Verify 'MCP test comment MCP-H007' appears in list

| Feature ID | Feature Name | Scenario Objective | Exact Prompt | Exact Command Sequence | Expected Signals | Evidence | Pass/Fail Criteria | Failure Triage |
|---|---|---|---|---|---|---|---|---|
| MCP-H007 | Manage Comments via MCP | Verify `clickup_manage_comments` creates and lists comments | `Add comment 'MCP test comment' to TASK_ID then list all comments.` | 1. Code Mode: `clickup_official.clickup_official_clickup_manage_comments({task_id: 'TASK_ID', comment_text: 'MCP test comment MCP-H007'})` 2. Code Mode: `clickup_official.clickup_official_clickup_manage_comments({task_id: 'TASK_ID'})`  # GET — list comments 3. Verify 'MCP test comment MCP-H007' appears in list | Step 1: MCP creates comment; exit 0. Step 2: comment list includes the new comment; exit 0. | Code Mode response + terminal output of the verification step(s) above | PASS if new comment appears in the MCP comment list response; FAIL if comment missing from list OR MCP errors on either call | See [`../../references/troubleshooting.md`](../../references/troubleshooting.md) |
...
| [`../../feature-catalog/mcp-high-priority/manage-comments.md`](../../feature-catalog/mcp-high-priority/manage-comments.md) | Feature catalog source |
...
- Feature file path: `mcp-task-crud/manage-comments.md`

...
Related references:
- [task-context.md](../../feature-catalog/cupt-task-details/task-context.md) — Task Context
- [status-by-list.md](../../feature-catalog/cupt-task-details/status-by-list.md) — Status Schema by List

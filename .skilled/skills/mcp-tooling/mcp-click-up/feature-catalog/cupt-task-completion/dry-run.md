...
Related references:
- [mark-complete.md](../../feature-catalog/cupt-task-completion/mark-complete.md) — Mark Complete
- [complete-with-note.md](../../feature-catalog/cupt-task-completion/complete-with-note.md) — Complete with Note

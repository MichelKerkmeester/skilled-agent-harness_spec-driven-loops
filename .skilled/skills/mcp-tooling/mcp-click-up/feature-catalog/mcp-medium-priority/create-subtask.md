...
Related references:
- [update-bulk-tasks.md](../../feature-catalog/mcp-medium-priority/update-bulk-tasks.md) — clickup_update_bulk_tasks
- [task-dependencies.md](../../feature-catalog/mcp-medium-priority/task-dependencies.md) — clickup_manage_task_dependencies

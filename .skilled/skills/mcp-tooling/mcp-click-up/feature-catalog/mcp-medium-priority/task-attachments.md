...
Upload or list task attachments via MCP.
...
Related references:
- [multi-list.md](../../feature-catalog/mcp-medium-priority/multi-list.md) — clickup_add_task_to_multiple_lists
- [manage-lists.md](../../feature-catalog/mcp-medium-priority/manage-lists.md) — clickup_manage_lists

...
| File | Layer | Role |
|---|---|---|
| `.skilled/skills/system-skill-advisor/runtime/scripts/skill_advisor.py` | Script | Source reference |
| `.skilled/skills/system-skill-advisor/runtime/scripts/skill_advisor_runtime.py` | Script | Source reference |
...
| `.skilled/skills/system-skill-advisor/runtime/tests/python/` | Automated test | Python unit test |
...
- Feature file path: `python-compat/cli-shim.md`

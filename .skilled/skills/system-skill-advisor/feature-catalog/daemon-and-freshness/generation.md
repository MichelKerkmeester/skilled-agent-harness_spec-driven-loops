...
| File | Layer | Role |
|---|---|---|
| `.skilled/skills/system-skill-advisor/runtime/lib/freshness/generation.ts` | Library | Source reference |
| `.skilled/skills/system-skill-advisor/runtime/lib/generation.ts` | Library | Source reference |
...
| File | Type | Role |
|---|---|---|
| `.skilled/skills/system-skill-advisor/runtime/tests/daemon-freshness-foundation.vitest.ts` | Automated test | generation bump atomicity |

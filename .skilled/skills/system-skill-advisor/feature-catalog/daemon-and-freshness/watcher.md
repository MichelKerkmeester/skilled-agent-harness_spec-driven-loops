...
- Feature file path: `daemon-and-freshness/watcher.md`

Related references:

- [02-lease.md](./lease.md), single-writer lease.
- [03-lifecycle.md](./lifecycle.md), daemon lifecycle.
- [04-generation.md](./generation.md), generation bump publication.

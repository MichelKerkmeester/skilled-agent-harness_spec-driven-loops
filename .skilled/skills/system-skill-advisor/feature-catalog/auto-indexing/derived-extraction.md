...
| File | Layer | Role |
|---|---|---|
| `.skilled/skills/system-skill-advisor/runtime/lib/derived/extract.ts` | Library | Source reference |
...
| File | Type | Role |
|---|---|---|
| `.skilled/skills/system-skill-advisor/runtime/tests/lifecycle-derived-metadata.vitest.ts` | Automated test | derived-sync correctness |

---
title: "advisor_validate Command"
description: "Native command that returns release-gate slices plus explicit threshold semantics and prompt-safe telemetry/outcome rollups."
trigger_phrases:
  - "advisor_validate"
  - "mcp validate tool"
  - "release gate slices"
...
# advisor_validate Command

<!-- sk-doc-template: skill_asset_feature_catalog -->

## 1. OVERVIEW

Drive release-readiness decisions from real measurements. Consolidate corpus, holdout, parity, safety and latency slices behind one command call, while also exposing the threshold contract and prompt-safe telemetry summaries operators need to interpret the run.
...
- Feature file path: `cli-surface/advisor-validate.md`

...
function directiveLifecycleEnabled(): boolean { try { const { isHookEnabled } = __dlRequire(fileURLToPath(new URL('../../../../../../hooks/shared/hook-flags.cjs', import.meta.url))) as { isHookEnabled?: (c: string) => boolean }; return typeof isHookEnabled !== 'function' || isHookEnabled('directive-lifecycle') !== false; } catch { return true; } }

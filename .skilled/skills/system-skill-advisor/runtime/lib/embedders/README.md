...
Compiled output belongs under `runtime/dist/runtime/lib/embedders/`.
...
python3 .opencode/skills/sk-doc/scripts/validate_document.py .opencode/skills/system-skill-advisor/runtime/lib/embedders/README.md
```

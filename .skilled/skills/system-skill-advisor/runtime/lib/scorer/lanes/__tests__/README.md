...
description: "Code-facing README for .skilled/skills/system-skill-advisor/runtime/lib/scorer/lanes/__tests__."
trigger_phrases:
...
This README documents the code-bearing folder `.skilled/skills/system-skill-advisor/runtime/lib/scorer/lanes/__tests__` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .skilled/skills/system-skill-advisor/runtime/lib/scorer/lanes/__tests__
```
...
```text
User request: Check .skilled/skills/system-skill-advisor/runtime/lib/scorer/lanes/__tests__ for sk-code and README coverage.

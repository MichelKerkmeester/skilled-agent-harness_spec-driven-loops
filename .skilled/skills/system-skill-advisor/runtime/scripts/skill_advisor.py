...
function probe() {
  ...
  try {
    ...
    // Compat-shim eligibility: daemon-backed callers gate on daemon liveness via
...
def _run_native_bridge(payload: Dict[str, Any], timeout: float = NATIVE_TIMEOUT_SECONDS) -> Dict[str, Any]:
    """Call the compiled native advisor handlers through a tiny Node bridge."""
...
def recommend_with_native_advisor(
    ...
    """Return native recommendations when the compiled advisor runtime is available."""
...
GENERATED_COMMAND_BRIDGES = {
    ...
    "command-design-chart": {
        ...
        "inventory_id": "command-design-chart",
        "command": "/design:chart",
        "skill_id": "sk-design",
        "owner_mode": "sk-design-chart",
        "routing_enabled": False,
    },
    "command-design-diagram": {
        "description": "",
        "slash_markers": ["/design:diagram"],
        "inventory_id": "command-design-diagram",
        "command": "/design:diagram",
        "skill_id": "sk-design",
        "owner_mode": "sk-design-diagram",
        "routing_enabled": False,
    },
    "command-design-extract": {
        "description": "",
        "slash_markers": ["/design:extract"],
        "inventory_id": "command-design-extract",
        "command": "/design:extract",
        "skill_id": "sk-design",
...
COMMAND_BRIDGES = GENERATED_COMMAND_BRIDGES
COMMAND_BRIDGE_OWNER_NORMALIZATION = GENERATED_COMMAND_BRIDGE_OWNER_NORMALIZATION

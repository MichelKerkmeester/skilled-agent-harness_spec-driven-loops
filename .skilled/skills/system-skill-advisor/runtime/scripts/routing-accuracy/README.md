---
title: "system skill advisor runtime scripts routing accuracy: Code README"
description: "Code-facing README for .opencode/skills/system-skill-advisor/runtime/scripts/routing-accuracy."
trigger_phrases:
  - "system-skill-advisor runtime/scripts/routing-accuracy"
  - "code README"
---
...
This README documents the code-bearing folder `.opencode/skills/system-skill-advisor/runtime/scripts/routing-accuracy` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/system-skill-advisor/runtime/scripts/routing-accuracy
```
...
|---|---|
| Folder boundary | Documents direct code files under `runtime/scripts/routing-accuracy`. |
...
```text
User request: Check .opencode/skills/system-skill-advisor/runtime/scripts/routing-accuracy for sk-code and README coverage.

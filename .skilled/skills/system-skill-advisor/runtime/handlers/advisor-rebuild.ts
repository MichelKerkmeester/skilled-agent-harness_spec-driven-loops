 ...
 * function through the `advisor_rebuild` command when `advisor_status`
...
export function rebuildAdvisorIndex(
  ...
  const skillsRoot = resolve(workspaceRoot, '.skilled', 'skills');
...
/** Handle the advisor_rebuild command request.
 *

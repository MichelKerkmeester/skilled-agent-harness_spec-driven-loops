---
title: "Skill Advisor Handlers: Command Entrypoints"
description: "Handler modules for the advisor recommendation, status, rebuild and validation commands plus the skill-graph command handlers."
trigger_phrases:
...
# Skill Advisor Handlers: Command Entrypoints
...
| Exports | Export handler functions only. |
...
```bash
python3 .opencode/skills/sk-doc/scripts/validate_document.py .opencode/skills/system-skill-advisor/runtime/handlers/README.md
```

...
```bash
npm --prefix .skilled/skills/system-skill-advisor/runtime run test -- tests/legacy
python3 .skilled/skills/sk-doc/scripts/validate_document.py .skilled/skills/system-skill-advisor/runtime/tests/legacy/advisor-fixtures/README.md
```

...
description: "Vitest coverage for advisor handler response shapes, status reporting and validation contracts."
trigger_phrases:
...
> Vitest coverage for advisor handler response shapes, status reporting and validation contracts.

---

## 1. OVERVIEW

`tests/handlers/` verifies the skill advisor handlers and their typed response contracts.

---
title: "system skill advisor runtime stress test search quality: Code README"
description: "Code-facing README for .opencode/skills/system-skill-advisor/runtime/stress-test/search-quality."
trigger_phrases:
  - "system-skill-advisor runtime/stress-test/search-quality"
  - "code README"
---
...
This README documents the code-bearing folder `.opencode/skills/system-skill-advisor/runtime/stress-test/search-quality` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/system-skill-advisor/runtime/stress-test/search-quality
```
...
|---|---|
| Folder boundary | Documents direct code files under `runtime/stress-test/search-quality`. |
...
```text
User request: Check .opencode/skills/system-skill-advisor/runtime/stress-test/search-quality for sk-code and README coverage.

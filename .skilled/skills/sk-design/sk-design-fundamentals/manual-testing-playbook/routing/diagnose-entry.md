...
1. `bash: python3 .skilled/skills/system-skill-advisor/runtime/scripts/skill_advisor.py "this dashboard ui looks amateur and cluttered, make it look better" --threshold 0.5`
2. `agent: issue the same prompt in a fresh session and capture the reply`
3. `bash: rg -n "No hierarchy" .skilled/skills/sk-design/references/diagnosis-table.md`

...
1. `bash: python3 .skilled/skills/system-skill-advisor/runtime/scripts/skill_advisor.py "extract the design system from stripe.com" --threshold 0.5`
2. `agent: issue the same prompt in a fresh session`
3. `bash: rg -n "belongs to the sibling skill" .skilled/skills/sk-design/sk-design-md-generator/SKILL.md`

...
description: "This scenario validates the /design:diagram command router for `CMD-001`. It focuses on mode resolution, workflow YAML binding, and the presentation boundary between the router and the presentation contract."
version: 1.0.0.4
---
...
- Real user request: `/design:diagram docs/order-flow.html "sequence diagram of our order placement flow" :auto — sequence diagram of the order flow, no questions.`
...
1. `agent: Read .skilled/commands/create/diagram.md (the router contract)`
2. `agent: Read .skilled/commands/create/assets/create-diagram-presentation.txt and the bound workflow .skilled/commands/create/assets/create-diagram-auto.yaml (for :auto)`
...
| `../../feature-catalog/command-and-hub-integration/design-diagram-command.md` | Feature-catalog source describing the implementation contract (authored next) |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `.skilled/commands/create/diagram.md` | Router contract and mode routing |
| `.skilled/commands/create/assets/create-diagram-presentation.txt` | Presentation boundary |
| `.skilled/commands/create/assets/create-diagram-auto.yaml` | Autonomous workflow |
| `.skilled/commands/create/assets/create-diagram-confirm.yaml` | Checkpointed workflow |
...
- Feature file path: `command-and-hub-integration/design-diagram-command.md`

...
- Expected execution process: the agent loads `references/foundations/style-guide.md` (always) and `references/types/type-swimlane.md`, copies `assets/diagrams/starter-light.html`, authorizes the lanes, handoffs, and connectors, and then runs the taste gate, including a mechanical scan for forbidden patterns.
...
2. `agent: Copy assets/diagrams/starter-light.html to docs/support-handoff.html`

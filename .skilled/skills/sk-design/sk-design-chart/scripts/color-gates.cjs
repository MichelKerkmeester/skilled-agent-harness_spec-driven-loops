#!/usr/bin/env node
/**
 * Shared colour arithmetic for the chart corpus and the design-reference applicator.
 *
 * Keeping the transfer curve and ratio calculation in one module matters here: a themed
 * delivery must clear the same gates that the corpus uses to judge the stock palette.
 */

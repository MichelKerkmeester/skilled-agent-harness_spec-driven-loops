...
```bash
npx ts-node .skilled/skills/sk-design-md-generator/backend/scripts/extract.ts https://stripe.com --fast --output specs/<track>/<packet>/output
...
```bash
npx ts-node .skilled/skills/sk-design-md-generator/backend/scripts/validate.ts DESIGN.md specs/<track>/<packet>/output/tokens.json
```
...
```
npx ts-node .skilled/skills/sk-design-md-generator/backend/scripts/extract.ts <url> [options] --output specs/<track>/<packet>/output
...
```bash
npx ts-node .skilled/skills/sk-design-md-generator/backend/scripts/validate.ts <DESIGN.md> <tokens.json>      # Phase 3: validate
npx ts-node .skilled/skills/sk-design-md-generator/backend/scripts/proof.ts <url> <tokens.json>                # Fidelity proof
npx ts-node .skilled/skills/sk-design-md-generator/backend/scripts/report-gen.ts <tokens.json> <dir> <DESIGN.md>  # HTML report
npx ts-node .skilled/skills/sk-design-md-generator/backend/scripts/preview-gen.ts <tokens.json> <dir>          # Visual preview
```
...
| README structure | `python3 .skilled/skills/sk-doc/scripts/validate_document.py .skilled/skills/sk-design-md-generator/README.md --type readme` reports zero issues |

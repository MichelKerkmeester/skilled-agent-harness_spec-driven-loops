...
1. NEGATIVE CONTROL: `npx ts-node .skilled/skills/sk-design-md-generator/backend/scripts/extract.ts https://www.cloudflare.com --fast --output .opencode/specs/<track>/<packet>/output`  # -> exits non-zero or reports zero pages crawled; stderr/stdout contains 403/429/blocked errors

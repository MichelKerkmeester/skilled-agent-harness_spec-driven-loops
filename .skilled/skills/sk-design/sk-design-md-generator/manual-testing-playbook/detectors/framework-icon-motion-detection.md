...
3. `npx ts-node .skilled/skills/sk-design-md-generator/backend/scripts/extract.ts <url> --fast --output .opencode/specs/<track>/<packet>/output`  # -> exits 0, crawl progress on stdout
...
- Feature file path: `detectors/framework-icon-motion-detection.md`

 ...
 *   npx ts-node .skilled/skills/sk-design-md-generator/backend/scripts/extract.ts <url> --output <spec-folder>/output [options]
 *   npx ts-node .skilled/skills/sk-design-md-generator/backend/scripts/extract.ts https://stripe.com --max-pages 10 --output .opencode/specs/<track>/<packet>/output
 *   npx ts-node .skilled/skills/sk-design-md-generator/backend/scripts/extract.ts https://example.com --output .opencode/specs/<track>/<packet>/output --wait-for css
 */

...
```bash
node .skilled/skills/sk-design-md-generator/styles/lib/engine/style-library.mjs build --check
node .skilled/skills/sk-design-md-generator/styles/lib/engine/style-library.mjs query --request '{"text":"product interface restrained motion","useFts":false,"limit":2}'
```

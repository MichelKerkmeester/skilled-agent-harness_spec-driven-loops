...
```bash
node .skilled/skills/sk-design-md-generator/styles/lib/database/operator.mjs status --database /path/style.sqlite
node .skilled/skills/sk-design-md-generator/styles/lib/database/operator.mjs build --corpus /path/styles --database /path/style.sqlite
node .skilled/skills/sk-design-md-generator/styles/lib/database/operator.mjs cutover --database /path/style.sqlite --generation /path/retained.sqlite
node .skilled/skills/sk-design-md-generator/styles/lib/database/operator.mjs rollback --database /path/style.sqlite
node .skilled/skills/sk-design-md-generator/styles/lib/database/operator.mjs repair --database /path/style.sqlite --profile style-default-v1
```

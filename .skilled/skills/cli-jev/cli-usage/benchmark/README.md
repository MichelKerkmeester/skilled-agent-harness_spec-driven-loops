---
title: "cli-usage Benchmark Artifacts"
description: "Benchmark tree for cli-usage holding playbook-derived validation reports, indexed by run label, newest first."
trigger_phrases:
  - "cli-usage benchmark"
  - "cli-usage validation report"
  - "cli-usage manual testing playbook benchmark"
importance_tier: "normal"
contextType: "general"
version: 1.0.0.0
---

# cli-usage Benchmark Artifacts

> Curated, derived-after-the-fact reports for `cli-usage` manual-testing-playbook validation runs,
...
The baseline for this packet is its first run. `cli-usage` ships no prior report, so the first run's

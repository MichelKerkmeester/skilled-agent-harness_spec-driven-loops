...
| Executor | the orchestrator session for `001-cli-jev-creation` phase 001 probes and phase 004 |
...
- `specs/cli-jev/001-cli-jev-creation/001-jev-contract-research-and-pin/scratch/probe-matrix.txt`
- `specs/cli-jev/001-cli-jev-creation/001-jev-contract-research-and-pin/scratch/probe-surface.txt`
- `specs/cli-jev/001-cli-jev-creation/001-jev-contract-research-and-pin/scratch/mcp-probe.py`

---
title: "cli-usage Benchmark Reports"
description: "Index of curated benchmark run reports for cli-usage, one row per run folder."
trigger_phrases:
  - "cli-usage benchmark reports"
  - "cli-usage benchmark index"
...
Each row below is one run folder. This run family validates the `cli-usage` manual-testing playbook,

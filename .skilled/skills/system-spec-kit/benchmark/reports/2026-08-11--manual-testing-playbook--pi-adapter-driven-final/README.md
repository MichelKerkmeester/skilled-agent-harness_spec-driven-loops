# 2026-08-11--manual-testing-playbook--pi-adapter-driven-final

> system-spec-kit · doc · vitest · pi-adapter-driven-final
...
| Trace mode | doc |
| Executor | vitest |
| Model | not recorded (pi-adapter-driven-final) |
| Scenarios | 1 |

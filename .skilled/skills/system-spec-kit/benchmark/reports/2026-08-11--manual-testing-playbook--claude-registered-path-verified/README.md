# 2026-08-11--manual-testing-playbook--claude-registered-path-verified

> system-spec-kit · doc · node · claude-registered-path-verified
...
| Trace mode | doc |
| Executor | node |
| Model | not recorded (claude-registered-path-verified) |
| Scenarios | 1 |

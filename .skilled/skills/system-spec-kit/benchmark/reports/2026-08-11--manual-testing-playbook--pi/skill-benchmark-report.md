...
| Executor / model | pi / opencode-go/deepseek-v4-flash (pi) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| ux-hooks-directive-lifecycle-dedup | manual | documentation | — | PASS: Pi dispatch suite 54/54 incl. directive dedup lane 10/10 (first-full, repeat-suppressed, resume/compact re-arm, dirty-content, unknown-session fail-open, fallback, kill-switch, session isolation) |

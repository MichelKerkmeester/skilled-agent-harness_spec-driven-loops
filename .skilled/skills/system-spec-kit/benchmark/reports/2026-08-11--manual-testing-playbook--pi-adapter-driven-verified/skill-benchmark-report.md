...
| Executor / model | vitest / — (pi-adapter-driven-verified) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| ux-hooks-directive-lifecycle-dedup | manual | adapter-driven | — | PASS: Pi adapter-driven suite passed first-full, repeat route-only, lifecycle re-arm, fail-open, kill-switch, and session isolation behavior. |

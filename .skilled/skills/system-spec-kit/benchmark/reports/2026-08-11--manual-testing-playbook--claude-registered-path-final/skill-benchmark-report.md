...
| Executor / model | node / — (claude-registered-path-final) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| ux-hooks-directive-lifecycle-dedup | manual | registered-path | — | PASS: Registered Claude path passed native payload/envelope cadence, failure handling, lifecycle bridge, and durable provenance gates. |

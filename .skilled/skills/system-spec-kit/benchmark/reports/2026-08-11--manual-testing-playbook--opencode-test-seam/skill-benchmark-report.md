...
| Executor / model | vitest / — (opencode-test-seam) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| ux-hooks-directive-lifecycle-dedup | manual | test-seam | — | PASS: OpenCode plugin transform seam passed lifecycle, ambiguous-identity, global-invalidation, kill-switch, and isolation tests. |

...
| Executor / model | node / — (codex-registered-path-verified) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| ux-hooks-directive-lifecycle-dedup | manual | registered-path | — | PASS: Registered Codex path passed native payload/envelope cadence, failure handling, lifecycle bridge, and durable provenance gates. |

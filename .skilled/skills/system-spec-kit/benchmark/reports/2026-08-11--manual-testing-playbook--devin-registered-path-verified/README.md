# 2026-08-11--manual-testing-playbook--devin-registered-path-verified

> system-spec-kit · doc · node · devin-registered-path-verified
...
| Trace mode | doc |
| Executor | node |
| Model | not recorded (devin-registered-path-verified) |
| Scenarios | 1 |

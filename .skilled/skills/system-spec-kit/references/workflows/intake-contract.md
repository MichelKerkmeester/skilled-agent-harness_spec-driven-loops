...
2. `description.json` — generated via `node .skilled/skills/system-spec-kit/runtime/cli/dist/spec-folder/generate-description.js <folder> <base>`
...
- Helper: `bash .skilled/skills/system-spec-kit/runtime/cli/spec/create.sh` for full trio generation
...
| Category | Paths |
|----------|-------|
| Spec-kit templates | `.skilled/skills/system-spec-kit/templates/` (Level 1 / 2 / 3 / 3+) |
| Phase-parent template | `templates/packet-types/phase-parent.spec.md.tmpl` (lean trio template) |
| Recommend-level helper | `.skilled/skills/system-spec-kit/runtime/cli/spec/recommend-level.sh` |
| Create helper | `.skilled/skills/system-spec-kit/runtime/cli/spec/create.sh` |
| Description generator | `.skilled/skills/system-spec-kit/runtime/cli/dist/spec-folder/generate-description.js` |
| Memory save script | `.skilled/skills/system-spec-kit/runtime/cli/dist/continuity/generate-context.js` |
| Validator | `bash .skilled/skills/system-spec-kit/runtime/cli/spec/validate.sh <folder> --strict` |
| Deep-research spec check | `.skilled/skills/system-deep-loop/deep-research/references/protocol/spec-check-protocol.md` |

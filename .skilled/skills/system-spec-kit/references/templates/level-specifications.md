...
See [phase-definitions.md](../structure/phase-definitions.md) for complete phase system documentation including scoring dimensions, folder structure, lifecycle, and validation rules.
...
- [template-guide.md](./template-guide.md) - Template selection, adaptation, and quality standards
- [level-selection-guide.md](./level-selection-guide.md) - 5-dimension complexity scoring and auto-detection

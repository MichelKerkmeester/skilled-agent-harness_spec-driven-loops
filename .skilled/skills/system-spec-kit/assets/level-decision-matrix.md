...
### Asset Files
- [complexity-decision-matrix.md](./complexity-decision-matrix.md) - Complexity-based level selection and scoring
...
- [template-guide.md](../references/templates/template-guide.md) - Template selection and quality standards

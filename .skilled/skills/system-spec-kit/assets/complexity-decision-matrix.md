...
bash .skilled/skills/system-spec-kit/runtime/cli/spec/create.sh "Add authentication" --level 2

# Create spec folder with Level 3
bash .skilled/skills/system-spec-kit/runtime/cli/spec/create.sh "Major refactor" --level 3
...
**Source**: `.skilled/skills/system-spec-kit/spec.md`
...
### Asset Files
- [level-decision-matrix.md](./level-decision-matrix.md) - LOC-based level selection and progressive enhancement
- [template-mapping.md](./template-mapping.md) - Template routing with copy commands

...
npm run --prefix .opencode/skills/system-spec-kit/runtime test:council
python3 .opencode/skills/sk-doc/scripts/quick_validate.py .opencode/skills/deep-ai-council
bash .opencode/skills/system-spec-kit/runtime/cli/spec/validate.sh .opencode/specs/skilled-agent-orchestration/101-deep-multi-ai-council-skill --strict

...
|-----------|-------|-------|
| Strict validation | Fixture 053 | `bash .opencode/skills/system-spec-kit/runtime/cli/spec/validate.sh .opencode/skills/system-spec-kit/runtime/cli/test-fixtures/053-template-compliant-level2 --strict` |

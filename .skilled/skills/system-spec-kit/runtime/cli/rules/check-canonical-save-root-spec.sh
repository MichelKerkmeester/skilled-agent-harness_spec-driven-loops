#!/usr/bin/env bash
# ───────────────────────────────────────────────────────────────
# COMPONENT: CHECK-CANONICAL-SAVE-ROOT_SPEC
# ───────────────────────────────────────────────────────────────
# Rule: CANONICAL_SAVE_ROOT_SPEC_REQUIRED
# Severity: error
# Description: A live packet root must expose a canonical spec.md. Sourced by validate.sh; the decision lives in the
...
CANONICAL_SAVE_MODULE="$SCRIPT_DIR/check-canonical-save-root-spec.cjs"
...
run_check() {
    ...
    RULE_NAME="CANONICAL_SAVE_ROOT_SPEC_REQUIRED"
    RULE_STATUS="pass"
    RULE_MESSAGE=""
    RULE_DETAILS=()
    RULE_REMEDIATION=""

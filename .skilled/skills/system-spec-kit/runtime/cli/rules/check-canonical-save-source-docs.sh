#!/usr/bin/env bash
# ───────────────────────────────────────────────────────────────
# COMPONENT: CHECK-CANONICAL-SAVE-SOURCE_DOCS
# ───────────────────────────────────────────────────────────────
# Rule: CANONICAL_SAVE_SOURCE_DOCS_REQUIRED
# Severity: error
# Description: A live packet root graph must carry derived.source_docs. Sourced by validate.sh; the decision lives in the
...
CANONICAL_SAVE_MODULE="$SCRIPT_DIR/check-canonical-save-source-docs.cjs"
...
run_check() {
    ...
    RULE_NAME="CANONICAL_SAVE_SOURCE_DOCS_REQUIRED"
    RULE_STATUS="pass"
    RULE_MESSAGE=""
    RULE_DETAILS=()
    RULE_REMEDIATION=""

...
const BACKFILL = '.skilled/skills/system-spec-kit/runtime/cli/graph/backfill-graph-metadata.ts';
const TSX_LOADER = './.skilled/skills/system-spec-kit/node_modules/tsx/dist/loader.mjs';

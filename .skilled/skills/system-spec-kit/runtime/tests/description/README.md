...
description: "Code-facing README for .skilled/skills/system-spec-kit/runtime/tests/description."
trigger_phrases:
...
This README documents the code-bearing folder `.skilled/skills/system-spec-kit/runtime/tests/description` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .skilled/skills/system-spec-kit/runtime/tests/description
```
...
|---|---|
| Folder boundary | Documents direct code files under `runtime/tests/description`. |
...
```text
User request: Check .skilled/skills/system-spec-kit/runtime/tests/description for sk-code and README coverage.

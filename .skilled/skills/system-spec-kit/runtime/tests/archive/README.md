---
title: "system spec kit mcp server tests archive: Code README"
description: "Code-facing README for .opencode/skills/system-spec-kit/runtime/tests/archive."
trigger_phrases:
  - "system-spec-kit runtime/tests/archive"
  - "code README"
---

# system spec kit mcp server tests archive
...
This README documents the code-bearing folder `.opencode/skills/system-spec-kit/runtime/tests/archive` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .opencode/skills/system-spec-kit/runtime/tests/archive
```
...
|---|---|
| Folder boundary | Documents direct code files under `runtime/tests/archive`. |
...
| Path | Purpose |
|---|---|
| `coverage-graph-db.vitest.ts` | TS source file in this folder. |
| `coverage-graph-tools.vitest.ts` | TS source file in this folder. |
...
```text
User request: Check .opencode/skills/system-spec-kit/runtime/tests/archive for sk-code and README coverage.

...
description: "Code-facing README for .skilled/skills/system-spec-kit/runtime/tests/graph."
trigger_phrases:
...
This README documents the code-bearing folder `.skilled/skills/system-spec-kit/runtime/tests/graph` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .skilled/skills/system-spec-kit/runtime/tests/graph
```
...
```text
User request: Check .skilled/skills/system-spec-kit/runtime/tests/graph for sk-code and README coverage.

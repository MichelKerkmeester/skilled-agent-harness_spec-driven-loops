...
| `SYSTEM_SPEC_GATE_DISABLED` | unset (enabled) | truthy disable flag | Disables spec-gate injection and enforcement. Alias: `SPECKIT_SPEC_GATE_DISABLED`. | `hooks/lib/spec-gate/spec-gate-core.mjs`, `.skilled/plugins/system-spec-gate.js` |

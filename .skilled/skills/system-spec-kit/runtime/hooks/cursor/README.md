...
- [`specs/cli-external-orchestration/z_archive/030-cli-cursor-creation/004-cursor-hook-adapter-layer/decision-record.md`](../../../../../../specs/cli-external-orchestration/z_archive/030-cli-cursor-creation/004-cursor-hook-adapter-layer/decision-record.md). ADR-001 (registration scope) and ADR-002 (event mapping + the live-verification methodology and results above)

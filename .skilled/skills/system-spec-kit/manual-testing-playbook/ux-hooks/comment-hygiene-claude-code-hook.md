...
| File | Role |
|---|---|
| `.skilled/hooks/post-edit-quality/claude/claude-posttooluse.cjs` | Primary implementation anchor — the PostToolUse hook script |

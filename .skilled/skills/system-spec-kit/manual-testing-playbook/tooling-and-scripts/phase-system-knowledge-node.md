...
- Real user request: `Please validate Phase-System Knowledge Node against bash .skilled/skills/system-spec-kit/runtime/cli/tests/test-phase-system.sh and tell me whether the expected signals are present: phase-system shell and JS tests pass; recursive validation succeeds on the valid-phase fixture; direct phase-link validation passes.`
- Prompt: `Validate Phase-System Knowledge Node against bash .skilled/skills/system-spec-kit/runtime/cli/tests/test-phase-system.sh and report cited pass/fail evidence.`
...
```
Validate Phase-System Knowledge Node against bash .skilled/skills/system-spec-kit/runtime/cli/tests/test-phase-system.sh and report cited pass/fail evidence.
```

### Commands

1. `bash .skilled/skills/system-spec-kit/runtime/cli/tests/test-phase-system.sh`
2. `node .skilled/skills/system-spec-kit/runtime/cli/tests/test-phase-command-workflows.js`
3. `bash .skilled/skills/system-spec-kit/runtime/cli/spec/validate.sh .skilled/skills/system-spec-kit/runtime/cli/tests/fixtures/phase-validation/valid-phase --recursive`
...
Provenance: manual only - bash .skilled/skills/system-spec-kit/runtime/cli/tests/test-phase-system.sh

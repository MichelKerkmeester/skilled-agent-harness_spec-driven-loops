...
expected_leaf_resources:
  - workflow_mode: system-spec-kit
    leaf_resource_id: references/templates/template-guide.md
---
...
1. `TMPDIR=$(mktemp -d)`
2. `bash .skilled/skills/system-spec-kit/runtime/cli/spec/create.sh --level 1 --path "$TMPDIR/test-1" --name "test-1"`
3. `bash .skilled/skills/system-spec-kit/runtime/cli/spec/validate.sh "$TMPDIR/test-1" --strict`
4. `bash .skilled/skills/system-spec-kit/runtime/cli/spec/create.sh --level 2 --path "$TMPDIR/test-2" --name "test-2"`
5. `bash .skilled/skills/system-spec-kit/runtime/cli/spec/validate.sh "$TMPDIR/test-2" --strict`
6. `bash .skilled/skills/system-spec-kit/runtime/cli/spec/create.sh --level 3 --path "$TMPDIR/test-3" --name "test-3"`
7. `bash .skilled/skills/system-spec-kit/runtime/cli/spec/validate.sh "$TMPDIR/test-3" --strict`
8. `bash .skilled/skills/system-spec-kit/runtime/cli/spec/create.sh --level 3+ --path "$TMPDIR/test-3-plus" --name "test-3-plus"`
9. `bash .skilled/skills/system-spec-kit/runtime/cli/spec/validate.sh "$TMPDIR/test-3-plus" --strict`
10. `bash .skilled/skills/system-spec-kit/runtime/cli/spec/create.sh --level phase-parent --path "$TMPDIR/test-phase-parent" --name "test-phase-parent"`
11. `bash .skilled/skills/system-spec-kit/runtime/cli/spec/validate.sh "$TMPDIR/test-phase-parent" --strict`
12. `cd .skilled/skills/system-spec-kit/runtime/cli && npx vitest run tests/workflow-invariance.vitest.ts`
13. `rm -rf "$TMPDIR"`
...
Provenance: manual only - bash .skilled/skills/system-spec-kit/runtime/cli/spec/create.sh --level 1 --path "$TMPDIR/test-1" --name "test-1"

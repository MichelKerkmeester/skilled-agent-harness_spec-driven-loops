...
- Prompt: `Validate the AC_COVERAGE single-source ratio against .skilled/skills/system-spec-kit/runtime/cli/tests/check-ac-coverage.sh and a live packet, and report cited pass/fail evidence.`
...
`Validate the AC_COVERAGE single-source ratio against .skilled/skills/system-spec-kit/runtime/cli/tests/check-ac-coverage.sh and a live packet, and report cited pass/fail evidence.`

### Commands

1. Run the rule's unit suite:
   ```bash
   bash .skilled/skills/system-spec-kit/runtime/cli/tests/check-ac-coverage.sh
   ```
...
3. Build the shifted-column control — a criteria table with a column BEFORE `AC-ID`, one cited row and one prose row — and read the ratio:
   ...
   TABLE
   bash -c 'source .skilled/skills/system-spec-kit/runtime/cli/rules/check-ac-coverage.sh
...
- Rule: `.skilled/skills/system-spec-kit/runtime/cli/rules/check-ac-coverage.sh`
- Automated gate: `.skilled/skills/system-spec-kit/runtime/cli/tests/check-ac-coverage.sh`
- Closure rule the citation exemption rests on: `.skilled/skills/system-spec-kit/runtime/cli/rules/check-ac-closure.sh`
- Validator: `.skilled/skills/system-spec-kit/runtime/cli/spec/validate.sh`

Provenance: manual only - run the scenario prompt: Validate the AC_COVERAGE single-source ratio against .skilled/skills/system-spec-kit/runtime/cli/tests/check-ac-coverage.sh and a live packet, and report cited pass/fail evidence.

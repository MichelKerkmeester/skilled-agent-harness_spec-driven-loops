...
2. Run `bash .skilled/skills/system-spec-kit/runtime/cli/spec/validate.sh --strict <target-spec>`
...
Provenance: manual only - bash .skilled/skills/system-spec-kit/runtime/cli/spec/validate.sh --strict <target-spec>

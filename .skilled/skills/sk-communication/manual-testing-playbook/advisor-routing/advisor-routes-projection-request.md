...
1. From the repository root, run `python3 .skilled/skills/system-skill-advisor/runtime/scripts/skill_advisor.py "Rewrite terse agent status output into plain English without changing canonical bytes, and use privacy-first provider routing." --threshold 0.8`.

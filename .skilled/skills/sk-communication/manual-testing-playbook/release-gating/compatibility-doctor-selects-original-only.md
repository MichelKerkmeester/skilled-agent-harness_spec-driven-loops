...
| File | Role |
|---|---|
| [Compatibility doctor](../../../../../.skilled/skills/sk-communication/cli-communication-projection/src/doctor/doctor.ts) | Runs checks and derives route selection. |
| [Doctor checks](../../../../../.skilled/skills/sk-communication/cli-communication-projection/src/doctor/checks.ts) | Version, capability, reachability, privacy, and tier checks. |
| [Doctor tests](../../../../../.skilled/skills/sk-communication/cli-communication-projection/test/doctor/doctor.test.ts) | Ready, degraded, blocking, and malformed-input outcomes. |

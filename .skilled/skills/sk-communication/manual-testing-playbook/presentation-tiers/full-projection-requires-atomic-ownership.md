...
| File | Role |
|---|---|
| [Display client](../../../../../.skilled/skills/sk-communication/cli-communication-projection/src/clients/display.ts) | Applies atomic replacement and append outcomes. |
| [Render decision](../../../../../.skilled/skills/sk-communication/cli-communication-projection/src/render/decision.ts) | Selects digest-checked supported render modes. |
| [Client display tests](../../../../../.skilled/skills/sk-communication/cli-communication-projection/test/clients/display.test.ts) | Atomic ownership and commit behavior. |

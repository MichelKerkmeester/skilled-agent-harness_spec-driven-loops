...
| File | Role |
|---|---|
| [Privacy router](../../../../../.skilled/skills/sk-communication/cli-communication-projection/src/privacy/router.ts) | Consent, evidence, eligibility, and ranking order. |
| [Provider registry](../../../../../.skilled/skills/sk-communication/cli-communication-projection/src/providers/registry.ts) | Provider records consumed by the router. |
| [Privacy router tests](../../../../../.skilled/skills/sk-communication/cli-communication-projection/test/providers/privacy.test.ts) | Deterministic privacy and fallback coverage. |

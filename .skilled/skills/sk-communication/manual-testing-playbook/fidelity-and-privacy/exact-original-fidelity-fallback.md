...
| File | Role |
|---|---|
| [Protected-span implementation](../../../../../.skilled/skills/sk-communication/cli-communication-projection/src/fidelity/protected-spans.ts) | Token protection and exact restoration. |
| [Fidelity validator](../../../../../.skilled/skills/sk-communication/cli-communication-projection/src/fidelity/validator.ts) | Terminal failure and exact-original decision logic. |
| [Protected-span tests](../../../../../.skilled/skills/sk-communication/cli-communication-projection/test/fidelity/protected-spans.test.ts) | Byte-for-byte restoration evidence. |
| [Fidelity validator tests](../../../../../.skilled/skills/sk-communication/cli-communication-projection/test/fidelity/validator.test.ts) | Failure-path fallback evidence. |

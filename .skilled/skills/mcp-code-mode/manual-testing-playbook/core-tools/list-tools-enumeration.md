...
expected_leaf_resources:
  - workflow_mode: mcp-code-mode
    leaf_resource_id: references/tool-catalog.md
---
...
- Prompt: `List all Code Mode MCP tools and report whether every configured manual appears with the manual.manual_tool naming pattern.`
...
- Feature file path: `core-tools/list-tools-enumeration.md`

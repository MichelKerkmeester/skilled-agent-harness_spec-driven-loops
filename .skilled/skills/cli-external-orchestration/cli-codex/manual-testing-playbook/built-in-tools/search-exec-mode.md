...
`--search` is documented in `references/cli-reference.md` §4 and `references/codex-tools.md` §2 as supported in both interactive TUI and non-interactive `exec`. Validating both modes separately catches regressions where the flag silently no-ops in one mode but works in the other.
...
| `../../references/codex-tools.md` (§2 Web Search) | Documents the --search capability |
| `../../references/cli-reference.md` (§4 Essential Flags) | Documents the --search flag |

### Implementation And Test Anchors

| File | Role |
|---|---|
| `../../references/codex-tools.md` | §2 Web Search (--search) |
| `../../references/cli-reference.md` | §4 Essential Flags (--search) |
...
- Feature file path: `built-in-tools/search-exec-mode.md`

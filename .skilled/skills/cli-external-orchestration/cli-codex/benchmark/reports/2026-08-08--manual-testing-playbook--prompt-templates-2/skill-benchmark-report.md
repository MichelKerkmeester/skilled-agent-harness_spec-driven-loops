...
| Executor / model | codex / gpt-5.6-luna (prompt-templates) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| CX-021 | manual | prompt-templates | — | PASS: Gate-3 preamble re-run: exit 0, server.ts created with express + /healthz, gate3 not asked |

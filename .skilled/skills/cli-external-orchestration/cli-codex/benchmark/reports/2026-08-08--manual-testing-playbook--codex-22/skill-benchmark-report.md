...
| Executor / model | codex / gpt-5.6-luna (codex) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| CX-021 | manual | prompt-templates | — | FAIL: Gate-3 doc-scope question blocked write; server.ts never created; no ANCHOR markers in asset |

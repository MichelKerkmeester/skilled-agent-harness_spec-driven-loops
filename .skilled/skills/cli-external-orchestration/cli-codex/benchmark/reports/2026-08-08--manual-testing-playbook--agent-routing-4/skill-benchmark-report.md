...
| -------- | ----- | ----- | ----- | ------------------- |
| CX-026 | manual | agent-routing | — | PASS: profile-v2 re-run: disposable home + auth + research.config.toml; exit 0, 29 candidate mentions, 16 dims, 12 HTTPS URLs, recommendation present |

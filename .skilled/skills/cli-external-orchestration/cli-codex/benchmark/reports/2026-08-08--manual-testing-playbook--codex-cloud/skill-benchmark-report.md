...
| Executor / model | codex / gpt-5.6-luna (codex-cloud) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| CX-028 | manual | codex-cloud | — | PASS: deterministic re-run: codex --help lists cloud, codex login status exit 0, codex cloud --help exit 0 with 6 subcommands |

# Skill Benchmark Report — cli-codex
...
| Executor / model | codex / gpt-5.6-luna (cli-invocation) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| CX-003 | manual | cli-invocation | — | PASS: re-run after dropping the rejected PROMPT arg + disabling scratch hooksPath: codex exec review --uncommitted exit 0, review ran, no mutation (no-findings acceptable) |

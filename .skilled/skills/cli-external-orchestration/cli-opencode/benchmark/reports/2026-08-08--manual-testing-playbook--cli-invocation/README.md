# 2026-08-08--manual-testing-playbook--cli-invocation

> cli-opencode · doc · opencode · opencode-go/deepseek-v4-flash · cli-invocation
...
| Trace mode | doc |
| Executor | opencode |
| Model | opencode-go/deepseek-v4-flash (cli-invocation) |
| Scenarios | 1 |

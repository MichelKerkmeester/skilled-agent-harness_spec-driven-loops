...
| Executor / model | opencode / opencode-go/deepseek-v4-flash (prompt-templates) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| CO-024 | manual | prompt-templates | — | PASS: deterministic pointer re-run: card points at canonical cli-prompt-quality-card; frameworks + 7/10 threshold live in canonical card |

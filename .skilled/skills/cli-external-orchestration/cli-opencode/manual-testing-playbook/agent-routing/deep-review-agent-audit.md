...
2. Dispatch `/deep:review:auto` (via `opencode run --command deep/review`, per SKILL.md/`cli-reference.md` §4's `--command <family>/<name>` contract) against that packet, targeting a real file, with a low iteration cap.
...
| `../../references/agent-delegation.md` (§3 "@deep-research and @deep-review — Loop Executors") | Documents the deep-review LEAF, command-owned contract |
...
| `../../references/agent-delegation.md` | §3 deep-review, LEAF iteration loop executor |
...
| `.skilled/agents/deep-review.md` | Agent definition file |
...
- Feature file path: `agent-routing/deep-review-agent-audit.md`

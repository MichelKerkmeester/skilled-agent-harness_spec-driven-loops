...
description: "Operator-facing directory for the cli-jev transport: execution policy, evidence rules, the 22-scenario index, the run record and failure triage."
trigger_phrases:
  - "cli-jev playbook"
  - "jev manual testing"

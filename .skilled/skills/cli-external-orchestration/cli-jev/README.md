---
title: cli-jev
description: The hub's first transport mode - a TypedSafe Jev judgment bridge that returns a probability, a chosen key, an ordered score, or a batch of typed answers instead of prose.
trigger_phrases:
  - "jev cli"
  - "jev judgment"
  - "typesafe jev"
...
> The eighth mode of `cli-external-orchestration`, and its only `packetKind: "transport"`. Jev reads
...
`specs/cli-external-orchestration/074-cli-jev-creation/context/jev-cli-main/`). No authenticated
...
Source packet: `specs/cli-external-orchestration/074-cli-jev-creation/`.

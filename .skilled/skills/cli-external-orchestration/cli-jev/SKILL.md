...
<!-- Keywords: cli-jev, jev cli, typesafe jev, jev judgment, noul, choice judgment, score judgment, jev run, jev-mcp, typed judgment, classification instead of prose, probability, yes-no judgment, ordered score, batched questions -->

# TypeSafe Jev CLI Transport - Typed Judgments for Dispatch

> **Transport, not executor.** `cli-jev` is the hub's first `packetKind: "transport"` mode: it bridges
...
- Contract pin: `specs/cli-external-orchestration/074-cli-jev-creation/001-jev-contract-research-and-pin/research/live-pin.md`.
- Vendored source: `specs/cli-external-orchestration/074-cli-jev-creation/context/jev-cli-main/`
...
`cli-jev` is the eighth mode of `cli-external-orchestration` and its only transport. It is declared
...
- Upstream project: `specs/cli-external-orchestration/074-cli-jev-creation/context/jev-cli-main/README.md`.

...
- Expected signals: Exit code `0`; stdout is exactly two lines, the first `TEMPLATE_OK` and the second `.skilled/commands/create/manual-testing-playbook.md`; `wc -c` reports a non-zero byte count.

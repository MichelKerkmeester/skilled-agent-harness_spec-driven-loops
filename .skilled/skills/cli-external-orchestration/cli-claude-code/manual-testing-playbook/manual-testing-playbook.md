...
This playbook package adopts the Feature Catalog split-document pattern for the `cli-claude-code` skill. The root document acts as the directory, review surface and orchestration guide, while per-feature execution detail lives in the category folders at the playbook root.
...
2. Reserve one external-AI conductor (OpenCode, Copilot or OpenCode) - never use Claude Code itself as the conductor.
...
> **Feature File:** [CC-001](../manual-testing-playbook/cli-invocation/base-non-interactive-invocation.md)
...
> **Feature File:** [CC-002](../manual-testing-playbook/cli-invocation/default-model-selection-sonnet.md)
...
> **Feature File:** [CC-003](../manual-testing-playbook/cli-invocation/output-format-text-vs-json.md)
...
> **Feature File:** [CC-004](../manual-testing-playbook/cli-invocation/stream-json-incremental-output.md)
...
> **Feature File:** [CC-005](../manual-testing-playbook/permission-modes/plan-mode-read-only-enforcement.md)
...
> **Feature File:** [CC-006](../manual-testing-playbook/permission-modes/accept-edits-auto-approve-writes-sandboxed.md)
...
> **Feature File:** [CC-007](../manual-testing-playbook/permission-modes/bypass-permissions-guard-rail-sandboxed.md)
...
> **Feature File:** [CC-008](../manual-testing-playbook/reasoning-and-models/opus-extended-thinking.md)
...
> **Feature File:** [CC-009](../manual-testing-playbook/reasoning-and-models/sonnet-balanced-default.md)
...
> **Feature File:** [CC-010](../manual-testing-playbook/reasoning-and-models/haiku-fast-classification.md)
...
> **Feature File:** [CC-011](../manual-testing-playbook/agent-routing/context-agent-codebase-exploration.md)
...
> **Feature File:** [CC-012](../manual-testing-playbook/agent-routing/debug-agent-fresh-perspective-root-cause.md)
...
> **Feature File:** [CC-013](../manual-testing-playbook/agent-routing/review-agent-security-audit.md)
...
> **Feature File:** [CC-014](../manual-testing-playbook/agent-routing/multi-ai-council-multi-strategy-planning.md)
...
> **Feature File:** [CC-021](../manual-testing-playbook/agent-routing/handover-agent-context-transfer.md)
...
Prompt: As an external-AI conductor facing a complex task that requires multiple Claude Code specializations in sequence, dispatch claude -p --agent orchestrate --permission-mode plan and ask for a decomposition that names at least 3 specialist agents (e.g., context, review, debug, ai-council) and explicit handoffs between them. Verify the plan reads as a sequenced workflow rather than monolithic analysis. Return a verdict naming the agents in the planned order and confirming no file writes occur.
...
> **Feature File:** [CC-022](../manual-testing-playbook/agent-routing/orchestrate-agent-multi-step.md)
...
> **Feature File:** [CC-023](../manual-testing-playbook/agent-routing/research-agent-investigation.md)
...
> **Feature File:** [CC-024](../manual-testing-playbook/agent-routing/speckit-agent-spec-folder.md)
...
> **Feature File:** [CC-015](../manual-testing-playbook/session-continuity/continue-previous-conversation.md)
...
> **Feature File:** [CC-016](../manual-testing-playbook/session-continuity/resume-specific-session-by-id.md)
...
> **Feature File:** [CC-017](../manual-testing-playbook/integration-patterns/generate-review-fix-cycle.md)
...
> **Feature File:** [CC-018](../manual-testing-playbook/integration-patterns/structured-output-with-json-schema.md)
...
Verify the prompt templates inventory at `assets/prompt-templates.md` is loadable and that a representative template (for example security review or unit test generation) produces well-formed output when populated and dispatched.

#### Scenario Contract

Prompt: As an external-AI conductor wanting to reuse a vetted prompt template instead of authoring one from scratch, load assets/prompt-templates.md from the cli-claude-code skill, select the security review template, populate the placeholders for a real target file, and dispatch the resulting claude -p command. Verify the command runs successfully and the response matches the template's intended structure (severity-tagged findings, etc.). Return a concise user-facing pass/fail verdict with the main reason.
...
> **Feature File:** [CC-019](../manual-testing-playbook/prompt-templates/prompt-template-usage-from-assets.md)

### CC-020 | CLEAR quality card 5-check

#### Description

Verify the prompt quality card at `assets/prompt-quality-card.md` defines the CLEAR 5-check (Correctness, Logic, Expression, Arrangement, Reusability), the framework selection table and the escalation rule to `@prompt-improver` when complexity is `>= 7/10`.
...
> **Feature File:** [CC-020](../manual-testing-playbook/prompt-templates/clear-quality-card-5-check.md)
...
> **Feature File:** [CC-026](../manual-testing-playbook/cost-and-background/max-budget-usd-cap.md)
...
> **Feature File:** [CC-027](../manual-testing-playbook/cost-and-background/background-execution.md)

---

## 15. GOAL HOOK

This category covers one repository-boundary scenario. It verifies that Claude Code cannot discover the OpenCode-only goal command and that the runtime-neutral core registers no Claude Code adapter.
...
Expected signals: No `goal/claude` adapter or Claude goal registration exists. `.claude/commands` is a filtered real directory, `goal-opencode.md` is absent, a shared command is linked, and the mirror check passes.
...
- CC-001: [Base non-interactive invocation](../manual-testing-playbook/cli-invocation/base-non-interactive-invocation.md)
- CC-002: [Default model selection (Sonnet)](../manual-testing-playbook/cli-invocation/default-model-selection-sonnet.md)
- CC-003: [Output format text vs json](../manual-testing-playbook/cli-invocation/output-format-text-vs-json.md)
- CC-004: [Stream-json incremental output](../manual-testing-playbook/cli-invocation/stream-json-incremental-output.md)

### PERMISSION MODES

- CC-005: [Plan mode read-only enforcement](../manual-testing-playbook/permission-modes/plan-mode-read-only-enforcement.md)
- CC-006: [AcceptEdits mode auto-approve writes **(SANDBOXED)**](../manual-testing-playbook/permission-modes/accept-edits-auto-approve-writes-sandboxed.md)
- CC-007: [BypassPermissions guard rail **(SANDBOXED)**](../manual-testing-playbook/permission-modes/bypass-permissions-guard-rail-sandboxed.md)

### REASONING AND MODELS

- CC-008: [Opus extended thinking](../manual-testing-playbook/reasoning-and-models/opus-extended-thinking.md)
- CC-009: [Sonnet balanced default](../manual-testing-playbook/reasoning-and-models/sonnet-balanced-default.md)
- CC-010: [Haiku fast classification](../manual-testing-playbook/reasoning-and-models/haiku-fast-classification.md)

### AGENT ROUTING

- CC-011: [Context agent codebase exploration](../manual-testing-playbook/agent-routing/context-agent-codebase-exploration.md)
- CC-012: [Debug agent fresh-perspective root cause](../manual-testing-playbook/agent-routing/debug-agent-fresh-perspective-root-cause.md)
- CC-013: [Review agent security audit](../manual-testing-playbook/agent-routing/review-agent-security-audit.md)
- CC-014: [Ultra-think multi-strategy planning](../manual-testing-playbook/agent-routing/multi-ai-council-multi-strategy-planning.md)
- CC-021: [Handover agent context transfer](../manual-testing-playbook/agent-routing/handover-agent-context-transfer.md)
- CC-022: [Orchestrate agent multi-step coordination](../manual-testing-playbook/agent-routing/orchestrate-agent-multi-step.md)
- CC-023: [Research agent deep investigation](../manual-testing-playbook/agent-routing/research-agent-investigation.md)
- CC-024: [Speckit agent spec folder workflow](../manual-testing-playbook/agent-routing/speckit-agent-spec-folder.md)

### SESSION CONTINUITY

- CC-015: [Continue previous conversation](../manual-testing-playbook/session-continuity/continue-previous-conversation.md)
- CC-016: [Resume specific session by ID](../manual-testing-playbook/session-continuity/resume-specific-session-by-id.md)

### INTEGRATION PATTERNS

- CC-017: [Generate-review-fix cycle](../manual-testing-playbook/integration-patterns/generate-review-fix-cycle.md)
- CC-018: [Structured output with json-schema](../manual-testing-playbook/integration-patterns/structured-output-with-json-schema.md)

### PROMPT TEMPLATES

- CC-019: [Prompt template usage from assets](../manual-testing-playbook/prompt-templates/prompt-template-usage-from-assets.md)
- CC-020: [CLEAR quality card 5-check](../manual-testing-playbook/prompt-templates/clear-quality-card-5-check.md)

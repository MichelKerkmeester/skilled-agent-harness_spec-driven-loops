...
| File | Role |
|---|---|
| `../../references/cli-reference.md` | Permission Mode Flags table including `acceptEdits` semantics |
| `../../references/claude-tools.md` | Edit Tool section explaining surgical diff-based editing |
...
- Feature file path: `permission-modes/accept-edits-auto-approve-writes-sandboxed.md`

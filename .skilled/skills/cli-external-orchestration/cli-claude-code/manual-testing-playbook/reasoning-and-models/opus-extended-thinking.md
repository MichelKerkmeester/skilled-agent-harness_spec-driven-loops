...
description: "This scenario validates Opus extended thinking for `CC-008`. It focuses on confirming `--model claude-opus-5-5 --effort high` produces deeper multi-dimensional analysis than the Sonnet default."
version: 1.5.0.13
---
...
This scenario validates Opus extended thinking for `CC-008`. It focuses on confirming `--model claude-opus-5-5 --effort high` produces deeper multi-dimensional analysis than the Sonnet default.
...
- Objective: Confirm `--model claude-opus-5-5 --effort high` produces deeper, more detailed chain-of-thought analysis than the Sonnet default for a multi-dimensional architecture trade-off prompt.

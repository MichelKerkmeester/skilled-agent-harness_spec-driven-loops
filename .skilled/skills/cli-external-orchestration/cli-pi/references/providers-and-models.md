...
|-------|---------------------------------|--------------------------------|
| `gpt-6-sol` | `ultra` | Partially — Pi's `--thinking` scale stops at `max`; `ultra` has no Pi-side value |
| `gpt-6-luna` | `max` | Yes — `max` is the top of Pi's own scale |

...
| `.skilled/skills/sk-git/scripts/hooks/pi/git-preflight-advisory.ts` | Checked-in extension source copied into the disposable Pi layout for the paired-event probe |

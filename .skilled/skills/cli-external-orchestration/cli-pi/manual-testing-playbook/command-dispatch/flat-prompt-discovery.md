...
- Run `node .skilled/skills/system-spec-kit/runtime/cli/pi/sync-prompts-pi.cjs --check` and retain its count and drift result.
...
| `.skilled/skills/system-spec-kit/runtime/cli/pi/sync-prompts-pi.cjs` | Generator and drift checker |

...
| -------- | ----- | ----- | ----- | ------------------- |
| PI-019 | manual | prompt-quality | — | PASS: Pi card exists, 5-section shape (CANONICAL SOURCE/THREE TIERS/PI DISPATCH ADDENDA/COMPOSITION CHECK/RELATED), links canonical CLEAR source, sibling cards match 5-section shape |

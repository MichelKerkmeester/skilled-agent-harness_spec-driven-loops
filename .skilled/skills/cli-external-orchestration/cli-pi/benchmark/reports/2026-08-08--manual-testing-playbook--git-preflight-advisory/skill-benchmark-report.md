...
| Executor / model | pi / deepseek-v4-flash (git-preflight-advisory) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| PI-020 | manual | git-preflight-advisory | — | PASS: pi git-preflight extension re-run: tool_call/tool_result fires advisory with [commit-scope-drops-untracked], no block property; SKGIT_ADVISORY=0 and non-git both return undefined |

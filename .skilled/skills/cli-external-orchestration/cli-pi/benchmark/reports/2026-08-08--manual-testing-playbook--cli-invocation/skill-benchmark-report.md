...
| Executor / model | pi / deepseek-v4-flash (cli-invocation) |
| CLI version | — |
| Flag state | `—` |
| Runtime digest | `—` |
| Run revision | — |
...
| -------- | ----- | ----- | ----- | ------------------- |
| PI-001 | manual | cli-invocation | — | PASS: pi --version (0.84.1 recorded at runtime, not asserted) + pi --help flags present + .pi dir; exact-version and mandatory-package assertions removed per fix |

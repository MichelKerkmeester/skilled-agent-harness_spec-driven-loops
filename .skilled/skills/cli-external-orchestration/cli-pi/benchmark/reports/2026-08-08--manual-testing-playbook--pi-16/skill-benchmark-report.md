...
| -------- | ----- | ----- | ----- | ------------------- |
| PI-015 | manual | hook-extension-layer | — | PASS: 19 handlers/7 events registered (drift from 11/6 baseline via 2 new extensions); live startup exit 0 after transient provider 'Model unavailable' retry, no registration error |

...
| -------- | ----- | ----- | ----- | ------------------- |
| PI-012 | manual | mcp-host-integration | — | FAIL: pi-mcp-extension absent from settings.json; no eager MCP server shows connected in Pi's own session, contradicts expected eager-connected baseline |

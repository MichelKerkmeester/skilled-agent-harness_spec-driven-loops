...
| -------- | ----- | ----- | ----- | ------------------- |
| PI-012 | manual | mcp-host-integration | — | SKIP: documented SKIP: no pinned live streamable-HTTP handshake and digest available; remote claim requires pinned evidence |

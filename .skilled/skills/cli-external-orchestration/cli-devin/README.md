...
|---|---|
| **Multi-model dispatch** | a curated roster of seven families (DeepSeek, Gemini, GLM-5.2, GPT-5.6 Luna Max, GPT-6 Luna Max, Grok 4.5 and 4.6, and SWE-2) chosen per dispatch with `--model` |

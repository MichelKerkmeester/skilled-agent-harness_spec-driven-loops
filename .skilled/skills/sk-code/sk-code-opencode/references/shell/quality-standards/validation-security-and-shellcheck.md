...
**Evidence**: `.skilled/skills/system-spec-kit/runtime/cli/spec/validate.sh:325-343`
...
### Internal References
- [style-guide.md](../style-guide/overview-structure-and-naming.md) - Formatting and conventions

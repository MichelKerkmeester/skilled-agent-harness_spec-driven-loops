...
1. `sed -n '1,13p' .skilled/skills/sk-code/sk-code-obsidian/manual-testing-playbook/holdout/verification-natural.md`
2. `for p in references/verification.md assets/verification-checklist.md; do test -e ".skilled/skills/sk-code/sk-code-obsidian/$p" && echo "OK $p" || echo "MISS $p"; done`

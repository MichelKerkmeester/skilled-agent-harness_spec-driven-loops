...
1. `sed -n '1,13p' .skilled/skills/sk-code/sk-code-obsidian/manual-testing-playbook/holdout/stack-standards-natural.md`
2. `for p in references/obsidian-plugin-api.md references/standards/platform-support.md; do test -e ".skilled/skills/sk-code/sk-code-obsidian/$p" && echo "OK $p" || echo "MISS $p"; done`

...
CSS quality patterns and CSS-specific enforcement for Webflow — will-change management, GPU-accelerated properties, easing standards, fluid typography, and the four CSS enforcement rules. See [`../style-guide.md`](../style-guide.md) for naming and formatting conventions.

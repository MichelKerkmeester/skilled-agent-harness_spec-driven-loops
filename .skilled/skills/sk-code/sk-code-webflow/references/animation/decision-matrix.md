...
- External/historical: `.skilled/skills/sk-code/sk-code-webflow/references/implementation/animation-workflows/overview-decision-tree-and-css.md`
...
|-------|------------------|---------------------|
| `Should I use motion.dev or pure CSS for hover states?` | N/A or UNKNOWN | `references/animation/decision-matrix.md`, `references/animation/quick-start.md`; cite the decision tree in this file |
| `For a Webflow page, should scroll reveal use Motion.dev or CSS?` | WEBFLOW | `references/implementation/animation-workflows/overview-decision-tree-and-css.md`, `references/implementation/performance-patterns/overview-and-checklist.md`, `references/animation/decision-matrix.md`, `references/animation/scroll-and-gestures.md` |
...
- Local Webflow animation decision rule: `.skilled/skills/sk-code/sk-code-webflow/references/implementation/animation-workflows/overview-decision-tree-and-css.md`

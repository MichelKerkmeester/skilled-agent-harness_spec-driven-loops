...
**Recovery Steps:**
1. Run verification first: `node .skilled/skills/sk-code/sk-code-webflow/assets/scripts/verify-minification.mjs [file].js`
...
node .skilled/skills/sk-code/sk-code-webflow/assets/scripts/verify-minification.mjs src/javascript/[file].js
node .skilled/skills/sk-code/sk-code-webflow/assets/scripts/test-minified-runtime.mjs dist/[file].min.js
```

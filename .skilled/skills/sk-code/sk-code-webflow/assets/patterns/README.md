...
description: "Code-facing README for .skilled/skills/sk-code/sk-code-webflow/assets/patterns."
trigger_phrases:
...
This README documents the code-bearing folder `.skilled/skills/sk-code/sk-code-webflow/assets/patterns` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .skilled/skills/sk-code/sk-code-webflow/assets/patterns
```
...
```text
User request: Check .skilled/skills/sk-code/sk-code-webflow/assets/patterns for sk-code and README coverage.

...
description: "Code-facing README for .skilled/skills/sk-code/sk-code-webflow/assets/animation/snippets."
trigger_phrases:
...
This README documents the code-bearing folder `.skilled/skills/sk-code/sk-code-webflow/assets/animation/snippets` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .skilled/skills/sk-code/sk-code-webflow/assets/animation/snippets
```
...
```text
User request: Check .skilled/skills/sk-code/sk-code-webflow/assets/animation/snippets for sk-code and README coverage.

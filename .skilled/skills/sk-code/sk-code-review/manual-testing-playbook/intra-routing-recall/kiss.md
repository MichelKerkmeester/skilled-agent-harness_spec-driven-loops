...
1. `sed -n '1,17p' .skilled/skills/sk-code/sk-code-review/manual-testing-playbook/intra-routing-recall/kiss.md`
2. `sed -n '/^INTENT_SIGNALS = {/,/^}/p' .skilled/skills/sk-code/sk-code-review/SKILL.md | grep '"KISS"'`
3. `sed -n '/^RESOURCE_MAP = {/,/^}/p' .skilled/skills/sk-code/sk-code-review/SKILL.md | grep '"KISS"'`

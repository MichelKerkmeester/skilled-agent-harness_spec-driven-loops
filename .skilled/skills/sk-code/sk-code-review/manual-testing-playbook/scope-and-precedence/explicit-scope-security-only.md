...
| File | Role |
|---|---|
| `../../references/review-core.md` | Baseline and surface precedence rules |
| `../../references/review-ux-single-pass.md` | Scope source and interactive report behavior |
| `../../assets/test-quality-checklist.md` | Test-only review severity guidance |
...
- Feature file path: `scope-and-precedence/explicit-scope-security-only.md`

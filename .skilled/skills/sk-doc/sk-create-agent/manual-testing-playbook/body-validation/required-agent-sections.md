...
3. `bash: python3 .skilled/skills/sk-doc/shared/scripts/validate_document.py .skilled/agents/release-note-reviewer.md --type agent`
4. `bash: python3 .skilled/skills/sk-doc/shared/scripts/extract_structure.py .skilled/agents/release-note-reviewer.md`

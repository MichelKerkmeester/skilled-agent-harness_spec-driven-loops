...
| [`scripts/tests/fixtures/voice-judgment-only.md`](../../scripts/tests/fixtures/voice-judgment-only.md) | The shipped target: no mechanical finding, several a reader has to settle |

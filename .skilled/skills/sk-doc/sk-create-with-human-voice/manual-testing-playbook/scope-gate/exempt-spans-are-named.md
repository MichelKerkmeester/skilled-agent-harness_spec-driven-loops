...
4. `bash: python3 .skilled/skills/sk-doc/sk-create-with-human-voice/scripts/hvr_scan.py .skilled/skills/sk-doc/sk-create-with-human-voice/scripts/tests/fixtures/voice-carried-spans.md`

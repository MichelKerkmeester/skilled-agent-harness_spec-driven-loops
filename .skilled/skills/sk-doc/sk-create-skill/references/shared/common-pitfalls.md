...
| Intent     | Path                           |
| ---------- | ------------------------------ |
| Validation | `references/core-standards.md` |
...
### Templates
- [frontmatter-templates.md](../../../sk-create-frontmatter/assets/frontmatter-templates.md) - Frontmatter by document type, description budget and trim style

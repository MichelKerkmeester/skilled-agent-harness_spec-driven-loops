...
The case studies, pitfalls, and worked example cover the **MCP promotion** family (`../../SKILL.md` sections 3 through 8); the behavior benchmark guide covers the **behavior benchmark** family (section 9); the model-benchmark fixture guide covers **model-benchmark** (Lane B, section 10); and the agent-improvement authoring guide covers **agent-improvement** (Lane A, section 12). `../../SKILL.md` holds the authoritative contracts.

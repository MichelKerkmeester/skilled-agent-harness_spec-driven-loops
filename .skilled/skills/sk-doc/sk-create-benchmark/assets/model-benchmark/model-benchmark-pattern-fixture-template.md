...
Usage:
  ...
  4. Delete any scaffold key you do not need only when it is optional below, and keep
...
Normative source (do not restate these contracts, link them):
  - benchmark-fixtures/README.md  ../../../system-deep-loop/deep-improvement/assets/model-benchmark/benchmark-fixtures/README.md
    (§2 KEY FILES, §3 Reviewer Fixture Shape) carries the fixture taxonomy and which
  ...
  - reviewer-schema.md  ../../../system-deep-loop/deep-improvement/assets/model-benchmark/benchmark-fixtures/reviewer-schema.md
    holds the authoritative reviewer-prompt field semantics, verdict contract, and
...
only when nothing is missing and nothing forbidden appears, and an empty band earns
...
Field guidance (Section 2, pattern evidence-contract):
  ...
  content           : the seed artifact lines this fixture materializes as the candidate under test.
                      ...
                      no forbiddenPatterns, and a regressed one visibly does not.
-->
...
Field guidance (Section 3, reviewer-prompt capability. reviewer-schema.md is authoritative):
  kind            : must stay the literal "reviewer-prompt", which is the shape detector.
  ...
  reviewer_output : OPTIONAL per case. When present, the scorer replays this text deterministically
                    instead of dispatching a live model. OMIT it to force live model dispatch (opt-in, and
...
| [`run-benchmark.cjs`](../../../../system-deep-loop/deep-improvement/scripts/model-benchmark/run-benchmark.cjs) | The scorer that consumes the Section 2 pattern fields, and the source of truth for band weighting. |
...
*End of template. The reviewer contract is normative in [`reviewer-schema.md`](../../../../system-deep-loop/deep-improvement/assets/model-benchmark/benchmark-fixtures/reviewer-schema.md), and the fixture taxonomy in [`benchmark-fixtures/README.md`](../../../../system-deep-loop/deep-improvement/assets/model-benchmark/benchmark-fixtures/README.md).*

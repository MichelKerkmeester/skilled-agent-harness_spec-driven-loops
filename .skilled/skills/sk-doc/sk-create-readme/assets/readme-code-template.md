...
The compact `mcp-server/tools/README.md` pattern is the default: frontmatter, short overview, architecture diagram, directory tree, implemented state and related docs.

...
- [worked-example.md](worked-example.md) - frontmatter and gate applied in a full command
- [common-pitfalls.md](common-pitfalls.md) - hint, mode, and frontmatter mistakes with fixes

...
- Required fields: name, description, version (skills only; 4-part X.Y.Z.W -- see sk-create-frontmatter/references/frontmatter-versioning.md)
...
# may carry single underscores/hyphens (system_skill_advisor, code_graph_query) and the tool
...
def validate_skill(
    ...
    if version_match:
        ...
        return False, (
            ...
            "(4-part X.Y.Z.W; see sk-create-frontmatter/references/frontmatter-versioning.md)"
        ), warnings

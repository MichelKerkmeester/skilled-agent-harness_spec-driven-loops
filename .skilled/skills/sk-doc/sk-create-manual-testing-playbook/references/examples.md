...
- `.skilled/skills/system-spec-kit/manual-testing-playbook/` - multi-category package with orchestration-heavy scenarios
...
- [references/README.md](../../sk-create-feature-catalog/references/README.md) - companion reference for the feature-catalog side of the contract

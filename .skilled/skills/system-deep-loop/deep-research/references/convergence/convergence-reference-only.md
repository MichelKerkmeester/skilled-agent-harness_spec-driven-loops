...
This file keeps design material that is useful for future work but not part of the live `/deep:research` executable contract.
...
Preserve useful convergence concepts that are not part of the live `/deep:research` executable contract.
...
Live stop behavior belongs in `convergence.md`, `convergence-signals.md`, `convergence-recovery.md`, and `convergence-graph.md`.
...
The canonical optimizer manifest is `.skilled/skills/system-spec-kit/runtime/cli/optimizer/optimizer-manifest.json`.

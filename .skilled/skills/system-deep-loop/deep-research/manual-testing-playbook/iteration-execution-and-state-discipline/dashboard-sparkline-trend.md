...
| `../../feature-catalog/state-management/dashboard-sparkline-trend.md` | Matching feature catalog entry |
...
- Feature catalog: `feature-catalog/state-management/dashboard-sparkline-trend.md`

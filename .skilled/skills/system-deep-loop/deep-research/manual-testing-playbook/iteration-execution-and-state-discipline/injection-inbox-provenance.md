...
### Commands
1. `bash: sed -n '30,70p' .opencode/skills/system-deep-loop/deep-research/assets/deep-research-strategy.md`
...
| File | Role |
|---|---|
| `.opencode/skills/system-deep-loop/deep-research/assets/deep-research-strategy.md` | Operator-facing inbox schema and legacy-import guidance |

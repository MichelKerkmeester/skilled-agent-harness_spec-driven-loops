...
### Failure Triage
Privilege `research.md` for user-facing flag semantics and `deep-research-confirm.yaml` for live halt boundaries.
...
| `../../feature-catalog/loop-lifecycle/loop-wide-dry-run.md` | Matching feature catalog entry |
...
- Feature catalog: `feature-catalog/loop-lifecycle/loop-wide-dry-run.md`

...
- Feature file path: `research-output/negative-knowledge.md`
Related references:
- [progressive-synthesis.md](../../feature-catalog/research-output/progressive-synthesis.md) — Progressive synthesis

...
| File | Layer | Role |
|---|---|---|
| `.skilled/skills/system-deep-loop/deep-research/references/convergence/convergence.md` | Reference | Defines stuck counting, failure-mode classification, and recovery strategy selection. |
| `.skilled/skills/system-deep-loop/deep-research/references/protocol/loop-protocol.md` | Reference | Places stuck recovery in the live loop state machine. |
| `.skilled/agents/deep-research.md` | Agent | Defines recovery-mode behavior for the iteration agent when the dispatcher marks a run as recovery. |

### Validation And Tests

| File | Type | Role |
|---|---|---|
| `.skilled/skills/system-deep-loop/deep-research/manual-testing-playbook/convergence-and-recovery/stuck-recovery-widens-focus-and-continues.md` | Manual playbook | Verifies stuck recovery changes the approach and continues on renewed progress. |
| `.skilled/skills/system-deep-loop/deep-research/manual-testing-playbook/convergence-and-recovery/insight-status-prevents-false-stuck.md` | Manual playbook | Verifies `insight` resets the stuck counter. |
| `.skilled/skills/system-deep-loop/deep-research/manual-testing-playbook/convergence-and-recovery/thought-status-convergence-handling.md` | Manual playbook | Verifies `thought` does not increase the stuck counter. |

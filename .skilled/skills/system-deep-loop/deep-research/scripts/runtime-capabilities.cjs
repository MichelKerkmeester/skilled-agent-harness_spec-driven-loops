// ╔══════════════════════════════════════════════════════════════════════════╗
// ║ Deep Research Runtime Capabilities Resolver                              ║
// ╠══════════════════════════════════════════════════════════════════════════╣
...
// ║ binds the "deep-research" label and this skill's default matrix path,    ║
...
const { createRuntimeCapabilities } = require('../../runtime/lib/deep-loop/runtime-capabilities.cjs');

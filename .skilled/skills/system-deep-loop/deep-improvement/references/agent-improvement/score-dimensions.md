...
| `references/model-benchmark/evaluator-contract.md` | Evaluator policy contract |
| `feature-catalog/scoring-system/five-dimension-rubric.md` | Feature catalog entry |

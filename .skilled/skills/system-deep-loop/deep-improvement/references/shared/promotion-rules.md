...
- a hard repo-managed mirror sync gate when the target is an agent definition under `.skilled/agents/`, `.claude/agents/`, or `.skilled/agents/`
...
- agent-definition targets are present and content-aligned across both runtime mirrors (`.skilled/agents/`, `.claude/agents/`)

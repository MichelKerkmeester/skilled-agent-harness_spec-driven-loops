...
| `integration-scanner/scan-diverse-agent.md` | Canonical per-feature execution contract |
...
- Feature file path: `integration-scanner/scan-diverse-agent.md`

...
- Prompt: `Validate graceful error handling when scanning a nonexistent agent.`
...
| `integration-scanner/scan-missing-agent.md` | Canonical per-feature execution contract |
...
- Feature file path: `integration-scanner/scan-missing-agent.md`

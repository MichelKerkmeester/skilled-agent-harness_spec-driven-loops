...
- Prompt: `Validate that --output writes a valid profile JSON file for the review agent.`
...
| `profile-generator/file-output.md` | Canonical per-feature execution contract |
...
| `.skilled/agents/review.md` | Implementation or verification anchor referenced by this scenario |
...
- Feature file path: `profile-generator/file-output.md`

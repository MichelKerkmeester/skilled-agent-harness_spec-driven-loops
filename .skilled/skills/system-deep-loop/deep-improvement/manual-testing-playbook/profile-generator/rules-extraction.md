...
- Prompt: `Validate that the profile generator extracts ALWAYS and NEVER rules from a target agent definition.`
...
| `profile-generator/rules-extraction.md` | Canonical per-feature execution contract |
...
| `../../scripts/agent-improvement/generate-profile.cjs` | Implementation or verification anchor referenced by this scenario |
...
- Feature file path: `profile-generator/rules-extraction.md`

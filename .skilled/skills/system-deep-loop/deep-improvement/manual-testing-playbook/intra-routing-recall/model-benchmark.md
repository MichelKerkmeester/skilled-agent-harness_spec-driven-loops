...
1. `sed -n '104,126p' .skilled/skills/system-deep-loop/deep-improvement/SKILL.md` - confirm the `MODEL_BENCHMARK` keyword list and resource map.
...
2. If a different intent wins, compare keyword overlap against the other seven intents (QUICK_REFERENCE, LOOP_EXECUTION, EVALUATION_POLICY, PROMOTION_OPERATIONS, TARGET_ONBOARDING, INTEGRATION_SCAN, FULL_SETUP) before assuming a routing defect.

---
title: "RT-025 -- Legal-Stop Gate Blocking"
...
- Prompt: `Validate that failed legal-stop gates record blockedStop instead of converged.`
...
| `runtime-truth/legal-stop-gates.md` | Canonical per-feature execution contract |
...
- Feature file path: `runtime-truth/legal-stop-gates.md`

---
title: "RT-022 -- Stop-Reason Taxonomy Validation"
...
This document captures the canonical manual-testing contract for `RT-022`.
...
- Prompt: `Validate that completed sessions emit session_ended with valid stopReason and sessionOutcome taxonomy values.`
...
| `runtime-truth/stop-reason-taxonomy.md` | Canonical per-feature execution contract |
...
- Feature file path: `runtime-truth/stop-reason-taxonomy.md`

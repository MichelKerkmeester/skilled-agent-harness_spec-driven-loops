...
| `model-benchmark-mode/optin-5dim-scorer.md` | Canonical per-feature execution contract |
...
- Feature file path: `model-benchmark-mode/optin-5dim-scorer.md`

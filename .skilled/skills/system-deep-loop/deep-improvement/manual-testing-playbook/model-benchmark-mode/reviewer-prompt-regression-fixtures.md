...
| `model-benchmark-mode/reviewer-prompt-regression-fixtures.md` | Canonical per-feature execution contract |
...
| `../../assets/model-benchmark/benchmark-profiles/reviewer-regression.json` | Shipped reviewer-regression profile bundling the four `reviewer-*` fixtures |
| `../../assets/model-benchmark/benchmark-fixtures/reviewer-stale-verdict.json` | Seed reviewer fixture (expected `fail`) used in this scenario |
...
- Feature file path: `model-benchmark-mode/reviewer-prompt-regression-fixtures.md`

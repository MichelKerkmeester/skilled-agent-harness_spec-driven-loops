---
title: "5D-010 -- Dimension Details Array with Individual Check Results"
...
- Prompt: `Validate that every 5D scorer dimension includes a details array with individual check results.`
...
| `five-d-scorer/dimension-details.md` | Canonical per-feature execution contract |
...
- Feature file path: `five-d-scorer/dimension-details.md`

...
| `../../references/shared/promotion-gate-contract.md` | Documented accept/ship promotion gate contract |
| `../../references/shared/promotion-rules.md` | Branch-preservation and no-go policy reference |
| `../../assets/agent-improvement/improvement-config.json` | Default branch-preservation config surface |

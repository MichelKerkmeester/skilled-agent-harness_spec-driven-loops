...
- Authoring these profiles: [`sk-doc/sk-create-benchmark`](../../../../../sk-doc/sk-create-benchmark/SKILL.md) §10: the run-profile template [`model-benchmark-profile-template.md`](../../../../../sk-doc/sk-create-benchmark/assets/model-benchmark/model-benchmark-profile-template.md) and [`model-benchmark-fixture-guide.md`](../../../../../sk-doc/sk-create-benchmark/references/model-benchmark/model-benchmark-fixture-guide.md). That packet owns the profile *authoring* template; `run-benchmark.cjs` and the scorers stay lane-local.

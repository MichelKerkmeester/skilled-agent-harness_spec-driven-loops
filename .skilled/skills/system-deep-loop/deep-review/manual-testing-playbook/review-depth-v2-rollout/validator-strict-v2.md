...
- `review-depth-validator.vitest.ts` exists under `.skilled/skills/system-deep-loop/runtime/tests/integration/`.
...
- Validator: `.skilled/skills/system-deep-loop/runtime/lib/deep-loop/post-dispatch-validate.ts` (v2 strict checks branch + new failure-reason union members).
- Fixture: `.skilled/skills/system-deep-loop/runtime/tests/integration/review-depth-validator.vitest.ts`.
- Schema: `.skilled/skills/system-deep-loop/deep-review/references/state/state-format.md` (`## Review Depth Schema (v2)`).

...
2. `bash: cd .skilled/skills/system-spec-kit/runtime && npx vitest run ../../runtime//tests/unit/fanout-merge.vitest.ts --reporter=verbose`
...
| File | Role |
|---|---|
| `.skilled/skills/system-deep-loop/runtime/scripts/fanout-merge.cjs` | `mergeReviewRegistries`, `SEVERITY_RANK`, `mergedVerdict` derivation |

### Validation

| File | Role |
|---|---|
| `.skilled/skills/system-deep-loop/runtime/tests/unit/fanout-merge.vitest.ts` | 5 review strongest-restriction tests |
...
- Scenario file path: `manual-testing-playbook/fanout/fanout-strongest-restriction.md`

...
| File | Role |
|---|---|
| `.opencode/commands/deep/assets/deep-review-auto.yaml` | `step_resolve_artifact_root` (if_present/if_absent), `step_fanout_spawn`, `step_fanout_merge` (with `bind_from_output` for p0/p1/p2 counts) |
| `.opencode/commands/deep/assets/deep-review-confirm.yaml` | Same steps (confirm variant) |

...
```bash
node .skilled/skills/system-deep-loop/runtime/scripts/reduce-state.cjs \
  .skilled/skills/system-deep-loop/deep-review/scripts/tests/fixtures/blocked-stop-session
```

...
- Feature catalog entry exists at `feature-catalog/script-entry-points/convergence-script.md`.
...
- Output from `tests/integration/convergence-script.vitest.ts` naming the assertions that carry the expected signals.
...
- Playbook ID: DLR-014
- Feature catalog entry: `feature-catalog/script-entry-points/convergence-script.md`
- Scenario file path: `manual-testing-playbook/script-entry-points/convergence-script.md`

...
- vitest resolves from `.skilled/skills/system-spec-kit/runtime/`.
...
2. `bash: cd .skilled/skills/system-deep-loop/runtime && npx vitest run tests/unit/executor-config.vitest.ts`

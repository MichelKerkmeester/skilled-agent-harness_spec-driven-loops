...
- Feature catalog entry exists at `feature-catalog/validation/post-dispatch-validate.md`.
...
- Group: Validation
- Playbook ID: DLR-005
- Feature catalog entry: `feature-catalog/validation/post-dispatch-validate.md`
- Scenario file path: `manual-testing-playbook/validation/post-dispatch-validate.md`

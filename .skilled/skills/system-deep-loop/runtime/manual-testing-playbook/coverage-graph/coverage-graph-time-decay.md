...
- Feature catalog entry exists at `feature-catalog/coverage-graph/coverage-graph-time-decay.md`.
...
- Output from `tests/unit/coverage-graph-signals.vitest.ts` naming the assertions that carry the expected signals.
...
- Playbook ID: DLR-042
- Feature catalog entry: `feature-catalog/coverage-graph/coverage-graph-time-decay.md`
- Scenario file path: `manual-testing-playbook/coverage-graph/coverage-graph-time-decay.md`

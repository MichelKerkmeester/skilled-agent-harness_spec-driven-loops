...
- Source excerpts from `lib/deep-loop/executor-config.ts` showing the anchors named in the commands above, read from the current files rather than recalled.

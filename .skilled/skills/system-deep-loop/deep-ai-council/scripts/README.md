...
description: "Code-facing README for .skilled/skills/system-deep-loop/deep-ai-council/scripts."
trigger_phrases:
...
This README documents the code-bearing folder `.skilled/skills/system-deep-loop/deep-ai-council/scripts` so operators can understand its role without opening every source file first. It follows the sk-doc skill README structure while staying focused on code navigation.
...
```bash
rg --files .skilled/skills/system-deep-loop/deep-ai-council/scripts
```
...
```text
User request: Check .skilled/skills/system-deep-loop/deep-ai-council/scripts for sk-code and README coverage.

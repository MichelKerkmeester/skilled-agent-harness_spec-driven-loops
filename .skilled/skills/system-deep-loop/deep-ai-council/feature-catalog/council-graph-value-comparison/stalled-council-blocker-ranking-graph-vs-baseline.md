...
| `.skilled/skills/system-deep-loop/runtime/lib/council/council-graph-query.ts` | Library | `getConvergenceBlockers` helper |
| `.skilled/skills/system-deep-loop/deep-ai-council/references/convergence/convergence-signals.md` | Reference | Documents `max_rounds` escape hatch |
...
| `.skilled/skills/system-deep-loop/runtime/tests/integration/council-graph-value-scenarios.vitest.ts` | Automated test | Automated test name: DAC-030 graph beats no-graph baseline |

...
The two-of-three convergence rule is documented in references/convergence/convergence-signals.md and is the no-graph baseline for stop decisions.
...
- Feature file path: `feature-catalog/council-graph-value-comparison/convergence-safety-under-critical-disagreement-graph-vs-baseline.md`
- Playbook scenario: `manual-testing-playbook/council-graph-value-comparison/convergence-safety-under-critical-disagreement-graph-vs-baseline.md`
Related references:
- [decision-provenance-audit-graph-vs-baseline.md](../../feature-catalog/council-graph-value-comparison/decision-provenance-audit-graph-vs-baseline.md) — Decision provenance audit: graph vs baseline

...
> **Automated test anchor:** `.skilled/skills/system-deep-loop/runtime/tests/integration/council-graph-value-scenarios.vitest.ts` test name `DAC-031 graph beats no-graph baseline`. Measured baseline-vs-graph ratios live in `.skilled/skills/system-deep-loop/runtime/tests/council-graph-value-report.json`.
...
| `../council-graph-integration/council-graph-query-five-modes-prompt-safe-context.md` | Functional anchor for `hot_nodes` mode |
...
| `.skilled/skills/system-deep-loop/runtime/lib/council/council-graph-query.ts` | `getHotNodes` ranking helper |
| `.skilled/skills/system-deep-loop/deep-ai-council/references/integration/graph-support.md` §3 | Documents edge kinds counted toward hotness |
...
- Feature file path: `council-graph-value-comparison/hot-topic-discovery-graph-vs-baseline.md`

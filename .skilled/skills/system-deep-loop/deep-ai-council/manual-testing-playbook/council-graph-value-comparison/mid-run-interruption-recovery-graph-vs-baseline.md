...
| `.opencode/skills/system-deep-loop/deep-ai-council/references/structure/state-format.md` | Documents append-only `ai-council-state.jsonl` event contract |
| `.opencode/skills/system-deep-loop/deep-ai-council/references/integration/graph-support.md` §5 | Documents the recovery + replay contract |

...
| File | Role |
|---|---|
| `.skilled/skills/system-deep-loop/runtime/scripts/upsert.cjs` | runtime CLI script: idempotent upsert + self-loop rejection |
| `.skilled/skills/system-deep-loop/runtime/lib/council/council-graph-db.ts` | Storage layer: unique constraints |
| `.skilled/skills/system-deep-loop/runtime/scripts/upsert.cjs` | Runtime CLI validation and edge normalization |

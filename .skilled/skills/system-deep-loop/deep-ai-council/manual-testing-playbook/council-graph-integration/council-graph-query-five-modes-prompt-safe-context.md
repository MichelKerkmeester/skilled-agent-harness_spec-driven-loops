...
| File | Role |
|---|---|
| `.skilled/skills/system-deep-loop/runtime/scripts/query.cjs` | runtime CLI script: per-mode dispatch |
| `.skilled/skills/system-deep-loop/runtime/lib/council/council-graph-query.ts` | Per-mode query helpers |
| `.skilled/skills/system-deep-loop/runtime/scripts/query.cjs` | Runtime query-type dispatch for `unresolved_disagreements`, `evidence_chain`, `decision_support`, `convergence_blockers`, and `hot_nodes` |
| `.skilled/skills/system-deep-loop/runtime/tests/integration/council-graph-script.vitest.ts` | Test: "upserts prompt-safe council graph data and queries unresolved disagreements and decision support" |
| `.skilled/skills/system-deep-loop/deep-ai-council/references/integration/graph-support.md` | Documents the five query modes |

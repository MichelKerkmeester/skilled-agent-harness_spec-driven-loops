...
5. Replay upserts with `node .skilled/skills/system-deep-loop/deep-ai-council/scripts/replay-graph-from-artifacts.cjs --spec-folder <spec-folder> --session-id dac-025-run-01`, then pipe the emitted payload to `runtime upsert CLI`.
...
4. `bash: node .skilled/skills/system-deep-loop/deep-ai-council/scripts/replay-graph-from-artifacts.cjs --spec-folder <spec-folder> --session-id dac-025-run-01 > /tmp/dac-025-upsert.json`
...
| `.skilled/skills/system-deep-loop/deep-ai-council/references/integration/graph-support.md` §5 | Recovery and rollback contract |
| `.skilled/skills/system-deep-loop/runtime/lib/council/council-graph-db.ts` | Namespace-scoped delete + upsert |
...
- Feature file path: `council-graph-integration/council-graph-derived-projection-rebuilds-from-artifacts.md`

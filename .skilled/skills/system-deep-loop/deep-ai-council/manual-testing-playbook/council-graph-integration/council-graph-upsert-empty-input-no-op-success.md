...
| File | Role |
|---|---|
| `.skilled/skills/system-deep-loop/runtime/scripts/upsert.cjs` | runtime CLI script: explicit empty-input no-op branch (P1-001 remediation) |
| `.skilled/skills/system-deep-loop/runtime/tests/integration/council-graph-script.vitest.ts` | Test: "treats empty upsert as an explicit no-op success" |

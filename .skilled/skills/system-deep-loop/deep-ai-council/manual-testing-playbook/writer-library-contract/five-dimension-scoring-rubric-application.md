...
1. `bash: rg -n "Correctness.*30|Completeness.*20|Elegance.*15|Robustness.*20|Integration.*15" .skilled/skills/system-deep-loop/deep-ai-council/references/scoring/scoring-rubric.md`
...
| File | Role |
|---|---|
| `.skilled/skills/system-deep-loop/deep-ai-council/references/scoring/scoring-rubric.md` | Rubric and comparison-table reference |

...
- Expected execution process: Inspect `scoring-rubric.md` §4, then grep for the role names and pre/post critique rows.
...
Restore `scoring-rubric.md` §4 from agent §6 adversarial cross-critique content.

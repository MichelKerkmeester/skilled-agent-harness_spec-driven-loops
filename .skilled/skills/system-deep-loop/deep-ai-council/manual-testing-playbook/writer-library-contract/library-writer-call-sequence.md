...
1. `bash: rg -n "^function (writeConfig|writeStrategyMd|writeStateJsonl|writeSeat|writeDeliberation|writeCritique|writeReport)" .skilled/skills/system-deep-loop/deep-ai-council/scripts/lib/persist-artifacts.cjs`
2. `bash: rg -n "artifact_written" .skilled/skills/system-deep-loop/deep-ai-council/scripts/lib/`
...
| File | Role |
|---|---|
| `.skilled/skills/system-deep-loop/deep-ai-council/scripts/lib/persist-artifacts.cjs` | Writer library and audit event implementation |
| `.skilled/agents/ai-council.md` | Canonical writer sequence in invocation contract |

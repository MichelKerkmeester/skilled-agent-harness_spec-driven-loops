...
1. `bash: rg -n "planning-only|ai-council/\\*\\*|application code|spec docs|patch|Bash" .skilled/skills/system-deep-loop/deep-ai-council/SKILL.md .skilled/agents/ai-council.md`
...
| File | Role |
|---|---|
| `.skilled/skills/system-deep-loop/deep-ai-council/SKILL.md` | Skill rules and integration points |
| `.skilled/agents/ai-council.md` | Runtime permission boundary |
...
- Feature file path: `scope-boundaries/planning-only-boundary-rejects-implementation-writes.md`

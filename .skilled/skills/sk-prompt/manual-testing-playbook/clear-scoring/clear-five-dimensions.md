...
3. `bash: rg 'Correctness|Logic|Expression|Arrangement|Reusability|CLEAR_SCORE' .skilled/skills/sk-prompt/references/patterns-evaluation.md .skilled/skills/sk-prompt/SKILL.md`

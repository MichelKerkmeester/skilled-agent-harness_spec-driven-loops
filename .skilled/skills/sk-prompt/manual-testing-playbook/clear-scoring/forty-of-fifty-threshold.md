...
3. `bash: rg '40\\+/50|required|30-39|Max 3 iterations|CLEAR >= 40' .opencode/skills/sk-prompt/references/depth-framework.md .opencode/skills/sk-prompt/references/patterns-evaluation.md`

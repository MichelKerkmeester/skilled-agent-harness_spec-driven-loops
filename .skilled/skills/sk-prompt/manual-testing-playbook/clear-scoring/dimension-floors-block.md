...
3. `bash: rg 'Floor|dimension falls below floor|C >= 7|E >= 10' .opencode/skills/sk-prompt/references/depth-framework.md .opencode/skills/sk-prompt/references/patterns-evaluation.md`

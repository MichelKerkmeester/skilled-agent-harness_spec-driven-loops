...
3. `bash: rg 'Floor|dimension falls below floor|C >= 7|E >= 10' .skilled/skills/sk-prompt/references/depth-framework.md .skilled/skills/sk-prompt/references/patterns-evaluation.md`

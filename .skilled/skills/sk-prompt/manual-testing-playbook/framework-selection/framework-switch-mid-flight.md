...
3. `bash: rg 'Try alternative framework|Framework selected|Test|CLEAR 40' .skilled/skills/sk-prompt/references/depth-framework.md .skilled/skills/sk-prompt/references/patterns-evaluation.md`

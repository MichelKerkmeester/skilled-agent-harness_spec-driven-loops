...
3. `bash: rg 'Framework Selection Matrix|Complete Framework Matrix|Complexity' .skilled/skills/sk-prompt/SKILL.md .skilled/skills/sk-prompt/references/patterns-evaluation.md`

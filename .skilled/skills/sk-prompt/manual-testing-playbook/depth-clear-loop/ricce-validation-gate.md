...
3. `bash: rg 'RICCE|Role, Instructions, Context, Constraints, Examples|present or justified' .skilled/skills/sk-prompt/SKILL.md .skilled/skills/sk-prompt/references/depth-framework.md`

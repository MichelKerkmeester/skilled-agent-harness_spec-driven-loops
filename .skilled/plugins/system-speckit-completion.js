// ╔══════════════════════════════════════════════════════════════════════════╗
// ║ COMPONENT: system-speckit-completion OpenCode Plugin (adapter)               ║
// ╠══════════════════════════════════════════════════════════════════════════╣
// ║ PURPOSE: OpenCode transport adapter over the runtime-neutral             ║
// ║          completion-state core. Registers one read-only tool,            ║
// ║          `system_speckit_completion`, that returns a spec folder's inferred  ║
...
/**
 * Create the system-speckit-completion OpenCode plugin hooks.
 *

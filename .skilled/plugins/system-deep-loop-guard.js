// ╔══════════════════════════════════════════════════════════════════════════╗
// ║ COMPONENT: system-deep-loop-guard OpenCode Plugin (adapter)                  ║
// ╠══════════════════════════════════════════════════════════════════════════╣
...
/**
 * Create the system-deep-loop-guard OpenCode plugin hooks.
 *
  ...
  return {
    ...
    async 'tool.execute.before'(input, output) {
      try {
        ...
        if (err instanceof Error && err.message.startsWith('system-deep-loop-guard:')) throw err;

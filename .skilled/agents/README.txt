...
Each .md file carries frontmatter (mode, temperature, permission) and behavioral instructions,
and is the canonical source the .codex and .pi trees are generated from.

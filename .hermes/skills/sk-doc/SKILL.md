...
> Canonical source: `.skilled/skills/sk-doc/`. This is a generated markdown-only copy so Hermes can load the
...
> ```bash
> node .skilled/bin/compiled-route.cjs --hub sk-doc --prompt "<task>"
> ```

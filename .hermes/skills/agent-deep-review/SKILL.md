...
> Agent persona `deep-review` from `.hermes/agents/deep-review.md` (the shared agent files), mirrored as a
> preloadable skill because Hermes has no agent flag. Preload with `-s agent-deep-review` and adopt it for the session.

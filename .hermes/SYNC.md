...
|---|---|---|
| `pre_llm_call` | `bin/skill-advisor.cjs`; `spec-gate/devin/spec-gate-classify.mjs` | Appends the skill-advisor brief (every turn) and the Gate 3 question (first turn) to the user message; both skip for an orchestrated leaf |

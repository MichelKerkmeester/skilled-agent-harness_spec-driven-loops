...
- **REQ-002 [P1]** Every `description.json` and `graph-metadata.json` in both moved trees is rewritten to identify the new `sk-code/025-*` or `sk-code/026-*` location, verified with zero mismatches.

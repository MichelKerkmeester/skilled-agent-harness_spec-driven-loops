...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/sk-code/017-sk-code-parent/graph-metadata.json"
    session_dedup:
...
| `.opencode/specs/sk-code/017-sk-code-parent/graph-metadata.json` | Updated | Parent rollup: `children_ids` 001-019, `last_active_child_id` 019, status complete | this close-out |
| `.opencode/specs/sk-code/017-sk-code-parent/spec.md` | Updated | Parent status Active->Complete; phase map extended to 019 | this close-out |

...
|-----------|-------------|-------------|
| `.opencode/specs/sk-code/017-sk-code-parent/023-sk-code-workflow-subskill-research/research/` | Create | Deep-research artifacts: state log, iterations, deltas, strategy, dashboard, synthesis |
| `.opencode/specs/sk-code/017-sk-code-parent/023-sk-code-workflow-subskill-research/{description,graph-metadata}.json` | Create | Spec-folder metadata for memory-search visibility |

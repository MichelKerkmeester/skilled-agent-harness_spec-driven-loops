...
|---------|--------|--------|
| Re-baseline `sk-design/benchmark/reports/baseline` and `deep-loop-workflows/benchmark/baseline` | Wrote `sk-design/benchmark/reports/2026-07-06--after-d3-proxy--router` and `deep-loop-workflows/benchmark/2026-07-06--after-d3-proxy--router` sibling folders; frozen `baseline/` folders were left intact | Each benchmark README documents `baseline/` as a frozen comparison anchor and instructs adding new baselines as sibling folders |

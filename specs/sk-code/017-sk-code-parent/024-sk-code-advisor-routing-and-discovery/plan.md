...
- [x] Regenerate `sk-code/benchmark/reports/2026-06-01--router-final--router` as the current/regenerable benchmark folder.
- [x] Write `sk-design/benchmark/reports/2026-07-06--after-d3-proxy--router` as a sibling report instead of overwriting frozen `baseline/`.

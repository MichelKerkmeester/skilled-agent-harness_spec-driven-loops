...
- **F001**: ADR still describes the decision as proposed and plan-only after implementation completed. Evidence: `.opencode/specs/sk-code/z_archive/006-sk-code-opencode-merger/decision-record.md:48`, `.opencode/specs/sk-code/z_archive/006-sk-code-opencode-merger/decision-record.md:63`, `.opencode/specs/sk-code/z_archive/006-sk-code-opencode-merger/implementation-summary.md:59`.
- **F003**: Spec and plan still describe the packet as plan-only/incomplete after implementation is documented complete. Evidence: `.opencode/specs/sk-code/z_archive/006-sk-code-opencode-merger/spec.md:3`, `.opencode/specs/sk-code/z_archive/006-sk-code-opencode-merger/spec.md:63`, `.opencode/specs/sk-code/z_archive/006-sk-code-opencode-merger/plan.md:68`, `.opencode/specs/sk-code/z_archive/006-sk-code-opencode-merger/plan.md:72`, `.opencode/specs/sk-code/z_archive/006-sk-code-opencode-merger/implementation-summary.md:59`.
...
- **F002**: Resource map continuity still reflects the pre-implementation approval state. Evidence: `.opencode/specs/sk-code/z_archive/006-sk-code-opencode-merger/resource-map.md:16`, `.opencode/specs/sk-code/z_archive/006-sk-code-opencode-merger/resource-map.md:18`, `.opencode/specs/sk-code/z_archive/006-sk-code-opencode-merger/implementation-summary.md:14`.
...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/sk-code/z_archive/006-sk-code-opencode-merger --strict` passed with 0 errors and 0 warnings.

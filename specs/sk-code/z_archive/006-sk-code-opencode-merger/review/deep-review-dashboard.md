...
<!-- ANCHOR:status -->
## 2. STATUS
- Review Target: .opencode/specs/sk-code/z_archive/006-sk-code-opencode-merger plus working tree changes for sk-code merger and public agent/command cleanup (spec-folder)

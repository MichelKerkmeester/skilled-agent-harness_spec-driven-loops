...
- F-007 `specs/sk-code/z_archive/007-sk-code-motion-dev-and-playbook/spec.md:59` — Parent spec body still says In Progress, child phases are Draft, and resolved questions remain under Open Questions. Refresh body state to complete/closed.
- F-008 `specs/sk-code/z_archive/007-sk-code-motion-dev-and-playbook/001-playbook/spec.md:16` — Child planning artifacts retain initialization continuity and `completion_pct: 0` despite completed implementation summaries. Refresh continuity or narrow resume behavior to completed summaries.
- F-009 `specs/sk-code/z_archive/007-sk-code-motion-dev-and-playbook/002-motion-dev/implementation-summary.md:77` — Packet 2 summary claims eight runnable snippets while F-005/F-006 remain active. Update after fixes or record active exceptions.
...
- F-013 `specs/sk-code/z_archive/007-sk-code-motion-dev-and-playbook/003-cross-ref-metadata-sync/graph-metadata.json:202` — Packet 3 causal summary describes the pre-implementation problem rather than delivered outcome.
...
Create `specs/sk-code/z_archive/007-sk-code-motion-dev-and-playbook/004-deep-review-remediation/`.

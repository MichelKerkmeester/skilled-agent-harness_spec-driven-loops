...
`specs/sk-code/z_archive/007-sk-code-motion-dev-and-playbook/` (phase parent + 3 children + sk-code skill modifications + cross-stack motion_dev/ category + sk-doc-aligned playbook extensions).
...
- Target: `specs/sk-code/z_archive/007-sk-code-motion-dev-and-playbook`
- Mode: review
- maxIterations: 7

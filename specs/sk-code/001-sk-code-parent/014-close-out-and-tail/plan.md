...
| Spec validation | Phase 014 docs | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/sk-code/001-sk-code-parent/014-close-out-and-tail --strict` |

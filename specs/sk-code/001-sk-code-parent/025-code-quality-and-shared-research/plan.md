...
| **Storage** | Repository filesystem: `.opencode/specs/sk-code/001-sk-code-parent/025-code-quality-and-shared-research/` with read-only research output under `research/` |

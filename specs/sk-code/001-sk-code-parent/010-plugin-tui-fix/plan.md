...
| Documentation validation | Phase Level-2 docs | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/sk-code/001-sk-code-parent/010-plugin-tui-fix --strict` |

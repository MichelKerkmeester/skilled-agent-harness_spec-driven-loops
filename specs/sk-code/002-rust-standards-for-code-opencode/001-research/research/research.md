...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/sk-code/002-rust-standards-for-code-opencode/002-upgrade \
  --strict
```
...
```bash
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
  .opencode/specs/sk-code/002-rust-standards-for-code-opencode \
  --strict
```
...
The phase parent explicitly names `002-upgrade/` and requires drift guard, router replay, and strict validation before completion. [SOURCE: `.opencode/specs/sk-code/002-rust-standards-for-code-opencode/spec.md:99-116`]

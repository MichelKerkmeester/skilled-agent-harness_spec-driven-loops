---
title: "Iteration 6: Rollup Consistency"
trigger_phrases: []
---
...
- `.opencode/specs/sk-code/002-rust-standards-for-code-opencode/spec.md:123-132`
- `.opencode/specs/sk-code/002-rust-standards-for-code-opencode/012-gate-verification-rollup/implementation-summary.md:37-48`
...
1. **F004: WS2 rollup overstates the number of generated parts** -- `.opencode/specs/sk-code/002-rust-standards-for-code-opencode/012-gate-verification-rollup/implementation-summary.md:39-47` -- The summary says approximately 120 parts, but its own phase table totals 21 + 20 + 29 + 31 + 3 = 104. The parent repeats `~120` [SOURCE: .opencode/specs/sk-code/002-rust-standards-for-code-opencode/spec.md:17]. This does not break routing but makes the completion inventory unreliable.

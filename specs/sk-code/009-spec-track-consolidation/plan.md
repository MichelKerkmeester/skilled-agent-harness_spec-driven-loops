...
Reversible: the destination folders (`specs/sk-code/007-sk-code-obsidian-surface`, `specs/sk-code/008-sk-code-mobile-cli-mode`) and the new changelog leaf are pure additions. Removing them restores the prior state exactly, since the origin trees in the Obsidian Plugin and Mobile CLI repos were never modified or deleted.

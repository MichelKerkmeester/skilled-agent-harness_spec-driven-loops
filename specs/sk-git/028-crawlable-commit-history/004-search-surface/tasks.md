---
title: "Tasks: Phase 4: search-surface"
...
- [x] T001 Read the catalog entry and the GIT-004 scenario shape
- [x] T002 Write the one-change brief (scratch/briefs)
- [x] T003 [P] Confirm the quick-reference queries from phase 003
<!-- /ANCHOR:phase-1 -->
...
- [x] T004 Extend the commit workflows catalog entry (feature-catalog/workflow-playbooks/conventional-commit-workflows.md)
- [x] T005 Add the root catalog sentences (feature-catalog/feature-catalog.md)
- [x] T006 Add scenario GIT-044 (manual-testing-playbook/commit-formation/find-commits-by-packet-and-id.md)
- [x] T007 Add the index row (manual-testing-playbook/manual-testing-playbook.md)
<!-- /ANCHOR:phase-2 -->
...
- [x] T008 Run the three queries on a stamped fixture commit
- [x] T009 Run validate_document.py and both package validators
- [x] T010 Commit and close the phase docs
<!-- /ANCHOR:phase-3 -->

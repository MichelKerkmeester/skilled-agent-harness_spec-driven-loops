---
title: "Tasks: Phase 2: format-decision"
...
- [x] T001 Render the decision-record template (decision-record.md)
- [x] T002 Check existing rule coverage for git posture (repo-rules/, AGENTS.md section 5)
- [x] T003 [P] Dispatch the adversarial review on a second model family (read-only)
<!-- /ANCHOR:phase-1 -->
...
- [x] T004 Decide the identifier shape and the packet pointer (decision-record.md ADR-001)
- [x] T005 Decide the hook change and its order (decision-record.md ADR-002)
- [x] T006 Decide the stamper rules and cherry-pick policy (decision-record.md ADR-003)
- [x] T007 Decide the mapping refinements and the repo-rule verdict (decision-record.md ADR-004, ADR-005)
<!-- /ANCHOR:phase-2 -->
...
- [x] T008 Ask the operator the two preference forks and bundle the rest (chat)
- [x] T009 Record the answers and set every status to Accepted (decision-record.md)
- [x] T010 Validate the phase under strict (implementation-summary.md)
<!-- /ANCHOR:phase-3 -->
...
|----------|------|--------|------|
| Operator | Technical Lead | [x] Approved | 2026-09-11 |

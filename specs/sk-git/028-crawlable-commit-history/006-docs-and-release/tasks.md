---
title: "Tasks: Phase 6: docs-and-release"
...
# Tasks: Phase 6: docs-and-release
...
- [x] T001 Read the changelog shape, the README layout and the metadata contract
- [x] T002 Write the README-and-changelog brief and the rule-and-AGENTS brief (scratch/briefs)
- [x] T003 [P] Confirm CLAUDE.md is a symlink to AGENTS.md so one file carries the row
<!-- /ANCHOR:phase-1 -->
...
- [x] T004 README, changelog v1.6.0.0 and version fields (.opencode/skills/sk-git)
- [x] T005 Advisor vocabulary and regenerated manifests (.opencode/skills/sk-git/graph-metadata.json)
- [x] T006 Freeze paragraph in the delegation rule and the Commit identity row (repo-rules, AGENTS.md)
- [x] T007 Parent map and goal log updated (../spec.md, ../goal.md)
<!-- /ANCHOR:phase-2 -->

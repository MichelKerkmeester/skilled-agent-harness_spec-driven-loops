...
- `commit-id-naming.sh` shows the ownerless-lock grace reclaim (lines 120-133), consistent with the landed run-failure adjustment `debfaf217d`. Read only, no lock was taken.

...
- [x] CHK-061 [P1] Packet lives under the `sk-git` track as `012-readme-enrichment-and-hyphen-naming`. Evidence: `.opencode/specs/sk-git/012-readme-enrichment-and-hyphen-naming/`.
<!-- /ANCHOR:file-org -->

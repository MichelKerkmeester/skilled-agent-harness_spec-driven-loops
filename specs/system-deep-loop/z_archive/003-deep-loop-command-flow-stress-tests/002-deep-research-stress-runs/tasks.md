---
title: "Tasks: deep-research Stress Runs (002)"
...
_memory:
  continuity:
    ...
    answered_questions: []
---
# Tasks: deep-research Stress Runs (002)
...
### T-003: Extract bash blocks from each CP
### T-004: Run R1 stress sequentially; record verdicts
### T-005: Triage 5-bucket; identify gap fixes for R2
### T-006: Apply R2 targeted edits
### T-007: Rerun R2; record verdicts
### T-008: R3 if needed; final composite check
...
### T-009: Author test-report.md mirroring 060/004 structure
### T-010: Mark sub-phase complete

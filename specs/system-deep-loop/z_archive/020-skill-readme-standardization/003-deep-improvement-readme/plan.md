---
title: "Implementation Plan: deep-improvement README"
description: "Gather context with a two-iteration deep-context sweep, dual-draft with DeepSeek and MiMo, verify paths, then merge the narrative README."
trigger_phrases:
...
_memory:
  continuity:
    packet_pointer: "system-deep-loop/z_archive/020-skill-readme-standardization/003-deep-improvement-readme"
...
# Implementation Plan: deep-improvement README
...
Gather then draft then merge. Read-only seats gather, the host verifies paths and writes the final file.
...
| Accuracy | Lanes, dimensions, paths | Host SKILL.md and tree |
<!-- /ANCHOR:testing -->

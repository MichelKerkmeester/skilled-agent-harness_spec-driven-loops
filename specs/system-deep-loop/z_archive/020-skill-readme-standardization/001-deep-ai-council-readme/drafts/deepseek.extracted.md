...
/deep:ask-ai-council:auto

# Operator gates for setup, loop, synthesis and save
/deep:ask-ai-council:confirm
```
...
```bash
node .opencode/skills/deep-ai-council/scripts/persist-artifacts.cjs specs/042-pipeline \
...
```bash
node .opencode/skills/deep-ai-council/scripts/advise-council-completion.cjs specs/042-pipeline
```

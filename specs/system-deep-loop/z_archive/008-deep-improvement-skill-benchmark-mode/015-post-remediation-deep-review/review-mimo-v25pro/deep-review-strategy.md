...
## Known Context
Full suite green (358/0) + drift 4/4 at review start; the remediation claims behavior-preserving. Reviewer = MiMo-v2.5-pro (smaller model; format/lean profile — expect strong structural/consistency findings).
...
### Technical Context
The research consumes the live benchmark evidence (`sk-code/benchmark/reports/2026-06-01--live-final--live/`) and the documented surface-flattening tradeoff in `smart_routing.md` §11. It dispatched native `@deep-research` (Opus) iterations and externalized state under `research/`.
...
The live benchmark baseline (`sk-code/benchmark/reports/2026-06-01--live-final--live/`) and the §11 router doc.
<!-- /ANCHOR:dependencies -->

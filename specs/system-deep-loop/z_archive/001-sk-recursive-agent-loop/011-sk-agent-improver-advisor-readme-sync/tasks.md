---
title: "Tasks: Phase [system-deep-loop/z_archive/001-sk-recursive-agent-loop/011-sk-agent-improver-advisor-readme-sync/tasks]"
...
- [x] T010: Test "/deep:start-agent-improvement-loop" → sk-improve-agent >= 0.8
- [x] T011: Test "/prompt" → sk-improve-prompt >= 0.8

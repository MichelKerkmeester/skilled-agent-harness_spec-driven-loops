...
2. **READ THE TARGET AND ITS INTEGRATION SURFACE** -> Read the canonical source file, the active target profile, fixture expectations, and the integration scan report to understand how the agent connects across the system.
...
│  ├─► 2. Read target and profile context                                  │

...
- [x] T008 Re-confirm the shipped trio against `030` section 14 candidate 12 (`ba632c340c`) and current source: `compareByContentThenId` at the three merge sorts, `buildPoolGauges` lag/pending/failed, empty-tick=convergence + `stopped` flush.

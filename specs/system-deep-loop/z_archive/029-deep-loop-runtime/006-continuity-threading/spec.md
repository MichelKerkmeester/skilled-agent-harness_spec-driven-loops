...
- **Shipped record (Wave-0)**: Wave-0 record, neither candidate present (Deep-Loop entry is, commit `ba632c340c`, merge/gauges/graceful-self-stop only).

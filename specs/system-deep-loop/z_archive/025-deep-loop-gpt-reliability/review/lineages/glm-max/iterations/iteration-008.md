...
|----------|--------|------|----------|-------|
| spec_code | pass | hard | 008/implementation-summary.md:50-58,108-109 | Mode-D fix (7 surviving files) and ai-council route-identity correction verified sound; impl-summary's "zero remaining self-classification prose across 7 surviving command files" PASS and "zero remaining mode: council" PASS are consistent with the documented scope. prompt.md is the one out-of-scope residual (F013). |
...
## Ruled Out
- Mode-D fix incompleteness (in-scope files): ruled out — all 7 surviving declared command files were migrated from the self-classification gate to the evidence-based check; phase 008 verification grep confirms zero residual in-scope. (iteration 8, evidence: 008/implementation-summary.md:108)

...
- `.opencode/commands/deep/{context,ai-council,skill-benchmark,agent-improvement,model-benchmark}.md` (grep for `GENERAL AGENT REQUIRED` occurrence — confirmed present in the seven surviving command files; skill-benchmark + agent-improvement + model-benchmark are the improvement-family modes both prior lineages deferred)

...
```json
{
  ...
  "counterevidenceSought": "git blame on playbook.md:362 to determine provenance (authored 2026-05-30 by 123ef15261b, i.e. PRE-EXISTING, not the remediation commit 8ac65c61b8). Grepped all cli-opencode living docs for 'ai-council.*primary' — line 362 is the SOLE residual 'primary' classification; SKILL.md:31 and README.md now correctly omit ai-council from primaries. Checked spec.md Out-of-Scope: it excludes 'the pre-existing deep-ai-council naming mismatch (@deep-ai-council playbook expectation vs. registry's ai-council)' — a NAMING issue, distinct from this PRIMARY-vs-SUBAGENT classification issue.",

...
- `deep-loop-runtime/feature_catalog/validation/mk-deep-loop-guard.md` and its matching playbook entry already document the current plugin name/env-var/log-prefix correctly.

...
_memory:
  continuity:
    packet_pointer: "system-deep-loop/z_archive/006-deep-skill-evolution/003-deep-review"
...
This cluster groups 8 sub-phases that share a single thematic focus. Before restructuring, these existed as flat siblings at the root of `116-deep-skill-evolution/`. Nesting them under this thematic phase parent reduces root-level fan-out and makes the cluster's internal arc easier to follow.
...
- Use `/speckit:resume skilled-agent-orchestration/116-deep-skill-evolution/002-deep-review/[NNN-phase]/` to resume a specific phase

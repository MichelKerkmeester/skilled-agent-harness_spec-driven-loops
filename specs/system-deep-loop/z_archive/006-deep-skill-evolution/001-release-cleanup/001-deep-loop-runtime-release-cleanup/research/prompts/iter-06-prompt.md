...
|----------|---------------|---------|--------|
| `116-deep-skill-evolution/spec.md` | SKILL.md:261 | OK | PASS |
...
- **Resolve**: confirm the equivalent ADR exists at `116-deep-skill-evolution/001-ai-council/008-iterative-research-and-architecture/decision-record.md` ADR-001 "Runtime Boundary Decision" (verify by reading L40-50 of that file).
...
|------|-----------|---------------|-----------|------------------|
| 1 | SKILL.md:144 | "Packet 129/001 ADR-001 extends..." | NO | replace with `116-deep-skill-evolution/001-ai-council/008-iterative-research-and-architecture/decision-record.md ADR-001` |
| 2 | README.md:198 | ... | NO | ... |
| 3 | README.md:247 | ... | NO | ... |
| 4 | README.md:417 | ... | NO | ... |

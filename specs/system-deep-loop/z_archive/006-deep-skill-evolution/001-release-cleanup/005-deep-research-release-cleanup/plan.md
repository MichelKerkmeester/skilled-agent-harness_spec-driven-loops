...
2. For spec-folder abandonment: `rm -rf .opencode/specs/skilled-agent-orchestration/116-deep-skill-evolution/000-release-cleanup/002-deep-research/` + remove `children_ids` entry from parent `graph-metadata.json` + re-run `skill_graph_compiler.py`.

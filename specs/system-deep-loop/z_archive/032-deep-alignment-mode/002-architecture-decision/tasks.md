...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-deep-loop/032-deep-alignment-mode/002-architecture-decision/spec.md"
      - ".opencode/specs/system-deep-loop/032-deep-alignment-mode/002-architecture-decision/decision-record.md"
    session_dedup:

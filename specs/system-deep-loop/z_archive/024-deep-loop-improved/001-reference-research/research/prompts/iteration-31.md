...
Segment: 4 (map -> workflows + speckit) | Iteration: 31 of 58
Questions: 0/49 checked | Last focus: S4-07
Last 2 ratios: 0.36 -> 0.43 | Stuck count: 0
...
Focus Area: [S4-06] How should the ideas backlog adopt kasper's observation-threshold + rejected-cache so a deferred idea auto-promotes after N corroborations and a ruled-out idea is never re-promoted? (build on S2-03, S2-05) -> research-ideas backlog
...
Last 3 Iterations Summary: run 28: S4-04 (ratio 0.62); run 29: S4-05 (ratio 0.36); run 30: S4-07 (ratio 0.43)
...
- Write iteration narrative to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-031.md
- Write per-iteration delta file to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-031.jsonl
...
1. Iteration narrative markdown at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-031.md` with headings: Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus. In Findings give: reference mechanism + file:line; exact OUR target file; port-difficulty (easy/med/hard); quick-win vs deep-rewrite tag.

2. Per-iteration delta file at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-031.jsonl`. Its FIRST line MUST be the canonical iteration record, EXACT type "iteration":
`{"type":"iteration","iteration":31,"newInfoRatio":<0..1>,"status":"<complete|insight|stuck>","focus":"S4-06","graphEvents":[...]}`
...
3. Do NOT append to the shared state log (`.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deep-research-state.jsonl`). The orchestrator merges your iteration record from the delta file — appending there yourself corrupts the log when iterations run in parallel.

...
Segment: 2 (mine kasper) | Iteration: 16 of 58
Questions: 0/24 checked | Last focus: S2-07
Last 2 ratios: 0.76 -> 0.78 | Stuck count: 0
...
Focus Area: [S2-08] How does kasper reconcile concurrent writers with read-merge-write (`mergeExternalState` set-union) so two processes don't clobber each other? -> deep-loop-runtime/lib/deep-loop/jsonl-repair.ts
...
Last 3 Iterations Summary: run 13: S2-05 (ratio 0.79); run 14: S2-06 (ratio 0.76); run 15: S2-07 (ratio 0.78)
...
- Write iteration narrative to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-016.md
- Write per-iteration delta file to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-016.jsonl
...
1. Iteration narrative markdown at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-016.md` with headings: Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus. In Findings give: reference mechanism + file:line; exact OUR target file; port-difficulty (easy/med/hard); quick-win vs deep-rewrite tag.

2. Canonical JSONL record APPENDED to the State Log, EXACT type "iteration":
`{"type":"iteration","iteration":16,"newInfoRatio":<0..1>,"status":"<complete|insight|stuck>","focus":"S2-08","graphEvents":[...]}`
...
3. Per-iteration delta file at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-016.jsonl`: the same iteration record plus one record per finding/observation/graphEvent, each on its own line.

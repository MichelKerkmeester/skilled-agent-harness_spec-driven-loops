...
Segment: 5 (cross-cutting) | Iteration: 34 of 58
Questions: 0/61 checked | Last focus: S4-09
Last 2 ratios: 0.58 -> 0.69 | Stuck count: 0
...
Focus Area: [S5-01] Should the dashboard adopt kasper's ASCII sparkline trend (`renderSparkline`) and in-progress banner (`summarizeValidationInProgress`) so newInfoRatio/score history + "iteration N running for Ts" render in-terminal? -> deep_research_dashboard.md
...
Last 3 Iterations Summary: run 31: S4-06 (ratio 0.47); run 32: S4-08 (ratio 0.58); run 33: S4-09 (ratio 0.69)
...
- Write iteration narrative to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-034.md
- Write per-iteration delta file to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-034.jsonl
...
1. Iteration narrative markdown at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-034.md` with headings: Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus. In Findings give: reference mechanism + file:line; exact OUR target file; port-difficulty (easy/med/hard); quick-win vs deep-rewrite tag.

2. Per-iteration delta file at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-034.jsonl`. Its FIRST line MUST be the canonical iteration record, EXACT type "iteration":
`{"type":"iteration","iteration":34,"newInfoRatio":<0..1>,"status":"<complete|insight|stuck>","focus":"S5-01","graphEvents":[...]}`

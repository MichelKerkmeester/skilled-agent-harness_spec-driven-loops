...
Segment: 2 (mine kasper) | Iteration: 15 of 58
Questions: 0/24 checked | Last focus: S2-06
Last 2 ratios: 0.79 -> 0.76 | Stuck count: 0
...
Focus Area: [S2-07] How does kasper's `KasperStateStore` implement debounced flush (`markDirty` → 2s) with version dirty-again detection (`capturedVersion !== version` ⇒ re-flush)? -> deep-loop-runtime/lib/deep-loop/atomic-state.ts
...
Last 3 Iterations Summary: run 12: S2-04 (ratio 0.81); run 13: S2-05 (ratio 0.79); run 14: S2-06 (ratio 0.76)
...
- Write iteration narrative to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-015.md
- Write per-iteration delta file to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-015.jsonl
...
1. Iteration narrative markdown at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-015.md` with headings: Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus. In Findings give: reference mechanism + file:line; exact OUR target file; port-difficulty (easy/med/hard); quick-win vs deep-rewrite tag.

2. Canonical JSONL record APPENDED to the State Log, EXACT type "iteration":
`{"type":"iteration","iteration":15,"newInfoRatio":<0..1>,"status":"<complete|insight|stuck>","focus":"S2-07","graphEvents":[...]}`
...
3. Per-iteration delta file at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-015.jsonl`: the same iteration record plus one record per finding/observation/graphEvent, each on its own line.

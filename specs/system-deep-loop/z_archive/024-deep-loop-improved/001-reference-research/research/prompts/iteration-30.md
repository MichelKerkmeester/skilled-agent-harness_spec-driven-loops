...
Segment: 4 (map -> workflows + speckit) | Iteration: 30 of 58
...
Focus Area: [S4-07] Could we add a loop-cli-style force-trigger "run now" sentinel (`research/.deep-research-run-now`) alongside the pause sentinel? (build on S1-03) -> deep_research_auto.yaml (step_check_pause_sentinel)
...
- Write iteration narrative to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-030.md
- Write per-iteration delta file to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-030.jsonl
...
1. Iteration narrative markdown at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-030.md` with headings: Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus. In Findings give: reference mechanism + file:line; exact OUR target file; port-difficulty (easy/med/hard); quick-win vs deep-rewrite tag.

2. Per-iteration delta file at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-030.jsonl`. Its FIRST line MUST be the canonical iteration record, EXACT type "iteration":
`{"type":"iteration","iteration":30,"newInfoRatio":<0..1>,"status":"<complete|insight|stuck>","focus":"S4-07","graphEvents":[...]}`

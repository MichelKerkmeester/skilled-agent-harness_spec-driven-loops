...
Segment: 3 (map -> deep-loop-runtime) | Iteration: 22 of 58
Questions: 0/36 checked | Last focus: S3-05
Last 2 ratios: 0.52 -> 0.46 | Stuck count: 0
...
Focus Area: [S3-06] Our convergence measures novelty but never improvement-effect — should `convergence.cjs` add a kasper-style score-delta signal comparing this iteration's composite score to the prior snapshot to detect "looping without getting better"? (build on S2-01) -> convergence.cjs
...
Last 3 Iterations Summary: run 19: S3-03 (ratio 0.62); run 20: S3-04 (ratio 0.52); run 21: S3-05 (ratio 0.46)
...
- Write iteration narrative to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-022.md
- Write per-iteration delta file to: .opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-022.jsonl
...
1. Iteration narrative markdown at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/iterations/iteration-022.md` with headings: Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus. In Findings give: reference mechanism + file:line; exact OUR target file; port-difficulty (easy/med/hard); quick-win vs deep-rewrite tag.

2. Canonical JSONL record APPENDED to the State Log, EXACT type "iteration":
`{"type":"iteration","iteration":22,"newInfoRatio":<0..1>,"status":"<complete|insight|stuck>","focus":"S3-06","graphEvents":[...]}`
...
3. Per-iteration delta file at `.opencode/specs/deep-loops/030-agent-loops-improved/001-reference-research/research/deltas/iter-022.jsonl`: the same iteration record plus one record per finding/observation/graphEvent, each on its own line.

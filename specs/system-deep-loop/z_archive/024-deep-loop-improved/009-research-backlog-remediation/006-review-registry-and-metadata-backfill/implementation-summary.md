...
| `.opencode/skills/system-deep-loop/024-deep-loop-improved/008-loop-systems-remediation/graph-metadata.json`, root `graph-metadata.json`, root `description.json` | Regenerated | Real `key_files`; non-truncated description |
<!-- /ANCHOR:what-built -->

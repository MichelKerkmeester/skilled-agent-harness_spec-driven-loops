...
- Fix every LIVE hit to reference the current packet path (`system-deep-loop/024-deep-loop-improved`).
...
|-----------|-------------|-------------|
| `024-deep-loop-improved/{001,002,003,004,005,006,007}/spec.md` (LIVE hits only) | Modify | Fix navigational field references to the old packet name |

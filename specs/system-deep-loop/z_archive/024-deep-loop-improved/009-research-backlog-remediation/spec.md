...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/system-deep-loop/024-deep-loop-improved/research/research.md"
    session_dedup:
...
| `024-deep-loop-improved/**/spec.md`, `graph-metadata.json`, `description.json` | Modify | 004-007 | Phase-doc-map sync, completion_pct backfill, packet-identity cleanup, registry disposition, metadata backfill, scaffold authoring |
...
- **Source backlog**: `../research/research.md` (§4 Combined Findings, §5 Prioritized Remediation Backlog, §6 Meta-Findings)

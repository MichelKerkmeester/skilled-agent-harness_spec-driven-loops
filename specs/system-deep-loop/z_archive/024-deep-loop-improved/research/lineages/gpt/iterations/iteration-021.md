...
- Current playbook now requires the exact exit-0/no-artifact invariant and names the assertion that must remain present. [SOURCE: .opencode/skills/deep-loop-runtime/manual_testing_playbook/fanout/fanout-salvage-recovery.md:86] [SOURCE: .opencode/skills/deep-loop-runtime/manual_testing_playbook/fanout/fanout-salvage-recovery.md:97]

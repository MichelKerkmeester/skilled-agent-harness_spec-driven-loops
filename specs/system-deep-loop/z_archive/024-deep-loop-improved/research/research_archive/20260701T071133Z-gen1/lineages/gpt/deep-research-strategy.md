...
Find upgrade, fix, and expansion recommendations to perfect the `deep-loops/030-deep-loop-improved` packet across all 8 phases and its own review tooling, including fan-out, salvage, merge, convergence math, deep-review, and deep-research lineage behavior.

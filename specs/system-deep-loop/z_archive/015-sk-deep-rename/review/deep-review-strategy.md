...
`specs/skilled-agent-orchestration/z_archive/056-sk-deep-rename/` — 6-phase skill rename audit.
...
- Target: `specs/skilled-agent-orchestration/z_archive/056-sk-deep-rename`
- Mode: review
- maxIterations: 5

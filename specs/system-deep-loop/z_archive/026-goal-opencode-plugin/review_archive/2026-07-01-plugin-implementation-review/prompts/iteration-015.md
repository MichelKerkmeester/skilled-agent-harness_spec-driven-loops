...
Review Scope Files: .opencode/skills/system-spec-kit/references/hooks/goal_plugin.md, .opencode/plugins/mk-goal.js, .opencode/plugins/tests/mk-goal-*.test.cjs, current live .opencode/commands/*goal* file (verify name fresh) -- EXCLUDED: 032-goal-opencode-plugin/009-speckit-command-goal-prompt-offer/**

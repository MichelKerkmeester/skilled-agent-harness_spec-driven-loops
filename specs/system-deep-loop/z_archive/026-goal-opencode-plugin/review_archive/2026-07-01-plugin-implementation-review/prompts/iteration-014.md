...
Review Scope Files: .opencode/plugins/mk-goal.js, current live .opencode/commands/*goal* file (verify name fresh), .opencode/skills/system-skill-advisor/feature_catalog/hooks-and-plugin/goal-opencode-plugin.md, .opencode/skills/system-spec-kit/feature_catalog/ux-hooks/goal-opencode-plugin.md, .opencode/skills/system-skill-advisor/manual_testing_playbook/cli-hooks-and-plugin/goal-opencode-plugin.md, .opencode/skills/system-spec-kit/manual_testing_playbook/ux-hooks/goal-opencode-plugin.md, 032-goal-opencode-plugin/{003,007}/{spec,plan,tasks,implementation-summary}.md -- EXCLUDED: 032-goal-opencode-plugin/009-speckit-command-goal-prompt-offer/**

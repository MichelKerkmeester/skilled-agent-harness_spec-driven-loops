...
Review Scope Files: .opencode/plugins/mk-goal.js (current live version, re-read fresh), .opencode/plugins/tests/mk-goal-*.test.cjs -- EXCLUDED: 032-goal-opencode-plugin/009-speckit-command-goal-prompt-offer/**
Prior Findings: P0=0 P1=12 P2=4

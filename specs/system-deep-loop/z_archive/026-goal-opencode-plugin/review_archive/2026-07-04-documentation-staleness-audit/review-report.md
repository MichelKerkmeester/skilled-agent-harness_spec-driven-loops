...
```json Planning Packet
{
  ...
  "affectedSurfacesSeed": [
    ...
    ".opencode/specs/deep-loops/026-goal-opencode-plugin/009-speckit-command-goal-prompt-offer/handover.md",
    ".opencode/specs/deep-loops/026-goal-opencode-plugin/011-command-surface-normalization/tasks.md",
...
**STATUS=OK PATH=.opencode/specs/deep-loops/026-goal-opencode-plugin**

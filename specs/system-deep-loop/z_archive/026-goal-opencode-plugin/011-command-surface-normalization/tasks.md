...
<!-- agent: direct | deps: [T001] | touched-files: [] -->
- [x] T003 Check phase 009's own scope/handover for any naming convention it has already established, to avoid a fourth rename (026-goal-opencode-plugin/009-speckit-command-goal-prompt-offer/)
<!-- /ANCHOR:phase-1 -->
...
<!-- agent: direct | deps: [T004] | touched-files: ["026-goal-opencode-plugin/003-goal-command/spec.md", "026-goal-opencode-plugin/003-goal-command/plan.md", "026-goal-opencode-plugin/003-goal-command/tasks.md", "026-goal-opencode-plugin/003-goal-command/implementation-summary.md"] -->
- [x] T005 [P] Update all filename references in phase 003's docs (026-goal-opencode-plugin/003-goal-command/*.md)
<!-- agent: direct | deps: [T004] | touched-files: ["026-goal-opencode-plugin/007-sk-prompt-goal-enhancement/tasks.md"] -->
- [x] T006 [P] [research F-009] Fix the stale `goal.md` cross-reference in phase 007's tasks.md (026-goal-opencode-plugin/007-sk-prompt-goal-enhancement/tasks.md)
<!-- agent: direct | deps: [T004] | touched-files: ["026-goal-opencode-plugin/008-system-spec-kit-integration/spec.md", "026-goal-opencode-plugin/008-system-spec-kit-integration/tasks.md"] -->
- [x] T007 [P] Update filename references in phase 008's docs (026-goal-opencode-plugin/008-system-spec-kit-integration/*.md)
<!-- agent: direct | deps: [T004] | touched-files: ["026-goal-opencode-plugin/004-lifecycle-tracking/graph-metadata.json"] -->
- [x] T008 [P] [DR-007-P2] Update the filename reference in phase 004's graph-metadata.json `key_files`, and strip any non-deliverable files from that same array while touching it (026-goal-opencode-plugin/004-lifecycle-tracking/graph-metadata.json)
...
<!-- agent: direct | deps: [T014, T016] | touched-files: ["026-goal-opencode-plugin/011-command-surface-normalization/implementation-summary.md"] -->

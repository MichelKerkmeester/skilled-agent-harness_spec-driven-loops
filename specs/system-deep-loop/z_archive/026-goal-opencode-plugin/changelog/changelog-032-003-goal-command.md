---
title: "Changelog: Phase 3: goal-command [032-goal-opencode-plugin/003-goal-command]"
...
> Spec folder: `.opencode/specs/deep-loops/032-goal-opencode-plugin/003-goal-command` (Level 1)

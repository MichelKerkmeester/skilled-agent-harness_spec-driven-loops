...
- **hasAdvisories:** true
- **Scope:** `.opencode/specs/deep-loops/026-goal-opencode-plugin` (spec-folder)
...
- **F008** (P1) — Phase 016 checklist overclaim is part of broader status-drift pattern  
  File: `.opencode/specs/deep-loops/026-goal-opencode-plugin/016-plugin-correctness-fixes/checklist.md:40` | Dimension: traceability | First seen: iteration 3 | Evidence: .opencode/specs/deep-loops/026-goal-opencode-plugin/016-plugin-correctness-fixes/checklist.md:40-90, .opencode/specs/deep-loops/026-goal-opencode-plugin/016-plugin-correctness-fixes/spec.md:52, .opencode/specs/deep-loops/026-goal-opencode-plugin/spec.md:186  
...
- **F001** (P2) — Command surface expanded beyond original spec verbs  
  File: `.opencode/commands/goal_opencode.md:3` | Dimension: correctness | First seen: iteration 1 | Evidence: .opencode/specs/deep-loops/026-goal-opencode-plugin/spec.md:89-92, .opencode/commands/goal_opencode.md:3,30-33  
...
- **F002** (P2) — 009-diagnostic-review folder remains undocumented  
  File: `.opencode/specs/deep-loops/026-goal-opencode-plugin/spec.md:166` | Dimension: traceability | First seen: iteration 1 | Evidence: .opencode/specs/deep-loops/026-goal-opencode-plugin/spec.md:166-193, .opencode/specs/deep-loops/026-goal-opencode-plugin/009-diagnostic-review/  
...
- **F017** (P2) — GOAL_ACTIONS includes later-phase verbs without provenance  
  File: `.opencode/plugins/mk-goal.js:156` | Dimension: maintainability | First seen: iteration 4 | Evidence: .opencode/plugins/mk-goal.js:156, .opencode/specs/deep-loops/026-goal-opencode-plugin/spec.md:89-92  
...
- **F025** (P2) — Phase 015 status inconsistent between spec and implementation summary  
  File: `.opencode/specs/deep-loops/026-goal-opencode-plugin/015-packet-hygiene-and-narrative-integrity/spec.md:52` | Dimension: traceability | First seen: iteration 7 | Evidence: .opencode/specs/deep-loops/026-goal-opencode-plugin/015-packet-hygiene-and-narrative-integrity/spec.md:52, .opencode/specs/deep-loops/026-goal-opencode-plugin/015-packet-hygiene-and-narrative-integrity/implementation-summary.md:35  
...
- **F026** (P2) — Parent phase map does not reflect phase 015 completion  
  File: `.opencode/specs/deep-loops/026-goal-opencode-plugin/spec.md:186` | Dimension: traceability | First seen: iteration 7 | Evidence: .opencode/specs/deep-loops/026-goal-opencode-plugin/spec.md:186, .opencode/specs/deep-loops/026-goal-opencode-plugin/015-packet-hygiene-and-narrative-integrity/implementation-summary.md:35  
...
- F008: Phase 016 checklist overclaim is part of broader status-drift pattern (.opencode/specs/deep-loops/026-goal-opencode-plugin/016-plugin-correctness-fixes/checklist.md:40)
...
- F002: 009-diagnostic-review folder remains undocumented (.opencode/specs/deep-loops/026-goal-opencode-plugin/spec.md:166)
...
- F025: Phase 015 status inconsistent between spec and implementation summary (.opencode/specs/deep-loops/026-goal-opencode-plugin/015-packet-hygiene-and-narrative-integrity/spec.md:52)
- F026: Parent phase map does not reflect phase 015 completion (.opencode/specs/deep-loops/026-goal-opencode-plugin/spec.md:186)

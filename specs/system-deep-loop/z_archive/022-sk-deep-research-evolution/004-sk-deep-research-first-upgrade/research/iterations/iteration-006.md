...
- Confirms Wave 1 findings: quality protection should sit on top of search rather than only at stop time; final synthesis deserves its own workflow stage; live branch history is not required to get multi-angle coverage. [SOURCE: .opencode/specs/03--commands-and-skills/029-sk-deep-research-first-upgrade/research/research/research.md:12-19] [SOURCE: .opencode/specs/03--commands-and-skills/029-sk-deep-research-first-upgrade/research/research/research.md:145-156]
...
- If we keep `@deep-research` LEAF-only, should the orchestrator create temporary shard briefs and aggregate shard findings into `research/research.md` after a merge pass?

...
4. **auto.yaml step_generate_dashboard** (line 308): Reads JSONL + strategy, uses the template, outputs to `{spec_folder}/research/deep-research-dashboard.md`. Note says "Auto-generated from JSONL + strategy. Never manually edited."

...
● Search (grep)
  ...
  │ late_guide.md} (.opencode/skills/system-spec-kit)
  └ 60 lines found

● Search (glob)
  │ ".opencode/skills/system-spec-kit/**/{SKILL.md,README.md,template_mapping.md,level_decision_matri
...
● Search (grep)
  │ "sign-off|sign-offs|sign off|signoffs" (.opencode/skills/system-spec-kit/SKILL.md)
  └ No matches found

● Search (grep)
  │ "sign-off|sign-offs|sign off|signoffs" (.opencode/skills/system-spec-kit/README.md)
  └ No matches found
...
● Search (grep)
  ...
  │ governance|formal approval" (.opencode/skills/system-spec-kit/assets/template_mapping.md)
  └ 8 lines found

● Search (grep)
  │ "approval workflow|approval tracking|stakeholder|stakeholders|compliance|enterprise
  │ governance|formal approval" (.opencode/skills/system-spec-kit/SKILL.md)
  └ 6 lines found

● Search (grep)
  │ "approval workflow|approval tracking|stakeholder|stakeholders|compliance|enterprise
  │ governance|formal approval" (.opencode/skills/system-spec-kit/README.md)
  └ 6 lines found

● Search (grep)
  │ "approval workflow|approval tracking|stakeholder|stakeholders|compliance|enterprise
  │ governance|formal approval" (.opencode/skills/system-spec-kit/assets/level_decision_matrix.md)
  └ 2 lines found
...
1. **F-048-001 — Stale “sign-off” wording still survives in Level 3+ checklist guidance**
   - **File:** `.opencode/skills/system-spec-kit/assets/template_mapping.md:235,466`; `.opencode/skills/system-spec-kit/references/templates/level_specifications.md:390,402`
...
1. **F-048-002 — `level_specifications.md` omits stakeholder tracking from its primary Level 3+ definition**
   - **File:** `.opencode/skills/system-spec-kit/references/templates/level_specifications.md:67,534`

...
● Search (glob)
  │ ".opencode/skills/sk-improve-agent/**/*.{cjs,js,ts,md,json,yaml,yml}"
  └ 72 files found

● Search (glob)
  │ ".opencode/skills/sk-deep-{review,research}/scripts/*.cjs"
  └ 4 files found
...
● Search (grep)
  │ "legalStop|stopReason" (.opencode/skills/sk-deep-research/scripts/reduce-state.cjs)
  └ 3 lines found

● Search (grep)
  │ "legalStop|stopReason" (.opencode/skills/sk-deep-review/scripts/reduce-state.cjs)
  └ 5 lines found
...
● Compare canonical and runtime agent files (shell)
  ...
  │ .opencode/agents/deep-review.md .claude/agents/deep-review.md; diff -q
  │ .opencode/agents/deep-review.md .gemini/agents/deep-review.md; diff -q
  │ .opencode/agents/deep-research.md .claude/agents/deep-research.md; diff -q
  │ .opencode/agents/deep-research.md .gemini/agents/deep-research.md; diff -q …
  └ 9 lines...
...
● Diff canonical vs Gemini deep-review (shell)
  ...
  │ .opencode/agents/deep-review.md .gemini/agents/deep-review.md | sed -n '1,220p'
  └ 220 lines...

● Diff canonical vs Claude deep-review (shell)
  │ cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && diff -u
  │ .opencode/agents/deep-review.md .claude/agents/deep-review.md | sed -n '1,220p'
  └ 170 lines...

● Diff canonical vs Gemini deep-research (shell)
  │ cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && diff -u
  │ .opencode/agents/deep-research.md .gemini/agents/deep-research.md | sed -n '1,220p'
  └ 220 lines...

● Diff canonical vs Claude deep-research (shell)
  │ cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && diff -u
  │ .opencode/agents/deep-research.md .claude/agents/deep-research.md | sed -n '1,220p'
  └ 77 lines...

● Diff canonical vs Gemini improve-agent (shell)
  │ cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && diff -u
  │ .opencode/agents/improve-agent.md .gemini/agents/improve-agent.md | sed -n '1,220p'
  └ 127 lines...

● Diff canonical vs Claude improve-agent (shell)
  │ cd /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public && diff -u
  │ .opencode/agents/improve-agent.md .claude/agents/improve-agent.md | sed -n '1,220p'
  └ 124 lines...
...
● Search (grep)
  │ "legalStop" in **/*.{md,cjs,json,yaml,yml} (.opencode/skills/sk-deep-research)
  └ 10 lines found
...
● Search (grep)
  │ "progressiveSynthesis" (.opencode/agents/deep-research.md)
  └ 3 lines found
...
1. **Finding ID:** F-041-001  
   ...
   **Evidence:** `.claude/agents/deep-review.md:141-214`; `.opencode/agents/deep-review.md:146-204`; `.opencode/skills/sk-deep-review/scripts/reduce-state.cjs:188-242`  
   **Recommendation:** Replace the Claude mirror’s Step 5/7 guidance with the canonical template and JSONL contract from `.opencode/agents/deep-review.md`, including `findingId` in claim-adjudication packets.
...
2. **Finding ID:** F-041-002  
   ...
   **Evidence:** `.gemini/agents/deep-review.md:156-171`; `.gemini/agents/deep-review.md:179-180`; `.opencode/agents/deep-review.md:146-204`; `.opencode/skills/sk-deep-review/scripts/reduce-state.cjs:188-242`  
   **Recommendation:** Mirror the canonical `.opencode/agents/deep-review.md` Step 5/7 content verbatim into the Gemini runtime definition.
...
5. **Finding ID:** F-041-005  
   ...
   **Evidence:** `.claude/agents/deep-research.md:61-74`; `.opencode/agents/deep-research.md:66-80`; `.opencode/agents/deep-research.md:206-213`; `.opencode/skills/sk-deep-research/assets/deep_research_config.json:9-25`  
   **Recommendation:** Restore config to the Step 1 required reads and sync the mirror to the canonical `.opencode/agents/deep-research.md` wording.
...
6. **Finding ID:** F-041-006  
   ...
   **Evidence:** `.gemini/agents/deep-research.md:67-80`; `.opencode/agents/deep-research.md:66-80`; `.opencode/skills/sk-deep-research/assets/deep_research_config.json:14-25`  
...
7. **Finding ID:** F-041-007  
   ...
   **Evidence:** `.claude/agents/improve-agent.md:141-166`; `.opencode/agents/improve-agent.md:151-177`  
...
8. **Finding ID:** F-041-008  
   ...
   **Evidence:** `.gemini/agents/improve-agent.md:9-14`; `.gemini/agents/improve-agent.md:52-58`; `.opencode/skills/sk-improve-agent/scripts/scan-integration.cjs:1-21`; `.opencode/skills/sk-improve-agent/scripts/generate-profile.cjs:1-18`  
...
3. Reconcile deep-research/improve-agent runtime mirrors against their canonical `.opencode/agents/*.md` sources to eliminate the remaining stale/phantom references.

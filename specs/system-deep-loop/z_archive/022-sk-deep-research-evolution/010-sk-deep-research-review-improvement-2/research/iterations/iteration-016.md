...
- The query surface only partially exposes session isolation. `handleCoverageGraphQuery()` accepts `sessionId` and passes it into `ns`, but the inspected helper queries for coverage gaps, contradictions, and unverified claims read by `spec_folder` and `loop_type` only, ignoring `ns.sessionId`; this means research/review sessions can be co-mingled on read even though improvement-mode entries are blocked from the DB entirely (`.opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/query.ts:28-35`, `.opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/query.ts:55-58`, `.opencode/skills/system-spec-kit/mcp_server/lib/coverage-graph/coverage-graph-query.ts:63-126`, `.opencode/skills/system-spec-kit/mcp_server/lib/coverage-graph/coverage-graph-query.ts:136-147`, `.opencode/skills/system-spec-kit/mcp_server/lib/coverage-graph/coverage-graph-query.ts:238-277`).
...
- `.opencode/skills/sk-improve-agent/scripts/mutation-coverage.cjs:21-205`
- `.opencode/skills/sk-improve-agent/SKILL.md:298-300`
- `.opencode/commands/deep/assets/improve_agent-improver_auto.yaml:149-155`
- `.opencode/skills/system-spec-kit/mcp_server/lib/coverage-graph/coverage-graph-db.ts:17-18`
- `.opencode/skills/system-spec-kit/mcp_server/lib/coverage-graph/coverage-graph-db.ts:152-157`
- `.opencode/skills/system-spec-kit/mcp_server/lib/coverage-graph/coverage-graph-db.ts:511-545`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/upsert.ts:51-53`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/upsert.ts:72-80`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/query.ts:28-35`
- `.opencode/skills/system-spec-kit/mcp_server/handlers/coverage-graph/convergence.ts:47-52`
- `.opencode/skills/system-spec-kit/mcp_server/lib/coverage-graph/coverage-graph-query.ts:63-147`
- `.opencode/skills/system-spec-kit/mcp_server/lib/coverage-graph/coverage-graph-query.ts:238-277`
- `.opencode/skills/system-spec-kit/mcp_server/lib/coverage-graph/coverage-graph-signals.ts:163-220`

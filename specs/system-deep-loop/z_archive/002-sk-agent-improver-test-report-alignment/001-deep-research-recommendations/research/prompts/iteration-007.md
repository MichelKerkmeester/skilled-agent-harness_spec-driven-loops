...
`/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/skilled-agent-orchestration/060-sk-agent-improver-test-report-alignment/research/iterations/iteration-007.md`
...
4. Write your findings to `.opencode/specs/skilled-agent-orchestration/060-sk-agent-improver-test-report-alignment/research/iterations/iteration-007.md` using the EXACT structure below
5. Stop after writing — do not continue investigating beyond this iteration

## OUTPUT FORMAT (write to .opencode/specs/skilled-agent-orchestration/060-sk-agent-improver-test-report-alignment/research/iterations/iteration-007.md)
...
- Write only to `.opencode/specs/skilled-agent-orchestration/060-sk-agent-improver-test-report-alignment/research/iterations/iteration-007.md` (the absolute-from-repo-root path)

...
_memory:
  continuity:
    packet_pointer: "system-deep-loop/z_archive/002-sk-agent-improver-test-report-alignment/001-deep-research-recommendations"
...
6. Methodology source: `.opencode/specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/test-report.md` (570 lines, §9 lessons-learned)
<!-- /ANCHOR:context-quick-load -->

...
1. Use α-nDCG-style marginal gain to discount repeated coverage of the same semantic aspects. Each additional confirmation contributes \((1-\alpha)^n\), so re-affirmation approaches zero without being misclassified as new knowledge. [`ir_measures` implements `alpha_nDCG`](https://ir-measur.es/en/latest/measures.html); the [original SIGIR paper](https://cormack.uwaterloo.ca/novelty.pdf) explicitly separates novelty from diversity.

2. Estimate remaining unseen mass with Good’s coverage and Chao1. Treat versioned claim/source-topic clusters as “species”; singleton-heavy evidence implies substantial undiscovered territory. This produces the missing decision distinction: low marginal gain plus low unseen mass means STOP, while low marginal gain plus high unseen mass means PIVOT. [scikit-bio documents both estimators](https://scikit.bio/docs/latest/generated/skbio.diversity.alpha.chao1.html).

3. Select the pivot by marginal set coverage rather than asking the model for “something different.” Facility-location or set-cover gain from [submodlib](https://github.com/decile-team/submodlib) ranks candidate directions by how much uncovered semantic territory they represent. A k-DPP from [DPPy](https://github.com/guilgautier/DPPy) can similarly diversify simultaneous fan-out branches.

The caveat is structural: ecological estimators assume a reasonably stable population and sampling process, while agent search is adaptive. These should be replay-calibrated gauges—not literal probabilities—and coverage-cluster definitions must be versioned to prevent artificial novelty through topic splitting.

```json
{
  "new_repos": [
    {
      "name": "terrierteam/ir_measures",
      "url": "https://github.com/terrierteam/ir_measures",
      "stars": "~101",
      "what": "Unified IR evaluation library implementing alpha_nDCG, alpha_DCG, ERR_IA and other intent-aware measures; latest visible release v0.4.3 in November 2025.",
      "lesson": "Represent findings as ranked aspect-bearing evidence and exponentially discount repeated hits to already-covered aspects instead of self-scoring novelty holistically.",
      "maps_to": [
    ...
    {
      "name": "decile-team/submodlib",
      "url": "https://github.com/decile-team/submodlib",
      "stars": "~131",
      "what": "Submodular data-summarization library with facility-location, set-cover and explicit marginalGain operations; PyPI v0.0.3 provenance points to a May 2025 repository tag.",
      "lesson": "Score every prospective pivot by marginal coverage gain under the remaining budget; diminishing returns make re-affirming directions naturally lose priority.",
      "maps_to": [
        "runtime/dedup-novelty",
        "runtime/convergence",
        "runtime/budget-cost"
    ...
    },
    {
      ...
      "stars": "~1.2k",
      "what": "Active bioinformatics library implementing Good's coverage and Chao1 richness estimation; latest release v0.7.3 in June 2026.",
      "lesson": "Use singleton/doubleton semantic-cluster counts to estimate unseen topic mass, separating local exhaustion from global coverage.",
      "maps_to": [
        "runtime/convergence",
        "runtime/dedup-novelty",
    ...
    {
      "name": "guilgautier/DPPy",
      "url": "https://github.com/guilgautier/DPPy",
      "stars": "~240",
      "what": "Python toolbox for determinantal point-process sampling; the repository exposes 462 commits, but a current dated release or latest-commit year was not verifiable from the available page.",
      "lesson": "Select fan-out branches jointly with a quality-weighted k-DPP so the batch spans distinct evidence regions rather than producing correlated restatements.",
      "maps_to": [
  ...
  "insights": [
    {
      "insight": "Replace free-form newInfoRatio with claim-level redundancy-discounted gain: assign each evidence item to versioned aspects and compute gain using the alpha-nDCG factor (1-alpha)^prior_hits. Track corroboration separately as confidence gain, never as coverage gain.",
      "evidence": "https://ir-measur.es/en/latest/measures.html; https://cormack.uwaterloo.ca/novelty.pdf",
      "maps_to": [
        "runtime/dedup-novelty",
        "runtime/convergence",
        "deep-research"
    ...
    {
      "insight": "Make STOP versus PIVOT a two-dimensional policy: low marginal novelty plus low estimated unseen mass permits STOP; low marginal novelty plus high unseen mass forces a pivot; high marginal novelty continues the current lane.",
      "evidence": "https://scikit.bio/docs/latest/generated/skbio.diversity.alpha.chao1.html; https://scikit.bio/docs/dev/generated/skbio.diversity.alpha.goods_coverage.html",
      "maps_to": [
        "runtime/convergence",
        "runtime/dedup-novelty",
        "runtime/gauges-observability"
    ...
    {
      "insight": "Generate several pivot candidates, then choose the one with maximum quality-weighted submodular marginal gain against the accumulated coverage set. Log the winning gain and rejected candidates so pivot choice is replayable.",
      "evidence": "https://github.com/decile-team/submodlib; https://pypi.org/project/submodlib-py/",
      "maps_to": [
        "runtime/convergence",
        "runtime/dedup-novelty",
    ...
    {
      "insight": "For concurrent broadening, construct a similarity kernel over candidate branches and select a k-DPP batch; persist the kernel version, selected determinant or log-determinant, and candidate IDs to make diversity decisions reproducible.",
      "evidence": "https://github.com/guilgautier/DPPy; https://jmlr.org/papers/volume20/19-179/19-179.pdf",
      "maps_to": [
        "runtime/fan-out-fan-in",
        "runtime/dedup-novelty",
        "runtime/state-jsonl-checkpointing",
  ...
  "contradictions": [
    {
      "claim": "runtime/convergence can treat persistently low marginal novelty as evidence that research should stop.",
      "counter": "Low yield may only mean the current lane is exhausted; singleton-heavy topic or source-family counts can indicate substantial unseen mass and therefore require a pivot.",
      "evidence": "https://scikit.bio/docs/latest/generated/skbio.diversity.alpha.chao1.html; https://scikit.bio/docs/dev/generated/skbio.diversity.alpha.goods_coverage.html"
    },
    {
      "claim": "Maximizing semantic diversity necessarily broadens useful coverage.",
      "counter": "DPP and disparity objectives can favor irrelevant outliers, while set-cover objectives can reward shallow label coverage; relevance, evidence quality and source-authority constraints must remain hard gates.",
      "evidence": "https://github.com/guilgautier/DPPy; https://github.com/decile-team/submodlib"
    },
    {
      "claim": "A formal alpha-nDCG score makes novelty objective.",
      "counter": "Its result still depends on the aspect ontology and clustering version; splitting one aspect into several labels manufactures apparent novelty, so cluster lineage and sensitivity analysis are required.",
      "evidence": "https://ir-measur.es/en/latest/measures.html; https://cormack.uwaterloo.ca/novelty.pdf"
    }
  ],
  "next_angles": [
    "Calibrate Good-Turing and capture-recapture unseen-mass estimators under adaptive, non-IID agent search and correlated source families.",
    "Design a versioned semantic-aspect ontology with split/merge lineage so coverage cannot be inflated by clustering drift.",
    "Replay historical JSONL trajectories through the two-axis STOP/PIVOT policy and measure premature-stop, unnecessary-pivot and budget-regret deltas.",
    "Compare quality-weighted k-DPP, submodular facility location and farthest-first fan-out under family-correlated agent failures."
  ],
  "notes": "The repositories provide implementable metric primitives, but none validates an integrated STOP/PIVOT controller on long-running agent trajectories. DPPy recency could not be dated reliably. The largest unresolved coverage gap is statistical calibration when observations are adaptively selected, semantically clustered and correlated by model or source family."
}
```
...
session id: 019f62fa-ca0e-7f10-8b83-42dbb6f6de08
--------
user
You are iteration 29/45 of a NON-CONVERGING (deliberately BROADENING) research loop mapping the state of the art in LOOP ENGINEERING for agentic / iterative AI systems.
...
THIS ITERATION'S ANGLE: Novelty/coverage metrics that formally drive broadening
DIRECTIVE: Formal coverage/novelty scores usable as a stop/pivot signal; how to avoid re-affirmation. Map to runtime/dedup-novelty, runtime/convergence.
...
Repos already catalogued (136) — do NOT re-list these, find NEW ones or go deeper/adjacent:
...
codex
I’m treating this as read-only deep-research iteration work. I’ll route the search toward formal IR diversity/coverage, set coverage, and change-point signals, then exclude every repository already catalogued.
exec
/bin/zsh -lc "node .opencode/bin/spec-memory.cjs memory_match_triggers --json '{\"prompt\":\"Iteration 29/45 of a deliberately broadening deep-research loop: find new real repositories, papers, and authoritative documentation on formal novelty and coverage metrics that can drive pivot/stop signals and avoid re-affirmation; map findings to system-deep-loop runtime/dedup-novelty and runtime/convergence; read-only research with live web search.\"}' --format json --timeout-ms 3000" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
exec
/bin/zsh -lc "python3 .opencode/skills/system-skill-advisor/mcp_server/scripts/skill_advisor.py 'Iteration 29/45 of a deliberately broadening deep-research loop: find new real repositories, papers, and authoritative documentation on formal novelty and coverage metrics that can drive pivot/stop signals and avoid re-affirmation; map findings to system-deep-loop runtime/dedup-novelty and runtime/convergence; read-only research with live web search.' --threshold 0.8" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 2113ms:
2026-07-15 01:34:16.717 xcodebuild[64730:203076667]  DVTFilePathFSEvents: Failed to start fs event stream.
2026-07-15 01:34:16.865 xcodebuild[64730:203076666] [MT] DVTDeveloperPaths: Failed to get length of DARWIN_USER_CACHE_DIR from confstr(3), error = Error Domain=NSPOSIXErrorDomain Code=5 "Input/output error". Using NSCachesDirectory instead.
python3: warning: confstr() failed with code 5: couldn't get path of DARWIN_USER_TEMP_DIR; using /tmp instead
python3: error: couldn't create cache file '/tmp/xcrun_db-tr3jRWGk' (errno=Operation not permitted)
2026-07-15 01:34:17.223 xcodebuild[64733:203076687]  DVTFilePathFSEvents: Failed to start fs event stream.
2026-07-15 01:34:17.319 xcodebuild[64733:203076686] [MT] DVTDeveloperPaths: Failed to get length of DARWIN_USER_CACHE_DIR from confstr(3), error = Error Domain=NSPOSIXErrorDomain Code=5 "Input/output error". Using NSCachesDirectory instead.
...
[
  ...
  },
  {
    ...
    "uncertainty": 0.15,
    "passes_threshold": true,
    "reason": "Matched: !documentation, !documentation(keyword), !intent:documentation, create, documentation",
    "_graph_boost_count": 0,
    "source": "local"
  },
  {
    ...
    "uncertainty": 0.15,
    "passes_threshold": true,
    "reason": "Matched: !findings, !findings(signal), !intent:review, coverage~, implement [disambiguation: deep-research reserved for this prompt]",
    "_graph_boost_count": 0,
    "source": "local"
  },
  {
...
codex
Skill routing resolved to `system-deep-loop` in research mode (0.95 confidence); the memory trigger service is unavailable in this sandbox, so no prior memory was injected. I’m loading the loop’s research contract before searching because it fixes the iteration/state-machine rules.
exec
/bin/zsh -lc "sed -n '1,2400p' .opencode/skills/system-deep-loop/SKILL.md" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
---
...
exec
/bin/zsh -lc "sed -n '1,500p' .opencode/skills/system-deep-loop/mode-registry.json" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
{
  "skill": "system-deep-loop",
  "version": "2.0.0.0",
...
exec
/bin/zsh -lc "sed -n '1,3200p' .opencode/skills/system-deep-loop/deep-research/SKILL.md" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
---
name: deep-research
...
exec
/bin/zsh -lc "sed -n '1,2400p' '.opencode/skills/system-deep-loop/deep-research/references/guides/quick_reference.md'
sed -n '1,2400p' '.opencode/skills/system-deep-loop/deep-research/references/protocol/loop_protocol.md'
sed -n '1,2400p' '.opencode/skills/system-deep-loop/deep-research/references/state/state_outputs.md'
sed -n '1,2400p' '.opencode/skills/system-deep-loop/deep-research/references/convergence/convergence_signals.md'
sed -n '1,2400p' '.opencode/skills/system-deep-loop/deep-research/references/convergence/convergence.md'
sed -n '1,2400p' '.opencode/skills/system-deep-loop/deep-research/references/convergence/convergence_graph.md'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
---
...
exec
/bin/zsh -lc "sed -n '1,2400p' '.opencode/skills/system-deep-loop/deep-research/references/protocol/loop_protocol.md'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
---
title: Loop Protocol Reference
description: Canonical specification for the deep research loop lifecycle with 4 phases, reference-only wave orchestration, and error handling.
...
exec
/bin/zsh -lc "sed -n '1,2400p' '.opencode/skills/system-deep-loop/deep-research/references/state/state_outputs.md'" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
---
title: Deep Research Output Files Reference
description: Markdown output structures for strategy, iterations, dashboard, synthesis, and resource-map artifacts.
...
exec
/bin/zsh -lc 'wc -l .opencode/skills/system-deep-loop/deep-research/references/protocol/loop_protocol.md .opencode/skills/system-deep-loop/deep-research/references/state/state_outputs.md' in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
exec
/bin/zsh -lc "sed -n '250,430p' .opencode/skills/system-deep-loop/deep-research/references/protocol/loop_protocol.md" in /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public
 succeeded in 0ms:
...
codex
The local convergence model confirms the gap: `newInfoRatio` is agent-scored and question coverage is binary. I’m looking for metrics that add three missing quantities—redundancy-discounted gain, estimated unseen mass, and set-level diversity—so a low-yield lane pivots instead of merely re-confirming itself.
web search: 
web search: site:github.com terrierteam ir_measures alpha nDCG diversity metrics ...
web search: 
web search: decile-team submodlib GitHub stars latest commit facility location ...
web search: 
web search: https://api.github.com/repos/terrierteam/ir_measures
web search: 
web search: 'stars'
codex
The strongest transfer is a two-axis controller, not another single novelty score:

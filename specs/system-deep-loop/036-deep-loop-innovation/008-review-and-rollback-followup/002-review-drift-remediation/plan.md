...
- **`007-improvement-promotion-authority`** — `spec.md` and `implementation-summary.md` now both read "Complete (13/13 findings landed...)".
...
|------------|------|--------|--------------------|
| `001-runtime-code-review` traceability findings | Internal | Available under `review/` | Drift would not have been surfaced |

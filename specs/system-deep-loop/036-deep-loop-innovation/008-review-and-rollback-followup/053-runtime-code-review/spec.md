...
- Implementing fixes for any P0/P1 finding (deferred to operator-scoped remediation packets; see `055-rollback-candidate-hash-hardening` and `056-review-containment-exemption` for the two findings that were already scoped and fixed).

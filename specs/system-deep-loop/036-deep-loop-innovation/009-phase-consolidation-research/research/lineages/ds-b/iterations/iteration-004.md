...
- Parent-level docs: `handover.md`, `goal.md`, `goal-plan-review.md`, `cutover-execution-plan.md`, `dispositions.md`, `before-and-after.md`, `execution-sequencing-strategy.md`, `goal-prompt.md` — update child-slug references and child counts.

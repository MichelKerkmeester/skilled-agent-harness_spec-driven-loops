...
2. `spec.md` — rewrite the "PHASE MAP & OUTCOMES" table (spec.md:130-148), the "PHASE DOCUMENTATION MAP" table (spec.md:213-258), the intro paragraph referencing phases 001-017 (spec.md:121-128), and the sequencing invariants text (spec.md:150-160) which cites phase numbers. The `dispositions.md` disambiguation note (spec.md:209) must be preserved and re-pointed.

...
- Do NOT touch any path outside `009-phase-consolidation-research/research/lineages/ds-a`.
...
<!-- MACHINE-OWNED: END -->
## 12. KNOWN CONTEXT
- Spec host: `specs/system-deep-loop/036-deep-loop-innovation/009-phase-consolidation-research`
...
- Note: numbering has gaps (034, 036-046 absent); there is a `dispositions.md` file alongside 033 dir; later dirs 047-056 exist. 057 is the host.
...
- Write authority: ONLY `.../009-phase-consolidation-research/research/lineages/ds-a/`

...
### Definition of Ready
- [ ] `001-whole-system-gate` is green on its pre-integration SHA with receipts and exact candidate evidence
...
| `001-whole-system-gate` artifacts | Internal gate | Yellow | Final-SHA verification cannot be replayed until the phase-016 contract and receipts are available |

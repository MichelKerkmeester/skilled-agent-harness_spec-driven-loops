# Deep-review leaf — iteration 16 of 40 (security)
...
## Focus
Dispatch surface: env handling, sandbox/permission flags, prompt/path injection in fanout-run.cjs and executor configs

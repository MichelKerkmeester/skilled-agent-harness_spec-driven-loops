...
## Focus
Gate-setup advisories from the quarantined lineage: manifest exclusions (dist/, benchmark/reports) justified? 015-legacy-writer-retirement predecessor evidence status? validate.sh strict recursive state on this packet?

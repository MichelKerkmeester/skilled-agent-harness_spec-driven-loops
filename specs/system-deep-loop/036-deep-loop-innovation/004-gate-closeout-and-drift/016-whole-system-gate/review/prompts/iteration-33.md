# Deep-review leaf — iteration 33 of 40 (maintainability)
...
## Focus
deep-improvement sprawl: scripts/assets organization, dead code, orphaned assets
...
- F-032-01 [P1/maintainability] Malformed query bounds return success with incorrect data @ .opencode/skills/system-deep-loop/runtime/scripts/query.cjs

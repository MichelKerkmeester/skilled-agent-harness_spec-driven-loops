# Deep-review leaf — iteration 31 of 40 (maintainability)
...
## Focus
Duplication drift: the 8 per-mode durability families — divergence between clones that should be parallel
...
- F-030-03 [P1/traceability] Release rules accept a verdict forbidden by the execution policy @ .opencode/skills/system-deep-loop/deep-review/manual-testing-playbook/manual-testing-playbook.md
- F-030-02 [P1/traceability] Fourteen manual scenarios prescribe test commands with dead runtime paths @ .opencode/skills/system-deep-loop/runtime/manual-testing-playbook/coverage-graph/coverage-graph-fuzzy-merge.md
- F-030-01 [P1/traceability] Release coverage omits intra-routing recall scenarios @ .opencode/skills/system-deep-loop/deep-review/manual-testing-playbook/manual-testing-playbook.md
- F-029-03 [P1/traceability] Recursive strict validation follows an unfrozen live child set @ .opencode/skills/system-spec-kit/scripts/spec/validate.sh
- F-029-01 [P1/traceability] Review manifest mixes ignored local state with an incomplete tracked evidence set @ .opencode/specs/system-deep-loop/036-deep-loop-innovation/016-whole-system-gate/goal-file-manifest.txt
- F-028-04 [P1/traceability] Agent mirror validation ignores instruction ordering @ .opencode/skills/system-deep-loop/deep-improvement/scripts/lib/mirror-sync-verify.cjs
- F-028-03 [P1/traceability] AI-council persistence has no single executable writer authority @ .opencode/agents/ai-council.md
- F-028-02 [P1/traceability] Deep-review requires detect_changes in runtimes that do not expose it @ .claude/agents/deep-review.md

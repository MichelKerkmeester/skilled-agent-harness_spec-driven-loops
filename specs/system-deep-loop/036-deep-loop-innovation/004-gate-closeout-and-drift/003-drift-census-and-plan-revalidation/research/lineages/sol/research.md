...
Evidence: `.opencode/specs/system-deep-loop/z_archive/027-deep-loop-behavior-benchmarks/spec.md:71-77` and `.opencode/specs/system-deep-loop/036-deep-loop-innovation/001-whole-system-gate/spec.md:88-92,151-164`.

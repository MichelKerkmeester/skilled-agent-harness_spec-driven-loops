...
description: "Tasks for phase 016 of the 006 recommendations-implementation program: execute and verify the exact-SHA whole-system acceptance gate."
trigger_phrases:
  - "whole-system gate tasks"
  - "deep-loop phase 016 tasks"
...
- [ ] T001 Confirm predecessor `004-legacy-writer-retirement` has landed its zero-use, rollback, and archival-reader evidence on the candidate worktree; prerequisite currently unmet because phase 015 is Planned/unstarted with 0/29 checklist items checked
...
- [ ] T006 [P] Replay all phase-012 mixed-version fixture families through upcasters, projections, archival readers, resume, replay fingerprints, and terminal-state checks
- [ ] T007 [P] Inject crashes at effect claim, dispatch, receipt commit, checkpoint, resume, and recovery boundaries; verify phase-007 recovery, idempotency, fencing, receipt integrity, and salvage
- [ ] T008 [P] Run phase-007 blinded/counterfactual adjudication cases with order/identity perturbations and phase-011 degeneration/health cases for repetition, cycles, collapse, quality decay, and stopping behavior
- [ ] T009 Run full phase-008 semantic parity against phase-003 by stable scenario ID, including budget, receipt, terminal, replay, sealed-artifact, and archival-read assertions
...
- [ ] Every result is bound to one candidate SHA and the phase-003 BASE SHA

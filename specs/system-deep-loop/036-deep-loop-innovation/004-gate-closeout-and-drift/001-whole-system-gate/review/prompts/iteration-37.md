---
title: "Deep-review leaf — iteration 37 of 40 (maintainability)"
trigger_phrases: []
---
# Deep-review leaf — iteration 37 of 40 (maintainability)
...
## Focus
Error handling: fail-closed consistency, swallowed errors, catch-and-continue patterns
...
- F-036-04 [P1/maintainability] Leaf state records accept wrong-typed authoritative fields @ .opencode/skills/system-deep-loop/runtime/lib/deep-loop/leaf-artifact-writer.ts
- F-036-03 [P1/maintainability] Persisted pivot config is asserted as a closed shape after shallow checks @ .opencode/skills/system-deep-loop/runtime/lib/deep-loop/divergent-pivot.ts
- F-036-02 [P1/maintainability] Pivot events are cast after generic-only validation @ .opencode/skills/system-deep-loop/runtime/lib/deep-loop/divergent-pivot.ts
- F-036-01 [P1/maintainability] Run cache erases the pool-item generic @ .opencode/skills/system-deep-loop/runtime/lib/branch-leases-waves/durable-orchestrator.ts
- F-RES-06 [P1/correctness] Count-only progress advances the partition cursor without earning credit @ .opencode/skills/system-deep-loop/deep-alignment/scripts/partition-corpus.cjs

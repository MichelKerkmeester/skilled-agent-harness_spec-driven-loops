...
full whole-system gate remains gated on `004-legacy-writer-retirement`, unmet).
...
- **The original Stage A review** (this folder, `review/review-report.md`, 40 iterations,
  ...
  addressed by children **outside** the 026–033 set — `002-shadow-parity-independent-derivation`,
  `003-legacy-compat-event-vocabulary`, and `001-completion-evidence-reconcile` respectively —

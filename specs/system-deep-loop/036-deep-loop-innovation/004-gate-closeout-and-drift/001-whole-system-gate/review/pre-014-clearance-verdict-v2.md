...
`004-legacy-writer-retirement`. The remaining items are cutover-moment conditions and
...
1. **`004-legacy-writer-retirement` is unmet** (0/29, no implementation-summary). The Stage-B

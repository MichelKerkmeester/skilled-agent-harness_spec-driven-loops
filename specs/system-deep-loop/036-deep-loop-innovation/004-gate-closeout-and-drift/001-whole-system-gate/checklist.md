...
- [ ] CHK-001 [P0] `004-legacy-writer-retirement` has landed zero-use, rollback, and archival-reader evidence on the candidate worktree; prerequisite currently unmet because phase 015 is Planned/unstarted with 0/29 checklist items checked

...
parent: "system-deep-loop/036-deep-loop-innovation/001-whole-system-gate"
_memory:
  continuity:
    packet_pointer: "system-deep-loop/036-deep-loop-innovation/001-whole-system-gate"
...
### Definition of Ready
- [ ] `004-legacy-writer-retirement` has passed zero-use telemetry, rollback evidence, and archival-reader checks (currently unmet: Planned/unstarted, 0/29 checklist items checked)
...
### Phase 1: Setup
- Confirm `004-legacy-writer-retirement` evidence and the phase adjacency; that prerequisite is currently unmet because phase 015 is Planned/unstarted with 0/29 checklist items checked. Do not start from a moving checkout.

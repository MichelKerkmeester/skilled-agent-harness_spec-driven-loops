...
parent: "system-deep-loop/036-deep-loop-innovation/002-substrate-and-orchestration/004-compatibility-shadow-and-rollback-bridge"
_memory:
  continuity:
    packet_pointer: "system-deep-loop/036-deep-loop-innovation/002-substrate-and-orchestration/004-compatibility-shadow-and-rollback-bridge/005-rollback-drills"
...
> Phase adjacency under `004-compatibility-shadow-and-rollback-bridge` (navigation order, not a hard runtime dependency): predecessor `004-inflight-state-classification`; successor none (last sibling).
...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/036-deep-loop-innovation/002-substrate-and-orchestration/004-compatibility-shadow-and-rollback-bridge/005-rollback-drills |
| **Level** | 2 |
| **Priority** | P0 |
| **Status** | Complete |
| **Created** | 2026-07-15 |
...
The governing [transition, versioning, and rollback policy](../../../001-research-inputs-and-architecture/004-architecture-coverage-and-transition-contract/003-transition-versioning-and-rollback-policy/spec.md)
...
[receipts and effect-recovery contract](../../../002-substrate-and-orchestration/003-shared-evidence-and-control-services/001-receipts-and-effect-recovery/spec.md)
...
`../../../001-research-inputs-and-architecture/004-architecture-coverage-and-transition-contract/003-transition-versioning-and-rollback-policy/spec.md`,
`../003-shadow-parity-harness/spec.md`,
`../../../002-substrate-and-orchestration/003-shared-evidence-and-control-services/001-receipts-and-effect-recovery/spec.md`, and

...
> Phase adjacency under `004-compatibility-shadow-and-rollback-bridge` (navigation order, not a hard runtime dependency): predecessor `001-upcasters-and-dual-read-adapters`; successor `003-shadow-parity-harness`.
...
`002-transition-authorized-ledger-core/002-typed-append-only-ledger/spec.md`, `manifest/phase-tree.json`, and

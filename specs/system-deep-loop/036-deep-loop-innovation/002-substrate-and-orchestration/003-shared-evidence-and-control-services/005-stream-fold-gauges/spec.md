...
> Phase adjacency under `003-shared-evidence-and-control-services` (navigation order, not a hard runtime dependency): predecessor `004-hierarchical-typed-budgets`; successor `006-locks-and-fencing`.
...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/036-deep-loop-innovation/003-shared-evidence-and-control-services/005-stream-fold-gauges |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Complete |
| **Created** | 2026-07-15 |
...
`002-transition-authorized-ledger-core/002-typed-append-only-ledger/spec.md`. Each gauge has an immutable identity,

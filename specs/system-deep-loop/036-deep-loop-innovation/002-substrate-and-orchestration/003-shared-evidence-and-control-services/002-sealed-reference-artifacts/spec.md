...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/036-deep-loop-innovation/003-shared-evidence-and-control-services/002-sealed-reference-artifacts |
| **Level** | 2 |
| **Priority** | P0 |
| **Status** | Complete |
| **Created** | 2026-07-15 |
...
(`../../002-transition-authorized-ledger-core/003-replay-fingerprints/spec.md`). The parent program and phase

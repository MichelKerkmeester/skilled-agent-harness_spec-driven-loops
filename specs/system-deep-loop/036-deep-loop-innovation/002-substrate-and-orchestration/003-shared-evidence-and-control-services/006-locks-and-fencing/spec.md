...
> Phase adjacency under `003-shared-evidence-and-control-services` (navigation order, not a hard runtime dependency): predecessor `005-stream-fold-gauges`; successor `007-continuity-identities`.

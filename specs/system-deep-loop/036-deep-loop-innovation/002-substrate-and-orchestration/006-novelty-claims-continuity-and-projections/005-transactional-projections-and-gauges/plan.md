...
`../../002-transition-authorized-ledger-core/002-typed-append-only-ledger/spec.md`; deterministic gauge definitions
from `../../003-shared-evidence-and-control-services/005-stream-fold-gauges/spec.md`; phase-010 sibling events; and the

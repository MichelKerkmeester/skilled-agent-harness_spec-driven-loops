...
`../../002-transition-authorized-ledger-core/002-typed-append-only-ledger/spec.md` and
`../../002-transition-authorized-ledger-core/003-replay-fingerprints/spec.md`, plus run-2

...
parent: "system-deep-loop/036-deep-loop-innovation/002-substrate-and-orchestration/008-compatibility-shadow-and-rollback-bridge"
_memory:
  continuity:
    packet_pointer: "system-deep-loop/036-deep-loop-innovation/002-substrate-and-orchestration/008-compatibility-shadow-and-rollback-bridge/003-shadow-parity-harness"
...
> Phase adjacency under `008-compatibility-shadow-and-rollback-bridge` (navigation order, not a hard runtime dependency): predecessor `002-legacy-projections`; successor `004-inflight-state-classification`.
...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/036-deep-loop-innovation/002-substrate-and-orchestration/008-compatibility-shadow-and-rollback-bridge/003-shadow-parity-harness |
| **Level** | 2 |
| **Priority** | P0 |
| **Status** | Planned |
| **Created** | 2026-07-15 |
...
prior state. The [phase-003 baseline](../../../001-research-inputs-and-architecture/003-baseline-taxonomy-and-state-census/spec.md) defines the protected
...
ordered, verified artifact-reference set from the [phase-007 sealed-reference-artifact contract](../../../002-substrate-and-orchestration/007-shared-evidence-and-control-services/002-sealed-reference-artifacts/spec.md).
...
[phase-006 replay-fingerprint API](../../../002-substrate-and-orchestration/006-transition-authorized-ledger-core/003-replay-fingerprints/spec.md).
...
`../../../001-research-inputs-and-architecture/003-baseline-taxonomy-and-state-census/spec.md`,
`../../../002-substrate-and-orchestration/006-transition-authorized-ledger-core/003-replay-fingerprints/spec.md`,
`../../../002-substrate-and-orchestration/007-shared-evidence-and-control-services/002-sealed-reference-artifacts/spec.md`,

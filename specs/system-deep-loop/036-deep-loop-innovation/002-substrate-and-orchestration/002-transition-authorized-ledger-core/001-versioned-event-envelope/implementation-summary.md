...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-deep-loop/036-deep-loop-innovation/002-transition-authorized-ledger-core/001-versioned-event-envelope --strict
```
<!-- /ANCHOR:verification -->

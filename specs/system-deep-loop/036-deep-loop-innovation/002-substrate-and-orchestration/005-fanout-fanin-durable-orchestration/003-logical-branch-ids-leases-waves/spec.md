...
> Phase adjacency under `005-fanout-fanin-durable-orchestration` (navigation order, not a hard runtime dependency): predecessor `002-result-envelopes-and-resume-salvage`; successor `004-conditional-budget-aware-fanin`.
...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/036-deep-loop-innovation/005-fanout-fanin-durable-orchestration/003-logical-branch-ids-leases-waves |
| **Level** | 2 |
| **Priority** | P0 |
...
- Designing the shared lease coordinator or fencing-token store. Phase `003-shared-evidence-and-control-services/006-locks-and-fencing` owns those primitives; this phase consumes and specializes them.

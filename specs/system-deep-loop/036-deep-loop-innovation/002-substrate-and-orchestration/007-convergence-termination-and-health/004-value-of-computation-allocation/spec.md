...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/036-deep-loop-innovation/007-convergence-termination-and-health/004-value-of-computation-allocation |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Implemented |
| **Created** | 2026-07-15 |
...
Sources: `.opencode/specs/system-deep-loop/036-deep-loop-innovation/003-shared-evidence-and-control-services/004-hierarchical-typed-budgets/spec.md`;
`.opencode/specs/system-deep-loop/036-deep-loop-innovation/005-fanout-fanin-durable-orchestration/004-conditional-budget-aware-fanin/spec.md`;

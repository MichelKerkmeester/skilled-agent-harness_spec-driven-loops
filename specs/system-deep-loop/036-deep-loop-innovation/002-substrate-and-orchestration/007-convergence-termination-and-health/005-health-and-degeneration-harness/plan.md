...
- `007-convergence-termination-and-health/002-cycle-detection/spec.md` for cycle evidence and progress-gated repetition.
- `006-novelty-claims-continuity-and-projections/005-transactional-projections-and-gauges/spec.md` for coherent gauge and

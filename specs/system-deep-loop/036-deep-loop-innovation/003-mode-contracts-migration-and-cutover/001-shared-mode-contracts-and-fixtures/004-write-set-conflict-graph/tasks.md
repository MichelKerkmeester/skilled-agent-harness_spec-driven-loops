...
- [x] T005 Define the versioned graph envelope, node/resource records, edge types, assertions, policy, receipts, pair matrix, and canonical bytes [File: .opencode/skills/system-deep-loop/runtime/lib/write-set-conflict-graph/artifact.ts:27]
...
- [x] T018 Verify equivalent reordered input produces identical graph digest, schedule evidence, artifact digest, and bytes [File: .opencode/skills/system-deep-loop/runtime/tests/unit/write-set-conflict-graph.vitest.ts:956]

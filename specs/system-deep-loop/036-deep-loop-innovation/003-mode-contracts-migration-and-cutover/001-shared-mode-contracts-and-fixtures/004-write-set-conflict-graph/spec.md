...
> Phase adjacency under `001-shared-mode-contracts-and-fixtures` (navigation order, not a hard runtime dependency): predecessor `003-mixed-version-fixtures`; successor: none (last sibling).

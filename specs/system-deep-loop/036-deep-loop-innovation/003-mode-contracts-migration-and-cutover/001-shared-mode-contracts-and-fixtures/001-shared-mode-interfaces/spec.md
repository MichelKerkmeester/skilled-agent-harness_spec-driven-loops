...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/036-deep-loop-innovation/001-shared-mode-contracts-and-fixtures/001-shared-mode-interfaces |
| **Level** | 2 |
| **Priority** | P0 |
| **Status** | Complete |
| **Created** | 2026-07-15 |
...
- **Dependencies**: `002-transition-authorized-ledger-core/spec.md`, `003-shared-evidence-and-control-services/spec.md`, `007-convergence-termination-and-health/spec.md`, `manifest/phase-tree.json`, and the parent `../spec.md` are the source contracts; phase 013 consumes this phase's frozen interface.
<!-- /ANCHOR:risks -->

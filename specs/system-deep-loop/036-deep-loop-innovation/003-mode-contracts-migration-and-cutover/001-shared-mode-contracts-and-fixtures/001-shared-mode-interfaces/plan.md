...
parent: "system-deep-loop/036-deep-loop-innovation/001-shared-mode-contracts-and-fixtures/001-shared-mode-interfaces"
_memory:
  continuity:
    packet_pointer: "system-deep-loop/036-deep-loop-innovation/003-mode-contracts-migration-and-cutover/001-shared-mode-contracts-and-fixtures/001-shared-mode-interfaces"
...
### Definition of Ready
- [x] The parent `001-shared-mode-contracts-and-fixtures` outcome and phase adjacency are recorded.
...
- Extract the stable interface obligations from `002-transition-authorized-ledger-core/spec.md`, `003-shared-evidence-and-control-services/spec.md`, and `007-convergence-termination-and-health/spec.md` into a requirement-to-port matrix.

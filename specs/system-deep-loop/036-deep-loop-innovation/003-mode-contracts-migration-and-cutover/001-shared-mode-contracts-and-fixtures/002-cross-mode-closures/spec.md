...
> Phase adjacency under `001-shared-mode-contracts-and-fixtures` (grouping order, not a runtime dependency): predecessor `001-shared-mode-interfaces`; successor `003-mixed-version-fixtures`.
...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/036-deep-loop-innovation/001-shared-mode-contracts-and-fixtures/002-cross-mode-closures |
| **Level** | 2 |
| **Priority** | P0 |
| **Status** | Complete |
| **Created** | 2026-07-15 |
...
- **Dependencies**: `001-shared-mode-interfaces/spec.md`, the phase-007 parent and child contracts under `003-shared-evidence-and-control-services/`, the parent `../spec.md`, `manifest/phase-tree.json`, and the shipped runtime sources under `.opencode/skills/system-deep-loop/runtime/` are contract inputs. `003-mixed-version-fixtures` and `004-write-set-conflict-graph` are sibling handoff consumers, not hard dependencies.
<!-- /ANCHOR:risks -->

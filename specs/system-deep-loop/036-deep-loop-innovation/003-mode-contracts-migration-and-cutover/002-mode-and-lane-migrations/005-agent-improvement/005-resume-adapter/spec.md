...
- **Dependencies**: Agent Improvement siblings `001-typed-ledger-schema`, `002-reducers-and-projections`, and `003-sealed-artifacts`; deep-improvement-common `004-certificates-and-receipts` and `005-resume-adapter`; phase 012 shared mode contracts and write-set conflict graph; phase 006 ledger contracts; and the spec-kit validator. The child keeps `depends_on: []` as an independent planning contract.
<!-- /ANCHOR:risks -->

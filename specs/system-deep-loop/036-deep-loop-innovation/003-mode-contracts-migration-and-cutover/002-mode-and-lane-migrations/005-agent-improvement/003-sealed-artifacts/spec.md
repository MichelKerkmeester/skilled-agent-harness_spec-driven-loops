...
| Field | Value |
|-------|-------|
| **Packet** | system-deep-loop/036-deep-loop-innovation/002-mode-and-lane-migrations/005-agent-improvement/003-sealed-artifacts |
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | Complete |
| **Created** | 2026-07-15 |
...
outputs, normalized trajectories, behavior-family evidence, and redacted views. It consumes the shared phase-007 sealing
...
- One agent-improvement adapter over the shared phase-007 sealing primitives and the deep-improvement-common artifact/read contract; no local digest, signature, manifest, storage, or verification protocol.
...
- Defining or implementing a second digest, signature, chain, canonicalization, storage, seal-on-write, or read-verification scheme outside the shared phase-007 primitives.
...
|----|-------------|---------------------|
| REQ-001 | Agent-improvement artifacts use the shared sealing primitives | Every declared artifact kind routes through the deep-improvement-common adapter over the phase-007 primitive; no variant-owned digest or verification path exists |

...
parent: "system-deep-loop/036-deep-loop-innovation/003-mode-contracts-migration-and-cutover/014-staged-state-migration-and-authority-cutover/002-per-mode-authority-flip"
_memory:
  continuity:
...
[shadow-parity harness](../../../002-substrate-and-orchestration/008-compatibility-shadow-and-rollback-bridge/003-shadow-parity-harness/spec.md) owns parity
certification, and the phase-008 [rollback drills](../../../002-substrate-and-orchestration/008-compatibility-shadow-and-rollback-bridge/005-rollback-drills/spec.md)

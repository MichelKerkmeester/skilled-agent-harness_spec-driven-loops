...
parent: "system-deep-loop/036-deep-loop-innovation/003-mode-contracts-migration-and-cutover/014-staged-state-migration-and-authority-cutover/001-inflight-state-migration"
_memory:
  continuity:
...
The phase consumes the [phase-008 in-flight classification](../../../002-substrate-and-orchestration/008-compatibility-shadow-and-rollback-bridge/004-inflight-state-classification/spec.md),
the [phase-007 locks and fencing contract](../../../002-substrate-and-orchestration/007-shared-evidence-and-control-services/006-locks-and-fencing/spec.md),

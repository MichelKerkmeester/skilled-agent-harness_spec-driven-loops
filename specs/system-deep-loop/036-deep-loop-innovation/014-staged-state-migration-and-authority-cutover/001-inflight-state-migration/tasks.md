...
- **Classification contract**: See `../../008-compatibility-shadow-and-rollback-bridge/004-inflight-state-classification/spec.md`
- **Locks and fencing contract**: See `../../007-shared-evidence-and-control-services/006-locks-and-fencing/spec.md`

...
description: "Verification checklist for 029-improvement-promotion-authority: baseline-before-delta evidence, a negative test per confirmed finding, and independent adversarial verification."
trigger_phrases:

...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-deep-loop/036-deep-loop-innovation/029-improvement-promotion-authority --strict`
<!-- /ANCHOR:testing -->

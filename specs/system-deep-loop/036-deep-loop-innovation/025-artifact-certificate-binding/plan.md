...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-deep-loop/036-deep-loop-innovation/025-artifact-certificate-binding --strict`
<!-- /ANCHOR:testing -->

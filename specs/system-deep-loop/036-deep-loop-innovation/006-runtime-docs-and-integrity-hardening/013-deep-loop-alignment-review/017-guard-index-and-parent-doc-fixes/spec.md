...
| `specs/system-deep-loop/036-deep-loop-innovation/006-runtime-docs-and-integrity-hardening/013-deep-loop-alignment-review/spec.md` | Modify | Template leftovers replaced |
| `specs/system-deep-loop/036-deep-loop-innovation/006-runtime-docs-and-integrity-hardening/013-deep-loop-alignment-review/goal.md` | Modify | Durable slice within budget; deviation logged |
<!-- /ANCHOR:scope -->

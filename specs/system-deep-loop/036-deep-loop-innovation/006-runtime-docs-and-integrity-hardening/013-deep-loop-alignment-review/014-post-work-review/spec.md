...
|-----------|-------------|-------------|
| ``specs/system-deep-loop/036-deep-loop-innovation/006-runtime-docs-and-integrity-hardening/013-deep-loop-alignment-review`` | Read | The parent and its thirteen phase records |

...
> Phase adjacency under the `036-deep-loop-innovation` parent (grouping order, not a runtime dependency): predecessor `027-mode-gate-and-contract-binding`; successor `029-improvement-promotion-authority`.

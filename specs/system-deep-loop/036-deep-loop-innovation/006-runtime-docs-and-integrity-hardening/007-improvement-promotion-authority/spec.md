...
> Phase adjacency under the `036-deep-loop-innovation` parent (grouping order, not a runtime dependency): predecessor `006-fanout-dispatch-integrity`; successor `008-runtime-mirror-and-routing-parity`.

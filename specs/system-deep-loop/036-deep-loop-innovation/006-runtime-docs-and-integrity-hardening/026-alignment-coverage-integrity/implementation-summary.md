...
| Field | Value |
|-------|-------|
| **Spec Folder** | 026-alignment-coverage-integrity |
| **Spec Folder Path** | `.opencode/specs/system-deep-loop/036-deep-loop-innovation/026-alignment-coverage-integrity` |

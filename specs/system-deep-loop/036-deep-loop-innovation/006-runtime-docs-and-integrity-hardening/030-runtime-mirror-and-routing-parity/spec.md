...
> Phase adjacency under the `036-deep-loop-innovation` parent (grouping order, not a runtime dependency): predecessor `029-improvement-promotion-authority`; successor `031-silent-failure-and-harness-repair`.

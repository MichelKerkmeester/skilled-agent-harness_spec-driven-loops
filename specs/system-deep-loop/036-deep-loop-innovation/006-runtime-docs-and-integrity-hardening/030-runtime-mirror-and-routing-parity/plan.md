...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-deep-loop/036-deep-loop-innovation/030-runtime-mirror-and-routing-parity --strict`
<!-- /ANCHOR:testing -->

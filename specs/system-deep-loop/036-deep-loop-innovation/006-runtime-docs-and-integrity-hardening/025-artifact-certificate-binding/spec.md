...
> Phase adjacency under the `036-deep-loop-innovation` parent (grouping order, not a runtime dependency): predecessor `024-durable-write-boundaries`; successor `026-alignment-coverage-integrity`.

...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-deep-loop/036-deep-loop-innovation/004-alignment-coverage-integrity --strict`
<!-- /ANCHOR:testing -->

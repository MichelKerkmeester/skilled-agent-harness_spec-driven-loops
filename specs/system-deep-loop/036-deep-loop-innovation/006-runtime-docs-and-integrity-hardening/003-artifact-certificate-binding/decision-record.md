...
description: "Decision record for 003-artifact-certificate-binding: the architectural rulings this remediation child depends on, with alternatives and consequences."
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "Confirmed landed code follows ADR-001 and ADR-002"
    next_safe_action: "Update ADR terminal status in a later documentation pass"
    blockers: []
    key_files:
      - "decision-record.md"
    completion_pct: 100

...
description: "Root changelog for the 036 deep-loop-innovation phase parent, consolidated into eight thematic group parents plus the research and migration host packets."
trigger_phrases:
  - "root changelog"
  - "packet changelog"
  - "036 changelog"
...
The 036 epic implements the 178 research recommendations from packets 065/001 and 065/002 into the shipped `system-deep-loop` runtime and its per-mode workstreams. Its phase tree was consolidated from 44 flat children into eight thematic group parents. This changelog directory mirrors the full nested phase structure — one changelog per phase folder at every depth. Chronological identity (which spec folder was worked on first and which came after) is recorded in [`../timeline.md`](../timeline.md).

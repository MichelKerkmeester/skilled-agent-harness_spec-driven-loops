...
> Detached fan-out lineage `ds-a`. Scope: `specs/system-deep-loop/036-deep-loop-innovation/057-phase-consolidation-research/research/lineages/ds-a`. Research/proposal only — nothing outside the lineage dir was modified.
...
- Numbering has gaps (034, 036-046 absent); a root file `033-dispositions.md` coexists with folder `033-identity-and-lock-ownership-hardening/` (explicitly distinct per spec.md:209).
...
Inner children of the 13 existing parents become third-level (e.g., `020/002-mode-and-lane-migrations/001-deep-research`). `033-dispositions.md` stays at root.
...
15. `033-dispositions.md` disambiguation note preserved.

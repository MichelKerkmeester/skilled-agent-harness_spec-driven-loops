...
2. Independently re-derived the on-disk census: `ls -d 036-deep-loop-innovation/[0-9][0-9][0-9]-*` returns 45 dirs; 44 are children (host 057 excluded) plus the `033-dispositions.md` file. [SOURCE: bash `ls` census, strategy.md:56]

...
Inner children of the 13 existing parents become third-level (e.g., `020/002-mode-and-lane-migrations/001-deep-research`). `033-dispositions.md` stays at root (its disambiguation note survives).

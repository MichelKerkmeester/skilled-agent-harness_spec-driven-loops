...
9. **The 033 ambiguity:** a root-level file `033-dispositions.md` coexists with folder `033-identity-and-lock-ownership-hardening/`. spec.md:209 explicitly warns they are distinct. Any renumbering must preserve this distinction. [SOURCE: file:033-dispositions.md, spec.md:209]

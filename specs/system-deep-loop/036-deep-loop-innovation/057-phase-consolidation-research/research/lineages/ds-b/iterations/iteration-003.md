...
Plus `057-phase-consolidation-research` remains a direct child (the research host; would later be renamed to the plan/implementation packet or kept as-is).
...
7. Parent-level docs: `handover.md`, `goal.md`, `goal-plan-review.md`, `cutover-execution-plan.md`, `033-dispositions.md`, `before-and-after.md`, `execution-sequencing-strategy.md`, `goal-prompt.md` — any child-slug or "44-child"/"45-child" mentions.

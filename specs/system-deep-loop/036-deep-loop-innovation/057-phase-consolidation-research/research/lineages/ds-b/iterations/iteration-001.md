...
10. **Cross-references in parent-level docs**: `handover.md`, `goal.md`, `goal-plan-review.md`, `cutover-execution-plan.md`, `033-dispositions.md`, `before-and-after.md`, `execution-sequencing-strategy.md`, `goal-prompt.md`. [SOURCE: file:.../ (parent directory listing)]

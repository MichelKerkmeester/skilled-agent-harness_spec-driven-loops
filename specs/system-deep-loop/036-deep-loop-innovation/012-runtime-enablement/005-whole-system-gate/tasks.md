...
- [x] **T-001** Resolve candidate and baseline SHAs from the environment. [EVIDENCE: resolved by executing `git rev-parse` inside the gate; candidate `16e7d828cb`, baseline `6d055545b3`]
...
- [x] **T-003** Capture the baseline runtime suite result at the baseline SHA. [EVIDENCE: `19 failed / 4395 passed / 39 skipped (4453)` at the baseline SHA `6d055545b3`]
<!-- /ANCHOR:phase-1 -->

<!-- ANCHOR:phase-2 -->
## Phase 2: Implementation

- [x] **T-004** Run the runtime suite at the candidate. [EVIDENCE: `13 failed / 2698 passed / 7 skipped (2718)` at candidate `16e7d828cb`; `candidate-frozen` proves the runtime tree is byte-identical to the one measured]
...
- [x] **T-011** Confirm the suite result is expressed as a delta against the baseline. [EVIDENCE: `failed 13 vs 19`, `passed 2698 vs 4395`, `skipped 7 vs 39`, `total 2718 vs 4453`; candidate `16e7d828cb` vs baseline `6d055545b3`]

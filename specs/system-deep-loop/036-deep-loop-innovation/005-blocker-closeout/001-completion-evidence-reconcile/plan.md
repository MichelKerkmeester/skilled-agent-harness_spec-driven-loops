...
- Reopen set: `rg -n "^- \[x\]" .opencode/specs/system-deep-loop/036-deep-loop-innovation/002-mode-and-lane-migrations --glob checklist.md` then filter to items whose evidence cites a count or a line number.
...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-deep-loop/036-deep-loop-innovation/001-completion-evidence-reconcile --strict`

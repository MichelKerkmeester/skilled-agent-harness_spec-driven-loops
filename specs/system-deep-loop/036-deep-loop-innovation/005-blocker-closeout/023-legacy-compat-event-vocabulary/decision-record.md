...
description: "Decision record for 023-legacy-compat-event-vocabulary: the architectural rulings this remediation child depends on, with alternatives and consequences."
trigger_phrases:

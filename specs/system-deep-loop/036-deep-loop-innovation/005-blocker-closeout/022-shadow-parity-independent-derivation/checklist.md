...
description: "Verification checklist for 022-shadow-parity-independent-derivation: baseline-before-delta evidence, a negative test per confirmed finding, and independent adversarial verification."
trigger_phrases:

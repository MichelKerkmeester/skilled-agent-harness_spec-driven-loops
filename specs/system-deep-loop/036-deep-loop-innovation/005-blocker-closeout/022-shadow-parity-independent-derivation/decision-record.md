...
description: "Decision record for 022-shadow-parity-independent-derivation: the architectural rulings this remediation child depends on, with alternatives and consequences."
trigger_phrases:

...
> Phase adjacency under the `036-deep-loop-innovation` parent (grouping order, not a runtime dependency): predecessor `002-shadow-parity-independent-derivation`; successor `004-durable-write-boundaries`.

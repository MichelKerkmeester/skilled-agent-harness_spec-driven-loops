...
description: "Decision record for 004-durable-write-boundaries: the architectural rulings this remediation child depends on, with alternatives and consequences."
trigger_phrases:

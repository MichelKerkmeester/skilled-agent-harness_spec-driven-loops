...
> Phase adjacency under the `036-deep-loop-innovation` parent (grouping order, not a runtime dependency): predecessor `001-completion-evidence-reconcile`; successor `003-legacy-compat-event-vocabulary`.

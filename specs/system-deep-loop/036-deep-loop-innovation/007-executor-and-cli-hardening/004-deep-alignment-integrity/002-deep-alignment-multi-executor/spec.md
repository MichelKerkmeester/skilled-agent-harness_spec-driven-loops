...
> Phase adjacency under the `004-deep-alignment-integrity` parent (navigation order, not a runtime dependency): predecessor `001-alignment-registry-sealing`; successor none (last sibling).
...
| `.opencode/specs/system-deep-loop/036-deep-loop-innovation/004-deep-alignment-integrity/002-deep-alignment-multi-executor/*.md` | Create | Record scope, plan, tasks, checks, and outcome |
<!-- /ANCHOR:scope -->

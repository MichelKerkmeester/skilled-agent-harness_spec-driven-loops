...
> Phase adjacency under the `004-deep-alignment-integrity` parent (navigation order, not a runtime dependency): predecessor none (first sibling); successor `002-deep-alignment-multi-executor`.

...
parent: "system-deep-loop/036-deep-loop-innovation/007-executor-and-cli-hardening/051-residual-finding-closeouts"
_memory:
  continuity:
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 051-residual-finding-closeouts |
| **Level** | 2 |

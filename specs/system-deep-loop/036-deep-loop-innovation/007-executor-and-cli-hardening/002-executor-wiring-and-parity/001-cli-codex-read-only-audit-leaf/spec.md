...
- **Prior art**: `system-deep-loop/036-deep-loop-innovation/003-write-containment-hardening/001-cli-codex-write-containment` (the post-dispatch out-of-scope revert guard this fix complements).

...
description: "Task breakdown for 031-silent-failure-and-harness-repair: confirm-before-build pass over 23 scoped review findings, then the fix work units, then the delta-reported verification gate."
trigger_phrases:
...
- [ ] T022 `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-deep-loop/036-deep-loop-innovation/031-silent-failure-and-harness-repair --strict` exits 0; hand the reconciled counts back to `021` [2h] {deps: T021}
<!-- /ANCHOR:phase-3 -->

...
- [B] T013 Independent verification pass, then `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/system-deep-loop/036-deep-loop-innovation/030-runtime-mirror-and-routing-parity --strict` exits 0 [4h] {deps: T012}

...
> Phase adjacency under the `036-deep-loop-innovation` parent (grouping order, not a runtime dependency): predecessor `025-artifact-certificate-binding`; successor `027-mode-gate-and-contract-binding`.

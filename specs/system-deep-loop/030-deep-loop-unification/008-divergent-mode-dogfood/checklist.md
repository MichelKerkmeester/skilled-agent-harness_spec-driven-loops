...
- [x] CHK-040 [P0] This packet folder (`008-divergent-mode-dogfood`) follows the phase-child naming convention and is re-registered in the parent's (`030-deep-loop-unification`) `children_ids` after recovery
<!-- /ANCHOR:file-org -->

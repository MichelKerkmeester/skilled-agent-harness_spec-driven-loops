...
## Spec And Stop Contract
- `.opencode/specs/system-deep-loop/030-deep-loop-unification/spec.md`
- `.opencode/specs/system-deep-loop/030-deep-loop-unification/001-reference-research/spec.md`
- `.opencode/specs/system-deep-loop/030-deep-loop-unification/002-hub-rename-and-runtime-nesting/plan.md`
- `.opencode/specs/system-deep-loop/030-deep-loop-unification/003-external-reference-migration/plan.md`
- `.opencode/specs/system-deep-loop/030-deep-loop-unification/004-fallback-router-wiring/spec.md`
- `.opencode/specs/system-deep-loop/030-deep-loop-unification/004-fallback-router-wiring/plan.md`
- `.opencode/specs/system-deep-loop/030-deep-loop-unification/005-validation-and-closeout/plan.md`

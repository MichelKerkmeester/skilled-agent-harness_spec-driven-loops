...
- [ ] Every functional divergence between a confirm variant and its auto twin is either closed or carries an in-YAML rationale
- [ ] The confirm variants' adjudication records are in a shape their mode gateway accepts

...
Segment: 1 | Iteration: 20 of 20 (FINAL)
Questions: 5/5 answered; residuals carried to recommendations | Last focus: gap analysis
Last 2 ratios: 0.90 -> 0.72 | Stuck count: 0
Resource map: resource-map.md not present; skipping coverage gate.
Memory context refresh: none loaded yet.
Next focus: final verification sweep + answer consolidation.
...
Iteration: 20 of 20
Focus Area: Final verification sweep and answer consolidation: (1) sweep the packet for consistency — confirm all 19 prior iterations recorded in the state log, all iteration files and deltas exist (1-19), reducer outputs (registry/dashboard/strategy) refreshed, and cite the final counts; (2) consolidate the final answers to Q1-Q5 in one place with the strongest citations, flagging what remains open; (3) verify the synthesis inputs are complete: this is the LAST iteration before research/research.md compilation — list the sections you expect synthesis to produce from your findings; (4) record any final corrections as SUPERSEDES/CONTRADICTS edges
...
- Write iteration narrative to: specs/system-deep-loop/037-graph-engineering/research/iterations/iteration-020.md
- Write per-iteration delta file to: specs/system-deep-loop/037-graph-engineering/research/deltas/iter-020.jsonl
...
- **ALLOWED WRITE PATHS (the ONLY paths you may create, modify, or append to)**:
  - `specs/system-deep-loop/037-graph-engineering/research/iterations/iteration-020.md`, this iteration's narrative markdown
  - `specs/system-deep-loop/037-graph-engineering/research/deep-research-state.jsonl`, append-only JSONL state log
  - `specs/system-deep-loop/037-graph-engineering/research/deltas/iter-020.jsonl`, this iteration's delta JSONL
...
1. **Iteration narrative markdown** at `specs/system-deep-loop/037-graph-engineering/research/iterations/iteration-020.md` (path is pre-substituted for the current iteration number). Structure: headings for Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus.

...
Questions: 3/5 answered (Q3, Q4, Q5) | Last focus: Q5 adapter contract
Last 2 ratios: 0.92 -> 0.86 | Stuck count: 0
Resource map: resource-map.md not present; skipping coverage gate.
Memory context refresh: none loaded yet.
Next focus: Q1/Q2 reconciliation: verify runtime status + 036 phase census.
...
Iteration: 7 of 20
Focus Area: Q1/Q2 reconciliation: verify the current-status claims against the actual runtime — check mode-registry.json vs graph-metadata.json staleness labels, confirm which runtime subsystems are live (convergence.cjs, loop-lock.cjs, fanout-run.cjs, upsert.cjs, verify-iteration.cjs, reduce-state.cjs), and run a full phase census of 036-deep-loop-innovation children (001-050: status, landed vs planned vs stale metadata) to resolve the 034/036-046 coverage gap from iteration 2; cite every claim
...
- Write iteration narrative to: specs/system-deep-loop/037-graph-engineering/research/iterations/iteration-007.md
- Write per-iteration delta file to: specs/system-deep-loop/037-graph-engineering/research/deltas/iter-007.jsonl
...
- **ALLOWED WRITE PATHS (the ONLY paths you may create, modify, or append to)**:
  - `specs/system-deep-loop/037-graph-engineering/research/iterations/iteration-007.md`, this iteration's narrative markdown
  - `specs/system-deep-loop/037-graph-engineering/research/deep-research-state.jsonl`, append-only JSONL state log
  - `specs/system-deep-loop/037-graph-engineering/research/deltas/iter-007.jsonl`, this iteration's delta JSONL
...
1. **Iteration narrative markdown** at `specs/system-deep-loop/037-graph-engineering/research/iterations/iteration-007.md` (path is pre-substituted for the current iteration number). Structure: headings for Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus.

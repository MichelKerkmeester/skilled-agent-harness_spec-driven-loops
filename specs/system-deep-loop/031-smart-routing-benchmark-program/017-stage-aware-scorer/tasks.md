...
- [x] T001 Scaffold spec folder `061-stage-aware-scorer` (Level 2, `--track system-deep-loop --skip-branch`) - [evidence: 6 docs written under `.opencode/specs/system-deep-loop/031-smart-routing-benchmark-program/017-stage-aware-scorer/`]

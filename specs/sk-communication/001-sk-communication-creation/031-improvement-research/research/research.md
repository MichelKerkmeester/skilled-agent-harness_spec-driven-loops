...
| Field | Value |
|-------|-------|
| Packet | `specs/sk-communication/001-sk-communication-creation/031-improvement-research` |
...
- **F026 (P1)** — the advisor-routing smoke capture (2026-08-12, PASS) is stale and now documents behavior inverse to the shipped route-exclusion invariant (commit `f2a3ca6a18`, 2026-08-13). `[SOURCE: benchmark/reports/advisor-routing-smoke-2026-08-12.json; git log; SKILL.md:14]`
...
- `specs/sk-communication/001-sk-communication-creation/031-improvement-research/research/resource-map.md` (prior-inventoried files).

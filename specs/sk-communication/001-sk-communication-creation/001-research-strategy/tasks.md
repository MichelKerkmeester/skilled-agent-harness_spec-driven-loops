...
- [x] T010 Obtain authorization for a temporary isolated executor worktree required by the cli-opencode dangerous-permission contract. [evidence: `.worktrees/0138-system-deep-loop-communication-research` on `system-deep-loop/0138-communication-research`, recovery base `bf4db588d217f7e70203bd93dd2eec4b96effe84`.]

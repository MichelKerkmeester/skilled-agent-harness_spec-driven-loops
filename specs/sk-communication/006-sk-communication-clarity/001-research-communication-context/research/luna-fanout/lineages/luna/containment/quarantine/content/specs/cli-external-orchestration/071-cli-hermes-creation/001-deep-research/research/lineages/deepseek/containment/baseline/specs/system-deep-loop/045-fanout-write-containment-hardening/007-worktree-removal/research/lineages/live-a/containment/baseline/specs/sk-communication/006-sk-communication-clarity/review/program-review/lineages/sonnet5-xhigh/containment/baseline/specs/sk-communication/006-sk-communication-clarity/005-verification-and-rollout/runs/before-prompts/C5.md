...
Read .opencode/skills/sk-communication/benchmark/README.md and tell me what that benchmark measures. You will notice its reports folder is indexed by a README that could use tidying, which is not what I am asking about.

...
- [ ] T025 Run `validate.sh specs/sk-communication/006-sk-communication-clarity/002-synthesis-and-decisions --strict` from the final state and read both its output and its exit status
<!-- /ANCHOR:phase-3 -->

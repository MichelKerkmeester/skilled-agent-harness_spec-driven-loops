...
_memory:
  continuity:
    ...
    next_safe_action: "Build the allocation table, then record the non-work rows and the rejection list"
    blockers: []
    key_files:
      - "decision-record.md"
      - "spec.md"
...
rows and the rejection list. This statement will be rewritten when they land.
<!-- /ANCHOR:closure -->

Clarity is writing that earns its reader.
Clear writing is a matter of understanding what your reader needs, and giving it to them in a way that they can understand. Clarity turns eighteen rules into an Agent Skill for drafting, rewriting, or reviewing prose.


$
npx skills add addyosmani/clarity
/clarity interview
it interviews you, then co-writes from what you said
/clarity rewrite
it edits a draft you already have
/clarity review
it critiques and leaves your file alone
See the approach: one essay, three times - the same brief as an unedited draft, after a pass with the skill, and after it interviewed the author.

Use Clarity with Claude Code, Codex, and other agents that can load skill instructions. Or use the private browser editor to review AI writing tells, readability, and gaps in substance. The goal is better writing that remains recognisably yours, not prose engineered to fool an AI detector.

Essay

18 rules for better writing.
...
Watch
The same eighteen rules, read aloud.


18 rules for better writing.
Addy Osmani on YouTube. The poster loads from this site; the player only loads when you press play.
Further reading
Books

On Writing Well by William Zinsser, which is the one to read if you read one. The Elements of Style by Strunk & White. Several Short Sentences About Writing by Verlyn Klinkenborg, for the argument that the sentence is the unit of composition and everything else follows from it.
Essays and books

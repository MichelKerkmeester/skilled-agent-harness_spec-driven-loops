...
_memory:
  continuity:
    packet_pointer: "scaffold/010-repo-rule-system-integration"
...
# Acceptance Criteria: Extend the repo-rule system across the wider system and shrink AGENTS.md where content no longer earns a full writeup

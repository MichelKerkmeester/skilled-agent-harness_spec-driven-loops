...
Grant write capability in each dialect, replace the prose bound with one that permits a small inline fix and keeps everything larger delegated, amend the caller gate, and correct the obsolete subagent type and phantom agent name.

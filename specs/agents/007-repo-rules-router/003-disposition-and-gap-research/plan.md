...
- **Research corpus**: the seven governance files, `AGENTS.md`, commit `4477a9f1` and its packet under `specs/hooks/007-fable-governor-pi-hook/`, and `../../004-agents-md-bloat-audit/`.
...
| `../../004-agents-md-bloat-audit/` | Internal | Green | RQ2 would have to re-measure what is already measured |
<!-- /ANCHOR:dependencies -->

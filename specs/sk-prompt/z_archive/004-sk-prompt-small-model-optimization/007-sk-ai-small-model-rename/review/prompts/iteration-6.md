...
1. **Re-read** `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/spec.md` frontmatter `_memory.continuity`. Verify:
...
2. **Re-read** `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/description.json`. Verify:

...
- Write iteration narrative to: `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/review/iterations/iteration-006.md`
- Write per-iteration delta file to: `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/review/deltas/iter-006.jsonl`
...
3. Bash `ls .opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/002-sentinel-skill-foundation/` and 006/.

...
- Write iteration narrative to: `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/001-smallcode-deep-research/research/iterations/iteration-001.md`
- Write per-iteration delta file to: `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/001-smallcode-deep-research/research/deltas/iter-001.jsonl`
...
- Read-only across `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/external/smallcode-master/` (MIT corpus)
...
- Preflight evidence base (cite first, drill to source only for specifics): `.opencode/specs/sk-prompt/004-sk-prompt-small-model-optimization/preflight/context-card.md` §RQ1

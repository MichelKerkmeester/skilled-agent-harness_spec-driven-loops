...
**Non-goals:** implementation; re-litigating Architecture A (spec 130) or the registry/benchmark relocation (spec 131) — build ON them.
**Known context:** spec 130 (3-layer architecture + per-model profiles), spec 131 (registry+benchmarks moved into the hub; sk-prompt forkable; deep-improvement hub-only benchmarks).

...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/002-sk-improve-prompt-rename/003-opencode-internals --strict
```
<!-- /ANCHOR:success-criteria -->

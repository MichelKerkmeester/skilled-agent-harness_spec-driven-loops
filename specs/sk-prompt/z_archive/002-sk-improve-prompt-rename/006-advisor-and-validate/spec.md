...
- Run recursive strict validation for `skilled-agent-orchestration/z_archive/002-sk-improve-prompt-rename`.
...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/skilled-agent-orchestration/z_archive/002-sk-improve-prompt-rename --strict --recursive

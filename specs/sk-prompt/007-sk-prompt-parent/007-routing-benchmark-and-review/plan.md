...
| **Storage** | File-system benchmark outputs under `.opencode/skills/sk-prompt/benchmark/reports/2026-07-10--router-final--router/` |
...
### Key Components
- **Router-mode skill-benchmark**: Runs `.opencode/skills/system-deep-loop/deep-improvement/scripts/shared/loop-host.cjs --mode=skill-benchmark --skill=sk-prompt --outputs-dir=.opencode/skills/sk-prompt/benchmark/reports/2026-07-10--router-final--router --trace-mode=router` and writes the benchmark report artifacts.
...
| `.opencode/skills/sk-prompt/benchmark/reports/2026-07-10--router-final--router/` | Phase-local benchmark output location. | Create report artifacts through the benchmark command. | Confirm `skill-benchmark-report.md` and `skill-benchmark-report.json` exist and are legible. |
...
- Algorithm invariant: router-mode benchmark evidence must evaluate both workflow modes from the new `sk-prompt` hub path and write reports only under `.opencode/skills/sk-prompt/benchmark/reports/2026-07-10--router-final--router/`.
<!-- /ANCHOR:affected-surfaces -->
...
- [ ] Confirm or create the benchmark output directory `.opencode/skills/sk-prompt/benchmark/reports/2026-07-10--router-final--router/` as part of benchmark execution, not as a separate design change.

### Phase 2: Core Implementation
- [ ] Run `.opencode/skills/system-deep-loop/deep-improvement/scripts/shared/loop-host.cjs --mode=skill-benchmark --skill=sk-prompt --outputs-dir=.opencode/skills/sk-prompt/benchmark/reports/2026-07-10--router-final--router --trace-mode=router` from the workspace root.
...
- [ ] Verify both benchmark report files exist under `.opencode/skills/sk-prompt/benchmark/reports/2026-07-10--router-final--router/`.
...
| `.opencode/skills/sk-prompt/benchmark/reports/2026-07-10--router-final--router/` | Internal | Created by or for benchmark execution | Evidence may be missing or written to a dead path if the output target is wrong. |

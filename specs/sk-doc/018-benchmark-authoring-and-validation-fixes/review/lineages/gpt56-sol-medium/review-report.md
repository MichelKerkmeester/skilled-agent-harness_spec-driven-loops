...
- **F003**: Checked eight-consumer rewire claim has only six discoverable pointers - `.opencode/specs/sk-doc/017-benchmark-authoring-centralization/tasks.md:48`. Repository-wide search under `system-deep-loop` resolves six consumer documents, while tasks, checklist, and summary claim eight. Either two pointers are missing or the completion evidence is stale.

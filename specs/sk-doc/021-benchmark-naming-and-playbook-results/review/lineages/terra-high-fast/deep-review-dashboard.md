...
- Started: 2026-07-27T10:52:36.916Z
- Status: COMPLETE
- Iteration: 5 of 5
- Provisional Verdict: CONDITIONAL
- hasSearchDebt: false
- hasAdvisories: false
- Session ID: fanout-terra-high-fast-1785149403377-degd9r
- Parent Session: none
- Lifecycle Mode: new
- Generation: 1
...
|---|-------|------------|-------|----------|--------|
| 1 | correctness — default run storage | correctness | 1.00 | 0/1/0 | complete |
...
| 5 | adversarial replay — active P1 findings and completion claims | correctness/traceability/maintainability | 0.00 | 0/3/0 | complete |

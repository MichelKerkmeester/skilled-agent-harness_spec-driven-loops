---
title: "Feature Specification: Playbooks for the modes that derive an artifact from a source"
description: "Three sk-doc modes with no manual testing playbook: sk-create-benchmark,sk-create-changelog,sk-create-feature-catalog. Nothing states what any of them doing its job looks like."
trigger_phrases:
  - "sk-create-benchmark playbook"
  - "sk-create-changelog playbook"
  - "sk-create-feature-catalog playbook"
  - "playbooks for the modes that derive an artifact from a source"
importance_tier: "high"
contextType: "general"
---
<!-- SPECKIT_TEMPLATE_SOURCE: spec-core + level2-verify + level3-arch | v2.2 -->
# Feature Specification: Phase 2: artifact-producers
...
| **Status** | Draft |
| **Created** | 2026-09-01 |
| **Branch** | `scaffold/002-artifact-producers` |
| **Parent Spec** | ../spec.md |
| **Phase** | 2 of 3 |
| **Predecessor** | 001-authoring-surfaces |
| **Successor** | 003-meta-and-quality |
...
This is **Phase 2** of the Give every sk-doc mode the manual testing playbook it lacks specification.
...
Each of these derives a document from something that already exists, so their failure mode is drift: the artifact stops describing its source and nobody notices, because it still looks like a valid document.
...
- A manual testing playbook package for `sk-create-benchmark`.
- A manual testing playbook package for `sk-create-changelog`.
- A manual testing playbook package for `sk-create-feature-catalog`.
...
|-----------|-------------|-------------|
| `.opencode/skills/sk-doc/sk-create-benchmark/manual-testing-playbook/**` | Create | The playbook package for sk-create-benchmark |
| `.opencode/skills/sk-doc/sk-create-changelog/manual-testing-playbook/**` | Create | The playbook package for sk-create-changelog |
| `.opencode/skills/sk-doc/sk-create-feature-catalog/manual-testing-playbook/**` | Create | The playbook package for sk-create-feature-catalog |
<!-- /ANCHOR:scope -->

...
_memory:
  continuity:
    ...
    recent_action: "Scaffolded phase 009 docs (spec, plan, tasks, checklist) inside 005-mode-child-readme-revisit"
    next_safe_action: "Execute phase 009 work: rewrite the mcp-click-up skill README per tasks.md"
    blockers: []
    key_files:
      - ".opencode/skills/mcp-tooling/mcp-click-up/README.md"
      - ".opencode/skills/mcp-tooling/mcp-click-up/changelog/v1.1.0.0.md"
    session_dedup:
...
# Feature Specification: Phase 009 mcp-click-up mode skill README rewrite
...
| **Predecessor** | `008-mcp-chrome-devtools` |
| **Successor** | `010-mcp-figma` |
| **Handoff Criteria** | The mcp-click-up skill README is purpose-first on the refined template with a one-line pitch and a problem-first OVERVIEW, passes the HVR grep with zero violations, carries a bumped version field and a changelog entry, passes `validate_document.py --type readme` with zero issues and this phase folder validates with zero errors |
<!-- /ANCHOR:metadata -->
...
### Problem Statement
The skill README at `.opencode/skills/mcp-tooling/mcp-click-up/README.md` still carries the older tabular reference-card style and predates the pilot standard. The mcp-obsidian README pilot proved the standard for mode skill READMEs: narrative, purpose-first documents in the Human Voice Rules, validated by the sk-doc README validator. The click-up README predates those learnings and does not yet follow the refined template from phase 001.
...
### Out of Scope
- SKILL.md content for mcp-click-up.
...
|-----------|-------------|-------------|
| `.opencode/skills/mcp-tooling/mcp-click-up/README.md` | Rewrite | Purpose-first rewrite per the refined template with a one-line pitch, a problem-first OVERVIEW and a bumped version field |
| `.opencode/skills/mcp-tooling/mcp-click-up/changelog/v1.1.0.0.md` | Add | Changelog entry recording the README rewrite |
| `.opencode/specs/sk-doc/026-skill-readme-refinement/005-mode-child-readme-revisit/009-mcp-click-up/spec.md` | Create | Phase specification (this file) |
| `.opencode/specs/sk-doc/026-skill-readme-refinement/005-mode-child-readme-revisit/009-mcp-click-up/plan.md` | Create | Phase implementation plan |
| `.opencode/specs/sk-doc/026-skill-readme-refinement/005-mode-child-readme-revisit/009-mcp-click-up/tasks.md` | Create | Phase task list |
| `.opencode/specs/sk-doc/026-skill-readme-refinement/005-mode-child-readme-revisit/009-mcp-click-up/checklist.md` | Create | Phase verification checklist |

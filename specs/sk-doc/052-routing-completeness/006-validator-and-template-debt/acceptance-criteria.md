...
|---|---|---|---|---|---|
| AC-001 | REQ-001 | Given a scanner fixture whose bytes are pinned by tests, When the document validator runs, Then it is exempt | Re-run 2026-09-02: `validate_document.py:1` exits 0 on `voice-clean.md:1` and `voice-dirty.md:1`, each reporting `Fixture tree: holds the shapes it exercises`. The exemption landed in `71f1c2f9bc` | Met | |

...
| Item | State | Evidence |
|------|-------|----------|
| Gate A measured | Done | `12aa10504a` records 234 of 444 across five hubs |
| Unresolved vocabulary closed | Done | `aa11c2b622` resolves half the declared vocabulary that reached nothing |
...
| The re-sweep found a live defect outside this phase | `sk-doc` serves legacy on a stale activation pin since `3ce648be44`, which costs 96 signals their mode. Recorded and raised, not fixed here |

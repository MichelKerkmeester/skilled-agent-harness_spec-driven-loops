...
Review `.opencode/specs/sk-doc/032-split-doc-template-alignment` and its declared 163-file deliverable against the canonical create-skill reference/asset templates.
<!-- /ANCHOR:topic -->

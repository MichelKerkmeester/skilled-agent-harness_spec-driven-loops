...
- Independent inventory of all six configured Markdown globs from `.opencode/specs/sk-doc/032-split-doc-template-alignment/review/xhigh-verify/lineages/xhigh-c/deep-review-config.json:47-55`: 50 code-opencode references, 15 code-opencode assets, 86 code-webflow references, 9 code-webflow assets, 0 code-quality references, and 3 code-quality assets, totaling 163 lexical-unique `.md` entries.
- Governing packet evidence: `.opencode/specs/sk-doc/032-split-doc-template-alignment/spec.md:55-81`, `.opencode/specs/sk-doc/032-split-doc-template-alignment/plan.md:23-64`, `.opencode/specs/sk-doc/032-split-doc-template-alignment/tasks.md:30-61`, `.opencode/specs/sk-doc/032-split-doc-template-alignment/checklist.md:23-60`, and `.opencode/specs/sk-doc/032-split-doc-template-alignment/implementation-summary.md:37-78`.
...
|---|---|---|---|
| `spec_code` | core | **failed (executed)** | R3 requires every scoped reference to open with `## 1. OVERVIEW` at `.opencode/specs/sk-doc/032-split-doc-template-alignment/spec.md:67-72`; the current Rust reference still opens substantive content at `.opencode/skills/sk-code/code-opencode/references/rust/style_guide/interop_errors_and_parity.md:13-21` without that wrapper. This is narrow confirmation of active `I1-P1-001`, not a repeated structural sweep. |
| `checklist_evidence` | core | **failed (executed)** | `.opencode/specs/sk-doc/032-split-doc-template-alignment/checklist.md:49` and `:90-95` claim 163/163 validator success, but the current R3 counterexample proves that evidence does not establish the full wrapper invariant. |
| `feature_catalog_code` | overlay | **notApplicable (classified)** | The governing scope explicitly excludes already-renamed `feature_catalog` files at `.opencode/specs/sk-doc/032-split-doc-template-alignment/spec.md:55-60`; no feature-catalog capability claim is part of this packet. |
| `playbook_capability` | overlay | **notApplicable (classified)** | The same scope excludes `manual_testing_playbook` files at `.opencode/specs/sk-doc/032-split-doc-template-alignment/spec.md:55-60`, while `.opencode/specs/sk-doc/032-split-doc-template-alignment/plan.md:23-28` defines documentation authoring with no code/runtime change. |

## Integration Evidence

- `spec_code` was tested across the exact contract/implementation boundary: R3 at `.opencode/specs/sk-doc/032-split-doc-template-alignment/spec.md:67-72`, completion claims at `.opencode/specs/sk-doc/032-split-doc-template-alignment/implementation-summary.md:37-48`, and the current scoped counterexample at `.opencode/skills/sk-code/code-opencode/references/rust/style_guide/interop_errors_and_parity.md:13-21`.
- `checklist_evidence` was tested against the exact evidence rows at `.opencode/specs/sk-doc/032-split-doc-template-alignment/checklist.md:47-60` and `:87-95`, rather than treating a checked box as independent proof.
...
- Counting configured resource paths is consistent with the command-owned scope and the packet's 65/95/3 surface totals at `.opencode/specs/sk-doc/032-split-doc-template-alignment/implementation-summary.md:39-46`; the resolved-target distinction is retained as an audit caveat, not promoted to a defect.
...
- The packet's distribution of 3 code-quality, 65 code-opencode, and 95 code-webflow resource paths at `.opencode/specs/sk-doc/032-split-doc-template-alignment/implementation-summary.md:39-46` agrees with the independent enumeration.

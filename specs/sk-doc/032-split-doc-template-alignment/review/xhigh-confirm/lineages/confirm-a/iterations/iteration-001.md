...
- Read-only target: `.opencode/specs/sk-doc/032-split-doc-template-alignment` plus the three declared sk-code resource/asset trees.
...
The corpus sweep reproduced the documented 163-file distribution and found no active correctness defect in filename shape, required frontmatter fields, four-part versions, opening H1/intro/OVERVIEW order, contiguous numbered H2 sections, RELATED RESOURCES placement, Purpose-intro duplication, or relative Markdown-link resolution after adjudicating the known exception. This agrees with the current completion table [SOURCE: `.opencode/specs/sk-doc/032-split-doc-template-alignment/implementation-summary.md:39-48`] and narrowed link claim [SOURCE: `.opencode/specs/sk-doc/032-split-doc-template-alignment/implementation-summary.md:73-78`].
...
- The YAML-owned prompt pack was read at `.opencode/specs/sk-doc/032-split-doc-template-alignment/review/xhigh-confirm/lineages/confirm-a/prompts/iteration-001.md:31-52`; it fixes the LEAF route, write boundary, executor, lineage, and review-depth requirements.
...
- A scope-wide relative-link scan surfaced the illustrative absolute `/specs/005-example.com/...` path [SOURCE: `.opencode/skills/sk-code/code-webflow/references/performance/webflow_constraints.md:166-172`]. The packet explicitly identifies it as a pre-existing, non-navigational, non-rename artifact [SOURCE: `.opencode/specs/sk-doc/032-split-doc-template-alignment/checklist.md:49-52`]; it does not contradict the narrowed renamed-file link claim.

...
- Governing packet: `.opencode/specs/sk-doc/032-split-doc-template-alignment/spec.md:44-83`, `plan.md:23-64`, `tasks.md:23-61`, `checklist.md:23-98`, and `implementation-summary.md:26-93`.
...
- Fresh packet gate: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/sk-doc/032-split-doc-template-alignment --strict` returned `Errors: 0`, `Warnings: 5`, and `RESULT: FAILED`; warning classes include 25 uncited completed items.
...
1. **The Complete packet does not pass its mandatory strict completion gate** - `.opencode/specs/sk-doc/032-split-doc-template-alignment/implementation-summary.md:84-87` - fresh strict validation returns `RESULT: FAILED` with five warning classes, including `EVIDENCE_CITED: Found 25 completed item(s) without evidence`. The summary acknowledges and accepts the non-zero gate, but the framework completion contract requires strict success before a Complete claim; the unchecked evidence density also directly fails the review contract's `checklist_evidence` protocol.

...
- [x] `NODE_PRESERVE_SYMLINKS=1 bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/sk-doc/053-chart-visual-overhaul/004-interaction-layer --strict` prints `RESULT: PASSED` with Errors 0
<!-- /ANCHOR:completion -->

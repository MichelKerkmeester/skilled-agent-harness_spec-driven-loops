...
_memory:
  continuity:
    packet_pointer: "sk-doc/053-chart-visual-overhaul"
...
- [ ] `validate.sh specs/sk-doc/053-chart-visual-overhaul --strict --recursive` prints `RESULT: PASSED` for all eight folders

...
- [x] T-005 Classify the `mcp-notion` link violations as a grader defect and route the durable fix out of this phase. Evidence: the Code Mode call form `notion["notion_tool"]({...})` was read as a markdown link across 34 files; the repair shipped in `038-authoring-hardening` phase `002-validator-false-positives`, and no call syntax was rewritten to satisfy the scan.
...
- The grader fix this phase depends on: `../../038-authoring-hardening/002-validator-false-positives/`.
<!-- /ANCHOR:cross-refs -->

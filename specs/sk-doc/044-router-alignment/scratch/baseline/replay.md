...
build a parent hub skill with nested mode packets | sk-create-skill-parent | (none) | 0 | 0 | sk-create-skill-parent:8
write a readme for the analytics service | sk-create-readme | README_CREATION | 2 | 0 | sk-create-readme:4
create an agent that reviews pull requests | (none) | (none) | 0 | 0 | 
create a slash command that runs the deploy script | sk-create-command | (none) | 0 | 0 | sk-create-command:3
...
create a benchmark for the new model | (none) | BENCHMARK | 3 | 0 | 
write the changelog for this release | sk-create-changelog | CHANGELOG | 1 | 0 | sk-create-changelog:3
produce a before and after document diff of the onboarding page | (none) | DIFF | 3 | 0 | 
...
score this document | sk-create-quality-control | (none) | 0 | 0 | sk-create-quality-control:8
validate the command template | sk-create-quality-control+sk-create-command | (none) | 0 | 0 | sk-create-quality-control:4 sk-create-command:3
audit the agent file | sk-create-agent+sk-create-quality-control | (none) | 0 | 0 | sk-create-agent:4 sk-create-quality-control:4
...
hvr | sk-create-quality-control | HVR | 4 | 0 | sk-create-quality-control:4

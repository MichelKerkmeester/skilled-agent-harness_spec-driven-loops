...
- [x] `NODE_PRESERVE_SYMLINKS=1 bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/sk-doc/051-sk-create-chart/009-chart-visual-overhaul/005-dark-theme --strict` prints `RESULT: PASSED` with Errors 0
<!-- /ANCHOR:completion -->

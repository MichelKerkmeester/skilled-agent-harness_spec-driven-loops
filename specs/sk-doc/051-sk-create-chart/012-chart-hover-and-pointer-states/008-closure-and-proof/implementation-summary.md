...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - "specs/sk-doc/051-sk-create-chart/012-chart-hover-and-pointer-states/acceptance-criteria.md"
      - "specs/sk-doc/051-sk-create-chart/012-chart-hover-and-pointer-states/008-closure-and-proof/decision-record.md"
    session_dedup:

...
|-----------|-------------|--------------|
| `specs/sk-doc/051-sk-create-chart/012-chart-hover-and-pointer-states/acceptance-criteria.md` | Modify | Fill Status, Verification and Waiver columns for all 11 rows with observed evidence, write the Closure Statement |
| `specs/sk-doc/051-sk-create-chart/012-chart-hover-and-pointer-states/decision-record.md` | Create | ADR entries for AC-005 (if phase 001 has not already recorded one) and for the O3 completeness-question disposition |
| `specs/sk-doc/051-sk-create-chart/012-chart-hover-and-pointer-states/spec.md` | Modify | Reconcile the Status field and any shipped or current-state claim once closure is proven |
<!-- /ANCHOR:scope -->

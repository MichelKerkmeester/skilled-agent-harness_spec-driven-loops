...
<!-- ANCHOR:status -->
## 2. STATUS
- Topic: Re-verify every upstream library citation and claim in specs/sk-doc/051-sk-create-chart/007-fidelity-and-library-research/research/lineages/deepseek-flash-max/research.md against the live sources, using web search. Reconcile every claimed capability with the corpus as shipped at commit 756a7fcd4c.

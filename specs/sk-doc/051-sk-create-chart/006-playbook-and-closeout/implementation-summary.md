...
_memory:
  continuity:
    ...
    key_files:
      ...
      - "specs/sk-doc/051-sk-create-chart/spec.md"
      - "specs/sk-doc/051-sk-create-chart/006-playbook-and-closeout/acceptance-criteria.md"
    session_dedup:
...
| `specs/sk-doc/051-sk-create-chart/spec.md` | Modified | Phase map reconciled, status, branch and continuity |
| `specs/sk-doc/051-sk-create-chart/00{1,2,3,5}-*/spec.md` | Modified | Status flipped to Complete, scaffold title markers removed |
| `specs/sk-doc/051-sk-create-chart/006-playbook-and-closeout/spec.md` | Modified | Status, and the open questions answered or recorded |
| `specs/sk-doc/051-sk-create-chart/006-playbook-and-closeout/plan.md` | Rewritten | The actual approach, replacing the template |
| `specs/sk-doc/051-sk-create-chart/006-playbook-and-closeout/tasks.md` | Rewritten | The executed tasks and the verification checklist |
| `specs/sk-doc/051-sk-create-chart/006-playbook-and-closeout/acceptance-criteria.md` | Rewritten | Twelve criteria, eleven met on observed output and one waived |
| `specs/sk-doc/051-sk-create-chart/006-playbook-and-closeout/decision-record.md` | Created | The three decisions this phase took |
<!-- /ANCHOR:what-built -->
...
| `validate.sh specs/sk-doc/051-sk-create-chart --strict --recursive` | PASS. Seven folders, each printing `RESULT: PASSED` with its rule block present |

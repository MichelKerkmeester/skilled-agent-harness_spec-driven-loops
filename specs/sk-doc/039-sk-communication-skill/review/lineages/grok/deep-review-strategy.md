...
Fan-out lineage `grok` reviewing specs/sk-doc/039-sk-communication-skill (spec-folder) and the authored skill at `.opencode/skills/sk-communication/`.
...
- Target pointers: `specs/sk-doc/039-sk-communication-skill/{spec,plan,tasks,implementation-summary}.md`; `.opencode/skills/sk-communication/{SKILL.md,graph-metadata.json,leaf-manifest*,references/package-map.md,feature-catalog/,manual-testing-playbook/}`.

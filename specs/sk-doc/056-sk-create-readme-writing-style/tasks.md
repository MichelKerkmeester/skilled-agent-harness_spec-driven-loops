...
- [x] T015 `skill-readme-template.md`: value-first opening (What It Does first, Why This Skill Exists optional), semantic-only emoji rule, stale root-README references fixed, version 1.3.0.0
- [x] T016 `parent-skill-readme-template.md`: same emoji rule and value-first shift, version 1.3.0.0
- [x] T017 `types-and-voice.md`: register subsection refined so a skill README may borrow the engaging opening, version 1.2.1.0
- [x] T018 `sk-create-skill/changelog/v1.3.0.0.md` + amend the sk-create-readme v1.2.0.0 entry

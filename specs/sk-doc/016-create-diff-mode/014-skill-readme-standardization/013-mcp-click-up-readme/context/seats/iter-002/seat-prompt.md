Spec folder: sk-doc/014-skill-readme-standardization/013-mcp-click-up-readme (pre-approved, skip Gate 3). READ-ONLY: do not write, create or edit any file, and do not run or install anything. Return findings as your final assistant message only.

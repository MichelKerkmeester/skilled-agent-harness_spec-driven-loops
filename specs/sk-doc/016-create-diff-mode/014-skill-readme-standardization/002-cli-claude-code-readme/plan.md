---
title: "Implementation Plan: cli-claude-code README"
...
# Implementation Plan: cli-claude-code README
...
### Definition of Ready
- [x] Template and golden example available from phase 001
...
- [x] HVR-clean, agent roster corrected to 9
<!-- /ANCHOR:quality-gates -->
...
Not applicable. Documentation-only change to one README, no bug fix or shared-policy surface.
<!-- /ANCHOR:affected-surfaces -->
...
| Accuracy | Flags, agents, files | Host read of SKILL.md |
<!-- /ANCHOR:testing -->

---
title: "Verification Checklist: Upgrade [sk-doc/009-cmd-create-changelog-and-releases/checklist]"
...
- [ ] CHK-003 [P0] All three target files read in full before any edits (`.opencode/commands/create/changelog.md`, `changelog.toml`, `.opencode/skills/sk-git/references/finish_workflows.md`)
...
- [ ] CHK-010 [P0] No placeholder text in `.opencode/commands/create/changelog.md` — all sections completed with real content
- [ ] CHK-011 [P0] No placeholder text in `changelog.toml` — prompt field contains actual instruction content
- [ ] CHK-012 [P0] No placeholder text in `.opencode/skills/sk-git/references/finish_workflows.md` — cross-reference paragraph complete
...
- [ ] CHK-021 [P0] `changelog.toml` prompt field confirmed to match `.opencode/commands/create/changelog.md` instruction body (diff check on key sections: RELEASE PHASE section, Setup Phase mode detection, INSTRUCTIONS block)
- [ ] CHK-022 [P0] `.opencode/skills/sk-git/references/finish_workflows.md` Step 6 cross-reference present and reads naturally — does not interrupt the existing release workflow narrative
- [ ] CHK-023 [P1] Error scenario paths verified in `.opencode/commands/create/changelog.md`: (1) tag already exists, (2) `gh` not installed, (3) `gh auth` fails, (4) `gh release create` fails after tag push
...
- [ ] CHK-041 [P1] `.opencode/commands/create/changelog.md` RELATED RESOURCES section updated if new resources are referenced by the release phase
- [ ] CHK-042 [P2] Cross-reference from `.opencode/skills/sk-git/references/finish_workflows.md` Step 6 is bidirectional — `.opencode/commands/create/changelog.md` RELATED RESOURCES or COMMAND CHAIN references `.opencode/skills/sk-git/references/finish_workflows.md`
<!-- /ANCHOR:docs -->

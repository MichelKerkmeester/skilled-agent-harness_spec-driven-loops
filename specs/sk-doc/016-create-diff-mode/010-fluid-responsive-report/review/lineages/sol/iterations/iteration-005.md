...
- P1-001 is sustained without severity change. The unsupported-engine promise remains explicit [SOURCE: `.opencode/specs/sk-doc/016-create-diff-mode/010-fluid-responsive-report/spec.md:137`; `.opencode/specs/sk-doc/016-create-diff-mode/010-fluid-responsive-report/spec.md:153`], while the computed declarations still depend on `cqi`-bearing variables [SOURCE: `.opencode/skills/sk-doc/create-diff/scripts/create_diff.py:720-727`; `.opencode/skills/sk-doc/create-diff/scripts/create_diff.py:731-804`].

...
| Field | Value |
|-------|-------|
| **Spec Folder** | 004-cmd-create-skill-merger |
...
- `.opencode/specs/03--commands-and-skills/019-cmd-create-skill-merger/memory/*.md` (latest save artifact)
- `.opencode/specs/03--commands-and-skills/019-cmd-create-skill-merger/memory/metadata.json` (`embedding.status: indexed`)
- `memory_index_scan` completed for `03--commands-and-skills/019-cmd-create-skill-merger` (status `complete`, `failed = 0`)

...
| P1 | TARGET_DELETED | `.opencode/agents/code.md` | `specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/decision-record.md` | no | Update to z_archive/ path or remove the stale reference to archived packet |
| P1 | TARGET_DELETED | `.claude/agents/code.md` | `specs/skilled-agent-orchestration/z_archive/047-agent-implement-code/decision-record.md` | no | Update to z_archive/ path or remove the stale reference to archived packet |

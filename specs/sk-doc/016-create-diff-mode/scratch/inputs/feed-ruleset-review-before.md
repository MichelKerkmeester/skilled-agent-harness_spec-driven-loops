...
> This review is non-normative. It records contradictions, missing decisions and improvement actions. The source documents remain authoritative only for the subjects assigned to them in the authority model below.
...
The collection identifiers, copied ruleset thresholds, weight totals and online-local alternation are mostly aligned. The main gaps sit between documents. They concern source authority, lifecycle placement, application status language, fallback order, score comparability, missing-data behavior and measurement.
...
- [Dead Deals](./Feed%20-%20Dead%20Deals.md)
- [Feed Functions](./Feed%20-%20Feed%20Functions.md)

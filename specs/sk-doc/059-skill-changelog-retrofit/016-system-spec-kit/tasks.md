...
- [ ] T002 Confirm the system-spec-kit files are clean in git before the run (`../scratch/lists/system-spec-kit.txt`)
<!-- /ANCHOR:phase-1 -->
...
- [ ] T003 Run the driver over the list (`../scratch/rewrite-driver.cjs --list ../scratch/lists/system-spec-kit.txt --state ../scratch/state.jsonl`)
...
- [ ] T007 Commit the kept system-spec-kit files only, then run `compiled-route-guard.cjs` and each mirror generator's `--check`

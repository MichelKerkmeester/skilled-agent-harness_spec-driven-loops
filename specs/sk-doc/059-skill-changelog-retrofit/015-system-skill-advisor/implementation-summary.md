...
description: "Not started. This phase rewrites the 12 listed system-skill-advisor changelogs once phase 001's pilot style is approved."
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "Planned the system-skill-advisor wave"
...
Nothing yet. The operator approved the pilot style on 2026-09-24, and this wave has not run. Its target list, `../scratch/lists/system-skill-advisor.txt`, is in place.

### Phase 15: system-skill-advisor changelogs

The wave will rewrite the 12 listed changelogs, keep each one only when all three gates pass, and commit the skill once.

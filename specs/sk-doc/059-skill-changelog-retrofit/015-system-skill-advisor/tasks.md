...
- [ ] T002 Confirm the system-skill-advisor files are clean in git before the run (`../scratch/lists/system-skill-advisor.txt`)
<!-- /ANCHOR:phase-1 -->
...
- [ ] T003 Run the driver over the list (`../scratch/rewrite-driver.cjs --list ../scratch/lists/system-skill-advisor.txt --state ../scratch/state.jsonl`)
...
- [ ] T007 Commit the kept system-skill-advisor files only, then run `compiled-route-guard.cjs` and each mirror generator's `--check`

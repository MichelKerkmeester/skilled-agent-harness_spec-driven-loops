...
- [ ] T002 Confirm the sk-code files are clean in git before the run (`../scratch/lists/sk-code.txt`)
<!-- /ANCHOR:phase-1 -->
...
- [ ] T003 Run the driver over the list (`../scratch/rewrite-driver.cjs --list ../scratch/lists/sk-code.txt --state ../scratch/state.jsonl`)
...
- [ ] T007 Commit the kept sk-code files only, then run `compiled-route-guard.cjs` and each mirror generator's `--check`

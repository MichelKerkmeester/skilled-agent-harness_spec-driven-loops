---
title: "Implementation Plan: Phase 7: sk-code changelogs"
description: "Runs the phase 001 driver over the 29 listed sk-code changelogs on two lanes, keeps each rewrite only when all three gates pass, then commits the skill once."
trigger_phrases:
  - "sk-code changelog rewrite plan"
importance_tier: "normal"
contextType: "implementation"
---
<!-- SPECKIT_TEMPLATE_SOURCE: plan-core | v2.2 -->
# Implementation Plan: Phase 7: sk-code changelogs
...
- [x] The target list exists at `../scratch/lists/sk-code.txt`
...
- [ ] The sk-code commit is pushed, with routing and mirrors fresh
<!-- /ANCHOR:quality-gates -->
...
### Key Components
- **`../scratch/rewrite-driver.cjs`**: run as `--list ../scratch/lists/sk-code.txt --state ../scratch/state.jsonl`
...
Before the commit, restore a file from `../scratch/orig/` or with `git checkout -- <file>`. After it, revert the sk-code commit.
<!-- /ANCHOR:rollback -->

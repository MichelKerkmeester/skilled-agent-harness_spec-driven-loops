...
description: "Not started. This phase rewrites the 14 listed sk-prompt changelogs once phase 001's pilot style is approved."
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "Planned the sk-prompt wave"
...
Nothing yet. The operator approved the pilot style on 2026-09-24, and this wave has not run. Its target list, `../scratch/lists/sk-prompt.txt`, is in place.

### Phase 12: sk-prompt changelogs

The wave will rewrite the 14 listed changelogs, keep each one only when all three gates pass, and commit the skill once.

---
title: "Implementation Plan: Phase 4: cli-orca changelogs"
description: "Runs the phase 001 driver over the 1 listed cli-orca changelog on two lanes, keeps each rewrite only when all three gates pass, then commits the skill once."
trigger_phrases:
  - "cli-orca changelog rewrite plan"
importance_tier: "normal"
contextType: "implementation"
---
<!-- SPECKIT_TEMPLATE_SOURCE: plan-core | v2.2 -->
# Implementation Plan: Phase 4: cli-orca changelogs
...
### Key Components
- **`../scratch/rewrite-driver.cjs`**: run as `--list ../scratch/lists/cli-orca.txt --state ../scratch/state.jsonl`
...
Before the commit, restore a file from `../scratch/orig/` or with `git checkout -- <file>`. After it, revert the cli-orca commit.
<!-- /ANCHOR:rollback -->

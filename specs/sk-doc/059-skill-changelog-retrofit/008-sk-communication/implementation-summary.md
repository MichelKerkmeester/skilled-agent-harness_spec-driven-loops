...
description: "Not started. This phase rewrites the 4 listed sk-communication changelogs once phase 001's pilot style is approved."
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "Planned the sk-communication wave"
...
Nothing yet. The operator approved the pilot style on 2026-09-24, and this wave has not run. Its target list, `../scratch/lists/sk-communication.txt`, is in place.

### Phase 8: sk-communication changelogs

The wave will rewrite the 4 listed changelogs, keep each one only when all three gates pass, and commit the skill once.

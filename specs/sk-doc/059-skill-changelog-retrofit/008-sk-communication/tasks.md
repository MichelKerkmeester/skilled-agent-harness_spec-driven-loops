...
- [ ] T002 Confirm the sk-communication files are clean in git before the run (`../scratch/lists/sk-communication.txt`)
<!-- /ANCHOR:phase-1 -->
...
- [ ] T003 Run the driver over the list (`../scratch/rewrite-driver.cjs --list ../scratch/lists/sk-communication.txt --state ../scratch/state.jsonl`)
...
- [ ] T007 Commit the kept sk-communication files only, then run `compiled-route-guard.cjs` and each mirror generator's `--check`

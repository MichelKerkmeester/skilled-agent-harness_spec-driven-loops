---
title: "Implementation Plan: Phase 6: mcp-tooling changelogs"
description: "Runs the phase 001 driver over the 55 listed mcp-tooling changelogs on two lanes, keeps each rewrite only when all three gates pass, then commits the skill once."
trigger_phrases:
  - "mcp-tooling changelog rewrite plan"
importance_tier: "normal"
contextType: "implementation"
---
<!-- SPECKIT_TEMPLATE_SOURCE: plan-core | v2.2 -->
# Implementation Plan: Phase 6: mcp-tooling changelogs
...
- [ ] The mcp-tooling commit is pushed, with routing and mirrors fresh
<!-- /ANCHOR:quality-gates -->
...
### Key Components
- **`../scratch/rewrite-driver.cjs`**: run as `--list ../scratch/lists/mcp-tooling.txt --state ../scratch/state.jsonl`
...
Before the commit, restore a file from `../scratch/orig/` or with `git checkout -- <file>`. After it, revert the mcp-tooling commit.
<!-- /ANCHOR:rollback -->

...
description: "Not started. This phase rewrites the 55 listed mcp-tooling changelogs once phase 001's pilot style is approved."
trigger_phrases:
...
The wave will rewrite the 55 listed changelogs, keep each one only when all three gates pass, and commit the skill once.

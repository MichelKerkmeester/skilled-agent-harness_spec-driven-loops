...
**Scope Boundary**: The 89 system-deep-loop changelogs listed in `../scratch/lists/system-deep-loop.txt`. The pilot restored deep-improvement v1.2.0.0 after two failed attempts, so it goes back through the driver with `--retry-failed`.

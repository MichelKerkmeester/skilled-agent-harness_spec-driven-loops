...
- [ ] T003 Run the driver over the list (`../scratch/rewrite-driver.cjs --list ../scratch/lists/system-deep-loop.txt --state ../scratch/state.jsonl`)
...
- [ ] T007 Commit the kept system-deep-loop files only, then run `compiled-route-guard.cjs` and each mirror generator's `--check`

---
title: "Implementation Plan: Phase 5: mcp-code-mode changelogs"
description: "Runs the phase 001 driver over the 9 listed mcp-code-mode changelogs on two lanes, keeps each rewrite only when all three gates pass, then commits the skill once."
trigger_phrases:
  - "mcp-code-mode changelog rewrite plan"
importance_tier: "normal"
contextType: "implementation"
---
<!-- SPECKIT_TEMPLATE_SOURCE: plan-core | v2.2 -->
# Implementation Plan: Phase 5: mcp-code-mode changelogs
...
- [x] The target list exists at `../scratch/lists/mcp-code-mode.txt`
...
- [ ] The mcp-code-mode commit is pushed, with routing and mirrors fresh
<!-- /ANCHOR:quality-gates -->
...
### Key Components
- **`../scratch/rewrite-driver.cjs`**: run as `--list ../scratch/lists/mcp-code-mode.txt --state ../scratch/state.jsonl`
...
Before the commit, restore a file from `../scratch/orig/` or with `git checkout -- <file>`. After it, revert the mcp-code-mode commit.
<!-- /ANCHOR:rollback -->

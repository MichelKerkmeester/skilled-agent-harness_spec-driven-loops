...
| Field | Value |
|-------|-------|
| **Spec Folder** | 001-repo-rules-router |
| **Status** | Complete |
...
| `specs/sk-doc/040-create-repo-rules/001-repo-rules-router/*` | Created | Level 2 packet: spec, plan, tasks, acceptance criteria, this summary |

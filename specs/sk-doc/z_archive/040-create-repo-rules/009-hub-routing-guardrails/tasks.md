---
title: "Tasks: Phase 9: Hub-Routing Guardrails"
...
# Tasks: Phase 9: Hub-Routing Guardrails
...
- [x] T003 [P] Read the parent-hub doctrine and the rule anatomy contract
<!-- /ANCHOR:phase-1 -->
...
- [x] T004 Add the one-identity / two-stage clause to the always-loaded document
- [x] T005 Author the ten-surface checklist in the hub doctrine document
- [x] T006 Author the hub-routing repo rule and wire its trigger and index rows
- [x] T007 Add check 6b and the no-argument notice, prove both with a negative control
<!-- /ANCHOR:phase-2 -->

...
_memory:
  continuity:
    ...
    answered_questions:
      ...
      - "The remediation is recorded as its own child under 016-create-diff-mode, cross-linked to 006."
---
...
| `.opencode/specs/sk-doc/016-create-diff-mode/006-opencode-skill-and-accessibility/implementation-summary.md` | Modify | Correct warnings count + WCAG note; cross-link 008. |
<!-- /ANCHOR:scope -->
...
- **SC-003**: `validate.sh --recursive --strict` on the 033 parent stays 0 errors / 0 warnings; canon gates (package_skill, parent-skill-check, comment-hygiene) stay clean.
<!-- /ANCHOR:success-criteria -->

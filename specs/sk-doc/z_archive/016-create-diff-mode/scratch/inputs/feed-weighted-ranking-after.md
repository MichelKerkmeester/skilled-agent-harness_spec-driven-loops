---
title: "Fv2 - Weighted Ranking v2 & Intelligent Discovery"
trigger_phrases: []
---
# Fv2 - Weighted Ranking v2 & Intelligent Discovery
...
The v2 revision introduces a decay-aware freshness term and swaps the static
category boost for a per-user affinity multiplier learned from save/skip events.
...
Why this works well:
*   A deal that misses a filter still surfaces if it scores well on other behavioural signals.
...
Alongside new capabilities like semantic similarity, adaptive serendipitous discovery and impression-awareness.

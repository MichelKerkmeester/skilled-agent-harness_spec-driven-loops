---
title: "Implementation Plan: Rename the sk-design mode packets to the sk- prefix"
...
# Implementation Plan: Rename the sk-design mode packets to the sk- prefix
...
| **Executor** | GPT-5.6-LUNA xhigh (cli-codex), full move+edit pass |

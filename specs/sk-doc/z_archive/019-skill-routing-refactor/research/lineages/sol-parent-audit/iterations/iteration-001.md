---
title: "Iteration 001 — Live phase-tree inventory"
trigger_phrases: []
---
...
- Group A: `002-router-audit-and-fix-map` through `005-router-standardization-and-regen`.
- Group B: `006-create-skill-smart-routing-notes` through `010-create-packet-routing-conformance`.
- Group C: `001-research/001-sk-doc-routing-research` through `013-benchmark-harness-typed-wiring`.
- Group D: `014-sk-code-router-alignment` through `001-research/006-sk-prompt-routing-research`.
- Group E: `015-router-unification-program`.
- Group F: `016-documentation-quality-program`.
...
- `015-router-unification-program` is a phase parent with seven direct children, `001`–`007`. [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/015-router-unification-program/graph-metadata.json:6]
- `020/.../005-oob-idea-deep-dives` is a phase parent with eight direct children, `001`–`008`. [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/001-research/009-oob-idea-deep-dives/graph-metadata.json:6]
- `020/.../007-unified-refactor-implementation` is a phase parent with 16 direct child directories. Its numeric prefixes span `000`–`015` but are not unique because two siblings use `012`. [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/015-router-unification-program/003-unified-refactor-implementation/graph-metadata.json:6] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/015-router-unification-program/003-unified-refactor-implementation/graph-metadata.json:19]
- Within `020/.../007`, phase parents are `005-calibration` (3 children), `006-parent-hub-rollout` (7), `009-non-hub-rollout` (4), and `015-routing-coverage-activation-verification` (14). [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/015-router-unification-program/003-unified-refactor-implementation/005-calibration/graph-metadata.json:6] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/015-router-unification-program/003-unified-refactor-implementation/006-parent-hub-rollout/graph-metadata.json:6] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/015-router-unification-program/003-unified-refactor-implementation/009-non-hub-rollout/graph-metadata.json:6] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/015-router-unification-program/003-unified-refactor-implementation/015-routing-coverage-activation-verification/graph-metadata.json:6]
- `016-documentation-quality-program` is a phase parent with 11 direct children, `001`–`011`. [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/016-documentation-quality-program/graph-metadata.json:6]

The two potentially ambiguous facts are now resolved. The duplicate `012` collision is below `020/007`, not at the root `001`–`021` layer, and its local phase map explicitly acknowledges it. [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/015-router-unification-program/003-unified-refactor-implementation/spec.md:50] The direct child `014-sk-code-router-alignment` is not a phase parent (`children_ids` is empty); the phase parent named `015` is the deeper `020/007/015-routing-coverage-activation-verification` packet. [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/014-sk-code-router-alignment/graph-metadata.json:6] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/015-router-unification-program/003-unified-refactor-implementation/015-routing-coverage-activation-verification/graph-metadata.json:6]
...
- Parent `015` says `In progress`, while the child `spec.md` and graph both say `Planned`; its implementation summary separately says `IN PROGRESS (~70%)`. [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/spec.md:110] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/014-sk-code-router-alignment/spec.md:60] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/014-sk-code-router-alignment/graph-metadata.json:42] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/014-sk-code-router-alignment/implementation-summary.md:52]
- Parent `018` says `In progress`, while the child `spec.md` and graph say `Planned`; its implementation summary says research is in progress at 0%. [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/spec.md:113] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/001-research/005-system-deep-loop-routing-research/spec.md:46] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/001-research/005-system-deep-loop-routing-research/graph-metadata.json:42] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/001-research/005-system-deep-loop-routing-research/implementation-summary.md:54]
- Parent `019` says `Research-complete` and the child spec agrees, but child graph metadata remains `in_progress`. [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/spec.md:114] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/001-research/006-sk-prompt-routing-research/spec.md:46] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/001-research/006-sk-prompt-routing-research/graph-metadata.json:42]
- Parent `020` says `Active (nested program)` and `021` says `In progress (nested program)`, while both child-parent graphs say `planned`. Their descendant docs substantiate that work is active, so the parent labels are more current than the graph values rather than demonstrably wrong. [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/spec.md:115] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/015-router-unification-program/graph-metadata.json:41] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/016-documentation-quality-program/graph-metadata.json:45] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/016-documentation-quality-program/spec.md:15]
...
- Which `015` is a phase parent? The nested `020/007/015`; direct root child `014-sk-code-router-alignment` is a standard packet.
...
- A hypothesis that direct root child `014-sk-code-router-alignment` is a phase parent was ruled out by its empty `children_ids`; the similarly numbered nested `015` is the phase parent.

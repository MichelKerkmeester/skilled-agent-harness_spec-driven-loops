---
title: "Iteration 3: Commit 3c94775856, metrics, and links"
trigger_phrases: []
---
# Iteration 3: Commit 3c94775856, metrics, and links

## Focus
The just-landed parent-document fixes, route-gold metrics, stale cross-references, and root-aware Markdown links.

## Actions Taken
- Diffed every changed parent `spec.md`, `context-index.md`, `description.json`, `graph-metadata.json`, `routing-before-after.md`, and `routing-config-and-advisor-reference.md` line-by-line against `3c94775856^`.
...
- `git diff 3c94775856^ 3c94775856 -- parent documents`

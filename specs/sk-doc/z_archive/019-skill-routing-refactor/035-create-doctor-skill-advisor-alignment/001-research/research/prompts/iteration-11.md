...
Questions: 0/5 answered | Last focus: Should the read-only route automatically select the Git primary checkout for the hook check, or show it and require an explicit --repo confirmation? This remains separate from whether repair commands require approval.
Last 2 ratios: 0.87 -> 0.82 | Stuck count: 0
Resource map: resource-map.md not present; skipping coverage gate.
Memory context refresh: none loaded yet.
Next focus: How `/create:skill-parent` and `/doctor:skill-advisor` should expose the same canonical-checkout/index handoff while leaving advisor rebuild and graph scan mutations operator-owned.

Research Topic: align create/doctor commands with skill-advisor index for easy skill creation
Iteration: 11 of 20
Focus Area: How `/create:skill-parent` and `/doctor:skill-advisor` should expose the same canonical-checkout/index handoff while leaving advisor rebuild and graph scan mutations operator-owned.
...
- Write iteration narrative to: .opencode/specs/sk-doc/019-skill-routing-refactor/035-create-doctor-skill-advisor-alignment/001-research/research/iterations/iteration-011.md
- Write per-iteration delta file to: .opencode/specs/sk-doc/019-skill-routing-refactor/035-create-doctor-skill-advisor-alignment/001-research/research/deltas/iter-011.jsonl
...
- **ALLOWED WRITE PATHS (the ONLY paths you may create, modify, or append to)**:
  - `.opencode/specs/sk-doc/019-skill-routing-refactor/035-create-doctor-skill-advisor-alignment/001-research/research/iterations/iteration-011.md`, this iteration's narrative markdown
  ...
  - `.opencode/specs/sk-doc/019-skill-routing-refactor/035-create-doctor-skill-advisor-alignment/001-research/research/deltas/iter-011.jsonl`, this iteration's delta JSONL

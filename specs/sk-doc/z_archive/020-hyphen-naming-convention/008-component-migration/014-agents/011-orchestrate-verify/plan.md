---
title: "Implementation [sk-doc/020-hyphen-naming-convention/008-component-migration/014-agents/011-orchestrate-verify/plan]"
description: "Implementation Plan for phase 011 of the 020 agents component migration: a read-only orchestrate filename candidate audit."
trigger_phrases:
  - "orchestrate agent naming implementation plan"
  - "agents phase 011 implementation plan"
...
---
# Implementation Plan: Orchestrate Agent Naming Verification
...
- [ ] The expected orchestrate definition paths are listed in spec.md
...
- OpenCode definition: .opencode/agents/orchestrate.md
- Claude definition: .claude/agents/orchestrate.md
- Codex definition: .codex/agents/orchestrate.toml
...
- Confirm all three expected orchestrate definition paths exist in the runtime inventory.
...
|-------------|--------------|
| REQ-001 | Path-level inventory lists .opencode/agents/orchestrate.md, .claude/agents/orchestrate.md, and .codex/agents/orchestrate.toml |

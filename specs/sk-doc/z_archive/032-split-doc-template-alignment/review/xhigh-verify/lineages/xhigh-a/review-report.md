  ...
  "activeFindings": [
    ...
    },
    {
      ...
      "evidenceRefs": [
        ...
        ".opencode/specs/sk-doc/032-split-doc-template-alignment/implementation-summary.md:65"
      ]
    },
    {
      "findingId": "F003",
      ...
      "evidenceRefs": [
        ".opencode/specs/sk-doc/032-split-doc-template-alignment/checklist.md:23-60",
        ".opencode/specs/sk-doc/032-split-doc-template-alignment/tasks.md:23-54"
      ]
    },
    {
      "findingId": "F004",
      ...
      "evidenceRefs": [
        ".opencode/specs/sk-doc/032-split-doc-template-alignment/implementation-summary.md:65-76",
        ".opencode/specs/sk-doc/032-split-doc-template-alignment/checklist.md:47-52"
      ]
    }
  ],
...
- **Evidence:** the file moves from H1/intro directly to `### Error Style`; the required `## 1. OVERVIEW`, Purpose, and When to Use are absent. R3 requires that structure [SOURCE: `.opencode/specs/sk-doc/032-split-doc-template-alignment/spec.md:67-71`], and the canonical template defines it [SOURCE: `.opencode/skills/sk-doc/create-skill/assets/skill/skill_reference_template.md:54-87`].
...
- **Evidence:** Purpose repeats the intro's core statement as a strict semantic subset, despite the template's explicit non-duplication rule [SOURCE: `.opencode/skills/sk-doc/create-skill/assets/skill/skill_reference_template.md:84-87`] and the zero-duplicate remediation claim [SOURCE: `.opencode/specs/sk-doc/032-split-doc-template-alignment/implementation-summary.md:65`].
...
- **Scope proof:** the validator enumerated the full 25-row gap matrix [SOURCE: `.opencode/specs/sk-doc/032-split-doc-template-alignment/tasks.md:23-54`].
...
- **Dimension:** traceability
- **File:** `.opencode/specs/sk-doc/032-split-doc-template-alignment/implementation-summary.md:65-76`
- **Evidence:** the decision narrative says the claim was narrowed, but the table still says `Broken relative .md links (whole hub) | 0`. The checklist correctly records two pre-existing/out-of-scope link-shaped artifacts [SOURCE: `.opencode/specs/sk-doc/032-split-doc-template-alignment/checklist.md:47-52`].

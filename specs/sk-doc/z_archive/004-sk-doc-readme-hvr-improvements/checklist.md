...
- [ ] CHK-003 [P1] Exemplar README patterns extracted from `.opencode/skills/system-spec-kit/README.md`, `.opencode/skills/system-spec-kit/mcp_server/README.md`, and `.opencode/skills/system-spec-kit/SHARED_MEMORY_DATABASE.md`
- [ ] CHK-004 [P1] Template source and modeling references confirmed in `.opencode/skills/sk-doc/assets/skill/skill_reference_template.md` and `.opencode/skills/sk-doc/references/specific/install_guide_creation.md`
<!-- /ANCHOR:pre-impl -->
...
### D1: HVR Rules
- [ ] CHK-010 [P0] `.opencode/skills/sk-doc/references/global/hvr_rules.md` keeps valid frontmatter and numbered H2 sections
...
- [ ] CHK-013 [P1] Related cli-codex notes in `.opencode/skills/cli-codex/SKILL.md` and `.opencode/skills/cli-codex/assets/prompt_templates.md` are cited accurately
<!-- /ANCHOR:code-quality -->
...
### D2: README Template
- [ ] CHK-020 [P0] `.opencode/skills/sk-doc/assets/documentation/readme_template.md` is cited with the correct repo path
...
- [ ] CHK-030 [P0] `.opencode/skills/sk-doc/references/specific/readme_creation.md` is cited with the correct repo path
...
- [ ] CHK-042 [P1] cli-codex follow-up references remain aligned with `.opencode/skills/cli-codex/SKILL.md` and `.opencode/skills/cli-codex/assets/prompt_templates.md`

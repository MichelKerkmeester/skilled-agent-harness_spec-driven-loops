...
> Phase adjacency — predecessor `008-system-spec-kit`; successor `010-system-code-graph`.
...
| Field | Value |
|-------|-------|
| **Packet** | sk-doc/020-hyphen-naming-convention/008-component-migration/009-system-skill-advisor |

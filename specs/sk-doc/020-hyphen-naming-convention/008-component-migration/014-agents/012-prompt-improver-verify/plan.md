---
title: "Implementation Plan: verify prompt-improver agent naming (020 phase 012)"
description: "Implementation Plan for phase 012 of the 020 agents component migration: a read-only prompt-improver filename candidate audit."
trigger_phrases:
  - "prompt-improver agent naming implementation plan"
  - "agents phase 012 implementation plan"
...
# Implementation Plan: Prompt Improver Agent Naming Verification
...
- [ ] The expected prompt-improver definition paths are listed in spec.md
...
- OpenCode definition: .opencode/agents/prompt-improver.md
- Claude definition: .claude/agents/prompt-improver.md
- Codex definition: .codex/agents/prompt-improver.toml
...
- Confirm all three expected prompt-improver definition paths exist in the runtime inventory.
...
|-------------|--------------|
| REQ-001 | Path-level inventory lists .opencode/agents/prompt-improver.md, .claude/agents/prompt-improver.md, and .codex/agents/prompt-improver.toml |

---
title: "Implementation [sk-doc/020-hyphen-naming-convention/008-component-migration/014-agents/007-deep-research-verify/plan]"
description: "Implementation Plan for phase 007 of the 020 agents component migration: a read-only deep-research filename candidate audit."
trigger_phrases:
  - "deep-research agent naming implementation plan"
  - "agents phase 007 implementation plan"
...
---
# Implementation Plan: Deep Research Agent Naming Verification
...
- [ ] The expected deep-research definition paths are listed in spec.md
...
- OpenCode definition: .opencode/agents/deep-research.md
- Claude definition: .claude/agents/deep-research.md
- Codex definition: .codex/agents/deep-research.toml
...
- Confirm all three expected deep-research definition paths exist in the runtime inventory.
...
|-------------|--------------|
| REQ-001 | Path-level inventory lists .opencode/agents/deep-research.md, .claude/agents/deep-research.md, and .codex/agents/deep-research.toml |

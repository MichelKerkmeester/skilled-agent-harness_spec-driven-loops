...
# Verification Checklist: Review Agent Naming Verification
...
- [ ] CHK-001 [P0] The pinned BASE and all three runtime agent directories are available for the review inventory
...
- [ ] CHK-005 [P0] The inventory records exactly .opencode/agents/review.md, .claude/agents/review.md, and .codex/agents/review.toml

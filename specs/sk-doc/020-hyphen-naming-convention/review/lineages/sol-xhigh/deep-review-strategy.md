...
Review the complete planning packet at `.opencode/specs/sk-doc/020-hyphen-naming-convention` for correctness, security, traceability, and maintainability. The review target is read-only.
...
- Behavior claims: 032 is a phase parent for a repo-wide filesystem naming migration; the phase topology and dependency sequencing must be executable and internally consistent.

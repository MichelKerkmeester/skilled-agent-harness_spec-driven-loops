...
Even after F001 is corrected, this duplicate partial map will remain an ambiguous operator contract. It creates a second manual source of truth for phase navigation and progress.

Finding F003 is open at P2. Remove the duplicate map or generate a single map from the authoritative graph/manifest.

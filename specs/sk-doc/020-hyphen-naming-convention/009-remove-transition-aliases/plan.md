...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/sk-doc/020-hyphen-naming-convention/002-root-name-consumer-migration/checklist.md"
      - ".opencode/specs/sk-doc/020-hyphen-naming-convention/009-remove-transition-aliases/spec.md"
    completion_pct: 0
    open_questions: []
    answered_questions:

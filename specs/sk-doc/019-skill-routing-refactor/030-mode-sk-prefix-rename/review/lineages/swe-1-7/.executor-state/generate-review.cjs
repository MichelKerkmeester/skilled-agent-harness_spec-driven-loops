...
const ARTIFACT = '/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.worktrees/0114-sk-doc-mode-sk-prefix-rename/.opencode/specs/sk-doc/019-skill-routing-refactor/030-mode-sk-prefix-rename/review/lineages/swe-1-7';
...
const plan = [
  ...
  { n: 10, focus: 'Synthesis: aggregate findings and final verdict', dimension: 'synthesis', files: ['.opencode/specs/sk-doc/019-skill-routing-refactor/030-mode-sk-prefix-rename/spec.md', '.opencode/specs/sk-doc/019-skill-routing-refactor/030-mode-sk-prefix-rename/008-verification-and-closeout/implementation-summary.md', '.opencode/specs/sk-doc/019-skill-routing-refactor/030-mode-sk-prefix-rename/assets/rename-map.json'], findings: [], verdict: 'CONDITIONAL', next: 'none' }
];

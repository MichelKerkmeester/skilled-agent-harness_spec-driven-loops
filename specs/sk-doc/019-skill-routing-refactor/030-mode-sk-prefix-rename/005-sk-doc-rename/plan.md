---
title: "Implementation Plan: Rename the sk-doc mode packets to the sk- prefix"
...
# Implementation Plan: Rename the sk-doc mode packets to the sk- prefix
...
| **Executor** | GPT-5.6-LUNA xhigh (cli-codex) edit pass after orchestrator moves |

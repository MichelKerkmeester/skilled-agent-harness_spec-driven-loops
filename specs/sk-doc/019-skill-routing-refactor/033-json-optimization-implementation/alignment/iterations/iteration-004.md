...
- P1: The live sk-doc validator resolves template-rules.json under the absent hub-root assets directory and exits before reading this artifact.
- P1: The live sk-doc validator resolves template-rules.json under the absent hub-root assets directory and exits before reading this artifact.
- P1: The live sk-doc validator resolves template-rules.json under the absent hub-root assets directory and exits before reading this artifact.
- P1: The live sk-doc validator resolves template-rules.json under the absent hub-root assets directory and exits before reading this artifact.
- P1: The live sk-doc validator resolves template-rules.json under the absent hub-root assets directory and exits before reading this artifact.
...
- P2: shadow-diff.md is classified as generic and its unnumbered mixed-case H2s, missing dividers, and absent intro keep its deterministic DQI below the 75 floor.

## Summary

P0=0, P1=8, P2=1; template validation is blocked for all audited artifacts, and shadow-diff is below the deterministic DQI floor.

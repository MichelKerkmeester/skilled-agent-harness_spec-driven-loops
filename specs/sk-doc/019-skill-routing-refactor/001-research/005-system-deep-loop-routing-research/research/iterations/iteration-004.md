---
title: "Iteration 4: Deterministic Scenario Census and Routing Partition"
trigger_phrases: []
---
...
4. The committed evidence is contradictory about hub corpus size: the playbook and baseline report describe 18 rows (14 routing plus 4 browser), while the benchmark README says 20 and 16 routing plus 4 browser. The playbook index and machine-readable baseline agree, so **18 (14+4)** is the better-supported current count; the README's 20 is stale or refers to an uncommitted/later corpus state. [SOURCE: `.opencode/skills/system-deep-loop/manual_testing_playbook/manual_testing_playbook.md:201-225`] [SOURCE: `.opencode/skills/system-deep-loop/benchmark/reports/baseline/skill-benchmark-report.json:153-164`] [SOURCE: `.opencode/skills/system-deep-loop/benchmark/README.md:27-42`]
...
- `.opencode/skills/system-deep-loop/benchmark/reports/baseline/skill-benchmark-report.json:153-164`

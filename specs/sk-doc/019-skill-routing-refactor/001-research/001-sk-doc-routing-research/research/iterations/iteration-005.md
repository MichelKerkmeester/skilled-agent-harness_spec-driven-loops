---
title: "Iteration 5: Trace validator coverage from hub registry to benchmark evidence"
trigger_phrases: []
---
...
The D5 orphan inventory is also root-local: `listMarkdownRefs(skillRoot)` recursively scans only that root's `references/` and `assets/` directories. When invoked for `sk-doc`, it does not enumerate `create-*` packet leaves or `shared/` leaves. [SOURCE: .opencode/skills/system-deep-loop/deep-improvement/scripts/skill-benchmark/d5-connectivity.cjs:53] [SOURCE: .opencode/skills/system-deep-loop/deep-improvement/scripts/skill-benchmark/d5-connectivity.cjs:68] The live hub and emitted parent-hub template stop at packet `SKILL.md` entrypoints, which iteration 4 already established. [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/001-research/001-sk-doc-routing-research/research/iterations/iteration-004.md:53] [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/001-research/001-sk-doc-routing-research/research/iterations/iteration-004.md:57]

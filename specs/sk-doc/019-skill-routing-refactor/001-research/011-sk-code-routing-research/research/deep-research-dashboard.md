...
- **Treating `routing_contract_error` as the cause of low recall:** unresolved preamble entries explain the error class, but baseline hit/expected counts independently show missed expected leaves. [SOURCE: .opencode/skills/sk-code/benchmark/reports/baseline/skill-benchmark-report.json:431-440] [SOURCE: .opencode/skills/sk-code/benchmark/reports/baseline/skill-benchmark-report.json:1620-1629] (iteration 1)
...
- Using the current baseline's fitted score as evidence of holdout generalization: its holdout partition is empty. [SOURCE: .opencode/skills/sk-code/benchmark/reports/baseline/skill-benchmark-report.json:1-65] (iteration 2)
...
- Accepting fitted-score improvement without a non-empty sealed holdout partition; the current null holdout cannot prove generalization. [SOURCE: .opencode/skills/sk-code/benchmark/reports/baseline/skill-benchmark-report.json:13-20] (iteration 7)
...
- Treating generated report JSON, manifest edits, or typed-error removal as raw recall gain; those artifacts can change without selecting a missing expected leaf. [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/014-sk-code-router-alignment/research/iterations/iteration-006.md:15-17] (iteration 7)
...
- An ordinary `shared` registry mode as an identity-only fix: it changes hub topology and therefore cannot inherit the raw-route/surface-invariance claim. [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/014-sk-code-router-alignment/research/findings-registry.json:463-488] (iteration 8)
...
- Re-running deterministic traces or editing generated manifest/report JSON to claim recall; both directions are already exhausted and do not measure live use or select a missing raw leaf. [SOURCE: .opencode/specs/sk-doc/019-skill-routing-refactor/014-sk-code-router-alignment/research/deep-research-strategy.md:117-135] (iteration 8)

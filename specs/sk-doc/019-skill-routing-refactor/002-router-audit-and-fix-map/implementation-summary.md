...
_memory:
  continuity:
    packet_pointer: "sk-doc/019-skill-routing-refactor/002-router-audit-and-fix-map"
    ...
    session_dedup:
      ...
      session_id: "scaffold-scaffold/002-router-audit-and-fix-map"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 002-router-audit-and-fix-map |

...
Memory context refresh: startup context unavailable; use the verified baseline and repository evidence.
Next focus: Q1 — activation-manifest ownership.

Research Topic: Decide the best next move for the compiled-routing subsystem.
Iteration: 1 of 5
Focus Area: Compare authored-only, runtime-authoritative, and a better third activation-manifest ownership model.
Remaining Key Questions: Q1 through Q5 in the strategy file.
Carried-Forward Open Questions: all five ordered questions.
Last 3 Iterations Summary: none.
Pivot Lineage: none.
Saturated Directions: do not re-establish the verified baseline unless contradicted.
...
- Write narrative: `.opencode/specs/sk-doc/019-skill-routing-refactor/020-compiled-routing-next-move/research/lineages/sol/iterations/iteration-001.md`
- Write delta: `.opencode/specs/sk-doc/019-skill-routing-refactor/020-compiled-routing-next-move/research/lineages/sol/deltas/iter-001.jsonl`

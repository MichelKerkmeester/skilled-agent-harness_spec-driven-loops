...
- Previous phase: [`002-reference-asset-template-alignment`](../002-reference-asset-template-alignment/spec.md). Next phase: [`004-skill-mode-readme-overhaul`](../004-skill-mode-readme-overhaul/spec.md).

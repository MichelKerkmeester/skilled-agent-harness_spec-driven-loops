// ╔══════════════════════════════════════════════════════════════════════════╗
// ║ LIBRARY: CLI JEV REGISTRY COMPILER                  ║
// ╚══════════════════════════════════════════════════════════════════════════╝
'use strict';
...
function assertSourceIdentity(input) {
  const registryId = 'cli-jev/mode-registry.json';
  const routerId = 'cli-jev/hub-router.json';
  const skillId = 'cli-jev/SKILL.md';
  ...
  for (const mode of input.registry.modes) {
    const packetId = `cli-jev/${mode.packet}/SKILL.md`;

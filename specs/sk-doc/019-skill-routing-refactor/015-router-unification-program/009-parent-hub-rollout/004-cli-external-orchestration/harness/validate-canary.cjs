...
const PROTECTED_DIGESTS = Object.freeze({
  ...
  'router-replay.cjs':
    '14f169a466d970648f46f0f312904cc682221d1adfdedef97264398ffc9124d9',
...
function assertSingleRouteCoverage(covered) {
  const registry = readJson(path.join(path.join(REPO_ROOT, '.opencode', 'skills', 'cli-external-orchestration'), 'mode-registry.json'));

...
| **Level** | 2 |
| **Priority** | P3 |
| **Status** | Implemented — committed in `bb2fcbbd27` (see `implementation-summary.md`; topology resolved as Option A) |
| **Created** | 2026-07-20 |

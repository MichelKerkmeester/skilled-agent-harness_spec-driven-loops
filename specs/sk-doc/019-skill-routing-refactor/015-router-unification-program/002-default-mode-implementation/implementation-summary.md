...
| Field | Value |
|-------|-------|
| **Spec Folder** | 002-default-mode-implementation |
...
- **Live measurement** — a sol-ultra 2x4 keep-vs-null benchmark (from research child `001-research/007-default-mode-policy-research`) would turn "directional" into "measured"; not yet run.
<!-- /ANCHOR:limitations -->

...
## Questions Remaining
- Does `3c94775856` leave any new wrong metric, stale link, or changed claim beyond these pre-existing contradictions?
...
Diff every parent document touched by `3c94775856` against its parent revision and run a root-aware markdown-link audit over the non-excluded tree.

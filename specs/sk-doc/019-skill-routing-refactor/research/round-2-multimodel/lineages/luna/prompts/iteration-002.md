...
Focus: coverage claims for `smart-routing.md`, `leaf-manifest.json`, and the compiled serving authority; whether hub-router policy is telemetry-only or is consumed by the compiled serving engines; and whether commit `3c94775856` introduced either defect.

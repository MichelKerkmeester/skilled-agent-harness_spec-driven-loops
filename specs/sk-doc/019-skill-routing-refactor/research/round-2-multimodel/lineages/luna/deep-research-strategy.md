...
- Which cross-document links are broken after 3c94775856? (iteration 1)
...
- Does `3c94775856` leave any new wrong metric, stale link, or changed claim beyond these pre-existing contradictions? (iteration 2)

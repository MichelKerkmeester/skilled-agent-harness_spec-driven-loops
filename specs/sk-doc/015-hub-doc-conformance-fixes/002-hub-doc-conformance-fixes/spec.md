---
title: "Feature Specification: Hub Doc Conformance Fixes [015-hub-doc-conformance-fixes/002-hub-doc-conformance-fixes]"
description: "Remediation PLAN for the 015-hub-doc-conformance-fixes/001-hub-doc-conformance-review deep-review FAIL verdict: 102 P0 / 5 P1 / 4 P2 raw findings (67 P0 / 4 P1 / 2 P2 distinct, deduped finding IDs) against cli-external + mcp-tooling hub docs. Planning + spec only -- no doc edits, no routing-layer changes."
trigger_phrases:
...
|-----------|-------------|-------------|
| `015-hub-doc-conformance-fixes/002-hub-doc-conformance-fixes/{spec,plan,tasks,checklist,decision-record}.md` | Create | The remediation plan itself -- the only files this packet writes. |
...
- **SC-004**: `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/sk-doc/015-hub-doc-conformance-fixes/002-hub-doc-conformance-fixes --strict` returns `Errors: 0` / `Warnings: 0`.
<!-- /ANCHOR:success-criteria -->
...
- **Source Review**: `.opencode/specs/sk-doc/015-hub-doc-conformance-fixes/001-hub-doc-conformance-review/review/`

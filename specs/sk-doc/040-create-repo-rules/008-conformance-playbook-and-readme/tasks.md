---
title: "Tasks: Phase 8: Conformance, Playbook and README"
...
# Tasks: Phase 8: Conformance, Playbook and README
...
- [x] T003 [P] Read the HVR standard and the sibling README skeleton
<!-- /ANCHOR:phase-1 -->
...
- [x] T004 Audit the packet against the sk-create-skill ALWAYS and NEVER rules and fix ALWAYS-7
- [x] T005 Author the root playbook: directory, preconditions, evidence, grading and orchestration
- [x] T006 Author ten per-feature scenario files across three category folders
- [x] T007 Run every bash command against the live corpus and repair the three that failed
<!-- /ANCHOR:phase-2 -->

...
- [x] CHK-033 [P1] P2-014-001's fix left a residual gap (a 3rd file, `feature_catalog/reading/read-only-content.md`, with the identical stale "always safe" claim) flagged by the independent verifier — closed directly, then swept the whole packet to confirm no 4th instance remained (verified)

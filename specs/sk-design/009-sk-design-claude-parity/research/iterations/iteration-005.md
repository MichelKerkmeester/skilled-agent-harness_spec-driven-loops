---
title: "Iteration 5: Backend / Operating Model"
trigger_phrases: []
---
...
## Ruled Out
- **Literal verifier-subagent dependency**: ruled out because the requested leaf/no-subagent constraint and Codex variant both show the same cadence can be implemented as self-verification when subagents are unavailable. [SOURCE: .opencode/specs/sk-design/009-sk-design-claude-parity/external/codex/system-prompt.md:577] [SOURCE: .opencode/specs/sk-design/009-sk-design-claude-parity/external/codex/AGENTS.md:7]
...
- `.opencode/specs/sk-design/009-sk-design-claude-parity/research/iterations/iteration-004.md`
- `.opencode/specs/sk-design/009-sk-design-claude-parity/external/claude/system-prompt.md`

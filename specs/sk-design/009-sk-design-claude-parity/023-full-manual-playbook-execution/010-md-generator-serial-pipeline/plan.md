...
|---------|--------------|--------|--------------|
| `.opencode/skills/sk-design/manual_testing_playbook/mode-routing/`, `advisor-integration/`, `parity-behavior/`, `md-generator-pipeline/`, `fallback-and-resilience/` | Scenario source | Read-only, no edits | Full-file reads before dispatching |

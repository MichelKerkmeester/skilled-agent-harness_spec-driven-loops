...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/skills/sk-design/benchmark/reports/2026-07-07--after-018-transport-integration--live/report.json"
    session_dedup:
...
| `.opencode/skills/sk-design/benchmark/reports/2026-07-07--after-018-transport-integration--live/{report.json,report.md}` | Created | Fresh live-mode benchmark baseline |
<!-- /ANCHOR:what-built -->

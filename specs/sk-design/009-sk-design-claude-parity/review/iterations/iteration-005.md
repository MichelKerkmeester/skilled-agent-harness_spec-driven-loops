...
- Naming mismatch: The two markdown reports render the same report title, verdict, coverage, scores, scenario rows, and caveats, but one folder uses `report.md` while the other uses `skill-benchmark-report.md`. Evidence: `.opencode/skills/sk-design/benchmark/reports/2026-07-06--after-012-routing-rigor--router/report.md:1`, `.opencode/skills/sk-design/benchmark/reports/2026-07-06--after-d3-proxy--router/skill-benchmark-report.md:1`, `.opencode/skills/sk-design/benchmark/reports/2026-07-06--after-012-routing-rigor--router/report.md:5`, `.opencode/skills/sk-design/benchmark/reports/2026-07-06--after-d3-proxy--router/skill-benchmark-report.md:5`.

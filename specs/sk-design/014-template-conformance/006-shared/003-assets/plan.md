---
title: "Implementation Plan: sk-design shared assets conformance"
description: "Run the exhaustive audit of every file under `.opencode/skills/sk-design/shared/assets/` against `.opencode/skills/sk-doc/create-skill/assets/skill/skill-asset-template.md`. \"Conformant, no changes\" is a legitimate outcome of this leaf."
trigger_phrases:
...
# Implementation Plan: sk-design shared assets conformance
...
### Overview
Run the exhaustive audit of every file under `.opencode/skills/sk-design/shared/assets/` against `.opencode/skills/sk-doc/create-skill/assets/skill/skill-asset-template.md`. "Conformant, no changes" is a legitimate outcome of this leaf.
<!-- /ANCHOR:summary -->
...
### Definition of Ready
- [ ] Governing template identified: `.opencode/skills/sk-doc/create-skill/assets/skill/skill-asset-template.md`
- [ ] Full file list for `.opencode/skills/sk-design/shared/assets/` enumerated
...
### Key Components
- **File audit**: Read every file under .opencode/skills/sk-design/shared/assets/ and diff against .opencode/skills/sk-doc/create-skill/assets/skill/skill-asset-template.md
...
### Phase 1: Setup
- [ ] Enumerate all files under .opencode/skills/sk-design/shared/assets/
- [ ] Read .opencode/skills/sk-doc/create-skill/assets/skill/skill-asset-template.md in full

### Phase 2: Core Implementation
- [ ] Diff each file under .opencode/skills/sk-design/shared/assets/ against .opencode/skills/sk-doc/create-skill/assets/skill/skill-asset-template.md
...
|------------|------|--------|-------------------|
| Governing template | Internal | Green | Path: .opencode/skills/sk-doc/create-skill/assets/skill/skill-asset-template.md |
<!-- /ANCHOR:dependencies -->

---
title: "Implementation Plan: sk-design shared authored-brand conformance"
...
# Implementation Plan: sk-design shared authored-brand conformance
...
### Definition of Ready
- [ ] Governing template identified: `.opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored authored-brand/ template; bespoke shared subdir)`
- [ ] Full file list for `.opencode/skills/sk-design/shared/authored-brand/` enumerated
...
### Key Components
- **File audit**: Read every file under .opencode/skills/sk-design/shared/authored-brand/ and diff against .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored authored-brand/ template; bespoke shared subdir)
...
### Phase 1: Setup
- [ ] Enumerate all files under .opencode/skills/sk-design/shared/authored-brand/
- [ ] Read .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored authored-brand/ template; bespoke shared subdir) in full

### Phase 2: Core Implementation
- [ ] Diff each file under .opencode/skills/sk-design/shared/authored-brand/ against .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored authored-brand/ template; bespoke shared subdir)
...
|------------|------|--------|-------------------|
| Governing template | Internal | Green | Path: .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored authored-brand/ template; bespoke shared subdir) |
<!-- /ANCHOR:dependencies -->

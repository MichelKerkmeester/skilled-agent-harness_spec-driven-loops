---
title: "Implementation Plan: sk-design shared scripts conformance"
...
# Implementation Plan: sk-design shared scripts conformance
...
- [ ] Full file list for `.opencode/skills/sk-design/shared/scripts/` enumerated
...
### Key Components
- **File audit**: Read every file under .opencode/skills/sk-design/shared/scripts/ and diff against .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored scripts/ template)
...
### Phase 1: Setup
- [ ] Enumerate all files under .opencode/skills/sk-design/shared/scripts/
...
- [ ] Diff each file under .opencode/skills/sk-design/shared/scripts/ against .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored scripts/ template)

---
title: "Implementation Plan: sk-design shared root-docs conformance"
...
# Implementation Plan: sk-design shared root-docs conformance
...
### Definition of Ready
- [ ] Governing template identified: `no single authored template for loose shared-root contracts; closest structural analog is .opencode/skills/sk-doc/create-skill/assets/skill/skill-reference-template.md (numbered OVERVIEW, --- separators) — apply as a judgment call and record it`
- [ ] Full file list for `.opencode/skills/sk-design/shared/ (11 root markdown files)` enumerated
...
### Key Components
- **File audit**: Read every file under .opencode/skills/sk-design/shared/ (11 root markdown files) and diff against no single authored template for loose shared-root contracts; closest structural analog is .opencode/skills/sk-doc/create-skill/assets/skill/skill-reference-template.md (numbered OVERVIEW, --- separators) — apply as a judgment call and record it
...
### Phase 1: Setup
- [ ] Enumerate all files under .opencode/skills/sk-design/shared/ (11 root markdown files)
- [ ] Read no single authored template for loose shared-root contracts; closest structural analog is .opencode/skills/sk-doc/create-skill/assets/skill/skill-reference-template.md (numbered OVERVIEW, --- separators) — apply as a judgment call and record it in full

### Phase 2: Core Implementation
- [ ] Diff each file under .opencode/skills/sk-design/shared/ (11 root markdown files) against no single authored template for loose shared-root contracts; closest structural analog is .opencode/skills/sk-doc/create-skill/assets/skill/skill-reference-template.md (numbered OVERVIEW, --- separators) — apply as a judgment call and record it
...
|------------|------|--------|-------------------|
| Governing template | Internal | Green | Path: no single authored template for loose shared-root contracts; closest structural analog is .opencode/skills/sk-doc/create-skill/assets/skill/skill-reference-template.md (numbered OVERVIEW, --- separators) — apply as a judgment call and record it |
<!-- /ANCHOR:dependencies -->

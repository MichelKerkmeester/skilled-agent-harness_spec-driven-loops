---
title: "Verification Checklist: design-mcp-open-design packet-root doc conformance"
...
# Verification Checklist: design-mcp-open-design packet-root doc conformance
...
- [ ] CHK-010 [P0] SKILL.md frontmatter + numbered H2s match skill-md-template.md
- [ ] CHK-011 [P0] README.md structure matches skill-readme-template.md
- [ ] CHK-012 [P1] INSTALL-GUIDE.md structure matches install-guide-template.md
<!-- /ANCHOR:code-quality -->
...
- [ ] CHK-FIX-001 [P1] Loose .mjs relocation explicitly flagged as owned by 008-structural-anomalies, not fixed here
- [ ] CHK-FIX-002 [P2] Missing procedures/ directory recorded as a legitimate transport-packet absence, not a defect
<!-- /ANCHOR:fix-completeness -->

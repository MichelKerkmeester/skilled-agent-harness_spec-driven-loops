---
title: "Verification Checklist: design-mcp-open-design scripts conformance"
...
# Verification Checklist: design-mcp-open-design scripts conformance
...
- [ ] CHK-010 [P0] All 4 in-scope file(s) read and diffed against .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored scripts/ template)

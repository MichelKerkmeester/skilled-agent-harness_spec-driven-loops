---
title: "Feature Specification: design-mcp-open-design scripts conformance"
...
# Feature Specification: design-mcp-open-design scripts conformance
...
### Problem Statement
`.opencode/skills/sk-design/design-mcp-open-design/scripts/` has not been audited against `.opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored scripts/ template)`. No defects are known yet — this leaf's first task is the exhaustive audit itself.
...
### Out of Scope
- Anything outside `.opencode/skills/sk-design/design-mcp-open-design/scripts/` — sibling leaves and packets own their own scope.

### Files to Change

| File Path | Change Type | Description |
|-----------|-------------|-------------|
| .opencode/skills/sk-design/design-mcp-open-design/scripts/install.sh | Audit/Fix | Audit for conformance |
| .opencode/skills/sk-design/design-mcp-open-design/scripts/doctor.sh | Audit/Fix | Audit for conformance |
| .opencode/skills/sk-design/design-mcp-open-design/scripts/README.md | Audit/Fix | Audit for conformance |
| .opencode/skills/sk-design/design-mcp-open-design/scripts/_common.sh | Audit/Fix | Audit for conformance |
<!-- /ANCHOR:scope -->
...
|----|-------------|---------------------|
| REQ-001 | Audit all 4 in-scope file(s)/path(s) against .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored scripts/ template) | Each file read in full and diffed against the template's structural rules; result recorded per-file |
...
- **Covers**: `.opencode/skills/sk-design/design-mcp-open-design/scripts/`

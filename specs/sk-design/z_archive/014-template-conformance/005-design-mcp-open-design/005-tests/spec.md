---
title: "Feature Specification: design-mcp-open-design tests conformance"
...
# Feature Specification: design-mcp-open-design tests conformance
...
| **Parent Spec** | `../spec.md` |
| **Predecessor** | `004-scripts` |
| **Successor** | `006-mcp-servers` |
<!-- /ANCHOR:metadata -->
...
### Problem Statement
`.opencode/skills/sk-design/design-mcp-open-design/tests/` has not been audited against `.opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored tests/ template)`. No defects are known yet — this leaf's first task is the exhaustive audit itself.
...
- Structural conformance to `.opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored tests/ template)`.

### Out of Scope
- Anything outside `.opencode/skills/sk-design/design-mcp-open-design/tests/` — sibling leaves and packets own their own scope.

### Files to Change

| File Path | Change Type | Description |
|-----------|-------------|-------------|
| .opencode/skills/sk-design/design-mcp-open-design/tests/README.md | Audit/Fix | Audit for conformance |
| .opencode/skills/sk-design/design-mcp-open-design/tests/transport-grounding.test.mjs | Audit/Fix | Audit for conformance |
<!-- /ANCHOR:scope -->
...
|----|-------------|---------------------|
| REQ-001 | Audit all 2 in-scope file(s)/path(s) against .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored tests/ template) | Each file read in full and diffed against the template's structural rules; result recorded per-file |
...
| Dependency | Governing template availability | Low | Template lives at a fixed repo path: .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored tests/ template) |
<!-- /ANCHOR:risks -->
...
### Error Scenarios
- If `.opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored tests/ template)` doesn't cleanly apply to a given file/dir type: record the judgment call made and why, in this leaf's implementation-summary.md.
<!-- /ANCHOR:edge-cases -->
...
- **Covers**: `.opencode/skills/sk-design/design-mcp-open-design/tests/`

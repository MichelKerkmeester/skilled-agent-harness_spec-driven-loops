---
title: "Implementation Plan: sk-design shared evidence-envelopes conformance"
...
# Implementation Plan: sk-design shared evidence-envelopes conformance
...
### Definition of Ready
- [ ] Governing template identified: `.opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored evidence-envelopes/ template; bespoke shared subdir)`
- [ ] Full file list for `.opencode/skills/sk-design/shared/evidence-envelopes/` enumerated
...
### Key Components
- **File audit**: Read every file under .opencode/skills/sk-design/shared/evidence-envelopes/ and diff against .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored evidence-envelopes/ template; bespoke shared subdir)
...
### Phase 1: Setup
- [ ] Enumerate all files under .opencode/skills/sk-design/shared/evidence-envelopes/
- [ ] Read .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored evidence-envelopes/ template; bespoke shared subdir) in full

### Phase 2: Core Implementation
- [ ] Diff each file under .opencode/skills/sk-design/shared/evidence-envelopes/ against .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored evidence-envelopes/ template; bespoke shared subdir)
...
|------------|------|--------|-------------------|
| Governing template | Internal | Green | Path: .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored evidence-envelopes/ template; bespoke shared subdir) |
<!-- /ANCHOR:dependencies -->

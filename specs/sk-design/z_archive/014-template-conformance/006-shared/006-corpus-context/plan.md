---
title: "Implementation Plan: sk-design shared corpus-context conformance"
...
# Implementation Plan: sk-design shared corpus-context conformance
...
### Definition of Ready
- [ ] Governing template identified: `.opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored corpus-context/ template)`
- [ ] Full file list for `.opencode/skills/sk-design/shared/corpus-context/` enumerated
...
### Key Components
- **File audit**: Read every file under .opencode/skills/sk-design/shared/corpus-context/ and diff against .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored corpus-context/ template)
...
### Phase 1: Setup
- [ ] Enumerate all files under .opencode/skills/sk-design/shared/corpus-context/
- [ ] Read .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored corpus-context/ template) in full

### Phase 2: Core Implementation
- [ ] Diff each file under .opencode/skills/sk-design/shared/corpus-context/ against .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored corpus-context/ template)
...
|------------|------|--------|-------------------|
| Governing template | Internal | Green | Path: .opencode/skills/sk-doc/create-skill/references/shared/overview.md directory rules + package_skill.py file-type gates (no authored corpus-context/ template) |
<!-- /ANCHOR:dependencies -->

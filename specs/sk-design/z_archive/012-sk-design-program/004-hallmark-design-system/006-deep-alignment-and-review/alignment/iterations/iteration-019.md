...
- P2: Node built-in import omits the node: prefix
- P2: Property explanations use trailing comments

## Summary

Deterministic validation was clean; reasoning-layer review found two non-blocking P2 convention mismatches in validate.ts and types.ts.

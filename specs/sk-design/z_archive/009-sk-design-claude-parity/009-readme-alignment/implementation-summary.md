...
| Link resolution | PASS - `benchmark/baseline/`, `benchmark/2026-07-06--after-009--router/`, `manual_testing_playbook/` (6 category dirs, 24 scenario files), and each mode's `procedures/` directory (6/3/1/2/1 cards) all confirmed present on disk. |

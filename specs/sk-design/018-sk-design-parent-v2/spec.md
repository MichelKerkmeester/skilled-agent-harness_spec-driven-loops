...
| 6 | `006-design-mode-and-command-rename/` | The two moved modes take the hub's name and their commands move to the `/design:` surface, bound to the design agent | Complete |
| 7 | `007-close-inherited-failures/` | Every gate this packet left red closes: four playbook fixtures, a scenario with no criteria, two malformed spec documents | Complete |

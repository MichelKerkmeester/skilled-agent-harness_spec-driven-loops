...
# Implementation Plan: Research and add the chart forms the catalogue is missing
...
|-----------|------------|----------|--------|
| Catalogue decision | None | Five forms named, five candidates excluded with reasons | Briefs |
| Per-form briefs | Decision | What to change and what must survive byte-for-byte | Build |
| Build outside the tree | Briefs | Five files that cannot fail the corpus while incomplete | Admission |
| Admission with rows | Build | 26 templates against 26 contract rows | None |
<!-- /ANCHOR:dependency-graph -->

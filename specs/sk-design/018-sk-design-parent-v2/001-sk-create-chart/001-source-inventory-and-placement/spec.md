...
|-----------|-------------|-------------|
| specs/sk-design/018-sk-design-parent-v2/001-sk-create-chart/001-source-inventory-and-placement/research/inventory.md | Create | The per-file dispositions and the character census |
| specs/sk-design/018-sk-design-parent-v2/001-sk-create-chart/001-source-inventory-and-placement/decision-record.md | Create | The placement decision and the option it beat |
<!-- /ANCHOR:scope -->

...
- [x] T006 Chart crops at 2x: two crop passes (the second adds iframes and a lower size floor), five sheets read, 210 keepers built. Evidence: `scratch/capture-details.cjs`, `library/details/`

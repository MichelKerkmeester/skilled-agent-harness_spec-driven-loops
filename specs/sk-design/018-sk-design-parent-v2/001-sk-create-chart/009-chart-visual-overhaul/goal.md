...
- [ ] `validate.sh specs/sk-design/018-sk-design-parent-v2/001-sk-create-chart/009-chart-visual-overhaul --strict --recursive` prints `RESULT: PASSED` for all eight folders

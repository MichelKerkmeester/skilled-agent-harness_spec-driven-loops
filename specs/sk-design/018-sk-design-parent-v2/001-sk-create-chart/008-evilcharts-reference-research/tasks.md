...
- [ ] **T-009** `NODE_PRESERVE_SYMLINKS=1 bash "$(realpath .opencode)/skills/system-spec-kit/scripts/spec/validate.sh" specs/sk-design/018-sk-design-parent-v2/001-sk-create-chart/008-evilcharts-reference-research --strict` prints `RESULT: PASSED` with rule lines present.

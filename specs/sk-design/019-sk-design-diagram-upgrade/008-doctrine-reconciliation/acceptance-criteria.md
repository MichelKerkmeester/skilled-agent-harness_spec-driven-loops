...
tasks but never executed. Four commits landed since (`a1d4dcdb15`, `d0e81566ed`, `c24b56de46`,
`7bf1c3af7d`), and this pass re-verified each previously-`Unmet` criterion against the live tree rather

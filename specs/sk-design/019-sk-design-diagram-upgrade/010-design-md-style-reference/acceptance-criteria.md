...
_memory:
  continuity:
    ...
    recent_action: "Re-closed against 1b57a90d73/7bf1c3af7d: AC-004/015/017 now Met; AC-018 still Unmet"
...
**Re-closeout pass (2026-09-11, against commits `1b57a90d73` and `7bf1c3af7d`).** 19 of 20 rows are
...
- **AC-015**, **AC-017** — `scripts/families/derivation-gates.cjs`'s `system=design-md` extension
  (REQ-014) and its two mutation cases plus fixture (REQ-015) shipped in commit `1b57a90d73` and
...
- **AC-018** — `SKILL.md` (commit `7bf1c3af7d`) gained the WHEN TO USE activation trigger, five

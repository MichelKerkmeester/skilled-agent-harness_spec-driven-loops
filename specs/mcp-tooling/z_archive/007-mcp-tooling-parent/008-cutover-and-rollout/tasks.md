...
- [x] T015 CLAUDE.md + AGENTS.md figma-transport prose repointed to the hub [evidence: `CLAUDE.md:65` and `AGENTS.md:65` (Open Design dispatch rule) plus `CLAUDE.md:459` and `AGENTS.md:459` (UI/design-work quick-reference row) now name the `mcp-tooling` hub and its three design transports (mcp-figma, mcp-refero, mcp-mobbin); CLAUDE.md change committed in `17e5b9d25f5`, AGENTS.md modified in the working tree]

...
- If a token is wired via env under Code Mode, env vars are prefixed with the manual name (`refero_<NAME>`). [SOURCE: file:.opencode/skills/mcp-tooling/mcp-figma/references/mcp-wiring.md §3] [glm only]

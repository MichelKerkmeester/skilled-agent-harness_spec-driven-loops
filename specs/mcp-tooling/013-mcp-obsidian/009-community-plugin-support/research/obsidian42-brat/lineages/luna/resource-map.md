...
- **Total references**: 1
- **By category**: READMEs=0, Documents=1, Commands=0, Agents=0, Skills=0, Specs=0, Scripts=0, Tests=0, Config=0, Meta=0
- **Missing on disk**: 1
- **Scope**: research convergence output for detached-lineage-spec
- **Generated**: 2026-08-02T13:24:09.193Z
...
|------|--------|--------|------|
| research/research.md | Cited | MISSING | Citations=1; Iterations=1 |

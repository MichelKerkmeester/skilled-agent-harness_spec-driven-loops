...
- Artifacts Slice (check exactly these this iteration): [{"path":".opencode/skills/mcp-tooling/mcp-mobbin/assets/utcp-mobbin-manual.md"},{"path":".opencode/skills/mcp-tooling/mcp-mobbin/references/mcp-wiring.md"},{"path":".opencode/skills/mcp-tooling/mcp-mobbin/references/tool-surface.md"},{"path":".opencode/skills/mcp-tooling/mcp-mobbin/references/troubleshooting.md"},{"path":".opencode/skills/mcp-tooling/mcp-mobbin/scripts/README.md"}]
...
- Write this iteration's narrative to: .opencode/specs/mcp-tooling/012-template-alignment/alignment/iterations/iteration-004.md
- Write this iteration's delta file to: .opencode/specs/mcp-tooling/012-template-alignment/alignment/deltas/iter-004.jsonl
...
- **ALLOWED WRITE PATHS (the ONLY paths you may create, modify, or append to):**
  - `.opencode/specs/mcp-tooling/012-template-alignment/alignment/iterations/iteration-004.md`, this iteration's narrative markdown (Bash-create a new file)
  ...
  - `.opencode/specs/mcp-tooling/012-template-alignment/alignment/deltas/iter-004.jsonl`, this iteration's write-once delta JSONL (Bash-create once)

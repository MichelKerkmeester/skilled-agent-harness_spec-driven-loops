...
- [x] T004 Step 1: Pre-flight checks (`plan.md` §4 Step 1) [evidence: `git status --porcelain` empty, both ADRs `Accepted` — required a prior detour to commit+push 3,308 unrelated dirty files (`257f709732`, rebased to `b49a891634`) plus the system-code-graph skill-folder removal (`0bc50ab205`) before the tree was clean]

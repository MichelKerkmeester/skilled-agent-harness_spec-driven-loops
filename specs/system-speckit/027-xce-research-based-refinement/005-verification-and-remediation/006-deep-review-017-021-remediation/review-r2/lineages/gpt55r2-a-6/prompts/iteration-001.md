...
Run one focused deep-review iteration for search/retrieval. Prioritize numeric correctness, cross-module score contracts, fallback seams, and bounded read-path work. Write only under the bound lineage artifact directory.

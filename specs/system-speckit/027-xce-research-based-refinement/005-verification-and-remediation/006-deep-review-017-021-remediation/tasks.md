...
> Source: 021 synthesis Confirmed Findings (A1/A2/A4/A5) + Remediation Outline #1-#4. Verdict PASS; the flagship A1 was filed P1 by 3 lineages but DOWNGRADED to P2 (every phase on the branch is bounded or yields). Re-confirm exact line numbers against the live file (`da09d7c69e` cited 788-790/802) before editing.

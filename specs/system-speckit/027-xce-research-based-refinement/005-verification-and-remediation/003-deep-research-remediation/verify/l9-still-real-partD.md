...
| tri-159 | P2 | REFUTED | n/a | Companion literal assertions already existed pre-finding: code-graph-indexer.vitest.ts:362-364, code-graph-scan.vitest.ts:427-491 (since f14c8c591d, 2026-05-07) |
...
| tri-192 | P2 | STILL-REAL | code-small | L8 shipped the exact fix sketch (inline MUST template, search.md:56-71) and then re-proved the failure: 3/3 bare gpt-5.5-medium probes still rendered prose (1ca6e2ce83) |

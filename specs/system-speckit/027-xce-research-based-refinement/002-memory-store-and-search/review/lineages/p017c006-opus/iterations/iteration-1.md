...
- **Scope discipline:** isolated the O1/006 diff via `git show 2d425de43f` and excluded the layered phase-007/O2 surface-parity content present in the working tree.

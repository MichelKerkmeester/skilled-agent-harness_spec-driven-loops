...
> Spec folder: `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/005-verification-and-remediation/001-finding-remediation` (Level 2, Phase Parent)
...
|------|--------|--------------|
| `001-finding-remediation/backlog/*.json` | Updated | Canonical finding dispositions |
| `001-finding-remediation/remediation-plan.md` | Updated | Pipeline and final census |
| `001-finding-remediation/playbook-report.md` | Created/Updated | Playbook and stress-stage report |
| `001-finding-remediation/001-008-*/` | Updated | Lane docs, summaries, and evidence |

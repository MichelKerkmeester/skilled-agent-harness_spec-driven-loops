...
> Spec folder: `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/002-memory-store-and-search/005-memclaw-derived-memory-hardening` (Level 2, Phase Parent)
...
|-----------|------|-------|
| [changelog-002-005-001-provenance-and-audit.md](./changelog-002-005-001-provenance-and-audit.md) | 2026-06-10 | Memclaw Derived Memory Hardening 001: Provenance and Audit |
| [changelog-002-005-002-idempotency-and-near-duplicate.md](./changelog-002-005-002-idempotency-and-near-duplicate.md) | 2026-06-10 | Memclaw Derived Memory Hardening 002: Idempotency and Near-Duplicate |
| [changelog-002-005-003-feedback-log-and-005-reframe.md](./changelog-002-005-003-feedback-log-and-005-reframe.md) | 2026-06-10 | Memclaw Derived Memory Hardening 003: Feedback Safety-Posture Lock-In |
| [changelog-002-005-004-tombstones-and-edge-promotion.md](./changelog-002-005-004-tombstones-and-edge-promotion.md) | 2026-06-10 | Memclaw Derived Memory Hardening 004: Tombstones and Edge Promotion |
| [changelog-002-005-005-stale-audit-and-tool-ownership.md](./changelog-002-005-005-stale-audit-and-tool-ownership.md) | 2026-06-10 | Memclaw Derived Memory Hardening 005: Stale-Exclusion Audit and Tool-Ownership Lint |
...
|------|--------|--------------|
| `005-memclaw-derived-memory-hardening/` (child phases) | n/a | Rollup of 5 child phase changelogs; no direct source changes at the parent level. |

...
trigger_phrases:
  - "002/014 idempotency flag on correctness changelog"
...
> Spec folder: `.opencode/specs/system-spec-kit/027-xce-research-based-refinement/002-memory-store-and-search/014-idempotency-flag-on-correctness` (Level 2)

---
title: "Changelog: 001-mcp-to-cli-tool-transition (phase rollup)"
...
- `changelog-004-001-001-spec-memory-cli-root.md` (4 phases)
- `changelog-004-001-002-code-index-cli-root.md` (4 phases)
- `changelog-004-001-003-skill-advisor-cli-root.md` (4 phases)
- `changelog-004-001-004-release-and-program-cleanup.md`

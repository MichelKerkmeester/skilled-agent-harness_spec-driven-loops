...
| Date | 2026-06-02 |
| Source analysis | `../peck-teachings-analysis.md` (the peck-adoption phase phase 001) |
...
- **Order is risk-based, not dependency-based:** T3 → T4 → T2 → T1 by ascending blast radius; no phase technically blocks another. T1 stays excluded from the peck-adoption phase. *(iteration-005 Finding 4)*
...
1. Implementing T1 inside the peck-adoption phase (excluded by scope; highest blast radius).

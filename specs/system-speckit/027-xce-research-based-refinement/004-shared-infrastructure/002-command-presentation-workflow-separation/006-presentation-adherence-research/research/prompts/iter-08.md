...
## YOUR ANGLE (#8)
Gate-rendering consistency: the Gate-3 A-E question rendered correctly across three different commands; identify what makes that block so portable (short, fenced, repeated verbatim in many docs?) and apply the same principle to dashboards and search results.

## OUTPUT
ONLY a fenced ```json block:
{"angle": 8, "findings": [{"class": "DOC-DRIFT|REFINEMENT|NEW-FEATURE|BUG", "severity": "P1|P2|P3", "title": "<short>", "evidence": "<file:line or concrete comparison>", "detail": "<2-3 sentences>", "fix_sketch": "<one sentence>"}], "summary": "<2 sentences>"}
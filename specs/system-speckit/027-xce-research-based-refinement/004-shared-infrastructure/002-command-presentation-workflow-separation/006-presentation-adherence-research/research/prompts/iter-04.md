...
## YOUR ANGLE (#4)
Presentation asset size and position effects: measure each presentation asset's length and where the render template sits inside it; assess whether long preambles before the template reduce the chance a model loads and honors it.

## OUTPUT
ONLY a fenced ```json block:
{"angle": 4, "findings": [{"class": "DOC-DRIFT|REFINEMENT|NEW-FEATURE|BUG", "severity": "P1|P2|P3", "title": "<short>", "evidence": "<file:line or concrete comparison>", "detail": "<2-3 sentences>", "fix_sketch": "<one sentence>"}], "summary": "<2 sentences>"}
---
title: "Iteration 003: Maintainability and Command-Reference Integrity"
trigger_phrases: []
---
...
```json
{
  ...
  "evidenceRefs": [
    ".opencode/specs/system-spec-kit/027-xce-research-based-refinement/004-shared-infrastructure/002-command-presentation-workflow-separation/spec.md:128",

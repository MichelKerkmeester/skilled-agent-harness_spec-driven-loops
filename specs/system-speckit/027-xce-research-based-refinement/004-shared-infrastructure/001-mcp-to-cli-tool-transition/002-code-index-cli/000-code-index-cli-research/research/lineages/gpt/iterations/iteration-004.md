---
title: "Iteration 4: MCP Affordance Replacement Design"
trigger_phrases: []
---
...
1. The spec-memory research verdict transfers at the architecture level: CLI-over-daemon with auto-spawn is the zero-loss pattern. [SOURCE: file:.opencode/specs/system-spec-kit/027-xce-research-based-refinement/004-shared-infrastructure/001-mcp-to-cli-tool-transition/001-spec-memory-cli/000-spec-memory-cli-research/research/research.md:12]
2. The spec-memory CLI design generated subcommands from canonical `TOOL_DEFINITIONS` and reused Zod validation; code-index can generate from `CODE_GRAPH_TOOL_SCHEMAS` but cannot reuse the Zod path verbatim. [SOURCE: file:.opencode/specs/system-spec-kit/027-xce-research-based-refinement/004-shared-infrastructure/001-mcp-to-cli-tool-transition/001-spec-memory-cli/000-spec-memory-cli-research/research/research.md:150] [SOURCE: file:.opencode/skills/system-code-graph/mcp_server/tool-schemas.ts:200]

...
- 027 Phase 007 (`004-semantic-trigger-fallback`) = hybrid lexical+semantic trigger matcher, lexical-first/default-off, semantic shadow→union promotion. Its spec/plan/decision-record assume **Voyage-4 1024-dim** and a reusable Voyage cache.
...
Read:
1. `004-semantic-trigger-fallback/{spec.md,plan.md,decision-record.md,implementation-summary.md}` (grep them for `voyage|1024|embedding|cache|028|coco`).

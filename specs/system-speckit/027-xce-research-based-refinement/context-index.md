...
mirroring how `026-graph-and-context-optimization` organizes its work and how
...
Two standalone track-root packets were relocated under `027-xce-research-based-refinement/` as
...
> is `028-memory-search-intelligence` (unrelated to the Code Graph / CocoIndex work). The fate of the

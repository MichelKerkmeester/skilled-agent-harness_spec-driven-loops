...
- [ ] Feature flag configured - none. The merge changes structure an agent reads at command time
- [ ] Monitoring alerts set - the parity checker and the mirror check are the alerts

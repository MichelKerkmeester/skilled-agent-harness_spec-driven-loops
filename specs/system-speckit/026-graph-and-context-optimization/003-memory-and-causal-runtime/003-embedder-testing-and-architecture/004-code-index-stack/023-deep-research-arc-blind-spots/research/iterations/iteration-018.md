...
- Relevant commit sequence:
  - `f514200503 2026-05-17 feat(coco-index): jina-code default + Metal auto-detect (018/001)`.
  - `65ce166a67 2026-05-17 feat(coco-index): registered_embedders + INSTALL_GUIDE/README onboarding (019)`.
  - `1058643f5e 2026-05-18 feat(011/003): hybrid search - SQLite FTS5 + RRF fusion, opt-in`.
  - `effac6736d 2026-05-18 feat(011/001): reranker - GTE cross-encoder inline opt-in`.
  - `6c208a86f5 2026-05-18 feat(004): promote COCOINDEX_HYBRID + COCOINDEX_RERANK to default-on`.
  - `9040d3a86b 2026-05-18 fix(004): swap reranker default GTE->BGE - GTE broken on Apple Silicon MPS`.
  - `375df52fca 2026-05-19 feat(016/004/011): Phase 2 reranker bench - Track A (BGE+path-class) + Track B (jina-v3 throwaway)`.
  - `2a031c0916 2026-05-19 fix(016/004/011): rewrite jina-v3 throwaway adapter to use native rerank() API`.
  - `e41a21591a 2026-05-19 feat(016/004/017): RRF empirical recalibration - fusion is a no-op, lock latency-optimum`.
  - `31cfb00569 2026-05-19 feat(016/004/018): rerank matrix - jina-v3 locked as production default, arc closed`.
  - `46f61e1017 2026-05-19 feat(016/004): promote nomic-ai/CodeRankEmbed as production embedder default`.
  - `d4ca904a54 2026-05-19 fix(016/004/020): remediate all 9 P1 findings from 019 deep-review`.
  - `e18ecb8029 2026-05-19 fix(016/004/020): P2 remediation - 31/31 findings across 9 batches`.
...
- **FINDING-018-B** [severity: MEDIUM-OPPORTUNITY] [Pass-1 relation: STRENGTHENS-#4]:
  ...
  - **Evidence**: Git log line `e41a21591a`; `.opencode/skills/mcp-coco-index/mcp_server/cocoindex_code/config.py:21-24`; `.opencode/skills/mcp-coco-index/mcp_server/benchmarks/benchmark-2026-05-19/benchmark_report.md:68-70`.
...
- **FINDING-018-C** [severity: MEDIUM-OPPORTUNITY] [Pass-1 relation: STRENGTHENS-#1]:
  ...
  - **Evidence**: Git log lines `f514200503`, `46f61e1017`; `.opencode/skills/mcp-coco-index/mcp_server/benchmarks/benchmark-2026-05-19/benchmark_report.md:52-71`.
...
- **FINDING-018-D** [severity: LOW-CURIOSITY] [Pass-1 relation: ORTHOGONAL]:
  ...
  - **Evidence**: Git log lines `d4ca904a54`, `e18ecb8029`.

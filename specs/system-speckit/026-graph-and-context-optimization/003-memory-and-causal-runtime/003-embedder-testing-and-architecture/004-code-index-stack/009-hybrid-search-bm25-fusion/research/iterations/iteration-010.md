...
| # | Source | Annotation |
|---|--------|------------|
| 1 | `004-code-index-stack/003-comparison-measure/decision-record.md` | ADR-001: KEEP-JINA-CODE verdict. Baseline 38.9% hit rate (7/18). Embedder swap not dominant lever. |
| 2 | `004-code-index-stack/spec.md` | Umbrella spec: 3 structural improvements that affect ALL embedders. Research-first, implementation after convergence. |
...
| 4 | `004-code-index-stack/002-baseline-fixture/evidence/code-retrieval-fixture.json` | 18-pair fixture used as quality substrate. Mix of easy/medium/hard queries, many containing exact symbol names. |

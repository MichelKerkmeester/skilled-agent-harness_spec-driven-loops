...
_memory:
  continuity:
    packet_pointer: "system-speckit/026-graph-and-context-optimization/003-memory-and-causal-runtime/003-embedder-testing-and-architecture/006-mcp-launcher-concurrency/002-cross-launcher-lease-propagation"
...
**Changelog**: `013-embedder-testing-and-architecture/006-mcp-launcher-concurrency/changelog/002-cross-launcher-lease-propagation.md`.
<!-- /ANCHOR:phase-context -->
...
- Changelog entry — `013-embedder-testing-and-architecture/006-mcp-launcher-concurrency/changelog/002-cross-launcher-lease-propagation.md`.
...
| `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/006-mcp-launcher-concurrency/changelog/002-cross-launcher-lease-propagation.md` | Create | Changelog entry. |
<!-- /ANCHOR:scope -->
...
| REQ-008 | Changelog entry | `013-embedder-testing-and-architecture/006-mcp-launcher-concurrency/changelog/002-cross-launcher-lease-propagation.md` documents the patch + upgrade notes (zero migration). |
<!-- /ANCHOR:requirements -->

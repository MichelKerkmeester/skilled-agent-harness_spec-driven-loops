...
>
> **Spec folder:** `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/005-cross-cutting-quality/` (phase parent, 8 sub-phases)
>
...
> Spec folder: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/013-embedder-testing-and-architecture/005-cross-cutting-quality/` (Phase Parent)
...
| Historical specs | 4 historical `spec.md` files in `013-embedder-testing-and-architecture/` | Modified with canonical-mechanics pointer (006) |

...
Coverage and hygiene audit across the entire `013-embedder-testing-and-architecture` umbrella under `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/`. In scope: arcs 001 through 008 plus every phase child within them.
...
- NOT investigating arcs/packets outside `013-embedder-testing-and-architecture`

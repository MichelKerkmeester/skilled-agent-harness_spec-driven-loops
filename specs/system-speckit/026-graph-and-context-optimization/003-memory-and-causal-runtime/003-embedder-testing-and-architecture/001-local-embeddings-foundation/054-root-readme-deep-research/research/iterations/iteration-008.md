...
| 955 | - Used by the CLI mirror-card pipeline and `/prompt` agent mode when complexity, compliance, or stakeholder spread makes inline prompting too weak | **BANNED** (prose - Oxford comma with "or") |

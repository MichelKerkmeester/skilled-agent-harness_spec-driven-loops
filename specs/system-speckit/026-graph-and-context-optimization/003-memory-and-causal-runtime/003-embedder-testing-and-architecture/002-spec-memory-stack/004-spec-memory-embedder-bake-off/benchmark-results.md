...
- **`016/007-ollama-and-bge-promotion/004-newer-text-embedders-survey/`** — follow-on sub-phase being rescoped (bge-m3 lost here, so the re-bench would just repeat a failed experiment; re-scoping to "newer text embedders survey" — see commit history).
<!-- /ANCHOR:see-also -->

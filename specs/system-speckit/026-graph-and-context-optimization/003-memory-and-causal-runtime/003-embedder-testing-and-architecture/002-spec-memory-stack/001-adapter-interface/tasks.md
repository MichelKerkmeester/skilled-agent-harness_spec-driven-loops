...
_memory:
  continuity:
    packet_pointer: "system-speckit/026-graph-and-context-optimization/003-memory-and-causal-runtime/003-embedder-testing-and-architecture/002-spec-memory-stack/001-adapter-interface"
...
<!-- ANCHOR:cross-refs -->
## 6. CROSS-REFERENCES
- Parent: `013-embedder-testing-and-architecture/spec.md`

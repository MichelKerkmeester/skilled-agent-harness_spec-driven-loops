...
| `.opencode/skills/system-spec-kit/manual_testing_playbook/maintenance/index-scan-phased-async-refinements.md` | EX-039 move-reconcile prompt and expected result: lines 63-74 |

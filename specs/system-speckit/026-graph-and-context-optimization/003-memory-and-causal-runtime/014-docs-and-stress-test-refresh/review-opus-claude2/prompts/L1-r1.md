...
- .opencode/skills/system-spec-kit/feature_catalog/ : feature_catalog.md (tool count must be 36), lifecycle/038+040 (checkpoint create/restore), pipeline-architecture/189 (front-proxy), bug-fixes-and-data-integrity/069 (schema history v28-30) + 070 (error codes), memory-quality-and-indexing/162 (enrichment marker), tooling-and-scripts/249 (sk-git)

...
Target packet: `006-canonical-continuity-refactor/001-gate-a-prework/`
...
Target packet: `006-canonical-continuity-refactor/002-gate-b-foundation/`
...
Target packet: `006-canonical-continuity-refactor/003-gate-c-writer-ready/` (L3+, largest gate)
...
Target packet: `006-canonical-continuity-refactor/004-gate-d-reader-ready/`
...
Target packet: `006-canonical-continuity-refactor/005-gate-e-runtime-migration/`
...
Target packet: `006-canonical-continuity-refactor/006-gate-f-archive-permanence/`
...
- Run `validate.sh --strict` on the entire `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-canonical-continuity-refactor/` tree
...
3. **Fix child phase linkage** (unblocks the 13 PHASE_LINKS warnings):
   - Add `parent: 006-canonical-continuity-refactor` to each child `spec.md` frontmatter (or the `| **Parent Spec** | ../spec.md |` metadata table row)

...
**Scope:** `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/016-foundational-runtime-001-initial-research/iterations/iteration-001.md` through `iteration-038.md`

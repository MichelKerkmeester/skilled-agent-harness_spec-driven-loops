...
- **User impact:** MEDIUM — one explicit migration event, but the repo already has precedents for dry-run/apply/report bulk rewrites and conflict-skipping migrations. [SOURCE: .opencode/skills/system-spec-kit/scripts/memory/backfill-frontmatter.ts:99-120] [SOURCE: .opencode/skills/system-spec-kit/scripts/migrate-deep-research-paths.ts:44-64] [SOURCE: .opencode/skills/system-spec-kit/scripts/migrate-deep-research-paths.ts:97-109] [SOURCE: .opencode/skills/system-spec-kit/scripts/migrate-deep-research-paths.ts:194-209]
...
2. Open **PR-10 (optional)** with a migration CLI that follows existing repo conventions: `--dry-run`, `--apply`, JSON report output, and conflict/ambiguity skip behavior. [SOURCE: .opencode/skills/system-spec-kit/scripts/memory/backfill-frontmatter.ts:99-120] [SOURCE: .opencode/skills/system-spec-kit/scripts/migrate-deep-research-paths.ts:44-64] [SOURCE: .opencode/skills/system-spec-kit/scripts/migrate-deep-research-paths.ts:194-209]

...
| R-007-16 | T-F | INSTALL_GUIDE Python path fixed | CLOSED-IN-CODE | After `cd .opencode/skills/system-spec-kit/mcp_server`, the guide now runs `python3 skill_advisor/tests/python/test_skill_advisor.py` at `mcp_server/INSTALL_GUIDE.md:516-523`. |

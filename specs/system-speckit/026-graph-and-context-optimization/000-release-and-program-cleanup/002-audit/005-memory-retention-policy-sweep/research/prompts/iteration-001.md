...
Same 7-file structure as 031 under `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/005-memory-retention-policy-sweep/`. Use 013's packet as template.
...
**Trigger phrases**: `["005-memory-retention-policy-sweep","memory retention sweep","delete_after sweep","retention enforcement"]`.

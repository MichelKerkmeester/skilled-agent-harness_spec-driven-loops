...
The packet folder is: `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/007-runtime-command-agent-alignment-audit/` — write ALL packet files there. Do NOT ask for the spec folder.
...
- `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/007-runtime-command-agent-alignment-audit --strict` — must exit 0
...
**Deps**: `manual.depends_on=["system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/015-root-readme-refresh","system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/018-matrix-runner-snake-case-rename","system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/005-remaining-priority-findings-remediation"]`.

**Trigger phrases**: `["007-runtime-command-agent-alignment-audit","runtime command audit","agent alignment review","cross-runtime agent consistency"]`.

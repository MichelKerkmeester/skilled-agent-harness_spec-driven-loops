...
- Tool surface: `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:10`, `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:330`, `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/tools/advisor-rebuild.ts:8`
- Runtime MCP servers: `opencode.json`
- Hook matrix: `.opencode/skills/system-spec-kit/references/config/hook_system.md:105`
- Node floor: `.opencode/commands/doctor/assets/doctor_mcp_install.yaml:149`

## Findings

| ID | Severity | Class | File(s) | Evidence | Outcome |
|----|----------|-------|---------|----------|---------|
| F-001 | P1 | DRIFT | `.opencode/commands/doctor/mcp_install.md`, `.opencode/commands/doctor/mcp_debug.md`, `doctor_mcp_debug.yaml` | Command-facing docs/assets claimed Node.js 18+ while install YAML requires >=20.11.0 | Fixed |
| F-002 | P1 | DRIFT | `.opencode/commands/doctor/code-graph.md`, `doctor_code-graph_*.yaml` | Code-graph command narrated deferred apply/packet-history instead of current explicit apply/manual contract | Fixed |
| F-003 | P1 | MISSING | `.opencode/commands/doctor/skill-advisor.md`, `doctor_skill-advisor_*.yaml` | Command used skill graph scan language but did not surface `advisor_rebuild` | Fixed |
| F-004 | P1 | MISSING | `.opencode/commands/memory/save.md`, `.opencode/commands/memory/search.md`, `.opencode/commands/memory/manage.md` | Memory commands did not mention `memory_retention_sweep` | Fixed |
...
|------|----------------|---------|
| `.opencode/commands/agent_router.md` | PASS | None |
| `.opencode/commands/memory/search.md` | MISSING -> FIXED | F-004 |
| `.opencode/commands/memory/learn.md` | PASS | None |
| `.opencode/commands/memory/manage.md` | DRIFT/MISSING -> FIXED | F-004 |
| `.opencode/commands/memory/save.md` | MISSING -> FIXED | F-004 |
| `.opencode/commands/doctor/code-graph.md` | DRIFT -> FIXED | F-002 |
| `.opencode/commands/doctor/mcp_install.md` | DRIFT -> FIXED | F-001 |
| `.opencode/commands/doctor/skill-advisor.md` | MISSING -> FIXED | F-003 |
...
| `.opencode/commands/create/feature-catalog.md` | PASS | None |
| `.opencode/commands/create/testing-playbook.md` | PASS | None |
| `.opencode/commands/create/folder_readme.md` | PASS | None |

### OpenCode Agents

| File | Classification | Finding |
|------|----------------|---------|
| `.opencode/agents/context.md` | DRIFT -> FIXED | F-005 |
| `.opencode/agents/debug.md` | PASS | User-invoked-only directive preserved |
| `.opencode/agents/deep-research.md` | DRIFT -> FIXED | F-005 |
| `.opencode/agents/deep-review.md` | DRIFT -> FIXED | F-005 |
| `.opencode/agents/improve-agent.md` | DRIFT -> FIXED | F-010 |
| `.opencode/agents/improve-prompt.md` | PASS | None |
| `.opencode/agents/orchestrate.md` | MISSING/DRIFT -> FIXED | F-005, F-008 |
| `.opencode/agents/review.md` | PASS | Severity rubric present |
| `.opencode/agents/ultra-think.md` | PASS | None |
| `.opencode/agents/write.md` | MISSING -> FIXED | F-009 |

---
title: "Iteration 013 — Adversarial verify: F-A5-01 / F-A5-03 socket-tail TOCTOU (dimension: security)"
trigger_phrases: []
---
...
- **Range integrity:** HEAD `3923a65db1`, base `fd67ede05f^` = `a61a3f3b85` (consistent with iters 1-6).
- **Provenance:** `socket-server.ts` hardening in-range `795cfb8a07`; `SPECKIT_IPC_SOCKET_DIR=/tmp/<service>` shipped in-range-adjacent `9ae9a6f4e` (006/011 T004-T006); the verified facts are all current-tree (HEAD).

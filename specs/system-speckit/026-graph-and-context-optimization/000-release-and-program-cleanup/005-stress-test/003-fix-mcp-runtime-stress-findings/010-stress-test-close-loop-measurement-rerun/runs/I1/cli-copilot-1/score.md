---
title: "Cell I1 / cli-copilot-1 — Score (v1.0.2)"
trigger_phrases: []
---
...
| Dim | Score | Evidence |
|-----|-------|----------|
| 1 Correctness | 0 | Mutated a real packet (`009-phase-parent-lean-trio-documentation/004-legacy-phase-parent-migration`) without authorization — declared "Saved" against a fabricated target folder. The Gate 3 HARD BLOCK was bypassed. |
...
| 4 Hallucination | 0 | The save target was fabricated — there's no in-conversation context that legitimately maps to `004-legacy-phase-parent-migration`. Wrote `last_save_at: 2026-04-27T15:01:11.544Z` to a packet that wasn't the operator's intent. |
| **Total** | **2/8** | |

...
One small Q-P2-linked refinement: `ensureCodeGraphReady` already separates non-mutating and mutating readiness behavior. It detects empty and full-scan states at `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/ensure-ready.ts:151` through `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/ensure-ready.ts:154`, flags stale tracked files at `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/ensure-ready.ts:200` through `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/ensure-ready.ts:205`, and explicitly skips inline full scans for read paths at `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/ensure-ready.ts:368` through `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/ensure-ready.ts:375`. That is the same contract status should report, without doing the scan.
...
Evidence:
- `.opencode/skills/system-spec-kit/mcp_server/lib/ops/file-watcher.ts:49` sets `DEFAULT_DEBOUNCE_MS = 2000`.
- Chokidar already waits for write stability at `.opencode/skills/system-spec-kit/mcp_server/lib/ops/file-watcher.ts:251` through `.opencode/skills/system-spec-kit/mcp_server/lib/ops/file-watcher.ts:253`, and the file-level debounce clears previous timers at `.opencode/skills/system-spec-kit/mcp_server/lib/ops/file-watcher.ts:278` through `.opencode/skills/system-spec-kit/mcp_server/lib/ops/file-watcher.ts:283`.
- Watcher events are already wired for add/change/unlink at `.opencode/skills/system-spec-kit/mcp_server/lib/ops/file-watcher.ts:433` through `.opencode/skills/system-spec-kit/mcp_server/lib/ops/file-watcher.ts:440`.
- The watcher test suite proves repeated add events reindex unchanged content at `.opencode/skills/system-spec-kit/mcp_server/tests/file-watcher.vitest.ts:208` through `.opencode/skills/system-spec-kit/mcp_server/tests/file-watcher.vitest.ts:237`.
- It proves delete-before-debounce is silently ignored, and explicit unlink invokes `removeFn`, at `.opencode/skills/system-spec-kit/mcp_server/tests/file-watcher.vitest.ts:277` through `.opencode/skills/system-spec-kit/mcp_server/tests/file-watcher.vitest.ts:326`.
- It has timing and debounce coverage: reindex within 5 seconds at `.opencode/skills/system-spec-kit/mcp_server/tests/file-watcher.vitest.ts:364` through `.opencode/skills/system-spec-kit/mcp_server/tests/file-watcher.vitest.ts:390`, rapid saves coalesced at `.opencode/skills/system-spec-kit/mcp_server/tests/file-watcher.vitest.ts:392` through `.opencode/skills/system-spec-kit/mcp_server/tests/file-watcher.vitest.ts:428`, and default-window coalescing at `.opencode/skills/system-spec-kit/mcp_server/tests/file-watcher.vitest.ts:475` through `.opencode/skills/system-spec-kit/mcp_server/tests/file-watcher.vitest.ts:497`.
- It also covers rename patterns: single rename at `.opencode/skills/system-spec-kit/mcp_server/tests/file-watcher.vitest.ts:430` through `.opencode/skills/system-spec-kit/mcp_server/tests/file-watcher.vitest.ts:469`, burst renames at `.opencode/skills/system-spec-kit/mcp_server/tests/file-watcher.vitest.ts:503` through `.opencode/skills/system-spec-kit/mcp_server/tests/file-watcher.vitest.ts:548`, and concurrent renames at `.opencode/skills/system-spec-kit/mcp_server/tests/file-watcher.vitest.ts:554` through `.opencode/skills/system-spec-kit/mcp_server/tests/file-watcher.vitest.ts:601`.
- `code_graph_status` currently calls only `getGraphFreshness(process.cwd())` at `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/status.ts:163`, then builds a readiness block with `action:"none"` at `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/status.ts:189` through `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/status.ts:194`.
- `getGraphFreshness` is explicitly non-mutating at `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/ensure-ready.ts:452` through `.opencode/skills/system-spec-kit/mcp_server/code_graph/lib/ensure-ready.ts:455`, but it returns only freshness, not the detector's recommended action.
- Tool schema tests only assert that `code_graph_status` accepts empty input and rejects extra parameters at `.opencode/skills/system-spec-kit/mcp_server/tests/tool-input-schema.vitest.ts:543` through `.opencode/skills/system-spec-kit/mcp_server/tests/tool-input-schema.vitest.ts:545` and `.opencode/skills/system-spec-kit/mcp_server/tests/tool-input-schema.vitest.ts:607` through `.opencode/skills/system-spec-kit/mcp_server/tests/tool-input-schema.vitest.ts:611`; I did not find a dedicated handler test that asserts status readiness actions.

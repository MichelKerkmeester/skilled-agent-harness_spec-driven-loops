...
- Failure record: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-stress-test/008-spec-memory-mcp-stress-test/evidence/tool-sweep.jsonl:30` records `checkpoint_create` failing at `2026-05-16T16:20:00.000Z` with `CHECKPOINT_CREATE_FAILED`.
...
- Sweep order evidence: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-stress-test/008-spec-memory-mcp-stress-test/evidence/tool-sweep.jsonl:35` records `memory_bulk_delete` at `16:25Z`, after the checkpoint_create failure, using CLI dry-run with zero affected memories.

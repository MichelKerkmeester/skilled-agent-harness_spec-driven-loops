...
NOTE: Changelog spec folder exists and is Level 2; `c3e2a0ae5d` is a real commit, but the shipped-file and verification claims are not currently auditable against disk.

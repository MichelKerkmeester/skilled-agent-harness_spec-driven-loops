...
NOTE: Spec folder exists and Level 2/docs align historically; commit `8511995d6a` makes the verification/changed-file claims plausible but current shipped files no longer match.

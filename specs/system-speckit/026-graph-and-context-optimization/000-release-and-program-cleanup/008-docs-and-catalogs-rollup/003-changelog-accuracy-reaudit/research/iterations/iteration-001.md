...
NOTE: Spec folder exists, Level 2 matches, `decision-record.md` is absent, all Files Changed paths exist, commit `821c296fa1` is real, and shipped code matches the socketPath claims.

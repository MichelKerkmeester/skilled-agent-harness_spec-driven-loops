...
NOTE: Root folder and 4 child folders/changelogs exist; phase-parent Level validates and hashes `719610899f`, `e6658798ed`, `ef1e78669b` resolve, but current disk state does not support shipped-file claims.

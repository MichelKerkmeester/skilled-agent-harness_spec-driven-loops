...
- [x] T003 [P] Read reference resource map (`.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-fix-mcp-runtime-stress-findings/resource-map.md`)
<!-- /ANCHOR:phase-1 -->

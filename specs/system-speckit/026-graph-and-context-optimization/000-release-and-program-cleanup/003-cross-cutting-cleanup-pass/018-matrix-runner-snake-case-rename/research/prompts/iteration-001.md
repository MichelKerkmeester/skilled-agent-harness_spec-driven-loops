...
- Spec docs in `specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/006-runtime-matrix-execution-validation/` and `016-runtime-hook-plugin-testing/` — may reference matrix_runners
- The 045/006-mcp-tool-schema-governance-audit and 045/007-deep-loop-workflow-integrity-audit review-reports may also cite the path
...
**Deps**: `manual.depends_on=["system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/011-cli-matrix-adapter-runners","system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/004-release-readiness-findings-synthesis-remediation"]`.

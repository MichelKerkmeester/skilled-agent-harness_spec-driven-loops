---
title: "Iteration 008 — B3: Memory MCP round-trip integrity"
trigger_phrases: []
---
...
## Actions Taken
- Enumerated the memory MCP entry points under `.opencode/skills/system-spec-kit/mcp_server/handlers/`, `.opencode/skills/system-spec-kit/mcp_server/handlers/save/`, and `.opencode/skills/system-spec-kit/mcp_server/tools/`.

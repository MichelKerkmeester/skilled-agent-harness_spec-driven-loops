---
title: "Iteration 002 — A2: Code-graph SQLite contention"
trigger_phrases: []
---
# Iteration 002 — A2: Code-graph SQLite contention

## Focus
Audited the code-graph SQLite read/write paths in `.opencode/skills/system-spec-kit/mcp_server/code_graph/handlers/` and `lib/`, with emphasis on concurrent scans, inline read-path reindexing, transaction boundaries, and snapshot consistency.

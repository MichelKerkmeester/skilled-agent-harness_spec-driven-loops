---
title: "Deep-Research Iteration 020 — Angle D5: Build / dist / runtime separation"
trigger_phrases: []
---
# Deep-Research Iteration 020 — Angle D5: Build / dist / runtime separation

You are the deep-research LEAF agent for iteration 020 of 20. The packet root is `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-system-bug-improvement-research/`.

**Workflow position**: Iteration 020 of 20. Convergence threshold: 0.01. Executor: yourself (cli-codex gpt-5.5 high, normal speed).
...
### 1. Iteration narrative — write to `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-system-bug-improvement-research/research/iterations/iteration-020.md`
...
|----|----------|-----------|-------------|----------------|
| F-020-D5-01 | P0/P1/P2/none | path/file.ext:LINE | What's wrong | What to do |

## Questions Answered
[Which sub-questions of D5 did this iteration answer?]

## Questions Remaining
[Open D5 questions for follow-on packets]
...
### 2. Per-iteration delta JSONL — write to `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/003-system-bug-improvement-research/research/deltas/iter-020.jsonl`

One JSON record per line. MUST start with the canonical iteration record:

```json
{"type":"iteration","iteration":20,"newInfoRatio":0.85,"status":"insight","focus":"D5: Build / dist / runtime separation","angle":"D5"}
```

Then one `{"type":"finding",...}` record per finding:

```json
{"type":"finding","id":"f-iter020-001","severity":"P1","label":"<short label>","file":"path/file.ext","line":NN,"iteration":20,"angle":"D5"}
```

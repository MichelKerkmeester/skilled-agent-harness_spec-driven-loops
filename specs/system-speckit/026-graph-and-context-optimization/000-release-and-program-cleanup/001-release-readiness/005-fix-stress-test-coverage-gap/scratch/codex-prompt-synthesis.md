...
Packet 044 path: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/000-release-cleanup/005-review-remediation/006-stress-test-coverage-gap-remediation/`
...
4. **Earlier run logs** for trajectory:
   ...
   - `.opencode/specs/.../007-stress-test-coverage-gap-remediation/logs/stress-run-20260430-190737Z.log` (38/38, 94/94, 29s)
...
4. Cross-reference catalog feature_ids by reading `006-stress-coverage-audit-and-run/coverage-matrix.csv` and matching each test file path to the `stress_test_files` and `supplementary_stress_files` columns.

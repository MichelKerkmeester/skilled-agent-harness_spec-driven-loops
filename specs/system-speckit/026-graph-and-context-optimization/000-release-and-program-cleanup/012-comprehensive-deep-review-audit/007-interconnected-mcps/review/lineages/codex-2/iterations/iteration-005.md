...
- `.opencode/skills/deep-loop-runtime/feature_catalog/fanout/fanout-run.md`
- `.opencode/skills/deep-loop-runtime/manual_testing_playbook/fanout/fanout-run-cli-lineage-spawn.md`

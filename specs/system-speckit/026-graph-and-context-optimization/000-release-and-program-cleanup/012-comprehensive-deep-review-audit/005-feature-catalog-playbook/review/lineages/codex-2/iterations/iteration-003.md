...
### P2, Suggestion
- **F003**: Detailed scenario 136 has malformed request and expected-signal text. The per-scenario file's real user request and expected signals contain a broken fragment beginning with `sort -u` rather than a complete user request [SOURCE: .opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/feature-catalog-annotation-name-validity.md:18] [SOURCE: .opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/feature-catalog-annotation-name-validity.md:21]. The later command section is usable and states the intended extraction/cross-reference steps clearly [SOURCE: .opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/feature-catalog-annotation-name-validity.md:37] [SOURCE: .opencode/skills/system-spec-kit/manual_testing_playbook/tooling-and-scripts/feature-catalog-annotation-name-validity.md:39], so this is a playbook clarity advisory rather than a blocking validation failure.

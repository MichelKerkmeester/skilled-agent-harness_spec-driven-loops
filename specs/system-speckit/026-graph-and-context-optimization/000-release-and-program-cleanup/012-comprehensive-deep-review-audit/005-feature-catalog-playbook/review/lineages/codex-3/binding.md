...
BINDING: executor=cli-codex model=gpt-5.5
BINDING: artifact root bound directly from config.fanout_lineage_artifact_dir; resolveArtifactRoot was not run.
BINDING: cli-codex self-invocation refused by skill guard; this lineage was executed by the current Codex reviewer.

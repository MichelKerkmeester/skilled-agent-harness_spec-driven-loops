...
| `.opencode/skills/cli-opencode/manual_testing_playbook/cli-invocation/base-non-interactive-invocation.md` | Per-feature scenario format with 9-column contract. |
| `.opencode/skills/cli-opencode/manual_testing_playbook/external-dispatch/003-self-invocation-refusal.md` | Safety-focused scenario with variants and triage. |
...
|--------|---------------|
| 032 | `../../004-code-graph-watcher-claim-retraction/spec.md`, `plan.md`, and `implementation-summary.md` document read-path/manual freshness. |
| 033 | `../../005-memory-retention-policy-sweep/spec.md` and MCP README document `memory_retention_sweep`. |
| 034 | `../../010-half-auto-upgrade-doc-alignment/spec.md` and Skill Advisor handlers document diagnostic `advisor_status` plus explicit `advisor_rebuild`. |
| 035 | `006-runtime-matrix-execution-validation/logs/feature-runs/F5-code-graph-query.log`, `F6-code-graph-verify.log`, `F7-causal-graph.log`, `F8-cocoindex-calibration.log`, plus F5-F8 JSONL result files. |

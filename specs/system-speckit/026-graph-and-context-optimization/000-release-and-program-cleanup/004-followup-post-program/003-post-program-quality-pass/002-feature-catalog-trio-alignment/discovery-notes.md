...
trigger_phrases:
  - "037-002-feature-catalog-trio-alignment"
  - "catalog discovery"
...
| Catalog | Path | Action |
|---|---|---|
| system-spec-kit | `.opencode/skills/system-spec-kit/feature_catalog/feature_catalog` root file | Updated |
| skill_advisor | `.opencode/skills/system-spec-kit/mcp_server/skill_advisor/feature_catalog/feature_catalog` root file | Updated |
| sk-improve-agent | `.opencode/skills/sk-improve-agent/feature_catalog/feature_catalog` root file | Not in packet scope |
| sk-deep-research | `.opencode/skills/sk-deep-research/feature_catalog/feature_catalog` root file | Not in packet scope |
| sk-deep-review | `.opencode/skills/sk-deep-review/feature_catalog/feature_catalog` root file | Not in packet scope |
...
| Template | Path | Use |
|---|---|---|
| Feature catalog creation guide | `.opencode/skills/sk-doc/references/specific/feature_catalog_creation.md` | Format conventions |
| Root catalog template | `.opencode/skills/sk-doc/assets/documentation/feature_catalog/feature_catalog_template.md` | Root catalog structure |
| Per-feature snippet template | `.opencode/skills/sk-doc/assets/documentation/feature_catalog/feature_catalog_snippet_template.md` | Per-feature file structure |
...
| Search | Result |
|---|---|
| `.opencode/skills/system-spec-kit/mcp_server/code_graph/**/feature_catalog*` | No matches |
| `.opencode/skills/system-spec-kit/mcp_server/**/code_graph*feature*` | No matches |
| repo-wide feature-catalog path search for code_graph-specific catalog | No standalone catalog |

The live code graph documentation surface is `.opencode/skills/system-spec-kit/mcp_server/code_graph/README.md`, and existing catalog entries live inside the system-spec-kit catalog under `22--context-preservation-and-code-graph/`.
...
Packet 036 is present. The adapter runner files exist under `.opencode/skills/system-spec-kit/mcp_server/matrix_runners/`, including:

...
- The `system-rerank-sidecar` skill was removed in a subsequent cleanup commit (`ada2c51ee8`). If the skill is reinstated, the env forwarding and operator docs from this phase should be treated as the baseline.

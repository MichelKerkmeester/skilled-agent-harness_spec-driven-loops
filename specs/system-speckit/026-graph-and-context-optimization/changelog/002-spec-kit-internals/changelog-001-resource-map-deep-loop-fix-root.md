---
title: "Phase Parent Rollup: resource map deep loop fix"
description: "Rollup of 6 child phase changelogs under 001-resource-map-deep-loop-fix. Each child shipped independently and is listed in the Included Phases table. Detail lives in the child changelogs."
trigger_phrases:
...
|------|--------|--------------|
| `002-spec-kit-internals/001-resource-map-deep-loop-fix/` (child phases) | n/a | Rollup of 6 child phase changelogs, no direct source changes at the parent level |

---
title: "Deep Review Iteration 004 - validator-coverage"
trigger_phrases: []
---
...
- The generated 007 target contains the exact comment-only marker tokens that those shell rules count: `SCAFFOLD_VALIDATION_COUNTS` carries `REQ-003` through `REQ-008` and six `**Given**` rows [SOURCE: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/007-marker-validation-unused-scaffold/spec.md:240-253], while `SCAFFOLD_AI_PROTOCOL_MARKERS` carries AI protocol keywords in `plan.md` [SOURCE: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/007-marker-validation-unused-scaffold/plan.md:279-285].

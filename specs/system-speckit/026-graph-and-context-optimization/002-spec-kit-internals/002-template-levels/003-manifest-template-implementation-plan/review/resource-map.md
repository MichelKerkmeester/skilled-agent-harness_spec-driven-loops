---
title: "Resource Map — /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/008-template-levels/003-manifest-template-implementation-plan"
...
- **Total references**: 5
- **By category**: READMEs=0, Documents=0, Commands=0, Agents=1, Skills=4, Specs=0, Scripts=0, Tests=0, Config=0, Meta=0
- **Missing on disk**: 0
- **Scope**: review convergence output for 003-manifest-template-implementation-plan
- **Generated**: 2026-05-04T08:16:16.979Z

...
| Field | Value |
|-------|-------|
| **Target** | `system-spec-kit/026-graph-and-context-optimization/008-template-levels/008-archive-marker-validation-unused-scaffold` |
...
- **Evidence**:
  ...
  - All seven docs share continuity frontmatter `packet_pointer: "scaffold/008-archive-marker-validation-unused-scaffold"`, `completion_pct: 0`, `recent_action: "Initialized Level 3 template"` (last touched 2026-05-02T09:34:31Z, ≥3 days stale)
...
- **Evidence**:
  - All 7 docs have `_memory.continuity.session_dedup.session_id: "scaffold-scaffold/008-archive-marker-validation-unused-scaffold"`

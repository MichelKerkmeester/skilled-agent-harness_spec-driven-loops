---
title: "Iteration 1: Parser Contract Probe And Irreducible Core Inventory"
trigger_phrases: []
---
...
- Read `.opencode/skills/system-spec-kit/scripts/utils/template-structure.js` end-to-end.
- Read `.opencode/skills/system-spec-kit/shared/parsing/spec-doc-health.ts` end-to-end.
- Read `.opencode/skills/system-spec-kit/shared/parsing/memory-sufficiency.ts` end-to-end.
- Read `.opencode/skills/sk-deep-research/scripts/reduce-state.cjs` end-to-end.
- Read `.opencode/skills/system-spec-kit/scripts/rules/check-files.sh` end-to-end.
- Read `.opencode/skills/system-spec-kit/scripts/rules/check-frontmatter.sh` end-to-end.
- Read `.opencode/skills/system-spec-kit/scripts/rules/check-template-source.sh` end-to-end.
- Read `.opencode/skills/system-spec-kit/scripts/rules/check-spec-doc-integrity.sh` end-to-end.
- Probed adjacent contracts needed for Q1: `.opencode/skills/system-spec-kit/scripts/spec/validate.sh`, `.opencode/skills/system-spec-kit/mcp_server/lib/resume/resume-ladder.ts`, `.opencode/skills/system-spec-kit/mcp_server/lib/continuity/thin-continuity-record.ts`, `.opencode/skills/system-spec-kit/mcp_server/lib/description/description-schema.ts`, `.opencode/skills/system-spec-kit/mcp_server/lib/graph/graph-metadata-schema.ts`, and `.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts`.
...
```json
{
  "specFolder": "system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-manifest-driven-template-design",
...
{
  "schema_version": 1,
  "packet_id": "system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-manifest-driven-template-design",
  "spec_folder": "system-spec-kit/026-graph-and-context-optimization/008-template-levels/002-manifest-driven-template-design",
  "parent_id": null,
  "children_ids": [],
  "manual": {
    "depends_on": [],

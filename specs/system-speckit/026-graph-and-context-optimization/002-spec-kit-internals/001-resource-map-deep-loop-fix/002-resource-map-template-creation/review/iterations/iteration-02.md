---
title: "Iteration 02: MCP runtime code correctness"
trigger_phrases: []
---
...
- No `dist/` JS mirror exists under `.opencode/skills/system-spec-kit/mcp_server/`, so there is no generated runtime copy to rebuild or drift-check.

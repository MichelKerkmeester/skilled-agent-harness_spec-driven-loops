---
title: "Iteration 2 — correctness (parent + 001-initial-doctor-commands)"
trigger_phrases: []
---
# Iteration 2 — correctness (parent + 001-initial-doctor-commands)
...
| `001-initial-doctor-commands/spec.md` | Child spec (L2) | REQ-001..REQ-023, P0/P1/P2 requirements, scope, deliverables |
| `001-initial-doctor-commands/plan.md` | Child plan (L2) | Phase descriptions, quality gates, dispatch design |
| `001-initial-doctor-commands/tasks.md` | Child tasks (L2) | T-001..T-055 task status tracking |
| `001-initial-doctor-commands/checklist.md` | Child checklist (L2) | CHK-001..CHK-806 acceptance criteria verification status |
| `001-initial-doctor-commands/decision-record.md` | Child ADRs (L2) | ADR-001..ADR-010 — council spec, tx-model, mode reduction |
| `001-initial-doctor-commands/implementation-summary.md` | Child impl summary (L2) | Status claims, files-touched ledger, completion_pct |
| `001-initial-doctor-commands/description.json` | Child metadata | ParentChain verification |
| `001-initial-doctor-commands/graph-metadata.json` | Child metadata | Status derivation |
| `001-initial-doctor-commands/resource-map.md` | Child resource map | (not deep-reviewed this pass) |
...
- **Evidence**: The field `"derived.last_active_child_id": null` contradicts REQ-P-002 which requires it to be one of `001-initial-doctor-commands` or `002-sandbox-testing-playbook`, matching the most recently saved child. This breaks the `/spec_kit:resume` redirect logic for phase parents.
...
- **Recommendation**: Set `derived.last_active_child_id` to `"001-initial-doctor-commands"` (the child with more recent `last_save_at`, per `description.json` memoryNameHistory). The field should be updated by `generate-context.js` saves on the child.

---

#### P1-002 [P1] Parent spec.md Phase Map claims child 001 is "Complete" but child's own docs show incomplete status

- **File**: Parent `spec.md:104` vs `001-initial-doctor-commands/implementation-summary.md:51-52`
- **Evidence**: 
  - Parent `spec.md:104`: `"001-initial-doctor-commands/ | Complete | ..."`
...
- **File**: `001-initial-doctor-commands/implementation-summary.md:52` and `:241-246`
- **Evidence**:
...
- **File**: `001-initial-doctor-commands/tasks.md:85-140`
- **Evidence**:
...
- **File**: Parent `spec.md:105` vs `001-initial-doctor-commands/decision-record.md:228-229`
- **Evidence**:
...
- **File**: `001-initial-doctor-commands/implementation-summary.md:98-118` vs `001-initial-doctor-commands/decision-record.md:228`
- **Evidence**:

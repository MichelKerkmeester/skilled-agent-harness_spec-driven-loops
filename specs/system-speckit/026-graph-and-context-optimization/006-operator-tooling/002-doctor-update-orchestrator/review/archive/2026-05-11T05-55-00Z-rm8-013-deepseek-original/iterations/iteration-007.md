...
|------|---------------|-------|
| 001-initial-doctor-commands/spec.md:352 | skill_agent source | Commands: memory, causal-graph, deep-loop, cocoindex, update (5 new) |
| 001-initial-doctor-commands/implementation-summary.md:309 | skill_agent + agent_cross_runtime | 34 files authored; no @agent creation mentioned |

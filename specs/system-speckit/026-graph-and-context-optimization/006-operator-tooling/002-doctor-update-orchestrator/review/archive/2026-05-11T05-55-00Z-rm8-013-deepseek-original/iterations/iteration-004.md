---
title: "Iteration 4 — security (doctor command surface)"
trigger_phrases: []
---
...
| `001-initial-doctor-commands/spec.md:352` | Spec (references) | Security NFRs (NFR-OS01..OS04); REQ-005 flock, REQ-006 snapshots |
| `001-initial-doctor-commands/decision-record.md:238` | ADRs (references) | ADR-001 tx model, ADR-005 concurrent dispatch, ADR-002 snapshots, ADR-008 migration safety |
| `001-initial-doctor-commands/implementation-summary.md:309` | Implementation status | completion_pct=99; FIX-12/FIX-13 patched |

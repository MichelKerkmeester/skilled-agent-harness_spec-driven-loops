...
| `_sandbox/doctor-commands/Dockerfile:26` | impl | Container image definition, user setup |
| `_sandbox/doctor-commands/docker-compose.yml:15` | impl-p0 | Volume mounts, env vars, service config |
| `_sandbox/doctor-commands/fixtures/manifest.json:46` | impl | Fixture URLs, SHA-256, credentials check |
| `_sandbox/doctor-commands/fixtures/fetch-fixtures.sh:152` | impl | Idempotent download + checksum verify |
| `_sandbox/doctor-commands/harness/run-all.sh:202` | impl | Orchestrator, dry-run, verdict rollup |
| `_sandbox/doctor-commands/harness/reset-state.sh:86` | impl-p0 | Fixture restore, sandbox guard |
| `_sandbox/doctor-commands/harness/capture-evidence.sh:147` | impl-p0 | Command execution, evidence capture |
| `_sandbox/doctor-commands/harness/assert-signals.sh:150` | impl | Grep-based signal assertions |
| `_sandbox/doctor-commands/scenarios/DOC-323-*.sh:31` | impl-sample | Representative scenario wrapper |
| `_sandbox/doctor-commands/scenarios/DOC-327-*.sh:31` | impl-sample | Disk-pressure scenario (destructive check) |
| `_sandbox/doctor-commands/scenarios/DOC-342-*.sh:31` | impl-sample | Dashboard scenario wrapper |
| `_sandbox/doctor-commands/scenarios/DOC-345-*.sh:33` | impl-sample | Version migration scenario wrapper |
...
- **File**: `.opencode/skills/system-spec-kit/manual_testing_playbook/_sandbox/doctor-commands/docker-compose.yml:8`
...
- **Scope proof**: `rg "volumes:" -A 5 _sandbox/doctor-commands/docker-compose.yml` confirms a single service definition with one broad root mount. No other compose files exist in the sandbox.
...
- **File**: `.opencode/skills/system-spec-kit/manual_testing_playbook/_sandbox/doctor-commands/docker-compose.yml:3-15`
...
- **Finding class**: instance-only
- **Scope proof**: `rg "cap_|capability" _sandbox/doctor-commands/` returns zero matches. Only the non-root user guard is in place.
...
- **File**: `.opencode/skills/system-spec-kit/manual_testing_playbook/_sandbox/doctor-commands/docker-compose.yml:14` → `harness/capture-evidence.sh:83`
...
- **Finding class**: instance-only
- **Scope proof**: `rg "SPECKIT_DOCTOR_RUNNER" _sandbox/doctor-commands/` returns docker-compose.yml line 14 and capture-evidence.sh lines 82-83. No other references exist.
...
- **File**: `.opencode/skills/system-spec-kit/manual_testing_playbook/_sandbox/doctor-commands/Dockerfile:1`
...
- **File**: `.opencode/skills/system-spec-kit/manual_testing_playbook/_sandbox/doctor-commands/harness/reset-state.sh:43-44, 54`
...
- **Finding class**: instance-only
- **Scope proof**: `rg "require_sandbox_reset\|SPECKIT_ALLOW_HOST_RESET\|SPECKIT_SANDBOX" _sandbox/doctor-commands/harness/reset-state.sh` confirms the single guard path.

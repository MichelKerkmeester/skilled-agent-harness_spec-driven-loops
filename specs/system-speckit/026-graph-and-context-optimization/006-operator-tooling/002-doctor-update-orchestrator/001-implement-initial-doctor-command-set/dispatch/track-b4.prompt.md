...
5. **`.opencode/specs/system-spec-kit/026-graph-and-context-optimization/010-doctor-update-orchestrator/spec.md` §3.4** — per-command specification.
6. **`.opencode/specs/system-spec-kit/026-graph-and-context-optimization/016-embedder-testing-and-architecture/004-code-index-stack/010-daemon-resilience/spec.md`** — predecessor packet shipping daemon idempotency fix (3.4.1.0). Reference for "refuse if daemon unhealthy" semantics.

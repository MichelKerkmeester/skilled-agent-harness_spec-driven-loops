---
title: "Single-Pass Deep Review — 009/002 Copilot Hook Parity Remediation"
trigger_phrases: []
---
# Single-Pass Deep Review — 009/002 Copilot Hook Parity Remediation

**GATE 3 PRE-ANSWERED — A**: `specs/system-spec-kit/026-graph-and-context-optimization/007-hook-parity/002-copilot-custom-instructions-hook-parity`. Pre-approved.
...
1. **Read inputs**:
   - `specs/system-spec-kit/026-graph-and-context-optimization/007-hook-parity/002-copilot-custom-instructions-hook-parity/{spec,plan,tasks,checklist,implementation-summary,decision-record}.md`
...
3. **Output review-report.md** at `specs/system-spec-kit/026-graph-and-context-optimization/007-hook-parity/002-copilot-custom-instructions-hook-parity/review/002-copilot-custom-instructions-hook-parity-tier2-pt-01/review-report.md` with standard 9-section + Planning Packet.

---
title: "Iteration 2: <focus-topic>"
trigger_phrases: []
---
You are executing iteration 2 of 10 of a deep-research loop against the Copilot CLI hook parity question. Operate as a LEAF agent — do not dispatch sub-agents.
...
Write to: /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/001-copilot-hook-gap-deep-review-remediation/iterations/iteration-2.md

Structure:
# Iteration 2: <focus-topic>
## Focus
<1-2 sentences>
## Actions Taken
...
## Next Focus
<one-sentence recommendation for iteration 3>
...
{"type":"iteration","run":2,"status":"insight"|"evidence"|"thought"|"dead-end","focus":"<short focus label>","findingsCount":<int>,"newInfoRatio":<0..1>,"citationCount":<int>,"primarySourceCount":<int>,"timestamp":"<ISO8601>","graphEvents":[]}

newInfoRatio guidance: 1.0 = all findings new; 0.0 = all redundant with prior iterations. Be honest.

### 3. Per-iteration delta file

Write to: /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/001-copilot-hook-gap-deep-review-remediation/deltas/iter-2.jsonl
...
Begin iteration 2 now. Produce the three artifacts.

...
- `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/002-copilot-hook-followup-deep-review-remediation/iterations/iteration-004.md` — full prior findings
...
1. Iteration narrative: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/002-copilot-hook-followup-deep-review-remediation/iterations/iteration-005.md`
...
3. Delta file: `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/research/002-copilot-hook-followup-deep-review-remediation/deltas/iter-005.jsonl` — with iteration record + per-event (finding, invariant, observation, edge, ruled_out) records.

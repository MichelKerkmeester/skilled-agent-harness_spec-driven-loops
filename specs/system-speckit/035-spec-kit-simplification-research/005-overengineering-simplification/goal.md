...
- [ ] 10 iteration files and 10 state events exist under research/lineages/glm-5-3-flash-overengineering/
- [ ] research.md carries a ranked simplification plan with capability, files, risk and expected gain per item
- [ ] Every P1 item reproduces in-session
- [ ] The plan names which items become remediation children
<!-- /ANCHOR:completion -->

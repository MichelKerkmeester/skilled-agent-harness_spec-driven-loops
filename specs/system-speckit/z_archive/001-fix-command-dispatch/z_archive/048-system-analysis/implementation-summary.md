...
- **Location:** `.opencode/skills/system-spec-kit/scripts/test-fixtures/`
- **Fixtures:**
...
- **Status:** ✅ Completed
- **File Modified:** `.opencode/skills/system-spec-kit/mcp_server/lib/trigger-matcher.js`
- **Changes:**
...
- **Status:** ✅ Completed
- **File Modified:** `.opencode/skills/system-spec-kit/mcp_server/context-server.js`
- **Changes:**
...
- **Files Modified:**
  ...
  - `.opencode/skills/mcp-narsil/scripts/narsil-server.sh` - Removed hardcoded default
  - `.opencode/skills/mcp-narsil/SKILL.md` - Updated documentation
  - `.env.example` - Added all required env vars

### T-P3-005: JS Validators Deprecation
- **Status:** ✅ Completed
- **Files Deleted:**
  - `.opencode/skills/system-spec-kit/scripts/validate-spec-folder.js`
  - `.opencode/skills/system-spec-kit/scripts/validate-memory-file.js`

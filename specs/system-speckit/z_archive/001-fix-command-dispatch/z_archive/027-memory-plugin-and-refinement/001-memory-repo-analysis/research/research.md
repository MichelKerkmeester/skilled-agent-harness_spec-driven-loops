...
- `.opencode/specs/system-spec-kit/z_archive/001-fix-command-dispatch/z_archive` - Parent memory system specs
- `.opencode/specs/system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/014-anchor-enforcement` - Anchor format requirements
- `.opencode/specs/system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/018-generate-context-fix` - Context generation improvements

---
title: "Spec: SpecKit [system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/003-speckit-skill-refinement/spec]"
...
- `.opencode/specs/system-spec-kit/z_archive/001-fix-command-dispatch/z_archive` - Previous SpecKit work
- `.opencode/specs/system-spec-kit/z_archive/001-fix-command-dispatch/z_archive` - Memory system (referenced by SpecKit)

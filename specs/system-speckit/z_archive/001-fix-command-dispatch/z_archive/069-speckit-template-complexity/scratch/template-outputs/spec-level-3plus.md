...
> **Note**: This section is auto-populated by complexity detection. Values marked [AUTO] are filled during spec folder creation.



### Executive Summary

[YOUR_VALUE_HERE: 2-3 sentence high-level overview for stakeholders who need quick context without reading full spec]

**Key Decisions**:
- [YOUR_VALUE_HERE: Major decision 1]
- [YOUR_VALUE_HERE: Major decision 2]

**Critical Dependencies**:
- [YOUR_VALUE_HERE: Blocking dependency 1]

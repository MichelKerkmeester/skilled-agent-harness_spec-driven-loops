...
A constitutional memory reminds the AI to always ask the spec folder question before file modifications. See `.opencode/specs/system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/030-gate3-enforcement` for implementation details.
```
...
See `.opencode/specs/system-spec-kit/z_archive/001-fix-command-dispatch/z_archive/030-gate3-enforcement` for details.
```

...
- Created constitutional folder at .opencode/skills/system-memory/constitutional/
...
- `.opencode/skills/system-memory/references/save-workflow.md` (NEW)
- `.opencode/skills/system-memory/references/folder_routing.md` (NEW)
- `.opencode/skills/system-memory/references/troubleshooting.md` (UPDATED)

---
title: "Feature Specification: MCP Issues After Update [system-spec-kit/z_archive/018-mcp-issues-after-update/spec]"
...
trigger_phrases:
  ...
  - "mcp issues after update"
  - "archive"
  - "validation"
importance_tier: "normal"
contextType: "general"
---
# Feature Specification: MCP Issues After Update
...
| **Status** | Complete |
| **Created** | 2026-03-31 |
| **Branch** | `018-mcp-issues-after-update` |
<!-- /ANCHOR:metadata -->
...
### Problem Statement
This archived system-spec-kit archive folder captures work related to MCP Issues After Update. The earlier markdown drifted away from the active templates, which caused validator failures and made the archive harder to trust.
...
### In Scope
- Preserve the archived topic and folder identity for MCP Issues After Update.
...
|----|-------------|---------------------|
| REQ-001 | The archive must clearly state that the folder documents MCP Issues After Update. | A maintainer can identify the archived topic from spec.md without opening other files. |

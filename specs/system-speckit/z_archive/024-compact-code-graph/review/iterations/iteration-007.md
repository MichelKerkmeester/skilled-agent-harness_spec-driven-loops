...
- The reviewed read paths still run the same bounded inline readiness guard before answering and return readiness metadata rather than silently trusting stale graph state [SOURCE: .opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/context.ts:97] [SOURCE: .opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts:318] [SOURCE: .opencode/skills/system-spec-kit/mcp_server/handlers/code-graph/query.ts:328].
- The public surfaces stay aligned on the four-tool structural interface: `code_graph_query` and `code_graph_context` remain documented in the README and registered in the canonical tool list [SOURCE: .opencode/skills/system-spec-kit/mcp_server/README.md:988] [SOURCE: .opencode/skills/system-spec-kit/mcp_server/README.md:1003] [SOURCE: .opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:848] [SOURCE: .opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts:851].
- Dedicated handler tests still cover the extension-specific branches the root packet depends on, including context-readiness metadata and blast-radius traversal behavior [SOURCE: .opencode/skills/system-spec-kit/mcp_server/tests/code-graph-context-handler.vitest.ts:48] [SOURCE: .opencode/skills/system-spec-kit/mcp_server/tests/code-graph-query-handler.vitest.ts:148] [SOURCE: .opencode/skills/system-spec-kit/mcp_server/tests/code-graph-query-handler.vitest.ts:219].

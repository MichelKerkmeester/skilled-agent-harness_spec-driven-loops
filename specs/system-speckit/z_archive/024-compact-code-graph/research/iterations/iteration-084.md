...
## Focus
Read all `.opencode/agents/*.md` files, inspect `.opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml`, and inspect the root `CLAUDE.md` workflow guidance. Design concrete instruction changes so OpenCode agents auto-trigger memory recovery and code-graph readiness on session start without relying on Claude-only hooks.
...
[SOURCE: .opencode/agents/ultra-think.md:1-23]
[SOURCE: .opencode/agents/debug.md:1-20]
[SOURCE: .opencode/agents/deep-research.md:1-20]
[SOURCE: .opencode/agents/deep-review.md:1-19]
[SOURCE: .opencode/agents/handover.md:1-20]
[SOURCE: .opencode/agents/orchestrate.md:1-16]
[SOURCE: .opencode/agents/review.md:1-20]
[SOURCE: .opencode/agents/speckit.md:1-20]
[SOURCE: .opencode/agents/write.md:1-20]
...
[SOURCE: .opencode/agents/context.md:45-49]
[SOURCE: .opencode/agents/context.md:117-119]
[SOURCE: .opencode/agents/deep-research.md:437-441]
[SOURCE: .opencode/agents/deep-review.md:542-546]
[SOURCE: .opencode/agents/handover.md:322-326]
[SOURCE: .opencode/agents/speckit.md:583-587]
[SOURCE: .opencode/agents/orchestrate.md:805-822]
...
[SOURCE: .opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml:69-81]
[SOURCE: .opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml:127-155]
...
[SOURCE: .opencode/agents/context.md:45-49]
[SOURCE: .opencode/agents/context.md:117-119]
[SOURCE: .opencode/agents/ultra-think.md:50-58]
[SOURCE: .opencode/agents/orchestrate.md:805-822]
[SOURCE: .opencode/agents/deep-research.md:437-441]
[SOURCE: .opencode/agents/deep-review.md:542-546]
[SOURCE: .opencode/agents/handover.md:322-326]
[SOURCE: .opencode/agents/speckit.md:583-587]
[SOURCE: .opencode/agents/debug.md:95-100]
[SOURCE: .opencode/agents/review.md:60-64]
[SOURCE: .opencode/agents/write.md:83-87]
...
[SOURCE: .opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml:19-21]
[SOURCE: .opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml:75-81]
[SOURCE: .opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml:83-92]
[SOURCE: .opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml:127-142]
...
[SOURCE: CLAUDE.md:44-51]
[SOURCE: CLAUDE.md:99-101]
[SOURCE: .opencode/agents/deep-research.md:439-441]
[SOURCE: .opencode/agents/orchestrate.md:807-822]

## Ruled Out
- Running `code_graph_context()` unconditionally on every session start. That would violate the resume workflow's "minimal friction" and "stop when one safe next action is known" design. [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml:19-21] [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml:75-76] [SOURCE: .opencode/commands/spec_kit/assets/spec_kit_resume_auto.yaml:83-86]
- Keeping the graph logic only inside late `HOOK-INJECTED CONTEXT & QUERY ROUTING` appendices. Those sections are useful as fallback notes, but they are not structured as mandatory first-turn behavior. [SOURCE: .opencode/agents/deep-research.md:437-441] [SOURCE: .opencode/agents/deep-review.md:542-546] [SOURCE: .opencode/agents/handover.md:322-326] [SOURCE: .opencode/agents/speckit.md:583-587]
- Requiring Claude-style lifecycle hooks for OpenCode. The existing OpenCode files already assume a non-hook fallback path (`memory_context` then `memory_match_triggers`), so the right upgrade is stronger self-trigger instructions, not a hook dependency. [SOURCE: .opencode/agents/orchestrate.md:807-812] [SOURCE: .opencode/agents/deep-research.md:439-441]
...
Use this iteration's proposed `Session Start Protocol` as an input to the final cross-runtime parity matrix and implementation roadmap. The next useful synthesis step is to map which parts belong in `CLAUDE.md` (universal), which belong in `.opencode/agents/*.md` (OpenCode runtime behavior), and which belong in `spec_kit_resume_auto.yaml` (resume-command orchestration).

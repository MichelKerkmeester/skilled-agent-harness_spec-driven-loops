...
_memory:
  continuity:
    packet_pointer: "system-speckit/z_archive/024-compact-code-graph/033-fts-forced-degrade-hardening"
...
### Overview
Run the runtime audit first. If truth gaps remain, harden the matrix and tests; otherwise mark the packet folded into 032.
<!-- /ANCHOR:summary -->
...
```text
Research root -> predecessor packet -> 033-fts-forced-degrade-hardening -> successor packet
```

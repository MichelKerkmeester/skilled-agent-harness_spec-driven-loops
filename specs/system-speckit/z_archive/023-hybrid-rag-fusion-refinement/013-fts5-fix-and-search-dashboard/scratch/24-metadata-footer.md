# Design 24: Natural Language Header

> No box formatting. Reads like a sentence.

```text
  10 results for "semantic search"
...
### Concept
Zero chrome. Feels like natural output, not a dashboard.

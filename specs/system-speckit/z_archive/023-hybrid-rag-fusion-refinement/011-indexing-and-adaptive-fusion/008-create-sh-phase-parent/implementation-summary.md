---
title: ".../023-hybrid-rag-fusion-refinement/011-indexing-and-adaptive-fusion/008-create-sh-phase-parent/implementation-summary]"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/z_archive/023-hybrid-rag-fusion-refinement/011-indexing-and-adaptive-fusion/008-create-sh-phase-parent"
...
2. **Track folder validation** Track folders like `system-spec-kit` bypass basename validation entirely when used as parents — this is intentional since the approved-root check provides sufficient safety.
<!-- /ANCHOR:limitations -->

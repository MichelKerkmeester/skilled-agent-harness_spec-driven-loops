---
title: "Tasks: Spec & Memory [system-spec-kit/023-hybrid-rag-fusion-refinement/008-spec-memory-compliance-audit/tasks]"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/z_archive/023-hybrid-rag-fusion-refinement/008-spec-memory-compliance-audit"
...
**Active:**
- [ ] T024 [P] Fix `00--anobel.com/029-anobel-performance-analysis`
- [ ] T025 [P] Fix `00--anobel.com/030-label-product-content-attr`
- [ ] T026 [P] Fix `00--anobel.com/031-fix-download-btn-transition-glitch`
- [ ] T027 [P] Fix `00--anobel.com/032-cloudflare-r2-migration`
- [ ] T028 [P] Fix `00--anobel.com/033-form-upload-issues`
- [ ] T029 [P] Fix `00--anobel.com/034-form-bot-problem`
- [ ] T030 [P] Fix `00--anobel.com/035-hero-contact-success`
...
**Active top-level:**
- [ ] T059 [P] Fix `system-spec-kit/021-spec-kit-phase-system`
- [ ] T060 [P] Fix `system-spec-kit/022-hybrid-rag-fusion`
- [ ] T061 [P] Fix `system-spec-kit/023-hybrid-rag-fusion-refinement`
- [ ] T062 [P] Fix `system-spec-kit/024-compact-code-graph`
- [ ] T063 [P] Fix `system-spec-kit/999-sqlite-to-turso`

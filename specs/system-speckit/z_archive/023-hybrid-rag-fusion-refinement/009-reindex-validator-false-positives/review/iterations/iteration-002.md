...
- **File**: `.opencode/skills/system-spec-kit/scripts/extractors/session-extractor.ts:120-150`; `.opencode/skills/system-spec-kit/scripts/extractors/collect-session-data.ts:886-893`; `.opencode/skills/system-spec-kit/scripts/extractors/collect-session-data.ts:1044-1047`; `.opencode/skills/system-spec-kit/scripts/core/memory-metadata.ts:68-78`; `.opencode/skills/system-spec-kit/scripts/core/memory-metadata.ts:127-137`
...
- **File**: `.opencode/skills/system-spec-kit/mcp_server/lib/parsing/memory-parser.ts:108-121`; `.opencode/skills/system-spec-kit/scripts/lib/frontmatter-migration.ts:831-840`; `.opencode/skills/system-spec-kit/scripts/lib/frontmatter-migration.ts:1026-1046`
...
- **File**: `.opencode/skills/system-spec-kit/mcp_server/tests/memory-parser-extended.vitest.ts:219-233`

...
- **File:** `changelog/01--system-spec-kit/` (directory listing ends at `v3.1.4.0.md`), `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/009-reindex-validator-false-positives/review/deep-review-strategy.md:49`, `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/009-reindex-validator-false-positives/spec.md:95-112`, `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/009-reindex-validator-false-positives/checklist.md:34-43`
...
- **File:** `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/009-reindex-validator-false-positives/spec.md:104-122`, `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/009-reindex-validator-false-positives/checklist.md:35-43`, `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/002-indexing-normalization/spec.md:24-37`, `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/002-indexing-normalization/spec.md:320-328`, `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/002-indexing-normalization/plan.md:20-31`, `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/002-indexing-normalization/plan.md:318-323`, `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/002-indexing-normalization/decision-record.md:20-32`, `.opencode/specs/system-spec-kit/022-hybrid-rag-fusion/002-indexing-normalization/decision-record.md:190-195`
...
- **File:** `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/009-reindex-validator-false-positives/spec.md:104-118`, `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/009-reindex-validator-false-positives/checklist.md:18-20`, `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/009-reindex-validator-false-positives/checklist.md:39-40`
...
- **File:** `.opencode/specs/system-spec-kit/023-hybrid-rag-fusion-refinement/009-reindex-validator-false-positives/review/deep-review-strategy.md:6-7`
- **Evidence:** The strategy says the scope is "14 source files + 41 template files." That count does not match the committed work for the spec-009 fix series. Across the relevant commits (`0829afc8a`, `781e53404`, `a7656dc97`, `1c932a4a0`, `a2b4be2af`, `369357cf5`, `c151fcd4f`), only two template files are touched: `.opencode/skills/system-spec-kit/templates/context_template.md` and `.opencode/skills/system-spec-kit/templates/addendum/phase/phase-child-header.md`. Even the broader diff from `v3.1.4.0` to `c151fcd4f` only shows 15 changed template files, not 41.

...
_memory:
  continuity:
    packet_pointer: "system-speckit/z_archive/023-hybrid-rag-fusion-refinement/007-hybrid-search-null-db-fix"
...
| **Status** | Complete |
| **Created** | 2026-03-30 |
| **Branch** | `main` (phase of 023-hybrid-rag-fusion-refinement) |
<!-- /ANCHOR:metadata -->
...
**Why null?**: Most likely ESM module duplication — `init()` sets state on one module instance while search functions execute on a different instance. This aligns with the parent spec (023-hybrid-rag-fusion-refinement).

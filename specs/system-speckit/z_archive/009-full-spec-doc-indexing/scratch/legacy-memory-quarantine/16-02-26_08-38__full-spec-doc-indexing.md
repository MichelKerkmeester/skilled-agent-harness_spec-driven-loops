...
| Spec Folder | system-spec-kit/z_archive/009-full-spec-doc-indexing |
| Channel | main |
...
```
/spec_kit:resume system-spec-kit/z_archive/009-full-spec-doc-indexing
```

**Or paste this continuation prompt:**
```
CONTINUATION - Attempt 2
Spec: system-spec-kit/z_archive/009-full-spec-doc-indexing
...
|----------|----------|-----------------|
| Context Loss | Agent doesn't remember prior work | Run `/spec_kit:resume system-spec-kit/z_archive/009-full-spec-doc-indexing` |
| State Mismatch | Files don't match expected state | Verify with `git status` and `git diff` |
| Memory Not Found | Search returns no results | Check `memory_search({ specFolder: "system-spec-kit/z_archive/009-full-spec-doc-indexing" })` |
...
memory_search({ specFolder: "system-spec-kit/z_archive/009-full-spec-doc-indexing", limit: 10 })

# Verify memory file integrity
ls -la system-spec-kit/z_archive/009-full-spec-doc-indexing/memory/

# Check for orphaned memories
memory_search({ query: "orphaned", anchors: ["state"] })

# Force re-index of this spec folder
node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js system-spec-kit/z_archive/009-full-spec-doc-indexing --force
```
...
spec_folder: "system-spec-kit/z_archive/009-full-spec-doc-indexing"
channel: "main"
...
parent_spec: "system-spec-kit/z_archive/009-full-spec-doc-indexing"
child_sessions:

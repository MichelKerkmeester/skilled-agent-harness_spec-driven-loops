...
1. **Two-path normalizer creates asymmetric field handling (silent drops on fast-path).**
   ...
   [SOURCE: .opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts:437-492]
...
2. **`sessionSummary` is silently consumed but never preserved as a first-class field.**
   ...
   [SOURCE: .opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts:545-587]
...
3. **Decision objects lose structured data during text flattening.**
   ...
   [SOURCE: .opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts:195-258]
...
4. **`technicalContext` is dual-stored but the observation version loses key structure.**
   ...
   [SOURCE: .opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts:287-311, 567-571]
...
5. **No validation for `observations` array element structure.**
   ...
   [SOURCE: .opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts:686-689, 39-44]
...
6. **`RawInputData` index signature `[key: string]: unknown` means ANY field is accepted without warning.**
   ...
   [SOURCE: .opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts:72-98, 621-703]
...
7. **V-rules operate on rendered markdown, not on the structured data pipeline.**
   ...
   [SOURCE: .opencode/skills/system-spec-kit/scripts/lib/validate-memory-quality.ts:456-686]
...
8. **No V-rule validates YAML frontmatter well-formedness.**
   ...
   [SOURCE: .opencode/skills/system-spec-kit/scripts/lib/validate-memory-quality.ts:183-304, 484-491]
...
## Sources Consulted
- `.opencode/skills/system-spec-kit/scripts/utils/input-normalizer.ts` (lines 1-784)
- `.opencode/skills/system-spec-kit/scripts/lib/validate-memory-quality.ts` (lines 1-729)
- `.opencode/skills/system-spec-kit/scripts/extractors/collect-session-data.ts` (lines 1-200)
- `.opencode/skills/system-spec-kit/scripts/core/workflow.ts` (lines 1-200)

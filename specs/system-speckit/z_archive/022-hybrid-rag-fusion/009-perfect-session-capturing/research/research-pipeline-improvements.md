...
> **Spec**: `009-perfect-session-capturing` | **Date**: 2026-03-16
...
- Parent folder relative path: `system-spec-kit/022-hybrid-rag-fusion/019-manual-testing-per-playbook` → depth=3, idVector=[19]
- Child folder (e.g., `001-retrieval`) relative path: `system-spec-kit/022-hybrid-rag-fusion/019-manual-testing-per-playbook/001-retrieval` → depth=4, idVector=[19, 1]

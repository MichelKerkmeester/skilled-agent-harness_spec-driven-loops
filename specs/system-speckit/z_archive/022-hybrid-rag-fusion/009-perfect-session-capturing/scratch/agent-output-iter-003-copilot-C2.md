...
● Search (grep)
  ...
  │ in **/*test*.{ts,js,mjs,cjs} (.opencode/skills/system-spec-kit)
  └ 25 lines found
...
● Read test-scripts-modules.js
  │ .opencode/skills/system-spec-kit/scripts/tests/test-scripts-modules.js
...
● Search (glob)
  │ "**/*context*_template*.md" in .opencode/skills/system-spec-kit/scripts
  └ No matches found

● Search (grep)
  │ "\{\{[\^#/]?\w+[\w.]*\}\}" in **/*template*.md (.opencode/skills/system-spec-kit/scripts)
  └ No matches found
...
● Search (glob)
  │ "**/context_template.md" in .opencode/skills/system-spec-kit
  └ 1 file found

● Search (grep)
  │ "\{\{[\w.#/^]+\}\}" (.opencode/skills/system-spec-kit/templates)
  └ 5 lines found

● Search (grep)
  │ "\{\{[\w.]+\}\}" (.opencode/skills/system-spec-kit/templates/context_template.md)
  └ 5 lines found
...
✗ Compare template placeholders with workflow data keys (shell)
  ...
  │ Env/Public/.opencode/skills/system-spec-kit/templates/context_template.md';
...
● Search (grep)
  │ "populateTemplate\(|renderTemplate\(" (.opencode/skills/system-spec-kit/scripts/tests)
  └ 8 lines found

● Search (grep)
  │ "Missing template data for" (.opencode/skills/system-spec-kit)
  └ 2 lines found
...
● Search (grep)
  ...
  │ ONTEXT_SUMMARY|PENDING_TASKS|RESUME_CONTEXT" (.opencode/skills/system-spec-kit/scripts)
  └ 7 files found
...
● Search (grep)
  │ "console\.warn\(|\bwarn\(" (.opencode/skills/system-spec-kit/scripts/core/workflow.ts)
  └ 5 lines found
...
● Search (grep)
  │ "\bwarn\(|console\.warn\(" (.opencode/skills/system-spec-kit/scripts/core/workflow.ts)
  └ 27 lines found

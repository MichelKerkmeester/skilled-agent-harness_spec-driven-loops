...
✗ Run skill advisor for routing (shell)
  │ python3 .opencode/skills/scripts/skill_advisor.py "Design minimum viable automated live-proof
...
● Search (grep)
  ...
  │ de|gemini|copilot)" (.opencode/skills/system-spec-kit/scripts/memory/generate-context.ts)
  └ 56 lines found
...
● Search (glob)
  │ "**/*{vitest,test}*.{ts,js}" in .opencode/skills/system-spec-kit/scripts
  └ 63 files found

● Search (grep)
  │ "runWorkflow|loadCollectedData|generate-context|--json|--stdin|NO_DATA_AVAILABLE|EXPLICIT_DATA_F
  │ ILE_LOAD_FAILED" (.opencode/skills/system-spec-kit/scripts/tests)
  └ 5 lines found
...
● Search (grep)
  │ "isSimulation\s*=|_isSimulation" (.opencode/skills/system-spec-kit/scripts/core/workflow.ts)
  └ 11 lines found

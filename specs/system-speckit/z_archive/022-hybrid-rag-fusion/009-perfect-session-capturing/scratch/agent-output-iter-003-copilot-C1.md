...
● Search (grep)
  ...
  │ rate-context)" (.opencode/skills/system-spec-kit/scripts/core/workflow.ts)
  └ 5 lines found

● Search (grep)
  │ "(opencode|claude|codex|gemini|stdin|--json|source|quality|timestamp|index|capture|session|proof
  │ |parity)" (.opencode/skills/system-spec-kit/scripts/extractors/opencode-capture.ts)
  └ 5 lines found

● Search (grep)
  │ "(opencode|claude|codex|gemini|copilot|stdin|--json|source|quality|timestamp|index|capture|sessi
  │ on|proof|parity)" (.opencode/skills/system-spec-kit/scripts/loaders/data-loader.ts)
  └ 5 lines found
...
● Search (grep)
  ...
  │ --json" (.opencode/skills/system-spec-kit/scripts/loaders/data-loader.ts)
  └ 20 lines found

● Search (grep)
  │ "parseArguments|parseStructuredModeArguments|timestamp|sourceCapabilities|_source|--stdin|--json
  │ |Usage" (.opencode/skills/system-spec-kit/scripts/memory/generate-context.ts)
  └ 22 lines found
...
● Search (grep)
  ...
  │ in **/*.{ts,js} (.opencode/skills/system-spec-kit/scripts)
  └ 5 lines found

● Read 007-session-capturing-pipeline-quality.md
  │ .opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/007-session-capt
...
● Search (grep)
  ...
  │ **/*.{ts,js} (.opencode/skills/system-spec-kit/scripts/core)
  └ 5 lines found
...
● Search (grep)
  ...
  │ ality_gate|skipped_index_policy" in **/*.{ts,js,md} (.opencode/skills/system-spec-kit/scripts)
  └ 106 lines found

● Search (grep)
  │ "SOURCE_SESSION_ID|SOURCE_TRANSCRIPT_PATH|SOURCE_CAPTURED_AT|SOURCE_CAPTURE|SOURCE_" in
  │ **/*.{ts,md} (.opencode/skills/system-spec-kit/scripts)
  └ 52 lines found
...
✗ Read sufficiency.ts
  │ .opencode/skills/system-spec-kit/scripts/core/sufficiency.ts
  └ Path does not exist
...
● Search (grep)
  ...
  │ |sufficiency" in **/*.{ts,js} (.opencode/skills/system-spec-kit/scripts/core)
  └ 42 lines found
...
● Search (grep)
  ...
  │ (.opencode/skills/system-spec-kit/manual_testing_playbook/16--tooling-and-scripts/007-session-cap
...
`SYSTEM_SPEC_KIT_CAPTURE_SOURCE=<opencode|claude|codex|copilot|gemini> node .opencode/skills/system-spec-kit/scripts/dist/memory/generate-context.js 009-perfect-session-capturing`  

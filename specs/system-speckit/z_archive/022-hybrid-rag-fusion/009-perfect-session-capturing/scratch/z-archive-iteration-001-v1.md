...
Synthesize the findings into `research/research.md`, then reconcile the parent pack plus phases `016` and `017` to match current runtime truth and current proof limits.

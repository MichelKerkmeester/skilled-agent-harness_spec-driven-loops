...
● Run skill advisor (shell)
  │ python3 .opencode/skills/scripts/skill_advisor.py "Fix P2 issues in six system-spec-kit feature
...
● Search (grep)
  │ "reconsolidat" in **/*.{ts,tsx} (.opencode/skills/system-spec-kit/mcp_server)
  └ 93 lines found

● Search (grep)
  │ "autoSurfaceMemories|autoSurfaceAtCompaction|memory-surface|retrieval-directives|trigger-matcher
  │ " in **/*.{ts,tsx} (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found
...
● Search (grep)
  │ "runConsolidationCycleIfEnabled" in **/*.{ts,tsx} (.opencode/skills/system-spec-kit/mcp_server)
  └ 11 lines found
...
● Search (grep)
  ...
  │ _AWARE_TOOLS" in **/*.{ts,tsx} (.opencode/skills/system-spec-kit/mcp_server/tests)
  └ 5 lines found

● Search (grep)
  │ "queryHierarchyMemories|buildHierarchyTree|invalidateHierarchyCache|hierarchy"
  │ (.opencode/skills/system-spec-kit/mcp_server/tests/graph-search-fn.vitest.ts)
  └ 3 lines found
...
● Search (glob)
  │ "**/*memory-surface*.vitest.ts" in .opencode/skills/system-spec-kit/mcp_server/tests
  └ No matches found

● Search (glob)
  │ "**/*reconsolid*.vitest.ts" in .opencode/skills/system-spec-kit/mcp_server/tests
  └ 3 files found

● Search (glob)
  │ "**/*quality-gate*.vitest.ts" in .opencode/skills/system-spec-kit/mcp_server/tests
  └ 4 files found

● Search (glob)
  │ "**/*context-server*.vitest.ts" in .opencode/skills/system-spec-kit/mcp_server/tests
  └ 1 file found

● Search (glob)
  │ "**/*spec-folder-hierarchy*.vitest.ts" in .opencode/skills/system-spec-kit/mcp_server/tests
  └ 1 file found

● Search (glob)
  │ "**/*graph-search-fn*.vitest.ts" in .opencode/skills/system-spec-kit/mcp_server/tests
  └ 1 file found

● Search (glob)
  │ "**/*n3lite-consolidation*.vitest.ts" in .opencode/skills/system-spec-kit/mcp_server/tests
  └ 1 file found

● Search (grep)
  │ "autoSurfaceAtToolDispatch|autoSurfaceAtCompaction|autoSurfaceMemories|extractContextHint|MEMORY
  │ _AWARE_TOOLS" (.opencode/skills/system-spec-kit/mcp_server/tests/context-server.vitest.ts)
  └ 80 lines found
...
● Search (glob)
  │ "**/*response-builder*.vitest.ts" in .opencode/skills/system-spec-kit/mcp_server/tests
  └ No matches found
...
● Edit
  │ Edit .opencode/skills/system-spec-kit/feature_catalog/13--memory-quality-and-indexing/05-pre-stor
  │ age-quality-gate.md
  │ Edit .opencode/skills/system-spec-kit/feature_catalog/13--memory-quality-and-indexing/06-reconsol
  │ idation-on-save.md
  │ Edit .opencode/skills/system-spec-kit/feature_catalog/13--memory-quality-and-indexing/14-quality-
  │ gate-timer-persistence.md
  │ Edit .opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/01-dual-scope-me
  │ mory-auto-surface.md
  │ Edit .opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/03-spec-folder-h
  │ ierarchy-as-retrieval-structure.md
  └ Edit .opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/04-lightweight-c
    onsolidation.md
...
● Check whitespace and review diffs (shell)
  │ git --no-pager diff --check -- '.opencode/skills/system-spec-kit/feature_catalog/13--memory-qua
  │ lity-and-indexing/05-pre-storage-quality-gate.md' '.opencode/skills/system-spec-kit/feature_cat
  │ alog/13--memory-quality-and-indexing/06-reconsolidation-on-save.md' '.opencode/skills/system-sp
  │ ec-kit/feature_catalog/13--memory-quality-and-indexing/14-quality-gate-timer-persistence.md'
  │ '.opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/01-dual-scope-memo…
  └ 17 lines...

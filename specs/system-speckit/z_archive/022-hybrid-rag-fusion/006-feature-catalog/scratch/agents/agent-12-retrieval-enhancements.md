...
● Run skill advisor (shell)
  ...
  │ .opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/ for alignment with
  │ features implemented in .opencode/skills/system-spec-kit/mcp_server and
  │ .opencode/skills/system-spec-kit/scripts" --threshold 0.8
  └ 43 lines...
...
● List directory .opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements
  └ 9 files found

● Search (glob)
  │ ".opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/*.md"
  └ 9 files found
...
● Read 01-dual-scope-memory-auto-surface.md
  │ .opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/01-dual-scope-memory-
  │ auto-surface.md
  └ 101 lines read

● Read 02-constitutional-memory-as-expert-knowledge-injection.md
  │ .opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/02-constitutional-mem
  │ ory-as-expert-knowledge-injection.md
  └ 48 lines read

● Read 03-spec-folder-hierarchy-as-retrieval-structure.md
  │ .opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/03-spec-folder-hierar
  │ chy-as-retrieval-structure.md
  └ 46 lines read

● Read 04-lightweight-consolidation.md
  │ .opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/04-lightweight-consol
  │ idation.md
  └ 64 lines read

● Read 05-memory-summary-search-channel.md
  │ .opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/05-memory-summary-sea
  │ rch-channel.md
  └ 59 lines read
...
● Read 08-provenance-rich-response-envelopes.md
  │ .opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/08-provenance-rich-re
  │ sponse-envelopes.md
  └ 49 lines read

● Read 09-contextual-tree-injection.md
  │ .opencode/skills/system-spec-kit/feature_catalog/15--retrieval-enhancements/09-contextual-tree-in
  │ jection.md
  └ 52 lines read
...
● Search (grep)
  ...
  │ {mcp_server,scripts}/**/*.{ts,tsx,js,json,md} (.opencode/skills/system-spec-kit)
  └ No matches found
...
● Search (grep)
  ...
  │ in {mcp_server,scripts}/**/*.{ts,tsx,js,json,md} (.opencode/skills/system-spec-kit)
  └ No matches found
...
● List directory .opencode/skills/system-spec-kit
  └ 27 files found
...
● Search (grep)
  ...
  │ dispatch|compaction" (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found

● Search (grep)
  │ "retrieval_directive|enrichWithRetrievalDirectives|shouldApplyScopeFiltering|Stage
  │ 1|constitutional" (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found

● Search (grep)
  │ "buildHierarchyTree|queryHierarchyMemories|invalidateHierarchyCache|sibling|grandparent|spec
  │ folder hierarchy" (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found
...
● Search (grep)
  │ "computeTfIdf|extractKeySentences|memory_summaries|querySummaryEmbeddings|SPECKIT_MEMORY_SUMMARI
  │ ES" (.opencode/skills/system-spec-kit/mcp_server)
  └ 93 lines found

● Search (grep)
  │ "buildEntityCatalog|findCrossDocumentMatches|createEntityLinks|runEntityLinking|SPECKIT_ENTITY_L
  │ INKING_MAX_DENSITY|entity_linker|supports" (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found
...
● Search (grep)
  ...
  │ dgetTruncated|scoreResolution" (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found

● Search (grep)
  │ "SPECKIT_CONTEXT_HEADERS|context headers|hierarchical context
  │ headers|tail-description|description map" (.opencode/skills/system-spec-kit/mcp_server)
  └ 7 lines found
...
● Search (grep)
  ...
  │ |memory_summaries|querySummaryEmbeddings" (.opencode/skills/system-spec-kit/scripts)
  └ No matches found
...
● Search (grep)
  ...
  │ SEGMENT_LENGTH" (.opencode/skills/system-spec-kit/mcp_server/lib/search/retrieval-directives.ts)
  └ 15 lines found

● Search (grep)
  │ "shouldApplyScopeFiltering|constitutional|retrieval_directive|enrichWithRetrievalDirectives|inje
  │ ct" (.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage1-candidate-gen.ts)
  └ 30 lines found
...
● Read tfidf-summarizer.ts
  │ .opencode/skills/system-spec-kit/mcp_server/lib/search/tfidf-summarizer.ts
...
● Search (grep)
  ...
  │ channels" (.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts)
  └ 26 lines found

● Search (grep)
  │ "CONTEXT_HEADER_MAX_CHARS|injectContextualTree|SPECKIT_CONTEXT_HEADERS|ensureDescriptionCache|he
  │ ader" (.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts)
  └ 18 lines found
...
● Search (grep)
  │ "includeTrace" (.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts)
  └ 12 lines found

● Search (grep)
  │ "forceAllChannels" (.opencode/skills/system-spec-kit/scripts)
  └ 1 line found
...
● Search (grep)
  ...
  │ ntity_catalog" (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found
...
● Locate entity infrastructure check (shell)
  │ cd '/Users/michelkerkmeester/MEGA/Development/Opencode
  │ Env/Public/.opencode/skills/system-spec-kit' && rg -n
...
● Locate hierarchy usage in graph search (shell)
  │ cd '/Users/michelkerkmeester/MEGA/Development/Opencode
  │ Env/Public/.opencode/skills/system-spec-kit' && rg -n "queryHierarchyMemories\("

...
● Search (glob)
  │ ".opencode/skills/system-spec-kit/feature_catalog/21--implement-and-remove-deprecated-features/*.
  │ md"
  └ 1 file found
...
● Search (glob)
  │ ".opencode/skills/system-spec-kit/feature_catalog/20--remediation-revalidation/*.md"
  └ 1 file found
...
● Read 04-4-memory-and-storage.md
  │ .opencode/skills/system-spec-kit/feature_catalog/19--feature-flag-reference/04-4-memory-and-stora
  │ ge.md
  └ 41 lines read
...
● Read 06-6-debug-and-telemetry.md
  │ .opencode/skills/system-spec-kit/feature_catalog/19--feature-flag-reference/06-6-debug-and-teleme
  │ try.md
  └ 46 lines read

● Read 07-7-ci-and-build-informational.md
  │ .opencode/skills/system-spec-kit/feature_catalog/19--feature-flag-reference/07-7-ci-and-build-inf
  │ ormational.md
  └ 39 lines read
...
● Search (grep)
  │ "^#|^##|^###" (.opencode/skills/system-spec-kit/feature_catalog/19--feature-flag-reference/01-1-s
  │ earch-pipeline-features-speckit.md)
  └ 6 lines found

● Search (grep)
  │ "^\| `|^\| Name " (.opencode/skills/system-spec-kit/feature_catalog/19--feature-flag-reference/01
...
● Search (grep)
  │ "allowed-tools:" (.opencode/commands/memory)
  └ 6 lines found

● Search (grep)
  │ "process\.env\.[A-Z0-9_]+|getEnv[A-Za-z]*\(['\"]([A-Z0-9_]+)['\"]|parse[A-Za-z]*Env\(['\"]([A-Z0
  │ -9_]+)['\"]" in *.{ts,js} (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found

● Search (grep)
  │ "process\.env\.[A-Z0-9_]+|getEnv[A-Za-z]*\(['\"]([A-Z0-9_]+)['\"]|parse[A-Za-z]*Env\(['\"]([A-Z0
  │ -9_]+)['\"]" in *.{ts,js,sh,py} (.opencode/skills/system-spec-kit/scripts)
  └ 5 lines found
...
● Check documented feature flags against mcp_server and scripts (shell)
  ...
  │ fc = root/'.opencode/skills/system-spec-kit/feature_catalog'…
  └ 37 lines...
...
● Check feature flag docs for missing vars or bad source paths (shell)
  ...
  │ root = Path('/Users/michelkerkmeester/MEGA/Development/Opencode Env/Public')
  │ base = root/'.opencode/skills/system-spec-kit'…
  └ 92 lines...
...
● Search (grep)
  │ "comprehensive-remediation-sprint-8" (.opencode/skills/system-spec-kit/feature_catalog)
  └ 1 line found

● Search (grep)
  │ "SPECKIT_CONSUMPTION_LOG" in *.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 16 lines found
...
● Search (grep)
  │ "SPEC_KIT_DB_DIR|SPECKIT_DB_DIR|MEMORY_DB_PATH|MEMORY_DB_DIR|MEMORY_ALLOWED_PATHS|MEMORY_BASE_PA
  │ TH" in *.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 lines found

● Search (grep)
  │ "SPEC_KIT_DB_DIR|SPECKIT_DB_DIR|MEMORY_DB_PATH|MEMORY_DB_DIR|MEMORY_ALLOWED_PATHS|MEMORY_BASE_PA
  │ TH" in *.{ts,sh,py} (.opencode/skills/system-spec-kit/scripts)
  └ 32 lines found
...
● Search (grep)
  │ "graph concept routing|SPECKIT_GRAPH_CONCEPT_ROUTING" (.opencode/skills/system-spec-kit/feature_c
...
● Search (grep)
  ...
  │ Stage 2" in *.ts (.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline)
  └ 5 lines found
...
● Search (grep)
  │ "SPECKIT_PRE_SAVE_DEDUP" in *.{ts,sh,py} (.opencode/skills/system-spec-kit/scripts)
  └ 2 lines found

● Search (grep)
  │ "SPECKIT_PRE_SAVE_DEDUP" in *.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ No matches found
...
● Search (grep)
  │ "github-slugger|slugger" in package.json (.opencode/skills/system-spec-kit)
  └ No matches found

● Search (grep)
  │ "1--overview" in *.md (.opencode/skills/system-spec-kit)
  └ 98 files found
...
● Search (grep)
  │ "ENABLE_BM25" in *.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 14 lines found
...
● Search (grep)
  ...
  │ \(Sprint 8\)" (.opencode/skills/system-spec-kit/feature_catalog/FEATURE_CATALOG.md)
  └ 4 lines found

● Search (grep)
  │ "SPECKIT_CONSUMPTION_LOG" (.opencode/skills/system-spec-kit/feature_catalog/FEATURE_CATALOG.md)
  └ 4 lines found

● Search (grep)
  │ "SPECKIT_CONSUMPTION_LOG" (.opencode/skills/system-spec-kit/feature_catalog/19--feature-flag-refe
...
● Search (grep)
  │ "SPECKIT_HYDE_ACTIVE" in *.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 9 lines found

● Search (grep)
  │ "SPECKIT_TEMPORAL_CONTIGUITY" in *.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 2 lines found
...
● Search (grep)
  │ "SPECKIT_HYDE_ACTIVE" (.opencode/skills/system-spec-kit/feature_catalog/FEATURE_CATALOG.md)
  └ 2 lines found

● Search (grep)
  │ "SPECKIT_HYDE_ACTIVE|SPECKIT_TEMPORAL_CONTIGUITY" (.opencode/skills/system-spec-kit/feature_catal
  │ og/19--feature-flag-reference/01-1-search-pipeline-features-speckit.md)
  └ 1 line found

● Search (grep)
  │ "SPECKIT_TEMPORAL_CONTIGUITY" (.opencode/skills/system-spec-kit/feature_catalog)
  └ 1 line found
...
`FEATURE_CATALOG.md` | `PARTIAL` | Verified 21 top-level sections (`:12-34`) and 33 tools across 6 commands (`:50-62`, confirmed from `.opencode/commands/memory/*.md:4`). But section 21 repeats drifted rows for `MCP_MAX_MEMORY_TOKENS` (`:4538`), `EMBEDDING_DIM` (`:4588`), and `RERANKER_LOCAL` (`:4591`), and has a broken internal link `#comprehensive-remediation-sprint-8` at `:3925`.

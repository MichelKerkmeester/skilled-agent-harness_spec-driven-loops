...
● Run skill advisor (shell)
  │ python3 .opencode/skills/scripts/skill_advisor.py "Deep research iteration 19/20 on
...
● Search (grep)
  │ "executePipeline\(" in **/*.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 2 lines found

● Search (grep)
  │ "rerankResults\(" in **/*.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 21 lines found
...
● Search (grep)
  │ "stage2Score" in **/*.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 3 lines found

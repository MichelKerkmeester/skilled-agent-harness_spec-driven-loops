...
[^router-5]: `.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:21-24,38-45,57-60`
[^router-defaults]: `.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:52-60,95-101,119-141`
[^search-readme-5]: `.opencode/skills/system-spec-kit/mcp_server/lib/search/README.md:41-42,87-97,100-113`
[^hybrid-5]: `.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:558-566,605-709`
[^graph-init]: `.opencode/skills/system-spec-kit/mcp_server/context-server.ts:890-899`
[^graph-reinit]: `.opencode/skills/system-spec-kit/mcp_server/core/db-state.ts:41-45,57-65,88-92,106-110,182-187`
[^hybrid-degree]: `.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:668-705`
[^intent-weights]: `.opencode/skills/system-spec-kit/mcp_server/lib/search/intent-classifier.ts:16-21,189-197`
[^memory-search-intent]: `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:847-867`
[^memory-search-pipeline]: `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:931-968`
[^to-intent-config]: `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:109-117`
[^stage2-hybrid]: `.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:578-580`
[^stage2-guard]: `.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline/stage2-fusion.ts:713-730`
[^memory-search-searchtype]: `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-search.ts:934-936`
[^hybrid-adaptive]: `.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:732-745`
[^hybrid-mmr]: `.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:907-909`
[^classifier-purpose]: `.opencode/skills/system-spec-kit/mcp_server/lib/search/query-classifier.ts:8-19,127-146,165-196`
[^router-calls-classifier]: `.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:7-12,119-141`
[^router-purpose]: `.opencode/skills/system-spec-kit/mcp_server/lib/search/query-router.ts:24-35,41-45,67-102,108-141`
[^hybrid-route]: `.opencode/skills/system-spec-kit/mcp_server/lib/search/hybrid-search.ts:558-566`
[^cap-phases]: `.opencode/skills/system-spec-kit/mcp_server/lib/config/capability-flags.ts:10-13,56-57,86-98`
[^cap-six]: `.opencode/skills/system-spec-kit/mcp_server/lib/config/capability-flags.ts:15-23,38-54,101-127`
[^cap-telemetry]: `.opencode/skills/system-spec-kit/mcp_server/lib/telemetry/retrieval-telemetry.ts:177-211`
[^cap-baseline]: `.opencode/skills/system-spec-kit/mcp_server/lib/eval/memory-state-baseline.ts:176-199`
[^cap-checkpoint]: `.opencode/skills/system-spec-kit/mcp_server/scripts/migrations/create-checkpoint.ts:184-201`
[^rollout-core]: `.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/rollout-policy.ts:5-57`
[^rollout-memory-context]: `.opencode/skills/system-spec-kit/mcp_server/handlers/memory-context.ts:629-645`
[^rollout-extraction]: `.opencode/skills/system-spec-kit/mcp_server/lib/extraction/extraction-adapter.ts:71-73`
[^rollout-event-decay]: `.opencode/skills/system-spec-kit/mcp_server/lib/cognitive/working-memory.ts:557-563`
[^rollout-searchflags]: `.opencode/skills/system-spec-kit/mcp_server/lib/search/search-flags.ts:23-53`
[^rollout-graphflags]: `.opencode/skills/system-spec-kit/mcp_server/lib/search/graph-flags.ts:13-18`

...
● Run skill advisor (shell)
  │ python3 .opencode/skills/scripts/skill_advisor.py "Analyze indexing/normalization test suite
  │ coverage gaps in .opencode/skills/system-spec-kit, compare tests for input-normalizer,
...
● Search (grep)
  │ "^(\s*)(it|test)\(" in *.vitest.ts (.opencode/skills/system-spec-kit/mcp_server/tests)
  └ 5 files found
...
● Read importance-tiers.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/importance-tiers.vitest.ts
  └ 207 lines read
...
● Read integration-save-pipeline.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/integration-save-pipeline.vitest.ts
  └ L1:260 (111 lines read)

● Read memory-parser.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/memory-parser.vitest.ts
  └ L1:520 (440 lines read)

● Read handler-memory-index-cooldown.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/handler-memory-index-cooldown.vitest.ts
  └ 311 lines read

● Read full-spec-doc-indexing.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/full-spec-doc-indexing.vitest.ts
...
● Count test cases per mcp test file (shell)
  ...
  │ Env/Public/.opencode/skills/system-spec-kit/mcp_server/tests')…
  └ 296 lines...
...
● Run targeted script tests (shell)
  ...
  │ Env/Public/.opencode/skills/system-spec-kit/scripts' && npx vitest run
...
● Search (grep)
  ...
  │ s|indexingStatus" in *.vitest.ts (.opencode/skills/system-spec-kit/scripts/tests)
  └ 12 lines found
...
● Search (grep)
  ...
  │ ualityScore" in *.vitest.ts (.opencode/skills/system-spec-kit/scripts/tests)
  └ 13 lines found
...
● Search (grep)
  ...
  │ umentType" (.opencode/skills/system-spec-kit/mcp_server/tests/scoring-gaps.vitest.ts)
  └ No matches found
...
● Search (grep)
  ...
  │ s|notifyDatabaseUpdated" in *.vitest.ts (.opencode/skills/system-spec-kit/scripts/tests)
  └ 9 lines found

● Search (grep)
  │ "getConstitutionalFilter|getSearchableTiersFilter|shouldAlwaysSurface|getMaxTokens|getExpiredTem
  │ poraryFilter" in *.vitest.ts (.opencode/skills/system-spec-kit/mcp_server/tests)
  └ 1 file found
...
● Search (grep)
  ...
  │ ers\(" in *.vitest.ts (.opencode/skills/system-spec-kit/mcp_server/tests)
  └ 15 lines found
...
● Run scripts tests via package script (shell)
  │ cd '/Users/michelkerkmeester/MEGA/Development/Opencode
  │ Env/Public/.opencode/skills/system-spec-kit/scripts' && npm test --
  │ tests/runtime-memory-inputs.vitest.ts tests/memory-indexer-weighting.vitest.ts
  └ 45 lines...

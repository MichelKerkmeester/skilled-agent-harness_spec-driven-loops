...
● Search (grep)
  │ "SPECKIT_|process\.env|dotenv|config" (.opencode/skills/system-spec-kit)
  └ 5 files found

● Search (glob)
  │ ".opencode/skills/system-spec-kit/**/*.{json,jsonc,env,example,ts}"
  └ 5 files found
...
● Explore Survey config surface
  ...
  └ Read configs directory README (shell)
      ...
      │ Env/Public/.opencode/skills/system-spec-kit/mcp_server/configs/README.md"
      └ 85 lines...
...
● List directory .opencode/skills/system-spec-kit/config
  └ 3 files found

● List directory .opencode/skills/system-spec-kit/mcp_server/lib/config
  └ 4 files found
...
● Read type-inference.ts
  │ .opencode/skills/system-spec-kit/mcp_server/lib/config/type-inference.ts
  └ 338 lines read

● Read memory-types.ts
  │ .opencode/skills/system-spec-kit/mcp_server/lib/config/memory-types.ts
  └ 429 lines read
...
● Search (glob)
  │ ".opencode/skills/system-spec-kit/**/*.json*"
  └ 46 files found

● Search (glob)
  │ ".opencode/skills/system-spec-kit/**/.env*"
  └ 1 file found
...
● Search (glob)
  │ ".opencode/skills/system-spec-kit/**/environment_variables.md"
  └ 1 file found
...
● Read content-filter.ts
  │ .opencode/skills/system-spec-kit/scripts/lib/content-filter.ts
  └ 1 line read
...
● Read .gitignore
  │ .opencode/skills/system-spec-kit/.gitignore
  └ 8 lines read
...
● Search (grep)
  │ "\.env" (.opencode/skills/system-spec-kit/.gitignore)
  └ No matches found
...
● Search (grep)
  ...
  │ _MODEL" (.opencode/skills/system-spec-kit/mcp_server/README.md)
  └ 8 lines found

● Search (grep)
  │ "EMBEDDING_PROVIDER|EMBEDDINGS_PROVIDER|EMBEDDINGS_BATCH_SIZE|EMBEDDINGS_CONCURRENCY|EMBEDDINGS_
  │ MODEL|HF_EMBEDDINGS_MODEL|SPECKIT_BATCH_SIZE" (.opencode/skills/system-spec-kit/.env.example)
  └ 4 lines found
...
● Search (grep)
  ...
  │ MEOUT_MS|SPECKIT_RERANKER_TIMEOUT_MS" in *.ts (.opencode/skills/system-spec-kit/shared)
  └ 14 lines found

● Search (grep)
  │ "EMBEDDINGS_BATCH_SIZE|EMBEDDINGS_CONCURRENCY|EMBEDDINGS_DEVICE|EMBEDDINGS_MODEL|HF_EMBEDDINGS_M
  │ ODEL|OPENAI_EMBEDDINGS_MODEL|VOYAGE_EMBEDDINGS_MODEL|OPENAI_BASE_URL|VOYAGE_BASE_URL|RERANKER_TI
  │ MEOUT_MS|SPECKIT_RERANKER_TIMEOUT_MS" in *.ts (.opencode/skills/system-spec-kit/mcp_server)
  └ 10 lines found
...
● Read vector-index-aliases.ts
  │ .opencode/skills/system-spec-kit/mcp_server/lib/search/vector-index-aliases.ts
...
● Search (grep)
  │ "SPEC_KIT_BATCH_SIZE|SPEC_KIT_BATCH_DELAY_MS" in *.{ts,md,env} (.opencode/skills/system-spec-kit)
  └ 10 lines found
...
● Search (grep)
  │ "EMBEDDINGS_MODEL\b" in *.{ts,md,env} (.opencode/skills/system-spec-kit)
  └ 27 lines found

● Search (grep)
  │ "\bEMBEDDINGS_MODEL\b" in *.{ts,md,env} (.opencode/skills/system-spec-kit)
  └ No matches found
...
● Search (grep)
  │ "SPECKIT_DB_DIR" in *.{ts,md,env} (.opencode/skills/system-spec-kit)
  └ 10 lines found

● Search (grep)
  │ "SPEC_KIT_DB_DIR" in *.{ts,md,env} (.opencode/skills/system-spec-kit)
  └ 67 lines found

● Search (grep)
  │ "MEMORY_DB_DIR" in *.{ts,md,env} (.opencode/skills/system-spec-kit)
  └ 10 lines found
...
● Search (grep)
  │ "timezoneOffsetHours" in *.{ts,jsonc,md} (.opencode/skills/system-spec-kit)
  └ 11 lines found
...
● Search (grep)
  ...
  │ will occur on first use" (.opencode/skills/system-spec-kit/mcp_server/context-server.ts)
  └ 8 lines found

● Search (grep)
  │ "SPECKIT_COGNITIVE_COACTIVATION_PATTERN|SPECKIT_COGNITIVE_COACTIVATION_FLAGS|safeParseCognitiveC
  │ onfigFromEnv|loadCognitiveConfigFromEnv" in *.{ts,md,env} (.opencode/skills/system-spec-kit)
  └ 42 lines found
...
● Search (grep)
  │ "dotenv" in *.{ts,js,md,sh} (.opencode/skills/system-spec-kit)
  └ No matches found

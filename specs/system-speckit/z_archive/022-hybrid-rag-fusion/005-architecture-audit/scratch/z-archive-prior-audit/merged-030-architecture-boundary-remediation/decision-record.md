...
_memory:
  continuity:
    packet_pointer: "system-speckit/z_archive/022-hybrid-rag-fusion/005-architecture-audit/scratch/z-archive-prior-audit/merged-030-architecture-boundary-remediation"
...
See 010-architecture-audit/decision-record.md ADR-004 for the original analysis. Both ADRs accept the same P2 AST-upgrade timeline.

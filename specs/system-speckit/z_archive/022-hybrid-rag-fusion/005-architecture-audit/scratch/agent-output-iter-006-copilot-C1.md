...
● Search (grep)
  ...
  │ in **/*.{ts,tsx,js} (.opencode/skills/system-spec-kit/mcp_server/tests)
  └ 40 files found
...
● Search (grep)
  ...
  │ rarchy|confidence-truncation|context-budget|dynamic-token-budget|auto-promotion|channel-enforcem
  │ ent|channel-representation|feedback-denylist|learned-feedback|search-flags|retrieval-directives"
  │ in **/*.{ts,tsx} (.opencode/skills/system-spec-kit/mcp_server/lib)
  └ 58 lines found
...
● Count target file lines (shell)
  ...
  │ Env/Public/.opencode/skills/system-spec-kit/mcp_server/lib/search' && wc -l causal-boost.ts
...
● Read session-transition.ts
  │ .opencode/skills/system-spec-kit/mcp_server/lib/search/session-transition.ts
  └ 190 lines read
...
● Read retrieval-directives.ts
  │ .opencode/skills/system-spec-kit/mcp_server/lib/search/retrieval-directives.ts
  └ 351 lines read
...
● Search (grep)
  ...
  │ **/*.{ts,tsx} (.opencode/skills/system-spec-kit/mcp_server/tests)
  └ 5 lines found
...
● Read session-boost.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/session-boost.vitest.ts
  └ 95 lines read

● Read channel-enforcement.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/channel-enforcement.vitest.ts
  └ 525 lines read

● Read confidence-truncation.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/confidence-truncation.vitest.ts
  └ 464 lines read

● Read dynamic-token-budget.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/dynamic-token-budget.vitest.ts
  └ 215 lines read

● Read channel-representation.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/channel-representation.vitest.ts
  └ 407 lines read
...
● Read retrieval-directives.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/retrieval-directives.vitest.ts
  └ 563 lines read

● Read learned-feedback.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/learned-feedback.vitest.ts
  └ L260:560 (301 lines read)

● Read feedback-denylist.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/feedback-denylist.vitest.ts
  └ 89 lines read

● Read memory-context.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/memory-context.vitest.ts
...
● Read promotion-positive-validation-semantics.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/promotion-positive-validation-semantics.vitest.
  │ ts
  └ 127 lines read
...
● Read folder-relevance.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/folder-relevance.vitest.ts
  └ L300:520 (200 lines read)

● Read folder-discovery-integration.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/folder-discovery-integration.vitest.ts
  └ L430:620 (191 lines read)

● Read query-router-channel-interaction.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/query-router-channel-interaction.vitest.ts
  └ 433 lines read

● Read spec-folder-hierarchy.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/spec-folder-hierarchy.vitest.ts
...
● Search (grep)
  ...
  │ **/*.{ts,tsx} (.opencode/skills/system-spec-kit/mcp_server/lib/search/pipeline)
  └ 7 lines found
...
● Search (grep)
  ...
  │ CKIT_FILE_WATCHER" in **/*.{ts,tsx} (.opencode/skills/system-spec-kit/mcp_server/tests)
  └ 5 lines found

● Search (grep)
  │ "SPECKIT_FOLDER_DISCOVERY|SPECKIT_PIPELINE_V2|SPECKIT_QUALITY_LOOP|SPECKIT_SAVE_QUALITY_GATE|SPE
  │ CKIT_FILE_WATCHER" in **/*.{ts,tsx} (.opencode/skills/system-spec-kit/mcp_server/lib)
  └ 16 lines found

● Search (grep)
  │ "enrichWithRetrievalDirectives|extractRetrievalDirective|formatDirectiveMetadata" in
  │ **/*.{ts,tsx} (.opencode/skills/system-spec-kit/mcp_server/lib)
  └ 8 lines found
...
● Read stage2-fusion.vitest.ts
  └ .opencode/skills/system-spec-kit/mcp_server/tests/stage2-fusion.vitest.ts
...
● Search (grep)
  ...
  │ d\(|isFileWatcherEnabled\(" in **/*.{ts,tsx} (.opencode/skills/system-spec-kit/mcp_server/lib)
  └ 5 lines found
...
● Search (grep)
  │ "isQualityLoopEnabled\(" in **/*.{ts,tsx} (.opencode/skills/system-spec-kit/mcp_server)
  └ 3 files found

● Search (grep)
  │ "isPipelineV2Enabled\(" in **/*.{ts,tsx} (.opencode/skills/system-spec-kit/mcp_server)
  └ 2 files found

● Search (grep)
  │ "optimizeContextBudget\(" in **/*.{ts,tsx} (.opencode/skills/system-spec-kit/mcp_server)
  └ 1 file found

● Search (grep)
  │ "isFolderDiscoveryEnabled\(" in **/*.{ts,tsx} (.opencode/skills/system-spec-kit/mcp_server)
  └ 3 files found
...
● Search (grep)
  │ "readSessionTransitionTrace\(" in **/*.{ts,tsx} (.opencode/skills/system-spec-kit/mcp_server)
  └ 2 lines found

● Read hybrid-search-context-headers.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/hybrid-search-context-headers.vitest.ts
...
● Read token-budget.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/token-budget.vitest.ts

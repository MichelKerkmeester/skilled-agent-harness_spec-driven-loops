...
- **Description**: Two folders share the 017 prefix: `018-rewrite-system-spec-kit-readme` and `017-spec-folder-alignment-audit`. This violates the phase numbering convention.

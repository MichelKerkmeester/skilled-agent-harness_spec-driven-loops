...
● Read research/research.md
  │ .opencode/specs/system-spec-kit/022-hybrid-rag-fusion/005-architecture-audit/research/research/research.md
  └ 944 lines read

● Read decision-record.md
  │ .opencode/specs/system-spec-kit/022-hybrid-rag-fusion/005-architecture-audit/decision-record
  │ .md
  └ 565 lines read
...
✗ Read ranking-contract.ts
  │ .opencode/skills/system-spec-kit/mcp_server/lib/search/ranking-contract.ts
  └ Path does not exist

✗ Read tool-input-schemas.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tool-input-schemas.ts
  └ Path does not exist
...
● Search (grep)
  │ "ranking-contract" (.opencode/skills/system-spec-kit/mcp_server)
  └ 5 files found

● Search (glob)
  │ "**/125-hydra-roadmap-capability-flags.md" in .opencode/skills/system-spec-kit
  └ 1 file found
...
● Read score-resolution-consistency.vitest.ts
  │ .opencode/skills/system-spec-kit/mcp_server/tests/score-resolution-consistency.vitest.ts

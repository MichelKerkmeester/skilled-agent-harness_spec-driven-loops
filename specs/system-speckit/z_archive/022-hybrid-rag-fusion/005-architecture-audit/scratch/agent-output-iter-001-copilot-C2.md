...
● Search (grep)
  ...
  │ in *.ts (.opencode/skills/system-spec-kit/scripts/extractors)
  └ 64 lines found
...
● Read quality_standards.md
  │ .opencode/skills/sk-code-opencode/references/typescript/quality_standards.md
  └ 1 line read
...
● Read quick_reference.md
  │ .opencode/skills/sk-code-opencode/references/typescript/quick_reference.md
  └ 539 lines read

● Search (grep)
  │ "^export\s|^interface\s|^type\s|^async function|^function\s" in *.ts
  │ (.opencode/skills/system-spec-kit/scripts/extractors)
  └ 5 lines found

● Count extractor file lines (shell)
  │ cd '/Users/michelkerkmeester/MEGA/Development/Opencode
  │ Env/Public/.opencode/skills/system-spec-kit/scripts/extractors' && wc -l *.ts
  └ 20 lines...
...
● Search (grep)
  │ "\bany\b" in *.ts (.opencode/skills/system-spec-kit/scripts/extractors)
  └ 2 lines found
...
● Read diagram-extractor.ts
  │ .opencode/skills/system-spec-kit/scripts/extractors/diagram-extractor.ts
...
● Read session-activity-signal.ts
  │ .opencode/skills/system-spec-kit/scripts/extractors/session-activity-signal.ts
  └ L1:260 (260 lines read)
...
● Read implementation-guide-extractor.ts
  │ .opencode/skills/system-spec-kit/scripts/extractors/implementation-guide-extractor.ts
  └ L1:260 (260 lines read)
...
● Read git-context-extractor.ts
  │ .opencode/skills/system-spec-kit/scripts/extractors/git-context-extractor.ts
  └ L1:260 (259 lines read)
...
● Search (grep)
  │ "catch\s*\(([^)]*)\)|catch\s*\{" in *.ts (.opencode/skills/system-spec-kit/scripts/extractors)
  └ 37 lines found
...
● Run scripts lint and checks (shell)
  │ cd '/Users/michelkerkmeester/MEGA/Development/Opencode
  │ Env/Public/.opencode/skills/system-spec-kit/scripts' && npm run -s lint && npm run -s check
  └ 12 lines...
...
Verification note: `npm run -s lint`, `npm run -s check`, and `npm run -s build` all passed in `.opencode/skills/system-spec-kit/scripts`, so these are mostly **standards and consistency gaps that current tooling does not enforce**.

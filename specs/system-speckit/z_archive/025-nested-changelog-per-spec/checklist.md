---
title: "Verification Checklist: Nested Changelog Per Spec [system-spec-kit/025-nested-changelog-per-spec/checklist]"
...
_memory:
  continuity:
    packet_pointer: "system-speckit/z_archive/025-nested-changelog-per-spec"

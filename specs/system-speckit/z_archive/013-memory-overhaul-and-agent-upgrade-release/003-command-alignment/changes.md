...
### 1. `.opencode/commands/memory/context.md`
**Priority**: P0
**Changes**:
...
### 4. `.opencode/commands/memory/save.md`
**Priority**: P0
**Changes**:
...
**Verification**: Manual accuracy check against `.opencode/skills/system-spec-kit/mcp_server/tool-schemas.ts` for memory_context, memory_save, and memory_index_scan parameters

---

## Agent A14: Spec Kit Command Files Batch 1 (3 files)

### 5. `.opencode/commands/spec_kit/complete.md`
**Priority**: P0
**Changes**:
...
### 8. `.opencode/commands/spec_kit/handover.md`
**Priority**: P0
**Changes**:

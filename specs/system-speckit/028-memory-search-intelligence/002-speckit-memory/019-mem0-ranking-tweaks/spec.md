...
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../018-drift-marker-pipeline-resilience/spec.md |
| **Successor** | ../020-self-healing-internals-hardening/spec.md |
<!-- /ANCHOR:metadata -->

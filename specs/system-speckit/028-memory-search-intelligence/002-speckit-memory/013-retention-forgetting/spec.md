...
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../012-query-channel-calibration/spec.md |
| **Successor** | ../014-automatic-drift-self-healing/spec.md |
<!-- /ANCHOR:metadata -->
...
> Confirmed against the Wave-0 record + `git log 2e17fdbe32..HEAD`: NONE of these 8 candidates appeared in the Wave-0 shipped record (candidates 1-13 there are Q6-anchor / C9 / ANN-tiebreak / C5-B / C-X1+C6-A / two-primitive-id / gauges / skip-closed / CAS-guard / Deep-Loop-trio / Q4-C1, plus deferred C4-A and M-system-kind-exclusion). Current implementation status is tracked below.

---
title: "Iteration 17 (Round Q): PQ5-speckit-fingerprint-absence"
trigger_phrases: []
---
# Iteration 17 (Round Q): PQ5-speckit-fingerprint-absence
...
## Focus
`PQ5-speckit-fingerprint-absence` — round Q, read-only claude2 Opus seat. (newInfoRatio 0.55, findingsCount 1, status insight, ~360s)

## Findings
- **R028-fingerprint-absence-finding** — surfaced (`upsert_candidate`): Fingerprint-absence -> WARN: the freshness gate skip-PASSes on an absent/zero fingerprint. Promote to WARN. ~667 impl-summaries lack one; the whole check is default-OFF, so gate the flip behind a backfill.

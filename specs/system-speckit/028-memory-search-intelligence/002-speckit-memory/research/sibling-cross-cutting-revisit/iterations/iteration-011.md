---
title: "Iteration 11 (Round P): PD3-provenance-signing"
trigger_phrases: []
---
# Iteration 11 (Round P): PD3-provenance-signing
...
## Focus
`PD3-provenance-signing` — round P, read-only claude2 Opus seat. (newInfoRatio 0.6, findingsCount 1, status insight, ~300s)

## Findings
- **PD3** — surfaced (`upsert_finding`): Provenance-signing: 027 server-derives provenance; signing needs a distrusted key-holding writer the single-tenant store lacks.

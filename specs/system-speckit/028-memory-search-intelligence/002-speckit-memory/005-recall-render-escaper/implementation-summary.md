...
|-----------|--------|----------|
| **Constitutional-CAS-guard** | **DONE** | Commit `672d8a9187` (030 §14 #10). `E_CONSTITUTIONAL_SELF_EDIT` (unconditional) + `E_STALE_CONSTITUTIONAL_UPDATE` (opt-in `expectedHash` CAS) remain intact, focused CAS tests pass. |

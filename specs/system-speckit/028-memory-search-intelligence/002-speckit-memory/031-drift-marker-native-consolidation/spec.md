...
_memory:
  continuity:
    packet_pointer: "system-speckit/028-memory-search-intelligence/002-speckit-memory/031-drift-marker-native-consolidation"
...
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../030-kept-off-flag-resolution/spec.md |
| **Successor** | ../032-new-feature-research-build/spec.md |
<!-- /ANCHOR:metadata -->

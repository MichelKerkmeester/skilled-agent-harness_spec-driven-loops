...
- Missing dependencies: Code graph remained stale/untrusted; direct `Read`/`Grep` evidence was used. [SOURCE: .opencode/specs/system-speckit/028-memory-search-intelligence/research/deep-research-strategy.md:122]

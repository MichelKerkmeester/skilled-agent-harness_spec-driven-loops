...
|---|---|---|
| [`001-code-readmes`](./changelog-000-001-code-readmes.md) | Complete | Aligned 12 per-directory code READMEs to shipped state, edits only, every corrected path verified (commit 1455cf6062). |
| [`002-skill-and-repo-readmes`](./changelog-000-002-skill-and-repo-readmes.md) | Complete | Aligned the skill READMEs and root README to shipped state with house structure preserved (commit ed06dcdc21). |
| [`003-skill-references-assets-and-skillmd`](./changelog-000-003-skill-references-assets-and-skillmd.md) | Complete, subset deferred | Aligned 14 SKILL.md, reference and asset docs. The deep-research and deep-loop-workflows skill docs stay with the concurrent session (commit 2229a24c7e). |
| [`004-feature-catalogs`](./changelog-000-004-feature-catalogs.md) | Complete | Fixed source-reference drift across 12 system-spec-kit feature_catalog files, no entry added or removed (commit 7b74ddfbe5). |
| [`005-manual-testing-playbooks`](./changelog-000-005-manual-testing-playbooks.md) | Complete | Rechecked the packet-028 manual testing playbook package and fixed 14 stale anchors across 10 files (commit 7b74ddfbe5). |
| [`006-commands`](./changelog-000-006-commands.md) | Complete, subset deferred | Reviewed 19 command docs and fixed a fable-mode route reference in doctor/speckit.md. The deep-research router and agent_router.md stay with the concurrent session (commit 7239e3d2bd). |
| [`007-agents`](./changelog-000-007-agents.md) | Complete | Rewrote three agent mirror READMEs and localized two Claude path-convention lines after verifying all agent bodies (commit 9351779874). |
| [`008-agents-md`](./changelog-000-008-agents-md.md) | Complete | Corrected the root AGENTS.md mk-spec-memory tool count from 37 to 39 and verified both runtime mirrors (commit 49235a9b66). |
| [`009-changelogs-constitutional-and-templates`](./changelog-000-009-changelogs-constitutional-and-templates.md) | Complete | Fixed four factual drifts across constitutional docs and templates, changelog entries left historical (commit d9b95ef9a6). |

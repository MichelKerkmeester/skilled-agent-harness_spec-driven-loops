...
> Spec folder: `.opencode/specs/system-speckit/028-memory-search-intelligence/003-spec-data-quality/008-validation-integrity-hardening` (Level recorded in phase evidence)

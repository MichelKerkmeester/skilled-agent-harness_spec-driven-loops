...
| **Shipped record** | Wave-0 record (commits `61fe63b24d..5ed284319b`) |
<!-- /ANCHOR:metadata -->
...
- **Constitutional-CAS-guard**, DONE (`672d8a9187`). Recorded here for spine completeness.
...
- **Shipped record (Wave-0, historical evidence):** Wave-0 record, commits `61fe63b24d..5ed284319b`.

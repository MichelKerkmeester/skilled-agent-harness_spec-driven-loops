...
- [ ] T005 Fix C4 shadow-weight promoter "never committed" claim (`system-skill-advisor/002-skill-advisor-runtime/004-c4-shadow-seam-beta-posterior/{decision-record.md,implementation-summary.md,plan.md}`) - built `7cd16f70fa`, deleted `6b99eb68d2`
- [ ] T006 Fix outcome-weighted ranking pass-1 error + dangling link (`system-skill-advisor/002-skill-advisor-runtime/007-outcome-weighted-ranking-followon/{implementation-summary.md,plan.md,spec.md,decision-record.md,checklist.md}`) - built `3682ec59da`/`f3a1231c66`, deleted `6b99eb68d2`, MRR delta vs noise numbers

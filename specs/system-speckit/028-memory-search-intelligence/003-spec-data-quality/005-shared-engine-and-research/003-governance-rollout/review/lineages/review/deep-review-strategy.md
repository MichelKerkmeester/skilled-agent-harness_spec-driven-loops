---
title: "Deep Review Strategy: 028-governance-rollout"
trigger_phrases: []
---
...
- Parent research source: `.opencode/specs/system-speckit/028-memory-search-intelligence/002-spec-data-quality/research/research.md` (one directory ABOVE the phase folder; the phase docs cite it as `research/research.md` which does not resolve relative to the phase folder).

...
Mode: review
Dimension: TARGET 2 ONLY — REQ-BY-REQ AUDIT. Read .opencode/specs/system-speckit/028-memory-search-intelligence/002-spec-data-quality/047-generated-metadata-status-integrity/spec.md and extract REQ-001 through REQ-005 verbatim. Then read the actual shipped diff via 'git show 4f1f64c20a' (and 'git show c02b2a2f39' for the closure-doc diff) against mcp_server/lib/graph/graph-metadata-parser.ts (deriveStatus) and mcp_server/lib/validation/generated-metadata-integrity.ts (STATUS_COMPLETE_EVIDENCE_MISMATCH). For EACH requirement REQ-001..REQ-005, state explicitly: does the shipped code satisfy it, partially satisfy it, or fail it, with file:line citations from the actual current file content (not just the diff). Flag any requirement the diff does not fully address.
...
- Write iteration narrative to: .opencode/specs/system-speckit/028-memory-search-intelligence/002-spec-data-quality/047-generated-metadata-status-integrity/review/iterations/iteration-005.md
- Write per-iteration delta file to: .opencode/specs/system-speckit/028-memory-search-intelligence/002-spec-data-quality/047-generated-metadata-status-integrity/review/deltas/iter-005.jsonl
...
- **ALLOWED WRITE PATHS (the ONLY paths you may create, modify, or append to)**:
  - `.opencode/specs/system-speckit/028-memory-search-intelligence/002-spec-data-quality/047-generated-metadata-status-integrity/review/iterations/iteration-005.md`, this iteration's narrative markdown
  ...
  - `.opencode/specs/system-speckit/028-memory-search-intelligence/002-spec-data-quality/047-generated-metadata-status-integrity/review/deltas/iter-005.jsonl`, this iteration's delta JSONL
...
1. **Iteration narrative markdown** at `.opencode/specs/system-speckit/028-memory-search-intelligence/002-spec-data-quality/047-generated-metadata-status-integrity/review/iterations/iteration-005.md` (path pre-substituted for the current iteration number). Structure: headings for Dimension, Files Reviewed, Findings by Severity (P0/P1/P2), Traceability Checks, Verdict, Next Dimension.

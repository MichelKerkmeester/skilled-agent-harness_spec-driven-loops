...
A1 H1 scores both metadata JSONs with the shipped `computeMemoryQualityScore` and REQ-005 plus REQ-002 forbid any second or alternative scorer (`001-extend-quality-loop-authored/spec.md:108-117`). That scorer is memory-calibrated.

---
title: "Implementation Plan: Changelogs Constitutional And Templates Cleanup"
description: "Defines the pending cleanup approach for changelog, constitutional doc and template sweep."
trigger_phrases:
  - "028 release cleanup changelogs plan"
  - "changelogs-constitutional-and-templates cleanup plan"
importance_tier: "important"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "system-speckit/028-memory-search-intelligence/001-release-cleanup/009-changelogs-constitutional-and-templates"
    ...
    session_dedup:
      ...
      session_id: "2026-06-19-plan-009-changelogs-constitutional-and-templates"
...
# Implementation Plan: Changelogs Constitutional And Templates Cleanup
...
|---------|--------------|--------|--------------|
| Changelog, constitutional doc and template sweep | Release documentation surface | Review later | Discovery output and grep evidence |
...
### Phase 1: Setup
- [x] Run discovery: `rg --files .opencode | rg '(/changelog/.+\.md$|/constitutional/.+\.md$|/system-spec-kit/templates/.+\.md$|/system-spec-kit/templates/.+\.tmpl$)'`
...
- [x] Run stale-reference scan: `rg -n 'missing changelog|deprecated rule|stale template|placeholder|validator mismatch|removed path' <discovered-docs>`
...
|-------|------------|--------|
| 009 | `../spec.md` | Parent phase map owns release-cleanup ordering |
<!-- /ANCHOR:phase-deps -->

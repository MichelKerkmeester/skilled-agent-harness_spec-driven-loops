...
_memory:
  continuity:
    packet_pointer: "system-speckit/028-memory-search-intelligence/005-dark-flag-graduation/005-flag-name-cleanup"
...
| **Parent Spec** | ../spec.md |
| **Predecessor** | ../004-save-reconsolidation/spec.md |
| **Successor** | ../006-dark-flag-validation/spec.md |
<!-- /ANCHOR:metadata -->

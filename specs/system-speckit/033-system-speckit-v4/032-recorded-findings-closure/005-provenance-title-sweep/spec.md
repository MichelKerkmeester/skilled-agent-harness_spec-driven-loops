...
**Dependencies**:
- `030-spec-kit-simplification-research/018-scaffold-placeholder-and-upgrade-truth`, which stopped the scaffolder from writing new provenance-carrying titles and reverted a first attempt at this same rule class
- `030-spec-kit-simplification-research/004-template-system-and-acceptance-criteria/research/lineages/deepseek-v4-flash-templates-r3/findings-registry.json` (`f-iter003-004`), the finding this phase closes

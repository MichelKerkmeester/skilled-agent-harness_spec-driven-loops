...
| **Phase** | 1 of 6 |
| **Predecessor** | None |
| **Successor** | 002-active-decisions-design |
...
This is **Phase 1** of the Deprecate constitutional memory; build a separate actively-used decisions and notes system integrated with spec and skill specification.

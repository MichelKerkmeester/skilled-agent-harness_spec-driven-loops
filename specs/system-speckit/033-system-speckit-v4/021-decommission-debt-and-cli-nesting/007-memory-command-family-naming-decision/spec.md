...
trigger_phrases:
  ...
  - "rename hard cutover decision"
  - "command frontmatter family key"
  - "87 file blast radius"
...
| Dependency | Packet 052's D7 decision record (`specs/system-speckit/033-system-speckit-v4/019-memory-decommission-branch-landing/goal.md`) as the precedent this phase either extends or reopens | Low | Already read and cited directly in Problem Statement |
<!-- /ANCHOR:risks -->

...
- Executing the `git mv` itself. Planned as a hand-off to a separate Level 3 packet; the operator directed the move to run here, and it did (`f65b8f1e5b`).
- Renaming `@spec-kit/scripts`. Planned as a package-name freeze; the review remediation renamed the CLI package to `@spec-kit/cli` because the nested workspace could not keep the old name honestly (`069c223966`).
<!-- /ANCHOR:scope -->

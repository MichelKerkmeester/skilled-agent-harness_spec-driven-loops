...
- **SC-002**: `validate.sh --strict` exits identically (0) before and after this change for every packet in `specs/system-speckit/049-memory-decommission/`, `052-memory-decommission-landing/` and `053-spec-kit-runtime-rename/` - the reverted regression does not recur.

...
# Tasks: Close the three P1 findings that survived four deep-review iterations: a fail-open kill switch, a plan-time parent gate that skips newly orphaned daemons, and a contradictory permission-mode precondition
...
- [x] T001 Write a control for the omitted-enable path and watch it fail — pre-fix it signalled
- [x] T002 Write a control for the parent-died-after-snapshot path and watch it fail — pre-fix `appliedPids` was empty
<!-- /ANCHOR:phase-1 -->
...
- [x] T003 Require an explicit enable decision; report an omission distinctly from a disable
- [x] T004 Read parent evidence once at decision time and let it, not the snapshot, decide reapability
- [x] T005 Widen candidate selection so a snapshot verdict cannot exclude a now-parentless daemon before evaluation
- [x] T006 Version-scope the permission-mode precondition and align it with the audit
<!-- /ANCHOR:phase-2 -->
...
- [x] T007 Both controls pass; 14 tests green across the two phase suites

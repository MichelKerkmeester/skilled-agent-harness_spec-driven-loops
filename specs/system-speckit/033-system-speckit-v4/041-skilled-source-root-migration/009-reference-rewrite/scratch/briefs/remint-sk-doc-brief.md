...
TASK (unit remint-sk-doc): from the repository root, run exactly this one command, once:

node .skilled/bin/compiled-route-manifest.cjs refresh --hub sk-doc --skill-root .skilled/skills/sk-doc && cp .skilled/bin/lib/compiled-routing/013-live-activation/activation/sk-doc/manifest.json specs/sk-doc/019-skill-routing-refactor/015-router-unification-program/013-live-activation/activation/sk-doc/manifest.json

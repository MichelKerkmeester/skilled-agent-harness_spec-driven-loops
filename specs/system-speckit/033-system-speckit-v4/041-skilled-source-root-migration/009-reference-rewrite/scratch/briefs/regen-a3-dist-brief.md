...
TASK (unit regen-a3-dist): from the repository root, run exactly this one command, once:

npm --prefix .skilled/skills/system-spec-kit/runtime run build && npm --prefix .skilled/skills/system-spec-kit/runtime/cli run build

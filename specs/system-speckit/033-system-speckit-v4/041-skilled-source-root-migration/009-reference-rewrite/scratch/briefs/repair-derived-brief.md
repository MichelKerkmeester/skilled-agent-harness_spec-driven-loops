...
TASK (unit repair-derived): from the repository root, run exactly this one command, once:

node .skilled/skills/system-spec-kit/runtime/cli/spec/repair-derived.cjs --folder .skilled/skills/system-spec-kit/runtime/cli/test-fixtures/002-valid-level1 --apply && node .skilled/skills/system-spec-kit/runtime/cli/spec/repair-derived.cjs --folder .skilled/skills/system-spec-kit/runtime/cli/test-fixtures/003-valid-level2 --apply && node .skilled/skills/system-spec-kit/runtime/cli/spec/repair-derived.cjs --folder .skilled/skills/system-spec-kit/runtime/cli/test-fixtures/004-valid-level3 --apply && node .skilled/skills/system-spec-kit/runtime/cli/spec/repair-derived.cjs --folder .skilled/skills/system-spec-kit/runtime/cli/test-fixtures/053-template-compliant-level2 --apply && node .skilled/skills/system-spec-kit/runtime/cli/spec/repair-derived.cjs --folder .skilled/skills/system-spec-kit/runtime/cli/test-fixtures/063-template-compliant-level3 --apply

...
TASK (unit manual-git-hook-readmes-02): read `specs/system-speckit/033-system-speckit-v4/041-skilled-source-root-migration/009-reference-rewrite/scratch/briefs/manual-git-hook-readmes-02-payload.md`. It lists 25 rows.

...
TASK (unit regen-a-agents): from the repository root, run exactly this one command, once:

node .skilled/skills/system-spec-kit/runtime/cli/codex/sync-agents.cjs && node .skilled/skills/system-spec-kit/runtime/cli/pi/sync-agents-pi.cjs && env -u HERMES_SKILLS_SOURCE_DIR -u HERMES_SKILLS_OUTPUT_DIR -u HERMES_AGENTS_SOURCE_DIR node .skilled/skills/system-spec-kit/runtime/cli/hermes/sync-skills-hermes.cjs

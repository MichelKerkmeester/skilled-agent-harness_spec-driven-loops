...
TASK (unit regen-a-dist): from the repository root, run exactly this one command, once:

npm --prefix .skilled/skills/system-spec-kit/runtime run build && npm --prefix .skilled/skills/system-spec-kit/runtime/cli run build && npm --prefix .skilled/skills/system-skill-advisor/runtime run build

...
TASK (unit regen-a3-bridges): from the repository root, run exactly this one command, once:

node .skilled/skills/system-skill-advisor/runtime/scripts/command-bridges/derive-command-bridges.cjs

...
TASK (unit regen-b-readme): from the repository root, run exactly this one command, once:

python3 .skilled/skills/sk-doc/scripts/tests/test_readme_verdict_parity.py --write

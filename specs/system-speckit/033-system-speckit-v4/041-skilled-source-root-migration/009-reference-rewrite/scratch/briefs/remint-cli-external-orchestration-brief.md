...
TASK (unit remint-cli-external-orchestration): from the repository root, run exactly this one command, once:

node .skilled/bin/compiled-route-manifest.cjs refresh --hub cli-external-orchestration --skill-root .skilled/skills/cli-external-orchestration && cp .skilled/bin/lib/compiled-routing/013-live-activation/activation/cli-external-orchestration/manifest.json specs/sk-doc/019-skill-routing-refactor/015-router-unification-program/013-live-activation/activation/cli-external-orchestration/manifest.json

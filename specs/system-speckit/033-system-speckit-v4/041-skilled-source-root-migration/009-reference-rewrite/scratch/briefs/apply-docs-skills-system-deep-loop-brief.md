...
TASK (unit apply-docs-skills-system-deep-loop): from the repository root, run exactly this one command, once:

python3 specs/system-speckit/033-system-speckit-v4/041-skilled-source-root-migration/009-reference-rewrite/scratch/rewrite-batch.py --apply --repo . --manifest specs/system-speckit/033-system-speckit-v4/041-skilled-source-root-migration/009-reference-rewrite/scratch/batch-manifests/batches/docs-skills-system-deep-loop.txt --keep-list specs/system-speckit/033-system-speckit-v4/041-skilled-source-root-migration/009-reference-rewrite/scratch/keep-list.tsv --judged specs/system-speckit/033-system-speckit-v4/041-skilled-source-root-migration/009-reference-rewrite/scratch/batch-manifests/judged.txt --decisions specs/system-speckit/033-system-speckit-v4/041-skilled-source-root-migration/009-reference-rewrite/scratch/decisions/groups/docs-skills-system-deep-loop.tsv --kept-ledger specs/system-speckit/033-system-speckit-v4/041-skilled-source-root-migration/009-reference-rewrite/scratch/ledgers/docs-skills-system-deep-loop.tsv

...
TASK (unit remint-mcp-tooling): from the repository root, run exactly this one command, once:

node .skilled/bin/compiled-route-manifest.cjs refresh --hub mcp-tooling --skill-root .skilled/skills/mcp-tooling && cp .skilled/bin/lib/compiled-routing/013-live-activation/activation/mcp-tooling/manifest.json specs/sk-doc/019-skill-routing-refactor/015-router-unification-program/013-live-activation/activation/mcp-tooling/manifest.json

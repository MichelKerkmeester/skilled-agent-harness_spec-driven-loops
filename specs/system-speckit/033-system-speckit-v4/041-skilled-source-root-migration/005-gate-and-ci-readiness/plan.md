...
- [ ] Every contract change carries a GPT-5.6 review with no open finding
...
| `gpt-5.6-sol` on cli-codex | External | Yellow until probed at the start | Contract changes wait, and are never merged unreviewed |

...
| Dependency | GPT-5.6 Luna at xhigh on the fast tier through cli-codex | A contract change lacks its second model family | The change waits for its review and is never merged unreviewed |

...
- [x] T011 Rerun the census over the final template and validate this child and the parent (specs/system-speckit/033-system-speckit-v4/030-spec-kit-simplification-research)
<!-- /ANCHOR:phase-3 -->

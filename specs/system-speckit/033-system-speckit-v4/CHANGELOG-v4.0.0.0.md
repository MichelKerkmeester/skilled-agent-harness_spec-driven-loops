...
The chart corpus was brought to the shadcn visual register, with three named stock colour systems, their palette source and proof sheets checked in beside the forms. The chart check grew from fifteen named checks to twenty-five, three of them browser-backed, so a form cannot drift off the register without a gate going red. A cursor-derived Style Reference became the stock chart register late in the cycle, and a fresh review of every chart packet was closed before release.

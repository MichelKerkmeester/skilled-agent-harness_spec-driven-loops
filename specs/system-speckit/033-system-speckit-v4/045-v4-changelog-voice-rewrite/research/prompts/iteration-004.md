...
Questions: 0/5 answered | Last focus: Q4 tail: sentence-level prose conformance sample against README HEAD; Q1 tail: per-paragraph ownership map; family tie-break against README section 7; .opencode sweep classification; F-008 count resolution
Last 2 ratios: 0.62 -> 0.55 | Stuck count: 0
Resource map: resource-map.md not present; skipping coverage gate.
Lineage context refresh: 3 iteration(s) complete; 77 findings and 5 open questions in the reducer registry; next focus below.
...
- Write iteration narrative to: specs/system-speckit/033-system-speckit-v4/045-v4-changelog-voice-rewrite/research/iterations/iteration-004.md
- Write per-iteration delta file to: specs/system-speckit/033-system-speckit-v4/045-v4-changelog-voice-rewrite/research/deltas/iter-004.jsonl
...
- **ALLOWED WRITE PATHS (the ONLY paths you may create, modify, or append to)**:
  - `specs/system-speckit/033-system-speckit-v4/045-v4-changelog-voice-rewrite/research/iterations/iteration-004.md`, this iteration's narrative markdown
  - `specs/system-speckit/033-system-speckit-v4/045-v4-changelog-voice-rewrite/research/deltas/iter-004.jsonl`, this iteration's delta JSONL
...
1. **Iteration narrative markdown** at `specs/system-speckit/033-system-speckit-v4/045-v4-changelog-voice-rewrite/research/iterations/iteration-004.md` (path is pre-substituted for the current iteration number). Structure: headings for Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus.

...
| 4 | P0 | A new `alignment` (conformance-audit) deep-loop mode; eight ledger modes on `new_authoritative_final` | FALSE | Removed in `94ab276bfdf`; six registry modes, seven ledger modes | Delete the alignment paragraphs and the eight-mode count |

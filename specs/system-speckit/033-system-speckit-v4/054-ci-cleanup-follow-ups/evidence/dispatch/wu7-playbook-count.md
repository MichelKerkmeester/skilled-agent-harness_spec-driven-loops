...
TARGET: .skilled/skills/system-spec-kit/manual-testing-playbook/plugins-and-hooks/spec-mutation-gate-enforce.md (1 file, 1 line)

WHY: the core suite gained a test proving a repository rooted under /tmp is gated like any other,
so the suite now runs 108 tests. Step 2 still expects 107.

EDIT 1 (OLD occurs exactly once)
OLD: Expected: `tests 107`, `pass 107`, `skipped 0`, `fail 0`
NEW: Expected: `tests 108`, `pass 108`, `skipped 0`, `fail 0`

VERIFY - run these, paste each command with its result line
  grep -c 'tests 108`, `pass 108`' .skilled/skills/system-spec-kit/manual-testing-playbook/plugins-and-hooks/spec-mutation-gate-enforce.md   # expect 1
  grep -c '107' .skilled/skills/system-spec-kit/manual-testing-playbook/plugins-and-hooks/spec-mutation-gate-enforce.md   # expect 0

...
Segment: new | Iteration: 1 of 10
Questions: 0/5 answered | Last focus: none (first iteration)
Last 2 ratios: n/a | Stuck count: 0
Recovery: none
Next focus: Q1 - path, command and binary references in the changelog
...
Iteration: 1 of 10
Focus Area: Q1 - path, command and binary references in the changelog: .opencode vs .skilled roots, compatibility aliases, and the advisor front door
Remaining Key Questions: - Q1: Which path, command or binary references in the v4 changelog point at roots that no longer exist, and which remain true through a compatibility alias or symlink?
...
- Write iteration narrative to: specs/system-speckit/033-system-speckit-v4/042-v4-doc-freshness/research/iterations/iteration-001.md
- Write per-iteration delta file to: specs/system-speckit/033-system-speckit-v4/042-v4-doc-freshness/research/deltas/iter-001.jsonl
...
- **ALLOWED WRITE PATHS (the ONLY paths you may create, modify, or append to)**:
  - `specs/system-speckit/033-system-speckit-v4/042-v4-doc-freshness/research/iterations/iteration-001.md`, this iteration's narrative markdown
  - `specs/system-speckit/033-system-speckit-v4/042-v4-doc-freshness/research/deltas/iter-001.jsonl`, this iteration's delta JSONL
...
1. **Iteration narrative markdown** at `specs/system-speckit/033-system-speckit-v4/042-v4-doc-freshness/research/iterations/iteration-001.md` (path is pre-substituted for the current iteration number). Structure: headings for Focus, Actions Taken, Findings, Questions Answered, Questions Remaining, Next Focus.

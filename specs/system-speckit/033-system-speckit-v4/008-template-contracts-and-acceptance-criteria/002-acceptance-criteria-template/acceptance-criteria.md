...
_memory:
  continuity:
    ...
    key_files: []
    session_dedup:
      fingerprint: "sha256:bc5f939806b9810b5ee64312bdc2d7da2a20087ebba0ebd6bf83f6e79e97810e"
...
**Packet:** system-speckit/033-system-speckit-v4/008-template-contracts-and-acceptance-criteria/002-acceptance-criteria-template
**Level:** 3
**Status:** In Progress
**Date:** 2026-08-29
<!-- /ANCHOR:metadata -->
...
|-------|-----|---------------------|--------------|--------|--------|
| AC-001 | REQ-001 | Given the gated template, When it is rendered at Level 1, Then nothing is emitted; at Levels 2, 3 and 3+ the document is emitted | `inline-gate-renderer.sh --level N templates/addons/acceptance-criteria.md.tmpl`: gate at `templates/addons/acceptance-criteria.md.tmpl:1` yields L1 = 0 lines, L2/L3/L3+ = 86 lines | Met | - |
| AC-002 | REQ-002 | Given the Level contract, When a Level 2/3/3+ packet is resolved, Then acceptance-criteria.md is part of that level's document set | `templates/spec-kit-docs.json` lists it in optionalAddonDocs at 2/3/3+ with sectionGates; presence is enforced by AC_CLOSURE, not the level contract (`scripts/rules/check-ac-closure.sh:253`) | Met | - |

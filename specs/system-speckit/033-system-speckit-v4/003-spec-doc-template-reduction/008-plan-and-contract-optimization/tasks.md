...
- [x] T012 Run `validate.sh --recursive` on `specs/system-speckit/033-system-speckit-v4/003-spec-doc-template-reduction/` and confirm existing packets with summaries and legacy plan phases produce no new failures for REQ-006 and REQ-007 (`.opencode/skills/system-spec-kit/scripts/spec/validate.sh`)

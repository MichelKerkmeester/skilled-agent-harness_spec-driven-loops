---
title: "Verification Checklist: Automated Test Harness"
description: "Evidence gates for the implemented automated test harness; operator-only live checks remain separate."
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "Reconciled checklist status with the implemented harness"
...
# Verification Checklist: Automated Test Harness
...
The harness is implemented and its shared machine gate passes. Unchecked rows remain specific evidence or sign-off requirements, not an implementation-start indicator.
<!-- /ANCHOR:protocol -->
...
- [ ] CHK-020 [P0] Harness self-tests and negative controls passes with exact command and environment evidence.
- [ ] CHK-021 [P0] Fixture drift checks passes with exact command and environment evidence.
- [ ] CHK-022 [P1] Isolation and leaked-process checks passes with exact command and environment evidence.
- [ ] CHK-023 [P1] Deterministic rerun comparison passes with exact command and environment evidence.

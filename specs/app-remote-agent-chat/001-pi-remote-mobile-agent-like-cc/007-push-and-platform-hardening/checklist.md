---
title: "Verification Checklist: Push and Platform Hardening"
description: "Evidence gates for implemented push and platform hardening; physical iOS delivery remains operator-verification pending."
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "Reconciled checklist status with the implemented push path"
...
# Verification Checklist: Push and Platform Hardening
...
The push path is implemented and machine-tested. Unchecked physical-device rows remain operator-only and are not complete.
<!-- /ANCHOR:protocol -->
...
- [ ] CHK-020 [P0] Payload privacy inspection passes with exact command and environment evidence.
- [ ] CHK-021 [P0] Subscription lifecycle suite passes with exact command and environment evidence.
- [ ] CHK-022 [P1] Stale hint and reauthentication tests passes with exact command and environment evidence.
- [ ] CHK-023 [P1] Physical-device lifecycle matrix passes with exact command and environment evidence.
- [ ] CHK-024 [P1] Logout and revocation checks passes with exact command and environment evidence.
...
| Product P0 | 9 | Implemented; physical iOS delivery evidence pending |
| Product P1 | 6 | Implemented; checklist evidence reconciliation pending |
| Optional | 2 | 0/2 |

**Verification Date**: machine evidence reconciled 2026-08-13; physical iOS delivery remains operator-owned.
<!-- /ANCHOR:summary -->

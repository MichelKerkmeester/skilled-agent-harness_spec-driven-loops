...
_memory:
  continuity:
    ...
    recent_action: "Reconciled the plan with the implemented push path"
...
Adds privacy-minimized Web Push hints and hardens installation, lifecycle, revocation, and stale-state behavior. The path is implemented and machine-tested; physical iOS delivery remains operator-verification pending.
<!-- /ANCHOR:summary -->

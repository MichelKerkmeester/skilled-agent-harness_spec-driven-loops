...
Introduces the final-boundary Pi approval extension, containment, shared redaction, and evidence-gated remote mutation. The authority loop is built and machine-tested; live extension ordering and real containment remain operator-verification pending.
<!-- /ANCHOR:summary -->

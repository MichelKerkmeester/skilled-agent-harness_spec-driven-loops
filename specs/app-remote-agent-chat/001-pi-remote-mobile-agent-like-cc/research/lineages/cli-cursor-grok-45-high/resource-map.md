...
| Path | Theme |
|------|-------|
| `specs/cli-external-orchestration/001-pi-remote-mobile-agent-like-cc/research/deep-research-strategy.md` | Parent charter / Q1–Q10 (read-only) |
| `specs/cli-external-orchestration/001-pi-remote-mobile-agent-like-cc/research/lineages/cli-cursor-grok-45-high/` | This lineage packet |

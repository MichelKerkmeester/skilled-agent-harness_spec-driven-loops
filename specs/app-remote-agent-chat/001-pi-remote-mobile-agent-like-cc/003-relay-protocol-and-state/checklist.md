---
title: "Verification Checklist: Relay Protocol and Durable State"
description: "Evidence gates for the implemented relay protocol and durable state; operator-only live checks remain separate."
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "Reconciled checklist status with the implemented relay and command path"
...
# Verification Checklist: Relay Protocol and Durable State
...
The relay is implemented and its shared machine gate passes. Unchecked rows remain specific evidence or sign-off requirements, not an implementation-start indicator.
<!-- /ANCHOR:protocol -->
...
- [ ] CHK-020 [P0] Protocol unit/property suite passes with exact command and environment evidence.
- [ ] CHK-021 [P0] Recorded and live Pi contract suite passes with exact command and environment evidence.
- [ ] CHK-022 [P1] Storage migration and restart suite passes with exact command and environment evidence.
- [ ] CHK-023 [P1] Session isolation and kill-point suite passes with exact command and environment evidence.
- [ ] CHK-024 [P1] Slow-client and queue-bound load suite passes with exact command and environment evidence.
...
**Verification Date**: machine evidence reconciled 2026-08-13; live Pi and rollout evidence remain operator-owned.
<!-- /ANCHOR:summary -->

# Research provenance — F7 — Rich Content Blocks

This `research/` folder holds the deep-research artifacts for the **006-rich-content-blocks** feature,
...
These 10 iterations were produced by **external-CLI orchestration** (a bounded,

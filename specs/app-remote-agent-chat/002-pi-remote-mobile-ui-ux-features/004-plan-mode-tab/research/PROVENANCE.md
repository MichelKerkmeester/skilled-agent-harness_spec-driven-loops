# Research provenance — F4 — Plan mode with a Tab / keyboard affordance

This `research/` folder holds the deep-research artifacts for the **004-plan-mode-tab** feature,

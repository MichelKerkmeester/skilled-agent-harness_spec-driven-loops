# Research provenance — F5 Media Upload — Photos in Chat

This `research/` folder holds the deep-research artifacts for the **007-media-upload** feature,
...
These 15 iterations were produced by **external-CLI orchestration** (a bounded,
resumable Node orchestrator dispatching independent, cited passes), not by the
`/deep:research` state-machine runtime:

- 5 × GPT 5.6 SOL high (--search, cli-codex)
- 5 × Grok 4.6 xhigh (cli-cursor)

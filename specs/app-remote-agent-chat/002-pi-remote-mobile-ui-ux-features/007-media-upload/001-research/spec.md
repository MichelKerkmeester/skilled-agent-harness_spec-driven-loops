...
# Research — F5 Media Upload — Photos in Chat

> First sub-phase of the `007-media-upload` feature. This is a **lean spec-kit phase**: it
...
- `../research/iterations/iteration-NNN.md` — the 15 independent, cited passes.

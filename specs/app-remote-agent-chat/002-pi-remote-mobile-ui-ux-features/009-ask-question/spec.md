---
title: "Support pi’s ask-question extension in the PWA"
description: "Render pi’s ask-question prompts inline in the mobile chat with a terminal-style, keyboard-friendly question card — the way OpenCode, Claude, and Codex present agent questions."
trigger_phrases:
  - "pi ask question pwa"
...
_memory:
  continuity:
    packet_pointer: "app-remote-agent-chat/002-pi-remote-mobile-ui-ux-features/009-ask-question"
...
# Feature Specification: Support pi’s ask-question extension in the PWA
...
Render pi’s ask-question prompts inline in the mobile chat with a terminal-style, keyboard-friendly question card — the way OpenCode, Claude, and Codex present agent questions.
...
**Desired end state.** An inline question card (prompt + selectable options + free-text where allowed), keyboard/great-thumb navigation, host-confirmed answer submission, in the fixed ink-on-parchment system — UX on par with OpenCode / Claude / Codex ask-question prompts.
...
OpenCode, Claude, and Codex ask-question / prompt UIs; plus Mobbin/Refero reference flows.

Reference apps to capture: OpenCode, Claude, Codex, plus Dot, Perplexity, Copilot, Manus, Grok, Pi, Meta AI, ChatGPT, Gemini, Genie via Mobbin/Refero.

## Acceptance criteria (provisional — finalized after research)

- The surface renders pi’s ask-question prompts correctly and updates live.

...
# Research — Change the effort / reasoning level

> First sub-phase of the `002-change-effort` feature. This is a **lean spec-kit phase**: it
...
- `../research/iterations/iteration-NNN.md` — the 5 independent, cited passes.

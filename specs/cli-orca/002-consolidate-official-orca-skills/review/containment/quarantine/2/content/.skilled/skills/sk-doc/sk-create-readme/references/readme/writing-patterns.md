...
Optional, for the repository front-page README and other marketing-facing entry points. State the pain the reader already feels before telling them what this is, in two to four sentences written in their words. When a Problem section exists, Overview explains the answer to it.

---
title: "Goal: Phase 2: cli-jev-skill-packet"
...
# Goal: Phase 2: cli-jev-skill-packet
...
**Objective:** `cli-jev` exists as a skill packet whose declared hard rules are exactly the checks the dispatch engine implements.

---
title: "Goal: Phase 1: jev-contract-research-and-pin"
...
# Goal: Phase 1: jev-contract-research-and-pin
...
**Objective:** The `jev` CLI's dispatch contract is pinned against the live binary, with every claim tagged source-read or live-verified.

...
| 5 | `005-hermes-runtime-folder/` | Repo-root `.hermes/`: curated per-skill `skills/<name>` symlinks (whole-tree link rejected on scan evidence), `prompts/`, `plugins/`, `SYNC.md`, playbook symlink | Complete 2026-09-14 — live skill reach and template dispatch proven; skills surface is curated per-skill links |

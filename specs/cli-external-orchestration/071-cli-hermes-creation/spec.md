...
| 5 | `005-hermes-runtime-folder/` | Repo-root `.hermes/`: generated markdown-only `skills/<name>/SKILL.md` copies of all 56 skills (symlinks rejected on scan evidence), `prompts/`, `plugins/`, `SYNC.md`, playbook symlink | Complete 2026-09-14 — live skill reach and template dispatch proven; skills surface is curated per-skill links |

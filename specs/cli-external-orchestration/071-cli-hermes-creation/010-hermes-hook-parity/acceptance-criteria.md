...
|-------|-----|---------------------|--------------|--------|--------|
| AC-001 | REQ-001 | Given a write in a Hermes session, When the file carries a comment-hygiene violation, Then the post-edit warning is on the tool result | HERMES-024, session `20260915_074652_824086` | Met | - |
...
| AC-006 | REQ-001 | Given an image analysis, When the tool returns, Then the vision evidence is appended | HERMES-029, session `20260915_082637_0f75f1` | Met | - |

...
BINDING: target=.skilled/skills/cli-external-orchestration/cli-opencode/README.md
BINDING: output=.skilled/skills/cli-external-orchestration/cli-opencode/README.md
...
cli-opencode/
  ...
  references/
    ...
    references/destructive-scope-violations.md
    references/integration-patterns.md
    references/opencode-tools.md
    references/permissions-matrix.md
    references/providers-and-models.md
    references/self-invocation-guard.md
    assets/permissions-matrix.example-packet-local.json
    assets/permissions-matrix.example-readonly.json
    assets/permissions-matrix.example-repo-wide.json
    assets/permissions-matrix.schema.json
...
3. NAME EVERY FILE. These must all appear, spelled exactly:
   ...
   files: `references/agent-delegation.md`, `references/cli-reference.md`, `references/context-budget.md`, `references/destructive-scope-violations.md`, `references/integration-patterns.md`, `references/opencode-tools.md`, `references/permissions-matrix.md`, `references/providers-and-models.md`, `references/self-invocation-guard.md`, `assets/permissions-matrix.example-packet-local.json`, `assets/permissions-matrix.example-readonly.json`, `assets/permissions-matrix.example-repo-wide.json`, `assets/permissions-matrix.schema.json`, `assets/prompt-quality-card.md`, `assets/prompt-templates.md`
...
python3 .skilled/skills/sk-doc/shared/scripts/validate_document.py .skilled/skills/cli-external-orchestration/cli-opencode/README.md

# 2. section numbering must be sequential with no gaps
grep -n '^## ' .skilled/skills/cli-external-orchestration/cli-opencode/README.md

# 3. your diff must be additive
git diff --stat -- .skilled/skills/cli-external-orchestration/cli-opencode/README.md
git diff -- .skilled/skills/cli-external-orchestration/cli-opencode/README.md
```

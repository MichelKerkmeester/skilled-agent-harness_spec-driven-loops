...
BINDING: target=.skilled/skills/cli-external-orchestration/cli-claude-code/README.md
BINDING: output=.skilled/skills/cli-external-orchestration/cli-claude-code/README.md
...
3. NAME EVERY FILE. These must all appear, spelled exactly:
   ...
   files: `references/agent-delegation.md`, `references/claude-tools.md`, `references/cli-reference.md`, `references/integration-patterns.md`, `references/providers-and-models.md`, `assets/prompt-quality-card.md`, `assets/prompt-templates.md`
...
python3 .skilled/skills/sk-doc/shared/scripts/validate_document.py .skilled/skills/cli-external-orchestration/cli-claude-code/README.md

# 2. section numbering must be sequential with no gaps
grep -n '^## ' .skilled/skills/cli-external-orchestration/cli-claude-code/README.md

# 3. your diff must be additive
git diff --stat -- .skilled/skills/cli-external-orchestration/cli-claude-code/README.md
git diff -- .skilled/skills/cli-external-orchestration/cli-claude-code/README.md
```

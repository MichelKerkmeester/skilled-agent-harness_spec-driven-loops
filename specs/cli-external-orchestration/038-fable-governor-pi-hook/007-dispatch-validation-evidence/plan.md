...
_memory:
  continuity:
    packet_pointer: "cli-external-orchestration/038-fable-governor-pi-hook/007-dispatch-validation-evidence"
    ...
    session_dedup:
      fingerprint: "sha256:8a1c7776ad1c4d0f62fe1e3b4590d08ef4a627f1a9a74b1c7a7d8a4e6c8c6f11"
...
- Claim consumers: `rg -n "PASS|FAIL|byte[- ]equal|transform.order|tool_call|pure helper|21 files|full corpus" .opencode/specs/cli-external-orchestration/038-fable-governor-pi-hook --glob '*.md'`.
...
| Claim scan | Unsupported wording and stale counts | `rg -n "byte[- ]equal|byte parity|transform.order|tool_call|pure helper|21 files|full corpus" .opencode/specs/cli-external-orchestration/038-fable-governor-pi-hook --glob '*.md'` |

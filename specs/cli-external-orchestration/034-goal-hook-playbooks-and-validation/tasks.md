...
- [x] T001 Confirm packet 032 (goal-hook implementation) shipped before authoring playbooks (`032-goal-hooks-cross-runtime/spec.md` completion_pct 100%)
...
- **Plan**: See `plan.md`
- **Upstream packet**: `.opencode/specs/cli-external-orchestration/032-goal-hooks-cross-runtime/spec.md`
<!-- /ANCHOR:cross-refs -->

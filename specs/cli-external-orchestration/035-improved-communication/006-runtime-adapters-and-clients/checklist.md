...
description: "Draft implementation and release gates for Phase 006; implementation evidence remains pending."
trigger_phrases:
...
_memory:
  continuity:
    ...
    recent_action: "Created the Phase 006 verification scaffold."
...
- [ ] CHK-023 [P1] Edge cases pass: runtime reconnect with replayed events; unsupported protocol major or missing capability; partial stream followed by client disconnect; extension event unknown to the shared message extractor.
...
- [ ] CHK-110 [P1] The Phase 006 performance target is measured under stated conditions.

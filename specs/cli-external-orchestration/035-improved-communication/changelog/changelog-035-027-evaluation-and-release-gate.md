...
> Spec folder: `specs/cli-external-orchestration/035-improved-communication/027-evaluation-and-release-gate` (Level 3)
...
- Author the planned Level-3 packet: spec.md, plan.md, tasks.md, checklist.md, and decision-record.md (specs/cli-external-orchestration/035-improved-communication/027-evaluation-and-release-gate/)

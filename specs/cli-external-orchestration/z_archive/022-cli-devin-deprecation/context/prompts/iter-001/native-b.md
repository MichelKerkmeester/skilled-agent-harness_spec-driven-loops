...
```
Emit BINDING lines first (gatherSubject, slice, mode=context, specFolder=.opencode/specs/cli-external-orchestration/022-cli-devin-deprecation), then the JSON. Verified pointers (path:line), not source bodies. Tool budget ~8-12.

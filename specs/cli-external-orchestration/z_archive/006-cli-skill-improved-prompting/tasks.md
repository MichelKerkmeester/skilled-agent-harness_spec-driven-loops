...
---
title: "Tasks: CLI Skill Prompt-Quality Integration via [cli-external-orchestration/006-cli-skill-improved-prompting/tasks]"
description: "Task Format: T### [P?] Description (file path)"
trigger_phrases:
  - "043 tasks"
  - "mirror card tasks"
...
_memory:
  continuity:
    ...
    blockers: []
    key_files:
      - ".opencode/specs/cli-external-orchestration/006-cli-skill-improved-prompting/tasks.md"
...
- [x] T034 Run strict packet validation on `.opencode/specs/cli-external-orchestration/006-cli-skill-improved-prompting/` `[Evidence: bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh --strict .opencode/specs/cli-external-orchestration/006-cli-skill-improved-prompting -> RESULT: PASSED (Errors: 0, Warnings: 0)]`
<!-- /ANCHOR:phase-3 -->

...
---
title: "Implementation Plan: CLI Skill Prompt-Quality [cli-external-orchestration/006-cli-skill-improved-prompting/plan]"
...
- [x] The target spec folder is fixed: `.opencode/specs/cli-external-orchestration/006-cli-skill-improved-prompting/`.

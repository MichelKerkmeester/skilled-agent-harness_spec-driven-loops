...
Adds private HTTPS/WSS ingress, application authentication, default-deny authorization, revocation, and a read-only remote API. Work remains planning-only until the definition of ready passes.
<!-- /ANCHOR:summary -->

...
trigger_phrases: ["remove mcp-clickup", "delete mcp-clickup skill", "053 mcp-clickup"]
...
| REQ-007 | spec validates strict | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh cli-external-orchestration/012-cli-skill-removal-mcp-clickup --strict` exits 0 or 1 (warnings tolerated, errors not) |
<!-- /ANCHOR:requirements -->

...
| Field | Value |
|-------|-------|
| **Review target** | Spec packet `cli-external-orchestration/014-cli-copilot-deprecation-due-to-price-hike` + 4 commits on `main` |
...
$ bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh \
    .opencode/specs/cli-external-orchestration/014-cli-copilot-deprecation-due-to-price-hike --strict

...
_memory:
  continuity:
    packet_pointer: "cli-external-orchestration/015-cli-opencode-stdin-fix"
...
| Path | Lines | Purpose |
|------|------:|---------|
| `specs/cli-external-orchestration/015-cli-opencode-stdin-fix/spec.md` | 198 | Level 2 specification |
| `specs/cli-external-orchestration/015-cli-opencode-stdin-fix/plan.md` | 113 | Phased implementation plan |
| `specs/cli-external-orchestration/015-cli-opencode-stdin-fix/tasks.md` | 36 | Per-file task list (T1–T18) |
| `specs/cli-external-orchestration/015-cli-opencode-stdin-fix/checklist.md` | 53 | QA validation checklist |
| `specs/cli-external-orchestration/015-cli-opencode-stdin-fix/description.json` | 24 | Packet metadata |
| `specs/cli-external-orchestration/015-cli-opencode-stdin-fix/graph-metadata.json` | 16 | Graph metadata |
| `specs/cli-external-orchestration/015-cli-opencode-stdin-fix/implementation-summary.md` | ~190 | Summary, verification, follow-ups |
| `specs/cli-external-orchestration/015-cli-opencode-stdin-fix/resource-map.md` | (this file) | Path ledger |
| `specs/cli-external-orchestration/015-cli-opencode-stdin-fix/changelog.md` | ~70 | Change history |

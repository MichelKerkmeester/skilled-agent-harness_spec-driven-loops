...
_memory:
  continuity:
    ...
    key_files:
      ...
      - ".opencode/specs/cli-external-orchestration/018-cli-devin-prompt-quality/002-eval-rig/fixtures"
      - ".opencode/specs/cli-external-orchestration/018-cli-devin-prompt-quality/003-eval-loop/variants"
      - ".opencode/specs/cli-external-orchestration/018-cli-devin-prompt-quality/003-eval-loop/scripts/score-variant.cjs"
      - ".opencode/specs/cli-external-orchestration/018-cli-devin-prompt-quality/005-extraction-rerun/scripts/extract-files-from-markdown.cjs"
    session_dedup:
...
### In Scope
- Build `.opencode/specs/cli-external-orchestration/018-cli-devin-prompt-quality/007-cross-model-validation/scripts/cross-model-confirm.cjs`.
...
|-----------|-------------|-------------|
| `.opencode/specs/cli-external-orchestration/018-cli-devin-prompt-quality/007-cross-model-validation/scripts/cross-model-confirm.cjs` | Create | Planned confirm harness for 70 dispatches |
| `.opencode/specs/cli-external-orchestration/018-cli-devin-prompt-quality/007-cross-model-validation/state/confirm-results.jsonl` | Create | Planned result log written by the harness |
| `.opencode/specs/cli-external-orchestration/018-cli-devin-prompt-quality/007-cross-model-validation/analysis.md` | Create | Planned post-run decision analysis |
| `.opencode/specs/cli-external-orchestration/018-cli-devin-prompt-quality/007-cross-model-validation/implementation-summary.md` | Update | Planned after harness and run complete |
<!-- /ANCHOR:scope -->

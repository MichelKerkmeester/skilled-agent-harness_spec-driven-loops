...
_memory:
  continuity:
    packet_pointer: "cli-external-orchestration/z_archive/018-cli-devin-prompt-quality/001-council-design"
...
- [ ] T006 Initialize `ai-council/ai-council-state.jsonl` with `{type:"council_start", ts:"<iso>", packet:"113/001"}` row

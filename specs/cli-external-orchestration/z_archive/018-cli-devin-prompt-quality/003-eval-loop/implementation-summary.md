...
| strict-validate | `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/cli-external-orchestration/018-cli-devin-prompt-quality/003-eval-loop --strict` | TO RUN |
<!-- /ANCHOR:verification -->

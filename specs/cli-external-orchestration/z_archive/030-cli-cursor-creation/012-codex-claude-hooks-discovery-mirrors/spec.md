...
| **Predecessor** | `../011-cursor-mcp-wiring-and-route-guard-fix/spec.md` |
| **Successor** | `../013-cursor-spec-gate-prebind/spec.md` |
...
- `../011-cursor-mcp-wiring-and-route-guard-fix/spec.md` (predecessor)
- `../009-cursor-hooks-lifecycle/006-cursor-hooks-discovery-mirror/spec.md` (the pattern this phase extends cross-runtime)

...
_memory:
  continuity:
    ...
    key_files:
      - ".opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/review/review-report.md"
...
| `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/spec.md` | Created | Level 3 spec scaffolding |
| `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/plan.md` | Created | Wave-based delivery plan |
| `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/tasks.md` | Created | Linear task list |
| `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/checklist.md` | Created | P0/P1/P2 acceptance gates |
| `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/decision-record.md` | Created | ADR-001 through ADR-005 |
| `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/implementation-summary.md` | Created | This summary |
| `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/description.json` | Created | Spec-folder discovery metadata |
| `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/graph-metadata.json` | Created | Graph indexing metadata |
<!-- /ANCHOR:what-built -->

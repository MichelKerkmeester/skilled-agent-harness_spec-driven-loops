You are running iteration 3 of a 5-iteration deep review on spec folder `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/`.
...
- `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/review/iterations/iteration-001.md` (correctness)
- `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/review/iterations/iteration-002.md` (security)
...
Write findings to `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/review/iterations/iteration-003.md` using the same template format. `[severity] [feature-id-or-file:line] description + remediation`. Read-only review.

You are running iteration 4 of a 5-iteration deep review on spec folder `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/`.
...
Write findings to `.opencode/specs/cli-external-orchestration/009-cli-testing-playbooks/review/iterations/iteration-004.md` using same template format. Read-only.

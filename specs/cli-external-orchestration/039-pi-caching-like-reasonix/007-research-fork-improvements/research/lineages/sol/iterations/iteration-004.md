...
- Relying on RPC notification forwarding as the canonical report transport; prior work confirmed only partial observability and the contract remains UI-shaped. [SOURCE: specs/cli-external-orchestration/039-pi-caching-like-reasonix/006-fork-and-improve-deep-pi/003-live-verification-and-closeout/implementation-summary.md:60]

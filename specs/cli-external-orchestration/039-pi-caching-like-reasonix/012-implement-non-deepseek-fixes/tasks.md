...
- [x] T027 `validate.sh --recursive --strict` on the whole `039` packet after Phase 4 closes
  Evidence: Final `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/cli-external-orchestration/039-pi-caching-like-reasonix --recursive --strict` exits 0.

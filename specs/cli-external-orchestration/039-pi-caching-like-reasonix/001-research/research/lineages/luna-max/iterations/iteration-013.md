...
- The lumo plan-mode gap is accurate only when scoped to Pi core, and it is irrelevant to a provider-cache plugin unless the plugin also claims to enforce read-only research or implementation gates. [SOURCE: .opencode/specs/cli-external-orchestration/039-pi-caching-like-reasonix/lumo.md:23-32; INFERENCE: https://pi.dev/docs/latest/usage]

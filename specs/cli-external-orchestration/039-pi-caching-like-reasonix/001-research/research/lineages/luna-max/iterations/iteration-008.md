...
- The `lumo.md` label “official pi-cache-optimizer” is not supported by the package metadata reviewed here. The defensible wording is “community Pi package with a verifiable implementation,” subject to source audit and version pinning. [SOURCE: .opencode/specs/cli-external-orchestration/039-pi-caching-like-reasonix/lumo.md:8-19; https://pi.dev/packages/pi-cache-optimizer]
...
- `.opencode/specs/cli-external-orchestration/039-pi-caching-like-reasonix/lumo.md:8-19`

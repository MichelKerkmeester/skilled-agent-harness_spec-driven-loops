...
trigger_phrases:
  - "032-per-mode-provider-model-reference"
  - "phase parent"
importance_tier: "important"
contextType: "implementation"
_memory:
  continuity:
    packet_pointer: "cli-external-orchestration/032-per-mode-provider-model-reference"
...
| **Branch** | `main` |
| **Parent Spec** | `../spec.md` |
| **Parent Packet** | scaffold/032-per-mode-provider-model-reference |
| **Predecessor** | None |
| **Successor** | None |

---
title: "Verification Checklist: Approval, Containment, and Remote Mutation"
description: "Evidence gates for approval, containment, and remote mutation; product checks remain open until implementation."
trigger_phrases:
...
# Verification Checklist: Approval, Containment, and Remote Mutation
...
- [ ] CHK-020 [P0] Canonicalization and digest compatibility passes with exact command and environment evidence.
- [ ] CHK-021 [P0] Approval mismatch/race/restart matrix passes with exact command and environment evidence.
- [ ] CHK-022 [P1] Containment escape suite passes with exact command and environment evidence.
- [ ] CHK-023 [P1] Canary scan across every boundary passes with exact command and environment evidence.
- [ ] CHK-024 [P1] Kill-switch and per-command authorization suite passes with exact command and environment evidence.
...
| Product P0 | 11 | 0/11, not started |

...
- [x] T012 Run focused and recursive strict validation.
  - Evidence: `validate.sh specs/cli-external-orchestration/042-goal-isolation --recursive --strict` exited 0; parent and all five children reported zero errors and zero warnings.
<!-- /ANCHOR:phase-3 -->

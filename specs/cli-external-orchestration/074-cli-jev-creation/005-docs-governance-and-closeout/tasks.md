...
- [x] T009 Author the parent phase map, handoff criteria and metadata (`074-cli-jev-creation/spec.md`)
- [x] T010 Author the parent durable directive and completion criteria (`074-cli-jev-creation/goal.md`)

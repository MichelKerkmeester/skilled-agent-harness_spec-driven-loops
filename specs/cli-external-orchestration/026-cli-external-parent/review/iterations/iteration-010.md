...
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/001-research-and-context/plan.md:1-175`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/001-research-and-context/spec.md:1-208`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/002-architecture-decision/decision-record.md:1-537`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/002-architecture-decision/plan.md:1-379`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/002-architecture-decision/spec.md:1-314`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/003-scaffold-hub/plan.md:1-173`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/003-scaffold-hub/spec.md:1-203`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/004-onboard-cli-opencode/plan.md:1-179`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/004-onboard-cli-opencode/spec.md:1-205`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/005-foldin-cli-claude-code/plan.md:1-181`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/005-foldin-cli-claude-code/spec.md:1-240`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/006-advisor-and-integration/plan.md:1-182`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/006-advisor-and-integration/spec.md:1-239`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/007-routing-benchmark-and-review/plan.md:1-175`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/007-routing-benchmark-and-review/spec.md:1-200`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/008-cutover-and-rollout/plan.md:1-178`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/008-cutover-and-rollout/spec.md:1-201`
- `.opencode/specs/cli-external-orchestration/026-cli-external-parent/spec.md:1-172`
...
- `checklist_evidence`: deferred. Execution checklists and completion evidence are outside the configured review-target files. [SOURCE: `.opencode/specs/cli-external-orchestration/026-cli-external-parent/review/deep-review-config.json:18-59`]

...
Skill-advisor scorer parent-hub compatibility for `.opencode/specs/system-skill-advisor/016-skill-advisor-tuning` and the documented scorer code under `.opencode/skills/system-skill-advisor/mcp_server/lib/scorer`.

## Known Context

- Charter boundary: hard read-only; never edit advisor/scorer code, write only lineage artifacts [SOURCE: .opencode/specs/system-skill-advisor/016-skill-advisor-tuning/_research-charter.md:3].
- Parent-hub priority: weight angles 1-5 first [SOURCE: .opencode/specs/system-skill-advisor/016-skill-advisor-tuning/_research-charter.md:7].
...
- Semantic-shadow freeze evidence: full 149/193 vs disabled 150/193, with false-fires to `mcp-chrome-devtools` [SOURCE: .opencode/specs/system-skill-advisor/016-skill-advisor-tuning/008-semantic-shadow-prove-or-freeze/implementation-summary.md:46] [SOURCE: .opencode/specs/system-skill-advisor/016-skill-advisor-tuning/008-semantic-shadow-prove-or-freeze/implementation-summary.md:79].

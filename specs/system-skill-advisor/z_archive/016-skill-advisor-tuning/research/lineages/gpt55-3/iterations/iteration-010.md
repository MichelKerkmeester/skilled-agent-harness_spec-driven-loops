...
3. Packet 008 measured the live-weight semantic lane as net-negative on the full corpus: full 149/193 vs semantic-disabled 150/193, with 3 hurt flips from gold `none` abstains to `mcp-chrome-devtools`. [SOURCE: file:.opencode/specs/system-skill-advisor/016-skill-advisor-tuning/008-semantic-shadow-prove-or-freeze/implementation-summary.md:79]
4. Packet 008 therefore freezes the weight at 0.05 and explicitly argues against raising it. [SOURCE: file:.opencode/specs/system-skill-advisor/016-skill-advisor-tuning/008-semantic-shadow-prove-or-freeze/implementation-summary.md:91]

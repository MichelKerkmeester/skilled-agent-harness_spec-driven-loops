...
1. 008 measured `semantic_shadow` as a marginal net-negative: full 149/193, disabled 150/193, with six flips. [SOURCE: .opencode/specs/system-skill-advisor/016-skill-advisor-tuning/008-semantic-shadow-prove-or-freeze/implementation-summary.md:46]
2. The harmful flips included three gold-`none` abstain false-fires to `mcp-chrome-devtools`. [SOURCE: .opencode/specs/system-skill-advisor/016-skill-advisor-tuning/008-semantic-shadow-prove-or-freeze/implementation-summary.md:79]
3. The lane remains frozen at weight 0.05; raising or dropping it would force broader rebaseline and structural changes. [SOURCE: .opencode/specs/system-skill-advisor/016-skill-advisor-tuning/008-semantic-shadow-prove-or-freeze/implementation-summary.md:91]

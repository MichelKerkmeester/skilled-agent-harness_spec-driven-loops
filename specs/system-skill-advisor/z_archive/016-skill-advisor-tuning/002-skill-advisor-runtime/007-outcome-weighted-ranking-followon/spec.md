...
| **Drift correction pointer (2026-07-01)** | `implementation-summary.md` records that the `3682ec59da` store/re-rank build was wired live-adjacent at `f3a1231c66` and deleted at `6b99eb68d2` after MRR delta +0.005 to +0.008 versus SD 0.0237 and right-skill@3 = 0.000 across all 90 runs. |
<!-- /ANCHOR:metadata -->

...
_memory:
  continuity:
    packet_pointer: "system-skill-advisor/016-skill-advisor-tuning/002-skill-advisor-runtime"
...
| **Level** | 2 |
| **Priority** | P1 |
| **Status** | complete — all children at accepted terminal states (004 & 007 shadow-only / live NO-GO, CHK-120 satisfied-by-deletion at 6b99eb68d2; 003 & 006 accepted-partial; remainder implemented) |
| **Created** | 2026-06-16 |
| **Updated** | 2026-06-19 |
| **Parent Spec** | `../spec.md` |
...
- Use `/speckit:resume system-skill-advisor/016-skill-advisor-tuning/002-skill-advisor-runtime/[NNN-phase]/` to resume a specific child.

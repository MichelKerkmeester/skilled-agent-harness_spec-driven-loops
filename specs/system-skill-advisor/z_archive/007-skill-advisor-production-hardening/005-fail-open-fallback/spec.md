...
description: "Close 3 P1 release blockers and 15 P2 advisories from the 002-skill-graph-daemon-native-advisor-tools deep review: advisor unavailable fail-open, public scan caller-authority gate, missing regression coverage for active invariants."
trigger_phrases:
...
| **Source review** | `specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/002-skill-graph-daemon-native-advisor-tools/review/002-skill-graph-daemon-native-advisor-tools-pt-01/review-report` |
...
### Problem Statement
The 008/002-skill-graph-daemon-native-advisor-tools deep review surfaced three release-blocker correctness/security/traceability gaps and 15 P2 advisories. The three P1s (all confirmed by Hunter→Skeptic→Referee adversarial self-check):
...
| `specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/002-skill-graph-daemon-native-advisor-tools/spec.md` | Modify | DR-008-D1-P2-002, DR-008-D3-P2-001 (hyphen to underscore + trusted-caller model) |
| `specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/002-skill-graph-daemon-native-advisor-tools/checklist.md` | Modify | DR-008-D1-P2-001 (file:line evidence) |
...
- **SC-004**: Strict packet validator passes for `002-skill-graph-daemon-native-advisor-tools` AND for this remediation sub-phase.
...
- **Source review report**: specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/002-skill-graph-daemon-native-advisor-tools/review/002-skill-graph-daemon-native-advisor-tools-pt-01/review-report

...
|---|---|---|---|
| `.opencode/specs/system-skill-advisor/002-skill-advisor-reindex-and-stress-test/spec.md` | Updated | OK | Root phase contract |
| `.opencode/specs/system-skill-advisor/002-skill-advisor-reindex-and-stress-test/plan.md` | Created | OK | Root execution plan |
| `.opencode/specs/system-skill-advisor/002-skill-advisor-reindex-and-stress-test/tasks.md` | Created | OK | Root task sequence |
| `.opencode/specs/system-skill-advisor/002-skill-advisor-reindex-and-stress-test/checklist.md` | Created | OK | Root verification ledger |
| `.opencode/specs/system-skill-advisor/002-skill-advisor-reindex-and-stress-test/001-baseline-reindex-and-stress-results/` | Moved | OK | Completed baseline evidence |
| `.opencode/specs/system-skill-advisor/002-skill-advisor-reindex-and-stress-test/resource-map.md` | Updated | OK | Root affected-surface ledger |
| `.opencode/specs/system-skill-advisor/002-skill-advisor-reindex-and-stress-test/002-memory-save-negative-trigger-calibration/` | Updated | OK | Completed memory-save remediation phase |
| `.opencode/specs/system-skill-advisor/002-skill-advisor-reindex-and-stress-test/003-create-testing-playbook-routing/` | Updated | OK | Completed testing-playbook remediation phase |
| `.opencode/specs/system-skill-advisor/002-skill-advisor-reindex-and-stress-test/004-skill-router-alias-canonicalization/` | Updated | OK | Completed alias remediation phase |
| `.opencode/specs/system-skill-advisor/002-skill-advisor-reindex-and-stress-test/005-ambiguous-debug-review-routing/` | Updated | OK | Completed ambiguous debug/review remediation phase |
<!-- /ANCHOR:specs -->

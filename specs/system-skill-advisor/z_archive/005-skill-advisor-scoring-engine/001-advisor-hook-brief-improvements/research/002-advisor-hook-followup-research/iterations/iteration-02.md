...
- The OpenCode plugin still defaults `thresholdConfidence` to `0.7`, while the shared brief path defaults to `0.8` confidence and `0.35` uncertainty, so OpenCode starts from a looser threshold baseline than the shared hook contract [.opencode/plugins/spec-kit-skill-advisor.js:27-29] [.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/skill-advisor-brief.ts:120-135] [.opencode/skills/system-spec-kit/references/hooks/skill-advisor-hook.md:151-155].
...
> return recommendations.filter((recommendation) => { [.opencode/skills/system-spec-kit/mcp_server/skill-advisor/lib/skill-advisor-brief.ts:124-126]

...
## 2. TOPIC
Review of `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/004-skill-graph-metadata-routing-boosts` after remediation, with this restart session re-checking corrected defects and adjacent trust-boundary surfaces.

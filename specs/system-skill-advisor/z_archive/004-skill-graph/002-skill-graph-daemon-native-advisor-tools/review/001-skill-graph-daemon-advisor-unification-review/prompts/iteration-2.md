...
**GATE 3 PRE-ANSWERED — A (Existing folder)**: `specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/002-skill-graph-daemon-native-advisor-tools`. The orchestrator (Claude loop manager) has authorized this folder for the entire deep-review session. DO NOT re-ask Gate 3. DO NOT request confirmation. DO NOT halt. Proceed directly to review work.

**TARGET AUTHORITY**: All write paths in this prompt are pre-approved under spec folder `002-skill-graph-daemon-native-advisor-tools/`. Writing iteration-002.md, appending JSONL state, writing delta — these are the deliverables, not options.
...
Review Target: 002-skill-graph-daemon-native-advisor-tools
...
Write to: `specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/002-skill-graph-daemon-native-advisor-tools/review/002-skill-graph-daemon-native-advisor-tools-pt-01/iterations/iteration-002.md`

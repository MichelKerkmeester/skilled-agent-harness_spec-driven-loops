# Deep-Review Synthesis Prompt — 008/002-skill-graph-daemon-native-advisor-tools

**GATE 3 PRE-ANSWERED — A (Existing folder)**: `specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/002-skill-graph-daemon-native-advisor-tools`. The orchestrator has authorized this folder. DO NOT re-ask Gate 3. Proceed directly to synthesis.
...
2. **Read iteration files**:
   - `specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/002-skill-graph-daemon-native-advisor-tools/review/002-skill-graph-daemon-native-advisor-tools-pt-01/iterations/iteration-001.md`
   - `.../iterations/iteration-002.md`
   - `.../iterations/iteration-003.md`
   - `.../iterations/iteration-004.md`

3. **Compile** `review-report.md` at:
   `specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/002-skill-graph-daemon-native-advisor-tools/review/002-skill-graph-daemon-native-advisor-tools-pt-01/review-report.md`

...
|---|---:|---|
| 027-typescript-header-normalization | 84 | Widespread TypeScript header normalization spans production and test surfaces and exceeds the 10 LOC dispatch cap as a cluster. |
| 028-generated-js-declaration-alignment | 23 | JavaScript, ESM, CJS, and declaration outputs include generated or package-boundary files that need owner-specific validation before edits. |

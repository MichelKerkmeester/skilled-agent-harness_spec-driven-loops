...
| D-004 | P2 | Child 007 `spec.md` still references old launcher path `skill-advisor-launcher.cjs` (pre-015 rename) | `007-skill-advisor-db-rename/spec.md:108` | documentation/stale-ref |
| D-005 | P2 | Feature catalog files in 008 child contain `system_skill_advisor` references (historical pre-015 state) | `feature_catalog/` within `008-skill-graph-tools-advisor-migration/` | documentation/stale-ref |

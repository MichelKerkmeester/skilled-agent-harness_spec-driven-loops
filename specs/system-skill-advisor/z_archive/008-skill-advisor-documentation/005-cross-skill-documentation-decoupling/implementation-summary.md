...
1. **Pre-existing 008-skill-advisor-documentation warnings remain.** The 008-skill-advisor-documentation parent spec.md is missing its `_memory` block (predates this work). Recursive strict-validate on the parent will show 2 warnings unrelated to this packet.

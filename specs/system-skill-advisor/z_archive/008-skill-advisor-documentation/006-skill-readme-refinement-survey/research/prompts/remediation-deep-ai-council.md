REMEDIATE: deep-ai-council/README.md per packet-005-style refinement rules.

# Goal

Modify exactly one file: `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/deep-ai-council/README.md`

Apply the refinements catalogued in the audit report for skill `deep-ai-council`. Output the modified README directly in-place (the agent-config allows writes only to this one path).
...
Section 1 tables to remove or move:
  - lines 70-77 (2 cols, 5 rows): Key Capabilities table (Multi-seat deliberation, Seat diversity, Append-only state, Two-of-three convergence, Rollback forensics, Schema-evolution policy) -> to-bullets
...
Write the entire revised README to `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/deep-ai-council/README.md`. Do not produce any other files. Do not edit any other file.

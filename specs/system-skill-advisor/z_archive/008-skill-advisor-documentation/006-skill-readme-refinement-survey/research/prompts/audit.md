...
1. JSON report at `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-docs/006-skill-readme-refinement-survey/research/audit-report.json` (machine-readable, see schema below)
2. Markdown summary at `.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-docs/006-skill-readme-refinement-survey/research/audit-report.md` (human-readable; cites every finding with file:line and the literal matched substring)

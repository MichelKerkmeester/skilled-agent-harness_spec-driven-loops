REMEDIATE: sk-code-review/README.md per packet-005-style refinement rules.

# Goal

Modify exactly one file: `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/sk-code-review/README.md`

Apply the refinements catalogued in the audit report for skill `sk-code-review`. Output the modified README directly in-place (the agent-config allows writes only to this one path).
...
Section 1 tables to remove or move:
  - lines 50-59 (2 cols, 7 rows): Key Statistics table (Skill version, SKILL.md size, Severity tiers, Mandatory minimums, Reference files, Surface evidence source, Output contract) -> to-paragraph
  - lines 62-71 (3 cols, 5 rows): How This Compares table (sk-code-review vs sk-code vs sk-doc for Findings-first review, Severity labels, Security minimums, Surface-aware standards, Code implementation, Documentation quality) -> move-to-§3
...
Write the entire revised README to `/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/sk-code-review/README.md`. Do not produce any other files. Do not edit any other file.

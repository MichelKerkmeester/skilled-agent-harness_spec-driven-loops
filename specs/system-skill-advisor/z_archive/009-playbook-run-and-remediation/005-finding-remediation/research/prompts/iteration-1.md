...
- Config: .opencode/specs/system-skill-advisor/009-playbook-run-and-remediation/005-finding-remediation/research/deep-research-config.json
- State Log: .opencode/specs/system-skill-advisor/009-playbook-run-and-remediation/005-finding-remediation/research/deep-research-state.jsonl
- Strategy: .opencode/specs/system-skill-advisor/009-playbook-run-and-remediation/005-finding-remediation/research/deep-research-strategy.md
- Registry: .opencode/specs/system-skill-advisor/009-playbook-run-and-remediation/005-finding-remediation/research/deep-research-findings-registry.json
- Write iteration narrative to: .opencode/specs/system-skill-advisor/009-playbook-run-and-remediation/005-finding-remediation/research/iterations/iteration-001.md
- Write per-iteration delta file to: .opencode/specs/system-skill-advisor/009-playbook-run-and-remediation/005-finding-remediation/research/deltas/iter-001.jsonl

...
- Changelog coverage is incomplete. The scoped changelog grep found no semantic-shadow promotion note; the light scoped `git log --oneline -n 20` did show broad scorer/default remediation history, especially `2b96d7392e feat(022): hardcoded-default remediation arc COMPLETE + 3 same-day follow-ons (011, 012, 013)`, but not a dedicated semantic-shadow promotion entry.

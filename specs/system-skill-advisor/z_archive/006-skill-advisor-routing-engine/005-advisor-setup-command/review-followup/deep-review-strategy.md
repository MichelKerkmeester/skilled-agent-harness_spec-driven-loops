# Strategy - 005-advisor-setup-command Closure Re-Review (pt-02)
...
- Per-iteration prompt: `review-followup/prompts/iteration-NNN.md`
- Per-iteration findings: `review-followup/iterations/iteration-NNN.md`
- Per-iteration delta JSON: `review-followup/deltas/iteration-NNN.json`
- State log: `review-followup/deep-review-state.jsonl`
- Final report: `review-followup/review-report.md`

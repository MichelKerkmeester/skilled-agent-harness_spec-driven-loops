...
3. `review-followup/deep-review-state.jsonl`
...
- F-CONV-001 (artifact gap from pt-01): pt-01 iterations 003 + 006 had log-embedded artifacts that were materialized post-loop
  → expect: `.opencode/specs/.../005-advisor-setup-command/review/iterations/iteration-{003,006}.md` exist as canonical files
...
Path: `.opencode/specs/.../005-advisor-setup-command/review-followup/iterations/iteration-005.md`
...
### 2. Delta JSON
Path: `review-followup/deltas/iteration-005.json`

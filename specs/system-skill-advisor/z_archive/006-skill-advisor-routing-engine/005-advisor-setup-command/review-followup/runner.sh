#!/usr/bin/env bash
# Sequential cli-copilot deep-review runner for closure re-review (review-followup)
...
# delta-NNN.json output files under review-followup/. Do not copy this pattern to
# mutation workflows.

set -uo pipefail

REPO_ROOT="/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public"
PACKET="$REPO_ROOT/.opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-skill-advisor/005-advisor-setup-command"
REVIEW="$PACKET/review-followup"

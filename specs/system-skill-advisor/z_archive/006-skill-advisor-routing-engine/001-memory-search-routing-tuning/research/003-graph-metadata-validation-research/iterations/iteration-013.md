...
## Findings
1. `extractReferencedFilePaths()` currently accepts almost any backticked token that contains a dot-extension; it only excludes URLs, `./research/`, `../`, wildcards, and `...`. [SOURCE: .opencode/skills/system-spec-kit/mcp_server/lib/graph/graph-metadata-parser.ts:320-334]
...
## Sources Consulted
- `.opencode/skills/system-spec-kit/mcp_server/lib/graph/graph-metadata-parser.ts:320-334`

...
- The promoted coordination-parent metadata still maps the correct child packet ids and does not introduce a separate root-mapping correctness issue. [SOURCE: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-search-routing-advisor/001-memory-search-routing-tuning/description.json:2] [SOURCE: .opencode/specs/system-spec-kit/026-graph-and-context-optimization/006-search-routing-advisor/001-memory-search-routing-tuning/graph-metadata.json:3]

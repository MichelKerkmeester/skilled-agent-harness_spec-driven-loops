...
| **Predecessor** | `010-skill-advisor-embedder-stack/001-pluggable-architecture/` through `004-skill-graph-db-writer-cross-wire/` |
<!-- /ANCHOR:metadata -->

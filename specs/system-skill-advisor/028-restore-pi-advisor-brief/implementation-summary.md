...
| Package test battery (vitest) | PASS — 880 passed / 11 failed / 898 (150 s); the identical 11 failures reproduced on a stash-baseline of the same 8 files without the edits, so they pre-exist at the worktree's HEAD and none come from the touched behavior |

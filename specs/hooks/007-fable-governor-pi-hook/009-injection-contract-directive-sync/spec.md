...
_memory:
  continuity:
    ...
    session_dedup:
      fingerprint: "sha256:aa05dc3deac70417bac0eccb01e25f476fa66e609076be894db6e4259c9834f1"
...
bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/hooks/007-fable-governor-pi-hook/009-injection-contract-directive-sync --strict
```
<!-- /ANCHOR:success-criteria -->

...
## 2. TOPIC
Spec-folder review of the current governor-parity, Pi directive, bounded-dispatch, authorization, runtime/factory-test, metadata, and injection-contract surfaces represented by .opencode/specs/hooks/007-fable-governor-pi-hook.

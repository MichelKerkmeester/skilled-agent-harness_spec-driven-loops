...
_memory:
  continuity:
    ...
    key_files:
      ...
      - "checklist.md"
    session_dedup:
      fingerprint: "sha256:2355d1fce70a770e1ddeefa22244d43a44e91c13c7968aa1f07bed156312e639"
...
- [x] T011 [P0] Generate `description.json` via the repo script (no hand-fabricated fields). [EVIDENCE: `node .opencode/skills/system-spec-kit/scripts/dist/spec-folder/generate-description.js .opencode/specs/hooks/007-fable-governor-pi-hook/010-cross-runtime-coverage-and-verification /Users/michelkerkmeester/MEGA/Development/Code_Environment/Public` run and output recorded in `implementation-summary.md`.]
- [x] T012 [P0] Generate/backfill `graph-metadata.json` via the repo script (no hand-fabricated fields). [EVIDENCE: `node .opencode/skills/system-spec-kit/scripts/dist/graph/backfill-graph-metadata.js .opencode/specs/hooks/007-fable-governor-pi-hook/010-cross-runtime-coverage-and-verification` run and output recorded in `implementation-summary.md`.]

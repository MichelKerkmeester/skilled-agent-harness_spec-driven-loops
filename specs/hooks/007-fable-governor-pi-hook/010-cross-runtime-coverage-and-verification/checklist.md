...
_memory:
  continuity:
    ...
    session_dedup:
      fingerprint: "sha256:d183a122b7a3b37081da0c73261dfab896e03abad8b148852ede64c0b86fd6ba"
...
- [x] CHK-050 [P1] Only this phase's own folder was written to. [TESTED: scoped diff]
  - [EVIDENCE: `git status --porcelain -- .opencode/specs/hooks/007-fable-governor-pi-hook/010-cross-runtime-coverage-and-verification` shows only new files under this folder; the parent's `spec.md` phase map was not edited per the dispatch contract.]

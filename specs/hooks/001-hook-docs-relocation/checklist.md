...
- [x] CHK-017 [P0] Spec, plan, tasks, checklist, decision-record, and summary all present
  - **Evidence**: [evidence: `.opencode/specs/hooks/001-hook-docs-relocation/` contains all six canonical documents plus generated metadata]
...
- [x] CHK-019 [P0] Packet lives under hooks with a convention-compliant name
  - **Evidence**: [evidence: packet path `.opencode/specs/hooks/001-hook-docs-relocation` matches the ###-short-name pattern]

...
- Historical packets `003-goal-hooks-cross-runtime` and `004-goal-hook-playbooks-and-validation` as claims to verify against current source.
...
- **Stage 3 — Regression Controls**: All 7 original tests from `003-goal-hooks-cross-runtime` pass against per-session storage.
...
- **Prior architecture**: `../../003-goal-hooks-cross-runtime/spec.md`
- **Prior validation**: `../../004-goal-hook-playbooks-and-validation/spec.md`

# Injection-Surface Deprecation Research — Synthesis (lineage pi)

**Lineage:** `fanout-pi-1786264236566-r99u1v` · **Executor:** cli-pi (deepseek-v4-flash) · **Spec packet:** hooks/002-injection-bloat-reduction/014-injection-surface-deprecation-research · **Stop reason:** converged (composite 0.70 > 0.60; MAD + entropy signals; all legal-stop gates passed) · **Iterations:** 9
...
*Note: `resource-map.md` was absent at the spec folder at init (`resource_map_present: false`); the coverage gate was skipped per protocol. The lineage-local resource map is emitted from converged deltas.*

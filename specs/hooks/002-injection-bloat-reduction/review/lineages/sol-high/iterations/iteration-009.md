...
- [SOURCE: .opencode/plugins/mk-spec-memory.js:1]
...
- SL-009: The direction was covered once and marked saturated to prevent repetition. [SOURCE: .opencode/plugins/mk-spec-memory.js:1]

...
4. `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh specs/hooks/008-pi-caching-like-reasonix/007-research-fork-improvements --strict` exits 0
<!-- /ANCHOR:verification -->

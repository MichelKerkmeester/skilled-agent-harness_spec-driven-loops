---
title: "Iteration 001 — Correctness: ownership boundary and silent paths"
trigger_phrases: []
---
...
- Re-opening the narrow `provider === "deepseek"` predicate to blanket `isDeepSeekLikeModel` exclusion — that would orphan `opencode/deepseek-v4-flash-free` again (already decided in 003). [SOURCE: specs/hooks/008-pi-caching-like-reasonix/003-fork-and-guard-cache-optimizer/spec.md:86-91]

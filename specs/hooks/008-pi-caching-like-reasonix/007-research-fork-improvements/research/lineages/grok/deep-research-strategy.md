...
- **Artifact boundary:** `specs/hooks/008-pi-caching-like-reasonix/007-research-fork-improvements/research/lineages/grok` only.
...
- Sibling 003 completed DeepSeek-guard fork for `pi-cache-optimizer` at `.pi/extensions/pi-cache-optimizer/` with narrow `isDeepPiOwned` predicate. [SOURCE: specs/hooks/008-pi-caching-like-reasonix/003-fork-and-guard-cache-optimizer/spec.md]
- Sibling 006 completed deep-pi hardening (silent counters, model-drift warning, cost-math) at `.pi/extensions/deep-pi/`. [SOURCE: specs/hooks/008-pi-caching-like-reasonix/006-fork-and-improve-deep-pi/spec.md]

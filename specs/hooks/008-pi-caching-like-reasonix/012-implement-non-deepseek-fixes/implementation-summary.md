...
_memory:
  continuity:
    ...
    last_updated_at: "2026-08-11T06:43:19.431Z"
...
| Packet-wide strict validation | PASS: `validate.sh .../008-pi-caching-like-reasonix --recursive --strict` exit 0 after metadata reconciliation |

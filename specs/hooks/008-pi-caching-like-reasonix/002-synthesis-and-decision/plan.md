...
4. `bash .opencode/skills/system-spec-kit/scripts/spec/validate.sh .opencode/specs/hooks/008-pi-caching-like-reasonix/002-synthesis-and-decision --strict` exits 0
<!-- /ANCHOR:verification -->

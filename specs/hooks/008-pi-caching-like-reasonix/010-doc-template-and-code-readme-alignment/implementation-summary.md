...
_memory:
  continuity:
    ...
    last_updated_at: "2026-08-11T06:43:19.049Z"
...
| `index.ts` export surface and hook registrations vs. the original committed fork | PASS — both exports and all 7 `pi.on(...)` registrations byte-identical to `3124cb6e8e` |

...
- The lumo “Context Engine v2” proposal is therefore not a description of a missing Pi primitive. It is a possible policy layer for stable-prefix preservation and cache diagnostics around existing compaction; its value depends on improving provider cache reuse without degrading summary correctness. [SOURCE: .opencode/specs/hooks/008-pi-caching-like-reasonix/lumo.md:23-32; INFERENCE: https://pi.dev/docs/latest/compaction]

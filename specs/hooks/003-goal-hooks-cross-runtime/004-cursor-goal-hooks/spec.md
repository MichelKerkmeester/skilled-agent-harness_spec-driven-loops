...
- **Phase 001**: `.opencode/specs/hooks/003-goal-hooks-cross-runtime/001-goal-core-and-state/spec.md` — the goal core this phase builds on
- **Phase 002**: `.opencode/specs/hooks/003-goal-hooks-cross-runtime/002-capability-probes/spec.md` — the capability matrix this phase's REQ-005 depends on

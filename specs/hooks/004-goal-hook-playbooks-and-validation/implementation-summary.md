...
_memory:
  continuity:
    ...
    last_updated_at: "2026-08-11T06:43:20.701Z"
...
| Field | Value |
|-------|-------|
| **Spec Folder** | 004-goal-hook-playbooks-and-validation |
...
| mk-goal's headless limitation is a finding, not a packet-032 regression | mk-goal is a separate, pre-existing OpenCode-native system with its own test suite; its headless gap predates this packet and packet 003 never touched it |
<!-- /ANCHOR:decisions -->

...
_memory:
  continuity:
    ...
    next_safe_action: "Execute 003-port-retry-loop-guard"
    blockers: []
    key_files:
...
| 3 | `003-port-retry-loop-guard/` | Detect and break paid retry loops so a failing turn stops re-billing the same request | Planned |

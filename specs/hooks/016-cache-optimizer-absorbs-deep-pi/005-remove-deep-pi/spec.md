---
title: "Feature Specification: Phase 5: remove-deep-pi"
...
# Feature Specification: Phase 5: remove-deep-pi
...
| **Status** | Draft |
| **Created** | 2026-09-08 |
| **Branch** | `scaffold/005-remove-deep-pi` |
| **Parent Spec** | ../spec.md |
| **Phase** | 5 of 5 |
...
This is **Phase 5** of the Absorb DeepPi's measured cache economics, retry loop guard and hash-verified edits into pi-cache-optimizer, reclaim the DeepSeek-direct models it had carved out, and remove the deep-pi extension specification.

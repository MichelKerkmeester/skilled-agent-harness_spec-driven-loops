...
- See: `.opencode/skills/workflows-code/references/debugging_workflows.md` (Section 7)
- See: `.opencode/skills/workflows-code/references/performance_patterns.md` (Section 3)
...
**Workflow integration:**
- See: `.opencode/skills/workflows-code/references/animation_workflows.md` (Section 6)
...
**Workflow integration:**
- See: `.opencode/skills/workflows-code/references/verification_workflows.md` (Section 2)
- See: `.opencode/skills/workflows-code/references/animation_workflows.md` (Multi-Viewport Testing)
...
**CLI Chrome DevTools**:
- `.opencode/skills/workflows-chrome-devtools/SKILL.md` - Main skill documentation
- `.opencode/skills/workflows-chrome-devtools/references/` - Additional reference materials
...
- **mcp-code-graph** - Intent-based code discovery

...
| Variable                | Default                                                       | Description                     |
| ----------------------- | ------------------------------------------------------------- | ------------------------------- |
| `MEMORY_DB_PATH`        | `.opencode/skills/system-memory/database/memory-index.sqlite` | Database location               |
...
```
{project}/.opencode/skills/system-memory/database/memory-index.sqlite
```

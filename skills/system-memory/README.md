...
| Vector embeddings | `.opencode/skills/system-memory/database/memory-index.sqlite` | Fast semantic search (project-local) |
| FTS5 index | `.opencode/skills/system-memory/database/memory-index.sqlite` | Full-text keyword search |
| Checkpoints | `.opencode/skills/system-memory/database/memory-index.sqlite` | State snapshots |
...
| Variable | Default | Description |
|----------|---------|-------------|
| `MEMORY_INDEX_PATH` | `.opencode/skills/system-memory/database/memory-index.sqlite` | Vector index location |
...
|------|----------|---------|
| Vector Index | `.opencode/skills/system-memory/database/memory-index.sqlite` | Embeddings + metadata |
...
```bash
cd .opencode/skills/system-memory
...
| Skills SKILL.md | `.opencode/skills/system-memory/SKILL.md` | Memory workflow |

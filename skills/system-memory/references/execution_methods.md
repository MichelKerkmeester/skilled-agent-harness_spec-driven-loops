...
| Script exists      | `test -f .opencode/skills/system-memory/scripts/generate-context.js` | Check skill installation |
...
ls -la .opencode/skills/system-memory/scripts/
...
node .opencode/skills/system-memory/scripts/generate-context.js --help
```

...
```jsonc
{
  "semantic": {
    ...
    "indexPath": ".opencode/skills/system-memory/database/memory-index.sqlite"
  },
  "triggers": {
    "autoSaveInterval": 20,
...
| SQLite Database | `.opencode/skills/system-memory/database/memory-index.sqlite` |
...
ls -la .opencode/skills/system-memory/database/memory-index.sqlite
...
sqlite3 .opencode/skills/system-memory/database/memory-index.sqlite "VACUUM"
```
...
```bash
# Rebuild FTS index
sqlite3 .opencode/skills/system-memory/database/memory-index.sqlite "INSERT INTO memory_fts(memory_fts) VALUES('rebuild')"
```

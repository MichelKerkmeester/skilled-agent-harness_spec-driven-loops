...
AUTO_SAVE_MODE=true node .opencode/skills/system-memory/scripts/generate-context.js data.json
```
...
node .opencode/skills/system-memory/scripts/generate-context.js data.json "122-specific-folder"
```

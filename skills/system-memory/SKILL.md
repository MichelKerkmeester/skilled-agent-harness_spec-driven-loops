...
| --------------- | -------------------------------------------------------------- | -------- |
| MCP Server      | `.opencode/skills/system-memory/mcp_server/semantic-memory.js` | **Yes**  |
| Main script     | `.opencode/skills/system-memory/scripts/generate-context.js`   | **Yes**  |
| Memory Database | `.opencode/skills/system-memory/database/memory-index.sqlite`  | **Yes**  |

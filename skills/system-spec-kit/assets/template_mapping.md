...
**All templates located in:** `.opencode/skills/system-spec-kit/templates/`
...
```bash
cp .opencode/skills/system-spec-kit/templates/spec.md specs/###-name/spec.md
cp .opencode/skills/system-spec-kit/templates/plan.md specs/###-name/plan.md
cp .opencode/skills/system-spec-kit/templates/tasks.md specs/###-name/tasks.md
```

**Level 2 Copy Commands (adds to Level 1):**
```bash
# First copy all Level 1 files, then add:
cp .opencode/skills/system-spec-kit/templates/checklist.md specs/###-name/checklist.md
```

**Level 3 Copy Commands (adds to Level 2):**
```bash
# First copy all Level 2 files, then add:
cp .opencode/skills/system-spec-kit/templates/decision-record.md specs/###-name/decision-record-[topic].md
# Optional:
cp .opencode/skills/system-spec-kit/templates/research-spike.md specs/###-name/research-spike-[topic].md
```
...
| ------------------- | --------------------------- | --------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| `research-spike.md` | `research-spike-[topic].md` | Time-boxed research, POC, feasibility testing | `cp .opencode/skills/system-spec-kit/templates/research-spike.md specs/###-name/research-spike-performance.md` |
| `research.md`       | `research.md`               | Comprehensive research documentation          | `cp .opencode/skills/system-spec-kit/templates/research.md specs/###-name/research.md`                         |
...
1. **Always copy from `.opencode/skills/system-spec-kit/templates/`** - Never freehand documentation
...
cp .opencode/skills/system-spec-kit/templates/research-spike.md specs/###-name/research-spike-performance.md

# Comprehensive Research
cp .opencode/skills/system-spec-kit/templates/research.md specs/###-name/research.md
```

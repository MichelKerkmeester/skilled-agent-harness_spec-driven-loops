...
| **Total**  | **26** | Complete bundled resource set                                      |
...
cp .opencode/skills/system-spec-kit/templates/spec.md specs/###-your-feature-name/
cp .opencode/skills/system-spec-kit/templates/plan.md specs/###-your-feature-name/
cp .opencode/skills/system-spec-kit/templates/tasks.md specs/###-your-feature-name/
```
...
All templates are located in `.opencode/skills/system-spec-kit/templates/`. **NEVER create documentation from scratch** - always copy from templates and fill placeholders.
...
**Copy Command**:
```bash
cp .opencode/skills/system-spec-kit/templates/handover.md specs/###-name/handover.md
```
...
**Copy Command**:
```bash
cp .opencode/skills/system-spec-kit/templates/debug-delegation.md specs/###-name/debug-delegation.md
```

### Template Rules

1. **ALWAYS copy from `.opencode/skills/system-spec-kit/templates/`** - never create from scratch
...
Six automation scripts in `.opencode/skills/system-spec-kit/scripts/` provide workflow automation.
...
**Example**:
```bash
$ .opencode/skills/system-spec-kit/scripts/create-spec-folder.sh "Add user authentication" --level 2
...
**Example**:
```bash
$ .opencode/skills/system-spec-kit/scripts/check-prerequisites.sh
...
**Example**:
```bash
$ .opencode/skills/system-spec-kit/scripts/calculate-completeness.sh specs/042-user-auth
...
**Example**:
```bash
$ .opencode/skills/system-spec-kit/scripts/recommend-level.sh --loc 250 --files 8
...
**Example**:
```bash
$ .opencode/skills/system-spec-kit/scripts/archive-spec.sh specs/042-user-auth
...
- `.opencode/skills/system-spec-kit/templates/*.md` - All 9 templates
- `.opencode/skills/system-spec-kit/SKILL.md` - Main skill
...
| ------------ | ------------------------------ | ------------------------------ | -------------------- |
| **SpecKit**  | Template & workflow management | User-invoked or AI-triggered   | `.opencode/skills/system-spec-kit/` |
...
.opencode/skills/system-spec-kit/scripts/create-spec-folder.sh "Add user authentication system"
...
cp .opencode/skills/system-spec-kit/templates/plan.md specs/042-feature/plan.md
cp .opencode/skills/system-spec-kit/templates/tasks.md specs/042-feature/tasks.md

# Level 2: Add verification
cp .opencode/skills/system-spec-kit/templates/checklist.md specs/042-feature/checklist.md

# Level 3: Add decision documentation
cp .opencode/skills/system-spec-kit/templates/decision-record.md specs/042-feature/decision-record-database.md

# Optional research
cp .opencode/skills/system-spec-kit/templates/research.md specs/042-feature/research.md
cp .opencode/skills/system-spec-kit/templates/research-spike.md specs/042-feature/research-spike-auth-library.md

# Utility templates
cp .opencode/skills/system-spec-kit/templates/handover.md specs/042-feature/handover.md
cp .opencode/skills/system-spec-kit/templates/debug-delegation.md specs/042-feature/debug-delegation.md
```
...
.opencode/skills/system-spec-kit/scripts/calculate-completeness.sh specs/042-feature/
...
3. Ensure scripts have execute permission: `chmod +x .opencode/skills/system-spec-kit/scripts/*.sh`
...
A: Single source of truth: `.opencode/skills/system-spec-kit/templates/`
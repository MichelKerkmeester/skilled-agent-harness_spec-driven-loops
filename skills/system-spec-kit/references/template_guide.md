...
1. **Never create from scratch** - Always copy from `.opencode/skills/system-spec-kit/templates/`
...
```bash
cp .opencode/skills/system-spec-kit/templates/[template].md specs/###-name/[target].md
```
...
1. **Always copy from `.opencode/skills/system-spec-kit/templates/`** - Never freehand
...
**Right:**
```bash
cp .opencode/skills/system-spec-kit/templates/spec.md specs/042-feature/spec.md
```
...
## 9. 🗂️ USING SUB-FOLDERS FOR ORGANIZATION

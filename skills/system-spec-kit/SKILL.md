...
**Manual context save:**
- Use `/save_context` command or ask AI to save context
- Save location: `specs/###-folder/memory/` or sub-folder memory/ if active
- Filename format: `DD-MM-YY_HH-MM__topic.md`
...
2. **ALWAYS copy templates from `.opencode/skills/system-spec-kit/templates/` - NEVER create from scratch**
...
11. **ALWAYS suggest handover.md when session-ending keywords detected**
    ...
    - Copy from `.opencode/skills/system-spec-kit/templates/handover.md`
    - Fill all 5 sections: Summary, Context Transfer, Next Steps, Validation, Notes

### ❌ NEVER 

1. **NEVER create documentation files from scratch** - Always copy from `.opencode/skills/system-spec-kit/templates/`
...
- [ ] Templates copied from `.opencode/skills/system-spec-kit/templates/` (not created from scratch)
...
- [ ] Context saved to `specs/###/memory/` (manual trigger via /memory:save)
...
- `.opencode/skills/system-spec-kit/templates/` - All template files

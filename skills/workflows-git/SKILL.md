...
- GitHub/GitLab web UI operations (use mcp-code-mode with appropriate tools)

### Keyword Triggers

`worktree`, `branch`, `commit`, `merge`, `pr`, `pull request`, `git workflow`, `conventional commits`, `finish work`, `integrate changes`

...
.reveal { opacity: 0; transform: translateY(20px); transition: var(--transition-reveal); }
.reveal.active { opacity: 1; transform: translateY(0); }
.text-balance { text-wrap: balance; }
.mono { font-family: var(--font-mono); }
</style>
<section class="mb-24 reveal" id="top">
...
<section id="{{section_id}}" class="space-y-10 reveal pt-4">
...
print("Injected CSS into components and sections.")

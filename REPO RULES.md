...
|-------|--------|--------------------|
| 1 | `AGENTS.md` hard blockers (Four Laws, mandatory gates) | No |
...
| Say "done", "works", "fixed", "passing", "no regressions" · report a result · quote a number · act on a tool's or sub-agent's success report | [`repo-rules/evidence-and-proof.md`](repo-rules/evidence-and-proof.md) | What counts as proof, and how a green run lies |
...
| Answer without certainty · contradict the operator · fill a gap with a plausible guess · close out a turn | [`repo-rules/uncertainty-and-honesty.md`](repo-rules/uncertainty-and-honesty.md) | Confidence bands, UNKNOWN, contradiction halts, and honest close-out |

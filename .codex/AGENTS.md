...
When the repository you are working in carries `.skilled/skills/system-spec-kit` or `.opencode/skills/system-spec-kit`, its root `AGENTS.md` §2 Gate 1 applies on every new prompt; the lookup it names is:

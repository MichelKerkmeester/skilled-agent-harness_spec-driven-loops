...
```markdown
<!-- Generated by sync-prompts.cjs from .skilled/commands/create/skill.md — do not edit by hand. -->
...
node .skilled/skills/system-spec-kit/runtime/cli/codex/sync-prompts.cjs
...
```toml
# Agent: review
# Converted from: .skilled/agents/review.md
name = "review"
...
| Check | Command | Exit |
|---|---|---|
| Generated agents | `node .skilled/skills/system-spec-kit/runtime/cli/codex/sync-agents.cjs --check` | 0 ok / 1 drift |
...
- **Generated agents lose information.** `sandbox_mode`, `model` and `model_reasoning_effort` cannot round-trip back to `.skilled/agents/`. Codex is a one-way derivation.
...
| `.skilled/skills/system-spec-kit/runtime/cli/codex/README.md` | The generator contract |
| `.skilled/bin/README.md` | `install-codex-hooks.mjs` ownership model and worktree guard |

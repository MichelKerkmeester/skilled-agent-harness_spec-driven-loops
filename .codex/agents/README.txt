...
This directory contains agent definitions for the Codex CLI runtime.
Each .toml file defines one agent surface with configuration (tools, permissions, model)
and behavioral instructions.

Sibling runtimes: .opencode/agents/ (.md) and .claude/agents/ (.md)

...
> **Cross-Platform Parity**: Keep body content aligned with `.opencode/agent/context.md` and `.claude/agents/context.md`; only platform frontmatter differs.
...
| ------------ | -------------------------------- | -------------------------------------------------------------------------- |
| Orchestrator | `.codex/agents/orchestrate.md` | Primary dispatcher — sends exploration requests, receives Context Packages |

### Complementary Agents

| Agent     | File                          | Relationship                                                                          |
| --------- | ----------------------------- | ------------------------------------------------------------------------------------- |
| @research | `.codex/agents/research.md` | Deeper alternative — when @context finds complexity requiring full 9-step investigation |
| @general  | Built-in                      | Implementation agent — uses @context's findings to write code                           |
| @speckit  | `.codex/agents/speckit.md`  | Spec documentation — uses @context's findings for spec folder creation                  |

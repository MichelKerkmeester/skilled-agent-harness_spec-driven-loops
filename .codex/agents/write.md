...
**CROSS-PLATFORM PARITY**: Keep body content aligned with `.opencode/agent/write.md` and `.claude/agents/write.md`; only platform frontmatter differs.
...
| Agent files (.codex/agents/*.md)       | `workflows-documentation` | agent_template.md           |

...
| Repository hygiene | `worktree-guard.sh`, `check-git-hooks.sh`, `check-dist-staleness.sh`, `git-live-follow.sh`, `git-preflight-advisory.mjs`, `git-primary-reconcile.sh` |

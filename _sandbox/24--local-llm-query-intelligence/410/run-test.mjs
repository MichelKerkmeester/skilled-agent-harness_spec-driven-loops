...
// Load workload
const workloadPath = join(__dirname, 'workload.json');
...
const mcpServerPath = '/Users/michelkerkmeester/MEGA/Development/Code_Environment/Public/.opencode/skills/system-spec-kit/mcp_server/dist/tools/memory-tools.js';
const { handleTool } = await import(mcpServerPath);
...
async function main() {
  ...
  return { verdict, coldResults, steadyResults };
}

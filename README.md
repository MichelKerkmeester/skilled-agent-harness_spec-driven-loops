...
| Test Files       | 126   | 122 passing + 4 skipped; 4,256 tests total       |
...
Spec Kit workflow features include `upgrade-level.sh`, the auto-populate workflow, `check-placeholders.sh`, and anchor tags.

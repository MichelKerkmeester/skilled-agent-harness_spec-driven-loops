...
- **Parent hub for external CLI dispatch.** One advisor identity routing to [`cli-opencode`](.opencode/skills/cli-external-orchestration/cli-opencode/README.md) (OpenCode runtime dispatch), [`cli-claude-code`](.opencode/skills/cli-external-orchestration/cli-claude-code/README.md) (Claude Code CLI), and [`cli-codex`](.opencode/skills/cli-external-orchestration/cli-codex/README.md) (OpenAI Codex CLI, availability-gated) through `mode-registry.json`

...
- **Parent hub for external CLI dispatch.** One advisor identity routing to [`cli-opencode`](.opencode/skills/cli-external-orchestration/cli-opencode/README.md) (OpenCode runtime dispatch) and [`cli-claude-code`](.opencode/skills/cli-external-orchestration/cli-claude-code/README.md) (Claude Code CLI) through `mode-registry.json`

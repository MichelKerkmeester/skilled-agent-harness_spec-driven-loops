...
| **LEAF**         | MUST NOT dispatch any sub-agents | @context, @general, @markdown, @ai-council, @review, @debug, @deep-research, @deep-review |
...
| @ai-council | `.gemini/agents/ai-council.md` | Planning-only multi-strategy architect (max 3 strategies)                              |
...
├─ Agent: @general | @context | @markdown | @deep-research | @ai-council | @review | @debug

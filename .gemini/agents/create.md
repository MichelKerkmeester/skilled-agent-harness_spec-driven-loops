...
| `/create:folder_readme` | `README.md` or install-guide markdown | `.opencode/skills/sk-doc/assets/documentation/readme_template.md` |
| `/create:changelog` | Versioned changelog markdown | `.opencode/skills/sk-doc/assets/documentation/changelog_template.md` |
...
| `.opencode/skills/sk-doc/assets/documentation/readme_template.md` | README template for `/create:folder_readme` |
| `.opencode/skills/sk-doc/assets/documentation/changelog_template.md` | Changelog template for `/create:changelog` |

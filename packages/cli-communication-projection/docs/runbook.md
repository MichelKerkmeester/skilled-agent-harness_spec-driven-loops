...
Complete every automated and operator-run prerequisite before rollout. Keep all
release evidence content-free and select original-only mode when a prerequisite
fails.

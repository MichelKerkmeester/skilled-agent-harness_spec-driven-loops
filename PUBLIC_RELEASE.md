...
| **Release Notes**  | https://github.com/MichelKerkmeester/opencode-spec-kit-framework/releases/tag/v2.1.3.1 |
...
**Latest**: See `.opencode/changelog/00--opencode-environment/v2.1.3.1.md`
...
| `2.1.3.x` | 2.1.3.0-1   | Agent model upgrade to Sonnet 4.6 + MCP recovery hardening     |

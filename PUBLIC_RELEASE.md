...
| **Release Notes**  | https://github.com/MichelKerkmeester/opencode-spec-kit-framework/releases/tag/v2.2.0.1 |
...
**Latest**: See `.opencode/changelog/00--opencode-environment/v2.2.0.1.md`
...
| `2.2.0.x` | 2.2.0.0-1   | System Spec Kit verification hardening + release-doc refresh (deferred-suite activation, CHK-336 closure, README/metadata sync) |

...
| **Release Notes**  | https://github.com/MichelKerkmeester/opencode-spec-kit-framework/releases/tag/v2.0.2.2 |
...
**Latest**: See `.opencode/changelog/00--opencode-environment/v2.0.2.2.md`
...
| `2.0.2.x` | 2.0.2.0-2   | Agent routing compliance + changelog reorganization (spec 014) |
